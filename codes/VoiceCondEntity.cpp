        ...
        const MethodInfo *method)
{
  if ( (byte_59397F2 & 1) == 0 )
  {
    sub_21FFC50(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_59397F2 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_38222C8 *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
