        ...
        const MethodInfo *method)
{
  if ( (byte_4CEF73C & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_4CEF73C = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_316F8AC *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
