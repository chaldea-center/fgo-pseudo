        ...
        const MethodInfo *method)
{
  if ( (byte_40FF73F & 1) == 0 )
  {
    sub_B16FFC(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___, *(_QWORD *)&voicePrefix);
    byte_40FF73F = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__string__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_18C2EC0 *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
