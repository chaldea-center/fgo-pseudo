        ...
        const MethodInfo *method)
{
  if ( (byte_4A5C06F & 1) == 0 )
  {
    sub_1B885B0(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
    byte_4A5C06F = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_2E7EDC0 *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
