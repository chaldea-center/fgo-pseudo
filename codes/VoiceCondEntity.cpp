        ...
        const MethodInfo *method)
{
  if ( (byte_421A2B0 & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___, *(_QWORD *)&voicePrefix);
    byte_421A2B0 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__string__long__long__long_(
           ...
           targetId,
           condGroup,
           (const MethodInfo_17141E4 *)Method_DataEntityBase_CreateMultiplePK_long__long__string__long__long__long___);
}
