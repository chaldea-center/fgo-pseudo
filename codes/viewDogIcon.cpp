void __fastcall viewDogIcon___ctor(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A021D9 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_20241/*"img_frameselect"*/, method);
    byte_4A021D9 = 1;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.FRAME_SELECT_NAME, v5, v2, v3);
...
void __fastcall viewDogIcon__ClickNotReleased(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A021D8 & 1) == 0 )
  {
    sub_1B64870(&Method_viewDogIcon_ClickNotReleased__, method);
    byte_4A021D8 = 1;
  }
  v2 = Method_viewDogIcon_ClickNotReleased__;
  if ( (*((_BYTE *)Method_viewDogIcon_ClickNotReleased__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1B64888(Method_viewDogIcon_ClickNotReleased__);
...
void __fastcall viewDogIcon__ClickPanel(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A021D7 & 1) == 0 )
  {
    sub_1B64870(&Method_viewDogIcon_ClickPanel__, method);
    byte_4A021D7 = 1;
  }
  ...
  {
    sub_1B64ACC(selectSprite, method);
  }
  ...
  if ( (*((_BYTE *)Method_viewDogIcon_ClickPanel__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B64888(Method_viewDogIcon_ClickPanel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A021D6 & 1) == 0 )
  {
    sub_1B64870(&long_TypeInfo, time);
    sub_1B64870(&LocalizationManager_TypeInfo, v4);
    sub_1B64870(&StringLiteral_5757/*"EXPEDITION_TIME_FORMAT"*/, v5);
    byte_4A021D6 = 1;
  }
  if ( time < 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A021D4 & 1) == 0 )
  {
    sub_1B64870(&AtlasManager_TypeInfo, eventExpeditionPieceEntity);
    sub_1B64870(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v5);
  ...
  *(_WORD *)&this->fields._IsSelect_k__BackingField = 0;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.onClickPanel, 0, v9, v10);
  ...
  AtlasManager__SetEventUI_37549072(eventId, selectSprite, FRAME_SELECT_NAME, 0LL);
  ...
  {
    compatibilityLabel = (UILabel_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( compatibilityLabel )
    {
...
LABEL_31:
    sub_1B64ACC(compatibilityLabel, eventExpeditionPieceEntity);
  }
LABEL_18:
  compatibilityLabel = (UILabel_o *)this->fields.dispLabelRoot;
  if ( !compatibilityLabel )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A021D5 & 1) == 0 )
  {
    sub_1B64870(&AtlasManager_TypeInfo, *(_QWORD *)&compatibilityPercent);
    sub_1B64870(&int_TypeInfo, v11);
    sub_1B64870(&LocalizationManager_TypeInfo, v12);
    sub_1B64870(&StringLiteral_20121/*"icon_{0}"*/, v13);
    sub_1B64870(&StringLiteral_5739/*"EXPEDITION_CONFIRM_DIALOG_COMPATIBILITY"*/, v14);
    sub_1B64870(&StringLiteral_5743/*"EXPEDITION_CONFIRM_DIALOG_ON_AN_EXPEDITION"*/, v15);
    sub_1B64870(&StringLiteral_15871/*"[FFFF00]{0}[-]"*/, v16);
    sub_1B64870(&StringLiteral_5744/*"EXPEDITION_CONFIRM_DIALOG_TIME_REQUIRED"*/, v17);
    byte_4A021D5 = 1;
  }
  if ( v9 >= 1 )
  {
    ...
    if ( !compatibilityLabel )
LABEL_35:
      sub_1B64ACC(onAnExpedition, *(_QWORD *)&compatibilityPercent);
  ...
  *(_QWORD *)&compatibilityPercent = onAnExpedition;
  ...
  if ( ((unsigned __int8)onAnExpedition & 1) != 0 )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_37549072(eventId, icon, v39, 0LL);
  }
  this->fields.onClickPanel = callback;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.onClickPanel, (int32_t)callback, v33, v34);
}
