void __fastcall viewDogIcon___ctor(viewDogIcon_o *this, const MethodInfo *method)
{
  if ( (byte_4B16942 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_20224/*"img_frameselect"*/, method);
    byte_4B16942 = 1;
  }
  this->fields.FRAME_SELECT_NAME = (struct System_String_o *)StringLiteral_20224/*"img_frameselect"*/;
  sub_1BCAF9C(&this->fields.FRAME_SELECT_NAME);
...
void __fastcall viewDogIcon__ClickNotReleased(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B16941 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_viewDogIcon_ClickNotReleased__, method);
    byte_4B16941 = 1;
  }
  v2 = Method_viewDogIcon_ClickNotReleased__;
  if ( (*((_BYTE *)Method_viewDogIcon_ClickNotReleased__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1BCB010(Method_viewDogIcon_ClickNotReleased__);
...
void __fastcall viewDogIcon__ClickPanel(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B16940 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_viewDogIcon_ClickPanel__, method);
    byte_4B16940 = 1;
  }
  ...
  {
    sub_1BCB254(selectSprite, method);
  }
  ...
  if ( (*((_BYTE *)Method_viewDogIcon_ClickPanel__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BCB010(Method_viewDogIcon_ClickPanel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1693F & 1) == 0 )
  {
    sub_1BCAFF8(&long_TypeInfo, time);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v4);
    sub_1BCAFF8(&StringLiteral_5771/*"EXPEDITION_TIME_FORMAT"*/, v5);
    byte_4B1693F = 1;
  }
  if ( time < 1 )
  {
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5771/*"EXPEDITION_TIME_FORMAT"*/, 0LL);
  v25 = v8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1693D & 1) == 0 )
  {
    sub_1BCAFF8(&AtlasManager_TypeInfo, eventExpeditionPieceEntity);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v5);
  ...
  *(_WORD *)&this->fields._IsSelect_k__BackingField = 0;
  compatibilityLabel = (UILabel_o *)sub_1BCAF9C(&this->fields.onClickPanel);
  ...
  AtlasManager__SetEventUI_39794720(eventId, selectSprite, FRAME_SELECT_NAME, 0LL);
  ...
  sub_1BCAF9C(&this->fields._EventExpeditionPieceEntity_k__BackingField);
  if ( eventExpeditionPieceEntity->fields.commonReleaseId )
  {
    compatibilityLabel = (UILabel_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( compatibilityLabel )
    {
...
LABEL_31:
    sub_1BCB254(compatibilityLabel, eventExpeditionPieceEntity);
  }
LABEL_18:
  compatibilityLabel = (UILabel_o *)this->fields.dispLabelRoot;
  if ( !compatibilityLabel )
  ...
  v12 = 0;
LABEL_30:
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)compatibilityLabel, v12, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1693E & 1) == 0 )
  {
    sub_1BCAFF8(&AtlasManager_TypeInfo, *(_QWORD *)&compatibilityPercent);
    sub_1BCAFF8(&int_TypeInfo, v11);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v12);
    sub_1BCAFF8(&StringLiteral_20071/*"icon_{0}"*/, v13);
    sub_1BCAFF8(&StringLiteral_5753/*"EXPEDITION_CONFIRM_DIALOG_COMPATIBILITY"*/, v14);
    sub_1BCAFF8(&StringLiteral_5757/*"EXPEDITION_CONFIRM_DIALOG_ON_AN_EXPEDITION"*/, v15);
    sub_1BCAFF8(&StringLiteral_15794/*"[FFFF00]{0}[-]"*/, v16);
    sub_1BCAFF8(&StringLiteral_5758/*"EXPEDITION_CONFIRM_DIALOG_TIME_REQUIRED"*/, v17);
    byte_4B1693E = 1;
  }
  if ( v9 >= 1 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5753/*"EXPEDITION_CONFIRM_DIALOG_COMPATIBILITY"*/, 0LL);
    v41 = v9;
    v23 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v41, v20, v21, v22);
    onAnExpedition = System_String__Format(v19, v23, 0LL);
    if ( !compatibilityLabel )
LABEL_35:
      sub_1BCB254(onAnExpedition, *(_QWORD *)&compatibilityPercent);
  ...
  if ( this->fields._IsDoingTheExpedition_k__BackingField )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    onAnExpedition = LocalizationManager__Get((System_String_o *)StringLiteral_5757/*"EXPEDITION_CONFIRM_DIALOG_ON_AN_EXPEDITION"*/, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  onAnExpedition = LocalizationManager__Get((System_String_o *)StringLiteral_5758/*"EXPEDITION_CONFIRM_DIALOG_TIME_REQUIRED"*/, 0LL);
  ...
  *(_QWORD *)&compatibilityPercent = onAnExpedition;
  if ( v9 >= 1 )
  {
    onAnExpedition = System_String__Format((System_String_o *)StringLiteral_15794/*"[FFFF00]{0}[-]"*/, (Il2CppObject *)onAnExpedition, 0LL);
    *(_QWORD *)&compatibilityPercent = onAnExpedition;
  }
  ...
  if ( ((unsigned __int8)onAnExpedition & 1) != 0 )
  {
    ...
    v39 = System_String__Format((System_String_o *)StringLiteral_20071/*"icon_{0}"*/, v38, 0LL);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_39794720(eventId, icon, v39, 0LL);
  }
  this->fields.onClickPanel = callback;
  sub_1BCAF9C(&this->fields.onClickPanel);
}
