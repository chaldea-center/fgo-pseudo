void __fastcall viewDogIcon___ctor(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AEBE5 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_19640/*"img_frameselect"*/);
    byte_42AEBE5 = 1;
  }
  v9 = (System_Int32_array **)StringLiteral_19640/*"img_frameselect"*/;
  this->fields.FRAME_SELECT_NAME = (struct System_String_o *)StringLiteral_19640/*"img_frameselect"*/;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.FRAME_SELECT_NAME, v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall viewDogIcon__ClickPanel(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52A5C(selectSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v9; // x21
  Il2CppObject *v10; // x0
  unsigned __int64 v12; // [xsp+0h] [xbp-40h] BYREF
  unsigned __int64 v13; // [xsp+8h] [xbp-38h] BYREF
  ...
  if ( (byte_42AEBE2 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5831/*"EXPEDITION_TIME_FORMAT"*/);
    byte_42AEBE2 = 1;
  }
  if ( time < 1 )
  {
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_5831/*"EXPEDITION_TIME_FORMAT"*/, 0LL);
  v14 = v6;
        ...
        const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields._IsSelect_k__BackingField = 0;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.onClickPanel, 0LL, v6, v7, v8, v9, v10, v11);
  ...
  AtlasManager__SetEventUI_28377220(eventId, selectSprite, FRAME_SELECT_NAME, 0LL);
  ...
  {
    compatibilityLabel = (UILabel_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( compatibilityLabel )
    {
...
LABEL_32:
    sub_B52A5C(compatibilityLabel, eventExpeditionPieceEntity);
  }
LABEL_19:
  compatibilityLabel = (UILabel_o *)this->fields.dispLabelRoot;
  if ( !compatibilityLabel )
        ...
        const MethodInfo *method)
{
  ...
  struct EventExpeditionPieceEntity_o *v43; // x8
  UISprite_o *icon; // x22
  Il2CppObject *v45; // x0
  ...
  if ( (byte_42AEBE1 & 1) == 0 )
  {
    ...
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&StringLiteral_19525/*"icon_{0}"*/);
    sub_B52984(&StringLiteral_5813/*"EXPEDITION_CONFIRM_DIALOG_COMPATIBILITY"*/);
    sub_B52984(&StringLiteral_5817/*"EXPEDITION_CONFIRM_DIALOG_ON_AN_EXPEDITION"*/);
    sub_B52984(&StringLiteral_15849/*"[FFFF00]{0}[-]"*/);
    sub_B52984(&StringLiteral_5818/*"EXPEDITION_CONFIRM_DIALOG_TIME_REQUIRED"*/);
    byte_42AEBE1 = 1;
  }
  if ( compatibilityPercent >= 1 )
  {
    ...
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_5813/*"EXPEDITION_CONFIRM_DIALOG_COMPATIBILITY"*/, 0LL);
    v48 = compatibilityPercent;
    v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v48);
    onAnExpedition = System_String__Format(v12, v13, 0LL);
    if ( !compatibilityLabel )
LABEL_38:
      sub_B52A5C(onAnExpedition, v15);
  ...
  if ( this->fields._IsDoingTheExpedition_k__BackingField )
  {
    ...
    onAnExpedition = LocalizationManager__Get((System_String_o *)StringLiteral_5817/*"EXPEDITION_CONFIRM_DIALOG_ON_AN_EXPEDITION"*/, 0LL);
    ...
    v17 = (UIWidget_o *)this->fields.compatibilityLabel;
  ...
  {
    v27 = (UIWidget_o *)this->fields.compatibilityLabel;
  ...
  UIWidget__set_color(nameLabel, *(UnityEngine_Color_o *)&v23, 0LL);
  ...
  onAnExpedition = LocalizationManager__Get((System_String_o *)StringLiteral_5818/*"EXPEDITION_CONFIRM_DIALOG_TIME_REQUIRED"*/, 0LL);
  ...
  onAnExpedition = viewDogIcon__GetExpeditionTimeLabel(v34, timeRequiredNum, v35);
  v15 = onAnExpedition;
  if ( compatibilityPercent >= 1 )
  {
    onAnExpedition = System_String__Format((System_String_o *)StringLiteral_15849/*"[FFFF00]{0}[-]"*/, (Il2CppObject *)onAnExpedition, 0LL);
    v15 = onAnExpedition;
  }
  if ( !timeRequiredNumLabel )
    goto LABEL_38;
  UILabel__set_text(timeRequiredNumLabel, v15, 0LL);
  ...
  {
    v43 = this->fields._EventExpeditionPieceEntity_k__BackingField;
    if ( !v43 )
      goto LABEL_38;
    icon = this->fields.icon;
    iconImageId = v43->fields.iconImageId;
    v45 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &iconImageId);
    v46 = System_String__Format((System_String_o *)StringLiteral_19525/*"icon_{0}"*/, v45, 0LL);
    if ( (BYTE3(AtlasManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !AtlasManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    }
    AtlasManager__SetEventUI_28377220(eventId, icon, v46, 0LL);
  }
