void __fastcall viewDogIcon___ctor(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48D34 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_20421/*"img_frameselect"*/, method);
    byte_4B48D34 = 1;
  }
  v5 = StringLiteral_20421/*"img_frameselect"*/;
  this->fields.FRAME_SELECT_NAME = (struct System_String_o *)StringLiteral_20421/*"img_frameselect"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.FRAME_SELECT_NAME, v5, v2, v3);
...
void __fastcall viewDogIcon__ClickNotReleased(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48D33 & 1) == 0 )
  {
    sub_1BDB878(&Method_viewDogIcon_ClickNotReleased__, method);
    byte_4B48D33 = 1;
  }
  v2 = Method_viewDogIcon_ClickNotReleased__;
  if ( (*((_BYTE *)Method_viewDogIcon_ClickNotReleased__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1BDB890(Method_viewDogIcon_ClickNotReleased__);
...
void __fastcall viewDogIcon__ClickPanel(viewDogIcon_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48D32 & 1) == 0 )
  {
    sub_1BDB878(&Method_viewDogIcon_ClickPanel__, method);
    byte_4B48D32 = 1;
  }
  ...
  {
    sub_1BDBAD4(selectSprite, method);
  }
  ...
  if ( (*((_BYTE *)Method_viewDogIcon_ClickPanel__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BDB890(Method_viewDogIcon_ClickPanel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48D31 & 1) == 0 )
  {
    sub_1BDB878(&long_TypeInfo, time);
    sub_1BDB878(&LocalizationManager_TypeInfo, v4);
    sub_1BDB878(&StringLiteral_5831/*"EXPEDITION_TIME_FORMAT"*/, v5);
    byte_4B48D31 = 1;
  }
  if ( time < 1 )
  {
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5831/*"EXPEDITION_TIME_FORMAT"*/, 0LL);
  v25 = v8;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48D2F & 1) == 0 )
  {
    sub_1BDB878(&AtlasManager_TypeInfo, eventExpeditionPieceEntity);
    sub_1BDB878(&Method_DataManager_GetMasterData_CommonReleaseMaster___, v5);
  ...
  *(_WORD *)&this->fields._IsSelect_k__BackingField = 0;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickPanel, 0, v9, v10);
  ...
  AtlasManager__SetEventUI_39626228(eventId, selectSprite, FRAME_SELECT_NAME, 0LL);
  ...
  sub_1BDB81C(
    (CGThumbnailListItem_o *)&this->fields._EventExpeditionPieceEntity_k__BackingField,
    (int32_t)eventExpeditionPieceEntity,
    v14,
    v15);
  if ( eventExpeditionPieceEntity->fields.commonReleaseId )
  {
    compatibilityLabel = (UILabel_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( compatibilityLabel )
    {
...
LABEL_31:
    sub_1BDBAD4(compatibilityLabel, eventExpeditionPieceEntity);
  }
LABEL_18:
  compatibilityLabel = (UILabel_o *)this->fields.dispLabelRoot;
  if ( !compatibilityLabel )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48D30 & 1) == 0 )
  {
    sub_1BDB878(&AtlasManager_TypeInfo, *(_QWORD *)&compatibilityPercent);
    sub_1BDB878(&int_TypeInfo, v11);
    sub_1BDB878(&LocalizationManager_TypeInfo, v12);
    sub_1BDB878(&StringLiteral_20269/*"icon_{0}"*/, v13);
    sub_1BDB878(&StringLiteral_5813/*"EXPEDITION_CONFIRM_DIALOG_COMPATIBILITY"*/, v14);
    sub_1BDB878(&StringLiteral_5817/*"EXPEDITION_CONFIRM_DIALOG_ON_AN_EXPEDITION"*/, v15);
    sub_1BDB878(&StringLiteral_15907/*"[FFFF00]{0}[-]"*/, v16);
    sub_1BDB878(&StringLiteral_5818/*"EXPEDITION_CONFIRM_DIALOG_TIME_REQUIRED"*/, v17);
    byte_4B48D30 = 1;
  }
  if ( v9 >= 1 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5813/*"EXPEDITION_CONFIRM_DIALOG_COMPATIBILITY"*/, 0LL);
    v41 = v9;
    v23 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v41, v20, v21, v22);
    onAnExpedition = System_String__Format(v19, v23, 0LL);
    if ( !compatibilityLabel )
LABEL_35:
      sub_1BDBAD4(onAnExpedition, *(_QWORD *)&compatibilityPercent);
  ...
  *(_QWORD *)&compatibilityPercent = onAnExpedition;
  if ( v9 >= 1 )
  {
    onAnExpedition = System_String__Format((System_String_o *)StringLiteral_15907/*"[FFFF00]{0}[-]"*/, (Il2CppObject *)onAnExpedition, 0LL);
    *(_QWORD *)&compatibilityPercent = onAnExpedition;
  }
  ...
  if ( ((unsigned __int8)onAnExpedition & 1) != 0 )
  {
    ...
    v39 = System_String__Format((System_String_o *)StringLiteral_20269/*"icon_{0}"*/, v38, 0LL);
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI_39626228(eventId, icon, v39, 0LL);
  }
  this->fields.onClickPanel = callback;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onClickPanel, (int32_t)callback, v33, v34);
}
