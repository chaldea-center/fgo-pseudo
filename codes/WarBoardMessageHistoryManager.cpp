void __fastcall WarBoardMessageHistoryManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_40F8571 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_6604/*"Fgo_20220427"*/, v10);
    byte_40F8571 = 1;
  }
  static_fields = (BattleServantConfConponent_o *)WarBoardMessageHistoryManager_TypeInfo->static_fields;
  v12 = (System_Int32_array **)StringLiteral_6604/*"Fgo_20220427"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_6604/*"Fgo_20220427"*/;
