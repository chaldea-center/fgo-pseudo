void WarBoardMessageHistoryManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C38E8B & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo___ctor__);
    sub_1C32C20(&System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
    sub_1C32C20(&WarBoardMessageHistoryManager_TypeInfo);
    sub_1C32C20(&StringLiteral_6684/*"Fgo_20220427"*/);
    byte_4C38E8B = 1;
  }
  WarBoardMessageHistoryManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6684/*"Fgo_20220427"*/;
  sub_1C32BC4(
    (CGThumbnailListItem_o *)WarBoardMessageHistoryManager_TypeInfo->static_fields,
    StringLiteral_6684/*"Fgo_20220427"*/,
    v1,
    v2);
  *(_WORD *)&WarBoardMessageHistoryManager_TypeInfo->static_fields->isModfiy = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_3797F88 *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo___ctor__);
...
void WarBoardMessageHistoryManager__ClearSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4C38E86 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Linq_Enumerable_Any_WarBoardMessageHistoryManager_HistoryInfo___);
    sub_1C32C20(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Clear__);
    sub_1C32C20(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4C38E86 = 1;
  }
  ...
  if ( System_Linq_Enumerable__Any_object_(
         ...
         (const MethodInfo_30E8F68 *)Method_System_Linq_Enumerable_Any_WarBoardMessageHistoryManager_HistoryInfo___) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38E87 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__);
    sub_1C32C20(&System_Predicate_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
    sub_1C32C20(&Method_WarBoardMessageHistoryManager___c__DisplayClass9_0__IsHistory_b__0__);
    sub_1C32C20(&WarBoardMessageHistoryManager___c__DisplayClass9_0_TypeInfo);
    sub_1C32C20(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4C38E87 = 1;
  }
  v7 = sub_1C32E6C(WarBoardMessageHistoryManager___c__DisplayClass9_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 24) = idx;
  ...
  v11 = (System_Predicate_object__o *)sub_1C32E6C(System_Predicate_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
...
LABEL_8:
  ...
  return System_Collections_Generic_List_object___Find(
           ...
           (const MethodInfo_3798E24 *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__) != 0;
}
...
bool WarBoardMessageHistoryManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4C38E89 & 1) == 0 )
  {
    ...
    sub_1C32C20(&WarBoardMessageHistoryManager_HistoryInfo_TypeInfo);
    sub_1C32C20(&System_IDisposable_TypeInfo);
    sub_1C32C20(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Add__);
    ...
    if ( v14 >= 1 )
    {
      do
      {
        ...
        v17 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, const MethodInfo *))v7->klass->vtable._15_ReadInt32.methodPtr)(
                v7,
                v7->klass->vtable._15_ReadInt32.method);
        v18 = sub_1C32E6C(WarBoardMessageHistoryManager_HistoryInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38E88 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__);
    sub_1C32C20(&System_Predicate_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
    sub_1C32C20(&Method_WarBoardMessageHistoryManager___c__DisplayClass10_0__SaveHistory_b__0__);
    sub_1C32C20(&WarBoardMessageHistoryManager___c__DisplayClass10_0_TypeInfo);
    sub_1C32C20(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4C38E88 = 1;
  }
  v7 = sub_1C32E6C(WarBoardMessageHistoryManager___c__DisplayClass10_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0);
  if ( !v7 )
    goto LABEL_18;
  *(_DWORD *)(v7 + 16) = stageId;
  ...
  *(_DWORD *)(v7 + 24) = idx;
  ...
  if ( System_Collections_Generic_List_object___Find(
         infoList,
         (System_Predicate_T__o *)v11,
         (const MethodInfo_3798E24 *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__) )
  {
    return;
  }
  v12 = sub_1C32E6C(WarBoardMessageHistoryManager_HistoryInfo_TypeInfo);
...
bool WarBoardMessageHistoryManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4C38E8A & 1) == 0 )
  {
    ...
    sub_1C32C20(&System_IDisposable_TypeInfo);
    sub_1C32C20(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__get_Count__);
    sub_1C32C20(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__get_Item__);
    sub_1C32C20(&ManagerConfig_TypeInfo);
    sub_1C32C20(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4C38E8A = 1;
  }
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               v14,
               i,
               (const MethodInfo_37984EC *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__get_Item__);
      v16 = Item;
      if ( !Item )
        sub_1C32E7C(0);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, const MethodInfo *))v7->klass->vtable._17_Write.methodPtr)(
