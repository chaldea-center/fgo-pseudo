void __fastcall WarBoardMessageHistoryManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C405 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo___ctor__);
    sub_1B885B0(&System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
    sub_1B885B0(&WarBoardMessageHistoryManager_TypeInfo);
    sub_1B885B0(&StringLiteral_6649/*"Fgo_20220427"*/);
    byte_4A5C405 = 1;
  }
  WarBoardMessageHistoryManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6649/*"Fgo_20220427"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)WarBoardMessageHistoryManager_TypeInfo->static_fields,
    StringLiteral_6649/*"Fgo_20220427"*/,
    v1,
    v2);
  *(_WORD *)&WarBoardMessageHistoryManager_TypeInfo->static_fields->isModfiy = 0;
  v3 = (System_Collections_Generic_List_object__o *)sub_1B887FC(System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_34FD000 *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo___ctor__);
...
void __fastcall WarBoardMessageHistoryManager__ClearSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C400 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Linq_Enumerable_Any_WarBoardMessageHistoryManager_HistoryInfo___);
    sub_1B885B0(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Clear__);
    sub_1B885B0(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4A5C400 = 1;
  }
  ...
  if ( System_Linq_Enumerable__Any_object_(
         ...
         (const MethodInfo_2E8D2DC *)Method_System_Linq_Enumerable_Any_WarBoardMessageHistoryManager_HistoryInfo___) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C401 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__);
    sub_1B885B0(&System_Predicate_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
    sub_1B885B0(&Method_WarBoardMessageHistoryManager___c__DisplayClass9_0__IsHistory_b__0__);
    sub_1B885B0(&WarBoardMessageHistoryManager___c__DisplayClass9_0_TypeInfo);
    sub_1B885B0(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4A5C401 = 1;
  }
  v7 = sub_1B887FC(WarBoardMessageHistoryManager___c__DisplayClass9_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 24) = idx;
  ...
  v12 = (System_Predicate_object__o *)sub_1B887FC(System_Predicate_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
...
LABEL_8:
  ...
  return System_Collections_Generic_List_object___Find(
           ...
           (const MethodInfo_34FDE9C *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__) != 0LL;
}
...
bool __fastcall WarBoardMessageHistoryManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C403 & 1) == 0 )
  {
    ...
    sub_1B885B0(&WarBoardMessageHistoryManager_HistoryInfo_TypeInfo);
    sub_1B885B0(&System_IDisposable_TypeInfo);
    sub_1B885B0(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Add__);
    ...
    if ( v15 >= 1 )
    {
      do
      {
        ...
        v18 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v7->klass->vtable._15_ReadInt32.method)(
                v7,
                v7->klass->vtable._16_ReadUInt32.methodPtr);
        v19 = sub_1B887FC(WarBoardMessageHistoryManager_HistoryInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C402 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__);
    sub_1B885B0(&System_Predicate_WarBoardMessageHistoryManager_HistoryInfo__TypeInfo);
    sub_1B885B0(&Method_WarBoardMessageHistoryManager___c__DisplayClass10_0__SaveHistory_b__0__);
    sub_1B885B0(&WarBoardMessageHistoryManager___c__DisplayClass10_0_TypeInfo);
    sub_1B885B0(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4A5C402 = 1;
  }
  v7 = sub_1B887FC(WarBoardMessageHistoryManager___c__DisplayClass10_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  if ( !v7 )
    goto LABEL_18;
  *(_DWORD *)(v7 + 16) = stageId;
  ...
  *(_DWORD *)(v7 + 24) = idx;
  ...
  if ( System_Collections_Generic_List_object___Find(
         infoList,
         (System_Predicate_T__o *)v12,
         (const MethodInfo_34FDE9C *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__Find__) )
  {
    return;
  }
  v13 = sub_1B887FC(WarBoardMessageHistoryManager_HistoryInfo_TypeInfo);
...
bool __fastcall WarBoardMessageHistoryManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C404 & 1) == 0 )
  {
    ...
    sub_1B885B0(&System_IDisposable_TypeInfo);
    sub_1B885B0(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__get_Count__);
    sub_1B885B0(&Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__get_Item__);
    sub_1B885B0(&ManagerConfig_TypeInfo);
    sub_1B885B0(&WarBoardMessageHistoryManager_TypeInfo);
    byte_4A5C404 = 1;
  }
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               v16,
               i,
               (const MethodInfo_34FD564 *)Method_System_Collections_Generic_List_WarBoardMessageHistoryManager_HistoryInfo__get_Item__);
      v19 = Item;
      if ( !Item )
        sub_1B8880C(0LL, v18);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v7->klass->vtable._17_Write.method)(
