        ...
        const MethodInfo *method)
{
  ...
  __int64 v40; // x10
  Il2CppClass **v41; // x0
  UIStandFigureR_o *RenderPrefab_41427348; // x0
...
LABEL_7:
  ...
  if ( !standFigureCollectList )
  {
    v20 = (System_Collections_Generic_List_object__o *)sub_1C942E4(System_Collections_Generic_List_StandFigureCollect__TypeInfo);
    ...
    *p_standFigureCollectList = (struct System_Collections_Generic_List_StandFigureCollect__o *)v20;
    sub_1C9403C(&this->fields.standFigureCollectList, v20);
  }
  ...
  {
    RenderPrefab_41427348 = StandFigureManager__CreateRenderPrefab_41427348(
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    sub_1C9403C(&PrefabForImageId->fields.svtMultiPortraitEntity, current);
