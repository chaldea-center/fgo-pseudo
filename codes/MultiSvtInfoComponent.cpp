        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73CB8 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_StandFigureCollect__Add__, v23);
    sub_1B90010(&Method_System_Collections_Generic_List_SvtMultiPortraitEntity__GetEnumerator__, v24);
    sub_1B90010(&Method_System_Collections_Generic_List_StandFigureCollect___ctor__, v25);
    sub_1B90010(&System_Collections_Generic_List_StandFigureCollect__TypeInfo, v26);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v27);
    sub_1B90010(&StandFigureCollect_TypeInfo, v28);
    byte_4A73CB8 = 1;
  }
  limitCount = 0;
...
LABEL_7:
  ...
  if ( !standFigureCollectList )
  {
    v31 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_StandFigureCollect__TypeInfo);
    ...
    *p_standFigureCollectList = (struct System_Collections_Generic_List_StandFigureCollect__o *)v31;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.standFigureCollectList, (int32_t)v31, v32, v33);
  }
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    v50 = (StandFigureCollect_o *)sub_1B9025C(StandFigureCollect_TypeInfo);
    ...
    else
    {
      ...
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v58 + 4), (int32_t)v50, v53, v54);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73CBA & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_Component_GetComponent_Collider___, isEnable);
    byte_4A73CBA = 1;
  }
