        ...
        const MethodInfo *method)
{
  ...
  __int64 v40; // x10
  Il2CppClass **v41; // x0
  UIStandFigureR_o *RenderPrefab_42036172; // x0
...
LABEL_7:
  ...
  if ( !standFigureCollectList )
  {
    ...
    *p_standFigureCollectList = (struct System_Collections_Generic_List_StandFigureCollect__o *)v20;
    sub_1D0F058(&this->fields.standFigureCollectList, v20);
  }
  ...
  {
    RenderPrefab_42036172 = StandFigureManager__CreateRenderPrefab_42036172(
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    sub_1D0F058(&PrefabForImageId->fields.svtMultiPortraitEntity, current);
    v34 = (System_Collections_Generic_List_object__o *)*p_standFigureCollectList;
    v35 = (StandFigureCollect_o *)sub_1D0F300(StandFigureCollect_TypeInfo);
