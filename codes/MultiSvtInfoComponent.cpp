...
LABEL_7:
  ...
  if ( !standFigureCollectList )
  {
    v20 = (System_Collections_Generic_List_object__o *)sub_1C93D20(System_Collections_Generic_List_StandFigureCollect__TypeInfo);
    ...
    *p_standFigureCollectList = (struct System_Collections_Generic_List_StandFigureCollect__o *)v20;
    sub_1C93A78(&this->fields.standFigureCollectList, v20);
  }
           ...
           (const MethodInfo_31B0714 *)Method_System_Linq_Enumerable_Any_SvtMultiPortraitEntity___)) )
  {
    ...
    v44 = RenderPrefab_41393712;
    v45 = (StandFigureCollect_o *)sub_1C93D20(StandFigureCollect_TypeInfo);
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    sub_1C93A78(&PrefabForImageId->fields.svtMultiPortraitEntity, current);
