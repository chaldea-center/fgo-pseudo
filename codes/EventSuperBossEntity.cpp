void __fastcall EventSuperBossEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C220D3 & 1) == 0 )
  {
    sub_1C3B764(&EventSuperBossEntity_TypeInfo, v1);
    sub_1C3B764(&StringLiteral_24649/*"{0} ({1})"*/, v8);
    sub_1C3B764(&StringLiteral_24646/*"{0}  Lv.{1}"*/, v9);
    sub_1C3B764(&StringLiteral_24645/*"{0} "*/, v10);
    sub_1C3B764(&StringLiteral_24647/*"{0} (0x{0:x4})"*/, v11);
    sub_1C3B764(&StringLiteral_24648/*"{0} (at {1}:{2})"*/, v12);
    byte_4C220D3 = 1;
  }
  EventSuperBossEntity_TypeInfo->static_fields->UI_START_QUEST_ID_KEY = (struct System_String_o *)StringLiteral_24648/*"{0} (at {1}:{2})"*/;
  sub_1C3B708(
    (PartyOrganizationUtility_o *)EventSuperBossEntity_TypeInfo->static_fields,
    StringLiteral_24648/*"{0} (at {1}:{2})"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v13 = StringLiteral_24649/*"{0} ({1})"*/;
  static_fields = EventSuperBossEntity_TypeInfo->static_fields;
  static_fields->UI_START_QUEST_PHASE_KEY = (struct System_String_o *)StringLiteral_24649/*"{0} ({1})"*/;
  sub_1C3B708((PartyOrganizationUtility_o *)&static_fields->UI_START_QUEST_PHASE_KEY, v13, v15, v16, v17, v18, v19, v20);
  v21 = StringLiteral_24645/*"{0} "*/;
  v22 = EventSuperBossEntity_TypeInfo->static_fields;
  v22->UI_END_QUEST_ID_KEY = (struct System_String_o *)StringLiteral_24645/*"{0} "*/;
  sub_1C3B708((PartyOrganizationUtility_o *)&v22->UI_END_QUEST_ID_KEY, v21, v23, v24, v25, v26, v27, v28);
  v29 = StringLiteral_24646/*"{0}  Lv.{1}"*/;
  v30 = EventSuperBossEntity_TypeInfo->static_fields;
  v30->UI_END_QUEST_PHASE_KEY = (struct System_String_o *)StringLiteral_24646/*"{0}  Lv.{1}"*/;
  sub_1C3B708((PartyOrganizationUtility_o *)&v30->UI_END_QUEST_PHASE_KEY, v29, v31, v32, v33, v34, v35, v36);
  v37 = StringLiteral_24647/*"{0} (0x{0:x4})"*/;
  v38 = EventSuperBossEntity_TypeInfo->static_fields;
  v38->UI_HIDDEN = (struct System_String_o *)StringLiteral_24647/*"{0} (0x{0:x4})"*/;
  sub_1C3B708((PartyOrganizationUtility_o *)&v38->UI_HIDDEN, v37, v39, v40, v41, v42, v43, v44);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C220CB & 1) == 0 )
  {
    sub_1C3B764(&EventSuperBossEntity_TypeInfo, method);
    byte_4C220CB = 1;
  }
...
int32_t __fastcall EventSuperBossEntity__DamageProgressNum(EventSuperBossEntity_o *this, const MethodInfo *method)
{
  ...
  if ( UserSuperBossEntity )
  {
    ...
    if ( !splitHp )
      sub_1C3B9C0(UserSuperBossEntity, v4);
    ...
    else
    {
      ...
      do
      {
        if ( (unsigned int)UserSuperBossEntity >= max_length )
          sub_1C3B9C8(UserSuperBossEntity, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C220D1 & 1) == 0 )
  {
    ...
    sub_1C3B764(&long___TypeInfo, v5);
    sub_1C3B764(&Method_System_Collections_Generic_List_object__get_Count__, v6);
    sub_1C3B764(&Method_System_Collections_Generic_List_object__get_Item__, v7);
    sub_1C3B764(&System_Collections_Generic_List_object__TypeInfo, v8);
    sub_1C3B764(&StringLiteral_17776/*"combineAnimation"*/, v9);
    byte_4C220D1 = 1;
  }
  ...
  if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
         ...
         (Il2CppObject *)StringLiteral_17776/*"combineAnimation"*/,
         (const MethodInfo_335595C *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
  {
    ...
    if ( (int)v13 >= 1 )
    {
      v14 = (System_Int64_array *)sub_1C3B80C(long___TypeInfo, (unsigned int)v13);
      v15 = 0LL;
      while ( 1 )
      {
...
LABEL_21:
      sub_1C3B9C0(script, method);
    }
  }
  script = sub_1C3B80C(long___TypeInfo, 1LL);
  if ( !script )
    goto LABEL_21;
  v14 = (System_Int64_array *)script;
  if ( !*(_DWORD *)(script + 24) )
LABEL_22:
    sub_1C3B9C8(script, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C220CD & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_UserSuperBossMaster___, method);
    sub_1C3B764(&DataManager_TypeInfo, v3);
    sub_1C3B764(&NetworkManager_TypeInfo, v4);
    sub_1C3B764(&UserSuperBossEntity_TypeInfo, v5);
    byte_4C220CD = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_UserSuperBossMaster___);
  ...
  v9 = (UserSuperBossEntity_o *)sub_1C3B9B0(UserSuperBossEntity_TypeInfo);
...
bool __fastcall EventSuperBossEntity__InUIDisplayPeriod(EventSuperBossEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C220CF & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, v3);
    sub_1C3B764(&Method_System_Collections_Generic_Dictionary_string__object__get_Item__, v4);
    sub_1C3B764(&EventSuperBossEntity_TypeInfo, v5);
...
bool __fastcall EventSuperBossEntity__IsEncounted(EventSuperBossEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C220CE & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_UserQuestMaster___, method);
    sub_1C3B764(&DataManager_TypeInfo, v3);
    sub_1C3B764(&EventSuperBossMaster_TypeInfo, v4);
  ...
  if ( EventSuperBossEntity__InUIDisplayPeriod(this, method) )
  {
    for ( i = 0; ; ++i )
    {
      ...
      v19 = System_String__Format_63382984(SAVE_KEY, v14, v18, 0LL);
        ...
        if ( Master_object )
        {
          if ( UserQuestMaster__getChallengeCountsFromId(
                 ...
                 *(_QWORD *)&Int[5].fields.cQuestReleaseListP[1].fields._size,
                 ...
                 0LL) > 0 )
            return 1;
          Int = (clsQuestCheck_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38C8B54 *)Method_SingletonTemplate_clsQuestCheck__get_Instance__);
...
bool __fastcall EventSuperBossEntity__IsHidden(EventSuperBossEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C220D0 & 1) == 0 )
  {
    ...
    sub_1C3B764(&EventSuperBossEntity_TypeInfo, v4);
