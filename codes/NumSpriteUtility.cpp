    ...
    if ( (int)v11 >= 1 )
    {
      ...
      while ( v12 < LODWORD(sprites->max_length) )
      {
        ...
        if ( ((unsigned __int8)v11 & 1) == 0 )
        {
          ...
          if ( (__int64)v12 <= v14 )
          {
            DigitNumber = NumSpriteUtility__GetDigitNumber(number, v13, v18);
            v21 = System_Int64__ToString((int64_t)&DigitNumber, 0);
            v11 = System_String__Concat_64031724(baseName, v21, 0);
            if ( !setSprite )
              goto LABEL_25;
          ...
          else if ( padding0 )
          {
            ...
            v11 = System_String__Concat_64031724(baseName, v20, 0);
            if ( !setSprite )
              goto LABEL_25;
