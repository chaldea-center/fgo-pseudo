...
int64_t __fastcall NumSpriteUtility__GetDigitNumber(int64_t number, int64_t digit, const MethodInfo *method)
{
  ...
  if ( (byte_4BB0D21 & 1) == 0 )
  {
    sub_1C13D24(&System_Math_TypeInfo, digit);
    byte_4BB0D21 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0D1F & 1) == 0 )
  {
    sub_1C13D24(&Method_System_Linq_Enumerable_Count_UISprite___, sprites);
  ...
  if ( sprites )
  {
    ...
    if ( (int)v13 >= 1 )
    {
      ...
      while ( v15 < sprites->max_length )
      {
        ...
        v13 = (System_String_o *)UnityEngine_Object__op_Equality(v19, 0LL, 0LL);
        if ( ((unsigned __int8)v13 & 1) == 0 )
        {
          ...
          if ( (__int64)v15 <= v17 )
          {
            ...
            v13 = System_String__Concat_62967944(baseName, v23, 0LL);
            if ( !setSprite )
              goto LABEL_25;
            ...
            if ( v15 >= sprites->max_length )
              break;
            v13 = (System_String_o *)m_Items[v15];
            if ( !v13 )
              goto LABEL_25;
          ...
          else if ( padding0 )
          {
            ...
            v13 = System_String__Concat_62967944(baseName, v22, 0LL);
            if ( !setSprite )
              goto LABEL_25;
