void __fastcall HeelPortraitMaster___ctor(HeelPortraitMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A5B454 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int___ctor__);
    byte_4A5B454 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    455,
    (const MethodInfo_311D8F4 *)Method_DataMasterBase_HeelPortraitMaster__HeelPortraitEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B453 & 1) == 0 )
  {
    sub_1B885B0(&System_Converter_DataEntityBase__HeelPortraitEntity__TypeInfo);
    sub_1B885B0(&Method_System_Linq_Enumerable_Count_HeelPortraitEntity___);
    sub_1B885B0(&Method_System_Linq_Enumerable_Where_HeelPortraitEntity___);
    sub_1B885B0(&System_Func_HeelPortraitEntity__bool__TypeInfo);
    sub_1B885B0(&Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__HeelPortraitEntity___);
    sub_1B885B0(&Method_HeelPortraitMaster___c__GetCompleteNum_b__1_0__);
    sub_1B885B0(&Method_HeelPortraitMaster___c__DisplayClass1_0__GetCompleteNum_b__1__);
    sub_1B885B0(&HeelPortraitMaster___c__DisplayClass1_0_TypeInfo);
    sub_1B885B0(&HeelPortraitMaster___c_TypeInfo);
    byte_4A5B453 = 1;
  }
  v5 = sub_1B887FC(HeelPortraitMaster___c__DisplayClass1_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = eventId;
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Converter_TInput__TOutput__o *)sub_1B887FC(System_Converter_DataEntityBase__HeelPortraitEntity__TypeInfo);
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__1_0, (int32_t)_9__1_0, v13, v14);
  }
  v15 = ObservableCollectionExtensions__ConvertAll_object__object_(
          list,
          (System_Converter_T__TOutput__o *)_9__1_0,
          (const MethodInfo_2F042F8 *)Method_ObservableCollectionExtensions_ConvertAll_DataEntityBase__HeelPortraitEntity___);
  v16 = (System_Func_object__bool__o *)sub_1B887FC(System_Func_HeelPortraitEntity__bool__TypeInfo);
  ...
  v17 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_2EBE07C *)Method_System_Linq_Enumerable_Where_HeelPortraitEntity___);
  return System_Linq_Enumerable__Count_object_(
           v17,
           (const MethodInfo_2E9CA20 *)Method_System_Linq_Enumerable_Count_HeelPortraitEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B452 & 1) == 0 )
  {
    ...
    sub_1B885B0(&HeelPortraitEntity_TypeInfo);
    sub_1B885B0(&System_IDisposable_TypeInfo);
    sub_1B885B0(&System_Collections_Generic_IEnumerator_DataEntityBase__TypeInfo);
    sub_1B885B0(&System_Collections_IEnumerator_TypeInfo);
    sub_1B885B0(&Method_System_Collections_Generic_List_HeelPortraitEntity__Add__);
    sub_1B885B0(&Method_System_Collections_Generic_List_HeelPortraitEntity___ctor__);
    sub_1B885B0(&System_Collections_Generic_List_HeelPortraitEntity__TypeInfo);
    byte_4A5B452 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1B887FC(System_Collections_Generic_List_HeelPortraitEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_34FD000 *)Method_System_Collections_Generic_List_HeelPortraitEntity___ctor__);
...
LABEL_16:
    ...
    if ( !v18
      || (methodPtr_low = LOBYTE(HeelPortraitEntity_TypeInfo->vtable._0_Equals.methodPtr),
          LOBYTE(v18->klass->vtable[0].methodPtr) < (unsigned int)methodPtr_low)
      || (HeelPortraitEntity_c *)v18->klass->_2.typeHierarchy[methodPtr_low - 1] != HeelPortraitEntity_TypeInfo )
    {
      sub_1B8880C(v18, v19);
    }
    if ( HIDWORD(v18[2].klass) == eventId )
    {
      ...
      if ( IsOpen )
      {
        ...
        v30 = Method_System_Collections_Generic_List_HeelPortraitEntity__Add__;
        ++v5->fields._version;
        if ( !items )
          sub_1B8880C(IsOpen, v26);
        ...
        else
        {
          ...
          sub_1B88554((ServantStatusBattleListViewItem_o *)(v32 + 4), (int32_t)v20, v27, v28);
        }
      }
    }
  }
...
void __fastcall HeelPortraitMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(HeelPortraitMaster___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  HeelPortraitMaster___c_TypeInfo->static_fields->__9 = (struct HeelPortraitMaster___c_o *)v1;
  sub_1B88554((ServantStatusBattleListViewItem_o *)HeelPortraitMaster___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
