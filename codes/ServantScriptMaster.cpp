void __fastcall ServantScriptMaster___ctor(ServantScriptMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FF30A & 1) == 0 )
  {
    sub_1B64A00(&Method_DataMasterBase_ServantScriptMaster__ServantScriptEntity__string___ctor__, method);
    byte_49FF30A = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    10,
    (const MethodInfo_30D6AB0 *)Method_DataMasterBase_ServantScriptMaster__ServantScriptEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF307 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataMasterBase_ServantScriptMaster__ServantScriptEntity__string__GetEntity__, *(_QWORD *)&id);
    sub_1B64A00(&ServantScriptEntity_TypeInfo, v7);
    byte_49FF307 = 1;
  }
  ...
  return (ServantScriptEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_30D6AF0 *)Method_DataMasterBase_ServantScriptMaster__ServantScriptEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF30B & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_System_Collections_Generic_List_ServantScriptEntity__Add__, v6);
    sub_1B64A00(&Method_System_Collections_Generic_List_ServantScriptEntity___ctor__, v7);
    sub_1B64A00(&System_Collections_Generic_List_ServantScriptEntity__TypeInfo, v8);
    sub_1B64A00(&ServantScriptEntity_TypeInfo, v9);
    byte_49FF30B = 1;
  }
  ...
  v12 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_ServantScriptEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_34AF794 *)Method_System_Collections_Generic_List_ServantScriptEntity___ctor__);
  if ( Count >= 1 )
  {
    v13 = 0;
    while ( 1 )
        ...
        *(_QWORD *)&id = list;
          ...
          && LODWORD(list->fields.items) == v3 )
        {
          ...
          else
          {
            ...
            sub_1B649A4((ServantStatusBattleListViewItem_o *)(v20 + 4), id, v14, v15);
          }
        }
      }
      if ( Count == ++v13 )
...
LABEL_30:
  ...
  {
LABEL_21:
    v21 = sub_1BB69E0(lookup, System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, 1LL);
  }
...
ServantScriptEntity_o *__fastcall ServantScriptMaster__GetEntity_39411344(
        ServantScriptMaster_o *this,
        int32_t id,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF308 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataMasterBase_ServantScriptMaster__ServantScriptEntity__string__TryGetEntity__, entity);
    sub_1B64A00(&ServantScriptEntity_TypeInfo, v9);
    byte_49FF308 = 1;
  }
  if ( !ServantScriptEntity_TypeInfo->_2.cctor_finished )
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D6B40 *)Method_DataMasterBase_ServantScriptMaster__ServantScriptEntity__string__TryGetEntity__);
}
...
int32_t __fastcall ServantScriptMaster__getId(int32_t svtId, int32_t imageLimitCount, const MethodInfo *method)
{
  ...
  if ( (byte_49FF309 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, *(_QWORD *)&imageLimitCount);
  ...
  v9 = System_String__Concat_61385136(v7, v8, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  float x; // s0
  float y; // s1
  UnityEngine_Vector2_o Offset_39412284; // kr00_8
  UnityEngine_Vector2_o result; // 0:s0.4,4:s1.4

  Offset_39412284 = ServantScriptMaster__getOffset_39412284(this, id, 0, offsetKind, v4);
  y = Offset_39412284.fields.y;
  x = Offset_39412284.fields.x;
  result.fields.y = y;
  result.fields.x = x;
  return result;
}
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_Vector2_o __fastcall ServantScriptMaster__getOffset_39412284(
        ServantScriptMaster_o *this,
        int32_t id,
        int32_t formId,
        int32_t offsetKind,
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF30D & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_ServantScriptAddMaster___, *(_QWORD *)&id);
    sub_1B64A00(&DataManager_TypeInfo, v9);
    sub_1B64A00(&Method_DataMasterBase_ServantScriptAddMaster__ServantScriptAddEntity__int__TryGetEntity__, v10);
    byte_49FF30D = 1;
  }
  entity = 0LL;
...
LABEL_20:
    sub_1B64C5C(EntityWithRetryFormId0, v12);
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  EntityWithRetryFormId0 = (ServantScriptEntity_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_ServantScriptAddMaster___);
  ...
  EntityWithRetryFormId0 = (ServantScriptEntity_o *)DataMasterBase_object__object__int___TryGetEntity(
                                                      ...
                                                      &entity,
                                                      id,
                                                      (const MethodInfo_30D67EC *)Method_DataMasterBase_ServantScriptAddMaster__ServantScriptAddEntity__int__TryGetEntity__);
