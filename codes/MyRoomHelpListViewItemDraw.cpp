        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD855 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_20258/*"img_menuboard_01"*/, v7);
    sub_1BC3008(&StringLiteral_1/*""*/, v8);
    sub_1BC3008(&StringLiteral_20406/*"img_tutorial_txtbg"*/, v9);
    byte_4AFD855 = 1;
  }
  if ( item )
  {
    ...
    if ( mode )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        if ( !infoTextLabel )
          goto LABEL_41;
        imageName = (System_String_o *)StringLiteral_20258/*"img_menuboard_01"*/;
