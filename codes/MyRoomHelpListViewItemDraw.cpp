        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB18C5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_20392/*"img_menuboard_01"*/, v7);
    sub_1BAB41C(&StringLiteral_1/*""*/, v8);
    sub_1BAB41C(&StringLiteral_20521/*"img_tutorial_txtbg"*/, v9);
    byte_4AB18C5 = 1;
  }
  if ( item )
  {
    ...
    if ( mode )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        if ( !infoTextLabel )
          goto LABEL_41;
        imageName = (System_String_o *)StringLiteral_20392/*"img_menuboard_01"*/;
