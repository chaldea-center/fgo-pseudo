        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BADF & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_20389/*"img_menuboard_01"*/, v7);
    sub_1B90010(&StringLiteral_1/*""*/, v8);
    sub_1B90010(&StringLiteral_20518/*"img_tutorial_txtbg"*/, v9);
    byte_4A6BADF = 1;
  }
  if ( item )
  {
    ...
    if ( mode )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        if ( !infoTextLabel )
          goto LABEL_41;
        imageName = (System_String_o *)StringLiteral_20389/*"img_menuboard_01"*/;
