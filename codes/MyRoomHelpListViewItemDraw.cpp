        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE728 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_20084/*"img_menuboard_01"*/, v7);
    sub_1B00CCC(&StringLiteral_1/*""*/, v8);
    sub_1B00CCC(&StringLiteral_20211/*"img_tutorial_txtbg"*/, v9);
    byte_48DE728 = 1;
  }
  if ( item )
  {
    ...
    if ( mode )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        if ( !infoTextLabel )
          goto LABEL_41;
        imageName = (System_String_o *)StringLiteral_20084/*"img_menuboard_01"*/;
