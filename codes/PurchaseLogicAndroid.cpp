void PurchaseLogicAndroid___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E76FDB & 1) == 0 )
  {
    sub_1D0F0B4(&PurchaseLogicAndroid_TypeInfo);
    sub_1D0F0B4(&StringLiteral_15288/*"UnityPurchasingInitializeFailedCount"*/);
    byte_4E76FDB = 1;
  }
  PurchaseLogicAndroid_TypeInfo->static_fields->INITIALIZE_FAILED_COUNT_PREF_KEY = (struct System_String_o *)StringLiteral_15288/*"UnityPurchasingInitializeFailedCount"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)PurchaseLogicAndroid_TypeInfo->static_fields,
    StringLiteral_15288/*"UnityPurchasingInitializeFailedCount"*/,
    v1,
    v2,
    v3,
    v4,
...
void PurchaseLogicAndroid__DisableCrashReporterOnInitialize(PurchaseLogicAndroid_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E76FD7 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_295/*" rateToSend:"*/);
    sub_1D0F0B4(&StringLiteral_16151/*"[UnityIAP]unityPurchasingInitializeFailedCount:"*/);
    byte_4E76FD7 = 1;
  }
  ...
  if ( Int >= 1 )
  {
    ...
    Instance = (CrashReporter_o *)System_String__Concat_65603040(
                                    (System_String_o *)StringLiteral_16151/*"[UnityIAP]unityPurchasingInitializeFailedCount:"*/,
                                    v6,
    ...
    Instance = (CrashReporter_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( !Instance )
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E76FCE & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&PurchaseLogic_ReceiptContents_TypeInfo);
    sub_1D0F0B4(&string_TypeInfo);
    sub_1D0F0B4(&StringLiteral_21513/*"json"*/);
    sub_1D0F0B4(&StringLiteral_10738/*"Payload"*/);
    sub_1D0F0B4(&StringLiteral_23966/*"signature"*/);
    this = (PurchaseLogicAndroid_o *)sub_1D0F0B4(&StringLiteral_1/*""*/);
    byte_4E76FCE = 1;
  }
  v43 = 0;
  value = 0;
  ...
  v5 = (PurchaseLogic_ReceiptContents_o *)sub_1D0F300(PurchaseLogic_ReceiptContents_TypeInfo);
  ...
  System_Collections_Generic_Dictionary_object__object___TryGetValue(
    ...
    (Il2CppObject *)StringLiteral_10738/*"Payload"*/,
    &value,
...
LABEL_37:
  ...
  sub_1D0F058(p_fields, v21, v11, v12, v13, v14, v15, v16);
  v28 = v42;
  if ( v42 )
  {
    v29 = string_TypeInfo;
  ...
  sub_1D0F058(p_googleSignatureStr, v32, v22, v23, v24, v25, v26, v27);
  if ( !p_fields->klass )
  {
    v39 = StringLiteral_1/*""*/;
    p_fields->klass = (GrandQuestFolderBoardItem_c *)StringLiteral_1/*""*/;
    sub_1D0F058(p_fields, v39, v33, v34, v35, v36, v37, v38);
  }
  if ( !p_googleSignatureStr->klass )
  {
    v40 = StringLiteral_1/*""*/;
    p_googleSignatureStr->klass = (GrandQuestFolderBoardItem_c *)StringLiteral_1/*""*/;
    sub_1D0F058(p_googleSignatureStr, v40, v33, v34, v35, v36, v37, v38);
  }
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E76FCD & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_Product__TypeInfo);
    sub_1D0F0B4(&Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___);
    this = (PurchaseLogicAndroid_o *)sub_1D0F0B4(&UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo);
    byte_4E76FCD = 1;
  }
  ...
  if ( !ConfigurationBuilder
    || (v5 = ConfigurationBuilder,
        v6 = UnityEngine_Purchasing_ConfigurationBuilder__Configure_object_(
               ...
               (const MethodInfo_3247604 *)Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___),
        ConfigurationBuilder = (UnityEngine_Purchasing_ConfigurationBuilder_o *)sub_1D0F300(System_Action_Product__TypeInfo),
        !v2)
    || (v7 = ConfigurationBuilder,
        ...
        !v6) )
  {
    sub_1D0F30C(ConfigurationBuilder, v4);
  }
  klass = v6->klass;
  ...
  {
LABEL_10:
    v11 = sub_1CE5430(v6, UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E76FDA & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Linq_Enumerable_FirstOrDefault_BankShopEntity___);
    sub_1D0F0B4(&System_Func_BankShopEntity__bool__TypeInfo);
    sub_1D0F0B4(&PurchaseBehaviour_TypeInfo);
    sub_1D0F0B4(&Method_PurchaseLogicAndroid___c__DisplayClass22_0__OnDeferred_b__0__);
    sub_1D0F0B4(&PurchaseLogicAndroid___c__DisplayClass22_0_TypeInfo);
    byte_4E76FDA = 1;
  }
  v5 = sub_1D0F300(PurchaseLogicAndroid___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 16) = id_k__BackingField;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 16), (int32_t)id_k__BackingField, v8, v9, v10, v11, v12, v13);
  ...
  v18 = (System_Func_object__bool__o *)sub_1D0F300(System_Func_BankShopEntity__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v18,
    (Il2CppObject *)v5,
    Method_PurchaseLogicAndroid___c__DisplayClass22_0__OnDeferred_b__0__,
    0);
  v19 = System_Linq_Enumerable__FirstOrDefault_object__52923832(
          BankShopEntityCollection,
          (System_Func_TSource__bool__o *)v18,
          (const MethodInfo_3278DB8 *)Method_System_Linq_Enumerable_FirstOrDefault_BankShopEntity___);
  if ( v19 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E76FD0 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___);
    sub_1D0F0B4(&UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo);
    sub_1D0F0B4(&StringLiteral_24806/*"unexpected obfuscatedAccountId:"*/);
    sub_1D0F0B4(&StringLiteral_741/*"(null)"*/);
    byte_4E76FD0 = 1;
  }
  ...
  if ( UnityEngine_Application__get_platform(0) == 11 )
  {
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      ...
      IsNullOrEmpty = System_String__Concat_65562772((System_String_o *)StringLiteral_24806/*"unexpected obfuscatedAccountId:"*/, v10, 0);
...
LABEL_26:
    ...
    else if ( builder )
    {
      ...
      if ( IsNullOrEmpty )
      {
        ...
        {
LABEL_23:
          v19 = sub_1CE5430(IsNullOrEmpty, UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, 1);
        }
        ...
        const MethodInfo *method)
{
  if ( !bankShop )
    sub_1D0F30C(this, 0);
  return System_String__Equals_65598896(this->fields.productId, bankShop->fields.googleShopId, 4, 0);
}