void __fastcall PurchaseLogicAndroid___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A08574 & 1) == 0 )
  {
    sub_1B686D4(&PurchaseLogicAndroid_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_15011/*"UnityPurchasingInitializeFailedCount"*/, v4);
    byte_4A08574 = 1;
  }
  PurchaseLogicAndroid_TypeInfo->static_fields->INITIALIZE_FAILED_COUNT_PREF_KEY = (struct System_String_o *)StringLiteral_15011/*"UnityPurchasingInitializeFailedCount"*/;
  sub_1B68678(
    (ServantStatusBattleListViewItem_o *)PurchaseLogicAndroid_TypeInfo->static_fields,
    StringLiteral_15011/*"UnityPurchasingInitializeFailedCount"*/,
    v2,
    v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08570 & 1) == 0 )
  {
    sub_1B686D4(&PurchaseLogicAndroid_TypeInfo, method);
    sub_1B686D4(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__, v3);
    sub_1B686D4(&StringLiteral_323/*" rateToSend:"*/, v4);
    sub_1B686D4(&StringLiteral_15891/*"[UnityIAP]unityPurchasingInitializeFailedCount:"*/, v5);
    byte_4A08570 = 1;
  }
  ...
  if ( Int >= 1 )
  {
    ...
    Instance = (CrashReporter_o *)System_String__Concat_61432732(
    ...
    Instance = (CrashReporter_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( !Instance )
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08567 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, product);
    sub_1B686D4(&System_Collections_Generic_Dictionary_string__object__TypeInfo, v4);
    sub_1B686D4(&PurchaseLogic_ReceiptContents_TypeInfo, v5);
    sub_1B686D4(&string_TypeInfo, v6);
    sub_1B686D4(&StringLiteral_20886/*"json"*/, v7);
    sub_1B686D4(&StringLiteral_10541/*"Payload"*/, v8);
    sub_1B686D4(&StringLiteral_23239/*"signature"*/, v9);
    this = (PurchaseLogicAndroid_o *)sub_1B686D4(&StringLiteral_1/*""*/, v10);
    byte_4A08567 = 1;
  }
  v38 = 0LL;
  value = 0LL;
  ...
  v12 = (PurchaseLogic_ReceiptContents_o *)sub_1B68920(PurchaseLogic_ReceiptContents_TypeInfo);
  ...
  if ( !this
    ...
    || (System_Collections_Generic_Dictionary_object__object___TryGetValue(
          (System_Collections_Generic_Dictionary_object__object__o *)this,
          (Il2CppObject *)StringLiteral_20886/*"json"*/,
          &v38,
          (const MethodInfo_318B374 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__),
        this = (PurchaseLogicAndroid_o *)System_Collections_Generic_Dictionary_object__object___TryGetValue(
                                           ...
                                           (Il2CppObject *)StringLiteral_23239/*"signature"*/,
                                           &v37,
                                           (const MethodInfo_318B374 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__),
        !v12) )
  {
LABEL_37:
  ...
  sub_1B68678(p_fields, v24, v18, v19);
  v27 = v37;
  if ( v37 )
  {
    v28 = string_TypeInfo;
  ...
  if ( !p_googleSignatureStr->klass )
  {
    ...
    sub_1B68678(p_googleSignatureStr, v35, v32, v33);
  }
  return v12;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08566 & 1) == 0 )
  {
    sub_1B686D4(&System_Action_Product__TypeInfo, method);
    sub_1B686D4(&Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___, v3);
    this = (PurchaseLogicAndroid_o *)sub_1B686D4(&UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, v4);
    byte_4A08566 = 1;
  }
  ...
  if ( !ConfigurationBuilder
    || (v7 = ConfigurationBuilder,
        v8 = UnityEngine_Purchasing_ConfigurationBuilder__Configure_object_(
               ...
               (const MethodInfo_2E42238 *)Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___),
        ConfigurationBuilder = (UnityEngine_Purchasing_ConfigurationBuilder_o *)sub_1B68920(System_Action_Product__TypeInfo),
        !v2)
    || (v9 = ConfigurationBuilder,
        ...
        !v8) )
  {
    sub_1B68930(ConfigurationBuilder, v6);
  }
  klass = v8->klass;
  ...
  {
LABEL_10:
    p_method = sub_1BBA6B4(v8, UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08573 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_PurchaseLogicAndroid___c__DisplayClass22_0__OnDeferred_b__0__, v7);
    sub_1B686D4(&PurchaseLogicAndroid___c__DisplayClass22_0_TypeInfo, v8);
    byte_4A08573 = 1;
  }
  v9 = sub_1B68920(PurchaseLogicAndroid___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 16) = id_k__BackingField;
  ...
  v18 = (System_Func_object__bool__o *)sub_1B68920(System_Func_BankShopEntity__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0856D & 1) == 0 )
  {
    sub_1B686D4(&PurchaseLogicAndroid_TypeInfo, isInitialized);
    byte_4A0856D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0856A & 1) == 0 )
  {
    sub_1B686D4(&PurchaseLogicAndroid_TypeInfo, obfuscatedAccountId);
    byte_4A0856A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0856F & 1) == 0 )
  {
    sub_1B686D4(&PurchaseLogicAndroid_TypeInfo, isMismatched);
    byte_4A0856F = 1;
  }
  v4 = PurchaseLogicAndroid_TypeInfo;
  if ( !PurchaseLogicAndroid_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08569 & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Application_TypeInfo, builder);
    sub_1B686D4(&Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___, v5);
    sub_1B686D4(&UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, v6);
    sub_1B686D4(&StringLiteral_24086/*"unexpected obfuscatedAccountId:"*/, v7);
    sub_1B686D4(&StringLiteral_794/*"(null)"*/, v8);
    byte_4A08569 = 1;
  }
  ...
  if ( UnityEngine_Application__get_platform(0LL) == 11 )
  {
    if ( !byte_4A085F8 )
    {
      sub_1B686D4(&PurchaseLogicAndroid_TypeInfo, v9);
      byte_4A085F8 = 1;
    }
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      ...
      IsNullOrEmpty = System_String__Concat_61419468((System_String_o *)StringLiteral_24086/*"unexpected obfuscatedAccountId:"*/, v15, 0LL);
...
LABEL_26:
    ...
    else if ( builder )
    {
      ...
      if ( IsNullOrEmpty )
      {
        ...
        {
LABEL_23:
          v24 = sub_1BBA6B4(IsNullOrEmpty, UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, 1LL);
        }
