void __fastcall PurchaseLogicAndroid___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42AFC0E & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_15056/*"UnityPurchasingInitializeFailedCount"*/);
    byte_42AFC0E = 1;
  }
  static_fields = (BattleServantConfConponent_o *)PurchaseLogicAndroid_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_15056/*"UnityPurchasingInitializeFailedCount"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_15056/*"UnityPurchasingInitializeFailedCount"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFC0B & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_257/*" rateToSend:"*/);
    sub_B52984(&StringLiteral_15866/*"[UnityIAP]unityPurchasingInitializeFailedCount:"*/);
    byte_42AFC0B = 1;
  }
  _8[0] = 0LL;
  ...
  if ( Int >= 1 )
  {
    ...
    Instance = (System_Uri_o *)System_String__Concat_44571728(
                                 (System_String_o *)StringLiteral_15866/*"[UnityIAP]unityPurchasingInitializeFailedCount:"*/,
                                 v6,
                                 (System_String_o *)StringLiteral_257/*" rateToSend:"*/,
                                 v8,
                                 0LL);
    if ( !logOutputAction )
      goto LABEL_12;
    ...
    Instance = (System_Uri_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( !Instance )
LABEL_12:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFC02 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_20229/*"json"*/);
    sub_B52984(&StringLiteral_10700/*"Payload"*/);
    sub_B52984(&StringLiteral_22311/*"signature"*/);
    this = (PurchaseLogicAndroid_o *)sub_B52984(&StringLiteral_1/*""*/);
    byte_42AFC02 = 1;
  }
  v35 = 0LL;
  value = 0LL;
  ...
  v5 = sub_B52A54(PurchaseLogic_ReceiptContents_TypeInfo);
  ...
  if ( !this
    ...
    || (System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___TryGetValue(
          (System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject__o *)this,
          (System_Xml_XmlQualifiedName_o *)StringLiteral_20229/*"json"*/,
          &v35,
          (const MethodInfo_2F1D600 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__),
        this = (PurchaseLogicAndroid_o *)System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___TryGetValue(
                                           ...
                                           (System_Xml_XmlQualifiedName_o *)StringLiteral_22311/*"signature"*/,
                                           &v34,
                                           (const MethodInfo_2F1D600 *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__),
        !v5) )
  {
LABEL_31:
  ...
  *(_QWORD *)(v5 + 16) = v16;
  sub_B52920((BattleServantConfConponent_o *)(v5 + 16), v16, v10, v11, v12, v13, v14, v15);
  if ( v34 )
  {
  ...
  *(_QWORD *)(v5 + 24) = v23;
  v24 = (_QWORD *)(v5 + 24);
  sub_B52920((BattleServantConfConponent_o *)(v5 + 24), v23, v17, v18, v19, v20, v21, v22);
  if ( !*(_QWORD *)(v5 + 16) )
  {
    v31 = (System_Int32_array **)StringLiteral_1/*""*/;
    *(_QWORD *)(v5 + 16) = StringLiteral_1/*""*/;
    sub_B52920((BattleServantConfConponent_o *)(v5 + 16), v31, v25, v26, v27, v28, v29, v30);
  }
  if ( !*v24 )
  {
    v32 = (System_Int32_array **)StringLiteral_1/*""*/;
    *v24 = StringLiteral_1/*""*/;
    sub_B52920((BattleServantConfConponent_o *)(v5 + 24), v32, v25, v26, v27, v28, v29, v30);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFC01 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___);
    this = (PurchaseLogicAndroid_o *)sub_B52984(&UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo);
    byte_42AFC01 = 1;
  }
  ...
  if ( !ConfigurationBuilder
    || (v5 = ConfigurationBuilder,
        v6 = UnityEngine_Purchasing_ConfigurationBuilder__Configure_object_(
               ...
               (const MethodInfo_1A49B5C *)Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___),
        ConfigurationBuilder = (UnityEngine_Purchasing_ConfigurationBuilder_o *)sub_B52A54(System_Action_Product__TypeInfo),
        !v2)
    || (v7 = ConfigurationBuilder,
        ...
        !v6) )
  {
    sub_B52A5C(ConfigurationBuilder, v4);
  }
  klass = v6->klass;
  ...
  {
LABEL_10:
    p_method = sub_AEB880(v6, UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, 0LL, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFC04 & 1) == 0 )
  {
    sub_B52984(&Method_System_Action_string__Invoke__);
    sub_B52984(&Method_UnityEngine_Purchasing_ConfigurationBuilder_Configure_IGooglePlayConfiguration___);
    sub_B52984(&UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo);
    sub_B52984(&StringLiteral_23083/*"unexpected obfuscatedAccountId:"*/);
    sub_B52984(&StringLiteral_648/*"(null)"*/);
    byte_42AFC04 = 1;
  }
  if ( UnityEngine_Application__get_platform(0LL) == 11 )
  {
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      ...
      if ( cachedObfuscatedAccountId )
        ...
        v10 = (System_String_o *)StringLiteral_648/*"(null)"*/;
      IsNullOrEmpty = (System_Uri_o *)System_String__Concat_44568316((System_String_o *)StringLiteral_23083/*"unexpected obfuscatedAccountId:"*/, v10, 0LL);
...
LABEL_25:
    ...
    if ( *(_WORD *)&IsNullOrEmpty->klass->_2.bitflags1 )
    {
      ...
      while ( *(p_offset - 1) != UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo )
      {
        ++v14;
        p_offset += 2;
        if ( v14 >= *(unsigned __int16 *)&IsNullOrEmpty->klass->_2.bitflags1 )
          goto LABEL_22;
      }
      v16 = (__int64)(&klass->vtable._1_Finalize.method + 2 * *(_DWORD *)p_offset);
    }
    else
    {
LABEL_22:
      v16 = sub_AEB880(IsNullOrEmpty, UnityEngine_Purchasing_IGooglePlayConfiguration_TypeInfo, 1LL, v11);
    }
    (*(void (__fastcall **)(System_Uri_o *, System_String_o *, _QWORD))v16)(
      v13,
