        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21583 & 1) == 0 )
  {
    this = (BgmPlayerBase_o *)sub_1C3B764(&BgmManager_TypeInfo, method);
    byte_4C21583 = 1;
  }
  if ( v7->fields.fadeinTime > 0.0 )
  {
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      sub_1C3B708((PartyOrganizationUtility_o *)&v7->fields.bgmPlayer, bgmFadePlayer, v15, v16, v17, v18, v19, v20);
  ...
  if ( ((unsigned __int8)v22 & 1) != 0 )
  {
    if ( fadeTime <= 0.0 )
    {
      ...
      if ( !byte_4C1D531 )
      {
        sub_1C3B764(&BgmManager_TypeInfo, v21);
        byte_4C1D531 = 1;
      }
...
bool __fastcall BgmPlayerBase__FadeoutBgm(BgmPlayerBase_o *this, float fadeoutTime, const MethodInfo *method)
{
  ...
  if ( bgmName )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.bgmName, 0LL, v3, v4, v5, v6, v7, v8);
    ...
    if ( this->fields.fadeinTime > 0.0 )
    {
      ...
      if ( ((unsigned __int8)v7 & 1) != 0 )
      {
        ...
        *p_bgmFadePlayer = (struct CriAtomSource_o *)p_bgmPlayer->klass;
        sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.bgmFadePlayer, klass, v11, v12, v13, v14, v15, v16);
        p_bgmPlayer->klass = (PartyOrganizationUtility_c *)v18;
        sub_1C3B708(p_bgmPlayer, v18, v19, v20, v21, v22, v23, v24);
    ...
    if ( !IsPaused )
    {
        ...
        && (v11 = BgmPlayerBase__CheckPlaying((BgmPlayerBase_o *)v11, this->fields.bgmFadePlayer, v12)) )
      {
        ...
        if ( fadeoutTime > 0.0 )
        {
          ...
          if ( !byte_4C1F4CC )
          {
            sub_1C3B764(&BgmManager_TypeInfo, v6);
            byte_4C1F4CC = 1;
          }
          ...
          if ( v28 >= fadeinTime )
          {
            ...
            if ( ((unsigned __int8)v8 & 1) != 0 )
            {
              if ( v22 )
              {
                ...
                sub_1C3B708(p_bgmFadePlayer, (int64_t)v30, v32, v33, v34, v35, v36, v37);
                *p_bgmPlayer = (CriAtomSource_o *)klass;
                sub_1C3B708((PartyOrganizationUtility_o *)p_bgmPlayer, klass, v38, v39, v40, v41, v42, v43);
                return;
              }
              goto LABEL_80;
            }
...
System_String_array *__fastcall BgmPlayerBase__GetUsingCueNames(BgmPlayerBase_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C3B80C(string___TypeInfo, 2LL);
  bgmPlayer = this->fields.bgmPlayer;
  if ( !bgmPlayer )
    goto LABEL_9;
  v12 = v3;
  ...
  *(_QWORD *)(v3 + 32) = cueName;
  sub_1C3B708((PartyOrganizationUtility_o *)(v3 + 32), cueName, v5, v6, v7, v8, v9, v10);
...
LABEL_10:
  ...
  *(_QWORD *)(v12 + 40) = v21;
  sub_1C3B708((PartyOrganizationUtility_o *)(v12 + 40), v21, v14, v15, v16, v17, v18, v19);
...
void __fastcall BgmPlayerBase__Initialize(BgmPlayerBase_o *this, const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)p_cueSheet, v23, v17, v18, v19, v20, v21, v22);
  p_bgmFadePlayer = &this->fields.bgmFadePlayer;
  ...
  if ( UnityEngine_Object__op_Equality(bgmFadePlayer, 0LL, 0LL) )
  {
    ...
    if ( Instance )
    {
      ...
      *p_bgmFadePlayer = v27;
      sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.bgmFadePlayer, (int64_t)v27, v28, v29, v30, v31, v32, v33);
      v34 = *p_bgmFadePlayer;
      if ( v34 )
      {
        ...
        sub_1C3B708((PartyOrganizationUtility_o *)&v34->fields._cueSheet, v35, v36, v37, v38, v39, v40, v41);
        return;
      }
    }
LABEL_19:
...
void __fastcall BgmPlayerBase__PauseBgm(BgmPlayerBase_o *this, bool isPause, const MethodInfo *method)
{
  ...
  if ( (byte_4C21580 & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, isPause);
    byte_4C21580 = 1;
  }
  bgmPlayer = (UnityEngine_Object_o *)this->fields.bgmPlayer;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21587 & 1) == 0 )
  {
    this = (BgmPlayerBase_o *)sub_1C3B764(&BgmManager_TypeInfo, name);
    byte_4C21587 = 1;
  }
  if ( !name )
    sub_1C3B9C0(this, name);
  if ( System_String__Equals_63376928(name, v10->fields.bgmName, 0LL) )
  {
  ...
  else
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&v10->fields.bgmName, (int64_t)name, v12, v13, v14, v15, v16, v17);
    ...
    if ( !byte_4C1F4CC )
    {
      sub_1C3B764(&BgmManager_TypeInfo, v18);
      byte_4C1F4CC = 1;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21584 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_BgmPlayerBase___c__DisplayClass31_0__PlayLocal_b__0__, v12);
    sub_1C3B764(&BgmPlayerBase___c__DisplayClass31_0_TypeInfo, v13);
    byte_4C21584 = 1;
  }
  v14 = sub_1C3B9B0(BgmPlayerBase___c__DisplayClass31_0_TypeInfo);
  ...
  *(_BYTE *)(v14 + 48) = loop;
  if ( fadeTime > 0.0 && BgmPlayerBase__CheckPlaying(v29, this->fields.bgmPlayer, v30) )
  {
    ...
    *(_QWORD *)(v14 + 32) = bgmFadePlayer;
    sub_1C3B708((PartyOrganizationUtility_o *)(v14 + 32), (int64_t)bgmFadePlayer, (int64_t)v30, v31, v32, v33, v34, v35);
    bgmPlayer = this->fields.bgmPlayer;
    if ( !bgmPlayer )
      goto LABEL_12;
  ...
  else
  {
    ...
    *(_QWORD *)(v14 + 32) = v39;
    sub_1C3B708((PartyOrganizationUtility_o *)(v14 + 32), (int64_t)v39, (int64_t)v30, v31, v32, v33, v34, v35);
  ...
  Instance = (CriAtomSource_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_BgmManager__get_Instance__);
  if ( !Instance )
LABEL_12:
...
void __fastcall BgmPlayerBase__Reset(BgmPlayerBase_o *this, const MethodInfo *method)
{
  ...
  {
    p_bgmName->klass = 0LL;
    sub_1C3B708(p_bgmName, 0LL, v3, v4, v5, v6, v7, v8);
  }
}
  ...
  else if ( bgmName )
  {
    ...
    *(float *)&v8 = this->fields.bgmVolume;
    ...
    sub_1C3B708(
      ...
      v7);
    this->fields.bgmName = 0LL;
    sub_1C3B708((PartyOrganizationUtility_o *)p_bgmName, 0LL, v15, v16, v17, v18, v19, v20);
    klass = this->klass;
...
bool __fastcall BgmPlayerBase__StopBgm(BgmPlayerBase_o *this, bool keepPlayArgs, const MethodInfo *method)
{
  ...
  {
    this->fields.bgmName = 0LL;
    sub_1C3B708((PartyOrganizationUtility_o *)p_bgmName, 0LL, (int64_t)method, v3, v4, v5, v6, v7);
    this->fields.bgmVolume = 0.0;
  }
  this->fields.bgmFadeTime = -1.0;
...
System_String_o *__fastcall BgmPlayerBase__get_CueSheetName(BgmPlayerBase_o *this, const MethodInfo *method)
{
  if ( (byte_4C2157C & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_3046/*"BacktraceConfigurationProduction"*/, method);
    byte_4C2157C = 1;
  }
  return (System_String_o *)StringLiteral_3046/*"BacktraceConfigurationProduction"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21586 & 1) == 0 )
  {
    sub_1C3B764(&BgmManager_TypeInfo, player);
    byte_4C21586 = 1;
  }
  if ( !BgmManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BgmManager_TypeInfo);
  ...
  this->fields.playTime = -1.0;
  if ( !player )
    sub_1C3B9C0(v15, player);
  CriAtomSource__Stop(player, 0LL);
  player->fields._cueSheet = cueSheet;
  sub_1C3B708((PartyOrganizationUtility_o *)&player->fields._cueSheet, (int64_t)cueSheet, v17, v18, v19, v20, v21, v22);
  player->fields._cueName = cueName;
  sub_1C3B708((PartyOrganizationUtility_o *)&player->fields._cueName, (int64_t)cueName, v23, v24, v25, v26, v27, v28);
  v30 = 0.0;
  if ( fadeTime <= 0.0 )
  {
    if ( !BgmManager_TypeInfo->_2.cctor_finished )
    ...
    if ( !byte_4C1D531 )
    {
      sub_1C3B764(&BgmManager_TypeInfo, v29);
      byte_4C1D531 = 1;
    }
...
void __fastcall BgmPlayerBase__set_PlayTime(BgmPlayerBase_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4C2157E & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, *(_QWORD *)&value);
    byte_4C2157E = 1;
  }
  bgmPlayer = (UnityEngine_Object_o *)this->fields.bgmPlayer;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  Instance = (BgmManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_BgmManager__get_Instance__);
  if ( !Instance )
    goto LABEL_10;
  if ( BgmManager__IsPreloadSucceeded(Instance, this->fields.name, 0LL) )
  {
    ...
    if ( Instance )
    {
      ...
      Instance = (BgmManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_SoundManager__get_Instance__);
      if ( Instance )
      {
