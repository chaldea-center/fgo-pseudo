...
void FortificationConfirmDialogComponent__Close(FortificationConfirmDialogComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D26A8E & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_FortificationConfirmDialogComponent__Close_b__41_0__);
    byte_4D26A8E = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26A8A & 1) == 0 )
  {
    ...
    this = (FortificationConfirmDialogComponent_o *)sub_1C94098(&StringLiteral_20377/*"icon_guest"*/);
    byte_4D26A8A = 1;
  }
...
LABEL_18:
  ...
  AtlasManager__SetEventUI_41357612(eventId, guestIconBefore, (System_String_o *)StringLiteral_20377/*"icon_guest"*/, 0);
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26A8D & 1) == 0 )
  {
    sub_1C94098(&Method_FortificationConfirmDialogComponent_OnClickCancel__);
    byte_4D26A8D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationConfirmDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_FortificationConfirmDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26A89 & 1) == 0 )
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&AtlasManager_TypeInfo);
    sub_1C94098(&Method_FortificationConfirmDialogComponent__Open_b__32_0__);
    sub_1C94098(&int_TypeInfo);
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&StringLiteral_4955/*"D2"*/);
    sub_1C94098(&StringLiteral_6494/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_WARNING_DESCRIPTION"*/);
    sub_1C94098(&StringLiteral_6503/*"FORTIFICATION_NPC_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/);
    sub_1C94098(&StringLiteral_6506/*"FORTIFICATION_REMOVE_CONFIRM_DIALOG_TITLE"*/);
    sub_1C94098(&StringLiteral_6493/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_TITLE"*/);
    sub_1C94098(&StringLiteral_6492/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/);
    sub_1C94098(&StringLiteral_6508/*"FORTIFICATION_SET_CONFIRM_DIALOG_TITLE"*/);
    sub_1C94098(&StringLiteral_3691/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C94098(&StringLiteral_3690/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C94098(&StringLiteral_6509/*"FORTIFICATION_SET_CONFIRM_DIALOG_WARNING_DESCRIPTION"*/);
    sub_1C94098(&StringLiteral_6505/*"FORTIFICATION_REMOVE_CONFIRM_DIALOG_DESCRIPTION"*/);
    sub_1C94098(&StringLiteral_20367/*"icon_event_{0}{1}"*/);
    sub_1C94098(&StringLiteral_6497/*"FORTIFICATION_CONFIRM_DIALOG_SUB_TITLE"*/);
    sub_1C94098(&StringLiteral_6507/*"FORTIFICATION_SET_CONFIRM_DIALOG_DESCRIPTION"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C9403C(&this->fields.onDecide, onDecide);
    ...
    if ( dialogType != 2 )
    {
      if ( dialogType == 1 )
      {
        ...
        guestIconBefore = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6506/*"FORTIFICATION_REMOVE_CONFIRM_DIALOG_TITLE"*/, 0);
        if ( !titleLb )
          goto LABEL_52;
        ...
        v29 = LocalizationManager__Get((System_String_o *)StringLiteral_6505/*"FORTIFICATION_REMOVE_CONFIRM_DIALOG_DESCRIPTION"*/, 0);
      ...
      else
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        guestIconBefore = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6508/*"FORTIFICATION_SET_CONFIRM_DIALOG_TITLE"*/, 0);
        if ( !v18 )
          goto LABEL_52;
        UILabel__set_text(v18, (System_String_o *)guestIconBefore, 0);
        descriptionLb = this->fields.descriptionLb;
        v20 = LocalizationManager__Get((System_String_o *)StringLiteral_6507/*"FORTIFICATION_SET_CONFIRM_DIALOG_DESCRIPTION"*/, 0);
        ...
        guestIconBefore = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6509/*"FORTIFICATION_SET_CONFIRM_DIALOG_WARNING_DESCRIPTION"*/, 0);
...
LABEL_40:
      ...
      v37 = (Il2CppObject *)System_Int32__ToString_65926240((int32_t)&v49, (System_String_o *)StringLiteral_4955/*"D2"*/, 0);
      v38 = System_String__Format_64459052((System_String_o *)StringLiteral_20367/*"icon_event_{0}{1}"*/, v36, v37, 0);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetEventUI_41357612(eventId, workTypeIcon, v38, 0);
      subTitleLb = this->fields.subTitleLb;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v40 = LocalizationManager__Get((System_String_o *)StringLiteral_6497/*"FORTIFICATION_CONFIRM_DIALOG_SUB_TITLE"*/, 0);
      guestIconBefore = (UnityEngine_Component_o *)System_String__Format_64459052(
                                                     v40,
          ...
          if ( this->fields.subTitleLb )
          {
            ...
            if ( v44 )
            {
              ...
              if ( decideButtonLb )
              {
                ...
                guestIconBefore = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_3690/*"COMMON_CONFIRM_CLOSE"*/,
                                                               0);
                if ( cancelButtonLb )
                {
...
LABEL_52:
      sub_1C942F0(guestIconBefore, v16);
    }
    v23 = this->fields.titleLb;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    guestIconBefore = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6493/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_TITLE"*/, 0);
    if ( !v23 )
      goto LABEL_52;
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_23:
        guestIconBefore = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6503/*"FORTIFICATION_NPC_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/, 0);
        goto LABEL_34;
      }
    }
    else
    ...
    v31 = LocalizationManager__Get((System_String_o *)StringLiteral_6492/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_DESCRIPTION"*/, 0);
...
LABEL_34:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    guestIconBefore = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6494/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_WARNING_DESCRIPTION"*/, 0);
    if ( !v32 )
      goto LABEL_52;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&StringLiteral_6490/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_AFTER"*/);
    sub_1C94098(&StringLiteral_6491/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_BEFOR"*/);
    byte_4D26A8B = 1;
  }
  ...
  singleServantDisplayObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_6491/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_BEFOR"*/,
                                                             0);
  if ( !beforeLb )
    goto LABEL_16;
  ...
  singleServantDisplayObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_6490/*"FORTIFICATION_CHANGE_CONFIRM_DIALOG_AFTER"*/,
                                                             0);
  if ( !afterLb )
LABEL_16:
    sub_1C942F0(singleServantDisplayObject, userServantEntity);
...
LABEL_17:
    sub_1C942F8(singleServantDisplayObject);
  FortificationConfirmDialogComponent__SetServant(
    (FortificationConfirmDialogComponent_o *)singleServantDisplayObject,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26A8C & 1) == 0 )
  {
    ...
    sub_1C94098(&int_TypeInfo);
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&StringLiteral_6495/*"FORTIFICATION_CONFIRM_DIALOG_POINT"*/);
    sub_1C94098(&StringLiteral_6496/*"FORTIFICATION_CONFIRM_DIALOG_POINT_DESCRIPTION"*/);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  LevelMax = LocalizationManager__Get((System_String_o *)StringLiteral_6496/*"FORTIFICATION_CONFIRM_DIALOG_POINT_DESCRIPTION"*/, 0);
  if ( !label1 )
    goto LABEL_11;
  UILabel__set_text(label1, LevelMax, 0);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_6495/*"FORTIFICATION_CONFIRM_DIALOG_POINT"*/, 0);
  v19 = point;
  v16 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v19);
  v17 = (Il2CppObject *)System_String__Format((System_String_o *)StringLiteral_25304/*"{0:#,0}"*/, v16, 0);
  ...
  if ( !label2
    ...
    || (IconLabelInfo__Set_41670428(v12, 2, lv, (int32_t)LevelMax, 0, 0, 0, 0, 0, 0), !faceIcon) )
  {
LABEL_11:
    sub_1C942F0(LevelMax, v14);
  }
  ServantFaceIconComponent__Set_41844968(faceIcon, ent, v12, 0, 0);
}
