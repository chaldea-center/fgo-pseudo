void __fastcall CommandSpellWindowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BE29F & 1) == 0 )
  {
    sub_1B4CF90(&CommandSpellWindowComponent_TypeInfo, v1);
    byte_49BE29F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE294 & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, call);
    byte_49BE294 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  BattleWindowComponent_o *v35; // x21
  __int64 v36; // x0
  ...
  int32_t size; // w2
  int v41; // w9
  CommandSpellWindowComponent___c_c *v42; // x0
  ...
  CommandSpellWindowComponent_c *v53; // x8
  UnityEngine_Transform_o *v54; // x23
  const MethodInfo *v55; // x4
  Il2CppObject *v56; // x8
  BattleWindowComponent_o *v57; // x23
  int32_t v58; // w2
  ...
  if ( (byte_49BE295 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Array_Sort_CommandSpellEntity___, bp);
    sub_1B4CF90(&CommandSpellWindowComponent_TypeInfo, v9);
    sub_1B4CF90(&System_Comparison_CommandSpellEntity__TypeInfo, v10);
    ...
    sub_1B4CF90(
      ...
      v12);
    sub_1B4CF90(&Method_System_Collections_Generic_List_Enumerator_GameObject__Dispose__, v13);
    sub_1B4CF90(&Method_System_Collections_Generic_List_Enumerator_GameObject__MoveNext__, v14);
    sub_1B4CF90(&Method_System_Collections_Generic_List_Enumerator_GameObject__get_Current__, v15);
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___, v16);
    ...
    sub_1B4CF90(&Method_CommandSpellWindowComponent___c__InitializeCommandSpell_b__39_0__, v23);
    sub_1B4CF90(&CommandSpellWindowComponent___c_TypeInfo, v24);
    sub_1B4CF90(&StringLiteral_15259/*"WINDOWTITLE_COMMANDSPELL_NO_BATTLE"*/, v25);
    sub_1B4CF90(&StringLiteral_15258/*"WINDOWTITLE_COMMANDSPELL_BATTLE"*/, v26);
    sub_1B4CF90(&StringLiteral_2711/*"BATTLE_CHECKUSE_COMMANDSPELL"*/, v27);
    sub_1B4CF90(&StringLiteral_3645/*"COMMAND_SPELL_ADD_FUNCTION_CAUTION_TEXT"*/, v28);
    byte_49BE295 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)bp, 0LL, 0LL) )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.battlePerf, (int32_t)bp, v30, v31);
  }
  ...
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2711/*"BATTLE_CHECKUSE_COMMANDSPELL"*/, 0LL);
  if ( !checkuselabel )
    goto LABEL_77;
  UILabel__set_text(checkuselabel, (System_String_o *)checkWindow, 0LL);
  classBoardCautionLabel = this->fields.classBoardCautionLabel;
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3645/*"COMMAND_SPELL_ADD_FUNCTION_CAUTION_TEXT"*/, 0LL);
  ...
  checkWindow = (BattleWindowComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !checkWindow )
    goto LABEL_77;
  ...
  if ( !checkWindow )
    goto LABEL_77;
  v35 = checkWindow;
  v36 = sub_1B4D0C4(*((_QWORD *)&checkWindow->klass->vtable._1_Finalize.methodPtr
                    + 2
                    * *((unsigned __int16 *)Method_DataMasterBase_CommandSpellMaster__CommandSpellEntity__int__getEntitys_CommandSpellEntity___
                      + 40)));
  v37 = (System_Object_array *)(*(__int64 (__fastcall **)(BattleWindowComponent_o *, __int64))(v36 + 8))(v35, v36);
  if ( this->fields.objlist )
  {
    ...
    v41 = objlist->fields._version + 1;
    objlist->fields._size = 0;
    objlist->fields._version = v41;
    if ( size >= 1 )
      System_Array__Clear((System_Array_o *)objlist->fields._items, 0, size, 0LL);
  }
  v42 = CommandSpellWindowComponent___c_TypeInfo;
  ...
  _9__39_0 = (System_Comparison_T__o *)v42->static_fields->__9__39_0;
  if ( !_9__39_0 )
  {
    ...
    _9__39_0 = (System_Comparison_T__o *)sub_1B4D1DC(System_Comparison_CommandSpellEntity__TypeInfo);
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&static_fields->__9__39_0, (int32_t)_9__39_0, v46, v47);
  }
  System_Array__Sort_object__49088784(
    v37,
    _9__39_0,
    (const MethodInfo_2ED0910 *)Method_System_Array_Sort_CommandSpellEntity___);
  if ( !v37 )
    goto LABEL_77;
...
LABEL_78:
        sub_1B4D1F4(checkWindow, v29);
      checkWindow = (BattleWindowComponent_o *)m_Items[v49];
      if ( !checkWindow )
        goto LABEL_77;
      ...
      if ( ((unsigned __int8)checkWindow & 1) == 0 )
      {
        ...
        if ( !checkWindow )
          goto LABEL_77;
        v52 = (UnityEngine_GameObject_o *)checkWindow;
        UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)checkWindow, 1, 0LL);
        checkWindow = (BattleWindowComponent_o *)UnityEngine_GameObject__get_transform(v52, 0LL);
        v53 = CommandSpellWindowComponent_TypeInfo;
        v54 = (UnityEngine_Transform_o *)checkWindow;
        ...
        v71.fields.x = 0.0;
        v71.fields.z = 0.0;
        v71.fields.y = (float)-(v50 * v53->static_fields->objheight);
        UnityEngine_Transform__set_localPosition(v54, v71, 0LL);
        checkWindow = (BattleWindowComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   v52,
                                                   (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___);
        if ( (unsigned int)v49 >= v37->max_length )
          goto LABEL_78;
        v56 = m_Items[v49];
        if ( !v56 )
          goto LABEL_77;
        ...
        CommandSpellObjectComponent__setData(
          ...
          v55);
        v57->fields._closeBtnObject = (struct UnityEngine_GameObject_o *)this;
        sub_1B4CF34((CGThumbnailListItem_o *)&v57->fields._closeBtnObject, (int32_t)this, v58, v59);
        if ( !this->fields.mode )
          LOBYTE(v57[1].fields.m_CachedPtr) = 0;
        UnityEngine_GameObject__SetActive(v52, 1, 0LL);
        checkWindow = (BattleWindowComponent_o *)this->fields.objlist;
        if ( !checkWindow )
          goto LABEL_77;
        v62 = *(_QWORD *)&checkWindow->fields.m_CachedPtr;
        ...
        else
        {
          ...
          *(_QWORD *)(v65 + 32) = v52;
          sub_1B4CF34((CGThumbnailListItem_o *)(v65 + 32), (int32_t)v52, v60, v61);
        }
      }
LABEL_65:
      max_length = v37->max_length;
  ...
  if ( mode )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v68 = &StringLiteral_15258/*"WINDOWTITLE_COMMANDSPELL_BATTLE"*/;
  }
  else
  {
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v68 = &StringLiteral_15259/*"WINDOWTITLE_COMMANDSPELL_NO_BATTLE"*/;
  }
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)*v68, 0LL);
  if ( !titleLabel )
LABEL_77:
    sub_1B4D1EC(checkWindow, v29);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE296 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_Component_GetComponent_UIPanel___, *(_QWORD *)&inMode);
    sub_1B4CF90(&Method_UnityEngine_Component_GetComponent_UIScrollView___, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE29C & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_CommandSpellWindowComponent_EndCloseClassBoardEffectListDialog__, v3);
    sub_1B4CF90(&Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__, v4);
  ...
  if ( !this->fields.isOpenClassBoardEffectListDialog )
  {
    ...
    if ( (*((_BYTE *)Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B4CFA8(Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE297 & 1) == 0 )
  {
    sub_1B4CF90(&BalanceConfig_TypeInfo, call);
    ...
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___, v9);
...
LABEL_34:
  ...
  if ( UnityEngine_Object__op_Inequality(classBoardWindowButton, 0LL, 0LL) )
  {
    ...
    SelfUserGame = (UserGameEntity_o *)CondType__IsQuestClear_38126524(ClassBoardReleaseQuestId, -1, 0, 0LL);
    if ( v22 )
    {
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_13:
    sub_1B4D1EC(spellnamelabel, isAddFunction);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE298 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_CommandSpellWindowComponent_cancelSpell__, v5);
    sub_1B4CF90(&Method_CommandSpellWindowComponent_endSpellOpened__, v6);
    sub_1B4CF90(&CondType_TypeInfo, v7);
    sub_1B4CF90(&Method_DataManager_GetMasterData_CommandSpellMaster___, v8);
    sub_1B4CF90(&Method_DataManager_GetMaster_ClassBoardCommandSpellMaster___, v9);
    sub_1B4CF90(&DataManager_TypeInfo, v10);
    sub_1B4CF90(&Method_DataMasterBase_CommandSpellMaster__CommandSpellEntity__int__GetEntity__, v11);
    sub_1B4CF90(&BattleWindowComponent_EndCall_TypeInfo, v12);
    sub_1B4CF90(&BattleWindowOuterClickComponent_OuterClickCall_TypeInfo, v13);
  ...
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0LL) )
  {
    ...
    battlePerf = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( battlePerf )
    {
      ...
      if ( battlePerf )
      {
        ...
        if ( battlePerf )
        {
          if ( this->fields.spellnamelabel )
          {
            ...
            v22 = (BattleWindowComponent_EndCall_o *)sub_1B4D1DC(BattleWindowComponent_EndCall_TypeInfo);
            ...
            if ( checkWindow )
            {
              ...
              v24 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1B4D1DC(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
...
LABEL_23:
    sub_1B4D1EC(battlePerf, *(_QWORD *)&Id);
  }
}
...
void __fastcall CommandSpellWindowComponent__cancelSpell(CommandSpellWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BE29A & 1) == 0 )
  {
    sub_1B4CF90(&Method_CommandSpellWindowComponent_cancelSpell__, method);
    byte_49BE29A = 1;
  }
  if ( this->fields.isOpenFlg )
  {
    ...
    if ( (*((_BYTE *)Method_CommandSpellWindowComponent_cancelSpell__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B4CFA8(Method_CommandSpellWindowComponent_cancelSpell__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE29B & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_Component_GetComponentsInChildren_UIMessageButton___, method);
    sub_1B4CF90(&StringLiteral_12715/*"Sprite"*/, v3);
    byte_49BE29B = 1;
  }
  ...
  if ( !transform
    || (transform = UnityEngine_Component__GetComponentsInChildren_object_(
                      ...
                      1,
                      (const MethodInfo_2EF9018 *)Method_UnityEngine_Component_GetComponentsInChildren_UIMessageButton___)) == 0LL )
  {
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    transform = (void *)System_String__op_Equality(name, (System_String_o *)StringLiteral_12715/*"Sprite"*/, 0LL);
...
void __fastcall CommandSpellWindowComponent__okSpell(CommandSpellWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BE299 & 1) == 0 )
  {
    sub_1B4CF90(&Method_CommandSpellWindowComponent_okSpell__, method);
    byte_49BE299 = 1;
  }
  v3 = Method_CommandSpellWindowComponent_okSpell__;
  if ( (*((_BYTE *)Method_CommandSpellWindowComponent_okSpell__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B4CFA8(Method_CommandSpellWindowComponent_okSpell__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B4CF74(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.callback_use, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._closeBtnObject, (int32_t)value, (int32_t)method, v3);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A04BC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A047C;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A0518;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A04D0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE2A0 & 1) == 0 )
  {
    sub_1B4CF90(&int_TypeInfo, *(_QWORD *)&commandSpellId);
    byte_49BE2A0 = 1;
  }
  v9[1] = 0LL;
...
void __fastcall CommandSpellWindowComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BE2A1 & 1) == 0 )
  {
    sub_1B4CF90(&CommandSpellWindowComponent___c_TypeInfo, v1);
    byte_49BE2A1 = 1;
  }
  v2 = (Il2CppObject *)sub_1B4D1DC(CommandSpellWindowComponent___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  CommandSpellWindowComponent___c_TypeInfo->static_fields->__9 = (struct CommandSpellWindowComponent___c_o *)v2;
  sub_1B4CF34((CGThumbnailListItem_o *)CommandSpellWindowComponent___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
