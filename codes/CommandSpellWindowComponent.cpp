void __fastcall CommandSpellWindowComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A01585 & 1) == 0 )
  {
    sub_1B64870(&CommandSpellWindowComponent_TypeInfo, v1);
    byte_4A01585 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0157B & 1) == 0 )
  {
    sub_1B64870(&Method_System_Array_Sort_CommandSpellEntity___, bp);
    sub_1B64870(&CommandSpellWindowComponent_TypeInfo, v9);
    sub_1B64870(&System_Comparison_CommandSpellEntity__TypeInfo, v10);
    sub_1B64870(&Method_DataManager_GetMasterData_CommandSpellMaster___, v11);
    sub_1B64870(&Method_DataMasterBase_getEntitys_CommandSpellEntity___, v12);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_GameObject__Dispose__, v13);
    ...
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___, v16);
    ...
    sub_1B64870(&Method_CommandSpellWindowComponent___c__InitializeCommandSpell_b__39_0__, v23);
    sub_1B64870(&CommandSpellWindowComponent___c_TypeInfo, v24);
    sub_1B64870(&StringLiteral_15492/*"WINDOWTITLE_COMMANDSPELL_NO_BATTLE"*/, v25);
    sub_1B64870(&StringLiteral_15491/*"WINDOWTITLE_COMMANDSPELL_BATTLE"*/, v26);
    sub_1B64870(&StringLiteral_2806/*"BATTLE_CHECKUSE_COMMANDSPELL"*/, v27);
    sub_1B64870(&StringLiteral_3721/*"COMMAND_SPELL_ADD_FUNCTION_CAUTION_TEXT"*/, v28);
    byte_4A0157B = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)bp, 0LL, 0LL) )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.battlePerf, (int32_t)bp, v30, v31);
  }
  ...
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2806/*"BATTLE_CHECKUSE_COMMANDSPELL"*/, 0LL);
  if ( !checkuselabel )
    goto LABEL_77;
  UILabel__set_text(checkuselabel, (System_String_o *)checkWindow, 0LL);
  classBoardCautionLabel = this->fields.classBoardCautionLabel;
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3721/*"COMMAND_SPELL_ADD_FUNCTION_CAUTION_TEXT"*/, 0LL);
  ...
  checkWindow = (BattleWindowComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !checkWindow )
    goto LABEL_77;
  ...
  Entitys_object = DataMasterBase__getEntitys_object_(
                     ...
                     (const MethodInfo_2E3BF5C *)Method_DataMasterBase_getEntitys_CommandSpellEntity___);
  ...
  if ( !_9__39_0 )
  {
    ...
    _9__39_0 = (System_Comparison_T__o *)sub_1B64ABC(System_Comparison_CommandSpellEntity__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__39_0, (int32_t)_9__39_0, v44, v45);
  }
  System_Array__Sort_object__48273508(
    Entitys_object,
    _9__39_0,
    (const MethodInfo_2E09864 *)Method_System_Array_Sort_CommandSpellEntity___);
  if ( !Entitys_object )
    goto LABEL_77;
...
LABEL_78:
      ...
      if ( ((unsigned __int8)checkWindow & 1) == 0 )
      {
        ...
        checkWindow = (BattleWindowComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   v50,
                                                   (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___);
        ...
        sub_1B64814((ServantStatusBattleListViewItem_o *)&v55->fields._closeBtnObject, (int32_t)this, v56, v57);
        if ( !this->fields.mode )
        ...
        else
        {
          ...
          *(_QWORD *)(v63 + 32) = v50;
          sub_1B64814((ServantStatusBattleListViewItem_o *)(v63 + 32), (int32_t)v50, v58, v59);
        }
      }
LABEL_65:
      max_length = Entitys_object->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0157C & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UIPanel___, *(_QWORD *)&inMode);
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UIScrollView___, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01582 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_CommandSpellWindowComponent_EndCloseClassBoardEffectListDialog__, v3);
    sub_1B64870(&Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__, v4);
  ...
  if ( !this->fields.isOpenClassBoardEffectListDialog )
  {
    ...
    if ( (*((_BYTE *)Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B64888(Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0157D & 1) == 0 )
  {
    sub_1B64870(&BalanceConfig_TypeInfo, call);
    ...
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___, v9);
...
LABEL_34:
  ...
  if ( UnityEngine_Object__op_Inequality(classBoardWindowButton, 0LL, 0LL) )
  {
    ...
    SelfUserGame = (UserGameEntity_o *)CondType__IsQuestClear_37290360(ClassBoardReleaseQuestId, -1, 0, 0LL);
    if ( v22 )
    {
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_13:
    sub_1B64ACC(spellnamelabel, isAddFunction);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0157E & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_CommandSpellWindowComponent_cancelSpell__, v5);
    sub_1B64870(&Method_CommandSpellWindowComponent_endSpellOpened__, v6);
    sub_1B64870(&CondType_TypeInfo, v7);
    sub_1B64870(&Method_DataManager_GetMasterData_CommandSpellMaster___, v8);
    sub_1B64870(&Method_DataManager_GetMaster_ClassBoardCommandSpellMaster___, v9);
    sub_1B64870(&DataManager_TypeInfo, v10);
    sub_1B64870(&Method_DataMasterBase_CommandSpellMaster__CommandSpellEntity__int__GetEntity__, v11);
    sub_1B64870(&BattleWindowComponent_EndCall_TypeInfo, v12);
    sub_1B64870(&BattleWindowOuterClickComponent_OuterClickCall_TypeInfo, v13);
  ...
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0LL) )
  {
    ...
    battlePerf = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( battlePerf )
    {
      ...
      if ( battlePerf )
      {
        ...
        if ( battlePerf )
        {
          if ( this->fields.spellnamelabel )
          {
            ...
            v22 = (BattleWindowComponent_EndCall_o *)sub_1B64ABC(BattleWindowComponent_EndCall_TypeInfo);
            ...
            if ( checkWindow )
            {
              ...
              v24 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1B64ABC(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
...
LABEL_23:
    sub_1B64ACC(battlePerf, *(_QWORD *)&Id);
  }
}
...
void __fastcall CommandSpellWindowComponent__cancelSpell(CommandSpellWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01580 & 1) == 0 )
  {
    sub_1B64870(&Method_CommandSpellWindowComponent_cancelSpell__, method);
    byte_4A01580 = 1;
  }
  if ( this->fields.isOpenFlg )
  {
    ...
    if ( (*((_BYTE *)Method_CommandSpellWindowComponent_cancelSpell__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_CommandSpellWindowComponent_cancelSpell__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01581 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponentsInChildren_UIMessageButton___, method);
    sub_1B64870(&StringLiteral_12849/*"Sprite"*/, v3);
    byte_4A01581 = 1;
  }
  ...
  if ( !transform
    || (transform = UnityEngine_Component__GetComponentsInChildren_object_(
                      ...
                      1,
                      (const MethodInfo_2E32C58 *)Method_UnityEngine_Component_GetComponentsInChildren_UIMessageButton___)) == 0LL )
  {
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    transform = (void *)System_String__op_Equality(name, (System_String_o *)StringLiteral_12849/*"Sprite"*/, 0LL);
...
void __fastcall CommandSpellWindowComponent__okSpell(CommandSpellWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0157F & 1) == 0 )
  {
    sub_1B64870(&Method_CommandSpellWindowComponent_okSpell__, method);
    byte_4A0157F = 1;
  }
  v3 = Method_CommandSpellWindowComponent_okSpell__;
  if ( (*((_BYTE *)Method_CommandSpellWindowComponent_okSpell__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64888(Method_CommandSpellWindowComponent_okSpell__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.callback_use, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._closeBtnObject, (int32_t)value, (int32_t)method, v3);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B0570;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B0530;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B05CC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B0584;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01586 & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&commandSpellId);
    byte_4A01586 = 1;
  }
  v9[1] = 0LL;
...
void __fastcall CommandSpellWindowComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A01587 & 1) == 0 )
  {
    sub_1B64870(&CommandSpellWindowComponent___c_TypeInfo, v1);
    byte_4A01587 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(CommandSpellWindowComponent___c_TypeInfo);
