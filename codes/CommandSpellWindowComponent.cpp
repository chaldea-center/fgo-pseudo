void CommandSpellWindowComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D34295 & 1) == 0 )
  {
    sub_1C93AD4(&CommandSpellWindowComponent_TypeInfo);
    byte_4D34295 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3428B & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Array_Sort_CommandSpellEntity___);
    sub_1C93AD4(&CommandSpellWindowComponent_TypeInfo);
    sub_1C93AD4(&System_Comparison_CommandSpellEntity__TypeInfo);
    ...
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___);
    ...
    sub_1C93AD4(&Method_CommandSpellWindowComponent___c__InitializeCommandSpell_b__39_0__);
    sub_1C93AD4(&CommandSpellWindowComponent___c_TypeInfo);
    sub_1C93AD4(&StringLiteral_15658/*"WINDOWTITLE_COMMANDSPELL_NO_BATTLE"*/);
    sub_1C93AD4(&StringLiteral_15657/*"WINDOWTITLE_COMMANDSPELL_BATTLE"*/);
    sub_1C93AD4(&StringLiteral_2716/*"BATTLE_CHECKUSE_COMMANDSPELL"*/);
    sub_1C93AD4(&StringLiteral_3692/*"COMMAND_SPELL_ADD_FUNCTION_CAUTION_TEXT"*/);
    byte_4D3428B = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)bp, 0, 0) )
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.battlePerf, (int32_t)bp, v10, v11, v12, v13, v14, v15);
  }
  ...
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2716/*"BATTLE_CHECKUSE_COMMANDSPELL"*/, 0);
  if ( !checkuselabel )
    goto LABEL_77;
  UILabel__set_text(checkuselabel, (System_String_o *)checkWindow, 0);
  classBoardCautionLabel = this->fields.classBoardCautionLabel;
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3692/*"COMMAND_SPELL_ADD_FUNCTION_CAUTION_TEXT"*/, 0);
  ...
  checkWindow = (BattleWindowComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !checkWindow )
    goto LABEL_77;
  ...
  Entitys = DataMasterBase_object__object__int___getEntitys(
              ...
              (const MethodInfo_34624F8 *)Method_DataMasterBase_CommandSpellMaster__CommandSpellEntity__int__getEntitys__);
  ...
  if ( !_9__39_0 )
  {
    ...
    _9__39_0 = (System_Comparison_T__o *)sub_1C93D20(System_Comparison_CommandSpellEntity__TypeInfo);
  ...
  System_Array__Sort_object__51842132(
    Entitys,
    _9__39_0,
    (const MethodInfo_3170C54 *)Method_System_Array_Sort_CommandSpellEntity___);
  if ( !Entitys )
    goto LABEL_77;
...
LABEL_78:
      ...
      if ( ((unsigned __int8)checkWindow & 1) == 0 )
      {
        ...
        checkWindow = (BattleWindowComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                                   v38,
                                                   (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_CommandSpellObjectComponent___);
        ...
        else
        {
          ...
          *(_QWORD *)(v59 + 32) = v38;
          sub_1C93A78((GrandQuestFolderBoardItem_o *)(v59 + 32), (int32_t)v38, v50, v51, v52, v53, v54, v55);
        }
      }
LABEL_65:
      max_length = Entitys->max_length;
  ...
  if ( mode )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v62 = &StringLiteral_15657/*"WINDOWTITLE_COMMANDSPELL_BATTLE"*/;
  }
  else
  {
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v62 = &StringLiteral_15658/*"WINDOWTITLE_COMMANDSPELL_NO_BATTLE"*/;
  }
  checkWindow = (BattleWindowComponent_o *)LocalizationManager__Get((System_String_o *)*v62, 0);
  if ( !titleLabel )
LABEL_77:
    sub_1C93D2C(checkWindow, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34292 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_CommandSpellWindowComponent_EndCloseClassBoardEffectListDialog__);
    sub_1C93AD4(&Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__);
  ...
  if ( !this->fields.isOpenClassBoardEffectListDialog )
  {
    ...
    if ( (*((_BYTE *)Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C93AEC(Method_CommandSpellWindowComponent_OnClickClassBoardWindowOpen__);
...
LABEL_34:
  ...
  if ( UnityEngine_Object__op_Inequality(classBoardWindowButton, 0, 0) )
  {
    ...
    SelfUserGame = (UserGameEntity_o *)CondType__IsQuestClear_41038904(ClassBoardReleaseQuestId, -1, 0, 0);
    if ( v14 )
    {
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_11:
    sub_1C93D2C(spellnamelabel, isAddFunction);
  }
...
void CommandSpellWindowComponent__UseSpell(CommandSpellWindowComponent_o *this, int32_t Id, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&BalanceConfig_TypeInfo);
    sub_1C93AD4(&Method_CommandSpellWindowComponent_cancelSpell__);
    sub_1C93AD4(&Method_CommandSpellWindowComponent_endSpellOpened__);
    sub_1C93AD4(&CondType_TypeInfo);
    sub_1C93AD4(&Method_DataManager_GetMasterData_CommandSpellMaster___);
  ...
  if ( BattleWindowComponent__isOpen((BattleWindowComponent_o *)this, 0) )
  {
    ...
    battlePerf = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( battlePerf )
    {
        ...
        if ( battlePerf )
        {
          if ( this->fields.spellnamelabel )
          {
            ...
            if ( checkWindow )
            {
              ...
              v14 = (BattleWindowOuterClickComponent_OuterClickCall_o *)sub_1C93D20(BattleWindowOuterClickComponent_OuterClickCall_TypeInfo);
...
LABEL_23:
    sub_1C93D2C(battlePerf, *(_QWORD *)&Id);
  }
}
...
void CommandSpellWindowComponent__cancelSpell(CommandSpellWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.isOpenFlg )
  {
    ...
    if ( (*((_BYTE *)Method_CommandSpellWindowComponent_cancelSpell__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_CommandSpellWindowComponent_cancelSpell__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D34291 & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_Component_GetComponentsInChildren_UIMessageButton___);
  ...
  if ( !transform
    || (transform = UnityEngine_Component__GetComponentsInChildren_object_(
                      ...
                      1,
                      (const MethodInfo_319BF30 *)Method_UnityEngine_Component_GetComponentsInChildren_UIMessageButton___)) == 0 )
  {
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    transform = (void *)System_String__op_Equality(name, (System_String_o *)StringLiteral_13104/*"Sprite"*/, 0);
...
void CommandSpellWindowComponent__okSpell(CommandSpellWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D3428F & 1) == 0 )
  {
    sub_1C93AD4(&Method_CommandSpellWindowComponent_okSpell__);
    byte_4D3428F = 1;
  }
  v3 = Method_CommandSpellWindowComponent_okSpell__;
  if ( (*((_BYTE *)Method_CommandSpellWindowComponent_okSpell__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_CommandSpellWindowComponent_okSpell__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ACD078;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ACD038;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ACD0D4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ACD08C;
}
...
void CommandSpellWindowComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C93D20(CommandSpellWindowComponent___c_TypeInfo);
