...
void BattleLogicPlayerAi__Initialize(BattleLogicPlayerAi_o *this, BattleData_o *data, const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.aiLogic, (int32_t)aiLogic, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB958D & 1) == 0 )
  {
    ...
    this = (BattleLogicPlayerAi_o *)sub_1C6BA08(&ServantAiActArgument_TypeInfo);
    byte_4CB958D = 1;
  }
  if ( !aiEnt )
    goto LABEL_11;
  ...
  v15 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  ...
  if ( !this
    || (AiState__setBeforeAction((AiState_o *)this, data_high, aiEnt->fields.aiActId, 0),
        v16 = (ServantAiActArgument_o *)sub_1C6BC54(ServantAiActArgument_TypeInfo),
