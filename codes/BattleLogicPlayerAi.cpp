        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.aiLogic, (int64_t)aiLogic, v6, v7, v8, v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24D8C & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, svtData);
    ...
    this = (BattleLogicPlayerAi_o *)sub_1C3B764(&ServantAiActArgument_TypeInfo, v13);
    byte_4C24D8C = 1;
  }
  if ( !aiEnt )
    goto LABEL_11;
  ...
  if ( !this
    || (AiState__setBeforeAction((AiState_o *)this, data_high, aiEnt->fields.aiActId, 0LL),
        v19 = (ServantAiActArgument_o *)sub_1C3B9B0(ServantAiActArgument_TypeInfo),
