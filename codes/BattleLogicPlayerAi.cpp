        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.aiLogic, (int32_t)aiLogic, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5301 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, svtData);
    ...
    this = (BattleLogicPlayerAi_o *)sub_1B00CCC(&ServantAiActArgument_TypeInfo, v12);
    byte_48E5301 = 1;
  }
  if ( !aiEnt )
    goto LABEL_11;
  ...
  v17 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  ...
  if ( !this
    || (AiState__setBeforeAction((AiState_o *)this, data_high, aiEnt->fields.aiActId, 0LL),
        v18 = (ServantAiActArgument_o *)sub_1B00F18(ServantAiActArgument_TypeInfo),
