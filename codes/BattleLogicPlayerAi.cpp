        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.aiLogic, (int64_t)aiLogic, v6, v7, v8, v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB743D & 1) == 0 )
  {
    sub_1C13D24(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, svtData);
    ...
    this = (BattleLogicPlayerAi_o *)sub_1C13D24(&ServantAiActArgument_TypeInfo, v12);
    byte_4BB743D = 1;
  }
  if ( !aiEnt )
    goto LABEL_11;
  ...
  v17 = (System_Collections_Generic_List_object__o *)sub_1C13F70(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  ...
  if ( !this
    || (AiState__setBeforeAction((AiState_o *)this, data_high, aiEnt->fields.aiActId, 0LL),
        v18 = (ServantAiActArgument_o *)sub_1C13F70(ServantAiActArgument_TypeInfo),
