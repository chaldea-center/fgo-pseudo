        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.aiLogic, (int32_t)aiLogic, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04FE4 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, svtData);
    ...
    this = (BattleLogicPlayerAi_o *)sub_1BC3008(&ServantAiActArgument_TypeInfo, v13);
    byte_4B04FE4 = 1;
  }
  if ( !aiEnt )
    goto LABEL_11;
  ...
  if ( !this
    || (AiState__setBeforeAction((AiState_o *)this, data_high, aiEnt->fields.aiActId, 0LL),
        v19 = (ServantAiActArgument_o *)sub_1BC3254(ServantAiActArgument_TypeInfo),
