        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.aiLogic, (int32_t)aiLogic, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B858 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, svtData);
    ...
    this = (BattleLogicPlayerAi_o *)sub_1B686D4(&ServantAiActArgument_TypeInfo, v12);
    byte_4A0B858 = 1;
  }
  if ( !aiEnt )
    goto LABEL_11;
  ...
  v17 = (System_Collections_Generic_List_object__o *)sub_1B68920(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  ...
  if ( !this
    || (AiState__setBeforeAction((AiState_o *)this, data_high, aiEnt->fields.aiActId, 0LL),
        v18 = (ServantAiActArgument_o *)sub_1B68920(ServantAiActArgument_TypeInfo),
