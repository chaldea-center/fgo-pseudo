        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.aiLogic, (int32_t)aiLogic, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDCC6 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, svtData);
    ...
    this = (BattleLogicPlayerAi_o *)sub_1B4CF90(&ServantAiActArgument_TypeInfo, v13);
    byte_49BDCC6 = 1;
  }
  if ( !aiEnt )
    goto LABEL_11;
  ...
  if ( !this
    || (AiState__setBeforeAction((AiState_o *)this, data_high, aiEnt->fields.aiActId, 0LL),
        v19 = (ServantAiActArgument_o *)sub_1B4D1DC(ServantAiActArgument_TypeInfo),
