        ...
        const MethodInfo *method)
{
  if ( (byte_4BB570D & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_string__int___, *(_QWORD *)&form);
    byte_4BB570D = 1;
  }
  return DataEntityBase__CreateMultiplePK_object__int_(
           (Il2CppObject *)imageId,
           form,
           (const MethodInfo_2F8D8A0 *)Method_DataEntityBase_CreateMultiplePK_string__int___);
}
