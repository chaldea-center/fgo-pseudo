        ...
        const MethodInfo *method)
{
  if ( (byte_4B381A9 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_string__int___, *(_QWORD *)&form);
    byte_4B381A9 = 1;
  }
  return DataEntityBase__CreateMultiplePK_object__int_(
           (Il2CppObject *)imageId,
           form,
           (const MethodInfo_2F2FAB8 *)Method_DataEntityBase_CreateMultiplePK_string__int___);
}
