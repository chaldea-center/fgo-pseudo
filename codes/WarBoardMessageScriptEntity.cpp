        ...
        const MethodInfo *method)
{
  if ( (byte_4B45BAF & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_string__int___, *(_QWORD *)&form);
    byte_4B45BAF = 1;
  }
  return DataEntityBase__CreateMultiplePK_object__int_(
           (Il2CppObject *)imageId,
           form,
           (const MethodInfo_3031CF4 *)Method_DataEntityBase_CreateMultiplePK_string__int___);
}
