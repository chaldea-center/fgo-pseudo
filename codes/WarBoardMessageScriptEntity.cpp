        ...
        const MethodInfo *method)
{
  if ( (byte_4A2EEFB & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_string__int___, *(_QWORD *)&form);
    byte_4A2EEFB = 1;
  }
  return DataEntityBase__CreateMultiplePK_object__int_(
           (Il2CppObject *)imageId,
           form,
           (const MethodInfo_2E6083C *)Method_DataEntityBase_CreateMultiplePK_string__int___);
}
