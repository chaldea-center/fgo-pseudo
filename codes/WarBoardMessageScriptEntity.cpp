        ...
        const MethodInfo *method)
{
  if ( (byte_4B0315C & 1) == 0 )
  {
    sub_1BC3008(&Method_DataEntityBase_CreateMultiplePK_string__int___, *(_QWORD *)&form);
    byte_4B0315C = 1;
  }
  return DataEntityBase__CreateMultiplePK_object__int_(
           (Il2CppObject *)imageId,
           form,
           (const MethodInfo_30001FC *)Method_DataEntityBase_CreateMultiplePK_string__int___);
}
