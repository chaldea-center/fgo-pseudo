        ...
        const MethodInfo *method)
{
  if ( (byte_4B67BE4 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_string__int___, *(_QWORD *)&form);
    byte_4B67BE4 = 1;
  }
  return DataEntityBase__CreateMultiplePK_object__int_(
           (Il2CppObject *)imageId,
           form,
           (const MethodInfo_2F57544 *)Method_DataEntityBase_CreateMultiplePK_string__int___);
}
