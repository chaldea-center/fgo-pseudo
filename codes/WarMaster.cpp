void __fastcall WarMaster___ctor(WarMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B0320E & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_WarMaster__WarEntity__int___ctor__, method);
    byte_4B0320E = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    4,
    (const MethodInfo_32ACD4C *)Method_DataMasterBase_WarMaster__WarEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0320F & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Linq_Enumerable_Select_WarEntity__WarEntity___, method);
    sub_1BC3008(&Method_System_Linq_Enumerable_ToList_WarEntity___, v3);
    sub_1BC3008(&System_Func_WarEntity__WarEntity__TypeInfo, v4);
    sub_1BC3008(&Method_WarMaster___c__GetEntityList_b__1_0__, v5);
    sub_1BC3008(&WarMaster___c_TypeInfo, v6);
    byte_4B0320F = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Func_object__object__o *)sub_1BC3254(System_Func_WarEntity__WarEntity__TypeInfo);
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->__9__1_0, (int32_t)_9__1_0, v12, v13);
  }
  v14 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               (System_Collections_Generic_IEnumerable_TSource__o *)list,
                                                               (System_Func_TSource__TResult__o *)_9__1_0,
                                                               (const MethodInfo_3036320 *)Method_System_Linq_Enumerable_Select_WarEntity__WarEntity___);
  return (System_Collections_Generic_List_WarEntity__o *)System_Linq_Enumerable__ToList_object_(
                                                           v14,
                                                           (const MethodInfo_3042DE0 *)Method_System_Linq_Enumerable_ToList_WarEntity___);
}
...
int64_t __fastcall WarMaster__GetEventStartAt(WarMaster_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4B03217 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_EventMaster___, *(_QWORD *)&warId);
    sub_1BC3008(&DataManager_TypeInfo, v4);
    sub_1BC3008(&Method_DataMasterBase_EventMaster__EventEntity__int__TryGetEntity__, v5);
    byte_4B03217 = 1;
  }
  entity = 0LL;
...
bool __fastcall WarMaster__IsClearAllMainScenario(WarMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03216 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__, method);
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__, v3);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_324A858 *)Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__);
  if ( Count >= 1 )
  {
    v7 = Count;
    v8 = 0;
    ...
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v8,
                                                                 (const MethodInfo_324A8E8 *)Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__);
      if ( !list )
        break;
      v11 = list;
      ...
      if ( CondType__IsQuestClear_39366056(klass_high, -1, 0, 0LL) )
      {
LABEL_20:
        v9 = ++v8 < v7;
        if ( v7 != v8 )
...
bool __fastcall WarMaster__IsLastQuest(int32_t warId, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4B03215 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_WarMaster___, *(_QWORD *)&questId);
    sub_1BC3008(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v5);
    sub_1BC3008(&StringLiteral_6346/*"FES_WAR_ID"*/, v6);
    byte_4B03215 = 1;
  }
  ...
  {
    v11 = v10;
    if ( ConstantMaster__getValue((System_String_o *)StringLiteral_6346/*"FES_WAR_ID"*/, 0LL) == warId && v11->fields.id == warId )
      return 1;
  }
  return result;
}
...
WarEntity_o *__fastcall WarMaster__getByEventId(WarMaster_o *this, int32_t event_id, const MethodInfo *method)
{
  ...
  if ( (byte_4B03211 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__, *(_QWORD *)&event_id);
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__, v5);
    byte_4B03211 = 1;
  }
  result = (WarEntity_o *)this->fields.list;
  if ( !result )
LABEL_10:
    sub_1BC3264(result, *(_QWORD *)&event_id);
  v7 = 0;
...
WarEntity_o *__fastcall WarMaster__getByLastQuestId(WarMaster_o *this, int32_t last_quest_id, const MethodInfo *method)
{
  ...
  if ( (byte_4B03210 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__, *(_QWORD *)&last_quest_id);
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__, v5);
    byte_4B03210 = 1;
  }
  result = (WarEntity_o *)this->fields.list;
  if ( !result )
LABEL_10:
    sub_1BC3264(result, *(_QWORD *)&last_quest_id);
  v7 = 0;
  while ( v7 < System_Collections_ObjectModel_Collection_object___get_Count(
                 (System_Collections_ObjectModel_Collection_T__o *)result,
                 (const MethodInfo_324A858 *)Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__) )
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)list & 1) == 0 )
      {
        ...
        if ( klass_high >= 1 )
        {
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          list = (System_Collections_ObjectModel_Collection_T__o *)CondType__IsQuestClear_39366056(
                                                                     klass_high,
                                                                     -1,
                                                                     0,
                                                                     0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03213 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__, ids);
    sub_1BC3008(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__, v5);
    sub_1BC3008(&System_Comparison_WarEntity__TypeInfo, v6);
    sub_1BC3008(&Method_System_Collections_Generic_List_WarEntity__Add__, v7);
    sub_1BC3008(&Method_System_Collections_Generic_List_int__Remove__, v8);
    sub_1BC3008(&Method_System_Collections_Generic_List_WarEntity__Sort__, v9);
    sub_1BC3008(&Method_System_Collections_Generic_List_WarEntity__ToArray__, v10);
    sub_1BC3008(&Method_System_Collections_Generic_List_WarEntity___ctor__, v11);
    sub_1BC3008(&Method_System_Collections_Generic_List_int__get_Count__, v12);
    sub_1BC3008(&System_Collections_Generic_List_WarEntity__TypeInfo, v13);
    sub_1BC3008(&Method_WarMaster___c__getPrioredWarEntsWithIds_b__5_0__, v14);
    sub_1BC3008(&WarMaster___c_TypeInfo, v15);
    byte_4B03213 = 1;
  }
  v16 = (System_Collections_Generic_List_object__o *)sub_1BC3254(System_Collections_Generic_List_WarEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v16,
    (const MethodInfo_36A060C *)Method_System_Collections_Generic_List_WarEntity___ctor__);
  list = this->fields.list;
  if ( !list )
    goto LABEL_26;
  v19 = 0;
  ...
  if ( !v27 )
  {
    ...
    v27 = (System_Comparison_T__o *)sub_1BC3254(System_Comparison_WarEntity__TypeInfo);
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->__9__5_0, (int32_t)v27, v30, v31);
  }
  if ( !v16 )
LABEL_26:
  ...
  System_Collections_Generic_List_object___Sort_57288964(
    v16,
    v27,
    (const MethodInfo_36A2904 *)Method_System_Collections_Generic_List_WarEntity__Sort__);
  return (WarEntity_array *)System_Collections_Generic_List_object___ToArray(
                              v16,
                              (const MethodInfo_36A2998 *)Method_System_Collections_Generic_List_WarEntity__ToArray__);
}
...
void __fastcall WarMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B03218 & 1) == 0 )
  {
    sub_1BC3008(&WarMaster___c_TypeInfo, v1);
    byte_4B03218 = 1;
  }
  v2 = (Il2CppObject *)sub_1BC3254(WarMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  WarMaster___c_TypeInfo->static_fields->__9 = (struct WarMaster___c_o *)v2;
  sub_1BC2FAC((CGThumbnailListItem_o *)WarMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
