void __fastcall WarMaster___ctor(WarMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E37D5 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_WarMaster__WarEntity__int___ctor__, method);
    byte_48E37D5 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    4,
    (const MethodInfo_2FE6A0C *)Method_DataMasterBase_WarMaster__WarEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E37D6 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Linq_Enumerable_Select_DataEntityBase__WarEntity___, method);
    sub_1B00CCC(&Method_System_Linq_Enumerable_ToList_WarEntity___, v3);
    sub_1B00CCC(&System_Func_DataEntityBase__WarEntity__TypeInfo, v4);
    sub_1B00CCC(&Method_WarMaster___c__GetEntityList_b__1_0__, v5);
    sub_1B00CCC(&WarMaster___c_TypeInfo, v6);
    byte_48E37D6 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Func_object__object__o *)sub_1B00F18(System_Func_DataEntityBase__WarEntity__TypeInfo);
  ...
  v14 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               ...
                                                               (const MethodInfo_2D8FA10 *)Method_System_Linq_Enumerable_Select_DataEntityBase__WarEntity___);
  return (System_Collections_Generic_List_WarEntity__o *)System_Linq_Enumerable__ToList_object_(
                                                           v14,
                                                           (const MethodInfo_2D9AFD4 *)Method_System_Linq_Enumerable_ToList_WarEntity___);
}
...
bool __fastcall WarMaster__IsClearAllMainScenario(WarMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E37DD & 1) == 0 )
  {
    ...
    sub_1B00CCC(&WarEntity_TypeInfo, v5);
    byte_48E37DD = 1;
  }
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( CondType__IsQuestClear_36399468(klass_high, -1, 0, 0LL) )
      {
LABEL_22:
        v10 = ++v9 < v8;
        if ( v8 != v9 )
...
bool __fastcall WarMaster__IsLastQuest(int32_t warId, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_48E37DC & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_WarMaster___, *(_QWORD *)&questId);
  ...
  {
    v11 = v10;
    if ( ConstantMaster__getValue((System_String_o *)StringLiteral_6299/*"FES_WAR_ID"*/, 0LL) == warId && v11->fields.id == warId )
      return 1;
  }
  return result;
}
...
WarEntity_o *__fastcall WarMaster__getByEventId(WarMaster_o *this, int32_t event_id, const MethodInfo *method)
{
  ...
  if ( (byte_48E37D8 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&event_id);
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B00CCC(&WarEntity_TypeInfo, v6);
    byte_48E37D8 = 1;
  }
  result = (WarEntity_o *)this->fields.list;
  if ( !result )
LABEL_12:
    sub_1B00F28(result, *(_QWORD *)&event_id);
  v8 = 0;
...
WarEntity_o *__fastcall WarMaster__getByLastQuestId(WarMaster_o *this, int32_t last_quest_id, const MethodInfo *method)
{
  ...
  if ( !result )
LABEL_12:
    sub_1B00F28(result, *(_QWORD *)&last_quest_id);
  v8 = 0;
  while ( v8 < System_Collections_ObjectModel_Collection_object___get_Count(
                 (System_Collections_ObjectModel_Collection_T__o *)result,
                 (const MethodInfo_2F836B0 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__) )
...
System_Int32_array *__fastcall WarMaster__getClearWarIdList(WarMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E37DB & 1) == 0 )
  {
    ...
    sub_1B00CCC(&WarEntity_TypeInfo, v9);
    byte_48E37DB = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)list & 1) == 0 )
      {
        ...
        if ( klass_high >= 1 )
        {
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          list = (System_Collections_ObjectModel_Collection_T__o *)CondType__IsQuestClear_36399468(
                                                                     klass_high,
                                                                     -1,
                                                                     0,
                                                                     0LL);
...
int32_t __fastcall WarMaster__getEventID(int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_48E37D9 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataMasterBase_WarMaster__WarEntity__int__GetEntity__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E37DA & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, ids);
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B00CCC(&System_Comparison_WarEntity__TypeInfo, v6);
    sub_1B00CCC(&Method_System_Collections_Generic_List_WarEntity__Add__, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_int__Remove__, v8);
    sub_1B00CCC(&Method_System_Collections_Generic_List_WarEntity__Sort__, v9);
    sub_1B00CCC(&Method_System_Collections_Generic_List_WarEntity__ToArray__, v10);
    sub_1B00CCC(&Method_System_Collections_Generic_List_WarEntity___ctor__, v11);
    sub_1B00CCC(&Method_System_Collections_Generic_List_int__get_Count__, v12);
    sub_1B00CCC(&System_Collections_Generic_List_WarEntity__TypeInfo, v13);
    sub_1B00CCC(&Method_WarMaster___c__getPrioredWarEntsWithIds_b__5_0__, v14);
    sub_1B00CCC(&WarMaster___c_TypeInfo, v15);
    sub_1B00CCC(&WarEntity_TypeInfo, v16);
    byte_48E37DA = 1;
  }
  v17 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_WarEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_33C119C *)Method_System_Collections_Generic_List_WarEntity___ctor__);
  list = this->fields.list;
  if ( !list )
    goto LABEL_28;
  v20 = 0;
  while ( 1 )
  {
    ...
    if ( ((unsigned __int8)list & 1) != 0 )
    {
      ...
      else
      {
        ...
        sub_1B00C70((ServantStatusBattleListViewItem_o *)(v28 + 4), (int32_t)v21, v23, v24);
      }
    }
    list = this->fields.list;
    ++v20;
  ...
  if ( !v29 )
  {
    ...
    v29 = (System_Comparison_T__o *)sub_1B00F18(System_Comparison_WarEntity__TypeInfo);
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->__9__5_0, (int32_t)v29, v32, v33);
  }
  if ( !v17 )
LABEL_28:
  ...
  return (WarEntity_array *)System_Collections_Generic_List_object___ToArray(
                              v17,
                              (const MethodInfo_33C3528 *)Method_System_Collections_Generic_List_WarEntity__ToArray__);
}
...
void __fastcall WarMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E37DE & 1) == 0 )
  {
    sub_1B00CCC(&WarMaster___c_TypeInfo, v1);
    byte_48E37DE = 1;
  }
  v2 = (Il2CppObject *)sub_1B00F18(WarMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  WarMaster___c_TypeInfo->static_fields->__9 = (struct WarMaster___c_o *)v2;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)WarMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E37DF & 1) == 0 )
  {
    sub_1B00CCC(&WarEntity_TypeInfo, data);
    byte_48E37DF = 1;
  }
  if ( !data )
    return 0LL;
