void WarMaster___ctor(WarMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E05C7F & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_WarMaster__WarEntity__int___ctor__);
    byte_4E05C7F = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    4,
    (const MethodInfo_34E6CE4 *)Method_DataMasterBase_WarMaster__WarEntity__int___ctor__);
}
...
System_Collections_Generic_List_WarEntity__o *WarMaster__GetEntityList(WarMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E05C80 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Linq_Enumerable_Select_WarEntity__WarEntity___);
    sub_1CE6700(&Method_System_Linq_Enumerable_ToList_WarEntity___);
    sub_1CE6700(&System_Func_WarEntity__WarEntity__TypeInfo);
    sub_1CE6700(&Method_WarMaster___c__GetEntityList_b__1_0__);
    sub_1CE6700(&WarMaster___c_TypeInfo);
    byte_4E05C80 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Func_object__object__o *)sub_1CE694C(System_Func_WarEntity__WarEntity__TypeInfo);
  ...
  v14 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               ...
                                                               (const MethodInfo_323A63C *)Method_System_Linq_Enumerable_Select_WarEntity__WarEntity___);
  return (System_Collections_Generic_List_WarEntity__o *)System_Linq_Enumerable__ToList_object_(
                                                           v14,
                                                           (const MethodInfo_3248A54 *)Method_System_Linq_Enumerable_ToList_WarEntity___);
}
...
bool WarMaster__IsClearAllMainScenario(WarMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E05C87 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__);
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__);
  if ( Count >= 1 )
  {
    v5 = Count;
    v6 = 0;
    ...
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v6,
                                                                 (const MethodInfo_3480B40 *)Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__);
      if ( !list )
        break;
      v9 = list;
...
bool WarMaster__IsLastQuest(int32_t warId, int32_t questId, const MethodInfo *method)
{
  ...
  {
    v9 = v8;
    if ( ConstantMaster__getValue((System_String_o *)StringLiteral_6447/*"FES_WAR_ID"*/, 0) == warId && v9->fields.id == warId )
      return 1;
  }
  return result;
}
...
WarEntity_o *WarMaster__getByEventId(WarMaster_o *this, int32_t event_id, const MethodInfo *method)
{
  ...
  if ( !result )
LABEL_10:
    sub_1CE6958(result, *(_QWORD *)&event_id);
  v6 = 0;
...
WarEntity_o *WarMaster__getByLastQuestId(WarMaster_o *this, int32_t last_quest_id, const MethodInfo *method)
{
  ...
  if ( !result )
LABEL_10:
    sub_1CE6958(result, *(_QWORD *)&last_quest_id);
  v6 = 0;
  while ( v6 < System_Collections_ObjectModel_Collection_object___get_Count(
                 (System_Collections_ObjectModel_Collection_T__o *)result,
                 (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__) )
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)list & 1) == 0 )
      {
        ...
        if ( klass_high >= 1 )
        {
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          list = (System_Collections_ObjectModel_Collection_T__o *)CondType__IsQuestClear_41467300(klass_high, -1, 0, 0);
          if ( ((unsigned __int8)list & 1) != 0 )
          {
            if ( !v5 )
              break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E05C84 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_WarEntity__get_Item__);
    sub_1CE6700(&System_Comparison_WarEntity__TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_WarEntity__Add__);
    sub_1CE6700(&Method_System_Collections_Generic_List_int__Remove__);
    sub_1CE6700(&Method_System_Collections_Generic_List_WarEntity__Sort__);
    sub_1CE6700(&Method_System_Collections_Generic_List_WarEntity__ToArray__);
    sub_1CE6700(&Method_System_Collections_Generic_List_WarEntity___ctor__);
    sub_1CE6700(&Method_System_Collections_Generic_List_int__get_Count__);
    sub_1CE6700(&System_Collections_Generic_List_WarEntity__TypeInfo);
    sub_1CE6700(&Method_WarMaster___c__getPrioredWarEntsWithIds_b__5_0__);
    sub_1CE6700(&WarMaster___c_TypeInfo);
    byte_4E05C84 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_WarEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_WarEntity___ctor__);
  list = this->fields.list;
  if ( !list )
    goto LABEL_26;
  v8 = 0;
  ...
  if ( !v20 )
  {
    ...
    v20 = (System_Comparison_T__o *)sub_1CE694C(System_Comparison_WarEntity__TypeInfo);
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&static_fields->__9__5_0, (int32_t)v20, v23, v24, v25, v26, v27, v28);
  }
  if ( !v5 )
LABEL_26:
    sub_1CE6958(list, v6);
  System_Collections_Generic_List_object___Sort_59800108(
    v5,
    v20,
    (const MethodInfo_3907A2C *)Method_System_Collections_Generic_List_WarEntity__Sort__);
  return (WarEntity_array *)System_Collections_Generic_List_object___ToArray(
                              v5,
                              (const MethodInfo_3907AC0 *)Method_System_Collections_Generic_List_WarEntity__ToArray__);
}
...
void WarMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(WarMaster___c_TypeInfo);
  System_Object___ctor(v1, 0);
  WarMaster___c_TypeInfo->static_fields->__9 = (struct WarMaster___c_o *)v1;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)WarMaster___c_TypeInfo->static_fields, (int32_t)v1, v2, v3, v4, v5, v6, v7);
}
