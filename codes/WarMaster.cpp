void __fastcall WarMaster___ctor(WarMaster_o *this, const MethodInfo *method)
{
  if ( (byte_43526B1 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_WarMaster__WarEntity__int___ctor__);
    byte_43526B1 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    4,
    (const MethodInfo_21C03A4 *)Method_DataMasterBase_WarMaster__WarEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43526B2 & 1) == 0 )
  {
    sub_B70694(&Method_System_Linq_Enumerable_Select_DataEntityBase__WarEntity___);
    sub_B70694(&Method_System_Linq_Enumerable_ToList_WarEntity___);
    sub_B70694(&Method_System_Func_DataEntityBase__WarEntity___ctor__);
    sub_B70694(&System_Func_DataEntityBase__WarEntity__TypeInfo);
    sub_B70694(&Method_WarMaster___c__GetEntityList_b__1_0__);
    sub_B70694(&WarMaster___c_TypeInfo);
    byte_43526B2 = 1;
  }
  ...
  if ( !_9__1_0 )
  {
    ...
    _9__1_0 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__WarBoardPieceData__o *)sub_B70764(System_Func_DataEntityBase__WarEntity__TypeInfo);
    System_Func_WarBoardManager_WarBoardOnboardSkillTarget__WarBoardPieceData____ctor(
      _9__1_0,
      v7,
      Method_WarMaster___c__GetEntityList_b__1_0__,
      (const MethodInfo_29ADCC4 *)Method_System_Func_DataEntityBase__WarEntity___ctor__);
  ...
  v15 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_WarBoardManager_WarBoardOnboardSkillTarget__WarBoardPieceData_(
                                                               ...
                                                               (const MethodInfo_1CC4218 *)Method_System_Linq_Enumerable_Select_DataEntityBase__WarEntity___);
  return (System_Collections_Generic_List_WarEntity__o *)System_Linq_Enumerable__ToList_WarBoardManager_WarBoardOnboardSkillTarget_(
                                                           v15,
                                                           (const MethodInfo_1CCB668 *)Method_System_Linq_Enumerable_ToList_WarEntity___);
}
  ...
  while ( 1 )
  {
    ...
    if ( WarEntity__HasFlag((WarEntity_o *)list, 128, v7) )
    {
      ...
      if ( klass_high >= 1 )
      {
        ...
        if ( !CondType__IsQuestClear_24296868(klass_high, -1, 0, 0LL) )
          return 0;
      }
    }
    if ( ++v6 >= v5 )
...
bool __fastcall WarMaster__IsLastQuest(int32_t warId, int32_t questId, const MethodInfo *method)
{
  ...
  {
    v9 = v8;
    if ( ConstantMaster__getValue((System_String_o *)StringLiteral_6425/*"FES_WAR_ID"*/, 0LL) == warId && v9->fields.id == warId )
      return 1;
  }
  return result;
}
...
WarEntity_o *__fastcall WarMaster__getByEventId(WarMaster_o *this, int32_t event_id, const MethodInfo *method)
{
  ...
  if ( !result )
LABEL_12:
    sub_B7076C(result, *(_QWORD *)&event_id);
  v6 = 0;
...
WarEntity_o *__fastcall WarMaster__getByLastQuestId(WarMaster_o *this, int32_t last_quest_id, const MethodInfo *method)
{
  ...
  if ( !result )
LABEL_12:
    sub_B7076C(result, *(_QWORD *)&last_quest_id);
  v6 = 0;
  while ( v6 < System_Collections_ObjectModel_Collection_UnicastIPAddressInformation___get_Count(
                 (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)result,
                 (const MethodInfo_2C85F70 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__) )
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)list & 1) == 0 )
      {
        ...
        if ( klass_high >= 1 )
        {
          if ( (BYTE3(CondType_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          list = (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)CondType__IsQuestClear_24296868(
                                                                                               klass_high,
                                                                                               -1,
                                                                                               0,
                                                                                               0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43526B6 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_System_Collections_Generic_List_WarEntity__Add__);
    ...
    sub_B70694(&Method_System_Collections_Generic_List_WarEntity__ToArray__);
    sub_B70694(&Method_System_Collections_Generic_List_WarEntity___ctor__);
    sub_B70694(&Method_System_Collections_Generic_List_int__get_Count__);
    sub_B70694(&System_Collections_Generic_List_WarEntity__TypeInfo);
    sub_B70694(&Method_WarMaster___c__getPrioredWarEntsWithIds_b__5_0__);
    sub_B70694(&WarMaster___c_TypeInfo);
    sub_B70694(&WarEntity_TypeInfo);
    byte_43526B6 = 1;
  }
  v5 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B70764(System_Collections_Generic_List_WarEntity__TypeInfo);
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v5,
    (const MethodInfo_30249C4 *)Method_System_Collections_Generic_List_WarEntity___ctor__);
  list = this->fields.list;
  if ( !list )
    goto LABEL_27;
  v8 = 0;
          ...
          && *(WarEntity_c **)(*(_QWORD *)(*(_QWORD *)list + 200LL) + 8 * v10 - 8) == WarEntity_TypeInfo )
        {
          ...
          if ( ((unsigned __int8)list & 1) != 0 )
          {
            ...
            System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
              v5,
              v9,
              (const MethodInfo_3025688 *)Method_System_Collections_Generic_List_WarEntity__Add__);
          }
          list = this->fields.list;
          ++v8;
          if ( list )
  ...
  if ( !_9__5_0 )
  {
    ...
    _9__5_0 = (System_Comparison_TitleInfoControl_EventEndTimeInfo__o *)sub_B70764(System_Comparison_WarEntity__TypeInfo);
...
LABEL_27:
  ...
  return (WarEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                              ...
                              (const MethodInfo_30277D4 *)Method_System_Collections_Generic_List_WarEntity__ToArray__);
}
...
void __fastcall WarMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B70764(WarMaster___c_TypeInfo);
