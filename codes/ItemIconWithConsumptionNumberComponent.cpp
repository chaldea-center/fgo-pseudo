        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21414 & 1) == 0 )
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, *(_QWORD *)&consumptionNumber);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v4);
    sub_1C3B764(&StringLiteral_11096/*"RestorePurchases continuing: "*/, v5);
    byte_4C21414 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(consumptionNumberLabel, 0LL, 0LL) )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11096/*"RestorePurchases continuing: "*/, 0LL);
