        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3B9D & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, *(_QWORD *)&consumptionNumber);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v4);
    sub_1C13D24(&StringLiteral_11062/*"QUEST_CONFIRM_CONSUME_AP_RETIRE"*/, v5);
    byte_4BB3B9D = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(consumptionNumberLabel, 0LL, 0LL) )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11062/*"QUEST_CONFIRM_CONSUME_AP_RETIRE"*/, 0LL);
