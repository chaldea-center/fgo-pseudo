        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6F6B & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, *(_QWORD *)&consumptionNumber);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v4);
    sub_1C1ABD4(&StringLiteral_11071/*"QUEST_CONFIRM_NO_CONSUME_COUNT"*/, v5);
    byte_4BC6F6B = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(consumptionNumberLabel, 0LL, 0LL) )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11071/*"QUEST_CONFIRM_NO_CONSUME_COUNT"*/, 0LL);
