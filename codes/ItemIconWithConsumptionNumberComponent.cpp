        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA328 & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, *(_QWORD *)&consumptionNumber);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v4);
    sub_1B4CF90(&StringLiteral_10653/*"QUEST_CONFIRM_NO_CONSUME_COUNT"*/, v5);
    byte_49BA328 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(consumptionNumberLabel, 0LL, 0LL) )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_10653/*"QUEST_CONFIRM_NO_CONSUME_COUNT"*/, 0LL);
