        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.iconLabelInfo1, (int32_t)v11, v12, v13);
  v14 = (IconLabelInfo_o *)sub_1C2D6DC(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v14, 0);
  this->fields.iconLabelInfo2 = v14;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.iconLabelInfo2, (int32_t)v14, v15, v16);
...
void CheckMaterialSvtListViewItem___ctor_48442832(
        CheckMaterialSvtListViewItem_o *this,
        int32_t index,
...
LABEL_8:
      sub_1C2D6EC(UserCommandCodeEntity_k__BackingField, type);
    }
    return -1;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v19.fields.fakeValue = v10;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v19, 0);
    if ( !v12
      || (Entity = DataMasterBase_object__object__int___GetEntity(
                     v12,
                     (int32_t)Instance,
          ...
          sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servantEntity, (int32_t)Entity, v14, v15),
...
LABEL_15:
  ...
  else
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servantEntity, 0, v17, v18);
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2B395 & 1) == 0 )
  {
    ...
    this = (CheckMaterialSvtListViewItem_o *)sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C2B395 = 1;
  }
  if ( type == 1 )
  {
    ...
    *(_OWORD *)&v20.fields.fakeValue = v8;
    ...
    if ( !this
      || (IsKeepServantEquip = ServantEntity__get_IsKeepServantEquip((ServantEntity_o *)this, 0),
          (this = (CheckMaterialSvtListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
        ...
        if ( IsKeepServantEquip )
        {
          ...
          if ( sortValue0 )
          {
            ...
            *(_OWORD *)&v19.fields.fakeValue = v13;
            ...
            v18 = v19;
            v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48831392(&v18, 0);
            v17 = v20;
            if ( v14 == CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48831392(&v17, 0) )
            {
        ...
        const MethodInfo *method)
{
  ...
  if ( type != 2 )
  {
    if ( type != 1 )
      return;
    this = (CheckMaterialSvtListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
      this = (CheckMaterialSvtListViewItem_o *)DataManager__GetMasterData_object_(
                                                 (DataManager_o *)this,
          ...
          if ( servantEntity )
          {
            ...
            if ( UserServantEntity_k__BackingField )
            {
              ...
              *(_QWORD *)&v13.fields.fakeValue = v8;
              v4->fields.sortValue2B = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v13, 0);
              return;
            }
          }
        }
...
LABEL_18:
  ...
  *(_QWORD *)&v14.fields.fakeValue = v11;
  v4->fields.sortValue1B = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v14, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2B399 & 1) == 0 )
  {
    this = (CheckMaterialSvtListViewItem_o *)sub_1C2D490(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    byte_4C2B399 = 1;
  }
