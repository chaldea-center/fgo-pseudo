        ...
        const MethodInfo *method)
{
  ...
  CheckMaterialSvtListViewItem__Init(this, index, v29);
  CheckMaterialSvtListViewItem__SetServantData(this, userServantEntity, v30);
  CheckMaterialSvtListViewItem__SetCommandCodeData(this, 0LL, v31);
  CheckMaterialSvtListViewItem__SetData(this, 1, v32);
  CheckMaterialSvtListViewItem__SetServantUses(this, 1, v33, v34, v35);
  this->fields._IsFavorite_k__BackingField = isFavorite;
  CheckMaterialSvtListViewItem__SetSortValues(this, 1, v36);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall CheckMaterialSvtListViewItem___ctor_26918076(
        CheckMaterialSvtListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  CheckMaterialSvtListViewItem__SetServantData(this, 0LL, v28);
  CheckMaterialSvtListViewItem__SetCommandCodeData(this, userCommandCodeEntity, v29);
  CheckMaterialSvtListViewItem__SetData(this, 2, v30);
  CheckMaterialSvtListViewItem__SetServantUses(this, 2, v31, v32, v33);
  this->fields._IsCommandCodeEquipped_k__BackingField = isCommandCodeEquipped;
  CheckMaterialSvtListViewItem__SetSortValues(this, 2, v34);
        ...
        const MethodInfo *method)
{
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v36.fields.fakeValue = v16;
    v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44068536(v36, 0LL);
    if ( !v18
...
LABEL_17:
    ...
    this->fields._IsChoice_k__BackingField = UserServantEntity__IsChoice(v29, 0LL);
  }
  else
  {
    ...
    sub_B16F98((BattleServantConfConponent_o *)&this->fields.servantEntity, 0LL, v30, v31, v32, v33, v34, v35);
    if ( (BYTE3(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
