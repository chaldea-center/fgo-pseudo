...
// local variable allocation has failed, the output may be wrong!
void __fastcall CheckMaterialSvtListViewItem___ctor_46717188(
        CheckMaterialSvtListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v34.fields.fakeValue = v17;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v34, 0LL);
    if ( !v19
      || (Entity = DataMasterBase_object__object__int___GetEntity(
                     v19,
                     (int32_t)Instance,
...
LABEL_15:
  ...
  else
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.servantEntity, 0LL, v28, v29, v30, v31, v32, v33);
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25B44 & 1) == 0 )
  {
    ...
    this = (CheckMaterialSvtListViewItem_o *)sub_1C3B764(
    ...
    *(_OWORD *)&v25.fields.fakeValue = v13;
    ...
    if ( !this
      || (IsKeepServantEquip = ServantEntity__get_IsKeepServantEquip((ServantEntity_o *)this, 0LL),
          (this = (CheckMaterialSvtListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25B45 & 1) == 0 )
  {
    ...
    sub_1C3B764(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v6);
    this = (CheckMaterialSvtListViewItem_o *)sub_1C3B764(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v7);
    byte_4C25B45 = 1;
  }
  if ( type != 2 )
  {
    if ( type != 1 )
      return;
    this = (CheckMaterialSvtListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
      this = (CheckMaterialSvtListViewItem_o *)DataManager__GetMasterData_object_(
                                                 (DataManager_o *)this,
