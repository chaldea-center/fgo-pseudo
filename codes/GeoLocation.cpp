void __fastcall GeoLocation___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FE232 & 1) == 0 )
  {
    sub_1B64A00(&GeoLocation_TypeInfo, v1);
    byte_49FE232 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE231 & 1) == 0 )
  {
    sub_1B64A00(&GeoLocation_TypeInfo, v2);
    byte_49FE231 = 1;
  }
  ...
  for ( i = 1; ; ++i )
  {
    ...
    for ( j = v4 + 1; ; ++j )
    {
      ...
      if ( !byte_49F981F )
      {
        sub_1B64A00(&System_Math_TypeInfo, v2);
        byte_49F981F = 1;
      }
  ...
  if ( !v31 )
LABEL_40:
    sub_1B64C5C(result, v2);
  if ( v5 >= v31->max_length )
LABEL_41:
    sub_1B64C64(result, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE22F & 1) == 0 )
  {
    sub_1B64A00(&GeoLocation_TypeInfo, someMonoForCoroutine);
    sub_1B64A00(&UnityEngine_LocationInfo___TypeInfo, v5);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->callBack, (int32_t)locDel, (int32_t)method, v3);
  if ( !GeoLocation_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(GeoLocation_TypeInfo);
}
...
System_Collections_IEnumerator_o *__fastcall GeoLocation__GetLocationCoroutine(const MethodInfo *method)
{
  ...
  if ( (byte_49FE230 & 1) == 0 )
  {
    sub_1B64A00(&GeoLocation__GetLocationCoroutine_d__7_TypeInfo, v1);
    byte_49FE230 = 1;
  }
  v2 = sub_1B64C4C(GeoLocation__GetLocationCoroutine_d__7_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19ACB00;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19ACA98;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE233 & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_LocationInfo_TypeInfo, *(_QWORD *)&result);
    sub_1B64A00(&GeoLocation_ResultState_TypeInfo, v10);
    byte_49FE233 = 1;
  }
  v15[2] = 0LL;
  ...
  return (System_IAsyncResult_o *)sub_1B649B4(this, v15, callback, object);
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64A14(&Method_GeoLocation__GetLocationCoroutine_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B64B28(v3, v4);
}
