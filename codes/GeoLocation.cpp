        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&GeoLocation_TypeInfo);
    sub_1C713B0(&UnityEngine_LocationInfo___TypeInfo);
...
System_Collections_IEnumerator_o *GeoLocation__GetLocationCoroutine(const MethodInfo *method)
{
  ...
  if ( (byte_4CC6AD4 & 1) == 0 )
  {
    sub_1C713B0(&GeoLocation__GetLocationCoroutine_d__7_TypeInfo);
    byte_4CC6AD4 = 1;
  }
  v1 = sub_1C715FC(GeoLocation__GetLocationCoroutine_d__7_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AA7444;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA73DC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6AD7 & 1) == 0 )
  {
    sub_1C713B0(&UnityEngine_LocationInfo_TypeInfo);
    sub_1C713B0(&GeoLocation_ResultState_TypeInfo);
    byte_4CC6AD7 = 1;
  }
  v11[2] = 0;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_GeoLocation__GetLocationCoroutine_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
