void __fastcall GeoLocation___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B36865 & 1) == 0 )
  {
    sub_1BD3458(&GeoLocation_TypeInfo, v1);
    byte_4B36865 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36864 & 1) == 0 )
  {
    sub_1BD3458(&GeoLocation_TypeInfo, v2);
    byte_4B36864 = 1;
  }
  ...
  if ( !v31 )
LABEL_40:
    sub_1BD36B4(result, v2);
  if ( v5 >= v31->max_length )
LABEL_41:
    sub_1BD36BC(result, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36862 & 1) == 0 )
  {
    sub_1BD3458(&GeoLocation_TypeInfo, someMonoForCoroutine);
    sub_1BD3458(&UnityEngine_LocationInfo___TypeInfo, v9);
...
System_Collections_IEnumerator_o *__fastcall GeoLocation__GetLocationCoroutine(const MethodInfo *method)
{
  ...
  if ( (byte_4B36863 & 1) == 0 )
  {
    sub_1BD3458(&GeoLocation__GetLocationCoroutine_d__7_TypeInfo, v1);
    byte_4B36863 = 1;
  }
  v2 = sub_1BD36A4(GeoLocation__GetLocationCoroutine_d__7_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A15854;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A157EC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36866 & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_LocationInfo_TypeInfo, *(_QWORD *)&result);
    sub_1BD3458(&GeoLocation_ResultState_TypeInfo, v10);
    byte_4B36866 = 1;
  }
  v15[2] = 0LL;
  ...
  return (System_IAsyncResult_o *)sub_1BD340C(this, v15, callback, object);
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BD346C(&Method_GeoLocation__GetLocationCoroutine_d__7_System_Collections_IEnumerator_Reset__);
  sub_1BD3580(v3, v4);
}
