void __fastcall GeoLocation___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1CA & 1) == 0 )
  {
    sub_1B715CC(&GeoLocation_TypeInfo, v1);
    byte_4A1F1CA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1C9 & 1) == 0 )
  {
    sub_1B715CC(&GeoLocation_TypeInfo, v2);
    byte_4A1F1C9 = 1;
  }
  ...
  for ( i = 1; ; ++i )
  {
    ...
    for ( j = v4 + 1; ; ++j )
    {
      ...
      if ( !byte_4A1A74F )
      {
        sub_1B715CC(&System_Math_TypeInfo, v2);
        byte_4A1A74F = 1;
      }
  ...
  if ( !v31 )
LABEL_40:
    sub_1B71828(result, v2);
  if ( v5 >= v31->max_length )
LABEL_41:
    sub_1B71830(result, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1C7 & 1) == 0 )
  {
    sub_1B715CC(&GeoLocation_TypeInfo, someMonoForCoroutine);
    sub_1B715CC(&UnityEngine_LocationInfo___TypeInfo, v5);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->callBack, (int32_t)locDel, (int32_t)method, v3);
  if ( !GeoLocation_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(GeoLocation_TypeInfo);
}
...
System_Collections_IEnumerator_o *__fastcall GeoLocation__GetLocationCoroutine(const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1C8 & 1) == 0 )
  {
    sub_1B715CC(&GeoLocation__GetLocationCoroutine_d__7_TypeInfo, v1);
    byte_4A1F1C8 = 1;
  }
  v2 = sub_1B71818(GeoLocation__GetLocationCoroutine_d__7_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B9318;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B92B0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F1CB & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_LocationInfo_TypeInfo, *(_QWORD *)&result);
    sub_1B715CC(&GeoLocation_ResultState_TypeInfo, v10);
    byte_4A1F1CB = 1;
  }
  v15[2] = 0LL;
  ...
  return (System_IAsyncResult_o *)sub_1B71580(this, v15, callback, object);
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_GeoLocation__GetLocationCoroutine_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
