void __fastcall GeoLocation___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6627E & 1) == 0 )
  {
    sub_1BE4ACC(&GeoLocation_TypeInfo, v1);
    byte_4B6627E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6627D & 1) == 0 )
  {
    sub_1BE4ACC(&GeoLocation_TypeInfo, v2);
    byte_4B6627D = 1;
  }
  ...
  if ( !v31 )
LABEL_40:
    sub_1BE4D28(result, v2);
  if ( v5 >= v31->max_length )
LABEL_41:
    sub_1BE4D30(result, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6627B & 1) == 0 )
  {
    sub_1BE4ACC(&GeoLocation_TypeInfo, someMonoForCoroutine);
    sub_1BE4ACC(&UnityEngine_LocationInfo___TypeInfo, v9);
...
System_Collections_IEnumerator_o *__fastcall GeoLocation__GetLocationCoroutine(const MethodInfo *method)
{
  ...
  if ( (byte_4B6627C & 1) == 0 )
  {
    sub_1BE4ACC(&GeoLocation__GetLocationCoroutine_d__7_TypeInfo, v1);
    byte_4B6627C = 1;
  }
  v2 = sub_1BE4D18(GeoLocation__GetLocationCoroutine_d__7_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A26CFC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A26C94;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6627F & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_LocationInfo_TypeInfo, *(_QWORD *)&result);
    sub_1BE4ACC(&GeoLocation_ResultState_TypeInfo, v10);
    byte_4B6627F = 1;
  }
  v15[2] = 0LL;
  ...
  return (System_IAsyncResult_o *)sub_1BE4A80(this, v15, callback, object);
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BE4AE0(&Method_GeoLocation__GetLocationCoroutine_d__7_System_Collections_IEnumerator_Reset__);
  sub_1BE4BF4(v3, v4);
}
