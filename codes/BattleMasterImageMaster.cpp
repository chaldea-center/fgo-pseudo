void __fastcall BattleMasterImageMaster___ctor(BattleMasterImageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE1A0 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string___ctor__, method);
    byte_49FE1A0 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    391,
    (const MethodInfo_30D6498 *)Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE19F & 1) == 0 )
  {
    sub_1B64870(&BattleMasterImageEntity_TypeInfo, *(_QWORD *)&id);
    ...
    if ( v26->fields.id == id )
    {
      ...
      if ( v31 == type || v31 == 3 )
      {
        ...
        if ( !(_DWORD)commonReleaseId )
          goto LABEL_31;
        if ( !v15 )
          sub_1B64ACC(v26, commonReleaseId);
