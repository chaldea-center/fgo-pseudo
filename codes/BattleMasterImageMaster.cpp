void BattleMasterImageMaster___ctor(BattleMasterImageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CC7011 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string___ctor__);
    byte_4CC7011 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    397,
    (const MethodInfo_340B614 *)Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7010 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_ObjectModel_Collection_BattleMasterImageEntity__GetEnumerator__);
    sub_1C713B0(&Method_DataManager_GetMaster_CommonReleaseMaster___);
    sub_1C713B0(&DataManager_TypeInfo);
    sub_1C713B0(&Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string__getEntityList__);
    sub_1C713B0(&System_IDisposable_TypeInfo);
    sub_1C713B0(&System_Collections_Generic_IEnumerator_BattleMasterImageEntity__TypeInfo);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_33A21E0 *)Method_System_Collections_ObjectModel_Collection_BattleMasterImageEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C71608(0, v10);
  while ( 1 )
  {
...
LABEL_11:
    ...
    {
LABEL_18:
      v19 = sub_1C47738(Enumerator, System_Collections_Generic_IEnumerator_BattleMasterImageEntity__TypeInfo, 0);
    }
    ...
    if ( v20->fields.id == id )
    {
      ...
      if ( v23 == type || v23 == 3 )
      {
        ...
        if ( !(_DWORD)commonReleaseId )
          goto LABEL_29;
        if ( !v9 )
          sub_1C71608(v20, commonReleaseId);
