void __fastcall BattleMasterImageMaster___ctor(BattleMasterImageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B01C77 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string___ctor__, method);
    byte_4B01C77 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    397,
    (const MethodInfo_32B1804 *)Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01C76 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataMasterBase_BattleMasterImageMaster__BattleMasterImageEntity__string__getEntityList__, v9);
    sub_1BC3008(&System_IDisposable_TypeInfo, v10);
    sub_1BC3008(&System_Collections_Generic_IEnumerator_BattleMasterImageEntity__TypeInfo, v11);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 ...
                 (const MethodInfo_324AE30 *)Method_System_Collections_ObjectModel_Collection_BattleMasterImageEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BC3264(0LL, v16);
  while ( 1 )
  {
...
LABEL_11:
    ...
    {
LABEL_18:
      v25 = sub_1C13570(Enumerator, System_Collections_Generic_IEnumerator_BattleMasterImageEntity__TypeInfo, 0LL);
    }
    ...
    if ( v26->fields.id == id )
    {
      ...
      if ( v30 == type || v30 == 3 )
      {
        ...
        if ( !(_DWORD)commonReleaseId )
          goto LABEL_29;
        if ( !v15 )
          sub_1BC3264(v26, commonReleaseId);
