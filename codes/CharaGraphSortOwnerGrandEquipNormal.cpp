void CharaGraphSortOwnerGrandEquipNormal___ctor(CharaGraphSortOwnerGrandEquipNormal_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B5E1 & 1) == 0 )
  {
    sub_1C93AD4(&CharaGraphSortManageUnitGrandEquip_TypeInfo);
    byte_4D2B5E1 = 1;
  }
  v3 = (CharaGraphSortManageUnitServantEquip_o *)sub_1C93D20(CharaGraphSortManageUnitGrandEquip_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4D2B5E0 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_4412/*"CharaGraphSort_GrandEquip_Normal"*/);
    byte_4D2B5E0 = 1;
  }
  return (System_String_o *)StringLiteral_4412/*"CharaGraphSort_GrandEquip_Normal"*/;
}
