void CharaGraphSortOwnerGrandEquipNormal___ctor(CharaGraphSortOwnerGrandEquipNormal_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF605 & 1) == 0 )
  {
    sub_1CE6700(&CharaGraphSortManageUnitGrandEquip_TypeInfo);
    byte_4DFF605 = 1;
  }
  v3 = (CharaGraphSortManageUnitServantEquip_o *)sub_1CE694C(CharaGraphSortManageUnitGrandEquip_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4DFF604 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_4421/*"CharaGraphSort_GrandEquip_Normal"*/);
    byte_4DFF604 = 1;
  }
  return (System_String_o *)StringLiteral_4421/*"CharaGraphSort_GrandEquip_Normal"*/;
}
