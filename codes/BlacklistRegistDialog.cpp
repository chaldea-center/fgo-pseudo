        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354(
    ...
    (int32_t)func,
    (int32_t)message_main,
    (int32_t)message_sub,
    (System_String_o *)func,
    fontsize_main,
    *(int64_t *)&fontsize_sub,
  ...
  if ( UnityEngine_Object__op_Inequality(messageLabel, 0, 0) )
  {
    if ( fontsize_main )
    {
      ...
      if ( !v17 )
        goto LABEL_48;
      UILabel__set_fontSize(v17, fontsize_main, 0);
    }
    v17 = this->fields.messageLabel;
    if ( !v17 )
      goto LABEL_48;
    ...
    WrapControlText__textAdjust(v17, v20, v17->fields.mFontSize, 0, 0);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(messageLabel_sub, 0, 0) )
  {
    if ( fontsize_sub )
    {
      ...
      if ( !v17 )
        goto LABEL_48;
      UILabel__set_fontSize(v17, fontsize_sub, 0);
    }
    v17 = this->fields.messageLabel_sub;
    if ( v17 )
    {
      ...
      WrapControlText__textAdjust(v17, v22, v17->fields.mFontSize, 0, 0);
      goto LABEL_33;
    }
LABEL_48:
    sub_1C71608(v17, v16);
...
LABEL_33:
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0, 0) )
  {
    ...
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3688/*"COMMON_CONFIRM_YES"*/, 0);
    if ( !v24 )
      goto LABEL_48;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3683/*"COMMON_CONFIRM_NO"*/, 0);
    if ( v26 )
    {
