        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF976 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_3807/*"COMMON_CONFIRM_RETRY"*/, v19);
  ...
  if ( UnityEngine_Object__op_Inequality(messageLabel, 0LL, 0LL) )
  {
    ...
    WrapControlText__textAdjust(v23, v26, v23->fields.mFontSize, 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(messageLabel_sub, 0LL, 0LL) )
  {
    ...
    if ( v23 )
    {
      ...
      WrapControlText__textAdjust(v23, v28, v23->fields.mFontSize, 0, 0LL);
      goto LABEL_33;
    }
LABEL_48:
    sub_1C13F80(v23, v22);
...
LABEL_33:
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0LL, 0LL) )
  {
    ...
    v23 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3807/*"COMMON_CONFIRM_RETRY"*/, 0LL);
    if ( !v30 )
      goto LABEL_48;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v23 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3802/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
    if ( v32 )
    {
