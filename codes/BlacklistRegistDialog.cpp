...
LABEL_33:
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0, 0) )
  {
    ...
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3698/*"COMMON_CONFIRM_YES"*/, 0);
    if ( !v24 )
      goto LABEL_48;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3693/*"COMMON_CONFIRM_NO"*/, 0);
    if ( v26 )
    {
