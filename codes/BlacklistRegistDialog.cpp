        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(messageLabel, 0LL, 0LL) )
  {
    ...
    WrapControlText__textAdjust(v17, v20, v17->fields.mFontSize, 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(messageLabel_sub, 0LL, 0LL) )
  {
    ...
    if ( v17 )
    {
      ...
      WrapControlText__textAdjust(v17, v22, v17->fields.mFontSize, 0, 0LL);
      goto LABEL_33;
    }
LABEL_48:
    sub_1C22094(v17, v16);
...
LABEL_33:
  ...
  if ( UnityEngine_Object__op_Inequality(buttonDecideLabel, 0LL, 0LL) )
  {
    ...
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3819/*"COMMON_CONFIRM_YES"*/, 0LL);
    if ( !v24 )
      goto LABEL_48;
  ...
  if ( UnityEngine_Object__op_Inequality(buttonCancelLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3814/*"COMMON_CONFIRM_NO"*/, 0LL);
    if ( v26 )
    {
