        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39BA3 & 1) == 0 )
  {
    sub_1BD3458(&MasterMissionListViewItem_TypeInfo, missionListviewItem);
...
LABEL_41:
        sub_1BD36B4(timeOverInfo, missionListviewItem);
      }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&MasterMissionListViewItem_TypeInfo, missionListViewItem);
    sub_1BD3458(&MasterMissionListViewManager_TypeInfo, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39BA4 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_EventMissionAddMaster___, item);
    sub_1BD3458(&MissionInfoMaker_TypeInfo, v7);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v8);
    this = (MasterMissionListViewItemDraw_o *)sub_1BD3458(
  ...
  this = (MasterMissionListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_62;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39BA5 & 1) == 0 )
  {
    ...
    sub_1BD3458(&MissionListViewItemDraw_TypeInfo, v7);
    sub_1BD3458(&NetworkManager_TypeInfo, v8);
    sub_1BD3458(&StringLiteral_13519/*"TIME_REST_QUEST"*/, v9);
    sub_1BD3458(&StringLiteral_9452/*"NO_TIME_INFO"*/, v10);
      ...
      if ( progStatus != 4 )
      {
        ...
        else
        {
          if ( klass )
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v17 = LocalizationManager__Get((System_String_o *)StringLiteral_9452/*"NO_TIME_INFO"*/, 0LL);
          }
          else
          {
            resTimeLb = this->fields.resTimeLb;
          ...
          {
LABEL_28:
            v22 = &StringLiteral_13507/*"TIME_REST_ACHIVE"*/;
            goto LABEL_34;
          }
        }
        v22 = &StringLiteral_13519/*"TIME_REST_QUEST"*/;
LABEL_34:
...
LABEL_36:
        sub_1BD36B4(EventMissionEntity, v19);
      }
    }
  }
}
