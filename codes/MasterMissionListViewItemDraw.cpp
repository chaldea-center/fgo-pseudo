...
LABEL_39:
        sub_1C2D6EC(timeOverInfo, missionListviewItem);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A4C8 & 1) == 0 )
  {
    ...
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    this = (MasterMissionListViewItemDraw_o *)sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C2A4C8 = 1;
  }
  if ( !v5 )
    goto LABEL_63;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v6->fields.giftEntityList, (int32_t)IconGiftEntities, v12, v13);
  ...
  this = (MasterMissionListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_63;
...
LABEL_33:
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      if ( (int)item < 1 )
      {
        ...
        if ( !itemIcon )
          goto LABEL_63;
        ItemIconComponent__SetGift_40700316(itemIcon, v31, rewardObjectId, (int)this, 0, 0);
      }
      else
      {
        if ( !itemIcon )
          goto LABEL_63;
        num = (unsigned int)v25->fields.num;
        if ( (int)num <= 1 )
          v28 = -1;
        else
          v28 = num;
        ItemIconComponent__SetItemImage_40702764(v6->fields.itemIcon, (int32_t)item, v28, 0);
      }
    }
    else
    {
...
LABEL_64:
  ...
  if ( (int)item < 1 )
  {
    ...
    if ( v22 <= 1 )
      ...
      v35 = (unsigned int)v21->fields.num;
    ItemIconComponent__SetGift_40700316((ItemIconComponent_o *)this, v21->fields.type, v21->fields.objectId, v35, 0, 0);
  }
  else
  {
    if ( !this )
    ...
    if ( v22 <= 1 )
      ...
      v23 = (unsigned int)v21->fields.num;
    ItemIconComponent__SetItemImage_40702764((ItemIconComponent_o *)this, (int32_t)item, v23, 0);
  }
LABEL_49:
  v33 = v5->fields.eventMissionEnt;
  if ( !v33 )
    goto LABEL_63;
  if ( v33->fields.rewardType == 3 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A4C9 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_9331/*"NO_TIME_INFO"*/);
    this = (MasterMissionListViewItemDraw_o *)sub_1C2D490(&StringLiteral_13411/*"TIME_REST_ACHIVE"*/);
    byte_4C2A4C9 = 1;
  }
  if ( missionListViewItem )
  {
      ...
      if ( progStatus != 4 )
      {
        ...
        else
        {
          if ( klass )
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9331/*"NO_TIME_INFO"*/, 0);
          }
          else
          {
            resTimeLb = v5->fields.resTimeLb;
          ...
          {
LABEL_28:
            v16 = &StringLiteral_13411/*"TIME_REST_ACHIVE"*/;
            goto LABEL_34;
          }
        }
        v16 = &StringLiteral_13423/*"TIME_REST_QUEST"*/;
LABEL_34:
