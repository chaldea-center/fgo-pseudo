        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A015DC & 1) == 0 )
  {
    sub_1B64A00(&MasterMissionListViewItem_TypeInfo, missionListviewItem);
...
LABEL_41:
        sub_1B64C5C(timeOverInfo, missionListviewItem);
      }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&MasterMissionListViewItem_TypeInfo, missionListViewItem);
    sub_1B64A00(&MasterMissionListViewManager_TypeInfo, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A015DD & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_EventMissionAddMaster___, item);
    ...
    this = (MasterMissionListViewItemDraw_o *)sub_1B64A00(
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v6->fields.giftEntityList, (int32_t)GiftListById, v15, v16);
  ...
  this = (MasterMissionListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_63;
...
LABEL_34:
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      if ( (int)item < 1 )
      {
        ...
        if ( !itemIcon )
          goto LABEL_63;
        ItemIconComponent__SetGift_37834024(itemIcon, v32, rewardObjectId, (int32_t)this, 0, 0LL);
      }
      else
      {
        if ( !itemIcon )
        ...
        if ( num <= 1 )
          ...
          v29 = num;
        ItemIconComponent__SetItemImage_37836420(v6->fields.itemIcon, (int32_t)item, v29, 0LL);
      }
    }
    else
    {
...
LABEL_64:
  ...
  else
  {
    ...
    if ( v23 <= 1 )
      ...
      v24 = v22->fields.num;
    ItemIconComponent__SetItemImage_37836420((ItemIconComponent_o *)this, (int32_t)item, v24, 0LL);
  }
LABEL_50:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A015DE & 1) == 0 )
  {
    ...
    sub_1B64A00(&MasterMissionListViewItem_TypeInfo, v6);
    sub_1B64A00(&MissionListViewItemDraw_TypeInfo, v7);
    sub_1B64A00(&NetworkManager_TypeInfo, v8);
    sub_1B64A00(&StringLiteral_13278/*"TIME_REST_QUEST"*/, v9);
    sub_1B64A00(&StringLiteral_9267/*"NO_TIME_INFO"*/, v10);
    sub_1B64A00(&StringLiteral_13266/*"TIME_REST_ACHIVE"*/, v11);
    byte_4A015DE = 1;
  }
  if ( missionListViewItem )
  {
      ...
      if ( progStatus != 4 )
      {
        ...
        else
        {
          if ( klass )
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v17 = LocalizationManager__Get((System_String_o *)StringLiteral_9267/*"NO_TIME_INFO"*/, 0LL);
          }
          else
          {
            resTimeLb = this->fields.resTimeLb;
          ...
          {
LABEL_28:
            v22 = &StringLiteral_13266/*"TIME_REST_ACHIVE"*/;
            goto LABEL_34;
          }
        }
        v22 = &StringLiteral_13278/*"TIME_REST_QUEST"*/;
LABEL_34:
