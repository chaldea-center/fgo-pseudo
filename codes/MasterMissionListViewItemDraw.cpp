...
LABEL_41:
        sub_1CE6958(timeOverInfo, missionListviewItem);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07BEF & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    this = (MasterMissionListViewItemDraw_o *)sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4E07BEF = 1;
  }
  if ( !v5 )
    goto LABEL_62;
  ...
  this = (MasterMissionListViewItemDraw_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_62;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07BF0 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_9410/*"NO_TIME_INFO"*/);
      ...
      if ( progStatus != 4 )
      {
        ...
        else
        {
          if ( klass )
          {
            ...
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9410/*"NO_TIME_INFO"*/, 0);
          }
          else
          {
            resTimeLb = this->fields.resTimeLb;
          ...
          {
LABEL_28:
            v16 = &StringLiteral_13553/*"TIME_REST_ACHIVE"*/;
            goto LABEL_34;
          }
        }
        v16 = &StringLiteral_13565/*"TIME_REST_QUEST"*/;
LABEL_34:
...
LABEL_36:
        sub_1CE6958(EventMissionEntity, v13);
      }
    }
  }
}
