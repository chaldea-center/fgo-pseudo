...
System_String_o *__fastcall MyRoomHelpListViewItem__ToString(MyRoomHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD854 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1BC3008(&StringLiteral_12725/*"ShopHelpItem "*/, method);
    byte_4AFD854 = 1;
  }
  info = v2->fields.info;
  if ( !info )
    sub_1BC3264(this, method);
  return System_String__Concat_62348648((System_String_o *)StringLiteral_12725/*"ShopHelpItem "*/, info->fields.textCode, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD852 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1BC3008(&LocalizationManager_TypeInfo, method);
    byte_4AFD852 = 1;
  }
  info = v2->fields.info;
  if ( !info )
