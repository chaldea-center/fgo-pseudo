...
System_String_o *__fastcall MyRoomHelpListViewItem__ToString(MyRoomHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB18C4 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1BAB41C(&StringLiteral_12773/*"ShopHelpItem "*/, method);
    byte_4AB18C4 = 1;
  }
  info = v2->fields.info;
  if ( !info )
    sub_1BAB678(this, method);
  return System_String__Concat_62048128((System_String_o *)StringLiteral_12773/*"ShopHelpItem "*/, info->fields.textCode, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB18C2 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1BAB41C(&LocalizationManager_TypeInfo, method);
    byte_4AB18C2 = 1;
  }
  info = v2->fields.info;
  if ( !info )
