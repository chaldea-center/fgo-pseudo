...
System_String_o *MyRoomHelpListViewItem__ToString(MyRoomHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22A6A & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1C2D490(&StringLiteral_12846/*"ShopHelpItem "*/);
    byte_4C22A6A = 1;
  }
  info = v2->fields.info;
  if ( !info )
    sub_1C2D6EC(this, method);
  return System_String__Concat_63457864((System_String_o *)StringLiteral_12846/*"ShopHelpItem "*/, info->fields.textCode, 0);
}
...
System_String_o *MyRoomHelpListViewItem__get_InfoText(MyRoomHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22A68 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1C2D490(&LocalizationManager_TypeInfo);
    byte_4C22A68 = 1;
  }
  info = v2->fields.info;
  if ( !info )
