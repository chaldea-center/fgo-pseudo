...
System_String_o *MyRoomHelpListViewItem__ToString(MyRoomHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB19F9 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1C6BA08(&StringLiteral_12854/*"ShopHelpItem "*/);
    byte_4CB19F9 = 1;
  }
  info = v2->fields.info;
  if ( !info )
    sub_1C6BC60(this, method);
  return System_String__Concat_63966792((System_String_o *)StringLiteral_12854/*"ShopHelpItem "*/, info->fields.textCode, 0);
}
...
System_String_o *MyRoomHelpListViewItem__get_InfoText(MyRoomHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB19F7 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1C6BA08(&LocalizationManager_TypeInfo);
    byte_4CB19F7 = 1;
  }
  info = v2->fields.info;
  if ( !info )
