...
System_String_o *__fastcall MyRoomHelpListViewItem__ToString(MyRoomHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DE727 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1B00CCC(&StringLiteral_12533/*"ShopHelpItem "*/, method);
    byte_48DE727 = 1;
  }
  info = v2->fields.info;
  if ( !info )
    sub_1B00F28(this, method);
  return System_String__Concat_60325748((System_String_o *)StringLiteral_12533/*"ShopHelpItem "*/, info->fields.textCode, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE725 & 1) == 0 )
  {
    this = (MyRoomHelpListViewItem_o *)sub_1B00CCC(&LocalizationManager_TypeInfo, method);
    byte_48DE725 = 1;
  }
  info = v2->fields.info;
  if ( !info )
