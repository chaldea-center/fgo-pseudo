void EventInfoJobLevelSnapshot___ctor(EventInfoJobLevelSnapshot_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593998A & 1) == 0 )
  {
    sub_21FFC50(&EventInfoJobLevelSnapshot_JobEntry___TypeInfo);
    byte_593998A = 1;
  }
  v3 = (struct EventInfoJobLevelSnapshot_JobEntry_array *)sub_21FFD10(EventInfoJobLevelSnapshot_JobEntry___TypeInfo, 0);
  this->fields.jobs = v3;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.jobs, (int32_t)v3, v4, v5, v6, v7, v8, v9);
