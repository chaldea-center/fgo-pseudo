...
void TweenRotation__OnUpdate(TweenRotation_o *this, float factor, bool isFinished, const MethodInfo *method)
{
  ...
  UnityEngine_Vector3_o v9; // 0:kr40_12.12
  UnityEngine_Vector3_o v10; // 0:kr54_12.12
  UnityEngine_Vector3_o v11; // 0:kr60_12.12
  UnityEngine_Quaternion_o v12; // 0:kr00_16.16
  UnityEngine_Quaternion_o v13; // 0:s0.4,4:s1.4,8:s2.4,12:s3.4
  UnityEngine_Quaternion_o v14; // 0:s4.4,4:s5.4,8:s6.4,12:s7.4

  if ( this->fields.quaternionLerp )
  {
    v6.n64_u64[0] = vdup_n_s32(0x3C8EFA35u).n64_u64[0];
    *(float32x2_t *)&v9.fields.x = vmul_f32(*(float32x2_t *)&this->fields.from.fields.x, v6);
    v9.fields.z = this->fields.from.fields.z * 0.017453;
    v12 = UnityEngine_Quaternion__Internal_FromEulerRad(v9, 0);
    *(float32x2_t *)&v10.fields.x = vmul_f32(*(float32x2_t *)&this->fields.to.fields.x, v6);
    v10.fields.z = this->fields.to.fields.z * 0.017453;
    v14 = UnityEngine_Quaternion__Internal_FromEulerRad(v10, 0);
    v13 = UnityEngine_Quaternion__Slerp(v12, v14, factor, 0);
  }
  else
  {
    v7 = 1.0;
    ...
    if ( factor < 0.0 )
      v7 = 0.0;
    *(float32x2_t *)&v11.fields.x = vmul_f32(
                                      vadd_f32(
    ...
    v11.fields.z = (float)(this->fields.from.fields.z
                         + (float)(v7 * (float)(this->fields.to.fields.z - this->fields.from.fields.z)))
                 * 0.017453;
    v13 = UnityEngine_Quaternion__Internal_FromEulerRad(v11, 0);
  }
  TweenRotation__set_value(this, v13, v8);
}
...
void TweenRotation__SetCurrentValueToEnd(TweenRotation_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Vector3_o v4; // 0:kr10_12.12
  UnityEngine_Quaternion_o v5; // 0:s0.4,4:s1.4,8:s2.4,12:s3.4

  *(float32x2_t *)&v4.fields.x = vmul_f32(*(float32x2_t *)&this->fields.to.fields.x, vdup_n_s32(0x3C8EFA35u));
...
void TweenRotation__SetCurrentValueToStart(TweenRotation_o *this, const MethodInfo *method)
{
  ...
  *(float32x2_t *)&v4.fields.x = vmul_f32(*(float32x2_t *)&this->fields.from.fields.x, vdup_n_s32(0x3C8EFA35u));
