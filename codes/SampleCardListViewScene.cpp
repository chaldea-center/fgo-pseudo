...
void SampleCardListViewScene__Init(SampleCardListViewScene_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02110 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SampleCardListViewScene_OnMoveEnd__);
    byte_4E02110 = 1;
  }
  ...
  if ( !v5 )
LABEL_8:
    sub_1CE6958(cardListViewManager, method);
  SampleCardListViewManager__SetMode_38672708(v5, 1, v6, v7);
}
...
LABEL_11:
  ...
  if ( state == 1 )
  {
    ...
    if ( v5 )
    {
      ...
      v9 = v6;
LABEL_9:
      SampleCardListViewManager__SetMode_38672708(cardListViewManager, v8, v9, v2);
      return;
    }
    goto LABEL_11;
  }
