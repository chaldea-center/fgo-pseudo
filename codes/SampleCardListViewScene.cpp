...
void SampleCardListViewScene__Init(SampleCardListViewScene_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C54515 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SampleCardListViewScene_OnMoveEnd__);
    byte_4C54515 = 1;
  }
  ...
  if ( !v5 )
LABEL_8:
    sub_1C3E7C0(cardListViewManager, method);
  SampleCardListViewManager__SetMode_37688268(v5, 1, v6, v7);
}
...
LABEL_11:
  ...
  if ( state == 1 )
  {
    ...
    if ( v5 )
    {
      ...
      v9 = v6;
LABEL_9:
      SampleCardListViewManager__SetMode_37688268(cardListViewManager, v8, v9, v2);
      return;
    }
    goto LABEL_11;
  }
