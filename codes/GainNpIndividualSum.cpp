        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5973C6E & 1) == 0 )
  {
    ...
    battleData = (BattleData_o *)sub_2213A60(&Method_System_Collections_Generic_List_int__GetEnumerator__);
    byte_5973C6E = 1;
  }
  ...
  if ( !functionEntity
    ...
    || (vals = functionEntity->fields.vals,
        ...
        !TargetUniqueIdList) )
  {
    sub_2213CDC(battleData, *(_QWORD *)&actorId);
  }
  v15 = (int)battleData;
        ...
        const MethodInfo *method)
{
  ...
  int32_t v15; // w4
  BattleData_o *v16; // x1
  const MethodInfo_446747C *v17; // x2
  ...
  if ( (byte_5973C6C & 1) == 0 )
  {
    ...
    data = (BattleData_o *)sub_2213A60(&System_Collections_Generic_List_int__TypeInfo);
    byte_5973C6C = 1;
  }
  ...
  else
  {
    if ( (_DWORD)data != 2 )
    {
      ...
      if ( v12 )
      {
        ...
        v17 = (const MethodInfo_446747C *)Method_System_Collections_Generic_List_int__AddRange__;
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_446747C *v16; // x2
...
LABEL_12:
    ...
    {
      v15 = TargetIds;
      v16 = (const MethodInfo_446747C *)Method_System_Collections_Generic_List_int__AddRange__;
LABEL_16:
