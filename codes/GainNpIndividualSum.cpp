        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07D1D & 1) == 0 )
  {
    ...
    battleData = (BattleData_o *)sub_1CE6700(&Method_System_Collections_Generic_List_int__GetEnumerator__);
    byte_4E07D1D = 1;
  }
  ...
  if ( !functionEntity
    ...
    || (vals = functionEntity->fields.vals,
        ...
        battleData = (BattleData_o *)DataVals__GetParam(baseVals, 116, 0, 0),
        !TargetUniqueIdList) )
  {
    sub_1CE6958(battleData, *(_QWORD *)&actorId);
  }
  v15 = (int)battleData;
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_38E9150 *v18; // x2
  BattleData_o *v19; // x1
  int v20; // w23
  int v21; // w21
  _BOOL8 v22; // x0
  ...
  if ( (byte_4E07D1B & 1) == 0 )
  {
    ...
    data = (BattleData_o *)sub_1CE6700(&System_Collections_Generic_List_int__TypeInfo);
    byte_4E07D1B = 1;
  }
...
LABEL_27:
  ...
  switch ( (int)data )
  {
    ...
    case 3:
      ...
      v18 = (const MethodInfo_38E9150 *)Method_System_Collections_Generic_List_int__AddRange__;
...
LABEL_18:
      LODWORD(data) = DataVals__GetParam(baseVals, 116, 0, 0);
LABEL_19:
      v20 = (int)data;
      System_Collections_Generic_List_int___GetEnumerator(
      ...
      return v21;
    default:
      data = (BattleData_o *)DataVals__GetParam(baseVals, 116, 0, 0);
      if ( !v12 )
        goto LABEL_27;
      goto LABEL_19;
  }
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_38E9150 *v17; // x2
  ...
  switch ( individualityTargetType )
  {
    ...
    case 3:
      ...
      v17 = (const MethodInfo_38E9150 *)Method_System_Collections_Generic_List_int__AddRange__;
