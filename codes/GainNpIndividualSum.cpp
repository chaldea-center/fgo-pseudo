        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_34923C4 *v25; // x2
  BattleData_o *v26; // x1
  int v27; // w23
  int v28; // w21
  _BOOL8 v29; // x0
  ...
  if ( (byte_4A010A0 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__Dispose__, *(_QWORD *)&actorId);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__MoveNext__, v11);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__get_Current__, v12);
    ...
    data = (BattleData_o *)sub_1B64870(&System_Collections_Generic_List_int__TypeInfo, v17);
    byte_4A010A0 = 1;
  }
  ...
  {
LABEL_29:
    sub_1B64ACC(data, *(_QWORD *)&actorId);
  }
...
LABEL_14:
      ...
      if ( !v19 )
        goto LABEL_29;
      v26 = data;
      v25 = (const MethodInfo_34923C4 *)Method_System_Collections_Generic_List_int__AddRange__;
      break;
    case 3:
