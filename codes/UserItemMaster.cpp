void __fastcall UserItemMaster___ctor(UserItemMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4350758 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string___ctor__);
    byte_4350758 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    35,
    (const MethodInfo_21C07F4 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4350756 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string__GetEntity__);
    byte_4350756 = 1;
  }
  ...
  return (UserItemEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                               ...
                               PK,
                               (const MethodInfo_21C0890 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string__GetEntity__);
}
...
LABEL_8:
  ...
  if ( ((*(__int64 (__fastcall **)(DataMasterBase_WarMaster__WarEntity__int__o *, System_String_o *, _QWORD))v14)(
          ...
          *(_QWORD *)(v14 + 8)) & 1) == 0 )
  {
    v20 = (UserItemEntity_o *)sub_B70764(UserItemEntity_TypeInfo);
    UserItemEntity___ctor_22824460(v20, userId, itemId, v21);
    if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    lookup = (DataMasterBase_WarMaster__WarEntity__int__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1CA3540 *)Method_DataManager_GetMaster_ItemMaster___);
    if ( lookup )
    {
      ...
      if ( entity )
      {
        ...
        lookup = (DataMasterBase_WarMaster__WarEntity__int__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1CA3540 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
        if ( entity && lookup )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4350757 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string__TryGetEntity__);
    byte_4350757 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_21C08E8 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string__TryGetEntity__);
}
...
UserItemEntity_array *__fastcall UserItemMaster__getList(UserItemMaster_o *this, const MethodInfo *method)
{
  ...
  UserId = NetworkManager__get_UserId(0LL);
  return UserItemMaster__getList_22836404(this, UserId, v4);
}


UserItemEntity_array *__fastcall UserItemMaster__getList_22836404(
        UserItemMaster_o *this,
        int64_t userId,
        const MethodInfo *method)
{
  ...
  if ( (byte_435075C & 1) == 0 )
  {
    ...
    sub_B70694(&Method_System_Collections_Generic_List_UserItemEntity__Add__);
    sub_B70694(&Method_System_Collections_Generic_List_UserItemEntity__ToArray__);
    sub_B70694(&Method_System_Collections_Generic_List_UserItemEntity___ctor__);
    sub_B70694(&System_Collections_Generic_List_UserItemEntity__TypeInfo);
    sub_B70694(&UserItemEntity_TypeInfo);
    byte_435075C = 1;
  }
  ...
  v7 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B70764(System_Collections_Generic_List_UserItemEntity__TypeInfo);
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v7,
    (const MethodInfo_30249C4 *)Method_System_Collections_Generic_List_UserItemEntity___ctor__);
  if ( Count >= 1 )
  {
    v8 = 0;
    while ( 1 )
      ...
      if ( list )
      {
          ...
          && list->fields.items == (struct System_Collections_Generic_IList_T__o *)v3 )
        {
          ...
          System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
            ...
            (const MethodInfo_3025688 *)Method_System_Collections_Generic_List_UserItemEntity__Add__);
        }
      }
      if ( ++v8 >= Count )
        goto LABEL_14;
...
LABEL_14:
  ...
  return (UserItemEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                   ...
                                   (const MethodInfo_30277D4 *)Method_System_Collections_Generic_List_UserItemEntity__ToArray__);
}
