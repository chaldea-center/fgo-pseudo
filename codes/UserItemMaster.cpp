void __fastcall UserItemMaster___ctor(UserItemMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A70BB8 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string___ctor__, method);
    byte_4A70BB8 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    36,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70BB6 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string__GetEntity__, userId);
    byte_4A70BB6 = 1;
  }
  ...
  return (UserItemEntity_o *)DataMasterBase_object__object__object___GetEntity(
                               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                               PK,
                               (const MethodInfo_312C900 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70BBA & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMaster_ItemMaster___, userId);
    ...
    sub_1B90010(&UserItemEntity_TypeInfo, v11);
    byte_4A70BBA = 1;
  }
  entity = 0LL;
  v30 = 0LL;
  ...
  {
LABEL_8:
    v19 = sub_1BE1FF0(lookup, System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, 0LL);
  }
  if ( ((*(__int64 (__fastcall **)(DataMasterBase_TMaster__TEntity__PKType__o *, System_String_o *, _QWORD))v19)(
          ...
          *(_QWORD *)(v19 + 8)) & 1) == 0 )
  {
    v25 = (UserItemEntity_o *)sub_1B9025C(UserItemEntity_TypeInfo);
    UserItemEntity___ctor_40190356(v25, userId, itemId, v26);
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    lookup = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_ItemMaster___);
    if ( lookup )
    {
      ...
      if ( entity )
      {
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        lookup = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
        if ( entity && lookup )
        {
...
LABEL_39:
  ...
  {
LABEL_16:
    v24 = sub_1BE1FF0(lookup, System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, 2LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70BB7 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string__TryGetEntity__, entity);
    byte_4A70BB7 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string__TryGetEntity__);
}
...
UserItemEntity_array *__fastcall UserItemMaster__getList(UserItemMaster_o *this, const MethodInfo *method)
{
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  UserId = NetworkManager__get_UserId(0LL);
  return UserItemMaster__getList_40190996(this, UserId, v4);
}


UserItemEntity_array *__fastcall UserItemMaster__getList_40190996(
        UserItemMaster_o *this,
        int64_t userId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70BBC & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_UserItemEntity__Add__, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_UserItemEntity__ToArray__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_UserItemEntity___ctor__, v8);
    sub_1B90010(&System_Collections_Generic_List_UserItemEntity__TypeInfo, v9);
    sub_1B90010(&UserItemEntity_TypeInfo, v10);
    byte_4A70BBC = 1;
  }
  ...
  v13 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_UserItemEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_UserItemEntity___ctor__);
  if ( Count >= 1 )
  {
    v14 = 0;
    while ( 1 )
...
LABEL_17:
  ...
  return (UserItemEntity_array *)System_Collections_Generic_List_object___ToArray(
                                   v13,
                                   (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_UserItemEntity__ToArray__);
}
...
int32_t __fastcall UserItemMaster__getSum(UserItemMaster_o *this, int64_t userId, const MethodInfo *method)
{
  ...
  if ( (byte_4A70BBB & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, userId);
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B90010(&UserItemEntity_TypeInfo, v6);
    byte_4A70BBB = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
