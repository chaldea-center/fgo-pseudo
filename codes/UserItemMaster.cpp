void __fastcall UserItemMaster___ctor(UserItemMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4BFE539 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string___ctor__, method);
    byte_4BFE539 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    36,
    (const MethodInfo_327D914 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE537 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string__GetEntity__, userId);
    byte_4BFE537 = 1;
  }
  ...
  return (UserItemEntity_o *)DataMasterBase_object__object__object___GetEntity(
                               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                               PK,
                               (const MethodInfo_327FC38 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE53B & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMaster_ItemMaster___, userId);
    ...
    sub_1C2E12C(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string__get_lookup__, v10);
    sub_1C2E12C(&System_Collections_Generic_IReadOnlyDictionary_string__UserItemEntity__TypeInfo, v11);
    sub_1C2E12C(&UserItemEntity_TypeInfo, v12);
    byte_4BFE53B = 1;
  }
  v29 = 0LL;
  entity = 0LL;
  ...
  lookup = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__object___get_lookup(
                                                           (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                                           (const MethodInfo_327DA2C *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string__get_lookup__);
  if ( !lookup )
    goto LABEL_34;
  klass = lookup->klass;
  v17 = lookup;
  ...
  {
LABEL_8:
    v20 = sub_1C8010C(lookup, System_Collections_Generic_IReadOnlyDictionary_string__UserItemEntity__TypeInfo, 0LL);
  }
  if ( ((*(__int64 (__fastcall **)(DataMasterBase_TMaster__TEntity__PKType__o *, System_String_o *, _QWORD))v20)(
          ...
          *(_QWORD *)(v20 + 8)) & 1) == 0 )
  {
    v26 = (UserItemEntity_o *)sub_1C2E378(UserItemEntity_TypeInfo);
    UserItemEntity___ctor_41493372(v26, userId, itemId, v27);
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    lookup = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2FD17DC *)Method_DataManager_GetMaster_ItemMaster___);
    if ( lookup )
    {
      ...
      if ( entity )
      {
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        lookup = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2FD17DC *)Method_DataManager_GetMaster_UserSvtCoinMaster___);
        if ( entity && lookup )
        {
...
LABEL_34:
  ...
  {
LABEL_16:
    v25 = sub_1C8010C(lookup, System_Collections_Generic_IReadOnlyDictionary_string__UserItemEntity__TypeInfo, 2LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE538 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataMasterBase_UserItemMaster__UserItemEntity__string__TryGetEntity__, entity);
    byte_4BFE538 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_327FC84 *)Method_DataMasterBase_UserItemMaster__UserItemEntity__string__TryGetEntity__);
}
...
UserItemEntity_array *__fastcall UserItemMaster__getList(UserItemMaster_o *this, const MethodInfo *method)
{
  ...
  return UserItemMaster__getList_41494064(this, v4->static_fields->userIdNumber, v2);
}


UserItemEntity_array *__fastcall UserItemMaster__getList_41494064(
        UserItemMaster_o *this,
        int64_t userId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE53D & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_ObjectModel_Collection_UserItemEntity__get_Count__, userId);
    sub_1C2E12C(&Method_System_Collections_ObjectModel_Collection_UserItemEntity__get_Item__, v5);
    sub_1C2E12C(&Method_System_Collections_Generic_List_UserItemEntity__Add__, v6);
    sub_1C2E12C(&Method_System_Collections_Generic_List_UserItemEntity__ToArray__, v7);
    sub_1C2E12C(&Method_System_Collections_Generic_List_UserItemEntity___ctor__, v8);
    sub_1C2E12C(&System_Collections_Generic_List_UserItemEntity__TypeInfo, v9);
    byte_4BFE53D = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_3215B6C *)Method_System_Collections_ObjectModel_Collection_UserItemEntity__get_Count__);
  v12 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_UserItemEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_UserItemEntity___ctor__);
  if ( Count >= 1 )
  {
    v13 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v13,
                                                                 (const MethodInfo_3215BFC *)Method_System_Collections_ObjectModel_Collection_UserItemEntity__get_Item__);
      if ( list )
      {
        userId = (int64_t)list;
...
LABEL_15:
  ...
  return (UserItemEntity_array *)System_Collections_Generic_List_object___ToArray(
                                   v12,
                                   (const MethodInfo_366D404 *)Method_System_Collections_Generic_List_UserItemEntity__ToArray__);
}
