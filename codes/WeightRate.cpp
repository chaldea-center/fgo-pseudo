void __fastcall WeightRate_WeightSeed___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_388FCCC *method)
{
  _QWORD *monitor; // x19
  ...
  sub_19B6DC8(this, *(_QWORD *)(**(_QWORD **)(monitor[4] + 192LL) + 128LL), (unsigned int)w);
  v9 = monitor[4];
...
void __fastcall WeightRate_WeightSeed_int____ctor(
        ...
        int32_t w,
        int32_t t,
        const MethodInfo_388FCA0 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall WeightRate___c__DisplayClass4_0___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_3001224 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass4_0___Il2CppFullySharedGenericType____removeWeight_b__0(
        ...
        const MethodInfo_300122C *method)
{
...
void __fastcall WeightRate___c__DisplayClass4_0_int____ctor(
        WeightRate___c__DisplayClass4_0_T__o *this,
        const MethodInfo_3001180 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass4_0_int____removeWeight_b__0(
        WeightRate___c__DisplayClass4_0_T__o *this,
        WeightRate_WeightSeed_T__o *s,
        const MethodInfo_3001188 *method)
{
  if ( !s )
    sub_1B64ACC(this, 0LL);
  return System_Int32__CompareTo_62188528(
           (_DWORD)this + 16,
           *(&s->fields.weight + 1),
...
void __fastcall WeightRate___c___Il2CppFullySharedGenericType____cctor(const MethodInfo_2FF7810 *method)
{
  ...
  if ( (BYTE5(klass->vtable._0_Equals.methodPtr) & 1) == 0 )
    klass = (WeightRate___c_T__c *)sub_1BB674C(klass);
  _0_WeightRate___c_T = (__int64)klass->rgctx_data->_0_WeightRate___c_T_;
  if ( (*(_BYTE *)(_0_WeightRate___c_T + 309) & 1) == 0 )
    _0_WeightRate___c_T = sub_1BB674C(_0_WeightRate___c_T);
  v4 = sub_1B64ABC(_0_WeightRate___c_T);
  v5 = method->klass;
  v6 = v4;
...
void __fastcall WeightRate___c___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_2FF7904 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
int32_t __fastcall WeightRate___c___Il2CppFullySharedGenericType____ReverseWeight_b__11_0(
        ...
        const MethodInfo_2FF790C *method)
{
  const MethodInfo_2FF790C *v5; // x19
  _DWORD *v6; // x0
  WeightRate___c_T__c *klass; // x8

  v5 = method;
  v6 = (_DWORD *)sub_1B64894(b, method->klass->rgctx_data->_3_WeightRate_WeightSeed_T_->_1.fields);
  klass = v5->klass;
  LODWORD(v5) = *v6;
  return (_DWORD)v5 - *(_DWORD *)sub_1B64894(a, klass->rgctx_data->_3_WeightRate_WeightSeed_T_->_1.fields);
}


void __fastcall WeightRate___c_int____cctor(const MethodInfo_2FF3DB0 *method)
{
  WeightRate___c_T__c *klass; // x0
  __int64 _0_WeightRate___c_T; // x0
  Il2CppObject *v4; // x20
  ...
  if ( (*(_BYTE *)(_0_WeightRate___c_T + 309) & 1) == 0 )
    _0_WeightRate___c_T = sub_1BB674C(_0_WeightRate___c_T);
  v4 = (Il2CppObject *)sub_1B64ABC(_0_WeightRate___c_T);
  ...
  if ( (BYTE5(v7->vtable._0_Equals.methodPtr) & 1) == 0 )
    v7 = (WeightRate___c_T__c *)sub_1BB674C(v7);
  ...
  **(_QWORD **)(_2_WeightRate___c_T + 184) = v4;
  ...
  if ( (BYTE5(v9->vtable._0_Equals.methodPtr) & 1) == 0 )
    v9 = (WeightRate___c_T__c *)sub_1BB674C(v9);
...
void __fastcall WeightRate___c_int____ctor(WeightRate___c_T__o *this, const MethodInfo_2FF3E6C *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
int32_t __fastcall WeightRate___c_int____ReverseWeight_b__11_0(
        ...
        WeightRate_WeightSeed_T__o *a,
        WeightRate_WeightSeed_T__o *b,
        const MethodInfo_2FF3E74 *method)
{
  if ( !b || !a )
    sub_1B64ACC(this, a);
