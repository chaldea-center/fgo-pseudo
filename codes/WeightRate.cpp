void __fastcall WeightRate_WeightSeed___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_39DA228 *method)
{
  _QWORD *monitor; // x19
  ...
  sub_19DDC8C(this, *(_QWORD *)(**(_QWORD **)(monitor[4] + 192LL) + 128LL), (unsigned int)w);
  v9 = monitor[4];
...
void __fastcall WeightRate_WeightSeed_int____ctor(
        ...
        int32_t w,
        int32_t t,
        const MethodInfo_39DA1FC *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall WeightRate___c__DisplayClass4_0___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_31390F4 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass4_0___Il2CppFullySharedGenericType____removeWeight_b__0(
        ...
        const MethodInfo_31390FC *method)
{
...
void __fastcall WeightRate___c__DisplayClass4_0_int____ctor(
        WeightRate___c__DisplayClass4_0_T__o *this,
        const MethodInfo_3139050 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass4_0_int____removeWeight_b__0(
        WeightRate___c__DisplayClass4_0_T__o *this,
        WeightRate_WeightSeed_T__o *s,
        const MethodInfo_3139058 *method)
{
  if ( !s )
    sub_1B86614(this, 0LL);
  return System_Int32__CompareTo_63159108(
           (_DWORD)this + 16,
           *(&s->fields.weight + 1),
...
void __fastcall WeightRate___c__DisplayClass5_0___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_313AB58 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass5_0___Il2CppFullySharedGenericType____HasWeight_b__0(
        WeightRate___c__DisplayClass5_0_T__o *this,
        WeightRate_WeightSeed_T__o *s,
        const MethodInfo_313AB60 *method)
{
  ...
  v16 = (void *)sub_1B863DC(this, v13->_0_WeightRate___c__DisplayClass5_0_T_->_1.fields);
  if ( (method->klass->rgctx_data->_1_T->_1.byval_arg.bits & 0x80000000) == 0 )
    v11 = (_QWORD *)*v11;
  v18[1] = v11;
  sub_1B86E20((int)v14, (int)_0_WeightRate___c__DisplayClass5_0_T, (int)v10, v16);
  return v19 == 0;
}
...
void __fastcall WeightRate___c__DisplayClass5_0_int____ctor(
        WeightRate___c__DisplayClass5_0_T__o *this,
        const MethodInfo_313AAB4 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass5_0_int____HasWeight_b__0(
        WeightRate___c__DisplayClass5_0_T__o *this,
        WeightRate_WeightSeed_T__o *s,
        const MethodInfo_313AABC *method)
{
  if ( !s )
    sub_1B86614(this, 0LL);
  return System_Int32__CompareTo_63159108(
...
void __fastcall WeightRate___c___Il2CppFullySharedGenericType____cctor(const MethodInfo_312FB04 *method)
{
  __int64 klass; // x0
  __int64 v3; // x0
  __int64 v4; // x0
...
void __fastcall WeightRate___c___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_312FBF8 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
int32_t __fastcall WeightRate___c___Il2CppFullySharedGenericType____ReverseWeight_b__12_0(
        ...
        const MethodInfo_312FC00 *method)
{
  const MethodInfo_312FC00 *v5; // x19
  _DWORD *v6; // x0
  WeightRate___c_T__c *klass; // x8

  v5 = method;
  v6 = (_DWORD *)sub_1B863DC(b, method->klass->rgctx_data->_3_WeightRate_WeightSeed_T_->_1.fields);
  klass = v5->klass;
  LODWORD(v5) = *v6;
  return (_DWORD)v5 - *(_DWORD *)sub_1B863DC(a, klass->rgctx_data->_3_WeightRate_WeightSeed_T_->_1.fields);
}


void __fastcall WeightRate___c_int____cctor(const MethodInfo_312C26C *method)
{
  __int64 klass; // x0
  __int64 v3; // x0
  Il2CppObject *v4; // x20
...
void __fastcall WeightRate___c_int____ctor(WeightRate___c_T__o *this, const MethodInfo_312C328 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
int32_t __fastcall WeightRate___c_int____ReverseWeight_b__12_0(
        ...
        WeightRate_WeightSeed_T__o *a,
        WeightRate_WeightSeed_T__o *b,
        const MethodInfo_312C330 *method)
{
  if ( !b || !a )
    sub_1B86614(this, a);
