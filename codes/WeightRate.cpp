void __fastcall WeightRate_WeightSeed___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_38EFDDC *method)
{
  _QWORD *monitor; // x19
  ...
  sub_19E0250(this, *(_QWORD *)(**(_QWORD **)(monitor[4] + 192LL) + 128LL), (unsigned int)w);
  v9 = monitor[4];
...
void __fastcall WeightRate_WeightSeed_int____ctor(
        ...
        int32_t w,
        int32_t t,
        const MethodInfo_38EFDB0 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
...
void __fastcall WeightRate___c__DisplayClass4_0___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_3055580 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass4_0___Il2CppFullySharedGenericType____removeWeight_b__0(
        ...
        const MethodInfo_3055588 *method)
{
...
void __fastcall WeightRate___c__DisplayClass4_0_int____ctor(
        WeightRate___c__DisplayClass4_0_T__o *this,
        const MethodInfo_30554DC *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass4_0_int____removeWeight_b__0(
        WeightRate___c__DisplayClass4_0_T__o *this,
        WeightRate_WeightSeed_T__o *s,
        const MethodInfo_30554E4 *method)
{
  if ( !s )
    sub_1B9026C(this, 0LL);
  return System_Int32__CompareTo_62592052(
           (_DWORD)this + 16,
           *(&s->fields.weight + 1),
...
void __fastcall WeightRate___c__DisplayClass5_0___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_30564E0 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass5_0___Il2CppFullySharedGenericType____HasWeight_b__0(
        WeightRate___c__DisplayClass5_0_T__o *this,
        WeightRate_WeightSeed_T__o *s,
        const MethodInfo_30564E8 *method)
{
  ...
  v16 = (void *)sub_1B90034(this, v13->_0_WeightRate___c__DisplayClass5_0_T_->_1.fields);
  if ( (method->klass->rgctx_data->_1_T->_1.byval_arg.bits & 0x80000000) == 0 )
    v11 = (_QWORD *)*v11;
  v18[1] = v11;
  sub_1B90A78((int)v14, (int)_0_WeightRate___c__DisplayClass5_0_T, (int)v10, v16);
  return v19 == 0;
}
...
void __fastcall WeightRate___c__DisplayClass5_0_int____ctor(
        WeightRate___c__DisplayClass5_0_T__o *this,
        const MethodInfo_305643C *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
bool __fastcall WeightRate___c__DisplayClass5_0_int____HasWeight_b__0(
        WeightRate___c__DisplayClass5_0_T__o *this,
        WeightRate_WeightSeed_T__o *s,
        const MethodInfo_3056444 *method)
{
  if ( !s )
    sub_1B9026C(this, 0LL);
  return System_Int32__CompareTo_62592052(
...
void __fastcall WeightRate___c___Il2CppFullySharedGenericType____cctor(const MethodInfo_304BB70 *method)
{
  ...
  if ( (BYTE5(klass->vtable._0_Equals.methodPtr) & 1) == 0 )
    klass = (WeightRate___c_T__c *)sub_1BE1EEC(klass);
  _0_WeightRate___c_T = (__int64)klass->rgctx_data->_0_WeightRate___c_T_;
  if ( (*(_BYTE *)(_0_WeightRate___c_T + 309) & 1) == 0 )
    _0_WeightRate___c_T = sub_1BE1EEC(_0_WeightRate___c_T);
  v4 = sub_1B9025C(_0_WeightRate___c_T);
  v5 = method->klass;
  v6 = v4;
...
void __fastcall WeightRate___c___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_304BC64 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
int32_t __fastcall WeightRate___c___Il2CppFullySharedGenericType____ReverseWeight_b__12_0(
        ...
        const MethodInfo_304BC6C *method)
{
  const MethodInfo_304BC6C *v5; // x19
  _DWORD *v6; // x0
  WeightRate___c_T__c *klass; // x8

  v5 = method;
  v6 = (_DWORD *)sub_1B90034(b, method->klass->rgctx_data->_3_WeightRate_WeightSeed_T_->_1.fields);
  klass = v5->klass;
  LODWORD(v5) = *v6;
  return (_DWORD)v5 - *(_DWORD *)sub_1B90034(a, klass->rgctx_data->_3_WeightRate_WeightSeed_T_->_1.fields);
}


void __fastcall WeightRate___c_int____cctor(const MethodInfo_3048110 *method)
{
  WeightRate___c_T__c *klass; // x0
  __int64 _0_WeightRate___c_T; // x0
  Il2CppObject *v4; // x20
  ...
  if ( (*(_BYTE *)(_0_WeightRate___c_T + 309) & 1) == 0 )
    _0_WeightRate___c_T = sub_1BE1EEC(_0_WeightRate___c_T);
  v4 = (Il2CppObject *)sub_1B9025C(_0_WeightRate___c_T);
  ...
  if ( (BYTE5(v7->vtable._0_Equals.methodPtr) & 1) == 0 )
    v7 = (WeightRate___c_T__c *)sub_1BE1EEC(v7);
  ...
  **(_QWORD **)(_2_WeightRate___c_T + 184) = v4;
  ...
  if ( (BYTE5(v9->vtable._0_Equals.methodPtr) & 1) == 0 )
    v9 = (WeightRate___c_T__c *)sub_1BE1EEC(v9);
...
void __fastcall WeightRate___c_int____ctor(WeightRate___c_T__o *this, const MethodInfo_30481CC *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
int32_t __fastcall WeightRate___c_int____ReverseWeight_b__12_0(
        ...
        WeightRate_WeightSeed_T__o *a,
        WeightRate_WeightSeed_T__o *b,
        const MethodInfo_30481D4 *method)
{
  if ( !b || !a )
    sub_1B9026C(this, a);
