void ClientMissionManager___ctor(ClientMissionManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A85 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int___ctor__);
    sub_1C713B0(&System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__TypeInfo);
    sub_1C713B0(&Method_SingletonMonoBehaviour_ClientMissionManager___ctor__);
    byte_4CC6A85 = 1;
  }
  v3 = (System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__o *)sub_1C715FC(System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__TypeInfo);
  System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int____ctor(
    v3,
    (const MethodInfo_3515318 *)Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int___ctor__);
  this->fields.progressDictionary = v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.progressDictionary, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3A5F640 *)Method_SingletonMonoBehaviour_ClientMissionManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A83 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__ContainsKey__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__get_Item__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__set_Item__);
    byte_4CC6A83 = 1;
  }
  ...
  *(_QWORD *)&v11.fields.targetId = v5;
  progressDictionary = (System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__o *)System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int___ContainsKey(progressDictionary, v11, (const MethodInfo_3515F08 *)Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__ContainsKey__);
  if ( ((unsigned __int8)progressDictionary & 1) == 0 )
  {
    ...
    *(_QWORD *)&v12.fields.targetId = v5;
    System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int___set_Item(
      ...
      v12,
      0,
      (const MethodInfo_3515CE8 *)Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__set_Item__);
  }
  v9 = this->fields.progressDictionary;
  if ( !v9 )
LABEL_9:
    sub_1C71608(progressDictionary, *(_QWORD *)&key.fields.missionTargetId);
  ...
  *(_QWORD *)&v13.fields.targetId = v5;
  v10 = System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int___get_Item(
          v9,
          v13,
          (const MethodInfo_3515C50 *)Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__get_Item__)
      + valueToAdd;
...
void ClientMissionManager__ClearData(ClientMissionManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A84 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__Clear__);
    byte_4CC6A84 = 1;
  }
  progressDictionary = this->fields.progressDictionary;
  ...
  System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int___Clear(
    progressDictionary,
    (const MethodInfo_3515E9C *)Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__Clear__);
}
...
void ClientMissionManager__MyRoomPlayVoice(ClientMissionManager_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A81 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DataMasterBase_EventMissionConditionMaster__EventMissionConditionEntity__string__getEntitys__);
  ...
  Instance = (char *)DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_UserExchangeSvtMaster___);
  if ( !Instance )
    goto LABEL_45;
  ...
  if ( *((_DWORD *)Instance + 8) )
  {
    ...
    Instance = (char *)DataMasterBase_object__object__object___getEntitys(
                         ...
                         (const MethodInfo_340CBBC *)Method_DataMasterBase_EventMissionConditionMaster__EventMissionConditionEntity__string__getEntitys__);
    if ( !Instance )
      goto LABEL_45;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A82 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataManager_GetMaster_EventMissionCondDetailMaster___);
  ...
  v8 = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventMissionCondDetailMaster___);
  v9 = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_UserEventMissionMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A7F & 1) == 0 )
  {
    sub_1C713B0(&EventMissionProgressRequest_Argument_TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_Enumerator_ClientMissionManager_ProgressDictionaryKey__int__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_Enumerator_ClientMissionManager_ProgressDictionaryKey__int__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_Dictionary_Enumerator_ClientMissionManager_ProgressDictionaryKey__int__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_KeyValuePair_ClientMissionManager_ProgressDictionaryKey__int__get_Key__);
    sub_1C713B0(&Method_System_Collections_Generic_KeyValuePair_ClientMissionManager_ProgressDictionaryKey__int__get_Value__);
    sub_1C713B0(&Method_System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___ctor__);
    sub_1C713B0(&Method_System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__get_Count__);
    sub_1C713B0(&System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__TypeInfo);
    sub_1C713B0(&Method_NetworkManager_getRequest_EventMissionProgressRequest___);
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&EventMissionProgressRequest_Argument_ProgressData_TypeInfo);
    byte_4CC6A7F = 1;
  }
  ...
  Request_object = NetworkManager__getRequest_object_(
                     callback,
                     (const MethodInfo_31D69E8 *)Method_NetworkManager_getRequest_EventMissionProgressRequest___);
  v6 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__TypeInfo);
  ...
  System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int___GetEnumerator(
    &v26,
    progressDictionary,
    (const MethodInfo_3516124 *)Method_System_Collections_Generic_Dictionary_ClientMissionManager_ProgressDictionaryKey__int__GetEnumerator__);
  v27 = v26;
  while ( System_Collections_Generic_Dictionary_Enumerator_ClientMissionManager_ProgressDictionaryKey__int___MoveNext(
            &v27,
            (const MethodInfo_35DB4D0 *)Method_System_Collections_Generic_Dictionary_Enumerator_ClientMissionManager_ProgressDictionaryKey__int__MoveNext__) )
  {
    getEnumeratorRetType = v27.fields._getEnumeratorRetType;
    if ( v27.fields._getEnumeratorRetType )
    {
      current = v27.fields._current;
      v11 = (EventMissionProgressRequest_Argument_ProgressData_o *)sub_1C715FC(EventMissionProgressRequest_Argument_ProgressData_TypeInfo);
      ...
      else
      {
        ...
        sub_1C71354((GrandQuestFolderBoardItem_o *)(v23 + 4), (int32_t)v11, v14, v15, v16, v17, v18, v19);
      }
    }
  }
  System_Collections_Generic_Dictionary_Enumerator_ClientMissionManager_ProgressDictionaryKey__int___Dispose(
    &v27,
    (const MethodInfo_35DB604 *)Method_System_Collections_Generic_Dictionary_Enumerator_ClientMissionManager_ProgressDictionaryKey__int__Dispose__);
  if ( !v6 )
    goto LABEL_25;
  if ( v6->fields._size >= 1 )
  {
    ...
    v25 = (EventMissionProgressRequest_Argument_o *)sub_1C715FC(EventMissionProgressRequest_Argument_TypeInfo);
...
LABEL_25:
    sub_1C71608(progressDictionary, v7);
  }
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A86 & 1) == 0 )
  {
    sub_1C713B0(&ClientMissionManager_ProgressDictionaryKey_TypeInfo);
    byte_4CC6A86 = 1;
  }
  result = v3
...
bool ClientMissionManager_ProgressDictionaryKey__Equals_41522100(
        ClientMissionManager_ProgressDictionaryKey_o this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A87 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_ValueTuple_int__int__int__int__GetHashCode__);
    sub_1C713B0(&Method_System_ValueTuple_int__int__int__int___ctor__);
    byte_4CC6A87 = 1;
  }
  v3 = *v2;
  v4 = v2[1];
  ...
  System_ValueTuple_int__int__int__int____ctor(
    ...
    v5,
    v6,
    (const MethodInfo_3B894B4 *)Method_System_ValueTuple_int__int__int__int___ctor__);
  *(_OWORD *)&v8.fields.Item3 = *(_OWORD *)&v8.fields.Item1;
  return System_ValueTuple_int__int__int__int___GetHashCode(
           ...
           (const MethodInfo_3B8A214 *)Method_System_ValueTuple_int__int__int__int__GetHashCode__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6A88 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_21712/*"missionTargetId={0}, condDetailId={1}, targetId={2}, eventId={3}"*/);
    byte_4CC6A88 = 1;
  }
  v3 = (System_Object_array *)sub_1C71458(object___TypeInfo, 4);
  v39 = *v2;
...
LABEL_17:
  ...
  return System_String__Format_64073168((System_String_o *)StringLiteral_21712/*"missionTargetId={0}, condDetailId={1}, targetId={2}, eventId={3}"*/, v3, 0);
}