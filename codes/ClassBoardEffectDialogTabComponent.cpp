void ClassBoardEffectDialogTabComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C5A89D & 1) == 0 )
  {
    sub_1C3E564(&ClassBoardEffectDialogTabComponent_TypeInfo);
    sub_1C3E564(&StringLiteral_17548/*"btn_tab_{0}"*/);
    byte_4C5A89D = 1;
  }
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17548/*"btn_tab_{0}"*/;
  sub_1C3E508(
    (CGThumbnailListItem_o *)ClassBoardEffectDialogTabComponent_TypeInfo->static_fields,
    StringLiteral_17548/*"btn_tab_{0}"*/,
    v1,
    v2);
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->DISABLED_COLOR = (struct UnityEngine_Color_o)xmmword_C12500;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !buttonSprite
    || (UIWidget__set_color(
        ...
        classButton = (UICommonButton_o *)sub_1C3E60C(UnityEngine_GameObject___TypeInfo, 1),
        !v7) )
  {
LABEL_10:
    sub_1C3E7C0(classButton, isEnable);
  }
  v7->fields.tweenTargets = (struct UnityEngine_GameObject_array *)classButton;
  sub_1C3E508((CGThumbnailListItem_o *)&v7->fields.tweenTargets, (int32_t)classButton, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !isSupport )
  {
    if ( !Entity )
      goto LABEL_28;
    if ( ((v20 | ClassBoardBaseEntity__IsOpen(Entity, 0)) & 1) == 0 )
    {
      ...
      if ( buttonSprite )
      {
        ...
        classButton = this->fields.classButton;
        Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)sub_1C3E60C(UnityEngine_GameObject___TypeInfo, 1);
        if ( classButton )
        {
          classButton->fields.tweenTargets = (struct UnityEngine_GameObject_array *)Master_object;
          sub_1C3E508((CGThumbnailListItem_o *)&classButton->fields.tweenTargets, (int32_t)Master_object, v23, v24);
          goto LABEL_18;
        }
      }
LABEL_28:
...
LABEL_18:
  ...
  v32 = iconId;
  v28 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v32, v14, v15, v16, v17, v18, v19);
  ...
  GameObjectExtensions__SetLocalScale_36178300(gameObject, 0.6, 0);
  if ( !isSupport )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A89C & 1) == 0 )
  {
    sub_1C3E564(&Method_ClassBoardEffectDialogTabComponent_onClickButton__);
    byte_4C5A89C = 1;
  }
  if ( !this->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardEffectDialogTabComponent_onClickButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_ClassBoardEffectDialogTabComponent_onClickButton__);
