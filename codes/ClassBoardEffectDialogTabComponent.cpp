void __fastcall ClassBoardEffectDialogTabComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A22EA5 & 1) == 0 )
  {
    sub_1B715CC(&ClassBoardEffectDialogTabComponent_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_17497/*"btn_tab_{0}"*/, v4);
    byte_4A22EA5 = 1;
  }
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17497/*"btn_tab_{0}"*/;
  sub_1B71570(
    (ServantStatusBattleListViewItem_o *)ClassBoardEffectDialogTabComponent_TypeInfo->static_fields,
    StringLiteral_17497/*"btn_tab_{0}"*/,
    v2,
    v3);
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->DISABLED_COLOR = (struct UnityEngine_Color_o)xmmword_BAAFA0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22EA3 & 1) == 0 )
  {
    sub_1B715CC(&ClassBoardEffectDialogTabComponent_TypeInfo, isEnable);
  ...
  if ( !buttonSprite
    || (UIWidget__set_color(
        ...
        classButton = (UICommonButton_o *)sub_1B71674(UnityEngine_GameObject___TypeInfo, 1LL),
        !v8) )
  {
LABEL_10:
    sub_1B71828(classButton, isEnable);
  }
  v8->fields.tweenTargets = (struct UnityEngine_GameObject_array *)classButton;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v8->fields.tweenTargets, (int32_t)classButton, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22EA2 & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, effectListDialog);
    sub_1B715CC(&ClassBoardEffectDialogTabComponent_TypeInfo, v11);
    sub_1B715CC(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v12);
    sub_1B715CC(&DataManager_TypeInfo, v13);
    sub_1B715CC(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__GetEntity__, v14);
    sub_1B715CC(&UnityEngine_GameObject___TypeInfo, v15);
  ...
  if ( !isSupport )
  {
    ...
    if ( !ClassBoardBaseEntity__IsOpen((ClassBoardBaseEntity_o *)Master_object, 0LL) )
    {
      ...
      if ( buttonSprite )
      {
        ...
        classButton = this->fields.classButton;
        Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)sub_1B71674(
...
LABEL_14:
  ...
  GameObjectExtensions__SetLocalScale_33531524(gameObject, 0.6, 0LL);
  if ( !isSupport )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22EA4 & 1) == 0 )
  {
    sub_1B715CC(&Method_ClassBoardEffectDialogTabComponent_onClickButton__, method);
    byte_4A22EA4 = 1;
  }
  if ( !this->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardEffectDialogTabComponent_onClickButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_ClassBoardEffectDialogTabComponent_onClickButton__);
