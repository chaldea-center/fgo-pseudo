void __fastcall ClassBoardEffectDialogTabComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C00D97 & 1) == 0 )
  {
    sub_1C2E12C(&ClassBoardEffectDialogTabComponent_TypeInfo, v1);
    sub_1C2E12C(&StringLiteral_17856/*"btn_tab_{0}"*/, v8);
    byte_4C00D97 = 1;
  }
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17856/*"btn_tab_{0}"*/;
  sub_1C2E0D0(
    ...
    v6,
    v7);
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->DISABLED_COLOR = (struct UnityEngine_Color_o)xmmword_C06660;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00D95 & 1) == 0 )
  {
    sub_1C2E12C(&ClassBoardEffectDialogTabComponent_TypeInfo, isEnable);
  ...
  if ( !buttonSprite
    || (UIWidget__set_color(
        ...
        classButton = (UICommonButton_o *)sub_1C2E1D4(UnityEngine_GameObject___TypeInfo, 1LL),
        !v8) )
  {
LABEL_10:
    sub_1C2E388(classButton, isEnable);
  }
  v8->fields.tweenTargets = (struct UnityEngine_GameObject_array *)classButton;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v8->fields.tweenTargets, (int64_t)classButton, v9, v10, v11, v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00D94 & 1) == 0 )
  {
    sub_1C2E12C(&AtlasManager_TypeInfo, effectListDialog);
    sub_1C2E12C(&ClassBoardEffectDialogTabComponent_TypeInfo, v13);
    sub_1C2E12C(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v14);
    sub_1C2E12C(&DataManager_TypeInfo, v15);
    sub_1C2E12C(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__GetEntity__, v16);
    sub_1C2E12C(&UnityEngine_GameObject___TypeInfo, v17);
  ...
  if ( !isSupport )
  {
    ...
    if ( !ClassBoardBaseEntity__IsOpen((ClassBoardBaseEntity_o *)Master_object, 0LL) )
    {
      ...
      if ( buttonSprite )
      {
        ...
        classButton = this->fields.classButton;
        Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)sub_1C2E1D4(
...
LABEL_14:
  ...
  GameObjectExtensions__SetLocalScale_34859908(gameObject, 0.6, 0LL);
  if ( !isSupport )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00D96 & 1) == 0 )
  {
    sub_1C2E12C(&Method_ClassBoardEffectDialogTabComponent_onClickButton__, method);
    byte_4C00D96 = 1;
  }
  if ( !this->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardEffectDialogTabComponent_onClickButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_ClassBoardEffectDialogTabComponent_onClickButton__);
