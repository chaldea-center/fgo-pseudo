void ClassBoardEffectDialogTabComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E08690 & 1) == 0 )
  {
    sub_1CE6700(&ClassBoardEffectDialogTabComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_17718/*"btn_tab_{0}"*/);
    byte_4E08690 = 1;
  }
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17718/*"btn_tab_{0}"*/;
  sub_1CE66A4(
    ...
    v5,
    v6);
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->DISABLED_COLOR = (struct UnityEngine_Color_o)xmmword_D25110;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !buttonSprite
    || (UIWidget__set_color(
        ...
        classButton = (UICommonButton_o *)sub_1CE67A8(UnityEngine_GameObject___TypeInfo, 1),
        !v7) )
  {
LABEL_10:
    sub_1CE6958(classButton, isEnable);
  }
  v7->fields.tweenTargets = (struct UnityEngine_GameObject_array *)classButton;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v7->fields.tweenTargets, (int32_t)classButton, v8, v9, v10, v11, v12, v13);
}
  ...
  if ( !isSupport )
  {
    ...
    if ( ((v16 | ClassBoardBaseEntity__IsOpen(Entity, 0)) & 1) == 0 )
    {
      ...
      if ( buttonSprite )
      {
        ...
        classButton = this->fields.classButton;
        Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)sub_1CE67A8(UnityEngine_GameObject___TypeInfo, 1);
        if ( classButton )
        {
...
LABEL_18:
  ...
  GameObjectExtensions__SetLocalScale_37163176(gameObject, 0.6, 0);
  if ( !isSupport )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0868F & 1) == 0 )
  {
    sub_1CE6700(&Method_ClassBoardEffectDialogTabComponent_onClickButton__);
    byte_4E0868F = 1;
  }
  if ( !this->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardEffectDialogTabComponent_onClickButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ClassBoardEffectDialogTabComponent_onClickButton__);
