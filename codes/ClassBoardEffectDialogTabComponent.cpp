void ClassBoardEffectDialogTabComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB9E6F & 1) == 0 )
  {
    sub_1C6BA08(&ClassBoardEffectDialogTabComponent_TypeInfo);
    sub_1C6BA08(&StringLiteral_17546/*"btn_tab_{0}"*/);
    byte_4CB9E6F = 1;
  }
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17546/*"btn_tab_{0}"*/;
  sub_1C6B9AC(
    (CGThumbnailListItem_o *)ClassBoardEffectDialogTabComponent_TypeInfo->static_fields,
    StringLiteral_17546/*"btn_tab_{0}"*/,
    v1,
    v2);
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->DISABLED_COLOR = (struct UnityEngine_Color_o)xmmword_CEC7C0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !buttonSprite
    || (UIWidget__set_color(
        ...
        classButton = (UICommonButton_o *)sub_1C6BAB0(UnityEngine_GameObject___TypeInfo, 1),
        !v7) )
  {
LABEL_10:
    sub_1C6BC60(classButton, isEnable);
  }
  v7->fields.tweenTargets = (struct UnityEngine_GameObject_array *)classButton;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v7->fields.tweenTargets, (int32_t)classButton, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !isSupport )
  {
    if ( !Entity )
      goto LABEL_28;
    if ( ((v14 | ClassBoardBaseEntity__IsOpen(Entity, 0)) & 1) == 0 )
    {
      ...
      if ( buttonSprite )
      {
        ...
        classButton = this->fields.classButton;
        Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)sub_1C6BAB0(UnityEngine_GameObject___TypeInfo, 1);
        if ( classButton )
        {
          classButton->fields.tweenTargets = (struct UnityEngine_GameObject_array *)Master_object;
          sub_1C6B9AC((CGThumbnailListItem_o *)&classButton->fields.tweenTargets, (int32_t)Master_object, v17, v18);
          goto LABEL_18;
        }
      }
LABEL_28:
...
LABEL_18:
  ...
  v23 = System_String__Format(TAB_BTN_NAME_FORMAT, v22, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetClassIconSprite(v19, v23, 0);
  ...
  GameObjectExtensions__SetLocalScale_36358148(gameObject, 0.6, 0);
  if ( !isSupport )
    ClassBoardEffectDialogTabComponent__SetButtonState(this, isDisp, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9E6E & 1) == 0 )
  {
    sub_1C6BA08(&Method_ClassBoardEffectDialogTabComponent_onClickButton__);
    byte_4CB9E6E = 1;
  }
  if ( !this->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardEffectDialogTabComponent_onClickButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ClassBoardEffectDialogTabComponent_onClickButton__);
