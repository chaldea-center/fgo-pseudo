void __fastcall ClassBoardEffectDialogTabComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A3131B & 1) == 0 )
  {
    sub_1B761C0(&ClassBoardEffectDialogTabComponent_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_17541/*"btn_tab_{0}"*/, v4);
    byte_4A3131B = 1;
  }
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->TAB_BTN_NAME_FORMAT = (struct System_String_o *)StringLiteral_17541/*"btn_tab_{0}"*/;
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)ClassBoardEffectDialogTabComponent_TypeInfo->static_fields,
    StringLiteral_17541/*"btn_tab_{0}"*/,
    v2,
    v3);
  ClassBoardEffectDialogTabComponent_TypeInfo->static_fields->DISABLED_COLOR = (struct UnityEngine_Color_o)xmmword_BAD370;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31319 & 1) == 0 )
  {
    sub_1B761C0(&ClassBoardEffectDialogTabComponent_TypeInfo, isEnable);
  ...
  if ( !buttonSprite
    || (UIWidget__set_color(
        ...
        classButton = (UICommonButton_o *)sub_1B76268(UnityEngine_GameObject___TypeInfo, 1LL),
        !v8) )
  {
LABEL_10:
    sub_1B7641C(classButton, isEnable);
  }
  v8->fields.tweenTargets = (struct UnityEngine_GameObject_array *)classButton;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v8->fields.tweenTargets, (int32_t)classButton, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31318 & 1) == 0 )
  {
    sub_1B761C0(&AtlasManager_TypeInfo, effectListDialog);
    sub_1B761C0(&ClassBoardEffectDialogTabComponent_TypeInfo, v11);
    sub_1B761C0(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, v12);
    sub_1B761C0(&DataManager_TypeInfo, v13);
    sub_1B761C0(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__GetEntity__, v14);
    sub_1B761C0(&UnityEngine_GameObject___TypeInfo, v15);
  ...
  if ( !isSupport )
  {
    ...
    if ( !ClassBoardBaseEntity__IsOpen((ClassBoardBaseEntity_o *)Master_object, 0LL) )
    {
      ...
      if ( buttonSprite )
      {
        ...
        classButton = this->fields.classButton;
        Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)sub_1B76268(
...
LABEL_14:
  ...
  GameObjectExtensions__SetLocalScale_33554168(gameObject, 0.6, 0LL);
  if ( !isSupport )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3131A & 1) == 0 )
  {
    sub_1B761C0(&Method_ClassBoardEffectDialogTabComponent_onClickButton__, method);
    byte_4A3131A = 1;
  }
  if ( !this->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardEffectDialogTabComponent_onClickButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B761D8(Method_ClassBoardEffectDialogTabComponent_onClickButton__);
