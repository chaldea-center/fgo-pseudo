void __fastcall ClassBoardEffectDialogTabComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B383F & 1) == 0 )
  {
    sub_B52984(&ClassBoardEffectDialogTabComponent_TypeInfo);
    sub_B52984(&StringLiteral_17145/*"btn_tab_{0}"*/);
    byte_42B383F = 1;
  }
  static_fields = (BattleServantConfConponent_o *)ClassBoardEffectDialogTabComponent_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_17145/*"btn_tab_{0}"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_17145/*"btn_tab_{0}"*/;
  sub_B52920(static_fields, v8, v1, v2, v3, v4, v5, v6);
  v13.fields.r = 0.30196;
  v12 = (struct UnityEngine_Color_o)0LL;
  v13.fields.g = 0.30196;
  v13.fields.b = 0.30196;
  UnityEngine_Color___ctor_41463668(v13, v9, v10, v11, (const MethodInfo *)&v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( !buttonSprite
    || (UIWidget__set_color(
        ...
        classButton = (UICommonButton_o *)sub_B5299C(UnityEngine_GameObject___TypeInfo, 1LL),
        !v7) )
  {
LABEL_11:
    sub_B52A5C(classButton, isEnable);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !isSupport )
  {
    if ( !Master_WarQuestSelectionMaster )
      goto LABEL_28;
    if ( !ClassBoardBaseEntity__IsOpen((ClassBoardBaseEntity_o *)Master_WarQuestSelectionMaster, v14) )
    {
      buttonSprite = (UIWidget_o *)this->fields.buttonSprite;
      ...
      if ( buttonSprite )
      {
        UIWidget__set_color(
          ...
          *(UnityEngine_Color_o *)&Master_WarQuestSelectionMaster[2].fields._lookup->monitor,
          0LL);
        classButton = this->fields.classButton;
        Master_WarQuestSelectionMaster = (DataMasterBase_WarMaster__WarEntity__int__o *)sub_B5299C(
...
LABEL_16:
  ...
  v28 = System_String__Format(TAB_BTN_NAME_FORMAT, v27, 0LL);
  if ( (BYTE3(AtlasManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetClassIconSprite(v24, v28, 0LL);
  ...
  GameObjectExtensions__SetLocalScale_32087216(gameObject, 0.6, 0LL);
  if ( !isSupport )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B383E & 1) == 0 )
  {
    sub_B52984(&Method_ClassBoardEffectDialogTabComponent_onClickButton__);
    byte_42B383E = 1;
  }
  if ( !this->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardEffectDialogTabComponent_onClickButton__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B5298C(Method_ClassBoardEffectDialogTabComponent_onClickButton__);
