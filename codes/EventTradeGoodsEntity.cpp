...
int32_t __fastcall EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70002 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventTradePickupMaster_TypeInfo, v4);
    byte_4A70002 = 1;
  }
  pickupEntity = 0LL;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A70008 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_24720/*"welcomeAbleReceive"*/, method);
    byte_4A70008 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24720/*"welcomeAbleReceive"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A70006 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_24721/*"welcomeDefault"*/, method);
    byte_4A70006 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24721/*"welcomeDefault"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A70005 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_22559/*"pickup"*/, method);
    byte_4A70005 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_22559/*"pickup"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A70007 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_24722/*"welcomeRefillable"*/, method);
    byte_4A70007 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24722/*"welcomeRefillable"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A70004 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_16686/*"add"*/, method);
    byte_4A70004 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_16686/*"add"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A70003 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_23517/*"start"*/, method);
    byte_4A70003 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_23517/*"start"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70009 & 1) == 0 )
  {
    ...
    sub_1B90010(&DataManager_TypeInfo, v3);
    sub_1B90010(&Method_System_Collections_Generic_List_string__AddRange__, v4);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (UserEventTradeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_UserEventTradeMaster___);
  if ( !Master_object )
    goto LABEL_23;
