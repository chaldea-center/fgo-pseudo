...
int32_t EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_EventTradePickupMaster___);
  if ( !Master_object )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  if ( (byte_4CB6472 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_24914/*"welcomeAbleReceive"*/);
    byte_4CB6472 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_24914/*"welcomeAbleReceive"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4CB6470 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_24915/*"welcomeDefault"*/);
    byte_4CB6470 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_24915/*"welcomeDefault"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4CB646F & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_22781/*"pickup"*/);
    byte_4CB646F = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_22781/*"pickup"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4CB6471 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_24916/*"welcomeRefillable"*/);
    byte_4CB6471 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_24916/*"welcomeRefillable"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4CB646E & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_16668/*"add"*/);
    byte_4CB646E = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_16668/*"add"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4CB646D & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_23745/*"start"*/);
    byte_4CB646D = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_23745/*"start"*/, 0);
}
