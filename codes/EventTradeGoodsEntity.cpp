...
int32_t EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_EventTradePickupMaster___);
  if ( !Master_object )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04BC8 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_25216/*"welcomeAbleReceive"*/);
    byte_4E04BC8 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_25216/*"welcomeAbleReceive"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04BC6 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_25217/*"welcomeDefault"*/);
    byte_4E04BC6 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_25217/*"welcomeDefault"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04BC5 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_23048/*"pickup"*/);
    byte_4E04BC5 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_23048/*"pickup"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04BC7 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_25218/*"welcomeRefillable"*/);
    byte_4E04BC7 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_25218/*"welcomeRefillable"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04BC4 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_16829/*"add"*/);
    byte_4E04BC4 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_16829/*"add"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04BC3 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_24026/*"start"*/);
    byte_4E04BC3 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_24026/*"start"*/, 0);
}
