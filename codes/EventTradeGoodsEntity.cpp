...
int32_t __fastcall EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C220E9 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_EventTradePickupMaster___, method);
    sub_1C3B764(&DataManager_TypeInfo, v3);
    sub_1C3B764(&EventTradePickupMaster_TypeInfo, v4);
    byte_4C220E9 = 1;
  }
  pickupEntity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_EventTradePickupMaster___);
  if ( !Master_object )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  if ( (byte_4C220EF & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_25193, method);
    byte_4C220EF = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_25193,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C220ED & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_25194, method);
    byte_4C220ED = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
        ...
        const MethodInfo *method)
{
  if ( (byte_4C220EC & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_22990/*"showEnemyMasterIconOnWaveStart"*/, method);
    byte_4C220EC = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_22990/*"showEnemyMasterIconOnWaveStart"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C220EE & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_25195, method);
    byte_4C220EE = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
        ...
        const MethodInfo *method)
{
  if ( (byte_4C220EB & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_16983/*"blanchedalmond"*/, method);
    byte_4C220EB = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_16983/*"blanchedalmond"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C220EA & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_23973/*"updateNp"*/, method);
    byte_4C220EA = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_23973/*"updateNp"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C220F0 & 1) == 0 )
  {
    ...
    sub_1C3B764(&DataManager_TypeInfo, v3);
    sub_1C3B764(&Method_System_Collections_Generic_List_string__AddRange__, v4);
  ...
  v10 = (System_Collections_Generic_List_object__o *)sub_1C3B9B0(System_Collections_Generic_List_string__TypeInfo);
