...
int32_t __fastcall EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E0D9 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_EventTradePickupMaster___, method);
    sub_1B761C0(&DataManager_TypeInfo, v3);
    sub_1B761C0(&EventTradePickupMaster_TypeInfo, v4);
    byte_4A2E0D9 = 1;
  }
  pickupEntity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_EventTradePickupMaster___);
  if ( !Master_object )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E0DF & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_24668/*"welcomeAbleReceive"*/, method);
    byte_4A2E0DF = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24668/*"welcomeAbleReceive"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E0DD & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_24669/*"welcomeDefault"*/, method);
    byte_4A2E0DD = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24669/*"welcomeDefault"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E0DC & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_22516/*"pickup"*/, method);
    byte_4A2E0DC = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_22516/*"pickup"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E0DE & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_24670/*"welcomeRefillable"*/, method);
    byte_4A2E0DE = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24670/*"welcomeRefillable"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E0DB & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_16655/*"add"*/, method);
    byte_4A2E0DB = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_16655/*"add"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E0DA & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_23468/*"start"*/, method);
    byte_4A2E0DA = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_23468/*"start"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E0E0 & 1) == 0 )
  {
    ...
    sub_1B761C0(&DataManager_TypeInfo, v3);
    sub_1B761C0(&Method_System_Collections_Generic_List_string__AddRange__, v4);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (UserEventTradeMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_UserEventTradeMaster___);
  if ( !Master_object )
    goto LABEL_23;
