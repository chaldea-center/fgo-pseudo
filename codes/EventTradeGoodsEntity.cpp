...
int32_t __fastcall EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC6C & 1) == 0 )
  {
    ...
    sub_1B715CC(&EventTradePickupMaster_TypeInfo, v4);
    byte_4A1FC6C = 1;
  }
  pickupEntity = 0LL;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FC72 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_24622/*"welcomeAbleReceive"*/, method);
    byte_4A1FC72 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24622/*"welcomeAbleReceive"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FC70 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_24623/*"welcomeDefault"*/, method);
    byte_4A1FC70 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24623/*"welcomeDefault"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FC6F & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22470/*"pickup"*/, method);
    byte_4A1FC6F = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_22470/*"pickup"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FC71 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_24624/*"welcomeRefillable"*/, method);
    byte_4A1FC71 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24624/*"welcomeRefillable"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FC6E & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_16611/*"add"*/, method);
    byte_4A1FC6E = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_16611/*"add"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1FC6D & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_23422/*"start"*/, method);
    byte_4A1FC6D = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_23422/*"start"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FC73 & 1) == 0 )
  {
    ...
    sub_1B715CC(&DataManager_TypeInfo, v3);
    sub_1B715CC(&Method_System_Collections_Generic_List_string__AddRange__, v4);
