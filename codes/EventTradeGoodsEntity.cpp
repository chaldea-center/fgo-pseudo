...
int32_t __fastcall EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB4866 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMaster_EventTradePickupMaster___, method);
    sub_1C13D24(&DataManager_TypeInfo, v3);
    sub_1C13D24(&EventTradePickupMaster_TypeInfo, v4);
    byte_4BB4866 = 1;
  }
  pickupEntity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_EventTradePickupMaster___);
  if ( !Master_object )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB486C & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_25079/*"warboardcontinue.dat"*/, method);
    byte_4BB486C = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_25079/*"warboardcontinue.dat"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB486A & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_25080/*"warboardmessagehistorysave.dat"*/, method);
    byte_4BB486A = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_25080/*"warboardmessagehistorysave.dat"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB4869 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_22900/*"performance.json"*/, method);
    byte_4BB4869 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_22900/*"performance.json"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB486B & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_25081/*"warboardmoviehistorysave.dat"*/, method);
    byte_4BB486B = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_25081/*"warboardmoviehistorysave.dat"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB4868 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_16917/*"actionType"*/, method);
    byte_4BB4868 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_16917/*"actionType"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB4867 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_23868/*"squares_target"*/, method);
    byte_4BB4867 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_23868/*"squares_target"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB486D & 1) == 0 )
  {
    ...
    sub_1C13D24(&DataManager_TypeInfo, v3);
    sub_1C13D24(&Method_System_Collections_Generic_List_string__AddRange__, v4);
