...
int32_t EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_EventTradePickupMaster___);
  if ( !Master_object )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  if ( (byte_4E7784B & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_25325/*"welcomeAbleReceive"*/);
    byte_4E7784B = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_25325/*"welcomeAbleReceive"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E77849 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_25326/*"welcomeDefault"*/);
    byte_4E77849 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_25326/*"welcomeDefault"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E77848 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_23147/*"pickup"*/);
    byte_4E77848 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_23147/*"pickup"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E7784A & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_25327/*"welcomeRefillable"*/);
    byte_4E7784A = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_25327/*"welcomeRefillable"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E77847 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_16900/*"add"*/);
    byte_4E77847 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_16900/*"add"*/, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E77846 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_24128/*"start"*/);
    byte_4E77846 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(this->fields.voiceData, (System_String_o *)StringLiteral_24128/*"start"*/, 0);
}
