...
int32_t __fastcall EventTradeGoodsEntity__GetPickUpRateNow(EventTradeGoodsEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A08E00 & 1) == 0 )
  {
    ...
    sub_1B686D4(&EventTradePickupMaster_TypeInfo, v4);
    byte_4A08E00 = 1;
  }
  pickupEntity = 0LL;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A08E06 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_24598/*"welcomeAbleReceive"*/, method);
    byte_4A08E06 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24598/*"welcomeAbleReceive"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A08E04 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_24599/*"welcomeDefault"*/, method);
    byte_4A08E04 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24599/*"welcomeDefault"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A08E03 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_22449/*"pickup"*/, method);
    byte_4A08E03 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_22449/*"pickup"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A08E05 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_24600/*"welcomeRefillable"*/, method);
    byte_4A08E05 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_24600/*"welcomeRefillable"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A08E02 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_16595/*"add"*/, method);
    byte_4A08E02 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
        ...
        const MethodInfo *method)
{
  if ( (byte_4A08E01 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_23399/*"start"*/, method);
    byte_4A08E01 = 1;
  }
  return EntityScriptUtil__GetStringArrayDefaultEmpty(
           this->fields.voiceData,
           (System_String_o *)StringLiteral_23399/*"start"*/,
           0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08E07 & 1) == 0 )
  {
    ...
    sub_1B686D4(&DataManager_TypeInfo, v3);
    sub_1B686D4(&Method_System_Collections_Generic_List_string__AddRange__, v4);
