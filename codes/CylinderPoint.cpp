...
System_String_o *__fastcall CylinderPoint__GetEffectName(CylinderPoint_o *this, const MethodInfo *method)
{
  if ( (byte_4A57D49 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_18826/*"ef_difference21"*/);
    byte_4A57D49 = 1;
  }
  return (System_String_o *)StringLiteral_18826/*"ef_difference21"*/;
}
  ...
  if ( !UnityEngine_Object__op_Equality(mWidget, 0LL, 0LL) )
  {
    ...
    *(_QWORD *)&vec.fields.x = *(_QWORD *)&static_fields->zeroVector.fields.x;
    ...
    if ( UnityEngine_Object__op_Inequality(mParticleSystem, 0LL, 0LL) )
    {
      ...
      if ( !transform )
        goto LABEL_30;
      v14.fields.m_ParticleSystem = UnityEngine_ParticleSystem__get_main(transform, 0LL).fields.m_ParticleSystem;
      v24.fields.a = value;
      m_ParticleSystem = v14.fields.m_ParticleSystem;
      v24.fields.r = r;
      v24.fields.g = g;
      v24.fields.b = b;
      UnityEngine_ParticleSystem_MinMaxGradient__op_Implicit(&v19, v24, 0LL);
      v23.fields.m_ParticleSystem = (struct UnityEngine_ParticleSystem_o *)&m_ParticleSystem;
      v18 = v19;
      UnityEngine_ParticleSystem_MainModule__set_startColor(v23, &v18, 0LL);
    }
