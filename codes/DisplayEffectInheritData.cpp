        ...
        const MethodInfo *method)
{
  ...
  v8 = (System_Collections_Generic_Dictionary_int__float__o *)sub_1B887FC(System_Collections_Generic_Dictionary_int__float__TypeInfo);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v8, v9, v10);
...
float __fastcall DisplayEffectInheritData__GetMaxInterval(DisplayEffectInheritData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5D600 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Collections_Generic_Dictionary_int__float__get_Count__);
    sub_1B885B0(&Method_System_Collections_Generic_Dictionary_int__float__get_Values__);
    byte_4A5D600 = 1;
  }
  ...
  if ( System_Collections_Generic_Dictionary_int__float___get_Count(
         popTiming,
         (const MethodInfo_317353C *)Method_System_Collections_Generic_Dictionary_int__float__get_Count__) >= 1 )
  {
    popTiming = this->fields.popTiming;
    if ( popTiming )
    {
      Values = System_Collections_Generic_Dictionary_int__float___get_Values(
                 popTiming,
                 (const MethodInfo_317369C *)Method_System_Collections_Generic_Dictionary_int__float__get_Values__);
      return System_Linq_Enumerable__Max_63930904((System_Collections_Generic_IEnumerable_float__o *)Values, 0LL);
    }
LABEL_8:
    sub_1B8880C(popTiming, method);
  }
  return 0.0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D5FF & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Collections_Generic_Dictionary_int__float__TryGetValue__);
    sub_1B885B0(&Method_System_Collections_Generic_Dictionary_int__float__get_Item__);
    sub_1B885B0(&Method_System_Collections_Generic_Dictionary_int__float__set_Item__);
    byte_4A5D5FF = 1;
  }
  value = 0.0;
  popTiming = this->fields.popTiming;
  ...
  v14 = System_Collections_Generic_Dictionary_int__float___TryGetValue(
          ...
          targetId,
          &value,
          (const MethodInfo_3174F34 *)Method_System_Collections_Generic_Dictionary_int__float__TryGetValue__);
  if ( svtData )
  {
    if ( !v14 )
    {
  ...
  System_Collections_Generic_Dictionary_int__float___set_Item(
    ...
    (const MethodInfo_3173874 *)Method_System_Collections_Generic_Dictionary_int__float__set_Item__);
...
LABEL_17:
    sub_1B8880C(popTiming, *(_QWORD *)&targetId);
  }
  return value;
}
