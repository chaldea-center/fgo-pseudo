        ...
        const MethodInfo *method)
{
  ...
  v8 = (System_Collections_Generic_Dictionary_int__float__o *)sub_1CE694C(System_Collections_Generic_Dictionary_int__float__TypeInfo);
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)v8, v9, v10, v11, v12, v13, v14);
...
float DisplayEffectInheritData__GetMaxInterval(DisplayEffectInheritData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0741D & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__float__get_Count__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__float__get_Values__);
    byte_4E0741D = 1;
  }
  ...
  if ( System_Collections_Generic_Dictionary_int__float___get_Count(
         popTiming,
         (const MethodInfo_35610B8 *)Method_System_Collections_Generic_Dictionary_int__float__get_Count__) >= 1 )
  {
    popTiming = this->fields.popTiming;
    if ( popTiming )
    {
      Values = System_Collections_Generic_Dictionary_int__float___get_Values(
                 popTiming,
                 (const MethodInfo_3561218 *)Method_System_Collections_Generic_Dictionary_int__float__get_Values__);
      return System_Linq_Enumerable__Max_68126704((System_Collections_Generic_IEnumerable_float__o *)Values, 0);
    }
LABEL_8:
    sub_1CE6958(popTiming, method);
  }
  return 0.0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0741C & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__float__TryGetValue__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__float__get_Item__);
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__float__set_Item__);
    byte_4E0741C = 1;
  }
  value = 0.0;
  popTiming = this->fields.popTiming;
  ...
  v14 = System_Collections_Generic_Dictionary_int__float___TryGetValue(
          ...
          targetId,
          &value,
          (const MethodInfo_3562AB0 *)Method_System_Collections_Generic_Dictionary_int__float__TryGetValue__);
  if ( svtData )
  {
    if ( !v14 )
    {
  ...
  System_Collections_Generic_Dictionary_int__float___set_Item(
    ...
    (const MethodInfo_35613F0 *)Method_System_Collections_Generic_Dictionary_int__float__set_Item__);
...
LABEL_17:
    sub_1CE6958(popTiming, *(_QWORD *)&targetId);
  }
  return value;
}
