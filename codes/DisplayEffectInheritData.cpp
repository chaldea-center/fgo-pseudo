        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A0EB & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_int__float___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_Dictionary_int__float__TypeInfo);
    byte_4E7A0EB = 1;
  }
  v7 = isSetNextPossibleTime;
  v8 = (System_Collections_Generic_Dictionary_int__float__o *)sub_1D0F300(System_Collections_Generic_Dictionary_int__float__TypeInfo);
  System_Collections_Generic_Dictionary_int__float____ctor(
    v8,
    (const MethodInfo_35AD68C *)Method_System_Collections_Generic_Dictionary_int__float___ctor__);
  this->fields.popTiming = v8;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)v8, v9, v10, v11, v12, v13, v14);
...
float DisplayEffectInheritData__GetMaxInterval(DisplayEffectInheritData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7A0ED & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_int__float__get_Count__);
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_int__float__get_Values__);
    byte_4E7A0ED = 1;
  }
  ...
  if ( System_Collections_Generic_Dictionary_int__float___get_Count(
         popTiming,
         (const MethodInfo_35ADD0C *)Method_System_Collections_Generic_Dictionary_int__float__get_Count__) >= 1 )
  {
    popTiming = this->fields.popTiming;
    if ( popTiming )
    {
      Values = System_Collections_Generic_Dictionary_int__float___get_Values(
                 popTiming,
                 (const MethodInfo_35ADE6C *)Method_System_Collections_Generic_Dictionary_int__float__get_Values__);
      return System_Linq_Enumerable__Max_68566800((System_Collections_Generic_IEnumerable_float__o *)Values, 0);
    }
LABEL_8:
    sub_1D0F30C(popTiming, method);
  }
  return 0.0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A0EC & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_int__float__TryGetValue__);
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_int__float__get_Item__);
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_int__float__set_Item__);
    byte_4E7A0EC = 1;
  }
  value = 0.0;
  popTiming = this->fields.popTiming;
  ...
  v14 = System_Collections_Generic_Dictionary_int__float___TryGetValue(
          ...
          targetId,
          &value,
          (const MethodInfo_35AF704 *)Method_System_Collections_Generic_Dictionary_int__float__TryGetValue__);
  if ( svtData )
  {
    if ( !v14 )
    {
  ...
  System_Collections_Generic_Dictionary_int__float___set_Item(
    ...
    (const MethodInfo_35AE044 *)Method_System_Collections_Generic_Dictionary_int__float__set_Item__);
    ...
    if ( popTiming )
    {
      svtData->fields.nextPossibleTimePopEffect = time
                                                + System_Collections_Generic_Dictionary_int__float___get_Item(
                                                    popTiming,
                                                    targetId,
                                                    (const MethodInfo_35ADFBC *)Method_System_Collections_Generic_Dictionary_int__float__get_Item__);
      return value;
    }
LABEL_17:
    sub_1D0F30C(popTiming, *(_QWORD *)&targetId);
  }
  return value;
}
