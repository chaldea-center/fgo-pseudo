        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.info, (int32_t)info, v6, v7);
}
...
System_String_o *__fastcall ShopHelpListViewItem__get_InfoText(ShopHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A052E9 & 1) == 0 )
  {
    this = (ShopHelpListViewItem_o *)sub_1B686D4(&LocalizationManager_TypeInfo, method);
    byte_4A052E9 = 1;
  }
  info = v2->fields.info;
  if ( !info )
