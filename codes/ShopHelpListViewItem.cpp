        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.info, (int32_t)info, v6, v7);
}
...
System_String_o *__fastcall ShopHelpListViewItem__get_InfoText(ShopHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F8AEB & 1) == 0 )
  {
    this = (ShopHelpListViewItem_o *)sub_1B640C8(&LocalizationManager_TypeInfo, method);
    byte_49F8AEB = 1;
  }
  info = v2->fields.info;
  if ( !info )
