        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.info, (int32_t)info, v6, v7);
}
...
System_String_o *__fastcall ShopHelpListViewItem__get_InfoText(ShopHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C148 & 1) == 0 )
  {
    this = (ShopHelpListViewItem_o *)sub_1B715CC(&LocalizationManager_TypeInfo, method);
    byte_4A1C148 = 1;
  }
  info = v2->fields.info;
  if ( !info )
