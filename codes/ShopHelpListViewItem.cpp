        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.info, (int64_t)info, v6, v7, v8, v9, v10, v11);
}
...
System_String_o *__fastcall ShopHelpListViewItem__get_InfoText(ShopHelpListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD89F5 & 1) == 0 )
  {
    this = (ShopHelpListViewItem_o *)sub_1C21E38(&LocalizationManager_TypeInfo);
    byte_4BD89F5 = 1;
  }
  info = v2->fields.info;
  if ( !info )
