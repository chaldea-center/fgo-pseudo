void __fastcall WarBoardCommonReleaseMaster___ctor(WarBoardCommonReleaseMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    465,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_WarBoardCommonReleaseMaster__WarBoardCommonReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (WarBoardCommonReleaseEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                            (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                            PK,
                                            (const MethodInfo_312C900 *)Method_DataMasterBase_WarBoardCommonReleaseMaster__WarBoardCommonReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70DDC & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_WarBoardCommonReleaseEntity__Add__, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_WarBoardCommonReleaseEntity__ToArray__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_WarBoardCommonReleaseEntity___ctor__, v8);
    sub_1B90010(&System_Collections_Generic_List_WarBoardCommonReleaseEntity__TypeInfo, v9);
    sub_1B90010(&WarBoardCommonReleaseEntity_TypeInfo, v10);
    byte_4A70DDC = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_WarBoardCommonReleaseEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_WarBoardCommonReleaseEntity___ctor__);
...
LABEL_20:
  ...
  return (WarBoardCommonReleaseEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                v11,
                                                (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_WarBoardCommonReleaseEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  condGroup = 0;
  return WarBoardCommonReleaseMaster__IsOpen_40379388(this, id, &condGroup, v3);
}


// local variable allocation has failed, the output may be wrong!
bool __fastcall WarBoardCommonReleaseMaster__IsOpen_40379388(
        WarBoardCommonReleaseMaster_o *this,
        int32_t id,
        int32_t *condGroup,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70DDD & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_int__bool__GetEnumerator__, v8);
    ...
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_Enumerator_int__bool__Dispose__, v14);
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_Enumerator_int__bool__MoveNext__, v15);
    sub_1B90010(&Method_System_Collections_Generic_Dictionary_Enumerator_int__bool__get_Current__, v16);
    sub_1B90010(&Method_System_Collections_Generic_KeyValuePair_int__bool__get_Key__, v17);
    sub_1B90010(&Method_System_Collections_Generic_KeyValuePair_int__bool__get_Value__, v18);
    byte_4A70DDD = 1;
  }
  memset(&v32, 0, 32);
  *condGroup = -1;
  if ( (id & 0x80000000) != 0 )
    return 0;
  v19 = (System_Collections_Generic_Dictionary_int__bool__o *)sub_1B9025C(System_Collections_Generic_Dictionary_int__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_WarBoardCommonReleaseMaster__WarBoardCommonReleaseEntity__string__TryGetEntity__);
}