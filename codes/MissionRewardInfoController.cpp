void __fastcall MissionRewardInfoController___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A4 & 1) == 0 )
  {
    sub_1B4CF90(&MissionRewardInfoController_TypeInfo, v1);
    sub_1B4CF90(&float___TypeInfo, v4);
    sub_1B4CF90(&StringLiteral_20196/*"img_title_mission_"*/, v5);
    byte_49BE1A4 = 1;
  }
  MissionRewardInfoController_TypeInfo->static_fields->TitleImgNamePrefix = (struct System_String_o *)StringLiteral_20196/*"img_title_mission_"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)MissionRewardInfoController_TypeInfo->static_fields, StringLiteral_20196/*"img_title_mission_"*/, v2, v3);
...
LABEL_10:
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&v13->XNormalPositions, (int32_t)v12, v9, v10);
  v7 = (struct System_Single_array *)sub_1B4D038(float___TypeInfo, 2LL);
  if ( !v7 )
LABEL_11:
    sub_1B4D1EC(v7, v8);
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&v17->YNormalPositions, (int32_t)v12, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A3 & 1) == 0 )
  {
    sub_1B4CF90(&MissionRewardInfoController_TypeInfo, *(_QWORD *)&index);
    byte_49BE1A3 = 1;
  }
  ...
  if ( !byte_49B5360 )
  {
    sub_1B4CF90(&System_Math_TypeInfo, *(_QWORD *)&index);
    byte_49B5360 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A2 & 1) == 0 )
  {
    sub_1B4CF90(&FSUtility_TypeInfo, panelObject);
    sub_1B4CF90(&MissionRewardInfoController_TypeInfo, v4);
    byte_49BE1A2 = 1;
  }
  ...
  if ( FSUtility__IsUnderVista(0LL) )
  {
    if ( !byte_49B525A )
    {
      sub_1B4CF90(&UnityEngine_Vector2_TypeInfo, v5);
      byte_49B525A = 1;
    }
  ...
  v10.fields.y = *p_y;
  GameObjectExtensions__SetLocalPosition_34069452(panelObject, v10, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A1 & 1) == 0 )
  {
    sub_1B4CF90(
      ...
      itemIdAndInfoDic);
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_int__MissionItemDisplayInfo__get_Count__, v7);
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_Enumerator_int__MissionItemDisplayInfo__Dispose__, v8);
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_Enumerator_int__MissionItemDisplayInfo__MoveNext__, v9);
    sub_1B4CF90(
      &Method_System_Collections_Generic_Dictionary_Enumerator_int__MissionItemDisplayInfo__get_Current__,
      v10);
    sub_1B4CF90(&Method_System_Collections_Generic_KeyValuePair_int__MissionItemDisplayInfo__get_Key__, v11);
    sub_1B4CF90(&Method_System_Collections_Generic_KeyValuePair_int__MissionItemDisplayInfo__get_Value__, v12);
    this = (MissionRewardInfoController_o *)sub_1B4CF90(&MissionRewardInfoController_TypeInfo, v13);
    byte_49BE1A1 = 1;
  }
  ...
  this = (MissionRewardInfoController_o *)System_Collections_Generic_Dictionary_int__object___get_Count(
                                            ...
                                            (const MethodInfo_31F6B30 *)Method_System_Collections_Generic_Dictionary_int__MissionItemDisplayInfo__get_Count__);
  ...
  if ( !v53 )
LABEL_50:
    sub_1B4D1EC(this, itemIdAndInfoDic);
  v54 = 0LL;
  while ( 1 )
  {
    ...
    {
      if ( v54 >= max_length )
        sub_1B4D1F4(this, itemIdAndInfoDic);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE1A0 & 1) == 0 )
  {
    sub_1B4CF90(&AtlasManager_TypeInfo, *(_QWORD *)&missionType);
    sub_1B4CF90(&MissionRewardInfoController_TypeInfo, v5);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v6);
    sub_1B4CF90(&StringLiteral_18132/*"daily"*/, v7);
    sub_1B4CF90(&StringLiteral_20815/*"limited"*/, v8);
    sub_1B4CF90(&StringLiteral_19018/*"extra"*/, v9);
    sub_1B4CF90(&StringLiteral_24393/*"weekly"*/, v10);
    byte_49BE1A0 = 1;
  }
  ...
  if ( (unsigned int)(missionType - 2) <= 3 )
    TitleImgNamePrefix = System_String__Concat_61093468(
                           v11->static_fields->TitleImgNamePrefix,
                           *(System_String_o **)*(&off_44117A0 + missionType - 2),
                           0LL);
...
void __fastcall MissionRewardInfoController__SetupWindow(MissionRewardInfoController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BE19F & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_20035/*"img_itembg_mission"*/, v4);
    byte_49BE19F = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(rewardItemWindow, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetDownloadCommonSprite(v6, (System_String_o *)StringLiteral_20035/*"img_itembg_mission"*/, 0LL);
