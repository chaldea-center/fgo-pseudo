void __fastcall MissionRewardInfoController___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1F753 & 1) == 0 )
  {
    sub_1BCAFF8(&MissionRewardInfoController_TypeInfo, v1);
    sub_1BCAFF8(&float___TypeInfo, v4);
    sub_1BCAFF8(&StringLiteral_20416/*"img_title_mission_"*/, v5);
    byte_4B1F753 = 1;
  }
  MissionRewardInfoController_TypeInfo->static_fields->TitleImgNamePrefix = (struct System_String_o *)StringLiteral_20416/*"img_title_mission_"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)MissionRewardInfoController_TypeInfo->static_fields, StringLiteral_20416/*"img_title_mission_"*/, v2, v3);
...
LABEL_10:
    sub_1BCB25C(v7, v12, v9);
  v7->m_Items[2] = 100.0;
  v13 = MissionRewardInfoController_TypeInfo->static_fields;
  v13->XNormalPositions = v12;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v13->XNormalPositions, (int32_t)v12, v9, v10);
  v7 = (struct System_Single_array *)sub_1BCB0A0(float___TypeInfo, 2LL);
  if ( !v7 )
LABEL_11:
    sub_1BCB254(v7, v8);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v16->YNormalPositions, (int32_t)v12, v9, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F752 & 1) == 0 )
  {
    sub_1BCAFF8(&MissionRewardInfoController_TypeInfo, *(_QWORD *)&index);
    byte_4B1F752 = 1;
  }
  ...
  if ( !byte_4B16190 )
  {
    sub_1BCAFF8(&System_Math_TypeInfo, *(_QWORD *)&index);
    byte_4B16190 = 1;
  }
...
LABEL_18:
    sub_1BCB25C(v7, *(_QWORD *)&index, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F751 & 1) == 0 )
  {
    sub_1BCAFF8(&FSUtility_TypeInfo, panelObject);
    sub_1BCAFF8(&MissionRewardInfoController_TypeInfo, v4);
    byte_4B1F751 = 1;
  }
  ...
  if ( FSUtility__IsUnderVista(0LL) )
  {
    if ( !byte_4B1608A )
    {
      sub_1BCAFF8(&UnityEngine_Vector2_TypeInfo, v5);
      byte_4B1608A = 1;
    }
  ...
  v10.fields.y = *p_y;
  GameObjectExtensions__SetLocalPosition_35356744(panelObject, v10, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F750 & 1) == 0 )
  {
    sub_1BCAFF8(
      ...
      itemIdAndInfoDic);
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_int__MissionItemDisplayInfo__get_Count__, v7);
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_Enumerator_int__MissionItemDisplayInfo__Dispose__, v8);
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_Enumerator_int__MissionItemDisplayInfo__MoveNext__, v9);
    sub_1BCAFF8(
      &Method_System_Collections_Generic_Dictionary_Enumerator_int__MissionItemDisplayInfo__get_Current__,
      v10);
    sub_1BCAFF8(&Method_System_Collections_Generic_KeyValuePair_int__MissionItemDisplayInfo__get_Key__, v11);
    sub_1BCAFF8(&Method_System_Collections_Generic_KeyValuePair_int__MissionItemDisplayInfo__get_Value__, v12);
    this = (MissionRewardInfoController_o *)sub_1BCAFF8(&MissionRewardInfoController_TypeInfo, v13);
    byte_4B1F750 = 1;
  }
  ...
  this = (MissionRewardInfoController_o *)System_Collections_Generic_Dictionary_int__object___get_Count(
                                            ...
                                            (const MethodInfo_3320F94 *)Method_System_Collections_Generic_Dictionary_int__MissionItemDisplayInfo__get_Count__);
  ...
  if ( !v58 )
LABEL_50:
    sub_1BCB254(this, itemIdAndInfoDic);
  v59 = 0LL;
  while ( 1 )
  {
    ...
    {
      if ( v59 >= max_length )
        sub_1BCB25C(this, itemIdAndInfoDic, v57);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F74F & 1) == 0 )
  {
    sub_1BCAFF8(&AtlasManager_TypeInfo, *(_QWORD *)&missionType);
    sub_1BCAFF8(&MissionRewardInfoController_TypeInfo, v5);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v6);
    sub_1BCAFF8(&StringLiteral_18290/*"daily"*/, v7);
    sub_1BCAFF8(&StringLiteral_21047/*"limited"*/, v8);
    sub_1BCAFF8(&StringLiteral_19171/*"extra"*/, v9);
    sub_1BCAFF8(&StringLiteral_24583/*"weekly"*/, v10);
    byte_4B1F74F = 1;
  }
  ...
  if ( (unsigned int)(missionType - 2) <= 3 )
    TitleImgNamePrefix = System_String__Concat_62450424(
                           v11->static_fields->TitleImgNamePrefix,
                           *(System_String_o **)*(&off_4558650 + missionType - 2),
                           0LL);
...
void __fastcall MissionRewardInfoController__SetupWindow(MissionRewardInfoController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1F74E & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_20237/*"img_itembg_mission"*/, v4);
    byte_4B1F74E = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(rewardItemWindow, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetDownloadCommonSprite(v6, (System_String_o *)StringLiteral_20237/*"img_itembg_mission"*/, 0LL);
