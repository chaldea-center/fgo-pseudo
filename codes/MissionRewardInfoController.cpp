void MissionRewardInfoController___cctor(const MethodInfo *method)
{
  ...
  struct MissionRewardInfoController_StaticFields *v15; // x0

  if ( (byte_4CB9508 & 1) == 0 )
  {
    sub_1C6BA08(&MissionRewardInfoController_TypeInfo);
    sub_1C6BA08(&float___TypeInfo);
    sub_1C6BA08(&StringLiteral_20667/*"img_title_mission_"*/);
    byte_4CB9508 = 1;
  }
  MissionRewardInfoController_TypeInfo->static_fields->TitleImgNamePrefix = (struct System_String_o *)StringLiteral_20667/*"img_title_mission_"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)MissionRewardInfoController_TypeInfo->static_fields, StringLiteral_20667/*"img_title_mission_"*/, v1, v2);
  ...
  v4 = (struct System_Single_array *)sub_1C6BAB0(float___TypeInfo, 2);
  if ( !v4 )
    goto LABEL_11;
...
LABEL_10:
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&v10->XNormalPositions, (int32_t)v9, v6, v7);
  v4 = (struct System_Single_array *)sub_1C6BAB0(float___TypeInfo, 2);
  if ( !v4 )
LABEL_11:
    sub_1C6BC60(v4, v5);
  ...
  if ( v13 == 1 )
    goto LABEL_10;
  v4->m_Items[1] = 30.0;
  v15 = MissionRewardInfoController_TypeInfo->static_fields;
  v15->YNormalPositions = v14;
  sub_1C6B9AC((CGThumbnailListItem_o *)&v15->YNormalPositions, (int32_t)v14, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  v8.fields.y = *p_y;
  GameObjectExtensions__SetLocalPosition_36356036(panelObject, v8, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9505 & 1) == 0 )
  {
    ...
    this = (MissionRewardInfoController_o *)sub_1C6BA08(&MissionRewardInfoController_TypeInfo);
    byte_4CB9505 = 1;
  }
  ...
  this = (MissionRewardInfoController_o *)System_Collections_Generic_Dictionary_int__object___get_Count(
                                            ...
                                            (const MethodInfo_34521A0 *)Method_System_Collections_Generic_Dictionary_int__MissionItemDisplayInfo__get_Count__);
  ...
  if ( !v43 )
LABEL_50:
    sub_1C6BC60(this, itemIdAndInfoDic);
  v44 = 0;
  while ( 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9504 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_18477/*"daily"*/);
    sub_1C6BA08(&StringLiteral_21321/*"limited"*/);
    sub_1C6BA08(&StringLiteral_19395/*"extra"*/);
    sub_1C6BA08(&StringLiteral_24912/*"weekly"*/);
    byte_4CB9504 = 1;
  }
  ...
  if ( (unsigned int)(missionType - 2) <= 3 )
    TitleImgNamePrefix = System_String__Concat_63966792(
                           v5->static_fields->TitleImgNamePrefix,
                           *(System_String_o **)*(&off_46D14D8 + missionType - 2),
                           0);
...
void MissionRewardInfoController__SetupWindow(MissionRewardInfoController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB9503 & 1) == 0 )
  {
    sub_1C6BA08(&AtlasManager_TypeInfo);
    sub_1C6BA08(&UnityEngine_Object_TypeInfo);
    sub_1C6BA08(&StringLiteral_20488/*"img_itembg_mission"*/);
    byte_4CB9503 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(rewardItemWindow, 0, 0) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetDownloadCommonSprite(v4, (System_String_o *)StringLiteral_20488/*"img_itembg_mission"*/, 0);
