...
void __fastcall QuestRewardHarvestAction__Awake(QuestRewardHarvestAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD9456 & 1) == 0 )
  {
    sub_1C21E38(&Method_CStateManager_QuestRewardHarvestAction___ctor__);
    sub_1C21E38(&Method_CStateManager_QuestRewardHarvestAction__add__);
    sub_1C21E38(&CStateManager_QuestRewardHarvestAction__TypeInfo);
    sub_1C21E38(&QuestRewardHarvestAction_StateItemLabel_TypeInfo);
    sub_1C21E38(&QuestRewardHarvestAction_StateNone_TypeInfo);
    sub_1C21E38(&QuestRewardHarvestAction_StatePlay_TypeInfo);
    sub_1C21E38(&QuestRewardHarvestAction_StateTouchWait_TypeInfo);
    byte_4BD9456 = 1;
  }
  p_fsm = &this->fields.fsm;
  if ( !this->fields.fsm )
  {
    v4 = (CStateManager_T__o *)sub_1C22084(CStateManager_QuestRewardHarvestAction__TypeInfo);
    CStateManager_object____ctor(
      v4,
      (Il2CppObject *)this,
      4,
      (const MethodInfo_31E6A20 *)Method_CStateManager_QuestRewardHarvestAction___ctor__);
    ...
    v12 = (Il2CppObject *)sub_1C22084(QuestRewardHarvestAction_StateNone_TypeInfo);
    ...
    CStateManager_object___add(
      ...
      0,
      (IState_T__o *)v12,
      (const MethodInfo_31E6AC8 *)Method_CStateManager_QuestRewardHarvestAction__add__);
    v15 = (CStateManager_T__o *)*p_fsm;
    v16 = (Il2CppObject *)sub_1C22084(QuestRewardHarvestAction_StatePlay_TypeInfo);
    ...
    v18 = (Il2CppObject *)sub_1C22084(QuestRewardHarvestAction_StateItemLabel_TypeInfo);
    ...
    if ( !v17
      || (CStateManager_object___add(
          ...
          v20 = (Il2CppObject *)sub_1C22084(QuestRewardHarvestAction_StateTouchWait_TypeInfo),
...
int32_t __fastcall QuestRewardHarvestAction__GetState(QuestRewardHarvestAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD945A & 1) == 0 )
  {
    this = (QuestRewardHarvestAction_o *)sub_1C21E38(&Method_CStateManager_QuestRewardHarvestAction__getState__);
    byte_4BD945A = 1;
  }
  fsm = v2->fields.fsm;
  if ( !fsm )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD9459 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_QuestRewardHarvestAction__Play_b__12_0__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD945B & 1) == 0 )
  {
    sub_1C21E38(&Method_CStateManager_QuestRewardHarvestAction__setState__);
    byte_4BD945B = 1;
  }
  fsm = (CStateManager_T__o *)this->fields.fsm;
  if ( !fsm )
  ...
  CStateManager_object___setState(
    fsm,
    state,
    (const MethodInfo_31E6B54 *)Method_CStateManager_QuestRewardHarvestAction__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v99; // [xsp+18h] [xbp-78h] BYREF
  Il2CppObject *v100; // [xsp+20h] [xbp-70h] BYREF
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.simpleAnimation, (int64_t)v15, v17, v18, v19, v20, v21, v22);
  ...
  if ( (transform & 1) != 0 )
  {
    ...
    {
LABEL_15:
      v30 = sub_1C73E18(transform, SimpleAnimation_State_TypeInfo, 8LL);
    }
    ...
    {
LABEL_34:
      v42 = sub_1C73E18(transform, SimpleAnimation_State_TypeInfo, 6LL);
    }
  ...
  if ( !transform )
    goto LABEL_153;
  transform = (__int64)UnityEngine_Component__GetComponentInChildren_object__49965836(
                         (UnityEngine_Component_o *)transform,
  ...
  *(_BYTE *)(transform + 109) = 1;
  ...
  {
    v44 = 0LL;
    v45 = (unsigned int)*(_QWORD *)&itemSprite->max_length - 1LL;
    while ( v44 < itemSprite->max_length )
    {
...
LABEL_56:
  ...
  {
    v50 = 0LL;
    v51 = (unsigned int)*(_QWORD *)&itemLabel->max_length - 1LL;
    while ( v50 < itemLabel->max_length )
    {
      v52 = (UnityEngine_Object_o *)itemLabel->m_Items[v50];
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      transform = UnityEngine_Object__op_Inequality(v52, 0LL, 0LL);
      if ( (transform & 1) != 0 )
      {
        ...
        if ( !transform )
          goto LABEL_153;
        v54 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)transform, 0LL);
        transform = (__int64)GameObjectExtensions__GetParent(v54, 0LL);
        if ( !transform )
          goto LABEL_153;
        transform = (__int64)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)transform, 0LL);
        if ( !transform )
...
LABEL_153:
  ...
  {
    v55 = 0LL;
    v56 = (unsigned int)*(_QWORD *)&infos->max_length - 1LL;
    arg1 = (Il2CppObject *)StringLiteral_25612/*"×"*/;
    while ( 1 )
    {
      ...
      if ( (__int64)v55 < (int)max_length )
      {
        ...
        if ( !v59 )
          goto LABEL_153;
        if ( (__int64)v55 < (int)v59->max_length )
        {
          if ( v55 >= max_length )
            goto LABEL_143;
          ...
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          transform = UnityEngine_Object__op_Equality(v61, 0LL, 0LL);
          if ( (transform & 1) == 0 )
          {
            ...
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
            transform = UnityEngine_Object__op_Equality(v63, 0LL, 0LL);
            if ( (transform & 1) == 0 )
            {
              ...
              if ( !transform )
                goto LABEL_153;
              v65 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)transform, 0LL);
    ...
    switch ( type )
    {
      case 1:
        ...
        if ( !DataMasterBase_object__object__int___TryGetEntity(
          ...
          goto LABEL_120;
        transform = (__int64)v99;
        if ( !v99 )
          goto LABEL_153;
        klass = ServantEntity__GetName((ServantEntity_o *)v99, -1, 0, -1, 0, 0LL);
      ...
      case 5:
        ...
        if ( !v100 )
          goto LABEL_153;
        klass = (CodeStage_AntiCheat_ObscuredTypes_ObscuredString_o *)v100[2].klass;
        v73 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo;
        if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
        {
LABEL_118:
          v74 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47657208(klass, 0LL);
          v71 = StringLiteral_25612/*"×"*/;
          monitor = v74;
          goto LABEL_119;
        }
        break;
      case 2:
        ...
        v70 = (__int64 *)&StringLiteral_25909/*"＋"*/;
        if ( !IsCountableWithPlus )
          v70 = &StringLiteral_25612/*"×"*/;
        v71 = *v70;
LABEL_119:
...
LABEL_120:
        ...
        if ( (transform & 1) == 0 )
        {
          ...
          v77 = LocalizationManager__Get((System_String_o *)StringLiteral_11060/*"QUEST_CLEAR_REWARD_GET"*/, 0LL);
          num = v60->fields.num;
          v81 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &num, v78, v79, v80);
          transform = (__int64)System_String__Format_63129916(v77, (Il2CppObject *)monitor, arg1, v81, 0LL);
          if ( !v76 )
            goto LABEL_153;
          UILabel__set_text(v76, (System_String_o *)transform, 0LL);
          v82 = this->fields.itemLabel;
          if ( !v82 )
            goto LABEL_153;
          if ( v55 >= v82->max_length )
            goto LABEL_143;
          transform = (__int64)v82->m_Items[v55];
          if ( !transform )
            goto LABEL_153;
          transform = (__int64)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)transform, 0LL);
          if ( !transform )
        ...
        if ( imageFrame )
        {
          v84 = imageFrame->max_length;
          if ( (__int64)v55 < (int)v84 )
          {
            if ( v55 >= v84 )
              goto LABEL_143;
            v85 = (UnityEngine_Object_o *)imageFrame->m_Items[v55];
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
            transform = UnityEngine_Object__op_Inequality(v85, 0LL, 0LL);
            if ( (transform & 1) != 0 )
            {
              v86 = this->fields.imageFrame;
              if ( !v86 )
                goto LABEL_153;
              if ( v55 >= v86->max_length )
                goto LABEL_143;
              transform = (__int64)v86->m_Items[v55];
              if ( !transform )
                goto LABEL_153;
              UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)transform, v60->fields.type == 1, 0LL);
            }
          }
        }
        goto LABEL_141;
  ...
  if ( UnityEngine_Object__op_Equality(screenTouchInfo, 0LL, 0LL) )
  {
    ...
    if ( Instance )
    {
      ...
      if ( transform )
      {
        ...
        *p_screenTouchInfo = (struct ScreenTouchInformationComponent_o *)v90;
        sub_1C21DDC(
...
void __fastcall QuestRewardHarvestAction__Update(QuestRewardHarvestAction_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD9457 & 1) == 0 )
  {
    sub_1C21E38(&Method_CStateManager_QuestRewardHarvestAction__update__);
  ...
  if ( fsm )
    CStateManager_object___update(
      fsm,
      (const MethodInfo_31E6B30 *)Method_CStateManager_QuestRewardHarvestAction__update__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD945E & 1) == 0 )
  {
    ...
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&Method_QuestRewardHarvestAction_StateItemLabel_begin__);
    sub_1C21E38(&Method_QuestRewardHarvestAction_StateItemLabel___c__DisplayClass1_0__begin_b__1__);
    sub_1C21E38(&QuestRewardHarvestAction_StateItemLabel___c__DisplayClass1_0_TypeInfo);
    sub_1C21E38(&Method_QuestRewardHarvestAction_StateItemLabel___c__DisplayClass1_1__begin_b__0__);
    sub_1C21E38(&QuestRewardHarvestAction_StateItemLabel___c__DisplayClass1_1_TypeInfo);
    byte_4BD945E = 1;
  }
  v4 = sub_1C22084(QuestRewardHarvestAction_StateItemLabel___c__DisplayClass1_0_TypeInfo);
  ...
  *(_QWORD *)(v4 + 16) = that;
  ...
  if ( (int)v15 >= 1 )
  {
    ...
    while ( 1 )
    {
      v19 = sub_1C22084(QuestRewardHarvestAction_StateItemLabel___c__DisplayClass1_1_TypeInfo);
...
LABEL_31:
        ...
        *(_QWORD *)(v19 + 16) = gameObject;
        sub_1C21DDC((PartyOrganizationUtility_o *)(v19 + 16), (int64_t)gameObject, v23, v24, v25, v26, v27, v28);
        ...
        *(_QWORD *)(v19 + 24) = Component_object;
        sub_1C21DDC((PartyOrganizationUtility_o *)(v19 + 24), (int64_t)Component_object, v30, v31, v32, v33, v34, v35);
        ...
        if ( !*v18 )
        {
          ...
          System_Action___ctor(
            ...
            0LL);
          *(_QWORD *)(v4 + 24) = v45;
          sub_1C21DDC((PartyOrganizationUtility_o *)(v4 + 24), (int64_t)v45, v46, v47, v48, v49, v50, v51);
        }
        if ( !v40 )
          break;
...
LABEL_27:
  ...
  if ( (*((_BYTE *)Method_QuestRewardHarvestAction_StateItemLabel_begin__ + 83) & 2) != 0 )
    v52 = (_QWORD *)sub_1C21E50(Method_QuestRewardHarvestAction_StateItemLabel_begin__);
  v53 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v52, v52[4]);
  OverwriteAssetSoundName__PlaySystemSe(v53, 4, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    this = (QuestRewardHarvestAction_StatePlay_o *)sub_1C21E38(&SimpleAnimation_State_TypeInfo);
    byte_4BD945C = 1;
  }
  if ( !that )
    goto LABEL_49;
    ...
    if ( v17 )
    {
      ...
      if ( this )
      {
        ...
        if ( ((unsigned __int8)this & 1) == 0 )
        {
          ...
          this = (QuestRewardHarvestAction_StatePlay_o *)UnityEngine_Animation__Play_70614020(v19, v20, 0LL);
        }
...
LABEL_49:
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    this = (QuestRewardHarvestAction_StatePlay_o *)SimpleAnimation__Play_65253852(v7, v8, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    this = (QuestRewardHarvestAction_StatePlay_o *)sub_1C21E38(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4BD945D = 1;
  }
  if ( !that )
    goto LABEL_21;
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    if ( SimpleAnimation__IsPlaying(v5, name, 0LL) )
      return;
LABEL_17:
    this = (QuestRewardHarvestAction_StatePlay_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( this )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD945F & 1) == 0 )
  {
    ...
    sub_1C21E38(&CTouch_TypeInfo);
    sub_1C21E38(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C21E38(&Method_QuestRewardHarvestAction_StateTouchWait_update__);
    sub_1C21E38(&Method_QuestRewardHarvestAction_StateTouchWait___c__DisplayClass1_0__update_b__0__);
    sub_1C21E38(&QuestRewardHarvestAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
    byte_4BD945F = 1;
  }
  v4 = sub_1C22084(QuestRewardHarvestAction_StateTouchWait___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v4, 0LL);
  if ( !v4 )
    goto LABEL_18;
  *(_QWORD *)(v4 + 16) = that;
      ...
      if ( isTouchPush )
      {
        ...
        if ( isTouchPush )
        {
          ...
          if ( (*((_BYTE *)Method_QuestRewardHarvestAction_StateTouchWait_update__ + 83) & 2) != 0 )
            v14 = (_QWORD *)sub_1C21E50(Method_QuestRewardHarvestAction_StateTouchWait_update__);
