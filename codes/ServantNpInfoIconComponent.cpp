        ...
        const MethodInfo *method)
{
  ...
  commandCard = (BattleCommandComponent_o *)sub_1D0F058(&v6->fields.target, commandCard);
  if ( !npData )
    goto LABEL_14;
  npCardId = npData->fields.npCardId;
  svtId = npData->fields.svtId;
  limitCount = npData->fields.limitCount;
  v10 = (BattleCommandData_o *)sub_1D0F300(BattleCommandData_TypeInfo);
  BattleCommandData___ctor_48086632(v10, npCardId, svtId, limitCount, 0, -1, 0);
  if ( !v10 )
    goto LABEL_14;
  v10->fields.treasureDvc = npData->fields.svtDispNpId;
  commandCard = (BattleCommandComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !commandCard )
    goto LABEL_14;
  ...
  if ( !commandCard
    ...
    || (BattleCommandComponent__setShader(commandCard, (System_String_o *)StringLiteral_15334/*"Unlit/Transparent Colored"*/, 0),
        (commandCard = this->fields.commandCard) == 0)
    || (BattleCommandComponent__updateView(commandCard, 1, 0, 1, 0, npData->fields.isCardHide, 0),
        (commandCard = this->fields.commandCard) == 0) )
  {
LABEL_14:
    sub_1D0F30C(commandCard, npData);
  }
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalScale_37345220(detailRootTransformServant, 1.0, 0);
  ...
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_50144116(
    npData->fields.svtId,
    npData->fields.dispLimitCount,
  ...
  if ( !v26 )
LABEL_32:
    sub_1D0F30C(backSprite, baseData);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E714DD & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    this = (ServantNpInfoIconComponent_o *)sub_1D0F0B4(&StringLiteral_4624/*"CommandCard"*/);
    byte_4E714DD = 1;
  }
  if ( !npData )
    goto LABEL_19;
  if ( npData->fields.svtUseNpId >= 1 )
  {
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_4624/*"CommandCard"*/, 0);
        ...
        if ( this )
        {
          ...
          if ( transform )
          {
            ...
            sub_1D0F058(&v7->fields.commandCard, Component_object);
LABEL_17:
...
LABEL_19:
    sub_1D0F30C(this, baseUsrSvtData);
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B34094;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B3404C;
}
