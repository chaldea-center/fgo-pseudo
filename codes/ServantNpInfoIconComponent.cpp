        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFE89 & 1) == 0 )
  {
    sub_1B640C8(&BattleCommandData_TypeInfo, npData);
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v9->fields.target, (int32_t)commandCard, v10, v11);
  if ( !npData )
    goto LABEL_14;
  npCardId = npData->fields.npCardId;
  svtId = npData->fields.svtId;
  limitCount = npData->fields.limitCount;
  v17 = (BattleCommandData_o *)sub_1B64314(BattleCommandData_TypeInfo, v12, v13);
  BattleCommandData___ctor_42850076(v17, npCardId, svtId, limitCount, 0, -1, 0LL);
  if ( !v17 )
    goto LABEL_14;
  v17->fields.treasureDvc = npData->fields.svtDispNpId;
  commandCard = (BattleCommandComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !commandCard )
    goto LABEL_14;
  ...
  if ( !commandCard )
    goto LABEL_14;
  v17->fields._loadsvtLimit = ServantLimitImageMaster__GetServantLimitCountSealAfter(
  ...
  commandCard = this->fields.commandCard;
  if ( !commandCard
    || (BattleCommandComponent__setData(commandCard, v17, 0LL, 0, 1, 0, 1, 0LL),
        (commandCard = this->fields.commandCard) == 0LL)
    || (BattleCommandComponent__setShader(commandCard, (System_String_o *)StringLiteral_15058/*"Unlit/Transparent Colored"*/, 0LL),
        (commandCard = this->fields.commandCard) == 0LL)
    || (BattleCommandComponent__updateView(commandCard, 1, 0, 1, 0, npData->fields.isCardHide, 0LL),
        (commandCard = this->fields.commandCard) == 0LL) )
  {
LABEL_14:
    sub_1B64324(commandCard);
  }
        ...
        const MethodInfo *method)
{
  ...
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_44541432(
    npData->fields.svtId,
    npData->fields.dispLimitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFE88 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, baseUsrSvtData);
    sub_1B640C8(&Method_UnityEngine_Object_Instantiate_GameObject___, v8);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v9);
    this = (ServantNpInfoIconComponent_o *)sub_1B640C8(&StringLiteral_4589/*"CommandCard"*/, v10);
    byte_49FFE88 = 1;
  }
  if ( !npData )
    goto LABEL_19;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B0950;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B0908;
}
