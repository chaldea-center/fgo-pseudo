        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB842E & 1) == 0 )
  {
    sub_1C13D24(&BattleCommandData_TypeInfo, npData);
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v9->fields.target, (int64_t)commandCard, v10, v11, v12, v13, v14, v15);
  if ( !npData )
    goto LABEL_14;
  npCardId = npData->fields.npCardId;
  svtId = npData->fields.svtId;
  limitCount = npData->fields.limitCount;
  v19 = (BattleCommandData_o *)sub_1C13F70(BattleCommandData_TypeInfo);
  BattleCommandData___ctor_44526792(v19, npCardId, svtId, limitCount, 0, -1, 0LL);
  if ( !v19 )
    goto LABEL_14;
  v19->fields.treasureDvc = npData->fields.svtDispNpId;
  commandCard = (BattleCommandComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !commandCard )
    goto LABEL_14;
  ...
  if ( !commandCard
    ...
    || (BattleCommandComponent__setShader(commandCard, (System_String_o *)StringLiteral_15369/*"Unknown property '{0}'."*/, 0LL),
        (commandCard = this->fields.commandCard) == 0LL)
    || (BattleCommandComponent__updateView(commandCard, 1, 0, 1, 0, npData->fields.isCardHide, 0LL),
        (commandCard = this->fields.commandCard) == 0LL) )
  {
LABEL_14:
    sub_1C13F80(commandCard, npData);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C13F80(backSprite, baseData);
  }
  ...
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_46193432(
    npData->fields.svtId,
    npData->fields.dispLimitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB842D & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, baseUsrSvtData);
    sub_1C13D24(&Method_UnityEngine_Object_Instantiate_GameObject___, v8);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v9);
    this = (ServantNpInfoIconComponent_o *)sub_1C13D24(&StringLiteral_4693/*"Combining FileMode: {0} with FileAccess: {1} is invalid."*/, v10);
    byte_4BB842D = 1;
  }
  if ( !npData )
    goto LABEL_19;
  if ( npData->fields.svtUseNpId >= 1 )
  {
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        UnityEngine_Object__set_name((UnityEngine_Object_o *)v14, (System_String_o *)StringLiteral_4693/*"Combining FileMode: {0} with FileAccess: {1} is invalid."*/, 0LL);
...
LABEL_19:
    sub_1C13F80(this, baseUsrSvtData);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A59F5C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A59F14;
}
