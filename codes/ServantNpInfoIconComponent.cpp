        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BECF6 & 1) == 0 )
  {
    sub_1B4CF90(&BattleCommandData_TypeInfo, npData);
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&v9->fields.target, (int32_t)commandCard, v10, v11);
  if ( !npData )
    goto LABEL_14;
  npCardId = npData->fields.npCardId;
  svtId = npData->fields.svtId;
  limitCount = npData->fields.limitCount;
  v15 = (BattleCommandData_o *)sub_1B4D1DC(BattleCommandData_TypeInfo);
  BattleCommandData___ctor_44020724(v15, npCardId, svtId, limitCount, 0, -1, 0LL);
  if ( !v15 )
    goto LABEL_14;
  v15->fields.treasureDvc = npData->fields.svtDispNpId;
  commandCard = (BattleCommandComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !commandCard )
    goto LABEL_14;
  ...
  if ( !commandCard
    ...
    || (BattleCommandComponent__setShader(commandCard, (System_String_o *)StringLiteral_14832/*"Unlit/Transparent Colored"*/, 0LL),
        (commandCard = this->fields.commandCard) == 0LL)
    || (BattleCommandComponent__updateView(commandCard, 1, 0, 1, 0, npData->fields.isCardHide, 0LL),
        (commandCard = this->fields.commandCard) == 0LL) )
  {
LABEL_14:
    sub_1B4D1EC(commandCard, npData);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4D1EC(backSprite, baseData);
  }
  ...
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_45722896(
    npData->fields.svtId,
    npData->fields.dispLimitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BECF5 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, baseUsrSvtData);
    sub_1B4CF90(&Method_UnityEngine_Object_Instantiate_GameObject___, v8);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v9);
    this = (ServantNpInfoIconComponent_o *)sub_1B4CF90(&StringLiteral_4524/*"CommandCard"*/, v10);
    byte_49BECF5 = 1;
  }
  if ( !npData )
    goto LABEL_19;
  if ( npData->fields.svtUseNpId >= 1 )
  {
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        UnityEngine_Object__set_name((UnityEngine_Object_o *)v14, (System_String_o *)StringLiteral_4524/*"CommandCard"*/, 0LL);
        ...
        if ( this )
        {
          ...
          if ( transform )
          {
            ...
            sub_1B4CF34((CGThumbnailListItem_o *)&v7->fields.commandCard, (int32_t)Component_object, v21, v22);
LABEL_17:
...
LABEL_19:
    sub_1B4D1EC(this, baseUsrSvtData);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A1054;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A100C;
}
