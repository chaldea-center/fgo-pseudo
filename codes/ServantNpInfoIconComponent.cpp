        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A235A0 & 1) == 0 )
  {
    sub_1B715CC(&BattleCommandData_TypeInfo, npData);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v9->fields.target, (int32_t)commandCard, v10, v11);
  if ( !npData )
    goto LABEL_14;
  npCardId = npData->fields.npCardId;
  svtId = npData->fields.svtId;
  limitCount = npData->fields.limitCount;
  v15 = (BattleCommandData_o *)sub_1B71818(BattleCommandData_TypeInfo);
  BattleCommandData___ctor_42990820(v15, npCardId, svtId, limitCount, 0, -1, 0LL);
  if ( !v15 )
    goto LABEL_14;
  v15->fields.treasureDvc = npData->fields.svtDispNpId;
  commandCard = (BattleCommandComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !commandCard )
    goto LABEL_14;
  ...
  if ( !commandCard
    ...
    || (BattleCommandComponent__setShader(commandCard, (System_String_o *)StringLiteral_15080/*"Unlit/Transparent Colored"*/, 0LL),
        (commandCard = this->fields.commandCard) == 0LL)
    || (BattleCommandComponent__updateView(commandCard, 1, 0, 1, 0, npData->fields.isCardHide, 0LL),
        (commandCard = this->fields.commandCard) == 0LL) )
  {
LABEL_14:
    sub_1B71828(commandCard, npData);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B71828(backSprite, baseData);
  }
  ...
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_44689672(
    npData->fields.svtId,
    npData->fields.dispLimitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2359F & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_BattleCommandComponent___, baseUsrSvtData);
    sub_1B715CC(&Method_UnityEngine_Object_Instantiate_GameObject___, v8);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v9);
    this = (ServantNpInfoIconComponent_o *)sub_1B715CC(&StringLiteral_4593/*"CommandCard"*/, v10);
    byte_4A2359F = 1;
  }
  if ( !npData )
    goto LABEL_19;
  if ( npData->fields.svtUseNpId >= 1 )
  {
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        UnityEngine_Object__set_name((UnityEngine_Object_o *)v14, (System_String_o *)StringLiteral_4593/*"CommandCard"*/, 0LL);
...
LABEL_19:
    sub_1B71828(this, baseUsrSvtData);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19BDAA0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19BDA58;
}
