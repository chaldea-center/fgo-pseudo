        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v6->fields.target, (int32_t)commandCard, v7, v8);
  if ( !npData )
    goto LABEL_14;
  ...
  BattleCommandData___ctor_43210772(v12, npCardId, svtId, limitCount, 0, -1, 0LL);
  if ( !v12 )
    goto LABEL_14;
  v12->fields.treasureDvc = npData->fields.svtDispNpId;
  commandCard = (BattleCommandComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !commandCard )
    goto LABEL_14;
  ...
  commandCard = this->fields.commandCard;
  if ( !commandCard
    || (BattleCommandComponent__setData(commandCard, v12, 0LL, 0, 1, 0, 1, 0LL),
        (commandCard = this->fields.commandCard) == 0LL)
    || (BattleCommandComponent__setShader(commandCard, (System_String_o *)StringLiteral_15129/*"Unlit/Transparent Colored"*/, 0LL),
        (commandCard = this->fields.commandCard) == 0LL)
    || (BattleCommandComponent__updateView(commandCard, 1, 0, 1, 0, npData->fields.isCardHide, 0LL),
        (commandCard = this->fields.commandCard) == 0LL) )
  {
LABEL_14:
    sub_1B8880C(commandCard, npData);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(backSprite, baseData);
  }
  ...
  NoblePhantasmNameOverwriter__SetOverwriteNpLabel_44916892(
    npData->fields.svtId,
    npData->fields.dispLimitCount,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5ED2B & 1) == 0 )
  {
    ...
    this = (ServantNpInfoIconComponent_o *)sub_1B885B0(&StringLiteral_4612/*"CommandCard"*/);
    byte_4A5ED2B = 1;
  }
  if ( !npData )
    goto LABEL_19;
  if ( npData->fields.svtUseNpId >= 1 )
  {
    ...
    if ( this )
    {
      ...
      if ( this )
      {
        ...
        UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_4612/*"CommandCard"*/, 0LL);
...
LABEL_19:
    sub_1B8880C(this, baseUsrSvtData);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D34AC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D3464;
}
