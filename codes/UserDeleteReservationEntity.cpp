void __fastcall UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6780B & 1) == 0 )
  {
    sub_1BE4ACC(&UserDeleteReservationEntity_TypeInfo, v1);
    sub_1BE4ACC(&StringLiteral_15426/*"UserDeleteFlag"*/, v8);
    byte_4B6780B = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15426/*"UserDeleteFlag"*/;
  sub_1BE4A70(
    (PartyOrganizationUtility_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15426/*"UserDeleteFlag"*/,
    v2,
    v3,
    v4,
    v5,
...
System_String_o *__fastcall UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4B67807 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_long___, method);
    byte_4B67807 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_2F57204 *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67806 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserDeleteReservationEntity_TypeInfo, v3);
    byte_4B67806 = 1;
  }
  ...
  *(_OWORD *)&v9.fields.fakeValue = v4;
  ...
  v8 = v9;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47302584(&v8, 0LL);
...
void __fastcall UserDeleteReservationEntity__SetUserDeleteFlag(bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4B67808 & 1) == 0 )
  {
    sub_1BE4ACC(&UserDeleteReservationEntity_TypeInfo, method);
    byte_4B67808 = 1;
  }
