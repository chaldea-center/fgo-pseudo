void __fastcall UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D261 & 1) == 0 )
  {
    sub_1BCAFF8(&UserDeleteReservationEntity_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_15104/*"UserDeleteFlag"*/, v4);
    byte_4B1D261 = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15104/*"UserDeleteFlag"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)UserDeleteReservationEntity_TypeInfo->static_fields, StringLiteral_15104/*"UserDeleteFlag"*/, v2, v3);
}
...
System_String_o *__fastcall UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4B1D25D & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataEntityBase_CreateMultiplePK_long___, method);
    byte_4B1D25D = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_3018AFC *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D25C & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UserDeleteReservationEntity_TypeInfo, v3);
    byte_4B1D25C = 1;
  }
  ...
  *(_OWORD *)&v9.fields.fakeValue = v4;
  ...
  v8 = v9;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48128700(&v8, 0LL);
...
void __fastcall UserDeleteReservationEntity__SetUserDeleteFlag(bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4B1D25E & 1) == 0 )
  {
    sub_1BCAFF8(&UserDeleteReservationEntity_TypeInfo, method);
    byte_4B1D25E = 1;
  }
