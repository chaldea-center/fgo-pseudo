void UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E057CD & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_15375/*"UserDeleteFlag"*/);
    byte_4E057CD = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15375/*"UserDeleteFlag"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15375/*"UserDeleteFlag"*/,
    v1,
    v2,
    v3,
    v4,
...
System_String_o *UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4E057C9 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataEntityBase_CreateMultiplePK_long___);
    byte_4E057C9 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_3202400 *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v8.fields.fakeValue = v3;
  ...
  v7 = v8;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_50041532(&v7, 0);
