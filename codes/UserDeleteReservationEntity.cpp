void UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C43D52 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_15226/*"UserDeleteFlag"*/);
    byte_4C43D52 = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15226/*"UserDeleteFlag"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)UserDeleteReservationEntity_TypeInfo->static_fields, StringLiteral_15226/*"UserDeleteFlag"*/, v1, v2);
}
...
System_String_o *UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4C43D4E & 1) == 0 )
  {
    sub_1C37058(&Method_DataEntityBase_CreateMultiplePK_long___);
    byte_4C43D4E = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_30E5CB0 *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v8.fields.fakeValue = v3;
  ...
  v7 = v8;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48934420(&v7, 0);
