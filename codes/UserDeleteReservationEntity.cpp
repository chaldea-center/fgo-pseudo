void __fastcall UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB5337 & 1) == 0 )
  {
    sub_1C13D24(&UserDeleteReservationEntity_TypeInfo, v1);
    sub_1C13D24(&StringLiteral_15462/*"Use of unassigned Unicode characer is prohibited in this IdnMapping, at {0}"*/, v8);
    byte_4BB5337 = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15462/*"Use of unassigned Unicode characer is prohibited in this IdnMapping, at {0}"*/;
  sub_1C13CC8(
    (PartyOrganizationUtility_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15462/*"Use of unassigned Unicode characer is prohibited in this IdnMapping, at {0}"*/,
    v2,
    v3,
    v4,
    v5,
...
System_String_o *__fastcall UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4BB5333 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_long___, method);
    byte_4BB5333 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_2F8D560 *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5332 & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserDeleteReservationEntity_TypeInfo, v3);
    byte_4BB5332 = 1;
  }
  ...
  *(_OWORD *)&v9.fields.fakeValue = v4;
  ...
  v8 = v9;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47494132(&v8, 0LL);
...
void __fastcall UserDeleteReservationEntity__SetUserDeleteFlag(bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4BB5334 & 1) == 0 )
  {
    sub_1C13D24(&UserDeleteReservationEntity_TypeInfo, method);
    byte_4BB5334 = 1;
  }
