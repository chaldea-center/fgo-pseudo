void __fastcall UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5BD5F & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_15219/*"UserDeleteFlag"*/);
    byte_4A5BD5F = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15219/*"UserDeleteFlag"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15219/*"UserDeleteFlag"*/,
    v1,
    v2);
}
...
System_String_o *__fastcall UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4A5BD5B & 1) == 0 )
  {
    sub_1B885B0(&Method_DataEntityBase_CreateMultiplePK_long___);
    byte_4A5BD5B = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_2E7D9FC *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v8.fields.fakeValue = v3;
  ...
  v7 = v8;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46453324(&v7, 0LL);
