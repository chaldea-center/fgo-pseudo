void __fastcall UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4188AFA & 1) == 0 )
  {
    sub_B2C35C(&UserDeleteReservationEntity_TypeInfo, v1);
    sub_B2C35C(&StringLiteral_15096/*"UserDeleteFlag"*/, v8);
    byte_4188AFA = 1;
  }
  static_fields = (BattleServantConfConponent_o *)UserDeleteReservationEntity_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_15096/*"UserDeleteFlag"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_15096/*"UserDeleteFlag"*/;
...
System_String_o *__fastcall UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4188AF6 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataEntityBase_CreateMultiplePK_long___, method);
    byte_4188AF6 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_17328C4 *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188AF5 & 1) == 0 )
  {
    ...
    sub_B2C35C(&UserDeleteReservationEntity_TypeInfo, v3);
    byte_4188AF5 = 1;
  }
  ...
  *(_OWORD *)&v9.fields.fakeValue = v4;
  ...
  v8 = v9;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_44761220(&v8, 0LL);
...
void __fastcall UserDeleteReservationEntity__SetUserDeleteFlag(bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4188AF7 & 1) == 0 )
  {
    sub_B2C35C(&UserDeleteReservationEntity_TypeInfo, method);
    byte_4188AF7 = 1;
  }
  v3 = flag;
