void __fastcall UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC8714 & 1) == 0 )
  {
    sub_1C1ABD4(&UserDeleteReservationEntity_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_15474/*"UserDeleteFlag"*/, v8);
    byte_4BC8714 = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15474/*"UserDeleteFlag"*/;
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15474/*"UserDeleteFlag"*/,
    v2,
    v3,
    v4,
    v5,
...
System_String_o *__fastcall UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4BC8710 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_long___, method);
    byte_4BC8710 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_2F9D584 *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC870F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&UserDeleteReservationEntity_TypeInfo, v3);
    byte_4BC870F = 1;
  }
  ...
  *(_OWORD *)&v9.fields.fakeValue = v4;
  ...
  v8 = v9;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47559652(&v8, 0LL);
...
void __fastcall UserDeleteReservationEntity__SetUserDeleteFlag(bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4BC8711 & 1) == 0 )
  {
    sub_1C1ABD4(&UserDeleteReservationEntity_TypeInfo, method);
    byte_4BC8711 = 1;
  }
