void __fastcall UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6961 & 1) == 0 )
  {
    sub_1BAB41C(&UserDeleteReservationEntity_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_15250/*"UserDeleteFlag"*/, v4);
    byte_4AB6961 = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15250/*"UserDeleteFlag"*/;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15250/*"UserDeleteFlag"*/,
    v2,
    v3);
}
...
System_String_o *__fastcall UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4AB695D & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_long___, method);
    byte_4AB695D = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_2EC2468 *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB695C & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UserDeleteReservationEntity_TypeInfo, v3);
    byte_4AB695C = 1;
  }
  ...
  *(_OWORD *)&v9.fields.fakeValue = v4;
  ...
  v8 = v9;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46699376(&v8, 0LL);
...
void __fastcall UserDeleteReservationEntity__SetUserDeleteFlag(bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4AB695E & 1) == 0 )
  {
    sub_1BAB41C(&UserDeleteReservationEntity_TypeInfo, method);
    byte_4AB695E = 1;
  }
