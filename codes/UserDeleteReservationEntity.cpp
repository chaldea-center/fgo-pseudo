void UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2D634 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_15282/*"UserDeleteFlag"*/);
    byte_4D2D634 = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15282/*"UserDeleteFlag"*/;
  sub_1C9403C(
    (GrandQuestFolderBoardItem_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15282/*"UserDeleteFlag"*/,
    v1,
    v2,
    v3,
    v4,
...
System_String_o *UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4D2D630 & 1) == 0 )
  {
    sub_1C94098(&Method_DataEntityBase_CreateMultiplePK_long___);
    byte_4D2D630 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_319A18C *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v8.fields.fakeValue = v3;
  ...
  v7 = v8;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49625068(&v7, 0);
