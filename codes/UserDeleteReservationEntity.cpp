void UserDeleteReservationEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CEF3F1 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_15284/*"UserDeleteFlag"*/);
    byte_4CEF3F1 = 1;
  }
  UserDeleteReservationEntity_TypeInfo->static_fields->UserDeleteFlag = (struct System_String_o *)StringLiteral_15284/*"UserDeleteFlag"*/;
  sub_1C7BA8C(
    (GrandQuestFolderBoardItem_o *)UserDeleteReservationEntity_TypeInfo->static_fields,
    StringLiteral_15284/*"UserDeleteFlag"*/,
    v1,
    v2,
    v3,
    v4,
...
System_String_o *UserDeleteReservationEntity__CreatePK(int64_t userId, const MethodInfo *method)
{
  if ( (byte_4CEF3ED & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataEntityBase_CreateMultiplePK_long___);
    byte_4CEF3ED = 1;
  }
  return DataEntityBase__CreateMultiplePK_long_(
           userId,
           (const MethodInfo_316E44C *)Method_DataEntityBase_CreateMultiplePK_long___);
}
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v8.fields.fakeValue = v3;
  ...
  v7 = v8;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49453300(&v7, 0);
