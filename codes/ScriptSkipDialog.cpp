...
void ScriptSkipDialog__Close(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptSkipDialog__Close_44653080(this, 0, v2);
}


void ScriptSkipDialog__Close_44653080(ScriptSkipDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4C292FE & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptSkipDialog_EndClose__);
    byte_4C292FE = 1;
  }
...
void ScriptSkipDialog__OnClickCancel(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C29300 & 1) == 0 )
  {
    sub_1C2D490(&Method_ScriptSkipDialog_OnClickCancel__);
    byte_4C29300 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_ScriptSkipDialog_OnClickCancel__);
...
void ScriptSkipDialog__OnClickDecide(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C292FF & 1) == 0 )
  {
    sub_1C2D490(&Method_ScriptSkipDialog_OnClickDecide__);
    byte_4C292FF = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_ScriptSkipDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
...
void ScriptSkipDialog__OnClickExit(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C29301 & 1) == 0 )
  {
    sub_1C2D490(&Method_ScriptSkipDialog_OnClickExit__);
    byte_4C29301 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickExit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_ScriptSkipDialog_OnClickExit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0, 0);
    clickFunc = this->fields.clickFunc;
    this->fields.isButtonEnable = 0;
...
void ScriptSkipDialog__OnEnable(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C29302 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_15645/*"Window/NormalBase/CancelButton"*/);
    sub_1C2D490(&StringLiteral_15641/*"Window/ExitBase/CancelButton"*/);
    byte_4C29302 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  AndroidBackKeyManager__AddBackBtn_44721736(transform, (System_String_o *)StringLiteral_15645/*"Window/NormalBase/CancelButton"*/, 0);
  v4 = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  AndroidBackKeyManager__AddBackBtn_44721736(v4, (System_String_o *)StringLiteral_15641/*"Window/ExitBase/CancelButton"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C292FD & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptSkipDialog_EndOpen__);
    sub_1C2D490(&StringLiteral_11497/*"SCRIPT_ACTION_SKIP_CONFIRM_DETAIL"*/);
    sub_1C2D490(&StringLiteral_11498/*"SCRIPT_ACTION_SKIP_CONFIRM_EXIT"*/);
    sub_1C2D490(&StringLiteral_3681/*"COMMON_CONFIRM_NO"*/);
    sub_1C2D490(&StringLiteral_3686/*"COMMON_CONFIRM_YES"*/);
    byte_4C292FD = 1;
  }
  this->fields.clickFunc = func;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, (int32_t)func, method);
  ...
  if ( isUseExit )
  {
    ...
    normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11497/*"SCRIPT_ACTION_SKIP_CONFIRM_DETAIL"*/, 0);
    if ( message2Label )
    {
      UILabel__set_text(message2Label, (System_String_o *)normalBase, 0);
      buttonDecide2Label = this->fields.buttonDecide2Label;
      normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3686/*"COMMON_CONFIRM_YES"*/, 0);
      if ( buttonDecide2Label )
      {
        ...
        normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3681/*"COMMON_CONFIRM_NO"*/, 0);
        if ( buttonCancel2Label )
        {
          ...
          v13 = &StringLiteral_11498/*"SCRIPT_ACTION_SKIP_CONFIRM_EXIT"*/;
          goto LABEL_17;
        }
      }
    }
LABEL_19:
    sub_1C2D6EC(normalBase, v7);
  }
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v13 = &StringLiteral_3681/*"COMMON_CONFIRM_NO"*/;
LABEL_17:
  ...
  BaseDialog__Open((BaseDialog_o *)this, v16, 0, 0);
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A73D54;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A73D0C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29304 & 1) == 0 )
  {
    sub_1C2D490(&ScriptSkipDialog_ResultKind_TypeInfo);
    byte_4C29304 = 1;
  }
  v9[1] = 0;
