...
void __fastcall ScriptSkipDialog__Close(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptSkipDialog__Close_42920748(this, 0LL, v2);
}


void __fastcall ScriptSkipDialog__Close_42920748(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB641B & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_ScriptSkipDialog_EndClose__, v10);
    byte_4BB641B = 1;
  }
...
void __fastcall ScriptSkipDialog__OnClickCancel(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB641D & 1) == 0 )
  {
    sub_1C13D24(&Method_ScriptSkipDialog_OnClickCancel__, method);
    byte_4BB641D = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_ScriptSkipDialog_OnClickCancel__);
...
void __fastcall ScriptSkipDialog__OnClickDecide(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB641C & 1) == 0 )
  {
    sub_1C13D24(&Method_ScriptSkipDialog_OnClickDecide__, method);
    byte_4BB641C = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_ScriptSkipDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C13D08(v3, v3[4]);
...
void __fastcall ScriptSkipDialog__OnClickExit(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB641E & 1) == 0 )
  {
    sub_1C13D24(&Method_ScriptSkipDialog_OnClickExit__, method);
    byte_4BB641E = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickExit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_ScriptSkipDialog_OnClickExit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C13D08(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0, 0LL);
    clickFunc = this->fields.clickFunc;
    this->fields.isButtonEnable = 0;
...
void __fastcall ScriptSkipDialog__OnEnable(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB641F & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_15891/*"Wildcard '{0}' allows element '{1}', and causes the content model to become ambiguous. A content model must be formed such that during validation of an element information item sequence, the particle contained directly, indirectly or implicitly therein with which to attempt to validate each item in the sequence in turn can be uniquely determined without examining the content or attributes of that item, and without any information about the items in the remainder of the sequence."*/, method);
    sub_1C13D24(&StringLiteral_15887/*"WhiteSmoke"*/, v3);
    byte_4BB641F = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  AndroidBackKeyManager__AddBackBtn_42984304(transform, (System_String_o *)StringLiteral_15891/*"Wildcard '{0}' allows element '{1}', and causes the content model to become ambiguous. A content model must be formed such that during validation of an element information item sequence, the particle contained directly, indirectly or implicitly therein with which to attempt to validate each item in the sequence in turn can be uniquely determined without examining the content or attributes of that item, and without any information about the items in the remainder of the sequence."*/, 0LL);
  v5 = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  AndroidBackKeyManager__AddBackBtn_42984304(v5, (System_String_o *)StringLiteral_15887/*"WhiteSmoke"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB641A & 1) == 0 )
  {
    sub_1C13D24(&System_Action_TypeInfo, isUseExit);
    sub_1C13D24(&LocalizationManager_TypeInfo, v11);
    sub_1C13D24(&Method_ScriptSkipDialog_EndOpen__, v12);
    sub_1C13D24(&StringLiteral_11676/*"SCRIPT_ACTION_CODE_SWITCH_END"*/, v13);
    sub_1C13D24(&StringLiteral_11677/*"SCRIPT_ACTION_CODE_TALK"*/, v14);
    sub_1C13D24(&StringLiteral_3802/*"COMMON_CONFIRM_CLOSE"*/, v15);
    sub_1C13D24(&StringLiteral_3807/*"COMMON_CONFIRM_RETRY"*/, v16);
    byte_4BB641A = 1;
  }
  ...
  if ( isUseExit )
  {
    ...
    normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11676/*"SCRIPT_ACTION_CODE_SWITCH_END"*/, 0LL);
    if ( message2Label )
    {
      UILabel__set_text(message2Label, (System_String_o *)normalBase, 0LL);
      buttonDecide2Label = this->fields.buttonDecide2Label;
      normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3807/*"COMMON_CONFIRM_RETRY"*/, 0LL);
      if ( buttonDecide2Label )
      {
        ...
        normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3802/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
        if ( buttonCancel2Label )
        {
          ...
          v23 = &StringLiteral_11677/*"SCRIPT_ACTION_CODE_TALK"*/;
          goto LABEL_17;
        }
      }
    }
LABEL_19:
    sub_1C13F80(normalBase, v17);
  }
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v23 = &StringLiteral_3802/*"COMMON_CONFIRM_CLOSE"*/;
LABEL_17:
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A56E30;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A56DE8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6421 & 1) == 0 )
  {
    sub_1C13D24(&ScriptSkipDialog_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4BB6421 = 1;
  }
  v9[1] = 0LL;
