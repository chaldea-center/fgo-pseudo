...
void ScriptSkipDialog__Close(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptSkipDialog__Close_46028376(this, 0, v2);
}


void ScriptSkipDialog__Close_46028376(ScriptSkipDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  int32_t v3; // w3
  ...
  if ( (byte_4E06A6F & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ScriptSkipDialog_EndClose__);
    byte_4E06A6F = 1;
  }
...
void ScriptSkipDialog__OnClickCancel(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06A71 & 1) == 0 )
  {
    sub_1CE6700(&Method_ScriptSkipDialog_OnClickCancel__);
    byte_4E06A71 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ScriptSkipDialog_OnClickCancel__);
...
void ScriptSkipDialog__OnClickDecide(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06A70 & 1) == 0 )
  {
    sub_1CE6700(&Method_ScriptSkipDialog_OnClickDecide__);
    byte_4E06A70 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ScriptSkipDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
...
void ScriptSkipDialog__OnClickExit(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06A72 & 1) == 0 )
  {
    sub_1CE6700(&Method_ScriptSkipDialog_OnClickExit__);
    byte_4E06A72 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptSkipDialog_OnClickExit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ScriptSkipDialog_OnClickExit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0, 0);
    clickFunc = this->fields.clickFunc;
    this->fields.isButtonEnable = 0;
...
void ScriptSkipDialog__OnEnable(ScriptSkipDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06A73 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_15798/*"Window/NormalBase/CancelButton"*/);
    sub_1CE6700(&StringLiteral_15794/*"Window/ExitBase/CancelButton"*/);
    byte_4E06A73 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  AndroidBackKeyManager__AddBackBtn_46098588(transform, (System_String_o *)StringLiteral_15798/*"Window/NormalBase/CancelButton"*/, 0);
  v4 = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  AndroidBackKeyManager__AddBackBtn_46098588(v4, (System_String_o *)StringLiteral_15794/*"Window/ExitBase/CancelButton"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E06A6E & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ScriptSkipDialog_EndOpen__);
    sub_1CE6700(&StringLiteral_11626/*"SCRIPT_ACTION_SKIP_CONFIRM_DETAIL"*/);
    sub_1CE6700(&StringLiteral_11627/*"SCRIPT_ACTION_SKIP_CONFIRM_EXIT"*/);
  ...
  if ( isUseExit )
  {
    ...
    normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11626/*"SCRIPT_ACTION_SKIP_CONFIRM_DETAIL"*/, 0);
    if ( message2Label )
    {
      UILabel__set_text(message2Label, (System_String_o *)normalBase, 0);
      buttonDecide2Label = this->fields.buttonDecide2Label;
      normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3722/*"COMMON_CONFIRM_YES"*/, 0);
      if ( buttonDecide2Label )
      {
        ...
        normalBase = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3717/*"COMMON_CONFIRM_NO"*/, 0);
        if ( buttonCancel2Label )
        {
          ...
          v17 = &StringLiteral_11627/*"SCRIPT_ACTION_SKIP_CONFIRM_EXIT"*/;
          goto LABEL_17;
        }
      }
    }
LABEL_19:
  ...
  v17 = &StringLiteral_3717/*"COMMON_CONFIRM_NO"*/;
LABEL_17:
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B197E0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B19798;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E06A75 & 1) == 0 )
  {
    sub_1CE6700(&ScriptSkipDialog_ResultKind_TypeInfo);
    byte_4E06A75 = 1;
  }
  v9[1] = 0;
