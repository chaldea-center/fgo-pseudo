        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1860C & 1) == 0 )
  {
    sub_1BCAFF8(&CharaGraphSortManageUnitServantMission_TypeInfo, method);
    byte_4B1860C = 1;
  }
  v3 = (CharaGraphSortManageUnitSvtCollection_o *)sub_1BCB244(CharaGraphSortManageUnitServantMission_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B1860B & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_4359/*"CharaGraphSort_SvtMission_"*/, method);
    byte_4B1860B = 1;
  }
  return (System_String_o *)StringLiteral_4359/*"CharaGraphSort_SvtMission_"*/;
}
