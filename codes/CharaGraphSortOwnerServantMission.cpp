void CharaGraphSortOwnerServantMission___ctor(CharaGraphSortOwnerServantMission_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52DAE & 1) == 0 )
  {
    sub_1C3E564(&CharaGraphSortManageUnitServantMission_TypeInfo);
    byte_4C52DAE = 1;
  }
  v3 = (CharaGraphSortManageUnitSvtCollection_o *)sub_1C3E7B0(CharaGraphSortManageUnitServantMission_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C52DAD & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_4395/*"CharaGraphSort_SvtMission_"*/);
    byte_4C52DAD = 1;
  }
