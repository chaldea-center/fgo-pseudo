        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A5F7 & 1) == 0 )
  {
    sub_1B863B8(&CharaGraphSortManageUnitServantMission_TypeInfo, method);
    byte_4A4A5F7 = 1;
  }
  CharaGraphSortOwnerBase___ctor((CharaGraphSortOwnerBase_o *)this, 0LL);
  v3 = (CharaGraphSortManageUnitSvtCollection_o *)sub_1B86604(CharaGraphSortManageUnitServantMission_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4A5F6 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_4380/*"CharaGraphSort_SvtMission_"*/, method);
    byte_4A4A5F6 = 1;
  }
  return (System_String_o *)StringLiteral_4380/*"CharaGraphSort_SvtMission_"*/;
}