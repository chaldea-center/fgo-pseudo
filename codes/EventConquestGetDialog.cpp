...
void __fastcall EventConquestGetDialog__Close(EventConquestGetDialog_o *this, const MethodInfo *method)
{
  ...
  EventConquestGetDialog__Close_47811336(this, 0LL, v2);
}


void __fastcall EventConquestGetDialog__Close_47811336(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48BF3 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_EventConquestGetDialog_EndClose__, v6);
    byte_4B48BF3 = 1;
  }
...
LABEL_37:
  ...
  v22 = sub_1BDB9B4(Enumerator, System_IDisposable_TypeInfo);
  if ( v22 )
  {
    v23 = *(_QWORD *)v22;
    v24 = v22;
    ...
    {
LABEL_31:
      v27 = sub_1C2C00C(v22, System_IDisposable_TypeInfo, 0LL);
    }
  ...
  if ( !itemGetDetailLabel )
LABEL_38:
    sub_1BDBAD4(itemGetDetailLabel, method);
...
void __fastcall EventConquestGetDialog__OnClickClose(EventConquestGetDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48BF4 & 1) == 0 )
  {
    sub_1BDB878(&Method_EventConquestGetDialog_OnClickClose__, method);
    byte_4B48BF4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventConquestGetDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_EventConquestGetDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v26; // x2
  BalanceConfig_c **v27; // x29
  UserGameEntity_o *v28; // x25
  il2cpp_array_size_t v29; // w27
  GiftEntity_o *v30; // x26
  int v31; // w8
  int64_t qp; // x28
  ...
  System_String_o *v50; // [xsp+0h] [xbp-80h]
  System_String_o *v51; // [xsp+8h] [xbp-78h]
  Il2CppObject *v52; // [xsp+10h] [xbp-70h]
  signed int v53; // [xsp+1Ch] [xbp-64h]
  UnityEngine_Vector3_o v54; // 0:s0.4,4:s1.4,8:s2.4

  if ( (byte_4B48BF1 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, rewards);
    sub_1BDB878(&BalanceConfig_TypeInfo, v11);
    sub_1BDB878(&Method_DataManager_GetMasterData_ItemMaster___, v12);
    sub_1BDB878(&Method_DataManager_GetMasterData_UserItemMaster___, v13);
    sub_1BDB878(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__, v14);
    sub_1BDB878(&Method_EventConquestGetDialog_EndOpen__, v15);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_EventConquestGetIconComponent___, v16);
    sub_1BDB878(&NetworkManager_TypeInfo, v17);
    sub_1BDB878(&Method_UnityEngine_Object_Instantiate_GameObject___, v18);
  ...
  if ( max_length >= 1 )
  {
    ...
    v28 = (UserGameEntity_o *)Instance;
    v29 = 0;
    v53 = max_length;
    v52 = v25;
    do
    {
      if ( v29 >= rewards->max_length )
        sub_1BDBADC(Instance, v22, v26);
      v30 = rewards->m_Items[v29];
      if ( !v30 )
        goto LABEL_84;
      ...
      else
      {
        switch ( v31 )
        {
          ...
          case 13:
            if ( !v28 )
              goto LABEL_84;
            qp = UserGameEntity__GetFriendPoint(v28, 0LL);
            goto LABEL_37;
          case 22:
            if ( !v28 )
              goto LABEL_84;
            qp = v28->fields.rarePri;
            goto LABEL_37;
        }
      }
...
LABEL_37:
      ...
      if ( !v38 )
        goto LABEL_84;
      UnityEngine_Transform__set_parent(v38, (UnityEngine_Transform_o *)Instance, 0LL);
      Instance = (__int64)UnityEngine_GameObject__get_transform(v37, 0LL);
      v39 = (UnityEngine_Transform_o *)Instance;
      if ( !byte_4B3E911 )
      {
        Instance = sub_1BDB878(&UnityEngine_Vector3_TypeInfo, v22);
        byte_4B3E911 = 1;
      }
      if ( !v39 )
        goto LABEL_84;
      ...
      if ( !Instance )
        goto LABEL_84;
      v54.fields.x = this->fields.ICON_SCALE_SIZE;
      ...
      Instance = (__int64)UnityEngine_GameObject__GetComponent_object_(
                            v37,
                            (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_EventConquestGetIconComponent___);
      v40 = v30->fields.num < 0 ? -1 : v30->fields.num;
      if ( !Instance )
        goto LABEL_84;
      ...
      EventConquestGetIconComponent__setPossessionCounterLabel(
        (EventConquestGetIconComponent_o *)v41,
        qp,
        v40,
        qp >= UserItemMax,
        v42);
  ...
  if ( !Instance
    || (UIGrid__set_repositionNow((UIGrid_o *)Instance, 1, 0LL),
        ...
        v22 = v51,
        !Instance)
    || (UILabel__set_text((UILabel_o *)Instance, v51, 0LL), (Instance = (__int64)this->fields.itemGetDetailLabel) == 0)
    || (UILabel__set_text((UILabel_o *)Instance, v50, 0LL), !v50) )
  {
LABEL_84:
  ...
  else
  {
    ...
    do
    {
      Chars = System_String__get_Chars(v50, v43++, 0LL);
      if ( Chars == 10 )
        ++v44;
    }
    while ( v43 < v50->fields._stringLength );
  }
...
LABEL_80:
  ...
  v48 = -1038090240;
LABEL_81:
  GameObjectExtensions__SetLocalPositionY(gameObject, *(float *)&v48, 0LL);
LABEL_82:
...
void __fastcall EventConquestGetDialog__Open_47811136(
        EventConquestGetDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48BF2 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, reward);
    sub_1BDB878(&Method_EventConquestGetDialog_EndOpen__, v7);
    byte_4B48BF2 = 1;
  }
  this->fields.closeFunc = closeCb;
  sub_1BDB81C(
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A29F38;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A29EF8;
}
