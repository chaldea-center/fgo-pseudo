        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1B649A4(p_callbackFunc, 0, index, (int32_t)method);
...
void __fastcall DeckSelectMenu__Close(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  DeckSelectMenu__Close_31603920(this, 0LL, v2);
}


void __fastcall DeckSelectMenu__Close_31603920(
        DeckSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA93B & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DeckSelectMenu_EndClose__, v5);
    byte_49FA93B = 1;
  }
  deckListViewManager = this->fields.deckListViewManager;
  if ( !deckListViewManager )
    sub_1B64C5C(0LL, callback);
  DeckListViewManager__SetMode_31595720(deckListViewManager, 1, method);
...
void __fastcall DeckSelectMenu__EndOpen(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA93A & 1) == 0 )
  {
    sub_1B64A00(&DeckListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B64A00(&Method_DeckSelectMenu_OnSelectItem__, v3);
    byte_49FA93A = 1;
  }
  this->fields.state = 2;
  deckListViewManager = this->fields.deckListViewManager;
  v5 = (DeckListViewManager_CallbackFunc_o *)sub_1B64C4C(DeckListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&deckListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
  DeckListViewManager__SetMode_31595720(deckListViewManager, 2, v11);
...
void __fastcall DeckSelectMenu__OnClickCancel(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA93C & 1) == 0 )
  {
    sub_1B64A00(&Method_DeckSelectMenu_OnClickCancel__, method);
    byte_49FA93C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_DeckSelectMenu_OnClickCancel__);
...
void __fastcall DeckSelectMenu__OnSelectItem(DeckSelectMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  if ( (byte_49FA93D & 1) == 0 )
  {
    sub_1B64A00(&Method_DeckSelectMenu_OnSelectItem__, *(_QWORD *)&kind);
    byte_49FA93D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnSelectItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1B64A18(Method_DeckSelectMenu_OnSelectItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA939 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DeckSelectMenu_EndOpen__, v11);
    sub_1B64A00(&LocalizationManager_TypeInfo, v12);
    sub_1B64A00(&StringLiteral_10199/*"PARTY_ORGANIZATION_DECK_SELECT_CANCEL"*/, v13);
    sub_1B64A00(&StringLiteral_10201/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_TITLE"*/, v14);
    sub_1B64A00(&StringLiteral_10200/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_DETAIL"*/, v15);
    byte_49FA939 = 1;
  }
  ...
  if ( (unsigned int)(state - 2) < 2 )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v28, v29);
  ...
  else if ( state == 4 || !state )
  {
    ...
    if ( !kind )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10201/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_TITLE"*/, 0LL);
      if ( !titleLabel )
        goto LABEL_23;
      UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
      titleDetailLabel = this->fields.titleDetailLabel;
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10200/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_DETAIL"*/, 0LL);
      if ( !titleDetailLabel )
        goto LABEL_23;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10199/*"PARTY_ORGANIZATION_DECK_SELECT_CANCEL"*/, 0LL);
    if ( cancelLabel )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewManager__SetMode_31595720((DeckListViewManager_o *)gameObject, 1, v26);
              this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA937 & 1) == 0 )
  {
    sub_1B64A00(&DeckSelectMenu_CallbackFunc_TypeInfo, value);
    byte_49FA937 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (DeckSelectMenu_o *)sub_1B64F1C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A6C04;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A6BAC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA93F & 1) == 0 )
  {
    ...
    sub_1B64A00(&DeckSelectMenu_ResultKind_TypeInfo, v9);
    byte_49FA93F = 1;
  }
  v14[2] = 0LL;
