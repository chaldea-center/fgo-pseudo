...
void DeckSelectMenu__Callback(DeckSelectMenu_o *this, int32_t result, int32_t index, const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1D0F058(p_callbackFunc, 0, index, (int32_t)method, v4, v5, v6, v7);
...
void DeckSelectMenu__Close(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  DeckSelectMenu__Close_35151024(this, 0, v2);
}


void DeckSelectMenu__Close_35151024(DeckSelectMenu_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4E72D1E & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_DeckSelectMenu_EndClose__);
    byte_4E72D1E = 1;
  }
  deckListViewManager = this->fields.deckListViewManager;
  if ( !deckListViewManager )
    sub_1D0F30C(0, callback);
  DeckListViewManager__SetMode_35142800(deckListViewManager, 1, method);
...
void DeckSelectMenu__EndOpen(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72D1D & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_DeckSelectMenu_OnSelectItem__);
    byte_4E72D1D = 1;
  }
  this->fields.state = 2;
  deckListViewManager = this->fields.deckListViewManager;
  v4 = (DeckListViewManager_CallbackFunc_o *)sub_1D0F300(DeckListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1D0F058(
    ...
    v12,
    v13);
  DeckListViewManager__SetMode_35142800(deckListViewManager, 2, v14);
...
void DeckSelectMenu__OnClickCancel(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72D1F & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DeckSelectMenu_OnClickCancel__);
    byte_4E72D1F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_DeckSelectMenu_OnClickCancel__);
...
void DeckSelectMenu__OnSelectItem(DeckSelectMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnSelectItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1D0F0CC(Method_DeckSelectMenu_OnSelectItem__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_DeckSelectMenu_EndOpen__);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_10345/*"PARTY_ORGANIZATION_DECK_SELECT_CANCEL"*/);
    sub_1D0F0B4(&StringLiteral_10347/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_10346/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_DETAIL"*/);
    byte_4E72D1C = 1;
  }
  ...
  else if ( state == 4 || !state )
  {
    ...
    if ( !kind )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10347/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_TITLE"*/, 0);
      if ( !titleLabel )
        goto LABEL_23;
      UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
      titleDetailLabel = this->fields.titleDetailLabel;
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10346/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_DETAIL"*/, 0);
      if ( !titleDetailLabel )
        goto LABEL_23;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10345/*"PARTY_ORGANIZATION_DECK_SELECT_CANCEL"*/, 0);
    if ( cancelLabel )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewManager__SetMode_35142800((DeckListViewManager_o *)gameObject, 1, v27);
              this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E72D1A & 1) == 0 )
  {
    sub_1D0F0B4(&DeckSelectMenu_CallbackFunc_TypeInfo);
    byte_4E72D1A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (DeckSelectMenu_o *)sub_1D0F6A8(v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B36C98;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B36C40;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E72D22 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&DeckSelectMenu_ResultKind_TypeInfo);
    byte_4E72D22 = 1;
  }
  v10[2] = 0;
