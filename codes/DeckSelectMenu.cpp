        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1B8635C(p_callbackFunc, 0, index, method);
...
void __fastcall DeckSelectMenu__Close(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  DeckSelectMenu__Close_32376632(this, 0LL, v2);
}


void __fastcall DeckSelectMenu__Close_32376632(
        DeckSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49E3F & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_DeckSelectMenu_EndClose__, v5);
    byte_4A49E3F = 1;
  }
  deckListViewManager = this->fields.deckListViewManager;
  if ( !deckListViewManager )
    sub_1B86614(0LL, callback);
  DeckListViewManager__SetMode_32368416(deckListViewManager, 1, method);
...
void __fastcall DeckSelectMenu__EndOpen(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49E3E & 1) == 0 )
  {
    sub_1B863B8(&DeckListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B863B8(&Method_DeckSelectMenu_OnSelectItem__, v3);
    byte_4A49E3E = 1;
  }
  this->fields.state = 2;
  deckListViewManager = this->fields.deckListViewManager;
  v5 = (DeckListViewManager_CallbackFunc_o *)sub_1B86604(DeckListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&deckListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
  DeckListViewManager__SetMode_32368416(deckListViewManager, 2, v11);
...
void __fastcall DeckSelectMenu__OnClickCancel(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49E40 & 1) == 0 )
  {
    sub_1B863B8(&Method_DeckSelectMenu_OnClickCancel__, method);
    byte_4A49E40 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_DeckSelectMenu_OnClickCancel__);
...
void __fastcall DeckSelectMenu__OnSelectItem(DeckSelectMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  if ( (byte_4A49E41 & 1) == 0 )
  {
    sub_1B863B8(&Method_DeckSelectMenu_OnSelectItem__, *(_QWORD *)&kind);
    byte_4A49E41 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnSelectItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1B863D0(Method_DeckSelectMenu_OnSelectItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49E3D & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_DeckSelectMenu_EndOpen__, v11);
    sub_1B863B8(&LocalizationManager_TypeInfo, v12);
    sub_1B863B8(&StringLiteral_10071/*"PARTY_ORGANIZATION_DECK_SELECT_CANCEL"*/, v13);
    sub_1B863B8(&StringLiteral_10073/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_TITLE"*/, v14);
    sub_1B863B8(&StringLiteral_10072/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_DETAIL"*/, v15);
    byte_4A49E3D = 1;
  }
  ...
  else if ( state == 4 || !state )
  {
    ...
    if ( !kind )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10073/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_TITLE"*/, 0LL);
      if ( !titleLabel )
        goto LABEL_23;
      UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
      titleDetailLabel = this->fields.titleDetailLabel;
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10072/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_DETAIL"*/, 0LL);
      if ( !titleDetailLabel )
        goto LABEL_23;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10071/*"PARTY_ORGANIZATION_DECK_SELECT_CANCEL"*/, 0LL);
    if ( cancelLabel )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewManager__SetMode_32368416((DeckListViewManager_o *)gameObject, 1, v26);
              this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49E3B & 1) == 0 )
  {
    sub_1B863B8(&DeckSelectMenu_CallbackFunc_TypeInfo, value);
    byte_4A49E3B = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (DeckSelectMenu_o *)sub_1B868D4(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CC514;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CC4BC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49E43 & 1) == 0 )
  {
    ...
    sub_1B863B8(&DeckSelectMenu_ResultKind_TypeInfo, v9);
    byte_4A49E43 = 1;
  }
  v14[2] = 0LL;
