        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1BAB3C0(p_callbackFunc, 0, index, (int32_t)method);
...
void __fastcall DeckSelectMenu__Close(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  DeckSelectMenu__Close_32129092(this, 0LL, v2);
}


void __fastcall DeckSelectMenu__Close_32129092(
        DeckSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB19B6 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DeckSelectMenu_EndClose__, v5);
    byte_4AB19B6 = 1;
  }
  deckListViewManager = this->fields.deckListViewManager;
  if ( !deckListViewManager )
    sub_1BAB678(0LL, callback);
  DeckListViewManager__SetMode_32120892(deckListViewManager, 1, method);
...
void __fastcall DeckSelectMenu__EndOpen(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB19B5 & 1) == 0 )
  {
    sub_1BAB41C(&DeckListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BAB41C(&Method_DeckSelectMenu_OnSelectItem__, v3);
    byte_4AB19B5 = 1;
  }
  this->fields.state = 2;
  deckListViewManager = this->fields.deckListViewManager;
  v5 = (DeckListViewManager_CallbackFunc_o *)sub_1BAB668(DeckListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&deckListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
  DeckListViewManager__SetMode_32120892(deckListViewManager, 2, v11);
...
void __fastcall DeckSelectMenu__OnClickCancel(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB19B7 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DeckSelectMenu_OnClickCancel__, method);
    byte_4AB19B7 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_DeckSelectMenu_OnClickCancel__);
...
void __fastcall DeckSelectMenu__OnSelectItem(DeckSelectMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  if ( (byte_4AB19B8 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DeckSelectMenu_OnSelectItem__, *(_QWORD *)&kind);
    byte_4AB19B8 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnSelectItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1BAB434(Method_DeckSelectMenu_OnSelectItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB19B4 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DeckSelectMenu_EndOpen__, v11);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v12);
    sub_1BAB41C(&StringLiteral_10252/*"PARTY_ORGANIZATION_DECK_SELECT_CANCEL"*/, v13);
    sub_1BAB41C(&StringLiteral_10254/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_TITLE"*/, v14);
    sub_1BAB41C(&StringLiteral_10253/*"PARTY_ORGANIZATION_DECK_SELECT_COPY_DETAIL"*/, v15);
    byte_4AB19B4 = 1;
  }
  ...
  if ( (unsigned int)(state - 2) < 2 )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.openCallbackFunc, (int32_t)openCallback, v28, v29);
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewManager__SetMode_32120892((DeckListViewManager_o *)gameObject, 1, v26);
              this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB19B2 & 1) == 0 )
  {
    sub_1BAB41C(&DeckSelectMenu_CallbackFunc_TypeInfo, value);
    byte_4AB19B2 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (DeckSelectMenu_o *)sub_1BAB938(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19E8E0C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19E8DB4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB19BA & 1) == 0 )
  {
    ...
    sub_1BAB41C(&DeckSelectMenu_ResultKind_TypeInfo, v9);
    byte_4AB19BA = 1;
  }
  v14[2] = 0LL;
