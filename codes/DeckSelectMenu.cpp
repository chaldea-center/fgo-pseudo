...
void __fastcall DeckSelectMenu__Close(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  DeckSelectMenu__Close_32738092(this, 0LL, v2);
}


void __fastcall DeckSelectMenu__Close_32738092(
        DeckSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0200 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_DeckSelectMenu_EndClose__, v5);
    byte_4BB0200 = 1;
  }
  deckListViewManager = this->fields.deckListViewManager;
  if ( !deckListViewManager )
    sub_1C13F80(0LL, callback);
  DeckListViewManager__SetMode_32729876(deckListViewManager, 1, method);
...
void __fastcall DeckSelectMenu__EndOpen(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB01FF & 1) == 0 )
  {
    sub_1C13D24(&DeckListViewManager_CallbackFunc_TypeInfo, method);
    sub_1C13D24(&Method_DeckSelectMenu_OnSelectItem__, v3);
    byte_4BB01FF = 1;
  }
  this->fields.state = 2;
  deckListViewManager = this->fields.deckListViewManager;
  v5 = (DeckListViewManager_CallbackFunc_o *)sub_1C13F70(DeckListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1C13CC8(&deckListViewManager->fields.callbackFunc);
  DeckListViewManager__SetMode_32729876(deckListViewManager, 2, v9);
...
void __fastcall DeckSelectMenu__OnClickCancel(DeckSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB0201 & 1) == 0 )
  {
    sub_1C13D24(&Method_DeckSelectMenu_OnClickCancel__, method);
    byte_4BB0201 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_DeckSelectMenu_OnClickCancel__);
...
void __fastcall DeckSelectMenu__OnSelectItem(DeckSelectMenu_o *this, int32_t kind, int32_t n, const MethodInfo *method)
{
  ...
  if ( (byte_4BB0202 & 1) == 0 )
  {
    sub_1C13D24(&Method_DeckSelectMenu_OnSelectItem__, *(_QWORD *)&kind);
    byte_4BB0202 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckSelectMenu_OnSelectItem__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_1C13D3C(Method_DeckSelectMenu_OnSelectItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB01FE & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_DeckSelectMenu_EndOpen__, v11);
    sub_1C13D24(&LocalizationManager_TypeInfo, v12);
    sub_1C13D24(&StringLiteral_10428/*"PARTY_ORGANIZATION_COST_COLOR"*/, v13);
    sub_1C13D24(&StringLiteral_10430/*"PARTY_ORGANIZATION_COST_RESTRICTION_COLOR"*/, v14);
    sub_1C13D24(&StringLiteral_10429/*"PARTY_ORGANIZATION_COST_OVER_COLOR"*/, v15);
    byte_4BB01FE = 1;
  }
  ...
  else if ( state == 4 || !state )
  {
    ...
    if ( !kind )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10430/*"PARTY_ORGANIZATION_COST_RESTRICTION_COLOR"*/, 0LL);
      if ( !titleLabel )
        goto LABEL_23;
      UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
      titleDetailLabel = this->fields.titleDetailLabel;
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10429/*"PARTY_ORGANIZATION_COST_OVER_COLOR"*/, 0LL);
      if ( !titleDetailLabel )
        goto LABEL_23;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10428/*"PARTY_ORGANIZATION_COST_COLOR"*/, 0LL);
    if ( cancelLabel )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              DeckListViewManager__SetMode_32729876((DeckListViewManager_o *)gameObject, 1, v24);
              this->fields.state = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB01FC & 1) == 0 )
  {
    sub_1C13D24(&DeckSelectMenu_CallbackFunc_TypeInfo, value);
    byte_4BB01FC = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (DeckSelectMenu_o *)sub_1C14240(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A4F2D4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A4F27C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0204 & 1) == 0 )
  {
    ...
    sub_1C13D24(&DeckSelectMenu_ResultKind_TypeInfo, v9);
    byte_4BB0204 = 1;
  }
  v14[2] = 0LL;
