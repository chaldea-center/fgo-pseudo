        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDF39 & 1) == 0 )
  {
    sub_1B64A00(&ServantCharaGraphFilterLogic_TypeInfo, method);
    byte_49FDF39 = 1;
  }
  v2 = (ServantCharaGraphFilterLogic_o *)sub_1B64C4C(ServantCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDF38 & 1) == 0 )
  {
    sub_1B64A00(&ServantCharaGraphSortLogic_TypeInfo, method);
    byte_49FDF38 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1B64C4C(ServantCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FDF37 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_1267/*"1"*/, method);
    byte_49FDF37 = 1;
  }
