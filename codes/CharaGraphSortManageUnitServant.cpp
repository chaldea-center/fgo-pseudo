        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA223 & 1) == 0 )
  {
    sub_1B4CF90(&ServantCharaGraphFilterLogic_TypeInfo, method);
    byte_49BA223 = 1;
  }
  v2 = (Il2CppObject *)sub_1B4D1DC(ServantCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA222 & 1) == 0 )
  {
    sub_1B4CF90(&ServantCharaGraphSortLogic_TypeInfo, method);
    byte_49BA222 = 1;
  }
  v2 = (ServantCharaGraphSortLogic_o *)sub_1B4D1DC(ServantCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_49BA221 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_1190/*"1"*/, method);
    byte_49BA221 = 1;
  }
  return (System_String_o *)StringLiteral_1190/*"1"*/;
}