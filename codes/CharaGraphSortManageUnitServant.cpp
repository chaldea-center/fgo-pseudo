        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01385 & 1) == 0 )
  {
    sub_1BC3008(&ServantCharaGraphFilterLogic_TypeInfo, method);
    byte_4B01385 = 1;
  }
  v2 = (ServantCharaGraphFilterLogic_o *)sub_1BC3254(ServantCharaGraphFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01384 & 1) == 0 )
  {
    sub_1BC3008(&ServantCharaGraphSortLogic_TypeInfo, method);
    byte_4B01384 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1BC3254(ServantCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B01383 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_1163/*"1"*/, method);
    byte_4B01383 = 1;
  }
  return (System_String_o *)StringLiteral_1163/*"1"*/;
}