void __fastcall EquipMaster___ctor(EquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4E328 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_EquipMaster__EquipEntity__int___ctor__, method);
    byte_4A4E328 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    51,
    (const MethodInfo_3211F5C *)Method_DataMasterBase_EquipMaster__EquipEntity__int___ctor__);
}
...
System_String_o *__fastcall EquipMaster__getEquipName(int32_t equipId, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E329 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EquipMaster___, method);
    sub_1B863B8(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v3);
    sub_1B863B8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v4);
  ...
  if ( result )
  {
    ...
    return CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47470088(monitor, 0LL);
  }
  return result;
}