void __fastcall EquipMaster___ctor(EquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FD08 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EquipMaster__EquipEntity__int___ctor__, method);
    byte_4A6FD08 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    47,
    (const MethodInfo_312C568 *)Method_DataMasterBase_EquipMaster__EquipEntity__int___ctor__);
}
...
System_String_o *__fastcall EquipMaster__getEquipName(int32_t equipId, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FD09 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_EquipMaster___, method);
    sub_1B90010(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v3);
  ...
  if ( result )
  {
    ...
    return CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46542220(monitor, 0LL);
  }
  return result;
}