void EquipMaster___ctor(EquipMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CEE515 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataMasterBase_EquipMaster__EquipEntity__int___ctor__);
    byte_4CEE515 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    51,
    (const MethodInfo_342BFD8 *)Method_DataMasterBase_EquipMaster__EquipEntity__int___ctor__);
}
...
System_String_o *EquipMaster__getEquipName(int32_t equipId, const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    return CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49485620(monitor, 0);
  }
  return result;
}