void __fastcall AudioData___ctor(AudioData_o *this, UnityEngine_AudioClip_o *clip, const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields, (int64_t)name, v8, v9, v10, v11, v12, v13);
  this->fields.data = clip;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.data, (int64_t)clip, v14, v15, v16, v17, v18, v19);
}


void __fastcall AudioData___ctor_39327788(
        AudioData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.name = name;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields, (int64_t)name, v7, v8, v9, v10, v11, v12);
  this->fields.data = clip;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.data, (int64_t)clip, v13, v14, v15, v16, v17, v18);
}


void __fastcall AudioData___ctor_39327856(
        AudioData_o *this,
        System_String_o *name,
        ...
        const MethodInfo *method)
{
  ...
  if ( !buf
    || (v15 = UnityEngine_AudioClip__Create(name, buf->max_length, 1, 44100, 0, 0LL),
        ...
        sub_1C3B708((PartyOrganizationUtility_o *)p_data, (int64_t)v15, v17, v18, v19, v20, v21, v22),
        (v13 = *p_data) == 0LL) )
  {
    sub_1C3B9C0(v13, v14);
  }
  UnityEngine_AudioClip__SetData_70897116(v13, buf, 0, 0LL);
}
