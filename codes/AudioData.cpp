void AudioData___ctor(AudioData_o *this, UnityEngine_AudioClip_o *clip, const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)name, v8, v9, v10, v11, v12, v13);
  this->fields.data = clip;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.data, (int32_t)clip, v14, v15, v16, v17, v18, v19);
}


void AudioData___ctor_41221480(
        AudioData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.name = name;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)name, v7, v8, v9, v10, v11, v12);
  this->fields.data = clip;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.data, (int32_t)clip, v13, v14, v15, v16, v17, v18);
}


void AudioData___ctor_41221548(
        AudioData_o *this,
        System_String_o *name,
        ...
        const MethodInfo *method)
{
  ...
  if ( !buf
    || (v15 = UnityEngine_AudioClip__Create(name, buf->max_length, 1, 44100, 0, 0),
        ...
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)p_data, (int32_t)v15, v17, v18, v19, v20, v21, v22),
        (v13 = *p_data) == 0) )
  {
    sub_1C7BD40(v13, v14);
  }
  UnityEngine_AudioClip__SetData_71643600(v13, buf, 0, 0);
}
