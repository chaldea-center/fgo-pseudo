void AudioData___ctor(AudioData_o *this, UnityEngine_AudioClip_o *clip, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields, (int32_t)name, v7, v8);
  this->fields.data = clip;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.data, (int32_t)clip, v9, v10);
}


void AudioData___ctor_40657208(
        AudioData_o *this,
...
void AudioData___ctor_40657276(
        AudioData_o *this,
        System_String_o *name,
        ...
        const MethodInfo *method)
{
  ...
  if ( !buf
    || (v10 = UnityEngine_AudioClip__Create(name, buf->max_length, 1, 44100, 0, 0),
        ...
        sub_1C36FFC((CGThumbnailListItem_o *)p_data, (int32_t)v10, v12, v13),
        (v9 = *p_data) == 0) )
  {
    sub_1C372B4(v9);
  }
  UnityEngine_AudioClip__SetData_71041996(v9, buf, 0, 0);
}
