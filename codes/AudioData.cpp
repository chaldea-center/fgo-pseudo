void __fastcall AudioData___ctor(AudioData_o *this, UnityEngine_AudioClip_o *clip, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)name, v8, v9);
  this->fields.data = clip;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.data, (int32_t)clip, v10, v11);
}


void __fastcall AudioData___ctor_37723756(
        AudioData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.name = name;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)name, v7, v8);
  this->fields.data = clip;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.data, (int32_t)clip, v9, v10);
}


void __fastcall AudioData___ctor_37723824(
        AudioData_o *this,
        System_String_o *name,
        ...
        const MethodInfo *method)
{
  ...
  if ( !buf
    || (v11 = UnityEngine_AudioClip__Create(name, buf->max_length, 1, 44100, 0, 0LL),
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)p_data, (int32_t)v11, v13, v14),
        (v9 = *p_data) == 0LL) )
  {
    sub_1B7641C(v9, v10);
  }
  UnityEngine_AudioClip__SetData_69062460(v9, buf, 0, 0LL);
}
