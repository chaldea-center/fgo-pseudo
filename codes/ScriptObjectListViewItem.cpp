void __fastcall ScriptObjectListViewItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E62 & 1) == 0 )
  {
    sub_1C13D24(&ScriptObjectListViewItem_TypeInfo, v1);
    byte_4BB1E62 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.path, (int64_t)path, v6, v7, v8, v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E61 & 1) == 0 )
  {
    sub_1C13D24(&ScriptObjectListViewItem_TypeInfo, sort);
    byte_4BB1E61 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E5E & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_25419/*"{0} Array"*/, method);
    sub_1C13D24(&StringLiteral_25567/*"{}"*/, v3);
    sub_1C13D24(&StringLiteral_25673/*"⑀①"*/, v4);
    byte_4BB1E5E = 1;
  }
  if ( !ScriptObjectListViewItem__get_EncryptEntity(this, method) )
  ...
  if ( ScriptObjectListViewItem__get_IsExistKey(this, v10) )
    v11 = (Il2CppObject **)&StringLiteral_25673/*"⑀①"*/;
  else
    v11 = (Il2CppObject **)&StringLiteral_25567/*"{}"*/;
  return System_String__Format_62982384((System_String_o *)StringLiteral_25419/*"{0} Array"*/, Name, keyType, *v11, 0LL);
}