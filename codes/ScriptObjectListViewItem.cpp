...
System_String_o *ScriptObjectListViewItem__get_TitleText(ScriptObjectListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29E00 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_25388/*"{0} {1} {2}"*/);
    sub_1C94098(&StringLiteral_25520/*"×"*/);
    sub_1C94098(&StringLiteral_25627/*"〇"*/);
    byte_4D29E00 = 1;
  }
  if ( !ScriptObjectListViewItem__get_EncryptEntity(this, method) )
  ...
  if ( ScriptObjectListViewItem__get_IsExistKey(this, v8) )
    v9 = (Il2CppObject **)&StringLiteral_25627/*"〇"*/;
  else
    v9 = (Il2CppObject **)&StringLiteral_25520/*"×"*/;
  return System_String__Format_64459120((System_String_o *)StringLiteral_25388/*"{0} {1} {2}"*/, Name, keyType, *v9, 0);
}