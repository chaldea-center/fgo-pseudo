        ...
        const MethodInfo *method)
{
  ...
  return TweenTransform__Begin_49969996(go, duration, 0, to, v4);
}


TweenTransform_o *TweenTransform__Begin_49969996(
        UnityEngine_GameObject_o *go,
        float duration,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF2EDA & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UITweener_Begin_TweenTransform___);
    byte_4CF2EDA = 1;
  }
  v9 = UITweener__Begin_object_(go, duration, (const MethodInfo_3245DA8 *)Method_UITweener_Begin_TweenTransform___);
  if ( !v9 )
    sub_1C7BD40(0, v10);
  v17 = v9;
  v9[8].klass = (Il2CppClass *)from;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v9[8], (int32_t)from, v11, v12, v13, v14, v15, v16);
  v17[8].monitor = to;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v17[8].monitor, (int32_t)to, v18, v19, v20, v21, v22, v23);
  if ( duration <= 0.0 )
  {
