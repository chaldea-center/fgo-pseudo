        ...
        const MethodInfo *method)
{
  ...
  return TweenTransform__Begin_50558764(go, duration, 0, to, v4);
}


TweenTransform_o *TweenTransform__Begin_50558764(
        UnityEngine_GameObject_o *go,
        float duration,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E092AA & 1) == 0 )
  {
    sub_1CE6700(&Method_UITweener_Begin_TweenTransform___);
    byte_4E092AA = 1;
  }
  v9 = UITweener__Begin_object_(go, duration, (const MethodInfo_32DA710 *)Method_UITweener_Begin_TweenTransform___);
  if ( !v9 )
    sub_1CE6958(0, v10);
  v17 = v9;
  v9[8].klass = (Il2CppClass *)from;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v9[8], (int32_t)from, v11, v12, v13, v14, v15, v16);
  v17[8].monitor = to;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v17[8].monitor, (int32_t)to, v18, v19, v20, v21, v22, v23);
  if ( duration <= 0.0 )
  {
