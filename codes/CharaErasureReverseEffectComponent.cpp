        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DDF & 1) == 0 )
  {
    sub_1B715CC(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B715CC(&StringLiteral_4944/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_4A20DDF = 1;
  }
