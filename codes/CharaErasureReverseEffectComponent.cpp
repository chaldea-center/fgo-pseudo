        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C445F0 & 1) == 0 )
  {
    sub_1C37058(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__);
  ...
  {
    CharaErasureReverseEffectComponent__EndCreateEffect(this, 0, v11);
    return;
  }
  ...
  if ( !transform )
    goto LABEL_27;
  LODWORD(v12) = (unsigned int)UnityEngine_Transform__get_localPosition((UnityEngine_Transform_o *)transform, 0);
