        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F5E & 1) == 0 )
  {
    sub_1BDB878(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1BDB878(&StringLiteral_4963/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_4B45F5E = 1;
  }
