        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFE1A & 1) == 0 )
  {
    sub_1B64A00(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B64A00(&StringLiteral_4941/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_49FFE1A = 1;
  }
