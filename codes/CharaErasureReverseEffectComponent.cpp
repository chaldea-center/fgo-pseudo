        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF7F9 & 1) == 0 )
  {
    sub_1B64870(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B64870(&StringLiteral_4940/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_49FF7F9 = 1;
  }
