        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F934 & 1) == 0 )
  {
    sub_1B863B8(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B863B8(&StringLiteral_4894/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_4A4F934 = 1;
  }
