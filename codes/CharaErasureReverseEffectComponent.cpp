        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB708F & 1) == 0 )
  {
    sub_1BAB41C(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1BAB41C(&StringLiteral_4960/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_4AB708F = 1;
  }
