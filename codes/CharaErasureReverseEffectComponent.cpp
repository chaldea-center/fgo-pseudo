        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09F6A & 1) == 0 )
  {
    sub_1B686D4(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B686D4(&StringLiteral_4939/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_4A09F6A = 1;
  }
