        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5939D13 & 1) == 0 )
  {
    sub_21FFC50(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__);
  ...
  {
    CharaErasureReverseEffectComponent__EndCreateEffect(this, 0, v17);
    return;
  }
  ...
  if ( !transform )
    goto LABEL_27;
  LODWORD(v18) = (unsigned int)UnityEngine_Transform__get_localPosition((UnityEngine_Transform_o *)transform, 0);
