        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB707 & 1) == 0 )
  {
    sub_B5D5C4(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, (_DWORD)figure, (_DWORD)method, v3);
    ...
    sub_B5D5C4(&StringLiteral_4597/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v22, v23, v24);
    byte_42EB707 = 1;
  }
  ...
  {
    CharaErasureReverseEffectComponent__EndCreateEffect(this, 0LL, v31);
    return;
  }
  ...
  if ( ((unsigned __int8)figure & 1) != 0 )
  {
    ...
    if ( v10 > 0.0 )
    {
      if ( v9 )
      {
        ...
        {
          v18.fields.x = 0.0;
          v18.fields.y = -(float)(v10 * this->fields.bodySize.fields.y);
          v18.fields.z = 0.0;
