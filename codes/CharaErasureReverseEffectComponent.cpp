        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3A53 & 1) == 0 )
  {
    sub_1B00CCC(&Method_CharaErasureReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B00CCC(&StringLiteral_4909/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v10);
    byte_48E3A53 = 1;
  }
