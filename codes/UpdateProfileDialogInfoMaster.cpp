void __fastcall UpdateProfileDialogInfoMaster___ctor(UpdateProfileDialogInfoMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    389,
    (const MethodInfo_30D41BC *)Method_DataMasterBase_UpdateProfileDialogInfoMaster__UpdateProfileDialogInfoEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (UpdateProfileDialogInfoEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                              (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                              PK,
                                              (const MethodInfo_30D41FC *)Method_DataMasterBase_UpdateProfileDialogInfoMaster__UpdateProfileDialogInfoEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCEB1 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_System_Collections_Generic_List_UpdateProfileDialogInfoEntity__Add__, v7);
    sub_1B640C8(&Method_System_Collections_Generic_List_UpdateProfileDialogInfoEntity__ToArray__, v8);
    sub_1B640C8(&Method_System_Collections_Generic_List_UpdateProfileDialogInfoEntity___ctor__, v9);
    sub_1B640C8(&System_Collections_Generic_List_UpdateProfileDialogInfoEntity__TypeInfo, v10);
    sub_1B640C8(&UpdateProfileDialogInfoEntity_TypeInfo, v11);
    byte_49FCEB1 = 1;
  }
  ...
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_34ACEA0 *)Method_System_Collections_Generic_List_UpdateProfileDialogInfoEntity___ctor__);
...
LABEL_16:
    ...
    if ( v23 )
    {
      ...
      if ( LOBYTE(v23->klass->vtable[0].methodPtr) < (unsigned int)methodPtr_low
        || (UpdateProfileDialogInfoEntity_c *)v23->klass->_2.typeHierarchy[methodPtr_low - 1] != UpdateProfileDialogInfoEntity_TypeInfo )
      {
        sub_1B645E4(v23);
LABEL_35:
        sub_1B64324(v23);
      ...
      v29 = Method_System_Collections_Generic_List_UpdateProfileDialogInfoEntity__Add__;
      ++v12->fields._version;
      if ( !items )
        sub_1B64324(v23);
...
LABEL_37:
  ...
  return (UpdateProfileDialogInfoEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                  v12,
                                                  (const MethodInfo_34AF2CC *)Method_System_Collections_Generic_List_UpdateProfileDialogInfoEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D424C *)Method_DataMasterBase_UpdateProfileDialogInfoMaster__UpdateProfileDialogInfoEntity__string__TryGetEntity__);
}