void __fastcall EventScriptMaster___ctor(EventScriptMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FF9D & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventScriptMaster__EventScriptEntity__string___ctor__, method);
    byte_4A6FF9D = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    215,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_EventScriptMaster__EventScriptEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFA2 & 1) == 0 )
  {
    ...
    sub_1B90010(&System_Comparison_EventScriptEntity__TypeInfo, v6);
    sub_1B90010(&Method_DataManager_GetMasterData_EventScriptReleaseMaster___, v7);
    sub_1B90010(&Method_DataManager_GetMasterData_UserEventMaster___, v8);
    sub_1B90010(&EventScriptEntity_TypeInfo, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity__Add__, v10);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity__Sort__, v11);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity__ToArray__, v12);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity___ctor__, v13);
    sub_1B90010(&System_Collections_Generic_List_EventScriptEntity__TypeInfo, v14);
    sub_1B90010(&NetworkManager_TypeInfo, v15);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v16);
    sub_1B90010(&Method_EventScriptMaster___c__GetAvailable_b__7_0__, v17);
    sub_1B90010(&EventScriptMaster___c_TypeInfo, v18);
    byte_4A6FFA2 = 1;
  }
  entity = 0LL;
  v19 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventScriptEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v19,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventScriptEntity___ctor__);
  if ( eventId <= 0 )
  {
    if ( !v19 )
      goto LABEL_37;
    System_Collections_Generic_List_object___ToArray(
      v19,
      (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_EventScriptEntity__ToArray__);
  }
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        ...
                        (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_EventScriptReleaseMaster___);
  Instance = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_37;
...
LABEL_37:
          ...
          || (Instance = UserEventEntity__getScriptFlag(entity, *(_DWORD *)(v28 + 20), 0LL), (Instance & 1) == 0) )
        {
          ...
          if ( (Instance & 1) != 0 )
          {
            ...
            else
            {
              ...
              sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v35 + 4), v28, v30, v31);
            }
          }
        }
      }
  ...
  if ( !v36 )
  {
    ...
    v36 = (System_Comparison_T__o *)sub_1B9025C(System_Comparison_EventScriptEntity__TypeInfo);
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->__9__7_0, (int32_t)v36, v39, v40);
  }
  if ( !v19 )
    goto LABEL_37;
  System_Collections_Generic_List_object___Sort_55649412(
    v19,
    v36,
    (const MethodInfo_3512484 *)Method_System_Collections_Generic_List_EventScriptEntity__Sort__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FF9B & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventScriptMaster__EventScriptEntity__string__GetEntity__, *(_QWORD *)&eventId);
    byte_4A6FF9B = 1;
  }
  ...
  return (EventScriptEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                  (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                  PK,
                                  (const MethodInfo_312C900 *)Method_DataMasterBase_EventScriptMaster__EventScriptEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FF9C & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventScriptMaster__EventScriptEntity__string__TryGetEntity__, entity);
    byte_4A6FF9C = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_EventScriptMaster__EventScriptEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FF9E & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&playType);
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v11);
    sub_1B90010(&EventScriptEntity_TypeInfo, v12);
    byte_4A6FF9E = 1;
  }
...
LABEL_16:
    sub_1B9026C(result, *(_QWORD *)&playType);
  }
  return 0LL;
}


EventScriptEntity_o *__fastcall EventScriptMaster__getRaceResultEntity_39309496(
        EventScriptMaster_o *this,
        int64_t scriptId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FF9F & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, scriptId);
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B90010(&EventScriptEntity_TypeInfo, v6);
    byte_4A6FF9F = 1;
  }
  result = (EventScriptEntity_o *)this->fields.list;
  if ( !result )
LABEL_18:
    sub_1B9026C(result, scriptId);
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            (System_Collections_ObjectModel_Collection_T__o *)result,
            (const MethodInfo_30C91F4 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
  if ( Count < 1 )
...
// local variable allocation has failed, the output may be wrong!
EventScriptEntity_o *__fastcall EventScriptMaster__getRaceResultEntity_39309792(
        EventScriptMaster_o *this,
        int32_t playType,
        int64_t scriptId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFA0 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&playType);
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v7);
    sub_1B90010(&EventScriptEntity_TypeInfo, v8);
    byte_4A6FFA0 = 1;
  }
  result = (EventScriptEntity_o *)this->fields.list;
  if ( !result )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFA1 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B90010(&System_Comparison_EventScriptEntity__TypeInfo, v6);
    sub_1B90010(&Method_DataManager_GetMasterData_UserEventMaster___, v7);
    sub_1B90010(&EventScriptEntity_TypeInfo, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity__Add__, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity__Sort__, v10);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity___ctor__, v11);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity__get_Count__, v12);
    sub_1B90010(&Method_System_Collections_Generic_List_EventScriptEntity__get_Item__, v13);
    sub_1B90010(&System_Collections_Generic_List_EventScriptEntity__TypeInfo, v14);
    sub_1B90010(&NetworkManager_TypeInfo, v15);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v16);
    sub_1B90010(&Method_EventScriptMaster___c__getRaceTermIdEntity_b__6_0__, v17);
    sub_1B90010(&EventScriptMaster___c_TypeInfo, v18);
    byte_4A6FFA1 = 1;
  }
  ...
  v23 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventScriptEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v23,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventScriptEntity___ctor__);
  if ( Count >= 1 )
      ...
      *(_QWORD *)&eventId = list;
      ...
      if ( *(_DWORD *)(list + 28) == 2 )
      {
        ...
        else
        {
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v31 + 4), eventId, v25, v26);
        }
      }
      if ( Count == ++v24 )
        goto LABEL_21;
...
LABEL_21:
  ...
  if ( !v32 )
  {
    ...
    v32 = (System_Comparison_T__o *)sub_1B9025C(System_Comparison_EventScriptEntity__TypeInfo);
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->__9__6_0, (int32_t)v32, v35, v36);
  }
  if ( !v23 )
    goto LABEL_39;
  System_Collections_Generic_List_object___Sort_55649412(
  ...
  list = (int64_t)System_Collections_Generic_List_object___get_Item(
                    v23,
                    v23->fields._size - 1,
                    (const MethodInfo_35106F0 *)Method_System_Collections_Generic_List_EventScriptEntity__get_Item__);
  if ( !list )
    goto LABEL_39;
  v37 = *(_DWORD *)(list + 40);
...
void __fastcall EventScriptMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFA4 & 1) == 0 )
  {
    sub_1B90010(&EventScriptMaster___c_TypeInfo, v1);
    byte_4A6FFA4 = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(EventScriptMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventScriptMaster___c_TypeInfo->static_fields->__9 = (struct EventScriptMaster___c_o *)v2;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)EventScriptMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
