        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BF22 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveConfirmListViewItemDraw___, method);
    byte_4A0BF22 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  v7 = lineDisp;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.messageText, (int32_t)message, giftId, lineDisp);
