        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3122A & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveConfirmListViewItemDraw___, method);
    byte_4A3122A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  v7 = lineDisp;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.messageText, (int32_t)message, giftId, lineDisp);
