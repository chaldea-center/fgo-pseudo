        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8E69 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveConfirmListViewItemDraw___, method);
    byte_4AB8E69 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveConfirmListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  v7 = lineDisp;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.messageText, (int32_t)message, giftId, lineDisp);
