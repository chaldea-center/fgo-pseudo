...
void __fastcall BattleCharaChangeConfirmDialog__Close(BattleCharaChangeConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A12D & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_BattleCharaChangeConfirmDialog_EndClose__, v3);
    byte_4A4A12D = 1;
  }
...
void __fastcall BattleCharaChangeConfirmDialog__Init(BattleCharaChangeConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A12B & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_3679/*"COMMON_CONFIRM_NO"*/, v3);
    sub_1B863B8(&StringLiteral_3684/*"COMMON_CONFIRM_YES"*/, v4);
  ...
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3684/*"COMMON_CONFIRM_YES"*/, 0LL);
  if ( !buttonDecideLabel
    || (UILabel__set_text(buttonDecideLabel, (System_String_o *)messageLabel, 0LL),
        buttonCancelLabel = this->fields.buttonCancelLabel,
        messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3679/*"COMMON_CONFIRM_NO"*/, 0LL),
        !buttonCancelLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A12F & 1) == 0 )
  {
    sub_1B863B8(&Method_BattleCharaChangeConfirmDialog_OnClickCancel__, method);
    byte_4A4A12F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_BattleCharaChangeConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_BattleCharaChangeConfirmDialog_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A12E & 1) == 0 )
  {
    sub_1B863B8(&Method_BattleCharaChangeConfirmDialog_OnClickDecide__, method);
    byte_4A4A12E = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_BattleCharaChangeConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_BattleCharaChangeConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A12C & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_BattleCharaChangeConfirmDialog_EndOpen__, v7);
    sub_1B863B8(&LocalizationManager_TypeInfo, v8);
    sub_1B863B8(&StringLiteral_11693/*"SERVANT_STATUS_BATTLE_CHANGE_CONFIRM_MESSAGE_ADD"*/, v9);
    byte_4A4A12C = 1;
  }
  this->fields.clickFunc = func;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, (int32_t)itemInfo, method);
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  listViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_11693/*"SERVANT_STATUS_BATTLE_CHANGE_CONFIRM_MESSAGE_ADD"*/, 0LL);
  if ( !messageLabel )
    goto LABEL_10;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CCD74;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CCD2C;
}
