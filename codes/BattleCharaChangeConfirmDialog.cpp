...
void BattleCharaChangeConfirmDialog__Close(BattleCharaChangeConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2277E & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_BattleCharaChangeConfirmDialog_EndClose__);
    byte_4C2277E = 1;
  }
...
void BattleCharaChangeConfirmDialog__Init(BattleCharaChangeConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3686/*"COMMON_CONFIRM_YES"*/, 0);
  if ( !buttonDecideLabel
    || (UILabel__set_text(buttonDecideLabel, (System_String_o *)messageLabel, 0),
        buttonCancelLabel = this->fields.buttonCancelLabel,
        messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3681/*"COMMON_CONFIRM_NO"*/, 0),
        !buttonCancelLabel)
...
void BattleCharaChangeConfirmDialog__OnClickCancel(BattleCharaChangeConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22780 & 1) == 0 )
  {
    sub_1C2D490(&Method_BattleCharaChangeConfirmDialog_OnClickCancel__);
    byte_4C22780 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_BattleCharaChangeConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_BattleCharaChangeConfirmDialog_OnClickCancel__);
...
void BattleCharaChangeConfirmDialog__OnClickDecide(BattleCharaChangeConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2277F & 1) == 0 )
  {
    sub_1C2D490(&Method_BattleCharaChangeConfirmDialog_OnClickDecide__);
    byte_4C2277F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_BattleCharaChangeConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_BattleCharaChangeConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_BattleCharaChangeConfirmDialog_EndOpen__);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&StringLiteral_11891/*"SERVANT_STATUS_BATTLE_CHANGE_CONFIRM_MESSAGE_ADD"*/);
    byte_4C2277D = 1;
  }
  this->fields.clickFunc = func;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.clickFunc, (int32_t)func, (int32_t)itemInfo, method);
  messageLabel = this->fields.messageLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  listViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_11891/*"SERVANT_STATUS_BATTLE_CHANGE_CONFIRM_MESSAGE_ADD"*/, 0);
  if ( !messageLabel )
    goto LABEL_10;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A6AFFC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A6AFB4;
}
