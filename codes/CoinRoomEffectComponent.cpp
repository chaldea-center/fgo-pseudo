void CoinRoomEffectComponent___ctor(CoinRoomEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46C50 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_16852/*"ar154"*/);
    sub_1C37058(&StringLiteral_1/*""*/);
    byte_4C46C50 = 1;
  }
  v5 = StringLiteral_16852/*"ar154"*/;
  this->fields.arrivedPlaySeName = (struct System_String_o *)StringLiteral_16852/*"ar154"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.arrivedPlaySeName, v5, v2, v3);
  *(_QWORD *)&this->fields.arrivedPlaySeIntervalTime = 0x3E83D4CCCCDLL;
  this->fields.TARGET_ITEM_ID = 7999;
  v6 = (System_Collections_Generic_Dictionary_int__object__o *)sub_1C372A4(System_Collections_Generic_Dictionary_int__SelectedUserSvtCoin__TypeInfo);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.selectedCoinDic, (int32_t)v6, v7, v8);
  v9 = StringLiteral_1/*""*/;
  this->fields.stateName = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.stateName, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C46C4D & 1) == 0 )
  {
    this = (CoinRoomEffectComponent_o *)sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___);
    byte_4C46C4D = 1;
  }
  if ( !targetObject
    || (this = (CoinRoomEffectComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                              targetObject,
                                              (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_ParticleSystem___)) == 0 )
  {
    sub_1C372B4(this);
  }
...
void CoinRoomEffectComponent__NextAcquiredEffect(CoinRoomEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46C4E & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_CoinRoomEffectComponent___c__DisplayClass27_0__NextAcquiredEffect_b__0__);
    sub_1C37058(&CoinRoomEffectComponent___c__DisplayClass27_0_TypeInfo);
    byte_4C46C4E = 1;
  }
  v3 = sub_1C372A4(CoinRoomEffectComponent___c__DisplayClass27_0_TypeInfo);
  ...
  *(_QWORD *)(v3 + 16) = this;
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( acquiredEffect )
    {
      ...
      {
        UnityEngine_GameObject__SetActive(acquiredEffect, 1, 0);
        v7 = (QuestRewardInfo_o *)sub_1C372A4(QuestRewardInfo_TypeInfo);
        QuestRewardInfo___ctor(v7, 0);
        *(_QWORD *)(v3 + 24) = v7;
        sub_1C36FFC((CGThumbnailListItem_o *)(v3 + 24), (int32_t)v7, v8, v9);
        v10 = *(_DWORD **)(v3 + 24);
        if ( v10 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46C4B & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__GetEntity__);
    sub_1C37058(&NetworkManager_TypeInfo);
    sub_1C37058(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C37058(&SoundManager_TypeInfo);
    sub_1C37058(&UserCoinRoomEntity_TypeInfo);
    sub_1C37058(&StringLiteral_18932/*"effect_Circle_act2"*/);
    sub_1C37058(&StringLiteral_18931/*"effect_Circle_act1"*/);
    byte_4C46C4B = 1;
  }
  this->fields.state = 1;
  if ( !beforeUserCoinRoomEntity )
  {
    beforeUserCoinRoomEntity = (UserCoinRoomEntity_o *)sub_1C372A4(UserCoinRoomEntity_TypeInfo);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.selectedCoinDic, (int32_t)selectedCoinDic, v7, v8);
  ...
  if ( !MasterData_object
    || (Entity = DataMasterBase_object__object__long___GetEntity(
                   ...
                   *(_QWORD *)(*(_QWORD *)&Instance[1].fields._DispLog + 64LL),
                   (const MethodInfo_33A35FC *)Method_DataMasterBase_UserCoinRoomMaster__UserCoinRoomEntity__long__GetEntity__),
        this->fields.afterEntity = (struct UserCoinRoomEntity_o *)Entity,
        sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.afterEntity, (int32_t)Entity, v12, v13),
...
LABEL_20:
  ...
  if ( cnt )
    v18 = &StringLiteral_18931/*"effect_Circle_act1"*/;
  else
    v18 = &StringLiteral_18932/*"effect_Circle_act2"*/;
  v19 = (struct System_String_o *)*v18;
  this->fields.stateName = (struct System_String_o *)*v18;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.stateName, (int32_t)v19, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46C4F & 1) == 0 )
  {
    sub_1C37058(&CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_TypeInfo);
    byte_4C46C4F = 1;
  }
  v5 = sub_1C372A4(CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_TypeInfo);
...
void CoinRoomEffectComponent__StartPutInAnimation(CoinRoomEffectComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_CoinRoomEffectComponent_NextAcquiredEffect__);
    ...
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_CoinRoomControlEffect___);
    ...
    sub_1C37058(&Method_CoinRoomEffectComponent___c__StartPutInAnimation_b__25_0__);
    sub_1C37058(&CoinRoomEffectComponent___c_TypeInfo);
    byte_4C46C4C = 1;
  }
  m_ParticleSystem = 0;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.endCallBack, (int32_t)v3, v4, v5);
  ...
  if ( !_9__25_0 )
  {
    ...
    _9__25_0 = (System_Func_T__TResult__o *)sub_1C372A4(System_Func_KeyValuePair_int__SelectedUserSvtCoin___int__TypeInfo);
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->__9__25_0, (int32_t)_9__25_0, v13, v14);
  }
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.circleAnimation, (int32_t)Component_object, v19, v20);
  ...
  coinListPanel = (UnityEngine_GameObject_o *)UnityEngine_MonoBehaviour__StartCoroutine_71252324(
  ...
  coinListPanel = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                coinListPanel,
                                                (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomControlEffect___);
...
LABEL_31:
  ...
  SimpleAnimation__Play_66507412((SimpleAnimation_o *)coinListPanel, this->fields.stateName, 0);
}
...
void CoinRoomEffectComponent__Update(CoinRoomEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46C4A & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_CoinRoomEffectComponent__Update_b__23_0__);
    sub_1C37058(&CoinRoomUtility_TypeInfo);
    sub_1C37058(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
...
LABEL_26:
  ...
  {
LABEL_11:
    v8 = sub_1C87870(circleAnimation, SimpleAnimation_State_TypeInfo, 5);
  }
  if ( (*(float (__fastcall **)(SimpleAnimation_o *, _QWORD))v8)(v5, *(_QWORD *)(v8 + 8)) >= 0.95 )
  {
    ...
    else
    {
      ...
      sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.endCallBack, 0, v9, v10);
      ...
      circleAnimation = (SimpleAnimation_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      if ( circleAnimation )
      {
...
void CoinRoomEffectComponent___Update_b__23_0(CoinRoomEffectComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&CoinRoomUtility_TypeInfo);
    this = (CoinRoomEffectComponent_o *)sub_1C37058(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C46C51 = 1;
  }
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v2->fields.endCallBack, 0, v4, v5);
  v2->fields.isEffectEnd = 0;
  this = (CoinRoomEffectComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v6 = (CommonUI_o *)this;
  if ( !CoinRoomUtility_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CoinRoomUtility_TypeInfo);
  if ( !v6 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46D58 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_CoinRoomGaugeEffectComponent___);
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___);
    sub_1C37058(&Method_CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_MoveNext__);
    this = (CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_o *)sub_1C37058(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4C46D58 = 1;
  }
  m_ParticleSystem = 0;
  ...
  switch ( v4->fields.__1__state )
  {
    case 0:
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           (UnityEngine_GameObject_o *)this,
                           (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_CoinRoomGaugeEffectComponent___);
      v4->fields._gaugeEffectComponent_5__6 = (struct CoinRoomGaugeEffectComponent_o *)Component_object;
      sub_1C36FFC((CGThumbnailListItem_o *)&v4->fields._gaugeEffectComponent_5__6, (int32_t)Component_object, v14, v15);
LABEL_12:
      this = (CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_o *)_4__this->fields.coinPartObject;
      if ( !this )
        goto LABEL_32;
...
LABEL_17:
      ...
      if ( (*((_BYTE *)Method_CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_MoveNext__ + 83) & 2) != 0 )
        v31 = (_QWORD *)sub_1C37070(Method_CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_MoveNext__);
      this = (CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_o *)sub_1C3703C(v31, v31[4]);
      if ( !_4__this )
        goto LABEL_32;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_CoinRoomEffectComponent__PlayCoinArrivedSE_d__28_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
...
void CoinRoomEffectComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C372A4(CoinRoomEffectComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  CoinRoomEffectComponent___c_TypeInfo->static_fields->__9 = (struct CoinRoomEffectComponent___c_o *)v1;
  sub_1C36FFC((CGThumbnailListItem_o *)CoinRoomEffectComponent___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46D55 & 1) == 0 )
  {
    this = (CoinRoomEffectComponent___c_o *)sub_1C37058(&Method_System_Collections_Generic_KeyValuePair_int__SelectedUserSvtCoin__get_Value__);
    byte_4C46D55 = 1;
  }
  if ( !value )
    sub_1C372B4(this);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46D57 & 1) == 0 )
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C37058(&Method_CoinRoomEffectComponent___c__NextAcquiredEffect_b__27_1__);
    this = (CoinRoomEffectComponent___c__DisplayClass27_0_o *)sub_1C37058(&CoinRoomEffectComponent___c_TypeInfo);
    byte_4C46D57 = 1;
  }
  ...
  this = (CoinRoomEffectComponent___c__DisplayClass27_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  ...
  if ( !_9__27_1 )
  {
    ...
    _9__27_1 = (System_Action_o *)sub_1C372A4(System_Action_TypeInfo);
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->__9__27_1, (int32_t)_9__27_1, v12, v13);
  }
  if ( !v5 )
LABEL_15:
    sub_1C372B4(this);
