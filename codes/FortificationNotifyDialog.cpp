...
void FortificationNotifyDialog__ClickButtonAction(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C216DA & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_FortificationNotifyDialog__ClickButtonAction_b__13_0__);
    byte_4C216DA = 1;
  }
...
void FortificationNotifyDialog__OnClickCancel(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C216D9 & 1) == 0 )
  {
    sub_1C2D490(&Method_FortificationNotifyDialog_OnClickCancel__);
    byte_4C216D9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationNotifyDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_FortificationNotifyDialog_OnClickCancel__);
...
void FortificationNotifyDialog__OnClickDecide(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C216D8 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_FortificationNotifyDialog_OnClickDecide__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationNotifyDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_FortificationNotifyDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&System_Action_TypeInfo);
    sub_1C2D490(&Method_FortificationNotifyDialog__Open_b__9_0__);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( !decideButtonLb
      || (UILabel__set_text(decideButtonLb, (System_String_o *)descriptionLb, 0),
          ...
          descriptionLb = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3678/*"COMMON_CONFIRM_CLOSE"*/, 0),
          !cancelButtonLb) )
    {
LABEL_10:
      sub_1C2D6EC(descriptionLb, v7);
    }
