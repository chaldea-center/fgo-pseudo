        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B169DC & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_FortificationNotifyDialog__ClickButtonAction_b__13_0__, v3);
    byte_4B169DC = 1;
  }
...
void __fastcall FortificationNotifyDialog__OnClickCancel(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B169DB & 1) == 0 )
  {
    sub_1BCAFF8(&Method_FortificationNotifyDialog_OnClickCancel__, method);
    byte_4B169DB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationNotifyDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_FortificationNotifyDialog_OnClickCancel__);
...
void __fastcall FortificationNotifyDialog__OnClickDecide(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B169DA & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_FortificationNotifyDialog_OnClickDecide__, v4);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationNotifyDialog_OnClickDecide__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1BCB010(Method_FortificationNotifyDialog_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B169D9 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_FortificationNotifyDialog__Open_b__9_0__, v7);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v8);
    sub_1BCAFF8(&StringLiteral_6443/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, v9);
    sub_1BCAFF8(&StringLiteral_3650/*"COMMON_CONFIRM_CLOSE"*/, v10);
    byte_4B169D9 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    descriptionLb = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6443/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, 0LL);
    if ( !decideButtonLb
      || (UILabel__set_text(decideButtonLb, (System_String_o *)descriptionLb, 0LL),
          cancelButtonLb = this->fields.cancelButtonLb,
          descriptionLb = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3650/*"COMMON_CONFIRM_CLOSE"*/, 0LL),
          !cancelButtonLb) )
    {
LABEL_10:
      sub_1BCB254(descriptionLb, v11);
    }
