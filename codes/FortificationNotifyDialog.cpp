...
void FortificationNotifyDialog__ClickButtonAction(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC175E & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_FortificationNotifyDialog__ClickButtonAction_b__13_0__);
    byte_4CC175E = 1;
  }
  ...
  if ( onClick )
  {
    ...
    sub_1C71354(&this->fields.onClick, 0);
...
void FortificationNotifyDialog__OnClickCancel(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC175D & 1) == 0 )
  {
    sub_1C713B0(&Method_FortificationNotifyDialog_OnClickCancel__);
    byte_4CC175D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationNotifyDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_FortificationNotifyDialog_OnClickCancel__);
...
void FortificationNotifyDialog__OnClickDecide(FortificationNotifyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC175C & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_FortificationNotifyDialog_OnClickDecide__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FortificationNotifyDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_FortificationNotifyDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_FortificationNotifyDialog__Open_b__9_0__);
  ...
  if ( !this->fields.state )
  {
    ...
    descriptionLb = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6486/*"FORTIFICATION_EXPANSION_DIALOG_DECIDE"*/, 0);
    if ( !decideButtonLb
      || (UILabel__set_text(decideButtonLb, (System_String_o *)descriptionLb, 0),
          cancelButtonLb = this->fields.cancelButtonLb,
          descriptionLb = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/, 0),
          !cancelButtonLb) )
    {
LABEL_10:
      sub_1C71608(descriptionLb, v7);
    }
