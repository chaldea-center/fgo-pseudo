void __fastcall EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BF19D & 1) == 0 )
  {
    sub_1B4CF90(&EventRankingRoundInfo_TypeInfo, v1);
    sub_1B4CF90(&StringLiteral_17161/*"btn_bg_20"*/, v4);
    sub_1B4CF90(&StringLiteral_17162/*"btn_bg_21"*/, v5);
    byte_49BF19D = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17162/*"btn_bg_21"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)EventRankingRoundInfo_TypeInfo->static_fields, StringLiteral_17162/*"btn_bg_21"*/, v2, v3);
  v6 = StringLiteral_17161/*"btn_bg_20"*/;
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17161/*"btn_bg_20"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&static_fields->NON_SELECT_SPRITE_NAME, v6, v8, v9);
}
...
void __fastcall EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BF19C & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1B4CF90(&Method_EventRankingRoundInfo_OnClikcButton__, method);
    byte_49BF19C = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B4CFA8(Method_EventRankingRoundInfo_OnClikcButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)p_onClickFunc, (int32_t)callback, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF19B & 1) == 0 )
  {
    sub_1B4CF90(&EventRankingRoundInfo_TypeInfo, isSelect);
    byte_49BF19B = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A1628;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A15E0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF19E & 1) == 0 )
  {
    sub_1B4CF90(&int_TypeInfo, *(_QWORD *)&num);
    byte_49BF19E = 1;
  }
  v9[1] = 0LL;
