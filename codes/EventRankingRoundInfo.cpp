void __fastcall EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B16BE3 & 1) == 0 )
  {
    sub_1BCAFF8(&EventRankingRoundInfo_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_17307/*"btn_bg_20"*/, v2);
    sub_1BCAFF8(&StringLiteral_17308/*"btn_bg_21"*/, v3);
    byte_4B16BE3 = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17308/*"btn_bg_21"*/;
  sub_1BCAF9C(EventRankingRoundInfo_TypeInfo->static_fields);
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17307/*"btn_bg_20"*/;
  sub_1BCAF9C(&static_fields->NON_SELECT_SPRITE_NAME);
}
...
void __fastcall EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B16BE2 & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1BCAFF8(&Method_EventRankingRoundInfo_OnClikcButton__, method);
    byte_4B16BE2 = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_EventRankingRoundInfo_OnClikcButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16BE1 & 1) == 0 )
  {
    sub_1BCAFF8(&EventRankingRoundInfo_TypeInfo, isSelect);
    byte_4B16BE1 = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0CDC8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0CD80;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16BE4 & 1) == 0 )
  {
    sub_1BCAFF8(&int_TypeInfo, *(_QWORD *)&num);
    byte_4B16BE4 = 1;
  }
  v9[1] = 0LL;
