void __fastcall EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C26255 & 1) == 0 )
  {
    sub_1C3B764(&EventRankingRoundInfo_TypeInfo, v1);
    sub_1C3B764(&StringLiteral_17813/*"commandCodeId"*/, v8);
    sub_1C3B764(&StringLiteral_17814/*"commandSpell/use"*/, v9);
    byte_4C26255 = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17814/*"commandSpell/use"*/;
  sub_1C3B708(
    (PartyOrganizationUtility_o *)EventRankingRoundInfo_TypeInfo->static_fields,
    StringLiteral_17814/*"commandSpell/use"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v10 = StringLiteral_17813/*"commandCodeId"*/;
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17813/*"commandCodeId"*/;
  sub_1C3B708((PartyOrganizationUtility_o *)&static_fields->NON_SELECT_SPRITE_NAME, v10, v12, v13, v14, v15, v16, v17);
}
...
void __fastcall EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C26254 & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1C3B764(&Method_EventRankingRoundInfo_OnClikcButton__, method);
    byte_4C26254 = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_EventRankingRoundInfo_OnClikcButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)p_onClickFunc, (int64_t)callback, v14, v15, v16, v17, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26253 & 1) == 0 )
  {
    sub_1C3B764(&EventRankingRoundInfo_TypeInfo, isSelect);
    byte_4C26253 = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A81864;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A8181C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26256 & 1) == 0 )
  {
    sub_1C3B764(&int_TypeInfo, *(_QWORD *)&num);
    byte_4C26256 = 1;
  }
  v9[1] = 0LL;
