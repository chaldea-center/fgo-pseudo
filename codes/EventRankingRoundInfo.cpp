void EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB0863 & 1) == 0 )
  {
    sub_1C6BA08(&EventRankingRoundInfo_TypeInfo);
    sub_1C6BA08(&StringLiteral_17462/*"btn_bg_20"*/);
    sub_1C6BA08(&StringLiteral_17463/*"btn_bg_21"*/);
    byte_4CB0863 = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17463/*"btn_bg_21"*/;
  sub_1C6B9AC(EventRankingRoundInfo_TypeInfo->static_fields, StringLiteral_17463/*"btn_bg_21"*/);
  v1 = StringLiteral_17462/*"btn_bg_20"*/;
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17462/*"btn_bg_20"*/;
  sub_1C6B9AC(&static_fields->NON_SELECT_SPRITE_NAME, v1);
}
...
void EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0862 & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1C6BA08(&Method_EventRankingRoundInfo_OnClikcButton__);
    byte_4CB0862 = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_EventRankingRoundInfo_OnClikcButton__);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A98EF4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A98EAC;
}
