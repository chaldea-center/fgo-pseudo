void __fastcall EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5F13C & 1) == 0 )
  {
    sub_1B885B0(&EventRankingRoundInfo_TypeInfo);
    sub_1B885B0(&StringLiteral_17479/*"btn_bg_20"*/);
    sub_1B885B0(&StringLiteral_17480/*"btn_bg_21"*/);
    byte_4A5F13C = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17480/*"btn_bg_21"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)EventRankingRoundInfo_TypeInfo->static_fields,
    StringLiteral_17480/*"btn_bg_21"*/,
    v1,
    v2);
  v3 = StringLiteral_17479/*"btn_bg_20"*/;
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17479/*"btn_bg_20"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->NON_SELECT_SPRITE_NAME, v3, v5, v6);
}
...
void __fastcall EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5F13B & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1B885B0(&Method_EventRankingRoundInfo_OnClikcButton__);
    byte_4A5F13B = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_EventRankingRoundInfo_OnClikcButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_onClickFunc, (int32_t)callback, v14, v15);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D3A60;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D3A18;
}
