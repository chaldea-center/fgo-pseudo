void __fastcall EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A00350 & 1) == 0 )
  {
    sub_1B640C8(&EventRankingRoundInfo_TypeInfo, v1);
    sub_1B640C8(&StringLiteral_17409/*"btn_bg_20"*/, v4);
    sub_1B640C8(&StringLiteral_17410/*"btn_bg_21"*/, v5);
    byte_4A00350 = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17410/*"btn_bg_21"*/;
  sub_1B6406C(
    (ServantStatusBattleListViewItem_o *)EventRankingRoundInfo_TypeInfo->static_fields,
    StringLiteral_17410/*"btn_bg_21"*/,
    v2,
    v3);
  v6 = StringLiteral_17409/*"btn_bg_20"*/;
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17409/*"btn_bg_20"*/;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->NON_SELECT_SPRITE_NAME, v6, v8, v9);
}
...
void __fastcall EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0034F & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1B640C8(&Method_EventRankingRoundInfo_OnClikcButton__, method);
    byte_4A0034F = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_EventRankingRoundInfo_OnClikcButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_onClickFunc, (int32_t)callback, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0034E & 1) == 0 )
  {
    sub_1B640C8(&EventRankingRoundInfo_TypeInfo, isSelect);
    byte_4A0034E = 1;
  }
  ...
  v13.fields.b = b;
  v13.fields.a = a;
  UILabel__set_effectColor((UILabel_o *)gameObject, v13, 0LL);
...
LABEL_13:
  ...
  if ( !isSelect )
    ++v12;
  UISprite__set_spriteName(roundSprite, *v12, 0LL);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B11E8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B11A0;
}
