void __fastcall EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E6649 & 1) == 0 )
  {
    sub_1B00CCC(&EventRankingRoundInfo_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_17241/*"btn_bg_20"*/, v4);
    sub_1B00CCC(&StringLiteral_17242/*"btn_bg_21"*/, v5);
    byte_48E6649 = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17242/*"btn_bg_21"*/;
  sub_1B00C70(
    (ServantStatusBattleListViewItem_o *)EventRankingRoundInfo_TypeInfo->static_fields,
    StringLiteral_17242/*"btn_bg_21"*/,
    v2,
    v3);
  v6 = StringLiteral_17241/*"btn_bg_20"*/;
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17241/*"btn_bg_20"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->NON_SELECT_SPRITE_NAME, v6, v8, v9);
}
...
void __fastcall EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E6648 & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1B00CCC(&Method_EventRankingRoundInfo_OnClikcButton__, method);
    byte_48E6648 = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B00CE4(Method_EventRankingRoundInfo_OnClikcButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)p_onClickFunc, (int32_t)callback, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E6647 & 1) == 0 )
  {
    sub_1B00CCC(&EventRankingRoundInfo_TypeInfo, isSelect);
    byte_48E6647 = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19502A4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_195025C;
}
