void EventRankingRoundInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4DFEE20 & 1) == 0 )
  {
    sub_1CE6700(&EventRankingRoundInfo_TypeInfo);
    sub_1CE6700(&StringLiteral_17633/*"btn_bg_20"*/);
    sub_1CE6700(&StringLiteral_17635/*"btn_bg_21"*/);
    byte_4DFEE20 = 1;
  }
  EventRankingRoundInfo_TypeInfo->static_fields->SELECTED_SPRITE_NAME = (struct System_String_o *)StringLiteral_17635/*"btn_bg_21"*/;
  sub_1CE66A4(EventRankingRoundInfo_TypeInfo->static_fields, StringLiteral_17635/*"btn_bg_21"*/);
  v1 = StringLiteral_17633/*"btn_bg_20"*/;
  static_fields = EventRankingRoundInfo_TypeInfo->static_fields;
  static_fields->NON_SELECT_SPRITE_NAME = (struct System_String_o *)StringLiteral_17633/*"btn_bg_20"*/;
  sub_1CE66A4(&static_fields->NON_SELECT_SPRITE_NAME, v1);
}
...
void EventRankingRoundInfo__OnClikcButton(EventRankingRoundInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEE1F & 1) == 0 )
  {
    this = (EventRankingRoundInfo_o *)sub_1CE6700(&Method_EventRankingRoundInfo_OnClikcButton__);
    byte_4DFEE1F = 1;
  }
  if ( v2->fields.isSelect )
  {
    ...
    if ( (*((_BYTE *)Method_EventRankingRoundInfo_OnClikcButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_EventRankingRoundInfo_OnClikcButton__);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B0E860;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B0E818;
}
