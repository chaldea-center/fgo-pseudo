void FriendPointNoticeDialogSvtInfo___cctor(const MethodInfo *method)
{
  if ( (byte_4C595C0 & 1) == 0 )
  {
    sub_1C3E564(&FriendPointNoticeDialogSvtInfo_TypeInfo);
    byte_4C595C0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  IconLabelInfo_o *v40; // x23
  bool v41; // w8
  ServantOverwriteStatus_o *OverwriteStatus; // x0
  int32_t lv; // w21
  ServantOverwriteStatus_o *v44; // x20
  int32_t v46; // [xsp+64h] [xbp-7Ch] BYREF
  ServantLimitEntity_o *v47; // [xsp+68h] [xbp-78h] BYREF
  int32_t v48; // [xsp+74h] [xbp-6Ch] BYREF
  ...
  if ( (byte_4C595BE & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_6954/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/);
    sub_1C3E564(&StringLiteral_25601/*"４"*/);
    sub_1C3E564(&StringLiteral_25600/*"３"*/);
    sub_1C3E564(&StringLiteral_25598/*"１"*/);
    sub_1C3E564(&StringLiteral_1403/*"4"*/);
    sub_1C3E564(&StringLiteral_25602/*"５"*/);
    sub_1C3E564(&StringLiteral_6945/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/);
    sub_1C3E564(&StringLiteral_6953/*"GET_FRIEND_POINT_SERVANT_NAME"*/);
    sub_1C3E564(&StringLiteral_25599/*"２"*/);
  ...
  v13 = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v14 = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_ServantExceedMaster___);
  if ( svtId < 1 )
    goto LABEL_47;
  ...
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_6945/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/, 0);
  friendPointLabel = this->fields.friendPointLabel;
  v46 = friendPoint;
  v26 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v46, v20, v21, v22, v23, v24, v25);
  questLabel = System_String__Format(v18, v26, 0);
  if ( !friendPointLabel )
    goto LABEL_55;
...
LABEL_47:
  ...
  v27 = (UserServantEntity_o *)questLabel;
  v28 = usrSvtId < 1 || questLabel == 0;
  if ( v28 )
  {
    if ( !v16 )
      goto LABEL_55;
  ...
  if ( !v48 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    questLabel = LocalizationManager__Get((System_String_o *)StringLiteral_6954/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/, 0);
    if ( entity )
    {
      v36 = (System_String_o *)questLabel;
      ClassName = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0);
      questLabel = System_String__Format_63677760(v36, ServantShortName, ClassName, 0);
      if ( supportServantNameLabel )
        goto LABEL_33;
    }
LABEL_55:
    sub_1C3E7C0(questLabel, v15);
  }
  questLabel = System_Int32__ToString((int32_t)&v48, 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_63683016(
                 (System_String_o *)questLabel,
                 (System_String_o *)StringLiteral_1172/*"1"*/,
                 (System_String_o *)StringLiteral_25598/*"１"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_63683016(
                 ...
                 (System_String_o *)StringLiteral_25599/*"２"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_63683016(
                 ...
                 (System_String_o *)StringLiteral_25600/*"３"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_63683016(
                 ...
                 (System_String_o *)StringLiteral_25601/*"４"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  v31 = System_String__Replace_63683016(
          (System_String_o *)questLabel,
          (System_String_o *)StringLiteral_1420/*"5"*/,
          (System_String_o *)StringLiteral_25602/*"５"*/,
          0);
  supportServantNameLabel = this->fields.supportServantNameLabel;
  v33 = (Il2CppObject *)v31;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  questLabel = LocalizationManager__Get((System_String_o *)StringLiteral_6953/*"GET_FRIEND_POINT_SERVANT_NAME"*/, 0);
  if ( !entity )
    goto LABEL_55;
  v34 = (System_String_o *)questLabel;
  v35 = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0);
  questLabel = System_String__Format_63677828(v34, v33, ServantShortName, v35, 0);
  if ( !supportServantNameLabel )
    goto LABEL_55;
LABEL_33:
  UILabel__set_text(supportServantNameLabel, (System_String_o *)questLabel, 0);
  v38 = this->fields.supportServantNameLabel;
  ...
  if ( !UnityEngine_Object__op_Inequality(supportServantFaceIcon, 0, 0) )
    goto LABEL_47;
  v40 = (IconLabelInfo_o *)sub_1C3E7B0(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v40, 0);
  if ( !v28 )
  {
    OverwriteStatus = UserServantEntity__GetOverwriteStatus(v27, 0, 0);
    lv = v27->fields.lv;
    v44 = OverwriteStatus;
    questLabel = (void *)UserServantEntity__getLevelMax(v27, 0);
    if ( !v40 )
      goto LABEL_55;
    IconLabelInfo__Set_40964356(v40, 2, lv, (int32_t)questLabel, 0, 0, 0, 0, 0, 0);
    questLabel = this->fields.supportServantFaceIcon;
    if ( !questLabel )
      goto LABEL_55;
    ServantFaceIconComponent__Set((ServantFaceIconComponent_o *)questLabel, v27, 0, 0, 0, 0, 0, 1, 0, 0);
    if ( !v44 )
      goto LABEL_55;
    ...
    UIIconLabel__Set_41158744(
      ...
      36,
      v44->fields._Rarity_k__BackingField,
      0,
      0,
      0,
      0,
      0,
      0,
      v44->fields._ActualRarity_k__BackingField,
      0);
    goto LABEL_54;
  }
  if ( !v13 )
    goto LABEL_55;
  v41 = ServantLimitMaster__TryGetEntity((ServantLimitMaster_o *)v13, &v47, svtId, 0, 0);
  questLabel = 0;
  if ( v41 )
  {
    if ( !v47 )
    ...
    if ( !v40 )
      goto LABEL_55;
    IconLabelInfo__Set_40964356(v40, 2, 1, v47->fields.lvMax, 0, 0, 0, 0, 0, 0);
    questLabel = this->fields.supportServantFaceIcon;
    if ( !questLabel )
      goto LABEL_55;
    ...
    if ( !questLabel )
      goto LABEL_55;
    UIIconLabel__Set_41158744((UIIconLabel_o *)questLabel, 36, v48, 0, 0, 0, 0, 0, 0, 0, 0);
LABEL_54:
    LOBYTE(questLabel) = 1;
  }
  return (char)questLabel;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E7C0(supportServantFaceIcon, bitmapFont);
  }
        ...
        const MethodInfo *method)
{
  ...
  supportServantNameLabel = this->fields.supportServantNameLabel;
  if ( !supportServantNameLabel
    || (UILabel__SetCondensedScale_49599236(supportServantNameLabel, maxWidth, 0.0, 0),
        (supportServantNameLabel = this->fields.questLabel) == 0)
    || (UILabel__SetCondensedScale_49599236(supportServantNameLabel, maxWidth, 0.0, 0),
        (supportServantNameLabel = this->fields.friendPointLabel) == 0) )
  {
    sub_1C3E7C0(supportServantNameLabel, method);
  }
  UILabel__SetCondensedScale_49599236(supportServantNameLabel, maxWidth, 0.0, 0);
}