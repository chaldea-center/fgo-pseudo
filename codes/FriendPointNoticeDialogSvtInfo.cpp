void __fastcall FriendPointNoticeDialogSvtInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A006F4 & 1) == 0 )
  {
    sub_1B64870(&FriendPointNoticeDialogSvtInfo_TypeInfo, v1);
    byte_4A006F4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A006F2 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_ServantExceedMaster___, *(_QWORD *)&svtId);
    sub_1B64870(&Method_DataManager_GetMaster_ServantLimitMaster___, v11);
    sub_1B64870(&Method_DataManager_GetMaster_ServantMaster___, v12);
    sub_1B64870(&Method_DataManager_GetMaster_UserServantMaster___, v13);
    ...
    sub_1B64870(&Method_DataMasterBase_ServantMaster__ServantEntity__int__TryGetEntity__, v16);
    sub_1B64870(&FriendPointNoticeDialogSvtInfo_TypeInfo, v17);
    ...
    sub_1B64870(&StringLiteral_1476/*"3"*/, v22);
    sub_1B64870(&StringLiteral_1414/*"2"*/, v23);
    sub_1B64870(&StringLiteral_6885/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/, v24);
    sub_1B64870(&StringLiteral_25365/*"４"*/, v25);
    sub_1B64870(&StringLiteral_25364/*"３"*/, v26);
    sub_1B64870(&StringLiteral_25362/*"１"*/, v27);
    sub_1B64870(&StringLiteral_1494/*"4"*/, v28);
    sub_1B64870(&StringLiteral_25366/*"５"*/, v29);
    sub_1B64870(&StringLiteral_6876/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/, v30);
    sub_1B64870(&StringLiteral_6884/*"GET_FRIEND_POINT_SERVANT_NAME"*/, v31);
    sub_1B64870(&StringLiteral_25363/*"２"*/, v32);
    sub_1B64870(&StringLiteral_1267/*"1"*/, v33);
    sub_1B64870(&StringLiteral_1509/*"5"*/, v34);
    byte_4A006F2 = 1;
  }
  entity = 0LL;
  data = 0;
  ...
  v36 = DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_UserServantMaster___);
  v37 = DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v38 = DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  if ( svtId < 1 )
    goto LABEL_45;
...
LABEL_45:
  ...
  if ( !data )
  {
    ...
    if ( entity )
    {
      ...
      questLabel = (UILabel_o *)System_String__Format_61397948(v57, ServantShortName, ClassName, 0LL);
      if ( supportServantNameLabel )
        goto LABEL_32;
    }
LABEL_52:
    sub_1B64ACC(questLabel, v39);
  }
  questLabel = (UILabel_o *)System_Int32__ToString((int32_t)&data, 0LL);
  if ( !questLabel )
    goto LABEL_52;
  questLabel = (UILabel_o *)System_String__Replace_61403196(
  ...
  if ( !questLabel )
    goto LABEL_52;
  v52 = System_String__Replace_61403196(
          (System_String_o *)questLabel,
  ...
  questLabel = (UILabel_o *)System_String__Format_61398016(v55, v54, ServantShortName, v56, 0LL);
  if ( !supportServantNameLabel )
    goto LABEL_52;
LABEL_32:
  ...
  if ( !UnityEngine_Object__op_Inequality(supportServantFaceIcon, 0LL, 0LL) )
    goto LABEL_45;
  v61 = (IconLabelInfo_o *)sub_1B64ABC(IconLabelInfo_TypeInfo);
  ...
  if ( v49 )
  {
    ...
    if ( !v61 )
      goto LABEL_52;
    IconLabelInfo__Set_37829740(v61, 2, 1, v66->fields.lvMax, 0, 0, 0, 0, 0LL);
  ...
  else
  {
    ...
    if ( !v61 )
      goto LABEL_52;
    IconLabelInfo__Set_37829740(v61, 2, lv, (int32_t)questLabel, 0, 0, 0, 0, 0LL);
    questLabel = (UILabel_o *)this->fields.supportServantFaceIcon;
    if ( !questLabel )
      goto LABEL_52;
    ServantFaceIconComponent__Set_37909072((ServantFaceIconComponent_o *)questLabel, usrSvtId, v61, 0LL, 0LL);
  }
  questLabel = (UILabel_o *)this->fields.supportServantSubLabel;
  if ( !questLabel )
    goto LABEL_52;
  UIIconLabel__Set_37925528((UIIconLabel_o *)questLabel, 36, data, 0, 0, 0LL, 0, 0, 0, 0LL);
  LOBYTE(questLabel) = 1;
  return (char)questLabel;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A006F3 & 1) == 0 )
  {
    sub_1B64870(&FriendPointNoticeDialogSvtInfo_TypeInfo, method);
    byte_4A006F3 = 1;
  }
  if ( maxWidth <= 0.0 )
  {
  ...
  supportServantNameLabel = this->fields.supportServantNameLabel;
  if ( !supportServantNameLabel
    || (UILabel__SetCondensedScale_46769664(supportServantNameLabel, maxWidth, 0LL),
        (supportServantNameLabel = this->fields.questLabel) == 0LL)
    || (UILabel__SetCondensedScale_46769664(supportServantNameLabel, maxWidth, 0LL),
        (supportServantNameLabel = this->fields.friendPointLabel) == 0LL) )
  {
    sub_1B64ACC(supportServantNameLabel, method);
  }
  UILabel__SetCondensedScale_46769664(supportServantNameLabel, maxWidth, 0LL);
}