void __fastcall FriendPointNoticeDialogSvtInfo___cctor(const MethodInfo *method)
{
  if ( (byte_4BDE5E8 & 1) == 0 )
  {
    sub_1C21E38(&FriendPointNoticeDialogSvtInfo_TypeInfo);
    byte_4BDE5E8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE5E6 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_7080/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/);
  ...
  v12 = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_UserServantMaster___);
  v13 = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v14 = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  if ( svtId < 1 )
    goto LABEL_45;
  ...
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_7080/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/, 0LL);
...
LABEL_45:
  ...
  if ( !data )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    questLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7089/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/, 0LL);
    if ( entity )
    {
      v33 = (System_String_o *)questLabel;
      ClassName = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0LL);
      questLabel = (UILabel_o *)System_String__Format_63129848(v33, ServantShortName, ClassName, 0LL);
      if ( supportServantNameLabel )
        goto LABEL_32;
    }
LABEL_52:
    sub_1C22094(questLabel, v15);
  }
  questLabel = (UILabel_o *)System_Int32__ToString((int32_t)&data, 0LL);
  if ( !questLabel )
    goto LABEL_52;
  questLabel = (UILabel_o *)System_String__Replace_63135104(
  ...
  if ( !questLabel )
    goto LABEL_52;
  v28 = System_String__Replace_63135104(
          (System_String_o *)questLabel,
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  questLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7088/*"GET_FRIEND_POINT_SERVANT_NAME"*/, 0LL);
  if ( !entity )
    goto LABEL_52;
  v31 = (System_String_o *)questLabel;
  v32 = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0LL);
  questLabel = (UILabel_o *)System_String__Format_63129916(v31, v30, ServantShortName, v32, 0LL);
  if ( !supportServantNameLabel )
    goto LABEL_52;
LABEL_32:
  ...
  if ( !UnityEngine_Object__op_Inequality(supportServantFaceIcon, 0LL, 0LL) )
    goto LABEL_45;
  v37 = (IconLabelInfo_o *)sub_1C22084(IconLabelInfo_TypeInfo);
  ...
  if ( v25 )
  {
    ...
    if ( !v37 )
      goto LABEL_52;
    IconLabelInfo__Set_39381772(v37, 2, 1, v42->fields.lvMax, 0, 0, 0, 0, 0LL);
  ...
  else
  {
    ...
    if ( !v37 )
      goto LABEL_52;
    IconLabelInfo__Set_39381772(v37, 2, lv, (int32_t)questLabel, 0, 0, 0, 0, 0LL);
    questLabel = (UILabel_o *)this->fields.supportServantFaceIcon;
    if ( !questLabel )
      goto LABEL_52;
    ServantFaceIconComponent__Set_39463800((ServantFaceIconComponent_o *)questLabel, usrSvtId, v37, 0LL, 0LL);
  }
  questLabel = (UILabel_o *)this->fields.supportServantSubLabel;
  if ( !questLabel )
    goto LABEL_52;
  UIIconLabel__Set_39480396((UIIconLabel_o *)questLabel, 36, data, 0, 0, 0LL, 0, 0, 0, 0LL);
  LOBYTE(questLabel) = 1;
  return (char)questLabel;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C22094(supportServantNameLabel, method);
  }
  UILabel__SetCondensedScale_48213524(supportServantNameLabel, maxWidth, 0.0, 0LL);
}