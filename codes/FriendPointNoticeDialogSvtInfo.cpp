void FriendPointNoticeDialogSvtInfo___cctor(const MethodInfo *method)
{
  if ( (byte_59730A5 & 1) == 0 )
  {
    sub_2213A60(&FriendPointNoticeDialogSvtInfo_TypeInfo);
    byte_59730A5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59730A3 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_7247/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/);
    sub_2213A60(&StringLiteral_26981/*"４"*/);
    sub_2213A60(&StringLiteral_26980/*"３"*/);
    sub_2213A60(&StringLiteral_26978/*"１"*/);
    sub_2213A60(&StringLiteral_1480/*"4"*/);
    sub_2213A60(&StringLiteral_26982/*"５"*/);
    sub_2213A60(&StringLiteral_7238/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/);
    sub_2213A60(&StringLiteral_7246/*"GET_FRIEND_POINT_SERVANT_NAME"*/);
    sub_2213A60(&StringLiteral_26979/*"２"*/);
    sub_2213A60(&StringLiteral_1248/*"1"*/);
    sub_2213A60(&StringLiteral_1497/*"5"*/);
    byte_59730A3 = 1;
  }
  entity = 0;
  ...
  v14 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v15 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  if ( svtId < 1 )
    goto LABEL_57;
  ...
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_7238/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/, 0);
  friendPointLabel = this->fields.friendPointLabel;
  v49 = friendPoint;
  v22 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v49);
...
LABEL_57:
  ...
  else
  {
    ...
    *(_QWORD *)&v53.fields.fakeValue = m_CancellationTokenSource;
    v27 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v53, 0);
  ...
  if ( !v51 )
  {
    ...
    questLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7247/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/, 0);
    if ( entity )
    {
      v38 = (System_String_o *)questLabel;
      ClassName = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0);
      questLabel = (UILabel_o *)System_String__Format_75697880(v38, ServantShortName, ClassName, 0);
      if ( supportServantNameLabel )
        goto LABEL_43;
    }
LABEL_65:
    sub_2213CDC(questLabel, v16);
  }
  questLabel = (UILabel_o *)System_Int32__ToString((int32_t)&v51, 0);
  if ( !questLabel )
    goto LABEL_65;
  questLabel = (UILabel_o *)System_String__Replace_75703400(
                              (System_String_o *)questLabel,
                              (System_String_o *)StringLiteral_1248/*"1"*/,
                              (System_String_o *)StringLiteral_26978/*"１"*/,
                              0);
  if ( !questLabel )
    goto LABEL_65;
  questLabel = (UILabel_o *)System_String__Replace_75703400(
                              ...
                              (System_String_o *)StringLiteral_26979/*"２"*/,
                              0);
  if ( !questLabel )
    goto LABEL_65;
  questLabel = (UILabel_o *)System_String__Replace_75703400(
                              (System_String_o *)questLabel,
                              (System_String_o *)StringLiteral_1455/*"3"*/,
                              (System_String_o *)StringLiteral_26980/*"３"*/,
                              0);
  if ( !questLabel )
    goto LABEL_65;
  questLabel = (UILabel_o *)System_String__Replace_75703400(
                              ...
                              (System_String_o *)StringLiteral_26981/*"４"*/,
                              0);
  if ( !questLabel )
    goto LABEL_65;
  v32 = System_String__Replace_75703400(
          (System_String_o *)questLabel,
          (System_String_o *)StringLiteral_1497/*"5"*/,
          (System_String_o *)StringLiteral_26982/*"５"*/,
          0);
  supportServantNameLabel = this->fields.supportServantNameLabel;
  v35 = (Il2CppObject *)v32;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v33);
  questLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7246/*"GET_FRIEND_POINT_SERVANT_NAME"*/, 0);
  if ( !entity )
    goto LABEL_65;
  v36 = (System_String_o *)questLabel;
  v37 = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0);
  questLabel = (UILabel_o *)System_String__Format_75697948(v36, v35, ServantShortName, v37, 0);
  if ( !supportServantNameLabel )
    goto LABEL_65;
LABEL_43:
  ...
  if ( !UnityEngine_Object__op_Inequality(supportServantFaceIcon, 0, 0) )
    goto LABEL_57;
  v43 = (IconLabelInfo_o *)sub_2213CCC(IconLabelInfo_TypeInfo);
  ...
  if ( (v25 & 1) == 0 )
  {
    ...
    if ( !v43 )
      goto LABEL_65;
    IconLabelInfo__Set_47880948(v43, 2, lv, (int32_t)questLabel, 0, 0, 0, 0, 0, 0);
  ...
  if ( v44 )
  {
    ...
    if ( !v43 )
      goto LABEL_65;
    IconLabelInfo__Set_47880948(v43, 2, 1, v50->fields.lvMax, 0, 0, 0, 0, 0, 0);
    questLabel = (UILabel_o *)this->fields.supportServantFaceIcon;
    if ( !questLabel )
      goto LABEL_65;
    ...
    if ( !questLabel )
      goto LABEL_65;
    UIIconLabel__Set_48071660((UIIconLabel_o *)questLabel, 36, v51, 0, 0, 0, 0, 0, 0, 0, 0);
LABEL_64:
    LOBYTE(questLabel) = 1;
  }
  return (char)questLabel;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213CDC(supportServantFaceIcon, bitmapFont);
  }
        ...
        const MethodInfo *method)
{
  ...
  supportServantNameLabel = this->fields.supportServantNameLabel;
  if ( !supportServantNameLabel
    || (UILabel__SetCondensedScale_56591096(supportServantNameLabel, maxWidth, 0.0, 0),
        (supportServantNameLabel = this->fields.questLabel) == 0)
    || (UILabel__SetCondensedScale_56591096(supportServantNameLabel, maxWidth, 0.0, 0),
        (supportServantNameLabel = this->fields.friendPointLabel) == 0) )
  {
    sub_2213CDC(supportServantNameLabel, method);
  }
  UILabel__SetCondensedScale_56591096(supportServantNameLabel, maxWidth, 0.0, 0);
}