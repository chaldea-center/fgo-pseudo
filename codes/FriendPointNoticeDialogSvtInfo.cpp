void FriendPointNoticeDialogSvtInfo___cctor(const MethodInfo *method)
{
  if ( (byte_4CC9C81 & 1) == 0 )
  {
    sub_1C713B0(&FriendPointNoticeDialogSvtInfo_TypeInfo);
    byte_4CC9C81 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9C7F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_6949/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/);
    sub_1C713B0(&StringLiteral_25711/*"４"*/);
    sub_1C713B0(&StringLiteral_25710/*"３"*/);
    sub_1C713B0(&StringLiteral_25708/*"１"*/);
    sub_1C713B0(&StringLiteral_1397/*"4"*/);
    sub_1C713B0(&StringLiteral_25712/*"５"*/);
    sub_1C713B0(&StringLiteral_6940/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/);
    sub_1C713B0(&StringLiteral_6948/*"GET_FRIEND_POINT_SERVANT_NAME"*/);
    sub_1C713B0(&StringLiteral_25709/*"２"*/);
    sub_1C713B0(&StringLiteral_1165/*"1"*/);
    sub_1C713B0(&StringLiteral_1414/*"5"*/);
    byte_4CC9C7F = 1;
  }
  entity = 0;
  v42 = 0;
  ...
  v13 = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v14 = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  if ( svtId < 1 )
    goto LABEL_47;
  ...
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_6940/*"GET_FRIEND_POINT_CAPTION_POINT_FORMAT"*/, 0);
...
LABEL_47:
  ...
  if ( !v42 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    questLabel = LocalizationManager__Get((System_String_o *)StringLiteral_6949/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/, 0);
    if ( entity )
    {
      v30 = (System_String_o *)questLabel;
      ClassName = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0);
      questLabel = System_String__Format_64073032(v30, ServantShortName, ClassName, 0);
      if ( supportServantNameLabel )
        goto LABEL_33;
    }
LABEL_55:
    sub_1C71608(questLabel, v15);
  }
  questLabel = System_Int32__ToString((int32_t)&v42, 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_64078288(
                 (System_String_o *)questLabel,
                 (System_String_o *)StringLiteral_1165/*"1"*/,
                 (System_String_o *)StringLiteral_25708/*"１"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_64078288(
                 ...
                 (System_String_o *)StringLiteral_25709/*"２"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_64078288(
                 ...
                 (System_String_o *)StringLiteral_25710/*"３"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  questLabel = System_String__Replace_64078288(
                 ...
                 (System_String_o *)StringLiteral_25711/*"４"*/,
                 0);
  if ( !questLabel )
    goto LABEL_55;
  v25 = System_String__Replace_64078288(
          (System_String_o *)questLabel,
          (System_String_o *)StringLiteral_1414/*"5"*/,
          (System_String_o *)StringLiteral_25712/*"５"*/,
          0);
  supportServantNameLabel = this->fields.supportServantNameLabel;
  v27 = (Il2CppObject *)v25;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  questLabel = LocalizationManager__Get((System_String_o *)StringLiteral_6948/*"GET_FRIEND_POINT_SERVANT_NAME"*/, 0);
  if ( !entity )
    goto LABEL_55;
  v28 = (System_String_o *)questLabel;
  v29 = (Il2CppObject *)ServantEntity__getClassName((ServantEntity_o *)entity, 0);
  questLabel = System_String__Format_64073100(v28, v27, ServantShortName, v29, 0);
  if ( !supportServantNameLabel )
    goto LABEL_55;
LABEL_33:
  ...
  if ( !UnityEngine_Object__op_Inequality(supportServantFaceIcon, 0, 0) )
    goto LABEL_47;
  v34 = (IconLabelInfo_o *)sub_1C715FC(IconLabelInfo_TypeInfo);
  ...
  if ( !v22 )
  {
    ...
    if ( !v34 )
      goto LABEL_55;
    IconLabelInfo__Set_41192248(v34, 2, lv, (int32_t)questLabel, 0, 0, 0, 0, 0, 0);
  ...
  if ( v35 )
  {
    ...
    if ( !v34 )
      goto LABEL_55;
    IconLabelInfo__Set_41192248(v34, 2, 1, v41->fields.lvMax, 0, 0, 0, 0, 0, 0);
    questLabel = this->fields.supportServantFaceIcon;
    if ( !questLabel )
      goto LABEL_55;
    ...
    if ( !questLabel )
      goto LABEL_55;
    UIIconLabel__Set_41387288((UIIconLabel_o *)questLabel, 36, v42, 0, 0, 0, 0, 0, 0, 0, 0);
LABEL_54:
    LOBYTE(questLabel) = 1;
  }
  return (char)questLabel;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C71608(supportServantFaceIcon, bitmapFont);
  }
        ...
        const MethodInfo *method)
{
  ...
  supportServantNameLabel = this->fields.supportServantNameLabel;
  if ( !supportServantNameLabel
    || (UILabel__SetCondensedScale_49893052(supportServantNameLabel, maxWidth, 0.0, 0),
        (supportServantNameLabel = this->fields.questLabel) == 0)
    || (UILabel__SetCondensedScale_49893052(supportServantNameLabel, maxWidth, 0.0, 0),
        (supportServantNameLabel = this->fields.friendPointLabel) == 0) )
  {
    sub_1C71608(supportServantNameLabel, method);
  }
  UILabel__SetCondensedScale_49893052(supportServantNameLabel, maxWidth, 0.0, 0);
}