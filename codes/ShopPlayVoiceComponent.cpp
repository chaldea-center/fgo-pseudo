        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5ED & 1) == 0 )
  {
    sub_1B761C0(&SoundManager_TypeInfo, *(_QWORD *)&state);
    sub_1B761C0(&StringLiteral_12088/*"SHOP_SCENE_VOICE_WELCOME"*/, v9);
    byte_4A2A5ED = 1;
  }
  ...
  if ( voiceData )
  {
    ...
    *p_voiceData = 0LL;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.voiceData, 0, v12, v13);
  }
  ...
  if ( requestVoiceData )
  {
    *p_voiceData = requestVoiceData;
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.requestVoiceData, 0, v15, v16);
    ...
    {
      VoiceFromMaster = ShopPlayVoiceComponent__GetVoiceFromMaster(v17, (System_String_o *)StringLiteral_12088/*"SHOP_SCENE_VOICE_WELCOME"*/, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5EC & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_ConstantStrMaster___, masterKey);
...
void __fastcall ShopPlayVoiceComponent__InvokedPlayVoiceList(ShopPlayVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5EA & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_ShopPlayVoiceComponent_PlayVoiceList__, v3);
    this = (ShopPlayVoiceComponent_o *)sub_1B761C0(&SoundManager_TypeInfo, v4);
    byte_4A2A5EA = 1;
  }
...
LABEL_14:
  ...
  v17 = SoundManager__playVoice_38522468(voiceData, id, DEFAULT_VOLUME, v16, 0LL);
  v2->fields.voicePlayer = v17;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v2->fields.voicePlayer, (int32_t)v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5E5 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, *(_QWORD *)&figureSvtId);
    sub_1B761C0(&int_TypeInfo, v11);
    sub_1B761C0(&SoundManager_TypeInfo, v12);
    sub_1B761C0(&Method_ShopPlayVoiceComponent___c__DisplayClass14_0__LoadVoice_b__0__, v13);
    sub_1B761C0(&ShopPlayVoiceComponent___c__DisplayClass14_0_TypeInfo, v14);
    sub_1B761C0(&StringLiteral_4463/*"ChrVoice_"*/, v15);
    byte_4A2A5E5 = 1;
  }
  v16 = sub_1B7640C(ShopPlayVoiceComponent___c__DisplayClass14_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v16, 0LL);
  if ( !v16 )
    sub_1B7641C(v17, v18);
  *(_QWORD *)(v16 + 16) = this;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v16 + 16), (int32_t)this, v19, v20);
  *(_DWORD *)(v16 + 24) = state;
  ...
  *(_DWORD *)(v16 + 32) = playVoiceState;
  ...
  if ( !this->fields.requestVoiceData && !this->fields.voiceData )
  {
    ...
    v26 = System_String__Concat((Il2CppObject *)StringLiteral_4463/*"ChrVoice_"*/, v25, 0LL);
    *p_requestVoiceData = v26;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.requestVoiceData, (int32_t)v26, v27, v28);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5E8 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantVoiceMaster___, name);
    sub_1B761C0(&Method_System_Collections_Generic_List_ServantVoiceData____get_Count__, v5);
    sub_1B761C0(&Method_System_Collections_Generic_List_ServantVoiceData____get_Item__, v6);
    sub_1B761C0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v7);
    sub_1B761C0(&StringLiteral_1245/*"0_"*/, v8);
    byte_4A2A5E8 = 1;
  }
  if ( !System_String__IsNullOrEmpty(name, 0LL) && this->fields.voiceData )
  {
    ...
    if ( !Instance
      || (MasterData_object = DataManager__GetMasterData_object_(
          ...
          Instance = (DataManager_o *)System_String__Concat_61535060((System_String_o *)StringLiteral_1245/*"0_"*/, name, 0LL),
          !v16) )
    {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.voicePlayingList, (int32_t)Item, v18, v19);
...
void __fastcall ShopPlayVoiceComponent__PlayVoiceList(ShopPlayVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5E9 & 1) == 0 )
  {
    this = (ShopPlayVoiceComponent_o *)sub_1B761C0(&StringLiteral_7930/*"InvokedPlayVoiceList"*/, method);
    byte_4A2A5E9 = 1;
  }
  voicePlayingList = v2->fields.voicePlayingList;
    ...
    if ( v4 < max_length )
    {
      ...
      if ( v6 )
      {
        UnityEngine_MonoBehaviour__Invoke(
          ...
          (System_String_o *)StringLiteral_7930/*"InvokedPlayVoiceList"*/,
          v6->fields.delay,
          0LL);
        return;
      }
LABEL_10:
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v2->fields.voicePlayingList, 0, v7, v8);
  v2->fields.voicePlayer = 0LL;
  p_voicePlayer = (ServantStatusBattleListViewItem_o *)&v2->fields.voicePlayer;
  sub_1B76164(p_voicePlayer, 0, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5E7 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_1/*""*/, name);
    byte_4A2A5E7 = 1;
  }
...
void __fastcall ShopPlayVoiceComponent__QuitShopVoice(ShopPlayVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.requestVoiceData = 0LL;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.requestVoiceData, 0, v2, v3);
  ...
  if ( voiceData )
  {
    ...
    sub_1B76164(p_voiceData, 0, v9, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5E6 & 1) == 0 )
  {
    sub_1B761C0(&System_Action_TypeInfo, standFigureBack);
    sub_1B761C0(&int_TypeInfo, v13);
    sub_1B761C0(&SoundManager_TypeInfo, v14);
    sub_1B761C0(&Method_ShopPlayVoiceComponent___c__DisplayClass15_0__ReloadVoice_b__0__, v15);
    sub_1B761C0(&ShopPlayVoiceComponent___c__DisplayClass15_0_TypeInfo, v16);
    sub_1B761C0(&StringLiteral_4463/*"ChrVoice_"*/, v17);
    byte_4A2A5E6 = 1;
  }
  v18 = sub_1B7640C(ShopPlayVoiceComponent___c__DisplayClass15_0_TypeInfo);
  ...
  *(_QWORD *)(v18 + 24) = endReload;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v18 + 24), (int32_t)endReload, v23, v24);
  ...
  else
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.standFigureBack, (int32_t)standFigureBack, v25, v26);
    ...
    v31 = System_String__Concat((Il2CppObject *)StringLiteral_4463/*"ChrVoice_"*/, v30, 0LL);
    this->fields.requestVoiceData = v31;
    p_requestVoiceData = &this->fields.requestVoiceData;
    sub_1B76164((ServantStatusBattleListViewItem_o *)p_requestVoiceData, (int32_t)v31, v33, v34);
...
void __fastcall ShopPlayVoiceComponent__StopVoice(ShopPlayVoiceComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A5EB & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_7930/*"InvokedPlayVoiceList"*/, method);
    byte_4A2A5EB = 1;
  }
  ...
  if ( voicePlayer )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.voicePlayer, 0, v5, v6);
    this->fields.voicePlayingList = 0LL;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.voicePlayingList, 0, v7, v8);
  }
  if ( UnityEngine_MonoBehaviour__IsInvoking_69272124(
        ...
        const MethodInfo *method)
{
  ...
  if ( voiceData )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&_4__this->fields.voiceData, 0, v7, v8);
    _4__this = this->fields.__4__this;
    if ( !_4__this )
      goto LABEL_13;
  }
  ...
  if ( requestVoiceData )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&_4__this->fields.voiceData, (int32_t)requestVoiceData, v2, v3);
    _4__this = this->fields.__4__this;
    if ( _4__this )
    {
      _4__this->fields.requestVoiceData = 0LL;
      sub_1B76164((ServantStatusBattleListViewItem_o *)&_4__this->fields.requestVoiceData, 0, v10, v11);
