...
void __fastcall WarBoardStagePieceDetailEntity___ctor_41328396(
        ...
        const MethodInfo *method)
{
  if ( (byte_4B67C53 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&forceId);
    byte_4B67C53 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C5D & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18746/*"deadEffect"*/, method);
    byte_4B67C5D = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_18746/*"deadEffect"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_18889/*"dispLimitCount"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20520/*"imageSvtId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C5E & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22405/*"noMoveAfterAttack"*/, method);
    byte_4B67C5E = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22405/*"noMoveAfterAttack"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C5F & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22408/*"noMovedAfterDefend"*/, method);
    byte_4B67C5F = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22408/*"noMovedAfterDefend"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C5B & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22692/*"overwriteAttackCost"*/, method);
    byte_4B67C5B = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22692/*"overwriteAttackCost"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C5A & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22694/*"overwriteBaseActionPoint"*/, method);
    byte_4B67C5A = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22694/*"overwriteBaseActionPoint"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C5C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22716/*"overwriteMoveCost"*/, method);
    byte_4B67C5C = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22716/*"overwriteMoveCost"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C59 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22739/*"overwriteWallAttackCost"*/, method);
    byte_4B67C59 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22739/*"overwriteWallAttackCost"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67C58 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_24969/*"warBoardSvtDetail"*/, method);
    byte_4B67C58 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_24969/*"warBoardSvtDetail"*/, 0, v2);
}
