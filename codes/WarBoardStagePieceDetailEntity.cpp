...
void __fastcall WarBoardStagePieceDetailEntity___ctor_42272200(
        ...
        const MethodInfo *method)
{
  if ( (byte_4B45C1E & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&forceId);
    byte_4B45C1E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C28 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_18516/*"deadEffect"*/, method);
    byte_4B45C28 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_18516/*"deadEffect"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_18655/*"dispLimitCount"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_20307/*"imageSvtId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C29 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22263/*"noMoveAfterAttack"*/, method);
    byte_4B45C29 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22263/*"noMoveAfterAttack"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C2A & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22266/*"noMovedAfterDefend"*/, method);
    byte_4B45C2A = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22266/*"noMovedAfterDefend"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C26 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22550/*"overwriteAttackCost"*/, method);
    byte_4B45C26 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22550/*"overwriteAttackCost"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C25 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22552/*"overwriteBaseActionPoint"*/, method);
    byte_4B45C25 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22552/*"overwriteBaseActionPoint"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C27 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22581/*"overwriteMoveCost"*/, method);
    byte_4B45C27 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22581/*"overwriteMoveCost"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C24 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22606/*"overwriteWallAttackCost"*/, method);
    byte_4B45C24 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_22606/*"overwriteWallAttackCost"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C23 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_24821/*"warBoardSvtDetail"*/, method);
    byte_4B45C23 = 1;
  }
  return WarBoardStagePieceDetailEntity__getScriptIntParam(this, (System_String_o *)StringLiteral_24821/*"warBoardSvtDetail"*/, 0, v2);
}
