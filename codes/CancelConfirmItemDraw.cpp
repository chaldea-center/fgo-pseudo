        ...
        const MethodInfo *method)
{
  ...
  if ( !userServantEntity )
  {
    ...
    if ( !equipIdList->max_length )
      goto LABEL_42;
    v13 = (System_String_o *)StringLiteral_18961/*"formation_blank_small"*/;
    if ( !equipIdList->m_Items[0] )
      goto LABEL_39;
    maskSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !maskSprite )
      goto LABEL_41;
...
LABEL_41:
    sub_B52A5C(maskSprite, userServantEntity);
  }
  ...
  if ( UserServantEntity__IsHeroine(userServantEntity, 0LL) )
  {
    ...
    if ( TutorialFlag__Get_29217932(126, 0LL) )
    {
      ...
      maskSprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11717/*"SELECT_NO_SORTIE"*/, 0LL);
      if ( !warningText )
        goto LABEL_41;
  ...
  *(_OWORD *)&v16.fields.fakeValue = v10;
  ...
  v15 = v16;
  v12 = klass == (UnityEngine_Component_c *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_44789576(
                                              &v15,
                                              0LL);
  v13 = 0LL;
  if ( v12 )
