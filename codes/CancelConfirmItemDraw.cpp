        ...
        const MethodInfo *method)
{
  ...
  if ( !userServantEntity )
  {
    ...
    if ( !LODWORD(equipIdList->max_length) )
      goto LABEL_40;
    v13 = (System_String_o *)StringLiteral_19786/*"formation_blank_small"*/;
    if ( !equipIdList->m_Items[0] )
      goto LABEL_37;
    maskSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !maskSprite )
      goto LABEL_39;
...
LABEL_39:
    sub_1C93D2C(maskSprite, userServantEntity);
  }
  ...
  if ( UserServantEntity__IsHeroine(userServantEntity, 0) )
  {
    ...
    if ( TutorialFlag__Get_41140656(126, 0) )
    {
      ...
      maskSprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11627/*"SELECT_NO_SORTIE"*/, 0);
      if ( !warningText )
        goto LABEL_39;
  ...
  *(_OWORD *)&v15.fields.fakeValue = v10;
  ...
  v14 = v15;
  v12 = monitor == (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49657552(&v14, 0);
  v13 = 0;
  if ( v12 )
  {
    maskSprite = (UnityEngine_Component_o *)this->fields.pushSprite;
