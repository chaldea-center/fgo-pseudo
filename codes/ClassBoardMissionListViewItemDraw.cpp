        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFB38 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_3559/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_TITLE"*/);
    sub_1C21E38(&StringLiteral_3558/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_PROG"*/);
    byte_4BDFB38 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(conditionTitle, 0LL, 0LL) )
  {
    ...
    missionCondLb = LocalizationManager__Get((System_String_o *)StringLiteral_3559/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_TITLE"*/, 0LL);
    if ( !v10 )
      goto LABEL_29;
  ...
  if ( UnityEngine_Object__op_Inequality(progLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    missionCondLb = LocalizationManager__Get((System_String_o *)StringLiteral_3558/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_PROG"*/, 0LL);
    if ( !v14 )
      goto LABEL_29;
