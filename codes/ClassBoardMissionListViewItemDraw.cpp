        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7C83 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_3547/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_BEFORE"*/, v10);
    sub_1C13D24(&StringLiteral_3546/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_AFTER"*/, v11);
    byte_4BB7C83 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(conditionTitle, 0LL, 0LL) )
  {
    ...
    missionCondLb = LocalizationManager__Get((System_String_o *)StringLiteral_3547/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_BEFORE"*/, 0LL);
    if ( !v13 )
      goto LABEL_29;
  ...
  if ( UnityEngine_Object__op_Inequality(progLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    missionCondLb = LocalizationManager__Get((System_String_o *)StringLiteral_3546/*"CLASS_BOARD_LOCK_RELEASE_CONDITION_DIALOG_EXPLANATION_AFTER"*/, 0LL);
    if ( !v17 )
      goto LABEL_29;
