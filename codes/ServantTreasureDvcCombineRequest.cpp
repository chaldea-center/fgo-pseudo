        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EBF33 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_16823/*"baseUserSvtId"*/, baseUsrSvtId, selectTdIndex, *(_QWORD *)&selectTdId);
    sub_B5D5C4(&StringLiteral_23090/*"treasureDeviceId"*/, v11, v12, v13);
    sub_B5D5C4(&StringLiteral_21449/*"num"*/, v14, v15, v16);
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21449/*"num"*/, selectTdIndex, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23090/*"treasureDeviceId"*/, selectTdId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EBF32 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_17433/*"card/combineTd"*/, v4, v5, v6);
    byte_42EBF32 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_17433/*"card/combineTd"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(27, responseList, 0LL);
