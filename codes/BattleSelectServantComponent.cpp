void __fastcall BattleSelectServantComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB7804 & 1) == 0 )
  {
    sub_1C13D24(&BattleSelectServantComponent_TypeInfo, v1);
    byte_4BB7804 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7803 & 1) == 0 )
  {
    sub_1C13D24(&Method_BattleSelectServantComponent_OnServantClick__, method);
    byte_4BB7803 = 1;
  }
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantComponent_OnServantClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_BattleSelectServantComponent_OnServantClick__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7800 & 1) == 0 )
  {
    sub_1C13D24(&BattleSelectServantComponent_TypeInfo, svtData);
  ...
  *(_QWORD *)&v42.fields.fakeValue = v22;
  ...
  WrapControlText__fontSizeAdjust(nameLabel, v33, v32->static_fields->SERVANT_NAME_FONT_SIZE, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7802 & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, canSelect);
    sub_1C13D24(&StringLiteral_2886/*"BATTLE_DIALOG_BATTLEUSEITEM_ERROR_TITLE"*/, v6);
  ...
  if ( !this->fields.canSelectFlag )
  {
    ...
    servantSelectMask = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2886/*"BATTLE_DIALOG_BATTLEUSEITEM_ERROR_TITLE"*/, 0LL);
    *(_QWORD *)&canSelect = servantSelectMask;
    if ( servantSelectMaskLabel )
      goto LABEL_10;
LABEL_13:
    sub_1C13F80(servantSelectMask, canSelect);
  }
        ...
        const MethodInfo *method)
{
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    if ( !this->fields.targetObject )
      sub_1C13F80(this, selectUniqueId);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A58C14;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A58BBC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7805 & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, *(_QWORD *)&position);
    sub_1C13D24(&BattleSelectMainSubServantWindow_POSITION_TypeInfo, v9);
    byte_4BB7805 = 1;
  }
  v14[2] = 0LL;
