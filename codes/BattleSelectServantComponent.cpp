void __fastcall BattleSelectServantComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A30EEE & 1) == 0 )
  {
    sub_1B761C0(&BattleSelectServantComponent_TypeInfo, v1);
    byte_4A30EEE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EED & 1) == 0 )
  {
    sub_1B761C0(&Method_BattleSelectServantComponent_OnServantClick__, method);
    byte_4A30EED = 1;
  }
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantComponent_OnServantClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B761D8(Method_BattleSelectServantComponent_OnServantClick__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EEA & 1) == 0 )
  {
    sub_1B761C0(&BattleSelectServantComponent_TypeInfo, svtData);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.selectCallBack, (int32_t)call, position, index);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EEC & 1) == 0 )
  {
    sub_1B761C0(&LocalizationManager_TypeInfo, canSelect);
    sub_1B761C0(&StringLiteral_2856/*"BATTLE_DIALOG_CAN_NOT_REPLACE"*/, v6);
  ...
  if ( !this->fields.canSelectFlag )
  {
    ...
    *(_QWORD *)&canSelect = servantSelectMask;
    if ( servantSelectMaskLabel )
      goto LABEL_10;
LABEL_13:
    sub_1B7641C(servantSelectMask, canSelect);
  }
        ...
        const MethodInfo *method)
{
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    if ( !this->fields.targetObject )
      sub_1B7641C(this, selectUniqueId);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19C0D84;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C0D2C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30EEF & 1) == 0 )
  {
    sub_1B761C0(&int_TypeInfo, *(_QWORD *)&position);
    sub_1B761C0(&BattleSelectMainSubServantWindow_POSITION_TypeInfo, v9);
    byte_4A30EEF = 1;
  }
  v14[2] = 0LL;
