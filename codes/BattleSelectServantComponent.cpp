void __fastcall BattleSelectServantComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BCABEA & 1) == 0 )
  {
    sub_1C1ABD4(&BattleSelectServantComponent_TypeInfo, v1);
    byte_4BCABEA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABE9 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_BattleSelectServantComponent_OnServantClick__, method);
    byte_4BCABE9 = 1;
  }
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantComponent_OnServantClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_BattleSelectServantComponent_OnServantClick__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABE6 & 1) == 0 )
  {
    sub_1C1ABD4(&BattleSelectServantComponent_TypeInfo, svtData);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABE8 & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, canSelect);
    sub_1C1ABD4(&StringLiteral_2887/*"BATTLE_DIALOG_CAN_NOT_REPLACE"*/, v6);
  ...
  if ( !this->fields.canSelectFlag )
  {
    ...
    servantSelectMask = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2887/*"BATTLE_DIALOG_CAN_NOT_REPLACE"*/, 0LL);
    *(_QWORD *)&canSelect = servantSelectMask;
    if ( servantSelectMaskLabel )
      goto LABEL_10;
LABEL_13:
    sub_1C1AE30(servantSelectMask, canSelect);
  }
        ...
        const MethodInfo *method)
{
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    if ( !this->fields.targetObject )
      sub_1C1AE30(this, selectUniqueId);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5FA14;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5F9BC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCABEB & 1) == 0 )
  {
    sub_1C1ABD4(&int_TypeInfo, *(_QWORD *)&position);
    sub_1C1ABD4(&BattleSelectMainSubServantWindow_POSITION_TypeInfo, v9);
    byte_4BCABEB = 1;
  }
  v14[2] = 0LL;
