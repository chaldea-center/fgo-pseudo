void __fastcall BattleSelectServantComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B47EE8 & 1) == 0 )
  {
    sub_1BDB878(&BattleSelectServantComponent_TypeInfo, v1);
    byte_4B47EE8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47EE7 & 1) == 0 )
  {
    sub_1BDB878(&Method_BattleSelectServantComponent_OnServantClick__, method);
    byte_4B47EE7 = 1;
  }
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantComponent_OnServantClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_BattleSelectServantComponent_OnServantClick__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47EE4 & 1) == 0 )
  {
    sub_1BDB878(&BattleSelectServantComponent_TypeInfo, svtData);
  ...
  *(_QWORD *)&v40.fields.fakeValue = v20;
  v23 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v40, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47EE6 & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, canSelect);
    sub_1BDB878(&StringLiteral_2766/*"BATTLE_DIALOG_CAN_NOT_REPLACE"*/, v6);
  ...
  if ( !this->fields.canSelectFlag )
  {
    ...
    servantSelectMask = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2766/*"BATTLE_DIALOG_CAN_NOT_REPLACE"*/, 0LL);
    *(_QWORD *)&canSelect = servantSelectMask;
    if ( servantSelectMaskLabel )
      goto LABEL_10;
LABEL_13:
    sub_1BDBAD4(servantSelectMask, canSelect);
  }
        ...
        const MethodInfo *method)
{
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    if ( !this->fields.targetObject )
      sub_1BDBAD4(this, selectUniqueId);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A28A9C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A28A44;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47EE9 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&position);
    sub_1BDB878(&BattleSelectMainSubServantWindow_POSITION_TypeInfo, v9);
    byte_4B47EE9 = 1;
  }
  v14[2] = 0LL;
