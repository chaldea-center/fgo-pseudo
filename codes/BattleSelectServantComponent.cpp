void BattleSelectServantComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_593BF4B & 1) == 0 )
  {
    sub_21FFC50(&BattleSelectServantComponent_TypeInfo);
    sub_21FFC50(&StringLiteral_22313/*"listframes3_bg"*/);
    sub_21FFC50(&StringLiteral_21336/*"img_frames_grand_mask11"*/);
    byte_593BF4B = 1;
  }
  v7 = StringLiteral_22313/*"listframes3_bg"*/;
  BattleSelectServantComponent_TypeInfo->static_fields->MaskSpriteName = (struct System_String_o *)StringLiteral_22313/*"listframes3_bg"*/;
  sub_21FFBF4(
    (MissionNaviTransitionBoardItem_o *)BattleSelectServantComponent_TypeInfo->static_fields,
    v7,
    v1,
    v2,
    v3,
    ...
    v5,
    v6);
  v8 = StringLiteral_21336/*"img_frames_grand_mask11"*/;
  static_fields = BattleSelectServantComponent_TypeInfo->static_fields;
  static_fields->GrandMaskSpriteName = (struct System_String_o *)StringLiteral_21336/*"img_frames_grand_mask11"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&static_fields->GrandMaskSpriteName, v8, v10, v11, v12, v13, v14, v15);
}
...
void BattleSelectServantComponent__OnServantClick(BattleSelectServantComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593BF4A & 1) == 0 )
  {
    sub_21FFC50(&Method_BattleSelectServantComponent_OnServantClick__);
    byte_593BF4A = 1;
  }
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    ...
    if ( (*((_BYTE *)Method_BattleSelectServantComponent_OnServantClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_BattleSelectServantComponent_OnServantClick__);
        ...
        const MethodInfo *method)
{
  ...
  int32_t lv; // w28
  int32_t v25; // w27
  ServantFaceIconComponent_o *v26; // x22
  int32_t frameType_k__BackingField; // w23
  __int64 v28; // x1
  UnityEngine_GameObject_o *servantSelectMask; // x0
  Il2CppObject *Component_object; // x22
  BattleSelectServantComponent_c *v31; // x0
  ...
  int32_t NowHp; // w0
  struct BattleServantData_PreEntryStatus_o *v38; // x8
  int32_t v39; // w23
  ...
  BattleNpGaugeSystemComponent_o *v49; // x8
  BattleNpGaugeSystemComponent_o *v50; // x22
  int32_t v51; // [xsp+6Ch] [xbp-54h] BYREF
  ...
  *(_QWORD *)&v52.fields.fakeValue = v21;
  v23 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55792412(v52, 0);
  ...
  if ( !v26 )
    goto LABEL_48;
  ServantFaceIconComponent__ChangeClassIcon(v26, frameType_k__BackingField, (int32_t)imageSvtId, 0);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0, 0) )
  {
    if ( svtData->fields._IsGrand_k__BackingField )
    {
      ...
      if ( !*(&BattleSelectServantComponent_TypeInfo->_2.cctor_finished + 1) )
      {
        j_il2cpp_runtime_class_init_0(BattleSelectServantComponent_TypeInfo, v12);
        v31 = BattleSelectServantComponent_TypeInfo;
      }
      GrandMaskSpriteName = v31->static_fields->GrandMaskSpriteName;
...
LABEL_31:
  ...
  v38 = svtData->fields._PreEntryStatusInfo_k__BackingField;
  v39 = NowHp;
  if ( v38 )
  {
    GainNp_k__BackingField = v38->fields._GainNp_k__BackingField;
    v39 = v38->fields._AddMaxHp_k__BackingField + NowHp;
  }
  else
  {
  ...
  v44 = System_Math__Min_76940292(np + GainNp_k__BackingField, MaxNp, 0);
  hpLabel = this->fields.hpLabel;
  v51 = v39;
  v46 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &v51);
  imageSvtId = (UnityEngine_GameObject_o *)System_String__Format((System_String_o *)StringLiteral_26433/*"{0}"*/, v46, 0);
  if ( !hpLabel )
    goto LABEL_48;
  ...
  BattleHpGaugeBarComponent__setInitValue(
    ...
    v39,
    AddMaxHp_k__BackingField + v35,
    0);
  npGauge = this->fields.npGauge;
  if ( !npGauge )
    goto LABEL_48;
  npGauge->fields.lineCount = 3;
  imageSvtId = (UnityEngine_GameObject_o *)BattleServantData__getCountMaxNp(svtData, 0);
  v49 = this->fields.npGauge;
  npGauge->fields.maxparam = (int)imageSvtId;
  if ( !v49 )
    goto LABEL_48;
  BattleNpGaugeSystemComponent__InitSliderValue(v49, 0);
  imageSvtId = (UnityEngine_GameObject_o *)this->fields.npGauge;
  if ( !imageSvtId )
    goto LABEL_48;
  BattleNpGaugeSystemComponent__setNowParam((BattleNpGaugeSystemComponent_o *)imageSvtId, v44, 0);
  v50 = this->fields.npGauge;
  imageSvtId = (UnityEngine_GameObject_o *)BattleServantData__isAddNpGauge(svtData, 0);
  if ( !v50 )
    goto LABEL_48;
  BattleNpGaugeSystemComponent__setUseNp(v50, (unsigned __int8)imageSvtId & 1, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593BF49 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_2851/*"BATTLE_DIALOG_CAN_NOT_REPLACE"*/);
    sub_21FFC50(&StringLiteral_1/*""*/);
    byte_593BF49 = 1;
  }
  servantSelectMask = this->fields.servantSelectMask;
  ...
  else
  {
    ...
    if ( ((unsigned __int8)servantSelectMask & 1) != 0 )
    {
      if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, canSelect);
      servantSelectMask = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2851/*"BATTLE_DIALOG_CAN_NOT_REPLACE"*/, 0);
  ...
  {
LABEL_16:
    sub_21FFECC(servantSelectMask, canSelect);
  }
        ...
        const MethodInfo *method)
{
  if ( this->fields.isUse && this->fields.canSelectFlag )
  {
    if ( !this->fields.targetObject )
      sub_21FFECC(this, *(_QWORD *)&selectUniqueId);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_20002AC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_2000254;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_593BF4C & 1) == 0 )
  {
    sub_21FFC50(&BattleSelectMainSubServantWindow_POSITION_TypeInfo);
    byte_593BF4C = 1;
  }
  v10[2] = 0;
