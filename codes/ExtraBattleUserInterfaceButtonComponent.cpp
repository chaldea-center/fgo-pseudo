        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33A20 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ActionExtensions_Call_ExtraBattleUserInterfaceButtonComponent_ExecType__ExtraBattleUserInterfaceData___);
    sub_1C93AD4(&Method_ExtraBattleUserInterfaceButtonComponent_OnTap__);
    byte_4D33A20 = 1;
  }
  ...
  if ( IsEnable_k__BackingField )
  {
    if ( !IsNullOrEmpty )
    {
      ...
      if ( (*((_BYTE *)Method_ExtraBattleUserInterfaceButtonComponent_OnTap__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1C93AEC(Method_ExtraBattleUserInterfaceButtonComponent_OnTap__);
    ...
    ActionExtensions__Call_Int32Enum__object_(
      ...
      (const MethodInfo_30EBF98 *)Method_ActionExtensions_Call_ExtraBattleUserInterfaceButtonComponent_ExecType__ExtraBattleUserInterfaceData___);
  }
  else if ( !IsNullOrEmpty )
  {
    v7 = Method_ExtraBattleUserInterfaceButtonComponent_OnTap__;
    if ( (*((_BYTE *)Method_ExtraBattleUserInterfaceButtonComponent_OnTap__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1C93AEC(Method_ExtraBattleUserInterfaceButtonComponent_OnTap__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33A1C & 1) == 0 )
  {
    sub_1C93AD4(&System_Action_ExtraBattleUserInterfaceButtonComponent_StateObject__TypeInfo);
    sub_1C93AD4(&Method_BasicHelper_ForEach_ExtraBattleUserInterfaceButtonComponent_StateObject___);
    sub_1C93AD4(&Method_ExtraBattleUserInterfaceButtonComponent__SetActiveStateObjects_b__19_0__);
    byte_4D33A1C = 1;
  }
  stateObjects = (System_Collections_Generic_IEnumerable_T__o *)this->fields.stateObjects;
  v4 = (System_Action_object__o *)sub_1C93D20(System_Action_ExtraBattleUserInterfaceButtonComponent_StateObject__TypeInfo);
  ...
  BasicHelper__ForEach_object_(
    ...
    (const MethodInfo_3190798 *)Method_BasicHelper_ForEach_ExtraBattleUserInterfaceButtonComponent_StateObject___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33A1F & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_5861/*"EX_BATTLE_UI_SWITCH_PARTY_BUTTON_ALL_OTHER_PARTY_LOSE_MESSAGE"*/);
    sub_1C93AD4(&StringLiteral_1/*""*/);
    sub_1C93AD4(&StringLiteral_5860/*"EX_BATTLE_UI_EXECUTE_SKILL_BUTTON_COND_NO_ALIVE_SUB_MEMBER"*/);
    byte_4D33A1F = 1;
  }
  targetIndex = 0;
  ...
  if ( execType == 2 )
  {
    ...
    if ( Cond_k__BackingField )
    {
      if ( !ExtraBattleUserInterfaceData_CondDataWrapper__IsVerified(Cond_k__BackingField, 0, v27) )
      {
        ...
        v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5860/*"EX_BATTLE_UI_EXECUTE_SKILL_BUTTON_COND_NO_ALIVE_SUB_MEMBER"*/, 0);
        goto LABEL_26;
      }
LABEL_22:
...
LABEL_28:
    sub_1C93D2C(Cond_k__BackingField, executeSkill);
  }
  if ( execType != 1 )
    return;
  if ( !battleData )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5861/*"EX_BATTLE_UI_SWITCH_PARTY_BUTTON_ALL_OTHER_PARTY_LOSE_MESSAGE"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33A21 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ExtraBattleUserInterfaceButtonComponent__SetActiveStateObjects_b__19_1__);
    sub_1C93AD4(&System_Func_ExtraBattleUserInterfaceButtonComponent_ShowCondition__bool__TypeInfo);
    byte_4D33A21 = 1;
  }
  v5 = (System_Func_T__TResult__o *)sub_1C93D20(System_Func_ExtraBattleUserInterfaceButtonComponent_ShowCondition__bool__TypeInfo);
