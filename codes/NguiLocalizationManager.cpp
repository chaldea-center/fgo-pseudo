bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4A0339D & 1) == 0 )
  {
    key = (System_String_o *)sub_1B64A00(&NguiLocalizationManager_TypeInfo, method);
    byte_4A0339D = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1B64C5C(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0339B & 1) == 0 )
  {
    sub_1B64A00(&NguiLocalizationManager_TypeInfo, method);
    byte_4A0339B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->getFunc, (int32_t)getFunc, v2, v3);
}