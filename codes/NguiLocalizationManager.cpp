bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4C02011 & 1) == 0 )
  {
    key = (System_String_o *)sub_1C2E12C(&NguiLocalizationManager_TypeInfo, method);
    byte_4C02011 = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1C2E388(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C0200F & 1) == 0 )
  {
    sub_1C2E12C(&NguiLocalizationManager_TypeInfo, method);
    byte_4C0200F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&static_fields->getFunc, (int64_t)getFunc, v2, v3, v4, v5, v6, v7);
}