bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4ABA436 & 1) == 0 )
  {
    key = (System_String_o *)sub_1BAB41C(&NguiLocalizationManager_TypeInfo, method);
    byte_4ABA436 = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1BAB678(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4ABA434 & 1) == 0 )
  {
    sub_1BAB41C(&NguiLocalizationManager_TypeInfo, method);
    byte_4ABA434 = 1;
  }
  NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc = containsKeyFunc;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)NguiLocalizationManager_TypeInfo->static_fields,
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->getFunc, (int32_t)getFunc, v2, v3);
}