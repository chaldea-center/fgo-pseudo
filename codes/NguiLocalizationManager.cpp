bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_48E70DD & 1) == 0 )
  {
    key = (System_String_o *)sub_1B00CCC(&NguiLocalizationManager_TypeInfo, method);
    byte_48E70DD = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1B00F28(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E70DB & 1) == 0 )
  {
    sub_1B00CCC(&NguiLocalizationManager_TypeInfo, method);
    byte_48E70DB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->getFunc, (int32_t)getFunc, v2, v3);
}