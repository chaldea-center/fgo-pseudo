bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4B1A916 & 1) == 0 )
  {
    key = (System_String_o *)sub_1BCA7E0(&NguiLocalizationManager_TypeInfo, method, v2);
    byte_4B1A916 = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1BCAA3C(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A914 & 1) == 0 )
  {
    sub_1BCA7E0(&NguiLocalizationManager_TypeInfo, method, v2);
    byte_4B1A914 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCA784((PartyOrganizationUtility_o *)&static_fields->getFunc, (int64_t)getFunc, v2, v3, v4, v5, v6, v7);
}