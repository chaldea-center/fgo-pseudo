bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4B20A8E & 1) == 0 )
  {
    key = (System_String_o *)sub_1BCAFF8(&NguiLocalizationManager_TypeInfo, method);
    byte_4B20A8E = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1BCB254(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20A8C & 1) == 0 )
  {
    sub_1BCAFF8(&NguiLocalizationManager_TypeInfo, method);
    byte_4B20A8C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->getFunc, (int32_t)getFunc, v2, v3);
}