bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4BB8EBE & 1) == 0 )
  {
    key = (System_String_o *)sub_1C13D24(&NguiLocalizationManager_TypeInfo, method);
    byte_4BB8EBE = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1C13F80(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8EBC & 1) == 0 )
  {
    sub_1C13D24(&NguiLocalizationManager_TypeInfo, method);
    byte_4BB8EBC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&static_fields->getFunc, (int64_t)getFunc, v2, v3, v4, v5, v6, v7);
}