bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4A02D75 & 1) == 0 )
  {
    key = (System_String_o *)sub_1B64870(&NguiLocalizationManager_TypeInfo, method);
    byte_4A02D75 = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1B64ACC(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02D73 & 1) == 0 )
  {
    sub_1B64870(&NguiLocalizationManager_TypeInfo, method);
    byte_4A02D73 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->getFunc, (int32_t)getFunc, v2, v3);
}