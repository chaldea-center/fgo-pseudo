bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4B3B916 & 1) == 0 )
  {
    key = (System_String_o *)sub_1BD3458(&NguiLocalizationManager_TypeInfo, method);
    byte_4B3B916 = 1;
  }
  containsKeyFunc = NguiLocalizationManager_TypeInfo->static_fields->containsKeyFunc;
  if ( !containsKeyFunc )
    sub_1BD36B4(key, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B914 & 1) == 0 )
  {
    sub_1BD3458(&NguiLocalizationManager_TypeInfo, method);
    byte_4B3B914 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&static_fields->getFunc, (int64_t)getFunc, v2, v3, v4, v5, v6, v7);
}