bool __fastcall NguiLocalizationManager__ContainsKey(System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4A00C75 & 1) == 0 )
  {
    key = (System_String_o *)sub_1B640C8(&NguiLocalizationManager_TypeInfo, method);
    byte_4A00C75 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00C73 & 1) == 0 )
  {
    sub_1B640C8(&NguiLocalizationManager_TypeInfo, method);
    byte_4A00C73 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->getFunc, (int32_t)getFunc, v2, v3);
}