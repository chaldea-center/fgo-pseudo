        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F09 & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, *(_QWORD *)&currentLv);
    sub_1C13D24(&LocalizationManager_TypeInfo, v4);
    sub_1C13D24(&StringLiteral_8402/*"LEVELUP_NOTICE_TITLE"*/, v5);
    sub_1C13D24(&StringLiteral_2116/*"APPEND_SKILL_EXCHANGE_LIMIT_MSG"*/, v6);
    byte_4BB7F09 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( currentLv <= 0 )
    return LocalizationManager__Get((System_String_o *)StringLiteral_2116/*"APPEND_SKILL_EXCHANGE_LIMIT_MSG"*/, 0LL);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_8402/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
  v13 = currentLv;
...
void __fastcall AppendSkillExchangeDialog__OnClickCancel(AppendSkillExchangeDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F0B & 1) == 0 )
  {
    sub_1C13D24(&Method_AppendSkillExchangeDialog_OnClickCancel__, method);
    byte_4BB7F0B = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_AppendSkillExchangeDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C13D3C(Method_AppendSkillExchangeDialog_OnClickCancel__);
...
void __fastcall AppendSkillExchangeDialog__OnClickDecide(AppendSkillExchangeDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F0A & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_AppendSkillExchangeDialog_OnClickDecide__, v3);
    sub_1C13D24(&Method_AppendSkillExchangeDialog__OnClickDecide_b__24_0__, v4);
    byte_4BB7F0A = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_AppendSkillExchangeDialog_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C13D3C(Method_AppendSkillExchangeDialog_OnClickDecide__);
...
void __fastcall AppendSkillExchangeDialog__OnEnable(AppendSkillExchangeDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F0C & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_3226/*"BaseUtcOffsetDelta"*/, method);
    byte_4BB7F0C = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  AndroidBackKeyManager__AddBackBtn_42984304(transform, (System_String_o *)StringLiteral_3226/*"BaseUtcOffsetDelta"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F08 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_AppendSkillExchangeDialog_EndOpen__, v11);
    sub_1C13D24(&int_TypeInfo, v12);
    sub_1C13D24(&LocalizationManager_TypeInfo, v13);
    sub_1C13D24(&StringLiteral_2127/*"APPEND_SKILL_EXCHANGE_TITLE"*/, v14);
    sub_1C13D24(&StringLiteral_2125/*"APPEND_SKILL_EXCHANGE_SELECT_BASE_INFO"*/, v15);
    sub_1C13D24(&StringLiteral_2106/*"APPEND_SKILL_COMBINE_SELECT_BASE_INFO"*/, v16);
    sub_1C13D24(&StringLiteral_2118/*"APPEND_SKILL_EXCHANGE_LV"*/, v17);
    sub_1C13D24(&StringLiteral_3800/*"COMMON"*/, v18);
    sub_1C13D24(&StringLiteral_3798/*"COMMAND_TYPE_NAME_{0}"*/, v19);
    sub_1C13D24(&StringLiteral_2117/*"APPEND_SKILL_EXCHANGE_LOCK"*/, v20);
    sub_1C13D24(&StringLiteral_2126/*"APPEND_SKILL_EXCHANGE_TARGET"*/, v21);
    sub_1C13D24(&StringLiteral_2122/*"APPEND_SKILL_EXCHANGE_PRESELECT_TARGET_INFO"*/, v22);
    byte_4BB7F08 = 1;
  }
  AppendSkillExchangeDialog__Init(this, (const MethodInfo *)baseData);
  this->fields.onDecide = decideAction;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.onDecide, (int64_t)decideAction, v23, v24, v25, v26, v27, v28);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  appendSkillBaseIconComp = LocalizationManager__Get((System_String_o *)StringLiteral_2126/*"APPEND_SKILL_EXCHANGE_TARGET"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_32;
  UILabel__set_text(titleLabel, appendSkillBaseIconComp, 0LL);
  appendSkillBaseInfo = this->fields.appendSkillBaseInfo;
  appendSkillBaseIconComp = LocalizationManager__Get((System_String_o *)StringLiteral_2106/*"APPEND_SKILL_COMBINE_SELECT_BASE_INFO"*/, 0LL);
  ...
  appendSkillBaseIconComp = LocalizationManager__Get((System_String_o *)StringLiteral_2117/*"APPEND_SKILL_EXCHANGE_LOCK"*/, 0LL);
  if ( !targetData )
    goto LABEL_32;
  ...
  appendSkillBaseIconComp = LocalizationManager__Get((System_String_o *)StringLiteral_2125/*"APPEND_SKILL_EXCHANGE_SELECT_BASE_INFO"*/, 0LL);
  ...
  v45 = (AppendSkillExchangeDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2117/*"APPEND_SKILL_EXCHANGE_LOCK"*/, 0LL);
  ...
  {
LABEL_32:
    sub_1C13F80(appendSkillBaseIconComp, v31);
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( v52 )
      goto LABEL_22;
LABEL_26:
    appendSkillBaseIconComp = LocalizationManager__Get((System_String_o *)StringLiteral_2127/*"APPEND_SKILL_EXCHANGE_TITLE"*/, 0LL);
  ...
  if ( !IsExchangeLimited )
    goto LABEL_26;
LABEL_22:
  v53 = LocalizationManager__Get((System_String_o *)StringLiteral_2118/*"APPEND_SKILL_EXCHANGE_LV"*/, 0LL);
  v67 = remainingCount;
  ...
  v58 = LocalizationManager__Get((System_String_o *)StringLiteral_2122/*"APPEND_SKILL_EXCHANGE_PRESELECT_TARGET_INFO"*/, 0LL);
  v66 = remainingCount;
...
LABEL_27:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  appendSkillBaseIconComp = LocalizationManager__Get((System_String_o *)StringLiteral_3800/*"COMMON"*/, 0LL);
  if ( !decideButtonLabel )
    goto LABEL_32;
  UILabel__set_text(decideButtonLabel, appendSkillBaseIconComp, 0LL);
  cancelButtonLabel = this->fields.cancelButtonLabel;
  appendSkillBaseIconComp = LocalizationManager__Get((System_String_o *)StringLiteral_3798/*"COMMAND_TYPE_NAME_{0}"*/, 0LL);
