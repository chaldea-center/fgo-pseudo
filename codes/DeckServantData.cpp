void __fastcall DeckServantData___ctor(DeckServantData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36D0F & 1) == 0 )
  {
    ...
    sub_1BD3458(&long___TypeInfo, v4);
    byte_4B36D0F = 1;
  }
  ...
  v6 = (struct System_Int64_array *)sub_1BD3500(long___TypeInfo, (unsigned int)v5->static_fields->SvtEquipMax);
  this->fields.userSvtEquipIds = v6;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.userSvtEquipIds, (int64_t)v6, v7, v8, v9, v10, v11, v12);
  v13 = (struct System_Int32_array *)sub_1BD3500(
                                       int___TypeInfo,
                                       (unsigned int)BalanceConfig_TypeInfo->static_fields->SvtEquipMax);
  this->fields.svtEquipIds = v13;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.svtEquipIds, (int64_t)v13, v14, v15, v16, v17, v18, v19);
}
...
DeckServantData_o *__fastcall DeckServantData__Clone(DeckServantData_o *this, const MethodInfo *method)
{
  ...
  v5 = sub_1BD36A4(DeckServantData_TypeInfo);
  ...
  *(_DWORD *)(v5 + 32) = this->fields.svtId;
  ...
  if ( !userSvtEquipIds
    || (v9 = System_Array__Clone(userSvtEquipIds, 0LL),
        *(_QWORD *)(v5 + 40) = sub_1BD3594(v9, long___TypeInfo),
        v10 = sub_1BD3594(v9, long___TypeInfo),
        sub_1BD33FC((PartyOrganizationUtility_o *)(v5 + 40), v10, v11, v12, v13, v14, v15, v16),
        (userSvtEquipIds = (System_Array_o *)this->fields.svtEquipIds) == 0LL) )
  {
LABEL_7:
    sub_1BD36B4(userSvtEquipIds, v8);
  }
  v17 = System_Array__Clone(userSvtEquipIds, 0LL);
  *(_QWORD *)(v5 + 48) = sub_1BD3594(v17, int___TypeInfo);
  v18 = sub_1BD3594(v17, int___TypeInfo);
  sub_1BD33FC((PartyOrganizationUtility_o *)(v5 + 48), v18, v19, v20, v21, v22, v23, v24);
