void __fastcall DeckServantData___ctor(DeckServantData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE6C2 & 1) == 0 )
  {
    ...
    sub_1B64A00(&long___TypeInfo, v4);
    byte_49FE6C2 = 1;
  }
  ...
  v6 = (struct System_Int64_array *)sub_1B64AA8(long___TypeInfo, (unsigned int)v5->static_fields->SvtEquipMax);
  this->fields.userSvtEquipIds = v6;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.userSvtEquipIds, (int32_t)v6, v7, v8);
  v9 = (struct System_Int32_array *)sub_1B64AA8(
                                      int___TypeInfo,
                                      (unsigned int)BalanceConfig_TypeInfo->static_fields->SvtEquipMax);
  this->fields.svtEquipIds = v9;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.svtEquipIds, (int32_t)v9, v10, v11);
}
...
DeckServantData_o *__fastcall DeckServantData__Clone(DeckServantData_o *this, const MethodInfo *method)
{
  ...
  v5 = sub_1B64C4C(DeckServantData_TypeInfo);
  ...
  *(_DWORD *)(v5 + 32) = this->fields.svtId;
  ...
  if ( !userSvtEquipIds
    || (v9 = System_Array__Clone(userSvtEquipIds, 0LL),
        *(_QWORD *)(v5 + 40) = sub_1B64B3C(v9, long___TypeInfo),
        v10 = sub_1B64B3C(v9, long___TypeInfo),
        sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 40), v10, v11, v12),
        (userSvtEquipIds = (System_Array_o *)this->fields.svtEquipIds) == 0LL) )
  {
LABEL_7:
    sub_1B64C5C(userSvtEquipIds, v8);
  }
  v13 = System_Array__Clone(userSvtEquipIds, 0LL);
  *(_QWORD *)(v5 + 48) = sub_1B64B3C(v13, int___TypeInfo);
  v14 = sub_1B64B3C(v13, int___TypeInfo);
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v5 + 48), v14, v15, v16);
