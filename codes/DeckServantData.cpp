void DeckServantData___ctor(DeckServantData_o *this, const MethodInfo *method)
{
  ...
  v4 = (struct System_Int64_array *)sub_1C93B7C(long___TypeInfo, (unsigned int)v3->static_fields->SvtEquipMax);
  this->fields.userSvtEquipIds = v4;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.userSvtEquipIds, (int32_t)v4, v5, v6, v7, v8, v9, v10);
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.svtEquipIds, (int32_t)v11, v12, v13, v14, v15, v16, v17);
}
...
DeckServantData_o *DeckServantData__Clone(DeckServantData_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_1C93D20(DeckServantData_TypeInfo);
  ...
  *(_DWORD *)(v3 + 32) = this->fields.svtId;
  ...
  if ( !userSvtEquipIds
    || (v7 = System_Array__Clone(userSvtEquipIds, 0),
        *(_QWORD *)(v3 + 40) = sub_1C93C10(v7, long___TypeInfo),
        v8 = sub_1C93C10(v7, long___TypeInfo),
        sub_1C93A78((GrandQuestFolderBoardItem_o *)(v3 + 40), v8, v9, v10, v11, v12, v13, v14),
        (userSvtEquipIds = (System_Array_o *)this->fields.svtEquipIds) == 0) )
  {
LABEL_7:
    sub_1C93D2C(userSvtEquipIds, v6);
  }
  v15 = System_Array__Clone(userSvtEquipIds, 0);
  *(_QWORD *)(v3 + 48) = sub_1C93C10(v15, int___TypeInfo);
  v16 = sub_1C93C10(v15, int___TypeInfo);
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v3 + 48), v16, v17, v18, v19, v20, v21, v22);
