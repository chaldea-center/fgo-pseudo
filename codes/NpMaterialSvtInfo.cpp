void __fastcall NpMaterialSvtInfo___ctor(NpMaterialSvtInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.iconLabelInfo, (int64_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB4D8 & 1) == 0 )
  {
    sub_1C1ABD4(&AtlasManager_TypeInfo, *(_QWORD *)&idx);
    ...
    sub_1C1ABD4(&StringLiteral_23335/*"ribbon_noblephantasmup_01"*/, v14);
    byte_4BCB4D8 = 1;
  }
  ...
  npLvInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !npLvInfo )
    goto LABEL_21;
  ...
  if ( !iconLabelInfo )
    goto LABEL_21;
  IconLabelInfo__Set_39335328(iconLabelInfo, 2, m_CachedPtr, (int32_t)npLvInfo, 0, 0, 0, 0, 0LL);
        ...
        if ( v34 )
        {
          ...
          if ( *p_selectUsrSvtEnt )
          {
            if ( UserServantEntity__IsMaterialTd((UserServantEntity_o *)npLvInfo, 0LL) )
            {
              ...
              AtlasManager__SetEventSprite(v35, (System_String_o *)StringLiteral_23335/*"ribbon_noblephantasmup_01"*/, 0LL);
            }
            goto LABEL_20;
          }
        }
...
LABEL_21:
    sub_1C1AE30(npLvInfo, *(_QWORD *)&idx);
  }
LABEL_20:
...
LABEL_9:
  ...
  UIIconLabel__Set_39433952((UIIconLabel_o *)selectUsrSvtEnt, 33, lv, tdInfo->fields.maxLv, 0, 0LL, 0, 0, 0, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A60830;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A607D8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB4DA & 1) == 0 )
  {
    sub_1C1ABD4(&long_TypeInfo, *(_QWORD *)&type);
    sub_1C1ABD4(&CombineMenuControl_TargetType_TypeInfo, v9);
    byte_4BCB4DA = 1;
  }
  v14[2] = 0LL;
