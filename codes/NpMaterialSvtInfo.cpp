void NpMaterialSvtInfo___ctor(NpMaterialSvtInfo_o *this, const MethodInfo *method)
{
  ...
  v3 = (IconLabelInfo_o *)sub_1CE694C(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v3, 0);
  this->fields.iconLabelInfo = v3;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.iconLabelInfo, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  npLvInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !npLvInfo )
    goto LABEL_21;
  ...
  if ( !iconLabelInfo )
    goto LABEL_21;
  IconLabelInfo__Set_42060700(iconLabelInfo, 2, m_CachedPtr, (int32_t)npLvInfo, 0, 0, 0, 0, 0, 0);
...
LABEL_21:
    sub_1CE6958(npLvInfo, *(_QWORD *)&idx);
  }
LABEL_20:
...
LABEL_9:
  ...
  UIIconLabel__Set_42257736((UIIconLabel_o *)selectUsrSvtEnt, 33, lv, tdInfo->fields.maxLv, 0, 0, 0, 0, 0, 0, 0);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B1C704;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B1C6AC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E08BA7 & 1) == 0 )
  {
    ...
    sub_1CE6700(&CombineMenuControl_TargetType_TypeInfo);
    byte_4E08BA7 = 1;
  }
  v10[2] = 0;
