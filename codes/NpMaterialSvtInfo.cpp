void __fastcall NpMaterialSvtInfo___ctor(NpMaterialSvtInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B20369 & 1) == 0 )
  {
    sub_1BCAFF8(&IconLabelInfo_TypeInfo, method);
    byte_4B20369 = 1;
  }
  v3 = (IconLabelInfo_o *)sub_1BCB244(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v3, 0LL);
  this->fields.iconLabelInfo = v3;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.iconLabelInfo, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B20368 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_22902/*"ribbon_noblephantasmup_01"*/, v14);
    byte_4B20368 = 1;
  }
  ...
  npLvInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !npLvInfo )
    goto LABEL_21;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.selectUsrSvtEnt, (int32_t)Entity, v18, v19);
  ...
  if ( !iconLabelInfo )
    goto LABEL_21;
  IconLabelInfo__Set_40103972(iconLabelInfo, 2, m_CachedPtr, (int32_t)npLvInfo, 0, 0, 0, 0, 0, 0LL);
        ...
        if ( v26 )
        {
          ...
          if ( *p_selectUsrSvtEnt )
          {
            if ( UserServantEntity__IsMaterialTd((UserServantEntity_o *)npLvInfo, 0LL) )
            {
              ...
              AtlasManager__SetEventSprite(v27, (System_String_o *)StringLiteral_22902/*"ribbon_noblephantasmup_01"*/, 0LL);
            }
            goto LABEL_20;
          }
        }
...
LABEL_21:
    sub_1BCB254(npLvInfo, *(_QWORD *)&idx);
  }
LABEL_20:
  this->fields.callbackFunc = callback;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, v24, v25);
}
...
LABEL_9:
  ...
  UIIconLabel__Set_40290232((UIIconLabel_o *)selectUsrSvtEnt, 33, lv, tdInfo->fields.maxLv, 0, 0LL, 0, 0, 0, 0, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A19C68;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A19C10;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B2036A & 1) == 0 )
  {
    sub_1BCAFF8(&long_TypeInfo, *(_QWORD *)&type);
    sub_1BCAFF8(&CombineMenuControl_TargetType_TypeInfo, v9);
    byte_4B2036A = 1;
  }
  v14[2] = 0LL;
