void __fastcall NpMaterialSvtInfo___ctor(NpMaterialSvtInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.iconLabelInfo, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC09 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_22841/*"ribbon_noblephantasmup_01"*/, v14);
    byte_49FFC09 = 1;
  }
  ...
  npLvInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !npLvInfo )
    goto LABEL_21;
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.selectUsrSvtEnt, (int32_t)Entity, v18, v19);
  ...
  if ( !iconLabelInfo )
    goto LABEL_21;
  IconLabelInfo__Set_37825360(iconLabelInfo, 2, m_CachedPtr, (int32_t)npLvInfo, 0, 0, 0, 0, 0LL);
        ...
        if ( v26 )
        {
          ...
          if ( *p_selectUsrSvtEnt )
          {
            if ( UserServantEntity__IsMaterialTd((UserServantEntity_o *)npLvInfo, 0LL) )
            {
              ...
              AtlasManager__SetEventSprite(v27, (System_String_o *)StringLiteral_22841/*"ribbon_noblephantasmup_01"*/, 0LL);
            }
            goto LABEL_20;
          }
        }
...
LABEL_9:
  ...
  UIIconLabel__Set_37921148((UIIconLabel_o *)selectUsrSvtEnt, 33, lv, tdInfo->fields.maxLv, 0, 0LL, 0, 0, 0, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B04DC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B0484;
}
...
{
  __int64 v9; // x1
  __int64 v11[3]; // [xsp+0h] [xbp-60h] BYREF
  int64_t v12; // [xsp+18h] [xbp-48h] BYREF
  ...
  if ( (byte_49FFC0B & 1) == 0 )
  {
    sub_1B640C8(&long_TypeInfo, *(_QWORD *)&type);
    sub_1B640C8(&CombineMenuControl_TargetType_TypeInfo, v9);
    byte_49FFC0B = 1;
  }
  v11[2] = 0LL;
