        ...
        const MethodInfo *method)
{
  ...
  npLvInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !npLvInfo )
    goto LABEL_21;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.selectUsrSvtEnt, (int32_t)Entity, v13, v14);
  ...
  if ( !iconLabelInfo )
    goto LABEL_21;
  IconLabelInfo__Set_40818388(iconLabelInfo, 2, m_CachedPtr, (int32_t)npLvInfo, 0, 0, 0, 0, 0, 0);
        ...
        if ( v21 )
        {
          ...
          if ( *p_selectUsrSvtEnt )
          {
            if ( UserServantEntity__IsMaterialTd((UserServantEntity_o *)npLvInfo, 0) )
            {
              ...
              AtlasManager__SetEventSprite(v22, (System_String_o *)StringLiteral_23108/*"ribbon_noblephantasmup_01"*/, 0);
            }
            goto LABEL_20;
          }
        }
...
LABEL_21:
    sub_1C32E7C(npLvInfo);
  }
LABEL_20:
  this->fields.callbackFunc = callback;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, v19, v20);
}
...
LABEL_9:
  ...
  UIIconLabel__Set_41010828((UIIconLabel_o *)selectUsrSvtEnt, 33, lv, tdInfo->fields.maxLv, 0, 0, 0, 0, 0, 0, 0);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A7BD28;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A7BCD0;
}
