void __fastcall NpMaterialSvtInfo___ctor(NpMaterialSvtInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A23321 & 1) == 0 )
  {
    sub_1B715CC(&IconLabelInfo_TypeInfo, method);
    byte_4A23321 = 1;
  }
  v3 = (IconLabelInfo_o *)sub_1B71818(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v3, 0LL);
  this->fields.iconLabelInfo = v3;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.iconLabelInfo, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23320 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22879/*"ribbon_noblephantasmup_01"*/, v14);
    byte_4A23320 = 1;
  }
  ...
  npLvInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !npLvInfo )
    goto LABEL_21;
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.selectUsrSvtEnt, (int32_t)Entity, v18, v19);
  ...
  if ( !iconLabelInfo )
    goto LABEL_21;
  IconLabelInfo__Set_37935228(iconLabelInfo, 2, m_CachedPtr, (int32_t)npLvInfo, 0, 0, 0, 0, 0LL);
        ...
        if ( v26 )
        {
          ...
          if ( *p_selectUsrSvtEnt )
          {
            if ( UserServantEntity__IsMaterialTd((UserServantEntity_o *)npLvInfo, 0LL) )
            {
              ...
              AtlasManager__SetEventSprite(v27, (System_String_o *)StringLiteral_22879/*"ribbon_noblephantasmup_01"*/, 0LL);
            }
            goto LABEL_20;
          }
        }
...
LABEL_21:
    sub_1B71828(npLvInfo, *(_QWORD *)&idx);
  }
LABEL_20:
  this->fields.callbackFunc = callback;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callback, v24, v25);
}
...
LABEL_9:
  ...
  UIIconLabel__Set_38031016((UIIconLabel_o *)selectUsrSvtEnt, 33, lv, tdInfo->fields.maxLv, 0, 0LL, 0, 0, 0, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19BD62C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19BD5D4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23322 & 1) == 0 )
  {
    sub_1B715CC(&long_TypeInfo, *(_QWORD *)&type);
    sub_1B715CC(&CombineMenuControl_TargetType_TypeInfo, v9);
    byte_4A23322 = 1;
  }
  v14[2] = 0LL;
