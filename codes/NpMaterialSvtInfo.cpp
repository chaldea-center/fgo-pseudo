void __fastcall NpMaterialSvtInfo___ctor(NpMaterialSvtInfo_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.iconLabelInfo, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05E25 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_22883/*"ribbon_noblephantasmup_01"*/, v14);
    byte_4B05E25 = 1;
  }
  ...
  npLvInfo = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !npLvInfo )
    goto LABEL_21;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.selectUsrSvtEnt, (int32_t)Entity, v18, v19);
  ...
  if ( !iconLabelInfo )
    goto LABEL_21;
  IconLabelInfo__Set_39947860(iconLabelInfo, 2, m_CachedPtr, (int32_t)npLvInfo, 0, 0, 0, 0, 0, 0LL);
...
LABEL_21:
    sub_1BC3264(npLvInfo, *(_QWORD *)&idx);
  }
LABEL_20:
...
LABEL_9:
  ...
  UIIconLabel__Set_40054380((UIIconLabel_o *)selectUsrSvtEnt, 33, lv, tdInfo->fields.maxLv, 0, 0LL, 0, 0, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05E27 & 1) == 0 )
  {
    sub_1BC3008(&long_TypeInfo, *(_QWORD *)&type);
    sub_1BC3008(&CombineMenuControl_TargetType_TypeInfo, v9);
    byte_4B05E27 = 1;
  }
  v14[2] = 0LL;
