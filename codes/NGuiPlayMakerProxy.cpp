...
System_String_o *NGuiPlayMakerProxy__GetFsmEventEnumValue(System_Enum_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4CC51FF & 1) == 0 )
  {
    sub_1C713B0(&PlayMakerUtils_FsmEvent___TypeInfo);
    sub_1C713B0(&PlayMakerUtils_FsmEvent_var);
    value = (System_Enum_o *)sub_1C713B0(&System_Type_TypeInfo);
    byte_4CC51FF = 1;
  }
  if ( !v2 )
    goto LABEL_14;
  ...
  value = (System_Enum_o *)sub_1C714EC(v8, PlayMakerUtils_FsmEvent___TypeInfo);
  if ( !value )
    goto LABEL_14;
