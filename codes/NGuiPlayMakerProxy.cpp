...
System_String_o *NGuiPlayMakerProxy__GetFsmEventEnumValue(System_Enum_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4C54B8F & 1) == 0 )
  {
    sub_1C3E564(&PlayMakerUtils_FsmEvent___TypeInfo);
    sub_1C3E564(&PlayMakerUtils_FsmEvent_var);
    value = (System_Enum_o *)sub_1C3E564(&System_Type_TypeInfo);
    byte_4C54B8F = 1;
  }
  if ( !v2 )
    goto LABEL_14;
  ...
  value = (System_Enum_o *)sub_1C3E6A0(v8, PlayMakerUtils_FsmEvent___TypeInfo);
  if ( !value )
    goto LABEL_14;
  ...
  {
    if ( !(_DWORD)monitor )
      sub_1C3E7C8(value, method);
    klass = value[2].klass;
    if ( klass )
      return (System_String_o *)klass->_1.name;
LABEL_14:
    sub_1C3E7C0(value, method);
  }
  return 0;
}
