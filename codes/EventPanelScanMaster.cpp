void __fastcall EventPanelScanMaster___ctor(EventPanelScanMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE562 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int___ctor__, method);
    byte_49FE562 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    344,
    (const MethodInfo_30D6140 *)Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE563 & 1) == 0 )
  {
    ...
    sub_1B64870(&EventPanelScanEntity_TypeInfo, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_EventPanelScanEntity__Add__, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_EventPanelScanEntity__ToArray__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_EventPanelScanEntity___ctor__, v9);
    sub_1B64870(&System_Collections_Generic_List_EventPanelScanEntity__TypeInfo, v10);
    byte_49FE563 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_EventPanelScanEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_EventPanelScanEntity___ctor__);
...
LABEL_17:
  ...
  return (EventPanelScanEntity_array *)System_Collections_Generic_List_object___ToArray(
                                         v11,
                                         (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_EventPanelScanEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE564 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_CommonReleaseMaster___, entity);
...
LABEL_9:
    sub_1B64ACC(Instance, commonReleaseId);
  }
  return 1;
}