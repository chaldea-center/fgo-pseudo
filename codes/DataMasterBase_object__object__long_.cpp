void __fastcall DataMasterBase_object__object__long____ctor(
        ...
        int32_t kind,
        const MethodInfo_30D4010 *method)
{
  __int64 v5; // x0
...
void __fastcall DataMasterBase_object__object__long___ForForceDerived(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_30D41B8 *method)
{
  ;
}
...
Il2CppObject *__fastcall DataMasterBase_object__object__long___GetEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        int64_t key,
        const MethodInfo_30D4050 *method)
{
  System_String_o *v5; // x0
  int64_t v7; // [xsp+8h] [xbp-18h] BYREF

  v7 = key;
  v5 = System_Int64__ToString((int64_t)&v7, method->klass->rgctx_data->_3_DataMasterBase_getEntityFromKey_TEntity_);
  if ( !this )
    sub_1B64324(v5);
...
Il2CppObject *__fastcall DataMasterBase_object__object__long___GetSingleEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_30D410C *method)
{
  if ( !this )
    sub_1B64324(0LL);
...
bool __fastcall DataMasterBase_object__object__long___TryGetEntity(
        ...
        Il2CppObject **entity,
        int64_t key,
        const MethodInfo_30D40A4 *method)
{
  System_String_o *v7; // x0
  int64_t v9; // [xsp+8h] [xbp-28h] BYREF

  v9 = key;
  v7 = System_Int64__ToString((int64_t)&v9, method->klass->rgctx_data->_3_DataMasterBase_getEntityFromKey_TEntity_);
  if ( !this )
    sub_1B64324(v7);
...
bool __fastcall DataMasterBase_object__object__long___TryGetSingleEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject **entity,
        const MethodInfo_30D412C *method)
{
  if ( !this )
    sub_1B64324(0LL);
...
DataEntityBase_array *__fastcall DataMasterBase_object__object__long___getList(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *obj,
        const MethodInfo_30D414C *method)
{
  if ( (byte_4A021A7 & 1) == 0 )
  {
