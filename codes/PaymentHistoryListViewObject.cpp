...
void __fastcall PaymentHistoryListViewObject__Awake(PaymentHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B70F1 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_PaymentHistoryListViewItemDraw___, method);
    byte_49B70F1 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_PaymentHistoryListViewItemDraw___);
...
void __fastcall PaymentHistoryListViewObject__SetupDisp(PaymentHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B70F2 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&PaymentHistoryListViewItem_TypeInfo, v3);
    byte_49B70F2 = 1;
  }
