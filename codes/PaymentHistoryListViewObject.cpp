...
void __fastcall PaymentHistoryListViewObject__Awake(PaymentHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A050B4 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_PaymentHistoryListViewItemDraw___, method);
    byte_4A050B4 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_PaymentHistoryListViewItemDraw___);
...
void __fastcall PaymentHistoryListViewObject__SetupDisp(PaymentHistoryListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A050B5 & 1) == 0 )
  {
    ...
    sub_1B686D4(&PaymentHistoryListViewItem_TypeInfo, v3);
    byte_4A050B5 = 1;
  }
