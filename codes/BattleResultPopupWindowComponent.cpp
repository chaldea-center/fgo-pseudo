        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BE2B & 1) == 0 )
  {
    sub_1B686D4(&BattleWindowComponent_EndCall_TypeInfo, call);
    byte_4A0BE2B = 1;
  }
  this->fields.callbackClose = call;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.callbackClose, (int32_t)call, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v2->fields.callbackOpen, 0, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.callbackOpen, (int32_t)call, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BE2A & 1) == 0 )
  {
    sub_1B686D4(&Method_BattleResultPopupWindowComponent_OpenedPostProcess__, method);
    byte_4A0BE2A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleResultPopupWindowComponent_OpenedPostProcess__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1B686EC(Method_BattleResultPopupWindowComponent_OpenedPostProcess__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BE2F & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, anim);
    byte_4A0BE2F = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)anim, 0LL, 0LL) )
  {
    ...
    if ( IsNullOrEmpty )
    {
      ...
      UnityEngine_Animation__Play_68916908(anim, clipName, 0LL);
      return;
    }
LABEL_14:
...
LABEL_20:
  ...
  {
LABEL_16:
    v14 = sub_1BBA6B4(IsNullOrEmpty, SimpleAnimation_State_TypeInfo, 4LL);
  }
  (*(void (__fastcall **)(UnityEngine_Object_o *, _QWORD, float))v14)(v11, *(_QWORD *)(v14 + 8), 0.0);
  SimpleAnimation__Play_63557140(anim, clipName, 0LL);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BE2D & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, eventName);
    byte_4A0BE2D = 1;
  }
