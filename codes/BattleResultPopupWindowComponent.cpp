        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9096 & 1) == 0 )
  {
    sub_1BAB41C(&BattleWindowComponent_EndCall_TypeInfo, call);
    byte_4AB9096 = 1;
  }
  this->fields.callbackClose = call;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.callbackClose, (int32_t)call, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  BattleResultPopupWindowComponent__SendFsmEvent(this, (System_String_o *)StringLiteral_5491/*"END_PROC"*/, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v2->fields.callbackOpen, 0, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.callbackOpen, (int32_t)call, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9095 & 1) == 0 )
  {
    sub_1BAB41C(&Method_BattleResultPopupWindowComponent_OpenedPostProcess__, method);
    byte_4AB9095 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleResultPopupWindowComponent_OpenedPostProcess__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1BAB434(Method_BattleResultPopupWindowComponent_OpenedPostProcess__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB909A & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, anim);
    byte_4AB909A = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)anim, 0LL, 0LL) )
  {
    ...
    if ( IsNullOrEmpty )
    {
      ...
      UnityEngine_Animation__Play_69545712(anim, clipName, 0LL);
      return;
    }
LABEL_14:
...
LABEL_20:
  ...
  {
LABEL_16:
    v14 = sub_1BFD3FC(IsNullOrEmpty, SimpleAnimation_State_TypeInfo, 4LL);
  }
  (*(void (__fastcall **)(UnityEngine_Object_o *, _QWORD, float))v14)(v11, *(_QWORD *)(v14 + 8), 0.0);
  SimpleAnimation__Play_64185800(anim, clipName, 0LL);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9098 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, eventName);
    byte_4AB9098 = 1;
  }
