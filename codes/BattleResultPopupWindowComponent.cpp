        ...
        const MethodInfo *method)
{
  ...
  BattleResultPopupWindowComponent__SendFsmEvent(this, (System_String_o *)StringLiteral_5538/*"END_PROC"*/, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&v2->fields.callbackOpen, 0LL, v3, v4, v5, v6, v7, v8);
  v2->fields.callbackClose = 0LL;
  v2 = (BattleResultPopupWindowComponent_o *)((char *)v2 + 120);
  sub_B52920((BattleServantConfConponent_o *)v2, 0LL, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)anim, 0LL, 0LL) )
  {
    ...
    if ( IsNullOrEmpty )
    {
      ...
      UnityEngine_Animation__Play_51067744(anim, clipName, 0LL);
      return;
    }
LABEL_15:
...
LABEL_21:
  ...
  {
LABEL_18:
    v14 = sub_AEB880(IsNullOrEmpty, SimpleAnimation_State_TypeInfo, 4LL, v9);
  }
  (*(void (__fastcall **)(UnityEngine_Object_o *, _QWORD, float))v14)(v11, *(_QWORD *)(v14 + 8), 0.0);
  SimpleAnimation__Play_16625408(anim, clipName, 0LL);
  return 1;
}
