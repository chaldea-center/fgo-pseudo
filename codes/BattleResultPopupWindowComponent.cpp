        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22CB3 & 1) == 0 )
  {
    sub_1B715CC(&BattleWindowComponent_EndCall_TypeInfo, call);
    byte_4A22CB3 = 1;
  }
  this->fields.callbackClose = call;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.callbackClose, (int32_t)call, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  BattleResultPopupWindowComponent__SendFsmEvent(this, (System_String_o *)StringLiteral_5469/*"END_PROC"*/, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v2->fields.callbackOpen, 0, v3, v4);
  v2->fields.callbackClose = 0LL;
  v2 = (BattleResultPopupWindowComponent_o *)((char *)v2 + 128);
  sub_1B71570((ServantStatusBattleListViewItem_o *)v2, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.callbackOpen, (int32_t)call, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22CB2 & 1) == 0 )
  {
    sub_1B715CC(&Method_BattleResultPopupWindowComponent_OpenedPostProcess__, method);
    byte_4A22CB2 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleResultPopupWindowComponent_OpenedPostProcess__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1B715E4(Method_BattleResultPopupWindowComponent_OpenedPostProcess__);
  v3 = (System_Reflection_MethodBase_o *)sub_1B715B0(v2, v2[4]);
  OverwriteAssetSoundName__PlaySystemSe(v3, 6, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22CB7 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, anim);
    byte_4A22CB7 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)anim, 0LL, 0LL) )
  {
    ...
    if ( IsNullOrEmpty )
    {
      ...
      UnityEngine_Animation__Play_69002944(anim, clipName, 0LL);
      return;
    }
LABEL_14:
...
LABEL_20:
  ...
  {
LABEL_16:
    v14 = sub_1BC35AC(IsNullOrEmpty, SimpleAnimation_State_TypeInfo, 4LL);
  }
  (*(void (__fastcall **)(UnityEngine_Object_o *, _QWORD, float))v14)(v11, *(_QWORD *)(v14 + 8), 0.0);
  SimpleAnimation__Play_63643176(anim, clipName, 0LL);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22CB5 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, eventName);
    byte_4A22CB5 = 1;
  }
