        ...
        const MethodInfo *method)
{
  ...
  v10 = (BattleWindowComponent_EndCall_o *)sub_1C93D20(BattleWindowComponent_EndCall_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  BattleResultPopupWindowComponent__SendFsmEvent(this, (System_String_o *)StringLiteral_5480/*"END_PROC"*/, v5);
}
...
void BattleResultPopupWindowComponent__InitPopup(BattleResultPopupWindowComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v2->fields.callbackOpen, 0, v3, v4, v5, v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D344A5 & 1) == 0 )
  {
    sub_1C93AD4(&Method_BattleResultPopupWindowComponent_OpenedPostProcess__);
    byte_4D344A5 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleResultPopupWindowComponent_OpenedPostProcess__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1C93AEC(Method_BattleResultPopupWindowComponent_OpenedPostProcess__);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)anim, 0, 0) )
  {
    ...
    if ( IsNullOrEmpty )
    {
      ...
      UnityEngine_Animation__Play_71862428(anim, clipName, 0);
      return;
    }
LABEL_14:
...
LABEL_20:
  ...
  {
LABEL_16:
    v13 = sub_1C69E5C(IsNullOrEmpty, SimpleAnimation_State_TypeInfo, 4);
  }
  (*(void (__fastcall **)(UnityEngine_Object_o *, _QWORD, float))v13)(v10, *(_QWORD *)(v13 + 8), 0.0);
  SimpleAnimation__Play_67370764(anim, clipName, 0);
  return v6;
}
