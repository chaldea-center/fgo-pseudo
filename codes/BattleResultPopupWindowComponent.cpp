        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.callbackClose, (int32_t)call, (int32_t)method, v3);
...
void BattleResultPopupWindowComponent__InitPopup(BattleResultPopupWindowComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&v2->fields.callbackOpen, 0, v3, v4);
  v2->fields.callbackClose = 0;
  v2 = (BattleResultPopupWindowComponent_o *)((char *)v2 + 128);
  sub_1C3E508((CGThumbnailListItem_o *)v2, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.callbackOpen, (int32_t)call, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A67B & 1) == 0 )
  {
    sub_1C3E564(&Method_BattleResultPopupWindowComponent_OpenedPostProcess__);
    byte_4C5A67B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleResultPopupWindowComponent_OpenedPostProcess__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1C3E57C(Method_BattleResultPopupWindowComponent_OpenedPostProcess__);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)anim, 0, 0) )
  {
    ...
    if ( IsNullOrEmpty )
    {
      ...
      UnityEngine_Animation__Play_71086848(anim, clipName, 0);
      return;
    }
LABEL_14:
...
LABEL_20:
  ...
  {
LABEL_16:
    v13 = sub_1C8ED7C(IsNullOrEmpty, SimpleAnimation_State_TypeInfo, 4);
  }
  (*(void (__fastcall **)(UnityEngine_Object_o *, _QWORD, float))v13)(v10, *(_QWORD *)(v13 + 8), 0.0);
  SimpleAnimation__Play_66582224(anim, clipName, 0);
  return v6;
}
