        ...
        const MethodInfo *method)
{
  ...
  sub_2213A04(&this->fields._path_k__BackingField, path);
  ...
  if ( srcBinder )
  {
    ...
    sub_2213A04(&this->fields.newBinder, 0);
    this->fields.refBinder = srcBinder;
    sub_2213A04(&this->fields.refBinder, srcBinder);
  ...
  {
    v16 = (CriFsBinder_o *)sub_2213CCC(CriFsBinder_TypeInfo);
    CriFsBinder___ctor(v16, v17);
    this->fields.newBinder = v16;
    sub_2213A04(&this->fields.newBinder, v16);
    newBinder = this->fields.newBinder;
    this->fields.refBinder = newBinder;
    sub_2213A04(&this->fields.refBinder, newBinder);
...
void CriFsLoadFileRequest__Dispose(CriFsLoadFileRequest_o *this, bool disposing, const MethodInfo *method)
{
  ...
  if ( loader )
  {
    ...
    sub_2213A04(&this->fields.loader, 0);
  }
  newBinder = this->fields.newBinder;
  if ( newBinder )
  {
  ...
  sub_2213A04(&this->fields._bytes_k__BackingField, 0);
}
...
void CriFsLoadFileRequest__OnError(CriFsLoadFileRequest_o *this, const MethodInfo *method)
{
  ...
  this->fields._bytes_k__BackingField = 0;
  sub_2213A04(&this->fields._bytes_k__BackingField, 0);
  v3 = StringLiteral_6397/*"Error occurred."*/;
  this->fields._error_k__BackingField = (struct System_String_o *)StringLiteral_6397/*"Error occurred."*/;
  sub_2213A04(&this->fields._error_k__BackingField, v3);
  this->fields.refBinder = 0;
  sub_2213A04(&this->fields.refBinder, 0);
  newBinder = this->fields.newBinder;
  if ( newBinder )
  {
    ((void (__fastcall *)(struct CriFsBinder_o *, const MethodInfo *))newBinder->klass->vtable._5_Dispose.methodPtr)(
...
void CriFsLoadFileRequest__UpdateLoader(CriFsLoadFileRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5969695 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_CriFsLoadFileRequest_UpdateLoader__);
    sub_2213A60(&CriFsLoader_TypeInfo);
    byte_5969695 = 1;
  }
  loader = this->fields.loader;
  if ( !loader )
  {
    v4 = (CriFsLoader_o *)sub_2213CCC(CriFsLoader_TypeInfo);
    CriFsLoader___ctor(v4, v5);
    this->fields.loader = v4;
    loader = (CriFsLoader_o *)sub_2213A04(&this->fields.loader, v4);
    ...
    v9 = (struct System_Byte_array *)sub_2213B20(byte___TypeInfo, LODWORD(this->fields.fileSize));
    this->fields._bytes_k__BackingField = v9;
    sub_2213A04(&this->fields._bytes_k__BackingField, v9);
    loader = this->fields.loader;
    if ( !loader )
      goto LABEL_20;
    CriFsLoader__Load(
...
void CriFsLoadFileRequest__set_bytes(CriFsLoadFileRequest_o *this, System_Byte_array *value, const MethodInfo *method)
{
  ...
  sub_2213A04(&this->fields._bytes_k__BackingField, value);
}
