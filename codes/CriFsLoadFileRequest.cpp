        ...
        const MethodInfo *method)
{
  ...
  if ( srcBinder )
  {
    ...
    sub_1C6B9AC(&this->fields.newBinder, 0);
    this->fields.refBinder = srcBinder;
    sub_1C6B9AC(&this->fields.refBinder, srcBinder);
  ...
  {
    v15 = (CriFsBinder_o *)sub_1C6BC54(CriFsBinder_TypeInfo);
    CriFsBinder___ctor(v15, v16);
    this->fields.newBinder = v15;
    sub_1C6B9AC(&this->fields.newBinder, v15);
    newBinder = this->fields.newBinder;
    this->fields.refBinder = newBinder;
    sub_1C6B9AC(&this->fields.refBinder, newBinder);
...
void CriFsLoadFileRequest__Dispose(CriFsLoadFileRequest_o *this, bool disposing, const MethodInfo *method)
{
  ...
  if ( loader )
  {
    ...
    sub_1C6B9AC(&this->fields.loader, 0);
  }
  newBinder = this->fields.newBinder;
  if ( newBinder )
  {
  ...
  sub_1C6B9AC(&this->fields._bytes_k__BackingField, 0);
}
...
void CriFsLoadFileRequest__OnError(CriFsLoadFileRequest_o *this, const MethodInfo *method)
{
  ...
  this->fields._bytes_k__BackingField = 0;
  sub_1C6B9AC(&this->fields._bytes_k__BackingField, 0);
  v3 = StringLiteral_6129/*"Error occurred."*/;
  this->fields._error_k__BackingField = (struct System_String_o *)StringLiteral_6129/*"Error occurred."*/;
  sub_1C6B9AC(&this->fields._error_k__BackingField, v3);
  this->fields.refBinder = 0;
  sub_1C6B9AC(&this->fields.refBinder, 0);
  newBinder = this->fields.newBinder;
  if ( newBinder )
  {
    ((void (__fastcall *)(struct CriFsBinder_o *, const MethodInfo *))newBinder->klass->vtable._5_Dispose.methodPtr)(
...
void CriFsLoadFileRequest__UpdateLoader(CriFsLoadFileRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CAF7BD & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_CriFsLoadFileRequest_UpdateLoader__);
    sub_1C6BA08(&CriFsLoader_TypeInfo);
    byte_4CAF7BD = 1;
  }
  ...
  if ( !loader )
  {
    v5 = (CriFsLoader_o *)sub_1C6BC54(CriFsLoader_TypeInfo);
    CriFsLoader___ctor(v5, v6);
    *p_loader = v5;
    sub_1C6B9AC(&this->fields.loader, v5);
    loader = *p_loader;
    if ( !*p_loader )
      goto LABEL_18;
    CriFsLoader__SetReadUnitSize(loader, this->fields.readUnitSize, v7);
    v8 = (struct System_Byte_array *)sub_1C6BAB0(byte___TypeInfo, LODWORD(this->fields.fileSize));
    this->fields._bytes_k__BackingField = v8;
    sub_1C6B9AC(&this->fields._bytes_k__BackingField, v8);
    loader = this->fields.loader;
    if ( !loader )
      goto LABEL_18;
    CriFsLoader__Load(
...
void CriFsLoadFileRequest__set_bytes(CriFsLoadFileRequest_o *this, System_Byte_array *value, const MethodInfo *method)
{
  ...
  sub_1C6B9AC(&this->fields._bytes_k__BackingField, value);
}
