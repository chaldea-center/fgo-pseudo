    ...
    if ( UnityEngine_Object__op_Inequality(v9, 0, 0) )
    {
      ...
      if ( v11 )
      {
        ...
        if ( Item )
        {
          ...
          {
LABEL_21:
            v17 = sub_1C47738(Item, SimpleAnimation_State_TypeInfo, 18);
          }
...
LABEL_15:
  ...
  if ( !AnimationName )
LABEL_42:
    sub_1C71608(AnimationName, v15);
  UnityEngine_Animation__Stop((UnityEngine_Animation_o *)AnimationName, 0);
LABEL_41:
  this->fields.totaltime = 0.0;
  this->fields.loop = 1;
  this->fields.playAnimation = 0;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.playAnimation, 0, (int32_t)v24, v25, v26, v27, v28, v29);
  ((void (__fastcall *)(MapGimmickEffectComponent_o *, __int64, const MethodInfo *))this->klass->vtable._5_NextPlayAnimation.methodPtr)(
    this,
    3,
    this->klass->vtable._5_NextPlayAnimation.method);
        ...
        const MethodInfo *method)
{
  ...
  if ( status == 6 )
  {
    ...
    v18 = &StringLiteral_16549/*"_end"*/;
    return System_String__Concat_64031724(baseName, (System_String_o *)*v18, 0);
  }
  if ( status == 4 )
  {
...
LABEL_43:
  baseName = this->fields.baseName;
  v18 = &StringLiteral_16584/*"_start"*/;
  return System_String__Concat_64031724(baseName, (System_String_o *)*v18, 0);
}
...
LABEL_13:
      ...
      if ( callAfterStart )
      {
        ...
        sub_1C71354(p_callAfterStart, 0, (int32_t)v6, v7, v8, v9, v10, v11);
...
LABEL_36:
      ...
      {
LABEL_40:
        v29 = sub_1C47738(Item, SimpleAnimation_State_TypeInfo, 9);
      }
...
LABEL_64:
  ...
  if ( !UnityEngine_Object__op_Inequality(animationComponent, 0, 0) )
  {
    if ( next == 3 )
    {
      ...
      {
        v19->klass = 0;
        sub_1C71354(v19, 0, (int32_t)v6, v7, v8, v9, v10, v11);
  ...
  {
    v30->klass = 0;
    sub_1C71354(v30, 0, (int32_t)v6, v7, v8, v9, v10, v11);
...
LABEL_25:
  ...
  if ( v16 )
  {
    ...
    {
LABEL_14:
      v21 = sub_1C47738(v16, SimpleAnimation_State_TypeInfo, 18);
    }
