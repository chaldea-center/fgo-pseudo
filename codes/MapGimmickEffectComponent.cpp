...
LABEL_40:
          ...
          sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.playAnimation, 0, (int32_t)v20, v21);
          goto LABEL_41;
        }
      }
    }
LABEL_42:
    sub_1B64C5C(AnimationName, v8);
  }
}
...
LABEL_15:
  ...
  if ( !AnimationName )
LABEL_42:
    sub_1B64C5C(AnimationName, v12);
  UnityEngine_Animation__Stop((UnityEngine_Animation_o *)AnimationName, 0LL);
LABEL_41:
  this->fields.totaltime = 0.0;
  this->fields.loop = 1;
  this->fields.playAnimation = 0LL;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.playAnimation, 0, (int32_t)v21, v22);
  ((void (__fastcall *)(MapGimmickEffectComponent_o *, __int64, Il2CppMethodPointer))this->klass->vtable._5_NextPlayAnimation.method)(
    this,
    3LL,
    this->klass->vtable._6_ForceStart.methodPtr);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB9FD & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, *(_QWORD *)&status);
    sub_1B64A00(&string_TypeInfo, v5);
    sub_1B64A00(&StringLiteral_16486/*"_loop"*/, v6);
    sub_1B64A00(&StringLiteral_16507/*"_start"*/, v7);
  ...
  if ( status == 6 )
  {
    ...
    v22 = &StringLiteral_16471/*"_end"*/;
    return System_String__Concat_61385136(baseName, (System_String_o *)*v22, 0LL);
  }
  if ( status == 4 )
  {
...
LABEL_43:
  baseName = this->fields.baseName;
  v22 = &StringLiteral_16507/*"_start"*/;
  return System_String__Concat_61385136(baseName, (System_String_o *)*v22, 0LL);
}
...
LABEL_13:
      ...
      if ( callAfterStart )
      {
        ...
        sub_1B649A4(p_callAfterStart, 0, (int32_t)v8, v9);
...
LABEL_64:
  ...
  if ( !UnityEngine_Object__op_Inequality(animationComponent, 0LL, 0LL) )
  {
    if ( v3 == 3 )
    {
      ...
      {
        v17->klass = 0LL;
        sub_1B649A4(v17, 0, (int32_t)v8, v9);
  ...
  {
    v28->klass = 0LL;
    sub_1B649A4(v28, 0, (int32_t)v8, v9);
...
LABEL_65:
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.requestAnimation, (int32_t)v32, (int32_t)v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FBA01 & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, isDestroy);
    sub_1B64A00(&SimpleAnimation_State_TypeInfo, v7);
    byte_49FBA01 = 1;
  }
  if ( this->fields.status == 2 )
