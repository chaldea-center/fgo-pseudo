...
LABEL_40:
          ...
          sub_1B8635C((CGThumbnailListItem_o *)&this->fields.playAnimation, 0, (int32_t)v20, v21);
          goto LABEL_41;
        }
      }
    }
LABEL_42:
    sub_1B86614(AnimationName, v8);
  }
}
...
LABEL_15:
  ...
  if ( !AnimationName )
LABEL_42:
    sub_1B86614(AnimationName, v12);
  UnityEngine_Animation__Stop((UnityEngine_Animation_o *)AnimationName, 0LL);
LABEL_41:
  this->fields.totaltime = 0.0;
  this->fields.loop = 1;
  this->fields.playAnimation = 0LL;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.playAnimation, 0, (int32_t)v21, v22);
  ((void (__fastcall *)(MapGimmickEffectComponent_o *, __int64, Il2CppMethodPointer))this->klass->vtable._5_NextPlayAnimation.method)(
    this,
    3LL,
    this->klass->vtable._6_ForceStart.methodPtr);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B0B9 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, *(_QWORD *)&status);
    sub_1B863B8(&string_TypeInfo, v5);
    sub_1B863B8(&StringLiteral_16320/*"_loop"*/, v6);
    sub_1B863B8(&StringLiteral_16342/*"_start"*/, v7);
  ...
  if ( status == 6 )
  {
    ...
    v22 = &StringLiteral_16305/*"_end"*/;
    return System_String__Concat_61645176(baseName, (System_String_o *)*v22, 0LL);
  }
  if ( status == 4 )
  {
...
LABEL_43:
  baseName = this->fields.baseName;
  v22 = &StringLiteral_16342/*"_start"*/;
  return System_String__Concat_61645176(baseName, (System_String_o *)*v22, 0LL);
}
...
LABEL_13:
      ...
      if ( callAfterStart )
      {
        ...
        sub_1B8635C(p_callAfterStart, 0, (int32_t)v8, v9);
...
LABEL_64:
  ...
  if ( !UnityEngine_Object__op_Inequality(animationComponent, 0LL, 0LL) )
  {
    if ( v3 == 3 )
    {
      v17 = (CGThumbnailListItem_o *)&this->fields.callAfterStart;
      v18 = this->fields.callAfterStart;
      if ( v18 )
      {
        v17->klass = 0LL;
        sub_1B8635C(v17, 0, (int32_t)v8, v9);
  ...
  v28 = (CGThumbnailListItem_o *)&this->fields.callAfterStart;
  v29 = this->fields.callAfterStart;
  if ( v29 )
  {
    v28->klass = 0LL;
    sub_1B8635C(v28, 0, (int32_t)v8, v9);
...
LABEL_65:
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.requestAnimation, (int32_t)v32, (int32_t)v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B0BD & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, isDestroy);
    sub_1B863B8(&SimpleAnimation_State_TypeInfo, v7);
    byte_4A4B0BD = 1;
  }
  if ( this->fields.status == 2 )
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.callAfterStop, (int32_t)callback, (int32_t)callback, method);
  simpleAnimationComponent = (UnityEngine_Object_o *)this->fields.simpleAnimationComponent;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( !UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0LL, 0LL) )
