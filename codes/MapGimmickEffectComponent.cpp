...
LABEL_40:
          ...
          sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.playAnimation, 0, (int32_t)v19, v20);
          goto LABEL_41;
        }
      }
    }
LABEL_42:
    sub_1C6BC60(AnimationName, v7);
  }
}
...
LABEL_15:
  ...
  if ( !AnimationName )
LABEL_42:
    sub_1C6BC60(AnimationName, v11);
  UnityEngine_Animation__Stop((UnityEngine_Animation_o *)AnimationName, 0);
LABEL_41:
  this->fields.totaltime = 0.0;
  this->fields.loop = 1;
  this->fields.playAnimation = 0;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.playAnimation, 0, (int32_t)v20, v21);
  ((void (__fastcall *)(MapGimmickEffectComponent_o *, __int64, const MethodInfo *))this->klass->vtable._5_NextPlayAnimation.methodPtr)(
    this,
    3,
    this->klass->vtable._5_NextPlayAnimation.method);
        ...
        const MethodInfo *method)
{
  ...
  if ( status == 6 )
  {
    ...
    v18 = &StringLiteral_16542/*"_end"*/;
    return System_String__Concat_63966792(baseName, (System_String_o *)*v18, 0);
  }
  if ( status == 4 )
  {
...
LABEL_43:
  baseName = this->fields.baseName;
  v18 = &StringLiteral_16577/*"_start"*/;
  return System_String__Concat_63966792(baseName, (System_String_o *)*v18, 0);
}
...
LABEL_13:
      ...
      if ( callAfterStart )
      {
        ...
        sub_1C6B9AC(p_callAfterStart, 0, (int32_t)v6, v7);
...
LABEL_36:
      ...
      {
LABEL_40:
        v25 = sub_1C41D90(Item, SimpleAnimation_State_TypeInfo, 9);
      }
...
LABEL_64:
  ...
  if ( !UnityEngine_Object__op_Inequality(animationComponent, 0, 0) )
  {
    if ( next == 3 )
    {
      ...
      {
        v15->klass = 0;
        sub_1C6B9AC(v15, 0, (int32_t)v6, v7);
  ...
  {
    v26->klass = 0;
    sub_1C6B9AC(v26, 0, (int32_t)v6, v7);
...
LABEL_65:
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.requestAnimation, (int32_t)v30, (int32_t)v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.callAfterStop, (int32_t)callback, (int32_t)callback, method);
  simpleAnimationComponent = (UnityEngine_Object_o *)this->fields.simpleAnimationComponent;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( !UnityEngine_Object__op_Inequality(simpleAnimationComponent, 0, 0) )
