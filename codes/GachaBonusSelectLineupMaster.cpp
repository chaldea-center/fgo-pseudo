void __fastcall GachaBonusSelectLineupMaster___ctor(GachaBonusSelectLineupMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    190,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_GachaBonusSelectLineupMaster__GachaBonusSelectLineupEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (GachaBonusSelectLineupEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                             PK,
                                             (const MethodInfo_312C900 *)Method_DataMasterBase_GachaBonusSelectLineupMaster__GachaBonusSelectLineupEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_GachaBonusSelectLineupMaster__GachaBonusSelectLineupEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A700DC & 1) == 0 )
  {
    ...
    sub_1B90010(&GachaBonusSelectLineupEntity_TypeInfo, v7);
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_GachaBonusSelectLineupEntity__Add__, v11);
    sub_1B90010(&Method_System_Collections_Generic_List_GachaBonusSelectLineupEntity__ToArray__, v12);
    sub_1B90010(&Method_System_Collections_Generic_List_GachaBonusSelectLineupEntity___ctor__, v13);
    sub_1B90010(&System_Collections_Generic_List_GachaBonusSelectLineupEntity__TypeInfo, v14);
    byte_4A700DC = 1;
  }
  *gachaBonusSelectLineupEntities = 0LL;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)gachaBonusSelectLineupEntities, 0, lineupId, (int32_t)method);
  v15 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_GachaBonusSelectLineupEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_GachaBonusSelectLineupEntity___ctor__);
...
LABEL_31:
  ...
  if ( !v15
    || (v42 = System_Collections_Generic_List_object___ToArray(
                v15,
                (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_GachaBonusSelectLineupEntity__ToArray__),
        *gachaBonusSelectLineupEntities = (GachaBonusSelectLineupEntity_array *)v42,
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)gachaBonusSelectLineupEntities, (int32_t)v42, v43, v44),
        !*gachaBonusSelectLineupEntities) )
  {
LABEL_39:
