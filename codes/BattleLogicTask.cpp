void __fastcall BattleLogicTask___ctor(BattleLogicTask_o *this, const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.targetIdlist, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF040 & 1) == 0 )
  {
    sub_1B640C8(&BattleLogicTask_TypeInfo, skillInfo);
    byte_49FF040 = 1;
  }
  v9 = 32LL;
  if ( targetSwapExec )
  ...
  v13 = (BattleLogicTask_o *)sub_1B64314(BattleLogicTask_TypeInfo, skillInfo, *(_QWORD *)&actorType);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF03F & 1) == 0 )
  {
    sub_1B640C8(&BattleActionData_TypeInfo, relayTasks);
    sub_1B640C8(&BattleLogicTask___TypeInfo, v5);
    sub_1B640C8(&UpdateIntervalBuffViewBattleLogicTask_TypeInfo, v6);
    byte_49FF03F = 1;
  }
  if ( BattleLogicTask__get_ExistDisplayTriggerIntervalBuff(this, (const MethodInfo *)relayTasks) )
  {
    ...
    {
      v11 = (BattleActionData_o *)sub_1B64314(BattleActionData_TypeInfo, v8, v9);
      BattleActionData___ctor(v11, 0LL);
      if ( v11 )
      {
        v12 = BattleActionData__AddDisplayTriggerIntervalBuff(v11, this, 0LL);
        v3 = (BattleLogicTask_array *)sub_1B64170(BattleLogicTask___TypeInfo, 1LL);
        v15 = sub_1B64314(UpdateIntervalBuffViewBattleLogicTask_TypeInfo, v13, v14);
        BattleLogicTask___ctor((BattleLogicTask_o *)v15, v16);
        *(_DWORD *)(v15 + 48) = 58;
        *(_QWORD *)(v15 + 240) = v12;
        sub_1B6406C((ServantStatusBattleListViewItem_o *)(v15 + 240), (int32_t)v12, v17, v18);
        *(_BYTE *)(v15 + 210) = 1;
        if ( v3 )
        {
          IsNullOrEmpty = sub_1B64204(v15, v3->obj.klass->_1.element_class);
          if ( !IsNullOrEmpty )
          {
            v24 = sub_1B64348(0LL);
            sub_1B641F0(v24, 0LL);
          ...
          if ( v3->max_length )
          {
            ...
            v22 = v15;
LABEL_14:
            sub_1B6406C(m_Items, v22, v19, v20);
            return v3;
          }
LABEL_17:
    ...
    else if ( v3 )
    {
      ...
      if ( IsNullOrEmpty )
      {
        *(struct System_Collections_Generic_KeyValuePair_BattleServantData__BattleBuffData_BuffData____o *)(IsNullOrEmpty + 216) = this->fields._PairDisplayTriggerIntervalBuff_k__BackingField;
        sub_1B6406C((ServantStatusBattleListViewItem_o *)(IsNullOrEmpty + 216), 0, v9, v10);
...
bool __fastcall BattleLogicTask__IsTargetTypeEnemy(BattleLogicTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF03C & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v3);
        ...
        const MethodInfo *method)
{
  ...
  System_Func_object__bool__o *_9__126_0; // x22
  ...
  __int64 v24; // x1
  __int64 v25; // x2
  BattleLogicTask___c_c *v26; // x0
  System_Action_object__o *_9__126_1; // x22
  Il2CppObject *v28; // x23
  struct BattleLogicTask___c_StaticFields *v29; // x0
  int32_t v30; // w2
  int32_t v31; // w3
  const MethodInfo_33E4D90 *v32; // x4
  int32_t v33; // w2
  int32_t v34; // w3
  struct System_Collections_Generic_KeyValuePair_BattleServantData__BattleBuffData_BuffData____o v35; // [xsp+0h] [xbp-60h] BYREF
  ...
  if ( (byte_49FF03E & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_System_Linq_Enumerable_ToArray_BattleBuffData_BuffData___, v8);
    ...
    sub_1B640C8(
      ...
      v11);
    sub_1B640C8(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__126_0__, v12);
    sub_1B640C8(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__126_1__, v13);
    sub_1B640C8(&BattleLogicTask___c_TypeInfo, v14);
    byte_49FF03E = 1;
  }
  ...
  _9__126_0 = (System_Func_object__bool__o *)v15->static_fields->__9__126_0;
  if ( !_9__126_0 )
  {
    ...
    _9__126_0 = (System_Func_object__bool__o *)sub_1B64314(
    ...
    System_Func_object__bool____ctor(
      _9__126_0,
      v17,
      Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__126_0__,
      0LL);
    static_fields = BattleLogicTask___c_TypeInfo->static_fields;
    static_fields->__9__126_0 = (struct System_Func_BattleBuffData_BuffData__bool__o *)_9__126_0;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->__9__126_0, (int32_t)_9__126_0, v19, v20);
  }
  ...
  {
    v26 = BattleLogicTask___c_TypeInfo;
    if ( !BattleLogicTask___c_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(BattleLogicTask___c_TypeInfo);
      v26 = BattleLogicTask___c_TypeInfo;
    }
    _9__126_1 = (System_Action_object__o *)v26->static_fields->__9__126_1;
    if ( !_9__126_1 )
    {
      ...
      _9__126_1 = (System_Action_object__o *)sub_1B64314(System_Action_BattleBuffData_BuffData__TypeInfo, v24, v25);
      System_Action_object____ctor(
        _9__126_1,
        v28,
        Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__126_1__,
        0LL);
      v29 = BattleLogicTask___c_TypeInfo->static_fields;
      v29->__9__126_1 = (struct System_Action_BattleBuffData_BuffData__o *)_9__126_1;
      sub_1B6406C((ServantStatusBattleListViewItem_o *)&v29->__9__126_1, (int32_t)_9__126_1, v30, v31);
    }
    BasicHelper__ForEach_object_(
      (System_Collections_Generic_IEnumerable_T__o *)v22,
      (System_Action_T__o *)_9__126_1,
      (const MethodInfo_2E26860 *)Method_BasicHelper_ForEach_BattleBuffData_BuffData___);
    v36.fields.key = (Il2CppObject *)&v35;
    v36.fields.value = (Il2CppObject *)svtData;
    v35 = (struct System_Collections_Generic_KeyValuePair_BattleServantData__BattleBuffData_BuffData____o)0LL;
    System_Collections_Generic_KeyValuePair_object__object____ctor(
      ...
      v32);
    this->fields._PairDisplayTriggerIntervalBuff_k__BackingField = v35;
    sub_1B6406C(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF037 & 1) == 0 )
  {
    sub_1B640C8(&OverwriteTreasureDeviceData_TypeInfo, *(_QWORD *)&id);
    byte_49FF037 = 1;
  }
  v7 = (OverwriteTreasureDeviceData_o *)sub_1B64314(
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields._OverwriteTdData_k__BackingField, (int32_t)v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 14) = 44;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_motionName, (int32_t)name, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.combo, (int32_t)combo, (int32_t)command, index);
  this->fields.command = command;
  p_command = &this->fields.command;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_command, (int32_t)command, v10, v11);
  if ( !*p_command )
    sub_1B64324(0LL);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v7->fields.targetIdlist, (int32_t)targetlist, v12, v13);
  v7->fields.ptTarget = ptTarget;
  v7 = (BattleLogicTask_o *)((char *)v7 + 40);
  sub_1B6406C((ServantStatusBattleListViewItem_o *)v7, (int32_t)ptTarget, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  v7 = (struct System_Int32_array *)sub_1B64170(int___TypeInfo, 1LL);
  if ( !v7 )
    sub_1B64324(0LL);
  if ( !v7->max_length )
    sub_1B6432C(v7, v7);
  ...
  *((_DWORD *)p_actorIdlist - 2) = type;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_actorIdlist, (int32_t)v7, v8, v9);
}


void __fastcall BattleLogicTask__setActor_43258460(
        BattleLogicTask_o *this,
        int32_t type,
        ...
        const MethodInfo *method)
{
  ...
  this->fields.command = command;
  p_command = &this->fields.command;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_command, (int32_t)command, v8, v9);
  v10 = *p_command;
  if ( !*p_command
    || (BattleCommandData__setCombo(v10, combo, 2, 0LL), (v10 = *p_command) == 0LL)
    || (v10->fields.actionIndex = 3, BattleCommandData__ClearCommandCode(v10, 0LL), (v11 = *p_command) == 0LL) )
  {
    sub_1B64324(v10);
  }
...
void __fastcall BattleLogicTask__setComboOrder_43259828(
        BattleLogicTask_o *this,
        int32_t type,
        bool grdflg,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF03B & 1) == 0 )
  {
    sub_1B640C8(&BattleSkillInfoData_TypeInfo, *(_QWORD *)&skillId);
    byte_49FF03B = 1;
  }
  this->fields.actiontype = 9;
  v9 = (BattleSkillInfoData_o *)sub_1B64314(BattleSkillInfoData_TypeInfo, *(_QWORD *)&skillId, targetlist);
  BattleSkillInfoData___ctor(v9, 0LL);
  this->fields.skillInfo = v9;
  p_skillInfo = &this->fields.skillInfo;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.skillInfo, (int32_t)v9, v11, v12);
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.targetIdlist, (int32_t)targetlist, v15, v16);
  this->fields.ptTarget = ptTarget;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.ptTarget, (int32_t)ptTarget, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.motionMessage, (int32_t)message, type, (int32_t)method);
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 14) = 10;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)p_motionName, (int32_t)motionName, (int32_t)method, v3);
}
...
void __fastcall BattleLogicTask__setTarget(BattleLogicTask_o *this, int32_t targetId, const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.targetIdlist, (int32_t)v5, v6, v7);
}
...
void __fastcall BattleLogicTask__setTarget_43258772(
        BattleLogicTask_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C(p_PairDisplayTriggerIntervalBuff_k__BackingField, 0, (int32_t)value.fields.value, (int32_t)method);
}
...
void __fastcall BattleLogicTask___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FF042 & 1) == 0 )
  {
    sub_1B640C8(&BattleLogicTask___c_TypeInfo, v1);
    byte_49FF042 = 1;
  }
  v3 = (Il2CppObject *)sub_1B64314(BattleLogicTask___c_TypeInfo, v1, v2);
  System_Object___ctor(v3, 0LL);
  BattleLogicTask___c_TypeInfo->static_fields->__9 = (struct BattleLogicTask___c_o *)v3;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)BattleLogicTask___c_TypeInfo->static_fields, (int32_t)v3, v4, v5);
}
...
bool __fastcall BattleLogicTask___c___SetDisplayTriggerIntervalBuff_b__126_0(
...
void __fastcall BattleLogicTask___c___SetDisplayTriggerIntervalBuff_b__126_1(
        BattleLogicTask___c_o *this,
        BattleBuffData_BuffData_o *x,
        const MethodInfo *method)
{
