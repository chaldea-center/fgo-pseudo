void BattleLogicTask___ctor(BattleLogicTask_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)v3, v4, v5);
...
void BattleLogicTask__AddEntryAllAtOnceUniqueId(BattleLogicTask_o *this, int32_t uniqueId, const MethodInfo *method)
{
  ...
  if ( !entryAllAtOnceUniqueIdList )
  {
    ...
    sub_1C36FFC(p_entryAllAtOnceUniqueIdList, (int32_t)v7, v8, v9);
  ...
  if ( !items )
LABEL_9:
    sub_1C372B4(entryAllAtOnceUniqueIdList);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46251 & 1) == 0 )
  {
    ...
    sub_1C37058(&UpdateIntervalBuffViewBattleLogicTask_TypeInfo);
    byte_4C46251 = 1;
  }
  if ( BattleLogicTask__get_ExistDisplayTriggerIntervalBuff(this, (const MethodInfo *)relayTasks) )
  {
    ...
    if ( (IsNullOrEmpty & 1) != 0 )
    {
      ...
      if ( v8 )
      {
        ...
        v3 = (BattleLogicTask_array *)sub_1C37100(BattleLogicTask___TypeInfo, 1);
        v10 = sub_1C372A4(UpdateIntervalBuffViewBattleLogicTask_TypeInfo);
        BattleLogicTask___ctor((BattleLogicTask_o *)v10, v11);
        *(_DWORD *)(v10 + 48) = 58;
        *(_QWORD *)(v10 + 304) = v9;
        sub_1C36FFC((CGThumbnailListItem_o *)(v10 + 304), (int32_t)v9, v12, v13);
        *(_BYTE *)(v10 + 265) = 1;
        if ( v3 )
        {
          IsNullOrEmpty = sub_1C37194(v10, v3->obj.klass->_1.element_class);
          if ( !IsNullOrEmpty )
          {
            v20 = sub_1C372D8(0);
            sub_1C37180(v20, 0);
          ...
          if ( LODWORD(v3->max_length) )
          {
            ...
            v17 = v10;
LABEL_14:
            sub_1C36FFC((CGThumbnailListItem_o *)m_Items, v17, v14, v15);
            return v3;
          }
LABEL_17:
    ...
    else if ( v3 )
    {
      ...
      if ( v18 )
      {
        ...
        sub_1C36FFC((CGThumbnailListItem_o *)&v18->fields._PairDisplayTriggerIntervalBuff_k__BackingField, 0, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( addAction && !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.InterruptActionList, 0) )
  {
    ...
    sub_1C36FFC(p_InterruptActionList, 0, v9, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_36DBB40 *v22; // x4
  int32_t v23; // w2
  ...
  if ( (byte_4C46250 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_System_Collections_Generic_KeyValuePair_BattleServantData__BattleBuffData_BuffData_____ctor__);
    sub_1C37058(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__138_0__);
    sub_1C37058(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__138_1__);
    sub_1C37058(&BattleLogicTask___c_TypeInfo);
    byte_4C46250 = 1;
  }
  ...
  if ( !_9__138_0 )
  {
    ...
    _9__138_0 = (System_Func_object__bool__o *)sub_1C372A4(System_Func_BattleBuffData_BuffData__bool__TypeInfo);
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->__9__138_0, (int32_t)_9__138_0, v11, v12);
  }
  ...
  if ( svtData && !IsNullOrEmpty )
  {
    ...
    if ( !_9__138_1 )
    {
      ...
      _9__138_1 = (System_Action_object__o *)sub_1C372A4(System_Action_BattleBuffData_BuffData__TypeInfo);
      ...
      sub_1C36FFC((CGThumbnailListItem_o *)&v19->__9__138_1, (int32_t)_9__138_1, v20, v21);
    }
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._PairDisplayTriggerIntervalBuff_k__BackingField, 0, v23, v24);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.gimmickIndexArray, (int32_t)indexArray, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46254 & 1) == 0 )
  {
    sub_1C37058(&Method_System_Collections_Generic_List_BattleActionData__AddRange__);
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)actions, 0) )
  {
    ...
    {
      p_InterruptActionList = (CGThumbnailListItem_o *)&this->fields.InterruptActionList;
      v7 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_BattleActionData__TypeInfo);
      ...
      sub_1C36FFC(p_InterruptActionList, (int32_t)v7, v8, v9);
    ...
    System_Collections_Generic_List_object___AddRange(
      ...
      (const MethodInfo_37A3230 *)Method_System_Collections_Generic_List_BattleActionData__AddRange__);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46253 & 1) == 0 )
  {
    ...
    sub_1C37058(&BattleActionData_TypeInfo);
    sub_1C37058(&BattleActionWaitCond_UntilChangeModelLoadComplete_TypeInfo);
    byte_4C46253 = 1;
  }
  if ( execActData
          ...
          0) )
  {
    ...
    v7 = (BattleActionWaitCond_UntilChangeModelLoadComplete_o *)sub_1C372A4(BattleActionWaitCond_UntilChangeModelLoadComplete_TypeInfo);
    ...
    if ( !v5
      || (v9 = BattleActionData__SetWaitCond(v5, (BattleActionWaitCond_Base_o *)v7, 0),
          (v8 = sub_1C37100(BattleActionData___TypeInfo, 1)) == 0) )
    {
      sub_1C372B4(v8);
    }
    v12 = v8;
    if ( v9 )
    {
      v8 = sub_1C37194(v9, *(_QWORD *)(*(_QWORD *)v8 + 64LL));
      if ( !v8 )
      {
        v14 = sub_1C372D8(0);
        sub_1C37180(v14, 0);
    ...
    if ( !*(_DWORD *)(v12 + 24) )
      sub_1C372BC(v8);
    *(_QWORD *)(v12 + 32) = v9;
    sub_1C36FFC((CGThumbnailListItem_o *)(v12 + 32), (int32_t)v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46245 & 1) == 0 )
  {
    sub_1C37058(&OverwriteTreasureDeviceData_TypeInfo);
    byte_4C46245 = 1;
  }
  v7 = (OverwriteTreasureDeviceData_o *)sub_1C372A4(OverwriteTreasureDeviceData_TypeInfo);
  OverwriteTreasureDeviceData___ctor(v7, id, lv, 0);
  this->fields._OverwriteTdData_k__BackingField = v7;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._OverwriteTdData_k__BackingField, (int32_t)v7, v8, v9);
}
...
void BattleLogicTask__SetPlayFieldMotion(BattleLogicTask_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 18) = 44;
  sub_1C36FFC((CGThumbnailListItem_o *)p_motionName, (int32_t)name, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)p_command, (int32_t)command, v10, v11);
  if ( !*p_command )
    sub_1C372B4(0);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)targetlist, v13, v14);
  this->fields.ptTarget = ptTarget;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.ptTarget, (int32_t)ptTarget, v15, v16);
...
void BattleLogicTask__setActor(BattleLogicTask_o *this, int32_t type, int32_t uniqueID, const MethodInfo *method)
{
  ...
  v7 = sub_1C37100(int___TypeInfo, 1);
  if ( !v7 )
    sub_1C372B4(0);
  if ( !*(_DWORD *)(v7 + 24) )
    sub_1C372BC(v7);
  ...
  *((_DWORD *)p_actorIdlist - 2) = type;
  sub_1C36FFC((CGThumbnailListItem_o *)p_actorIdlist, v7, v8, v9);
}


void BattleLogicTask__setActor_47083896(
        BattleLogicTask_o *this,
        int32_t type,
        ...
        const MethodInfo *method)
{
  ...
  p_actorIdlist = &this->fields.actorIdlist;
  *((_DWORD *)p_actorIdlist - 2) = type;
  sub_1C36FFC((CGThumbnailListItem_o *)p_actorIdlist, (int32_t)uniqueIDList, (int32_t)uniqueIDList, method);
}
        ...
        const MethodInfo *method)
{
  ...
  this->fields.combo = combo;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.combo, (int32_t)combo, (int32_t)command, method);
  this->fields.command = command;
  p_command = &this->fields.command;
  sub_1C36FFC((CGThumbnailListItem_o *)p_command, (int32_t)command, v8, v9);
  v10 = *p_command;
  if ( !*p_command
...
void BattleLogicTask__setComboOrder_47084568(
        BattleLogicTask_o *this,
        int32_t type,
        bool grdflg,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  v9 = (BattleSkillInfoData_o *)sub_1C372A4(BattleSkillInfoData_TypeInfo);
  BattleSkillInfoData___ctor(v9, 0);
  this->fields.skillInfo = v9;
  p_skillInfo = &this->fields.skillInfo;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.skillInfo, (int32_t)v9, v11, v12);
  ...
  this->fields.targetIdlist = targetlist;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)targetlist, v15, v16);
  this->fields.ptTarget = ptTarget;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.ptTarget, (int32_t)ptTarget, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.motionMessage, (int32_t)message, type, method);
...
void BattleLogicTask__setPlayMoiton(BattleLogicTask_o *this, System_String_o *motionName, const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 18) = 10;
  sub_1C36FFC((CGThumbnailListItem_o *)p_motionName, (int32_t)motionName, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.skillInfo, (int32_t)inSkillInfo, inflgCheckUseSKill, method);
...
void BattleLogicTask__setTarget(BattleLogicTask_o *this, int32_t targetId, const MethodInfo *method)
{
  ...
  *(_DWORD *)(v5 + 32) = targetId;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetIdlist, v5, v6, v7);
}
...
void BattleLogicTask__setTarget_47084040(
        BattleLogicTask_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)targetIdlist, (int32_t)method, v3);
}
...
void BattleLogicTask___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C372A4(BattleLogicTask___c_TypeInfo);
  System_Object___ctor(v1, 0);
  BattleLogicTask___c_TypeInfo->static_fields->__9 = (struct BattleLogicTask___c_o *)v1;
  sub_1C36FFC((CGThumbnailListItem_o *)BattleLogicTask___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
