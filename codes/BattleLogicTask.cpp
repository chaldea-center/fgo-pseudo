void BattleLogicTask___ctor(BattleLogicTask_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)v3, v4, v5);
...
void BattleLogicTask__AddEntryAllAtOnceUniqueId(BattleLogicTask_o *this, int32_t uniqueId, const MethodInfo *method)
{
  ...
  if ( !entryAllAtOnceUniqueIdList )
  {
    ...
    sub_1C2D434(p_entryAllAtOnceUniqueIdList, (int32_t)v7, v8, v9);
  ...
  if ( !items )
LABEL_9:
    sub_1C2D6EC(entryAllAtOnceUniqueIdList, *(_QWORD *)&uniqueId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A43E & 1) == 0 )
  {
    ...
    sub_1C2D490(&UpdateIntervalBuffViewBattleLogicTask_TypeInfo);
    byte_4C2A43E = 1;
  }
  if ( BattleLogicTask__get_ExistDisplayTriggerIntervalBuff(this, (const MethodInfo *)relayTasks) )
  {
    ...
    {
      v9 = (BattleActionData_o *)sub_1C2D6DC(BattleActionData_TypeInfo);
      BattleActionData___ctor(v9, 0);
      if ( v9 )
      {
        v10 = BattleActionData__AddDisplayTriggerIntervalBuff(v9, this, 0);
        v3 = (BattleLogicTask_array *)sub_1C2D538(BattleLogicTask___TypeInfo, 1);
        v11 = sub_1C2D6DC(UpdateIntervalBuffViewBattleLogicTask_TypeInfo);
        BattleLogicTask___ctor((BattleLogicTask_o *)v11, v12);
        *(_DWORD *)(v11 + 48) = 58;
        *(_QWORD *)(v11 + 304) = v10;
        sub_1C2D434((CGThumbnailListItem_o *)(v11 + 304), (int32_t)v10, v13, v14);
        *(_BYTE *)(v11 + 265) = 1;
        if ( v3 )
        {
          IsNullOrEmpty = sub_1C2D5CC(v11, v3->obj.klass->_1.element_class);
          if ( !IsNullOrEmpty )
          {
            v20 = sub_1C2D710(0);
            sub_1C2D5B8(v20, 0);
          ...
          if ( LODWORD(v3->max_length) )
          {
            ...
            v17 = v11;
LABEL_14:
            sub_1C2D434((CGThumbnailListItem_o *)m_Items, v17, v7, v15);
            return v3;
          }
LABEL_17:
    ...
    else if ( v3 )
    {
      ...
      if ( v18 )
      {
        ...
        sub_1C2D434((CGThumbnailListItem_o *)&v18->fields._PairDisplayTriggerIntervalBuff_k__BackingField, 0, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( addAction && !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.InterruptActionList, 0) )
  {
    ...
    sub_1C2D434(p_InterruptActionList, 0, v10, v11);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_36C2838 *v22; // x4
  int32_t v23; // w2
  ...
  if ( (byte_4C2A43D & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Collections_Generic_KeyValuePair_BattleServantData__BattleBuffData_BuffData_____ctor__);
    sub_1C2D490(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__137_0__);
    sub_1C2D490(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__137_1__);
    sub_1C2D490(&BattleLogicTask___c_TypeInfo);
    byte_4C2A43D = 1;
  }
  ...
  _9__137_0 = (System_Func_object__bool__o *)v7->static_fields->__9__137_0;
  if ( !_9__137_0 )
  {
    ...
    _9__137_0 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_BattleBuffData_BuffData__bool__TypeInfo);
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__137_0, (int32_t)_9__137_0, v11, v12);
  }
  ...
  if ( svtData && !IsNullOrEmpty )
  {
    ...
    _9__137_1 = (System_Action_object__o *)v16->static_fields->__9__137_1;
    if ( !_9__137_1 )
    {
      ...
      _9__137_1 = (System_Action_object__o *)sub_1C2D6DC(System_Action_BattleBuffData_BuffData__TypeInfo);
      ...
      v19->__9__137_1 = (struct System_Action_BattleBuffData_BuffData__o *)_9__137_1;
      sub_1C2D434((CGThumbnailListItem_o *)&v19->__9__137_1, (int32_t)_9__137_1, v20, v21);
    }
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields._PairDisplayTriggerIntervalBuff_k__BackingField, 0, v23, v24);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.gimmickIndexArray, (int32_t)indexArray, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A441 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_BattleActionData__AddRange__);
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)actions, 0) )
  {
    ...
    {
      p_InterruptActionList = (CGThumbnailListItem_o *)&this->fields.InterruptActionList;
      v7 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_BattleActionData__TypeInfo);
      ...
      sub_1C2D434(p_InterruptActionList, (int32_t)v7, v8, v9);
    ...
    System_Collections_Generic_List_object___AddRange(
      ...
      (const MethodInfo_3789D90 *)Method_System_Collections_Generic_List_BattleActionData__AddRange__);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A440 & 1) == 0 )
  {
    ...
    sub_1C2D490(&BattleActionData_TypeInfo);
    sub_1C2D490(&BattleActionWaitCond_UntilChangeModelLoadComplete_TypeInfo);
    byte_4C2A440 = 1;
  }
  if ( execActData
          ...
          0) )
  {
    ...
    v7 = (BattleActionWaitCond_UntilChangeModelLoadComplete_o *)sub_1C2D6DC(BattleActionWaitCond_UntilChangeModelLoadComplete_TypeInfo);
    ...
    if ( !v5
      || (v10 = BattleActionData__SetWaitCond(v5, (BattleActionWaitCond_Base_o *)v7, 0),
          (v8 = sub_1C2D538(BattleActionData___TypeInfo, 1)) == 0) )
    {
      sub_1C2D6EC(v8, v9);
    }
    v13 = v8;
    if ( v10 )
    {
      v8 = sub_1C2D5CC(v10, *(_QWORD *)(*(_QWORD *)v8 + 64LL));
      if ( !v8 )
      {
        v15 = sub_1C2D710(0);
        sub_1C2D5B8(v15, 0);
    ...
    *(_QWORD *)(v13 + 32) = v10;
    sub_1C2D434((CGThumbnailListItem_o *)(v13 + 32), (int32_t)v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A432 & 1) == 0 )
  {
    sub_1C2D490(&OverwriteTreasureDeviceData_TypeInfo);
    byte_4C2A432 = 1;
  }
  v7 = (OverwriteTreasureDeviceData_o *)sub_1C2D6DC(OverwriteTreasureDeviceData_TypeInfo);
  OverwriteTreasureDeviceData___ctor(v7, id, lv, 0);
  this->fields._OverwriteTdData_k__BackingField = v7;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields._OverwriteTdData_k__BackingField, (int32_t)v7, v8, v9);
}
...
void BattleLogicTask__SetPlayFieldMotion(BattleLogicTask_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 18) = 44;
  sub_1C2D434((CGThumbnailListItem_o *)p_motionName, (int32_t)name, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)p_command, (int32_t)command, v10, v11);
  if ( !*p_command )
    sub_1C2D6EC(0, v12);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)targetlist, v13, v14);
  this->fields.ptTarget = ptTarget;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.ptTarget, (int32_t)ptTarget, v15, v16);
...
void BattleLogicTask__setActor(BattleLogicTask_o *this, int32_t type, int32_t uniqueID, const MethodInfo *method)
{
  ...
  *((_DWORD *)p_actorIdlist - 2) = type;
  sub_1C2D434((CGThumbnailListItem_o *)p_actorIdlist, v7, v9, v10);
}


void BattleLogicTask__setActor_46715184(
        BattleLogicTask_o *this,
        int32_t type,
        ...
        const MethodInfo *method)
{
  ...
  p_actorIdlist = &this->fields.actorIdlist;
  *((_DWORD *)p_actorIdlist - 2) = type;
  sub_1C2D434((CGThumbnailListItem_o *)p_actorIdlist, (int32_t)uniqueIDList, (int32_t)uniqueIDList, method);
}
        ...
        const MethodInfo *method)
{
  ...
  this->fields.combo = combo;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.combo, (int32_t)combo, (int32_t)command, method);
  this->fields.command = command;
  p_command = &this->fields.command;
  sub_1C2D434((CGThumbnailListItem_o *)p_command, (int32_t)command, v8, v9);
  v11 = *p_command;
  if ( !*p_command
...
void BattleLogicTask__setComboOrder_46715904(
        BattleLogicTask_o *this,
        int32_t type,
        bool grdflg,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  v9 = (BattleSkillInfoData_o *)sub_1C2D6DC(BattleSkillInfoData_TypeInfo);
  BattleSkillInfoData___ctor(v9, 0);
  this->fields.skillInfo = v9;
  p_skillInfo = &this->fields.skillInfo;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.skillInfo, (int32_t)v9, v11, v12);
  ...
  if ( !skillInfo
    || (klass = skillInfo->klass,
        ...
        !*p_skillInfo) )
  {
    sub_1C2D6EC(skillInfo, v13);
  }
  (*p_skillInfo)->fields.skilllv = 1;
  this->fields.targetIdlist = targetlist;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)targetlist, v16, v17);
  this->fields.ptTarget = ptTarget;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.ptTarget, (int32_t)ptTarget, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.motionMessage, (int32_t)message, type, method);
...
void BattleLogicTask__setPlayMoiton(BattleLogicTask_o *this, System_String_o *motionName, const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 18) = 10;
  sub_1C2D434((CGThumbnailListItem_o *)p_motionName, (int32_t)motionName, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.skillInfo, (int32_t)inSkillInfo, inflgCheckUseSKill, method);
...
void BattleLogicTask__setTarget(BattleLogicTask_o *this, int32_t targetId, const MethodInfo *method)
{
  ...
  *(_DWORD *)(v5 + 32) = targetId;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.targetIdlist, v5, v7, v8);
}
...
void BattleLogicTask__setTarget_46715328(
        BattleLogicTask_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.targetIdlist, (int32_t)targetIdlist, (int32_t)method, v3);
}
...
void BattleLogicTask___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(BattleLogicTask___c_TypeInfo);
  System_Object___ctor(v1, 0);
  BattleLogicTask___c_TypeInfo->static_fields->__9 = (struct BattleLogicTask___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)BattleLogicTask___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
...
bool BattleLogicTask___c___SetDisplayTriggerIntervalBuff_b__137_0(
...
void BattleLogicTask___c___SetDisplayTriggerIntervalBuff_b__137_1(
        BattleLogicTask___c_o *this,
        BattleBuffData_BuffData_o *x,
        const MethodInfo *method)
{
