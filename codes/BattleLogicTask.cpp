void __fastcall BattleLogicTask___ctor(BattleLogicTask_o *this, const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.targetIdlist, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01763 & 1) == 0 )
  {
    sub_1B64A00(&BattleLogicTask_TypeInfo, skillInfo);
    byte_4A01763 = 1;
  }
  v9 = 32LL;
  if ( targetSwapExec )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01762 & 1) == 0 )
  {
    sub_1B64A00(&BattleActionData_TypeInfo, relayTasks);
    sub_1B64A00(&BattleLogicTask___TypeInfo, v5);
    sub_1B64A00(&UpdateIntervalBuffViewBattleLogicTask_TypeInfo, v6);
    byte_4A01762 = 1;
  }
  if ( BattleLogicTask__get_ExistDisplayTriggerIntervalBuff(this, (const MethodInfo *)relayTasks) )
  {
    ...
    if ( (IsNullOrEmpty & 1) != 0 )
    {
      ...
      if ( v11 )
      {
        ...
        v3 = (BattleLogicTask_array *)sub_1B64AA8(BattleLogicTask___TypeInfo, 1LL);
        v13 = sub_1B64C4C(UpdateIntervalBuffViewBattleLogicTask_TypeInfo);
        BattleLogicTask___ctor((BattleLogicTask_o *)v13, v14);
        *(_DWORD *)(v13 + 48) = 58;
        *(_QWORD *)(v13 + 240) = v12;
        sub_1B649A4((ServantStatusBattleListViewItem_o *)(v13 + 240), (int32_t)v12, v15, v16);
        *(_BYTE *)(v13 + 210) = 1;
        if ( v3 )
        {
          IsNullOrEmpty = sub_1B64B3C(v13, v3->obj.klass->_1.element_class);
          if ( !IsNullOrEmpty )
          {
            v22 = sub_1B64C80(0LL);
            sub_1B64B28(v22, 0LL);
          ...
          if ( v3->max_length )
          {
            ...
            v20 = v13;
LABEL_14:
            sub_1B649A4(m_Items, v20, v17, v18);
            return v3;
          }
LABEL_17:
    ...
    else if ( v3 )
    {
      ...
      if ( IsNullOrEmpty )
      {
        *(struct System_Collections_Generic_KeyValuePair_BattleServantData__BattleBuffData_BuffData____o *)(IsNullOrEmpty + 216) = this->fields._PairDisplayTriggerIntervalBuff_k__BackingField;
        sub_1B649A4((ServantStatusBattleListViewItem_o *)(IsNullOrEmpty + 216), 0, v9, v10);
...
bool __fastcall BattleLogicTask__IsTargetTypeEnemy(BattleLogicTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0175F & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMasterData_TreasureDvcLvMaster___, v3);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A01764 & 1) == 0 )
  {
    sub_1B64A00(&BattleLogicTask___TypeInfo, logic);
    byte_4A01764 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  int32_t v28; // w2
  int32_t v29; // w3
  const MethodInfo_33E7684 *v30; // x4
  int32_t v31; // w2
  int32_t v32; // w3
  ...
  if ( (byte_4A01761 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_System_Linq_Enumerable_ToArray_BattleBuffData_BuffData___, v8);
    sub_1B64A00(&Method_System_Linq_Enumerable_Where_BattleBuffData_BuffData___, v9);
    ...
    sub_1B64A00(
      ...
      v11);
    sub_1B64A00(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__126_0__, v12);
    sub_1B64A00(&Method_BattleLogicTask___c__SetDisplayTriggerIntervalBuff_b__126_1__, v13);
    sub_1B64A00(&BattleLogicTask___c_TypeInfo, v14);
    byte_4A01761 = 1;
  }
  ...
  if ( !_9__126_0 )
  {
    ...
    _9__126_0 = (System_Func_object__bool__o *)sub_1B64C4C(System_Func_BattleBuffData_BuffData__bool__TypeInfo);
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->__9__126_0, (int32_t)_9__126_0, v19, v20);
  }
  ...
  if ( svtData && !IsNullOrEmpty )
  {
    ...
    if ( !_9__126_1 )
    {
      ...
      _9__126_1 = (System_Action_object__o *)sub_1B64C4C(System_Action_BattleBuffData_BuffData__TypeInfo);
      ...
      sub_1B649A4((ServantStatusBattleListViewItem_o *)&v27->__9__126_1, (int32_t)_9__126_1, v28, v29);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0175A & 1) == 0 )
  {
    sub_1B64A00(&OverwriteTreasureDeviceData_TypeInfo, *(_QWORD *)&id);
    byte_4A0175A = 1;
  }
  v7 = (OverwriteTreasureDeviceData_o *)sub_1B64C4C(OverwriteTreasureDeviceData_TypeInfo);
  OverwriteTreasureDeviceData___ctor(v7, id, lv, 0LL);
  this->fields._OverwriteTdData_k__BackingField = v7;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields._OverwriteTdData_k__BackingField, (int32_t)v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 14) = 44;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_motionName, (int32_t)name, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.combo, (int32_t)combo, (int32_t)command, index);
  this->fields.command = command;
  p_command = &this->fields.command;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_command, (int32_t)command, v10, v11);
  if ( !*p_command )
    sub_1B64C5C(0LL, v12);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v7->fields.targetIdlist, (int32_t)targetlist, v12, v13);
  v7->fields.ptTarget = ptTarget;
  v7 = (BattleLogicTask_o *)((char *)v7 + 40);
  sub_1B649A4((ServantStatusBattleListViewItem_o *)v7, (int32_t)ptTarget, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  v7 = (struct System_Int32_array *)sub_1B64AA8(int___TypeInfo, 1LL);
  if ( !v7 )
    sub_1B64C5C(0LL, v8);
  if ( !v7->max_length )
    sub_1B64C64(v7, v7);
  ...
  *((_DWORD *)p_actorIdlist - 2) = type;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_actorIdlist, (int32_t)v7, v9, v10);
}


void __fastcall BattleLogicTask__setActor_43267488(
        BattleLogicTask_o *this,
        int32_t type,
        ...
        const MethodInfo *method)
{
  ...
  this->fields.command = command;
  p_command = &this->fields.command;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_command, (int32_t)command, v8, v9);
  v11 = *p_command;
  if ( !*p_command
...
void __fastcall BattleLogicTask__setComboOrder_43268856(
        BattleLogicTask_o *this,
        int32_t type,
        bool grdflg,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0175E & 1) == 0 )
  {
    sub_1B64A00(&BattleSkillInfoData_TypeInfo, *(_QWORD *)&skillId);
    byte_4A0175E = 1;
  }
  this->fields.actiontype = 9;
  v9 = (BattleSkillInfoData_o *)sub_1B64C4C(BattleSkillInfoData_TypeInfo);
  BattleSkillInfoData___ctor(v9, 0LL);
  this->fields.skillInfo = v9;
  p_skillInfo = &this->fields.skillInfo;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.skillInfo, (int32_t)v9, v11, v12);
  ...
  if ( !skillInfo
    || (klass = skillInfo->klass,
        ...
        !*p_skillInfo) )
  {
    sub_1B64C5C(skillInfo, v13);
  }
  (*p_skillInfo)->fields.skilllv = 1;
  this->fields.targetIdlist = targetlist;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.targetIdlist, (int32_t)targetlist, v16, v17);
  this->fields.ptTarget = ptTarget;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.ptTarget, (int32_t)ptTarget, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.motionMessage, (int32_t)message, type, (int32_t)method);
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_motionName - 14) = 10;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_motionName, (int32_t)motionName, (int32_t)method, v3);
}
...
void __fastcall BattleLogicTask__setTarget(BattleLogicTask_o *this, int32_t targetId, const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.targetIdlist, (int32_t)v5, v7, v8);
}
...
void __fastcall BattleLogicTask__setTarget_43267800(
        BattleLogicTask_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4(p_PairDisplayTriggerIntervalBuff_k__BackingField, 0, (int32_t)value.fields.value, (int32_t)method);
}
...
void __fastcall BattleLogicTask___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A01765 & 1) == 0 )
  {
    sub_1B64A00(&BattleLogicTask___c_TypeInfo, v1);
    byte_4A01765 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64C4C(BattleLogicTask___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  BattleLogicTask___c_TypeInfo->static_fields->__9 = (struct BattleLogicTask___c_o *)v2;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)BattleLogicTask___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
