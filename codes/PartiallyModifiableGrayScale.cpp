        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF3A8 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_16527/*"_IsSet"*/);
    sub_1C21E38(&StringLiteral_16572/*"_OverTex"*/);
    sub_1C21E38(&StringLiteral_16619/*"_Size"*/);
    sub_1C21E38(&StringLiteral_16601/*"_Saturation"*/);
    sub_1C21E38(&StringLiteral_16658/*"_UVPosition"*/);
    this = (PartiallyModifiableGrayScale_o *)sub_1C21E38(&StringLiteral_16545/*"_MaskTex"*/);
    byte_4BDF3A8 = 1;
  }
  if ( !source )
    goto LABEL_46;
  ...
  if ( UnityEngine_Object__op_Inequality(OverTexture, 0LL, 0LL) )
  {
    ...
    UnityEngine_Material__SetTexture(
      (UnityEngine_Material_o *)this,
      (System_String_o *)StringLiteral_16572/*"_OverTex"*/,
  ...
  if ( !this
    || (UnityEngine_Material__SetFloat(
          (UnityEngine_Material_o *)this,
          (System_String_o *)StringLiteral_16601/*"_Saturation"*/,
          v6->fields.saturation,
          0LL),
        (this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL)) == 0LL)
    || (UnityEngine_Material__SetFloat(
          (UnityEngine_Material_o *)this,
          (System_String_o *)StringLiteral_16619/*"_Size"*/,
          v6->fields.radius,
          0LL),
        (this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL)) == 0LL) )
  {
LABEL_46:
    sub_1C22094(this, source);
  }
  v23.fields.x = posX + 0.5;
  v23.fields.z = 0.0;
  v23.fields.w = 0.0;
  v23.fields.y = v8;
  UnityEngine_Material__SetVector((UnityEngine_Material_o *)this, (System_String_o *)StringLiteral_16658/*"_UVPosition"*/, v23, 0LL);
  this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL);
  radius = v6->fields.radius;
  v13 = (System_String_o *)StringLiteral_16527/*"_IsSet"*/;
  v14 = this;
  if ( radius >= 0.03 )
    v15 = this;
  else
    v15 = 0LL;
  if ( radius >= 0.03 )
    v16 = StringLiteral_16527/*"_IsSet"*/;
  else
    v16 = 0LL;
  if ( radius < 0.03 )
  {
  ...
  if ( UnityEngine_Object__op_Inequality(v18, 0LL, 0LL) )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    this = (PartiallyModifiableGrayScale_o *)UnityEngine_Object__op_Inequality(v19, 0LL, 0LL);
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  this = (PartiallyModifiableGrayScale_o *)UnityEngine_Object__op_Inequality(v20, 0LL, 0LL);
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    v17 = 2;
  }
  else
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    this = (PartiallyModifiableGrayScale_o *)UnityEngine_Object__op_Inequality(v21, 0LL, 0LL);
    v17 = (unsigned __int8)this & 1;
  }
LABEL_42:
  if ( !v14 )
    goto LABEL_46;
  UnityEngine_Material__SetInt((UnityEngine_Material_o *)v14, v13, v17, 0LL);
  material = ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL);
  if ( !UnityEngine_Graphics_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Graphics_TypeInfo);
  UnityEngine_Graphics__Blit_70715340((UnityEngine_Texture_o *)source, destination, material, 0LL);
}