        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B699E0 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_16458/*"_IsSet"*/, v8);
    sub_1BE4ACC(&StringLiteral_16503/*"_OverTex"*/, v9);
    sub_1BE4ACC(&StringLiteral_16549/*"_Size"*/, v10);
    sub_1BE4ACC(&StringLiteral_16531/*"_Saturation"*/, v11);
    sub_1BE4ACC(&StringLiteral_16588/*"_UVPosition"*/, v12);
    this = (PartiallyModifiableGrayScale_o *)sub_1BE4ACC(&StringLiteral_16476/*"_MaskTex"*/, v13);
    byte_4B699E0 = 1;
  }
  if ( !source )
    goto LABEL_46;
  ...
  if ( UnityEngine_Object__op_Inequality(OverTexture, 0LL, 0LL) )
  {
    ...
    UnityEngine_Material__SetTexture(
      (UnityEngine_Material_o *)this,
      (System_String_o *)StringLiteral_16503/*"_OverTex"*/,
  ...
  if ( !this
    || (UnityEngine_Material__SetFloat(
          (UnityEngine_Material_o *)this,
          (System_String_o *)StringLiteral_16531/*"_Saturation"*/,
          v6->fields.saturation,
          0LL),
        (this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL)) == 0LL)
    || (UnityEngine_Material__SetFloat(
          (UnityEngine_Material_o *)this,
          (System_String_o *)StringLiteral_16549/*"_Size"*/,
          v6->fields.radius,
          0LL),
        (this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL)) == 0LL) )
  {
LABEL_46:
    sub_1BE4D28(this, source);
  }
  v30.fields.x = posX + 0.5;
  v30.fields.z = 0.0;
  v30.fields.w = 0.0;
  v30.fields.y = v15;
  UnityEngine_Material__SetVector((UnityEngine_Material_o *)this, (System_String_o *)StringLiteral_16588/*"_UVPosition"*/, v30, 0LL);
  this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL);
  radius = v6->fields.radius;
  v20 = (System_String_o *)StringLiteral_16458/*"_IsSet"*/;
  v21 = this;
  if ( radius >= 0.03 )
    v22 = this;
  else
    v22 = 0LL;
  if ( radius >= 0.03 )
    v23 = StringLiteral_16458/*"_IsSet"*/;
  else
    v23 = 0LL;
  if ( radius < 0.03 )
  {
...
LABEL_42:
  ...
  UnityEngine_Graphics__Blit_70297960((UnityEngine_Texture_o *)source, destination, material, 0LL);
}