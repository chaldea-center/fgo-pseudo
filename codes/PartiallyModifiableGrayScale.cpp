        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46385 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_16251/*"_IsSet"*/);
    sub_1C37058(&StringLiteral_16297/*"_OverTex"*/);
    sub_1C37058(&StringLiteral_16346/*"_Size"*/);
    sub_1C37058(&StringLiteral_16328/*"_Saturation"*/);
    sub_1C37058(&StringLiteral_16387/*"_UVPosition"*/);
    this = (PartiallyModifiableGrayScale_o *)sub_1C37058(&StringLiteral_16269/*"_MaskTex"*/);
    byte_4C46385 = 1;
  }
  if ( !source )
    goto LABEL_46;
  ...
  if ( UnityEngine_Object__op_Inequality(OverTexture, 0, 0) )
  {
    ...
    UnityEngine_Material__SetTexture(
      (UnityEngine_Material_o *)this,
      (System_String_o *)StringLiteral_16297/*"_OverTex"*/,
...
LABEL_46:
  ...
  v23.fields.w = 0.0;
  v23.fields.y = v8;
  UnityEngine_Material__SetVector((UnityEngine_Material_o *)this, (System_String_o *)StringLiteral_16387/*"_UVPosition"*/, v23, 0);
  this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0);
  radius = v6->fields.radius;
  v13 = (System_String_o *)StringLiteral_16251/*"_IsSet"*/;
  v14 = this;
  if ( radius >= 0.03 )
    v15 = this;
  else
    v15 = 0;
  if ( radius >= 0.03 )
    v16 = StringLiteral_16251/*"_IsSet"*/;
  else
    v16 = 0;
  if ( radius < 0.03 )
  {
...
LABEL_42:
  ...
  UnityEngine_Graphics__Blit_71112436((UnityEngine_Texture_o *)source, destination, material, 0);
}