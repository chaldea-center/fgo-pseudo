        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DE5E & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_16249/*"_IsSet"*/);
    sub_1B885B0(&StringLiteral_16294/*"_OverTex"*/);
    sub_1B885B0(&StringLiteral_16340/*"_Size"*/);
    sub_1B885B0(&StringLiteral_16322/*"_Saturation"*/);
    sub_1B885B0(&StringLiteral_16379/*"_UVPosition"*/);
    this = (PartiallyModifiableGrayScale_o *)sub_1B885B0(&StringLiteral_16267/*"_MaskTex"*/);
    byte_4A5DE5E = 1;
  }
  if ( !source )
    goto LABEL_46;
  ...
  if ( UnityEngine_Object__op_Inequality(OverTexture, 0LL, 0LL) )
  {
    ...
    UnityEngine_Material__SetTexture(
      (UnityEngine_Material_o *)this,
      (System_String_o *)StringLiteral_16294/*"_OverTex"*/,
  ...
  {
LABEL_46:
    sub_1B8880C(this, source);
  }
  v23.fields.x = posX + 0.5;
  v23.fields.z = 0.0;
  v23.fields.w = 0.0;
  v23.fields.y = v8;
  UnityEngine_Material__SetVector((UnityEngine_Material_o *)this, (System_String_o *)StringLiteral_16379/*"_UVPosition"*/, v23, 0LL);
  this = (PartiallyModifiableGrayScale_o *)ImageEffectBase__get_material((ImageEffectBase_o *)v6, 0LL);
  radius = v6->fields.radius;
  v13 = (System_String_o *)StringLiteral_16249/*"_IsSet"*/;
  v14 = this;
  if ( radius >= 0.03 )
    v15 = this;
  else
    v15 = 0LL;
  if ( radius >= 0.03 )
    v16 = StringLiteral_16249/*"_IsSet"*/;
  else
    v16 = 0LL;
  if ( radius < 0.03 )
  {
...
LABEL_42:
  ...
  UnityEngine_Graphics__Blit_69305428((UnityEngine_Texture_o *)source, destination, material, 0LL);
}