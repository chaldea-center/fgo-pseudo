        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1ECD5 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_ServantMaster___, originalSvtEnt);
...
LABEL_9:
          ...
          v14 = 0LL;
          System_Nullable_float____ctor(v16, HeadUpY, (const MethodInfo_37DB04C *)Method_System_Nullable_float___ctor__);
