void UIMultiTouch___ctor(UIMultiTouch_o *this, const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.onDragUpdate, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.onClick, (int32_t)v10, v11, v12, v13, v14, v15, v16);
...
LABEL_20:
        ...
        if ( !EventDelegate_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
        EventDelegate__Execute_49943632(onDragUpdate, 0);
        return;
      }
    }
    else
