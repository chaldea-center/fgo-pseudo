...
void SelectTakeOverTypeComponent__SetupTitleImg(SelectTakeOverTypeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C407D8 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_20615/*"img_txt_account"*/);
    sub_1C37058(&StringLiteral_20616/*"img_txt_account_overwrite"*/);
    byte_4C407D8 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v4 = &StringLiteral_20615/*"img_txt_account"*/)
      : (v4 = &StringLiteral_20616/*"img_txt_account_overwrite"*/),
