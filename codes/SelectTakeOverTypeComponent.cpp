...
void SelectTakeOverTypeComponent__SetupTitleImg(SelectTakeOverTypeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC4BDF & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_20693/*"img_txt_account"*/);
    sub_1C713B0(&StringLiteral_20694/*"img_txt_account_overwrite"*/);
    byte_4CC4BDF = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v4 = &StringLiteral_20693/*"img_txt_account"*/)
      : (v4 = &StringLiteral_20694/*"img_txt_account_overwrite"*/),
