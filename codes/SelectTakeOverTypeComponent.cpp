...
void SelectTakeOverTypeComponent__SetupTitleImg(SelectTakeOverTypeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C54575 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_20633/*"img_txt_account"*/);
    sub_1C3E564(&StringLiteral_20634/*"img_txt_account_overwrite"*/);
    byte_4C54575 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v4 = &StringLiteral_20633/*"img_txt_account"*/)
      : (v4 = &StringLiteral_20634/*"img_txt_account_overwrite"*/),
