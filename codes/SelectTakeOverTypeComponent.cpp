        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8807 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_20208/*"img_txt_account"*/, v3);
    sub_1B4CF90(&StringLiteral_20209/*"img_txt_account_overwrite"*/, v4);
    byte_49B8807 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v6 = &StringLiteral_20208/*"img_txt_account"*/)
      : (v6 = &StringLiteral_20209/*"img_txt_account_overwrite"*/),
