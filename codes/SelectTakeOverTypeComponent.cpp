...
void SelectTakeOverTypeComponent__SetupTitleImg(SelectTakeOverTypeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02170 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_20916/*"img_txt_account"*/);
    sub_1CE6700(&StringLiteral_20917/*"img_txt_account_overwrite"*/);
    byte_4E02170 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v4 = &StringLiteral_20916/*"img_txt_account"*/)
      : (v4 = &StringLiteral_20917/*"img_txt_account_overwrite"*/),
