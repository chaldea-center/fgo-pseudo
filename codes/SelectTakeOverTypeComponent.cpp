...
void SelectTakeOverTypeComponent__SetupTitleImg(SelectTakeOverTypeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74DE3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_21007/*"img_txt_account"*/);
    sub_1D0F0B4(&StringLiteral_21008/*"img_txt_account_overwrite"*/);
    byte_4E74DE3 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v4 = &StringLiteral_21007/*"img_txt_account"*/)
      : (v4 = &StringLiteral_21008/*"img_txt_account_overwrite"*/),
