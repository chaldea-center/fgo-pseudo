        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BD35 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_20308/*"img_txt_account"*/, v3);
    sub_1B863B8(&StringLiteral_20309/*"img_txt_account_overwrite"*/, v4);
    byte_4A4BD35 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v6 = &StringLiteral_20308/*"img_txt_account"*/)
      : (v6 = &StringLiteral_20309/*"img_txt_account_overwrite"*/),
