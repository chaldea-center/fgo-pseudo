...
void SelectTakeOverTypeComponent__SetupTitleImg(SelectTakeOverTypeComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB3AC7 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_20680/*"img_txt_account"*/);
    sub_1C6BA08(&StringLiteral_20681/*"img_txt_account_overwrite"*/);
    byte_4CB3AC7 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v4 = &StringLiteral_20680/*"img_txt_account"*/)
      : (v4 = &StringLiteral_20681/*"img_txt_account_overwrite"*/),
