        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB36C2 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_20528/*"img_txt_account"*/, v3);
    sub_1BAB41C(&StringLiteral_20529/*"img_txt_account_overwrite"*/, v4);
    byte_4AB36C2 = 1;
  }
  titleImg = this->fields.titleImg;
  if ( !titleImg
    || (!SelectTakeOverTypeComponent_TypeInfo->static_fields->isOverride
      ? (v6 = &StringLiteral_20528/*"img_txt_account"*/)
      : (v6 = &StringLiteral_20529/*"img_txt_account_overwrite"*/),
