void MasterDataUnpakcer___ctor(MasterDataUnpakcer_o *this, const MethodInfo *method)
{
  ...
  v3 = (struct System_Byte_array *)sub_1C94140(byte___TypeInfo, 8);
  this->fields.tmp0 = v3;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)v3, v4, v5, v6, v7, v8, v9);
  v10 = (struct System_Byte_array *)sub_1C94140(byte___TypeInfo, 8);
  this->fields.tmp1 = v10;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.tmp1, (int32_t)v10, v11, v12, v13, v14, v15, v16);
  v17 = (System_IO_MemoryStream_o *)sub_1C942E4(System_IO_MemoryStream_TypeInfo);
  System_IO_MemoryStream___ctor_65238292(v17, 2000000, 0);
  this->fields.writeStream = v17;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.writeStream, (int32_t)v17, v18, v19, v20, v21, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  {
    v7 = sub_1C940AC(&System_FormatException_TypeInfo);
    v8 = (System_FormatException_o *)sub_1C942E4(v7);
    System_FormatException___ctor(v8, 0);
    v9 = sub_1C940AC(&Method_MasterDataUnpakcer_Seek__);
    sub_1C941C0(v8, v9);
  }
}
...
void MasterDataUnpakcer__Skip(MasterDataUnpakcer_o *this, System_IO_Stream_o *s, const MethodInfo *method)
{
  ...
  {
LABEL_35:
    v19 = sub_1C940AC(&System_FormatException_TypeInfo);
    v20 = (System_FormatException_o *)sub_1C942E4(v19);
    System_FormatException___ctor(v20, 0);
    v21 = sub_1C940AC(&Method_MasterDataUnpakcer_Skip__);
    sub_1C941C0(v20, v21);
  }
  if ( (int)v5 >= 128 )
  {
        ...
        const MethodInfo *method)
{
  ...
  v9 = (System_IO_MemoryStream_o *)sub_1C942E4(System_IO_MemoryStream_TypeInfo);
  System_IO_MemoryStream___ctor_65238924(v9, buf, offset, size, 0);
  v11 = MasterDataUnpakcer__Unpack_41799300(this, (System_IO_Stream_o *)v9, v10);
  if ( v9 )
  {
    klass = v9->klass;
    ...
    {
LABEL_8:
      v15 = sub_1C6A420(v9, System_IDisposable_TypeInfo, 0);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BD32 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_System_Collections_Generic_List_object___ctor___78998512);
  ...
  System_Collections_Generic_List_object____ctor_59156080(
    v7,
    len,
    (const MethodInfo_386A670 *)Method_System_Collections_Generic_List_object___ctor___78998512);
  if ( len >= 1 )
  {
    do
    {
      v9 = MasterDataUnpakcer__Unpack_41799300(this, s, v8);
      if ( !v7
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BD2E & 1) == 0 )
  {
    this = (MasterDataUnpakcer_o *)sub_1C94098(&byte___TypeInfo);
    byte_4D2BD2E = 1;
  }
  p_tmpBuffer = (GrandQuestFolderBoardItem_o *)&v8->fields.tmpBuffer;
  if ( !v8->fields.tmpBuffer )
  {
    v10 = sub_1C94140(byte___TypeInfo, 0x100000);
    p_tmpBuffer->klass = (GrandQuestFolderBoardItem_c *)v10;
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&v8->fields.tmpBuffer, v10, v11, v12, v13, v14, v15, v16);
  }
  if ( v7 <= 191 )
  {
    v30 = v7 & 0x1F;
    ...
    {
      v31 = sub_1C94140(byte___TypeInfo, v7 & 0x1F);
      p_tmpBuffer->klass = (GrandQuestFolderBoardItem_c *)v31;
      sub_1C9403C(p_tmpBuffer, v31, v32, v33, v34, v35, v36, v37);
    }
    if ( !s )
      goto LABEL_43;
...
LABEL_42:
  ...
  if ( ((1 << v17) & 0x200001) != 0 )
  {
    ...
    *(_QWORD *)&b = p_tmpBuffer->klass;
    ...
    {
      v38 = sub_1C94140(byte___TypeInfo, (unsigned int)this);
      p_tmpBuffer->klass = (GrandQuestFolderBoardItem_c *)v38;
      sub_1C9403C(p_tmpBuffer, v38, v39, v40, v41, v42, v43, v44);
      *(_QWORD *)&b = p_tmpBuffer->klass;
    }
    ...
    if ( LODWORD(tmp0->max_length) >= 2 )
    {
      *(_QWORD *)&b = p_tmpBuffer->klass;
      if ( p_tmpBuffer->klass )
      {
        ...
        {
          v51 = sub_1C94140(byte___TypeInfo, v19);
          p_tmpBuffer->klass = (GrandQuestFolderBoardItem_c *)v51;
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v8->fields.tmpBuffer, v51, v52, v53, v54, v55, v56, v57);
          *(_QWORD *)&b = p_tmpBuffer->klass;
        }
        this = (MasterDataUnpakcer_o *)((__int64 (__fastcall *)(System_IO_Stream_o *, _QWORD, _QWORD, _QWORD, const MethodInfo *))s->klass->vtable._31_unknown.methodPtr)(
                                         s,
    ...
    if ( LODWORD(v18->max_length) >= 4 )
    {
      *(_QWORD *)&b = p_tmpBuffer->klass;
      if ( p_tmpBuffer->klass )
      {
        ...
        if ( (signed int)v19 > *(_DWORD *)(*(_QWORD *)&b + 24LL) )
        {
          v20 = sub_1C94140(byte___TypeInfo, v19);
          p_tmpBuffer->klass = (GrandQuestFolderBoardItem_c *)v20;
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v8->fields.tmpBuffer, v20, v21, v22, v23, v24, v25, v26);
          *(_QWORD *)&b = p_tmpBuffer->klass;
        }
        this = (MasterDataUnpakcer_o *)((__int64 (__fastcall *)(System_IO_Stream_o *, _QWORD, _QWORD, _QWORD, const MethodInfo *))s->klass->vtable._31_unknown.methodPtr)(
                                         s,
...
System_Byte_array *MasterDataUnpakcer__UnpackBinary_41805456(
        MasterDataUnpakcer_o *this,
        System_IO_Stream_o *s,
        int64_t len,
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&byte___TypeInfo);
    sub_1C94098(&Method_MasterDataUnpakcer_UnpackBinary__);
    byte_4D2BD31 = 1;
  }
  v6 = sub_1C94140(byte___TypeInfo, v4);
  if ( !s )
    sub_1C942F0(v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_28:
    v13 = sub_1C940AC(&System_FormatException_TypeInfo);
    v14 = (System_FormatException_o *)sub_1C942E4(v13);
    System_FormatException___ctor(v14, 0);
    v15 = sub_1C940AC(&Method_MasterDataUnpakcer_UnpackByte__);
    sub_1C941C0(v14, v15);
  }
  if ( v7 >= 128 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BD33 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Collections_Generic_Dictionary_string__long____Add__);
    sub_1C94098(&Method_System_Collections_Generic_Dictionary_string__long_____ctor__);
  ...
  v7 = (System_Collections_Generic_Dictionary_object__object__o *)sub_1C942E4(System_Collections_Generic_Dictionary_string__long____TypeInfo);
  System_Collections_Generic_Dictionary_object__object____ctor_55706204(
    v7,
    len,
    (const MethodInfo_352025C *)Method_System_Collections_Generic_Dictionary_string__long_____ctor__);
  if ( !s )
LABEL_24:
    sub_1C942F0(writeStream, v9);
  ...
  if ( len >= 1 )
  {
    ...
    do
    {
      v13 = MasterDataUnpakcer__Unpack_41799300(this, s, v11);
      if ( v13 )
      {
      ...
      System_Collections_Generic_Dictionary_object__object___Add(
        ...
        v14,
        writeStream,
        (const MethodInfo_3520BF4 *)Method_System_Collections_Generic_Dictionary_string__long____Add__);
LABEL_22:
      --len;
    }
    while ( len );
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    System_Text_StringBuilder___ctor_64495056(v9, len, 0);
      ...
      while ( 1 )
      {
        ...
        if ( (v20 & 0xC0) == 0x80 )
        {
          ...
          if ( !HIWORD(v21) )
          {
            ...
            if ( !v8 )
              goto LABEL_41;
            System_Text_StringBuilder__Append_64504032(v8, v21, 0);
LABEL_29:
            v17 = 0;
LABEL_30:
            v16 = v21;
          ...
          if ( !v8 )
            goto LABEL_41;
          v16 = v21 - 0x10000;
          System_Text_StringBuilder__Append_64504032(v8, ((v21 - 0x10000) >> 10) - 10240, 0);
          v8 = MasterDataUnpakcer_TypeInfo->static_fields->sb;
          if ( !v8 )
            goto LABEL_41;
          v22 = v21 & 0x3FF | 0xDC00;
LABEL_19:
          System_Text_StringBuilder__Append_64504032(v8, v22, 0);
          goto LABEL_20;
        }
LABEL_38:
        if ( v19++ >= len )
...
int64_t MasterDataUnpakcer__UnpackUint16(MasterDataUnpakcer_o *this, System_IO_Stream_o *s, const MethodInfo *method)
{
  ...
  if ( (_DWORD)this != 2 )
  {
    v6 = sub_1C940AC(&System_FormatException_TypeInfo);
    v7 = (System_FormatException_o *)sub_1C942E4(v6);
    System_FormatException___ctor(v7, 0);
    v8 = sub_1C940AC(&Method_MasterDataUnpakcer_UnpackUint16__);
    sub_1C941C0(v7, v8);
  }
  tmp0 = v3->fields.tmp0;
  if ( !tmp0 )
...
int64_t MasterDataUnpakcer__UnpackUint32(MasterDataUnpakcer_o *this, System_IO_Stream_o *s, const MethodInfo *method)
{
  ...
  if ( (_DWORD)this != 4 )
  {
    ...
    v7 = (System_FormatException_o *)sub_1C942E4(v6);
    System_FormatException___ctor(v7, 0);
    v8 = sub_1C940AC(&Method_MasterDataUnpakcer_UnpackUint32__);
    sub_1C941C0(v7, v8);
  }
  tmp0 = v3->fields.tmp0;
  if ( !tmp0 )
...
Il2CppObject *MasterDataUnpakcer__Unpack_41799300(
        MasterDataUnpakcer_o *this,
        System_IO_Stream_o *s,
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BD2F & 1) == 0 )
  {
    ...
    this = (MasterDataUnpakcer_o *)sub_1C94098(&long_TypeInfo);
    byte_4D2BD2F = 1;
  }
  if ( !s )
LABEL_112:
  ...
  {
LABEL_113:
    v64 = sub_1C940AC(&System_FormatException_TypeInfo);
    v65 = (System_FormatException_o *)sub_1C942E4(v64);
    System_FormatException___ctor(v65, 0);
    v66 = sub_1C940AC(&Method_MasterDataUnpakcer_Unpack__);
    sub_1C941C0(v65, v66);
  }
  if ( (int)v5 <= 127 )
  {
      ...
      if ( (int)v5 < 224 )
      {
        ...
        switch ( v8 )
        {
          ...
          case 2:
            ...
            v28 = (int)v26;
            v29 = s;
            return (Il2CppObject *)MasterDataUnpakcer__UnpackBinary_41805456(v26, v29, v28, v27);
          case 3:
...
Il2CppObject *MasterDataUnpakcer__Unpack_41801184(
        MasterDataUnpakcer_o *this,
        System_Byte_array *buf,
        const MethodInfo *method)
{
