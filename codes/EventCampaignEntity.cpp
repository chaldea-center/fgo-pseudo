...
EventCampaignEntity_o *EventCampaignEntity__Clone(EventCampaignEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7758B & 1) == 0 )
  {
    sub_1D0F0B4(&EventCampaignEntity_TypeInfo);
    byte_4E7758B = 1;
  }
  v3 = sub_1D0F300(EventCampaignEntity_TypeInfo);
  ...
  *(_QWORD *)(v3 + 40) = targetIds;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 40), (int32_t)targetIds, v7, v8, v9, v10, v11, v12);
  *(_QWORD *)(v3 + 48) = *(_QWORD *)&this->fields.value;
  warIds = this->fields.warIds;
  *(_QWORD *)(v3 + 56) = warIds;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 56), (int32_t)warIds, v15, v16, v17, v18, v19, v20);
  entryCondMessage = this->fields.entryCondMessage;
  *(_QWORD *)(v3 + 64) = entryCondMessage;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 64), (int32_t)entryCondMessage, v22, v23, v24, v25, v26, v27);
  warGroupIds = this->fields.warGroupIds;
  *(_QWORD *)(v3 + 72) = warGroupIds;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 72), (int32_t)warGroupIds, v29, v30, v31, v32, v33, v34);
  script = this->fields.script;
  *(_QWORD *)(v3 + 80) = script;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v3 + 80), (int32_t)script, v36, v37, v38, v39, v40, v41);
...
System_String_o *EventCampaignEntity__GetAddPassiveContentDetail(EventCampaignEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E77591 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_16915/*"addPassiveContentDetail"*/);
    byte_4E77591 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_16915/*"addPassiveContentDetail"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E77590 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_16916/*"addPassiveContentOrganization"*/);
    byte_4E77590 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_16916/*"addPassiveContentOrganization"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E77592 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_16917/*"addPassiveDescriptionDetail"*/);
    byte_4E77592 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_16917/*"addPassiveDescriptionDetail"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E7758F & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_16918/*"addPassiveIconOrganization"*/);
    byte_4E7758F = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_16918/*"addPassiveIconOrganization"*/, 0, 0);
}
...
int32_t EventCampaignEntity__GetAddPassiveSkillId(EventCampaignEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E77593 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_16919/*"addPassiveSkillId"*/);
    byte_4E77593 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_16919/*"addPassiveSkillId"*/, 0, 0);
}
...
int32_t EventCampaignEntity__GetOnlyMaxFuncGroupId(EventCampaignEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_10118/*"OnlyMaxFuncGroupId"*/, 0, 0);
}
...
bool EventCampaignEntity__IsNotDispEntryCondMessage(EventCampaignEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E7758C & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_21336/*"isNotDispEntryCondMessage"*/);
    byte_4E7758C = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21336/*"isNotDispEntryCondMessage"*/, 0, 0) > 0;
}
...
bool EventCampaignEntity__IsShowBoardMessageOnWarGroupId(EventCampaignEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E7758E & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_23954/*"showBoardMessageOnWarGroupId"*/);
    byte_4E7758E = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23954/*"showBoardMessageOnWarGroupId"*/, 0, 0) > 0;
}
