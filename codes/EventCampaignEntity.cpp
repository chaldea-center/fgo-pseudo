...
EventCampaignEntity_o *__fastcall EventCampaignEntity__Clone(EventCampaignEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4E387 & 1) == 0 )
  {
    sub_1B863B8(&EventCampaignEntity_TypeInfo, method);
    byte_4A4E387 = 1;
  }
  v3 = sub_1B86604(EventCampaignEntity_TypeInfo);
  ...
  *(_QWORD *)(v3 + 40) = targetIds;
  sub_1B8635C((CGThumbnailListItem_o *)(v3 + 40), (int32_t)targetIds, v7, v8);
  *(_QWORD *)(v3 + 48) = *(_QWORD *)&this->fields.value;
  warIds = this->fields.warIds;
  *(_QWORD *)(v3 + 56) = warIds;
  sub_1B8635C((CGThumbnailListItem_o *)(v3 + 56), (int32_t)warIds, v11, v12);
  entryCondMessage = this->fields.entryCondMessage;
  *(_QWORD *)(v3 + 64) = entryCondMessage;
  sub_1B8635C((CGThumbnailListItem_o *)(v3 + 64), (int32_t)entryCondMessage, v14, v15);
  warGroupIds = this->fields.warGroupIds;
  *(_QWORD *)(v3 + 72) = warGroupIds;
  sub_1B8635C((CGThumbnailListItem_o *)(v3 + 72), (int32_t)warGroupIds, v17, v18);
  script = this->fields.script;
  *(_QWORD *)(v3 + 80) = script;
  sub_1B8635C((CGThumbnailListItem_o *)(v3 + 80), (int32_t)script, v20, v21);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4E38A & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&target);
    byte_4A4E38A = 1;
  }
...
int32_t __fastcall EventCampaignEntity__GetOnlyMaxFuncGroupId(EventCampaignEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A4E389 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_9847/*"OnlyMaxFuncGroupId"*/, method);
    byte_4A4E389 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_9847/*"OnlyMaxFuncGroupId"*/, 0, 0LL);
}
...
bool __fastcall EventCampaignEntity__IsNotDispEntryCondMessage(EventCampaignEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A4E388 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_20618/*"isNotDispEntryCondMessage"*/, method);
    byte_4A4E388 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20618/*"isNotDispEntryCondMessage"*/, 0, 0LL) > 0;
}
