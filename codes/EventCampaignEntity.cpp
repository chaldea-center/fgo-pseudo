...
EventCampaignEntity_o *__fastcall EventCampaignEntity__Clone(EventCampaignEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7995 & 1) == 0 )
  {
    sub_1C1ABD4(&EventCampaignEntity_TypeInfo, method);
    byte_4BC7995 = 1;
  }
  v3 = sub_1C1AE20(EventCampaignEntity_TypeInfo);
  ...
  *(_QWORD *)(v3 + 40) = targetIds;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v3 + 40), (int64_t)targetIds, v7, v8, v9, v10, v11, v12);
  *(_QWORD *)(v3 + 48) = *(_QWORD *)&this->fields.value;
  warIds = this->fields.warIds;
  *(_QWORD *)(v3 + 56) = warIds;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v3 + 56), (int64_t)warIds, v15, v16, v17, v18, v19, v20);
  entryCondMessage = this->fields.entryCondMessage;
  *(_QWORD *)(v3 + 64) = entryCondMessage;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v3 + 64), (int64_t)entryCondMessage, v22, v23, v24, v25, v26, v27);
  warGroupIds = this->fields.warGroupIds;
  *(_QWORD *)(v3 + 72) = warGroupIds;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v3 + 72), (int64_t)warGroupIds, v29, v30, v31, v32, v33, v34);
