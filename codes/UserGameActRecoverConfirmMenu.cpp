...
void UserGameActRecoverConfirmMenu__Close(UserGameActRecoverConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  UserGameActRecoverConfirmMenu__Close_40160492(this, 0, v2);
}


void UserGameActRecoverConfirmMenu__Close_40160492(
        UserGameActRecoverConfirmMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C41C3E & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_UserGameActRecoverConfirmMenu_EndClose__);
    byte_4C41C3E = 1;
  }
...
void UserGameActRecoverConfirmMenu__OnClickCancel(UserGameActRecoverConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C41C40 & 1) == 0 )
  {
    sub_1C37058(&Method_UserGameActRecoverConfirmMenu_OnClickCancel__);
    byte_4C41C40 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserGameActRecoverConfirmMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_UserGameActRecoverConfirmMenu_OnClickCancel__);
...
void UserGameActRecoverConfirmMenu__OnClickClose(UserGameActRecoverConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C41C41 & 1) == 0 )
  {
    sub_1C37058(&Method_UserGameActRecoverConfirmMenu_OnClickClose__);
    byte_4C41C41 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserGameActRecoverConfirmMenu_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_UserGameActRecoverConfirmMenu_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    UserGameActRecoverConfirmMenu__Callback(this, 0, v5);
  }
...
void UserGameActRecoverConfirmMenu__OnClickDecide(UserGameActRecoverConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C41C3F & 1) == 0 )
  {
    sub_1C37058(&Method_UserGameActRecoverConfirmMenu_OnClickDecide__);
    byte_4C41C3F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserGameActRecoverConfirmMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_UserGameActRecoverConfirmMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C41C3D & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_UserGameActRecoverConfirmMenu_EndOpen__);
    sub_1C37058(&StringLiteral_14862/*"USER_GAME_ACT_RECOVER_STONE"*/);
    sub_1C37058(&StringLiteral_14858/*"USER_GAME_ACT_RECOVER_MESSAGE_INFO_NONE"*/);
    sub_1C37058(&StringLiteral_14852/*"USER_GAME_ACT_RECOVER_CANCEL"*/);
    sub_1C37058(&StringLiteral_14861/*"USER_GAME_ACT_RECOVER_REQUEST_STONE_MESSAGE"*/);
    sub_1C37058(&StringLiteral_14853/*"USER_GAME_ACT_RECOVER_CLOSE"*/);
    sub_1C37058(&StringLiteral_14854/*"USER_GAME_ACT_RECOVER_DECIDE"*/);
    sub_1C37058(&StringLiteral_14857/*"USER_GAME_ACT_RECOVER_MESSAGE_END"*/);
    sub_1C37058(&StringLiteral_14856/*"USER_GAME_ACT_RECOVER_INFO_BEFORE_AFTER"*/);
    sub_1C37058(&StringLiteral_12396/*"STONE_TAKE"*/);
    sub_1C37058(&StringLiteral_14860/*"USER_GAME_ACT_RECOVER_MESSAGE_START"*/);
    sub_1C37058(&StringLiteral_12397/*"STONE_UNIT"*/);
    sub_1C37058(&StringLiteral_1/*""*/);
    sub_1C37058(&StringLiteral_14855/*"USER_GAME_ACT_RECOVER_INFO"*/);
    sub_1C37058(&StringLiteral_14859/*"USER_GAME_ACT_RECOVER_MESSAGE_MAX_ACT"*/);
    byte_4C41C3D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.userGameEntity, (int32_t)SelfUserGame, v14, v15);
    stoneTitleLabel = this->fields.stoneTitleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12396/*"STONE_TAKE"*/, 0);
    if ( !stoneTitleLabel )
      goto LABEL_72;
    UILabel__set_text(stoneTitleLabel, (System_String_o *)gameObject, 0);
    stoneDataLabel = this->fields.stoneDataLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12397/*"STONE_UNIT"*/, 0);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14855/*"USER_GAME_ACT_RECOVER_INFO"*/, 0);
    if ( !*p_userGameEntity )
      goto LABEL_72;
    ...
    v42 = (Il2CppObject *)System_String__Format_63602948(v27, v40, v41, 0);
    if ( (unsigned int)kind < 2 )
    {
      messageLabel = this->fields.messageLabel;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14860/*"USER_GAME_ACT_RECOVER_MESSAGE_START"*/, 0);
      if ( !messageLabel )
        goto LABEL_72;
    ...
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14853/*"USER_GAME_ACT_RECOVER_CLOSE"*/, 0);
      if ( !closeLabel )
        goto LABEL_72;
...
LABEL_41:
      switch ( kind )
      {
        case 0:
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14854/*"USER_GAME_ACT_RECOVER_DECIDE"*/, 0);
          if ( !decideLabel )
            goto LABEL_72;
          UILabel__set_text(decideLabel, (System_String_o *)gameObject, 0);
          cancelLabel = this->fields.cancelLabel;
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14852/*"USER_GAME_ACT_RECOVER_CANCEL"*/, 0);
          if ( !cancelLabel )
            goto LABEL_72;
          ...
          v64 = (Il2CppObject *)System_String__Format_63602948(v54, v62, v63, 0);
          v65 = LocalizationManager__Get((System_String_o *)StringLiteral_14856/*"USER_GAME_ACT_RECOVER_INFO_BEFORE_AFTER"*/, 0);
          v42 = (Il2CppObject *)System_String__Format_63602948(v65, v42, v64, 0);
          goto LABEL_69;
        case 1:
          warningLabel = this->fields.warningLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14861/*"USER_GAME_ACT_RECOVER_REQUEST_STONE_MESSAGE"*/, 0);
          if ( !warningLabel )
            goto LABEL_72;
          UILabel__set_text(warningLabel, (System_String_o *)gameObject, 0);
          v67 = this->fields.decideLabel;
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_14862/*"USER_GAME_ACT_RECOVER_STONE"*/, 0);
          if ( !v67 )
            goto LABEL_72;
        ...
        case 2:
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v69 = &StringLiteral_14857/*"USER_GAME_ACT_RECOVER_MESSAGE_END"*/;
          goto LABEL_65;
        case 3:
          v68 = this->fields.messageLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v69 = &StringLiteral_14859/*"USER_GAME_ACT_RECOVER_MESSAGE_MAX_ACT"*/;
          goto LABEL_65;
        case 4:
          v68 = this->fields.messageLabel;
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v69 = &StringLiteral_14858/*"USER_GAME_ACT_RECOVER_MESSAGE_INFO_NONE"*/;
LABEL_65:
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A7AB60;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A7AB18;
}
