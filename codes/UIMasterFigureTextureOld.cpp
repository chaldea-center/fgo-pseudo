...
LABEL_12:
        ...
        if ( onLoadCallbackFunc )
        {
          ...
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.onLoadCallbackFunc, 0, v22, v23, v24, v25, v26, v27);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C942F0(bodyTexture, *(_QWORD *)&width);
  }
        ...
        const MethodInfo *method)
{
  ...
  GrandQuestFolderBoardItem_o *p_onLoadCallbackFunc; // x19
  ...
  if ( (byte_4D2E186 & 1) == 0 )
  {
    ...
    sub_1C94098(&AssetManager_TypeInfo);
    sub_1C94098(&Method_UIMasterFigureTextureOld_EndLoadAsset__);
    byte_4D2E186 = 1;
  }
  ...
  if ( v11 )
  {
    ...
    if ( AssetManager__compAssetStorageList(v11, loadNameList, 0) )
    {
      ...
      p_onLoadCallbackFunc = (GrandQuestFolderBoardItem_o *)&this->fields.onLoadCallbackFunc;
      v14 = System_Delegate__Combine(onLoadCallbackFunc, (System_Delegate_o *)callbackFunc, 0);
      v21 = v14;
      if ( v14 )
      {
...
LABEL_25:
      ...
      sub_1C9403C(p_onLoadCallbackFunc, (int32_t)v14, v15, v16, v17, v18, v19, v20);
      return;
    }
    v25 = this->fields.loadNameList;
    if ( !AssetManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
    AssetManager__releaseAssetStorage_41294468(v25, 0);
  }
  else
  {
    assetDataList = this->fields.assetDataList;
    if ( assetDataList )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      if ( AssetManager__compAssetStorageList_41283252(assetDataList, loadNameList, 0) )
      {
  ...
  if ( callbackFunc )
  {
    v26 = &this->fields.onLoadCallbackFunc;
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_41292120(v35, v36, 1, 0);
}
