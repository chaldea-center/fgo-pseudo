        ...
        const MethodInfo *method)
{
  ...
  PresentSelectableBulkItemConfirmDlg__Close_37981712(this, 0LL, v2);
}


void __fastcall PresentSelectableBulkItemConfirmDlg__Close_37981712(
        PresentSelectableBulkItemConfirmDlg_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9BEF & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_PresentSelectableBulkItemConfirmDlg_EndClose__, v6);
    byte_49B9BEF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9BF1 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_PresentSelectableBulkItemConfirmDlg_OnClickCancel__, v3);
    sub_1B4CF90(&Method_PresentSelectableBulkItemConfirmDlg__OnClickCancel_b__39_0__, v4);
    byte_49B9BF1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentSelectableBulkItemConfirmDlg_OnClickCancel__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B4CFA8(Method_PresentSelectableBulkItemConfirmDlg_OnClickCancel__);
    ...
    System_Action___ctor(
      ...
      0LL);
    PresentSelectableBulkItemConfirmDlg__Close_37981712(this, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&System_Action_TypeInfo, method);
    sub_1B4CF90(&Method_PresentSelectableBulkItemConfirmDlg_OnClickDecide__, v3);
    sub_1B4CF90(&Method_PresentSelectableBulkItemConfirmDlg__OnClickDecide_b__38_0__, v4);
    byte_49B9BF0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentSelectableBulkItemConfirmDlg_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B4CFA8(Method_PresentSelectableBulkItemConfirmDlg_OnClickDecide__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B4CF74(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9BEE & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_PresentSelectableBulkItemConfirmDlg_EndOpen__, v17);
    sub_1B4CF90(&StringLiteral_10230/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_TITLE"*/, v18);
    sub_1B4CF90(&StringLiteral_10229/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_DETAIL_UPPER"*/, v19);
    sub_1B4CF90(&StringLiteral_10232/*"PRESENT_BOX_SELECTABLE_BULK_DESTINATION_KIND"*/, v20);
    sub_1B4CF90(&StringLiteral_10234/*"PRESENT_BOX_SELECTABLE_BULK_ORIGIN_KIND"*/, v21);
    sub_1B4CF90(&StringLiteral_10228/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_DETAIL_UNDER"*/, v22);
    sub_1B4CF90(&StringLiteral_10233/*"PRESENT_BOX_SELECTABLE_BULK_ORIGIN"*/, v23);
    sub_1B4CF90(&StringLiteral_10256/*"PRESENT_SELECT_ITEM_OVER_WARNING"*/, v24);
    sub_1B4CF90(&StringLiteral_10231/*"PRESENT_BOX_SELECTABLE_BULK_DESTINATION"*/, v25);
    sub_1B4CF90(&StringLiteral_10255/*"PRESENT_SELECT_ITEM_FULL_WARNING"*/, v26);
    byte_49B9BEE = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.itemSelectEntity, (int32_t)entity, v27, v28);
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !gameObject )
      goto LABEL_42;
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10230/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_TITLE"*/, 0LL);
    if ( !TitleLabel )
      goto LABEL_42;
    UILabel__set_text(TitleLabel, (System_String_o *)gameObject, 0LL);
    DetailLabel = this->fields.DetailLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10229/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_DETAIL_UPPER"*/, 0LL);
    if ( !DetailLabel )
      goto LABEL_42;
    UILabel__set_text(DetailLabel, (System_String_o *)gameObject, 0LL);
    UnderDetailLabel = this->fields.UnderDetailLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10228/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_DETAIL_UNDER"*/, 0LL);
    if ( !UnderDetailLabel )
      goto LABEL_42;
    UILabel__set_text(UnderDetailLabel, (System_String_o *)gameObject, 0LL);
    exchangeOrigin = this->fields.exchangeOrigin;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10233/*"PRESENT_BOX_SELECTABLE_BULK_ORIGIN"*/, 0LL);
    if ( !exchangeOrigin )
      goto LABEL_42;
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10234/*"PRESENT_BOX_SELECTABLE_BULK_ORIGIN_KIND"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10231/*"PRESENT_BOX_SELECTABLE_BULK_DESTINATION"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10232/*"PRESENT_BOX_SELECTABLE_BULK_DESTINATION_KIND"*/, 0LL);
    ...
    if ( UserItemMax <= itemHold )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v45 = &StringLiteral_10255/*"PRESENT_SELECT_ITEM_FULL_WARNING"*/;
    }
    else
    {
...
LABEL_42:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v45 = &StringLiteral_10256/*"PRESENT_SELECT_ITEM_OVER_WARNING"*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9BF2 & 1) == 0 )
  {
    this = (PresentSelectableBulkItemConfirmDlg_o *)sub_1B4CF90(&LocalizationManager_TypeInfo, *(_QWORD *)&count);
    byte_49B9BF2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B9BEC & 1) == 0 )
  {
    sub_1B4CF90(&PresentSelectableBulkItemConfirmDlg_CallbackFunc_TypeInfo, value);
    byte_49B9BEC = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_199B8A4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_199B85C;
}
