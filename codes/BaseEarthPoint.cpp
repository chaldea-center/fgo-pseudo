void __fastcall BaseEarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B33BEA & 1) == 0 )
  {
    sub_1BD3458(&BaseEarthPoint_TypeInfo, v1);
    byte_4B33BEA = 1;
  }
  if ( !byte_4B31941 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33BE9 & 1) == 0 )
  {
    sub_1BD3458(&BaseEarthPoint_TypeInfo, vec);
    byte_4B33BE9 = 1;
  }
  ...
  {
    v10 = (unsigned __int8)byte_4B31941;
    vec->fields.x = x / v9;
    vec->fields.y = 0.0 / v9;
    vec->fields.z = z / v9;
    if ( !v10 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B33BE8 & 1) == 0 )
  {
    sub_1BD3458(&CommonEffectManager_TypeInfo, isActive);
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponentInChildren_ParticleSystem___, v7);
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_BaseCore___, v8);
  ...
  *(_QWORD *)&v72.fields.x = 0LL;
  ...
  v22 = UnityEngine_GameObject__GetComponent_object_(
          v14,
          (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_BaseCore___);
  this->fields.mEarthCore = (struct BaseCore_o *)v22;
  p_mEarthCore = &this->fields.mEarthCore;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.mEarthCore, (int64_t)v22, v24, v25, v26, v27, v28, v29);
  ...
  if ( isActive )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mParticleSystemObj, 0LL, 0LL) )
    {
      ...
      if ( !byte_4B31941 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1BD3458(&UnityEngine_Vector3_TypeInfo, v13);
        byte_4B31941 = 1;
      }
      if ( !v37 )
        goto LABEL_47;
      ...
      if ( !byte_4B31947 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1BD3458(&UnityEngine_Quaternion_TypeInfo, v13);
        byte_4B31947 = 1;
      }
      if ( !v38 )
        goto LABEL_47;
  ...
  if ( !byte_4B31941 )
  {
    sub_1BD3458(&UnityEngine_Vector3_TypeInfo, v31);
    byte_4B31941 = 1;
  }
  static_fields = UnityEngine_Vector3_TypeInfo->static_fields;
  z = static_fields->zeroVector.fields.z;
...
LABEL_37:
  ...
  if ( !byte_4B31944 )
  {
    sub_1BD3458(&System_Math_TypeInfo, v57);
    byte_4B31944 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  ...
  v75.fields.y = -v63;
  v75.fields.z = -v64;
  v76 = UnityEngine_Quaternion__LookRotation_70216632(v75, 0LL);
