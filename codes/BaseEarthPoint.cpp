void __fastcall BaseEarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFE8A6 & 1) == 0 )
  {
    sub_1BC3008(&BaseEarthPoint_TypeInfo, v1);
    byte_4AFE8A6 = 1;
  }
  if ( !byte_4AFBDB1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE8A5 & 1) == 0 )
  {
    sub_1BC3008(&BaseEarthPoint_TypeInfo, vec);
    byte_4AFE8A5 = 1;
  }
  ...
  {
    v10 = (unsigned __int8)byte_4AFBDB1;
    vec->fields.x = x / v9;
    vec->fields.y = 0.0 / v9;
    vec->fields.z = z / v9;
    if ( !v10 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE8A4 & 1) == 0 )
  {
    sub_1BC3008(&CommonEffectManager_TypeInfo, isActive);
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponentInChildren_ParticleSystem___, v7);
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_BaseCore___, v8);
  ...
  *(_QWORD *)&v52.fields.x = 0LL;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)Component_object, v16, v17);
  if ( !v14 )
    goto LABEL_47;
  v18 = UnityEngine_GameObject__GetComponent_object_(
          v14,
          (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_BaseCore___);
  this->fields.mEarthCore = (struct BaseCore_o *)v18;
  p_mEarthCore = &this->fields.mEarthCore;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.mEarthCore, (int32_t)v18, v20, v21);
  ...
  if ( isActive )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mParticleSystemObj, 0LL, 0LL) )
    {
      ...
      if ( !byte_4AFBDB1 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v13);
        byte_4AFBDB1 = 1;
      }
      if ( !v29 )
        goto LABEL_47;
      ...
      if ( !byte_4AFBDB7 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1BC3008(&UnityEngine_Quaternion_TypeInfo, v13);
        byte_4AFBDB7 = 1;
      }
      if ( !v30 )
        goto LABEL_47;
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.mParticleSystem, (int32_t)ComponentInChildren_object, v33, v34);
      this->fields.mParticleSystemObj = v28;
      sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.mParticleSystemObj, (int32_t)v28, v35, v36);
    }
  }
  if ( !byte_4AFBDB1 )
  {
...
LABEL_37:
  ...
  if ( !byte_4AFBDB4 )
  {
    sub_1BC3008(&System_Math_TypeInfo, v41);
    byte_4AFBDB4 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  ...
  if ( v45 <= 0.00001 )
  {
    if ( !byte_4AFBDB1 )
    {
      sub_1BC3008(&UnityEngine_Vector3_TypeInfo, v41);
      byte_4AFBDB1 = 1;
    }
  ...
  v55.fields.y = -v47;
  v55.fields.z = -v48;
  v56 = UnityEngine_Quaternion__LookRotation_69973144(v55, 0LL);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.earthEffectCamera, (int32_t)earthEffCamera, v50, v51);
}
