void __fastcall BaseEarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F8F8A & 1) == 0 )
  {
    sub_1B640C8(&BaseEarthPoint_TypeInfo, v1);
    byte_49F8F8A = 1;
  }
  if ( !byte_49F7111 )
  {
...
float __fastcall BaseEarthPoint__GetDotXZ(BaseEarthPoint_o *this, UnityEngine_Vector3_o *vec, const MethodInfo *method)
{
  ...
  *(UnityEngine_Vector3_o *)&v6 = GameObjectExtensions__GetPosition(gameObject, 0LL);
  ...
  v13 = v9 - Position.fields.x;
  v14 = v10 - Position.fields.z;
  vec->fields.y = 0.0;
  vec->fields.x = v13;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8F89 & 1) == 0 )
  {
    sub_1B640C8(&BaseEarthPoint_TypeInfo, vec);
    byte_49F8F89 = 1;
  }
  ...
  {
    v10 = (unsigned __int8)byte_49F7111;
    vec->fields.x = x / v9;
    vec->fields.y = 0.0 / v9;
    vec->fields.z = z / v9;
    if ( !v10 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F8F88 & 1) == 0 )
  {
    sub_1B640C8(&CommonEffectManager_TypeInfo, isActive);
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponentInChildren_ParticleSystem___, v7);
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_BaseCore___, v8);
  ...
  *(_QWORD *)&v54.fields.x = 0LL;
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v15, v16);
  if ( !v13 )
    goto LABEL_47;
  v17 = UnityEngine_GameObject__GetComponent_object_(
          v13,
          (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_BaseCore___);
  this->fields.mEarthCore = (struct BaseCore_o *)v17;
  p_mEarthCore = &this->fields.mEarthCore;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.mEarthCore, (int32_t)v17, v19, v20);
  gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(v13, 0LL);
  if ( !gameObject )
    goto LABEL_47;
  LODWORD(v21) = (unsigned int)UnityEngine_Transform__get_localScale((UnityEngine_Transform_o *)gameObject, 0LL);
  gameObject = (UnityEngine_GameObject_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
    goto LABEL_47;
  v55.fields.x = 1.0 / v21;
  v55.fields.y = 1.0 / v21;
  v55.fields.z = 1.0 / v21;
  ...
  if ( isActive )
  {
    ...
    {
      v25 = (System_String_o *)((__int64 (__fastcall *)(BaseEarthPoint_o *, void *))this->klass->vtable._5_GetEffectName.method)(
                                 this,
                                 this->klass[1]._1.image);
      v26 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
      if ( !CommonEffectManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CommonEffectManager_TypeInfo);
      gameObject = CommonEffectManager__SetSkinEffect(v25, v26, 0LL);
      if ( !gameObject )
        goto LABEL_47;
      v27 = gameObject;
      ...
      if ( !byte_49F7117 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1B640C8(&UnityEngine_Quaternion_TypeInfo, v30);
        byte_49F7117 = 1;
      }
      if ( !v31 )
        goto LABEL_47;
      ...
      if ( !byte_49F7116 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1B640C8(&UnityEngine_Vector3_TypeInfo, v32);
        byte_49F7116 = 1;
      }
      if ( !v33 )
        goto LABEL_47;
      ...
      sub_1B6406C(
        ...
        v35,
        v36);
      this->fields.mParticleSystemObj = v27;
      sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.mParticleSystemObj, (int32_t)v27, v37, v38);
    }
  }
  if ( !byte_49F7111 )
  {
  ...
  static_fields = UnityEngine_Vector3_TypeInfo->static_fields;
  z = static_fields->zeroVector.fields.z;
  *(_QWORD *)&v54.fields.x = *(_QWORD *)&static_fields->zeroVector.fields.x;
  v54.fields.z = z;
  DotXZ_Deg = BaseEarthPoint__GetDotXZ_Deg(this, &v54, v23);
  if ( v54.fields.x < 0.0 )
    DotXZ_Deg = -DotXZ_Deg;
...
LABEL_37:
  ...
  v46 = LocalPosition.fields.z;
  if ( !byte_49F7114 )
  {
    sub_1B640C8(&System_Math_TypeInfo, v43);
    byte_49F7114 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v47 = sqrtf((float)(v46 * v46) + (float)((float)(x * x) + (float)(y * y)));
  if ( v47 <= 0.00001 )
  {
    if ( !byte_49F7111 )
    {
      sub_1B640C8(&UnityEngine_Vector3_TypeInfo, v43);
      byte_49F7111 = 1;
    }
    v51 = UnityEngine_Vector3_TypeInfo->static_fields;
    v48 = v51->zeroVector.fields.x;
    v49 = v51->zeroVector.fields.y;
    v50 = v51->zeroVector.fields.z;
  }
  else
  {
    v48 = x / v47;
  ...
  v57.fields.y = -v49;
  v57.fields.z = -v50;
  v58 = UnityEngine_Quaternion__LookRotation_69066096(v57, 0LL);
  this->fields._FocusQua_k__BackingField = v58;
  this->fields._FocusQua_k__BackingField = UnityEngine_Quaternion__Inverse(v58, 0LL);
  this->fields.earthEffectCamera = earthEffCamera;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.earthEffectCamera, (int32_t)earthEffCamera, v52, v53);
}
