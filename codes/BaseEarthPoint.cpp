void __fastcall BaseEarthPoint___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FB079 & 1) == 0 )
  {
    sub_1B64870(&BaseEarthPoint_TypeInfo, v1);
    byte_49FB079 = 1;
  }
  if ( !byte_49F9201 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB078 & 1) == 0 )
  {
    sub_1B64870(&BaseEarthPoint_TypeInfo, vec);
    byte_49FB078 = 1;
  }
  ...
  {
    v10 = (unsigned __int8)byte_49F9201;
    vec->fields.x = x / v9;
    vec->fields.y = 0.0 / v9;
    vec->fields.z = z / v9;
    if ( !v10 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB077 & 1) == 0 )
  {
    sub_1B64870(&CommonEffectManager_TypeInfo, isActive);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponentInChildren_ParticleSystem___, v7);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_BaseCore___, v8);
  ...
  *(_QWORD *)&v52.fields.x = 0LL;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.mWidget, (int32_t)Component_object, v16, v17);
  if ( !v14 )
    goto LABEL_47;
  v18 = UnityEngine_GameObject__GetComponent_object_(
          v14,
          (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_BaseCore___);
  this->fields.mEarthCore = (struct BaseCore_o *)v18;
  p_mEarthCore = &this->fields.mEarthCore;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.mEarthCore, (int32_t)v18, v20, v21);
  ...
  if ( isActive )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mParticleSystemObj, 0LL, 0LL) )
    {
      ...
      if ( !byte_49F9201 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1B64870(&UnityEngine_Vector3_TypeInfo, v13);
        byte_49F9201 = 1;
      }
      if ( !v29 )
        goto LABEL_47;
      ...
      if ( !byte_49F9207 )
      {
        gameObject = (UnityEngine_GameObject_o *)sub_1B64870(&UnityEngine_Quaternion_TypeInfo, v13);
        byte_49F9207 = 1;
      }
      if ( !v30 )
        goto LABEL_47;
      ...
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.mParticleSystemObj, (int32_t)v28, v35, v36);
    }
  }
  if ( !byte_49F9201 )
  {
...
LABEL_37:
  ...
  if ( !byte_49F9204 )
  {
    sub_1B64870(&System_Math_TypeInfo, v41);
    byte_49F9204 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  ...
  v55.fields.y = -v47;
  v55.fields.z = -v48;
  v56 = UnityEngine_Quaternion__LookRotation_69074276(v55, 0LL);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.earthEffectCamera, (int32_t)earthEffCamera, v50, v51);
}
