        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ACF19 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_BaseCore___);
  ...
  sub_B52920(&this->fields.mWidget);
  if ( !v9 )
    goto LABEL_32;
  this->fields.mEarthCore = (struct BaseCore_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                   v9,
                                                   (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_BaseCore___);
  p_mEarthCore = &this->fields.mEarthCore;
  sub_B52920(&this->fields.mEarthCore);
  ...
  if ( isActive )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mParticleSystemObj, 0LL, 0LL) )
    {
      ...
      *(UnityEngine_Vector3_o *)&v26 = UnityEngine_Vector3__get_one(0LL);
      ...
      sub_B52920(&this->fields.mParticleSystem);
      this->fields.mParticleSystemObj = v15;
      sub_B52920(&this->fields.mParticleSystemObj);
    }
  }
...
LABEL_31:
  ...
  *(float *)&v32.invoker_method = LocalPosition.fields.z;
  ...
  v36 = UnityEngine_Quaternion__LookRotation_35647968(normalized, 0LL);
  ...
  sub_B52920(&this->fields.earthEffectCamera);
}
