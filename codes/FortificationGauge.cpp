void FortificationGauge___ctor(FortificationGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E08545 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_2857/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/);
    byte_4E08545 = 1;
  }
  v9 = StringLiteral_2857/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  this->fields.GET_POINT_LOCALIZE_KEY = (struct System_String_o *)StringLiteral_2857/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.GET_POINT_LOCALIZE_KEY, v9, v2, v3, v4, v5, v6, v7);
...
void FortificationGauge__SetData(FortificationGauge_o *this, BattleFortificationInfo_o *info, const MethodInfo *method)
{
  ...
  if ( (byte_4E08544 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2856/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/);
    byte_4E08544 = 1;
  }
  ...
  *(_QWORD *)&v34.fields.b = 0;
  ...
  v16 = System_String__Concat_65122828(GET_POINT_LOCALIZE_KEY, v15, 0);
  ...
  if ( !*p_fortificationInfo )
    goto LABEL_43;
  v18 = itemIcon;
  v19 = (Il2CppObject *)System_Int32__ToString_66631324(
  ...
  v22 = System_String__Format_65164136((System_String_o *)StringLiteral_2856/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v20, v21, 0);
  ...
  if ( GiftEntity )
  {
    ...
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__SetGift_42064732((ItemIconComponent_o *)itemIcon, v26[5], v26[6], v26[7], 0, 0);
    itemIcon = (System_String_o *)this->fields.itemIcon;
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__setFrameSprite(
      ...
      v26[5] == 1,
      (System_String_o *)StringLiteral_20659/*"img_common_frame01"*/,
      0);
  }
  itemIcon = (System_String_o *)*p_fortificationInfo;
  if ( !*p_fortificationInfo )
