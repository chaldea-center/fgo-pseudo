void FortificationGauge___ctor(FortificationGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AB72 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_2840/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/);
    byte_4C2AB72 = 1;
  }
  v5 = StringLiteral_2840/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  this->fields.GET_POINT_LOCALIZE_KEY = (struct System_String_o *)StringLiteral_2840/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.GET_POINT_LOCALIZE_KEY, v5, v2, v3);
...
void FortificationGauge__SetData(FortificationGauge_o *this, BattleFortificationInfo_o *info, const MethodInfo *method)
{
  ...
  if ( (byte_4C2AB71 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_2839/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/);
    byte_4C2AB71 = 1;
  }
  ...
  *(_QWORD *)&v36.fields.b = 0;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.fortificationInfo, (int32_t)info, (int32_t)method, v3);
  ...
  v12 = System_String__Concat_63457864(GET_POINT_LOCALIZE_KEY, v11, 0);
  ...
  if ( !*p_fortificationInfo )
    goto LABEL_43;
  v14 = itemIcon;
  v15 = (Il2CppObject *)System_Int32__ToString_64968716(
  ...
  v24 = System_String__Format_63499156((System_String_o *)StringLiteral_2839/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v19, v23, 0);
  v25 = LocalizationManager__Get(v24, 0);
  itemIcon = (System_String_o *)UnityEngine_ColorUtility__TryParseHtmlString(v25, &v36, 0);
  bg = this->fields.bg;
  if ( ((unsigned __int8)itemIcon & 1) != 0 )
  {
    if ( !bg )
      goto LABEL_43;
    UIWidget__set_color((UIWidget_o *)this->fields.bg, v36, 0);
  ...
  else
  {
    ...
    v39.fields.b = 1.0;
    v39.fields.a = 1.0;
    UIWidget__set_color((UIWidget_o *)this->fields.bg, v39, 0);
  }
  ...
  if ( GiftEntity )
  {
    ...
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__SetGift_40700316((ItemIconComponent_o *)itemIcon, v28[5], v28[6], v28[7], 0, 0);
    itemIcon = (System_String_o *)this->fields.itemIcon;
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__setFrameSprite(
      ...
      v28[5] == 1,
      (System_String_o *)StringLiteral_20349/*"img_common_frame01"*/,
      0);
  }
  itemIcon = (System_String_o *)*p_fortificationInfo;
  if ( !*p_fortificationInfo )
...
LABEL_42:
  UIProgressBar__set_value((UIProgressBar_o *)itemIcon, v34, 0);
}