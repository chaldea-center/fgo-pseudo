void __fastcall FortificationGauge___ctor(FortificationGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B48170 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_2869/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/, method);
    byte_4B48170 = 1;
  }
  v5 = StringLiteral_2869/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  this->fields.GET_POINT_LOCALIZE_KEY = (struct System_String_o *)StringLiteral_2869/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.GET_POINT_LOCALIZE_KEY, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4816F & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, info);
    sub_1BDB878(&LocalizationManager_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_20379/*"img_common_frame01"*/, v7);
    sub_1BDB878(&StringLiteral_9229/*"N0"*/, v8);
    sub_1BDB878(&StringLiteral_2868/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v9);
    byte_4B4816F = 1;
  }
  ...
  *(_QWORD *)&v40.fields.b = 0LL;
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.fortificationInfo, (int32_t)info, (int32_t)method, v3);
  ...
  v16 = System_String__Concat_62572260(GET_POINT_LOCALIZE_KEY, v15, 0LL);
  ...
  if ( !*p_fortificationInfo )
    goto LABEL_43;
  v18 = itemIcon;
  v19 = (Il2CppObject *)System_Int32__ToString_64087256(
  ...
  v28 = System_String__Format_62613552((System_String_o *)StringLiteral_2868/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v23, v27, 0LL);
  ...
  if ( GiftEntity )
  {
    ...
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__SetGift_39935088((ItemIconComponent_o *)itemIcon, v32[5], v32[6], v32[7], 0, 0LL);
    itemIcon = (System_String_o *)this->fields.itemIcon;
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__setFrameSprite(
      ...
      v32[5] == 1,
      (System_String_o *)StringLiteral_20379/*"img_common_frame01"*/,
      0LL);
  }
  itemIcon = (System_String_o *)*p_fortificationInfo;
  if ( !*p_fortificationInfo )
