void __fastcall FortificationGauge___ctor(FortificationGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCAF36 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_2990/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/, method);
    byte_4BCAF36 = 1;
  }
  v9 = StringLiteral_2990/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  this->fields.GET_POINT_LOCALIZE_KEY = (struct System_String_o *)StringLiteral_2990/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.GET_POINT_LOCALIZE_KEY, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAF35 & 1) == 0 )
  {
    sub_1C1ABD4(&int_TypeInfo, info);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v10);
    sub_1C1ABD4(&StringLiteral_20637/*"img_common_frame01"*/, v11);
    sub_1C1ABD4(&StringLiteral_9389/*"N0"*/, v12);
    sub_1C1ABD4(&StringLiteral_2989/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v13);
    byte_4BCAF35 = 1;
  }
  ...
  *(_QWORD *)&v44.fields.b = 0LL;
  ...
  v20 = System_String__Concat_63040368(GET_POINT_LOCALIZE_KEY, v19, 0LL);
  ...
  if ( !*p_fortificationInfo )
    goto LABEL_43;
  v22 = itemIcon;
  v23 = (Il2CppObject *)System_Int32__ToString_63845976(
  ...
  v32 = System_String__Format_63054740((System_String_o *)StringLiteral_2989/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v27, v31, 0LL);
  ...
  if ( GiftEntity )
  {
    ...
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__SetGift_39340176((ItemIconComponent_o *)itemIcon, v36[5], v36[6], v36[7], 0, 0LL);
    itemIcon = (System_String_o *)this->fields.itemIcon;
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__setFrameSprite(
      ...
      v36[5] == 1,
      (System_String_o *)StringLiteral_20637/*"img_common_frame01"*/,
      0LL);
  }
  itemIcon = (System_String_o *)*p_fortificationInfo;
  if ( !*p_fortificationInfo )
