void FortificationGauge___ctor(FortificationGauge_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B291 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_2843/*"BATTLE_RESULT_FORTIFICATION_GET_POINT"*/);
    byte_4C3B291 = 1;
  }
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.GET_POINT_LOCALIZE_KEY, v5, v2, v3);
...
void FortificationGauge__SetData(FortificationGauge_o *this, BattleFortificationInfo_o *info, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B290 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_2842/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/);
    byte_4C3B290 = 1;
  }
  ...
  *(_QWORD *)&v41.fields.b = 0;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.fortificationInfo, (int32_t)info, (int32_t)method, v3);
  ...
  v11 = System_String__Concat_63518544(GET_POINT_LOCALIZE_KEY, v10, 0);
  ...
  v14 = (Il2CppObject *)System_Int32__ToString_65028652(
  ...
  v29 = System_String__Format_63559836((System_String_o *)StringLiteral_2842/*"BATTLE_RESULT_FORTIFICATION_GAUGE_BG_COLOR_{0}_{1}"*/, v21, v28, 0);
  ...
  if ( GiftEntity )
  {
    ...
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__SetGift_40822420((ItemIconComponent_o *)itemIcon, v33[5], v33[6], v33[7], 0, 0);
    itemIcon = (__int64)this->fields.itemIcon;
    if ( !itemIcon )
      goto LABEL_43;
    ItemIconComponent__setFrameSprite(
      ...
      v33[5] == 1,
      (System_String_o *)StringLiteral_20361/*"img_common_frame01"*/,
      0);
  }
  itemIcon = (__int64)*p_fortificationInfo;
  if ( !*p_fortificationInfo )
