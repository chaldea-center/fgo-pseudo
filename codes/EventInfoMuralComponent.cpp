void __fastcall EventInfoMuralComponent___ctor(EventInfoMuralComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2117E & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17581/*"btn_wallpainting"*/, method);
    byte_4A2117E = 1;
  }
  v5 = StringLiteral_17581/*"btn_wallpainting"*/;
  this->fields.buttonSpriteName = (struct System_String_o *)StringLiteral_17581/*"btn_wallpainting"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.buttonSpriteName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2117B & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMaster_EventMuralMaster___, *(_QWORD *)&eventId);
  ...
  *(_QWORD *)total = 0LL;
  ...
  if ( !UnityEngine_Object__op_Equality(v11, 0LL, 0LL) )
  {
    ...
    Master_object = (EventMuralMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_EventMuralMaster___);
    if ( !Master_object )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2117D & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventInfoMuralComponent___c__DisplayClass14_0__LoadEventMuralUpdate_b__0__, v9);
    sub_1B715CC(&Method_EventInfoMuralComponent___c__DisplayClass14_0__LoadEventMuralUpdate_b__1__, v10);
    sub_1B715CC(&EventInfoMuralComponent___c__DisplayClass14_0_TypeInfo, v11);
    byte_4A2117D = 1;
  }
  v12 = sub_1B71818(EventInfoMuralComponent___c__DisplayClass14_0_TypeInfo);
  ...
  *(_QWORD *)(v12 + 24) = this;
  ...
  if ( !UnityEngine_Object__op_Equality(mTerminalList, 0LL, 0LL) )
  {
    ...
    System_Action___ctor(
      ...
      0LL);
    *(_QWORD *)(v12 + 32) = v21;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v12 + 32), (int32_t)v21, v22, v23);
...
void __fastcall EventInfoMuralComponent__OnClickButton(EventInfoMuralComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2117C & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventInfoMuralComponent_OnClickButton__, v3);
    sub_1B715CC(&TerminalSceneComponent_TypeInfo, v4);
    sub_1B715CC(&Method_EventInfoMuralComponent___c__OnClickButton_b__13_0__, v5);
    sub_1B715CC(&EventInfoMuralComponent___c_TypeInfo, v6);
    byte_4A2117C = 1;
  }
  if ( this->fields.isEnableClick )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoMuralComponent_OnClickButton__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B715E4(Method_EventInfoMuralComponent_OnClickButton__);
    ...
    if ( !_9__13_0 )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__13_0, (int32_t)_9__13_0, v17, v18);
    }
...
void __fastcall EventInfoMuralComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2117F & 1) == 0 )
  {
    sub_1B715CC(&EventInfoMuralComponent___c_TypeInfo, v1);
    byte_4A2117F = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(EventInfoMuralComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21181 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventInfoMuralComponent___c__DisplayClass14_0__LoadEventMuralUpdate_b__2__, v5);
    byte_4A21181 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21182 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_EventInfoMuralComponent___c__DisplayClass14_0__LoadEventMuralUpdate_b__3__, v4);
    byte_4A21182 = 1;
  }
  if ( !TerminalSceneComponent_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TerminalSceneComponent_TypeInfo);
  ...
  if ( !_9__3 )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.__9__3, (int32_t)_9__3, v11, v12);
  }
  if ( !mTerminalList )
LABEL_15:
