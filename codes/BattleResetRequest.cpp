...
void __fastcall BattleResetRequest__beginRequest(BattleResetRequest_o *this, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_42E9624 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_21903/*"questId"*/, questId, (_DWORD)method, v3);
    byte_42E9624 = 1;
  }
...
System_String_o *__fastcall BattleResetRequest__getURL(BattleResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E9623 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_16833/*"battle/reset"*/, v4, v5, v6);
    byte_42E9623 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_16833/*"battle/reset"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(113, responseList, 0LL);
