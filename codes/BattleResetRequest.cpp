...
void __fastcall BattleResetRequest__beginRequest(BattleResetRequest_o *this, int32_t questId, const MethodInfo *method)
{
  if ( (byte_40FA8CD & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_21520/*"questId"*/, *(_QWORD *)&questId);
    byte_40FA8CD = 1;
  }
...
System_String_o *__fastcall BattleResetRequest__getURL(BattleResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FA8CC & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_16568/*"battle/reset"*/, v2);
    byte_40FA8CC = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_16568/*"battle/reset"*/, 0LL);
}
