...
void __fastcall BattleResetRequest__beginRequest(BattleResetRequest_o *this, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4C23835 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_23160/*"start2"*/, *(_QWORD *)&questId);
    byte_4C23835 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23160/*"start2"*/, questId, v3);
...
System_String_o *__fastcall BattleResetRequest__getURL(BattleResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23834 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_17423/*"card_bg_{0}"*/, v2);
    byte_4C23834 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63368612(BaseUrl, (System_String_o *)StringLiteral_17423/*"card_bg_{0}"*/, 0LL);
}
