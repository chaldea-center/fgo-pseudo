...
void __fastcall BattleResetRequest__beginRequest(BattleResetRequest_o *this, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4A7163D & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_22723/*"questId"*/, *(_QWORD *)&questId);
    byte_4A7163D = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22723/*"questId"*/, questId, v3);
...
System_String_o *__fastcall BattleResetRequest__getURL(BattleResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7163C & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_17118/*"battle/reset"*/, v2);
    byte_4A7163C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61787092(BaseUrl, (System_String_o *)StringLiteral_17118/*"battle/reset"*/, 0LL);
}
