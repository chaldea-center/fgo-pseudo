...
void __fastcall BattleResetRequest__beginRequest(BattleResetRequest_o *this, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4B179E7 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_22933/*"questId"*/, *(_QWORD *)&questId, method);
    byte_4B179E7 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22933/*"questId"*/, questId, v3);
...
System_String_o *__fastcall BattleResetRequest__getURL(BattleResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B179E6 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_17265/*"battle/reset"*/, v3, v4);
    byte_4B179E6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_17265/*"battle/reset"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(113, responseList, 0LL);
