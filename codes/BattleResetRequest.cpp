...
void __fastcall BattleResetRequest__beginRequest(BattleResetRequest_o *this, int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_4B68402 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_23011/*"questId"*/, *(_QWORD *)&questId);
    byte_4B68402 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23011/*"questId"*/, questId, v3);
...
System_String_o *__fastcall BattleResetRequest__getURL(BattleResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B68401 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_17308/*"battle/reset"*/, v2);
    byte_4B68401 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_17308/*"battle/reset"*/, 0LL);
}
