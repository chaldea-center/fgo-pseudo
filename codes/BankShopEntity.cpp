...
bool BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_21FFECC(0, v7);
...
System_String_o *BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5938275 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_900/*", name:"*/);
    sub_21FFC50(&StringLiteral_895/*", googleShopId:"*/);
    sub_21FFC50(&StringLiteral_901/*", numDetail:"*/);
    sub_21FFC50(&StringLiteral_893/*", closeAt:"*/);
    sub_21FFC50(&StringLiteral_21196/*"id:"*/);
    sub_21FFC50(&StringLiteral_890/*", appleShopId:"*/);
    sub_21FFC50(&StringLiteral_905/*", stoneNum:"*/);
    sub_21FFC50(&StringLiteral_894/*", googlePrice:"*/);
    sub_21FFC50(&StringLiteral_902/*", openAt:"*/);
    sub_21FFC50(&StringLiteral_903/*", priceDetail:"*/);
    sub_21FFC50(&StringLiteral_889/*", applePrice:"*/);
    sub_21FFC50(&StringLiteral_891/*", auShopId:"*/);
    byte_5938275 = 1;
  }
  v169 = 0;
  v3 = (System_String_o *)sub_21FFD10(string___TypeInfo, 24);
  if ( !v3 )
    sub_21FFECC(0, v4);
  v11 = v3;
  if ( !LODWORD(v3[1].klass) )
    goto LABEL_29;
  v12 = StringLiteral_21196/*"id:"*/;
  v3[1].monitor = (void *)StringLiteral_21196/*"id:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v3[1].monitor, v12, v5, v6, v7, v8, v9, v10);
  v3 = System_Int32__ToString((int)this + 16, 0);
  if ( ((__int64)v11[1].klass & 0xFFFFFFFE) == 0 )
    goto LABEL_29;
  v11[1].fields = (System_String_Fields)v3;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[1].fields, (int32_t)v3, v13, v14, v15, v16, v17, v18);
  if ( LODWORD(v11[1].klass) <= 2 )
    goto LABEL_29;
  v25 = StringLiteral_900/*", name:"*/;
  v11[2].klass = (System_String_c *)StringLiteral_900/*", name:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[2], v25, v19, v20, v21, v22, v23, v24);
  if ( ((__int64)v11[1].klass & 0xFFFFFFFC) == 0 )
    goto LABEL_29;
  name = this->fields.name;
  v11[2].monitor = name;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[2].monitor, (int32_t)name, v26, v27, v28, v29, v30, v31);
  if ( LODWORD(v11[1].klass) <= 4 )
    goto LABEL_29;
  v39 = StringLiteral_890/*", appleShopId:"*/;
  v11[2].fields = (System_String_Fields)StringLiteral_890/*", appleShopId:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[2].fields, v39, v33, v34, v35, v36, v37, v38);
  if ( LODWORD(v11[1].klass) <= 5 )
    goto LABEL_29;
  appleShopId = this->fields.appleShopId;
  v11[3].klass = (System_String_c *)appleShopId;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[3], (int32_t)appleShopId, v40, v41, v42, v43, v44, v45);
  if ( LODWORD(v11[1].klass) <= 6 )
    goto LABEL_29;
  v53 = StringLiteral_895/*", googleShopId:"*/;
  v11[3].monitor = (void *)StringLiteral_895/*", googleShopId:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[3].monitor, v53, v47, v48, v49, v50, v51, v52);
  if ( ((__int64)v11[1].klass & 0xFFFFFFF8) == 0 )
    goto LABEL_29;
  googleShopId = this->fields.googleShopId;
  v11[3].fields = (System_String_Fields)googleShopId;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[3].fields, (int32_t)googleShopId, v54, v55, v56, v57, v58, v59);
  if ( LODWORD(v11[1].klass) <= 8 )
    goto LABEL_29;
  v67 = StringLiteral_891/*", auShopId:"*/;
  v11[4].klass = (System_String_c *)StringLiteral_891/*", auShopId:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[4], v67, v61, v62, v63, v64, v65, v66);
  if ( LODWORD(v11[1].klass) <= 9 )
    goto LABEL_29;
  auShopId = this->fields.auShopId;
  v11[4].monitor = auShopId;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[4].monitor, (int32_t)auShopId, v68, v69, v70, v71, v72, v73);
  if ( LODWORD(v11[1].klass) <= 0xA )
    goto LABEL_29;
  v81 = StringLiteral_889/*", applePrice:"*/;
  v11[4].fields = (System_String_Fields)StringLiteral_889/*", applePrice:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[4].fields, v81, v75, v76, v77, v78, v79, v80);
  v3 = System_Int32__ToString((int)this + 52, 0);
  if ( LODWORD(v11[1].klass) <= 0xB )
    goto LABEL_29;
  v11[5].klass = (System_String_c *)v3;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[5], (int32_t)v3, v82, v83, v84, v85, v86, v87);
  if ( LODWORD(v11[1].klass) <= 0xC )
    goto LABEL_29;
  v94 = StringLiteral_894/*", googlePrice:"*/;
  v11[5].monitor = (void *)StringLiteral_894/*", googlePrice:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[5].monitor, v94, v88, v89, v90, v91, v92, v93);
  v3 = System_Int32__ToString((int)this + 56, 0);
  if ( LODWORD(v11[1].klass) <= 0xD )
    goto LABEL_29;
  v11[5].fields = (System_String_Fields)v3;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[5].fields, (int32_t)v3, v95, v96, v97, v98, v99, v100);
  if ( LODWORD(v11[1].klass) <= 0xE )
    goto LABEL_29;
  v107 = StringLiteral_905/*", stoneNum:"*/;
  v11[6].klass = (System_String_c *)StringLiteral_905/*", stoneNum:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[6], v107, v101, v102, v103, v104, v105, v106);
  ...
  if ( ((__int64)v11[1].klass & 0xFFFFFFF0) == 0 )
    goto LABEL_29;
  v11[6].monitor = v3;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[6].monitor, (int32_t)v3, v108, v109, v110, v111, v112, v113);
  if ( LODWORD(v11[1].klass) <= 0x10 )
    goto LABEL_29;
  v120 = StringLiteral_901/*", numDetail:"*/;
  v11[6].fields = (System_String_Fields)StringLiteral_901/*", numDetail:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[6].fields, v120, v114, v115, v116, v117, v118, v119);
  if ( LODWORD(v11[1].klass) <= 0x11 )
    goto LABEL_29;
  numDetail = this->fields.numDetail;
  v11[7].klass = (System_String_c *)numDetail;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[7], (int32_t)numDetail, v121, v122, v123, v124, v125, v126);
  if ( LODWORD(v11[1].klass) <= 0x12 )
    goto LABEL_29;
  v134 = StringLiteral_903/*", priceDetail:"*/;
  v11[7].monitor = (void *)StringLiteral_903/*", priceDetail:"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[7].monitor, v134, v128, v129, v130, v131, v132, v133);
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[8], v148, v142, v143, v144, v145, v146, v147);
  ...
  if ( LODWORD(v11[1].klass) <= 0x15
    ...
    || (v161 = StringLiteral_893/*", closeAt:"*/,
        ...
        sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[8].fields, v161, v155, v156, v157, v158, v159, v160),
...
LABEL_29:
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v11[9], (int32_t)v3, v162, v163, v164, v165, v166, v167);
  return System_String__Concat_75483816((System_String_array *)v11, 0);
}