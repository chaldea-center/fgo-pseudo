...
bool __fastcall BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A088C4 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMaster_PaymentLimitMaster___, method);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_1B68930(0LL, v8);
...
System_String_o *__fastcall BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A088C2 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_898/*", name:"*/, v3);
    sub_1B686D4(&StringLiteral_895/*", googleShopId:"*/, v4);
    sub_1B686D4(&StringLiteral_899/*", numDetail:"*/, v5);
    sub_1B686D4(&StringLiteral_893/*", closeAt:"*/, v6);
    sub_1B686D4(&StringLiteral_20134/*"id:"*/, v7);
    sub_1B686D4(&StringLiteral_890/*", appleShopId:"*/, v8);
    sub_1B686D4(&StringLiteral_903/*", stoneNum:"*/, v9);
    sub_1B686D4(&StringLiteral_894/*", googlePrice:"*/, v10);
    sub_1B686D4(&StringLiteral_900/*", openAt:"*/, v11);
    sub_1B686D4(&StringLiteral_901/*", priceDetail:"*/, v12);
    sub_1B686D4(&StringLiteral_889/*", applePrice:"*/, v13);
    sub_1B686D4(&StringLiteral_891/*", auShopId:"*/, v14);
    byte_4A088C2 = 1;
  }
  v85 = 0;
  v15 = (System_String_o *)sub_1B6877C(string___TypeInfo, 24LL);
  if ( !v15 )
    sub_1B68930(0LL, v16);
  v19 = v15;
  if ( !LODWORD(v15[1].klass) )
    goto LABEL_29;
  v20 = StringLiteral_20134/*"id:"*/;
  v15[1].monitor = (void *)StringLiteral_20134/*"id:"*/;
...
LABEL_29:
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v19[9], (int32_t)v15, v82, v83);
  return System_String__Concat_61432996((System_String_array *)v19, 0LL);
}