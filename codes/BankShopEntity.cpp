...
bool __fastcall BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C139 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_PaymentLimitMaster___, method);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_1BCB254(0LL, v8);
...
System_String_o *__fastcall BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C137 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_835/*", name:"*/, v3);
    sub_1BCAFF8(&StringLiteral_832/*", googleShopId:"*/, v4);
    sub_1BCAFF8(&StringLiteral_836/*", numDetail:"*/, v5);
    sub_1BCAFF8(&StringLiteral_830/*", closeAt:"*/, v6);
    sub_1BCAFF8(&StringLiteral_20077/*"id:"*/, v7);
    sub_1BCAFF8(&StringLiteral_827/*", appleShopId:"*/, v8);
    sub_1BCAFF8(&StringLiteral_840/*", stoneNum:"*/, v9);
    sub_1BCAFF8(&StringLiteral_831/*", googlePrice:"*/, v10);
    sub_1BCAFF8(&StringLiteral_837/*", openAt:"*/, v11);
    sub_1BCAFF8(&StringLiteral_838/*", priceDetail:"*/, v12);
    sub_1BCAFF8(&StringLiteral_826/*", applePrice:"*/, v13);
    sub_1BCAFF8(&StringLiteral_828/*", auShopId:"*/, v14);
    byte_4B1C137 = 1;
  }
  v62 = 0;
  v15 = (System_String_o *)sub_1BCB0A0(string___TypeInfo, 24LL);
  if ( !v15 )
    sub_1BCB254(0LL, v16);
  v19 = v15;
  if ( !LODWORD(v15[1].klass) )
    goto LABEL_29;
  v20 = StringLiteral_20077/*"id:"*/;
  v15[1].monitor = (void *)StringLiteral_20077/*"id:"*/;
...
LABEL_29:
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v19[9], (int32_t)v15, v17, v60);
  return System_String__Concat_62490940((System_String_array *)v19, 0LL);
}