...
bool __fastcall BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE790 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_PaymentLimitMaster___, method);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_1B64C5C(0LL, v8);
...
System_String_o *__fastcall BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE78E & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_899/*", name:"*/, v3);
    sub_1B64A00(&StringLiteral_896/*", googleShopId:"*/, v4);
    sub_1B64A00(&StringLiteral_900/*", numDetail:"*/, v5);
    sub_1B64A00(&StringLiteral_894/*", closeAt:"*/, v6);
    sub_1B64A00(&StringLiteral_20127/*"id:"*/, v7);
    sub_1B64A00(&StringLiteral_891/*", appleShopId:"*/, v8);
    sub_1B64A00(&StringLiteral_904/*", stoneNum:"*/, v9);
    sub_1B64A00(&StringLiteral_895/*", googlePrice:"*/, v10);
    sub_1B64A00(&StringLiteral_901/*", openAt:"*/, v11);
    sub_1B64A00(&StringLiteral_902/*", priceDetail:"*/, v12);
    sub_1B64A00(&StringLiteral_890/*", applePrice:"*/, v13);
    sub_1B64A00(&StringLiteral_892/*", auShopId:"*/, v14);
    byte_49FE78E = 1;
  }
  v85 = 0;
  v15 = (System_String_o *)sub_1B64AA8(string___TypeInfo, 24LL);
  if ( !v15 )
    sub_1B64C5C(0LL, v16);
  v19 = v15;
...
LABEL_29:
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v19[9], (int32_t)v15, v82, v83);
  return System_String__Concat_61398664((System_String_array *)v19, 0LL);
}