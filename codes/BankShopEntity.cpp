...
bool BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_1C71608(0, v6);
...
System_String_o *BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6FD5 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_837/*", name:"*/);
    sub_1C713B0(&StringLiteral_834/*", googleShopId:"*/);
    sub_1C713B0(&StringLiteral_838/*", numDetail:"*/);
    sub_1C713B0(&StringLiteral_832/*", closeAt:"*/);
    sub_1C713B0(&StringLiteral_20334/*"id:"*/);
    sub_1C713B0(&StringLiteral_829/*", appleShopId:"*/);
    sub_1C713B0(&StringLiteral_842/*", stoneNum:"*/);
    sub_1C713B0(&StringLiteral_833/*", googlePrice:"*/);
    sub_1C713B0(&StringLiteral_839/*", openAt:"*/);
    sub_1C713B0(&StringLiteral_840/*", priceDetail:"*/);
    sub_1C713B0(&StringLiteral_828/*", applePrice:"*/);
    sub_1C713B0(&StringLiteral_830/*", auShopId:"*/);
    byte_4CC6FD5 = 1;
  }
  v169 = 0;
  v3 = (System_String_o *)sub_1C71458(string___TypeInfo, 24);
  if ( !v3 )
    sub_1C71608(0, v4);
  v11 = v3;
  if ( !LODWORD(v3[1].klass) )
    goto LABEL_29;
  v12 = StringLiteral_20334/*"id:"*/;
  v3[1].monitor = (void *)StringLiteral_20334/*"id:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v3[1].monitor, v12, v5, v6, v7, v8, v9, v10);
  v3 = System_Int32__ToString((int)this + 16, 0);
  if ( LODWORD(v11[1].klass) <= 1 )
    goto LABEL_29;
  v11[1].fields = (System_String_Fields)v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[1].fields, (int32_t)v3, v13, v14, v15, v16, v17, v18);
  if ( LODWORD(v11[1].klass) <= 2 )
    goto LABEL_29;
  v25 = StringLiteral_837/*", name:"*/;
  v11[2].klass = (System_String_c *)StringLiteral_837/*", name:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[2], v25, v19, v20, v21, v22, v23, v24);
  if ( LODWORD(v11[1].klass) <= 3 )
    goto LABEL_29;
  name = this->fields.name;
  v11[2].monitor = name;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[2].monitor, (int32_t)name, v26, v27, v28, v29, v30, v31);
  if ( LODWORD(v11[1].klass) <= 4 )
    goto LABEL_29;
  v39 = StringLiteral_829/*", appleShopId:"*/;
  v11[2].fields = (System_String_Fields)StringLiteral_829/*", appleShopId:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[2].fields, v39, v33, v34, v35, v36, v37, v38);
  if ( LODWORD(v11[1].klass) <= 5 )
    goto LABEL_29;
  appleShopId = this->fields.appleShopId;
  v11[3].klass = (System_String_c *)appleShopId;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[3], (int32_t)appleShopId, v40, v41, v42, v43, v44, v45);
  if ( LODWORD(v11[1].klass) <= 6 )
    goto LABEL_29;
  v53 = StringLiteral_834/*", googleShopId:"*/;
  v11[3].monitor = (void *)StringLiteral_834/*", googleShopId:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[3].monitor, v53, v47, v48, v49, v50, v51, v52);
  if ( LODWORD(v11[1].klass) <= 7 )
    goto LABEL_29;
  googleShopId = this->fields.googleShopId;
  v11[3].fields = (System_String_Fields)googleShopId;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[3].fields, (int32_t)googleShopId, v54, v55, v56, v57, v58, v59);
  if ( LODWORD(v11[1].klass) <= 8 )
    goto LABEL_29;
  v67 = StringLiteral_830/*", auShopId:"*/;
  v11[4].klass = (System_String_c *)StringLiteral_830/*", auShopId:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[4], v67, v61, v62, v63, v64, v65, v66);
  if ( LODWORD(v11[1].klass) <= 9 )
    goto LABEL_29;
  auShopId = this->fields.auShopId;
  v11[4].monitor = auShopId;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[4].monitor, (int32_t)auShopId, v68, v69, v70, v71, v72, v73);
  if ( LODWORD(v11[1].klass) <= 0xA )
    goto LABEL_29;
  v81 = StringLiteral_828/*", applePrice:"*/;
  v11[4].fields = (System_String_Fields)StringLiteral_828/*", applePrice:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[4].fields, v81, v75, v76, v77, v78, v79, v80);
  v3 = System_Int32__ToString((int)this + 52, 0);
  if ( LODWORD(v11[1].klass) <= 0xB )
    goto LABEL_29;
  v11[5].klass = (System_String_c *)v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[5], (int32_t)v3, v82, v83, v84, v85, v86, v87);
  if ( LODWORD(v11[1].klass) <= 0xC )
    goto LABEL_29;
  v94 = StringLiteral_833/*", googlePrice:"*/;
  v11[5].monitor = (void *)StringLiteral_833/*", googlePrice:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[5].monitor, v94, v88, v89, v90, v91, v92, v93);
  v3 = System_Int32__ToString((int)this + 56, 0);
  if ( LODWORD(v11[1].klass) <= 0xD )
    goto LABEL_29;
  v11[5].fields = (System_String_Fields)v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[5].fields, (int32_t)v3, v95, v96, v97, v98, v99, v100);
  if ( LODWORD(v11[1].klass) <= 0xE )
    goto LABEL_29;
  v107 = StringLiteral_842/*", stoneNum:"*/;
  v11[6].klass = (System_String_c *)StringLiteral_842/*", stoneNum:"*/;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[6], v107, v101, v102, v103, v104, v105, v106);
...
LABEL_29:
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&v11[9], (int32_t)v3, v162, v163, v164, v165, v166, v167);
  return System_String__Concat_64072256((System_String_array *)v11, 0);
}