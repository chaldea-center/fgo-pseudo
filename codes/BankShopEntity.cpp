...
bool __fastcall BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAAA5 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_PaymentLimitMaster___, method);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_1B4D1EC(0LL, v8);
...
System_String_o *__fastcall BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BAAA3 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_846/*", name:"*/, v3);
    sub_1B4CF90(&StringLiteral_843/*", googleShopId:"*/, v4);
    sub_1B4CF90(&StringLiteral_847/*", numDetail:"*/, v5);
    sub_1B4CF90(&StringLiteral_841/*", closeAt:"*/, v6);
    sub_1B4CF90(&StringLiteral_19904/*"id:"*/, v7);
    sub_1B4CF90(&StringLiteral_838/*", appleShopId:"*/, v8);
    sub_1B4CF90(&StringLiteral_851/*", stoneNum:"*/, v9);
    sub_1B4CF90(&StringLiteral_842/*", googlePrice:"*/, v10);
    sub_1B4CF90(&StringLiteral_848/*", openAt:"*/, v11);
    sub_1B4CF90(&StringLiteral_849/*", priceDetail:"*/, v12);
    sub_1B4CF90(&StringLiteral_837/*", applePrice:"*/, v13);
    sub_1B4CF90(&StringLiteral_839/*", auShopId:"*/, v14);
    byte_49BAAA3 = 1;
  }
  v85 = 0;
  v15 = (System_String_o *)sub_1B4D038(string___TypeInfo, 24LL);
  if ( !v15 )
    sub_1B4D1EC(0LL, v16);
  v19 = v15;
  if ( !LODWORD(v15[1].klass) )
    goto LABEL_29;
  v20 = StringLiteral_19904/*"id:"*/;
  v15[1].monitor = (void *)StringLiteral_19904/*"id:"*/;
  ...
  if ( LODWORD(v19[1].klass) <= 2 )
    goto LABEL_29;
  v25 = StringLiteral_846/*", name:"*/;
  v19[2].klass = (System_String_c *)StringLiteral_846/*", name:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[2], v25, v23, v24);
  if ( LODWORD(v19[1].klass) <= 3 )
    goto LABEL_29;
  name = this->fields.name;
  v19[2].monitor = name;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[2].monitor, (int32_t)name, v26, v27);
  if ( LODWORD(v19[1].klass) <= 4 )
    goto LABEL_29;
  v31 = StringLiteral_838/*", appleShopId:"*/;
  v19[2].fields = (System_String_Fields)StringLiteral_838/*", appleShopId:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[2].fields, v31, v29, v30);
  if ( LODWORD(v19[1].klass) <= 5 )
    goto LABEL_29;
  appleShopId = this->fields.appleShopId;
  v19[3].klass = (System_String_c *)appleShopId;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[3], (int32_t)appleShopId, v32, v33);
  if ( LODWORD(v19[1].klass) <= 6 )
    goto LABEL_29;
  v37 = StringLiteral_843/*", googleShopId:"*/;
  v19[3].monitor = (void *)StringLiteral_843/*", googleShopId:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[3].monitor, v37, v35, v36);
  if ( LODWORD(v19[1].klass) <= 7 )
    goto LABEL_29;
  googleShopId = this->fields.googleShopId;
  v19[3].fields = (System_String_Fields)googleShopId;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[3].fields, (int32_t)googleShopId, v38, v39);
  if ( LODWORD(v19[1].klass) <= 8 )
    goto LABEL_29;
  v43 = StringLiteral_839/*", auShopId:"*/;
  v19[4].klass = (System_String_c *)StringLiteral_839/*", auShopId:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[4], v43, v41, v42);
  if ( LODWORD(v19[1].klass) <= 9 )
    goto LABEL_29;
  auShopId = this->fields.auShopId;
  v19[4].monitor = auShopId;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[4].monitor, (int32_t)auShopId, v44, v45);
  if ( LODWORD(v19[1].klass) <= 0xA )
    goto LABEL_29;
  v49 = StringLiteral_837/*", applePrice:"*/;
  v19[4].fields = (System_String_Fields)StringLiteral_837/*", applePrice:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[4].fields, v49, v47, v48);
  v15 = System_Int32__ToString((int)this + 52, 0LL);
  if ( LODWORD(v19[1].klass) <= 0xB )
    goto LABEL_29;
  v19[5].klass = (System_String_c *)v15;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[5], (int32_t)v15, v50, v51);
  if ( LODWORD(v19[1].klass) <= 0xC )
    goto LABEL_29;
  v54 = StringLiteral_842/*", googlePrice:"*/;
  v19[5].monitor = (void *)StringLiteral_842/*", googlePrice:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[5].monitor, v54, v52, v53);
  v15 = System_Int32__ToString((int)this + 56, 0LL);
  if ( LODWORD(v19[1].klass) <= 0xD )
    goto LABEL_29;
  v19[5].fields = (System_String_Fields)v15;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[5].fields, (int32_t)v15, v55, v56);
  if ( LODWORD(v19[1].klass) <= 0xE )
    goto LABEL_29;
  v59 = StringLiteral_851/*", stoneNum:"*/;
  v19[6].klass = (System_String_c *)StringLiteral_851/*", stoneNum:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[6], v59, v57, v58);
  ...
  if ( LODWORD(v19[1].klass) <= 0xF )
    goto LABEL_29;
  v19[6].monitor = v15;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[6].monitor, (int32_t)v15, v60, v61);
  if ( LODWORD(v19[1].klass) <= 0x10 )
    goto LABEL_29;
  v64 = StringLiteral_847/*", numDetail:"*/;
  v19[6].fields = (System_String_Fields)StringLiteral_847/*", numDetail:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[6].fields, v64, v62, v63);
  if ( LODWORD(v19[1].klass) <= 0x11 )
    goto LABEL_29;
  numDetail = this->fields.numDetail;
  v19[7].klass = (System_String_c *)numDetail;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[7], (int32_t)numDetail, v65, v66);
  if ( LODWORD(v19[1].klass) <= 0x12 )
    goto LABEL_29;
  v70 = StringLiteral_849/*", priceDetail:"*/;
  v19[7].monitor = (void *)StringLiteral_849/*", priceDetail:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[7].monitor, v70, v68, v69);
  if ( LODWORD(v19[1].klass) <= 0x13 )
    goto LABEL_29;
  priceDetail = this->fields.priceDetail;
  v19[7].fields = (System_String_Fields)priceDetail;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[7].fields, (int32_t)priceDetail, v71, v72);
  if ( LODWORD(v19[1].klass) <= 0x14 )
    goto LABEL_29;
  v76 = StringLiteral_848/*", openAt:"*/;
  v19[8].klass = (System_String_c *)StringLiteral_848/*", openAt:"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[8], v76, v74, v75);
  v15 = System_Int64__ToString((int64_t)&this->fields.openedAt, 0LL);
  if ( LODWORD(v19[1].klass) <= 0x15
    || (v19[8].monitor = v15,
        sub_1B4CF34((CGThumbnailListItem_o *)&v19[8].monitor, (int32_t)v15, v77, v78),
        LODWORD(v19[1].klass) <= 0x16)
    || (v81 = StringLiteral_841/*", closeAt:"*/,
        v19[8].fields = (System_String_Fields)StringLiteral_841/*", closeAt:"*/,
        sub_1B4CF34((CGThumbnailListItem_o *)&v19[8].fields, v81, v79, v80),
...
LABEL_29:
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&v19[9], (int32_t)v15, v82, v83);
  return System_String__Concat_61133984((System_String_array *)v19, 0LL);
}