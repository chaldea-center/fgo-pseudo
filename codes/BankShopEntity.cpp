...
bool __fastcall BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76E4 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_PaymentLimitMaster___, method);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_1C1AE30(0LL, v8);
...
System_String_o *__fastcall BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC76E2 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_897/*", name:"*/, v3);
    sub_1C1ABD4(&StringLiteral_894/*", googleShopId:"*/, v4);
    sub_1C1ABD4(&StringLiteral_898/*", numDetail:"*/, v5);
    sub_1C1ABD4(&StringLiteral_892/*", closeAt:"*/, v6);
    sub_1C1ABD4(&StringLiteral_20544/*"id:"*/, v7);
    sub_1C1ABD4(&StringLiteral_889/*", appleShopId:"*/, v8);
    sub_1C1ABD4(&StringLiteral_902/*", stoneNum:"*/, v9);
    sub_1C1ABD4(&StringLiteral_893/*", googlePrice:"*/, v10);
    sub_1C1ABD4(&StringLiteral_899/*", openAt:"*/, v11);
    sub_1C1ABD4(&StringLiteral_900/*", priceDetail:"*/, v12);
    sub_1C1ABD4(&StringLiteral_888/*", applePrice:"*/, v13);
    sub_1C1ABD4(&StringLiteral_890/*", auShopId:"*/, v14);
    byte_4BC76E2 = 1;
  }
  v181 = 0;
  v15 = (System_String_o *)sub_1C1AC7C(string___TypeInfo, 24LL);
  if ( !v15 )
    sub_1C1AE30(0LL, v16);
  v23 = v15;
  if ( !LODWORD(v15[1].klass) )
    goto LABEL_29;
  v24 = StringLiteral_20544/*"id:"*/;
  v15[1].monitor = (void *)StringLiteral_20544/*"id:"*/;
...
LABEL_29:
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v23[9], (int64_t)v15, v174, v175, v176, v177, v178, v179);
  return System_String__Concat_63053896((System_String_array *)v23, 0LL);
}