...
bool __fastcall BankShopEntity__IsOpen(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC078 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMaster_PaymentLimitMaster___, method);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_PaymentLimitMaster___);
  if ( !Master_object )
    sub_1B64324(0LL);
...
System_String_o *__fastcall BankShopEntity__ToString(BankShopEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC076 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_899/*", name:"*/, v3);
    sub_1B640C8(&StringLiteral_896/*", googleShopId:"*/, v4);
    sub_1B640C8(&StringLiteral_900/*", numDetail:"*/, v5);
    sub_1B640C8(&StringLiteral_894/*", closeAt:"*/, v6);
    sub_1B640C8(&StringLiteral_20124/*"id:"*/, v7);
    sub_1B640C8(&StringLiteral_891/*", appleShopId:"*/, v8);
    sub_1B640C8(&StringLiteral_904/*", stoneNum:"*/, v9);
    sub_1B640C8(&StringLiteral_895/*", googlePrice:"*/, v10);
    sub_1B640C8(&StringLiteral_901/*", openAt:"*/, v11);
    sub_1B640C8(&StringLiteral_902/*", priceDetail:"*/, v12);
    sub_1B640C8(&StringLiteral_890/*", applePrice:"*/, v13);
    sub_1B640C8(&StringLiteral_892/*", auShopId:"*/, v14);
    byte_49FC076 = 1;
  }
  v85 = 0;
  v15 = (System_String_o *)sub_1B64170(string___TypeInfo, 24LL);
  if ( !v15 )
    sub_1B64324(0LL);
  v19 = v15;
  if ( !LODWORD(v15[1].klass) )
    goto LABEL_29;
  v20 = StringLiteral_20124/*"id:"*/;
  v15[1].monitor = (void *)StringLiteral_20124/*"id:"*/;
...
LABEL_29:
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v19[9], (int32_t)v15, v82, v83);
