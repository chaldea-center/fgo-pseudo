        ...
        const MethodInfo *method)
{
  ...
  if ( v5->fields.isInvalidRarity )
  {
    ...
    servantFaceIcon = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_12005/*"SELECT_BONUS_SKILL_INVALID"*/, 0);
...
LABEL_42:
  ...
  servantFaceIcon = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_5680/*"EQUIP_GRAPH_USE"*/, 0);
  if ( !warningLabel )
    goto LABEL_86;
  ...
  else
  {
    ...
    *(_QWORD *)(v51 + 32) = item;
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v51 + 32), (int32_t)item, v42, v43, v44, v45, v46, v47);
  }
LABEL_46:
  servantFaceIcon = (__int64)this->fields.messageLabelList;
  if ( !servantFaceIcon )
    ...
    if ( v36 == 1 && v5->fields.isInvalidRarity )
    {
      ...
      if ( (*(_DWORD *)(v37 + 24) & 0xFFFFFFFE) != 0 )
      {
        ...
        *(_DWORD *)(servantFaceIcon + 24) = 2;
        sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v37 + 40), (int32_t)item, v30, v31, v32, v33, v34, v35);
      }
      else
      {
        System_Collections_Generic_List_object___AddWithResize(
