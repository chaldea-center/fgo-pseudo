        ...
        const MethodInfo *method)
{
  ...
  v4 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_UIWidget__TypeInfo);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.messageLabelList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B332E8 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_List_UIWidget__Add__, item);
    ...
    sub_1BD3458(&Method_System_Collections_Generic_List_UIWidget__get_Count__, v9);
    sub_1BD3458(&LocalizationManager_TypeInfo, v10);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v11);
    sub_1BD3458(&StringLiteral_11652/*"SELECT_BONUS_SKILL_INVALID"*/, v12);
    sub_1BD3458(&StringLiteral_1/*""*/, v13);
    sub_1BD3458(&StringLiteral_5604/*"EQUIP_GRAPH_USE"*/, v14);
    byte_4B332E8 = 1;
  }
  if ( !v5 || !mode )
    return;
  ...
  if ( v5->fields.isInvalidRarity )
  {
    ...
    servantFaceIcon = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11652/*"SELECT_BONUS_SKILL_INVALID"*/, 0LL);
    ...
    else
    {
      ...
      *(_QWORD *)(v33 + 32) = item;
      sub_1BD33FC((PartyOrganizationUtility_o *)(v33 + 32), (int64_t)item, v24, v25, v26, v27, v28, v29);
    }
  }
  else
  {
...
LABEL_43:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  servantFaceIcon = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_5604/*"EQUIP_GRAPH_USE"*/, 0LL);
  if ( !warningLabel )
    goto LABEL_85;
  ...
  else
  {
    ...
    *(_QWORD *)(v54 + 32) = item;
    sub_1BD33FC((PartyOrganizationUtility_o *)(v54 + 32), (int64_t)item, v45, v46, v47, v48, v49, v50);
  }
LABEL_45:
  servantFaceIcon = (__int64)this->fields.messageLabelList;
  if ( !servantFaceIcon )
  ...
  if ( v40 >= 1 )
  {
    if ( v40 == 1 && v5->fields.isInvalidRarity )
    {
      ...
      else
      {
        ...
        *(_QWORD *)(v41 + 40) = item;
        sub_1BD33FC((PartyOrganizationUtility_o *)(v41 + 40), (int64_t)item, v34, v35, v36, v37, v38, v39);
      }
    }
    servantFaceIcon = (__int64)this->fields.messageLabelList;
    if ( servantFaceIcon )
