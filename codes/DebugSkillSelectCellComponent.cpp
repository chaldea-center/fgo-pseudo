        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.detail, (int32_t)detail, v15, v16, v17, v18, v19, v20);
  this->fields.callback = callback;
  p_callback = &this->fields.callback;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)p_callback, (int32_t)callback, v22, v23, v24, v25, v26, v27);
  v28 = (UILabel_o *)*(p_callback - 4);
  v29 = System_Int32__ToString(v13, 0);
  v30 = System_String__Concat_64463988(v29, (System_String_o *)StringLiteral_1451/*":"*/, *p_name, 0);
  if ( !v28 )
    sub_1C93D2C(v30, v31);
