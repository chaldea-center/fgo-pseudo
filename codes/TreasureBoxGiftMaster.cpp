void __fastcall TreasureBoxGiftMaster___ctor(TreasureBoxGiftMaster_o *this, const MethodInfo *method)
{
  if ( (byte_41899A3 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_TreasureBoxGiftMaster__TreasureBoxGiftEntity__string___ctor__, method);
    byte_41899A3 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    375,
    (const MethodInfo_24E4484 *)Method_DataMasterBase_TreasureBoxGiftMaster__TreasureBoxGiftEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41899A4 & 1) == 0 )
  {
    ...
    sub_B2C35C(&TreasureBoxGiftEntity_TypeInfo, v10);
    byte_41899A4 = 1;
  }
  ...
  if ( (int)list >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
        v16 = *(&TreasureBoxGiftEntity_TypeInfo->_2.bitflags2 + 1);
        if ( *(unsigned __int8 *)(*(_QWORD *)list + 300LL) >= (unsigned int)v16
          && *(TreasureBoxGiftEntity_c **)(*(_QWORD *)(*(_QWORD *)list + 200LL) + 8 * v16 - 8) == TreasureBoxGiftEntity_TypeInfo
          && *((_DWORD *)list + 4) == id )
        {
          if ( !v11 )
            break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41899A1 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_TreasureBoxGiftMaster__TreasureBoxGiftEntity__string__GetEntity__, *(_QWORD *)&id);
    byte_41899A1 = 1;
  }
  ...
  return (TreasureBoxGiftEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                      ...
                                      PK,
                                      (const MethodInfo_24E4520 *)Method_DataMasterBase_TreasureBoxGiftMaster__TreasureBoxGiftEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_41899A2 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_TreasureBoxGiftMaster__TreasureBoxGiftEntity__string__TryGetEntity__, entity);
    byte_41899A2 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_24E4578 *)Method_DataMasterBase_TreasureBoxGiftMaster__TreasureBoxGiftEntity__string__TryGetEntity__);
}