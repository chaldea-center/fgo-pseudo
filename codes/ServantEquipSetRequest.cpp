        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A598 & 1) == 0 )
  {
    sub_1B686D4(&JsonManager_TypeInfo, svtEquip);
    sub_1B686D4(&StringLiteral_18979/*"equipInfo"*/, v5);
    sub_1B686D4(&StringLiteral_15746/*"["*/, v6);
    sub_1B686D4(&StringLiteral_16002/*"]"*/, v7);
    byte_4A0A598 = 1;
  }
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  v8 = JsonManager__toJson((Il2CppObject *)svtEquip, 0, 0, 0LL);
  v9 = System_String__Concat_61430728(
         (System_String_o *)StringLiteral_15746/*"["*/,
         v8,
         (System_String_o *)StringLiteral_16002/*"]"*/,
         0LL);
  RequestBase__addField_40920848((RequestBase_o *)this, (System_String_o *)StringLiteral_18979/*"equipInfo"*/, v9, v10);
  RequestBase__beginRequest((RequestBase_o *)this, v11);
}


void __fastcall ServantEquipSetRequest__beginRequest_40957540(
        ServantEquipSetRequest_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A599 & 1) == 0 )
  {
    sub_1B686D4(&JsonManager_TypeInfo, svtEquipList);
    sub_1B686D4(&StringLiteral_18979/*"equipInfo"*/, v5);
    byte_4A0A599 = 1;
  }
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
  ...
  RequestBase__addField_40920848((RequestBase_o *)this, (System_String_o *)StringLiteral_18979/*"equipInfo"*/, v6, v7);
...
System_String_o *__fastcall ServantEquipSetRequest__getURL(ServantEquipSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A597 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_23625/*"svtEquip/set"*/, v2);
    byte_4A0A597 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_23625/*"svtEquip/set"*/, 0LL);
}
