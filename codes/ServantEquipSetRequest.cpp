        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB76AA & 1) == 0 )
  {
    sub_1BAB41C(&JsonManager_TypeInfo, svtEquip);
    sub_1BAB41C(&StringLiteral_19077/*"equipInfo"*/, v5);
    sub_1BAB41C(&StringLiteral_15842/*"["*/, v6);
    sub_1BAB41C(&StringLiteral_16099/*"]"*/, v7);
    byte_4AB76AA = 1;
  }
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  v8 = JsonManager__toJson((Il2CppObject *)svtEquip, 0, 0, 0LL);
  v9 = System_String__Concat_62059388(
         (System_String_o *)StringLiteral_15842/*"["*/,
         v8,
         (System_String_o *)StringLiteral_16099/*"]"*/,
         0LL);
  RequestBase__addField_41516464((RequestBase_o *)this, (System_String_o *)StringLiteral_19077/*"equipInfo"*/, v9, 0LL);
  RequestBase__beginRequest((RequestBase_o *)this, 0LL);
}


void __fastcall ServantEquipSetRequest__beginRequest_41611240(
        ServantEquipSetRequest_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB76AB & 1) == 0 )
  {
    sub_1BAB41C(&JsonManager_TypeInfo, svtEquipList);
    sub_1BAB41C(&StringLiteral_19077/*"equipInfo"*/, v5);
    byte_4AB76AB = 1;
  }
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
  ...
  RequestBase__addField_41516464((RequestBase_o *)this, (System_String_o *)StringLiteral_19077/*"equipInfo"*/, v6, 0LL);
  RequestBase__beginRequest((RequestBase_o *)this, 0LL);
}
...
System_String_o *__fastcall ServantEquipSetRequest__getURL(ServantEquipSetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB76A9 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_23745/*"svtEquip/set"*/, v2);
    byte_4AB76A9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_23745/*"svtEquip/set"*/, 0LL);
}
