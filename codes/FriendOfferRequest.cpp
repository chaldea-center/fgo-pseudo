...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_435551D & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_19190/*"friend/offer"*/);
    byte_435551D = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_19190/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_435551F & 1) == 0 )
  {
    ...
    sub_B70694(&Method_FriendOfferRequest_requestErrorDialog__);
