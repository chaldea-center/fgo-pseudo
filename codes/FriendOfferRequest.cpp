...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3F32 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_19369/*"friend/offer"*/, v2);
    byte_48E3F32 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_19369/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3F34 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_FriendOfferRequest_requestErrorDialog__, v7);
