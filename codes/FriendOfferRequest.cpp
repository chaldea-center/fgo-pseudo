...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03AF7 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_19488/*"friend/offer"*/, v2);
    byte_4B03AF7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_19488/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03AF9 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_FriendOfferRequest_requestErrorDialog__, v7);
