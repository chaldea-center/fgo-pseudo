...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EBE01 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_19135/*"friend/offer"*/, v4, v5, v6);
    byte_42EBE01 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_19135/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EBE03 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_FriendOfferRequest_requestErrorDialog__, v12, v13, v14);
  ...
  v45 = ResponseCommandKind__SearchData(13, responseList, 0LL);
  if ( !v45 )
    goto LABEL_13;
  v46 = v45;
