...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438EAB5 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_19278/*"friend/offer"*/);
    byte_438EAB5 = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_19278/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438EAB7 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_FriendOfferRequest_requestErrorDialog__);
