...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5CA38 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19638/*"friend/offer"*/);
    byte_4A5CA38 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_19638/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5CA3A & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_FriendOfferRequest_requestErrorDialog__);
