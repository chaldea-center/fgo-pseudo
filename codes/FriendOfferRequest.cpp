...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17AF9 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_19840/*"friend/offer"*/, v3, v4);
    byte_4B17AF9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_19840/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17AFB & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_FriendOfferRequest_requestErrorDialog__, v9, v10);
  ...
  v31 = ResponseCommandKind__SearchData(13, responseList, 0LL);
  if ( !v31
