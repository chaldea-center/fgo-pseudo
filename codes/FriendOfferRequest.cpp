...
System_String_o *__fastcall FriendOfferRequest__getURL(FriendOfferRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21391 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_19587/*"friend/offer"*/, v2);
    byte_4A21391 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_19587/*"friend/offer"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21393 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_FriendOfferRequest_requestErrorDialog__, v7);
