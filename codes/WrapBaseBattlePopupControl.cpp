        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields, (int64_t)parent, v7, v8, v9, v10, v11, v12);
  ...
  *((_DWORD *)p_perf - 2) = layer;
  sub_1C21DDC((PartyOrganizationUtility_o *)p_perf, (int64_t)inPerf, v17, v18, v19, v20, v21, v22);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)obj, 0LL, 0LL) )
  {
    ...
    UnityEngine_Transform__SetParent_70891020(transform, this->fields._TrParent_k__BackingField, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEEBA & 1) == 0 )
  {
    sub_1C21E38(&Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    byte_4BDEEBA = 1;
  }
  component = 0LL;
  ...
  if ( !System_String__IsNullOrEmpty(text, 0LL) )
  {
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v10 = (Il2CppObject *)UnityEngine_Object__op_Inequality(PopupObject, 0LL, 0LL);
    if ( ((unsigned __int8)v10 & 1) != 0 )
    {
      ...
      if ( UnityEngine_GameObject__TryGetComponent_object_(
             ...
             &component,
             (const MethodInfo_30017C4 *)Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___) )
      {
        v10 = component;
        if ( component )
        {
