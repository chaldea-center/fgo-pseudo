        ...
        const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields, (int64_t)parent, v7, v8, v9, v10, v11, v12);
  ...
  *((_DWORD *)p_perf - 2) = layer;
  sub_1BD33FC((PartyOrganizationUtility_o *)p_perf, (int64_t)inPerf, v17, v18, v19, v20, v21, v22);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)obj, 0LL, 0LL) )
  {
    ...
    UnityEngine_Transform__SetParent_70299520(transform, this->fields._TrParent_k__BackingField, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39A75 & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_Object_TypeInfo, prefab);
    byte_4B39A75 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39A76 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___, prefab);
  ...
  if ( !System_String__IsNullOrEmpty(text, 0LL) )
  {
    ...
    if ( ((unsigned __int8)v11 & 1) != 0 )
    {
      ...
      if ( UnityEngine_GameObject__TryGetComponent_object_(
             ...
             &component,
             (const MethodInfo_2F82D0C *)Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___) )
      {
        v11 = component;
        if ( component )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39A74 & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_Object_TypeInfo, *(_QWORD *)&id);
    byte_4B39A74 = 1;
  }
