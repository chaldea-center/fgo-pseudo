        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)parent, v7, v8);
  ...
  *((_DWORD *)p_perf - 2) = layer;
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_perf, (int32_t)inPerf, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)obj, 0LL, 0LL) )
  {
    ...
    UnityEngine_Transform__SetParent_69480628(transform, this->fields._TrParent_k__BackingField, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D99B & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A5D99B = 1;
  }
  component = 0LL;
  ...
  if ( !System_String__IsNullOrEmpty(text, 0LL) )
  {
    ...
    if ( ((unsigned __int8)v10 & 1) != 0 )
    {
      ...
      if ( UnityEngine_GameObject__TryGetComponent_object_(
             ...
             &component,
             (const MethodInfo_2ED0148 *)Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___) )
      {
        v10 = component;
        if ( component )
        {
