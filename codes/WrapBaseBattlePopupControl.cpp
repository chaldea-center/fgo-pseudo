        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)parent, v7, v8, v9, v10, v11, v12);
  ...
  *((_DWORD *)p_perf - 2) = layer;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)p_perf, (int32_t)inPerf, v17, v18, v19, v20, v21, v22);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)obj, 0, 0) )
  {
    ...
    UnityEngine_Transform__SetParent_73382924(transform, this->fields._TrParent_k__BackingField, 0, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A572 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E7A572 = 1;
  }
  component = 0;
  ...
  if ( !System_String__IsNullOrEmpty(text, 0) )
  {
    ...
    if ( ((unsigned __int8)v10 & 1) != 0 )
    {
      ...
      if ( UnityEngine_GameObject__TryGetComponent_object_(
             ...
             &component,
             (const MethodInfo_32A96D4 *)Method_UnityEngine_GameObject_TryGetComponent_UIRangeLabel___) )
      {
        v10 = component;
        if ( component )
        {
