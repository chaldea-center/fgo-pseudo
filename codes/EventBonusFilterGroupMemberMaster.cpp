        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    278,
    (const MethodInfo_31B3158 *)Method_DataMasterBase_EventBonusFilterGroupMemberMaster__EventBonusFilterGroupMemberEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B160B6 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&EventBonusFilterGroupMemberEntity_TypeInfo, v8, v9);
    sub_1BCA7E0(&Method_System_Collections_Generic_List_EventBonusFilterGroupMemberEntity__Add__, v10, v11);
    sub_1BCA7E0(&Method_System_Collections_Generic_List_EventBonusFilterGroupMemberEntity__ToArray__, v12, v13);
    sub_1BCA7E0(&Method_System_Collections_Generic_List_EventBonusFilterGroupMemberEntity___ctor__, v14, v15);
    sub_1BCA7E0(&System_Collections_Generic_List_EventBonusFilterGroupMemberEntity__TypeInfo, v16, v17);
    byte_4B160B6 = 1;
  }
  ...
  System_Collections_Generic_List_object____ctor(
    v18,
    (const MethodInfo_35A1428 *)Method_System_Collections_Generic_List_EventBonusFilterGroupMemberEntity___ctor__);
  ...
  while ( 1 )
  {
    ...
    if ( list )
    {
        ...
        && *(_DWORD *)(list + 16) == groupId )
      {
        ...
        v30 = Method_System_Collections_Generic_List_EventBonusFilterGroupMemberEntity__Add__;
        ++v18->fields._version;
        if ( !items )
          goto LABEL_20;
...
LABEL_20:
  ...
  return (EventBonusFilterGroupMemberEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                      v18,
                                                      (const MethodInfo_35A37B4 *)Method_System_Collections_Generic_List_EventBonusFilterGroupMemberEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventBonusFilterGroupMemberEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                                  (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                                  PK,
                                                  (const MethodInfo_31B3198 *)Method_DataMasterBase_EventBonusFilterGroupMemberMaster__EventBonusFilterGroupMemberEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_31B31E8 *)Method_DataMasterBase_EventBonusFilterGroupMemberMaster__EventBonusFilterGroupMemberEntity__string__TryGetEntity__);
}