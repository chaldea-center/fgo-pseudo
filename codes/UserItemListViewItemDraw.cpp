void UserItemListViewItemDraw___ctor(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2785A & 1) == 0 )
  {
    ...
    sub_1C94098(&Field__PrivateImplementationDetails__422B3C7B2DE8568542AA18DEE65F4FCAC64982394C5ABCF41D2B33D3EBFE51FD);
    byte_4D2785A = 1;
  }
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.enableTimePos, (int32_t)v5, v6, v7, v8, v9, v10, v11);
...
void UserItemListViewItemDraw__SetEnableTime(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D27859 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_13451/*"TIME_OVER_USER_ITEM"*/);
    sub_1C94098(&StringLiteral_13452/*"TIME_OVER_WORD"*/);
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_13458/*"TIME_REST2_TIMEOVER"*/, 0);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( v8 )
    v9 = (System_String_o **)&StringLiteral_13451/*"TIME_OVER_USER_ITEM"*/;
  else
    v9 = (System_String_o **)&StringLiteral_13495/*"TIME_REST_USER_ITEM"*/;
  ...
  if ( v8 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_13452/*"TIME_OVER_WORD"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27858 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_12849/*"SetEnableTime"*/);
    byte_4D27858 = 1;
  }
  ...
  if ( !this->fields.enableTimeLabel
    || (v11 = *(int *)(Component_object[7].fields.m_CachedPtr + 532),
    ...
    if ( Component_object )
    {
      ...
      if ( Component_object )
      {
        ...
        if ( !UnityEngine_MonoBehaviour__IsInvoking_72095608(
                ...
                (System_String_o *)StringLiteral_12849/*"SetEnableTime"*/,
                0) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27857 & 1) == 0 )
  {
    ...
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&Method_UserItemListViewItemDraw__SetItem_b__10_0__);
    sub_1C94098(&StringLiteral_14874/*"UNIT_INFO_LIMITED"*/);
    sub_1C94098(&StringLiteral_12849/*"SetEnableTime"*/);
    sub_1C94098(&StringLiteral_14875/*"UNIT_INFO_LIMITED_MAX"*/);
    byte_4D27857 = 1;
  }
  entity = 0;
  if ( item && mode )
  {
    ...
    itemIconInfo = (__int64)DataManager__GetMaster_object_((const MethodInfo_319C0E0 *)Method_DataManager_GetMaster_ItemMaster___);
    if ( !itemIconInfo )
      goto LABEL_46;
           ...
           (const MethodInfo_345B50C *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0) )
      {
        ...
        if ( v13 >= ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0) )
          v14 = (System_String_o **)&StringLiteral_14875/*"UNIT_INFO_LIMITED_MAX"*/;
        else
          v14 = (System_String_o **)&StringLiteral_14874/*"UNIT_INFO_LIMITED"*/;
        v15 = *v14;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        itemIconInfo = (__int64)System_String__Format_64459052(v16, v17, v18, 0);
        if ( !v12 )
          goto LABEL_46;
    ...
    if ( !this->fields.enableTimeLabel )
      goto LABEL_46;
    v20 = *(int *)(*(_QWORD *)(itemIconInfo + 184) + 532LL);
