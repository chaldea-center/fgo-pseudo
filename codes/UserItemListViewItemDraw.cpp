void __fastcall UserItemListViewItemDraw___ctor(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56765 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Field__PrivateImplementationDetails__422B3C7B2DE8568542AA18DEE65F4FCAC64982394C5ABCF41D2B33D3EBFE51FD);
    byte_4A56765 = 1;
  }
  ...
  sub_1B88554(&this->fields.enableTimePos, v4);
...
void __fastcall UserItemListViewItemDraw__SetEnableTime(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56764 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_13306/*"TIME_OVER_USER_ITEM"*/);
    sub_1B885B0(&StringLiteral_13307/*"TIME_OVER_WORD"*/);
  ...
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_13313/*"TIME_REST2_TIMEOVER"*/, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( v8 )
    v9 = (System_String_o **)&StringLiteral_13306/*"TIME_OVER_USER_ITEM"*/;
  else
    v9 = (System_String_o **)&StringLiteral_13350/*"TIME_REST_USER_ITEM"*/;
  ...
  if ( v8 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_13307/*"TIME_OVER_WORD"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56763 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_12695/*"SetEnableTime"*/);
    byte_4A56763 = 1;
  }
  ...
  if ( !this->fields.enableTimeLabel
    || (v11 = *(int *)(*(_QWORD *)&Component_object[7].fields.m_CachedPtr + 488LL),
    ...
    if ( Component_object )
    {
      ...
      if ( Component_object )
      {
        ...
        if ( !UnityEngine_MonoBehaviour__IsInvoking_69444096(
                ...
                (System_String_o *)StringLiteral_12695/*"SetEnableTime"*/,
                0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56762 & 1) == 0 )
  {
    ...
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_UserItemListViewItemDraw__SetItem_b__10_0__);
    sub_1B885B0(&StringLiteral_14798/*"UNIT_INFO_LIMITED"*/);
    sub_1B885B0(&StringLiteral_12695/*"SetEnableTime"*/);
    sub_1B885B0(&StringLiteral_14799/*"UNIT_INFO_LIMITED_MAX"*/);
    byte_4A56762 = 1;
  }
  entity = 0LL;
  if ( item && mode )
  {
    ...
    itemIconInfo = (ItemIconComponent_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_ItemMaster___);
    if ( !itemIconInfo )
      goto LABEL_46;
           ...
           (const MethodInfo_311D988 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0LL) )
      {
        ...
        if ( v13 >= ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0LL) )
          v14 = (System_String_o **)&StringLiteral_14799/*"UNIT_INFO_LIMITED_MAX"*/;
        else
          v14 = (System_String_o **)&StringLiteral_14798/*"UNIT_INFO_LIMITED"*/;
        v15 = *v14;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        itemIconInfo = (ItemIconComponent_o *)System_String__Format_61721404(v16, v20, v24, 0LL);
        if ( !v12 )
          goto LABEL_46;
