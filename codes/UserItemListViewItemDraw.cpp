void __fastcall UserItemListViewItemDraw___ctor(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  v4 = (System_Array_o *)sub_1B00D74(float___TypeInfo, 5LL);
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.enableTimePos, (int32_t)v5, v6, v7);
...
void __fastcall UserItemListViewItemDraw__SetEnableTime(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DE1D7 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_13128/*"TIME_REST_USER_ITEM"*/, v4);
    sub_1B00CCC(&StringLiteral_13089/*"TIME_OVER_USER_ITEM"*/, v5);
    sub_1B00CCC(&StringLiteral_13090/*"TIME_OVER_WORD"*/, v6);
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_13096/*"TIME_REST2_TIMEOVER"*/, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( v13 )
    v14 = (System_String_o **)&StringLiteral_13089/*"TIME_OVER_USER_ITEM"*/;
  else
    v14 = (System_String_o **)&StringLiteral_13128/*"TIME_REST_USER_ITEM"*/;
  ...
  if ( v13 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_13090/*"TIME_OVER_WORD"*/, 0LL);
  ...
  if ( !enableTimeLabel
    ...
    || (gameObject = (System_String_o *)UnityEngine_Component__get_gameObject(
                                          ...
                                          0LL),
        (v20 = this->fields.enableTimeLabel) == 0LL)
    || (mText = v20->fields.mText) == 0LL
...
LABEL_24:
  ...
  if ( (unsigned int)stringLength >= enableTimePos->max_length )
    sub_1B00F30(gameObject, v16, v18, v19);
  ...
  UserItemListViewItemDraw__SetRemainTimeColor(Time, v24 - (_QWORD)Time, this->fields.enableTimeLabel, v26);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE1D6 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_12484/*"SetEnableTime"*/, v9);
    byte_48DE1D6 = 1;
  }
  ...
  if ( !this->fields.enableTimeLabel
    || (v14 = *(int *)(*(_QWORD *)&Component_object[7].fields.m_CachedPtr + 476LL),
    ...
    if ( Component_object )
    {
      ...
      if ( Component_object )
      {
        ...
        if ( !UnityEngine_MonoBehaviour__IsInvoking_68062372(
                ...
                (System_String_o *)StringLiteral_12484/*"SetEnableTime"*/,
                0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE1D5 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMaster_ItemMaster___, v8);
    sub_1B00CCC(&DataManager_TypeInfo, v9);
    sub_1B00CCC(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__, v10);
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_TweenColor___, v11);
    sub_1B00CCC(&int_TypeInfo, v12);
    sub_1B00CCC(&LocalizationManager_TypeInfo, v13);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v14);
    sub_1B00CCC(&Method_UserItemListViewItemDraw__SetItem_b__10_0__, v15);
    sub_1B00CCC(&StringLiteral_14573/*"UNIT_INFO_LIMITED"*/, v16);
    sub_1B00CCC(&StringLiteral_12484/*"SetEnableTime"*/, v17);
    sub_1B00CCC(&StringLiteral_14574/*"UNIT_INFO_LIMITED_MAX"*/, v18);
    byte_48DE1D5 = 1;
  }
  entity = 0LL;
  if ( item && mode )
  {
    ...
    itemIconInfo = (ItemIconComponent_o *)DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_ItemMaster___);
    if ( !itemIconInfo )
      goto LABEL_46;
           ...
           (const MethodInfo_2FE6AA0 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0LL) )
      {
        ...
        if ( v25 >= ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0LL) )
          v26 = (System_String_o **)&StringLiteral_14574/*"UNIT_INFO_LIMITED_MAX"*/;
        else
          v26 = (System_String_o **)&StringLiteral_14573/*"UNIT_INFO_LIMITED"*/;
        v27 = *v26;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        itemIconInfo = (ItemIconComponent_o *)System_String__Format_60340120(v28, v32, v36, 0LL);
        if ( !v24 )
          goto LABEL_46;
    ...
    if ( !this->fields.enableTimeLabel )
      goto LABEL_46;
    mSpriteName_high = SHIDWORD(itemIconInfo[1].fields.backSprite->fields.mSpriteName);
    itemIconInfo = (ItemIconComponent_o *)UnityEngine_Component__get_gameObject(
                                            (UnityEngine_Component_o *)this->fields.enableTimeLabel,
                                            0LL);
    if ( !itemIconInfo )
      goto LABEL_46;
    if ( itemLostTime <= mSpriteName_high )
    {
