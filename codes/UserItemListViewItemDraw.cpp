void __fastcall UserItemListViewItemDraw___ctor(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  v4 = (System_Array_o *)sub_1C13DCC(float___TypeInfo, 5LL);
  ...
  sub_1C13CC8(&this->fields.enableTimePos);
...
void __fastcall UserItemListViewItemDraw__SetEnableTime(UserItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAFAD1 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_13583/*"TIME_REST_QUEST_BOARD_CAMPAIGN"*/, v4);
    sub_1C13D24(&StringLiteral_13539/*"TEST_NOBLE_PHANTASM"*/, v5);
    sub_1C13D24(&StringLiteral_13540/*"THINKING"*/, v6);
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_13546/*"TIME_BEFORE_MINUTES"*/, 0LL);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( v13 )
    v14 = (System_String_o **)&StringLiteral_13539/*"TEST_NOBLE_PHANTASM"*/;
  else
    v14 = (System_String_o **)&StringLiteral_13583/*"TIME_REST_QUEST_BOARD_CAMPAIGN"*/;
  ...
  if ( v13 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_13540/*"THINKING"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFAD0 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_12922/*"SetAtkLabel"*/, v9);
    byte_4BAFAD0 = 1;
  }
  ...
  if ( !this->fields.enableTimeLabel
    || (v14 = *(int *)(*(_QWORD *)&Component_object[7].fields.m_CachedPtr + 500LL),
    ...
    if ( Component_object )
    {
      ...
      if ( Component_object )
      {
        ...
        if ( !UnityEngine_MonoBehaviour__IsInvoking_70706704(
                ...
                (System_String_o *)StringLiteral_12922/*"SetAtkLabel"*/,
                0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFACF & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_DataManager_GetMaster_ItemMaster___, v8);
    sub_1C13D24(&DataManager_TypeInfo, v9);
    sub_1C13D24(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__, v10);
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_TweenColor___, v11);
    sub_1C13D24(&int_TypeInfo, v12);
    sub_1C13D24(&LocalizationManager_TypeInfo, v13);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v14);
    sub_1C13D24(&Method_UserItemListViewItemDraw__SetItem_b__10_0__, v15);
    sub_1C13D24(&StringLiteral_15036/*"UISkin02DialogAtlas"*/, v16);
    sub_1C13D24(&StringLiteral_12922/*"SetAtkLabel"*/, v17);
    sub_1C13D24(&StringLiteral_15037/*"UIWidgets must fill the buffer with 4 vertices per quad. Found "*/, v18);
    byte_4BAFACF = 1;
  }
  entity = 0LL;
  if ( item && mode )
  {
    ...
    itemIconInfo = (ItemIconComponent_o *)DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_ItemMaster___);
    if ( !itemIconInfo )
      goto LABEL_46;
           ...
           (const MethodInfo_3238670 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0LL) )
      {
        ...
        if ( v25 >= ItemEntity__GetMaxNum((ItemEntity_o *)entity, 0LL) )
          v26 = (System_String_o **)&StringLiteral_15037/*"UIWidgets must fill the buffer with 4 vertices per quad. Found "*/;
        else
          v26 = (System_String_o **)&StringLiteral_15036/*"UISkin02DialogAtlas"*/;
        v27 = *v26;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        itemIconInfo = (ItemIconComponent_o *)System_String__Format_62982316(v28, v32, v36, 0LL);
        if ( !v24 )
          goto LABEL_46;
    ...
    if ( !this->fields.enableTimeLabel )
      goto LABEL_46;
    v38 = *((int *)&itemIconInfo[1].fields.backSprite->fields.mSpriteSet + 1);
