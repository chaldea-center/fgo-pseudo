...
void __fastcall ScriptSelectListViewObject__Awake(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BCC3A & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewItemDraw___, method);
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_UIMessageButton___, v3);
    byte_49BCC3A = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewItemDraw___),
  ...
  {
    sub_1B4D1EC(dispObject, v4);
  }
  v9 = UnityEngine_GameObject__GetComponent_object_(
         dispObject,
         (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_UIMessageButton___);
  this->fields.messageButton = (struct UIMessageButton_o *)v9;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.messageButton, (int32_t)v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BCC3D & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewObject___, method);
    byte_49BCC3D = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewObject___)) == 0LL) )
  {
    sub_1B4D1EC(DragObject, v4);
  }
  ScriptSelectListViewObject__Init_42364840((ScriptSelectListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BCC3C & 1) == 0 )
  {
    sub_1B4CF90(&ScriptSelectListViewItem_TypeInfo, method);
    byte_49BCC3C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BCC3E & 1) == 0 )
  {
    sub_1B4CF90(&ScriptSelectListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49BCC3E = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_42364840(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_42364912(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_42366148(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptSelectListViewObject__NoSelectMove(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BCC41 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_ScriptSelectListViewObject_NoSelectMove2__, v4);
    byte_49BCC41 = 1;
  }
...
void __fastcall ScriptSelectListViewObject__NoSelectStart(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  if ( (byte_49BCC40 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_9306/*"NoSelectMove"*/, method);
    byte_49BCC40 = 1;
  }
  this->fields.isBusy = 1;
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_9306/*"NoSelectMove"*/,
    0.1,
    0LL);
}
...
void __fastcall ScriptSelectListViewObject__SelectMove(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BCC43 & 1) == 0 )
  {
    sub_1B4CF90(&System_Action_TypeInfo, method);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v3);
    sub_1B4CF90(&Method_ScriptSelectListViewObject_SelectMove2__, v4);
    byte_49BCC43 = 1;
  }
  itemDraw = (UnityEngine_Object_o *)this->fields.itemDraw;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall ScriptSelectListViewObject__SelectStart(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  if ( (byte_49BCC42 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_12383/*"SelectMove"*/, method);
    byte_49BCC42 = 1;
  }
  this->fields.isBusy = 1;
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_12383/*"SelectMove"*/,
    0.1,
    0LL);
}
...
void __fastcall ScriptSelectListViewObject__SetupDisp(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BCC3F & 1) == 0 )
  {
    ...
    sub_1B4CF90(&ScriptSelectListViewItem_TypeInfo, v3);
    byte_49BCC3F = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ScriptSelectListViewObject__Start(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptSelectListViewObject__Init_42364840(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BCC44 & 1) == 0 )
  {
    sub_1B4CF90(&ScriptSelectListViewItemDraw_DispMode_TypeInfo, method);
