...
void __fastcall ScriptSelectListViewObject__Awake(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4D9 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewItemDraw___, method);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UIMessageButton___, v3);
    byte_4B1E4D9 = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewItemDraw___),
  ...
  {
    sub_1BCB254(dispObject, v4);
  }
  v9 = UnityEngine_GameObject__GetComponent_object_(
         dispObject,
         (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_UIMessageButton___);
  this->fields.messageButton = (struct UIMessageButton_o *)v9;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.messageButton, (int32_t)v9, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4DC & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewObject___, method);
    byte_4B1E4DC = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewObject___)) == 0LL) )
  {
    sub_1BCB254(DragObject, v4);
  }
  ScriptSelectListViewObject__Init_44009448((ScriptSelectListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4DB & 1) == 0 )
  {
    sub_1BCAFF8(&ScriptSelectListViewItem_TypeInfo, method);
    byte_4B1E4DB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4DD & 1) == 0 )
  {
    sub_1BCAFF8(&ScriptSelectListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B1E4DD = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_44009448(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_44009520(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_44010756(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptSelectListViewObject__NoSelectMove(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4E0 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_ScriptSelectListViewObject_NoSelectMove2__, v4);
    byte_4B1E4E0 = 1;
  }
...
void __fastcall ScriptSelectListViewObject__NoSelectStart(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  if ( (byte_4B1E4DF & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_9435/*"NoSelectMove"*/, method);
    byte_4B1E4DF = 1;
  }
  this->fields.isBusy = 1;
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_9435/*"NoSelectMove"*/,
    0.1,
    0LL);
}
...
void __fastcall ScriptSelectListViewObject__SelectMove(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4E2 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_TypeInfo, method);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v3);
    sub_1BCAFF8(&Method_ScriptSelectListViewObject_SelectMove2__, v4);
    byte_4B1E4E2 = 1;
  }
  itemDraw = (UnityEngine_Object_o *)this->fields.itemDraw;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall ScriptSelectListViewObject__SelectStart(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  if ( (byte_4B1E4E1 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_12564/*"SelectMove"*/, method);
    byte_4B1E4E1 = 1;
  }
  this->fields.isBusy = 1;
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_12564/*"SelectMove"*/,
    0.1,
    0LL);
}
...
void __fastcall ScriptSelectListViewObject__SetupDisp(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4DE & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&ScriptSelectListViewItem_TypeInfo, v3);
    byte_4B1E4DE = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ScriptSelectListViewObject__Start(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptSelectListViewObject__Init_44009448(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E4E3 & 1) == 0 )
  {
    sub_1BCAFF8(&ScriptSelectListViewItemDraw_DispMode_TypeInfo, method);
