...
void __fastcall ScriptSelectListViewObject__Awake(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC97EF & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewItemDraw___, method);
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_UIMessageButton___, v3);
    byte_4BC97EF = 1;
  }
  ...
  if ( !dispObject
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                             dispObject,
                             (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewItemDraw___),
  ...
  {
    sub_1C1AE30(dispObject, v4);
  }
  v13 = UnityEngine_GameObject__GetComponent_object_(
          dispObject,
          (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_UIMessageButton___);
  this->fields.messageButton = (struct UIMessageButton_o *)v13;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.messageButton, (int64_t)v13, v14, v15, v16, v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC97F2 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewObject___, method);
    byte_4BC97F2 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_ScriptSelectListViewObject___)) == 0LL) )
  {
    sub_1C1AE30(DragObject, v4);
  }
  ScriptSelectListViewObject__Init_42974064((ScriptSelectListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC97F1 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptSelectListViewItem_TypeInfo, method);
    byte_4BC97F1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC97F3 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptSelectListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4BC97F3 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_42974064(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_42974136(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ScriptSelectListViewObject__Init_42975372(
        ScriptSelectListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall ScriptSelectListViewObject__NoSelectMove(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC97F6 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ScriptSelectListViewObject_NoSelectMove2__, v4);
    byte_4BC97F6 = 1;
  }
...
void __fastcall ScriptSelectListViewObject__NoSelectStart(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  if ( (byte_4BC97F5 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_9681/*"NoSelectMove"*/, method);
    byte_4BC97F5 = 1;
  }
...
void __fastcall ScriptSelectListViewObject__SelectMove(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC97F8 & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, method);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v3);
    sub_1C1ABD4(&Method_ScriptSelectListViewObject_SelectMove2__, v4);
    byte_4BC97F8 = 1;
  }
  itemDraw = (UnityEngine_Object_o *)this->fields.itemDraw;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
...
void __fastcall ScriptSelectListViewObject__SelectStart(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  if ( (byte_4BC97F7 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_12814/*"SelectMove"*/, method);
    byte_4BC97F7 = 1;
  }
  this->fields.isBusy = 1;
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_12814/*"SelectMove"*/,
    0.1,
    0LL);
}
...
void __fastcall ScriptSelectListViewObject__SetupDisp(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC97F4 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&ScriptSelectListViewItem_TypeInfo, v3);
    byte_4BC97F4 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall ScriptSelectListViewObject__Start(ScriptSelectListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ScriptSelectListViewObject__Init_42974064(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC97F9 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptSelectListViewItemDraw_DispMode_TypeInfo, method);
