...
void SetResolutionOptionControl__Init(SetResolutionOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B890 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_9744/*"OPTION_RERSOLUTION_INFO_DISABLE"*/);
    sub_1C93AD4(&StringLiteral_9743/*"OPTION_RERSOLUTION_INFO"*/);
    sub_1C93AD4(&StringLiteral_9746/*"OPTION_RERSOLUTION_NORMAL"*/);
    this = (SetResolutionOptionControl_o *)sub_1C93AD4(&StringLiteral_9745/*"OPTION_RERSOLUTION_LOW"*/);
    byte_4D2B890 = 1;
  }
  if ( v2->fields.isInit )
  {
  ...
  else
  {
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&v2->fields.offButtonName, (int32_t)v14, v15, v16, v17, v18, v19, v20);
  ...
  if ( enableResolutionSetting )
    v23 = (System_String_o **)&StringLiteral_9743/*"OPTION_RERSOLUTION_INFO"*/;
  else
    v23 = (System_String_o **)&StringLiteral_9744/*"OPTION_RERSOLUTION_INFO_DISABLE"*/;
  v24 = *v23;
  ...
  if ( !infoLabel
    || (UILabel__set_text(infoLabel, (System_String_o *)this, 0),
        ...
        this = (SetResolutionOptionControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9746/*"OPTION_RERSOLUTION_NORMAL"*/, 0),
        !v25)
    || (UILabel__set_text(v25, (System_String_o *)this, 0),
        v26 = v2->fields.lowLabel,
        this = (SetResolutionOptionControl_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9745/*"OPTION_RERSOLUTION_LOW"*/, 0),
        !v26) )
  {
LABEL_23:
...
void SetResolutionOptionControl__OnClickLowButton(SetResolutionOptionControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&OptionManager_TypeInfo);
    sub_1C93AD4(&Method_SetResolutionOptionControl_OnClickLowButton__);
    byte_4D2B892 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetResolutionOptionControl_OnClickLowButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_SetResolutionOptionControl_OnClickLowButton__);
...
void SetResolutionOptionControl__OnClickNormalButton(SetResolutionOptionControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&OptionManager_TypeInfo);
    sub_1C93AD4(&Method_SetResolutionOptionControl_OnClickNormalButton__);
    byte_4D2B891 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetResolutionOptionControl_OnClickNormalButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_SetResolutionOptionControl_OnClickNormalButton__);
  v5 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
  if ( enableResolutionSetting )
  {
    OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0);
          ...
          if ( normalLabel )
          {
            ...
            if ( normalLabel )
            {
              ...
              if ( normalLabel )
              {
                ...
                if ( lowButton )
                {
                  lowButton->fields.hover = (struct UnityEngine_Color_o)xmmword_D004E0;
                  v7 = this->fields.lowButton;
                  if ( v7 )
                  {
                    v7->fields.pressed = (struct UnityEngine_Color_o)xmmword_D004E0;
                    v8 = this->fields.lowButton;
                    if ( v8 )
                    {
                      v8->fields.disabledColor = (struct UnityEngine_Color_o)xmmword_D004E0;
                      return;
                    }
                  }
                }
...
LABEL_24:
    sub_1C93D2C(normalLabel, *(_QWORD *)&type);
  }
  if ( !normalLabel )
    goto LABEL_24;
  UILabel__set_effectColor(normalLabel, this->fields.offButtonOutlineColor, 0);
