...
void FigureViewListViewObject__Awake(FigureViewListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEBB6E & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_FigureViewListViewItemDraw___);
    byte_4CEBB6E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_FigureViewListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_FigureViewListViewObject___)) == 0) )
  {
    sub_1C7BD40(DragObject, v4);
  }
  FigureViewListViewObject__Init_37870684((FigureViewListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void FigureViewListViewObject__Init_37870684(
        FigureViewListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void FigureViewListViewObject__Init_37871792(
        FigureViewListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void FigureViewListViewObject__Init_37871876(
        FigureViewListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void FigureViewListViewObject__Start(FigureViewListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    FigureViewListViewObject__Init_37870684(this, 2, v2);
}
