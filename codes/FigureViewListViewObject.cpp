...
void FigureViewListViewObject__Awake(FigureViewListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596DC5C & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_FigureViewListViewItemDraw___);
    byte_596DC5C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_FigureViewListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_FigureViewListViewObject___)) == 0) )
  {
    sub_2213CDC(DragObject, v4);
  }
  FigureViewListViewObject__Init_44289396((FigureViewListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (FigureViewListViewItem_c *)klass->_2.typeHierarchy[naturalAligment - 1] == FigureViewListViewItem_TypeInfo )
      v12 = initMode;
    else
      v12 = 0;
  }
  ...
  if ( !state || dispMode != this->fields.dispMode )
    FigureViewListViewObject__SetupDisp(this, v24);
...
void FigureViewListViewObject__Init_44289396(
        FigureViewListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
  ...
  v10.fields.y = v6;
  v10.fields.z = v7;
  FigureViewListViewObject__Init(this, initMode, 0, v4, v10, v3);
}


void FigureViewListViewObject__Init_44290480(
        FigureViewListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  FigureViewListViewObject__Init(this, initMode, callbackFunc, delay, v11, method);
}


void FigureViewListViewObject__Init_44290564(
        FigureViewListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  FigureViewListViewObject__Init(this, initMode, callbackFunc, v4, v11, method);
}
...
void FigureViewListViewObject__SetupDisp(FigureViewListViewObject_o *this, const MethodInfo *method)
{
  ...
  FigureViewListViewItemDraw_o *v11; // x0
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0, 0) )
  {
    ...
    if ( !v11 )
      sub_2213CDC(0, v9);
    FigureViewListViewItemDraw__SetItem(v11, (FigureViewListViewItem_o *)linkItem, this->fields.dispMode, v10);
  }
}
...
void FigureViewListViewObject__Start(FigureViewListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    FigureViewListViewObject__Init_44289396(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x0
  bool v12; // zf
  FigureViewListViewObject_o *v13; // x0
  ...
  FigureViewListViewObject__remove_callbackFunc(v13, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_221405C(v8, System_Action_TypeInfo, v9, v10);
  FigureViewListViewObject__Awake(v13, v14);
}