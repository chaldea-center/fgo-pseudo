void __fastcall MapGimmickPathMaster___ctor(MapGimmickPathMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B37512 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_MapGimmickPathMaster__MapGimmickPathEntity__string___ctor__, method);
    byte_4B37512 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    474,
    (const MethodInfo_31D2208 *)Method_DataMasterBase_MapGimmickPathMaster__MapGimmickPathEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (MapGimmickPathEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_31D2248 *)Method_DataMasterBase_MapGimmickPathMaster__MapGimmickPathEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37511 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_DataManager_GetMaster_CommonReleaseMaster___, v6);
    sub_1BD3458(&DataManager_TypeInfo, v7);
    sub_1BD3458(&MapGimmickPathEntity_TypeInfo, v8);
    byte_4B37511 = 1;
  }
    ...
    while ( 1 )
    {
      ...
      if ( Item )
      {
          ...
          && LODWORD(Item[1].klass) == mapGimmickId )
        {
          ...
          list = (System_Collections_ObjectModel_Collection_T__o *)DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
          if ( !list )
            break;
...
LABEL_19:
    sub_1BD36B4(list, *(_QWORD *)&mapGimmickId);
  }
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37514 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_MapGimmickPathMaster__MapGimmickPathEntity__string__TryGetEntity__, entity);
    byte_4B37514 = 1;
  }
  PK = (Il2CppObject *)MapGimmickPathEntity__CreatePK(
                         mapGimmickId,
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_31D2298 *)Method_DataMasterBase_MapGimmickPathMaster__MapGimmickPathEntity__string__TryGetEntity__);
}