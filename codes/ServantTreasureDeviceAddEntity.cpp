        ...
        const MethodInfo *method)
{
  if ( (byte_49BB828 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_17895/*"condIgnoreSealedLimitCount"*/, method);
    byte_49BB828 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_17895/*"condIgnoreSealedLimitCount"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49BB826 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_18336/*"dispMaskTreasureDevices"*/, method);
    byte_49BB826 = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_18336/*"dispMaskTreasureDevices"*/, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49BB827 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_19150/*"fixedCardLimitCounts"*/, method);
    byte_49BB827 = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_19150/*"fixedCardLimitCounts"*/, 0LL, 0LL);
}
