        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01626 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Linq_Enumerable_OrderBy_QuestPhaseDetailEntity_BoardInfo__int___);
    sub_1CE6700(&Method_System_Linq_Enumerable_ToArray_QuestPhaseDetailEntity_BoardInfo___);
    sub_1CE6700(&System_Func_QuestPhaseDetailEntity_BoardInfo__int__TypeInfo);
    sub_1CE6700(&QuestBoardListViewMultiLimitedFormation_TypeInfo);
    sub_1CE6700(&Method_QuestBoardListViewMultiLimitedFormation___c__Init_b__9_0__);
    sub_1CE6700(&QuestBoardListViewMultiLimitedFormation___c_TypeInfo);
    byte_4E01626 = 1;
  }
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Func_object__int__o *)sub_1CE694C(System_Func_QuestPhaseDetailEntity_BoardInfo__int__TypeInfo);
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&static_fields->__9__9_0, (int32_t)_9__9_0, v15, v16, v17, v18, v19, v20);
  }
  v21 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_object__int_(
                                                               ...
                                                               (const MethodInfo_32333CC *)Method_System_Linq_Enumerable_OrderBy_QuestPhaseDetailEntity_BoardInfo__int___);
  v22 = System_Linq_Enumerable__ToArray_object_(
          v21,
          (const MethodInfo_32438A8 *)Method_System_Linq_Enumerable_ToArray_QuestPhaseDetailEntity_BoardInfo___);
  if ( !this )
    sub_1CE6958(v22, v23);
  this->fields.InfoList = (struct QuestPhaseDetailEntity_BoardInfo_array *)v22;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.InfoList, (int32_t)v22, v24, v25, v26, v27, v28, v29);
  this->fields.Label = label;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.Label, (int32_t)label, v30, v31, v32, v33, v34, v35);
  this->fields.Sprite = sprite;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.Sprite, (int32_t)sprite, v36, v37, v38, v39, v40, v41);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01627 & 1) == 0 )
  {
    this = (QuestBoardListViewMultiLimitedFormation_o *)sub_1CE6700(&Method_System_Linq_Enumerable_Count_QuestPhaseDetailEntity_BoardInfo___);
    byte_4E01627 = 1;
  }
...
LABEL_15:
  ...
  if ( v10 >= System_Linq_Enumerable__Count_object_(
                v9,
                (const MethodInfo_3223E68 *)Method_System_Linq_Enumerable_Count_QuestPhaseDetailEntity_BoardInfo___) )
...
void QuestBoardListViewMultiLimitedFormation___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(QuestBoardListViewMultiLimitedFormation___c_TypeInfo);
