        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2FA1 & 1) == 0 )
  {
    sub_1C6BA08(&Method_System_Linq_Enumerable_OrderBy_QuestPhaseDetailEntity_BoardInfo__int___);
    sub_1C6BA08(&Method_System_Linq_Enumerable_ToArray_QuestPhaseDetailEntity_BoardInfo___);
    sub_1C6BA08(&System_Func_QuestPhaseDetailEntity_BoardInfo__int__TypeInfo);
    sub_1C6BA08(&QuestBoardListViewMultiLimitedFormation_TypeInfo);
    sub_1C6BA08(&Method_QuestBoardListViewMultiLimitedFormation___c__Init_b__9_0__);
    sub_1C6BA08(&QuestBoardListViewMultiLimitedFormation___c_TypeInfo);
    byte_4CB2FA1 = 1;
  }
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Func_object__int__o *)sub_1C6BC54(System_Func_QuestPhaseDetailEntity_BoardInfo__int__TypeInfo);
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->__9__9_0, (int32_t)_9__9_0, v15, v16);
  }
  v17 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderBy_object__int_(
                                                               ...
                                                               (const MethodInfo_316AB98 *)Method_System_Linq_Enumerable_OrderBy_QuestPhaseDetailEntity_BoardInfo__int___);
  v18 = System_Linq_Enumerable__ToArray_object_(
          v17,
          (const MethodInfo_317B248 *)Method_System_Linq_Enumerable_ToArray_QuestPhaseDetailEntity_BoardInfo___);
  if ( !this )
    sub_1C6BC60(v18, v19);
  this->fields.InfoList = (struct QuestPhaseDetailEntity_BoardInfo_array *)v18;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.InfoList, (int32_t)v18, v20, v21);
  this->fields.Label = label;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.Label, (int32_t)label, v22, v23);
  this->fields.Sprite = sprite;
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.Sprite, (int32_t)sprite, v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2FA2 & 1) == 0 )
  {
    this = (QuestBoardListViewMultiLimitedFormation_o *)sub_1C6BA08(&Method_System_Linq_Enumerable_Count_QuestPhaseDetailEntity_BoardInfo___);
    byte_4CB2FA2 = 1;
  }
...
LABEL_15:
  ...
  if ( v10 >= System_Linq_Enumerable__Count_object_(
                v9,
                (const MethodInfo_315B7CC *)Method_System_Linq_Enumerable_Count_QuestPhaseDetailEntity_BoardInfo___) )
...
void QuestBoardListViewMultiLimitedFormation___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C6BC54(QuestBoardListViewMultiLimitedFormation___c_TypeInfo);
