        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC5040 & 1) == 0 )
  {
    sub_1C713B0(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
    byte_4CC5040 = 1;
  }
  v3 = sub_1C715FC(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
...
void WarBoardFaceMessagePerformance__OnStart(WarBoardFaceMessagePerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC503E & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1C713B0(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__);
    byte_4CC503E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC5042 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__);
    byte_4CC5042 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
