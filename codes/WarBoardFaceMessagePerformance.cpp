        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AC826 & 1) == 0 )
  {
    sub_B52984(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
    byte_42AC826 = 1;
  }
  v3 = (WarBoardFaceMessagePerformance__Execute_d__7_o *)sub_B52A54(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AC824 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_B52984(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__);
    byte_42AC824 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE8FF & 1) == 0 )
  {
    ...
    sub_B52984(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__);
    byte_42AE8FF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
