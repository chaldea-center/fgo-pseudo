        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD42 & 1) == 0 )
  {
    sub_1BC3008(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo, method);
    byte_4AFFD42 = 1;
  }
  v3 = sub_1BC3254(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD40 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__, v5);
    byte_4AFFD40 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD44 & 1) == 0 )
  {
    ...
    sub_1BC3008(&UnityEngine_WaitWhile_TypeInfo, v3);
    sub_1BC3008(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__, v4);
    byte_4AFFD44 = 1;
  }
  ...
  else
  {
    ...
    v9 = (UnityEngine_WaitWhile_o *)sub_1BC3254(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
