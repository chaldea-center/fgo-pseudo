        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A1F1 & 1) == 0 )
  {
    sub_1BCAFF8(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo, method);
    byte_4B1A1F1 = 1;
  }
  v3 = sub_1BCB244(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A1EF & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__, v5);
    byte_4B1A1EF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A1F3 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UnityEngine_WaitWhile_TypeInfo, v3);
    sub_1BCAFF8(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__, v4);
    byte_4B1A1F3 = 1;
  }
  ...
  else
  {
    ...
    v9 = (UnityEngine_WaitWhile_o *)sub_1BCB244(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BCB00C(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1BCB120(v3, v4);
}
