        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E625 & 1) == 0 )
  {
    sub_1C93AD4(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
    byte_4D2E625 = 1;
  }
  v3 = sub_1C93D20(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
...
void WarBoardFaceMessagePerformance__OnStart(WarBoardFaceMessagePerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E623 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1C93AD4(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__);
    byte_4D2E623 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E627 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__);
    byte_4D2E627 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C93AE8(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C93BFC(v3, v4);
}
