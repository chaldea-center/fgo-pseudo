        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DDE9 & 1) == 0 )
  {
    sub_1B90010(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo, method);
    byte_4A6DDE9 = 1;
  }
  v3 = sub_1B9025C(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DDE7 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__, v5);
    byte_4A6DDE7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DDEB & 1) == 0 )
  {
    ...
    sub_1B90010(&UnityEngine_WaitWhile_TypeInfo, v3);
    sub_1B90010(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__, v4);
    byte_4A6DDEB = 1;
  }
  ...
  else
  {
    ...
    v9 = (UnityEngine_WaitWhile_o *)sub_1B9025C(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B90024(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
