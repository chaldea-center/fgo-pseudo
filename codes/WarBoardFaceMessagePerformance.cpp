        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07BE & 1) == 0 )
  {
    sub_1B00CCC(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo, method);
    byte_48E07BE = 1;
  }
  v3 = sub_1B00F18(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07BC & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__, v5);
    byte_48E07BC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07C0 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UnityEngine_WaitWhile_TypeInfo, v3);
    sub_1B00CCC(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__, v4);
    byte_48E07C0 = 1;
  }
  ...
  else
  {
    ...
    v9 = (UnityEngine_WaitWhile_o *)sub_1B00F18(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B00CE0(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B00DF4(v3, v4);
}
