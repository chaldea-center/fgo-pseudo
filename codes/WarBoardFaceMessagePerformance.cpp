        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3F28 & 1) == 0 )
  {
    sub_1C6BA08(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
    byte_4CB3F28 = 1;
  }
  v3 = sub_1C6BC54(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
...
void WarBoardFaceMessagePerformance__OnStart(WarBoardFaceMessagePerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB3F26 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1C6BA08(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__);
    byte_4CB3F26 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3F2A & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__);
    byte_4CB3F2A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
