        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02647 & 1) == 0 )
  {
    sub_1CE6700(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
    byte_4E02647 = 1;
  }
  v3 = sub_1CE694C(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
...
void WarBoardFaceMessagePerformance__OnStart(WarBoardFaceMessagePerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E02645 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1CE6700(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__);
    byte_4E02645 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02649 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__);
    byte_4E02649 = 1;
  }
  ...
  else
  {
    ...
    v7 = (UnityEngine_WaitWhile_o *)sub_1CE694C(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
