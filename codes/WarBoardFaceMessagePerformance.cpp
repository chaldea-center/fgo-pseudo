        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C192 & 1) == 0 )
  {
    sub_1B863B8(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo, method);
    byte_4A4C192 = 1;
  }
  v3 = sub_1B86604(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C190 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__, v5);
    byte_4A4C190 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C194 & 1) == 0 )
  {
    ...
    sub_1B863B8(&UnityEngine_WaitWhile_TypeInfo, v3);
    sub_1B863B8(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__, v4);
    byte_4A4C194 = 1;
  }
  ...
  else
  {
    ...
    v9 = (UnityEngine_WaitWhile_o *)sub_1B86604(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
