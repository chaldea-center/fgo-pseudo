        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387BCC & 1) == 0 )
  {
    sub_B775C4(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
    byte_4387BCC = 1;
  }
  v3 = (WarBoardFaceMessagePerformance__Execute_d__7_o *)sub_B77694(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387BCA & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_B775C4(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__);
    byte_4387BCA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4388F5B & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__);
    byte_4388F5B = 1;
  }
  ...
  else
  {
    ...
    v7 = (UnityEngine_WaitWhile_o *)sub_B77694(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B775C8(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_B77668(v3, v4);
}
