        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3EE & 1) == 0 )
  {
    sub_1C94098(&WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
    byte_4D2A3EE = 1;
  }
  v3 = sub_1C942E4(WarBoardFaceMessagePerformance__Execute_d__7_TypeInfo);
...
void WarBoardFaceMessagePerformance__OnStart(WarBoardFaceMessagePerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3EC & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1C94098(&Method_WarBoardFaceMessagePerformance_MessageEndCallback__);
    byte_4D2A3EC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3F0 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_WarBoardFaceMessagePerformance__Execute_b__7_0__);
    byte_4D2A3F0 = 1;
  }
  ...
  else
  {
    ...
    v7 = (UnityEngine_WaitWhile_o *)sub_1C942E4(UnityEngine_WaitWhile_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C940AC(&Method_WarBoardFaceMessagePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C941C0(v3, v4);
}
