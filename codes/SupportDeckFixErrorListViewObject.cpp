        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C79A & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___, method);
    byte_4A6C79A = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C79B & 1) == 0 )
  {
    ...
    sub_1B90010(&SupportDeckFixErrorListViewItem_TypeInfo, v3);
    byte_4A6C79B = 1;
  }
