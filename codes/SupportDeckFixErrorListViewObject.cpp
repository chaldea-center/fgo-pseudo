        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25C4 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___, method);
    byte_4AB25C4 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25C5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&SupportDeckFixErrorListViewItem_TypeInfo, v3);
    byte_4AB25C5 = 1;
  }
