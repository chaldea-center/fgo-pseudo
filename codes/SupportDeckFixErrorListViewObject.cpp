        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3F01 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___);
    byte_42B3F01 = 1;
  }
  ...
  Component_srcLineSprite = (struct SupportDeckFixErrorListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                              dispObject,
                                                                              (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3F02 & 1) == 0 )
  {
    ...
    sub_B52984(&SupportDeckFixErrorListViewItem_TypeInfo);
    byte_42B3F02 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    v4 = *(&SupportDeckFixErrorListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v4 )
    {
      v5 = (SupportDeckFixErrorListViewItem_c *)linkItem->klass->_2.typeHierarchy[v4 - 1];
