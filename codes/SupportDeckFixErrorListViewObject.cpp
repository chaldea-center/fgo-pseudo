        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9F5C & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___, method);
    byte_4BF9F5C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_SupportDeckFixErrorListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9F5D & 1) == 0 )
  {
    ...
    sub_1C2E12C(&SupportDeckFixErrorListViewItem_TypeInfo, v3);
    byte_4BF9F5D = 1;
  }
