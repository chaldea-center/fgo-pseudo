        ...
        const MethodInfo *method)
{
  if ( (byte_40FC778 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_16559/*"baseUserSvtId"*/, baseUserSvtId);
    byte_40FC778 = 1;
  }
  RequestBase__addField_30956696((RequestBase_o *)this, (System_String_o *)StringLiteral_16559/*"baseUserSvtId"*/, baseUserSvtId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC777 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17157/*"card/friendshipExceed"*/, v2);
    byte_40FC777 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17157/*"card/friendshipExceed"*/, 0LL);
}
