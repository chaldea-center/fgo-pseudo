        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4216924 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_17275/*"card/friendshipExceed"*/, v2);
    byte_4216924 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_17275/*"card/friendshipExceed"*/, 0LL);
}
