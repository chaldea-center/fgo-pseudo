        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField_40919284((RequestBase_o *)this, (System_String_o *)StringLiteral_17019/*"baseUserSvtId"*/, baseUserSvtId, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A59B & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_17689/*"card/friendshipExceed"*/, v2);
    byte_4A0A59B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_17689/*"card/friendshipExceed"*/, 0LL);
}
