        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.attackPieceData, (int32_t)attacker, v9, v10);
  this->fields.targetPieceData = target;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.targetPieceData, (int32_t)target, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4C17C & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_Select_WarBoardPieceData__long___, method);
    sub_1B863B8(&Method_System_Linq_Enumerable_ToArray_long___, v3);
    sub_1B863B8(&Method_System_Linq_Enumerable_Where_WarBoardPieceData___, v4);
    sub_1B863B8(&System_Func_WarBoardPieceData__long__TypeInfo, v5);
    sub_1B863B8(&System_Func_WarBoardPieceData__bool__TypeInfo, v6);
    sub_1B863B8(&Method_NetworkManager_getRequest_WarBoardBattleSetupRequest___, v7);
    sub_1B863B8(&NetworkManager_TypeInfo, v8);
    sub_1B863B8(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v9);
    sub_1B863B8(&Method_WarBoardAPIServantAttackRequestTask___c__SetRequest_b__3_1__, v10);
    sub_1B863B8(&Method_WarBoardAPIServantAttackRequestTask___c__SetRequest_b__3_3__, v11);
    sub_1B863B8(&WarBoardAPIServantAttackRequestTask___c_TypeInfo, v12);
    sub_1B863B8(&Method_WarBoardAPIServantAttackRequestTask__SetRequest_b__3_0__, v13);
    sub_1B863B8(&Method_WarBoardAPIServantAttackRequestTask__SetRequest_b__3_2__, v14);
    byte_4A4C17C = 1;
  }
  ...
  v22 = (System_Func_object__bool__o *)sub_1B86604(System_Func_WarBoardPieceData__bool__TypeInfo);
  ...
  if ( !_9__3_1 )
  {
    ...
    _9__3_1 = (System_Func_T__TResult__o *)sub_1B86604(System_Func_WarBoardPieceData__long__TypeInfo);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&static_fields->__9__3_1, (int32_t)_9__3_1, v30, v31);
  ...
  v32 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__long_(
                                                               ...
                                                               (const MethodInfo_2FA0F80 *)Method_System_Linq_Enumerable_Select_WarBoardPieceData__long___);
  v33 = System_Linq_Enumerable__ToArray_long_(
          v32,
          (const MethodInfo_2FA9850 *)Method_System_Linq_Enumerable_ToArray_long___);
  v34 = (System_Func_object__bool__o *)sub_1B86604(System_Func_WarBoardPieceData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v34,
    (Il2CppObject *)this,
  ...
  if ( !_9__3_3 )
  {
    ...
    _9__3_3 = (System_Func_T__TResult__o *)sub_1B86604(System_Func_WarBoardPieceData__long__TypeInfo);
    System_Func_object__long____ctor(
      _9__3_3,
      v39,
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&v40->__9__3_3, (int32_t)_9__3_3, v41, v42);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     0LL,
                     (const MethodInfo_2FF4AF4 *)Method_NetworkManager_getRequest_WarBoardBattleSetupRequest___);
  Instance = (void *)WarBoardData__get_id(v18, 0LL);
  if ( !Request_object )
LABEL_24:
    sub_1B86614(Instance, attackPieceData);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.request, (int32_t)Request_object, v46, v47);
}
...
void __fastcall WarBoardAPIServantAttackRequestTask___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4C17D & 1) == 0 )
  {
    sub_1B863B8(&WarBoardAPIServantAttackRequestTask___c_TypeInfo, v1);
    byte_4A4C17D = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(WarBoardAPIServantAttackRequestTask___c_TypeInfo);
