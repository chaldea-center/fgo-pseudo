        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.targetPieceData, (int32_t)target, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D9B2 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Linq_Enumerable_Select_WarBoardPieceData__long___, method);
    sub_1B715CC(&Method_System_Linq_Enumerable_ToArray_long___, v3);
    sub_1B715CC(&Method_System_Linq_Enumerable_Where_WarBoardPieceData___, v4);
    sub_1B715CC(&System_Func_WarBoardPieceData__long__TypeInfo, v5);
    sub_1B715CC(&System_Func_WarBoardPieceData__bool__TypeInfo, v6);
    sub_1B715CC(&Method_NetworkManager_getRequest_WarBoardBattleSetupRequest___, v7);
    sub_1B715CC(&NetworkManager_TypeInfo, v8);
    sub_1B715CC(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v9);
    sub_1B715CC(&Method_WarBoardAPIServantAttackRequestTask___c__SetRequest_b__3_1__, v10);
    sub_1B715CC(&Method_WarBoardAPIServantAttackRequestTask___c__SetRequest_b__3_3__, v11);
    sub_1B715CC(&WarBoardAPIServantAttackRequestTask___c_TypeInfo, v12);
    sub_1B715CC(&Method_WarBoardAPIServantAttackRequestTask__SetRequest_b__3_0__, v13);
    sub_1B715CC(&Method_WarBoardAPIServantAttackRequestTask__SetRequest_b__3_2__, v14);
    byte_4A1D9B2 = 1;
  }
  ...
  v22 = (System_Func_object__bool__o *)sub_1B71818(System_Func_WarBoardPieceData__bool__TypeInfo);
  ...
  if ( !_9__3_1 )
  {
    ...
    _9__3_1 = (System_Func_T__TResult__o *)sub_1B71818(System_Func_WarBoardPieceData__long__TypeInfo);
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__3_1, (int32_t)_9__3_1, v30, v31);
  ...
  v32 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__long_(
                                                               ...
                                                               (const MethodInfo_2E8BBF8 *)Method_System_Linq_Enumerable_Select_WarBoardPieceData__long___);
  v33 = System_Linq_Enumerable__ToArray_long_(
          v32,
          (const MethodInfo_2E93DFC *)Method_System_Linq_Enumerable_ToArray_long___);
  v34 = (System_Func_object__bool__o *)sub_1B71818(System_Func_WarBoardPieceData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v34,
    (Il2CppObject *)this,
  ...
  if ( !_9__3_3 )
  {
    ...
    _9__3_3 = (System_Func_T__TResult__o *)sub_1B71818(System_Func_WarBoardPieceData__long__TypeInfo);
    System_Func_object__long____ctor(
      _9__3_3,
      v39,
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&v40->__9__3_3, (int32_t)_9__3_3, v41, v42);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     0LL,
                     (const MethodInfo_2EDD4A0 *)Method_NetworkManager_getRequest_WarBoardBattleSetupRequest___);
  Instance = (void *)WarBoardData__get_id(v18, 0LL);
  if ( !Request_object )
LABEL_24:
    sub_1B71828(Instance, attackPieceData);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.request, (int32_t)Request_object, v46, v47);
}
...
void __fastcall WarBoardAPIServantAttackRequestTask___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1D9B3 & 1) == 0 )
  {
    sub_1B715CC(&WarBoardAPIServantAttackRequestTask___c_TypeInfo, v1);
    byte_4A1D9B3 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(WarBoardAPIServantAttackRequestTask___c_TypeInfo);
