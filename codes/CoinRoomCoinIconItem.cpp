        ...
        const MethodInfo *method)
{
  ...
  ServantLimitEntity_o *v26; // [xsp+8h] [xbp-58h] BYREF
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.iconLabelInfo, (int64_t)v9, v10, v11, v12, v13, v14, v15);
  ...
  *(_QWORD *)&v28.fields.fakeValue = v21;
  iconLabelInfo = (IconLabelInfo_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v28, 0LL);
  if ( !v20 )
    goto LABEL_37;
...
LABEL_34:
      ServantEntity__getName_40922364(svtEntity, &this->fields.sortRuby, EntityDefinitely->fields.maxLimitCount, 0LL);
      goto LABEL_35;
    }
    goto LABEL_37;
  }
  if ( svtEntity )
    goto LABEL_34;
LABEL_35:
  this->fields._isCanStrength_k__BackingField = CoinRoomCoinIconItem__IsCanStrength_45952208(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC0D & 1) == 0 )
  {
    ...
    sub_1C21E38(&DataManager_TypeInfo);
    usrSvtEntity = (UserServantEntity_o *)sub_1C21E38(&Method_DataMasterBase_SkillMaster__SkillEntity__int__TryGetEntity__);
    byte_4BDFC0D = 1;
  }
  entity = 0LL;
  if ( !v2 )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  usrSvtEntity = (UserServantEntity_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_SkillMaster___);
  if ( !currentCryptoKey )
LABEL_20:
    sub_1C22094(usrSvtEntity, method);
  ...
  while ( 1 )
  {
    ...
    if ( v7 >= v5 )
LABEL_21:
      sub_1C2209C(usrSvtEntity, method);
    if ( !v6 )
      goto LABEL_20;
...
bool __fastcall CoinRoomCoinIconItem__IsCanStrength(CoinRoomCoinIconItem_o *this, const MethodInfo *method)
{
  ...
  return CoinRoomCoinIconItem__IsCanStrength_45952208(this->fields._svtId_k__BackingField, 0, v2);
}


bool __fastcall CoinRoomCoinIconItem__IsCanStrength_45952208(
        int32_t svtId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC0C & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_CoinRoomCoinIconItem___c__DisplayClass62_0__IsCanStrength_b__0__);
    sub_1C21E38(&CoinRoomCoinIconItem___c__DisplayClass62_0_TypeInfo);
    byte_4BDFC0C = 1;
  }
  v39 = 0LL;
  entity = 0LL;
  v5 = sub_1C22084(CoinRoomCoinIconItem___c__DisplayClass62_0_TypeInfo);
...
LABEL_56:
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  if ( !v8 )
  {
    if ( !Master_object )
      goto LABEL_56;
...
LABEL_21:
  ...
  AllList = (System_Collections_Generic_IEnumerable_TSource__o *)UserServantMaster__getAllList(
                                                                   ...
                                                                   0LL);
  v12 = (System_Func_object__bool__o *)sub_1C22084(System_Func_UserServantEntity__bool__TypeInfo);
  ...
  {
LABEL_29:
    v17 = sub_1C73E18(Master_object, System_Collections_Generic_IEnumerable_UserServantEntity__TypeInfo, 0LL);
  }
  ...
  do
  {
    ...
    {
LABEL_36:
      v23 = sub_1C73E18(v19, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_43:
      v28 = sub_1C73E18(v19, System_Collections_Generic_IEnumerator_UserServantEntity__TypeInfo, 0LL);
    }
  ...
  {
LABEL_51:
    v37 = sub_1C73E18(v19, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall CoinRoomCoinIconItem__IsHeroine(CoinRoomCoinIconItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC0B & 1) == 0 )
  {
    sub_1C21E38(&Method_BasicHelper_Any_UserServantEntity____77630056);
    sub_1C21E38(&Method_CoinRoomCoinIconItem__IsHeroine_b__58_0__);
    sub_1C21E38(&Method_DataManager_GetMaster_UserServantMaster___);
    sub_1C21E38(&DataManager_TypeInfo);
    sub_1C21E38(&System_Func_UserServantEntity__bool__TypeInfo);
    byte_4BDFC0B = 1;
  ...
  OrganizationList = (System_Object_array *)UserServantMaster__getOrganizationList(
                                              (UserServantMaster_o *)Master_object,
                                              0LL);
  v6 = (System_Func_object__bool__o *)sub_1C22084(System_Func_UserServantEntity__bool__TypeInfo);
  ...
  return BasicHelper__Any_object__49917468(
           ...
           (const MethodInfo_2F9AE1C *)Method_BasicHelper_Any_UserServantEntity____77630056);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC0E & 1) == 0 )
  {
    this = (CoinRoomCoinIconItem_o *)sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BDFC0E = 1;
  }
  ...
  *(_WORD *)&v9->fields.isTermination = 0;
  ...
  if ( sortKind <= 14 )
  {
    if ( sortKind == 2 )
    {
      ...
      sub_1C21DDC((PartyOrganizationUtility_o *)&v9->fields.sortStr1, (int64_t)v20, (int64_t)method, v3, v4, v5, v6, v7);
      ...
      if ( this )
      {
        IconLabelInfo__Set_39381772((IconLabelInfo_o *)this, 57, collectionNo_k__BackingField, 0, 0, 0, 0, 0, 0LL);
        goto LABEL_21;
      }
      goto LABEL_27;
    }
...
LABEL_16:
    ...
    v17 = StringLiteral_1/*""*/;
    v9->fields.sortStr1 = (struct System_String_o *)StringLiteral_1/*""*/;
    sub_1C21DDC((PartyOrganizationUtility_o *)&v9->fields.sortStr1, (int64_t)v17, (int64_t)method, v3, v4, v5, v6, v7);
    this = (CoinRoomCoinIconItem_o *)v9->fields.iconLabelInfo;
...
LABEL_14:
  sub_1C21DDC((PartyOrganizationUtility_o *)p_sortStr1, (int64_t)sortRuby, (int64_t)method, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC10 & 1) == 0 )
  {
    this = (CoinRoomCoinIconItem_o *)sub_1C21E38(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4BDFC10 = 1;
  }
  if ( !x )
    sub_1C22094(this, x);
  ...
  *(_QWORD *)&v8.fields.fakeValue = v5;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v8, 0LL) == v4->fields._svtId_k__BackingField
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC11 & 1) == 0 )
  {
    this = (CoinRoomCoinIconItem___c__DisplayClass62_0_o *)sub_1C21E38(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4BDFC11 = 1;
  }
  if ( !x )
    sub_1C22094(this, x);
