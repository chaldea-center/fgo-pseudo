...
{
  __int64 *v2; // x22
  System_Object_array *ComponentsInChildren_object__48721436; // x20
  ...
  States = (SimpleAnimation_o *)UnityEngine_Component__GetComponentsInChildren_object__48721436(
                                  (UnityEngine_Component_o *)this,
  ...
  if ( ComponentsInChildren_object__48721436
    && (v8 = *(_QWORD *)&ComponentsInChildren_object__48721436->max_length) != 0 )
  {
    if ( (int)v8 >= 1 )
    {
      v9 = 0;
      ...
      {
        States = (SimpleAnimation_o *)ComponentsInChildren_object__48721436->m_Items[v9];
        if ( !States )
          goto LABEL_91;
        ...
        {
LABEL_14:
          v14 = sub_1BDA590(States, System_Collections_Generic_IEnumerable_SimpleAnimation_State__TypeInfo, 0LL);
        }
...
LABEL_21:
          ...
          {
LABEL_28:
            v24 = sub_1BDA590(v16, System_Collections_Generic_IEnumerator_SimpleAnimation_State__TypeInfo, 0LL);
          }
          ...
          {
LABEL_35:
            v31 = sub_1BDA590(v25, SimpleAnimation_State_TypeInfo, 8LL);
          }
        ...
        {
LABEL_42:
          v35 = sub_1BDA590(v16, System_IDisposable_TypeInfo, 0LL);
        }
        States = (SimpleAnimation_o *)(*(__int64 (__fastcall **)(__int64, _QWORD))v35)(v16, *(_QWORD *)(v35 + 8));
        LODWORD(v8) = ComponentsInChildren_object__48721436->max_length;
        if ( (int)++v9 >= (int)v8 )
          goto LABEL_84;
      }
      goto LABEL_92;
...
LABEL_59:
            ...
            {
LABEL_66:
              v47 = sub_1BDA590(Enumerator, System_Collections_IEnumerator_TypeInfo, 1LL);
            }
            ...
            {
              sub_1B88ACC(v48);
              v58 = sub_1B886EC(Enumerator, System_IDisposable_TypeInfo);
              v59 = v58;
              if ( v58 )
              {
                v60 = *(_QWORD *)v58;
...
LABEL_98:
          ...
          v2 = 0LL;
          States = (SimpleAnimation_o *)sub_1B886EC(Enumerator, System_IDisposable_TypeInfo);
          if ( States )
          {
            v50 = States->klass;
            v51 = States;
            ...
            {
LABEL_76:
              v54 = sub_1BDA590(States, System_IDisposable_TypeInfo, 0LL);
            }
...
LABEL_91:
  ...
  if ( v55 >= 1 )
  {
    ...
    while ( v57 < v55 )
    {
      ...
      if ( !States )
        goto LABEL_91;
      UnityEngine_ParticleSystem__Play_69739516((UnityEngine_ParticleSystem_o *)States, 0LL);
...
LABEL_92:
    ...
    if ( v55 >= 1 )
    {
      ...
      while ( v57 < v55 )
      {
        ...
        if ( !States )
          goto LABEL_92;
        UnityEngine_ParticleSystem__Pause_69739648((UnityEngine_ParticleSystem_o *)States, 0LL);
        v55 = (int)v56->fields.m_CancellationTokenSource;
        if ( (int)++v57 >= v55 )
          return;
      }
