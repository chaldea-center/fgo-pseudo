        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3A14 & 1) == 0 )
  {
    sub_1C13D24(&CharaGraphEquipListViewItem_TypeInfo, method);
    byte_4BB3A14 = 1;
  }
    ...
    && (CharaGraphEquipListViewItem_c *)listViewItem->klass->_2.typeHierarchy[methodPtr_low - 1] == CharaGraphEquipListViewItem_TypeInfo )
  {
    ...
    sub_1C13CC8(p_listViewItem, (int64_t)item, v2, v3, v4, v5, v6, v7);
    return listViewItem;
  }
  sub_1C14240(this->fields.item);
