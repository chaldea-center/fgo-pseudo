void CampaignInfoItem___cctor(const MethodInfo *method)
{
  if ( (byte_4E71080 & 1) == 0 )
  {
    sub_1D0F0B4(&CampaignInfoItem_TypeInfo);
    byte_4E71080 = 1;
  }
...
void CampaignInfoItem__OnClick(CampaignInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7107F & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_CampaignInfoItem_OnClick__);
    sub_1D0F0B4(&WebViewManager_TypeInfo);
    this = (CampaignInfoItem_o *)sub_1D0F0B4(&StringLiteral_1/*""*/);
    byte_4E7107F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058(&this->fields.target, info);
  ...
  UnityEngine_Material__SetTexture(v14, (System_String_o *)StringLiteral_16486/*"_MaskTex"*/, (UnityEngine_Texture_o *)maskTex, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseText;
  if ( !gameObject )
    goto LABEL_15;
