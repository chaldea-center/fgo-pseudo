void __fastcall CampaignInfoItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1AB4B & 1) == 0 )
  {
    sub_1B715CC(&CampaignInfoItem_TypeInfo, v1);
    byte_4A1AB4B = 1;
  }
...
void __fastcall CampaignInfoItem__OnClick(CampaignInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1AB4A & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_CampaignInfoItem_OnClick__, v3);
    sub_1B715CC(&WebViewManager_TypeInfo, v4);
    this = (CampaignInfoItem_o *)sub_1B715CC(&StringLiteral_1/*""*/, v5);
    byte_4A1AB4A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1AB49 & 1) == 0 )
  {
    sub_1B715CC(&CampaignInfoItem_TypeInfo, info);
    sub_1B715CC(&UnityEngine_Material_TypeInfo, v11);
    sub_1B715CC(&StringLiteral_4956/*"Custom/SpriteWithMask"*/, v12);
    sub_1B715CC(&StringLiteral_16217/*"_MaskTex"*/, v13);
    byte_4A1AB49 = 1;
  }
  this->fields.target = info;
  sub_1B71570(&this->fields.target);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
    goto LABEL_15;
  UnityEngine_GameObject__SetActive(gameObject, 1, 0LL);
  v16 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4956/*"Custom/SpriteWithMask"*/, 0LL);
  v17 = (UnityEngine_Material_o *)sub_1B71818(UnityEngine_Material_TypeInfo);
  ...
  UnityEngine_Material__SetTexture(v17, (System_String_o *)StringLiteral_16217/*"_MaskTex"*/, (UnityEngine_Texture_o *)maskTex, 0LL);
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseText;
  if ( !gameObject )
    goto LABEL_15;
