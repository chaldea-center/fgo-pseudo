void __fastcall CampaignInfoItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B31D3B & 1) == 0 )
  {
    sub_1BD3458(&CampaignInfoItem_TypeInfo, v1);
    byte_4B31D3B = 1;
  }
...
void __fastcall CampaignInfoItem__OnClick(CampaignInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B31D3A & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_CampaignInfoItem_OnClick__, v3);
    sub_1BD3458(&WebViewManager_TypeInfo, v4);
    this = (CampaignInfoItem_o *)sub_1BD3458(&StringLiteral_1/*""*/, v5);
    byte_4B31D3A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Material__SetTexture(v17, (System_String_o *)StringLiteral_16455/*"_MaskTex"*/, (UnityEngine_Texture_o *)maskTex, 0LL);
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseText;
  if ( !gameObject )
    goto LABEL_15;
