void CampaignInfoItem___cctor(const MethodInfo *method)
{
  if ( (byte_4CC10EB & 1) == 0 )
  {
    sub_1C713B0(&CampaignInfoItem_TypeInfo);
    byte_4CC10EB = 1;
  }
...
void CampaignInfoItem__OnClick(CampaignInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC10EA & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_CampaignInfoItem_OnClick__);
    sub_1C713B0(&WebViewManager_TypeInfo);
    this = (CampaignInfoItem_o *)sub_1C713B0(&StringLiteral_1/*""*/);
    byte_4CC10EA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354(&this->fields.target, info);
  ...
  UnityEngine_Material__SetTexture(v14, (System_String_o *)StringLiteral_16270/*"_MaskTex"*/, (UnityEngine_Texture_o *)maskTex, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseText;
  if ( !gameObject )
    goto LABEL_15;
