void __fastcall CampaignInfoItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1C917 & 1) == 0 )
  {
    sub_1C3B764(&CampaignInfoItem_TypeInfo, v1);
    byte_4C1C917 = 1;
  }
...
void __fastcall CampaignInfoItem__OnClick(CampaignInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1C916 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_CampaignInfoItem_OnClick__, v3);
    sub_1C3B764(&WebViewManager_TypeInfo, v4);
    this = (CampaignInfoItem_o *)sub_1C3B764(&StringLiteral_1/*""*/, v5);
    byte_4C1C916 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1C915 & 1) == 0 )
  {
    sub_1C3B764(&CampaignInfoItem_TypeInfo, info);
    sub_1C3B764(&UnityEngine_Material_TypeInfo, v11);
    sub_1C3B764(&StringLiteral_5069/*"DataTable.MinimumCapacity"*/, v12);
    sub_1C3B764(&StringLiteral_16584/*"assemblyName cannot have zero length."*/, v13);
    byte_4C1C915 = 1;
  }
  this->fields.target = info;
  sub_1C3B708(&this->fields.target);
  ...
  UnityEngine_Material__SetTexture(v17, (System_String_o *)StringLiteral_16584/*"assemblyName cannot have zero length."*/, (UnityEngine_Texture_o *)maskTex, 0LL);
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseText;
  if ( !gameObject )
    goto LABEL_15;
