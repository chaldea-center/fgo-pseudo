void CampaignInfoItem___cctor(const MethodInfo *method)
{
  if ( (byte_4C211A2 & 1) == 0 )
  {
    sub_1C2D490(&CampaignInfoItem_TypeInfo);
    byte_4C211A2 = 1;
  }
...
void CampaignInfoItem__OnClick(CampaignInfoItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C211A1 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_CampaignInfoItem_OnClick__);
    sub_1C2D490(&WebViewManager_TypeInfo);
    this = (CampaignInfoItem_o *)sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C211A1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434(&this->fields.target);
  ...
  UnityEngine_Material__SetTexture(v14, (System_String_o *)StringLiteral_16265/*"_MaskTex"*/, (UnityEngine_Texture_o *)maskTex, 0);
  gameObject = (UnityEngine_GameObject_o *)this->fields.baseText;
  if ( !gameObject )
    goto LABEL_15;
