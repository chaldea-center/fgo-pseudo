void __fastcall EventBoardGameTokenMaster___ctor(EventBoardGameTokenMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2DDF9 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_EventBoardGameTokenMaster__EventBoardGameTokenEntity__string___ctor__, method);
    byte_4A2DDF9 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    307,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_EventBoardGameTokenMaster__EventBoardGameTokenEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDFA & 1) == 0 )
  {
    ...
    sub_1B761C0(&EventBoardGameTokenEntity_TypeInfo, v6);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventBoardGameTokenEntity__Add__, v7);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventBoardGameTokenEntity__ToArray__, v8);
    sub_1B761C0(&Method_System_Collections_Generic_List_EventBoardGameTokenEntity___ctor__, v9);
    sub_1B761C0(&System_Collections_Generic_List_EventBoardGameTokenEntity__TypeInfo, v10);
    byte_4A2DDFA = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_EventBoardGameTokenEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_EventBoardGameTokenEntity___ctor__);
...
LABEL_20:
  ...
  return (EventBoardGameTokenEntity_array *)System_Collections_Generic_List_object___ToArray(
                                              v11,
                                              (const MethodInfo_34D912C *)Method_System_Collections_Generic_List_EventBoardGameTokenEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventBoardGameTokenEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                          PK,
                                          (const MethodInfo_30FFAD8 *)Method_DataMasterBase_EventBoardGameTokenMaster__EventBoardGameTokenEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_EventBoardGameTokenMaster__EventBoardGameTokenEntity__string__TryGetEntity__);
}