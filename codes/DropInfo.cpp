...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB4257 & 1) == 0 )
  {
    sub_1C13D24(&DropInfo_SaveData_TypeInfo, method);
    byte_4BB4257 = 1;
  }
  v3 = sub_1C13F70(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_38830856(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_38830908(this->fields.type, 0LL);
}
