...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B445D6 & 1) == 0 )
  {
    sub_1BDB878(&DropInfo_SaveData_TypeInfo, method);
    byte_4B445D6 = 1;
  }
  v3 = sub_1BDBAC4(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_39448816(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_39448868(this->fields.type, 0LL);
}
