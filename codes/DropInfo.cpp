...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E23C3 & 1) == 0 )
  {
    sub_1B00CCC(&DropInfo_SaveData_TypeInfo, method);
    byte_48E23C3 = 1;
  }
  v3 = sub_1B00F18(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_36488892(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_36488944(this->fields.type, 0LL);
}
