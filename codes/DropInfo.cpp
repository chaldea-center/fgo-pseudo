...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7625 & 1) == 0 )
  {
    sub_1C1ABD4(&DropInfo_SaveData_TypeInfo, method);
    byte_4BC7625 = 1;
  }
  v3 = sub_1C1AE20(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_38884012(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_38884064(this->fields.type, 0LL);
}
