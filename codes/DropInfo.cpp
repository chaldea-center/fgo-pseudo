...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21AD2 & 1) == 0 )
  {
    sub_1C3B764(&DropInfo_SaveData_TypeInfo, method);
    byte_4C21AD2 = 1;
  }
  v3 = sub_1C3B9B0(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_39108536(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_39108588(this->fields.type, 0LL);
}
