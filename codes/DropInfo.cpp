...
DropInfo_SaveData_o *DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5687A & 1) == 0 )
  {
    sub_1C3E564(&DropInfo_SaveData_TypeInfo);
    byte_4C5687A = 1;
  }
  v3 = sub_1C3E7B0(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_40473368(this->fields.type, 0);
}


bool DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_40473420(this->fields.type, 0);
}
