...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6672B & 1) == 0 )
  {
    sub_1BE4ACC(&DropInfo_SaveData_TypeInfo, method);
    byte_4B6672B = 1;
  }
  v3 = sub_1BE4D18(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_38593312(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_38593364(this->fields.type, 0LL);
}
