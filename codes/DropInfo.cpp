...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36D12 & 1) == 0 )
  {
    sub_1BD3458(&DropInfo_SaveData_TypeInfo, method);
    byte_4B36D12 = 1;
  }
  v3 = sub_1BD36A4(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_38469552(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_38469604(this->fields.type, 0LL);
}
