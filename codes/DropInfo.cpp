...
LABEL_7:
    ...
    sub_1C6BC60(dropEffectId, dropAddMaster);
  }
  return (int)dropEffectId;
}
...
DropInfo_SaveData_o *DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB5DDA & 1) == 0 )
  {
    sub_1C6BA08(&DropInfo_SaveData_TypeInfo);
    byte_4CB5DDA = 1;
  }
  v3 = sub_1C6BC54(DropInfo_SaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !entity )
LABEL_7:
    sub_1C6BC60(this, dropAddMaster);
...
{
  return Gift__IsItem_40656752(this->fields.type, 0);
}


bool DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_40656804(this->fields.type, 0);
}
