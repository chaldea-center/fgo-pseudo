...
DropInfo_SaveData_o *__fastcall DropInfo__GetSaveData(DropInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A087F9 & 1) == 0 )
  {
    sub_1B686D4(&DropInfo_SaveData_TypeInfo, method);
    byte_4A087F9 = 1;
  }
  v3 = sub_1B68920(DropInfo_SaveData_TypeInfo);
...
{
  return Gift__IsItem_37438228(this->fields.type, 0LL);
}


bool __fastcall DropInfo__isServant(DropInfo_o *this, const MethodInfo *method)
{
  return Gift__IsServant_37438280(this->fields.type, 0LL);
}
