void __fastcall TreasureDvcInfo___ctor(TreasureDvcInfo_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.id = 0LL;
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.name, (int64_t)v3, v4, v5, v6, v7, v8, v9);
  v10 = StringLiteral_1/*""*/;
...
System_String_o *__fastcall TreasureDvcInfo__GetName(TreasureDvcInfo_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4C23281 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_TreasureDvcMaster___, *(_QWORD *)&svtId);
    ...
    sub_1C3B764(&StringLiteral_9519/*"OTHER_USER_SORT_PRIORITY_KIND_NONE"*/, v8);
    byte_4C23281 = 1;
  }
  if ( this->fields.id < 1 )
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_8:
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_9519/*"OTHER_USER_SORT_PRIORITY_KIND_NONE"*/, 0LL);
