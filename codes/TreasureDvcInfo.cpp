void __fastcall TreasureDvcInfo___ctor(TreasureDvcInfo_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.id = 0LL;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.name, v3, v4, v5);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)p_explanation, v6, v8, v9);
  p_explanation[1] = 0LL;
  p_explanation[2] = 0LL;
...
System_String_o *__fastcall TreasureDvcInfo__GetName(TreasureDvcInfo_o *this, int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A09E75 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_TreasureDvcMaster___, *(_QWORD *)&svtId);
    ...
    sub_1B686D4(&StringLiteral_9292/*"NP_NAME"*/, v8);
    byte_4A09E75 = 1;
  }
  if ( this->fields.id < 1 )
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_8:
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_9292/*"NP_NAME"*/, 0LL);
