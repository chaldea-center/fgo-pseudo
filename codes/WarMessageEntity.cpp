void __fastcall WarMessageEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FF568 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_HashSet_string___ctor__, v1);
    sub_1B64870(&System_Collections_Generic_HashSet_string__TypeInfo, v4);
    sub_1B64870(&WarMessageEntity_TypeInfo, v5);
    sub_1B64870(&StringLiteral_15426/*"WAR_MESSAGE_{0}_{1}"*/, v6);
    byte_49FF568 = 1;
  }
  ...
  sub_1B64814(
    ...
    v2,
    v3);
  v7 = (System_Collections_Generic_HashSet_T__o *)sub_1B64ABC(System_Collections_Generic_HashSet_string__TypeInfo);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->checkList, (int32_t)v7, v9, v10);
}
...
bool __fastcall WarMessageEntity__CheckFrequencyCondition(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF563 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_HashSet_string__Contains__, method);
    sub_1B64870(&WarMessageEntity_TypeInfo, v3);
    byte_49FF563 = 1;
  }
  v4 = 1;
...
System_String_o *__fastcall WarMessageEntity__CreatePrimaryKey(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF565 & 1) == 0 )
  {
    sub_1B64870(&WarMessageEntity_TypeInfo, method);
    byte_49FF565 = 1;
  }
...
bool __fastcall WarMessageEntity__IsNotClearedStartQuest(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( klass == 2 )
  {
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return !CondType__IsQuestClear_37290360((int32_t)monitor, -1, 0, 0LL);
  }
  if ( klass != 1 )
    return 0;
  warId = this->fields.warId;
...
void __fastcall WarMessageEntity__Save(WarMessageEntity_o *this, bool isDecided, const MethodInfo *method)
{
  ...
  if ( (byte_49FF561 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_HashSet_string__Add__, isDecided);
    sub_1B64870(&WarMessageEntity_TypeInfo, v5);
    byte_49FF561 = 1;
  }
  if ( isDecided )
...
System_String_o *__fastcall WarMessageEntity__get_SaveKey(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF560 & 1) == 0 )
  {
    ...
    sub_1B64870(&WarMessageEntity_TypeInfo, v6);
    byte_49FF560 = 1;
  }
  ...
  return System_String__Format_61397948(SAVE_KEY_FORMAT, v9, v13, 0LL);
}