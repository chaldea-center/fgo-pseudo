void WarMessageEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC868B & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_15483/*"WAR_MESSAGE_{0}_{1}"*/);
    byte_4CC868B = 1;
  }
  WarMessageEntity_TypeInfo->static_fields->SAVE_KEY_FORMAT = (struct System_String_o *)StringLiteral_15483/*"WAR_MESSAGE_{0}_{1}"*/;
  sub_1C71354(
    (GrandQuestFolderBoardItem_o *)WarMessageEntity_TypeInfo->static_fields,
    StringLiteral_15483/*"WAR_MESSAGE_{0}_{1}"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = (System_Collections_Generic_HashSet_T__o *)sub_1C715FC(System_Collections_Generic_HashSet_string__TypeInfo);
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&static_fields->checkList, (int32_t)v7, v9, v10, v11, v12, v13, v14);
}
...
bool WarMessageEntity__IsNotClearedStartQuest(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Instance = DataMasterBase_object__object__int___GetEntity(
                     ...
                     this->fields.warId,
                     (const MethodInfo_3408E80 *)Method_DataMasterBase_WarMaster__WarEntity__int__GetEntity__)) == 0 )
  {
  ...
  if ( klass == 2 )
  {
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return !CondType__IsQuestClear_40596552((int32_t)monitor, -1, 0, 0);
  }
  if ( klass != 1 )
    return 1;
  warId = this->fields.warId;
...
System_String_o *WarMessageEntity__get_SaveKey(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  return System_String__Format_64073032(SAVE_KEY_FORMAT, v5, v6, 0);
}