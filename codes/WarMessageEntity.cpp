void WarMessageEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB7562 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_15477/*"WAR_MESSAGE_{0}_{1}"*/);
    byte_4CB7562 = 1;
  }
  WarMessageEntity_TypeInfo->static_fields->SAVE_KEY_FORMAT = (struct System_String_o *)StringLiteral_15477/*"WAR_MESSAGE_{0}_{1}"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)WarMessageEntity_TypeInfo->static_fields, StringLiteral_15477/*"WAR_MESSAGE_{0}_{1}"*/, v1, v2);
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->checkList, (int32_t)v3, v5, v6);
}
...
bool WarMessageEntity__IsNotClearedStartQuest(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( klass == 2 )
  {
    ...
    if ( !CondType_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
    return !CondType__IsQuestClear_40554260((int32_t)monitor, -1, 0, 0);
  }
  if ( klass != 1 )
    return 1;
  warId = this->fields.warId;
...
System_String_o *WarMessageEntity__get_SaveKey(WarMessageEntity_o *this, const MethodInfo *method)
{
  ...
  return System_String__Format_64008100(SAVE_KEY_FORMAT, v5, v6, 0);
}