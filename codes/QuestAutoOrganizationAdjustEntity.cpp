...
float __fastcall QuestAutoOrganizationAdjustEntity__GetAdjustRate_40032040(
        QuestAutoOrganizationAdjustEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB2F4 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Linq_Enumerable_Contains_int___, individualities);
    byte_49BB2F4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB2F3 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, targetUserSvtId);
  ...
  *(_QWORD *)&v27.fields.fakeValue = monitor;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47008572(v27, 0LL);
  if ( !v14 )
LABEL_25:
  ...
  *(_QWORD *)&v28.fields.fakeValue = v18;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47008572(v28, 0LL);
  if ( !entity )
    goto LABEL_25;
  ...
  v22 = v25;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47008572(
