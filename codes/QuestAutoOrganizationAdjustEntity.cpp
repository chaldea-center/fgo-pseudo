...
float __fastcall QuestAutoOrganizationAdjustEntity__GetAdjustRate_40458192(
        QuestAutoOrganizationAdjustEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E930 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_Contains_int___, individualities);
    byte_4A4E930 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E92F & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, targetUserSvtId);
  ...
  *(_QWORD *)&v27.fields.fakeValue = monitor;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v27, 0LL);
  if ( !v14 )
LABEL_25:
  ...
  *(_QWORD *)&v28.fields.fakeValue = v18;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v28, 0LL);
  if ( !entity )
    goto LABEL_25;
  ...
  v22 = v25;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(
