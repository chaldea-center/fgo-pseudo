...
float __fastcall QuestAutoOrganizationAdjustEntity__GetAdjustRate_40724356(
        QuestAutoOrganizationAdjustEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v20.fields.fakeValue = monitor;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v20, 0LL);
  if ( !v7 )
LABEL_25:
  ...
  *(_QWORD *)&v21.fields.fakeValue = v11;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v21, 0LL);
  if ( !entity )
    goto LABEL_25;
  ...
  v15 = v18;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(
                                    (CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o)entity[6],
                                    0LL);
  if ( !v15 )
    goto LABEL_25;
  return ServantEntity__IsIndividuality(v15, (int32_t)Master_object, v14, this->fields.individuality, 0LL);
}