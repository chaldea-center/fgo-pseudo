...
float __fastcall QuestAutoOrganizationAdjustEntity__GetAdjustRate_40909736(
        QuestAutoOrganizationAdjustEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C223CA & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Linq_Enumerable_Contains_int___, individualities);
    byte_4C223CA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C223C9 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, targetUserSvtId);
  ...
  *(_QWORD *)&v27.fields.fakeValue = monitor;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v27, 0LL);
  if ( !v14 )
LABEL_25:
  ...
  *(_QWORD *)&v28.fields.fakeValue = v18;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v28, 0LL);
  if ( !entity )
    goto LABEL_25;
  ...
  v22 = v25;
  Master_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(
