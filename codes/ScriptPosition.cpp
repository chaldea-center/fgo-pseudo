void __fastcall ScriptPosition___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_43578D7 & 1) == 0 )
  {
    sub_B70694(&ScriptPosition_TypeInfo);
    sub_B70694(&UnityEngine_Vector2___TypeInfo);
    byte_43578D7 = 1;
  }
  v1 = sub_B706AC(UnityEngine_Vector2___TypeInfo, 7LL);
  if ( !v1 )
    goto LABEL_17;
  v9 = *(_DWORD *)(v1 + 24);
...
LABEL_16:
  ...
  *(_QWORD *)(v1 + 80) = 1140850688LL;
  ...
  v1 = sub_B706AC(UnityEngine_Vector2___TypeInfo, 3LL);
  if ( !v1 )
LABEL_17:
    sub_B7076C(v1, v2);
  v18 = *(_DWORD *)(v1 + 24);
  ...
  *(_QWORD *)(v1 + 48) = 0LL;
  ...
  sub_B70630((BattleServantConfConponent_o *)&v20->charaOffsetList, v19, v12, v13, v14, v15, v16, v17);
}
...
UnityEngine_Vector3_o __fastcall ScriptPosition__GetCharaOffset_34916076(float x, float y, const MethodInfo *method)
{
  float v3; // s2
  UnityEngine_Vector3_o result; // 0:s0.4,4:s1.4,8:s2.4
...
UnityEngine_Vector3_o __fastcall ScriptPosition__GetPosition_34915860(float x, float y, const MethodInfo *method)
{
  float v3; // s2
  UnityEngine_Vector3_o result; // 0:s0.4,4:s1.4,8:s2.4
