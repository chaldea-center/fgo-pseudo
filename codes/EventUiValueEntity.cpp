void __fastcall EventUiValueEntity___ctor(EventUiValueEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.id = 0LL;
  ...
  sub_B2C2F8((BattleServantConfConponent_o *)&this->fields.value, v4, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  if ( (byte_41882AF & 1) == 0 )
  {
    sub_B2C35C(&Method_DataEntityBase_CreateMultiplePK_long__long__string___, *(_QWORD *)&type);
    byte_41882AF = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__string_(
           ...
           type,
           value,
           (const MethodInfo_1732F28 *)Method_DataEntityBase_CreateMultiplePK_long__long__string___);
}
