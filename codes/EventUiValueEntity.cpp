void __fastcall EventUiValueEntity___ctor(EventUiValueEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.id = 0LL;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_value, v4, v6, v7);
  *((_DWORD *)p_value + 2) = 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_49FE714 & 1) == 0 )
  {
    sub_1B64870(&Method_DataEntityBase_CreateMultiplePK_long__long__string___, *(_QWORD *)&type);
    byte_49FE714 = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object_(
           ...
           type,
           (Il2CppObject *)value,
           (const MethodInfo_2E39FCC *)Method_DataEntityBase_CreateMultiplePK_long__long__string___);
}
