void __fastcall EventUiValueEntity___ctor(EventUiValueEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.id = 0LL;
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)p_value, (int64_t)v4, v6, v7, v8, v9, v10, v11);
  *((_DWORD *)p_value + 2) = 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B373AC & 1) == 0 )
  {
    sub_1BD3458(&Method_DataEntityBase_CreateMultiplePK_long__long__string___, *(_QWORD *)&type);
    byte_4B373AC = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object_(
           ...
           type,
           (Il2CppObject *)value,
           (const MethodInfo_2F2FF88 *)Method_DataEntityBase_CreateMultiplePK_long__long__string___);
}
