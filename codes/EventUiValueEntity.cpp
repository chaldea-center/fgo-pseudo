void __fastcall EventUiValueEntity___ctor(EventUiValueEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.id = 0LL;
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields.value, v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  if ( (byte_42AF8DE & 1) == 0 )
  {
    sub_B52984(&Method_DataEntityBase_CreateMultiplePK_long__long__string___);
    byte_42AF8DE = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__string_(
           ...
           type,
           value,
           (const MethodInfo_1A4E6C0 *)Method_DataEntityBase_CreateMultiplePK_long__long__string___);
}
