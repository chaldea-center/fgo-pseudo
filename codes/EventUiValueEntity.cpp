void EventUiValueEntity___ctor(EventUiValueEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.id = 0;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)p_value, v3, v5, v6);
  *((_DWORD *)p_value + 2) = 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C37BED & 1) == 0 )
  {
    sub_1C32C20(&Method_DataEntityBase_CreateMultiplePK_long__long__string___);
    byte_4C37BED = 1;
  }
  return DataEntityBase__CreateMultiplePK_long__long__object_(
           ...
           type,
           (Il2CppObject *)value,
           (const MethodInfo_30DBC58 *)Method_DataEntityBase_CreateMultiplePK_long__long__string___);
}
