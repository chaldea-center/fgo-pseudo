void __fastcall TreasureBoxMaster___ctor(TreasureBoxMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B2343 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_TreasureBoxMaster__TreasureBoxEntity__int___ctor__);
    byte_42B2343 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    375,
    (const MethodInfo_23E223C *)Method_DataMasterBase_TreasureBoxMaster__TreasureBoxEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2344 & 1) == 0 )
  {
    ...
    sub_B52984(&TreasureBoxEntity_TypeInfo);
    byte_42B2344 = 1;
  }
