void __fastcall DeckWaveServantData___ctor(DeckWaveServantData_o *this, const MethodInfo *method)
{
  ...
  v5 = (struct System_Int32_array *)sub_1B6877C(int___TypeInfo, (unsigned int)v4->static_fields->DeckMainMemberMax);
  this->fields.uniqueIds = v5;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.uniqueIds, (int32_t)v5, v6, v7);
}