        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E7104 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_23313/*"userEquipId"*/, deckNo, userEquipId, method);
    sub_B5D5C4(&StringLiteral_18149/*"deckNo"*/, v7, v8, v9);
    byte_42E7104 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18149/*"deckNo"*/, deckNo, 0LL);
...
System_String_o *__fastcall UserFormationRequest__getURL(UserFormationRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B5D5C4(&NetworkManager_TypeInfo, (_DWORD)method, v2, v3);
    sub_B5D5C4(&StringLiteral_23385/*"userformation/Setup"*/, v4, v5, v6);
    byte_42E7102 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_23385/*"userformation/Setup"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(15, responseList, 0LL);
