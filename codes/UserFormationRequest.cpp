        ...
        const MethodInfo *method)
{
  if ( (byte_42AEF0C & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18055/*"deckNo"*/);
    byte_42AEF0C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18055/*"deckNo"*/, deckNo, 0LL);
...
System_String_o *__fastcall UserFormationRequest__getURL(UserFormationRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&NetworkManager_TypeInfo);
    sub_B52984(&StringLiteral_23269/*"userformation/Setup"*/);
    byte_42AEF0A = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_23269/*"userformation/Setup"*/, 0LL);
}
