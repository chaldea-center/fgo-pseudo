        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDD7F & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_24288/*"userEquipId"*/, *(_QWORD *)&deckNo);
    sub_1B640C8(&StringLiteral_18452/*"deckNo"*/, v7);
    byte_49FDD7F = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18452/*"deckNo"*/, deckNo, method);
  RequestBase__addField_40849372((RequestBase_o *)this, (System_String_o *)StringLiteral_24288/*"userEquipId"*/, userEquipId, v8);
...
System_String_o *__fastcall UserFormationRequest__getURL(UserFormationRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&NetworkManager_TypeInfo, method);
    sub_1B640C8(&StringLiteral_24366/*"userformation/Setup"*/, v2);
    byte_49FDD7D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_24366/*"userformation/Setup"*/, 0LL);
}
