        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42136F0 & 1) == 0 )
  {
    sub_B0D8A4(&StringLiteral_23084/*"userEquipId"*/, *(_QWORD *)&deckNo);
    sub_B0D8A4(&StringLiteral_17983/*"deckNo"*/, v7);
    byte_42136F0 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17983/*"deckNo"*/, deckNo, 0LL);
...
System_String_o *__fastcall UserFormationRequest__getURL(UserFormationRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B0D8A4(&NetworkManager_TypeInfo, method);
    sub_B0D8A4(&StringLiteral_23155/*"userformation/Setup"*/, v2);
    byte_42136EE = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_23155/*"userformation/Setup"*/, 0LL);
}
