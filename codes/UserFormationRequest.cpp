        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9506 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_24806/*"userEquipId"*/, *(_QWORD *)&deckNo);
    sub_1C1ABD4(&StringLiteral_18823/*"deckNo"*/, v7);
    byte_4BC9506 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18823/*"deckNo"*/, deckNo, 0LL);
...
System_String_o *__fastcall UserFormationRequest__getURL(UserFormationRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&NetworkManager_TypeInfo, method);
    sub_1C1ABD4(&StringLiteral_24885/*"userformation/Setup"*/, v2);
    byte_4BC9504 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_24885/*"userformation/Setup"*/, 0LL);
}
