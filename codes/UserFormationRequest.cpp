        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F96B9 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_22915/*"userEquipId"*/, *(_QWORD *)&deckNo);
    sub_B16FFC(&StringLiteral_17859/*"deckNo"*/, v7);
    byte_40F96B9 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17859/*"deckNo"*/, deckNo, 0LL);
...
System_String_o *__fastcall UserFormationRequest__getURL(UserFormationRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B16FFC(&NetworkManager_TypeInfo, method);
    sub_B16FFC(&StringLiteral_22985/*"userformation/Setup"*/, v2);
    byte_40F96B7 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_22985/*"userformation/Setup"*/, 0LL);
}
