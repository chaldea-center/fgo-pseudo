        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34C6E & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_Component_GetComponent_TweenColor___, item);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v7);
    sub_1BD3458(&StringLiteral_20812/*"img_txt_myroom"*/, v8);
    sub_1BD3458(&StringLiteral_20818/*"img_txt_other"*/, v9);
    sub_1BD3458(&StringLiteral_20754/*"img_txt_battle"*/, v10);
    this = (ServantStatusVoiceListViewItemDraw_o *)sub_1BD3458(&StringLiteral_20846/*"img_txt_synthesis"*/, v11);
    byte_4B34C6E = 1;
  }
  if ( item && mode )
  {
    ...
    v14 = (System_String_o **)(v13 > 8 ? &StringLiteral_20818/*"img_txt_other"*/ : (&off_4579340)[v13]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD36B4(playIconSprite, item);
  }
  if ( item->fields.isPlay || !item->fields.isCanPlay )
  {
    v5 = 1.0;
