        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A063ED & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_Component_GetComponent_TweenColor___, item);
    sub_1B686D4(&UnityEngine_Object_TypeInfo, v7);
    sub_1B686D4(&StringLiteral_20489/*"img_txt_myroom"*/, v8);
    sub_1B686D4(&StringLiteral_20495/*"img_txt_other"*/, v9);
    sub_1B686D4(&StringLiteral_20431/*"img_txt_battle"*/, v10);
    this = (ServantStatusVoiceListViewItemDraw_o *)sub_1B686D4(&StringLiteral_20522/*"img_txt_synthesis"*/, v11);
    byte_4A063ED = 1;
  }
  if ( item && mode )
  {
    ...
    v14 = (System_String_o **)(v13 > 8 ? &StringLiteral_20495/*"img_txt_other"*/ : (&off_4463308)[v13]);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B68930(playIconSprite, item);
  }
  if ( item->fields.isPlay || !item->fields.isCanPlay )
  {
    v5 = 1.0;
