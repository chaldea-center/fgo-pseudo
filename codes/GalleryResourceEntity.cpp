        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB14E & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_1055/*".usm"*/, method);
    byte_49BB14E = 1;
  }
  path = 0LL;
  ...
  if ( GalleryType__IsMovie(this->fields.galleryType, 0LL) && !System_String__IsNullOrEmpty(assetPath, 0LL) )
    return System_String__Concat_61093468(assetPath, (System_String_o *)StringLiteral_1055/*".usm"*/, 0LL);
  return assetPath;
}
...
int32_t __fastcall GalleryResourceEntity__GetWarId(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB14F & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_GalleryMaster___, method);
    sub_1B4CF90(&DataManager_TypeInfo, v3);
    sub_1B4CF90(&Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__, v4);
    byte_49BB14F = 1;
  }
  entity = 0LL;
  ...
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    (const MethodInfo_319D9E8 *)Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  if ( (byte_49BB14B & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_24622/*"zoomRateMax"*/, method);
    byte_49BB14B = 1;
  }
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_24622/*"zoomRateMax"*/, defaultValue, 0LL)
       / 1000.0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB14C & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_20975/*"maleAssetPath"*/, path);
    byte_49BB14C = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_20975/*"maleAssetPath"*/, 0LL, 0LL);
  *path = StringValue;
  sub_1B4CF34((CGThumbnailListItem_o *)path, (int32_t)StringValue, v6, v7);
  return *path != 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB14D & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_20977/*"maleObjectName"*/, name);
    byte_49BB14D = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_20977/*"maleObjectName"*/, 0LL, 0LL);
  *name = StringValue;
  sub_1B4CF34((CGThumbnailListItem_o *)name, (int32_t)StringValue, v6, v7);
  return *name != 0LL;
}