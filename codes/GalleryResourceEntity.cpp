...
System_String_o *GalleryResourceEntity__GetAssetPath(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  {
    return System_String__Concat_65122828(assetPath, (System_String_o *)StringLiteral_1041/*".usm"*/, 0);
  }
  return assetPath;
}
...
int32_t GalleryResourceEntity__GetDownloadType(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04E2B & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_18893/*"downloadType"*/);
    byte_4E04E2B = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18893/*"downloadType"*/, 0, 0);
}
...
System_String_o *GalleryResourceEntity__GetTitleName(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04E29 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_8653/*"MATERIAL_MAP_QUEST_TITLE"*/);
  ...
  if ( !GalleryResourceEntity__TryGetOverWriteTitleName(this, &titleName, v2) )
  {
    ...
    if ( !Master_object
      || (Master_object = DataMasterBase_object__object__int___GetEntity(
                            ...
                            this->fields.questId,
                            (const MethodInfo_34E925C *)Method_DataMasterBase_QuestMaster__QuestEntity__int__GetEntity__)) == 0 )
    {
    ...
    if ( v6->fields.chapterSubId >= 1 )
    {
      ...
      if ( !System_String__IsNullOrEmpty((System_String_o *)ChapterSubStr, 0) )
      {
        ...
        v10 = LocalizationManager__Get((System_String_o *)StringLiteral_8653/*"MATERIAL_MAP_QUEST_TITLE"*/, 0);
        return System_String__Format_65164136(v10, ChapterSubStr, (Il2CppObject *)titleName, 0);
      }
    }
  }
  return titleName;
...
int32_t GalleryResourceEntity__GetWarId(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E04E2A & 1) == 0 )
  {
    sub_1CE6700(&Method_DataManager_GetMaster_GalleryMaster___);
    sub_1CE6700(&DataManager_TypeInfo);
    sub_1CE6700(&Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__);
    byte_4E04E2A = 1;
  }
  entity = 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_GalleryMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    (const MethodInfo_34E92A8 *)Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04E24 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_25442/*"zoomRateMax"*/);
    byte_4E04E24 = 1;
  }
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_25442/*"zoomRateMax"*/, defaultValue, 0)
       / 1000.0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04E25 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_21742/*"maleAssetPath"*/);
    byte_4E04E25 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21742/*"maleAssetPath"*/, 0, 0);
  *path = StringValue;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)path, (int32_t)StringValue, v6, v7, v8, v9, v10, v11);
  return *path != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04E26 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_21745/*"maleObjectName"*/);
    byte_4E04E26 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21745/*"maleObjectName"*/, 0, 0);
  *name = StringValue;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)name, (int32_t)StringValue, v6, v7, v8, v9, v10, v11);
  return *name != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04E27 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_22865/*"overWriteTitleName"*/);
    byte_4E04E27 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_22865/*"overWriteTitleName"*/, 0, 0);
  *titleName = StringValue;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)titleName, (int32_t)StringValue, v6, v7, v8, v9, v10, v11);
