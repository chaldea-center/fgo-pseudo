...
System_String_o *GalleryResourceEntity__GetAssetPath(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  {
    return System_String__Concat_64176912(assetPath, (System_String_o *)StringLiteral_1040/*".usm"*/, 0);
  }
  return assetPath;
}
...
int32_t GalleryResourceEntity__GetDownloadType(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CEEA7F & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_18782/*"downloadType"*/);
    byte_4CEEA7F = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18782/*"downloadType"*/, 0, 0);
}
...
System_String_o *GalleryResourceEntity__GetTitleName(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEEA7D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_8611/*"MATERIAL_MAP_QUEST_TITLE"*/);
  ...
  if ( !GalleryResourceEntity__TryGetOverWriteTitleName(this, &titleName, v2) )
  {
    ...
    if ( !Master_object
      || (Master_object = DataMasterBase_object__object__int___GetEntity(
                            ...
                            this->fields.questId,
                            (const MethodInfo_342E2FC *)Method_DataMasterBase_QuestMaster__QuestEntity__int__GetEntity__)) == 0 )
    {
    ...
    if ( v6->fields.chapterSubId >= 1 )
    {
      ...
      if ( !System_String__IsNullOrEmpty((System_String_o *)ChapterSubStr, 0) )
      {
        ...
        v10 = LocalizationManager__Get((System_String_o *)StringLiteral_8611/*"MATERIAL_MAP_QUEST_TITLE"*/, 0);
        return System_String__Format_64218220(v10, ChapterSubStr, (Il2CppObject *)titleName, 0);
      }
    }
  }
  return titleName;
...
int32_t GalleryResourceEntity__GetWarId(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEEA7E & 1) == 0 )
  {
    sub_1C7BAE8(&Method_DataManager_GetMaster_GalleryMaster___);
    sub_1C7BAE8(&DataManager_TypeInfo);
    sub_1C7BAE8(&Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__);
    byte_4CEEA7E = 1;
  }
  entity = 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_31703A0 *)Method_DataManager_GetMaster_GalleryMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    (const MethodInfo_342E348 *)Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  if ( (byte_4CEEA78 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_25285/*"zoomRateMax"*/);
    byte_4CEEA78 = 1;
  }
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_25285/*"zoomRateMax"*/, defaultValue, 0)
       / 1000.0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEEA79 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_21607/*"maleAssetPath"*/);
    byte_4CEEA79 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21607/*"maleAssetPath"*/, 0, 0);
  *path = StringValue;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)path, (int32_t)StringValue, v6, v7, v8, v9, v10, v11);
  return *path != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEEA7A & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_21610/*"maleObjectName"*/);
    byte_4CEEA7A = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21610/*"maleObjectName"*/, 0, 0);
  *name = StringValue;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)name, (int32_t)StringValue, v6, v7, v8, v9, v10, v11);
  return *name != 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEEA7B & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_22727/*"overWriteTitleName"*/);
    byte_4CEEA7B = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_22727/*"overWriteTitleName"*/, 0, 0);
  *titleName = StringValue;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)titleName, (int32_t)StringValue, v6, v7, v8, v9, v10, v11);
