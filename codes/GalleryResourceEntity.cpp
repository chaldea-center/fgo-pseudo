        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02311 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_1037/*".usm"*/, method);
    byte_4B02311 = 1;
  }
  path = 0LL;
  ...
  if ( GalleryType__IsMovie(this->fields.galleryType, 0LL) && !System_String__IsNullOrEmpty(assetPath, 0LL) )
    return System_String__Concat_62348648(assetPath, (System_String_o *)StringLiteral_1037/*".usm"*/, 0LL);
  return assetPath;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02312 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_8506/*"MATERIAL_MAP_QUEST_TITLE"*/, v7);
  ...
  if ( !GalleryResourceEntity__TryGetOverWriteTitleName(this, &titleName, v2) )
  {
    ...
    if ( !Master_object
      || (Master_object = DataMasterBase_object__object__int___GetEntity(
                            ...
                            this->fields.questId,
                            (const MethodInfo_32AF070 *)Method_DataMasterBase_QuestMaster__QuestEntity__int__GetEntity__)) == 0LL )
    {
    ...
    if ( v11->fields.chapterSubId >= 1 )
    {
      ...
      if ( !System_String__IsNullOrEmpty((System_String_o *)ChapterSubStr, 0LL) )
      {
        ...
        v15 = LocalizationManager__Get((System_String_o *)StringLiteral_8506/*"MATERIAL_MAP_QUEST_TITLE"*/, 0LL);
        return System_String__Format_62389940(v15, ChapterSubStr, (Il2CppObject *)titleName, 0LL);
      }
    }
  }
  return titleName;
...
int32_t __fastcall GalleryResourceEntity__GetWarId(GalleryResourceEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B02313 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_GalleryMaster___, method);
    sub_1BC3008(&DataManager_TypeInfo, v3);
    sub_1BC3008(&Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__, v4);
    byte_4B02313 = 1;
  }
  entity = 0LL;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_GalleryMaster___);
  if ( !Master_object )
    goto LABEL_11;
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    (const MethodInfo_32AF0BC *)Method_DataMasterBase_GalleryMaster__GalleryEntity__int__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B0230D & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_24789/*"zoomRateMax"*/, method);
    byte_4B0230D = 1;
  }
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_24789/*"zoomRateMax"*/, defaultValue, 0LL)
       / 1000.0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0230E & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_21197/*"maleAssetPath"*/, path);
    byte_4B0230E = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21197/*"maleAssetPath"*/, 0LL, 0LL);
  *path = StringValue;
  sub_1BC2FAC((CGThumbnailListItem_o *)path, (int32_t)StringValue, v6, v7);
  return *path != 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0230F & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_21199/*"maleObjectName"*/, name);
    byte_4B0230F = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21199/*"maleObjectName"*/, 0LL, 0LL);
  *name = StringValue;
  sub_1BC2FAC((CGThumbnailListItem_o *)name, (int32_t)StringValue, v6, v7);
  return *name != 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02310 & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_22298/*"overWriteTitleName"*/, titleName);
    byte_4B02310 = 1;
  }
  StringValue = EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_22298/*"overWriteTitleName"*/, 0LL, 0LL);
  *titleName = StringValue;
  sub_1BC2FAC((CGThumbnailListItem_o *)titleName, (int32_t)StringValue, v6, v7);
