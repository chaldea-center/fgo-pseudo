void __fastcall BattleRandomSwitchObj___ctor(BattleRandomSwitchObj_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0B38F & 1) == 0 )
  {
    sub_1B686D4(&BattleRandomSwitchObj_SwitchData___TypeInfo, method);
    byte_4A0B38F = 1;
  }
  v3 = (struct BattleRandomSwitchObj_SwitchData_array *)sub_1B6877C(BattleRandomSwitchObj_SwitchData___TypeInfo, 2LL);
  this->fields.switchDataArray = v3;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.switchDataArray, (int32_t)v3, v4, v5);
...
void __fastcall BattleRandomSwitchObj__Execution(BattleRandomSwitchObj_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0B38E & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_System_Array_ForEach_GameObject___, v3);
    sub_1B686D4(&Method_BattleRandomSwitchObj___c__DisplayClass3_0__Execution_b__0__, v4);
    sub_1B686D4(&BattleRandomSwitchObj___c__DisplayClass3_0_TypeInfo, v5);
    sub_1B686D4(&Method_BattleRandomSwitchObj___c__DisplayClass3_1__Execution_b__1__, v6);
    sub_1B686D4(&BattleRandomSwitchObj___c__DisplayClass3_1_TypeInfo, v7);
    sub_1B686D4(&Method_WeightRate_int___ctor__, v8);
    sub_1B686D4(&Method_WeightRate_int__getData__, v9);
    sub_1B686D4(&Method_WeightRate_int__getTotalWeight__, v10);
    sub_1B686D4(&Method_WeightRate_int__setWeight__, v11);
    sub_1B686D4(&WeightRate_int__TypeInfo, v12);
    byte_4A0B38E = 1;
  }
  v13 = sub_1B68920(BattleRandomSwitchObj___c__DisplayClass3_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v13, 0LL);
  if ( !v13 )
    goto LABEL_20;
  *(_QWORD *)(v13 + 16) = this;
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v13 + 16), (int32_t)this, v16, v17);
  v18 = (WeightRate_int__o *)sub_1B68920(WeightRate_int__TypeInfo);
  WeightRate_int____ctor(v18, (const MethodInfo_3897640 *)Method_WeightRate_int___ctor__);
  v19 = sub_1B68920(BattleRandomSwitchObj___c__DisplayClass3_1_TypeInfo);
  ...
  *(_DWORD *)(v19 + 16) = 0;
      ...
      if ( v25 )
      {
        ...
        if ( objs )
        {
          ...
          System_Array__ForEach_object_(
            ...
            (const MethodInfo_2F42570 *)Method_System_Array_ForEach_GameObject___);
          v23 = *(_DWORD *)(v19 + 16) + 1;
          *(_DWORD *)(v19 + 16) = v23;
          switchDataArray = this->fields.switchDataArray;
          if ( switchDataArray )
  ...
  if ( !v18 )
    goto LABEL_20;
  v29 = UnityEngine_Random__Range_69131556(0, v18->fields.totalweight, 0LL);
  Data = WeightRate_int___getData(v18, v29, (const MethodInfo_3896FD0 *)Method_WeightRate_int__getData__);
  *(_DWORD *)(v13 + 24) = Data;
...
LABEL_21:
    sub_1B68938(Data, v15);
  v31 = (System_Object_array *)v30->m_Items[(int)Data].fields.objs;
  if ( !v31 )
LABEL_20:
    sub_1B68930(Data, v15);
  v32 = (System_Action_object__o *)sub_1B68920(System_Action_GameObject__TypeInfo);
  System_Action_object____ctor(
    v32,
    (Il2CppObject *)v13,
