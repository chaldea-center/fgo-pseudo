void BattleRandomSwitchObj___ctor(BattleRandomSwitchObj_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A514 & 1) == 0 )
  {
    sub_1C32C20(&BattleRandomSwitchObj_SwitchData___TypeInfo);
    byte_4C3A514 = 1;
  }
  v3 = (struct BattleRandomSwitchObj_SwitchData_array *)sub_1C32CC8(BattleRandomSwitchObj_SwitchData___TypeInfo, 2);
  this->fields.switchDataArray = v3;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.switchDataArray, (int32_t)v3, v4, v5);
...
void BattleRandomSwitchObj__Execution(BattleRandomSwitchObj_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A513 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Array_ForEach_GameObject___);
    sub_1C32C20(&Method_BattleRandomSwitchObj___c__DisplayClass3_0__Execution_b__0__);
    sub_1C32C20(&BattleRandomSwitchObj___c__DisplayClass3_0_TypeInfo);
    sub_1C32C20(&Method_BattleRandomSwitchObj___c__DisplayClass3_1__Execution_b__1__);
    sub_1C32C20(&BattleRandomSwitchObj___c__DisplayClass3_1_TypeInfo);
  ...
  v3 = sub_1C32E6C(BattleRandomSwitchObj___c__DisplayClass3_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v3, 0);
  if ( !v3 )
    goto LABEL_20;
  *(_QWORD *)(v3 + 16) = this;
  sub_1C32BC4((CGThumbnailListItem_o *)(v3 + 16), (int32_t)this, v5, v6);
  v7 = (WeightRate_int__o *)sub_1C32E6C(WeightRate_int__TypeInfo);
  WeightRate_int____ctor(v7, (const MethodInfo_3B8A1D4 *)Method_WeightRate_int___ctor__);
  v8 = sub_1C32E6C(BattleRandomSwitchObj___c__DisplayClass3_1_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = 0;
      ...
      if ( v14 )
      {
        ...
        if ( objs )
        {
          ...
          System_Array__ForEach_object_(
            ...
            (const MethodInfo_31E4100 *)Method_System_Array_ForEach_GameObject___);
          v12 = *(_DWORD *)(v8 + 16) + 1;
          *(_DWORD *)(v8 + 16) = v12;
          switchDataArray = this->fields.switchDataArray;
          if ( switchDataArray )
  ...
  if ( !v7 )
    goto LABEL_20;
  v18 = UnityEngine_Random__Range_71183860(0, v7->fields.totalweight, 0);
  Data = WeightRate_int___getData(v7, v18, (const MethodInfo_3B89B64 *)Method_WeightRate_int__getData__);
  *(_DWORD *)(v3 + 24) = Data;
...
LABEL_20:
    sub_1C32E7C(Data);
  v21 = (System_Action_object__o *)sub_1C32E6C(System_Action_GameObject__TypeInfo);
  System_Action_object____ctor(
    v21,
    (Il2CppObject *)v3,
