...
void __fastcall BattleValueButtonComponent__OnClickTarget(BattleValueButtonComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(target, 0LL, 0LL) )
  {
    ...
    if ( !v8 )
      sub_1BCB254(v10, v11);
    UnityEngine_GameObject__SendMessage_70117864(v8, sendmessage, v10, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalPosition_35356848(gameObject, defaultPositionX, defaultPositionY, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  GameObjectExtensions__SetLocalPosition_35356848(gameObject, posX, posY, 0LL);
}
