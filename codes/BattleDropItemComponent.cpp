void BattleDropItemComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D2F329 & 1) == 0 )
  {
    sub_1C94098(&BattleDropItemComponent_TypeInfo);
    byte_4D2F329 = 1;
  }
...
LABEL_16:
    sub_1C942F0(IsServant, itemData);
  }
}
...
void BattleDropItemComponent__SetAutoSellItem(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F323 & 1) == 0 )
  {
    this = (BattleDropItemComponent_o *)sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2F323 = 1;
  }
...
void BattleDropItemComponent__SetEventPointBuff(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  servant = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !servant
...
void BattleDropItemComponent__SetItem(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( v10 - v9 >= 1 )
    {
      servant = (ServantFaceIconComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( servant )
      {
...
void BattleDropItemComponent__SetMaterialTd(BattleDropItemComponent_o *this, bool flg, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0, 0) )
  {
    ...
    if ( flg )
    {
      ...
      AtlasManager__SetEventSprite(v8, (System_String_o *)StringLiteral_23341/*"ribbon_noblephantasmup_01"*/, 0);
    }
  }
}
...
void BattleDropItemComponent__SetPossession(BattleDropItemComponent_o *this, int32_t num, const MethodInfo *method)
{
  ...
  transform = System_String__Format((System_String_o *)StringLiteral_25304/*"{0:#,0}"*/, v5, 0);
  if ( !possessionLabel )
    goto LABEL_19;
  ...
  if ( PossessionLabelWidth >= v10 )
  {
    if ( !byte_4D25F1E )
    {
      transform = (void *)sub_1C94098(&UnityEngine_Vector3_TypeInfo);
      byte_4D25F1E = 1;
    }
    if ( v12 )
    {
...
void BattleDropItemComponent__SetServant(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  else
  {
    if ( !item )
      goto LABEL_23;
    BattleServantFaceIconComponent__SetSvtDrop_41605292(
      (BattleServantFaceIconComponent_o *)item,
      (int64_t)method,
      0,
      itemData->fields.num,
  ...
  item = (ItemIconComponent_o *)DataManager__GetMaster_object_((const MethodInfo_319C0E0 *)Method_DataManager_GetMaster_UserServantMaster___);
...
// local variable allocation has failed, the output may be wrong!
void BattleDropItemComponent__Set_46820264(
        BattleDropItemComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F31F & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_3135/*"Battle_RESULT_ITEM_DROPUP"*/);
    byte_4D2F31F = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(AcquisitionUpObj, 0, 0) )
  {
    ...
    if ( ((unsigned __int8)v7 & 1) == 0 )
    {
      ...
      v15 = LocalizationManager__Get((System_String_o *)StringLiteral_3135/*"Battle_RESULT_ITEM_DROPUP"*/, 0);
      v7 = (UnityEngine_GameObject_o *)System_String__Concat_64417744(v14, v15, 0);
      if ( !v12 )
LABEL_20:
        sub_1C942F0(v7, v8);
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1ACB1F8;
}
