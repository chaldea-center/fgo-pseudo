void __fastcall BattleDropItemComponent___cctor(const MethodInfo *method)
{
  if ( (byte_42AECF2 & 1) == 0 )
  {
    sub_B52984(&BattleDropItemComponent_TypeInfo);
    byte_42AECF2 = 1;
  }
...
void __fastcall BattleDropItemComponent__SetAutoSellItem(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AECEC & 1) == 0 )
  {
    this = (BattleDropItemComponent_o *)sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42AECEC = 1;
  }
...
void __fastcall BattleDropItemComponent__SetEventPointBuff(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  servant = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !servant
...
void __fastcall BattleDropItemComponent__SetItem(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( v10 - v9 >= 1 )
    {
      servant = (ServantFaceIconComponent_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( servant )
      {
        ...
        const MethodInfo *method)
{
  ...
  v6 = System_String__Format((System_String_o *)StringLiteral_23682/*"{0:#,0}"*/, v5, 0LL);
  if ( !possessionLabel )
    goto LABEL_19;
...
void __fastcall BattleDropItemComponent__SetServant(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  else
  {
    if ( !item )
      goto LABEL_24;
    BattleServantFaceIconComponent__SetSvtDrop_29903296(
      (BattleServantFaceIconComponent_o *)item,
      (int64_t)method,
      0LL,
      itemData->fields.num,
  ...
  item = (ItemIconComponent_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_UserServantMaster___);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall BattleDropItemComponent__Set_22990832(
        BattleDropItemComponent_o *this,
        BattleDropItem_o *indata,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AECE8 & 1) == 0 )
  {
    ...
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_2818/*"Battle_RESULT_ITEM_DROPUP"*/);
    byte_42AECE8 = 1;
  }
  _8[0] = 0LL;
  ...
  if ( !UnityEngine_Object__op_Equality(AcquisitionUpObj, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)v7 & 1) == 0 )
    {
      ...
      *((float *)_8 + 1) = (float)indata->fields.dropUpRate / 1000.0;
      ...
      v15 = LocalizationManager__Get((System_String_o *)StringLiteral_2818/*"Battle_RESULT_ITEM_DROPUP"*/, 0LL);
      v7 = (UnityEngine_GameObject_o *)System_String__Concat_44568316(v14, v15, 0LL);
      if ( !v12 )
LABEL_23:
        sub_B52A5C(v7, v8);
...
LABEL_5:
    for ( i = 0LL; i != v7; ++i )
    {
      ...
      if ( *(__int16 *)(v31 + 72) == -1 )
        sub_B52A40(*(_QWORD *)&v30->fields.extra_arg, item, method, v3);
      v34 = sub_B529B4(v31);
          ...
          if ( *(__int16 *)(v31 + 72) != -1 && this->fields.m_target )
          {
            ...
            if ( (v44 & 1) != 0 )
            {
              if ( (v45 & 1) != 0 )
              {
                ...
                {
LABEL_57:
                  v26 = sub_AEB880(item, v48, v49, v46);
                }
                v17 = *(_QWORD *)(v26 + 8);
              }
              else
              ...
              v27 = (void (__fastcall **)(BattleDropItem_o *, _QWORD))sub_B52A34(v17, v31);
              (*v27)(item, v27);
            }
            else
            {
              ...
              if ( (v45 & 1) != 0 )
              {
                ...
                {
LABEL_11:
                  v16 = sub_AEB880(item, class_0, v10, v12);
                }
...
LABEL_48:
            ...
            v29 = (void (__fastcall **)(__int64 *, BattleDropItem_o *, _QWORD))sub_B52A34(v25, v31);
            (*v29)(v32, item, v29);
          }
          else
          {
