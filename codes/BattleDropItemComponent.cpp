void __fastcall BattleDropItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BD563 & 1) == 0 )
  {
    sub_1B4CF90(&BattleDropItemComponent_TypeInfo, v1);
    byte_49BD563 = 1;
  }
...
LABEL_16:
    sub_1B4D1EC(IsServant, itemData);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD558 & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, indata);
    byte_49BD558 = 1;
  }
  this->fields.itemData = indata;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.itemData, (int32_t)indata, (int32_t)method, v3);
  itemData = this->fields.itemData;
  if ( !itemData )
    goto LABEL_30;
...
void __fastcall BattleDropItemComponent__SetAutoSellItem(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BD55D & 1) == 0 )
  {
    this = (BattleDropItemComponent_o *)sub_1B4CF90(&UnityEngine_Object_TypeInfo, method);
    byte_49BD55D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)call, (int32_t)method, v3);
}
...
void __fastcall BattleDropItemComponent__SetEventPointBuff(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BD55C & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_EventPointBuffMaster___, method);
    sub_1B4CF90(&Method_DataMasterBase_EventPointBuffMaster__EventPointBuffEntity__int__GetEntity__, v3);
  ...
  servant = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !servant
...
void __fastcall BattleDropItemComponent__SetItem(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( v12 - v11 >= 1 )
    {
      servant = (ServantFaceIconComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( servant )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD560 & 1) == 0 )
  {
    sub_1B4CF90(&AtlasManager_TypeInfo, flg);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v5);
    sub_1B4CF90(&StringLiteral_22660/*"ribbon_noblephantasmup_01"*/, v6);
    byte_49BD560 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(materialTdSprite, 0LL, 0LL) )
  {
    ...
    if ( flg )
    {
      ...
      AtlasManager__SetEventSprite(v10, (System_String_o *)StringLiteral_22660/*"ribbon_noblephantasmup_01"*/, 0LL);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD562 & 1) == 0 )
  {
    sub_1B4CF90(&BattleDropItemComponent_TypeInfo, *(_QWORD *)&num);
    sub_1B4CF90(&int_TypeInfo, v6);
    sub_1B4CF90(&StringLiteral_24644/*"{0:#,0}"*/, v7);
    byte_49BD562 = 1;
  }
  ...
  transform = (__int64)System_String__Format((System_String_o *)StringLiteral_24644/*"{0:#,0}"*/, v9, 0LL);
  if ( !possessionLabel )
    goto LABEL_19;
  ...
  if ( PossessionLabelWidth >= v14 )
  {
    if ( !byte_49B5366 )
    {
      transform = sub_1B4CF90(&UnityEngine_Vector3_TypeInfo, v11);
      byte_49B5366 = 1;
    }
    if ( v16 )
    {
...
void __fastcall BattleDropItemComponent__SetServant(BattleDropItemComponent_o *this, const MethodInfo *method)
{
  ...
  else
  {
    if ( !item )
      goto LABEL_23;
    BattleServantFaceIconComponent__SetSvtDrop_38618432(
      (BattleServantFaceIconComponent_o *)item,
      (int64_t)method,
      0LL,
      itemData->fields.num,
  ...
  item = (ItemIconComponent_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_UserServantMaster___);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall BattleDropItemComponent__Set_43380040(
        BattleDropItemComponent_o *this,
        BattleDropItem_o *indata,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD559 & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, indata);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v5);
    sub_1B4CF90(&StringLiteral_3141/*"Battle_RESULT_ITEM_DROPUP"*/, v6);
    byte_49BD559 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(AcquisitionUpObj, 0LL, 0LL) )
  {
    ...
    if ( ((unsigned __int8)v9 & 1) == 0 )
    {
      ...
      v17 = LocalizationManager__Get((System_String_o *)StringLiteral_3141/*"Battle_RESULT_ITEM_DROPUP"*/, 0LL);
      v9 = (UnityEngine_GameObject_o *)System_String__Concat_61093468(v16, v17, 0LL);
      if ( !v14 )
LABEL_20:
        sub_1B4D1EC(v9, v10);
...
void __fastcall BattleDropItemComponent__setRateUp(BattleDropItemComponent_o *this, bool flg, const MethodInfo *method)
{
  ...
  if ( (byte_49BD55F & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, flg);
    byte_49BD55F = 1;
  }
  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_199EA68;
          else
            v9 = (Il2CppObject *)sub_199EA2C;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_199E9A8;
        }
        else
        {
          v9 = (Il2CppObject *)sub_199E97C;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_199E94C;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_199E904;
}
