        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF0B5 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_18846/*"deckId"*/, deckId);
    sub_1C2E12C(&StringLiteral_18848/*"deckName"*/, v7);
    byte_4BFF0B5 = 1;
  }
  RequestBase__addField_42510212((RequestBase_o *)this, (System_String_o *)StringLiteral_18846/*"deckId"*/, deckId, method);
...
System_String_o *__fastcall DeckEditNameRequest__getURL(DeckEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFF0B3 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_18844/*"deck/editName"*/, v2);
    byte_4BFF0B3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_18844/*"deck/editName"*/, 0LL);
}
