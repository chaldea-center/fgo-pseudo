        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A3EB & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_18454/*"deckId"*/, deckId);
    sub_1B686D4(&StringLiteral_18456/*"deckName"*/, v7);
    byte_4A0A3EB = 1;
  }
  RequestBase__addField_40919284((RequestBase_o *)this, (System_String_o *)StringLiteral_18454/*"deckId"*/, deckId, 0LL);
  RequestBase__addField_40920848((RequestBase_o *)this, (System_String_o *)StringLiteral_18456/*"deckName"*/, deckName, 0LL);
...
System_String_o *__fastcall DeckEditNameRequest__getURL(DeckEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A3E9 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_18452/*"deck/editName"*/, v2);
    byte_4A0A3E9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_18452/*"deck/editName"*/, 0LL);
}
