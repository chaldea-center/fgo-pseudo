        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F79C & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_18514/*"deckId"*/, deckId);
    sub_1B761C0(&StringLiteral_18516/*"deckName"*/, v7);
    byte_4A2F79C = 1;
  }
  RequestBase__addField_40947456((RequestBase_o *)this, (System_String_o *)StringLiteral_18514/*"deckId"*/, deckId, method);
  RequestBase__addField_40941128((RequestBase_o *)this, (System_String_o *)StringLiteral_18516/*"deckName"*/, deckName, v8);
...
System_String_o *__fastcall DeckEditNameRequest__getURL(DeckEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F79A & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_18512/*"deck/editName"*/, v2);
    byte_4A2F79A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_18512/*"deck/editName"*/, 0LL);
}
