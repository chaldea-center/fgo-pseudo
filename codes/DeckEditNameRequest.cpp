        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB75C6 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_18550/*"deckId"*/, deckId);
    sub_1BAB41C(&StringLiteral_18552/*"deckName"*/, v7);
    byte_4AB75C6 = 1;
  }
  RequestBase__addField_41522804((RequestBase_o *)this, (System_String_o *)StringLiteral_18550/*"deckId"*/, deckId, method);
...
System_String_o *__fastcall DeckEditNameRequest__getURL(DeckEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB75C4 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_18548/*"deck/editName"*/, v2);
    byte_4AB75C4 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_18548/*"deck/editName"*/, 0LL);
}
