        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B684AC & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18762/*"deckId"*/, deckId);
    sub_1BE4ACC(&StringLiteral_18764/*"deckName"*/, v7);
    byte_4B684AC = 1;
  }
  RequestBase__addField_42110748((RequestBase_o *)this, (System_String_o *)StringLiteral_18762/*"deckId"*/, deckId, method);
...
System_String_o *__fastcall DeckEditNameRequest__getURL(DeckEditNameRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B684AA & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_18760/*"deck/editName"*/, v2);
    byte_4B684AA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_18760/*"deck/editName"*/, 0LL);
}
