void __fastcall ServantLimitMaster___ctor(ServantLimitMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E6B3 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantLimitMaster__ServantLimitEntity__string___ctor__, method);
    byte_4A2E6B3 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    7,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_ServantLimitMaster__ServantLimitEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E6B5 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantLimitAddMaster___, *(_QWORD *)&limitCount);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E6B1 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantLimitMaster__ServantLimitEntity__string__GetEntity__, *(_QWORD *)&svtId);
    byte_4A2E6B1 = 1;
  }
  ...
  return (ServantLimitEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                   PK,
                                   (const MethodInfo_30FFAD8 *)Method_DataMasterBase_ServantLimitMaster__ServantLimitEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E6B4 & 1) == 0 )
  {
    sub_1B761C0(&Rarity_TypeInfo, *(_QWORD *)&svtId);
    byte_4A2E6B4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E6B2 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantLimitMaster__ServantLimitEntity__string__TryGetEntity__, entity);
    byte_4A2E6B2 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_ServantLimitMaster__ServantLimitEntity__string__TryGetEntity__);
}