...
System_String_o *BattleScenarioRequest__getURL(BattleScenarioRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06460 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_17236/*"battle/scenario"*/);
    byte_4E06460 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65122828(BaseUrl, (System_String_o *)StringLiteral_17236/*"battle/scenario"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E06462 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_6066/*"EndRequestBattleScenario: ResponseData is null. : QuestId={0}, Phase={1}"*/);
    sub_1CE6700(&StringLiteral_6068/*"EndRequestBattleScenario: successList is null. : QuestId={0}, Phase={1}"*/);
    sub_1CE6700(&StringLiteral_6067/*"EndRequestBattleScenario: server returned an error. : QuestId={0}, Phase={1}"*/);
    byte_4E06462 = 1;
  }
  ...
  if ( !v5 )
  {
    ...
    v19 = System_String__Format_65164136((System_String_o *)StringLiteral_6066/*"EndRequestBattleScenario: ResponseData is null. : QuestId={0}, Phase={1}"*/, v17, v18, 0);
    ...
    if ( Instance )
    {
      CrashReporter__SendReport_31803600((CrashReporter_o *)Instance, v19, 0, 0, 0);
      sub_1CE6958(v20, v21);
    }
    goto LABEL_18;
  }
  v6 = v5;
  if ( !ResponseData__checkError_45365352(v5, 0) )
  {
    requestQuestId = this->fields.requestQuestId;
    ...
    v9 = System_String__Format_65164136((System_String_o *)StringLiteral_6067/*"EndRequestBattleScenario: server returned an error. : QuestId={0}, Phase={1}"*/, v7, v8, 0);
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( !Instance )
      goto LABEL_18;
    CrashReporter__SendReport_31803600((CrashReporter_o *)Instance, v9, 0, 0, 0);
  }
  ...
  if ( !success )
  {
    ...
    v15 = System_String__Format_65164136((System_String_o *)StringLiteral_6068/*"EndRequestBattleScenario: successList is null. : QuestId={0}, Phase={1}"*/, v13, v14, 0);
    Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( Instance )
    {
      CrashReporter__SendReport_31803600((CrashReporter_o *)Instance, v15, 0, 0, 0);
      goto LABEL_14;
    }
LABEL_18:
