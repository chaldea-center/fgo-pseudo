void BattleCallBack___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_32FE32C *method)
{
  void *monitor; // x20
  ...
  sub_1C2D4B8(
    ...
    *((_QWORD *)m_target[12].klass->_1.gc_desc + 16),
    ...
    (unsigned int)v8);
  sub_1A7C6D0(this, *((_QWORD *)callBack->fields.m_target[12].klass->_1.gc_desc + 16) + 32LL, monitor);
}


void BattleCallBack___Il2CppFullySharedGenericType___call(BattleCallBack_T__o *this, const MethodInfo_32FE428 *method)
{
  ...
  v7 = *(void **)sub_1C2D4B4(this, (char *)rgctx_data->_1_BattleCallBack_T_->_1.fields + 32);
  v8 = (const void *)sub_1C2D4B4(this, method->klass->rgctx_data->_1_BattleCallBack_T_->_1.fields);
