void __fastcall BattleCallBack___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_304E7D8 *method)
{
  void *monitor; // x20
...
void __fastcall BattleCallBack___Il2CppFullySharedGenericType___call(
        BattleCallBack_T__o *this,
        const MethodInfo_304E8D4 *method)
{
  ...
  v7 = *(void **)sub_1B64894(this, (char *)rgctx_data->_1_BattleCallBack_T_->_1.fields + 32);
  v8 = (const void *)sub_1B64894(this, method->klass->rgctx_data->_1_BattleCallBack_T_->_1.fields);
