void __fastcall BattleCallBack___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_325AD20 *method)
{
  void *monitor; // x20
...
void __fastcall BattleCallBack___Il2CppFullySharedGenericType___call(
        BattleCallBack_T__o *this,
        const MethodInfo_325AE1C *method)
{
  ...
  v7 = *(void **)sub_1BDB89C(this, (char *)rgctx_data->_1_BattleCallBack_T_->_1.fields + 32);
  v8 = (const void *)sub_1BDB89C(this, method->klass->rgctx_data->_1_BattleCallBack_T_->_1.fields);
