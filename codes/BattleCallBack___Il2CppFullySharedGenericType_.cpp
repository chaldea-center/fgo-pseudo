void __fastcall BattleCallBack___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_31D13BC *method)
{
  void *monitor; // x20
...
void __fastcall BattleCallBack___Il2CppFullySharedGenericType___call(
        BattleCallBack_T__o *this,
        const MethodInfo_31D14B8 *method)
{
  ...
  v7 = *(void **)sub_1C21E5C(this, (char *)rgctx_data->_1_BattleCallBack_T_->_1.fields + 32);
  v8 = (const void *)sub_1C21E5C(this, method->klass->rgctx_data->_1_BattleCallBack_T_->_1.fields);
