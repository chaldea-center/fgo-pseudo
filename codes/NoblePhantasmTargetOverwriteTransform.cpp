        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2277E & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, targetActor);
    byte_4A2277E = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Inequality(targetNode, 0LL, 0LL) )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)NodeFromLvName, v14, v15);
...
LABEL_14:
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)v18, v19, v20);
    }
  }
}
