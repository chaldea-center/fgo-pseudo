        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39F3F & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_Object_TypeInfo, targetActor);
    byte_4B39F3F = 1;
  }
...
LABEL_14:
      ...
      sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.targetNode, (int64_t)v22, v23, v24, v25, v26, v27, v28);
    }
  }
}
