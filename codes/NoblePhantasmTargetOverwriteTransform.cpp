        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A80 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, targetActor);
    byte_4AB8A80 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Inequality(targetNode, 0LL, 0LL) )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)NodeFromLvName, v14, v15);
...
LABEL_14:
      ...
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)v18, v19, v20);
    }
  }
}
