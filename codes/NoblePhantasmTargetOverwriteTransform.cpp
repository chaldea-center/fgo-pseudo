        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB74F8 & 1) == 0 )
  {
    sub_1C13D24(&UnityEngine_Object_TypeInfo, targetActor);
    byte_4BB74F8 = 1;
  }
...
LABEL_14:
      ...
      sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.targetNode, (int64_t)v22, v23, v24, v25, v26, v27, v28);
    }
  }
}
