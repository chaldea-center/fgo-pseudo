        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B8F9 & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, targetActor);
    byte_4A0B8F9 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Inequality(targetNode, 0LL, 0LL) )
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)NodeFromLvName, v14, v15);
...
LABEL_14:
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)v18, v19, v20);
    }
  }
}
