        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51532 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, targetActor);
    byte_4A51532 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Inequality(targetNode, 0LL, 0LL) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.targetNode, (int32_t)NodeFromLvName, v13, v14);
...
LABEL_14:
      ...
      sub_1B8635C((CGThumbnailListItem_o *)&this->fields.targetNode, (int32_t)v17, v18, v19);
    }
  }
}
...
LABEL_9:
    sub_1B86614(this, overwriteTransformInfo);
  }
  return 1;
}
