        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B699C4 & 1) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, targetActor);
    byte_4B699C4 = 1;
  }
...
LABEL_14:
      ...
      sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.targetNode, (int64_t)v22, v23, v24, v25, v26, v27, v28);
    }
  }
}
