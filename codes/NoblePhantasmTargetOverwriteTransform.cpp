        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Inequality(targetNode, 0LL, 0LL) )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)NodeFromLvName, v14, v15);
...
LABEL_14:
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.targetNode, (int32_t)v18, v19, v20);
    }
  }
}
