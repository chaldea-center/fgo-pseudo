        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40DE6 & 1) == 0 )
  {
    sub_1BDB878(&ShopInfoIndicator__InformationChangeCR_d__7_TypeInfo, method);
    byte_4B40DE6 = 1;
  }
  v3 = sub_1BDBAC4(ShopInfoIndicator__InformationChangeCR_d__7_TypeInfo);
...
LABEL_11:
    sub_1BDBAD4(informationPanel, method);
  }
}
...
void __fastcall ShopInfoIndicator__OnClick(ShopInfoIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B40DE8 & 1) == 0 )
  {
    sub_1BDB878(&Method_ShopInfoIndicator_OnClick__, method);
    byte_4B40DE8 = 1;
  }
  if ( !this->fields.isClick )
  {
    ...
    if ( (*((_BYTE *)Method_ShopInfoIndicator_OnClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_ShopInfoIndicator_OnClick__);
...
void __fastcall ShopInfoIndicator__StartInformationChange(ShopInfoIndicator_o *this, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.InformationChangeCRW, (int32_t)v4, v5, v6);
...
void __fastcall ShopInfoIndicator__StopInformationChange(ShopInfoIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( InformationChangeCRW )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)p_InformationChangeCRW, 0, v5, v6);
  }
}
...
void __fastcall ShopInfoIndicator__SwitchInfo(ShopInfoIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( v6 < max_length )
    {
      this = (ShopInfoIndicator_o *)infos->m_Items[v6];
      if ( !this )
        goto LABEL_15;
...
LABEL_7:
  ...
  if ( !v7 )
    goto LABEL_15;
  infoIndex = v5->fields.infoIndex;
  if ( (unsigned int)infoIndex >= v7->max_length )
    goto LABEL_16;
  this = (ShopInfoIndicator_o *)v7->m_Items[infoIndex];
  if ( !this
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, 1, 0LL), (v9 = v5->fields.infos) == 0LL) )
  {
LABEL_15:
    sub_1BDBAD4(this, method);
  }
  v10 = v5->fields.infoIndex;
  if ( v10 < (signed int)(v9->max_length - 1) )
    v11 = v10 + 1;
  else
    v11 = 0;
  v5->fields.infoIndex = v11;
}


void __fastcall ShopInfoIndicator__InformationChangeCR_d__7___ctor(
...
bool __fastcall ShopInfoIndicator__InformationChangeCR_d__7__MoveNext(
        ShopInfoIndicator__InformationChangeCR_d__7_o *this,
        const MethodInfo *method)
{
  ...
  TweenAlpha_o *v14; // x0
  ShopInfoIndicator__InformationChangeCR_d__7_o **v15; // x21
  int32_t v16; // w2
  const MethodInfo *v17; // x3
  const MethodInfo *v18; // x1
  UnityEngine_Object_o *v19; // x22
  struct UnityEngine_WaitForEndOfFrame_o *wait_5__3; // x1
  ShopInfoIndicator__InformationChangeCR_d__7_o *v21; // x0
  int v22; // w20
  ...
  if ( (byte_4B40DE9 & 1) == 0 )
  {
    ...
    this = (ShopInfoIndicator__InformationChangeCR_d__7_o *)sub_1BDB878(&UnityEngine_WaitForEndOfFrame_TypeInfo, v3);
    byte_4B40DE9 = 1;
  }
  ...
  switch ( v2->fields.__1__state )
  {
    case 0:
      ...
      if ( !this )
        goto LABEL_48;
      ((void (__fastcall *)(ShopInfoIndicator__InformationChangeCR_d__7_o *, void *, float))this->klass->vtable._8_System_Collections_IEnumerator_Reset.method)(
        this,
        this->klass[1]._1.image,
        1.0);
      _4__this->fields.isClick = 1;
      v2->fields._ta_5__2 = 0LL;
      sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields._ta_5__2, 0, v5, v6);
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields._wait_5__3, (int32_t)v7, v8, v9);
      goto LABEL_17;
    case 1:
...
LABEL_34:
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields._ta_5__2, (int32_t)v24, v26, v27);
        ta_5__2 = (UnityEngine_Object_o *)v2->fields._ta_5__2;
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        this = (ShopInfoIndicator__InformationChangeCR_d__7_o *)UnityEngine_Object__op_Inequality(ta_5__2, 0LL, 0LL);
...
LABEL_17:
          ...
          sub_1BDB81C((CGThumbnailListItem_o *)&v2->fields._ta_5__2, (int32_t)v14, v16, v17);
          ShopInfoIndicator__SwitchInfo(_4__this, v18);
          v19 = (UnityEngine_Object_o *)v2->fields._ta_5__2;
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          this = (ShopInfoIndicator__InformationChangeCR_d__7_o *)UnityEngine_Object__op_Inequality(v19, 0LL, 0LL);
          if ( ((unsigned __int8)this & 1) != 0 )
          {
            this = *v15;
            if ( !*v15 )
...
LABEL_46:
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&v21->fields.__2__current, (int32_t)wait_5__3, v11, v12);
      result = 1;
...
Il2CppObject *__fastcall ShopInfoIndicator__InformationChangeCR_d__7__System_Collections_Generic_IEnumerator_System_Object__get_Current(
        ShopInfoIndicator__InformationChangeCR_d__7_o *this,
        const MethodInfo *method)
{
...
void __fastcall __noreturn ShopInfoIndicator__InformationChangeCR_d__7__System_Collections_IEnumerator_Reset(
        ShopInfoIndicator__InformationChangeCR_d__7_o *this,
        const MethodInfo *method)
{
  __int64 v2; // x0
  ...
  v4 = sub_1BDB88C(&Method_ShopInfoIndicator__InformationChangeCR_d__7_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}


Il2CppObject *__fastcall ShopInfoIndicator__InformationChangeCR_d__7__System_Collections_IEnumerator_get_Current(
        ShopInfoIndicator__InformationChangeCR_d__7_o *this,
        const MethodInfo *method)
{
  return this->fields.__2__current;
...
void __fastcall ShopInfoIndicator__InformationChangeCR_d__7__System_IDisposable_Dispose(
        ShopInfoIndicator__InformationChangeCR_d__7_o *this,
        const MethodInfo *method)
{
  ;
