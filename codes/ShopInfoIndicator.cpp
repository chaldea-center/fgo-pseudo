        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23596 & 1) == 0 )
  {
    sub_1C2D490(&ShopInfoIndicator__InformationChangeCR_d__7_TypeInfo);
    byte_4C23596 = 1;
  }
  v3 = sub_1C2D6DC(ShopInfoIndicator__InformationChangeCR_d__7_TypeInfo);
...
LABEL_11:
    sub_1C2D6EC(informationPanel, method);
  }
}
...
void ShopInfoIndicator__OnClick(ShopInfoIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23598 & 1) == 0 )
  {
    sub_1C2D490(&Method_ShopInfoIndicator_OnClick__);
    byte_4C23598 = 1;
  }
  if ( !this->fields.isClick )
  {
    ...
    if ( (*((_BYTE *)Method_ShopInfoIndicator_OnClick__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_ShopInfoIndicator_OnClick__);
...
void ShopInfoIndicator__StartInformationChange(ShopInfoIndicator_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.InformationChangeCRW, (int32_t)v4, v5, v6);
...
void ShopInfoIndicator__StopInformationChange(ShopInfoIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( InformationChangeCRW )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)p_InformationChangeCRW, 0, v5, v6);
  }
}
...
LABEL_7:
  ...
  if ( (unsigned int)infoIndex >= LODWORD(v7->max_length) )
    goto LABEL_16;
  this = (ShopInfoIndicator_o *)v7->m_Items[infoIndex];
  if ( !this
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, 1, 0), (v9 = v5->fields.infos) == 0) )
  {
LABEL_15:
    sub_1C2D6EC(this, method);
  }
  v10 = v5->fields.infoIndex;
  if ( v10 < LODWORD(v9->max_length) - 1 )
    v11 = v10 + 1;
  else
    v11 = 0;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    this = (ShopInfoIndicator__InformationChangeCR_d__7_o *)sub_1C2D490(&UnityEngine_WaitForEndOfFrame_TypeInfo);
    byte_4C23599 = 1;
  }
  ...
  switch ( v2->fields.__1__state )
  {
    case 0:
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&v2->fields._ta_5__2, 0, v4, v5);
      v6 = (UnityEngine_WaitForEndOfFrame_o *)sub_1C2D6DC(UnityEngine_WaitForEndOfFrame_TypeInfo);
      UnityEngine_WaitForEndOfFrame___ctor(v6, 0);
      v2->fields._wait_5__3 = v6;
      sub_1C2D434((CGThumbnailListItem_o *)&v2->fields._wait_5__3, (int32_t)v6, v7, v8);
      goto LABEL_17;
    case 1:
...
LABEL_34:
        ...
        sub_1C2D434((CGThumbnailListItem_o *)&v2->fields._ta_5__2, (int32_t)v23, v25, v26);
...
LABEL_17:
          ...
          sub_1C2D434((CGThumbnailListItem_o *)&v2->fields._ta_5__2, (int32_t)v13, v15, v16);
...
LABEL_46:
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&v20->fields.__2__current, (int32_t)wait_5__3, v10, v11);
      result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_ShopInfoIndicator__InformationChangeCR_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
