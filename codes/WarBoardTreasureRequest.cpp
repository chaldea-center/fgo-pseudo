        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A627 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_23396/*"stageId"*/, *(_QWORD *)&treasureId);
    this = (WarBoardTreasureRequest_o *)sub_1B686D4(&StringLiteral_23978/*"treasureId"*/, v7);
    byte_4A0A627 = 1;
  }
  if ( !warBoardData )
    sub_1B68930(this, *(_QWORD *)&treasureId);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_23396/*"stageId"*/, id, v9);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_23978/*"treasureId"*/, treasureId, v10);
...
System_String_o *__fastcall WarBoardTreasureRequest__getURL(WarBoardTreasureRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A626 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_24539/*"warBoard/treasure"*/, v2);
    byte_4A0A626 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_24539/*"warBoard/treasure"*/, 0LL);
}
