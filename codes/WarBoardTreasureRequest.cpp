        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BD1 & 1) == 0 )
  {
    ...
    this = (WarBoardTreasureRequest_o *)sub_B52984(&StringLiteral_22979/*"treasureId"*/);
    byte_42B0BD1 = 1;
  }
  if ( !warBoardData )
    sub_B52A5C(this, *(_QWORD *)&treasureId);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_22450/*"stageId"*/, id, 0LL);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_22979/*"treasureId"*/, treasureId, 0LL);
...
System_String_o *__fastcall WarBoardTreasureRequest__getURL(WarBoardTreasureRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0BD0 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_23403/*"warBoard/treasure"*/);
    byte_42B0BD0 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_23403/*"warBoard/treasure"*/, 0LL);
}
