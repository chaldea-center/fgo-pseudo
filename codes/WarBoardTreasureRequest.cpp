        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A004D7 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_23384/*"stageId"*/, *(_QWORD *)&treasureId);
    this = (WarBoardTreasureRequest_o *)sub_1B64A00(&StringLiteral_23966/*"treasureId"*/, v7);
    byte_4A004D7 = 1;
  }
  if ( !warBoardData )
    sub_1B64C5C(this, *(_QWORD *)&treasureId);
...
System_String_o *__fastcall WarBoardTreasureRequest__getURL(WarBoardTreasureRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A004D6 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_24527/*"warBoard/treasure"*/, v2);
    byte_4A004D6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_24527/*"warBoard/treasure"*/, 0LL);
}
