        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3263D & 1) == 0 )
  {
    ...
    this = (WarBoardTreasureRequest_o *)sub_1C93AD4(&StringLiteral_24505/*"treasureId"*/);
    byte_4D3263D = 1;
  }
  if ( !warBoardData )
    sub_1C93D2C(this, *(_QWORD *)&treasureId);
  id = WarBoardData__get_id(warBoardData, 0);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_23940/*"stageId"*/, id, v8);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_24505/*"treasureId"*/, treasureId, v9);
...
System_String_o *WarBoardTreasureRequest__getURL(WarBoardTreasureRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D3263C & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_25063/*"warBoard/treasure"*/);
    byte_4D3263C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64425724(BaseUrl, (System_String_o *)StringLiteral_25063/*"warBoard/treasure"*/, 0);
}
