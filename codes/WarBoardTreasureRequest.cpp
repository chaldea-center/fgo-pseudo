        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9542 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_23885/*"stageId"*/, *(_QWORD *)&treasureId);
    this = (WarBoardTreasureRequest_o *)sub_1C1ABD4(&StringLiteral_24475/*"treasureId"*/, v7);
    byte_4BC9542 = 1;
  }
  if ( !warBoardData )
    sub_1C1AE30(this, *(_QWORD *)&treasureId);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_23885/*"stageId"*/, id, 0LL);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_24475/*"treasureId"*/, treasureId, 0LL);
...
System_String_o *__fastcall WarBoardTreasureRequest__getURL(WarBoardTreasureRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC9541 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_25042/*"warBoard/treasure"*/, v2);
    byte_4BC9541 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_25042/*"warBoard/treasure"*/, 0LL);
}
