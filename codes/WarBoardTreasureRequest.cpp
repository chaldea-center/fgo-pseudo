        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_597255E & 1) == 0 )
  {
    ...
    this = (WarBoardTreasureRequest_o *)sub_2213A60(&StringLiteral_25507/*"treasureId"*/);
    byte_597255E = 1;
  }
  if ( !warBoardData )
    sub_2213CDC(this, *(_QWORD *)&treasureId);
  id = WarBoardData__get_id(warBoardData, 0);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_24904/*"stageId"*/, id, v8);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_25507/*"treasureId"*/, treasureId, v9);
...
System_String_o *WarBoardTreasureRequest__getURL(WarBoardTreasureRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_597255D & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_26113/*"warBoard/treasure"*/);
    byte_597255D = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75651716(BaseUrl, (System_String_o *)StringLiteral_26113/*"warBoard/treasure"*/, 0);
}
