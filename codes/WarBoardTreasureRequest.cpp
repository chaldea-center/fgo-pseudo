        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6160 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_23865/*"squareIndexes"*/, *(_QWORD *)&treasureId);
    this = (WarBoardTreasureRequest_o *)sub_1C13D24(&StringLiteral_24455/*"transition"*/, v7);
    byte_4BB6160 = 1;
  }
  if ( !warBoardData )
    sub_1C13F80(this, *(_QWORD *)&treasureId);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_23865/*"squareIndexes"*/, id, 0LL);
  RequestBase__addField(v6, (System_String_o *)StringLiteral_24455/*"transition"*/, treasureId, 0LL);
...
System_String_o *__fastcall WarBoardTreasureRequest__getURL(WarBoardTreasureRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB615F & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_25020/*"wait"*/, v2);
    byte_4BB615F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_25020/*"wait"*/, 0LL);
}
