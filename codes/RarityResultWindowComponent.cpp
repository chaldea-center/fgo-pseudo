        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C47072 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_RarityResultWindowComponent___c__DisplayClass13_0__CloseToNext_b__0__);
    sub_1C37058(&RarityResultWindowComponent___c__DisplayClass13_0_TypeInfo);
    byte_4C47072 = 1;
  }
  v5 = sub_1C372A4(RarityResultWindowComponent___c__DisplayClass13_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C47071 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_RarityResultWindowComponent_Open__);
    sub_1C37058(&string_TypeInfo);
    sub_1C37058(&StringLiteral_20362/*"img_combine_arrow_sp"*/);
    sub_1C37058(&StringLiteral_2902/*"BEFORE_CHANGE_RARITY_SUB_TITLE"*/);
    sub_1C37058(&StringLiteral_3842/*"COSTUME_CHANGE_RARITY_DETAIL_FORMAT"*/);
    sub_1C37058(&StringLiteral_20578/*"img_skillwindow_sp"*/);
    sub_1C37058(&StringLiteral_3843/*"COSTUME_CHANGE_RARITY_TITLE"*/);
    sub_1C37058(&StringLiteral_1927/*"AFTER_CHANGE_RARITY_SUB_TITLE"*/);
    byte_4C47071 = 1;
  }
  if ( !this->fields.baseState )
  {
    ...
    if ( (*((_BYTE *)Method_RarityResultWindowComponent_Open__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1C37070(Method_RarityResultWindowComponent_Open__);
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( rarityChangeInfoSubTitleOld )
        {
          ...
          gameObject = (UnityEngine_GameObject_o *)System_String__Format_63602948(v25, v32, v39, 0);
          if ( rarityChangeInfoNameOld )
          {
            ...
            if ( rarityChangeInfoSubTitleNow )
            {
              ...
              gameObject = (UnityEngine_GameObject_o *)System_String__Format_63602948(v42, v49, v56, 0);
