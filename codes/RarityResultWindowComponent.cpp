        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B9A5 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_RarityResultWindowComponent___c__DisplayClass13_0__CloseToNext_b__0__);
    sub_1D0F0B4(&RarityResultWindowComponent___c__DisplayClass13_0_TypeInfo);
    byte_4E7B9A5 = 1;
  }
  v5 = sub_1D0F300(RarityResultWindowComponent___c__DisplayClass13_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7B9A4 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_RarityResultWindowComponent_Open__);
    sub_1D0F0B4(&string_TypeInfo);
    sub_1D0F0B4(&StringLiteral_20748/*"img_combine_arrow_sp"*/);
    sub_1D0F0B4(&StringLiteral_2921/*"BEFORE_CHANGE_RARITY_SUB_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_3881/*"COSTUME_CHANGE_RARITY_DETAIL_FORMAT"*/);
    sub_1D0F0B4(&StringLiteral_20970/*"img_skillwindow_sp"*/);
    sub_1D0F0B4(&StringLiteral_3882/*"COSTUME_CHANGE_RARITY_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_1924/*"AFTER_CHANGE_RARITY_SUB_TITLE"*/);
    byte_4E7B9A4 = 1;
  }
  if ( !this->fields.baseState )
  {
    ...
    if ( (*((_BYTE *)Method_RarityResultWindowComponent_Open__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1D0F0CC(Method_RarityResultWindowComponent_Open__);
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( svtCostumeEnt )
        {
          ...
          v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3882/*"COSTUME_CHANGE_RARITY_TITLE"*/, 0);
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2921/*"BEFORE_CHANGE_RARITY_SUB_TITLE"*/, 0);
        if ( rarityChangeInfoSubTitleOld )
        {
          ...
          v26 = LocalizationManager__Get((System_String_o *)StringLiteral_3881/*"COSTUME_CHANGE_RARITY_DETAIL_FORMAT"*/, 0);
          v37 = oldRarity;
          v27 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v37);
          v36 = oldCost;
          v28 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36);
          gameObject = (UnityEngine_GameObject_o *)System_String__Format_65604080(v26, v27, v28, 0);
          if ( rarityChangeInfoNameOld )
          {
            ...
            gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_1924/*"AFTER_CHANGE_RARITY_SUB_TITLE"*/, 0);
            if ( rarityChangeInfoSubTitleNow )
            {
              ...
              v31 = LocalizationManager__Get((System_String_o *)StringLiteral_3881/*"COSTUME_CHANGE_RARITY_DETAIL_FORMAT"*/, 0);
              v35 = nowRarity;
              v32 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v35);
              v34 = nowCost;
              v33 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v34);
              gameObject = (UnityEngine_GameObject_o *)System_String__Format_65604080(v31, v32, v33, 0);
