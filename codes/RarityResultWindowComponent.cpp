        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB596 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_RarityResultWindowComponent___c__DisplayClass13_0__CloseToNext_b__0__);
    sub_1C713B0(&RarityResultWindowComponent___c__DisplayClass13_0_TypeInfo);
    byte_4CCB596 = 1;
  }
  v5 = sub_1C715FC(RarityResultWindowComponent___c__DisplayClass13_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCB595 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_RarityResultWindowComponent_Open__);
    sub_1C713B0(&string_TypeInfo);
    sub_1C713B0(&StringLiteral_20440/*"img_combine_arrow_sp"*/);
    sub_1C713B0(&StringLiteral_2896/*"BEFORE_CHANGE_RARITY_SUB_TITLE"*/);
    sub_1C713B0(&StringLiteral_3837/*"COSTUME_CHANGE_RARITY_DETAIL_FORMAT"*/);
    sub_1C713B0(&StringLiteral_20656/*"img_skillwindow_sp"*/);
    sub_1C713B0(&StringLiteral_3838/*"COSTUME_CHANGE_RARITY_TITLE"*/);
    sub_1C713B0(&StringLiteral_1921/*"AFTER_CHANGE_RARITY_SUB_TITLE"*/);
    byte_4CCB595 = 1;
  }
  if ( !this->fields.baseState )
  {
    ...
    if ( (*((_BYTE *)Method_RarityResultWindowComponent_Open__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1C713C8(Method_RarityResultWindowComponent_Open__);
    ...
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( svtCostumeEnt )
        {
          ...
          v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3838/*"COSTUME_CHANGE_RARITY_TITLE"*/, 0);
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2896/*"BEFORE_CHANGE_RARITY_SUB_TITLE"*/, 0);
        if ( rarityChangeInfoSubTitleOld )
        {
          ...
          v26 = LocalizationManager__Get((System_String_o *)StringLiteral_3837/*"COSTUME_CHANGE_RARITY_DETAIL_FORMAT"*/, 0);
          v37 = oldRarity;
          v27 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v37);
          v36 = oldCost;
          v28 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36);
          gameObject = (UnityEngine_GameObject_o *)System_String__Format_64073032(v26, v27, v28, 0);
          if ( rarityChangeInfoNameOld )
          {
            ...
            if ( rarityChangeInfoSubTitleNow )
            {
              ...
              v31 = LocalizationManager__Get((System_String_o *)StringLiteral_3837/*"COSTUME_CHANGE_RARITY_DETAIL_FORMAT"*/, 0);
              v35 = nowRarity;
              v32 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v35);
              v34 = nowCost;
              v33 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v34);
              gameObject = (UnityEngine_GameObject_o *)System_String__Format_64073032(v31, v32, v33, 0);
