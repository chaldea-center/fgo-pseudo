        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.logicNpcAi, (int32_t)logicNpcAi, v7, v8);
  this->fields.arg = arg;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.arg, (int32_t)arg, v9, v10);
  if ( !arg
    ...
    || (Npc_k__BackingField = (struct AiNpcBattleServantData_o *)((__int64 (__fastcall *)(struct AiNpcBattleServantData_o *, const MethodInfo *))Npc_k__BackingField->klass->vtable._25_get_ActorType.methodPtr)(
        ...
        (v12 = arg->fields._Npc_k__BackingField) == 0) )
  {
    sub_1C32E7C(Npc_k__BackingField);
  }
  BattleLogicTask__setActor((BattleLogicTask_o *)this, (int32_t)Npc_k__BackingField, v12->fields.uniqueId, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3AAD3 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_BattleLogicTask__ForEach__);
    ...
    sub_1C32C20(&Method_NpcAiCheckTask__MakeActionTask_b__4_0__);
    byte_4C3AAD3 = 1;
  }
  ...
  if ( !logicNpcAi
    ...
    || (NpcAiCheckTask_Argument__AddNextAiCheckTask(
          ...
          (System_Collections_Generic_List_BattleLogicTask__o *)v4,
          v7),
        v8 = (System_Action_object__o *)sub_1C32E6C(System_Action_BattleLogicTask__TypeInfo),
        System_Action_object____ctor(v8, (Il2CppObject *)this, Method_NpcAiCheckTask__MakeActionTask_b__4_0__, 0),
        !v4) )
  {
  ...
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_37991FC *)Method_System_Collections_Generic_List_BattleLogicTask__ForEach__);
...
void NpcAiCheckTask___MakeActionTask_b__4_0(NpcAiCheckTask_o *this, BattleLogicTask_o *x, const MethodInfo *method)
{
  if ( !x )
    sub_1C32E7C(this);
  BattleLogicTask__SetAiPriority(x, this->fields._AiTimingPriority_k__BackingField, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  int v13; // w22
  NpcAiCheckTask_Argument_o *v14; // x23
  ...
  if ( (byte_4C3AAD4 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_BasicHelper_IndexValue_AiNpcBattleServantData___);
  ...
  v9 = BasicHelper__IndexValue_object__51165460(
         (System_Collections_Generic_List_T__o *)npcList,
         index,
         0,
         (const MethodInfo_30CB914 *)Method_BasicHelper_IndexValue_AiNpcBattleServantData___);
  this->fields._Npc_k__BackingField = (struct AiNpcBattleServantData_o *)v9;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._Npc_k__BackingField, (int32_t)v9, v10, v11);
  ...
  if ( !Npc_k__BackingField || (AiNpcBattleServantData__AddCheckAiProcState(Npc_k__BackingField, state, 0), !npcList) )
    sub_1C32E7C(Npc_k__BackingField);
  v13 = index + 1;
  if ( v13 < npcList->fields._size )
  {
    v14 = (NpcAiCheckTask_Argument_o *)sub_1C32E6C(NpcAiCheckTask_Argument_TypeInfo);
    NpcAiCheckTask_Argument___ctor(v14, state, npcList, v13, v15);
    this->fields.nextNpcArg = v14;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.nextNpcArg, (int32_t)v14, v16, v17);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3AAD5 & 1) == 0 )
  {
    ...
    sub_1C32C20(&NpcAiCheckTask_TypeInfo);
    byte_4C3AAD5 = 1;
  }
  Npc_k__BackingField = this->fields._Npc_k__BackingField;
  v8 = this->fields._AiStateIndex_k__BackingField + 1;
  ...
  {
    v9 = (NpcAiCheckTask_o *)sub_1C32E6C(NpcAiCheckTask_TypeInfo);
...
LABEL_28:
        System_Collections_Generic_List_object___AddWithResize(
          v29,
          v30,
          *(const MethodInfo_37987BC **)(*(_QWORD *)(v28 + 192) + 112LL));
        return;
      }
    }
    goto LABEL_29;
  ...
  if ( nextNpcArg )
  {
    v32 = (NpcAiCheckTask_o *)sub_1C32E6C(NpcAiCheckTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._Npc_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
