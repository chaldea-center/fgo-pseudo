        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.logicNpcAi, (int32_t)logicNpcAi, v7, v8);
  this->fields.arg = arg;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.arg, (int32_t)arg, v9, v10);
  if ( !arg
  ...
  {
    sub_1B68930(Npc_k__BackingField, v12);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B84A & 1) == 0 )
  {
    sub_1B686D4(&System_Action_BattleLogicTask__TypeInfo, logic);
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleLogicTask__ForEach__, v4);
    ...
    sub_1B686D4(&Method_NpcAiCheckTask__MakeActionTask_b__4_0__, v8);
    byte_4A0B84A = 1;
  }
  ...
  if ( !logicNpcAi
    ...
    || (NpcAiCheckTask_Argument__AddNextAiCheckTask(
          ...
          (System_Collections_Generic_List_BattleLogicTask__o *)v9,
          v13),
        v14 = (System_Action_object__o *)sub_1B68920(System_Action_BattleLogicTask__TypeInfo),
  ...
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_34BCCB8 *)Method_System_Collections_Generic_List_BattleLogicTask__ForEach__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B84B & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_BasicHelper_IndexValue_AiNpcBattleServantData___, v9);
    sub_1B686D4(&Method_System_Collections_Generic_List_AiNpcBattleServantData__get_Count__, v10);
    byte_4A0B84B = 1;
  }
  ...
  v11 = BasicHelper__IndexValue_object__48466720(
          ...
          index,
          0LL,
          (const MethodInfo_2E38B20 *)Method_BasicHelper_IndexValue_AiNpcBattleServantData___);
  this->fields._Npc_k__BackingField = (struct AiNpcBattleServantData_o *)v11;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields._Npc_k__BackingField, (int32_t)v11, v12, v13);
  ...
  if ( !Npc_k__BackingField || (AiNpcBattleServantData__AddCheckAiProcState(Npc_k__BackingField, state, 0LL), !npcList) )
    sub_1B68930(Npc_k__BackingField, v14);
  v16 = index + 1;
  if ( v16 < npcList->fields._size )
  {
    v17 = (NpcAiCheckTask_Argument_o *)sub_1B68920(NpcAiCheckTask_Argument_TypeInfo);
    NpcAiCheckTask_Argument___ctor(v17, state, npcList, v16, v18);
    this->fields.nextNpcArg = v17;
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.nextNpcArg, (int32_t)v17, v19, v20);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B84C & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleLogicTask__Add__, logicNpcAi);
    sub_1B686D4(&NpcAiCheckTask_TypeInfo, v7);
    byte_4A0B84C = 1;
  }
  Npc_k__BackingField = this->fields._Npc_k__BackingField;
  ...
  {
    v10 = (NpcAiCheckTask_o *)sub_1B68920(NpcAiCheckTask_TypeInfo);
...
LABEL_28:
        System_Collections_Generic_List_object___AddWithResize(
          v30,
          v31,
          *(const MethodInfo_34BC278 **)(*(_QWORD *)(v29 + 192) + 112LL));
        return;
      }
    }
    goto LABEL_29;
  ...
  if ( nextNpcArg )
  {
    v33 = (NpcAiCheckTask_o *)sub_1B68920(NpcAiCheckTask_TypeInfo);
...
LABEL_29:
    sub_1B68930(Npc_k__BackingField, v9);
  }
}
