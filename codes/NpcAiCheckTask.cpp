        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B7076C(Npc_k__BackingField, v20);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4350B71 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_NpcAiCheckTask__MakeActionTask_b__4_0__);
    byte_4350B71 = 1;
  }
  ...
  if ( !logicNpcAi
    ...
    || (NpcAiCheckTask_Argument__AddNextAiCheckTask(
          ...
          (System_Collections_Generic_List_BattleLogicTask__o *)v4,
          0LL),
        v7 = (System_Action_DrawLotsDisplayMessage_DisplayedInGroup_SaveData__o *)sub_B70764(System_Action_BattleLogicTask__TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4350F08 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_BasicHelper_IndexValue_AiNpcBattleServantData___);
  ...
  v9 = (struct AiNpcBattleServantData_o *)BasicHelper__IndexValue_WarBoardAIRoute_RouteData_(
                                            ...
                                            index,
                                            0LL,
                                            (const MethodInfo_1BDED70 *)Method_BasicHelper_IndexValue_AiNpcBattleServantData___);
  ...
  if ( !Npc_k__BackingField || (AiNpcBattleServantData__AddCheckAiProcState(Npc_k__BackingField, state, 0LL), !npcList) )
    sub_B7076C(Npc_k__BackingField, v16);
  v18 = index + 1;
  if ( v18 < npcList->fields._size )
  {
    v19 = (NpcAiCheckTask_Argument_o *)sub_B70764(NpcAiCheckTask_Argument_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4350F09 & 1) == 0 )
  {
    ...
    sub_B70694(&NpcAiCheckTask_TypeInfo);
    byte_4350F09 = 1;
  }
  Npc_k__BackingField = this->fields._Npc_k__BackingField;
  ...
  {
LABEL_13:
    v10 = (NpcAiCheckTask_o *)sub_B70764(NpcAiCheckTask_TypeInfo);
...
LABEL_16:
    sub_B7076C(Npc_k__BackingField, v8);
  }
}
