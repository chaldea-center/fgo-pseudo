        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B309 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_CharaGraphListViewPatternGrandEquipNormal__GenerateListViewItem_b__3_0__);
    sub_2213A60(&Method_System_Linq_Enumerable_Select_UserServantEntity__CharaGraphGrandEquipListViewItem___);
    ...
    sub_2213A60(&System_Func_UserServantEntity__int__CharaGraphGrandEquipListViewItem__TypeInfo);
    byte_596B309 = 1;
  }
  ...
  if ( !Master_object
    || (ServantEquipList = (System_Collections_Generic_IEnumerable_TSource__o *)UserServantMaster__getServantEquipList(
                                                                                  ...
                                                                                  0),
        Master_object = (Il2CppObject *)sub_2213CCC(System_Func_UserServantEntity__bool__TypeInfo),
        !this) )
  {
  ...
  v8 = (System_Func_T1__T2__TResult__o *)sub_2213CCC(System_Func_UserServantEntity__int__CharaGraphGrandEquipListViewItem__TypeInfo);
  ...
  return (System_Collections_Generic_IEnumerable_CharaGraphListViewItemBase__o *)System_Linq_Enumerable__Select_object__object__59315436(
                                                                                   ...
                                                                                   (const MethodInfo_38914EC *)Method_System_Linq_Enumerable_Select_UserServantEntity__CharaGraphGrandEquipListViewItem___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B30A & 1) == 0 )
  {
    sub_2213A60(&CharaGraphListViewItemDrawPatternGrandEquip_TypeInfo);
    byte_596B30A = 1;
  }
  v2 = (CharaGraphListViewItemDrawPatternDefault_o *)sub_2213CCC(CharaGraphListViewItemDrawPatternGrandEquip_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v9 = (CharaGraphGrandEquipListViewItem_o *)sub_2213CCC(CharaGraphGrandEquipListViewItem_TypeInfo);
