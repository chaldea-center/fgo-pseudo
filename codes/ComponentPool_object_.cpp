void __fastcall ComponentPool_object____ctor(
        ...
        int32_t poolSizeMax,
        const MethodInfo_31ADDA8 *method)
{
  int64_t v8; // x2
  int32_t v9; // w3
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.prefab, (int64_t)prefab, v8, v9, v10, v11, v12, v13);
  ...
  if ( (*(_BYTE *)(_1_System_Collections_Generic_List_T + 309) & 1) == 0 )
    _1_System_Collections_Generic_List_T = sub_1C25334();
  v15 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(_1_System_Collections_Generic_List_T);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_35C055C *)method->klass->rgctx_data->_3_System_Collections_Generic_List_T___ctor);
  this->fields.availableComponentList = (struct System_Collections_Generic_List_T__o *)v15;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields, (int64_t)v15, v16, v17, v18, v19, v20, v21);
  v22 = (__int64)method->klass->rgctx_data->_1_System_Collections_Generic_List_T_;
  if ( (*(_BYTE *)(v22 + 309) & 1) == 0 )
    v22 = sub_1C25334();
  v23 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(v22);
  klass = method->klass;
  v25 = (struct System_Collections_Generic_List_T__o *)v23;
  System_Collections_Generic_List_object____ctor(
    v23,
    (const MethodInfo_35C055C *)klass->rgctx_data->_3_System_Collections_Generic_List_T___ctor);
...
void __fastcall ComponentPool_object___Clear(ComponentPool_T__o *this, const MethodInfo_31AE400 *method)
{
  struct System_Collections_Generic_List_T__o *availableComponentList; // x0
  _BOOL8 v5; // x0
  const MethodInfo_31AE674 *v6; // x2
  struct System_Collections_Generic_List_T__o *v7; // x8
  int32_t size; // w2
  int v9; // w9
  _BOOL8 v10; // x0
  const MethodInfo_31AE674 *v11; // x2
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_35C1888 *)method->klass->rgctx_data->_16_System_Collections_Generic_List_T__GetEnumerator);
  for ( i = v15; ; ComponentPool_object___DestroyItem((ComponentPool_T__o *)v5, i.fields._current, v6) )
  {
    v5 = System_Collections_Generic_List_Enumerator_object___MoveNext(
           &i,
           (const MethodInfo_3335E50 *)method->klass->rgctx_data->_20_System_Collections_Generic_List_Enumerator_T__MoveNext);
    if ( !v5 )
      break;
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &i,
    (const MethodInfo_3335E4C *)method->klass->rgctx_data->_22_System_Collections_Generic_List_T__Clear);
...
LABEL_16:
    sub_1BD36B4(availableComponentList, method);
...
void __fastcall ComponentPool_object___DestroyItem(
        ComponentPool_T__o *this,
        Il2CppObject *item,
        const MethodInfo_31AE674 *method)
{
  _BOOL8 v4; // x0
  __int64 v5; // x1
...
void __fastcall ComponentPool_object___Finish(ComponentPool_T__o *this, const MethodInfo_31AE648 *method)
{
  int64_t v3; // x2
  int32_t v4; // w3
  ...
  ComponentPool_object___Clear(this, (const MethodInfo_31AE400 *)method->klass->rgctx_data[1]._0_ComponentPool_T_);
  this->fields.prefab = 0LL;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.prefab, 0LL, v3, v4, v5, v6, v7, v8);
}
...
void __fastcall ComponentPool_object___Preload(
        ComponentPool_T__o *this,
        int32_t count,
        const MethodInfo_31ADE6C *method)
{
  __int64 v5; // x1

  if ( (byte_4B3CEC8 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_Object_Instantiate_GameObject___, *(_QWORD *)&count);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v5);
    byte_4B3CEC8 = 1;
  }
  ComponentPool_object___get_currentPoolSize(
    this,
    (const MethodInfo_31ADD7C *)method->klass->rgctx_data->_4_ComponentPool_T__get_currentPoolSize);
}


Il2CppObject *__fastcall ComponentPool_object___Rent(ComponentPool_T__o *this, const MethodInfo_31ADEC4 *method)
{
  __int64 v4; // x1
  ...
  while ( 1 )
  {
    ...
    availableComponentList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                            ...
                                                                            0,
                                                                            (const MethodInfo_35C0AC0 *)method->klass->rgctx_data->_8_System_Collections_Generic_List_T__get_Item);
    ...
    System_Collections_Generic_List_object___RemoveAt(
      ...
      0,
      (const MethodInfo_35C2564 *)method->klass->rgctx_data->_9_System_Collections_Generic_List_T__RemoveAt);
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  availableComponentList = (System_Collections_Generic_List_object__o *)UnityEngine_Object__op_Equality(v5, 0LL, 0LL);
...
LABEL_36:
    ...
    availableComponentList = (System_Collections_Generic_List_object__o *)GameObjectExtensions__SafeGetComponent_object_(
                                                                            ...
                                                                            (const MethodInfo_2F83564 *)method->klass->rgctx_data->_5_GameObjectExtensions_SafeGetComponent_T_);
    v5 = (UnityEngine_Object_o *)availableComponentList;
    if ( !availableComponentList )
      goto LABEL_33;
  }
  ...
  if ( ComponentPool_object___get_currentPoolSize(
         this,
         (const MethodInfo_31ADD7C *)method->klass->rgctx_data->_4_ComponentPool_T__get_currentPoolSize) >= this->fields.poolSizeMax )
  ...
  {
LABEL_33:
    sub_1BD36B4(availableComponentList, v7);
  }
  ...
  if ( (unsigned int)size >= items->max_length )
  {
    System_Collections_Generic_List_object___AddWithResize(
      availableComponentList,
      (Il2CppObject *)v5,
      (const MethodInfo_35C0D90 *)_7_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
  }
  else
  {
    ...
    sub_1BD33FC((PartyOrganizationUtility_o *)(v21 + 4), (int64_t)v5, v12, v13, v14, v15, v16, v17);
  }
  return (Il2CppObject *)v5;
}


Il2CppObject *__fastcall ComponentPool_object___Rent_52093224(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        const MethodInfo_31AE128 *method)
{
  ...
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent(
                                           this,
                                           (const MethodInfo_31ADEC4 *)method->klass->rgctx_data->_10_ComponentPool_T__Rent);
  if ( !transform
...
// local variable allocation has failed, the output may be wrong!
Il2CppObject *__fastcall ComponentPool_object___Rent_52093304(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        UnityEngine_Vector3_o position,
        const MethodInfo_31AE178 *method)
{
  float z; // s8
  float y; // s9
  float x; // s10
  ...
  y = position.fields.y;
  x = position.fields.x;
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent_52093224(
                                           this,
                                           parent,
                                           (const MethodInfo_31AE128 *)method->klass->rgctx_data->_11_ComponentPool_T__Rent);
  if ( !transform
...
// local variable allocation has failed, the output may be wrong!
Il2CppObject *__fastcall ComponentPool_object___Rent_52093408(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        UnityEngine_Vector3_o position,
        UnityEngine_Quaternion_o rotation,
        const MethodInfo_31AE1E0 *method)
{
  float w; // s8
  float z; // s9
  float y; // s10
  ...
  y = rotation.fields.y;
  x = rotation.fields.x;
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent_52093304(
                                           this,
                                           parent,
                                           position,
                                           (const MethodInfo_31AE178 *)method->klass->rgctx_data->_12_ComponentPool_T__Rent);
  if ( !transform
        ...
        const MethodInfo_31AE250 *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)item, 0LL, 0LL) )
  {
    ...
    nonAvailableComponentList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___Contains(
                                                                               ...
                                                                               item,
                                                                               (const MethodInfo_35C1120 *)method->klass->rgctx_data->_13_System_Collections_Generic_List_T__Contains);
    ...
    if ( !nonAvailableComponentList
      ...
      || (System_Collections_Generic_List_object___Remove(
            nonAvailableComponentList,
            item,
            (const MethodInfo_35C22B8 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_T__Remove),
    ...
    {
LABEL_17:
      sub_1BD36B4(nonAvailableComponentList, v6);
    }
    ...
    else
    {
      ...
      sub_1BD33FC((PartyOrganizationUtility_o *)(v18 + 4), (int64_t)item, v9, v10, v11, v12, v13, v14);
    }
  }
}
...
void __fastcall ComponentPool_object___ShrinkPool(
        ...
        float rate,
        int32_t infmum,
        const MethodInfo_31AE3B8 *method)
{
  float v4; // s0
  int v5; // w8
...
int32_t __fastcall ComponentPool_object___get_currentPoolSize(
        ComponentPool_T__o *this,
        const MethodInfo_31ADD7C *method)
{
