void ComponentPool_object____ctor(
        ...
        int32_t poolSizeMax,
        const MethodInfo_33719D8 *method)
{
  int32_t v8; // w2
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.prefab, (int32_t)prefab, v8, v9);
  ...
  if ( (*(_BYTE *)(_1_System_Collections_Generic_List_T + 309) & 1) == 0 )
    _1_System_Collections_Generic_List_T = sub_1C83334();
  v11 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(_1_System_Collections_Generic_List_T);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_3797F88 *)method->klass->rgctx_data->_3_System_Collections_Generic_List_T___ctor);
  ...
  if ( (*(_BYTE *)(v14 + 309) & 1) == 0 )
    v14 = sub_1C83334();
  v15 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(v14);
  klass = method->klass;
  v17 = (struct System_Collections_Generic_List_T__o *)v15;
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_3797F88 *)klass->rgctx_data->_3_System_Collections_Generic_List_T___ctor);
  this->fields.nonAvailableComponentList = v17;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.nonAvailableComponentList, (int32_t)v17, v18, v19);
}


void ComponentPool_object___Clear(ComponentPool_T__o *this, const MethodInfo_3372030 *method)
{
  struct System_Collections_Generic_List_T__o *availableComponentList; // x0
  _BOOL8 v5; // x0
  const MethodInfo_33722A4 *v6; // x2
  struct System_Collections_Generic_List_T__o *v7; // x8
  int32_t size; // w2
  int v9; // w9
  _BOOL8 v10; // x0
  const MethodInfo_33722A4 *v11; // x2
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_37992B4 *)method->klass->rgctx_data->_16_System_Collections_Generic_List_T__GetEnumerator);
  for ( i = v15; ; ComponentPool_object___DestroyItem((ComponentPool_T__o *)v5, i.fields._current, v6) )
  {
    v5 = System_Collections_Generic_List_Enumerator_object___MoveNext(
           &i,
           (const MethodInfo_3522FA8 *)method->klass->rgctx_data->_20_System_Collections_Generic_List_Enumerator_T__MoveNext);
    if ( !v5 )
      break;
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &i,
    (const MethodInfo_3522FA4 *)method->klass->rgctx_data->_22_System_Collections_Generic_List_T__Clear);
...
LABEL_16:
    sub_1C32E7C(availableComponentList);
...
void ComponentPool_object___DestroyItem(ComponentPool_T__o *this, Il2CppObject *item, const MethodInfo_33722A4 *method)
{
  _BOOL8 v4; // x0
...
void ComponentPool_object___Finish(ComponentPool_T__o *this, const MethodInfo_3372278 *method)
{
  int32_t v3; // w2
  const MethodInfo *v4; // x3

  ComponentPool_object___Clear(this, (const MethodInfo_3372030 *)method->klass->rgctx_data[1]._0_ComponentPool_T_);
  this->fields.prefab = 0;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.prefab, 0, v3, v4);
}


void ComponentPool_object___Preload(ComponentPool_T__o *this, int32_t count, const MethodInfo_3371A9C *method)
{
  if ( (byte_4C3D25E & 1) == 0 )
  {
  ...
  ComponentPool_object___get_currentPoolSize(
    this,
    (const MethodInfo_33719AC *)method->klass->rgctx_data->_4_ComponentPool_T__get_currentPoolSize);
}


Il2CppObject *ComponentPool_object___Rent(ComponentPool_T__o *this, const MethodInfo_3371AF4 *method)
{
  ...
  while ( 1 )
  {
    ...
    availableComponentList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                            ...
                                                                            0,
                                                                            (const MethodInfo_37984EC *)method->klass->rgctx_data->_8_System_Collections_Generic_List_T__get_Item);
    ...
    System_Collections_Generic_List_object___RemoveAt(
      ...
      0,
      (const MethodInfo_3799F90 *)method->klass->rgctx_data->_9_System_Collections_Generic_List_T__RemoveAt);
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  availableComponentList = (System_Collections_Generic_List_object__o *)UnityEngine_Object__op_Equality(v4, 0, 0);
...
LABEL_36:
    ...
    availableComponentList = (System_Collections_Generic_List_object__o *)GameObjectExtensions__SafeGetComponent_object_(
                                                                            ...
                                                                            (const MethodInfo_3136458 *)method->klass->rgctx_data->_5_GameObjectExtensions_SafeGetComponent_T_);
    v4 = (UnityEngine_Object_o *)availableComponentList;
    if ( !availableComponentList )
      goto LABEL_33;
  }
  ...
  if ( ComponentPool_object___get_currentPoolSize(
         this,
         (const MethodInfo_33719AC *)method->klass->rgctx_data->_4_ComponentPool_T__get_currentPoolSize) >= this->fields.poolSizeMax )
...
LABEL_33:
  ...
  if ( (unsigned int)size >= LODWORD(items->max_length) )
  {
    System_Collections_Generic_List_object___AddWithResize(
      availableComponentList,
      (Il2CppObject *)v4,
      (const MethodInfo_37987BC *)_7_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
  }
  else
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)(v15 + 4), (int32_t)v4, v10, v11);
  }
  return (Il2CppObject *)v4;
}


Il2CppObject *ComponentPool_object___Rent_53943640(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        const MethodInfo_3371D58 *method)
{
  ...
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent(
                                           this,
                                           (const MethodInfo_3371AF4 *)method->klass->rgctx_data->_10_ComponentPool_T__Rent);
  if ( !transform
...
Il2CppObject *ComponentPool_object___Rent_53943720(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        UnityEngine_Vector3_o position,
        const MethodInfo_3371DA8 *method)
{
  float z; // s8
  float y; // s9
  float x; // s10
  ...
  y = position.fields.y;
  x = position.fields.x;
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent_53943640(
                                           this,
                                           parent,
                                           (const MethodInfo_3371D58 *)method->klass->rgctx_data->_11_ComponentPool_T__Rent);
  if ( !transform
...
Il2CppObject *ComponentPool_object___Rent_53943824(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        UnityEngine_Vector3_o position,
        UnityEngine_Quaternion_o rotation,
        const MethodInfo_3371E10 *method)
{
  float w; // s8
  float z; // s9
  float y; // s10
  ...
  y = rotation.fields.y;
  x = rotation.fields.x;
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent_53943720(
                                           this,
                                           parent,
                                           position,
                                           (const MethodInfo_3371DA8 *)method->klass->rgctx_data->_12_ComponentPool_T__Rent);
  if ( !transform
...
void ComponentPool_object___Return(ComponentPool_T__o *this, Il2CppObject *item, const MethodInfo_3371E80 *method)
{
  System_Collections_Generic_List_object__o *nonAvailableComponentList; // x0
  const MethodInfo_33722A4 *v7; // x2
  int32_t v8; // w2
  const MethodInfo *v9; // x3
  struct System_Object_array *items; // x8
  MethodInfo *_7_System_Collections_Generic_List_T__Add; // x9
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)item, 0, 0) )
  {
    ...
    nonAvailableComponentList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___Contains(
                                                                               ...
                                                                               item,
                                                                               (const MethodInfo_3798B4C *)method->klass->rgctx_data->_13_System_Collections_Generic_List_T__Contains);
    ...
    if ( !nonAvailableComponentList
      ...
      || (System_Collections_Generic_List_object___Remove(
            nonAvailableComponentList,
            item,
            (const MethodInfo_3799CE4 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_T__Remove),
    ...
    {
LABEL_17:
      sub_1C32E7C(nonAvailableComponentList);
    }
    ...
    else
    {
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)(v13 + 4), (int32_t)item, v8, v9);
    }
  }
}
...
void ComponentPool_object___ShrinkPool(
        ...
        float rate,
        int32_t infmum,
        const MethodInfo_3371FE8 *method)
{
  float v4; // s0
  int v5; // w8
...
int32_t ComponentPool_object___get_currentPoolSize(ComponentPool_T__o *this, const MethodInfo_33719AC *method)
{
