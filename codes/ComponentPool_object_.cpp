void ComponentPool_object____ctor(
        ...
        int32_t poolSizeMax,
        const MethodInfo_340949C *method)
{
  int32_t v8; // w2
  int32_t v9; // w3
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.prefab, (int32_t)prefab, v8, v9, v10, v11, v12, v13);
  ...
  if ( (*(_BYTE *)(_1_System_Collections_Generic_List_T + 309) & 1) == 0 )
    _1_System_Collections_Generic_List_T = sub_1C51B7C();
  v15 = (System_Collections_Generic_List_object__o *)sub_1C7BD34(_1_System_Collections_Generic_List_T);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_383E5C8 *)method->klass->rgctx_data->_3_System_Collections_Generic_List_T___ctor);
  ...
  if ( (*(_BYTE *)(v22 + 309) & 1) == 0 )
    v22 = sub_1C51B7C();
  v23 = (System_Collections_Generic_List_object__o *)sub_1C7BD34(v22);
  klass = method->klass;
  v25 = (struct System_Collections_Generic_List_T__o *)v23;
  System_Collections_Generic_List_object____ctor(
    v23,
    (const MethodInfo_383E5C8 *)klass->rgctx_data->_3_System_Collections_Generic_List_T___ctor);
...
void ComponentPool_object___Clear(ComponentPool_T__o *this, const MethodInfo_3409AF4 *method)
{
  struct System_Collections_Generic_List_T__o *availableComponentList; // x0
  _BOOL8 v5; // x0
  const MethodInfo_3409D68 *v6; // x2
  struct System_Collections_Generic_List_T__o *v7; // x8
  int32_t size; // w2
  int v9; // w9
  _BOOL8 v10; // x0
  const MethodInfo_3409D68 *v11; // x2
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_383F8F4 *)method->klass->rgctx_data->_16_System_Collections_Generic_List_T__GetEnumerator);
  for ( i = v15; ; ComponentPool_object___DestroyItem((ComponentPool_T__o *)v5, i.fields._current, v6) )
  {
    v5 = System_Collections_Generic_List_Enumerator_object___MoveNext(
           &i,
           (const MethodInfo_35BDF98 *)method->klass->rgctx_data->_20_System_Collections_Generic_List_Enumerator_T__MoveNext);
    if ( !v5 )
      break;
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &i,
    (const MethodInfo_35BDF94 *)method->klass->rgctx_data->_22_System_Collections_Generic_List_T__Clear);
...
LABEL_16:
    sub_1C7BD40(availableComponentList, method);
...
void ComponentPool_object___DestroyItem(ComponentPool_T__o *this, Il2CppObject *item, const MethodInfo_3409D68 *method)
{
  _BOOL8 v4; // x0
  __int64 v5; // x1
...
void ComponentPool_object___Finish(ComponentPool_T__o *this, const MethodInfo_3409D3C *method)
{
  int32_t v3; // w2
  int32_t v4; // w3
  ...
  ComponentPool_object___Clear(this, (const MethodInfo_3409AF4 *)method->klass->rgctx_data[1]._0_ComponentPool_T_);
  this->fields.prefab = 0;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.prefab, 0, v3, v4, v5, v6, v7, v8);
}


void ComponentPool_object___Preload(ComponentPool_T__o *this, int32_t count, const MethodInfo_3409560 *method)
{
  if ( (byte_4CF4066 & 1) == 0 )
  {
  ...
  ComponentPool_object___get_currentPoolSize(
    this,
    (const MethodInfo_3409470 *)method->klass->rgctx_data->_4_ComponentPool_T__get_currentPoolSize);
}


Il2CppObject *ComponentPool_object___Rent(ComponentPool_T__o *this, const MethodInfo_34095B8 *method)
{
  ...
  while ( 1 )
  {
    ...
    availableComponentList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                            ...
                                                                            0,
                                                                            (const MethodInfo_383EB2C *)method->klass->rgctx_data->_8_System_Collections_Generic_List_T__get_Item);
    ...
    System_Collections_Generic_List_object___RemoveAt(
      ...
      0,
      (const MethodInfo_38405D0 *)method->klass->rgctx_data->_9_System_Collections_Generic_List_T__RemoveAt);
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  availableComponentList = (System_Collections_Generic_List_object__o *)UnityEngine_Object__op_Equality(v4, 0, 0);
...
LABEL_36:
    ...
    availableComponentList = (System_Collections_Generic_List_object__o *)GameObjectExtensions__SafeGetComponent_object_(
                                                                            ...
                                                                            (const MethodInfo_31C8BB0 *)method->klass->rgctx_data->_5_GameObjectExtensions_SafeGetComponent_T_);
    v4 = (UnityEngine_Object_o *)availableComponentList;
    if ( !availableComponentList )
      goto LABEL_33;
  }
  ...
  if ( ComponentPool_object___get_currentPoolSize(
         this,
         (const MethodInfo_3409470 *)method->klass->rgctx_data->_4_ComponentPool_T__get_currentPoolSize) >= this->fields.poolSizeMax )
  ...
  {
LABEL_33:
    sub_1C7BD40(availableComponentList, v6);
  }
  ...
  if ( (unsigned int)size >= LODWORD(items->max_length) )
  {
    System_Collections_Generic_List_object___AddWithResize(
      availableComponentList,
      (Il2CppObject *)v4,
      (const MethodInfo_383EDFC *)_7_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
  }
  else
  {
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v20 + 4), (int32_t)v4, v11, v12, v13, v14, v15, v16);
  }
  return (Il2CppObject *)v4;
}


Il2CppObject *ComponentPool_object___Rent_54564892(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        const MethodInfo_340981C *method)
{
  ...
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent(
                                           this,
                                           (const MethodInfo_34095B8 *)method->klass->rgctx_data->_10_ComponentPool_T__Rent);
  if ( !transform
...
Il2CppObject *ComponentPool_object___Rent_54564972(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        UnityEngine_Vector3_o position,
        const MethodInfo_340986C *method)
{
  float z; // s8
  float y; // s9
  float x; // s10
  ...
  y = position.fields.y;
  x = position.fields.x;
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent_54564892(
                                           this,
                                           parent,
                                           (const MethodInfo_340981C *)method->klass->rgctx_data->_11_ComponentPool_T__Rent);
  if ( !transform
...
Il2CppObject *ComponentPool_object___Rent_54565076(
        ComponentPool_T__o *this,
        UnityEngine_Transform_o *parent,
        UnityEngine_Vector3_o position,
        UnityEngine_Quaternion_o rotation,
        const MethodInfo_34098D4 *method)
{
  float w; // s8
  float z; // s9
  float y; // s10
  ...
  y = rotation.fields.y;
  x = rotation.fields.x;
  transform = (UnityEngine_Component_o *)ComponentPool_object___Rent_54564972(
                                           this,
                                           parent,
                                           position,
                                           (const MethodInfo_340986C *)method->klass->rgctx_data->_12_ComponentPool_T__Rent);
  if ( !transform
...
void ComponentPool_object___Return(ComponentPool_T__o *this, Il2CppObject *item, const MethodInfo_3409944 *method)
{
  __int64 v6; // x1
  System_Collections_Generic_List_object__o *nonAvailableComponentList; // x0
  const MethodInfo_3409D68 *v8; // x2
  int32_t v9; // w2
  int32_t v10; // w3
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)item, 0, 0) )
  {
    ...
    nonAvailableComponentList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___Contains(
                                                                               ...
                                                                               item,
                                                                               (const MethodInfo_383F18C *)method->klass->rgctx_data->_13_System_Collections_Generic_List_T__Contains);
    ...
    if ( !nonAvailableComponentList
      ...
      || (System_Collections_Generic_List_object___Remove(
            nonAvailableComponentList,
            item,
            (const MethodInfo_3840324 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_T__Remove),
    ...
    {
LABEL_17:
      sub_1C7BD40(nonAvailableComponentList, v6);
    }
    ...
    else
    {
      ...
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v18 + 4), (int32_t)item, v9, v10, v11, v12, v13, v14);
    }
  }
}
...
void ComponentPool_object___ShrinkPool(
        ...
        float rate,
        int32_t infmum,
        const MethodInfo_3409AAC *method)
{
  float v4; // s0
  int v5; // w8
...
int32_t ComponentPool_object___get_currentPoolSize(ComponentPool_T__o *this, const MethodInfo_3409470 *method)
{
