        ...
        const MethodInfo *method)
{
  if ( (byte_4354B43 & 1) == 0 )
  {
    sub_B70694(&StringLiteral_18208/*"defaultRandomLimitCount"*/);
    sub_B70694(&StringLiteral_18209/*"defaultRandomLimitCountSupport"*/);
    byte_4354B43 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18208/*"defaultRandomLimitCount"*/, randomSettingOwnAll, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18209/*"defaultRandomLimitCountSupport"*/, randomSettingSupportAll, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B70694(&NetworkManager_TypeInfo);
    sub_B70694(&StringLiteral_17484/*"card/initRandomLimitCount"*/);
    byte_4354B41 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_17484/*"card/initRandomLimitCount"*/, 0LL);
}
