        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6844C & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_18779/*"defaultRandomLimitCount"*/, *(_QWORD *)&randomSettingOwnAll);
    sub_1BE4ACC(&StringLiteral_18780/*"defaultRandomLimitCountSupport"*/, v7);
    byte_4B6844C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18779/*"defaultRandomLimitCount"*/, randomSettingOwnAll, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18780/*"defaultRandomLimitCountSupport"*/, randomSettingSupportAll, v8);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&NetworkManager_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_17988/*"card/initRandomLimitCount"*/, v2);
    byte_4B6844A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_17988/*"card/initRandomLimitCount"*/, 0LL);
}
