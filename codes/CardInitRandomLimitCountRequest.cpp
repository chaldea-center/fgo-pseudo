        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A38B & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_18471/*"defaultRandomLimitCount"*/, *(_QWORD *)&randomSettingOwnAll);
    sub_1B686D4(&StringLiteral_18472/*"defaultRandomLimitCountSupport"*/, v7);
    byte_4A0A38B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18471/*"defaultRandomLimitCount"*/, randomSettingOwnAll, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18472/*"defaultRandomLimitCountSupport"*/, randomSettingSupportAll, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&NetworkManager_TypeInfo, method);
    sub_1B686D4(&StringLiteral_17690/*"card/initRandomLimitCount"*/, v2);
    byte_4A0A389 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_17690/*"card/initRandomLimitCount"*/, 0LL);
}
