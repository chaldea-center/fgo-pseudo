        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DF36 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_18384/*"defaultRandomLimitCount"*/, *(_QWORD *)&randomSettingOwnAll);
    sub_1BCAFF8(&StringLiteral_18385/*"defaultRandomLimitCountSupport"*/, v7);
    byte_4B1DF36 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18384/*"defaultRandomLimitCount"*/, randomSettingOwnAll, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18385/*"defaultRandomLimitCountSupport"*/, randomSettingSupportAll, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&NetworkManager_TypeInfo, method);
    sub_1BCAFF8(&StringLiteral_17606/*"card/initRandomLimitCount"*/, v2);
    byte_4B1DF34 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_17606/*"card/initRandomLimitCount"*/, 0LL);
}
