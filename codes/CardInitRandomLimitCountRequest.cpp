        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4647C & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_18546/*"defaultRandomLimitCount"*/, *(_QWORD *)&randomSettingOwnAll);
    sub_1BDB878(&StringLiteral_18547/*"defaultRandomLimitCountSupport"*/, v7);
    byte_4B4647C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18546/*"defaultRandomLimitCount"*/, randomSettingOwnAll, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18547/*"defaultRandomLimitCountSupport"*/, randomSettingSupportAll, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&NetworkManager_TypeInfo, method);
    sub_1BDB878(&StringLiteral_17763/*"card/initRandomLimitCount"*/, v2);
    byte_4B4647A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62572260(BaseUrl, (System_String_o *)StringLiteral_17763/*"card/initRandomLimitCount"*/, 0LL);
}
