        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02D7C & 1) == 0 )
  {
    sub_1B64A00(&int_TypeInfo, *(_QWORD *)&remainTime);
    sub_1B64A00(&LocalizationManager_TypeInfo, v4);
    sub_1B64A00(&StringLiteral_12147/*"SPOT_COOLTIME_REMAIN"*/, v5);
    sub_1B64A00(&StringLiteral_12145/*"SPOT_COOLTIME_NONE"*/, v6);
    byte_4A02D7C = 1;
  }
  if ( remainTime <= 0 )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_12145/*"SPOT_COOLTIME_NONE"*/, 0LL);
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_12147/*"SPOT_COOLTIME_REMAIN"*/, 0LL);
    v26 = v7;
    ...
    return System_String__Format_61399576(v10, v14, v18, v22, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02D81 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_12149/*"SPOT_COOLTIME_REWARD_COUNT"*/, v4);
    sub_1B64A00(&StringLiteral_12152/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/, v5);
    sub_1B64A00(&StringLiteral_12151/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/, v6);
    sub_1B64A00(&StringLiteral_12150/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/, v7);
    byte_4A02D81 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( remainTime <= 0 )
    v10 = (System_String_o **)&StringLiteral_12152/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/;
  else
    v10 = (System_String_o **)&StringLiteral_12151/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/;
  if ( remainTime <= 0 )
    v11 = (System_String_o **)&StringLiteral_12150/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/;
  else
    v11 = (System_String_o **)&StringLiteral_12149/*"SPOT_COOLTIME_REWARD_COUNT"*/;
  if ( !isQpType )
    v10 = v11;
  ...
  return System_String__Format_61399508(v12, v16, v20, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02D7D & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_GiftMaster___, userCooltimeRewardEntity);
  ...
  if ( userCooltimeRewardEntity )
  {
    ...
    if ( this->fields.cooltimeRewardEntity )
    {
      ...
      sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.targetSpot, (int32_t)targetSpot, v14, v15);
      ...
      if ( !*p_cooltimeRewardEntity
        ...
        || (DataById = GiftMaster__getDataById(
            ...
            sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.giftEntity, (int32_t)DataById, v19, v20),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02D7E & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_23339/*"spot_info_gauge_base"*/, v5);
    sub_1B64A00(&StringLiteral_23338/*"spot_info_gauge"*/, v6);
    sub_1B64A00(&StringLiteral_23343/*"spot_info_window"*/, v7);
    byte_4A02D7E = 1;
  }
  rewardItemInfoRoot = this->fields.rewardItemInfoRoot;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_37549424(eventId, rewardItemInfoRoot, (System_String_o *)StringLiteral_23343/*"spot_info_window"*/, 0LL);
  AtlasManager__SetEventUI_37549424(eventId, this->fields.rewardQpInfoRoot, (System_String_o *)StringLiteral_23343/*"spot_info_window"*/, 0LL);
  AtlasManager__SetEventUI_37549424(eventId, this->fields.gaugeBaseSprite, (System_String_o *)StringLiteral_23339/*"spot_info_gauge_base"*/, 0LL);
  v9 = AtlasManager__SetEventUI_37549424(eventId, this->fields.gaugeSprite, (System_String_o *)StringLiteral_23338/*"spot_info_gauge"*/, 0LL);
  ...
  if ( (int)v12 >= 1 )
  {
    ...
    do
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v9 = AtlasManager__SetEventUI_37549424(eventId, v14, (System_String_o *)StringLiteral_23339/*"spot_info_gauge_base"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02D80 & 1) == 0 )
  {
    sub_1B64A00(&AtlasManager_TypeInfo, giftEntity);
    byte_4A02D80 = 1;
  }
  if ( giftEntity )
  {
...
void __fastcall SpotCooltimeInfoComponent__UpdateDisp(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A02D7B & 1) == 0 )
  {
    this = (SpotCooltimeInfoComponent_o *)sub_1B64A00(&NetworkManager_TypeInfo, method);
    byte_4A02D7B = 1;
  }
...
LABEL_16:
  ...
  v6 = NetworkManager__getTime_38166364(v23, 0LL) - 1;
      ...
      if ( this->fields.cooltimeRewardEntity )
      {
        ...
        if ( *p_cooltimeRewardEntity && Master_object )
        {
          DataById = GiftMaster__getDataById(
                       ...
                       0LL);
          this->fields.giftEntity = DataById;
          sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.giftEntity, (int32_t)DataById, v16, v17);
