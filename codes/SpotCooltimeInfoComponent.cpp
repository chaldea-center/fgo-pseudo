        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CED5 & 1) == 0 )
  {
    sub_1B686D4(&int_TypeInfo, *(_QWORD *)&remainTime);
    sub_1B686D4(&LocalizationManager_TypeInfo, v4);
    sub_1B686D4(&StringLiteral_12148/*"SPOT_COOLTIME_REMAIN"*/, v5);
    sub_1B686D4(&StringLiteral_12146/*"SPOT_COOLTIME_NONE"*/, v6);
    byte_4A0CED5 = 1;
  }
  if ( remainTime <= 0 )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_12146/*"SPOT_COOLTIME_NONE"*/, 0LL);
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_12148/*"SPOT_COOLTIME_REMAIN"*/, 0LL);
    v26 = v7;
    ...
    return System_String__Format_61433908(v10, v14, v18, v22, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CEDA & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_12150/*"SPOT_COOLTIME_REWARD_COUNT"*/, v4);
    sub_1B686D4(&StringLiteral_12153/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/, v5);
    sub_1B686D4(&StringLiteral_12152/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/, v6);
    sub_1B686D4(&StringLiteral_12151/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/, v7);
    byte_4A0CEDA = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( remainTime <= 0 )
    v10 = (System_String_o **)&StringLiteral_12153/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/;
  else
    v10 = (System_String_o **)&StringLiteral_12152/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/;
  if ( remainTime <= 0 )
    v11 = (System_String_o **)&StringLiteral_12151/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/;
  else
    v11 = (System_String_o **)&StringLiteral_12150/*"SPOT_COOLTIME_REWARD_COUNT"*/;
  if ( !isQpType )
    v10 = v11;
  ...
  return System_String__Format_61433840(v12, v16, v20, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CED6 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMaster_GiftMaster___, userCooltimeRewardEntity);
  ...
  if ( userCooltimeRewardEntity )
  {
    ...
    if ( this->fields.cooltimeRewardEntity )
    {
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.targetSpot, (int32_t)targetSpot, v14, v15);
      ...
      if ( !*p_cooltimeRewardEntity
        ...
        || (DataById = GiftMaster__getDataById(
            ...
            sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.giftEntity, (int32_t)DataById, v19, v20),
      ...
      SpotCooltimeInfoComponent__UpdateDisp(this, v24);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CED7 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_23352/*"spot_info_gauge_base"*/, v5);
    sub_1B686D4(&StringLiteral_23351/*"spot_info_gauge"*/, v6);
    sub_1B686D4(&StringLiteral_23356/*"spot_info_window"*/, v7);
    byte_4A0CED7 = 1;
  }
  rewardItemInfoRoot = this->fields.rewardItemInfoRoot;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_37606672(eventId, rewardItemInfoRoot, (System_String_o *)StringLiteral_23356/*"spot_info_window"*/, 0LL);
  AtlasManager__SetEventUI_37606672(eventId, this->fields.rewardQpInfoRoot, (System_String_o *)StringLiteral_23356/*"spot_info_window"*/, 0LL);
  AtlasManager__SetEventUI_37606672(eventId, this->fields.gaugeBaseSprite, (System_String_o *)StringLiteral_23352/*"spot_info_gauge_base"*/, 0LL);
  v9 = AtlasManager__SetEventUI_37606672(eventId, this->fields.gaugeSprite, (System_String_o *)StringLiteral_23351/*"spot_info_gauge"*/, 0LL);
  ...
  if ( (int)v12 >= 1 )
  {
    ...
    do
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v9 = AtlasManager__SetEventUI_37606672(eventId, v14, (System_String_o *)StringLiteral_23352/*"spot_info_gauge_base"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CED9 & 1) == 0 )
  {
    sub_1B686D4(&AtlasManager_TypeInfo, giftEntity);
    byte_4A0CED9 = 1;
  }
  if ( giftEntity )
  {
...
void __fastcall SpotCooltimeInfoComponent__UpdateDisp(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0CED4 & 1) == 0 )
  {
    this = (SpotCooltimeInfoComponent_o *)sub_1B686D4(&NetworkManager_TypeInfo, method);
    byte_4A0CED4 = 1;
  }
...
LABEL_16:
  ...
  v6 = NetworkManager__getTime_38223372(v23, 0LL) - 1;
      ...
      if ( this->fields.cooltimeRewardEntity )
      {
        ...
        if ( *p_cooltimeRewardEntity && Master_object )
        {
          DataById = GiftMaster__getDataById(
                       ...
                       0LL);
          this->fields.giftEntity = DataById;
          sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.giftEntity, (int32_t)DataById, v16, v17);
