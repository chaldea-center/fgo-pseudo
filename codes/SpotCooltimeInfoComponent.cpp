        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8F37 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_12334/*"SPOT_COOLTIME_REMAIN"*/);
    sub_1C7BAE8(&StringLiteral_12332/*"SPOT_COOLTIME_NONE"*/);
    byte_4CE8F37 = 1;
  }
  if ( remainTime <= 0 )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_12332/*"SPOT_COOLTIME_NONE"*/, 0);
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_12334/*"SPOT_COOLTIME_REMAIN"*/, 0);
    v14 = v4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8F3C & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_12336/*"SPOT_COOLTIME_REWARD_COUNT"*/);
    sub_1C7BAE8(&StringLiteral_12339/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/);
    sub_1C7BAE8(&StringLiteral_12338/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/);
    sub_1C7BAE8(&StringLiteral_12337/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/);
    byte_4CE8F3C = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( remainTime <= 0 )
    v5 = (System_String_o **)&StringLiteral_12339/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/;
  else
    v5 = (System_String_o **)&StringLiteral_12338/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/;
  if ( remainTime <= 0 )
    v6 = (System_String_o **)&StringLiteral_12337/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/;
  else
    v6 = (System_String_o **)&StringLiteral_12336/*"SPOT_COOLTIME_REWARD_COUNT"*/;
  if ( !isQpType )
    v5 = v6;
  ...
  return System_String__Format_64218220(v7, v8, v9, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( userCooltimeRewardEntity )
  {
    ...
    sub_1C7BA8C(&this->fields.cooltimeRewardEntity, EventCooltimeRewardEntity);
    if ( this->fields.cooltimeRewardEntity )
    {
      this->fields.userCooltimeRewardEntity = userCooltimeRewardEntity;
      sub_1C7BA8C(&this->fields.userCooltimeRewardEntity, userCooltimeRewardEntity);
      ...
      if ( !*p_cooltimeRewardEntity
        ...
        || (DataById = GiftMaster__getDataById(
            ...
            Master_object = (Il2CppObject *)sub_1C7BA8C(&this->fields.giftEntity, DataById),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8F39 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_23829/*"spot_info_gauge"*/);
  ...
  AtlasManager__SetEventUI_41168628(eventId, rewardItemInfoRoot, (System_String_o *)StringLiteral_23834/*"spot_info_window"*/, 0);
  AtlasManager__SetEventUI_41168628(eventId, this->fields.rewardQpInfoRoot, (System_String_o *)StringLiteral_23834/*"spot_info_window"*/, 0);
  AtlasManager__SetEventUI_41168628(eventId, this->fields.gaugeBaseSprite, (System_String_o *)StringLiteral_23830/*"spot_info_gauge_base"*/, 0);
  v6 = AtlasManager__SetEventUI_41168628(eventId, this->fields.gaugeSprite, (System_String_o *)StringLiteral_23829/*"spot_info_gauge"*/, 0);
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v6 = AtlasManager__SetEventUI_41168628(eventId, v11, (System_String_o *)StringLiteral_23830/*"spot_info_gauge_base"*/, 0);
...
void SpotCooltimeInfoComponent__UpdateDisp(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE8F36 & 1) == 0 )
  {
    this = (SpotCooltimeInfoComponent_o *)sub_1C7BAE8(&NetworkManager_TypeInfo);
    byte_4CE8F36 = 1;
  }
...
LABEL_16:
  ...
  v7 = NetworkManager__getTime_41942424(v6, 0) - 1;
...
void SpotCooltimeInfoComponent__UpdateUserData(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.userCooltimeRewardEntity )
  {
    ...
    *p_userCooltimeRewardEntity = CurrentLevelEntity;
    sub_1C7BA8C(&this->fields.userCooltimeRewardEntity, CurrentLevelEntity);
    if ( *p_userCooltimeRewardEntity )
    {
      ...
      if ( this->fields.cooltimeRewardEntity )
      {
        ...
        if ( *p_cooltimeRewardEntity && Master_object )
        {
          ...
          this->fields.giftEntity = DataById;
          sub_1C7BA8C(&this->fields.giftEntity, DataById);
