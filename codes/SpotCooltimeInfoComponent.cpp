        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71E28 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_12455/*"SPOT_COOLTIME_REMAIN"*/);
    sub_1D0F0B4(&StringLiteral_12453/*"SPOT_COOLTIME_NONE"*/);
    byte_4E71E28 = 1;
  }
  if ( remainTime <= 0 )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_12453/*"SPOT_COOLTIME_NONE"*/, 0);
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_12455/*"SPOT_COOLTIME_REMAIN"*/, 0);
    v14 = v4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71E2D & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_12457/*"SPOT_COOLTIME_REWARD_COUNT"*/);
    sub_1D0F0B4(&StringLiteral_12460/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/);
    sub_1D0F0B4(&StringLiteral_12459/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/);
    sub_1D0F0B4(&StringLiteral_12458/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/);
    byte_4E71E2D = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( remainTime <= 0 )
    v5 = (System_String_o **)&StringLiteral_12460/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/;
  else
    v5 = (System_String_o **)&StringLiteral_12459/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/;
  if ( remainTime <= 0 )
    v6 = (System_String_o **)&StringLiteral_12458/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/;
  else
    v6 = (System_String_o **)&StringLiteral_12457/*"SPOT_COOLTIME_REWARD_COUNT"*/;
  if ( !isQpType )
    v5 = v6;
  ...
  return System_String__Format_65604080(v7, v8, v9, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( userCooltimeRewardEntity )
  {
    ...
    sub_1D0F058(&this->fields.cooltimeRewardEntity, EventCooltimeRewardEntity);
    if ( this->fields.cooltimeRewardEntity )
    {
      this->fields.userCooltimeRewardEntity = userCooltimeRewardEntity;
      sub_1D0F058(&this->fields.userCooltimeRewardEntity, userCooltimeRewardEntity);
      this->fields.targetSpot = targetSpot;
      sub_1D0F058(&this->fields.targetSpot, targetSpot);
      ...
      if ( !*p_cooltimeRewardEntity
        ...
        || (DataById = GiftMaster__getDataById(
            ...
            Master_object = (Il2CppObject *)sub_1D0F058(&this->fields.giftEntity, DataById),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71E2A & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_24081/*"spot_info_gauge"*/);
  ...
  AtlasManager__SetEventUI_41967144(eventId, rewardItemInfoRoot, (System_String_o *)StringLiteral_24086/*"spot_info_window"*/, 0);
  AtlasManager__SetEventUI_41967144(eventId, this->fields.rewardQpInfoRoot, (System_String_o *)StringLiteral_24086/*"spot_info_window"*/, 0);
  AtlasManager__SetEventUI_41967144(eventId, this->fields.gaugeBaseSprite, (System_String_o *)StringLiteral_24082/*"spot_info_gauge_base"*/, 0);
  v6 = AtlasManager__SetEventUI_41967144(eventId, this->fields.gaugeSprite, (System_String_o *)StringLiteral_24081/*"spot_info_gauge"*/, 0);
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v6 = AtlasManager__SetEventUI_41967144(eventId, v11, (System_String_o *)StringLiteral_24082/*"spot_info_gauge_base"*/, 0);
...
void SpotCooltimeInfoComponent__UpdateDisp(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71E27 & 1) == 0 )
  {
    this = (SpotCooltimeInfoComponent_o *)sub_1D0F0B4(&NetworkManager_TypeInfo);
    byte_4E71E27 = 1;
  }
...
LABEL_16:
  ...
  v7 = NetworkManager__getTime_42740560(v6, 0) - 1;
...
void SpotCooltimeInfoComponent__UpdateUserData(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.userCooltimeRewardEntity )
  {
    ...
    *p_userCooltimeRewardEntity = CurrentLevelEntity;
    sub_1D0F058(&this->fields.userCooltimeRewardEntity, CurrentLevelEntity);
    if ( *p_userCooltimeRewardEntity )
    {
      ...
      if ( this->fields.cooltimeRewardEntity )
      {
        ...
        if ( *p_cooltimeRewardEntity && Master_object )
        {
          ...
          this->fields.giftEntity = DataById;
          sub_1D0F058(&this->fields.giftEntity, DataById);
