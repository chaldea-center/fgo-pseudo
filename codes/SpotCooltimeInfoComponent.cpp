        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v9; // x21
  Il2CppObject *v10; // x0
  unsigned int v12; // [xsp+Ch] [xbp-44h] BYREF
  unsigned int v13; // [xsp+18h] [xbp-38h] BYREF
  unsigned int v14; // [xsp+1Ch] [xbp-34h] BYREF

  if ( (byte_4DFF230 & 1) == 0 )
  {
    sub_1CE6700(&int_TypeInfo);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_12406/*"SPOT_COOLTIME_REMAIN"*/);
    sub_1CE6700(&StringLiteral_12404/*"SPOT_COOLTIME_NONE"*/);
    byte_4DFF230 = 1;
  }
  if ( remainTime <= 0 )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_12404/*"SPOT_COOLTIME_NONE"*/, 0);
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_12406/*"SPOT_COOLTIME_REMAIN"*/, 0);
    v14 = v4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF235 & 1) == 0 )
  {
    ...
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_12408/*"SPOT_COOLTIME_REWARD_COUNT"*/);
    sub_1CE6700(&StringLiteral_12411/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/);
    sub_1CE6700(&StringLiteral_12410/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/);
    sub_1CE6700(&StringLiteral_12409/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/);
    byte_4DFF235 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( remainTime <= 0 )
    v5 = (System_String_o **)&StringLiteral_12411/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/;
  else
    v5 = (System_String_o **)&StringLiteral_12410/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/;
  if ( remainTime <= 0 )
    v6 = (System_String_o **)&StringLiteral_12409/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/;
  else
    v6 = (System_String_o **)&StringLiteral_12408/*"SPOT_COOLTIME_REWARD_COUNT"*/;
  if ( !isQpType )
    v5 = v6;
  v7 = LocalizationManager__Get(*v5, 0);
  receivedRewardNum = this->fields.receivedRewardNum;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &receivedRewardNum);
  maxRewardNum = this->fields.maxRewardNum;
  v9 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &maxRewardNum);
  return System_String__Format_65164136(v7, v8, v9, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( userCooltimeRewardEntity )
  {
    ...
    sub_1CE66A4(&this->fields.cooltimeRewardEntity, EventCooltimeRewardEntity);
    if ( this->fields.cooltimeRewardEntity )
    {
      this->fields.userCooltimeRewardEntity = userCooltimeRewardEntity;
      sub_1CE66A4(&this->fields.userCooltimeRewardEntity, userCooltimeRewardEntity);
      this->fields.targetSpot = targetSpot;
      sub_1CE66A4(&this->fields.targetSpot, targetSpot);
      ...
      if ( !*p_cooltimeRewardEntity
        ...
        || (DataById = GiftMaster__getDataById(
            ...
            Master_object = (Il2CppObject *)sub_1CE66A4(&this->fields.giftEntity, DataById),
            (cooltimeRewardEntity = this->fields.cooltimeRewardEntity) == 0) )
      {
        sub_1CE6958(Master_object, v10);
      }
      SpotCooltimeInfoComponent__SetupBaseUI(this, cooltimeRewardEntity->fields.eventId, v12);
      SpotCooltimeInfoComponent__SetupRewardInfo(this, this->fields.giftEntity, v14);
      SpotCooltimeInfoComponent__UpdateDisp(this, v15);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF232 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_23979/*"spot_info_gauge"*/);
  ...
  AtlasManager__SetEventUI_41749752(eventId, rewardItemInfoRoot, (System_String_o *)StringLiteral_23984/*"spot_info_window"*/, 0);
  AtlasManager__SetEventUI_41749752(eventId, this->fields.rewardQpInfoRoot, (System_String_o *)StringLiteral_23984/*"spot_info_window"*/, 0);
  AtlasManager__SetEventUI_41749752(eventId, this->fields.gaugeBaseSprite, (System_String_o *)StringLiteral_23980/*"spot_info_gauge_base"*/, 0);
  v6 = AtlasManager__SetEventUI_41749752(eventId, this->fields.gaugeSprite, (System_String_o *)StringLiteral_23979/*"spot_info_gauge"*/, 0);
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    do
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v6 = AtlasManager__SetEventUI_41749752(eventId, v11, (System_String_o *)StringLiteral_23980/*"spot_info_gauge_base"*/, 0);
      ...
      case 7:
        ...
        else
        {
          if ( !cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          v5 = 1;
          AtlasManager__SetFaceImage(rewardServantItemIcon, objectId, 0, 1, 0, 0, 0);
        }
        goto LABEL_29;
      case 2:
...
void SpotCooltimeInfoComponent__UpdateDisp(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF22F & 1) == 0 )
  {
    this = (SpotCooltimeInfoComponent_o *)sub_1CE6700(&NetworkManager_TypeInfo);
    byte_4DFF22F = 1;
  }
...
LABEL_16:
  ...
  v7 = NetworkManager__getTime_42519948(v6, 0) - 1;
...
void SpotCooltimeInfoComponent__UpdateUserData(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.userCooltimeRewardEntity )
  {
    ...
    *p_userCooltimeRewardEntity = CurrentLevelEntity;
    sub_1CE66A4(&this->fields.userCooltimeRewardEntity, CurrentLevelEntity);
    if ( *p_userCooltimeRewardEntity )
    {
      ...
      if ( this->fields.cooltimeRewardEntity )
      {
        ...
        if ( *p_cooltimeRewardEntity && Master_object )
        {
          ...
          this->fields.giftEntity = DataById;
          sub_1CE66A4(&this->fields.giftEntity, DataById);
          SpotCooltimeInfoComponent__UpdateDisp(this, v10);
          return;
        }
LABEL_16:
