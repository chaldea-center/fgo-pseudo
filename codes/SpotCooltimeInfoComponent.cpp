        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16F0F & 1) == 0 )
  {
    sub_1BCAFF8(&int_TypeInfo, *(_QWORD *)&remainTime);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v4);
    sub_1BCAFF8(&StringLiteral_12177/*"SPOT_COOLTIME_REMAIN"*/, v5);
    sub_1BCAFF8(&StringLiteral_12175/*"SPOT_COOLTIME_NONE"*/, v6);
    byte_4B16F0F = 1;
  }
  if ( remainTime <= 0 )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_12175/*"SPOT_COOLTIME_NONE"*/, 0LL);
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_12177/*"SPOT_COOLTIME_REMAIN"*/, 0LL);
    v26 = v7;
    ...
    return System_String__Format_62491784(v10, v14, v18, v22, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16F14 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_12179/*"SPOT_COOLTIME_REWARD_COUNT"*/, v4);
    sub_1BCAFF8(&StringLiteral_12182/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/, v5);
    sub_1BCAFF8(&StringLiteral_12181/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/, v6);
    sub_1BCAFF8(&StringLiteral_12180/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/, v7);
    byte_4B16F14 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  if ( remainTime <= 0 )
    v10 = (System_String_o **)&StringLiteral_12182/*"SPOT_COOLTIME_REWARD_COUNT_QP_MAX"*/;
  else
    v10 = (System_String_o **)&StringLiteral_12181/*"SPOT_COOLTIME_REWARD_COUNT_QP"*/;
  if ( remainTime <= 0 )
    v11 = (System_String_o **)&StringLiteral_12180/*"SPOT_COOLTIME_REWARD_COUNT_MAX"*/;
  else
    v11 = (System_String_o **)&StringLiteral_12179/*"SPOT_COOLTIME_REWARD_COUNT"*/;
  if ( !isQpType )
    v10 = v11;
  ...
  return System_String__Format_62491716(v12, v16, v20, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16F10 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_GiftMaster___, userCooltimeRewardEntity);
    ...
    if ( this->fields.cooltimeRewardEntity )
    {
      ...
      if ( !*p_cooltimeRewardEntity
        ...
        || (this->fields.giftEntity = GiftMaster__getDataById(
                                        ...
                                        0LL),
            Master_object = (Il2CppObject *)sub_1BCAF9C(&this->fields.giftEntity),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16F11 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_23394/*"spot_info_gauge_base"*/, v5);
    sub_1BCAFF8(&StringLiteral_23393/*"spot_info_gauge"*/, v6);
    sub_1BCAFF8(&StringLiteral_23398/*"spot_info_window"*/, v7);
    byte_4B16F11 = 1;
  }
  rewardItemInfoRoot = this->fields.rewardItemInfoRoot;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_39794720(eventId, rewardItemInfoRoot, (System_String_o *)StringLiteral_23398/*"spot_info_window"*/, 0LL);
  AtlasManager__SetEventUI_39794720(eventId, this->fields.rewardQpInfoRoot, (System_String_o *)StringLiteral_23398/*"spot_info_window"*/, 0LL);
  AtlasManager__SetEventUI_39794720(eventId, this->fields.gaugeBaseSprite, (System_String_o *)StringLiteral_23394/*"spot_info_gauge_base"*/, 0LL);
  v9 = AtlasManager__SetEventUI_39794720(eventId, this->fields.gaugeSprite, (System_String_o *)StringLiteral_23393/*"spot_info_gauge"*/, 0LL);
  ...
  if ( (int)v13 >= 1 )
  {
    ...
    do
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v9 = AtlasManager__SetEventUI_39794720(eventId, v15, (System_String_o *)StringLiteral_23394/*"spot_info_gauge_base"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16F13 & 1) == 0 )
  {
    sub_1BCAFF8(&AtlasManager_TypeInfo, giftEntity);
    byte_4B16F13 = 1;
  }
  if ( giftEntity )
  {
...
void __fastcall SpotCooltimeInfoComponent__UpdateDisp(SpotCooltimeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B16F0E & 1) == 0 )
  {
    this = (SpotCooltimeInfoComponent_o *)sub_1BCAFF8(&NetworkManager_TypeInfo, method);
    byte_4B16F0E = 1;
  }
...
LABEL_16:
  ...
  v6 = NetworkManager__getTime_40542184(v23, 0LL) - 1;
      ...
      if ( this->fields.cooltimeRewardEntity )
      {
        ...
        if ( *p_cooltimeRewardEntity && Master_object )
        {
          this->fields.giftEntity = GiftMaster__getDataById(
                                      ...
                                      (*p_cooltimeRewardEntity)->fields.giftId,
                                      0LL);
          sub_1BCAF9C(&this->fields.giftEntity);
