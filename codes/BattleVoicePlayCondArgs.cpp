        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields, (int64_t)btlData, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24958 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Linq_Enumerable_Distinct_int___, *(_QWORD *)&targetIndividuality);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&Method_System_Linq_Enumerable_Distinct_int___, *(_QWORD *)&targetIndividuality);
    this = (BattleVoicePlayCondArgs_o *)sub_1C3B764(&Method_System_Linq_Enumerable_ToArray_int___, v5);
    byte_4C24957 = 1;
  }
  ...
  {
    sub_1C3B9C0(this, *(_QWORD *)&targetIndividuality);
  }
  ...
  if ( (int)ServantData_k__BackingField >= 1 )
  {
    ...
    do
    {
      if ( v12 >= (unsigned int)ServantData_k__BackingField )
        sub_1C3B9C8(this, *(_QWORD *)&targetIndividuality);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24956 & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, *(_QWORD *)&targetQuestId);
    byte_4C24956 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24959 & 1) == 0 )
  {
    sub_1C3B764(&Individuality_TypeInfo, *(_QWORD *)&targetUniqueId);
  ...
  if ( !BattleServantData__isAlive(v13, 0, 0LL) )
    return 0;
  v11 = (struct BattleData_o *)sub_1C3B80C(int___TypeInfo, 1LL);
  if ( !v11 )
LABEL_15:
    sub_1C3B9C0(v11, v10);
