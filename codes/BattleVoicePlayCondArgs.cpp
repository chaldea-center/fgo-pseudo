        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields, (int32_t)btlData, v9, v10);
  this->fields._ServantData_k__BackingField = svtData;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._ServantData_k__BackingField, (int32_t)svtData, v11, v12);
  this->fields._ActionData_k__BackingField = actData;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields._ActionData_k__BackingField, (int32_t)actData, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD892 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Linq_Enumerable_Distinct_int___, *(_QWORD *)&targetIndividuality);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&Method_System_Linq_Enumerable_Distinct_int___, *(_QWORD *)&targetIndividuality);
    this = (BattleVoicePlayCondArgs_o *)sub_1B4CF90(&Method_System_Linq_Enumerable_ToArray_int___, v5);
    byte_49BD891 = 1;
  }
  ...
  {
    sub_1B4D1EC(this, *(_QWORD *)&targetIndividuality);
  }
  ...
  if ( (int)ServantData_k__BackingField >= 1 )
  {
    ...
    do
    {
      if ( v12 >= (unsigned int)ServantData_k__BackingField )
        sub_1B4D1F4(this, *(_QWORD *)&targetIndividuality);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD890 & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, *(_QWORD *)&targetQuestId);
    byte_49BD890 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD893 & 1) == 0 )
  {
    sub_1B4CF90(&Individuality_TypeInfo, *(_QWORD *)&targetUniqueId);
  ...
  if ( !BattleServantData__isAlive(v13, 0, 0LL) )
    return 0;
  v11 = (struct BattleData_o *)sub_1B4D038(int___TypeInfo, 1LL);
  if ( !v11 )
LABEL_15:
    sub_1B4D1EC(v11, v10);
