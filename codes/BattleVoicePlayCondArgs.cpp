        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)btlData, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B453 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Linq_Enumerable_Distinct_int___, *(_QWORD *)&targetIndividuality);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&Method_System_Linq_Enumerable_Distinct_int___, *(_QWORD *)&targetIndividuality);
    this = (BattleVoicePlayCondArgs_o *)sub_1B686D4(&Method_System_Linq_Enumerable_ToArray_int___, v5);
    byte_4A0B452 = 1;
  }
  ...
  {
    sub_1B68930(this, *(_QWORD *)&targetIndividuality);
  }
  ...
  if ( (int)ServantData_k__BackingField >= 1 )
  {
    ...
    do
    {
      if ( v12 >= (unsigned int)ServantData_k__BackingField )
        sub_1B68938(this, *(_QWORD *)&targetIndividuality);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B451 & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, *(_QWORD *)&targetQuestId);
    byte_4A0B451 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B454 & 1) == 0 )
  {
    sub_1B686D4(&int___TypeInfo, *(_QWORD *)&targetUniqueId);
  ...
  if ( !BattleServantData__isAlive(v12, 0, 0LL) )
    return 0;
  v10 = (struct BattleData_o *)sub_1B6877C(int___TypeInfo, 1LL);
  if ( !v10 )
LABEL_13:
    sub_1B68930(v10, v9);
