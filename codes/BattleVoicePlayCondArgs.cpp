        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)btlData, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&Method_System_Linq_Enumerable_Distinct_int___);
    this = (BattleVoicePlayCondArgs_o *)sub_1B885B0(&Method_System_Linq_Enumerable_ToArray_int___);
    byte_4A5D990 = 1;
  }
  ...
  {
    sub_1B8880C(this, *(_QWORD *)&targetIndividuality);
  }
  ...
  if ( (int)ServantData_k__BackingField >= 1 )
  {
    ...
    do
    {
      if ( v11 >= (unsigned int)ServantData_k__BackingField )
        sub_1B88814(this, *(_QWORD *)&targetIndividuality);
        ...
        const MethodInfo *method)
{
  ...
  if ( !v9 )
    goto LABEL_13;
  ServantData = BattleData__getServantData(v9, targetUniqueId, 0LL);
  if ( !ServantData )
    return 0;
  v11 = ServantData;
  ConcatServantAndBuffIndividualityies = BattleServantData__getConcatServantAndBuffIndividualityies(
                                           ...
                                           0,
                                           0LL);
  if ( !BattleServantData__isAlive(v11, 0, 0LL) )
    return 0;
  v9 = (struct BattleData_o *)sub_1B88658(int___TypeInfo, 1LL);
  if ( !v9 )
LABEL_13:
    sub_1B8880C(v9, v8);
  if ( !LODWORD(v9->fields.m_CancellationTokenSource) )
    sub_1B88814(v9, v9);
  LODWORD(v9->fields.rootfsm) = targetIndividuality;
  return Individuality__CheckIndividualities(ConcatServantAndBuffIndividualityies, (System_Int32_array *)v9, 0LL);
}
