void OtherUserNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E789F8 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_6743/*"Fgo_20151127_1"*/);
    byte_4E789F8 = 1;
  }
  OtherUserNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6743/*"Fgo_20151127_1"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)OtherUserNewManager_TypeInfo->static_fields,
    StringLiteral_6743/*"Fgo_20151127_1"*/,
    v1,
    v2,
    v3,
    v4,
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v6 - 1,
             (const MethodInfo_3944154 *)Method_System_Collections_Generic_List_long__get_Item__) == userId )
        return !v7;
      v7 = v6 < size;
      if ( size == v6 )
        return !v7;
  ...
  if ( v1->static_fields->isContinueDevice )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_324F1B8 *)Method_DataManager_GetMasterData_OtherUserGameMaster___)) == 0 )
    {
...
bool OtherUserNewManager__ReadData(const MethodInfo *method)
{
  ...
  {
LABEL_33:
    v26 = sub_1CE5430(v7, System_IDisposable_TypeInfo, 0);
  }
...
void OtherUserNewManager__SetOld_44754208(System_Int64_array *userList, const MethodInfo *method)
{
