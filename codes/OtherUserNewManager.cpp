void OtherUserNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC874F & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_6665/*"Fgo_20151127_1"*/);
    byte_4CC874F = 1;
  }
  ...
  sub_1C71354(
    ...
    StringLiteral_6665/*"Fgo_20151127_1"*/,
    v1,
    v2,
    v3,
    v4,
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v6 - 1,
             (const MethodInfo_37F845C *)Method_System_Collections_Generic_List_long__get_Item__) == userId )
        return !v7;
      v7 = v6 < size;
      if ( size == v6 )
        return !v7;
...
bool OtherUserNewManager__ReadData(const MethodInfo *method)
{
  ...
  {
LABEL_33:
    v26 = sub_1C47738(v7, System_IDisposable_TypeInfo, 0);
  }
...
void OtherUserNewManager__SetOld_43679784(System_Int64_array *userList, const MethodInfo *method)
{
