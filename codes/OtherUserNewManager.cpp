void __fastcall OtherUserNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A20BE2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&OtherUserNewManager_TypeInfo, v5);
    sub_1B715CC(&StringLiteral_6614/*"Fgo_20151127_1"*/, v6);
    byte_4A20BE2 = 1;
  }
  ...
  sub_1B71570(
    ...
    StringLiteral_6614/*"Fgo_20151127_1"*/,
    v2,
    v3);
...
void __fastcall OtherUserNewManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4A20BDB & 1) == 0 )
  {
    ...
    sub_1B715CC(&OtherUserNewManager_TypeInfo, v3);
    byte_4A20BDB = 1;
  }
...
void __fastcall OtherUserNewManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20BD9 & 1) == 0 )
  {
    sub_1B715CC(&OtherUserNewManager_TypeInfo, v1);
    byte_4A20BD9 = 1;
  }
...
bool __fastcall OtherUserNewManager__IsNew(int64_t userId, const MethodInfo *method)
{
  ...
  if ( (byte_4A20BDD & 1) == 0 )
  {
    ...
    sub_1B715CC(&OtherUserNewManager_TypeInfo, v4);
    byte_4A20BDD = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v8 - 1,
             (const MethodInfo_34B7FA4 *)Method_System_Collections_Generic_List_long__get_Item__) == userId )
        return !v9;
      v9 = v8 < size;
      if ( size == v8 )
        return !v9;
...
void __fastcall OtherUserNewManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A20BDC & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_OtherUserGameMaster___, v1);
    sub_1B715CC(&OtherUserNewManager_TypeInfo, v2);
...
bool __fastcall OtherUserNewManager__ReadData(const MethodInfo *method)
{
      ...
      do
      {
        ...
        if ( (unsigned int)size >= items->max_length )
        {
          System_Collections_Generic_List_long___AddWithResize(
            oldList,
            v22,
            *(const MethodInfo_34B8294 **)(*(_QWORD *)(v26[4] + 192LL) + 112LL));
        }
        else
        {
  ...
  {
LABEL_33:
    v31 = sub_1BC35AC(v12, System_IDisposable_TypeInfo, 0LL);
  }
...
void __fastcall OtherUserNewManager__SetOld_40196312(System_Int64_array *userList, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  __int64 v5; // x1
...
bool __fastcall OtherUserNewManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20BE1 & 1) == 0 )
  {
    ...
    sub_1B715CC(&OtherUserNewManager_TypeInfo, v6);
    byte_4A20BE1 = 1;
  }
