void __fastcall OtherUserNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C289 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_6635/*"Fgo_20151127_1"*/);
    byte_4A5C289 = 1;
  }
  OtherUserNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6635/*"Fgo_20151127_1"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)OtherUserNewManager_TypeInfo->static_fields,
    StringLiteral_6635/*"Fgo_20151127_1"*/,
    v1,
    v2);
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v6 - 1,
             (const MethodInfo_34E5578 *)Method_System_Collections_Generic_List_long__get_Item__) == userId )
        return !v7;
      v7 = v6 < size;
      if ( size == v6 )
        return !v7;
...
void __fastcall OtherUserNewManager__SetOld_40408920(System_Int64_array *userList, const MethodInfo *method)
{
  __int64 v3; // x22
  int64_t oldList; // x0
  __int64 v5; // x8
