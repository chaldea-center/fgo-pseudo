void OtherUserNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C580B8 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_6671/*"Fgo_20151127_1"*/);
    byte_4C580B8 = 1;
  }
  OtherUserNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6671/*"Fgo_20151127_1"*/;
  sub_1C3E508((CGThumbnailListItem_o *)OtherUserNewManager_TypeInfo->static_fields, StringLiteral_6671/*"Fgo_20151127_1"*/, v1, v2);
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v6 - 1,
             (const MethodInfo_379D1A4 *)Method_System_Collections_Generic_List_long__get_Item__) == userId )
        return !v7;
      v7 = v6 < size;
      if ( size == v6 )
        return !v7;
...
bool OtherUserNewManager__ReadData(const MethodInfo *method)
{
  ...
  {
LABEL_33:
    v26 = sub_1C8ED7C(v7, System_IDisposable_TypeInfo, 0);
  }
...
void OtherUserNewManager__SetOld_43444176(System_Int64_array *userList, const MethodInfo *method)
{
