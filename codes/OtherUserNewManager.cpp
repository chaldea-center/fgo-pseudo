void OtherUserNewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB7626 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_6663/*"Fgo_20151127_1"*/);
    byte_4CB7626 = 1;
  }
  OtherUserNewManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6663/*"Fgo_20151127_1"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)OtherUserNewManager_TypeInfo->static_fields, StringLiteral_6663/*"Fgo_20151127_1"*/, v1, v2);
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_long___get_Item(
             ...
             v6 - 1,
             (const MethodInfo_37E86B8 *)Method_System_Collections_Generic_List_long__get_Item__) == userId )
        return !v7;
      v7 = v6 < size;
      if ( size == v6 )
        return !v7;
...
bool OtherUserNewManager__ReadData(const MethodInfo *method)
{
  ...
  {
LABEL_33:
    v26 = sub_1C41D90(v7, System_IDisposable_TypeInfo, 0);
  }
...
void OtherUserNewManager__SetOld_43634792(System_Int64_array *userList, const MethodInfo *method)
{
