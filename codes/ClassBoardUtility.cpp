void __fastcall ClassBoardUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B4838F & 1) == 0 )
  {
    sub_1BDB878(&ClassBoardUtility_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_12568/*"SavePlayedClassBoardBaseRelease"*/, v4);
    sub_1BDB878(&StringLiteral_12569/*"SavePlayedExClassRelease"*/, v5);
    sub_1BDB878(&StringLiteral_23554/*"skill_{0:D5}"*/, v6);
    sub_1BDB878(&StringLiteral_18398/*"cs_{0:D4}{1}"*/, v7);
    byte_4B4838F = 1;
  }
  ClassBoardUtility_TypeInfo->static_fields->commandSpellIconFormat = (struct System_String_o *)StringLiteral_18398/*"cs_{0:D4}{1}"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)ClassBoardUtility_TypeInfo->static_fields, StringLiteral_18398/*"cs_{0:D4}{1}"*/, v2, v3);
  v8 = StringLiteral_23554/*"skill_{0:D5}"*/;
  static_fields = ClassBoardUtility_TypeInfo->static_fields;
  static_fields->passiveSkillIconFormat = (struct System_String_o *)StringLiteral_23554/*"skill_{0:D5}"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->passiveSkillIconFormat, v8, v10, v11);
  v12 = StringLiteral_12568/*"SavePlayedClassBoardBaseRelease"*/;
  v13 = ClassBoardUtility_TypeInfo->static_fields;
  v13->savePlayedClassBoardBaseReleaseKey = (struct System_String_o *)StringLiteral_12568/*"SavePlayedClassBoardBaseRelease"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&v13->savePlayedClassBoardBaseReleaseKey, v12, v14, v15);
  v16 = StringLiteral_12569/*"SavePlayedExClassRelease"*/;
  v17 = ClassBoardUtility_TypeInfo->static_fields;
  v17->savePlayedExClassReleaseKey = (struct System_String_o *)StringLiteral_12569/*"SavePlayedExClassRelease"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)&v17->savePlayedExClassReleaseKey, v16, v18, v19);
}
...
void __fastcall ClassBoardUtility__FirstSavePlayedExClassReleaseEffect(const MethodInfo *method)
{
  ...
  {
    v7 = sub_1BDB920(int___TypeInfo, 1LL);
    if ( !v7 )
      sub_1BDBAD4(0LL, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48388 & 1) == 0 )
  {
    sub_1BDB878(&ClassBoardUtility_TypeInfo, *(_QWORD *)&skillType);
  ...
  if ( skillType == 2 )
  {
    ...
    return System_String__Format_62613552(commandSpellIconFormat, v11, v17, 0LL);
  }
  else
  {
...
bool __fastcall ClassBoardUtility__IsPlayedExClassReleaseEffect(int32_t classId, const MethodInfo *method)
{
  ...
  if ( (byte_4B4838B & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Linq_Enumerable_FirstOrDefault_string____77115920, v3);
    sub_1BDB878(&System_Func_string__bool__TypeInfo, v4);
    sub_1BDB878(&Method_ClassBoardUtility___c__DisplayClass8_0__IsPlayedExClassReleaseEffect_b__0__, v5);
    sub_1BDB878(&ClassBoardUtility___c__DisplayClass8_0_TypeInfo, v6);
    byte_4B4838B = 1;
  }
  v7 = sub_1BDBAC4(ClassBoardUtility___c__DisplayClass8_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 16) = classId;
  ...
  String_70242896 = UnityEngine_PlayerPrefs__GetString_70242896(v10->static_fields->savePlayedExClassReleaseKey, 0LL);
  IsNullOrEmpty = System_String__IsNullOrEmpty(String_70242896, 0LL);
  if ( IsNullOrEmpty )
    return 0;
  if ( !String_70242896 )
LABEL_10:
    sub_1BDBAD4(IsNullOrEmpty, v9);
  v13 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(String_70242896, 0x2Cu, 0, 0LL);
  v14 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_string__bool__TypeInfo);
  ...
  return System_Linq_Enumerable__FirstOrDefault_object__50698552(
           ...
           (const MethodInfo_3059938 *)Method_System_Linq_Enumerable_FirstOrDefault_string____77115920) != 0LL;
}
...
bool __fastcall ClassBoardUtility__IsPlayedReleaseEffect(int32_t classBoardBaseId, const MethodInfo *method)
{
  ...
  if ( (byte_4B48389 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Linq_Enumerable_FirstOrDefault_string____77115920, v3);
    sub_1BDB878(&System_Func_string__bool__TypeInfo, v4);
    sub_1BDB878(&Method_ClassBoardUtility___c__DisplayClass6_0__IsPlayedReleaseEffect_b__0__, v5);
    sub_1BDB878(&ClassBoardUtility___c__DisplayClass6_0_TypeInfo, v6);
    byte_4B48389 = 1;
  }
  v7 = sub_1BDBAC4(ClassBoardUtility___c__DisplayClass6_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  if ( !v7 )
    goto LABEL_10;
  *(_DWORD *)(v7 + 16) = classBoardBaseId;
  ...
  String_70242896 = UnityEngine_PlayerPrefs__GetString_70242896(
...
bool __fastcall ClassBoardUtility__IsTargetQuestClear(const MethodInfo *method)
{
  ...
  if ( (byte_4B48387 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_UserQuestMaster___, v2);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&ClassBoardUtility_TypeInfo, method);
    sub_1BDB878(&Method_System_Linq_Enumerable_Select_string__int___, v3);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToList_int___, v4);
    sub_1BDB878(&System_Func_string__int__TypeInfo, v5);
    ...
    sub_1BDB878(&Method_System_String_Join_int___, v10);
    sub_1BDB878(&Method_ClassBoardUtility___c__SavePlayedClassBaseReleaseEffect_b__7_0__, v11);
    sub_1BDB878(&ClassBoardUtility___c_TypeInfo, v12);
    sub_1BDB878(&StringLiteral_820/*","*/, v13);
    byte_4B4838A = 1;
  }
  ...
  String_70242896 = UnityEngine_PlayerPrefs__GetString_70242896(
                      ...
                      0LL);
  IsNullOrEmpty = (System_Collections_Generic_List_TSource__o *)System_String__IsNullOrEmpty(String_70242896, 0LL);
  ...
  else
  {
    if ( !String_70242896 )
      goto LABEL_29;
    v20 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(String_70242896, 0x2Cu, 0, 0LL);
    ...
    if ( !_9__7_0 )
    {
      ...
      _9__7_0 = (System_Func_object__int__o *)sub_1BDBAC4(System_Func_string__int__TypeInfo);
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__7_0, (int32_t)_9__7_0, v25, v26);
    }
  ...
  if ( (int)v28 >= 1 )
  {
    ...
    do
    {
      if ( v29 >= (unsigned int)v28 )
        sub_1BDBADC(IsNullOrEmpty, v17, v19);
      if ( !v18 )
        goto LABEL_29;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4838C & 1) == 0 )
  {
    ...
    sub_1BDB878(&System_Collections_Generic_List_int__TypeInfo, v9);
    sub_1BDB878(&Method_System_String_Join_int___, v10);
    sub_1BDB878(&Method_ClassBoardUtility___c__SavePlayedExClassReleaseEffect_b__9_0__, v11);
    sub_1BDB878(&ClassBoardUtility___c_TypeInfo, v12);
    sub_1BDB878(&StringLiteral_820/*","*/, v13);
    byte_4B4838C = 1;
  }
  ...
  String_70242896 = UnityEngine_PlayerPrefs__GetString_70242896(v14->static_fields->savePlayedExClassReleaseKey, 0LL);
  IsNullOrEmpty = (System_Collections_Generic_List_TSource__o *)System_String__IsNullOrEmpty(String_70242896, 0LL);
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    v18 = (System_Collections_Generic_List_int__o *)sub_1BDBAC4(System_Collections_Generic_List_int__TypeInfo);
  ...
  else
  {
    ...
    if ( !_9__9_0 )
    {
      ...
      v23 = (Il2CppObject *)v21->static_fields->__9;
      _9__9_0 = (System_Func_object__int__o *)sub_1BDBAC4(System_Func_string__int__TypeInfo);
      System_Func_object__int____ctor(
        _9__9_0,
        v23,
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__9_0, (int32_t)_9__9_0, v25, v26);
    }
    v27 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                                 v20,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4838E & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_ClassBoardBaseMaster___, openGrandClassBoardNum);
    sub_1BDB878(&Method_DataManager_GetMaster_ClassBoardClassMaster___, v16);
    sub_1BDB878(&DataManager_TypeInfo, v17);
    sub_1BDB878(&Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__, v18);
    sub_1BDB878(&Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__, v19);
    sub_1BDB878(&Method_System_Collections_Generic_Dictionary_int__int__get_Item__, v20);
    sub_1BDB878(&Method_System_Linq_Enumerable_FirstOrDefault_ClassBoardInfo___, v21);
    sub_1BDB878(&System_Func_ClassBoardInfo__bool__TypeInfo, v22);
    sub_1BDB878(&Method_ClassBoardUtility___c__DisplayClass11_0__SetOpenClassScoreNum_b__0__, v23);
    sub_1BDB878(&ClassBoardUtility___c__DisplayClass11_0_TypeInfo, v24);
    byte_4B4838E = 1;
  }
...
LABEL_37:
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v34 = sub_1BDBAC4(ClassBoardUtility___c__DisplayClass11_0_TypeInfo);
...
LABEL_33:
    ...
    v38 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_ClassBoardInfo__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v38,
      (Il2CppObject *)v34,
      Method_ClassBoardUtility___c__DisplayClass11_0__SetOpenClassScoreNum_b__0__,
      0LL);
    Master_object = System_Linq_Enumerable__FirstOrDefault_object__50698552(
                      (System_Collections_Generic_IEnumerable_TSource__o *)boardInfo,
                      (System_Func_TSource__bool__o *)v38,
                      (const MethodInfo_3059938 *)Method_System_Linq_Enumerable_FirstOrDefault_ClassBoardInfo___);
    v39 = *(_QWORD *)(v34 + 16);
...
void __fastcall ClassBoardUtility___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B48390 & 1) == 0 )
  {
    sub_1BDB878(&ClassBoardUtility___c_TypeInfo, v1);
    byte_4B48390 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(ClassBoardUtility___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ClassBoardUtility___c_TypeInfo->static_fields->__9 = (struct ClassBoardUtility___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)ClassBoardUtility___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
