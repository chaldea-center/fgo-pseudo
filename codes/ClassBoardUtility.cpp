void __fastcall ClassBoardUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0BC & 1) == 0 )
  {
    sub_1B686D4(&ClassBoardUtility_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_12453/*"SavePlayedClassBoardBaseRelease"*/, v4);
    sub_1B686D4(&StringLiteral_12454/*"SavePlayedExClassRelease"*/, v5);
    sub_1B686D4(&StringLiteral_23270/*"skill_{0:D5}"*/, v6);
    sub_1B686D4(&StringLiteral_18320/*"cs_{0:D4}{1}"*/, v7);
    byte_4A0C0BC = 1;
  }
  ClassBoardUtility_TypeInfo->static_fields->commandSpellIconFormat = (struct System_String_o *)StringLiteral_18320/*"cs_{0:D4}{1}"*/;
  sub_1B68678(
    (ServantStatusBattleListViewItem_o *)ClassBoardUtility_TypeInfo->static_fields,
    StringLiteral_18320/*"cs_{0:D4}{1}"*/,
    v2,
    v3);
  v8 = StringLiteral_23270/*"skill_{0:D5}"*/;
  static_fields = ClassBoardUtility_TypeInfo->static_fields;
  static_fields->passiveSkillIconFormat = (struct System_String_o *)StringLiteral_23270/*"skill_{0:D5}"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->passiveSkillIconFormat, v8, v10, v11);
  v12 = StringLiteral_12453/*"SavePlayedClassBoardBaseRelease"*/;
  v13 = ClassBoardUtility_TypeInfo->static_fields;
  v13->savePlayedClassBoardBaseReleaseKey = (struct System_String_o *)StringLiteral_12453/*"SavePlayedClassBoardBaseRelease"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v13->savePlayedClassBoardBaseReleaseKey, v12, v14, v15);
  v16 = StringLiteral_12454/*"SavePlayedExClassRelease"*/;
  v17 = ClassBoardUtility_TypeInfo->static_fields;
  v17->savePlayedExClassReleaseKey = (struct System_String_o *)StringLiteral_12454/*"SavePlayedExClassRelease"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v17->savePlayedExClassReleaseKey, v16, v18, v19);
}
...
void __fastcall ClassBoardUtility__FirstSavePlayedExClassReleaseEffect(const MethodInfo *method)
{
  ...
  {
    v7 = sub_1B6877C(int___TypeInfo, 1LL);
    if ( !v7 )
      sub_1B68930(0LL, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0B6 & 1) == 0 )
  {
    sub_1B686D4(&ClassBoardUtility_TypeInfo, *(_QWORD *)&skillType);
  ...
  if ( skillType == 2 )
  {
    ...
    return System_String__Format_61433840(commandSpellIconFormat, v11, v17, 0LL);
  }
  else
  {
...
bool __fastcall ClassBoardUtility__IsPlayedExClassReleaseEffect(int32_t classId, const MethodInfo *method)
{
  ...
  __int64 v9; // x1
  ClassBoardUtility_c *v10; // x0
  System_String_o *String_69130092; // x20
  ...
  if ( (byte_4A0C0B9 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_System_Linq_Enumerable_FirstOrDefault_string____75798328, v3);
    sub_1B686D4(&System_Func_string__bool__TypeInfo, v4);
    sub_1B686D4(&Method_ClassBoardUtility___c__DisplayClass8_0__IsPlayedExClassReleaseEffect_b__0__, v5);
    sub_1B686D4(&ClassBoardUtility___c__DisplayClass8_0_TypeInfo, v6);
    byte_4A0C0B9 = 1;
  }
  v7 = sub_1B68920(ClassBoardUtility___c__DisplayClass8_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 16) = classId;
  ...
  String_69130092 = UnityEngine_PlayerPrefs__GetString_69130092(v10->static_fields->savePlayedExClassReleaseKey, 0LL);
  IsNullOrEmpty = System_String__IsNullOrEmpty(String_69130092, 0LL);
  if ( IsNullOrEmpty )
    return 0;
  if ( !String_69130092 )
LABEL_10:
    sub_1B68930(IsNullOrEmpty, v9);
  v13 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(String_69130092, 0x2Cu, 0, 0LL);
  v14 = (System_Func_object__bool__o *)sub_1B68920(System_Func_string__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v14,
    (Il2CppObject *)v7,
    Method_ClassBoardUtility___c__DisplayClass8_0__IsPlayedExClassReleaseEffect_b__0__,
    0LL);
  return System_Linq_Enumerable__FirstOrDefault_object__48686452(
           v13,
           (System_Func_TSource__bool__o *)v14,
           (const MethodInfo_2E6E574 *)Method_System_Linq_Enumerable_FirstOrDefault_string____75798328) != 0LL;
}
...
bool __fastcall ClassBoardUtility__IsPlayedReleaseEffect(int32_t classBoardBaseId, const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0B7 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_System_Linq_Enumerable_FirstOrDefault_string____75798328, v3);
    sub_1B686D4(&System_Func_string__bool__TypeInfo, v4);
    sub_1B686D4(&Method_ClassBoardUtility___c__DisplayClass6_0__IsPlayedReleaseEffect_b__0__, v5);
    sub_1B686D4(&ClassBoardUtility___c__DisplayClass6_0_TypeInfo, v6);
    byte_4A0C0B7 = 1;
  }
  v7 = sub_1B68920(ClassBoardUtility___c__DisplayClass6_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  if ( !v7 )
    goto LABEL_10;
  *(_DWORD *)(v7 + 16) = classBoardBaseId;
  ...
  String_69130092 = UnityEngine_PlayerPrefs__GetString_69130092(
...
bool __fastcall ClassBoardUtility__IsTargetQuestClear(const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0B5 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_DataManager_GetMasterData_UserQuestMaster___, v2);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&ClassBoardUtility_TypeInfo, method);
    sub_1B686D4(&Method_System_Linq_Enumerable_Select_string__int___, v3);
    sub_1B686D4(&Method_System_Linq_Enumerable_ToList_int___, v4);
    sub_1B686D4(&System_Func_string__int__TypeInfo, v5);
    sub_1B686D4(&Method_System_Collections_Generic_List_int__Add__, v6);
    sub_1B686D4(&Method_System_Collections_Generic_List_int__Contains__, v7);
    ...
    sub_1B686D4(&Method_System_String_Join_int___, v10);
    sub_1B686D4(&Method_ClassBoardUtility___c__SavePlayedClassBaseReleaseEffect_b__7_0__, v11);
    sub_1B686D4(&ClassBoardUtility___c_TypeInfo, v12);
    sub_1B686D4(&StringLiteral_868/*","*/, v13);
    byte_4A0C0B8 = 1;
  }
  ...
  String_69130092 = UnityEngine_PlayerPrefs__GetString_69130092(
                      ...
                      0LL);
  IsNullOrEmpty = (System_Collections_Generic_List_TSource__o *)System_String__IsNullOrEmpty(String_69130092, 0LL);
  ...
  else
  {
    if ( !String_69130092 )
      goto LABEL_29;
    v19 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(String_69130092, 0x2Cu, 0, 0LL);
    ...
    if ( !_9__7_0 )
    {
      ...
      _9__7_0 = (System_Func_object__int__o *)sub_1B68920(System_Func_string__int__TypeInfo);
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->__9__7_0, (int32_t)_9__7_0, v24, v25);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0BA & 1) == 0 )
  {
    ...
    sub_1B686D4(&System_Collections_Generic_List_int__TypeInfo, v9);
    sub_1B686D4(&Method_System_String_Join_int___, v10);
    sub_1B686D4(&Method_ClassBoardUtility___c__SavePlayedExClassReleaseEffect_b__9_0__, v11);
    sub_1B686D4(&ClassBoardUtility___c_TypeInfo, v12);
    sub_1B686D4(&StringLiteral_868/*","*/, v13);
    byte_4A0C0BA = 1;
  }
  ...
  String_69130092 = UnityEngine_PlayerPrefs__GetString_69130092(v14->static_fields->savePlayedExClassReleaseKey, 0LL);
  IsNullOrEmpty = (System_Collections_Generic_List_TSource__o *)System_String__IsNullOrEmpty(String_69130092, 0LL);
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    v18 = (System_Collections_Generic_List_int__o *)sub_1B68920(System_Collections_Generic_List_int__TypeInfo);
  ...
  else
  {
    ...
    if ( !_9__9_0 )
    {
      ...
      v22 = (Il2CppObject *)v20->static_fields->__9;
      _9__9_0 = (System_Func_object__int__o *)sub_1B68920(System_Func_string__int__TypeInfo);
      System_Func_object__int____ctor(
        _9__9_0,
        v22,
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->__9__9_0, (int32_t)_9__9_0, v24, v25);
    }
    v26 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                                 v19,
...
void __fastcall ClassBoardUtility___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0BD & 1) == 0 )
  {
    sub_1B686D4(&ClassBoardUtility___c_TypeInfo, v1);
    byte_4A0C0BD = 1;
  }
  v2 = (Il2CppObject *)sub_1B68920(ClassBoardUtility___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ClassBoardUtility___c_TypeInfo->static_fields->__9 = (struct ClassBoardUtility___c_o *)v2;
  sub_1B68678((ServantStatusBattleListViewItem_o *)ClassBoardUtility___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
