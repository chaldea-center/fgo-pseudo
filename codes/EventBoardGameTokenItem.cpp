...
void EventBoardGameTokenItem__Init(EventBoardGameTokenItem_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434(&this->fields.tokenName);
  this->fields.tokenImageId = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C2D434(&this->fields.tokenImageId);
...
void EventBoardGameTokenItem__OnClickItem(EventBoardGameTokenItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21502 & 1) == 0 )
  {
    sub_1C2D490(&Method_EventBoardGameTokenItem_OnClickItem__);
    byte_4C21502 = 1;
  }
  if ( this->fields.callback && this->fields.haved )
  {
    ...
    if ( (*((_BYTE *)Method_EventBoardGameTokenItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_EventBoardGameTokenItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  EventBoardGameTokenItem_o *v12; // x1
  const MethodInfo *v13; // x3

  v10 = this;
  if ( (byte_4C21500 & 1) == 0 )
  {
    this = (EventBoardGameTokenItem_o *)sub_1C2D490(&StringLiteral_24094/*"token_enpty"*/);
    byte_4C21500 = 1;
  }
  v11 = *item;
  if ( ent )
  {
    ...
    v11->fields.tokenName = System_Int32__ToString((int)ent + 20, 0);
    this = (EventBoardGameTokenItem_o *)sub_1C2D434(&v11->fields.tokenName);
    v11 = *item;
    if ( !*item )
      goto LABEL_14;
...
LABEL_14:
  ...
  v12 = (EventBoardGameTokenItem_o *)StringLiteral_24094/*"token_enpty"*/;
LABEL_11:
  v11->fields.tokenImageId = (struct System_String_o *)v12;
  sub_1C2D434(&v11->fields.tokenImageId);
  EventBoardGameTokenItem__SetTokenInfo(v10, *item, 1, v13);
  if ( callback )
  {
    v10->fields.callback = callback;
    sub_1C2D434(&v10->fields.callback);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21501 & 1) == 0 )
  {
    this = (EventBoardGameTokenItem_o *)sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C21501 = 1;
  }
  if ( !item )
    goto LABEL_13;
  ...
  v6->fields.tokenName = item->fields.tokenName;
  sub_1C2D434(&v6->fields.tokenName);
  v6->fields.tokenImageId = item->fields.tokenImageId;
  sub_1C2D434(&v6->fields.tokenImageId);
