...
void __fastcall EventBoardGameTokenItem__Init(EventBoardGameTokenItem_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.tokenName, (int64_t)v9, v2, v3, v4, v5, v6, v7);
  v10 = StringLiteral_1/*""*/;
  this->fields.tokenImageId = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.tokenImageId, (int64_t)v10, v11, v12, v13, v14, v15, v16);
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.callback, 0LL, v19, v20, v21, v22, v23, v24);
}
...
void __fastcall EventBoardGameTokenItem__OnClickItem(EventBoardGameTokenItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BE03EB & 1) == 0 )
  {
    sub_1C21E38(&Method_EventBoardGameTokenItem_OnClickItem__);
    byte_4BE03EB = 1;
  }
  if ( this->fields.callback && this->fields.haved )
  {
    ...
    if ( (*((_BYTE *)Method_EventBoardGameTokenItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_EventBoardGameTokenItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE03E9 & 1) == 0 )
  {
    this = (EventBoardGameTokenItem_o *)sub_1C21E38(&StringLiteral_24410/*"token_enpty"*/);
    byte_4BE03E9 = 1;
  }
  v13 = *item;
  if ( ent )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&v13->fields.tokenName, (int64_t)v14, v15, v16, v17, v18, v19, v20);
    v13 = *item;
    if ( !*item )
      goto LABEL_14;
...
LABEL_14:
  ...
  v21 = (EventBoardGameTokenItem_o *)StringLiteral_24410/*"token_enpty"*/;
LABEL_11:
  ...
  if ( callback )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&v12->fields.callback, (int64_t)callback, v23, v24, v25, v26, v27, v28);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE03EA & 1) == 0 )
  {
    this = (EventBoardGameTokenItem_o *)sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BE03EA = 1;
  }
  if ( !item )
    goto LABEL_13;
