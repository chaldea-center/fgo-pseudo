...
void __fastcall EventBoardGameTokenItem__Init(EventBoardGameTokenItem_o *this, const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.tokenName, v5, v2, v3);
  v6 = (int)StringLiteral_1/*""*/;
  this->fields.tokenImageId = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.tokenImageId, v6, v7, v8);
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.callback, 0, v10, v11);
}
...
void __fastcall EventBoardGameTokenItem__OnClickItem(EventBoardGameTokenItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00044 & 1) == 0 )
  {
    sub_1B640C8(&Method_EventBoardGameTokenItem_OnClickItem__, method);
    byte_4A00044 = 1;
  }
  if ( this->fields.callback && this->fields.haved )
  {
    ...
    if ( (*((_BYTE *)Method_EventBoardGameTokenItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B640E0(Method_EventBoardGameTokenItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00042 & 1) == 0 )
  {
    this = (EventBoardGameTokenItem_o *)sub_1B640C8(&StringLiteral_23879/*"token_enpty"*/, item);
    byte_4A00042 = 1;
  }
  v11 = *item;
  if ( ent )
  {
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&v11->fields.tokenName, (int32_t)v12, v13, v14);
    v11 = *item;
    if ( !*item )
      goto LABEL_14;
...
LABEL_14:
  ...
  v15 = (EventBoardGameTokenItem_o *)StringLiteral_23879/*"token_enpty"*/;
LABEL_11:
  v11->fields.tokenImageId = (struct System_String_o *)v15;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v11->fields.tokenImageId, (int32_t)v15, (int32_t)ent, haved);
  EventBoardGameTokenItem__SetTokenInfo(v10, *item, 1, v16);
  if ( callback )
  {
    v10->fields.callback = callback;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&v10->fields.callback, (int32_t)callback, v17, v18);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00043 & 1) == 0 )
  {
    this = (EventBoardGameTokenItem_o *)sub_1B640C8(&StringLiteral_1/*""*/, item);
    byte_4A00043 = 1;
  }
  if ( !item )
    goto LABEL_13;
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v6->fields.tokenName, (int32_t)tokenName, dispNo, (int32_t)method);
  tokenImageId = item->fields.tokenImageId;
  v6->fields.tokenImageId = tokenImageId;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&v6->fields.tokenImageId, (int32_t)tokenImageId, v10, v11);
