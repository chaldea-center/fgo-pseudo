        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F194 & 1) == 0 )
  {
    ...
    this = (ShopBuyItemListViewItem_o *)sub_1C37058(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C3F194 = 1;
  }
  if ( !shopEntity )
    goto LABEL_17;
  ...
  v5 = sub_1C37100(ItemEntity___TypeInfo, (unsigned int)ItemCount);
  v6 = (unsigned int *)v5;
  if ( ItemCount >= 1 )
  {
    v7 = 0;
    ...
    {
      this = (ShopBuyItemListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !this )
        break;
      ...
      if ( this )
      {
        this = (ShopBuyItemListViewItem_o *)sub_1C37194(this, *(_QWORD *)(*(_QWORD *)v6 + 64LL));
        if ( !this )
        {
          v15 = sub_1C372D8();
          sub_1C37180(v15, 0);
      ...
      sub_1C36FFC(i, (int32_t)v13, v11, v12);
      if ( v8 == ++v7 )
        ...
        const MethodInfo *method)
{
  ...
  {
    *message = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)message, 0, (int32_t)itemName, method);
    *itemName = 0;
    v15 = itemName;
    LODWORD(name) = 0;
    goto LABEL_6;
  ...
  {
    *message = 0;
    sub_1C36FFC((CGThumbnailListItem_o *)message, 0, v8, v9);
    ...
    if ( itemEntity )
    {
      ...
      *itemName = name;
LABEL_6:
      sub_1C36FFC((CGThumbnailListItem_o *)v15, (int32_t)name, v11, v12);
      return 1;
    }
LABEL_9:
    sub_1C372B4(v10);
...
bool ShopBuyItemListViewItem__IsPrepareTextOnMask(ShopBuyItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F19A & 1) == 0 )
  {
    sub_1C37058(&Method_BasicHelper_Any_UserEquipEntity___);
    ...
    sub_1C37058(&System_Func_UserEquipEntity__bool__TypeInfo);
    sub_1C37058(&NetworkManager_TypeInfo);
    sub_1C37058(&Method_ShopBuyItemListViewItem__IsPrepareTextOnMask_b__89_0__);
    sub_1C37058(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C3F19A = 1;
  }
  v23 = 0;
  ...
  if ( this->fields._ShopKind_k__BackingField == 6 )
  {
    ...
    if ( Shop_k__BackingField->fields.purchaseType == 19 )
    {
      ...
      if ( CondType__IsCommandCodeGet(TargetId, 0) )
        goto LABEL_43;
      Shop_k__BackingField = (ShopEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !Shop_k__BackingField )
        goto LABEL_61;
    ...
    if ( Shop_k__BackingField->fields.purchaseType == 14 )
    {
      ...
      v7 = System_String__Substring_63607580(
...
LABEL_46:
      if ( Shop_k__BackingField->fields.purchaseType == 16 )
      {
        ...
        if ( eventId >= 1 )
        {
          ...
          {
            if ( eventId == i )
              sub_1C372BC(Shop_k__BackingField);
...
LABEL_61:
    ...
    List = (System_Object_array *)UserEquipMaster__getList(
                                    ...
                                    *((_QWORD *)Shop_k__BackingField[1].monitor + 8),
                                    0);
    v14 = (System_Func_object__bool__o *)sub_1C372A4(System_Func_UserEquipEntity__bool__TypeInfo);
    ...
    if ( !BasicHelper__Any_object__51187876(
            ...
            (const MethodInfo_30D10A4 *)Method_BasicHelper_Any_UserEquipEntity___) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Shop_k__BackingField = (ShopEntity_o *)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_UserPresentBoxMaster___);
      if ( !this->fields._Shop_k__BackingField )
        goto LABEL_61;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v4->fields.itemEntity, (int32_t)ItemEntity, v6, v7);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v4->fields._Shop_k__BackingField, (int32_t)shopEntity, v11, v12);
  ...
  sub_1C36FFC(p_EventItemEntities_k__BackingField, 0, (int32_t)v14, v15);
      ...
      if ( ClassFilterKindList )
      {
        ...
        if ( sort )
        {
          ...
          if ( itemEntity )
          {
            ...
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            ClassFilterKindList = (System_Collections_Generic_List_T__o *)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_ServantMaster___);
        ...
        const MethodInfo *method)
{
  ...
  *message = 0;
  sub_1C36FFC((CGThumbnailListItem_o *)message, 0, (int32_t)itemName, method);
  *itemName = 0;
  sub_1C36FFC((CGThumbnailListItem_o *)itemName, 0, v5, v6);
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F19B & 1) == 0 )
  {
    this = (ShopBuyItemListViewItem_o *)sub_1C37058(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C3F19B = 1;
  }
  if ( !equip )
    goto LABEL_8;
  ...
  *(_QWORD *)&v9.fields.fakeValue = v5;
  this = (ShopBuyItemListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v9, 0);
  Shop_k__BackingField = v4->fields._Shop_k__BackingField;
  if ( !Shop_k__BackingField )
LABEL_8:
    sub_1C372B4(this);
...
System_String_o *ShopBuyItemListViewItem__get_BulkNameText(ShopBuyItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  return LocalizationManager__Get((System_String_o *)StringLiteral_10817/*"QP_UNIT"*/, 0);
}
...
void ShopBuyItemListViewItem__set_Shop(ShopBuyItemListViewItem_o *this, ShopEntity_o *value, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._Shop_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
