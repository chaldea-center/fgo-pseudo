        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31C84 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog_OnClickCloseButton__);
    sub_1C32C20(&Method_EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog__OnClickCloseButton_b__20_0__);
    byte_4C31C84 = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31C82 & 1) == 0 )
  {
    sub_1C32C20(&Method_EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog_Open__);
    sub_1C32C20(&Method_System_Collections_Generic_List_AssistEntity__get_Count__);
    sub_1C32C20(&Method_System_Collections_Generic_List_EventEquipSkillPartsEntity__get_Count__);
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.playSeName, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog_Open__ + 83) & 2) != 0 )
      v11 = (_QWORD *)sub_1C32C38(Method_EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog_Open__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31C83 & 1) == 0 )
  {
    ...
    sub_1C32C20(&EventEquipSkillPartsRenoQuestReleaseAndCompletionListViewItem_TypeInfo);
    sub_1C32C20(&Method_GameObjectHelper_Instantiate_EventEquipSkillPartsRenoQuestReleaseAndCompletionListViewItemDraw___);
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_AssistEntity__get_Count__);
    this = (EventEquipSkillPartsRenoQuestReleaseAndCompletionDialog_o *)sub_1C32C20(&Method_System_Collections_Generic_List_EventEquipSkillPartsEntity__get_Count__);
    byte_4C31C83 = 1;
  }
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)eventEquipSkillPartsEntityList, 0) )
  {
              ...
              (const MethodInfo_3522FA8 *)Method_System_Collections_Generic_List_Enumerator_EventEquipSkillPartsEntity__MoveNext__) )
    {
      ...
      v9 = GameObjectHelper__Instantiate_object_(
             ...
             0,
             (const MethodInfo_3136594 *)Method_GameObjectHelper_Instantiate_EventEquipSkillPartsRenoQuestReleaseAndCompletionListViewItemDraw___);
      ...
      v14 = (EventEquipSkillPartsRenoQuestReleaseAndCompletionListViewItem_o *)sub_1C32E6C(EventEquipSkillPartsRenoQuestReleaseAndCompletionListViewItem_TypeInfo);
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)assistList, 0) )
  {
              ...
              (const MethodInfo_3522FA8 *)Method_System_Collections_Generic_List_Enumerator_AssistEntity__MoveNext__) )
    {
      ...
      v24 = (EventEquipSkillPartsRenoQuestReleaseAndCompletionListViewItem_o *)sub_1C32E6C(EventEquipSkillPartsRenoQuestReleaseAndCompletionListViewItem_TypeInfo);
