        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC409 & 1) == 0 )
  {
    sub_1B64870(&Method_NetworkManager_getRequest_WarBoardFinishRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2EBCCAC *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  if ( !monitor
