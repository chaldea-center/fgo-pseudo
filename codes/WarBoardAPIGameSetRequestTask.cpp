        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4212B39 & 1) == 0 )
  {
    sub_B0D8A4(&Method_NetworkManager_getRequest_WarBoardFinishRequest___, method);
  ...
  Instance = NetworkManager__getRequest_WarBoardWallAttackRequest_(
               0LL,
               (const MethodInfo_2049D98 *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  if ( !v6 || (v7 = (WarBoardFinishRequest_o *)Instance, Instance = (void *)WarBoardData__get_id(v6, 0LL), !v7) )
LABEL_10:
    sub_B0D97C(Instance);
