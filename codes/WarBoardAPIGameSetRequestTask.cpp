        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B51 & 1) == 0 )
  {
    sub_1B686D4(&Method_NetworkManager_getRequest_WarBoardFinishRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2ECB448 *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  if ( !monitor
