        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B649F1 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_NetworkManager_getRequest_WarBoardFinishRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2FDD714 *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  if ( !monitor
