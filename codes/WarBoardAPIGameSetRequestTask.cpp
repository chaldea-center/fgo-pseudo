        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B427A8 & 1) == 0 )
  {
    sub_1BDB878(&Method_NetworkManager_getRequest_WarBoardFinishRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_30BC7D4 *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  if ( !monitor
