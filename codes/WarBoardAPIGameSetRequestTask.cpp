        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE07D & 1) == 0 )
  {
    sub_B52984(&Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  ...
  Instance = NetworkManager__getRequest_WarBoardWallAttackRequest_(
               0LL,
               (const MethodInfo_1F705CC *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
