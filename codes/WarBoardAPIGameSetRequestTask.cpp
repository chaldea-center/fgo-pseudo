        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A590D2 & 1) == 0 )
  {
    sub_1B885B0(&Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F019D8 *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  if ( !monitor
