        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E07AB & 1) == 0 )
  {
    sub_1B00CCC(&Method_NetworkManager_getRequest_WarBoardFinishRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2DD4818 *)Method_NetworkManager_getRequest_WarBoardFinishRequest___);
  if ( !monitor
