...
void ScrollPageIndicator__CreateIndicator(ScrollPageIndicator_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( (byte_4C365FE & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ScrollPageIndicator___c__DisplayClass10_0__CreateIndicator_b__0__);
    sub_1C32C20(&ScrollPageIndicator___c__DisplayClass10_0_TypeInfo);
    sub_1C32C20(&UISprite___TypeInfo);
    sub_1C32C20(&StringLiteral_20771/*"indicator"*/);
    byte_4C365FE = 1;
  }
  v46 = 0;
  if ( count > 1 )
  {
    v5 = (struct UISprite_array *)sub_1C32CC8(UISprite___TypeInfo, (unsigned int)count);
    this->fields.Indicator = v5;
    p_Indicator = &this->fields.Indicator;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.Indicator, (int32_t)v5, v7, v8);
    ...
    if ( Component_object )
    {
      ...
      if ( Component_object )
      {
        v48 = UnityEngine_Transform__get_localPosition((UnityEngine_Transform_o *)Component_object, 0);
        if ( transform )
        {
          ...
          while ( 1 )
          {
            v18 = sub_1C32E6C(ScrollPageIndicator___c__DisplayClass10_0_TypeInfo);
            System_Object___ctor((Il2CppObject *)v18, 0);
            if ( !v18 )
              break;
            *(_QWORD *)(v18 + 24) = this;
            sub_1C32BC4((CGThumbnailListItem_o *)(v18 + 24), (int32_t)this, v19, v20);
            ...
            Component_object = (__int64)System_String__Concat_63518544((System_String_o *)StringLiteral_20771/*"indicator"*/, v24, 0);
            if ( !v22 )
              break;
            ...
            Component_object = (__int64)UnityEngine_GameObject__get_transform((UnityEngine_GameObject_o *)v22, 0);
            if ( !Component_object )
              break;
            ...
            if ( Component_object )
            {
              Component_object = sub_1C32D5C(Component_object, *(_QWORD *)(*(_QWORD *)v29 + 64LL));
              if ( !Component_object )
              {
                v44 = sub_1C32EA0(0);
                sub_1C32D48(v44, 0);
            ...
            *(_QWORD *)&v29[2 * v15 + 8] = v30;
            sub_1C32BC4((CGThumbnailListItem_o *)&v29[v17], (int32_t)v30, v27, v28);
            if ( !v30 )
              break;
            ...
            *(_QWORD *)(v33 + 32) = 0;
            v33 += 32;
            sub_1C32BC4((CGThumbnailListItem_o *)v33, 0, v34, v35);
            *(_DWORD *)(v18 + 16) = v15;
            v36 = (EventDelegate_Callback_o *)sub_1C32E6C(EventDelegate_Callback_TypeInfo);
            EventDelegate_Callback___ctor(
              v36,
              (Il2CppObject *)v18,
              Method_ScrollPageIndicator___c__DisplayClass10_0__CreateIndicator_b__0__,
              0);
            v37 = (EventDelegate_o *)sub_1C32E6C(EventDelegate_TypeInfo);
            EventDelegate___ctor_49230836(v37, v36, 0);
            Component_object = *(_QWORD *)(v33 + 168);
            if ( !Component_object )
              break;
            v40 = *(_QWORD *)(Component_object + 16);
            v41 = Method_System_Collections_Generic_List_EventDelegate__Add__;
            ++*(_DWORD *)(Component_object + 28);
            if ( !v40 )
              break;
            v42 = *(int *)(Component_object + 24);
            ...
            {
              v43 = v40 + 8 * v42;
              *(_DWORD *)(Component_object + 24) = v42 + 1;
              *(_QWORD *)(v43 + 32) = v37;
              sub_1C32BC4((CGThumbnailListItem_o *)(v43 + 32), (int32_t)v37, v38, v39);
            }
            v17 += 2;
            ++v15;
            v14 += IndicatorStep;
...
void ScrollPageIndicator__Init(ScrollPageIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C365FD & 1) == 0 )
  {
    this = (ScrollPageIndicator_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C365FD = 1;
  }
  ...
  if ( Indicator )
  {
    ...
    p_Indicator->klass = 0;
    sub_1C32BC4(p_Indicator, 0, v2, v3);
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A767CC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A76784;
}
