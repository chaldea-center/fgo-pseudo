        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1E786 & 1) == 0 )
  {
    sub_1B715CC(&EventDelegate_Callback_TypeInfo, *(_QWORD *)&count);
    sub_1B715CC(&EventDelegate_TypeInfo, v5);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_UIButton___, v6);
    ...
    sub_1B715CC(&Method_ScrollPageIndicator___c__DisplayClass10_0__CreateIndicator_b__0__, v12);
    sub_1B715CC(&ScrollPageIndicator___c__DisplayClass10_0_TypeInfo, v13);
    sub_1B715CC(&UISprite___TypeInfo, v14);
    sub_1B715CC(&StringLiteral_20588/*"indicator"*/, v15);
    byte_4A1E786 = 1;
  }
  v59 = 0;
  if ( count > 1 )
  {
    v16 = (struct UISprite_array *)sub_1B71674(UISprite___TypeInfo, (unsigned int)count);
    this->fields.Indicator = v16;
    p_Indicator = &this->fields.Indicator;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.Indicator, (int32_t)v16, v18, v19);
      ...
      if ( Component_object )
      {
        *(UnityEngine_Vector3_o *)(&v24 - 2) = UnityEngine_Transform__get_localPosition(
        ...
        if ( transform )
        {
          ...
          while ( 1 )
          {
            v31 = sub_1B71818(ScrollPageIndicator___c__DisplayClass10_0_TypeInfo);
            System_Object___ctor((Il2CppObject *)v31, 0LL);
            if ( !v31 )
              break;
            *(_QWORD *)(v31 + 24) = this;
            sub_1B71570((ServantStatusBattleListViewItem_o *)(v31 + 24), (int32_t)this, v32, v33);
            ...
            Component_object = (__int64)System_String__Concat_61505504((System_String_o *)StringLiteral_20588/*"indicator"*/, v37, 0LL);
            if ( !v35 )
              break;
            ...
            if ( Component_object )
            {
              Component_object = sub_1B71708(Component_object, *(_QWORD *)(*(_QWORD *)v42 + 64LL));
              if ( !Component_object )
              {
                v57 = sub_1B7184C(0LL);
                sub_1B716F4(v57, 0LL);
            ...
            if ( v28 >= v42[6] )
              sub_1B71830(Component_object, v22);
            *(_QWORD *)&v42[2 * v28 + 8] = v43;
            sub_1B71570((ServantStatusBattleListViewItem_o *)&v42[v30], (int32_t)v43, v40, v41);
            if ( !v43 )
              break;
            ...
            sub_1B71570(v46, 0, v47, v48);
            *(_DWORD *)(v31 + 16) = v28;
            v49 = (EventDelegate_Callback_o *)sub_1B71818(EventDelegate_Callback_TypeInfo);
            EventDelegate_Callback___ctor(
              v49,
              (Il2CppObject *)v31,
              Method_ScrollPageIndicator___c__DisplayClass10_0__CreateIndicator_b__0__,
              0LL);
            v50 = (EventDelegate_o *)sub_1B71818(EventDelegate_TypeInfo);
            EventDelegate___ctor_46645204(v50, v49, 0LL);
            ...
            else
            {
              ...
              *(_QWORD *)(v56 + 32) = v50;
              sub_1B71570((ServantStatusBattleListViewItem_o *)(v56 + 32), (int32_t)v50, v51, v52);
            }
            v30 += 2LL;
            ++v28;
            v27 += IndicatorStep;
...
void __fastcall ScrollPageIndicator__Init(ScrollPageIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1E785 & 1) == 0 )
  {
    this = (ScrollPageIndicator_o *)sub_1B715CC(&UnityEngine_Object_TypeInfo, method);
    byte_4A1E785 = 1;
  }
  ...
  if ( Indicator )
  {
    ...
    sub_1B71570(p_Indicator, 0, v2, v3);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B8330;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B82E8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1E787 & 1) == 0 )
  {
    sub_1B715CC(&int_TypeInfo, *(_QWORD *)&pageIndex);
    byte_4A1E787 = 1;
  }
  v9[1] = 0LL;
