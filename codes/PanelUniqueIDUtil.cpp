void __fastcall PanelUniqueIDUtil___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_40F8023 & 1) == 0 )
  {
    sub_B16FFC(&PanelUniqueIDUtil_TypeInfo, v1);
    byte_40F8023 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F8022 & 1) == 0 )
  {
    sub_B16FFC(&Method_System_Array_IndexOf_int___, *(_QWORD *)&vIndex);
    sub_B16FFC(&PanelUniqueIDUtil_TypeInfo, v7);
    byte_40F8022 = 1;
  }
  if ( (BYTE3(PanelUniqueIDUtil_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !PanelUniqueIDUtil_TypeInfo->_2.cctor_finished )
  ...
  return System_Array__IndexOf_int_(uniqueIds, ID, (const MethodInfo_2045560 *)Method_System_Array_IndexOf_int___) >= 0;
}