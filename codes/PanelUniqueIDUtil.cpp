void __fastcall PanelUniqueIDUtil___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFA257 & 1) == 0 )
  {
    sub_1C2E12C(&PanelUniqueIDUtil_TypeInfo, v1);
    byte_4BFA257 = 1;
  }
...
int32_t __fastcall PanelUniqueIDUtil__GetID(int32_t hIndex, int32_t vIndex, const MethodInfo *method)
{
  ...
  if ( (byte_4BFA255 & 1) == 0 )
  {
    sub_1C2E12C(&PanelUniqueIDUtil_TypeInfo, *(_QWORD *)&vIndex);
    byte_4BFA255 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFA256 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Array_IndexOf_int___, *(_QWORD *)&vIndex);
    sub_1C2E12C(&PanelUniqueIDUtil_TypeInfo, v7);
    byte_4BFA256 = 1;
  }
  if ( !PanelUniqueIDUtil_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(PanelUniqueIDUtil_TypeInfo);
  ID = PanelUniqueIDUtil__GetID(hIndex, vIndex, (const MethodInfo *)uniqueIds);
  return System_Array__IndexOf_int_(uniqueIds, ID, (const MethodInfo_30CF08C *)Method_System_Array_IndexOf_int___) >= 0;
}