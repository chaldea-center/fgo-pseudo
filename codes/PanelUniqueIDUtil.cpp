void __fastcall PanelUniqueIDUtil___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F90BA & 1) == 0 )
  {
    sub_1B640C8(&PanelUniqueIDUtil_TypeInfo, v1);
    byte_49F90BA = 1;
  }
...
int32_t __fastcall PanelUniqueIDUtil__GetID(int32_t hIndex, int32_t vIndex, const MethodInfo *method)
{
  ...
  if ( (byte_49F90B8 & 1) == 0 )
  {
    sub_1B640C8(&PanelUniqueIDUtil_TypeInfo, *(_QWORD *)&vIndex);
    byte_49F90B8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F90B9 & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Array_IndexOf_int___, *(_QWORD *)&vIndex);
  ...
  return System_Array__IndexOf_int_(uniqueIds, ID, (const MethodInfo_2F31E68 *)Method_System_Array_IndexOf_int___) >= 0;
}