void __fastcall PanelUniqueIDUtil___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42120F2 & 1) == 0 )
  {
    sub_B0D8A4(&PanelUniqueIDUtil_TypeInfo, v1);
    byte_42120F2 = 1;
  }
...
int32_t __fastcall PanelUniqueIDUtil__GetID(int32_t hIndex, int32_t vIndex, const MethodInfo *method)
{
  ...
  if ( (byte_42120F0 & 1) == 0 )
  {
    sub_B0D8A4(&PanelUniqueIDUtil_TypeInfo, *(_QWORD *)&vIndex);
    byte_42120F0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42120F1 & 1) == 0 )
  {
    sub_B0D8A4(&Method_System_Array_IndexOf_int___, *(_QWORD *)&vIndex);
  ...
  return System_Array__IndexOf_int_(uniqueIds, ID, (const MethodInfo_1F69B20 *)Method_System_Array_IndexOf_int___) >= 0;
}