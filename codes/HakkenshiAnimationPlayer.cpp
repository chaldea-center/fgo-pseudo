void HakkenshiAnimationPlayer___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2AB41 & 1) == 0 )
  {
    sub_1C93AD4(&HakkenshiAnimationPlayer_TypeInfo);
    sub_1C93AD4(&StringLiteral_24001/*"stay_dog_{0}_loop"*/);
    sub_1C93AD4(&StringLiteral_24000/*"stay_dog_{0}_action"*/);
    byte_4D2AB41 = 1;
  }
  HakkenshiAnimationPlayer_TypeInfo->static_fields->HAKKENSHI_LOOP_ANIM_NAME = (struct System_String_o *)StringLiteral_24001/*"stay_dog_{0}_loop"*/;
  sub_1C93A78(HakkenshiAnimationPlayer_TypeInfo->static_fields, StringLiteral_24001/*"stay_dog_{0}_loop"*/);
  v1 = StringLiteral_24000/*"stay_dog_{0}_action"*/;
  static_fields = HakkenshiAnimationPlayer_TypeInfo->static_fields;
  static_fields->HAKKENSHI_ACTION_ANIM_NAME = (struct System_String_o *)StringLiteral_24000/*"stay_dog_{0}_action"*/;
  sub_1C93A78(&static_fields->HAKKENSHI_ACTION_ANIM_NAME, v1);
}
...
void HakkenshiAnimationPlayer__Awake(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  sub_1C93A78(&this->fields.stayDogAnimation, Component_object);
}
...
void HakkenshiAnimationPlayer__OnReleaseEvent(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2AB3F & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_10751/*"PlayStayAnim"*/);
    byte_4D2AB3F = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(stayDogAnimation, 0, 0) )
    UnityEngine_MonoBehaviour__Invoke(
      ...
      (System_String_o *)StringLiteral_10751/*"PlayStayAnim"*/,
...
LABEL_17:
      sub_1C93D2C(v8, v9);
    UnityEngine_Animation__Play_71862428(v11, v8, 0);
  }
}
