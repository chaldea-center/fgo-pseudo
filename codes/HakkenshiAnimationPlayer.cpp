void HakkenshiAnimationPlayer___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4DFEB63 & 1) == 0 )
  {
    sub_1CE6700(&HakkenshiAnimationPlayer_TypeInfo);
    sub_1CE6700(&StringLiteral_24084/*"stay_dog_{0}_loop"*/);
    sub_1CE6700(&StringLiteral_24083/*"stay_dog_{0}_action"*/);
    byte_4DFEB63 = 1;
  }
  HakkenshiAnimationPlayer_TypeInfo->static_fields->HAKKENSHI_LOOP_ANIM_NAME = (struct System_String_o *)StringLiteral_24084/*"stay_dog_{0}_loop"*/;
  sub_1CE66A4(HakkenshiAnimationPlayer_TypeInfo->static_fields, StringLiteral_24084/*"stay_dog_{0}_loop"*/);
  v1 = StringLiteral_24083/*"stay_dog_{0}_action"*/;
  static_fields = HakkenshiAnimationPlayer_TypeInfo->static_fields;
  static_fields->HAKKENSHI_ACTION_ANIM_NAME = (struct System_String_o *)StringLiteral_24083/*"stay_dog_{0}_action"*/;
  sub_1CE66A4(&static_fields->HAKKENSHI_ACTION_ANIM_NAME, v1);
}
...
void HakkenshiAnimationPlayer__Awake(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields.stayDogAnimation, Component_object);
}
...
void HakkenshiAnimationPlayer__OnReleaseEvent(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEB61 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_10783/*"PlayStayAnim"*/);
    byte_4DFEB61 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(stayDogAnimation, 0, 0) )
    UnityEngine_MonoBehaviour__Invoke(
      ...
      (System_String_o *)StringLiteral_10783/*"PlayStayAnim"*/,
...
LABEL_17:
      sub_1CE6958(v8, v9);
    UnityEngine_Animation__Play_72661460(v11, v8, 0);
  }
}
