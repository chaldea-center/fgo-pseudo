void HakkenshiAnimationPlayer___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3D2EC & 1) == 0 )
  {
    sub_1C37058(&HakkenshiAnimationPlayer_TypeInfo);
    sub_1C37058(&StringLiteral_23708/*"stay_dog_{0}_loop"*/);
    sub_1C37058(&StringLiteral_23707/*"stay_dog_{0}_action"*/);
    byte_4C3D2EC = 1;
  }
  HakkenshiAnimationPlayer_TypeInfo->static_fields->HAKKENSHI_LOOP_ANIM_NAME = (struct System_String_o *)StringLiteral_23708/*"stay_dog_{0}_loop"*/;
  sub_1C36FFC(HakkenshiAnimationPlayer_TypeInfo->static_fields, StringLiteral_23708/*"stay_dog_{0}_loop"*/);
  v1 = StringLiteral_23707/*"stay_dog_{0}_action"*/;
  static_fields = HakkenshiAnimationPlayer_TypeInfo->static_fields;
  static_fields->HAKKENSHI_ACTION_ANIM_NAME = (struct System_String_o *)StringLiteral_23707/*"stay_dog_{0}_action"*/;
  sub_1C36FFC(&static_fields->HAKKENSHI_ACTION_ANIM_NAME, v1);
}
...
void HakkenshiAnimationPlayer__Awake(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC(&this->fields.stayDogAnimation, Component_object);
}
...
void HakkenshiAnimationPlayer__OnReleaseEvent(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3D2EA & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_10674/*"PlayStayAnim"*/);
    byte_4C3D2EA = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(stayDogAnimation, 0, 0) )
    UnityEngine_MonoBehaviour__Invoke(
      ...
      (System_String_o *)StringLiteral_10674/*"PlayStayAnim"*/,
...
LABEL_17:
      sub_1C372B4(v14);
    UnityEngine_Animation__Play_71012036(v22, v14, 0);
  }
}
