void HakkenshiAnimationPlayer___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E71758 & 1) == 0 )
  {
    sub_1D0F0B4(&HakkenshiAnimationPlayer_TypeInfo);
    sub_1D0F0B4(&StringLiteral_24186/*"stay_dog_{0}_loop"*/);
    sub_1D0F0B4(&StringLiteral_24185/*"stay_dog_{0}_action"*/);
    byte_4E71758 = 1;
  }
  HakkenshiAnimationPlayer_TypeInfo->static_fields->HAKKENSHI_LOOP_ANIM_NAME = (struct System_String_o *)StringLiteral_24186/*"stay_dog_{0}_loop"*/;
  sub_1D0F058(HakkenshiAnimationPlayer_TypeInfo->static_fields, StringLiteral_24186/*"stay_dog_{0}_loop"*/);
  v1 = StringLiteral_24185/*"stay_dog_{0}_action"*/;
  static_fields = HakkenshiAnimationPlayer_TypeInfo->static_fields;
  static_fields->HAKKENSHI_ACTION_ANIM_NAME = (struct System_String_o *)StringLiteral_24185/*"stay_dog_{0}_action"*/;
  sub_1D0F058(&static_fields->HAKKENSHI_ACTION_ANIM_NAME, v1);
}
...
void HakkenshiAnimationPlayer__Awake(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058(&this->fields.stayDogAnimation, Component_object);
}
...
void HakkenshiAnimationPlayer__OnReleaseEvent(HakkenshiAnimationPlayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71756 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_10829/*"PlayStayAnim"*/);
    byte_4E71756 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(stayDogAnimation, 0, 0) )
    UnityEngine_MonoBehaviour__Invoke(
      ...
      (System_String_o *)StringLiteral_10829/*"PlayStayAnim"*/,
...
LABEL_17:
      sub_1D0F30C(v8, v9);
    UnityEngine_Animation__Play_73101556(v11, v8, 0);
  }
}
