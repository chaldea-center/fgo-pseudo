void __fastcall BattleDataDefine___cctor(const MethodInfo *method)
{
  ...
  v2 = (System_Int32_array **)sub_B706AC(int___TypeInfo, 1LL);
  static_fields = BattleDataDefine_TypeInfo->static_fields;
  static_fields->NO_INDIVIDUALITY_ARRAY = (struct System_Int32_array *)v2;
  sub_B70630((BattleServantConfConponent_o *)&static_fields->NO_INDIVIDUALITY_ARRAY, v2, v4, v5, v6, v7, v8, v9);
  v10 = BattleDataDefine_TypeInfo->static_fields;
  v11 = (System_Int32_array **)StringLiteral_2816/*"Battle/Common"*/;
  v10->ASSET_BATTLE_COMMON = (struct System_String_o *)StringLiteral_2816/*"Battle/Common"*/;
  sub_B70630((BattleServantConfConponent_o *)&v10->ASSET_BATTLE_COMMON, v11, v12, v13, v14, v15, v16, v17);
}
...
System_String_o *__fastcall BattleDataDefine__AddUniqueCameraPath(int32_t cameraId, const MethodInfo *method)
{
  ...
  if ( (byte_4350522 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_2832/*"Battle/UniqueCamera/Add/{0}"*/);
    byte_4350522 = 1;
  }
  v6 = cameraId;
  v4 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v6, v2);
  return System_String__Format((System_String_o *)StringLiteral_2832/*"Battle/UniqueCamera/Add/{0}"*/, v4, 0LL);
}
...
System_String_o *__fastcall BattleDataDefine__FieldMotionPath(int32_t motionId, const MethodInfo *method)
{
  ...
  {
    sub_B70694(&int_TypeInfo);
    sub_B70694(&StringLiteral_2822/*"Battle/Field/{0}"*/);
    byte_4350521 = 1;
  }
  v6 = motionId;
  v4 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v6, v2);
  return System_String__Format((System_String_o *)StringLiteral_2822/*"Battle/Field/{0}"*/, v4, 0LL);
}
