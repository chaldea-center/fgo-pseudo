void __fastcall BattleDataDefine___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_421345B & 1) == 0 )
  {
    sub_B0D8A4(&BattleDataDefine_TypeInfo, v1);
    sub_B0D8A4(&int___TypeInfo, v2);
    sub_B0D8A4(&StringLiteral_2766/*"Battle/Common"*/, v3);
    sub_B0D8A4(&StringLiteral_2764/*"Battle/20220731"*/, v4);
    byte_421345B = 1;
  }
  ...
  v6 = (System_Int32_array **)sub_B0D8BC(int___TypeInfo, 1LL);
  static_fields = BattleDataDefine_TypeInfo->static_fields;
  static_fields->NO_INDIVIDUALITY_ARRAY = (struct System_Int32_array *)v6;
  sub_B0D840((BattleServantConfConponent_o *)&static_fields->NO_INDIVIDUALITY_ARRAY, v6, v8, v9, v10, v11, v12, v13);
  v14 = BattleDataDefine_TypeInfo->static_fields;
  v15 = (System_Int32_array **)StringLiteral_2766/*"Battle/Common"*/;
  v14->ASSET_BATTLE_COMMON = (struct System_String_o *)StringLiteral_2766/*"Battle/Common"*/;
  sub_B0D840((BattleServantConfConponent_o *)&v14->ASSET_BATTLE_COMMON, v15, v16, v17, v18, v19, v20, v21);
  v22 = BattleDataDefine_TypeInfo->static_fields;
  v23 = (System_Int32_array **)StringLiteral_2764/*"Battle/20220731"*/;
  v22->ASSET_PATH_20220731 = (struct System_String_o *)StringLiteral_2764/*"Battle/20220731"*/;
  sub_B0D840((BattleServantConfConponent_o *)&v22->ASSET_PATH_20220731, v23, v24, v25, v26, v27, v28, v29);
}
