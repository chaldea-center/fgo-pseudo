void BattleDataDefine___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2F29F & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_3011/*"BUSTER_CHAIN_INDIVIDUALITY"*/);
    sub_1C94098(&StringLiteral_11472/*"RootCameraPrefab"*/);
    sub_1C94098(&StringLiteral_10956/*"QUICK_CHAIN_INDIVIDUALITY"*/);
    sub_1C94098(&StringLiteral_3088/*"Battle/Common"*/);
    sub_1C94098(&StringLiteral_2036/*"ARTS_CHAIN_INDIVIDUALITY"*/);
    sub_1C94098(&StringLiteral_3322/*"CHAIN_ERROR_INDIVIDUALITY"*/);
    sub_1C94098(&StringLiteral_3004/*"BRAVE_CHAIN_INDIVIDUALITY"*/);
    sub_1C94098(&StringLiteral_8689/*"MIGHTY_CHAIN_INDIVIDUALITY"*/);
    byte_4D2F29F = 1;
  }
  ...
  *(_OWORD *)&static_fields->PERMILLAGE_DENOMINATOR_INT = xmmword_CFE540;
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v3->NO_INDIVIDUALITY_ARRAY, v2, v4, v5, v6, v7, v8, v9);
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v11->ASSET_BATTLE_COMMON, v10, v12, v13, v14, v15, v16, v17);
  v18 = StringLiteral_11472/*"RootCameraPrefab"*/;
  v19 = BattleDataDefine_TypeInfo->static_fields;
  v19->RootCameraAssetName = (struct System_String_o *)StringLiteral_11472/*"RootCameraPrefab"*/;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v19->RootCameraAssetName, v18, v20, v21, v22, v23, v24, v25);
  BattleDataDefine_TypeInfo->static_fields->ShadowServantDefaultColor = (struct UnityEngine_Color_o)xmmword_CFE140;
  BattleDataDefine_TypeInfo->static_fields->_ArtsChainIndividuality_k__BackingField = ConstantMaster__getValue(
                                                                                        (System_String_o *)StringLiteral_2036/*"ARTS_CHAIN_INDIVIDUALITY"*/,
                                                                                        0);
  ...
  BattleDataDefine_TypeInfo->static_fields->_QuickChainIndividuality_k__BackingField = ConstantMaster__getValue(
                                                                                         (System_String_o *)StringLiteral_10956/*"QUICK_CHAIN_INDIVIDUALITY"*/,
                                                                                         0);
  ...
  BattleDataDefine_TypeInfo->static_fields->_MigthyChainIndividuality_k__BackingField = ConstantMaster__getValue(
                                                                                          (System_String_o *)StringLiteral_8689/*"MIGHTY_CHAIN_INDIVIDUALITY"*/,
                                                                                          0);
  BattleDataDefine_TypeInfo->static_fields->_ChainErrorIndividuality_k__BackingField = ConstantMaster__getValue(
                                                                                         (System_String_o *)StringLiteral_3322/*"CHAIN_ERROR_INDIVIDUALITY"*/,
                                                                                         0);
}
...
System_String_o *BattleDataDefine__AddUniqueCameraPath(int32_t cameraId, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F295 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_3107/*"Battle/UniqueCamera/Add/{0}"*/);
    byte_4D2F295 = 1;
  }
  v5 = cameraId;
...
System_String_o *BattleDataDefine__FieldMotionPath(int32_t motionId, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&int_TypeInfo);
    sub_1C94098(&StringLiteral_3096/*"Battle/Field/{0}"*/);
    byte_4D2F294 = 1;
  }
  v5 = motionId;
  v3 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v5);
...
System_String_o *BattleDataDefine__MakeBgPath(int32_t bgId, const MethodInfo *method)
{
  ...
  return BattleDataDefine__MakeBgPath_46796368(v3, v2);
}


System_String_o *BattleDataDefine__MakeBgPath_46796368(System_String_o *bgIdStr, const MethodInfo *method)
{
  if ( (byte_4D2F297 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_3152/*"Bg/"*/);
    byte_4D2F297 = 1;
  }
  return System_String__Concat_64417744((System_String_o *)StringLiteral_3152/*"Bg/"*/, bgIdStr, 0);
}
...
PlayerMasterIndividuality_o *BattleDataDefine__get_PlayerMasterIndividuality(const MethodInfo *method)
{
  ...
  if ( (byte_4D2F29E & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_JsonManager_Deserialize_PlayerMasterIndividuality___);
    sub_1C94098(&JsonManager_TypeInfo);
    sub_1C94098(&StringLiteral_10423/*"PLAYER_MASTER_INDIVIDUALITY"*/);
    byte_4D2F29E = 1;
  }
  v1 = BattleDataDefine_TypeInfo;
  if ( !BattleDataDefine_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    if ( !Master_object )
      sub_1C942F0(0, v4);
    Value = ConstantStrMaster__GetValue((ConstantStrMaster_o *)Master_object, (System_String_o *)StringLiteral_10423/*"PLAYER_MASTER_INDIVIDUALITY"*/, 0);
    ...
    if ( !IsNullOrEmpty )
    {
      ...
      v7 = JsonManager__Deserialize_object_(
             (Il2CppObject *)Value,
             (const MethodInfo_320C52C *)Method_JsonManager_Deserialize_PlayerMasterIndividuality___);
