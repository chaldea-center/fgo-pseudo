void BattleDataDefine___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C45947 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_3010/*"BUSTER_CHAIN_INDIVIDUALITY"*/);
    sub_1C37058(&StringLiteral_11426/*"RootCameraPrefab"*/);
    sub_1C37058(&StringLiteral_10916/*"QUICK_CHAIN_INDIVIDUALITY"*/);
    sub_1C37058(&StringLiteral_3087/*"Battle/Common"*/);
    sub_1C37058(&StringLiteral_2039/*"ARTS_CHAIN_INDIVIDUALITY"*/);
    sub_1C37058(&StringLiteral_3319/*"CHAIN_ERROR_INDIVIDUALITY"*/);
    sub_1C37058(&StringLiteral_3003/*"BRAVE_CHAIN_INDIVIDUALITY"*/);
    sub_1C37058(&StringLiteral_8669/*"MIGHTY_CHAIN_INDIVIDUALITY"*/);
    byte_4C45947 = 1;
  }
  ...
  *(_OWORD *)&static_fields->PERMILLAGE_DENOMINATOR_INT = xmmword_C0E360;
  v2 = sub_1C37100(int___TypeInfo, 1);
  v3 = BattleDataDefine_TypeInfo->static_fields;
  v3->NO_INDIVIDUALITY_ARRAY = (struct System_Int32_array *)v2;
  sub_1C36FFC((CGThumbnailListItem_o *)&v3->NO_INDIVIDUALITY_ARRAY, v2, v4, v5);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&v7->ASSET_BATTLE_COMMON, v6, v8, v9);
  v10 = StringLiteral_11426/*"RootCameraPrefab"*/;
  v11 = BattleDataDefine_TypeInfo->static_fields;
  v11->RootCameraAssetName = (struct System_String_o *)StringLiteral_11426/*"RootCameraPrefab"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&v11->RootCameraAssetName, v10, v12, v13);
  BattleDataDefine_TypeInfo->static_fields->ShadowServantDefaultColor = (struct UnityEngine_Color_o)xmmword_C0DF40;
  ...
  BattleDataDefine_TypeInfo->static_fields->_QuickChainIndividuality_k__BackingField = ConstantMaster__getValue(
                                                                                         (System_String_o *)StringLiteral_10916/*"QUICK_CHAIN_INDIVIDUALITY"*/,
                                                                                         0);
...
System_String_o *BattleDataDefine__AddUniqueCameraPath(int32_t cameraId, const MethodInfo *method)
{
  ...
  if ( (byte_4C4593D & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_3105/*"Battle/UniqueCamera/Add/{0}"*/);
    byte_4C4593D = 1;
  }
  v11 = cameraId;
...
System_String_o *BattleDataDefine__FieldMotionPath(int32_t motionId, const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&int_TypeInfo);
    sub_1C37058(&StringLiteral_3095/*"Battle/Field/{0}"*/);
    byte_4C4593C = 1;
  }
  v11 = motionId;
  v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, v2, v3, v4, v5, v6, v7);
...
System_String_o *BattleDataDefine__MakeBgPath(int32_t bgId, const MethodInfo *method)
{
  ...
  return BattleDataDefine__MakeBgPath_45974380(v3, v2);
}


System_String_o *BattleDataDefine__MakeBgPath_45974380(System_String_o *bgIdStr, const MethodInfo *method)
{
  if ( (byte_4C4593F & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_3149/*"Bg/"*/);
    byte_4C4593F = 1;
  }
  return System_String__Concat_63561656((System_String_o *)StringLiteral_3149/*"Bg/"*/, bgIdStr, 0);
}
...
PlayerMasterIndividuality_o *BattleDataDefine__get_PlayerMasterIndividuality(const MethodInfo *method)
{
  ...
  if ( (byte_4C45946 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_JsonManager_Deserialize_PlayerMasterIndividuality___);
    sub_1C37058(&JsonManager_TypeInfo);
    sub_1C37058(&StringLiteral_10389/*"PLAYER_MASTER_INDIVIDUALITY"*/);
    byte_4C45946 = 1;
  }
  v1 = BattleDataDefine_TypeInfo;
  if ( !BattleDataDefine_TypeInfo->_2.cctor_finished )
  ...
  else
  {
    ...
    if ( !Master_object )
      sub_1C372B4(0);
    Value = ConstantStrMaster__GetValue((ConstantStrMaster_o *)Master_object, (System_String_o *)StringLiteral_10389/*"PLAYER_MASTER_INDIVIDUALITY"*/, 0);
    ...
    if ( !IsNullOrEmpty )
    {
      ...
      v6 = JsonManager__Deserialize_object_(
             (Il2CppObject *)Value,
             (const MethodInfo_3156F74 *)Method_JsonManager_Deserialize_PlayerMasterIndividuality___);
      ...
      sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->playerMasterIndividuality, (int32_t)v10, v7, v8);
      return BattleDataDefine_TypeInfo->static_fields->playerMasterIndividuality;
    }
  }
