void __fastcall BattleDataDefine___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B396DA & 1) == 0 )
  {
    sub_1BD3458(&BattleDataDefine_TypeInfo, v1);
    sub_1BD3458(&int___TypeInfo, v2);
    sub_1BD3458(&StringLiteral_3240/*"Battle/Common"*/, v3);
    byte_4B396DA = 1;
  }
  ...
  *(_OWORD *)&static_fields->PERMILLAGE_DENOMINATOR_INT = xmmword_BD7680;
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v6->NO_INDIVIDUALITY_ARRAY, v5, v7, v8, v9, v10, v11, v12);
  v13 = StringLiteral_3240/*"Battle/Common"*/;
  v14 = BattleDataDefine_TypeInfo->static_fields;
  v14->ASSET_BATTLE_COMMON = (struct System_String_o *)StringLiteral_3240/*"Battle/Common"*/;
  sub_1BD33FC((PartyOrganizationUtility_o *)&v14->ASSET_BATTLE_COMMON, v13, v15, v16, v17, v18, v19, v20);
  BattleDataDefine_TypeInfo->static_fields->ShadowServantDefaultColor = (struct UnityEngine_Color_o)xmmword_BD7280;
}
...
System_String_o *__fastcall BattleDataDefine__AddUniqueCameraPath(int32_t cameraId, const MethodInfo *method)
{
  ...
  if ( (byte_4B396D7 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_3256/*"Battle/UniqueCamera/Add/{0}"*/, v6);
    byte_4B396D7 = 1;
  }
  v9 = cameraId;
  v7 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v9, v2, v3, v4);
  return System_String__Format((System_String_o *)StringLiteral_3256/*"Battle/UniqueCamera/Add/{0}"*/, v7, 0LL);
}
...
System_String_o *__fastcall BattleDataDefine__FieldMotionPath(int32_t motionId, const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&int_TypeInfo, method);
    sub_1BD3458(&StringLiteral_3246/*"Battle/Field/{0}"*/, v6);
    byte_4B396D6 = 1;
  }
  v9 = motionId;
  v7 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v9, v2, v3, v4);
  return System_String__Format((System_String_o *)StringLiteral_3246/*"Battle/Field/{0}"*/, v7, 0LL);
}
...
System_String_o *__fastcall BattleDataDefine__MakeBgPath(int32_t bgId, const MethodInfo *method)
{
  ...
  return BattleDataDefine__MakeBgPath_43530548(v3, v2);
}


System_String_o *__fastcall BattleDataDefine__MakeBgPath_43530548(System_String_o *bgIdStr, const MethodInfo *method)
{
  if ( (byte_4B396D9 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_3298/*"Bg/"*/, method);
    byte_4B396D9 = 1;
  }
  return System_String__Concat_62525248((System_String_o *)StringLiteral_3298/*"Bg/"*/, bgIdStr, 0LL);
}
