        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CF96 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_OtherUserGameMaster___, *(_QWORD *)&kind);
    sub_1C3B764(&Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long__GetEntity__, v11);
  ...
  v15 = (IconLabelInfo_o *)sub_1C3B9B0(IconLabelInfo_TypeInfo);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FF0204 *)Method_DataManager_GetMasterData_OtherUserGameMaster___)) == 0LL )
  {
...
// local variable allocation has failed, the output may be wrong!
void __fastcall FriendOperationItemListViewItem___ctor_31913008(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CF97 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_Dictionary_int__int___ctor___77804048, *(_QWORD *)&kind);
    sub_1C3B764(&System_Collections_Generic_Dictionary_int__int__TypeInfo, v13);
    sub_1C3B764(&IconLabelInfo_TypeInfo, v14);
    byte_4C1CF97 = 1;
  }
  v15 = (IconLabelInfo_o *)sub_1C3B9B0(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v15, 0LL);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall FriendOperationItemListViewItem___ctor_31913324(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        OtherUserGameEntity_o *otherUserGameEntity,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&Method_System_Collections_Generic_Dictionary_int__int___ctor___77804048, *(_QWORD *)&kind);
    sub_1C3B764(&System_Collections_Generic_Dictionary_int__int__TypeInfo, v15);
  ...
  sub_1C3B708(&this->fields.userBlacklistEntity);
  if ( classBoardMaxNumDictionary )
  {
    v19 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1C3B9B0(System_Collections_Generic_Dictionary_int__int__TypeInfo);
    System_Collections_Generic_Dictionary_int__int____ctor_53393384(
      v19,
      (System_Collections_Generic_IDictionary_TKey__TValue__o *)classBoardMaxNumDictionary,
      (const MethodInfo_32EB7E8 *)Method_System_Collections_Generic_Dictionary_int__int___ctor___77804048);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall FriendOperationItemListViewItem___ctor_31913660(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        OtherUserGameEntity_o *otherUserGameEntity,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708(&this->fields.userFriendRequestHistoryEntity);
  if ( classBoardMaxNumDictionary )
  {
    v19 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1C3B9B0(System_Collections_Generic_Dictionary_int__int__TypeInfo);
    System_Collections_Generic_Dictionary_int__int____ctor_53393384(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CF9E & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_ServantClassMaster___, *(_QWORD *)&classPos);
    ...
    sub_1C3B764(&Method_DataMasterBase_ServantClassMaster__ServantClassEntity__int__GetEntity__, v11);
    sub_1C3B764(&Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__, v12);
  ...
  if ( !*(_DWORD *)(v16 + 24) )
LABEL_54:
    sub_1C3B9C8(otherUserGameEntity, *(_QWORD *)&classPos);
  v17 = *(_DWORD *)(v16 + 32);
  ...
  {
    v19 = SvtId;
    otherUserGameEntity = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !otherUserGameEntity )
      goto LABEL_53;
...
LABEL_46:
        ...
        otherUserGameEntity = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_ServantMaster___);
        if ( otherUserGameEntity )
        {
          otherUserGameEntity = DataMasterBase_object__object__int___GetEntity(
                                  (DataMasterBase_TMaster__TEntity__PKType__o *)otherUserGameEntity,
          ...
          if ( otherUserGameEntity )
          {
            ...
            otherUserGameEntity = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_ClassBoardClassMaster___);
            if ( otherUserGameEntity )
            {
...
LABEL_53:
        sub_1C3B9C0(otherUserGameEntity, *(_QWORD *)&classPos);
      }
      v26 = 1LL;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CFA5 & 1) == 0 )
  {
    ...
    this = (FriendOperationItemListViewItem_o *)sub_1C3B764(&SkillInfo___TypeInfo, v5);
    byte_4C1CFA5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( otherUserGameEntity )
  {
    mainSupportDeckIds = otherUserGameEntity->fields.mainSupportDeckIds;
    if ( !mainSupportDeckIds )
      sub_1C3B9C0(otherUserGameEntity, tdInfo);
    if ( !mainSupportDeckIds->max_length )
      sub_1C3B9C8(otherUserGameEntity, tdInfo);
  ...
  {
    v8 = (TreasureDvcInfo_o *)sub_1C3B9B0(TreasureDvcInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !otherUserGameEntity || (mainSupportDeckIds = otherUserGameEntity->fields.mainSupportDeckIds) == 0LL )
    sub_1C3B9C0(otherUserGameEntity, method);
  if ( !mainSupportDeckIds->max_length )
    sub_1C3B9C8(otherUserGameEntity, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CF9F & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_FunctionMaster___, *(_QWORD *)&priorityKind);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CFA0 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_1391/*"2D UI"*/, v8);
    sub_1C3B764(&StringLiteral_1244/*"1.2.840.113549.1.7.2"*/, v9);
    sub_1C3B764(&StringLiteral_1191/*"1.0"*/, v10);
    byte_4C1CFA0 = 1;
  }
...
LABEL_10:
  ...
  if ( FriendOperationItemListViewItem__get_EquipTargetInfo(this, v18) )
  {
    ...
    *(_QWORD *)&v58.fields.fakeValue = v19;
    v21 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v58, 0LL);
    if ( ValuesDictionary )
    {
      if ( v21 >= 1 )
      {
        if ( (unsigned int)(priorityKind - 2) >= 4 )
        {
          if ( priorityKind == 6 )
          {
            v25 = &StringLiteral_1391/*"2D UI"*/;
          }
          else
          {
            if ( priorityKind != 1 )
              goto LABEL_47;
            v25 = &StringLiteral_1191/*"1.0"*/;
          }
          if ( System_Collections_Generic_Dictionary_object__int___ContainsKey(
...
LABEL_81:
            sub_1C3B9C0(iconLabelInfo2, sort);
          }
        }
...
LABEL_47:
  ...
  if ( !v36 )
    goto LABEL_81;
  if ( !*(_DWORD *)(v36 + 24) )
    sub_1C3B9C8(iconLabelInfo2, sort);
  ...
  switch ( sortKind )
  {
    ...
    case 6:
      ...
      v50 = 5;
LABEL_68:
      IconLabelInfo__Set_39561332(iconLabelInfo1, v50, v47, v48, v49, 0, 0, 0, 0LL);
      iconLabelInfo2 = (int64_t)this->fields.otherUserGameEntity;
      if ( !iconLabelInfo2 )
        goto LABEL_81;
...
LABEL_74:
      ...
      if ( !v41 )
        goto LABEL_81;
      IconLabelInfo__Set_39561332(v41, 2, v55, iconLabelInfo2, 0, 0, 0, 0, 0LL);
      break;
    case 17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CF9B & 1) == 0 )
  {
    sub_1C3B764(&FriendOperationItemListViewObject_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CFA2 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_3816/*"CP01147"*/, v6);
    byte_4C1CFA2 = 1;
  }
  servantEntity = this->fields.servantEntity;
  if ( !servantEntity )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_3816/*"CP01147"*/, 0LL);
  }
  otherUserGameEntity = this->fields.otherUserGameEntity;
  if ( !otherUserGameEntity )
  ...
  if ( !mainSupportDeckIds )
    goto LABEL_21;
  if ( !mainSupportDeckIds->max_length )
    sub_1C3B9C8(servantEntity, method);
  ServantLeaderInfo = OtherUserGameEntity__getServantLeaderInfo(
                        this->fields.otherUserGameEntity,
                        this->fields.classPos,
                        0,
  ...
  if ( System_String__IsNullOrEmpty(overwriteServantName, 0LL) )
  {
    ...
    *(_QWORD *)&v18.fields.fakeValue = v14;
    servantEntity = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v18, 0LL);
    if ( v16 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CF9A & 1) == 0 )
  {
    sub_1C3B764(&FriendOperationItemListViewManager_TypeInfo, value);
    sub_1C3B764(&FriendOperationItemListViewObject_TypeInfo, v5);
...
LABEL_15:
      ...
      v13 = (FriendOperationItemListViewItem_o *)sub_1C3BC80(v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CF9C & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_TblFriendMaster___, *(_QWORD *)&kind);
