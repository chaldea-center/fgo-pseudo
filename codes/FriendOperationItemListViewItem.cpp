        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292CC & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_OtherUserGameMaster___, *(_QWORD *)&kind);
    sub_1B761C0(&Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long__GetEntity__, v11);
  ...
  v15 = (IconLabelInfo_o *)sub_1B7640C(IconLabelInfo_TypeInfo);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_OtherUserGameMaster___)) == 0LL )
  {
...
// local variable allocation has failed, the output may be wrong!
void __fastcall FriendOperationItemListViewItem___ctor_30708168(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292CD & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_int__int___ctor___75807128, *(_QWORD *)&kind);
    sub_1B761C0(&System_Collections_Generic_Dictionary_int__int__TypeInfo, v13);
    sub_1B761C0(&IconLabelInfo_TypeInfo, v14);
    byte_4A292CD = 1;
  }
  v15 = (IconLabelInfo_o *)sub_1B7640C(IconLabelInfo_TypeInfo);
  IconLabelInfo___ctor(v15, 0LL);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall FriendOperationItemListViewItem___ctor_30708484(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        OtherUserGameEntity_o *otherUserGameEntity,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_int__int___ctor___75807128, *(_QWORD *)&kind);
    sub_1B761C0(&System_Collections_Generic_Dictionary_int__int__TypeInfo, v15);
  ...
  sub_1B76164(&this->fields.userBlacklistEntity);
  if ( classBoardMaxNumDictionary )
  {
    v19 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1B7640C(System_Collections_Generic_Dictionary_int__int__TypeInfo);
    System_Collections_Generic_Dictionary_int__int____ctor_51668160(
      v19,
      (System_Collections_Generic_IDictionary_TKey__TValue__o *)classBoardMaxNumDictionary,
      (const MethodInfo_31464C0 *)Method_System_Collections_Generic_Dictionary_int__int___ctor___75807128);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall FriendOperationItemListViewItem___ctor_30708820(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        OtherUserGameEntity_o *otherUserGameEntity,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164(&this->fields.userFriendRequestHistoryEntity);
  if ( classBoardMaxNumDictionary )
  {
    v19 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1B7640C(System_Collections_Generic_Dictionary_int__int__TypeInfo);
    System_Collections_Generic_Dictionary_int__int____ctor_51668160(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292D4 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantClassMaster___, *(_QWORD *)&classPos);
    ...
    sub_1B761C0(&Method_DataManager_GetMaster_ClassBoardClassMaster___, v8);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__, v13);
  ...
  if ( !*(_DWORD *)(v17 + 24) )
LABEL_54:
    sub_1B76424(otherUserGameEntity, *(_QWORD *)&classPos, method, v3);
  v18 = *(_DWORD *)(v17 + 32);
  ...
  {
    v20 = SvtId;
    otherUserGameEntity = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !otherUserGameEntity )
      goto LABEL_53;
...
LABEL_46:
        ...
        otherUserGameEntity = DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_ServantMaster___);
        if ( otherUserGameEntity )
        {
          otherUserGameEntity = DataMasterBase_object__object__int___GetEntity(
                                  (DataMasterBase_TMaster__TEntity__PKType__o *)otherUserGameEntity,
          ...
          if ( otherUserGameEntity )
          {
            ...
            otherUserGameEntity = DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_ClassBoardClassMaster___);
            if ( otherUserGameEntity )
            {
...
LABEL_53:
        sub_1B7641C(otherUserGameEntity, *(_QWORD *)&classPos);
      }
      v27 = 1LL;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292DB & 1) == 0 )
  {
    ...
    this = (FriendOperationItemListViewItem_o *)sub_1B761C0(&SkillInfo___TypeInfo, v5);
    byte_4A292DB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( otherUserGameEntity )
  {
    mainSupportDeckIds = otherUserGameEntity->fields.mainSupportDeckIds;
    if ( !mainSupportDeckIds )
      sub_1B7641C(otherUserGameEntity, tdInfo);
    if ( !mainSupportDeckIds->max_length )
      sub_1B76424(otherUserGameEntity, tdInfo);
  ...
  {
    v8 = (TreasureDvcInfo_o *)sub_1B7640C(TreasureDvcInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !otherUserGameEntity || (mainSupportDeckIds = otherUserGameEntity->fields.mainSupportDeckIds) == 0LL )
    sub_1B7641C(otherUserGameEntity, method);
  if ( !mainSupportDeckIds->max_length )
    sub_1B76424(otherUserGameEntity, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292D5 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_FunctionMaster___, *(_QWORD *)&priorityKind);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292D6 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_1413/*"2"*/, v8);
...
LABEL_10:
  ...
  if ( FriendOperationItemListViewItem__get_EquipTargetInfo(this, v18) )
  {
    ...
    *(_QWORD *)&v58.fields.fakeValue = v19;
    v21 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v58, 0LL);
    if ( ValuesDictionary )
    {
      if ( v21 >= 1 )
      {
...
LABEL_81:
            sub_1B7641C(iconLabelInfo2, sort);
          }
        }
...
LABEL_47:
  ...
  if ( !v36 )
    goto LABEL_81;
  if ( !*(_DWORD *)(v36 + 24) )
    sub_1B76424(iconLabelInfo2, sort);
  ...
  switch ( sortKind )
  {
    ...
    case 6:
      ...
      v50 = 5;
LABEL_68:
      IconLabelInfo__Set_37960168(iconLabelInfo1, v50, v47, v48, v49, 0, 0, 0, 0LL);
      iconLabelInfo2 = (int64_t)this->fields.otherUserGameEntity;
      if ( !iconLabelInfo2 )
        goto LABEL_81;
...
LABEL_74:
      ...
      if ( !v41 )
        goto LABEL_81;
      IconLabelInfo__Set_37960168(v41, 2, v55, iconLabelInfo2, 0, 0, 0, 0, 0LL);
      break;
    case 17:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292D1 & 1) == 0 )
  {
    sub_1B761C0(&FriendOperationItemListViewObject_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292D8 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_3771/*"COMMON_NO_ENTRY"*/, v3);
    byte_4A292D8 = 1;
  }
  servantEntity = this->fields.servantEntity;
  if ( !servantEntity )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_3771/*"COMMON_NO_ENTRY"*/, 0LL);
  }
  otherUserGameEntity = this->fields.otherUserGameEntity;
  if ( !otherUserGameEntity )
  {
LABEL_15:
  ...
  if ( !mainSupportDeckIds )
    goto LABEL_18;
  if ( !mainSupportDeckIds->max_length )
    sub_1B76424(servantEntity, method);
  ServantLeaderInfo = OtherUserGameEntity__getServantLeaderInfo(
                        this->fields.otherUserGameEntity,
                        this->fields.classPos,
                        0,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292D0 & 1) == 0 )
  {
    sub_1B761C0(&FriendOperationItemListViewManager_TypeInfo, value);
    sub_1B761C0(&FriendOperationItemListViewObject_TypeInfo, v5);
  ...
  if ( this->fields.swapMessageDisp != v4 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(viewObject, 0LL, 0LL) )
    {
      ...
      if ( v10 )
      {
        ...
        {
          v10 = (struct ListViewObject_o *)sub_1B766DC(v10);
          goto LABEL_14;
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A292D2 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_TblFriendMaster___, *(_QWORD *)&kind);
