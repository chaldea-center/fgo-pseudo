...
void FriendOperationItemListViewItem___ctor_32984092(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354(&this->fields.otherUserGameEntity, otherUserGameEntity);
  ...
  sub_1C71354(&this->fields.classBoardMaxNumDictionary, v15);
  FriendOperationItemListViewItem__setupItem(this, kind, classPos, v16);
}


void FriendOperationItemListViewItem___ctor_32984408(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        OtherUserGameEntity_o *otherUserGameEntity,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354(&this->fields.classBoardMaxNumDictionary, v17);
  FriendOperationItemListViewItem__setupItem(this, kind, classPos, v18);
}


void FriendOperationItemListViewItem___ctor_32984744(
        FriendOperationItemListViewItem_o *this,
        int32_t kind,
        int32_t index,
        OtherUserGameEntity_o *otherUserGameEntity,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354(&this->fields.userFriendRequestHistoryEntity, userFriendRequestHistoryEntity);
  if ( classBoardMaxNumDictionary )
  {
    v17 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1C715FC(System_Collections_Generic_Dictionary_int__int__TypeInfo);
    System_Collections_Generic_Dictionary_int__int____ctor_54890232(
        ...
        const MethodInfo *method)
{
  ...
  if ( !*(_DWORD *)(v8 + 24) )
LABEL_54:
    sub_1C71610(otherUserGameEntity);
  v9 = *(_DWORD *)(v8 + 32);
  ...
  {
    v11 = SvtId;
    otherUserGameEntity = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !otherUserGameEntity )
      goto LABEL_53;
    ...
    sub_1C71354(&this->fields.servantEntity, Entity);
    otherUserGameEntity = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !otherUserGameEntity )
      goto LABEL_53;
    otherUserGameEntity = DataManager__GetMasterData_object_(
...
LABEL_46:
        ...
        otherUserGameEntity = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_ServantMaster___);
        if ( otherUserGameEntity )
        {
          otherUserGameEntity = DataMasterBase_object__object__int___GetEntity(
                                  (DataMasterBase_TMaster__TEntity__PKType__o *)otherUserGameEntity,
          ...
          if ( otherUserGameEntity )
          {
            ...
            otherUserGameEntity = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_ClassBoardClassMaster___);
            if ( otherUserGameEntity )
            {
...
LABEL_53:
        sub_1C71608(otherUserGameEntity, *(_QWORD *)&classPos);
      }
      v19 = 1;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1F38 & 1) == 0 )
  {
    ...
    this = (FriendOperationItemListViewItem_o *)sub_1C713B0(&SkillInfo___TypeInfo);
    byte_4CC1F38 = 1;
  }
  ...
  if ( otherUserGameEntity )
  {
    ...
    if ( !mainSupportDeckIds )
      sub_1C71608(this, skillInfoList);
        ...
        const MethodInfo *method)
{
  ...
  if ( otherUserGameEntity )
  {
    mainSupportDeckIds = otherUserGameEntity->fields.mainSupportDeckIds;
    if ( !mainSupportDeckIds )
      sub_1C71608(otherUserGameEntity, tdInfo);
    if ( !LODWORD(mainSupportDeckIds->max_length) )
      sub_1C71610(otherUserGameEntity);
  ...
  {
    v8 = (TreasureDvcInfo_o *)sub_1C715FC(TreasureDvcInfo_TypeInfo);
    TreasureDvcInfo___ctor(v8, 0);
    *tdInfo = v8;
    sub_1C71354(tdInfo, v8);
    return 0;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v8 = (SkillInfo_array *)sub_1C71458(SkillInfo___TypeInfo, (unsigned int)v7->static_fields->SvtSkillListMax);
    *skillInfoList = v8;
    sub_1C71354(skillInfoList, v8);
  }
  return otherUserGameEntity != 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !otherUserGameEntity || (mainSupportDeckIds = otherUserGameEntity->fields.mainSupportDeckIds) == 0 )
    sub_1C71608(otherUserGameEntity, method);
  if ( !LODWORD(mainSupportDeckIds->max_length) )
    sub_1C71610(otherUserGameEntity);
...
LABEL_10:
  ...
  if ( FriendOperationItemListViewItem__get_EquipTargetInfo(this, v12) )
  {
    ...
    *(_QWORD *)&v54.fields.fakeValue = v13;
    v15 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v54, 0);
    if ( ValuesDictionary )
    {
      if ( v15 >= 1 )
      {
...
LABEL_77:
            sub_1C71608(iconLabelInfo2, sort);
          }
        }
...
LABEL_47:
  ...
  switch ( sortKind )
  {
    ...
    case 5:
      ...
      if ( !iconLabelInfo1 )
        goto LABEL_77;
      IconLabelInfo__Set_41192248(iconLabelInfo1, 3, v42, v43, iconLabelInfo2, 0, 0, 0, 0, 0);
      goto LABEL_64;
    case 6:
      atk = this->fields.atk;
      ...
      if ( !v48 )
        goto LABEL_77;
      IconLabelInfo__Set_41192248(v48, 5, v49, v50, iconLabelInfo2, 0, 0, 0, 0, 0);
LABEL_64:
      iconLabelInfo2 = (int64_t)this->fields.otherUserGameEntity;
      if ( !iconLabelInfo2 )
        goto LABEL_77;
...
LABEL_70:
      ...
      if ( !v35 )
        goto LABEL_77;
      IconLabelInfo__Set_41192248(v35, 2, v51, iconLabelInfo2, 0, 0, 0, 0, 0, 0);
      break;
    case 17:
...
void FriendOperationItemListViewItem__SwapLock(FriendOperationItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1F2E & 1) == 0 )
  {
    sub_1C713B0(&FriendOperationItemListViewObject_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantEntity )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_3698/*"COMMON_NO_ENTRY"*/, 0);
  }
  otherUserGameEntity = this->fields.otherUserGameEntity;
  if ( !otherUserGameEntity )
  ...
  if ( System_String__IsNullOrEmpty(overwriteServantName, 0) )
  {
    ...
    *(_QWORD *)&v14.fields.fakeValue = v10;
    servantEntity = (ServantEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v14, 0);
    if ( v12 )
  ...
  if ( this->fields.swapMessageDisp != v4 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(viewObject, 0, 0) )
    {
      ...
      if ( v8 )
      {
        ...
        {
          v8 = (struct ListViewObject_o *)sub_1C719A4(v8);
          goto LABEL_14;
        }
