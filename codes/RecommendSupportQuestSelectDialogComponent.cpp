        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E08D & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, callAction);
    sub_1C3B764(&Method_RecommendSupportQuestSelectDialogComponent___c__DisplayClass33_0__Close_b__0__, v5);
    sub_1C3B764(&RecommendSupportQuestSelectDialogComponent___c__DisplayClass33_0_TypeInfo, v6);
    byte_4C1E08D = 1;
  }
  v7 = sub_1C3B9B0(RecommendSupportQuestSelectDialogComponent___c__DisplayClass33_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = callAction;
  sub_1C3B708((PartyOrganizationUtility_o *)(v7 + 24), (int64_t)callAction, v16, v17, v18, v19, v20, v21);
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E08C & 1) == 0 )
  {
    sub_1C3B764(&Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__, method);
    byte_4C1E08C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E08B & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_RecommendSupportQuestSelectDialogComponent_CallOnDecide__, v3);
    sub_1C3B764(&Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__, v4);
    byte_4C1E08B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C3B77C(Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E088 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_RecommendSupportQuestSelectDialogComponent__Open_b__27_0__, v14);
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v15);
    sub_1C3B764(&StringLiteral_11247/*"SELECT_NO_SORTIE_FATIGURE_NARROW_FIGURE"*/, v16);
    sub_1C3B764(&StringLiteral_11251/*"SELECT_NO_SORTIE_TIMES_TO_RESTART"*/, v17);
    sub_1C3B764(&StringLiteral_11249/*"SELECT_NO_SORTIE_FATIGURE_RECOVER_NARROW_FIGURE"*/, v18);
    sub_1C3B764(&StringLiteral_11250/*"SELECT_NO_SORTIE_REASON_FATIGUE"*/, v19);
    ...
    sub_1C3B764(&StringLiteral_11253/*"SELECT_PARTY"*/, v22);
    sub_1C3B764(&StringLiteral_3803/*"COST_ICON_INFO"*/, v23);
    sub_1C3B764(&StringLiteral_11248/*"SELECT_NO_SORTIE_FATIGURE_RECOVER"*/, v24);
    sub_1C3B764(&StringLiteral_11252/*"SELECT_NO_SORTIE_TITLE"*/, v25);
    byte_4C1E088 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1C3B708(
      ...
      v6,
      v7);
    Instance = (System_String_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    if ( Instance )
    {
      ...
      v30 = (System_String_o **)&StringLiteral_11252/*"SELECT_NO_SORTIE_TITLE"*/;
      if ( !isRemove )
        v30 = (System_String_o **)&StringLiteral_11251/*"SELECT_NO_SORTIE_TIMES_TO_RESTART"*/;
      Instance = LocalizationManager__Get(*v30, 0LL);
      if ( titleLb )
      {
        UILabel__set_text(titleLb, Instance, 0LL);
        v31 = (System_String_o **)&StringLiteral_11248/*"SELECT_NO_SORTIE_FATIGURE_RECOVER"*/;
        descriptionLb = this->fields.descriptionLb;
        if ( !isRemove )
          v31 = (System_String_o **)&StringLiteral_11247/*"SELECT_NO_SORTIE_FATIGURE_NARROW_FIGURE"*/;
        v33 = *v31;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        if ( descriptionLb )
        {
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              Instance = LocalizationManager__Get((System_String_o *)StringLiteral_11249/*"SELECT_NO_SORTIE_FATIGURE_RECOVER_NARROW_FIGURE"*/, 0LL);
              if ( situationLb )
              {
                ...
                if ( Instance )
                {
                  ...
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  v43 = (System_String_o **)&StringLiteral_3803/*"COST_ICON_INFO"*/;
                  if ( !isRemove )
                    v43 = (System_String_o **)&StringLiteral_3800/*"COSTUME_SELECT_SERVANT_EVENT_ITEM_COSTUME_MSG"*/;
                                ...
                                if ( item )
                                {
                                  ...
                                  if ( Instance )
                                  {
                                    ...
                                    if ( Instance )
                                    {
                                      ...
                                      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                      v53 = LocalizationManager__Get((System_String_o *)StringLiteral_11250/*"SELECT_NO_SORTIE_REASON_FATIGUE"*/, 0LL);
                                      ...
                                      if ( v52 )
                                      {
                                        ...
                                        v59 = LocalizationManager__Get((System_String_o *)StringLiteral_11253/*"SELECT_PARTY"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  Instance = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance )
    goto LABEL_41;
      ...
      if ( Instance )
      {
        ...
        if ( entity )
        {
          ...
          *(_QWORD *)&v26.fields.fakeValue = v20;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v26, 0LL);
          if ( v19 )
          {
            v22 = (int)Instance > 0;
            Instance = v19;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E089 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_UserServantMaster___, *(_QWORD *)&index);
    ...
    sub_1C3B764(&IconLabelInfo_TypeInfo, v7);
  ...
  if ( DataMasterBase_object__object__long___TryGetEntity(
         ...
         (const MethodInfo_329D3F0 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
  {
    v12 = (IconLabelInfo_o *)sub_1C3B9B0(IconLabelInfo_TypeInfo);
    ...
    if ( entity )
    {
      ...
      if ( v12 )
      {
        IconLabelInfo__Set_39561332(v12, 2, klass, Instance, 0, 0, 0, 0, 0LL);
