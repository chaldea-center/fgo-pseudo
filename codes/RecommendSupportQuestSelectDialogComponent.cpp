        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9886 & 1) == 0 )
  {
    sub_1C2E12C(&System_Action_TypeInfo, callAction);
    sub_1C2E12C(&Method_RecommendSupportQuestSelectDialogComponent___c__DisplayClass33_0__Close_b__0__, v5);
    sub_1C2E12C(&RecommendSupportQuestSelectDialogComponent___c__DisplayClass33_0_TypeInfo, v6);
    byte_4BF9886 = 1;
  }
  v7 = sub_1C2E378(RecommendSupportQuestSelectDialogComponent___c__DisplayClass33_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = callAction;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v7 + 24), (int64_t)callAction, v16, v17, v18, v19, v20, v21);
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9885 & 1) == 0 )
  {
    sub_1C2E12C(&Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__, method);
    byte_4BF9885 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2E144(Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9884 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_RecommendSupportQuestSelectDialogComponent_CallOnDecide__, v3);
    sub_1C2E12C(&Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__, v4);
    byte_4BF9884 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C2E144(Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9881 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_RecommendSupportQuestSelectDialogComponent__Open_b__27_0__, v14);
    sub_1C2E12C(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v15);
    sub_1C2E12C(&StringLiteral_11226/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION"*/, v16);
    sub_1C2E12C(&StringLiteral_11230/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE"*/, v17);
    sub_1C2E12C(&StringLiteral_11228/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_SITUATION"*/, v18);
    sub_1C2E12C(&StringLiteral_11229/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_SITUATION_WARNING"*/, v19);
    sub_1C2E12C(&StringLiteral_3800/*"COMMON_CONFIRM_DECIDE"*/, v20);
    sub_1C2E12C(&StringLiteral_3798/*"COMMON_CONFIRM_CANCEL"*/, v21);
    sub_1C2E12C(&StringLiteral_11232/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_WARNING"*/, v22);
    sub_1C2E12C(&StringLiteral_3803/*"COMMON_CONFIRM_REMOVE"*/, v23);
    sub_1C2E12C(&StringLiteral_11227/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION_REMOVE"*/, v24);
    sub_1C2E12C(&StringLiteral_11231/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE_REMOVE"*/, v25);
    byte_4BF9881 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1C2E0D0(
      ...
      v6,
      v7);
    Instance = (System_String_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    if ( Instance )
    {
      ...
      v30 = (System_String_o **)&StringLiteral_11231/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE_REMOVE"*/;
      if ( !isRemove )
        v30 = (System_String_o **)&StringLiteral_11230/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE"*/;
      Instance = LocalizationManager__Get(*v30, 0LL);
      if ( titleLb )
      {
        UILabel__set_text(titleLb, Instance, 0LL);
        v31 = (System_String_o **)&StringLiteral_11227/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION_REMOVE"*/;
        descriptionLb = this->fields.descriptionLb;
        if ( !isRemove )
          v31 = (System_String_o **)&StringLiteral_11226/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION"*/;
        v33 = *v31;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        if ( descriptionLb )
        {
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              Instance = LocalizationManager__Get((System_String_o *)StringLiteral_11228/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_SITUATION"*/, 0LL);
              if ( situationLb )
              {
                ...
                if ( Instance )
                {
                  ...
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  v43 = (System_String_o **)&StringLiteral_3803/*"COMMON_CONFIRM_REMOVE"*/;
                  if ( !isRemove )
                    v43 = (System_String_o **)&StringLiteral_3800/*"COMMON_CONFIRM_DECIDE"*/;
                                ...
                                if ( item )
                                {
                                  ...
                                  if ( Instance )
                                  {
                                    ...
                                    if ( Instance )
                                    {
                                      ...
                                      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                      v52 = LocalizationManager__Get((System_String_o *)StringLiteral_11229/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_SITUATION_WARNING"*/, 0LL);
                                      ...
                                      if ( v51 )
                                      {
                                        ...
                                        v58 = LocalizationManager__Get((System_String_o *)StringLiteral_11232/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_WARNING"*/, 0LL);
      ...
      if ( Instance )
      {
        ...
        if ( entity )
        {
          ...
          *(_QWORD *)&v26.fields.fakeValue = v20;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v26, 0LL);
          if ( v19 )
          {
            v22 = (int)Instance > 0;
            Instance = v19;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF9882 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMaster_UserServantMaster___, *(_QWORD *)&index);
    ...
    sub_1C2E12C(&IconLabelInfo_TypeInfo, v7);
  ...
  if ( DataMasterBase_object__object__long___TryGetEntity(
         ...
         (const MethodInfo_327D728 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
  {
    v12 = (IconLabelInfo_o *)sub_1C2E378(IconLabelInfo_TypeInfo);
    ...
    if ( entity )
    {
      ...
      if ( v12 )
      {
        IconLabelInfo__Set_39452344(v12, 2, klass, Instance, 0, 0, 0, 0, 0LL);
