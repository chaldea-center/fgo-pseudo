        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA82F & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, callAction);
    sub_1B64870(&Method_RecommendSupportQuestSelectDialogComponent___c__DisplayClass22_0__Close_b__0__, v5);
    sub_1B64870(&RecommendSupportQuestSelectDialogComponent___c__DisplayClass22_0_TypeInfo, v6);
    byte_49FA82F = 1;
  }
  v7 = sub_1B64ABC(RecommendSupportQuestSelectDialogComponent___c__DisplayClass22_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = callAction;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v7 + 24), (int32_t)callAction, v12, v13);
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA82E & 1) == 0 )
  {
    sub_1B64870(&Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__, method);
    byte_49FA82E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_RecommendSupportQuestSelectDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA82D & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_RecommendSupportQuestSelectDialogComponent_CallOnDecide__, v3);
    sub_1B64870(&Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__, v4);
    byte_49FA82D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B64888(Method_RecommendSupportQuestSelectDialogComponent_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA82A & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_RecommendSupportQuestSelectDialogComponent__Open_b__16_0__, v11);
    sub_1B64870(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v12);
    sub_1B64870(&StringLiteral_10969/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION"*/, v13);
    sub_1B64870(&StringLiteral_10972/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE"*/, v14);
    sub_1B64870(&StringLiteral_10971/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_SITUATION"*/, v15);
    sub_1B64870(&StringLiteral_3734/*"COMMON_CONFIRM_DECIDE"*/, v16);
    sub_1B64870(&StringLiteral_3732/*"COMMON_CONFIRM_CANCEL"*/, v17);
    sub_1B64870(&StringLiteral_3737/*"COMMON_CONFIRM_REMOVE"*/, v18);
    sub_1B64870(&StringLiteral_10970/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION_REMOVE"*/, v19);
    sub_1B64870(&StringLiteral_10973/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE_REMOVE"*/, v20);
    byte_49FA82A = 1;
  }
  if ( !this->fields.state )
  {
    this->fields.onDecide = action;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.onDecide, (int32_t)action, isRemove, (int32_t)action);
    Instance = (System_String_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    if ( !Instance )
      goto LABEL_27;
    ...
    v25 = (System_String_o **)&StringLiteral_10973/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE_REMOVE"*/;
    if ( !isRemove )
      v25 = (System_String_o **)&StringLiteral_10972/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_TITLE"*/;
    Instance = LocalizationManager__Get(*v25, 0LL);
    if ( !titleLb )
      goto LABEL_27;
    UILabel__set_text(titleLb, Instance, 0LL);
    v26 = (System_String_o **)&StringLiteral_10970/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION_REMOVE"*/;
    descriptionLb = this->fields.descriptionLb;
    if ( !isRemove )
      v26 = (System_String_o **)&StringLiteral_10969/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_DESCRIPTION"*/;
    v28 = *v26;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ...
    Instance = LocalizationManager__Get((System_String_o *)StringLiteral_10971/*"RECOMMEND_SUPPORT_QUEST_SELECT_DIALOG_SITUATION"*/, 0LL);
    if ( !situationLb )
      goto LABEL_27;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v36 = (System_String_o **)&StringLiteral_3737/*"COMMON_CONFIRM_REMOVE"*/;
    if ( !isRemove )
      v36 = (System_String_o **)&StringLiteral_3734/*"COMMON_CONFIRM_DECIDE"*/;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Instance = LocalizationManager__Get((System_String_o *)StringLiteral_3732/*"COMMON_CONFIRM_CANCEL"*/, 0LL);
    if ( !cancelButtonLb
        ...
        const MethodInfo *method)
{
  ...
  Instance = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance )
    goto LABEL_40;
      ...
      if ( Instance )
      {
        ...
        if ( entity )
        {
          ...
          *(_QWORD *)&v24.fields.fakeValue = v18;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v24, 0LL);
          if ( v17 )
          {
            v20 = (int)Instance > 0;
            Instance = v17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA82B & 1) == 0 )
  {
    ...
    sub_1B64870(&IconLabelInfo_TypeInfo, v5);
         ...
         (const MethodInfo_30D6380 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
  {
    ...
    if ( entity )
    {
      ...
      if ( v10 )
      {
        IconLabelInfo__Set_37829740(v10, 2, klass, Instance, 0, 0, 0, 0, 0LL);
