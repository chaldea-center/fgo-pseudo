...
void __fastcall MapEntity___ctor_40735408(MapEntity_o *this, MapEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
...
System_String_o *__fastcall MapEntity__CreatePK(int32_t id, int32_t warId, const MethodInfo *method)
{
  if ( (byte_4BFDAC0 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&warId);
    byte_4BFDAC0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDAC6 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, fadeType);
    sub_1C2E12C(&Method_System_Collections_Generic_Dictionary_string__object__get_Item__, v11);
    sub_1C2E12C(&long_TypeInfo, v12);
    sub_1C2E12C(&MapMaster_TypeInfo, v13);
...
LABEL_14:
    *fadeType = 0LL;
    sub_1C2E0D0((PartyOrganizationUtility_o *)fadeType, 0LL, (int64_t)fadeTime, (int32_t)method, v4, v5, v6, v7);
    return 0;
  }
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)fadeType, (int64_t)Item, v20, v21, v22, v23, v24, v25);
...
System_String_o *__fastcall MapEntity__GetOverwriteMapAssetId(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDAC8 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&MapMaster_TypeInfo, v4);
...
System_String_o *__fastcall MapEntity__GetPrioredBgmName(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDAC4 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_DataManager_GetMasterData_MapCondMaster___, v3);
    sub_1C2E12C(&Method_DataMasterBase_BgmMaster__BgmEntity__int__TryGetEntity__, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDAC5 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_MapCondMaster___, *(_QWORD *)&beforeClearQuestId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_MapCondMaster___)) == 0LL )
  {
...
int32_t __fastcall MapEntity__GetPrioredMapImageId(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDAC3 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_MapCondMaster___, method);
...
int32_t __fastcall MapEntity__GetReferrerMapId(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDAC7 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&MapMaster_TypeInfo, v5);
    byte_4BFDAC7 = 1;
  }
  script = this->fields.script;
  if ( !script )
...
float __fastcall MapEntity__GetSpotScale(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDACA & 1) == 0 )
  {
    ...
    sub_1C2E12C(&MapMaster_TypeInfo, v3);
    byte_4BFDACA = 1;
  }
...
System_Int32_array *__fastcall MapEntity__GetUseVoiceSvtIDList(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFDACB & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_System_Int32_Parse__, v6);
    sub_1C2E12C(&MapMaster_TypeInfo, v7);
  ...
  if ( (System_String_c *)value->klass == string_TypeInfo )
  {
    v12 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(
                                                                 ...
                                                                 0,
                                                                 0LL);
    v13 = (System_Func_object__int__o *)sub_1C2E378(System_Func_string__int__TypeInfo);
...
int32_t __fastcall MapEntity__get_MapCameraMoveEasingType(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  return JsonManager__GetScriptValue_39493056(script, MAP_CAMERA_MOVE_TIME_EASING_TYPE, MapCameraMoveEasingType, 0LL);
}
...
int32_t __fastcall MapEntity__get_MapCameraMoveTimeLogarithmBase(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  return JsonManager__GetScriptValue_39493056(
           script,
