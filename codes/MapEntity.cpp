...
void __fastcall MapEntity___ctor_39218472(MapEntity_o *this, MapEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
...
System_String_o *__fastcall MapEntity__CreatePK(int32_t id, int32_t warId, const MethodInfo *method)
{
  if ( (byte_4A2E282 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&warId);
    byte_4A2E282 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E288 & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__, fadeType);
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_string__object__get_Item__, v7);
    sub_1B761C0(&long_TypeInfo, v8);
    sub_1B761C0(&MapMaster_TypeInfo, v9);
...
LABEL_14:
    *fadeType = 0LL;
    sub_1B76164((ServantStatusBattleListViewItem_o *)fadeType, 0, (int32_t)fadeTime, (int32_t)method);
    return 0;
  }
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)fadeType, (int32_t)Item, v16, v17);
...
System_String_o *__fastcall MapEntity__GetOverwriteMapAssetId(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E28A & 1) == 0 )
  {
    ...
    sub_1B761C0(&MapMaster_TypeInfo, v4);
...
System_String_o *__fastcall MapEntity__GetPrioredBgmName(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E286 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMasterData_MapCondMaster___, v3);
    sub_1B761C0(&Method_DataMasterBase_BgmMaster__BgmEntity__int__TryGetEntity__, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E287 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_MapCondMaster___, *(_QWORD *)&beforeClearQuestId);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_MapCondMaster___)) == 0LL )
  {
...
int32_t __fastcall MapEntity__GetPrioredMapImageId(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E285 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_MapCondMaster___, method);
...
int32_t __fastcall MapEntity__GetReferrerMapId(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E289 & 1) == 0 )
  {
    ...
    sub_1B761C0(&MapMaster_TypeInfo, v5);
    byte_4A2E289 = 1;
  }
  script = this->fields.script;
  if ( !script )
...
float __fastcall MapEntity__GetSpotScale(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2E28C & 1) == 0 )
  {
    ...
    sub_1B761C0(&MapMaster_TypeInfo, v3);
    byte_4A2E28C = 1;
  }
...
int32_t __fastcall MapEntity__get_MapCameraMoveEasingType(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  return JsonManager__GetScriptValue_37999052(script, MAP_CAMERA_MOVE_TIME_EASING_TYPE, MapCameraMoveEasingType, 0LL);
}
...
int32_t __fastcall MapEntity__get_MapCameraMoveTimeLogarithmBase(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  return JsonManager__GetScriptValue_37999052(
           script,
