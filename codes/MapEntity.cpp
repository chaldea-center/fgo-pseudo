...
void __fastcall MapEntity___ctor_40661660(MapEntity_o *this, MapEntity_o *cSrc, const MethodInfo *method)
{
  __int64 v5; // x0
  __int64 v6; // x1
...
LABEL_14:
    *fadeType = 0LL;
    sub_1C21DDC((PartyOrganizationUtility_o *)fadeType, 0LL, (int64_t)fadeTime, (int32_t)method, v4, v5, v6, v7);
    return 0;
  }
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)fadeType, (int64_t)Item, v16, v17, v18, v19, v20, v21);
...
LABEL_26:
  sub_1C22354(Item);
  return MapEntity__GetReferrerMapId(v26, v27);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_MapCondMaster___)) == 0LL )
  {
...
System_Int32_array *__fastcall MapEntity__GetUseVoiceSvtIDList(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (System_String_c *)value->klass == string_TypeInfo )
  {
    v6 = (System_Collections_Generic_IEnumerable_TSource__o *)System_String__Split(
                                                                ...
                                                                0,
                                                                0LL);
    v7 = (System_Func_object__int__o *)sub_1C22084(System_Func_string__int__TypeInfo);
    System_Func_object__int____ctor(v7, 0LL, Method_System_Int32_Parse__, 0LL);
  ...
  {
    sub_1C22354(value);
    return (System_Int32_array *)MapGimmickEntity__CreatePrimaryKey(v10, v11);
  }
}
...
int32_t __fastcall MapEntity__get_MapCameraMoveEasingType(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  return JsonManager__GetScriptValue_39422488(script, MAP_CAMERA_MOVE_TIME_EASING_TYPE, MapCameraMoveEasingType, 0LL);
}
...
int32_t __fastcall MapEntity__get_MapCameraMoveTimeLogarithmBase(MapEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
  return JsonManager__GetScriptValue_39422488(
           script,
