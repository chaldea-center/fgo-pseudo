System_String_o *__fastcall FriendTopRequest__getURL(FriendTopRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23954 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_20025/*"img_masterprofile_bg2"*/, v2);
    byte_4C23954 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63368612(BaseUrl, (System_String_o *)StringLiteral_20025/*"img_masterprofile_bg2"*/, 0LL);
}
