        ...
        const MethodInfo *method)
{
  ...
  int32_t v44; // [xsp+4Ch] [xbp-44h] BYREF

  v12 = this;
  if ( (byte_4A01E77 & 1) == 0 )
  {
    this = (CombineExpUpClassInfo_o *)sub_1B64870(&CombineExpUpClassInfo_TypeInfo, *(_QWORD *)&classId);
    byte_4A01E77 = 1;
  }
  v44 = 0;
...
LABEL_89:
    sub_1B64AD4(this, *(_QWORD *)&classId);
  }
  if ( v29 != 4 )
    goto LABEL_86;
  this = (CombineExpUpClassInfo_o *)CombineExpUpClassInfo_TypeInfo;
  ...
  {
LABEL_88:
    sub_1B64ACC(this, *(_QWORD *)&classId);
  }
  if ( v32->max_length <= 4 )
    goto LABEL_89;
...
void __fastcall CombineExpUpClassInfo__Set_44755116(
        CombineExpUpClassInfo_o *this,
        System_Int32_array *numList,
        const MethodInfo *method)
{
