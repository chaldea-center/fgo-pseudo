        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C0146C & 1) == 0 )
  {
    this = (CombineExpUpClassInfo_o *)sub_1C2E12C(&CombineExpUpClassInfo_TypeInfo, *(_QWORD *)&classId);
    byte_4C0146C = 1;
  }
  v44 = 0;
...
LABEL_89:
    sub_1C2E390(this, *(_QWORD *)&classId);
  }
  if ( v29 != 4 )
    goto LABEL_86;
  this = (CombineExpUpClassInfo_o *)CombineExpUpClassInfo_TypeInfo;
...
void __fastcall CombineExpUpClassInfo__Set_46752848(
        CombineExpUpClassInfo_o *this,
        System_Int32_array *numList,
        const MethodInfo *method)
{
