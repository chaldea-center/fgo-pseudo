        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73877 & 1) == 0 )
  {
    this = (CombineExpUpClassInfo_o *)sub_1B90010(&CombineExpUpClassInfo_TypeInfo, *(_QWORD *)&classId);
    byte_4A73877 = 1;
  }
  v44 = 0;
...
LABEL_89:
    sub_1B90274(this, *(_QWORD *)&classId);
  }
  if ( v29 != 4 )
    goto LABEL_86;
  this = (CombineExpUpClassInfo_o *)CombineExpUpClassInfo_TypeInfo;
  ...
  {
LABEL_88:
    sub_1B9026C(this, *(_QWORD *)&classId);
  }
  if ( v32->max_length <= 4 )
    goto LABEL_89;
...
void __fastcall CombineExpUpClassInfo__Set_45178440(
        CombineExpUpClassInfo_o *this,
        System_Int32_array *numList,
        const MethodInfo *method)
{
