        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2348C & 1) == 0 )
  {
    this = (CombineExpUpClassInfo_o *)sub_1B715CC(&CombineExpUpClassInfo_TypeInfo, *(_QWORD *)&classId);
    byte_4A2348C = 1;
  }
  v44 = 0;
...
LABEL_89:
    sub_1B71830(this, *(_QWORD *)&classId);
  }
  if ( v29 != 4 )
    goto LABEL_86;
  this = (CombineExpUpClassInfo_o *)CombineExpUpClassInfo_TypeInfo;
  ...
  {
LABEL_88:
    sub_1B71828(this, *(_QWORD *)&classId);
  }
  if ( v32->max_length <= 4 )
    goto LABEL_89;
...
void __fastcall CombineExpUpClassInfo__Set_44894676(
        CombineExpUpClassInfo_o *this,
        System_Int32_array *numList,
        const MethodInfo *method)
{
