void ActionChainBase_object____ctor(
        ...
        const MethodInfo_3406B80 *method)
{
  ...
  ActionChainBase_object___AddRange(
    this,
    chains,
    (const MethodInfo_3406C34 *)method->klass->rgctx_data->_3_ActionChainBase_T__AddRange);
}
...
ActionChainBase_T__o *ActionChainBase_object___AddRange(
        ...
        const MethodInfo_3406C34 *method)
{
  ...
  if ( (byte_4C3D4A2 & 1) == 0 )
  {
    this = (ActionChainBase_T__o *)sub_1C32C20(&System_Action_TypeInfo);
    byte_4C3D4A2 = 1;
  }
  if ( !v5 )
    goto LABEL_17;
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v8 )
          break;
        v8[1].monitor = v9;
        sub_1C32BC4((CGThumbnailListItem_o *)&v8[1].monitor, (int32_t)v9, v10, v11);
        ...
        if ( (unsigned int)nextAction_low >= LODWORD(endCallback->fields.invoke_impl) )
        {
          System_Collections_Generic_List_object___AddWithResize(
            ...
            v8,
            (const MethodInfo_37987BC *)_8_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
        }
        else
        {
          ...
          sub_1C32BC4((CGThumbnailListItem_o *)(v17 + 4), (int32_t)v8, v12, v13);
        }
        max_length = chainElems->max_length;
...
void ActionChainBase_object___DoNext(ActionChainBase_T__o *this, const MethodInfo_34070FC *method)
{
    ...
    *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = v4;
    ...
    else
    {
      Item = System_Collections_Generic_List_object___get_Item(
               v3,
               v4,
               (const MethodInfo_37984EC *)method->klass->rgctx_data->_19_ActionChainBase_T__ExecuteCurrentAction);
...
void ActionChainBase_object___ExecuteOnDetail(ActionChainBase_T__o *this, const MethodInfo_34070EC *method)
{
  ActionChainBase_object___DoNext(
    this,
    (const MethodInfo_34070FC *)method->klass->rgctx_data->_7_ActionChainBase_T__DoNext);
}


void ActionChainBase_object___Init(ActionChainBase_T__o *this, const MethodInfo_3406BCC *method)
{
  ...
  *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = -1;
  ...
  if ( (*(_BYTE *)(_4_System_Collections_Generic_List_T + 309) & 1) == 0 )
    _4_System_Collections_Generic_List_T = sub_1C83334();
  v5 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(_4_System_Collections_Generic_List_T);
  klass = method->klass;
  v7 = v5;
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3797F88 *)klass->rgctx_data->_5_System_Collections_Generic_List_T___ctor);
  *(_QWORD *)&this->fields.currentIndex = v7;
  p_currentIndex = &this->fields.currentIndex;
  sub_1C32BC4((CGThumbnailListItem_o *)p_currentIndex, (int32_t)v7, v9, v10);
  *((_WORD *)p_currentIndex + 4) = 0;
}


void ActionChainBase_object___PauseNext(ActionChainBase_T__o *this, const MethodInfo_3406D7C *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    1,
    (const MethodInfo_3406DD0 *)method->klass->rgctx_data->_9_ActionChainBase_T__SetIsPausing);
}


void ActionChainBase_object___ResumeNext(ActionChainBase_T__o *this, const MethodInfo_3406D90 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    0,
  ...
  ActionChainBase_object___StartPendingNextAction(
    this,
    (const MethodInfo_3406F5C *)method->klass->rgctx_data->_10_ActionChainBase_T__StartPendingNextAction);
}


void ActionChainBase_object___SetIsPausing(ActionChainBase_T__o *this, bool value, const MethodInfo_3406DD0 *method)
{
  bool v6; // w22
  ...
  if ( (byte_4C3D4A3 & 1) == 0 )
  {
    sub_1C32C20(&Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
    sub_1C32C20(&ActionChainBase_ChainableActionBase__TypeInfo);
    byte_4C3D4A3 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    v7,
    (const MethodInfo_37992B4 *)method->klass->rgctx_data->_11_System_Collections_Generic_List_T__GetEnumerator);
  v8 = value;
  v11 = v10;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v11,
            (const MethodInfo_3522FA8 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_Enumerator_T__MoveNext) )
  {
    if ( v11.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v11.fields._current->klass->_2.typeHierarchy[naturalAligment - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___SetIsPausing(
          ...
          v8,
          (const MethodInfo_3406DD0 *)Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v11,
    (const MethodInfo_3522FA4 *)method->klass->rgctx_data->_17_System_Collections_Generic_List_T__get_Count);
}


void ActionChainBase_object___StartPendingNextAction(ActionChainBase_T__o *this, const MethodInfo_3406F5C *method)
{
  ...
  if ( (byte_4C3D4A4 & 1) == 0 )
  {
    sub_1C32C20(&Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
    sub_1C32C20(&ActionChainBase_ChainableActionBase__TypeInfo);
    byte_4C3D4A4 = 1;
  }
    ...
    if ( v7.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v7.fields._current->klass->_2.typeHierarchy[naturalAligment - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___StartPendingNextAction(
          ...
          (const MethodInfo_3406F5C *)Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
