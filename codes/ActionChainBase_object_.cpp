void __fastcall ActionChainBase_object____ctor(
        ...
        const MethodInfo_3288CB4 *method)
{
  ...
  ActionChainBase_object___AddRange(
    this,
    chains,
    (const MethodInfo_3288D68 *)method->klass->rgctx_data->_3_ActionChainBase_T__AddRange);
}
...
ActionChainBase_T__o *__fastcall ActionChainBase_object___AddRange(
        ...
        const MethodInfo_3288D68 *method)
{
  ...
  if ( (byte_4A542CE & 1) == 0 )
  {
    this = (ActionChainBase_T__o *)sub_1B863B8(&System_Action_TypeInfo, chainElems);
    byte_4A542CE = 1;
  }
  if ( !v5 )
    goto LABEL_17;
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v8 )
          break;
        v8[1].monitor = v9;
        sub_1B8635C((CGThumbnailListItem_o *)&v8[1].monitor, (int32_t)v9, v10, v11);
        ...
        if ( (unsigned int)nextAction_low >= LODWORD(endCallback->fields.m_target) )
        {
          System_Collections_Generic_List_object___AddWithResize(
            ...
            v8,
            (const MethodInfo_35FC958 *)_8_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
        }
        else
        {
...
void __fastcall ActionChainBase_object___DoNext(ActionChainBase_T__o *this, const MethodInfo_3289230 *method)
{
    ...
    *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = v4;
    ...
    else
    {
      Item = System_Collections_Generic_List_object___get_Item(
               v3,
               v4,
               (const MethodInfo_35FC688 *)method->klass->rgctx_data->_19_ActionChainBase_T__ExecuteCurrentAction);
...
void __fastcall ActionChainBase_object___ExecuteOnDetail(ActionChainBase_T__o *this, const MethodInfo_3289220 *method)
{
  ActionChainBase_object___DoNext(
    this,
    (const MethodInfo_3289230 *)method->klass->rgctx_data->_7_ActionChainBase_T__DoNext);
}


void __fastcall ActionChainBase_object___Init(ActionChainBase_T__o *this, const MethodInfo_3288D00 *method)
{
  ...
  *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = -1;
  ...
  if ( (*(_BYTE *)(_4_System_Collections_Generic_List_T + 309) & 1) == 0 )
    _4_System_Collections_Generic_List_T = sub_1BD6A48();
  v5 = (System_Collections_Generic_List_object__o *)sub_1B86604(_4_System_Collections_Generic_List_T);
  klass = method->klass;
  v7 = v5;
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_35FC124 *)klass->rgctx_data->_5_System_Collections_Generic_List_T___ctor);
  *(_QWORD *)&this->fields.currentIndex = v7;
  p_currentIndex = &this->fields.currentIndex;
  sub_1B8635C((CGThumbnailListItem_o *)p_currentIndex, (int32_t)v7, v9, v10);
  *((_WORD *)p_currentIndex + 4) = 0;
}


void __fastcall ActionChainBase_object___PauseNext(ActionChainBase_T__o *this, const MethodInfo_3288EB0 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    1,
    (const MethodInfo_3288F04 *)method->klass->rgctx_data->_9_ActionChainBase_T__SetIsPausing);
}


void __fastcall ActionChainBase_object___ResumeNext(ActionChainBase_T__o *this, const MethodInfo_3288EC4 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    0,
  ...
  ActionChainBase_object___StartPendingNextAction(
    this,
    (const MethodInfo_3289090 *)method->klass->rgctx_data->_10_ActionChainBase_T__StartPendingNextAction);
}
...
void __fastcall ActionChainBase_object___SetIsPausing(
        ActionChainBase_T__o *this,
        bool value,
        const MethodInfo_3288F04 *method)
{
  bool v6; // w22
  __int64 v7; // x1
  ...
  if ( (byte_4A542CF & 1) == 0 )
  {
    sub_1B863B8(&Method_ActionChainBase_ChainableActionBase__SetIsPausing__, value);
    sub_1B863B8(&ActionChainBase_ChainableActionBase__TypeInfo, v7);
    byte_4A542CF = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    v8,
    (const MethodInfo_35FD450 *)method->klass->rgctx_data->_11_System_Collections_Generic_List_T__GetEnumerator);
  v9 = value;
  v12 = v11;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v12,
            (const MethodInfo_3398634 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_Enumerator_T__MoveNext) )
  {
    if ( v12.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v12.fields._current->klass->_2.typeHierarchy[methodPtr_low - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___SetIsPausing(
          ...
          v9,
          (const MethodInfo_3288F04 *)Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v12,
    (const MethodInfo_3398630 *)method->klass->rgctx_data->_17_System_Collections_Generic_List_T__get_Count);
}


void __fastcall ActionChainBase_object___StartPendingNextAction(
        ActionChainBase_T__o *this,
        const MethodInfo_3289090 *method)
{
  __int64 v4; // x1
  System_Collections_Generic_List_object__o *v5; // x0
  __int64 methodPtr_low; // x10
  ...
  if ( (byte_4A542D0 & 1) == 0 )
  {
    sub_1B863B8(&Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__, method);
    sub_1B863B8(&ActionChainBase_ChainableActionBase__TypeInfo, v4);
    byte_4A542D0 = 1;
  }
    ...
    if ( v8.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v8.fields._current->klass->_2.typeHierarchy[methodPtr_low - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___StartPendingNextAction(
          ...
          (const MethodInfo_3289090 *)Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
