void __fastcall ActionChainBase_object____ctor(
        ...
        const MethodInfo_32B6278 *method)
{
  ...
  ActionChainBase_object___AddRange(
    this,
    chains,
    (const MethodInfo_32B632C *)method->klass->rgctx_data->_3_ActionChainBase_T__AddRange);
}
...
ActionChainBase_T__o *__fastcall ActionChainBase_object___AddRange(
        ...
        const MethodInfo_32B632C *method)
{
  ...
  if ( (byte_4BCDBBD & 1) == 0 )
  {
    this = (ActionChainBase_T__o *)sub_1C1ABD4(&System_Action_TypeInfo, chainElems);
    byte_4BCDBBD = 1;
  }
  if ( !v5 )
    goto LABEL_17;
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v8 )
          break;
        v8[1].monitor = v9;
        sub_1C1AB78((PartyOrganizationUtility_o *)&v8[1].monitor, (int64_t)v9, v10, v11, v12, v13, v14, v15);
        ...
        if ( (unsigned int)nextAction_low >= LODWORD(endCallback->fields.m_target) )
        {
          System_Collections_Generic_List_object___AddWithResize(
            ...
            v8,
            (const MethodInfo_363C890 *)_8_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
        }
        else
        {
          ...
          sub_1C1AB78((PartyOrganizationUtility_o *)(v25 + 4), (int64_t)v8, v16, v17, v18, v19, v20, v21);
        }
        max_length = chainElems->max_length;
...
void __fastcall ActionChainBase_object___DoNext(ActionChainBase_T__o *this, const MethodInfo_32B67F4 *method)
{
    ...
    *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = v4;
    ...
    else
    {
      Item = System_Collections_Generic_List_object___get_Item(
               v3,
               v4,
               (const MethodInfo_363C5C0 *)method->klass->rgctx_data->_19_ActionChainBase_T__ExecuteCurrentAction);
...
void __fastcall ActionChainBase_object___ExecuteOnDetail(ActionChainBase_T__o *this, const MethodInfo_32B67E4 *method)
{
  ActionChainBase_object___DoNext(
    this,
    (const MethodInfo_32B67F4 *)method->klass->rgctx_data->_7_ActionChainBase_T__DoNext);
}


void __fastcall ActionChainBase_object___Init(ActionChainBase_T__o *this, const MethodInfo_32B62C4 *method)
{
  ...
  *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = -1;
  ...
  if ( (*(_BYTE *)(_4_System_Collections_Generic_List_T + 309) & 1) == 0 )
    _4_System_Collections_Generic_List_T = sub_1C6CAB0();
  v5 = (System_Collections_Generic_List_object__o *)sub_1C1AE20(_4_System_Collections_Generic_List_T);
  klass = method->klass;
  v7 = (int64_t)v5;
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_363C05C *)klass->rgctx_data->_5_System_Collections_Generic_List_T___ctor);
  *(_QWORD *)&this->fields.currentIndex = v7;
  p_currentIndex = &this->fields.currentIndex;
  sub_1C1AB78((PartyOrganizationUtility_o *)p_currentIndex, v7, v9, v10, v11, v12, v13, v14);
  *((_WORD *)p_currentIndex + 4) = 0;
}


void __fastcall ActionChainBase_object___PauseNext(ActionChainBase_T__o *this, const MethodInfo_32B6474 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    1,
    (const MethodInfo_32B64C8 *)method->klass->rgctx_data->_9_ActionChainBase_T__SetIsPausing);
}


void __fastcall ActionChainBase_object___ResumeNext(ActionChainBase_T__o *this, const MethodInfo_32B6488 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    0,
  ...
  ActionChainBase_object___StartPendingNextAction(
    this,
    (const MethodInfo_32B6654 *)method->klass->rgctx_data->_10_ActionChainBase_T__StartPendingNextAction);
}
...
void __fastcall ActionChainBase_object___SetIsPausing(
        ActionChainBase_T__o *this,
        bool value,
        const MethodInfo_32B64C8 *method)
{
  bool v6; // w22
  __int64 v7; // x1
  ...
  if ( (byte_4BCDBBE & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ActionChainBase_ChainableActionBase__SetIsPausing__, value);
    sub_1C1ABD4(&ActionChainBase_ChainableActionBase__TypeInfo, v7);
    byte_4BCDBBE = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    v8,
    (const MethodInfo_363D388 *)method->klass->rgctx_data->_11_System_Collections_Generic_List_T__GetEnumerator);
  v9 = value;
  v12 = v11;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v12,
            (const MethodInfo_33CE4F8 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_Enumerator_T__MoveNext) )
  {
    if ( v12.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v12.fields._current->klass->_2.typeHierarchy[methodPtr_low - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___SetIsPausing(
          ...
          v9,
          (const MethodInfo_32B64C8 *)Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v12,
    (const MethodInfo_33CE4F4 *)method->klass->rgctx_data->_17_System_Collections_Generic_List_T__get_Count);
}


void __fastcall ActionChainBase_object___StartPendingNextAction(
        ActionChainBase_T__o *this,
        const MethodInfo_32B6654 *method)
{
  __int64 v4; // x1
  System_Collections_Generic_List_object__o *v5; // x0
  __int64 methodPtr_low; // x10
  ...
  if ( (byte_4BCDBBF & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__, method);
    sub_1C1ABD4(&ActionChainBase_ChainableActionBase__TypeInfo, v4);
    byte_4BCDBBF = 1;
  }
    ...
    if ( v8.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v8.fields._current->klass->_2.typeHierarchy[methodPtr_low - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___StartPendingNextAction(
          ...
          (const MethodInfo_32B6654 *)Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
