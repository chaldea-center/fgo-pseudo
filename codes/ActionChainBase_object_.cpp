void ActionChainBase_object____ctor(
        ...
        const MethodInfo_3466974 *method)
{
  ...
  ActionChainBase_object___AddRange(
    this,
    chains,
    (const MethodInfo_3466A28 *)method->klass->rgctx_data->_3_ActionChainBase_T__AddRange);
}
...
ActionChainBase_T__o *ActionChainBase_object___AddRange(
        ...
        const MethodInfo_3466A28 *method)
{
  ...
  if ( (byte_4CBBF69 & 1) == 0 )
  {
    this = (ActionChainBase_T__o *)sub_1C6BA08(&System_Action_TypeInfo);
    byte_4CBBF69 = 1;
  }
  if ( !v5 )
    goto LABEL_17;
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v8 )
          break;
        v8[1].monitor = v9;
        sub_1C6B9AC((CGThumbnailListItem_o *)&v8[1].monitor, (int32_t)v9, v10, v11);
        ...
        if ( (unsigned int)nextAction_low >= LODWORD(endCallback->fields.invoke_impl) )
        {
          System_Collections_Generic_List_object___AddWithResize(
            ...
            v8,
            (const MethodInfo_3800974 *)_8_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
        }
        else
        {
...
void ActionChainBase_object___DoNext(ActionChainBase_T__o *this, const MethodInfo_3466EF0 *method)
{
    ...
    *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = v4;
    ...
    else
    {
      Item = System_Collections_Generic_List_object___get_Item(
               v3,
               v4,
               (const MethodInfo_38006A4 *)method->klass->rgctx_data->_19_ActionChainBase_T__ExecuteCurrentAction);
...
void ActionChainBase_object___ExecuteOnDetail(ActionChainBase_T__o *this, const MethodInfo_3466EE0 *method)
{
  ActionChainBase_object___DoNext(
    this,
    (const MethodInfo_3466EF0 *)method->klass->rgctx_data->_7_ActionChainBase_T__DoNext);
}


void ActionChainBase_object___Init(ActionChainBase_T__o *this, const MethodInfo_34669C0 *method)
{
  ...
  *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = -1;
  ...
  if ( (*(_BYTE *)(_4_System_Collections_Generic_List_T + 309) & 1) == 0 )
    _4_System_Collections_Generic_List_T = sub_1C41A9C();
  v5 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(_4_System_Collections_Generic_List_T);
  klass = method->klass;
  v7 = v5;
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3800140 *)klass->rgctx_data->_5_System_Collections_Generic_List_T___ctor);
  *(_QWORD *)&this->fields.currentIndex = v7;
  p_currentIndex = &this->fields.currentIndex;
  sub_1C6B9AC((CGThumbnailListItem_o *)p_currentIndex, (int32_t)v7, v9, v10);
  *((_WORD *)p_currentIndex + 4) = 0;
}


void ActionChainBase_object___PauseNext(ActionChainBase_T__o *this, const MethodInfo_3466B70 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    1,
    (const MethodInfo_3466BC4 *)method->klass->rgctx_data->_9_ActionChainBase_T__SetIsPausing);
}


void ActionChainBase_object___ResumeNext(ActionChainBase_T__o *this, const MethodInfo_3466B84 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    0,
  ...
  ActionChainBase_object___StartPendingNextAction(
    this,
    (const MethodInfo_3466D50 *)method->klass->rgctx_data->_10_ActionChainBase_T__StartPendingNextAction);
}


// local variable allocation has failed, the output may be wrong!
void ActionChainBase_object___SetIsPausing(ActionChainBase_T__o *this, bool value, const MethodInfo_3466BC4 *method)
{
  bool v6; // w22
  ...
  if ( (byte_4CBBF6A & 1) == 0 )
  {
    sub_1C6BA08(&Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
    sub_1C6BA08(&ActionChainBase_ChainableActionBase__TypeInfo);
    byte_4CBBF6A = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    v7,
    (const MethodInfo_380146C *)method->klass->rgctx_data->_11_System_Collections_Generic_List_T__GetEnumerator);
  v8 = value;
  v11 = v10;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v11,
            (const MethodInfo_3586524 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_Enumerator_T__MoveNext) )
  {
    if ( v11.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v11.fields._current->klass->_2.typeHierarchy[naturalAligment - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___SetIsPausing(
          ...
          v8,
          (const MethodInfo_3466BC4 *)Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v11,
    (const MethodInfo_3586520 *)method->klass->rgctx_data->_17_System_Collections_Generic_List_T__get_Count);
}


void ActionChainBase_object___StartPendingNextAction(ActionChainBase_T__o *this, const MethodInfo_3466D50 *method)
{
  ...
  if ( (byte_4CBBF6B & 1) == 0 )
  {
    sub_1C6BA08(&Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
    sub_1C6BA08(&ActionChainBase_ChainableActionBase__TypeInfo);
    byte_4CBBF6B = 1;
  }
    ...
    if ( v7.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v7.fields._current->klass->_2.typeHierarchy[naturalAligment - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___StartPendingNextAction(
          ...
          (const MethodInfo_3466D50 *)Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
