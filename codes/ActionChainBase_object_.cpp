void __fastcall ActionChainBase_object____ctor(
        ...
        const MethodInfo_2620100 *method)
{
  if ( !this )
    sub_B52A5C(0LL, chains);
...
ActionChainBase_T__o *__fastcall ActionChainBase_object___AddRange(
        ...
        const MethodInfo_26201E4 *method)
{
  ...
  if ( (byte_42B91C4 & 1) == 0 )
  {
    this = (ActionChainBase_T__o *)sub_B52984(&System_Action_TypeInfo);
    byte_42B91C4 = 1;
  }
  if ( !v5 )
    goto LABEL_13;
...
void __fastcall ActionChainBase_object___DoNext(ActionChainBase_T__o *this, const MethodInfo_26207D8 *method)
{
  int v3; // w8
  __int64 v4; // x0
  __int64 v6; // x1
...
void __fastcall ActionChainBase_object___ExecuteOnDetail(ActionChainBase_T__o *this, const MethodInfo_26207B4 *method)
{
  if ( !this )
...
void __fastcall ActionChainBase_object___Init(ActionChainBase_T__o *this, const MethodInfo_2620164 *method)
{
  ...
  *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = -1;
  ...
  if ( (BYTE2(_2_System_Collections_Generic_List_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(method->klass->rgctx_data->_2_System_Collections_Generic_List_T_);
  v5 = sub_B52A54(_2_System_Collections_Generic_List_T);
  klass = method->klass;
  ...
  *(_QWORD *)&this->fields.currentIndex = v7;
  ...
  sub_B52920((BattleServantConfConponent_o *)p_currentIndex, v7, v9, v10, v11, v12, v13, v14);
  *((_WORD *)p_currentIndex + 4) = 0;
}


void __fastcall ActionChainBase_object___PauseNext(ActionChainBase_T__o *this, const MethodInfo_26202F4 *method)
{
  if ( !this )
    sub_B52A5C(0LL, method);
...
void __fastcall ActionChainBase_object___ResumeNext(ActionChainBase_T__o *this, const MethodInfo_262031C *method)
{
  if ( !this )
    sub_B52A5C(0LL, method);
...
void __fastcall ActionChainBase_object___SetIsPausing(
        ActionChainBase_T__o *this,
        bool value,
        const MethodInfo_2620370 *method)
{
  __int64 v6; // x0
  __int64 v7; // x3
  ...
  if ( (byte_42B91C5 & 1) == 0 )
  {
    sub_B52984(&Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
    sub_B52984(&ActionChainBase_ChainableActionBase__TypeInfo);
  ...
  while ( System_Collections_Generic_List_Enumerator_BattleLogicBuff_ReduceHpProcess_BuffInfo___MoveNext(
            &v16,
            (const MethodInfo_201195C *)method->klass->rgctx_data->_11_System_Collections_Generic_List_Enumerator_T__MoveNext) )
  {
    current = v16.fields.current;
    if ( sub_B52A44(v16.fields.current, ActionChainBase_ChainableActionBase__TypeInfo) )
    {
      if ( !sub_B52A44(current, ActionChainBase_ChainableActionBase__TypeInfo) )
        sub_B52A5C(0LL, v9);
      v10 = (ActionChainBase_T__o *)sub_B52A44(current, ActionChainBase_ChainableActionBase__TypeInfo);
      ActionChainBase_object___SetIsPausing(
        v10,
        value,
        (const MethodInfo_2620370 *)Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
    }
  }
  v17 = 0x100000054LL;
  ...
  if ( (BYTE2(_12_System_Collections_Generic_List_Enumerator_T->vtable[0].methodPtr) & 1) == 0 )
    sub_AEB684(_12_System_Collections_Generic_List_Enumerator_T);
  ...
  {
LABEL_15:
    p_method = sub_AEB880(&v15, System_IDisposable_TypeInfo, 0LL, v7);
  }
...
void __fastcall ActionChainBase_object___StartPendingNextAction(
        ActionChainBase_T__o *this,
        const MethodInfo_262058C *method)
{
  __int64 v4; // x3
  ...
  if ( (byte_42B91C6 & 1) == 0 )
  {
    sub_B52984(&Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
    sub_B52984(&ActionChainBase_ChainableActionBase__TypeInfo);
    sub_B52984(&System_IDisposable_TypeInfo);
    byte_42B91C6 = 1;
  }
            ...
            (const MethodInfo_201195C *)method->klass->rgctx_data->_11_System_Collections_Generic_List_Enumerator_T__MoveNext) )
  {
    ...
    if ( sub_B52A44(v14.fields.current, ActionChainBase_ChainableActionBase__TypeInfo) )
    {
      if ( !sub_B52A44(current, ActionChainBase_ChainableActionBase__TypeInfo) )
        sub_B52A5C(0LL, v6);
      v7 = (ActionChainBase_T__o *)sub_B52A44(current, ActionChainBase_ChainableActionBase__TypeInfo);
      ActionChainBase_object___StartPendingNextAction(
        v7,
        (const MethodInfo_262058C *)Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
    }
  }
  v13 = 0x100000061LL;
  _12_System_Collections_Generic_List_Enumerator_T = method->klass->rgctx_data->_12_System_Collections_Generic_List_Enumerator_T_;
  ...
  {
LABEL_17:
    p_method = sub_AEB880(&v12, System_IDisposable_TypeInfo, 0LL, v4);
  }
