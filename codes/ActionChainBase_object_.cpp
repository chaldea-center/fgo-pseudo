void __fastcall ActionChainBase_object____ctor(
        ...
        const MethodInfo_3145B1C *method)
{
  ...
  ActionChainBase_object___AddRange(
    this,
    chains,
    (const MethodInfo_3145BD0 *)method->klass->rgctx_data->_3_ActionChainBase_T__AddRange);
}
...
ActionChainBase_T__o *__fastcall ActionChainBase_object___AddRange(
        ...
        const MethodInfo_3145BD0 *method)
{
  ...
  if ( (byte_4A04A5A & 1) == 0 )
  {
    this = (ActionChainBase_T__o *)sub_1B64A00(&System_Action_TypeInfo, chainElems);
    byte_4A04A5A = 1;
  }
  if ( !v5 )
    goto LABEL_17;
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v8 )
          break;
        v8[1].monitor = v9;
        sub_1B649A4((ServantStatusBattleListViewItem_o *)&v8[1].monitor, (int32_t)v9, v10, v11);
        ...
        if ( (unsigned int)nextAction_low >= LODWORD(endCallback->fields.m_target) )
        {
          System_Collections_Generic_List_object___AddWithResize(
            ...
            v8,
            (const MethodInfo_34AFFC8 *)_8_System_Collections_Generic_List_T__Add->klass->rgctx_data[14].rgctxDataDummy);
        }
        else
        {
...
void __fastcall ActionChainBase_object___DoNext(ActionChainBase_T__o *this, const MethodInfo_3146098 *method)
{
    ...
    *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = v4;
    ...
    else
    {
      Item = System_Collections_Generic_List_object___get_Item(
               v3,
               v4,
               (const MethodInfo_34AFCF8 *)method->klass->rgctx_data->_19_ActionChainBase_T__ExecuteCurrentAction);
...
void __fastcall ActionChainBase_object___ExecuteOnDetail(ActionChainBase_T__o *this, const MethodInfo_3146088 *method)
{
  ActionChainBase_object___DoNext(
    this,
    (const MethodInfo_3146098 *)method->klass->rgctx_data->_7_ActionChainBase_T__DoNext);
}


void __fastcall ActionChainBase_object___Init(ActionChainBase_T__o *this, const MethodInfo_3145B68 *method)
{
  ...
  *((_DWORD *)&this->fields._IsExecuted_k__BackingField + 1) = -1;
  ...
  if ( (BYTE5(_4_System_Collections_Generic_List_T->vtable[0].methodPtr) & 1) == 0 )
    _4_System_Collections_Generic_List_T = (Il2CppClass *)sub_1BB68DC(_4_System_Collections_Generic_List_T);
  v5 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(_4_System_Collections_Generic_List_T);
  klass = method->klass;
  v7 = v5;
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_34AF794 *)klass->rgctx_data->_5_System_Collections_Generic_List_T___ctor);
  *(_QWORD *)&this->fields.currentIndex = v7;
  p_currentIndex = &this->fields.currentIndex;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)p_currentIndex, (int32_t)v7, v9, v10);
  *((_WORD *)p_currentIndex + 4) = 0;
}


void __fastcall ActionChainBase_object___PauseNext(ActionChainBase_T__o *this, const MethodInfo_3145D18 *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    1,
    (const MethodInfo_3145D6C *)method->klass->rgctx_data->_9_ActionChainBase_T__SetIsPausing);
}


void __fastcall ActionChainBase_object___ResumeNext(ActionChainBase_T__o *this, const MethodInfo_3145D2C *method)
{
  ActionChainBase_object___SetIsPausing(
    this,
    0,
  ...
  ActionChainBase_object___StartPendingNextAction(
    this,
    (const MethodInfo_3145EF8 *)method->klass->rgctx_data->_10_ActionChainBase_T__StartPendingNextAction);
}
...
void __fastcall ActionChainBase_object___SetIsPausing(
        ActionChainBase_T__o *this,
        bool value,
        const MethodInfo_3145D6C *method)
{
  bool v6; // w22
  __int64 v7; // x1
  ...
  if ( (byte_4A04A5B & 1) == 0 )
  {
    sub_1B64A00(&Method_ActionChainBase_ChainableActionBase__SetIsPausing__, value);
    sub_1B64A00(&ActionChainBase_ChainableActionBase__TypeInfo, v7);
    byte_4A04A5B = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    v8,
    (const MethodInfo_34B0B60 *)method->klass->rgctx_data->_11_System_Collections_Generic_List_T__GetEnumerator);
  v9 = value;
  v12 = v11;
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v12,
            (const MethodInfo_322C9A4 *)method->klass->rgctx_data->_15_System_Collections_Generic_List_Enumerator_T__MoveNext) )
  {
    if ( v12.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v12.fields._current->klass->_2.typeHierarchy[methodPtr_low - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___SetIsPausing(
          ...
          v9,
          (const MethodInfo_3145D6C *)Method_ActionChainBase_ChainableActionBase__SetIsPausing__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v12,
    (const MethodInfo_322C9A0 *)method->klass->rgctx_data->_17_System_Collections_Generic_List_T__get_Count);
}


void __fastcall ActionChainBase_object___StartPendingNextAction(
        ActionChainBase_T__o *this,
        const MethodInfo_3145EF8 *method)
{
  __int64 v4; // x1
  System_Collections_Generic_List_object__o *v5; // x0
  __int64 methodPtr_low; // x10
  ...
  if ( (byte_4A04A5C & 1) == 0 )
  {
    sub_1B64A00(&Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__, method);
    sub_1B64A00(&ActionChainBase_ChainableActionBase__TypeInfo, v4);
    byte_4A04A5C = 1;
  }
    ...
    if ( v8.fields._current )
    {
        ...
        && (ActionChainBase_ChainableActionBase__c *)v8.fields._current->klass->_2.typeHierarchy[methodPtr_low - 1] == ActionChainBase_ChainableActionBase__TypeInfo )
      {
        ActionChainBase_object___StartPendingNextAction(
          ...
          (const MethodInfo_3145EF8 *)Method_ActionChainBase_ChainableActionBase__StartPendingNextAction__);
      }
    }
  }
  System_Collections_Generic_List_Enumerator_object___Dispose(
