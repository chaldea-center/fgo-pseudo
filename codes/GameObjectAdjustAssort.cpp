...
void GameObjectAdjustAssort__Apply(GameObjectAdjustAssort_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4C56326 & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Linq_Enumerable_Where_GameObjectAdjustAssort_AdjustParam___);
    sub_1C3E564(&System_Func_GameObjectAdjustAssort_AdjustParam__bool__TypeInfo);
    sub_1C3E564(&System_IDisposable_TypeInfo);
    sub_1C3E564(&System_Collections_Generic_IEnumerable_GameObjectAdjustAssort_AdjustParam__TypeInfo);
    sub_1C3E564(&System_Collections_Generic_IEnumerator_GameObjectAdjustAssort_AdjustParam__TypeInfo);
    sub_1C3E564(&System_Collections_IEnumerator_TypeInfo);
    sub_1C3E564(&Method_GameObjectAdjustAssort___c__Apply_b__2_0__);
    sub_1C3E564(&GameObjectAdjustAssort___c_TypeInfo);
    byte_4C56326 = 1;
  }
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_object__bool__o *)sub_1C3E7B0(System_Func_GameObjectAdjustAssort_AdjustParam__bool__TypeInfo);
  ...
  v12 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_3140304 *)Method_System_Linq_Enumerable_Where_GameObjectAdjustAssort_AdjustParam___);
  if ( !v12 )
    sub_1C3E7C0(0, v13);
  klass = v12->klass;
  v15 = v12;
  ...
  {
LABEL_14:
    v18 = sub_1C8ED7C(v12, System_Collections_Generic_IEnumerable_GameObjectAdjustAssort_AdjustParam__TypeInfo, 0);
  }
...
LABEL_21:
    ...
    {
LABEL_28:
      v28 = sub_1C8ED7C(v20, System_Collections_Generic_IEnumerator_GameObjectAdjustAssort_AdjustParam__TypeInfo, 0);
    }
  ...
  {
LABEL_35:
    v34 = sub_1C8ED7C(v20, System_IDisposable_TypeInfo, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56327 & 1) == 0 )
  {
    this = (GameObjectAdjustAssort_o *)sub_1C3E564(&Method_BasicHelper_IsValidIndex_Vector3___);
    byte_4C56327 = 1;
  }
  if ( !adjustParam )
    goto LABEL_9;
  this = (GameObjectAdjustAssort_o *)BasicHelper__IsValidIndex_Vector3_(
                                       ...
                                       index,
                                       (const MethodInfo_30E83E0 *)Method_BasicHelper_IsValidIndex_Vector3___);
  if ( ((unsigned __int8)this & 1) == 0 )
    return;
  localPosArray = adjustParam->fields.localPosArray;
  if ( !localPosArray )
LABEL_9:
    sub_1C3E7C0(this, adjustParam);
  if ( LODWORD(localPosArray->max_length) <= index )
    sub_1C3E7C8(this, adjustParam);
...
void GameObjectAdjustAssort___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(GameObjectAdjustAssort___c_TypeInfo);
  System_Object___ctor(v1, 0);
  GameObjectAdjustAssort___c_TypeInfo->static_fields->__9 = (struct GameObjectAdjustAssort___c_o *)v1;
  sub_1C3E508((CGThumbnailListItem_o *)GameObjectAdjustAssort___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56329 & 1) == 0 )
  {
    this = (GameObjectAdjustAssort___c_o *)sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C56329 = 1;
  }
  if ( !x )
    sub_1C3E7C0(this, x);
