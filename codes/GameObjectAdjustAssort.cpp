...
void __fastcall GameObjectAdjustAssort__Apply(GameObjectAdjustAssort_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4A5A73C & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Linq_Enumerable_Where_GameObjectAdjustAssort_AdjustParam___);
    sub_1B885B0(&System_Func_GameObjectAdjustAssort_AdjustParam__bool__TypeInfo);
    sub_1B885B0(&System_IDisposable_TypeInfo);
    sub_1B885B0(&System_Collections_Generic_IEnumerable_GameObjectAdjustAssort_AdjustParam__TypeInfo);
    sub_1B885B0(&System_Collections_Generic_IEnumerator_GameObjectAdjustAssort_AdjustParam__TypeInfo);
    sub_1B885B0(&System_Collections_IEnumerator_TypeInfo);
    sub_1B885B0(&Method_GameObjectAdjustAssort___c__Apply_b__2_0__);
    sub_1B885B0(&GameObjectAdjustAssort___c_TypeInfo);
    byte_4A5A73C = 1;
  }
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_object__bool__o *)sub_1B887FC(System_Func_GameObjectAdjustAssort_AdjustParam__bool__TypeInfo);
  ...
  v12 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_2EBE07C *)Method_System_Linq_Enumerable_Where_GameObjectAdjustAssort_AdjustParam___);
  if ( !v12 )
    sub_1B8880C(0LL, v13);
  klass = v12->klass;
  v15 = v12;
...
LABEL_21:
    ...
    {
LABEL_28:
      v28 = sub_1BDA590(v20, System_Collections_Generic_IEnumerator_GameObjectAdjustAssort_AdjustParam__TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A73D & 1) == 0 )
  {
    this = (GameObjectAdjustAssort_o *)sub_1B885B0(&Method_BasicHelper_IsValidIndex_Vector3___);
    byte_4A5A73D = 1;
  }
  if ( !adjustParam )
    goto LABEL_9;
  this = (GameObjectAdjustAssort_o *)BasicHelper__IsValidIndex_Vector3_(
                                       ...
                                       index,
                                       (const MethodInfo_2E6EB24 *)Method_BasicHelper_IsValidIndex_Vector3___);
  if ( ((unsigned __int8)this & 1) == 0 )
    return;
  localPosArray = adjustParam->fields.localPosArray;
  if ( !localPosArray )
LABEL_9:
    sub_1B8880C(this, adjustParam);
  if ( localPosArray->max_length <= index )
    sub_1B88814(this, adjustParam);
...
void __fastcall GameObjectAdjustAssort___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(GameObjectAdjustAssort___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A73F & 1) == 0 )
  {
    this = (GameObjectAdjustAssort___c_o *)sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A5A73F = 1;
  }
  if ( !x )
    sub_1B8880C(this, x);
