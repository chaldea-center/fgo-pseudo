...
void __fastcall GameObjectAdjustAssort__Apply(GameObjectAdjustAssort_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4B6615B & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Linq_Enumerable_Where_GameObjectAdjustAssort_AdjustParam___, *(_QWORD *)&index);
    sub_1BE4ACC(&System_Func_GameObjectAdjustAssort_AdjustParam__bool__TypeInfo, v5);
    sub_1BE4ACC(&System_IDisposable_TypeInfo, v6);
    sub_1BE4ACC(&System_Collections_Generic_IEnumerable_GameObjectAdjustAssort_AdjustParam__TypeInfo, v7);
    sub_1BE4ACC(&System_Collections_Generic_IEnumerator_GameObjectAdjustAssort_AdjustParam__TypeInfo, v8);
    sub_1BE4ACC(&System_Collections_IEnumerator_TypeInfo, v9);
    sub_1BE4ACC(&Method_GameObjectAdjustAssort___c__Apply_b__2_0__, v10);
    sub_1BE4ACC(&GameObjectAdjustAssort___c_TypeInfo, v11);
    byte_4B6615B = 1;
  }
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_object__bool__o *)sub_1BE4D18(System_Func_GameObjectAdjustAssort_AdjustParam__bool__TypeInfo);
  ...
  v23 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_2F98960 *)Method_System_Linq_Enumerable_Where_GameObjectAdjustAssort_AdjustParam___);
  if ( !v23 )
    sub_1BE4D28(0LL, v24);
  klass = v23->klass;
  v26 = v23;
...
LABEL_21:
    ...
    {
LABEL_28:
      v39 = sub_1C36AAC(v31, System_Collections_Generic_IEnumerator_GameObjectAdjustAssort_AdjustParam__TypeInfo, 0LL);
    }
  ...
  {
LABEL_35:
    v45 = sub_1C36AAC(v31, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6615C & 1) == 0 )
  {
    this = (GameObjectAdjustAssort_o *)sub_1BE4ACC(&Method_BasicHelper_IsValidIndex_Vector3___, adjustParam);
    byte_4B6615C = 1;
  }
  if ( !adjustParam )
    goto LABEL_9;
  this = (GameObjectAdjustAssort_o *)BasicHelper__IsValidIndex_Vector3_(
                                       ...
                                       index,
                                       (const MethodInfo_2F480A8 *)Method_BasicHelper_IsValidIndex_Vector3___);
  if ( ((unsigned __int8)this & 1) == 0 )
    return;
  localPosArray = adjustParam->fields.localPosArray;
  if ( !localPosArray )
LABEL_9:
    sub_1BE4D28(this, adjustParam);
  if ( localPosArray->max_length <= index )
    sub_1BE4D30(this, adjustParam);
...
void __fastcall GameObjectAdjustAssort___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6615D & 1) == 0 )
  {
    sub_1BE4ACC(&GameObjectAdjustAssort___c_TypeInfo, v1);
    byte_4B6615D = 1;
  }
  v2 = (Il2CppObject *)sub_1BE4D18(GameObjectAdjustAssort___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6615E & 1) == 0 )
  {
    this = (GameObjectAdjustAssort___c_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, x);
    byte_4B6615E = 1;
  }
  if ( !x )
    sub_1BE4D28(this, x);
