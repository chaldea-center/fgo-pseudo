void __fastcall SetVolumeControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4218A96 & 1) == 0 )
  {
    sub_B0D8A4(&SetVolumeControl_TypeInfo, v1);
    byte_4218A96 = 1;
  }
  v20.fields.r = 1.0;
  v20.fields.g = 1.0;
...
void __fastcall SetVolumeControl__getChangeVoiceValue(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4218A91 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_22721/*"testVoice"*/, v4);
    byte_4218A91 = 1;
  }
  ...
  *(float *)&this[1].klass = UIProgressBar__get_value((UIProgressBar_o *)voiceValueTxt, 0LL);
  ...
  if ( !BYTE4(this[1].klass) )
  {
    ...
    if ( v7 != v8 )
    {
      ...
      SoundManager__playVoice((System_String_o *)StringLiteral_22721/*"testVoice"*/, 0LL);
    }
  }
}
...
void __fastcall SetVolumeControl__initSetVolume(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4218A8B & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_9848/*"OPTION_VOLUME_MUTE_INFO"*/, v4);
    sub_B0D8A4(&StringLiteral_9845/*"OPTION_VOICE"*/, v5);
    sub_B0D8A4(&StringLiteral_9847/*"OPTION_VOLUME_MUTE_EXPLANATION"*/, v6);
    sub_B0D8A4(&StringLiteral_9833/*"OPTION_SE"*/, v7);
    sub_B0D8A4(&StringLiteral_9803/*"OPTION_BGM"*/, v8);
    sub_B0D8A4(&StringLiteral_9846/*"OPTION_VOLUME_MUTE"*/, v9);
    byte_4218A8B = 1;
  }
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9833/*"OPTION_SE"*/, 0LL);
  if ( !seSilder )
    goto LABEL_19;
  UILabel__set_text(seSilder, v11, 0LL);
  voiceSilder = (UILabel_o *)this->fields.voiceSilder;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9845/*"OPTION_VOICE"*/, 0LL);
  if ( !voiceSilder )
    goto LABEL_19;
  UILabel__set_text(voiceSilder, v11, 0LL);
  muteBtnInfoTxt = this->fields.muteBtnInfoTxt;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9846/*"OPTION_VOLUME_MUTE"*/, 0LL);
  if ( !muteBtnInfoTxt )
    goto LABEL_19;
  UILabel__set_text(muteBtnInfoTxt, v11, 0LL);
  muteMaskExpTxt = this->fields.muteMaskExpTxt;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9848/*"OPTION_VOLUME_MUTE_INFO"*/, 0LL);
  if ( !muteMaskExpTxt )
    goto LABEL_19;
  UILabel__set_text(muteMaskExpTxt, v11, 0LL);
  v16 = *(UILabel_o **)&this->fields.bgmValue;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9847/*"OPTION_VOLUME_MUTE_EXPLANATION"*/, 0LL);
  if ( !v16 )
    goto LABEL_19;
  UILabel__set_text(v16, v11, 0LL);
  if ( (BYTE3(OptionManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !OptionManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
...
LABEL_19:
  ...
  UIProgressBar__set_value((UIProgressBar_o *)voiceValueTxt, v23, 0LL);
...
void __fastcall SetVolumeControl__muteSetting(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B0D8A4(&OptionManager_TypeInfo, method);
    sub_B0D8A4(&SetVolumeControl_TypeInfo, v3);
    sub_B0D8A4(&StringLiteral_17057/*"btn_on"*/, v4);
    sub_B0D8A4(&StringLiteral_17056/*"btn_off"*/, v5);
    byte_4218A95 = 1;
  }
  ...
  if ( BYTE4(this[1].klass) )
  {
    UIButton__set_normalSprite((UIButton_o *)muteMask, (System_String_o *)StringLiteral_17057/*"btn_on"*/, 0LL);
...
LABEL_34:
  ...
  UIButton__set_normalSprite((UIButton_o *)muteMask, (System_String_o *)StringLiteral_17056/*"btn_off"*/, 0LL);
  muteMask = this->fields.muteBtnTxt;
  if ( !muteMask )
    goto LABEL_34;
...
void __fastcall SetVolumeControl__setDefaultVolume(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  *(float *)&this->fields.muteFlag = v9;
  if ( !seValueTxt )
    goto LABEL_33;
  UIProgressBar__set_value((UIProgressBar_o *)seValueTxt, v9, 0LL);
  voiceValueTxt = this->fields.voiceValueTxt;
  if ( !byte_4218B0C )
  {
  ...
  *(float *)&this[1].klass = v12;
  if ( !voiceValueTxt )
LABEL_33:
    sub_B0D97C(v4);
  UIProgressBar__set_value((UIProgressBar_o *)voiceValueTxt, v12, 0LL);
