void SetVolumeControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E725BA & 1) == 0 )
  {
    sub_1D0F0B4(&SetVolumeControl_TypeInfo);
    byte_4E725BA = 1;
  }
  __asm { FMOV            V0.4S, #1.0 }
  SetVolumeControl_TypeInfo->static_fields->NORMAL_TEXT_COLOR = _Q0;
  v6 = SetVolumeControl_TypeInfo;
  SetVolumeControl_TypeInfo->static_fields->DARK_TEXT_COLOR = (struct UnityEngine_Color_o)xmmword_D34FA0;
  v6->static_fields->NORMAL_VALUE_COLOR = (struct UnityEngine_Color_o)xmmword_D35D30;
  v6->static_fields->DARK_VALUE_COLOR = (struct UnityEngine_Color_o)xmmword_D35D40;
}
...
void SetVolumeControl__OnClickMuteButton(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E725B8 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SetVolumeControl_OnClickMuteButton__);
    byte_4E725B8 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetVolumeControl_OnClickMuteButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_SetVolumeControl_OnClickMuteButton__);
...
void SetVolumeControl__getChangeSeValue(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&OptionManager_TypeInfo);
    sub_1D0F0B4(&Method_SetVolumeControl_getChangeSeValue__);
    byte_4E725B3 = 1;
  }
  ...
  if ( !this->fields.muteFlag )
  {
    ...
    if ( seValue != v6 )
    {
      ...
      if ( (*((_BYTE *)Method_SetVolumeControl_getChangeSeValue__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1D0F0CC(Method_SetVolumeControl_getChangeSeValue__);
...
void SetVolumeControl__getChangeVoiceValue(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E725B5 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_24530/*"testVoice"*/);
    byte_4E725B5 = 1;
  }
  ...
  {
    sub_1D0F30C(voiceSilder, method);
  }
  ...
  if ( !this->fields.muteFlag )
  {
    ...
    if ( voiceValue != v6 )
    {
      ...
      SoundManager__playVoice((System_String_o *)StringLiteral_24530/*"testVoice"*/, 0, 0);
    }
  }
}
...
void SetVolumeControl__initSetVolume(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E725AF & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&OptionManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_9838/*"OPTION_VOLUME_MUTE_INFO"*/);
    sub_1D0F0B4(&StringLiteral_9835/*"OPTION_VOICE"*/);
    sub_1D0F0B4(&StringLiteral_9837/*"OPTION_VOLUME_MUTE_EXPLANATION"*/);
    sub_1D0F0B4(&StringLiteral_9823/*"OPTION_SE"*/);
    sub_1D0F0B4(&StringLiteral_9779/*"OPTION_BGM"*/);
    sub_1D0F0B4(&StringLiteral_9836/*"OPTION_VOLUME_MUTE"*/);
    byte_4E725AF = 1;
  }
  bgmTxt = this->fields.bgmTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9779/*"OPTION_BGM"*/, 0);
  if ( !bgmTxt )
    goto LABEL_17;
  UILabel__set_text(bgmTxt, v4, 0);
  seTxt = this->fields.seTxt;
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9823/*"OPTION_SE"*/, 0);
  if ( !seTxt )
    goto LABEL_17;
  UILabel__set_text(seTxt, v4, 0);
  voiceTxt = this->fields.voiceTxt;
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9835/*"OPTION_VOICE"*/, 0);
  if ( !voiceTxt )
    goto LABEL_17;
  UILabel__set_text(voiceTxt, v4, 0);
  muteBtnTxt = this->fields.muteBtnTxt;
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9836/*"OPTION_VOLUME_MUTE"*/, 0);
  if ( !muteBtnTxt )
    goto LABEL_17;
  UILabel__set_text(muteBtnTxt, v4, 0);
  muteBtnInfoTxt = this->fields.muteBtnInfoTxt;
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9838/*"OPTION_VOLUME_MUTE_INFO"*/, 0);
  if ( !muteBtnInfoTxt )
    goto LABEL_17;
  UILabel__set_text(muteBtnInfoTxt, v4, 0);
  muteMaskExpTxt = this->fields.muteMaskExpTxt;
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9837/*"OPTION_VOLUME_MUTE_EXPLANATION"*/, 0);
  if ( !muteMaskExpTxt )
    goto LABEL_17;
...
void SetVolumeControl__muteSetting(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.muteFlag )
  {
    UIButton__set_normalSprite((UIButton_o *)muteBtn, (System_String_o *)StringLiteral_17768/*"btn_on"*/, 0);
...
LABEL_30:
    sub_1D0F30C(muteBtn, method);
  }
  UIButton__set_normalSprite((UIButton_o *)muteBtn, (System_String_o *)StringLiteral_17767/*"btn_off"*/, 0);
  muteBtn = this->fields.muteMask;
  if ( !muteBtn )
    goto LABEL_30;
...
void SetVolumeControl__setDefaultVolume(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&OptionManager_TypeInfo);
    sub_1D0F0B4(&Method_SetVolumeControl_setDefaultVolume__);
    byte_4E725B7 = 1;
  }
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
...
LABEL_27:
  ...
  if ( (*((_BYTE *)Method_SetVolumeControl_setDefaultVolume__ + 83) & 2) != 0 )
    v11 = (_QWORD *)sub_1D0F0CC(Method_SetVolumeControl_setDefaultVolume__);
