void __fastcall SetVolumeControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0E9 & 1) == 0 )
  {
    sub_1B715CC(&SetVolumeControl_TypeInfo, v1);
    byte_4A1B0E9 = 1;
  }
  __asm { FMOV            V0.4S, #1.0 }
  SetVolumeControl_TypeInfo->static_fields->NORMAL_TEXT_COLOR = _Q0;
  v7 = SetVolumeControl_TypeInfo;
  SetVolumeControl_TypeInfo->static_fields->DARK_TEXT_COLOR = (struct UnityEngine_Color_o)xmmword_BAA5D0;
  v7->static_fields->NORMAL_VALUE_COLOR = (struct UnityEngine_Color_o)xmmword_BAB280;
  v7->static_fields->DARK_VALUE_COLOR = (struct UnityEngine_Color_o)xmmword_BAB290;
}
...
void __fastcall SetVolumeControl__OnClickMuteButton(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0E7 & 1) == 0 )
  {
    sub_1B715CC(&Method_SetVolumeControl_OnClickMuteButton__, method);
    byte_4A1B0E7 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetVolumeControl_OnClickMuteButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B715E4(Method_SetVolumeControl_OnClickMuteButton__);
...
void __fastcall SetVolumeControl__getChangeSeValue(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&OptionManager_TypeInfo, method);
    sub_1B715CC(&Method_SetVolumeControl_getChangeSeValue__, v3);
    byte_4A1B0E2 = 1;
  }
  ...
  if ( !this->fields.muteFlag )
  {
    ...
    if ( seValue != v7 )
    {
      ...
      if ( (*((_BYTE *)Method_SetVolumeControl_getChangeSeValue__ + 83) & 2) != 0 )
        v10 = (_QWORD *)sub_1B715E4(Method_SetVolumeControl_getChangeSeValue__);
...
void __fastcall SetVolumeControl__getChangeVoiceValue(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0E4 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_23832/*"testVoice"*/, v4);
    byte_4A1B0E4 = 1;
  }
  ...
  {
    sub_1B71828(voiceSilder, method);
  }
  ...
  if ( !this->fields.muteFlag )
  {
    ...
    if ( voiceValue != v8 )
    {
      ...
      SoundManager__playVoice((System_String_o *)StringLiteral_23832/*"testVoice"*/, 0LL);
    }
  }
}
...
void __fastcall SetVolumeControl__initSetVolume(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0DE & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9681/*"OPTION_VOLUME_MUTE_INFO"*/, v4);
    sub_1B715CC(&StringLiteral_9678/*"OPTION_VOICE"*/, v5);
    sub_1B715CC(&StringLiteral_9680/*"OPTION_VOLUME_MUTE_EXPLANATION"*/, v6);
    sub_1B715CC(&StringLiteral_9666/*"OPTION_SE"*/, v7);
    sub_1B715CC(&StringLiteral_9622/*"OPTION_BGM"*/, v8);
    sub_1B715CC(&StringLiteral_9679/*"OPTION_VOLUME_MUTE"*/, v9);
    byte_4A1B0DE = 1;
  }
  bgmTxt = this->fields.bgmTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9622/*"OPTION_BGM"*/, 0LL);
  if ( !bgmTxt )
    goto LABEL_17;
  UILabel__set_text(bgmTxt, v11, 0LL);
  seTxt = this->fields.seTxt;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9666/*"OPTION_SE"*/, 0LL);
  if ( !seTxt )
    goto LABEL_17;
  UILabel__set_text(seTxt, v11, 0LL);
  voiceTxt = this->fields.voiceTxt;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9678/*"OPTION_VOICE"*/, 0LL);
  if ( !voiceTxt )
    goto LABEL_17;
  UILabel__set_text(voiceTxt, v11, 0LL);
  muteBtnTxt = this->fields.muteBtnTxt;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9679/*"OPTION_VOLUME_MUTE"*/, 0LL);
  if ( !muteBtnTxt )
    goto LABEL_17;
  UILabel__set_text(muteBtnTxt, v11, 0LL);
  muteBtnInfoTxt = this->fields.muteBtnInfoTxt;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9681/*"OPTION_VOLUME_MUTE_INFO"*/, 0LL);
  if ( !muteBtnInfoTxt )
    goto LABEL_17;
  UILabel__set_text(muteBtnInfoTxt, v11, 0LL);
  muteMaskExpTxt = this->fields.muteMaskExpTxt;
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9680/*"OPTION_VOLUME_MUTE_EXPLANATION"*/, 0LL);
  if ( !muteMaskExpTxt )
    goto LABEL_17;
...
void __fastcall SetVolumeControl__muteSetting(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&OptionManager_TypeInfo, method);
    sub_1B715CC(&SetVolumeControl_TypeInfo, v3);
    sub_1B715CC(&StringLiteral_17476/*"btn_on"*/, v4);
    sub_1B715CC(&StringLiteral_17475/*"btn_off"*/, v5);
    byte_4A1B0E8 = 1;
  }
  ...
  if ( this->fields.muteFlag )
  {
    UIButton__set_normalSprite((UIButton_o *)muteBtn, (System_String_o *)StringLiteral_17476/*"btn_on"*/, 0LL);
...
LABEL_30:
    sub_1B71828(muteBtn, method);
  }
  UIButton__set_normalSprite((UIButton_o *)muteBtn, (System_String_o *)StringLiteral_17475/*"btn_off"*/, 0LL);
  muteBtn = this->fields.muteMask;
  if ( !muteBtn )
    goto LABEL_30;
...
void __fastcall SetVolumeControl__setDefaultVolume(SetVolumeControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&OptionManager_TypeInfo, method);
    sub_1B715CC(&Method_SetVolumeControl_setDefaultVolume__, v3);
    byte_4A1B0E6 = 1;
  }
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
...
LABEL_27:
  ...
  if ( (*((_BYTE *)Method_SetVolumeControl_setDefaultVolume__ + 83) & 2) != 0 )
    v12 = (_QWORD *)sub_1B715E4(Method_SetVolumeControl_setDefaultVolume__);
