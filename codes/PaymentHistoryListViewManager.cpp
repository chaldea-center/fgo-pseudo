        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8810 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataManager_GetMaster_PaymentHistoryMaster___);
    sub_1C21E38(&DataManager_TypeInfo);
    sub_1C21E38(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__Dispose__);
    sub_1C21E38(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__MoveNext__);
    sub_1C21E38(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__get_Current__);
    sub_1C21E38(&Method_System_Collections_Generic_List_ListViewItem__Add__);
    sub_1C21E38(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&PaymentHistoryListViewItem_TypeInfo);
    sub_1C21E38(&StringLiteral_10563/*"PAYMENT_HISTORY_TEMPLATE_UPSIDE"*/);
    sub_1C21E38(&StringLiteral_10561/*"PAYMENT_HISTORY_SP_TEMPLATE"*/);
    sub_1C21E38(&StringLiteral_10562/*"PAYMENT_HISTORY_TEMPLATE"*/);
  ...
  Master_object = (PaymentHistoryMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_PaymentHistoryMaster___);
  if ( Master_object )
  {
    ...
    while ( 1 )
    {
      v5 = System_Collections_Generic_List_Enumerator_object___MoveNext(
             &v37,
             (const MethodInfo_33E129C *)Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__MoveNext__);
      if ( !v5 )
        break;
      ...
      if ( LOBYTE(v37.fields._current[1].monitor) )
      {
        if ( !cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10561/*"PAYMENT_HISTORY_SP_TEMPLATE"*/, 0LL);
      }
      else
      {
        if ( !cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10562/*"PAYMENT_HISTORY_TEMPLATE"*/, 0LL);
      }
      v10 = v9;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v11 = LocalizationManager__Get((System_String_o *)StringLiteral_10563/*"PAYMENT_HISTORY_TEMPLATE_UPSIDE"*/, 0LL);
      ...
      v14 = System_String__Format_63129848(v11, CreatedAtToString, TypeText, 0LL);
      name = (Il2CppObject *)current->fields.name;
      v16 = v14;
      DispPrice = (Il2CppObject *)PaymentHistoryEntity__GetDispPrice(current, 0LL);
      v18 = System_String__Format_63129848(v10, name, DispPrice, 0LL);
      itemList = (System_Collections_Generic_List_object__o *)this->fields.itemList;
      idx = current->fields.idx;
      v21 = (PaymentHistoryListViewItem_o *)sub_1C22084(PaymentHistoryListViewItem_TypeInfo);
    ...
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v37,
      (const MethodInfo_33E1298 *)Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__Dispose__);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8811 & 1) == 0 )
  {
    this = (PaymentHistoryListViewManager_o *)sub_1C21E38(&PaymentHistoryListViewObject_TypeInfo);
    byte_4BD8811 = 1;
  }
  if ( !obj
