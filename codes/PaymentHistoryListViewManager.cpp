...
void PaymentHistoryListViewManager__CreateList(PaymentHistoryListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2C8C7 & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataManager_GetMaster_PaymentHistoryMaster___);
    sub_1C93AD4(&DataManager_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__Dispose__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__MoveNext__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__get_Current__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_ListViewItem__Add__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__);
    sub_1C93AD4(&LocalizationManager_TypeInfo);
    sub_1C93AD4(&PaymentHistoryListViewItem_TypeInfo);
    sub_1C93AD4(&StringLiteral_10409/*"PAYMENT_HISTORY_TEMPLATE_UPSIDE"*/);
    sub_1C93AD4(&StringLiteral_10407/*"PAYMENT_HISTORY_SP_TEMPLATE"*/);
    sub_1C93AD4(&StringLiteral_10408/*"PAYMENT_HISTORY_TEMPLATE"*/);
  ...
  Master_object = (PaymentHistoryMaster_o *)DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_PaymentHistoryMaster___);
  if ( Master_object )
  {
    ...
    System_Collections_Generic_List_object___GetEnumerator(
      ...
      (const MethodInfo_387A494 *)Method_System_Collections_Generic_List_PaymentHistoryEntity__GetEnumerator__);
    v37 = v36;
    while ( 1 )
    {
      v5 = System_Collections_Generic_List_Enumerator_object___MoveNext(
             &v37,
             (const MethodInfo_35FA018 *)Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__MoveNext__);
      if ( !v5 )
        break;
      ...
      if ( BYTE4(v37.fields._current[1].monitor) )
      {
        ...
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10407/*"PAYMENT_HISTORY_SP_TEMPLATE"*/, 0);
      }
      else
      {
        if ( !cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10408/*"PAYMENT_HISTORY_TEMPLATE"*/, 0);
      }
      v10 = v9;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v11 = LocalizationManager__Get((System_String_o *)StringLiteral_10409/*"PAYMENT_HISTORY_TEMPLATE_UPSIDE"*/, 0);
      ...
      v14 = System_String__Format_64467032(v11, CreatedAtToString, TypeText, 0);
      name = (Il2CppObject *)current->fields.name;
      v16 = v14;
      DispPrice = (Il2CppObject *)PaymentHistoryEntity__GetDispPrice(current, 0);
      v18 = System_String__Format_64467032(v10, name, DispPrice, 0);
      itemList = (System_Collections_Generic_List_object__o *)this->fields.itemList;
      idx = current->fields.idx;
      v21 = (PaymentHistoryListViewItem_o *)sub_1C93D20(PaymentHistoryListViewItem_TypeInfo);
    ...
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v37,
      (const MethodInfo_35FA014 *)Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__Dispose__);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C8C8 & 1) == 0 )
  {
    this = (PaymentHistoryListViewManager_o *)sub_1C93AD4(&PaymentHistoryListViewObject_TypeInfo);
    byte_4D2C8C8 = 1;
  }
  if ( !obj
