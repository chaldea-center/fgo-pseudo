...
void PaymentHistoryListViewManager__CreateList(PaymentHistoryListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E009B9 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataManager_GetMaster_PaymentHistoryMaster___);
    sub_1CE6700(&DataManager_TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__Dispose__);
    sub_1CE6700(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__MoveNext__);
    sub_1CE6700(&Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__get_Current__);
    ...
    sub_1CE6700(&PaymentHistoryListViewItem_TypeInfo);
    sub_1CE6700(&StringLiteral_10430/*"PAYMENT_HISTORY_TEMPLATE_UPSIDE"*/);
    sub_1CE6700(&StringLiteral_10428/*"PAYMENT_HISTORY_SP_TEMPLATE"*/);
    sub_1CE6700(&StringLiteral_10429/*"PAYMENT_HISTORY_TEMPLATE"*/);
  ...
  Master_object = (PaymentHistoryMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_PaymentHistoryMaster___);
  if ( Master_object )
  {
    ...
    while ( 1 )
    {
      v5 = System_Collections_Generic_List_Enumerator_object___MoveNext(
             &v37,
             (const MethodInfo_36809F0 *)Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__MoveNext__);
      if ( !v5 )
        break;
      ...
      if ( BYTE4(v37.fields._current[1].monitor) )
      {
        ...
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10428/*"PAYMENT_HISTORY_SP_TEMPLATE"*/, 0);
      }
      else
      {
        if ( !cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v9 = LocalizationManager__Get((System_String_o *)StringLiteral_10429/*"PAYMENT_HISTORY_TEMPLATE"*/, 0);
      }
      v10 = v9;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v11 = LocalizationManager__Get((System_String_o *)StringLiteral_10430/*"PAYMENT_HISTORY_TEMPLATE_UPSIDE"*/, 0);
      ...
      v14 = System_String__Format_65164136(v11, CreatedAtToString, TypeText, 0);
      name = (Il2CppObject *)current->fields.name;
      v16 = v14;
      DispPrice = (Il2CppObject *)PaymentHistoryEntity__GetDispPrice(current, 0);
      v18 = System_String__Format_65164136(v10, name, DispPrice, 0);
      itemList = (System_Collections_Generic_List_object__o *)this->fields.itemList;
      idx = current->fields.idx;
      v21 = (PaymentHistoryListViewItem_o *)sub_1CE694C(PaymentHistoryListViewItem_TypeInfo);
    ...
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v37,
      (const MethodInfo_36809EC *)Method_System_Collections_Generic_List_Enumerator_PaymentHistoryEntity__Dispose__);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E009BA & 1) == 0 )
  {
    this = (PaymentHistoryListViewManager_o *)sub_1CE6700(&PaymentHistoryListViewObject_TypeInfo);
    byte_4E009BA = 1;
  }
  if ( !obj
