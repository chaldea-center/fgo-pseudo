void __fastcall ItemDropEfficiencyMaster___ctor(ItemDropEfficiencyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B66ED7 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_ItemDropEfficiencyMaster__ItemDropEfficiencyEntity__string___ctor__, method);
    byte_4B66ED7 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    519,
    (const MethodInfo_31FDADC *)Method_DataMasterBase_ItemDropEfficiencyMaster__ItemDropEfficiencyEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66ED6 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, *(_QWORD *)&itemId);
    ...
    sub_1BE4ACC(&ItemDropEfficiencyEntity_TypeInfo, v9);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ItemDropEfficiencyEntity__Add__, v10);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ItemDropEfficiencyEntity___ctor__, v11);
    sub_1BE4ACC(&System_Collections_Generic_List_ItemDropEfficiencyEntity__TypeInfo, v12);
    byte_4B66ED6 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_ItemDropEfficiencyEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_ItemDropEfficiencyEntity___ctor__);
    ...
    if ( LODWORD(v26[1].klass) == itemId )
    {
      ...
      if ( IsOpen )
      {
        ...
        else
        {
          ...
          sub_1BE4A70((PartyOrganizationUtility_o *)(v42 + 4), (int64_t)v28, v33, v34, v35, v36, v37, v38);
        }
      }
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  return (ItemDropEfficiencyEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                         (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                         PK,
                                         (const MethodInfo_31FDB1C *)Method_DataMasterBase_ItemDropEfficiencyMaster__ItemDropEfficiencyEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_31FDB6C *)Method_DataMasterBase_ItemDropEfficiencyMaster__ItemDropEfficiencyEntity__string__TryGetEntity__);
}