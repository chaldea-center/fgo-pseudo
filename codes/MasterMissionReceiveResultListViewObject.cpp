        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31237 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___, method);
    byte_4A31237 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31238 & 1) == 0 )
  {
    sub_1B761C0(&MasterMissionReceiveResultListViewItem_TypeInfo, method);
