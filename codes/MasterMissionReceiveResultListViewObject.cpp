        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69DE2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___, method);
    byte_4B69DE2 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69DE3 & 1) == 0 )
  {
    sub_1BE4ACC(&MasterMissionReceiveResultListViewItem_TypeInfo, method);
