        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22DC1 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___, method);
    byte_4A22DC1 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22DC2 & 1) == 0 )
  {
    sub_1B715CC(&MasterMissionReceiveResultListViewItem_TypeInfo, method);
