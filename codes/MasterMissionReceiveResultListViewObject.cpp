        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A017BE & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___, method);
    byte_4A017BE = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A017BF & 1) == 0 )
  {
    sub_1B64870(&MasterMissionReceiveResultListViewItem_TypeInfo, method);
