        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B052A6 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___, method);
    byte_4B052A6 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B052A7 & 1) == 0 )
  {
    sub_1BC3008(&MasterMissionReceiveResultListViewItem_TypeInfo, method);
