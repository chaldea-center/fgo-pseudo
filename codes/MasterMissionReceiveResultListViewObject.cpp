        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF6C0 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___, method);
    byte_49FF6C0 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF6C1 & 1) == 0 )
  {
    sub_1B640C8(&MasterMissionReceiveResultListViewItem_TypeInfo, method);
