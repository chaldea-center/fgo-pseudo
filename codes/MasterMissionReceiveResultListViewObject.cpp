        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5262 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___, method);
    byte_48E5262 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_MasterMissionReceiveResultListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5263 & 1) == 0 )
  {
    sub_1B00CCC(&MasterMissionReceiveResultListViewItem_TypeInfo, method);
