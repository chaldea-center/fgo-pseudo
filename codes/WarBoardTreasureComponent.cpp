void __fastcall WarBoardTreasureComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4BE46 & 1) == 0 )
  {
    sub_1B863B8(&WarBoardTreasureComponent_TypeInfo, v1);
    byte_4A4BE46 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BE45 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_12800/*"SrareTreasureGet"*/, method);
    sub_1B863B8(&StringLiteral_4575/*"CommonTreasureGet"*/, v3);
    sub_1B863B8(&StringLiteral_10999/*"RareTreasureGetPlus2"*/, v4);
    sub_1B863B8(&StringLiteral_12802/*"SrareTreasureGetPlus2"*/, v5);
    sub_1B863B8(&StringLiteral_12801/*"SrareTreasureGetPlus"*/, v6);
    sub_1B863B8(&StringLiteral_10997/*"RareTreasureGet"*/, v7);
    sub_1B863B8(&StringLiteral_4577/*"CommonTreasureGetPlus2"*/, v8);
    sub_1B863B8(&StringLiteral_4576/*"CommonTreasureGetPlus"*/, v9);
    sub_1B863B8(&StringLiteral_10998/*"RareTreasureGetPlus"*/, v10);
    byte_4A4BE45 = 1;
  }
  ...
  if ( (unsigned int)v12 > 7 )
    v13 = (System_String_o **)&StringLiteral_4575/*"CommonTreasureGet"*/;
  else
    v13 = (System_String_o **)*(&off_4498FC0 + v12);
  return *v13;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BE3F & 1) == 0 )
  {
    ...
    sub_1B863B8(&WarBoardTreasureComponent_TypeInfo, v9);
    sub_1B863B8(&StringLiteral_19924/*"icon_drop_item_L_{0:00}"*/, v10);
    byte_4A4BE3F = 1;
  }
  this->fields.treasureData = data;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.treasureData, (int32_t)data, (int32_t)itemIconAtlas, method);
  treasureData = (char *)this->fields.treasureData;
  if ( !treasureData )
    goto LABEL_19;
  *((_QWORD *)treasureData + 6) = this;
  sub_1B8635C((CGThumbnailListItem_o *)(treasureData + 48), (int32_t)this, v12, v13);
  ...
  treasureData = (char *)System_String__Format((System_String_o *)StringLiteral_19924/*"icon_drop_item_L_{0:00}"*/, v22, 0LL);
  if ( !itemIcon )
    goto LABEL_19;
  UISprite__set_spriteName(itemIcon, (System_String_o *)treasureData, 0LL);
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  treasureData = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  ...
  *(UnityEngine_Vector3_o *)&v25 = WarBoardManager__GetSquarePosition(
  ...
  v28 = (UnityEngine_Transform_array *)sub_1B86460(UnityEngine_Transform___TypeInfo, 1LL);
  ...
  if ( treasureData )
  {
    treasureData = (char *)sub_1B864F4(treasureData, v28->obj.klass->_1.element_class);
    if ( !treasureData )
    {
      v34 = sub_1B86638();
      sub_1B864E0(v34, 0LL);
  ...
  if ( !v28->max_length )
    sub_1B8661C(treasureData, v11);
  v28->m_Items[0] = v31;
  sub_1B8635C((CGThumbnailListItem_o *)v28->m_Items, (int32_t)v31, v29, v30);
...
void __fastcall WarBoardTreasureComponent__OnClick(WarBoardTreasureComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4BE43 & 1) == 0 )
  {
    ...
    this = (WarBoardTreasureComponent_o *)sub_1B863B8(&Method_WarBoardTreasureComponent_OnClick__, v3);
    byte_4A4BE43 = 1;
  }
  ...
  {
    this = (WarBoardTreasureComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( !this )
      goto LABEL_16;
    if ( WarBoardManager__get_isSelectedPiece((WarBoardManager_o *)this, 0LL) && v2->fields.isSelectable )
    {
      ...
      if ( (*((_BYTE *)Method_WarBoardTreasureComponent_OnClick__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1B863D0(Method_WarBoardTreasureComponent_OnClick__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BE44 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponent_SimpleAnimation___, *(_QWORD *)&squareIndex);
    sub_1B863B8(&Method_DataManager_GetMaster_WarBoardMessageMaster___, v6);
    sub_1B863B8(&DataManager_TypeInfo, v7);
    sub_1B863B8(&Method_System_Linq_Enumerable_Any_WarBoardTaskBase___, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_WarBoardTaskBase__AddRange__, v9);
    ...
    sub_1B863B8(&WarBoardTaskBase_TaskCallback_TypeInfo, v14);
    sub_1B863B8(&Method_WarBoardTreasureComponent___c__DisplayClass13_0__OnUse_b__1__, v15);
    sub_1B863B8(&Method_WarBoardTreasureComponent___c__DisplayClass13_0__OnUse_g__AddAfterTask_0__, v16);
    sub_1B863B8(&WarBoardTreasureComponent___c__DisplayClass13_0_TypeInfo, v17);
    sub_1B863B8(&WarBoardCallbackTask_TypeInfo, v18);
    sub_1B863B8(&WarBoardSimpleAnimationPerformance_TypeInfo, v19);
    byte_4A4BE44 = 1;
  }
  v20 = sub_1B86604(WarBoardTreasureComponent___c__DisplayClass13_0_TypeInfo);
  ...
  *(_QWORD *)(v20 + 24) = endCallback;
  sub_1B8635C((CGThumbnailListItem_o *)(v20 + 24), (int32_t)endCallback, v25, v26);
  ...
  *(_QWORD *)(v20 + 40) = playedStageReinforcementsList;
  sub_1B8635C((CGThumbnailListItem_o *)(v20 + 40), (int32_t)playedStageReinforcementsList, v28, v29);
  ...
  *(_QWORD *)(v20 + 32) = Master_object;
  sub_1B8635C((CGThumbnailListItem_o *)(v20 + 32), (int32_t)Master_object, v32, v33);
  ...
  v39 = sub_1B86604(WarBoardSimpleAnimationPerformance_TypeInfo);
...
LABEL_32:
  ...
  v42 = (WarBoardTaskBase_TaskCallback_o *)sub_1B86604(WarBoardTaskBase_TaskCallback_TypeInfo);
  ...
  *v40 = v46;
LABEL_20:
  sub_1B8635C((CGThumbnailListItem_o *)(v39 + 40), (int32_t)v46, v44, v45);
  if ( !v27 )
    goto LABEL_32;
  ...
  else
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)(v53 + 4), v39, v48, v49);
  }
  v54 = sub_1B86604(WarBoardCallbackTask_TypeInfo);
  WarBoardCallbackTask___ctor((WarBoardCallbackTask_o *)v54, 0LL, 0LL);
  v55 = (WarBoardTaskBase_TaskCallback_o *)sub_1B86604(WarBoardTaskBase_TaskCallback_TypeInfo);
  WarBoardTaskBase_TaskCallback___ctor(
    v55,
    (Il2CppObject *)v20,
  ...
  if ( !v54 )
    goto LABEL_32;
  *(_QWORD *)(v54 + 32) = v55;
  sub_1B8635C((CGThumbnailListItem_o *)(v54 + 32), (int32_t)v55, v56, v57);
  ...
  else
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)(v63 + 4), v54, v58, v59);
  }
  Instance = (WarBoardData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_32;
        ...
        const MethodInfo *method)
{
  ...
  System_Collections_Generic_List_object___AddRange(
    ...
    (const MethodInfo_35FCB64 *)Method_System_Collections_Generic_List_WarBoardTaskBase__AddRange__);
  warBoardData = (WarBoardData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !warBoardData )
    goto LABEL_11;
