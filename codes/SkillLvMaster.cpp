void __fastcall SkillLvMaster___ctor(SkillLvMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4EFFD & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__, method);
    byte_4A4EFFD = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    57,
    (const MethodInfo_3216A14 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
}
...
int64_t __fastcall SkillLvMaster__GetBaseTime(const MethodInfo *method)
{
  ...
  if ( (byte_4A4F000 & 1) == 0 )
  {
    ...
    sub_1B863B8(&SkillLvMaster_TypeInfo, v2);
    byte_4A4F000 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F002 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMaster_FunctionMaster___, *(_QWORD *)&skillId);
  ...
  if ( ((unsigned __int8)Master_object & 1) == 0 )
    return (System_Int32_array *)sub_1B86460(int___TypeInfo, 1LL);
  v16 = entity;
  if ( !entity )
    goto LABEL_23;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4EFFA & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__, *(_QWORD *)&skillId);
    sub_1B863B8(&SkillLvMaster_TypeInfo, v7);
    byte_4A4EFFA = 1;
  }
  PK = (Il2CppObject *)SkillLvEntity__CreatePK(skillId, lv, 0LL);
  Entity = DataMasterBase_object__object__object___GetEntity(
             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
             PK,
             (const MethodInfo_3218D38 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4EFFC & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMaster_SkillGroupMaster___, entity);
    sub_1B863B8(&Method_DataManager_GetMaster_SkillGroupOverwriteMaster___, v6);
    sub_1B863B8(&DataManager_TypeInfo, v7);
    sub_1B863B8(&int___TypeInfo, v8);
    sub_1B863B8(&NetworkManager_TypeInfo, v9);
    sub_1B863B8(&SkillLvEntity_TypeInfo, v10);
  ...
  if ( v5 )
  {
    ...
    if ( !Master_object )
      goto LABEL_37;
    v14 = *(_QWORD *)&Master_object->max_length;
    v15 = Master_object;
    if ( (int)v14 >= 1 )
    {
      v16 = 0LL;
      ...
      v18 = sub_1B86604(SkillLvEntity_TypeInfo);
      SkillLvEntity___ctor_40971832((SkillLvEntity_o *)v18, v5, 0LL);
      if ( !entitya )
        goto LABEL_37;
      ...
      {
        v21 = Master_object;
        Master_object = (System_Int32_array *)sub_1B864F4(Master_object, int___TypeInfo);
        v13 = Master_object;
        if ( !Master_object )
          goto LABEL_32;
      }
      ...
      if ( !v18 )
        goto LABEL_37;
      *(_QWORD *)(v18 + 32) = v13;
      sub_1B8635C((CGThumbnailListItem_o *)(v18 + 32), (int32_t)v13, v19, v20);
      if ( !entitya )
        goto LABEL_37;
      svals = (System_Array_o *)entitya->fields.svals;
      if ( !svals )
        goto LABEL_33;
      v25 = System_Array__Clone(svals, 0LL);
      if ( !v25 )
        goto LABEL_33;
      v21 = (System_Int32_array *)v25;
      v26 = sub_1B864F4(v25, string___TypeInfo);
      if ( v26 )
        goto LABEL_34;
LABEL_32:
      sub_1B868D4(v21);
...
LABEL_34:
      *(_QWORD *)(v18 + 40) = v26;
      sub_1B8635C((CGThumbnailListItem_o *)(v18 + 40), v26, v22, v23);
      if ( entitya )
      {
        v5 = (SkillLvEntity_o *)v18;
        *(_DWORD *)(v18 + 48) = entitya->fields.skillDetailId;
        return v5;
      }
LABEL_37:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4EFFE & 1) == 0 )
  {
    sub_1B863B8(&Method_BasicHelper_GetValue_Dictionary_string__object____, *(_QWORD *)&skillId);
    sub_1B863B8(&StringLiteral_12447/*"SelectAddInfo"*/, v8);
    byte_4A4EFFE = 1;
  }
  entity = 0LL;
  ...
  if ( v10 )
  {
    ...
    return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                        ...
                                                                        (System_String_o *)StringLiteral_12447/*"SelectAddInfo"*/,
                                                                        0LL,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F003 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMaster_FunctionMaster___, skillEnity);
    sub_1B863B8(&DataManager_TypeInfo, v4);
    byte_4A4F003 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataVals_array *)DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_FunctionMaster___);
  if ( !skillEnity
    || (funcId = skillEnity->fields.funcId,
        v8 = (FunctionMaster_o *)Master_object,
        Master_object = SkillLvEntity__getDataValsList(skillEnity, 0LL),
        !v8) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F004 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__, ret);
    byte_4A4F004 = 1;
  }
  if ( includeBeforeOverwrite )
  {
    PK = (Il2CppObject *)SkillLvEntity__CreatePK(skillId, skillLv, 0LL);
    Entity = DataMasterBase_object__object__object___GetEntity(
               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
               PK,
               (const MethodInfo_3218D38 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
    if ( Entity )
      SkillLvEntity__GetUniqueFuncIds((SkillLvEntity_o *)Entity, ret, 0LL);
  }
...
void __fastcall SkillLvMaster__ResetBaseTime(const MethodInfo *method)
{
  ...
  if ( (byte_4A4F001 & 1) == 0 )
  {
    sub_1B863B8(&SkillLvMaster_TypeInfo, v1);
    byte_4A4F001 = 1;
  }
...
void __fastcall SkillLvMaster__SetBaseTime(int64_t value, const MethodInfo *method)
{
  if ( (byte_4A4EFFF & 1) == 0 )
  {
    sub_1B863B8(&SkillLvMaster_TypeInfo, method);
    byte_4A4EFFF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4EFFB & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__, entity);
    sub_1B863B8(&SkillLvMaster_TypeInfo, v9);
    byte_4A4EFFB = 1;
  }
  PK = (Il2CppObject *)SkillLvEntity__CreatePK(skillId, lv, 0LL);
  v11 = DataMasterBase_object__object__object___TryGetEntity(
          ...
          (Il2CppObject **)entity,
          PK,
          (const MethodInfo_3218D84 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
  v13 = v11;
  if ( v11 )
  {
    ...
    *entity = OverwriteEntity;
    sub_1B8635C((CGThumbnailListItem_o *)entity, (int32_t)OverwriteEntity, v15, v16);
  }
  return v13;
}