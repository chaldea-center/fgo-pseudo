void SkillLvMaster___ctor(SkillLvMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C43BA2 & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
    byte_4C43BA2 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    57,
    (const MethodInfo_33A3834 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Master_object & 1) == 0 )
    return (System_Int32_array *)sub_1C37100(int___TypeInfo, 1);
  if ( !entity )
    goto LABEL_22;
...
SkillLvEntity_o *SkillLvMaster__GetEntity(SkillLvMaster_o *this, int32_t skillId, int32_t lv, const MethodInfo *method)
{
  ...
  if ( (byte_4C43B9F & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
    sub_1C37058(&SkillLvMaster_TypeInfo);
    byte_4C43B9F = 1;
  }
  ...
  Entity = DataMasterBase_object__object__object___GetEntity(
             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
             PK,
             (const MethodInfo_33A5B58 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C43BA1 & 1) == 0 )
  {
    ...
    sub_1C37058(&int___TypeInfo);
    sub_1C37058(&NetworkManager_TypeInfo);
    sub_1C37058(&SkillLvEntity_TypeInfo);
  ...
  if ( entity )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      v13 = sub_1C372A4(SkillLvEntity_TypeInfo);
      SkillLvEntity___ctor_42893576((SkillLvEntity_o *)v13, entity, v14);
      if ( !entitya )
        goto LABEL_37;
      ...
      {
        v17 = Master_object;
        Master_object = (System_Int32_array *)sub_1C37194(Master_object, int___TypeInfo);
        v18 = Master_object;
        if ( !Master_object )
          goto LABEL_32;
      }
      ...
      if ( !v13 )
        goto LABEL_37;
      *(_QWORD *)(v13 + 32) = v18;
      sub_1C36FFC((CGThumbnailListItem_o *)(v13 + 32), (int32_t)v18, v15, v16);
      if ( !entitya )
        goto LABEL_37;
      ...
      v23 = sub_1C37194(v22, string___TypeInfo);
      if ( v23 )
        goto LABEL_34;
LABEL_32:
      sub_1C37574(v17);
...
LABEL_34:
      *(_QWORD *)(v13 + 40) = v23;
      sub_1C36FFC((CGThumbnailListItem_o *)(v13 + 40), v23, v19, v20);
      if ( entitya )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C43BA3 & 1) == 0 )
  {
    sub_1C37058(&Method_BasicHelper_GetValue_Dictionary_string__object____);
    sub_1C37058(&StringLiteral_12668/*"SelectAddInfo"*/);
    byte_4C43BA3 = 1;
  }
  entity = 0;
  ...
  if ( v8 )
  {
    ...
    return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                        *(System_Collections_Generic_Dictionary_string__object__o **)((char *)&word_38 + (_QWORD)entity),
                                                                        (System_String_o *)StringLiteral_12668/*"SelectAddInfo"*/,
                                                                        0,
                                                                        (const MethodInfo_30D55CC *)Method_BasicHelper_GetValue_Dictionary_string__object____);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataVals_array *)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_FunctionMaster___);
  if ( !skillEnity
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C43BA0 & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
    sub_1C37058(&SkillLvMaster_TypeInfo);
    byte_4C43BA0 = 1;
  }
  ...
  v10 = DataMasterBase_object__object__object___TryGetEntity(
          ...
          (Il2CppObject **)entity,
          PK,
          (const MethodInfo_33A5BA4 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
  v12 = v10;
  if ( v10 )
  {
    ...
    *entity = OverwriteEntity;
    sub_1C36FFC((CGThumbnailListItem_o *)entity, (int32_t)OverwriteEntity, v14, v15);
  }
  return v12;
}