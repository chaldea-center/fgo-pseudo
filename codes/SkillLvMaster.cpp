void __fastcall SkillLvMaster___ctor(SkillLvMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B455FA & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__, method);
    byte_4B455FA = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    57,
    (const MethodInfo_32E45D0 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
}
...
int64_t __fastcall SkillLvMaster__GetBaseTime(const MethodInfo *method)
{
  ...
  if ( (byte_4B455FD & 1) == 0 )
  {
    ...
    sub_1BDB878(&SkillLvMaster_TypeInfo, v2);
    byte_4B455FD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B455FF & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_FunctionMaster___, *(_QWORD *)&skillId);
  ...
  if ( ((unsigned __int8)Master_object & 1) == 0 )
    return (System_Int32_array *)sub_1BDB920(int___TypeInfo, 1LL);
  v17 = entity;
  if ( !entity )
    goto LABEL_22;
  ...
  if ( (int)funcId->max_length >= 1 )
  {
    ...
    while ( SetTypeDataValArray )
    {
      if ( v23 >= SetTypeDataValArray->max_length )
        sub_1BDBADC(Master_object, v17, v21);
      if ( !v22 )
        break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B455F7 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__, *(_QWORD *)&skillId);
    sub_1BDB878(&SkillLvMaster_TypeInfo, v7);
    byte_4B455F7 = 1;
  }
  ...
  Entity = DataMasterBase_object__object__object___GetEntity(
             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
             PK,
             (const MethodInfo_32E68F4 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B455F9 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_SkillGroupMaster___, entity);
    sub_1BDB878(&Method_DataManager_GetMaster_SkillGroupOverwriteMaster___, v6);
    sub_1BDB878(&DataManager_TypeInfo, v7);
    sub_1BDB878(&int___TypeInfo, v8);
    sub_1BDB878(&NetworkManager_TypeInfo, v9);
    sub_1BDB878(&SkillLvEntity_TypeInfo, v10);
  ...
  if ( v5 )
  {
    ...
    if ( (int)v15 >= 1 )
    {
      ...
      v19 = sub_1BDBAC4(SkillLvEntity_TypeInfo);
      SkillLvEntity___ctor_41834228((SkillLvEntity_o *)v19, v5, v20);
      if ( !entitya )
        goto LABEL_37;
      ...
      {
        v23 = Master_object;
        Master_object = (System_Int32_array *)sub_1BDB9B4(Master_object, int___TypeInfo);
        v13 = Master_object;
        if ( !Master_object )
          goto LABEL_32;
      }
      ...
      if ( !v19 )
        goto LABEL_37;
      *(_QWORD *)(v19 + 32) = v13;
      sub_1BDB81C((CGThumbnailListItem_o *)(v19 + 32), (int32_t)v13, v21, v22);
      if ( !entitya )
        goto LABEL_37;
      ...
      if ( !v27 )
        goto LABEL_33;
      v23 = (System_Int32_array *)v27;
      v28 = sub_1BDB9B4(v27, string___TypeInfo);
      if ( v28 )
        goto LABEL_34;
LABEL_32:
      sub_1BDBD94(v23);
...
LABEL_34:
      *(_QWORD *)(v19 + 40) = v28;
      sub_1BDB81C((CGThumbnailListItem_o *)(v19 + 40), v28, v24, v25);
      if ( entitya )
      {
        v5 = (SkillLvEntity_o *)v19;
        *(_DWORD *)(v19 + 48) = entitya->fields.skillDetailId;
        return v5;
      }
LABEL_37:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B455FB & 1) == 0 )
  {
    sub_1BDB878(&Method_BasicHelper_GetValue_Dictionary_string__object____, *(_QWORD *)&skillId);
    sub_1BDB878(&StringLiteral_12633/*"SelectAddInfo"*/, v8);
    byte_4B455FB = 1;
  }
  entity = 0LL;
  ...
  if ( v10 )
  {
    ...
    return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                        ...
                                                                        (System_String_o *)StringLiteral_12633/*"SelectAddInfo"*/,
                                                                        0LL,
                                                                        (const MethodInfo_30213D0 *)Method_BasicHelper_GetValue_Dictionary_string__object____);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45600 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_FunctionMaster___, skillEnity);
    sub_1BDB878(&DataManager_TypeInfo, v4);
    byte_4B45600 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataVals_array *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_FunctionMaster___);
  if ( !skillEnity
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45601 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__, ret);
    byte_4B45601 = 1;
  }
...
void __fastcall SkillLvMaster__ResetBaseTime(const MethodInfo *method)
{
  ...
  if ( (byte_4B455FE & 1) == 0 )
  {
    sub_1BDB878(&SkillLvMaster_TypeInfo, v1);
    byte_4B455FE = 1;
  }
...
void __fastcall SkillLvMaster__SetBaseTime(int64_t value, const MethodInfo *method)
{
  if ( (byte_4B455FC & 1) == 0 )
  {
    sub_1BDB878(&SkillLvMaster_TypeInfo, method);
    byte_4B455FC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B455F8 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__, entity);
    sub_1BDB878(&SkillLvMaster_TypeInfo, v9);
    byte_4B455F8 = 1;
  }
  ...
  v11 = DataMasterBase_object__object__object___TryGetEntity(
          ...
          (Il2CppObject **)entity,
          PK,
          (const MethodInfo_32E6940 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
  v13 = v11;
  if ( v11 )
  {
    ...
    *entity = OverwriteEntity;
    sub_1BDB81C((CGThumbnailListItem_o *)entity, (int32_t)OverwriteEntity, v15, v16);
  }
  return v13;
}