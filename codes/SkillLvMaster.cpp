void SkillLvMaster___ctor(SkillLvMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C57959 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
    byte_4C57959 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    57,
    (const MethodInfo_33B56EC *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Master_object & 1) == 0 )
    return (System_Int32_array *)sub_1C3E60C(int___TypeInfo, 1);
  v11 = entity;
  if ( !entity )
    goto LABEL_22;
...
SkillLvEntity_o *SkillLvMaster__GetEntity(SkillLvMaster_o *this, int32_t skillId, int32_t lv, const MethodInfo *method)
{
  ...
  if ( (byte_4C57956 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
    sub_1C3E564(&SkillLvMaster_TypeInfo);
    byte_4C57956 = 1;
  }
  ...
  Entity = DataMasterBase_object__object__object___GetEntity(
             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
             PK,
             (const MethodInfo_33B7A10 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C57958 & 1) == 0 )
  {
    ...
    sub_1C3E564(&int___TypeInfo);
    sub_1C3E564(&NetworkManager_TypeInfo);
    sub_1C3E564(&SkillLvEntity_TypeInfo);
  ...
  if ( entity )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      v14 = sub_1C3E7B0(SkillLvEntity_TypeInfo);
      SkillLvEntity___ctor_42945592((SkillLvEntity_o *)v14, entity, v15);
      if ( !entitya )
        goto LABEL_37;
      ...
      {
        v18 = Master_object;
        Master_object = (System_Int32_array *)sub_1C3E6A0(Master_object, int___TypeInfo);
        v7 = Master_object;
        if ( !Master_object )
          goto LABEL_32;
      }
      ...
      if ( !v14 )
        goto LABEL_37;
      *(_QWORD *)(v14 + 32) = v7;
      sub_1C3E508((CGThumbnailListItem_o *)(v14 + 32), (int32_t)v7, v16, v17);
      if ( !entitya )
        goto LABEL_37;
      ...
      v23 = sub_1C3E6A0(v22, string___TypeInfo);
      if ( v23 )
        goto LABEL_34;
LABEL_32:
      sub_1C3EA80(v18);
...
LABEL_34:
      *(_QWORD *)(v14 + 40) = v23;
      sub_1C3E508((CGThumbnailListItem_o *)(v14 + 40), v23, v19, v20);
      if ( entitya )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5795A & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_12676/*"SelectAddInfo"*/);
    byte_4C5795A = 1;
  }
  entity = 0;
  ...
  if ( v9 )
  {
    ...
    return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                        *(System_Collections_Generic_Dictionary_string__object__o **)((char *)&word_38 + (_QWORD)entity),
                                                                        (System_String_o *)StringLiteral_12676/*"SelectAddInfo"*/,
                                                                        0,
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataVals_array *)DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_FunctionMaster___);
  if ( !skillEnity
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C57957 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
    sub_1C3E564(&SkillLvMaster_TypeInfo);
    byte_4C57957 = 1;
  }
  ...
  v10 = DataMasterBase_object__object__object___TryGetEntity(
          ...
          (Il2CppObject **)entity,
          PK,
          (const MethodInfo_33B7A5C *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
  v12 = v10;
  if ( v10 )
  {
    ...
    *entity = OverwriteEntity;
    sub_1C3E508((CGThumbnailListItem_o *)entity, (int32_t)OverwriteEntity, v14, v15);
  }
  return v12;
}