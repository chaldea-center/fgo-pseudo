void SkillLvMaster___ctor(SkillLvMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CC7FEE & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
    byte_4CC7FEE = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    57,
    (const MethodInfo_340B614 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Master_object & 1) == 0 )
    return (System_Int32_array *)sub_1C71458(int___TypeInfo, 1);
  v11 = entity;
  if ( !entity )
    goto LABEL_22;
...
SkillLvEntity_o *SkillLvMaster__GetEntity(SkillLvMaster_o *this, int32_t skillId, int32_t lv, const MethodInfo *method)
{
  ...
  if ( (byte_4CC7FEB & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
    sub_1C713B0(&SkillLvMaster_TypeInfo);
    byte_4CC7FEB = 1;
  }
  ...
  Entity = DataMasterBase_object__object__object___GetEntity(
             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
             PK,
             (const MethodInfo_340D938 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__GetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7FED & 1) == 0 )
  {
    ...
    sub_1C713B0(&int___TypeInfo);
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&SkillLvEntity_TypeInfo);
  ...
  if ( entity )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      v14 = sub_1C715FC(SkillLvEntity_TypeInfo);
      SkillLvEntity___ctor_43179736((SkillLvEntity_o *)v14, entity, v15);
      if ( !entitya )
        goto LABEL_37;
      ...
      {
        v22 = Master_object;
        Master_object = (System_Int32_array *)sub_1C714EC(Master_object, int___TypeInfo);
        v7 = Master_object;
        if ( !Master_object )
          goto LABEL_32;
      }
      ...
      if ( !v14 )
        goto LABEL_37;
      *(_QWORD *)(v14 + 32) = v7;
      sub_1C71354((GrandQuestFolderBoardItem_o *)(v14 + 32), (int32_t)v7, v16, v17, v18, v19, v20, v21);
      if ( !entitya )
        goto LABEL_37;
      ...
      v31 = sub_1C714EC(v30, string___TypeInfo);
      if ( v31 )
        goto LABEL_34;
LABEL_32:
      sub_1C719A4(v22);
...
LABEL_34:
      *(_QWORD *)(v14 + 40) = v31;
      sub_1C71354((GrandQuestFolderBoardItem_o *)(v14 + 40), v31, v23, v24, v25, v26, v27, v28);
      if ( entitya )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7FEF & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_12678/*"SelectAddInfo"*/);
    byte_4CC7FEF = 1;
  }
  entity = 0;
  ...
  if ( v9 )
  {
    ...
    return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                        *(System_Collections_Generic_Dictionary_string__object__o **)((char *)&word_38 + (_QWORD)entity),
                                                                        (System_String_o *)StringLiteral_12678/*"SelectAddInfo"*/,
                                                                        0,
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataVals_array *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_FunctionMaster___);
  if ( !skillEnity
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7FEC & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
    sub_1C713B0(&SkillLvMaster_TypeInfo);
    byte_4CC7FEC = 1;
  }
  ...
  v10 = DataMasterBase_object__object__object___TryGetEntity(
          ...
          (Il2CppObject **)entity,
          PK,
          (const MethodInfo_340D984 *)Method_DataMasterBase_SkillLvMaster__SkillLvEntity__string__TryGetEntity__);
  v12 = v10;
  if ( v10 )
  {
    ...
    *entity = OverwriteEntity;
    sub_1C71354((GrandQuestFolderBoardItem_o *)entity, (int32_t)OverwriteEntity, v14, v15, v16, v17, v18, v19);
  }
  return v12;
}