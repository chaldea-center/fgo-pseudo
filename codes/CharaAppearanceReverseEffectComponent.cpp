        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B67F52 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1BE4ACC(&StringLiteral_5043/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v15);
    byte_4B67F52 = 1;
  }
