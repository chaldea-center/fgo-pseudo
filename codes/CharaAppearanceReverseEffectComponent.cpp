        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09F58 & 1) == 0 )
  {
    sub_1B686D4(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B686D4(&StringLiteral_4939/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v11);
    byte_4A09F58 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4939/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
