        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2336B & 1) == 0 )
  {
    sub_1C3B764(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1C3B764(&StringLiteral_5053/*"DataTable.DataColumn_{0}.Caption"*/, v15);
    byte_4C2336B = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_5053/*"DataTable.DataColumn_{0}.Caption"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
