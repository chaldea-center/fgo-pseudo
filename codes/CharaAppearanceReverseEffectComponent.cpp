        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B034F9 & 1) == 0 )
  {
    sub_1BC3008(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1BC3008(&StringLiteral_4883/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v11);
    byte_4B034F9 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4883/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
