        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEB41 & 1) == 0 )
  {
    sub_1C2E12C(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1C2E12C(&StringLiteral_5053/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v15);
    byte_4BFEB41 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_5053/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
