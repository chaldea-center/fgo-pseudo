        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F4C & 1) == 0 )
  {
    sub_1BDB878(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1BDB878(&StringLiteral_4963/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v11);
    byte_4B45F4C = 1;
  }
