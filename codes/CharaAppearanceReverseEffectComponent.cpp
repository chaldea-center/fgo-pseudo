        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438E26B & 1) == 0 )
  {
    sub_B775C4(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__);
    ...
    sub_B775C4(&StringLiteral_4659/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/);
    byte_438E26B = 1;
  }
  ...
  if ( !transform )
    goto LABEL_36;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4659/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_36;
