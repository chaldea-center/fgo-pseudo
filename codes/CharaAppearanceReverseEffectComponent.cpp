        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DCD & 1) == 0 )
  {
    sub_1B715CC(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B715CC(&StringLiteral_4944/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v11);
    byte_4A20DCD = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4944/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
