        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4215E35 & 1) == 0 )
  {
    sub_B0D8A4(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_B0D8A4(&StringLiteral_4540/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v15);
    byte_4215E35 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_36;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4540/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_36;
  ...
  {
    CharaAppearanceReverseEffectComponent__EndCreateEffect(this, 0LL, v22);
    return;
  }
