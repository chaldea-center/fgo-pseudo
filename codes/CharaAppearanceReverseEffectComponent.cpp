        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F241 & 1) == 0 )
  {
    sub_1B761C0(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B761C0(&StringLiteral_4962/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v11);
    byte_4A2F241 = 1;
  }
