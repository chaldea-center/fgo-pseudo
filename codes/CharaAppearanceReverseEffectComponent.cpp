        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB5A7F & 1) == 0 )
  {
    sub_1C13D24(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1C13D24(&StringLiteral_5052/*"Custom/Sprite-ScriptActionFigureCrossFadeSummon"*/, v15);
    byte_4BB5A7F = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_5052/*"Custom/Sprite-ScriptActionFigureCrossFadeSummon"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
