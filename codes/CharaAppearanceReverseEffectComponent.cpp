        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB6F5 & 1) == 0 )
  {
    sub_B5D5C4(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__, (_DWORD)figure, (_DWORD)method, v3);
    sub_B5D5C4(&CommonEffectManager_TypeInfo, v11, v12, v13);
    sub_B5D5C4(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v14, v15, v16);
    sub_B5D5C4(&UnityEngine_Object_TypeInfo, v17, v18, v19);
    sub_B5D5C4(&StringLiteral_13710/*"Talk/"*/, v20, v21, v22);
    sub_B5D5C4(&StringLiteral_4597/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, v23, v24, v25);
    byte_42EB6F5 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_36;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4597/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_36;
  ...
  v31 = (UnityEngine_Object_o *)*p_figure;
  if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  {
    CharaAppearanceReverseEffectComponent__EndCreateEffect(this, 0LL, v33);
    return;
  }
  ...
  if ( !transform )
    goto LABEL_36;
  LODWORD(v34) = (unsigned int)UnityEngine_Transform__get_localPosition((UnityEngine_Transform_o *)transform, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v7 = TweenRenderVolume__Begin(gameObject, this->fields.duration, 1.0, 0LL);
  if ( !v7 )
    sub_B5D69C(0LL, v8);
  v9 = v7;
  v7->fields.style = 1;
