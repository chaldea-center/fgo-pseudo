        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43549AC & 1) == 0 )
  {
    sub_B70694(&Method_CharaAppearanceReverseEffectComponent_EndCreateEffect__);
    ...
    sub_B70694(&StringLiteral_4607/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/);
    byte_43549AC = 1;
  }
  ...
  if ( !transform )
    goto LABEL_36;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4607/*"Custom/Sprite-ScriptActionFigureErasureReverse"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_36;
