void __fastcall EquipExpMaster___ctor(EquipExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FC2AB & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_EquipExpMaster__EquipExpEntity__string___ctor__, method);
    byte_49FC2AB = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    48,
    (const MethodInfo_30D41BC *)Method_DataMasterBase_EquipExpMaster__EquipExpEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC2A9 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_EquipExpMaster__EquipExpEntity__string__GetEntity__, *(_QWORD *)&equipId);
    byte_49FC2A9 = 1;
  }
  ...
  return (EquipExpEntity_o *)DataMasterBase_object__object__object___GetEntity(
                               (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                               PK,
                               (const MethodInfo_30D41FC *)Method_DataMasterBase_EquipExpMaster__EquipExpEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC2AA & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_EquipExpMaster__EquipExpEntity__string__TryGetEntity__, entity);
    byte_49FC2AA = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D424C *)Method_DataMasterBase_EquipExpMaster__EquipExpEntity__string__TryGetEntity__);
}
...
int32_t __fastcall EquipExpMaster__getLevelMax(EquipExpMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_49FC2AC & 1) == 0 )
  {
    ...
    sub_1B640C8(&EquipExpEntity_TypeInfo, v6);
    byte_49FC2AC = 1;
  }
