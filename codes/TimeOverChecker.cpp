        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)monoBehaviour, v7, v8, v9, v10, v11, v12);
  this->fields.onFinish = onFinish;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.onFinish, (int64_t)onFinish, v13, v14, v15, v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB8BE & 1) == 0 )
  {
    sub_1C1ABD4(&TimeOverChecker__CheckTimeOver_d__7_TypeInfo, method);
    byte_4BCB8BE = 1;
  }
  v3 = sub_1C1AE20(TimeOverChecker__CheckTimeOver_d__7_TypeInfo);
...
void __fastcall TimeOverChecker__Start(TimeOverChecker_o *this, int64_t finishedAt, const MethodInfo *method)
{
  ...
  if ( this->fields.finishedAt )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)monoBehaviour, 0LL) )
    {
      ...
      if ( v7 )
      {
        started = UnityEngine_MonoBehaviour__StartCoroutine_70779684(v7, monoBehaviour, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB8BF & 1) == 0 )
  {
    ...
    this = (TimeOverChecker__CheckTimeOver_d__7_o *)sub_1C1ABD4(&UnityEngine_WaitForSeconds_TypeInfo, v3);
    byte_4BCB8BF = 1;
  }
  ...
  else
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&v2->fields._waitTime_5__2, (int64_t)v6, v7, v8, v9, v10, v11, v12);
  }
...
LABEL_16:
  ...
  sub_1C1AB78(p__2__current, waitTime_5__2, v14, v15, v16, v17, v18, v19);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_TimeOverChecker__CheckTimeOver_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
