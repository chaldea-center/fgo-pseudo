        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)monoBehaviour, v7, v8);
  this->fields.onFinish = onFinish;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.onFinish, (int32_t)onFinish, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31B6B & 1) == 0 )
  {
    sub_1B761C0(&TimeOverChecker__CheckTimeOver_d__7_TypeInfo, method);
    byte_4A31B6B = 1;
  }
  v3 = sub_1B7640C(TimeOverChecker__CheckTimeOver_d__7_TypeInfo);
...
void __fastcall TimeOverChecker__Start(TimeOverChecker_o *this, int64_t finishedAt, const MethodInfo *method)
{
  ...
  if ( this->fields.finishedAt )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)monoBehaviour, 0LL) )
    {
      ...
      if ( v7 )
      {
        started = UnityEngine_MonoBehaviour__StartCoroutine_69272680(v7, monoBehaviour, 0LL);
        this->fields.coroutine = started;
        sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.coroutine, (int32_t)started, v9, v10);
        return;
      }
LABEL_7:
      sub_1B7641C(monoBehaviour, v4);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31B6C & 1) == 0 )
  {
    ...
    this = (TimeOverChecker__CheckTimeOver_d__7_o *)sub_1B761C0(&UnityEngine_WaitForSeconds_TypeInfo, v3);
    byte_4A31B6C = 1;
  }
  ...
  else
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&v2->fields._waitTime_5__2, (int32_t)v6, v7, v8);
  }
...
LABEL_16:
  ...
  sub_1B76164(p__2__current, (int32_t)waitTime_5__2, v10, v11);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_TimeOverChecker__CheckTimeOver_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
