        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields, (int64_t)monoBehaviour, v7, v8, v9, v10, v11, v12);
  this->fields.onFinish = onFinish;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.onFinish, (int64_t)onFinish, v13, v14, v15, v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0380 & 1) == 0 )
  {
    sub_1C21E38(&TimeOverChecker__CheckTimeOver_d__7_TypeInfo);
    byte_4BE0380 = 1;
  }
  v3 = sub_1C22084(TimeOverChecker__CheckTimeOver_d__7_TypeInfo);
...
void __fastcall TimeOverChecker__Start(TimeOverChecker_o *this, int64_t finishedAt, const MethodInfo *method)
{
  ...
  if ( this->fields.finishedAt )
  {
    ...
    if ( UnityEngine_Behaviour__get_isActiveAndEnabled((UnityEngine_Behaviour_o *)monoBehaviour, 0LL) )
    {
      ...
      if ( v7 )
      {
        started = UnityEngine_MonoBehaviour__StartCoroutine_70854884(v7, monoBehaviour, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0381 & 1) == 0 )
  {
    ...
    this = (TimeOverChecker__CheckTimeOver_d__7_o *)sub_1C21E38(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4BE0381 = 1;
  }
  ...
  else
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&v2->fields._waitTime_5__2, (int64_t)v5, v6, v7, v8, v9, v10, v11);
  }
...
LABEL_16:
  ...
  sub_1C21DDC(p__2__current, waitTime_5__2, v13, v14, v15, v16, v17, v18);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_TimeOverChecker__CheckTimeOver_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
