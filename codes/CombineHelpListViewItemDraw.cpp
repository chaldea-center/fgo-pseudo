...
void __fastcall CombineHelpListViewItemDraw__Awake(CombineHelpListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.baseImageBasicAtlas, (int32_t)mAtlas, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05DD6 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_20351/*"img_shop_0"*/, v8);
  ...
  if ( item )
  {
    ...
    if ( mode )
    {
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        if ( !infoTextLabel )
          goto LABEL_52;
        imageName = (System_String_o *)StringLiteral_20351/*"img_shop_0"*/;
      ...
      if ( v18 )
      {
        ...
        if ( gameObject )
        {
          UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_20406/*"img_tutorial_txtbg"*/, 0LL);
          gameObject = (UnityEngine_Component_o *)this->fields.infoTextLabel;
          if ( gameObject )
          {
            gameObject = (UnityEngine_Component_o *)UnityEngine_Component__get_transform(gameObject, 0LL);
