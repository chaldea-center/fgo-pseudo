        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43892D8 & 1) == 0 )
  {
    sub_B775C4(&Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___);
    byte_43892D8 = 1;
  }
  ...
  Component_srcLineSprite = (struct UserPresentHistoryListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                             dispObject,
                                                                             (const MethodInfo_1DEBFC4 *)Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___);
