        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE0EE & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___);
    byte_42AE0EE = 1;
  }
  ...
  Component_srcLineSprite = (struct UserPresentHistoryListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                             dispObject,
                                                                             (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___);
