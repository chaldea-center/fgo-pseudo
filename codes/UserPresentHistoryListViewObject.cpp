        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD8DD & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___, method);
    byte_49FD8DD = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD8DE & 1) == 0 )
  {
    ...
    sub_1B64A00(&UserPresentHistoryListViewItem_TypeInfo, v3);
    byte_49FD8DE = 1;
  }
