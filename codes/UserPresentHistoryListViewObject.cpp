        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D294 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___, method);
    byte_4A4D294 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_UserPresentHistoryListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D295 & 1) == 0 )
  {
    ...
    sub_1B863B8(&UserPresentHistoryListViewItem_TypeInfo, v3);
    byte_4A4D295 = 1;
  }
