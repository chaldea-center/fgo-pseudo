void ScriptConnectListViewItemDraw___ctor(ScriptConnectListViewItemDraw_o *this, const MethodInfo *method)
{
...
void ScriptConnectListViewItemDraw__SetItem(
        ...
        const MethodInfo *method)
{
  ...
  if ( item && mode )
  {
    if ( ScriptConnectListViewItem__get_TitleText(item, (const MethodInfo *)item) )
    {
      ...
      TitleText = ScriptConnectListViewItem__get_TitleText(item, v7);
      if ( !titleTextLabel )
        goto LABEL_20;
