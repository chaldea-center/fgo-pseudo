void __fastcall ServantStatusFlavorTextListViewItemDrawParam___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6C213 & 1) == 0 )
  {
    sub_1B90010(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v1);
    byte_4A6C213 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C212 & 1) == 0 )
  {
    ...
    sub_1B90010(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v6);
    sub_1B90010(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v7);
...
LABEL_15:
    ...
    sub_1B9026C(transformNameSprite, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C211 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantLimitMaster___, item);
    sub_1B90010(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v5);
    ...
    this = (ServantStatusFlavorTextListViewItemDrawParam_o *)sub_1B90010(&StringLiteral_1/*""*/, v9);
    byte_4A6C211 = 1;
  }
  entity = 0LL;
  if ( !item )
    ...
    if ( entity )
    {
      ...
      if ( entity )
      {
        ...
        if ( entity )
        {
          ...
          this = (ServantStatusFlavorTextListViewItemDrawParam_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( this )
          {
