void __fastcall ServantStatusFlavorTextListViewItemDrawParam___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB26B7 & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v1);
    byte_4AB26B7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB26B6 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v6);
    sub_1BAB41C(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v7);
...
LABEL_15:
    ...
    sub_1BAB678(transformNameSprite, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB26B5 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_ServantLimitMaster___, item);
    sub_1BAB41C(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v5);
    ...
    this = (ServantStatusFlavorTextListViewItemDrawParam_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v9);
    byte_4AB26B5 = 1;
  }
  entity = 0LL;
  if ( !item )
    ...
    if ( entity )
    {
      ...
      if ( entity )
      {
        ...
        if ( entity )
        {
          ...
          this = (ServantStatusFlavorTextListViewItemDrawParam_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( this )
          {
