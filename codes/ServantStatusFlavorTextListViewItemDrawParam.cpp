void __fastcall ServantStatusFlavorTextListViewItemDrawParam___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B339F4 & 1) == 0 )
  {
    sub_1BD3458(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v1);
    byte_4B339F4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B339F3 & 1) == 0 )
  {
    ...
    sub_1BD3458(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v6);
    sub_1BD3458(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v7);
...
LABEL_15:
    ...
    sub_1BD36B4(transformNameSprite, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B339F2 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_ServantLimitMaster___, item);
    sub_1BD3458(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v5);
    ...
    this = (ServantStatusFlavorTextListViewItemDrawParam_o *)sub_1BD3458(&StringLiteral_1/*""*/, v9);
    byte_4B339F2 = 1;
  }
  entity = 0LL;
  if ( !item )
    ...
    if ( entity )
    {
      ...
      if ( entity )
      {
        ...
        if ( entity )
        {
          ...
          this = (ServantStatusFlavorTextListViewItemDrawParam_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( this )
          {
