void __fastcall ServantStatusFlavorTextListViewItemDrawParam___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F893C & 1) == 0 )
  {
    sub_1B640C8(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v1);
    byte_49F893C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F893B & 1) == 0 )
  {
    ...
    sub_1B640C8(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v6);
    sub_1B640C8(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F893A & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_ServantLimitMaster___, item);
    sub_1B640C8(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v5);
    sub_1B640C8(&DataManager_TypeInfo, v6);
    sub_1B640C8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v7);
    sub_1B640C8(&string_TypeInfo, v8);
    this = (ServantStatusFlavorTextListViewItemDrawParam_o *)sub_1B640C8(&StringLiteral_1/*""*/, v9);
    byte_49F893A = 1;
  }
  entity = 0LL;
  if ( !item )
    ...
    if ( entity )
    {
      ...
      if ( entity )
      {
        ...
        if ( entity )
        {
          ...
          this = (ServantStatusFlavorTextListViewItemDrawParam_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( this )
          {
