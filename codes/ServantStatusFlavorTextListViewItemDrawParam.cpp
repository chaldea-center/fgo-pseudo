void __fastcall ServantStatusFlavorTextListViewItemDrawParam___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49B7493 & 1) == 0 )
  {
    sub_1B4CF90(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v1);
    byte_49B7493 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B7492 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v6);
    sub_1B4CF90(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v7);
...
LABEL_15:
    ...
    sub_1B4D1EC(transformNameSprite, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B7491 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_ServantLimitMaster___, item);
    sub_1B4CF90(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v5);
    ...
    this = (ServantStatusFlavorTextListViewItemDrawParam_o *)sub_1B4CF90(&StringLiteral_1/*""*/, v9);
    byte_49B7491 = 1;
  }
  entity = 0LL;
  if ( !item )
    ...
    if ( entity )
    {
      ...
      if ( entity )
      {
        ...
        if ( entity )
        {
          ...
          this = (ServantStatusFlavorTextListViewItemDrawParam_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( this )
          {
