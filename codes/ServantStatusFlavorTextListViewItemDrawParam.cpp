void __fastcall ServantStatusFlavorTextListViewItemDrawParam___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1E65A & 1) == 0 )
  {
    sub_1C3B764(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v1);
    byte_4C1E65A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E659 & 1) == 0 )
  {
    ...
    sub_1C3B764(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v6);
    sub_1C3B764(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v7);
...
LABEL_15:
    ...
    sub_1C3B9C0(transformNameSprite, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E658 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_ServantLimitMaster___, item);
    sub_1C3B764(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v5);
    ...
    this = (ServantStatusFlavorTextListViewItemDrawParam_o *)sub_1C3B764(&StringLiteral_1/*""*/, v9);
    byte_4C1E658 = 1;
  }
  entity = 0LL;
  if ( !item )
    ...
    if ( entity )
    {
      ...
      if ( entity )
      {
        ...
        if ( entity )
        {
          ...
          this = (ServantStatusFlavorTextListViewItemDrawParam_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( this )
          {
