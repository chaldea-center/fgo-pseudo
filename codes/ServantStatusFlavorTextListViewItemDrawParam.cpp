void __fastcall ServantStatusFlavorTextListViewItemDrawParam___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B12A6A & 1) == 0 )
  {
    sub_1BCA7E0(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v1, v2);
    byte_4B12A6A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B12A69 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, v7, v8);
    sub_1BCA7E0(&ServantStatusFlavorTextListViewItemDrawText2_TypeInfo, v9, v10);
...
LABEL_45:
  ...
  else
  {
    ...
    if ( !ServantStatusFlavorTextListViewItemDrawParam_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ServantStatusFlavorTextListViewItemDrawParam_TypeInfo, title);
    titleServantBase = (UnityEngine_GameObject_o *)this->fields.titleName;
    if ( !titleServantBase )
      goto LABEL_45;
    if ( v16 >= (float)ServantStatusFlavorTextListViewItemDrawParam_TypeInfo->static_fields->TITLE_NAME_CONDENSED_WIDTH )
    {
...
LABEL_15:
    ...
    sub_1BCAA3C(transformNameSprite, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  struct ServantLimitEntity_o *v17; // x8
  struct ServantLimitEntity_o *v18; // x8
  struct ServantLimitEntity_o *v19; // x8
  ...
  struct ServantLimitEntity_o *v38; // x8
  struct ServantLimitEntity_o *v39; // x8
  struct ServantLimitEntity_o *v40; // x8
  struct ServantLimitEntity_o *v41; // x8
  ServantLimitAddEntity_o *entity; // [xsp+8h] [xbp-38h] BYREF

  v4 = (ServantStatusFlavorTextListViewItemDrawParam_o **)this;
  if ( (byte_4B12A68 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_DataManager_GetMasterData_ServantLimitMaster___, item, method);
    sub_1BCA7E0(&Method_DataManager_GetMaster_ServantLimitAddMaster___, v5, v6);
    sub_1BCA7E0(&DataManager_TypeInfo, v7, v8);
    sub_1BCA7E0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9, v10);
    sub_1BCA7E0(&string_TypeInfo, v11, v12);
    this = (ServantStatusFlavorTextListViewItemDrawParam_o *)sub_1BCA7E0(&StringLiteral_1/*""*/, v13, v14);
    byte_4B12A68 = 1;
  }
  entity = 0LL;
  if ( !item )
  ...
  if ( item->fields._IsTransformed_k__BackingField )
  {
    ...
    ServantStatusParameterGauge__Set(
      ...
      0LL);
    v16 = item->fields.transformedServantLimitEntity;
    if ( !v16 )
      goto LABEL_48;
    this = v4[7];
    if ( !this )
      goto LABEL_48;
    ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 1, v16->fields.defense, 0LL);
    v17 = item->fields.transformedServantLimitEntity;
    if ( !v17 )
      goto LABEL_48;
    this = v4[8];
    if ( !this )
      goto LABEL_48;
    ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 2, v17->fields.agility, 0LL);
    v18 = item->fields.transformedServantLimitEntity;
    if ( !v18 )
      goto LABEL_48;
    this = v4[9];
    if ( !this )
      goto LABEL_48;
    ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 3, v18->fields.magic, 0LL);
    v19 = item->fields.transformedServantLimitEntity;
    if ( !v19 )
      goto LABEL_48;
    this = v4[10];
    if ( !this )
      goto LABEL_48;
    ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 4, v19->fields.luck, 0LL);
    v20 = item->fields.transformedServantLimitEntity;
    if ( !v20 )
      goto LABEL_48;
    goto LABEL_44;
  }
  ...
  this = (ServantStatusFlavorTextListViewItemDrawParam_o *)ServantStatusListViewItem__get_SvtId(item, v23);
  if ( !Master_object )
    goto LABEL_48;
         ...
         0LL) )
  {
    ...
    if ( entity )
    {
      ...
      if ( entity )
      {
        ...
        if ( entity )
        {
          v27 = paramLimitCount >= 11 ? 0 : paramLimitCount;
          ServantParameterLimitCount = ServantLimitAddEntity__GetServantParameterLimitCount(entity, v27, 0LL);
          this = (ServantStatusFlavorTextListViewItemDrawParam_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37DEB14 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( this )
          {
            MasterData_object = DataManager__GetMasterData_object_(
                                  (DataManager_o *)this,
                                  (const MethodInfo_2F12C90 *)Method_DataManager_GetMasterData_ServantLimitMaster___);
            this = (ServantStatusFlavorTextListViewItemDrawParam_o *)ServantStatusListViewItem__get_SvtId(item, v30);
...
LABEL_48:
  ...
  v38 = item->fields.svtLimitEntity;
  if ( !v38 )
    goto LABEL_48;
  this = v4[7];
  if ( !this )
    goto LABEL_48;
  ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 1, v38->fields.defense, 0LL);
  v39 = item->fields.svtLimitEntity;
  if ( !v39 )
    goto LABEL_48;
  this = v4[8];
  if ( !this )
    goto LABEL_48;
  ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 2, v39->fields.agility, 0LL);
  v40 = item->fields.svtLimitEntity;
  if ( !v40 )
    goto LABEL_48;
  this = v4[9];
  if ( !this )
    goto LABEL_48;
  ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 3, v40->fields.magic, 0LL);
  v41 = item->fields.svtLimitEntity;
  if ( !v41 )
    goto LABEL_48;
  this = v4[10];
  if ( !this )
    goto LABEL_48;
  ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 4, v41->fields.luck, 0LL);
  v20 = item->fields.svtLimitEntity;
  if ( !v20 )
    goto LABEL_48;
LABEL_44:
  this = v4[11];
  if ( !this )
    goto LABEL_48;
  ServantStatusParameterGauge__Set((ServantStatusParameterGauge_o *)this, 5, v20->fields.treasureDevice, 0LL);
}