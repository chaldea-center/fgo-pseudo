void __fastcall FriendSearchResultMenu___ctor(FriendSearchResultMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !max_length || (v3->m_Items[1] = 95, max_length == 1) )
    sub_1C2209C(v3, v3);
  v3->m_Items[2] = 46;
  this->fields.OFFER_BUTTON_SIZE = v3;
  sub_1C21DDC(&this->fields.OFFER_BUTTON_SIZE, v3);
  ...
  *(_QWORD *)&this->fields.OFFER_TITLE_SPRITE_WIDTH = 0xC19800000000002ALL;
  ...
  sub_1C21DDC(&this->fields.searchId, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    v8 = sub_1C21DDC(p_callbackFunc, 0LL);
...
void __fastcall FriendSearchResultMenu__Close(FriendSearchResultMenu_o *this, const MethodInfo *method)
{
  ...
  FriendSearchResultMenu__Close_31860884(this, 0LL, v2);
}


void __fastcall FriendSearchResultMenu__Close_31860884(
        FriendSearchResultMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7718 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_FriendSearchResultMenu_EndClose__);
    byte_4BD7718 = 1;
  }
  ...
  System_Action___ctor(v5, (Il2CppObject *)this, Method_FriendSearchResultMenu_EndClose__, 0LL);
...
void __fastcall FriendSearchResultMenu__Init(FriendSearchResultMenu_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 0;
  v4 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1C22084(System_Collections_Generic_Dictionary_int__int__TypeInfo);
  ...
  sub_1C21DDC(&this->fields.classBoardMaxNumDictionary, v4);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  titleLabel = (UILabel_o *)DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_ClassBoardBaseMaster___);
...
LABEL_14:
    ...
    {
LABEL_21:
      v15 = sub_1C73E18(Enumerator, System_Collections_Generic_IEnumerator_ClassBoardBaseEntity__TypeInfo, 0LL);
    }
    ...
    if ( OtherThanNoneEntity )
    {
      if ( !*p_classBoardMaxNumDictionary )
        sub_1C22094(OtherThanNoneEntity, v20);
...
void __fastcall FriendSearchResultMenu__OnClickCancel(FriendSearchResultMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD771A & 1) == 0 )
  {
    sub_1C21E38(&Method_FriendSearchResultMenu_OnClickCancel__);
    byte_4BD771A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendSearchResultMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_FriendSearchResultMenu_OnClickCancel__);
...
void __fastcall FriendSearchResultMenu__OnClickDecide(FriendSearchResultMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7719 & 1) == 0 )
  {
    sub_1C21E38(&Method_FriendSearchResultMenu_OnClickDecide__);
    byte_4BD7719 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendSearchResultMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_FriendSearchResultMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
...
void __fastcall FriendSearchResultMenu__OnClickFollow(FriendSearchResultMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD771C & 1) == 0 )
  {
    sub_1C21E38(&Method_FriendSearchResultMenu_OnClickFollow__);
    byte_4BD771C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendSearchResultMenu_OnClickFollow__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_FriendSearchResultMenu_OnClickFollow__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7717 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_FriendSearchResultMenu_EndOpen__);
    sub_1C21E38(&Method_FriendSearchResultMenu_changeClass__);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&StringLiteral_17772/*"btn_bg_26_2"*/);
    sub_1C21E38(&StringLiteral_6700/*"FRIEND_SEARCH_RESULT_TITLE"*/);
    byte_4BD7717 = 1;
  }
  classButtonControl = this->fields.classButtonControl;
  v10 = (ClassButtonControlComponent_CallbackFunc_o *)sub_1C22084(ClassButtonControlComponent_CallbackFunc_TypeInfo);
  ...
  if ( state == 3 )
  {
    ...
    p_callbackFunc = &this->fields.callbackFunc;
    sub_1C21DDC(p_callbackFunc, callback);
  ...
  else if ( !state )
  {
    ...
    friendIcon = (ClassButtonControlComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6700/*"FRIEND_SEARCH_RESULT_TITLE"*/, 0LL);
    if ( titleLabel )
    {
...
LABEL_37:
        ...
        if ( OFFER_BUTTON_SIZE )
        {
          ...
          v19 = this->fields.OFFER_BUTTON_SIZE;
          if ( !v19 )
            goto LABEL_40;
          if ( v19->max_length <= 1 )
            goto LABEL_41;
          ...
          if ( !friendIcon )
            goto LABEL_40;
          UIWidget__set_height((UIWidget_o *)friendIcon, v19->m_Items[2], 0LL);
          ...
          GameObjectExtensions__SetLocalPosition_34797564(gameObject, this->fields.OFFER_MARK_POS, 0LL);
          friendIcon = (ClassButtonControlComponent_o *)this->fields.decideButton;
          if ( !friendIcon )
            goto LABEL_40;
          v21 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)friendIcon, 0LL);
          GameObjectExtensions__SetLocalPositionX(v21, 413.5, 0LL);
          friendIcon = (ClassButtonControlComponent_o *)AtlasManager__SetDownloadCommonSprite(
                                                          this->fields.followBackSprite,
                                                          (System_String_o *)StringLiteral_17772/*"btn_bg_26_2"*/,
                                                          0LL);
          v22 = this->fields.OFFER_BUTTON_SIZE;
          if ( !v22 )
            goto LABEL_40;
          if ( !v22->max_length )
            goto LABEL_41;
          ...
          if ( !friendIcon )
            goto LABEL_40;
          UIWidget__set_width((UIWidget_o *)friendIcon, v22->m_Items[1], 0LL);
          v23 = this->fields.OFFER_BUTTON_SIZE;
          if ( !v23 )
            goto LABEL_40;
          if ( v23->max_length <= 1 )
LABEL_41:
            sub_1C2209C(friendIcon, v12);
          friendIcon = (ClassButtonControlComponent_o *)this->fields.followBackSprite;
          if ( friendIcon )
          {
            UIWidget__set_height((UIWidget_o *)friendIcon, v23->m_Items[2], 0LL);
            friendIcon = (ClassButtonControlComponent_o *)this->fields.followButton;
            if ( friendIcon )
            {
              v24 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)friendIcon, 0LL);
              GameObjectExtensions__SetLocalPositionX(v24, 413.5, 0LL);
              goto LABEL_37;
            }
          }
        }
        ...
        const MethodInfo *method)
{
  ...
  v11 = (FriendSearchResultMenu_o *)sub_1C22354(v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_FriendSearchResultMenu_changeClass__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C21E50(Method_FriendSearchResultMenu_changeClass__);
  ...
  if ( otherUserGameEntity )
  {
    ...
    if ( !classButtonControl || (friendIcon = this->fields.friendIcon) == 0LL )
      sub_1C22094(friendIcon, otherUserGameEntity);
    FriendIconComponent__Set(
      friendIcon,
      otherUserGameEntity,
      1,
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5BADC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5BA84;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD771E & 1) == 0 )
  {
    ...
    sub_1C21E38(&FriendRootComponent_OfferState_TypeInfo);
    byte_4BD771E = 1;
  }
  v13[2] = 0LL;
  v13[0] = j_il2cpp_value_box_0(FriendRootComponent_OfferState_TypeInfo, &v15, *(_QWORD *)&classPos, callback, object);
