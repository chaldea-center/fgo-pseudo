void EventBannerWindowScrollItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB2BBE & 1) == 0 )
  {
    sub_1C6BA08(&EventBannerWindowScrollItem_TypeInfo);
    sub_1C6BA08(&StringLiteral_17042/*"banner_loading"*/);
    byte_4CB2BBE = 1;
  }
  EventBannerWindowScrollItem_TypeInfo->static_fields->DEFAULT_SP_NAME = (struct System_String_o *)StringLiteral_17042/*"banner_loading"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)EventBannerWindowScrollItem_TypeInfo->static_fields, StringLiteral_17042/*"banner_loading"*/, v1, v2);
}
...
bool EventBannerWindowScrollItem__IsGrayOut(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB2BBD & 1) == 0 )
  {
    ...
    this = (EventBannerWindowScrollItem_o *)sub_1C6BA08(&TitleInfoControl_TypeInfo);
    byte_4CB2BBD = 1;
  }
  ...
  if ( !mEventEndTimeInfo->fields.is_reward && mEventEndTimeInfo->fields.is_shop_closed )
    return 1;
  this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)this,
                              (const MethodInfo_313B368 *)Method_DataManager_GetMasterData_EventDetailMaster___),
        (this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
...
LABEL_24:
  ...
  if ( v7 && Entity )
  {
    ...
    return !TitleInfoControl__IsEnableEventShopButton_40140312((EventDetailEntity_o *)Entity, 0)
...
void EventBannerWindowScrollItem__OnClickItem(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB2BBC & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_EventBannerWindowScrollItem___c__OnClickItem_b__9_0__);
    this = (EventBannerWindowScrollItem_o *)sub_1C6BA08(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_4CB2BBC = 1;
  }
  mEventEndTimeInfo = v2->fields.mEventEndTimeInfo;
  if ( !mEventEndTimeInfo )
      ...
      if ( v4 )
      {
        if ( this )
        {
          Entity = DataMasterBase_object__object__int___GetEntity(
                     ...
                     v4->fields.event_id,
                     (const MethodInfo_33F90DC *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__);
          this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          if ( Entity )
          {
            v6 = (CommonUI_o *)this;
            ...
            if ( !v9 )
            {
              ...
              sub_1C6B9AC((CGThumbnailListItem_o *)&static_fields->__9__9_0, (int32_t)v9, v12, v13);
            }
            if ( v6 )
            {
...
LABEL_21:
  ...
  if ( !TitleInfoControl_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TitleInfoControl_TypeInfo);
  TitleInfoControl__OnClickEventBtn_40138412(event_id, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.mEventEndTimeInfo, (int32_t)ev_end_time_inf, (int32_t)method, v3);
  ...
  if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
  {
    ...
    if ( !v21->fields.is_reward && v21->fields.is_shop_closed )
    {
      ...
      IsGrayOut = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5699/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0);
      v21 = *p_mEventEndTimeInfo;
      if ( !*p_mEventEndTimeInfo )
        goto LABEL_43;
    ...
    if ( !v21->fields.is_shop_closed )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Empty = LocalizationManager__Get((System_String_o *)StringLiteral_5702/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0);
    }
  }
  ...
  if ( *p_mEventEndTimeInfo )
  {
    ...
    if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
    {
      ...
      *p_mNoticeNumber = (struct NoticeNumberComponent_o *)v26;
      sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.mNoticeNumber, (int32_t)v26, v27, v28);
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
      if ( !*p_mNoticeNumber )
        goto LABEL_43;
      gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)IsGrayOut, 0);
      GameObjectExtensions__SafeSetParent_36361932(gameObject, this->fields.noticeNumberRoot, 0);
    }
    if ( ev_end_time_inf )
    {
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
...
void EventBannerWindowScrollItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB2BBF & 1) == 0 )
  {
    sub_1C6BA08(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_4CB2BBF = 1;
  }
  v1 = (Il2CppObject *)sub_1C6BC54(EventBannerWindowScrollItem___c_TypeInfo);
  System_Object___ctor(v1, 0);
  EventBannerWindowScrollItem___c_TypeInfo->static_fields->__9 = (struct EventBannerWindowScrollItem___c_o *)v1;
  sub_1C6B9AC((CGThumbnailListItem_o *)EventBannerWindowScrollItem___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
