void __fastcall EventBannerWindowScrollItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C6F9 & 1) == 0 )
  {
    sub_1B715CC(&EventBannerWindowScrollItem_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_17015/*"banner_loading"*/, v4);
    byte_4A1C6F9 = 1;
  }
  EventBannerWindowScrollItem_TypeInfo->static_fields->DEFAULT_SP_NAME = (struct System_String_o *)StringLiteral_17015/*"banner_loading"*/;
  sub_1B71570(
    (ServantStatusBattleListViewItem_o *)EventBannerWindowScrollItem_TypeInfo->static_fields,
    StringLiteral_17015/*"banner_loading"*/,
    v2,
    v3);
}
...
bool __fastcall EventBannerWindowScrollItem__IsGrayOut(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C6F8 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataManager_GetMasterData_EventMaster___, v3);
    ...
    this = (EventBannerWindowScrollItem_o *)sub_1B715CC(&TitleInfoControl_TypeInfo, v8);
    byte_4A1C6F8 = 1;
  }
  ...
  if ( !mEventEndTimeInfo->fields.is_reward && mEventEndTimeInfo->fields.is_shop_closed )
    return 1;
  this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)this,
                              (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_EventDetailMaster___),
        (this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
...
LABEL_24:
  ...
  if ( v13 && Entity )
  {
    ...
    return !TitleInfoControl__IsEnableEventShopButton_37051452((EventDetailEntity_o *)Entity, 0LL)
...
void __fastcall EventBannerWindowScrollItem__OnClickItem(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C6F7 & 1) == 0 )
  {
    ...
    sub_1B715CC(&TitleInfoControl_TypeInfo, v8);
    sub_1B715CC(&Method_EventBannerWindowScrollItem___c__OnClickItem_b__9_0__, v9);
    this = (EventBannerWindowScrollItem_o *)sub_1B715CC(&EventBannerWindowScrollItem___c_TypeInfo, v10);
    byte_4A1C6F7 = 1;
  }
  mEventEndTimeInfo = v2->fields.mEventEndTimeInfo;
  if ( !mEventEndTimeInfo )
      ...
      if ( v12 )
      {
        if ( this )
        {
          Entity = DataMasterBase_object__object__int___GetEntity(
                     ...
                     v12->fields.event_id,
                     (const MethodInfo_30F8760 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__);
          this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          if ( Entity )
          {
            v14 = (CommonUI_o *)this;
            ...
            if ( !v17 )
            {
              ...
              sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__9_0, (int32_t)v17, v20, v21);
            }
            if ( v14 )
            {
...
LABEL_21:
  ...
  if ( !TitleInfoControl_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TitleInfoControl_TypeInfo);
  TitleInfoControl__OnClickEventBtn_37049564(event_id, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C6F6 & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, ev_end_time_inf);
    sub_1B715CC(&EventBannerWindowScrollItem_TypeInfo, v6);
    sub_1B715CC(&LocalizationManager_TypeInfo, v7);
    sub_1B715CC(&Method_UnityEngine_Object_Instantiate_NoticeNumberComponent___, v8);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v9);
    sub_1B715CC(&string_TypeInfo, v10);
    sub_1B715CC(&StringLiteral_5684/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, v11);
    sub_1B715CC(&StringLiteral_5687/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, v12);
    byte_4A1C6F6 = 1;
  }
  ...
  if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
  {
    ...
    if ( !v28->fields.is_reward && v28->fields.is_shop_closed )
    {
      ...
      IsGrayOut = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5684/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0LL);
      v28 = *p_mEventEndTimeInfo;
      if ( !*p_mEventEndTimeInfo )
        goto LABEL_43;
    ...
    if ( !v28->fields.is_shop_closed )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Empty = LocalizationManager__Get((System_String_o *)StringLiteral_5687/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0LL);
    }
  }
  ...
  if ( *p_mEventEndTimeInfo )
  {
    ...
    if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
    {
      ...
      *p_mNoticeNumber = (struct NoticeNumberComponent_o *)v33;
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mNoticeNumber, (int32_t)v33, v34, v35);
      ...
      GameObjectExtensions__SafeSetParent_33535352(gameObject, this->fields.noticeNumberRoot, 0LL);
    }
    if ( ev_end_time_inf )
    {
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
...
void __fastcall EventBannerWindowScrollItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C6FA & 1) == 0 )
  {
    sub_1B715CC(&EventBannerWindowScrollItem___c_TypeInfo, v1);
    byte_4A1C6FA = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(EventBannerWindowScrollItem___c_TypeInfo);
