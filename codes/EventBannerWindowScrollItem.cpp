void __fastcall EventBannerWindowScrollItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B2664 & 1) == 0 )
  {
    sub_B52984(&EventBannerWindowScrollItem_TypeInfo);
    sub_B52984(&StringLiteral_16720/*"banner_loading"*/);
    byte_42B2664 = 1;
  }
  static_fields = (BattleServantConfConponent_o *)EventBannerWindowScrollItem_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_16720/*"banner_loading"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_16720/*"banner_loading"*/;
...
bool __fastcall EventBannerWindowScrollItem__IsGrayOut(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2663 & 1) == 0 )
  {
    ...
    this = (EventBannerWindowScrollItem_o *)sub_B52984(&TitleInfoControl_TypeInfo);
    byte_42B2663 = 1;
  }
  ...
  if ( !mEventEndTimeInfo->fields.is_reward && mEventEndTimeInfo->fields.is_shop_closed )
    return 1;
  this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (MasterData_WarQuestSelectionMaster = (DataMasterBase_WarMaster__WarEntity__int__o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                                                                              (DataManager_o *)this,
                                                                                              (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_EventDetailMaster___),
        (this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
...
LABEL_27:
  ...
  if ( v7 && Entity )
  {
    ...
    return !TitleInfoControl__IsEnableEventShopButton_18398208(Entity, 0LL) || Time >= v7->fields.finishedAt;
  }
  return result;
}
...
void __fastcall EventBannerWindowScrollItem__OnClickItem(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2662 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_EventBannerWindowScrollItem___c__OnClickItem_b__9_0__);
    this = (EventBannerWindowScrollItem_o *)sub_B52984(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_42B2662 = 1;
  }
  mEventEndTimeInfo = v2->fields.mEventEndTimeInfo;
  if ( !mEventEndTimeInfo )
      ...
      if ( v4 )
      {
        if ( this )
        {
          Entity = DataMasterBase_WarMaster__WarEntity__int___GetEntity(
                     ...
                     v4->fields.event_id,
                     (const MethodInfo_23E22D8 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__);
          this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          if ( Entity )
          {
            v6 = (CommonUI_o *)this;
...
LABEL_23:
  ...
  TitleInfoControl__OnClickEventBtn_18396180(event_id, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2661 & 1) == 0 )
  {
    ...
    sub_B52984(&string_TypeInfo);
    sub_B52984(&StringLiteral_5753/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/);
    sub_B52984(&StringLiteral_5756/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/);
    byte_42B2661 = 1;
  }
  ...
  if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
  {
    ...
    if ( !v25->fields.is_reward && v25->fields.is_shop_closed )
    {
      ...
      IsGrayOut = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5753/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0LL);
      v25 = *p_mEventEndTimeInfo;
      if ( !*p_mEventEndTimeInfo )
        goto LABEL_50;
    ...
    if ( !v25->fields.is_shop_closed )
    {
      ...
      Empty = LocalizationManager__Get((System_String_o *)StringLiteral_5756/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0LL);
    }
  }
  ...
  if ( *p_mEventEndTimeInfo )
  {
    ...
    if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
    {
      ...
      *p_mNoticeNumber = (struct NoticeNumberComponent_o *)v30;
      sub_B52920((BattleServantConfConponent_o *)&this->fields.mNoticeNumber, v30, v31, v32, v33, v34, v35, v36);
      ...
      GameObjectExtensions__SafeSetParent_32091088(gameObject, this->fields.noticeNumberRoot, 0LL);
    }
    if ( ev_end_time_inf )
    {
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
...
void __fastcall EventBannerWindowScrollItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42AD8A9 & 1) == 0 )
  {
    sub_B52984(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_42AD8A9 = 1;
  }
  v1 = (Il2CppObject *)sub_B52A54(EventBannerWindowScrollItem___c_TypeInfo);
