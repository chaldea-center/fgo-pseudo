void EventBannerWindowScrollItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_5934DC1 & 1) == 0 )
  {
    sub_21FFC50(&EventBannerWindowScrollItem_TypeInfo);
    sub_21FFC50(&StringLiteral_17718/*"banner_loading"*/);
    byte_5934DC1 = 1;
  }
  v7 = StringLiteral_17718/*"banner_loading"*/;
  EventBannerWindowScrollItem_TypeInfo->static_fields->DEFAULT_SP_NAME = (struct System_String_o *)StringLiteral_17718/*"banner_loading"*/;
  sub_21FFBF4(
...
bool EventBannerWindowScrollItem__IsGrayOut(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5934DC0 & 1) == 0 )
  {
    ...
    this = (EventBannerWindowScrollItem_o *)sub_21FFC50(&TitleInfoControl_TypeInfo);
    byte_5934DC0 = 1;
  }
  ...
  if ( !mEventEndTimeInfo->fields.is_reward && mEventEndTimeInfo->fields.is_shop_closed )
    return 1;
  this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)this,
                              (const MethodInfo_3822EA4 *)Method_DataManager_GetMasterData_EventDetailMaster___),
        (this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
...
LABEL_25:
  ...
  if ( v7 && Entity )
  {
    ...
    return !TitleInfoControl__IsEnableEventShopButton_46896112((EventDetailEntity_o *)Entity, 0)
...
void EventBannerWindowScrollItem__OnClickItem(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5934DBF & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_EventBannerWindowScrollItem___c__OnClickItem_b__9_0__);
    this = (EventBannerWindowScrollItem_o *)sub_21FFC50(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_5934DBF = 1;
  }
      ...
      if ( v5 )
      {
        if ( this )
        {
          Entity = DataMasterBase_object__object__int___GetEntity(
                     ...
                     v5->fields.event_id,
                     (const MethodInfo_3EDD388 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__);
          this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          if ( Entity )
          {
            v8 = (CommonUI_o *)this;
...
LABEL_21:
  ...
  TitleInfoControl__OnClickEventBtn_46894224(event_id, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
  {
    ...
    if ( !v27->fields.is_reward && v27->fields.is_shop_closed )
    {
      ...
      IsGrayOut = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5928/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/, 0);
      v27 = *p_mEventEndTimeInfo;
      if ( !*p_mEventEndTimeInfo )
        goto LABEL_43;
    ...
    if ( !v27->fields.is_shop_closed )
    {
      if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v11, v26);
      v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5931/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/, 0);
    }
  }
  ...
  if ( *p_mEventEndTimeInfo )
  {
    ...
    if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
    {
      ...
      *p_mNoticeNumber = (struct NoticeNumberComponent_o *)v36;
      ...
      GameObjectExtensions__SafeSetParent_42881912(gameObject, this->fields.noticeNumberRoot, 0);
    }
    if ( ev_end_time_inf )
    {
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
...
void EventBannerWindowScrollItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_5934DC2 & 1) == 0 )
  {
    sub_21FFC50(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_5934DC2 = 1;
  }
  v1 = (Il2CppObject *)sub_21FFEBC(EventBannerWindowScrollItem___c_TypeInfo);
