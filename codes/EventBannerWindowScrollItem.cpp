void EventBannerWindowScrollItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3F8D3 & 1) == 0 )
  {
    sub_1C37058(&EventBannerWindowScrollItem_TypeInfo);
    sub_1C37058(&StringLiteral_17029/*"banner_loading"*/);
    byte_4C3F8D3 = 1;
  }
  EventBannerWindowScrollItem_TypeInfo->static_fields->DEFAULT_SP_NAME = (struct System_String_o *)StringLiteral_17029/*"banner_loading"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)EventBannerWindowScrollItem_TypeInfo->static_fields, StringLiteral_17029/*"banner_loading"*/, v1, v2);
}
...
bool EventBannerWindowScrollItem__IsGrayOut(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F8D2 & 1) == 0 )
  {
    ...
    this = (EventBannerWindowScrollItem_o *)sub_1C37058(&TitleInfoControl_TypeInfo);
    byte_4C3F8D2 = 1;
  }
  ...
  if ( !mEventEndTimeInfo->fields.is_reward && mEventEndTimeInfo->fields.is_shop_closed )
    return 1;
  this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)this,
                              (const MethodInfo_30E7C58 *)Method_DataManager_GetMasterData_EventDetailMaster___),
        (this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
...
LABEL_24:
  ...
  if ( v7 && Entity )
  {
    ...
    return !TitleInfoControl__IsEnableEventShopButton_39912232((EventDetailEntity_o *)Entity, 0)
...
void EventBannerWindowScrollItem__OnClickItem(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F8D1 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_EventBannerWindowScrollItem___c__OnClickItem_b__9_0__);
    this = (EventBannerWindowScrollItem_o *)sub_1C37058(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_4C3F8D1 = 1;
  }
  mEventEndTimeInfo = v2->fields.mEventEndTimeInfo;
  if ( !mEventEndTimeInfo )
      ...
      if ( v4 )
      {
        if ( this )
        {
          Entity = DataMasterBase_object__object__int___GetEntity(
                     ...
                     v4->fields.event_id,
                     (const MethodInfo_33A10A0 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__);
          this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          if ( Entity )
          {
            v6 = (CommonUI_o *)this;
            ...
            if ( !v9 )
            {
              ...
              sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->__9__9_0, (int32_t)v9, v12, v13);
            }
            if ( v6 )
            {
...
LABEL_21:
  ...
  if ( !TitleInfoControl_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TitleInfoControl_TypeInfo);
  TitleInfoControl__OnClickEventBtn_39910332(event_id, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F8D0 & 1) == 0 )
  {
    ...
    sub_1C37058(&string_TypeInfo);
    sub_1C37058(&StringLiteral_5709/*"EVENT_SHOP_BANNER_CLOSED_MSG"*/);
    sub_1C37058(&StringLiteral_5712/*"EVENT_SHOP_BANNER_LOCKED_MSG"*/);
    byte_4C3F8D0 = 1;
  }
  this->fields.mEventEndTimeInfo = ev_end_time_inf;
  p_mEventEndTimeInfo = &this->fields.mEventEndTimeInfo;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mEventEndTimeInfo, (int32_t)ev_end_time_inf, (int32_t)method, v3);
  ...
  if ( *p_mEventEndTimeInfo )
  {
    ...
    if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
    {
      ...
      *p_mNoticeNumber = (struct NoticeNumberComponent_o *)v25;
      sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mNoticeNumber, (int32_t)v25, v26, v27);
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
      if ( !*p_mNoticeNumber )
        goto LABEL_43;
      gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)IsGrayOut, 0);
      GameObjectExtensions__SafeSetParent_36138184(gameObject, this->fields.noticeNumberRoot, 0);
    }
    if ( ev_end_time_inf )
    {
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
...
void EventBannerWindowScrollItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3F8D4 & 1) == 0 )
  {
    sub_1C37058(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_4C3F8D4 = 1;
  }
  v1 = (Il2CppObject *)sub_1C372A4(EventBannerWindowScrollItem___c_TypeInfo);
  System_Object___ctor(v1, 0);
  EventBannerWindowScrollItem___c_TypeInfo->static_fields->__9 = (struct EventBannerWindowScrollItem___c_o *)v1;
  sub_1C36FFC((CGThumbnailListItem_o *)EventBannerWindowScrollItem___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
