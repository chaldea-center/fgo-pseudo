void __fastcall EventBannerWindowScrollItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_43550A8 & 1) == 0 )
  {
    sub_B70694(&EventBannerWindowScrollItem_TypeInfo);
    sub_B70694(&StringLiteral_16849/*"banner_loading"*/);
    byte_43550A8 = 1;
  }
  static_fields = (BattleServantConfConponent_o *)EventBannerWindowScrollItem_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_16849/*"banner_loading"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_16849/*"banner_loading"*/;
...
bool __fastcall EventBannerWindowScrollItem__IsGrayOut(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_43550A7 & 1) == 0 )
  {
    ...
    this = (EventBannerWindowScrollItem_o *)sub_B70694(&TitleInfoControl_TypeInfo);
    byte_43550A7 = 1;
  }
  ...
  if ( !mEventEndTimeInfo->fields.is_reward && mEventEndTimeInfo->fields.is_shop_closed )
    return 1;
  this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
    || (MasterData_WarQuestSelectionMaster = (DataMasterBase_WarMaster__WarEntity__int__o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                                                                              (DataManager_o *)this,
                                                                                              (const MethodInfo_1CA35A0 *)Method_DataManager_GetMasterData_EventDetailMaster___),
        (this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
...
LABEL_27:
  ...
  if ( v7 && Entity )
  {
    ...
    return !TitleInfoControl__IsEnableEventShopButton_18661980(Entity, 0LL) || Time >= v7->fields.finishedAt;
  }
  return result;
}
...
void __fastcall EventBannerWindowScrollItem__OnClickItem(EventBannerWindowScrollItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_43550A6 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_EventBannerWindowScrollItem___c__OnClickItem_b__9_0__);
    this = (EventBannerWindowScrollItem_o *)sub_B70694(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_43550A6 = 1;
  }
  mEventEndTimeInfo = v2->fields.mEventEndTimeInfo;
  if ( !mEventEndTimeInfo )
      ...
      if ( v4 )
      {
        if ( this )
        {
          Entity = DataMasterBase_WarMaster__WarEntity__int___GetEntity(
                     ...
                     v4->fields.event_id,
                     (const MethodInfo_21C0440 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__);
          this = (EventBannerWindowScrollItem_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
          if ( Entity )
          {
            v6 = (CommonUI_o *)this;
...
LABEL_23:
  ...
  TitleInfoControl__OnClickEventBtn_18659952(event_id, 0LL);
}
  ...
  if ( *p_mEventEndTimeInfo )
  {
    ...
    if ( ((unsigned __int8)IsGrayOut & 1) != 0 )
    {
      ...
      *p_mNoticeNumber = (struct NoticeNumberComponent_o *)v30;
      sub_B70630((BattleServantConfConponent_o *)&this->fields.mNoticeNumber, v30, v31, v32, v33, v34, v35, v36);
      ...
      GameObjectExtensions__SafeSetParent_32503456(gameObject, this->fields.noticeNumberRoot, 0LL);
    }
    if ( ev_end_time_inf )
    {
      IsGrayOut = (UILabel_o *)*p_mNoticeNumber;
...
void __fastcall EventBannerWindowScrollItem___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_434F033 & 1) == 0 )
  {
    sub_B70694(&EventBannerWindowScrollItem___c_TypeInfo);
    byte_434F033 = 1;
  }
  v1 = (Il2CppObject *)sub_B70764(EventBannerWindowScrollItem___c_TypeInfo);
