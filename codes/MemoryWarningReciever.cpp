...
void MemoryWarningReciever__Awake(MemoryWarningReciever_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596FF88 & 1) == 0 )
  {
    ...
    sub_2213A60(&UnityEngine_Application_LowMemoryCallback_TypeInfo);
    sub_2213A60(&Method_MemoryWarningReciever_DidReceiveMemoryWarning__);
    byte_596FF88 = 1;
  }
  v3 = (UnityEngine_Application_LowMemoryCallback_o *)sub_2213CCC(UnityEngine_Application_LowMemoryCallback_TypeInfo);
  ...
  v5 = (UnityEngine_Application_LowMemoryCallback_o *)sub_2213CCC(UnityEngine_Application_LowMemoryCallback_TypeInfo);
  UnityEngine_Application_LowMemoryCallback___ctor(
    v5,
    (Il2CppObject *)this,
    Method_MemoryWarningReciever_DidReceiveMemoryWarning__,
