...
void __fastcall MemoryWarningReciever__Awake(MemoryWarningReciever_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF9FA & 1) == 0 )
  {
    sub_B52984(&UnityEngine_Application_LowMemoryCallback_TypeInfo);
    sub_B52984(&Method_MemoryWarningReciever_DidReceiveMemoryWarning__);
    byte_42AF9FA = 1;
  }
  v3 = (UnityEngine_Application_LowMemoryCallback_o *)sub_B52A54(UnityEngine_Application_LowMemoryCallback_TypeInfo);
  ...
  v4 = (UnityEngine_Application_LowMemoryCallback_o *)sub_B52A54(UnityEngine_Application_LowMemoryCallback_TypeInfo);
  UnityEngine_Application_LowMemoryCallback___ctor(
    v4,
    (Il2CppObject *)this,
    Method_MemoryWarningReciever_DidReceiveMemoryWarning__,
