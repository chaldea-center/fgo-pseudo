...
void __fastcall MemoryWarningReciever__Awake(MemoryWarningReciever_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC72D2 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&UnityEngine_Application_LowMemoryCallback_TypeInfo, v3);
    sub_1C1ABD4(&Method_MemoryWarningReciever_DidReceiveMemoryWarning__, v4);
    byte_4BC72D2 = 1;
  }
  v5 = (UnityEngine_Application_LowMemoryCallback_o *)sub_1C1AE20(UnityEngine_Application_LowMemoryCallback_TypeInfo);
  ...
  v6 = (UnityEngine_Application_LowMemoryCallback_o *)sub_1C1AE20(UnityEngine_Application_LowMemoryCallback_TypeInfo);
  UnityEngine_Application_LowMemoryCallback___ctor(
    v6,
    (Il2CppObject *)this,
    Method_MemoryWarningReciever_DidReceiveMemoryWarning__,
...
void __fastcall MemoryWarningReciever__DidReceiveMemoryWarning(MemoryWarningReciever_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC72D4 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__, method);
    sub_1C1ABD4(&StringLiteral_8653/*"LowMemoryWarning"*/, v3);
    byte_4BC72D4 = 1;
  }
  if ( UnityEngine_Time__get_realtimeSinceStartup(0LL) >= this->fields.nextExecuteTime )
  {
    ...
    if ( !Instance )
      sub_1C1AE30(0LL, v7);
    CrashReporter__SendReport_30983168(
      (CrashReporter_o *)Instance,
      (System_String_o *)StringLiteral_8653/*"LowMemoryWarning"*/,
      0LL,
      0LL,
      0LL);
  }
...
void __fastcall MemoryWarningReciever__GabageCollection(MemoryWarningReciever_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC72D5 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_AssetManager__get_Instance__, v2);
    byte_4BC72D5 = 1;
  }
