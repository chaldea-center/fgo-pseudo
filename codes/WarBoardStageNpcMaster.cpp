void __fastcall WarBoardStageNpcMaster___ctor(WarBoardStageNpcMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2EF66 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_WarBoardStageNpcMaster__WarBoardStageNpcEntity__string___ctor__, method);
    byte_4A2EF66 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    327,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_WarBoardStageNpcMaster__WarBoardStageNpcEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (WarBoardStageNpcEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                       (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                       PK,
                                       (const MethodInfo_30FFAD8 *)Method_DataMasterBase_WarBoardStageNpcMaster__WarBoardStageNpcEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF67 & 1) == 0 )
  {
    sub_1B761C0(&WarBoardStageNpcMaster__GetWarBoardStageEntities_d__3_TypeInfo, *(_QWORD *)&stageId);
    byte_4A2EF67 = 1;
  }
  v5 = sub_1B7640C(WarBoardStageNpcMaster__GetWarBoardStageEntities_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF65 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_WarBoardStageNpcMaster__WarBoardStageNpcEntity__string__TryGetEntity__, entity);
    byte_4A2EF65 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_WarBoardStageNpcMaster__WarBoardStageNpcEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF68 & 1) == 0 )
  {
    ...
    this = (WarBoardStageNpcMaster__GetWarBoardStageEntities_d__3_o *)sub_1B761C0(&WarBoardStageNpcEntity_TypeInfo, v4);
    byte_4A2EF68 = 1;
  }
    ...
    while ( (int)method < (int)this )
    {
      ...
      if ( Item )
      {
          ...
          && LODWORD(Item[1].klass) == v2->fields.stageId )
        {
          ...
          sub_1B76164(p__2__current, (int32_t)Item, v8, v9);
          result = 1;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF69 & 1) == 0 )
  {
    sub_1B761C0(&WarBoardStageNpcMaster__GetWarBoardStageEntities_d__3_TypeInfo, method);
    byte_4A2EF69 = 1;
  }
  ...
  {
    v4 = (WarBoardStageNpcMaster__GetWarBoardStageEntities_d__3_o *)sub_1B7640C(WarBoardStageNpcMaster__GetWarBoardStageEntities_d__3_TypeInfo);
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&v4->fields.__4__this, (int32_t)_4__this, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_WarBoardStageNpcMaster__GetWarBoardStageEntities_d__3_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
