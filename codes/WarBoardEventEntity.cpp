...
System_Int32_array *WarBoardEventEntity__GetSquareIndicesToAdd(WarBoardEventEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CC8578 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_16695/*"addSquareIndex"*/);
    byte_4CC8578 = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_16695/*"addSquareIndex"*/, 0, 0);
}
...
bool WarBoardEventEntity__IsIncludeInvolvedAttacker(WarBoardEventEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CC8579 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_20824/*"includeInvolvedAttacker"*/);
    byte_4CC8579 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20824/*"includeInvolvedAttacker"*/, 0, 0) == 1;
}
...
bool WarBoardEventEntity__IsIncludeInvolvedDefender(WarBoardEventEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CC857A & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_20825/*"includeInvolvedDefender"*/);
    byte_4CC857A = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20825/*"includeInvolvedDefender"*/, 0, 0) == 1;
}
