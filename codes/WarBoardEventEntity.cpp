        ...
        const MethodInfo *method)
{
  if ( (byte_4A20A3C & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_16625/*"addSquareIndex"*/, method);
    byte_4A20A3C = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_16625/*"addSquareIndex"*/, 0LL, 0LL);
}
...
bool __fastcall WarBoardEventEntity__IsIncludeInvolvedAttacker(WarBoardEventEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A20A3D & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_20560/*"includeInvolvedAttacker"*/, method);
    byte_4A20A3D = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20560/*"includeInvolvedAttacker"*/, 0, 0LL) == 1;
}
...
bool __fastcall WarBoardEventEntity__IsIncludeInvolvedDefender(WarBoardEventEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A20A3E & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_20561/*"includeInvolvedDefender"*/, method);
    byte_4A20A3E = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20561/*"includeInvolvedDefender"*/, 0, 0LL) == 1;
}
