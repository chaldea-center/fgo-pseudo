        ...
        const MethodInfo *method)
{
  if ( (byte_4BFE77E & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_16968/*"addSquareIndex"*/, method);
    byte_4BFE77E = 1;
  }
  return EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_16968/*"addSquareIndex"*/, 0LL, 0LL);
}
...
bool __fastcall WarBoardEventEntity__IsIncludeInvolvedAttacker(WarBoardEventEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BFE77F & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_20997/*"includeInvolvedAttacker"*/, method);
    byte_4BFE77F = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20997/*"includeInvolvedAttacker"*/, 0, 0LL) == 1;
}
...
bool __fastcall WarBoardEventEntity__IsIncludeInvolvedDefender(WarBoardEventEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BFE780 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_20998/*"includeInvolvedDefender"*/, method);
    byte_4BFE780 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_20998/*"includeInvolvedDefender"*/, 0, 0LL) == 1;
}
