        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7247A & 1) == 0 )
  {
    sub_1B90010(&PlayFieldMotionBattleLogicTask_TypeInfo, buff);
    sub_1B90010(&UpdateAllViewBattleLogicTask_TypeInfo, v7);
    sub_1B90010(&StringLiteral_8740/*"MOTION_UPDATE_FIELD"*/, v8);
    byte_4A7247A = 1;
  }
  ...
  v11 = (UpdateAllViewBattleLogicTask_o *)sub_1B9025C(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v14 = (PlayFieldMotionBattleLogicTask_o *)sub_1B9025C(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v14, (System_String_o *)StringLiteral_8740/*"MOTION_UPDATE_FIELD"*/, 0, 0LL);
      if ( v13 )
      {
...
LABEL_11:
      sub_1B9026C(FieldEnvData_k__BackingField, buff);
    }
  }
}