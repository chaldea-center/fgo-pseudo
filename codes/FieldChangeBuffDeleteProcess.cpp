        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB837A & 1) == 0 )
  {
    sub_1BAB41C(&PlayFieldMotionBattleLogicTask_TypeInfo, buff);
    sub_1BAB41C(&UpdateAllViewBattleLogicTask_TypeInfo, v7);
    sub_1BAB41C(&StringLiteral_8741/*"MOTION_UPDATE_FIELD"*/, v8);
    byte_4AB837A = 1;
  }
  ...
  v11 = (UpdateAllViewBattleLogicTask_o *)sub_1BAB668(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v14 = (PlayFieldMotionBattleLogicTask_o *)sub_1BAB668(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v14, (System_String_o *)StringLiteral_8741/*"MOTION_UPDATE_FIELD"*/, 0, 0LL);
      if ( v13 )
      {
...
LABEL_11:
      sub_1BAB678(FieldEnvData_k__BackingField, buff);
    }
  }
}