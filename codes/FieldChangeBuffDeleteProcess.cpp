        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A2C9 & 1) == 0 )
  {
    sub_1D0F0B4(&PlayFieldMotionBattleLogicTask_TypeInfo);
    sub_1D0F0B4(&UpdateAllViewBattleLogicTask_TypeInfo);
    sub_1D0F0B4(&StringLiteral_8878/*"MOTION_UPDATE_FIELD"*/);
    byte_4E7A2C9 = 1;
  }
  ...
  v9 = (UpdateAllViewBattleLogicTask_o *)sub_1D0F300(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v12 = (PlayFieldMotionBattleLogicTask_o *)sub_1D0F300(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v12, (System_String_o *)StringLiteral_8878/*"MOTION_UPDATE_FIELD"*/, 0, 0);
      if ( v11 )
      {
...
LABEL_11:
      sub_1D0F30C(FieldEnvData_k__BackingField, buff);
    }
  }
}