        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6DD4 & 1) == 0 )
  {
    sub_1C13D24(&PlayFieldMotionBattleLogicTask_TypeInfo, buff);
    sub_1C13D24(&UpdateAllViewBattleLogicTask_TypeInfo, v7);
    sub_1C13D24(&StringLiteral_8908/*"MOTION_SHIFT_GAUGE_DOWN"*/, v8);
    byte_4BB6DD4 = 1;
  }
  ...
  v11 = (UpdateAllViewBattleLogicTask_o *)sub_1C13F70(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v14 = (PlayFieldMotionBattleLogicTask_o *)sub_1C13F70(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v14, (System_String_o *)StringLiteral_8908/*"MOTION_SHIFT_GAUGE_DOWN"*/, 0, 0LL);
      if ( v13 )
      {
...
LABEL_11:
      sub_1C13F80(FieldEnvData_k__BackingField, buff);
    }
  }
}