        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E4D04 & 1) == 0 )
  {
    sub_1B00CCC(&PlayFieldMotionBattleLogicTask_TypeInfo, buff);
    sub_1B00CCC(&UpdateAllViewBattleLogicTask_TypeInfo, v7);
    sub_1B00CCC(&StringLiteral_8635/*"MOTION_UPDATE_FIELD"*/, v8);
    byte_48E4D04 = 1;
  }
  ...
  v11 = (UpdateAllViewBattleLogicTask_o *)sub_1B00F18(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v14 = (PlayFieldMotionBattleLogicTask_o *)sub_1B00F18(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v14, (System_String_o *)StringLiteral_8635/*"MOTION_UPDATE_FIELD"*/, 0, 0LL);
      if ( v13 )
      {
...
LABEL_11:
      sub_1B00F28(FieldEnvData_k__BackingField, buff);
    }
  }
}