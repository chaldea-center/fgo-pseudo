        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA1B6 & 1) == 0 )
  {
    sub_1C1ABD4(&PlayFieldMotionBattleLogicTask_TypeInfo, buff);
    sub_1C1ABD4(&UpdateAllViewBattleLogicTask_TypeInfo, v7);
    sub_1C1ABD4(&StringLiteral_8913/*"MOTION_UPDATE_FIELD"*/, v8);
    byte_4BCA1B6 = 1;
  }
  ...
  v11 = (UpdateAllViewBattleLogicTask_o *)sub_1C1AE20(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v14 = (PlayFieldMotionBattleLogicTask_o *)sub_1C1AE20(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v14, (System_String_o *)StringLiteral_8913/*"MOTION_UPDATE_FIELD"*/, 0, 0LL);
      if ( v13 )
      {
...
LABEL_11:
      sub_1C1AE30(FieldEnvData_k__BackingField, buff);
    }
  }
}