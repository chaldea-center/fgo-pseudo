        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D33574 & 1) == 0 )
  {
    sub_1C93AD4(&PlayFieldMotionBattleLogicTask_TypeInfo);
    sub_1C93AD4(&UpdateAllViewBattleLogicTask_TypeInfo);
    sub_1C93AD4(&StringLiteral_8827/*"MOTION_UPDATE_FIELD"*/);
    byte_4D33574 = 1;
  }
  ...
  v9 = (UpdateAllViewBattleLogicTask_o *)sub_1C93D20(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v12 = (PlayFieldMotionBattleLogicTask_o *)sub_1C93D20(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v12, (System_String_o *)StringLiteral_8827/*"MOTION_UPDATE_FIELD"*/, 0, 0);
      if ( v11 )
      {
...
LABEL_11:
      sub_1C93D2C(FieldEnvData_k__BackingField, buff);
    }
  }
}