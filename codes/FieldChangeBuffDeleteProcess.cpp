        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E075ED & 1) == 0 )
  {
    sub_1CE6700(&PlayFieldMotionBattleLogicTask_TypeInfo);
    sub_1CE6700(&UpdateAllViewBattleLogicTask_TypeInfo);
    sub_1CE6700(&StringLiteral_8842/*"MOTION_UPDATE_FIELD"*/);
    byte_4E075ED = 1;
  }
  ...
  v9 = (UpdateAllViewBattleLogicTask_o *)sub_1CE694C(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v12 = (PlayFieldMotionBattleLogicTask_o *)sub_1CE694C(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v12, (System_String_o *)StringLiteral_8842/*"MOTION_UPDATE_FIELD"*/, 0, 0);
      if ( v11 )
      {
...
LABEL_11:
      sub_1CE6958(FieldEnvData_k__BackingField, buff);
    }
  }
}