        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D763 & 1) == 0 )
  {
    sub_1B885B0(&PlayFieldMotionBattleLogicTask_TypeInfo);
    sub_1B885B0(&UpdateAllViewBattleLogicTask_TypeInfo);
    sub_1B885B0(&StringLiteral_8736/*"MOTION_UPDATE_FIELD"*/);
    byte_4A5D763 = 1;
  }
  ...
  v9 = (UpdateAllViewBattleLogicTask_o *)sub_1B887FC(UpdateAllViewBattleLogicTask_TypeInfo);
  ...
  if ( isAddAfterTask )
  {
    ...
    if ( BattleFieldEnvironmentData__IsNeedChangeField(FieldEnvData_k__BackingField, (const MethodInfo *)buff) )
    {
      ...
      v12 = (PlayFieldMotionBattleLogicTask_o *)sub_1B887FC(PlayFieldMotionBattleLogicTask_TypeInfo);
      PlayFieldMotionBattleLogicTask___ctor(v12, (System_String_o *)StringLiteral_8736/*"MOTION_UPDATE_FIELD"*/, 0, 0LL);
      if ( v11 )
      {
...
LABEL_11:
      sub_1B8880C(FieldEnvData_k__BackingField, buff);
    }
  }
}