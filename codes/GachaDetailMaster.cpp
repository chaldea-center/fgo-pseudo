void __fastcall GachaDetailMaster___ctor(GachaDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB5FCE & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__, method);
    byte_4AB5FCE = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    188,
    (const MethodInfo_3163D50 *)Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5FCF & 1) == 0 )
  {
    ...
    sub_1BAB41C(&GachaDetailEntity_TypeInfo, v6);
    byte_4AB5FCF = 1;
  }
...
LABEL_14:
    sub_1BAB678(result, *(_QWORD *)&gachaID);
  }
  return 0LL;
}