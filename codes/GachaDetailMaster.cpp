void __fastcall GachaDetailMaster___ctor(GachaDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FD52 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__, method);
    byte_4A1FD52 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    188,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FD53 & 1) == 0 )
  {
    ...
    sub_1B715CC(&GachaDetailEntity_TypeInfo, v6);
    byte_4A1FD53 = 1;
  }
...
LABEL_14:
    sub_1B71828(result, *(_QWORD *)&gachaID);
  }
  return 0LL;
}