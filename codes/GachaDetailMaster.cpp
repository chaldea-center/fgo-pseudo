void __fastcall GachaDetailMaster___ctor(GachaDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A08EE6 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__, method);
    byte_4A08EE6 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    188,
    (const MethodInfo_30E4480 *)Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08EE7 & 1) == 0 )
  {
    ...
    sub_1B686D4(&GachaDetailEntity_TypeInfo, v6);
    byte_4A08EE7 = 1;
  }
...
LABEL_14:
    sub_1B68930(result, *(_QWORD *)&gachaID);
  }
  return 0LL;
}