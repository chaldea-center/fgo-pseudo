void __fastcall GachaDetailMaster___ctor(GachaDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B66E50 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__, method);
    byte_4B66E50 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    192,
    (const MethodInfo_31FD784 *)Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66E51 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&GachaDetailEntity_TypeInfo, v6);
    byte_4B66E51 = 1;
  }
...
LABEL_14:
    sub_1BE4D28(result, *(_QWORD *)&gachaID);
  }
  return 0LL;
}