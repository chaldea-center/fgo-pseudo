void __fastcall GachaDetailMaster___ctor(GachaDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B3B10 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__);
    byte_42B3B10 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    187,
    (const MethodInfo_23E223C *)Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B3B11 & 1) == 0 )
  {
    ...
    sub_B52984(&GachaDetailEntity_TypeInfo);
    byte_42B3B11 = 1;
  }
...
LABEL_14:
    sub_B52A5C(result, *(_QWORD *)&gachaID);
  }
  return 0LL;
}