void __fastcall GachaDetailMaster___ctor(GachaDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E1BF & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__, method);
    byte_4A2E1BF = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    188,
    (const MethodInfo_30FF740 *)Method_DataMasterBase_GachaDetailMaster__GachaDetailEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E1C0 & 1) == 0 )
  {
    ...
    sub_1B761C0(&GachaDetailEntity_TypeInfo, v6);
    byte_4A2E1C0 = 1;
  }
...
LABEL_14:
    sub_1B7641C(result, *(_QWORD *)&gachaID);
  }
  return 0LL;
}