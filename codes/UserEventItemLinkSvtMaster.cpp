void __fastcall UserEventItemLinkSvtMaster___ctor(UserEventItemLinkSvtMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B4580A & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_UserEventItemLinkSvtMaster__UserEventItemLinkSvtEntity__int___ctor__, method);
    byte_4B4580A = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    539,
    (const MethodInfo_32DFB18 *)Method_DataMasterBase_UserEventItemLinkSvtMaster__UserEventItemLinkSvtEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4580B & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataMasterBase_UserEventItemLinkSvtMaster__UserEventItemLinkSvtEntity__int__getEntityList__, v6);
    sub_1BDB878(&Method_System_Linq_Enumerable_SelectMany_UserEventItemLinkSvtEntity__EventItemUsedInfo___, v7);
    sub_1BDB878(&Method_System_Linq_Enumerable_ToArray_EventItemUsedInfo___, v8);
    sub_1BDB878(&Method_System_Linq_Enumerable_Where_UserEventItemLinkSvtEntity___, v9);
    sub_1BDB878(&System_Func_UserEventItemLinkSvtEntity__bool__TypeInfo, v10);
    sub_1BDB878(&System_Func_UserEventItemLinkSvtEntity__IEnumerable_EventItemUsedInfo___TypeInfo, v11);
    sub_1BDB878(&Method_UserEventItemLinkSvtMaster___c__EnableEventItemUsedInfo_b__1_1__, v12);
    sub_1BDB878(&Method_UserEventItemLinkSvtMaster___c__DisplayClass1_0__EnableEventItemUsedInfo_b__0__, v13);
    sub_1BDB878(&UserEventItemLinkSvtMaster___c__DisplayClass1_0_TypeInfo, v14);
    sub_1BDB878(&UserEventItemLinkSvtMaster___c_TypeInfo, v15);
    byte_4B4580B = 1;
  }
  v16 = sub_1BDBAC4(UserEventItemLinkSvtMaster___c__DisplayClass1_0_TypeInfo);
  ...
  *(_QWORD *)(v16 + 16) = Master_object;
  sub_1BDB81C((CGThumbnailListItem_o *)(v16 + 16), (int32_t)Master_object, v20, v21);
  list = this->fields.list;
  v23 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_UserEventItemLinkSvtEntity__bool__TypeInfo);
  ...
  v24 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_3077440 *)Method_System_Linq_Enumerable_Where_UserEventItemLinkSvtEntity___);
  ...
  if ( !_9__1_1 )
  {
    ...
    _9__1_1 = (System_Func_object__object__o *)sub_1BDBAC4(System_Func_UserEventItemLinkSvtEntity__IEnumerable_EventItemUsedInfo___TypeInfo);
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__1_1, (int32_t)_9__1_1, v30, v31);
  }
  v32 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__SelectMany_object__object_(
                                                               ...
                                                               (const MethodInfo_306AA08 *)Method_System_Linq_Enumerable_SelectMany_UserEventItemLinkSvtEntity__EventItemUsedInfo___);
  return (EventItemUsedInfo_array *)System_Linq_Enumerable__ToArray_object_(
                                      v32,
                                      (const MethodInfo_30707A8 *)Method_System_Linq_Enumerable_ToArray_EventItemUsedInfo___);
}
...
void __fastcall UserEventItemLinkSvtMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B4580C & 1) == 0 )
  {
    sub_1BDB878(&UserEventItemLinkSvtMaster___c_TypeInfo, v1);
    byte_4B4580C = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(UserEventItemLinkSvtMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  UserEventItemLinkSvtMaster___c_TypeInfo->static_fields->__9 = (struct UserEventItemLinkSvtMaster___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)UserEventItemLinkSvtMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4580D & 1) == 0 )
  {
    this = (UserEventItemLinkSvtMaster___c__DisplayClass1_0_o *)sub_1BDB878(
