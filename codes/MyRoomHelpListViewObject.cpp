...
void __fastcall MyRoomHelpListViewObject__Awake(MyRoomHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B11CF2 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_MyRoomHelpListViewItemDraw___, method, v2);
    byte_4B11CF2 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_MyRoomHelpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B11CF5 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_UnityEngine_GameObject_GetComponent_MyRoomHelpListViewObject___, method, v2);
    byte_4B11CF5 = 1;
  }
  ...
  if ( !DragObject
    || (v6 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2F626D0 *)Method_UnityEngine_GameObject_GetComponent_MyRoomHelpListViewObject___)) == 0LL) )
  {
    sub_1BCAA3C(DragObject, v5);
  }
  MyRoomHelpListViewObject__Init_32328792((MyRoomHelpListViewObject_o *)DragObject, 2, v7);
  return v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B11CF4 & 1) == 0 )
  {
    sub_1BCA7E0(&MyRoomHelpListViewItem_TypeInfo, method, v2);
    byte_4B11CF4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B11CF6 & 1) == 0 )
  {
    sub_1BCA7E0(&MyRoomHelpListViewItem_TypeInfo, *(_QWORD *)&initMode, callbackFunc);
    byte_4B11CF6 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MyRoomHelpListViewObject__Init_32328792(
        MyRoomHelpListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MyRoomHelpListViewObject__Init_32329388(
        MyRoomHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MyRoomHelpListViewObject__Init_32329976(
        MyRoomHelpListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall MyRoomHelpListViewObject__SetupDisp(MyRoomHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  MyRoomHelpListViewItemDraw_o *v13; // x0
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v13 )
      sub_1BCAA3C(0LL, v11);
    MyRoomHelpListViewItemDraw__SetItem(v13, (MyRoomHelpListViewItem_o *)linkItem, this->fields.dispMode, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (MyRoomHelpListViewObject_o *)sub_1BCACFC(v8);
