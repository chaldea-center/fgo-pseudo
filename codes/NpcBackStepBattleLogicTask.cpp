        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3AB66 & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_9342/*"NPC_BACKSTEP"*/);
    byte_4C3AB66 = 1;
  }
  PlayFieldMotionNpcBattleLogicTask___ctor(
    (PlayFieldMotionNpcBattleLogicTask_o *)this,
    (System_String_o *)StringLiteral_9342/*"NPC_BACKSTEP"*/,
    targetId,
    isForcedSpeedOne,
    v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3AB67 & 1) == 0 )
  {
    this = (NpcBackStepBattleLogicTask_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C3AB67 = 1;
  }
  if ( !logic )
    goto LABEL_11;
