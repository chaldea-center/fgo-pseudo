        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5368 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_9208/*"NPC_BACKSTEP"*/, *(_QWORD *)&targetId);
    byte_48E5368 = 1;
  }
  PlayFieldMotionNpcBattleLogicTask___ctor(
    (PlayFieldMotionNpcBattleLogicTask_o *)this,
    (System_String_o *)StringLiteral_9208/*"NPC_BACKSTEP"*/,
    targetId,
    isForcedSpeedOne,
    v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5369 & 1) == 0 )
  {
    this = (NpcBackStepBattleLogicTask_o *)sub_1B00CCC(&UnityEngine_Object_TypeInfo, logic);
    byte_48E5369 = 1;
  }
  if ( !logic )
    goto LABEL_11;
