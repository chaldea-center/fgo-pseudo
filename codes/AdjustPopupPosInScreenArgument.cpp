...
void __fastcall AdjustPopupPosInScreenArgument___ctor_45018420(
        ...
        const MethodInfo *method)
{
  ...
  y = worldPos.fields.y;
  x = worldPos.fields.x;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._Camera_k__BackingField, (int32_t)camera, (int32_t)method, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(Camera_k__BackingField, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      sub_1B86614(0LL, v4);
    *(UnityEngine_Vector3_o *)&x = UnityEngine_Camera__WorldToViewportPoint_69162188(
                                     v5,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._Camera_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
