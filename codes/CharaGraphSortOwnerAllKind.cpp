void CharaGraphSortOwnerAllKind___ctor(CharaGraphSortOwnerAllKind_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C36D01 & 1) == 0 )
  {
    sub_1C32C20(&CharaGraphSortManageUnitCommandCode_TypeInfo);
    sub_1C32C20(&CharaGraphSortManageUnitServantEquip_TypeInfo);
    sub_1C32C20(&CharaGraphSortManageUnitServant_TypeInfo);
    byte_4C36D01 = 1;
  }
  v3 = (Il2CppObject *)sub_1C32E6C(CharaGraphSortManageUnitServant_TypeInfo);
  System_Object___ctor(v3, 0);
  this->fields._ServantSortManageUnit_k__BackingField = (struct CharaGraphSortManageUnitBase_o *)v3;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._ServantSortManageUnit_k__BackingField, (int32_t)v3, v4, v5);
  v6 = (Il2CppObject *)sub_1C32E6C(CharaGraphSortManageUnitServantEquip_TypeInfo);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._ServantEquipSortManageUnit_k__BackingField, (int32_t)v6, v7, v8);
  v9 = (Il2CppObject *)sub_1C32E6C(CharaGraphSortManageUnitCommandCode_TypeInfo);
  System_Object___ctor(v9, 0);
  this->fields._CommandCodeSortManageUnit_k__BackingField = (struct CharaGraphSortManageUnitBase_o *)v9;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields._CommandCodeSortManageUnit_k__BackingField, (int32_t)v9, v10, v11);
