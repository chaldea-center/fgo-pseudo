...
void ServantCoinConfirmDialog__Init(ServantCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.closedAction, 0, v3, v4);
...
void ServantCoinConfirmDialog__OnClickClose(ServantCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A34C & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_ServantCoinConfirmDialog_OnClickClose__);
    sub_1C32C20(&Method_ServantCoinConfirmDialog__OnClickClose_b__9_0__);
    byte_4C3A34C = 1;
  }
  v3 = Method_ServantCoinConfirmDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ServantCoinConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C32C38(Method_ServantCoinConfirmDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A34B & 1) == 0 )
  {
    ...
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_11595/*"SERVANT_COIN_CONFIRM_OVERFLOW_TITLE"*/);
    sub_1C32C20(&StringLiteral_11592/*"SERVANT_COIN_CONFIRM_GET_DESCRIPTION"*/);
    sub_1C32C20(&StringLiteral_11594/*"SERVANT_COIN_CONFIRM_OVERFLOW_DESCRIPTION"*/);
    sub_1C32C20(&StringLiteral_11593/*"SERVANT_COIN_CONFIRM_GET_TITLE"*/);
    byte_4C3A34B = 1;
  }
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.closedAction, (int32_t)closedAction, v9, v10);
...
LABEL_14:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = &StringLiteral_11592/*"SERVANT_COIN_CONFIRM_GET_DESCRIPTION"*/;
      goto LABEL_34;
    }
LABEL_38:
    sub_1C32E7C(servantCoinConfirmListViewManager);
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v18 = &StringLiteral_11594/*"SERVANT_COIN_CONFIRM_OVERFLOW_DESCRIPTION"*/;
LABEL_34:
