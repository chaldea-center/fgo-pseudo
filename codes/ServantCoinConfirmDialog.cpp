...
void __fastcall ServantCoinConfirmDialog__Init(ServantCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.closedAction, 0, v4, v5);
...
void __fastcall ServantCoinConfirmDialog__OnClickClose(ServantCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00F37 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_ServantCoinConfirmDialog_OnClickClose__, v3);
    sub_1B64870(&Method_ServantCoinConfirmDialog__OnClickClose_b__9_0__, v4);
    byte_4A00F37 = 1;
  }
  v5 = Method_ServantCoinConfirmDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ServantCoinConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B64888(Method_ServantCoinConfirmDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00F36 & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, *(_QWORD *)&dispType);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v9);
    sub_1B64870(&StringLiteral_11511/*"SERVANT_COIN_CONFIRM_OVERFLOW_TITLE"*/, v10);
    sub_1B64870(&StringLiteral_11508/*"SERVANT_COIN_CONFIRM_GET_DESCRIPTION"*/, v11);
    sub_1B64870(&StringLiteral_11510/*"SERVANT_COIN_CONFIRM_OVERFLOW_DESCRIPTION"*/, v12);
    sub_1B64870(&StringLiteral_11509/*"SERVANT_COIN_CONFIRM_GET_TITLE"*/, v13);
    byte_4A00F36 = 1;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.closedAction, (int32_t)closedAction, v14, v15);
  ...
  if ( v18 != 2 )
  {
    ...
    servantCoinConfirmListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_11509/*"SERVANT_COIN_CONFIRM_GET_TITLE"*/, 0LL);
    if ( v20 )
    {
...
LABEL_14:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v24 = &StringLiteral_11508/*"SERVANT_COIN_CONFIRM_GET_DESCRIPTION"*/;
      goto LABEL_34;
    }
LABEL_38:
    sub_1B64ACC(servantCoinConfirmListViewManager, v16);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v25, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    servantCoinConfirmListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_11511/*"SERVANT_COIN_CONFIRM_OVERFLOW_TITLE"*/, 0LL);
    if ( !v26 )
      goto LABEL_38;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v24 = &StringLiteral_11510/*"SERVANT_COIN_CONFIRM_OVERFLOW_DESCRIPTION"*/;
LABEL_34:
