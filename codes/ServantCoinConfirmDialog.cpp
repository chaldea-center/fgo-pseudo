...
void ServantCoinConfirmDialog__Init(ServantCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.closedAction, 0, v3, v4, v5, v6, v7, v8);
...
void ServantCoinConfirmDialog__OnClickClose(ServantCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F050 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_ServantCoinConfirmDialog_OnClickClose__);
    sub_1C94098(&Method_ServantCoinConfirmDialog__OnClickClose_b__9_0__);
    byte_4D2F050 = 1;
  }
  v3 = Method_ServantCoinConfirmDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_ServantCoinConfirmDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C940B0(Method_ServantCoinConfirmDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F04F & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_11643/*"SERVANT_COIN_CONFIRM_OVERFLOW_TITLE"*/);
    sub_1C94098(&StringLiteral_11640/*"SERVANT_COIN_CONFIRM_GET_DESCRIPTION"*/);
    sub_1C94098(&StringLiteral_11642/*"SERVANT_COIN_CONFIRM_OVERFLOW_DESCRIPTION"*/);
    sub_1C94098(&StringLiteral_11641/*"SERVANT_COIN_CONFIRM_GET_TITLE"*/);
    byte_4D2F04F = 1;
  }
  ...
  if ( v17 != 2 )
  {
    ...
    servantCoinConfirmListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_11641/*"SERVANT_COIN_CONFIRM_GET_TITLE"*/, 0);
    if ( v19 )
    {
...
LABEL_14:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v23 = &StringLiteral_11640/*"SERVANT_COIN_CONFIRM_GET_DESCRIPTION"*/;
      goto LABEL_34;
    }
LABEL_38:
    sub_1C942F0(servantCoinConfirmListViewManager, v15);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v24, 0, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    servantCoinConfirmListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_11643/*"SERVANT_COIN_CONFIRM_OVERFLOW_TITLE"*/, 0);
    if ( !v25 )
      goto LABEL_38;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v23 = &StringLiteral_11642/*"SERVANT_COIN_CONFIRM_OVERFLOW_DESCRIPTION"*/;
LABEL_34:
