...
System_String_o *PaymentHistoryEntity__GetTypeText(PaymentHistoryEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&LocalizationManager_TypeInfo);
    sub_1C3E564(&StringLiteral_10339/*"PAYMENT_HISTORY_EXTERNAL"*/);
    sub_1C3E564(&StringLiteral_10340/*"PAYMENT_HISTORY_EXTERNAL_GIFT_CARD"*/);
    sub_1C3E564(&StringLiteral_10341/*"PAYMENT_HISTORY_INTERNAL"*/);
    byte_4C57324 = 1;
  }
  ...
  if ( type == 2 )
  {
    ...
    if ( subType == 1 )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v4 = &StringLiteral_10340/*"PAYMENT_HISTORY_EXTERNAL_GIFT_CARD"*/;
    ...
    if ( !subType )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v4 = &StringLiteral_10339/*"PAYMENT_HISTORY_EXTERNAL"*/;
      return LocalizationManager__Get((System_String_o *)*v4, 0);
    }
    return 0;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = &StringLiteral_10341/*"PAYMENT_HISTORY_INTERNAL"*/;
  return LocalizationManager__Get((System_String_o *)*v4, 0);
}
...
System_String_o *PaymentHistoryEntity__get_CreatedAtToString(PaymentHistoryEntity_o *this, const MethodInfo *method)
{
  ...
  if ( System_String__IsNullOrEmpty(this->fields.createdAtString, 0) )
  {
    ...
    sub_1C3E508(p_createdAtString, (int32_t)Date, v6, v7);
  }
