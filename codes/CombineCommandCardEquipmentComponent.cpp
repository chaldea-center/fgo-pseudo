        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51F39 & 1) == 0 )
  {
    sub_1B863B8(&LocalizationManager_TypeInfo, userCommandCode);
    sub_1B863B8(&Rarity_TypeInfo, v11);
    sub_1B863B8(&StringLiteral_1/*""*/, v12);
    sub_1B863B8(&StringLiteral_11321/*"SELECTED_COMMAND_CODE"*/, v13);
    byte_4A51F39 = 1;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.userCommandCodeEntity, (int32_t)v9, v15, v16);
...
LABEL_22:
    sub_1B86614(raritySprite, userCommandCode);
  }
  ServantFaceIconComponent__Set_39183928((ServantFaceIconComponent_o *)raritySprite, v9, 0LL, 0LL, 0LL);
  if ( !v9 )
    goto LABEL_22;
  ...
  else
  {
    ...
    raritySprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11321/*"SELECTED_COMMAND_CODE"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51F3A & 1) == 0 )
  {
    sub_1B863B8(&Rarity_TypeInfo, userCommandCode);
    byte_4A51F3A = 1;
  }
  raritySprite = (UnityEngine_Component_o *)this->fields.raritySprite;
  if ( !raritySprite )
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.userCommandCodeEntity, (int32_t)v3, v6, v7);
  ...
  if ( userCommandCode )
  {
    ...
    if ( raritySprite )
    {
      ServantFaceIconComponent__Set_39183928((ServantFaceIconComponent_o *)raritySprite, userCommandCode, 0LL, 0LL, 0LL);
