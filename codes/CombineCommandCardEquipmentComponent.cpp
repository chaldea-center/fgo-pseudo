        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0ECD & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_11705/*"SELECTED_COMMAND_CODE"*/);
    byte_42B0ECD = 1;
  }
  ...
  ServantFaceIconComponent__Set_30476088((ServantFaceIconComponent_o *)raritySprite, v9, 0LL, 0LL, 0LL);
  if ( !v9 )
    goto LABEL_24;
  ...
  if ( !statusInfoLabel )
LABEL_24:
    sub_B52A5C(raritySprite, userCommandCode);
LABEL_22:
        ...
        const MethodInfo *method)
{
  ...
  if ( userCommandCode )
  {
    ...
    if ( raritySprite )
    {
      ServantFaceIconComponent__Set_30476088((ServantFaceIconComponent_o *)raritySprite, userCommandCode, 0LL, 0LL, 0LL);
