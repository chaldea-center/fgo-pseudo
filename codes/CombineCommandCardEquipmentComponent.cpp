        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D349A3 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_11605/*"SELECTED_COMMAND_CODE"*/);
    byte_4D349A3 = 1;
  }
...
LABEL_22:
    sub_1C93D2C(raritySprite, userCommandCode);
  }
  ServantFaceIconComponent__Set_41819388((ServantFaceIconComponent_o *)raritySprite, v9, 0, 0, 0);
  if ( !v9 )
    goto LABEL_22;
  ...
  else
  {
    ...
    raritySprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11605/*"SELECTED_COMMAND_CODE"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.userCommandCodeEntity, (int32_t)v3, v6, v7, v8, v9, v10, v11);
  ...
  if ( userCommandCode )
  {
    ...
    if ( raritySprite )
    {
      ServantFaceIconComponent__Set_41819388((ServantFaceIconComponent_o *)raritySprite, userCommandCode, 0, 0, 0);
