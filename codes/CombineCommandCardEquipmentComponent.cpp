        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F7C & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, userCommandCode);
    sub_1C13D24(&Rarity_TypeInfo, v11);
    sub_1C13D24(&StringLiteral_1/*""*/, v12);
    sub_1C13D24(&StringLiteral_11690/*"SCRIPT_FINISHED"*/, v13);
    byte_4BB7F7C = 1;
  }
...
LABEL_22:
    sub_1C13F80(raritySprite, userCommandCode);
  }
  ServantFaceIconComponent__Set_39370868((ServantFaceIconComponent_o *)raritySprite, v9, 0LL, 0LL, 0LL);
  if ( !v9 )
    goto LABEL_22;
  ...
  else
  {
    ...
    raritySprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11690/*"SCRIPT_FINISHED"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7F7D & 1) == 0 )
  {
    sub_1C13D24(&Rarity_TypeInfo, userCommandCode);
    byte_4BB7F7D = 1;
  }
  raritySprite = (UnityEngine_Component_o *)this->fields.raritySprite;
  if ( !raritySprite )
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.userCommandCodeEntity, (int64_t)v3, v6, v7, v8, v9, v10, v11);
  ...
  if ( userCommandCode )
  {
    ...
    if ( raritySprite )
    {
      ServantFaceIconComponent__Set_39370868((ServantFaceIconComponent_o *)raritySprite, userCommandCode, 0LL, 0LL, 0LL);
