        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2B0FF & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_11511/*"SELECTED_COMMAND_CODE"*/);
    byte_4C2B0FF = 1;
  }
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.userCommandCodeEntity, (int32_t)v9, v12, v13);
...
LABEL_22:
    sub_1C2D6EC(raritySprite, userCommandCode);
  }
  ServantFaceIconComponent__Set_40791192((ServantFaceIconComponent_o *)raritySprite, v9, 0, 0, 0);
  if ( !v9 )
    goto LABEL_22;
  ...
  else
  {
    ...
    raritySprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11511/*"SELECTED_COMMAND_CODE"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.userCommandCodeEntity, (int32_t)v3, v6, v7);
  ...
  if ( userCommandCode )
  {
    ...
    if ( raritySprite )
    {
      ServantFaceIconComponent__Set_40791192((ServantFaceIconComponent_o *)raritySprite, userCommandCode, 0, 0, 0);
      ...
      if ( raritySprite )
      {
        ...
        if ( v8 )
        {
          UISprite__set_spriteName(v8, (System_String_o *)raritySprite, 0);
          raritySprite = (UnityEngine_Component_o *)this->fields.raritySprite;
          if ( raritySprite )
          {
