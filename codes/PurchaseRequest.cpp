        ...
        const MethodInfo *method)
{
  if ( (byte_438B65F & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_16675/*"anotherPayFlag"*/);
    byte_438B65F = 1;
  }
  ...
  if ( anotherPayFlag >= 1 )
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16675/*"anotherPayFlag"*/, anotherPayFlag, 0LL);
...
System_String_o *__fastcall PurchaseRequest__getURL(PurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438B65E & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_22578/*"shop/purchase"*/);
    byte_438B65E = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_22578/*"shop/purchase"*/, 0LL);
}
