        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB766B & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_22214/*"num"*/, *(_QWORD *)&id);
    sub_1BAB41C(&StringLiteral_20230/*"id"*/, v9);
    sub_1BAB41C(&StringLiteral_16821/*"anotherPayFlag"*/, v10);
    byte_4AB766B = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22214/*"num"*/, num, v11);
  if ( anotherPayFlag >= 1 )
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16821/*"anotherPayFlag"*/, anotherPayFlag, v13);
...
System_String_o *__fastcall PurchaseRequest__getURL(PurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB766A & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_23305/*"shop/purchase"*/, v2);
    byte_4AB766A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_23305/*"shop/purchase"*/, 0LL);
}
