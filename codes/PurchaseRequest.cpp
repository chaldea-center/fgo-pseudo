        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B68554 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22496/*"num"*/, *(_QWORD *)&id);
    sub_1BE4ACC(&StringLiteral_20482/*"id"*/, v9);
    sub_1BE4ACC(&StringLiteral_17001/*"anotherPayFlag"*/, v10);
    byte_4B68554 = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22496/*"num"*/, num, v11);
  if ( anotherPayFlag >= 1 )
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17001/*"anotherPayFlag"*/, anotherPayFlag, v13);
...
System_String_o *__fastcall PurchaseRequest__getURL(PurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B68553 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_23600/*"shop/purchase"*/, v2);
    byte_4B68553 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_23600/*"shop/purchase"*/, 0LL);
}
