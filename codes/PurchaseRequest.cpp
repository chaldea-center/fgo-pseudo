        ...
        const MethodInfo *method)
{
  if ( (byte_4351F9C & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_16596/*"anotherPayFlag"*/);
    byte_4351F9C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19684/*"id"*/, id, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21512/*"num"*/, num, 0LL);
  if ( anotherPayFlag >= 1 )
    RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16596/*"anotherPayFlag"*/, anotherPayFlag, 0LL);
...
System_String_o *__fastcall PurchaseRequest__getURL(PurchaseRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4351F9B & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_22477/*"shop/purchase"*/);
    byte_4351F9B = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_22477/*"shop/purchase"*/, 0LL);
}
