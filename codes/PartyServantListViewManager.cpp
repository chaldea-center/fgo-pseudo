void __fastcall PartyServantListViewManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2F9 & 1) == 0 )
  {
    ...
    sub_1B863B8(&PartyServantListViewManager_TypeInfo, v4);
    sub_1B863B8(&StringLiteral_15364/*"WarBoardPartyServant"*/, v5);
    sub_1B863B8(&StringLiteral_10409/*"PartyServant"*/, v6);
    byte_4A4A2F9 = 1;
  }
  PartyServantListViewManager_TypeInfo->static_fields->SORT_SAVE_KEY = (struct System_String_o *)StringLiteral_10409/*"PartyServant"*/;
  sub_1B8635C((CGThumbnailListItem_o *)PartyServantListViewManager_TypeInfo->static_fields, StringLiteral_10409/*"PartyServant"*/, v2, v3);
  v7 = StringLiteral_15364/*"WarBoardPartyServant"*/;
  static_fields = PartyServantListViewManager_TypeInfo->static_fields;
  static_fields->WAR_SORT_SAVE_KEY = (struct System_String_o *)StringLiteral_15364/*"WarBoardPartyServant"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&static_fields->WAR_SORT_SAVE_KEY, v7, v9, v10);
  ...
  ListViewSort___ctor_41808980(v12, SORT_SAVE_KEY, 3, 0, 0LL);
  ...
  ListViewSort___ctor_41808980(v17, WAR_SORT_SAVE_KEY, 3, 0, 0LL);
  v18 = PartyServantListViewManager_TypeInfo->static_fields;
  v18->warServantSortInfo = v17;
  sub_1B8635C((CGThumbnailListItem_o *)&v18->warServantSortInfo, (int32_t)v17, v19, v20);
}
...
LABEL_8:
  ...
  PartyServantListViewManager__SetMode_32969368(this, 2, v11);
        ...
        const MethodInfo *method)
{
  ...
  int32_t maxCost; // w28
  ListViewSort_o *v44; // x27
  int32_t v45; // w0
  int32_t TotalCost; // w0
  const MethodInfo *v47; // x4
  __int64 v48; // x8
  unsigned __int64 v49; // x26
  UserServantEntity_o *v50; // x29
  PartyServantListViewItem_o *v51; // x28
  int32_t v52; // w2
  ...
  const MethodInfo *v61; // [xsp+8h] [xbp-78h]

  if ( (byte_4A4A2DE & 1) == 0 )
  {
    sub_1B863B8(&CommonRestrictionMaster_TypeInfo, baseDeckItemList);
    sub_1B863B8(&Method_DataManager_GetMasterData_UserServantMaster___, v12);
    sub_1B863B8(&Method_DataManager_GetMaster_EventServantPointRankMaster___, v13);
    ...
    sub_1B863B8(&PartyServantListViewItem_TypeInfo, v17);
    sub_1B863B8(&PartyServantListViewManager_TypeInfo, v18);
  ...
  servantSortInfo = v23->static_fields->servantSortInfo;
  this->fields.sort = servantSortInfo;
  p_sort = &this->fields.sort;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.sort, (int32_t)servantSortInfo, v21, v22);
  sort = this->fields.sort;
  if ( !sort )
    goto LABEL_55;
...
LABEL_17:
    ...
    if ( !*p_sort )
      goto LABEL_55;
    if ( v40->fields.sortKind == 28 )
      v40->fields.sortKind = 3;
    goto LABEL_20;
  }
  ...
  if ( !v34 )
    goto LABEL_55;
  v34->fields.isBonusKind = ((unsigned __int8)sort & 1) == 0;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_EventServantPointRankMaster___);
  ...
  sort = (ListViewSort_o *)EventServantPointRankMaster__IsEnableEvent(
                             ...
                             (int32_t)sort,
                             0LL);
  v38 = this->fields.isQuestStart;
  this->fields.isBuddyPoint = (unsigned __int8)sort & 1;
  if ( !v38 || ((unsigned __int8)sort & 1) == 0 )
    goto LABEL_17;
LABEL_20:
  if ( questRestrictionInfo )
  {
    QuestRestrictionInfo__SetDeckInfo_41480352(questRestrictionInfo, partyItem, num, 0LL);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.seed, (int32_t)normalSizeSeed, v36, v37);
LABEL_30:
  sort = (ListViewSort_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !sort )
    goto LABEL_55;
  ...
  v44 = sort;
  v45 = questRestrictionInfo ? QuestRestrictionInfo__GetTotalCostRestriction(questRestrictionInfo, 0LL) : 0;
  this->fields.restrictionTotalCost = v45;
  TotalCost = PartyListViewItem__GetTotalCost(partyItem, 0LL);
  PartyServantListViewManager__UpdateCost(this, TotalCost, maxCost, this->fields.restrictionTotalCost, v47);
  ...
  if ( !v44 )
    goto LABEL_55;
  v48 = *(_QWORD *)&v44->fields.FILTER_DEFAULT_VALUE;
  if ( (int)v48 >= 1 )
  {
    v49 = 0LL;
    while ( 1 )
    {
      if ( v49 >= (unsigned int)v48 )
        sub_1B8661C(sort, v26);
      v50 = (UserServantEntity_o *)*((_QWORD *)&v44->fields.manager + v49);
      v51 = (PartyServantListViewItem_o *)sub_1B86604(PartyServantListViewItem_TypeInfo);
      ...
      {
        v57 = v54 + 8 * v56;
        *(_DWORD *)&sort->fields.FILTER_DEFAULT_VALUE = v56 + 1;
        *(_QWORD *)(v57 + 32) = v51;
        sub_1B8635C((CGThumbnailListItem_o *)(v57 + 32), (int32_t)v51, v52, v53);
      }
      LODWORD(v48) = *(_DWORD *)&v44->fields.FILTER_DEFAULT_VALUE;
      if ( (__int64)++v49 >= (int)v48 )
        goto LABEL_49;
    }
LABEL_55:
    sub_1B86614(sort, v26);
  }
LABEL_49:
  ...
  sort = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11603/*"SERVANT_SORT_FILTER_RESULT_EMPTY"*/, 0LL);
  if ( !emptyMessageLabel )
    goto LABEL_55;
  UILabel__set_text(emptyMessageLabel, (System_String_o *)sort, 0LL);
  PartyServantListViewManager__SortItem(this, -1, 0, -1, v59);
  PartyServantListViewManager__SetFilterButtonImage(this, v60);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall PartyServantListViewManager__CreateList_32964148(
        PartyServantListViewManager_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2DF & 1) == 0 )
  {
    sub_1B863B8(&CommonRestrictionMaster_TypeInfo, partyItem);
    sub_1B863B8(&Method_DataManager_GetMasterData_UserServantMaster___, v11);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_EventDropUpValInfo__Dispose__, v12);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_EventDropUpValInfo__MoveNext__, v13);
    ...
    sub_1B863B8(&Method_System_Collections_Generic_List_EventDropUpValInfo__GetEnumerator__, v18);
    ...
    sub_1B863B8(&PartyServantListViewItem_TypeInfo, v23);
    sub_1B863B8(&PartyServantListViewManager_TypeInfo, v24);
    sub_1B863B8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v25);
    sub_1B863B8(&StringLiteral_10068/*"PARTY_ORGANIZATION_COST_SPLIT"*/, v26);
    sub_1B863B8(&StringLiteral_10066/*"PARTY_ORGANIZATION_COST_OVER_COLOR"*/, v27);
    sub_1B863B8(&StringLiteral_10067/*"PARTY_ORGANIZATION_COST_RESTRICTION_COLOR"*/, v28);
    sub_1B863B8(&StringLiteral_11603/*"SERVANT_SORT_FILTER_RESULT_EMPTY"*/, v29);
    sub_1B863B8(&StringLiteral_10065/*"PARTY_ORGANIZATION_COST_COLOR"*/, v30);
    byte_4A4A2DF = 1;
  }
  eventUpValInfo = 0LL;
  v97 = 0LL;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.lastPartyItem, 0, num, *(const MethodInfo **)&tutorialMode);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.sort, (int32_t)warServantSortInfo, v31, v32);
  sort = this->fields.sort;
  if ( !sort )
    goto LABEL_86;
  ListViewSort__Load(sort, 0LL);
...
LABEL_31:
  if ( setupInfo )
  {
    ...
    AlignedBonusFilter = ListViewSort__GetAlignedBonusFilter(
                           ...
                           0LL);
    this->fields.alignedBonusFilterInfos = AlignedBonusFilter;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.alignedBonusFilterInfos, (int32_t)AlignedBonusFilter, v55, v56);
  ...
  else
  {
    ...
    this->fields.alignedBonusFilterInfos = 0LL;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.alignedBonusFilterInfos, 0, v38, v39);
    if ( questRestrictionInfo )
LABEL_36:
      this->fields.eventId = questRestrictionInfo->fields.eventId;
  }
...
LABEL_47:
    this->fields.seed = normalSizeSeed;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.seed, (int32_t)normalSizeSeed, v58, v59);
  }
  sort = (ListViewSort_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !sort )
    goto LABEL_86;
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_55:
      v69 = LocalizationManager__Get((System_String_o *)StringLiteral_10067/*"PARTY_ORGANIZATION_COST_RESTRICTION_COLOR"*/, 0LL);
      HIDWORD(v97) = v67;
      goto LABEL_58;
    }
  }
  ...
  v69 = LocalizationManager__Get((System_String_o *)StringLiteral_10065/*"PARTY_ORGANIZATION_COST_COLOR"*/, 0LL);
LABEL_58:
  maxCostLabel = this->fields.maxCostLabel;
  v71 = System_Int32__ToString((int32_t)&v97 + 4, 0LL);
  sort = (ListViewSort_o *)System_String__Concat_61645176(v69, v71, 0LL);
  if ( !maxCostLabel )
    goto LABEL_86;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v73 = LocalizationManager__Get((System_String_o *)StringLiteral_10068/*"PARTY_ORGANIZATION_COST_SPLIT"*/, 0LL);
  sort = (ListViewSort_o *)System_String__Concat_61645176(v69, v73, 0LL);
  if ( !splitCostLabel )
    goto LABEL_86;
  ...
  if ( cost > SHIDWORD(v97) )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v76 = LocalizationManager__Get((System_String_o *)StringLiteral_10066/*"PARTY_ORGANIZATION_COST_OVER_COLOR"*/, 0LL);
    cost = partyItem->fields.cost;
    v69 = v76;
  }
  LODWORD(v97) = cost;
  v77 = System_Int32__ToString((int32_t)&v97, 0LL);
  sort = (ListViewSort_o *)System_String__Concat_61645176(v69, v77, 0LL);
  if ( !selectCostLabel )
    goto LABEL_86;
  ...
  if ( (int)v78 >= 1 )
  {
    ...
    {
      v80 = v65->m_Items[v79];
      v81 = (PartyServantListViewItem_o *)sub_1B86604(PartyServantListViewItem_TypeInfo);
      PartyServantListViewItem___ctor_32942048(
        v81,
        v79,
        v80,
        partyItem,
      ...
      else
      {
        ...
        *(_QWORD *)(v87 + 32) = v81;
        sub_1B8635C((CGThumbnailListItem_o *)(v87 + 32), (int32_t)v81, v82, v83);
      }
...
void __fastcall PartyServantListViewManager__DeleteContinueData(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2D9 & 1) == 0 )
  {
    sub_1B863B8(&PartyServantListViewManager_TypeInfo, v1);
    byte_4A4A2D9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2ED & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_PartyServantListViewManager_EndCloseSelectFilterKind__, v6);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&System_Action_TypeInfo, isDecide);
    sub_1B863B8(&Method_PartyServantListViewManager_EndCloseSelectSortKind__, v6);
    sub_1B863B8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    byte_4A4A2F0 = 1;
  }
  if ( isDecide )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2F3 & 1) == 0 )
  {
    ...
    sub_1B863B8(&PartyServantListViewItem_TypeInfo, v6);
    byte_4A4A2F3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2F8 & 1) == 0 )
  {
    ...
    this = (PartyServantListViewManager_o *)sub_1B863B8(&PartyServantListViewItem_TypeInfo, v9);
    byte_4A4A2F8 = 1;
  }
  *index = -1;
  if ( sum >= 1 )
        ...
        const MethodInfo *method)
{
  ...
  __int64 v7; // x1
  __int64 v8; // x1
  PartyServantListViewManager___c__DisplayClass55_0_o *v9; // x21
  __int64 v10; // x0
  __int64 v11; // x1
  PartyServantListViewItem_o *result; // x0
  ...
  if ( (byte_4A4A2E3 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_Cast_PartyServantListViewItem___, id);
    sub_1B863B8(&Method_System_Linq_Enumerable_FirstOrDefault_PartyServantListViewItem___, v5);
    sub_1B863B8(&System_Func_PartyServantListViewItem__bool__TypeInfo, v6);
    sub_1B863B8(&Method_PartyServantListViewManager___c__DisplayClass55_0__GetItemByUserServantID_b__0__, v7);
    sub_1B863B8(&PartyServantListViewManager___c__DisplayClass55_0_TypeInfo, v8);
    byte_4A4A2E3 = 1;
  }
  v9 = (PartyServantListViewManager___c__DisplayClass55_0_o *)sub_1B86604(PartyServantListViewManager___c__DisplayClass55_0_TypeInfo);
  PartyServantListViewManager___c__DisplayClass55_0___ctor(v9, 0LL);
  if ( !v9 )
    sub_1B86614(v10, v11);
  v9->fields.id = id;
  result = (PartyServantListViewItem_o *)this->fields.itemList;
  if ( result )
  {
    v13 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Cast_object_(
                                                                 ...
                                                                 (const MethodInfo_2F7E43C *)Method_System_Linq_Enumerable_Cast_PartyServantListViewItem___);
    v14 = (System_Func_object__bool__o *)sub_1B86604(System_Func_PartyServantListViewItem__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v14,
      (Il2CppObject *)v9,
      Method_PartyServantListViewManager___c__DisplayClass55_0__GetItemByUserServantID_b__0__,
      0LL);
    return (PartyServantListViewItem_o *)System_Linq_Enumerable__FirstOrDefault_object__49893388(
                                           v13,
                                           (System_Func_TSource__bool__o *)v14,
                                           (const MethodInfo_2F9500C *)Method_System_Linq_Enumerable_FirstOrDefault_PartyServantListViewItem___);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2F7 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_ListViewItem__Dispose__, userServantId);
    ...
    sub_1B863B8(&PartyServantListViewItem_TypeInfo, v9);
    byte_4A4A2F7 = 1;
  }
  memset(&v20, 0, sizeof(v20));
  itemList = this->fields.itemList;
  if ( !itemList )
    sub_1B86614(0LL, userServantId);
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    if ( v20.fields._current )
    {
        ...
        && (PartyServantListViewItem_c *)v20.fields._current->klass->_2.typeHierarchy[methodPtr_low - 1] == PartyServantListViewItem_TypeInfo )
      {
        ...
        *(Il2CppType *)&v19.fields.fakeValue = byval_arg;
        ...
        v18 = v19;
        if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v18, 0LL) == userServantId )
          goto LABEL_15;
      }
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2E5 & 1) == 0 )
  {
    ...
    sub_1B863B8(&PartyServantListViewItem_TypeInfo, v14);
    byte_4A4A2E5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  int64_t v24; // x22
  int32_t v25; // w23
  PartyServantListViewItem_o *v26; // x24
  __int64 methodPtr_low; // x10
  __int64 v28; // x8
  __int128 v29; // q0
  ...
  if ( (byte_4A4A2E1 & 1) == 0 )
  {
    ...
    sub_1B863B8(&PartyServantListViewItem_TypeInfo, v8);
  ...
  TotalCost = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !TotalCost
    ...
    while ( 1 )
    {
      ...
      *(_OWORD *)&v41.fields.fakeValue = v23;
      if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
      v40 = v41;
      TotalCost = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v40, 0LL);
      if ( size >= 1 )
      {
        v24 = TotalCost;
        v25 = 0;
        while ( 1 )
        {
          ...
          if ( !TotalCost )
            goto LABEL_47;
          v26 = (PartyServantListViewItem_o *)TotalCost;
          methodPtr_low = LOBYTE(PartyServantListViewItem_TypeInfo->vtable._0_Equals.methodPtr);
          ...
          v28 = *(_QWORD *)(TotalCost + 112);
          if ( v28 )
          {
            v29 = *(_OWORD *)(v28 + 32);
            *(_OWORD *)&v41.fields.currentCryptoKey = *(_OWORD *)(v28 + 16);
            *(_OWORD *)&v41.fields.fakeValue = v29;
            if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
            v39 = v41;
            TotalCost = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v39, 0LL);
            if ( TotalCost == v24 )
              break;
          }
          if ( size == ++v25 )
        ...
        if ( v18 >= *(_DWORD *)(v17 + 24) )
          goto LABEL_32;
        PartyServantListViewItem__ModifyItem(v26, *v21, v30);
        if ( !isIconSizeChange )
        {
          PartyServantListViewItem__ModifyLockItem(v26, v12);
          PartyServantListViewItem__ModifyChoiceItem(v26, v31);
        }
      }
LABEL_30:
      if ( ++v18 == (_DWORD)v38 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2EB & 1) == 0 )
  {
    sub_1B863B8(&Method_PartyServantListViewManager_OnClickBonusFilterKind__, method);
  ...
  if ( this->fields.isInput )
  {
    ...
    if ( (*((_BYTE *)Method_PartyServantListViewManager_OnClickBonusFilterKind__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B863D0(Method_PartyServantListViewManager_OnClickBonusFilterKind__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2EC & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_PartyServantListViewManager_EndSelectFilterKind__, v3);
    sub_1B863B8(&Method_PartyServantListViewManager_OnClickFilterKind__, v4);
  ...
  if ( this->fields.isInput )
  {
    ...
    if ( (*((_BYTE *)Method_PartyServantListViewManager_OnClickFilterKind__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B863D0(Method_PartyServantListViewManager_OnClickFilterKind__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2F1 & 1) == 0 )
  {
    sub_1B863B8(&Method_PartyServantListViewManager_OnClickSortAscendingOrder__, method);
    byte_4A4A2F1 = 1;
  }
  if ( this->fields.isInput )
  {
    ...
    if ( (*((_BYTE *)Method_PartyServantListViewManager_OnClickSortAscendingOrder__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_PartyServantListViewManager_OnClickSortAscendingOrder__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2EF & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_PartyServantListViewManager_EndSelectSortKind__, v3);
    sub_1B863B8(&Method_PartyServantListViewManager_OnClickSortKind__, v4);
    sub_1B863B8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v5);
    byte_4A4A2EF = 1;
  }
  if ( this->fields.isInput )
  {
    ...
    if ( (*((_BYTE *)Method_PartyServantListViewManager_OnClickSortKind__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B863D0(Method_PartyServantListViewManager_OnClickSortKind__);
    v7 = (System_Reflection_MethodBase_o *)sub_1B8639C(v6, v6[4]);
    OverwriteAssetSoundName__PlaySystemSe(v7, 0, 0, 0LL);
    v8 = 7;
    ...
    v13 = (ServantSortSelectMenu_CallbackFunc_o *)sub_1B86604(ServantSortSelectMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2E8 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__Dispose__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__MoveNext__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__get_Current__, v9);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__GetEnumerator__, v10);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__get_Count__, v11);
    sub_1B863B8(&Method_PartyServantListViewManager_OnMoveEnd__, v12);
  ...
  else
  {
    ...
    System_Collections_Generic_List_object___GetEnumerator(
      ...
      ObjectList,
      (const MethodInfo_35FD450 *)Method_System_Collections_Generic_List_PartyServantListViewObject__GetEnumerator__);
    while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
              &v21,
              (const MethodInfo_3398634 *)Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__MoveNext__) )
    {
      ...
      if ( !current )
        sub_1B86614(v19, v20);
      PartyServantListViewObject__Init_32978832((PartyServantListViewObject_o *)current, mode, v18, delay, 0LL);
    }
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v21,
      (const MethodInfo_3398630 *)Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__Dispose__);
  }
}


// local variable allocation has failed, the output may be wrong!
void __fastcall PartyServantListViewManager__RequestListObject_32970260(
        PartyServantListViewManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&System_Action_TypeInfo, *(_QWORD *)&mode);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__Dispose__, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__MoveNext__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__get_Current__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__GetEnumerator__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__get_Count__, v9);
    sub_1B863B8(&Method_PartyServantListViewManager_OnMoveEnd__, v10);
  ...
  else
  {
              ...
              (const MethodInfo_3398634 *)Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__MoveNext__) )
    {
      ...
      if ( !current )
        sub_1B86614(v17, v18);
      PartyServantListViewObject__Init_32978916((PartyServantListViewObject_o *)current, mode, v16, 0LL);
    }
    System_Collections_Generic_List_Enumerator_object___Dispose(
      &v19,
      (const MethodInfo_3398630 *)Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__Dispose__);
        ...
        const MethodInfo *method)
{
  ...
  PartyServantListViewManager__SetMode_32969368(this, mode, v6);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall PartyServantListViewManager__SetMode_32969368(
        PartyServantListViewManager_o *this,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&System_Action_TypeInfo, *(_QWORD *)&mode);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__get_Count__, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__get_Item__, v6);
    sub_1B863B8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, v7);
    sub_1B863B8(&Method_PartyServantListViewManager_OnMoveEnd__, v8);
  ...
  switch ( mode )
  {
    ...
    case 3:
      v14 = 4;
LABEL_12:
      PartyServantListViewManager__RequestListObject_32970260(this, v14, v12);
      return;
    case 4:
  ...
  do
  {
    scrollView = (int64_t)System_Collections_Generic_List_object___get_Item(
                            v16,
                            v18,
                            (const MethodInfo_35FC688 *)Method_System_Collections_Generic_List_PartyServantListViewObject__get_Item__);
    if ( !scrollView )
      goto LABEL_39;
    ...
    if ( v20 && (*(_DWORD *)(scrollView + 220) & 0x80000000) != 0 )
    {
      ...
      *(_OWORD *)&v31.fields.fakeValue = v22;
      if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
      v30 = v31;
      scrollView = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v30, 0LL);
      if ( v17 < scrollView )
      {
        v20 = *(_QWORD *)(v21 + 112);
        if ( !v20 )
...
LABEL_26:
        ...
        *(_OWORD *)&v31.fields.fakeValue = v23;
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
        v29 = v31;
        v17 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v29, 0LL);
        v19 = v18;
      }
    }
    size = v16->fields._size;
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v19 == v25 )
        ...
        v28 = 2;
      PartyServantListViewObject__Init_32978916((PartyServantListViewObject_o *)Item, v28, v27, 0LL);
      if ( ++v25 >= v16->fields._size )
        return;
    }
LABEL_39:
    sub_1B86614(scrollView, v10);
  }
}


void __fastcall PartyServantListViewManager__SetMode_32970208(
        PartyServantListViewManager_o *this,
        int32_t mode,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2E6 & 1) == 0 )
  {
    this = (PartyServantListViewManager_o *)sub_1B863B8(&PartyServantListViewObject_TypeInfo, obj);
    byte_4A4A2E6 = 1;
  }
  if ( !obj
  ...
  if ( v5->fields.initMode == 2 )
    ...
    v7 = 2;
  PartyServantListViewObject__Init_32978028((PartyServantListViewObject_o *)obj, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A4A2DD & 1) == 0 )
  {
    sub_1B863B8(&NetworkManager_TypeInfo, *(_QWORD *)&selectIndex);
    byte_4A4A2DD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2E0 & 1) == 0 )
  {
    sub_1B863B8(&LocalizationManager_TypeInfo, *(_QWORD *)&cost);
    sub_1B863B8(&StringLiteral_10068/*"PARTY_ORGANIZATION_COST_SPLIT"*/, v8);
    sub_1B863B8(&StringLiteral_10066/*"PARTY_ORGANIZATION_COST_OVER_COLOR"*/, v9);
    sub_1B863B8(&StringLiteral_10067/*"PARTY_ORGANIZATION_COST_RESTRICTION_COLOR"*/, v10);
    sub_1B863B8(&StringLiteral_10065/*"PARTY_ORGANIZATION_COST_COLOR"*/, v11);
...
LABEL_8:
  ...
  v17 = System_String__Concat_61645176(v14, v16, 0LL);
  if ( !maxCostLabel )
    goto LABEL_18;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_10068/*"PARTY_ORGANIZATION_COST_SPLIT"*/, 0LL);
  v17 = System_String__Concat_61645176(v14, v20, 0LL);
  if ( !splitCostLabel )
    goto LABEL_18;
  ...
  if ( v24 > v23 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_10066/*"PARTY_ORGANIZATION_COST_OVER_COLOR"*/, 0LL);
  }
  v22 = System_Int32__ToString((int32_t)&v24, 0LL);
  v17 = System_String__Concat_61645176(v14, v22, 0LL);
  if ( !selectCostLabel )
LABEL_18:
    sub_1B86614(v17, v18);
...
void __fastcall PartyServantListViewManager__UpdateDisp(PartyServantListViewManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2F5 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__Dispose__, method);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__MoveNext__, v3);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_PartyServantListViewObject__get_Current__, v4);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__GetEnumerator__, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__get_Count__, v6);
    byte_4A4A2F5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2F6 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_ListViewItem__Dispose__, *(_QWORD *)&modeKind);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_ListViewItem__MoveNext__, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_ListViewItem__get_Current__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_ListViewItem__GetEnumerator__, v7);
    sub_1B863B8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, v8);
  ...
  *(_OWORD *)&v33.fields._list = *(_OWORD *)&v32.fields.currentCryptoKey;
  ...
  while ( 1 )
  {
    ...
    {
      v17 = sub_1B868D4(v33.fields._current);
LABEL_23:
      sub_1B86614(v17, v18);
    }
    ...
    *(Il2CppType *)&v32.fields.fakeValue = byval_arg;
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    v31 = v32;
    v24 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v31, 0LL);
    v26 = BYTE2(current[14].monitor);
    BYTE3(current[14].monitor) = v24 == (_QWORD)klass;
    if ( v26 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2D5 & 1) == 0 )
  {
    sub_1B863B8(&PartyServantListViewManager_CallbackFunc_TypeInfo, value);
    byte_4A4A2D5 = 1;
  }
  ...
  v10 = (PartyServantListViewManager_o *)sub_1B868D4(v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2DC & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_PartyServantListViewObject___, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject__Add__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_GameObject__GetEnumerator__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_PartyServantListViewObject___ctor__, v8);
    sub_1B863B8(&System_Collections_Generic_List_PartyServantListViewObject__TypeInfo, v9);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v10);
    byte_4A4A2DC = 1;
  }
  memset(&v32, 0, sizeof(v32));
  v11 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_PartyServantListViewObject__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_PartyServantListViewObject___ctor__);
            ...
            (const MethodInfo_3398634 *)Method_System_Collections_Generic_List_Enumerator_GameObject__MoveNext__) )
  {
    ...
    if ( v15 )
    {
      ...
      Component_object = UnityEngine_GameObject__GetComponent_object_(
                           ...
                           (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_PartyServantListViewObject___);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CD46C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CD414;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2FB & 1) == 0 )
  {
    ...
    sub_1B863B8(&PartyServantListViewManager_ResultKind_TypeInfo, v9);
    byte_4A4A2FB = 1;
  }
  v14[2] = 0LL;
...
void __fastcall PartyServantListViewManager___c__DisplayClass55_0___ctor(
        PartyServantListViewManager___c__DisplayClass55_0_o *this,
        const MethodInfo *method)
{
...
bool __fastcall PartyServantListViewManager___c__DisplayClass55_0___GetItemByUserServantID_b__0(
        PartyServantListViewManager___c__DisplayClass55_0_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A2FC & 1) == 0 )
  {
    sub_1B863B8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, e);
    byte_4A4A2FC = 1;
  }
  if ( !e )
    return 0;
  ...
  *(_OWORD *)&v9.fields.fakeValue = v6;
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
  v8 = v9;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47437768(&v8, 0LL) == this->fields.id;
}