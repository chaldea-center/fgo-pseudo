        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24C1E & 1) == 0 )
  {
    this = (BattleAddSkillTaskBeforeTargetTask_o *)sub_1C3B764(
  ...
  if ( !arg
    ...
    || (Task_k__BackingField = (Il2CppObject *)arg->fields._Task_k__BackingField,
        ...
        !items) )
  {
    sub_1C3B9C0(v7, Task_k__BackingField);
  }
  ...
  else
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)(v18 + 4), (int64_t)Task_k__BackingField, v9, v10, v11, v12, v13, v14);
  }
}