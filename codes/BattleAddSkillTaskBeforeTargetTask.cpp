        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BDB58 & 1) == 0 )
  {
    this = (BattleAddSkillTaskBeforeTargetTask_o *)sub_1B4CF90(
  ...
  if ( !arg
    ...
    || (Task_k__BackingField = (Il2CppObject *)arg->fields._Task_k__BackingField,
        ...
        !items) )
  {
    sub_1B4D1EC(v7, Task_k__BackingField);
  }
  ...
  else
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)(v14 + 4), (int32_t)Task_k__BackingField, v9, v10);
  }
}