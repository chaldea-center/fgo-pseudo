        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51240 & 1) == 0 )
  {
    this = (BattleAddSkillTaskBeforeTargetTask_o *)sub_1B863B8(
  ...
  if ( !arg
    ...
    || (Task_k__BackingField = (Il2CppObject *)arg->fields._Task_k__BackingField,
        ...
        !items) )
  {
    sub_1B86614(v7, Task_k__BackingField);
  }
  ...
  else
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)(v14 + 4), (int32_t)Task_k__BackingField, v9, v10);
  }
}