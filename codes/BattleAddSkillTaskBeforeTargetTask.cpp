        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA6BC & 1) == 0 )
  {
    this = (BattleAddSkillTaskBeforeTargetTask_o *)sub_1C1ABD4(
  ...
  if ( !arg
    ...
    || (Task_k__BackingField = (Il2CppObject *)arg->fields._Task_k__BackingField,
        ...
        !items) )
  {
    sub_1C1AE30(v7, Task_k__BackingField);
  }
  ...
  else
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)(v18 + 4), (int64_t)Task_k__BackingField, v9, v10, v11, v12, v13, v14);
  }
}