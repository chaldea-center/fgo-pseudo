        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB850E & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, *(_QWORD *)&posCount);
    ...
    sub_1C13D24(&StringLiteral_5690/*"EVENT_COMMAND_BUFF_POINT_COUNT_STOP"*/, v12);
    sub_1C13D24(&StringLiteral_5691/*"EVENT_CONQUEST_ARMAMENT_LABEL"*/, v13);
    sub_1C13D24(&StringLiteral_5696/*"EVENT_CONQUEST_GET_MESSAGE"*/, v14);
    byte_4BB850E = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(possessionCounterLabel, 0LL, 0LL) )
  {
    ...
    v17 = LocalizationManager__Get((System_String_o *)StringLiteral_5696/*"EVENT_CONQUEST_GET_MESSAGE"*/, 0LL);
    v38 = getCount;
    ...
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_5691/*"EVENT_CONQUEST_ARMAMENT_LABEL"*/, 0LL);
    v37 = posCount;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    transform = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5690/*"EVENT_COMMAND_BUFF_POINT_COUNT_STOP"*/, 0LL);
