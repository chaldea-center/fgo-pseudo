        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EE08 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_5586/*"EVENT_CONQUEST_GET_COUNT_LABEL"*/);
    sub_1B885B0(&StringLiteral_5587/*"EVENT_CONQUEST_GET_ITEM_FORMAT"*/);
    sub_1B885B0(&StringLiteral_5592/*"EVENT_CONQUEST_POS_ITEM_FORMAT"*/);
    byte_4A5EE08 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(possessionCounterLabel, 0LL, 0LL) )
  {
    ...
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5592/*"EVENT_CONQUEST_POS_ITEM_FORMAT"*/, 0LL);
    v32 = getCount;
    ...
    v18 = (System_Text_StringBuilder_o *)sub_1B887FC(System_Text_StringBuilder_TypeInfo);
    System_Text_StringBuilder___ctor(v18, 0LL);
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_5587/*"EVENT_CONQUEST_GET_ITEM_FORMAT"*/, 0LL);
    v31 = posCount;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    transform = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5586/*"EVENT_CONQUEST_GET_COUNT_LABEL"*/, 0LL);
