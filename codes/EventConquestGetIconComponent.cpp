        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0211F & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&posCount);
    ...
    sub_1B64870(&StringLiteral_5560/*"EVENT_CONQUEST_GET_COUNT_LABEL"*/, v12);
    sub_1B64870(&StringLiteral_5561/*"EVENT_CONQUEST_GET_ITEM_FORMAT"*/, v13);
    sub_1B64870(&StringLiteral_5566/*"EVENT_CONQUEST_POS_ITEM_FORMAT"*/, v14);
    byte_4A0211F = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(possessionCounterLabel, 0LL, 0LL) )
  {
    ...
    v17 = LocalizationManager__Get((System_String_o *)StringLiteral_5566/*"EVENT_CONQUEST_POS_ITEM_FORMAT"*/, 0LL);
    v38 = getCount;
