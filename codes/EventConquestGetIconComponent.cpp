        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEA0B & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_5602/*"EVENT_CONQUEST_GET_COUNT_LABEL"*/);
    sub_1CE6700(&StringLiteral_5603/*"EVENT_CONQUEST_GET_ITEM_FORMAT"*/);
    sub_1CE6700(&StringLiteral_5608/*"EVENT_CONQUEST_POS_ITEM_FORMAT"*/);
    byte_4DFEA0B = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(possessionCounterLabel, 0, 0) )
  {
    ...
    v11 = LocalizationManager__Get((System_String_o *)StringLiteral_5608/*"EVENT_CONQUEST_POS_ITEM_FORMAT"*/, 0);
    v26 = getCount;
    ...
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_5603/*"EVENT_CONQUEST_GET_ITEM_FORMAT"*/, 0);
    v25 = posCount;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    transform = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5602/*"EVENT_CONQUEST_GET_COUNT_LABEL"*/, 0);
