...
bool __fastcall SimpleSkillData__Equals(SimpleSkillData_o this, Il2CppObject *obj, const MethodInfo *method)
{
  ...
  if ( (byte_49BD4BA & 1) == 0 )
  {
    sub_1B4CF90(&SimpleSkillData_TypeInfo, obj);
    byte_49BD4BA = 1;
  }
  result = obj
...
bool __fastcall SimpleSkillData__Equals_43349900(
        SimpleSkillData_o this,
...
int32_t __fastcall SimpleSkillData__GetHashCode(SimpleSkillData_o this, const MethodInfo *method)
{
  ...
  if ( (byte_49BD4BB & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Tuple_Create_int__int___, method);
    byte_49BD4BB = 1;
  }
  int__int = System_Tuple__Create_int__int_(
               *(_DWORD *)this.fields.id,
               *(_DWORD *)(*(_QWORD *)&this + 4LL),
               (const MethodInfo_2FB2998 *)Method_System_Tuple_Create_int__int___);
  if ( !int__int )
    sub_1B4D1EC(0LL, v4);
