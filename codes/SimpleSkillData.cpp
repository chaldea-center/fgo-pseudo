...
bool __fastcall SimpleSkillData__Equals_43988296(
        SimpleSkillData_o this,
...
int32_t __fastcall SimpleSkillData__GetHashCode(SimpleSkillData_o this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDEAF1 & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Tuple_Create_int__int___);
    byte_4BDEAF1 = 1;
  }
  int__int = System_Tuple__Create_int__int_(
               *(_DWORD *)this.fields.id,
               *(_DWORD *)(*(_QWORD *)&this + 4LL),
               (const MethodInfo_30607EC *)Method_System_Tuple_Create_int__int___);
  if ( !int__int )
    sub_1C22094(0LL, v4);
