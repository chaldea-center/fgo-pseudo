...
bool SimpleSkillData__Equals_46785672(SimpleSkillData_o this, SimpleSkillData_o toCompare, const MethodInfo *method)
{
...
int32_t SimpleSkillData__GetHashCode(SimpleSkillData_o this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F266 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Tuple_Create_int__int___);
    byte_4D2F266 = 1;
  }
  int__int = System_Tuple__Create_int__int_(
               *(_DWORD *)this.fields.id,
               *(_DWORD *)(*(_QWORD *)&this + 4LL),
               (const MethodInfo_326E2F0 *)Method_System_Tuple_Create_int__int___);
  if ( !int__int )
    sub_1C942F0(0, v4);
