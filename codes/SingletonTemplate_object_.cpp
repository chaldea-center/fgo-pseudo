void __fastcall SingletonTemplate_object____cctor(const MethodInfo_2A718AC *method)
{
  ;
}


void __fastcall SingletonTemplate_object___Delete(const MethodInfo_2A716EC *method)
{
