void __fastcall SingletonTemplate_object____cctor(const MethodInfo_2A306A8 *method)
{
  ;
}


void __fastcall SingletonTemplate_object___Delete(const MethodInfo_2A304E8 *method)
{
  ...
  if ( (v4 & 1) == 0 )
  {
    sub_AF52C4(_0_SingletonTemplate_CLASS);
    v4 = WORD1(_0_SingletonTemplate_CLASS->vtable[0].methodPtr);
  }
  if ( (v4 & 0x400) != 0 )
  {
