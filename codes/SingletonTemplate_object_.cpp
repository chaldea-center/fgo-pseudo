void __fastcall SingletonTemplate_object____cctor(const MethodInfo_2B765F8 *method)
{
  ;
}


void __fastcall SingletonTemplate_object___Delete(const MethodInfo_2B76438 *method)
{
