void __fastcall SingletonTemplate_object____cctor(const MethodInfo_2841EB0 *method)
{
  ;
}


void __fastcall SingletonTemplate_object___Delete(const MethodInfo_2841CF0 *method)
{
  ...
  if ( (v4 & 1) == 0 )
  {
    sub_AC505C(_0_SingletonTemplate_CLASS);
    v4 = WORD1(_0_SingletonTemplate_CLASS->vtable[0].methodPtr);
  }
  if ( (v4 & 0x400) != 0 )
  {
