        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.messageLabelList, (int32_t)v4, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B41206 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Collections_Generic_List_UIWidget__get_Count__, v9);
    sub_1BDB878(&LocalizationManager_TypeInfo, v10);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v11);
    sub_1BDB878(&StringLiteral_11490/*"SELECT_BONUS_SKILL_INVALID"*/, v12);
    sub_1BDB878(&StringLiteral_1/*""*/, v13);
    sub_1BDB878(&StringLiteral_5525/*"EQUIP_GRAPH_USE"*/, v14);
    byte_4B41206 = 1;
  }
  if ( !v5 || !mode )
    return;
  ...
  if ( v5->fields.isInvalidRarity )
  {
    ...
    servantFaceIcon = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_11490/*"SELECT_BONUS_SKILL_INVALID"*/, 0LL);
    ...
    else
    {
      ...
      *(_QWORD *)(v29 + 32) = item;
      sub_1BDB81C((CGThumbnailListItem_o *)(v29 + 32), (int32_t)item, v24, v25);
    }
  }
  else
  {
...
LABEL_43:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  servantFaceIcon = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_5525/*"EQUIP_GRAPH_USE"*/, 0LL);
  if ( !warningLabel )
    goto LABEL_85;
  ...
  else
  {
    ...
    *(_QWORD *)(v42 + 32) = item;
    sub_1BDB81C((CGThumbnailListItem_o *)(v42 + 32), (int32_t)item, v37, v38);
  }
LABEL_45:
  servantFaceIcon = (__int64)this->fields.messageLabelList;
  if ( !servantFaceIcon )
  ...
  if ( v32 >= 1 )
  {
    if ( v32 == 1 && v5->fields.isInvalidRarity )
    {
      ...
      else
      {
        ...
        *(_QWORD *)(v33 + 40) = item;
        sub_1BDB81C((CGThumbnailListItem_o *)(v33 + 40), (int32_t)item, v30, v31);
      }
    }
    servantFaceIcon = (__int64)this->fields.messageLabelList;
    if ( servantFaceIcon )
