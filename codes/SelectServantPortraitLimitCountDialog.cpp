        ...
        const MethodInfo *method)
{
  ...
  SelectServantPortraitLimitCountDialog__Close_45515048(this, 0LL, v2);
}


void __fastcall SelectServantPortraitLimitCountDialog__Close_45515048(
        SelectServantPortraitLimitCountDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024DA & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_SelectServantPortraitLimitCountDialog_EndClose__, v6);
    byte_4A024DA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.statusAssetData )
  {
    ...
    if ( !System_String__IsNullOrEmpty(this->fields.statusAssetFolderName, 0LL) )
    {
      ...
      *p_statusAssetFolderName = 0LL;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.statusAssetFolderName, 0, v5, v6);
    }
  }
  ...
  if ( closeEndFunc )
  {
    ...
    sub_1B64814(p_closeEndFunc, 0, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024D6 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__, v6);
    byte_4A024D6 = 1;
  }
  this->fields.statusAssetData = data;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.statusAssetData, (int32_t)data, (int32_t)method, v3);
  ...
  if ( !portraitStatusList
    ...
    || (ServantStatusListViewManager__SetMode_33487516(portraitStatusList, 6, 0LL),
        ...
        !v9) )
  {
    sub_1B64ACC(portraitStatusList, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024D8 & 1) == 0 )
  {
    this = (SelectServantPortraitLimitCountDialog_o *)sub_1B64870(&ImageLimitCount_TypeInfo, *(_QWORD *)&ImgIndex);
    byte_4A024D8 = 1;
  }
      ...
      if ( v7 )
      {
        ...
        if ( v8 )
        {
          if ( v3 - (int)this >= v8->max_length )
            sub_1B64AD4(this, *(_QWORD *)&ImgIndex);
          return v8->m_Items[v3 - (int)this + 1];
        }
      }
LABEL_15:
      sub_1B64ACC(this, *(_QWORD *)&ImgIndex);
    }
  }
  return v3;
}
...
LABEL_19:
  if ( !System_String__IsNullOrEmpty(this->fields.statusAssetFolderName, 0LL) )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.statusAssetFolderName, 0, v12, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024D9 & 1) == 0 )
  {
    sub_1B64870(&Method_SelectServantPortraitLimitCountDialog_OnClickClose__, method);
    byte_4A024D9 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64888(Method_SelectServantPortraitLimitCountDialog_OnClickClose__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0LL);
  SelectServantPortraitLimitCountDialog__Close_45515048(this, 0LL, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024D7 & 1) == 0 )
  {
    sub_1B64870(&ImageLimitCount_TypeInfo, *(_QWORD *)&kind);
    sub_1B64870(&Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__, v6);
    byte_4A024D7 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B64888(Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__);
  ...
  SelectServantPortraitLimitCountDialog__Close_45515048(this, 0LL, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024D4 & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, userSvtCollectionEnt);
    sub_1B64870(&Method_SelectServantPortraitLimitCountDialog__Open_b__14_0__, v7);
    byte_4A024D4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024D5 & 1) == 0 )
  {
    sub_1B64870(&AssetManager_TypeInfo, onSetupEndCallback);
    sub_1B64870(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B64870(&ServantAssetLoadManager_TypeInfo, v6);
    sub_1B64870(&ServantStatusListViewItem_TypeInfo, v7);
    sub_1B64870(&Method_SelectServantPortraitLimitCountDialog___c__DisplayClass15_0__Setup_b__0__, v8);
    sub_1B64870(&SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo, v9);
    byte_4A024D5 = 1;
  }
  v10 = sub_1B64ABC(SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo);
  ...
  *(_QWORD *)(v10 + 24) = onSetupEndCallback;
  v15 = v10 + 24;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v10 + 24), (int32_t)onSetupEndCallback, v16, v17);
  userSvtCollectionEnt = this->fields.userSvtCollectionEnt;
  v19 = (ServantStatusListViewItem_o *)sub_1B64ABC(ServantStatusListViewItem_TypeInfo);
  ServantStatusListViewItem___ctor_32475268(v19, userSvtCollectionEnt, 0, 0, 0LL);
  this->fields.listViewItem = v19;
  p_listViewItem = &this->fields.listViewItem;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.listViewItem, (int32_t)v19, v21, v22);
...
LABEL_14:
  ...
  p_statusAssetFolderName = &this->fields.statusAssetFolderName;
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_statusAssetFolderName, (int32_t)StatusImageFolderName, v28, v29);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024DE & 1) == 0 )
  {
    ...
    sub_1B64870(&UnityEngine_Object_TypeInfo, v3);
    sub_1B64870(&Method_SelectServantPortraitLimitCountDialog___c__Open_b__14_1__, v4);
    sub_1B64870(&SelectServantPortraitLimitCountDialog___c_TypeInfo, v5);
    byte_4A024DE = 1;
  }
  ...
  if ( !v7 )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__14_1, (int32_t)v7, v10, v11);
  }
  if ( !this )
    goto LABEL_16;
...
void __fastcall SelectServantPortraitLimitCountDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A024DF & 1) == 0 )
  {
    sub_1B64870(&SelectServantPortraitLimitCountDialog___c_TypeInfo, v1);
    byte_4A024DF = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(SelectServantPortraitLimitCountDialog___c_TypeInfo);
