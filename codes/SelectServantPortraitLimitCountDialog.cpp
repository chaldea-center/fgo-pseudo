        ...
        const MethodInfo *method)
{
  ...
  SelectServantPortraitLimitCountDialog__Close_46308156(this, 0LL, v2);
}


void __fastcall SelectServantPortraitLimitCountDialog__Close_46308156(
        SelectServantPortraitLimitCountDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E02 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SelectServantPortraitLimitCountDialog_EndClose__, v6);
    byte_4AB9E02 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.statusAssetData )
  {
    ...
    if ( !System_String__IsNullOrEmpty(this->fields.statusAssetFolderName, 0LL) )
    {
      ...
      *p_statusAssetFolderName = 0LL;
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.statusAssetFolderName, 0, v5, v6);
    }
  }
  ...
  if ( closeEndFunc )
  {
    ...
    sub_1BAB3C0(p_closeEndFunc, 0, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9DFE & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__, v6);
    byte_4AB9DFE = 1;
  }
  this->fields.statusAssetData = data;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.statusAssetData, (int32_t)data, (int32_t)method, v3);
  ...
  if ( !portraitStatusList
    ...
    || (ServantStatusListViewManager__SetMode_34711652(portraitStatusList, 6, 0LL),
        ...
        !v9) )
  {
    sub_1BAB678(portraitStatusList, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E00 & 1) == 0 )
  {
    this = (SelectServantPortraitLimitCountDialog_o *)sub_1BAB41C(&ImageLimitCount_TypeInfo, *(_QWORD *)&ImgIndex);
    byte_4AB9E00 = 1;
  }
      ...
      if ( v7 )
      {
        ...
        if ( v8 )
        {
          if ( v3 - (int)this >= v8->max_length )
            sub_1BAB680(this, *(_QWORD *)&ImgIndex);
          return v8->m_Items[v3 - (int)this + 1];
        }
      }
LABEL_15:
      sub_1BAB678(this, *(_QWORD *)&ImgIndex);
    }
  }
  return v3;
}
...
LABEL_19:
  if ( !System_String__IsNullOrEmpty(this->fields.statusAssetFolderName, 0LL) )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.statusAssetFolderName, 0, v12, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E01 & 1) == 0 )
  {
    sub_1BAB41C(&Method_SelectServantPortraitLimitCountDialog_OnClickClose__, method);
    byte_4AB9E01 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BAB434(Method_SelectServantPortraitLimitCountDialog_OnClickClose__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BAB400(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0LL);
  SelectServantPortraitLimitCountDialog__Close_46308156(this, 0LL, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9DFF & 1) == 0 )
  {
    sub_1BAB41C(&ImageLimitCount_TypeInfo, *(_QWORD *)&kind);
    sub_1BAB41C(&Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__, v6);
    byte_4AB9DFF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BAB434(Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__);
  ...
  SelectServantPortraitLimitCountDialog__Close_46308156(this, 0LL, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9DFC & 1) == 0 )
  {
    sub_1BAB41C(&System_Action_TypeInfo, userSvtCollectionEnt);
    sub_1BAB41C(&Method_SelectServantPortraitLimitCountDialog__Open_b__14_0__, v7);
    byte_4AB9DFC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9DFD & 1) == 0 )
  {
    sub_1BAB41C(&AssetManager_TypeInfo, onSetupEndCallback);
    sub_1BAB41C(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1BAB41C(&ServantAssetLoadManager_TypeInfo, v6);
    sub_1BAB41C(&ServantStatusListViewItem_TypeInfo, v7);
    sub_1BAB41C(&Method_SelectServantPortraitLimitCountDialog___c__DisplayClass15_0__Setup_b__0__, v8);
    sub_1BAB41C(&SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo, v9);
    byte_4AB9DFD = 1;
  }
  v10 = sub_1BAB668(SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo);
  ...
  *(_QWORD *)(v10 + 24) = onSetupEndCallback;
  v15 = v10 + 24;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v10 + 24), (int32_t)onSetupEndCallback, v16, v17);
  userSvtCollectionEnt = this->fields.userSvtCollectionEnt;
  v19 = (ServantStatusListViewItem_o *)sub_1BAB668(ServantStatusListViewItem_TypeInfo);
  ServantStatusListViewItem___ctor_33659464(v19, userSvtCollectionEnt, 0, 0, 0LL);
  this->fields.listViewItem = v19;
  p_listViewItem = &this->fields.listViewItem;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.listViewItem, (int32_t)v19, v21, v22);
...
LABEL_14:
  ...
  p_statusAssetFolderName = &this->fields.statusAssetFolderName;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p_statusAssetFolderName, (int32_t)StatusImageFolderName, v28, v29);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E06 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v3);
    sub_1BAB41C(&Method_SelectServantPortraitLimitCountDialog___c__Open_b__14_1__, v4);
    sub_1BAB41C(&SelectServantPortraitLimitCountDialog___c_TypeInfo, v5);
    byte_4AB9E06 = 1;
  }
  ...
  if ( !v7 )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__14_1, (int32_t)v7, v10, v11);
  }
  if ( !this )
    goto LABEL_16;
...
void __fastcall SelectServantPortraitLimitCountDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E07 & 1) == 0 )
  {
    sub_1BAB41C(&SelectServantPortraitLimitCountDialog___c_TypeInfo, v1);
    byte_4AB9E07 = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(SelectServantPortraitLimitCountDialog___c_TypeInfo);
