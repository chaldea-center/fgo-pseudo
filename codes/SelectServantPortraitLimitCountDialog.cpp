        ...
        const MethodInfo *method)
{
  ...
  SelectServantPortraitLimitCountDialog__Close_32318476(this, 0, v2);
}


void SelectServantPortraitLimitCountDialog__Close_32318476(
        SelectServantPortraitLimitCountDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19EE & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SelectServantPortraitLimitCountDialog_EndClose__);
    byte_4CC19EE = 1;
  }
  ...
  if ( this->fields.statusAssetData )
  {
    ...
    if ( !System_String__IsNullOrEmpty(this->fields.statusAssetFolderName, 0) )
    {
      ...
      *p_statusAssetFolderName = 0;
      sub_1C71354(&this->fields.statusAssetFolderName, 0);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19EA & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__);
    byte_4CC19EA = 1;
  }
  this->fields.statusAssetData = data;
  sub_1C71354(&this->fields.statusAssetData, data);
  ...
  if ( !portraitStatusList
    ...
    || (ServantStatusListViewManager__SetMode_37768252(portraitStatusList, 6, 0),
        ...
        !v7) )
  {
    sub_1C71608(portraitStatusList, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19EC & 1) == 0 )
  {
    this = (SelectServantPortraitLimitCountDialog_o *)sub_1C713B0(&ImageLimitCount_TypeInfo);
    byte_4CC19EC = 1;
  }
...
LABEL_15:
      sub_1C71608(this, *(_QWORD *)&ImgIndex);
    }
  }
  return v3;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19ED & 1) == 0 )
  {
    sub_1C713B0(&Method_SelectServantPortraitLimitCountDialog_OnClickClose__);
    byte_4CC19ED = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_SelectServantPortraitLimitCountDialog_OnClickClose__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
  SelectServantPortraitLimitCountDialog__Close_32318476(this, 0, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1C713C8(Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__);
  ...
  SelectServantPortraitLimitCountDialog__Close_32318476(this, 0, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_SelectServantPortraitLimitCountDialog__Open_b__14_0__);
    byte_4CC19E8 = 1;
  }
  this->fields.userSvtCollectionEnt = userSvtCollectionEnt;
  sub_1C71354(&this->fields.userSvtCollectionEnt, userSvtCollectionEnt);
  this->fields.selectPortraitLimitCountCallback = selectPortraitLimitCountCallback;
  sub_1C71354(&this->fields.selectPortraitLimitCountCallback, selectPortraitLimitCountCallback);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19E9 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SelectServantPortraitLimitCountDialog___c__DisplayClass15_0__Setup_b__0__);
    sub_1C713B0(&SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo);
    byte_4CC19E9 = 1;
  }
  v5 = (Il2CppObject *)sub_1C715FC(SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo);
  ...
  sub_1C71354(&v5[1].monitor, onSetupEndCallback);
  userSvtCollectionEnt = this->fields.userSvtCollectionEnt;
  v10 = (ServantStatusListViewItem_o *)sub_1C715FC(ServantStatusListViewItem_TypeInfo);
  ServantStatusListViewItem___ctor_35624244(v10, userSvtCollectionEnt, 0, 0, 0);
  this->fields.listViewItem = v10;
  p_listViewItem = &this->fields.listViewItem;
  sub_1C71354(&this->fields.listViewItem, v10);
...
LABEL_14:
  ...
  p_statusAssetFolderName = &this->fields.statusAssetFolderName;
  sub_1C71354(p_statusAssetFolderName, StatusImageFolderName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC19F2 & 1) == 0 )
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&Method_SelectServantPortraitLimitCountDialog___c__Open_b__14_1__);
    sub_1C713B0(&SelectServantPortraitLimitCountDialog___c_TypeInfo);
    byte_4CC19F2 = 1;
  }
  ...
  if ( !v4 )
  {
    ...
    v3 = (void *)sub_1C71354(&static_fields->__9__14_1, v4);
  }
  if ( !this )
    goto LABEL_16;
...
void SelectServantPortraitLimitCountDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(SelectServantPortraitLimitCountDialog___c_TypeInfo);
  ...
  sub_1C71354(SelectServantPortraitLimitCountDialog___c_TypeInfo->static_fields, v1);
}
