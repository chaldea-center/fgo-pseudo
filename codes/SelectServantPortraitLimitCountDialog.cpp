        ...
        const MethodInfo *method)
{
  ...
  SelectServantPortraitLimitCountDialog__Close_46877412(this, 0LL, v2);
}


void __fastcall SelectServantPortraitLimitCountDialog__Close_46877412(
        SelectServantPortraitLimitCountDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3B4 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_SelectServantPortraitLimitCountDialog_EndClose__, v10);
    byte_4B3B3B4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.statusAssetData )
  {
    ...
    if ( !System_String__IsNullOrEmpty(this->fields.statusAssetFolderName, 0LL) )
    {
      ...
      *p_statusAssetFolderName = 0LL;
      sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.statusAssetFolderName, 0LL, v5, v6, v7, v8, v9, v10);
    }
  }
  ...
  if ( closeEndFunc )
  {
    ...
    sub_1BD33FC(p_closeEndFunc, 0LL, v13, v14, v15, v16, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3B0 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__, v10);
    byte_4B3B3B0 = 1;
  }
  ...
  if ( !portraitStatusList
    ...
    || (ServantStatusListViewManager__SetMode_34855640(portraitStatusList, 6, 0LL),
        v13 = this->fields.portraitStatusList,
        v14 = (ServantStatusListViewManager_CallbackFunc_o *)sub_1BD36A4(ServantStatusListViewManager_CallbackFunc_TypeInfo),
        ...
        !v13) )
  {
    sub_1BD36B4(portraitStatusList, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3B2 & 1) == 0 )
  {
    this = (SelectServantPortraitLimitCountDialog_o *)sub_1BD3458(&ImageLimitCount_TypeInfo, *(_QWORD *)&ImgIndex);
    byte_4B3B3B2 = 1;
  }
      ...
      if ( v7 )
      {
        ...
        if ( v8 )
        {
          if ( v3 - (int)this >= v8->max_length )
            sub_1BD36BC(this, *(_QWORD *)&ImgIndex);
          return v8->m_Items[v3 - (int)this + 1];
        }
      }
LABEL_15:
      sub_1BD36B4(this, *(_QWORD *)&ImgIndex);
    }
  }
  return v3;
}
...
LABEL_19:
  if ( !System_String__IsNullOrEmpty(this->fields.statusAssetFolderName, 0LL) )
  {
    ...
    sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.statusAssetFolderName, 0LL, v12, v13, v14, v15, v16, v17);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3B3 & 1) == 0 )
  {
    sub_1BD3458(&Method_SelectServantPortraitLimitCountDialog_OnClickClose__, method);
    byte_4B3B3B3 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnClickClose__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BD3470(Method_SelectServantPortraitLimitCountDialog_OnClickClose__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BD343C(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0LL);
  SelectServantPortraitLimitCountDialog__Close_46877412(this, 0LL, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3B1 & 1) == 0 )
  {
    sub_1BD3458(&ImageLimitCount_TypeInfo, *(_QWORD *)&kind);
    sub_1BD3458(&Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__, v6);
    byte_4B3B3B1 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BD3470(Method_SelectServantPortraitLimitCountDialog_OnSelectPortraitLimitCount__);
  ...
  SelectServantPortraitLimitCountDialog__Close_46877412(this, 0LL, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3AE & 1) == 0 )
  {
    sub_1BD3458(&System_Action_TypeInfo, userSvtCollectionEnt);
    sub_1BD3458(&Method_SelectServantPortraitLimitCountDialog__Open_b__14_0__, v11);
    byte_4B3B3AE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3AF & 1) == 0 )
  {
    sub_1BD3458(&AssetManager_TypeInfo, onSetupEndCallback);
    sub_1BD3458(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1BD3458(&ServantAssetLoadManager_TypeInfo, v6);
    sub_1BD3458(&ServantStatusListViewItem_TypeInfo, v7);
    sub_1BD3458(&Method_SelectServantPortraitLimitCountDialog___c__DisplayClass15_0__Setup_b__0__, v8);
    sub_1BD3458(&SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo, v9);
    byte_4B3B3AF = 1;
  }
  v10 = sub_1BD36A4(SelectServantPortraitLimitCountDialog___c__DisplayClass15_0_TypeInfo);
  ...
  *(_QWORD *)(v10 + 24) = onSetupEndCallback;
  v19 = v10 + 24;
  sub_1BD33FC((PartyOrganizationUtility_o *)(v10 + 24), (int64_t)onSetupEndCallback, v20, v21, v22, v23, v24, v25);
  userSvtCollectionEnt = this->fields.userSvtCollectionEnt;
  v27 = (ServantStatusListViewItem_o *)sub_1BD36A4(ServantStatusListViewItem_TypeInfo);
  ServantStatusListViewItem___ctor_33934024(v27, userSvtCollectionEnt, 0, 0, 0LL);
  this->fields.listViewItem = v27;
  p_listViewItem = &this->fields.listViewItem;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.listViewItem, (int64_t)v27, v29, v30, v31, v32, v33, v34);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3B8 & 1) == 0 )
  {
    ...
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v3);
    sub_1BD3458(&Method_SelectServantPortraitLimitCountDialog___c__Open_b__14_1__, v4);
    sub_1BD3458(&SelectServantPortraitLimitCountDialog___c_TypeInfo, v5);
    byte_4B3B3B8 = 1;
  }
  ...
  if ( !v7 )
  {
    ...
    sub_1BD33FC((PartyOrganizationUtility_o *)&static_fields->__9__14_1, (int64_t)v7, v10, v11, v12, v13, v14, v15);
  }
  if ( !this )
    goto LABEL_16;
...
void __fastcall SelectServantPortraitLimitCountDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3B3B9 & 1) == 0 )
  {
    sub_1BD3458(&SelectServantPortraitLimitCountDialog___c_TypeInfo, v1);
    byte_4B3B3B9 = 1;
  }
  v2 = (Il2CppObject *)sub_1BD36A4(SelectServantPortraitLimitCountDialog___c_TypeInfo);
