...
void __fastcall SupportSelectConfirmMenu__Close(SupportSelectConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  SupportSelectConfirmMenu__Close_34326716(this, 0LL, v2);
}


void __fastcall SupportSelectConfirmMenu__Close_34326716(
        SupportSelectConfirmMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4312 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_SupportSelectConfirmMenu_EndClose__, v10);
    byte_4BC4312 = 1;
  }
...
void __fastcall SupportSelectConfirmMenu__OnCancelClose(SupportSelectConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC4314 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SupportSelectConfirmMenu_OnCancelClose__, method);
    byte_4BC4314 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmMenu_OnCancelClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_SupportSelectConfirmMenu_OnCancelClose__);
...
void __fastcall SupportSelectConfirmMenu__OnClickClose(SupportSelectConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC4313 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SupportSelectConfirmMenu_OnClickClose__, method);
    byte_4BC4313 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmMenu_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_SupportSelectConfirmMenu_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
...
void __fastcall SupportSelectConfirmMenu__OnDecideClose(SupportSelectConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC4315 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SupportSelectConfirmMenu_OnDecideClose__, method);
    byte_4BC4315 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmMenu_OnDecideClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_SupportSelectConfirmMenu_OnDecideClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    SupportSelectConfirmMenu__Callback(this, 1, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4310 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_1/*""*/, *(_QWORD *)&kind);
    byte_4BC4310 = 1;
  }
  SupportSelectConfirmMenu__Open_34325308(
    this,
    kind,
    callback,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SupportSelectConfirmMenu__Open_34325308(
        SupportSelectConfirmMenu_o *this,
        int32_t kind,
        SupportSelectConfirmMenu_CallbackFunc_o *callback,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC4311 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_SupportSelectConfirmMenu_EndOpen__, v14);
    sub_1C1ABD4(&StringLiteral_12681/*"SUPPORT_SELECT_EQUIP_CHANGE_TITLE"*/, v15);
    sub_1C1ABD4(&StringLiteral_12644/*"SUPPORT_SELECT_ALL_CLEAR_TITLE"*/, v16);
    sub_1C1ABD4(&StringLiteral_12683/*"SUPPORT_SELECT_EQUIP_CLEAR_WARNING"*/, v17);
    sub_1C1ABD4(&StringLiteral_12698/*"SUPPORT_SELECT_WARNING_DIALOG_CLOSE"*/, v18);
    sub_1C1ABD4(&StringLiteral_12693/*"SUPPORT_SELECT_SERVANT_CLEAR_TITLE"*/, v19);
    sub_1C1ABD4(&StringLiteral_12690/*"SUPPORT_SELECT_NO_SERVANT_TITLE"*/, v20);
    sub_1C1ABD4(&StringLiteral_12691/*"SUPPORT_SELECT_NO_SERVANT_WARNING"*/, v21);
    sub_1C1ABD4(&StringLiteral_12680/*"SUPPORT_SELECT_EQUIP_CHANGE_MESSAGE"*/, v22);
    sub_1C1ABD4(&StringLiteral_12699/*"SUPPORT_SELECT_WARNING_DIALOG_DECIDE"*/, v23);
    sub_1C1ABD4(&StringLiteral_12694/*"SUPPORT_SELECT_SERVANT_CLEAR_WARNING"*/, v24);
    sub_1C1ABD4(&StringLiteral_12697/*"SUPPORT_SELECT_WARNING_DIALOG_CANCEL"*/, v25);
    sub_1C1ABD4(&StringLiteral_12645/*"SUPPORT_SELECT_ALL_CLEAR_WARNING"*/, v26);
    sub_1C1ABD4(&StringLiteral_12682/*"SUPPORT_SELECT_EQUIP_CLEAR_TITLE"*/, v27);
    byte_4BC4311 = 1;
  }
...
LABEL_61:
    ...
    switch ( kind )
    {
      case 1:
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12690/*"SUPPORT_SELECT_NO_SERVANT_TITLE"*/, 0LL);
        if ( !titleLabel )
          goto LABEL_61;
        UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
        messageLabel = this->fields.messageLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12691/*"SUPPORT_SELECT_NO_SERVANT_WARNING"*/, 0LL);
        if ( !messageLabel )
          goto LABEL_61;
      ...
      case 2:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12693/*"SUPPORT_SELECT_SERVANT_CLEAR_TITLE"*/, 0LL);
        if ( !v33 )
          goto LABEL_61;
        UILabel__set_text(v33, (System_String_o *)gameObject, 0LL);
        v34 = this->fields.messageLabel;
        v35 = &StringLiteral_12694/*"SUPPORT_SELECT_SERVANT_CLEAR_WARNING"*/;
        goto LABEL_30;
      case 3:
        v36 = this->fields.titleLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12682/*"SUPPORT_SELECT_EQUIP_CLEAR_TITLE"*/, 0LL);
        if ( !v36 )
          goto LABEL_61;
        UILabel__set_text(v36, (System_String_o *)gameObject, 0LL);
        v34 = this->fields.messageLabel;
        v35 = &StringLiteral_12683/*"SUPPORT_SELECT_EQUIP_CLEAR_WARNING"*/;
        goto LABEL_30;
      case 4:
        v37 = this->fields.titleLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12644/*"SUPPORT_SELECT_ALL_CLEAR_TITLE"*/, 0LL);
        if ( !v37 )
          goto LABEL_61;
        UILabel__set_text(v37, (System_String_o *)gameObject, 0LL);
        v34 = this->fields.messageLabel;
        v35 = &StringLiteral_12645/*"SUPPORT_SELECT_ALL_CLEAR_WARNING"*/;
LABEL_30:
...
LABEL_45:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12698/*"SUPPORT_SELECT_WARNING_DIALOG_CLOSE"*/, 0LL);
        if ( !closeLabel )
          goto LABEL_61;
        UILabel__set_text(closeLabel, (System_String_o *)gameObject, 0LL);
        cancelLabel = this->fields.cancelLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12697/*"SUPPORT_SELECT_WARNING_DIALOG_CANCEL"*/, 0LL);
        if ( !cancelLabel )
          goto LABEL_61;
        UILabel__set_text(cancelLabel, (System_String_o *)gameObject, 0LL);
        decideLabel = this->fields.decideLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12699/*"SUPPORT_SELECT_WARNING_DIALOG_DECIDE"*/, 0LL);
        if ( !decideLabel )
          goto LABEL_61;
...
LABEL_60:
      ...
      case 5:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12681/*"SUPPORT_SELECT_EQUIP_CHANGE_TITLE"*/, 0LL);
        if ( !v40 )
          goto LABEL_61;
        UILabel__set_text(v40, (System_String_o *)gameObject, 0LL);
        v41 = this->fields.messageLabel;
        v42 = LocalizationManager__Get((System_String_o *)StringLiteral_12680/*"SUPPORT_SELECT_EQUIP_CHANGE_MESSAGE"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC430D & 1) == 0 )
  {
    sub_1C1ABD4(&SupportSelectConfirmMenu_CallbackFunc_TypeInfo, value);
    byte_4BC430D = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A58A68;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A58A20;
}
