void EventInfoDialogLoader_object____ctor(EventInfoDialogLoader_TDialog__o *this, const MethodInfo_42320B4 *method)
{
...
void EventInfoDialogLoader_object___Load(
        ...
        const MethodInfo_4231EC4 *method)
{
  ...
  if ( (*(_WORD *)(_0_EventInfoDialogLoader___c__DisplayClass0_0_TDialog + 309) & 1) == 0 )
    _0_EventInfoDialogLoader___c__DisplayClass0_0_TDialog = sub_2237AF8();
  v12 = sub_21FFEBC(_0_EventInfoDialogLoader___c__DisplayClass0_0_TDialog);
  EventInfoDialogLoader___c__DisplayClass0_0_object____ctor(
    (EventInfoDialogLoader___c__DisplayClass0_0_TDialog__o *)v12,
    (const MethodInfo_3ACC31C *)method->klass->rgctx_data->_1_EventInfoDialogLoader___c__DisplayClass0_0_TDialog___ctor);
  if ( !v12 )
    sub_21FFECC(v13, v14);
  *(_QWORD *)(v12 + 16) = prefabName;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v12 + 16), (int32_t)prefabName, v15, v16, v17, v18, v19, v20);
  *(_QWORD *)(v12 + 24) = assetPath;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v12 + 24), (int32_t)assetPath, v21, v22, v23, v24, v25, v26);
  *(_QWORD *)(v12 + 32) = onLoaded;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v12 + 32), (int32_t)onLoaded, v27, v28, v29, v30, v31, v32);
  *(_QWORD *)(v12 + 40) = parent;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v12 + 40), (int32_t)parent, v33, v34, v35, v36, v37, v38);
  ...
  v42 = (AssetLoader_LoadEndDataHandler_o *)sub_21FFEBC(AssetLoader_LoadEndDataHandler_TypeInfo);
...
LABEL_12:
    ActionExtensions__Call_object_(
      *(System_Action_T__o **)(v12 + 32),
      0,
      (const MethodInfo_36CDF5C *)method->klass->rgctx_data->_4_ActionExtensions_Call_TDialog_);
}
...
void EventInfoDialogLoader_object___Release(
        EventInfoDialogLoader_TDialog__o *this,
        System_String_o *assetPath,
        const MethodInfo_423205C *method)
{
  if ( (byte_593F766 & 1) == 0 )
  {
    sub_21FFC50(&AssetManager_TypeInfo);
