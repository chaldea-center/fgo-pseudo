        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B025FC & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_CommonEffectActionComponent___, v6);
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v8);
    sub_1BC3008(&Method_EventInfoCircleProgressDrawComponent___c__DisplayClass40_0__PlayCompleteAnim_b__0__, v9);
    sub_1BC3008(&Method_EventInfoCircleProgressDrawComponent___c__DisplayClass40_0__PlayCompleteAnim_b__1__, v10);
    sub_1BC3008(&EventInfoCircleProgressDrawComponent___c__DisplayClass40_0_TypeInfo, v11);
    byte_4B025FC = 1;
  }
  v12 = sub_1BC3254(EventInfoCircleProgressDrawComponent___c__DisplayClass40_0_TypeInfo);
  ...
  *(_QWORD *)(v12 + 24) = endAction;
  ...
  GameObjectExtensions__SafeSetParent_35217712(v21, gameObject, 0LL);
  if ( !v21 )
    goto LABEL_20;
  ...
  *(_QWORD *)(v12 + 32) = Component_object;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v12 + 32), (int32_t)Component_object, v24, v25);
...
LABEL_20:
    sub_1BC3264(progressBarCompleteSprite, v14);
  }
  ...
  if ( !v26 )
    goto LABEL_20;
  v26[2].monitor = v27;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v26[2].monitor, (int32_t)v27, v28, v29);
  ...
  System_Action___ctor(
    ...
    0LL);
  v31 = BasicHelper__DelayCall(0.066, v30, 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B025FB & 1) == 0 )
  {
    sub_1BC3008(&int_TypeInfo, endAction);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B025FA & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_EventInfoCircleProgressDrawComponent___c__DisplayClass38_0__PlayProgressBarAnim_b__0__, v8);
    sub_1BC3008(&EventInfoCircleProgressDrawComponent___c__DisplayClass38_0_TypeInfo, v9);
    byte_4B025FA = 1;
  }
  v10 = sub_1BC3254(EventInfoCircleProgressDrawComponent___c__DisplayClass38_0_TypeInfo);
  ...
  *(_QWORD *)(v10 + 32) = endAction;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v10 + 32), (int32_t)endAction, v15, v16);
  ...
  *(float *)(v10 + 28) = v20;
  ...
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this->fields.progressBarBgSprite, 0LL);
  GameObjectExtensions__SafeSetParent_35217712(v22, gameObject, 0LL);
  ...
  {
    v28 = BasicHelper__DelayCall(0.7, v24, 1, 0LL);
...
LABEL_16:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&Component_object[2].monitor, (int32_t)v24, v26, v27);
}
        ...
        const MethodInfo *method)
{
  ...
  EventInfoCircleProgressDrawComponent_ImageInfo_o *v40; // x28
  ...
  if ( (byte_4B025F8 & 1) == 0 )
  {
    sub_1BC3008(&int_TypeInfo, circleProgressCtrl);
    sub_1BC3008(&LocalizationManager_TypeInfo, v11);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v12);
    sub_1BC3008(&StringLiteral_8183/*"LEVEL_INFO"*/, v13);
    sub_1BC3008(&StringLiteral_17033/*"bit_circlemeter_gain"*/, v14);
    sub_1BC3008(&StringLiteral_17475/*"bufficon_{0:D2}"*/, v15);
    sub_1BC3008(&StringLiteral_17032/*"bit_circlemeter_comptext"*/, v16);
  ...
  if ( progressData )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.progressData, (int32_t)progressData, v18, v19);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_8183/*"LEVEL_INFO"*/, 0LL);
    ...
    v48 = (int)v33;
    v35 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v48, v30, v31, v32);
    nameLabel = (UILabel_o *)System_String__Format((System_String_o *)StringLiteral_17475/*"bufficon_{0:D2}"*/, v35, 0LL);
    ...
    if ( !imageInfoList )
      goto LABEL_33;
    v38 = *(_QWORD *)&imageInfoList->max_length;
    if ( (int)v38 >= 1 )
    {
      v39 = 0LL;
      do
      {
        if ( v39 >= (unsigned int)v38 )
          sub_1BC326C(nameLabel, v20, v36);
        v40 = imageInfoList->m_Items[v39];
        if ( v40 )
        {
          Sprite = (UnityEngine_Object_o *)v40->fields.Sprite;
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          ...
          if ( ((unsigned __int8)nameLabel & 1) == 0 )
            nameLabel = (UILabel_o *)EventInfoUIBase__SetSpriteByLocalAtlas(
                                       (EventInfoUIBase_o *)circleProgressCtrl,
                                       v40->fields.Sprite,
                                       v40->fields.SpriteName,
                                       0LL);
        }
        LODWORD(v38) = imageInfoList->max_length;
        ++v39;
      }
    ...
    if ( !nameLabel
      ...
      || (GameObjectFromEventUIAssetData = EventInfoUIBase__GetGameObjectFromEventUIAssetData(
                                             ...
                                             (System_String_o *)StringLiteral_17033/*"bit_circlemeter_gain"*/,
                                             0LL),
    ...
    {
LABEL_33:
      sub_1BC3264(nameLabel, v20);
    }
    v45 = EventInfoUIBase__GetGameObjectFromEventUIAssetData(
            (EventInfoUIBase_o *)nameLabel,
            (System_String_o *)StringLiteral_17032/*"bit_circlemeter_comptext"*/,
            0LL);
    this->fields.completedAnimPrefab = v45;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.completedAnimPrefab, (int32_t)v45, v46, v47);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B025F9 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_20099/*"img_LeaderIcon{0:D2}"*/, v6);
    byte_4B025F9 = 1;
  }
...
LABEL_16:
  ...
  else
  {
    ...
    SelfUserGame = (UnityEngine_Component_o *)System_String__Format((System_String_o *)StringLiteral_20099/*"img_LeaderIcon{0:D2}"*/, v14, 0LL);
    if ( !circleProgressCtrl )
      goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B025FD & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_GameObjectExtensions_SafeGetComponent_EasingObject___, v3);
    sub_1BC3008(&Method_EventInfoCircleProgressDrawComponent___c__DisplayClass38_0__PlayProgressBarAnim_b__2__, v4);
    sub_1BC3008(&Method_EventInfoCircleProgressDrawComponent___c__DisplayClass38_1__PlayProgressBarAnim_b__1__, v5);
    sub_1BC3008(&EventInfoCircleProgressDrawComponent___c__DisplayClass38_1_TypeInfo, v6);
    byte_4B025FD = 1;
  }
  v7 = sub_1BC3254(EventInfoCircleProgressDrawComponent___c__DisplayClass38_1_TypeInfo);
  ...
  *(_QWORD *)(v7 + 16) = Component_object;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v7 + 16), (int32_t)Component_object, v15, v16);
  ...
  if ( !_9__2 )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.__9__2, (int32_t)_9__2, v22, v23);
  }
  if ( !v18 )
LABEL_11:
    sub_1BC3264(progressBarSprite, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B025FE & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_17032/*"bit_circlemeter_comptext"*/, method);
    byte_4B025FE = 1;
  }
  anim = this->fields.anim;
  if ( !anim )
    sub_1BC3264(0LL, method);
  UnityEngine_Animation__Play_69779584(anim, (System_String_o *)StringLiteral_17032/*"bit_circlemeter_comptext"*/, 0LL);
}