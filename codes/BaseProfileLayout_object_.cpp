void BaseProfileLayout_object____ctor(BaseProfileLayout_TLayout__o *this, const MethodInfo_3E58DF4 *method)
{
...
void BaseProfileLayout_object___IProfileLayout_ApplyLayout(
        ...
        const MethodInfo_3E58DB0 *method)
{
  ...
  ClampedValueSafely_object = ArrayHelper__GetClampedValueSafely_object_(
                                ...
                                profileIndex,
                                0,
                                (const MethodInfo_37CEDB0 *)method->klass->rgctx_data->_3_ArrayHelper_GetClampedValueSafely_TLayout_);
