        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C42A31 & 1) == 0 )
  {
    sub_1C37058(&SimpleSkillData___TypeInfo);
    byte_4C42A31 = 1;
  }
  v6 = 0;
  if ( skillIds )
  {
    if ( skillLvs )
    {
      ...
      v8 = sub_1C37100(SimpleSkillData___TypeInfo, (unsigned int)max_length);
      v6 = v8;
      if ( (int)max_length >= 1 )
      {
        v9 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    if ( grandSvt == 1 )
      v6 = 52;
    result = (System_Int64_array *)sub_1C37100(
                                     long___TypeInfo,
...
int32_t BattleUserServantData__getBattleSvtId(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v8.fields.fakeValue = v3;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v8, 0) == 1
