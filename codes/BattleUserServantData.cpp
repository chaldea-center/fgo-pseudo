        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C2C6 & 1) == 0 )
  {
    sub_1C94098(&SimpleSkillData___TypeInfo);
    byte_4D2C2C6 = 1;
  }
  v6 = 0;
  if ( skillIds )
  {
    if ( skillLvs )
    {
      ...
      v8 = sub_1C94140(SimpleSkillData___TypeInfo, (unsigned int)max_length);
      v6 = v8;
      if ( (int)max_length >= 1 )
      {
        v9 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    if ( grandSvt == 1 )
      v6 = 52;
    result = (System_Int64_array *)sub_1C94140(
                                     long___TypeInfo,
...
int32_t BattleUserServantData__getBattleSvtId(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v8.fields.fakeValue = v3;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v8, 0) == 1
