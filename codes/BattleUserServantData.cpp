        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F96D & 1) == 0 )
  {
    sub_1B90010(&SimpleSkillData___TypeInfo, skillIds);
    byte_4A6F96D = 1;
  }
  v6 = 0LL;
  if ( skillIds )
  {
    if ( skillLvs )
    {
      ...
      v8 = sub_1B900B8(SimpleSkillData___TypeInfo, (unsigned int)v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    result = (System_Int64_array *)sub_1B900B8(long___TypeInfo, (unsigned int)v5->static_fields->SvtEquipMax);
    if ( !result )
      sub_1B9026C(0LL, v6);
...
int32_t __fastcall BattleUserServantData__getBattleSvtId(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v8.fields.fakeValue = v3;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v8, 0LL) == 1
        ...
        const MethodInfo *method)
{
  ...
  if ( !items )
LABEL_12:
    sub_1B9026C(BattleSkillIdList, v11);
  while ( 1 )
  {
