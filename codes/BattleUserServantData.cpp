        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36C86 & 1) == 0 )
  {
    sub_1BD3458(&SimpleSkillData___TypeInfo, skillIds);
    byte_4B36C86 = 1;
  }
  v6 = 0LL;
  if ( skillIds )
  {
    if ( skillLvs )
    {
      ...
      v8 = sub_1BD3500(SimpleSkillData___TypeInfo, (unsigned int)v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    result = (System_Int64_array *)sub_1BD3500(long___TypeInfo, (unsigned int)v5->static_fields->SvtEquipMax);
    if ( !result )
      sub_1BD36B4(0LL, v6);
...
int32_t __fastcall BattleUserServantData__getBattleSvtId(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v8.fields.fakeValue = v3;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47136620(v8, 0LL) == 1
        ...
        const MethodInfo *method)
{
  ...
  if ( !items )
LABEL_12:
    sub_1BD36B4(BattleSkillIdList, v11);
  while ( 1 )
  {
