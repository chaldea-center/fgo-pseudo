        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5AC64 & 1) == 0 )
  {
    sub_1B885B0(&SimpleSkillData___TypeInfo);
    byte_4A5AC64 = 1;
  }
  v6 = 0LL;
  if ( skillIds )
  {
    if ( skillLvs )
    {
      ...
      v8 = sub_1B88658(SimpleSkillData___TypeInfo, (unsigned int)v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    result = (System_Int64_array *)sub_1B88658(long___TypeInfo, (unsigned int)v4->static_fields->SvtEquipMax);
    if ( !result )
      sub_1B8880C(0LL, v5);
...
int32_t __fastcall BattleUserServantData__getBattleSvtId(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v8.fields.fakeValue = v3;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v8, 0LL) == 1
