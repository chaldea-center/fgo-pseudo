        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_597029B & 1) == 0 )
  {
    sub_2213A60(&SimpleSkillData___TypeInfo);
    byte_597029B = 1;
  }
  v6 = 0;
  if ( skillIds )
  {
    if ( skillLvs )
    {
      ...
      v8 = sub_2213B20(SimpleSkillData___TypeInfo, (unsigned int)max_length);
      v6 = v8;
      if ( (int)max_length >= 1 )
      {
        v9 = 0;
        do
        {
          if ( v9 >= LODWORD(skillIds->max_length) || v9 >= LODWORD(skillLvs->max_length) )
            goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    if ( grandSvt == 1 )
    {
      ...
      p_GrandSvtEquipMax = &v5->static_fields->GrandSvtEquipMax;
    }
    else
    {
      if ( !v6 )
      ...
      p_GrandSvtEquipMax = &v5->static_fields->SvtEquipMax;
    }
    result = (System_Int64_array *)sub_2213B20(long___TypeInfo, (unsigned int)*p_GrandSvtEquipMax);
    if ( !result )
      sub_2213CDC(0, v8);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    LODWORD(skillId1) = this->fields.skillId2;
    ++v3->fields._version;
  }
  v9 = v3->fields._size;
...
int32_t BattleUserServantData__getBattleSvtId(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  v3 = *(_QWORD *)&this->fields.dispLimitCount.fields.currentCryptoKey;
  ...
  *(_QWORD *)&v9.fields.fakeValue = v4;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v9, 0) == 1
...
System_Int32_array *BattleUserServantData__getSkillLevelList(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  if ( !BattleSkillIdList || !v4 )
    goto LABEL_13;
  v8 = LODWORD(BattleSkillIdList->max_length) - v4->fields._size;
  if ( v8 >= 1 )
  {
...
LABEL_13:
    sub_2213CDC(BattleSkillIdList, v7);
  }
  return System_Collections_Generic_List_int___ToArray(
           v4,
           (const MethodInfo_4468CF0 *)Method_System_Collections_Generic_List_int__ToArray__);
