        ...
        const MethodInfo *method)
{
  ...
  return BattleUserServantData__MakeSimpleSkillArray((BattleUserServantData_o *)AddPassiveSkill, v6, addPassiveLvs, v4);
}
...
LABEL_24:
  ...
  if ( max_length >= 1 )
  {
    ...
    do
    {
      if ( v9 >= max_length )
        sub_1C32E84(v6);
      v10 = classBoardAddPassiveSkills->m_Items[v9];
      if ( !v10 )
        goto LABEL_24;
      if ( !v4 )
        goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C37441 & 1) == 0 )
  {
    sub_1C32C20(&SimpleSkillData___TypeInfo);
    byte_4C37441 = 1;
  }
  v6 = 0;
  if ( skillIds )
  {
    if ( skillLvs )
    {
      ...
      v8 = sub_1C32CC8(SimpleSkillData___TypeInfo, (unsigned int)max_length);
      v6 = v8;
      if ( (int)max_length >= 1 )
      {
        v9 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
  {
    ...
    if ( grandSvt == 1 )
      v6 = 52;
    result = (System_Int64_array *)sub_1C32CC8(
                                     long___TypeInfo,
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    items->m_Items[v10] = skillId2;
  }
  skillId3 = this->fields.skillId3;
  ++v3->fields._version;
  if ( !items )
    goto LABEL_27;
  v12 = v3->fields._size;
...
int32_t BattleUserServantData__getBattleSvtId(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v8.fields.fakeValue = v3;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v8, 0) == 1
...
System_Int32_array *BattleUserServantData__getSkillLevelList(BattleUserServantData_o *this, const MethodInfo *method)
{
  ...
  if ( !BattleSkillIdList || !v4 )
    goto LABEL_12;
  size = v4->fields._size;
  v8 = LODWORD(BattleSkillIdList->max_length) - size;
  if ( v8 < 1 )
    return System_Collections_Generic_List_int___ToArray(
             v4,
             (const MethodInfo_377D250 *)Method_System_Collections_Generic_List_int__ToArray__);
