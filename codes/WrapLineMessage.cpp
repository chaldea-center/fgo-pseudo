        ...
        const MethodInfo *method)
{
  ...
  if ( WrapLineMessage__IsWrapTextSize(this, tempTxt, (const MethodInfo *)addLabel) )
  {
    ...
    System_Text_StringBuilder__Append_75735064(tempTxt, v9, 0);
  }
}
...
UILabel_o *WrapLineMessage__GetWrapCheckLabel(WrapLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(wrapCheckLabel, 0, 0) )
  {
    ...
    sub_2213A04(
      (MissionNaviTransitionBoardItem_o *)&this->fields._wrapCheckLabel,
      (int32_t)MainLabel,
      v5,
      v6,
      v7,
...
void WrapLineMessage__Init(WrapLineMessage_o *this, System_String_o *text, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.originalText, (int32_t)text, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  v7 = this->fields.startPosition.fields.x;
  Length = System_Text_StringBuilder__get_Length(tempTxt, 0);
  this = (WrapLineMessage_o *)WrapLineMessage__GetWrapCheckLabel(v5, v9);
  if ( !this )
    goto LABEL_10;
  ...
  if ( !v11
    || (UILabel__set_text(v11, (System_String_o *)this, 0),
        (this = (WrapLineMessage_o *)WrapLineMessage__GetWrapCheckLabel(v5, v12)) == 0) )
  {
LABEL_10:
    sub_2213CDC(this, tempTxt);
  }
...
void WrapLineMessage__PreProcSetRubyLabel(WrapLineMessage_o *this, System_String_o *mainText, const MethodInfo *method)
{
  ...
  System_Text_StringBuilder___ctor_75728968(v5, mainText, 0);
...
void WrapLineMessage__Quit(WrapLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(wrapCheckLabel, 0, 0) )
  {
    ...
    *p_wrapCheckLabel = 0;
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields._wrapCheckLabel, 0, v8, v9, v10, v11, v12, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  this->fields.originalText = text;
  sub_2213A04(
    (MissionNaviTransitionBoardItem_o *)&this->fields.originalText,
    (int32_t)text,
    color,
    (System_String_o *)font,
    removeUserNameColorCode,
    isTalkName,
    (bool)method,
    v7);
