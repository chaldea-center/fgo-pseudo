        ...
        const MethodInfo *method)
{
  ...
  if ( WrapLineMessage__IsWrapTextSize(this, tempTxt, (const MethodInfo *)addLabel) )
  {
    ...
    System_Text_StringBuilder__Append_60545472(tempTxt, v9, 0LL);
  }
}
...
UILabel_o *__fastcall WrapLineMessage__GetWrapCheckLabel(WrapLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(wrapCheckLabel, 0LL, 0LL) )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._wrapCheckLabel, (int32_t)MainLabel, v5, v6);
...
void __fastcall WrapLineMessage__Init(WrapLineMessage_o *this, System_String_o *text, const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.originalText, (int32_t)text, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A015A4 & 1) == 0 )
  {
    sub_1B64870(&System_Text_StringBuilder_TypeInfo, mainText);
    byte_4A015A4 = 1;
  }
  v5 = (System_Text_StringBuilder_o *)sub_1B64ABC(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor_60539296(v5, mainText, 0LL);
...
void __fastcall WrapLineMessage__Quit(WrapLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(wrapCheckLabel, 0LL, 0LL) )
  {
    ...
    *p_wrapCheckLabel = 0LL;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._wrapCheckLabel, 0, v7, v8);
  }
