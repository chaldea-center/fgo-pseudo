        ...
        const MethodInfo *method)
{
  ...
  if ( WrapLineMessage__IsWrapTextSize(this, tempTxt, (const MethodInfo *)addLabel) )
  {
    ...
    System_Text_StringBuilder__Append_62129096(tempTxt, v9, 0LL);
  }
}
...
void __fastcall WrapLineMessage__Init(WrapLineMessage_o *this, System_String_o *text, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.originalText, (int64_t)text, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7A10 & 1) == 0 )
  {
    sub_1C13D24(&System_Text_StringBuilder_TypeInfo, mainText);
    byte_4BB7A10 = 1;
  }
  v5 = (System_Text_StringBuilder_o *)sub_1C13F70(System_Text_StringBuilder_TypeInfo);
  System_Text_StringBuilder___ctor_62122920(v5, mainText, 0LL);
...
void __fastcall WrapLineMessage__Quit(WrapLineMessage_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(wrapCheckLabel, 0LL, 0LL) )
  {
    ...
    *p_wrapCheckLabel = 0LL;
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields._wrapCheckLabel, 0LL, v7, v8, v9, v10, v11, v12);
  }
