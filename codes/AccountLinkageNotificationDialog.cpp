void __fastcall AccountLinkageNotificationDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A48B26 & 1) == 0 )
  {
    sub_1B863B8(&AccountLinkageNotificationDialog_TypeInfo, v1);
    byte_4A48B26 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  AccountLinkageNotificationDialog__Close_30383800(this, 0LL, v2);
}


void __fastcall AccountLinkageNotificationDialog__Close_30383800(
        AccountLinkageNotificationDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48B22 & 1) == 0 )
  {
    sub_1B863B8(&Method_AccountLinkageNotificationDialog_EndClose__, callback);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48B23 & 1) == 0 )
  {
    sub_1B863B8(&Method_AccountLinkageNotificationDialog_OnClickOk__, method);
    byte_4A48B23 = 1;
  }
  ...
  {
    AccountLinkageNotificationDialog__Close_30383800(this, 0LL, v5);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  AndroidBackKeyManager__AddBackBtn_42896176(transform, (System_String_o *)StringLiteral_15425/*"Window/OkBtn"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48B21 & 1) == 0 )
  {
    sub_1B863B8(&AccountLinkageNotificationDialog_TypeInfo, message);
    sub_1B863B8(&LocalizationManager_TypeInfo, v13);
    sub_1B863B8(&Method_System_Nullable_float__GetValueOrDefault__, v14);
    sub_1B863B8(&Method_System_Nullable_int__GetValueOrDefault__, v15);
    sub_1B863B8(&Method_System_Nullable_float__get_HasValue__, v16);
  ...
  if ( UnityEngine_Object__op_Inequality(buttonLabel, 0LL, 0LL) )
  {
    ...
    v25 = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3676/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
    if ( v31 )
    {
...
LABEL_32:
    sub_1B86614(v25, MESSAGE_FONT_SIZE);
  }
LABEL_31:
