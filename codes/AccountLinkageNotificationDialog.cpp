void __fastcall AccountLinkageNotificationDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFC0F1 & 1) == 0 )
  {
    sub_1BC3008(&AccountLinkageNotificationDialog_TypeInfo, v1);
    byte_4AFC0F1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  AccountLinkageNotificationDialog__Close_30630516(this, 0LL, v2);
}


void __fastcall AccountLinkageNotificationDialog__Close_30630516(
        AccountLinkageNotificationDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC0ED & 1) == 0 )
  {
    sub_1BC3008(&Method_AccountLinkageNotificationDialog_EndClose__, callback);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC0EE & 1) == 0 )
  {
    sub_1BC3008(&Method_AccountLinkageNotificationDialog_OnClickOk__, method);
    byte_4AFC0EE = 1;
  }
  ...
  {
    AccountLinkageNotificationDialog__Close_30630516(this, 0LL, v5);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  AndroidBackKeyManager__AddBackBtn_43913684(transform, (System_String_o *)StringLiteral_15506/*"Window/OkBtn"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC0EC & 1) == 0 )
  {
    sub_1BC3008(&AccountLinkageNotificationDialog_TypeInfo, message);
    sub_1BC3008(&LocalizationManager_TypeInfo, v13);
    sub_1BC3008(&Method_System_Nullable_float__GetValueOrDefault__, v14);
    sub_1BC3008(&Method_System_Nullable_int__GetValueOrDefault__, v15);
    sub_1BC3008(&Method_System_Nullable_float__get_HasValue__, v16);
    sub_1BC3008(&Method_System_Nullable_int__get_HasValue__, v17);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v18);
    sub_1BC3008(&StringLiteral_3648/*"COMMON_CONFIRM_CLOSE"*/, v19);
  ...
  if ( UnityEngine_Object__op_Inequality(buttonLabel, 0LL, 0LL) )
  {
    ...
    v25 = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3648/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
    if ( v31 )
    {
...
LABEL_32:
    sub_1BC3264(v25, MESSAGE_FONT_SIZE);
  }
LABEL_31:
