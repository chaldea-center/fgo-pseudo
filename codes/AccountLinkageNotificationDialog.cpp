void AccountLinkageNotificationDialog___cctor(const MethodInfo *method)
{
  if ( (byte_4C3CC61 & 1) == 0 )
  {
    sub_1C37058(&AccountLinkageNotificationDialog_TypeInfo);
    byte_4C3CC61 = 1;
  }
...
void AccountLinkageNotificationDialog__Close(AccountLinkageNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  AccountLinkageNotificationDialog__Close_31106636(this, 0, v2);
}


void AccountLinkageNotificationDialog__Close_31106636(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3CC5D & 1) == 0 )
  {
    sub_1C37058(&Method_AccountLinkageNotificationDialog_EndClose__);
...
LABEL_15:
  ...
  BaseDialog__Init((BaseDialog_o *)this, v6);
}
...
void AccountLinkageNotificationDialog__OnClickOk(AccountLinkageNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3CC5E & 1) == 0 )
  {
    sub_1C37058(&Method_AccountLinkageNotificationDialog_OnClickOk__);
    byte_4C3CC5E = 1;
  }
  ...
  {
    AccountLinkageNotificationDialog__Close_31106636(this, 0, v5);
  }
}
...
void AccountLinkageNotificationDialog__OnEnable(AccountLinkageNotificationDialog_o *this, const MethodInfo *method)
{
  ...
  AndroidBackKeyManager__AddBackBtn_44960000(transform, (System_String_o *)StringLiteral_15652/*"Window/OkBtn"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  float value; // s8
  AccountLinkageNotificationDialog_c *v15; // x0
  ...
  if ( UnityEngine_Object__op_Inequality(messageLabel, 0, 0) )
  {
    ...
    {
      v15 = AccountLinkageNotificationDialog_TypeInfo;
      ...
      value = v15->static_fields->MESSAGE_BASE_POS_Y;
    }
    ...
    {
      v18 = HIDWORD(*(unsigned __int64 *)&msgFontSize);
    }
    else
    {
      ...
      LODWORD(v18) = v19->static_fields->MESSAGE_FONT_SIZE;
    }
    v16 = (UnityEngine_Component_o *)this->fields.messageLabel;
    if ( !v16 )
      goto LABEL_32;
    UILabel__set_fontSize((UILabel_o *)v16, v18, 0);
    v16 = (UnityEngine_Component_o *)this->fields.messageLabel;
    if ( !v16 )
      goto LABEL_32;
    v20 = message ? message : (System_String_o *)StringLiteral_1/*""*/;
    UILabel__set_text((UILabel_o *)v16, v20, 0);
    v16 = (UnityEngine_Component_o *)this->fields.messageLabel;
    if ( !v16 )
      goto LABEL_32;
    UILabel__set_spacingY((UILabel_o *)v16, spacingY, 0);
  }
  buttonLabel = (UnityEngine_Object_o *)this->fields.buttonLabel;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(buttonLabel, 0, 0) )
  {
    ...
    v16 = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3685/*"COMMON_CONFIRM_CLOSE"*/, 0);
    if ( v23 )
    {
