void __fastcall AccountLinkageNotificationDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1C856 & 1) == 0 )
  {
    sub_1C3B764(&AccountLinkageNotificationDialog_TypeInfo, v1);
    byte_4C1C856 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  AccountLinkageNotificationDialog__Close_31132992(this, 0LL, v2);
}


void __fastcall AccountLinkageNotificationDialog__Close_31132992(
        AccountLinkageNotificationDialog_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1C852 & 1) == 0 )
  {
    sub_1C3B764(&Method_AccountLinkageNotificationDialog_EndClose__, callback);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1C853 & 1) == 0 )
  {
    sub_1C3B764(&Method_AccountLinkageNotificationDialog_OnClickOk__, method);
    byte_4C1C853 = 1;
  }
  ...
  {
    AccountLinkageNotificationDialog__Close_31132992(this, 0LL, v5);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  AndroidBackKeyManager__AddBackBtn_43310944(transform, (System_String_o *)StringLiteral_15961/*"_PositionOffset"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1C851 & 1) == 0 )
  {
    sub_1C3B764(&AccountLinkageNotificationDialog_TypeInfo, message);
    sub_1C3B764(&LocalizationManager_TypeInfo, v13);
    sub_1C3B764(&Method_System_Nullable_float__GetValueOrDefault__, v14);
    sub_1C3B764(&Method_System_Nullable_int__GetValueOrDefault__, v15);
    sub_1C3B764(&Method_System_Nullable_float__get_HasValue__, v16);
    sub_1C3B764(&Method_System_Nullable_int__get_HasValue__, v17);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v18);
    sub_1C3B764(&StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, v19);
  ...
  if ( UnityEngine_Object__op_Inequality(buttonLabel, 0LL, 0LL) )
  {
    ...
    v25 = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, 0LL);
    if ( v31 )
    {
...
LABEL_32:
    sub_1C3B9C0(v25, MESSAGE_FONT_SIZE);
  }
LABEL_31:
