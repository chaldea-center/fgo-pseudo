void ListViewItem___ctor(ListViewItem_o *this, const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.sortStr1, v9, v2, v3, v4, v5, v6, v7);
...
void ListViewItem___ctor_44594388(ListViewItem_o *this, int32_t index, const MethodInfo *method)
{
  int32_t v3; // w3
  System_String_o *v4; // x4
  int32_t v5; // w5
  ...
  v10 = StringLiteral_1/*""*/;
  this->fields.sortStr1 = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.sortStr1, v10, (int32_t)method, v3, v4, v5, v6, v7);
  System_Object___ctor((Il2CppObject *)this, 0);
  ...
  v11 = StringLiteral_1/*""*/;
  this->fields.sortStr1 = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.sortStr1, v11, v12, v13, v14, v15, v16, v17);
  this->fields.basePosition.fields.z = 0.0;
  *(_QWORD *)&this->fields.basePosition.fields.x = 0;
}
...
bool ListViewItem__SetSortValue(ListViewItem_o *this, ListViewSort_o *sort, const MethodInfo *method)
{
  ...
  this->fields.sortStr1 = (struct System_String_o *)StringLiteral_1/*""*/;
  p_sortStr1 = &this->fields.sortStr1;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)p_sortStr1, v10, (int32_t)method, v3, v4, v5, v6, v7);
  ...
  if ( sortValue0 == v4 )
  {
    ...
    if ( sortValue0B == v9 )
    {
      ...
      if ( sortValue1 == v11 )
      {
        ...
        if ( !sortStr1 || (v13 = item->fields.sortStr1) == 0 || System_String__Equals_64453064(sortStr1, v13, 0) )
        {
        ...
        if ( this )
          return System_String__CompareTo_64452108((System_String_o *)this, v6->fields.sortStr1, 0);
LABEL_18:
...
LABEL_13:
  ...
  {
    sortStr1 = this->fields.sortStr1;
    if ( !sortStr1 || (v14 = item->fields.sortStr1) == 0 || System_String__Equals_64453064(sortStr1, v14, 0) )
    {
      sortValue1B = v6->fields.sortValue1B;
    ...
    if ( this )
      return System_String__CompareTo_64452108((System_String_o *)this, item->fields.sortStr1, 0);
LABEL_21:
    sub_1C942F0(this, item);
  }
LABEL_16:
