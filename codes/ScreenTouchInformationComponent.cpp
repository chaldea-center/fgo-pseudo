        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEB1D & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_TweenScale___, v3);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.tScale, (int32_t)Component_object, v9, v10);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.tAlpha, (int32_t)v12, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEB1F & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, tweener);
    byte_4AFEB1F = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
