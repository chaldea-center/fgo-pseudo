        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.tScale, (int32_t)Component_object, v9, v10);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.tAlpha, (int32_t)v12, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05A4A & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, tweener);
    byte_4A05A4A = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
