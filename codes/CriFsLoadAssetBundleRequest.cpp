        ...
        const MethodInfo *method)
{
  ...
  struct CriFsLoadFileRequest_o *File_30862304; // x0
  ...
  File_30862304 = CriFsUtility__LoadFile_30862304(binder, path, readUnitSize, v9);
  this->fields.loadFileReq = File_30862304;
  sub_1C3E508(&this->fields.loadFileReq, File_30862304);
  ...
  if ( loadFileReq )
  {
    if ( loadFileReq->fields._isDone_k__BackingField )
    {
      if ( loadFileReq->fields._error_k__BackingField )
      {
        ...
        sub_1C3E508(&this->fields._error_k__BackingField, v5);
      ...
      else
      {
        ...
        sub_1C3E508(&this->fields.assetBundleReq, v12);
      }
      ...
      if ( *p_loadFileReq )
      {
        ...
        *p_loadFileReq = 0;
        sub_1C3E508(&this->fields.loadFileReq, 0);
        return;
      }
LABEL_18:
      sub_1C3E7C0(v9, v6);
...
LABEL_17:
  ...
  if ( UnityEngine_AsyncOperation__get_isDone(assetBundleReq, 0) )
  {
    ...
    sub_1C3E508(&this->fields._assetBundle_k__BackingField, assetBundle);
    v11 = this->fields._doneDelegate_k__BackingField;
    this->fields._isDone_k__BackingField = 1;
    if ( v11 )
      goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508(&this->fields._assetBundle_k__BackingField, value);
}
