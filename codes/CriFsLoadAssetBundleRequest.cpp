        ...
        const MethodInfo *method)
{
  ...
  struct CriFsLoadFileRequest_o *File_31544916; // x0
  ...
  File_31544916 = CriFsUtility__LoadFile_31544916(binder, path, readUnitSize, v9);
  this->fields.loadFileReq = File_31544916;
  sub_1CE66A4(&this->fields.loadFileReq, File_31544916);
  ...
  if ( loadFileReq )
  {
    if ( loadFileReq->fields._isDone_k__BackingField )
    {
      ...
      else
      {
        ...
        sub_1CE66A4(&this->fields.assetBundleReq, v12);
      }
      ...
      if ( *p_loadFileReq )
      {
        ...
        *p_loadFileReq = 0;
        sub_1CE66A4(&this->fields.loadFileReq, 0);
        return;
      }
LABEL_18:
      sub_1CE6958(v9, v6);
...
LABEL_17:
  ...
  if ( UnityEngine_AsyncOperation__get_isDone(assetBundleReq, 0) )
  {
    ...
    sub_1CE66A4(&this->fields._assetBundle_k__BackingField, assetBundle);
    v11 = this->fields._doneDelegate_k__BackingField;
    this->fields._isDone_k__BackingField = 1;
    if ( v11 )
      goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields._assetBundle_k__BackingField, value);
}
