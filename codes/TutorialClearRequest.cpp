...
System_String_o *__fastcall TutorialClearRequest__getURL(TutorialClearRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B685DC & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_24435/*"tutorial/clear"*/, v2);
    byte_4B685DC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_24435/*"tutorial/clear"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B685B9 & 1) == 0 )
  {
    sub_1BE4ACC(&TopHomeRequest_TypeInfo, responseList);
    byte_4B685B9 = 1;
  }
