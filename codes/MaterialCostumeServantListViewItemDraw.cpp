        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29674 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_8549/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/, v9);
    byte_4A29674 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !servantFaceIcon )
      goto LABEL_33;
    ServantFaceIconComponent__Set_38043784(
      servantFaceIcon,
...
LABEL_13:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v16 = &StringLiteral_8549/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/;
    }
