        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FD42 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_8570/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/, v9);
    byte_4B3FD42 = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !servantFaceIcon )
      goto LABEL_33;
    ServantFaceIconComponent__Set_40021668(
      servantFaceIcon,
...
LABEL_13:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v16 = &StringLiteral_8570/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/;
    }
