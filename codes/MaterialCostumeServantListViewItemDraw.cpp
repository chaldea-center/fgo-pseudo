        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C224BE & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_8571/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/);
    byte_4C224BE = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !servantFaceIcon )
      goto LABEL_34;
    ServantFaceIconComponent__Set_40787180(
      servantFaceIcon,
    ...
    if ( status == 1 )
    {
      ...
      v13 = &StringLiteral_8572/*"MATERIAL_FIND_SERVANT"*/;
    }
    else
    {
      if ( status != 2 )
...
LABEL_14:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v13 = &StringLiteral_8571/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/;
    }
