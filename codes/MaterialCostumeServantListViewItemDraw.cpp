        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(baseButton, 0, 0) )
  {
    ...
    if ( isEnable )
      ...
      v7 = 3;
    ((void (__fastcall *)(struct UICommonButton_o *, __int64, __int64, const MethodInfo *))v6->klass->vtable._14_SetState.methodPtr)(
      v6,
      v7,
      1,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C32B8D & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_8577/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/);
    byte_4C32B8D = 1;
  }
  if ( item && mode )
  {
    ...
    if ( !servantFaceIcon )
      goto LABEL_34;
    ServantFaceIconComponent__Set_40909284(
      servantFaceIcon,
    ...
    if ( status == 1 )
    {
      ...
      v13 = &StringLiteral_8578/*"MATERIAL_FIND_SERVANT"*/;
    }
    else
    {
      if ( status != 2 )
...
LABEL_14:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v13 = &StringLiteral_8577/*"MATERIAL_FIND_NOT_SELECT_COSTUME"*/;
    }
