        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0865F & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_System_Collections_Generic_List_UIWidget__Add__, v7);
    ...
    sub_1B686D4(&Method_System_Collections_Generic_List_UIWidget__get_Count__, v12);
    ...
    sub_1B686D4(&StringLiteral_15427/*"WAVE_BATTLE_ALREADY_SORTIE"*/, v17);
    sub_1B686D4(&StringLiteral_11445/*"SELECT_BONUS_SKILL_INVALID"*/, v18);
    sub_1B686D4(&StringLiteral_15447/*"WAVE_BATTLE_EQUIP_UNIQUE"*/, v19);
    sub_1B686D4(&StringLiteral_15448/*"WAVE_BATTLE_EQUIP_WAVE"*/, v20);
    sub_1B686D4(&StringLiteral_1/*""*/, v21);
    sub_1B686D4(&StringLiteral_5493/*"EQUIP_GRAPH_USE"*/, v22);
    byte_4A0865F = 1;
  }
  if ( !v5 || !mode )
    return;
  ...
  UIIconLabel__Set_37983136((UIIconLabel_o *)servantFaceIcon, 7, cost, 0, 0, 0LL, 0, 0, 0, 0LL);
  ...
  if ( v5->fields.isInvalidRarity )
  {
    ...
    servantFaceIcon = (int *)LocalizationManager__Get((System_String_o *)StringLiteral_11445/*"SELECT_BONUS_SKILL_INVALID"*/, 0LL);
    ...
    else
    {
      ...
      *(_QWORD *)(v35 + 32) = item;
      sub_1B68678((ServantStatusBattleListViewItem_o *)(v35 + 32), (int32_t)item, v30, v31);
    }
  }
  else
  {
...
LABEL_28:
    ...
    v45 = (System_Collections_Generic_List_object__o *)sub_1B68920(System_Collections_Generic_List_string__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v45,
    ...
    if ( !v5->fields._IsClearedWave_k__BackingField )
    {
      if ( v5->fields._UniqueOrganizedWave_k__BackingField >= 1 )
      {
        ...
        servantFaceIcon = (int *)System_String__Format_61433840(v65, v69, v73, 0LL);
        if ( !v45 )
          goto LABEL_123;
        ...
        else
        {
          ...
          sub_1B68678((ServantStatusBattleListViewItem_o *)(v80 + 4), (int32_t)v79, v74, v75);
        }
        ...
        else
        {
          ...
          sub_1B68678((ServantStatusBattleListViewItem_o *)(v105 + 4), (int32_t)item, v81, v82);
        }
      }
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      ...
      else
      {
        ...
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v112 + 4), (int32_t)v111, v106, v107);
      }
      ...
      else
      {
        ...
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v118 + 4), (int32_t)item, v113, v114);
      }
  ...
  else
  {
    ...
    if ( !v5->fields._IsClearedWave_k__BackingField )
    {
      if ( v5->fields._OrganizedWave_k__BackingField >= 1 )
      {
        ...
        servantFaceIcon = (int *)System_String__Format_61433840(v46, v50, v54, 0LL);
        if ( !v45 )
          goto LABEL_123;
        ...
        else
        {
          ...
          sub_1B68678((ServantStatusBattleListViewItem_o *)(v86 + 4), (int32_t)item, v62, v63);
        }
      }
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
...
LABEL_96:
  ...
  else
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)(v94 + 4), (int32_t)v93, v87, v88);
  }
  warningLabel = this->fields.warningLabel;
  servantFaceIcon = (int *)System_String__Join_61435124(
  ...
  else
  {
    ...
    *(_QWORD *)(v101 + 32) = item;
    sub_1B68678((ServantStatusBattleListViewItem_o *)(v101 + 32), (int32_t)item, v96, v97);
  }
LABEL_32:
  servantFaceIcon = (int *)this->fields.messageLabelList;
  if ( !servantFaceIcon )
  ...
  if ( v38 >= 1 )
  {
    if ( v38 == 1 && v5->fields.isInvalidRarity )
    {
      ...
      else
      {
        servantFaceIcon[6] = 2;
        *(_QWORD *)(v39 + 40) = item;
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v39 + 40), (int32_t)item, v36, v37);
      }
    }
    servantFaceIcon = (int *)this->fields.messageLabelList;
    if ( !servantFaceIcon )
