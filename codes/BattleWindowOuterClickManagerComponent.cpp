  ...
  if ( UnityEngine_Object__op_Inequality(outerPanel, 0LL, 0LL) )
  {
    ...
    if ( !v9
      || (v9->fields.clickCallBack = callBack,
          sub_1B8635C((CGThumbnailListItem_o *)&v9->fields.clickCallBack, (int32_t)callBack, v7, v8),
          (v9 = this->fields.outerPanel) == 0LL) )
    {
      sub_1B86614(v9, v6);
    }
    v9->fields.targetWindow = (struct BattleWindowComponent_o *)this;
    sub_1B8635C((CGThumbnailListItem_o *)&v9->fields.targetWindow, (int32_t)this, v10, v11);
  }
}