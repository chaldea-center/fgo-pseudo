void __fastcall TitleInfoEventTowerStamp___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B35C57 & 1) == 0 )
  {
    sub_1BD3458(&TitleInfoEventTowerStamp_TypeInfo, v1);
    sub_1BD3458(&StringLiteral_24288/*"tower_img_base{0:00}_stamp"*/, v8);
    byte_4B35C57 = 1;
  }
  TitleInfoEventTowerStamp_TypeInfo->static_fields->SPRITE_NAME_STAMP = (struct System_String_o *)StringLiteral_24288/*"tower_img_base{0:00}_stamp"*/;
  sub_1BD33FC(
    (PartyOrganizationUtility_o *)TitleInfoEventTowerStamp_TypeInfo->static_fields,
    StringLiteral_24288/*"tower_img_base{0:00}_stamp"*/,
    v2,
    v3,
    v4,
    v5,
...
void __fastcall TitleInfoEventTowerStamp__ResetStamp(TitleInfoEventTowerStamp_o *this, const MethodInfo *method)
{
  ...
  {
    v19 = (System_Collections_Generic_List_object__o *)sub_1BD36A4(System_Collections_Generic_List_GameObject__TypeInfo);
    ...
    sub_1BD33FC(p_stampList, (int64_t)v19, v20, v21, v22, v23, v24, v25);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35C55 & 1) == 0 )
  {
    sub_1BD3458(&AtlasManager_TypeInfo, *(_QWORD *)&floor);
    ...
    sub_1BD3458(&Method_UnityEngine_Object_Instantiate_GameObject____77057344, v12);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v13);
    sub_1BD3458(&TitleInfoEventTowerStamp_TypeInfo, v14);
    byte_4B35C55 = 1;
  }
  ...
  if ( floor >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        sub_1BD33FC((PartyOrganizationUtility_o *)(v39 + 4), (int64_t)v38, v28, v29, v30, v31, v32, v33);
      }
      if ( !v38 )
        break;
