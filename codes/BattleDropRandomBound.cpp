void __fastcall BattleDropRandomBound___ctor(BattleDropRandomBound_o *this, const MethodInfo *method)
{
  ...
  v4 = (BattleDropRandomBound_RangeFloat_o *)sub_1BDBAC4(BattleDropRandomBound_RangeFloat_TypeInfo);
  BattleDropRandomBound_RangeFloat___ctor(v4, v5);
  this->fields.moveSpeedXRange = v4;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.moveSpeedXRange, (int32_t)v4, v6, v7);
  v8 = (BattleDropRandomBound_RangeFloat_o *)sub_1BDBAC4(BattleDropRandomBound_RangeFloat_TypeInfo);
  BattleDropRandomBound_RangeFloat___ctor(v8, v9);
  this->fields.moveSpeedYRange = v8;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.moveSpeedYRange, (int32_t)v8, v10, v11);
  v12 = (BattleDropRandomBound_RangeFloat_o *)sub_1BDBAC4(BattleDropRandomBound_RangeFloat_TypeInfo);
  BattleDropRandomBound_RangeFloat___ctor(v12, v13);
  this->fields.delayStartTimeRange = v12;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.delayStartTimeRange, (int32_t)v12, v14, v15);
  v16 = (BattleDropRandomBound_RangeInt_o *)sub_1BDBAC4(BattleDropRandomBound_RangeInt_TypeInfo);
  BattleDropRandomBound_RangeInt___ctor(v16, v17);
  this->fields.boundCountRange = v16;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.boundCountRange, (int32_t)v16, v18, v19);
  if ( !byte_4B3E80A )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( result != max )
    return UnityEngine_Random__Range_70244360(result, max + 1, 0LL);
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4728B & 1) == 0 )
  {
    sub_1BDB878(&BattleDropRandomBoundOverwriteSetting_TypeInfo, scriptableObject);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)scriptableObject, 0LL, 0LL) )
  {
    if ( scriptableObject )
    {
        ...
        && (BattleDropRandomBoundOverwriteSetting_c *)scriptableObject->klass->_2.typeHierarchy[methodPtr_low - 1] == BattleDropRandomBoundOverwriteSetting_TypeInfo )
      {
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.overwriteSetting, (int32_t)scriptableObject, v8, v9);
      }
    }
  }
    ...
    else
    {
      ...
      if ( (float)(this->fields.delayStartTime + this->fields.additionalDelayStartTime) <= elapsedTime )
      {
        ...
        if ( AppearEffectCallback_k__BackingField )
        {
          ...
          sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._AppearEffectCallback_k__BackingField, 0, v11, v12);
          return;
        }
        v5 = this->fields.boundObject;
        if ( v5 )
        ...
        const MethodInfo *method)
{
  if ( (byte_4B4728E & 1) == 0 )
  {
    sub_1BDB878(&Method_BattleDropRandomBound_Range_float___ctor__, method);
    byte_4B4728E = 1;
  }
  BattleDropRandomBound_Range_float____ctor(
    (BattleDropRandomBound_Range_float__o *)this,
    (const MethodInfo_388C270 *)Method_BattleDropRandomBound_Range_float___ctor__);
}
...
void __fastcall BattleDropRandomBound_Range_float____ctor(
        BattleDropRandomBound_Range_float__o *this,
        const MethodInfo_388C270 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}
...
void __fastcall BattleDropRandomBound_Range_int____ctor(
        BattleDropRandomBound_Range_int__o *this,
        const MethodInfo_388C268 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0LL);
}