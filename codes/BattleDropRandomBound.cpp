void BattleDropRandomBound___ctor(BattleDropRandomBound_o *this, const MethodInfo *method)
{
  ...
  v3 = (BattleDropRandomBound_RangeFloat_o *)sub_1C942E4(BattleDropRandomBound_RangeFloat_TypeInfo);
  BattleDropRandomBound_RangeFloat___ctor(v3, v4);
  this->fields.moveSpeedXRange = v3;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.moveSpeedXRange, (int32_t)v3, v5, v6, v7, v8, v9, v10);
  v11 = (BattleDropRandomBound_RangeFloat_o *)sub_1C942E4(BattleDropRandomBound_RangeFloat_TypeInfo);
  BattleDropRandomBound_RangeFloat___ctor(v11, v12);
  this->fields.moveSpeedYRange = v11;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.moveSpeedYRange, (int32_t)v11, v13, v14, v15, v16, v17, v18);
  v19 = (BattleDropRandomBound_RangeFloat_o *)sub_1C942E4(BattleDropRandomBound_RangeFloat_TypeInfo);
  ...
  sub_1C9403C(
    ...
    v25,
    v26);
  v27 = (BattleDropRandomBound_RangeInt_o *)sub_1C942E4(BattleDropRandomBound_RangeInt_TypeInfo);
  BattleDropRandomBound_RangeInt___ctor(v27, v28);
  this->fields.boundCountRange = v27;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.boundCountRange, (int32_t)v27, v29, v30, v31, v32, v33, v34);
  if ( !byte_4D25DF9 )
  {
...
int32_t BattleDropRandomBound__GetRandomInt(BattleDropRandomBound_RangeInt_o *rangeInt, const MethodInfo *method)
{
  ...
  if ( result != max )
    return UnityEngine_Random__Range_72070684(result, max + 1, 0);
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  struct BattleDropRandomBoundOverwriteSetting_o *v38; // x8
  float RandomFloat; // s0
  struct BattleDropRandomBoundOverwriteSetting_o *v40; // x8
  float v41; // s8
  float v42; // s0
  struct BattleDropRandomBoundOverwriteSetting_o *v43; // x8
  float v44; // s9
  float v45; // s0
  ...
  if ( (byte_4D2F339 & 1) == 0 )
  {
    sub_1C94098(&BattleDropRandomBoundOverwriteSetting_TypeInfo);
...
LABEL_31:
  ...
  MoveSpeedXRange = BattleDropRandomBound__get_MoveSpeedXRange(this, v24);
  this->fields.moveSpeedXPerSecond = BattleDropRandomBound__GetRandomFloat(MoveSpeedXRange, v26) * 30.0;
  MoveSpeedYRange = BattleDropRandomBound__get_MoveSpeedYRange(this, v27);
  this->fields.startSpeedYPerSecond = BattleDropRandomBound__GetRandomFloat(MoveSpeedYRange, v29) * 30.0;
  this->fields.gravityPerSecond = (float)(BattleDropRandomBound__get_Gravity(this, v30) * 30.0) * 30.0;
  DelayStartTimeRange = BattleDropRandomBound__get_DelayStartTimeRange(this, v31);
  this->fields.delayStartTime = BattleDropRandomBound__GetRandomFloat(DelayStartTimeRange, v33);
  BoundCountRange = BattleDropRandomBound__get_BoundCountRange(this, v34);
  this->fields.maxBoundCount = BattleDropRandomBound__GetRandomInt(BoundCountRange, v36);
  *(_QWORD *)&this->fields.boundCount = 0;
  if ( isRandomShiftInitialPosition )
  {
    v37 = (UnityEngine_Object_o *)this->fields.overwriteSetting;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__op_Inequality(v37, 0, 0);
    if ( ((unsigned __int8)transform & 1) != 0 )
    {
      v38 = this->fields.overwriteSetting;
      if ( v38 )
      {
        RandomFloat = BattleDropRandomBound__GetRandomFloat(v38->fields.initScatterPosBaseRectXRange, v10);
        v40 = this->fields.overwriteSetting;
        if ( v40 )
        {
          v41 = RandomFloat;
          v42 = BattleDropRandomBound__GetRandomFloat(v40->fields.initScatterPosBaseRectYRange, v10);
          v43 = this->fields.overwriteSetting;
          if ( v43 )
          {
            v44 = v42;
            sincosf(v43->fields.initScatterPosBaseRectAngle * 0.017453, &sinx, &cosx);
            v45 = (float)(v41 * sinx) + (float)(v44 * cosx);
            this->fields.initScatterPos.fields.x = (float)(v41 * cosx) - (float)(v44 * sinx);
            this->fields.initScatterPos.fields.y = v45;
            return;
          }
        }
      }
      ...
      if ( activeInHierarchy )
      {
        ...
        if ( activeInHierarchy )
        {
          ...
          if ( (float)(localPosition.fields.y + simpleCurrentSpeedY) < simpleStopYPosition )
          {
            ...
            {
              activeInHierarchy = (UnityEngine_GameObject_o *)UnityEngine_Random__Range_72070684(0, 2, 0);
...
LABEL_38:
      sub_1C942F0(activeInHierarchy, v4);
    }
  }
}
...
void BattleDropRandomBound_RangeFloat___ctor(BattleDropRandomBound_RangeFloat_o *this, const MethodInfo *method)
{
  if ( (byte_4D2F33D & 1) == 0 )
  {
    sub_1C94098(&Method_BattleDropRandomBound_Range_float___ctor__);
    byte_4D2F33D = 1;
  }
  BattleDropRandomBound_Range_float____ctor(
    (BattleDropRandomBound_Range_float__o *)this,
    (const MethodInfo_3A2B6EC *)Method_BattleDropRandomBound_Range_float___ctor__);
}
...
void BattleDropRandomBound_Range_float____ctor(
        BattleDropRandomBound_Range_float__o *this,
        const MethodInfo_3A2B6EC *method)
{
  System_Object___ctor((Il2CppObject *)this, 0);
}
...
void BattleDropRandomBound_Range_int____ctor(
        BattleDropRandomBound_Range_int__o *this,
        const MethodInfo_3A2B6E4 *method)
{
  System_Object___ctor((Il2CppObject *)this, 0);
}