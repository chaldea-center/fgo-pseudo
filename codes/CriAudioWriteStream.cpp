...
void CriAudioWriteStream___ctor_31189036(
        CriAudioWriteStream_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29BC4 & 1) == 0 )
  {
    sub_1C93AD4(&CriAudioWriteStream_InternalDelegate_TypeInfo);
    sub_1C93AD4(&Method_System_Runtime_InteropServices_Marshal_GetFunctionPointerForDelegate_CriAudioWriteStream_InternalDelegate___);
    sub_1C93AD4(&System_Runtime_InteropServices_Marshal_TypeInfo);
    sub_1C93AD4(&float_____TypeInfo);
    sub_1C93AD4(&float___TypeInfo);
    sub_1C93AD4(&Method_CriAudioWriteStream___c__DisplayClass12_0___ctor_b__0__);
    sub_1C93AD4(&CriAudioWriteStream___c__DisplayClass12_0_TypeInfo);
    byte_4D29BC4 = 1;
  }
  v9 = sub_1C93D20(CriAudioWriteStream___c__DisplayClass12_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = callback;
  ...
  System_Object___ctor((Il2CppObject *)this, 0);
  v12 = sub_1C93B7C(float_____TypeInfo, *(unsigned int *)(v9 + 20));
  *(_QWORD *)(v9 + 32) = v12;
  sub_1C93A78(v9 + 32, v12);
  if ( *(int *)(v9 + 20) >= 1 )
  {
    v13 = 0;
    v14 = 32;
...
LABEL_9:
  v16 = (CriAudioWriteStream_InternalDelegate_o *)sub_1C93D20(CriAudioWriteStream_InternalDelegate_TypeInfo);
  ...
  this->fields._callbackFunction_k__BackingField = System_Runtime_InteropServices_Marshal__GetFunctionPointerForDelegate_object_(
                                                     internalDelegate,
                                                     (const MethodInfo_322662C *)Method_System_Runtime_InteropServices_Marshal_GetFunctionPointerForDelegate_CriAudioWriteStream_InternalDelegate___);
}
...
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1ABCDD0;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1ABCDA4;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1ABCD3C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29BC7 & 1) == 0 )
  {
    this = (CriAudioWriteStream___c__DisplayClass12_0_o *)sub_1C93AD4(&System_Runtime_InteropServices_Marshal_TypeInfo);
    byte_4D29BC7 = 1;
  }
  ...
  if ( v7->fields.numChannels >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v8 >= LODWORD(buffer->max_length) )
        sub_1C93D34(this);
      System_Runtime_InteropServices_Marshal__Copy_65107712((intptr_t)this, buffer->m_Items[v8++], 0, numSamples, 0);
