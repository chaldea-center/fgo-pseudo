void __fastcall ServantStatusListViewItemDrawAppendSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48DF992 & 1) == 0 )
  {
    sub_1B00CCC(&ServantStatusListViewItemDrawAppendSkill_TypeInfo, v1);
    byte_48DF992 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.skillList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF98F & 1) == 0 )
  {
    this = (ServantStatusListViewItemDrawAppendSkill_o *)sub_1B00CCC(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF990 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_ServantStatusSkillComponent___, v7);
    ...
    sub_1B00CCC(&Method_System_Collections_Generic_List_GameObject__set_Item__, v12);
    ...
    sub_1B00CCC(&ServantStatusListViewItemDrawAppendSkill_TypeInfo, v16);
    sub_1B00CCC(&StringLiteral_11688/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, v17);
    sub_1B00CCC(&StringLiteral_20250/*"img_txt_extraskill_title"*/, v18);
    byte_48DF990 = 1;
  }
  titleList = 0LL;
  idList = 0LL;
  ...
  while ( 1 )
  {
    ...
    UnityEngine_Object__Destroy_68077656((UnityEngine_Object_o *)v22, 0LL);
    skillList = this->fields.skillList;
    if ( skillList )
    {
      System_Collections_Generic_List_object___set_Item(
        ...
        v20,
        0LL,
        (const MethodInfo_33C1754 *)Method_System_Collections_Generic_List_GameObject__set_Item__);
      skillList = this->fields.skillList;
      ++v20;
      if ( skillList )
        continue;
  ...
  *((_DWORD *)skillList + 7) = v23;
  ...
  if ( item && mode )
  {
    ...
    skillList = LocalizationManager__Get((System_String_o *)StringLiteral_11688/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, 0LL);
    if ( !explanationLabel )
      goto LABEL_10;
    ...
    AtlasManager__SetEventSprite(titleTextSprite, (System_String_o *)StringLiteral_20250/*"img_txt_extraskill_title"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      if ( v26->m_Items[v27 + 1] >= 1 )
      {
        ...
        if ( !transform )
          goto LABEL_10;
        UnityEngine_Transform__SetParent_68098904(transform, (UnityEngine_Transform_o *)skillList, 0, 0LL);
        if ( !byte_48DD9F6 )
        {
        ...
        skillList = UnityEngine_GameObject__GetComponent_object_(
                      v33,
                      (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusSkillComponent___);
        if ( !idList )
          goto LABEL_10;
        ...
        else
        {
          ...
          *(_QWORD *)(v49 + 32) = v33;
          sub_1B00C70((ServantStatusBattleListViewItem_o *)(v49 + 32), (int32_t)v33, v38, v39);
        }
        if ( !idList )
          goto LABEL_10;
