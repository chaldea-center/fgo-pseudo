void __fastcall ServantStatusListViewItemDrawAppendSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB2EEB & 1) == 0 )
  {
    sub_1BAB41C(&ServantStatusListViewItemDrawAppendSkill_TypeInfo, v1);
    byte_4AB2EEB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.skillList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2EE8 & 1) == 0 )
  {
    this = (ServantStatusListViewItemDrawAppendSkill_o *)sub_1BAB41C(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2EE9 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_ServantStatusSkillComponent___, v7);
    ...
    sub_1BAB41C(&Method_System_Collections_Generic_List_GameObject__set_Item__, v12);
    ...
    sub_1BAB41C(&ServantStatusListViewItemDrawAppendSkill_TypeInfo, v16);
    sub_1BAB41C(&StringLiteral_11888/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, v17);
    sub_1BAB41C(&StringLiteral_20560/*"img_txt_extraskill_title"*/, v18);
    byte_4AB2EE9 = 1;
  }
  titleList = 0LL;
  idList = 0LL;
  ...
  while ( 1 )
  {
    ...
    UnityEngine_Object__Destroy_69800620((UnityEngine_Object_o *)v22, 0LL);
    skillList = this->fields.skillList;
    if ( skillList )
    {
      System_Collections_Generic_List_object___set_Item(
        ...
        v20,
        0LL,
        (const MethodInfo_354D640 *)Method_System_Collections_Generic_List_GameObject__set_Item__);
      skillList = this->fields.skillList;
      ++v20;
      if ( skillList )
        continue;
  ...
  *((_DWORD *)skillList + 7) = v23;
  ...
  if ( item && mode )
  {
    ...
    skillList = LocalizationManager__Get((System_String_o *)StringLiteral_11888/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, 0LL);
    if ( !explanationLabel )
      goto LABEL_10;
    ...
    AtlasManager__SetEventSprite(titleTextSprite, (System_String_o *)StringLiteral_20560/*"img_txt_extraskill_title"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      if ( v26->m_Items[v27 + 1] >= 1 )
      {
        ...
        if ( !transform )
          goto LABEL_10;
        UnityEngine_Transform__SetParent_69821868(transform, (UnityEngine_Transform_o *)skillList, 0, 0LL);
        if ( !byte_4AB0696 )
        {
        ...
        skillList = UnityEngine_GameObject__GetComponent_object_(
                      v33,
                      (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusSkillComponent___);
        if ( !idList )
          goto LABEL_10;
        ...
        else
        {
          ...
          *(_QWORD *)(v49 + 32) = v33;
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v49 + 32), (int32_t)v33, v38, v39);
        }
        if ( !idList )
          goto LABEL_10;
