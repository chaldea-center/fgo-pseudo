void ServantStatusListViewItemDrawAppendSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E745F5 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantStatusListViewItemDrawAppendSkill_TypeInfo);
    byte_4E745F5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E745F2 & 1) == 0 )
  {
    this = (ServantStatusListViewItemDrawAppendSkill_o *)sub_1D0F0B4(&ServantStatusListViewItemDrawAppendSkill_TypeInfo);
    byte_4E745F2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E745F3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_ServantStatusSkillComponent___);
    ...
    sub_1D0F0B4(&StringLiteral_21042/*"img_txt_extraskill_title"*/);
    byte_4E745F3 = 1;
  }
  titleList = 0;
  idList = 0;
  ...
  while ( 1 )
  {
    ...
    UnityEngine_Object__Destroy_73359484((UnityEngine_Object_o *)v10, 0);
    skillList = this->fields.skillList;
    if ( skillList )
    {
  ...
  *((_DWORD *)skillList + 7) = v11;
  ...
  if ( item && mode )
  {
    ...
    skillList = LocalizationManager__Get((System_String_o *)StringLiteral_12105/*"SERVANT_STATUS_EXPLANATION_SKILL_PASSIVE"*/, 0);
    if ( !explanationLabel )
      goto LABEL_10;
    ...
    AtlasManager__SetEventSprite(titleTextSprite, (System_String_o *)StringLiteral_21042/*"img_txt_extraskill_title"*/, 0);
    ...
    while ( 1 )
    {
      ...
      if ( v14->m_Items[v15] >= 1 )
      {
        ...
        if ( !transform )
          goto LABEL_10;
        UnityEngine_Transform__SetParent_73382924(transform, (UnityEngine_Transform_o *)skillList, 0, 0);
        if ( !byte_4E70C9E )
        {
        ...
        skillList = UnityEngine_GameObject__GetComponent_object_(
                      v21,
                      (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusSkillComponent___);
        if ( !idList )
          goto LABEL_10;
        ...
        else
        {
          ...
          *(_QWORD *)(v40 + 32) = v21;
          sub_1D0F058((GrandQuestFolderBoardItem_o *)(v40 + 32), (int32_t)v21, v25, v26, v27, v28, v29, v30);
        }
        if ( !idList )
          goto LABEL_10;
...
LABEL_10:
            ...
            *(_QWORD *)&v97.fields.fakeValue = v56;
            v58 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v97, 0);
