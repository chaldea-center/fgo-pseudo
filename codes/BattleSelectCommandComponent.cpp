void __fastcall BattleSelectCommandComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B69734 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleSelectCommandComponent_TypeInfo, v1);
    sub_1BE4ACC(&string___TypeInfo, v2);
    sub_1BE4ACC(&StringLiteral_18403/*"commandcard_select_3rd"*/, v3);
    sub_1BE4ACC(&StringLiteral_18402/*"commandcard_select_2nd"*/, v4);
    sub_1BE4ACC(&StringLiteral_18401/*"commandcard_select_1st"*/, v5);
    byte_4B69734 = 1;
  }
  ...
  v14 = v6;
  if ( !*(_DWORD *)(v6 + 24)
    || (v15 = StringLiteral_18401/*"commandcard_select_1st"*/,
        *(_QWORD *)(v6 + 32) = StringLiteral_18401/*"commandcard_select_1st"*/,
        sub_1BE4A70((PartyOrganizationUtility_o *)(v6 + 32), v15, v8, v9, v10, v11, v12, v13),
        *(_DWORD *)(v14 + 24) <= 1u)
    || (v22 = StringLiteral_18402/*"commandcard_select_2nd"*/,
        *(_QWORD *)(v14 + 40) = StringLiteral_18402/*"commandcard_select_2nd"*/,
        sub_1BE4A70((PartyOrganizationUtility_o *)(v14 + 40), v22, v16, v17, v18, v19, v20, v21),
        *(_DWORD *)(v14 + 24) <= 2u) )
  {
    sub_1BE4D30(v6, v7);
  }
  v29 = StringLiteral_18403/*"commandcard_select_3rd"*/;
  *(_QWORD *)(v14 + 48) = StringLiteral_18403/*"commandcard_select_3rd"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69733 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleSelectCommandComponent_TypeInfo, *(_QWORD *)&index);
  ...
  if ( *(_DWORD *)(v9 + 24) <= (unsigned int)index )
    sub_1BE4D30(gameObject, *(_QWORD *)&index);
  if ( !markSprite )
    goto LABEL_16;
...
LABEL_16:
    sub_1BE4D28(gameObject, *(_QWORD *)&index);
  }
}