void __fastcall BattleSelectCommandComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FED55 & 1) == 0 )
  {
    sub_1B640C8(&BattleSelectCommandComponent_TypeInfo, v1);
    sub_1B640C8(&string___TypeInfo, v2);
    sub_1B640C8(&StringLiteral_18096/*"commandcard_select_3rd"*/, v3);
    sub_1B640C8(&StringLiteral_18095/*"commandcard_select_2nd"*/, v4);
    sub_1B640C8(&StringLiteral_18094/*"commandcard_select_1st"*/, v5);
    byte_49FED55 = 1;
  }
  ...
  v10 = v6;
  if ( !*(_DWORD *)(v6 + 24)
    || (v11 = StringLiteral_18094/*"commandcard_select_1st"*/,
        *(_QWORD *)(v6 + 32) = StringLiteral_18094/*"commandcard_select_1st"*/,
        sub_1B6406C((ServantStatusBattleListViewItem_o *)(v6 + 32), v11, v8, v9),
        *(_DWORD *)(v10 + 24) <= 1u)
    || (v14 = StringLiteral_18095/*"commandcard_select_2nd"*/,
        *(_QWORD *)(v10 + 40) = StringLiteral_18095/*"commandcard_select_2nd"*/,
        sub_1B6406C((ServantStatusBattleListViewItem_o *)(v10 + 40), v14, v12, v13),
        *(_DWORD *)(v10 + 24) <= 2u) )
  {
    sub_1B6432C(v6, v7);
  }
  v17 = StringLiteral_18096/*"commandcard_select_3rd"*/;
  *(_QWORD *)(v10 + 48) = StringLiteral_18096/*"commandcard_select_3rd"*/;
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)BattleSelectCommandComponent_TypeInfo->static_fields, v10, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FED54 & 1) == 0 )
  {
    sub_1B640C8(&BattleSelectCommandComponent_TypeInfo, *(_QWORD *)&index);
  ...
  if ( *(_DWORD *)(v9 + 24) <= (unsigned int)index )
    sub_1B6432C(gameObject, *(_QWORD *)&index);
  if ( !markSprite )
    goto LABEL_16;
