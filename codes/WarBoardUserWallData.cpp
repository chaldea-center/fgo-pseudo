...
WarBoardUserWallData_o *WarBoardUserWallData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E4DC & 1) == 0 )
  {
    sub_1C93AD4(&Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  ...
  result = (WarBoardUserWallData_o *)JsonManager__DeserializeArray_object_(
                                       v3,
                                       (const MethodInfo_3213F70 *)Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  if ( result )
  {
