...
WarBoardUserWallData_o *WarBoardUserWallData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4E75202 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  ...
  result = (WarBoardUserWallData_o *)JsonManager__DeserializeArray_object_(
                                       v3,
                                       (const MethodInfo_32C03D4 *)Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  if ( result )
  {
