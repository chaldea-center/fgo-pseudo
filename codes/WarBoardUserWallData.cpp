...
WarBoardUserWallData_o *WarBoardUserWallData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4CB3E70 & 1) == 0 )
  {
    sub_1C6BA08(&Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  ...
  result = (WarBoardUserWallData_o *)JsonManager__DeserializeArray_object_(
                                       v3,
                                       (const MethodInfo_31AB018 *)Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  if ( result )
  {
