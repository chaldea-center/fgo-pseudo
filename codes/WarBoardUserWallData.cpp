...
WarBoardUserWallData_o *__fastcall WarBoardUserWallData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4B6494F & 1) == 0 )
  {
    sub_1BE4ACC(&Method_JsonManager_DeserializeArray_WarBoardUserWallData___, method);
  ...
  result = (WarBoardUserWallData_o *)JsonManager__DeserializeArray_object_(
                                       v5,
                                       (const MethodInfo_2FC092C *)Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  if ( result )
  {
