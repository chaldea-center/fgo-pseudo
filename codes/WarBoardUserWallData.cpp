...
WarBoardUserWallData_o *__fastcall WarBoardUserWallData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4A4C0DD & 1) == 0 )
  {
    sub_1B863B8(&Method_JsonManager_DeserializeArray_WarBoardUserWallData___, method);
  ...
  result = (WarBoardUserWallData_o *)JsonManager__DeserializeArray_object_(
                                       v5,
                                       (const MethodInfo_2FD883C *)Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  if ( result )
  {
