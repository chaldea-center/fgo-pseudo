...
WarBoardUserWallData_o *__fastcall WarBoardUserWallData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4A1D913 & 1) == 0 )
  {
    sub_1B715CC(&Method_JsonManager_DeserializeArray_WarBoardUserWallData___, method);
  ...
  result = (WarBoardUserWallData_o *)JsonManager__DeserializeArray_object_(
                                       v5,
                                       (const MethodInfo_2EC1990 *)Method_JsonManager_DeserializeArray_WarBoardUserWallData___);
  if ( result )
  {
