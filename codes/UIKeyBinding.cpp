...
void UIKeyBinding__OnBindingClick(UIKeyBinding_o *this, const MethodInfo *method)
{
  ...
  UICamera__Notify(gameObject, (System_String_o *)StringLiteral_9955/*"OnClick"*/, 0, 0);
}
...
void UIKeyBinding__OnBindingPress(UIKeyBinding_o *this, bool pressed, const MethodInfo *method)
{
  ...
  if ( !UICamera_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UICamera_TypeInfo);
  UICamera__Notify(gameObject, (System_String_o *)StringLiteral_10063/*"OnPress"*/, v6, 0);
}
...
LABEL_44:
      ...
      sub_1D0F058((GrandQuestFolderBoardItem_o *)&gameObject[2].fields, 0, v26, v27, v28, v29, v30, v31);
      action = this->fields.action;
    }
    if ( action == 1 )
    {
