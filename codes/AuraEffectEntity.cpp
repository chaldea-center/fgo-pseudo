        ...
        const MethodInfo *method)
{
  ...
  sub_1BCACFC(script);
  return (unsigned int)AuraEffectEntity__getScript_39667264(v14, v15, v16, v17);
}


System_String_o *__fastcall AuraEffectEntity__getScript_39667264(
        AuraEffectEntity_o *this,
        System_String_o *key,
