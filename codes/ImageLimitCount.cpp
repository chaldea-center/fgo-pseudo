void __fastcall ImageLimitCount___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B1B96 & 1) == 0 )
  {
    ...
    sub_B52984(&Field__PrivateImplementationDetails__598CEB271FAC09B40101AAE5910D6939EFC22B105F7DF2AA77795704D4CC7911);
    sub_B52984(&Field__PrivateImplementationDetails__E8845519DB154B41E620A98F949B9EDCEFB1F9060DC8290A9F7D2C3200ABD0CB);
    sub_B52984(&Field__PrivateImplementationDetails__F239810D17032E35383496434C64894FFE055A198BA7CFB907D73BAF26A70F0C);
    byte_42B1B96 = 1;
  }
  v1 = (System_Array_o *)sub_B5299C(int___TypeInfo, 5LL);
  v37.fields.value = Field__PrivateImplementationDetails__598CEB271FAC09B40101AAE5910D6939EFC22B105F7DF2AA77795704D4CC7911;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_43814272(v1, v37, 0LL);
  ...
  v38.fields.value = Field__PrivateImplementationDetails__F239810D17032E35383496434C64894FFE055A198BA7CFB907D73BAF26A70F0C;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_43814272(v9, v38, 0LL);
  ...
  sub_B52920(
    ...
    v15,
    v16);
  v17 = (System_Array_o *)sub_B5299C(int___TypeInfo, 4LL);
  v39.fields.value = Field__PrivateImplementationDetails__E8845519DB154B41E620A98F949B9EDCEFB1F9060DC8290A9F7D2C3200ABD0CB;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_43814272(v17, v39, 0LL);
  ...
  sub_B52920(
    ...
    v23,
    v24);
  v25 = (System_Int32_array **)sub_B5299C(int___TypeInfo, 3LL);
  if ( !v25 )
    sub_B52A5C(0LL, v26);
  v33 = *((_DWORD *)v25 + 6);
  v34 = v25;
  ...
  *((_DWORD *)v25 + 10) = 4;
  ...
  sub_B52920((BattleServantConfConponent_o *)&v35->maxDispLimitCountList, v34, v27, v28, v29, v30, v31, v32);
...
LABEL_37:
        v17 = sub_B52A88(limitMaxList);
        sub_B52A28(v17, 0LL);
      }
LABEL_36:
      sub_B52A5C(limitMaxList, *(_QWORD *)&limitCount);
    }
  }
  return 3;
}
...
System_Int32_array *__fastcall ImageLimitCount__GetCardSelectList_28278416(
        int32_t svtId,
        int32_t limitCount,
        int32_t costumeId,
        const MethodInfo *method)
{
  ...
  if ( costumeId <= 10 )
    ...
    v9 = 5LL;
  result = (System_Int32_array *)sub_B5299C(int___TypeInfo, v9);
  if ( !result )
    sub_B52A5C(0LL, v11);
...
LABEL_18:
    sub_B52A5C(v5, *(_QWORD *)&maxLimitCount);
...
// local variable allocation has failed, the output may be wrong!
int32_t __fastcall ImageLimitCount__GetLimitCountByImageLimit_28275948(
        int32_t imageLimitCount,
        int32_t maxLimitCount,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
System_Int32_array *__fastcall ImageLimitCount__GetSelectList_28277688(
        int32_t svtId,
        int32_t limitCount,
        int32_t costumeId,
        bool isOwn,
...
LABEL_7:
    v10 = 0;
  result = (System_Int32_array *)sub_B5299C(int___TypeInfo, (unsigned int)(v10 + 3));
  if ( !result )
    sub_B52A5C(0LL, v12);
  max_length = result->max_length;
  v14 = 0LL;
...
void __fastcall ImageLimitCount__Initialize(const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)&static_fields->limitMaxList, LimitCountMaxList, v3, v4, v5, v6, v7, v8);
}
  ...
  *limitCount = -1;
  ...
  if ( value <= v5 )
  {
    ...
    if ( klass )
    {
      ...
      {
LABEL_15:
        v10 = sub_B52A88(limitMaxList);
        sub_B52A28(v10, 0LL);
      }
      goto LABEL_22;
    }
LABEL_26:
    sub_B52A5C(limitMaxList, *(_QWORD *)&svtLimitCnt);
  }
  if ( (WORD1(ImageLimitCount_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
    && !ImageLimitCount_TypeInfo->_2.cctor_finished )
  {
