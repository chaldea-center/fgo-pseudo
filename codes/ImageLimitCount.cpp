void __fastcall ImageLimitCount___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B65B7F & 1) == 0 )
  {
    sub_1BE4ACC(&ImageLimitCount_TypeInfo, v1);
  ...
  v7 = (System_Array_o *)sub_1BE4B74(int___TypeInfo, 5LL);
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62606144(v7, v53, 0LL);
  ...
  sub_1BE4A70(
    ...
    v13,
    v14);
  v15 = (System_Array_o *)sub_1BE4B74(int___TypeInfo, 4LL);
  v54.fields.value = Field__PrivateImplementationDetails__F239810D17032E35383496434C64894FFE055A198BA7CFB907D73BAF26A70F0C;
  v16 = (int64_t)v15;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62606144(v15, v54, 0LL);
  static_fields = ImageLimitCount_TypeInfo->static_fields;
  static_fields->minLimitCountList = (struct System_Int32_array *)v16;
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->minLimitCountList, v16, v18, v19, v20, v21, v22, v23);
  v24 = (System_Array_o *)sub_1BE4B74(int___TypeInfo, 4LL);
  v55.fields.value = Field__PrivateImplementationDetails__E8845519DB154B41E620A98F949B9EDCEFB1F9060DC8290A9F7D2C3200ABD0CB;
  v25 = (int64_t)v24;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62606144(v24, v55, 0LL);
  v26 = ImageLimitCount_TypeInfo->static_fields;
  v26->maxLimitCountList = (struct System_Int32_array *)v25;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v26->maxLimitCountList, v25, v27, v28, v29, v30, v31, v32);
  v33 = (_DWORD *)sub_1BE4B74(int___TypeInfo, 3LL);
  if ( !v33 )
    sub_1BE4D28(0LL, v34);
  v41 = v33[6];
  v42 = (int64_t)v33;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&v43->maxDispLimitCountList, v42, v35, v36, v37, v38, v39, v40);
  v44 = (System_Array_o *)sub_1BE4B74(int___TypeInfo, 5LL);
  v56.fields.value = Field__PrivateImplementationDetails__3A795EE993DCFCD47AE2FD7282FAE2348DADC51429112235F8375626F9439A0B;
  v45 = (int64_t)v44;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62606144(v44, v56, 0LL);
  v46 = ImageLimitCount_TypeInfo->static_fields;
  v46->dispLimitCountList = (struct System_Int32_array *)v45;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v46->dispLimitCountList, v45, v47, v48, v49, v50, v51, v52);
...
LABEL_33:
      sub_1BE4D30(limitMaxList, *(_QWORD *)&limitCount);
    }
LABEL_32:
    sub_1BE4D28(limitMaxList, *(_QWORD *)&limitCount);
  }
  limitMaxList = (System_Collections_Generic_Dictionary_int__int__o *)ImageLimitCount_TypeInfo;
  if ( !ImageLimitCount_TypeInfo->_2.cctor_finished )
  {
...
// local variable allocation has failed, the output may be wrong!
System_Int32_array *__fastcall ImageLimitCount__GetCardSelectList_38600296(
        int32_t svtId,
        int32_t limitCount,
        int32_t costumeId,
        const MethodInfo *method)
{
  ...
  if ( costumeId <= 10 )
    ...
    v10 = 5LL;
  result = (System_Int32_array *)sub_1BE4B74(int___TypeInfo, v10);
  if ( !result )
    sub_1BE4D28(0LL, v12);
...
int32_t __fastcall ImageLimitCount__GetImageLimitCount(int32_t svtId, int32_t limitCount, const MethodInfo *method)
{
  ...
  if ( (byte_4B65B77 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_Dictionary_int__int__TryGetValue__, *(_QWORD *)&limitCount);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65B76 & 1) == 0 )
  {
    sub_1BE4ACC(&ImageLimitCount_TypeInfo, *(_QWORD *)&maxLimitCount);
    byte_4B65B76 = 1;
  }
...
LABEL_16:
    sub_1BE4D28(v5, *(_QWORD *)&maxLimitCount);
  ...
  if ( maxDispLimitCountList->max_length <= dispLimitCount )
    sub_1BE4D30(v5, *(_QWORD *)&maxLimitCount);
...
// local variable allocation has failed, the output may be wrong!
int32_t __fastcall ImageLimitCount__GetLimitCountByImageLimit_38597824(
        int32_t imageLimitCount,
        int32_t maxLimitCount,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
System_Int32_array *__fastcall ImageLimitCount__GetSelectList_38599480(
        int32_t svtId,
        int32_t limitCount,
        int32_t costumeId,
        bool isOwn,
...
LABEL_6:
  ...
  result = (System_Int32_array *)sub_1BE4B74(int___TypeInfo, v13);
  if ( !result )
    sub_1BE4D28(0LL, v15);
  max_length = result->max_length;
  for ( i = 0LL; i != 3; ++i )
...
void __fastcall ImageLimitCount__Initialize(const MethodInfo *method)
{
  ...
  if ( (byte_4B65B70 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&ImageLimitCount_TypeInfo, v2);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&static_fields->limitMaxList, v14, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B65B74 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_Dictionary_int__int__TryGetValue__, *(_QWORD *)&svtLimitCnt);
  ...
  *limitCount = -1;
  ...
  if ( v10 <= v5 )
  {
    if ( klass )
    {
      ...
      if ( (unsigned int)value >= LODWORD(klass->_1.namespaze) )
LABEL_13:
        sub_1BE4D30(limitMaxList, *(_QWORD *)&svtLimitCnt);
      goto LABEL_17;
    }
LABEL_19:
    sub_1BE4D28(limitMaxList, *(_QWORD *)&svtLimitCnt);
  }
  if ( !klass )
    goto LABEL_19;
