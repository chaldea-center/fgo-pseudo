...
void __fastcall FGO_param3ObjectPoint2__Start(FGO_param3ObjectPoint2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E8C8B & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_16380/*"_threeValue1_2"*/, v5, v6, v7);
    sub_B5D5C4(&StringLiteral_16379/*"_threeValue1_1"*/, v8, v9, v10);
    sub_B5D5C4(&StringLiteral_16378/*"_threeValue1_0"*/, v11, v12, v13);
    byte_42E8C8B = 1;
  }
  ...
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16378/*"_threeValue1_0"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16379/*"_threeValue1_1"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16380/*"_threeValue1_2"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  if ( !v24 )
    goto LABEL_22;
  UnityEngine_Material__SetFloat(v24, (System_String_o *)StringLiteral_16378/*"_threeValue1_0"*/, v25, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v27 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v26
    || (UnityEngine_Material__SetFloat(v26, (System_String_o *)StringLiteral_16379/*"_threeValue1_1"*/, v27, 0LL),
...
LABEL_22:
  ...
  UnityEngine_Material__SetFloat(v29, (System_String_o *)StringLiteral_16380/*"_threeValue1_2"*/, v30, 0LL);
}
...
void __fastcall FGO_param3ObjectPoint2__Update(FGO_param3ObjectPoint2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E8C8C & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_16380/*"_threeValue1_2"*/, (_DWORD)method, v2, v3);
    sub_B5D5C4(&StringLiteral_16379/*"_threeValue1_1"*/, v5, v6, v7);
    sub_B5D5C4(&StringLiteral_16378/*"_threeValue1_0"*/, v8, v9, v10);
    byte_42E8C8C = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer )
  ...
  if ( !v12 )
    goto LABEL_16;
  UnityEngine_Material__SetFloat(v12, (System_String_o *)StringLiteral_16378/*"_threeValue1_0"*/, v13, 0LL);
  renderer = this->fields._renderer;
  if ( !renderer )
    goto LABEL_16;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v15 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v14
    || (UnityEngine_Material__SetFloat(v14, (System_String_o *)StringLiteral_16379/*"_threeValue1_1"*/, v15, 0LL),
...
LABEL_16:
  ...
  UnityEngine_Material__SetFloat(v17, (System_String_o *)StringLiteral_16380/*"_threeValue1_2"*/, v18, 0LL);
}