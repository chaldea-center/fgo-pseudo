...
void __fastcall FGO_param3ObjectPoint2__Start(FGO_param3ObjectPoint2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD40A & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_16516/*"_threeValue1_2"*/, v3);
    sub_1B64870(&StringLiteral_16515/*"_threeValue1_1"*/, v4);
    sub_1B64870(&StringLiteral_16514/*"_threeValue1_0"*/, v5);
    byte_49FD40A = 1;
  }
...
void __fastcall FGO_param3ObjectPoint2__Update(FGO_param3ObjectPoint2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD40B & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_16516/*"_threeValue1_2"*/, method);
    sub_1B64870(&StringLiteral_16515/*"_threeValue1_1"*/, v3);
    sub_1B64870(&StringLiteral_16514/*"_threeValue1_0"*/, v4);
    byte_49FD40B = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer )
