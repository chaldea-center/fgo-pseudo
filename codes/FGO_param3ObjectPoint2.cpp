...
void __fastcall FGO_param3ObjectPoint2__Start(FGO_param3ObjectPoint2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC6936 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_16851/*"_threeValue1_2"*/, v3);
    sub_1C1ABD4(&StringLiteral_16850/*"_threeValue1_1"*/, v4);
    sub_1C1ABD4(&StringLiteral_16849/*"_threeValue1_0"*/, v5);
    byte_4BC6936 = 1;
  }
  ...
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16849/*"_threeValue1_0"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16850/*"_threeValue1_1"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16851/*"_threeValue1_2"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  if ( !v16 )
    goto LABEL_22;
  UnityEngine_Material__SetFloat(v16, (System_String_o *)StringLiteral_16849/*"_threeValue1_0"*/, v17, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v19 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v18
    || (UnityEngine_Material__SetFloat(v18, (System_String_o *)StringLiteral_16850/*"_threeValue1_1"*/, v19, 0LL),
...
LABEL_22:
  ...
  UnityEngine_Material__SetFloat(v21, (System_String_o *)StringLiteral_16851/*"_threeValue1_2"*/, v22, 0LL);
}
...
void __fastcall FGO_param3ObjectPoint2__Update(FGO_param3ObjectPoint2_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC6937 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_16851/*"_threeValue1_2"*/, method);
    sub_1C1ABD4(&StringLiteral_16850/*"_threeValue1_1"*/, v3);
    sub_1C1ABD4(&StringLiteral_16849/*"_threeValue1_0"*/, v4);
    byte_4BC6937 = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer )
  ...
  if ( !v6 )
    goto LABEL_16;
  UnityEngine_Material__SetFloat(v6, (System_String_o *)StringLiteral_16849/*"_threeValue1_0"*/, v7, 0LL);
  renderer = this->fields._renderer;
  if ( !renderer )
    goto LABEL_16;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v9 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v8
    || (UnityEngine_Material__SetFloat(v8, (System_String_o *)StringLiteral_16850/*"_threeValue1_1"*/, v9, 0LL),
...
LABEL_16:
  ...
  UnityEngine_Material__SetFloat(v11, (System_String_o *)StringLiteral_16851/*"_threeValue1_2"*/, v12, 0LL);
}