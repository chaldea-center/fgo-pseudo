        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6ED8 & 1) == 0 )
  {
    sub_1C1ABD4(&ClassButtonComponent_CallbackFunc_TypeInfo, value);
    byte_4BC6ED8 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5C208;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5C1C0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6EDA & 1) == 0 )
  {
    sub_1C1ABD4(&int_TypeInfo, *(_QWORD *)&classPos);
    byte_4BC6EDA = 1;
  }
  v9[1] = 0LL;
