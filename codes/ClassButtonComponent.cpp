        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D8BC & 1) == 0 )
  {
    sub_1B863B8(&ClassButtonComponent_CallbackFunc_TypeInfo, value);
    byte_4A4D8BC = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D2AA8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D2A60;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D8BE & 1) == 0 )
  {
    sub_1B863B8(&int_TypeInfo, *(_QWORD *)&classPos);
    byte_4A4D8BE = 1;
  }
  v9[1] = 0LL;
