        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A080D9 & 1) == 0 )
  {
    sub_1B686D4(&ClassButtonComponent_CallbackFunc_TypeInfo, value);
    byte_4A080D9 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B0618;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B05D0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A080DB & 1) == 0 )
  {
    sub_1B686D4(&int_TypeInfo, *(_QWORD *)&classPos);
    byte_4A080DB = 1;
  }
  v9[1] = 0LL;
