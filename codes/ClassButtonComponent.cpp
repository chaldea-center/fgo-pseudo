        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD98A & 1) == 0 )
  {
    sub_1B64870(&ClassButtonComponent_CallbackFunc_TypeInfo, value);
    byte_49FD98A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19AC820;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19AC7D8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD98C & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&classPos);
    byte_49FD98C = 1;
  }
  v9[1] = 0LL;
