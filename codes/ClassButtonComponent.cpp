...
void ClassButtonComponent__Awake(ClassButtonComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BBE2 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_410/*"#606060"*/);
    byte_4D2BBE2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BBE0 & 1) == 0 )
  {
    sub_1C94098(&ClassButtonComponent_CallbackFunc_TypeInfo);
    byte_4D2BBE0 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC8984;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC893C;
}
