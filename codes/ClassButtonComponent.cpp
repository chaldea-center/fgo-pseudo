        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EF41 & 1) == 0 )
  {
    sub_1B715CC(&ClassButtonComponent_CallbackFunc_TypeInfo, value);
    byte_4A1EF41 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B91C8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B9180;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1EF43 & 1) == 0 )
  {
    sub_1B715CC(&int_TypeInfo, *(_QWORD *)&classPos);
    byte_4A1EF43 = 1;
  }
  v9[1] = 0LL;
