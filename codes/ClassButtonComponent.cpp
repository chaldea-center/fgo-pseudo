        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3B0A & 1) == 0 )
  {
    sub_1C13D24(&ClassButtonComponent_CallbackFunc_TypeInfo, value);
    byte_4BB3B0A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A55408;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A553C0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3B0C & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, *(_QWORD *)&classPos);
    byte_4BB3B0C = 1;
  }
  v9[1] = 0LL;
