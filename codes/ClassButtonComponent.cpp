        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D3AC & 1) == 0 )
  {
    sub_1B761C0(&ClassButtonComponent_CallbackFunc_TypeInfo, value);
    byte_4A2D3AC = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19BD6C8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19BD680;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D3AE & 1) == 0 )
  {
    sub_1B761C0(&int_TypeInfo, *(_QWORD *)&classPos);
    byte_4A2D3AE = 1;
  }
  v9[1] = 0LL;
