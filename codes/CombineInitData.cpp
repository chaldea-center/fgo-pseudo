void CombineInitData___ctor(CombineInitData_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.eventIdList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B7C9 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_DataMasterBase_EventCampaignMaster__EventCampaignEntity__string__getEntitys__);
    sub_1C32C20(&Method_System_Collections_Generic_List_int__Add__);
    byte_4C3B7C9 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_EventCampaignMaster___);
  if ( !Master_object )
    goto LABEL_20;
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__object___getEntitys(
                                                                  Master_object,
                                                                  (const MethodInfo_339A574 *)Method_DataMasterBase_EventCampaignMaster__EventCampaignEntity__string__getEntitys__);
  if ( !Master_object )
    return 0;
...
void CombineInitData__getEventData(CombineInitData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3B7C8 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_EventEntity__AddRange__);
    sub_1C32C20(&Method_System_Collections_Generic_List_EventEntity__ToArray__);
    sub_1C32C20(&Method_System_Collections_Generic_List_EventEntity___ctor___78003024);
    sub_1C32C20(&System_Collections_Generic_List_EventEntity__TypeInfo);
    sub_1C32C20(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C3B7C8 = 1;
  }
  Instance = (EventEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    ...
    || (v4 = (EventMaster_o *)Instance,
        ...
        !EnableEntityList)
    || (v6 = Instance) == 0
    || (v7 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_EventEntity__TypeInfo),
        System_Collections_Generic_List_object____ctor_58294264(
          v7,
          LODWORD(v6->max_length) + LODWORD(EnableEntityList->max_length),
          (const MethodInfo_3797FF8 *)Method_System_Collections_Generic_List_EventEntity___ctor___78003024),
        !v7) )
  {
  ...
  System_Collections_Generic_List_object___AddRange(
    ...
    (const MethodInfo_37989C8 *)Method_System_Collections_Generic_List_EventEntity__AddRange__);
  System_Collections_Generic_List_object___AddRange(
    v7,
  ...
  v8 = (struct EventEntity_array *)System_Collections_Generic_List_object___ToArray(
                                     v7,
                                     (const MethodInfo_379A314 *)Method_System_Collections_Generic_List_EventEntity__ToArray__);
  this->fields.combineEventList = v8;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.combineEventList, (int32_t)v8, v9, v10);
}
