void __fastcall CombineInitData___ctor(CombineInitData_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventIdList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51EE7 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMaster_EventCampaignMaster___, *(_QWORD *)&eventId);
    sub_1B863B8(&DataManager_TypeInfo, v5);
    sub_1B863B8(&Method_DataMasterBase_EventCampaignMaster__EventCampaignEntity__string__getEntitys__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_int__Add__, v7);
    byte_4A51EE7 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_EventCampaignMaster___);
  if ( !Master_object )
    goto LABEL_20;
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__object___getEntitys(
                                                                  Master_object,
                                                                  (const MethodInfo_3217FBC *)Method_DataMasterBase_EventCampaignMaster__EventCampaignEntity__string__getEntitys__);
  if ( !Master_object )
    return 0LL;
...
void __fastcall CombineInitData__getEventData(CombineInitData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A51EE6 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_Generic_List_EventEntity__AddRange__, v3);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventEntity__ToArray__, v4);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventEntity___ctor___76029576, v5);
    sub_1B863B8(&System_Collections_Generic_List_EventEntity__TypeInfo, v6);
  ...
  if ( !Instance
    ...
    || (v10 = (EventMaster_o *)Instance,
        ...
        !EnableEntityList)
    || (v12 = Instance) == 0LL
    || (v13 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_EventEntity__TypeInfo),
        System_Collections_Generic_List_object____ctor_56607124(
          v13,
          v12->max_length + EnableEntityList->max_length,
          (const MethodInfo_35FC194 *)Method_System_Collections_Generic_List_EventEntity___ctor___76029576),
        !v13) )
  {
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.combineEventList, (int32_t)v14, v15, v16);
}
