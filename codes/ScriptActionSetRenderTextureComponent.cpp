void ScriptActionSetRenderTextureComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4C44EDB & 1) == 0 )
  {
    sub_1C37058(&ScriptActionSetRenderTextureComponent_TypeInfo);
    byte_4C44EDB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  ScriptManager_o *ComponentsInChildren_object__51641852; // x0
  ...
  if ( (byte_4C44EDA & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponentsInChildren_Renderer___);
  ...
  if ( textureType == 1 )
  {
    ComponentsInChildren_object__51641852 = (ScriptManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
    if ( !ComponentsInChildren_object__51641852 )
      goto LABEL_34;
    captureTexture = (UnityEngine_Object_o *)ComponentsInChildren_object__51641852->fields.captureTexture;
  }
  else if ( textureType )
  {
    captureTexture = 0;
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ComponentsInChildren_object__51641852 = (ScriptManager_o *)UnityEngine_Object__op_Equality(captureTexture, 0, 0);
...
LABEL_34:
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v9 >= max_length )
        goto LABEL_35;
      ComponentsInChildren_object__51641852 = (ScriptManager_o *)TargetObjects->m_Items[v9];
      if ( !ComponentsInChildren_object__51641852 )
        goto LABEL_34;
      ComponentsInChildren_object__51641852 = (ScriptManager_o *)UnityEngine_GameObject__GetComponentsInChildren_object__51641852(
                                                                   (UnityEngine_GameObject_o *)ComponentsInChildren_object__51641852,
                                                                   (const MethodInfo_313FDFC *)Method_UnityEngine_GameObject_GetComponentsInChildren_Renderer___);
      if ( !ComponentsInChildren_object__51641852 )
        goto LABEL_34;
      m_CancellationTokenSource = (int)ComponentsInChildren_object__51641852->fields.m_CancellationTokenSource;
      v11 = (UnityEngine_GameObject_o *)ComponentsInChildren_object__51641852;
...
LABEL_32:
    ...
    while ( v12 < m_CancellationTokenSource )
    {
      ...
      if ( !v14 )
        goto LABEL_34;
      ComponentsInChildren_object__51641852 = (ScriptManager_o *)UnityEngine_Renderer__get_material(
                                                                   (UnityEngine_Renderer_o *)v13[4],
                                                                   0);
      if ( !ComponentsInChildren_object__51641852 )
        goto LABEL_34;
      UnityEngine_Material__set_mainTexture(
        (UnityEngine_Material_o *)ComponentsInChildren_object__51641852,
        (UnityEngine_Texture_o *)captureTexture,
        0);
      ComponentsInChildren_object__51641852 = (ScriptManager_o *)UnityEngine_Renderer__get_material(v14, 0);
      v15 = ScriptActionSetRenderTextureComponent_TypeInfo;
      v16 = (UnityEngine_Material_o *)ComponentsInChildren_object__51641852;
