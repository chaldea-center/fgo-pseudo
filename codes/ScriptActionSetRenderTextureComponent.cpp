void ScriptActionSetRenderTextureComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4CF0567 & 1) == 0 )
  {
    sub_1C7BAE8(&ScriptActionSetRenderTextureComponent_TypeInfo);
    byte_4CF0567 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  ScriptManager_o *ComponentsInChildren_object__52198636; // x0
  __int64 v6; // x1
  ...
  if ( (byte_4CF0566 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponentsInChildren_Renderer___);
  ...
  if ( textureType == 1 )
  {
    ComponentsInChildren_object__52198636 = (ScriptManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
    if ( !ComponentsInChildren_object__52198636 )
      goto LABEL_34;
    captureTexture = (UnityEngine_Object_o *)ComponentsInChildren_object__52198636->fields.captureTexture;
  }
  else if ( textureType )
  {
    captureTexture = 0;
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ComponentsInChildren_object__52198636 = (ScriptManager_o *)UnityEngine_Object__op_Equality(captureTexture, 0, 0);
  if ( ((unsigned __int8)ComponentsInChildren_object__52198636 & 1) != 0 )
    return;
  TargetObjects = this->fields.TargetObjects;
  if ( !TargetObjects )
LABEL_34:
    sub_1C7BD40(ComponentsInChildren_object__52198636, v6);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v10 >= max_length )
        goto LABEL_35;
      ComponentsInChildren_object__52198636 = (ScriptManager_o *)TargetObjects->m_Items[v10];
      if ( !ComponentsInChildren_object__52198636 )
        goto LABEL_34;
      ComponentsInChildren_object__52198636 = (ScriptManager_o *)UnityEngine_GameObject__GetComponentsInChildren_object__52198636(
                                                                   (UnityEngine_GameObject_o *)ComponentsInChildren_object__52198636,
                                                                   (const MethodInfo_31C7CEC *)Method_UnityEngine_GameObject_GetComponentsInChildren_Renderer___);
      if ( !ComponentsInChildren_object__52198636 )
        goto LABEL_34;
      m_CancellationTokenSource = (int)ComponentsInChildren_object__52198636->fields.m_CancellationTokenSource;
      v12 = (UnityEngine_GameObject_o *)ComponentsInChildren_object__52198636;
...
LABEL_32:
    ...
    while ( v13 < m_CancellationTokenSource )
    {
      ...
      if ( !v15 )
        goto LABEL_34;
      ComponentsInChildren_object__52198636 = (ScriptManager_o *)UnityEngine_Renderer__get_material(
                                                                   (UnityEngine_Renderer_o *)v14[4],
                                                                   0);
      if ( !ComponentsInChildren_object__52198636 )
        goto LABEL_34;
      UnityEngine_Material__set_mainTexture(
        (UnityEngine_Material_o *)ComponentsInChildren_object__52198636,
        (UnityEngine_Texture_o *)captureTexture,
        0);
      ComponentsInChildren_object__52198636 = (ScriptManager_o *)UnityEngine_Renderer__get_material(v15, 0);
      v16 = ScriptActionSetRenderTextureComponent_TypeInfo;
      v17 = (UnityEngine_Material_o *)ComponentsInChildren_object__52198636;
