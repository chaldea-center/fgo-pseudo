void ScriptActionSetRenderTextureComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4C58CA7 & 1) == 0 )
  {
    sub_1C3E564(&ScriptActionSetRenderTextureComponent_TypeInfo);
    byte_4C58CA7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  ScriptManager_o *ComponentsInChildren_object__51715312; // x0
  __int64 v6; // x1
  ...
  if ( (byte_4C58CA6 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponentsInChildren_Renderer___);
  ...
  if ( textureType == 1 )
  {
    ComponentsInChildren_object__51715312 = (ScriptManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_ScriptManager__get_Instance__);
    if ( !ComponentsInChildren_object__51715312 )
      goto LABEL_34;
    captureTexture = (UnityEngine_Object_o *)ComponentsInChildren_object__51715312->fields.captureTexture;
  }
  else if ( textureType )
  {
    captureTexture = 0;
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ComponentsInChildren_object__51715312 = (ScriptManager_o *)UnityEngine_Object__op_Equality(captureTexture, 0, 0);
...
LABEL_34:
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v10 >= max_length )
        goto LABEL_35;
      ComponentsInChildren_object__51715312 = (ScriptManager_o *)TargetObjects->m_Items[v10];
      if ( !ComponentsInChildren_object__51715312 )
        goto LABEL_34;
      ComponentsInChildren_object__51715312 = (ScriptManager_o *)UnityEngine_GameObject__GetComponentsInChildren_object__51715312(
                                                                   (UnityEngine_GameObject_o *)ComponentsInChildren_object__51715312,
                                                                   (const MethodInfo_3151CF0 *)Method_UnityEngine_GameObject_GetComponentsInChildren_Renderer___);
      if ( !ComponentsInChildren_object__51715312 )
        goto LABEL_34;
      m_CancellationTokenSource = (int)ComponentsInChildren_object__51715312->fields.m_CancellationTokenSource;
      v12 = (UnityEngine_GameObject_o *)ComponentsInChildren_object__51715312;
...
LABEL_32:
    ...
    while ( v13 < m_CancellationTokenSource )
    {
      ...
      if ( !v15 )
        goto LABEL_34;
      ComponentsInChildren_object__51715312 = (ScriptManager_o *)UnityEngine_Renderer__get_material(
                                                                   (UnityEngine_Renderer_o *)v14[4],
                                                                   0);
      if ( !ComponentsInChildren_object__51715312 )
        goto LABEL_34;
      UnityEngine_Material__set_mainTexture(
        (UnityEngine_Material_o *)ComponentsInChildren_object__51715312,
        (UnityEngine_Texture_o *)captureTexture,
        0);
      ComponentsInChildren_object__51715312 = (ScriptManager_o *)UnityEngine_Renderer__get_material(v15, 0);
      v16 = ScriptActionSetRenderTextureComponent_TypeInfo;
      v17 = (UnityEngine_Material_o *)ComponentsInChildren_object__51715312;
