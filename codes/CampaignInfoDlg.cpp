void __fastcall CampaignInfoDlg___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BAF1A0 & 1) == 0 )
  {
    sub_1C13D24(&CampaignInfoDlg_TypeInfo, v1);
    sub_1C13D24(&StringLiteral_14835/*"Trying to remove {0} from rebuild list while we are already inside a rebuild loop. This is not supported."*/, v2);
    sub_1C13D24(&StringLiteral_24495/*"try"*/, v3);
    byte_4BAF1A0 = 1;
  }
  ...
  sub_1C13CC8(&static_fields->alphaImgPath);
  v5 = CampaignInfoDlg_TypeInfo->static_fields;
  v5->alphaImgName = (struct System_String_o *)StringLiteral_24495/*"try"*/;
  sub_1C13CC8(&v5->alphaImgName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF192 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___, v7);
    ...
    sub_1C13D24(&StringLiteral_16993/*"aix"*/, v12);
    this = (CampaignInfoDlg_o *)sub_1C13D24(&StringLiteral_7640/*"Illegal rep dist code"*/, v13);
    byte_4BAF192 = 1;
  }
  if ( !data )
    goto LABEL_38;
  ...
  if ( m_CancellationTokenSource >= 1 )
  {
    ...
    while ( v18 < m_CancellationTokenSource )
    {
      ...
      if ( v18 >= LODWORD(v17->fields.m_CancellationTokenSource) )
        break;
      v25 = (char)this;
      this = (CampaignInfoDlg_o *)AssetData__GetObject_object__49747248(
                                    data,
                                    *v23,
...
LABEL_16:
  ...
  v29 = System_Int32__ToString((int)v41 + 224, 0LL);
  this = (CampaignInfoDlg_o *)System_String__Concat_62967944((System_String_o *)StringLiteral_7640/*"Illegal rep dist code"*/, v29, 0LL);
  if ( !v28 )
    goto LABEL_38;
  ...
  this = (CampaignInfoDlg_o *)UnityEngine_GameObject__GetComponent_object_(
                                ...
                                (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___);
  ...
  if ( !byte_4BAEDA6 )
  {
    this = (CampaignInfoDlg_o *)sub_1C13D24(&UnityEngine_Vector3_TypeInfo, data);
    byte_4BAEDA6 = 1;
  }
  if ( !v35
...
void __fastcall CampaignInfoDlg__AfterLoad(CampaignInfoDlg_o *this, int32_t addCount, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF193 & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1C13D24(&StringLiteral_10185/*"Opacity update total\t: "*/, *(_QWORD *)&addCount);
    byte_4BAF193 = 1;
  }
  ...
  if ( !infoData )
    sub_1C13F80(this, *(_QWORD *)&addCount);
...
void __fastcall CampaignInfoDlg__Close(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  CampaignInfoDlg__Close_31026200(this, 0LL, v2);
}


void __fastcall CampaignInfoDlg__Close_31026200(
        CampaignInfoDlg_o *this,
        System_Action_o *callback,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF199 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CampaignInfoDlg_EndClose__, v5);
    byte_4BAF199 = 1;
  }
...
void __fastcall CampaignInfoDlg__EndClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF19A & 1) == 0 )
  {
    ...
    sub_1C13D24(&CampaignInfoDlg_TypeInfo, v3);
  ...
  if ( this->fields.alphaTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1C13CC8(&this->fields.alphaTexAssetData);
  ...
  if ( this->fields.baseTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1C13CC8(&this->fields.baseTexAssetData);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        if ( (unsigned int)v19 >= max_length )
          sub_1C13F88(ImagePageList, method, v11, v12);
...
LABEL_29:
    ...
    sub_1C13CC8(&this->fields.infoData);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF18F & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_20992/*"indexer"*/, v7);
    byte_4BAF18F = 1;
  }
  v11 = imgId;
  ...
  return System_String__Concat_62967944((System_String_o *)StringLiteral_20992/*"indexer"*/, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF18E & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1C13D24(&StringLiteral_4069/*"CameraShake"*/, *(_QWORD *)&imgId);
    byte_4BAF18E = 1;
  }
  CampaignInfoImageName = CampaignInfoDlg__GetCampaignInfoImageName(this, imgId, method);
  return System_String__Concat_62967944((System_String_o *)StringLiteral_4069/*"CameraShake"*/, CampaignInfoImageName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( LODWORD(this->fields.m_CancellationTokenSource) <= 2 )
    sub_1C13F88(this, imageName, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF18C & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1C13D24(&StringLiteral_14832/*"Trying to purchase null Product"*/, *(_QWORD *)&imgId);
    byte_4BAF18C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF195 & 1) == 0 )
  {
    ...
    sub_1C13D24(&CampaignInfoDlg_TypeInfo, v5);
    sub_1C13D24(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    sub_1C13D24(&Method_CampaignInfoDlg___c__DisplayClass45_0__LoadAlpha_b__0__, v7);
    sub_1C13D24(&CampaignInfoDlg___c__DisplayClass45_0_TypeInfo, v8);
    byte_4BAF195 = 1;
  }
  v9 = (Il2CppObject *)sub_1C13F70(CampaignInfoDlg___c__DisplayClass45_0_TypeInfo);
...
void __fastcall CampaignInfoDlg__LoadBase(CampaignInfoDlg_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF194 & 1) == 0 )
  {
    ...
    sub_1C13D24(&CampaignInfoDlg_TypeInfo, v5);
    sub_1C13D24(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    sub_1C13D24(&Method_CampaignInfoDlg___c__DisplayClass44_0__LoadBase_b__0__, v7);
    sub_1C13D24(&CampaignInfoDlg___c__DisplayClass44_0_TypeInfo, v8);
    byte_4BAF194 = 1;
  }
  v9 = (Il2CppObject *)sub_1C13F70(CampaignInfoDlg___c__DisplayClass44_0_TypeInfo);
  System_Object___ctor(v9, 0LL);
  if ( !v9 )
    sub_1C13F80(v10, v11);
  v9[1].klass = (Il2CppClass *)this;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF18B & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CampaignInfoDlg__LoadImages_b__34_0__, v4);
  ...
  sub_1C13CC8(&this->fields.ImagePageList);
...
void __fastcall CampaignInfoDlg__LoadStart(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13D24(&AssetManager_TypeInfo, method);
    sub_1C13D24(&Method_CampaignInfoDlg__LoadStart_b__40_0__, v5);
    this = (CampaignInfoDlg_o *)sub_1C13D24(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    byte_4BAF190 = 1;
  }
  infoData = v4->fields.infoData;
  if ( !infoData )
...
LABEL_13:
  ...
  {
    v11 = (AssetLoader_LoadEndDataHandler_o *)sub_1C13F70(AssetLoader_LoadEndDataHandler_TypeInfo);
...
void __fastcall CampaignInfoDlg__OnCancelButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF19C & 1) == 0 )
  {
    sub_1C13D24(&Method_CampaignInfoDlg_OnCancelButton__, method);
    byte_4BAF19C = 1;
  }
...
void __fastcall CampaignInfoDlg__OnClickClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF19D & 1) == 0 )
  {
    sub_1C13D24(&Method_CampaignInfoDlg_OnClickClose__, method);
    byte_4BAF19D = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
...
void __fastcall CampaignInfoDlg__OnDecideButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF19B & 1) == 0 )
  {
    sub_1C13D24(&Method_CampaignInfoDlg_OnDecideButton__, method);
    byte_4BAF19B = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF18A & 1) == 0 )
  {
    sub_1C13D24(&CampaignInfoDlg_TypeInfo, cInfo);
    byte_4BAF18A = 1;
  }
  ...
  sub_1C13CC8(&this->fields.btnCallbackFunc);
...
void __fastcall CampaignInfoDlg__OpenWindow(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF196 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CampaignInfoDlg_EndOpen__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF191 & 1) == 0 )
  {
    ...
    sub_1C13D24(&NGUITools_TypeInfo, v7);
    sub_1C13D24(&StringLiteral_5068/*"Custom/Sprite-ScriptActionFigureSummonCombine"*/, v8);
    sub_1C13D24(&StringLiteral_16520/*"_L"*/, v9);
    byte_4BAF191 = 1;
  }
  ...
  v13 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5068/*"Custom/Sprite-ScriptActionFigureSummonCombine"*/, 0LL);
...
void __fastcall CampaignInfoDlg__SetDecideActive(CampaignInfoDlg_o *this, bool onOff, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF19E & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_BoxCollider___, onOff);
  ...
  if ( !DecideButton )
LABEL_10:
    sub_1C13F80(DecideButton, onOff);
  v8 = 1.0;
  v9 = v7;
  v10 = v7;
...
LABEL_10:
    sub_1C13F80(CloseButton, isDisp);
  }
...
void __fastcall CampaignInfoDlg__UpdatePage(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BAF197 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CampaignInfoDlg__UpdatePage_b__47_0__, v3);
    sub_1C13D24(&CampaignInfoDlg_TypeInfo, v4);
    byte_4BAF197 = 1;
  }
  ...
  v8 = (EventDelegate_Callback_o *)sub_1C13F70(EventDelegate_Callback_TypeInfo);
...
void __fastcall CampaignInfoDlg___LoadImages_b__34_0(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C13D24(&System_Action_TypeInfo, method);
    sub_1C13D24(&Method_CampaignInfoDlg_LoadStart__, v3);
    byte_4BAF1A1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF1A2 & 1) == 0 )
  {
    ...
    this = (CampaignInfoDlg_o *)sub_1C13D24(&Method_CampaignInfoDlg__LoadStart_b__40_1__, v5);
    byte_4BAF1A2 = 1;
  }
  if ( !data )
    sub_1C13F80(this, data);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF1A4 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_16520/*"_L"*/, v8);
    byte_4BAF1A4 = 1;
  }
  ...
  sub_1C13CC8(&_4__this->fields.baseTexAssetData);
  v10 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5068/*"Custom/Sprite-ScriptActionFigureSummonCombine"*/, 0LL);
  v11 = (UnityEngine_Material_o *)sub_1C13F70(UnityEngine_Material_TypeInfo);
  UnityEngine_Material___ctor(v11, v10, 0LL);
  v12 = this->fields.__4__this;
  if ( !v12 )
    goto LABEL_14;
  _4__this = (CampaignInfoDlg_o *)v12->fields.BaseImg;
  if ( !_4__this )
    goto LABEL_14;
  ...
  if ( !v14
    || (_4__this = (CampaignInfoDlg_o *)CampaignInfoDlg__GetTuorialImageName(
                                          ...
                                          v13),
        !data)
    || (_4__this = (CampaignInfoDlg_o *)AssetData__GetObject_object__49747248(
                                          data,
    ...
    || (_4__this = (CampaignInfoDlg_o *)v15->fields.alphaTexAssetData) == 0LL )
  {
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8(&_4__this->fields.alphaTexAssetData);
  ActionExtensions__Call(this->fields.callback, 0LL);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A4D360;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A4D318;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF1A3 & 1) == 0 )
  {
    sub_1C13D24(&bool_TypeInfo, decide);
    byte_4BAF1A3 = 1;
  }
  v9[1] = 0LL;
