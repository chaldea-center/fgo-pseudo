void __fastcall CampaignInfoDlg___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FB0 & 1) == 0 )
  {
    sub_1C21E38(&CampaignInfoDlg_TypeInfo);
  ...
  v2 = StringLiteral_14858/*"Tutorial/tutorial_alpha"*/;
  static_fields->alphaImgPath = (struct System_String_o *)StringLiteral_14858/*"Tutorial/tutorial_alpha"*/;
  sub_1C21DDC(&static_fields->alphaImgPath, v2);
  v3 = StringLiteral_24535/*"tutorial_alpha"*/;
  v4 = CampaignInfoDlg_TypeInfo->static_fields;
  v4->alphaImgName = (struct System_String_o *)StringLiteral_24535/*"tutorial_alpha"*/;
  sub_1C21DDC(&v4->alphaImgName, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FA2 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___);
    ...
    this = (CampaignInfoDlg_o *)sub_1C21E38(&StringLiteral_7653/*"Image"*/);
    byte_4BD6FA2 = 1;
  }
  if ( !data )
    goto LABEL_38;
  ...
  if ( m_CancellationTokenSource >= 1 )
  {
    ...
    while ( v9 < m_CancellationTokenSource )
    {
      ...
      if ( v9 >= LODWORD(v8->fields.m_CancellationTokenSource) )
        break;
      v16 = (char)this;
      this = (CampaignInfoDlg_o *)AssetData__GetObject_object__49880776(
                                    data,
                                    *v14,
...
LABEL_16:
  ...
  this = (CampaignInfoDlg_o *)System_String__Concat_63115476((System_String_o *)StringLiteral_7653/*"Image"*/, v21, 0LL);
  if ( !v20 )
    goto LABEL_38;
  ...
  this = (CampaignInfoDlg_o *)UnityEngine_GameObject__GetComponent_object_(
                                ...
                                (const MethodInfo_3000534 *)Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___);
  ...
  if ( !byte_4BD6BB6 )
  {
    this = (CampaignInfoDlg_o *)sub_1C21E38(&UnityEngine_Vector3_TypeInfo);
    byte_4BD6BB6 = 1;
  }
  if ( !v27
...
void __fastcall CampaignInfoDlg__AfterLoad(CampaignInfoDlg_o *this, int32_t addCount, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FA3 & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1C21E38(&StringLiteral_10201/*"OpenWindow"*/);
    byte_4BD6FA3 = 1;
  }
  ...
  if ( !infoData )
    sub_1C22094(this, *(_QWORD *)&addCount);
...
void __fastcall CampaignInfoDlg__Close(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  CampaignInfoDlg__Close_31083820(this, 0LL, v2);
}


void __fastcall CampaignInfoDlg__Close_31083820(
        CampaignInfoDlg_o *this,
        System_Action_o *callback,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FA9 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_CampaignInfoDlg_EndClose__);
    byte_4BD6FA9 = 1;
  }
...
void __fastcall CampaignInfoDlg__EndClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.alphaTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1C21DDC(&this->fields.alphaTexAssetData, 0LL);
  ...
  if ( this->fields.baseTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1C21DDC(&this->fields.baseTexAssetData, 0LL);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        if ( (unsigned int)v12 >= max_length )
          sub_1C2209C(ImagePageList, method);
...
LABEL_29:
    ...
    sub_1C21DDC(&this->fields.infoData, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD6F9F & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_21024/*"info_"*/);
    byte_4BD6F9F = 1;
  }
  v9 = imgId;
  ...
  return System_String__Concat_63115476((System_String_o *)StringLiteral_21024/*"info_"*/, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD6F9E & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1C21E38(&StringLiteral_4081/*"CampaignInfo/"*/);
    byte_4BD6F9E = 1;
  }
  CampaignInfoImageName = CampaignInfoDlg__GetCampaignInfoImageName(this, imgId, method);
  return System_String__Concat_63115476((System_String_o *)StringLiteral_4081/*"CampaignInfo/"*/, CampaignInfoImageName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD6F9C & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1C21E38(&StringLiteral_14855/*"Tutorial/"*/);
    byte_4BD6F9C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FA5 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_CampaignInfoDlg___c__DisplayClass45_0__LoadAlpha_b__0__);
    sub_1C21E38(&CampaignInfoDlg___c__DisplayClass45_0_TypeInfo);
    byte_4BD6FA5 = 1;
  }
  v5 = (Il2CppObject *)sub_1C22084(CampaignInfoDlg___c__DisplayClass45_0_TypeInfo);
...
void __fastcall CampaignInfoDlg__LoadBase(CampaignInfoDlg_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FA4 & 1) == 0 )
  {
    ...
    sub_1C21E38(&CampaignInfoDlg_TypeInfo);
    sub_1C21E38(&AssetLoader_LoadEndDataHandler_TypeInfo);
    sub_1C21E38(&Method_CampaignInfoDlg___c__DisplayClass44_0__LoadBase_b__0__);
    sub_1C21E38(&CampaignInfoDlg___c__DisplayClass44_0_TypeInfo);
    byte_4BD6FA4 = 1;
  }
  v5 = (Il2CppObject *)sub_1C22084(CampaignInfoDlg___c__DisplayClass44_0_TypeInfo);
  System_Object___ctor(v5, 0LL);
  if ( !v5 )
    sub_1C22094(v6, v7);
  v5[1].klass = (Il2CppClass *)this;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_CampaignInfoDlg__LoadImages_b__34_0__);
  ...
  sub_1C21DDC(&this->fields.ImagePageList, v4);
...
void __fastcall CampaignInfoDlg__LoadStart(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&AssetManager_TypeInfo);
    sub_1C21E38(&Method_CampaignInfoDlg__LoadStart_b__40_0__);
    this = (CampaignInfoDlg_o *)sub_1C21E38(&AssetLoader_LoadEndDataHandler_TypeInfo);
    byte_4BD6FA0 = 1;
  }
...
void __fastcall CampaignInfoDlg__OnCancelButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FAC & 1) == 0 )
  {
    sub_1C21E38(&Method_CampaignInfoDlg_OnCancelButton__);
    byte_4BD6FAC = 1;
  }
...
void __fastcall CampaignInfoDlg__OnClickClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FAD & 1) == 0 )
  {
    sub_1C21E38(&Method_CampaignInfoDlg_OnClickClose__);
    byte_4BD6FAD = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
...
void __fastcall CampaignInfoDlg__OnDecideButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FAB & 1) == 0 )
  {
    sub_1C21E38(&Method_CampaignInfoDlg_OnDecideButton__);
    byte_4BD6FAB = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(&this->fields.infoData, script);
  this->fields.isButtonEnable = 0;
  ...
  sub_1C21DDC(&this->fields.btnCallbackFunc, onClickButton);
...
void __fastcall CampaignInfoDlg__OpenWindow(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_CampaignInfoDlg_EndOpen__);
    sub_1C21E38(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4BD6FA6 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
        ...
        const MethodInfo *method)
{
  ...
  v8 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5081/*"Custom/SpriteWithMask"*/, 0LL);
  v9 = (UnityEngine_Material_o *)sub_1C22084(UnityEngine_Material_TypeInfo);
...
void __fastcall CampaignInfoDlg__SetDecideActive(CampaignInfoDlg_o *this, bool onOff, const MethodInfo *method)
{
  ...
  if ( !DecideButton )
LABEL_10:
    sub_1C22094(DecideButton, onOff);
  v7 = 1.0;
  v8 = v6;
  v9 = v6;
...
LABEL_10:
    sub_1C22094(CloseButton, isDisp);
  }
...
void __fastcall CampaignInfoDlg__UpdatePage(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD6FA7 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_CampaignInfoDlg__UpdatePage_b__47_0__);
    sub_1C21E38(&CampaignInfoDlg_TypeInfo);
    byte_4BD6FA7 = 1;
  }
...
void __fastcall CampaignInfoDlg___LoadImages_b__34_0(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_CampaignInfoDlg_LoadStart__);
    byte_4BD6FB1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    this = (CampaignInfoDlg_o *)sub_1C21E38(&Method_CampaignInfoDlg__LoadStart_b__40_1__);
    byte_4BD6FB2 = 1;
  }
  if ( !data )
    sub_1C22094(this, data);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(&_4__this->fields.baseTexAssetData, data);
  v6 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_5081/*"Custom/SpriteWithMask"*/, 0LL);
  v7 = (UnityEngine_Material_o *)sub_1C22084(UnityEngine_Material_TypeInfo);
  ...
  if ( !v10
    || (_4__this = (CampaignInfoDlg_o *)CampaignInfoDlg__GetTuorialImageName(
                                          ...
                                          v9),
        !data)
    || (_4__this = (CampaignInfoDlg_o *)AssetData__GetObject_object__49880776(
                                          data,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(&_4__this->fields.alphaTexAssetData, data);
  ActionExtensions__Call(this->fields.callback, 0LL);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5B108;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5B0C0;
}
