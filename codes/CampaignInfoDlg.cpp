void __fastcall CampaignInfoDlg___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A48BE0 & 1) == 0 )
  {
    sub_1B863B8(&CampaignInfoDlg_TypeInfo, v1);
    sub_1B863B8(&StringLiteral_14386/*"Tutorial/tutorial_alpha"*/, v2);
    sub_1B863B8(&StringLiteral_23939/*"tutorial_alpha"*/, v3);
    byte_4A48BE0 = 1;
  }
  ...
  sub_1B8635C(&static_fields->alphaImgPath);
  v5 = CampaignInfoDlg_TypeInfo->static_fields;
  v5->alphaImgName = (struct System_String_o *)StringLiteral_23939/*"tutorial_alpha"*/;
  sub_1B8635C(&v5->alphaImgName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD2 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___, v7);
    ...
    sub_1B863B8(&StringLiteral_16503/*"alpha"*/, v12);
    this = (CampaignInfoDlg_o *)sub_1B863B8(&StringLiteral_7418/*"Image"*/, v13);
    byte_4A48BD2 = 1;
  }
  if ( !data )
    goto LABEL_38;
  ...
  if ( m_CancellationTokenSource >= 1 )
  {
    ...
    while ( v18 < m_CancellationTokenSource )
    {
      ...
      if ( v18 >= LODWORD(v17->fields.m_CancellationTokenSource) )
        break;
      v25 = (char)this;
      this = (CampaignInfoDlg_o *)AssetData__GetObject_object__49610244(
                                    data,
                                    *v23,
...
LABEL_16:
  ...
  this = (CampaignInfoDlg_o *)System_String__Concat_61645176((System_String_o *)StringLiteral_7418/*"Image"*/, v29, 0LL);
  if ( !v28 )
    goto LABEL_38;
  ...
  this = (CampaignInfoDlg_o *)UnityEngine_GameObject__GetComponent_object_(
                                ...
                                (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___);
  ...
  if ( !byte_4A487E6 )
  {
    this = (CampaignInfoDlg_o *)sub_1B863B8(&UnityEngine_Vector3_TypeInfo, data);
    byte_4A487E6 = 1;
  }
  if ( !v35
...
void __fastcall CampaignInfoDlg__AfterLoad(CampaignInfoDlg_o *this, int32_t addCount, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD3 & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1B863B8(&StringLiteral_9858/*"OpenWindow"*/, *(_QWORD *)&addCount);
    byte_4A48BD3 = 1;
  }
  ...
  if ( !infoData )
    sub_1B86614(this, *(_QWORD *)&addCount);
...
void __fastcall CampaignInfoDlg__Close(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  CampaignInfoDlg__Close_30439448(this, 0LL, v2);
}


void __fastcall CampaignInfoDlg__Close_30439448(
        CampaignInfoDlg_o *this,
        System_Action_o *callback,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD9 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_CampaignInfoDlg_EndClose__, v5);
    byte_4A48BD9 = 1;
  }
...
void __fastcall CampaignInfoDlg__EndClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BDA & 1) == 0 )
  {
    ...
    sub_1B863B8(&CampaignInfoDlg_TypeInfo, v3);
  ...
  if ( this->fields.alphaTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1B8635C(&this->fields.alphaTexAssetData);
  ...
  if ( this->fields.baseTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1B8635C(&this->fields.baseTexAssetData);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        if ( (unsigned int)v19 >= max_length )
          sub_1B8661C(ImagePageList, method, v11, v12);
...
LABEL_29:
    ...
    sub_1B8635C(&this->fields.infoData);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BCF & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_20469/*"info_"*/, v7);
    byte_4A48BCF = 1;
  }
  v11 = imgId;
  ...
  return System_String__Concat_61645176((System_String_o *)StringLiteral_20469/*"info_"*/, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BCE & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1B863B8(&StringLiteral_3955/*"CampaignInfo/"*/, *(_QWORD *)&imgId);
    byte_4A48BCE = 1;
  }
  CampaignInfoImageName = CampaignInfoDlg__GetCampaignInfoImageName(this, imgId, method);
  return System_String__Concat_61645176((System_String_o *)StringLiteral_3955/*"CampaignInfo/"*/, CampaignInfoImageName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( LODWORD(this->fields.m_CancellationTokenSource) <= 2 )
    sub_1B8661C(this, imageName, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BCC & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1B863B8(&StringLiteral_14383/*"Tutorial/"*/, *(_QWORD *)&imgId);
    byte_4A48BCC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD5 & 1) == 0 )
  {
    ...
    sub_1B863B8(&CampaignInfoDlg_TypeInfo, v5);
    sub_1B863B8(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    sub_1B863B8(&Method_CampaignInfoDlg___c__DisplayClass45_0__LoadAlpha_b__0__, v7);
    sub_1B863B8(&CampaignInfoDlg___c__DisplayClass45_0_TypeInfo, v8);
    byte_4A48BD5 = 1;
  }
  v9 = (Il2CppObject *)sub_1B86604(CampaignInfoDlg___c__DisplayClass45_0_TypeInfo);
...
void __fastcall CampaignInfoDlg__LoadBase(CampaignInfoDlg_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD4 & 1) == 0 )
  {
    ...
    sub_1B863B8(&CampaignInfoDlg_TypeInfo, v5);
    sub_1B863B8(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    sub_1B863B8(&Method_CampaignInfoDlg___c__DisplayClass44_0__LoadBase_b__0__, v7);
    sub_1B863B8(&CampaignInfoDlg___c__DisplayClass44_0_TypeInfo, v8);
    byte_4A48BD4 = 1;
  }
  v9 = (Il2CppObject *)sub_1B86604(CampaignInfoDlg___c__DisplayClass44_0_TypeInfo);
  System_Object___ctor(v9, 0LL);
  if ( !v9 )
    sub_1B86614(v10, v11);
  v9[1].klass = (Il2CppClass *)this;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BCB & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_CampaignInfoDlg__LoadImages_b__34_0__, v4);
  ...
  sub_1B8635C(&this->fields.ImagePageList);
...
void __fastcall CampaignInfoDlg__LoadStart(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&AssetManager_TypeInfo, method);
    sub_1B863B8(&Method_CampaignInfoDlg__LoadStart_b__40_0__, v5);
    this = (CampaignInfoDlg_o *)sub_1B863B8(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    byte_4A48BD0 = 1;
  }
  infoData = v4->fields.infoData;
  if ( !infoData )
...
void __fastcall CampaignInfoDlg__OnCancelButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BDC & 1) == 0 )
  {
    sub_1B863B8(&Method_CampaignInfoDlg_OnCancelButton__, method);
    byte_4A48BDC = 1;
  }
...
void __fastcall CampaignInfoDlg__OnClickClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BDD & 1) == 0 )
  {
    sub_1B863B8(&Method_CampaignInfoDlg_OnClickClose__, method);
    byte_4A48BDD = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
...
void __fastcall CampaignInfoDlg__OnDecideButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BDB & 1) == 0 )
  {
    sub_1B863B8(&Method_CampaignInfoDlg_OnDecideButton__, method);
    byte_4A48BDB = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BCA & 1) == 0 )
  {
    sub_1B863B8(&CampaignInfoDlg_TypeInfo, cInfo);
    byte_4A48BCA = 1;
  }
  ...
  sub_1B8635C(&this->fields.btnCallbackFunc);
...
void __fastcall CampaignInfoDlg__OpenWindow(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD6 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_CampaignInfoDlg_EndOpen__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD1 & 1) == 0 )
  {
    ...
    sub_1B863B8(&NGUITools_TypeInfo, v7);
    sub_1B863B8(&StringLiteral_4910/*"Custom/SpriteWithMask"*/, v8);
    sub_1B863B8(&StringLiteral_16032/*"_MaskTex"*/, v9);
    byte_4A48BD1 = 1;
  }
  ...
  v13 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4910/*"Custom/SpriteWithMask"*/, 0LL);
...
void __fastcall CampaignInfoDlg__SetDecideActive(CampaignInfoDlg_o *this, bool onOff, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BDE & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_BoxCollider___, onOff);
  ...
  if ( !DecideButton )
LABEL_10:
    sub_1B86614(DecideButton, onOff);
  v8 = 1.0;
  v9 = v7;
  v10 = v7;
...
LABEL_10:
    sub_1B86614(CloseButton, isDisp);
  }
...
void __fastcall CampaignInfoDlg__UpdatePage(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48BD7 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_CampaignInfoDlg__UpdatePage_b__47_0__, v3);
    sub_1B863B8(&CampaignInfoDlg_TypeInfo, v4);
    byte_4A48BD7 = 1;
  }
...
void __fastcall CampaignInfoDlg___LoadImages_b__34_0(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&System_Action_TypeInfo, method);
    sub_1B863B8(&Method_CampaignInfoDlg_LoadStart__, v3);
    byte_4A48BE1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BE2 & 1) == 0 )
  {
    ...
    this = (CampaignInfoDlg_o *)sub_1B863B8(&Method_CampaignInfoDlg__LoadStart_b__40_1__, v5);
    byte_4A48BE2 = 1;
  }
  if ( !data )
    sub_1B86614(this, data);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BE4 & 1) == 0 )
  {
    ...
    this = (CampaignInfoDlg___c__DisplayClass44_0_o *)sub_1B863B8(&StringLiteral_16032/*"_MaskTex"*/, v8);
    byte_4A48BE4 = 1;
  }
  ...
  sub_1B8635C(&_4__this->fields.baseTexAssetData);
  v10 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4910/*"Custom/SpriteWithMask"*/, 0LL);
  ...
  if ( !v14
    || (this = (CampaignInfoDlg___c__DisplayClass44_0_o *)CampaignInfoDlg__GetTuorialImageName(
                                                            ...
                                                            v13),
        !data)
    || (this = (CampaignInfoDlg___c__DisplayClass44_0_o *)AssetData__GetObject_object__49610244(
                                                            data,
                                                            (System_String_o *)this,
                                                            (const MethodInfo_2F4FE04 *)Method_AssetData_GetObject_Texture2D____76085320),
        !v11)
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C(&_4__this->fields.alphaTexAssetData);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CA2A0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CA258;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A48BE3 & 1) == 0 )
  {
    sub_1B863B8(&bool_TypeInfo, decide);
    byte_4A48BE3 = 1;
  }
  v9[1] = 0LL;
