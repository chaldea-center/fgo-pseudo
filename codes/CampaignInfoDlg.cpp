void __fastcall CampaignInfoDlg___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48DDDE4 & 1) == 0 )
  {
    sub_1B00CCC(&CampaignInfoDlg_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_14372/*"Tutorial/tutorial_alpha"*/, v2);
    sub_1B00CCC(&StringLiteral_23746/*"tutorial_alpha"*/, v3);
    byte_48DDDE4 = 1;
  }
  ...
  sub_1B00C70(&static_fields->alphaImgPath);
  v5 = CampaignInfoDlg_TypeInfo->static_fields;
  v5->alphaImgName = (struct System_String_o *)StringLiteral_23746/*"tutorial_alpha"*/;
  sub_1B00C70(&v5->alphaImgName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD6 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___, v7);
    ...
    sub_1B00CCC(&StringLiteral_16503/*"alpha"*/, v12);
    this = (CampaignInfoDlg_o *)sub_1B00CCC(&StringLiteral_7391/*"Image"*/, v13);
    byte_48DDDD6 = 1;
  }
  if ( !data )
    goto LABEL_38;
  ...
  if ( m_CancellationTokenSource >= 1 )
  {
    ...
    while ( v18 < m_CancellationTokenSource )
    {
      ...
      if ( v18 >= LODWORD(v17->fields.m_CancellationTokenSource) )
        break;
      v25 = (char)this;
      this = (CampaignInfoDlg_o *)AssetData__GetObject_object__47470892(
                                    data,
                                    *v23,
...
LABEL_16:
  ...
  this = (CampaignInfoDlg_o *)System_String__Concat_60325748((System_String_o *)StringLiteral_7391/*"Image"*/, v29, 0LL);
  if ( !v28 )
    goto LABEL_38;
  ...
  this = (CampaignInfoDlg_o *)UnityEngine_GameObject__GetComponent_object_(
                                ...
                                (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_CampaignInfoItem___);
  ...
  if ( !byte_48DD9F6 )
  {
    this = (CampaignInfoDlg_o *)sub_1B00CCC(&UnityEngine_Vector3_TypeInfo, data);
    byte_48DD9F6 = 1;
  }
  if ( !v35
...
void __fastcall CampaignInfoDlg__AfterLoad(CampaignInfoDlg_o *this, int32_t addCount, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD7 & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1B00CCC(&StringLiteral_9894/*"OpenWindow"*/, *(_QWORD *)&addCount);
    byte_48DDDD7 = 1;
  }
  ...
  if ( v6 >= (signed int)infoData->max_length )
  {
    ...
    UnityEngine_MonoBehaviour__Invoke(
      ...
      (System_String_o *)StringLiteral_9894/*"OpenWindow"*/,
      0.3,
      0LL);
  }
  else
...
void __fastcall CampaignInfoDlg__Close(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  CampaignInfoDlg__Close_29895768(this, 0LL, v2);
}


void __fastcall CampaignInfoDlg__Close_29895768(
        CampaignInfoDlg_o *this,
        System_Action_o *callback,
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDDD & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_CampaignInfoDlg_EndClose__, v5);
    byte_48DDDDD = 1;
  }
...
void __fastcall CampaignInfoDlg__EndClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDDE & 1) == 0 )
  {
    ...
    sub_1B00CCC(&CampaignInfoDlg_TypeInfo, v3);
  ...
  if ( this->fields.alphaTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1B00C70(&this->fields.alphaTexAssetData);
  ...
  if ( this->fields.baseTexLoadRequested )
  {
    ...
    ImagePageList = (System_Collections_Generic_List_object__o *)sub_1B00C70(&this->fields.baseTexAssetData);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        if ( (unsigned int)v19 >= max_length )
          sub_1B00F30(ImagePageList, method, v11, v12);
...
LABEL_29:
    ...
    sub_1B00C70(&this->fields.infoData);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD3 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_20369/*"info_"*/, v7);
    byte_48DDDD3 = 1;
  }
  v11 = imgId;
  ...
  return System_String__Concat_60325748((System_String_o *)StringLiteral_20369/*"info_"*/, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD2 & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1B00CCC(&StringLiteral_3946/*"CampaignInfo/"*/, *(_QWORD *)&imgId);
    byte_48DDDD2 = 1;
  }
  CampaignInfoImageName = CampaignInfoDlg__GetCampaignInfoImageName(this, imgId, method);
  return System_String__Concat_60325748((System_String_o *)StringLiteral_3946/*"CampaignInfo/"*/, CampaignInfoImageName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( LODWORD(this->fields.m_CancellationTokenSource) <= 2 )
    sub_1B00F30(this, imageName, v3, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD0 & 1) == 0 )
  {
    this = (CampaignInfoDlg_o *)sub_1B00CCC(&StringLiteral_14369/*"Tutorial/"*/, *(_QWORD *)&imgId);
    byte_48DDDD0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD9 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&CampaignInfoDlg_TypeInfo, v5);
    sub_1B00CCC(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    sub_1B00CCC(&Method_CampaignInfoDlg___c__DisplayClass45_0__LoadAlpha_b__0__, v7);
    sub_1B00CCC(&CampaignInfoDlg___c__DisplayClass45_0_TypeInfo, v8);
    byte_48DDDD9 = 1;
  }
  v9 = (Il2CppObject *)sub_1B00F18(CampaignInfoDlg___c__DisplayClass45_0_TypeInfo);
...
void __fastcall CampaignInfoDlg__LoadBase(CampaignInfoDlg_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD8 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&CampaignInfoDlg_TypeInfo, v5);
    sub_1B00CCC(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    sub_1B00CCC(&Method_CampaignInfoDlg___c__DisplayClass44_0__LoadBase_b__0__, v7);
    sub_1B00CCC(&CampaignInfoDlg___c__DisplayClass44_0_TypeInfo, v8);
    byte_48DDDD8 = 1;
  }
  v9 = (Il2CppObject *)sub_1B00F18(CampaignInfoDlg___c__DisplayClass44_0_TypeInfo);
  System_Object___ctor(v9, 0LL);
  if ( !v9 )
    sub_1B00F28(v10, v11);
  v9[1].klass = (Il2CppClass *)this;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDCF & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_CampaignInfoDlg__LoadImages_b__34_0__, v4);
  ...
  sub_1B00C70(&this->fields.ImagePageList);
...
void __fastcall CampaignInfoDlg__LoadStart(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&AssetManager_TypeInfo, method);
    sub_1B00CCC(&Method_CampaignInfoDlg__LoadStart_b__40_0__, v5);
    this = (CampaignInfoDlg_o *)sub_1B00CCC(&AssetLoader_LoadEndDataHandler_TypeInfo, v6);
    byte_48DDDD4 = 1;
  }
  infoData = v4->fields.infoData;
  if ( !infoData )
...
void __fastcall CampaignInfoDlg__OnCancelButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDE0 & 1) == 0 )
  {
    sub_1B00CCC(&Method_CampaignInfoDlg_OnCancelButton__, method);
    byte_48DDDE0 = 1;
  }
...
void __fastcall CampaignInfoDlg__OnClickClose(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDE1 & 1) == 0 )
  {
    sub_1B00CCC(&Method_CampaignInfoDlg_OnClickClose__, method);
    byte_48DDDE1 = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
...
void __fastcall CampaignInfoDlg__OnDecideButton(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDDF & 1) == 0 )
  {
    sub_1B00CCC(&Method_CampaignInfoDlg_OnDecideButton__, method);
    byte_48DDDDF = 1;
  }
  if ( !this->fields.IsFading && this->fields.isButtonEnable )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDCE & 1) == 0 )
  {
    sub_1B00CCC(&CampaignInfoDlg_TypeInfo, cInfo);
    byte_48DDDCE = 1;
  }
  ...
  sub_1B00C70(&this->fields.btnCallbackFunc);
...
void __fastcall CampaignInfoDlg__OpenWindow(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDDA & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_CampaignInfoDlg_EndOpen__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDD5 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&NGUITools_TypeInfo, v7);
    sub_1B00CCC(&StringLiteral_4921/*"Custom/SpriteWithMask"*/, v8);
    sub_1B00CCC(&StringLiteral_16035/*"_MaskTex"*/, v9);
    byte_48DDDD5 = 1;
  }
  ...
  v13 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4921/*"Custom/SpriteWithMask"*/, 0LL);
...
void __fastcall CampaignInfoDlg__SetDecideActive(CampaignInfoDlg_o *this, bool onOff, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDE2 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_BoxCollider___, onOff);
  ...
  if ( !DecideButton )
LABEL_10:
    sub_1B00F28(DecideButton, onOff);
  v8 = 1.0;
  v9 = v7;
  v10 = v7;
...
LABEL_10:
    sub_1B00F28(CloseButton, isDisp);
  }
...
void __fastcall CampaignInfoDlg__UpdatePage(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DDDDB & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_CampaignInfoDlg__UpdatePage_b__47_0__, v3);
    sub_1B00CCC(&CampaignInfoDlg_TypeInfo, v4);
    byte_48DDDDB = 1;
  }
  ...
  v8 = (EventDelegate_Callback_o *)sub_1B00F18(EventDelegate_Callback_TypeInfo);
...
void __fastcall CampaignInfoDlg___LoadImages_b__34_0(CampaignInfoDlg_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&System_Action_TypeInfo, method);
    sub_1B00CCC(&Method_CampaignInfoDlg_LoadStart__, v3);
    byte_48DDDE5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDE6 & 1) == 0 )
  {
    ...
    this = (CampaignInfoDlg_o *)sub_1B00CCC(&Method_CampaignInfoDlg__LoadStart_b__40_1__, v5);
    byte_48DDDE6 = 1;
  }
  if ( !data )
    sub_1B00F28(this, data);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDE8 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_16035/*"_MaskTex"*/, v8);
    byte_48DDDE8 = 1;
  }
  ...
  sub_1B00C70(&_4__this->fields.baseTexAssetData);
  v10 = UnityEngine_Shader__Find((System_String_o *)StringLiteral_4921/*"Custom/SpriteWithMask"*/, 0LL);
  ...
  if ( !v14
    || (_4__this = (CampaignInfoDlg_o *)CampaignInfoDlg__GetTuorialImageName(
                                          ...
                                          v13),
        !data)
    || (_4__this = (CampaignInfoDlg_o *)AssetData__GetObject_object__47470892(
                                          data,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70(&_4__this->fields.alphaTexAssetData);
  ActionExtensions__Call(this->fields.callback, 0LL);
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1943D80;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1943D38;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDDE7 & 1) == 0 )
  {
    sub_1B00CCC(&bool_TypeInfo, decide);
    byte_48DDDE7 = 1;
  }
  v9[1] = 0LL;
