        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78ADD & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent__CreateEventInfoPassiveSkillChangeConfirmDialog_b__16_0__);
    sub_1D0F0B4(&Method_GameObjectHelper_Instantiate_EventInfoPassiveSkillChangeConfirmDialog___);
  ...
  v12 = GameObjectHelper__Instantiate_object_(
          ...
          0,
          (const MethodInfo_32AA068 *)Method_GameObjectHelper_Instantiate_EventInfoPassiveSkillChangeConfirmDialog___);
  ...
  Instance = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ServantMaster___);
  if ( !Instance
    || (Entity = DataMasterBase_object__object__int___GetEntity(
                   (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
                   svtId,
                   (const MethodInfo_3535B7C *)Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__),
        (Instance = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_SkillMaster___)) == 0)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78ADC & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_GameObjectHelper_Instantiate_EventInfoPassiveSkillChangeDialog___);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent___c__DisplayClass15_0__CreateEventInfoPassiveSkillChangeDialog_b__0__);
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent___c__DisplayClass15_0__CreateEventInfoPassiveSkillChangeDialog_b__1__);
    sub_1D0F0B4(&EventInfoPassiveSkillGivenItemComponent___c__DisplayClass15_0_TypeInfo);
    byte_4E78ADC = 1;
  }
  v5 = sub_1D0F300(EventInfoPassiveSkillGivenItemComponent___c__DisplayClass15_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = eventItemUsedInfo;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)eventItemUsedInfo, v14, v15, v16, v17, v18, v19);
  if ( !*(_QWORD *)(v5 + 24) )
    return;
...
LABEL_12:
  ...
  v21 = GameObjectHelper__Instantiate_object_(
          ...
          (UnityEngine_Transform_o *)Instance[7].monitor,
          0,
          (const MethodInfo_32AA068 *)Method_GameObjectHelper_Instantiate_EventInfoPassiveSkillChangeDialog___);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_DataManager_GetMaster_UserEventItemLinkSvtMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent___c__DisplayClass9_0__Initialization_b__0__);
    sub_1D0F0B4(&EventInfoPassiveSkillGivenItemComponent___c__DisplayClass9_0_TypeInfo);
    byte_4E78AD9 = 1;
  }
  v5 = sub_1D0F300(EventInfoPassiveSkillGivenItemComponent___c__DisplayClass9_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    goto LABEL_12;
  *(_QWORD *)(v5 + 16) = this;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  IsTargetScene = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserEventItemLinkSvtMaster___);
  if ( !IsTargetScene )
LABEL_12:
    sub_1D0F30C(IsTargetScene, v7);
  EventItemUsedInfo = UserEventItemLinkSvtMaster__GetEventItemUsedInfo(
                        ...
                        0);
  *(_QWORD *)(v5 + 24) = EventItemUsedInfo;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v5 + 24), (int32_t)EventItemUsedInfo, v16, v17, v18, v19, v20, v21);
  v23 = *(_QWORD *)(v5 + 24);
  if ( v23 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78AE1 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent___c__DisplayClass20_0__LoadBuffIcon_b__0__);
    sub_1D0F0B4(&EventInfoPassiveSkillGivenItemComponent___c__DisplayClass20_0_TypeInfo);
    byte_4E78AE1 = 1;
  }
  v7 = sub_1D0F300(EventInfoPassiveSkillGivenItemComponent___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = eventUiEntity;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v7 + 24), (int32_t)eventUiEntity, v16, v17, v18, v19, v20, v21);
  *(_QWORD *)(v7 + 32) = onFinish;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v7 + 32), (int32_t)onFinish, v22, v23, v24, v25, v26, v27);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78ADB & 1) == 0 )
  {
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent_OnClickOnInvalid__);
    byte_4E78ADB = 1;
  }
      ...
      & 1) == 0 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoPassiveSkillGivenItemComponent_OnClickOnInvalid__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_EventInfoPassiveSkillGivenItemComponent_OnClickOnInvalid__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78ADA & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataManager_GetMaster_UserEventItemLinkSvtMaster___);
    sub_1D0F0B4(&DataManager_TypeInfo);
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent_OnClickOnValid__);
    byte_4E78ADA = 1;
  }
  if ( (((__int64 (__fastcall *)(EventInfoPassiveSkillGivenItemComponent_o *, const MethodInfo *))this->klass->vtable._17_IsBusy.methodPtr)(
          this,
      ...
      & 1) == 0 )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserEventItemLinkSvtMaster___);
    if ( !Master_object )
      sub_1D0F30C(0, v4);
    EventItemUsedInfo = UserEventItemLinkSvtMaster__GetEventItemUsedInfo(
    ...
    if ( EventItemUsedInfo )
    {
      ...
      if ( (*((_BYTE *)Method_EventInfoPassiveSkillGivenItemComponent_OnClickOnValid__ + 83) & 2) != 0 )
        v7 = (_QWORD *)sub_1D0F0CC(Method_EventInfoPassiveSkillGivenItemComponent_OnClickOnValid__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78AE3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_17902/*"bufficon_{0}"*/);
    byte_4E78AE3 = 1;
  }
  if ( this->fields.useCommonBuffIcon )
  {
  ...
  else
  {
    ...
    v9 = System_String__Format((System_String_o *)StringLiteral_17902/*"bufficon_{0}"*/, v8, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v7 = (ServantLimitImageMaster_o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  if ( !entity || !v7 )
LABEL_23:
    sub_1D0F30C(v7, v5);
...
LABEL_15:
    ...
    v9 = System_Array__IndexOf_int_(SkillList, skillId, (const MethodInfo_33590E4 *)Method_System_Array_IndexOf_int___);
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(mInstance, 0, 0) )
  {
    ...
    if ( !klass || (genericContainerHandle = (TitleInfoControl_o *)klass->_2.genericContainerHandle) == 0 )
      sub_1D0F30C(genericContainerHandle, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78AE4 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_NetworkManager_getRequest_EventChangePassiveSkillRequest___);
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&NetworkManager_ResultCallbackFunc_TypeInfo);
    sub_1D0F0B4(&Method_EventInfoPassiveSkillGivenItemComponent___c__DisplayClass15_1__CreateEventInfoPassiveSkillChangeDialog_b__2__);
    sub_1D0F0B4(&EventInfoPassiveSkillGivenItemComponent___c__DisplayClass15_1_TypeInfo);
    byte_4E78AE4 = 1;
  }
  v5 = sub_1D0F300(EventInfoPassiveSkillGivenItemComponent___c__DisplayClass15_1_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    goto LABEL_10;
  *(_QWORD *)(v5 + 24) = this;
  ...
  *(_DWORD *)(v5 + 16) = skillId;
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v14,
                     (const MethodInfo_32DC000 *)Method_NetworkManager_getRequest_EventChangePassiveSkillRequest___);
