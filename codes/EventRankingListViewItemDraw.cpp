void __fastcall EventRankingListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A528B0 & 1) == 0 )
  {
    sub_1B863B8(&EventRankingListViewItemDraw_TypeInfo, v1);
    sub_1B863B8(&StringLiteral_19012/*"event_ranking_"*/, v4);
    sub_1B863B8(&StringLiteral_18970/*"event_goal_flag"*/, v5);
    sub_1B863B8(&StringLiteral_19016/*"event_ranking_rewardget_"*/, v6);
    sub_1B863B8(&StringLiteral_19015/*"event_ranking_reward_txt"*/, v7);
    sub_1B863B8(&StringLiteral_19014/*"event_ranking_group_name_"*/, v8);
    sub_1B863B8(&StringLiteral_19013/*"event_ranking_group_"*/, v9);
    sub_1B863B8(&StringLiteral_19049/*"event_support_txt"*/, v10);
    sub_1B863B8(&StringLiteral_19029/*"event_rewardranking_"*/, v11);
    byte_4A528B0 = 1;
  }
  EventRankingListViewItemDraw_TypeInfo->static_fields->GROUP_IMAGE_NAME = (struct System_String_o *)StringLiteral_19013/*"event_ranking_group_"*/;
  sub_1B8635C(
    (CGThumbnailListItem_o *)EventRankingListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_19013/*"event_ranking_group_"*/,
    v2,
    v3);
  v12 = StringLiteral_19014/*"event_ranking_group_name_"*/;
  static_fields = EventRankingListViewItemDraw_TypeInfo->static_fields;
  static_fields->GROUP_NAME_IMAGE_NAME = (struct System_String_o *)StringLiteral_19014/*"event_ranking_group_name_"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&static_fields->GROUP_NAME_IMAGE_NAME, v12, v14, v15);
  v16 = StringLiteral_19029/*"event_rewardranking_"*/;
  v17 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v17->BOARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19029/*"event_rewardranking_"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v17->BOARD_IMAGE_NAME, v16, v18, v19);
  v20 = StringLiteral_19016/*"event_ranking_rewardget_"*/;
  v21 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v21->REWARD_GET_IMAGE_NAME = (struct System_String_o *)StringLiteral_19016/*"event_ranking_rewardget_"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v21->REWARD_GET_IMAGE_NAME, v20, v22, v23);
  v24 = StringLiteral_19012/*"event_ranking_"*/;
  v25 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v25->RANKING_IMAGE_NAME = (struct System_String_o *)StringLiteral_19012/*"event_ranking_"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v25->RANKING_IMAGE_NAME, v24, v26, v27);
  v28 = StringLiteral_18970/*"event_goal_flag"*/;
  v29 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v29->GOAL_IMAGE_NAME = (struct System_String_o *)StringLiteral_18970/*"event_goal_flag"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v29->GOAL_IMAGE_NAME, v28, v30, v31);
  v32 = StringLiteral_19015/*"event_ranking_reward_txt"*/;
  v33 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v33->HIGHER_REWARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19015/*"event_ranking_reward_txt"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v33->HIGHER_REWARD_IMAGE_NAME, v32, v34, v35);
  v36 = StringLiteral_19049/*"event_support_txt"*/;
  v37 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v37->SUPPORT_TXT_IMAGE_NAME = (struct System_String_o *)StringLiteral_19049/*"event_support_txt"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v37->SUPPORT_TXT_IMAGE_NAME, v36, v38, v39);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( this->fields.isMultipleReward )
  {
    ...
    if ( v5 >= max_length )
      sub_1B8661C(this, manager);
    v6 = (int32_t *)giftEntityList->m_Items[v5];
    if ( !v6 || (this = (EventRankingListViewItemDraw_o *)this->fields.itemIcon) == 0LL )
LABEL_12:
      sub_1B86614(this, manager);
    if ( v6[7] <= 1 )
      v7 = -1;
    else
      v7 = v6[7];
    ItemIconComponent__SetGift_39099496((ItemIconComponent_o *)this, v6[5], v6[6], v7, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A528AF & 1) == 0 )
  {
    ...
    sub_1B863B8(&EventRankingListViewItemDraw_TypeInfo, v7);
    sub_1B863B8(&EventRankingListViewManager_TypeInfo, v8);
    sub_1B863B8(&EventRewardRootComponent_TypeInfo, v9);
    sub_1B863B8(&int_TypeInfo, v10);
    sub_1B863B8(&LocalizationManager_TypeInfo, v11);
    sub_1B863B8(&object___TypeInfo, v12);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v13);
    sub_1B863B8(&StringLiteral_15886/*"_"*/, v14);
    byte_4A528AF = 1;
  }
  if ( !v5 || !mode )
    return;
  ...
  rewardGetObj = sub_1B86460(object___TypeInfo, 4LL);
  ...
  if ( BOARD_IMAGE_NAME )
  {
    rewardGetObj = sub_1B864F4(BOARD_IMAGE_NAME, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v20->max_length )
  ...
  sub_1B8635C((CGThumbnailListItem_o *)v20->m_Items, (int32_t)BOARD_IMAGE_NAME, v18, v19);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B864F4(rewardGetObj, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v20->max_length <= 1 )
    goto LABEL_145;
  v20->m_Items[1] = v29;
  sub_1B8635C((CGThumbnailListItem_o *)&v20->m_Items[1], (int32_t)v29, v27, v28);
  rewardGetObj = StringLiteral_15886/*"_"*/;
  if ( StringLiteral_15886/*"_"*/ )
  {
    rewardGetObj = sub_1B864F4(StringLiteral_15886/*"_"*/, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15886/*"_"*/;
  }
  else
  {
    item = 0LL;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&v20->m_Items[2], (int32_t)item, v30, v31);
  v157 = ranking;
  ...
  if ( v20->max_length <= 3 )
    goto LABEL_145;
  v20->m_Items[3] = v37;
  sub_1B8635C((CGThumbnailListItem_o *)&v20->m_Items[3], (int32_t)v37, v35, v36);
  v38 = System_String__Concat_61683616(v20, 0LL);
  ...
  {
    rewardGetObj = sub_1B864F4(RANKING_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v42->max_length )
  ...
  sub_1B8635C((CGThumbnailListItem_o *)v42->m_Items, (int32_t)RANKING_IMAGE_NAME, v40, v41);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B864F4(rewardGetObj, v42->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v42->max_length <= 1 )
    goto LABEL_145;
  v42->m_Items[1] = v50;
  sub_1B8635C((CGThumbnailListItem_o *)&v42->m_Items[1], (int32_t)v50, v48, v49);
  rewardGetObj = StringLiteral_15886/*"_"*/;
  if ( StringLiteral_15886/*"_"*/ )
  {
    rewardGetObj = sub_1B864F4(StringLiteral_15886/*"_"*/, v42->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15886/*"_"*/;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&v42->m_Items[2], (int32_t)item, v51, v52);
  ...
  if ( v42->max_length <= 3 )
    goto LABEL_145;
  v42->m_Items[3] = v58;
  sub_1B8635C((CGThumbnailListItem_o *)&v42->m_Items[3], (int32_t)v58, v56, v57);
  v59 = System_String__Concat_61683616(v42, 0LL);
  ...
  if ( GROUP_IMAGE_NAME )
  {
    rewardGetObj = sub_1B864F4(GROUP_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v63->max_length )
  ...
  sub_1B8635C((CGThumbnailListItem_o *)v63->m_Items, (int32_t)GROUP_IMAGE_NAME, v61, v62);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B864F4(rewardGetObj, v63->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v63->max_length <= 1 )
    goto LABEL_145;
  v63->m_Items[1] = v71;
  sub_1B8635C((CGThumbnailListItem_o *)&v63->m_Items[1], (int32_t)v71, v69, v70);
  rewardGetObj = StringLiteral_15886/*"_"*/;
  if ( StringLiteral_15886/*"_"*/ )
  {
    rewardGetObj = sub_1B864F4(StringLiteral_15886/*"_"*/, v63->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15886/*"_"*/;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&v63->m_Items[2], (int32_t)item, v72, v73);
  ...
  if ( v63->max_length <= 3 )
    goto LABEL_145;
  v63->m_Items[3] = v79;
  sub_1B8635C((CGThumbnailListItem_o *)&v63->m_Items[3], (int32_t)v79, v77, v78);
  v80 = System_String__Concat_61683616(v63, 0LL);
  ...
  {
    rewardGetObj = sub_1B864F4(GROUP_NAME_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v84->max_length )
  ...
  sub_1B8635C((CGThumbnailListItem_o *)v84->m_Items, (int32_t)GROUP_NAME_IMAGE_NAME, v82, v83);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B864F4(rewardGetObj, v84->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v84->max_length <= 1 )
    goto LABEL_145;
  v84->m_Items[1] = v92;
  sub_1B8635C((CGThumbnailListItem_o *)&v84->m_Items[1], (int32_t)v92, v90, v91);
  rewardGetObj = StringLiteral_15886/*"_"*/;
  if ( StringLiteral_15886/*"_"*/ )
  {
    rewardGetObj = sub_1B864F4(StringLiteral_15886/*"_"*/, v84->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15886/*"_"*/;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&v84->m_Items[2], (int32_t)item, v93, v94);
  ...
  if ( v84->max_length <= 3 )
    goto LABEL_145;
  v84->m_Items[3] = v101;
  sub_1B8635C((CGThumbnailListItem_o *)&v84->m_Items[3], (int32_t)v101, v99, v100);
  v102 = System_String__Concat_61683616(v84, 0LL);
  ...
  if ( v5->fields.isJoinTerm )
  {
    ...
    if ( v5->fields.isGetReward )
    {
      ...
      if ( !REWARD_GET_IMAGE_NAME
        || (rewardGetObj = sub_1B864F4(REWARD_GET_IMAGE_NAME, v115->obj.klass->_1.element_class)) != 0 )
      {
        if ( !v115->max_length )
          goto LABEL_145;
        v115->m_Items[0] = REWARD_GET_IMAGE_NAME;
        sub_1B8635C((CGThumbnailListItem_o *)v115->m_Items, (int32_t)REWARD_GET_IMAGE_NAME, v112, v113);
        ...
        if ( !rewardGetObj || (rewardGetObj = sub_1B864F4(rewardGetObj, v115->obj.klass->_1.element_class)) != 0 )
        {
          if ( v115->max_length <= 1 )
            goto LABEL_145;
          v115->m_Items[1] = v123;
          sub_1B8635C((CGThumbnailListItem_o *)&v115->m_Items[1], (int32_t)v123, v121, v122);
          rewardGetObj = StringLiteral_15886/*"_"*/;
          if ( StringLiteral_15886/*"_"*/ )
          {
            rewardGetObj = sub_1B864F4(StringLiteral_15886/*"_"*/, v115->obj.klass->_1.element_class);
            if ( !rewardGetObj )
              goto LABEL_146;
            item = (EventRankingListViewItem_o *)StringLiteral_15886/*"_"*/;
          }
          ...
          sub_1B8635C((CGThumbnailListItem_o *)&v115->m_Items[2], (int32_t)item, v124, v125);
          v157 = ranking;
          ...
          if ( !rewardGetObj || (rewardGetObj = sub_1B864F4(rewardGetObj, v115->obj.klass->_1.element_class)) != 0 )
          {
            if ( v115->max_length <= 3 )
              goto LABEL_145;
            v115->m_Items[3] = v131;
            sub_1B8635C((CGThumbnailListItem_o *)&v115->m_Items[3], (int32_t)v131, v129, v130);
            v132 = System_String__Concat_61683616(v115, 0LL);
            if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
...
LABEL_122:
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.giftEntityList, (int32_t)giftEntityList, v106, v107);
      ...
      if ( v145 )
      {
        ...
        if ( rewardGetObj )
        {
          if ( v145[7] <= 1 )
            ...
            v146 = v145[7];
          ItemIconComponent__SetGift_39099496((ItemIconComponent_o *)rewardGetObj, v145[5], v145[6], v146, 0, 0LL);
          return;
        }
      }
LABEL_144:
      sub_1B86614(rewardGetObj, item);
    }
LABEL_145:
    sub_1B8661C(rewardGetObj, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.listViewObject, (int32_t)listViewObject, (int32_t)method, v3);
}
