void __fastcall EventRankingListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BCBCA0 & 1) == 0 )
  {
    sub_1C1ABD4(&EventRankingListViewItemDraw_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_19549/*"event_ranking_"*/, v8);
    sub_1C1ABD4(&StringLiteral_19507/*"event_goal_flag"*/, v9);
    sub_1C1ABD4(&StringLiteral_19553/*"event_ranking_rewardget_"*/, v10);
    sub_1C1ABD4(&StringLiteral_19552/*"event_ranking_reward_txt"*/, v11);
    sub_1C1ABD4(&StringLiteral_19551/*"event_ranking_group_name_"*/, v12);
    sub_1C1ABD4(&StringLiteral_19550/*"event_ranking_group_"*/, v13);
    sub_1C1ABD4(&StringLiteral_19586/*"event_support_txt"*/, v14);
    sub_1C1ABD4(&StringLiteral_19566/*"event_rewardranking_"*/, v15);
    byte_4BCBCA0 = 1;
  }
  EventRankingListViewItemDraw_TypeInfo->static_fields->GROUP_IMAGE_NAME = (struct System_String_o *)StringLiteral_19550/*"event_ranking_group_"*/;
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)EventRankingListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_19550/*"event_ranking_group_"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v16 = StringLiteral_19551/*"event_ranking_group_name_"*/;
  static_fields = EventRankingListViewItemDraw_TypeInfo->static_fields;
  static_fields->GROUP_NAME_IMAGE_NAME = (struct System_String_o *)StringLiteral_19551/*"event_ranking_group_name_"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&static_fields->GROUP_NAME_IMAGE_NAME, v16, v18, v19, v20, v21, v22, v23);
  v24 = StringLiteral_19566/*"event_rewardranking_"*/;
  v25 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v25->BOARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19566/*"event_rewardranking_"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v25->BOARD_IMAGE_NAME, v24, v26, v27, v28, v29, v30, v31);
  v32 = StringLiteral_19553/*"event_ranking_rewardget_"*/;
  v33 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v33->REWARD_GET_IMAGE_NAME = (struct System_String_o *)StringLiteral_19553/*"event_ranking_rewardget_"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v33->REWARD_GET_IMAGE_NAME, v32, v34, v35, v36, v37, v38, v39);
  v40 = StringLiteral_19549/*"event_ranking_"*/;
  v41 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v41->RANKING_IMAGE_NAME = (struct System_String_o *)StringLiteral_19549/*"event_ranking_"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v41->RANKING_IMAGE_NAME, v40, v42, v43, v44, v45, v46, v47);
  v48 = StringLiteral_19507/*"event_goal_flag"*/;
  v49 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v49->GOAL_IMAGE_NAME = (struct System_String_o *)StringLiteral_19507/*"event_goal_flag"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v49->GOAL_IMAGE_NAME, v48, v50, v51, v52, v53, v54, v55);
  v56 = StringLiteral_19552/*"event_ranking_reward_txt"*/;
  v57 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v57->HIGHER_REWARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19552/*"event_ranking_reward_txt"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v57->HIGHER_REWARD_IMAGE_NAME, v56, v58, v59, v60, v61, v62, v63);
  v64 = StringLiteral_19586/*"event_support_txt"*/;
  v65 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v65->SUPPORT_TXT_IMAGE_NAME = (struct System_String_o *)StringLiteral_19586/*"event_support_txt"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v65->SUPPORT_TXT_IMAGE_NAME, v64, v66, v67, v68, v69, v70, v71);
}
...
LABEL_12:
    ...
    if ( v6[7] <= 1 )
      ...
      v7 = v6[7];
    ItemIconComponent__SetGift_39340176((ItemIconComponent_o *)this, v6[5], v6[6], v7, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC9F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&EventRankingListViewItemDraw_TypeInfo, v7);
    sub_1C1ABD4(&EventRankingListViewManager_TypeInfo, v8);
    ...
    sub_1C1ABD4(&StringLiteral_16388/*"_"*/, v14);
    byte_4BCBC9F = 1;
  }
  if ( !v5 || !mode )
    return;
  ...
  rewardGetObj = sub_1C1AC7C(object___TypeInfo, 4LL);
  ...
  if ( BOARD_IMAGE_NAME )
  {
    rewardGetObj = sub_1C1AD10(BOARD_IMAGE_NAME, v24->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v24->max_length )
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)v24->m_Items, BOARD_IMAGE_NAME, v18, v19, v20, v21, v22, v23);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1C1AD10(rewardGetObj, v24->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v24->max_length <= 1 )
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v24->m_Items[1], v37, v31, v32, v33, v34, v35, v36);
  rewardGetObj = StringLiteral_16388/*"_"*/;
  if ( StringLiteral_16388/*"_"*/ )
  {
    rewardGetObj = sub_1C1AD10(StringLiteral_16388/*"_"*/, v24->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_16388/*"_"*/;
  }
  else
  {
    item = 0LL;
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v24->m_Items[2], (int64_t)item, v38, v39, v40, v41, v42, v43);
  v241 = ranking;
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v24->m_Items[3], v53, v47, v48, v49, v50, v51, v52);
  v54 = System_String__Concat_63051820(v24, 0LL);
  ...
  {
    rewardGetObj = sub_1C1AD10(RANKING_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v62->max_length )
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)v62->m_Items, (int64_t)RANKING_IMAGE_NAME, v56, v57, v58, v59, v60, v61);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1C1AD10(rewardGetObj, v62->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v62->max_length <= 1 )
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v62->m_Items[1], v74, v68, v69, v70, v71, v72, v73);
  rewardGetObj = StringLiteral_16388/*"_"*/;
  if ( StringLiteral_16388/*"_"*/ )
  {
    rewardGetObj = sub_1C1AD10(StringLiteral_16388/*"_"*/, v62->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_16388/*"_"*/;
  }
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v62->m_Items[2], (int64_t)item, v75, v76, v77, v78, v79, v80);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v62->m_Items[3], v90, v84, v85, v86, v87, v88, v89);
  v91 = System_String__Concat_63051820(v62, 0LL);
  ...
  if ( GROUP_IMAGE_NAME )
  {
    rewardGetObj = sub_1C1AD10(GROUP_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v99->max_length )
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)v99->m_Items, (int64_t)GROUP_IMAGE_NAME, v93, v94, v95, v96, v97, v98);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1C1AD10(rewardGetObj, v99->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v99->max_length <= 1 )
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v99->m_Items[1], v111, v105, v106, v107, v108, v109, v110);
  rewardGetObj = StringLiteral_16388/*"_"*/;
  if ( StringLiteral_16388/*"_"*/ )
  {
    rewardGetObj = sub_1C1AD10(StringLiteral_16388/*"_"*/, v99->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_16388/*"_"*/;
  }
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v99->m_Items[2], (int64_t)item, v112, v113, v114, v115, v116, v117);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v99->m_Items[3], v127, v121, v122, v123, v124, v125, v126);
  v128 = System_String__Concat_63051820(v99, 0LL);
  ...
  {
    rewardGetObj = sub_1C1AD10(GROUP_NAME_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v136->max_length )
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1C1AD10(rewardGetObj, v136->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v136->m_Items[1], v148, v142, v143, v144, v145, v146, v147);
  rewardGetObj = StringLiteral_16388/*"_"*/;
  if ( StringLiteral_16388/*"_"*/ )
  {
    rewardGetObj = sub_1C1AD10(StringLiteral_16388/*"_"*/, v136->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_16388/*"_"*/;
  }
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v136->m_Items[2], (int64_t)item, v149, v150, v151, v152, v153, v154);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&v136->m_Items[3], v165, v159, v160, v161, v162, v163, v164);
  v166 = System_String__Concat_63051820(v136, 0LL);
  ...
  if ( v5->fields.isJoinTerm )
  {
    ...
    if ( v5->fields.isGetReward )
    {
      ...
      if ( !REWARD_GET_IMAGE_NAME
        || (rewardGetObj = sub_1C1AD10(REWARD_GET_IMAGE_NAME, v187->obj.klass->_1.element_class)) != 0 )
      {
        if ( !v187->max_length )
          goto LABEL_145;
        ...
        v199 = rewardGetObj;
        if ( !rewardGetObj || (rewardGetObj = sub_1C1AD10(rewardGetObj, v187->obj.klass->_1.element_class)) != 0 )
        {
          if ( v187->max_length <= 1 )
            goto LABEL_145;
          v187->m_Items[1] = (Il2CppObject *)v199;
          sub_1C1AB78((PartyOrganizationUtility_o *)&v187->m_Items[1], v199, v193, v194, v195, v196, v197, v198);
          rewardGetObj = StringLiteral_16388/*"_"*/;
          if ( StringLiteral_16388/*"_"*/ )
          {
            rewardGetObj = sub_1C1AD10(StringLiteral_16388/*"_"*/, v187->obj.klass->_1.element_class);
            if ( !rewardGetObj )
              goto LABEL_146;
            item = (EventRankingListViewItem_o *)StringLiteral_16388/*"_"*/;
          }
          ...
          if ( !rewardGetObj || (rewardGetObj = sub_1C1AD10(rewardGetObj, v187->obj.klass->_1.element_class)) != 0 )
          {
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v187->m_Items[3], v215, v209, v210, v211, v212, v213, v214);
            v216 = System_String__Concat_63051820(v187, 0LL);
            if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
...
LABEL_146:
      v231 = sub_1C1AE54(rewardGetObj);
      sub_1C1ACFC(v231, 0LL);
    }
  }
LABEL_122:
      ...
      if ( v229 )
      {
        ...
        if ( rewardGetObj )
        {
          if ( v229[7] <= 1 )
            ...
            v230 = v229[7];
          ItemIconComponent__SetGift_39340176((ItemIconComponent_o *)rewardGetObj, v229[5], v229[6], v230, 0, 0LL);
          return;
        }
      }
LABEL_144:
      sub_1C1AE30(rewardGetObj, item);
    }
LABEL_145:
    sub_1C1AE38(rewardGetObj, item);
  }
}
