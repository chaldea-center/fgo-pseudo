void __fastcall EventRankingListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B16BBD & 1) == 0 )
  {
    sub_1BCAFF8(&EventRankingListViewItemDraw_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_19081/*"event_ranking_"*/, v2);
    sub_1BCAFF8(&StringLiteral_19039/*"event_goal_flag"*/, v3);
    sub_1BCAFF8(&StringLiteral_19085/*"event_ranking_rewardget_"*/, v4);
    sub_1BCAFF8(&StringLiteral_19084/*"event_ranking_reward_txt"*/, v5);
    sub_1BCAFF8(&StringLiteral_19083/*"event_ranking_group_name_"*/, v6);
    sub_1BCAFF8(&StringLiteral_19082/*"event_ranking_group_"*/, v7);
    sub_1BCAFF8(&StringLiteral_19118/*"event_support_txt"*/, v8);
    sub_1BCAFF8(&StringLiteral_19098/*"event_rewardranking_"*/, v9);
    byte_4B16BBD = 1;
  }
  EventRankingListViewItemDraw_TypeInfo->static_fields->GROUP_IMAGE_NAME = (struct System_String_o *)StringLiteral_19082/*"event_ranking_group_"*/;
  sub_1BCAF9C(EventRankingListViewItemDraw_TypeInfo->static_fields);
  static_fields = EventRankingListViewItemDraw_TypeInfo->static_fields;
  static_fields->GROUP_NAME_IMAGE_NAME = (struct System_String_o *)StringLiteral_19083/*"event_ranking_group_name_"*/;
  sub_1BCAF9C(&static_fields->GROUP_NAME_IMAGE_NAME);
  v11 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v11->BOARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19098/*"event_rewardranking_"*/;
  sub_1BCAF9C(&v11->BOARD_IMAGE_NAME);
  v12 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v12->REWARD_GET_IMAGE_NAME = (struct System_String_o *)StringLiteral_19085/*"event_ranking_rewardget_"*/;
  sub_1BCAF9C(&v12->REWARD_GET_IMAGE_NAME);
  v13 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v13->RANKING_IMAGE_NAME = (struct System_String_o *)StringLiteral_19081/*"event_ranking_"*/;
  sub_1BCAF9C(&v13->RANKING_IMAGE_NAME);
  v14 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v14->GOAL_IMAGE_NAME = (struct System_String_o *)StringLiteral_19039/*"event_goal_flag"*/;
  sub_1BCAF9C(&v14->GOAL_IMAGE_NAME);
  v15 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v15->HIGHER_REWARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19084/*"event_ranking_reward_txt"*/;
  sub_1BCAF9C(&v15->HIGHER_REWARD_IMAGE_NAME);
  v16 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v16->SUPPORT_TXT_IMAGE_NAME = (struct System_String_o *)StringLiteral_19118/*"event_support_txt"*/;
  sub_1BCAF9C(&v16->SUPPORT_TXT_IMAGE_NAME);
}
...
LABEL_12:
    ...
    if ( v6[7] <= 1 )
      ...
      v7 = v6[7];
    ItemIconComponent__SetGift_40107980((ItemIconComponent_o *)this, v6[5], v6[6], v7, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B16BBC & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&EventRankingListViewItemDraw_TypeInfo, v7);
    sub_1BCAFF8(&EventRankingListViewManager_TypeInfo, v8);
    sub_1BCAFF8(&EventRewardRootComponent_TypeInfo, v9);
    sub_1BCAFF8(&int_TypeInfo, v10);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v11);
    sub_1BCAFF8(&object___TypeInfo, v12);
  ...
  rewardGetObj = sub_1BCB0A0(object___TypeInfo, 4LL);
  ...
  if ( BOARD_IMAGE_NAME )
  {
    rewardGetObj = sub_1BCB134(BOARD_IMAGE_NAME, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v20->max_length )
  ...
  rewardGetObj = sub_1BCAF9C(v20->m_Items);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1BCB134(rewardGetObj, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v20->max_length <= 1 )
    goto LABEL_145;
  v20->m_Items[1] = v27;
  sub_1BCAF9C(&v20->m_Items[1]);
  rewardGetObj = StringLiteral_15973/*"_"*/;
  if ( StringLiteral_15973/*"_"*/ )
  {
    rewardGetObj = sub_1BCB134(StringLiteral_15973/*"_"*/, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15973/*"_"*/;
  }
  else
  {
    item = 0LL;
  ...
  v32 = System_String__Concat_62488864(v20, 0LL);
  ...
  {
    rewardGetObj = sub_1BCB134(RANKING_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v34->max_length )
  ...
  rewardGetObj = sub_1BCAF9C(v34->m_Items);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1BCB134(rewardGetObj, v34->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v34->max_length <= 1 )
    goto LABEL_145;
  v34->m_Items[1] = v40;
  sub_1BCAF9C(&v34->m_Items[1]);
  rewardGetObj = StringLiteral_15973/*"_"*/;
  if ( StringLiteral_15973/*"_"*/ )
  {
    rewardGetObj = sub_1BCB134(StringLiteral_15973/*"_"*/, v34->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15973/*"_"*/;
  }
  ...
  if ( v34->max_length <= 3 )
    goto LABEL_145;
  v34->m_Items[3] = v44;
  sub_1BCAF9C(&v34->m_Items[3]);
  v45 = System_String__Concat_62488864(v34, 0LL);
  ...
  if ( GROUP_IMAGE_NAME )
  {
    rewardGetObj = sub_1BCB134(GROUP_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v47->max_length )
  ...
  rewardGetObj = sub_1BCAF9C(v47->m_Items);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1BCB134(rewardGetObj, v47->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v47->max_length <= 1 )
    goto LABEL_145;
  v47->m_Items[1] = v53;
  sub_1BCAF9C(&v47->m_Items[1]);
  rewardGetObj = StringLiteral_15973/*"_"*/;
  if ( StringLiteral_15973/*"_"*/ )
  {
    rewardGetObj = sub_1BCB134(StringLiteral_15973/*"_"*/, v47->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15973/*"_"*/;
  }
  ...
  if ( v47->max_length <= 3 )
    goto LABEL_145;
  v47->m_Items[3] = v57;
  sub_1BCAF9C(&v47->m_Items[3]);
  v58 = System_String__Concat_62488864(v47, 0LL);
  ...
  {
    rewardGetObj = sub_1BCB134(GROUP_NAME_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v60->max_length )
  ...
  rewardGetObj = sub_1BCAF9C(v60->m_Items);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1BCB134(rewardGetObj, v60->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v60->max_length <= 1 )
    goto LABEL_145;
  v60->m_Items[1] = v66;
  sub_1BCAF9C(&v60->m_Items[1]);
  rewardGetObj = StringLiteral_15973/*"_"*/;
  if ( StringLiteral_15973/*"_"*/ )
  {
    rewardGetObj = sub_1BCB134(StringLiteral_15973/*"_"*/, v60->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_15973/*"_"*/;
  }
  ...
  rewardGetObj = sub_1BCAF9C(&v60->m_Items[2]);
  ...
  if ( v60->max_length <= 3 )
    goto LABEL_145;
  v60->m_Items[3] = v71;
  sub_1BCAF9C(&v60->m_Items[3]);
  v72 = System_String__Concat_62488864(v60, 0LL);
  ...
  if ( v5->fields.isJoinTerm )
  {
    ...
    if ( v5->fields.isGetReward )
    {
      ...
      if ( !REWARD_GET_IMAGE_NAME
        || (rewardGetObj = sub_1BCB134(REWARD_GET_IMAGE_NAME, v81->obj.klass->_1.element_class)) != 0 )
      {
        if ( !v81->max_length )
          goto LABEL_145;
        v81->m_Items[0] = REWARD_GET_IMAGE_NAME;
        rewardGetObj = sub_1BCAF9C(v81->m_Items);
        ...
        if ( !rewardGetObj || (rewardGetObj = sub_1BCB134(rewardGetObj, v81->obj.klass->_1.element_class)) != 0 )
        {
          if ( v81->max_length <= 1 )
            goto LABEL_145;
          v81->m_Items[1] = v87;
          ...
          if ( StringLiteral_15973/*"_"*/ )
          {
            rewardGetObj = sub_1BCB134(StringLiteral_15973/*"_"*/, v81->obj.klass->_1.element_class);
            if ( !rewardGetObj )
              goto LABEL_146;
            item = (EventRankingListViewItem_o *)StringLiteral_15973/*"_"*/;
          }
          ...
          if ( !rewardGetObj || (rewardGetObj = sub_1BCB134(rewardGetObj, v81->obj.klass->_1.element_class)) != 0 )
          {
            ...
            v92 = System_String__Concat_62488864(v81, 0LL);
            if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
...
LABEL_122:
  ...
  rewardGetObj = sub_1BCAF9C(&this->fields.giftEntityList);
  ...
  if ( (rewardGetObj & 1) != 0 )
  {
    ...
    {
      v107 = (EventRankingListViewManager_o *)sub_1BCB514(rewardGetObj);
      ...
      if ( v104 )
      {
        ...
        if ( rewardGetObj )
        {
          if ( v104[7] <= 1 )
            ...
            v105 = v104[7];
          ItemIconComponent__SetGift_40107980((ItemIconComponent_o *)rewardGetObj, v104[5], v104[6], v105, 0, 0LL);
          return;
        }
      }
LABEL_144:
      sub_1BCB254(rewardGetObj, item);
    }
LABEL_145:
    sub_1BCB25C(rewardGetObj, item, v18, v19);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C(&this->fields.listViewObject);
}
