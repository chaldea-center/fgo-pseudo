void __fastcall EventRankingListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0242C & 1) == 0 )
  {
    sub_1B64870(&EventRankingListViewItemDraw_TypeInfo, v1);
    sub_1B64870(&StringLiteral_19157/*"event_ranking_"*/, v4);
    sub_1B64870(&StringLiteral_19116/*"event_goal_flag"*/, v5);
    sub_1B64870(&StringLiteral_19161/*"event_ranking_rewardget_"*/, v6);
    sub_1B64870(&StringLiteral_19160/*"event_ranking_reward_txt"*/, v7);
    sub_1B64870(&StringLiteral_19159/*"event_ranking_group_name_"*/, v8);
    sub_1B64870(&StringLiteral_19158/*"event_ranking_group_"*/, v9);
    sub_1B64870(&StringLiteral_19194/*"event_support_txt"*/, v10);
    sub_1B64870(&StringLiteral_19174/*"event_rewardranking_"*/, v11);
    byte_4A0242C = 1;
  }
  EventRankingListViewItemDraw_TypeInfo->static_fields->GROUP_IMAGE_NAME = (struct System_String_o *)StringLiteral_19158/*"event_ranking_group_"*/;
  sub_1B64814(
    (ServantStatusBattleListViewItem_o *)EventRankingListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_19158/*"event_ranking_group_"*/,
    v2,
    v3);
  v12 = StringLiteral_19159/*"event_ranking_group_name_"*/;
  static_fields = EventRankingListViewItemDraw_TypeInfo->static_fields;
  static_fields->GROUP_NAME_IMAGE_NAME = (struct System_String_o *)StringLiteral_19159/*"event_ranking_group_name_"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->GROUP_NAME_IMAGE_NAME, v12, v14, v15);
  v16 = StringLiteral_19174/*"event_rewardranking_"*/;
  v17 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v17->BOARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19174/*"event_rewardranking_"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v17->BOARD_IMAGE_NAME, v16, v18, v19);
  v20 = StringLiteral_19161/*"event_ranking_rewardget_"*/;
  v21 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v21->REWARD_GET_IMAGE_NAME = (struct System_String_o *)StringLiteral_19161/*"event_ranking_rewardget_"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v21->REWARD_GET_IMAGE_NAME, v20, v22, v23);
  v24 = StringLiteral_19157/*"event_ranking_"*/;
  v25 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v25->RANKING_IMAGE_NAME = (struct System_String_o *)StringLiteral_19157/*"event_ranking_"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v25->RANKING_IMAGE_NAME, v24, v26, v27);
  v28 = StringLiteral_19116/*"event_goal_flag"*/;
  v29 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v29->GOAL_IMAGE_NAME = (struct System_String_o *)StringLiteral_19116/*"event_goal_flag"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v29->GOAL_IMAGE_NAME, v28, v30, v31);
  v32 = StringLiteral_19160/*"event_ranking_reward_txt"*/;
  v33 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v33->HIGHER_REWARD_IMAGE_NAME = (struct System_String_o *)StringLiteral_19160/*"event_ranking_reward_txt"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v33->HIGHER_REWARD_IMAGE_NAME, v32, v34, v35);
  v36 = StringLiteral_19194/*"event_support_txt"*/;
  v37 = EventRankingListViewItemDraw_TypeInfo->static_fields;
  v37->SUPPORT_TXT_IMAGE_NAME = (struct System_String_o *)StringLiteral_19194/*"event_support_txt"*/;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v37->SUPPORT_TXT_IMAGE_NAME, v36, v38, v39);
}
...
LABEL_12:
    ...
    if ( v6[7] <= 1 )
      ...
      v7 = v6[7];
    ItemIconComponent__SetGift_37833672((ItemIconComponent_o *)this, v6[5], v6[6], v7, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0242B & 1) == 0 )
  {
    ...
    sub_1B64870(&EventRankingListViewItemDraw_TypeInfo, v7);
    sub_1B64870(&EventRankingListViewManager_TypeInfo, v8);
    ...
    sub_1B64870(&StringLiteral_16056/*"_"*/, v14);
    byte_4A0242B = 1;
  }
  if ( !v5 || !mode )
    return;
  ...
  rewardGetObj = sub_1B64918(object___TypeInfo, 4LL);
  ...
  if ( BOARD_IMAGE_NAME )
  {
    rewardGetObj = sub_1B649AC(BOARD_IMAGE_NAME, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v20->max_length )
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)v20->m_Items, (int32_t)BOARD_IMAGE_NAME, v18, v19);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B649AC(rewardGetObj, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v20->max_length <= 1 )
    goto LABEL_145;
  v20->m_Items[1] = v29;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v20->m_Items[1], (int32_t)v29, v27, v28);
  rewardGetObj = StringLiteral_16056/*"_"*/;
  if ( StringLiteral_16056/*"_"*/ )
  {
    rewardGetObj = sub_1B649AC(StringLiteral_16056/*"_"*/, v20->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v20->m_Items[2], (int32_t)item, v30, v31);
  v157 = ranking;
  ...
  if ( v20->max_length <= 3 )
    goto LABEL_145;
  v20->m_Items[3] = v37;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v20->m_Items[3], (int32_t)v37, v35, v36);
  v38 = System_String__Concat_61395028(v20, 0LL);
  ...
  {
    rewardGetObj = sub_1B649AC(RANKING_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v42->max_length )
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)v42->m_Items, (int32_t)RANKING_IMAGE_NAME, v40, v41);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B649AC(rewardGetObj, v42->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v42->max_length <= 1 )
    goto LABEL_145;
  v42->m_Items[1] = v50;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v42->m_Items[1], (int32_t)v50, v48, v49);
  rewardGetObj = StringLiteral_16056/*"_"*/;
  if ( StringLiteral_16056/*"_"*/ )
  {
    rewardGetObj = sub_1B649AC(StringLiteral_16056/*"_"*/, v42->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_16056/*"_"*/;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v42->m_Items[2], (int32_t)item, v51, v52);
  ...
  if ( v42->max_length <= 3 )
    goto LABEL_145;
  v42->m_Items[3] = v58;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v42->m_Items[3], (int32_t)v58, v56, v57);
  v59 = System_String__Concat_61395028(v42, 0LL);
  ...
  if ( GROUP_IMAGE_NAME )
  {
    rewardGetObj = sub_1B649AC(GROUP_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v63->max_length )
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)v63->m_Items, (int32_t)GROUP_IMAGE_NAME, v61, v62);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B649AC(rewardGetObj, v63->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v63->max_length <= 1 )
    goto LABEL_145;
  v63->m_Items[1] = v71;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v63->m_Items[1], (int32_t)v71, v69, v70);
  rewardGetObj = StringLiteral_16056/*"_"*/;
  if ( StringLiteral_16056/*"_"*/ )
  {
    rewardGetObj = sub_1B649AC(StringLiteral_16056/*"_"*/, v63->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_16056/*"_"*/;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v63->m_Items[2], (int32_t)item, v72, v73);
  ...
  if ( v63->max_length <= 3 )
    goto LABEL_145;
  v63->m_Items[3] = v79;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v63->m_Items[3], (int32_t)v79, v77, v78);
  v80 = System_String__Concat_61395028(v63, 0LL);
  ...
  {
    rewardGetObj = sub_1B649AC(GROUP_NAME_IMAGE_NAME, *(_QWORD *)(*(_QWORD *)rewardGetObj + 64LL));
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( !v84->max_length )
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)v84->m_Items, (int32_t)GROUP_NAME_IMAGE_NAME, v82, v83);
  ...
  if ( rewardGetObj )
  {
    rewardGetObj = sub_1B649AC(rewardGetObj, v84->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
  }
  if ( v84->max_length <= 1 )
    goto LABEL_145;
  v84->m_Items[1] = v92;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v84->m_Items[1], (int32_t)v92, v90, v91);
  rewardGetObj = StringLiteral_16056/*"_"*/;
  if ( StringLiteral_16056/*"_"*/ )
  {
    rewardGetObj = sub_1B649AC(StringLiteral_16056/*"_"*/, v84->obj.klass->_1.element_class);
    if ( !rewardGetObj )
      goto LABEL_146;
    item = (EventRankingListViewItem_o *)StringLiteral_16056/*"_"*/;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v84->m_Items[2], (int32_t)item, v93, v94);
  ...
  if ( v84->max_length <= 3 )
    goto LABEL_145;
  v84->m_Items[3] = v101;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v84->m_Items[3], (int32_t)v101, v99, v100);
  v102 = System_String__Concat_61395028(v84, 0LL);
  ...
  if ( v5->fields.isJoinTerm )
  {
    ...
    if ( v5->fields.isGetReward )
    {
      ...
      if ( !REWARD_GET_IMAGE_NAME
        || (rewardGetObj = sub_1B649AC(REWARD_GET_IMAGE_NAME, v115->obj.klass->_1.element_class)) != 0 )
      {
        if ( !v115->max_length )
          goto LABEL_145;
        v115->m_Items[0] = REWARD_GET_IMAGE_NAME;
        sub_1B64814((ServantStatusBattleListViewItem_o *)v115->m_Items, (int32_t)REWARD_GET_IMAGE_NAME, v112, v113);
        ...
        if ( !rewardGetObj || (rewardGetObj = sub_1B649AC(rewardGetObj, v115->obj.klass->_1.element_class)) != 0 )
        {
          if ( v115->max_length <= 1 )
            goto LABEL_145;
          v115->m_Items[1] = v123;
          sub_1B64814((ServantStatusBattleListViewItem_o *)&v115->m_Items[1], (int32_t)v123, v121, v122);
          rewardGetObj = StringLiteral_16056/*"_"*/;
          if ( StringLiteral_16056/*"_"*/ )
          {
            rewardGetObj = sub_1B649AC(StringLiteral_16056/*"_"*/, v115->obj.klass->_1.element_class);
            if ( !rewardGetObj )
              goto LABEL_146;
            item = (EventRankingListViewItem_o *)StringLiteral_16056/*"_"*/;
          }
          ...
          sub_1B64814((ServantStatusBattleListViewItem_o *)&v115->m_Items[2], (int32_t)item, v124, v125);
          v157 = ranking;
          ...
          if ( !rewardGetObj || (rewardGetObj = sub_1B649AC(rewardGetObj, v115->obj.klass->_1.element_class)) != 0 )
          {
            if ( v115->max_length <= 3 )
              goto LABEL_145;
            v115->m_Items[3] = v131;
            sub_1B64814((ServantStatusBattleListViewItem_o *)&v115->m_Items[3], (int32_t)v131, v129, v130);
            v132 = System_String__Concat_61395028(v115, 0LL);
            if ( !EventRewardRootComponent_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(EventRewardRootComponent_TypeInfo);
...
LABEL_146:
      v147 = sub_1B64AF0(rewardGetObj);
      sub_1B64998(v147, 0LL);
    }
  }
LABEL_122:
  giftEntityList = v5->fields.giftEntityList;
  this->fields.giftEntityList = giftEntityList;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.giftEntityList, (int32_t)giftEntityList, v106, v107);
      ...
      if ( v145 )
      {
        ...
        if ( rewardGetObj )
        {
          if ( v145[7] <= 1 )
            ...
            v146 = v145[7];
          ItemIconComponent__SetGift_37833672((ItemIconComponent_o *)rewardGetObj, v145[5], v145[6], v146, 0, 0LL);
          return;
        }
      }
LABEL_144:
      sub_1B64ACC(rewardGetObj, item);
    }
LABEL_145:
    sub_1B64AD4(rewardGetObj, item);
  }
}
