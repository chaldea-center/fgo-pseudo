void WarBoardStageNpcEntity___ctor(WarBoardStageNpcEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.stageId = 0;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.masterName, v3, v4, v5);
  this->fields.masterImageId = 0;
  this->fields.servants = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servants, 0, v6, v7);
  this->fields.svtEquipIds = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.svtEquipIds, 0, v8, v9);
  this->fields.aiIds = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.aiIds, 0, v10, v11);
  this->fields.ratingBaseIds = 0;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.ratingBaseIds, 0, v12, v13);
  this->fields.tacticalIds = 0;
  p_tacticalIds = &this->fields.tacticalIds;
  sub_1C2D434((CGThumbnailListItem_o *)p_tacticalIds, 0, v15, v16);
  *(_OWORD *)(p_tacticalIds + 1) = xmmword_C08C50;
  p_tacticalIds[3] = (struct System_Int32_array *)&byte_5;
}


void WarBoardStageNpcEntity___ctor_43099244(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.stageId = *(_QWORD *)&cSrc->fields.stageId;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.masterName, (int32_t)masterName, v7, v8);
  this->fields.masterImageId = cSrc->fields.masterImageId;
  servants = cSrc->fields.servants;
  this->fields.servants = servants;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.servants, (int32_t)servants, v11, v12);
  svtEquipIds = cSrc->fields.svtEquipIds;
  this->fields.svtEquipIds = svtEquipIds;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.svtEquipIds, (int32_t)svtEquipIds, v14, v15);
  aiIds = cSrc->fields.aiIds;
  this->fields.aiIds = aiIds;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.aiIds, (int32_t)aiIds, v17, v18);
  ratingBaseIds = cSrc->fields.ratingBaseIds;
  this->fields.ratingBaseIds = ratingBaseIds;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.ratingBaseIds, (int32_t)ratingBaseIds, v20, v21);
  tacticalIds = cSrc->fields.tacticalIds;
  this->fields.tacticalIds = tacticalIds;
  p_tacticalIds = &this->fields.tacticalIds;
  sub_1C2D434((CGThumbnailListItem_o *)p_tacticalIds, (int32_t)tacticalIds, v24, v25);
...
System_Int32_array *WarBoardStageNpcEntity__GetDefenseTarget(WarBoardStageNpcEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C284CE & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_18540/*"defenseTarget"*/);
    byte_4C284CE = 1;
  }
  ...
  return WarBoardStageNpcEntity__getScriptIntArrayParam(
           this,
           (System_String_o *)StringLiteral_18540/*"defenseTarget"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C284CC & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_WarBoardStageNpcEntity___c__getScriptIntArrayParam_b__22_0__);
    sub_1C2D490(&WarBoardStageNpcEntity___c_TypeInfo);
    byte_4C284CC = 1;
  }
  ...
  if ( !_9__22_0 )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__22_0, (int32_t)_9__22_0, v13, v14);
  }
...
void WarBoardStageNpcEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(WarBoardStageNpcEntity___c_TypeInfo);
  System_Object___ctor(v1, 0);
  WarBoardStageNpcEntity___c_TypeInfo->static_fields->__9 = (struct WarBoardStageNpcEntity___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)WarBoardStageNpcEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
