void __fastcall WarBoardStageNpcEntity___ctor(WarBoardStageNpcEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.stageId = 0LL;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.masterName, v4, v5, v6);
  this->fields.masterImageId = 0;
  this->fields.servants = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.servants, 0, v7, v8);
  this->fields.svtEquipIds = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.svtEquipIds, 0, v9, v10);
  this->fields.aiIds = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.aiIds, 0, v11, v12);
  this->fields.ratingBaseIds = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.ratingBaseIds, 0, v13, v14);
  this->fields.tacticalIds = 0LL;
  p_tacticalIds = &this->fields.tacticalIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_tacticalIds, 0, v16, v17);
  *(_OWORD *)(p_tacticalIds + 1) = xmmword_BA2840;
  p_tacticalIds[3] = (struct System_Int32_array *)&byte_5;
}


void __fastcall WarBoardStageNpcEntity___ctor_40030576(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.stageId = *(_QWORD *)&cSrc->fields.stageId;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.masterName, (int32_t)masterName, v7, v8);
  this->fields.masterImageId = cSrc->fields.masterImageId;
  servants = cSrc->fields.servants;
  this->fields.servants = servants;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.servants, (int32_t)servants, v11, v12);
  svtEquipIds = cSrc->fields.svtEquipIds;
  this->fields.svtEquipIds = svtEquipIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.svtEquipIds, (int32_t)svtEquipIds, v14, v15);
  aiIds = cSrc->fields.aiIds;
  this->fields.aiIds = aiIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.aiIds, (int32_t)aiIds, v17, v18);
  ratingBaseIds = cSrc->fields.ratingBaseIds;
  this->fields.ratingBaseIds = ratingBaseIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.ratingBaseIds, (int32_t)ratingBaseIds, v20, v21);
  tacticalIds = cSrc->fields.tacticalIds;
  this->fields.tacticalIds = tacticalIds;
  p_tacticalIds = &this->fields.tacticalIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_tacticalIds, (int32_t)tacticalIds, v24, v25);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FF50B & 1) == 0 )
  {
    sub_1B64870(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&forceId);
    byte_49FF50B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF511 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_18476/*"defenseTarget"*/, v4);
    byte_49FF511 = 1;
  }
  ...
  return WarBoardStageNpcEntity__getScriptIntArrayParam(
           this,
           (System_String_o *)StringLiteral_18476/*"defenseTarget"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF50F & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_WarBoardStageNpcEntity___c__getScriptIntArrayParam_b__22_0__, v9);
    sub_1B64870(&WarBoardStageNpcEntity___c_TypeInfo, v10);
    byte_49FF50F = 1;
  }
  ...
  if ( !_9__22_0 )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__22_0, (int32_t)_9__22_0, v17, v18);
  }
...
void __fastcall WarBoardStageNpcEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FF512 & 1) == 0 )
  {
    sub_1B64870(&WarBoardStageNpcEntity___c_TypeInfo, v1);
    byte_49FF512 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(WarBoardStageNpcEntity___c_TypeInfo);
