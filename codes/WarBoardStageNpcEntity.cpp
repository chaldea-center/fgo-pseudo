void __fastcall WarBoardStageNpcEntity___ctor(WarBoardStageNpcEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.stageId = 0LL;
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.masterName, v4, v5, v6);
  this->fields.masterImageId = 0;
  this->fields.servants = 0LL;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.servants, 0, v7, v8);
  this->fields.svtEquipIds = 0LL;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.svtEquipIds, 0, v9, v10);
  this->fields.aiIds = 0LL;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.aiIds, 0, v11, v12);
  this->fields.ratingBaseIds = 0LL;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.ratingBaseIds, 0, v13, v14);
  this->fields.tacticalIds = 0LL;
  p_tacticalIds = &this->fields.tacticalIds;
  sub_1B4CF34((CGThumbnailListItem_o *)p_tacticalIds, 0, v16, v17);
  *(_OWORD *)(p_tacticalIds + 1) = xmmword_BA9670;
  p_tacticalIds[3] = (struct System_Int32_array *)&byte_5;
}


void __fastcall WarBoardStageNpcEntity___ctor_40960792(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.stageId = *(_QWORD *)&cSrc->fields.stageId;
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.masterName, (int32_t)masterName, v7, v8);
  this->fields.masterImageId = cSrc->fields.masterImageId;
  servants = cSrc->fields.servants;
  this->fields.servants = servants;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.servants, (int32_t)servants, v11, v12);
  svtEquipIds = cSrc->fields.svtEquipIds;
  this->fields.svtEquipIds = svtEquipIds;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.svtEquipIds, (int32_t)svtEquipIds, v14, v15);
  aiIds = cSrc->fields.aiIds;
  this->fields.aiIds = aiIds;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.aiIds, (int32_t)aiIds, v17, v18);
  ratingBaseIds = cSrc->fields.ratingBaseIds;
  this->fields.ratingBaseIds = ratingBaseIds;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.ratingBaseIds, (int32_t)ratingBaseIds, v20, v21);
  tacticalIds = cSrc->fields.tacticalIds;
  this->fields.tacticalIds = tacticalIds;
  p_tacticalIds = &this->fields.tacticalIds;
  sub_1B4CF34((CGThumbnailListItem_o *)p_tacticalIds, (int32_t)tacticalIds, v24, v25);
        ...
        const MethodInfo *method)
{
  if ( (byte_49BBF7D & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&forceId);
    byte_49BBF7D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBF83 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_18235/*"defenseTarget"*/, v5);
    byte_49BBF83 = 1;
  }
  ...
  return WarBoardStageNpcEntity__getScriptIntArrayParam(
           this,
           (System_String_o *)StringLiteral_18235/*"defenseTarget"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBF81 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_WarBoardStageNpcEntity___c__getScriptIntArrayParam_b__22_0__, v9);
    sub_1B4CF90(&WarBoardStageNpcEntity___c_TypeInfo, v10);
    byte_49BBF81 = 1;
  }
  ...
  if ( !_9__22_0 )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&static_fields->__9__22_0, (int32_t)_9__22_0, v17, v18);
  }
...
void __fastcall WarBoardStageNpcEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BBF85 & 1) == 0 )
  {
    sub_1B4CF90(&WarBoardStageNpcEntity___c_TypeInfo, v1);
    byte_49BBF85 = 1;
  }
  v2 = (Il2CppObject *)sub_1B4D1DC(WarBoardStageNpcEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  WarBoardStageNpcEntity___c_TypeInfo->static_fields->__9 = (struct WarBoardStageNpcEntity___c_o *)v2;
  sub_1B4CF34((CGThumbnailListItem_o *)WarBoardStageNpcEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
