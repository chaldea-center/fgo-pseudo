void __fastcall UseSkillEachTurn___ctor(UseSkillEachTurn_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00963 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_HashSet_long___ctor__, method);
    sub_1B64870(&System_Collections_Generic_HashSet_long__TypeInfo, v3);
    byte_4A00963 = 1;
  }
  v4 = (System_Collections_Generic_HashSet_long__o *)sub_1B64ABC(System_Collections_Generic_HashSet_long__TypeInfo);
  System_Collections_Generic_HashSet_long____ctor(
    v4,
    (const MethodInfo_3369F90 *)Method_System_Collections_Generic_HashSet_long___ctor__);
  this->fields.hashSkillId = v4;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.hashSkillId, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0095F & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_HashSet_long__Add__, waveTurn);
    sub_1B64870(&Method_System_Collections_Generic_HashSet_long__Clear__, v7);
    byte_4A0095F = 1;
  }
  if ( this->fields.waveTurn != waveTurn )
  {
    ...
    System_Collections_Generic_HashSet_long___Clear(
      hashSkillId,
      (const MethodInfo_336A624 *)Method_System_Collections_Generic_HashSet_long__Clear__);
  }
  hashSkillId = this->fields.hashSkillId;
  if ( !hashSkillId )
LABEL_8:
    sub_1B64ACC(hashSkillId, waveTurn);
  System_Collections_Generic_HashSet_long___Add(
    hashSkillId,
    skillId,
    (const MethodInfo_336B170 *)Method_System_Collections_Generic_HashSet_long__Add__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00961 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Linq_Enumerable_ToArray_long___, method);
    sub_1B64870(&UseSkillEachTurn_SaveData_TypeInfo, v3);
    byte_4A00961 = 1;
  }
  v4 = sub_1B64ABC(UseSkillEachTurn_SaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00960 & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_Any_long___, data);
    sub_1B64870(&System_Func_long__bool__TypeInfo, v7);
    this = (UseSkillEachTurn_o *)sub_1B64870(&Method_UseSkillEachTurn__IsUseThisTurn_b__3_0__, v8);
    byte_4A00960 = 1;
  }
  if ( !data )
  ...
  if ( !BattleData__EqualCurrentUniqueWaveTurn(data, v6->fields.waveTurn, 0LL) )
    return 0;
  v9 = (System_Func_long__bool__o *)sub_1B64ABC(System_Func_long__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00962 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_HashSet_long___ctor___75645760, sv);
    sub_1B64870(&System_Collections_Generic_HashSet_long__TypeInfo, v5);
    byte_4A00962 = 1;
  }
  if ( sv )
  {
    ...
    v7 = (System_Collections_Generic_HashSet_long__o *)sub_1B64ABC(System_Collections_Generic_HashSet_long__TypeInfo);
    System_Collections_Generic_HashSet_long____ctor_53911680(
      v7,
      skillIds,
      (const MethodInfo_336A080 *)Method_System_Collections_Generic_HashSet_long___ctor___75645760);
    this->fields.hashSkillId = v7;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.hashSkillId, (int32_t)v7, v8, v9);
  }
}
...
bool __fastcall UseSkillEachTurn___IsUseThisTurn_b__3_0(UseSkillEachTurn_o *this, int64_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A00964 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_HashSet_long__Contains__, id);
    byte_4A00964 = 1;
  }
  hashSkillId = this->fields.hashSkillId;
  if ( !hashSkillId )
