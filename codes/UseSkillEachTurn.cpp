void UseSkillEachTurn___ctor(UseSkillEachTurn_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DCE & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_long___ctor__);
    sub_1C713B0(&System_Collections_Generic_HashSet_long__TypeInfo);
    byte_4CC9DCE = 1;
  }
  v3 = (System_Collections_Generic_HashSet_long__o *)sub_1C715FC(System_Collections_Generic_HashSet_long__TypeInfo);
  System_Collections_Generic_HashSet_long____ctor(
    v3,
    (const MethodInfo_36C5068 *)Method_System_Collections_Generic_HashSet_long___ctor__);
  this->fields.hashSkillId = v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.hashSkillId, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DCA & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_long__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_long__Clear__);
    byte_4CC9DCA = 1;
  }
  if ( this->fields.waveTurn != waveTurn )
  {
    ...
    System_Collections_Generic_HashSet_long___Clear(
      hashSkillId,
      (const MethodInfo_36C56FC *)Method_System_Collections_Generic_HashSet_long__Clear__);
  }
  hashSkillId = this->fields.hashSkillId;
  if ( !hashSkillId )
LABEL_8:
    sub_1C71608(hashSkillId, waveTurn);
  System_Collections_Generic_HashSet_long___Add(
    hashSkillId,
    skillId,
    (const MethodInfo_36C6248 *)Method_System_Collections_Generic_HashSet_long__Add__);
}
...
UseSkillEachTurn_SaveData_o *UseSkillEachTurn__GetSaveData(UseSkillEachTurn_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DCC & 1) == 0 )
  {
    ...
    sub_1C713B0(&UseSkillEachTurn_SaveData_TypeInfo);
    byte_4CC9DCC = 1;
  }
  v3 = sub_1C715FC(UseSkillEachTurn_SaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DCB & 1) == 0 )
  {
    ...
    this = (UseSkillEachTurn_o *)sub_1C713B0(&Method_UseSkillEachTurn__IsUseThisTurn_b__3_0__);
    byte_4CC9DCB = 1;
  }
  if ( !data )
  ...
  if ( !BattleData__EqualCurrentUniqueWaveTurn(data, v6->fields.waveTurn, 0) )
    return 0;
  v7 = (System_Func_long__bool__o *)sub_1C715FC(System_Func_long__bool__TypeInfo);
...
void UseSkillEachTurn__SetSaveData(UseSkillEachTurn_o *this, UseSkillEachTurn_SaveData_o *sv, const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DCD & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_long___ctor___78566336);
    sub_1C713B0(&System_Collections_Generic_HashSet_long__TypeInfo);
    byte_4CC9DCD = 1;
  }
  if ( sv )
  {
    ...
    v6 = (System_Collections_Generic_HashSet_long__o *)sub_1C715FC(System_Collections_Generic_HashSet_long__TypeInfo);
    System_Collections_Generic_HashSet_long____ctor_57430360(
      v6,
      skillIds,
      (const MethodInfo_36C5158 *)Method_System_Collections_Generic_HashSet_long___ctor___78566336);
    this->fields.hashSkillId = v6;
    sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.hashSkillId, (int32_t)v6, v7, v8, v9, v10, v11, v12);
  }
}
...
bool UseSkillEachTurn___IsUseThisTurn_b__3_0(UseSkillEachTurn_o *this, int64_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4CC9DCF & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_long__Contains__);
    byte_4CC9DCF = 1;
  }
  hashSkillId = this->fields.hashSkillId;
  if ( !hashSkillId )
