void UseSkillEachTurn___ctor(UseSkillEachTurn_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A22C & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_HashSet_long___ctor__);
    sub_1C32C20(&System_Collections_Generic_HashSet_long__TypeInfo);
    byte_4C3A22C = 1;
  }
  v3 = (System_Collections_Generic_HashSet_long__o *)sub_1C32E6C(System_Collections_Generic_HashSet_long__TypeInfo);
  System_Collections_Generic_HashSet_long____ctor(
    v3,
    (const MethodInfo_364D70C *)Method_System_Collections_Generic_HashSet_long___ctor__);
  this->fields.hashSkillId = v3;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.hashSkillId, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A228 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_HashSet_long__Add__);
    sub_1C32C20(&Method_System_Collections_Generic_HashSet_long__Clear__);
    byte_4C3A228 = 1;
  }
  if ( this->fields.waveTurn != waveTurn )
  {
    ...
    System_Collections_Generic_HashSet_long___Clear(
      hashSkillId,
      (const MethodInfo_364DDA0 *)Method_System_Collections_Generic_HashSet_long__Clear__);
  }
  hashSkillId = this->fields.hashSkillId;
  if ( !hashSkillId )
LABEL_8:
    sub_1C32E7C(hashSkillId);
  System_Collections_Generic_HashSet_long___Add(
    hashSkillId,
    skillId,
    (const MethodInfo_364E8EC *)Method_System_Collections_Generic_HashSet_long__Add__);
}
...
UseSkillEachTurn_SaveData_o *UseSkillEachTurn__GetSaveData(UseSkillEachTurn_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A22A & 1) == 0 )
  {
    ...
    sub_1C32C20(&UseSkillEachTurn_SaveData_TypeInfo);
    byte_4C3A22A = 1;
  }
  v3 = sub_1C32E6C(UseSkillEachTurn_SaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A229 & 1) == 0 )
  {
    ...
    this = (UseSkillEachTurn_o *)sub_1C32C20(&Method_UseSkillEachTurn__IsUseThisTurn_b__3_0__);
    byte_4C3A229 = 1;
  }
  if ( !data )
    sub_1C32E7C(this);
  if ( !BattleData__EqualCurrentUniqueWaveTurn(data, v6->fields.waveTurn, 0) )
    return 0;
  v7 = (System_Func_long__bool__o *)sub_1C32E6C(System_Func_long__bool__TypeInfo);
...
void UseSkillEachTurn__SetSaveData(UseSkillEachTurn_o *this, UseSkillEachTurn_SaveData_o *sv, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A22B & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_HashSet_long___ctor___77989112);
    sub_1C32C20(&System_Collections_Generic_HashSet_long__TypeInfo);
    byte_4C3A22B = 1;
  }
  if ( sv )
  {
    ...
    v6 = (System_Collections_Generic_HashSet_long__o *)sub_1C32E6C(System_Collections_Generic_HashSet_long__TypeInfo);
    System_Collections_Generic_HashSet_long____ctor_56940540(
      v6,
      skillIds,
      (const MethodInfo_364D7FC *)Method_System_Collections_Generic_HashSet_long___ctor___77989112);
    this->fields.hashSkillId = v6;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.hashSkillId, (int32_t)v6, v7, v8);
  }
}
...
bool UseSkillEachTurn___IsUseThisTurn_b__3_0(UseSkillEachTurn_o *this, int64_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4C3A22D & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_HashSet_long__Contains__);
    byte_4C3A22D = 1;
  }
  hashSkillId = this->fields.hashSkillId;
  if ( !hashSkillId )
