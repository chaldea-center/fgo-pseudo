...
void EventRewardVoicePlayCountView__SetUp(EventRewardVoicePlayCountView_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74B6F & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_19480/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/);
    byte_4E74B6F = 1;
  }
...
LABEL_67:
        ...
        while ( 1 )
        {
          ...
          *(_QWORD *)&v106.fields.fakeValue = v17;
          v18 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v106, 0);
          EventRewardSaveData__LoadEventVoicePlayCount(v14, v15, v16, v18, 0);
          if ( !byte_4E7199F )
          {
            gameObject = sub_1D0F0B4(&EventRewardSaveData_TypeInfo);
            byte_4E7199F = 1;
          }
          countLabel = this->fields.countLabel;
          if ( !countLabel )
          ...
          if ( (gameObject & 1) != 0 )
          {
            v22 = (System_Object_array *)sub_1D0F15C(object___TypeInfo, 5);
            v105 = *(_DWORD *)(v11 + 16);
            ...
            if ( gameObject )
            {
              gameObject = sub_1D0F1F0(gameObject, v22->obj.klass->_1.element_class);
              if ( !gameObject )
                goto LABEL_70;
            }
            if ( !LODWORD(v22->max_length) )
              goto LABEL_67;
            v22->m_Items[0] = v29;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)v22->m_Items, (int32_t)v29, v23, v24, v25, v26, v27, v28);
            v104 = *(_DWORD *)(v11 + 20);
            ...
            if ( LODWORD(v22->max_length) <= 1 )
              goto LABEL_67;
            v22->m_Items[1] = v36;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v22->m_Items[1], (int32_t)v36, v30, v31, v32, v33, v34, v35);
            v103 = *(_DWORD *)(v11 + 24);
            ...
            if ( LODWORD(v22->max_length) <= 2 )
              goto LABEL_67;
            v22->m_Items[2] = v43;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v22->m_Items[2], (int32_t)v43, v37, v38, v39, v40, v41, v42);
            v102 = *v12;
            ...
            if ( LODWORD(v22->max_length) <= 3 )
              goto LABEL_67;
            v22->m_Items[3] = v50;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v22->m_Items[3], (int32_t)v50, v44, v45, v46, v47, v48, v49);
            ...
            if ( LODWORD(v22->max_length) <= 4 )
              goto LABEL_67;
            v22->m_Items[4] = v57;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v22->m_Items[4], (int32_t)v57, v51, v52, v53, v54, v55, v56);
            gameObject = (__int64)System_String__Format_65604216((System_String_o *)StringLiteral_19480/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v22, 0);
            if ( !v21 )
              break;
          }
          else
          {
            ...
            v59 = (System_Object_array *)sub_1D0F15C(object___TypeInfo, 5);
            v105 = *(_DWORD *)(v11 + 16);
            gameObject = j_il2cpp_value_box_0(int_TypeInfo, &v105);
            if ( !v59 )
              break;
            ...
            if ( gameObject )
            {
              gameObject = sub_1D0F1F0(gameObject, v59->obj.klass->_1.element_class);
              if ( !gameObject )
                goto LABEL_70;
            }
            if ( !LODWORD(v59->max_length) )
              goto LABEL_67;
            v59->m_Items[0] = v66;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)v59->m_Items, (int32_t)v66, v60, v61, v62, v63, v64, v65);
            v104 = *(_DWORD *)(v11 + 20);
            gameObject = j_il2cpp_value_box_0(int_TypeInfo, &v104);
            ...
            if ( LODWORD(v59->max_length) <= 1 )
              goto LABEL_67;
            v59->m_Items[1] = v73;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v59->m_Items[1], (int32_t)v73, v67, v68, v69, v70, v71, v72);
            v103 = *(_DWORD *)(v11 + 24);
            gameObject = j_il2cpp_value_box_0(int_TypeInfo, &v103);
            ...
            if ( LODWORD(v59->max_length) <= 2 )
              goto LABEL_67;
            v59->m_Items[2] = v80;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v59->m_Items[2], (int32_t)v80, v74, v75, v76, v77, v78, v79);
            v102 = *v12;
            gameObject = j_il2cpp_value_box_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, &v102);
            ...
            if ( LODWORD(v59->max_length) <= 3 )
              goto LABEL_67;
            v59->m_Items[3] = v87;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v59->m_Items[3], (int32_t)v87, v81, v82, v83, v84, v85, v86);
            v101 = EventVoicePlayCount_k__BackingField;
            gameObject = j_il2cpp_value_box_0(int_TypeInfo, &v101);
...
LABEL_70:
            ...
            if ( LODWORD(v59->max_length) <= 4 )
              goto LABEL_67;
            v59->m_Items[4] = v94;
            sub_1D0F058((GrandQuestFolderBoardItem_o *)&v59->m_Items[4], (int32_t)v94, v88, v89, v90, v91, v92, v93);
            v95 = System_String__Format_65604216((System_String_o *)StringLiteral_19480/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v59, 0);
            gameObject = (__int64)System_String__Concat_65601036(mText, (System_String_o *)StringLiteral_43/*"\n"*/, v95, 0);
          }
