...
void __fastcall EventRewardVoicePlayCountView__SetUp(EventRewardVoicePlayCountView_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B84E0 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMasterData_EventVoicePlayMaster___, v3);
    ...
    sub_1B4CF90(&StringLiteral_18825/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v9);
    byte_49B84E0 = 1;
  }
...
LABEL_67:
        ...
        while ( 1 )
        {
          ...
          *(_QWORD *)&v103.fields.fakeValue = v24;
          v25 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47008572(v103, 0LL);
          EventRewardSaveData__LoadEventVoicePlayCount(v21, v22, v23, v25, 0LL);
          if ( !byte_49B853A )
          {
            gameObject = sub_1B4CF90(&EventRewardSaveData_TypeInfo, v11);
            byte_49B853A = 1;
          }
          countLabel = this->fields.countLabel;
          if ( !countLabel )
          ...
          if ( (gameObject & 1) != 0 )
          {
            v29 = (System_Object_array *)sub_1B4D038(object___TypeInfo, 5LL);
            v102 = *(_DWORD *)(v18 + 16);
            ...
            if ( gameObject )
            {
              gameObject = sub_1B4D0CC(gameObject, v29->obj.klass->_1.element_class);
              if ( !gameObject )
                goto LABEL_70;
            }
            if ( !v29->max_length )
              goto LABEL_67;
            v29->m_Items[0] = v35;
            sub_1B4CF34((CGThumbnailListItem_o *)v29->m_Items, (int32_t)v35, v33, v34);
            v101 = *(_DWORD *)(v18 + 20);
            ...
            if ( v29->max_length <= 1 )
              goto LABEL_67;
            v29->m_Items[1] = v41;
            sub_1B4CF34((CGThumbnailListItem_o *)&v29->m_Items[1], (int32_t)v41, v39, v40);
            v100 = *(_DWORD *)(v18 + 24);
            ...
            if ( v29->max_length <= 2 )
              goto LABEL_67;
            v29->m_Items[2] = v47;
            sub_1B4CF34((CGThumbnailListItem_o *)&v29->m_Items[2], (int32_t)v47, v45, v46);
            v99 = *v19;
            ...
            if ( v29->max_length <= 3 )
              goto LABEL_67;
            v29->m_Items[3] = v53;
            sub_1B4CF34((CGThumbnailListItem_o *)&v29->m_Items[3], (int32_t)v53, v51, v52);
            ...
            if ( v29->max_length <= 4 )
              goto LABEL_67;
            v29->m_Items[4] = v59;
            sub_1B4CF34((CGThumbnailListItem_o *)&v29->m_Items[4], (int32_t)v59, v57, v58);
            gameObject = (__int64)System_String__Format_61134896((System_String_o *)StringLiteral_18825/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v29, 0LL);
            if ( !v28 )
              break;
          }
          else
          {
            ...
            v61 = (System_Object_array *)sub_1B4D038(object___TypeInfo, 5LL);
            v102 = *(_DWORD *)(v18 + 16);
            ...
            if ( gameObject )
            {
              gameObject = sub_1B4D0CC(gameObject, v61->obj.klass->_1.element_class);
              if ( !gameObject )
                goto LABEL_70;
            }
            if ( !v61->max_length )
              goto LABEL_67;
            v61->m_Items[0] = v67;
            sub_1B4CF34((CGThumbnailListItem_o *)v61->m_Items, (int32_t)v67, v65, v66);
            v101 = *(_DWORD *)(v18 + 20);
            ...
            if ( v61->max_length <= 1 )
              goto LABEL_67;
            v61->m_Items[1] = v73;
            sub_1B4CF34((CGThumbnailListItem_o *)&v61->m_Items[1], (int32_t)v73, v71, v72);
            v100 = *(_DWORD *)(v18 + 24);
            ...
            if ( v61->max_length <= 2 )
              goto LABEL_67;
            v61->m_Items[2] = v79;
            sub_1B4CF34((CGThumbnailListItem_o *)&v61->m_Items[2], (int32_t)v79, v77, v78);
            v99 = *v19;
            gameObject = j_il2cpp_value_box_0(
                           CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo,
                           &v99,
            ...
            if ( v61->max_length <= 3 )
              goto LABEL_67;
            v61->m_Items[3] = v85;
            sub_1B4CF34((CGThumbnailListItem_o *)&v61->m_Items[3], (int32_t)v85, v83, v84);
            v98 = EventVoicePlayCount_k__BackingField;
...
LABEL_70:
            ...
            if ( v61->max_length <= 4 )
              goto LABEL_67;
            v61->m_Items[4] = v91;
            sub_1B4CF34((CGThumbnailListItem_o *)&v61->m_Items[4], (int32_t)v91, v89, v90);
            v92 = System_String__Format_61134896((System_String_o *)StringLiteral_18825/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v61, 0LL);
            gameObject = (__int64)System_String__Concat_61131716(mText, (System_String_o *)StringLiteral_43/*"\n"*/, v92, 0LL);
          }
