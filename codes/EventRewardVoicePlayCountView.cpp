...
void __fastcall EventRewardVoicePlayCountView__SetUp(EventRewardVoicePlayCountView_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC5153 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_DataManager_GetMasterData_EventVoicePlayMaster___, v3);
    ...
    sub_1C1ABD4(&StringLiteral_19446/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v9);
    byte_4BC5153 = 1;
  }
...
LABEL_67:
        ...
        while ( 1 )
        {
          ...
          *(_QWORD *)&v143.fields.fakeValue = v24;
          v25 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47556128(v143, 0LL);
          EventRewardSaveData__LoadEventVoicePlayCount(v21, v22, v23, v25, 0LL);
          if ( !byte_4BC51AD )
          {
            gameObject = sub_1C1ABD4(&EventRewardSaveData_TypeInfo, v11);
            byte_4BC51AD = 1;
          }
          countLabel = this->fields.countLabel;
          if ( !countLabel )
          ...
          if ( (gameObject & 1) != 0 )
          {
            v29 = (System_Object_array *)sub_1C1AC7C(object___TypeInfo, 5LL);
            v142 = *(_DWORD *)(v18 + 16);
            ...
            if ( gameObject )
            {
              gameObject = sub_1C1AD10(gameObject, v29->obj.klass->_1.element_class);
              if ( !gameObject )
                goto LABEL_70;
            }
            if ( !v29->max_length )
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)v29->m_Items, v39, v33, v34, v35, v36, v37, v38);
            v141 = *(_DWORD *)(v18 + 20);
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v29->m_Items[1], v49, v43, v44, v45, v46, v47, v48);
            v140 = *(_DWORD *)(v18 + 24);
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v29->m_Items[2], v59, v53, v54, v55, v56, v57, v58);
            v139 = *v19;
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v29->m_Items[3], v69, v63, v64, v65, v66, v67, v68);
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v29->m_Items[4], v79, v73, v74, v75, v76, v77, v78);
            gameObject = (__int64)System_String__Format_63054876((System_String_o *)StringLiteral_19446/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v29, 0LL);
            if ( !v28 )
              break;
          }
          else
          {
            ...
            v81 = (System_Object_array *)sub_1C1AC7C(object___TypeInfo, 5LL);
            v142 = *(_DWORD *)(v18 + 16);
            ...
            if ( gameObject )
            {
              gameObject = sub_1C1AD10(gameObject, v81->obj.klass->_1.element_class);
              if ( !gameObject )
                goto LABEL_70;
            }
            if ( !v81->max_length )
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)v81->m_Items, v91, v85, v86, v87, v88, v89, v90);
            v141 = *(_DWORD *)(v18 + 20);
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v81->m_Items[1], v101, v95, v96, v97, v98, v99, v100);
            v140 = *(_DWORD *)(v18 + 24);
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v81->m_Items[2], v111, v105, v106, v107, v108, v109, v110);
            v139 = *v19;
            gameObject = j_il2cpp_value_box_0(
                           CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo,
                           &v139,
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v81->m_Items[3], v121, v115, v116, v117, v118, v119, v120);
            v138 = EventVoicePlayCount_k__BackingField;
...
LABEL_70:
            ...
            sub_1C1AB78((PartyOrganizationUtility_o *)&v81->m_Items[4], v131, v125, v126, v127, v128, v129, v130);
            v132 = System_String__Format_63054876((System_String_o *)StringLiteral_19446/*"eventId : {0}, slot : {1}, idx : {2}, guideImageId : {3}, count : {4}"*/, v81, 0LL);
            gameObject = (__int64)System_String__Concat_63051628(mText, (System_String_o *)StringLiteral_43/*"\n"*/, v132, 0LL);
          }
