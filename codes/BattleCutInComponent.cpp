void __fastcall BattleCutInComponent___ctor(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Hashtable_o *)sub_1B86604(System_Collections_Hashtable_TypeInfo);
  System_Collections_Hashtable___ctor_63012588(v3, 0LL);
  this->fields.table = v3;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.table, (int32_t)v3, v4, v5);
...
void __fastcall BattleCutInComponent__onStartComp(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A50B6A & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_22089/*"onEndComp"*/, v4);
    sub_1B863B8(&StringLiteral_23770/*"time"*/, v5);
    sub_1B863B8(&StringLiteral_18321/*"delay"*/, v6);
    sub_1B863B8(&StringLiteral_22416/*"position"*/, v7);
    sub_1B863B8(&StringLiteral_22109/*"oncomplete"*/, v8);
...
LABEL_11:
  ...
  iTween__MoveTo_61282740(v26, v25, 0LL);
}
...
void __fastcall BattleCutInComponent__startAction(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A50B69 & 1) == 0 )
  {
    sub_1B863B8(&float_TypeInfo, method);
    sub_1B863B8(&UnityEngine_Vector3_TypeInfo, v3);
    sub_1B863B8(&StringLiteral_22104/*"onStartComp"*/, v4);
    sub_1B863B8(&StringLiteral_23770/*"time"*/, v5);
    sub_1B863B8(&StringLiteral_22416/*"position"*/, v6);
    sub_1B863B8(&StringLiteral_22109/*"oncomplete"*/, v7);
    sub_1B863B8(&iTween_TypeInfo, v8);
    byte_4A50B69 = 1;
  }
  table = this->fields.table;
  if ( !table )
  ...
  if ( !v11
    ...
    || (((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))table->klass->vtable._22_Add.method)(
          table,
          StringLiteral_22109/*"oncomplete"*/,
          StringLiteral_22104/*"onStartComp"*/,
          table->klass->vtable._23_Clear.methodPtr),
...
LABEL_10:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_61282740(v21, v20, 0LL);
}