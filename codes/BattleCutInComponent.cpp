...
void __fastcall BattleCutInComponent__onStartComp(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFFD3F & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_22672/*"onEndComp"*/, v4);
    sub_1C2E12C(&StringLiteral_24383/*"time"*/, v5);
    sub_1C2E12C(&StringLiteral_18875/*"delay"*/, v6);
    sub_1C2E12C(&StringLiteral_22998/*"position"*/, v7);
    sub_1C2E12C(&StringLiteral_22692/*"oncomplete"*/, v8);
    sub_1C2E12C(&iTween_TypeInfo, v9);
    byte_4BFFD3F = 1;
  }
...
LABEL_11:
  ...
  iTween__MoveTo_61773172(v26, v25, 0LL);
}
...
void __fastcall BattleCutInComponent__startAction(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFFD3E & 1) == 0 )
  {
    sub_1C2E12C(&float_TypeInfo, method);
    sub_1C2E12C(&UnityEngine_Vector3_TypeInfo, v3);
    sub_1C2E12C(&StringLiteral_22687/*"onStartComp"*/, v4);
    sub_1C2E12C(&StringLiteral_24383/*"time"*/, v5);
    sub_1C2E12C(&StringLiteral_22998/*"position"*/, v6);
    sub_1C2E12C(&StringLiteral_22692/*"oncomplete"*/, v7);
    sub_1C2E12C(&iTween_TypeInfo, v8);
    byte_4BFFD3E = 1;
  }
  table = this->fields.table;
  if ( !table )
  ...
  if ( !v11
    ...
    || (((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))table->klass->vtable._23_Add.method)(
          table,
          StringLiteral_22692/*"oncomplete"*/,
          StringLiteral_22687/*"onStartComp"*/,
          table->klass->vtable._24_Clear.methodPtr),
...
LABEL_10:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_61773172(v21, v20, 0LL);
}