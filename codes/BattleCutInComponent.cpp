...
void __fastcall BattleCutInComponent__onStartComp(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00941 & 1) == 0 )
  {
    sub_1B64870(&float_TypeInfo, method);
    sub_1B64870(&UnityEngine_Vector3_TypeInfo, v3);
    sub_1B64870(&StringLiteral_22168/*"onEndComp"*/, v4);
    sub_1B64870(&StringLiteral_23834/*"time"*/, v5);
    sub_1B64870(&StringLiteral_18481/*"delay"*/, v6);
    sub_1B64870(&StringLiteral_22485/*"position"*/, v7);
    sub_1B64870(&StringLiteral_22188/*"oncomplete"*/, v8);
...
LABEL_11:
  ...
  iTween__MoveTo_59921908(v26, v25, 0LL);
}
...
void __fastcall BattleCutInComponent__startAction(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00940 & 1) == 0 )
  {
    sub_1B64870(&float_TypeInfo, method);
    sub_1B64870(&UnityEngine_Vector3_TypeInfo, v3);
    sub_1B64870(&StringLiteral_22183/*"onStartComp"*/, v4);
    sub_1B64870(&StringLiteral_23834/*"time"*/, v5);
    sub_1B64870(&StringLiteral_22485/*"position"*/, v6);
    sub_1B64870(&StringLiteral_22188/*"oncomplete"*/, v7);
    sub_1B64870(&iTween_TypeInfo, v8);
    byte_4A00940 = 1;
  }
  table = this->fields.table;
  if ( !table )
...
LABEL_10:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_59921908(v21, v20, 0LL);
}