...
void __fastcall BattleCutInComponent__onStartComp(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB81FD & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_22289/*"onEndComp"*/, v4);
    sub_1BAB41C(&StringLiteral_23968/*"time"*/, v5);
    sub_1BAB41C(&StringLiteral_18580/*"delay"*/, v6);
    sub_1BAB41C(&StringLiteral_22611/*"position"*/, v7);
    sub_1BAB41C(&StringLiteral_22309/*"oncomplete"*/, v8);
...
LABEL_11:
  ...
  iTween__MoveTo_60586460(v26, v25, 0LL);
}
...
void __fastcall BattleCutInComponent__startAction(BattleCutInComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB81FC & 1) == 0 )
  {
    sub_1BAB41C(&float_TypeInfo, method);
    sub_1BAB41C(&UnityEngine_Vector3_TypeInfo, v3);
    sub_1BAB41C(&StringLiteral_22304/*"onStartComp"*/, v4);
    sub_1BAB41C(&StringLiteral_23968/*"time"*/, v5);
    sub_1BAB41C(&StringLiteral_22611/*"position"*/, v6);
    sub_1BAB41C(&StringLiteral_22309/*"oncomplete"*/, v7);
    sub_1BAB41C(&iTween_TypeInfo, v8);
    byte_4AB81FC = 1;
  }
  table = this->fields.table;
  if ( !table )
  ...
  if ( !v11
    ...
    || (((void (__fastcall *)(struct System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))table->klass->vtable._23_Add.method)(
          table,
          StringLiteral_22309/*"oncomplete"*/,
          StringLiteral_22304/*"onStartComp"*/,
          table->klass->vtable._24_Clear.methodPtr),
...
LABEL_10:
  ...
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
  iTween__MoveTo_60586460(v21, v20, 0LL);
}