        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4214658 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_17504/*"classBoard/releaseSquare"*/, v2);
    byte_4214658 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_17504/*"classBoard/releaseSquare"*/, 0LL);
}
