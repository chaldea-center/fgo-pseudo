void __fastcall FriendPointNoticeDlgSvtInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BCF99 & 1) == 0 )
  {
    sub_1B4CF90(&FriendPointNoticeDlgSvtInfo_TypeInfo, v1);
    byte_49BCF99 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BCF97 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&FriendPointNoticeDlgSvtInfo_TypeInfo, v15);
    ...
    sub_1B4CF90(&StringLiteral_1396/*"3"*/, v20);
    sub_1B4CF90(&StringLiteral_1335/*"2"*/, v21);
    sub_1B4CF90(&StringLiteral_6836/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/, v22);
    sub_1B4CF90(&StringLiteral_25171/*"４"*/, v23);
    sub_1B4CF90(&StringLiteral_25170/*"３"*/, v24);
    sub_1B4CF90(&StringLiteral_25168/*"１"*/, v25);
    sub_1B4CF90(&StringLiteral_1414/*"4"*/, v26);
    sub_1B4CF90(&StringLiteral_25172/*"５"*/, v27);
    sub_1B4CF90(&StringLiteral_6835/*"GET_FRIEND_POINT_SERVANT_NAME"*/, v28);
    sub_1B4CF90(&StringLiteral_25169/*"２"*/, v29);
    sub_1B4CF90(&StringLiteral_1190/*"1"*/, v30);
    sub_1B4CF90(&StringLiteral_1431/*"5"*/, v31);
    byte_49BCF97 = 1;
  }
  entity = 0LL;
  data = 0;
  ...
  v33 = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_UserServantMaster___);
  v34 = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v35 = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  v36 = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  ServantLimitCountSealAfter = (UserServantCollectionMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( svtId < 1 )
    goto LABEL_59;
  if ( !Master_object )
    goto LABEL_66;
  ...
  if ( Rarity )
  {
    ...
    if ( !ServantLimitCountSealAfter )
      goto LABEL_66;
    ServantLimitCountSealAfter = (UserServantCollectionMaster_o *)System_String__Replace_61140016(
    ...
    if ( !ServantLimitCountSealAfter )
      goto LABEL_66;
    v43 = (Il2CppObject *)System_String__Replace_61140016(
                            (System_String_o *)ServantLimitCountSealAfter,
    ...
    ServantLimitCountSealAfter = (UserServantCollectionMaster_o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_6835/*"GET_FRIEND_POINT_SERVANT_NAME"*/,
                                                                    0LL);
    if ( !entity
      ...
      || (v50 = (Il2CppObject *)ServantLimitCountSealAfter,
          ...
          ServantLimitCountSealAfter = (UserServantCollectionMaster_o *)System_String__Format_61134828(
                                                                          v49,
                                                                          v43,
                                                                          v50,
                                                                          ClassName,
    ...
    {
LABEL_66:
      sub_1B4D1EC(ServantLimitCountSealAfter, v38);
    }
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ServantLimitCountSealAfter = (UserServantCollectionMaster_o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_6836/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/,
                                                                    0LL);
    if ( !entity )
      goto LABEL_66;
    ...
    ServantLimitCountSealAfter = (UserServantCollectionMaster_o *)System_String__Format_61134760(v46, v47, v48, 0LL);
    if ( !supportServantNameLabel )
      goto LABEL_66;
  }
...
LABEL_59:
  ...
  v54 = (IconLabelInfo_o *)sub_1B4D1DC(IconLabelInfo_TypeInfo);
    ...
    if ( entity )
    {
      if ( v34 )
      {
        ...
        if ( v58 )
        {
          if ( v54 )
          {
            IconLabelInfo__Set_38677548(v54, 2, 1, v58->fields.lvMax, 0, 0, 0, 0, 0LL);
  ...
  if ( !v54 )
    goto LABEL_66;
  IconLabelInfo__Set_38677548(v54, 2, lv, (int32_t)ServantLimitCountSealAfter, 0, 0, 0, 0, 0LL);
  ServantLimitCountSealAfter = (UserServantCollectionMaster_o *)this->fields.supportServantFaceIcon;
  if ( !ServantLimitCountSealAfter )
    goto LABEL_66;
...
LABEL_64:
  ...
  if ( !ServantLimitCountSealAfter )
    goto LABEL_66;
  UIIconLabel__Set_38776192((UIIconLabel_o *)ServantLimitCountSealAfter, 36, data, 0, 0, 0LL, 0, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BCF98 & 1) == 0 )
  {
    sub_1B4CF90(&FriendPointNoticeDlgSvtInfo_TypeInfo, method);
    byte_49BCF98 = 1;
  }
  if ( maxWidth <= 0.0 )
  {
