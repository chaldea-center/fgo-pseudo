void __fastcall FriendPointNoticeDlgSvtInfo___cctor(const MethodInfo *method)
{
  if ( (byte_42B2AEE & 1) == 0 )
  {
    sub_B52984(&FriendPointNoticeDlgSvtInfo_TypeInfo);
    byte_42B2AEE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2AED & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_6916/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/);
    sub_B52984(&StringLiteral_24164/*"４"*/);
    sub_B52984(&StringLiteral_24163/*"３"*/);
    sub_B52984(&StringLiteral_24161/*"１"*/);
    sub_B52984(&StringLiteral_1187/*"4"*/);
    sub_B52984(&StringLiteral_24165/*"５"*/);
    sub_B52984(&StringLiteral_6915/*"GET_FRIEND_POINT_SERVANT_NAME"*/);
    sub_B52984(&StringLiteral_24162/*"２"*/);
    sub_B52984(&StringLiteral_1022/*"1"*/);
    sub_B52984(&StringLiteral_1202/*"5"*/);
    byte_42B2AED = 1;
  }
  entity = 0LL;
  v41 = 0;
  ...
  v8 = (DataMasterBase_UserServantStorageMaster__UserServantEntity__long__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_UserServantMaster___);
  v9 = (ServantLimitMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v10 = (ServantExceedMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  v11 = (ServantLimitImageMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  UserId = (int64_t)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( svtId < 1 )
    goto LABEL_62;
  ...
  if ( Rarity )
  {
    ...
    if ( !UserId )
      goto LABEL_69;
    UserId = (int64_t)System_String__Replace_44575552(
                        (System_String_o *)UserId,
                        (System_String_o *)StringLiteral_1022/*"1"*/,
                        (System_String_o *)StringLiteral_24161/*"１"*/,
                        0LL);
    if ( !UserId )
      goto LABEL_69;
    UserId = (int64_t)System_String__Replace_44575552(
                        ...
                        (System_String_o *)StringLiteral_24162/*"２"*/,
                        0LL);
    if ( !UserId )
      goto LABEL_69;
    UserId = (int64_t)System_String__Replace_44575552(
                        ...
                        (System_String_o *)StringLiteral_24163/*"３"*/,
                        0LL);
    if ( !UserId )
      goto LABEL_69;
    UserId = (int64_t)System_String__Replace_44575552(
                        ...
                        (System_String_o *)StringLiteral_24164/*"４"*/,
                        0LL);
    if ( !UserId )
      goto LABEL_69;
    v18 = (Il2CppObject *)System_String__Replace_44575552(
                            (System_String_o *)UserId,
                            (System_String_o *)StringLiteral_1202/*"5"*/,
                            (System_String_o *)StringLiteral_24165/*"５"*/,
                            0LL);
    ...
    if ( !entity
      ...
      || (v30 = (Il2CppObject *)UserId,
          ...
          UserId = (int64_t)System_String__Format_44569380(v29, v18, v30, ClassName, 0LL),
...
LABEL_69:
  ...
  else
  {
    ...
    UserId = (int64_t)System_String__Format_44563852(v24, v25, v26, 0LL);
    if ( !v23 )
      goto LABEL_69;
...
LABEL_62:
  ...
  v34 = (IconLabelInfo_o *)sub_B52A54(IconLabelInfo_TypeInfo);
    ...
    if ( entity )
    {
      if ( v9 )
      {
        ...
        if ( v39 )
        {
          if ( v34 )
          {
            IconLabelInfo__Set_28274368(v34, 2, 1, v39->fields.lvMax, 0, 0, 0, 0, 0LL);
  ...
  if ( !v34 )
    goto LABEL_69;
  IconLabelInfo__Set_28274368(v34, 2, lv, UserId, 0, 0, 0, 0, 0LL);
  UserId = (int64_t)this->fields.supportServantFaceIcon;
  if ( !UserId )
    goto LABEL_69;
  ServantFaceIconComponent__Set_30470152((ServantFaceIconComponent_o *)UserId, usrSvtId, v34, 0LL, 0LL);
LABEL_67:
  UserId = (int64_t)this->fields.supportServantSubLabel;
  if ( !UserId )
    goto LABEL_69;
  UIIconLabel__Set_41786400((UIIconLabel_o *)UserId, 36, v41, 0, 0, 0LL, 0, 0, 0, 0LL);
  LOBYTE(UserId) = 1;
  return UserId;
}