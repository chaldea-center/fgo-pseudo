void FriendPointNoticeDlgSvtInfo___cctor(const MethodInfo *method)
{
  if ( (byte_59730A8 & 1) == 0 )
  {
    sub_2213A60(&FriendPointNoticeDlgSvtInfo_TypeInfo);
    byte_59730A8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v9 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_UserServantMaster___);
  v10 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  v11 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  v12 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  OverwriteStatus = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( svtId < 1 )
    goto LABEL_68;
  if ( !Master_object )
    goto LABEL_75;
  ...
  if ( Rarity )
  {
    ...
    if ( !OverwriteStatus )
      goto LABEL_75;
    OverwriteStatus = System_String__Replace_75703400(
    ...
    if ( !OverwriteStatus )
      goto LABEL_75;
    v22 = (Il2CppObject *)System_String__Replace_75703400(
                            (System_String_o *)OverwriteStatus,
    ...
    OverwriteStatus = LocalizationManager__Get((System_String_o *)StringLiteral_7246/*"GET_FRIEND_POINT_SERVANT_NAME"*/, 0);
    if ( !entity
      ...
      || (v30 = (Il2CppObject *)OverwriteStatus,
          ...
          OverwriteStatus = System_String__Format_75697948(v29, v22, v30, ClassName, 0),
          !supportServantNameLabel) )
    {
LABEL_75:
      sub_2213CDC(OverwriteStatus, v14);
    }
  ...
  else
  {
    ...
    if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v14);
    OverwriteStatus = LocalizationManager__Get((System_String_o *)StringLiteral_7247/*"GET_FRIEND_POINT_SERVANT_NAME_NORARE"*/, 0);
    if ( !entity )
      goto LABEL_75;
    ...
    OverwriteStatus = System_String__Format_75697880(v25, v26, v27, 0);
    if ( !v24 )
      goto LABEL_75;
...
LABEL_68:
  ...
  v35 = (IconLabelInfo_o *)sub_2213CCC(IconLabelInfo_TypeInfo);
    ...
    if ( entity )
    {
      if ( v10 )
      {
        ...
        if ( v39 )
        {
          if ( v35 )
          {
            IconLabelInfo__Set_47880948(v35, 2, 1, v39->fields.lvMax, 0, 0, 0, 0, 0, 0);
  ...
  if ( !v35 )
    goto LABEL_75;
  IconLabelInfo__Set_47880948(v35, 2, lv, (int32_t)OverwriteStatus, 0, 0, 0, 0, 0, 0);
  OverwriteStatus = this->fields.supportServantFaceIcon;
  if ( !OverwriteStatus )
    goto LABEL_75;
  ServantFaceIconComponent__Set_48049308((ServantFaceIconComponent_o *)OverwriteStatus, usrSvtId, v35, 0, 0);
LABEL_73:
  OverwriteStatus = this->fields.supportServantSubLabel;
  if ( !OverwriteStatus )
    goto LABEL_75;
  UIIconLabel__Set_48071660((UIIconLabel_o *)OverwriteStatus, 36, data, 0, 0, 0, 0, 0, 0, v20, 0);
