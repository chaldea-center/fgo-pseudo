        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01BFB & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent___ctor__, method);
    sub_1B64A00(&System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo, v3);
    byte_4A01BFB = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.bondsIconList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01BF8 & 1) == 0 )
  {
    sub_1B64A00(&Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___, method);
    sub_1B64A00(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__Add__, v3);
    byte_4A01BF8 = 1;
  }
  ...
  if ( !iconRoot
    || (bondsIcon = (Il2CppObject *)this->fields.bondsIcon,
        ...
        iconRoot = (UnityEngine_Component_o *)BaseMonoBehaviour__createObject_object_(
                                                ...
                                                transform,
                                                0LL,
                                                (const MethodInfo_2E26A18 *)Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___),
  ...
  else
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)(v14 + 4), (int32_t)v13, v7, v8);
  }
  return v13;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01BF9 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__ToArray__, method);
    byte_4A01BF9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01BFA & 1) == 0 )
  {
    sub_1B64A00(&int_TypeInfo, *(_QWORD *)&current);
    sub_1B64A00(&LocalizationManager_TypeInfo, v7);
    sub_1B64A00(&StringLiteral_2935/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, v8);
    byte_4A01BFA = 1;
  }
  ...
  waveLabel = (UILabel_o *)System_String__Format_61399508(v11, v15, v19, 0LL);
  if ( !v10
  ...
  {
LABEL_12:
    sub_1B64C5C(waveLabel, *(_QWORD *)&current);
  }
