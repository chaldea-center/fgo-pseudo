        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B52A54(System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0A1A & 1) == 0 )
  {
    sub_B52984(&Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___);
    sub_B52984(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__Add__);
    byte_42B0A1A = 1;
  }
  ...
  if ( !iconRoot
    || (bondsIcon = (Il2CppObject *)this->fields.bondsIcon,
        ...
        iconRoot = (UnityEngine_Component_o *)BaseMonoBehaviour__createObject_object_(
                                                ...
                                                transform,
                                                0LL,
                                                (const MethodInfo_1A4161C *)Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___),
        (bondsIconList = this->fields.bondsIconList) == 0LL) )
  {
    sub_B52A5C(iconRoot, method);
  }
  ...
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
    ...
    (const MethodInfo_2FF1604 *)Method_System_Collections_Generic_List_BattleResultBondsIconComponent__Add__);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0A1C & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_2522/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/);
    byte_42B0A1C = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_2522/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, 0LL);
  v17 = current;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v17);
  v16 = max;
  v11 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v16);
  waveLabel = (UILabel_o *)System_String__Format_44563852(v9, v10, v11, 0LL);
  if ( !v8
    || (UILabel__set_text(v8, (System_String_o *)waveLabel, 0LL), (v12 = this->fields.waveLabel) == 0LL)
    || (waveLabel = (UILabel_o *)this->fields.waveLabelLine) == 0LL )
  {
LABEL_13:
    sub_B52A5C(waveLabel, *(_QWORD *)&current);
  }
  mWidth = v12->fields.mWidth;
  v14 = waveLabel->fields.mWidth;
  v15 = v14 + mWidth;
  if ( v15 + 9 >= 286 )
    UIWidget__set_width((UIWidget_o *)waveLabel, v14 + 276 - v15, 0LL);
}