        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4806F & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent___ctor__, method);
    sub_1BDB878(&System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo, v3);
    byte_4B4806F = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.bondsIconList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4806C & 1) == 0 )
  {
    sub_1BDB878(&Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___, method);
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__Add__, v3);
    byte_4B4806C = 1;
  }
  ...
  if ( !iconRoot
    || (bondsIcon = (Il2CppObject *)this->fields.bondsIcon,
        ...
        iconRoot = (UnityEngine_Component_o *)BaseMonoBehaviour__createObject_object_(
                                                ...
                                                transform,
                                                0LL,
                                                (const MethodInfo_301C6D4 *)Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___),
  ...
  else
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)(v14 + 4), (int32_t)v13, v7, v8);
  }
  return v13;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4806D & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__ToArray__, method);
    byte_4B4806D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4806E & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&current);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_2865/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, v8);
    byte_4B4806E = 1;
  }
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_2865/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, 0LL);
  v25 = current;
  ...
  waveLabel = (UILabel_o *)System_String__Format_62613552(v11, v15, v19, 0LL);
  if ( !v10
  ...
  {
LABEL_12:
    sub_1BDBAD4(waveLabel, *(_QWORD *)&current);
  }
