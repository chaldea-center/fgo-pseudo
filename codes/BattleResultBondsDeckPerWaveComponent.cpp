        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1C942E4(System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo);
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.bondsIconList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D30187 & 1) == 0 )
  {
    sub_1C94098(&Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___);
    sub_1C94098(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__Add__);
    byte_4D30187 = 1;
  }
  ...
  if ( !iconRoot
    || (bondsIcon = (Il2CppObject *)this->fields.bondsIcon,
        ...
        iconRoot = (UnityEngine_Component_o *)BaseMonoBehaviour__createObject_object_(
                                                ...
                                                transform,
                                                0,
                                                (const MethodInfo_3184C94 *)Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___),
  ...
  else
  {
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)(v17 + 4), (int32_t)v16, v6, v7, v8, v9, v10, v11);
  }
  return v16;
}
...
LABEL_9:
    sub_1C942F0(this, isPartyNameDialog);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3018A & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_2834/*"BATTLE_RESULT_BONDS_PARTY_ID"*/);
    byte_4D3018A = 1;
  }
  ...
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_2834/*"BATTLE_RESULT_BONDS_PARTY_ID"*/, 0);
  ...
  if ( !v6 )
LABEL_8:
    sub_1C942F0(waveLabel, *(_QWORD *)&partyId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D30189 & 1) == 0 )
  {
    ...
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&StringLiteral_2835/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/);
    byte_4D30189 = 1;
  }
  waveLabel = this->fields.waveLabel;
  if ( !waveLabel )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_2835/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, 0);
  v14 = current;
  v10 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v14);
  v13 = max;
  v11 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v13);
  waveLabel = (UILabel_o *)System_String__Format_64459052(v9, v10, v11, 0);
  if ( !v8 )
LABEL_8:
    sub_1C942F0(waveLabel, *(_QWORD *)&current);
