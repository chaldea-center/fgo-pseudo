        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_object__o *)sub_1B887FC(System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.bondsIconList, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E2AA & 1) == 0 )
  {
    sub_1B885B0(&Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___);
    sub_1B885B0(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__Add__);
    byte_4A5E2AA = 1;
  }
  ...
  if ( !iconRoot
    || (bondsIcon = (Il2CppObject *)this->fields.bondsIcon,
        ...
        iconRoot = (UnityEngine_Component_o *)BaseMonoBehaviour__createObject_object_(
                                                ...
                                                transform,
                                                0LL,
                                                (const MethodInfo_2E6A584 *)Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___),
  ...
  else
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)(v13 + 4), (int32_t)v12, v6, v7);
  }
  return v12;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E2AC & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_2955/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/);
    byte_4A5E2AC = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_2955/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, 0LL);
  v23 = current;
  ...
  waveLabel = (UILabel_o *)System_String__Format_61721404(v9, v13, v17, 0LL);
  if ( !v8
  ...
  {
LABEL_12:
    sub_1B8880C(waveLabel, *(_QWORD *)&current);
  }
