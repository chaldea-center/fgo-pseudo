        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A519FF & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent___ctor__, method);
    sub_1B863B8(&System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo, v3);
    byte_4A519FF = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_BattleResultBondsIconComponent__TypeInfo);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.bondsIconList, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A519FC & 1) == 0 )
  {
    sub_1B863B8(&Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___, method);
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__Add__, v3);
    byte_4A519FC = 1;
  }
  ...
  if ( !iconRoot
    || (bondsIcon = (Il2CppObject *)this->fields.bondsIcon,
        ...
        iconRoot = (UnityEngine_Component_o *)BaseMonoBehaviour__createObject_object_(
                                                ...
                                                transform,
                                                0LL,
                                                (const MethodInfo_2F57628 *)Method_BaseMonoBehaviour_createObject_BattleResultBondsIconComponent___),
  ...
  else
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)(v14 + 4), (int32_t)v13, v7, v8);
  }
  return v13;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A519FD & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleResultBondsIconComponent__ToArray__, method);
    byte_4A519FD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A519FE & 1) == 0 )
  {
    sub_1B863B8(&int_TypeInfo, *(_QWORD *)&current);
    sub_1B863B8(&LocalizationManager_TypeInfo, v7);
    sub_1B863B8(&StringLiteral_2853/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, v8);
    byte_4A519FE = 1;
  }
  ...
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_2853/*"BATTLE_RESULT_BONDS_WAVE_COUNT"*/, 0LL);
  v25 = current;
  ...
  waveLabel = (UILabel_o *)System_String__Format_61686468(v11, v15, v19, 0LL);
  if ( !v10
  ...
  {
LABEL_12:
    sub_1B86614(waveLabel, *(_QWORD *)&current);
  }
