...
{
  System_IFormatProvider_o *CultureInfo_65176300; // x21
  ...
  if ( (byte_4CB272E & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_6904/*"GACHA_OVERWRITE_TIME_MESSAGE"*/);
    sub_1C6BA08(&StringLiteral_13448/*"TIME_STR_MONTH"*/);
    byte_4CB272E = 1;
  }
  Month = 0;
  ...
  remain = LocalizationManager__Get((System_String_o *)StringLiteral_13448/*"TIME_STR_MONTH"*/, 0);
  if ( !v10 )
    goto LABEL_20;
  ...
  day = this->fields.day;
  remain = LocalizationManager__Get((System_String_o *)StringLiteral_13445/*"TIME_STR_DAYS"*/, 0);
  if ( !day )
    goto LABEL_20;
  UILabel__set_text(day, remain, 0);
  week = this->fields.week;
  v15.fields._dateData = (uint64_t)&dateData;
  v16 = System_DateTime__ToString_65365192(v15, (System_String_o *)StringLiteral_18528/*"ddd"*/, CultureInfo_65176300, 0);
  remain = System_String__Concat_64005056(
  ...
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_6904/*"GACHA_OVERWRITE_TIME_MESSAGE"*/, 0);
