...
void __fastcall OverwriteTimeComponent__SetTime(OverwriteTimeComponent_o *this, int64_t time, const MethodInfo *method)
{
  ...
  __int64 v13; // x1
  __int64 v14; // x1
  System_IFormatProvider_o *CultureInfo_62379344; // x21
  ...
  if ( (byte_49B7449 & 1) == 0 )
  {
    sub_1B4CF90(&System_Globalization_CultureInfo_TypeInfo, time);
    sub_1B4CF90(&System_DateTime_TypeInfo, v5);
    sub_1B4CF90(&LocalizationManager_TypeInfo, v6);
    sub_1B4CF90(&NetworkManager_TypeInfo, v7);
    sub_1B4CF90(&StringLiteral_20616/*"ja-JP"*/, v8);
    sub_1B4CF90(&StringLiteral_18187/*"ddd"*/, v9);
    sub_1B4CF90(&StringLiteral_651/*"("*/, v10);
    sub_1B4CF90(&StringLiteral_13146/*"TIME_STR_DAYS"*/, v11);
    sub_1B4CF90(&StringLiteral_763/*")"*/, v12);
    sub_1B4CF90(&StringLiteral_6794/*"GACHA_OVERWRITE_TIME_MESSAGE"*/, v13);
    sub_1B4CF90(&StringLiteral_13149/*"TIME_STR_MONTH"*/, v14);
    byte_49B7449 = 1;
  }
  Month = 0;
  ...
  CultureInfo_62379344 = (System_IFormatProvider_o *)System_Globalization_CultureInfo__GetCultureInfo_62379344(
                                                       (System_String_o *)StringLiteral_20616/*"ja-JP"*/,
                                                       0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime_39105304(time, 0LL).fields._dateData;
  ...
  remain = LocalizationManager__Get((System_String_o *)StringLiteral_13149/*"TIME_STR_MONTH"*/, 0LL);
  if ( !v19 )
    goto LABEL_20;
  ...
  day = this->fields.day;
  remain = LocalizationManager__Get((System_String_o *)StringLiteral_13146/*"TIME_STR_DAYS"*/, 0LL);
  if ( !day )
    goto LABEL_20;
  UILabel__set_text(day, remain, 0LL);
  week = this->fields.week;
  v31.fields._dateData = (uint64_t)&dateData;
  v23 = System_DateTime__ToString_62497760(v31, (System_String_o *)StringLiteral_18187/*"ddd"*/, CultureInfo_62379344, 0LL);
  remain = System_String__Concat_61131716(
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_6794/*"GACHA_OVERWRITE_TIME_MESSAGE"*/, 0LL);
