        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.squareIndexes, (int32_t)squareIds, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A590D4 & 1) == 0 )
  {
    sub_1B885B0(&Method_NetworkManager_getRequest_WarBoardReinforcementsRequest___);
  ...
  Instance = (WarBoardReinforcementsRequest_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_8;
  ...
  Instance = (WarBoardReinforcementsRequest_o *)NetworkManager__getRequest_object_(
                                                  0LL,
                                                  (const MethodInfo_2F019D8 *)Method_NetworkManager_getRequest_WarBoardReinforcementsRequest___);
  if ( !Instance )
LABEL_8:
