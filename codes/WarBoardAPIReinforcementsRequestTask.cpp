        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02636 & 1) == 0 )
  {
    sub_1CE6700(&Method_NetworkManager_getRequest_WarBoardReinforcementsRequest___);
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    byte_4E02636 = 1;
  }
  Instance = (WarBoardReinforcementsRequest_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_8;
  ...
  Instance = (WarBoardReinforcementsRequest_o *)NetworkManager__getRequest_object_(
                                                  0,
                                                  (const MethodInfo_328F954 *)Method_NetworkManager_getRequest_WarBoardReinforcementsRequest___);
  if ( !Instance )
LABEL_8:
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.request, (int32_t)v6, v7, v8, v9, v10, v11, v12);
}