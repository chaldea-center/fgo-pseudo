void __fastcall BoxGachaUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB872F & 1) == 0 )
  {
    sub_1C13D24(&BoxGachaUtility_TypeInfo, v1);
    byte_4BB872F = 1;
  }
...
void __fastcall BoxGachaUtility__SetBoxGachaNumSprite(UISprite_o *sprite, int32_t num, const MethodInfo *method)
{
  ...
  if ( (byte_4BB872E & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_20657/*"img_frames_mask03"*/, v7);
    byte_4BB872E = 1;
  }
  v11 = num;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_20657/*"img_frames_mask03"*/, v8, 0LL);
  if ( !sprite )
    sub_1C13F80(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB872D & 1) == 0 )
  {
    *(_QWORD *)&gachaTime = sub_1C13D24(&BoxGachaUtility_TypeInfo, oneDigit);
    byte_4BB872D = 1;
  }
  if ( v8 < 10 )
    goto LABEL_9;
...
LABEL_32:
    sub_1C13F80(*(_QWORD *)&gachaTime, oneDigit);
  }
  if ( v9 )
    return;
LABEL_9:
