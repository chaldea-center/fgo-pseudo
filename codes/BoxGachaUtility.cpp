void __fastcall BoxGachaUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3F009 & 1) == 0 )
  {
    sub_1BDB878(&BoxGachaUtility_TypeInfo, v1);
    byte_4B3F009 = 1;
  }
...
void __fastcall BoxGachaUtility__SetBoxGachaNumSprite(UISprite_o *sprite, int32_t num, const MethodInfo *method)
{
  ...
  if ( (byte_4B3F008 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_20425/*"img_gachatxt_{0:D2}"*/, v7);
    byte_4B3F008 = 1;
  }
  v11 = num;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_20425/*"img_gachatxt_{0:D2}"*/, v8, 0LL);
  if ( !sprite )
    sub_1BDBAD4(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  v8 = gachaTime;
  if ( (qword_4B3F000 & 0x100000000000000LL) == 0 )
  {
    *(_QWORD *)&gachaTime = sub_1BDB878(&BoxGachaUtility_TypeInfo, oneDigit);
    HIBYTE(qword_4B3F000) = 1;
  }
  if ( v8 < 10 )
    goto LABEL_9;
  v9 = 0;
...
LABEL_32:
    sub_1BDBAD4(*(_QWORD *)&gachaTime, oneDigit);
  }
  if ( v9 )
    return;
LABEL_9:
