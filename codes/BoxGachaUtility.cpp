...
void __fastcall BoxGachaUtility__SetBoxGachaNumSprite(UISprite_o *sprite, int32_t num, const MethodInfo *method)
{
  ...
  if ( (byte_4A5EFA3 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_20322/*"img_gachatxt_{0:D2}"*/);
    byte_4A5EFA3 = 1;
  }
  v10 = num;
  v7 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v10, method, v3, v4);
  v8 = System_String__Format((System_String_o *)StringLiteral_20322/*"img_gachatxt_{0:D2}"*/, v7, 0LL);
  if ( !sprite )
    sub_1B8880C(v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EFA2 & 1) == 0 )
  {
    *(_QWORD *)&gachaTime = sub_1B885B0(&BoxGachaUtility_TypeInfo);
    byte_4A5EFA2 = 1;
  }
  if ( v8 < 10 )
    goto LABEL_9;
...
LABEL_32:
    sub_1B8880C(*(_QWORD *)&gachaTime, oneDigit);
  }
  if ( v9 )
    return;
LABEL_9:
