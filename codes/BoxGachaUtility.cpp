void __fastcall BoxGachaUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E64B1 & 1) == 0 )
  {
    sub_1B00CCC(&BoxGachaUtility_TypeInfo, v1);
    byte_48E64B1 = 1;
  }
...
void __fastcall BoxGachaUtility__SetBoxGachaNumSprite(UISprite_o *sprite, int32_t num, const MethodInfo *method)
{
  ...
  if ( (byte_48E64B0 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_20047/*"img_gachatxt_{0:D2}"*/, v7);
    byte_48E64B0 = 1;
  }
  v11 = num;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v11, method, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_20047/*"img_gachatxt_{0:D2}"*/, v8, 0LL);
  if ( !sprite )
    sub_1B00F28(v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E64AF & 1) == 0 )
  {
    *(_QWORD *)&gachaTime = sub_1B00CCC(&BoxGachaUtility_TypeInfo, oneDigit);
    byte_48E64AF = 1;
  }
  if ( v8 < 10 )
    goto LABEL_9;
...
LABEL_32:
    sub_1B00F28(*(_QWORD *)&gachaTime, oneDigit);
  }
  if ( v9 )
    return;
LABEL_9:
