        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8C8 & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Material_TypeInfo, shader);
  ...
  if ( UnityEngine_Object__op_Equality(v8, 0LL, 0LL) )
  {
    ...
    *material = v9;
    sub_1BC2FAC((CGThumbnailListItem_o *)material, (int32_t)v9, v12, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8C9 & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, shaderName);
    sub_1BC3008(&StringLiteral_243/*" from Shader.Find"*/, v5);
    sub_1BC3008(&StringLiteral_19208/*"failed to get "*/, v6);
    byte_4AFD8C9 = 1;
  }
  v7 = UnityEngine_Shader__Find(shaderName, 0LL);
  *shaderAsset = v7;
  sub_1BC2FAC((CGThumbnailListItem_o *)shaderAsset, (int32_t)v7, v8, v9);
  v10 = (UnityEngine_Object_o *)*shaderAsset;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v11 = UnityEngine_Object__op_Equality(v10, 0LL, 0LL);
  if ( v11 )
    System_String__Concat_62386896(
      (System_String_o *)StringLiteral_19208/*"failed to get "*/,
      shaderName,
        ...
        const MethodInfo *method)
{
  ...
  if ( v3 )
  {
    ...
    *outlineCmd = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)outlineCmd, 0, v4, v5);
  }
}
...
void __fastcall OutlineEffectUtility__DestroyMaterial(UnityEngine_Material_o **mat, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(v4, 0LL, 0LL) )
  {
    ...
    if ( v7 )
      ...
      UnityEngine_Object__DestroyImmediate_70034488(v6, 0LL);
    *mat = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)mat, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    if ( v7 )
      ...
      UnityEngine_Object__DestroyImmediate_70034488(v6, 0LL);
    *renderTexture = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)renderTexture, 0, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8D1 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_Camera___, battlePath);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v5);
    sub_1BC3008(&StringLiteral_43/*"\n"*/, v6);
    sub_1BC3008(&StringLiteral_6972/*"GameObject.Find return null"*/, v7);
    sub_1BC3008(&StringLiteral_19209/*"failed to get Camera component"*/, v8);
    byte_4AFD8D1 = 1;
  }
  ...
  {
    System_String__Concat_62386896(
      (System_String_o *)StringLiteral_6972/*"GameObject.Find return null"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8D0 & 1) == 0 )
  {
    smr = (UnityEngine_SkinnedMeshRenderer_o *)sub_1BC3008(&StringLiteral_17575/*"cant get material from SkinnedMeshRenderer.sharedMaterials. Either the sharedMaterials is null or have 0 length"*/, method);
    byte_4AFD8D0 = 1;
  }
  if ( !v2 )
    goto LABEL_9;
...
UnityEngine_Vector2_o __fastcall OutlineEffectUtility__GetScaledUVOffset(const MethodInfo *method)
{
  ...
  else
  {
    if ( !byte_4AFBCAA )
    {
      sub_1BC3008(&UnityEngine_Vector2_TypeInfo, v2);
      byte_4AFBCAA = 1;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8CE & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_Material__Add__, targetMaterial);
    sub_1BC3008(&Method_System_Collections_Generic_List_Material__ToArray__, v5);
    sub_1BC3008(&Method_System_Collections_Generic_List_Material___ctor___76762840, v6);
    sub_1BC3008(&System_Collections_Generic_List_Material__TypeInfo, v7);
    smr = (UnityEngine_SkinnedMeshRenderer_o *)sub_1BC3008(&UnityEngine_Object_TypeInfo, v8);
    byte_4AFD8CE = 1;
  }
  if ( !v4 )
    goto LABEL_38;
...
LABEL_21:
        if ( v13 < v12->max_length )
        {
          ...
          sharedMaterials = sub_1BC3144(targetMaterial, v12->obj.klass->_1.element_class);
          if ( !sharedMaterials )
          {
            v33 = sub_1BC3288();
            sub_1BC3130(v33, 0LL);
          ...
          {
            *v15 = targetMaterial;
            sub_1BC2FAC((CGThumbnailListItem_o *)v15, (int32_t)targetMaterial, v10, v28);
            v29 = v4;
            v30 = v12;
LABEL_27:
          ...
          if ( v19 )
          {
            ...
            if ( items )
            {
              ...
              else
              {
                ...
                sub_1BC2FAC((CGThumbnailListItem_o *)(v25 + 4), (int32_t)targetMaterial, v20, v21);
              }
...
LABEL_38:
          sub_1BC3264(smr, targetMaterial);
        }
        if ( v13 < v12->max_length )
        {
...
LABEL_39:
    sub_1BC326C(sharedMaterials, targetMaterial, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8CA & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Rendering_CommandBuffer_TypeInfo, name);
    byte_4AFD8CA = 1;
  }
  if ( *cb )
    UnityEngine_Rendering_CommandBuffer__Dispose(*cb, 0LL);
  v5 = (UnityEngine_Rendering_CommandBuffer_o *)sub_1BC3254(UnityEngine_Rendering_CommandBuffer_TypeInfo);
  UnityEngine_Rendering_CommandBuffer___ctor(v5, 0LL);
  if ( !v5 )
    sub_1BC3264(v6, v7);
  UnityEngine_Rendering_CommandBuffer__set_name(v5, name, 0LL);
  *cb = v5;
  sub_1BC2FAC((CGThumbnailListItem_o *)cb, (int32_t)v5, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8CF & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Application_TypeInfo, *(_QWORD *)&rtWidth);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v9);
    sub_1BC3008(&UnityEngine_RenderTexture_TypeInfo, v10);
    byte_4AFD8CF = 1;
  }
  ...
  v15 = (UnityEngine_RenderTexture_o *)sub_1BC3254(UnityEngine_RenderTexture_TypeInfo);
  UnityEngine_RenderTexture___ctor_69941292(v15, rtWidth, rtHeight, 0, 0LL);
  *rt = v15;
  sub_1BC2FAC((CGThumbnailListItem_o *)rt, (int32_t)v15, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8CD & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_System_Collections_Generic_List_Material__get_Count__, v5);
    sub_1BC3008(&Method_System_Collections_Generic_List_Material__get_Item__, v6);
    sub_1BC3008(&System_Collections_Generic_List_Material__TypeInfo, v7);
    smr = (UnityEngine_SkinnedMeshRenderer_o *)sub_1BC3008(&UnityEngine_Object_TypeInfo, v8);
    byte_4AFD8CD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD8D2 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_Material__RemoveAt__, instantiatedMaterialReference);
    sub_1BC3008(&Method_System_Collections_Generic_List_Material__ToArray__, v5);
    sub_1BC3008(&Method_System_Collections_Generic_List_Material___ctor___76762840, v6);
    sub_1BC3008(&Method_System_Collections_Generic_List_Material__get_Item__, v7);
    sub_1BC3008(&System_Collections_Generic_List_Material__TypeInfo, v8);
    smr = (UnityEngine_SkinnedMeshRenderer_o *)sub_1BC3008(&UnityEngine_Object_TypeInfo, v9);
    byte_4AFD8D2 = 1;
  }
  if ( !v4 )
    goto LABEL_12;
  ...
  if ( !v12 )
LABEL_12:
    sub_1BC3264(smr, instantiatedMaterialReference);
