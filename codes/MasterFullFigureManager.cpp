void __fastcall MasterFullFigureManager___ctor(MasterFullFigureManager_o *this, const MethodInfo *method)
{
  if ( (byte_4BC6CD1 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__, method);
    byte_4BC6CD1 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_387ACC0 *)Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CCF & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___, parent);
    sub_1C1ABD4(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v6);
    sub_1C1ABD4(&StringLiteral_14982/*"UIMasterFullFigure"*/, v7);
    byte_4BC6CCF = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14982/*"UIMasterFullFigure"*/, 0LL);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreateLocal_39120648(
        MasterFullFigureManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CD0 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_14983/*"UIMasterFullFigure("*/, v13);
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v27 = StringLiteral_14983/*"UIMasterFullFigure("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14983/*"UIMasterFullFigure("*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)(Local + 32), v27, v20, v21, v22, v23, v24, v25);
  Local = (char *)System_Int32__ToString((int32_t)&v56, 0LL);
  if ( *((_DWORD *)v26 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v26 + 5) = Local;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v26 + 40), (int64_t)Local, v28, v29, v30, v31, v32, v33);
  if ( *((_DWORD *)v26 + 6) <= 2u
    || (v40 = StringLiteral_918/*"-"*/,
        *((_QWORD *)v26 + 6) = StringLiteral_918/*"-"*/,
        sub_1C1AB78((PartyOrganizationUtility_o *)(v26 + 48), (int64_t)v40, v34, v35, v36, v37, v38, v39),
        Local = (char *)System_Int32__ToString((int32_t)&v55, 0LL),
        *((_DWORD *)v26 + 6) <= 3u)
    || (*((_QWORD *)v26 + 7) = Local,
        sub_1C1AB78((PartyOrganizationUtility_o *)(v26 + 56), (int64_t)Local, v41, v42, v43, v44, v45, v46),
        *((_DWORD *)v26 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C1AE38(Local, v17);
  }
  v53 = StringLiteral_812/*")"*/;
  *((_QWORD *)v26 + 8) = StringLiteral_812/*")"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v26 + 64), v53, v47, v48, v49, v50, v51, v52);
  Local = (char *)System_String__Concat_63053896((System_String_array *)v26, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1C1AE30(Local, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CCD & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, method);
    byte_4BC6CCD = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1C1AE30(0LL, v4);
...
// local variable allocation has failed, the output may be wrong!
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreatePrefab_39120500(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CCE & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, *(_QWORD *)&dispType);
    byte_4BC6CCE = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1C1AE30(0LL, v14);
  return MasterFullFigureManager__CreateLocal_39120648(
        ...
        const MethodInfo *method)
{
  if ( (byte_4BC6CC9 & 1) == 0 )
  {
    sub_1C1ABD4(&UIMasterFullFigureRender_TypeInfo, *(_QWORD *)&equipId);
    byte_4BC6CC9 = 1;
  }
