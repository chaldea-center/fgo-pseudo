void __fastcall MasterFullFigureManager___ctor(MasterFullFigureManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A6F0CD & 1) == 0 )
  {
    sub_1B90010(&Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__, method);
    byte_4A6F0CD = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_374CCA8 *)Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F0CB & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___, parent);
    sub_1B90010(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v6);
    sub_1B90010(&StringLiteral_14757/*"UIMasterFullFigure"*/, v7);
    byte_4A6F0CB = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14757/*"UIMasterFullFigure"*/, 0LL);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreateLocal_37973348(
        MasterFullFigureManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F0CC & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_14758/*"UIMasterFullFigure("*/, v13);
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v23 = StringLiteral_14758/*"UIMasterFullFigure("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14758/*"UIMasterFullFigure("*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(Local + 32), v23, v20, v21);
  Local = (char *)System_Int32__ToString((int32_t)&v36, 0LL);
  if ( *((_DWORD *)v22 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v22 + 5) = Local;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v22 + 40), (int32_t)Local, v24, v25);
  if ( *((_DWORD *)v22 + 6) <= 2u
    || (v28 = (int)StringLiteral_919/*"-"*/,
        *((_QWORD *)v22 + 6) = StringLiteral_919/*"-"*/,
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v22 + 48), v28, v26, v27),
        Local = (char *)System_Int32__ToString((int32_t)&v35, 0LL),
        *((_DWORD *)v22 + 6) <= 3u)
    || (*((_QWORD *)v22 + 7) = Local,
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v22 + 56), (int32_t)Local, v29, v30),
        *((_DWORD *)v22 + 6) <= 4u) )
  {
LABEL_12:
    sub_1B90274(Local, v17);
  }
  v33 = StringLiteral_814/*")"*/;
  *((_QWORD *)v22 + 8) = StringLiteral_814/*")"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v22 + 64), v33, v31, v32);
  Local = (char *)System_String__Concat_61800620((System_String_array *)v22, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1B9026C(Local, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F0C9 & 1) == 0 )
  {
    sub_1B90010(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, method);
    byte_4A6F0C9 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1B9026C(0LL, v4);
...
// local variable allocation has failed, the output may be wrong!
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreatePrefab_37973200(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F0CA & 1) == 0 )
  {
    sub_1B90010(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, *(_QWORD *)&dispType);
    byte_4A6F0CA = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1B9026C(0LL, v14);
  return MasterFullFigureManager__CreateLocal_37973348(
        ...
        const MethodInfo *method)
{
  if ( (byte_4A6F0C5 & 1) == 0 )
  {
    sub_1B90010(&UIMasterFullFigureRender_TypeInfo, *(_QWORD *)&equipId);
    byte_4A6F0C5 = 1;
  }
