void __fastcall MasterFullFigureManager___ctor(MasterFullFigureManager_o *this, const MethodInfo *method)
{
  if ( (byte_49FDDA5 & 1) == 0 )
  {
    sub_1B64A00(&Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__, method);
    byte_49FDDA5 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_36EED48 *)Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDA3 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___, parent);
    sub_1B64A00(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1B64A00(&UnityEngine_Object_TypeInfo, v6);
    sub_1B64A00(&StringLiteral_14666/*"UIMasterFullFigure"*/, v7);
    byte_49FDDA3 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14666/*"UIMasterFullFigure"*/, 0LL);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreateLocal_37611136(
        MasterFullFigureManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDA4 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_14667/*"UIMasterFullFigure("*/, v13);
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v23 = StringLiteral_14667/*"UIMasterFullFigure("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14667/*"UIMasterFullFigure("*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(Local + 32), v23, v20, v21);
  Local = (char *)System_Int32__ToString((int32_t)&v36, 0LL);
  if ( *((_DWORD *)v22 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v22 + 5) = Local;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v22 + 40), (int32_t)Local, v24, v25);
  if ( *((_DWORD *)v22 + 6) <= 2u
    || (v28 = (int)StringLiteral_920/*"-"*/,
        *((_QWORD *)v22 + 6) = StringLiteral_920/*"-"*/,
        sub_1B649A4((ServantStatusBattleListViewItem_o *)(v22 + 48), v28, v26, v27),
        Local = (char *)System_Int32__ToString((int32_t)&v35, 0LL),
        *((_DWORD *)v22 + 6) <= 3u)
    || (*((_QWORD *)v22 + 7) = Local,
        sub_1B649A4((ServantStatusBattleListViewItem_o *)(v22 + 56), (int32_t)Local, v29, v30),
        *((_DWORD *)v22 + 6) <= 4u) )
  {
LABEL_12:
    sub_1B64C64(Local, v17);
  }
  v33 = StringLiteral_815/*")"*/;
  *((_QWORD *)v22 + 8) = StringLiteral_815/*")"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v22 + 64), v33, v31, v32);
  Local = (char *)System_String__Concat_61398664((System_String_array *)v22, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1B64C5C(Local, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDA1 & 1) == 0 )
  {
    sub_1B64A00(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, method);
    byte_49FDDA1 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1B64C5C(0LL, v4);
...
// local variable allocation has failed, the output may be wrong!
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreatePrefab_37610988(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDA2 & 1) == 0 )
  {
    sub_1B64A00(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, *(_QWORD *)&dispType);
    byte_49FDDA2 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1B64C5C(0LL, v14);
  return MasterFullFigureManager__CreateLocal_37611136(
        ...
        const MethodInfo *method)
{
  if ( (byte_49FDD9D & 1) == 0 )
  {
    sub_1B64A00(&UIMasterFullFigureRender_TypeInfo, *(_QWORD *)&equipId);
    byte_49FDD9D = 1;
  }
