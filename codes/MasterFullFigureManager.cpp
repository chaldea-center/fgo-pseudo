void __fastcall MasterFullFigureManager___ctor(MasterFullFigureManager_o *this, const MethodInfo *method)
{
  if ( (byte_4B011CA & 1) == 0 )
  {
    sub_1BC3008(&Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__, method);
    byte_4B011CA = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_38E0160 *)Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011C8 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___, parent);
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v6);
    sub_1BC3008(&StringLiteral_14615/*"UIMasterFullFigure"*/, v7);
    byte_4B011C8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14615/*"UIMasterFullFigure"*/, 0LL);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreateLocal_39710844(
        MasterFullFigureManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011C9 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_14616/*"UIMasterFullFigure("*/, v13);
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v23 = StringLiteral_14616/*"UIMasterFullFigure("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14616/*"UIMasterFullFigure("*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(Local + 32), v23, v20, v21);
  Local = (char *)System_Int32__ToString((int32_t)&v32, 0LL);
  if ( *((_DWORD *)v22 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v22 + 5) = Local;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v22 + 40), (int32_t)Local, v20, v24);
  if ( *((_DWORD *)v22 + 6) <= 2u
    || (v26 = (int)StringLiteral_856/*"-"*/,
        *((_QWORD *)v22 + 6) = StringLiteral_856/*"-"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v22 + 48), v26, v20, v25),
        Local = (char *)System_Int32__ToString((int32_t)&v31, 0LL),
        *((_DWORD *)v22 + 6) <= 3u)
    || (*((_QWORD *)v22 + 7) = Local,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v22 + 56), (int32_t)Local, v20, v27),
        *((_DWORD *)v22 + 6) <= 4u) )
  {
LABEL_12:
    sub_1BC326C(Local, v17, v20);
  }
  v29 = StringLiteral_754/*")"*/;
  *((_QWORD *)v22 + 8) = StringLiteral_754/*")"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v22 + 64), v29, v20, v28);
  Local = (char *)System_String__Concat_62389164((System_String_array *)v22, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1BC3264(Local, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011C6 & 1) == 0 )
  {
    sub_1BC3008(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, method);
    byte_4B011C6 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1BC3264(0LL, v4);
...
// local variable allocation has failed, the output may be wrong!
UIMasterFullFigureTexture_o *__fastcall MasterFullFigureManager__CreatePrefab_39710696(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011C7 & 1) == 0 )
  {
    sub_1BC3008(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__, *(_QWORD *)&dispType);
    byte_4B011C7 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1BC3264(0LL, v14);
  return MasterFullFigureManager__CreateLocal_39710844(
        ...
        const MethodInfo *method)
{
  if ( (byte_4B011C2 & 1) == 0 )
  {
    sub_1BC3008(&UIMasterFullFigureRender_TypeInfo, *(_QWORD *)&equipId);
    byte_4B011C2 = 1;
  }
