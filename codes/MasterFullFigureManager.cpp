void MasterFullFigureManager___ctor(MasterFullFigureManager_o *this, const MethodInfo *method)
{
  if ( (byte_4C2645A & 1) == 0 )
  {
    sub_1C2D490(&Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__);
    byte_4C2645A = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_39D40E4 *)Method_SingletonMonoBehaviour_MasterFullFigureManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26458 & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___);
    sub_1C2D490(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_14744/*"UIMasterFullFigure"*/);
    byte_4C26458 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFullFigureTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v8, (System_String_o *)StringLiteral_14744/*"UIMasterFullFigure"*/, 0);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFullFigureTexture_o *MasterFullFigureManager__CreateLocal_40453264(
        MasterFullFigureManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26459 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_14745/*"UIMasterFullFigure("*/);
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v20 = StringLiteral_14745/*"UIMasterFullFigure("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14745/*"UIMasterFullFigure("*/;
  sub_1C2D434((CGThumbnailListItem_o *)(Local + 32), v20, v17, v18);
  Local = (char *)System_Int32__ToString((int32_t)&v29, 0);
  if ( *((_DWORD *)v19 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v19 + 5) = Local;
  sub_1C2D434((CGThumbnailListItem_o *)(v19 + 40), (int32_t)Local, v17, v21);
  if ( *((_DWORD *)v19 + 6) <= 2u
    || (v23 = (int)StringLiteral_861/*"-"*/,
        *((_QWORD *)v19 + 6) = StringLiteral_861/*"-"*/,
        sub_1C2D434((CGThumbnailListItem_o *)(v19 + 48), v23, v17, v22),
        Local = (char *)System_Int32__ToString((int32_t)&v28, 0),
        *((_DWORD *)v19 + 6) <= 3u)
    || (*((_QWORD *)v19 + 7) = Local,
        sub_1C2D434((CGThumbnailListItem_o *)(v19 + 56), (int32_t)Local, v17, v24),
        *((_DWORD *)v19 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C2D6F4(Local, v14, v17);
  }
  v26 = StringLiteral_759/*")"*/;
  *((_QWORD *)v19 + 8) = StringLiteral_759/*")"*/;
  sub_1C2D434((CGThumbnailListItem_o *)(v19 + 64), v26, v17, v25);
  Local = (char *)System_String__Concat_63498380((System_String_array *)v19, 0);
  if ( !gameObject )
LABEL_13:
    sub_1C2D6EC(Local, v14);
  UnityEngine_Object__set_name(gameObject, (System_String_o *)Local, 0);
  UIMasterFullFigureTexture__SetCharacter(v15, dispType, v29, v28, callbackFunc, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26456 & 1) == 0 )
  {
    sub_1C2D490(&Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
    byte_4C26456 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_MasterFullFigureManager__get_Instance__);
  if ( !Instance )
    sub_1C2D6EC(0, v4);
...
UIMasterFullFigureTexture_o *MasterFullFigureManager__CreatePrefab_40453116(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_1C2D6EC(0, v14);
  return MasterFullFigureManager__CreateLocal_40453264(
        ...
        const MethodInfo *method)
{
  if ( (byte_4C26452 & 1) == 0 )
  {
    sub_1C2D490(&UIMasterFullFigureRender_TypeInfo);
    byte_4C26452 = 1;
  }
