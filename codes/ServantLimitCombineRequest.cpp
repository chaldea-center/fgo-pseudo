        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A016 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_17217/*"card/combineLimit"*/, v2);
    byte_418A016 = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_17217/*"card/combineLimit"*/, 0LL);
}
