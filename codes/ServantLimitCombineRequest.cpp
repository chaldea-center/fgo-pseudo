        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438D57E & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_17560/*"card/combineLimit"*/);
    byte_438D57E = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_17560/*"card/combineLimit"*/, 0LL);
}
