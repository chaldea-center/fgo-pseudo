        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E087 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_17598/*"card/combineLimit"*/, v2);
    byte_4B1E087 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_17598/*"card/combineLimit"*/, 0LL);
}
