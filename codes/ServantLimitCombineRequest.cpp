        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EAE2E & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_17430/*"card/combineLimit"*/, v4, v5, v6);
    byte_42EAE2E = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_17430/*"card/combineLimit"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(39, responseList, 0LL);
