        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B24D1 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17336/*"card/combineLimit"*/);
    byte_42B24D1 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17336/*"card/combineLimit"*/, 0LL);
}
