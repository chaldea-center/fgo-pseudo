        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4353CC0 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_17477/*"card/combineLimit"*/);
    byte_4353CC0 = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_17477/*"card/combineLimit"*/, 0LL);
}
