        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC7F2 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17151/*"card/combineLimit"*/, v2);
    byte_40FC7F2 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17151/*"card/combineLimit"*/, 0LL);
}
