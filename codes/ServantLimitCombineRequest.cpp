        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB60D6 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_18022/*"cannot be less than zero"*/, v2);
    byte_4BB60D6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_18022/*"cannot be less than zero"*/, 0LL);
}
