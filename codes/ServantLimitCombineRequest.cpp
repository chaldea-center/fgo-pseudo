        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38B4D & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_17956/*"card/combineLimit"*/, v2);
    byte_4B38B4D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_17956/*"card/combineLimit"*/, 0LL);
}
