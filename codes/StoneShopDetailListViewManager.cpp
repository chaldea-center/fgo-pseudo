  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13 = (StoneShopDetailListViewItem_o *)sub_1C715FC(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC37B0 & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1C713B0(&StoneShopDetailListViewObject_TypeInfo);
    byte_4CC37B0 = 1;
  }
  if ( !obj
