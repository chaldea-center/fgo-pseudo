        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE42D & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_GiftMaster___, bankShop);
    sub_1BC3008(&DataManager_TypeInfo, v5);
    sub_1BC3008(&Method_System_Collections_Generic_List_ListViewItem__Add__, v6);
    sub_1BC3008(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v7);
    sub_1BC3008(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v8);
    sub_1BC3008(&StoneShopDetailListViewItem_TypeInfo, v9);
    byte_4AFE42D = 1;
  }
  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v18 = (StoneShopDetailListViewItem_o *)sub_1BC3254(StoneShopDetailListViewItem_TypeInfo);
        ...
        else
        {
          ...
          sub_1BC2FAC((CGThumbnailListItem_o *)(v25 + 4), (int32_t)v18, v20, v21);
        }
        if ( size == ++v15 )
          goto LABEL_16;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE42E & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1BC3008(&StoneShopDetailListViewObject_TypeInfo, obj);
    byte_4AFE42E = 1;
  }
  if ( !obj
