        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB23B2 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_GiftMaster___, bankShop);
    sub_1BAB41C(&DataManager_TypeInfo, v5);
    sub_1BAB41C(&Method_System_Collections_Generic_List_ListViewItem__Add__, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v7);
    sub_1BAB41C(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v8);
    sub_1BAB41C(&StoneShopDetailListViewItem_TypeInfo, v9);
    byte_4AB23B2 = 1;
  }
  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v18 = (StoneShopDetailListViewItem_o *)sub_1BAB668(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB23B3 & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1BAB41C(&StoneShopDetailListViewObject_TypeInfo, obj);
    byte_4AB23B3 = 1;
  }
  if ( !obj
