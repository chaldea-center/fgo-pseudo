        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E4C7 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_GiftMaster___, bankShop);
    sub_1C3B764(&DataManager_TypeInfo, v5);
    sub_1C3B764(&Method_System_Collections_Generic_List_ListViewItem__Add__, v6);
    sub_1C3B764(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v7);
    sub_1C3B764(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v8);
    sub_1C3B764(&StoneShopDetailListViewItem_TypeInfo, v9);
    byte_4C1E4C7 = 1;
  }
  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v18 = (StoneShopDetailListViewItem_o *)sub_1C3B9B0(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E4C8 & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1C3B764(&StoneShopDetailListViewObject_TypeInfo, obj);
    byte_4C1E4C8 = 1;
  }
  if ( !obj
