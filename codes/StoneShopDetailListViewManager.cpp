        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6317B & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMaster_GiftMaster___, bankShop);
    sub_1BE4ACC(&DataManager_TypeInfo, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ListViewItem__Add__, v6);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v7);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v8);
    sub_1BE4ACC(&StoneShopDetailListViewItem_TypeInfo, v9);
    byte_4B6317B = 1;
  }
  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v18 = (StoneShopDetailListViewItem_o *)sub_1BE4D18(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6317C & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1BE4ACC(&StoneShopDetailListViewObject_TypeInfo, obj);
    byte_4B6317C = 1;
  }
  if ( !obj
