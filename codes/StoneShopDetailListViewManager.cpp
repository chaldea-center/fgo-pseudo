        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FACB2 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_GiftMaster___, bankShop);
    sub_1B64870(&DataManager_TypeInfo, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_ListViewItem__Add__, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v8);
    sub_1B64870(&StoneShopDetailListViewItem_TypeInfo, v9);
    byte_49FACB2 = 1;
  }
  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v18 = (StoneShopDetailListViewItem_o *)sub_1B64ABC(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FACB3 & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1B64870(&StoneShopDetailListViewObject_TypeInfo, obj);
    byte_49FACB3 = 1;
  }
  if ( !obj
