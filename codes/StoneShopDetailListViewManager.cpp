  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13 = (StoneShopDetailListViewItem_o *)sub_1CE694C(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00C9F & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1CE6700(&StoneShopDetailListViewObject_TypeInfo);
    byte_4E00C9F = 1;
  }
  if ( !obj
