  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13 = (StoneShopDetailListViewItem_o *)sub_1C2D6DC(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2366E & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1C2D490(&StoneShopDetailListViewObject_TypeInfo);
    byte_4C2366E = 1;
  }
  if ( !obj
