  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13 = (StoneShopDetailListViewItem_o *)sub_1C93D20(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2CC3C & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1C93AD4(&StoneShopDetailListViewObject_TypeInfo);
    byte_4D2CC3C = 1;
  }
  if ( !obj
