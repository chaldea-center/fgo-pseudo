        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B73B9 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_GiftMaster___, bankShop);
    sub_1B4CF90(&DataManager_TypeInfo, v5);
    sub_1B4CF90(&Method_System_Collections_Generic_List_ListViewItem__Add__, v6);
    sub_1B4CF90(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v7);
    sub_1B4CF90(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v8);
    sub_1B4CF90(&StoneShopDetailListViewItem_TypeInfo, v9);
    byte_49B73B9 = 1;
  }
  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v18 = (StoneShopDetailListViewItem_o *)sub_1B4D1DC(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B73BA & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1B4CF90(&StoneShopDetailListViewObject_TypeInfo, obj);
    byte_49B73BA = 1;
  }
  if ( !obj
