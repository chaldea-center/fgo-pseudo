        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18915 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_GiftMaster___, bankShop);
    sub_1BCAFF8(&DataManager_TypeInfo, v5);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_ListViewItem__Add__, v6);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v7);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v8);
    sub_1BCAFF8(&StoneShopDetailListViewItem_TypeInfo, v9);
    byte_4B18915 = 1;
  }
  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v18 = (StoneShopDetailListViewItem_o *)sub_1BCB244(StoneShopDetailListViewItem_TypeInfo);
        ...
        else
        {
          ...
          sub_1BCAF9C((CGThumbnailListItem_o *)(v25 + 4), (int32_t)v18, v20, v21);
        }
        if ( size == ++v15 )
          goto LABEL_16;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18916 & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1BCAFF8(&StoneShopDetailListViewObject_TypeInfo, obj);
    byte_4B18916 = 1;
  }
  if ( !obj
