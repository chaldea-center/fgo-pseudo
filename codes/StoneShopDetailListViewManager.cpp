  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13 = (StoneShopDetailListViewItem_o *)sub_1D0F300(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E738C7 & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1D0F0B4(&StoneShopDetailListViewObject_TypeInfo);
    byte_4E738C7 = 1;
  }
  if ( !obj
