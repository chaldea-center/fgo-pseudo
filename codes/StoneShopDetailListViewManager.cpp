  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13 = (StoneShopDetailListViewItem_o *)sub_1C6BC54(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB269F & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1C6BA08(&StoneShopDetailListViewObject_TypeInfo);
    byte_4CB269F = 1;
  }
  if ( !obj
