  ...
  if ( ListById )
  {
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13 = (StoneShopDetailListViewItem_o *)sub_1C7BD34(StoneShopDetailListViewItem_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA94C & 1) == 0 )
  {
    this = (StoneShopDetailListViewManager_o *)sub_1C7BAE8(&StoneShopDetailListViewObject_TypeInfo);
    byte_4CEA94C = 1;
  }
  if ( !obj
