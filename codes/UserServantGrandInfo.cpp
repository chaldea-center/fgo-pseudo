void UserServantGrandInfo___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_2213CCC(UserServantGrandInfo_TypeInfo);
...
void UserServantGrandInfo___ctor_50652260(
        ...
        const MethodInfo *method)
{
  ...
  if ( userSvtEntity )
  {
    ...
    *(_QWORD *)&v38.fields.fakeValue = v11;
    Entity = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v38, 0);
    if ( v12 )
    {
      ...
      if ( Entity )
      {
        ...
        if ( notCheckUserServantGrand )
        {
          ...
          v18 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_UserServantGrandMaster___);
          v20 = *(_QWORD *)(v15 + 16);
          v21 = *(_QWORD *)(v15 + 24);
          ...
          *(_QWORD *)&v39.fields.fakeValue = v21;
          Entity = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v39, 0);
          if ( !v22 )
            goto LABEL_30;
        ...
        else
        {
          if ( !v17 )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v16);
          v26 = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_UserServantGrandMaster___);
          ...
          *(_OWORD *)&v37.fields.fakeValue = v27;
          ...
          v36 = v37;
          Entity = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_56000612(&v36, 0);
          if ( !v26 )
            goto LABEL_30;
        ...
        Entity = (int64_t)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_GrandGraphDetailMaster___);
        if ( Entity )
        {
          ...
          sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields, (int32_t)v29, v30, v31, v32, v33, v34, v35);
          return;
        }
      }
    }
LABEL_30:
    sub_2213CDC(Entity, v14);
  }
}


void UserServantGrandInfo___ctor_50652868(
        UserServantGrandInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( servantLeaderInfo && servantLeaderInfo->fields.grandSvt )
  {
    ...
    *(_QWORD *)&v24.fields.fakeValue = v9;
    Entity = (GrandGraphDetailEntity_array *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v24, 0);
    if ( !Master_object )
      goto LABEL_25;
    ...
    if ( ServantEntity__get_IsOrganization((ServantEntity_o *)Entity, 0) )
    {
      ...
      if ( servantLeaderInfo->fields.grandGraphId < 1 )
      {
        ...
        Entity = (GrandGraphDetailEntity_array *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_GrandGraphDetailMaster___);
        if ( Entity )
        {
      ...
      else
      {
        ...
        if ( Entity )
        {
          ...
          p_fields = (MissionNaviTransitionBoardItem_o *)&this->fields;
LABEL_24:
          sub_2213A04(p_fields, (int32_t)v22, v16, v17, v18, v19, v20, v21);
          return;
        }
      }
LABEL_25:
        ...
        const MethodInfo *method)
{
  ...
  if ( userSvtEntity )
  {
    Empty = (UserServantGrandInfo_o *)sub_2213CCC(UserServantGrandInfo_TypeInfo);
    UserServantGrandInfo___ctor_50652260(Empty, userSvtEntity, notCheckUserServantGrand, v7);
    if ( Empty )
      goto LABEL_5;
LABEL_13:
    sub_2213CDC(v5, notCheckUserServantGrand);
  }
...
UserServantGrandInfo_o *UserServantGrandInfo__Make_50582324(
        ServantLeaderInfo_o *servantLeaderInfo,
        const MethodInfo *method)
{
  ...
  {
    Empty = (UserServantGrandInfo_o *)sub_2213CCC(UserServantGrandInfo_TypeInfo);
    UserServantGrandInfo___ctor_50652868(Empty, servantLeaderInfo, v5);
    if ( Empty )
      goto LABEL_5;
LABEL_13:
