void __fastcall UserServantGrandInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D963 & 1) == 0 )
  {
    sub_1BCAFF8(&UserServantGrandInfo_TypeInfo, v1);
    byte_4B1D963 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(UserServantGrandInfo_TypeInfo);
  System_Object___ctor(v2, 0LL);
  UserServantGrandInfo_TypeInfo->static_fields->Empty = (struct UserServantGrandInfo_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)UserServantGrandInfo_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
...
void __fastcall UserServantGrandInfo___ctor_42690336(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D95F & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_GrandGraphDetailMaster___, userSvtEntity);
    sub_1BCAFF8(&Method_DataManager_GetMaster_ServantMaster___, v7);
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserServantGrandMaster___, v8);
  ...
  if ( userSvtEntity )
  {
    ...
    *(_QWORD *)&v29.fields.fakeValue = v14;
    Entity = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v29, 0LL);
    if ( v16 )
    {
      ...
      if ( Entity )
      {
        ...
        if ( !notCheckUserServantGrand )
        {
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          v20 = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_UserServantGrandMaster___);
          ...
          *(_OWORD *)&v28.fields.fakeValue = v22;
          ...
          v27 = v28;
          Entity = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48128700(&v27, 0LL);
          if ( !v23 )
            goto LABEL_23;
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Entity = (int64_t)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_GrandGraphDetailMaster___);
        if ( Entity )
        {
          ...
          sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields, (int32_t)EntityByBaseClassId, v25, v26);
          return;
        }
      }
    }
LABEL_23:
    sub_1BCB254(Entity, v18);
  }
}


void __fastcall UserServantGrandInfo___ctor_42690844(
        UserServantGrandInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D960 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_GrandGraphDetailMaster___, servantLeaderInfo);
  ...
  if ( servantLeaderInfo && servantLeaderInfo->fields.grandSvt )
  {
    ...
    *(_QWORD *)&v19.fields.fakeValue = v10;
    Entity = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v19, 0LL);
    if ( !v12 )
      goto LABEL_17;
    ...
    if ( ServantEntity__get_IsOrganization((ServantEntity_o *)Entity, 0LL) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Entity = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_GrandGraphDetailMaster___);
      if ( Entity )
      {
        EntityByBaseClassId = GrandGraphDetailMaster__GetEntityByBaseClassId(
                                (GrandGraphDetailMaster_o *)Entity,
                                ...
                                0LL);
        this->fields.svtGrandDetailEntity = EntityByBaseClassId;
        sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields, (int32_t)EntityByBaseClassId, v17, v18);
        return;
      }
LABEL_17:
      sub_1BCB254(Entity, v14);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D961 & 1) == 0 )
  {
    sub_1BCAFF8(&UserServantGrandInfo_TypeInfo, notCheckUserServantGrand);
    byte_4B1D961 = 1;
  }
  v5 = UserServantGrandInfo_TypeInfo;
  if ( userSvtEntity )
  {
    Empty = (UserServantGrandInfo_o *)sub_1BCB244(UserServantGrandInfo_TypeInfo);
    UserServantGrandInfo___ctor_42690336(Empty, userSvtEntity, notCheckUserServantGrand, v7);
    if ( Empty )
      goto LABEL_5;
LABEL_13:
    sub_1BCB254(v5, notCheckUserServantGrand);
  }
...
UserServantGrandInfo_o *__fastcall UserServantGrandInfo__Make_42608508(
        ServantLeaderInfo_o *servantLeaderInfo,
        const MethodInfo *method)
{
  ...
  {
    Empty = (UserServantGrandInfo_o *)sub_1BCB244(UserServantGrandInfo_TypeInfo);
    UserServantGrandInfo___ctor_42690844(Empty, servantLeaderInfo, v5);
    if ( Empty )
      goto LABEL_5;
LABEL_13:
