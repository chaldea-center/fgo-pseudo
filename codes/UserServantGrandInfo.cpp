void __fastcall UserServantGrandInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B0345A & 1) == 0 )
  {
    sub_1BC3008(&UserServantGrandInfo_TypeInfo, v1);
    byte_4B0345A = 1;
  }
  v2 = (Il2CppObject *)sub_1BC3254(UserServantGrandInfo_TypeInfo);
  System_Object___ctor(v2, 0LL);
  UserServantGrandInfo_TypeInfo->static_fields->Empty = (struct UserServantGrandInfo_o *)v2;
  sub_1BC2FAC((CGThumbnailListItem_o *)UserServantGrandInfo_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
...
void __fastcall UserServantGrandInfo___ctor_42527404(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03456 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_GrandGraphDetailMaster___, userSvtEntity);
    sub_1BC3008(&Method_DataManager_GetMaster_ServantMaster___, v7);
    sub_1BC3008(&Method_DataManager_GetMaster_UserServantGrandMaster___, v8);
  ...
  if ( userSvtEntity )
  {
    ...
    *(_QWORD *)&v29.fields.fakeValue = v14;
    Entity = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v29, 0LL);
    if ( v16 )
    {
      ...
      if ( Entity )
      {
        ...
        if ( !notCheckUserServantGrand )
        {
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          v20 = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_UserServantGrandMaster___);
          ...
          *(_OWORD *)&v28.fields.fakeValue = v22;
          ...
          v27 = v28;
          Entity = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48027584(&v27, 0LL);
          if ( !v23 )
            goto LABEL_23;
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Entity = (int64_t)DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_GrandGraphDetailMaster___);
        if ( Entity )
        {
          ...
          sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields, (int32_t)EntityByBaseClassId, v25, v26);
          return;
        }
      }
    }
LABEL_23:
    sub_1BC3264(Entity, v18);
  }
}


void __fastcall UserServantGrandInfo___ctor_42527912(
        UserServantGrandInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03457 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_GrandGraphDetailMaster___, servantLeaderInfo);
  ...
  if ( servantLeaderInfo && servantLeaderInfo->fields.grandSvt )
  {
    ...
    *(_QWORD *)&v19.fields.fakeValue = v10;
    Entity = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v19, 0LL);
    if ( !v12 )
      goto LABEL_17;
    ...
    if ( ServantEntity__get_IsOrganization((ServantEntity_o *)Entity, 0LL) )
    {
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Entity = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_GrandGraphDetailMaster___);
      if ( Entity )
      {
        EntityByBaseClassId = GrandGraphDetailMaster__GetEntityByBaseClassId(
                                (GrandGraphDetailMaster_o *)Entity,
                                ...
                                0LL);
        this->fields.svtGrandDetailEntity = EntityByBaseClassId;
        sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields, (int32_t)EntityByBaseClassId, v17, v18);
        return;
      }
LABEL_17:
      sub_1BC3264(Entity, v14);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03458 & 1) == 0 )
  {
    sub_1BC3008(&UserServantGrandInfo_TypeInfo, notCheckUserServantGrand);
    byte_4B03458 = 1;
  }
  v5 = UserServantGrandInfo_TypeInfo;
  if ( userSvtEntity )
  {
    Empty = (UserServantGrandInfo_o *)sub_1BC3254(UserServantGrandInfo_TypeInfo);
    UserServantGrandInfo___ctor_42527404(Empty, userSvtEntity, notCheckUserServantGrand, v7);
    if ( Empty )
      goto LABEL_5;
LABEL_13:
    sub_1BC3264(v5, notCheckUserServantGrand);
  }
...
UserServantGrandInfo_o *__fastcall UserServantGrandInfo__Make_42445700(
        ServantLeaderInfo_o *servantLeaderInfo,
        const MethodInfo *method)
{
  ...
  {
    Empty = (UserServantGrandInfo_o *)sub_1BC3254(UserServantGrandInfo_TypeInfo);
    UserServantGrandInfo___ctor_42527912(Empty, servantLeaderInfo, v5);
    if ( Empty )
      goto LABEL_5;
LABEL_13:
