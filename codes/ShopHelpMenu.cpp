...
void ShopHelpMenu__Close(ShopHelpMenu_o *this, System_Action_o *onClose, const MethodInfo *method)
{
  ...
  if ( (byte_4C5910B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ShopHelpMenu_endClose__);
    byte_4C5910B = 1;
  }
  this->fields.onClose = onClose;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.onClose, (int32_t)onClose, (int32_t)method, v3);
...
void ShopHelpMenu__OnEnable(ShopHelpMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5910A & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_12859/*"ShopHelpListPanel/BaseWindow/UpperCloseButton"*/);
    byte_4C5910A = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  if ( !transform )
    goto LABEL_9;
  v5 = (UnityEngine_Object_o *)UnityEngine_Transform__Find(transform, (System_String_o *)StringLiteral_12859/*"ShopHelpListPanel/BaseWindow/UpperCloseButton"*/, 0);
...
void ShopHelpMenu__endClose(ShopHelpMenu_o *this, const MethodInfo *method)
{
  ...
  if ( onClose )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)p_onClose, 0, v2, v3);
    BaseDialog__Init((BaseDialog_o *)this, 0);
