void __fastcall PartyOrganizationMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCE6 & 1) == 0 )
  {
    ...
    sub_1C3B764(&PartyOrganizationMenu_TypeInfo, v2);
    byte_4C1DCE6 = 1;
  }
  ...
  sub_1C3B708(PartyOrganizationMenu_TypeInfo->static_fields);
}
...
void __fastcall PartyOrganizationMenu__ClearItem(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B9C0(mainDeckBase, method);
  }
...
void __fastcall PartyOrganizationMenu__Close(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationMenu__Close_33344584(this, 0LL, v2);
}


void __fastcall PartyOrganizationMenu__Close_33344584(
        PartyOrganizationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCDD & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_PartyOrganizationMenu_EndClose__, v5);
    byte_4C1DCDD = 1;
  }
...
void __fastcall PartyOrganizationMenu__EndOpen(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCDC & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_PartyOrganizationMenu_EndOpenTutorialArrow__, v7);
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v8);
    sub_1C3B764(&StringLiteral_13796/*"The parameter must be a BigInteger."*/, v9);
    byte_4C1DCDC = 1;
  }
  if ( this->fields.mode == 4 )
  {
    ...
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_13796/*"The parameter must be a BigInteger."*/, 0LL);
...
void __fastcall PartyOrganizationMenu__Init(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  sub_1C3B708(&this->fields.basePartyItem);
  this->fields.partyItem = 0LL;
  sub_1C3B708(&this->fields.partyItem);
  this->fields.state = 0;
...
void __fastcall PartyOrganizationMenu__ModifyItem(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !partyOrganizationListViewManager )
    sub_1C3B9C0(0LL, method);
  PartyOrganizationListViewManager__SetMode_33328692(partyOrganizationListViewManager, 9, v2);
}
...
void __fastcall PartyOrganizationMenu__OnClickCancel(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( !partyOrganizationListViewManager )
      sub_1C3B9C0(0LL, method);
    PartyOrganizationListViewManager__SetMode_33328692(partyOrganizationListViewManager, 1, v2);
...
void __fastcall PartyOrganizationMenu__OnClickDecide(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&System_Action_TypeInfo, method);
    sub_1C3B764(&Method_PartyOrganizationMenu_EndCloseTutorialArrowDecide__, v4);
  ...
  if ( state == 7 )
  {
    if ( this->fields.mode == 4 )
    {
      ...
      if ( !Instance )
        goto LABEL_11;
      CommonUI__CloseTutorialNotificationDialogArrow_31257460((CommonUI_o *)Instance, v10, 0LL);
    }
  }
  else if ( state == 2 )
  {
...
LABEL_11:
    sub_1C3B9C0(partyOrganizationListViewManager, method);
  }
}
...
void __fastcall PartyOrganizationMenu__OnClickInfomation(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCE0 & 1) == 0 )
  {
    sub_1C3B764(&Method_PartyOrganizationMenu_OnClickInfomation__, method);
    byte_4C1DCE0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_PartyOrganizationMenu_OnClickInfomation__);
    ...
    if ( !partyOrganizationListViewManager )
      sub_1C3B9C0(0LL, v5);
    PartyOrganizationListViewManager__SetMode_33328692(partyOrganizationListViewManager, 1, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCE2 & 1) == 0 )
  {
    sub_1C3B764(&PartyOrganizationListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1C3B764(&Method_PartyOrganizationMenu_OnClickItem__, v7);
...
LABEL_10:
          ...
          if ( partyItem )
          {
            PartyOrganizationListViewManager__SetMode_33328692((PartyOrganizationListViewManager_o *)partyItem, 1, v10);
            goto LABEL_12;
          }
          goto LABEL_41;
        }
        ...
        {
          partyItem = (PartyListViewItem_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38C8B54 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
          if ( !partyItem )
            goto LABEL_41;
          if ( !partyItem->fields.deckName )
          {
            ...
            if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickItem__ + 83) & 2) != 0 )
              v20 = (_QWORD *)sub_1C3B77C(Method_PartyOrganizationMenu_OnClickItem__);
...
LABEL_16:
      partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
      v15 = (PartyOrganizationListViewManager_CallbackFunc_o *)sub_1C3B9B0(PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
      ...
      if ( partyOrganizationListViewManager )
      {
        ...
        sub_1C3B708(&partyOrganizationListViewManager->fields.callbackFunc);
        PartyOrganizationListViewManager__SetMode_33328692(partyOrganizationListViewManager, 2, v17);
        return;
      }
      goto LABEL_41;
    }
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickItem__ + 83) & 2) != 0 )
      v18 = (_QWORD *)sub_1C3B77C(Method_PartyOrganizationMenu_OnClickItem__);
...
LABEL_41:
    sub_1C3B9C0(partyItem, *(_QWORD *)&result);
  }
}
...
void __fastcall PartyOrganizationMenu__OnClickPointEvent(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCE1 & 1) == 0 )
  {
    sub_1C3B764(&Method_PartyOrganizationMenu_OnClickPointEvent__, method);
    byte_4C1DCE1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_PartyOrganizationMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
    this->fields.state = 3;
...
void __fastcall PartyOrganizationMenu__OnClickQuestInfo(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCE3 & 1) == 0 )
  {
    sub_1C3B764(&Method_PartyOrganizationMenu_OnClickQuestInfo__, method);
    byte_4C1DCE3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickQuestInfo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_PartyOrganizationMenu_OnClickQuestInfo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCDB & 1) == 0 )
  {
    ...
    sub_1C3B764(&BalanceConfig_TypeInfo, v20);
    sub_1C3B764(&LocalizationManager_TypeInfo, v21);
    sub_1C3B764(&Method_PartyOrganizationMenu_EndOpen__, v22);
    sub_1C3B764(&Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__, v23);
    sub_1C3B764(&StringLiteral_20064/*"img_quest_lasttime"*/, v24);
    sub_1C3B764(&StringLiteral_12501/*"Setting position is not supported on "*/, v25);
    byte_4C1DCDB = 1;
  }
  state = this->fields.state;
              ...
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  if ( gameObject )
                  {
                    ...
                    {
                      UnityEngine_GameObject__SetActive(gameObject, 1, 0LL);
                      gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38C8B54 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
                      if ( gameObject )
                      {
                        *(_QWORD *)&gameObject[3].fields.m_CachedPtr = partyItem;
                        sub_1C3B708(&gameObject[3].fields);
                        ...
                        AtlasManager__SetEventUI(
                          ...
                          (System_String_o *)StringLiteral_20064/*"img_quest_lasttime"*/,
                          0LL);
...
void __fastcall PartyOrganizationMenu__SetInput(PartyOrganizationMenu_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCDA & 1) == 0 )
  {
    sub_1C3B764(&PartyOrganizationListViewManager_CallbackFunc_TypeInfo, isInput);
    this = (PartyOrganizationMenu_o *)sub_1C3B764(&Method_PartyOrganizationMenu_OnClickItem__, v5);
    byte_4C1DCDA = 1;
  }
...
LABEL_9:
    sub_1C3B9C0(this, isInput);
  }
  v7 = (PartyOrganizationListViewManager_CallbackFunc_o *)sub_1C3B9B0(PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
  ...
  v9 = 2;
LABEL_8:
  PartyOrganizationListViewManager__SetMode_33328692(klass, v9, method);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B9C0(partyListViewIndicator, *(_QWORD *)&friendBonusVal);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCDE & 1) == 0 )
  {
    sub_1C3B764(&AtlasManager_TypeInfo, isMove);
    sub_1C3B764(&BalanceConfig_TypeInfo, v5);
    sub_1C3B764(&CondType_TypeInfo, v6);
    sub_1C3B764(&System_Convert_TypeInfo, v7);
    sub_1C3B764(&FSUtility_TypeInfo, v8);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v9);
    sub_1C3B764(&PartyOrganizationMenu_TypeInfo, v10);
    sub_1C3B764(&QuestInformationComponent_TypeInfo, v11);
    sub_1C3B764(&StringLiteral_18014/*"csIBM424"*/, v12);
    byte_4C1DCDE = 1;
  }
...
LABEL_71:
    sub_1C3B9C0(partyRemoveButton, isMove);
  }
  questRestrictionInfo = this->fields.questRestrictionInfo;
  if ( questRestrictionInfo )
  {
...
LABEL_25:
  ...
  if ( (v20 & 1) != 0 )
  {
    ...
    partyRemoveButton = (UnityEngine_Component_o *)System_Convert__ToInt32_63991276(v16, 0LL);
    if ( !LAYOUT_POS_X_HINT )
      goto LABEL_71;
    if ( (unsigned int)partyRemoveButton >= LAYOUT_POS_X_HINT->max_length )
      sub_1C3B9C8(partyRemoveButton, isMove);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCD8 & 1) == 0 )
  {
    sub_1C3B764(&PartyOrganizationMenu_CallbackFunc_TypeInfo, value);
    byte_4C1DCD8 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationMenu_o *)sub_1C3BC80(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A76DF8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A76DA0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DCE7 & 1) == 0 )
  {
    ...
    sub_1C3B764(&PartyOrganizationMenu_ResultKind_TypeInfo, v9);
    byte_4C1DCE7 = 1;
  }
  v14[2] = 0LL;
