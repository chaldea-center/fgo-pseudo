void __fastcall PartyOrganizationMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BD8332 & 1) == 0 )
  {
    ...
    sub_1C21E38(&PartyOrganizationMenu_TypeInfo);
    byte_4BD8332 = 1;
  }
  ...
  sub_1C21DDC(PartyOrganizationMenu_TypeInfo->static_fields, v1);
}
...
void __fastcall PartyOrganizationMenu__Close(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationMenu__Close_33205020(this, 0LL, v2);
}


void __fastcall PartyOrganizationMenu__Close_33205020(
        PartyOrganizationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8329 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PartyOrganizationMenu_EndClose__);
    byte_4BD8329 = 1;
  }
...
void __fastcall PartyOrganizationMenu__EndOpen(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD8328 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_PartyOrganizationMenu_EndOpenTutorialArrow__);
  ...
  if ( this->fields.mode == 4 )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_13758/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, 0LL);
    v9 = (System_Action_o *)sub_1C22084(System_Action_TypeInfo);
    System_Action___ctor(v9, (Il2CppObject *)this, Method_PartyOrganizationMenu_EndOpenTutorialArrow__, 0LL);
    if ( !Instance )
LABEL_21:
      sub_1C22094(tutorialMaskBase, method);
    v13.fields.x = AddOffset.fields.x + 422.0;
    v13.fields.y = AddOffset.fields.y + -231.0;
    v14.fields.m_XMin = AddOffset.fields.x + 329.0;
    v14.fields.m_YMin = AddOffset.fields.y + -291.0;
    v14.fields.m_Width = 190.0;
    v14.fields.m_Height = 90.0;
    CommonUI__OpenTutorialNotificationDialogArrow((CommonUI_o *)Instance, v8, v13, v14, 0.0, 0LL, -1, v9, 0LL);
  }
...
void __fastcall PartyOrganizationMenu__ModifyItem(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !partyOrganizationListViewManager )
    sub_1C22094(0LL, method);
  PartyOrganizationListViewManager__SetMode_33189232(partyOrganizationListViewManager, 9, v2);
}
...
void __fastcall PartyOrganizationMenu__OnClickCancel(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( !partyOrganizationListViewManager )
      sub_1C22094(0LL, method);
    PartyOrganizationListViewManager__SetMode_33189232(partyOrganizationListViewManager, 1, v2);
...
void __fastcall PartyOrganizationMenu__OnClickDecide(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_PartyOrganizationMenu_EndCloseTutorialArrowDecide__);
    sub_1C21E38(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4BD832B = 1;
  }
...
LABEL_11:
    sub_1C22094(partyOrganizationListViewManager, method);
  }
}
...
void __fastcall PartyOrganizationMenu__OnClickInfomation(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD832C & 1) == 0 )
  {
    sub_1C21E38(&Method_PartyOrganizationMenu_OnClickInfomation__);
    byte_4BD832C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_PartyOrganizationMenu_OnClickInfomation__);
    ...
    if ( !partyOrganizationListViewManager )
      sub_1C22094(0LL, v5);
    PartyOrganizationListViewManager__SetMode_33189232(partyOrganizationListViewManager, 1, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD832E & 1) == 0 )
  {
    sub_1C21E38(&PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
    sub_1C21E38(&Method_PartyOrganizationMenu_OnClickItem__);
...
LABEL_10:
          ...
          if ( partyItem )
          {
            PartyOrganizationListViewManager__SetMode_33189232((PartyOrganizationListViewManager_o *)partyItem, 1, v8);
            goto LABEL_12;
          }
          goto LABEL_41;
        }
        ...
        {
          partyItem = (PartyListViewItem_o *)SingletonTemplate_object___get_Instance((const MethodInfo_388D478 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
          if ( !partyItem )
            goto LABEL_41;
          if ( !PartyOrganizationUtility__ExistsTemporaryPartyInfo((PartyOrganizationUtility_o *)partyItem, 0LL) )
          {
            ...
            if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickItem__ + 83) & 2) != 0 )
              v18 = (_QWORD *)sub_1C21E50(Method_PartyOrganizationMenu_OnClickItem__);
...
LABEL_16:
      partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
      v13 = (PartyOrganizationListViewManager_CallbackFunc_o *)sub_1C22084(PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
      ...
      if ( partyOrganizationListViewManager )
      {
        ...
        sub_1C21DDC(&partyOrganizationListViewManager->fields.callbackFunc, v13);
        PartyOrganizationListViewManager__SetMode_33189232(partyOrganizationListViewManager, 2, v15);
        return;
      }
      goto LABEL_41;
    }
    ...
    v16 = Method_PartyOrganizationMenu_OnClickItem__;
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickItem__ + 83) & 2) != 0 )
      v16 = (_QWORD *)sub_1C21E50(Method_PartyOrganizationMenu_OnClickItem__);
...
LABEL_41:
    sub_1C22094(partyItem, *(_QWORD *)&result);
  }
}
...
void __fastcall PartyOrganizationMenu__OnClickPointEvent(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD832D & 1) == 0 )
  {
    sub_1C21E38(&Method_PartyOrganizationMenu_OnClickPointEvent__);
    byte_4BD832D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_PartyOrganizationMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
    this->fields.state = 3;
...
void __fastcall PartyOrganizationMenu__OnClickQuestInfo(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD832F & 1) == 0 )
  {
    sub_1C21E38(&Method_PartyOrganizationMenu_OnClickQuestInfo__);
    byte_4BD832F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickQuestInfo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_PartyOrganizationMenu_OnClickQuestInfo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8327 & 1) == 0 )
  {
    ...
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&Method_PartyOrganizationMenu_EndOpen__);
    sub_1C21E38(&Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
...
LABEL_27:
    ...
    case 0:
      ...
      if ( gameObject )
      {
        ...
        {
          v22 = *(_DWORD *)(*(_QWORD *)&gameObject[7].fields.m_CachedPtr + 1088LL);
              ...
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  if ( gameObject )
                  {
                    ...
                    {
                      UnityEngine_GameObject__SetActive(gameObject, 1, 0LL);
                      gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_388D478 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
                      if ( gameObject )
                      {
                        *(_QWORD *)&gameObject[3].fields.m_CachedPtr = partyItem;
                        sub_1C21DDC(&gameObject[3].fields, partyItem);
                        ...
                        AtlasManager__SetEventUI(
                          ...
                          (System_String_o *)StringLiteral_20014/*"func_group_icon_1009_starting"*/,
                          0LL);
...
void __fastcall PartyOrganizationMenu__SetInput(PartyOrganizationMenu_o *this, bool isInput, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
    this = (PartyOrganizationMenu_o *)sub_1C21E38(&Method_PartyOrganizationMenu_OnClickItem__);
    byte_4BD8326 = 1;
  }
...
LABEL_9:
  ...
  v6 = (PartyOrganizationListViewManager_CallbackFunc_o *)sub_1C22084(PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
  ...
  sub_1C21DDC(&klass->fields.callbackFunc, v6);
  v8 = 2;
LABEL_8:
  PartyOrganizationListViewManager__SetMode_33189232(klass, v8, method);
}
...
LABEL_25:
  ...
  if ( (v12 & 1) != 0 )
  {
    ...
    partyRemoveButton = (UnityEngine_Component_o *)System_Convert__ToInt32_63738140(v8, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8324 & 1) == 0 )
  {
    sub_1C21E38(&PartyOrganizationMenu_CallbackFunc_TypeInfo);
    byte_4BD8324 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationMenu_o *)sub_1C22354(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5D8A0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5D848;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8333 & 1) == 0 )
  {
    ...
    sub_1C21E38(&PartyOrganizationMenu_ResultKind_TypeInfo);
    byte_4BD8333 = 1;
  }
  v13[2] = 0LL;
