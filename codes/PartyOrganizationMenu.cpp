void __fastcall PartyOrganizationMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B629FF & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationMenu_TypeInfo, v2);
    byte_4B629FF = 1;
  }
  ...
  sub_1BE4A70(PartyOrganizationMenu_TypeInfo->static_fields);
}
...
void __fastcall PartyOrganizationMenu__ClearItem(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4D28(mainDeckBase, method);
  }
...
void __fastcall PartyOrganizationMenu__Close(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  PartyOrganizationMenu__Close_32920644(this, 0LL, v2);
}


void __fastcall PartyOrganizationMenu__Close_32920644(
        PartyOrganizationMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B629F6 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_PartyOrganizationMenu_EndClose__, v5);
    byte_4B629F6 = 1;
  }
...
void __fastcall PartyOrganizationMenu__EndOpen(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B629F5 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_PartyOrganizationMenu_EndOpenTutorialArrow__, v7);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v8);
    sub_1BE4ACC(&StringLiteral_13702/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, v9);
    byte_4B629F5 = 1;
  }
  if ( this->fields.mode == 4 )
  {
    ...
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_13702/*"TUTORIAL_MESSAGE_PARTY_ORGANIZATION4"*/, 0LL);
...
void __fastcall PartyOrganizationMenu__Init(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70(&this->fields.basePartyItem);
...
void __fastcall PartyOrganizationMenu__ModifyItem(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !partyOrganizationListViewManager )
    sub_1BE4D28(0LL, method);
  PartyOrganizationListViewManager__SetMode_32904880(partyOrganizationListViewManager, 9, v2);
}
...
void __fastcall PartyOrganizationMenu__OnClickCancel(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( !partyOrganizationListViewManager )
      sub_1BE4D28(0LL, method);
    PartyOrganizationListViewManager__SetMode_32904880(partyOrganizationListViewManager, 1, v2);
...
void __fastcall PartyOrganizationMenu__OnClickDecide(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&System_Action_TypeInfo, method);
    sub_1BE4ACC(&Method_PartyOrganizationMenu_EndCloseTutorialArrowDecide__, v4);
  ...
  if ( state == 7 )
  {
    if ( this->fields.mode == 4 )
    {
      ...
      if ( !Instance )
        goto LABEL_11;
      CommonUI__CloseTutorialNotificationDialogArrow_30899300((CommonUI_o *)Instance, v10, 0LL);
    }
  }
  else if ( state == 2 )
  {
...
LABEL_11:
    sub_1BE4D28(partyOrganizationListViewManager, method);
  }
}
...
void __fastcall PartyOrganizationMenu__OnClickInfomation(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B629F9 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_PartyOrganizationMenu_OnClickInfomation__, method);
    byte_4B629F9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickInfomation__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationMenu_OnClickInfomation__);
    ...
    if ( !partyOrganizationListViewManager )
      sub_1BE4D28(0LL, v5);
    PartyOrganizationListViewManager__SetMode_32904880(partyOrganizationListViewManager, 1, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B629FB & 1) == 0 )
  {
    sub_1BE4ACC(&PartyOrganizationListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1BE4ACC(&Method_PartyOrganizationMenu_OnClickItem__, v7);
...
LABEL_10:
          ...
          if ( partyItem )
          {
            PartyOrganizationListViewManager__SetMode_32904880((PartyOrganizationListViewManager_o *)partyItem, 1, v10);
            goto LABEL_12;
          }
          goto LABEL_41;
        }
        ...
        {
          partyItem = (PartyListViewItem_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38291E8 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
          if ( !partyItem )
            goto LABEL_41;
          if ( !PartyOrganizationUtility__ExistsTemporaryPartyInfo((PartyOrganizationUtility_o *)partyItem, 0LL) )
          {
            ...
            if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickItem__ + 83) & 2) != 0 )
              v20 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationMenu_OnClickItem__);
...
LABEL_16:
      partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
      v15 = (PartyOrganizationListViewManager_CallbackFunc_o *)sub_1BE4D18(PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
      ...
      if ( partyOrganizationListViewManager )
      {
        ...
        sub_1BE4A70(&partyOrganizationListViewManager->fields.callbackFunc);
        PartyOrganizationListViewManager__SetMode_32904880(partyOrganizationListViewManager, 2, v17);
        return;
      }
      goto LABEL_41;
    }
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickItem__ + 83) & 2) != 0 )
      v18 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationMenu_OnClickItem__);
...
LABEL_41:
    sub_1BE4D28(partyItem, *(_QWORD *)&result);
  }
}
...
void __fastcall PartyOrganizationMenu__OnClickPointEvent(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B629FA & 1) == 0 )
  {
    sub_1BE4ACC(&Method_PartyOrganizationMenu_OnClickPointEvent__, method);
    byte_4B629FA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickPointEvent__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationMenu_OnClickPointEvent__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
    this->fields.state = 3;
...
void __fastcall PartyOrganizationMenu__OnClickQuestInfo(PartyOrganizationMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B629FC & 1) == 0 )
  {
    sub_1BE4ACC(&Method_PartyOrganizationMenu_OnClickQuestInfo__, method);
    byte_4B629FC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PartyOrganizationMenu_OnClickQuestInfo__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_PartyOrganizationMenu_OnClickQuestInfo__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    partyOrganizationListViewManager = this->fields.partyOrganizationListViewManager;
    this->fields.state = 3;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B629F4 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&BalanceConfig_TypeInfo, v20);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v21);
    sub_1BE4ACC(&Method_PartyOrganizationMenu_EndOpen__, v22);
    sub_1BE4ACC(&Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__, v23);
    sub_1BE4ACC(&StringLiteral_19941/*"func_group_icon_1009_starting"*/, v24);
    sub_1BE4ACC(&StringLiteral_12415/*"STARTING_MEMBER_FRIENDSHIP_UP_TITLE"*/, v25);
    byte_4B629F4 = 1;
  }
  state = this->fields.state;
              ...
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  if ( gameObject )
                  {
                    ...
                    {
                      UnityEngine_GameObject__SetActive(gameObject, 1, 0LL);
                      gameObject = (UnityEngine_GameObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38291E8 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
                      if ( gameObject )
                      {
                        *(_QWORD *)&gameObject[3].fields.m_CachedPtr = partyItem;
                        sub_1BE4A70(&gameObject[3].fields);
                        ...
                        AtlasManager__SetEventUI(
                          ...
                          (System_String_o *)StringLiteral_19941/*"func_group_icon_1009_starting"*/,
                          0LL);
...
void __fastcall PartyOrganizationMenu__SetInput(PartyOrganizationMenu_o *this, bool isInput, const MethodInfo *method)
{
  ...
  if ( (byte_4B629F3 & 1) == 0 )
  {
    sub_1BE4ACC(&PartyOrganizationListViewManager_CallbackFunc_TypeInfo, isInput);
    this = (PartyOrganizationMenu_o *)sub_1BE4ACC(&Method_PartyOrganizationMenu_OnClickItem__, v5);
    byte_4B629F3 = 1;
  }
...
LABEL_9:
  ...
  v7 = (PartyOrganizationListViewManager_CallbackFunc_o *)sub_1BE4D18(PartyOrganizationListViewManager_CallbackFunc_TypeInfo);
  ...
  v9 = 2;
LABEL_8:
  PartyOrganizationListViewManager__SetMode_32904880(klass, v9, method);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4D28(partyListViewIndicator, *(_QWORD *)&friendBonusVal);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B629F7 & 1) == 0 )
  {
    sub_1BE4ACC(&AtlasManager_TypeInfo, isMove);
    sub_1BE4ACC(&BalanceConfig_TypeInfo, v5);
    sub_1BE4ACC(&CondType_TypeInfo, v6);
    sub_1BE4ACC(&System_Convert_TypeInfo, v7);
    sub_1BE4ACC(&FSUtility_TypeInfo, v8);
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v9);
    sub_1BE4ACC(&PartyOrganizationMenu_TypeInfo, v10);
    sub_1BE4ACC(&QuestInformationComponent_TypeInfo, v11);
    sub_1BE4ACC(&StringLiteral_17900/*"buttontxt_formation_20"*/, v12);
    byte_4B629F7 = 1;
  }
...
LABEL_71:
    sub_1BE4D28(partyRemoveButton, isMove);
  }
  questRestrictionInfo = this->fields.questRestrictionInfo;
  if ( questRestrictionInfo )
  {
...
LABEL_25:
  ...
  if ( (v20 & 1) != 0 )
  {
    ...
    partyRemoveButton = (UnityEngine_Component_o *)System_Convert__ToInt32_63321472(v16, 0LL);
    if ( !LAYOUT_POS_X_HINT )
      goto LABEL_71;
    if ( (unsigned int)partyRemoveButton >= LAYOUT_POS_X_HINT->max_length )
      sub_1BE4D30(partyRemoveButton, isMove);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B629F1 & 1) == 0 )
  {
    sub_1BE4ACC(&PartyOrganizationMenu_CallbackFunc_TypeInfo, value);
    byte_4B629F1 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (PartyOrganizationMenu_o *)sub_1BE4FE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A21364;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2130C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62A00 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationMenu_ResultKind_TypeInfo, v9);
    byte_4B62A00 = 1;
  }
  v14[2] = 0LL;
