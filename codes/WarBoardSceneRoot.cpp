        ...
        const MethodInfo *method)
{
  ...
  int32_t v10; // w2
  int32_t v11; // w3
  WarBoardDataEntity_o *v12; // x20

  v3 = data;
  if ( (byte_49FA422 & 1) == 0 )
  {
    sub_1B640C8(&Method_JsonManager_Deserialize_WarBoardDataEntity___, data);
    sub_1B640C8(&JsonManager_TypeInfo, v4);
    sub_1B640C8(&string_TypeInfo, v5);
    sub_1B640C8(&WarBoardDataEntity_TypeInfo, v6);
    byte_49FA422 = 1;
  }
  if ( v3 )
  {
      ...
      || (WarBoardDataEntity_c *)klass->_2.typeHierarchy[methodPtr_low - 1] != WarBoardDataEntity_TypeInfo )
    {
      if ( klass == string_TypeInfo )
      {
        ...
        v9 = JsonManager__Deserialize_object_(
               v3,
               (const MethodInfo_2E9ED70 *)Method_JsonManager_Deserialize_WarBoardDataEntity___);
        if ( !v9 )
          sub_1B64324(0LL);
        v12 = (WarBoardDataEntity_o *)v9;
        v9[9].monitor = v3;
        sub_1B6406C((ServantStatusBattleListViewItem_o *)&v9[9].monitor, (int32_t)v3, v10, v11);
        return v12;
      }
      else
      {
...
void __fastcall WarBoardSceneRoot__beginResume(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_49FA421 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_WarBoardSceneRoot__beginResume_b__3_0__, v7);
    byte_49FA421 = 1;
  }
  ...
  if ( (BYTE5(Instance[19].klass) & 1) == 0 )
    Instance = (Il2CppObject *)sub_1BB5FA4(Instance);
        ...
        const MethodInfo *method)
{
  ...
  int32_t v10; // w2
  int32_t v11; // w3
  WarBoardSceneRoot_o *v12; // x0
  const MethodInfo *v13; // x2
  WarBoardDataEntity_o *WarBoardDataEntity; // x0
  WarBoardDataEntity_o **v15; // x21
  int32_t v16; // w2
  int32_t v17; // w3
  __int64 v18; // x1
  __int64 v19; // x2
  WarBoardDataEntity_o *v20; // x22
  ...
  if ( (byte_49FA420 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_WarBoardSceneRoot___c__DisplayClass2_0__beginStartUp_b__0__, v6);
    sub_1B640C8(&WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo, v7);
    byte_49FA420 = 1;
  }
  v8 = sub_1B64314(WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo, data, method);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    goto LABEL_11;
  *(_QWORD *)(v8 + 24) = this;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v8 + 24), (int32_t)this, v10, v11);
  WarBoardDataEntity = WarBoardSceneRoot__GetWarBoardDataEntity(v12, data, v13);
  *(_QWORD *)(v8 + 16) = WarBoardDataEntity;
  v15 = (WarBoardDataEntity_o **)(v8 + 16);
  sub_1B6406C((ServantStatusBattleListViewItem_o *)(v8 + 16), (int32_t)WarBoardDataEntity, v16, v17);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    goto LABEL_11;
  CommonUI__SetConnect((CommonUI_o *)Instance, 1, 0LL);
  ...
  System_Action___ctor(v22, (Il2CppObject *)v8, Method_WarBoardSceneRoot___c__DisplayClass2_0__beginStartUp_b__0__, 0LL);
  if ( !manager )
LABEL_11:
    sub_1B64324(Instance);
  WarBoardManager__Initialize(manager, v20, v22, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, method);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)sub_1B640C8(
  ...
  this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
    goto LABEL_11;
  if ( progressType == 2 )
  {
    CommonUI__SetConnect((CommonUI_o *)this, 0, 0LL);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( this )
    {
