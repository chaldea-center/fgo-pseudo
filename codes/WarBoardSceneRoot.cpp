        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596E496 & 1) == 0 )
  {
    sub_2213A60(&Method_JsonManager_Deserialize_WarBoardDataEntity___);
    sub_2213A60(&JsonManager_TypeInfo);
    sub_2213A60(&WarBoardDataEntity_TypeInfo);
    byte_596E496 = 1;
  }
  if ( v3 )
  {
    ...
    {
      if ( klass == (Il2CppClass *)qword_5984390 )
      {
        if ( !*(&JsonManager_TypeInfo->_2.cctor_finished + 1) )
          j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo, data, method);
        v6 = JsonManager__Deserialize_object_(
               v3,
               (const MethodInfo_38D38E4 *)Method_JsonManager_Deserialize_WarBoardDataEntity___);
        if ( !v6 )
          sub_2213CDC(0, v7);
        v14 = (WarBoardDataEntity_o *)v6;
        v6[9].monitor = v3;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)&v6[9].monitor, (int32_t)v3, v8, v9, v10, v11, v12, v13);
        return v14;
      }
      else
      {
...
void WarBoardSceneRoot__beginResume(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_596E495 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_2213A60(&Method_WarBoardSceneRoot__beginResume_b__3_0__);
    byte_596E495 = 1;
  }
  ...
  if ( (*(_WORD *)((_BYTE *)&Instance[19].klass + 5) & 1) == 0 )
    Instance = (Il2CppObject *)sub_224B908(v10);
...
void WarBoardSceneRoot__beginStartUp(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_596E494 & 1) == 0 )
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_2213A60(&Method_WarBoardSceneRoot___c__DisplayClass2_0__beginStartUp_b__0__);
    sub_2213A60(&WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
    byte_596E494 = 1;
  }
  v5 = sub_2213CCC(WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 16) = WarBoardDataEntity;
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)(v5 + 16), (int32_t)WarBoardDataEntity, v18, v19, v20, v21, v22, v23);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    goto LABEL_11;
  CommonUI__SetConnect((CommonUI_o *)Instance, 1, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)sub_2213A60(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    byte_596E498 = 1;
  }
  ...
  this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( progressType == 2 )
  {
    if ( this )
    {
      CommonUI__SetConnect((CommonUI_o *)this, 0, 0);
      this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      if ( this )
      {
