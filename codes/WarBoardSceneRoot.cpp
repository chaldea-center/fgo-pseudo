        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB64B & 1) == 0 )
  {
    sub_1C2E12C(&Method_JsonManager_Deserialize_WarBoardDataEntity___, data);
    sub_1C2E12C(&JsonManager_TypeInfo, v4);
    sub_1C2E12C(&string_TypeInfo, v5);
    sub_1C2E12C(&WarBoardDataEntity_TypeInfo, v6);
    byte_4BFB64B = 1;
  }
  if ( v3 )
  {
      ...
      || (WarBoardDataEntity_c *)klass->_2.typeHierarchy[methodPtr_low - 1] != WarBoardDataEntity_TypeInfo )
    {
      if ( klass == string_TypeInfo )
      {
        ...
        v9 = JsonManager__Deserialize_object_(
               v3,
               (const MethodInfo_3039C8C *)Method_JsonManager_Deserialize_WarBoardDataEntity___);
        if ( !v9 )
          sub_1C2E388(0LL, v10);
        v17 = (WarBoardDataEntity_o *)v9;
        v9[9].monitor = v3;
        sub_1C2E0D0((PartyOrganizationUtility_o *)&v9[9].monitor, (int64_t)v3, v11, v12, v13, v14, v15, v16);
        return v17;
      }
      else
      {
...
void __fastcall WarBoardSceneRoot__beginResume(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_4BFB64A & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_SingletonMonoBehaviour_WarBoardManager__getInstance__, v6);
    sub_1C2E12C(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    sub_1C2E12C(&Method_WarBoardSceneRoot__beginResume_b__3_0__, v8);
    byte_4BFB64A = 1;
  }
  ...
  if ( (BYTE5(Instance[19].klass) & 1) == 0 )
    Instance = (Il2CppObject *)sub_1C80008(v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB649 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_WarBoardSceneRoot___c__DisplayClass2_0__beginStartUp_b__0__, v6);
    sub_1C2E12C(&WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo, v7);
    byte_4BFB649 = 1;
  }
  v8 = sub_1C2E378(WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 16) = WarBoardDataEntity;
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v8 + 16), (int64_t)WarBoardDataEntity, v21, v22, v23, v24, v25, v26);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    goto LABEL_11;
  CommonUI__SetConnect((CommonUI_o *)Instance, 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, method);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)sub_1C2E12C(
  ...
  this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
    goto LABEL_11;
  if ( progressType == 2 )
  {
    CommonUI__SetConnect((CommonUI_o *)this, 0, 0LL);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( this )
    {
