        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B428B5 & 1) == 0 )
  {
    sub_1BDB878(&Method_JsonManager_Deserialize_WarBoardDataEntity___, data);
    sub_1BDB878(&JsonManager_TypeInfo, v4);
    sub_1BDB878(&string_TypeInfo, v5);
    sub_1BDB878(&WarBoardDataEntity_TypeInfo, v6);
    byte_4B428B5 = 1;
  }
  if ( v3 )
  {
      ...
      || (WarBoardDataEntity_c *)klass->_2.typeHierarchy[methodPtr_low - 1] != WarBoardDataEntity_TypeInfo )
    {
      if ( klass == string_TypeInfo )
      {
        ...
        v9 = JsonManager__Deserialize_object_(
               v3,
               (const MethodInfo_30A0354 *)Method_JsonManager_Deserialize_WarBoardDataEntity___);
        if ( !v9 )
          sub_1BDBAD4(0LL, v10);
        v13 = (WarBoardDataEntity_o *)v9;
        v9[9].monitor = v3;
        sub_1BDB81C((CGThumbnailListItem_o *)&v9[9].monitor, (int32_t)v3, v11, v12);
        return v13;
      }
      else
      {
...
void __fastcall WarBoardSceneRoot__beginResume(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_4B428B4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_WarBoardSceneRoot__beginResume_b__3_0__, v8);
    byte_4B428B4 = 1;
  }
  ...
  if ( (BYTE5(Instance[19].klass) & 1) == 0 )
    Instance = (Il2CppObject *)sub_1C2BF08(v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B428B3 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_WarBoardSceneRoot___c__DisplayClass2_0__beginStartUp_b__0__, v6);
    sub_1BDB878(&WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo, v7);
    byte_4B428B3 = 1;
  }
  v8 = sub_1BDBAC4(WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v8 + 16) = WarBoardDataEntity;
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)(v8 + 16), (int32_t)WarBoardDataEntity, v17, v18);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    goto LABEL_11;
  CommonUI__SetConnect((CommonUI_o *)Instance, 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, method);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)sub_1BDB878(
  ...
  this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
    goto LABEL_11;
  if ( progressType == 2 )
  {
    CommonUI__SetConnect((CommonUI_o *)this, 0, 0LL);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( this )
    {
