        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B21EA & 1) == 0 )
  {
    sub_B52984(&Method_JsonManager_Deserialize_WarBoardDataEntity___);
    sub_B52984(&JsonManager_TypeInfo);
    sub_B52984(&string_TypeInfo);
    sub_B52984(&WarBoardDataEntity_TypeInfo);
    byte_42B21EA = 1;
  }
  if ( data )
  {
      ...
      || (WarBoardDataEntity_c *)klass->_2.typeHierarchy[v5 - 1] != WarBoardDataEntity_TypeInfo )
    {
      if ( klass == string_TypeInfo )
      {
        ...
        v6 = JsonManager__Deserialize_TerminalPramsManager_ClearData_(
               data,
               (const MethodInfo_1F69038 *)Method_JsonManager_Deserialize_WarBoardDataEntity___);
        if ( !v6 )
          sub_B52A5C(0LL, v7);
...
void __fastcall WarBoardSceneRoot__beginResume(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_42B21E9 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_B52984(&Method_WarBoardSceneRoot__beginResume_b__3_0__);
    byte_42B21E9 = 1;
  }
  ...
  if ( (*(_BYTE *)(v9 + 306) & 1) == 0 )
    Instance = (WebViewManager_o *)sub_AEB684(*((_QWORD *)Method_SingletonMonoBehaviour_WarBoardManager__getInstance__
                                              + 3));
  v10 = **(_QWORD **)(v9 + 192);
  if ( (*(_BYTE *)(v10 + 306) & 1) == 0 )
    Instance = (WebViewManager_o *)sub_AEB684(v10);
  v11 = **(_QWORD **)(v10 + 184);
  if ( !v11 )
    goto LABEL_26;
  if ( *(_BYTE *)(v11 + 840) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B21E8 & 1) == 0 )
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_B52984(&Method_WarBoardSceneRoot___c__DisplayClass2_0__beginStartUp_b__0__);
    sub_B52984(&WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
    byte_42B21E8 = 1;
  }
  v5 = sub_B52A54(WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 16) = WarBoardDataEntity;
  sub_B52920((BattleServantConfConponent_o *)(v5 + 16), WarBoardDataEntity, v18, v19, v20, v21, v22, v23);
  Instance = (CommonUI_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)sub_B52984(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_42AD74E = 1;
  }
  ...
  this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
    goto LABEL_11;
  if ( progressType == 2 )
  {
    CommonUI__SetConnect((CommonUI_o *)this, 0, 0LL);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( this )
    {
