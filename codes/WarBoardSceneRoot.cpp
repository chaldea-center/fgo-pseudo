        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A58C & 1) == 0 )
  {
    sub_1C94098(&Method_JsonManager_Deserialize_WarBoardDataEntity___);
    sub_1C94098(&JsonManager_TypeInfo);
    sub_1C94098(&string_TypeInfo);
    sub_1C94098(&WarBoardDataEntity_TypeInfo);
    byte_4D2A58C = 1;
  }
  if ( data )
  {
      ...
      || (WarBoardDataEntity_c *)klass->_2.typeHierarchy[naturalAligment - 1] != WarBoardDataEntity_TypeInfo )
    {
      if ( klass == string_TypeInfo )
      {
        ...
        v6 = JsonManager__Deserialize_object_(
               data,
               (const MethodInfo_320C52C *)Method_JsonManager_Deserialize_WarBoardDataEntity___);
        if ( !v6 )
          sub_1C942F0(0, v7);
        v14 = (WarBoardDataEntity_o *)v6;
        v6[9].monitor = data;
        sub_1C9403C((GrandQuestFolderBoardItem_o *)&v6[9].monitor, (int32_t)data, v8, v9, v10, v11, v12, v13);
        return v14;
      }
      else
      {
...
void WarBoardSceneRoot__beginResume(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A58B & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C94098(&Method_WarBoardSceneRoot__beginResume_b__3_0__);
    byte_4D2A58B = 1;
  }
  ...
  if ( (BYTE5(Instance[19].klass) & 1) == 0 )
    Instance = (Il2CppObject *)sub_1C6A12C(v10);
...
void WarBoardSceneRoot__beginStartUp(WarBoardSceneRoot_o *this, Il2CppObject *data, const MethodInfo *method)
{
  ...
  if ( (byte_4D2A58A & 1) == 0 )
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C94098(&Method_WarBoardSceneRoot___c__DisplayClass2_0__beginStartUp_b__0__);
    sub_1C94098(&WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
    byte_4D2A58A = 1;
  }
  v5 = sub_1C942E4(WarBoardSceneRoot___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 16) = WarBoardDataEntity;
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)(v5 + 16), (int32_t)WarBoardDataEntity, v18, v19, v20, v21, v22, v23);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    goto LABEL_11;
  CommonUI__SetConnect((CommonUI_o *)Instance, 1, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)sub_1C94098(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    byte_4D2A58E = 1;
  }
  ...
  this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !this )
    goto LABEL_11;
  if ( progressType == 2 )
  {
    CommonUI__SetConnect((CommonUI_o *)this, 0, 0);
    this = (WarBoardSceneRoot___c__DisplayClass2_0_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
    if ( this )
    {
