void __fastcall WeightRate___Il2CppFullySharedGenericType____ctor(
        ...
        const MethodInfo_388FC98 *method)
{
...
void __fastcall WeightRate___Il2CppFullySharedGenericType___ReverseWeight(
        WeightRate_T__o *this,
        const MethodInfo_388F908 *method)
{
  ...
  v5 = sub_1B64ABC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
...
LABEL_32:
  ...
  if ( (*(_BYTE *)(_31_WeightRate___c_T___ReverseWeight_b__11_0 + 309) & 1) == 0 )
    _31_WeightRate___c_T___ReverseWeight_b__11_0 = sub_1BB674C(_31_WeightRate___c_T___ReverseWeight_b__11_0);
  ...
  v10 = (__int64)(*p_klass)->rgctx_data->_31_WeightRate___c_T___ReverseWeight_b__11_0;
  ...
  if ( !v11 )
  {
    ...
    v14 = (__int64)rgctx_data->_31_WeightRate___c_T___ReverseWeight_b__11_0;
    ...
    v11 = sub_1B64ABC(_30_WeightRate___c_T);
    ...
    v20 = (__int64)v19->_31_WeightRate___c_T___ReverseWeight_b__11_0;
    ...
    *(_QWORD *)(*(_QWORD *)(v20 + 184) + 8LL) = v11;
    v21 = (__int64)v19->_31_WeightRate___c_T___ReverseWeight_b__11_0;
    if ( (*(_BYTE *)(v21 + 309) & 1) == 0 )
      v21 = sub_1BB674C(v21);
    sub_1B64814((ServantStatusBattleListViewItem_o *)(*(_QWORD *)(v21 + 184) + 8LL), v11, v17, v18);
  }
  ((void (__fastcall *)(__int64, __int64, long double))(*p_klass)->rgctx_data[1]._0_WeightRate_T_->_1.image)(
    v5,
    v11,
    inited);
  if ( ((__int64 (__fastcall *)(__int64))(*p_klass)->rgctx_data->_20_System_Collections_Generic_List_WeightRate_WeightSeed_T___get_Item->methodPointer)(v5) >= 1 )
  {
    v22 = 0;
    v23 = -1;
    do
    {
      v24 = ((__int64 (__fastcall *)(__int64))(*p_klass)->rgctx_data->_20_System_Collections_Generic_List_WeightRate_WeightSeed_T___get_Item->methodPointer)(v5)
          + v23;
      if ( v22 >= v24 )
        break;
      ...
      _21_System_Activator_CreateInstance_T->invoker_method(
        ...
        (void **)&v35,
        &v36);
      v27 = *(_DWORD *)sub_1B64894(v36, (*p_klass)->rgctx_data->_4_WeightRate_WeightSeed_T_->_1.fields);
      v28 = (*p_klass)->rgctx_data->_21_System_Activator_CreateInstance_T_;
      v29 = v28->methodPointer;
      v37 = v22;
      v35 = &v37;
      v28->invoker_method(v29, v28, (void *)v5, (void **)&v35, &v36);
      v30 = (__int64)v36;
      v31 = (*p_klass)->rgctx_data->_21_System_Activator_CreateInstance_T_;
      v32 = v31->methodPointer;
      v37 = v24;
      v35 = &v37;
      v31->invoker_method(v32, v31, (void *)v5, (void **)&v35, &v36);
      list = (struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *)sub_1B64894(
                                                                                     v36,
                                                                                     (*p_klass)->rgctx_data->_4_WeightRate_WeightSeed_T_->_1.fields);
      if ( !v30 )
        goto LABEL_32;
      sub_19B6DC8(v30, (*p_klass)->rgctx_data->_4_WeightRate_WeightSeed_T_->_1.fields, LODWORD(list->klass));
      ...
      if ( !v36 )
        goto LABEL_32;
      sub_19B6DC8(v36, (*p_klass)->rgctx_data->_4_WeightRate_WeightSeed_T_->_1.fields, v27);
      ++v22;
      --v23;
    }
    while ( v22 < ((__int64 (__fastcall *)(__int64))(*p_klass)->rgctx_data->_20_System_Collections_Generic_List_WeightRate_WeightSeed_T___get_Item->methodPointer)(v5) );
  }
}
...
void __fastcall WeightRate___Il2CppFullySharedGenericType___SetAdjust(
        WeightRate_T__o *this,
        const MethodInfo_388EFE0 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
  int32_t v5; // w22
  int v6; // w23
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( v10 )
      {
        list = (struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *)sub_19B6DC8(
                                                                                       v10,
                                                                                       method->klass->rgctx_data->_4_WeightRate_WeightSeed_T_->_1.fields,
        ...
        if ( v11 )
        {
          ...
          v14 = *(_DWORD *)sub_1B64894(v16, method->klass->rgctx_data->_4_WeightRate_WeightSeed_T_->_1.fields);
          list = this->fields.list;
          ++v6;
          v5 += v14;
          if ( list )
...
bool __fastcall WeightRate___Il2CppFullySharedGenericType___checkWeight(
        WeightRate_T__o *this,
        const MethodInfo_388EFB0 *method)
{
...
int32_t __fastcall WeightRate___Il2CppFullySharedGenericType___getCount(
        WeightRate_T__o *this,
        const MethodInfo_388EFC0 *method)
{
  struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *list; // x0
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall WeightRate___Il2CppFullySharedGenericType___getData(
        WeightRate_T__o *this,
        int32_t keywieght,
        const MethodInfo_388F118 *method)
{
  __int64 v3; // x3
  __int64 v4; // x22
  __int64 v8; // x28
  ...
  while ( 1 )
  {
    ...
    (*(void (__fastcall **)(_QWORD, __int64, System_Collections_Generic_List_Enumerator_T__o *, _QWORD, __int64 *))(v20 + 16))(
      *(_QWORD *)v20,
      ...
      v30);
    v21 = v30[0];
    totalweight -= *(_DWORD *)sub_1B64894(
                                v30[0],
    ...
    if ( totalweight <= keywieght )
      break;
    v23 = (const void *)sub_1B64894(v21, v22);
    memcpy(v10, v23, v9);
    memcpy(v10, v10, v9);
  }
  v25 = (const void *)sub_1B64894(v21, v22);
  memcpy(v10, v25, v9);
  memcpy(v10, v10, v9);
  v24 = 5;
LABEL_8:
  System_Collections_Generic_List_Enumerator___Il2CppFullySharedGenericType___Dispose(
    &v29,
    *(const MethodInfo_3237274 **)(*(_QWORD *)(*(_QWORD *)(v4 + 32) + 192LL) + 144LL));
  if ( v24 == 5 )
...
// local variable allocation has failed, the output may be wrong!
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o __fastcall WeightRate___Il2CppFullySharedGenericType___getData_59307004(
        WeightRate_T__o *this,
        int32_t keyWeight,
        Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o skipValue,
        const MethodInfo_388F3FC *method)
{
  ...
  __int64 v53[2]; // [xsp+80h] [xbp-10h] BYREF
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o result; // 0:x0.16
  ...
  v9 = (char *)&v42 - ((native_size + 15) & 0x1FFFFFFF0LL);
  ...
  v15 = sub_1B64ABC(_1_System_Collections_Generic_List_WeightRate_WeightSeed_T);
  v16 = ((__int64 (__fastcall *)(__int64, struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *))method->klass->rgctx_data->_23_System_Collections_Generic_IEnumerable_WeightRate_WeightSeed_T__->_1.image)(
          v15,
          list);
  if ( !v15 )
    sub_1B64ACC(v16, v17);
  ...
  while ( 1 )
  {
    ...
    memcpy(v9, v26, native_size);
    v27 = (Il2CppObject *)j_il2cpp_value_box_0(v24->rgctx_data->_3_T, v9);
    if ( System_Object__Equals_62528260(v25, v27, 0LL) )
    {
      ...
      v29 = _25_System_Collections_Generic_List_WeightRate_WeightSeed_T___ToArray->methodPointer;
      v53[0] = v21;
  ...
  System_Collections_Generic_List_Enumerator___Il2CppFullySharedGenericType___Dispose(
    &v50,
    (const MethodInfo_3237274 *)method->klass->rgctx_data->_19_System_Collections_Generic_List_WeightRate_WeightSeed_T___get_Count);
  ...
  while ( 1 )
  {
    ...
    v34->invoker_method(v34->methodPointer, v34, &v50, 0LL, &v49);
    ...
    if ( totalweight <= v31 )
      break;
    v37 = (const void *)sub_1B64894(v35, v36);
    memcpy(v9, v37, native_size);
    memcpy(v30, v9, native_size);
  }
  v39 = (const void *)sub_1B64894(v35, v36);
  memcpy(v9, v39, native_size);
  memcpy(v43, v9, native_size);
  v38 = 8;
LABEL_17:
  System_Collections_Generic_List_Enumerator___Il2CppFullySharedGenericType___Dispose(
    &v50,
  ...
  if ( v38 == 8 )
    v30 = v43;
  memcpy(v9, v30, native_size);
  v40 = (Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_c *)memcpy(monitor, v9, native_size);
  result.monitor = v41;
  result.klass = v40;
  return result;
}
...
int32_t __fastcall WeightRate___Il2CppFullySharedGenericType___getTotalWeight(
        WeightRate_T__o *this,
        const MethodInfo_388EFA8 *method)
{
...
void __fastcall WeightRate___Il2CppFullySharedGenericType___removeWeight(
        ...
        const MethodInfo_388ED28 *method)
{
  _QWORD *monitor; // x19
  ...
  __int64 v27[2]; // [xsp+20h] [xbp-10h] BYREF

  monitor = t.monitor;
  klass = t.klass;
  v27[1] = *(_QWORD *)(_ReadStatusReg(ARM64_SYSREG(3, 3, 13, 0, 2)) + 40);
...
LABEL_15:
  ...
  for ( i = 0;
        ;
        i += *(_DWORD *)sub_1B64894(v27[0], *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(monitor[4] + 192LL) + 32LL) + 128LL)) )
  {
    ...
    (*(void (__fastcall **)(_QWORD, __int64, System_Collections_Generic_List_Enumerator_T__o *, _QWORD, __int64 *))(v24 + 16))(
      *(_QWORD *)v24,
      v24,
      &v25,
      0LL,
  ...
  System_Collections_Generic_List_Enumerator___Il2CppFullySharedGenericType___Dispose(
    &v25,
    *(const MethodInfo_3237274 **)(*(_QWORD *)(monitor[4] + 192LL) + 144LL));
...
void __fastcall WeightRate___Il2CppFullySharedGenericType___setWeight(
        ...
        int32_t weight,
        Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_o t,
        const MethodInfo_388EB78 *method)
{
  _QWORD *monitor; // x19
  ...
  __int64 v32[2]; // [xsp+10h] [xbp-20h] BYREF
  ...
  else
  {
    ...
    sub_1B64814(p_fields, v16, v17, v18);
    v7 = monitor[4];
  ...
  v32[0] = (__int64)&v33;
  v32[1] = (__int64)v11;
  v26 = ((__int64 (__fastcall *)(__int64, __int64 *, __int64, __int64 *, _QWORD *))v23[2])(v25, v23, v21, v32, v11);
  if ( !list )
    sub_1B64ACC(v26, v27);
  v28 = *(__int64 **)(*(_QWORD *)(monitor[4] + 192LL) + 48LL);
  v29 = *v28;
  v32[0] = v21;
  ((void (__fastcall *)(__int64, __int64 *, struct System_Collections_Generic_List_WeightRate_WeightSeed_T___o *, __int64 *, __int64))v28[2])(
    v29,
    v28,
    list,
    v32,
