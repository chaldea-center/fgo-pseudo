...
void EventInfoRepairDialog__OnClose(EventInfoRepairDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC89B2 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_EventInfoRepairDialog_OnClose__);
    sub_1C713B0(&Method_EventInfoRepairDialog__OnClose_b__7_0__);
  ...
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoRepairDialog_OnClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C713C8(Method_EventInfoRepairDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_EventInfoRepairDialog__Open_b__6_0__);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CC89B1 = 1;
  }
