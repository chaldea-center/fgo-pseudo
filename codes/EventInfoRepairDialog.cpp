...
void EventInfoRepairDialog__OnClose(EventInfoRepairDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E79397 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventInfoRepairDialog_OnClose__);
    sub_1D0F0B4(&Method_EventInfoRepairDialog__OnClose_b__7_0__);
  ...
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoRepairDialog_OnClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1D0F0CC(Method_EventInfoRepairDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v14; // x1
  float v15; // s8
  EventInfoEquipSkillPartsListComponent_o *v16; // x0
  struct EventInfoEquipSkillPartsListComponent_o *v17; // x8
  ...
  {
    sub_1D0F0B4(&System_Action_TypeInfo);
    sub_1D0F0B4(&Method_EventInfoRepairDialog__Open_b__6_0__);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E79396 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(eventInfoEquipSkillPartsListComponent, 0, 0) )
  {
    ...
    if ( !v16 )
      goto LABEL_29;
    EventInfoEquipSkillPartsListComponent__Setup(v16, eventId, 0);
    v17 = this->fields.eventInfoEquipSkillPartsListComponent;
    if ( !v17 )
      goto LABEL_29;
    v15 = v17->fields._Height_k__BackingField + 0.0;
  }
  ...
  {
    ComponentHelper__SetLocalPositionY((UnityEngine_Component_o *)this->fields.eventInfoAssistListComponent, -v15, 0);
    v16 = (EventInfoEquipSkillPartsListComponent_o *)this->fields.eventInfoAssistListComponent;
    if ( !v16 )
      goto LABEL_29;
    EventInfoAssistListComponent__Setup((EventInfoAssistListComponent_o *)v16, 0);
  }
  scrollView = (UnityEngine_Object_o *)this->fields.scrollView;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  v16 = (EventInfoEquipSkillPartsListComponent_o *)UnityEngine_Object__op_Inequality(scrollView, 0, 0);
  if ( ((unsigned __int8)v16 & 1) != 0 )
  {
    ...
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    v16 = (EventInfoEquipSkillPartsListComponent_o *)UnityEngine_Object__op_Inequality(verticalScrollBar, 0, 0);
    if ( ((unsigned __int8)v16 & 1) != 0 )
    {
      v22 = this->fields.scrollView;
      if ( v22 )
      {
        v16 = (EventInfoEquipSkillPartsListComponent_o *)v22->fields.verticalScrollBar;
        if ( v16 )
        {
          UIProgressBar__set_value((UIProgressBar_o *)v16, 0.0, 0);
          return;
        }
      }
LABEL_29:
