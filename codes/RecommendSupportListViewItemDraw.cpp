        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A225 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_19573/*"formation_select_small"*/, v5);
    sub_1B761C0(&StringLiteral_11009/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_SELECT_BUTTON"*/, v6);
    sub_1B761C0(&StringLiteral_19547/*"formation_blank_Landscape_select"*/, v7);
    sub_1B761C0(&StringLiteral_19546/*"formation_blank_Landscape"*/, v8);
    sub_1B761C0(&StringLiteral_11015/*"RECOMMEND_SUPPORT_QUEST_SELECT_BUTTON"*/, v9);
    byte_4A2A225 = 1;
  }
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11009/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_SELECT_BUTTON"*/, 0LL);
  if ( !messageSelectButtonLabel
    || (UILabel__set_text(messageSelectButtonLabel, (System_String_o *)gameObject, 0LL),
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11015/*"RECOMMEND_SUPPORT_QUEST_SELECT_BUTTON"*/, 0LL),
...
LABEL_11:
  ...
  AtlasManager__SetPartyOrganizationImage(unSelectedServantSprite, (System_String_o *)StringLiteral_19573/*"formation_select_small"*/, 0LL);
  AtlasManager__SetPartyOrganizationImage(this->fields.emptyBoardSprite, (System_String_o *)StringLiteral_19546/*"formation_blank_Landscape"*/, 0LL);
  AtlasManager__SetPartyOrganizationImage(
    this->fields.emptyBoardSelectSprite,
    (System_String_o *)StringLiteral_19547/*"formation_blank_Landscape_select"*/,
    0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A226 & 1) == 0 )
  {
    sub_1B761C0(&AtlasManager_TypeInfo, deckData);
    sub_1B761C0(&StringLiteral_19573/*"formation_select_small"*/, v5);
    byte_4A2A226 = 1;
  }
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  v7 = AtlasManager__SetPartyOrganizationImage(unSelectedServantSprite, (System_String_o *)StringLiteral_19573/*"formation_select_small"*/, 0LL);
  if ( !deckData )
    sub_1B7641C(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A228 & 1) == 0 )
  {
    sub_1B761C0(&LocalizationManager_TypeInfo, entity);
    sub_1B761C0(&StringLiteral_11035/*"RECOMMEND_SUPPORT_SERVANT_NAME_NO_SELECT"*/, v5);
    byte_4A2A228 = 1;
  }
  ...
  else
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SvtName = LocalizationManager__Get((System_String_o *)StringLiteral_11035/*"RECOMMEND_SUPPORT_SERVANT_NAME_NO_SELECT"*/, 0LL);
  }
  if ( !servantNameLabel )
    sub_1B7641C(SvtName, SvtName);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B7641C(emptyObject, isEmpty);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A227 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_UserServantMaster___, userSvtId);
    ...
    sub_1B761C0(&IconLabelInfo_TypeInfo, v9);
  ...
  Master_object = (System_Int64_array *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_UserServantMaster___);
  if ( !Master_object )
    goto LABEL_24;
         ...
         (const MethodInfo_30FF980 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
  {
    ...
    if ( entity )
    {
      ...
      if ( v13 )
      {
        IconLabelInfo__Set_37960168(v13, 2, klass, (int32_t)Master_object, 0, 0, 0, 0, 0LL);
        servantFaceIcon = this->fields.servantFaceIcon;
        v16 = entity;
        Master_object = (System_Int64_array *)sub_1B76268(long___TypeInfo, 1LL);
        if ( Master_object )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A22A & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_RecommendAdviceMessageMaster___, ids);
    sub_1B761C0(&DataManager_TypeInfo, v5);
    sub_1B761C0(&LocalizationManager_TypeInfo, v6);
    sub_1B761C0(&StringLiteral_11010/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_SEPARATOR"*/, v7);
    sub_1B761C0(&StringLiteral_11001/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_CHANGE_NO_INPUT"*/, v8);
    byte_4A2A22A = 1;
  }
...
LABEL_5:
      Master_object = (RecommendAdviceMessageMaster_o *)LocalizationManager__Get(
                                                          (System_String_o *)StringLiteral_11001/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_CHANGE_NO_INPUT"*/,
                                                          0LL);
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_11010/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_SEPARATOR"*/, 0LL);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (RecommendAdviceMessageMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_RecommendAdviceMessageMaster___);
  if ( !Master_object
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A229 & 1) == 0 )
  {
    sub_1B761C0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo, entity);
    byte_4A2A229 = 1;
  }
...
LABEL_11:
  ...
  *(_OWORD *)&v11.fields.fakeValue = v8;
  ...
  v10 = v11;
  pushSprite = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46340496(
                                            &v10,
                                            0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A22B & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMaster_RecommendSupportQuestMaster___, v6);
    sub_1B761C0(&Method_DataManager_GetMaster_SpotMaster___, v7);
    sub_1B761C0(&Method_DataManager_GetMaster_WarMaster___, v8);
    sub_1B761C0(&DataManager_TypeInfo, v9);
    sub_1B761C0(&Method_DataMasterBase_SpotMaster__SpotEntity__int__TryGetEntity__, v10);
    sub_1B761C0(&Method_DataMasterBase_QuestMaster__QuestEntity__int__TryGetEntity__, v11);
    sub_1B761C0(&Method_DataMasterBase_WarMaster__WarEntity__int__TryGetEntity__, v12);
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_string__get_Item__, v15);
    sub_1B761C0(&Method_System_Collections_Generic_List_string__set_Item__, v16);
    ...
    sub_1B761C0(&StringLiteral_11028/*"RECOMMEND_SUPPORT_QUEST_SEPARATOR"*/, v20);
    sub_1B761C0(&StringLiteral_11014/*"RECOMMEND_SUPPORT_QUEST_CHANGE_NO_INPUT"*/, v21);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_QuestMaster___);
  if ( !Master_object )
    goto LABEL_60;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_SpotMaster___);
         ...
         (const MethodInfo_30FF7D4 *)Method_DataMasterBase_WarMaster__WarEntity__int__TryGetEntity__) )
  {
    ...
    if ( (questPhasea & 0x80000000) == 0 )
    {
      ...
      v44 = (Il2CppObject *)System_String__Concat_61535060((System_String_o *)Item, v43, 0LL);
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_RecommendSupportQuestMaster___);
    if ( !Master_object )
      goto LABEL_60;
    ...
    if ( ((unsigned __int8)Master_object & 1) != 0 )
    {
      ...
      if ( !Master_object )
        goto LABEL_60;
      v54 = System_String__Replace_61554688(
              (System_String_o *)Master_object,
              (System_String_o *)StringLiteral_43/*"\n"*/,
              (System_String_o *)StringLiteral_1/*""*/,
              0LL);
      Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat_61535060(
                                                                      (System_String_o *)StringLiteral_43/*"\n"*/,
                                                                      v54,
                                                                      0LL);
      ...
      else
      {
        ...
        sub_1B76164((ServantStatusBattleListViewItem_o *)(v61 + 4), (int32_t)v60, v55, v56);
      }
    }
    else
    {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v63 = LocalizationManager__Get((System_String_o *)StringLiteral_11028/*"RECOMMEND_SUPPORT_QUEST_SEPARATOR"*/, 0LL);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Join_61550716(
                                                                    v63,
...
LABEL_22:
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_11014/*"RECOMMEND_SUPPORT_QUEST_CHANGE_NO_INPUT"*/,
                                                                    0LL);
    if ( !v34 )
      goto LABEL_60;
  }
...
LABEL_12:
    sub_1B7641C(servantFaceIcon, isMount);
  }
