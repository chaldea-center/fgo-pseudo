...
void RecommendSupportListViewItemDraw__Init(RecommendSupportListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596C50C & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_RecommendSupportListViewItemDraw___c__Init_b__27_0__);
    sub_2213A60(&RecommendSupportListViewItemDraw___c_TypeInfo);
    sub_2213A60(&StringLiteral_20544/*"formation_select_small"*/);
    sub_2213A60(&StringLiteral_11512/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_SELECT_BUTTON"*/);
    sub_2213A60(&StringLiteral_20499/*"formation_blank_Landscape_select"*/);
    sub_2213A60(&StringLiteral_20498/*"formation_blank_Landscape"*/);
    sub_2213A60(&StringLiteral_11520/*"RECOMMEND_SUPPORT_QUEST_SELECT_BUTTON"*/);
    byte_596C50C = 1;
  }
  ...
  *(_QWORD *)&this->fields.savedQuestId = -1;
  if ( downloadAtlasSprites )
  {
    ...
    if ( !_9__27_0 )
    {
      ...
      _9__27_0 = (System_Action_object__o *)sub_2213CCC(System_Action_UISprite__TypeInfo);
      ...
      sub_2213A04((MissionNaviTransitionBoardItem_o *)&v9->__9__27_0, (int32_t)_9__27_0, v10, v11, v12, v13, v14, v15);
    }
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11512/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_SELECT_BUTTON"*/, 0);
  if ( !messageSelectButtonLabel
    || (UILabel__set_text(messageSelectButtonLabel, (System_String_o *)gameObject, 0),
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11520/*"RECOMMEND_SUPPORT_QUEST_SELECT_BUTTON"*/, 0),
...
LABEL_19:
  ...
  AtlasManager__SetPartyOrganizationImage(unSelectedServantSprite, (System_String_o *)StringLiteral_20544/*"formation_select_small"*/, 0);
  AtlasManager__SetPartyOrganizationImage(this->fields.emptyBoardSprite, (System_String_o *)StringLiteral_20498/*"formation_blank_Landscape"*/, 0);
  AtlasManager__SetPartyOrganizationImage(
    this->fields.emptyBoardSelectSprite,
    (System_String_o *)StringLiteral_20499/*"formation_blank_Landscape_select"*/,
    0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596C514 & 1) == 0 )
  {
    sub_2213A60(&AtlasManager_TypeInfo);
    sub_2213A60(&StringLiteral_20544/*"formation_select_small"*/);
    sub_2213A60(&StringLiteral_20541/*"formation_grand_select_small"*/);
    byte_596C514 = 1;
  }
  unSelectedServantSprite = this->fields.unSelectedServantSprite;
  v6 = StringLiteral_20541/*"formation_grand_select_small"*/;
  v7 = StringLiteral_20544/*"formation_select_small"*/;
  if ( !*(&AtlasManager_TypeInfo->_2.cctor_finished + 1) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596C50D & 1) == 0 )
  {
    this = (RecommendSupportListViewItemDraw_o *)sub_2213A60(&Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    byte_596C50D = 1;
  }
  if ( !deckData )
    goto LABEL_13;
  ...
  if ( questId != v4->fields.savedQuestId || questPhase != v4->fields.savedQuestPhase )
  {
    ...
    this = (RecommendSupportListViewItemDraw_o *)SingletonTemplate_object___get_Instance((const MethodInfo_47A2F30 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
    if ( this )
    {
      IsSupportGrandEnableQuest = PartyOrganizationUtility__IsSupportGrandEnableQuest(
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&LocalizationManager_TypeInfo);
    sub_2213A60(&StringLiteral_11543/*"RECOMMEND_SUPPORT_SERVANT_NAME_NO_SELECT"*/);
    byte_596C510 = 1;
  }
  ...
  else
  {
    ...
    SvtName = LocalizationManager__Get((System_String_o *)StringLiteral_11543/*"RECOMMEND_SUPPORT_SERVANT_NAME_NO_SELECT"*/, 0);
  }
  if ( !servantNameLabel )
    sub_2213CDC(SvtName, SvtName);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213CDC(emptyObject, isEmpty);
  }
        ...
        const MethodInfo *method)
{
         ...
         (const MethodInfo_3F131DC *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__) )
  {
    ...
    if ( entity )
    {
      ...
      if ( v13 )
      {
        IconLabelInfo__Set_47880948(v13, 2, klass, Master_object, 0, 0, 0, 0, 0, 0);
        servantFaceIcon = this->fields.servantFaceIcon;
        v16 = entity;
        Master_object = sub_2213B20(long___TypeInfo, 1);
        if ( Master_object )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( IsNullOrEmpty )
  {
    ...
    Master_object = (RecommendAdviceMessageMaster_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_11504/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_CHANGE_NO_INPUT"*/,
                                                        0);
  ...
  else
  {
    if ( !v9 )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, v5, v6);
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_11513/*"RECOMMEND_SUPPORT_ADVICE_MESSAGE_SEPARATOR"*/, 0);
    if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v12, v13);
    Master_object = (RecommendAdviceMessageMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_RecommendAdviceMessageMaster___);
    if ( !Master_object
...
LABEL_11:
  ...
  *(_OWORD *)&v12.fields.fakeValue = v9;
  ...
  v11 = v12;
  pushSprite = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_56000612(&v11, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596C513 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_11536/*"RECOMMEND_SUPPORT_QUEST_SEPARATOR"*/);
    sub_2213A60(&StringLiteral_11518/*"RECOMMEND_SUPPORT_QUEST_CHANGE_NO_INPUT"*/);
...
LABEL_22:
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_11518/*"RECOMMEND_SUPPORT_QUEST_CHANGE_NO_INPUT"*/,
                                                                    0);
    if ( !selectQuestLabel )
      goto LABEL_76;
...
LABEL_76:
  ...
  if ( (phaseNum & 0x80000000) == 0 )
  {
    ...
    v47 = (Il2CppObject *)System_String__Concat_75651716((System_String_o *)Item, v46, 0);
  ...
  else
  {
    ...
    sub_2213A04((MissionNaviTransitionBoardItem_o *)(v58 + 4), (int32_t)v57, v48, v49, v50, v51, v52, v53);
  }
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v59, v60);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_RecommendSupportQuestMaster___);
  if ( !Master_object )
    goto LABEL_76;
  ...
  if ( v61 )
  {
    ...
    if ( !Master_object )
      goto LABEL_76;
    v63 = System_String__Replace_75703400(
            (System_String_o *)Master_object,
            (System_String_o *)StringLiteral_43/*"\n"*/,
            (System_String_o *)StringLiteral_1/*""*/,
            0);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat_75651716(
                                                                    (System_String_o *)StringLiteral_43/*"\n"*/,
                                                                    v63,
                                                                    0);
    ...
    else
    {
      ...
      sub_2213A04((MissionNaviTransitionBoardItem_o *)(v74 + 4), (int32_t)v73, v64, v65, v66, v67, v68, v69);
    }
  }
  else
  {
  ...
  v79 = LocalizationManager__Get((System_String_o *)StringLiteral_11536/*"RECOMMEND_SUPPORT_QUEST_SEPARATOR"*/, 0);
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Join_75699092(
                                                                  v79,
...
LABEL_14:
    sub_2213CDC(servantFaceIcon, isMount);
  }
  if ( !servantFaceIcon )
    goto LABEL_14;
  servantFaceIcon = (ServantFaceIconComponent_o *)UnityEngine_Component__get_gameObject(
        ...
        const MethodInfo *method)
{
  ...
  *overwriteName = name;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)overwriteName, (int32_t)name, v14, v15, v16, v17, v18, v19);
  return 1;
}
...
void RecommendSupportListViewItemDraw___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_2213CCC(RecommendSupportListViewItemDraw___c_TypeInfo);
