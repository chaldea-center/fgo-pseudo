        ...
        const MethodInfo *method)
{
  if ( (byte_4A22B15 & 1) == 0 )
  {
    sub_1B715CC(&BattleServantParamComponent_TypeInfo, method);
    byte_4A22B15 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22B0F & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_2922/*"BATTLE_RAID_TOTALHP"*/, v3);
    byte_4A22B0F = 1;
  }
  ...
  if ( !this->fields.hpformat )
  {
    ...
    v7 = System_String__Concat_61505504((System_String_o *)StringLiteral_2922/*"BATTLE_RAID_TOTALHP"*/, v6, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    if ( LocalizationManager__ContainsKey(v7, 0LL) )
    {
      v8 = System_Int32__ToString(v5, 0LL);
      v9 = System_String__Concat_61505504((System_String_o *)StringLiteral_2922/*"BATTLE_RAID_TOTALHP"*/, v8, 0LL);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    }
    else
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = (System_String_o *)StringLiteral_2922/*"BATTLE_RAID_TOTALHP"*/;
    }
    v10 = LocalizationManager__Get(v9, 0LL);
    p_hpformat->klass = (ServantStatusBattleListViewItem_c *)v10;
    sub_1B71570(p_hpformat, (int32_t)v10, v11, v12);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22B10 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataManager_GetMasterData_EventBossStatusUiMaster___, v6);
    sub_1B715CC(&Method_DataManager_GetMaster_BattleMaster___, v7);
    sub_1B715CC(&DataManager_TypeInfo, v8);
    sub_1B715CC(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v9);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v10);
    sub_1B715CC(&int_TypeInfo, v11);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    sub_1B715CC(&StringLiteral_22711/*"raid_down_last_"*/, v13);
    sub_1B715CC(&StringLiteral_3193/*"Battle/Common"*/, v14);
    sub_1B715CC(&StringLiteral_3211/*"BattleAssetUIAtlas"*/, v15);
    sub_1B715CC(&StringLiteral_22710/*"raid_down_end_"*/, v16);
    sub_1B715CC(&StringLiteral_22712/*"raid_down_normal_"*/, v17);
    byte_4A22B10 = 1;
  }
  if ( data )
  {
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_BattleMaster___);
    if ( !Master_object )
      goto LABEL_30;
    SingleEntity = DataMasterBase_object__object__long___GetSingleEntity(
                     Master_object,
                     (const MethodInfo_30F89C8 *)Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Master_object )
      goto LABEL_30;
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMasterData_object_(
                                                                    (DataManager_o *)Master_object,
                                                                    (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_EventBossStatusUiMaster___);
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)AssetManager__getAssetStorage(
                                                                    (System_String_o *)StringLiteral_3193/*"Battle/Common"*/,
                                                                    0LL);
    if ( !Master_object )
      goto LABEL_30;
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)AssetData__GetObject_object__48486748(
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat(
                                                                    (Il2CppObject *)StringLiteral_22712/*"raid_down_normal_"*/,
                                                                    v37,
                                                                    0LL);
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat(
                                                                    (Il2CppObject *)StringLiteral_22711/*"raid_down_last_"*/,
                                                                    v42,
                                                                    0LL);
    if ( !raidDownLastSprite
      ...
      || (UISprite__set_atlas((UISprite_o *)Master_object, v32, 0LL),
          ...
          Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat(
                                                                          (Il2CppObject *)StringLiteral_22710/*"raid_down_end_"*/,
                                                                          v47,
                                                                          0LL),
          !raidDownEndSprite) )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22B13 & 1) == 0 )
  {
    ...
    this = (BattleServantRaidParamComponent_o *)sub_1B715CC(&StringLiteral_1/*""*/, v3);
    byte_4A22B13 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.previnfo, (int32_t)newinfo, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22B11 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_EventPointBuffMaster___, svtData);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventRaidMaster___, v5);
    sub_1B715CC(&Method_DataManager_GetMaster_BattleMaster___, v6);
    sub_1B715CC(&DataManager_TypeInfo, v7);
    sub_1B715CC(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v8);
    sub_1B715CC(&long_TypeInfo, v9);
    this = (BattleServantRaidParamComponent_o *)sub_1B715CC(
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (BattleServantRaidParamComponent_o *)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_BattleMaster___);
  if ( !this )
    goto LABEL_41;
  SingleEntity = DataMasterBase_object__object__long___GetSingleEntity(
                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                   (const MethodInfo_30F89C8 *)Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__);
  this = (BattleServantRaidParamComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_41;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22B12 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, now);
    byte_4A22B12 = 1;
  }
...
LABEL_14:
  ...
  else if ( v8 )
  {
    ...
    if ( v10 )
    {
      v11 = now;
LABEL_12:
      BattleHpGaugeBarComponent__setValue_43566664(v10, v11, max, 0LL);
      return;
    }
    goto LABEL_14;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( fixUpdate )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)p_newinfo, (int32_t)info, fixUpdate, (int32_t)method);
    newinfo = this->fields.newinfo;
    this->fields.previnfo = newinfo;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.previnfo, (int32_t)newinfo, v7, v8);
    data = this->fields.data;
    this->fields.flgUpdate = 0;
