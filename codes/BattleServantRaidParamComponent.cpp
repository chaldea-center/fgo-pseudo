        ...
        const MethodInfo *method)
{
  if ( (byte_4B47FA0 & 1) == 0 )
  {
    sub_1BDB878(&BattleServantParamComponent_TypeInfo, method);
    byte_4B47FA0 = 1;
  }
  ...
  BattleServantParamComponent___ctor((BattleServantParamComponent_o *)this, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  BattleServantParamComponent__changeHp((BattleServantParamComponent_o *)this, svtData, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47F9A & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_2847/*"BATTLE_RAID_TOTALHP"*/, v3);
    byte_4B47F9A = 1;
  }
  ...
  if ( !this->fields.hpformat )
  {
    ...
    v7 = System_String__Concat_62572260((System_String_o *)StringLiteral_2847/*"BATTLE_RAID_TOTALHP"*/, v6, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    if ( LocalizationManager__ContainsKey(v7, 0LL) )
    {
      v8 = System_Int32__ToString(v5, 0LL);
      v9 = System_String__Concat_62572260((System_String_o *)StringLiteral_2847/*"BATTLE_RAID_TOTALHP"*/, v8, 0LL);
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    }
    else
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = (System_String_o *)StringLiteral_2847/*"BATTLE_RAID_TOTALHP"*/;
    }
    v10 = LocalizationManager__Get(v9, 0LL);
    p_hpformat->klass = (CGThumbnailListItem_c *)v10;
    sub_1BDB81C(p_hpformat, (int32_t)v10, v11, v12);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47F9B & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_EventBossStatusUiMaster___, v6);
    sub_1BDB878(&Method_DataManager_GetMaster_BattleMaster___, v7);
    sub_1BDB878(&DataManager_TypeInfo, v8);
    sub_1BDB878(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v9);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_UIAtlas___, v10);
    sub_1BDB878(&int_TypeInfo, v11);
    sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    sub_1BDB878(&StringLiteral_22965/*"raid_down_last_"*/, v13);
    sub_1BDB878(&StringLiteral_3132/*"Battle/Common"*/, v14);
    sub_1BDB878(&StringLiteral_3150/*"BattleAssetUIAtlas"*/, v15);
    sub_1BDB878(&StringLiteral_22964/*"raid_down_end_"*/, v16);
    sub_1BDB878(&StringLiteral_22966/*"raid_down_normal_"*/, v17);
    byte_4B47F9B = 1;
  }
  if ( data )
  {
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_BattleMaster___);
    if ( !Master_object )
      goto LABEL_30;
    SingleEntity = DataMasterBase_object__object__long___GetSingleEntity(
                     Master_object,
                     (const MethodInfo_32E4444 *)Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__);
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Master_object )
      goto LABEL_30;
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)DataManager__GetMasterData_object_(
                                                                    (DataManager_o *)Master_object,
                                                                    (const MethodInfo_303395C *)Method_DataManager_GetMasterData_EventBossStatusUiMaster___);
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)AssetManager__getAssetStorage(
                                                                    (System_String_o *)StringLiteral_3132/*"Battle/Common"*/,
                                                                    0LL);
    if ( !Master_object )
      goto LABEL_30;
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)AssetData__GetObject_object__50417328(
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat(
                                                                    (Il2CppObject *)StringLiteral_22966/*"raid_down_normal_"*/,
                                                                    v37,
                                                                    0LL);
    ...
    Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat(
                                                                    (Il2CppObject *)StringLiteral_22965/*"raid_down_last_"*/,
                                                                    v42,
                                                                    0LL);
    if ( !raidDownLastSprite
      ...
      || (UISprite__set_atlas((UISprite_o *)Master_object, v32, 0LL),
          ...
          Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)System_String__Concat(
                                                                          (Il2CppObject *)StringLiteral_22964/*"raid_down_end_"*/,
                                                                          v47,
                                                                          0LL),
          !raidDownEndSprite) )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47F9E & 1) == 0 )
  {
    ...
    this = (BattleServantRaidParamComponent_o *)sub_1BDB878(&StringLiteral_1/*""*/, v3);
    byte_4B47F9E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.previnfo, (int32_t)newinfo, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  System_Int64_c *v29; // x0
  Il2CppObject *v30; // x0
  struct BattleRaidInfo_o *v31; // x8
  struct BattleRaidInfo_o *v32; // x8
  int64_t v33; // [xsp+8h] [xbp-38h] BYREF

  v4 = this;
  if ( (byte_4B47F9C & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_EventPointBuffMaster___, svtData);
    sub_1BDB878(&Method_DataManager_GetMasterData_EventRaidMaster___, v5);
    sub_1BDB878(&Method_DataManager_GetMaster_BattleMaster___, v6);
    sub_1BDB878(&DataManager_TypeInfo, v7);
    sub_1BDB878(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v8);
    sub_1BDB878(&long_TypeInfo, v9);
    this = (BattleServantRaidParamComponent_o *)sub_1BDB878(
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (BattleServantRaidParamComponent_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_BattleMaster___);
  if ( !this )
    goto LABEL_41;
  SingleEntity = DataMasterBase_object__object__long___GetSingleEntity(
                   (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                   (const MethodInfo_32E4444 *)Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__);
  this = (BattleServantRaidParamComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_41;
...
LABEL_30:
  ...
  if ( !((unsigned int)p_klass | v21) && v4->fields.isDefeatCount && !v4->fields.isJumbleRaid )
  {
    ...
    v32 = v4->fields.previnfo;
    if ( v32 )
    {
      RaidHPFormat = (System_String_o *)this;
      v33 = v32->fields.totalDamage;
      v29 = long_TypeInfo;
      goto LABEL_33;
    }
LABEL_41:
  ...
  v29 = long_TypeInfo;
LABEL_33:
  v30 = (Il2CppObject *)j_il2cpp_value_box_0(v29, &v33, v25, v26, v27);
  this = (BattleServantRaidParamComponent_o *)System_String__Format(RaidHPFormat, v30, 0LL);
  if ( !raidhplabel )
    goto LABEL_41;
...
LABEL_35:
  ...
  if ( !v31 )
    goto LABEL_41;
  BattleServantRaidParamComponent__updateRaidHpbar(v4, v14, v31->fields.maxHp, v19);
}
...
LABEL_14:
  ...
  else if ( v8 )
  {
    ...
    if ( v10 )
    {
      v11 = now;
LABEL_12:
      BattleHpGaugeBarComponent__setValue_45941620(v10, v11, max, 0LL);
      return;
    }
    goto LABEL_14;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( fixUpdate )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)p_newinfo, (int32_t)info, fixUpdate, method);
    newinfo = this->fields.newinfo;
    this->fields.previnfo = newinfo;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.previnfo, (int32_t)newinfo, v7, v8);
    data = this->fields.data;
    this->fields.flgUpdate = 0;
