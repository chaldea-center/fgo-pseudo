void UserPresentBoxErrorDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2B507 & 1) == 0 )
  {
    sub_1C94098(&UserPresentBoxErrorDialog_TypeInfo);
    byte_4D2B507 = 1;
  }
...
void UserPresentBoxErrorDialog__ChangeScene(UserPresentBoxErrorDialog_o *this, int32_t scene, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B504 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UserPresentBoxErrorDialog___c__DisplayClass23_0__ChangeScene_b__0__);
    sub_1C94098(&UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo);
    sub_1C94098(&Method_UserPresentBoxErrorDialog_ChangeScene__);
  ...
  v5 = sub_1C942E4(UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = scene;
  ...
  if ( (*((_BYTE *)Method_UserPresentBoxErrorDialog_ChangeScene__ + 83) & 2) != 0 )
    v14 = (_QWORD *)sub_1C940B0(Method_UserPresentBoxErrorDialog_ChangeScene__);
...
LABEL_28:
      ...
      SceneJumpInfo___ctor_42243168(v20, (System_String_o *)StringLiteral_12781/*"ServantEquipList"*/, 0);
      if ( !v18 )
        goto LABEL_30;
      v25 = 71;
LABEL_27:
    ...
    case 32:
      ...
      v18 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      v27 = (SceneJumpInfo_o *)sub_1C942E4(SceneJumpInfo_TypeInfo);
      v24 = v26 == 1;
      v20 = v27;
      if ( v24 )
        v29 = &StringLiteral_12780/*"ServantEQCombine"*/;
      else
        v29 = &StringLiteral_12777/*"ServantCombine"*/;
      SceneJumpInfo___ctor_42243168(v27, (System_String_o *)*v29, 0);
      if ( !v18 )
        goto LABEL_30;
      v25 = 32;
      goto LABEL_27;
    case 22:
      ...
      {
        v18 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
        v19 = (SceneJumpInfo_o *)sub_1C942E4(SceneJumpInfo_TypeInfo);
        v20 = v19;
        v21 = 1;
        v22 = (System_String_o *)StringLiteral_12741/*"SellServant"*/;
      }
      else
      {
        v18 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      ...
      SceneJumpInfo___ctor_42243256(v19, v22, v21, 0);
      if ( v18 )
      {
        v25 = 22;
        goto LABEL_27;
...
void UserPresentBoxErrorDialog__Init(UserPresentBoxErrorDialog_o *this, const MethodInfo *method)
{
  ...
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3690/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    goto LABEL_30;
  UILabel__set_text(closeLabel, (System_String_o *)messageLabel, 0);
  shopLabel = this->fields.shopLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12256/*"SHORT_SERVANT_SELL"*/, 0);
  if ( !shopLabel )
    goto LABEL_30;
  UILabel__set_text(shopLabel, (System_String_o *)messageLabel, 0);
  combineLabel = this->fields.combineLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12241/*"SHORT_SERVANT_COMBINE"*/, 0);
  if ( !combineLabel )
    goto LABEL_30;
  UILabel__set_text(combineLabel, (System_String_o *)messageLabel, 0);
  warehouseLabel = this->fields.warehouseLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12259/*"SHORT_SERVANT_WAREHOUSE"*/, 0);
  if ( !warehouseLabel )
    goto LABEL_30;
...
void UserPresentBoxErrorDialog__OnClickCloseButton(UserPresentBoxErrorDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&Method_UserPresentBoxErrorDialog_OnClickCloseButton__);
    sub_1C94098(&Method_UserPresentBoxErrorDialog__OnClickCloseButton_b__18_0__);
    byte_4D2B502 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_UserPresentBoxErrorDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C940B0(Method_UserPresentBoxErrorDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    v9 = v8;
    v10 = sub_1C941D4(v8, System_Action_SceneList_Type__TypeInfo);
    if ( !v10 )
      break;
LABEL_8:
    v11 = sub_1CEFE6C(p_OnErrorDialogClosed, v10, v6);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_15702/*"Window/ExitButton"*/;
}
...
void UserPresentBoxErrorDialog__setJumpType(UserPresentBoxErrorDialog_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( type == 2 )
  {
    ...
    {
LABEL_25:
      sub_1C942F0(messageLabel, *(_QWORD *)&type);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)messageLabel, 0, 0);
  }
}
