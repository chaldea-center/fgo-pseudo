void __fastcall UserPresentBoxErrorDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B437BC & 1) == 0 )
  {
    sub_1BDB878(&UserPresentBoxErrorDialog_TypeInfo, v1);
    byte_4B437BC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B437B9 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, *(_QWORD *)&scene);
    sub_1BDB878(&SceneJumpInfo_TypeInfo, v5);
    sub_1BDB878(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v6);
    sub_1BDB878(&Method_UserPresentBoxErrorDialog___c__DisplayClass23_0__ChangeScene_b__0__, v7);
    sub_1BDB878(&UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo, v8);
    sub_1BDB878(&Method_UserPresentBoxErrorDialog_ChangeScene__, v9);
    sub_1BDB878(&StringLiteral_12691/*"ServantEquipList"*/, v10);
    sub_1BDB878(&StringLiteral_12651/*"SellServant"*/, v11);
    sub_1BDB878(&StringLiteral_12690/*"ServantEQCombine"*/, v12);
    sub_1BDB878(&StringLiteral_12687/*"ServantCombine"*/, v13);
    byte_4B437B9 = 1;
  }
  v14 = sub_1BDBAC4(UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo);
  ...
  *(_DWORD *)(v14 + 24) = scene;
  ...
  if ( (*((_BYTE *)Method_UserPresentBoxErrorDialog_ChangeScene__ + 83) & 2) != 0 )
    v19 = (_QWORD *)sub_1BDB890(Method_UserPresentBoxErrorDialog_ChangeScene__);
...
LABEL_28:
      ...
      v25 = (SceneJumpInfo_o *)sub_1BDBAC4(SceneJumpInfo_TypeInfo);
      SceneJumpInfo___ctor_40482208(v25, (System_String_o *)StringLiteral_12691/*"ServantEquipList"*/, 0LL);
      if ( !v23 )
        goto LABEL_30;
      v30 = 71;
LABEL_27:
    ...
    case 32:
      ...
      v23 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      v32 = (SceneJumpInfo_o *)sub_1BDBAC4(SceneJumpInfo_TypeInfo);
      v29 = v31 == 1;
      v25 = v32;
      if ( v29 )
        v34 = &StringLiteral_12690/*"ServantEQCombine"*/;
      else
        v34 = &StringLiteral_12687/*"ServantCombine"*/;
      SceneJumpInfo___ctor_40482208(v32, (System_String_o *)*v34, 0LL);
      if ( !v23 )
        goto LABEL_30;
      v30 = 32;
      goto LABEL_27;
    case 22:
      ...
      {
        v23 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
        v24 = (SceneJumpInfo_o *)sub_1BDBAC4(SceneJumpInfo_TypeInfo);
        v25 = v24;
        v26 = 1;
        v27 = (System_String_o *)StringLiteral_12651/*"SellServant"*/;
      }
      else
      {
        v23 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      ...
      SceneJumpInfo___ctor_40482296(v24, v27, v26, 0LL);
      if ( v23 )
      {
        v30 = 22;
        goto LABEL_27;
...
void __fastcall UserPresentBoxErrorDialog__Init(UserPresentBoxErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B437B6 & 1) == 0 )
  {
    ...
    sub_1BDB878(&UserPresentBoxErrorDialog_TypeInfo, v3);
    sub_1BDB878(&StringLiteral_12179/*"SHORT_SERVANT_SELL"*/, v4);
    sub_1BDB878(&StringLiteral_3717/*"COMMON_CONFIRM_CLOSE"*/, v5);
    sub_1BDB878(&StringLiteral_12182/*"SHORT_SERVANT_WAREHOUSE"*/, v6);
    sub_1BDB878(&StringLiteral_12164/*"SHORT_SERVANT_COMBINE"*/, v7);
  ...
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3717/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_30;
  UILabel__set_text(closeLabel, (System_String_o *)messageLabel, 0LL);
  shopLabel = this->fields.shopLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12179/*"SHORT_SERVANT_SELL"*/, 0LL);
  if ( !shopLabel )
    goto LABEL_30;
  UILabel__set_text(shopLabel, (System_String_o *)messageLabel, 0LL);
  combineLabel = this->fields.combineLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12164/*"SHORT_SERVANT_COMBINE"*/, 0LL);
  if ( !combineLabel )
    goto LABEL_30;
  UILabel__set_text(combineLabel, (System_String_o *)messageLabel, 0LL);
  warehouseLabel = this->fields.warehouseLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12182/*"SHORT_SERVANT_WAREHOUSE"*/, 0LL);
  if ( !warehouseLabel )
    goto LABEL_30;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B437B7 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_UserPresentBoxErrorDialog_OnClickCloseButton__, v3);
    sub_1BDB878(&Method_UserPresentBoxErrorDialog__OnClickCloseButton_b__18_0__, v4);
    byte_4B437B7 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_UserPresentBoxErrorDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BDB890(Method_UserPresentBoxErrorDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B437B4 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_SceneList_Type__TypeInfo, value);
    byte_4B437B4 = 1;
  }
  OnErrorDialogClosed = this->fields.OnErrorDialogClosed;
  ...
  while ( 1 )
  {
    ...
    v9 = v8;
    v10 = sub_1BDB9B4(v8, System_Action_SceneList_Type__TypeInfo);
    if ( !v10 )
      break;
LABEL_8:
    v11 = sub_1C15B34(p_OnErrorDialogClosed, v10, v6);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B437BA & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_15620/*"Window/ExitButton"*/, method);
    byte_4B437BA = 1;
  }
  return (System_String_o *)StringLiteral_15620/*"Window/ExitButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B437B8 & 1) == 0 )
  {
    sub_1BDB878(&UserPresentBoxErrorDialog_TypeInfo, *(_QWORD *)&type);
    byte_4B437B8 = 1;
  }
  ...
  if ( type == 2 )
  {
    ...
    {
LABEL_25:
      sub_1BDBAD4(messageLabel, *(_QWORD *)&type);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)messageLabel, 0, 0LL);
  }
}
