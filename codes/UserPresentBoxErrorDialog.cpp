void __fastcall UserPresentBoxErrorDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E15C4 & 1) == 0 )
  {
    sub_1B00CCC(&UserPresentBoxErrorDialog_TypeInfo, v1);
    byte_48E15C4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E15C1 & 1) == 0 )
  {
    sub_1B00CCC(&System_Action_TypeInfo, *(_QWORD *)&scene);
    sub_1B00CCC(&SceneJumpInfo_TypeInfo, v5);
    sub_1B00CCC(&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__, v6);
    sub_1B00CCC(&Method_UserPresentBoxErrorDialog___c__DisplayClass23_0__ChangeScene_b__0__, v7);
    sub_1B00CCC(&UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo, v8);
    sub_1B00CCC(&Method_UserPresentBoxErrorDialog_ChangeScene__, v9);
    sub_1B00CCC(&StringLiteral_12416/*"ServantEquipList"*/, v10);
    sub_1B00CCC(&StringLiteral_12375/*"SellServant"*/, v11);
    sub_1B00CCC(&StringLiteral_12415/*"ServantEQCombine"*/, v12);
    sub_1B00CCC(&StringLiteral_12412/*"ServantCombine"*/, v13);
    byte_48E15C1 = 1;
  }
  v14 = sub_1B00F18(UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo);
  ...
  *(_DWORD *)(v14 + 24) = scene;
  ...
  if ( (*((_BYTE *)Method_UserPresentBoxErrorDialog_ChangeScene__ + 83) & 2) != 0 )
    v19 = (_QWORD *)sub_1B00CE4(Method_UserPresentBoxErrorDialog_ChangeScene__);
...
LABEL_28:
      ...
      v25 = (SceneJumpInfo_o *)sub_1B00F18(SceneJumpInfo_TypeInfo);
      SceneJumpInfo___ctor_37367628(v25, (System_String_o *)StringLiteral_12416/*"ServantEquipList"*/, 0LL);
      if ( !v23 )
        goto LABEL_30;
      v30 = 71;
LABEL_27:
    ...
    case 32:
      ...
      v23 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      v32 = (SceneJumpInfo_o *)sub_1B00F18(SceneJumpInfo_TypeInfo);
      v29 = v31 == 1;
      v25 = v32;
      if ( v29 )
        v34 = &StringLiteral_12415/*"ServantEQCombine"*/;
      else
        v34 = &StringLiteral_12412/*"ServantCombine"*/;
      SceneJumpInfo___ctor_37367628(v32, (System_String_o *)*v34, 0LL);
      if ( !v23 )
        goto LABEL_30;
      v30 = 32;
      goto LABEL_27;
    case 22:
      ...
      {
        v23 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
        v24 = (SceneJumpInfo_o *)sub_1B00F18(SceneJumpInfo_TypeInfo);
        v25 = v24;
        v26 = 1;
        v27 = (System_String_o *)StringLiteral_12375/*"SellServant"*/;
      }
      else
      {
        v23 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      ...
      SceneJumpInfo___ctor_37367716(v24, v27, v26, 0LL);
      if ( v23 )
      {
        v30 = 22;
        goto LABEL_27;
...
void __fastcall UserPresentBoxErrorDialog__Init(UserPresentBoxErrorDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E15BE & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UserPresentBoxErrorDialog_TypeInfo, v3);
    sub_1B00CCC(&StringLiteral_11938/*"SHORT_SERVANT_SELL"*/, v4);
    sub_1B00CCC(&StringLiteral_3715/*"COMMON_CONFIRM_CLOSE"*/, v5);
    sub_1B00CCC(&StringLiteral_11941/*"SHORT_SERVANT_WAREHOUSE"*/, v6);
    sub_1B00CCC(&StringLiteral_11923/*"SHORT_SERVANT_COMBINE"*/, v7);
  ...
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3715/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_30;
  UILabel__set_text(closeLabel, (System_String_o *)messageLabel, 0LL);
  shopLabel = this->fields.shopLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11938/*"SHORT_SERVANT_SELL"*/, 0LL);
  if ( !shopLabel )
    goto LABEL_30;
  UILabel__set_text(shopLabel, (System_String_o *)messageLabel, 0LL);
  combineLabel = this->fields.combineLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11923/*"SHORT_SERVANT_COMBINE"*/, 0LL);
  if ( !combineLabel )
    goto LABEL_30;
  UILabel__set_text(combineLabel, (System_String_o *)messageLabel, 0LL);
  warehouseLabel = this->fields.warehouseLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11941/*"SHORT_SERVANT_WAREHOUSE"*/, 0LL);
  if ( !warehouseLabel )
    goto LABEL_30;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E15BF & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_UserPresentBoxErrorDialog_OnClickCloseButton__, v3);
    sub_1B00CCC(&Method_UserPresentBoxErrorDialog__OnClickCloseButton_b__18_0__, v4);
    byte_48E15BF = 1;
  }
  ...
  if ( (*((_BYTE *)Method_UserPresentBoxErrorDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B00CE4(Method_UserPresentBoxErrorDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E15BC & 1) == 0 )
  {
    sub_1B00CCC(&System_Action_SceneList_Type__TypeInfo, value);
    byte_48E15BC = 1;
  }
  OnErrorDialogClosed = this->fields.OnErrorDialogClosed;
  ...
  while ( 1 )
  {
    ...
    v9 = v8;
    v10 = sub_1B00E08(v8, System_Action_SceneList_Type__TypeInfo);
    if ( !v10 )
      break;
LABEL_8:
    v11 = sub_1B3C1BC(p_OnErrorDialogClosed, v10, v6);
        ...
        const MethodInfo *method)
{
  if ( (byte_48E15C2 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_15414/*"Window/ExitButton"*/, method);
    byte_48E15C2 = 1;
  }
  return (System_String_o *)StringLiteral_15414/*"Window/ExitButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E15C0 & 1) == 0 )
  {
    sub_1B00CCC(&UserPresentBoxErrorDialog_TypeInfo, *(_QWORD *)&type);
    byte_48E15C0 = 1;
  }
  ...
  if ( type == 2 )
  {
    ...
    {
LABEL_25:
      sub_1B00F28(messageLabel, *(_QWORD *)&type);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)messageLabel, 0, 0LL);
  }
}
