void __fastcall UserPresentBoxErrorDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4187086 & 1) == 0 )
  {
    sub_B2C35C(&UserPresentBoxErrorDialog_TypeInfo, v1);
    byte_4187086 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  SceneJumpInfo_o *v26; // x0
  SceneJumpInfo_o *v27; // x22
  int32_t v28; // w2
  System_String_o *v29; // x1
  int32_t v30; // w22
  SceneJumpInfo_o *v31; // x0
  bool v32; // zf
  ...
  if ( (byte_4187083 & 1) == 0 )
  {
    sub_B2C35C(&System_Action_TypeInfo, *(_QWORD *)&scene);
    ...
    sub_B2C35C(&Method_UserPresentBoxErrorDialog___c__DisplayClass23_0__ChangeScene_b__0__, v8);
    sub_B2C35C(&UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo, v9);
    sub_B2C35C(&StringLiteral_12711/*"ServantEquipList"*/, v10);
    sub_B2C35C(&StringLiteral_12668/*"SellServant"*/, v11);
    sub_B2C35C(&StringLiteral_12710/*"ServantEQCombine"*/, v12);
    sub_B2C35C(&StringLiteral_12707/*"ServantCombine"*/, v13);
    byte_4187083 = 1;
  }
  v14 = sub_B2C42C(UserPresentBoxErrorDialog___c__DisplayClass23_0_TypeInfo);
    ...
    case 71:
      ...
      if ( !v32 )
      {
        if ( Instance )
        {
          ...
          v36 = 0LL;
LABEL_29:
          AvalonSceneManager__transitionScene(Instance, v34, 1, v36, 0LL);
          break;
        }
        goto LABEL_31;
      }
      v27 = (SceneJumpInfo_o *)sub_B2C42C(SceneJumpInfo_TypeInfo);
      SceneJumpInfo___ctor_17292872(v27, (System_String_o *)StringLiteral_12711/*"ServantEquipList"*/, 0LL);
      if ( !v25 )
        goto LABEL_31;
      v34 = 71;
LABEL_28:
      Instance = (AvalonSceneManager_o *)v25;
      v36 = (Il2CppObject *)v27;
      goto LABEL_29;
    case 32:
      v30 = this->fields.jumpType;
      v25 = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2841668 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      v31 = (SceneJumpInfo_o *)sub_B2C42C(SceneJumpInfo_TypeInfo);
      v32 = v30 == 1;
      v27 = v31;
      if ( v32 )
        v35 = &StringLiteral_12710/*"ServantEQCombine"*/;
      else
        v35 = &StringLiteral_12707/*"ServantCombine"*/;
      SceneJumpInfo___ctor_17292872(v31, (System_String_o *)*v35, 0LL);
      if ( !v25 )
        goto LABEL_31;
      v34 = 32;
      goto LABEL_28;
    case 22:
      v24 = this->fields.jumpType;
      if ( v24 == 1 )
      {
        v25 = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2841668 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
        v26 = (SceneJumpInfo_o *)sub_B2C42C(SceneJumpInfo_TypeInfo);
        v27 = v26;
        v28 = 1;
        v29 = (System_String_o *)StringLiteral_12668/*"SellServant"*/;
      }
      else
      {
        v25 = SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2841668 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
      ...
      SceneJumpInfo___ctor_17292968(v26, v29, v28, 0LL);
      if ( v25 )
      {
        v34 = 22;
        goto LABEL_28;
...
void __fastcall UserPresentBoxErrorDialog__Init(UserPresentBoxErrorDialog_o *this, const MethodInfo *method)
{
  ...
  UserPresentBoxErrorDialog_c *v16; // x8

  if ( (byte_4187080 & 1) == 0 )
  {
    sub_B2C35C(&LocalizationManager_TypeInfo, method);
    sub_B2C35C(&UserPresentBoxErrorDialog_TypeInfo, v3);
    sub_B2C35C(&StringLiteral_12233/*"SHORT_SERVANT_SELL"*/, v4);
    sub_B2C35C(&StringLiteral_3261/*"COMMON_CONFIRM_CLOSE"*/, v5);
    sub_B2C35C(&StringLiteral_12236/*"SHORT_SERVANT_WAREHOUSE"*/, v6);
    sub_B2C35C(&StringLiteral_12219/*"SHORT_SERVANT_COMBINE"*/, v7);
  ...
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3261/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    goto LABEL_32;
  UILabel__set_text(closeLabel, (System_String_o *)messageLabel, 0LL);
  shopLabel = this->fields.shopLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12233/*"SHORT_SERVANT_SELL"*/, 0LL);
  if ( !shopLabel )
    goto LABEL_32;
  UILabel__set_text(shopLabel, (System_String_o *)messageLabel, 0LL);
  combineLabel = this->fields.combineLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12219/*"SHORT_SERVANT_COMBINE"*/, 0LL);
  if ( !combineLabel )
    goto LABEL_32;
  UILabel__set_text(combineLabel, (System_String_o *)messageLabel, 0LL);
  warehouseLabel = this->fields.warehouseLabel;
  messageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12236/*"SHORT_SERVANT_WAREHOUSE"*/, 0LL);
  if ( !warehouseLabel )
    goto LABEL_32;
  ...
  v16 = UserPresentBoxErrorDialog_TypeInfo;
  ...
  if ( !v15 )
    goto LABEL_32;
  UnityEngine_Transform__set_localPosition(v15, v16->static_fields->MESSAGE_POS, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187081 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_UserPresentBoxErrorDialog__OnClickCloseButton_b__18_0__, v4);
    byte_4187081 = 1;
  }
  if ( (BYTE3(SoundManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !SoundManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187087 & 1) == 0 )
  {
    sub_B2C35C(&Method_System_Action_SceneList_Type__Invoke__, method);
    byte_4187087 = 1;
  }
  ...
  if ( OnErrorDialogClosed )
    System_Action_ShopRootConstants_State___Invoke(
      ...
      -1,
      (const MethodInfo_24BA830 *)Method_System_Action_SceneList_Type__Invoke__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418707E & 1) == 0 )
  {
    sub_B2C35C(&System_Action_SceneList_Type__TypeInfo, value);
    byte_418707E = 1;
  }
  OnErrorDialogClosed = this->fields.OnErrorDialogClosed;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_B20D74(p_OnErrorDialogClosed, v8, v6);
    v10 = v6 == (System_Delegate_o *)v9;
    v6 = (System_Delegate_o *)v9;
    if ( v10 )
      return;
  }
  v11 = (UserPresentBoxErrorDialog_o *)sub_B2C728(v8);
        ...
        const MethodInfo *method)
{
  if ( (byte_4187084 & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_15481/*"Window/ExitButton"*/, method);
    byte_4187084 = 1;
  }
  return (System_String_o *)StringLiteral_15481/*"Window/ExitButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187082 & 1) == 0 )
  {
    sub_B2C35C(&UserPresentBoxErrorDialog_TypeInfo, *(_QWORD *)&type);
    byte_4187082 = 1;
  }
  ...
  if ( type == 2 )
  {
    ...
    {
LABEL_26:
      sub_B2C434(messageLabel, *(_QWORD *)&type);
    }
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)messageLabel, 0, 0LL);
  }
}
