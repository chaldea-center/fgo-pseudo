        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B145 & 1) == 0 )
  {
    sub_1BD3458(&CTouch_TypeInfo, *(_QWORD *)&eventId);
    sub_1BD3458(&StringLiteral_2252/*"ActivationTouchFlag"*/, v14);
    byte_4B3B145 = 1;
  }
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.eventRoot, (int64_t)eventRoot, v15, v16, v17, v18, v19, v20);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.orgCamera, (int64_t)orgCamera, v22, v23, v24, v25, v26, v27);
  ...
  if ( !byte_4B34FE6 )
  {
    sub_1BD3458(&CTouch_TypeInfo, v31);
    byte_4B34FE6 = 1;
  }
  v38 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1BD36B4(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1BD36B4(IsEnableOutSideCollider, v4);
