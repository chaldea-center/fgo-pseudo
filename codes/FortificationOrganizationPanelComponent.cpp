        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02898 & 1) == 0 )
  {
    sub_1B64A00(&MapZoom_TypeInfo, method);
    byte_4A02898 = 1;
  }
  v3 = MapZoom_TypeInfo;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02897 & 1) == 0 )
  {
    sub_1B64A00(&CTouch_TypeInfo, *(_QWORD *)&eventId);
    sub_1B64A00(&StringLiteral_2225/*"ActivationTouchFlag"*/, v14);
    byte_4A02897 = 1;
  }
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.eventRoot, (int32_t)eventRoot, v15, v16);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.orgCamera, (int32_t)orgCamera, v18, v19);
  ...
  if ( !byte_49FCA21 )
  {
    sub_1B64A00(&CTouch_TypeInfo, v23);
    byte_49FCA21 = 1;
  }
  v26 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->mScreenCam, (int32_t)mainCamera, v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1B64C5C(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1B64C5C(IsEnableOutSideCollider, v4);
