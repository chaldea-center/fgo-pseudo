        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE05A1 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_2266/*"ActivationTouchFlag"*/);
    byte_4BE05A1 = 1;
  }
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.eventRoot, (int64_t)eventRoot, v14, v15, v16, v17, v18, v19);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.orgCamera, (int64_t)orgCamera, v21, v22, v23, v24, v25, v26);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1C22094(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1C22094(IsEnableOutSideCollider, v4);
