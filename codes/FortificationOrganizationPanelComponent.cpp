        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2ABED & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2139/*"ActivationTouchFlag"*/);
    byte_4D2ABED = 1;
  }
  this->fields.mainPanel = mainPanel;
  sub_1C93A78(&this->fields.mainPanel, mainPanel);
  this->fields.eventRoot = eventRoot;
  sub_1C93A78(&this->fields.eventRoot, eventRoot);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1C93A78(&this->fields.orgCamera, orgCamera);
  ...
  sub_1C93A78(&static_fields->mScreenCam, mainCamera);
  ...
  {
LABEL_16:
    sub_1C93D2C(organizationBg, v16);
  }
  MapZoom__SetZoomSize((MapZoom_o *)organizationBg, this->fields.zoomSize, 1, 0, 0);
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_2139/*"ActivationTouchFlag"*/, 0.05, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1C93D2C(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1C93D2C(IsEnableOutSideCollider, v4);
