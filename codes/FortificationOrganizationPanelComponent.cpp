        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D26A9A & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_2126/*"ActivationTouchFlag"*/);
    byte_4D26A9A = 1;
  }
  this->fields.mainPanel = mainPanel;
  sub_1C9403C(&this->fields.mainPanel, mainPanel);
  this->fields.eventRoot = eventRoot;
  sub_1C9403C(&this->fields.eventRoot, eventRoot);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1C9403C(&this->fields.orgCamera, orgCamera);
  ...
  sub_1C9403C(&static_fields->mScreenCam, mainCamera);
  ...
  {
LABEL_16:
    sub_1C942F0(organizationBg, v16);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1C942F0(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1C942F0(IsEnableOutSideCollider, v4);
