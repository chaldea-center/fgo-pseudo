        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBAE0 & 1) == 0 )
  {
    sub_1C1ABD4(&MapZoom_TypeInfo, method);
    byte_4BCBAE0 = 1;
  }
  v3 = MapZoom_TypeInfo;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBADF & 1) == 0 )
  {
    sub_1C1ABD4(&CTouch_TypeInfo, *(_QWORD *)&eventId);
    sub_1C1ABD4(&StringLiteral_2257/*"ActivationTouchFlag"*/, v14);
    byte_4BCBADF = 1;
  }
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.eventRoot, (int64_t)eventRoot, v15, v16, v17, v18, v19, v20);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.orgCamera, (int64_t)orgCamera, v22, v23, v24, v25, v26, v27);
  ...
  if ( !byte_4BC58B3 )
  {
    sub_1C1ABD4(&CTouch_TypeInfo, v31);
    byte_4BC58B3 = 1;
  }
  v38 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1C1AE30(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1C1AE30(IsEnableOutSideCollider, v4);
