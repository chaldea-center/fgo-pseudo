        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438EA68 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_1903/*"ActivationTouchFlag"*/);
    byte_438EA68 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_B7769C(IsEnableOutSideCollider, v4);
