        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8919 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_2127/*"ActivationTouchFlag"*/);
    byte_4CE8919 = 1;
  }
  this->fields.mainPanel = mainPanel;
  sub_1C7BA8C(&this->fields.mainPanel, mainPanel);
  this->fields.eventRoot = eventRoot;
  sub_1C7BA8C(&this->fields.eventRoot, eventRoot);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1C7BA8C(&this->fields.orgCamera, orgCamera);
  ...
  sub_1C7BA8C(&static_fields->mScreenCam, mainCamera);
  ...
  {
LABEL_16:
    sub_1C7BD40(organizationBg, v16);
  }
  MapZoom__SetZoomSize((MapZoom_o *)organizationBg, this->fields.zoomSize, 1, 0, 0);
  UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)this, (System_String_o *)StringLiteral_2127/*"ActivationTouchFlag"*/, 0.05, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1C7BD40(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1C7BD40(IsEnableOutSideCollider, v4);
