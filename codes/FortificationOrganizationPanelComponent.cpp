        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00175 & 1) == 0 )
  {
    sub_1B640C8(&MapZoom_TypeInfo, method);
    byte_4A00175 = 1;
  }
  v3 = MapZoom_TypeInfo;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00174 & 1) == 0 )
  {
    sub_1B640C8(&CTouch_TypeInfo, *(_QWORD *)&eventId);
    sub_1B640C8(&StringLiteral_2225/*"ActivationTouchFlag"*/, v14);
    byte_4A00174 = 1;
  }
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.eventRoot, (int32_t)eventRoot, v15, v16);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.orgCamera, (int32_t)orgCamera, v18, v19);
  ...
  if ( !byte_49FA30C )
  {
    sub_1B640C8(&CTouch_TypeInfo, v22);
    byte_49FA30C = 1;
  }
  v25 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->mScreenCam, (int32_t)mainCamera, v23, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1B64324(IsEnableOutSideCollider);
