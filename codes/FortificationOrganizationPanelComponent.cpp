        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43554D0 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_1857/*"ActivationTouchFlag"*/);
    byte_43554D0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_B7076C(IsEnableOutSideCollider, v4);
