        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEFB6 & 1) == 0 )
  {
    sub_1B4CF90(&MapZoom_TypeInfo, method);
    byte_49BEFB6 = 1;
  }
  v3 = MapZoom_TypeInfo;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEFB5 & 1) == 0 )
  {
    sub_1B4CF90(&CTouch_TypeInfo, *(_QWORD *)&eventId);
    sub_1B4CF90(&StringLiteral_2135/*"ActivationTouchFlag"*/, v14);
    byte_49BEFB5 = 1;
  }
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.eventRoot, (int32_t)eventRoot, v15, v16);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.orgCamera, (int32_t)orgCamera, v18, v19);
  ...
  if ( !byte_49B8C44 )
  {
    sub_1B4CF90(&CTouch_TypeInfo, v23);
    byte_49B8C44 = 1;
  }
  v26 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&static_fields->mScreenCam, (int32_t)mainCamera, v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1B4D1EC(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1B4D1EC(IsEnableOutSideCollider, v4);
