        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EF60 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_2227/*"ActivationTouchFlag"*/);
    byte_4A5EF60 = 1;
  }
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.eventRoot, (int32_t)eventRoot, v14, v15);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.orgCamera, (int32_t)orgCamera, v17, v18);
  FortificationOrganizationPanelComponent__SetActiveForOrgObj(this, 1, v19);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->mScreenCam, (int32_t)mainCamera, v22, v23);
  ...
  {
LABEL_16:
    sub_1B8880C(organizationBg, v20);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1B8880C(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1B8880C(IsEnableOutSideCollider, v4);
