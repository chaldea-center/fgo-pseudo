        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51119 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_2129/*"ActivationTouchFlag"*/);
    byte_4C51119 = 1;
  }
  this->fields.mainPanel = mainPanel;
  sub_1C3E508(&this->fields.mainPanel, mainPanel);
  this->fields.eventRoot = eventRoot;
  sub_1C3E508(&this->fields.eventRoot, eventRoot);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1C3E508(&this->fields.orgCamera, orgCamera);
  ...
  sub_1C3E508(&static_fields->mScreenCam, mainCamera);
  ...
  {
LABEL_16:
    sub_1C3E7C0(organizationBg, v16);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1C3E7C0(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1C3E7C0(IsEnableOutSideCollider, v4);
