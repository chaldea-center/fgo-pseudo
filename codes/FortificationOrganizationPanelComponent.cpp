        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31D08 & 1) == 0 )
  {
    sub_1B761C0(&MapZoom_TypeInfo, method);
    byte_4A31D08 = 1;
  }
  v3 = MapZoom_TypeInfo;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31D07 & 1) == 0 )
  {
    sub_1B761C0(&CTouch_TypeInfo, *(_QWORD *)&eventId);
    sub_1B761C0(&StringLiteral_2227/*"ActivationTouchFlag"*/, v14);
    byte_4A31D07 = 1;
  }
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.eventRoot, (int32_t)eventRoot, v15, v16);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.orgCamera, (int32_t)orgCamera, v18, v19);
  ...
  if ( !byte_4A2BE16 )
  {
    sub_1B761C0(&CTouch_TypeInfo, v23);
    byte_4A2BE16 = 1;
  }
  v26 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->mScreenCam, (int32_t)mainCamera, v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1B7641C(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1B7641C(IsEnableOutSideCollider, v4);
