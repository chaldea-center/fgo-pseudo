        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A526EF & 1) == 0 )
  {
    sub_1B863B8(&MapZoom_TypeInfo, method);
    byte_4A526EF = 1;
  }
  v3 = MapZoom_TypeInfo;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A526EE & 1) == 0 )
  {
    sub_1B863B8(&CTouch_TypeInfo, *(_QWORD *)&eventId);
    sub_1B863B8(&StringLiteral_2139/*"ActivationTouchFlag"*/, v14);
    byte_4A526EE = 1;
  }
  this->fields.mainPanel = mainPanel;
  sub_1B8635C(
    (CGThumbnailListItem_o *)&this->fields.mainPanel,
    (int32_t)mainPanel,
    (int32_t)orgBgTexture,
    (const MethodInfo *)mainPanel);
  this->fields.eventRoot = eventRoot;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventRoot, (int32_t)eventRoot, v15, v16);
  this->fields.orgCamera = orgCamera;
  p_orgCamera = &this->fields.orgCamera;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.orgCamera, (int32_t)orgCamera, v18, v19);
  ...
  if ( !byte_4A4C172 )
  {
    sub_1B863B8(&CTouch_TypeInfo, v23);
    byte_4A4C172 = 1;
  }
  v26 = CTouch_TypeInfo;
  if ( !CTouch_TypeInfo->_2.cctor_finished )
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&static_fields->mScreenCam, (int32_t)mainCamera, v24, v25);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1B86614(mainPanel, isActive);
  }
  UnityEngine_GameObject__SetActive(mainPanel, isActive, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !orgCamera )
    sub_1B86614(IsEnableOutSideCollider, v4);
