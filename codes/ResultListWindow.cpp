void __fastcall ResultListWindow___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A239F0 & 1) == 0 )
  {
    sub_1B715CC(&ResultListWindow_TypeInfo, v1);
    byte_4A239F0 = 1;
  }
...
void __fastcall ResultListWindow___ctor(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A239EF & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_18759/*"ef_boxitem_fall"*/, v7);
    byte_4A239EF = 1;
  }
  *(_OWORD *)&this->fields.itemDropTime = xmmword_BAB220;
  v8 = StringLiteral_18759/*"ef_boxitem_fall"*/;
  this->fields.aniName = (struct System_String_o *)StringLiteral_18759/*"ef_boxitem_fall"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.aniName, v8, v2, v3);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.dropEffectObjList, (int32_t)v12, v13, v14);
...
void __fastcall ResultListWindow__ClearGridAllChild(ResultListWindow_o *this, UIGrid_o *grid, const MethodInfo *method)
{
  ...
  if ( (byte_4A239ED & 1) == 0 )
  {
    this = (ResultListWindow_o *)sub_1B715CC(&UnityEngine_Object_TypeInfo, grid);
    byte_4A239ED = 1;
  }
  if ( !grid )
    goto LABEL_13;
    ...
    if ( v9 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v11, 0LL, 0LL) )
        {
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
          UnityEngine_Object__Destroy_69257852((UnityEngine_Object_o *)v11, 0LL);
        }
        if ( v9 == ++v10 )
          break;
        skipCollider = this->fields.dropEffectObjList;
...
void __fastcall ResultListWindow__Close(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A239EB & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ResultListWindow_EndClose__, v3);
    byte_4A239EB = 1;
  }
  ...
  ResultListWindow__Close_45547544(this, v4, v5);
}


void __fastcall ResultListWindow__Close_45547544(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A239EC & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ResultListWindow_EndClose__, v6);
    byte_4A239EC = 1;
  }
...
void __fastcall ResultListWindow__EndClose(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( closeCallBack )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.closeCallBack, 0, v2, v3);
...
void __fastcall ResultListWindow__EndOpen(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( openCallBack )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.openCallBack, 0, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A239E0 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_GameObject__Clear__, resultIds);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( gameObject )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.openCallBack, (int32_t)callback, size, v23);
      this->fields.resultIdList = resultIds;
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.resultIdList, (int32_t)resultIds, v28, v29);
      this->fields.rareIdxList = rareIdxs;
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.rareIdxList, (int32_t)rareIdxs, v30, v31);
      this->fields.baseNoList = baseNos;
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.baseNoList, (int32_t)baseNos, v32, v33);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A239E3 & 1) == 0 )
  {
    sub_1B715CC(&ResultListWindow__StartDisp_d__47_TypeInfo, method);
    byte_4A239E3 = 1;
  }
  v3 = sub_1B71818(ResultListWindow__StartDisp_d__47_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A239E4 & 1) == 0 )
  {
    sub_1B715CC(&ResultListWindow__StartRewardAction_d__48_TypeInfo, rewardAction);
    byte_4A239E4 = 1;
  }
  v5 = sub_1B71818(ResultListWindow__StartRewardAction_d__48_TypeInfo);
    ...
    if ( v4 && (int)v4 >= 1 )
    {
      ...
      do
      {
        if ( v8 >= (unsigned int)v4 )
          sub_1B71830(v6, *(_QWORD *)&idx);
        v10 = rareIdxList->m_Items[v8 + 1];
        v6 = System_Int32__Equals_62310612((int32_t)&v10, idx, 0LL);
        if ( v6 )
          break;
        rareIdxList = this->fields.rareIdxList;
        if ( !rareIdxList )
          sub_1B71828(v6, *(_QWORD *)&idx);
...
void __fastcall ResultListWindow__endDisp(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A239E9 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_5962/*"EndOpen"*/, method);
    sub_1B715CC(&StringLiteral_23095/*"setDisp"*/, v3);
    byte_4A239E9 = 1;
  }
  ...
  if ( this->fields.playCnt >= maxPlayCnt )
  {
    ...
    if ( isDischargeGetEffectItem )
    {
      UnityEngine_MonoBehaviour__Invoke(
        ...
        (System_String_o *)StringLiteral_5962/*"EndOpen"*/,
        0.5,
        0LL);
    }
...
LABEL_6:
  ...
  else
  {
    UnityEngine_MonoBehaviour__Invoke(
      (UnityEngine_MonoBehaviour_o *)this,
      (System_String_o *)StringLiteral_23095/*"setDisp"*/,
      0.00001,
      0LL);
...
void __fastcall ResultListWindow__playEffectDrop(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A239E7 & 1) == 0 )
  {
    sub_1B715CC(&BoxGachaUtility_TypeInfo, method);
    sub_1B715CC(&Method_System_Collections_Generic_List_GameObject__Add__, v3);
    sub_1B715CC(&StringLiteral_18757/*"ef_boxitem_drop_rare"*/, v4);
    sub_1B715CC(&StringLiteral_18756/*"ef_boxitem_drop"*/, v5);
    sub_1B715CC(&StringLiteral_23255/*"showResultItem"*/, v6);
    byte_4A239E7 = 1;
  }
  ...
  if ( this->fields.isRare )
    v10 = (System_String_o **)&StringLiteral_18757/*"ef_boxitem_drop_rare"*/;
  else
    v10 = (System_String_o **)&StringLiteral_18756/*"ef_boxitem_drop"*/;
  v11 = *v10;
  if ( maxPlayCnt < 11 )
  {
    v9 = 0;
    ...
    if ( skipCollider )
    {
      ...
      if ( v22 )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v25 + 32) = v14;
          sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 32), (int32_t)v14, v19, v20);
        }
        goto LABEL_30;
      }
    }
...
LABEL_30:
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_23255/*"showResultItem"*/,
...
void __fastcall ResultListWindow__setDisp(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&BoxGachaUtility_TypeInfo, method);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponentInChildren_Animation___, v3);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponentInChildren_SimpleAnimation___, v4);
    ...
    sub_1B715CC(&StringLiteral_22494/*"playEffectDrop"*/, v8);
    sub_1B715CC(&StringLiteral_18759/*"ef_boxitem_fall"*/, v9);
    byte_4A239E6 = 1;
  }
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.dispObj, (int32_t)Item, v13, v14);
  ...
  resultItemObjList = (System_Collections_Generic_List_object__o *)BoxGachaResultEffectComponent__getEffect(
                                                                     (System_String_o *)StringLiteral_18759/*"ef_boxitem_fall"*/,
                                                                     transform,
                                                                     v22);
  if ( !resultItemObjList )
    goto LABEL_38;
  ...
  *(UnityEngine_Vector3_o *)&v26 = UnityEngine_Transform__get_localPosition(
  ...
  {
LABEL_38:
    sub_1B71828(resultItemObjList, method);
  }
  ...
  else
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v35 + 4), (int32_t)v23, v29, v30);
  }
  ...
  if ( ((unsigned __int8)resultItemObjList & 1) == 0 )
  {
    ...
    if ( v37 )
    {
      UnityEngine_Animation__Play_69002944((UnityEngine_Animation_o *)v37, this->fields.aniName, 0LL);
      goto LABEL_37;
    }
    goto LABEL_38;
  }
  if ( !ComponentInChildren_object )
    goto LABEL_38;
  SimpleAnimation__Play_63643176((SimpleAnimation_o *)ComponentInChildren_object, this->fields.aniName, 0LL);
LABEL_37:
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_22494/*"playEffectDrop"*/,
...
void __fastcall ResultListWindow__setDispResultListBg(ResultListWindow_o *this, bool isDisp, const MethodInfo *method)
{
  ...
  if ( !firstLineGrid
    ...
    || (firstLineGrid = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(firstLineGrid, 0LL)) == 0LL )
  {
    sub_1B71828(firstLineGrid, isDisp);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)firstLineGrid, isDisp, 0LL);
}
...
void __fastcall ResultListWindow__setResultItem(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&BoxGachaUtility_TypeInfo, method);
    sub_1B715CC(&Method_DataManager_GetMaster_BoxGachaBaseMaster___, v3);
    sub_1B715CC(&Method_DataManager_GetMaster_GiftMaster___, v4);
    sub_1B715CC(&DataManager_TypeInfo, v5);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_ResultItemComponent___, v6);
    ...
    sub_1B715CC(&StringLiteral_12908/*"StartDisp"*/, v13);
    byte_4A239E2 = 1;
  }
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.resultItemObjList, (int32_t)v14, v15, v16);
  ...
  if ( max_length >= 1 )
  {
    ...
    do
    {
      ...
      Master_object = (__int64)DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_BoxGachaBaseMaster___);
      baseNoList = this->fields.baseNoList;
      if ( !baseNoList )
        goto LABEL_87;
      if ( v28 >= (unsigned __int64)baseNoList->max_length )
        sub_1B71830(Master_object, v18);
      if ( !Master_object )
        goto LABEL_87;
      ...
      if ( !byte_4A1A756 )
      {
        Master_object = sub_1B715CC(&UnityEngine_Vector3_TypeInfo, v18);
        byte_4A1A756 = 1;
      }
      if ( !v36 )
        goto LABEL_87;
      ...
      Master_object = (__int64)UnityEngine_GameObject__GetComponent_object_(
                                 v35,
                                 (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_ResultItemComponent___);
      ...
      if ( max_length >= 11 )
      {
        ...
        *(_QWORD *)(Master_object + 32) = resultScrollView;
        sub_1B71570((ServantStatusBattleListViewItem_o *)(Master_object + 32), (int32_t)resultScrollView, v52, v53);
        v26 = v45;
        v27 = v44;
        max_length = v76;
      }
...
LABEL_61:
            ...
            else
            {
              ...
              *(_QWORD *)(v64 + 32) = v35;
              sub_1B71570((ServantStatusBattleListViewItem_o *)(v64 + 32), (int32_t)v35, v59, v60);
            }
          }
        }
      }
...
LABEL_79:
  ...
  if ( max_length < 11 )
    ...
    UnityEngine_MonoBehaviour__StartCoroutine(
      (UnityEngine_MonoBehaviour_o *)this,
      (System_String_o *)StringLiteral_12908/*"StartDisp"*/,
      0LL);
}
...
void __fastcall ResultListWindow__showResultEffect(ResultListWindow_o *this, const MethodInfo *method)
{
  if ( (byte_4A239E5 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_23095/*"setDisp"*/, method);
    byte_4A239E5 = 1;
  }
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
...
void __fastcall ResultListWindow__showResultItem(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A239E8 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_18951/*"endDisp"*/, method);
    byte_4A239E8 = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_18951/*"endDisp"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A239F1 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction__Add__, method);
    sub_1B715CC(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction___ctor__, v3);
    sub_1B715CC(&Method_System_Collections_Generic_List_GameObject__get_Count__, v4);
    sub_1B715CC(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction__get_Count__, v5);
    sub_1B715CC(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction__get_Item__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_GameObject__get_Item__, v7);
    sub_1B715CC(&System_Collections_Generic_List_ResultListWindow_RewardAction__TypeInfo, v8);
    sub_1B715CC(&ResultListWindow_TypeInfo, v9);
    sub_1B715CC(&ResultListWindow_RewardAction_TypeInfo, v10);
    sub_1B715CC(&UnityEngine_WaitForSeconds_TypeInfo, v11);
    sub_1B715CC(&StringLiteral_5962/*"EndOpen"*/, v12);
    byte_4A239F1 = 1;
  }
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.__2__current, (int32_t)v15, v16, v17);
      result = 1;
      this->fields.__1__state = 1;
      return result;
    }
  ...
  while ( 1 )
  {
    v20 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_ResultListWindow_RewardAction__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v20,
      (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_ResultListWindow_RewardAction___ctor__);
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields._listRewardAction_5__2, (int32_t)v20, v22, v23);
    if ( !_4__this )
      goto LABEL_69;
    v24 = 0;
    while ( v24 + _4__this->fields.playCnt < _4__this->fields.maxPlayCnt )
    {
      v25 = sub_1B71818(ResultListWindow_RewardAction_TypeInfo);
      ...
      *(float *)(v25 + 24) = v28;
      ...
      else
      {
        ...
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v38 + 4), v25, v26, v27);
      }
      if ( ++v24 == 10 )
        break;
    }
    ...
    if ( v39 >= 1 )
    {
      ...
      do
      {
        listRewardAction_5__2 = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                               listRewardAction_5__2,
                                                                               v40,
                                                                               (const MethodInfo_34CFF90 *)Method_System_Collections_Generic_List_ResultListWindow_RewardAction__get_Item__);
        if ( !*p_listRewardAction_5__2 )
          goto LABEL_69;
        ...
        listRewardAction_5__2 = (System_Collections_Generic_List_object__o *)UnityEngine_MonoBehaviour__StartCoroutine_69243124(
...
LABEL_58:
          ...
          if ( listRewardAction_5__2 )
          {
            ...
            if ( _4__this->fields.isDischargeGetEffectItem )
            {
              ...
              v53 = (System_String_o *)StringLiteral_5962/*"EndOpen"*/;
            }
            else
            {
...
LABEL_69:
      sub_1B71828(listRewardAction_5__2, method);
    }
    *v49 = 0LL;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields._listRewardAction_5__2, 0, v47, v48);
  }
  this->fields.__2__current = 0LL;
  p__2__current = &this->fields.__2__current;
  sub_1B71570((ServantStatusBattleListViewItem_o *)p__2__current, 0, v47, v48);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_ResultListWindow__StartDisp_d__47_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&BoxGachaUtility_TypeInfo, method);
    sub_1B715CC(&Method_UnityEngine_GameObject_AddComponent_SyncPositionComponent___, v4);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponentInChildren_Animation___, v5);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponentInChildren_SimpleAnimation___, v6);
    ...
    sub_1B715CC(&ResultListWindow_TypeInfo, v10);
    sub_1B715CC(&UnityEngine_WaitForSeconds_TypeInfo, v11);
    sub_1B715CC(&StringLiteral_18757/*"ef_boxitem_drop_rare"*/, v12);
    sub_1B715CC(&StringLiteral_18758/*"ef_boxitem_drop_scalable"*/, v13);
    sub_1B715CC(&StringLiteral_18760/*"ef_boxitem_fall_scalable"*/, v14);
    this = (ResultListWindow__StartRewardAction_d__48_o *)sub_1B715CC(&StringLiteral_5962/*"EndOpen"*/, v15);
    byte_4A239F2 = 1;
  }
...
LABEL_6:
      ...
      if ( v17 < rewardAction->fields.index )
      {
        if ( _4__this )
        {
          ...
          sub_1B71570(p__2__current, (int32_t)v21, v23, v24);
          result = 1;
...
LABEL_84:
      ...
      if ( !isSkip || v48 )
      {
        ...
        this = (ResultListWindow__StartRewardAction_d__48_o *)BoxGachaResultEffectComponent__getEffect(
                                                                (System_String_o *)StringLiteral_18760/*"ef_boxitem_fall_scalable"*/,
                                                                transform,
                                                                v52);
        if ( !this )
          goto LABEL_84;
        ...
        this = (ResultListWindow__StartRewardAction_d__48_o *)UnityEngine_GameObject__AddComponent_object_(
                                                                ...
                                                                (const MethodInfo_2EAA8B0 *)Method_UnityEngine_GameObject_AddComponent_SyncPositionComponent___);
        ...
        sub_1B71570((ServantStatusBattleListViewItem_o *)&v55->fields.__4__this, (int32_t)this, v56, v57);
        ...
        else
        {
          ...
          *(_QWORD *)(v65 + 32) = v53;
          sub_1B71570((ServantStatusBattleListViewItem_o *)(v65 + 32), (int32_t)v53, v59, v60);
        }
        if ( !_4__this->fields.isSkip )
        {
          ComponentInChildren_object = UnityEngine_GameObject__GetComponentInChildren_object_(
          ...
          else
          {
            ...
            if ( ((unsigned __int8)this & 1) != 0 )
            {
              if ( !v67 )
                goto LABEL_84;
              UnityEngine_Animation__Play_69002944((UnityEngine_Animation_o *)v67, _4__this->fields.aniName, 0LL);
            }
          }
        }
      }
      itemDropTime = _4__this->fields.itemDropTime;
      v71 = (UnityEngine_WaitForSeconds_o *)sub_1B71818(UnityEngine_WaitForSeconds_TypeInfo);
      ...
      sub_1B71570(v68, (int32_t)v71, v72, v73);
      v69 = 2;
LABEL_83:
    ...
    case 2:
      ...
      v29 = (System_String_o **)(_4__this->fields.isRare ? &StringLiteral_18757/*"ef_boxitem_drop_rare"*/ : &StringLiteral_18758/*"ef_boxitem_drop_scalable"*/);
      v30 = *v29;
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&v35->fields.__4__this, (int32_t)this, v36, v37);
      ...
      else
      {
        ...
        *(_QWORD *)(v43 + 32) = v33;
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v43 + 32), (int32_t)v33, v26, v27);
      }
LABEL_76:
      v3->fields.__2__current = 0LL;
      v68 = (ServantStatusBattleListViewItem_o *)&v3->fields.__2__current;
      sub_1B71570(v68, 0, v26, v27);
      v69 = 3;
      goto LABEL_83;
    case 3:
      v3->fields.__1__state = -1;
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1B71818(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1B715E0(&Method_ResultListWindow__StartRewardAction_d__48_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
