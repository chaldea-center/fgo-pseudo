void __fastcall ResultListWindow___cctor(const MethodInfo *method)
{
  if ( (byte_42B28ED & 1) == 0 )
  {
    sub_B52984(&ResultListWindow_TypeInfo);
    byte_42B28ED = 1;
  }
...
void __fastcall ResultListWindow___ctor(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B28EC & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18299/*"ef_boxitem_fall"*/);
    byte_42B28EC = 1;
  }
  *(_OWORD *)&this->fields.itemDropTime = xmmword_328D2A0;
  v9 = (System_Int32_array **)StringLiteral_18299/*"ef_boxitem_fall"*/;
  this->fields.aniName = (struct System_String_o *)StringLiteral_18299/*"ef_boxitem_fall"*/;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.aniName, v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall ResultListWindow__ClearGridAllChild(ResultListWindow_o *this, UIGrid_o *grid, const MethodInfo *method)
{
  ...
  if ( (byte_42B28EA & 1) == 0 )
  {
    this = (ResultListWindow_o *)sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42B28EA = 1;
  }
  if ( !grid )
    goto LABEL_13;
...
void __fastcall ResultListWindow__Close(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B28E8 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_ResultListWindow_EndClose__);
    byte_42B28E8 = 1;
  }
  ...
  ResultListWindow__Close_29764212(this, v3, v4);
}


void __fastcall ResultListWindow__Close_29764212(
...
void __fastcall ResultListWindow__EndClose(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( closeCallBack )
  {
    ...
    sub_B52920((BattleServantConfConponent_o *)&this->fields.closeCallBack, 0LL, v2, v3, v4, v5, v6, v7);
...
void __fastcall ResultListWindow__EndOpen(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( openCallBack )
  {
    ...
    sub_B52920((BattleServantConfConponent_o *)&this->fields.openCallBack, 0LL, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B28E0 & 1) == 0 )
  {
    sub_B52984(&ResultListWindow__StartDisp_d__47_TypeInfo);
    byte_42B28E0 = 1;
  }
  v3 = sub_B52A54(ResultListWindow__StartDisp_d__47_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B28E1 & 1) == 0 )
  {
    sub_B52984(&ResultListWindow__StartRewardAction_d__48_TypeInfo);
    byte_42B28E1 = 1;
  }
  v5 = sub_B52A54(ResultListWindow__StartRewardAction_d__48_TypeInfo);
  ...
  if ( rareIdxList )
  {
    ...
    if ( v4 && (int)v4 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v6 = System_Int32__Equals_39386936((int32_t)&v12, idx, 0LL);
        if ( v6 )
          break;
        rareIdxList = this->fields.rareIdxList;
        if ( !rareIdxList )
...
void __fastcall ResultListWindow__endDisp(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B28E6 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_6013/*"EndOpen"*/);
    sub_B52984(&StringLiteral_22197/*"setDisp"*/);
    byte_42B28E6 = 1;
  }
  ...
  if ( this->fields.playCnt >= maxPlayCnt )
  {
    ...
    if ( isDischargeGetEffectItem )
    {
      UnityEngine_MonoBehaviour__Invoke(
        ...
        (System_String_o *)StringLiteral_6013/*"EndOpen"*/,
        0.5,
        0LL);
    }
...
LABEL_6:
  ...
  else
  {
    UnityEngine_MonoBehaviour__Invoke(
      (UnityEngine_MonoBehaviour_o *)this,
      (System_String_o *)StringLiteral_22197/*"setDisp"*/,
      0.00001,
      0LL);
...
void __fastcall ResultListWindow__playEffectDrop(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B28E4 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18297/*"ef_boxitem_drop_rare"*/);
    sub_B52984(&StringLiteral_18296/*"ef_boxitem_drop"*/);
    sub_B52984(&StringLiteral_22305/*"showResultItem"*/);
    byte_42B28E4 = 1;
  }
  ...
  if ( this->fields.isRare )
    v4 = (System_String_o **)&StringLiteral_18297/*"ef_boxitem_drop_rare"*/;
  else
    v4 = (System_String_o **)&StringLiteral_18296/*"ef_boxitem_drop"*/;
  v5 = *v4;
...
LABEL_32:
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_22305/*"showResultItem"*/,
...
void __fastcall ResultListWindow__setDisp(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B28E3 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Collections_Generic_List_GameObject__get_Item__);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_21667/*"playEffectDrop"*/);
    this = (ResultListWindow_o *)sub_B52984(&StringLiteral_18299/*"ef_boxitem_fall"*/);
    byte_42B28E3 = 1;
  }
  ...
  sub_B52920((BattleServantConfConponent_o *)&v8->fields.dispObj, v11, v2, v3, v4, v5, v6, v7);
  ...
  this = (ResultListWindow_o *)BoxGachaResultEffectComponent__getEffect(
                                 (System_String_o *)StringLiteral_18299/*"ef_boxitem_fall"*/,
                                 v19,
                                 0LL);
  if ( !this )
    goto LABEL_42;
...
LABEL_42:
  ...
  if ( !v8->fields.isSkip )
  {
    ...
    else
    {
      ...
      if ( v28 )
      {
        UnityEngine_Animation__Play_51067744((UnityEngine_Animation_o *)v28, v8->fields.aniName, 0LL);
        goto LABEL_41;
      }
    }
    goto LABEL_42;
...
LABEL_41:
  UnityEngine_MonoBehaviour__Invoke(
    ...
    (System_String_o *)StringLiteral_21667/*"playEffectDrop"*/,
...
void __fastcall ResultListWindow__setDispResultListBg(ResultListWindow_o *this, bool isDisp, const MethodInfo *method)
{
  ...
  if ( !firstLineGrid
    ...
    || (firstLineGrid = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(firstLineGrid, 0LL)) == 0LL )
  {
    sub_B52A5C(firstLineGrid, isDisp);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)firstLineGrid, isDisp, 0LL);
}
...
void __fastcall ResultListWindow__setResultItem(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&BoxGachaUtility_TypeInfo);
    sub_B52984(&Method_DataManager_GetMaster_BoxGachaBaseMaster___);
    sub_B52984(&Method_DataManager_GetMaster_GiftMaster___);
    sub_B52984(&DataManager_TypeInfo);
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_ResultItemComponent___);
  ...
  Master_WarQuestSelectionMaster = (char *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_GiftMaster___);
  resultIdList = this->fields.resultIdList;
  ...
  if ( max_length >= 1 )
  {
    ...
    do
    {
      ...
      Master_WarQuestSelectionMaster = (char *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_BoxGachaBaseMaster___);
      baseNoList = this->fields.baseNoList;
      if ( !baseNoList )
        goto LABEL_85;
      if ( v19 >= (unsigned __int64)baseNoList->max_length )
      {
        v65 = sub_B52A88(Master_WarQuestSelectionMaster);
        sub_B52A28(v65, 0LL);
      }
      if ( !Master_WarQuestSelectionMaster )
        goto LABEL_85;
      ...
      *(UnityEngine_Vector3_o *)&v29 = UnityEngine_Vector3__get_one(0LL);
      ...
      Master_WarQuestSelectionMaster = (char *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                 v27,
                                                 (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_ResultItemComponent___);
...
LABEL_77:
  ...
  if ( max_length < 11 )
    ...
    UnityEngine_MonoBehaviour__StartCoroutine(
      (UnityEngine_MonoBehaviour_o *)this,
      (System_String_o *)StringLiteral_13139/*"StartDisp"*/,
      0LL);
}
...
void __fastcall ResultListWindow__showResultItem(ResultListWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B28E5 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18479/*"endDisp"*/);
    byte_42B28E5 = 1;
  }
  ...
  UnityEngine_MonoBehaviour__Invoke(
    (UnityEngine_MonoBehaviour_o *)this,
    (System_String_o *)StringLiteral_18479/*"endDisp"*/,
        ...
        const MethodInfo *method)
{
  ...
  ResultListWindow_c *v60; // x0
  BattleServantConfConponent_o *p__2__current; // x20

  v8 = this;
  if ( (byte_42AF2B6 & 1) == 0 )
  {
    sub_B52984(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction__Add__);
    sub_B52984(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction___ctor__);
    sub_B52984(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction__get_Count__);
    sub_B52984(&Method_System_Collections_Generic_List_GameObject__get_Count__);
    sub_B52984(&Method_System_Collections_Generic_List_GameObject__get_Item__);
    sub_B52984(&Method_System_Collections_Generic_List_ResultListWindow_RewardAction__get_Item__);
    sub_B52984(&System_Collections_Generic_List_ResultListWindow_RewardAction__TypeInfo);
    sub_B52984(&ResultListWindow_TypeInfo);
    sub_B52984(&ResultListWindow_RewardAction_TypeInfo);
    sub_B52984(&UnityEngine_WaitForSeconds_TypeInfo);
    this = (ResultListWindow__StartDisp_d__47_o *)sub_B52984(&StringLiteral_6013/*"EndOpen"*/);
    byte_42AF2B6 = 1;
  }
  ...
  if ( _1__state != 1 )
  {
    if ( !_1__state )
    {
      ...
      v8->fields.__2__current = (Il2CppObject *)v11;
      sub_B52920(
  ...
  while ( 1 )
  {
    v21 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B52A54(System_Collections_Generic_List_ResultListWindow_RewardAction__TypeInfo);
    System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
      v21,
      (const MethodInfo_2FF0940 *)Method_System_Collections_Generic_List_ResultListWindow_RewardAction___ctor__);
    p_listRewardAction_5__2->klass = (BattleServantConfConponent_c *)v21;
    sub_B52920(p_listRewardAction_5__2, (System_Int32_array **)v21, v22, v23, v24, v25, v26, v27);
    if ( !_4__this )
      goto LABEL_77;
    v28 = 0;
    while ( (signed int)(v28 + _4__this->fields.playCnt) < _4__this->fields.maxPlayCnt )
    {
      v29 = sub_B52A54(ResultListWindow_RewardAction_TypeInfo);
      System_Object___ctor((Il2CppObject *)v29, 0LL);
      if ( !v29 )
        goto LABEL_77;
      *(_DWORD *)(v29 + 16) = v28;
      v30 = 0.0;
      v31 = v28 + _4__this->fields.playCnt;
      *(_DWORD *)(v29 + 20) = v31;
      ...
      *(float *)(v29 + 24) = v30;
      ...
      System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
        ...
        (const MethodInfo_2FF1604 *)Method_System_Collections_Generic_List_ResultListWindow_RewardAction__Add__);
      if ( v28++ > 8 )
        break;
    }
    if ( !p_listRewardAction_5__2->klass )
    ...
    while ( 1 )
    {
      v40 = listRewardAction_5__2[6];
      if ( (int)v38 >= v40 )
        break;
      if ( v40 <= (unsigned int)v38 )
        System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
      v41 = *(_QWORD *)(*((_QWORD *)listRewardAction_5__2 + 2) + v39);
      if ( listRewardAction_5__2[6] <= (unsigned int)v38 )
        System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
      started = ResultListWindow__StartRewardAction(
                  _4__this,
                  *(ResultListWindow_RewardAction_o **)(*((_QWORD *)listRewardAction_5__2 + 2) + 8 * v38 + 32),
                  0LL);
      this = (ResultListWindow__StartDisp_d__47_o *)UnityEngine_MonoBehaviour__StartCoroutine_35611808(
      ...
      if ( v41 )
      {
        *(_QWORD *)(v41 + 32) = this;
        sub_B52920(
          (BattleServantConfConponent_o *)(v41 + 32),
    ...
    if ( !v40 || v40 == _4__this->fields.maxPlayCnt )
      goto LABEL_65;
LABEL_38:
    v49 = listRewardAction_5__2[6];
    if ( !v49 )
      System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
    v50 = *(_QWORD *)(*((_QWORD *)listRewardAction_5__2 + 2) + 8LL * (v49 - 1) + 32);
    if ( !v50 )
      goto LABEL_77;
    if ( *(_BYTE *)(v50 + 28) )
    {
    ...
    if ( _4__this->fields.isSkip )
    {
      ...
      if ( p_listRewardAction_5__2->klass )
      {
        ...
        while ( 1 )
        {
          ...
          if ( (int)v52 >= namespaze )
            break;
          if ( namespaze <= (unsigned int)v52 )
            System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
          v54 = *(_QWORD *)&klass->_1.name[8 * v52 + 32];
          if ( v54 )
          {
            UnityEngine_MonoBehaviour__StopCoroutine_35612476(
              (UnityEngine_MonoBehaviour_o *)_4__this,
              *(UnityEngine_Coroutine_o **)(v54 + 32),
              0LL);
            klass = p_listRewardAction_5__2->klass;
            ++v52;
            if ( p_listRewardAction_5__2->klass )
        ...
        if ( resultItemObjList )
        {
          ...
          while ( 1 )
          {
            ...
            if ( size <= (unsigned int)v56 )
              System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
            this = (ResultListWindow__StartDisp_d__47_o *)resultItemObjList->fields._items->m_Items[v56];
            if ( this )
            {
...
LABEL_65:
          ...
          if ( this )
          {
            ...
            else
            {
              ...
              EFFECT_PLAY_TIME = v60->static_fields->EFFECT_PLAY_TIME;
              v59 = (System_String_o *)StringLiteral_6013/*"EndOpen"*/;
            }
            UnityEngine_MonoBehaviour__Invoke((UnityEngine_MonoBehaviour_o *)_4__this, v59, EFFECT_PLAY_TIME, 0LL);
            return 0;
          }
        }
      }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_ResultListWindow__StartDisp_d__47_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  struct ResultListWindow_RewardAction_o *v29; // x8
  struct System_Collections_Generic_List_GameObject__o *v30; // x24
  __int64 v31; // x25
  ResultListWindow__StartRewardAction_d__48_o *v32; // x22
  ...
  if ( (byte_42AF2B7 & 1) == 0 )
  {
    sub_B52984(&BoxGachaResultEffectComponent_TypeInfo);
    sub_B52984(&BoxGachaUtility_TypeInfo);
    sub_B52984(&Method_UnityEngine_GameObject_AddComponent_SyncPositionComponent___);
    sub_B52984(&Method_UnityEngine_GameObject_GetComponentInChildren_Animation___);
    sub_B52984(&Method_UnityEngine_GameObject_GetComponentInChildren_SimpleAnimation___);
    sub_B52984(&Method_System_Collections_Generic_List_GameObject__Add__);
    sub_B52984(&Method_System_Collections_Generic_List_GameObject__get_Item__);
    ...
    sub_B52984(&UnityEngine_WaitForSeconds_TypeInfo);
    sub_B52984(&StringLiteral_18297/*"ef_boxitem_drop_rare"*/);
    sub_B52984(&StringLiteral_18298/*"ef_boxitem_drop_scalable"*/);
    sub_B52984(&StringLiteral_18300/*"ef_boxitem_fall_scalable"*/);
    this = (ResultListWindow__StartRewardAction_d__48_o *)sub_B52984(&StringLiteral_6013/*"EndOpen"*/);
    byte_42AF2B7 = 1;
  }
...
LABEL_97:
      ...
      v43 = ResultListWindow__checkRare(_4__this, rewardAction->fields.playCnt, 0LL);
      _4__this->fields.isRare = v43;
      if ( v43 || !_4__this->fields.isSkip )
      {
        ...
        this = (ResultListWindow__StartRewardAction_d__48_o *)BoxGachaResultEffectComponent__getEffect(
                                                                (System_String_o *)StringLiteral_18300/*"ef_boxitem_fall_scalable"*/,
                                                                transform,
                                                                0LL);
        if ( !this )
          goto LABEL_97;
        ...
        this = (ResultListWindow__StartRewardAction_d__48_o *)UnityEngine_GameObject__AddComponent_UnitySynchronizationContext_SynchronizationContextBehavoir_(
                                                                ...
                                                                (const MethodInfo_1B7B0BC *)Method_UnityEngine_GameObject_AddComponent_SyncPositionComponent___);
        v47 = v2->fields.rewardAction;
        if ( !v47 )
          goto LABEL_97;
        resultItemObjList = _4__this->fields.resultItemObjList;
        if ( !resultItemObjList )
          goto LABEL_97;
        playCnt = v47->fields.playCnt;
        v50 = this;
        if ( resultItemObjList->fields._size <= (unsigned int)playCnt )
          System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
        ...
        if ( !v50 )
          goto LABEL_97;
        SyncPositionComponent__SetTarget((SyncPositionComponent_o *)v50, (UnityEngine_Transform_o *)this, 0LL);
        if ( maxPlayCnt >= 11 )
        {
          ...
          GameObjectExtensions__SetLocalScale(v46, v51->static_fields->CHANGE_MAX_DRAW_EFFECT_SCALE, 0LL);
        }
        ...
        if ( !_4__this->fields.isSkip )
        {
          ComponentInChildren_Dropdown_DropdownItem = (UnityEngine_Object_o *)UnityEngine_GameObject__GetComponentInChildren_Dropdown_DropdownItem_(
                                                                                v46,
                                                                                (const MethodInfo_1B7B264 *)Method_UnityEngine_GameObject_GetComponentInChildren_SimpleAnimation___);
          v53 = (UnityEngine_Object_o *)UnityEngine_GameObject__GetComponentInChildren_Dropdown_DropdownItem_(
                                          v46,
                                          (const MethodInfo_1B7B264 *)Method_UnityEngine_GameObject_GetComponentInChildren_Animation___);
          if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
            && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          ...
          else
          {
            ...
            this = (ResultListWindow__StartRewardAction_d__48_o *)UnityEngine_Object__op_Inequality(v53, 0LL, 0LL);
            if ( ((unsigned __int8)this & 1) != 0 )
            {
              if ( !v53 )
                goto LABEL_97;
              UnityEngine_Animation__Play_51067744((UnityEngine_Animation_o *)v53, _4__this->fields.aniName, 0LL);
            }
          }
        }
      }
      itemDropTime = _4__this->fields.itemDropTime;
      v55 = (UnityEngine_WaitForSeconds_o *)sub_B52A54(UnityEngine_WaitForSeconds_TypeInfo);
      UnityEngine_WaitForSeconds___ctor(v55, itemDropTime, 0LL);
      v2->fields.__2__current = (Il2CppObject *)v55;
      v34 = (BattleServantConfConponent_o *)&v2->fields.__2__current;
      sub_B52920(v34, (System_Int32_array **)v55, v56, v57, v58, v59, v60, v61);
      v35 = 2;
LABEL_96:
      *(_DWORD *)&v34[-1].fields.isOpenAfter = v35;
      return 1;
    case 2:
      v2->fields.__1__state = -1;
      if ( !_4__this )
...
LABEL_15:
      this = (ResultListWindow__StartRewardAction_d__48_o *)_4__this->fields.effectRoot;
      if ( isRare )
        v24 = (System_String_o **)&StringLiteral_18297/*"ef_boxitem_drop_rare"*/;
      else
        v24 = (System_String_o **)&StringLiteral_18298/*"ef_boxitem_drop_scalable"*/;
      if ( !this )
        goto LABEL_97;
      v25 = _4__this->fields.maxPlayCnt;
      v26 = *v24;
      ...
      this = (ResultListWindow__StartRewardAction_d__48_o *)BoxGachaResultEffectComponent__getEffect(v26, v27, 0LL);
      if ( !this )
        goto LABEL_97;
      ...
      if ( !v30 )
        goto LABEL_97;
      v31 = v29->fields.playCnt;
      v32 = this;
      if ( v30->fields._size <= (unsigned int)v31 )
        System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
      this = (ResultListWindow__StartRewardAction_d__48_o *)v30->fields._items->m_Items[v31];
      if ( !this )
        goto LABEL_97;
      this = (ResultListWindow__StartRewardAction_d__48_o *)UnityEngine_GameObject__get_transform(
                                                              (UnityEngine_GameObject_o *)this,
      ...
      if ( !v32 )
        goto LABEL_97;
      SyncPositionComponent__SetTarget((SyncPositionComponent_o *)v32, (UnityEngine_Transform_o *)this, 0LL);
      if ( v25 >= 11 )
      {
        v33 = BoxGachaUtility_TypeInfo;
        if ( (BYTE3(BoxGachaUtility_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        ...
        GameObjectExtensions__SetLocalScale(v28, v33->static_fields->CHANGE_MAX_DRAW_EFFECT_SCALE, 0LL);
      }
      if ( _4__this->fields.isRare )
        goto LABEL_37;
...
LABEL_37:
      ...
      v34 = (BattleServantConfConponent_o *)&v2->fields.__2__current;
      sub_B52920(v34, 0LL, v17, v18, v19, v20, v21, v22);
      v35 = 3;
      goto LABEL_96;
    case 3:
      v2->fields.__1__state = -1;
      if ( !_4__this )
        goto LABEL_97;
      v36 = v2->fields.rewardAction;
      if ( !v36 )
        goto LABEL_97;
      v37 = _4__this->fields.resultItemObjList;
      if ( !v37 )
        goto LABEL_97;
      v38 = v36->fields.playCnt;
      if ( v37->fields._size <= (unsigned int)v38 )
        System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
      this = (ResultListWindow__StartRewardAction_d__48_o *)v37->fields._items->m_Items[v38];
      if ( !this )
        goto LABEL_97;
      UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)this, 1, 0LL);
      v39 = v2->fields.rewardAction;
      if ( !v39 )
        goto LABEL_97;
      v39->fields.isEnd = 1;
      if ( _4__this->fields.isDischargeGetEffectItem )
      ...
      if ( !v40 )
        goto LABEL_97;
      if ( v40->fields.playCnt == _4__this->fields.maxPlayCnt - 1 )
      {
        v41 = ResultListWindow_TypeInfo;
        if ( (BYTE3(ResultListWindow_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
          && !ResultListWindow_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(ResultListWindow_TypeInfo);
        ...
        UnityEngine_MonoBehaviour__Invoke(
          (UnityEngine_MonoBehaviour_o *)_4__this,
          (System_String_o *)StringLiteral_6013/*"EndOpen"*/,
          v41->static_fields->EFFECT_PLAY_TIME,
          0LL);
      }
      return 0;
    default:
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_B52A54(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_B52988(&Method_ResultListWindow__StartRewardAction_d__48_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
