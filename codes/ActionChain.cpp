        ...
        const MethodInfo *method)
{
  if ( (byte_4A0D474 & 1) == 0 )
  {
    sub_1B686D4(&Method_ActionChainBase_ChainableActionBase___ctor__, chainableActions);
    byte_4A0D474 = 1;
  }
  ActionChainBase_object____ctor(
    (ActionChainBase_T__o *)this,
    (System_Object_array *)chainableActions,
    (const MethodInfo_3152F14 *)Method_ActionChainBase_ChainableActionBase___ctor__);
}


void __fastcall ActionChain___ctor_46345900(
        ActionChain_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0D475 & 1) == 0 )
  {
    sub_1B686D4(&Method_ActionChainBase_ChainableActionBase__AddRange__, actions);
    byte_4A0D475 = 1;
  }
  ...
  ActionChainBase_object___AddRange(
    (ActionChainBase_T__o *)this,
    v5,
    (const MethodInfo_3152FC8 *)Method_ActionChainBase_ChainableActionBase__AddRange__);
  return this;
}
