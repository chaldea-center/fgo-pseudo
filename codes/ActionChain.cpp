void ActionChain___ctor(ActionChain_o *this, ChainableActionBase_array *chainableActions, const MethodInfo *method)
{
  if ( (byte_4E7BC8F & 1) == 0 )
  {
    sub_1D0F0B4(&Method_ActionChainBase_ChainableActionBase___ctor__);
    byte_4E7BC8F = 1;
  }
  ActionChainBase_object____ctor(
    (ActionChainBase_T__o *)this,
    (System_Object_array *)chainableActions,
    (const MethodInfo_358C3D4 *)Method_ActionChainBase_ChainableActionBase___ctor__);
}


void ActionChain___ctor_50441276(ActionChain_o *this, System_Action_Action__array *actions, const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7BC90 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_ActionChainBase_ChainableActionBase__AddRange__);
    byte_4E7BC90 = 1;
  }
  ...
  ActionChainBase_object___AddRange(
    (ActionChainBase_T__o *)this,
    v5,
    (const MethodInfo_358C488 *)Method_ActionChainBase_ChainableActionBase__AddRange__);
  return this;
}
