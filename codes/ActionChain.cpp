        ...
        const MethodInfo *method)
{
  if ( (byte_4C01FA0 & 1) == 0 )
  {
    sub_1C2E12C(&Method_ActionChainBase_ChainableActionBase___ctor__, chainableActions);
    byte_4C01FA0 = 1;
  }
  ActionChainBase_object____ctor(
    (ActionChainBase_T__o *)this,
    (System_Object_array *)chainableActions,
    (const MethodInfo_32E9644 *)Method_ActionChainBase_ChainableActionBase___ctor__);
}


void __fastcall ActionChain___ctor_47868324(
        ActionChain_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01FA1 & 1) == 0 )
  {
    sub_1C2E12C(&Method_ActionChainBase_ChainableActionBase__AddRange__, actions);
    byte_4C01FA1 = 1;
  }
  ...
  ActionChainBase_object___AddRange(
    (ActionChainBase_T__o *)this,
    v5,
    (const MethodInfo_32E96F8 *)Method_ActionChainBase_ChainableActionBase__AddRange__);
  return this;
}
