        ...
        const MethodInfo *method)
{
  if ( (byte_4A7463C & 1) == 0 )
  {
    sub_1B90010(&Method_ActionChainBase_ChainableActionBase___ctor__, chainableActions);
    byte_4A7463C = 1;
  }
  ActionChainBase_object____ctor(
    (ActionChainBase_T__o *)this,
    (System_Object_array *)chainableActions,
    (const MethodInfo_319A484 *)Method_ActionChainBase_ChainableActionBase___ctor__);
}


void __fastcall ActionChain___ctor_46612860(
        ActionChain_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7463D & 1) == 0 )
  {
    sub_1B90010(&Method_ActionChainBase_ChainableActionBase__AddRange__, actions);
    byte_4A7463D = 1;
  }
  ...
  ActionChainBase_object___AddRange(
    (ActionChainBase_T__o *)this,
    v5,
    (const MethodInfo_319A538 *)Method_ActionChainBase_ChainableActionBase__AddRange__);
  return this;
}
