...
void __fastcall QuestBoardListViewEarthLine__Awake(QuestBoardListViewEarthLine_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6CDD8 & 1) == 0 )
  {
    sub_1B90010(&Method_CStateManager_QuestBoardListViewEarthLine___ctor__, method);
    sub_1B90010(&Method_CStateManager_QuestBoardListViewEarthLine__add__, v3);
    sub_1B90010(&CStateManager_QuestBoardListViewEarthLine__TypeInfo, v4);
    sub_1B90010(&QuestBoardListViewEarthLine_StateMain_TypeInfo, v5);
    sub_1B90010(&QuestBoardListViewEarthLine_StateNone_TypeInfo, v6);
    byte_4A6CDD8 = 1;
  }
  if ( !this->fields.mFSM )
  {
    v7 = (CStateManager_T__o *)sub_1B9025C(CStateManager_QuestBoardListViewEarthLine__TypeInfo);
    CStateManager_object____ctor(
      v7,
      (Il2CppObject *)this,
      2,
      (const MethodInfo_30B99A8 *)Method_CStateManager_QuestBoardListViewEarthLine___ctor__);
    ...
    v11 = (Il2CppObject *)sub_1B9025C(QuestBoardListViewEarthLine_StateNone_TypeInfo);
    ...
    if ( !mFSM
      || (CStateManager_object___add(
            ...
            0,
            (IState_T__o *)v11,
            (const MethodInfo_30B9A50 *)Method_CStateManager_QuestBoardListViewEarthLine__add__),
          v14 = (CStateManager_T__o *)this->fields.mFSM,
          v15 = (Il2CppObject *)sub_1B9025C(QuestBoardListViewEarthLine_StateMain_TypeInfo),
  ...
  if ( !mEarthPoint
    ...
    || (LODWORD(v7) = (unsigned int)UnityEngine_Transform__get_lossyScale((UnityEngine_Transform_o *)mEarthPoint, 0LL),
        (mEarthPoint = (UnityEngine_Component_o *)UnityEngine_Component__get_transform(
                                                    ...
                                                    0LL)) == 0LL) )
  {
    sub_1B9026C(mEarthPoint, method);
  }
...
int32_t __fastcall QuestBoardListViewEarthLine__GetState(QuestBoardListViewEarthLine_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6CDDB & 1) == 0 )
  {
    this = (QuestBoardListViewEarthLine_o *)sub_1B90010(
...
void __fastcall QuestBoardListViewEarthLine__LateUpdate(QuestBoardListViewEarthLine_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6CDD9 & 1) == 0 )
  {
    sub_1B90010(&Method_CStateManager_QuestBoardListViewEarthLine__update__, method);
    byte_4A6CDD9 = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___update(
      mFSM,
      (const MethodInfo_30B9AB8 *)Method_CStateManager_QuestBoardListViewEarthLine__update__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6CDDC & 1) == 0 )
  {
    sub_1B90010(&Method_CStateManager_QuestBoardListViewEarthLine__setState__, *(_QWORD *)&state);
    byte_4A6CDDC = 1;
  }
  mFSM = (CStateManager_T__o *)this->fields.mFSM;
  if ( mFSM )
    CStateManager_object___setState(
      mFSM,
      state,
      (const MethodInfo_30B9ADC *)Method_CStateManager_QuestBoardListViewEarthLine__setState__);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.mLineRenderer, (int32_t)lr, (int32_t)method, v3);
  ...
  if ( !byte_4A6A9C1 )
  {
    sharedMaterial = (UnityEngine_LineRenderer_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, v5);
    byte_4A6A9C1 = 1;
  }
  if ( !v7 )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6CDDA & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_Object_TypeInfo, lvo);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.mListViewObject, 0, war_id, (int32_t)method);
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.mTerminalServant, (int32_t)v18, v14, v15);
  if ( !byte_4A6AF7D )
  {
    sub_1B90010(&TerminalSceneComponent_TypeInfo, v13);
    byte_4A6AF7D = 1;
  ...
  if ( !v21
    || (v22 = (struct BaseCore_o *)v21->vtable._4_Dispose.method,
        ...
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.mEarthCore, (int32_t)v22, v19, v20),
        (mEarthCore = this->fields.mEarthCore) == 0LL) )
  {
LABEL_20:
    sub_1B9026C(mEarthCore, v13);
  }
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)p_mEarthPoint, (int32_t)EarthPoint, v25, v26);
  ...
  if ( !UnityEngine_Object__op_Equality(v27, 0LL, 0LL) )
  {
    ...
    sub_1B8FFB4(p_mListViewObject, (int32_t)lvo, v28, v29);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6CDDE & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_QuestBoardListViewEarthLine_StateMain___c__DisplayClass2_0__begin_b__0__, v6);
    sub_1B90010(&Method_QuestBoardListViewEarthLine_StateMain___c__DisplayClass2_0__begin_b__1__, v7);
    sub_1B90010(&QuestBoardListViewEarthLine_StateMain___c__DisplayClass2_0_TypeInfo, v8);
    byte_4A6CDDE = 1;
  }
  v9 = sub_1B9025C(QuestBoardListViewEarthLine_StateMain___c__DisplayClass2_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = Component_object;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v9 + 24), (int32_t)Component_object, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6CDDD & 1) == 0 )
  {
    ...
    this = (QuestBoardListViewEarthLine_StateNone_o *)sub_1B90010(&UnityEngine_Object_TypeInfo, v4);
    byte_4A6CDDD = 1;
  }
  if ( !that )
    goto LABEL_11;
