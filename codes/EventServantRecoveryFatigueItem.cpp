void EventServantRecoveryFatigueItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E71E05 & 1) == 0 )
  {
    sub_1D0F0B4(&EventServantRecoveryFatigueItem_TypeInfo);
    sub_1D0F0B4(&StringLiteral_17205/*"available_0"*/);
    sub_1D0F0B4(&StringLiteral_19594/*"event_recvoer_servant_bg02"*/);
    byte_4E71E05 = 1;
  }
  EventServantRecoveryFatigueItem_TypeInfo->static_fields->EMPTY_BG_NAME = (struct System_String_o *)StringLiteral_19594/*"event_recvoer_servant_bg02"*/;
  sub_1D0F058(EventServantRecoveryFatigueItem_TypeInfo->static_fields, StringLiteral_19594/*"event_recvoer_servant_bg02"*/);
  v1 = StringLiteral_17205/*"available_0"*/;
  static_fields = EventServantRecoveryFatigueItem_TypeInfo->static_fields;
  static_fields->OPEN_CLIP_NAME = (struct System_String_o *)StringLiteral_17205/*"available_0"*/;
  sub_1D0F058(&static_fields->OPEN_CLIP_NAME, v1);
}
...
void EventServantRecoveryFatigueItem__Init(EventServantRecoveryFatigueItem_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058(&this->fields.clickCallback, 0);
  this->fields.eventFatigueRecoveryEnt = 0;
  sub_1D0F058(&this->fields.eventFatigueRecoveryEnt, 0);
...
LABEL_28:
    sub_1D0F30C(servantFaceIcon, method);
  }
...
void EventServantRecoveryFatigueItem__OnClickItem(EventServantRecoveryFatigueItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E71E02 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_EventServantRecoveryFatigueItem_OnClickItem__);
    byte_4E71E02 = 1;
  }
  if ( this->fields.clickCallback )
  {
    ...
    if ( (*((_BYTE *)Method_EventServantRecoveryFatigueItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_EventServantRecoveryFatigueItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( EventServantRecoveryFatigueItem__IsAnimation(this, *(const MethodInfo **)&no) )
  {
    ...
    v7 = System_String__Concat_65562772(OPEN_CLIP_NAME, v6, 0);
    simpleAnimation = (UnityEngine_Object_o *)this->fields.simpleAnimation;
    v9 = v7;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(simpleAnimation, 0, 0) )
    {
      ...
      {
LABEL_15:
        v16 = sub_1CE5430(Item, SimpleAnimation_State_TypeInfo, 14);
      }
          ...
          if ( Item )
          {
            ...
            if ( v22 )
            {
              ...
              if ( Item )
              {
                ...
                SimpleAnimation__Play_68509268(v22, name, 0);
                return;
              }
            }
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71E00 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_11841/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/);
    byte_4E71E00 = 1;
  }
  recoverAt = 0;
  this->fields.isFatigueRecover = 0;
  ...
  sub_1D0F058(&this->fields.eventFatigueRecoveryEnt, EntityDefinitely);
  if ( userServantEntity )
  {
    ...
    if ( !v15 )
      goto LABEL_68;
    IconLabelInfo__Set_42279788(v15, 2, lv, (int32_t)Instance, 0, 0, 0, 0, 0, 0);
    Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Instance )
      goto LABEL_68;
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
    ...
    *(_QWORD *)&v34.fields.fakeValue = v19;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v34, 0);
    if ( !v18 )
      goto LABEL_68;
           ...
           0) )
    {
      ...
      if ( ((unsigned __int8)Instance & 1) == 0 )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v30 = LocalizationManager__Get((System_String_o *)StringLiteral_11841/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0);
...
LABEL_51:
    ...
    if ( !Instance )
      goto LABEL_68;
    ServantFaceIconComponent__Set_42454992((ServantFaceIconComponent_o *)Instance, userServantEntity, v15, 0, 1, 0);
    frameSprite = (UnityEngine_Object_o *)this->fields.frameSprite;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(frameSprite, 0, 0) )
...
LABEL_13:
    sub_1D0F30C(fatigueRecoveryTimeLabel, v5);
  }
  v7 = this->fields.fatigueRecoveryTimeLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11841/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0);
