void __fastcall EventServantRecoveryFatigueItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BD745D & 1) == 0 )
  {
    sub_1C21E38(&EventServantRecoveryFatigueItem_TypeInfo);
    sub_1C21E38(&StringLiteral_17274/*"available_0"*/);
    sub_1C21E38(&StringLiteral_19571/*"event_recvoer_servant_bg02"*/);
    byte_4BD745D = 1;
  }
  EventServantRecoveryFatigueItem_TypeInfo->static_fields->EMPTY_BG_NAME = (struct System_String_o *)StringLiteral_19571/*"event_recvoer_servant_bg02"*/;
  sub_1C21DDC(EventServantRecoveryFatigueItem_TypeInfo->static_fields, StringLiteral_19571/*"event_recvoer_servant_bg02"*/);
  v1 = StringLiteral_17274/*"available_0"*/;
  static_fields = EventServantRecoveryFatigueItem_TypeInfo->static_fields;
  static_fields->OPEN_CLIP_NAME = (struct System_String_o *)StringLiteral_17274/*"available_0"*/;
  sub_1C21DDC(&static_fields->OPEN_CLIP_NAME, v1);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(&this->fields.clickCallback, 0LL);
  this->fields.eventFatigueRecoveryEnt = 0LL;
  sub_1C21DDC(&this->fields.eventFatigueRecoveryEnt, 0LL);
...
LABEL_28:
    sub_1C22094(servantFaceIcon, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD745A & 1) == 0 )
  {
    sub_1C21E38(&Method_EventServantRecoveryFatigueItem_OnClickItem__);
    byte_4BD745A = 1;
  }
  if ( this->fields.clickCallback )
  {
    ...
    if ( (*((_BYTE *)Method_EventServantRecoveryFatigueItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_EventServantRecoveryFatigueItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( EventServantRecoveryFatigueItem__IsAnimation(this, *(const MethodInfo **)&no) )
  {
    ...
    v7 = System_String__Concat_63115476(OPEN_CLIP_NAME, v6, 0LL);
    simpleAnimation = (UnityEngine_Object_o *)this->fields.simpleAnimation;
    v9 = v7;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(simpleAnimation, 0LL, 0LL) )
    {
      ...
      {
LABEL_15:
        v16 = sub_1C73E18(Item, SimpleAnimation_State_TypeInfo, 14LL);
      }
          ...
          if ( Item )
          {
            ...
            if ( v22 )
            {
              ...
              if ( Item )
              {
                ...
                SimpleAnimation__Play_65253852(v22, name, 0LL);
                return;
              }
            }
          }
            ...
            if ( Item )
            {
              ...
              if ( v19 )
              {
                ...
                if ( Item )
                {
                  ...
                  UnityEngine_Animation__Play_70614020(v19, v20, 0LL);
                  return;
                }
              }
            }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7458 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_11856/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/);
    byte_4BD7458 = 1;
  }
  recoverAt = 0LL;
  this->fields.isFatigueRecover = 0;
  ...
  if ( callback )
  {
    ...
    sub_1C21DDC(&this->fields.clickCallback, callback);
  }
  ...
  sub_1C21DDC(&this->fields.eventFatigueRecoveryEnt, EntityDefinitely);
  if ( userServantEntity )
  {
    ...
    if ( !v15 )
      goto LABEL_68;
    IconLabelInfo__Set_39381772(v15, 2, lv, (int32_t)Instance, 0, 0, 0, 0, 0LL);
    Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Instance )
      goto LABEL_68;
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
    ...
    *(_QWORD *)&v34.fields.fakeValue = v19;
           ...
           0LL) )
    {
      ...
      RestTime4 = LocalizationManager__GetRestTime4(v21, -1LL, 0LL);
      ...
      if ( ((unsigned __int8)Instance & 1) == 0 )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v30 = LocalizationManager__Get((System_String_o *)StringLiteral_11856/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0LL);
        Instance = (DataManager_o *)System_String__Format(v30, (Il2CppObject *)RestTime4, 0LL);
...
LABEL_51:
    ...
    if ( !Instance )
      goto LABEL_68;
    ServantFaceIconComponent__Set_39464008((ServantFaceIconComponent_o *)Instance, userServantEntity, v15, 0LL, 0LL);
    frameSprite = (UnityEngine_Object_o *)this->fields.frameSprite;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(frameSprite, 0LL, 0LL) )
...
LABEL_13:
    sub_1C22094(fatigueRecoveryTimeLabel, v5);
  }
  v7 = this->fields.fatigueRecoveryTimeLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11856/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0LL);
