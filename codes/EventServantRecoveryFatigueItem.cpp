void __fastcall EventServantRecoveryFatigueItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A7413B & 1) == 0 )
  {
    sub_1B90010(&EventServantRecoveryFatigueItem_TypeInfo, v1);
    sub_1B90010(&StringLiteral_17014/*"available_0"*/, v4);
    sub_1B90010(&StringLiteral_19266/*"event_recvoer_servant_bg02"*/, v5);
    byte_4A7413B = 1;
  }
  EventServantRecoveryFatigueItem_TypeInfo->static_fields->EMPTY_BG_NAME = (struct System_String_o *)StringLiteral_19266/*"event_recvoer_servant_bg02"*/;
  sub_1B8FFB4(
    (ServantStatusBattleListViewItem_o *)EventServantRecoveryFatigueItem_TypeInfo->static_fields,
    StringLiteral_19266/*"event_recvoer_servant_bg02"*/,
    v2,
    v3);
  v6 = StringLiteral_17014/*"available_0"*/;
  static_fields = EventServantRecoveryFatigueItem_TypeInfo->static_fields;
  static_fields->OPEN_CLIP_NAME = (struct System_String_o *)StringLiteral_17014/*"available_0"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&static_fields->OPEN_CLIP_NAME, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.userServantEntity, 0, v4, v5);
  this->fields.isFatigueRecover = 0;
  this->fields.index = -1;
  this->fields.fatigueTime = -1LL;
  this->fields.updateTime = -1LL;
  this->fields.clickCallback = 0LL;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.clickCallback, 0, v6, v7);
  this->fields.eventFatigueRecoveryEnt = 0LL;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.eventFatigueRecoveryEnt, 0, v8, v9);
...
LABEL_28:
    sub_1B9026C(servantFaceIcon, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A74138 & 1) == 0 )
  {
    sub_1B90010(&Method_EventServantRecoveryFatigueItem_OnClickItem__, method);
    byte_4A74138 = 1;
  }
  if ( this->fields.clickCallback )
  {
    ...
    if ( (*((_BYTE *)Method_EventServantRecoveryFatigueItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B90028(Method_EventServantRecoveryFatigueItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7413A & 1) == 0 )
  {
    sub_1B90010(&EventServantRecoveryFatigueItem_TypeInfo, *(_QWORD *)&no);
  ...
  if ( EventServantRecoveryFatigueItem__IsAnimation(this, *(const MethodInfo **)&no) )
  {
    ...
    v9 = System_String__Concat_61787092(OPEN_CLIP_NAME, v8, 0LL);
    simpleAnimation = (UnityEngine_Object_o *)this->fields.simpleAnimation;
    v11 = v9;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(simpleAnimation, 0LL, 0LL) )
    {
      ...
      {
LABEL_15:
        v18 = sub_1BE1FF0(Item, SimpleAnimation_State_TypeInfo, 14LL);
      }
          ...
          if ( Item )
          {
            ...
            if ( v24 )
            {
              ...
              if ( Item )
              {
                ...
                SimpleAnimation__Play_63924764(v24, name, 0LL);
                return;
              }
            }
          }
            ...
            if ( Item )
            {
              ...
              if ( v21 )
              {
                ...
                if ( Item )
                {
                  ...
                  UnityEngine_Animation__Play_69284532(v21, v22, 0LL);
                  return;
                }
              }
            }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A74136 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_EventFatigueRecoveryMaster___, userServantEntity);
    ...
    sub_1B90010(&EventServantRecoveryFatigueItem_TypeInfo, v13);
    ...
    sub_1B90010(&StringLiteral_11645/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, v20);
    byte_4A74136 = 1;
  }
  recoverAt = 0LL;
  this->fields.isFatigueRecover = 0;
  ...
  if ( callback )
  {
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.clickCallback, (int32_t)callback, v22, v23);
  }
  ...
  if ( userServantEntity )
  {
    ...
    if ( !v29 )
      goto LABEL_68;
    IconLabelInfo__Set_38192256(v29, 2, lv, (int32_t)Instance, 0, 0, 0, 0, 0LL);
    Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Instance )
      goto LABEL_68;
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
    ...
    *(_QWORD *)&v48.fields.fakeValue = v33;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v48, 0LL);
    if ( !v32 )
      goto LABEL_68;
           ...
           0LL) )
    {
      ...
      if ( ((unsigned __int8)Instance & 1) == 0 )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v44 = LocalizationManager__Get((System_String_o *)StringLiteral_11645/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0LL);
...
LABEL_51:
    ...
    if ( !Instance )
      goto LABEL_68;
    ServantFaceIconComponent__Set_38272380((ServantFaceIconComponent_o *)Instance, userServantEntity, v29, 0LL, 0LL);
    frameSprite = (UnityEngine_Object_o *)this->fields.frameSprite;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(frameSprite, 0LL, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A74137 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_11645/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, v3);
    byte_4A74137 = 1;
  }
...
LABEL_13:
    sub_1B9026C(fatigueRecoveryTimeLabel, v6);
  }
  v8 = this->fields.fatigueRecoveryTimeLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_11645/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0LL);
