void __fastcall EventServantRecoveryFatigueItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4918A & 1) == 0 )
  {
    sub_1B863B8(&EventServantRecoveryFatigueItem_TypeInfo, v1);
    sub_1B863B8(&StringLiteral_16745/*"available_0"*/, v2);
    sub_1B863B8(&StringLiteral_19019/*"event_recvoer_servant_bg02"*/, v3);
    byte_4A4918A = 1;
  }
  EventServantRecoveryFatigueItem_TypeInfo->static_fields->EMPTY_BG_NAME = (struct System_String_o *)StringLiteral_19019/*"event_recvoer_servant_bg02"*/;
  sub_1B8635C(EventServantRecoveryFatigueItem_TypeInfo->static_fields);
  static_fields = EventServantRecoveryFatigueItem_TypeInfo->static_fields;
  static_fields->OPEN_CLIP_NAME = (struct System_String_o *)StringLiteral_16745/*"available_0"*/;
  sub_1B8635C(&static_fields->OPEN_CLIP_NAME);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C(&this->fields.clickCallback);
  this->fields.eventFatigueRecoveryEnt = 0LL;
  sub_1B8635C(&this->fields.eventFatigueRecoveryEnt);
...
LABEL_28:
    sub_1B86614(servantFaceIcon, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49187 & 1) == 0 )
  {
    sub_1B863B8(&Method_EventServantRecoveryFatigueItem_OnClickItem__, method);
    byte_4A49187 = 1;
  }
  if ( this->fields.clickCallback )
  {
    ...
    if ( (*((_BYTE *)Method_EventServantRecoveryFatigueItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_EventServantRecoveryFatigueItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  UnityEngine_Animation_o *v21; // x19
  System_String_o *v22; // x0
  UnityEngine_AnimationClip_o *v23; // x20
  struct SimpleAnimation_o *v24; // x19
  ...
  if ( (byte_4A49189 & 1) == 0 )
  {
    sub_1B863B8(&EventServantRecoveryFatigueItem_TypeInfo, *(_QWORD *)&no);
  ...
  if ( EventServantRecoveryFatigueItem__IsAnimation(this, *(const MethodInfo **)&no) )
  {
    ...
    v9 = System_String__Concat_61645176(OPEN_CLIP_NAME, v8, 0LL);
    simpleAnimation = (UnityEngine_Object_o *)this->fields.simpleAnimation;
    v11 = v9;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(simpleAnimation, 0LL, 0LL) )
    {
      ...
      if ( *(_WORD *)(&Item->klass->_2.bitflags2 + 3) )
      {
        ...
        v18 = (__int64)(&klass[1]._1.typeMetadataHandle + 2 * *(_DWORD *)p_offset);
      }
      else
      {
LABEL_15:
        v18 = sub_1BD6B4C(Item, SimpleAnimation_State_TypeInfo, 14LL);
      }
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v23, 0LL, 0LL) )
      {
        ...
        if ( Item )
        {
          SimpleAnimation__set_clip(Item, v23, 0LL);
          Item = this->fields.simpleAnimation;
          if ( Item )
          {
            UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)Item, 1, 0LL);
            v24 = this->fields.simpleAnimation;
            if ( v24 )
            {
              Item = (SimpleAnimation_o *)v24[1].monitor;
              if ( Item )
              {
                name = UnityEngine_Object__get_name((UnityEngine_Object_o *)Item, 0LL);
                SimpleAnimation__Play_64595412(v24, name, 0LL);
                return;
              }
            }
          }
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Clip, 0LL, 0LL) )
        {
          ...
          if ( Item )
          {
            ...
            if ( Item )
            {
              ...
              if ( v21 )
              {
                Item = (SimpleAnimation_o *)UnityEngine_Animation__get_clip(v21, 0LL);
                if ( Item )
                {
                  v22 = UnityEngine_Object__get_name((UnityEngine_Object_o *)Item, 0LL);
                  UnityEngine_Animation__Play_69099832(v21, v22, 0LL);
                  return;
                }
              }
            }
        ...
        const MethodInfo *method)
{
  ...
  UserEventServantFatigueMaster_o *v27; // x24
  __int64 v28; // x25
  __int64 v29; // x26
  int64_t v30; // x22
  ...
  EventServantRecoveryFatigueItem_c *v36; // x0
  ...
  if ( (byte_4A49185 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EventFatigueRecoveryMaster___, userServantEntity);
    ...
    sub_1B863B8(&EventServantRecoveryFatigueItem_TypeInfo, v13);
    ...
    sub_1B863B8(&StringLiteral_11466/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, v20);
    byte_4A49185 = 1;
  }
  recoverAt = 0LL;
  this->fields.isFatigueRecover = 0;
  ...
  if ( userServantEntity )
  {
    ...
    if ( !v24 )
      goto LABEL_68;
    IconLabelInfo__Set_39094644(v24, 2, lv, (int32_t)Instance, 0, 0, 0, 0, 0, 0LL);
    Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Instance )
      goto LABEL_68;
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
    ...
    if ( !*p_userServantEntity )
      goto LABEL_68;
    v27 = (UserEventServantFatigueMaster_o *)Instance;
    ...
    *(_QWORD *)&v43.fields.fakeValue = v28;
           ...
           0LL) )
    {
      ...
      RestTime4 = LocalizationManager__GetRestTime4(v30, -1LL, 0LL);
      ...
      if ( ((unsigned __int8)Instance & 1) == 0 )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v39 = LocalizationManager__Get((System_String_o *)StringLiteral_11466/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0LL);
    ...
    v34 = 0;
LABEL_51:
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Instance, v34, 0LL);
    Instance = (DataManager_o *)this->fields.servantFaceIcon;
    if ( !Instance )
      goto LABEL_68;
    ServantFaceIconComponent__Set_39177000((ServantFaceIconComponent_o *)Instance, userServantEntity, v24, 0LL, 0LL);
    frameSprite = (UnityEngine_Object_o *)this->fields.frameSprite;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(frameSprite, 0LL, 0LL) )
...
LABEL_68:
  ...
  if ( !Instance )
    goto LABEL_68;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Instance, 0, 0LL);
  v33 = (UnityEngine_Object_o *)this->fields.frameSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  ...
  else
  {
    ...
    v36 = EventServantRecoveryFatigueItem_TypeInfo;
    if ( !EventServantRecoveryFatigueItem_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(EventServantRecoveryFatigueItem_TypeInfo);
      v36 = EventServantRecoveryFatigueItem_TypeInfo;
    }
    EMPTY_BG_NAME = v36->static_fields->EMPTY_BG_NAME;
  ...
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Instance, 1, 0LL);
  v38 = (UnityEngine_Object_o *)this->fields.nameSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49186 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_11466/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, v3);
    byte_4A49186 = 1;
  }
...
LABEL_13:
    sub_1B86614(fatigueRecoveryTimeLabel, v6);
  }
  v8 = this->fields.fatigueRecoveryTimeLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_11466/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0LL);
