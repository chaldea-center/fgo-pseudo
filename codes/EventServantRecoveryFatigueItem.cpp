void EventServantRecoveryFatigueItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C516F1 & 1) == 0 )
  {
    sub_1C3E564(&EventServantRecoveryFatigueItem_TypeInfo);
    sub_1C3E564(&StringLiteral_16976/*"available_0"*/);
    sub_1C3E564(&StringLiteral_19278/*"event_recvoer_servant_bg02"*/);
    byte_4C516F1 = 1;
  }
  EventServantRecoveryFatigueItem_TypeInfo->static_fields->EMPTY_BG_NAME = (struct System_String_o *)StringLiteral_19278/*"event_recvoer_servant_bg02"*/;
  sub_1C3E508(EventServantRecoveryFatigueItem_TypeInfo->static_fields, StringLiteral_19278/*"event_recvoer_servant_bg02"*/);
  v1 = StringLiteral_16976/*"available_0"*/;
  static_fields = EventServantRecoveryFatigueItem_TypeInfo->static_fields;
  static_fields->OPEN_CLIP_NAME = (struct System_String_o *)StringLiteral_16976/*"available_0"*/;
  sub_1C3E508(&static_fields->OPEN_CLIP_NAME, v1);
}
...
void EventServantRecoveryFatigueItem__Init(EventServantRecoveryFatigueItem_o *this, const MethodInfo *method)
{
  ...
  sub_1C3E508(&this->fields.clickCallback, 0);
  this->fields.eventFatigueRecoveryEnt = 0;
  sub_1C3E508(&this->fields.eventFatigueRecoveryEnt, 0);
...
LABEL_28:
    sub_1C3E7C0(servantFaceIcon, method);
  }
...
void EventServantRecoveryFatigueItem__OnClickItem(EventServantRecoveryFatigueItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C516EE & 1) == 0 )
  {
    sub_1C3E564(&Method_EventServantRecoveryFatigueItem_OnClickItem__);
    byte_4C516EE = 1;
  }
  if ( this->fields.clickCallback )
  {
    ...
    if ( (*((_BYTE *)Method_EventServantRecoveryFatigueItem_OnClickItem__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_EventServantRecoveryFatigueItem_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( EventServantRecoveryFatigueItem__IsAnimation(this, *(const MethodInfo **)&no) )
  {
    ...
    v7 = System_String__Concat_63636468(OPEN_CLIP_NAME, v6, 0);
    simpleAnimation = (UnityEngine_Object_o *)this->fields.simpleAnimation;
    v9 = v7;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(simpleAnimation, 0, 0) )
    {
      ...
      if ( *(_WORD *)&Item->klass->_2.rank )
      {
        ...
        v16 = (__int64)(&klass[1]._1.generic_class + 2 * *(_DWORD *)p_offset);
      }
      else
      {
LABEL_15:
        v16 = sub_1C8ED7C(Item, SimpleAnimation_State_TypeInfo, 14);
      }
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v21, 0, 0) )
      {
        ...
        if ( Item )
        {
          SimpleAnimation__set_clip(Item, v21, 0);
          Item = this->fields.simpleAnimation;
          if ( Item )
          {
            ...
            if ( v22 )
            {
              Item = (SimpleAnimation_o *)v22->fields.m_Clip;
              if ( Item )
              {
                name = UnityEngine_Object__get_name((UnityEngine_Object_o *)Item, 0);
                SimpleAnimation__Play_66582224(v22, name, 0);
                return;
              }
            }
          }
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Clip, 0, 0) )
        {
          ...
          if ( Item )
          {
            ...
            if ( Item )
            {
              ...
              if ( v19 )
              {
                Item = (SimpleAnimation_o *)UnityEngine_Animation__get_clip(v19, 0);
                if ( Item )
                {
                  v20 = UnityEngine_Object__get_name((UnityEngine_Object_o *)Item, 0);
                  UnityEngine_Animation__Play_71086848(v19, v20, 0);
                  return;
                }
              }
            }
        ...
        const MethodInfo *method)
{
  ...
  UserEventServantFatigueMaster_o *v18; // x24
  __int64 v19; // x25
  __int64 v20; // x26
  int64_t v21; // x22
  ...
  EventServantRecoveryFatigueItem_c *v27; // x0
  ...
  if ( (byte_4C516EC & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_11673/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/);
    byte_4C516EC = 1;
  }
  recoverAt = 0;
  this->fields.isFatigueRecover = 0;
  ...
  sub_1C3E508(&this->fields.eventFatigueRecoveryEnt, EntityDefinitely);
  if ( userServantEntity )
  {
    ...
    if ( !v15 )
      goto LABEL_68;
    IconLabelInfo__Set_40964356(v15, 2, lv, (int32_t)Instance, 0, 0, 0, 0, 0, 0);
    Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !Instance )
      goto LABEL_68;
    Instance = (DataManager_o *)DataManager__GetMasterData_object_(
    ...
    if ( !*p_userServantEntity )
      goto LABEL_68;
    v18 = (UserEventServantFatigueMaster_o *)Instance;
    ...
    *(_QWORD *)&v34.fields.fakeValue = v19;
           ...
           0) )
    {
      ...
      RestTime4 = LocalizationManager__GetRestTime4(v21, -1, 0);
      ...
      if ( ((unsigned __int8)Instance & 1) == 0 )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v30 = LocalizationManager__Get((System_String_o *)StringLiteral_11673/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0);
        Instance = (DataManager_o *)System_String__Format(v30, (Il2CppObject *)RestTime4, 0);
...
LABEL_51:
    ...
    if ( !Instance )
      goto LABEL_68;
    ServantFaceIconComponent__Set_41053768((ServantFaceIconComponent_o *)Instance, userServantEntity, v15, 0, 0);
    frameSprite = (UnityEngine_Object_o *)this->fields.frameSprite;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(frameSprite, 0, 0) )
...
LABEL_68:
  ...
  else
  {
    ...
    v27 = EventServantRecoveryFatigueItem_TypeInfo;
    if ( !EventServantRecoveryFatigueItem_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(EventServantRecoveryFatigueItem_TypeInfo);
      v27 = EventServantRecoveryFatigueItem_TypeInfo;
    }
    EMPTY_BG_NAME = v27->static_fields->EMPTY_BG_NAME;
  ...
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Instance, 1, 0);
  v29 = (UnityEngine_Object_o *)this->fields.nameSprite;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_13:
    sub_1C3E7C0(fatigueRecoveryTimeLabel, v5);
  }
  v7 = this->fields.fatigueRecoveryTimeLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_11673/*"SERVANT_RECOVERY_FATIGUE_REST_TIME"*/, 0);
  fatigueRecoveryTimeLabel = (UnityEngine_Component_o *)System_String__Format(v8, (Il2CppObject *)RestTime4, 0);
  if ( !v7 )
    goto LABEL_13;
  UILabel__set_text(v7, (System_String_o *)fatigueRecoveryTimeLabel, 0);
}
