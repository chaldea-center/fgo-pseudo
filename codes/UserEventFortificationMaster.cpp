void __fastcall UserEventFortificationMaster___ctor(UserEventFortificationMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    384,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_UserEventFortificationMaster__UserEventFortificationEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (UserEventFortificationEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                             (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                             PK,
                                             (const MethodInfo_30F8AB8 *)Method_DataMasterBase_UserEventFortificationMaster__UserEventFortificationEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20719 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&workIndex);
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B715CC(&UserEventFortificationEntity_TypeInfo, v6);
    byte_4A20719 = 1;
  }
...
LABEL_17:
    sub_1B71828(list, *(_QWORD *)&workIndex);
  }
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2071A & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, *(_QWORD *)&eventId);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEventFortificationEntity__get_Count__, v6);
    sub_1B715CC(&UserEventFortificationEntity_TypeInfo, v7);
    byte_4A2071A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_UserEventFortificationMaster__UserEventFortificationEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20716 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEventFortificationEntity__Add__, v10);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEventFortificationEntity___ctor__, v11);
    sub_1B715CC(&Method_System_Collections_Generic_List_UserEventFortificationEntity__get_Count__, v12);
    sub_1B715CC(&System_Collections_Generic_List_UserEventFortificationEntity__TypeInfo, v13);
    sub_1B715CC(&UserEventFortificationEntity_TypeInfo, v14);
    byte_4A20716 = 1;
  }
  v15 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_UserEventFortificationEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_UserEventFortificationEntity___ctor__);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    goto LABEL_38;
...
LABEL_31:
  ...
  *userEventFortificationList = (System_Collections_Generic_List_UserEventFortificationEntity__o *)v15;
  sub_1B71570((ServantStatusBattleListViewItem_o *)userEventFortificationList, (int32_t)v15, v42, v43);
  if ( !*userEventFortificationList )
LABEL_38:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20717 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__, fortificationIdx);
  ...
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1B71828(0LL, fortificationIdx);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_3096080 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__GetEnumerator__);
  if ( !Enumerator )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20718 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_EventFortificationDetailMaster___, fortificationName);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventFortificationMaster___, v11);
  ...
  *fortificationDetailName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)fortificationDetailName, (int32_t)StringLiteral_1/*""*/, v14, v15);
  ...
  if ( FortificationIdxAndPositionBySvtId )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_EventFortificationMaster___)) == 0LL
      || (v21 = position[1],
      ...
      || (Instance = DataManager__GetMasterData_object_(
                       (DataManager_o *)Instance,
                       (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_EventFortificationDetailMaster___)) == 0LL )
    {
    ...
    if ( Entity )
    {
      if ( v25 )
      {
        ...
        *fortificationName = name;
        sub_1B71570((ServantStatusBattleListViewItem_o *)fortificationName, (int32_t)name, v23, v24);
        v27 = v25->fields.name;
        *fortificationDetailName = v27;
        sub_1B71570((ServantStatusBattleListViewItem_o *)fortificationDetailName, (int32_t)v27, v28, v29);
        return 1;
      }
    }
  }
