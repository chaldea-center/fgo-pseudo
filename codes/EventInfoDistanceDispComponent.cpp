void __fastcall EventInfoDistanceDispComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB65A8 & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoDistanceDispComponent_TypeInfo, v1);
    byte_4AB65A8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB65A7 & 1) == 0 )
  {
    ...
    sub_1BAB41C(
      ...
      v6);
    sub_1BAB41C(&EventInfoDistanceDispComponent_TypeInfo, v7);
    sub_1BAB41C(
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_354E3B4 *)Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  v31 = v30;
  while ( 2 )
  {
    v14 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v31,
            (const MethodInfo_32C4C78 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    if ( !v14 )
    {
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v31,
        (const MethodInfo_32C4C74 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
      return (System_String_o *)StringLiteral_1/*""*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB65A5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_5630/*"EVENT_INFO_DISTANCE_TXT_"*/, v8);
  ...
  v18 = System_String__Concat_62048128((System_String_o *)StringLiteral_5630/*"EVENT_INFO_DISTANCE_TXT_"*/, v17, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
