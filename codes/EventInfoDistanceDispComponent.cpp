void __fastcall EventInfoDistanceDispComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B035A2 & 1) == 0 )
  {
    sub_1BC3008(&EventInfoDistanceDispComponent_TypeInfo, v1);
    byte_4B035A2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B035A1 & 1) == 0 )
  {
    ...
    sub_1BC3008(
      ...
      v6);
    sub_1BC3008(&EventInfoDistanceDispComponent_TypeInfo, v7);
    sub_1BC3008(
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_36A1938 *)Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  v31 = v30;
  while ( 2 )
  {
    v14 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v31,
            (const MethodInfo_343678C *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    if ( !v14 )
    {
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v31,
        (const MethodInfo_3436788 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
      return (System_String_o *)StringLiteral_1/*""*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0359F & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_5567/*"EVENT_INFO_DISTANCE_TXT_"*/, v8);
  ...
  v18 = System_String__Concat_62348648((System_String_o *)StringLiteral_5567/*"EVENT_INFO_DISTANCE_TXT_"*/, v17, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
