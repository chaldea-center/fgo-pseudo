void __fastcall EventInfoDistanceDispComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A70830 & 1) == 0 )
  {
    sub_1B90010(&EventInfoDistanceDispComponent_TypeInfo, v1);
    byte_4A70830 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7082F & 1) == 0 )
  {
    ...
    sub_1B90010(
      ...
      v6);
    sub_1B90010(&EventInfoDistanceDispComponent_TypeInfo, v7);
    sub_1B90010(
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_35114B8 *)Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  v31 = v30;
  while ( 2 )
  {
    v14 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v31,
            (const MethodInfo_328A150 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    if ( !v14 )
    {
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v31,
        (const MethodInfo_328A14C *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
      return (System_String_o *)StringLiteral_1/*""*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A7082D & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_5629/*"EVENT_INFO_DISTANCE_TXT_"*/, v8);
  ...
  v18 = System_String__Concat_61787092((System_String_o *)StringLiteral_5629/*"EVENT_INFO_DISTANCE_TXT_"*/, v17, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
