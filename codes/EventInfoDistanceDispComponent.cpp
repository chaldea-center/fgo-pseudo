void __fastcall EventInfoDistanceDispComponent___cctor(const MethodInfo *method)
{
  if ( (byte_42B0DDB & 1) == 0 )
  {
    sub_B52984(&EventInfoDistanceDispComponent_TypeInfo);
    byte_42B0DDB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v19; // x1
  System_Collections_Generic_List_Enumerator_T__o v21; // [xsp+0h] [xbp-80h] BYREF
  int v22; // [xsp+18h] [xbp-68h]
  int v23; // [xsp+2Ch] [xbp-54h]
  System_Collections_Generic_List_Enumerator_T__o v24; // [xsp+30h] [xbp-50h] BYREF

  if ( (byte_42B0DDA & 1) == 0 )
  {
    sub_B52984(&Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
    sub_B52984(&Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    sub_B52984(&Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__get_Current__);
    sub_B52984(&EventInfoDistanceDispComponent_TypeInfo);
    sub_B52984(&Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  ...
  System_Collections_Generic_List_BattleLogicBuff_ReduceHpProcess_BuffInfo___GetEnumerator(
    &v21,
    conditionDic,
    (const MethodInfo_2FF2480 *)Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  v24 = v21;
  while ( 2 )
  {
    v7 = System_Collections_Generic_List_Enumerator_BattleLogicBuff_ReduceHpProcess_BuffInfo___MoveNext(
           &v24,
           (const MethodInfo_201195C *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    if ( v7 )
    {
      current = v24.fields.current;
      if ( !v24.fields.current )
        sub_B52A5C(v7, v8);
      switch ( LODWORD(v24.fields.current[1].klass) )
      {
        case 1:
          if ( *((float *)&v24.fields.current[1].klass + 1) >= restDistance )
            continue;
          v10 = 0.0;
          if ( restDistance > 0.0 )
          {
      ...
      *(float *)&v21.fields.list = v10;
      v19 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &v21);
      v13 = System_String__Format(v18, v19, 0LL);
      v14 = 368;
    }
    else
    {
  ...
  System_Collections_Generic_List_Enumerator_BattleLogicBuff_ReduceHpProcess_BuffInfo___Dispose(
    &v24,
    (const MethodInfo_2011958 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
  if ( v22 == 362 )
  {
    v23 = 0;
    return (System_String_o *)StringLiteral_1/*""*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0DD8 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_5678/*"EVENT_INFO_DISTANCE_TXT_"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42B0DD8 = 1;
  }
  ...
  v18 = System_String__Concat_44568316((System_String_o *)StringLiteral_5678/*"EVENT_INFO_DISTANCE_TXT_"*/, v17, 0LL);
  if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
