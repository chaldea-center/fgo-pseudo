void __fastcall EventInfoDistanceDispComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2EAA2 & 1) == 0 )
  {
    sub_1B761C0(&EventInfoDistanceDispComponent_TypeInfo, v1);
    byte_4A2EAA2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EAA1 & 1) == 0 )
  {
    ...
    sub_1B761C0(
      ...
      v6);
    sub_1B761C0(&EventInfoDistanceDispComponent_TypeInfo, v7);
    sub_1B761C0(
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_34D80CC *)Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  v31 = v30;
  while ( 2 )
  {
    v14 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v31,
            (const MethodInfo_32568D8 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    if ( !v14 )
    {
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v31,
        (const MethodInfo_32568D4 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
      return (System_String_o *)StringLiteral_1/*""*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EA9F & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_5627/*"EVENT_INFO_DISTANCE_TXT_"*/, v8);
  ...
  v18 = System_String__Concat_61535060((System_String_o *)StringLiteral_5627/*"EVENT_INFO_DISTANCE_TXT_"*/, v17, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
