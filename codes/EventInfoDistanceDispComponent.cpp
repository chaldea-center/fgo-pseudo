void __fastcall EventInfoDistanceDispComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B46036 & 1) == 0 )
  {
    sub_1BDB878(&EventInfoDistanceDispComponent_TypeInfo, v1);
    byte_4B46036 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46035 & 1) == 0 )
  {
    ...
    sub_1BDB878(
      ...
      v6);
    sub_1BDB878(&EventInfoDistanceDispComponent_TypeInfo, v7);
    sub_1BDB878(
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_36D68BC *)Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  v31 = v30;
  while ( 2 )
  {
    v14 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v31,
            (const MethodInfo_346A2A4 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    if ( !v14 )
    {
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v31,
        (const MethodInfo_346A2A0 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
      return (System_String_o *)StringLiteral_1/*""*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B46033 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_5643/*"EVENT_INFO_DISTANCE_TXT_"*/, v8);
  ...
  v18 = System_String__Concat_62572260((System_String_o *)StringLiteral_5643/*"EVENT_INFO_DISTANCE_TXT_"*/, v17, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
