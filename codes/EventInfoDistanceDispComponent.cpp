void __fastcall EventInfoDistanceDispComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FCFB8 & 1) == 0 )
  {
    sub_1B640C8(&EventInfoDistanceDispComponent_TypeInfo, v1);
    byte_49FCFB8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  EventInfoDistanceDispComponent_c *v19; // x0
  ...
  if ( (byte_49FCFB7 & 1) == 0 )
  {
    ...
    sub_1B640C8(
      ...
      v6);
    sub_1B640C8(&EventInfoDistanceDispComponent_TypeInfo, v7);
    sub_1B640C8(
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    (const MethodInfo_34AE26C *)Method_System_Collections_Generic_List_EventInfoDistanceDispComponent_KeyPositionPairData__GetEnumerator__);
  v26 = v25;
  while ( 2 )
  {
    v13 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v26,
            (const MethodInfo_322A0B0 *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__MoveNext__);
    if ( !v13 )
    {
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v26,
        (const MethodInfo_322A0AC *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
      return (System_String_o *)StringLiteral_1/*""*/;
    }
    current = v26.fields._current;
    if ( !v26.fields._current )
      sub_1B64324(v13);
    switch ( LODWORD(v26.fields._current[1].klass) )
    {
      case 1:
        if ( *((float *)&v26.fields._current[1].klass + 1) >= restDistance )
          continue;
        v15 = 0.0;
        if ( restDistance > 0.0 )
        {
      ...
      case 4:
        ...
        if ( restDistance > 0.0 )
        {
          v19 = EventInfoDistanceDispComponent_TypeInfo;
          if ( !EventInfoDistanceDispComponent_TypeInfo->_2.cctor_finished )
          {
            j_il2cpp_runtime_class_init_0(EventInfoDistanceDispComponent_TypeInfo);
            v19 = EventInfoDistanceDispComponent_TypeInfo;
          }
          v15 = restDistance / (float)v19->static_fields->DISTANCE_DISP_FRACTION;
        }
        monitor = (System_String_o *)current[1].monitor;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v22 = LocalizationManager__Get(monitor, 0LL);
  *(float *)&v25.fields._list = v15;
  v23 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &v25);
  v18 = System_String__Format(v22, v23, 0LL);
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v26,
    (const MethodInfo_322A0AC *)Method_System_Collections_Generic_List_Enumerator_EventInfoDistanceDispComponent_KeyPositionPairData__Dispose__);
  return v18;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCFB5 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_5602/*"EVENT_INFO_DISTANCE_TXT_"*/, v8);
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) == 0 )
  {
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      ...
      IsNullOrEmpty = (System_String_o *)AtlasManager__SetEventUI(v13, bgSpriteName, 0LL);
    }
  }
  ...
  v17 = System_String__Concat_61375396((System_String_o *)StringLiteral_5602/*"EVENT_INFO_DISTANCE_TXT_"*/, v16, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  IsNullOrEmpty = LocalizationManager__Get(v17, 0LL);
  if ( !titleText
...
LABEL_16:
  ...
  EventInfoDistanceDispComponent__UpdateDisp(this, v18);
}
