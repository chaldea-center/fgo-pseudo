void SceneTemp___ctor(SceneTemp_o *this, System_String_o *sceneName, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)sceneName, v5, v6, v7, v8, v9, v10);
...
void SceneTemp___ctor_42638144(SceneTemp_o *this, SceneRootComponent_o *comp, const MethodInfo *method)
{
  __int64 v5; // x0
  ...
  this->fields.sceneName = SceneName;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)SceneName, v8, v9, v10, v11, v12, v13);
