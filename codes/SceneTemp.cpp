void SceneTemp___ctor(SceneTemp_o *this, System_String_o *sceneName, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)sceneName, v5, v6);
...
void SceneTemp___ctor_41530220(SceneTemp_o *this, SceneRootComponent_o *comp, const MethodInfo *method)
{
  __int64 v5; // x0
  ...
  this->fields.sceneName = SceneName;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)SceneName, v8, v9);
