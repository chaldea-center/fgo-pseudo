void BitExpeditionStartComponent___ctor(BitExpeditionStartComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEAF6 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_17387/*"bit_expedition_start_dog_{0}"*/);
    sub_1CE6700(&StringLiteral_17386/*"bit_expedition_start"*/);
    sub_1CE6700(&StringLiteral_17328/*"bg_{0}"*/);
    byte_4DFEAF6 = 1;
  }
  v3 = StringLiteral_17386/*"bit_expedition_start"*/;
  this->fields.START_ANIMATION_NAME_BASE = (struct System_String_o *)StringLiteral_17386/*"bit_expedition_start"*/;
  sub_1CE66A4(&this->fields.START_ANIMATION_NAME_BASE, v3);
  v4 = StringLiteral_17387/*"bit_expedition_start_dog_{0}"*/;
  this->fields.DOG_ANIMATION_NAME_BASE = (struct System_String_o *)StringLiteral_17387/*"bit_expedition_start_dog_{0}"*/;
  sub_1CE66A4(&this->fields.DOG_ANIMATION_NAME_BASE, v4);
  v5 = StringLiteral_17328/*"bg_{0}"*/;
  this->fields.BG_IMAGE_NAME_BASE = (struct System_String_o *)StringLiteral_17328/*"bg_{0}"*/;
  sub_1CE66A4(&this->fields.BG_IMAGE_NAME_BASE, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEAF4 & 1) == 0 )
  {
    sub_1CE6700(&BitExpeditionStartComponent__AnimationPlaying_d__11_TypeInfo);
    byte_4DFEAF4 = 1;
  }
  v8 = sub_1CE694C(BitExpeditionStartComponent__AnimationPlaying_d__11_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0);
  *(_DWORD *)(v8 + 16) = 0;
  *(_QWORD *)(v8 + 48) = this;
  sub_1CE66A4(v8 + 48, this);
  *(_QWORD *)(v8 + 32) = animation;
  sub_1CE66A4(v8 + 32, animation);
  *(_QWORD *)(v8 + 40) = callBack;
  sub_1CE66A4(v8 + 40, callBack);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEAF5 & 1) == 0 )
  {
    this = (BitExpeditionStartComponent_o *)sub_1CE6700(&Method_System_Collections_Generic_List_GameObject__get_Count__);
    byte_4DFEAF5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEAF2 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Linq_Enumerable_FirstOrDefault_GameObject___);
    ...
    sub_1CE6700(&Method_BitExpeditionStartComponent___c__DisplayClass9_0__SetUp_b__0__);
    sub_1CE6700(&BitExpeditionStartComponent___c__DisplayClass9_0_TypeInfo);
    byte_4DFEAF2 = 1;
  }
  v11 = (Il2CppObject *)sub_1CE694C(BitExpeditionStartComponent___c__DisplayClass9_0_TypeInfo);
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_41749752(eventId, bgSprite, v22, 0);
  ...
  sub_1CE66A4(&v11[1], Instance);
  dogList = this->fields.dogList;
  v26 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_GameObject__bool__TypeInfo);
  System_Func_object__bool____ctor(v26, v11, Method_BitExpeditionStartComponent___c__DisplayClass9_0__SetUp_b__0__, 0);
  v27 = System_Linq_Enumerable__FirstOrDefault_object__52613440(
          (System_Collections_Generic_IEnumerable_TSource__o *)dogList,
          (System_Func_TSource__bool__o *)v26,
          (const MethodInfo_322D140 *)Method_System_Linq_Enumerable_FirstOrDefault_GameObject___);
  ...
  if ( !byte_4DFE0AE )
  {
    Instance = (DataManager_o *)sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
    byte_4DFE0AE = 1;
  }
  if ( !v30
    ...
    || (UnityEngine_Animation__Rewind_72660800(
...
LABEL_24:
  ...
  UnityEngine_Animation__Play_72661460((UnityEngine_Animation_o *)Instance, this->fields.START_ANIMATION_NAME_BASE, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEAF3 & 1) == 0 )
  {
    sub_1CE6700(&BitExpeditionStartComponent__WaitTouchSkip_d__10_TypeInfo);
    byte_4DFEAF3 = 1;
  }
  v5 = sub_1CE694C(BitExpeditionStartComponent__WaitTouchSkip_d__10_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1CE66A4(v5 + 32, this);
  *(_QWORD *)(v5 + 40) = setTouchPanelMethod;
  sub_1CE66A4(v5 + 40, setTouchPanelMethod);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEAF7 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_BitExpeditionStartComponent___c__DisplayClass11_0__AnimationPlaying_b__0__);
    sub_1CE6700(&BitExpeditionStartComponent___c__DisplayClass11_0_TypeInfo);
...
LABEL_15:
      ...
      {
LABEL_22:
        v23 = sub_1CBCA7C(Enumerator, System_Collections_IEnumerator_TypeInfo, 1);
      }
      ...
      {
        v24 = (UnityEngine_Component_o *)sub_1CE6CF4(v24);
LABEL_40:
        sub_1CE6958(v24, v25);
      }
...
LABEL_35:
  ...
  {
    this->fields.__1__state = -1;
    v4 = (Il2CppObject *)sub_1CE694C(BitExpeditionStartComponent___c__DisplayClass11_0_TypeInfo);
    ...
    if ( v4 )
    {
      ...
      System_Func_bool____ctor(
        ...
        0);
      v9 = (UnityEngine_WaitUntil_o *)sub_1CE694C(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_BitExpeditionStartComponent__AnimationPlaying_d__11_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEAF8 & 1) == 0 )
  {
    this = (BitExpeditionStartComponent__WaitTouchSkip_d__10_o *)sub_1CE6700(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4DFEAF8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1CE694C(v2);
  System_NotSupportedException___ctor(v3, 0);
  v4 = sub_1CE6714(&Method_BitExpeditionStartComponent__WaitTouchSkip_d__10_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
