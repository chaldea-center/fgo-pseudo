void __fastcall BitExpeditionStartComponent___ctor(BitExpeditionStartComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A73B62 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_17256/*"bit_expedition_start_dog_{0}"*/, method);
    sub_1B90010(&StringLiteral_17255/*"bit_expedition_start"*/, v5);
    sub_1B90010(&StringLiteral_17198/*"bg_{0}"*/, v6);
    byte_4A73B62 = 1;
  }
  v7 = StringLiteral_17255/*"bit_expedition_start"*/;
  this->fields.START_ANIMATION_NAME_BASE = (struct System_String_o *)StringLiteral_17255/*"bit_expedition_start"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.START_ANIMATION_NAME_BASE, v7, v2, v3);
  v8 = StringLiteral_17256/*"bit_expedition_start_dog_{0}"*/;
  this->fields.DOG_ANIMATION_NAME_BASE = (struct System_String_o *)StringLiteral_17256/*"bit_expedition_start_dog_{0}"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.DOG_ANIMATION_NAME_BASE, v8, v9, v10);
  v11 = StringLiteral_17198/*"bg_{0}"*/;
  this->fields.BG_IMAGE_NAME_BASE = (struct System_String_o *)StringLiteral_17198/*"bg_{0}"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.BG_IMAGE_NAME_BASE, v11, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B60 & 1) == 0 )
  {
    sub_1B90010(&BitExpeditionStartComponent__AnimationPlaying_d__11_TypeInfo, animation);
    byte_4A73B60 = 1;
  }
  v8 = sub_1B9025C(BitExpeditionStartComponent__AnimationPlaying_d__11_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  *(_DWORD *)(v8 + 16) = 0;
  *(_QWORD *)(v8 + 48) = this;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v8 + 48), (int32_t)this, v9, v10);
  *(_QWORD *)(v8 + 32) = animation;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v8 + 32), (int32_t)animation, v11, v12);
  *(_QWORD *)(v8 + 40) = callBack;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v8 + 40), (int32_t)callBack, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B61 & 1) == 0 )
  {
    this = (BitExpeditionStartComponent_o *)sub_1B90010(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B5E & 1) == 0 )
  {
    sub_1B90010(&AtlasManager_TypeInfo, eventExpeditionEntity);
    sub_1B90010(&Method_DataManager_GetMasterData_CommonConsumeMaster___, v11);
    sub_1B90010(&Method_System_Linq_Enumerable_FirstOrDefault_GameObject___, v12);
    sub_1B90010(&System_Func_GameObject__bool__TypeInfo, v13);
    ...
    sub_1B90010(&Method_BitExpeditionStartComponent___c__DisplayClass9_0__SetUp_b__0__, v18);
    sub_1B90010(&BitExpeditionStartComponent___c__DisplayClass9_0_TypeInfo, v19);
    byte_4A73B5E = 1;
  }
  v20 = sub_1B9025C(BitExpeditionStartComponent___c__DisplayClass9_0_TypeInfo);
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_37911484(eventId, bgSprite, v34, 0LL);
  ...
  *(_QWORD *)(v20 + 16) = Instance;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v20 + 16), (int32_t)Instance, v40, v41);
  dogList = this->fields.dogList;
  v43 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_GameObject__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v43,
    (Il2CppObject *)v20,
    Method_BitExpeditionStartComponent___c__DisplayClass9_0__SetUp_b__0__,
    0LL);
  v44 = System_Linq_Enumerable__FirstOrDefault_object__48967524(
          (System_Collections_Generic_IEnumerable_TSource__o *)dogList,
          (System_Func_TSource__bool__o *)v43,
          (const MethodInfo_2EB2F64 *)Method_System_Linq_Enumerable_FirstOrDefault_GameObject___);
  ...
  if ( !byte_4A6A9C6 )
  {
    Instance = (DataManager_o *)sub_1B90010(&UnityEngine_Vector3_TypeInfo, v23);
    byte_4A6A9C6 = 1;
  }
  if ( !v47
    ...
    || (UnityEngine_Animation__Rewind_69283872(
...
LABEL_24:
  ...
  UnityEngine_Animation__Play_69284532((UnityEngine_Animation_o *)Instance, this->fields.START_ANIMATION_NAME_BASE, 0LL);
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_69524712((UnityEngine_MonoBehaviour_o *)this, v52, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B5F & 1) == 0 )
  {
    sub_1B90010(&BitExpeditionStartComponent__WaitTouchSkip_d__10_TypeInfo, setTouchPanelMethod);
    byte_4A73B5F = 1;
  }
  v5 = sub_1B9025C(BitExpeditionStartComponent__WaitTouchSkip_d__10_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v5 + 32), (int32_t)this, v6, v7);
  *(_QWORD *)(v5 + 40) = setTouchPanelMethod;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v5 + 40), (int32_t)setTouchPanelMethod, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B63 & 1) == 0 )
  {
    ...
    sub_1B90010(&System_Collections_IEnumerator_TypeInfo, v4);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v5);
    sub_1B90010(&UnityEngine_Transform_TypeInfo, v6);
    sub_1B90010(&Method_BitExpeditionStartComponent___c__DisplayClass11_0__AnimationPlaying_b__0__, v7);
    sub_1B90010(&BitExpeditionStartComponent___c__DisplayClass11_0_TypeInfo, v8);
    sub_1B90010(&UnityEngine_WaitUntil_TypeInfo, v9);
    byte_4A73B63 = 1;
  }
...
LABEL_15:
      ...
      {
LABEL_22:
        v34 = sub_1BE1FF0(Enumerator, System_Collections_IEnumerator_TypeInfo, 1LL);
      }
...
LABEL_40:
    ...
    v39 = sub_1B9014C(Enumerator, System_IDisposable_TypeInfo);
    if ( v39 )
    {
      v40 = *(_QWORD *)v39;
      v41 = v39;
      ...
      {
LABEL_35:
        v44 = sub_1BE1FF0(v39, System_IDisposable_TypeInfo, 0LL);
      }
  ...
  {
    this->fields.__1__state = -1;
    v11 = sub_1B9025C(BitExpeditionStartComponent___c__DisplayClass11_0_TypeInfo);
    System_Object___ctor((Il2CppObject *)v11, 0LL);
    if ( v11 )
    {
      animation = this->fields.animation;
      *(_QWORD *)(v11 + 16) = animation;
      sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v11 + 16), (int32_t)animation, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B90024(&Method_BitExpeditionStartComponent__AnimationPlaying_d__11_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73B64 & 1) == 0 )
  {
    this = (BitExpeditionStartComponent__WaitTouchSkip_d__10_o *)sub_1B90010(
  ...
  sub_1B8FFB4(p__2__current, (int32_t)v6, v8, v9);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1B9025C(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1B90024(&Method_BitExpeditionStartComponent__WaitTouchSkip_d__10_System_Collections_IEnumerator_Reset__);
  sub_1B90138(v3, v4);
}
