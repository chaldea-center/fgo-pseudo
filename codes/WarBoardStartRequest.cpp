        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E410B & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_22382/*"questPhase"*/, *(_QWORD *)&questId);
    sub_1B00CCC(&StringLiteral_22380/*"questId"*/, v7);
    byte_48E410B = 1;
  }
...
System_String_o *__fastcall WarBoardStartRequest__getURL(WarBoardStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E410A & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_24258/*"warBoard/start"*/, v2);
    byte_48E410A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_24258/*"warBoard/start"*/, 0LL);
}
