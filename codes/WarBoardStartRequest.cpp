        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21499 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_22636/*"questPhase"*/, *(_QWORD *)&questId);
    sub_1B715CC(&StringLiteral_22634/*"questId"*/, v7);
    byte_4A21499 = 1;
  }
...
System_String_o *__fastcall WarBoardStartRequest__getURL(WarBoardStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21498 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_24562/*"warBoard/start"*/, v2);
    byte_4A21498 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_24562/*"warBoard/start"*/, 0LL);
}
