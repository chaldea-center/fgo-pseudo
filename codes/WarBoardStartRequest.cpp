        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFEB3 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_22603/*"questPhase"*/, *(_QWORD *)&questId);
    sub_1B64870(&StringLiteral_22601/*"questId"*/, v7);
    byte_49FFEB3 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22601/*"questId"*/, questId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22603/*"questPhase"*/, questPhase, v8);
...
System_String_o *__fastcall WarBoardStartRequest__getURL(WarBoardStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFEB2 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_24526/*"warBoard/start"*/, v2);
    byte_49FFEB2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_24526/*"warBoard/start"*/, 0LL);
}
