        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22861/*"questId"*/, questId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22865/*"questPhase"*/, questPhase, v7);
...
System_String_o *WarBoardStartRequest__getURL(WarBoardStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44C28 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_24740/*"warBoard/start"*/);
    byte_4C44C28 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63561656(BaseUrl, (System_String_o *)StringLiteral_24740/*"warBoard/start"*/, 0);
}
