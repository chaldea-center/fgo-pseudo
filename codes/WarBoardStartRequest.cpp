        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB773A & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_22730/*"questPhase"*/, *(_QWORD *)&questId);
    sub_1BAB41C(&StringLiteral_22728/*"questId"*/, v7);
    byte_4AB773A = 1;
  }
...
System_String_o *__fastcall WarBoardStartRequest__getURL(WarBoardStartRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7739 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_24663/*"warBoard/start"*/, v2);
    byte_4AB7739 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_24663/*"warBoard/start"*/, 0LL);
}
