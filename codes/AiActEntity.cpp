        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C0E0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int__Add__, *(_QWORD *)&commandType);
    ...
    sub_1BCAFF8(&StringLiteral_19292/*"fixQuickCardId"*/, v8);
    sub_1BCAFF8(&StringLiteral_19289/*"fixBusterCardId"*/, v9);
    sub_1BCAFF8(&StringLiteral_19295/*"fixWeakCardId"*/, v10);
    sub_1BCAFF8(&StringLiteral_19288/*"fixArtsCardId"*/, v11);
    sub_1BCAFF8(&StringLiteral_19293/*"fixStrengthCardId"*/, v12);
    byte_4B1C0E0 = 1;
  }
  *(_QWORD *)value = 0LL;
  v25 = 0LL;
  ...
  switch ( commandType )
  {
    case 1:
      IntValueAndCompare = EntityScriptUtil__GetIntValueAndCompare(
                             this->fields.script,
                             (System_String_o *)StringLiteral_19288/*"fixArtsCardId"*/,
                             (int32_t *)&v25 + 1,
                             -1,
                             0LL);
    ...
    case 2:
      IntValueAndCompare = EntityScriptUtil__GetIntValueAndCompare(
                             this->fields.script,
                             (System_String_o *)StringLiteral_19289/*"fixBusterCardId"*/,
                             (int32_t *)&v25,
                             -1,
                             0LL);
      if ( IntValueAndCompare )
...
LABEL_29:
      sub_1BCB254(IntValueAndCompare, v15);
    case 3:
      IntValueAndCompare = EntityScriptUtil__GetIntValueAndCompare(
                             this->fields.script,
                             (System_String_o *)StringLiteral_19292/*"fixQuickCardId"*/,
                             &value[1],
                             -1,
                             0LL);
      if ( IntValueAndCompare )
  ...
  IntValueAndCompare = EntityScriptUtil__GetIntValueAndCompare(
                         this->fields.script,
                         (System_String_o *)StringLiteral_19295/*"fixWeakCardId"*/,
                         value,
                         -1,
                         0LL);
  if ( IntValueAndCompare )
  ...
  IntValueAndCompare = EntityScriptUtil__GetIntValueAndCompare(
                         this->fields.script,
                         (System_String_o *)StringLiteral_19293/*"fixStrengthCardId"*/,
                         &item,
                         -1,
                         0LL);
  if ( !IntValueAndCompare )
...
int32_t __fastcall AiActEntity__GetNoTargetNoActionType(AiActEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B1C0DE & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_22052/*"noTargetNoActionType"*/, method);
    byte_4B1C0DE = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22052/*"noTargetNoActionType"*/, 0, 0LL);
}
...
bool __fastcall AiActEntity__IsIncludeDeathSvt(AiActEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B1C0DC & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_20558/*"includeDeathSvt"*/, method);
    byte_4B1C0DC = 1;
  }
  return EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_20558/*"includeDeathSvt"*/, 0LL);
}
...
bool __fastcall AiActEntity__IsNoCriticalOnAttack(AiActEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B1C0DF & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_22043/*"noCriticalOnAttack"*/, method);
    byte_4B1C0DF = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22043/*"noCriticalOnAttack"*/, 0, 0LL) == 1;
}
