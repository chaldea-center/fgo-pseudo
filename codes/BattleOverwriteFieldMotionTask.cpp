        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FC1A & 1) == 0 )
  {
    sub_1C94098(&BattleOverwriteFieldMotionActionData_TypeInfo);
    byte_4D2FC1A = 1;
  }
  overwriteMotionIds = this->fields.overwriteMotionIds;
  v5 = (BattleOverwriteFieldMotionActionData_o *)sub_1C942E4(BattleOverwriteFieldMotionActionData_TypeInfo);
