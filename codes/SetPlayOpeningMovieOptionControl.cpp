        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5670C & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_9668/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/);
    sub_1B885B0(&StringLiteral_9710/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/);
    sub_1B885B0(&StringLiteral_9711/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/);
    sub_1B885B0(&StringLiteral_20568/*"img_txt_playopening"*/);
    sub_1B885B0(&StringLiteral_9669/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/);
    byte_4A5670C = 1;
  }
  titleImage = this->fields.titleImage;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetMyRoomImage(titleImage, (System_String_o *)StringLiteral_20568/*"img_txt_playopening"*/, 0LL);
  notPlayTitleLabel = this->fields.notPlayTitleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9668/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/, 0LL);
  if ( !notPlayTitleLabel )
    goto LABEL_14;
  UILabel__set_text(notPlayTitleLabel, v5, 0LL);
  notPlayInfoLabel = this->fields.notPlayInfoLabel;
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9669/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/, 0LL);
  if ( !notPlayInfoLabel
    || (UILabel__set_text(notPlayInfoLabel, v5, 0LL),
        touchSkipTitleLabel = this->fields.touchSkipTitleLabel,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9710/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/, 0LL),
        !touchSkipTitleLabel)
    || (UILabel__set_text(touchSkipTitleLabel, v5, 0LL),
        touchSkipInfoLabel = this->fields.touchSkipInfoLabel,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9711/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/, 0LL),
        !touchSkipInfoLabel) )
  {
LABEL_14:
    sub_1B8880C(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5670E & 1) == 0 )
  {
    sub_1B885B0(&Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__);
    byte_4A5670E = 1;
  }
  klass = this->klass;
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B885C8(Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5670F & 1) == 0 )
  {
    sub_1B885B0(&Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__);
    byte_4A5670F = 1;
  }
  klass = this->klass;
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B885C8(Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v4, v4[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( !notPlaySwitchButton
    || ((touchSkipFlag = this->fields.touchSkipFlag,
         v5 = StringLiteral_17525/*"btn_off"*/,
         v6 = StringLiteral_17526/*"btn_on"*/,
         this->fields.notPlayFlag)
      ? (v7 = (System_String_o *)StringLiteral_17526/*"btn_on"*/)
      : (v7 = (System_String_o *)StringLiteral_17525/*"btn_off"*/),
        UIButton__set_normalSprite(notPlaySwitchButton, v7, 0LL),
        (notPlaySwitchButton = this->fields.touchSkipSwitchButton) == 0LL) )
  {
    sub_1B8880C(notPlaySwitchButton, method);
  }
  if ( touchSkipFlag )
