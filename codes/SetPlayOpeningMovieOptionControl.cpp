...
void SetPlayOpeningMovieOptionControl__Init(SetPlayOpeningMovieOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596B59E & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_10072/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/);
    sub_2213A60(&StringLiteral_10114/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/);
    sub_2213A60(&StringLiteral_10115/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/);
    sub_2213A60(&StringLiteral_21696/*"img_txt_playopening"*/);
    sub_2213A60(&StringLiteral_10073/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/);
    byte_596B59E = 1;
  }
  titleImage = this->fields.titleImage;
  if ( !*(&AtlasManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo, method, v2);
  AtlasManager__SetMyRoomImage(titleImage, (System_String_o *)StringLiteral_21696/*"img_txt_playopening"*/, 0);
  ...
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_10072/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/, 0);
  if ( !notPlayTitleLabel )
    goto LABEL_14;
  UILabel__set_text(notPlayTitleLabel, v8, 0);
  notPlayInfoLabel = this->fields.notPlayInfoLabel;
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_10073/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/, 0);
  if ( !notPlayInfoLabel
    || (UILabel__set_text(notPlayInfoLabel, v8, 0),
        touchSkipTitleLabel = this->fields.touchSkipTitleLabel,
        v8 = LocalizationManager__Get((System_String_o *)StringLiteral_10114/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/, 0),
        !touchSkipTitleLabel)
    || (UILabel__set_text(touchSkipTitleLabel, v8, 0),
        touchSkipInfoLabel = this->fields.touchSkipInfoLabel,
        v8 = LocalizationManager__Get((System_String_o *)StringLiteral_10115/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/, 0),
        !touchSkipInfoLabel) )
  {
LABEL_14:
    sub_2213CDC(v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B5A0 & 1) == 0 )
  {
    sub_2213A60(&Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__);
    byte_596B5A0 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_2213A78(Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596B5A1 & 1) == 0 )
  {
    sub_2213A60(&Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__);
    byte_596B5A1 = 1;
  }
  methodPtr = this->klass->vtable._5_Reflection.methodPtr;
  v3 = this->klass->vtable._5_Reflection.method;
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_2213A78(Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__);
  v7 = (System_Reflection_MethodBase_o *)sub_2213A44(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( !notPlaySwitchButton
    || ((touchSkipFlag = this->fields.touchSkipFlag,
         ...
         v6 = StringLiteral_18275/*"btn_on"*/,
         this->fields.notPlayFlag)
      ? (v7 = (System_String_o *)StringLiteral_18275/*"btn_on"*/)
      : (v7 = (System_String_o *)StringLiteral_18274/*"btn_off"*/),
        UIButton__set_normalSprite(notPlaySwitchButton, v7, 0),
        (notPlaySwitchButton = this->fields.touchSkipSwitchButton) == 0) )
  {
    sub_2213CDC(notPlaySwitchButton, method);
  }
  if ( touchSkipFlag )
