        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1761A & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_9599/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/, v5);
    sub_1BCAFF8(&StringLiteral_9641/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/, v6);
    sub_1BCAFF8(&StringLiteral_9642/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/, v7);
    sub_1BCAFF8(&StringLiteral_20511/*"img_txt_playopening"*/, v8);
    sub_1BCAFF8(&StringLiteral_9600/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/, v9);
    byte_4B1761A = 1;
  }
  titleImage = this->fields.titleImage;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetMyRoomImage(titleImage, (System_String_o *)StringLiteral_20511/*"img_txt_playopening"*/, 0LL);
  notPlayTitleLabel = this->fields.notPlayTitleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_9599/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/, 0LL);
  if ( !notPlayTitleLabel )
    goto LABEL_14;
  UILabel__set_text(notPlayTitleLabel, v12, 0LL);
  notPlayInfoLabel = this->fields.notPlayInfoLabel;
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_9600/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/, 0LL);
  if ( !notPlayInfoLabel
    || (UILabel__set_text(notPlayInfoLabel, v12, 0LL),
        touchSkipTitleLabel = this->fields.touchSkipTitleLabel,
        v12 = LocalizationManager__Get((System_String_o *)StringLiteral_9641/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/, 0LL),
        !touchSkipTitleLabel)
    || (UILabel__set_text(touchSkipTitleLabel, v12, 0LL),
        touchSkipInfoLabel = this->fields.touchSkipInfoLabel,
        v12 = LocalizationManager__Get((System_String_o *)StringLiteral_9642/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/, 0LL),
        !touchSkipInfoLabel) )
  {
LABEL_14:
    sub_1BCB254(v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1761C & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__, method);
    byte_4B1761C = 1;
  }
  klass = this->klass;
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BCB010(Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1761D & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__, method);
    byte_4B1761D = 1;
  }
  klass = this->klass;
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BCB010(Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v4, v4[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( !notPlaySwitchButton
    || ((touchSkipFlag = this->fields.touchSkipFlag,
         v6 = StringLiteral_17362/*"btn_off"*/,
         v7 = StringLiteral_17363/*"btn_on"*/,
         this->fields.notPlayFlag)
      ? (v8 = (System_String_o *)StringLiteral_17363/*"btn_on"*/)
      : (v8 = (System_String_o *)StringLiteral_17362/*"btn_off"*/),
        UIButton__set_normalSprite(notPlaySwitchButton, v8, 0LL),
        (notPlaySwitchButton = this->fields.touchSkipSwitchButton) == 0LL) )
  {
    sub_1BCB254(notPlaySwitchButton, method);
  }
  if ( touchSkipFlag )
