...
void SetPlayOpeningMovieOptionControl__Init(SetPlayOpeningMovieOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B87C & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_9729/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/);
    sub_1C93AD4(&StringLiteral_9771/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/);
    sub_1C93AD4(&StringLiteral_9772/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/);
    sub_1C93AD4(&StringLiteral_20932/*"img_txt_playopening"*/);
    sub_1C93AD4(&StringLiteral_9730/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/);
    byte_4D2B87C = 1;
  }
  titleImage = this->fields.titleImage;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetMyRoomImage(titleImage, (System_String_o *)StringLiteral_20932/*"img_txt_playopening"*/, 0);
  notPlayTitleLabel = this->fields.notPlayTitleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9729/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/, 0);
  if ( !notPlayTitleLabel )
    goto LABEL_14;
  UILabel__set_text(notPlayTitleLabel, v5, 0);
  notPlayInfoLabel = this->fields.notPlayInfoLabel;
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9730/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/, 0);
  if ( !notPlayInfoLabel
    || (UILabel__set_text(notPlayInfoLabel, v5, 0),
        touchSkipTitleLabel = this->fields.touchSkipTitleLabel,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9771/*"OPTION_TOUCH_SKIP_OPENING_MOVIE"*/, 0),
        !touchSkipTitleLabel)
    || (UILabel__set_text(touchSkipTitleLabel, v5, 0),
        touchSkipInfoLabel = this->fields.touchSkipInfoLabel,
        v5 = LocalizationManager__Get((System_String_o *)StringLiteral_9772/*"OPTION_TOUCH_SKIP_OPENING_MOVIE_INFO"*/, 0),
        !touchSkipInfoLabel) )
  {
LABEL_14:
    sub_1C93D2C(v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B87E & 1) == 0 )
  {
    sub_1C93AD4(&Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__);
    byte_4D2B87E = 1;
  }
  klass = this->klass;
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C93AEC(Method_SetPlayOpeningMovieOptionControl_OnClickNotPlaySwitchButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B87F & 1) == 0 )
  {
    sub_1C93AD4(&Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__);
    byte_4D2B87F = 1;
  }
  klass = this->klass;
  ...
  if ( (*((_BYTE *)Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C93AEC(Method_SetPlayOpeningMovieOptionControl_OnClickTouchSkipSwitchButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v4, v4[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( !notPlaySwitchButton
    || ((touchSkipFlag = this->fields.touchSkipFlag,
         v5 = StringLiteral_17637/*"btn_off"*/,
         v6 = StringLiteral_17638/*"btn_on"*/,
         this->fields.notPlayFlag)
      ? (v7 = (System_String_o *)StringLiteral_17638/*"btn_on"*/)
      : (v7 = (System_String_o *)StringLiteral_17637/*"btn_off"*/),
        UIButton__set_normalSprite(notPlaySwitchButton, v7, 0),
        (notPlaySwitchButton = this->fields.touchSkipSwitchButton) == 0) )
  {
    sub_1C93D2C(notPlaySwitchButton, method);
  }
  if ( touchSkipFlag )
