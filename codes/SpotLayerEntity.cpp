        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F020 & 1) == 0 )
  {
    sub_1B863B8(&Method_BasicHelper_Any_int____76088168, *(_QWORD *)&targetLayer);
    sub_1B863B8(&System_Func_int__bool__TypeInfo, v5);
    sub_1B863B8(&Method_SpotLayerEntity___c__DisplayClass1_0__IsEnabledDispSpot_b__0__, v6);
    sub_1B863B8(&SpotLayerEntity___c__DisplayClass1_0_TypeInfo, v7);
    byte_4A4F020 = 1;
  }
  v8 = sub_1B86604(SpotLayerEntity___c__DisplayClass1_0_TypeInfo);
...
bool __fastcall SpotLayerEntity__IsEnabledSpot(SpotLayerEntity_o *this, int32_t targetLayer, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F01F & 1) == 0 )
  {
    sub_1B863B8(&Method_BasicHelper_Any_int____76088168, *(_QWORD *)&targetLayer);
    sub_1B863B8(&System_Func_int__bool__TypeInfo, v5);
    sub_1B863B8(&Method_SpotLayerEntity___c__DisplayClass0_0__IsEnabledSpot_b__0__, v6);
    sub_1B863B8(&SpotLayerEntity___c__DisplayClass0_0_TypeInfo, v7);
    byte_4A4F01F = 1;
  }
  v8 = sub_1B86604(SpotLayerEntity___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1B86614(v9, v10);
  *(_DWORD *)(v8 + 16) = targetLayer;
