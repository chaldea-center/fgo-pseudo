        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D0DA & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BasicHelper_Any_int____76918080, *(_QWORD *)&targetLayer);
    sub_1BCAFF8(&System_Func_int__bool__TypeInfo, v5);
    sub_1BCAFF8(&Method_SpotLayerEntity___c__DisplayClass1_0__IsEnabledDispSpot_b__0__, v6);
    sub_1BCAFF8(&SpotLayerEntity___c__DisplayClass1_0_TypeInfo, v7);
    byte_4B1D0DA = 1;
  }
  v8 = sub_1BCB244(SpotLayerEntity___c__DisplayClass1_0_TypeInfo);
...
bool __fastcall SpotLayerEntity__IsEnabledSpot(SpotLayerEntity_o *this, int32_t targetLayer, const MethodInfo *method)
{
  ...
  if ( (byte_4B1D0D9 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BasicHelper_Any_int____76918080, *(_QWORD *)&targetLayer);
    sub_1BCAFF8(&System_Func_int__bool__TypeInfo, v5);
    sub_1BCAFF8(&Method_SpotLayerEntity___c__DisplayClass0_0__IsEnabledSpot_b__0__, v6);
    sub_1BCAFF8(&SpotLayerEntity___c__DisplayClass0_0_TypeInfo, v7);
    byte_4B1D0D9 = 1;
  }
  v8 = sub_1BCB244(SpotLayerEntity___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1BCB254(v9, v10);
  *(_DWORD *)(v8 + 16) = targetLayer;
