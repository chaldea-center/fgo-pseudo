        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22A85 & 1) == 0 )
  {
    sub_1C3B764(&Method_BasicHelper_Any_int____77906328, *(_QWORD *)&targetLayer);
    sub_1C3B764(&System_Func_int__bool__TypeInfo, v5);
    sub_1C3B764(&Method_SpotLayerEntity___c__DisplayClass1_0__IsEnabledDispSpot_b__0__, v6);
    sub_1C3B764(&SpotLayerEntity___c__DisplayClass1_0_TypeInfo, v7);
    byte_4C22A85 = 1;
  }
  v8 = sub_1C3B9B0(SpotLayerEntity___c__DisplayClass1_0_TypeInfo);
...
bool __fastcall SpotLayerEntity__IsEnabledSpot(SpotLayerEntity_o *this, int32_t targetLayer, const MethodInfo *method)
{
  ...
  if ( (byte_4C22A84 & 1) == 0 )
  {
    sub_1C3B764(&Method_BasicHelper_Any_int____77906328, *(_QWORD *)&targetLayer);
    sub_1C3B764(&System_Func_int__bool__TypeInfo, v5);
    sub_1C3B764(&Method_SpotLayerEntity___c__DisplayClass0_0__IsEnabledSpot_b__0__, v6);
    sub_1C3B764(&SpotLayerEntity___c__DisplayClass0_0_TypeInfo, v7);
    byte_4C22A84 = 1;
  }
  v8 = sub_1C3B9B0(SpotLayerEntity___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1C3B9C0(v9, v10);
  *(_DWORD *)(v8 + 16) = targetLayer;
