...
System_String_o *BattleSetupScenarioRequest__getURL(BattleSetupScenarioRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06467 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_17238/*"battle/setupScenario"*/);
    byte_4E06467 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65122828(BaseUrl, (System_String_o *)StringLiteral_17238/*"battle/setupScenario"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E06469 & 1) == 0 )
  {
    ...
    this = (BattleSetupScenarioRequest_o *)sub_1CE6700(&StringLiteral_22555/*"ng"*/);
    byte_4E06469 = 1;
  }
  if ( !responseList )
    goto LABEL_10;
