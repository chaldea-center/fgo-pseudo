...
System_String_o *BattleSetupScenarioRequest__getURL(BattleSetupScenarioRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_597233F & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_17788/*"battle/setupScenario"*/);
    byte_597233F = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75651716(BaseUrl, (System_String_o *)StringLiteral_17788/*"battle/setupScenario"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972341 & 1) == 0 )
  {
    ...
    this = (BattleSetupScenarioRequest_o *)sub_2213A60(&StringLiteral_23336/*"ng"*/);
    byte_5972341 = 1;
  }
  if ( !responseList )
    goto LABEL_10;
