void __fastcall BattleLogicBaseAi___ctor(BattleLogicBaseAi_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B47938 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Array_Empty_BattleLogicTask___, method);
    byte_4B47938 = 1;
  }
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.emptyTask, (int32_t)v11, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47937 & 1) == 0 )
  {
    sub_1BDB878(&BattleEndNotRelatedSurvivalStatusInstantlyTask_TypeInfo, retList);
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleLogicTask__Add__, v7);
    byte_4B47937 = 1;
  }
  v8 = (BattleEndNotRelatedSurvivalStatusInstantlyTask_o *)sub_1BDBAC4(BattleEndNotRelatedSurvivalStatusInstantlyTask_TypeInfo);
  BattleEndNotRelatedSurvivalStatusInstantlyTask___ctor(v8, arg, 0LL);
  if ( !arg
    || (Task_45580864 = (Il2CppObject *)BaseAiActArgument__MakeTask_45580864(
                                          arg,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47930 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleLogicTask__Add__, retList);
    sub_1BDB878(&MessageBattleLogicTask_TypeInfo, v7);
    byte_4B47930 = 1;
  }
  v8 = (MessageBattleLogicTask_o *)sub_1BDBAC4(MessageBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&Method_System_Collections_Generic_List_BattleLogicTask__Add__, retList);
    this = (BattleLogicBaseAi_o *)sub_1BDB878(&StringLiteral_8732/*"MOTION_"*/, v7);
    byte_4B4792F = 1;
  }
  if ( !arg )
    goto LABEL_15;
  ...
  this = (BattleLogicBaseAi_o *)System_String__Concat_62572260((System_String_o *)StringLiteral_8732/*"MOTION_"*/, v10, 0LL);
  if ( !Task )
    goto LABEL_15;
  ...
  if ( !perf
    || (ServantGameObject = BattlePerformance__getServantGameObject(perf, (int32_t)this, 0LL),
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&Task->fields.targetObject, (int32_t)ServantGameObject, v14, v15),
        !retList)
    || (items = retList->fields._items,
...
LABEL_15:
  ...
  else
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)(v21 + 4), (int32_t)Task, v16, v17);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47931 & 1) == 0 )
  {
    sub_1BDB878(&Method_BasicHelper_IndexValue_int____77079288, retList);
    ...
    this = (BattleLogicBaseAi_o *)sub_1BDB878(&TempBattleSkillInfoData_TypeInfo, v11);
    byte_4B47931 = 1;
  }
  v37 = 0LL;
  entity = 0LL;
  ...
  this = (BattleLogicBaseAi_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_SkillLvMaster___);
  if ( !this )
    goto LABEL_22;
          ...
          v6->klass->vtable._17_SetAddSkillTaskParam.methodPtr) & 1) != 0 )
  {
    v16 = ((__int64 (__fastcall *)(BaseAiActArgument_o *, Il2CppMethodPointer))arg->klass->vtable._4_get_UniqueId.method)(
            arg,
            arg->klass->vtable._5_InitCommonTask.methodPtr);
    v17 = (TempBattleSkillInfoData_o *)sub_1BDBAC4(TempBattleSkillInfoData_TypeInfo);
        ...
        if ( items )
        {
          ...
          if ( v32 )
          {
            ...
            else
            {
              ...
              sub_1BDB81C((CGThumbnailListItem_o *)(v35 + 4), (int32_t)v29, v30, v31);
            }
            return;
          }
        }
...
LABEL_12:
  ...
  else
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)(v15 + 4), (int32_t)v14, v9, v10);
  }
}
...
bool __fastcall BattleLogicBaseAi__ExistProcAiAct(BattleLogicBaseAi_o *this, int32_t type, const MethodInfo *method)
{
  ...
  if ( System_Collections_Generic_Dictionary_Int32Enum__object___ContainsKey(
         ...
         type,
         (const MethodInfo_336D204 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__ContainsKey__) )
  {
    return 1;
  }
  ...
  if ( !dicNoTargetAiActFunc )
LABEL_8:
    sub_1BDBAD4(dicNoTargetAiActFunc, *(_QWORD *)&type);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47933 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_AiActMaster__AiActEntity__int__GetEntity__, *(_QWORD *)&aiActId);
    byte_4B47933 = 1;
  }
  aiActMst = (DataMasterBase_TMaster__TEntity__PKType__o *)this->fields.aiActMst;
  if ( !aiActMst )
    sub_1BDBAD4(0LL, *(_QWORD *)&aiActId);
        ...
        const MethodInfo *method)
{
  ...
  *ptTargets = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)ptTargets, 0, (int32_t)skillLvEnt, (const MethodInfo *)targets);
  *targets = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)targets, 0, v7, v8);
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47932 & 1) == 0 )
  {
    sub_1BDB878(&int___TypeInfo, arg);
    byte_4B47932 = 1;
  }
  TargetAiAct = sub_1BDB920(int___TypeInfo, 1LL);
  if ( !arg
    ...
    || (TargetAiAct = BattleLogicTarget__getTargetAiAct(
        ...
        !v18) )
  {
    sub_1BDBAD4(TargetAiAct, v14);
  }
  if ( !v18->max_length )
    sub_1BDBADC(TargetAiAct, v14, v20);
...
void __fastcall BattleLogicBaseAi__InitAiActTaskFunction(BattleLogicBaseAi_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B4792D & 1) == 0 )
  {
    ...
    sub_1BDB878(
      ...
      v3);
    sub_1BDB878(&System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__TypeInfo, v4);
    sub_1BDB878(&BattleLogicBaseAi_taskAiActFunction_TypeInfo, v5);
    byte_4B4792D = 1;
  }
  v6 = (System_Collections_Generic_Dictionary_TKey__TValue__o *)sub_1BDBAC4(System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__TypeInfo);
  System_Collections_Generic_Dictionary_Int32Enum__object____ctor(
    v6,
    (const MethodInfo_336C63C *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction___ctor__);
  v7 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  if ( !this )
    goto LABEL_7;
  v10 = (Il2CppObject *)v7;
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    0,
    v10,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v11 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v11,
    (Il2CppObject *)this,
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v11,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v13 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v13,
    (Il2CppObject *)this,
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v13,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v15 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v15,
    (Il2CppObject *)this,
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v15,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v17 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v17,
    (Il2CppObject *)this,
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v17,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v19 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v19,
    (Il2CppObject *)this,
    (intptr_t)this->klass->vtable._15_AddSkillTask.methodPtr,
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v19,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v21 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v21,
    (Il2CppObject *)this,
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v21,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v23 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v23,
    (Il2CppObject *)this,
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v23,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v25 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dicNoTargetAiActFunc, (int32_t)v6, v27, v28);
  v29 = (System_Collections_Generic_Dictionary_TKey__TValue__o *)sub_1BDBAC4(System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__TypeInfo);
  System_Collections_Generic_Dictionary_Int32Enum__object____ctor(
    v29,
    (const MethodInfo_336C63C *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction___ctor__);
  v30 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v30,
    (Il2CppObject *)this,
...
LABEL_7:
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___Add(
    ...
    (Il2CppObject *)v30,
    (const MethodInfo_336D010 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__Add__);
  v32 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BDBAC4(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v32,
    (Il2CppObject *)this,
    (intptr_t)this->klass->vtable._16_GetAiActTargets.methodPtr,
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.dicAiActFunc, (int32_t)v29, v34, v35);
}
...
void __fastcall BattleLogicBaseAi__Initialize(BattleLogicBaseAi_o *this, BattleData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4B4792C & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_AiActMaster___, data);
  ...
  if ( !data
    || (logic = data->fields.logic,
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.logic, (int32_t)logic, v9, v10),
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.logictarget, (int32_t)logictarget, v12, v13);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.aiActMst, (int32_t)Master_object, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( !aiEnt )
LABEL_9:
    sub_1BDBAD4(this, *(_QWORD *)&actType);
  v5 = actType;
...
LABEL_8:
    sub_1BDBAD4(dicNoTargetAiActFunc, retList);
  }
  return v10 & 1;
}
...
LABEL_8:
    sub_1BDBAD4(dicAiActFunc, retList);
  }
  return v10 & 1;
}
  ...
  else
  {
    if ( v8 == 1 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v11 & 1) != 0 )
            v9 = (Il2CppObject *)sub_1A28254;
          else
            v9 = (Il2CppObject *)sub_1A28208;
        }
        else if ( (v11 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_1A2817C;
        }
        else
        {
          v9 = (Il2CppObject *)sub_1A2814C;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_1A28114;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A280BC;
}
