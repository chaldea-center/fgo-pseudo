void __fastcall MstProfileComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4C3 & 1) == 0 )
  {
    sub_1B90010(&MstProfileComponent_TypeInfo, v1);
    byte_4A6B4C3 = 1;
  }
...
void __fastcall MstProfileComponent___ctor(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_61695172(v4, v6, 0LL);
  this->fields.dispItemInfoList = v5;
  sub_1B8FFB4(&this->fields.dispItemInfoList);
...
void __fastcall MstProfileComponent__OnClickBack(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4BF & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_OnClickBack__, method);
  ...
  if ( (*((_BYTE *)Method_MstProfileComponent_OnClickBack__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_OnClickBack__);
...
void __fastcall MstProfileComponent__OnClickNameChangeBtn(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4AE & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_OnClickNameChangeBtn__, method);
  ...
  if ( !UnityEngine_Object__op_Inequality(myRoomFsm, 0LL, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_MstProfileComponent_OnClickNameChangeBtn__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_OnClickNameChangeBtn__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B1 & 1) == 0 )
  {
    sub_1B90010(&UnityEngine_Object_TypeInfo, changeName);
    sub_1B90010(&StringLiteral_4412/*"ChangeUserName"*/, v5);
    sub_1B90010(&StringLiteral_3571/*"CLICK_SUBMIT"*/, v6);
    byte_4A6B4B1 = 1;
  }
  myRoomFsm = (UnityEngine_Object_o *)this->fields.myRoomFsm;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(myRoomFsm, 0LL, 0LL) )
  {
    ...
    if ( !Fsm
      ...
      || (Fsm->fields.addEventHandlers = (struct PlayMakerFSM_AddEventHandlerDelegate_o *)changeName,
          sub_1B8FFB4(&Fsm->fields.addEventHandlers),
          (Fsm = this->fields.myRoomFsm) == 0LL) )
    {
      sub_1B9026C(Fsm, v8);
    }
    PlayMakerFSM__SendEvent(Fsm, (System_String_o *)StringLiteral_3571/*"CLICK_SUBMIT"*/, 0LL);
  }
  else
  {
...
void __fastcall MstProfileComponent__OpenExpInfo(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B3 & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_OpenExpInfo__, method);
    byte_4A6B4B3 = 1;
  }
  v3 = Method_MstProfileComponent_OpenExpInfo__;
  if ( (*((_BYTE *)Method_MstProfileComponent_OpenExpInfo__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_OpenExpInfo__);
...
void __fastcall MstProfileComponent__SetProfileData(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4A4 & 1) == 0 )
  {
    ...
    sub_1B90010(&MstProfileComponent_TypeInfo, v3);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v4);
    sub_1B90010(&StringLiteral_8915/*"MasterProfileInfo"*/, v5);
    byte_4A6B4A4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B49D & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_TitleInfoControl___, v7);
    sub_1B90010(&Method_MstProfileComponent_OnClickBack__, v8);
    ...
    sub_1B90010(&Method_MstProfileComponent___c__DisplayClass62_0__ShowMstProfile_b__0__, v13);
    sub_1B90010(&MstProfileComponent___c__DisplayClass62_0_TypeInfo, v14);
    byte_4A6B49D = 1;
  }
  count = 0;
  recoverTime = 0LL;
  v15 = (Il2CppObject *)sub_1B9025C(MstProfileComponent___c__DisplayClass62_0_TypeInfo);
  ...
  sub_1B8FFB4(&this->fields.titleInfo);
  ...
  if ( !*p_titleInfo )
    goto LABEL_28;
  TitleInfoControl__changeTitleInfo_37240592((TitleInfoControl_o *)gameObject, 1, 45, 0, 0LL);
  gameObject = (UnityEngine_GameObject_o *)*p_titleInfo;
  if ( !*p_titleInfo )
    goto LABEL_28;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4C4 & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_callbackChangeMessage__, result);
    this = (MstProfileComponent_o *)sub_1B90010(&NetworkManager_ResultCallbackFunc_TypeInfo, v7);
    byte_4A6B4C4 = 1;
  }
  if ( result )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4BE & 1) == 0 )
  {
    this = (MstProfileComponent_o *)sub_1B90010(&StringLiteral_22258/*"ok"*/, result);
    byte_4A6B4BE = 1;
  }
  if ( !result
    || (this = (MstProfileComponent_o *)System_String__Equals_61795408(
                                          result,
        ...
        const MethodInfo *method)
{
  ...
  if ( !result )
    goto LABEL_10;
  this = (MstProfileComponent_o *)System_String__Equals_61795408(result, (System_String_o *)StringLiteral_22258/*"ok"*/, 0LL);
...
void __fastcall MstProfileComponent__checkInput(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B2 & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_callbackChangeName__, method);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v3);
    sub_1B90010(&NetworkManager_ResultCallbackFunc_TypeInfo, v4);
    sub_1B90010(&StringLiteral_3460/*"CHECK_OK"*/, v5);
    byte_4A6B4B2 = 1;
  }
  myRoomFsm = (UnityEngine_Object_o *)this->fields.myRoomFsm;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(myRoomFsm, 0LL, 0LL) )
  {
    ...
    if ( SelfUserGame )
    {
      PlayMakerFSM__SendEvent((PlayMakerFSM_o *)SelfUserGame, (System_String_o *)StringLiteral_3460/*"CHECK_OK"*/, 0LL);
      return;
    }
LABEL_10:
...
void __fastcall MstProfileComponent__createCmdSpellWindow(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4A2 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_CommandSpellWindowComponent___, method);
  ...
  if ( UnityEngine_Object__op_Equality(cmdSpellWinComp, 0LL, 0LL) )
  {
    ...
    if ( !gameObject
      ...
      || (*p_cmdSpellWinComp = (struct CommandSpellWindowComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                         ...
                                                                         (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_CommandSpellWindowComponent___),
          sub_1B8FFB4(&this->fields.cmdSpellWinComp),
    ...
    GameObjectExtensions__SafeSetParent_33776688(v12, this->fields.cmdSpellWinInfo, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4AA & 1) == 0 )
  {
    sub_1B90010(&CondType_TypeInfo, callback);
    sub_1B90010(&System_DateTime_TypeInfo, v5);
    sub_1B90010(&LocalizationManager_TypeInfo, v6);
    sub_1B90010(&MstProfileComponent_TypeInfo, v7);
    sub_1B90010(&StringLiteral_3033/*"BIRTHDAY"*/, v8);
    byte_4A6B4AA = 1;
  }
  ...
  IsOpen = (UnityEngine_Transform_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3033/*"BIRTHDAY"*/, 0LL);
  ...
  if ( !this->fields.inputBirthDayWindow
    || (v22 = (Il2CppObject *)IsOpen,
        PaddingBirthday = (Il2CppObject *)InputUserBirthDayWindow__getPaddingBirthday(
                                            ...
                                            Day,
                                            0LL),
        IsOpen = (UnityEngine_Transform_o *)System_String__Format_61801464(v21, v22, PaddingBirthday, 0LL),
        !birthDayLb)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B0 & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_endOpenChangeDlg__, res);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v7);
    sub_1B90010(&StringLiteral_3535/*"CLICK_CANCLE"*/, v8);
    byte_4A6B4B0 = 1;
  }
  v9 = Method_MstProfileComponent_endOpenChangeDlg__;
  if ( (*((_BYTE *)Method_MstProfileComponent_endOpenChangeDlg__ + 83) & 2) != 0 )
    v9 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_endOpenChangeDlg__);
  ...
  if ( UnityEngine_Object__op_Inequality(myRoomFsm, 0LL, 0LL) )
  {
    ...
    if ( changeNameWindow )
    {
      PlayMakerFSM__SendEvent(changeNameWindow, (System_String_o *)StringLiteral_3535/*"CLICK_CANCLE"*/, 0LL);
      return;
    }
LABEL_14:
    sub_1B9026C(changeNameWindow, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B6 & 1) == 0 )
  {
    sub_1B90010(&CondType_TypeInfo, res);
    sub_1B90010(&Method_DataManager_GetMaster_BeforeBirthDayMaster___, v7);
    sub_1B90010(&DataManager_TypeInfo, v8);
    sub_1B90010(&Method_DataMasterBase_BeforeBirthDayMaster__BeforeBirthDayEntity__long__GetSingleEntity__, v9);
    sub_1B90010(&Method_MstProfileComponent_endOpenSetBirthDay__, v10);
    byte_4A6B4B6 = 1;
  }
  if ( !res )
  {
    ...
    if ( (*((_BYTE *)Method_MstProfileComponent_endOpenSetBirthDay__ + 83) & 2) != 0 )
      v17 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_endOpenSetBirthDay__);
  ...
  if ( CondType__IsOpen(144, 0, 0LL, 0, 0LL, 0LL) )
  {
    ...
    inputBirthDayWindow = (InputUserBirthDayWindow_o *)DataManager__GetMaster_object_((const MethodInfo_2E8E1C8 *)Method_DataManager_GetMaster_BeforeBirthDayMaster___);
    if ( inputBirthDayWindow )
    {
...
LABEL_22:
    sub_1B9026C(inputBirthDayWindow, v12);
  }
LABEL_13:
  v14 = Method_MstProfileComponent_endOpenSetBirthDay__;
  if ( (*((_BYTE *)Method_MstProfileComponent_endOpenSetBirthDay__ + 83) & 2) != 0 )
    v14 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_endOpenSetBirthDay__);
  ...
  if ( paramList->max_length < 2 )
    sub_1B90274(inputBirthDayWindow, v12);
...
void __fastcall MstProfileComponent__genderChange(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4BA & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_genderChange__, method);
    byte_4A6B4BA = 1;
  }
  v3 = Method_MstProfileComponent_genderChange__;
  if ( (*((_BYTE *)Method_MstProfileComponent_genderChange__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_genderChange__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  usrGameEnt = this->fields.usrGameEnt;
  if ( !usrGameEnt )
...
void __fastcall MstProfileComponent__gradeSetup(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( Kind )
  {
    ...
    if ( !v11 )
LABEL_14:
      sub_1B9026C(MasterProfileBgImage, v7);
...
void __fastcall MstProfileComponent__hideMstProfile(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(masterFigure, 0LL, 0LL) )
  {
    ...
    sub_1B8FFB4(&this->fields.masterFigure);
  }
  ...
  {
LABEL_24:
    sub_1B9026C(userMessageInputDlg, v4);
  }
...
void __fastcall MstProfileComponent__messageSetup(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B49F & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_8641/*"MESSAGE_CHANGE_NO_INPUT"*/, v3);
    byte_4A6B49F = 1;
  }
...
void __fastcall MstProfileComponent__onClickCmdSpell(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B8 & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_onClickCmdSpell__, method);
    byte_4A6B4B8 = 1;
  }
  v3 = Method_MstProfileComponent_onClickCmdSpell__;
  if ( (*((_BYTE *)Method_MstProfileComponent_onClickCmdSpell__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_onClickCmdSpell__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
...
void __fastcall MstProfileComponent__onClickMessageChange(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4BD & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MstProfileComponent__onClickMessageChange_b__104_0__, v3);
    sub_1B90010(&Method_MstProfileComponent_onClickMessageChange__, v4);
    byte_4A6B4BD = 1;
  }
  v5 = Method_MstProfileComponent_onClickMessageChange__;
  if ( (*((_BYTE *)Method_MstProfileComponent_onClickMessageChange__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_onClickMessageChange__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
  SelfUserGame = UserGameMaster__getSelfUserGame(0LL);
  if ( !SelfUserGame
    || (message = SelfUserGame->fields.message,
        ...
        v11 = (SupportDeckNameInputMenu_CallbackFunc_o *)sub_1B9025C(SupportDeckNameInputMenu_CallbackFunc_TypeInfo),
...
void __fastcall MstProfileComponent__onSpellWindowClose(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B9 & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_onSpellWindowClose__, method);
    byte_4A6B4B9 = 1;
  }
  ...
  if ( BattleWindowComponent__isOpen(cmdSpellWinComp, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_MstProfileComponent_onSpellWindowClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_onSpellWindowClose__);
    v5 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v4, v4[4]);
    OverwriteAssetSoundName__PlaySystemSe(v5, 1, 0LL);
    cmdSpellWinComp = (BattleWindowComponent_o *)this->fields.cmdSpellWinComp;
    if ( cmdSpellWinComp )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4C0 & 1) == 0 )
  {
    sub_1B90010(&Method_NetworkManager_getRequest_UserNameChangeRequest___, changedName);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4BB & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_callbackGenderChange__, *(_QWORD *)&genderType);
    sub_1B90010(&Method_NetworkManager_getRequest_UserNameChangeRequest___, v5);
...
LABEL_9:
    sub_1B9026C(this, *(_QWORD *)&genderType);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B7 & 1) == 0 )
  {
    sub_1B90010(&Method_MstProfileComponent_callbackSetBirthDay__, *(_QWORD *)&month);
    sub_1B90010(&Method_NetworkManager_getRequest_SetUserBirthDayRequest___, v7);
    sub_1B90010(&NetworkManager_TypeInfo, v8);
    this = (MstProfileComponent_o *)sub_1B90010(&NetworkManager_ResultCallbackFunc_TypeInfo, v9);
    byte_4A6B4B7 = 1;
  }
  ...
  this = (MstProfileComponent_o *)NetworkManager__getRequest_object_(
                                    v13,
                                    (const MethodInfo_2F10358 *)Method_NetworkManager_getRequest_SetUserBirthDayRequest___);
  if ( !this )
LABEL_8:
    sub_1B9026C(this, *(_QWORD *)&month);
...
void __fastcall MstProfileComponent__setCmdSpellImg(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4A6 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MstProfileComponent_onSpellWindowClose__, v4);
    sub_1B90010(&MstProfileComponent_TypeInfo, v5);
    this = (MstProfileComponent_o *)sub_1B90010(&UnityEngine_Object_TypeInfo, v6);
    byte_4A6B4A6 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(cmdSpellWinComp, 0LL, 0LL) )
  {
    ...
    if ( v9 )
    {
      ...
      if ( this )
      {
        ...
        {
          v10->fields.mode = 0;
          v11 = (CommandSpellWindowComponent_CloseButtonCallBack_o *)sub_1B9025C(CommandSpellWindowComponent_CloseButtonCallBack_TypeInfo);
          ...
          sub_1B8FFB4(&v10->fields.callback_close);
          return;
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( genderType == 2 )
  {
    ...
    {
LABEL_17:
      sub_1B9026C(cmdSpellIconMale, *(_QWORD *)&genderType);
    }
  }
  else
  {
...
void __fastcall MstProfileComponent__setGenderInfo(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.usrGameEnt = UserGameMaster__getSelfUserGame(0LL);
  v3 = sub_1B8FFB4(&this->fields.usrGameEnt);
  usrGameEnt = this->fields.usrGameEnt;
  if ( !usrGameEnt )
    sub_1B9026C(v3, v4);
...
void __fastcall MstProfileComponent__setHaveItemInfo(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4AD & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_MstHaveItemInfoComponent___, method);
    byte_4A6B4AD = 1;
  }
  ...
  while ( 1 )
  {
    ...
    if ( (__int64)v5 >= (int)max_length )
      break;
    if ( v5 >= max_length )
      sub_1B90274(itemListGrid, method);
    itemListGrid = (__int64)this->fields.itemListGrid;
    if ( itemListGrid )
    {
      ...
      if ( itemListGrid )
      {
        ...
        if ( !byte_4A6A9C6 )
        {
          itemListGrid = sub_1B90010(&UnityEngine_Vector3_TypeInfo, method);
          byte_4A6A9C6 = 1;
        }
        if ( v11 )
        {
          ...
          itemListGrid = (__int64)UnityEngine_GameObject__GetComponent_object_(
                                    v10,
                                    (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_MstHaveItemInfoComponent___);
          if ( itemListGrid )
          {
  ...
  {
LABEL_17:
    sub_1B9026C(itemListGrid, method);
  }
...
void __fastcall MstProfileComponent__setMstImg(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4A7 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataManager_GetMasterData_UserEquipMaster___, v4);
    sub_1B90010(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__GetEntity__, v5);
    sub_1B90010(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__, v6);
    sub_1B90010(&UnityEngine_Object_TypeInfo, v7);
    ...
    sub_1B90010(&Method_MstProfileComponent___c__DisplayClass75_0__setMstImg_b__0__, v11);
    sub_1B90010(&MstProfileComponent___c__DisplayClass75_0_TypeInfo, v12);
    byte_4A6B4A7 = 1;
  }
  v13 = sub_1B9025C(MstProfileComponent___c__DisplayClass75_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v13, 0LL);
  if ( !v13 )
    goto LABEL_29;
  *(_QWORD *)(v13 + 16) = this;
  Instance = (Il2CppObject *)sub_1B8FFB4(v13 + 16);
  usrGameEnt = this->fields.usrGameEnt;
  if ( !usrGameEnt )
    goto LABEL_29;
...
LABEL_22:
  ...
  {
    this->fields.masterFigure = MasterFigureManagerOld__CreatePrefab_37970952(
...
void __fastcall MstProfileComponent__setUserBirthDay(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&Method_MstProfileComponent_closeSetBirthDayDlg__, v3);
    this = (MstProfileComponent_o *)sub_1B90010(&NetworkManager_TypeInfo, v4);
    byte_4A6B4A9 = 1;
  }
...
LABEL_11:
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  v2->fields.dtBirthDay = NetworkManager__getDateTime_38530964(birthDay, 0LL);
...
void __fastcall MstProfileComponent__setUserExp(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4AC & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_429/*"#,0"*/, method);
    byte_4A6B4AC = 1;
  }
  exp = 0LL;
  lateExp = 0LL;
  ...
  usrGameEnt = (UserGameEntity_o *)System_Int64__ToString_62597548(
                                     (int64_t)&lateExp,
...
void __fastcall MstProfileComponent__setUserGender(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4A8 & 1) == 0 )
  {
    this = (MstProfileComponent_o *)sub_1B90010(&Gender_TypeInfo, method);
    byte_4A6B4A8 = 1;
  }
  usrGameEnt = v2->fields.usrGameEnt;
  if ( !usrGameEnt )
...
void __fastcall MstProfileComponent__setUserLv(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4AB & 1) == 0 )
  {
    ...
    this = (MstProfileComponent_o *)sub_1B90010(&StringLiteral_1/*""*/, v3);
    byte_4A6B4AB = 1;
  }
  usrGameEnt = v2->fields.usrGameEnt;
  if ( !usrGameEnt )
...
void __fastcall MstProfileComponent__showChangeDlg(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4AF & 1) == 0 )
  {
    sub_1B90010(&ChangeUserNameWindow_CallbackFunc_TypeInfo, method);
    this = (MstProfileComponent_o *)sub_1B90010(&Method_MstProfileComponent_endOpenChangeDlg__, v3);
    byte_4A6B4AF = 1;
  }
  ...
  if ( !monitor
    || (v5 = (ChangeUserNameWindow_o *)v2[2].monitor,
        ...
        v7 = (ChangeUserNameWindow_CallbackFunc_o *)sub_1B9025C(ChangeUserNameWindow_CallbackFunc_TypeInfo),
...
void __fastcall MstProfileComponent__showLoginCountInfo(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B4 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_TotalLoginMaster___, method);
    sub_1B90010(&Method_DataManager_GetMasterData_UserLoginMaster___, v3);
    sub_1B90010(&Method_DataMasterBase_UserLoginMaster__UserLoginEntity__long__GetEntity__, v4);
    ...
    sub_1B90010(&StringLiteral_25011/*"{0:N0}"*/, v9);
    sub_1B90010(&StringLiteral_1/*""*/, v10);
    sub_1B90010(&StringLiteral_9245/*"NEXT_TOTAL_LOGIN_BONUS_DAYS"*/, v11);
    byte_4A6B4B4 = 1;
  }
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        UserId,
                        (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_UserLoginMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  Entity = DataMasterBase_object__object__long___GetEntity(
             ...
             (int64_t)UserId,
             (const MethodInfo_312C754 *)Method_DataMasterBase_UserLoginMaster__UserLoginEntity__long__GetEntity__);
  if ( Entity )
  {
    ...
    UserId = (DataManager_o *)DataManager__GetMasterData_object_(
                                UserId,
                                (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_TotalLoginMaster___);
    if ( !UserId )
      goto LABEL_28;
  ...
  UserId = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25011/*"{0:N0}"*/, v26, 0LL);
  if ( !seqLoginLb )
    goto LABEL_28;
  ...
  UserId = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25011/*"{0:N0}"*/, v31, 0LL);
  if ( !totalLoginLb )
    goto LABEL_28;
  ...
  if ( NextLoginBonusDay < 1 )
  {
    ...
    if ( nextLoginBonusLb )
      goto LABEL_26;
LABEL_28:
    sub_1B9026C(UserId, method);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v33 = LocalizationManager__Get((System_String_o *)StringLiteral_9245/*"NEXT_TOTAL_LOGIN_BONUS_DAYS"*/, 0LL);
...
void __fastcall MstProfileComponent__showSetBirthDayDlg(MstProfileComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4B5 & 1) == 0 )
  {
    sub_1B90010(&InputUserBirthDayWindow_CallbackFunc_TypeInfo, method);
    sub_1B90010(&Method_MstProfileComponent_endOpenSetBirthDay__, v3);
    sub_1B90010(&Method_MstProfileComponent_showSetBirthDayDlg__, v4);
    byte_4A6B4B5 = 1;
  }
  v5 = Method_MstProfileComponent_showSetBirthDayDlg__;
  if ( (*((_BYTE *)Method_MstProfileComponent_showSetBirthDayDlg__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_MstProfileComponent_showSetBirthDayDlg__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
  inputBirthDayWindow = this->fields.inputBirthDayWindow;
  v8 = (InputUserBirthDayWindow_CallbackFunc_o *)sub_1B9025C(InputUserBirthDayWindow_CallbackFunc_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CEEA0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CEE60;
}
...
void __fastcall MstProfileComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4C5 & 1) == 0 )
  {
    sub_1B90010(&MstProfileComponent___c_TypeInfo, v1);
    byte_4A6B4C5 = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(MstProfileComponent___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  MstProfileComponent___c_TypeInfo->static_fields->__9 = (struct MstProfileComponent___c_o *)v2;
  sub_1B8FFB4(MstProfileComponent___c_TypeInfo->static_fields);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B4C7 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MstProfileComponent___c__ShowMstProfile_b__62_1__, v5);
    sub_1B90010(&MstProfileComponent___c_TypeInfo, v6);
    byte_4A6B4C7 = 1;
  }
  ...
  else
  {
    ...
    if ( !_9__62_1 )
    {
      ...
      _9__62_1 = (System_Action_o *)sub_1B9025C(System_Action_TypeInfo);
      ...
      v11 = (MstProfileComponent___c_c *)sub_1B8FFB4(&static_fields->__9__62_1);
    }
    if ( !Instance )
      sub_1B9026C(v11, v8);
