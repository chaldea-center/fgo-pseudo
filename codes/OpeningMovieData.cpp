void __fastcall OpeningMovieData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B43F40 & 1) == 0 )
  {
    sub_1BDB878(&OpeningMovieData_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_3381/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/, v4);
    byte_4B43F40 = 1;
  }
  OpeningMovieData_TypeInfo->static_fields->ChapterPrologueWarKey = (struct System_String_o *)StringLiteral_3381/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)OpeningMovieData_TypeInfo->static_fields, StringLiteral_3381/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/, v2, v3);
...
void __fastcall OpeningMovieData___ctor_39995796(
        OpeningMovieData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C(v5, (int32_t)movieFileName, v7, v8);
...
System_String_o *__fastcall OpeningMovieData__GetMaterialString(OpeningMovieData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43F3D & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_8593/*"MATERIAL_TOP_OPENING_{0:00000}"*/, v7);
    byte_4B43F3D = 1;
  }
  warId = this->fields.warId;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &warId, v2, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_8593/*"MATERIAL_TOP_OPENING_{0:00000}"*/, v8, 0LL);
...
int32_t __fastcall OpeningMovieData__GetPrologueWarId(int32_t idx, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&int_TypeInfo, method);
    sub_1BDB878(&OpeningMovieData_TypeInfo, v6);
    byte_4B43F3E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43F3A & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_OpeningMovieData_OnEndDownload__, v8);
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v9);
    sub_1BDB878(&StringLiteral_9176/*"Movie/ops{0:00000}.usm"*/, v10);
    byte_4B43F3A = 1;
  }
  this->fields.action = action;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.action, (int32_t)action, (int32_t)method, v3);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    sub_1BDBAD4(0LL, v12);
  ...
  v17 = System_String__Format((System_String_o *)StringLiteral_9176/*"Movie/ops{0:00000}.usm"*/, v16, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43F3B & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_OpeningMovieData_OnEndDownload__, v7);
    sub_1BDB878(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v8);
    sub_1BDB878(&StringLiteral_9178/*"Movie/{0}.usm"*/, v9);
    byte_4B43F3B = 1;
  }
  this->fields.action = action;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.action, (int32_t)action, (int32_t)method, v3);
  ...
  if ( !Instance )
    sub_1BDBAD4(0LL, v11);
  CommonUI__SetLoadMode((CommonUI_o *)Instance, 1, 0LL);
  v12 = System_String__Format((System_String_o *)StringLiteral_9178/*"Movie/{0}.usm"*/, (Il2CppObject *)this->fields.movieFileName, 0LL);
