void __fastcall OpeningMovieData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BA364 & 1) == 0 )
  {
    sub_1B4CF90(&OpeningMovieData_TypeInfo, v1);
    sub_1B4CF90(&StringLiteral_3343/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/, v4);
    byte_49BA364 = 1;
  }
  OpeningMovieData_TypeInfo->static_fields->ChapterPrologueWarKey = (struct System_String_o *)StringLiteral_3343/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)OpeningMovieData_TypeInfo->static_fields, StringLiteral_3343/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/, v2, v3);
...
void __fastcall OpeningMovieData___ctor_38742964(
        OpeningMovieData_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34(v5, (int32_t)movieFileName, v7, v8);
...
System_String_o *__fastcall OpeningMovieData__GetMaterialString(OpeningMovieData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BA361 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_8405/*"MATERIAL_TOP_OPENING_{0:00000}"*/, v7);
    byte_49BA361 = 1;
  }
  warId = this->fields.warId;
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &warId, v2, v3, v4);
  v9 = System_String__Format((System_String_o *)StringLiteral_8405/*"MATERIAL_TOP_OPENING_{0:00000}"*/, v8, 0LL);
...
int32_t __fastcall OpeningMovieData__GetPrologueWarId(int32_t idx, const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&int_TypeInfo, method);
    sub_1B4CF90(&OpeningMovieData_TypeInfo, v6);
    byte_49BA362 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA35E & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_OpeningMovieData_OnEndDownload__, v8);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v9);
    sub_1B4CF90(&StringLiteral_8981/*"Movie/ops{0:00000}.usm"*/, v10);
    byte_49BA35E = 1;
  }
  this->fields.action = action;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.action, (int32_t)action, (int32_t)method, v3);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
    sub_1B4D1EC(0LL, v12);
  ...
  v17 = System_String__Format((System_String_o *)StringLiteral_8981/*"Movie/ops{0:00000}.usm"*/, v16, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA35F & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_OpeningMovieData_OnEndDownload__, v7);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v8);
    sub_1B4CF90(&StringLiteral_8983/*"Movie/{0}.usm"*/, v9);
    byte_49BA35F = 1;
  }
  this->fields.action = action;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.action, (int32_t)action, (int32_t)method, v3);
  ...
  if ( !Instance )
    sub_1B4D1EC(0LL, v11);
  CommonUI__SetLoadMode((CommonUI_o *)Instance, 1, 0LL);
  v12 = System_String__Format((System_String_o *)StringLiteral_8983/*"Movie/{0}.usm"*/, (Il2CppObject *)this->fields.movieFileName, 0LL);
