void OpeningMovieData___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_5937B61 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_3474/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/);
    byte_5937B61 = 1;
  }
  v7 = StringLiteral_3474/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/;
  OpeningMovieData_TypeInfo->static_fields->ChapterPrologueWarKey = (struct System_String_o *)StringLiteral_3474/*"CHAPTER{0}_PROLOGUE_WAR_ID"*/;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)OpeningMovieData_TypeInfo->static_fields, v7, v1, v2, v3, v4, v5, v6);
...
void OpeningMovieData___ctor_47995596(
        ...
        const MethodInfo *method)
{
  ...
  sub_21FFBF4(v6, (int32_t)movieFileName, v7, v8, v9, v10, v11, v12);
...
System_String_o *OpeningMovieData__GetMaterialString(OpeningMovieData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5937B5E & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_8951/*"MATERIAL_TOP_OPENING_{0:00000}"*/);
    byte_5937B5E = 1;
  }
  warId = this->fields.warId;
  v3 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &warId);
  v5 = System_String__Format((System_String_o *)StringLiteral_8951/*"MATERIAL_TOP_OPENING_{0:00000}"*/, v3, 0);
...
void OpeningMovieData__OnEndDownload(OpeningMovieData_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  {
    p_action->klass = 0;
    sub_21FFBF4(p_action, 0, v7, v8, v9, v10, v11, v12);
    if ( data )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5937B5B & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_OpeningMovieData_OnEndDownload__);
    sub_21FFC50(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_21FFC50(&StringLiteral_9547/*"Movie/ops{0:00000}.usm"*/);
    byte_5937B5B = 1;
  }
  ...
  warId = this->fields.warId;
  v12 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &warId);
  v13 = System_String__Format((System_String_o *)StringLiteral_9547/*"Movie/ops{0:00000}.usm"*/, v12, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_21FFECC(0, v11);
  CommonUI__SetLoadMode((CommonUI_o *)Instance, 1, 0);
  v12 = System_String__Format((System_String_o *)StringLiteral_9549/*"Movie/{0}.usm"*/, (Il2CppObject *)this->fields.movieFileName, 0);
