        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC(&this->fields, eventSetupInfo);
  this->fields._QuestRestriction_k__BackingField = questRestriction;
  sub_1C6B9AC(&this->fields._QuestRestriction_k__BackingField, questRestriction);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC(&this->fields._QuestRestriction_k__BackingField, value);
}