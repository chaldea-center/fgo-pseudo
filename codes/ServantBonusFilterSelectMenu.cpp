void __fastcall ServantBonusFilterSelectMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B1057 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_12798/*"ServantBonusFilterSelect1"*/);
    byte_42B1057 = 1;
  }
  v1 = (ListViewSort_o *)sub_B52A54(ListViewSort_TypeInfo);
  ListViewSort___ctor_33999208(v1, (System_String_o *)StringLiteral_12798/*"ServantBonusFilterSelect1"*/, 3, 0, 0LL);
...
void __fastcall ServantBonusFilterSelectMenu__Close(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  ServantBonusFilterSelectMenu__Close_26838648(this, 0LL, v2);
}


void __fastcall ServantBonusFilterSelectMenu__Close_26838648(
        ServantBonusFilterSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B104A & 1) == 0 )
  {
    ...
    sub_B52984(&Method_ServantBonusFilterSelectMenu_EndClose__);
    byte_42B104A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B104C & 1) == 0 )
  {
    ...
    this = (ServantBonusFilterSelectMenu_o *)sub_B52984(&StringLiteral_1/*""*/);
    byte_42B104C = 1;
  }
    ...
    if ( eventIdList )
    {
      ...
      if ( (int)v8 >= 1 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !v9 )
            break;
          v11 = eventIdList->m_Items[v10 + 1];
          if ( v9->fields.m_stringLength >= 1 )
            v9 = System_String__Concat_44568316(v9, (System_String_o *)StringLiteral_709/*","*/, 0LL);
          v16 = v11;
          v12 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v16);
          this = (ServantBonusFilterSelectMenu_o *)System_String__Concat((Il2CppObject *)v9, v12, 0LL);
          LODWORD(v8) = eventIdList->max_length;
          ++v10;
...
LABEL_18:
      UnityEngine_PlayerPrefs__SetString((System_String_o *)StringLiteral_2868/*"BonusFilterEventId"*/, v9, 0LL);
    }
    if ( v2->fields.isServantEquipBonusFilterEnable )
    {
      ...
      if ( !v13 )
        goto LABEL_27;
      ListViewSort__SetFilter(v13, 41, ((unsigned __int8)this & 1) == 0, 0LL);
      this = (ServantBonusFilterSelectMenu_o *)v2->fields.servantBonusFilterEquipComponent;
      if ( !this )
        goto LABEL_27;
    ...
    ServantBonusFilterSelectMenu__Callback(v2, 1, v14);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1049 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_ServantBonusFilterSelectMenu_EndOpen__);
    sub_B52984(&ServantBonusFilterSelectMenu_TypeInfo);
    sub_B52984(&StringLiteral_12032/*"SERVANT_SORT_RESET"*/);
    sub_B52984(&StringLiteral_11891/*"SERVANT_SORT_EXPLANATION4"*/);
    sub_B52984(&StringLiteral_12036/*"SERVANT_SORT_TITLE4"*/);
    sub_B52984(&StringLiteral_11892/*"SERVANT_SORT_EXPLANATION5"*/);
    sub_B52984(&StringLiteral_12035/*"SERVANT_SORT_TITLE3"*/);
    sub_B52984(&StringLiteral_11883/*"SERVANT_SORT_CANCEL"*/);
    sub_B52984(&StringLiteral_11887/*"SERVANT_SORT_DECIDE"*/);
    sub_B52984(&StringLiteral_11871/*"SERVANT_SORT_ALL_DISPLAY"*/);
    sub_B52984(&StringLiteral_12031/*"SERVANT_SORT_MAX_ONLY_DISPLAY"*/);
    sub_B52984(&StringLiteral_11890/*"SERVANT_SORT_EXPLANATION3"*/);
    sub_B52984(&StringLiteral_11928/*"SERVANT_SORT_FILTER_KIND_20"*/);
    sub_B52984(&StringLiteral_11884/*"SERVANT_SORT_CLEAR"*/);
    sub_B52984(&StringLiteral_12038/*"SERVANT_SORT_TITLE6"*/);
    sub_B52984(&StringLiteral_11926/*"SERVANT_SORT_FILTER_KIND_19"*/);
    sub_B52984(&StringLiteral_12037/*"SERVANT_SORT_TITLE5"*/);
    sub_B52984(&StringLiteral_12001/*"SERVANT_SORT_INDIVIDUAL_CLEAR"*/);
    byte_42B1049 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    ListViewSort___ctor_33999772(v28, v27, 0LL);
    ...
    if ( baseSortInfo )
    {
      ...
      if ( decideLabel )
      {
        ...
        if ( cancelLabel )
        {
          ...
          baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11926/*"SERVANT_SORT_FILTER_KIND_19"*/, 0LL);
          if ( filter1Label )
          {
            UILabel__set_text(filter1Label, (System_String_o *)baseSortInfo, 0LL);
            filter2Label = this->fields.filter2Label;
            baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11928/*"SERVANT_SORT_FILTER_KIND_20"*/, 0LL);
            if ( filter2Label )
            {
              ...
              if ( this->fields.isServantEquipBonusFilterEnable )
              {
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12036/*"SERVANT_SORT_TITLE4"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11890/*"SERVANT_SORT_EXPLANATION3"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12037/*"SERVANT_SORT_TITLE5"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11891/*"SERVANT_SORT_EXPLANATION4"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11871/*"SERVANT_SORT_ALL_DISPLAY"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12031/*"SERVANT_SORT_MAX_ONLY_DISPLAY"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12038/*"SERVANT_SORT_TITLE6"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11892/*"SERVANT_SORT_EXPLANATION5"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12001/*"SERVANT_SORT_INDIVIDUAL_CLEAR"*/, 0LL);
              ...
              else
              {
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12035/*"SERVANT_SORT_TITLE3"*/, 0LL);
                if ( !titleLabel )
                  goto LABEL_59;
        ...
        const MethodInfo *method)
{
  ...
  if ( !v4 )
    goto LABEL_30;
  v5 = (System_String_o **)(((unsigned __int8)filter1Button & 1) != 0 ? &StringLiteral_17074/*"btn_bg_03"*/ : &StringLiteral_17075/*"btn_bg_04"*/);
  ...
  if ( ((unsigned __int8)filter1Button & 1) != 0 )
    v7 = &StringLiteral_17074/*"btn_bg_03"*/;
  else
    v7 = &StringLiteral_17075/*"btn_bg_04"*/;
...
LABEL_30:
    sub_B52A5C(filter1Button, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v10 = (ServantBonusFilterSelectMenu_o *)sub_B52D50(v7);
