void ServantBonusFilterSelectMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B85 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_12726/*"ServantBonusFilterSelect1"*/);
    byte_4CB0B85 = 1;
  }
  v1 = (ListViewSort_o *)sub_1C6BC54(ListViewSort_TypeInfo);
  ListViewSort___ctor_44084664(v1, (System_String_o *)StringLiteral_12726/*"ServantBonusFilterSelect1"*/, 3, 0, 0);
  ServantBonusFilterSelectMenu_TypeInfo->static_fields->commonServantSortInfo = v1;
  sub_1C6B9AC(ServantBonusFilterSelectMenu_TypeInfo->static_fields, v1);
}
...
void ServantBonusFilterSelectMenu__Close(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  ServantBonusFilterSelectMenu__Close_32636696(this, 0, v2);
}


void ServantBonusFilterSelectMenu__Close_32636696(
        ServantBonusFilterSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B78 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_EndClose__);
    byte_4CB0B78 = 1;
  }
...
void ServantBonusFilterSelectMenu__OnClickAllDisplay(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B80 & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickAllDisplay__);
    byte_4CB0B80 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickAllDisplay__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickAllDisplay__);
...
void ServantBonusFilterSelectMenu__OnClickCancel(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B7B & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickCancel__);
    byte_4CB0B7B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
...
void ServantBonusFilterSelectMenu__OnClickClear(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B7C & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickClear__);
    byte_4CB0B7C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickClear__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickClear__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo
...
void ServantBonusFilterSelectMenu__OnClickDecide(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B7A & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickDecide__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickDecide__ + 83) & 2) != 0 )
      v10 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickDecide__);
      ...
      if ( (int)max_length >= 1 )
      {
        ...
        while ( 1 )
        {
          if ( v15 >= (unsigned int)max_length )
            sub_1C6BC68(verticalScrollBar);
          if ( !v14 )
            break;
          v16 = eventIdList->m_Items[v15];
          if ( v14->fields._stringLength >= 1 )
            v14 = System_String__Concat_63966792(v14, (System_String_o *)StringLiteral_808/*","*/, 0);
          v20 = v16;
...
LABEL_30:
        sub_1C6BC60(verticalScrollBar, v5);
      }
LABEL_21:
      UnityEngine_PlayerPrefs__SetString((System_String_o *)StringLiteral_3187/*"BonusFilterEventId"*/, v14, 0);
    }
...
void ServantBonusFilterSelectMenu__OnClickFilter1(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B7E & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickFilter1__);
    byte_4CB0B7E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickFilter1__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickFilter1__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
...
void ServantBonusFilterSelectMenu__OnClickFilter2(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B7F & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickFilter2__);
    byte_4CB0B7F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickFilter2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickFilter2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
...
void ServantBonusFilterSelectMenu__OnClickInitialize(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B7D & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickInitialize__);
    byte_4CB0B7D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickInitialize__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickInitialize__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B81 & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickMaxOnlyDisplay__);
    byte_4CB0B81 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickMaxOnlyDisplay__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickMaxOnlyDisplay__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B82 & 1) == 0 )
  {
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_OnClickResetIndividual__);
    byte_4CB0B82 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickResetIndividual__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_ServantBonusFilterSelectMenu_OnClickResetIndividual__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0B77 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_ServantBonusFilterSelectMenu_EndOpen__);
    sub_1C6BA08(&ServantBonusFilterSelectMenu_TypeInfo);
    sub_1C6BA08(&StringLiteral_11884/*"SERVANT_SORT_RESET"*/);
    sub_1C6BA08(&StringLiteral_11726/*"SERVANT_SORT_EXPLANATION4"*/);
    sub_1C6BA08(&StringLiteral_11888/*"SERVANT_SORT_TITLE4"*/);
    sub_1C6BA08(&StringLiteral_11727/*"SERVANT_SORT_EXPLANATION5"*/);
    sub_1C6BA08(&StringLiteral_11887/*"SERVANT_SORT_TITLE3"*/);
    sub_1C6BA08(&StringLiteral_11718/*"SERVANT_SORT_CANCEL"*/);
    sub_1C6BA08(&StringLiteral_11722/*"SERVANT_SORT_DECIDE"*/);
    sub_1C6BA08(&StringLiteral_11705/*"SERVANT_SORT_ALL_DISPLAY"*/);
    sub_1C6BA08(&StringLiteral_11883/*"SERVANT_SORT_MAX_ONLY_DISPLAY"*/);
    sub_1C6BA08(&StringLiteral_11725/*"SERVANT_SORT_EXPLANATION3"*/);
    sub_1C6BA08(&StringLiteral_11766/*"SERVANT_SORT_FILTER_KIND_20"*/);
    sub_1C6BA08(&StringLiteral_11719/*"SERVANT_SORT_CLEAR"*/);
    sub_1C6BA08(&StringLiteral_11890/*"SERVANT_SORT_TITLE6"*/);
    sub_1C6BA08(&StringLiteral_11764/*"SERVANT_SORT_FILTER_KIND_19"*/);
    sub_1C6BA08(&StringLiteral_11889/*"SERVANT_SORT_TITLE5"*/);
    sub_1C6BA08(&StringLiteral_11852/*"SERVANT_SORT_INDIVIDUAL_CLEAR"*/);
    byte_4CB0B77 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1C6B9AC(&this->fields.operationSortInfo, v21);
        ...
        if ( cancelLabel )
        {
          ...
          if ( filter1Label )
          {
            ...
            if ( filter2Label )
            {
              ...
              sub_1C6B9AC(&this->fields.eventIdList, equipBonusFilterEventIds);
              if ( this->fields.isServantEquipBonusFilterEnable )
              {
...
void ServantBonusFilterSelectMenu__SetButtonSelect(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !v4 )
    goto LABEL_30;
  v5 = (System_String_o **)(((unsigned __int8)filter1Button & 1) != 0 ? &StringLiteral_17453/*"btn_bg_03"*/ : &StringLiteral_17454/*"btn_bg_04"*/);
  ...
  if ( ((unsigned __int8)filter1Button & 1) != 0 )
    v7 = &StringLiteral_17453/*"btn_bg_03"*/;
  else
    v7 = &StringLiteral_17454/*"btn_bg_04"*/;
        ...
        if ( v8 )
        {
          ...
          if ( filter1Button )
          {
            ...
            if ( operationSortInfo )
            {
              ...
              {
                if ( ((unsigned __int8)filter1Button & 1) != 0 )
                  v12 = &StringLiteral_17454/*"btn_bg_04"*/;
                else
                  v12 = &StringLiteral_17453/*"btn_bg_03"*/;
...
LABEL_30:
    sub_1C6BC60(filter1Button, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v10 = (ServantBonusFilterSelectMenu_o *)sub_1C6BFFC(v7);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A993A8;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A99360;
}
