void __fastcall ServantBonusFilterSelectMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4352CFA & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_12878/*"ServantBonusFilterSelect1"*/);
    byte_4352CFA = 1;
  }
  v1 = (ListViewSort_o *)sub_B70764(ListViewSort_TypeInfo);
  ListViewSort___ctor_33980040(v1, (System_String_o *)StringLiteral_12878/*"ServantBonusFilterSelect1"*/, 3, 0, 0LL);
...
void __fastcall ServantBonusFilterSelectMenu__Close(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  ServantBonusFilterSelectMenu__Close_27014172(this, 0LL, v2);
}


void __fastcall ServantBonusFilterSelectMenu__Close_27014172(
        ServantBonusFilterSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352CED & 1) == 0 )
  {
    ...
    sub_B70694(&Method_ServantBonusFilterSelectMenu_EndClose__);
    byte_4352CED = 1;
  }
...
int32_t __fastcall ServantBonusFilterSelectMenu__GetMaxIndividualFilter(const MethodInfo *method)
{
  ...
  if ( v1->static_fields->maxIndividualFilter <= 0 )
  {
    ...
    v1->static_fields->maxIndividualFilter = (int32_t)v4->fields.datalist;
    v1->static_fields->maxIndividualFilter += 20;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352CEF & 1) == 0 )
  {
    ...
    this = (ServantBonusFilterSelectMenu_o *)sub_B70694(&StringLiteral_1/*""*/);
    byte_4352CEF = 1;
  }
  if ( v2->fields.state == 2 )
  {
    ...
    ServantBonusFilterSelectMenu__SetButtonEnable(v2, 0, v5);
    v2->fields.state = 3;
    if ( (BYTE3(SoundManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !SoundManager_TypeInfo->_2.cctor_finished )
    {
    ...
    if ( eventIdList )
    {
      v9 = *(_QWORD *)&eventIdList->max_length;
      ...
      if ( (int)v9 >= 1 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !v10 )
            break;
          v12 = eventIdList->m_Items[v11 + 1];
          if ( v10->fields.m_stringLength >= 1 )
            v10 = System_String__Concat_44758168(v10, (System_String_o *)StringLiteral_712/*","*/, 0LL);
          v17 = v12;
          v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v17, v7);
          this = (ServantBonusFilterSelectMenu_o *)System_String__Concat((Il2CppObject *)v10, v13, 0LL);
          LODWORD(v9) = eventIdList->max_length;
          ++v11;
...
LABEL_18:
      UnityEngine_PlayerPrefs__SetString((System_String_o *)StringLiteral_2902/*"BonusFilterEventId"*/, v10, 0LL);
    }
    if ( v2->fields.isServantEquipBonusFilterEnable )
    {
      ...
      if ( !v14 )
        goto LABEL_27;
      ListViewSort__SetFilter(v14, 41, ((unsigned __int8)this & 1) == 0, 0LL);
      this = (ServantBonusFilterSelectMenu_o *)v2->fields.servantBonusFilterEquipComponent;
      if ( !this )
        goto LABEL_27;
    ...
    ServantBonusFilterSelectMenu__Callback(v2, 1, v15);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  ServantBonusFilterEquipComponent_c *v59; // x8
  ...
  if ( (byte_4352CEC & 1) == 0 )
  {
    ...
    sub_B70694(&Method_ServantBonusFilterSelectMenu_EndOpen__);
    sub_B70694(&ServantBonusFilterSelectMenu_TypeInfo);
    sub_B70694(&StringLiteral_12110/*"SERVANT_SORT_RESET"*/);
    sub_B70694(&StringLiteral_11968/*"SERVANT_SORT_EXPLANATION4"*/);
    sub_B70694(&StringLiteral_12114/*"SERVANT_SORT_TITLE4"*/);
    sub_B70694(&StringLiteral_11969/*"SERVANT_SORT_EXPLANATION5"*/);
    sub_B70694(&StringLiteral_12113/*"SERVANT_SORT_TITLE3"*/);
    sub_B70694(&StringLiteral_11960/*"SERVANT_SORT_CANCEL"*/);
    sub_B70694(&StringLiteral_11964/*"SERVANT_SORT_DECIDE"*/);
    sub_B70694(&StringLiteral_11948/*"SERVANT_SORT_ALL_DISPLAY"*/);
    sub_B70694(&StringLiteral_12109/*"SERVANT_SORT_MAX_ONLY_DISPLAY"*/);
    sub_B70694(&StringLiteral_11967/*"SERVANT_SORT_EXPLANATION3"*/);
    sub_B70694(&StringLiteral_12005/*"SERVANT_SORT_FILTER_KIND_20"*/);
    sub_B70694(&StringLiteral_11961/*"SERVANT_SORT_CLEAR"*/);
    sub_B70694(&StringLiteral_12116/*"SERVANT_SORT_TITLE6"*/);
    sub_B70694(&StringLiteral_12003/*"SERVANT_SORT_FILTER_KIND_19"*/);
    sub_B70694(&StringLiteral_12115/*"SERVANT_SORT_TITLE5"*/);
    sub_B70694(&StringLiteral_12079/*"SERVANT_SORT_INDIVIDUAL_CLEAR"*/);
    byte_4352CEC = 1;
  }
  if ( !this->fields.state )
  {
    ...
    ListViewSort___ctor_33980604(v28, v27, 0LL);
    ...
    if ( baseSortInfo )
    {
      ...
      if ( decideLabel )
      {
        ...
        if ( cancelLabel )
        {
          ...
          baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12003/*"SERVANT_SORT_FILTER_KIND_19"*/, 0LL);
          if ( filter1Label )
          {
            UILabel__set_text(filter1Label, (System_String_o *)baseSortInfo, 0LL);
            filter2Label = this->fields.filter2Label;
            baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12005/*"SERVANT_SORT_FILTER_KIND_20"*/, 0LL);
            if ( filter2Label )
            {
              ...
              if ( this->fields.isServantEquipBonusFilterEnable )
              {
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12114/*"SERVANT_SORT_TITLE4"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11967/*"SERVANT_SORT_EXPLANATION3"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12115/*"SERVANT_SORT_TITLE5"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11968/*"SERVANT_SORT_EXPLANATION4"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11948/*"SERVANT_SORT_ALL_DISPLAY"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12109/*"SERVANT_SORT_MAX_ONLY_DISPLAY"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12116/*"SERVANT_SORT_TITLE6"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11969/*"SERVANT_SORT_EXPLANATION5"*/, 0LL);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12079/*"SERVANT_SORT_INDIVIDUAL_CLEAR"*/, 0LL);
                ...
                GameObjectExtensions__SetLocalPositionY(
                  gameObject,
                  14.0 - (float)(v59->static_fields->POS_Y_INTERVAL * (float)(v57 - 1)),
                  0LL);
                baseSortInfo = (ListViewSort_o *)this->fields.servantBonusFilterEquipComponent;
                if ( !baseSortInfo )
                  goto LABEL_59;
              ...
              else
              {
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12113/*"SERVANT_SORT_TITLE3"*/, 0LL);
                if ( !titleLabel )
                  goto LABEL_59;
              ...
              ServantBonusFilterSelectMenu__SetButtonEnable(this, 1, v65);
              v66 = this->fields.scrollView;
              if ( v66 )
              {
                if ( *p_baseSortInfo )
                {
                  baseSortInfo = *(ListViewSort_o **)&v66->fields.showScrollBars;
                  if ( baseSortInfo )
                  {
                    ...
                    System_Action___ctor(v67, (Il2CppObject *)this, Method_ServantBonusFilterSelectMenu_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !v4 )
    goto LABEL_30;
  v5 = (System_String_o **)(((unsigned __int8)filter1Button & 1) != 0 ? &StringLiteral_17212/*"btn_bg_03"*/ : &StringLiteral_17213/*"btn_bg_04"*/);
  ...
  if ( ((unsigned __int8)filter1Button & 1) != 0 )
    v7 = &StringLiteral_17212/*"btn_bg_03"*/;
  else
    v7 = &StringLiteral_17213/*"btn_bg_04"*/;
...
LABEL_30:
    sub_B7076C(filter1Button, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v10 = (ServantBonusFilterSelectMenu_o *)sub_B70A60(v7);
