void ServantBonusFilterSelectMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C89 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_12732/*"ServantBonusFilterSelect1"*/);
    byte_4CC1C89 = 1;
  }
  v1 = (ListViewSort_o *)sub_1C715FC(ListViewSort_TypeInfo);
  ListViewSort___ctor_44130992(v1, (System_String_o *)StringLiteral_12732/*"ServantBonusFilterSelect1"*/, 3, 0, 0);
  ServantBonusFilterSelectMenu_TypeInfo->static_fields->commonServantSortInfo = v1;
  sub_1C71354(ServantBonusFilterSelectMenu_TypeInfo->static_fields, v1);
}
...
void ServantBonusFilterSelectMenu__Close(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  ServantBonusFilterSelectMenu__Close_32660100(this, 0, v2);
}


void ServantBonusFilterSelectMenu__Close_32660100(
        ServantBonusFilterSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C7C & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_EndClose__);
    byte_4CC1C7C = 1;
  }
...
void ServantBonusFilterSelectMenu__OnClickAllDisplay(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C84 & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickAllDisplay__);
    byte_4CC1C84 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickAllDisplay__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickAllDisplay__);
...
void ServantBonusFilterSelectMenu__OnClickCancel(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C7F & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickCancel__);
    byte_4CC1C7F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
...
void ServantBonusFilterSelectMenu__OnClickClear(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C80 & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickClear__);
    byte_4CC1C80 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickClear__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickClear__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo
...
void ServantBonusFilterSelectMenu__OnClickDecide(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C7E & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickDecide__);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickDecide__ + 83) & 2) != 0 )
      v10 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickDecide__);
      ...
      if ( (int)max_length >= 1 )
      {
        ...
        while ( 1 )
        {
          if ( v15 >= (unsigned int)max_length )
            sub_1C71610(verticalScrollBar);
          if ( !v14 )
            break;
          v16 = eventIdList->m_Items[v15];
          if ( v14->fields._stringLength >= 1 )
            v14 = System_String__Concat_64031724(v14, (System_String_o *)StringLiteral_808/*","*/, 0);
          v20 = v16;
...
LABEL_30:
        sub_1C71608(verticalScrollBar, v5);
      }
LABEL_21:
      UnityEngine_PlayerPrefs__SetString((System_String_o *)StringLiteral_3190/*"BonusFilterEventId"*/, v14, 0);
    }
...
void ServantBonusFilterSelectMenu__OnClickFilter1(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C82 & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickFilter1__);
    byte_4CC1C82 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickFilter1__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickFilter1__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
...
void ServantBonusFilterSelectMenu__OnClickFilter2(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C83 & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickFilter2__);
    byte_4CC1C83 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickFilter2__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickFilter2__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
...
void ServantBonusFilterSelectMenu__OnClickInitialize(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C81 & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickInitialize__);
    byte_4CC1C81 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickInitialize__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickInitialize__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C85 & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickMaxOnlyDisplay__);
    byte_4CC1C85 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickMaxOnlyDisplay__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickMaxOnlyDisplay__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C86 & 1) == 0 )
  {
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_OnClickResetIndividual__);
    byte_4CC1C86 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantBonusFilterSelectMenu_OnClickResetIndividual__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ServantBonusFilterSelectMenu_OnClickResetIndividual__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1C7B & 1) == 0 )
  {
    ...
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&ServantBonusFilterEquipComponent_TypeInfo);
    sub_1C713B0(&Method_ServantBonusFilterSelectMenu_EndOpen__);
    sub_1C713B0(&ServantBonusFilterSelectMenu_TypeInfo);
    sub_1C713B0(&StringLiteral_11890/*"SERVANT_SORT_RESET"*/);
    sub_1C713B0(&StringLiteral_11732/*"SERVANT_SORT_EXPLANATION4"*/);
    sub_1C713B0(&StringLiteral_11894/*"SERVANT_SORT_TITLE4"*/);
    sub_1C713B0(&StringLiteral_11733/*"SERVANT_SORT_EXPLANATION5"*/);
    sub_1C713B0(&StringLiteral_11893/*"SERVANT_SORT_TITLE3"*/);
    sub_1C713B0(&StringLiteral_11724/*"SERVANT_SORT_CANCEL"*/);
    sub_1C713B0(&StringLiteral_11728/*"SERVANT_SORT_DECIDE"*/);
    sub_1C713B0(&StringLiteral_11711/*"SERVANT_SORT_ALL_DISPLAY"*/);
    sub_1C713B0(&StringLiteral_11889/*"SERVANT_SORT_MAX_ONLY_DISPLAY"*/);
    sub_1C713B0(&StringLiteral_11731/*"SERVANT_SORT_EXPLANATION3"*/);
    sub_1C713B0(&StringLiteral_11772/*"SERVANT_SORT_FILTER_KIND_20"*/);
    sub_1C713B0(&StringLiteral_11725/*"SERVANT_SORT_CLEAR"*/);
    sub_1C713B0(&StringLiteral_11896/*"SERVANT_SORT_TITLE6"*/);
    sub_1C713B0(&StringLiteral_11770/*"SERVANT_SORT_FILTER_KIND_19"*/);
    sub_1C713B0(&StringLiteral_11895/*"SERVANT_SORT_TITLE5"*/);
    sub_1C713B0(&StringLiteral_11858/*"SERVANT_SORT_INDIVIDUAL_CLEAR"*/);
    byte_4CC1C7B = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1C71354(&this->fields.operationSortInfo, v21);
    ...
    if ( baseSortInfo )
    {
      ...
      if ( decideLabel )
      {
        ...
        if ( cancelLabel )
        {
          ...
          baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11770/*"SERVANT_SORT_FILTER_KIND_19"*/, 0);
          if ( filter1Label )
          {
            UILabel__set_text(filter1Label, (System_String_o *)baseSortInfo, 0);
            filter2Label = this->fields.filter2Label;
            baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11772/*"SERVANT_SORT_FILTER_KIND_20"*/, 0);
            if ( filter2Label )
            {
              UILabel__set_text(filter2Label, (System_String_o *)baseSortInfo, 0);
              this->fields.eventIdList = equipBonusFilterEventIds;
              sub_1C71354(&this->fields.eventIdList, equipBonusFilterEventIds);
              if ( this->fields.isServantEquipBonusFilterEnable )
              {
                allFilterTitleLabel = this->fields.allFilterTitleLabel;
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11894/*"SERVANT_SORT_TITLE4"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11731/*"SERVANT_SORT_EXPLANATION3"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11895/*"SERVANT_SORT_TITLE5"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11732/*"SERVANT_SORT_EXPLANATION4"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11711/*"SERVANT_SORT_ALL_DISPLAY"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11889/*"SERVANT_SORT_MAX_ONLY_DISPLAY"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11896/*"SERVANT_SORT_TITLE6"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11733/*"SERVANT_SORT_EXPLANATION5"*/, 0);
                ...
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11858/*"SERVANT_SORT_INDIVIDUAL_CLEAR"*/, 0);
              ...
              else
              {
                ...
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                baseSortInfo = (ListViewSort_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11893/*"SERVANT_SORT_TITLE3"*/, 0);
                if ( !titleLabel )
                  goto LABEL_57;
...
void ServantBonusFilterSelectMenu__SetButtonSelect(ServantBonusFilterSelectMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !v4 )
    goto LABEL_30;
  v5 = (System_String_o **)(((unsigned __int8)filter1Button & 1) != 0 ? &StringLiteral_17460/*"btn_bg_03"*/ : &StringLiteral_17461/*"btn_bg_04"*/);
        ...
        if ( v8 )
        {
          ...
          if ( filter1Button )
          {
            ...
            if ( operationSortInfo )
            {
              ...
              {
                if ( ((unsigned __int8)filter1Button & 1) != 0 )
                  v12 = &StringLiteral_17461/*"btn_bg_04"*/;
                else
                  v12 = &StringLiteral_17460/*"btn_bg_03"*/;
...
LABEL_30:
    sub_1C71608(filter1Button, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v10 = (ServantBonusFilterSelectMenu_o *)sub_1C719A4(v7);
