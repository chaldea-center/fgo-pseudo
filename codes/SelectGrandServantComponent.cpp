        ...
        const MethodInfo *method)
{
  ...
  int32_t size; // w20
  SelectGrandServantComponent_o *v38; // x0
  const MethodInfo *v39; // x2
  char v40; // w22
  System_Collections_Generic_List_object__o *v41; // x23
  int32_t v42; // w23
  SvtMultiPortraitEntity_o *v43; // x24
  int32_t v44; // w25
  UnityEngine_Component_o *v45; // x26
  ...
  UnityEngine_Component_o *v53; // x25
  struct System_Int32_array *v54; // x8
  struct System_Int32_array *v55; // x8
  System_Collections_Generic_List_object__o *v56; // x26
  StandFigureCollect_o *v57; // x27
  ...
  __int64 v74; // x10
  Il2CppClass **v75; // x0
  struct CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o v76; // [xsp+30h] [xbp-90h] BYREF
  Il2CppObject *v77; // [xsp+40h] [xbp-80h] BYREF
  Il2CppObject *v78; // [xsp+48h] [xbp-78h] BYREF
    ...
    if ( EntityListOrderBy )
    {
      ...
      if ( FigureImageLimitCount )
      {
        *((_DWORD *)FigureImageLimitCount + 18) = size;
        ...
        if ( FigureImageLimitCount )
        {
          v38 = (SelectGrandServantComponent_o *)System_Collections_Generic_Dictionary_int__object___TryGetValue(
...
LABEL_72:
          ...
          while ( 1 )
          {
            ...
            v44 = *((_DWORD *)FigureImageLimitCount + 9) + 1;
            if ( (v40 & 1) != 0 )
            {
              FigureImageLimitCount = v78;
              if ( !v78 )
                break;
              FigureImageLimitCount = System_Collections_Generic_List_object___get_Item(
              ...
              BasicHelper__SetActiveSafely(v45, 1, 0);
              if ( !v45 )
                break;
              UIStandFigureR__SetCharacterForImageIdWithEffect(
                (UIStandFigureR_o *)v45,
                v43->fields.portraitImageId,
                8,
                0,
                0,
                v42,
              ...
              commonPosition = v43->fields.commonPosition;
              if ( commonPosition && SLODWORD(commonPosition->max_length) >= 2 )
              {
                FigureImageLimitCount = UnityEngine_Component__get_gameObject(v45, 0);
                v49 = v43->fields.commonPosition;
                if ( !v49 )
                  break;
            ...
            else
            {
              ...
              *((_QWORD *)FigureImageLimitCount + 17) = v43;
              ...
              {
                FigureImageLimitCount = UnityEngine_Component__get_gameObject(v53, 0);
                v55 = v43->fields.commonPosition;
                if ( !v55 )
                  break;
...
LABEL_83:
          ...
          (const MethodInfo_3463A20 *)Method_System_Collections_Generic_Dictionary_int__List_StandFigureCollect___TryGetValue__) )
  {
    ...
    v65 = *(_QWORD *)&userServantEntity->fields.svtId.fields.fakeValue;
    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
  ...
  *(_QWORD *)&v85.fields.fakeValue = v32;
  ...
  size = 1;
LABEL_82:
  SelectGrandServantComponent__DisplayFigureWithEffect(this, size, v36);
}
