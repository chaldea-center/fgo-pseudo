        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCA0F & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, onTapEvent);
    byte_49FCA0F = 1;
  }
  this->fields.onTapEvent = onTapEvent;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.onTapEvent, (int32_t)onTapEvent, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.listViewItem, (int32_t)item, (int32_t)method, v3);
}