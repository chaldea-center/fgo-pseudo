        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BE04 & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, onTapEvent);
    byte_4A2BE04 = 1;
  }
  this->fields.onTapEvent = onTapEvent;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.onTapEvent, (int32_t)onTapEvent, (int32_t)method, v3);
