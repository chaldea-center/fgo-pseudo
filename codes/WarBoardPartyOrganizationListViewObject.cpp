        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D99B & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, onTapEvent);
    byte_4A1D99B = 1;
  }
  this->fields.onTapEvent = onTapEvent;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.onTapEvent, (int32_t)onTapEvent, (int32_t)method, v3);
