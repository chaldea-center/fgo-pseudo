        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v28.fields.fakeValue = v18;
  this->fields._SvtId_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v28, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7698A & 1) == 0 )
  {
    this = (CharaGraphServantCollectionListViewItem_o *)sub_1D0F0B4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4E7698A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantLimitEntity )
  {
    ...
    sub_1D0F058(p_servantLimitEntity, (int32_t)servantLimitEntity, v9, v10, v11, v12, v13, v14);
  }
