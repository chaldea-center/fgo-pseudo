        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v28.fields.fakeValue = v18;
  this->fields._SvtId_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49654028(v28, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2FCD7 & 1) == 0 )
  {
    this = (CharaGraphServantCollectionListViewItem_o *)sub_1C93AD4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4D2FCD7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantLimitEntity )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_ServantLimitMaster___);
    UserServantCollectionEntity_k__BackingField = this->fields._UserServantCollectionEntity_k__BackingField;
    ...
    sub_1C93A78(p_servantLimitEntity, (int32_t)servantLimitEntity, v9, v10, v11, v12, v13, v14);
  }
