        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v28.fields.fakeValue = v18;
  this->fields._SvtId_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v28, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC66C4 & 1) == 0 )
  {
    this = (CharaGraphServantCollectionListViewItem_o *)sub_1C713B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4CC66C4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  GrandQuestFolderBoardItem_o *p_servantLimitEntity; // x19
  int32_t v9; // w2
  int32_t v10; // w3
  System_String_o *v11; // x4
  int32_t v12; // w5
  ...
  if ( !servantLimitEntity )
  {
    ...
    sub_1C71354(p_servantLimitEntity, (int32_t)servantLimitEntity, v9, v10, v11, v12, v13, v14);
  }
