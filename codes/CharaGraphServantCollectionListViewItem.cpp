        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B834 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_ServantMaster___, *(_QWORD *)&index);
  ...
  *(_QWORD *)&v23.fields.fakeValue = v17;
  this->fields._SvtId_k__BackingField = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v23, 0LL);
...
LABEL_10:
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)p_ServantEntity_k__BackingField, (int32_t)Entity, v21, v22);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B831 & 1) == 0 )
  {
    this = (CharaGraphServantCollectionListViewItem_o *)sub_1BCAFF8(
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantClassEntity )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.servantClassEntity, (int32_t)servantClassEntity, v9, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B833 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_ServantLimitMaster___, method);
    sub_1BCAFF8(&DataManager_TypeInfo, v3);
    byte_4B1B833 = 1;
  }
  ...
  if ( !servantLimitEntity )
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    Master_object = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_ServantLimitMaster___);
    UserServantCollectionEntity_k__BackingField = this->fields._UserServantCollectionEntity_k__BackingField;
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.servantLimitEntity, (int32_t)servantLimitEntity, v8, v9);
  }
