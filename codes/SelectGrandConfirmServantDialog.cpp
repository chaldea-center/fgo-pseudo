...
void SelectGrandConfirmServantDialog__OnClickCancel(SelectGrandConfirmServantDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B67D & 1) == 0 )
  {
    sub_1C93AD4(&Method_SelectGrandConfirmServantDialog_OnClickCancel__);
    byte_4D2B67D = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectGrandConfirmServantDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_SelectGrandConfirmServantDialog_OnClickCancel__);
...
void SelectGrandConfirmServantDialog__OnClickDecide(SelectGrandConfirmServantDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B67C & 1) == 0 )
  {
    sub_1C93AD4(&Method_SelectGrandConfirmServantDialog_OnClickDecide__);
    byte_4D2B67C = 1;
  }
  if ( this->fields.baseState == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectGrandConfirmServantDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_SelectGrandConfirmServantDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B67B & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_11618/*"SELECT_GRAND_CONFIRM_DIALOG_CANCEL_BUTTON_TEXT"*/);
    sub_1C93AD4(&StringLiteral_11619/*"SELECT_GRAND_CONFIRM_DIALOG_DECIDE_BUTTON_TEXT"*/);
    sub_1C93AD4(&StringLiteral_11620/*"SELECT_GRAND_CONFIRM_DIALOG_MESSAGE"*/);
    sub_1C93AD4(&StringLiteral_11621/*"SELECT_GRAND_CONFIRM_DIALOG_TITLE"*/);
    byte_4D2B67B = 1;
  }
  ...
  v19 = DataManager__GetMaster_object_((const MethodInfo_31A49E8 *)Method_DataManager_GetMaster_UserItemMaster___);
  ...
  Master_object = (GrandGraphDetailMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11621/*"SELECT_GRAND_CONFIRM_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_29;
  UILabel__set_text(titleLabel, (System_String_o *)Master_object, 0);
  messageLabel = this->fields.messageLabel;
  v24 = LocalizationManager__Get((System_String_o *)StringLiteral_11620/*"SELECT_GRAND_CONFIRM_DIALOG_MESSAGE"*/, 0);
  Master_object = (GrandGraphDetailMaster_o *)UserServantEntity__GetSvtName(userServantEntity, 0);
  if ( !v17 )
    goto LABEL_29;
  if ( !Entity )
    goto LABEL_29;
  Master_object = (GrandGraphDetailMaster_o *)System_String__Format_64467100(
                                                v24,
  ...
  Master_object = (GrandGraphDetailMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11618/*"SELECT_GRAND_CONFIRM_DIALOG_CANCEL_BUTTON_TEXT"*/, 0);
  if ( !cancelButtonLabel
    || (UILabel__set_text(cancelButtonLabel, (System_String_o *)Master_object, 0),
        decideButtonLabel = this->fields.decideButtonLabel,
        Master_object = (GrandGraphDetailMaster_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11619/*"SELECT_GRAND_CONFIRM_DIALOG_DECIDE_BUTTON_TEXT"*/, 0),
        !decideButtonLabel)
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC0B68;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC0B20;
}
