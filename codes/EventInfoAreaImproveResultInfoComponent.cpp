        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45094 & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, str);
    sub_1BDB878(&StringLiteral_5550/*"EVENT_AREA_IMPROVE_REWARD_CHANGE_COLOR"*/, v8);
    byte_4B45094 = 1;
    if ( isChangeColor )
      goto LABEL_3;
    return str;
...
LABEL_3:
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_5550/*"EVENT_AREA_IMPROVE_REWARD_CHANGE_COLOR"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4508F & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&addEventPointRate);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_5544/*"EVENT_AREA_IMPROVE_GET_POINT_RATE"*/, v8);
    byte_4B4508F = 1;
  }
  ...
  v20 = (EventInfoAreaImproveResultInfoComponent_o *)System_String__Format_62613552(v11, v15, v19, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45093 & 1) == 0 )
  {
    ...
    this = (EventInfoAreaImproveResultInfoComponent_o *)sub_1BDB878(&NetworkManager_TypeInfo, v7);
    byte_4B45093 = 1;
  }
  if ( !giftEnt )
    goto LABEL_25;
  ...
  if ( !byte_4B3ED56 )
  {
    sub_1BDB878(&NetworkManager_TypeInfo, giftEnt);
    byte_4B3ED56 = 1;
  }
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (EventInfoAreaImproveResultInfoComponent_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !this )
LABEL_25:
    sub_1BDBAD4(this, giftEnt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4508E & 1) == 0 )
  {
    ...
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_5546/*"EVENT_AREA_IMPROVE_LEVEL"*/, v8);
    byte_4B4508E = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45092 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&coolTime);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&StringLiteral_5551/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME"*/, v8);
    sub_1BDB878(&StringLiteral_5548/*"EVENT_AREA_IMPROVE_MAX_REWARD_TIME_TEXT"*/, v9);
    byte_4B45092 = 1;
  }
  v10 = coolTime / 3600;
  v11 = coolTime % 60;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45091 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&unitNum);
    sub_1BDB878(&LocalizationManager_TypeInfo, v11);
    sub_1BDB878(&StringLiteral_5547/*"EVENT_AREA_IMPROVE_MAX_REWARD_NUM"*/, v12);
    sub_1BDB878(&StringLiteral_5545/*"EVENT_AREA_IMPROVE_GET_REWARD_NUM"*/, v13);
    byte_4B45091 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5547/*"EVENT_AREA_IMPROVE_MAX_REWARD_NUM"*/, 0LL);
  v33 = maxNum;
  ...
  v31 = System_String__Concat_62572260(v21, v29, 0LL);
  if ( !rewardNumLabel )
    sub_1BDBAD4(v31, v32);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45090 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&coolUnitTime);
    sub_1BDB878(&LocalizationManager_TypeInfo, v9);
    sub_1BDB878(&string_TypeInfo, v10);
    sub_1BDB878(&StringLiteral_5551/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME"*/, v11);
    sub_1BDB878(&StringLiteral_5537/*"EVENT_AREA_IMPROVE_AFTER_TIME_MESSAGE"*/, v12);
    sub_1BDB878(&StringLiteral_5552/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME_SEC"*/, v13);
    byte_4B45090 = 1;
  }
  if ( isQP )
  {
  ...
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5551/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME"*/, 0LL);
    v44 = v21;
    ...
    v19 = (EventInfoAreaImproveResultInfoComponent_o *)System_String__Format_62613620(v24, v28, v32, v36, 0LL);
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v39 = LocalizationManager__Get((System_String_o *)StringLiteral_5537/*"EVENT_AREA_IMPROVE_AFTER_TIME_MESSAGE"*/, 0LL);
  v40 = System_String__Concat_62572260(v38, v39, 0LL);
