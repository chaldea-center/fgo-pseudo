        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF017 & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, str);
    sub_1B64870(&StringLiteral_5516/*"EVENT_AREA_IMPROVE_REWARD_CHANGE_COLOR"*/, v8);
    byte_49FF017 = 1;
    if ( isChangeColor )
      goto LABEL_3;
    return str;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF012 & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&addEventPointRate);
    sub_1B64870(&LocalizationManager_TypeInfo, v7);
    sub_1B64870(&StringLiteral_5510/*"EVENT_AREA_IMPROVE_GET_POINT_RATE"*/, v8);
    byte_49FF012 = 1;
  }
  ...
  v20 = (EventInfoAreaImproveResultInfoComponent_o *)System_String__Format_61397948(v11, v15, v19, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF016 & 1) == 0 )
  {
    ...
    this = (EventInfoAreaImproveResultInfoComponent_o *)sub_1B64870(&NetworkManager_TypeInfo, v7);
    byte_49FF016 = 1;
  }
  if ( !giftEnt )
    goto LABEL_21;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (EventInfoAreaImproveResultInfoComponent_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !this )
LABEL_21:
    sub_1B64ACC(this, giftEnt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF011 & 1) == 0 )
  {
    ...
    sub_1B64870(&LocalizationManager_TypeInfo, v7);
    sub_1B64870(&StringLiteral_5512/*"EVENT_AREA_IMPROVE_LEVEL"*/, v8);
    byte_49FF011 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF015 & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&coolTime);
    sub_1B64870(&LocalizationManager_TypeInfo, v7);
    sub_1B64870(&StringLiteral_5517/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME"*/, v8);
    sub_1B64870(&StringLiteral_5514/*"EVENT_AREA_IMPROVE_MAX_REWARD_TIME_TEXT"*/, v9);
    byte_49FF015 = 1;
  }
  v10 = coolTime / 3600;
  v11 = coolTime % 60;
  ...
  v26 = System_String__Format_61398016(v13, v17, v21, v25, 0LL);
  ...
  v32 = System_String__Concat_61383576((System_String_o *)v29, v31, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF014 & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&unitNum);
    sub_1B64870(&LocalizationManager_TypeInfo, v11);
    sub_1B64870(&StringLiteral_5513/*"EVENT_AREA_IMPROVE_MAX_REWARD_NUM"*/, v12);
    sub_1B64870(&StringLiteral_5511/*"EVENT_AREA_IMPROVE_GET_REWARD_NUM"*/, v13);
    byte_49FF014 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5513/*"EVENT_AREA_IMPROVE_MAX_REWARD_NUM"*/, 0LL);
  v33 = maxNum;
  ...
  v31 = System_String__Concat_61383576(v21, v29, 0LL);
  if ( !rewardNumLabel )
    sub_1B64ACC(v31, v32);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF013 & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, *(_QWORD *)&coolUnitTime);
    sub_1B64870(&LocalizationManager_TypeInfo, v9);
    sub_1B64870(&string_TypeInfo, v10);
    sub_1B64870(&StringLiteral_5517/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME"*/, v11);
    sub_1B64870(&StringLiteral_5503/*"EVENT_AREA_IMPROVE_AFTER_TIME_MESSAGE"*/, v12);
    sub_1B64870(&StringLiteral_5518/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME_SEC"*/, v13);
    byte_49FF013 = 1;
  }
  if ( isQP )
  {
  ...
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5517/*"EVENT_AREA_IMPROVE_REWARD_UNIT_TIME"*/, 0LL);
    v44 = v21;
    ...
    v19 = (EventInfoAreaImproveResultInfoComponent_o *)System_String__Format_61398016(v24, v28, v32, v36, 0LL);
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v39 = LocalizationManager__Get((System_String_o *)StringLiteral_5503/*"EVENT_AREA_IMPROVE_AFTER_TIME_MESSAGE"*/, 0LL);
  v40 = System_String__Concat_61383576(v38, v39, 0LL);
