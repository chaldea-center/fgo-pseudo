        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD793 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_12185/*"STAFF_NO_SELECT_WARNING"*/, v8);
    this = (StaffSelectListViewItemDraw_o *)sub_1BC3008(&StringLiteral_17297/*"btn_bg_21"*/, v9);
    byte_4AFD793 = 1;
  }
  if ( !v3 )
    goto LABEL_49;
...
LABEL_20:
  ...
  if ( !this )
    goto LABEL_49;
  if ( v3->fields._IsSelected_k__BackingField )
    v23 = &StringLiteral_17297/*"btn_bg_21"*/;
  else
    v23 = &StringLiteral_17296/*"btn_bg_20"*/;
  ...
  if ( v3->fields._IsNotSelect_k__BackingField )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    this = (StaffSelectListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12185/*"STAFF_NO_SELECT_WARNING"*/, 0LL);
