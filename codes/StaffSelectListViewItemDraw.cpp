        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5933B5B & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_12794/*"STAFF_NO_SELECT_WARNING"*/);
    this = (StaffSelectListViewItemDraw_o *)sub_21FFC50(&StringLiteral_18173/*"btn_bg_21"*/);
    byte_5933B5B = 1;
  }
  if ( !v3 )
    goto LABEL_50;
...
LABEL_22:
  ...
  if ( !this )
    goto LABEL_50;
  v19 = &StringLiteral_18171/*"btn_bg_20"*/;
  if ( v3->fields._IsSelected_k__BackingField )
    v19 = &StringLiteral_18173/*"btn_bg_21"*/;
  ...
  if ( v3->fields._IsNotSelect_k__BackingField )
  {
    ...
    this = (StaffSelectListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12794/*"STAFF_NO_SELECT_WARNING"*/, 0);
  ...
  {
    item = **(StaffSelectListViewItem_o ***)(qword_594C0B8 + 184);
    if ( !v26 )
      goto LABEL_50;
  }
