        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52224 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_ServantMaster___, npAddManager);
  ...
  DataManager__GetMasterData_object_(v19, (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_ServantMaster___);
  if ( transformCount >= 2 )
  {
