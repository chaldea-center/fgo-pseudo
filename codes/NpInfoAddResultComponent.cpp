        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C012CD & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_ServantMaster___, npAddManager);
  ...
  DataManager__GetMasterData_object_(v19, (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_ServantMaster___);
  if ( transformCount >= 2 )
  {
