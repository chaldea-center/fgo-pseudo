        ...
        const MethodInfo *method)
{
  ...
  DataManager__GetMasterData_object_(v15, (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_ServantMaster___);
  if ( transformCount >= 2 )
  {
...
LABEL_10:
  ...
  if ( !v24 )
    goto LABEL_30;
  WrapControlText__textAdjust(beforeDetailLabel, (System_String_o *)Instance, v24->fields.mFontSize, 0, 0LL);
  ...
  if ( !v31 )
    goto LABEL_30;
  WrapControlText__textAdjust(afterDetailLabel, (System_String_o *)Instance, v31->fields.mFontSize, 0, 0LL);
}