        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5F7C & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_ServantMaster___, npAddManager);
    ...
    sub_1B00CCC(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v13);
  ...
  DataManager__GetMasterData_object_(v17, (const MethodInfo_2D62C10 *)Method_DataManager_GetMasterData_ServantMaster___);
