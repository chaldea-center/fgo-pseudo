        ...
        const MethodInfo *method)
{
  ...
  DataManager__GetMasterData_object_(v15, (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_ServantMaster___);
  if ( transformCount >= 2 )
  {
...
LABEL_10:
  ...
  Instance = TreasureDvcLvMaster__GetEntity((TreasureDvcLvMaster_o *)v17, v18[6], v18[7], 0LL);
  if ( !v19 )
    goto LABEL_30;
  ...
  if ( !Instance )
    goto LABEL_30;
  UILabel__set_text((UILabel_o *)Instance, v19[4], 0LL);
  Instance = this->fields.nameLabel;
  if ( !Instance )
    goto LABEL_30;
  v21 = (_DWORD)v18 + 28;
  UILabel__set_text((UILabel_o *)Instance, v19[3], 0LL);
  beforeLvLabel = this->fields.beforeLvLabel;
  Instance = System_Int32__ToString(v21, 0LL);
  if ( !beforeLvLabel )
    goto LABEL_30;
  ...
  if ( !Instance )
    goto LABEL_30;
  UILabel__set_text((UILabel_o *)Instance, v19[5], 0LL);
  if ( !v20 )
    goto LABEL_30;
  beforeDetailLabel = this->fields.beforeDetailLabel;
  Instance = TreasureDvcLvEntity__getDetalShort(v20, 0LL);
  v24 = this->fields.beforeDetailLabel;
  if ( !v24 )
    goto LABEL_30;
  WrapControlText__textAdjust(beforeDetailLabel, (System_String_o *)Instance, v24->fields.mFontSize, 0, 0, 0LL);
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             *((_DWORD *)Instance + 6),
             (const MethodInfo_311D934 *)Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__);
  v27 = TreasureDvcLvMaster__GetEntity((TreasureDvcLvMaster_o *)v17, v25[6], v25[7], 0LL);
  afterLvLabel = this->fields.afterLvLabel;
  v29 = v27;
  Instance = System_Int32__ToString((int)v25 + 28, 0LL);
  if ( !afterLvLabel )
    goto LABEL_30;
  ...
  Instance = TreasureDvcLvEntity__getDetalShort(v29, 0LL);
  v31 = this->fields.afterDetailLabel;
  if ( !v31 )
    goto LABEL_30;
  WrapControlText__textAdjust(afterDetailLabel, (System_String_o *)Instance, v31->fields.mFontSize, 0, 0, 0LL);
}