        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB56C & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_ServantMaster___, npAddManager);
  ...
  DataManager__GetMasterData_object_(v19, (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_ServantMaster___);
  if ( transformCount >= 2 )
  {
...
LABEL_10:
  ...
  if ( !v28 )
    goto LABEL_30;
  WrapControlText__textAdjust(beforeDetailLabel, (System_String_o *)Instance, v28->fields.mFontSize, 0, 0LL);
  ...
  if ( !v35 )
    goto LABEL_30;
  WrapControlText__textAdjust(afterDetailLabel, (System_String_o *)Instance, v35->fields.mFontSize, 0, 0LL);
}