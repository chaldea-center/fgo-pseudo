        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73796 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ServantMaster___, npAddManager);
  ...
  DataManager__GetMasterData_object_(v19, (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_ServantMaster___);
  if ( transformCount >= 2 )
  {
