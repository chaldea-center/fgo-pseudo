        ...
        const MethodInfo *method)
{
  ...
  *fortificationName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4(fortificationName, StringLiteral_1/*""*/);
  *fortificationDetailName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4(fortificationDetailName, StringLiteral_1/*""*/);
  ...
  if ( !Instance
    || (MasterData_object = DataManager__GetMasterData_object_(
        ...
        (Instance = (EventEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
        ...
        const MethodInfo *method)
{
  ...
  v13 = System_String__Concat_65122828((System_String_o *)StringLiteral_370/*"#"*/, colorCodeMilitsry, 0);
