        ...
        const MethodInfo *method)
{
  ...
  *fortificationName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1D0F058(fortificationName, StringLiteral_1/*""*/);
  *fortificationDetailName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1D0F058(fortificationDetailName, StringLiteral_1/*""*/);
  ...
  if ( !Instance
    || (MasterData_object = DataManager__GetMasterData_object_(
        ...
        (Instance = (EventEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0)
        ...
        const MethodInfo *method)
{
  ...
  v13 = System_String__Concat_65562772((System_String_o *)StringLiteral_370/*"#"*/, colorCodeMilitsry, 0);
