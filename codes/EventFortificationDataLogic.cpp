        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E63D3 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventMaster___, fortificationName);
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserEventFortificationMaster___, v9);
  ...
  *fortificationDetailName = (System_String_o *)StringLiteral_1/*""*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)fortificationDetailName, (int32_t)StringLiteral_1/*""*/, v12, v13);
  ...
  if ( !Instance
    || (MasterData_object = DataManager__GetMasterData_object_(
        ...
        (Instance = (EventEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E63D4 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_398/*"#"*/, colorCodeMilitsry);
  ...
  v14 = System_String__Concat_60325748((System_String_o *)StringLiteral_398/*"#"*/, v11, 0LL);
