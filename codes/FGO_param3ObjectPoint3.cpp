...
void __fastcall FGO_param3ObjectPoint3__Start(FGO_param3ObjectPoint3_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B150A2 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_16755/*"_threeValue2_1"*/, v4, v5);
    sub_1BCA7E0(&StringLiteral_16756/*"_threeValue2_2"*/, v6, v7);
    sub_1BCA7E0(&StringLiteral_16754/*"_threeValue2_0"*/, v8, v9);
    byte_4B150A2 = 1;
  }
  ...
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16754/*"_threeValue2_0"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16755/*"_threeValue2_1"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  if ( !renderer )
    goto LABEL_22;
  UnityEngine_Material__EnableKeyword((UnityEngine_Material_o *)renderer, (System_String_o *)StringLiteral_16756/*"_threeValue2_2"*/, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  if ( !v20 )
    goto LABEL_22;
  UnityEngine_Material__SetFloat(v20, (System_String_o *)StringLiteral_16754/*"_threeValue2_0"*/, v21, 0LL);
  renderer = *p_renderer;
  if ( !*p_renderer )
    goto LABEL_22;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v23 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v22
    || (UnityEngine_Material__SetFloat(v22, (System_String_o *)StringLiteral_16755/*"_threeValue2_1"*/, v23, 0LL),
...
LABEL_22:
  ...
  UnityEngine_Material__SetFloat(v25, (System_String_o *)StringLiteral_16756/*"_threeValue2_2"*/, v26, 0LL);
}
...
void __fastcall FGO_param3ObjectPoint3__Update(FGO_param3ObjectPoint3_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B150A3 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_16755/*"_threeValue2_1"*/, method, v2);
    sub_1BCA7E0(&StringLiteral_16756/*"_threeValue2_2"*/, v4, v5);
    sub_1BCA7E0(&StringLiteral_16754/*"_threeValue2_0"*/, v6, v7);
    byte_4B150A3 = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer )
  ...
  if ( !v9 )
    goto LABEL_16;
  UnityEngine_Material__SetFloat(v9, (System_String_o *)StringLiteral_16754/*"_threeValue2_0"*/, v10, 0LL);
  renderer = this->fields._renderer;
  if ( !renderer )
    goto LABEL_16;
  renderer = (UnityEngine_Renderer_o *)UnityEngine_Renderer__get_sharedMaterial(renderer, 0LL);
  ...
  *(UnityEngine_Vector3_o *)(&v12 - 1) = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)renderer, 0LL);
  if ( !v11
    || (UnityEngine_Material__SetFloat(v11, (System_String_o *)StringLiteral_16755/*"_threeValue2_1"*/, v12, 0LL),
...
LABEL_16:
  ...
  UnityEngine_Material__SetFloat(v14, (System_String_o *)StringLiteral_16756/*"_threeValue2_2"*/, v15, 0LL);
}