...
void __fastcall FGO_param3ObjectPoint3__Start(FGO_param3ObjectPoint3_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD40C & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_16519/*"_threeValue2_1"*/, v3);
    sub_1B64870(&StringLiteral_16520/*"_threeValue2_2"*/, v4);
    sub_1B64870(&StringLiteral_16518/*"_threeValue2_0"*/, v5);
    byte_49FD40C = 1;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields._renderer, (int32_t)Component_object, v8, v9);
...
void __fastcall FGO_param3ObjectPoint3__Update(FGO_param3ObjectPoint3_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD40D & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_16519/*"_threeValue2_1"*/, method);
    sub_1B64870(&StringLiteral_16520/*"_threeValue2_2"*/, v3);
    sub_1B64870(&StringLiteral_16518/*"_threeValue2_0"*/, v4);
    byte_49FD40D = 1;
  }
  renderer = this->fields._renderer;
  if ( !renderer )
