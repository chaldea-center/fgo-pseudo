...
void __fastcall EventRankingListViewObject__Awake(EventRankingListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0497 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_EventRankingListViewItemDraw___);
    byte_42B0497 = 1;
  }
  ...
  if ( !dispObject
    || (Component_srcLineSprite = (struct EventRankingListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                             ...
                                                                             (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_EventRankingListViewItemDraw___),
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventRankingListViewObject__Init_25582748(
        EventRankingListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventRankingListViewObject__Init_25583652(
        EventRankingListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventRankingListViewObject__Init_25584184(
        EventRankingListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall EventRankingListViewObject__SetItem_25586840(
        EventRankingListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B04A4 & 1) == 0 )
  {
    sub_B52984(&EventRankingListViewItemDraw_DispMode_TypeInfo);
    sub_B52984(&StringLiteral_81/*" "*/);
    byte_42B04A4 = 1;
  }
  v13 = 0.0;
  v12 = 0LL;
  v3 = j_il2cpp_value_box_0(EventRankingListViewItemDraw_DispMode_TypeInfo, &this->fields.dispMode);
  if ( !v3 )
    sub_B52A5C(0LL, v4);
  v5 = v3;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventRankingListViewObject_o *)sub_B52D50(v8);
