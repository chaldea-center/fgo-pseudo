        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2FFC5 & 1) == 0 )
  {
    sub_1B761C0(&AssumedBattleAssetSearcherForMasterSkill_TypeInfo, v1);
    byte_4A2FFC5 = 1;
  }
  v2 = (AssumedBattleAssetSearcherBase_o *)sub_1B7640C(AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2FFC4 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__, v3);
    sub_1B761C0(&Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor__, v4);
    sub_1B761C0(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo, v5);
    byte_4A2FFC4 = 1;
  }
  ...
  v8 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1B7640C(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
