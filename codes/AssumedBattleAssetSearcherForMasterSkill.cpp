        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD17E & 1) == 0 )
  {
    sub_1B4CF90(&AssumedBattleAssetSearcherForMasterSkill_TypeInfo, v1);
    byte_49BD17E = 1;
  }
  v2 = (AssumedBattleAssetSearcherBase_o *)sub_1B4D1DC(AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BD17D & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_System_Collections_Generic_HashSet_SimpleSkillData__UnionWith__, v3);
    sub_1B4CF90(&Method_System_Collections_Generic_HashSet_SimpleSkillData___ctor__, v4);
    sub_1B4CF90(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo, v5);
    byte_49BD17D = 1;
  }
  ...
  v8 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1B4D1DC(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
