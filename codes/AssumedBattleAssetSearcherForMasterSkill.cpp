        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1C49 & 1) == 0 )
  {
    sub_B52984(&AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
    byte_42B1C49 = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_B52A54(AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1C48 & 1) == 0 )
  {
    ...
    sub_B52984(&System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
    byte_42B1C48 = 1;
  }
  v3 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_B52A54(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v3, 0LL);
  v4 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_B52A54(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
