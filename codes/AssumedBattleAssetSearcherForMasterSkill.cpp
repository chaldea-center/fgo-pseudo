AssumedBattleAssetSearcherForMasterSkill_o *AssumedBattleAssetSearcherForMasterSkill__Create(const MethodInfo *method)
{
  ...
  if ( (byte_5972E13 & 1) == 0 )
  {
    sub_2213A60(&AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
    byte_5972E13 = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_2213CCC(AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v3 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_2213CCC(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v3, v4);
  v5 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_2213CCC(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
