AssumedBattleAssetSearcherForMasterSkill_o *AssumedBattleAssetSearcherForMasterSkill__Create(const MethodInfo *method)
{
  ...
  if ( (byte_4CB87DA & 1) == 0 )
  {
    sub_1C6BA08(&AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
    byte_4CB87DA = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_1C6BC54(AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v3 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1C6BC54(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v3, v4);
  v5 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1C6BC54(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
