        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE7CC & 1) == 0 )
  {
    sub_1C21E38(&AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
    byte_4BDE7CC = 1;
  }
  v1 = (AssumedBattleAssetSearcherBase_o *)sub_1C22084(AssumedBattleAssetSearcherForMasterSkill_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v3 = (AssumedBattleAssetLoadManager_AnalyzedResultParam_o *)sub_1C22084(AssumedBattleAssetLoadManager_AnalyzedResultParam_TypeInfo);
  AssumedBattleAssetLoadManager_AnalyzedResultParam___ctor(v3, v4);
  v5 = (System_Collections_Generic_HashSet_SimpleSkillData__o *)sub_1C22084(System_Collections_Generic_HashSet_SimpleSkillData__TypeInfo);
