        ...
        const MethodInfo *method)
{
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.target, (int32_t)target, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8C6C & 1) == 0 )
  {
    sub_1B4CF90(&WarBoardMovePerformance__Execute_d__7_TypeInfo, method);
    byte_49B8C6C = 1;
  }
  v3 = sub_1B4D1DC(WarBoardMovePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_WarBoardMovePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
