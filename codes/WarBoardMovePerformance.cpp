        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.target, (int32_t)target, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C40C3D & 1) == 0 )
  {
    sub_1C37058(&WarBoardMovePerformance__Execute_d__7_TypeInfo);
    byte_4C40C3D = 1;
  }
  v3 = sub_1C372A4(WarBoardMovePerformance__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_WarBoardMovePerformance__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
