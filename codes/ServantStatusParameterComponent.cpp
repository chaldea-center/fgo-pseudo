        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B871E & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterGauge___, parent);
  ...
  if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)parent, 0LL, 0LL) )
    return 0LL;
  GameObjectExtensions__SafeSetParent_34075504((UnityEngine_GameObject_o *)v8, parent, 0LL);
  if ( !v8 )
    sub_1B4D1EC(v10, v11);
  return (ServantStatusParameterGauge_o *)UnityEngine_GameObject__GetComponent_object_(
                                            (UnityEngine_GameObject_o *)v8,
                                            (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterGauge___);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_8:
    sub_1B4D1EC(powerGauge, *(_QWORD *)&power);
  }
