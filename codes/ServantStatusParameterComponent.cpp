        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC33F & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterGauge___, parent);
  ...
  if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)parent, 0LL, 0LL) )
    return 0LL;
  GameObjectExtensions__SafeSetParent_33382640((UnityEngine_GameObject_o *)v8, parent, 0LL);
  if ( !v8 )
    sub_1B64C5C(v10, v11);
  return (ServantStatusParameterGauge_o *)UnityEngine_GameObject__GetComponent_object_(
                                            (UnityEngine_GameObject_o *)v8,
                                            (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterGauge___);
}
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_8:
    sub_1B64C5C(powerGauge, *(_QWORD *)&power);
  }
