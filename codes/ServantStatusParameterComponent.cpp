        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3959 & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterGauge___);
  ...
  if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)parent, 0, 0) )
    return 0;
  GameObjectExtensions__SafeSetParent_36361932((UnityEngine_GameObject_o *)v6, parent, 0);
  if ( !v6 )
    sub_1C6BC60(v8, v9);
  return (ServantStatusParameterGauge_o *)UnityEngine_GameObject__GetComponent_object_(
                                            (UnityEngine_GameObject_o *)v6,
                                            (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterGauge___);
}
