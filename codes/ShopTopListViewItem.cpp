        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.info, (int32_t)info, v12, v13, v14, v15, v16, v17);
...
System_String_o *ShopTopListViewItem__get_InfoText(ShopTopListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA919 & 1) == 0 )
  {
    this = (ShopTopListViewItem_o *)sub_1C7BAE8(&LocalizationManager_TypeInfo);
    byte_4CEA919 = 1;
  }
  info = v2->fields.info;
  if ( !info )
...
bool ShopTopListViewItem__get_IsPeriod(ShopTopListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEA91A & 1) == 0 )
  {
    ...
    this = (ShopTopListViewItem_o *)sub_1C7BAE8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4CEA91A = 1;
  }
  info = v2->fields.info;
  if ( !info )
  ...
  {
    this = (ShopTopListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
