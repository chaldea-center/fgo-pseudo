        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.info, (int32_t)info, v12, v13, v14, v15, v16, v17);
...
System_String_o *ShopTopListViewItem__get_InfoText(ShopTopListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00C6C & 1) == 0 )
  {
    this = (ShopTopListViewItem_o *)sub_1CE6700(&LocalizationManager_TypeInfo);
    byte_4E00C6C = 1;
  }
  info = v2->fields.info;
  if ( !info )
...
bool ShopTopListViewItem__get_IsPeriod(ShopTopListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00C6D & 1) == 0 )
  {
    ...
    this = (ShopTopListViewItem_o *)sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4E00C6D = 1;
  }
  info = v2->fields.info;
  if ( !info )
  ...
  {
    this = (ShopTopListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
