        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.info, (int32_t)info, v12, v13);
  this->fields._IsUse_k__BackingField = isUse;
  this->fields.shopListNotice = shopListNotice;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.shopListNotice, (int32_t)shopListNotice, v14, v15);
...
System_String_o *__fastcall ShopTopListViewItem__get_InfoText(ShopTopListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6C559 & 1) == 0 )
  {
    this = (ShopTopListViewItem_o *)sub_1B90010(&LocalizationManager_TypeInfo, method);
    byte_4A6C559 = 1;
  }
  info = v2->fields.info;
  if ( !info )
...
bool __fastcall ShopTopListViewItem__get_IsPeriod(ShopTopListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6C55A & 1) == 0 )
  {
    ...
    this = (ShopTopListViewItem_o *)sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v3);
    byte_4A6C55A = 1;
  }
  info = v2->fields.info;
  if ( !info )
  ...
  {
    this = (ShopTopListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( this )
    {
