        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23D3E & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___, method);
    byte_4A23D3E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23D3F & 1) == 0 )
  {
    sub_1B715CC(&EventServantFatigueListViewItem_TypeInfo, method);
    byte_4A23D3F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23D40 & 1) == 0 )
  {
    sub_1B715CC(&EventServantFatigueListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A23D40 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_45938588(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_45939236(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_45955828(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1B715CC(&EventServantFatigueListViewManager_TypeInfo, v3);
    sub_1B715CC(&Method_EventServantFatigueListViewObject_OnClickSelect__, v4);
    sub_1B715CC(&StringLiteral_9832/*"OnClickSelectObject"*/, v5);
    this = (EventServantFatigueListViewObject_o *)sub_1B715CC(&StringLiteral_9833/*"OnClickSelectPush"*/, v6);
    byte_4A23D44 = 1;
  }
  ...
  if ( linkItem )
  {
    ...
    if ( CallbackFunc_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v16 = (_QWORD *)sub_1B715E4(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_37:
    ...
    if ( CallbackFunc_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v13 = (_QWORD *)sub_1B715E4(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_23:
    ...
    if ( CallbackFunc_high == 3 )
    {
      if ( !EventServantFatigueListViewItem__get_IsCanNotSelectPush(v9, 0LL) )
      {
        ...
        if ( !this )
          goto LABEL_37;
        v18 = &StringLiteral_9833/*"OnClickSelectPush"*/;
        goto LABEL_31;
      }
    }
    ...
    {
      v18 = &StringLiteral_9832/*"OnClickSelectObject"*/;
      this = manager;
LABEL_31:
    ...
    if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v19 = (_QWORD *)sub_1B715E4(Method_EventServantFatigueListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1B715CC(&StringLiteral_9887/*"OnLongPushListView"*/, v3);
    this = (EventServantFatigueListViewObject_o *)sub_1B715CC(&StringLiteral_9906/*"OnPressCancel"*/, v4);
    byte_4A23D45 = 1;
  }
  linkItem = v2->fields.linkItem;
  if ( linkItem )
...
void __fastcall EventServantFatigueListViewObject__SetItem_45955128(
        EventServantFatigueListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventServantFatigueListViewObject__Init_45938588(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23D43 & 1) == 0 )
  {
    sub_1B715CC(&EventServantFatigueListViewItemDraw_DispMode_TypeInfo, method);
