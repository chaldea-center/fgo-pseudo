        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4917A & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___, method);
    byte_4A4917A = 1;
  }
  ...
  this->fields.itemDraw = (struct EventServantFatigueListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                            dispObject,
                                                                            (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4917B & 1) == 0 )
  {
    sub_1B863B8(&EventServantFatigueListViewItem_TypeInfo, method);
    byte_4A4917B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4917C & 1) == 0 )
  {
    sub_1B863B8(&EventServantFatigueListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4A4917C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  {
    v20 = dword_BFAA04[v11];
    this->fields.dispMode = dword_BFA9F0[v11];
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_31023248(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_31023896(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_31040596(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1B863B8(&EventServantFatigueListViewManager_TypeInfo, v3);
    sub_1B863B8(&Method_EventServantFatigueListViewObject_OnClickSelect__, v4);
    sub_1B863B8(&StringLiteral_9719/*"OnClickSelectObject"*/, v5);
    this = (EventServantFatigueListViewObject_o *)sub_1B863B8(&StringLiteral_9720/*"OnClickSelectPush"*/, v6);
    byte_4A49180 = 1;
  }
  ...
  if ( linkItem )
  {
    ...
    if ( CallbackFunc_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v16 = (_QWORD *)sub_1B863D0(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_37:
    ...
    if ( CallbackFunc_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v13 = (_QWORD *)sub_1B863D0(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_23:
    ...
    if ( CallbackFunc_high == 3 )
    {
      if ( !EventServantFatigueListViewItem__get_IsCanNotSelectPush(v9, 0LL) )
      {
        ...
        if ( !this )
          goto LABEL_37;
        v18 = &StringLiteral_9720/*"OnClickSelectPush"*/;
        goto LABEL_31;
      }
    }
    ...
    {
      v18 = &StringLiteral_9719/*"OnClickSelectObject"*/;
      this = manager;
LABEL_31:
    ...
    if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v19 = (_QWORD *)sub_1B863D0(Method_EventServantFatigueListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1B863B8(&StringLiteral_9777/*"OnLongPushListView"*/, v3);
    this = (EventServantFatigueListViewObject_o *)sub_1B863B8(&StringLiteral_9795/*"OnPressCancel"*/, v4);
    byte_4A49181 = 1;
  }
  linkItem = v2->fields.linkItem;
  if ( linkItem )
...
void __fastcall EventServantFatigueListViewObject__SetItem_31039896(
        EventServantFatigueListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventServantFatigueListViewObject__Init_31023248(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4917F & 1) == 0 )
  {
    sub_1B863B8(&EventServantFatigueListViewItemDraw_DispMode_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventServantFatigueListViewObject_o *)sub_1B868D4(v8);
