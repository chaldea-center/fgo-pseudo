        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5C16 & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___, method);
    byte_49B5C16 = 1;
  }
  ...
  this->fields.itemDraw = (struct EventServantFatigueListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                            dispObject,
                                                                            (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5C17 & 1) == 0 )
  {
    sub_1B4CF90(&EventServantFatigueListViewItem_TypeInfo, method);
    byte_49B5C17 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5C18 & 1) == 0 )
  {
    sub_1B4CF90(&EventServantFatigueListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_49B5C18 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_30695304(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_30695952(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_30712652(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1B4CF90(&EventServantFatigueListViewManager_TypeInfo, v3);
    sub_1B4CF90(&Method_EventServantFatigueListViewObject_OnClickSelect__, v4);
    sub_1B4CF90(&StringLiteral_9666/*"OnClickSelectObject"*/, v5);
    this = (EventServantFatigueListViewObject_o *)sub_1B4CF90(&StringLiteral_9667/*"OnClickSelectPush"*/, v6);
    byte_49B5C1C = 1;
  }
  ...
  if ( linkItem )
  {
    ...
    if ( CallbackFunc_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v16 = (_QWORD *)sub_1B4CFA8(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_37:
    ...
    if ( CallbackFunc_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v13 = (_QWORD *)sub_1B4CFA8(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_23:
    ...
    if ( CallbackFunc_high == 3 )
    {
      if ( !EventServantFatigueListViewItem__get_IsCanNotSelectPush(v9, 0LL) )
      {
        ...
        if ( !this )
          goto LABEL_37;
        v18 = &StringLiteral_9667/*"OnClickSelectPush"*/;
        goto LABEL_31;
      }
    }
    ...
    {
      v18 = &StringLiteral_9666/*"OnClickSelectObject"*/;
      this = manager;
LABEL_31:
    ...
    if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v19 = (_QWORD *)sub_1B4CFA8(Method_EventServantFatigueListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1B4CF90(&StringLiteral_9723/*"OnLongPushListView"*/, v3);
    this = (EventServantFatigueListViewObject_o *)sub_1B4CF90(&StringLiteral_9741/*"OnPressCancel"*/, v4);
    byte_49B5C1D = 1;
  }
  linkItem = v2->fields.linkItem;
  if ( linkItem )
...
void __fastcall EventServantFatigueListViewObject__SetItem_30711952(
        EventServantFatigueListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventServantFatigueListViewObject__Init_30695304(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5C1B & 1) == 0 )
  {
    sub_1B4CF90(&EventServantFatigueListViewItemDraw_DispMode_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventServantFatigueListViewObject_o *)sub_1B4D4AC(v8);
