...
void EventServantFatigueListViewObject__Awake(EventServantFatigueListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0C29 & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___);
    byte_4CB0C29 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___);
...
void EventServantFatigueListViewObject__Init_32706804(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void EventServantFatigueListViewObject__Init_32707452(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void EventServantFatigueListViewObject__Init_32723768(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0C2F & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_EventServantFatigueListViewObject_OnClickSelect__);
    sub_1C6BA08(&StringLiteral_9866/*"OnClickSelectObject"*/);
    this = (EventServantFatigueListViewObject_o *)sub_1C6BA08(&StringLiteral_9867/*"OnClickSelectPush"*/);
    byte_4CB0C2F = 1;
  }
  ...
  if ( linkItem )
  {
    ...
    if ( CallbackFunc_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1C6BA20(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_37:
    ...
    if ( CallbackFunc_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1C6BA20(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_31:
    ...
    if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1C6BA20(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
void EventServantFatigueListViewObject__OnLongPush(EventServantFatigueListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB0C30 & 1) == 0 )
  {
    ...
    this = (EventServantFatigueListViewObject_o *)sub_1C6BA08(&StringLiteral_9942/*"OnPressCancel"*/);
    byte_4CB0C30 = 1;
  }
  linkItem = v2->fields.linkItem;
  if ( linkItem )
...
void EventServantFatigueListViewObject__SetItem_32723068(
        EventServantFatigueListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void EventServantFatigueListViewObject__Start(EventServantFatigueListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventServantFatigueListViewObject__Init_32706804(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0C2E & 1) == 0 )
  {
    sub_1C6BA08(&EventServantFatigueListViewItemDraw_DispMode_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventServantFatigueListViewObject_o *)sub_1C6BFFC(v8);
