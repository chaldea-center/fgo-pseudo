        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CDAD & 1) == 0 )
  {
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___, method);
    byte_4C1CDAD = 1;
  }
  ...
  if ( !dispObject )
    sub_1C3B9C0(0LL, v3);
  this->fields.itemDraw = (struct EventServantFatigueListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                            dispObject,
                                                                            (const MethodInfo_3041A18 *)Method_UnityEngine_GameObject_GetComponent_EventServantFatigueListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CDAE & 1) == 0 )
  {
    sub_1C3B764(&EventServantFatigueListViewItem_TypeInfo, method);
    byte_4C1CDAE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CDAF & 1) == 0 )
  {
    sub_1C3B764(&EventServantFatigueListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4C1CDAF = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
  ...
  {
    v20 = dword_C46734[v11];
    this->fields.dispMode = dword_C46720[v11];
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_31680964(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_31681900(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventServantFatigueListViewObject__Init_31681984(
        EventServantFatigueListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1C3B764(&EventServantFatigueListViewManager_TypeInfo, v3);
    sub_1C3B764(&Method_EventServantFatigueListViewObject_OnClickSelect__, v4);
    sub_1C3B764(&StringLiteral_10059/*"PARTY_ORGANIZATION_SERVANT_QUEST_RESTRICTION_FIXED_NPC"*/, v5);
    this = (EventServantFatigueListViewObject_o *)sub_1C3B764(&StringLiteral_10060/*"PARTY_ORGANIZATION_SERVANT_QUEST_RESTRICTION_FIXED_NPC_ONLY"*/, v6);
    byte_4C1CDB3 = 1;
  }
  ...
  if ( linkItem )
  {
    ...
    if ( CallbackFunc_high == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v16 = (_QWORD *)sub_1C3B77C(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_37:
    ...
    if ( CallbackFunc_high == 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
        v13 = (_QWORD *)sub_1C3B77C(Method_EventServantFatigueListViewObject_OnClickSelect__);
...
LABEL_23:
    ...
    if ( CallbackFunc_high == 3 )
    {
      if ( !EventServantFatigueListViewItem__get_IsCanNotSelectPush(v9, 0LL) )
      {
        ...
        if ( !this )
          goto LABEL_37;
        v18 = &StringLiteral_10060/*"PARTY_ORGANIZATION_SERVANT_QUEST_RESTRICTION_FIXED_NPC_ONLY"*/;
        goto LABEL_31;
      }
    }
    ...
    {
      v18 = &StringLiteral_10059/*"PARTY_ORGANIZATION_SERVANT_QUEST_RESTRICTION_FIXED_NPC"*/;
      this = manager;
LABEL_31:
    ...
    if ( (*((_BYTE *)Method_EventServantFatigueListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v19 = (_QWORD *)sub_1C3B77C(Method_EventServantFatigueListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&EventServantFatigueListViewItem_TypeInfo, method);
    sub_1C3B764(&StringLiteral_10115/*"PHOTO_CAMPAIGN_BUTTON_TEXT"*/, v3);
    this = (EventServantFatigueListViewObject_o *)sub_1C3B764(&StringLiteral_10133/*"PHOTO_TARGET_SELECT_DIALOG_MESSAGE_RIGHT"*/, v4);
    byte_4C1CDB4 = 1;
  }
  linkItem = v2->fields.linkItem;
  if ( linkItem )
...
void __fastcall EventServantFatigueListViewObject__SetItem_31681196(
        EventServantFatigueListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    EventServantFatigueListViewObject__Init_31680964(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CDB2 & 1) == 0 )
  {
    sub_1C3B764(&EventServantFatigueListViewItemDraw_DispMode_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v9 )
      sub_1C3B9C0(0LL, v8);
    EventServantFatigueListViewItemDraw__UpdateDisp(v9, (EventServantFatigueListViewItem_o *)v6, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventServantFatigueListViewObject_o *)sub_1C3BC80(v8);
