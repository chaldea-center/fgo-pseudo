...
LABEL_17:
    sub_1BDBAD4(skillIconComp, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B1E & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_TweenColor___, method);
    byte_4B48B1E = 1;
  }
  ...
  {
    sub_1BDBAD4(noSelectMskImg, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B17 & 1) == 0 )
  {
    sub_1BDB878(&Method_ServantSkillInfoIconComponent_OnClickSkill__, method);
    byte_4B48B17 = 1;
  }
  if ( this->fields.currentSkillId >= 1 && this->fields.isPlayClickSe )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSkillInfoIconComponent_OnClickSkill__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_ServantSkillInfoIconComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B18 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ServantSkillInfoIconComponent_OnClickSkillDetail__, v8);
  ...
  if ( this->fields.currentSkillId >= 1 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSkillInfoIconComponent_OnClickSkillDetail__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1BDB890(Method_ServantSkillInfoIconComponent_OnClickSkillDetail__);
    ...
    if ( Instance )
    {
      ...
      if ( Instance )
      {
        ...
        if ( Instance )
        {
          ...
          v21 = LocalizationManager__Get((System_String_o *)StringLiteral_8542/*"MASTER_EQSKILL_LV_TXT"*/, 0LL);
          chargeTurn = v19;
          v25 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &chargeTurn, v22, v23, v24);
          v26 = System_String__Format(v21, v25, 0LL);
          name = System_String__Concat_62610508(v20, (System_String_o *)StringLiteral_115/*" "*/, v26, 0LL);
          Empty = string_TypeInfo->static_fields->Empty;
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_SkillLvMaster___);
          if ( Instance )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B1F & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_TweenColor___, isPlayLock);
...
LABEL_12:
    sub_1BDBAD4(skillIconSprite, isPlayLock);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !noSelectMskImg
    || (noSelectMskImg = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(noSelectMskImg, 0LL)) == 0LL )
  {
    sub_1BDBAD4(noSelectMskImg, isShow);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B1C & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&skillLv);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&string_TypeInfo, v8);
    this = (ServantSkillInfoIconComponent_o *)sub_1BDB878(&StringLiteral_2027/*"APPEND_SKILL_ICON_INFO_LV"*/, v9);
    byte_4B48B1C = 1;
  }
  ...
  if ( !skillLv )
  {
    ...
    if ( levelLabel )
      goto LABEL_7;
LABEL_9:
    sub_1BDBAD4(this, Empty);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_2027/*"APPEND_SKILL_ICON_INFO_LV"*/, 0LL);
  v22 = skillLv;
  ...
  this = (ServantSkillInfoIconComponent_o *)System_String__Format_62613552(v11, v15, v19, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B1D & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, msg);
    byte_4B48B1D = 1;
  }
  msgLabel = (UnityEngine_Object_o *)this->fields.msgLabel;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B14 & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, *(_QWORD *)&idx);
    byte_4B48B14 = 1;
  }
  skillIconComp = this->fields.skillIconComp;
  ...
  if ( !skillIconComp )
    goto LABEL_17;
  SkillIconComponent__Set_40036740(skillIconComp, skillId, skillLv, 0LL);
...
LABEL_17:
    sub_1BDBAD4(skillIconComp, *(_QWORD *)&idx);
  }
LABEL_16:
  this->fields.callbackFunc = callback;
  p_callbackFunc = &this->fields.callbackFunc;
  sub_1BDB81C((CGThumbnailListItem_o *)p_callbackFunc, (int32_t)callback, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B16 & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, *(_QWORD *)&skillLv);
    sub_1BDB878(&StringLiteral_8785/*"MSG_ABLED_SKILLUP"*/, v11);
...
LABEL_27:
    sub_1BDBAD4(lockImg, *(_QWORD *)&skillLv);
  }
  if ( updateLockSkillSprite )
  {
    lockImg = (UnityEngine_Component_o *)this->fields.skillIconSprite;
  ...
  if ( skillLv <= 9 && isEnableCombine )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    lockImg = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8785/*"MSG_ABLED_SKILLUP"*/, 0LL);
    if ( statusLb )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B13 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_SkillMaster___, *(_QWORD *)&idx);
    sub_1BDB878(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v19);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, v20);
    sub_1BDB878(&int_TypeInfo, v21);
    sub_1BDB878(&LocalizationManager_TypeInfo, v22);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v23);
    sub_1BDB878(&ServantSkillStrengthStatus_TypeInfo, v24);
    sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v25);
    sub_1BDB878(&StringLiteral_5055/*"DISP_SKLL_LV"*/, v26);
    sub_1BDB878(&StringLiteral_12193/*"SKILLCHARGETURN_TXT"*/, v27);
    byte_4B48B13 = 1;
  }
  SkillChargeTime = 0;
  ...
  skillNameLabel = BaseMonoBehaviour__createObject_40191676((BaseMonoBehaviour_o *)this, PATH, transform, 0LL, 0LL);
  if ( !skillNameLabel )
    goto LABEL_30;
  Component_object = UnityEngine_GameObject__GetComponent_object_(
  ...
  *p_skillStrengthStatus = (struct ServantSkillStrengthStatus_o *)Component_object;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.skillStrengthStatus, (int32_t)Component_object, v36, v37);
  skillNameLabel = *p_skillStrengthStatus;
  if ( !*p_skillStrengthStatus )
    goto LABEL_30;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v39 = LocalizationManager__Get((System_String_o *)StringLiteral_5055/*"DISP_SKLL_LV"*/, 0LL);
  v54 = skillLv;
  ...
  skillNameLabel = System_String__Format_62613552(v39, v43, v47, 0LL);
  if ( !levelLabel )
    goto LABEL_30;
  UILabel__set_text(levelLabel, (System_String_o *)skillNameLabel, 0LL);
  skillNameLabel = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !skillNameLabel )
    goto LABEL_30;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  skillNameLabel = LocalizationManager__Get((System_String_o *)StringLiteral_12193/*"SKILLCHARGETURN_TXT"*/, 0LL);
  if ( !chargeTitleLb
  ...
  {
LABEL_30:
    sub_1BDBAD4(skillNameLabel, v28);
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantSkillInfoIconComponent__SetSkillInfo_47697752(
        ServantSkillInfoIconComponent_o *this,
        int32_t idx,
        System_String_o *skillName,
        int32_t skillId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B15 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, *(_QWORD *)&idx);
    sub_1BDB878(&LocalizationManager_TypeInfo, v17);
    sub_1BDB878(&StringLiteral_2027/*"APPEND_SKILL_ICON_INFO_LV"*/, v18);
    byte_4B48B15 = 1;
  }
  ServantSkillInfoIconComponent__SetSkillIconInfo(
    this,
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_2027/*"APPEND_SKILL_ICON_INFO_LV"*/, 0LL);
  v32 = skillLv;
  ...
  skillNameLabel = (UILabel_o *)System_String__Format_62613552(v22, v26, v30, 0LL);
  if ( !levelLabel )
LABEL_10:
    sub_1BDBAD4(skillNameLabel, v19);
  UILabel__set_text(levelLabel, (System_String_o *)skillNameLabel, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B48B19 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_CombineSkillMaster___, *(_QWORD *)&id);
...
LABEL_41:
        sub_1BDBADC(SelfUserGame, v13, v21);
...
LABEL_40:
  ...
  if ( v24 && !v20 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SelfUserGame = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8785/*"MSG_ABLED_SKILLUP"*/, 0LL);
    if ( !statusLb )
      goto LABEL_40;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A29DE8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A29D90;
}
