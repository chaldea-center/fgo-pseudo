...
LABEL_17:
    sub_1BAB678(skillIconComp, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9973 & 1) == 0 )
  {
    sub_1BAB41C(&Method_ServantSkillInfoIconComponent_OnClickSkill__, method);
    byte_4AB9973 = 1;
  }
  if ( this->fields.currentSkillId >= 1 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSkillInfoIconComponent_OnClickSkill__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_ServantSkillInfoIconComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9974 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_SkillMaster___, method);
    ...
    sub_1BAB41C(&Method_ServantSkillInfoIconComponent_OnClickSkillDetail__, v8);
  ...
  if ( this->fields.currentSkillId >= 1 )
  {
    ...
    if ( (*((_BYTE *)Method_ServantSkillInfoIconComponent_OnClickSkillDetail__ + 83) & 2) != 0 )
      v15 = (_QWORD *)sub_1BAB434(Method_ServantSkillInfoIconComponent_OnClickSkillDetail__);
    ...
    if ( Instance )
    {
      ...
      if ( Instance )
      {
        ...
        if ( Instance )
        {
          ...
          name = System_String__Concat_62059388(v20, (System_String_o *)StringLiteral_116/*" "*/, v26, 0LL);
          Empty = string_TypeInfo->static_fields->Empty;
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_SkillLvMaster___);
          if ( Instance )
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9970 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, *(_QWORD *)&idx);
    byte_4AB9970 = 1;
  }
  skillIconComp = this->fields.skillIconComp;
  ...
  if ( !skillIconComp )
    goto LABEL_17;
  SkillIconComponent__Set_38616648(skillIconComp, skillId, skillLv, 0LL);
...
LABEL_17:
    sub_1BAB678(skillIconComp, *(_QWORD *)&idx);
  }
LABEL_16:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9972 & 1) == 0 )
  {
    sub_1BAB41C(&LocalizationManager_TypeInfo, *(_QWORD *)&skillLv);
    sub_1BAB41C(&StringLiteral_8758/*"MSG_ABLED_SKILLUP"*/, v7);
...
LABEL_22:
    sub_1BAB678(skillIconSprite, *(_QWORD *)&skillLv);
  }
  if ( !skillIconSprite )
    goto LABEL_22;
  v12.fields.r = 1.0;
  ...
  if ( skillLv <= 9 && isEnableCombine )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    skillIconSprite = (UIWidget_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8758/*"MSG_ABLED_SKILLUP"*/, 0LL);
    if ( statusLb )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB996F & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_SkillMaster___, *(_QWORD *)&idx);
    sub_1BAB41C(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v19);
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, v20);
    sub_1BAB41C(&int_TypeInfo, v21);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v22);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v23);
    sub_1BAB41C(&ServantSkillStrengthStatus_TypeInfo, v24);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v25);
    sub_1BAB41C(&StringLiteral_5051/*"DISP_SKLL_LV"*/, v26);
    sub_1BAB41C(&StringLiteral_12170/*"SKILLCHARGETURN_TXT"*/, v27);
    byte_4AB996F = 1;
  }
  SkillChargeTime = 0;
  ...
  skillNameLabel = BaseMonoBehaviour__createObject_38621984((BaseMonoBehaviour_o *)this, PATH, transform, 0LL, 0LL);
  if ( !skillNameLabel )
    goto LABEL_30;
  ...
  *p_skillStrengthStatus = (struct ServantSkillStrengthStatus_o *)Component_object;
  ...
  skillNameLabel = System_String__Format_62062500(v39, v43, v47, 0LL);
  if ( !levelLabel )
    goto LABEL_30;
  UILabel__set_text(levelLabel, (System_String_o *)skillNameLabel, 0LL);
  skillNameLabel = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !skillNameLabel )
    goto LABEL_30;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  skillNameLabel = LocalizationManager__Get((System_String_o *)StringLiteral_12170/*"SKILLCHARGETURN_TXT"*/, 0LL);
  if ( !chargeTitleLb
  ...
  {
LABEL_30:
    sub_1BAB678(skillNameLabel, v28);
  }
...
// local variable allocation has failed, the output may be wrong!
void __fastcall ServantSkillInfoIconComponent__SetSkillInfo_45819616(
        ServantSkillInfoIconComponent_o *this,
        int32_t idx,
        System_String_o *skillName,
        int32_t skillId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9971 & 1) == 0 )
  {
    sub_1BAB41C(&int_TypeInfo, *(_QWORD *)&idx);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v15);
    sub_1BAB41C(&StringLiteral_2097/*"APPEND_SKILL_ICON_INFO_LV"*/, v16);
    byte_4AB9971 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_2097/*"APPEND_SKILL_ICON_INFO_LV"*/, 0LL);
  v30 = skillLv;
  ...
  skillNameLabel = (UILabel_o *)System_String__Format_62062500(v20, v24, v28, 0LL);
  if ( !levelLabel )
LABEL_10:
    sub_1BAB678(skillNameLabel, v17);
  UILabel__set_text(levelLabel, (System_String_o *)skillNameLabel, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9975 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_CombineSkillMaster___, *(_QWORD *)&id);
    sub_1BAB41C(&Method_DataManager_GetMasterData_ServantMaster___, v5);
    sub_1BAB41C(&Method_DataManager_GetMasterData_UserItemMaster___, v6);
    ...
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v10);
    sub_1BAB41C(&StringLiteral_8758/*"MSG_ABLED_SKILLUP"*/, v11);
    byte_4AB9975 = 1;
  }
  entity = 0LL;
  ...
  SelfUserGame = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !SelfUserGame )
    goto LABEL_36;
...
LABEL_36:
  ...
  if ( v24 && !v21 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    SelfUserGame = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_8758/*"MSG_ABLED_SKILLUP"*/, 0LL);
    if ( !statusLb )
      goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BAB678(noSelectMskImg, isShow);
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19F3B8C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19F3B34;
}
