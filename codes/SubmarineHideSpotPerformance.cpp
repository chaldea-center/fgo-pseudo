        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.spot, (int64_t)spot, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC465B & 1) == 0 )
  {
    sub_1C1ABD4(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4BC465B = 1;
  }
  v3 = sub_1C1AE20(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC465A & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_4BC465A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC465C & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
