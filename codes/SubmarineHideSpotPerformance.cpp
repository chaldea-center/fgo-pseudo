        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42135EB & 1) == 0 )
  {
    sub_B0D8A4(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_42135EB = 1;
  }
  v4 = sub_B0D974(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method, v2);
  SubmarineHideSpotPerformance__Execute_d__4___ctor((SubmarineHideSpotPerformance__Execute_d__4_o *)v4, 0, 0LL);
  if ( !v4 )
    sub_B0D97C(v5);
  *(_QWORD *)(v4 + 32) = this;
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42135EA & 1) == 0 )
  {
    ...
    sub_B0D8A4(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_42135EA = 1;
  }
  ...
  System_Action___ctor(v7, (Il2CppObject *)this, Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, 0LL);
  if ( !spot )
    sub_B0D97C(v8);
  SrcSpotBasePrefab__SetState(spot, 2, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_421172F & 1) == 0 )
  {
    ...
    sub_B0D8A4(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v5);
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_B0D8A8(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_B0D948(v5, v6);
}
