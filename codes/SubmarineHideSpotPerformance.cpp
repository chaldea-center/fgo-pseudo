        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57E67 & 1) == 0 )
  {
    sub_1B885B0(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
    byte_4A57E67 = 1;
  }
  v3 = sub_1B887FC(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57E66 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__);
    byte_4A57E66 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57E68 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
