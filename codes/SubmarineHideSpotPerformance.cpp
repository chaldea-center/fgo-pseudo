        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438A5B3 & 1) == 0 )
  {
    sub_B775C4(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
    byte_438A5B3 = 1;
  }
  v3 = sub_B77694(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438A5B2 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__);
    byte_438A5B2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438869F & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B775C8(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_B77668(v3, v4);
}
