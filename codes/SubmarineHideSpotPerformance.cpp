        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414EE & 1) == 0 )
  {
    sub_1BDB878(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4B414EE = 1;
  }
  v3 = sub_1BDBAC4(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B414ED & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_4B414ED = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414EF & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
