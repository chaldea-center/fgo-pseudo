        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.spot, (int32_t)spot, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB29AC & 1) == 0 )
  {
    sub_1BAB41C(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4AB29AC = 1;
  }
  v3 = sub_1BAB668(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB29AB & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_4AB29AB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB29AD & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
