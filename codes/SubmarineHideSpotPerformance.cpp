        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B12E18 & 1) == 0 )
  {
    sub_1BCA7E0(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method, v2);
    byte_4B12E18 = 1;
  }
  v5 = sub_1BCAA2C(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method, v2, v3);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B12E17 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v4, v5);
    byte_4B12E17 = 1;
  }
  ...
  System_Action___ctor(v10, (Il2CppObject *)this, Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, 0LL);
  if ( !spot )
    sub_1BCAA3C(v11, v12);
  SrcSpotBasePrefab__SetState(spot, 2, v10, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B12E19 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v5, v6);
  ...
  else
  {
    ...
    System_Func_bool____ctor(v12, _4__this, Method_SubmarineHideSpotPerformance__Execute_b__4_0__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v8 = sub_1BCA7F4(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__, v7);
  sub_1BCA908(v6, v8);
}
