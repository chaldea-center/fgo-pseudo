        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F96B & 1) == 0 )
  {
    sub_1C37058(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
    byte_4C3F96B = 1;
  }
  v3 = sub_1C372A4(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F96A & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__);
    byte_4C3F96A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F96C & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
