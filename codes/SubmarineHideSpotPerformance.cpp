        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2C8 & 1) == 0 )
  {
    sub_1C93AD4(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
    byte_4D2D2C8 = 1;
  }
  v3 = sub_1C93D20(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2C7 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__);
    byte_4D2D2C7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2C9 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C93AE8(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C93BFC(v3, v4);
}
