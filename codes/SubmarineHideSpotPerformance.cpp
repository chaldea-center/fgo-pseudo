        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.spot, (int32_t)spot, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C7A1 & 1) == 0 )
  {
    sub_1B715CC(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4A1C7A1 = 1;
  }
  v3 = sub_1B71818(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C7A0 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_4A1C7A0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C7A2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
  ...
  else
  {
    ...
    v8 = (System_Func_bool__o *)sub_1B71818(System_Func_bool__TypeInfo);
    System_Func_bool____ctor(v8, _4__this, Method_SubmarineHideSpotPerformance__Execute_b__4_0__, 0LL);
    v9 = (UnityEngine_WaitUntil_o *)sub_1B71818(UnityEngine_WaitUntil_TypeInfo);
    UnityEngine_WaitUntil___ctor(v9, v8, 0LL);
    this->fields.__2__current = (Il2CppObject *)v9;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.__2__current, (int32_t)v9, v10, v11);
    v12 = 1;
    result = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B715E0(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B716F4(v3, v4);
}
