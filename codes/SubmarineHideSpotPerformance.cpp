        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.spot, (int32_t)spot, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0593D & 1) == 0 )
  {
    sub_1B686D4(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4A0593D = 1;
  }
  v3 = sub_1B68920(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0593C & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_4A0593C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0593E & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
  ...
  else
  {
    ...
    v9 = (UnityEngine_WaitUntil_o *)sub_1B68920(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B686E8(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B687FC(v3, v4);
}
