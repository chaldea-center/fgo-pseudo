        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C53706 & 1) == 0 )
  {
    sub_1C3E564(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
    byte_4C53706 = 1;
  }
  v3 = sub_1C3E7B0(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C53705 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__);
    byte_4C53705 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C53707 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
