        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB836 & 1) == 0 )
  {
    sub_1B64A00(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_49FB836 = 1;
  }
  v3 = sub_1B64C4C(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FB835 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_49FB835 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB837 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64A14(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B64B28(v3, v4);
}
