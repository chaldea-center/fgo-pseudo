        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.spot, (int32_t)spot, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC0A & 1) == 0 )
  {
    sub_1B761C0(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4A2AC0A = 1;
  }
  v3 = sub_1B7640C(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC09 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_4A2AC09 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AC0B & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
  ...
  else
  {
    ...
    v9 = (UnityEngine_WaitUntil_o *)sub_1B7640C(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
