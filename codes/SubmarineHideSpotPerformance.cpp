        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9127 & 1) == 0 )
  {
    sub_1B640C8(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_49F9127 = 1;
  }
  v4 = sub_1B64314(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method, v2);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9126 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_49F9126 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9128 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v4);
  ...
  else
  {
    ...
    System_Func_bool____ctor(v9, _4__this, Method_SubmarineHideSpotPerformance__Execute_b__4_0__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_1B640DC(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1B641F0(v5, v6);
}
