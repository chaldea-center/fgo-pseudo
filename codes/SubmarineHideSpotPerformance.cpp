        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2C56 & 1) == 0 )
  {
    sub_1C6BA08(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
    byte_4CB2C56 = 1;
  }
  v3 = sub_1C6BC54(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB2C55 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__);
    byte_4CB2C55 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB2C57 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
