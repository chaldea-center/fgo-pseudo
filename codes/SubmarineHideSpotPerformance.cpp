        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.spot, (int32_t)spot, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA61 & 1) == 0 )
  {
    sub_1BC3008(&SubmarineHideSpotPerformance__Execute_d__4_TypeInfo, method);
    byte_4AFEA61 = 1;
  }
  v3 = sub_1BC3254(SubmarineHideSpotPerformance__Execute_d__4_TypeInfo);
...
void __fastcall SubmarineHideSpotPerformance__OnStart(SubmarineHideSpotPerformance_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA60 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_SubmarineHideSpotPerformance__OnStart_b__3_0__, v3);
    byte_4AFEA60 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA62 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_SubmarineHideSpotPerformance__Execute_b__4_0__, v3);
  ...
  else
  {
    ...
    v8 = (System_Func_bool__o *)sub_1BC3254(System_Func_bool__TypeInfo);
    System_Func_bool____ctor(v8, _4__this, Method_SubmarineHideSpotPerformance__Execute_b__4_0__, 0LL);
    v9 = (UnityEngine_WaitUntil_o *)sub_1BC3254(UnityEngine_WaitUntil_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_SubmarineHideSpotPerformance__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
