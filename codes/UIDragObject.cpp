void UIDragObject___ctor(UIDragObject_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.momentumAmount = xmmword_E93DD0;
...
LABEL_60:
  ...
  if ( UnityEngine_Object__op_Inequality(v34, 0, 0) )
  {
    ...
    if ( v5 )
    {
      ...
      v35 = (unsigned __int8)byte_5931940;
...
void UIDragObject__FindPanel(UIDragObject_o *this, const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.panelRegion, (int32_t)v11, v5, v6, v7, v8, v9, v10);
...
void UIDragObject__LateUpdate(UIDragObject_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(target, 0, 0) )
  {
    ...
    v7 = (unsigned __int8)byte_5931940;
    v8 = v5.n64_u32[1];
    ...
    *(float32x2_t *)&this->fields.mMomentum.fields.x = vsub_f32(*(float32x2_t *)&this->fields.mMomentum.fields.x, v5);
    ...
    v10 = v8;
    v11 = z;
    v31 = NGUIMath__SpringLerp_56160220(
    ...
    v13 = (unsigned __int8)byte_5931942;
          ...
          if ( v14 )
          {
            ...
            *(_DWORD *)(v14 + 96) = 2;
            if ( panelRegion )
            {
              ...
              UnityEngine_Camera__ScreenPointToRay_82985504(&v38, panelRegion, v41, 0);
              v39 = 0.0;
              v40 = v38;
              v37 = v38;
              if ( (sub_357A988(&this->fields.mPlane, &v37, &v39, 0) & 1) == 0 )
                return;
    ...
    if ( UnityEngine_Object__op_Inequality(target, 0, 0) )
    {
      ...
      if ( UnityEngine_Application__get_isPlaying(0) )
      {
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0, 0) )
        {
          ...
          sub_21FFBF4(p_contentRect, (int32_t)Component_object, v15, v16, v17, v18, v19, v20);
        }
      }
    }
  }
...
LABEL_44:
            ...
            v43.fields.z = z;
            v43.fields.w = w;
            v40 = UnityEngine_Quaternion__op_Multiply_83158396(v43, v41, 0);
            v31 = v40.fields.x;
            v32 = v40.fields.y;
            ...
            sub_357A878(&v39, 0, v31, v32, v34, v36, v37, v38);
        ...
        if ( panelRegion )
        {
          ...
          if ( panelRegion )
          {
            ...
            if ( v8[3].n64_u32[0] )
            {
              ...
              if ( !byte_5931940 )
              {
                panelRegion = (UIRect_o *)sub_21FFC50(&UnityEngine_Vector3_TypeInfo);
                byte_5931940 = 1;
              }
              v13 = 1;
              static_fields = UnityEngine_Vector3_TypeInfo->static_fields;
...
LABEL_27:
            sub_21FFED4(panelRegion);
          }
        }
      }
    }
LABEL_28:
    sub_21FFECC(panelRegion, v5);
  }
  if ( !panelRegion )
    goto LABEL_28;
