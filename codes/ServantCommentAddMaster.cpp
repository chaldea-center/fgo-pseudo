void ServantCommentAddMaster___ctor(ServantCommentAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CC7C83 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__);
    byte_4CC7C83 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    186,
    (const MethodInfo_340B614 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__);
}
    ...
    while ( (unsigned int)v21 < (unsigned int)v17 )
    {
      ...
      if ( ((unsigned __int8)EntitiyList & 1) == 0 )
      {
        ...
        else
        {
          ...
          v34 = LocalizationManager__Get((System_String_o *)StringLiteral_3717/*"COND_TYPE_AND_FLAVOR2"*/, 0);
          oldFriendShipRank = v36;
          v13 = System_String__Concat_64031724(v13, v34, 0);
        }
        EntitiyList = (ServantCommentAddEntity_o *)System_String__Concat_64031724(v13, ConditionText, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7C84 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Count__);
    sub_1C713B0(&Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Item__);
    sub_1C713B0(&Method_System_Collections_Generic_List_ServantCommentAddEntity__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__);
    sub_1C713B0(&Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo);
    byte_4CC7C84 = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_33A1C08 *)Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Count__);
  v11 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__);
  if ( Count >= 1 )
  {
    v12 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v12,
                                                                 (const MethodInfo_33A1C98 *)Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Item__);
      if ( list )
      {
        *(_QWORD *)&svtId = list;
          ...
          && LODWORD(list[1].klass) == priority )
        {
          ...
          else
          {
            ...
            sub_1C71354((GrandQuestFolderBoardItem_o *)(v22 + 4), svtId, v13, v14, v15, v16, v17, v18);
          }
        }
      }
      if ( Count == ++v12 )
...
LABEL_17:
  ...
  return (ServantCommentAddEntity_array *)System_Collections_Generic_List_object___ToArray(
                                            v11,
                                            (const MethodInfo_3812270 *)Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7C81 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__GetEntity__);
    byte_4CC7C81 = 1;
  }
  ...
  return (ServantCommentAddEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_340D938 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7C82 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__);
    byte_4CC7C82 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_340D984 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__);
}