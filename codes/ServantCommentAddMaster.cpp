void __fastcall ServantCommentAddMaster___ctor(ServantCommentAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A20149 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__, method);
    byte_4A20149 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    182,
    (const MethodInfo_30F8A78 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2014C & 1) == 0 )
  {
    sub_1B715CC(&LocalizationManager_TypeInfo, textType);
    sub_1B715CC(&ServantCommentEntity_TypeInfo, v13);
    sub_1B715CC(&StringLiteral_3770/*"COND_TYPE_AND_FLAVOR2"*/, v14);
    ...
    while ( (unsigned int)v24 < (unsigned int)v20 )
    {
      ...
      if ( ((unsigned __int8)EntitiyList & 1) == 0 )
      {
        ...
        else
        {
          ...
          v37 = LocalizationManager__Get((System_String_o *)StringLiteral_3770/*"COND_TYPE_AND_FLAVOR2"*/, 0LL);
          oldFriendShipRank = v39;
          v16 = System_String__Concat_61505504(v16, v37, 0LL);
        }
        EntitiyList = (ServantCommentAddEntity_o *)System_String__Concat_61505504(v16, ConditionText, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2014A & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_ServantCommentAddEntity__Add__, v10);
    sub_1B715CC(&Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__, v11);
    sub_1B715CC(&Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__, v12);
    sub_1B715CC(&System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo, v13);
    sub_1B715CC(&ServantCommentAddEntity_TypeInfo, v14);
    byte_4A2014A = 1;
  }
  ...
  v17 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__);
  if ( Count >= 1 )
  {
    v18 = 0;
    while ( 1 )
        ...
        *(_QWORD *)&svtId = list;
          ...
          && LODWORD(list[1].klass) == priority )
        {
          ...
          else
          {
            ...
            sub_1B71570((ServantStatusBattleListViewItem_o *)(v25 + 4), svtId, v19, v20);
          }
        }
      }
      if ( Count == ++v18 )
...
LABEL_19:
  ...
  return (ServantCommentAddEntity_array *)System_Collections_Generic_List_object___ToArray(
                                            v17,
                                            (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (ServantCommentAddEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_30F8AB8 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2014B & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantCommentAddEntity_TypeInfo, v12);
    byte_4A2014B = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20148 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__, entity);
    byte_4A20148 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30F8B08 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__);
}