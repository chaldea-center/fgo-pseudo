void ServantCommentAddMaster___ctor(ServantCommentAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C43841 & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__);
    byte_4C43841 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    186,
    (const MethodInfo_33A3834 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__);
}
    ...
    while ( (unsigned int)v20 < (unsigned int)v16 )
    {
      ...
      if ( ((unsigned __int8)EntitiyList & 1) == 0 )
      {
        ...
        else
        {
          ...
          oldFriendShipRank = v35;
          v13 = System_String__Concat_63561656(v13, v33, 0);
        }
        EntitiyList = (ServantCommentAddEntity_o *)System_String__Concat_63561656(v13, ConditionText, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C43842 & 1) == 0 )
  {
    sub_1C37058(&Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Count__);
    sub_1C37058(&Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Item__);
    sub_1C37058(&Method_System_Collections_Generic_List_ServantCommentAddEntity__Add__);
    sub_1C37058(&Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__);
    sub_1C37058(&Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__);
    sub_1C37058(&System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo);
    byte_4C43842 = 1;
  }
  ...
  Count = System_Collections_ObjectModel_Collection_object___get_Count(
            list,
            (const MethodInfo_333A510 *)Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Count__);
  v11 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_37A27F0 *)Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__);
  if ( Count >= 1 )
  {
    v12 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v12,
                                                                 (const MethodInfo_333A5A0 *)Method_System_Collections_ObjectModel_Collection_ServantCommentAddEntity__get_Item__);
      if ( list )
      {
        v15 = list;
...
LABEL_17:
  ...
  return (ServantCommentAddEntity_array *)System_Collections_Generic_List_object___ToArray(
                                            v11,
                                            (const MethodInfo_37A4B7C *)Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C4383F & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__GetEntity__);
    byte_4C4383F = 1;
  }
  ...
  return (ServantCommentAddEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_33A5B58 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C43840 & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__);
    byte_4C43840 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_33A5BA4 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__);
}