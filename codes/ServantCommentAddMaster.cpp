void __fastcall ServantCommentAddMaster___ctor(ServantCommentAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E5BB & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__, method);
    byte_4A2E5BB = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    182,
    (const MethodInfo_30FFA98 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E5BE & 1) == 0 )
  {
    sub_1B761C0(&LocalizationManager_TypeInfo, textType);
    sub_1B761C0(&ServantCommentEntity_TypeInfo, v13);
    sub_1B761C0(&StringLiteral_3787/*"COND_TYPE_AND_FLAVOR2"*/, v14);
    ...
    while ( (unsigned int)v24 < (unsigned int)v20 )
    {
      ...
      if ( ((unsigned __int8)EntitiyList & 1) == 0 )
      {
        ...
        else
        {
          ...
          v37 = LocalizationManager__Get((System_String_o *)StringLiteral_3787/*"COND_TYPE_AND_FLAVOR2"*/, 0LL);
          oldFriendShipRank = v39;
          v16 = System_String__Concat_61535060(v16, v37, 0LL);
        }
        EntitiyList = (ServantCommentAddEntity_o *)System_String__Concat_61535060(v16, ConditionText, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E5BC & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_ServantCommentAddEntity__Add__, v10);
    sub_1B761C0(&Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__, v11);
    sub_1B761C0(&Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__, v12);
    sub_1B761C0(&System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo, v13);
    sub_1B761C0(&ServantCommentAddEntity_TypeInfo, v14);
    byte_4A2E5BC = 1;
  }
  ...
  v17 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_ServantCommentAddEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_ServantCommentAddEntity___ctor__);
  if ( Count >= 1 )
  {
    v18 = 0;
    while ( 1 )
        ...
        *(_QWORD *)&svtId = list;
          ...
          && LODWORD(list[1].klass) == priority )
        {
          ...
          else
          {
            ...
            sub_1B76164((ServantStatusBattleListViewItem_o *)(v25 + 4), svtId, v19, v20);
          }
        }
      }
      if ( Count == ++v18 )
...
LABEL_19:
  ...
  return (ServantCommentAddEntity_array *)System_Collections_Generic_List_object___ToArray(
                                            v17,
                                            (const MethodInfo_34D912C *)Method_System_Collections_Generic_List_ServantCommentAddEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (ServantCommentAddEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_30FFAD8 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E5BD & 1) == 0 )
  {
    ...
    sub_1B761C0(&ServantCommentAddEntity_TypeInfo, v12);
    byte_4A2E5BD = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2E5BA & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__, entity);
    byte_4A2E5BA = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30FFB28 *)Method_DataMasterBase_ServantCommentAddMaster__ServantCommentAddEntity__string__TryGetEntity__);
}