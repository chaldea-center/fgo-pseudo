  ...
  *(_QWORD *)&v12.fields.b = 0LL;
  if ( item )
  {
    if ( item->fields.isAppointment )
    {
      ...
      teamNameLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6603/*"FORTIFICATION_APPOINTMENT"*/, 0LL);
      if ( !appointmentLabel )
        goto LABEL_31;
          ...
          if ( teamNameLabel )
          {
            ...
            if ( teamNameLabel )
            {
              ...
              if ( teamNameLabel )
              {
                ...
                AtlasManager__SetEventUI_39058000(eventId, lineUpeer, (System_String_o *)StringLiteral_17449/*"bg_white"*/, 0LL);
                AtlasManager__SetEventUI_39058000(
                  item->fields.eventId,
                  this->fields.lineBottom,
                  (System_String_o *)StringLiteral_17449/*"bg_white"*/,
                  0LL);
...
LABEL_31:
    sub_1C1AE30(teamNameLabel, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBA51 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v5);
    sub_1C1ABD4(&StringLiteral_6619/*"FORTIFICATION_GET_POINT_TEXT"*/, v6);
  ...
  if ( item )
  {
    if ( item->fields.isCanNotSelect && item->fields.isHeroineSvt )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      maskObject = LocalizationManager__Get((System_String_o *)StringLiteral_11704/*"SELECT_CANNOT"*/, 0LL);
      if ( statusLabel )
      {
...
LABEL_22:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_6619/*"FORTIFICATION_GET_POINT_TEXT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBA50 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_20494/*"icon_guest"*/, v8);
    byte_4BCBA50 = 1;
  }
  if ( !item || !mode )
    return;
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_39058000(eventId, guestSprite, (System_String_o *)StringLiteral_20494/*"icon_guest"*/, 0LL);
  ...
  if ( item->fields.isNpc )
  {
    ...
    if ( !lockImg )
      goto LABEL_66;
    UIIconLabel__Set_39433952((UIIconLabel_o *)lockImg, 2, userServantEntity->fields.lv, 0, 0, 0LL, 0, 0, 0, 0LL);
  }
...
LABEL_41:
  ...
  if ( UnityEngine_Object__op_Inequality(fortificationInfoRootObj, 0LL, 0LL) )
  {
    if ( !byte_4BC2141 )
    {
      sub_1C1ABD4(&UnityEngine_Vector3_TypeInfo, item);
      byte_4BC2141 = 1;
    }
    lockImg = (UnityEngine_Component_o *)this->fields.removeImg;
    if ( !lockImg )
