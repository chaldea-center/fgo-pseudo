  ...
  *(_QWORD *)&v10.fields.b = 0;
  if ( item )
  {
    if ( item->fields.isAppointment )
    {
      ...
      teamNameLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6477/*"FORTIFICATION_APPOINTMENT"*/, 0);
      if ( !appointmentLabel )
        goto LABEL_31;
          ...
          if ( teamNameLabel )
          {
            ...
            if ( teamNameLabel )
            {
              ...
              if ( teamNameLabel )
              {
                ...
                AtlasManager__SetEventUI_40507600(eventId, lineUpeer, (System_String_o *)StringLiteral_17142/*"bg_white"*/, 0);
                AtlasManager__SetEventUI_40507600(
                  item->fields.eventId,
                  this->fields.lineBottom,
                  (System_String_o *)StringLiteral_17142/*"bg_white"*/,
                  0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31D20 & 1) == 0 )
  {
    ...
    sub_1C32C20(&LocalizationManager_TypeInfo);
    sub_1C32C20(&StringLiteral_6493/*"FORTIFICATION_GET_POINT_TEXT"*/);
...
LABEL_22:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = LocalizationManager__Get((System_String_o *)StringLiteral_6493/*"FORTIFICATION_GET_POINT_TEXT"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_40507600(eventId, guestSprite, (System_String_o *)StringLiteral_20203/*"icon_guest"*/, 0);
  ...
  if ( item->fields.isNpc )
  {
    ...
    if ( !lockImg )
      goto LABEL_72;
    UIIconLabel__Set_41010828((UIIconLabel_o *)lockImg, 2, userServantEntity->fields.lv, 0, 0, 0, 0, 0, 0, 0, 0);
  }
