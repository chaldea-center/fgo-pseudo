        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C965 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_17107/*"bg_white"*/, v7);
    byte_4A0C965 = 1;
  }
  ...
  *(_QWORD *)&v13.fields.b = 0LL;
  if ( item )
  {
    if ( item->fields.isAppointment )
    {
      ...
      teamNameLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6420/*"FORTIFICATION_APPOINTMENT"*/, 0LL);
      if ( !appointmentLabel )
        goto LABEL_31;
          ...
          if ( teamNameLabel )
          {
            ...
            if ( teamNameLabel )
            {
              ...
              if ( teamNameLabel )
              {
                ...
                AtlasManager__SetEventUI_37606672(eventId, lineUpeer, (System_String_o *)StringLiteral_17107/*"bg_white"*/, 0LL);
...
LABEL_31:
    sub_1B68930(teamNameLabel, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C964 & 1) == 0 )
  {
    ...
    sub_1B686D4(&LocalizationManager_TypeInfo, v5);
    sub_1B686D4(&StringLiteral_6436/*"FORTIFICATION_GET_POINT_TEXT"*/, v6);
  ...
  if ( item )
  {
    if ( item->fields.isCanNotSelect && item->fields.isHeroineSvt )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      maskObject = LocalizationManager__Get((System_String_o *)StringLiteral_11446/*"SELECT_CANNOT"*/, 0LL);
      if ( statusLabel )
      {
...
LABEL_22:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_6436/*"FORTIFICATION_GET_POINT_TEXT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C963 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_20085/*"icon_guest"*/, v8);
    byte_4A0C963 = 1;
  }
  if ( !item || !mode )
    return;
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_37606672(eventId, guestSprite, (System_String_o *)StringLiteral_20085/*"icon_guest"*/, 0LL);
  ...
  if ( item->fields.isNpc )
  {
    ...
    if ( !lockImg )
      goto LABEL_72;
    UIIconLabel__Set_37983136((UIIconLabel_o *)lockImg, 2, userServantEntity->fields.lv, 0, 0, 0LL, 0, 0, 0, 0LL);
  }
...
LABEL_47:
  ...
  if ( UnityEngine_Object__op_Inequality(fortificationInfoRootObj, 0LL, 0LL) )
  {
    if ( !byte_4A03901 )
    {
      sub_1B686D4(&UnityEngine_Vector3_TypeInfo, item);
      byte_4A03901 = 1;
    }
    lockImg = (UnityEngine_Component_o *)this->fields.removeImg;
    if ( !lockImg )
