        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23801 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_6425/*"FORTIFICATION_APPOINTMENT"*/, v6);
    sub_1B715CC(&StringLiteral_17122/*"bg_white"*/, v7);
    byte_4A23801 = 1;
  }
  ...
  *(_QWORD *)&v13.fields.b = 0LL;
  if ( item )
  {
    if ( item->fields.isAppointment )
    {
      ...
      teamNameLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6425/*"FORTIFICATION_APPOINTMENT"*/, 0LL);
      if ( !appointmentLabel )
        goto LABEL_31;
          ...
          if ( teamNameLabel )
          {
            ...
            if ( teamNameLabel )
            {
              ...
              if ( teamNameLabel )
              {
                ...
                AtlasManager__SetEventUI_37654552(eventId, lineUpeer, (System_String_o *)StringLiteral_17122/*"bg_white"*/, 0LL);
                AtlasManager__SetEventUI_37654552(
                  item->fields.eventId,
                  this->fields.lineBottom,
                  (System_String_o *)StringLiteral_17122/*"bg_white"*/,
                  0LL);
...
LABEL_31:
    sub_1B71828(teamNameLabel, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23800 & 1) == 0 )
  {
    ...
    sub_1B715CC(&LocalizationManager_TypeInfo, v5);
    sub_1B715CC(&StringLiteral_6441/*"FORTIFICATION_GET_POINT_TEXT"*/, v6);
  ...
  if ( item )
  {
    if ( item->fields.isCanNotSelect && item->fields.isHeroineSvt )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      maskObject = LocalizationManager__Get((System_String_o *)StringLiteral_11455/*"SELECT_CANNOT"*/, 0LL);
      if ( statusLabel )
      {
...
LABEL_22:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_6441/*"FORTIFICATION_GET_POINT_TEXT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A237FF & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_20103/*"icon_guest"*/, v8);
    byte_4A237FF = 1;
  }
  if ( !item || !mode )
    return;
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_37654552(eventId, guestSprite, (System_String_o *)StringLiteral_20103/*"icon_guest"*/, 0LL);
  ...
  if ( item->fields.isNpc )
  {
    ...
    if ( !lockImg )
      goto LABEL_72;
    UIIconLabel__Set_38031016((UIIconLabel_o *)lockImg, 2, userServantEntity->fields.lv, 0, 0, 0LL, 0, 0, 0, 0LL);
  }
...
LABEL_47:
  ...
  if ( UnityEngine_Object__op_Inequality(fortificationInfoRootObj, 0LL, 0LL) )
  {
    if ( !byte_4A1A751 )
    {
      sub_1B715CC(&UnityEngine_Vector3_TypeInfo, item);
      byte_4A1A751 = 1;
    }
    lockImg = (UnityEngine_Component_o *)this->fields.removeImg;
    if ( !lockImg )
