  ...
  *(_QWORD *)&v10.fields.b = 0;
  if ( item )
  {
    if ( item->fields.isAppointment )
    {
      ...
      teamNameLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6524/*"FORTIFICATION_APPOINTMENT"*/, 0);
      if ( !appointmentLabel )
        goto LABEL_31;
          ...
          if ( teamNameLabel )
          {
            ...
            if ( teamNameLabel )
            {
              ...
              if ( teamNameLabel )
              {
                ...
                AtlasManager__SetEventUI_41749752(eventId, lineUpeer, (System_String_o *)StringLiteral_17327/*"bg_white"*/, 0);
                AtlasManager__SetEventUI_41749752(
                  item->fields.eventId,
                  this->fields.lineBottom,
                  (System_String_o *)StringLiteral_17327/*"bg_white"*/,
                  0);
...
LABEL_31:
    sub_1CE6958(teamNameLabel, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEB81 & 1) == 0 )
  {
    ...
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_6540/*"FORTIFICATION_GET_POINT_TEXT"*/);
  ...
  if ( item )
  {
    if ( item->fields.isCanNotSelect && item->fields.isHeroineSvt )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      maskObject = LocalizationManager__Get((System_String_o *)StringLiteral_11643/*"SELECT_CANNOT"*/, 0);
      if ( statusLabel )
      {
...
LABEL_22:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = LocalizationManager__Get((System_String_o *)StringLiteral_6540/*"FORTIFICATION_GET_POINT_TEXT"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_41749752(eventId, guestSprite, (System_String_o *)StringLiteral_20499/*"icon_guest"*/, 0);
  ...
  if ( item->fields.isNpc )
  {
    ...
    if ( !lockImg )
      goto LABEL_72;
    UIIconLabel__Set_42257736((UIIconLabel_o *)lockImg, 2, userServantEntity->fields.lv, 0, 0, 0, 0, 0, 0, 0, 0);
  }
