void UserQuestRecordEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E0596D & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_24623/*"turnMaxDamage"*/);
    sub_1CE6700(&StringLiteral_21463/*"knockdownNum"*/);
    sub_1CE6700(&StringLiteral_24518/*"totalDamageToAliveEnemy"*/);
    byte_4E0596D = 1;
  }
  UserQuestRecordEntity_TypeInfo->static_fields->KEY_RECORD_TURN_MAX_DAMAGE = (struct System_String_o *)StringLiteral_24623/*"turnMaxDamage"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)UserQuestRecordEntity_TypeInfo->static_fields,
    StringLiteral_24623/*"turnMaxDamage"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_21463/*"knockdownNum"*/;
  static_fields = UserQuestRecordEntity_TypeInfo->static_fields;
  static_fields->KEY_RECORD_KNOCKDOWN_NUM = (struct System_String_o *)StringLiteral_21463/*"knockdownNum"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&static_fields->KEY_RECORD_KNOCKDOWN_NUM, v7, v9, v10, v11, v12, v13, v14);
  v15 = StringLiteral_24518/*"totalDamageToAliveEnemy"*/;
  v16 = UserQuestRecordEntity_TypeInfo->static_fields;
  v16->KEY_RECORD_TOTAL_DAMAGE_TO_ALIVE_ENEMY = (struct System_String_o *)StringLiteral_24518/*"totalDamageToAliveEnemy"*/;
  sub_1CE66A4(
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6958(recordValueJson, v7);
  }
