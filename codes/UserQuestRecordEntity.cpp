void UserQuestRecordEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2D7DD & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_24469/*"turnMaxDamage"*/);
    sub_1C94098(&StringLiteral_21333/*"knockdownNum"*/);
    sub_1C94098(&StringLiteral_24366/*"totalDamageToAliveEnemy"*/);
    byte_4D2D7DD = 1;
  }
  UserQuestRecordEntity_TypeInfo->static_fields->KEY_RECORD_TURN_MAX_DAMAGE = (struct System_String_o *)StringLiteral_24469/*"turnMaxDamage"*/;
  sub_1C9403C(
    (GrandQuestFolderBoardItem_o *)UserQuestRecordEntity_TypeInfo->static_fields,
    StringLiteral_24469/*"turnMaxDamage"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_21333/*"knockdownNum"*/;
  static_fields = UserQuestRecordEntity_TypeInfo->static_fields;
  static_fields->KEY_RECORD_KNOCKDOWN_NUM = (struct System_String_o *)StringLiteral_21333/*"knockdownNum"*/;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&static_fields->KEY_RECORD_KNOCKDOWN_NUM, v7, v9, v10, v11, v12, v13, v14);
  v15 = StringLiteral_24366/*"totalDamageToAliveEnemy"*/;
  v16 = UserQuestRecordEntity_TypeInfo->static_fields;
  v16->KEY_RECORD_TOTAL_DAMAGE_TO_ALIVE_ENEMY = (struct System_String_o *)StringLiteral_24366/*"totalDamageToAliveEnemy"*/;
  sub_1C9403C(
...
void UserQuestRecordEntity___ctor_43905200(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.questId = *(_QWORD *)&original->fields.questId;
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)p_deckJson, (int32_t)deckJson, v16, v17, v18, v19, v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C942F0(recordValueJson, v7);
  }
