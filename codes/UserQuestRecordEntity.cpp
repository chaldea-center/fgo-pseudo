void __fastcall UserQuestRecordEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FF275 & 1) == 0 )
  {
    sub_1B64870(&UserQuestRecordEntity_TypeInfo, v1);
    sub_1B64870(&StringLiteral_23996/*"turnMaxDamage"*/, v4);
    sub_1B64870(&StringLiteral_20926/*"knockdownNum"*/, v5);
    sub_1B64870(&StringLiteral_23894/*"totalDamageToAliveEnemy"*/, v6);
    byte_49FF275 = 1;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->KEY_RECORD_KNOCKDOWN_NUM, v7, v9, v10);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v12->KEY_RECORD_TOTAL_DAMAGE_TO_ALIVE_ENEMY, v11, v13, v14);
}
...
void __fastcall UserQuestRecordEntity___ctor_39830152(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF270 & 1) == 0 )
  {
    sub_1B64870(&Method_DataEntityBase_string___ctor__, original);
    byte_49FF270 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  *(_QWORD *)&this->fields.questId = *(_QWORD *)&original->fields.questId;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.recordValueJson, (int32_t)recordValueJson, v7, v8);
  deckJson = original->fields.deckJson;
  this->fields.deckJson = deckJson;
  p_deckJson = &this->fields.deckJson;
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_deckJson, (int32_t)deckJson, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF271 & 1) == 0 )
  {
    sub_1B64870(&UserQuestRecordEntity_TypeInfo, method);
    byte_49FF271 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64ACC(recordValueJson, v8);
  }
