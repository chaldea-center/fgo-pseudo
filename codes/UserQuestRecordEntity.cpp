...
void __fastcall UserQuestRecordEntity___ctor_21371996(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F80F1 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataEntityBase_string___ctor__, original);
    byte_40F80F1 = 1;
  }
  DataEntityBase_string____ctor(
    (DataEntityBase_string__o *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F80F2 & 1) == 0 )
  {
    sub_B16FFC(&UserQuestRecordEntity_TypeInfo, method);
    byte_40F80F2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !recordValueJson
    || (Item = System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
                 (System_Collections_Generic_Dictionary_Type__IStoreExtension__o *)recordValueJson,
                 (System_Type_o *)key,
  ...
  v11 = (const MethodInfo *)sub_B173C8(Item);
