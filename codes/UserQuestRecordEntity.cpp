void __fastcall UserQuestRecordEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC88AF & 1) == 0 )
  {
    sub_1C1ABD4(&UserQuestRecordEntity_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_24505/*"turnMaxDamage"*/, v8);
    sub_1C1ABD4(&StringLiteral_21365/*"knockdownNum"*/, v9);
    sub_1C1ABD4(&StringLiteral_24401/*"totalDamageToAliveEnemy"*/, v10);
    byte_4BC88AF = 1;
  }
  UserQuestRecordEntity_TypeInfo->static_fields->KEY_RECORD_TURN_MAX_DAMAGE = (struct System_String_o *)StringLiteral_24505/*"turnMaxDamage"*/;
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)UserQuestRecordEntity_TypeInfo->static_fields,
    StringLiteral_24505/*"turnMaxDamage"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v11 = StringLiteral_21365/*"knockdownNum"*/;
  static_fields = UserQuestRecordEntity_TypeInfo->static_fields;
  static_fields->KEY_RECORD_KNOCKDOWN_NUM = (struct System_String_o *)StringLiteral_21365/*"knockdownNum"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&static_fields->KEY_RECORD_KNOCKDOWN_NUM, v11, v13, v14, v15, v16, v17, v18);
  v19 = StringLiteral_24401/*"totalDamageToAliveEnemy"*/;
  v20 = UserQuestRecordEntity_TypeInfo->static_fields;
  v20->KEY_RECORD_TOTAL_DAMAGE_TO_ALIVE_ENEMY = (struct System_String_o *)StringLiteral_24401/*"totalDamageToAliveEnemy"*/;
  sub_1C1AB78(
...
void __fastcall UserQuestRecordEntity___ctor_41380536(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC88AA & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_string___ctor__, original);
    byte_4BC88AA = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  *(_QWORD *)&this->fields.questId = *(_QWORD *)&original->fields.questId;
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)p_deckJson, (int64_t)deckJson, v16, v17, v18, v19, v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC88AB & 1) == 0 )
  {
    sub_1C1ABD4(&UserQuestRecordEntity_TypeInfo, method);
    byte_4BC88AB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1AE30(recordValueJson, v8);
  }
