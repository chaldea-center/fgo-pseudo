void __fastcall DialogMessageEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1F948 & 1) == 0 )
  {
    sub_1B715CC(&DialogMessageEntity_TypeInfo, v1);
    byte_4A1F948 = 1;
  }
...
int32_t __fastcall DialogMessageEntity__GetCommonReleaseId(DialogMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1F943 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_18120/*"commonReleaseId"*/, method);
    byte_4A1F943 = 1;
  }
  return DialogMessageEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_18120/*"commonReleaseId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F93C & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DialogMessageEntity___c__GetTargets_b__14_0__, v5);
    sub_1B715CC(&DialogMessageEntity___c_TypeInfo, v6);
      ...
      if ( v11 )
      {
        ...
        if ( v11 )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Converter_object__int__o *)sub_1B71818(System_Converter_string__int__TypeInfo);
            ...
            sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v24, v25);
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F942 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_23988/*"transitionParam"*/, method);
    sub_1B715CC(&StringLiteral_1/*""*/, v4);
    byte_4A1F942 = 1;
  }
  ScriptStr = DialogMessageEntity__GetScriptStr(
                this,
                (System_String_o *)StringLiteral_23988/*"transitionParam"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                v2);
  if ( !ScriptStr )
    sub_1B71828(0LL, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F93F & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMaster_CommonReleaseMaster___, *(_QWORD *)&ex1);
  ...
  if ( !Master_object )
    sub_1B71828(CommonReleaseId, v13);
...
bool __fastcall DialogMessageEntity__IsOpenTime(DialogMessageEntity_o *this, int64_t now, const MethodInfo *method)
{
  ...
  if ( (byte_4A1F93D & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMaster_CommonReleaseMaster___, now);
    this = (DialogMessageEntity_o *)sub_1B715CC(&DataManager_TypeInfo, v6);
    byte_4A1F93D = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1F93E & 1) == 0 )
  {
    sub_1B715CC(&NetworkManager_TypeInfo, start);
    byte_4A1F93E = 1;
  }
  if ( !now )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F940 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Action_Invoke__, callback);
  ...
  if ( imageIds && *(_QWORD *)&imageIds->max_length )
  {
    ...
    if ( v10 )
    {
      CommonUI__OpenTutorialImageDialog_30426084(v10, v9, -1, 0, v11, 0LL, 0LL, 0LL);
      return;
    }
LABEL_9:
    sub_1B71828(v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F941 & 1) == 0 )
  {
    sub_1B715CC(&CommonConfirmDialog_ClickDelegate_TypeInfo, decideTxt);
    sub_1B715CC(&DialogMessageEntity_TypeInfo, v9);
    sub_1B715CC(&LocalizationManager_TypeInfo, v10);
    sub_1B715CC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v11);
    sub_1B715CC(&Method_DialogMessageEntity___c__DisplayClass22_0__OpenConfirmDecideDialog_b__0__, v12);
    sub_1B715CC(&DialogMessageEntity___c__DisplayClass22_0_TypeInfo, v13);
    sub_1B715CC(&StringLiteral_3738/*"COMMON_CONFIRM_CLOSE"*/, v14);
    byte_4A1F941 = 1;
  }
  v15 = sub_1B71818(DialogMessageEntity___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v15, 0LL);
  if ( !v15 )
    goto LABEL_10;
  *(_QWORD *)(v15 + 16) = decideCallback;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v15 + 16), (int32_t)decideCallback, v18, v19);
  *(_QWORD *)(v15 + 24) = callback;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v15 + 24), (int32_t)callback, v20, v21);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  title = this->fields.title;
  message = this->fields.message;
  ...
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_3738/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
...
void __fastcall DialogMessageEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1F949 & 1) == 0 )
  {
    sub_1B715CC(&DialogMessageEntity___c_TypeInfo, v1);
    byte_4A1F949 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(DialogMessageEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  DialogMessageEntity___c_TypeInfo->static_fields->__9 = (struct DialogMessageEntity___c_o *)v2;
  sub_1B71570((ServantStatusBattleListViewItem_o *)DialogMessageEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F94A & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DialogMessageEntity___c__DisplayClass22_1__OpenConfirmDecideDialog_b__1__, v6);
    sub_1B715CC(&DialogMessageEntity___c__DisplayClass22_1_TypeInfo, v7);
    byte_4A1F94A = 1;
  }
  v8 = sub_1B71818(DialogMessageEntity___c__DisplayClass22_1_TypeInfo);
