...
int32_t DialogMessageEntity__GetCommonReleaseId(DialogMessageEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18191/*"commonReleaseId"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C56BB4 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_21708/*"msgFontSize"*/);
    byte_4C56BB4 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21708/*"msgFontSize"*/, defaultValue, 0);
}
...
System_Nullable_float__o DialogMessageEntity__GetMsgPosY(DialogMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56BB5 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_21709/*"msgPosY"*/);
    byte_4C56BB5 = 1;
  }
  if ( EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_21709/*"msgPosY"*/, 0) )
  {
    FloatValue = EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_21709/*"msgPosY"*/, 0.0, 0);
    v4 = (System_Nullable_float__o)&v6;
    v6 = 0;
    System_Nullable_float____ctor(v4, FloatValue, (const MethodInfo_38DD2E0 *)Method_System_Nullable_float___ctor__);
    return v6;
  }
  else
  {
...
int32_t DialogMessageEntity__GetMsgSpacingY(DialogMessageEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C56BB6 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_21710/*"msgSpacingY"*/);
    byte_4C56BB6 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21710/*"msgSpacingY"*/, 0, 0);
}
...
System_Int32_array_array *DialogMessageEntity__GetTargets(DialogMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C56BAB & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_DialogMessageEntity___c__GetTargets_b__14_0__);
    sub_1C3E564(&DialogMessageEntity___c_TypeInfo);
      ...
      if ( v4 )
      {
        ...
        if ( v4 )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Converter_object__int__o *)sub_1C3E7B0(System_Converter_string__int__TypeInfo);
            ...
            sub_1C3E508((CGThumbnailListItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v17, v18);
          }
...
int32_t DialogMessageEntity__GetTitleFontSize(DialogMessageEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24120/*"titleFontSize"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !Master_object )
    sub_1C3E7C0(CommonReleaseId, v12);
...
bool DialogMessageEntity__IsOpenTime(DialogMessageEntity_o *this, int64_t now, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&Method_DataManager_GetMaster_CommonReleaseMaster___);
    this = (DialogMessageEntity_o *)sub_1C3E564(&DataManager_TypeInfo);
    byte_4C56BAC = 1;
  }
...
void DialogMessageEntity__Open(DialogMessageEntity_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( imageIds && imageIds->max_length )
  {
    ...
    if ( v8 )
    {
      CommonUI__OpenTutorialImageDialog_31264708(v8, v7, -1, 0, v9, 0, 0, 0, 0);
      return;
    }
LABEL_9:
    sub_1C3E7C0(messagePosY, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56BB0 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&Method_DialogMessageEntity___c__DisplayClass22_0__OpenConfirmDecideDialog_b__0__);
    sub_1C3E564(&DialogMessageEntity___c__DisplayClass22_0_TypeInfo);
    sub_1C3E564(&StringLiteral_3685/*"COMMON_CONFIRM_CLOSE"*/);
    byte_4C56BB0 = 1;
  }
  v9 = sub_1C3E7B0(DialogMessageEntity___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v9, 0);
  if ( !v9 )
    goto LABEL_10;
  *(_QWORD *)(v9 + 16) = decideCallback;
  sub_1C3E508((CGThumbnailListItem_o *)(v9 + 16), (int32_t)decideCallback, v12, v13);
...
void DialogMessageEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C3E7B0(DialogMessageEntity___c_TypeInfo);
  System_Object___ctor(v1, 0);
  DialogMessageEntity___c_TypeInfo->static_fields->__9 = (struct DialogMessageEntity___c_o *)v1;
  sub_1C3E508((CGThumbnailListItem_o *)DialogMessageEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56BB9 & 1) == 0 )
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C3E564(&Method_DialogMessageEntity___c__DisplayClass22_1__OpenConfirmDecideDialog_b__1__);
    sub_1C3E564(&DialogMessageEntity___c__DisplayClass22_1_TypeInfo);
    byte_4C56BB9 = 1;
  }
  v5 = sub_1C3E7B0(DialogMessageEntity___c__DisplayClass22_1_TypeInfo);
