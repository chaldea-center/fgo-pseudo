void __fastcall DialogMessageEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDB5 & 1) == 0 )
  {
    sub_1B761C0(&DialogMessageEntity_TypeInfo, v1);
    byte_4A2DDB5 = 1;
  }
...
int32_t __fastcall DialogMessageEntity__GetCommonReleaseId(DialogMessageEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDB0 & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_18164/*"commonReleaseId"*/, method);
    byte_4A2DDB0 = 1;
  }
  return DialogMessageEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_18164/*"commonReleaseId"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDA9 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DialogMessageEntity___c__GetTargets_b__14_0__, v5);
    sub_1B761C0(&DialogMessageEntity___c_TypeInfo, v6);
      ...
      if ( v11 )
      {
        ...
        if ( v11 )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Converter_object__int__o *)sub_1B7640C(System_Converter_string__int__TypeInfo);
            ...
            sub_1B76164((ServantStatusBattleListViewItem_o *)&static_fields->__9__14_0, (int32_t)_9__14_0, v24, v25);
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDAF & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_24034/*"transitionParam"*/, method);
    sub_1B761C0(&StringLiteral_1/*""*/, v4);
    byte_4A2DDAF = 1;
  }
  ScriptStr = DialogMessageEntity__GetScriptStr(
                this,
                (System_String_o *)StringLiteral_24034/*"transitionParam"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                v2);
  if ( !ScriptStr )
    sub_1B7641C(0LL, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDAC & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_CommonReleaseMaster___, *(_QWORD *)&ex1);
  ...
  if ( !Master_object )
    sub_1B7641C(CommonReleaseId, v13);
...
bool __fastcall DialogMessageEntity__IsOpenTime(DialogMessageEntity_o *this, int64_t now, const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDAA & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_CommonReleaseMaster___, now);
    this = (DialogMessageEntity_o *)sub_1B761C0(&DataManager_TypeInfo, v6);
    byte_4A2DDAA = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2DDAB & 1) == 0 )
  {
    sub_1B761C0(&NetworkManager_TypeInfo, start);
    byte_4A2DDAB = 1;
  }
  if ( !now )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDAD & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Action_Invoke__, callback);
  ...
  if ( imageIds && *(_QWORD *)&imageIds->max_length )
  {
    ...
    if ( v10 )
    {
      CommonUI__OpenTutorialImageDialog_30445536(v10, v9, -1, 0, v11, 0LL, 0LL, 0LL);
      return;
    }
LABEL_9:
    sub_1B7641C(v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDAE & 1) == 0 )
  {
    sub_1B761C0(&CommonConfirmDialog_ClickDelegate_TypeInfo, decideTxt);
    sub_1B761C0(&DialogMessageEntity_TypeInfo, v9);
    sub_1B761C0(&LocalizationManager_TypeInfo, v10);
    sub_1B761C0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v11);
    sub_1B761C0(&Method_DialogMessageEntity___c__DisplayClass22_0__OpenConfirmDecideDialog_b__0__, v12);
    sub_1B761C0(&DialogMessageEntity___c__DisplayClass22_0_TypeInfo, v13);
    sub_1B761C0(&StringLiteral_3755/*"COMMON_CONFIRM_CLOSE"*/, v14);
    byte_4A2DDAE = 1;
  }
  v15 = sub_1B7640C(DialogMessageEntity___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v15, 0LL);
  if ( !v15 )
    goto LABEL_10;
  *(_QWORD *)(v15 + 16) = decideCallback;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v15 + 16), (int32_t)decideCallback, v18, v19);
  *(_QWORD *)(v15 + 24) = callback;
  sub_1B76164((ServantStatusBattleListViewItem_o *)(v15 + 24), (int32_t)callback, v20, v21);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  title = this->fields.title;
  message = this->fields.message;
  ...
  v26 = LocalizationManager__Get((System_String_o *)StringLiteral_3755/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
...
void __fastcall DialogMessageEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDB6 & 1) == 0 )
  {
    sub_1B761C0(&DialogMessageEntity___c_TypeInfo, v1);
    byte_4A2DDB6 = 1;
  }
  v2 = (Il2CppObject *)sub_1B7640C(DialogMessageEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  DialogMessageEntity___c_TypeInfo->static_fields->__9 = (struct DialogMessageEntity___c_o *)v2;
  sub_1B76164((ServantStatusBattleListViewItem_o *)DialogMessageEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DDB7 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DialogMessageEntity___c__DisplayClass22_1__OpenConfirmDecideDialog_b__1__, v6);
    sub_1B761C0(&DialogMessageEntity___c__DisplayClass22_1_TypeInfo, v7);
    byte_4A2DDB7 = 1;
  }
  v8 = sub_1B7640C(DialogMessageEntity___c__DisplayClass22_1_TypeInfo);
