...
int32_t __fastcall DialogMessageEntity__GetCommonReleaseId(DialogMessageEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C21DB8 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_18525/*"effect/BitEffect/bit_buster{0:00}"*/, method);
    byte_4C21DB8 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18525/*"effect/BitEffect/bit_buster{0:00}"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C21DBA & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_21980/*"op_Modulus"*/, *(_QWORD *)&defaultValue);
    byte_4C21DBA = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21980/*"op_Modulus"*/, defaultValue, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DBB & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_21981/*"op_Multiply"*/, v3);
    byte_4C21DBB = 1;
  }
  if ( EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_21981/*"op_Multiply"*/, 0LL) )
  {
    FloatValue = EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_21981/*"op_Multiply"*/, 0.0, 0LL);
    v7 = (System_Nullable_float__o)&v6;
    v6 = 0LL;
    System_Nullable_float____ctor(v7, FloatValue, (const MethodInfo_37AA644 *)Method_System_Nullable_float___ctor__);
    return v6;
  }
  else
  {
...
int32_t __fastcall DialogMessageEntity__GetMsgSpacingY(DialogMessageEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C21DBC & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_21982/*"op_OnesComplement"*/, method);
    byte_4C21DBC = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21982/*"op_OnesComplement"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DB1 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DialogMessageEntity___c__GetTargets_b__14_0__, v5);
    sub_1C3B764(&DialogMessageEntity___c_TypeInfo, v6);
      ...
      if ( v11 )
      {
        ...
        if ( v11 )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Converter_object__int__o *)sub_1C3B9B0(System_Converter_string__int__TypeInfo);
...
int32_t __fastcall DialogMessageEntity__GetTitleFontSize(DialogMessageEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C21DB9 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_24459/*"x-ms-cp932"*/, method);
    byte_4C21DB9 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24459/*"x-ms-cp932"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DB7 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_24549/*"yyyyMMddHHmmss'Z'"*/, v3);
    byte_4C21DB7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DB4 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_CommonReleaseMaster___, *(_QWORD *)&ex1);
  ...
  if ( !Master_object )
    sub_1C3B9C0(CommonReleaseId, v13);
...
bool __fastcall DialogMessageEntity__IsOpenTime(DialogMessageEntity_o *this, int64_t now, const MethodInfo *method)
{
  ...
  if ( (byte_4C21DB2 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMaster_CommonReleaseMaster___, now);
    this = (DialogMessageEntity_o *)sub_1C3B764(&DataManager_TypeInfo, v6);
    byte_4C21DB2 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4C21DB3 & 1) == 0 )
  {
    sub_1C3B764(&NetworkManager_TypeInfo, start);
    byte_4C21DB3 = 1;
  }
  if ( !now )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DB5 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Action_Invoke__, callback);
  ...
  if ( imageIds && *(_QWORD *)&imageIds->max_length )
  {
    ...
    if ( v10 )
    {
      CommonUI__OpenTutorialImageDialog_31258368(v10, v9, -1, 0, v11, 0LL, 0LL, 0LL);
      return;
    }
LABEL_9:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1C3B9C0)(messagePosY, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DB6 & 1) == 0 )
  {
    sub_1C3B764(&CommonConfirmDialog_ClickDelegate_TypeInfo, decideTxt);
    sub_1C3B764(&LocalizationManager_TypeInfo, v9);
    sub_1C3B764(&Method_System_Nullable_float__GetValueOrDefault__, v10);
    sub_1C3B764(&Method_System_Nullable_float__get_HasValue__, v11);
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1C3B764(&Method_DialogMessageEntity___c__DisplayClass22_0__OpenConfirmDecideDialog_b__0__, v13);
    sub_1C3B764(&DialogMessageEntity___c__DisplayClass22_0_TypeInfo, v14);
    sub_1C3B764(&StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, v15);
    byte_4C21DB6 = 1;
  }
  v16 = sub_1C3B9B0(DialogMessageEntity___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v16, 0LL);
  if ( !v16 )
    goto LABEL_10;
  *(_QWORD *)(v16 + 16) = decideCallback;
  sub_1C3B708((PartyOrganizationUtility_o *)(v16 + 16), (int64_t)decideCallback, v19, v20, v21, v22, v23, v24);
  *(_QWORD *)(v16 + 24) = callback;
  sub_1C3B708((PartyOrganizationUtility_o *)(v16 + 24), (int64_t)callback, v25, v26, v27, v28, v29, v30);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  title = this->fields.title;
  message = this->fields.message;
  ...
  v35 = LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, 0LL);
  v36 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C3B9B0(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
void __fastcall DialogMessageEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C21DBE & 1) == 0 )
  {
    sub_1C3B764(&DialogMessageEntity___c_TypeInfo, v1);
    byte_4C21DBE = 1;
  }
  v2 = (Il2CppObject *)sub_1C3B9B0(DialogMessageEntity___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DBF & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DialogMessageEntity___c__DisplayClass22_1__OpenConfirmDecideDialog_b__1__, v6);
    sub_1C3B764(&DialogMessageEntity___c__DisplayClass22_1_TypeInfo, v7);
    byte_4C21DBF = 1;
  }
  v8 = sub_1C3B9B0(DialogMessageEntity___c__DisplayClass22_1_TypeInfo);
