...
int32_t __fastcall DialogMessageEntity__GetCommonReleaseId(DialogMessageEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B37008 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_18382/*"commonReleaseId"*/, method);
    byte_4B37008 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18382/*"commonReleaseId"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B3700A & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_21811/*"msgFontSize"*/, *(_QWORD *)&defaultValue);
    byte_4B3700A = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21811/*"msgFontSize"*/, defaultValue, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3700B & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_21812/*"msgPosY"*/, v3);
    byte_4B3700B = 1;
  }
  if ( EntityScriptUtil__ScriptHasKey(this->fields.script, (System_String_o *)StringLiteral_21812/*"msgPosY"*/, 0LL) )
  {
    FloatValue = EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_21812/*"msgPosY"*/, 0.0, 0LL);
    v7 = (System_Nullable_float__o)&v6;
    v6 = 0LL;
    System_Nullable_float____ctor(v7, FloatValue, (const MethodInfo_36DFDF8 *)Method_System_Nullable_float___ctor__);
    return v6;
  }
  else
  {
...
int32_t __fastcall DialogMessageEntity__GetMsgSpacingY(DialogMessageEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B3700C & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_21813/*"msgSpacingY"*/, method);
    byte_4B3700C = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21813/*"msgSpacingY"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37001 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_DialogMessageEntity___c__GetTargets_b__14_0__, v5);
    sub_1BD3458(&DialogMessageEntity___c_TypeInfo, v6);
      ...
      if ( v11 )
      {
        ...
        if ( v11 )
        {
          ...
          if ( !_9__14_0 )
          {
            ...
            _9__14_0 = (System_Converter_object__int__o *)sub_1BD36A4(System_Converter_string__int__TypeInfo);
...
int32_t __fastcall DialogMessageEntity__GetTitleFontSize(DialogMessageEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B37009 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_24244/*"titleFontSize"*/, method);
    byte_4B37009 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24244/*"titleFontSize"*/, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37007 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_24334/*"transitionParam"*/, v3);
    byte_4B37007 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37004 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_CommonReleaseMaster___, *(_QWORD *)&ex1);
  ...
  if ( !Master_object )
    sub_1BD36B4(CommonReleaseId, v13);
...
bool __fastcall DialogMessageEntity__IsOpenTime(DialogMessageEntity_o *this, int64_t now, const MethodInfo *method)
{
  ...
  if ( (byte_4B37002 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_CommonReleaseMaster___, now);
    this = (DialogMessageEntity_o *)sub_1BD3458(&DataManager_TypeInfo, v6);
    byte_4B37002 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4B37003 & 1) == 0 )
  {
    sub_1BD3458(&NetworkManager_TypeInfo, start);
    byte_4B37003 = 1;
  }
  if ( !now )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37005 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Action_Invoke__, callback);
  ...
  if ( imageIds && *(_QWORD *)&imageIds->max_length )
  {
    ...
    if ( v10 )
    {
      CommonUI__OpenTutorialImageDialog_30828908(v10, v9, -1, 0, v11, 0LL, 0LL, 0LL);
      return;
    }
LABEL_9:
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1BD36B4)(messagePosY, v13);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B37006 & 1) == 0 )
  {
    sub_1BD3458(&CommonConfirmDialog_ClickDelegate_TypeInfo, decideTxt);
    sub_1BD3458(&LocalizationManager_TypeInfo, v9);
    sub_1BD3458(&Method_System_Nullable_float__GetValueOrDefault__, v10);
    sub_1BD3458(&Method_System_Nullable_float__get_HasValue__, v11);
    sub_1BD3458(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1BD3458(&Method_DialogMessageEntity___c__DisplayClass22_0__OpenConfirmDecideDialog_b__0__, v13);
    sub_1BD3458(&DialogMessageEntity___c__DisplayClass22_0_TypeInfo, v14);
    sub_1BD3458(&StringLiteral_3794/*"COMMON_CONFIRM_CLOSE"*/, v15);
    byte_4B37006 = 1;
  }
  v16 = sub_1BD36A4(DialogMessageEntity___c__DisplayClass22_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v16, 0LL);
  if ( !v16 )
    goto LABEL_10;
  *(_QWORD *)(v16 + 16) = decideCallback;
  sub_1BD33FC((PartyOrganizationUtility_o *)(v16 + 16), (int64_t)decideCallback, v19, v20, v21, v22, v23, v24);
  *(_QWORD *)(v16 + 24) = callback;
  sub_1BD33FC((PartyOrganizationUtility_o *)(v16 + 24), (int64_t)callback, v25, v26, v27, v28, v29, v30);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  title = this->fields.title;
  message = this->fields.message;
  ...
  v35 = LocalizationManager__Get((System_String_o *)StringLiteral_3794/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
...
void __fastcall DialogMessageEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3700E & 1) == 0 )
  {
    sub_1BD3458(&DialogMessageEntity___c_TypeInfo, v1);
    byte_4B3700E = 1;
  }
  v2 = (Il2CppObject *)sub_1BD36A4(DialogMessageEntity___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3700F & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_DialogMessageEntity___c__DisplayClass22_1__OpenConfirmDecideDialog_b__1__, v6);
    sub_1BD3458(&DialogMessageEntity___c__DisplayClass22_1_TypeInfo, v7);
    byte_4B3700F = 1;
  }
  v8 = sub_1BD36A4(DialogMessageEntity___c__DisplayClass22_1_TypeInfo);
