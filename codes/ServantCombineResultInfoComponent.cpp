        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352FCA & 1) == 0 )
  {
    ...
    sub_B70694(&Method_ServantCombineResultInfoComponent_EndClose__);
    byte_4352FCA = 1;
  }
  ...
  ServantCombineResultInfoComponent__Close_27462124(this, v4, v5);
}


void __fastcall ServantCombineResultInfoComponent__Close_27462124(
        ServantCombineResultInfoComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352FC7 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_ServantCombineResultInfoComponent_EndOpen__);
    sub_B70694(&SoundManager_TypeInfo);
    sub_B70694(&StringLiteral_8476/*"LEVEL_INFO"*/);
    sub_B70694(&StringLiteral_8473/*"LEVELUP_NOTICE_TITLE"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( infoData->fields.oldLv < infoData->fields.currentLv )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8473/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
      if ( !levelUpTitleLb )
        goto LABEL_28;
    ...
    v17 = LocalizationManager__Get((System_String_o *)StringLiteral_8476/*"LEVEL_INFO"*/, 0LL);
    oldLv = infoData->fields.oldLv;
    v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &oldLv, v18);
    gameObject = (UnityEngine_GameObject_o *)System_String__Format(v17, v19, 0LL);
    if ( befLevelLb )
    {
      ...
      if ( currentLevelLb )
      {
        ...
        if ( currentHpLb )
        {
          ...
          v23 = LocalizationManager__Get((System_String_o *)StringLiteral_7367/*"INCREMENT_SVTLEVEL"*/, 0LL);
          increHpVal = infoData->fields.increHpVal;
          v25 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &increHpVal, v24);
          gameObject = (UnityEngine_GameObject_o *)System_String__Format(v23, v25, 0LL);
          if ( increHpLb )
          {
            ...
            if ( currentAtkLb )
            {
              ...
              v28 = LocalizationManager__Get((System_String_o *)StringLiteral_7367/*"INCREMENT_SVTLEVEL"*/, 0LL);
              increAtkVal = infoData->fields.increAtkVal;
              v30 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &increAtkVal, v29);
              gameObject = (UnityEngine_GameObject_o *)System_String__Format(v28, v30, 0LL);
              if ( increAtkLb )
              {
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_B70630(
      ...
      v20,
      v21);
    ServantCombineResultInfoComponent__setCenter(this, v22);
    gameObject = this->fields.resultInfoGrid;
    if ( !gameObject )
      goto LABEL_23;
    v23 = *((float *)gameObject + 11);
    ...
    if ( size >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !gameObject )
          break;
        v30 = v25->fields._items->m_Items[v28];
        transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)gameObject, 0LL);
        gameObject = BaseMonoBehaviour__createObject((BaseMonoBehaviour_o *)this, v30, transform, 0LL, 0LL);
        if ( !gameObject )
          break;
        UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, 1, 0LL);
        v25 = *p_resInfoList;
...
LABEL_19:
    ...
    if ( !gameObject )
      goto LABEL_23;
    v33.fields.z = this->fields.center.fields.z;
    v33.fields.y = (float)((float)(v23 * 0.5) * (float)size) + -25.0;
    v33.fields.x = v27;
    ...
    System_Action___ctor(v32, (Il2CppObject *)this, Method_ServantCombineResultInfoComponent_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_15:
    sub_B7076C(resultInfoGrid, method);
  }
  ...
  if ( childCount >= 1 )
  {
    ...
    sub_B70630((BattleServantConfConponent_o *)&this->fields.resInfoList, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
