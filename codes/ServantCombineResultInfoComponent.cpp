        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A522DF & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_ServantCombineResultInfoComponent_EndClose__, v3);
    byte_4A522DF = 1;
  }
  ...
  ServantCombineResultInfoComponent__Close_46503704(this, v5, v6);
}


void __fastcall ServantCombineResultInfoComponent__Close_46503704(
        ServantCombineResultInfoComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A522E0 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_ServantCombineResultInfoComponent_EndClose__, v4);
    byte_4A522E0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A522DC & 1) == 0 )
  {
    sub_1B863B8(&System_Action_TypeInfo, infoData);
    sub_1B863B8(&int_TypeInfo, v7);
    sub_1B863B8(&LocalizationManager_TypeInfo, v8);
    sub_1B863B8(&Method_ServantCombineResultInfoComponent_EndOpen__, v9);
    sub_1B863B8(&Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__, v10);
    sub_1B863B8(&StringLiteral_8111/*"LEVEL_INFO"*/, v11);
    sub_1B863B8(&StringLiteral_8108/*"LEVELUP_NOTICE_TITLE"*/, v12);
    sub_1B863B8(&StringLiteral_7296/*"INCREMENT_SVTLEVEL"*/, v13);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.openCallBack, (int32_t)callback, v17, v18);
    ...
    if ( infoData->fields.oldLv < infoData->fields.currentLv )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8108/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
      if ( !levelUpTitleLb )
        goto LABEL_25;
      ...
      if ( (*((_BYTE *)Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__ + 83) & 2) != 0 )
        v20 = (_QWORD *)sub_1B863D0(Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v23 = LocalizationManager__Get((System_String_o *)StringLiteral_8111/*"LEVEL_INFO"*/, 0LL);
    ...
    if ( befLevelLb )
    {
      ...
      if ( currentLevelLb )
      {
        ...
        if ( currentHpLb )
        {
          ...
          v31 = LocalizationManager__Get((System_String_o *)StringLiteral_7296/*"INCREMENT_SVTLEVEL"*/, 0LL);
          ...
          if ( increHpLb )
          {
            ...
            if ( currentAtkLb )
            {
              ...
              v38 = LocalizationManager__Get((System_String_o *)StringLiteral_7296/*"INCREMENT_SVTLEVEL"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A522DB & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_ServantCombineResultInfoComponent_EndOpen__, v9);
    sub_1B863B8(&Method_ServantCombineResultInfoComponent_OpenResultInfo__, v10);
    byte_4A522DB = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_ServantCombineResultInfoComponent_OpenResultInfo__ + 83) & 2) != 0 )
      v11 = (_QWORD *)sub_1B863D0(Method_ServantCombineResultInfoComponent_OpenResultInfo__);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.resInfoList, (int32_t)resInfo, v16, v17);
    this->fields.openCallBack = callback;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.openCallBack, (int32_t)callback, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_14:
    sub_1B86614(resultInfoGrid, method);
  }
  ...
  if ( childCount >= 1 )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.resInfoList, 0, v7, v8);
  }
}
