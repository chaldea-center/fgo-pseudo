        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E41 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_ServantCombineResultInfoComponent_EndClose__, v3);
    byte_4A01E41 = 1;
  }
  ...
  ServantCombineResultInfoComponent__Close_44728068(this, v5, v6);
}


void __fastcall ServantCombineResultInfoComponent__Close_44728068(
        ServantCombineResultInfoComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E42 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_ServantCombineResultInfoComponent_EndClose__, v4);
    byte_4A01E42 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E3E & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, infoData);
    sub_1B64870(&int_TypeInfo, v7);
    sub_1B64870(&LocalizationManager_TypeInfo, v8);
    sub_1B64870(&Method_ServantCombineResultInfoComponent_EndOpen__, v9);
    sub_1B64870(&Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__, v10);
    sub_1B64870(&StringLiteral_8199/*"LEVEL_INFO"*/, v11);
    sub_1B64870(&StringLiteral_8196/*"LEVELUP_NOTICE_TITLE"*/, v12);
    sub_1B64870(&StringLiteral_7319/*"INCREMENT_SVTLEVEL"*/, v13);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.openCallBack, (int32_t)callback, v17, v18);
    ...
    if ( infoData->fields.oldLv < infoData->fields.currentLv )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8196/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
      if ( !levelUpTitleLb )
        goto LABEL_25;
      ...
      if ( (*((_BYTE *)Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__ + 83) & 2) != 0 )
        v20 = (_QWORD *)sub_1B64888(Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v23 = LocalizationManager__Get((System_String_o *)StringLiteral_8199/*"LEVEL_INFO"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01E3D & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_ServantCombineResultInfoComponent_EndOpen__, v9);
    sub_1B64870(&Method_ServantCombineResultInfoComponent_OpenResultInfo__, v10);
    byte_4A01E3D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_ServantCombineResultInfoComponent_OpenResultInfo__ + 83) & 2) != 0 )
      v11 = (_QWORD *)sub_1B64888(Method_ServantCombineResultInfoComponent_OpenResultInfo__);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.resInfoList, (int32_t)resInfo, v16, v17);
    this->fields.openCallBack = callback;
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.openCallBack, (int32_t)callback, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_14:
    sub_1B64ACC(resultInfoGrid, method);
  }
  ...
  if ( childCount >= 1 )
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.resInfoList, 0, v7, v8);
  }
}
