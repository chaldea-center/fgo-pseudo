        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EB28 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_ServantCombineResultInfoComponent_EndClose__);
    byte_4A5EB28 = 1;
  }
  ...
  ServantCombineResultInfoComponent__Close_45094876(this, v4, v5);
}


void __fastcall ServantCombineResultInfoComponent__Close_45094876(
        ServantCombineResultInfoComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EB25 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_ServantCombineResultInfoComponent_EndOpen__);
    sub_1B885B0(&Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__);
    sub_1B885B0(&StringLiteral_8236/*"LEVEL_INFO"*/);
    sub_1B885B0(&StringLiteral_8233/*"LEVELUP_NOTICE_TITLE"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.openCallBack, (int32_t)callback, v9, v10);
    ...
    if ( infoData->fields.oldLv < infoData->fields.currentLv )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8233/*"LEVELUP_NOTICE_TITLE"*/, 0LL);
      if ( !levelUpTitleLb )
        goto LABEL_25;
      ...
      if ( (*((_BYTE *)Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__ + 83) & 2) != 0 )
        v12 = (_QWORD *)sub_1B885C8(Method_ServantCombineResultInfoComponent_OpenLevelUpInfo__);
      v13 = (System_Reflection_MethodBase_o *)sub_1B88594(v12, v12[4]);
      OverwriteAssetSoundName__PlaySystemSe(v13, 5, 0LL);
    }
    befLevelLb = this->fields.befLevelLb;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v15 = LocalizationManager__Get((System_String_o *)StringLiteral_8236/*"LEVEL_INFO"*/, 0LL);
    oldLv = infoData->fields.oldLv;
    v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &oldLv, v16, v17, v18);
    gameObject = (UnityEngine_GameObject_o *)System_String__Format(v15, v19, 0LL);
    if ( befLevelLb )
    {
      ...
      if ( currentLevelLb )
      {
        ...
        if ( currentHpLb )
        {
          ...
          v23 = LocalizationManager__Get((System_String_o *)StringLiteral_7349/*"INCREMENT_SVTLEVEL"*/, 0LL);
          ...
          if ( increHpLb )
          {
            ...
            if ( currentAtkLb )
            {
              ...
              v30 = LocalizationManager__Get((System_String_o *)StringLiteral_7349/*"INCREMENT_SVTLEVEL"*/, 0LL);
              increAtkVal = infoData->fields.increAtkVal;
              v34 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &increAtkVal, v31, v32, v33);
              gameObject = (UnityEngine_GameObject_o *)System_String__Format(v30, v34, 0LL);
              if ( increAtkLb )
              {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5EB24 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_ServantCombineResultInfoComponent_EndOpen__);
    sub_1B885B0(&Method_ServantCombineResultInfoComponent_OpenResultInfo__);
    byte_4A5EB24 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_ServantCombineResultInfoComponent_OpenResultInfo__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1B885C8(Method_ServantCombineResultInfoComponent_OpenResultInfo__);
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.resInfoList, (int32_t)resInfo, v12, v13);
    this->fields.openCallBack = callback;
    ...
    while ( v22 != v20 )
    {
      ...
      if ( this->fields.resultInfoGrid )
      {
        ...
        gameObject = BaseMonoBehaviour__createObject((BaseMonoBehaviour_o *)this, v23, transform, 0LL, 0LL);
        if ( gameObject )
        {
          UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, 1, 0LL);
          gameObject = *p_resInfoList;
...
LABEL_20:
    ...
    System_Action___ctor(v26, (Il2CppObject *)this, Method_ServantCombineResultInfoComponent_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_14:
    sub_1B8880C(resultInfoGrid, method);
  }
  ...
  if ( childCount >= 1 )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.resInfoList, 0, v7, v8);
  }
}
