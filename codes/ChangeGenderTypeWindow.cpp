...
void __fastcall ChangeGenderTypeWindow__Close(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  ChangeGenderTypeWindow__Close_32165792(this, 0LL, v2);
}


void __fastcall ChangeGenderTypeWindow__Close_32165792(
        ChangeGenderTypeWindow_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D280 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ChangeGenderTypeWindow_EndClose__, v5);
    byte_4C1D280 = 1;
  }
...
void __fastcall ChangeGenderTypeWindow__OnClickFemale(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  v3 = !System_Int32__Equals_64174048((_DWORD)this + 152, 2, 0LL);
...
void __fastcall ChangeGenderTypeWindow__OnClickMale(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  v3 = !System_Int32__Equals_64174048((_DWORD)this + 152, 1, 0LL);
  ChangeGenderTypeWindow__Callback(this, v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D27F & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, *(_QWORD *)&currentType);
    sub_1C3B764(&Method_ChangeGenderTypeWindow_EndOpen__, v7);
    sub_1C3B764(&LocalizationManager_TypeInfo, v8);
    sub_1C3B764(&StringLiteral_8682/*"MapGimmickEffect_GappolyPiece_3"*/, v9);
    sub_1C3B764(&StringLiteral_6528/*"Faze_Tactical"*/, v10);
    sub_1C3B764(&StringLiteral_3471/*"CLICK_WAVE_BANNER"*/, v11);
    sub_1C3B764(&StringLiteral_3472/*"CLOSE"*/, v12);
    byte_4C1D27F = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3472/*"CLOSE"*/, 0LL);
  if ( !titleLb )
    goto LABEL_11;
  UILabel__set_text(titleLb, (System_String_o *)gameObject, 0LL);
  inputInfoLb = this->fields.inputInfoLb;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3471/*"CLICK_WAVE_BANNER"*/, 0LL);
  if ( !inputInfoLb
    || (UILabel__set_text(inputInfoLb, (System_String_o *)gameObject, 0LL),
        femaleTxt = this->fields.femaleTxt,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6528/*"Faze_Tactical"*/, 0LL),
        !femaleTxt)
    || (UILabel__set_text(femaleTxt, (System_String_o *)gameObject, 0LL),
        maleTxt = this->fields.maleTxt,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8682/*"MapGimmickEffect_GappolyPiece_3"*/, 0LL),
        !maleTxt) )
  {
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D27D & 1) == 0 )
  {
    sub_1C3B764(&ChangeGenderTypeWindow_CallbackFunc_TypeInfo, value);
    byte_4C1D27D = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ChangeGenderTypeWindow_o *)sub_1C3BC80(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A75428;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A753D0;
}
