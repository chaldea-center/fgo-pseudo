...
void __fastcall ChangeGenderTypeWindow__Close(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  ChangeGenderTypeWindow__Close_30882720(this, 0LL, v2);
}


void __fastcall ChangeGenderTypeWindow__Close_30882720(
        ChangeGenderTypeWindow_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A042C7 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_ChangeGenderTypeWindow_EndClose__, v5);
    byte_4A042C7 = 1;
  }
...
void __fastcall ChangeGenderTypeWindow__OnClickFemale(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  v3 = !System_Int32__Equals_62224576((_DWORD)this + 144, 2, 0LL);
...
void __fastcall ChangeGenderTypeWindow__OnClickMale(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  v3 = !System_Int32__Equals_62224576((_DWORD)this + 144, 1, 0LL);
  ChangeGenderTypeWindow__Callback(this, v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A042C6 & 1) == 0 )
  {
    sub_1B686D4(&System_Action_TypeInfo, *(_QWORD *)&currentType);
    sub_1B686D4(&Method_ChangeGenderTypeWindow_EndOpen__, v7);
    sub_1B686D4(&LocalizationManager_TypeInfo, v8);
    sub_1B686D4(&StringLiteral_8470/*"MALE_TEXT"*/, v9);
    sub_1B686D4(&StringLiteral_6337/*"FEMALE_TEXT"*/, v10);
    sub_1B686D4(&StringLiteral_3410/*"CHANGE_GENDER_INFO"*/, v11);
    sub_1B686D4(&StringLiteral_3411/*"CHANGE_GENDER_TITLE"*/, v12);
    byte_4A042C6 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3411/*"CHANGE_GENDER_TITLE"*/, 0LL);
  if ( !titleLb )
    goto LABEL_11;
  UILabel__set_text(titleLb, (System_String_o *)gameObject, 0LL);
  inputInfoLb = this->fields.inputInfoLb;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3410/*"CHANGE_GENDER_INFO"*/, 0LL);
  if ( !inputInfoLb
    || (UILabel__set_text(inputInfoLb, (System_String_o *)gameObject, 0LL),
        femaleTxt = this->fields.femaleTxt,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6337/*"FEMALE_TEXT"*/, 0LL),
        !femaleTxt)
    || (UILabel__set_text(femaleTxt, (System_String_o *)gameObject, 0LL),
        maleTxt = this->fields.maleTxt,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8470/*"MALE_TEXT"*/, 0LL),
        !maleTxt) )
  {
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A042C4 & 1) == 0 )
  {
    sub_1B686D4(&ChangeGenderTypeWindow_CallbackFunc_TypeInfo, value);
    byte_4A042C4 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ChangeGenderTypeWindow_o *)sub_1B68BF0(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A96A0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A9648;
}
