...
void __fastcall ChangeGenderTypeWindow__Close(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  ChangeGenderTypeWindow__Close_31140532(this, 0LL, v2);
}


void __fastcall ChangeGenderTypeWindow__Close_31140532(
        ChangeGenderTypeWindow_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B468 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_ChangeGenderTypeWindow_EndClose__, v5);
    byte_4A6B468 = 1;
  }
...
void __fastcall ChangeGenderTypeWindow__OnClickFemale(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  v3 = !System_Int32__Equals_62592200((_DWORD)this + 144, 2, 0LL);
...
void __fastcall ChangeGenderTypeWindow__OnClickMale(ChangeGenderTypeWindow_o *this, const MethodInfo *method)
{
  ...
  v3 = !System_Int32__Equals_62592200((_DWORD)this + 144, 1, 0LL);
  ChangeGenderTypeWindow__Callback(this, v3, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B467 & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, *(_QWORD *)&currentType);
    sub_1B90010(&Method_ChangeGenderTypeWindow_EndOpen__, v7);
    sub_1B90010(&LocalizationManager_TypeInfo, v8);
    sub_1B90010(&StringLiteral_8509/*"MALE_TEXT"*/, v9);
    sub_1B90010(&StringLiteral_6364/*"FEMALE_TEXT"*/, v10);
    sub_1B90010(&StringLiteral_3435/*"CHANGE_GENDER_INFO"*/, v11);
    sub_1B90010(&StringLiteral_3436/*"CHANGE_GENDER_TITLE"*/, v12);
    byte_4A6B467 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3436/*"CHANGE_GENDER_TITLE"*/, 0LL);
  if ( !titleLb )
    goto LABEL_11;
  UILabel__set_text(titleLb, (System_String_o *)gameObject, 0LL);
  inputInfoLb = this->fields.inputInfoLb;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3435/*"CHANGE_GENDER_INFO"*/, 0LL);
  if ( !inputInfoLb
    || (UILabel__set_text(inputInfoLb, (System_String_o *)gameObject, 0LL),
        femaleTxt = this->fields.femaleTxt,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6364/*"FEMALE_TEXT"*/, 0LL),
        !femaleTxt)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B465 & 1) == 0 )
  {
    sub_1B90010(&ChangeGenderTypeWindow_CallbackFunc_TypeInfo, value);
    byte_4A6B465 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ChangeGenderTypeWindow_o *)sub_1B9052C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CECAC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CEC54;
}
