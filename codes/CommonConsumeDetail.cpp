        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6E6D & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_3689/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/);
    sub_1C713B0(&StringLiteral_3693/*"COMMON_CONSUME_INFO_SEPARATOR"*/);
    sub_1C713B0(&StringLiteral_3692/*"COMMON_CONSUME_INFO_IF_LACKING"*/);
    byte_4CC6E6D = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v3 = LocalizationManager__Get((System_String_o *)StringLiteral_3689/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/, 0);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_3691/*"COMMON_CONSUME_INFO_IF_ENOUGH"*/, 0);
  v5 = LocalizationManager__Get((System_String_o *)StringLiteral_3692/*"COMMON_CONSUME_INFO_IF_LACKING"*/, 0);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3693/*"COMMON_CONSUME_INFO_SEPARATOR"*/, 0);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v8 = (Il2CppObject *)System_String__Format_64073032(v16, Name_k__BackingField, v17, 0);
      if ( !v7 )
        break;
...
LABEL_19:
  ...
  return System_String__Concat_64031724(v3, v30, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6E6C & 1) == 0 )
  {
    sub_1C713B0(&CommonConsumeDetailInfo_TypeInfo);
    sub_1C713B0(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__);
    sub_1C713B0(&Method_System_Collections_Generic_List_CommonConsumeDetailInfo__Add__);
    sub_1C713B0(&Method_System_Collections_Generic_List_CommonConsumeDetailInfo__ToArray__);
    sub_1C713B0(&Method_System_Collections_Generic_List_CommonConsumeDetailInfo___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_CommonConsumeDetailInfo__TypeInfo);
    sub_1C713B0(&NetworkManager_TypeInfo);
    byte_4CC6E6C = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_CommonConsumeDetailInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_CommonConsumeDetailInfo___ctor__);
  ...
  if ( v7 >= 1 )
  {
    ...
    {
      if ( v9 >= v7 )
        sub_1C71610(commonConusmeMaster);
        ...
        if ( commonConusmeMaster )
        {
          ...
          Entity = (Il2CppObject *)UserItemMaster__GetEntity(
                                     ...
                                     *(_QWORD *)(*((_QWORD *)commonConusmeMaster + 23) + 64LL),
                                     (int32_t)v11[1].klass,
                                     0);
          v14 = (CommonConsumeDetailInfo_o *)sub_1C715FC(CommonConsumeDetailInfo_TypeInfo);
...
LABEL_27:
    sub_1C71608(commonConusmeMaster, v6);
  }
LABEL_25:
  if ( !v3 )
    goto LABEL_27;
  return (CommonConsumeDetailInfo_array *)System_Collections_Generic_List_object___ToArray(
                                            v3,
                                            (const MethodInfo_3812270 *)Method_System_Collections_Generic_List_CommonConsumeDetailInfo__ToArray__);
}
...
bool CommonConsumeDetail__IsAllSatisfied(CommonConsumeDetailInfo_array *consumeItemInfoArray, const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( max_length == v3 )
        sub_1C71610(consumeItemInfoArray);
...
LABEL_12:
    sub_1C71608(consumeItemInfoArray, method);
  }
  v3 = 0;
  return v3 >= max_length;
}
