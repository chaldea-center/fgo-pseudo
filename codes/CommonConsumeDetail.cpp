        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C42A43 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_3694/*"COMMON_CONSUME_DESCRIPTION_TITLE"*/);
    sub_1C37058(&StringLiteral_3698/*"COMMON_CONSUME_INFO_SEPARATOR"*/);
    sub_1C37058(&StringLiteral_3697/*"COMMON_CONSUME_INFO_IF_LACKING"*/);
    byte_4C42A43 = 1;
  }
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v8 = (Il2CppObject *)System_String__Format_63602948(v21, Name_k__BackingField, v22, 0);
      if ( !v7 )
        break;
...
LABEL_19:
  ...
  return System_String__Concat_63561656(v3, v31, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C42A42 & 1) == 0 )
  {
    sub_1C37058(&CommonConsumeDetailInfo_TypeInfo);
    sub_1C37058(&Method_DataMasterBase_ItemMaster__ItemEntity__int__GetEntity__);
    sub_1C37058(&Method_System_Collections_Generic_List_CommonConsumeDetailInfo__Add__);
    sub_1C37058(&Method_System_Collections_Generic_List_CommonConsumeDetailInfo__ToArray__);
    sub_1C37058(&Method_System_Collections_Generic_List_CommonConsumeDetailInfo___ctor__);
    sub_1C37058(&System_Collections_Generic_List_CommonConsumeDetailInfo__TypeInfo);
    sub_1C37058(&NetworkManager_TypeInfo);
    byte_4C42A42 = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_CommonConsumeDetailInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_37A27F0 *)Method_System_Collections_Generic_List_CommonConsumeDetailInfo___ctor__);
  ...
  if ( v6 >= 1 )
  {
    ...
    {
      if ( v8 >= v6 )
        sub_1C372BC(commonConusmeMaster);
        ...
        if ( commonConusmeMaster )
        {
          ...
          Entity = (Il2CppObject *)UserItemMaster__GetEntity(
                                     ...
                                     *(_QWORD *)(*((_QWORD *)commonConusmeMaster + 23) + 64LL),
                                     (int32_t)v10[1].klass,
                                     0);
          v13 = (CommonConsumeDetailInfo_o *)sub_1C372A4(CommonConsumeDetailInfo_TypeInfo);
...
LABEL_27:
    sub_1C372B4(commonConusmeMaster);
  }
LABEL_25:
  if ( !v3 )
    goto LABEL_27;
  return (CommonConsumeDetailInfo_array *)System_Collections_Generic_List_object___ToArray(
                                            v3,
                                            (const MethodInfo_37A4B7C *)Method_System_Collections_Generic_List_CommonConsumeDetailInfo__ToArray__);
}
...
bool CommonConsumeDetail__IsAllSatisfied(CommonConsumeDetailInfo_array *consumeItemInfoArray, const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( max_length == v3 )
        sub_1C372BC(consumeItemInfoArray);
...
LABEL_12:
    sub_1C372B4(consumeItemInfoArray);
  }
  v3 = 0;
  return v3 >= max_length;
}
