void __fastcall ClassBoardAddClassDialog___ctor(ClassBoardAddClassDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A0BA & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ServantClassIconComponent___ctor__, v3);
    sub_1BE4ACC(&System_Collections_Generic_List_ServantClassIconComponent__TypeInfo, v4);
    byte_4B6A0BA = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_ServantClassIconComponent__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_ServantClassIconComponent___ctor__);
  this->fields.iconList = (struct System_Collections_Generic_List_ServantClassIconComponent__o *)v5;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.iconList, (int64_t)v5, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A0B7 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_ClassBoardAddClassDialog_OnCloseEnd__, v10);
    byte_4B6A0B7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  _QWORD *v22; // x9
  __int64 v23; // x10
  ClassBoardAddClassDialog_o *v24; // x1
  Il2CppClass **v25; // x0

  v4 = this;
  if ( (byte_4B6A0B9 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_ServantClassIconComponent___, *(_QWORD *)&count);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ServantClassIconComponent__Add__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ServantClassIconComponent__get_Count__, v6);
    sub_1BE4ACC(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    this = (ClassBoardAddClassDialog_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v8);
    byte_4B6A0B9 = 1;
  }
    ...
    if ( count - size >= 1 )
    {
      do
      {
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v13, 0LL, 0LL) )
        {
          ...
          v22 = Method_System_Collections_Generic_List_ServantClassIconComponent__Add__;
          ++v14->fields._version;
          if ( !items )
            goto LABEL_17;
          ...
          else
          {
            ...
            sub_1BE4A70((PartyOrganizationUtility_o *)(v25 + 4), (int64_t)v24, v15, v16, v17, v18, v19, v20);
          }
        }
        --v11;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A0B6 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ClassBoardAddClassDialog_OnClickCloseButton__, method);
  ...
  if ( (*((_BYTE *)Method_ClassBoardAddClassDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BE4AE4(Method_ClassBoardAddClassDialog_OnClickCloseButton__);
...
void __fastcall ClassBoardAddClassDialog__OnCloseEnd(ClassBoardAddClassDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70(p_closeCallback, 0LL, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A0B5 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_UIGrid___, *(_QWORD *)&classBaseId);
    ...
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_ServantClassIconComponent__Dispose__, v10);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_ServantClassIconComponent__MoveNext__, v11);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_Enumerator_ServantClassIconComponent__get_Current__, v12);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ServantClassIconComponent__GetEnumerator__, v13);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ServantClassIconComponent__get_Count__, v14);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ServantClassIconComponent__get_Item__, v15);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v16);
    sub_1BE4ACC(&StringLiteral_3508/*"CLASS_BOARD_ADD_CLASS_DIALOG_CONTENT_FORMAT"*/, v17);
    byte_4B6A0B5 = 1;
  }
  entity = 0LL;
  ...
  if ( classIds )
  {
    ...
    if ( v18 )
    {
      ...
      System_Collections_Generic_List_object___GetEnumerator(
        ...
        iconList,
        (const MethodInfo_35ECD1C *)Method_System_Collections_Generic_List_ServantClassIconComponent__GetEnumerator__);
      v29 = v28;
      while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
                &v29,
                (const MethodInfo_3361CE0 *)Method_System_Collections_Generic_List_Enumerator_ServantClassIconComponent__MoveNext__) )
      {
      ...
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v29,
        (const MethodInfo_3361CDC *)Method_System_Collections_Generic_List_Enumerator_ServantClassIconComponent__Dispose__);
        ...
        while ( 1 )
        {
          ...
          if ( (__int64)v25 < iconList->fields._size )
          {
            iconList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                      iconList,
                                                                      v25,
                                                                      (const MethodInfo_35EBF54 *)Method_System_Collections_Generic_List_ServantClassIconComponent__get_Item__);
            if ( v25 >= classIds->max_length )
              sub_1BE4D30(iconList, v19);
            if ( !iconList )
              break;
            ServantClassIconComponent__Set_39115964(
...
LABEL_39:
        sub_1BE4D28(iconList, v19);
      }
LABEL_22:
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      iconList = (System_Collections_Generic_List_object__o *)DataManager__GetMaster_object_((const MethodInfo_2F590BC *)Method_DataManager_GetMaster_ClassBoardBaseMaster___);
      if ( !iconList )
        goto LABEL_39;
             ...
             (const MethodInfo_31FD818 *)Method_DataMasterBase_ClassBoardBaseMaster__ClassBoardBaseEntity__int__TryGetEntity__) )
      {
        ...
        iconList = (System_Collections_Generic_List_object__o *)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_3508/*"CLASS_BOARD_ADD_CLASS_DIALOG_CONTENT_FORMAT"*/,
                                                                  0LL);
        if ( !entity )
          goto LABEL_39;
...
void __fastcall ClassBoardAddClassDialog__SetupText(ClassBoardAddClassDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A0B8 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_3509/*"CLASS_BOARD_ADD_CLASS_DIALOG_TITLE"*/, v3);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3509/*"CLASS_BOARD_ADD_CLASS_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v6, 0LL),
        closeButtonLabel = this->fields.closeButtonLabel,
        v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3796/*"COMMON_CONFIRM_CLOSE"*/, 0LL),
        !closeButtonLabel) )
  {
    sub_1BE4D28(v6, v7);
  }
