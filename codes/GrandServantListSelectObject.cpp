        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B3 & 1) == 0 )
  {
    sub_1BDB878(&EventDelegate_Callback_TypeInfo, touchPress);
    sub_1BDB878(&EventDelegate_TypeInfo, v5);
    this = (GrandServantListSelectObject_o *)sub_1BDB878(&Method_GrandServantListSelectObject_OnClickServant__, v6);
    byte_4B3F9B3 = 1;
  }
  if ( !touchPress )
    sub_1BDBAD4(this, touchPress);
  onClick = touchPress->fields.onClick;
  v8 = (EventDelegate_Callback_o *)sub_1BDBAC4(EventDelegate_Callback_TypeInfo);
  EventDelegate_Callback___ctor(v8, v4, Method_GrandServantListSelectObject_OnClickServant__, 0LL);
  if ( !EventDelegate_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
  EventDelegate__Set_48553224(onClick, v8, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B2 & 1) == 0 )
  {
    sub_1BDB878(&EventDelegate_Callback_TypeInfo, fsm);
    sub_1BDB878(&EventDelegate_TypeInfo, v7);
    sub_1BDB878(&Method_GrandServantListSelectObject_OnClickServant__, v8);
    sub_1BDB878(&Method_GrandServantListSelectObject_OnLongPressServant__, v9);
    byte_4B3F9B2 = 1;
  }
  this->fields.fsm = fsm;
  v10 = (EventDelegate_o *)sub_1BDB81C(&this->fields.fsm);
  ...
  if ( !EventDelegate_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
  v10 = EventDelegate__Set_48553224(onClick, v14, 0LL);
  v15 = this->fields.servantTouchPress;
  if ( !v15
    || (onLongPress = v15->fields.onLongPress,
        v17 = (EventDelegate_Callback_o *)sub_1BDBAC4(EventDelegate_Callback_TypeInfo),
        EventDelegate_Callback___ctor(
          v17,
          (Il2CppObject *)this,
          Method_GrandServantListSelectObject_OnLongPressServant__,
          0LL),
        v10 = EventDelegate__Set_48553224(onLongPress, v17, 0LL),
...
LABEL_18:
  ...
  while ( 1 )
  {
    ...
    if ( v23 )
    {
      ...
      if ( !EventDelegate_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
      v10 = EventDelegate__Set_48553224(v24, v25, 0LL);
      v26 = this->fields.equipTouchPresses;
      if ( v26 )
      {
        if ( v22 >= v26->max_length )
LABEL_20:
          sub_1BDBADC(v10, v11, v18);
        ...
        if ( v27 )
        {
          ...
          v10 = EventDelegate__Set_48553224(v28, v29, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B6 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3487/*"CLICK_EQUIP"*/, *(_QWORD *)&index);
    byte_4B3F9B6 = 1;
  }
  GrandServantListSelectObject__SetEquipIndex(this, index, method);
  GrandServantListSelectObject__SendEvent(this, (System_String_o *)StringLiteral_3487/*"CLICK_EQUIP"*/, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B4 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3512/*"CLICK_SERVANT"*/, method);
    byte_4B3F9B4 = 1;
  }
  GrandServantListSelectObject__SendEvent(this, (System_String_o *)StringLiteral_3512/*"CLICK_SERVANT"*/, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B7 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_8321/*"LONG_PRESS_EQUIP"*/, *(_QWORD *)&index);
    byte_4B3F9B7 = 1;
  }
  GrandServantListSelectObject__SetEquipIndex(this, index, method);
  GrandServantListSelectObject__SendEvent(this, (System_String_o *)StringLiteral_8321/*"LONG_PRESS_EQUIP"*/, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B5 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_8322/*"LONG_PRESS_SERVANT"*/, method);
    byte_4B3F9B5 = 1;
  }
  GrandServantListSelectObject__SendEvent(this, (System_String_o *)StringLiteral_8322/*"LONG_PRESS_SERVANT"*/, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B8 & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, eventName);
    sub_1BDB878(&StringLiteral_11493/*"SELECT_CLASS_BOARD_BASE_ID"*/, v5);
    byte_4B3F9B8 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(fsm, 0LL, 0LL) )
  {
    ...
    if ( !m_CancellationTokenSource
      ...
      || (m_CancellationTokenSource = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmInt(
                                                          ...
                                                          (System_String_o *)StringLiteral_11493/*"SELECT_CLASS_BOARD_BASE_ID"*/,
                                                          0LL)) == 0LL
    ...
    {
      sub_1BDBAD4(m_CancellationTokenSource, v7);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9B9 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_11497/*"SELECT_EQUIP_INDEX"*/, v5);
    byte_4B3F9B9 = 1;
  }
  fsm = (UnityEngine_Object_o *)this->fields.fsm;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( UnityEngine_Object__op_Inequality(fsm, 0LL, 0LL) )
  {
    ...
    if ( !m_CancellationTokenSource
      ...
      || (m_CancellationTokenSource = (PlayMakerFSM_o *)HutongGames_PlayMaker_FsmVariables__GetFsmInt(
                                                          (HutongGames_PlayMaker_FsmVariables_o *)m_CancellationTokenSource,
                                                          (System_String_o *)StringLiteral_11497/*"SELECT_EQUIP_INDEX"*/,
                                                          0LL)) == 0LL )
    {
      sub_1BDBAD4(m_CancellationTokenSource, v7);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9BA & 1) == 0 )
  {
    sub_1BDB878(&EventDelegate_Callback_TypeInfo, *(_QWORD *)&index);
    sub_1BDB878(&Method_GrandServantListSelectObject___c__DisplayClass4_0__Initialize_b__2__, v5);
    sub_1BDB878(&GrandServantListSelectObject___c__DisplayClass4_0_TypeInfo, v6);
    byte_4B3F9BA = 1;
  }
  v7 = sub_1BDBAC4(GrandServantListSelectObject___c__DisplayClass4_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = this;
  sub_1BDB81C(v7 + 24);
  *(_DWORD *)(v7 + 16) = index;
  v10 = (EventDelegate_Callback_o *)sub_1BDBAC4(EventDelegate_Callback_TypeInfo);
  EventDelegate_Callback___ctor(
    v10,
    (Il2CppObject *)v7,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&EventDelegate_Callback_TypeInfo, *(_QWORD *)&index);
    sub_1BDB878(&Method_GrandServantListSelectObject___c__DisplayClass4_1__Initialize_b__3__, v5);
    sub_1BDB878(&GrandServantListSelectObject___c__DisplayClass4_1_TypeInfo, v6);
    byte_4B3F9BB = 1;
  }
  v7 = sub_1BDBAC4(GrandServantListSelectObject___c__DisplayClass4_1_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  if ( !v7 )
    sub_1BDBAD4(v8, v9);
  *(_QWORD *)(v7 + 24) = this;
