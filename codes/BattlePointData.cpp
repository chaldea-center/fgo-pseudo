...
void __fastcall BattlePointData___ctor_42809744(
        BattlePointData_o *this,
...
BattlePointData_SaveData_o *__fastcall BattlePointData__GetSaveData(BattlePointData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5D7BB & 1) == 0 )
  {
    sub_1B885B0(&BattlePointData_SaveData_TypeInfo);
    byte_4A5D7BB = 1;
  }
  v3 = (Il2CppObject *)sub_1B887FC(BattlePointData_SaveData_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D7B8 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataManager_GetMasterData_BattlePointMaster___);
    sub_1B885B0(&Method_DataMasterBase_BattlePointMaster__BattlePointEntity__int__GetEntity__);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_BattlePointMaster___);
  if ( !Instance )
    goto LABEL_10;
  Instance = (DataManager_o *)DataMasterBase_object__object__int___GetEntity(
                                (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
                                this->fields.id,
                                (const MethodInfo_311D934 *)Method_DataMasterBase_BattlePointMaster__BattlePointEntity__int__GetEntity__);
  if ( !Instance )
    goto LABEL_10;
  ...
  if ( !svtData
    || (v8 = (char)Instance, (Instance = (DataManager_o *)svtData->fields.deckSvt) == 0LL)
    || (this->fields._IsEnableToAddValue_k__BackingField = v8 & ~BattleDeckServantData__IsIgnoreBattlePointUp(
                                                                   (BattleDeckServantData_o *)Instance,
                                                                   this->fields.id,
                                                                   0LL) & 1,
        IsHideBattlePointGauge = BattlePointEntity__IsHideBattlePointGauge(v7, svtData, 0LL),
...
LABEL_10:
  ...
  this->fields._IsHideBattlePointGauge_k__BackingField = (v10 | BattleDeckServantData__IsHideBattlePointGauge(
                                                                  (BattleDeckServantData_o *)Instance,
                                                                  this->fields.id,
                                                                  0LL)) & 1;
}
...
void __fastcall BattlePointData__UpdateMaxValue(BattlePointData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5D7B9 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataManager_GetMasterData_BattlePointPhaseMaster___);
    sub_1B885B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4A5D7B9 = 1;
  }
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_BattlePointPhaseMaster___)) == 0LL )
  {
...
LABEL_8:
  ...
  *p_IsEnableToAddValue_k__BackingField = v13;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_BattlePointMaster___)) == 0LL
    || (Instance = DataMasterBase_object__object__int___GetEntity(
                     (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
                     this->fields.id,
                     (const MethodInfo_311D934 *)Method_DataMasterBase_BattlePointMaster__BattlePointEntity__int__GetEntity__)) == 0LL )
  {
    sub_1B8880C(Instance, v17);
  }
  v18 = this->fields._IsHideBattlePointGauge_k__BackingField;
  this->fields._IsHideBattlePointGauge_k__BackingField = (v18 | BattlePointEntity__IsHideBattlePointGauge(
...
int32_t __fastcall BattlePointData__get_Phase(BattlePointData_o *this, const MethodInfo *method)
{
  ...
  Instance = DataManager__GetMasterData_object_(
               (DataManager_o *)Instance,
               (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_BattlePointPhaseMaster___);
  if ( !Instance )
    goto LABEL_10;
