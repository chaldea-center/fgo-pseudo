...
void __fastcall StoneShopDetailListViewObject__Awake(StoneShopDetailListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A688 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___, method);
    byte_4A2A688 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A689 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StoneShopDetailListViewItem_TypeInfo, v3);
    byte_4A2A689 = 1;
  }
