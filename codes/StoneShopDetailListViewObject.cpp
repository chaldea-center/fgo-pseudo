...
void __fastcall StoneShopDetailListViewObject__Awake(StoneShopDetailListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC404D & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___, method);
    byte_4BC404D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC404E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StoneShopDetailListViewItem_TypeInfo, v3);
    byte_4BC404E = 1;
  }
