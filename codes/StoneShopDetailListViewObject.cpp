...
void StoneShopDetailListViewObject__Awake(StoneShopDetailListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F3B8 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___);
    byte_4C3F3B8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___);
...
void StoneShopDetailListViewObject__SetupDisp(StoneShopDetailListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F3B9 & 1) == 0 )
  {
    ...
    sub_1C37058(&StoneShopDetailListViewItem_TypeInfo);
    byte_4C3F3B9 = 1;
  }
