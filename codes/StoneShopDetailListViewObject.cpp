...
void StoneShopDetailListViewObject__Awake(StoneShopDetailListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2366F & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___);
    byte_4C2366F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___);
...
void StoneShopDetailListViewObject__SetupDisp(StoneShopDetailListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23670 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StoneShopDetailListViewItem_TypeInfo);
    byte_4C23670 = 1;
  }
