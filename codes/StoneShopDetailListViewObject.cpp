...
void __fastcall StoneShopDetailListViewObject__Awake(StoneShopDetailListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B18917 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___, method);
    byte_4B18917 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_StoneShopDetailListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18918 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StoneShopDetailListViewItem_TypeInfo, v3);
    byte_4B18918 = 1;
  }
