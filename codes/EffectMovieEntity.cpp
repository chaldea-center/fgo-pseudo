        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B448E2 & 1) == 0 )
  {
    sub_1BDB878(&EffectMovieMaster_TypeInfo, *(_QWORD *)&additionalId);
...
LABEL_17:
      ...
      else
      {
        ...
        v22 = System_String__Format_62613552(WEAPON_SUB_PATH, v17, v21, 0LL);
      }
      result = System_String__Concat_62572260(v22, this->fields.name, 0LL);
      break;
    case 5:
      ...
      result = System_String__Concat_62572260(v23->static_fields->BATTLECOMMON_PATH, this->fields.name, 0LL);
      break;
    default:
