        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21DCA & 1) == 0 )
  {
    sub_1C3B764(&EffectMovieMaster_TypeInfo, *(_QWORD *)&additionalId);
...
LABEL_11:
      ...
      result = System_String__Concat_63368612(v16, this->fields.name, 0LL);
      break;
    case 5:
      ...
      result = System_String__Concat_63368612(v17->static_fields->BATTLECOMMON_PATH, this->fields.name, 0LL);
      break;
    default:
