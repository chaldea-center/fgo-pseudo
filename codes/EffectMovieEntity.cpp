        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB612E & 1) == 0 )
  {
    sub_1C6BA08(&EffectMovieMaster_TypeInfo);
...
LABEL_17:
      ...
      else
      {
        ...
        v16 = System_String__Format_64008100(WEAPON_SUB_PATH, v14, v15, 0);
      }
      result = System_String__Concat_63966792(v16, this->fields.name, 0);
      break;
    case 5:
      ...
      result = System_String__Concat_63966792(v17->static_fields->BATTLECOMMON_PATH, this->fields.name, 0);
      break;
    default:
