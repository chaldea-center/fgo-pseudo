        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB454C & 1) == 0 )
  {
    sub_1C13D24(&EffectMovieMaster_TypeInfo, *(_QWORD *)&additionalId);
...
LABEL_11:
      ...
      result = System_String__Concat_62967944(v16, this->fields.name, 0LL);
      break;
    case 5:
      ...
      result = System_String__Concat_62967944(v17->static_fields->BATTLECOMMON_PATH, this->fields.name, 0LL);
      break;
    default:
