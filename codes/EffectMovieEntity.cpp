        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F956 & 1) == 0 )
  {
    sub_1B715CC(&EffectMovieMaster_TypeInfo, *(_QWORD *)&additionalId);
...
LABEL_11:
      ...
      result = System_String__Concat_61505504(v16, this->fields.name, 0LL);
      break;
    case 5:
      ...
      result = System_String__Concat_61505504(v17->static_fields->BATTLECOMMON_PATH, this->fields.name, 0LL);
      break;
    default:
