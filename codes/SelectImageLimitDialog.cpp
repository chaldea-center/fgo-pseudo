        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB14AD & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_string__int__Add__, json);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_string__object__GetEnumerator__, v4);
    ...
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_Enumerator_string__object__Dispose__, v7);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_Enumerator_string__object__MoveNext__, v8);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_Enumerator_string__object__get_Current__, v9);
    sub_1BAB41C(&JsonManager_TypeInfo, v10);
    sub_1BAB41C(&Method_System_Collections_Generic_KeyValuePair_string__object__get_Key__, v11);
    sub_1BAB41C(&Method_System_Collections_Generic_KeyValuePair_string__object__get_Value__, v12);
    byte_4AB14AD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB14AC & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_int__int__ContainsKey__, *(_QWORD *)&svtId);
...
LABEL_8:
    sub_1BAB678(dicSelectedImageLimit, *(_QWORD *)&svtId);
  }
  return -1;
}
...
LABEL_11:
  ...
  v9 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1BAB668(System_Collections_Generic_Dictionary_int__int__TypeInfo);
  ...
  sub_1BAB3C0(&this->fields.dicSelectedImageLimit);
...
void __fastcall SelectImageLimitDialog__LoadImageLimitData(SelectImageLimitDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB14AA & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_int__int__Add__, method);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_string__object__GetEnumerator__, v3);
    ...
    sub_1BAB41C(&StringLiteral_9178/*"MultipleViewSelectImageLimit"*/, v10);
    sub_1BAB41C(&StringLiteral_10621/*"PhotoCampaignSelectImageLimit2024"*/, v11);
    byte_4AB14AA = 1;
  }
  *(_QWORD *)result = 0LL;
  ...
  if ( eventType == 24 )
  {
    v14 = &StringLiteral_9178/*"MultipleViewSelectImageLimit"*/;
  }
  else
  {
    String = 0LL;
    if ( eventType != 26 )
      goto LABEL_8;
    v14 = &StringLiteral_10621/*"PhotoCampaignSelectImageLimit2024"*/;
  }
...
void __fastcall SelectImageLimitDialog__OnClickCancel(SelectImageLimitDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB14A7 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SelectImageLimitDialog_OnClickCancel__, v3);
    sub_1BAB41C(&Method_SelectImageLimitDialog__OnClickCancel_b__23_0__, v4);
    byte_4AB14A7 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectImageLimitDialog_OnClickCancel__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BAB434(Method_SelectImageLimitDialog_OnClickCancel__);
...
void __fastcall SelectImageLimitDialog__OnClickDecide(SelectImageLimitDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&System_Action_TypeInfo, method);
    sub_1BAB41C(&Method_System_Collections_Generic_List_int__get_Item__, v3);
    sub_1BAB41C(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v4);
    sub_1BAB41C(&Method_SelectImageLimitDialog_OnClickDecide__, v5);
    sub_1BAB41C(&Method_SelectImageLimitDialog__OnClickDecide_b__22_0__, v6);
    byte_4AB14A6 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SelectImageLimitDialog_OnClickDecide__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1BAB434(Method_SelectImageLimitDialog_OnClickDecide__);
    ...
    *(_QWORD *)&v18.fields.fakeValue = v12;
    v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46695852(v18, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB14AE & 1) == 0 )
  {
    sub_1BAB41C(&SelectImageLimitListViewManager_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1BAB41C(&Method_System_Collections_Generic_List_int__get_Item__, v7);
    sub_1BAB41C(&Method_SelectImageLimitDialog_OnClickImageLimit__, v8);
    byte_4AB14AE = 1;
  }
  if ( kind == 1 && this->fields.state == 2 )
  {
    if ( this->fields.selectedIndex != index )
    {
      ...
      if ( (*((_BYTE *)Method_SelectImageLimitDialog_OnClickImageLimit__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1BAB434(Method_SelectImageLimitDialog_OnClickImageLimit__);
    ...
    if ( !imageIdList
      ...
      || (SelectImageLimitListViewManager__ModifyItem(selectImageLimitListViewManager, (int32_t)imageIdList, v13),
          ...
          v15 = (SelectImageLimitListViewManager_CallbackFunc_o *)sub_1BAB668(SelectImageLimitListViewManager_CallbackFunc_TypeInfo),
          ...
          !v14) )
    {
      sub_1BAB678(imageIdList, *(_QWORD *)&kind);
    }
    v14->fields.callbackFunc = v15;
    sub_1BAB3C0(&v14->fields.callbackFunc);
    SelectImageLimitListViewManager__SetMode_31595680(v14, 2, v17);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB14A3 & 1) == 0 )
  {
    sub_1BAB41C(&Method_ActionExtensions_Call_bool___, *(_QWORD *)&eventType);
    sub_1BAB41C(&System_Action_TypeInfo, v12);
    sub_1BAB41C(&SelectImageLimitListViewManager_CallbackFunc_TypeInfo, v13);
    ...
    sub_1BAB41C(&Method_SelectImageLimitDialog_EndOpen__, v17);
    sub_1BAB41C(&Method_SelectImageLimitDialog_OnClickImageLimit__, v18);
    sub_1BAB41C(&StringLiteral_3755/*"COMMON_CONFIRM_DECIDE"*/, v19);
    sub_1BAB41C(&StringLiteral_3753/*"COMMON_CONFIRM_CANCEL"*/, v20);
    sub_1BAB41C(&StringLiteral_8783/*"MULTIPLE_SERVANT_SELECT_IMAGE_DIALOG_TITLE_"*/, v21);
    sub_1BAB41C(&StringLiteral_10376/*"PHOTO_SERVANT_SELECT_IMAGE_DIALOG_TITLE"*/, v22);
    sub_1BAB41C(&StringLiteral_10377/*"PHOTO_SERVANT_SELECT_IMAGE_DIALOG_WARNING"*/, v23);
    sub_1BAB41C(&StringLiteral_8784/*"MULTIPLE_SERVANT_SELECT_IMAGE_DIALOG_WARNING_"*/, v24);
    byte_4AB14A3 = 1;
  }
  SelectImageLimitDialog__Init(this, *(const MethodInfo **)&eventType);
  this->fields.closeFunc = closeCallback;
  sub_1BAB3C0(&this->fields.closeFunc);
  this->fields.eventType = eventType;
  this->fields.SetMaskCollider = setMaskMethod;
  sub_1BAB3C0(&this->fields.SetMaskCollider);
  ActionExtensions__Call_bool_(
    (System_Action_T__o *)this->fields.SetMaskCollider,
    1,
    (const MethodInfo_2E183D8 *)Method_ActionExtensions_Call_bool___);
  ...
  v33 = (SelectImageLimitListViewManager_CallbackFunc_o *)sub_1BAB668(SelectImageLimitListViewManager_CallbackFunc_TypeInfo);
  SelectImageLimitListViewManager_CallbackFunc___ctor(
    v33,
    (Il2CppObject *)this,
    (intptr_t)Method_SelectImageLimitDialog_OnClickImageLimit__,
  ...
  sub_1BAB3C0(&v32->fields.callbackFunc);
  SelectImageLimitListViewManager__SetMode_31595680(v32, 2, v35);
...
LABEL_26:
  ...
  v39 = System_String__Concat_62048128((System_String_o *)StringLiteral_8783/*"MULTIPLE_SERVANT_SELECT_IMAGE_DIALOG_TITLE_"*/, v38, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v42 = System_String__Concat_62048128((System_String_o *)StringLiteral_8784/*"MULTIPLE_SERVANT_SELECT_IMAGE_DIALOG_WARNING_"*/, v41, 0LL);
LABEL_19:
...
LABEL_21:
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3753/*"COMMON_CONFIRM_CANCEL"*/, 0LL);
...
void __fastcall SelectImageLimitDialog__SaveImageLimitData(SelectImageLimitDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB14A9 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_string__object__Add__, method);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_int__int__GetEnumerator__, v3);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_string__object___ctor__, v4);
    sub_1BAB41C(&System_Collections_Generic_Dictionary_string__object__TypeInfo, v5);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_Enumerator_int__int__Dispose__, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_Enumerator_int__int__MoveNext__, v7);
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_Enumerator_int__int__get_Current__, v8);
    sub_1BAB41C(&int_TypeInfo, v9);
    sub_1BAB41C(&JsonManager_TypeInfo, v10);
    sub_1BAB41C(&Method_System_Collections_Generic_KeyValuePair_int__int__get_Key__, v11);
    sub_1BAB41C(&Method_System_Collections_Generic_KeyValuePair_int__int__get_Value__, v12);
    sub_1BAB41C(&StringLiteral_9178/*"MultipleViewSelectImageLimit"*/, v13);
    sub_1BAB41C(&StringLiteral_10621/*"PhotoCampaignSelectImageLimit2024"*/, v14);
    byte_4AB14A9 = 1;
  }
  memset(&v29, 0, 32);
  *(&v28.fields._getEnumeratorRetType + 1) = 0;
  v15 = (System_Collections_Generic_Dictionary_object__object__o *)sub_1BAB668(System_Collections_Generic_Dictionary_string__object__TypeInfo);
  ...
  *(_OWORD *)&v29.fields._dictionary = *(_OWORD *)&v28.fields._dictionary;
            ...
            (const MethodInfo_3302BF8 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__int__MoveNext__) )
  {
    ...
    *(&v28.fields._getEnumeratorRetType + 1) = (int32_t)v29.fields._current.fields.key;
    ...
    System_Collections_Generic_Dictionary_object__object___Add(
      ...
      v19,
      v23,
      (const MethodInfo_321354C *)Method_System_Collections_Generic_Dictionary_string__object__Add__);
  }
  ...
  if ( !System_String__IsNullOrEmpty(v25, 0LL) )
  {
    ...
    if ( eventType == 24 )
    {
      v27 = &StringLiteral_9178/*"MultipleViewSelectImageLimit"*/;
    }
    else
    {
      if ( eventType != 26 )
...
LABEL_16:
      ...
      v27 = &StringLiteral_10621/*"PhotoCampaignSelectImageLimit2024"*/;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB14A4 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_ServantCostumeMaster___, usrSvtId);
  ...
  sub_1BAB3C0(&this->fields.usrSvtEnt);
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)&v42.fields.fakeValue = v22;
    if ( v21 > CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46695852(v42, 0LL) )
      break;
        ...
        if ( (int)v17 >= 1 )
        {
          ...
          if ( (unsigned int)v36 >= *(_DWORD *)(v34 + 24) )
          {
            System_Collections_Generic_List_int___AddWithResize(
              (System_Collections_Generic_List_int__o *)Master_object,
              v17,
              *(const MethodInfo_3530898 **)(*(_QWORD *)(v35[4] + 192LL) + 112LL));
          }
          else
          {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB14AB & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Collections_Generic_Dictionary_int__int__set_Item__, *(_QWORD *)&svtId);
    byte_4AB14AB = 1;
  }
  dicSelectedImageLimit = this->fields.dicSelectedImageLimit;
  if ( !dicSelectedImageLimit )
        ...
        const MethodInfo *method)
{
  ...
  if ( !imageIdList
    || (closeFunc = this->fields.closeFunc,
        ...
        !closeFunc) )
  {
    sub_1BAB678(imageIdList, method);
  }
