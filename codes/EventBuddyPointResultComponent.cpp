        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF1FF & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_22511/*"rank_"*/, *(_QWORD *)&rank);
    byte_49BF1FF = 1;
  }
  v3 = System_Int32__ToString((int32_t)&v5, 0LL);
  return System_String__Concat_61093468((System_String_o *)StringLiteral_22511/*"rank_"*/, v3, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF1FE & 1) == 0 )
  {
    sub_1B4CF90(&Method_EventBuddyPointResultComponent_OnClickScreen__, method);
    byte_49BF1FE = 1;
  }
  ...
  if ( UnityEngine_GameObject__get_activeInHierarchy(touchHintObj, 0LL) )
  {
    ...
    if ( (*((_BYTE *)Method_EventBuddyPointResultComponent_OnClickScreen__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B4CFA8(Method_EventBuddyPointResultComponent_OnClickScreen__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF1FC & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventBuddyPointResultComponent_FadeInFigure__, v3);
    sub_1B4CF90(&Method_EventBuddyPointResultComponent_OnPlayEnd__, v4);
    byte_49BF1FC = 1;
  }
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&v9->fields.endAction, (int32_t)v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF1FA & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_EventServantPointRankMaster___, *(_QWORD *)&eventId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF1FB & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventBuddyPointResultComponent___c__DisplayClass11_0__SetSvtFigure_b__0__, v14);
    sub_1B4CF90(&EventBuddyPointResultComponent___c__DisplayClass11_0_TypeInfo, v15);
    byte_49BF1FB = 1;
  }
  v16 = sub_1B4D1DC(EventBuddyPointResultComponent___c__DisplayClass11_0_TypeInfo);
  ...
  *(_QWORD *)(v16 + 24) = setupEndCallBack;
  sub_1B4CF34((CGThumbnailListItem_o *)(v16 + 24), (int32_t)setupEndCallBack, v21, v22);
...
LABEL_22:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  svtStandFig = (ServantLimitImageMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_ServantLimitImageMaster___);
  if ( !svtStandFig )
    goto LABEL_31;
...
LABEL_28:
  ...
  if ( !v27 )
    goto LABEL_31;
  StandFigureBack__CreatedStandFigure(v27, svtId, overwriteImgLimitCount, 0, 0, v28, 0, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF1F9 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_UserEventServantPointMaster___, *(_QWORD *)&eventId);
  ...
  sub_1B4CF34(
    (CGThumbnailListItem_o *)&this->fields.closeCallback,
    (int32_t)closeCallback,
    (int32_t)buddyUiAtlas,
    (const MethodInfo *)setupEndCallback);
  this->fields.buddyUiAtlas = buddyUiAtlas;
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.buddyUiAtlas, (int32_t)buddyUiAtlas, v15, v16);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F01AD0 *)Method_DataManager_GetMaster_UserEventServantPointMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_49B57A5 )
  {
  ...
  if ( BestServantPointEntity )
  {
    ...
    EventBuddyPointResultComponent__SetPointInfo(this, eventId, BuddyPoint, svtId, v23);
    EventBuddyPointResultComponent__SetSvtFigure(this, svtId, overwriteLimitCount, setupEndCallback, v24);
    EventBuddyPointResultComponent__SetAnimationEvent(this, v25);
    touchHintObj = this->fields.touchHintObj;
    if ( touchHintObj )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF200 & 1) == 0 )
  {
    this = (EventBuddyPointResultComponent___c__DisplayClass11_0_o *)sub_1B4CF90(&UnityEngine_Object_TypeInfo, method);
    byte_49BF200 = 1;
  }
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&_4__this->fields.figureR, (int32_t)SvtStandFigure, v5, v6);
