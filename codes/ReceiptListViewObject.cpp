...
void ReceiptListViewObject__Awake(ReceiptListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596DCA4 & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_ReceiptListViewItemDraw___);
    byte_596DCA4 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_ReceiptListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_ReceiptListViewObject___)) == 0) )
  {
    sub_2213CDC(DragObject, v4);
  }
  ReceiptListViewObject__Init_44304528((ReceiptListViewObject_o *)DragObject, 2, v6);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( (ReceiptListViewItem_c *)klass->_2.typeHierarchy[naturalAligment - 1] == ReceiptListViewItem_TypeInfo )
      v12 = initMode;
    else
      v12 = 0;
  }
...
LABEL_16:
  ...
  if ( v12 == 4 )
  {
    ...
    this->fields.state = 2;
    ReceiptListViewObject__EventMoveEnd(this, v24);
    return;
  }
  if ( v12 == 5 )
  {
...
LABEL_17:
  if ( !state || dispMode != this->fields.dispMode )
    ReceiptListViewObject__SetupDisp(this, v24);
...
void ReceiptListViewObject__Init_44304528(ReceiptListViewObject_o *this, int32_t initMode, const MethodInfo *method)
{
  ...
  v10.fields.y = v6;
  v10.fields.z = v7;
  ReceiptListViewObject__Init(this, initMode, 0, v4, v10, v3);
}


void ReceiptListViewObject__Init_44305120(
        ReceiptListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  ReceiptListViewObject__Init(this, initMode, callbackFunc, delay, v11, method);
}


void ReceiptListViewObject__Init_44306208(
        ReceiptListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
  ...
  v11.fields.y = v6;
  v11.fields.z = v7;
  ReceiptListViewObject__Init(this, initMode, callbackFunc, v4, v11, method);
}
...
void ReceiptListViewObject__SetupDisp(ReceiptListViewObject_o *this, const MethodInfo *method)
{
  ...
  __int64 v9; // x1
  ReceiptListViewItemDraw_o *v10; // x0
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0, 0) )
  {
    ...
    if ( !v10 )
      sub_2213CDC(0, v9);
    ReceiptListViewItemDraw__SetItem(v10, (ReceiptListViewItem_o *)linkItem, this->fields.dispMode, 0);
  }
}
...
void ReceiptListViewObject__Start(ReceiptListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    ReceiptListViewObject__Init_44304528(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x0
  bool v12; // zf
  ReceiptListViewObject_o *v13; // x0
  ...
  ReceiptListViewObject__remove_callbackFunc(v13, v14, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_221405C(v8, System_Action_TypeInfo, v9, v10);
  ReceiptListViewObject__Awake(v13, v14);
}