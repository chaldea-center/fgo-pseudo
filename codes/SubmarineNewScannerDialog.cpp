...
void SubmarineNewScannerDialog__Init(SubmarineNewScannerDialog_o *this, const MethodInfo *method)
{
  ...
  upperMessageLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
LABEL_9:
    sub_1C71608(upperMessageLabel, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3D3E & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SubmarineNewScannerDialog___c__DisplayClass16_0__LoadEventUIAssetData_b__0__);
    sub_1C713B0(&SubmarineNewScannerDialog___c__DisplayClass16_0_TypeInfo);
    byte_4CC3D3E = 1;
  }
  v7 = sub_1C715FC(SubmarineNewScannerDialog___c__DisplayClass16_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3D41 & 1) == 0 )
  {
    ...
    this = (SubmarineNewScannerDialog_o *)sub_1C713B0(&StringLiteral_5338/*"DownloadEventUIAtlas{0}{1}"*/);
    byte_4CC3D41 = 1;
  }
...
void SubmarineNewScannerDialog__OnClickCloseButton(SubmarineNewScannerDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC3D3B & 1) == 0 )
  {
    sub_1C713B0(&Method_SubmarineNewScannerDialog_OnClickCloseButton__);
    byte_4CC3D3B = 1;
  }
  BaseDialog__SetMaskTouchCloseEnabled((BaseDialog_o *)this, 0, 0);
  ...
  if ( (*((_BYTE *)Method_SubmarineNewScannerDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_SubmarineNewScannerDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3D3A & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__TryGetEntity__);
    sub_1C713B0(&LocalizationManager_TypeInfo);
    sub_1C713B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C713B0(&Method_SubmarineNewScannerDialog___c__DisplayClass10_0__Open_b__0__);
    sub_1C713B0(&Method_SubmarineNewScannerDialog___c__DisplayClass10_0__Open_b__1__);
    sub_1C713B0(&SubmarineNewScannerDialog___c__DisplayClass10_0_TypeInfo);
    sub_1C713B0(&StringLiteral_5713/*"EVENT_SUBMARINE_NEW_SCAN_ADDED_MESSAGE_UPPER"*/);
    sub_1C713B0(&StringLiteral_5712/*"EVENT_SUBMARINE_NEW_SCAN_ADDED_MESSAGE_LOWER"*/);
    byte_4CC3D3A = 1;
  }
  v7 = sub_1C715FC(SubmarineNewScannerDialog___c__DisplayClass10_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0);
  if ( !v7 )
    goto LABEL_15;
  *(_QWORD *)(v7 + 16) = this;
  ...
  if ( DataMasterBase_object__object__int___TryGetEntity(
         ...
         (Il2CppObject **)(v7 + 24),
         scanId,
         (const MethodInfo_3408ECC *)Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__TryGetEntity__) )
  {
    upperMessageLabel = this->fields.upperMessageLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5713/*"EVENT_SUBMARINE_NEW_SCAN_ADDED_MESSAGE_UPPER"*/, 0);
    if ( *(_QWORD *)v17 )
    {
      ...
      if ( upperMessageLabel )
      {
        ...
        Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5712/*"EVENT_SUBMARINE_NEW_SCAN_ADDED_MESSAGE_LOWER"*/, 0);
...
void SubmarineNewScannerDialog__ReleaseLocalAtlas(SubmarineNewScannerDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC3D40 & 1) == 0 )
  {
    this = (SubmarineNewScannerDialog_o *)sub_1C713B0(&Method_System_Collections_Generic_List_UIAtlas__Clear__);
    byte_4CC3D40 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&int_TypeInfo);
    this = (SubmarineNewScannerDialog___c__DisplayClass10_0_o *)sub_1C713B0(&StringLiteral_23314/*"scan_icon_{0}"*/);
    byte_4CC3D45 = 1;
  }
  ...
  v9 = System_String__Format((System_String_o *)StringLiteral_23314/*"scan_icon_{0}"*/, v8, 0);
