...
void ShopHelpListViewObject__Awake(ShopHelpListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00BBE & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_ShopHelpListViewItemDraw___);
    byte_4E00BBE = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_ShopHelpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00BC1 & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_ShopHelpListViewObject___);
    byte_4E00BC1 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_ShopHelpListViewObject___)) == 0) )
  {
