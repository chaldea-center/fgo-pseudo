bool __fastcall BitValue_Int32Enum___CheckAndOff(BitValue_T__o *this, int32_t val, const MethodInfo_2BABDFC *method)
{
  const MethodInfo_2BABDFC *v3; // x21
  char v6; // w0
...
void __fastcall BitValue_Int32Enum___Off(BitValue_T__o *this, int32_t val, const MethodInfo_2BABD6C *method)
{
...
void __fastcall BitValue_Int32Enum___Reset(BitValue_T__o *this, const MethodInfo_2BABE68 *method)
{
  this->fields.value = 0;
}