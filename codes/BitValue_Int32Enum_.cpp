void __fastcall BitValue_Int32Enum____ctor(
        ...
        const MethodInfo_305AAD4 *method)
{
  int32_t v5; // w2
  int32_t v6; // w3
...
bool __fastcall BitValue_Int32Enum___Check(BitValue_T__o *this, int32_t val, const MethodInfo_305AB84 *method)
{
...
bool __fastcall BitValue_Int32Enum___CheckAndOff(BitValue_T__o *this, int32_t val, const MethodInfo_305ABB8 *method)
{
  const MethodInfo_305ABB8 *v3; // x19
  bool v6; // w0
  ...
  v6 = BitValue_Int32Enum___Check(
         this,
         val,
         (const MethodInfo_305AB84 *)method->klass->rgctx_data->_4_BitValue_T__Check);
  klass = v3->klass;
  LOBYTE(v3) = v6;
  BitValue_Int32Enum___Off(this, val, (const MethodInfo_305AB44 *)klass->rgctx_data->_5_BitValue_T__Off);
  return (unsigned __int8)v3 & 1;
}


void __fastcall BitValue_Int32Enum___Off(BitValue_T__o *this, int32_t val, const MethodInfo_305AB44 *method)
{
  struct System_Func_T__int__o *convertFunc; // x8
  int32_t value; // w20
...
void __fastcall BitValue_Int32Enum___On(BitValue_T__o *this, int32_t val, const MethodInfo_305AB04 *method)
{
  struct System_Func_T__int__o *convertFunc; // x8
  int32_t value; // w20
...
void __fastcall BitValue_Int32Enum___Reset(BitValue_T__o *this, const MethodInfo_305AC08 *method)
{
  this->fields.value = 0;
}