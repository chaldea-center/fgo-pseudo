bool __fastcall BitValue_Int32Enum___CheckAndOff(BitValue_T__o *this, int32_t val, const MethodInfo_2B8BD90 *method)
{
  const MethodInfo_2B8BD90 *v3; // x21
  char v6; // w0
...
void __fastcall BitValue_Int32Enum___Off(BitValue_T__o *this, int32_t val, const MethodInfo_2B8BD00 *method)
{
...
void __fastcall BitValue_Int32Enum___Reset(BitValue_T__o *this, const MethodInfo_2B8BDFC *method)
{
  this->fields.value = 0;
}