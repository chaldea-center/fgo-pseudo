        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)entity, v15, v16, v17, v18, v19, v20);
  if ( this->fields.userServantEntity )
  {
    ...
    *(_QWORD *)&v43.fields.fakeValue = v31;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49654028(v43, 0);
    if ( !v30
    ...
    {
LABEL_14:
      sub_1C93D2C(Instance, v28);
    }
    IconLabelInfo__Set_41636824(iconLabelInfo, 2, nowLoadCount, (int32_t)Instance, 0, 0, 0, 0, 0, 0);
  }
  else
  {
