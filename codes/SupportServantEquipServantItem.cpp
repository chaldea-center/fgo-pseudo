        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)entity, v15, v16, v17, v18, v19, v20);
  if ( this->fields.userServantEntity )
  {
    ...
    *(_QWORD *)&v43.fields.fakeValue = v31;
    Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_50331200(v43, 0);
    if ( !v30
      ...
      || (iconLabelInfo = this->fields.iconLabelInfo,
          v41 = *((_DWORD *)Instance + 100),
          Instance = (void *)UserServantEntity__getLevelMax((UserServantEntity_o *)Instance, 0),
          !iconLabelInfo) )
    {
LABEL_14:
      sub_1D0F30C(Instance, v28);
    }
    IconLabelInfo__Set_42279788(iconLabelInfo, 2, v41, (int32_t)Instance, 0, 0, 0, 0, 0, 0);
  }
  else
  {
    this->fields.servantEntity = 0;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.servantEntity, 0, v21, v22, v23, v24, v25, v26);
  }
