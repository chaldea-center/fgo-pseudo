        ...
        const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields, (int32_t)entity, v15, v16, v17, v18, v19, v20);
  if ( this->fields.userServantEntity )
  {
    ...
    *(_QWORD *)&v44.fields.fakeValue = v33;
    Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55792412(v44, 0);
    if ( !v31
...
LABEL_14:
    ...
    IconLabelInfo__Set_47932852(iconLabelInfo, 2, v42, (int32_t)Instance, 0, 0, 0, 0, 0, 0);
  }
  else
  {
    this->fields.servantEntity = 0;
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.servantEntity, 0, v21, v22, v23, v24, v25, v26);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( equipUserSvtId >= 1 )
  {
    ...
    *(_QWORD *)&v43.fields.fakeValue = parent;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55792412(v43, 0) >= 1 )
    {
      Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_476E8C0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( Instance )
      {
        ...
        if ( p_equipUserSvtEntity->klass )
        {
          ...
          *(_QWORD *)&v44.fields.fakeValue = v35;
          Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55792412(v44, 0);
          if ( v33 )
          {
