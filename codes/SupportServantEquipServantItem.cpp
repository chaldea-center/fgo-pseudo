        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFE7AB & 1) == 0 )
  {
    ...
    sub_1BC3008(&IconLabelInfo_TypeInfo, v8);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.iconLabelInfo, (int32_t)v11, v12, v13);
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.userServantEntity = entity;
  p_fields = &this->fields;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields, (int32_t)entity, v15, v16);
  if ( this->fields.userServantEntity )
  {
    ...
    *(_QWORD *)&v31.fields.fakeValue = v23;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v31, 0LL);
    if ( !v22
      || (v25 = DataMasterBase_object__object__int___GetEntity(
          ...
          sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.servantEntity, (int32_t)v25, v26, v27),
...
LABEL_14:
    ...
    IconLabelInfo__Set_39947860(iconLabelInfo, 2, nowLoadCount, (int32_t)Instance, 0, 0, 0, 0, 0, 0LL);
  }
  else
  {
    this->fields.servantEntity = 0LL;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.servantEntity, 0, v17, v18);
  }
