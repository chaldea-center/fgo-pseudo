        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields, (int32_t)entity, v11, v12);
  if ( this->fields.userServantEntity )
  {
    ...
    *(_QWORD *)&v27.fields.fakeValue = v19;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v27, 0);
    if ( !v18
      || (v21 = DataMasterBase_object__object__int___GetEntity(
          ...
          sub_1C3E508((CGThumbnailListItem_o *)&this->fields.servantEntity, (int32_t)v21, v22, v23),
...
LABEL_14:
    ...
    IconLabelInfo__Set_40964356(iconLabelInfo, 2, nowLoadCount, (int32_t)Instance, 0, 0, 0, 0, 0, 0);
  }
  else
  {
    this->fields.servantEntity = 0;
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.servantEntity, 0, v13, v14);
  }
