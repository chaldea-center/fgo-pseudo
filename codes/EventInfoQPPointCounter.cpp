void __fastcall EventInfoQPPointCounter___ctor(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3879E & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_22959/*"qp_counter_overlay"*/, method);
    byte_4B3879E = 1;
  }
  *(_QWORD *)&this->fields.DigitDefaultScale = 0x3F6666663F800000LL;
  v9 = StringLiteral_22959/*"qp_counter_overlay"*/;
  this->fields.OverlaySpName = (struct System_String_o *)StringLiteral_22959/*"qp_counter_overlay"*/;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.OverlaySpName, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3879A & 1) == 0 )
  {
    sub_1BD3458(&System_Math_TypeInfo, num);
    byte_4B3879A = 1;
  }
  if ( !num )
    return 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3879B & 1) == 0 )
  {
    sub_1BD3458(&System_Math_TypeInfo, number);
    byte_4B3879B = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
...
int64_t __fastcall EventInfoQPPointCounter__GetLimitPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3879D & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_EventPointUpperMaster___, method);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2F31684 *)Method_DataManager_GetMasterData_EventPointUpperMaster___)) == 0LL )
  {
...
int64_t __fastcall EventInfoQPPointCounter__GetNextPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3879C & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___, v4);
    sub_1BD3458(&Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___, v5);
    sub_1BD3458(&System_Func_EventMissionConditionEntity__long__TypeInfo, v6);
    sub_1BD3458(&Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___, v7);
    sub_1BD3458(&JsonManager_TypeInfo, v8);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventMissionConditionEntity__get_Count__, v9);
    sub_1BD3458(&Method_System_Collections_Generic_List_EventMissionConditionEntity__get_Item__, v10);
    sub_1BD3458(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1BD3458(&Method_EventInfoQPPointCounter___c__GetNextPoint_b__24_0__, v12);
    sub_1BD3458(&EventInfoQPPointCounter___c_TypeInfo, v13);
    sub_1BD3458(&StringLiteral_10969/*"QPEVENT_NEXT_DISPLAY_DATA"*/, v14);
    byte_4B3879C = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
  ...
  if ( MasterData_object )
  {
    ...
    if ( !_9__24_0 )
    {
      ...
      _9__24_0 = (System_Func_T__TResult__o *)sub_1BD36A4(System_Func_EventMissionConditionEntity__long__TypeInfo);
    ...
    v30 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderByDescending_object__long_(
                                                                 v20,
                                                                 (System_Func_TSource__TKey__o *)_9__24_0,
                                                                 (const MethodInfo_2F5ACDC *)Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___);
    Instance = System_Linq_Enumerable__ToList_object_(
                 v30,
                 (const MethodInfo_2F6EB10 *)Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___);
    if ( !Instance )
      goto LABEL_40;
    v31 = (System_Collections_Generic_List_object__o *)Instance;
    if ( *((int *)Instance + 6) >= 1 )
    {
      v32 = 0;
      v33 = 0LL;
      while ( 1 )
      {
        ...
        if ( !Instance )
          break;
        v34 = *((_DWORD *)Instance + 4);
        if ( !CondType_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
        if ( !CondType__IsMissionAchive(v34, 0LL) )
        {
          Instance = System_Collections_Generic_List_object___get_Item(
                       v31,
                       v32,
...
LABEL_40:
  ...
  v33 = 0LL;
LABEL_22:
  Value = (Il2CppObject *)ConstantStrMaster__getValue((System_String_o *)StringLiteral_10969/*"QPEVENT_NEXT_DISPLAY_DATA"*/, 0LL);
  if ( !System_String__IsNullOrEmpty((System_String_o *)Value, 0LL) )
  {
    ...
    Instance = JsonManager__DeserializeArray_object_(
                 Value,
                 (const MethodInfo_2F98C0C *)Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___);
    if ( !Instance )
      goto LABEL_40;
    ...
    if ( v36 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v39 = (_DWORD *)*((_QWORD *)v37 + (int)v38 + 4);
        if ( !v39 )
          break;
        if ( v39[4] == this->fields.eventId )
        {
          v40 = v39[5];
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          Instance = (void *)CondType__IsMissionAchive(v40, 0LL);
          if ( ((unsigned __int8)Instance & 1) != 0 )
          {
            v41 = v39[6];
            if ( !CondType_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
            Instance = (void *)CondType__IsQuestClear_38374588(v41, -1, 0, 0LL);
            if ( ((unsigned __int8)Instance & 1) == 0 )
              v33 = 0LL;
          }
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38797 & 1) == 0 )
  {
    this = (EventInfoQPPointCounter_o *)sub_1BD3458(&int_TypeInfo, val);
    byte_4B38797 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B38799 & 1) == 0 )
  {
    sub_1BD3458(&AtlasManager_TypeInfo, number);
    sub_1BD3458(&Method_System_Linq_Enumerable_Count_UISprite___, v7);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v8);
    sub_1BD3458(&StringLiteral_22958/*"qp_counter_comma"*/, v9);
    sub_1BD3458(&StringLiteral_22954/*"qp_counter_"*/, v10);
    this = (EventInfoQPPointCounter_o *)sub_1BD3458(&StringLiteral_1/*""*/, v11);
    byte_4B38799 = 1;
  }
  DigitNumber = 0LL;
  if ( sprites )
  {
    ...
    transform = (UnityEngine_Transform_o *)System_Linq_Enumerable__Count_object_(
                                             ...
                                             (const MethodInfo_2F4C97C *)Method_System_Linq_Enumerable_Count_UISprite___);
    if ( (int)transform >= 1 )
    {
      v14 = 0LL;
      v15 = 0;
      ...
      while ( v14 < sprites->max_length )
      {
        ...
        if ( ((unsigned __int8)transform & 1) == 0 )
        {
          ...
          if ( (__int64)v14 <= Digit )
          {
            ...
            v21 = System_String__Concat_62525248((System_String_o *)StringLiteral_22954/*"qp_counter_"*/, v20, 0LL);
          ...
          if ( ((unsigned __int8)transform & 1) == 0 )
          {
            ...
            else
            {
              ...
              transform = (UnityEngine_Transform_o *)AtlasManager__SetEventUI(
                                                       v28,
                                                       (System_String_o *)StringLiteral_22958/*"qp_counter_comma"*/,
                                                       0LL);
...
void __fastcall EventInfoQPPointCounter__Start(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38796 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_22956/*"qp_counter_bg_main"*/, v4);
    sub_1BD3458(&StringLiteral_22957/*"qp_counter_bg_next"*/, v5);
    sub_1BD3458(&StringLiteral_22955/*"qp_counter_bg_limit"*/, v6);
    byte_4B38796 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(PointCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v8, (System_String_o *)StringLiteral_22956/*"qp_counter_bg_main"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v12, (System_String_o *)StringLiteral_22957/*"qp_counter_bg_next"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v14, (System_String_o *)StringLiteral_22955/*"qp_counter_bg_limit"*/, 0LL);
...
void __fastcall EventInfoQPPointCounter__UpdateDisp(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38798 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_5762/*"EVENT_QPPOINT_NEXT_FORMAT"*/, v5);
    sub_1BD3458(&StringLiteral_5761/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, v6);
    byte_4B38798 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterLabel, 0LL, 0LL) )
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_5762/*"EVENT_QPPOINT_NEXT_FORMAT"*/, 0LL);
    v30 = NextPoint;
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5761/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, 0LL);
    v30 = v11;
...
void __fastcall EventInfoQPPointCounter___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3879F & 1) == 0 )
  {
    sub_1BD3458(&EventInfoQPPointCounter___c_TypeInfo, v1);
    byte_4B3879F = 1;
  }
  v2 = (Il2CppObject *)sub_1BD36A4(EventInfoQPPointCounter___c_TypeInfo);
