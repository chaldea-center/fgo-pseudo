void __fastcall EventInfoQPPointCounter___ctor(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0E3A & 1) == 0 )
  {
    sub_B52984(&StringLiteral_21783/*"qp_counter_overlay"*/);
    byte_42B0E3A = 1;
  }
  *(_QWORD *)&this->fields.DigitDefaultScale = 0x3F6666663F800000LL;
  v9 = (System_Int32_array **)StringLiteral_21783/*"qp_counter_overlay"*/;
  this->fields.OverlaySpName = (struct System_String_o *)StringLiteral_21783/*"qp_counter_overlay"*/;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.OverlaySpName, v9, v2, v3, v4, v5, v6, v7);
...
int64_t __fastcall EventInfoQPPointCounter__GetLimitPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1A4F184 *)Method_DataManager_GetMasterData_EventPointUpperMaster___)) == 0LL )
  {
...
int64_t __fastcall EventInfoQPPointCounter__GetNextPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0E38 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___);
    sub_B52984(&Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___);
    sub_B52984(&Method_System_Func_EventMissionConditionEntity__long___ctor__);
    sub_B52984(&System_Func_EventMissionConditionEntity__long__TypeInfo);
    sub_B52984(&Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___);
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_B52984(&Method_EventInfoQPPointCounter___c__GetNextPoint_b__24_0__);
    sub_B52984(&EventInfoQPPointCounter___c_TypeInfo);
    sub_B52984(&StringLiteral_10964/*"QPEVENT_NEXT_DISPLAY_DATA"*/);
    byte_42B0E38 = 1;
  }
  ...
  if ( MasterData_WarQuestSelectionMaster )
  {
    ...
    if ( !_9__24_0 )
    {
      ...
      _9__24_0 = (System_Func_ItemDroppedSkillShiftInfo_ServantInfo__long__o *)sub_B52A54(System_Func_EventMissionConditionEntity__long__TypeInfo);
      System_Func_ItemDroppedSkillShiftInfo_ServantInfo__long____ctor(
        ...
        (const MethodInfo_2BCA428 *)Method_System_Func_EventMissionConditionEntity__long___ctor__);
    ...
    v18 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderByDescending_UserEventServantPointEntity__long_(
                                                                 ...
                                                                 (const MethodInfo_1B66750 *)Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___);
    Instance = System_Linq_Enumerable__ToList_WarBoardManager_WarBoardOnboardSkillTarget_(
                 v18,
                 (const MethodInfo_1B714E4 *)Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___);
    if ( !Instance )
      goto LABEL_50;
...
LABEL_50:
  ...
  v22 = 0LL;
LABEL_29:
  Value = (Il2CppObject *)ConstantStrMaster__getValue((System_String_o *)StringLiteral_10964/*"QPEVENT_NEXT_DISPLAY_DATA"*/, 0LL);
  if ( !System_String__IsNullOrEmpty((System_String_o *)Value, 0LL) )
  {
    ...
    Instance = JsonManager__DeserializeArray_UserPresentBoxWindow_resData_(
                 Value,
                 (const MethodInfo_1F690B0 *)Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___);
    if ( !Instance )
      goto LABEL_50;
      ...
      while ( 1 )
      {
        ...
        if ( v30[4] == this->fields.eventId )
        {
          ...
          if ( ((unsigned __int8)Instance & 1) != 0 )
          {
            ...
            Instance = (void *)CondType__IsQuestClear_25987760(v32, -1, 0, 0LL);
            if ( ((unsigned __int8)Instance & 1) == 0 )
              v22 = 0LL;
          }
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E33 & 1) == 0 )
  {
    this = (EventInfoQPPointCounter_o *)sub_B52984(&int_TypeInfo);
    byte_42B0E33 = 1;
  }
  if ( !val )
    sub_B52A5C(this, val);
  ...
  {
    v7 = (EventInfoQPPointCounter_o *)sub_B52D50(val);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0E35 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Linq_Enumerable_Count_UISprite___);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_21782/*"qp_counter_comma"*/);
    sub_B52984(&StringLiteral_21778/*"qp_counter_"*/);
    this = (EventInfoQPPointCounter_o *)sub_B52984(&StringLiteral_1/*""*/);
    byte_42B0E35 = 1;
  }
  DigitNumber = 0LL;
  if ( sprites )
  {
    ...
    transform = (UnityEngine_Transform_o *)System_Linq_Enumerable__Count_WarBoardSquareIndexData_SaveData_(
                                             ...
                                             (const MethodInfo_1B5EDCC *)Method_System_Linq_Enumerable_Count_UISprite___);
    if ( (int)transform >= 1 )
    {
      v7 = 0LL;
      v8 = 0;
      ...
      while ( v7 < sprites->max_length )
      {
        ...
        if ( ((unsigned __int8)transform & 1) == 0 )
        {
          ...
          if ( (__int64)v7 <= Digit )
          {
            ...
            v15 = System_String__Concat_44568316((System_String_o *)StringLiteral_21778/*"qp_counter_"*/, v14, 0LL);
          ...
          if ( ((unsigned __int8)transform & 1) == 0 )
          {
            ...
            else
            {
              ...
              transform = (UnityEngine_Transform_o *)AtlasManager__SetEventUI(
                                                       v22,
                                                       (System_String_o *)StringLiteral_21782/*"qp_counter_comma"*/,
                                                       0LL);
...
void __fastcall EventInfoQPPointCounter__Start(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0E32 & 1) == 0 )
  {
    sub_B52984(&AtlasManager_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_21780/*"qp_counter_bg_main"*/);
    sub_B52984(&StringLiteral_21781/*"qp_counter_bg_next"*/);
    sub_B52984(&StringLiteral_21779/*"qp_counter_bg_limit"*/);
    byte_42B0E32 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(PointCounterSp, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v4, (System_String_o *)StringLiteral_21780/*"qp_counter_bg_main"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterSp, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v8, (System_String_o *)StringLiteral_21781/*"qp_counter_bg_next"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterSp, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v10, (System_String_o *)StringLiteral_21779/*"qp_counter_bg_limit"*/, 0LL);
...
void __fastcall EventInfoQPPointCounter__UpdateDisp(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0E34 & 1) == 0 )
  {
    ...
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_5718/*"EVENT_QPPOINT_NEXT_FORMAT"*/);
    sub_B52984(&StringLiteral_5717/*"EVENT_QPPOINT_LIMIT_FORMAT"*/);
    byte_42B0E34 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterLabel, 0LL, 0LL) )
  {
    ...
    v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5718/*"EVENT_QPPOINT_NEXT_FORMAT"*/, 0LL);
    v20 = NextPoint;
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterLabel, 0LL, 0LL) )
  {
    ...
    v15 = LocalizationManager__Get((System_String_o *)StringLiteral_5717/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, 0LL);
    v20 = v7;
    v16 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v20);
    v11 = System_String__Format(v15, v16, 0LL);
    if ( !v14 )
      goto LABEL_34;
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterParent, 0LL, 0LL) )
  {
    ...
    if ( !v11 )
      goto LABEL_34;
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)v11, NextPoint > 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCountParent, 0LL, 0LL) )
  {
    ...
    if ( v11 )
    {
      UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)v11, v7 > 0, 0LL);
      goto LABEL_33;
    }
LABEL_34:
    sub_B52A5C(v11, v12);
...
void __fastcall EventInfoQPPointCounter___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(EventInfoQPPointCounter___c_TypeInfo);
