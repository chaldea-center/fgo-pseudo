void __fastcall EventInfoQPPointCounter___ctor(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDBA8 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_23094/*"qp_counter_overlay"*/);
    byte_4BDDBA8 = 1;
  }
  *(_QWORD *)&this->fields.DigitDefaultScale = 0x3F6666663F800000LL;
  v9 = StringLiteral_23094/*"qp_counter_overlay"*/;
  this->fields.OverlaySpName = (struct System_String_o *)StringLiteral_23094/*"qp_counter_overlay"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.OverlaySpName, v9, v2, v3, v4, v5, v6, v7);
...
int64_t __fastcall EventInfoQPPointCounter__GetLimitPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_EventPointUpperMaster___)) == 0LL )
  {
...
int64_t __fastcall EventInfoQPPointCounter__GetNextPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDBA6 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___);
    sub_1C21E38(&Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___);
    sub_1C21E38(&System_Func_EventMissionConditionEntity__long__TypeInfo);
    sub_1C21E38(&Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___);
    ...
    sub_1C21E38(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C21E38(&Method_EventInfoQPPointCounter___c__GetNextPoint_b__24_0__);
    sub_1C21E38(&EventInfoQPPointCounter___c_TypeInfo);
    sub_1C21E38(&StringLiteral_11026/*"QPEVENT_NEXT_DISPLAY_DATA"*/);
    byte_4BDDBA6 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
  ...
  if ( MasterData_object )
  {
    ...
    if ( !_9__24_0 )
    {
      ...
      _9__24_0 = (System_Func_T__TResult__o *)sub_1C22084(System_Func_EventMissionConditionEntity__long__TypeInfo);
    ...
    v18 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderByDescending_object__long_(
                                                                 ...
                                                                 (const MethodInfo_2FD9478 *)Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___);
    Instance = System_Linq_Enumerable__ToList_object_(
                 v18,
                 (const MethodInfo_2FED5C8 *)Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___);
    if ( !Instance )
      goto LABEL_40;
    ...
    if ( *((int *)Instance + 6) >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !CondType__IsMissionAchive(v22, 0LL) )
        {
          Instance = System_Collections_Generic_List_object___get_Item(
                       v19,
                       v20,
...
LABEL_40:
  ...
  v21 = 0LL;
LABEL_22:
  Value = (Il2CppObject *)ConstantStrMaster__getValue((System_String_o *)StringLiteral_11026/*"QPEVENT_NEXT_DISPLAY_DATA"*/, 0LL);
  if ( !System_String__IsNullOrEmpty((System_String_o *)Value, 0LL) )
  {
    ...
    Instance = JsonManager__DeserializeArray_object_(
                 Value,
                 (const MethodInfo_3017804 *)Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___);
    if ( !Instance )
      goto LABEL_40;
    ...
    if ( v24 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v27[4] == this->fields.eventId )
        {
          ...
          if ( !CondType_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
          Instance = (void *)CondType__IsMissionAchive(v28, 0LL);
          if ( ((unsigned __int8)Instance & 1) != 0 )
          {
            v29 = v27[6];
            if ( !CondType_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
            Instance = (void *)CondType__IsQuestClear_38834244(v29, -1, 0, 0LL);
            if ( ((unsigned __int8)Instance & 1) == 0 )
              v21 = 0LL;
          }
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDDBA1 & 1) == 0 )
  {
    this = (EventInfoQPPointCounter_o *)sub_1C21E38(&int_TypeInfo);
    byte_4BDDBA1 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDDBA3 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_System_Linq_Enumerable_Count_UISprite___);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&StringLiteral_23093/*"qp_counter_comma"*/);
    sub_1C21E38(&StringLiteral_23089/*"qp_counter_"*/);
    this = (EventInfoQPPointCounter_o *)sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BDDBA3 = 1;
  }
  DigitNumber = 0LL;
  if ( sprites )
  {
    ...
    transform = (UnityEngine_Transform_o *)System_Linq_Enumerable__Count_object_(
                                             ...
                                             (const MethodInfo_2FCAE0C *)Method_System_Linq_Enumerable_Count_UISprite___);
    if ( (int)transform >= 1 )
    {
      v9 = 0LL;
      v10 = 0;
      ...
      while ( v9 < sprites->max_length )
      {
        ...
        if ( ((unsigned __int8)transform & 1) == 0 )
        {
          ...
          if ( (__int64)v9 <= Digit )
          {
            ...
            v16 = System_String__Concat_63115476((System_String_o *)StringLiteral_23089/*"qp_counter_"*/, v15, 0LL);
          ...
          if ( ((unsigned __int8)transform & 1) == 0 )
          {
            ...
            else
            {
              ...
              transform = (UnityEngine_Transform_o *)AtlasManager__SetEventUI(
                                                       v23,
                                                       (System_String_o *)StringLiteral_23093/*"qp_counter_comma"*/,
                                                       0LL);
...
void __fastcall EventInfoQPPointCounter__Start(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDBA0 & 1) == 0 )
  {
    sub_1C21E38(&AtlasManager_TypeInfo);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&StringLiteral_23091/*"qp_counter_bg_main"*/);
    sub_1C21E38(&StringLiteral_23092/*"qp_counter_bg_next"*/);
    sub_1C21E38(&StringLiteral_23090/*"qp_counter_bg_limit"*/);
    byte_4BDDBA0 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(PointCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v4, (System_String_o *)StringLiteral_23091/*"qp_counter_bg_main"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v8, (System_String_o *)StringLiteral_23092/*"qp_counter_bg_next"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v10, (System_String_o *)StringLiteral_23090/*"qp_counter_bg_limit"*/, 0LL);
...
void __fastcall EventInfoQPPointCounter__UpdateDisp(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDBA2 & 1) == 0 )
  {
    ...
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&StringLiteral_5796/*"EVENT_QPPOINT_NEXT_FORMAT"*/);
    sub_1C21E38(&StringLiteral_5795/*"EVENT_QPPOINT_LIMIT_FORMAT"*/);
    byte_4BDDBA2 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterLabel, 0LL, 0LL) )
  {
    ...
    v9 = LocalizationManager__Get((System_String_o *)StringLiteral_5796/*"EVENT_QPPOINT_NEXT_FORMAT"*/, 0LL);
    v26 = NextPoint;
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = LocalizationManager__Get((System_String_o *)StringLiteral_5795/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, 0LL);
    v26 = v7;
...
void __fastcall EventInfoQPPointCounter___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C22084(EventInfoQPPointCounter___c_TypeInfo);
