void __fastcall EventInfoQPPointCounter___ctor(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA45 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_22647/*"qp_counter_overlay"*/, method);
    byte_4B1DA45 = 1;
  }
  *(_QWORD *)&this->fields.DigitDefaultScale = 0x3F6666663F800000LL;
  v5 = StringLiteral_22647/*"qp_counter_overlay"*/;
  this->fields.OverlaySpName = (struct System_String_o *)StringLiteral_22647/*"qp_counter_overlay"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.OverlaySpName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA41 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Math_TypeInfo, num);
    byte_4B1DA41 = 1;
  }
  if ( !num )
    return 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA42 & 1) == 0 )
  {
    sub_1BCAFF8(&System_Math_TypeInfo, number);
    byte_4B1DA42 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
...
int64_t __fastcall EventInfoQPPointCounter__GetLimitPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA44 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventPointUpperMaster___, method);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_301AAA4 *)Method_DataManager_GetMasterData_EventPointUpperMaster___)) == 0LL )
  {
...
int64_t __fastcall EventInfoQPPointCounter__GetNextPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA43 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___, v4);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___, v5);
    sub_1BCAFF8(&System_Func_EventMissionConditionEntity__long__TypeInfo, v6);
    sub_1BCAFF8(&Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___, v7);
    sub_1BCAFF8(&JsonManager_TypeInfo, v8);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_EventMissionConditionEntity__get_Count__, v9);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_EventMissionConditionEntity__get_Item__, v10);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1BCAFF8(&Method_EventInfoQPPointCounter___c__GetNextPoint_b__24_0__, v12);
    sub_1BCAFF8(&EventInfoQPPointCounter___c_TypeInfo, v13);
    sub_1BCAFF8(&StringLiteral_10732/*"QPEVENT_NEXT_DISPLAY_DATA"*/, v14);
    byte_4B1DA43 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
  ...
  if ( MasterData_object )
  {
    ...
    if ( !_9__24_0 )
    {
      ...
      _9__24_0 = (System_Func_T__TResult__o *)sub_1BCB244(System_Func_EventMissionConditionEntity__long__TypeInfo);
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__24_0, (int32_t)_9__24_0, v24, v25);
    }
    v26 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderByDescending_object__long_(
                                                                 ...
                                                                 (const MethodInfo_3046734 *)Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___);
...
LABEL_40:
  ...
  v29 = 0LL;
LABEL_22:
  Value = (Il2CppObject *)ConstantStrMaster__getValue((System_String_o *)StringLiteral_10732/*"QPEVENT_NEXT_DISPLAY_DATA"*/, 0LL);
  if ( !System_String__IsNullOrEmpty((System_String_o *)Value, 0LL) )
  {
    ...
    Instance = JsonManager__DeserializeArray_object_(
                 Value,
                 (const MethodInfo_3086694 *)Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___);
    if ( !Instance )
      goto LABEL_40;
      ...
      while ( 1 )
      {
        ...
        if ( v36[4] == this->fields.eventId )
        {
          ...
          if ( ((unsigned __int8)Instance & 1) != 0 )
          {
            ...
            if ( !CondType_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
            Instance = (void *)CondType__IsQuestClear_39516796(v38, -1, 0, 0LL);
            if ( ((unsigned __int8)Instance & 1) == 0 )
              v29 = 0LL;
          }
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA3E & 1) == 0 )
  {
    this = (EventInfoQPPointCounter_o *)sub_1BCAFF8(&int_TypeInfo, val);
    byte_4B1DA3E = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA40 & 1) == 0 )
  {
    sub_1BCAFF8(&AtlasManager_TypeInfo, number);
    sub_1BCAFF8(&Method_System_Linq_Enumerable_Count_UISprite___, v7);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v8);
    sub_1BCAFF8(&StringLiteral_22646/*"qp_counter_comma"*/, v9);
    sub_1BCAFF8(&StringLiteral_22642/*"qp_counter_"*/, v10);
    this = (EventInfoQPPointCounter_o *)sub_1BCAFF8(&StringLiteral_1/*""*/, v11);
    byte_4B1DA40 = 1;
  }
  DigitNumber = 0LL;
  if ( sprites )
  {
    ...
    transform = (UnityEngine_Transform_o *)System_Linq_Enumerable__Count_object_(
                                             ...
                                             (const MethodInfo_3036E54 *)Method_System_Linq_Enumerable_Count_UISprite___);
    if ( (int)transform >= 1 )
    {
      v15 = 0LL;
      v16 = 0;
      ...
      while ( v15 < sprites->max_length )
      {
        ...
        if ( ((unsigned __int8)transform & 1) == 0 )
        {
          ...
          if ( (__int64)v15 <= Digit )
          {
            ...
            v22 = System_String__Concat_62450424((System_String_o *)StringLiteral_22642/*"qp_counter_"*/, v21, 0LL);
          ...
          if ( ((unsigned __int8)transform & 1) == 0 )
          {
            ...
            else
            {
              ...
              transform = (UnityEngine_Transform_o *)AtlasManager__SetEventUI(
                                                       v29,
                                                       (System_String_o *)StringLiteral_22646/*"qp_counter_comma"*/,
                                                       0LL);
...
void __fastcall EventInfoQPPointCounter__Start(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA3D & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_22644/*"qp_counter_bg_main"*/, v4);
    sub_1BCAFF8(&StringLiteral_22645/*"qp_counter_bg_next"*/, v5);
    sub_1BCAFF8(&StringLiteral_22643/*"qp_counter_bg_limit"*/, v6);
    byte_4B1DA3D = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(PointCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v8, (System_String_o *)StringLiteral_22644/*"qp_counter_bg_main"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v12, (System_String_o *)StringLiteral_22645/*"qp_counter_bg_next"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v14, (System_String_o *)StringLiteral_22643/*"qp_counter_bg_limit"*/, 0LL);
...
void __fastcall EventInfoQPPointCounter__UpdateDisp(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA3F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_5618/*"EVENT_QPPOINT_NEXT_FORMAT"*/, v5);
    sub_1BCAFF8(&StringLiteral_5617/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, v6);
    byte_4B1DA3F = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterLabel, 0LL, 0LL) )
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_5618/*"EVENT_QPPOINT_NEXT_FORMAT"*/, 0LL);
    v30 = NextPoint;
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5617/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, 0LL);
    v30 = v11;
...
void __fastcall EventInfoQPPointCounter___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1DA46 & 1) == 0 )
  {
    sub_1BCAFF8(&EventInfoQPPointCounter___c_TypeInfo, v1);
    byte_4B1DA46 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(EventInfoQPPointCounter___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventInfoQPPointCounter___c_TypeInfo->static_fields->__9 = (struct EventInfoQPPointCounter___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)EventInfoQPPointCounter___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
