void __fastcall EventInfoQPPointCounter___ctor(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7307 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_22721/*"qp_counter_overlay"*/, method);
    byte_4AB7307 = 1;
  }
  *(_QWORD *)&this->fields.DigitDefaultScale = 0x3F6666663F800000LL;
  v5 = StringLiteral_22721/*"qp_counter_overlay"*/;
  this->fields.OverlaySpName = (struct System_String_o *)StringLiteral_22721/*"qp_counter_overlay"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.OverlaySpName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7303 & 1) == 0 )
  {
    sub_1BAB41C(&System_Math_TypeInfo, num);
    byte_4AB7303 = 1;
  }
  if ( !num )
    return 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7304 & 1) == 0 )
  {
    sub_1BAB41C(&System_Math_TypeInfo, number);
    byte_4AB7304 = 1;
  }
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
...
int64_t __fastcall EventInfoQPPointCounter__GetLimitPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7306 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventPointUpperMaster___, method);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2EC55C8 *)Method_DataManager_GetMasterData_EventPointUpperMaster___)) == 0LL )
  {
...
int64_t __fastcall EventInfoQPPointCounter__GetNextPoint(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7305 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___, v4);
    sub_1BAB41C(&Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___, v5);
    sub_1BAB41C(&System_Func_EventMissionConditionEntity__long__TypeInfo, v6);
    sub_1BAB41C(&Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___, v7);
    sub_1BAB41C(&JsonManager_TypeInfo, v8);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventMissionConditionEntity__get_Count__, v9);
    sub_1BAB41C(&Method_System_Collections_Generic_List_EventMissionConditionEntity__get_Item__, v10);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1BAB41C(&Method_EventInfoQPPointCounter___c__GetNextPoint_b__24_0__, v12);
    sub_1BAB41C(&EventInfoQPPointCounter___c_TypeInfo, v13);
    sub_1BAB41C(&StringLiteral_10824/*"QPEVENT_NEXT_DISPLAY_DATA"*/, v14);
    byte_4AB7305 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
  ...
  if ( MasterData_object )
  {
    ...
    if ( !_9__24_0 )
    {
      ...
      _9__24_0 = (System_Func_T__TResult__o *)sub_1BAB668(System_Func_EventMissionConditionEntity__long__TypeInfo);
      ...
      sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__24_0, (int32_t)_9__24_0, v24, v25);
    }
    v26 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OrderByDescending_object__long_(
                                                                 ...
                                                                 (const MethodInfo_2EEE268 *)Method_System_Linq_Enumerable_OrderByDescending_EventMissionConditionEntity__long___);
    Instance = System_Linq_Enumerable__ToList_object_(
                 v26,
                 (const MethodInfo_2F00A04 *)Method_System_Linq_Enumerable_ToList_EventMissionConditionEntity___);
    if ( !Instance )
      goto LABEL_40;
...
LABEL_40:
  ...
  v29 = 0LL;
LABEL_22:
  Value = (Il2CppObject *)ConstantStrMaster__getValue((System_String_o *)StringLiteral_10824/*"QPEVENT_NEXT_DISPLAY_DATA"*/, 0LL);
  if ( !System_String__IsNullOrEmpty((System_String_o *)Value, 0LL) )
  {
    ...
    Instance = JsonManager__DeserializeArray_object_(
                 Value,
                 (const MethodInfo_2F2AABC *)Method_JsonManager_DeserializeArray_EventInfoQPPointCounter_NextDisplayData___);
    if ( !Instance )
      goto LABEL_40;
      ...
      while ( 1 )
      {
        ...
        if ( v35[4] == this->fields.eventId )
        {
          ...
          if ( ((unsigned __int8)Instance & 1) != 0 )
          {
            ...
            if ( !CondType_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
            Instance = (void *)CondType__IsQuestClear_37980612(v37, -1, 0, 0LL);
            if ( ((unsigned __int8)Instance & 1) == 0 )
              v29 = 0LL;
          }
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7300 & 1) == 0 )
  {
    this = (EventInfoQPPointCounter_o *)sub_1BAB41C(&int_TypeInfo, val);
    byte_4AB7300 = 1;
  }
  if ( !val )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7302 & 1) == 0 )
  {
    sub_1BAB41C(&AtlasManager_TypeInfo, number);
    sub_1BAB41C(&Method_System_Linq_Enumerable_Count_UISprite___, v7);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v8);
    sub_1BAB41C(&StringLiteral_22720/*"qp_counter_comma"*/, v9);
    sub_1BAB41C(&StringLiteral_22716/*"qp_counter_"*/, v10);
    this = (EventInfoQPPointCounter_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v11);
    byte_4AB7302 = 1;
  }
  DigitNumber = 0LL;
  if ( sprites )
  {
    ...
    transform = (UnityEngine_Transform_o *)System_Linq_Enumerable__Count_object_(
                                             ...
                                             (const MethodInfo_2EE08C0 *)Method_System_Linq_Enumerable_Count_UISprite___);
    if ( (int)transform >= 1 )
    {
      v14 = 0LL;
      v15 = 0;
      ...
      while ( v14 < sprites->max_length )
      {
        ...
        if ( ((unsigned __int8)transform & 1) == 0 )
        {
          ...
          if ( (__int64)v14 <= Digit )
          {
            ...
            v21 = System_String__Concat_62048128((System_String_o *)StringLiteral_22716/*"qp_counter_"*/, v20, 0LL);
          ...
          if ( ((unsigned __int8)transform & 1) == 0 )
          {
            ...
            else
            {
              ...
              transform = (UnityEngine_Transform_o *)AtlasManager__SetEventUI(
                                                       v28,
                                                       (System_String_o *)StringLiteral_22720/*"qp_counter_comma"*/,
                                                       0LL);
...
void __fastcall EventInfoQPPointCounter__Start(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB72FF & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_22718/*"qp_counter_bg_main"*/, v4);
    sub_1BAB41C(&StringLiteral_22719/*"qp_counter_bg_next"*/, v5);
    sub_1BAB41C(&StringLiteral_22717/*"qp_counter_bg_limit"*/, v6);
    byte_4AB72FF = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(PointCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v8, (System_String_o *)StringLiteral_22718/*"qp_counter_bg_main"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v12, (System_String_o *)StringLiteral_22719/*"qp_counter_bg_next"*/, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterSp, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v14, (System_String_o *)StringLiteral_22717/*"qp_counter_bg_limit"*/, 0LL);
...
void __fastcall EventInfoQPPointCounter__UpdateDisp(EventInfoQPPointCounter_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7301 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_5671/*"EVENT_QPPOINT_NEXT_FORMAT"*/, v5);
    sub_1BAB41C(&StringLiteral_5670/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, v6);
    byte_4AB7301 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(NextCounterLabel, 0LL, 0LL) )
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_5671/*"EVENT_QPPOINT_NEXT_FORMAT"*/, 0LL);
    v30 = NextPoint;
  ...
  if ( UnityEngine_Object__op_Inequality(LimitCounterLabel, 0LL, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_5670/*"EVENT_QPPOINT_LIMIT_FORMAT"*/, 0LL);
    v30 = v11;
...
void __fastcall EventInfoQPPointCounter___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB7308 & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoQPPointCounter___c_TypeInfo, v1);
    byte_4AB7308 = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(EventInfoQPPointCounter___c_TypeInfo);
