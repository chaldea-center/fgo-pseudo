        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE94B9 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&StringLiteral_8848/*"MYROOM_FAVORITE_STATUS"*/);
    byte_4CE94B9 = 1;
  }
  if ( item && mode )
  {
                ...
                if ( servantFaceIcon )
                {
                  ...
                  if ( servantFaceIcon )
                  {
                    ...
                    servantFaceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                      (System_String_o *)StringLiteral_8848/*"MYROOM_FAVORITE_STATUS"*/,
                                                                      0);
                    if ( statusLb )
                    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE94BB & 1) == 0 )
  {
    ...
    this = (FavoriteChangeListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_11603/*"SELECT_SERVANT_EVENT_JOIN"*/);
    byte_4CE94BB = 1;
  }
  if ( !item )
    goto LABEL_38;
