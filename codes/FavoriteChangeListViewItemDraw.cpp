        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1752A & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v7);
    sub_1BCAFF8(&StringLiteral_8753/*"MYROOM_FAVORITE_STATUS"*/, v8);
    byte_4B1752A = 1;
  }
  if ( item && mode )
  {
          ...
          if ( servantFaceIcon )
          {
            ...
            if ( servantFaceIcon )
            {
              ...
              if ( UnityEngine_Object__op_Inequality(partyIcon, 0LL, 0LL) )
              {
                ...
                if ( !servantFaceIcon )
                  goto LABEL_54;
                FlashingIconComponent__Set_40087648(
              ...
              if ( servantFaceIcon )
              {
                ...
                if ( servantFaceIcon )
                {
                  ...
                  servantFaceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_8753/*"MYROOM_FAVORITE_STATUS"*/,
                                                                    0LL);
                  if ( statusLb )
                  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1752C & 1) == 0 )
  {
    ...
    this = (FavoriteChangeListViewItemDraw_o *)sub_1BCAFF8(&StringLiteral_11448/*"SELECT_SERVANT_EVENT_JOIN"*/, v6);
    byte_4B1752C = 1;
  }
  if ( !item )
    goto LABEL_38;
