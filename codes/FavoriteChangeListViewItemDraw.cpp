...
void FavoriteChangeListViewItemDraw__Awake(FavoriteChangeListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4(&this->fields.defaultMaskAtlas, mAtlas);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C32928 & 1) == 0 )
  {
    ...
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_8823/*"MYROOM_FAVORITE_STATUS"*/);
    byte_4C32928 = 1;
  }
  if ( item && mode )
  {
                ...
                if ( servantFaceIcon )
                {
                  ...
                  if ( servantFaceIcon )
                  {
                    ...
                    servantFaceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                      (System_String_o *)StringLiteral_8823/*"MYROOM_FAVORITE_STATUS"*/,
                                                                      0);
                    if ( statusLb )
                    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3292A & 1) == 0 )
  {
    ...
    this = (FavoriteChangeListViewItemDraw_o *)sub_1C32C20(&StringLiteral_11552/*"SELECT_SERVANT_EVENT_JOIN"*/);
    byte_4C3292A = 1;
  }
  if ( !item )
    goto LABEL_38;
