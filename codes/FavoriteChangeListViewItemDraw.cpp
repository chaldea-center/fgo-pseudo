        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61F1B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v7);
    sub_1BE4ACC(&StringLiteral_8931/*"MYROOM_FAVORITE_STATUS"*/, v8);
    byte_4B61F1B = 1;
  }
  if ( item && mode )
  {
          ...
          if ( servantFaceIcon )
          {
            ...
            if ( servantFaceIcon )
            {
              ...
              if ( UnityEngine_Object__op_Inequality(partyIcon, 0LL, 0LL) )
              {
                ...
                if ( !servantFaceIcon )
                  goto LABEL_54;
                FlashingIconComponent__Set_39029432(
              ...
              if ( servantFaceIcon )
              {
                ...
                if ( servantFaceIcon )
                {
                  ...
                  servantFaceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_8931/*"MYROOM_FAVORITE_STATUS"*/,
                                                                    0LL);
                  if ( statusLb )
                  {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&LocalizationManager_TypeInfo, item);
    sub_1BE4ACC(&StringLiteral_11666/*"SELECT_CANNOT"*/, v5);
    this = (FavoriteChangeListViewItemDraw_o *)sub_1BE4ACC(&StringLiteral_11690/*"SELECT_SERVANT_EVENT_JOIN"*/, v6);
    byte_4B61F1D = 1;
  }
  if ( !item )
    goto LABEL_38;
  if ( item->fields.isPushMode )
  {
    ...
    if ( userSvtEntity && UserServantEntity__IsEventJoin(userSvtEntity, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = &StringLiteral_11690/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_36:
...
LABEL_31:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = &StringLiteral_11666/*"SELECT_CANNOT"*/;
      goto LABEL_36;
    }
  }
