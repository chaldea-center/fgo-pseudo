        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B78A & 1) == 0 )
  {
    ...
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&StringLiteral_8875/*"MYROOM_FAVORITE_STATUS"*/);
    byte_4D2B78A = 1;
  }
  if ( item && mode )
  {
                ...
                if ( servantFaceIcon )
                {
                  ...
                  if ( servantFaceIcon )
                  {
                    ...
                    servantFaceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                      (System_String_o *)StringLiteral_8875/*"MYROOM_FAVORITE_STATUS"*/,
                                                                      0);
                    if ( statusLb )
                    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B78C & 1) == 0 )
  {
    ...
    this = (FavoriteChangeListViewItemDraw_o *)sub_1C93AD4(&StringLiteral_11640/*"SELECT_SERVANT_EVENT_JOIN"*/);
    byte_4D2B78C = 1;
  }
  if ( !item )
    goto LABEL_38;
