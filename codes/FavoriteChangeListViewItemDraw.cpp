        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51C92 & 1) == 0 )
  {
    ...
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&StringLiteral_8824/*"MYROOM_FAVORITE_STATUS"*/);
    byte_4C51C92 = 1;
  }
  if ( item && mode )
  {
            ...
            if ( servantFaceIcon )
            {
              ...
              if ( servantFaceIcon )
              {
                ...
                if ( UnityEngine_Object__op_Inequality(partyIcon, 0, 0) )
                {
                  ...
                  if ( !servantFaceIcon )
                    goto LABEL_55;
                  FlashingIconComponent__Set_40947528(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C51C94 & 1) == 0 )
  {
    ...
    this = (FavoriteChangeListViewItemDraw_o *)sub_1C3E564(&StringLiteral_11555/*"SELECT_SERVANT_EVENT_JOIN"*/);
    byte_4C51C94 = 1;
  }
  if ( !item )
    goto LABEL_38;
  if ( item->fields.isPushMode )
  {
    ...
    if ( userSvtEntity && UserServantEntity__IsEventJoin(userSvtEntity, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v7 = &StringLiteral_11555/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_36:
...
LABEL_31:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v7 = &StringLiteral_11523/*"SELECT_CANNOT"*/;
      goto LABEL_36;
    }
  }
