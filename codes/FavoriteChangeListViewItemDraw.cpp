...
void FavoriteChangeListViewItemDraw__Awake(FavoriteChangeListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434(&this->fields.defaultMaskAtlas);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22259 & 1) == 0 )
  {
    ...
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_8817/*"MYROOM_FAVORITE_STATUS"*/);
    byte_4C22259 = 1;
  }
  if ( item && mode )
  {
            ...
            if ( servantFaceIcon )
            {
              ...
              if ( servantFaceIcon )
              {
                ...
                if ( UnityEngine_Object__op_Inequality(partyIcon, 0, 0) )
                {
                  ...
                  if ( !servantFaceIcon )
                    goto LABEL_55;
                  FlashingIconComponent__Set_40679456(
                ...
                if ( servantFaceIcon )
                {
                  ...
                  if ( servantFaceIcon )
                  {
                    ...
                    servantFaceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                      (System_String_o *)StringLiteral_8817/*"MYROOM_FAVORITE_STATUS"*/,
                                                                      0);
                    if ( statusLb )
                    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2225B & 1) == 0 )
  {
    ...
    this = (FavoriteChangeListViewItemDraw_o *)sub_1C2D490(&StringLiteral_11546/*"SELECT_SERVANT_EVENT_JOIN"*/);
    byte_4C2225B = 1;
  }
  if ( !item )
    goto LABEL_38;
  if ( item->fields.isPushMode )
  {
    ...
    if ( userSvtEntity && UserServantEntity__IsEventJoin(userSvtEntity, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v7 = &StringLiteral_11546/*"SELECT_SERVANT_EVENT_JOIN"*/;
LABEL_36:
...
LABEL_31:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v7 = &StringLiteral_11514/*"SELECT_CANNOT"*/;
      goto LABEL_36;
    }
  }
