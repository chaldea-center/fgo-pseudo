        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0022B & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_22093/*"num"*/, *(_QWORD *)&gachaId);
    sub_1B64A00(&StringLiteral_17328/*"boxGachaId"*/, v7);
    byte_4A0022B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17328/*"boxGachaId"*/, gachaId, 0LL);
...
System_String_o *__fastcall BoxGachaDrawRequest__getURL(BoxGachaDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0022A & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_17325/*"boxGacha/draw"*/, v2);
    byte_4A0022A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_17325/*"boxGacha/draw"*/, 0LL);
}
