        ...
        const MethodInfo *method)
{
  if ( (byte_4CF00B8 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_17451/*"boxGachaId"*/);
    byte_4CF00B8 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17451/*"boxGachaId"*/, gachaId, 0);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22543/*"num"*/, num, 0);
...
System_String_o *BoxGachaDrawRequest__getURL(BoxGachaDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CF00B7 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_17448/*"boxGacha/draw"*/);
    byte_4CF00B7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_17448/*"boxGacha/draw"*/, 0);
}
