        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FE3C & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_17153/*"boxGachaId"*/, v7);
    byte_4A4FE3C = 1;
  }
...
System_String_o *__fastcall BoxGachaDrawRequest__getURL(BoxGachaDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4FE3B & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_17150/*"boxGacha/draw"*/, v2);
    byte_4A4FE3B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_17150/*"boxGacha/draw"*/, 0LL);
}
