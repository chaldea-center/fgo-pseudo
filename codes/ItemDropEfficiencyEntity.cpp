        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E23F & 1) == 0 )
  {
    sub_1B761C0(&Method_DataEntityBase_CreateMultiplePK_int__int__int___, *(_QWORD *)&targetType);
    byte_4A2E23F = 1;
  }
...
bool __fastcall ItemDropEfficiencyEntity__IsMainScenario(ItemDropEfficiencyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A2E23D & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_21248/*"mainScenario"*/, method);
    byte_4A2E23D = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21248/*"mainScenario"*/, 0, 0LL) > 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2E23E & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_22134/*"notDisplayQuestInfo"*/, method);
    byte_4A2E23E = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22134/*"notDisplayQuestInfo"*/, 0, 0LL) > 0;
}