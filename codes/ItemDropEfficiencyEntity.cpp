...
bool ItemDropEfficiencyEntity__IsLoginBonus(ItemDropEfficiencyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4D2CCDD & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_21546/*"loginBonus"*/);
    byte_4D2CCDD = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21546/*"loginBonus"*/, 0, 0) > 0;
}
...
bool ItemDropEfficiencyEntity__IsMainScenario(ItemDropEfficiencyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4D2CCDB & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_21603/*"mainScenario"*/);
    byte_4D2CCDB = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21603/*"mainScenario"*/, 0, 0) > 0;
}
...
bool ItemDropEfficiencyEntity__IsNotDisplayQuestInfo(ItemDropEfficiencyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4D2CCDC & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_22511/*"notDisplayQuestInfo"*/);
    byte_4D2CCDC = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22511/*"notDisplayQuestInfo"*/, 0, 0) > 0;
}