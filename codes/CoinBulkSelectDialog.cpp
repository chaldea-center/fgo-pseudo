        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31414 & 1) == 0 )
  {
    sub_1B761C0(&Method_ActionExtensions_Call_int___, action);
    sub_1B761C0(&System_Action_TypeInfo, v5);
    sub_1B761C0(&Method_CoinBulkSelectDialog_EndClose__, v6);
    byte_4A31414 = 1;
  }
  this->fields.state = 4;
...
void __fastcall CoinBulkSelectDialog__Init(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.userSvtCoinEntity, 0, v5, v6);
...
void __fastcall CoinBulkSelectDialog__OnClickCancel(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A31416 & 1) == 0 )
  {
    sub_1B761C0(&Method_CoinBulkSelectDialog_OnClickCancel__, method);
    byte_4A31416 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B761D8(Method_CoinBulkSelectDialog_OnClickCancel__);
...
void __fastcall CoinBulkSelectDialog__OnClickDecide(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A31415 & 1) == 0 )
  {
    sub_1B761C0(&Method_CoinBulkSelectDialog_OnClickDecide__, method);
    byte_4A31415 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B761D8(Method_CoinBulkSelectDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B761A4(v3, v3[4]);
    ...
    if ( onDecideAction )
    {
      ...
      sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.onDecideAction, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31413 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_CoinBulkSelectDialog_EndOpen__, v11);
    sub_1B761C0(&CoinRoomCoinIconItem_TypeInfo, v12);
    sub_1B761C0(&CoinRoomUtility_TypeInfo, v13);
    sub_1B761C0(&Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___, v14);
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_BoxCollider___, v15);
    sub_1B761C0(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, v16);
    ...
    sub_1B761C0(&StringLiteral_3636/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, v24);
    sub_1B761C0(&StringLiteral_3633/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_NAME"*/, v25);
    sub_1B761C0(&StringLiteral_3634/*"COIN_ROOM_SELECT_DIALOD_SELECT_INFO_TXET"*/, v26);
    byte_4A31413 = 1;
  }
  entitya = 0LL;
  if ( !this->fields.state )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.userSvtCoinEntity, (int32_t)entity, v28, v29);
    ...
    if ( gameObject )
    {
      ...
      this->fields.isOpen = 0;
      sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.iconObject, (int32_t)iconObject, v32, v33);
      if ( iconObject )
      {
        ...
        gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_3636/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, 0LL);
        if ( subTitleLabel )
        {
          UILabel__set_text(subTitleLabel, (System_String_o *)gameObject, 0LL);
          selectInfoLabel = this->fields.selectInfoLabel;
          gameObject = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_3634/*"COIN_ROOM_SELECT_DIALOD_SELECT_INFO_TXET"*/, 0LL);
          if ( selectInfoLabel )
          {
            ...
            if ( gameObject )
            {
              gameObject = (int64_t)UnityEngine_Component__GetComponentInChildren_object__48599312(
                                      (UnityEngine_Component_o *)gameObject,
                                      (const MethodInfo_2E59110 *)Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___);
              if ( gameObject )
              {
                          ...
                          if ( gameObject )
                          {
                            ...
                            if ( MasterData_object )
                            {
                              ...
                              if ( v41 )
                              {
                                ...
                                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                v44 = LocalizationManager__Get((System_String_o *)StringLiteral_3633/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_NAME"*/, 0LL);
                                ...
                                if ( itemName )
                                {
                                  ...
                                  if ( *p_userSvtCoinEntity )
                                  {
                                    ...
                                    gameObject = System_Math__Min_62354036(maxPoint - currentPoint, num, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31418 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_3632/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/, v8);
    sub_1B761C0(&StringLiteral_3631/*"COIN_ROOM_SELECT_DIALOD_REMAINING_TEXT"*/, v9);
    byte_4A31418 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3631/*"COIN_ROOM_SELECT_DIALOD_REMAINING_TEXT"*/, 0LL);
  ...
  if ( !remainingLabel
    || (UILabel__set_text(remainingLabel, v16, 0LL),
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3632/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/, 0LL),
