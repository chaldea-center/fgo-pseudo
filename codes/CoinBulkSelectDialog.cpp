        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B483D9 & 1) == 0 )
  {
    sub_1BDB878(&Method_ActionExtensions_Call_int___, action);
    sub_1BDB878(&System_Action_TypeInfo, v5);
    sub_1BDB878(&Method_CoinBulkSelectDialog_EndClose__, v6);
    byte_4B483D9 = 1;
  }
  this->fields.state = 4;
...
void __fastcall CoinBulkSelectDialog__Init(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.userSvtCoinEntity, 0, v5, v6);
...
void __fastcall CoinBulkSelectDialog__OnClickCancel(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B483DB & 1) == 0 )
  {
    sub_1BDB878(&Method_CoinBulkSelectDialog_OnClickCancel__, method);
    byte_4B483DB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_CoinBulkSelectDialog_OnClickCancel__);
...
void __fastcall CoinBulkSelectDialog__OnClickDecide(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B483DA & 1) == 0 )
  {
    sub_1BDB878(&Method_CoinBulkSelectDialog_OnClickDecide__, method);
    byte_4B483DA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_CoinBulkSelectDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
    ...
    if ( onDecideAction )
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.onDecideAction, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B483D8 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CoinBulkSelectDialog_EndOpen__, v11);
    sub_1BDB878(&CoinRoomCoinIconItem_TypeInfo, v12);
    sub_1BDB878(&CoinRoomUtility_TypeInfo, v13);
    sub_1BDB878(&Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___, v14);
    sub_1BDB878(&Method_UnityEngine_Component_GetComponent_BoxCollider___, v15);
    sub_1BDB878(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, v16);
    ...
    sub_1BDB878(&StringLiteral_3589/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, v24);
    sub_1BDB878(&StringLiteral_3586/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_NAME"*/, v25);
    sub_1BDB878(&StringLiteral_3587/*"COIN_ROOM_SELECT_DIALOD_SELECT_INFO_TXET"*/, v26);
    byte_4B483D8 = 1;
  }
  entitya = 0LL;
  if ( !this->fields.state )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.userSvtCoinEntity, (int32_t)entity, v28, v29);
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( gameObject )
    {
      ...
      this->fields.isOpen = 0;
      sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.iconObject, (int32_t)iconObject, v32, v33);
      if ( iconObject )
      {
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3589/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, 0LL);
        if ( subTitleLabel )
        {
          UILabel__set_text(subTitleLabel, (System_String_o *)gameObject, 0LL);
          selectInfoLabel = this->fields.selectInfoLabel;
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3587/*"COIN_ROOM_SELECT_DIALOD_SELECT_INFO_TXET"*/, 0LL);
          if ( selectInfoLabel )
          {
            ...
            if ( gameObject )
            {
              gameObject = (UnityEngine_GameObject_o *)UnityEngine_Component__GetComponentInChildren_object__50504592(
                                                         ...
                                                         (const MethodInfo_302A390 *)Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___);
              if ( gameObject )
              {
                          ...
                          if ( gameObject )
                          {
                            ...
                            if ( MasterData_object )
                            {
                              ...
                              if ( v41 )
                              {
                                ...
                                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                v44 = LocalizationManager__Get((System_String_o *)StringLiteral_3586/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_NAME"*/, 0LL);
                                ...
                                if ( itemName )
                                {
                                  ...
                                  if ( *p_userSvtCoinEntity )
                                  {
                                    ...
                                    gameObject = (UnityEngine_GameObject_o *)System_Math__Min_64100908(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B483DD & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_3585/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/, v8);
    sub_1BDB878(&StringLiteral_3584/*"COIN_ROOM_SELECT_DIALOD_REMAINING_TEXT"*/, v9);
    byte_4B483DD = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3584/*"COIN_ROOM_SELECT_DIALOD_REMAINING_TEXT"*/, 0LL);
  ...
  if ( !remainingLabel
    || (UILabel__set_text(remainingLabel, v16, 0LL),
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3585/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/, 0LL),
