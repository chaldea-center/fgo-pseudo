        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A219 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ActionExtensions_Call_int___, action);
    sub_1BE4ACC(&System_Action_TypeInfo, v5);
    sub_1BE4ACC(&Method_CoinBulkSelectDialog_EndClose__, v6);
    byte_4B6A219 = 1;
  }
  this->fields.state = 4;
...
void __fastcall CoinBulkSelectDialog__Init(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.userSvtCoinEntity, 0LL, v5, v6, v7, v8, v9, v10);
...
void __fastcall CoinBulkSelectDialog__OnClickCancel(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A21B & 1) == 0 )
  {
    sub_1BE4ACC(&Method_CoinBulkSelectDialog_OnClickCancel__, method);
    byte_4B6A21B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_CoinBulkSelectDialog_OnClickCancel__);
...
void __fastcall CoinBulkSelectDialog__OnClickDecide(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A21A & 1) == 0 )
  {
    sub_1BE4ACC(&Method_CoinBulkSelectDialog_OnClickDecide__, method);
    byte_4B6A21A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_CoinBulkSelectDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v3, v3[4]);
    ...
    if ( onDecideAction )
    {
      ...
      sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.onDecideAction, 0LL, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A218 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CoinBulkSelectDialog_EndOpen__, v13);
    sub_1BE4ACC(&CoinRoomCoinIconItem_TypeInfo, v14);
    sub_1BE4ACC(&CoinRoomUtility_TypeInfo, v15);
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___, v16);
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_BoxCollider___, v17);
    sub_1BE4ACC(&Method_DataManager_GetMasterData_ServantLimitImageMaster___, v18);
    ...
    sub_1BE4ACC(&StringLiteral_3676/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, v26);
    sub_1BE4ACC(&StringLiteral_3673/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_NAME"*/, v27);
    sub_1BE4ACC(&StringLiteral_3674/*"COIN_ROOM_SELECT_DIALOD_SELECT_INFO_TXET"*/, v28);
    byte_4B6A218 = 1;
  }
  entitya = 0LL;
  if ( !this->fields.state )
  {
    ...
    if ( gameObject )
    {
      ...
      if ( iconObject )
      {
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3676/*"COIN_ROOM_SELECT_LIST_SUB_TITLE"*/, 0LL);
        if ( subTitleLabel )
        {
          UILabel__set_text(subTitleLabel, (System_String_o *)gameObject, 0LL);
          selectInfoLabel = this->fields.selectInfoLabel;
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3674/*"COIN_ROOM_SELECT_DIALOD_SELECT_INFO_TXET"*/, 0LL);
          if ( selectInfoLabel )
          {
            ...
            if ( gameObject )
            {
              gameObject = (UnityEngine_GameObject_o *)UnityEngine_Component__GetComponentInChildren_object__49610264(
                                                         (UnityEngine_Component_o *)gameObject,
                                                         (const MethodInfo_2F4FE18 *)Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___);
              if ( gameObject )
              {
                          ...
                          if ( gameObject )
                          {
                            ...
                            if ( MasterData_object )
                            {
                              ...
                              if ( v51 )
                              {
                                ...
                                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                v54 = LocalizationManager__Get((System_String_o *)StringLiteral_3673/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_NAME"*/, 0LL);
                                ...
                                if ( itemName )
                                {
                                  ...
                                  if ( *p_userSvtCoinEntity )
                                  {
                                    ...
                                    gameObject = (UnityEngine_GameObject_o *)System_Math__Min_63518280(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A21D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_3672/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/, v8);
    sub_1BE4ACC(&StringLiteral_3671/*"COIN_ROOM_SELECT_DIALOD_REMAINING_TEXT"*/, v9);
    byte_4B6A21D = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3671/*"COIN_ROOM_SELECT_DIALOD_REMAINING_TEXT"*/, 0LL);
  ...
  if ( !remainingLabel
    || (UILabel__set_text(remainingLabel, v16, 0LL),
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3672/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/, 0LL),
