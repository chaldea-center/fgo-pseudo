...
void CoinBulkSelectDialog__Close(CoinBulkSelectDialog_o *this, System_Action_int__o *action, const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9E4 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_CoinBulkSelectDialog_EndClose__);
    byte_4C5A9E4 = 1;
  }
  this->fields.state = 4;
...
void CoinBulkSelectDialog__Init(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.userSvtCoinEntity, 0, v5, v6);
...
void CoinBulkSelectDialog__OnClickCancel(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9E6 & 1) == 0 )
  {
    sub_1C3E564(&Method_CoinBulkSelectDialog_OnClickCancel__);
    byte_4C5A9E6 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_CoinBulkSelectDialog_OnClickCancel__);
...
void CoinBulkSelectDialog__OnClickDecide(CoinBulkSelectDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9E5 & 1) == 0 )
  {
    sub_1C3E564(&Method_CoinBulkSelectDialog_OnClickDecide__);
    byte_4C5A9E5 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinBulkSelectDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_CoinBulkSelectDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3E548(v3, v3[4]);
    ...
    if ( onDecideAction )
    {
      ...
      sub_1C3E508((CGThumbnailListItem_o *)&this->fields.onDecideAction, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_CoinBulkSelectDialog_EndOpen__);
    sub_1C3E564(&CoinRoomCoinIconItem_TypeInfo);
    sub_1C3E564(&CoinRoomUtility_TypeInfo);
    sub_1C3E564(&Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___);
    ...
    sub_1C3E564(&StringLiteral_3554/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_NAME"*/);
    sub_1C3E564(&StringLiteral_3555/*"COIN_ROOM_SELECT_DIALOD_SELECT_INFO_TXET"*/);
    byte_4C5A9E3 = 1;
  }
  entitya = 0;
  if ( !this->fields.state )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.userSvtCoinEntity, (int32_t)entity, v12, v13);
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
    if ( gameObject )
    {
      ...
      this->fields.isOpen = 0;
      sub_1C3E508((CGThumbnailListItem_o *)&this->fields.iconObject, (int32_t)iconObject, v16, v17);
      if ( iconObject )
      {
          ...
          if ( selectInfoLabel )
          {
            ...
            if ( gameObject )
            {
              gameObject = (UnityEngine_GameObject_o *)UnityEngine_Component__GetComponentInChildren_object__51315876(
                                                         ...
                                                         (const MethodInfo_30F04A4 *)Method_UnityEngine_Component_GetComponentInChildren_CoinRoomCoinIconDraw___);
              if ( gameObject )
              {
                              ...
                              if ( v25 )
                              {
                                ...
                                if ( itemName )
                                {
                                  ...
                                  if ( *p_userSvtCoinEntity )
                                  {
                                    ...
                                    gameObject = (UnityEngine_GameObject_o *)System_Math__Min_65160228(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9E8 & 1) == 0 )
  {
    ...
    sub_1C3E564(&LocalizationManager_TypeInfo);
    sub_1C3E564(&StringLiteral_3553/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/);
    sub_1C3E564(&StringLiteral_3552/*"COIN_ROOM_SELECT_DIALOD_REMAINING_TEXT"*/);
    byte_4C5A9E8 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  v28 = this->fields.maxPoint - point;
  v15 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v28, v9, v10, v11, v12, v13, v14);
  v16 = System_String__Format(v7, v15, 0);
  if ( !remainingLabel
    || (UILabel__set_text(remainingLabel, v16, 0),
        v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3553/*"COIN_ROOM_SELECT_DIALOD_SELECTED_ITEM_COUNT"*/, 0),
        itemCount = this->fields.itemCount,
        v27 = count,
        v26 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v27, v20, v21, v22, v23, v24, v25),
        v16 = System_String__Format(v18, v26, 0),
        !itemCount) )
  {
    sub_1C3E7C0(v16, v17);
  }
