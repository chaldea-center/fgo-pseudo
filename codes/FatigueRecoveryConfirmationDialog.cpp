void __fastcall FatigueRecoveryConfirmationDialog___cctor(const MethodInfo *method)
{
  if ( (byte_42B039A & 1) == 0 )
  {
    sub_B52984(&FatigueRecoveryConfirmationDialog_TypeInfo);
    byte_42B039A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0399 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_CommonConfirmDialog_EndOpen__);
    sub_B52984(&FatigueRecoveryConfirmationDialog_TypeInfo);
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_EventServantFatigueChangeDialogItem___);
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_11831/*"SERVANT_RECOVERY_FATIGUE_DIALOG_CONFIRM"*/);
    sub_B52984(&StringLiteral_11828/*"SERVANT_OUT_RECOVERY_FATIGUE_TEXT"*/);
    sub_B52984(&StringLiteral_3295/*"COMMON_CONFIRM_DECIDE"*/);
    sub_B52984(&StringLiteral_3294/*"COMMON_CONFIRM_CLOSE"*/);
    sub_B52984(&StringLiteral_11835/*"SERVANT_RECOVERY_FATIGUE_LIST_PICKUP_COLOR"*/);
    sub_B52984(&StringLiteral_11749/*"SERVANT_CHANGE_RECOVERY_FATIGUE_TEXT"*/);
    sub_B52984(&StringLiteral_11820/*"SERVANT_IN_RECOVERY_FATIGUE_TEXT"*/);
    byte_42B0399 = 1;
  }
  ...
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11835/*"SERVANT_RECOVERY_FATIGUE_LIST_PICKUP_COLOR"*/, 0LL);
  ...
  if ( inSvtEnt )
  {
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11820/*"SERVANT_IN_RECOVERY_FATIGUE_TEXT"*/, 0LL);
    if ( !inLabel )
      goto LABEL_73;
    ...
    if ( UnityEngine_Object__op_Inequality(0LL, inSvtIcon, 0LL) )
    {
      ...
      UnityEngine_Object__DestroyImmediate_35617168((UnityEngine_Object_o *)v24, 0LL);
    }
    ...
    GameObjectExtensions__SetLocalPosition_32084952(v32, v33->static_fields->SVT_ICON_POS, 0LL);
    GameObjectExtensions__SetLocalScale_32087216(
      *p_inSvtIcon,
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                     inRootGameObject,
                                                     (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_EventServantFatigueChangeDialogItem___);
    if ( !inRootGameObject )
      goto LABEL_73;
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)System_String__Concat_44568316(v20, inAfterTime, 0LL);
    if ( !inAfterTimeLabel )
      goto LABEL_73;
  ...
  if ( outSvtEnt )
  {
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11828/*"SERVANT_OUT_RECOVERY_FATIGUE_TEXT"*/, 0LL);
    if ( !outLabel )
      goto LABEL_73;
    ...
    if ( UnityEngine_Object__op_Inequality(0LL, outSvtIcon, 0LL) )
    {
      ...
      UnityEngine_Object__DestroyImmediate_35617168((UnityEngine_Object_o *)v38, 0LL);
    }
    ...
    GameObjectExtensions__SetLocalPosition_32084952(v46, v47->static_fields->SVT_ICON_POS, 0LL);
    GameObjectExtensions__SetLocalScale_32087216(
      *p_outSvtIcon,
      FatigueRecoveryConfirmationDialog_TypeInfo->static_fields->SVT_ICON_SCALE,
      0LL);
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)System_String__Concat_44568316(v20, outBeforeTime, 0LL);
        ...
        if ( inRootGameObject )
        {
          ...
          if ( inRootGameObject )
          {
            ...
            inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_11749/*"SERVANT_CHANGE_RECOVERY_FATIGUE_TEXT"*/,
                                                             0LL);
            if ( v51 )
            {
...
LABEL_73:
      sub_B52A5C(inRootGameObject, v19);
    }
  }
  inRootGameObject = (UnityEngine_GameObject_o *)this->fields.outRootGameObject;
  if ( !inRootGameObject )
...
LABEL_65:
  ...
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11831/*"SERVANT_RECOVERY_FATIGUE_DIALOG_CONFIRM"*/, 0LL);
  if ( !confirmLabel )
    goto LABEL_73;
  UILabel__set_text(confirmLabel, (System_String_o *)inRootGameObject, 0LL);
  buttonDecideLabel = this->fields.buttonDecideLabel;
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3295/*"COMMON_CONFIRM_DECIDE"*/, 0LL);
  if ( !buttonDecideLabel )
    goto LABEL_73;
  UILabel__set_text(buttonDecideLabel, (System_String_o *)inRootGameObject, 0LL);
  buttonCancelLabel = this->fields.buttonCancelLabel;
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3294/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
