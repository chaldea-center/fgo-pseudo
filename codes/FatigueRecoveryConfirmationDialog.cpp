void FatigueRecoveryConfirmationDialog___cctor(const MethodInfo *method)
{
  if ( (byte_4CC1BF4 & 1) == 0 )
  {
    sub_1C713B0(&FatigueRecoveryConfirmationDialog_TypeInfo);
    byte_4CC1BF4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1BF3 & 1) == 0 )
  {
    ...
    sub_1C713B0(&FatigueRecoveryConfirmationDialog_TypeInfo);
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_EventServantFatigueChangeDialogItem___);
    sub_1C713B0(&LocalizationManager_TypeInfo);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    sub_1C713B0(&StringLiteral_11671/*"SERVANT_RECOVERY_FATIGUE_DIALOG_CONFIRM"*/);
    sub_1C713B0(&StringLiteral_11666/*"SERVANT_OUT_RECOVERY_FATIGUE_TEXT"*/);
    sub_1C713B0(&StringLiteral_3681/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C713B0(&StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C713B0(&StringLiteral_11675/*"SERVANT_RECOVERY_FATIGUE_LIST_PICKUP_COLOR"*/);
    sub_1C713B0(&StringLiteral_11586/*"SERVANT_CHANGE_RECOVERY_FATIGUE_TEXT"*/);
    sub_1C713B0(&StringLiteral_11658/*"SERVANT_IN_RECOVERY_FATIGUE_TEXT"*/);
    byte_4CC1BF3 = 1;
  }
  ...
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11675/*"SERVANT_RECOVERY_FATIGUE_LIST_PICKUP_COLOR"*/, 0);
  ...
  if ( inSvtEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11658/*"SERVANT_IN_RECOVERY_FATIGUE_TEXT"*/, 0);
    if ( !inLabel )
      goto LABEL_62;
    ...
    if ( UnityEngine_Object__op_Inequality(0, inSvtIcon, 0) )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      UnityEngine_Object__DestroyImmediate_71724796((UnityEngine_Object_o *)v25, 0);
    }
    ...
    sub_1C71354(&this->fields.inSvtIcon, Object);
    ...
    GameObjectExtensions__SetLocalPosition_36389872(v28, v27->static_fields->SVT_ICON_POS, 0);
    GameObjectExtensions__SetLocalScale_36391984(
      *p_inSvtIcon,
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     inRootGameObject,
                                                     (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_EventServantFatigueChangeDialogItem___);
    if ( !inRootGameObject )
      goto LABEL_62;
    v12 = isDecideSe;
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)System_String__Concat_64031724(v21, inAfterTime, 0);
    if ( !inAfterTimeLabel )
      goto LABEL_62;
  ...
  if ( outSvtEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11666/*"SERVANT_OUT_RECOVERY_FATIGUE_TEXT"*/, 0);
    if ( !outLabel )
      goto LABEL_62;
    ...
    if ( UnityEngine_Object__op_Inequality(0, outSvtIcon, 0) )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      UnityEngine_Object__DestroyImmediate_71724796((UnityEngine_Object_o *)v33, 0);
    }
    ...
    sub_1C71354(&this->fields.outSvtIcon, v34);
    ...
    GameObjectExtensions__SetLocalPosition_36389872(v36, v35->static_fields->SVT_ICON_POS, 0);
    GameObjectExtensions__SetLocalScale_36391984(
      *p_outSvtIcon,
      FatigueRecoveryConfirmationDialog_TypeInfo->static_fields->SVT_ICON_SCALE,
      0);
    ...
    inRootGameObject = (UnityEngine_GameObject_o *)System_String__Concat_64031724(v21, outBeforeTime, 0);
        ...
        if ( inRootGameObject )
        {
          ...
          if ( inRootGameObject )
          {
            ...
            inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_11586/*"SERVANT_CHANGE_RECOVERY_FATIGUE_TEXT"*/,
                                                             0);
            if ( v40 )
            {
...
LABEL_62:
      sub_1C71608(inRootGameObject, v20);
    }
  }
  inRootGameObject = (UnityEngine_GameObject_o *)this->fields.outRootGameObject;
  if ( !inRootGameObject )
...
LABEL_55:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11671/*"SERVANT_RECOVERY_FATIGUE_DIALOG_CONFIRM"*/, 0);
  if ( !confirmLabel )
    goto LABEL_62;
  UILabel__set_text(confirmLabel, (System_String_o *)inRootGameObject, 0);
  buttonDecideLabel = this->fields.buttonDecideLabel;
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3681/*"COMMON_CONFIRM_DECIDE"*/, 0);
  if ( !buttonDecideLabel )
    goto LABEL_62;
  UILabel__set_text(buttonDecideLabel, (System_String_o *)inRootGameObject, 0);
  buttonCancelLabel = this->fields.buttonCancelLabel;
  inRootGameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/, 0);
