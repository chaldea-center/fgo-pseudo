...
int32_t BattleScriptEntity__GetAiActId(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04681 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_16891/*"aiActId"*/);
    byte_4E04681 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_16891/*"aiActId"*/, 0, 0);
}
...
int32_t BattleScriptEntity__GetAiActIndividuality(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21078/*"individuality"*/, 0, 0);
}
...
int32_t BattleScriptEntity__GetAiActType(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24642/*"type"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4E04694 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_16900/*"aiScript"*/);
    byte_4E04694 = 1;
  }
  return EntityScriptUtil__GetInScript(this->fields.script, (System_String_o *)StringLiteral_16900/*"aiScript"*/, 0);
}
...
System_String_o *BattleScriptEntity__GetCameraMotionEventName(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E0468C & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_19407/*"eventName"*/);
    byte_4E0468C = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_19407/*"eventName"*/, 0, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04693 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_JsonManager_DeserializeArray_BattleScriptCameraTargetData___);
    sub_1CE6700(&JsonManager_TypeInfo);
    sub_1CE6700(&StringLiteral_17907/*"cameraTargetData"*/);
    byte_4E04693 = 1;
  }
  value = 0;
  ...
  if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
          ...
          (Il2CppObject *)StringLiteral_17907/*"cameraTargetData"*/,
          &value,
  ...
  return (BattleScriptCameraTargetData_array *)JsonManager__DeserializeArray_object_(
                                                 v4,
                                                 (const MethodInfo_3273D28 *)Method_JsonManager_DeserializeArray_BattleScriptCameraTargetData___);
}
...
System_String_o *BattleScriptEntity__GetCharaVoice(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04690 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_18131/*"charaVoice"*/);
    byte_4E04690 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_18131/*"charaVoice"*/, 0, 0);
}
...
int32_t BattleScriptEntity__GetCutInCamPlayerAll(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18632/*"cutInCamPlayerAll"*/, -1, 0);
}
...
int32_t BattleScriptEntity__GetCutInId(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18633/*"cutInId"*/, 0, 0);
}
...
int32_t BattleScriptEntity__GetCutInMessageMode(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18634/*"cutInMessageMode"*/, -1, 0);
}
...
System_String_o *BattleScriptEntity__GetCutInMessageText(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04688 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_18635/*"cutInMessageText"*/);
    byte_4E04688 = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_18635/*"cutInMessageText"*/, 0, 0);
}
...
UnityEngine_Vector3_array *BattleScriptEntity__GetCutInOffset(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  ScriptStringArray = BattleScriptEntity__GetScriptStringArray(this, (System_String_o *)StringLiteral_18637/*"cutInPrefabOffsets"*/, 0x2Fu, v2);
  ...
  if ( !IsNullOrEmpty )
  {
    ...
    v8 = (System_String_array *)sub_1CE67A8(UnityEngine_Vector3___TypeInfo, LODWORD(ScriptStringArray->max_length));
...
System_String_array *BattleScriptEntity__GetCutInPrefabInfo(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return BattleScriptEntity__GetScriptStringArray(this, (System_String_o *)StringLiteral_18636/*"cutInPrefabInfo"*/, 0x2Cu, v2);
}
...
System_String_array *BattleScriptEntity__GetCutInVoices(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return BattleScriptEntity__GetScriptStringArray(this, (System_String_o *)StringLiteral_18640/*"cutInVoices"*/, 0x2Fu, v2);
}
...
int32_t BattleScriptEntity__GetDelayTime(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04691 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_18776/*"delayTime"*/);
    byte_4E04691 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18776/*"delayTime"*/, 0, 0);
}
...
int32_t BattleScriptEntity__GetDispTime(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E0468F & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_18871/*"dispTime"*/);
    byte_4E0468F = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_18871/*"dispTime"*/, 0, 0);
}
...
float BattleScriptEntity__GetFovValue(BattleScriptEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetFloatValue(this->fields.script, (System_String_o *)StringLiteral_19902/*"fov"*/, -1.0, 0);
}
...
System_String_o *BattleScriptEntity__GetMessageText(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E0468E & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_21894/*"messageText"*/);
    byte_4E0468E = 1;
  }
  return EntityScriptUtil__GetStringValue(this->fields.script, (System_String_o *)StringLiteral_21894/*"messageText"*/, 0, 0);
}
...
int32_t BattleScriptEntity__GetNormalSpeedOnlyFirst(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04692 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_21251/*"isOnlyFirst"*/);
    byte_4E04692 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_21251/*"isOnlyFirst"*/, 0, 0);
}
...
int32_t BattleScriptEntity__GetWaitTime(BattleScriptEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4E04684 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_25132/*"waitTime"*/);
    byte_4E04684 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_25132/*"waitTime"*/, 0, 0);
}