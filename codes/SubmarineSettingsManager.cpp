void SubmarineSettingsManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3F936 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_12408/*"SUBMARINE_OPEN_PANEL_CAMERA_DURATION"*/);
    sub_1C37058(&StringLiteral_12410/*"SUBMARINE_VIEW_SCAN_RANGE_CAMERA_DURATION"*/);
    sub_1C37058(&StringLiteral_12409/*"SUBMARINE_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION"*/);
    byte_4C3F936 = 1;
  }
  static_fields = SubmarineSettingsManager_TypeInfo->static_fields;
  *(_QWORD *)&static_fields->DEFAULT_PANEL_WIDTH = 0x5200000052LL;
  *(_OWORD *)&static_fields->DEFAULT_PANEL_SELECT_DELAY_SECOND = xmmword_C0E090;
  *(_QWORD *)&static_fields->DEFAULT_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION = 0x3F0000003F000000LL;
  v4 = StringLiteral_12410/*"SUBMARINE_VIEW_SCAN_RANGE_CAMERA_DURATION"*/;
  static_fields->KEY_VIEW_SCAN_RANGE_CAMERA_DURATION = (struct System_String_o *)StringLiteral_12410/*"SUBMARINE_VIEW_SCAN_RANGE_CAMERA_DURATION"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->KEY_VIEW_SCAN_RANGE_CAMERA_DURATION, v4, v1, v2);
  v5 = StringLiteral_12409/*"SUBMARINE_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION"*/;
  v6 = SubmarineSettingsManager_TypeInfo->static_fields;
  v6->KEY_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION = (struct System_String_o *)StringLiteral_12409/*"SUBMARINE_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&v6->KEY_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION, v5, v7, v8);
  v9 = StringLiteral_12408/*"SUBMARINE_OPEN_PANEL_CAMERA_DURATION"*/;
  v10 = SubmarineSettingsManager_TypeInfo->static_fields;
  v10->KEY_OPEN_PANEL_CAMERA_DURATION = (struct System_String_o *)StringLiteral_12408/*"SUBMARINE_OPEN_PANEL_CAMERA_DURATION"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)&v10->KEY_OPEN_PANEL_CAMERA_DURATION, v9, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  v7 = (System_Collections_Generic_Dictionary_int__float__o *)sub_1C372A4(System_Collections_Generic_Dictionary_int__float__TypeInfo);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._ScanOpenPanelIntervals_k__BackingField, (int32_t)v7, v8, v9);
...
LABEL_8:
    sub_1C372B4(ScanOpenPanelIntervals_k__BackingField);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F933 & 1) == 0 )
  {
    this = (SubmarineSettingsManager_o *)sub_1C37058(&Method_System_Collections_Generic_Dictionary_int__float__set_Item__);
    byte_4C3F933 = 1;
  }
  if ( !overrwrites )
    goto LABEL_45;
