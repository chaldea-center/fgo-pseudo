void __fastcall SubmarineSettingsManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA2C & 1) == 0 )
  {
    sub_1BC3008(&SubmarineSettingsManager_TypeInfo, v1);
    sub_1BC3008(&StringLiteral_12292/*"SUBMARINE_OPEN_PANEL_CAMERA_DURATION"*/, v4);
    sub_1BC3008(&StringLiteral_12294/*"SUBMARINE_VIEW_SCAN_RANGE_CAMERA_DURATION"*/, v5);
    sub_1BC3008(&StringLiteral_12293/*"SUBMARINE_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION"*/, v6);
    byte_4AFEA2C = 1;
  }
  static_fields = SubmarineSettingsManager_TypeInfo->static_fields;
  *(_QWORD *)&static_fields->DEFAULT_PANEL_WIDTH = 0x5200000052LL;
  *(_OWORD *)&static_fields->DEFAULT_PANEL_SELECT_DELAY_SECOND = xmmword_BDDC50;
  *(_QWORD *)&static_fields->DEFAULT_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION = 0x3F0000003F000000LL;
  v8 = StringLiteral_12294/*"SUBMARINE_VIEW_SCAN_RANGE_CAMERA_DURATION"*/;
  static_fields->KEY_VIEW_SCAN_RANGE_CAMERA_DURATION = (struct System_String_o *)StringLiteral_12294/*"SUBMARINE_VIEW_SCAN_RANGE_CAMERA_DURATION"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->KEY_VIEW_SCAN_RANGE_CAMERA_DURATION, v8, v2, v3);
  v9 = StringLiteral_12293/*"SUBMARINE_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION"*/;
  v10 = SubmarineSettingsManager_TypeInfo->static_fields;
  v10->KEY_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION = (struct System_String_o *)StringLiteral_12293/*"SUBMARINE_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v10->KEY_SCAN_RANGE_TO_HOME_SPOT_CAMERA_DURATION, v9, v11, v12);
  v13 = StringLiteral_12292/*"SUBMARINE_OPEN_PANEL_CAMERA_DURATION"*/;
  v14 = SubmarineSettingsManager_TypeInfo->static_fields;
  v14->KEY_OPEN_PANEL_CAMERA_DURATION = (struct System_String_o *)StringLiteral_12292/*"SUBMARINE_OPEN_PANEL_CAMERA_DURATION"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v14->KEY_OPEN_PANEL_CAMERA_DURATION, v13, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA28 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__float___ctor__, *(_QWORD *)&eventId);
    sub_1BC3008(&System_Collections_Generic_Dictionary_int__float__TypeInfo, v7);
    sub_1BC3008(&SubmarineSettingsManager_TypeInfo, v8);
    byte_4AFEA28 = 1;
  }
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields._ScanOpenPanelIntervals_k__BackingField, (int32_t)v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA2B & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__float__ContainsKey__, *(_QWORD *)&scanId);
    sub_1BC3008(&Method_System_Collections_Generic_Dictionary_int__float__get_Item__, v5);
    byte_4AFEA2B = 1;
  }
...
LABEL_8:
    sub_1BC3264(ScanOpenPanelIntervals_k__BackingField, *(_QWORD *)&scanId);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA29 & 1) == 0 )
  {
    this = (SubmarineSettingsManager_o *)sub_1BC3008(
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v7 >= max_length )
LABEL_46:
        sub_1BC326C(this, overrwrites, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEA2A & 1) == 0 )
  {
    sub_1BC3008(&SubmarineSettingsManager_TypeInfo, method);
    byte_4AFEA2A = 1;
  }
