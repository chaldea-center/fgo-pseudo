        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C220AE & 1) == 0 )
  {
    sub_1C2D490(&CharaGraphSortManageUnitGrandEquipRewardUp_TypeInfo);
    byte_4C220AE = 1;
  }
  v3 = (CharaGraphSortManageUnitServantEquip_o *)sub_1C2D6DC(CharaGraphSortManageUnitGrandEquipRewardUp_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C220AD & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_4386/*"CharaGraphSort_GrandEquip_Reward_Up"*/);
    byte_4C220AD = 1;
  }
  return (System_String_o *)StringLiteral_4386/*"CharaGraphSort_GrandEquip_Reward_Up"*/;
}
