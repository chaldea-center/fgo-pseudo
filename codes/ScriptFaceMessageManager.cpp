void __fastcall ScriptFaceMessageManager___cctor(const MethodInfo *method)
{
  if ( (byte_42B4778 & 1) == 0 )
  {
    sub_B52984(&ScriptFaceMessageManager_TypeInfo);
    byte_42B4778 = 1;
  }
...
void __fastcall ScriptFaceMessageManager___ctor(ScriptFaceMessageManager_o *this, const MethodInfo *method)
{
  ...
  v3 = sub_B5299C(float___TypeInfo, 2LL);
  if ( !v3 )
    goto LABEL_20;
  v11 = *(_DWORD *)(v3 + 24);
  if ( !v11 )
  ...
  *(_DWORD *)(v3 + 36) = 1146224640;
  ...
  sub_B52920(
    ...
    v16,
    v17);
  v3 = sub_B5299C(UnityEngine_Vector3___TypeInfo, 2LL);
  if ( !v3 )
    goto LABEL_20;
  v25 = *(_DWORD *)(v3 + 24);
...
LABEL_19:
  ...
  *(_QWORD *)(v3 + 44) = 0x41500000C2CE0000LL;
  ...
  sub_B52920(
    ...
    v23,
    v24);
  v3 = sub_B5299C(UnityEngine_Vector2___TypeInfo, 2LL);
  v32 = v3;
        ...
        const MethodInfo *method)
{
  ...
  if ( !faceIcon || (UIWidget__set_width(faceIcon, width, 0LL), (faceIcon = this->fields.faceIcon) == 0LL) )
    sub_B52A5C(faceIcon, *(_QWORD *)&width);
...
void __fastcall ScriptFaceMessageManager__Start(ScriptFaceMessageManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B4775 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_UnityEngine_Object_Instantiate_UILabel___);
  ...
  if ( !(_DWORD)rootObject )
  {
    ...
    rootObject = ScriptMessageLabel__GetFontSize((System_String_o *)StringLiteral_757/*"-"*/, 0, 0LL);
  }
  ...
  rootObject = (unsigned __int64)UnityEngine_Object__Instantiate_Dropdown_DropdownItem_(
                                   messageMainLabel,
                                   (const MethodInfo_1F711B8 *)Method_UnityEngine_Object_Instantiate_UILabel___);
...
LABEL_17:
  ...
  UILabel__set_text(v15, (System_String_o *)StringLiteral_23972/*"■"*/, 0LL);
  ...
  UnityEngine_Object__Destroy_35616956(v32, 0LL);
