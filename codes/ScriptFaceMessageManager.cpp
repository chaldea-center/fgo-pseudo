void __fastcall ScriptFaceMessageManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B687FA & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptFaceMessageManager_TypeInfo, v1);
    byte_4B687FA = 1;
  }
...
void __fastcall ScriptFaceMessageManager___ctor(ScriptFaceMessageManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B687F9 & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptFaceMessageManager_TypeInfo, method);
    sub_1BE4ACC(&float___TypeInfo, v3);
    sub_1BE4ACC(&UnityEngine_Vector2___TypeInfo, v4);
    sub_1BE4ACC(&UnityEngine_Vector3___TypeInfo, v5);
    byte_4B687F9 = 1;
  }
  v6 = sub_1BE4B74(float___TypeInfo, 2LL);
  if ( !v6 )
    goto LABEL_19;
  v14 = *(_DWORD *)(v6 + 24);
  v7 = v6;
  ...
  *(_DWORD *)(v6 + 36) = 1138491392;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.ALIGN_CENTER_BASE, v6, v8, v9, v10, v11, v12, v13);
  v6 = sub_1BE4B74(float___TypeInfo, 2LL);
  if ( !v6 )
    goto LABEL_19;
  v21 = *(_DWORD *)(v6 + 24);
  ...
  *(_DWORD *)(v6 + 36) = 1146224640;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.ALIGN_RIGHT_BASE, v6, v15, v16, v17, v18, v19, v20);
  v6 = sub_1BE4B74(UnityEngine_Vector3___TypeInfo, 2LL);
  if ( !v6 )
    goto LABEL_19;
  v28 = *(_DWORD *)(v6 + 24);
  v7 = v6;
...
LABEL_18:
  ...
  *(_QWORD *)(v6 + 44) = 0x41500000C2CE0000LL;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.TALK_NAME_ANCHOR_POS, v6, v22, v23, v24, v25, v26, v27);
  v6 = sub_1BE4B74(UnityEngine_Vector2___TypeInfo, 2LL);
...
LABEL_19:
  ...
  *(_QWORD *)(v36 + 40) = 0LL;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.MESSAGE_SCROLL_POS, v36, v29, v30, v31, v32, v33, v34);
        ...
        const MethodInfo *method)
{
  ...
  if ( !faceIcon || (UIWidget__set_width(faceIcon, width, 0LL), (faceIcon = this->fields.faceIcon) == 0LL) )
    sub_1BE4D28(faceIcon, *(_QWORD *)&width);
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_4B612E1 )
  {
    this = (ScriptFaceMessageManager_o *)sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, method);
    byte_4B612E1 = 1;
  }
  if ( !v10
    || (UnityEngine_Transform__set_localPosition(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B687F8 & 1) == 0 )
  {
    this = (ScriptFaceMessageManager_o *)sub_1BE4ACC(
...
void __fastcall ScriptFaceMessageManager__Start(ScriptFaceMessageManager_o *this, const MethodInfo *method)
{
  ...
  rootObject = (unsigned __int64)UnityEngine_Object__Instantiate_object_(
                                   messageMainLabel,
                                   (const MethodInfo_2FDE9E4 *)Method_UnityEngine_Object_Instantiate_UILabel___);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.fontType, (int64_t)trueTypeFont, v28, v29, v30, v31, v32, v33);
  UILabel__set_fontSize(v19, this->fields.defaultFontSize, 0LL);
  UILabel__set_text(v19, (System_String_o *)StringLiteral_25599/*"■"*/, 0LL);
...
LABEL_15:
  ...
  UILabel__set_text(v20, (System_String_o *)StringLiteral_25599/*"■"*/, 0LL);
  ...
  UnityEngine_Object__Destroy_70452000(v37, 0LL);
