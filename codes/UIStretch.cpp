...
void UIStretch__Awake(UIStretch_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3C318 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_UIStretch_ScreenSizeChanged__);
    byte_4C3C318 = 1;
  }
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mAnim, (int32_t)Component_object, v4, v5);
  ...
  *(_QWORD *)&this->fields.mRect.fields.m_Width = 0;
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mWidget, (int32_t)v9, v10, v11);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mSprite, (int32_t)v12, v13, v14);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mPanel, (int32_t)v15, v16, v17);
  ...
  v20 = (UICamera_OnScreenResize_o *)sub_1C32E6C(UICamera_OnScreenResize_TypeInfo);
...
LABEL_9:
  ...
  sub_1C32BC4(p_onScreenResize, (int32_t)v24, v22, v23);
}
...
void UIStretch__Start(UIStretch_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(uiCamera, 0, 0) )
  {
    ...
    if ( v6 )
    {
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.uiCamera, (int32_t)CameraForLayer, v15, v16);
      goto LABEL_18;
    }
LABEL_21:
    sub_1C32E7C(v6);
...
LABEL_18:
  ...
  if ( !NGUITools_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NGUITools_TypeInfo);
  v18 = NGUITools__FindInParents_object_(v17, (const MethodInfo_31676B4 *)Method_NGUITools_FindInParents_UIRoot___);
  this->fields.mRoot = (struct UIRoot_o *)v18;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mRoot, (int32_t)v18, v19, v20);
...
LABEL_59:
  ...
  if ( UnityEngine_Object__op_Inequality(v11, 0, 0) )
  {
    ...
    if ( (v13 & 1) != 0 )
      NGUIMath__CalculateRelativeWidgetBounds_49181936(&iptr, (UnityEngine_Transform_o *)parent, v14, 0);
    else
