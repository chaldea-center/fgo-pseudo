        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields, (int32_t)inputPerf, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05246 & 1) == 0 )
  {
    sub_1BC3008(&BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_TypeInfo, message);
    byte_4B05246 = 1;
  }
  v9 = sub_1BC3254(BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_TypeInfo);
  System_Object___ctor((Il2CppObject *)v9, 0LL);
  *(_DWORD *)(v9 + 16) = 0;
  *(_QWORD *)(v9 + 40) = this;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v9 + 40), (int32_t)this, v10, v11);
  *(_QWORD *)(v9 + 48) = message;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v9 + 48), (int32_t)message, v12, v13);
  *(_DWORD *)(v9 + 56) = index;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05247 & 1) == 0 )
  {
    sub_1BC3008(&BattleMultiMessageDisplay__CoroutineWaitEndMessage_d__19_TypeInfo, callBack);
    byte_4B05247 = 1;
  }
  v5 = sub_1BC3254(BattleMultiMessageDisplay__CoroutineWaitEndMessage_d__19_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    sub_1BC2FAC(p_messageObject, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( arg && (Message = BattleMultiMessageDisplay_Argument__GetMessage(arg, index, method)) != 0LL )
  {
    ...
    if ( !perf )
      sub_1BC3264(v12, v13);
    started = UnityEngine_MonoBehaviour__StartCoroutine_70019872(perf, v12, 0LL);
    this->fields.corDisplayMessage = started;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.corDisplayMessage, (int32_t)started, v15, v16);
  }
  else
  {
    BattleMultiMessageDisplay__ReleaseMessage_46024084(this, *(const MethodInfo **)&index);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( inputArg )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&v4->fields.arg, (int32_t)inputArg, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( isDisplayNextMessage || (arg = this->fields.arg) == 0LL || !arg->fields._IsContinueDisplayMessage_k__BackingField )
    BattleMultiMessageDisplay__ReleaseMessage_46024084(this, (const MethodInfo *)isDisplayNextMessage);
}


void __fastcall BattleMultiMessageDisplay__ReleaseMessage_46024084(
        BattleMultiMessageDisplay_o *this,
        const MethodInfo *method)
{
  ...
  this->fields.arg = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.arg, 0, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( corDisplayMessage )
  {
    perf = (UnityEngine_MonoBehaviour_o *)this->fields.perf;
    if ( !perf )
      sub_1BC3264(0LL, corDisplayMessage);
    UnityEngine_MonoBehaviour__StopCoroutine_70020492(perf, corDisplayMessage, 0LL);
    p_corDisplayMessage->klass = 0LL;
    sub_1BC2FAC(p_corDisplayMessage, 0, v5, v6);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( arg && arg->fields._IsWaitMessageEnd_k__BackingField )
  {
    ...
    if ( !perf )
      sub_1BC3264(v5, v6);
    UnityEngine_MonoBehaviour__StartCoroutine_70019872(perf, v5, 0LL);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  if ( (byte_4B0524A & 1) == 0 )
  {
    sub_1BC3008(&Method_BasicHelper_IndexValue_BattleActionData_DisplayMessageData___, *(_QWORD *)&index);
    byte_4B0524A = 1;
  }
  return (BattleActionData_DisplayMessageData_o *)BasicHelper__IndexValue_object_(
                                                    ...
                                                    index,
                                                    0LL,
                                                    (const MethodInfo_2FF04DC *)Method_BasicHelper_IndexValue_BattleActionData_DisplayMessageData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05249 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMaster_BattleMessageMaster___, parse);
    sub_1BC3008(&DataManager_TypeInfo, v5);
    byte_4B05249 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3001E10 *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !Master_object )
    sub_1BC3264(0LL, v7);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.messageArray, (int32_t)DisplayMessageArray, v9, v10);
  return this;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0524B & 1) == 0 )
  {
    ...
    this = (BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_o *)sub_1BC3008(
  ...
  switch ( v4->fields.__1__state )
  {
    case 0:
      ...
      if ( startDelayTime > 0.0 )
      {
        ...
        sub_1BC2FAC(p__2__current, (int32_t)v19, v21, v22);
        result = 1;
    ...
    case 2:
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&_4__this->fields.messageObject, (int32_t)BattleMessage, v10, v11);
      ...
      if ( BattleActionData_DisplayMessageData__get_DispTime((BattleActionData_DisplayMessageData_o *)this, 0LL) > 0.0 )
      {
        ...
        if ( this )
        {
          DispTime = BattleActionData_DisplayMessageData__get_DispTime(
                       ...
                       0LL);
          v13 = (UnityEngine_WaitForSecondsRealtime_o *)sub_1BC3254(UnityEngine_WaitForSecondsRealtime_TypeInfo);
          UnityEngine_WaitForSecondsRealtime___ctor(v13, DispTime, 0LL);
          v4->fields.__2__current = (Il2CppObject *)v13;
          v14 = (CGThumbnailListItem_o *)&v4->fields.__2__current;
          sub_1BC2FAC(v14, (int32_t)v13, v15, v16);
          v17 = 3;
LABEL_23:
      ...
      if ( BattleActionData_DisplayMessageData__get_Interval((BattleActionData_DisplayMessageData_o *)this, 0LL) > 0.0 )
      {
        ...
        if ( this )
        {
          Interval = BattleActionData_DisplayMessageData__get_Interval(
                       (BattleActionData_DisplayMessageData_o *)this,
                       0LL);
          v25 = (UnityEngine_WaitForSecondsRealtime_o *)sub_1BC3254(UnityEngine_WaitForSecondsRealtime_TypeInfo);
          UnityEngine_WaitForSecondsRealtime___ctor(v25, Interval, 0LL);
          v4->fields.__2__current = (Il2CppObject *)v25;
          v14 = (CGThumbnailListItem_o *)&v4->fields.__2__current;
          sub_1BC2FAC(v14, (int32_t)v25, v26, v27);
          v17 = 4;
          goto LABEL_23;
        }
LABEL_24:
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1BC3254(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1BC301C(&Method_BattleMultiMessageDisplay__CoroutineWaitEndMessage_d__19_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
