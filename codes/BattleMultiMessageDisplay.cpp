        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)inputPerf, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAA60 & 1) == 0 )
  {
    sub_1C1ABD4(&BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_TypeInfo, message);
    byte_4BCAA60 = 1;
  }
  v7 = sub_1C1AE20(BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  *(_DWORD *)(v7 + 16) = 0;
  *(_QWORD *)(v7 + 32) = this;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 32), (int64_t)this, v8, v9, v10, v11, v12, v13);
  *(_QWORD *)(v7 + 40) = message;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 40), (int64_t)message, v14, v15, v16, v17, v18, v19);
  *(_DWORD *)(v7 + 48) = index;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAA61 & 1) == 0 )
  {
    sub_1C1ABD4(&BattleMultiMessageDisplay__CoroutineWaitEndMessage_d__19_TypeInfo, callBack);
    byte_4BCAA61 = 1;
  }
  v5 = sub_1C1AE20(BattleMultiMessageDisplay__CoroutineWaitEndMessage_d__19_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    sub_1C1AB78(p_messageObject, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  BattleActionData_DisplayMessageData_o *v7; // x22
  UnityEngine_MonoBehaviour_o *perf; // x21
  ...
  if ( arg && (Message = BattleMultiMessageDisplay_Argument__GetMessage(arg, index, method)) != 0LL )
  {
    ...
    v10 = BattleMultiMessageDisplay__CoroutineDisplayMessage(this, v7, index, v9);
    if ( !perf )
      sub_1C1AE30(v10, v11);
    started = UnityEngine_MonoBehaviour__StartCoroutine_70779684(perf, v10, 0LL);
  ...
  {
    BattleMultiMessageDisplay__ReleaseMessage_45131348(this, *(const MethodInfo **)&index);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( inputArg )
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&v4->fields.arg, (int64_t)inputArg, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( isDisplayNextMessage || (arg = this->fields.arg) == 0LL || !arg->fields._IsContinueDisplayMessage_k__BackingField )
    BattleMultiMessageDisplay__ReleaseMessage_45131348(this, (const MethodInfo *)isDisplayNextMessage);
}


void __fastcall BattleMultiMessageDisplay__ReleaseMessage_45131348(
        BattleMultiMessageDisplay_o *this,
        const MethodInfo *method)
{
  ...
  this->fields.arg = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.arg, 0LL, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( corDisplayMessage )
  {
    perf = (UnityEngine_MonoBehaviour_o *)this->fields.perf;
    if ( !perf )
      sub_1C1AE30(0LL, corDisplayMessage);
    UnityEngine_MonoBehaviour__StopCoroutine_70780304(perf, corDisplayMessage, 0LL);
    p_corDisplayMessage->klass = 0LL;
    sub_1C1AB78(p_corDisplayMessage, 0LL, v5, v6, v7, v8, v9, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( arg && arg->fields._IsWaitMessageEnd_k__BackingField )
  {
    ...
    if ( !perf )
      sub_1C1AE30(v5, v6);
    UnityEngine_MonoBehaviour__StartCoroutine_70779684(perf, v5, 0LL);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  this->fields._IsWaitMessageEnd_k__BackingField = DataVals__GetParam(dataVal, 203, 0, 0LL) > 0;
  this->fields._IsContinueDisplayMessage_k__BackingField = DataVals__GetParam(dataVal, 204, 0, 0LL) > 0;
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4BCAA64 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_BasicHelper_IndexValue_BattleActionData_DisplayMessageData___, *(_QWORD *)&index);
    byte_4BCAA64 = 1;
  }
  return (BattleActionData_DisplayMessageData_o *)BasicHelper__IndexValue_object_(
                                                    ...
                                                    index,
                                                    0LL,
                                                    (const MethodInfo_2F8E058 *)Method_BasicHelper_IndexValue_BattleActionData_DisplayMessageData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCAA63 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_BattleMessageMaster___, parse);
    sub_1C1ABD4(&DataManager_TypeInfo, v5);
    byte_4BCAA63 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_BattleMessageMaster___);
  if ( !Master_object )
    sub_1C1AE30(0LL, v7);
        ...
        const MethodInfo *method)
{
  ...
  int v30; // w8
  float Interval; // s8
  UnityEngine_WaitForSecondsRealtime_o *v32; // x20
  int64_t v33; // x2
  int32_t v34; // w3
  ...
  if ( (byte_4BCAA65 & 1) == 0 )
  {
    this = (BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_o *)sub_1C1ABD4(
  ...
  switch ( v8->fields.__1__state )
  {
    case 0:
      ...
      *(_DWORD *)&p__2__current[-1].fields._IsQuestStartMenuMode_k__BackingField = -1;
      sub_1C1AB78(p__2__current, 0LL, (int64_t)v2, (int32_t)v3, v4, v5, v6, v7);
      result = 1;
      *(_DWORD *)&p__2__current[-1].fields._IsQuestStartMenuMode_k__BackingField = 1;
      return result;
    case 1:
      ...
      if ( BattleActionData_DisplayMessageData__get_DispTime((BattleActionData_DisplayMessageData_o *)this, 0LL) > 0.0 )
      {
        ...
        if ( this )
        {
          DispTime = BattleActionData_DisplayMessageData__get_DispTime(
                       ...
                       0LL);
          v22 = (UnityEngine_WaitForSecondsRealtime_o *)sub_1C1AE20(UnityEngine_WaitForSecondsRealtime_TypeInfo);
          UnityEngine_WaitForSecondsRealtime___ctor(v22, DispTime, 0LL);
          v8->fields.__2__current = (Il2CppObject *)v22;
          v23 = (PartyOrganizationUtility_o *)&v8->fields.__2__current;
          sub_1C1AB78(v23, (int64_t)v22, v24, v25, v26, v27, v28, v29);
          v30 = 2;
LABEL_18:
      ...
      if ( BattleActionData_DisplayMessageData__get_Interval((BattleActionData_DisplayMessageData_o *)this, 0LL) > 0.0 )
      {
        ...
        if ( this )
        {
          Interval = BattleActionData_DisplayMessageData__get_Interval(
                       (BattleActionData_DisplayMessageData_o *)this,
                       0LL);
          v32 = (UnityEngine_WaitForSecondsRealtime_o *)sub_1C1AE20(UnityEngine_WaitForSecondsRealtime_TypeInfo);
          UnityEngine_WaitForSecondsRealtime___ctor(v32, Interval, 0LL);
          v8->fields.__2__current = (Il2CppObject *)v32;
          v23 = (PartyOrganizationUtility_o *)&v8->fields.__2__current;
          sub_1C1AB78(v23, (int64_t)v32, v33, v34, v35, v36, v37, v38);
          v30 = 3;
          goto LABEL_18;
        }
LABEL_23:
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_BattleMultiMessageDisplay__CoroutineDisplayMessage_d__17_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  v3 = (System_NotSupportedException_o *)sub_1C1AE20(v2);
  System_NotSupportedException___ctor(v3, 0LL);
  v4 = sub_1C1ABE8(&Method_BattleMultiMessageDisplay__CoroutineWaitEndMessage_d__19_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
