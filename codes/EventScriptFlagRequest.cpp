...
System_String_o *__fastcall EventScriptFlagRequest__getURL(EventScriptFlagRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC93F7 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_19437/*"event/scriptFlag"*/, v2);
    byte_4BC93F7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63040368(BaseUrl, (System_String_o *)StringLiteral_19437/*"event/scriptFlag"*/, 0LL);
}
