void __fastcall EventPointReplaseRewardDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5F349 & 1) == 0 )
  {
    sub_1B885B0(&EventPointReplaseRewardDialog_TypeInfo);
    byte_4A5F349 = 1;
  }
...
void __fastcall EventPointReplaseRewardDialog__Close(EventPointReplaseRewardDialog_o *this, const MethodInfo *method)
{
  ...
  EventPointReplaseRewardDialog__Close_46093384(this, 0LL, v2);
}


void __fastcall EventPointReplaseRewardDialog__Close_46093384(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F346 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_EventPointReplaseRewardDialog_EndClose__);
    byte_4A5F346 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F347 & 1) == 0 )
  {
    sub_1B885B0(&Method_EventPointReplaseRewardDialog_OnClickOk__);
    byte_4A5F347 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_EventPointReplaseRewardDialog_OnClickOk__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_EventPointReplaseRewardDialog_OnClickOk__);
        ...
        const MethodInfo *method)
{
  ...
  EventPointReplaseRewardDialog_c *v27; // x8
  UnityEngine_GameObject_o *v28; // x25
  EventPointReplaseRewardDialog_c *v29; // x0
  ...
  EventPointReplaseRewardDialog_c *v42; // x8
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_EventPointReplaseRewardDialog_EndOpen__);
    sub_1B885B0(&EventPointReplaseRewardDialog_TypeInfo);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, (int32_t)func, v19, v20);
  ...
  if ( UnityEngine_Object__op_Inequality(titleLabel, 0LL, 0LL) )
  {
    ...
    if ( !transform )
      goto LABEL_61;
    v25 = title ? title : (System_String_o *)StringLiteral_1/*""*/;
    UILabel__set_text(transform, v25, 0LL);
    transform = this->fields.titleLabel;
    if ( !transform )
      goto LABEL_61;
    ...
    GameObjectExtensions__SetLocalPosition(v28, v27->static_fields->TITLE_BASE_POS, 0LL);
  }
  v29 = EventPointReplaseRewardDialog_TypeInfo;
  if ( !EventPointReplaseRewardDialog_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(EventPointReplaseRewardDialog_TypeInfo);
    v29 = EventPointReplaseRewardDialog_TypeInfo;
  ...
  messageLabel = (UnityEngine_Object_o *)this->fields.messageLabel;
  v33 = p_BANNER_RETRY_MAX[4];
  v32 = p_BANNER_RETRY_MAX[5];
  v34 = p_BANNER_RETRY_MAX[6];
  v35 = *((_DWORD *)p_BANNER_RETRY_MAX + 8);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(messageLabel, 0LL, 0LL) )
  {
    ...
    if ( !v36 )
      goto LABEL_61;
    UIWidget__SetDimensions(v36, EventPointReplaseRewardDialog_TypeInfo->static_fields->MESSAGE_BASE_SIZE_X, v35, 0LL);
    ...
    WrapControlText__textAdjust(transform, v37, transform->fields.mFontSize, 0, 0, 0LL);
    transform = this->fields.messageLabel;
    if ( !transform )
      goto LABEL_61;
    ...
    v45.fields.y = v32;
    v45.fields.z = v34;
    GameObjectExtensions__SetLocalPosition(v38, v45, 0LL);
  }
  okBtnLabel = (UnityEngine_Object_o *)this->fields.okBtnLabel;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(okBtnLabel, 0LL, 0LL) )
  {
    ...
    if ( !transform )
      goto LABEL_61;
    v41 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)transform, 0LL);
    ...
    GameObjectExtensions__SetLocalPosition(v43, v42->static_fields->BUTTON_BASE_POS, 0LL);
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  transform = (UILabel_o *)UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)TargetPanel, 0LL, 0LL);
...
LABEL_60:
  ...
  System_Action___ctor(v44, (Il2CppObject *)this, Method_EventPointReplaseRewardDialog_EndOpen__, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D3CBC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D3C74;
}
