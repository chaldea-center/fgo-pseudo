...
System_String_o *__fastcall StrengthStatus__GetIconName(int32_t strengthStatus, const MethodInfo *method)
{
  ...
  if ( (byte_4B3618F & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_20431/*"icon_stateup_on"*/, method);
    sub_1BD3458(&StringLiteral_20430/*"icon_stateup_off"*/, v3);
    byte_4B3618F = 1;
  }
  if ( !strengthStatus )
    return 0LL;
  if ( (unsigned int)(strengthStatus - 1) <= 0x61 )
    return (System_String_o *)StringLiteral_20430/*"icon_stateup_off"*/;
  if ( strengthStatus == 99 )
    return (System_String_o *)StringLiteral_20431/*"icon_stateup_on"*/;
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36190 & 1) == 0 )
  {
    sub_1BD3458(&System_Math_TypeInfo, *(_QWORD *)&treasureDeviceNum);
    sub_1BD3458(&StringLiteral_20403/*"icon_np_off"*/, v5);
    sub_1BD3458(&StringLiteral_20404/*"icon_np_on"*/, v6);
    byte_4B36190 = 1;
  }
  if ( !strengthStatus )
    return 0LL;
  if ( strengthStatus == 99 )
  {
    v7 = &StringLiteral_20404/*"icon_np_on"*/;
  ...
  if ( v8 == 1 )
  {
    v7 = &StringLiteral_20403/*"icon_np_off"*/;
    return (System_String_o *)*v7;
  }
  ...
  if ( v8 >= 0x63 )
    return 0LL;
  return (System_String_o *)StringLiteral_20404/*"icon_np_on"*/;
}
