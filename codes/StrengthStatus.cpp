...
System_String_o *StrengthStatus__GetIconName(int32_t strengthStatus, const MethodInfo *method)
{
  ...
  if ( (unsigned int)(strengthStatus - 1) <= 0x61 )
    return (System_String_o *)StringLiteral_20235/*"icon_stateup_off"*/;
  if ( strengthStatus == 99 )
    return (System_String_o *)StringLiteral_20236/*"icon_stateup_on"*/;
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C368E4 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_20208/*"icon_np_off"*/);
    sub_1C32C20(&StringLiteral_20209/*"icon_np_on"*/);
    byte_4C368E4 = 1;
  }
  if ( !strengthStatus )
    return 0;
  if ( strengthStatus == 99 )
  {
    v5 = &StringLiteral_20209/*"icon_np_on"*/;
  ...
  if ( v6 == 1 )
  {
    v5 = &StringLiteral_20208/*"icon_np_off"*/;
    return (System_String_o *)*v5;
  }
  ...
  if ( v6 >= 0x63 )
    return 0;
  return (System_String_o *)StringLiteral_20209/*"icon_np_on"*/;
}
