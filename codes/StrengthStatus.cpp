...
System_String_o *StrengthStatus__GetIconName(int32_t strengthStatus, const MethodInfo *method)
{
  if ( (byte_4CC62F5 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_20315/*"icon_stateup_on"*/);
    sub_1C713B0(&StringLiteral_20314/*"icon_stateup_off"*/);
    byte_4CC62F5 = 1;
  }
  if ( !strengthStatus )
    return 0;
  if ( (unsigned int)(strengthStatus - 1) <= 0x61 )
    return (System_String_o *)StringLiteral_20314/*"icon_stateup_off"*/;
  if ( strengthStatus == 99 )
    return (System_String_o *)StringLiteral_20315/*"icon_stateup_on"*/;
  return 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC62F6 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_20287/*"icon_np_off"*/);
    sub_1C713B0(&StringLiteral_20288/*"icon_np_on"*/);
    byte_4CC62F6 = 1;
  }
  if ( !strengthStatus )
    return 0;
  if ( strengthStatus == 99 )
  {
    v5 = &StringLiteral_20288/*"icon_np_on"*/;
  ...
  if ( v6 == 1 )
  {
    v5 = &StringLiteral_20287/*"icon_np_off"*/;
    return (System_String_o *)*v5;
  }
  ...
  if ( v6 >= 0x63 )
    return 0;
  return (System_String_o *)StringLiteral_20288/*"icon_np_on"*/;
}
