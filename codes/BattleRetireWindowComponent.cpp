        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF365 & 1) == 0 )
  {
    sub_1B640C8(&AtlasManager_TypeInfo, call);
    sub_1B640C8(&Method_DataManager_GetMasterData_QuestMaster___, v5);
    sub_1B640C8(&Method_DataMasterBase_QuestMaster__QuestEntity__int__GetEntity__, v6);
    sub_1B640C8(&LocalizationManager_TypeInfo, v7);
    sub_1B640C8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1B640C8(&StringLiteral_2942/*"BATTLE_RETIRE_CHECKSTR"*/, v9);
  ...
  continueItemRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !continueItemRoot )
    goto LABEL_62;
                              ...
                              if ( continueItemRoot )
                              {
                                ...
                                if ( continueItemRoot )
                                {
                                  ...
                                  continueItemRoot = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                                   (System_String_o *)StringLiteral_2942/*"BATTLE_RETIRE_CHECKSTR"*/,
                                                                                   0LL);
                                  if ( checkGiveUpLabel )
                                  {
  ...
  if ( ((unsigned __int8)continueItemRoot & 1) != 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = &StringLiteral_2943/*"BATTLE_RETIRE_CONSUME_COST_CHECKSTR"*/;
    goto LABEL_38;
  }
  ...
  if ( !QuestPhaseEntity__IsInterruptionQuest((QuestPhaseEntity_o *)continueItemRoot, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = &StringLiteral_2942/*"BATTLE_RETIRE_CHECKSTR"*/;
LABEL_38:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF366 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_SingletonTemplate_BattleItemData__get_Instance__, v6);
    sub_1B640C8(&StringLiteral_16541/*"_{0}"*/, v7);
    sub_1B640C8(&StringLiteral_2944/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/, v8);
    byte_49FF366 = 1;
  }
  ...
  UnityEngine_Transform__set_localPosition(
    ...
    0LL);
  checkGiveUpLabel = (UIWidget_o *)SingletonTemplate_object___get_Instance((const MethodInfo_36EC45C *)Method_SingletonTemplate_BattleItemData__get_Instance__);
  if ( !checkGiveUpLabel )
    goto LABEL_46;
  v10 = (System_String_o *)StringLiteral_2944/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/;
  if ( checkGiveUpLabel->fields.m_CachedPtr >= 1 )
  {
    ...
    v12 = System_String__Format((System_String_o *)StringLiteral_16541/*"_{0}"*/, v11, 0LL);
    v10 = System_String__Concat_61375396(v10, v12, 0LL);
  }
  v13 = this->fields.checkGiveUpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  checkGiveUpLabel = (UIWidget_o *)LocalizationManager__Get(v10, 0LL);
  if ( !v13 )
    goto LABEL_46;
  UILabel__set_text(v13, (System_String_o *)checkGiveUpLabel, 0LL);
  checkGiveUpLabel = (UIWidget_o *)this->fields.checkGiveUpLabel;
  if ( !checkGiveUpLabel )
    goto LABEL_46;
  ...
  if ( !giveUpBg )
    goto LABEL_46;
  UIRect__SetAnchor_46647144(giveUpBg, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0LL);
  ...
  if ( !v18 )
    goto LABEL_46;
  checkGiveUpLabel = (UIWidget_o *)v18->fields.topAnchor;
  if ( !checkGiveUpLabel )
    goto LABEL_46;
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    if ( !Component_object )
      goto LABEL_46;
    UIRect__SetAnchor_46647144(Component_object, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v20, 0LL, 0LL) )
  {
    ...
    if ( checkGiveUpLabel )
    {
      ...
      if ( v20 )
      {
        UIRect__SetAnchor_46647144(v20, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0LL);
...
void __fastcall BattleRetireWindowComponent__Update(BattleRetireWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF363 & 1) == 0 )
  {
    sub_1B640C8(&Method_BattleRetireWindowComponent_CallbackConfirmDialog__, method);
    ...
    sub_1B640C8(&StringLiteral_2823/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/, v8);
    sub_1B640C8(&StringLiteral_2822/*"BATTLE_CONTINUE_ITEM_END_TIME"*/, v9);
  ...
  if ( !UnityEngine_Object__op_Equality(data_k__BackingField, 0LL, 0LL) && this->fields.EnableContinueItem )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_2823/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/, 0LL);
    if ( !this->fields._data_k__BackingField )
      goto LABEL_21;
    v14 = v13;
    ...
    if ( v17 < NetworkManager__getTime(0LL) && !this->fields.isShowDeadLineDialog )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_2822/*"BATTLE_CONTINUE_ITEM_END_TIME"*/, 0LL);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FF367 & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_17431/*"btn_cancel"*/, method);
    byte_49FF367 = 1;
  }
  return (System_String_o *)StringLiteral_17431/*"btn_cancel"*/;
}
