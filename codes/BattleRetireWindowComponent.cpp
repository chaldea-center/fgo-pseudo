        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72E45 & 1) == 0 )
  {
    sub_1B90010(&AtlasManager_TypeInfo, call);
    sub_1B90010(&Method_DataManager_GetMasterData_QuestMaster___, v5);
    sub_1B90010(&Method_DataMasterBase_QuestMaster__QuestEntity__int__GetEntity__, v6);
    sub_1B90010(&LocalizationManager_TypeInfo, v7);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v8);
    sub_1B90010(&StringLiteral_2963/*"BATTLE_RETIRE_CHECKSTR"*/, v9);
    sub_1B90010(&StringLiteral_2964/*"BATTLE_RETIRE_CONSUME_COST_CHECKSTR"*/, v10);
  ...
  continueItemRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !continueItemRoot )
    goto LABEL_62;
                              ...
                              if ( continueItemRoot )
                              {
                                ...
                                if ( continueItemRoot )
                                {
                                  ...
                                  continueItemRoot = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                                   (System_String_o *)StringLiteral_2963/*"BATTLE_RETIRE_CHECKSTR"*/,
                                                                                   0LL);
                                  if ( checkGiveUpLabel )
                                  {
  ...
  if ( ((unsigned __int8)continueItemRoot & 1) != 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = &StringLiteral_2964/*"BATTLE_RETIRE_CONSUME_COST_CHECKSTR"*/;
    goto LABEL_38;
  }
  ...
  if ( !QuestPhaseEntity__IsInterruptionQuest((QuestPhaseEntity_o *)continueItemRoot, 0LL) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = &StringLiteral_2963/*"BATTLE_RETIRE_CHECKSTR"*/;
LABEL_38:
...
LABEL_62:
    sub_1B9026C(continueItemRoot, call);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72E46 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_SingletonTemplate_BattleItemData__get_Instance__, v6);
    sub_1B90010(&StringLiteral_16635/*"_{0}"*/, v7);
    sub_1B90010(&StringLiteral_2965/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/, v8);
    byte_4A72E46 = 1;
  }
  ...
  UnityEngine_Transform__set_localPosition(
    ...
    0LL);
  checkGiveUpLabel = (UIWidget_o *)SingletonTemplate_object___get_Instance((const MethodInfo_374D460 *)Method_SingletonTemplate_BattleItemData__get_Instance__);
  if ( !checkGiveUpLabel )
    goto LABEL_46;
  v13 = (System_String_o *)StringLiteral_2965/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/;
  if ( checkGiveUpLabel->fields.m_CachedPtr >= 1 )
  {
    ...
    v15 = System_String__Format((System_String_o *)StringLiteral_16635/*"_{0}"*/, v14, 0LL);
    v13 = System_String__Concat_61787092(v13, v15, 0LL);
  }
  v16 = this->fields.checkGiveUpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !giveUpBg )
    goto LABEL_46;
  UIRect__SetAnchor_46981912(giveUpBg, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    if ( !Component_object )
      goto LABEL_46;
    UIRect__SetAnchor_46981912(Component_object, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0LL);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v23, 0LL, 0LL) )
  {
    ...
    if ( checkGiveUpLabel )
    {
      ...
      if ( v23 )
      {
        UIRect__SetAnchor_46981912(v23, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0LL);
...
LABEL_46:
    sub_1B9026C(checkGiveUpLabel, method);
  }
}
...
void __fastcall BattleRetireWindowComponent__Update(BattleRetireWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A72E43 & 1) == 0 )
  {
    sub_1B90010(&Method_BattleRetireWindowComponent_CallbackConfirmDialog__, method);
    sub_1B90010(&ErrorDialog_ClickDelegate_TypeInfo, v3);
    sub_1B90010(&LocalizationManager_TypeInfo, v4);
    ...
    sub_1B90010(&StringLiteral_2841/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/, v8);
    sub_1B90010(&StringLiteral_2840/*"BATTLE_CONTINUE_ITEM_END_TIME"*/, v9);
  ...
  if ( !UnityEngine_Object__op_Equality(data_k__BackingField, 0LL, 0LL) && this->fields.EnableContinueItem )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_2841/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/, 0LL);
    if ( !this->fields._data_k__BackingField )
      goto LABEL_21;
    v15 = v13;
    ...
    if ( v18 < NetworkManager__getTime(0LL) && !this->fields.isShowDeadLineDialog )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v20 = LocalizationManager__Get((System_String_o *)StringLiteral_2840/*"BATTLE_CONTINUE_ITEM_END_TIME"*/, 0LL);
      v21 = (ErrorDialog_ClickDelegate_o *)sub_1B9025C(ErrorDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A72E47 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_17526/*"btn_cancel"*/, method);
    byte_4A72E47 = 1;
  }
  return (System_String_o *)StringLiteral_17526/*"btn_cancel"*/;
}
