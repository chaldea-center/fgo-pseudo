        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0819E & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2860/*"BATTLE_RETIRE_CHECKSTR"*/);
    sub_1CE6700(&StringLiteral_2861/*"BATTLE_RETIRE_CONSUME_COST_CHECKSTR"*/);
  ...
  if ( !continueItemRoot )
    goto LABEL_62;
  UILabel__set_text((UILabel_o *)continueItemRoot, (System_String_o *)StringLiteral_1117/*"0"*/, 0);
  ...
  continueItemRoot = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !continueItemRoot )
    goto LABEL_62;
                              ...
                              if ( continueItemRoot )
                              {
                                ...
                                if ( continueItemRoot )
                                {
                                  ...
                                  continueItemRoot = (__int64)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_2860/*"BATTLE_RETIRE_CHECKSTR"*/,
                                                                0);
                                  if ( checkGiveUpLabel )
                                  {
  ...
  if ( !v8 )
    goto LABEL_62;
  continueItemRoot = QuestEntity__HasFlag(v8, 0x40000000, 0);
  if ( (continueItemRoot & 1) != 0 )
  {
    v9 = this->fields.checkGiveUpLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = &StringLiteral_2861/*"BATTLE_RETIRE_CONSUME_COST_CHECKSTR"*/;
    goto LABEL_38;
  }
  v11 = this->fields._data_k__BackingField;
  if ( !v11 )
    goto LABEL_62;
  continueItemRoot = (__int64)v11->fields.questphase_ent;
  if ( !continueItemRoot )
    goto LABEL_62;
  if ( !QuestPhaseEntity__IsInterruptionQuest((QuestPhaseEntity_o *)continueItemRoot, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = &StringLiteral_2860/*"BATTLE_RETIRE_CHECKSTR"*/;
LABEL_38:
    continueItemRoot = (__int64)LocalizationManager__Get((System_String_o *)*v10, 0);
    if ( v9 )
    {
...
LABEL_62:
    sub_1CE6958(continueItemRoot, call);
  }
...
void BattleRetireWindowComponent__SetInterruptionQuestUI(BattleRetireWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0819F & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_16776/*"_{0}"*/);
    sub_1CE6700(&StringLiteral_2862/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/);
    sub_1CE6700(&StringLiteral_2863/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR_PARTY"*/);
    byte_4E0819F = 1;
  }
  ...
  UnityEngine_Transform__set_localPosition(
    ...
    0);
  checkGiveUpLabel = (UIWidget_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3B55234 *)Method_SingletonTemplate_BattleItemData__get_Instance__);
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  v4 = checkGiveUpLabel;
  ...
  v6 = (System_String_o *)StringLiteral_2862/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/;
  if ( BattleData__IsWaveSetupAsOneParty((BattleData_o *)checkGiveUpLabel, 0) )
    v6 = (System_String_o *)StringLiteral_2863/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR_PARTY"*/;
  if ( m_CachedPtr >= 1 )
  {
    v17 = m_CachedPtr;
    v7 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v17);
    v8 = System_String__Format((System_String_o *)StringLiteral_16776/*"_{0}"*/, v7, 0);
    v6 = System_String__Concat_65122828((System_String_o *)StringLiteral_2862/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/, v8, 0);
  }
  v9 = this->fields.checkGiveUpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !v9 )
    goto LABEL_49;
  UILabel__set_text(v9, (System_String_o *)checkGiveUpLabel, 0);
  checkGiveUpLabel = (UIWidget_o *)this->fields.checkGiveUpLabel;
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  ...
  if ( !giveUpBg )
    goto LABEL_49;
  UIRect__SetAnchor_50523140(giveUpBg, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0);
  v11 = this->fields.giveUpBg;
  if ( !v11 )
    goto LABEL_49;
  checkGiveUpLabel = (UIWidget_o *)v11->fields.leftAnchor;
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  ...
  if ( !v12 )
    goto LABEL_49;
  checkGiveUpLabel = (UIWidget_o *)v12->fields.rightAnchor;
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  ...
  if ( !v13 )
    goto LABEL_49;
  checkGiveUpLabel = (UIWidget_o *)v13->fields.bottomAnchor;
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  ...
  if ( !v14 )
    goto LABEL_49;
  checkGiveUpLabel = (UIWidget_o *)v14->fields.topAnchor;
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0, 0) )
  {
    ...
    if ( !Component_object )
      goto LABEL_49;
    UIRect__SetAnchor_50523140(Component_object, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0);
  ...
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  v16 = (UIRect_o *)UnityEngine_GameObject__GetComponent_object_(
                      (UnityEngine_GameObject_o *)checkGiveUpLabel,
                      (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_UISprite___);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v16, 0, 0) )
  {
    ...
    if ( checkGiveUpLabel )
    {
      ...
      if ( v16 )
      {
        UIRect__SetAnchor_50523140(v16, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0);
        checkGiveUpLabel = (UIWidget_o *)v16->fields.leftAnchor;
        if ( checkGiveUpLabel )
        {
          UIRect_AnchorPoint__Set((UIRect_AnchorPoint_o *)checkGiveUpLabel, 1.0, -383.0, 0);
          checkGiveUpLabel = (UIWidget_o *)v16->fields.rightAnchor;
          if ( checkGiveUpLabel )
          {
            UIRect_AnchorPoint__Set((UIRect_AnchorPoint_o *)checkGiveUpLabel, 1.0, -113.0, 0);
            checkGiveUpLabel = (UIWidget_o *)v16->fields.bottomAnchor;
            if ( checkGiveUpLabel )
            {
              UIRect_AnchorPoint__Set((UIRect_AnchorPoint_o *)checkGiveUpLabel, 0.0, 15.0, 0);
...
LABEL_49:
    sub_1CE6958(checkGiveUpLabel, method);
  }
}
...
void BattleRetireWindowComponent__Update(BattleRetireWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0819C & 1) == 0 )
  {
    sub_1CE6700(&Method_BattleRetireWindowComponent_CallbackConfirmDialog__);
    sub_1CE6700(&ErrorDialog_ClickDelegate_TypeInfo);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1CE6700(&StringLiteral_2737/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/);
    sub_1CE6700(&StringLiteral_2736/*"BATTLE_CONTINUE_ITEM_END_TIME"*/);
  ...
  if ( !UnityEngine_Object__op_Equality(data_k__BackingField, 0, 0) && this->fields.EnableContinueItem )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_2737/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/, 0);
    if ( !this->fields._data_k__BackingField )
      goto LABEL_21;
    v7 = v5;
    ...
    v5 = System_String__Format(v7, RestTime, 0);
    ...
    if ( !v5 )
      goto LABEL_21;
    v10 = BattleData__GetContinueDeadLine((BattleData_o *)v5, 0);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    if ( v10 < NetworkManager__getTime(0) && !this->fields.isShowDeadLineDialog )
    {
      this->fields.isShowDeadLineDialog = 1;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_2736/*"BATTLE_CONTINUE_ITEM_END_TIME"*/, 0);
      v13 = (ErrorDialog_ClickDelegate_o *)sub_1CE694C(ErrorDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4E081A0 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_17658/*"btn_cancel"*/);
    byte_4E081A0 = 1;
  }
  return (System_String_o *)StringLiteral_17658/*"btn_cancel"*/;
}
