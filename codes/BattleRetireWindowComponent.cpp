        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3411D & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2855/*"BATTLE_RETIRE_CHECKSTR"*/);
    sub_1C93AD4(&StringLiteral_2856/*"BATTLE_RETIRE_CONSUME_COST_CHECKSTR"*/);
  ...
  if ( !continueItemRoot )
    goto LABEL_62;
  UILabel__set_text((UILabel_o *)continueItemRoot, (System_String_o *)StringLiteral_1116/*"0"*/, 0);
  ...
  continueItemRoot = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !continueItemRoot )
    goto LABEL_62;
                              ...
                              if ( continueItemRoot )
                              {
                                ...
                                if ( continueItemRoot )
                                {
                                  ...
                                  continueItemRoot = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                                   (System_String_o *)StringLiteral_2855/*"BATTLE_RETIRE_CHECKSTR"*/,
                                                                                   0);
                                  if ( checkGiveUpLabel )
                                  {
  ...
  if ( ((unsigned __int8)continueItemRoot & 1) != 0 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = &StringLiteral_2856/*"BATTLE_RETIRE_CONSUME_COST_CHECKSTR"*/;
    goto LABEL_38;
  }
  ...
  if ( !QuestPhaseEntity__IsInterruptionQuest((QuestPhaseEntity_o *)continueItemRoot, 0) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = &StringLiteral_2855/*"BATTLE_RETIRE_CHECKSTR"*/;
LABEL_38:
...
LABEL_62:
    sub_1C93D2C(continueItemRoot, call);
  }
...
void BattleRetireWindowComponent__SetInterruptionQuestUI(BattleRetireWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D3411E & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_16724/*"_{0}"*/);
    sub_1C93AD4(&StringLiteral_2857/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/);
    sub_1C93AD4(&StringLiteral_2858/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR_PARTY"*/);
    byte_4D3411E = 1;
  }
  ...
  UnityEngine_Transform__set_localPosition(
    ...
    0);
  checkGiveUpLabel = (UIWidget_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3AC57EC *)Method_SingletonTemplate_BattleItemData__get_Instance__);
  if ( !checkGiveUpLabel )
    goto LABEL_49;
  v4 = checkGiveUpLabel;
  ...
  v6 = (System_String_o *)StringLiteral_2857/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/;
  if ( BattleData__IsWaveSetupAsOneParty((BattleData_o *)checkGiveUpLabel, 0) )
    v6 = (System_String_o *)StringLiteral_2858/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR_PARTY"*/;
  if ( m_CachedPtr >= 1 )
  {
    v17 = m_CachedPtr;
    v7 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v17);
    v8 = System_String__Format((System_String_o *)StringLiteral_16724/*"_{0}"*/, v7, 0);
    v6 = System_String__Concat_64425724((System_String_o *)StringLiteral_2857/*"BATTLE_RETIRE_INTERRUPTION_BATTLE_ITEM_CHECK_STR"*/, v8, 0);
  }
  v9 = this->fields.checkGiveUpLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !giveUpBg )
    goto LABEL_49;
  UIRect__SetAnchor_50138724(giveUpBg, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0, 0) )
  {
    ...
    if ( !Component_object )
      goto LABEL_49;
    UIRect__SetAnchor_50138724(Component_object, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v16, 0, 0) )
  {
    ...
    if ( checkGiveUpLabel )
    {
      ...
      if ( v16 )
      {
        UIRect__SetAnchor_50138724(v16, (UnityEngine_GameObject_o *)checkGiveUpLabel, 0);
...
LABEL_49:
    sub_1C93D2C(checkGiveUpLabel, method);
  }
}
...
void BattleRetireWindowComponent__Update(BattleRetireWindowComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D3411B & 1) == 0 )
  {
    sub_1C93AD4(&Method_BattleRetireWindowComponent_CallbackConfirmDialog__);
    sub_1C93AD4(&ErrorDialog_ClickDelegate_TypeInfo);
    sub_1C93AD4(&LocalizationManager_TypeInfo);
    sub_1C93AD4(&NetworkManager_TypeInfo);
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C93AD4(&StringLiteral_2732/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/);
    sub_1C93AD4(&StringLiteral_2731/*"BATTLE_CONTINUE_ITEM_END_TIME"*/);
  ...
  if ( !UnityEngine_Object__op_Equality(data_k__BackingField, 0, 0) && this->fields.EnableContinueItem )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_2732/*"BATTLE_CONTINUE_ITEM_GIVEUP"*/, 0);
    if ( !this->fields._data_k__BackingField )
      goto LABEL_21;
    v7 = v5;
    ...
    if ( v10 < NetworkManager__getTime(0) && !this->fields.isShowDeadLineDialog )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_2731/*"BATTLE_CONTINUE_ITEM_END_TIME"*/, 0);
      v13 = (ErrorDialog_ClickDelegate_o *)sub_1C93D20(ErrorDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4D3411F & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_17601/*"btn_cancel"*/);
    byte_4D3411F = 1;
  }
  return (System_String_o *)StringLiteral_17601/*"btn_cancel"*/;
}
