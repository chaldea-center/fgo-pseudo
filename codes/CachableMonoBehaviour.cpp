        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mRenderer, 0LL, 0LL) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mRenderer, (int32_t)Component_object, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mRigidbody, 0LL, 0LL) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mRigidbody, (int32_t)Component_object, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AFE5 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponent_Transform___, method);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v3);
    byte_4A4AFE5 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(mTransform, 0LL, 0LL) )
  {
    Component_object = UnityEngine_Component__GetComponent_object_(
                         (UnityEngine_Component_o *)this,
                         (const MethodInfo_2F646C0 *)Method_UnityEngine_Component_GetComponent_Transform___);
    this->fields.mTransform = (struct UnityEngine_Transform_o *)Component_object;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mTransform, (int32_t)Component_object, v6, v7);
  }
