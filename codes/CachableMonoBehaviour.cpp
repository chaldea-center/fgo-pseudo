        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mRenderer, 0LL, 0LL) )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.mRenderer, (int32_t)Component_object, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mRigidbody, 0LL, 0LL) )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.mRigidbody, (int32_t)Component_object, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18FEE & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_Component_GetComponent_Transform___, method);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v3);
    byte_4B18FEE = 1;
  }
  ...
  if ( UnityEngine_Object__op_Equality(mTransform, 0LL, 0LL) )
  {
    Component_object = UnityEngine_Component__GetComponent_object_(
                         (UnityEngine_Component_o *)this,
                         (const MethodInfo_3011274 *)Method_UnityEngine_Component_GetComponent_Transform___);
    this->fields.mTransform = (struct UnityEngine_Transform_o *)Component_object;
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.mTransform, (int32_t)Component_object, v6, v7);
  }
