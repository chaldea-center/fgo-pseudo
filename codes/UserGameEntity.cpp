...
int32_t __fastcall UserGameEntity__GetFriendPoint(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A207EA & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_TblUserMaster___, method);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__getInstance__, v3);
    byte_4A207EA = 1;
  }
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_TblUserMaster___)) == 0LL
...
int32_t __fastcall UserGameEntity__GetSpellImageId(int32_t genderType, int64_t equipId, const MethodInfo *method)
{
  ...
  if ( (byte_4A207ED & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_EquipMaster___, equipId);
    sub_1B715CC(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v5);
  ...
  if ( !Instance
    ...
    || (Instance = DataMasterBase_object__object__int___GetEntity(
                     ...
                     v3,
                     (const MethodInfo_30F8760 *)Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__)) == 0LL )
  {
  ...
  *(_QWORD *)&v13.fields.fakeValue = monitor;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v13, 0LL);
}
...
int64_t __fastcall UserGameEntity__getActiveUserEquipId(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A207F0 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserDeckMaster___, method);
    sub_1B715CC(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__, v3);
    sub_1B715CC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4);
    byte_4A207F0 = 1;
  }
  result = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !result )
    goto LABEL_9;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A207E8 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_3731/*"COMMAND_SPELL_RECOVER_AT"*/, v8);
    byte_4A207E8 = 1;
  }
  ...
  {
    Value = ConstantMaster__getValue((System_String_o *)StringLiteral_3731/*"COMMAND_SPELL_RECOVER_AT"*/, 0LL);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    if ( this->fields.commandSpellUseAt < NetworkManager__getNextDayTime_38272876(Value, 0LL) - 86400 )
      goto LABEL_20;
  }
...
int32_t __fastcall UserGameEntity__getCommandSpell(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&NetworkManager_TypeInfo, method);
    sub_1B715CC(&StringLiteral_3731/*"COMMAND_SPELL_RECOVER_AT"*/, v3);
    sub_1B715CC(&StringLiteral_9586/*"ONE_COMMAND_SPELL"*/, v4);
    sub_1B715CC(&StringLiteral_8549/*"MAX_COMMAND_SPELL"*/, v5);
    byte_4A207E7 = 1;
  }
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_8549/*"MAX_COMMAND_SPELL"*/, 0LL);
  if ( !ConstantMaster__IsFLAG20240804(0LL) )
    goto LABEL_7;
  v7 = ConstantMaster__getValue((System_String_o *)StringLiteral_3731/*"COMMAND_SPELL_RECOVER_AT"*/, 0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( this->fields.commandSpellUseAt >= NetworkManager__getNextDayTime_38272876(v7, 0LL) - 86400 )
  {
LABEL_7:
    commandSpellRecoverAt = this->fields.commandSpellRecoverAt;
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    ...
    if ( v9 >= 1 )
    {
      v10 = ConstantMaster__getValue((System_String_o *)StringLiteral_9586/*"ONE_COMMAND_SPELL"*/, 0LL);
      v11 = (v9 + v10 - 1) / v10;
      if ( v11 >= Value )
        return 0;
      else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A207E9 & 1) == 0 )
  {
    sub_1B715CC(&BalanceConfig_TypeInfo, exp);
    sub_1B715CC(&Method_DataManager_GetMasterData_UserExpMaster___, v9);
    sub_1B715CC(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int__GetEntity__, v10);
...
bool __fastcall UserGameEntity__getTutorialFlag(UserGameEntity_o *this, int32_t flagId, const MethodInfo *method)
{
  if ( (byte_4A207EE & 1) == 0 )
  {
    sub_1B715CC(&TutorialFlag_TypeInfo, *(_QWORD *)&flagId);
    byte_4A207EE = 1;
  }
  if ( !TutorialFlag_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TutorialFlag_TypeInfo);
  return TutorialFlag__Get_37486608(this, flagId, 0LL);
}
...
int32_t __fastcall UserGameEntity__get_SpellImageId(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A207EB & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserEquipMaster___, method);
    sub_1B715CC(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__GetEntity__, v3);
  ...
  if ( Entity )
  {
    ...
    *(_QWORD *)&v17.fields.fakeValue = monitor;
    v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v17, 0LL);
...
int32_t __fastcall UserGameEntity__get_SpellImageIdBattle(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A207EC & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataManager_GetMasterData_UserEquipMaster___, v3);
    sub_1B715CC(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__GetEntity__, v4);
  ...
  Entity = DataMasterBase_object__object__long___GetEntity(
             ...
             Instance,
             (const MethodInfo_30F890C *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__GetEntity__);
  Instance = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !Instance )
    goto LABEL_26;
  ...
  *(_QWORD *)&v25.fields.fakeValue = monitor;
  v22 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v25, 0LL);
...
void __fastcall UserGameEntity__setTutorialFlag(UserGameEntity_o *this, int32_t flagId, const MethodInfo *method)
{
  ...
  if ( !TutorialFlag_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TutorialFlag_TypeInfo);
  TutorialFlag__Set_37518272(this, flagId, 0LL);
}