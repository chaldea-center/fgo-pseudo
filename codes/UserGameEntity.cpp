...
{
  const MethodInfo_3F0E560 *v3; // x1
  ...
  v3 = (const MethodInfo_3F0E560 *)Method_DataEntityBase_long___ctor__;
  this->fields.mainSupportDeckId = 1;
  DataEntityBase_long____ctor((DataEntityBase_long__o *)this, v3);
}
...
int32_t UserGameEntity__GetFavoriteServantId(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  klass = Master_object[5].klass;
  monitor = Master_object[5].monitor;
...
int32_t UserGameEntity__GetFriendPoint(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_385636C *)Method_DataManager_GetMasterData_TblUserMaster___)) == 0
...
int64_t UserGameEntity__getActNextRecoverTime(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  v5 = actRecoverAt - NetworkManager__getTime(0);
  if ( v5 < 1 )
    return 0;
...
int32_t UserGameEntity__getBaseAct(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  __int64 v5; // x20
  BalanceConfig_c *v6; // x0
  __int64 UerGameActRecoverCost; // x8
  __int64 v8; // x8
  __int64 actMax; // x9
  ...
  UerGameActRecoverCost = v6->static_fields->UerGameActRecoverCost;
  v8 = (v5 + UerGameActRecoverCost - 1) / UerGameActRecoverCost;
...
int32_t UserGameEntity__getBaseRp(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( v7 >= 1 )
  {
    ...
    v10 = (v7 + static_fields->UerGameRpRecoverCost - 1) / static_fields->UerGameRpRecoverCost;
    if ( v10 >= UerGameRpMax )
      return 0;
    else
      UerGameRpMax -= v10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5971790 & 1) == 0 )
  {
    sub_2213A60(&BalanceConfig_TypeInfo);
    sub_2213A60(&NetworkManager_TypeInfo);
    sub_2213A60(&StringLiteral_3820/*"COMMAND_SPELL_RECOVER_AT"*/);
    byte_5971790 = 1;
  }
  ...
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_3820/*"COMMAND_SPELL_RECOVER_AT"*/, 0);
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, v9);
  if ( this->fields.commandSpellUseAt < NetworkManager__getNextDayTime_48348308(Value, 0, 0) - 86400 )
    goto LABEL_19;
  commandSpellRecoverAt = this->fields.commandSpellRecoverAt;
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, v11);
  v14 = commandSpellRecoverAt - NetworkManager__getTime(0);
  if ( !*(&BalanceConfig_TypeInfo->_2.cctor_finished + 1) )
...
LABEL_19:
  ...
  else
  {
    ...
    v16 = (v14 + CommandSpellRecoverCost - 1) / CommandSpellRecoverCost;
    if ( v16 >= CommandSpellMax )
      v17 = 0;
    else
      v17 = CommandSpellMax - v16;
    *count = v17;
    if ( v14 % CommandSpellRecoverCost )
      CommandSpellRecoverCost = v14 % CommandSpellRecoverCost;
  }
...
int32_t UserGameEntity__getCommandSpell(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  v5 = ConstantMaster__getValue((System_String_o *)StringLiteral_3820/*"COMMAND_SPELL_RECOVER_AT"*/, 0);
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, v4);
  if ( this->fields.commandSpellUseAt >= NetworkManager__getNextDayTime_48348308(v5, 0, 0) - 86400 )
  {
    commandSpellRecoverAt = this->fields.commandSpellRecoverAt;
    if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, v6);
    v8 = commandSpellRecoverAt - NetworkManager__getTime(0);
    if ( v8 >= 1 )
    {
      v9 = ConstantMaster__getValue((System_String_o *)StringLiteral_10024/*"ONE_COMMAND_SPELL"*/, 0);
      v10 = (v8 + v9 - 1) / v9;
      if ( v10 >= Value )
        return 0;
      else
...
int64_t UserGameEntity__getRpNextRecoverTime(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  v5 = rpRecoverAt - NetworkManager__getTime(0);
  if ( v5 < 1 )
    return 0;
  v6 = BalanceConfig_TypeInfo;
  if ( !*(&BalanceConfig_TypeInfo->_2.cctor_finished + 1) )
...
int32_t UserGameEntity__get_PayableStoneNum(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Max_77153260(v4, chargeStone, 0);
}
...
int32_t UserGameEntity__get_SpellImageId(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( Entity )
  {
    ...
    *(_QWORD *)&v15.fields.fakeValue = monitor;
    ...
    LODWORD(Entity) = UserGameEntity__GetSpellImageId(genderType, v12, v13);
  }
  return (int)Entity;
}
...
int32_t UserGameEntity__get_SpellImageIdBattle(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = monitor;
  v16 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_55997068(v19, 0);
  Instance = UserGameEntity__GetSpellImageId(v15, v16, v17);
  if ( !*(_QWORD *)(v10 + 64) )
LABEL_26:
    sub_2213CDC(Instance, v4);
  v18 = Instance;
