...
int32_t UserGameEntity__GetFriendPoint(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_31703F4 *)Method_DataManager_GetMasterData_TblUserMaster___)) == 0
...
int32_t UserGameEntity__GetSpellImageId(int32_t genderType, int64_t equipId, const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Instance = DataMasterBase_object__object__int___GetEntity(
                     ...
                     v3,
                     (const MethodInfo_342E2FC *)Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__)) == 0 )
  {
...
int64_t UserGameEntity__getActiveUserEquipId(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  result = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !result )
    goto LABEL_9;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEF519 & 1) == 0 )
  {
    sub_1C7BAE8(&BalanceConfig_TypeInfo);
    sub_1C7BAE8(&NetworkManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_3683/*"COMMAND_SPELL_RECOVER_AT"*/);
    byte_4CEF519 = 1;
  }
  ...
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_3683/*"COMMAND_SPELL_RECOVER_AT"*/, 0);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( this->fields.commandSpellUseAt < NetworkManager__getNextDayTime_41944232(Value, 0) - 86400 )
    goto LABEL_19;
...
int32_t UserGameEntity__getCommandSpell(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEF518 & 1) == 0 )
  {
    sub_1C7BAE8(&NetworkManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_3683/*"COMMAND_SPELL_RECOVER_AT"*/);
    sub_1C7BAE8(&StringLiteral_9651/*"ONE_COMMAND_SPELL"*/);
  ...
  v4 = ConstantMaster__getValue((System_String_o *)StringLiteral_3683/*"COMMAND_SPELL_RECOVER_AT"*/, 0);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( this->fields.commandSpellUseAt >= NetworkManager__getNextDayTime_41944232(v4, 0) - 86400 )
  {
    commandSpellRecoverAt = this->fields.commandSpellRecoverAt;
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    ...
    if ( v6 >= 1 )
    {
      v7 = ConstantMaster__getValue((System_String_o *)StringLiteral_9651/*"ONE_COMMAND_SPELL"*/, 0);
      v8 = (v6 + v7 - 1) / v7;
      if ( v8 >= Value )
        return 0;
      else
...
int32_t UserGameEntity__get_PayableStoneNum(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Max_65698740(v4, chargeStone, 0);
}
...
int32_t UserGameEntity__get_SpellImageIdBattle(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.fakeValue = monitor;
  v16 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49449776(v19, 0);
