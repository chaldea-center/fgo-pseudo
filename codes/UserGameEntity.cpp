...
int32_t UserGameEntity__GetFriendPoint(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_30DD3F0 *)Method_DataManager_GetMasterData_TblUserMaster___)) == 0
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C38887 & 1) == 0 )
  {
    sub_1C32C20(&BalanceConfig_TypeInfo);
    sub_1C32C20(&NetworkManager_TypeInfo);
    sub_1C32C20(&StringLiteral_3678/*"COMMAND_SPELL_RECOVER_AT"*/);
    byte_4C38887 = 1;
  }
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( this->fields.commandSpellUseAt < NetworkManager__getNextDayTime_41268696(Value, 0) - 86400 )
    goto LABEL_19;
...
int32_t UserGameEntity__getCommandSpell(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( this->fields.commandSpellUseAt >= NetworkManager__getNextDayTime_41268696(v4, 0) - 86400 )
  {
    commandSpellRecoverAt = this->fields.commandSpellRecoverAt;
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    ...
    if ( v6 >= 1 )
    {
      v7 = ConstantMaster__getValue((System_String_o *)StringLiteral_9625/*"ONE_COMMAND_SPELL"*/, 0);
      v8 = (v6 + v7 - 1) / v7;
      if ( v8 >= Value )
        return 0;
      else
...
bool UserGameEntity__getTutorialFlag(UserGameEntity_o *this, int32_t flagId, const MethodInfo *method)
{
  ...
  return TutorialFlag__Get_40328500(this, flagId, 0);
}
...
int32_t UserGameEntity__get_PayableStoneNum(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Max_65041976(v4, chargeStone, 0);
}
...
int32_t UserGameEntity__get_SpellImageIdBattle(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v18.fields.fakeValue = monitor;
  v15 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(v18, 0);
...
void UserGameEntity__setTutorialFlag(UserGameEntity_o *this, int32_t flagId, const MethodInfo *method)
{
  ...
  if ( !TutorialFlag_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TutorialFlag_TypeInfo);
  TutorialFlag__Set_40363528(this, flagId, 0);
}