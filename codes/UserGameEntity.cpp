...
int32_t __fastcall UserGameEntity__GetFriendPoint(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_TblUserMaster___)) == 0LL
...
int32_t __fastcall UserGameEntity__GetSpellImageId(int32_t genderType, int64_t equipId, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE517 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_EquipMaster___, equipId);
    sub_1C2E12C(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v5);
  ...
  if ( !Instance
    ...
    || (Instance = DataMasterBase_object__object__int___GetEntity(
                     ...
                     v3,
                     (const MethodInfo_327B180 *)Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__)) == 0LL )
  {
  ...
  *(_QWORD *)&v13.fields.fakeValue = monitor;
  return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v13, 0LL);
}
...
int64_t __fastcall UserGameEntity__getActiveUserEquipId(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE51A & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_DataMasterBase_UserDeckMaster__UserDeckEntity__long__GetEntity__, v3);
    sub_1C2E12C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v4);
    byte_4BFE51A = 1;
  }
  result = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !result )
    goto LABEL_9;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE512 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_3792/*"COMMAND_SPELL_RECOVER_AT"*/, v8);
    byte_4BFE512 = 1;
  }
  ...
  {
    Value = ConstantMaster__getValue((System_String_o *)StringLiteral_3792/*"COMMAND_SPELL_RECOVER_AT"*/, 0LL);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    if ( this->fields.commandSpellUseAt < NetworkManager__getNextDayTime_39878696(Value, 0LL) - 86400 )
      goto LABEL_20;
  }
...
int32_t __fastcall UserGameEntity__getCommandSpell(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, method);
    sub_1C2E12C(&StringLiteral_3792/*"COMMAND_SPELL_RECOVER_AT"*/, v3);
    sub_1C2E12C(&StringLiteral_9809/*"ONE_COMMAND_SPELL"*/, v4);
    sub_1C2E12C(&StringLiteral_8754/*"MAX_COMMAND_SPELL"*/, v5);
    byte_4BFE511 = 1;
  }
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_8754/*"MAX_COMMAND_SPELL"*/, 0LL);
  if ( !ConstantMaster__IsFLAG20240804(0LL) )
    goto LABEL_7;
  v7 = ConstantMaster__getValue((System_String_o *)StringLiteral_3792/*"COMMAND_SPELL_RECOVER_AT"*/, 0LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( this->fields.commandSpellUseAt >= NetworkManager__getNextDayTime_39878696(v7, 0LL) - 86400 )
  {
LABEL_7:
    commandSpellRecoverAt = this->fields.commandSpellRecoverAt;
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    ...
    if ( v9 >= 1 )
    {
      v10 = ConstantMaster__getValue((System_String_o *)StringLiteral_9809/*"ONE_COMMAND_SPELL"*/, 0LL);
      v11 = (v9 + v10 - 1) / v10;
      if ( v11 >= Value )
        return 0;
      else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE513 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_UserExpMaster___, exp);
    sub_1C2E12C(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int__GetEntity__, v9);
...
bool __fastcall UserGameEntity__getTutorialFlag(UserGameEntity_o *this, int32_t flagId, const MethodInfo *method)
{
  if ( (byte_4BFE518 & 1) == 0 )
  {
    sub_1C2E12C(&TutorialFlag_TypeInfo, *(_QWORD *)&flagId);
    byte_4BFE518 = 1;
  }
  if ( !TutorialFlag_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TutorialFlag_TypeInfo);
  return TutorialFlag__Get_39000304(this, flagId, 0LL);
}
...
int32_t __fastcall UserGameEntity__get_PayableStoneNum(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  return System_Math__Max_64054728(v4, chargeStone, 0LL);
}
...
int32_t __fastcall UserGameEntity__get_SpellImageId(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE515 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_UserEquipMaster___, method);
    sub_1C2E12C(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__GetEntity__, v3);
...
int32_t __fastcall UserGameEntity__get_SpellImageIdBattle(UserGameEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE516 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_DataManager_GetMasterData_UserEquipMaster___, v3);
    sub_1C2E12C(&Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__GetEntity__, v4);
  ...
  Entity = DataMasterBase_object__object__long___GetEntity(
             ...
             Instance,
             (const MethodInfo_327D6DC *)Method_DataMasterBase_UserEquipMaster__UserEquipEntity__long__GetEntity__);
  Instance = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__);
  if ( !Instance )
    goto LABEL_26;
  ...
  *(_QWORD *)&v25.fields.fakeValue = monitor;
  v22 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v25, 0LL);
...
void __fastcall UserGameEntity__setTutorialFlag(UserGameEntity_o *this, int32_t flagId, const MethodInfo *method)
{
  ...
  if ( !TutorialFlag_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(TutorialFlag_TypeInfo);
  TutorialFlag__Set_39033792(this, flagId, 0LL);
}