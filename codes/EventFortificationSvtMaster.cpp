void __fastcall EventFortificationSvtMaster___ctor(EventFortificationSvtMaster_o *this, const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    393,
    (const MethodInfo_32CA594 *)Method_DataMasterBase_EventFortificationSvtMaster__EventFortificationSvtEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventFortificationSvtEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                            (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                            PK,
                                            (const MethodInfo_32CC8B8 *)Method_DataMasterBase_EventFortificationSvtMaster__EventFortificationSvtEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32CC904 *)Method_DataMasterBase_EventFortificationSvtMaster__EventFortificationSvtEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C4DC & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&System_Collections_Generic_IEnumerator_EventFortificationSvtEntity__TypeInfo, v9);
    sub_1BCAFF8(&System_Collections_IEnumerator_TypeInfo, v10);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_EventFortificationSvtEntity__Add__, v11);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_EventFortificationSvtEntity___ctor__, v12);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_EventFortificationSvtEntity__get_Count__, v13);
    sub_1BCAFF8(&System_Collections_Generic_List_EventFortificationSvtEntity__TypeInfo, v14);
  ...
  v19 = (System_Collections_Generic_List_object__o *)sub_1BCB244(System_Collections_Generic_List_EventFortificationSvtEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v19,
    (const MethodInfo_36B939C *)Method_System_Collections_Generic_List_EventFortificationSvtEntity___ctor__);
  Instance = (DataManager_o *)this->fields.list;
  if ( !Instance )
    goto LABEL_41;
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 (System_Collections_ObjectModel_Collection_T__o *)Instance,
                 (const MethodInfo_3263BC0 *)Method_System_Collections_ObjectModel_Collection_EventFortificationSvtEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BCB254(0LL, v20);
  while ( 1 )
  {
...
LABEL_10:
    ...
    {
LABEL_17:
      v29 = sub_1C1B560(Enumerator, System_Collections_Generic_IEnumerator_EventFortificationSvtEntity__TypeInfo, 0LL);
    }
...
LABEL_33:
  ...
  *eventFortificationSvtList = (System_Collections_Generic_List_EventFortificationSvtEntity__o *)v19;
  sub_1BCAF9C((CGThumbnailListItem_o *)eventFortificationSvtList, (int32_t)v19, v44, v45);
