void __fastcall ConstantStrMaster___ctor(ConstantStrMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FCC3 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_ConstantStrMaster__ConstantStrEntity__string___ctor__, method);
    byte_4A6FCC3 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    103,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_ConstantStrMaster__ConstantStrEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCCF & 1) == 0 )
  {
    sub_1B90010(&Method_BasicHelper_Any_int____76172960, name);
    sub_1B90010(&System_Func_int__bool__TypeInfo, v7);
    sub_1B90010(&Method_ConstantStrMaster___c__DisplayClass14_0__ExistValueArray_b__0__, v8);
    sub_1B90010(&ConstantStrMaster___c__DisplayClass14_0_TypeInfo, v9);
    byte_4A6FCCF = 1;
  }
  v10 = sub_1B9025C(ConstantStrMaster___c__DisplayClass14_0_TypeInfo);
  ...
  *(_DWORD *)(v10 + 16) = checkVal;
  ...
  if ( ValueArray )
  {
    ...
    System_Func_int__bool____ctor(
      ...
      0LL);
    LOBYTE(ValueArray) = BasicHelper__Any_int__48730980(
                           v15,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCCD & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_getEntityFromKey_ConstantStrEntity___, method);
    sub_1B90010(&StringLiteral_3692/*"COMBINE_SCENE_VOICE_RETURN"*/, v3);
    byte_4A6FCCD = 1;
  }
  EntityFromKey_object = DataMasterBase__getEntityFromKey_object_(
                           (DataMasterBase_o *)this,
                           (System_String_o *)StringLiteral_3692/*"COMBINE_SCENE_VOICE_RETURN"*/,
                           (const MethodInfo_2E8E994 *)Method_DataMasterBase_getEntityFromKey_ConstantStrEntity___);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataMasterBase_getEntityFromKey_ConstantStrEntity___, method);
    sub_1B90010(&StringLiteral_3693/*"COMBINE_SCENE_VOICE_WELCOME"*/, v3);
    byte_4A6FCCC = 1;
  }
  EntityFromKey_object = DataMasterBase__getEntityFromKey_object_(
                           (DataMasterBase_o *)this,
                           (System_String_o *)StringLiteral_3693/*"COMBINE_SCENE_VOICE_WELCOME"*/,
                           (const MethodInfo_2E8E994 *)Method_DataMasterBase_getEntityFromKey_ConstantStrEntity___);
  return ConstantStrMaster__GetVoiceList(
           (ConstantStrMaster_o *)EntityFromKey_object,
           (ConstantStrEntity_o *)EntityFromKey_object,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCCE & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_getEntityFromKey_ConstantStrEntity___, key);
  ...
  {
    v9 = VoiceList;
    v10 = UnityEngine_Random__Range_69499180(0, VoiceList->max_length, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCC7 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_ConstantStrMaster__ConstantStrEntity__string__TryGetEntity__, name);
    byte_4A6FCC7 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataMasterBase_ConstantStrMaster__ConstantStrEntity__string__TryGetEntity__, name);
    sub_1B90010(&Method_System_Linq_Enumerable_Select_string__int___, v7);
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_int___, v8);
    sub_1B90010(&System_Func_string__int__TypeInfo, v9);
    sub_1B90010(&Method_ConstantStrMaster___c__GetValueArray_b__6_0__, v10);
    sub_1B90010(&ConstantStrMaster___c_TypeInfo, v11);
    byte_4A6FCC8 = 1;
  }
  entity = 0LL;
  ...
  if ( v12 )
  {
    ...
    if ( monitor )
    {
      ...
      if ( !_9__6_0 )
      {
        ...
        _9__6_0 = (System_Func_object__int__o *)sub_1B9025C(System_Func_string__int__TypeInfo);
...
System_Int32_array *__fastcall ConstantStrMaster__GetValueAsIntArray(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCC6 & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMaster_ConstantStrMaster___, method);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataMasterBase_ConstantStrMaster__ConstantStrEntity__string__TryGetEntity__, name);
    sub_1B90010(&Method_System_Linq_Enumerable_Select_string__float___, v5);
    sub_1B90010(&Method_System_Linq_Enumerable_ToArray_float___, v6);
    sub_1B90010(&System_Func_string__float__TypeInfo, v7);
    sub_1B90010(&Method_ConstantStrMaster___c__GetValueFloatArray_b__7_0__, v8);
    sub_1B90010(&ConstantStrMaster___c_TypeInfo, v9);
    byte_4A6FCC9 = 1;
  }
  entity = 0LL;
  ...
  if ( v11 )
  {
    ...
    if ( result )
    {
      ...
      if ( !_9__7_0 )
      {
        ...
        _9__7_0 = (System_Func_T__TResult__o *)sub_1B9025C(System_Func_string__float__TypeInfo);
      ...
      v20 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__float_(
                                                                   ...
                                                                   (const MethodInfo_2EBF0F0 *)Method_System_Linq_Enumerable_Select_string__float___);
      return System_Linq_Enumerable__ToArray_float_(
               v20,
               (const MethodInfo_2EC701C *)Method_System_Linq_Enumerable_ToArray_float___);
    }
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCCA & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_TryGetEntityFromId_ConstantStrEntity___, name);
    byte_4A6FCCA = 1;
  }
  result = 0LL;
  EntityFromId_object = DataMasterBase__TryGetEntityFromId_object_(
                          ...
                          &result,
                          name,
                          (const MethodInfo_2E8E6BC *)Method_DataMasterBase_TryGetEntityFromId_ConstantStrEntity___);
  monitor = 0LL;
  if ( EntityFromId_object )
  {
    if ( !result || (monitor = (System_String_array *)result[1].monitor) == 0LL )
      sub_1B9026C(monitor, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( ValueFloatArray )
  {
    if ( ValueFloatArray->max_length < 3 )
      sub_1B90274(ValueFloatArray, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCCB & 1) == 0 )
  {
    sub_1B90010(&char___TypeInfo, ent);
    sub_1B90010(&string_____TypeInfo, v4);
    byte_4A6FCCB = 1;
  }
  if ( !ent )
    return 0LL;
  value = ent->fields.value;
  v6 = (System_Char_array *)sub_1B900B8(char___TypeInfo, 1LL);
  if ( !v6 )
    goto LABEL_20;
  v7 = v6;
  if ( !v6->max_length )
    goto LABEL_21;
  v6->m_Items[2] = 47;
  if ( !value || (v6 = (System_Char_array *)System_String__Split_61809248(value, v6, 0LL)) == 0LL )
LABEL_20:
    sub_1B9026C(v6, v7);
  v8 = v6;
  v6 = (System_Char_array *)sub_1B900B8(string_____TypeInfo, v6->max_length);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( (unsigned int)v11 < max_length )
    {
      ...
      if ( !v13 )
        goto LABEL_20;
      v6 = (System_Char_array *)System_String__Split_61809248(v13, v6, 0LL);
      if ( !v10 )
        goto LABEL_20;
      if ( (unsigned int)v11 >= v10->max_length )
        break;
      v12->klass = (ServantStatusBattleListViewItem_c *)v6;
      sub_1B8FFB4(v12, (int32_t)v6, v14, v15);
      max_length = v8->max_length;
      ++v11;
...
System_String_o *__fastcall ConstantStrMaster__getValue(System_String_o *name, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ConstantStrMaster___, method);
    sub_1B90010(&Method_DataMasterBase_getEntityFromKey_ConstantStrEntity___, v3);
...
void __fastcall ConstantStrMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCD0 & 1) == 0 )
  {
    sub_1B90010(&ConstantStrMaster___c_TypeInfo, v1);
    byte_4A6FCD0 = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(ConstantStrMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ConstantStrMaster___c_TypeInfo->static_fields->__9 = (struct ConstantStrMaster___c_o *)v2;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)ConstantStrMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
