...
System_String_o *__fastcall CommandCodeDetach__getURL(CommandCodeDetach_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDE3C & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_18458/*"commandCode/detach"*/);
    byte_4BDDE3C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_18458/*"commandCode/detach"*/, 0LL);
}
