...
System_String_o *__fastcall CommandCodeDetach__getURL(CommandCodeDetach_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_421483A & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_17650/*"commandCode/detach"*/, v2);
    byte_421483A = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_17650/*"commandCode/detach"*/, 0LL);
}
