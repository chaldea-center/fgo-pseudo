...
System_String_o *__fastcall CommandCodeDetach__getURL(CommandCodeDetach_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0102 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17719/*"commandCode/detach"*/);
    byte_42B0102 = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17719/*"commandCode/detach"*/, 0LL);
}
