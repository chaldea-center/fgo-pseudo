...
System_String_o *__fastcall CommandCodeDetach__getURL(CommandCodeDetach_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_41880F5 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_17594/*"commandCode/detach"*/, v2);
    byte_41880F5 = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_17594/*"commandCode/detach"*/, 0LL);
}
