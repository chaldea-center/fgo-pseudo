...
System_String_o *__fastcall CommandCodeDetach__getURL(CommandCodeDetach_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FA5AC & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_17527/*"commandCode/detach"*/, v2);
    byte_40FA5AC = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_17527/*"commandCode/detach"*/, 0LL);
}
