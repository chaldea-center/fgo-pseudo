...
void SupportSelectConfirmDeckMenu__Close(SupportSelectConfirmDeckMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB28F4 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SupportSelectConfirmDeckMenu_OnFinishedClose__);
    byte_4CB28F4 = 1;
  }
  this->fields.currentState = 2;
...
void SupportSelectConfirmDeckMenu__OnClickCancel(SupportSelectConfirmDeckMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB28F6 & 1) == 0 )
  {
    sub_1C6BA08(&Method_SupportSelectConfirmDeckMenu_OnClickCancel__);
    byte_4CB28F6 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmDeckMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_SupportSelectConfirmDeckMenu_OnClickCancel__);
...
void SupportSelectConfirmDeckMenu__OnClickDecide(SupportSelectConfirmDeckMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB28F5 & 1) == 0 )
  {
    sub_1C6BA08(&Method_SupportSelectConfirmDeckMenu_OnClickDecide__);
    byte_4CB28F5 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmDeckMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_SupportSelectConfirmDeckMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C6B9EC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB28F3 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SupportSelectConfirmDeckMenu_OnFinishedOpen__);
    sub_1C6BA08(&StringLiteral_12535/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_INIT_ALL_DECK_NAME"*/);
    sub_1C6BA08(&StringLiteral_12534/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_DECIDE"*/);
    sub_1C6BA08(&StringLiteral_12540/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_MESSAGE"*/);
    sub_1C6BA08(&StringLiteral_12537/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_INIT_ALL_TITLE"*/);
    sub_1C6BA08(&StringLiteral_12536/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_INIT_ALL_MESSAGE"*/);
    sub_1C6BA08(&StringLiteral_12538/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_EQUIP_MESSAGE"*/);
    sub_1C6BA08(&StringLiteral_12539/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_EQUIP_TITLE"*/);
    sub_1C6BA08(&StringLiteral_12541/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_TITLE"*/);
    sub_1C6BA08(&StringLiteral_12522/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_CANCEL"*/);
    byte_4CB28F3 = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    if ( kind == 2 )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12539/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_EQUIP_TITLE"*/, 0);
      if ( !titleLabel )
        goto LABEL_34;
      UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
      messageLabel = this->fields.messageLabel;
      v13 = &StringLiteral_12538/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_EQUIP_MESSAGE"*/;
    }
    else
    {
      if ( kind == 1 )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12537/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_INIT_ALL_TITLE"*/, 0);
        if ( !v16 )
          goto LABEL_34;
        UILabel__set_text(v16, (System_String_o *)gameObject, 0);
        v17 = this->fields.messageLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12536/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_INIT_ALL_MESSAGE"*/, 0);
        if ( !v17 )
          goto LABEL_34;
        UILabel__set_text(v17, (System_String_o *)gameObject, 0);
        nameLabel = this->fields.nameLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12535/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_INIT_ALL_DECK_NAME"*/, 0);
        if ( !supportData )
          goto LABEL_34;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12541/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_TITLE"*/, 0);
      if ( !v11 )
        goto LABEL_34;
      UILabel__set_text(v11, (System_String_o *)gameObject, 0);
      messageLabel = this->fields.messageLabel;
      v13 = &StringLiteral_12540/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_REMOVE_ALL_MESSAGE"*/;
    }
...
LABEL_28:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12534/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_DECIDE"*/, 0);
    if ( decideButtonLabel )
    {
      UILabel__set_text(decideButtonLabel, (System_String_o *)gameObject, 0);
      cancelButtonLabel = this->fields.cancelButtonLabel;
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12522/*"SUPPORT_SELECT_CONFIRM_DECK_MENU_CANCEL"*/, 0);
      if ( cancelButtonLabel )
      {
        ...
        if ( gameObject )
        {
          ...
          sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.onClickButton, (int32_t)onClickButton, v22, v23);
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1CC77DC(p_onClickButton, v8, v6);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_4638/*"ConfirmWindow/CancelButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A9E0AC;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A9E064;
}
