...
void __fastcall SupportSelectConfirmDeckMenu__Close(SupportSelectConfirmDeckMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1E782 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SupportSelectConfirmDeckMenu_OnFinishedClose__, v3);
    byte_4C1E782 = 1;
  }
  this->fields.currentState = 2;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E784 & 1) == 0 )
  {
    sub_1C3B764(&Method_SupportSelectConfirmDeckMenu_OnClickCancel__, method);
    byte_4C1E784 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmDeckMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_SupportSelectConfirmDeckMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E783 & 1) == 0 )
  {
    sub_1C3B764(&Method_SupportSelectConfirmDeckMenu_OnClickDecide__, method);
    byte_4C1E783 = 1;
  }
  if ( this->fields.currentState == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportSelectConfirmDeckMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_SupportSelectConfirmDeckMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3B748(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E781 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SupportSelectConfirmDeckMenu_OnFinishedOpen__, v11);
    sub_1C3B764(&StringLiteral_12708/*"Standalone document declaration must have a value of 'no' because an external entity '{0}' is referenced."*/, v12);
    sub_1C3B764(&StringLiteral_12707/*"StandFigureR("*/, v13);
    sub_1C3B764(&StringLiteral_12713/*"Start index cannot be less than 0 or greater than input length."*/, v14);
    sub_1C3B764(&StringLiteral_12710/*"StandardName"*/, v15);
    sub_1C3B764(&StringLiteral_12709/*"StandardCutIn"*/, v16);
    sub_1C3B764(&StringLiteral_12711/*"Start"*/, v17);
    sub_1C3B764(&StringLiteral_12712/*"Start StyleValues must contain the same values as end values. Missing property:"*/, v18);
    sub_1C3B764(&StringLiteral_12714/*"StartAnimationName"*/, v19);
    sub_1C3B764(&StringLiteral_12695/*"SrareTreasureGetPlus2"*/, v20);
    byte_4C1E781 = 1;
  }
  if ( this->fields.currentState == 2 )
  {
    ...
    if ( kind == 2 )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12712/*"Start StyleValues must contain the same values as end values. Missing property:"*/, 0LL);
      if ( !titleLabel )
        goto LABEL_34;
      UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
      messageLabel = this->fields.messageLabel;
      v25 = &StringLiteral_12711/*"Start"*/;
    }
    else
    {
      if ( kind == 1 )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12710/*"StandardName"*/, 0LL);
        if ( !v28 )
          goto LABEL_34;
        UILabel__set_text(v28, (System_String_o *)gameObject, 0LL);
        v29 = this->fields.messageLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12709/*"StandardCutIn"*/, 0LL);
        if ( !v29 )
          goto LABEL_34;
        UILabel__set_text(v29, (System_String_o *)gameObject, 0LL);
        nameLabel = this->fields.nameLabel;
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12708/*"Standalone document declaration must have a value of 'no' because an external entity '{0}' is referenced."*/, 0LL);
        if ( !supportData )
          goto LABEL_34;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12714/*"StartAnimationName"*/, 0LL);
      if ( !v23 )
        goto LABEL_34;
      UILabel__set_text(v23, (System_String_o *)gameObject, 0LL);
      messageLabel = this->fields.messageLabel;
      v25 = &StringLiteral_12713/*"Start index cannot be less than 0 or greater than input length."*/;
    }
...
LABEL_28:
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12707/*"StandFigureR("*/, 0LL);
    if ( decideButtonLabel )
    {
      UILabel__set_text(decideButtonLabel, (System_String_o *)gameObject, 0LL);
      cancelButtonLabel = this->fields.cancelButtonLabel;
      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12695/*"SrareTreasureGetPlus2"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E77F & 1) == 0 )
  {
    sub_1C3B764(&SupportSelectConfirmDeckMenu_OnClickButtonEvent_TypeInfo, value);
    byte_4C1E77F = 1;
  }
  onClickButton = this->fields.onClickButton;
  ...
  while ( 1 )
  {
    ...
    v9 = sub_1C76C54(p_onClickButton, v8, v6);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A78F04;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A78EBC;
}
