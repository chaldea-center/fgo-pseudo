        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_597129D & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ServantPassiveSkillReleaseEntity___c__IsUseInternal_b__12_0__);
    sub_2213A60(&ServantPassiveSkillReleaseEntity___c_TypeInfo);
    byte_597129D = 1;
  }
  value = 0;
  switch ( currentCondType )
  {
    ...
    case 113:
      ...
      if ( Master_object )
      {
        ...
        v15 = (System_Collections_Generic_Dictionary_int__bool__o *)sub_2213CCC(System_Collections_Generic_Dictionary_int__bool__TypeInfo);
...
void ServantPassiveSkillReleaseEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_2213CCC(ServantPassiveSkillReleaseEntity___c_TypeInfo);
