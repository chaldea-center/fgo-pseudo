        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B156 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__Add__, defenceTarget);
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__, v5);
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__get_Count__, v6);
    sub_1B686D4(&System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo, v7);
    byte_4A0B156 = 1;
  }
  ...
  if ( buffData )
  {
    ...
    v10 = (System_Collections_Generic_List_object__o *)sub_1B68920(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
    ...
    if ( max_length >= 1 )
    {
      ...
      {
        if ( v16 >= max_length )
          sub_1B68938(ShowServantParam, v12);
        ...
        if ( !v17 )
        {
          ...
          else
          {
            ...
            sub_1B68678((ServantStatusBattleListViewItem_o *)(v21 + 4), (int32_t)v12, v13, v14);
          }
        }
        max_length = ActiveList->max_length;
      }
    ...
    {
LABEL_24:
      sub_1B68930(ShowServantParam, v12);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B154 & 1) == 0 )
  {
    sub_1B686D4(&BattleDefenceTargetData_SaveData_TypeInfo, method);
    byte_4A0B154 = 1;
  }
  if ( this->fields.maxHp < 1 || this->fields.uiId < 1 )
    return 0LL;
  v3 = sub_1B68920(BattleDefenceTargetData_SaveData_TypeInfo);
  ...
  *(_QWORD *)(v3 + 24) = SaveData;
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v3 + 24), (int32_t)SaveData, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B153 & 1) == 0 )
  {
    sub_1B686D4(&BattleBuffData_TypeInfo, *(_QWORD *)&nowHp);
    byte_4A0B153 = 1;
  }
  ...
  if ( !buffData )
  {
    v11 = (BattleBuffData_o *)sub_1B68920(BattleBuffData_TypeInfo);
    BattleBuffData___ctor(v11, 0LL);
    *p_buffData = v11;
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.buffData, (int32_t)v11, v12, v13);
    buffData = *p_buffData;
    if ( !*p_buffData )
      sub_1B68930(0LL, v14);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B155 & 1) == 0 )
  {
    sub_1B686D4(&BattleBuffData_TypeInfo, saveData);
    byte_4A0B155 = 1;
  }
  if ( saveData )
  {
    ...
    *(_QWORD *)&this->fields.nowHp = *(_QWORD *)&saveData->fields.nowHp;
    if ( !buffData )
    {
      v7 = (BattleBuffData_o *)sub_1B68920(BattleBuffData_TypeInfo);
      BattleBuffData___ctor(v7, 0LL);
      *p_buffData = v7;
      sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.buffData, (int32_t)v7, v8, v9);
      buffData = *p_buffData;
      if ( !*p_buffData )
        sub_1B68930(0LL, v10);
    }
