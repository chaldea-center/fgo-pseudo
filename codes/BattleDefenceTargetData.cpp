        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A2CB & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__Add__);
  ...
  if ( buffData )
  {
    ...
    v7 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
      ...
      do
      {
        ...
        if ( !v14 )
        {
          ...
          else
          {
            ...
            sub_1C32BC4((CGThumbnailListItem_o *)(v18 + 4), (int32_t)v13, v9, v10);
          }
        }
        max_length = ActiveList->max_length;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A2C9 & 1) == 0 )
  {
    sub_1C32C20(&BattleDefenceTargetData_SaveData_TypeInfo);
    byte_4C3A2C9 = 1;
  }
  if ( this->fields.maxHp < 1 || this->fields.uiId < 1 )
    return 0;
  v3 = sub_1C32E6C(BattleDefenceTargetData_SaveData_TypeInfo);
  ...
  *(_QWORD *)(v3 + 24) = SaveData;
  sub_1C32BC4((CGThumbnailListItem_o *)(v3 + 24), (int32_t)SaveData, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( !buffData )
  {
    v11 = (BattleBuffData_o *)sub_1C32E6C(BattleBuffData_TypeInfo);
    BattleBuffData___ctor(v11, 0);
    *p_buffData = v11;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.buffData, (int32_t)v11, v12, v13);
    buffData = *p_buffData;
    if ( !*p_buffData )
      sub_1C32E7C(0);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( saveData )
  {
    ...
    *(_QWORD *)&this->fields.nowHp = *(_QWORD *)&saveData->fields.nowHp;
    if ( !buffData )
    {
      v7 = (BattleBuffData_o *)sub_1C32E6C(BattleBuffData_TypeInfo);
      BattleBuffData___ctor(v7, 0);
      *p_buffData = v7;
      sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.buffData, (int32_t)v7, v8, v9);
      buffData = *p_buffData;
      if ( !*p_buffData )
        sub_1C32E7C(0);
    }
