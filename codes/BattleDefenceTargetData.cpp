        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29BB9 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__Add__);
  ...
  if ( buffData )
  {
    ...
    v7 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
    ...
    if ( max_length >= 1 )
    {
      ...
      {
        if ( v13 >= max_length )
          sub_1C2D6F4(ShowServantParam, v9, v10);
        ...
        if ( !v14 )
        {
          ...
          else
          {
            ...
            sub_1C2D434((CGThumbnailListItem_o *)(v18 + 4), (int32_t)v9, v10, v11);
          }
        }
        max_length = ActiveList->max_length;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29BB7 & 1) == 0 )
  {
    sub_1C2D490(&BattleDefenceTargetData_SaveData_TypeInfo);
    byte_4C29BB7 = 1;
  }
  if ( this->fields.maxHp < 1 || this->fields.uiId < 1 )
    return 0;
  v3 = sub_1C2D6DC(BattleDefenceTargetData_SaveData_TypeInfo);
  ...
  *(_QWORD *)(v3 + 24) = SaveData;
  sub_1C2D434((CGThumbnailListItem_o *)(v3 + 24), (int32_t)SaveData, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( !buffData )
  {
    v11 = (BattleBuffData_o *)sub_1C2D6DC(BattleBuffData_TypeInfo);
    BattleBuffData___ctor(v11, 0);
    *p_buffData = v11;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.buffData, (int32_t)v11, v12, v13);
    buffData = *p_buffData;
    if ( !*p_buffData )
      sub_1C2D6EC(0, v14);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( saveData )
  {
    ...
    *(_QWORD *)&this->fields.nowHp = *(_QWORD *)&saveData->fields.nowHp;
    if ( !buffData )
    {
      v7 = (BattleBuffData_o *)sub_1C2D6DC(BattleBuffData_TypeInfo);
      BattleBuffData___ctor(v7, 0);
      *p_buffData = v7;
      sub_1C2D434((CGThumbnailListItem_o *)&this->fields.buffData, (int32_t)v7, v8, v9);
      buffData = *p_buffData;
      if ( !*p_buffData )
        sub_1C2D6EC(0, v10);
    }
