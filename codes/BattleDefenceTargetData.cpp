        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6CF2 & 1) == 0 )
  {
    sub_1C13D24(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__Add__, defenceTarget);
    sub_1C13D24(&Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__, v5);
    sub_1C13D24(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__get_Count__, v6);
    sub_1C13D24(&System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo, v7);
    byte_4BB6CF2 = 1;
  }
  ...
  if ( buffData )
  {
    ...
    v10 = (System_Collections_Generic_List_object__o *)sub_1C13F70(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v10,
      (const MethodInfo_362C998 *)Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__);
    if ( !ActiveList )
      goto LABEL_24;
    ...
    if ( max_length >= 1 )
    {
      ...
      {
        if ( v20 >= max_length )
          sub_1C13F88(ShowServantParam, v12);
        ...
        *(_DWORD *)(v12 + 20) = v21;
        if ( !v21 )
        {
          ...
          else
          {
            ...
            sub_1C13CC8((PartyOrganizationUtility_o *)(v25 + 4), v12, v13, v14, v15, v16, v17, v18);
          }
        }
        max_length = ActiveList->max_length;
      }
    ...
    {
LABEL_24:
      sub_1C13F80(ShowServantParam, v12);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6CF0 & 1) == 0 )
  {
    sub_1C13D24(&BattleDefenceTargetData_SaveData_TypeInfo, method);
    byte_4BB6CF0 = 1;
  }
  if ( this->fields.maxHp < 1 || this->fields.uiId < 1 )
    return 0LL;
  v3 = sub_1C13F70(BattleDefenceTargetData_SaveData_TypeInfo);
  ...
  *(_QWORD *)(v3 + 24) = SaveData;
  sub_1C13CC8((PartyOrganizationUtility_o *)(v3 + 24), (int64_t)SaveData, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6CEF & 1) == 0 )
  {
    sub_1C13D24(&BattleBuffData_TypeInfo, *(_QWORD *)&nowHp);
    byte_4BB6CEF = 1;
  }
  ...
  if ( !buffData )
  {
    v11 = (BattleBuffData_o *)sub_1C13F70(BattleBuffData_TypeInfo);
    BattleBuffData___ctor(v11, 0LL);
    *p_buffData = v11;
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.buffData, (int64_t)v11, v12, v13, v14, v15, v16, v17);
    buffData = *p_buffData;
    if ( !*p_buffData )
      sub_1C13F80(0LL, v18);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6CF1 & 1) == 0 )
  {
    sub_1C13D24(&BattleBuffData_TypeInfo, saveData);
    byte_4BB6CF1 = 1;
  }
  if ( saveData )
  {
    ...
    *(_QWORD *)&this->fields.nowHp = *(_QWORD *)&saveData->fields.nowHp;
    if ( !buffData )
    {
      v7 = (BattleBuffData_o *)sub_1C13F70(BattleBuffData_TypeInfo);
      BattleBuffData___ctor(v7, 0LL);
      *p_buffData = v7;
      sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.buffData, (int64_t)v7, v8, v9, v10, v11, v12, v13);
      buffData = *p_buffData;
      if ( !*p_buffData )
        sub_1C13F80(0LL, v14);
    }
