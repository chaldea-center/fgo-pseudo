        ...
        const MethodInfo *method)
{
  ...
  BattleBuffData_BuffData_o *v13; // x1
  int v14; // w8
  ...
  if ( (byte_4C459BC & 1) == 0 )
  {
    sub_1C37058(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__Add__);
    sub_1C37058(&Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__);
    sub_1C37058(&Method_System_Collections_Generic_List_BattleBuffData_BuffData__get_Count__);
    sub_1C37058(&System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
    byte_4C459BC = 1;
  }
  ...
  if ( buffData )
  {
    ...
    v7 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_BattleBuffData_BuffData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v7,
      (const MethodInfo_37A27F0 *)Method_System_Collections_Generic_List_BattleBuffData_BuffData___ctor__);
    if ( !ActiveList )
      goto LABEL_24;
    ...
    if ( max_length >= 1 )
    {
      ...
      {
        if ( v12 >= max_length )
          sub_1C372BC(ShowServantParam);
        v13 = ActiveList->m_Items[v12];
        if ( !v13 )
          goto LABEL_24;
        v14 = v13->fields.turn - 1;
        v13->fields.turn = v14;
        if ( !v14 )
        {
          if ( !v7 )
          ...
          else
          {
            ...
            sub_1C36FFC((CGThumbnailListItem_o *)(v18 + 4), (int32_t)v13, v9, v10);
          }
        }
        max_length = ActiveList->max_length;
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C459BA & 1) == 0 )
  {
    sub_1C37058(&BattleDefenceTargetData_SaveData_TypeInfo);
    byte_4C459BA = 1;
  }
  if ( this->fields.maxHp < 1 || this->fields.uiId < 1 )
    return 0;
  v3 = sub_1C372A4(BattleDefenceTargetData_SaveData_TypeInfo);
  ...
  *(_QWORD *)(v3 + 24) = SaveData;
  sub_1C36FFC((CGThumbnailListItem_o *)(v3 + 24), (int32_t)SaveData, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( !buffData )
  {
    v11 = (BattleBuffData_o *)sub_1C372A4(BattleBuffData_TypeInfo);
    BattleBuffData___ctor(v11, 0);
    *p_buffData = v11;
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.buffData, (int32_t)v11, v12, v13);
    buffData = *p_buffData;
    if ( !*p_buffData )
      sub_1C372B4(0);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( saveData )
  {
    ...
    *(_QWORD *)&this->fields.nowHp = *(_QWORD *)&saveData->fields.nowHp;
    if ( !buffData )
    {
      v7 = (BattleBuffData_o *)sub_1C372A4(BattleBuffData_TypeInfo);
      BattleBuffData___ctor(v7, 0);
      *p_buffData = v7;
      sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.buffData, (int32_t)v7, v8, v9);
      buffData = *p_buffData;
      if ( !*p_buffData )
        sub_1C372B4(0);
    }
