void __fastcall BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.baseAnimationName, (int64_t)v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.simpleAnim, (int64_t)Component_object, v4, v5, v6, v7, v8, v9);
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.anim, (int64_t)v10, v11, v12, v13, v14, v15, v16);
  *(_QWORD *)&this->fields.currentPhase = 1LL;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.commonEff, (int64_t)v17, v18, v19, v20, v21, v22, v23);
}
...
void __fastcall BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.simpleAnim, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.anim = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.anim, 0LL, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v31 = voiceId;
    v21 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v31, v17, v18, v19);
    v22 = System_String__Format_63129848((System_String_o *)StringLiteral_25543/*"{0}_{1}"*/, voiceDataStr, v21, 0LL);
    this->fields.voicePath = v22;
    p_voicePath = &this->fields.voicePath;
    sub_1C21DDC((PartyOrganizationUtility_o *)p_voicePath, (int64_t)v22, v24, v25, v26, v27, v28, v29);
    v30 = *p_voicePath;
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
    SoundManager__loadAudioAssetStorage(v30, callback, 1, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDECB5 & 1) == 0 )
  {
    sub_1C21E38(&BattleParamComponent__playingEffect_d__16_TypeInfo);
    byte_4BDECB5 = 1;
  }
  v9 = sub_1C22084(BattleParamComponent__playingEffect_d__16_TypeInfo);
  ...
  *(_QWORD *)(v9 + 48) = callback;
  sub_1C21DDC((PartyOrganizationUtility_o *)(v9 + 48), (int64_t)callback, v16, v17, v18, v19, v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDECB8 & 1) == 0 )
  {
    sub_1C21E38(&int_TypeInfo);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&StringLiteral_25557/*"{0}{1}_{2}"*/);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_1C21E38(&StringLiteral_25553/*"{0}{1}"*/);
    byte_4BDECB8 = 1;
  }
...
LABEL_41:
  ...
  for ( i = v5->fields.start; ; i = _4__this->fields.currentPhase + 1 )
  {
    ...
    if ( i == switchPhase->m_Items[switchIndex + 1] )
    {
      ...
      v37 = i;
      this = (BattleParamComponent__playingEffect_d__16_o *)j_il2cpp_value_box_0(int_TypeInfo, &v37, v2, v3, v4);
      animationIds = _4__this->fields.animationIds;
      if ( !animationIds )
        goto LABEL_41;
      v17 = _4__this->fields.switchIndex;
      if ( (unsigned int)v17 >= animationIds->max_length )
LABEL_42:
        sub_1C2209C(this, method);
      v18 = (Il2CppObject *)this;
      v36 = animationIds->m_Items[v17 + 1];
      v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36, v13, v14, v15);
      v20 = System_String__Format_63129916((System_String_o *)StringLiteral_25557/*"{0}{1}_{2}"*/, baseAnimationName, v18, v19, 0LL);
      ++_4__this->fields.switchIndex;
    }
    else
    {
LABEL_19:
      v21 = (Il2CppObject *)_4__this->fields.baseAnimationName;
      v35 = i;
      v22 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v35, v2, v3, v4);
      v20 = System_String__Format_63129848((System_String_o *)StringLiteral_25553/*"{0}{1}"*/, v21, v22, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(simpleAnim, 0LL, 0LL) )
    {
      ...
      if ( !this )
        goto LABEL_41;
      SimpleAnimation__Play_65253852((SimpleAnimation_o *)this, v20, 0LL);
LABEL_25:
      this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.simpleAnim;
      if ( !this )
        goto LABEL_41;
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        sub_1C21DDC(p__2__current, 0LL, v2, v3, v4, v24, v25, v26);
        result = 1;
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_70614020((UnityEngine_Animation_o *)this, v20, 0LL);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        {
          v5->fields.__2__current = 0LL;
          v34 = (PartyOrganizationUtility_o *)&v5->fields.__2__current;
          sub_1C21DDC(v34, 0LL, v2, v3, v4, v30, v31, v32);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
