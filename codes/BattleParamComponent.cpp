void __fastcall BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_B52920(&this->fields.baseAnimationName);
...
void __fastcall BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_B52920(&this->fields.simpleAnim);
  ...
  *(_QWORD *)&this->fields.currentPhase = 1LL;
  ...
  sub_B52920(&this->fields.commonEff);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_B52920(&this->fields.animationIds);
  if ( voiceId < 1 )
  {
    if ( !callback )
      sub_B52A5C(v9, v10);
  ...
  else
  {
    ...
    this->fields.voicePath = System_String__Format_44563852(
                               (System_String_o *)StringLiteral_23837/*"{0}_{1}"*/,
                               voiceDataStr,
                               v12,
                               0LL);
    sub_B52920(&this->fields.voicePath);
    voicePath = this->fields.voicePath;
    if ( (BYTE3(SoundManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !SoundManager_TypeInfo->_2.cctor_finished )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AC996 & 1) == 0 )
  {
    sub_B52984(&BattleParamComponent__playingEffect_d__17_TypeInfo);
    byte_42AC996 = 1;
  }
  v9 = (BattleParamComponent__playingEffect_d__17_o *)sub_B52A54(BattleParamComponent__playingEffect_d__17_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF527 & 1) == 0 )
  {
    sub_B52984(&int_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_23851/*"{0}{1}_{2}"*/);
    this = (BattleParamComponent__playingEffect_d__17_o *)sub_B52984(&StringLiteral_23845/*"{0}{1}"*/);
    byte_42AF527 = 1;
  }
...
LABEL_44:
  ...
  for ( i = v2->fields.start; ; i = _4__this->fields.currentPhase + 1 )
  {
    ...
    if ( i == switchPhase->m_Items[switchIndex + 1] )
    {
      ...
      v38 = i;
      this = (BattleParamComponent__playingEffect_d__17_o *)j_il2cpp_value_box_0(int_TypeInfo, &v38);
      animationIds = _4__this->fields.animationIds;
      if ( !animationIds )
        goto LABEL_44;
      v11 = _4__this->fields.switchIndex;
      if ( (unsigned int)v11 >= animationIds->max_length )
      {
LABEL_45:
        v34 = sub_B52A88(this);
        sub_B52A28(v34, 0LL);
      ...
      v37 = animationIds->m_Items[v11 + 1];
      v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v37);
      v14 = System_String__Format_44569380((System_String_o *)StringLiteral_23851/*"{0}{1}_{2}"*/, baseAnimationName, v12, v13, 0LL);
...
LABEL_19:
      ...
      v14 = System_String__Format_44563852((System_String_o *)StringLiteral_23845/*"{0}{1}"*/, v15, v16, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(simpleAnim, 0LL, 0LL) )
    {
      ...
      if ( !this )
        goto LABEL_44;
      SimpleAnimation__Play_16625408((SimpleAnimation_o *)this, v14, 0LL);
LABEL_26:
      this = (BattleParamComponent__playingEffect_d__17_o *)_4__this->fields.simpleAnim;
      if ( !this )
        goto LABEL_44;
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        sub_B52920(p__2__current, 0LL, v18, v19, v20, v21, v22, v23);
        LOBYTE(callback) = 1;
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_44;
        UnityEngine_Animation__Play_51067744((UnityEngine_Animation_o *)this, v14, 0LL);
LABEL_35:
        this = (BattleParamComponent__playingEffect_d__17_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_44;
        ...
        {
          v2->fields.__2__current = 0LL;
          v33 = (BattleServantConfConponent_o *)&v2->fields.__2__current;
          sub_B52920(v33, 0LL, v27, v28, v29, v30, v31, v32);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_BattleParamComponent__playingEffect_d__17_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
