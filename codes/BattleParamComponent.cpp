void __fastcall BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.baseAnimationName, v5, v2, v3);
...
void __fastcall BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A30574 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_CommonEffectComponent___, v3);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.simpleAnim, (int32_t)Component_object, v6, v7);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.anim, (int32_t)v8, v9, v10);
  *(_QWORD *)&this->fields.currentPhase = 1LL;
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.commonEff, (int32_t)v11, v12, v13);
}
...
void __fastcall BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.simpleAnim, 0, v2, v3);
  this->fields.anim = 0LL;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.anim, 0, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30575 & 1) == 0 )
  {
    sub_1B761C0(&int_TypeInfo, animationIds);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.animationIds, (int32_t)animationIds, v11, v12);
  if ( voiceId < 1 )
  {
    if ( !callback )
      sub_1B7641C(v13, v14);
  ...
  else
  {
    ...
    v20 = System_String__Format_61549432((System_String_o *)StringLiteral_25085/*"{0}_{1}"*/, voiceDataStr, v19, 0LL);
    this->fields.voicePath = v20;
    p_voicePath = &this->fields.voicePath;
    sub_1B76164((ServantStatusBattleListViewItem_o *)p_voicePath, (int32_t)v20, v22, v23);
    v24 = *p_voicePath;
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A30577 & 1) == 0 )
  {
    sub_1B761C0(&BattleParamComponent__playingEffect_d__16_TypeInfo, *(_QWORD *)&start);
    byte_4A30577 = 1;
  }
  v9 = sub_1B7640C(BattleParamComponent__playingEffect_d__16_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3057A & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_25097/*"{0}{1}_{2}"*/, v7);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_1B761C0(&StringLiteral_25093/*"{0}{1}"*/, v8);
    byte_4A3057A = 1;
  }
...
LABEL_42:
      ...
      v23 = System_String__Format_61549500((System_String_o *)StringLiteral_25097/*"{0}{1}_{2}"*/, baseAnimationName, v21, v22, 0LL);
...
LABEL_19:
      ...
      v23 = System_String__Format_61549432((System_String_o *)StringLiteral_25093/*"{0}{1}"*/, v24, v25, 0LL);
    }
...
LABEL_25:
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_69032500((UnityEngine_Animation_o *)this, v23, 0LL);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
