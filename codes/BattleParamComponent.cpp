void BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.baseAnimationName, v9, v2, v3, v4, v5, v6, v7);
...
void BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.anim, (int32_t)v10, v11, v12, v13, v14, v15, v16);
  *(_QWORD *)&this->fields.currentPhase = 1;
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.commonEff, (int32_t)v17, v18, v19, v20, v21, v22, v23);
}
...
void BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.simpleAnim, 0, v2, v3, v4, v5, v6, v7);
  this->fields.anim = 0;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.anim, 0, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v19 = System_String__Format_65604080((System_String_o *)StringLiteral_25720/*"{0}_{1}"*/, voiceDataStr, v18, 0);
    this->fields.voicePath = v19;
    p_voicePath = &this->fields.voicePath;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)p_voicePath, (int32_t)v19, v21, v22, v23, v24, v25, v26);
    v27 = *p_voicePath;
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A320 & 1) == 0 )
  {
    sub_1D0F0B4(&BattleParamComponent__playingEffect_d__16_TypeInfo);
    byte_4E7A320 = 1;
  }
  v9 = sub_1D0F300(BattleParamComponent__playingEffect_d__16_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7A323 & 1) == 0 )
  {
    sub_1D0F0B4(&int_TypeInfo);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&StringLiteral_25734/*"{0}{1}_{2}"*/);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_1D0F0B4(&StringLiteral_25732/*"{0}{1}"*/);
    byte_4E7A323 = 1;
  }
...
LABEL_42:
      ...
      v14 = System_String__Format_65604148((System_String_o *)StringLiteral_25734/*"{0}{1}_{2}"*/, baseAnimationName, v12, v13, 0);
...
LABEL_19:
      ...
      v14 = System_String__Format_65604080((System_String_o *)StringLiteral_25732/*"{0}{1}"*/, v15, v16, 0);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(simpleAnim, 0, 0) )
    {
      ...
      if ( !this )
        goto LABEL_41;
      SimpleAnimation__Play_68509268((SimpleAnimation_o *)this, v14, 0);
LABEL_25:
      this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.simpleAnim;
      if ( !this )
        goto LABEL_41;
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_73101556((UnityEngine_Animation_o *)this, v14, 0);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          ...
          sub_1D0F058(v34, 0, v27, v28, v29, v30, v31, v32);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1D0F0C8(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_1D0F1DC(v3, v4);
}
