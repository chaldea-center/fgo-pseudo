void __fastcall BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.baseAnimationName, (int64_t)v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB6E21 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_UnityEngine_Component_GetComponent_CommonEffectComponent___, v3);
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.anim, (int64_t)v12, v13, v14, v15, v16, v17, v18);
  *(_QWORD *)&this->fields.currentPhase = 1LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.commonEff, (int64_t)v19, v20, v21, v22, v23, v24, v25);
}
...
void __fastcall BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.simpleAnim, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.anim = 0LL;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.anim, 0LL, v10, v11, v12, v13, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6E22 & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, animationIds);
  ...
  else
  {
    ...
    v24 = System_String__Format_62982316((System_String_o *)StringLiteral_25499/*"{0}:{1}\n"*/, voiceDataStr, v23, 0LL);
    this->fields.voicePath = v24;
    p_voicePath = &this->fields.voicePath;
    sub_1C13CC8((PartyOrganizationUtility_o *)p_voicePath, (int64_t)v24, v26, v27, v28, v29, v30, v31);
    v32 = *p_voicePath;
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6E24 & 1) == 0 )
  {
    sub_1C13D24(&BattleParamComponent__playingEffect_d__16_TypeInfo, *(_QWORD *)&start);
    byte_4BB6E24 = 1;
  }
  v9 = sub_1C13F70(BattleParamComponent__playingEffect_d__16_TypeInfo);
  ...
  *(_QWORD *)(v9 + 48) = callback;
  sub_1C13CC8((PartyOrganizationUtility_o *)(v9 + 48), (int64_t)callback, v16, v17, v18, v19, v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB6E27 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_25513/*"{0}?{1}"*/, v7);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_1C13D24(&StringLiteral_25509/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/, v8);
    byte_4BB6E27 = 1;
  }
...
LABEL_42:
      ...
      v23 = System_String__Format_62982384((System_String_o *)StringLiteral_25513/*"{0}?{1}"*/, baseAnimationName, v21, v22, 0LL);
...
LABEL_19:
      ...
      v23 = System_String__Format_62982316((System_String_o *)StringLiteral_25509/*"{0}:{1}:{2}:{3}:{4}:{5}:{6}:{7}"*/, v24, v25, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(simpleAnim, 0LL, 0LL) )
    {
      ...
      if ( !this )
        goto LABEL_41;
      SimpleAnimation__Play_65106228((SimpleAnimation_o *)this, v23, 0LL);
LABEL_25:
      this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.simpleAnim;
      if ( !this )
        goto LABEL_41;
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        sub_1C13CC8(p__2__current, 0LL, v2, v3, v4, v27, v28, v29);
        result = 1;
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_70466396((UnityEngine_Animation_o *)this, v23, 0LL);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          ...
          sub_1C13CC8(v37, 0LL, v2, v3, v4, v33, v34, v35);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C13D38(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C13E4C(v3, v4);
}
