void __fastcall BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.baseAnimationName, (int64_t)v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCA203 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_UnityEngine_Component_GetComponent_CommonEffectComponent___, v3);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.anim, (int64_t)v12, v13, v14, v15, v16, v17, v18);
  *(_QWORD *)&this->fields.currentPhase = 1LL;
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.commonEff, (int64_t)v19, v20, v21, v22, v23, v24, v25);
}
...
void __fastcall BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.simpleAnim, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.anim = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.anim, 0LL, v10, v11, v12, v13, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA204 & 1) == 0 )
  {
    sub_1C1ABD4(&int_TypeInfo, animationIds);
  ...
  else
  {
    ...
    v24 = System_String__Format_63054740((System_String_o *)StringLiteral_25521/*"{0}_{1}"*/, voiceDataStr, v23, 0LL);
    this->fields.voicePath = v24;
    p_voicePath = &this->fields.voicePath;
    sub_1C1AB78((PartyOrganizationUtility_o *)p_voicePath, (int64_t)v24, v26, v27, v28, v29, v30, v31);
    v32 = *p_voicePath;
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA206 & 1) == 0 )
  {
    sub_1C1ABD4(&BattleParamComponent__playingEffect_d__16_TypeInfo, *(_QWORD *)&start);
    byte_4BCA206 = 1;
  }
  v9 = sub_1C1AE20(BattleParamComponent__playingEffect_d__16_TypeInfo);
  ...
  *(_QWORD *)(v9 + 48) = callback;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v9 + 48), (int64_t)callback, v16, v17, v18, v19, v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA209 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_25535/*"{0}{1}_{2}"*/, v7);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_1C1ABD4(&StringLiteral_25531/*"{0}{1}"*/, v8);
    byte_4BCA209 = 1;
  }
...
LABEL_42:
      ...
      v23 = System_String__Format_63054808((System_String_o *)StringLiteral_25535/*"{0}{1}_{2}"*/, baseAnimationName, v21, v22, 0LL);
...
LABEL_19:
      ...
      v23 = System_String__Format_63054740((System_String_o *)StringLiteral_25531/*"{0}{1}"*/, v24, v25, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(simpleAnim, 0LL, 0LL) )
    {
      ...
      if ( !this )
        goto LABEL_41;
      SimpleAnimation__Play_65178652((SimpleAnimation_o *)this, v23, 0LL);
LABEL_25:
      this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.simpleAnim;
      if ( !this )
        goto LABEL_41;
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        sub_1C1AB78(p__2__current, 0LL, v2, v3, v4, v27, v28, v29);
        result = 1;
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_70538820((UnityEngine_Animation_o *)this, v23, 0LL);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          ...
          sub_1C1AB78(v37, 0LL, v2, v3, v4, v33, v34, v35);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
