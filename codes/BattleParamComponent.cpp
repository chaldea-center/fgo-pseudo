void BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.baseAnimationName, (int32_t)v9, v2, v3, v4, v5, v6, v7);
...
void BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  bool v15; // w6
  bool v16; // w7
  const MethodInfo_3820CA8 *v17; // x1
  Il2CppObject *v18; // x0
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.anim, (int32_t)v10, v11, v12, v13, v14, v15, v16);
  v17 = (const MethodInfo_3820CA8 *)Method_UnityEngine_Component_GetComponent_CommonEffectComponent___;
  *(_QWORD *)&this->fields.currentPhase = 1;
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.commonEff, (int32_t)v18, v19, v20, v21, v22, v23, v24);
}
...
void BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.simpleAnim, 0, v2, v3, v4, v5, v6, v7);
  this->fields.anim = 0;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.anim, 0, v9, v10, v11, v12, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v29 = voiceId;
    v18 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v29);
    v19 = System_String__Format_75697880((System_String_o *)StringLiteral_26596/*"{0}_{1}"*/, voiceDataStr, v18, 0);
    this->fields.voicePath = v19;
    p_voicePath = &this->fields.voicePath;
    sub_2213A04((MissionNaviTransitionBoardItem_o *)p_voicePath, (int32_t)v19, v21, v22, v23, v24, v25, v26);
    v28 = *p_voicePath;
    if ( !*(&SoundManager_TypeInfo->_2.cctor_finished + 1) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5973574 & 1) == 0 )
  {
    sub_2213A60(&BattleParamComponent__playingEffect_d__16_TypeInfo);
    byte_5973574 = 1;
  }
  v9 = sub_2213CCC(BattleParamComponent__playingEffect_d__16_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&UnityEngine_Object_TypeInfo);
    sub_2213A60(&StringLiteral_26611/*"{0}{1}_{2}"*/);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_2213A60(&StringLiteral_26608/*"{0}{1}"*/);
    byte_5973577 = 1;
  }
...
LABEL_41:
  ...
  for ( i = v2->fields.start; ; i = _4__this->fields.currentPhase + 1 )
  {
    ...
    if ( i == switchPhase->m_Items[switchIndex] )
    {
      ...
      v39 = i;
      this = (BattleParamComponent__playingEffect_d__16_o *)j_il2cpp_value_box_0(qword_5984348, &v39);
...
LABEL_42:
      ...
      v15 = System_String__Format_75697948((System_String_o *)StringLiteral_26611/*"{0}{1}_{2}"*/, baseAnimationName, v12, v13, 0);
...
LABEL_19:
      ...
      v37 = i;
      v17 = (Il2CppObject *)j_il2cpp_value_box_0(qword_5984348, &v37);
      v15 = System_String__Format_75697880((System_String_o *)StringLiteral_26608/*"{0}{1}"*/, v16, v17, 0);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(simpleAnim, 0, 0) )
    {
      ...
      if ( !this )
        goto LABEL_41;
      SimpleAnimation__Play_78552168((SimpleAnimation_o *)this, v15, 0);
LABEL_25:
      this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.simpleAnim;
      if ( !this )
        goto LABEL_41;
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_83078544((UnityEngine_Animation_o *)this, v15, 0);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_2213A74(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_2213BA0(v3, v4);
}
