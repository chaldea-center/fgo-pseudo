void __fastcall BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.baseAnimationName, v5, v2, v3);
...
void __fastcall BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.simpleAnim, (int32_t)Component_object, v4, v5);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.anim, (int32_t)v6, v7, v8);
  *(_QWORD *)&this->fields.currentPhase = 1LL;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.commonEff, (int32_t)v9, v10, v11);
}
...
void __fastcall BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.simpleAnim, 0, v2, v3);
  this->fields.anim = 0LL;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.anim, 0, v5, v6);
  ...
  if ( voicePath && System_String__op_Inequality(voicePath, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
  {
    ...
    SoundManager__releaseAudioAssetStorage(v8, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.animationIds, (int32_t)animationIds, v9, v10);
  if ( voiceId < 1 )
  {
    if ( !callback )
      sub_1B8880C(v11, v12);
  ...
  else
  {
    ...
    v18 = System_String__Format_61721404((System_String_o *)StringLiteral_25098/*"{0}_{1}"*/, voiceDataStr, v17, 0LL);
    this->fields.voicePath = v18;
    p_voicePath = &this->fields.voicePath;
    sub_1B88554((ServantStatusBattleListViewItem_o *)p_voicePath, (int32_t)v18, v20, v21);
    v22 = *p_voicePath;
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
    SoundManager__loadAudioAssetStorage(v22, callback, 1, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D7B3 & 1) == 0 )
  {
    sub_1B885B0(&BattleParamComponent__playingEffect_d__16_TypeInfo);
    byte_4A5D7B3 = 1;
  }
  v9 = sub_1B887FC(BattleParamComponent__playingEffect_d__16_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D7B6 & 1) == 0 )
  {
    sub_1B885B0(&int_TypeInfo);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_25110/*"{0}{1}_{2}"*/);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_1B885B0(&StringLiteral_25106/*"{0}{1}"*/);
    byte_4A5D7B6 = 1;
  }
...
LABEL_41:
  ...
  for ( i = v5->fields.start; ; i = _4__this->fields.currentPhase + 1 )
  {
    ...
    if ( i == switchPhase->m_Items[switchIndex + 1] )
    {
      ...
      v31 = i;
      this = (BattleParamComponent__playingEffect_d__16_o *)j_il2cpp_value_box_0(int_TypeInfo, &v31, v2, v3, v4);
...
LABEL_42:
      ...
      v30 = animationIds->m_Items[v17 + 1];
      v19 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v30, v13, v14, v15);
      v20 = System_String__Format_61721472((System_String_o *)StringLiteral_25110/*"{0}{1}_{2}"*/, baseAnimationName, v18, v19, 0LL);
...
LABEL_19:
      ...
      v29 = i;
      v22 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v29, v2, v3, v4);
      v20 = System_String__Format_61721404((System_String_o *)StringLiteral_25106/*"{0}{1}"*/, v21, v22, 0LL);
    }
...
LABEL_25:
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_69204472((UnityEngine_Animation_o *)this, v20, 0LL);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        {
          v5->fields.__2__current = 0LL;
          v28 = (ServantStatusBattleListViewItem_o *)&v5->fields.__2__current;
          sub_1B88554(v28, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B885C4(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_1B886D8(v3, v4);
}
