void __fastcall BattleParamComponent___ctor(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.baseAnimationName, (int64_t)v9, v2, v3, v4, v5, v6, v7);
...
void __fastcall BattleParamComponent__Init(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFFF29 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponent_CommonEffectComponent___, v3);
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.anim, (int64_t)v12, v13, v14, v15, v16, v17, v18);
  *(_QWORD *)&this->fields.currentPhase = 1LL;
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.commonEff, (int64_t)v19, v20, v21, v22, v23, v24, v25);
}
...
void __fastcall BattleParamComponent__Release(BattleParamComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.simpleAnim, 0LL, v2, v3, v4, v5, v6, v7);
  this->fields.anim = 0LL;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.anim, 0LL, v10, v11, v12, v13, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFF2A & 1) == 0 )
  {
    sub_1C2E12C(&int_TypeInfo, animationIds);
  ...
  else
  {
    ...
    v24 = System_String__Format_63249956((System_String_o *)StringLiteral_25569/*"{0}_{1}"*/, voiceDataStr, v23, 0LL);
    this->fields.voicePath = v24;
    p_voicePath = &this->fields.voicePath;
    sub_1C2E0D0((PartyOrganizationUtility_o *)p_voicePath, (int64_t)v24, v26, v27, v28, v29, v30, v31);
    v32 = *p_voicePath;
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFF2C & 1) == 0 )
  {
    sub_1C2E12C(&BattleParamComponent__playingEffect_d__16_TypeInfo, *(_QWORD *)&start);
    byte_4BFFF2C = 1;
  }
  v9 = sub_1C2E378(BattleParamComponent__playingEffect_d__16_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFFF2F & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_25583/*"{0}{1}_{2}"*/, v7);
    this = (BattleParamComponent__playingEffect_d__16_o *)sub_1C2E12C(&StringLiteral_25579/*"{0}{1}"*/, v8);
    byte_4BFFF2F = 1;
  }
...
LABEL_42:
      ...
      v23 = System_String__Format_63250024((System_String_o *)StringLiteral_25583/*"{0}{1}_{2}"*/, baseAnimationName, v21, v22, 0LL);
...
LABEL_19:
      ...
      v23 = System_String__Format_63249956((System_String_o *)StringLiteral_25579/*"{0}{1}"*/, v24, v25, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(simpleAnim, 0LL, 0LL) )
    {
      ...
      if ( !this )
        goto LABEL_41;
      SimpleAnimation__Play_65373960((SimpleAnimation_o *)this, v23, 0LL);
LABEL_25:
      this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.simpleAnim;
      if ( !this )
        goto LABEL_41;
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        sub_1C2E0D0(p__2__current, 0LL, v2, v3, v4, v27, v28, v29);
        result = 1;
    ...
    else
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( !this )
          goto LABEL_41;
        UnityEngine_Animation__Play_70734128((UnityEngine_Animation_o *)this, v23, 0LL);
LABEL_33:
        this = (BattleParamComponent__playingEffect_d__16_o *)_4__this->fields.anim;
        if ( !this )
          goto LABEL_41;
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          ...
          sub_1C2E0D0(v37, 0LL, v2, v3, v4, v33, v34, v35);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2E140(&Method_BattleParamComponent__playingEffect_d__16_System_Collections_IEnumerator_Reset__);
  sub_1C2E254(v3, v4);
}
