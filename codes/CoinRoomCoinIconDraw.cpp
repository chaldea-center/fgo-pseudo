        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C256D4 & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, iconItem);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C256D5 & 1) == 0 )
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, enabled);
    sub_1C3B764(&StringLiteral_3661/*"COMMON_CONSUME_INFO_IF_ENOUGH"*/, v7);
    sub_1C3B764(&StringLiteral_3664/*"COMMON_COUNT_OPERATOR_CROSS"*/, v8);
    byte_4C256D5 = 1;
  }
  ...
  if ( enabled )
  {
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_14:
        v11 = &StringLiteral_3661/*"COMMON_CONSUME_INFO_IF_ENOUGH"*/;
        goto LABEL_18;
      }
    }
    else
    ...
    v11 = &StringLiteral_3664/*"COMMON_COUNT_OPERATOR_CROSS"*/;
LABEL_18:
...
LABEL_20:
    sub_1C3B9C0(maskSprite, enabled);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C256D2 & 1) == 0 )
  {
    sub_1C3B764(&int_TypeInfo, iconItem);
    sub_1C3B764(&LocalizationManager_TypeInfo, v9);
    sub_1C3B764(&StringLiteral_25446, v10);
    sub_1C3B764(&StringLiteral_3661/*"COMMON_CONSUME_INFO_IF_ENOUGH"*/, v11);
  ...
  if ( iconItem && mode )
  {
    ...
    if ( itemIcon )
    {
      ...
      if ( itemIcon )
      {
        ...
        itemIcon = (ItemIconComponent_o *)System_String__Format((System_String_o *)StringLiteral_25446, v18, 0LL);
        if ( possessionNum )
        {
...
LABEL_27:
                  ...
                  if ( itemIcon )
                  {
                    ...
                    itemIcon = (ItemIconComponent_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_3661/*"COMMON_CONSUME_INFO_IF_ENOUGH"*/,
                                                        0LL);
                    if ( infoLabel )
                    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C256D3 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_3663/*"COMMON_CONSUME_INFO_SEPARATOR"*/, v11);
    byte_4C256D3 = 1;
  }
  baseButton = (UnityEngine_Object_o *)this->fields.baseButton;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( iconItem->fields._selectedNum_k__BackingField >= 1 )
  {
    ...
    if ( infoObject )
    {
      ...
      if ( infoObject )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        infoObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3663/*"COMMON_CONSUME_INFO_SEPARATOR"*/, 0LL);
