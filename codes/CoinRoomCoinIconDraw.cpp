        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C11A & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, iconItem);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C11B & 1) == 0 )
  {
    sub_1B686D4(&LocalizationManager_TypeInfo, enabled);
    sub_1B686D4(&StringLiteral_3595/*"COIN_ROOM_CAN_NOT_SELECTED"*/, v7);
    sub_1B686D4(&StringLiteral_3598/*"COIN_ROOM_COIN_ICON_NOT_SELECT"*/, v8);
    byte_4A0C11B = 1;
  }
  ...
  if ( enabled )
  {
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_14:
        v11 = &StringLiteral_3595/*"COIN_ROOM_CAN_NOT_SELECTED"*/;
        goto LABEL_18;
      }
    }
    else
    ...
    v11 = &StringLiteral_3598/*"COIN_ROOM_COIN_ICON_NOT_SELECT"*/;
LABEL_18:
...
LABEL_20:
    sub_1B68930(maskSprite, enabled);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C118 & 1) == 0 )
  {
    sub_1B686D4(&int_TypeInfo, iconItem);
    sub_1B686D4(&LocalizationManager_TypeInfo, v9);
    sub_1B686D4(&StringLiteral_24850/*"{0:#,0}"*/, v10);
    sub_1B686D4(&StringLiteral_3595/*"COIN_ROOM_CAN_NOT_SELECTED"*/, v11);
  ...
  if ( iconItem && mode )
  {
    ...
    if ( itemIcon )
    {
      ...
      if ( itemIcon )
      {
        ...
        itemIcon = (ItemIconComponent_o *)System_String__Format((System_String_o *)StringLiteral_24850/*"{0:#,0}"*/, v18, 0LL);
        if ( possessionNum )
        {
...
LABEL_27:
                  ...
                  if ( itemIcon )
                  {
                    ...
                    itemIcon = (ItemIconComponent_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_3595/*"COIN_ROOM_CAN_NOT_SELECTED"*/,
                                                        0LL);
                    if ( infoLabel )
                    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C119 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_3597/*"COIN_ROOM_COIN_ICON_CONFIRM_NUM"*/, v11);
    byte_4A0C119 = 1;
  }
  baseButton = (UnityEngine_Object_o *)this->fields.baseButton;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( iconItem->fields._selectedNum_k__BackingField >= 1 )
  {
    ...
    if ( infoObject )
    {
      ...
      if ( infoObject )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        infoObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3597/*"COIN_ROOM_COIN_ICON_CONFIRM_NUM"*/, 0LL);
