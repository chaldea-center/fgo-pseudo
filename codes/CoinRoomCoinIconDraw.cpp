        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC09 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_3673/*"COIN_ROOM_CAN_NOT_SELECTED"*/);
    sub_1C21E38(&StringLiteral_3676/*"COIN_ROOM_COIN_ICON_NOT_SELECT"*/);
    byte_4BDFC09 = 1;
  }
  ...
  if ( enabled )
  {
    ...
    if ( LocalizationManager_TypeInfo->_2.cctor_finished )
    {
      ...
      {
LABEL_14:
        v9 = &StringLiteral_3673/*"COIN_ROOM_CAN_NOT_SELECTED"*/;
        goto LABEL_18;
      }
    }
    else
    ...
    v9 = &StringLiteral_3676/*"COIN_ROOM_COIN_ICON_NOT_SELECT"*/;
LABEL_18:
    maskSprite = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)*v9, 0LL);
    if ( infoLabel )
    {
...
LABEL_20:
    sub_1C22094(maskSprite, enabled);
  }
}
  ...
  if ( iconItem && mode )
  {
    ...
    if ( itemIcon )
    {
      ...
      if ( itemIcon )
      {
        ...
        v14 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &num_k__BackingField, v11, v12, v13);
        itemIcon = (ItemIconComponent_o *)System_String__Format((System_String_o *)StringLiteral_25376/*"{0:#,0}"*/, v14, 0LL);
        if ( possessionNum )
        {
...
LABEL_27:
                  ...
                  if ( itemIcon )
                  {
                    ...
                    itemIcon = (ItemIconComponent_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_3673/*"COIN_ROOM_CAN_NOT_SELECTED"*/,
                                                        0LL);
                    if ( infoLabel )
                    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDFC07 & 1) == 0 )
  {
    ...
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&StringLiteral_1/*""*/);
    sub_1C21E38(&StringLiteral_3675/*"COIN_ROOM_COIN_ICON_CONFIRM_NUM"*/);
    byte_4BDFC07 = 1;
  }
  baseButton = (UnityEngine_Object_o *)this->fields.baseButton;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( iconItem->fields._selectedNum_k__BackingField >= 1 )
  {
    ...
    if ( infoObject )
    {
      ...
      if ( infoObject )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        infoObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3675/*"COIN_ROOM_COIN_ICON_CONFIRM_NUM"*/, 0LL);
        if ( this->fields.selectedNumLabel )
        {
          ...
          if ( infoObject )
          {
            ...
            v16 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &selectedNum_k__BackingField, v13, v14, v15);
            infoObject = (UnityEngine_GameObject_o *)System_String__Format(v11, v16, 0LL);
            if ( selectedNumLabel )
            {
