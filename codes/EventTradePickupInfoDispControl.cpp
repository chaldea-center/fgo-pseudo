        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CE6A & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DataManager_GetMaster_CommonReleaseMaster___, v8);
    sub_1C3B764(&Method_DataManager_GetMaster_EventTradeGoodsMaster___, v9);
    sub_1C3B764(&Method_DataManager_GetMaster_GiftMaster___, v10);
    sub_1C3B764(&DataManager_TypeInfo, v11);
    sub_1C3B764(&Method_DataMasterBase_EventTradeGoodsMaster__EventTradeGoodsEntity__int__TryGetEntity__, v12);
    sub_1C3B764(&Method_System_Collections_Generic_List_EventTradePickupEntity__get_Count__, v13);
    sub_1C3B764(&Method_System_Collections_Generic_List_EventTradePickupEntity__get_Item__, v14);
    sub_1C3B764(&StringLiteral_20804/*"listframes3"*/, v15);
    sub_1C3B764(&StringLiteral_20805/*"listframes3_bg"*/, v16);
    sub_1C3B764(&StringLiteral_20566/*"iu-Cans-CA"*/, v17);
    sub_1C3B764(&StringLiteral_20803/*"listframes2_bg"*/, v18);
    sub_1C3B764(&StringLiteral_20565/*"iu"*/, v19);
    byte_4C1CE6A = 1;
  }
  entity = 0LL;
  if ( isToday )
    v20 = (System_String_o **)&StringLiteral_20804/*"listframes3"*/;
  else
    v20 = (System_String_o **)&StringLiteral_20805/*"listframes3_bg"*/;
  v21 = *v20;
  bg = this->fields.bg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_39282628(eventId, bg, v21, 0LL);
  ...
  v24 = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_GiftMaster___);
  Item = (CommonReleaseMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
  if ( !pickupEntityList )
    goto LABEL_49;
  if ( pickupEntityList->fields._size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      Item = (CommonReleaseMaster_o *)System_Collections_Generic_List_object___get_Item(
                                        ...
                                        (int)v28 - 4,
                                        (const MethodInfo_368B99C *)Method_System_Collections_Generic_List_EventTradePickupEntity__get_Item__);
...
LABEL_45:
    ...
    else
    {
      ...
      {
        v32 = (System_String_o *)StringLiteral_20566/*"iu-Cans-CA"*/;
LABEL_32:
...
LABEL_50:
          sub_1C3B9C8(Item, v26);
        v35 = (UISprite_o *)*((_QWORD *)&goodsIcon->obj.klass + v28);
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        Item = (CommonReleaseMaster_o *)AtlasManager__SetEventUI_39282628(eventId, v35, v32, 0LL);
        arrowIcon = this->fields.arrowIcon;
        if ( !arrowIcon )
          goto LABEL_49;
        if ( v29 >= arrowIcon->max_length )
          goto LABEL_50;
        Item = (CommonReleaseMaster_o *)AtlasManager__SetEventUI_39282628(
                                          eventId,
                                          *((UISprite_o **)&arrowIcon->obj.klass + v28),
                                          (System_String_o *)StringLiteral_20565/*"iu"*/,
                                          0LL);
    ...
    Item = (CommonReleaseMaster_o *)System_String__Concat_63368612((System_String_o *)StringLiteral_20803/*"listframes2_bg"*/, v33, 0LL);
