        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A006E3 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_DataManager_GetMaster_EventTradeGoodsMaster___, v9);
    sub_1B640C8(&Method_DataManager_GetMaster_GiftMaster___, v10);
    sub_1B640C8(&DataManager_TypeInfo, v11);
    sub_1B640C8(&Method_DataMasterBase_EventTradeGoodsMaster__EventTradeGoodsEntity__int__TryGetEntity__, v12);
    sub_1B640C8(&Method_System_Collections_Generic_List_EventTradePickupEntity__get_Count__, v13);
    sub_1B640C8(&Method_System_Collections_Generic_List_EventTradePickupEntity__get_Item__, v14);
    sub_1B640C8(&StringLiteral_20313/*"img_popularitem_today"*/, v15);
    sub_1B640C8(&StringLiteral_20314/*"img_popularitem_tommorow"*/, v16);
    sub_1B640C8(&StringLiteral_20086/*"icon_popularitem_unknown"*/, v17);
    sub_1B640C8(&StringLiteral_20312/*"img_popularitem_"*/, v18);
    sub_1B640C8(&StringLiteral_20085/*"icon_popularitem_reward_arrow"*/, v19);
    byte_4A006E3 = 1;
  }
  entity = 0LL;
  if ( isToday )
    v20 = (System_String_o **)&StringLiteral_20313/*"img_popularitem_today"*/;
  else
    v20 = (System_String_o **)&StringLiteral_20314/*"img_popularitem_tommorow"*/;
  v21 = *v20;
  bg = this->fields.bg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_37544692(eventId, bg, v21, 0LL);
  ...
  v24 = DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_GiftMaster___);
  Item = (CommonReleaseMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
  if ( !pickupEntityList )
    goto LABEL_49;
  if ( pickupEntityList->fields._size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      Item = (CommonReleaseMaster_o *)System_Collections_Generic_List_object___get_Item(
                                        ...
                                        (int)v27 - 4,
                                        (const MethodInfo_34AD404 *)Method_System_Collections_Generic_List_EventTradePickupEntity__get_Item__);
...
LABEL_45:
    ...
    if ( !entity || !v26 )
      goto LABEL_49;
    Item = (CommonReleaseMaster_o *)CommonReleaseMaster__IsOpen(v26, HIDWORD(entity[4].klass), 0LL, 0, 0LL);
    if ( ((unsigned __int8)Item & 1) != 0 )
    {
      if ( !entity )
        goto LABEL_49;
    ...
    else
    {
      ...
      {
        v32 = (System_String_o *)StringLiteral_20086/*"icon_popularitem_unknown"*/;
LABEL_32:
        goodsIcon = this->fields.goodsIcon;
        if ( !goodsIcon )
          goto LABEL_49;
        if ( v28 >= goodsIcon->max_length )
LABEL_50:
          sub_1B6432C(Item, v29);
        v35 = (UISprite_o *)*((_QWORD *)&goodsIcon->obj.klass + v27);
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        Item = (CommonReleaseMaster_o *)AtlasManager__SetEventUI_37544692(eventId, v35, v32, 0LL);
        arrowIcon = this->fields.arrowIcon;
        if ( !arrowIcon )
          goto LABEL_49;
        if ( v28 >= arrowIcon->max_length )
          goto LABEL_50;
        Item = (CommonReleaseMaster_o *)AtlasManager__SetEventUI_37544692(
                                          eventId,
                                          *((UISprite_o **)&arrowIcon->obj.klass + v27),
                                          (System_String_o *)StringLiteral_20085/*"icon_popularitem_reward_arrow"*/,
                                          0LL);
        rewardIcon = this->fields.rewardIcon;
        if ( !rewardIcon )
          goto LABEL_49;
        if ( v28 >= rewardIcon->max_length )
          goto LABEL_50;
        Item = (CommonReleaseMaster_o *)*((_QWORD *)&rewardIcon->obj.klass + v27);
        if ( !Item )
          goto LABEL_49;
        ...
        if ( !dispGameObjects )
          goto LABEL_49;
        if ( v28 >= dispGameObjects->max_length )
          goto LABEL_50;
        Item = (CommonReleaseMaster_o *)*((_QWORD *)&dispGameObjects->obj.klass + v27);
        if ( !Item )
          goto LABEL_49;
    ...
    Item = (CommonReleaseMaster_o *)System_String__Concat_61375396((System_String_o *)StringLiteral_20312/*"img_popularitem_"*/, v33, 0LL);
