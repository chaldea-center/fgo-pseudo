        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21C99 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Collections_Generic_List_EventTradePickupEntity__get_Item__);
    sub_1C2D490(&StringLiteral_20479/*"img_popularitem_today"*/);
    sub_1C2D490(&StringLiteral_20480/*"img_popularitem_tommorow"*/);
    sub_1C2D490(&StringLiteral_20202/*"icon_popularitem_unknown"*/);
    sub_1C2D490(&StringLiteral_20478/*"img_popularitem_"*/);
    sub_1C2D490(&StringLiteral_20201/*"icon_popularitem_reward_arrow"*/);
    byte_4C21C99 = 1;
  }
  entity = 0;
  if ( isToday )
    v8 = (System_String_o **)&StringLiteral_20479/*"img_popularitem_today"*/;
  else
    v8 = (System_String_o **)&StringLiteral_20480/*"img_popularitem_tommorow"*/;
  v9 = *v8;
  bg = this->fields.bg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_40385372(eventId, bg, v9, 0);
  ...
  v12 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_GiftMaster___);
  Item = (CommonReleaseMaster_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_CommonReleaseMaster___);
  if ( !pickupEntityList )
    goto LABEL_49;
  if ( pickupEntityList->fields._size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      Item = (CommonReleaseMaster_o *)System_Collections_Generic_List_object___get_Item(
                                        ...
                                        (int)v16 - 4,
                                        (const MethodInfo_37898B4 *)Method_System_Collections_Generic_List_EventTradePickupEntity__get_Item__);
...
LABEL_45:
      if ( v17 <= 1 )
      {
        v28 = v16 - 3;
        ++v16;
        if ( v28 < pickupEntityList->fields._size )
          continue;
      }
      goto LABEL_47;
    }
    ...
    if ( Item )
    {
      if ( !LODWORD(Item->fields._MasterName_k__BackingField) )
        goto LABEL_50;
      v19 = *(_QWORD *)&Item->fields.revision;
      if ( !v19 )
        goto LABEL_49;
      v20 = *(_DWORD *)(v19 + 24);
    }
    ...
    else
    {
      ...
      {
        v21 = (System_String_o *)StringLiteral_20202/*"icon_popularitem_unknown"*/;
LABEL_32:
...
LABEL_50:
          sub_1C2D6F4(Item, v14, v18);
        v24 = (UISprite_o *)*((_QWORD *)&goodsIcon->obj.klass + v16);
        if ( !AtlasManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        Item = (CommonReleaseMaster_o *)AtlasManager__SetEventUI_40385372(eventId, v24, v21, 0);
        arrowIcon = this->fields.arrowIcon;
        if ( !arrowIcon )
          goto LABEL_49;
        if ( v17 >= LODWORD(arrowIcon->max_length) )
          goto LABEL_50;
        Item = (CommonReleaseMaster_o *)AtlasManager__SetEventUI_40385372(
                                          eventId,
                                          *((UISprite_o **)&arrowIcon->obj.klass + v16),
                                          (System_String_o *)StringLiteral_20201/*"icon_popularitem_reward_arrow"*/,
                                          0);
        ...
        if ( !Item )
          goto LABEL_49;
        ItemIconComponent__SetItem((ItemIconComponent_o *)Item, v20, -1, 1, 0);
        dispGameObjects = this->fields.dispGameObjects;
        if ( !dispGameObjects )
          goto LABEL_49;
    ...
    v22 = System_Int32__ToString((int)entity + 40, 0);
    Item = (CommonReleaseMaster_o *)System_String__Concat_63457864((System_String_o *)StringLiteral_20478/*"img_popularitem_"*/, v22, 0);
    v21 = (System_String_o *)Item;
    goto LABEL_32;
  }
LABEL_47:
