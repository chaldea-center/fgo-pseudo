        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE92DB & 1) == 0 )
  {
    sub_1C7BAE8(&CharaGraphListViewPatternGrandSameServant_TypeInfo);
    byte_4CE92DB = 1;
  }
  grandSvtData = this->fields.grandSvtData;
  v8 = sub_1C7BD34(CharaGraphListViewPatternGrandSameServant_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE92D9 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_ChangeGrandSameServantListMenu_ExitMenu__);
    ...
    sub_1C7BAE8(&Method_ChangeGrandSameServantListMenu___c__DisplayClass8_0__ExitMenu_b__0__);
    sub_1C7BAE8(&ChangeGrandSameServantListMenu___c__DisplayClass8_0_TypeInfo);
    byte_4CE92D9 = 1;
  }
  v5 = sub_1C7BD34(ChangeGrandSameServantListMenu___c__DisplayClass8_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = result;
  if ( !result )
  {
    ...
    if ( (*((_BYTE *)Method_ChangeGrandSameServantListMenu_ExitMenu__ + 83) & 2) != 0 )
      v21 = (_QWORD *)sub_1C7BB00(Method_ChangeGrandSameServantListMenu_ExitMenu__);
...
LABEL_19:
  ...
  if ( (*((_BYTE *)Method_ChangeGrandSameServantListMenu_ExitMenu__ + 83) & 2) != 0 )
    v15 = (_QWORD *)sub_1C7BB00(Method_ChangeGrandSameServantListMenu_ExitMenu__);
  ...
  *(_OWORD *)&v29.fields.fakeValue = v19;
  ...
  v28 = v29;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49453300(&v28, 0) == this->fields.selectedUserServantId )
  {
        ...
        const MethodInfo *method)
{
  if ( (byte_4CE92D7 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_3326/*"CHANGE_GRAND_SAME_SERVANT_SELECT_EXPLANATION_STATUS"*/);
    byte_4CE92D7 = 1;
  }
  return (System_String_o *)StringLiteral_3326/*"CHANGE_GRAND_SAME_SERVANT_SELECT_EXPLANATION_STATUS"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE92D8 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_ChangeGrandSameServantListMenu_ExitMenu__);
    sub_1C7BAE8(&CharaGraphSortOwnerGrandSameServant_TypeInfo);
    byte_4CE92D8 = 1;
  }
  ...
  if ( !titleInfo )
    goto LABEL_8;
  TitleInfoControl__setTitleInfo(titleInfo, 0, 1, 0, 74, 1, 0);
  titleInfo = this->fields.titleInfo;
  if ( !titleInfo )
    goto LABEL_8;
  TitleInfoControl__setBackBtnSprite_40473788(titleInfo, 1, 0, 0, 0);
  v19 = (CharaGraphSortOwnerGrandSameServant_o *)sub_1C7BD34(CharaGraphSortOwnerGrandSameServant_TypeInfo);
  ...
  v27 = (CharaGraphListMenuBase_CallbackFunc_o *)sub_1C7BD34(CharaGraphListMenuBase_CallbackFunc_TypeInfo);
