        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B5AB & 1) == 0 )
  {
    sub_1C93AD4(&CharaGraphListViewPatternGrandSameServant_TypeInfo);
    byte_4D2B5AB = 1;
  }
  grandSvtData = this->fields.grandSvtData;
  v8 = sub_1C93D20(CharaGraphListViewPatternGrandSameServant_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B5A9 & 1) == 0 )
  {
    sub_1C93AD4(&Method_ChangeGrandSameServantListMenu_ExitMenu__);
    ...
    sub_1C93AD4(&Method_ChangeGrandSameServantListMenu___c__DisplayClass8_0__ExitMenu_b__0__);
    sub_1C93AD4(&ChangeGrandSameServantListMenu___c__DisplayClass8_0_TypeInfo);
    byte_4D2B5A9 = 1;
  }
  v5 = sub_1C93D20(ChangeGrandSameServantListMenu___c__DisplayClass8_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 24) = result;
  if ( !result )
  {
    ...
    if ( (*((_BYTE *)Method_ChangeGrandSameServantListMenu_ExitMenu__ + 83) & 2) != 0 )
      v21 = (_QWORD *)sub_1C93AEC(Method_ChangeGrandSameServantListMenu_ExitMenu__);
...
LABEL_19:
  ...
  if ( (*((_BYTE *)Method_ChangeGrandSameServantListMenu_ExitMenu__ + 83) & 2) != 0 )
    v15 = (_QWORD *)sub_1C93AEC(Method_ChangeGrandSameServantListMenu_ExitMenu__);
  ...
  *(_OWORD *)&v29.fields.fakeValue = v19;
  ...
  v28 = v29;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49657552(&v28, 0) == this->fields.selectedUserServantId )
  {
        ...
        const MethodInfo *method)
{
  if ( (byte_4D2B5A7 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_3342/*"CHANGE_GRAND_SAME_SERVANT_SELECT_EXPLANATION_STATUS"*/);
    byte_4D2B5A7 = 1;
  }
  return (System_String_o *)StringLiteral_3342/*"CHANGE_GRAND_SAME_SERVANT_SELECT_EXPLANATION_STATUS"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B5A8 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ChangeGrandSameServantListMenu_ExitMenu__);
    sub_1C93AD4(&CharaGraphSortOwnerGrandSameServant_TypeInfo);
    byte_4D2B5A8 = 1;
  }
  ...
  v19 = (CharaGraphSortOwnerGrandSameServant_o *)sub_1C93D20(CharaGraphSortOwnerGrandSameServant_TypeInfo);
  ...
  v27 = (CharaGraphListMenuBase_CallbackFunc_o *)sub_1C93D20(CharaGraphListMenuBase_CallbackFunc_TypeInfo);
