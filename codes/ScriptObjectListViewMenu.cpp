...
void ScriptObjectListViewMenu__Close(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( scriptAsset )
  {
    ...
    AssetManager__releaseAsset_41676764(scriptAsset, 0);
    this->fields.scriptAsset = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.scriptAsset, 0, v6, v7, v8, v9, v10, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01FF8 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ScriptObjectListViewMenu_EndLoadAsset__);
    byte_4E01FF8 = 1;
  }
...
void ScriptObjectListViewMenu__StartInput(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01FFA & 1) == 0 )
  {
    ...
    sub_1CE6700(&ScriptManager_TypeInfo);
    sub_1CE6700(&ScriptObjectListViewItem_TypeInfo);
    sub_1CE6700(&Method_ScriptObjectListViewMenu_OnClickItem__);
    byte_4E01FFA = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  v4 = (ScriptObjectListViewManager_CallbackFunc_o *)sub_1CE694C(ScriptObjectListViewManager_CallbackFunc_TypeInfo);
  ...
  if ( !listViewManager )
    goto LABEL_23;
  ScriptObjectListViewManager__SetMode_38567572(listViewManager, 1, v4, v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B14D64;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B14D0C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01FFF & 1) == 0 )
  {
    sub_1CE6700(&ScriptObjectListViewMenu_ResultKind_TypeInfo);
    byte_4E01FFF = 1;
  }
  v11[2] = 0;
