...
void __fastcall ScriptObjectListViewMenu__Close(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( scriptAsset )
  {
    ...
    AssetManager__releaseAsset_38744968(scriptAsset, 0LL);
    this->fields.scriptAsset = 0LL;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.scriptAsset, 0, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.scriptAsset, (int32_t)data, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B86614(forceObi169Sprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BB67 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_ScriptObjectListViewMenu_EndLoadAsset__, v8);
    byte_4A4BB67 = 1;
  }
...
LABEL_6:
      ...
      sub_1B8635C((CGThumbnailListItem_o *)&this->fields.path, (int32_t)assetName, (int32_t)callback, method);
      this->fields.callbackFunc = callback;
              ...
              if ( *p_path )
              {
                ...
                if ( scriptTestDefaultNameLabel )
                {
                  ...
                  if ( scriptAsset )
                  {
                    ...
                    AssetManager__releaseAsset_38744968(scriptAsset, 0LL);
                    this->fields.scriptAsset = 0LL;
                    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.scriptAsset, 0, v18, v19);
                  }
                  this->fields.state = 1;
...
void __fastcall ScriptObjectListViewMenu__StartInput(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4BB69 & 1) == 0 )
  {
    sub_1B863B8(&ScriptObjectListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B863B8(&ScriptManager_TypeInfo, v3);
    sub_1B863B8(&ScriptObjectListViewItem_TypeInfo, v4);
    sub_1B863B8(&Method_ScriptObjectListViewMenu_OnClickItem__, v5);
    byte_4A4BB69 = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  v7 = (ScriptObjectListViewManager_CallbackFunc_o *)sub_1B86604(ScriptObjectListViewManager_CallbackFunc_TypeInfo);
  ...
  if ( !listViewManager )
    goto LABEL_23;
  ScriptObjectListViewManager__SetMode_35656224(listViewManager, 1, v7, v11);
  ...
  {
LABEL_23:
    sub_1B86614(scriptTestObjectCancelButton, v10);
  }
  UnityEngine_Behaviour__set_enabled(
    scriptTestObjectCancelButton,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BB65 & 1) == 0 )
  {
    sub_1B863B8(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4A4BB65 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19D014C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19D00F4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BB6E & 1) == 0 )
  {
    sub_1B863B8(&ScriptObjectListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4A4BB6E = 1;
  }
  v11[2] = 0LL;
