...
void ScriptObjectListViewMenu__Close(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( scriptAsset )
  {
    ...
    AssetManager__releaseAsset_41285308(scriptAsset, 0);
    this->fields.scriptAsset = 0;
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.scriptAsset, 0, v6, v7, v8, v9, v10, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29E14 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_ScriptObjectListViewMenu_EndLoadAsset__);
    byte_4D29E14 = 1;
  }
...
void ScriptObjectListViewMenu__StartInput(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29E16 & 1) == 0 )
  {
    ...
    sub_1C94098(&ScriptManager_TypeInfo);
    sub_1C94098(&ScriptObjectListViewItem_TypeInfo);
    sub_1C94098(&Method_ScriptObjectListViewMenu_OnClickItem__);
    byte_4D29E16 = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  v4 = (ScriptObjectListViewManager_CallbackFunc_o *)sub_1C942E4(ScriptObjectListViewManager_CallbackFunc_TypeInfo);
  ...
  if ( !listViewManager )
    goto LABEL_23;
  ScriptObjectListViewManager__SetMode_38189144(listViewManager, 1, v4, v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC5D50;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC5CF8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29E1B & 1) == 0 )
  {
    sub_1C94098(&ScriptObjectListViewMenu_ResultKind_TypeInfo);
    byte_4D29E1B = 1;
  }
  v11[2] = 0;
