...
void __fastcall ScriptObjectListViewMenu__Close(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( scriptAsset )
  {
    ...
    AssetManager__releaseAsset_38697776(scriptAsset, 0LL);
    this->fields.scriptAsset = 0LL;
    sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.scriptAsset, 0LL, v6, v7, v8, v9, v10, v11);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4D28(forceObi169Sprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6435E & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptObjectListViewItem_TypeInfo, method);
    byte_4B6435E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64358 & 1) == 0 )
  {
    sub_1BE4ACC(&AssetManager_TypeInfo, assetName);
    sub_1BE4ACC(&AssetLoader_LoadEndDataHandler_TypeInfo, v11);
    sub_1BE4ACC(&Method_ScriptObjectListViewMenu_EndLoadAsset__, v12);
    byte_4B64358 = 1;
  }
...
LABEL_24:
      sub_1BE4D28(scriptTestObjectRootObject, v21);
  }
}
...
void __fastcall ScriptObjectListViewMenu__StartInput(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6435A & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptObjectListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BE4ACC(&ScriptManager_TypeInfo, v3);
    sub_1BE4ACC(&ScriptObjectListViewItem_TypeInfo, v4);
    sub_1BE4ACC(&Method_ScriptObjectListViewMenu_OnClickItem__, v5);
    byte_4B6435A = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  v7 = (ScriptObjectListViewManager_CallbackFunc_o *)sub_1BE4D18(ScriptObjectListViewManager_CallbackFunc_TypeInfo);
  ...
  if ( !listViewManager )
    goto LABEL_23;
  ScriptObjectListViewManager__SetMode_35739328(listViewManager, 1, v7, v11);
  ...
  {
LABEL_23:
    sub_1BE4D28(scriptTestObjectCancelButton, v10);
  }
  UnityEngine_Behaviour__set_enabled(
    scriptTestObjectCancelButton,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64356 & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4B64356 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A24250;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A241F8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6435F & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptObjectListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4B6435F = 1;
  }
  v11[2] = 0LL;
