...
void ScriptObjectListViewMenu__Close(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( scriptAsset )
  {
    ...
    AssetManager__releaseAsset_40313100(scriptAsset, 0);
    this->fields.scriptAsset = 0;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.scriptAsset, 0, v6, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.scriptAsset, (int32_t)data, (int32_t)method, v3);
...
void ScriptObjectListViewMenu__OnClickForceObi169(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D6EC(forceObi169Sprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C248FE & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptObjectListViewMenu_EndLoadAsset__);
    byte_4C248FE = 1;
  }
...
LABEL_6:
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&this->fields.path, (int32_t)assetName, (int32_t)callback, method);
      this->fields.callbackFunc = callback;
              ...
              if ( *p_path )
              {
                ...
                if ( scriptTestDefaultNameLabel )
                {
                  ...
                  if ( scriptAsset )
                  {
                    ...
                    AssetManager__releaseAsset_40313100(scriptAsset, 0);
                    this->fields.scriptAsset = 0;
                    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.scriptAsset, 0, v16, v17);
                  }
                  this->fields.state = 1;
...
LABEL_24:
      sub_1C2D6EC(scriptTestObjectRootObject, v11);
  }
}
...
void ScriptObjectListViewMenu__StartInput(ScriptObjectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24900 & 1) == 0 )
  {
    ...
    sub_1C2D490(&ScriptManager_TypeInfo);
    sub_1C2D490(&ScriptObjectListViewItem_TypeInfo);
    sub_1C2D490(&Method_ScriptObjectListViewMenu_OnClickItem__);
    byte_4C24900 = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  v4 = (ScriptObjectListViewManager_CallbackFunc_o *)sub_1C2D6DC(ScriptObjectListViewManager_CallbackFunc_TypeInfo);
  ...
  if ( !listViewManager )
    goto LABEL_23;
  ScriptObjectListViewManager__SetMode_37247360(listViewManager, 1, v4, v8);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A6F49C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A6F444;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24905 & 1) == 0 )
  {
    sub_1C2D490(&ScriptObjectListViewMenu_ResultKind_TypeInfo);
    byte_4C24905 = 1;
  }
  v11[2] = 0;
