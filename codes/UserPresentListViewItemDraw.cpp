void __fastcall UserPresentListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1B299 & 1) == 0 )
  {
    sub_1BCAFF8(&UserPresentListViewItemDraw_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_22904/*"ribon_present_important_1"*/, v4);
    sub_1BCAFF8(&StringLiteral_20263/*"img_listboard_bg02"*/, v5);
    sub_1BCAFF8(&StringLiteral_20264/*"img_listboard_bg03"*/, v6);
    sub_1BCAFF8(&StringLiteral_22905/*"ribon_present_limited_period"*/, v7);
    byte_4B1B299 = 1;
  }
  ...
  *(_QWORD *)&static_fields->BOARD_MSG_DEFAULT_OFFSET_Y = 0xFFFFFFEAFFFFFFF5LL;
  v9 = StringLiteral_20263/*"img_listboard_bg02"*/;
  static_fields->BOARD_BG_SP_NAME_NORMAL = (struct System_String_o *)StringLiteral_20263/*"img_listboard_bg02"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->BOARD_BG_SP_NAME_NORMAL, v9, v2, v3);
  v10 = StringLiteral_20264/*"img_listboard_bg03"*/;
  v11 = UserPresentListViewItemDraw_TypeInfo->static_fields;
  v11->BOARD_BG_SP_NAME_IMPORTANT = (struct System_String_o *)StringLiteral_20264/*"img_listboard_bg03"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v11->BOARD_BG_SP_NAME_IMPORTANT, v10, v12, v13);
  v14 = StringLiteral_22905/*"ribon_present_limited_period"*/;
  v15 = UserPresentListViewItemDraw_TypeInfo->static_fields;
  v15->ICON_SP_NAME_LIMITED = (struct System_String_o *)StringLiteral_22905/*"ribon_present_limited_period"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v15->ICON_SP_NAME_LIMITED, v14, v16, v17);
  v18 = StringLiteral_22904/*"ribon_present_important_1"*/;
  v19 = UserPresentListViewItemDraw_TypeInfo->static_fields;
  v19->ICON_SP_NAME_IMPORTANT = (struct System_String_o *)StringLiteral_22904/*"ribon_present_important_1"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v19->ICON_SP_NAME_IMPORTANT, v18, v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B295 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_Collider___, v6);
  ...
  if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
  {
    ...
    if ( !Component_object
      ...
      || (Component_object = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                          ...
                                                          (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_Collider___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B294 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UserPresentBoxMaster_TypeInfo, v8);
    sub_1BCAFF8(&UserPresentListViewItemDraw_TypeInfo, v9);
    sub_1BCAFF8(&UserPresentListViewManager_TypeInfo, v10);
    sub_1BCAFF8(&StringLiteral_10375/*"PRESENT_INFO"*/, v11);
  ...
  if ( item && mode )
  {
    ...
    ItemIconComponent__SetGift_40107980(itemIcon, giftType, objectId, -1, 0, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v20 = LocalizationManager__Get((System_String_o *)StringLiteral_10375/*"PRESENT_INFO"*/, 0LL);
    NameText = (Il2CppObject *)UserPresentListViewItem__get_NameText(item, v21);
    itemIcon = (ItemIconComponent_o *)System_String__Format_62491716(
                                        v20,
                                        NameText,
    ...
    p_mManager = &this->fields.mManager;
LABEL_24:
    sub_1BCAF9C((CGThumbnailListItem_o *)p_mManager, (int32_t)manager, v23, v24);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B296 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ItemMaster___, item);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserItemMaster___, v5);
    sub_1BCAFF8(&Method_DataManager_GetMaster_UserSvtCoinMaster___, v6);
    ...
    sub_1BCAFF8(&StringLiteral_13322/*"TIME_REST_STRING"*/, v12);
    sub_1BCAFF8(&StringLiteral_13310/*"TIME_REST_PRESENT_LIMITED"*/, v13);
    sub_1BCAFF8(&StringLiteral_11972/*"SHOP_BUY_ITEM_HOLD"*/, v14);
    sub_1BCAFF8(&StringLiteral_13307/*"TIME_REST_PRESENT"*/, v15);
    sub_1BCAFF8(&StringLiteral_13308/*"TIME_REST_PRESENT_INDEFINITE_PERIOD"*/, v16);
    sub_1BCAFF8(&StringLiteral_13309/*"TIME_REST_PRESENT_INDEFINITE_PERIOD_TEXT"*/, v17);
  ...
  if ( ((unsigned __int8)Instance & 1) == 0 )
  {
    ...
    if ( ((unsigned __int8)Instance & 1) == 0 )
    {
      ...
      if ( !ItemMaster__isEventPoint(v25, v28->fields.id, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_11972/*"SHOP_BUY_ITEM_HOLD"*/, 0LL);
        if ( !holdNumTitleLb )
          goto LABEL_126;
        ...
        else if ( type != 36 )
        {
          if ( type == 29 )
          {
            ...
            if ( ((unsigned __int8)Instance & 1) == 0 )
            {
              if ( !holdNumCntLb )
                goto LABEL_126;
              detail = (System_String_o *)StringLiteral_1113/*"0"*/;
              goto LABEL_123;
            }
            if ( !entity )
              goto LABEL_126;
...
LABEL_23:
  ...
  else
  {
    ...
    {
LABEL_31:
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_13310/*"TIME_REST_PRESENT_LIMITED"*/, 0LL);
      if ( !resTimeLb )
        goto LABEL_126;
      ...
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_13322/*"TIME_REST_STRING"*/, 0LL);
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_13307/*"TIME_REST_PRESENT"*/, 0LL);
  if ( !resTimeLb )
    goto LABEL_126;
  UILabel__set_text(resTimeLb, (System_String_o *)Instance, 0LL);
  ...
  if ( usrPresentEnt )
  {
    ...
    if ( UserPresentBoxEntity__IsEnableFlag(usrPresentEnt, v44->static_fields->INDEFINITE_PERIOD, 0LL) )
    {
      ...
      if ( !UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)Instance, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_13308/*"TIME_REST_PRESENT_INDEFINITE_PERIOD"*/, 0LL);
        if ( !v45 )
          goto LABEL_126;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_13309/*"TIME_REST_PRESENT_INDEFINITE_PERIOD_TEXT"*/, 0LL);
      if ( v46 )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B297 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventMaster___, item);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventServantMaster___, v5);
    ...
    sub_1BCAFF8(&UserPresentBoxMaster_TypeInfo, v9);
    sub_1BCAFF8(&StringLiteral_13307/*"TIME_REST_PRESENT"*/, v10);
    sub_1BCAFF8(&StringLiteral_13308/*"TIME_REST_PRESENT_INDEFINITE_PERIOD"*/, v11);
    sub_1BCAFF8(&StringLiteral_13309/*"TIME_REST_PRESENT_INDEFINITE_PERIOD_TEXT"*/, v12);
    byte_4B1B297 = 1;
  }
  holdNumTitleLb = this->fields.holdNumTitleLb;
  if ( !holdNumTitleLb )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  holdNumTitleLb = LocalizationManager__Get((System_String_o *)StringLiteral_13307/*"TIME_REST_PRESENT"*/, 0LL);
  if ( !resTimeLb )
    goto LABEL_66;
  ...
  if ( svtEnt )
  {
    ...
    {
      holdNumTitleLb = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !holdNumTitleLb )
        goto LABEL_66;
          ...
          if ( (int)v21 >= 1 )
          {
            ...
            while ( 1 )
            {
              if ( (unsigned int)v23 >= (unsigned int)v21 )
                sub_1BCB25C(holdNumTitleLb, item, v20);
              v24 = v22[v23 + 4];
              if ( !v24 )
                break;
              ...
              if ( *(_QWORD *)(v24 + 88) < createdAt && createdAt < *(_QWORD *)(v24 + 96) )
              {
                ...
                *(_QWORD *)&v38.fields.fakeValue = v30;
                holdNumTitleLb = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v38, 0LL);
                if ( !v28 )
                  break;
                holdNumTitleLb = EventServantMaster__getEntity_41279968(v28, v29, (int32_t)holdNumTitleLb, 0LL);
...
LABEL_66:
            sub_1BCB254(holdNumTitleLb, item);
          }
        }
      }
    }
...
LABEL_56:
  ...
  if ( v34 )
  {
    ...
    if ( UserPresentBoxEntity__IsEnableFlag(v34, v35->static_fields->INDEFINITE_PERIOD, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      holdNumTitleLb = LocalizationManager__Get((System_String_o *)StringLiteral_13308/*"TIME_REST_PRESENT_INDEFINITE_PERIOD"*/, 0LL);
      if ( !v36 )
        goto LABEL_66;
      UILabel__set_text(v36, (System_String_o *)holdNumTitleLb, 0LL);
      v37 = this->fields.resLimitedTimeLb;
      holdNumTitleLb = LocalizationManager__Get((System_String_o *)StringLiteral_13309/*"TIME_REST_PRESENT_INDEFINITE_PERIOD_TEXT"*/, 0LL);
      if ( !v37 )
        goto LABEL_66;
