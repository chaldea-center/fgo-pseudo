void __fastcall UserPresentListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A59F01 & 1) == 0 )
  {
    sub_1B885B0(&UserPresentListViewItemDraw_TypeInfo);
    sub_1B885B0(&StringLiteral_22938/*"ribon_present_important_1"*/);
    sub_1B885B0(&StringLiteral_20351/*"img_listboard_bg02"*/);
    sub_1B885B0(&StringLiteral_20352/*"img_listboard_bg03"*/);
    sub_1B885B0(&StringLiteral_22939/*"ribon_present_limited_period"*/);
    byte_4A59F01 = 1;
  }
  ...
  *(_QWORD *)&static_fields->BOARD_MSG_DEFAULT_OFFSET_Y = 0xFFFFFFEAFFFFFFF5LL;
  v4 = StringLiteral_20351/*"img_listboard_bg02"*/;
  static_fields->BOARD_BG_SP_NAME_NORMAL = (struct System_String_o *)StringLiteral_20351/*"img_listboard_bg02"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->BOARD_BG_SP_NAME_NORMAL, v4, v1, v2);
  v5 = StringLiteral_20352/*"img_listboard_bg03"*/;
  v6 = UserPresentListViewItemDraw_TypeInfo->static_fields;
  v6->BOARD_BG_SP_NAME_IMPORTANT = (struct System_String_o *)StringLiteral_20352/*"img_listboard_bg03"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v6->BOARD_BG_SP_NAME_IMPORTANT, v5, v7, v8);
  v9 = StringLiteral_22939/*"ribon_present_limited_period"*/;
  v10 = UserPresentListViewItemDraw_TypeInfo->static_fields;
  v10->ICON_SP_NAME_LIMITED = (struct System_String_o *)StringLiteral_22939/*"ribon_present_limited_period"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v10->ICON_SP_NAME_LIMITED, v9, v11, v12);
  v13 = StringLiteral_22938/*"ribon_present_important_1"*/;
  v14 = UserPresentListViewItemDraw_TypeInfo->static_fields;
  v14->ICON_SP_NAME_IMPORTANT = (struct System_String_o *)StringLiteral_22938/*"ribon_present_important_1"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v14->ICON_SP_NAME_IMPORTANT, v13, v15, v16);
  ...
  if ( UnityEngine_Object__op_Inequality(baseButton, 0LL, 0LL) )
  {
    ...
    if ( !Component_object
      ...
      || (Component_object = (UnityEngine_Component_o *)UnityEngine_GameObject__GetComponent_object_(
                                                          ...
                                                          (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_Collider___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( item && mode )
  {
    ...
    ItemIconComponent__SetGift_38144896(itemIcon, giftType, objectId, -1, 0, 0LL);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_10456/*"PRESENT_INFO"*/, 0LL);
    NameText = (Il2CppObject *)UserPresentListViewItem__get_NameText(item, v15);
    itemIcon = (ItemIconComponent_o *)System_String__Format_61721404(
                                        v14,
                                        NameText,
    ...
    if ( manager )
    {
        ...
        && (UserPresentListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] == UserPresentListViewManager_TypeInfo )
      {
        ...
        if ( LOBYTE(manager->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low
          && (UserPresentListViewManager_c *)manager->klass->_2.typeHierarchy[methodPtr_low - 1] == v22 )
        {
          goto LABEL_24;
        }
      }
    ...
    p_mManager = &this->fields.mManager;
LABEL_24:
    sub_1B88554((ServantStatusBattleListViewItem_o *)p_mManager, (int32_t)manager, v17, v18);
    ...
    if ( UserPresentBoxEntity__IsEnableFlag(v25, v26->static_fields->IMPORTANT_FOR_EVENT, 0LL) )
    {
    ...
    if ( UserPresentBoxEntity__IsEnableFlag(v25, v32->static_fields->IMPORTANT_FOR_LIMIT, 0LL) )
    {
      itemIcon = (ItemIconComponent_o *)UserPresentListViewItemDraw_TypeInfo;
      ...
      if ( !itemIcon )
        goto LABEL_79;
      v36 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)itemIcon, 0LL);
...
LABEL_50:
      ...
      if ( !v38 )
        goto LABEL_79;
      UIButton__set_normalSprite(v38, UserPresentListViewItemDraw_TypeInfo->static_fields->BOARD_BG_SP_NAME_NORMAL, 0LL);
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetBanner(v39, BOARD_BG_SP_NAME_NORMAL, 0LL);
      itemIcon = (ItemIconComponent_o *)this->fields.imortantSprite;
      if ( !itemIcon )
        goto LABEL_79;
      itemIcon = (ItemIconComponent_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)itemIcon, 0LL);
    ...
    GameObjectExtensions__SetLocalPositionY(v36, (float)BOARD_MSG_IMPORTANT_OFFSET_Y, 0LL);
    itemIcon = (ItemIconComponent_o *)this->fields.limitedPeriodSprite;
    if ( !itemIcon )
      goto LABEL_79;
    v31 = 1;
LABEL_61:
    UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)itemIcon, v31, 0LL);
      ...
      if ( itemIcon )
      {
        ...
        if ( itemIcon )
        {
          ...
          if ( itemIcon )
          {
            ...
            if ( itemIcon )
            {
              UILabel__set_text((UILabel_o *)itemIcon, v21, 0LL);
              itemIcon = (ItemIconComponent_o *)UserPresentListViewItemDraw_TypeInfo;
              ...
              if ( nameTextLabel )
              {
                ...
                if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                v44 = LocalizationManager__ReplaceCommonTag(presentMsg, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59EFE & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_13336/*"TIME_REST_PRESENT_LIMITED"*/);
    sub_1B885B0(&StringLiteral_12012/*"SHOP_BUY_ITEM_HOLD"*/);
    sub_1B885B0(&StringLiteral_13333/*"TIME_REST_PRESENT"*/);
    sub_1B885B0(&StringLiteral_13334/*"TIME_REST_PRESENT_INDEFINITE_PERIOD"*/);
    sub_1B885B0(&StringLiteral_13335/*"TIME_REST_PRESENT_INDEFINITE_PERIOD_TEXT"*/);
    sub_1B885B0(&StringLiteral_1/*""*/);
  ...
  if ( (Instance & 1) == 0 )
  {
    ...
    if ( (Instance & 1) == 0 )
    {
      ...
      if ( !ItemMaster__isEventPoint(v10, v13->fields.id, 0LL) )
      {
        ...
        if ( !v33 )
          goto LABEL_118;
        Instance = ItemMaster__isMana(v10, v33->fields.id, 0LL);
        if ( (Instance & 1) != 0 )
        {
...
LABEL_23:
  ...
  else
  {
    ...
    {
LABEL_31:
      Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13336/*"TIME_REST_PRESENT_LIMITED"*/, 0LL);
      if ( !resTimeLb )
        goto LABEL_118;
      ...
      Instance = (int64_t)LocalizationManager__GetRestTime2(v19->fields.endedAt, -1LL, 0LL);
      if ( !resLimitedTimeLb )
        goto LABEL_118;
      ...
      Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13348/*"TIME_REST_STRING"*/, 0LL);
  ...
  Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13333/*"TIME_REST_PRESENT"*/, 0LL);
  if ( !resTimeLb )
    goto LABEL_118;
  UILabel__set_text(resTimeLb, (System_String_o *)Instance, 0LL);
  ...
  Instance = (int64_t)LocalizationManager__GetRestTime2(v27, -1LL, 0LL);
  if ( !v26 )
    goto LABEL_118;
  ...
  if ( usrPresentEnt )
  {
    ...
    if ( UserPresentBoxEntity__IsEnableFlag(usrPresentEnt, v29->static_fields->INDEFINITE_PERIOD, 0LL) )
    {
      ...
      if ( !UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)Instance, 0LL) )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13334/*"TIME_REST_PRESENT_INDEFINITE_PERIOD"*/, 0LL);
        if ( !v30 )
          goto LABEL_118;
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Instance = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_13335/*"TIME_REST_PRESENT_INDEFINITE_PERIOD_TEXT"*/, 0LL);
      if ( v31 )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  holdNumTitleLb = LocalizationManager__Get((System_String_o *)StringLiteral_13333/*"TIME_REST_PRESENT"*/, 0LL);
  if ( !resTimeLb )
    goto LABEL_66;
  ...
  if ( svtEnt )
  {
    ...
    {
      holdNumTitleLb = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !holdNumTitleLb )
        goto LABEL_66;
          ...
          if ( (int)v12 >= 1 )
          {
            ...
            while ( 1 )
            {
              if ( (unsigned int)v14 >= (unsigned int)v12 )
                sub_1B88814(holdNumTitleLb, item);
              v15 = v13[v14 + 4];
              if ( !v15 )
                break;
              ...
              if ( *(_QWORD *)(v15 + 88) < createdAt && createdAt < *(_QWORD *)(v15 + 96) )
              {
                ...
                *(_QWORD *)&v29.fields.fakeValue = v21;
                holdNumTitleLb = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v29, 0LL);
                if ( !v19 )
                  break;
                holdNumTitleLb = EventServantMaster__getEntity_39266948(v19, v20, (int32_t)holdNumTitleLb, 0LL);
...
LABEL_66:
            sub_1B8880C(holdNumTitleLb, item);
          }
        }
      }
    }
...
LABEL_56:
  ...
  if ( v25 )
  {
    ...
    if ( UserPresentBoxEntity__IsEnableFlag(v25, v26->static_fields->INDEFINITE_PERIOD, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      holdNumTitleLb = LocalizationManager__Get((System_String_o *)StringLiteral_13334/*"TIME_REST_PRESENT_INDEFINITE_PERIOD"*/, 0LL);
      if ( !v27 )
        goto LABEL_66;
      UILabel__set_text(v27, (System_String_o *)holdNumTitleLb, 0LL);
      v28 = this->fields.resLimitedTimeLb;
      holdNumTitleLb = LocalizationManager__Get((System_String_o *)StringLiteral_13335/*"TIME_REST_PRESENT_INDEFINITE_PERIOD_TEXT"*/, 0LL);
      if ( !v28 )
        goto LABEL_66;
