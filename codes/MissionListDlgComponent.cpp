void __fastcall MissionListDlgComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5E44C & 1) == 0 )
  {
    sub_1B885B0(&MissionListDlgComponent_TypeInfo);
    byte_4A5E44C = 1;
  }
...
void __fastcall MissionListDlgComponent__OnClickClose(MissionListDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E44A & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_MissionListDlgComponent_OnClickClose__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1B885B0(&TerminalSceneComponent_TypeInfo);
    sub_1B885B0(&Method_MissionListDlgComponent___c__OnClickClose_b__17_0__);
    sub_1B885B0(&MissionListDlgComponent___c_TypeInfo);
    byte_4A5E44A = 1;
  }
  if ( this->fields.isTouchEnabled )
  {
    ...
    if ( (*((_BYTE *)Method_MissionListDlgComponent_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B885C8(Method_MissionListDlgComponent_OnClickClose__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
    Instance = (TitleInfoControl_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    ...
    if ( !_9__17_0 )
    {
      ...
      _9__17_0 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__17_0, (int32_t)_9__17_0, v12, v13);
    }
    if ( !v8 )
LABEL_23:
...
void __fastcall MissionListDlgComponent__OnClickMissionList(MissionListDlgComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_MissionListDlgComponent_OnClickMissionList__);
    sub_1B885B0(&Method_MissionListDlgComponent__OnClickMissionList_b__16_0__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1B885B0(&TerminalSceneComponent_TypeInfo);
    byte_4A5E449 = 1;
  }
  if ( this->fields.isTouchEnabled )
  {
    ...
    if ( (*((_BYTE *)Method_MissionListDlgComponent_OnClickMissionList__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B885C8(Method_MissionListDlgComponent_OnClickMissionList__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E448 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_MissionListDlgComponent___c__DisplayClass15_0__OpenEventMissionListDialog_b__0__);
    sub_1B885B0(&MissionListDlgComponent___c__DisplayClass15_0_TypeInfo);
    byte_4A5E448 = 1;
  }
  v13 = sub_1B887FC(MissionListDlgComponent___c__DisplayClass15_0_TypeInfo);
  ...
  *(_QWORD *)(v13 + 24) = title;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v13 + 24), (int32_t)title, v18, v19);
  *(_QWORD *)(v13 + 32) = subTitle;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v13 + 32), (int32_t)subTitle, v20, v21);
  *(_QWORD *)(v13 + 40) = eventDetailEnt;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v13 + 40), (int32_t)eventDetailEnt, v22, v23);
  *(_QWORD *)(v13 + 48) = eventMissionEntList;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v13 + 48), (int32_t)eventMissionEntList, v24, v25);
  *(_QWORD *)(v13 + 56) = missionBtnCallback;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v13 + 56), (int32_t)missionBtnCallback, v26, v27);
...
LABEL_10:
  ...
  AtlasManager__LoadNotification(v28, 0LL);
}
...
void __fastcall MissionListDlgComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(MissionListDlgComponent___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E450 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_MissionListDlgComponent___c__OpenEventMissionListDialog_b__15_1__);
    this = (MissionListDlgComponent___c__DisplayClass15_0_o *)sub_1B885B0(&MissionListDlgComponent___c_TypeInfo);
    byte_4A5E450 = 1;
  }
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this[2].fields, (int32_t)eventDetailEnt, v6, v7);
  this = (MissionListDlgComponent___c__DisplayClass15_0_o *)v2->fields.__4__this;
  if ( !this )
    goto LABEL_48;
  eventMissionEntList = (struct System_String_o *)v2->fields.eventMissionEntList;
  this[2].fields.title = eventMissionEntList;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this[2].fields.title, (int32_t)eventMissionEntList, v9, v10);
  this = (MissionListDlgComponent___c__DisplayClass15_0_o *)v2->fields.__4__this;
  if ( !this )
    goto LABEL_48;
  missionBtnCallback = (struct System_String_o *)v2->fields.missionBtnCallback;
  this[2].fields.subTitle = missionBtnCallback;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this[2].fields.subTitle, (int32_t)missionBtnCallback, v12, v13);
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    if ( !byte_4A57FF6 )
    {
      this = (MissionListDlgComponent___c__DisplayClass15_0_o *)sub_1B885B0(&EventRewardSaveData_TypeInfo);
      byte_4A57FF6 = 1;
    }
    ...
    if ( v28 )
    {
      ...
      if ( this )
      {
        ...
        if ( v29 )
        {
          EventMissionItemListViewManager__CreateList_45684820(v29, v30, v31, (unsigned __int8)this & 1, 0, 0LL);
          goto LABEL_40;
        }
      }
    }
...
LABEL_40:
  ...
  if ( !monitor )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__15_1, (int32_t)monitor, v36, v37);
  }
  if ( !v32 )
    goto LABEL_48;
  BaseDialog__Open(v32, monitor, 1, 0LL);
}