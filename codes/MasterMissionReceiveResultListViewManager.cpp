        ...
        const MethodInfo *method)
{
  void *Instance; // x0
  __int64 v6; // x1
  EventMissionEntity_array *EventMissionList_25658348; // x20
  ...
  __int64 v34; // x0
  GiftMaster_o *v35; // [xsp+0h] [xbp-80h]
  EventMissionEntity_array *v36; // [xsp+8h] [xbp-78h]
  unsigned int v37; // [xsp+10h] [xbp-70h]
  ...
  if ( (byte_42B000A & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_8698/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/);
    byte_42B000A = 1;
  }
  nameText = 0LL;
  entity = 0LL;
  ...
  if ( !Instance )
    goto LABEL_34;
  EventMissionList_25658348 = EventMissionMaster__getEventMissionList_25658348(
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_8698/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/, 0LL);
  if ( !EventMissionList_25658348 )
    goto LABEL_34;
  max_length = EventMissionList_25658348->max_length;
  if ( max_length >= 1 )
  {
...
LABEL_35:
      ...
      v14 = EventMissionList_25658348->m_Items[v12];
      if ( !v14 )
        break;
      ...
      if ( v15 >= 1 )
      {
        ...
        do
        {
          ...
          Instance = (void *)Gift__IsItem_28236268(v18->fields.type, 0LL);
          ...
          v22 = System_String__Format_44569380(v11, v20, CountableString, v21, 0LL);
          itemList = this->fields.itemList;
          v24 = (System_Int32_array **)v22;
          v25 = sub_B52A54(MasterMissionReceiveResultListViewItem_TypeInfo);
          ListViewItem___ctor_23532700((ListViewItem_o *)v25, v13 + v17, 0LL);
          *(_QWORD *)(v25 + 112) = v24;
          sub_B52920((BattleServantConfConponent_o *)(v25 + 112), v24, v26, v27, v28, v29, v30, v31);
          if ( !itemList )
            goto LABEL_34;
        ...
        while ( v17 < v15 );
        v13 += v17;
        MasterData_WarQuestSelectionMaster = v35;
        EventMissionList_25658348 = v36;
        v12 = v37;
      }
      max_length = EventMissionList_25658348->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B000B & 1) == 0 )
  {
    this = (MasterMissionReceiveResultListViewManager_o *)sub_B52984(&MasterMissionReceiveResultListViewObject_TypeInfo);
    byte_42B000B = 1;
  }
  if ( !obj
