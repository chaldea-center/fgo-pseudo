        ...
        const MethodInfo *method)
{
  ...
  void *Instance; // x0
  __int64 v15; // x1
  EventMissionEntity_array *EventMissionList_40113688; // x25
  ...
  if ( (byte_4B69DE0 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_EventMissionMaster___, receiveMissionIds);
    ...
    sub_1BE4ACC(&MasterMissionReceiveResultListViewItem_TypeInfo, v11);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v12);
    sub_1BE4ACC(&StringLiteral_8684/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/, v13);
    byte_4B69DE0 = 1;
  }
  nameText = 0LL;
  entity = 0LL;
  ...
  if ( !Instance )
    goto LABEL_36;
  EventMissionList_40113688 = EventMissionMaster__getEventMissionList_40113688(
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_8684/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/, 0LL);
  if ( !EventMissionList_40113688 )
    goto LABEL_36;
  max_length = EventMissionList_40113688->max_length;
  if ( max_length >= 1 )
  {
    ...
    v56 = EventMissionList_40113688;
    while ( 1 )
    {
      if ( v21 >= max_length )
LABEL_37:
        sub_1BE4D30(Instance, v15);
      v23 = EventMissionList_40113688->m_Items[v21];
      if ( !v23 )
        break;
      ...
      if ( v24 >= 1 )
      {
        ...
        do
        {
          ...
          Instance = (void *)Gift__IsItem_38593312(v27->fields.type, 0LL);
          ...
          v34 = System_String__Format_62713248(v20, v32, CountableString, v33, 0LL);
          itemList = (System_Collections_Generic_List_object__o *)this->fields.itemList;
          v36 = (int64_t)v34;
          v37 = sub_1BE4D18(MasterMissionReceiveResultListViewItem_TypeInfo);
          ListViewItem___ctor_41686696((ListViewItem_o *)v37, v22 + v26, 0LL);
          *(_QWORD *)(v37 + 112) = v36;
          sub_1BE4A70((PartyOrganizationUtility_o *)(v37 + 112), v36, v38, v39, v40, v41, v42, v43);
          if ( !itemList )
            goto LABEL_36;
          ...
          else
          {
            ...
            sub_1BE4A70((PartyOrganizationUtility_o *)(v53 + 4), v37, v44, v45, v46, v47, v48, v49);
          }
          v24 = *((_DWORD *)v25 + 6);
          ++v26;
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69DE1 & 1) == 0 )
  {
    this = (MasterMissionReceiveResultListViewManager_o *)sub_1BE4ACC(
