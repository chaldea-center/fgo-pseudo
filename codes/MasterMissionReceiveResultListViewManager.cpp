        ...
        const MethodInfo *method)
{
  void *Instance; // x0
  __int64 v6; // x1
  EventMissionEntity_array *EventMissionList_39188984; // x25
  ...
  Il2CppObject *v38; // [xsp+0h] [xbp-90h]
  EventMissionEntity_array *v39; // [xsp+8h] [xbp-88h]
  unsigned int v40; // [xsp+10h] [xbp-80h]
  ...
  if ( (byte_4A5E3A7 & 1) == 0 )
  {
    ...
    sub_1B885B0(&MasterMissionReceiveResultListViewItem_TypeInfo);
    sub_1B885B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1B885B0(&StringLiteral_8538/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/);
    byte_4A5E3A7 = 1;
  }
  nameText = 0LL;
  entity = 0LL;
  ...
  if ( !Instance )
    goto LABEL_36;
  EventMissionList_39188984 = EventMissionMaster__getEventMissionList_39188984(
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_8538/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/, 0LL);
  if ( !EventMissionList_39188984 )
    goto LABEL_36;
  max_length = EventMissionList_39188984->max_length;
  if ( max_length >= 1 )
  {
    ...
    v39 = EventMissionList_39188984;
    while ( 1 )
    {
      if ( v12 >= max_length )
LABEL_37:
        sub_1B88814(Instance, v6);
      v14 = EventMissionList_39188984->m_Items[v12];
      if ( !v14 )
        break;
      ...
      if ( v15 >= 1 )
      {
        ...
        do
        {
          ...
          Instance = (void *)Gift__IsItem_37687788(v18->fields.type, 0LL);
          ...
          v25 = System_String__Format_61721472(v11, v23, CountableString, v24, 0LL);
          itemList = (System_Collections_Generic_List_object__o *)this->fields.itemList;
          v27 = v25;
          v28 = sub_1B887FC(MasterMissionReceiveResultListViewItem_TypeInfo);
          ListViewItem___ctor_40706472((ListViewItem_o *)v28, v13 + v17, 0LL);
          *(_QWORD *)(v28 + 112) = v27;
          sub_1B88554((ServantStatusBattleListViewItem_o *)(v28 + 112), (int32_t)v27, v29, v30);
          if ( !itemList )
            goto LABEL_36;
          ...
          else
          {
            ...
            sub_1B88554((ServantStatusBattleListViewItem_o *)(v36 + 4), v28, v31, v32);
          }
          v15 = *((_DWORD *)v16 + 6);
          ++v17;
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E3A8 & 1) == 0 )
  {
    this = (MasterMissionReceiveResultListViewManager_o *)sub_1B885B0(&MasterMissionReceiveResultListViewObject_TypeInfo);
    byte_4A5E3A8 = 1;
  }
  if ( !obj
