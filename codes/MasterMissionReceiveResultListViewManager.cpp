        ...
        const MethodInfo *method)
{
  void *Instance; // x0
  __int64 v6; // x1
  EventMissionEntity_array *EventMissionList_43191332; // x25
  ...
  if ( (byte_4E07C31 & 1) == 0 )
  {
    ...
    sub_1CE6700(&MasterMissionReceiveResultListViewItem_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1CE6700(&StringLiteral_8632/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/);
    byte_4E07C31 = 1;
  }
  nameText = 0;
  entity = 0;
  ...
  if ( !Instance )
    goto LABEL_36;
  EventMissionList_43191332 = EventMissionMaster__getEventMissionList_43191332(
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_8632/*"MASTER_MISSION_RECEIVE_RESULT_REWARD_FMT"*/, 0);
  if ( !EventMissionList_43191332 )
    goto LABEL_36;
  max_length = EventMissionList_43191332->max_length;
  if ( max_length >= 1 )
  {
    ...
    v44 = EventMissionList_43191332;
    while ( 1 )
    {
      if ( v12 >= max_length )
LABEL_37:
        sub_1CE6960(Instance);
      v14 = EventMissionList_43191332->m_Items[v12];
      if ( !v14 )
        break;
      ...
      if ( v15 >= 1 )
      {
        ...
        do
        {
          ...
          Instance = (void *)Gift__IsItem_41568856(v18->fields.type, 0);
          ...
          v22 = System_String__Format_65164204(v11, v20, CountableString, v21, 0);
          itemList = (System_Collections_Generic_List_object__o *)this->fields.itemList;
          v24 = v22;
          v25 = sub_1CE694C(MasterMissionReceiveResultListViewItem_TypeInfo);
          ListViewItem___ctor_44921328((ListViewItem_o *)v25, v13 + v17, 0);
          *(_QWORD *)(v25 + 120) = v24;
          sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v25 + 120), (int32_t)v24, v26, v27, v28, v29, v30, v31);
          if ( !itemList )
            goto LABEL_36;
          ...
          else
          {
            ...
            sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v41 + 4), v25, v32, v33, v34, v35, v36, v37);
          }
          v15 = *((_DWORD *)v16 + 6);
          ++v17;
        }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07C32 & 1) == 0 )
  {
    this = (MasterMissionReceiveResultListViewManager_o *)sub_1CE6700(&MasterMissionReceiveResultListViewObject_TypeInfo);
    byte_4E07C32 = 1;
  }
  if ( !obj
