        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C80A & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_EventInfoSpotCooltimeRewardReceiveButton___c__CheckServantSpaceShortage_b__35_0__);
    sub_1B885B0(&EventInfoSpotCooltimeRewardReceiveButton___c_TypeInfo);
    byte_4A5C80A = 1;
  }
  ...
  if ( UserServantMaster__CheckServantAdd(v6, 1, 0LL) )
  {
    ...
    if ( SelfUserGame )
    {
      ...
      if ( !v11 )
      {
        ...
        sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__35_0, (int32_t)v11, v14, v15);
      }
      if ( v8 )
      {
        ...
        const MethodInfo *method)
{
  ...
  return NetworkManager__getTime_38478060(v3, 0LL) - 1;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C806 & 1) == 0 )
  {
    ...
    this = (EventInfoSpotCooltimeRewardReceiveButton_o *)sub_1B885B0(&UnityEngine_Object_TypeInfo);
    byte_4A5C806 = 1;
  }
  entity = 0LL;
  if ( !v2->fields.mode )
  ...
  Item = (__int64)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_UserEventCooltimeRewardMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( !userCooltimeRewardEntity || !cooltimeRewardEntity )
    sub_1B8880C(this, cooltimeRewardEntity);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C809 & 1) == 0 )
  {
    ...
    sub_1B885B0(&DataManager_TypeInfo);
    sub_1B885B0(&Method_System_Collections_Generic_List_int__get_Count__);
    this = (EventInfoSpotCooltimeRewardReceiveButton_o *)sub_1B885B0(&Method_System_Collections_Generic_List_int__get_Item__);
    byte_4A5C809 = 1;
  }
  entity = 0LL;
  if ( !v2->fields.baseSpotIdList )
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_EventCooltimeRewardMaster___);
  Item = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_UserEventCooltimeRewardMaster___);
  baseSpotIdList = v2->fields.baseSpotIdList;
  if ( !baseSpotIdList )
LABEL_17:
    sub_1B8880C(Item, v6);
  ...
  if ( size < 1 )
    return 0;
  v9 = (UserEventCooltimeRewardMaster_o *)Item;
  v10 = 0;
  while ( 1 )
  {
    ...
    if ( !v9 )
      goto LABEL_17;
    v11 = (int)Item;
    Item = UserEventCooltimeRewardMaster__GetCurrentLevelEntity(v9, v2->fields.eventId, (int32_t)Item, 0LL);
    if ( Item )
    {
      if ( !Master_object )
        goto LABEL_17;
      ...
      if ( ((unsigned __int8)Item & 1) != 0 )
      {
        ReceivedRewardUnitNum = (EventInfoSpotCooltimeRewardReceiveButton_o *)EventInfoSpotCooltimeRewardReceiveButton__GetReceivedRewardUnitNum(
                                                                                ...
                                                                                CurrentTime,
                                                                                v13);
        Item = (void *)EventInfoSpotCooltimeRewardReceiveButton__IsServantTypeReward(ReceivedRewardUnitNum, entity, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C7FE & 1) == 0 )
  {
    sub_1B885B0(&Method_DataManager_GetMaster_EventCooltimeRewardMaster___);
    sub_1B885B0(&DataManager_TypeInfo);
    sub_1B885B0(&StringLiteral_11375/*"RewardButtonBlink"*/);
    byte_4A5C7FE = 1;
  }
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.baseSpotIdList, (int32_t)SpotIdListByEventId, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C801 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_EventInfoSpotCooltimeRewardReceiveButton_OnClickButton__);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_EventInfoSpotCooltimeRewardReceiveButton___c__OnClickButton_b__21_0__);
    sub_1B885B0(&EventInfoSpotCooltimeRewardReceiveButton___c_TypeInfo);
    byte_4A5C801 = 1;
  }
  ...
  if ( this->fields.mode == 1 )
  {
    if ( v3 <= 1 )
    {
      ...
      if ( (*((_BYTE *)Method_EventInfoSpotCooltimeRewardReceiveButton_OnClickButton__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1B885C8(Method_EventInfoSpotCooltimeRewardReceiveButton_OnClickButton__);
...
LABEL_25:
    ...
    if ( (*((_BYTE *)Method_EventInfoSpotCooltimeRewardReceiveButton_OnClickButton__ + 83) & 2) != 0 )
      v20 = (_QWORD *)sub_1B885C8(Method_EventInfoSpotCooltimeRewardReceiveButton_OnClickButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v20, v20[4]);
    v21 = 2;
    goto LABEL_29;
  }
  if ( v3 > 1 )
...
LABEL_30:
  ...
  if ( (*((_BYTE *)Method_EventInfoSpotCooltimeRewardReceiveButton_OnClickButton__ + 83) & 2) != 0 )
    v12 = (_QWORD *)sub_1B885C8(Method_EventInfoSpotCooltimeRewardReceiveButton_OnClickButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v12, v12[4]);
  if ( v11 )
  {
    OverwriteAssetSoundName__PlaySystemSe(v6, 8, 0LL);
    ...
    if ( !monitor )
    {
      ...
      monitor = (System_Action_bool__o *)sub_1B887FC(System_Action_bool__TypeInfo);
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__21_0, (int32_t)monitor, v18, v19);
    }
    if ( v13 )
    {
...
LABEL_28:
  v21 = 0;
LABEL_29:
  OverwriteAssetSoundName__PlaySystemSe(v6, v21, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C807 & 1) == 0 )
  {
    sub_1B885B0(&Method_EventInfoSpotCooltimeRewardReceiveButton_Response__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C808 & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_EventInfoSpotCooltimeRewardReceiveButton___c__Response_b__31_0__);
    sub_1B885B0(&EventInfoSpotCooltimeRewardReceiveButton___c_TypeInfo);
  ...
  {
    v5 = (Il2CppObject *)System_String__Concat_61718292(
      ...
      if ( v9 && v9[2] )
      {
        ...
        if ( UnityEngine_Object__op_Inequality(rewardDialog, 0LL, 0LL) )
        {
          ...
          if ( (*((_BYTE *)Method_EventInfoSpotCooltimeRewardReceiveButton_Response__ + 83) & 2) != 0 )
            v11 = (_QWORD *)sub_1B885C8(Method_EventInfoSpotCooltimeRewardReceiveButton_Response__);
          v12 = (System_Reflection_MethodBase_o *)sub_1B88594(v11, v11[4]);
          v6 = (Il2CppObject ***)OverwriteAssetSoundName__PlaySe(v12, (System_String_o *)StringLiteral_16874/*"ar192"*/, 0LL);
          if ( *((_DWORD *)v8 + 6) )
          {
            v13 = v8[4];
            if ( !v13 )
            ...
            if ( !v16 )
            {
              ...
              sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__31_0, (int32_t)v16, v19, v20);
            }
            if ( !v14 )
LABEL_27:
              sub_1B8880C(v6, v7);
  ...
  if ( asset && !System_String__IsNullOrEmpty(prefabName, 0LL) )
  {
    ...
    if ( ((unsigned __int8)v10 & 1) == 0 )
    {
      if ( !Object_object__48635516 )
        goto LABEL_19;
      UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Object_object__48635516, 0, 0LL);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      ...
      *p_buttonEffectPrefab = (UnityEngine_Object_o *)v12;
      sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.buttonEffectPrefab, (int32_t)v12, v13, v14);
      if ( !UnityEngine_Object__op_Equality(*p_buttonEffectPrefab, 0LL, 0LL) )
      {
        v15 = this->fields.buttonEffectPrefab;
        gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
        GameObjectExtensions__SafeSetParent_33730068(v15, gameObject, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C800 & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_12199/*"SPOT_COOLTIME_REWARD_BUTTON_TEXT"*/);
    byte_4A5C800 = 1;
  }
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_12199/*"SPOT_COOLTIME_REWARD_BUTTON_TEXT"*/, 0LL);
  if ( !buttonTextLabel
    ...
    if ( !v10 )
    {
      if ( asset )
      {
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)dialogParent, 0LL, 0LL) )
          GameObjectExtensions__SafeSetParent_33730068((UnityEngine_GameObject_o *)v13, dialogParent, 0LL);
        ...
        if ( v13 )
        {
          ...
          sub_1B88554(p_rewardDialog, (int32_t)Component_object, v15, v16);
          return;
        }
      }
      sub_1B8880C(v10, v11);
...
LABEL_13:
    sub_1B8880C(receiveButton, *(_QWORD *)&state);
  }
...
void __fastcall EventInfoSpotCooltimeRewardReceiveButton___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(EventInfoSpotCooltimeRewardReceiveButton___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C80D & 1) == 0 )
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1B885B0(&Method_EventInfoSpotCooltimeRewardReceiveButton___c__DisplayClass35_0__CheckServantSpaceShortage_b__1__);
    sub_1B885B0(&EventInfoSpotCooltimeRewardReceiveButton___c__DisplayClass35_0_TypeInfo);
    byte_4A5C80D = 1;
  }
  v4 = sub_1B887FC(EventInfoSpotCooltimeRewardReceiveButton___c__DisplayClass35_0_TypeInfo);
