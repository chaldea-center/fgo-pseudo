...
void __fastcall SoundPlayerComponent__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A6BA82 & 1) == 0 )
  {
    sub_1B90010(&SoundPlayerComponent_TypeInfo, v1);
    byte_4A6BA82 = 1;
  }
...
void __fastcall SoundPlayerComponent__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A6BA83 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataManager_GetMasterData_BgmMaster___, v2);
    sub_1B90010(&Method_DataManager_GetMasterData_BgmReleaseMaster___, v3);
    sub_1B90010(&Method_DataManager_GetMasterData_ShopMaster___, v4);
    sub_1B90010(&Method_DataMasterBase_ShopMaster__ShopEntity__int__TryGetEntity__, v5);
    sub_1B90010(&Method_DataMasterBase_getEntitys_BgmEntity___, v6);
    ...
    sub_1B90010(&SoundPlayerComponent_TypeInfo, v13);
    sub_1B90010(&SoundPlayerMenu_TypeInfo, v14);
    sub_1B90010(&string___TypeInfo, v15);
    sub_1B90010(&StringLiteral_868/*","*/, v16);
    byte_4A6BA83 = 1;
  }
  entity = 0LL;
  Item = 0;
...
LABEL_37:
    ...
    v30 = sub_1B900B8(string___TypeInfo, (unsigned int)v29);
    ...
    if ( (int)v29 >= 1 )
    {
      ...
      do
      {
        ...
        sub_1B8FFB4(v33, (int32_t)Instance, v34, v35);
        ++v32;
        v33 = (ServantStatusBattleListViewItem_o *)((char *)v33 + 8);
      }
      while ( v29 != v32 );
    }
    v36 = System_String__Join((System_String_o *)StringLiteral_868/*","*/, v31, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BA84 & 1) == 0 )
  {
    sub_1B90010(&CondType_TypeInfo, *(_QWORD *)&kind);
    sub_1B90010(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, v5);
    sub_1B90010(&NetworkManager_TypeInfo, v6);
    releaseEntity = (BgmReleaseEntity_o *)sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v7);
    byte_4A6BA84 = 1;
  }
  if ( !v4 )
LABEL_27:
    sub_1B9026C(releaseEntity, *(_QWORD *)&kind);
  vals = v4->fields.vals;
  if ( !vals )
    return 0;
...
LABEL_30:
    sub_1B90274(releaseEntity, *(_QWORD *)&kind);
  ...
  while ( 1 )
  {
    ...
    if ( kind != 17 )
      break;
    releaseEntity = (BgmReleaseEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !releaseEntity )
      goto LABEL_27;
...
bool __fastcall SoundPlayerComponent__closeMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6BA86 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_SoundPlayerComponent_onClose__, v3);
    byte_4A6BA86 = 1;
  }
  ...
  if ( !soundPlayerMenu
    || (SoundPlayerMenu__hideMenu(soundPlayerMenu, method),
        (soundPlayerMenu = (SoundPlayerMenu_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0LL)) == 0LL) )
  {
    sub_1B9026C(soundPlayerMenu, method);
  }
...
void __fastcall SoundPlayerComponent__onEndMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6BA8A & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_3601/*"CLOSE_SOUND_PLAYER"*/, method);
    byte_4A6BA8A = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B9026C(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3601/*"CLOSE_SOUND_PLAYER"*/, 0LL);
}
...
bool __fastcall SoundPlayerComponent__openMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&Method_SoundPlayerComponent__openMenu_b__10_0__, v3);
    sub_1B90010(&Method_SoundPlayerComponent_onEndMenu__, v4);
    byte_4A6BA85 = 1;
  }
  ...
  if ( !titleInfo )
    goto LABEL_8;
  TitleInfoControl__changeTitleInfo_37240592((TitleInfoControl_o *)titleInfo, 1, 51, 0, 0LL);
