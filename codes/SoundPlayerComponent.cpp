...
void __fastcall SoundPlayerComponent__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B401B1 & 1) == 0 )
  {
    sub_1BDB878(&SoundPlayerComponent_TypeInfo, v1);
    byte_4B401B1 = 1;
  }
...
void __fastcall SoundPlayerComponent__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4B401B2 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_BgmMaster___, v2);
    sub_1BDB878(&Method_DataManager_GetMasterData_BgmReleaseMaster___, v3);
    sub_1BDB878(&Method_DataManager_GetMasterData_ShopMaster___, v4);
    sub_1BDB878(&Method_DataMasterBase_ShopMaster__ShopEntity__int__TryGetEntity__, v5);
    sub_1BDB878(&Method_DataMasterBase_BgmMaster__BgmEntity__int__getEntitys__, v6);
    ...
    sub_1BDB878(&SoundPlayerComponent_TypeInfo, v13);
    sub_1BDB878(&SoundPlayerMenu_TypeInfo, v14);
    sub_1BDB878(&string___TypeInfo, v15);
    sub_1BDB878(&StringLiteral_820/*","*/, v16);
    byte_4B401B2 = 1;
  }
  entity = 0LL;
  Item = 0;
  if ( SoundPlayerComponent_TypeInfo->static_fields->isContinueDevice )
  {
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        if ( v23 >= max_length )
LABEL_38:
          sub_1BDBADC(Instance, name_low, v21);
...
LABEL_37:
    ...
    v31 = sub_1BDB920(string___TypeInfo, (unsigned int)v30);
    ...
    if ( (int)v30 >= 1 )
    {
      ...
      do
      {
        ...
        sub_1BDB81C(v34, (int32_t)Instance, v21, v35);
        ++v33;
        v34 = (CGThumbnailListItem_o *)((char *)v34 + 8);
      }
      while ( v30 != v33 );
    }
    v36 = System_String__Join((System_String_o *)StringLiteral_820/*","*/, v32, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B401B3 & 1) == 0 )
  {
    sub_1BDB878(&CondType_TypeInfo, *(_QWORD *)&kind);
    sub_1BDB878(&Method_DataManager_GetMasterData_UserServantCollectionMaster___, v5);
    sub_1BDB878(&NetworkManager_TypeInfo, v6);
    releaseEntity = (BgmReleaseEntity_o *)sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v7);
    byte_4B401B3 = 1;
  }
  if ( !v4 )
LABEL_31:
    sub_1BDBAD4(releaseEntity, *(_QWORD *)&kind);
  vals = v4->fields.vals;
  if ( !vals )
    return 0;
...
LABEL_34:
    sub_1BDBADC(releaseEntity, *(_QWORD *)&kind, method);
  ...
  while ( 1 )
  {
    ...
    if ( kind != 17 )
      break;
    releaseEntity = (BgmReleaseEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !releaseEntity )
      goto LABEL_31;
...
bool __fastcall SoundPlayerComponent__closeMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B401B5 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_SoundPlayerComponent_onClose__, v3);
    byte_4B401B5 = 1;
  }
  ...
  if ( !soundPlayerMenu
    || (SoundPlayerMenu__hideMenu(soundPlayerMenu, method),
        (soundPlayerMenu = (SoundPlayerMenu_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0LL)) == 0LL) )
  {
    sub_1BDBAD4(soundPlayerMenu, method);
  }
...
void __fastcall SoundPlayerComponent__onEndMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B401B9 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_3551/*"CLOSE_SOUND_PLAYER"*/, method);
    byte_4B401B9 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1BDBAD4(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3551/*"CLOSE_SOUND_PLAYER"*/, 0LL);
}
...
bool __fastcall SoundPlayerComponent__openMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&System_Action_TypeInfo, method);
    sub_1BDB878(&Method_SoundPlayerComponent__openMenu_b__10_0__, v3);
    sub_1BDB878(&Method_SoundPlayerComponent_onEndMenu__, v4);
    byte_4B401B4 = 1;
  }
  ...
  if ( !titleInfo )
    goto LABEL_8;
  TitleInfoControl__changeTitleInfo_38893964((TitleInfoControl_o *)titleInfo, 1, 54, 0, 0LL);
