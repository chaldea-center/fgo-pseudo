...
void SoundPlayerComponent__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  if ( (byte_4C5244D & 1) == 0 )
  {
    sub_1C3E564(&SoundPlayerComponent_TypeInfo);
    byte_4C5244D = 1;
  }
...
LABEL_37:
    ...
    v14 = sub_1C3E60C(string___TypeInfo, (unsigned int)v13);
    v15 = v14;
    if ( (int)v13 >= 1 )
    {
      v16 = 0;
      ...
      do
      {
        ...
        sub_1C3E508(v17, (int32_t)Instance, v18, v19);
        ++v16;
        v17 = (CGThumbnailListItem_o *)((char *)v17 + 8);
      }
      while ( v13 != v16 );
    }
    v20 = System_String__Join((System_String_o *)StringLiteral_811/*","*/, (System_String_array *)v15, 0);
...
bool SoundPlayerComponent__checkOpen(BgmReleaseEntity_o *releaseEntity, int32_t kind, const MethodInfo *method)
{
  ...
  if ( (byte_4C5244F & 1) == 0 )
  {
    ...
    releaseEntity = (BgmReleaseEntity_o *)sub_1C3E564(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C5244F = 1;
  }
  if ( !v4 )
LABEL_31:
    sub_1C3E7C0(releaseEntity, *(_QWORD *)&kind);
  vals = v4->fields.vals;
  if ( !vals )
    return 0;
...
LABEL_34:
    sub_1C3E7C8(releaseEntity, *(_QWORD *)&kind);
  ...
  while ( 1 )
  {
    ...
    if ( kind != 17 )
      break;
    releaseEntity = (BgmReleaseEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !releaseEntity )
      goto LABEL_31;
...
bool SoundPlayerComponent__closeMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52451 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SoundPlayerComponent_onClose__);
    byte_4C52451 = 1;
  }
  ...
  if ( !soundPlayerMenu
    || (SoundPlayerMenu__hideMenu(soundPlayerMenu, method),
        (soundPlayerMenu = (SoundPlayerMenu_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0)) == 0) )
  {
    sub_1C3E7C0(soundPlayerMenu, method);
  }
...
bool SoundPlayerComponent__openMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_SoundPlayerComponent__openMenu_b__10_0__);
    sub_1C3E564(&Method_SoundPlayerComponent_onEndMenu__);
    byte_4C52450 = 1;
  }
  ...
  if ( !titleInfo )
    goto LABEL_8;
  TitleInfoControl__changeTitleInfo_39891972((TitleInfoControl_o *)titleInfo, 1, 54, 0, 0);
