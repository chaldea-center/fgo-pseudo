...
LABEL_46:
    ...
    v12 = sub_B5299C(string___TypeInfo, (unsigned int)size);
    ...
    if ( size >= 1 )
    {
      ...
      do
      {
        ...
        sub_B52920(v16, v23, v17, v18, v19, v20, v21, v22);
        ++v14;
        v16 = (BattleServantConfConponent_o *)((char *)v16 + 8);
      }
      while ( (__int64)v14 < v15 );
    }
    v24 = System_String__Join((System_String_o *)StringLiteral_709/*","*/, v13, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF453 & 1) == 0 )
  {
    ...
    releaseEntity = (BgmReleaseEntity_o *)sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_42AF453 = 1;
  }
  if ( !v4 )
LABEL_29:
    sub_B52A5C(releaseEntity, *(_QWORD *)&kind);
  vals = v4->fields.vals;
  if ( !vals )
    return 0;
...
LABEL_32:
  ...
  while ( 1 )
  {
    ...
    if ( kind != 17 )
      break;
    releaseEntity = (BgmReleaseEntity_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !releaseEntity )
      goto LABEL_29;
...
bool __fastcall SoundPlayerComponent__closeMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF455 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SoundPlayerComponent_onClose__);
    byte_42AF455 = 1;
  }
  ...
  if ( !soundPlayerMenu
    || (SoundPlayerMenu__hideMenu(soundPlayerMenu, method),
        (soundPlayerMenu = (SoundPlayerMenu_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0LL)) == 0LL) )
  {
    sub_B52A5C(soundPlayerMenu, method);
  }
...
void __fastcall SoundPlayerComponent__onEndMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !myRoomFsm )
    sub_B52A5C(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3140/*"CLOSE_SOUND_PLAYER"*/, 0LL);
}
...
bool __fastcall SoundPlayerComponent__openMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&System_Action_TypeInfo);
    sub_B52984(&Method_SoundPlayerComponent__openMenu_b__10_0__);
    sub_B52984(&Method_SoundPlayerComponent_onEndMenu__);
    byte_42AF454 = 1;
  }
  ...
  if ( !titleInfo )
    goto LABEL_8;
  TitleInfoControl__changeTitleInfo_18255196((TitleInfoControl_o *)titleInfo, 1, 51, 0, 0LL);
