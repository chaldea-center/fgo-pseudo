...
void SoundPlayerComponent__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  if ( (byte_4DFFFB3 & 1) == 0 )
  {
    sub_1CE6700(&SoundPlayerComponent_TypeInfo);
    byte_4DFFFB3 = 1;
  }
...
LABEL_37:
    ...
    v14 = sub_1CE67A8(string___TypeInfo, (unsigned int)v13);
    v15 = v14;
    if ( (int)v13 >= 1 )
    {
      v16 = 0;
      ...
      do
      {
        ...
        sub_1CE66A4(v17, (int32_t)Instance, v18, v19, v20, v21, v22, v23);
        ++v16;
        v17 = (GrandQuestFolderBoardItem_o *)((char *)v17 + 8);
      }
      while ( v13 != v16 );
    }
    v24 = System_String__Join((System_String_o *)StringLiteral_810/*","*/, (System_String_array *)v15, 0);
...
bool SoundPlayerComponent__checkOpen(BgmReleaseEntity_o *releaseEntity, int32_t kind, const MethodInfo *method)
{
  ...
  if ( (byte_4DFFFB5 & 1) == 0 )
  {
    ...
    releaseEntity = (BgmReleaseEntity_o *)sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4DFFFB5 = 1;
  }
  if ( !v4 )
LABEL_31:
    sub_1CE6958(releaseEntity, *(_QWORD *)&kind);
  vals = v4->fields.vals;
  if ( !vals )
    return 0;
...
LABEL_34:
  ...
  while ( 1 )
  {
    ...
    if ( kind != 17 )
      break;
    releaseEntity = (BgmReleaseEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !releaseEntity )
      goto LABEL_31;
...
bool SoundPlayerComponent__closeMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFFFB7 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SoundPlayerComponent_onClose__);
    byte_4DFFFB7 = 1;
  }
  ...
  if ( !soundPlayerMenu
    || (SoundPlayerMenu__hideMenu(soundPlayerMenu, method),
        (soundPlayerMenu = (SoundPlayerMenu_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0)) == 0) )
  {
    sub_1CE6958(soundPlayerMenu, method);
  }
...
void SoundPlayerComponent__onEndMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !myRoomFsm )
    sub_1CE6958(0, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3547/*"CLOSE_SOUND_PLAYER"*/, 0);
}
...
bool SoundPlayerComponent__openMenu(SoundPlayerComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_SoundPlayerComponent__openMenu_b__10_0__);
    sub_1CE6700(&Method_SoundPlayerComponent_onEndMenu__);
    byte_4DFFFB6 = 1;
  }
  ...
  if ( !titleInfo )
    goto LABEL_8;
  TitleInfoControl__changeTitleInfo_41045104((TitleInfoControl_o *)titleInfo, 1, 55, 0, 0);
