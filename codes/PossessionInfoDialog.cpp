void __fastcall PossessionInfoDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FAD4F & 1) == 0 )
  {
    sub_1B64870(&PossessionInfoDialog_TypeInfo, v1);
    byte_49FAD4F = 1;
  }
...
void __fastcall PossessionInfoDialog___ctor(PossessionInfoDialog_o *this, const MethodInfo *method)
{
  ...
  v5 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_GameObject__TypeInfo);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.objectList, (int32_t)v5, v6, v7);
...
void __fastcall PossessionInfoDialog__Init(PossessionInfoDialog_o *this, int32_t gachaId, const MethodInfo *method)
{
  ...
  if ( (byte_49FAD4B & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UIGrid___, *(_QWORD *)&gachaId);
    sub_1B64870(&Method_DataManager_GetMaster_ServantMaster___, v5);
    sub_1B64870(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v6);
    sub_1B64870(&Method_DataManager_GetMaster_ViewGachaFeaturedServantMaster___, v7);
    sub_1B64870(&DataManager_TypeInfo, v8);
    sub_1B64870(&Method_System_Linq_Enumerable_OrderBy_int__bool___, v9);
    sub_1B64870(&Method_System_Linq_Enumerable_ThenBy_int__int___, v10);
    sub_1B64870(&System_Func_int__int__TypeInfo, v11);
    sub_1B64870(&System_Func_int__bool__TypeInfo, v12);
    sub_1B64870(&System_IDisposable_TypeInfo, v13);
    sub_1B64870(&System_Collections_Generic_IEnumerable_int__TypeInfo, v14);
    sub_1B64870(&System_Collections_Generic_IEnumerator_int__TypeInfo, v15);
    sub_1B64870(&System_Collections_IEnumerator_TypeInfo, v16);
    sub_1B64870(&Method_System_Collections_Generic_List_GameObject__Add__, v17);
    sub_1B64870(&LocalizationManager_TypeInfo, v18);
    sub_1B64870(&Method_UnityEngine_Object_Instantiate_PossessionInfo___, v19);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v20);
    sub_1B64870(&PossessionInfoDialog_TypeInfo, v21);
    sub_1B64870(&Method_PossessionInfoDialog___c__DisplayClass7_0__Init_b__0__, v22);
    sub_1B64870(&Method_PossessionInfoDialog___c__DisplayClass7_0__Init_b__1__, v23);
    sub_1B64870(&PossessionInfoDialog___c__DisplayClass7_0_TypeInfo, v24);
    sub_1B64870(&StringLiteral_15577/*"Window/CloseButton"*/, v25);
    sub_1B64870(&StringLiteral_10355/*"POSSESSION_DIALOG_TITLE"*/, v26);
    sub_1B64870(&StringLiteral_10354/*"POSSESSION_DIALOG_MESSAGE"*/, v27);
    byte_49FAD4B = 1;
  }
  v28 = sub_1B64ABC(PossessionInfoDialog___c__DisplayClass7_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v28, 0LL);
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  AndroidBackKeyManager__AddBackKeyTarget_41452836(transform, (System_String_o *)StringLiteral_15577/*"Window/CloseButton"*/, 0LL);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ViewGachaFeaturedServantMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_ViewGachaFeaturedServantMaster___);
  if ( !Master_object )
    goto LABEL_63;
  ...
  if ( v33->static_fields->DISPLAY_LIMIT_NUM >= (signed int)FeaturedServantIds->max_length )
  {
    ...
    Master_object = (ViewGachaFeaturedServantMaster_o *)LocalizationManager__Get(
                                                          (System_String_o *)StringLiteral_10355/*"POSSESSION_DIALOG_TITLE"*/,
                                                          0LL);
    if ( titleLabel )
    {
      ...
      Master_object = (ViewGachaFeaturedServantMaster_o *)LocalizationManager__Get(
                                                            (System_String_o *)StringLiteral_10354/*"POSSESSION_DIALOG_MESSAGE"*/,
                                                            0LL);
      if ( messageLabel )
      {
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Master_object = (ViewGachaFeaturedServantMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_ServantMaster___);
        if ( v28 )
        {
          *(_QWORD *)(v28 + 24) = Master_object;
          sub_1B64814((ServantStatusBattleListViewItem_o *)(v28 + 24), (int32_t)Master_object, v36, v37);
          v38 = DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
          *(_QWORD *)(v28 + 16) = v38;
          sub_1B64814((ServantStatusBattleListViewItem_o *)(v28 + 16), (int32_t)v38, v39, v40);
          ...
          v42 = System_Linq_Enumerable__OrderBy_int__bool_(
                  ...
                  (const MethodInfo_2E65114 *)Method_System_Linq_Enumerable_OrderBy_int__bool___);
          v43 = (System_Func_int__int__o *)sub_1B64ABC(System_Func_int__int__TypeInfo);
          ...
          Master_object = (ViewGachaFeaturedServantMaster_o *)System_Linq_Enumerable__ThenBy_int__int_(
                                                                ...
                                                                (const MethodInfo_2E72A68 *)Method_System_Linq_Enumerable_ThenBy_int__int___);
          if ( Master_object )
          {
            ...
            {
LABEL_23:
              v48 = sub_1BB6850(Master_object, System_Collections_Generic_IEnumerable_int__TypeInfo, 0LL);
            }
            ...
            while ( 1 )
            {
              ...
              {
LABEL_30:
                v54 = sub_1BB6850(v50, System_Collections_IEnumerator_TypeInfo, 0LL);
              }
              ...
              {
LABEL_37:
                v58 = sub_1BB6850(v50, System_Collections_Generic_IEnumerator_int__TypeInfo, 0LL);
              }
              ...
              v64 = UnityEngine_Object__Instantiate_object__49012904(
                      possessionInfoObject,
                      v63,
                      (const MethodInfo_2EBE0A8 *)Method_UnityEngine_Object_Instantiate_PossessionInfo___);
              ...
              v71 = gameObject;
              if ( !objectList )
                sub_1B64ACC(gameObject, gameObject);
              ...
              else
              {
                ...
                sub_1B64814((ServantStatusBattleListViewItem_o *)(v75 + 4), (int32_t)v71, v69, v70);
              }
            ...
            {
LABEL_53:
              v80 = sub_1BB6850(v50, System_IDisposable_TypeInfo, 0LL);
            }
...
void __fastcall PossessionInfoDialog__OnClickClose(PossessionInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FAD4D & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_GameObject__ForEach__, v3);
    sub_1B64870(&Method_PossessionInfoDialog_OnClickClose__, v4);
    sub_1B64870(&Method_PossessionInfoDialog___c__OnClickClose_b__10_0__, v5);
    sub_1B64870(&PossessionInfoDialog___c_TypeInfo, v6);
    byte_49FAD4D = 1;
  }
  v7 = Method_PossessionInfoDialog_OnClickClose__;
  if ( (*((_BYTE *)Method_PossessionInfoDialog_OnClickClose__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B64888(Method_PossessionInfoDialog_OnClickClose__);
  ...
  if ( !_9__10_0 )
  {
    ...
    _9__10_0 = (System_Action_object__o *)sub_1B64ABC(System_Action_GameObject__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__10_0, (int32_t)_9__10_0, v15, v16);
  }
  if ( !objectList )
    sub_1B64ACC(v10, v9);
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_34B0490 *)Method_System_Collections_Generic_List_GameObject__ForEach__);
...
void __fastcall PossessionInfoDialog__Open(PossessionInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FAD4C & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_PossessionInfoDialog__Open_b__9_0__, v3);
    byte_49FAD4C = 1;
  }
...
void __fastcall PossessionInfoDialog___Open_b__9_0(PossessionInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FAD50 & 1) == 0 )
  {
    sub_1B64870(&System_Action_GameObject__TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_List_GameObject__ForEach__, v3);
    sub_1B64870(&Method_PossessionInfoDialog___c__Open_b__9_1__, v4);
    sub_1B64870(&PossessionInfoDialog___c_TypeInfo, v5);
    byte_49FAD50 = 1;
  }
  ...
  if ( !_9__9_1 )
  {
    ...
    _9__9_1 = (System_Action_object__o *)sub_1B64ABC(System_Action_GameObject__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__9_1, (int32_t)_9__9_1, v11, v12);
  }
  if ( !objectList )
...
void __fastcall PossessionInfoDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FAD51 & 1) == 0 )
  {
    sub_1B64870(&PossessionInfoDialog___c_TypeInfo, v1);
    byte_49FAD51 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(PossessionInfoDialog___c_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)obj, 0LL, 0LL) )
  {
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_69135916((UnityEngine_Object_o *)obj, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD54 & 1) == 0 )
  {
    sub_1B64870(&int___TypeInfo, *(_QWORD *)&id);
    byte_49FAD54 = 1;
  }
  userServantCollectionMaster = this->fields.userServantCollectionMaster;
  v6 = (System_Int32_array *)sub_1B64918(int___TypeInfo, 1LL);
  if ( !v6 )
    goto LABEL_7;
  v7 = v6;
  if ( !v6->max_length )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD55 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_ServantMaster__ServantEntity__int__GetEntity__, *(_QWORD *)&id);
    byte_49FAD55 = 1;
  }
  ...
  {
    sub_1B64ACC(svtMaster, *(_QWORD *)&id);
  }
