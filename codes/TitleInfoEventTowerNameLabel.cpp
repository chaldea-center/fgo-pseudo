void TitleInfoEventTowerNameLabel___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB4C4A & 1) == 0 )
  {
    sub_1C6BA08(&TitleInfoEventTowerNameLabel_TypeInfo);
    sub_1C6BA08(&StringLiteral_24242/*"tower_img_title{0:00}"*/);
    byte_4CB4C4A = 1;
  }
  TitleInfoEventTowerNameLabel_TypeInfo->static_fields->SPRITE_NAME_NAME = (struct System_String_o *)StringLiteral_24242/*"tower_img_title{0:00}"*/;
  sub_1C6B9AC(
    (CGThumbnailListItem_o *)TitleInfoEventTowerNameLabel_TypeInfo->static_fields,
    StringLiteral_24242/*"tower_img_title{0:00}"*/,
    v1,
    v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB4C49 & 1) == 0 )
  {
    sub_1C6BA08(&Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerData___);
    sub_1C6BA08(&Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerEventInfo___);
    sub_1C6BA08(&System_Func_TitleInfoEventTowerNameLabel_TowerData__bool__TypeInfo);
    sub_1C6BA08(&System_Func_TitleInfoEventTowerNameLabel_TowerEventInfo__bool__TypeInfo);
    sub_1C6BA08(&Method_TitleInfoEventTowerNameLabel___c__DisplayClass7_0__GetTowerData_b__0__);
    sub_1C6BA08(&Method_TitleInfoEventTowerNameLabel___c__DisplayClass7_0__GetTowerData_b__1__);
    sub_1C6BA08(&TitleInfoEventTowerNameLabel___c__DisplayClass7_0_TypeInfo);
    byte_4CB4C49 = 1;
  }
  v7 = sub_1C6BC54(TitleInfoEventTowerNameLabel___c__DisplayClass7_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 20) = towerId;
  ...
  v11 = (System_Func_object__bool__o *)sub_1C6BC54(System_Func_TitleInfoEventTowerNameLabel_TowerEventInfo__bool__TypeInfo);
  ...
  result = (TitleInfoEventTowerNameLabel_TowerData_o *)BasicHelper__Find_object_(
                                                         ...
                                                         (const MethodInfo_3124FFC *)Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerEventInfo___);
  if ( result )
  {
    v13 = *(System_Object_array **)&result->fields.NamePosition.fields.y;
    v14 = (System_Func_object__bool__o *)sub_1C6BC54(System_Func_TitleInfoEventTowerNameLabel_TowerData__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v14,
      (Il2CppObject *)v7,
    ...
    return (TitleInfoEventTowerNameLabel_TowerData_o *)BasicHelper__Find_object_(
                                                         ...
                                                         (const MethodInfo_3124FFC *)Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerData___);
  }
  return result;
}
