void __fastcall TitleInfoEventTowerNameLabel___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6E89A & 1) == 0 )
  {
    sub_1B90010(&TitleInfoEventTowerNameLabel_TypeInfo, v1);
    sub_1B90010(&StringLiteral_24045/*"tower_img_title{0:00}"*/, v4);
    byte_4A6E89A = 1;
  }
  TitleInfoEventTowerNameLabel_TypeInfo->static_fields->SPRITE_NAME_NAME = (struct System_String_o *)StringLiteral_24045/*"tower_img_title{0:00}"*/;
  sub_1B8FFB4(
    (ServantStatusBattleListViewItem_o *)TitleInfoEventTowerNameLabel_TypeInfo->static_fields,
    StringLiteral_24045/*"tower_img_title{0:00}"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6E899 & 1) == 0 )
  {
    sub_1B90010(&Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerData___, *(_QWORD *)&eventId);
    sub_1B90010(&Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerEventInfo___, v7);
    sub_1B90010(&System_Func_TitleInfoEventTowerNameLabel_TowerData__bool__TypeInfo, v8);
    sub_1B90010(&System_Func_TitleInfoEventTowerNameLabel_TowerEventInfo__bool__TypeInfo, v9);
    sub_1B90010(&Method_TitleInfoEventTowerNameLabel___c__DisplayClass7_0__GetTowerData_b__0__, v10);
    sub_1B90010(&Method_TitleInfoEventTowerNameLabel___c__DisplayClass7_0__GetTowerData_b__1__, v11);
    sub_1B90010(&TitleInfoEventTowerNameLabel___c__DisplayClass7_0_TypeInfo, v12);
    byte_4A6E899 = 1;
  }
  v13 = sub_1B9025C(TitleInfoEventTowerNameLabel___c__DisplayClass7_0_TypeInfo);
  ...
  *(_DWORD *)(v13 + 20) = towerId;
  ...
  v17 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_TitleInfoEventTowerNameLabel_TowerEventInfo__bool__TypeInfo);
  ...
  result = (TitleInfoEventTowerNameLabel_TowerData_o *)BasicHelper__Find_object_(
                                                         ...
                                                         (const MethodInfo_2E7A1B0 *)Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerEventInfo___);
  if ( result )
  {
    v19 = *(System_Object_array **)&result->fields.NamePosition.fields.y;
    v20 = (System_Func_object__bool__o *)sub_1B9025C(System_Func_TitleInfoEventTowerNameLabel_TowerData__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v20,
      (Il2CppObject *)v13,
    ...
    return (TitleInfoEventTowerNameLabel_TowerData_o *)BasicHelper__Find_object_(
                                                         ...
                                                         (const MethodInfo_2E7A1B0 *)Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerData___);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6E898 & 1) == 0 )
  {
    ...
    sub_1B90010(&TitleInfoEventTowerNameLabel_TypeInfo, v9);
    byte_4A6E898 = 1;
  }
