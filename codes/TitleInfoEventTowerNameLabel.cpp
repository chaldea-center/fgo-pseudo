void __fastcall TitleInfoEventTowerNameLabel___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDAFD0 & 1) == 0 )
  {
    sub_1C21E38(&TitleInfoEventTowerNameLabel_TypeInfo);
    sub_1C21E38(&StringLiteral_24438/*"tower_img_title{0:00}"*/);
    byte_4BDAFD0 = 1;
  }
  TitleInfoEventTowerNameLabel_TypeInfo->static_fields->SPRITE_NAME_NAME = (struct System_String_o *)StringLiteral_24438/*"tower_img_title{0:00}"*/;
  sub_1C21DDC(
    (PartyOrganizationUtility_o *)TitleInfoEventTowerNameLabel_TypeInfo->static_fields,
    StringLiteral_24438/*"tower_img_title{0:00}"*/,
    v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDAFCF & 1) == 0 )
  {
    sub_1C21E38(&Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerData___);
    sub_1C21E38(&Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerEventInfo___);
    sub_1C21E38(&System_Func_TitleInfoEventTowerNameLabel_TowerData__bool__TypeInfo);
    sub_1C21E38(&System_Func_TitleInfoEventTowerNameLabel_TowerEventInfo__bool__TypeInfo);
    sub_1C21E38(&Method_TitleInfoEventTowerNameLabel___c__DisplayClass7_0__GetTowerData_b__0__);
    sub_1C21E38(&Method_TitleInfoEventTowerNameLabel___c__DisplayClass7_0__GetTowerData_b__1__);
    sub_1C21E38(&TitleInfoEventTowerNameLabel___c__DisplayClass7_0_TypeInfo);
    byte_4BDAFCF = 1;
  }
  v7 = sub_1C22084(TitleInfoEventTowerNameLabel___c__DisplayClass7_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 20) = towerId;
  ...
  v11 = (System_Func_object__bool__o *)sub_1C22084(System_Func_TitleInfoEventTowerNameLabel_TowerEventInfo__bool__TypeInfo);
  ...
  result = (TitleInfoEventTowerNameLabel_TowerData_o *)BasicHelper__Find_object_(
                                                         ...
                                                         (const MethodInfo_2F9B93C *)Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerEventInfo___);
  if ( result )
  {
    v13 = *(System_Object_array **)&result->fields.NamePosition.fields.y;
    v14 = (System_Func_object__bool__o *)sub_1C22084(System_Func_TitleInfoEventTowerNameLabel_TowerData__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v14,
      (Il2CppObject *)v7,
    ...
    return (TitleInfoEventTowerNameLabel_TowerData_o *)BasicHelper__Find_object_(
                                                         ...
                                                         (const MethodInfo_2F9B93C *)Method_BasicHelper_Find_TitleInfoEventTowerNameLabel_TowerData___);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  v19 = System_String__Format(SPRITE_NAME_NAME, v18, 0LL);
