...
void __fastcall FriendWarningDialog__Close(FriendWarningDialog_o *this, const MethodInfo *method)
{
  ...
  FriendWarningDialog__Close_31026188(this, 0LL, v2);
}


void __fastcall FriendWarningDialog__Close_31026188(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5EEC & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_FriendWarningDialog_EndClose__, v5);
    byte_49B5EEC = 1;
  }
...
void __fastcall FriendWarningDialog__OnClickClose(FriendWarningDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B5EED & 1) == 0 )
  {
    sub_1B4CF90(&Method_FriendWarningDialog_OnClickClose__, method);
    byte_49B5EED = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendWarningDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B4CFA8(Method_FriendWarningDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5EEB & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMasterData_TblFriendMaster___, v8);
    sub_1B4CF90(&Method_DataManager_GetMasterData_UserFollowMaster___, v9);
    sub_1B4CF90(&Method_FriendWarningDialog_EndOpen__, v10);
    ...
    sub_1B4CF90(&StringLiteral_6428/*"FRIEND_NO_FRIEND_MESSAGE"*/, v14);
    sub_1B4CF90(&StringLiteral_6432/*"FRIEND_NO_OFFER_MESSAGE"*/, v15);
    sub_1B4CF90(&StringLiteral_6427/*"FRIEND_NO_FRIEND_CLOSE"*/, v16);
    sub_1B4CF90(&StringLiteral_6435/*"FRIEND_NO_STRING_CLOSE"*/, v17);
    sub_1B4CF90(&StringLiteral_6425/*"FRIEND_MAX_FRIEND_CLOSE"*/, v18);
    sub_1B4CF90(&StringLiteral_6436/*"FRIEND_NO_STRING_MESSAGE"*/, v19);
    sub_1B4CF90(&StringLiteral_6426/*"FRIEND_MAX_FRIEND_MESSAGE"*/, v20);
    sub_1B4CF90(&StringLiteral_6429/*"FRIEND_NO_OFFERED_CLOSE"*/, v21);
    sub_1B4CF90(&StringLiteral_6358/*"FOLLOW_MAX_CLOSE"*/, v22);
    sub_1B4CF90(&StringLiteral_6431/*"FRIEND_NO_OFFER_CLOSE"*/, v23);
    sub_1B4CF90(&StringLiteral_6434/*"FRIEND_NO_SEARCH_MESSAGE"*/, v24);
    sub_1B4CF90(&StringLiteral_6433/*"FRIEND_NO_SEARCH_CLOSE"*/, v25);
    sub_1B4CF90(&StringLiteral_6359/*"FOLLOW_MAX_MESSAGE"*/, v26);
    sub_1B4CF90(&StringLiteral_6430/*"FRIEND_NO_OFFERED_MESSAGE"*/, v27);
    byte_49B5EEB = 1;
  }
  if ( !this->fields.state )
  {
    ...
    switch ( kind )
    {
      case 1:
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6426/*"FRIEND_MAX_FRIEND_MESSAGE"*/, 0LL);
        if ( !v33 )
          goto LABEL_46;
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format_61134760(v37, v41, v42, 0LL);
        if ( !messageLabel )
          goto LABEL_46;
        UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6425/*"FRIEND_MAX_FRIEND_CLOSE"*/;
        break;
      case 2:
        v45 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6434/*"FRIEND_NO_SEARCH_MESSAGE"*/, 0LL);
        if ( !v45 )
          goto LABEL_46;
        UILabel__set_text(v45, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6433/*"FRIEND_NO_SEARCH_CLOSE"*/;
        break;
      case 3:
        v46 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6436/*"FRIEND_NO_STRING_MESSAGE"*/, 0LL);
        if ( !v46 )
          goto LABEL_46;
        UILabel__set_text(v46, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6435/*"FRIEND_NO_STRING_CLOSE"*/;
        break;
      case 4:
        v47 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6432/*"FRIEND_NO_OFFER_MESSAGE"*/, 0LL);
        if ( !v47 )
          goto LABEL_46;
        UILabel__set_text(v47, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6431/*"FRIEND_NO_OFFER_CLOSE"*/;
        break;
      case 5:
        v48 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6430/*"FRIEND_NO_OFFERED_MESSAGE"*/, 0LL);
        if ( !v48 )
          goto LABEL_46;
        UILabel__set_text(v48, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6429/*"FRIEND_NO_OFFERED_CLOSE"*/;
        break;
      case 6:
        v49 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6428/*"FRIEND_NO_FRIEND_MESSAGE"*/, 0LL);
        if ( !v49 )
          goto LABEL_46;
        UILabel__set_text(v49, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6427/*"FRIEND_NO_FRIEND_CLOSE"*/;
        break;
      case 7:
        gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !gameObject )
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6359/*"FOLLOW_MAX_MESSAGE"*/, 0LL);
        if ( !v52 )
          goto LABEL_46;
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format_61134760(v53, v60, v62, 0LL);
        if ( !v51 )
          goto LABEL_46;
        UILabel__set_text(v51, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6358/*"FOLLOW_MAX_CLOSE"*/;
        break;
      default:
        goto LABEL_44;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5EE8 & 1) == 0 )
  {
    sub_1B4CF90(&FriendWarningDialog_CallbackFunc_TypeInfo, value);
    byte_49B5EE8 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (FriendWarningDialog_o *)sub_1B4D4AC(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1994CF8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1994CB0;
}
