...
void __fastcall FriendWarningDialog__Close(FriendWarningDialog_o *this, const MethodInfo *method)
{
  ...
  FriendWarningDialog__Close_30993108(this, 0LL, v2);
}


void __fastcall FriendWarningDialog__Close_30993108(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2A6 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_FriendWarningDialog_EndClose__, v5);
    byte_4A6B2A6 = 1;
  }
...
void __fastcall FriendWarningDialog__OnClickClose(FriendWarningDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2A7 & 1) == 0 )
  {
    sub_1B90010(&Method_FriendWarningDialog_OnClickClose__, method);
    byte_4A6B2A7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2A5 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataManager_GetMasterData_TblFriendMaster___, v8);
    sub_1B90010(&Method_DataManager_GetMasterData_UserFollowMaster___, v9);
    sub_1B90010(&Method_FriendWarningDialog_EndOpen__, v10);
    ...
    sub_1B90010(&StringLiteral_6508/*"FRIEND_NO_FRIEND_MESSAGE"*/, v14);
    sub_1B90010(&StringLiteral_6512/*"FRIEND_NO_OFFER_MESSAGE"*/, v15);
    sub_1B90010(&StringLiteral_6507/*"FRIEND_NO_FRIEND_CLOSE"*/, v16);
    sub_1B90010(&StringLiteral_6515/*"FRIEND_NO_STRING_CLOSE"*/, v17);
    sub_1B90010(&StringLiteral_6505/*"FRIEND_MAX_FRIEND_CLOSE"*/, v18);
    sub_1B90010(&StringLiteral_6516/*"FRIEND_NO_STRING_MESSAGE"*/, v19);
    sub_1B90010(&StringLiteral_6506/*"FRIEND_MAX_FRIEND_MESSAGE"*/, v20);
    sub_1B90010(&StringLiteral_6509/*"FRIEND_NO_OFFERED_CLOSE"*/, v21);
    sub_1B90010(&StringLiteral_6438/*"FOLLOW_MAX_CLOSE"*/, v22);
    sub_1B90010(&StringLiteral_6511/*"FRIEND_NO_OFFER_CLOSE"*/, v23);
    sub_1B90010(&StringLiteral_6514/*"FRIEND_NO_SEARCH_MESSAGE"*/, v24);
    sub_1B90010(&StringLiteral_6513/*"FRIEND_NO_SEARCH_CLOSE"*/, v25);
    sub_1B90010(&StringLiteral_6439/*"FOLLOW_MAX_MESSAGE"*/, v26);
    sub_1B90010(&StringLiteral_6510/*"FRIEND_NO_OFFERED_MESSAGE"*/, v27);
    byte_4A6B2A5 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    switch ( kind )
    {
      case 1:
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6506/*"FRIEND_MAX_FRIEND_MESSAGE"*/, 0LL);
        if ( !v33 )
          goto LABEL_46;
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format_61801464(v37, v41, v42, 0LL);
        if ( !messageLabel )
          goto LABEL_46;
        UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6505/*"FRIEND_MAX_FRIEND_CLOSE"*/;
        break;
      case 2:
        v45 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6514/*"FRIEND_NO_SEARCH_MESSAGE"*/, 0LL);
        if ( !v45 )
          goto LABEL_46;
        UILabel__set_text(v45, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6513/*"FRIEND_NO_SEARCH_CLOSE"*/;
        break;
      case 3:
        v46 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6516/*"FRIEND_NO_STRING_MESSAGE"*/, 0LL);
        if ( !v46 )
          goto LABEL_46;
        UILabel__set_text(v46, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6515/*"FRIEND_NO_STRING_CLOSE"*/;
        break;
      case 4:
        v47 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6512/*"FRIEND_NO_OFFER_MESSAGE"*/, 0LL);
        if ( !v47 )
          goto LABEL_46;
        UILabel__set_text(v47, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6511/*"FRIEND_NO_OFFER_CLOSE"*/;
        break;
      case 5:
        v48 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6510/*"FRIEND_NO_OFFERED_MESSAGE"*/, 0LL);
        if ( !v48 )
          goto LABEL_46;
        UILabel__set_text(v48, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6509/*"FRIEND_NO_OFFERED_CLOSE"*/;
        break;
      case 6:
        v49 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6508/*"FRIEND_NO_FRIEND_MESSAGE"*/, 0LL);
        if ( !v49 )
          goto LABEL_46;
        UILabel__set_text(v49, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6507/*"FRIEND_NO_FRIEND_CLOSE"*/;
        break;
      case 7:
        gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !gameObject )
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6439/*"FOLLOW_MAX_MESSAGE"*/, 0LL);
        if ( !v52 )
          goto LABEL_46;
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format_61801464(v53, v60, v62, 0LL);
        if ( !v51 )
          goto LABEL_46;
        UILabel__set_text(v51, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6438/*"FOLLOW_MAX_CLOSE"*/;
        break;
      default:
        goto LABEL_44;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B2A2 & 1) == 0 )
  {
    sub_1B90010(&FriendWarningDialog_CallbackFunc_TypeInfo, value);
    byte_4A6B2A2 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (FriendWarningDialog_o *)sub_1B9052C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CE81C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CE7D4;
}
