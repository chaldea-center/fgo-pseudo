...
void __fastcall FriendWarningDialog__Close(FriendWarningDialog_o *this, const MethodInfo *method)
{
  ...
  FriendWarningDialog__Close_31997360(this, 0LL, v2);
}


void __fastcall FriendWarningDialog__Close_31997360(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D083 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_FriendWarningDialog_EndClose__, v5);
    byte_4C1D083 = 1;
  }
...
void __fastcall FriendWarningDialog__OnClickClose(FriendWarningDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D084 & 1) == 0 )
  {
    sub_1C3B764(&Method_FriendWarningDialog_OnClickClose__, method);
    byte_4C1D084 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_FriendWarningDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_FriendWarningDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D082 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DataManager_GetMasterData_TblFriendMaster___, v8);
    sub_1C3B764(&Method_DataManager_GetMasterData_UserFollowMaster___, v9);
    sub_1C3B764(&Method_FriendWarningDialog_EndOpen__, v10);
    ...
    sub_1C3B764(&StringLiteral_6668/*"Font '{0}' is not dynamic, which is required to override its style"*/, v14);
    sub_1C3B764(&StringLiteral_6672/*"FontAsset.AddSynthesizedCharacters"*/, v15);
    sub_1C3B764(&StringLiteral_6667/*"Font '{0}' is not dynamic, which is required to override its size"*/, v16);
    sub_1C3B764(&StringLiteral_6675/*"FontAsset.TryAddCharacter"*/, v17);
    sub_1C3B764(&StringLiteral_6665/*"FollowerSelectMainQuest"*/, v18);
    sub_1C3B764(&StringLiteral_6676/*"FontAsset.TryAddCharacters"*/, v19);
    sub_1C3B764(&StringLiteral_6666/*"FollowerSelectOldClass"*/, v20);
    sub_1C3B764(&StringLiteral_6669/*"Font not found for path: {0}"*/, v21);
    sub_1C3B764(&StringLiteral_6597/*"FileNotFound_FileName"*/, v22);
    sub_1C3B764(&StringLiteral_6671/*"Font/{0}"*/, v23);
    sub_1C3B764(&StringLiteral_6674/*"FontAsset.ReadFontAssetDefinition"*/, v24);
    sub_1C3B764(&StringLiteral_6673/*"FontAsset.ClearFontAssetData"*/, v25);
    sub_1C3B764(&StringLiteral_6598/*"FileNotFound_FusionLog"*/, v26);
    sub_1C3B764(&StringLiteral_6670/*"Font size and style overrides are only supported for dynamic fonts. Font '{0}' is not dynamic."*/, v27);
    byte_4C1D082 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    switch ( kind )
    {
      case 1:
        ...
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6666/*"FollowerSelectOldClass"*/, 0LL);
        if ( !v33 )
          goto LABEL_46;
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format_63382984(v37, v41, v42, 0LL);
        if ( !messageLabel )
          goto LABEL_46;
        UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6665/*"FollowerSelectMainQuest"*/;
        break;
      case 2:
        v45 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6674/*"FontAsset.ReadFontAssetDefinition"*/, 0LL);
        if ( !v45 )
          goto LABEL_46;
        UILabel__set_text(v45, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6673/*"FontAsset.ClearFontAssetData"*/;
        break;
      case 3:
        v46 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6676/*"FontAsset.TryAddCharacters"*/, 0LL);
        if ( !v46 )
          goto LABEL_46;
        UILabel__set_text(v46, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6675/*"FontAsset.TryAddCharacter"*/;
        break;
      case 4:
        v47 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6672/*"FontAsset.AddSynthesizedCharacters"*/, 0LL);
        if ( !v47 )
          goto LABEL_46;
        UILabel__set_text(v47, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6671/*"Font/{0}"*/;
        break;
      case 5:
        v48 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6670/*"Font size and style overrides are only supported for dynamic fonts. Font '{0}' is not dynamic."*/, 0LL);
        if ( !v48 )
          goto LABEL_46;
        UILabel__set_text(v48, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6669/*"Font not found for path: {0}"*/;
        break;
      case 6:
        v49 = this->fields.messageLabel;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6668/*"Font '{0}' is not dynamic, which is required to override its style"*/, 0LL);
        if ( !v49 )
          goto LABEL_46;
        UILabel__set_text(v49, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6667/*"Font '{0}' is not dynamic, which is required to override its size"*/;
        break;
      case 7:
        gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !gameObject )
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6598/*"FileNotFound_FusionLog"*/, 0LL);
        if ( !v52 )
          goto LABEL_46;
        ...
        gameObject = (UnityEngine_GameObject_o *)System_String__Format_63382984(v53, v60, v62, 0LL);
        if ( !v51 )
          goto LABEL_46;
        UILabel__set_text(v51, (System_String_o *)gameObject, 0LL);
        closeLabel = this->fields.closeLabel;
        v44 = &StringLiteral_6597/*"FileNotFound_FileName"*/;
        break;
      default:
        goto LABEL_44;
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D07F & 1) == 0 )
  {
    sub_1C3B764(&FriendWarningDialog_CallbackFunc_TypeInfo, value);
    byte_4C1D07F = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (FriendWarningDialog_o *)sub_1C3BC80(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A74F98;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A74F50;
}
