void __fastcall AttriMaster___ctor(AttriMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B36DD1 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__, method);
    byte_4B36DD1 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    479,
    (const MethodInfo_31D1EB0 *)Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
}
...
int32_t __fastcall AttriMaster__GetAttrValue(AttriMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4B36DCF & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_AttriMaster___, *(_QWORD *)&id);
    sub_1BD3458(&DataManager_TypeInfo, v4);
    sub_1BD3458(&Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__, v5);
    byte_4B36DCF = 1;
  }
  entity = 0LL;
  ...
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    &entity,
                                    id,
                                    (const MethodInfo_31D1F44 *)Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36DD0 & 1) == 0 )
  {
    sub_1BD3458(&AttriEntity_TypeInfo, *(_QWORD *)&attrValue);
  ...
  if ( !list )
    sub_1BD36B4(0LL, *(_QWORD *)&attrValue);
