void __fastcall AttriMaster___ctor(AttriMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B667EA & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__, method);
    byte_4B667EA = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    483,
    (const MethodInfo_31FD784 *)Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
}
...
int32_t __fastcall AttriMaster__GetAttrValue(AttriMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4B667E8 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMaster_AttriMaster___, *(_QWORD *)&id);
    sub_1BE4ACC(&DataManager_TypeInfo, v4);
    sub_1BE4ACC(&Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__, v5);
    byte_4B667E8 = 1;
  }
  entity = 0LL;
  ...
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    &entity,
                                    id,
                                    (const MethodInfo_31FD818 *)Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B667E9 & 1) == 0 )
  {
    sub_1BE4ACC(&AttriEntity_TypeInfo, *(_QWORD *)&attrValue);
  ...
  if ( !list )
    sub_1BE4D28(0LL, *(_QWORD *)&attrValue);
