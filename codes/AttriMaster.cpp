void __fastcall AttriMaster___ctor(AttriMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2DB8A & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__, method);
    byte_4A2DB8A = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    479,
    (const MethodInfo_30FF740 *)Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
}
...
int32_t __fastcall AttriMaster__GetAttrValue(AttriMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4A2DB88 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMaster_AttriMaster___, *(_QWORD *)&id);
    sub_1B761C0(&DataManager_TypeInfo, v4);
    sub_1B761C0(&Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__, v5);
    byte_4A2DB88 = 1;
  }
  entity = 0LL;
  ...
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    &entity,
                                    id,
                                    (const MethodInfo_30FF7D4 *)Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2DB89 & 1) == 0 )
  {
    sub_1B761C0(&AttriEntity_TypeInfo, *(_QWORD *)&attrValue);
  ...
  if ( !list )
    sub_1B7641C(0LL, *(_QWORD *)&attrValue);
