void AttriMaster___ctor(AttriMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4D2C434 & 1) == 0 )
  {
    sub_1C94098(&Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
    byte_4D2C434 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    485,
    (const MethodInfo_345919C *)Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
}
...
int32_t AttriMaster__GetAttrValue(AttriMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4D2C432 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__);
    byte_4D2C432 = 1;
  }
  entity = 0;
  ...
  Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                    ...
                                    &entity,
                                    id,
                                    (const MethodInfo_345B50C *)Method_DataMasterBase_AttriMaster__AttriEntity__int__TryGetEntity__);
...
int32_t AttriMaster__GetIndividualityFromValue(AttriMaster_o *this, int32_t attrValue, const MethodInfo *method)
{
  ...
  if ( (byte_4D2C433 & 1) == 0 )
  {
    sub_1C94098(&AttriEntity_TypeInfo);
    sub_1C94098(&Method_System_Collections_ObjectModel_Collection_AttriEntity__GetEnumerator__);
    sub_1C94098(&System_IDisposable_TypeInfo);
    sub_1C94098(&System_Collections_Generic_IEnumerator_AttriEntity__TypeInfo);
    sub_1C94098(&System_Collections_IEnumerator_TypeInfo);
    byte_4D2C433 = 1;
  }
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1C942F0(0, *(_QWORD *)&attrValue);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_33F413C *)Method_System_Collections_ObjectModel_Collection_AttriEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C942F0(0, v6);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v15 = sub_1C6A420(Enumerator, System_Collections_Generic_IEnumerator_AttriEntity__TypeInfo, 0);
    }
