void __fastcall AttriMaster___ctor(AttriMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE15D & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__, method);
    byte_49FE15D = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    479,
    (const MethodInfo_30D6140 *)Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
}
...
int32_t __fastcall AttriMaster__GetAttrValue(AttriMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_49FE15B & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_AttriMaster___, *(_QWORD *)&id);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE15C & 1) == 0 )
  {
    sub_1B64870(&AttriEntity_TypeInfo, *(_QWORD *)&attrValue);
  ...
  if ( !list )
    sub_1B64ACC(0LL, *(_QWORD *)&attrValue);
