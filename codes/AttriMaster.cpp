void __fastcall AttriMaster___ctor(AttriMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4355331 & 1) == 0 )
  {
    sub_B70694(&Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
    byte_4355331 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    478,
    (const MethodInfo_21C03A4 *)Method_DataMasterBase_AttriMaster__AttriEntity__int___ctor__);
}
...
int32_t __fastcall AttriMaster__GetAttrValue(AttriMaster_o *this, int32_t id, const MethodInfo *method)
{
  ...
  Master_WarQuestSelectionMaster = DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1CA3540 *)Method_DataManager_GetMaster_AttriMaster___);
