        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FA16 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_ListViewDropObject___, method);
    sub_1B863B8(&NGUITools_TypeInfo, v3);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v4);
    sub_1B863B8(&UIDragDropRoot_TypeInfo, v5);
    byte_4A4FA16 = 1;
  }
  ...
  transform = (__int64)NGUITools__AddChild_47850048(v11, dragObjectPrefab, 0LL);
  if ( !transform )
    goto LABEL_29;
  v12 = (UnityEngine_GameObject_o *)transform;
  transform = (__int64)UnityEngine_GameObject__GetComponent_object_(
                         (UnityEngine_GameObject_o *)transform,
                         (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_ListViewDropObject___);
  if ( !transform )
    goto LABEL_29;
  linkItem = this->fields.linkItem;
  v16 = (UnityEngine_Component_o *)transform;
  *(_QWORD *)(transform + 56) = linkItem;
  sub_1B8635C((CGThumbnailListItem_o *)(transform + 56), (int32_t)linkItem, v13, v14);
  ...
  *(UnityEngine_Vector3_o *)&v22 = UnityEngine_Transform__get_eulerAngles((UnityEngine_Transform_o *)transform, 0LL);
  ...
  if ( !byte_4A487E6 )
  {
    transform = sub_1B863B8(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4A487E6 = 1;
  }
  if ( !v25 )
    goto LABEL_29;
  ...
  if ( !transform )
    goto LABEL_29;
  v37 = UnityEngine_Transform__TransformPoint_69383112((UnityEngine_Transform_o *)transform, 1.0, 1.0, 0.0, 0LL);
  x = v37.fields.x;
  y = v37.fields.y;
  z = v37.fields.z;
  transform = (__int64)UnityEngine_Component__get_transform(v16, 0LL);
...
void __fastcall ListViewDropObject__ReleaseItem(ListViewDropObject_o *this, const MethodInfo *method)
{
  ...
  {
    this->fields.linkItem = 0LL;
    sub_1B8635C((CGThumbnailListItem_o *)p_linkItem, 0, v2, v3);
...
void __fastcall ListViewDropObject__SetItem_41774392(
        ListViewDropObject_o *this,
        ListViewItem_o *item,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FA15 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_12563/*"SetBaseTransform"*/, item);
    byte_4A4FA15 = 1;
  }
  this->fields.linkItem = item;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.linkItem, (int32_t)item, (int32_t)seed, method);
  ListViewObject__SetVisible((ListViewObject_o *)this, 0, v6);
  ((void (__fastcall *)(ListViewDropObject_o *, _QWORD, Il2CppMethodPointer))this->klass->vtable._9_SetInput.method)(
    this,
    0LL,
  ...
  if ( !gameObject )
    sub_1B86614(0LL, v8);
  UnityEngine_GameObject__SendMessage_69337760(gameObject, (System_String_o *)StringLiteral_12563/*"SetBaseTransform"*/, 0LL);
}