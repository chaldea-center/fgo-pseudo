...
bool __fastcall ListViewDropObject__ClearItem(ListViewDropObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.isBusy )
  {
    ...
    sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.linkItem, 0LL, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B385EA & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_ListViewDropObject___, method);
    sub_1BD3458(&NGUITools_TypeInfo, v3);
    sub_1BD3458(&UnityEngine_Object_TypeInfo, v4);
    sub_1BD3458(&UIDragDropRoot_TypeInfo, v5);
    byte_4B385EA = 1;
  }
  ...
  transform = (__int64)NGUITools__AddChild_47549648(v11, dragObjectPrefab, 0LL);
  if ( !transform )
    goto LABEL_29;
  v12 = (UnityEngine_GameObject_o *)transform;
  transform = (__int64)UnityEngine_GameObject__GetComponent_object_(
                         (UnityEngine_GameObject_o *)transform,
                         (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_ListViewDropObject___);
  if ( !transform )
    goto LABEL_29;
  linkItem = this->fields.linkItem;
  v20 = (UnityEngine_Component_o *)transform;
  *(_QWORD *)(transform + 56) = linkItem;
  sub_1BD33FC((PartyOrganizationUtility_o *)(transform + 56), (int64_t)linkItem, v13, v14, v15, v16, v17, v18);
  ...
  *(UnityEngine_Vector3_o *)&v26 = UnityEngine_Transform__get_eulerAngles((UnityEngine_Transform_o *)transform, 0LL);
  ...
  if ( !byte_4B31946 )
  {
    transform = sub_1BD3458(&UnityEngine_Vector3_TypeInfo, v7);
    byte_4B31946 = 1;
  }
  if ( !v29 )
    goto LABEL_29;
  ...
  if ( !transform )
    goto LABEL_29;
  v39 = UnityEngine_Transform__TransformPoint_70302860((UnityEngine_Transform_o *)transform, 1.0, 1.0, 0.0, 0LL);
  x = v39.fields.x;
  y = v39.fields.y;
  z = v39.fields.z;
  transform = (__int64)UnityEngine_Component__get_transform(v20, 0LL);
...
void __fastcall ListViewDropObject__ReleaseItem(ListViewDropObject_o *this, const MethodInfo *method)
{
  ...
  {
    this->fields.linkItem = 0LL;
    sub_1BD33FC((PartyOrganizationUtility_o *)p_linkItem, 0LL, v2, v3, v4, v5, v6, v7);
    ListViewObject__SetVisible((ListViewObject_o *)this, 0, 0LL);
    ((void (__fastcall *)(ListViewDropObject_o *, _QWORD, Il2CppMethodPointer))this->klass->vtable._9_SetInput.method)(
      this,
      0LL,
...
void __fastcall ListViewDropObject__SetItem_41546824(
        ListViewDropObject_o *this,
        ListViewItem_o *item,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B385E9 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_12865/*"SetBaseTransform"*/, item);
    byte_4B385E9 = 1;
  }
  ...
  if ( !gameObject )
    sub_1BD36B4(0LL, v11);
  UnityEngine_GameObject__SendMessage_70259732(gameObject, (System_String_o *)StringLiteral_12865/*"SetBaseTransform"*/, 0LL);
}