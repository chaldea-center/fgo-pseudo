...
UnityEngine_GameObject_o *ListViewDropObject__CreateDragObject(ListViewDropObject_o *this, const MethodInfo *method)
{
  ...
  UnityEngine_Vector3_o v27; // 0:kr20_12.12
  UnityEngine_Vector3_o v28; // 0:kr60_12.12
  ...
  if ( (byte_4D320C5 & 1) == 0 )
  {
    sub_1C93AD4(&Method_UnityEngine_GameObject_GetComponent_ListViewDropObject___);
  ...
  transform = (__int64)NGUITools__AddChild_50075848(v8, dragObjectPrefab, 0);
  if ( !transform )
    goto LABEL_29;
  v9 = (UnityEngine_GameObject_o *)transform;
  transform = (__int64)UnityEngine_GameObject__GetComponent_object_(
                         (UnityEngine_GameObject_o *)transform,
                         (const MethodInfo_31FC084 *)Method_UnityEngine_GameObject_GetComponent_ListViewDropObject___);
  if ( !transform )
    goto LABEL_29;
  linkItem = this->fields.linkItem;
  v17 = (UnityEngine_Component_o *)transform;
  *(_QWORD *)(transform + 56) = linkItem;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(transform + 56), (int32_t)linkItem, v10, v11, v12, v13, v14, v15);
  ...
  if ( !transform )
    goto LABEL_29;
  v27 = UnityEngine_Transform__TransformPoint_72146688((UnityEngine_Transform_o *)transform, 1.0, 1.0, 0.0, 0);
  transform = (__int64)UnityEngine_Component__get_transform(v17, 0);
  if ( !transform )
    goto LABEL_29;
  v25 = (unsigned __int64)UnityEngine_Transform__InverseTransformPoint((UnityEngine_Transform_o *)transform, v27, 0);
  transform = (__int64)UnityEngine_Component__get_transform(v17, 0);
  if ( !transform )
    goto LABEL_29;
  *(_QWORD *)&v28.fields.x = v25;
  v28.fields.z = 1.0;
  ...
  if ( !v8
    || (v21 = (UnityEngine_GameObject_o *)transform, transform = UnityEngine_GameObject__get_layer(v8, 0), !v21)
...
LABEL_29:
  ...
  *(_QWORD *)&v29.fields.x = localPosition;
  v29.fields.z = 0.0;
  UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)transform, v29, 0);
  ListViewObject__SetBaseTransform((ListViewObject_o *)v17, v22);
  ListViewObject__SetVisible((ListViewObject_o *)v17, 1, v23);
...
void ListViewDropObject__ReleaseItem(ListViewDropObject_o *this, const MethodInfo *method)
{
  ...
  {
    this->fields.linkItem = 0;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)p_linkItem, 0, v2, v3, v4, v5, v6, v7);
...
void ListViewDropObject__SetItem_44486176(
        ...
        const MethodInfo *method)
{
  ...
  if ( !gameObject )
    sub_1C93D2C(0, v12);
  UnityEngine_GameObject__SendMessage_72101276(gameObject, (System_String_o *)StringLiteral_12884/*"SetBaseTransform"*/, 0);
}