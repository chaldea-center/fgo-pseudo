...
void SetScenarioControl__initSetValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22360 & 1) == 0 )
  {
    ...
    sub_1C2D490(&OptionManager_TypeInfo);
    sub_1C2D490(&StringLiteral_9694/*"OPTION_SCENARIO_SPEED"*/);
    sub_1C2D490(&StringLiteral_9690/*"OPTION_SCENARIO_COMMENT"*/);
    sub_1C2D490(&StringLiteral_9695/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/);
    byte_4C22360 = 1;
  }
  scenarioSpeedTxt = this->fields.scenarioSpeedTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9694/*"OPTION_SCENARIO_SPEED"*/, 0);
  if ( !scenarioSpeedTxt )
    goto LABEL_29;
  UILabel__set_text(scenarioSpeedTxt, scenarioSpeedSlider, 0);
  scenarioTextWaitTxt = this->fields.scenarioTextWaitTxt;
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9695/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/, 0);
  ...
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9690/*"OPTION_SCENARIO_COMMENT"*/, 0);
  ...
  if ( !scenarioSpeedSlider )
LABEL_29:
    sub_1C2D6EC(scenarioSpeedSlider, v5);
...
void SetScenarioControl__setChangeScenarioSpeedText(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&StringLiteral_6379/*"F2"*/);
    sub_1C2D490(&StringLiteral_9699/*"OPTION_SCENARIO_UNIT"*/);
    byte_4C22362 = 1;
  }
  ...
  *(float *)&format.klass = v7;
  v8 = System_Single__ToString_65053868(v7, &format, (const MethodInfo *)StringLiteral_6379/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9699/*"OPTION_SCENARIO_UNIT"*/, 0);
  v10 = System_String__Concat_63457864(v8, v9, 0);
...
void SetScenarioControl__setDefaultValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22366 & 1) == 0 )
  {
    sub_1C2D490(&BalanceConfig_TypeInfo);
    sub_1C2D490(&OptionManager_TypeInfo);
    sub_1C2D490(&Method_SetScenarioControl_setDefaultValue__);
    byte_4C22366 = 1;
  }
  scenarioSpeedSlider = (UIProgressBar_o *)this->fields.scenarioSpeedSlider;
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
...
LABEL_20:
  ...
  if ( (*((_BYTE *)Method_SetScenarioControl_setDefaultValue__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1C2D4A8(Method_SetScenarioControl_setDefaultValue__);
...
LABEL_17:
  ...
  *(float *)&format.klass = v11;
  v12 = System_Single__ToString_65053868(v11, &format, (const MethodInfo *)StringLiteral_6379/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_9699/*"OPTION_SCENARIO_UNIT"*/, 0);
