...
void SetScenarioControl__initSetValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF987 & 1) == 0 )
  {
    ...
    sub_1CE6700(&OptionManager_TypeInfo);
    sub_1CE6700(&StringLiteral_9776/*"OPTION_SCENARIO_SPEED"*/);
    sub_1CE6700(&StringLiteral_9772/*"OPTION_SCENARIO_COMMENT"*/);
    sub_1CE6700(&StringLiteral_9777/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/);
    byte_4DFF987 = 1;
  }
  scenarioSpeedTxt = this->fields.scenarioSpeedTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9776/*"OPTION_SCENARIO_SPEED"*/, 0);
  if ( !scenarioSpeedTxt )
    goto LABEL_29;
  UILabel__set_text(scenarioSpeedTxt, scenarioSpeedSlider, 0);
  scenarioTextWaitTxt = this->fields.scenarioTextWaitTxt;
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9777/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/, 0);
  ...
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9772/*"OPTION_SCENARIO_COMMENT"*/, 0);
  ...
  if ( !scenarioSpeedSlider )
LABEL_29:
    sub_1CE6958(scenarioSpeedSlider, v5);
...
void SetScenarioControl__setChangeScenarioSpeedText(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_6434/*"F2"*/);
    sub_1CE6700(&StringLiteral_9781/*"OPTION_SCENARIO_UNIT"*/);
    byte_4DFF989 = 1;
  }
  ...
  *(float *)&format.klass = v7;
  v8 = System_Single__ToString_66716520(v7, &format, (const MethodInfo *)StringLiteral_6434/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9781/*"OPTION_SCENARIO_UNIT"*/, 0);
  v10 = System_String__Concat_65122828(v8, v9, 0);
...
void SetScenarioControl__setDefaultValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF98D & 1) == 0 )
  {
    sub_1CE6700(&BalanceConfig_TypeInfo);
    sub_1CE6700(&OptionManager_TypeInfo);
    sub_1CE6700(&Method_SetScenarioControl_setDefaultValue__);
    byte_4DFF98D = 1;
  }
  scenarioSpeedSlider = (UIProgressBar_o *)this->fields.scenarioSpeedSlider;
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
...
LABEL_20:
  ...
  if ( (*((_BYTE *)Method_SetScenarioControl_setDefaultValue__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1CE6718(Method_SetScenarioControl_setDefaultValue__);
...
LABEL_17:
  ...
  *(float *)&format.klass = v11;
  v12 = System_Single__ToString_66716520(v11, &format, (const MethodInfo *)StringLiteral_6434/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_9781/*"OPTION_SCENARIO_UNIT"*/, 0);
