...
void SetScenarioControl__initSetValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D27818 & 1) == 0 )
  {
    ...
    sub_1C94098(&OptionManager_TypeInfo);
    sub_1C94098(&StringLiteral_9721/*"OPTION_SCENARIO_SPEED"*/);
    sub_1C94098(&StringLiteral_9717/*"OPTION_SCENARIO_COMMENT"*/);
    sub_1C94098(&StringLiteral_9722/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/);
    byte_4D27818 = 1;
  }
  scenarioSpeedTxt = this->fields.scenarioSpeedTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9721/*"OPTION_SCENARIO_SPEED"*/, 0);
  if ( !scenarioSpeedTxt )
    goto LABEL_29;
  UILabel__set_text(scenarioSpeedTxt, scenarioSpeedSlider, 0);
  scenarioTextWaitTxt = this->fields.scenarioTextWaitTxt;
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9722/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/, 0);
  ...
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9717/*"OPTION_SCENARIO_COMMENT"*/, 0);
  ...
  v10 = p_CriticalRateToAddByQuickFirstBonus[142];
  v11 = p_CriticalRateToAddByQuickFirstBonus[144] - p_CriticalRateToAddByQuickFirstBonus[143];
  if ( !byte_4D265B8 )
  {
  ...
  if ( !scenarioSpeedSlider )
LABEL_29:
    sub_1C942F0(scenarioSpeedSlider, v5);
...
void SetScenarioControl__setChangeScenarioSpeedText(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&StringLiteral_6395/*"F2"*/);
    sub_1C94098(&StringLiteral_9726/*"OPTION_SCENARIO_UNIT"*/);
    byte_4D2781A = 1;
  }
  ...
  *(float *)&format.klass = v7;
  v8 = System_Single__ToString_66011392(v7, &format, (const MethodInfo *)StringLiteral_6395/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9726/*"OPTION_SCENARIO_UNIT"*/, 0);
  v10 = System_String__Concat_64417744(v8, v9, 0);
...
void SetScenarioControl__setDefaultValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2781E & 1) == 0 )
  {
    sub_1C94098(&BalanceConfig_TypeInfo);
    sub_1C94098(&OptionManager_TypeInfo);
    sub_1C94098(&Method_SetScenarioControl_setDefaultValue__);
    byte_4D2781E = 1;
  }
  scenarioSpeedSlider = (UIProgressBar_o *)this->fields.scenarioSpeedSlider;
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
...
LABEL_20:
  ...
  if ( (*((_BYTE *)Method_SetScenarioControl_setDefaultValue__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1C940B0(Method_SetScenarioControl_setDefaultValue__);
...
LABEL_17:
  ...
  *(float *)&format.klass = v11;
  v12 = System_Single__ToString_66011392(v11, &format, (const MethodInfo *)StringLiteral_6395/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_9726/*"OPTION_SCENARIO_UNIT"*/, 0);
  v14 = System_String__Concat_64417744(v12, v13, 0);
