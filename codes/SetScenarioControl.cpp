...
void __fastcall SetScenarioControl__initSetValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB1257 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_9700/*"OPTION_SCENARIO_SPEED"*/, v5);
    sub_1BAB41C(&StringLiteral_9696/*"OPTION_SCENARIO_COMMENT"*/, v6);
    sub_1BAB41C(&StringLiteral_9701/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/, v7);
    byte_4AB1257 = 1;
  }
  ...
  if ( !scenarioSpeedSlider )
LABEL_29:
    sub_1BAB678(scenarioSpeedSlider, v10);
...
void __fastcall SetScenarioControl__setChangeScenarioSpeedText(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB1259 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_6354/*"F2"*/, v3);
    sub_1BAB41C(&StringLiteral_9705/*"OPTION_SCENARIO_UNIT"*/, v4);
    byte_4AB1259 = 1;
  }
  ...
  *(float *)&format.klass = v9;
  v10 = System_Single__ToString_62936204(v9, &format, (const MethodInfo *)StringLiteral_6354/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9705/*"OPTION_SCENARIO_UNIT"*/, 0LL);
  v12 = System_String__Concat_62048128(v10, v11, 0LL);
...
void __fastcall SetScenarioControl__setDefaultValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB125D & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SetScenarioControl_setDefaultValue__, v4);
    byte_4AB125D = 1;
  }
  scenarioSpeedSlider = (UIProgressBar_o *)this->fields.scenarioSpeedSlider;
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
...
LABEL_20:
  ...
  if ( (*((_BYTE *)Method_SetScenarioControl_setDefaultValue__ + 83) & 2) != 0 )
    v10 = (_QWORD *)sub_1BAB434(Method_SetScenarioControl_setDefaultValue__);
...
LABEL_17:
  ...
  *(float *)&format.klass = v13;
  v14 = System_Single__ToString_62936204(v13, &format, (const MethodInfo *)StringLiteral_6354/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
