...
void __fastcall SetScenarioControl__initSetValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0B7 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9660/*"OPTION_SCENARIO_SPEED"*/, v5);
    sub_1B715CC(&StringLiteral_9656/*"OPTION_SCENARIO_COMMENT"*/, v6);
    sub_1B715CC(&StringLiteral_9661/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/, v7);
    byte_4A1B0B7 = 1;
  }
  scenarioSpeedTxt = this->fields.scenarioSpeedTxt;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9660/*"OPTION_SCENARIO_SPEED"*/, 0LL);
  if ( !scenarioSpeedTxt )
    goto LABEL_29;
  UILabel__set_text(scenarioSpeedTxt, scenarioSpeedSlider, 0LL);
  scenarioTextWaitTxt = this->fields.scenarioTextWaitTxt;
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9661/*"OPTION_SCENARIO_TEXTWAIT_SPEED"*/, 0LL);
  ...
  scenarioSpeedSlider = LocalizationManager__Get((System_String_o *)StringLiteral_9656/*"OPTION_SCENARIO_COMMENT"*/, 0LL);
  ...
  v16 = p_CriticalRateToAddByQuickFirstBonus[131];
  v17 = p_CriticalRateToAddByQuickFirstBonus[133] - p_CriticalRateToAddByQuickFirstBonus[132];
  if ( !byte_4A1ADDD )
  {
  ...
  if ( !scenarioSpeedSlider )
LABEL_29:
    sub_1B71828(scenarioSpeedSlider, v10);
...
void __fastcall SetScenarioControl__setChangeScenarioSpeedText(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0B9 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_6329/*"F2"*/, v3);
    sub_1B715CC(&StringLiteral_9665/*"OPTION_SCENARIO_UNIT"*/, v4);
    byte_4A1B0B9 = 1;
  }
  ...
  *(float *)&format.klass = v9;
  v10 = System_Single__ToString_62393580(v9, &format, (const MethodInfo *)StringLiteral_6329/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_9665/*"OPTION_SCENARIO_UNIT"*/, 0LL);
  v12 = System_String__Concat_61505504(v10, v11, 0LL);
...
void __fastcall SetScenarioControl__setDefaultValue(SetScenarioControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0BD & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SetScenarioControl_setDefaultValue__, v4);
    byte_4A1B0BD = 1;
  }
  scenarioSpeedSlider = (UIProgressBar_o *)this->fields.scenarioSpeedSlider;
  if ( !OptionManager_TypeInfo->_2.cctor_finished )
...
LABEL_20:
  ...
  if ( (*((_BYTE *)Method_SetScenarioControl_setDefaultValue__ + 83) & 2) != 0 )
    v10 = (_QWORD *)sub_1B715E4(Method_SetScenarioControl_setDefaultValue__);
...
LABEL_17:
  ...
  *(float *)&format.klass = v13;
  v14 = System_Single__ToString_62393580(v13, &format, (const MethodInfo *)StringLiteral_6329/*"F2"*/);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_9665/*"OPTION_SCENARIO_UNIT"*/, 0LL);
  v16 = System_String__Concat_61505504(v14, v15, 0LL);
