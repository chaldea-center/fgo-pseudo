        ...
        const MethodInfo *method)
{
  ...
  if ( eventMissionActionEntity )
  {
    ...
    sub_B70630((BattleServantConfConponent_o *)&this->fields.vals, (System_Int32_array **)vals, v5, v6, v7, v8, v9, v10);
    this->fields.optionId = eventMissionActionEntity->fields.optionId;
  }
}


void __fastcall EventMissionActionInfo___ctor_27396076(
        EventMissionActionInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4352F3F & 1) == 0 )
  {
    this = (EventMissionActionInfo_o *)sub_B70694(&StringLiteral_1/*""*/);
    byte_4352F3F = 1;
  }
  vals = v2->fields.vals;
