        ...
        const MethodInfo *method)
{
  ...
  if ( eventMissionActionEntity )
  {
    ...
    sub_B77560((BattleServantConfConponent_o *)&this->fields.vals, (System_Int32_array **)vals, v5, v6, v7, v8, v9, v10);
    this->fields.optionId = eventMissionActionEntity->fields.optionId;
  }
}


void __fastcall EventMissionActionInfo___ctor_27751816(
        EventMissionActionInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438C6BE & 1) == 0 )
  {
    this = (EventMissionActionInfo_o *)sub_B775C4(&StringLiteral_1/*""*/);
    byte_438C6BE = 1;
  }
  vals = v2->fields.vals;
