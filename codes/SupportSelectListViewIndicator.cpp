        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB551 & 1) == 0 )
  {
    sub_1B64A00(&LocalizationManager_TypeInfo, partyItem);
    sub_1B64A00(&StringLiteral_12402/*"SUPPORT_SELECT_NAME"*/, v5);
    this = (SupportSelectListViewIndicator_o *)sub_1B64A00(&StringLiteral_1/*""*/, v6);
    byte_49FB551 = 1;
  }
...
LABEL_12:
    sub_1B64C5C(this, partyItem);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this = (SupportSelectListViewIndicator_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12402/*"SUPPORT_SELECT_NAME"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB552 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SupportSelectListViewIndicator_OnClickLeft__, v3);
    byte_49FB552 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( this->fields.pageIndex >= 1 )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v7 = (_QWORD *)sub_1B64A18(Method_SupportSelectListViewIndicator_OnClickLeft__);
...
LABEL_19:
    ...
    if ( v10->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1B64A18(Method_SupportSelectListViewIndicator_OnClickLeft__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, method);
    sub_1B64A00(&Method_SupportSelectListViewIndicator_OnClickRight__, v3);
    byte_49FB553 = 1;
  }
  manager = (UnityEngine_Object_o *)this->fields.manager;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( (pageIndex & 0x80000000) == 0 && pageIndex < this->fields.pageMax - 1 )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1B64A18(Method_SupportSelectListViewIndicator_OnClickRight__);
...
LABEL_20:
    ...
    if ( v11->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v12 = (_QWORD *)sub_1B64A18(Method_SupportSelectListViewIndicator_OnClickRight__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB54E & 1) == 0 )
  {
    sub_1B64A00(&SupportSelectListViewItem_TypeInfo, manager);
    byte_49FB54E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB550 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_20390/*"img_slider_on"*/, v5);
    sub_1B64A00(&StringLiteral_22388/*"party_txt_"*/, v6);
    sub_1B64A00(&StringLiteral_20389/*"img_slider_off"*/, v7);
    byte_49FB550 = 1;
  }
...
LABEL_16:
    ...
    v9 = (UISprite_o *)System_String__Concat_61385136((System_String_o *)StringLiteral_22388/*"party_txt_"*/, v14, 0LL);
    if ( !indexSprite )
      goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB54F & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, *(_QWORD *)&max);
    this = (SupportSelectListViewIndicator_o *)sub_1B64A00(&StringLiteral_20389/*"img_slider_off"*/, v5);
    byte_49FB54F = 1;
  }
...
void __fastcall SupportSelectListViewIndicator__Start(SupportSelectListViewIndicator_o *this, const MethodInfo *method)
{
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.modifyCenterItemCallBack, 0, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !pageSpriteList || !*(_QWORD *)&v4->max_length )
  {
    ...
    v8 = sub_1B64AA8(UISprite___TypeInfo, (unsigned int)v7->static_fields->SupportDeckMax);
    p_pageSpriteList->klass = (ServantStatusBattleListViewItem_c *)v8;
    sub_1B649A4(p_pageSpriteList, v8, v9, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( sprite )
  {
    this = (SupportSelectListViewIndicator_o *)sub_1B64B3C(sprite, pageSpriteList->obj.klass->_1.element_class);
    if ( !this )
    {
      v8 = sub_1B64C80();
      sub_1B64B28(v8, 0LL);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v7 + 4), (int32_t)sprite, (int32_t)sprite, (int32_t)method);
}