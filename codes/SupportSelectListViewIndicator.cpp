        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E7D6 & 1) == 0 )
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, partyItem);
    sub_1C3B764(&StringLiteral_12734/*"Start_nf"*/, v5);
    this = (SupportSelectListViewIndicator_o *)sub_1C3B764(&StringLiteral_1/*""*/, v6);
    byte_4C1E7D6 = 1;
  }
...
LABEL_12:
    sub_1C3B9C0(this, partyItem);
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this = (SupportSelectListViewIndicator_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12734/*"Start_nf"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E7D7 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SupportSelectListViewIndicator_OnClickLeft__, v3);
    byte_4C1E7D7 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( this->fields.pageIndex >= 1 )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v7 = (_QWORD *)sub_1C3B77C(Method_SupportSelectListViewIndicator_OnClickLeft__);
...
LABEL_19:
    ...
    if ( v10->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1C3B77C(Method_SupportSelectListViewIndicator_OnClickLeft__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, method);
    sub_1C3B764(&Method_SupportSelectListViewIndicator_OnClickRight__, v3);
    byte_4C1E7D8 = 1;
  }
  manager = (UnityEngine_Object_o *)this->fields.manager;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( (pageIndex & 0x80000000) == 0 && pageIndex < this->fields.pageMax - 1 )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1C3B77C(Method_SupportSelectListViewIndicator_OnClickRight__);
...
LABEL_20:
    ...
    if ( v11->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v12 = (_QWORD *)sub_1C3B77C(Method_SupportSelectListViewIndicator_OnClickRight__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E7D3 & 1) == 0 )
  {
    sub_1C3B764(&SupportSelectListViewItem_TypeInfo, manager);
    byte_4C1E7D3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E7D5 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_20882/*"low-limit"*/, v5);
    sub_1C3B764(&StringLiteral_22940/*"shop/cancelPurchaseByBank"*/, v6);
    sub_1C3B764(&StringLiteral_20881/*"lotteryShopId"*/, v7);
    byte_4C1E7D5 = 1;
  }
    ...
    if ( ((unsigned __int8)v9 & 1) != 0 && this->fields.pageMax >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v9 )
          break;
        if ( index == (_DWORD)v11 )
          v13 = &StringLiteral_20882/*"low-limit"*/;
        else
          v13 = &StringLiteral_20881/*"lotteryShopId"*/;
...
LABEL_16:
    ...
    v9 = (UISprite_o *)System_String__Concat_63368612((System_String_o *)StringLiteral_22940/*"shop/cancelPurchaseByBank"*/, v14, 0LL);
    if ( !indexSprite )
      goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E7D4 & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, *(_QWORD *)&max);
    this = (SupportSelectListViewIndicator_o *)sub_1C3B764(&StringLiteral_20881/*"lotteryShopId"*/, v5);
    byte_4C1E7D4 = 1;
  }
...
LABEL_20:
  ...
  while ( 1 )
  {
    ...
    if ( this )
    {
      v12 = (int)v10 >= v4->fields.pageMax ? 0LL : (System_String_o *)StringLiteral_20881/*"lotteryShopId"*/;
...
void __fastcall SupportSelectListViewIndicator__Start(SupportSelectListViewIndicator_o *this, const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.modifyCenterItemCallBack, 0LL, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !pageSpriteList || !*(_QWORD *)&v4->max_length )
  {
    ...
    v8 = sub_1C3B80C(UISprite___TypeInfo, (unsigned int)v7->static_fields->SupportDeckMax);
    p_pageSpriteList->klass = (PartyOrganizationUtility_c *)v8;
    sub_1C3B708(p_pageSpriteList, v8, v9, v10, v11, v12, v13, v14);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( sprite )
  {
    this = (SupportSelectListViewIndicator_o *)sub_1C3B8A0(sprite, pageSpriteList->obj.klass->_1.element_class);
    if ( !this )
    {
      v12 = sub_1C3B9E4();
      sub_1C3B88C(v12, 0LL);
