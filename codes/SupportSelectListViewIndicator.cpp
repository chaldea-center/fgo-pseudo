        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C34074 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_12555/*"SUPPORT_SELECT_NAME"*/);
    this = (SupportSelectListViewIndicator_o *)sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C34074 = 1;
  }
...
LABEL_12:
  ...
  this = (SupportSelectListViewIndicator_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12555/*"SUPPORT_SELECT_NAME"*/, 0);
...
void SupportSelectListViewIndicator__OnClickLeft(SupportSelectListViewIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C34075 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SupportSelectListViewIndicator_OnClickLeft__);
    byte_4C34075 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0, 0) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( this->fields.pageIndex >= 1 )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1C32C38(Method_SupportSelectListViewIndicator_OnClickLeft__);
...
LABEL_19:
    ...
    if ( v8->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v9 = (_QWORD *)sub_1C32C38(Method_SupportSelectListViewIndicator_OnClickLeft__);
...
void SupportSelectListViewIndicator__OnClickRight(SupportSelectListViewIndicator_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&Method_SupportSelectListViewIndicator_OnClickRight__);
    byte_4C34076 = 1;
  }
  manager = (UnityEngine_Object_o *)this->fields.manager;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0, 0) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( (pageIndex & 0x80000000) == 0 && pageIndex < this->fields.pageMax - 1 )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1C32C38(Method_SupportSelectListViewIndicator_OnClickRight__);
...
LABEL_20:
    ...
    if ( v9->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_SupportSelectListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v10 = (_QWORD *)sub_1C32C38(Method_SupportSelectListViewIndicator_OnClickRight__);
    ...
    if ( ((unsigned __int8)v6 & 1) != 0 && this->fields.pageMax >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v6 )
          break;
        if ( index == (_DWORD)v7 )
          v9 = &StringLiteral_20577/*"img_slider_on"*/;
        else
          v9 = &StringLiteral_20576/*"img_slider_off"*/;
...
LABEL_16:
    ...
    v6 = (UISprite_o *)System_String__Concat_63518544((System_String_o *)StringLiteral_22646/*"party_txt_"*/, v10, 0);
    if ( !indexSprite )
      goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    this = (SupportSelectListViewIndicator_o *)sub_1C32C20(&StringLiteral_20576/*"img_slider_off"*/);
    byte_4C34072 = 1;
  }
...
LABEL_20:
  ...
  while ( 1 )
  {
    ...
    if ( this )
    {
      v11 = (int)v9 >= v4->fields.pageMax ? 0LL : (System_String_o *)StringLiteral_20576/*"img_slider_off"*/;
...
void SupportSelectListViewIndicator__Start(SupportSelectListViewIndicator_o *this, const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.modifyCenterItemCallBack, 0, v2, v3);
}
...
void SupportSelectListViewIndicator__createSpriteList(SupportSelectListViewIndicator_o *this, const MethodInfo *method)
{
  ...
  if ( !pageSpriteList || !v3->max_length )
  {
    ...
    v7 = sub_1C32CC8(UISprite___TypeInfo, (unsigned int)v6->static_fields->SupportDeckMax);
    p_pageSpriteList->klass = (CGThumbnailListItem_c *)v7;
    sub_1C32BC4(p_pageSpriteList, v7, v8, v9);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.modifyCenterItemCallBack, (int32_t)callback, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( sprite )
  {
    this = (SupportSelectListViewIndicator_o *)sub_1C32D5C(sprite, pageSpriteList->obj.klass->_1.element_class);
    if ( !this )
    {
      v8 = sub_1C32EA0();
      sub_1C32D48(v8, 0);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)(v7 + 4), (int32_t)sprite, (int32_t)sprite, method);
}