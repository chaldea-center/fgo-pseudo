        ...
        const MethodInfo *method)
{
  ...
  sub_1BCA784((PartyOrganizationUtility_o *)v12, (int64_t)svtName, v28, v29, v30, v31, v32, v33);
}
        ...
        const MethodInfo *method)
{
  ...
  int32_t phase; // w21
  int32_t id; // w20
  QuestRestrictionInfo_o *v21; // x19
  ...
  if ( !Instance
    || (Instance = RecommendSupportSelectControl__get_SelectServantId((RecommendSupportSelectControl_o *)Instance, v14),
        !Master_object) )
  {
LABEL_15:
  ...
  v21 = (QuestRestrictionInfo_o *)sub_1BCAA2C(QuestRestrictionInfo_TypeInfo, v14, v15, v16);
  QuestRestrictionInfo___ctor_41151748(v21, 0, id, phase, 0LL);
  Instance = (int64_t)entity;
  if ( !entity )
    goto LABEL_15;
  return UserServantEntity__getQuestRestriction((UserServantEntity_o *)entity, v21, 2, 0LL);
}
