void __fastcall BattleSubject___ctor(BattleSubject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01191 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleObserver___ctor__, method);
    sub_1B64870(&System_Collections_Generic_List_BattleObserver__TypeInfo, v3);
    byte_4A01191 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_BattleObserver__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_BattleObserver___ctor__);
...
void __fastcall BattleSubject__Add(BattleSubject_o *this, BattleObserver_o *observer, const MethodInfo *method)
{
  ...
  if ( (byte_4A0118E & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleObserver__Add__, observer);
    byte_4A0118E = 1;
  }
  if ( observer )
  {
    ...
    if ( !observers
      || (items = observers->fields._items,
          ...
          !items) )
    {
      sub_1B64ACC(observers, observer);
    }
    ...
    else
    {
      ...
      sub_1B64814((ServantStatusBattleListViewItem_o *)(v10 + 4), (int32_t)observer, (int32_t)method, v3);
    }
  }
}
...
void __fastcall BattleSubject__Notify(BattleSubject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01190 & 1) == 0 )
  {
    sub_1B64870(&System_Action_BattleObserver__TypeInfo, method);
    sub_1B64870(&Method_BattleSubject__Notify_b__3_0__, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_BattleObserver__ForEach__, v4);
    byte_4A01190 = 1;
  }
  observers = (System_Collections_Generic_List_object__o *)this->fields.observers;
  v6 = (System_Action_object__o *)sub_1B64ABC(System_Action_BattleObserver__TypeInfo);
  ...
  System_Collections_Generic_List_object___ForEach(
    ...
    (const MethodInfo_34B0490 *)Method_System_Collections_Generic_List_BattleObserver__ForEach__);
}
...
void __fastcall BattleSubject__Remove(BattleSubject_o *this, BattleObserver_o *observer, const MethodInfo *method)
{
  ...
  if ( (byte_4A0118F & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleObserver__Remove__, observer);
    byte_4A0118F = 1;
  }
  if ( observer )
  {
    observers = (System_Collections_Generic_List_object__o *)this->fields.observers;
    if ( !observers )
      sub_1B64ACC(0LL, observer);
    System_Collections_Generic_List_object___Remove(
      observers,
      (Il2CppObject *)observer,
      (const MethodInfo_34B0F78 *)Method_System_Collections_Generic_List_BattleObserver__Remove__);
  }
}
