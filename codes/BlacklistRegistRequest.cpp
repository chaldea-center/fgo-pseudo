...
System_String_o *__fastcall BlacklistRegistRequest__getURL(BlacklistRegistRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40F9096 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_16792/*"blacklist/regist"*/, v2);
    byte_40F9096 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_16792/*"blacklist/regist"*/, 0LL);
}
