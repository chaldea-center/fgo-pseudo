        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D365 & 1) == 0 )
  {
    sub_1B715CC(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, isExit);
    sub_1B715CC(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v4);
  ...
  if ( !Instance
    || (CommonUI__maskFadein((CommonUI_o *)Instance, 0.1, 0LL, 0LL),
        ...
        v10 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1B71818(ScriptObjectListViewMenu_CallbackFunc_TypeInfo),
...
void __fastcall ScriptAssetListViewMenu__OnClickItem(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1D363 & 1) == 0 )
  {
    sub_1B715CC(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, method);
    sub_1B715CC(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v4);
    byte_4A1D363 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (v6 & 0x80000000) == 0 )
    {
      ...
      if ( listViewManager )
      {
        ...
        sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.selectAssetPath, (int32_t)v9, v7, v8);
        scriptObjectListViewMenu = this->fields.scriptObjectListViewMenu;
        this->fields.state = 3;
        selectAssetPath = this->fields.selectAssetPath;
        v12 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1B71818(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
        ScriptObjectListViewMenu_CallbackFunc___ctor(
          v12,
          (Il2CppObject *)this,
          Method_ScriptAssetListViewMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D364 & 1) == 0 )
  {
    ...
    sub_1B715CC(&ScriptManager_CallbackBranchList_TypeInfo, v7);
    sub_1B715CC(&Method_ScriptAssetListViewMenu_OnClickItem__, v8);
    sub_1B715CC(&ScriptManager_TypeInfo, v9);
    sub_1B715CC(&Method_ScriptAssetListViewMenu___c__DisplayClass20_0__OnEndSelectObject_b__0__, v10);
    sub_1B715CC(&ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo, v11);
    sub_1B715CC(&StringLiteral_1123/*"/"*/, v12);
    sub_1B715CC(&StringLiteral_1/*""*/, v13);
    byte_4A1D364 = 1;
  }
  v14 = sub_1B71818(ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v14 + 16) = this;
  ...
  if ( !scriptObjectListViewMenu )
LABEL_23:
    sub_1B71828(scriptObjectListViewMenu, v16);
  if ( (result & 0xFFFFFFFE) != 2 )
  {
    ...
    if ( listViewManager )
    {
      ScriptAssetListViewManager__SetMode_34708836(listViewManager, 1, v37, v38);
  ...
  *(_DWORD *)(v14 + 32) = ScriptObjectListViewMenu__GetJumpLine(scriptObjectListViewMenu, 0LL);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.selectObjectPath, (int32_t)path, v19, v20);
  selectAssetPath = this->fields.selectAssetPath;
  selectObjectPath = this->fields.selectObjectPath;
  *(_QWORD *)(v14 + 24) = selectObjectPath;
  v23 = (System_String_o **)(v14 + 24);
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v14 + 24), (int32_t)selectObjectPath, v24, v25);
    ...
    && System_String__op_Inequality(*v23, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
  {
    ...
    *(_QWORD *)(v14 + 40) = StartModeForAssetStorage;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v14 + 40), (int32_t)StartModeForAssetStorage, v28, v29);
    v30 = System_String__IndexOf_61537080(selectAssetPath, (System_String_o *)StringLiteral_1123/*"/"*/, 0LL);
    this->fields.state = 4;
    if ( (v30 & 0x80000000) == 0 )
      selectAssetPath = System_String__Substring(selectAssetPath, v30 + 1, 0LL);
    *(_QWORD *)(v14 + 48) = selectAssetPath;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v14 + 48), (int32_t)selectAssetPath, v31, v32);
    v33 = *(System_String_o **)(v14 + 48);
    v34 = *(System_String_o **)(v14 + 24);
    v35 = (ScriptManager_CallbackBranchList_o *)sub_1B71818(ScriptManager_CallbackBranchList_TypeInfo);
  ...
  if ( state == 6 || !state )
  {
    ...
    if ( !scriptTestAssetRootObject
      ...
      || (UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)scriptTestAssetRootObject, 0, 0LL),
          (scriptTestAssetRootObject = (UnityEngine_GameObject_o *)this->fields.listViewManager) == 0LL) )
    {
      sub_1B71828(scriptTestAssetRootObject, v6);
    }
...
void __fastcall ScriptAssetListViewMenu__StartInput(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1D362 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ScriptAssetListViewMenu_OnClickItem__, v3);
    byte_4A1D362 = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  ...
  if ( !listViewManager
    || (ScriptAssetListViewManager__SetMode_34708836(listViewManager, 1, v5, v8),
        (scriptTestAssetCancelButton = (UnityEngine_Behaviour_o *)this->fields.scriptTestAssetCancelButton) == 0LL) )
  {
    sub_1B71828(scriptTestAssetCancelButton, v7);
  }
...
void __fastcall ScriptAssetListViewMenu__StartMenu(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1D35F & 1) == 0 )
  {
    ...
    sub_1B715CC(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo, v3);
    sub_1B715CC(&Method_ScriptAssetListViewMenu__StartMenu_b__9_0__, v4);
    sub_1B715CC(&StringLiteral_12494/*"ScriptActionEncrypt"*/, v5);
    byte_4A1D35F = 1;
  }
  ...
  AssetManager__resetAssetStorageVersion((System_String_o *)StringLiteral_12494/*"ScriptActionEncrypt"*/, 0LL);
  v6 = (ScriptAssetListViewMenu_CallbackFunc_o *)sub_1B71818(ScriptAssetListViewMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D360 & 1) == 0 )
  {
    sub_1B715CC(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4A1D360 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B65A8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B6560;
}
        ...
        const MethodInfo *method)
{
  ...
  ScriptManager_CallbackFunc_o *v20; // x20

  v5 = this;
  if ( (byte_4A1D367 & 1) == 0 )
  {
    sub_1B715CC(&ScriptBranchMenu_CallbackFunc_TypeInfo, list);
    sub_1B715CC(&ScriptManager_CallbackFunc_TypeInfo, v6);
    sub_1B715CC(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, v7);
    sub_1B715CC(&ScriptManager_TypeInfo, v8);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1B715CC(
  ...
  if ( list )
  {
    ...
    if ( !_9__1 )
    {
      _9__1 = (ScriptBranchMenu_CallbackFunc_o *)sub_1B71818(ScriptBranchMenu_CallbackFunc_TypeInfo);
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&v5->fields.__9__1, (int32_t)_9__1, v13, v14);
    }
    if ( !scriptBranchMenu )
LABEL_12:
  ...
  else
  {
    ...
    v20 = (ScriptManager_CallbackFunc_o *)sub_1B71818(ScriptManager_CallbackFunc_TypeInfo);
    ScriptManager_CallbackFunc___ctor(v20, v19, Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, 0LL);
    if ( !ScriptManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ScriptManager_TypeInfo);
    ScriptManager__DebugPlay(startMode, name, labelPath, jumpLine, v20, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D368 & 1) == 0 )
  {
    sub_1B715CC(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, b);
    sub_1B715CC(&ScriptManager_CallbackFunc_TypeInfo, v5);
    sub_1B715CC(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, v6);
    sub_1B715CC(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v7);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1B715CC(&ScriptManager_TypeInfo, v8);
    byte_4A1D368 = 1;
  }
  ...
  if ( !b )
  {
    ...
    if ( v16 )
    {
      ...
      v19 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1B71818(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
      ScriptObjectListViewMenu_CallbackFunc___ctor(
        v19,
        (Il2CppObject *)v16,
        Method_ScriptAssetListViewMenu_OnEndSelectObject__,
...
LABEL_12:
  ...
  v15 = (ScriptManager_CallbackFunc_o *)sub_1B71818(ScriptManager_CallbackFunc_TypeInfo);
