        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24882 & 1) == 0 )
  {
    sub_1C2D490(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
    sub_1C2D490(&Method_ScriptAssetListViewMenu_OnEndSelectObject__);
  ...
  if ( !Instance
    || (CommonUI__maskFadein((CommonUI_o *)Instance, 0.1, 0, 0),
        ...
        v8 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptObjectListViewMenu_CallbackFunc_TypeInfo),
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (callbackIndex & 0x80000000) == 0 )
    {
      ...
      if ( listViewManager )
      {
        ...
        sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectAssetPath, (int32_t)dragParentObject, v5, v6);
        scriptObjectListViewMenu = this->fields.scriptObjectListViewMenu;
        this->fields.state = 3;
        selectAssetPath = this->fields.selectAssetPath;
        v10 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
        ScriptObjectListViewMenu_CallbackFunc___ctor(
          v10,
          (Il2CppObject *)this,
          Method_ScriptAssetListViewMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24881 & 1) == 0 )
  {
    ...
    sub_1C2D490(&ScriptManager_CallbackBranchList_TypeInfo);
    sub_1C2D490(&Method_ScriptAssetListViewMenu_OnClickItem__);
    sub_1C2D490(&ScriptManager_TypeInfo);
    sub_1C2D490(&Method_ScriptAssetListViewMenu___c__DisplayClass20_0__OnEndSelectObject_b__0__);
    sub_1C2D490(&ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo);
    sub_1C2D490(&StringLiteral_1048/*"/"*/);
    sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C24881 = 1;
  }
  v7 = sub_1C2D6DC(ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 16) = this;
  ...
  if ( !scriptObjectListViewMenu )
LABEL_23:
    sub_1C2D6EC(scriptObjectListViewMenu, v9);
  if ( (result & 0xFFFFFFFE) != 2 )
  {
    ...
    if ( listViewManager )
    {
      ScriptAssetListViewManager__SetMode_37195624(listViewManager, 1, v30, 0);
  ...
  *(_DWORD *)(v7 + 32) = ScriptObjectListViewMenu__GetJumpLine(scriptObjectListViewMenu, v9);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selectObjectPath, (int32_t)path, v12, v13);
  selectAssetPath = this->fields.selectAssetPath;
  selectObjectPath = this->fields.selectObjectPath;
  *(_QWORD *)(v7 + 24) = selectObjectPath;
  v16 = (System_String_o **)(v7 + 24);
  sub_1C2D434((CGThumbnailListItem_o *)(v7 + 24), (int32_t)selectObjectPath, v17, v18);
    ...
    && System_String__op_Inequality(*v16, (System_String_o *)StringLiteral_1/*""*/, 0) )
  {
    ...
    *(_QWORD *)(v7 + 40) = StartModeForAssetStorage;
    sub_1C2D434((CGThumbnailListItem_o *)(v7 + 40), (int32_t)StartModeForAssetStorage, v21, v22);
    v23 = System_String__IndexOf_63516240(selectAssetPath, (System_String_o *)StringLiteral_1048/*"/"*/, 0);
    this->fields.state = 4;
    if ( (v23 & 0x80000000) == 0 )
      selectAssetPath = System_String__Substring(selectAssetPath, v23 + 1, 0);
    *(_QWORD *)(v7 + 48) = selectAssetPath;
    sub_1C2D434((CGThumbnailListItem_o *)(v7 + 48), (int32_t)selectAssetPath, v24, v25);
    v26 = *(System_String_o **)(v7 + 48);
    v27 = *(System_String_o **)(v7 + 24);
    v28 = (ScriptManager_CallbackBranchList_o *)sub_1C2D6DC(ScriptManager_CallbackBranchList_TypeInfo);
  ...
  if ( state == 6 || !state )
  {
    ...
    if ( !scriptTestAssetRootObject
      ...
      || (UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)scriptTestAssetRootObject, 0, 0),
          (scriptTestAssetRootObject = (UnityEngine_GameObject_o *)this->fields.listViewManager) == 0) )
    {
      sub_1C2D6EC(scriptTestAssetRootObject, v6);
    }
...
void ScriptAssetListViewMenu__StartInput(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !listViewManager
    || (ScriptAssetListViewManager__SetMode_37195624(listViewManager, 1, v4, 0),
        (scriptTestAssetCancelButton = (UnityEngine_Behaviour_o *)this->fields.scriptTestAssetCancelButton) == 0) )
  {
    sub_1C2D6EC(scriptTestAssetCancelButton, v6);
  }
...
void ScriptAssetListViewMenu__StartMenu(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2487C & 1) == 0 )
  {
    ...
    sub_1C2D490(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo);
    sub_1C2D490(&Method_ScriptAssetListViewMenu__StartMenu_b__9_0__);
    sub_1C2D490(&StringLiteral_12628/*"ScriptActionEncrypt"*/);
    byte_4C2487C = 1;
  }
  ...
  AssetManager__resetAssetStorageVersion((System_String_o *)StringLiteral_12628/*"ScriptActionEncrypt"*/, 0);
  v3 = (ScriptAssetListViewMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptAssetListViewMenu_CallbackFunc_TypeInfo);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A6EF78;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A6EF30;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24884 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__);
    sub_1C2D490(&ScriptManager_TypeInfo);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1C2D490(&Method_ScriptAssetListViewMenu___c__DisplayClass20_0__OnEndSelectObject_b__1__);
    byte_4C24884 = 1;
  }
  if ( list )
  {
    ...
    if ( !_9__1 )
    {
      _9__1 = (ScriptBranchMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptBranchMenu_CallbackFunc_TypeInfo);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&v5->fields.__9__1, (int32_t)_9__1, v10, v11);
    }
    if ( !scriptBranchMenu )
LABEL_12:
  ...
  else
  {
    ...
    v17 = (ScriptManager_CallbackFunc_o *)sub_1C2D6DC(ScriptManager_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24885 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__);
    sub_1C2D490(&Method_ScriptAssetListViewMenu_OnEndSelectObject__);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1C2D490(&ScriptManager_TypeInfo);
    byte_4C24885 = 1;
  }
  ...
  if ( !b )
  {
    ...
    if ( v12 )
    {
      ...
      v15 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1C2D6DC(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
      ScriptObjectListViewMenu_CallbackFunc___ctor(
        v15,
        (Il2CppObject *)v12,
        Method_ScriptAssetListViewMenu_OnEndSelectObject__,
...
LABEL_12:
  ...
  v11 = (ScriptManager_CallbackFunc_o *)sub_1C2D6DC(ScriptManager_CallbackFunc_TypeInfo);
