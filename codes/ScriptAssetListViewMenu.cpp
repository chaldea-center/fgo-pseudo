        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC51B4 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, isExit);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v4);
  ...
  if ( !Instance
    || (CommonUI__maskFadein((CommonUI_o *)Instance, 0.1, 0LL, 0LL),
        ...
        v10 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1C1AE20(ScriptObjectListViewMenu_CallbackFunc_TypeInfo),
...
void __fastcall ScriptAssetListViewMenu__OnClickItem(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC51B2 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v3);
    byte_4BC51B2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (v5 & 0x80000000) == 0 )
    {
      ...
      if ( listViewManager )
      {
        ...
        sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.selectAssetPath, (int64_t)v12, v6, v7, v8, v9, v10, v11);
        scriptObjectListViewMenu = this->fields.scriptObjectListViewMenu;
        this->fields.state = 3;
        selectAssetPath = this->fields.selectAssetPath;
        v15 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1C1AE20(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
        ScriptObjectListViewMenu_CallbackFunc___ctor(
          v15,
          (Il2CppObject *)this,
          Method_ScriptAssetListViewMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC51B3 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&ScriptManager_CallbackBranchList_TypeInfo, v7);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu_OnClickItem__, v8);
    sub_1C1ABD4(&ScriptManager_TypeInfo, v9);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu___c__DisplayClass20_0__OnEndSelectObject_b__0__, v10);
    sub_1C1ABD4(&ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo, v11);
    sub_1C1ABD4(&StringLiteral_1123/*"/"*/, v12);
    sub_1C1ABD4(&StringLiteral_1/*""*/, v13);
    byte_4BC51B3 = 1;
  }
  v14 = sub_1C1AE20(ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v14 + 16) = this;
  ...
  if ( !scriptObjectListViewMenu )
LABEL_23:
    sub_1C1AE30(scriptObjectListViewMenu, v16);
  if ( (result & 0xFFFFFFFE) != 2 )
  {
    ...
    if ( listViewManager )
    {
      ScriptAssetListViewManager__SetMode_35964756(listViewManager, 1, v57, 0LL);
  ...
  *(_DWORD *)(v14 + 32) = ScriptObjectListViewMenu__GetJumpLine(scriptObjectListViewMenu, v16);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.selectObjectPath, (int64_t)path, v23, v24, v25, v26, v27, v28);
  selectAssetPath = this->fields.selectAssetPath;
  selectObjectPath = this->fields.selectObjectPath;
  *(_QWORD *)(v14 + 24) = selectObjectPath;
  v31 = (System_String_o **)(v14 + 24);
  sub_1C1AB78((PartyOrganizationUtility_o *)(v14 + 24), (int64_t)selectObjectPath, v32, v33, v34, v35, v36, v37);
    ...
    && System_String__op_Inequality(*v31, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
  {
    ...
    *(_QWORD *)(v14 + 40) = StartModeForAssetStorage;
    sub_1C1AB78(
      ...
      v44,
      v45);
    v46 = System_String__IndexOf_63071944(selectAssetPath, (System_String_o *)StringLiteral_1123/*"/"*/, 0LL);
    this->fields.state = 4;
    if ( (v46 & 0x80000000) == 0 )
      selectAssetPath = System_String__Substring(selectAssetPath, v46 + 1, 0LL);
    *(_QWORD *)(v14 + 48) = selectAssetPath;
    sub_1C1AB78((PartyOrganizationUtility_o *)(v14 + 48), (int64_t)selectAssetPath, v47, v48, v49, v50, v51, v52);
    v53 = *(System_String_o **)(v14 + 48);
    v54 = *(System_String_o **)(v14 + 24);
    v55 = (ScriptManager_CallbackBranchList_o *)sub_1C1AE20(ScriptManager_CallbackBranchList_TypeInfo);
  ...
  if ( state == 6 || !state )
  {
    ...
    if ( !scriptTestAssetRootObject
      ...
      || (UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)scriptTestAssetRootObject, 0, 0LL),
          (scriptTestAssetRootObject = (UnityEngine_GameObject_o *)this->fields.listViewManager) == 0LL) )
    {
      sub_1C1AE30(scriptTestAssetRootObject, v10);
    }
...
void __fastcall ScriptAssetListViewMenu__StartInput(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC51B1 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu_OnClickItem__, v3);
    byte_4BC51B1 = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  ...
  if ( !listViewManager
    || (ScriptAssetListViewManager__SetMode_35964756(listViewManager, 1, v5, 0LL),
        (scriptTestAssetCancelButton = (UnityEngine_Behaviour_o *)this->fields.scriptTestAssetCancelButton) == 0LL) )
  {
    sub_1C1AE30(scriptTestAssetCancelButton, v7);
  }
...
void __fastcall ScriptAssetListViewMenu__StartMenu(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC51AE & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo, v3);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu__StartMenu_b__9_0__, v4);
    sub_1C1ABD4(&StringLiteral_12771/*"ScriptActionEncrypt"*/, v5);
    byte_4BC51AE = 1;
  }
  ...
  AssetManager__resetAssetStorageVersion((System_String_o *)StringLiteral_12771/*"ScriptActionEncrypt"*/, 0LL);
  v6 = (ScriptAssetListViewMenu_CallbackFunc_o *)sub_1C1AE20(ScriptAssetListViewMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC51AF & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4BC51AF = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A59388;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A59340;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC51B6 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptBranchMenu_CallbackFunc_TypeInfo, list);
    sub_1C1ABD4(&ScriptManager_CallbackFunc_TypeInfo, v6);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, v7);
    sub_1C1ABD4(&ScriptManager_TypeInfo, v8);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1C1ABD4(
  ...
  if ( list )
  {
    ...
    if ( !_9__1 )
    {
      _9__1 = (ScriptBranchMenu_CallbackFunc_o *)sub_1C1AE20(ScriptBranchMenu_CallbackFunc_TypeInfo);
      ...
      sub_1C1AB78((PartyOrganizationUtility_o *)&v5->fields.__9__1, (int64_t)_9__1, v14, v15, v16, v17, v18, v19);
    }
    if ( !scriptBranchMenu )
LABEL_12:
  ...
  else
  {
    ...
    v25 = (ScriptManager_CallbackFunc_o *)sub_1C1AE20(ScriptManager_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC51B7 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, b);
    sub_1C1ABD4(&ScriptManager_CallbackFunc_TypeInfo, v5);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, v6);
    sub_1C1ABD4(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v7);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1C1ABD4(&ScriptManager_TypeInfo, v8);
    byte_4BC51B7 = 1;
  }
  ...
  if ( !b )
  {
    ...
    if ( v16 )
    {
      ...
      v19 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1C1AE20(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
      ScriptObjectListViewMenu_CallbackFunc___ctor(
        v19,
        (Il2CppObject *)v16,
        Method_ScriptAssetListViewMenu_OnEndSelectObject__,
...
LABEL_12:
  ...
  v15 = (ScriptManager_CallbackFunc_o *)sub_1C1AE20(ScriptManager_CallbackFunc_TypeInfo);
