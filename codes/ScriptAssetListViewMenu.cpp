        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAEB & 1) == 0 )
  {
    sub_1B863B8(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, isExit);
    sub_1B863B8(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v4);
  ...
  if ( !Instance
    || (CommonUI__maskFadein((CommonUI_o *)Instance, 0.1, 0LL, 0LL),
        ...
        v10 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1B86604(ScriptObjectListViewMenu_CallbackFunc_TypeInfo),
...
void __fastcall ScriptAssetListViewMenu__OnClickItem(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAE9 & 1) == 0 )
  {
    sub_1B863B8(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, method);
    sub_1B863B8(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v3);
    byte_4A4BAE9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (v5 & 0x80000000) == 0 )
    {
      ...
      if ( listViewManager )
      {
        ...
        sub_1B8635C((CGThumbnailListItem_o *)&this->fields.selectAssetPath, (int32_t)v8, v6, v7);
        scriptObjectListViewMenu = this->fields.scriptObjectListViewMenu;
        this->fields.state = 3;
        selectAssetPath = this->fields.selectAssetPath;
        v11 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1B86604(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
        ScriptObjectListViewMenu_CallbackFunc___ctor(
          v11,
          (Il2CppObject *)this,
          Method_ScriptAssetListViewMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAEA & 1) == 0 )
  {
    ...
    sub_1B863B8(&ScriptManager_CallbackBranchList_TypeInfo, v7);
    sub_1B863B8(&Method_ScriptAssetListViewMenu_OnClickItem__, v8);
    sub_1B863B8(&ScriptManager_TypeInfo, v9);
    sub_1B863B8(&Method_ScriptAssetListViewMenu___c__DisplayClass20_0__OnEndSelectObject_b__0__, v10);
    sub_1B863B8(&ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo, v11);
    sub_1B863B8(&StringLiteral_1058/*"/"*/, v12);
    sub_1B863B8(&StringLiteral_1/*""*/, v13);
    byte_4A4BAEA = 1;
  }
  v14 = sub_1B86604(ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v14 + 16) = this;
  ...
  if ( !scriptObjectListViewMenu )
LABEL_23:
    sub_1B86614(scriptObjectListViewMenu, v16);
  if ( (result & 0xFFFFFFFE) != 2 )
  {
    ...
    if ( listViewManager )
    {
      ScriptAssetListViewManager__SetMode_35604488(listViewManager, 1, v37, 0LL);
  ...
  *(_DWORD *)(v14 + 32) = ScriptObjectListViewMenu__GetJumpLine(scriptObjectListViewMenu, v16);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.selectObjectPath, (int32_t)path, v19, v20);
  selectAssetPath = this->fields.selectAssetPath;
  selectObjectPath = this->fields.selectObjectPath;
  *(_QWORD *)(v14 + 24) = selectObjectPath;
  v23 = (System_String_o **)(v14 + 24);
  sub_1B8635C((CGThumbnailListItem_o *)(v14 + 24), (int32_t)selectObjectPath, v24, v25);
    ...
    && System_String__op_Inequality(*v23, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
  {
    ...
    *(_QWORD *)(v14 + 40) = StartModeForAssetStorage;
    sub_1B8635C((CGThumbnailListItem_o *)(v14 + 40), (int32_t)StartModeForAssetStorage, v28, v29);
    v30 = System_String__IndexOf_61703672(selectAssetPath, (System_String_o *)StringLiteral_1058/*"/"*/, 0LL);
    this->fields.state = 4;
    if ( (v30 & 0x80000000) == 0 )
      selectAssetPath = System_String__Substring(selectAssetPath, v30 + 1, 0LL);
    *(_QWORD *)(v14 + 48) = selectAssetPath;
    sub_1B8635C((CGThumbnailListItem_o *)(v14 + 48), (int32_t)selectAssetPath, v31, v32);
    v33 = *(System_String_o **)(v14 + 48);
    v34 = *(System_String_o **)(v14 + 24);
    v35 = (ScriptManager_CallbackBranchList_o *)sub_1B86604(ScriptManager_CallbackBranchList_TypeInfo);
  ...
  if ( state == 6 || !state )
  {
    ...
    if ( !scriptTestAssetRootObject
      ...
      || (UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)scriptTestAssetRootObject, 0, 0LL),
          (scriptTestAssetRootObject = (UnityEngine_GameObject_o *)this->fields.listViewManager) == 0LL) )
    {
      sub_1B86614(scriptTestAssetRootObject, v6);
    }
...
void __fastcall ScriptAssetListViewMenu__StartInput(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAE8 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_ScriptAssetListViewMenu_OnClickItem__, v3);
    byte_4A4BAE8 = 1;
  }
  this->fields.state = 2;
  listViewManager = this->fields.listViewManager;
  ...
  if ( !listViewManager
    || (ScriptAssetListViewManager__SetMode_35604488(listViewManager, 1, v5, 0LL),
        (scriptTestAssetCancelButton = (UnityEngine_Behaviour_o *)this->fields.scriptTestAssetCancelButton) == 0LL) )
  {
    sub_1B86614(scriptTestAssetCancelButton, v7);
  }
...
void __fastcall ScriptAssetListViewMenu__StartMenu(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAE5 & 1) == 0 )
  {
    ...
    sub_1B863B8(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo, v3);
    sub_1B863B8(&Method_ScriptAssetListViewMenu__StartMenu_b__9_0__, v4);
    sub_1B863B8(&StringLiteral_12413/*"ScriptActionEncrypt"*/, v5);
    byte_4A4BAE5 = 1;
  }
  ...
  AssetManager__resetAssetStorageVersion((System_String_o *)StringLiteral_12413/*"ScriptActionEncrypt"*/, 0LL);
  v6 = (ScriptAssetListViewMenu_CallbackFunc_o *)sub_1B86604(ScriptAssetListViewMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAE6 & 1) == 0 )
  {
    sub_1B863B8(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4A4BAE6 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CFC28;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CFBE0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAED & 1) == 0 )
  {
    sub_1B863B8(&ScriptBranchMenu_CallbackFunc_TypeInfo, list);
    sub_1B863B8(&ScriptManager_CallbackFunc_TypeInfo, v6);
    sub_1B863B8(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, v7);
    sub_1B863B8(&ScriptManager_TypeInfo, v8);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1B863B8(
  ...
  if ( list )
  {
    ...
    if ( !_9__1 )
    {
      _9__1 = (ScriptBranchMenu_CallbackFunc_o *)sub_1B86604(ScriptBranchMenu_CallbackFunc_TypeInfo);
      ...
      sub_1B8635C((CGThumbnailListItem_o *)&v5->fields.__9__1, (int32_t)_9__1, v14, v15);
    }
    if ( !scriptBranchMenu )
LABEL_12:
  ...
  else
  {
    ...
    v21 = (ScriptManager_CallbackFunc_o *)sub_1B86604(ScriptManager_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BAEE & 1) == 0 )
  {
    sub_1B863B8(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo, b);
    sub_1B863B8(&ScriptManager_CallbackFunc_TypeInfo, v5);
    sub_1B863B8(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, v6);
    sub_1B863B8(&Method_ScriptAssetListViewMenu_OnEndSelectObject__, v7);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_1B863B8(&ScriptManager_TypeInfo, v8);
    byte_4A4BAEE = 1;
  }
  ...
  if ( !b )
  {
    ...
    if ( v16 )
    {
      ...
      v19 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_1B86604(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
      ScriptObjectListViewMenu_CallbackFunc___ctor(
        v19,
        (Il2CppObject *)v16,
        Method_ScriptAssetListViewMenu_OnEndSelectObject__,
...
LABEL_12:
  ...
  v15 = (ScriptManager_CallbackFunc_o *)sub_1B86604(ScriptManager_CallbackFunc_TypeInfo);
