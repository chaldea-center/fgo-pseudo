...
void __fastcall ScriptAssetListViewMenu__Close(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !scriptObjectListViewMenu )
LABEL_6:
    sub_B52A5C(scriptObjectListViewMenu, v3);
...
void __fastcall ScriptAssetListViewMenu__EndInput(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( LODWORD(this->fields.selectAssetPath) )
  {
    ...
    {
      sub_B52A5C(scriptObjectListViewMenu, method);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B46F3 & 1) == 0 )
  {
    sub_B52984(&ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
    sub_B52984(&Method_ScriptAssetListViewMenu_OnEndSelectObject__);
  ...
  if ( !Instance
    || (CommonUI__maskFadein(Instance, 0.1, 0LL, 0LL),
        ...
        v8 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_B52A54(ScriptObjectListViewMenu_CallbackFunc_TypeInfo),
  ...
  if ( LODWORD(this->fields.selectAssetPath) == 2 )
  {
    ...
    if ( scriptObjectListViewMenu )
    {
      ...
      if ( scriptObjectListViewMenu )
      {
        ...
        LODWORD(this->fields.selectAssetPath) = 3;
        selectObjectPath = this->fields.selectObjectPath;
        v15 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_B52A54(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
        ScriptObjectListViewMenu_CallbackFunc___ctor(
          v15,
          (Il2CppObject *)this,
          Method_ScriptAssetListViewMenu_OnEndSelectObject__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B46F2 & 1) == 0 )
  {
    ...
    sub_B52984(&ScriptManager_CallbackBranchList_TypeInfo);
    sub_B52984(&Method_ScriptAssetListViewMenu_OnClickItem__);
    sub_B52984(&ScriptManager_TypeInfo);
    sub_B52984(&Method_ScriptAssetListViewMenu___c__DisplayClass20_0__OnEndSelectObject_b__0__);
    sub_B52984(&ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo);
    sub_B52984(&StringLiteral_886/*"/"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42B46F2 = 1;
  }
  v7 = sub_B52A54(ScriptAssetListViewMenu___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 16) = this;
  ...
  if ( !scriptBranchMenu )
LABEL_26:
    sub_B52A5C(scriptBranchMenu, v9);
  if ( (result & 0xFFFFFFFE) != 2 )
  {
    ...
    if ( scriptObjectListViewMenu )
    {
      ScriptAssetListViewManager__SetMode_33930160(scriptObjectListViewMenu, 1, v50, v51);
  ...
  *(_QWORD *)(v7 + 24) = callbackFunc;
  sub_B52920((BattleServantConfConponent_o *)(v7 + 24), callbackFunc, v25, v26, v27, v28, v29, v30);
    ...
    && System_String__op_Inequality(*v24, (System_String_o *)StringLiteral_1/*""*/, 0LL) )
  {
    ...
    *(_QWORD *)(v7 + 40) = StartModeForAssetStorage;
    sub_B52920((BattleServantConfConponent_o *)(v7 + 40), StartModeForAssetStorage, v33, v34, v35, v36, v37, v38);
    v39 = System_String__IndexOf_44640664(selectObjectPath, (System_String_o *)StringLiteral_886/*"/"*/, 0LL);
    ...
    *(_QWORD *)(v7 + 48) = selectObjectPath;
    ...
    v48 = (ScriptManager_CallbackBranchList_o *)sub_B52A54(ScriptManager_CallbackBranchList_TypeInfo);
  ...
  if ( selectAssetPath == 6 || !selectAssetPath )
  {
    ...
    if ( !scriptTestAssetCancelButton
      ...
      || (UnityEngine_Behaviour__set_enabled((UnityEngine_Behaviour_o *)scriptTestAssetCancelButton, 0, 0LL),
          (scriptTestAssetCancelButton = (UnityEngine_GameObject_o *)this->fields.scriptObjectListViewMenu) == 0LL) )
    {
      sub_B52A5C(scriptTestAssetCancelButton, v10);
    }
...
void __fastcall ScriptAssetListViewMenu__StartInput(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !scriptObjectListViewMenu
    || (ScriptAssetListViewManager__SetMode_33930160(scriptObjectListViewMenu, 1, v4, v7),
        (listViewManager = (UnityEngine_Behaviour_o *)this->fields.listViewManager) == 0LL) )
  {
    sub_B52A5C(listViewManager, v6);
  }
...
void __fastcall ScriptAssetListViewMenu__StartMenu(ScriptAssetListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B46ED & 1) == 0 )
  {
    ...
    sub_B52984(&ScriptAssetListViewMenu_CallbackFunc_TypeInfo);
    sub_B52984(&Method_ScriptAssetListViewMenu__StartMenu_b__9_0__);
    sub_B52984(&StringLiteral_12713/*"ScriptActionEncrypt"*/);
    byte_42B46ED = 1;
  }
  ...
  AssetManager__resetAssetStorageVersion((System_String_o *)StringLiteral_12713/*"ScriptActionEncrypt"*/, 0LL);
  v3 = (ScriptAssetListViewMenu_CallbackFunc_o *)sub_B52A54(ScriptAssetListViewMenu_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ADAD6 & 1) == 0 )
  {
    ...
    sub_B52984(&ScriptBranchMenu_CallbackFunc_TypeInfo);
    sub_B52984(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__);
    sub_B52984(&ScriptManager_TypeInfo);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_B52984(&Method_ScriptAssetListViewMenu___c__DisplayClass20_0__OnEndSelectObject_b__1__);
    byte_42ADAD6 = 1;
  }
  if ( list )
  {
    ...
    if ( !_9__1 )
    {
      _9__1 = (ScriptBranchMenu_CallbackFunc_o *)sub_B52A54(ScriptBranchMenu_CallbackFunc_TypeInfo);
...
LABEL_13:
    ...
    ScriptBranchMenu__Open(v6, list, _9__1, 0LL);
  }
  else
  {
    startMode = v4->fields.startMode;
    name = v4->fields.name;
    v11 = (Il2CppObject *)v4->fields.__4__this;
    labelPath = v4->fields.labelPath;
    jumpLine = v4->fields.jumpLine;
    v13 = (ScriptManager_CallbackFunc_o *)sub_B52A54(ScriptManager_CallbackFunc_TypeInfo);
    ScriptManager_CallbackFunc___ctor(v13, v11, Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, 0LL);
    if ( (BYTE3(ScriptManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !ScriptManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(ScriptManager_TypeInfo);
    }
    ScriptManager__DebugPlay(startMode, name, labelPath, jumpLine, v13, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  ScriptManager_CallbackFunc_o *v11; // x23
  struct ScriptAssetListViewMenu_o *v12; // x8
  ...
  if ( (byte_42ADAD7 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_ScriptAssetListViewMenu_EndPlayScriptDebug__);
    sub_B52984(&Method_ScriptAssetListViewMenu_OnEndSelectObject__);
    this = (ScriptAssetListViewMenu___c__DisplayClass20_0_o *)sub_B52984(&ScriptManager_TypeInfo);
    byte_42ADAD7 = 1;
  }
  _4__this = v4->fields.__4__this;
  if ( !_4__this )
  ...
  if ( !b )
  {
    ...
    if ( v12 )
    {
      LODWORD(v12->fields.selectAssetPath) = 3;
      v13 = (Il2CppObject *)v4->fields.__4__this;
      if ( v13 )
      {
        klass = (ScriptObjectListViewMenu_o *)v13[5].klass;
        monitor = (System_String_o *)v13[6].monitor;
        v16 = (ScriptObjectListViewMenu_CallbackFunc_o *)sub_B52A54(ScriptObjectListViewMenu_CallbackFunc_TypeInfo);
        ScriptObjectListViewMenu_CallbackFunc___ctor(v16, v13, Method_ScriptAssetListViewMenu_OnEndSelectObject__, 0LL);
        if ( klass )
        {
          ScriptObjectListViewMenu__Open(klass, monitor, v16, 0LL);
          return;
        }
      }
    }
LABEL_14:
  ...
  labelPath = v4->fields.labelPath;
  jumpLine = v4->fields.jumpLine;
  v11 = (ScriptManager_CallbackFunc_o *)sub_B52A54(ScriptManager_CallbackFunc_TypeInfo);
  ScriptManager_CallbackFunc___ctor(v11, v9, Method_ScriptAssetListViewMenu_EndPlayScriptDebug__, 0LL);
  if ( (BYTE3(ScriptManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !ScriptManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(ScriptManager_TypeInfo);
