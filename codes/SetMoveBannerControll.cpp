        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A565CC & 1) == 0 )
  {
    ...
    this = (SetMoveBannerControll_o *)sub_1B885B0(&Method_SetMoveBannerControll_OnMoveFinish__);
    byte_4A565CC = 1;
  }
  ...
  this = (SetMoveBannerControll_o *)EventDelegate__Set_46771408(onFinished, v12, 0LL);
  if ( !target
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
        ...
        *p_tp = (SetMoveBannerControll_o *)Component_object,
        sub_1B88554(&v8->fields.tp, Component_object),
        (this = *p_tp) == 0LL) )
  {
LABEL_9:
...
void __fastcall SetMoveBannerControll__rePositionLeft(SetMoveBannerControll_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A565CD & 1) == 0 )
  {
    this = (SetMoveBannerControll_o *)sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___);
    byte_4A565CD = 1;
  }
...
LABEL_21:
      ...
      sub_1B88554(&v2->fields.tp, Component_object);
      tp = v2->fields.tp;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A565CB & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SetMoveBannerControll___c__setBanner_b__15_0__);
    sub_1B885B0(&SetMoveBannerControll___c_TypeInfo);
    sub_1B885B0(&StringLiteral_17062/*"banner_event_002"*/);
    byte_4A565CB = 1;
  }
  ...
  if ( !v6 )
  {
    ...
    v6 = (System_Comparison_T__o *)sub_1B887FC(System_Comparison_EventEntity__TypeInfo);
    ...
    bannerPanel = (void *)sub_1B88554(&static_fields->__9__15_0, v6);
  }
  if ( !eventDataList )
    goto LABEL_35;
  ...
  v10 = (struct UnityEngine_GameObject_array *)sub_1B88658(UnityEngine_GameObject___TypeInfo, (unsigned int)size);
  this->fields.bannerList = v10;
  p_bannerList = &this->fields.bannerList;
  sub_1B88554(&this->fields.bannerList, v10);
  if ( (int)size >= 1 )
  {
    v13 = 0LL;
    p_tp = &this->fields.tp;
    ...
    while ( 1 )
    {
      ...
      if ( (v13 & 1) != 0 )
      {
        ...
        if ( !bannerPanel )
          break;
        UISprite__set_spriteName((UISprite_o *)bannerPanel, (System_String_o *)StringLiteral_17062/*"banner_event_002"*/, 0LL);
      }
      else if ( !bannerPanel )
      {
        break;
      ...
      if ( !byte_4A55CE6 )
      {
        bannerPanel = (void *)sub_1B885B0(&UnityEngine_Vector3_TypeInfo);
        byte_4A55CE6 = 1;
      }
      if ( !v24 )
        break;
      ...
      *p_tp = (struct TweenPosition_o *)Component_object;
      sub_1B88554(&this->fields.tp, Component_object);
      bannerPanel = *p_tp;
      if ( !*p_tp )
        break;
      ...
      *(UnityEngine_Vector3_o *)&v27 = UnityEngine_Transform__get_localPosition(
      ...
      if ( v13 >= v30->max_length )
        sub_1B88814(bannerPanel, eventDataList);
      *(Il2CppClass **)((char *)&v30->obj.klass + v15) = (Il2CppClass *)v18;
      sub_1B88554((char *)v30 + v15, v18);
      ++v13;
      v15 += 8LL;
      if ( size == v13 )
        goto LABEL_34;
...
LABEL_35:
    sub_1B8880C(bannerPanel, eventDataList);
  }
  v23 = 0.0;
LABEL_34:
...
void __fastcall SetMoveBannerControll___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(SetMoveBannerControll___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  SetMoveBannerControll___c_TypeInfo->static_fields->__9 = (struct SetMoveBannerControll___c_o *)v1;
  sub_1B88554(SetMoveBannerControll___c_TypeInfo->static_fields, v1);
}
