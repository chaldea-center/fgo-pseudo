        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9CE & 1) == 0 )
  {
    sub_1BDB878(&EventDelegate_Callback_TypeInfo, target);
    sub_1BDB878(&EventDelegate_TypeInfo, v9);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___, v10);
    this = (SetMoveBannerControll_o *)sub_1BDB878(&Method_SetMoveBannerControll_OnMoveFinish__, v11);
    byte_4B3F9CE = 1;
  }
  ...
  this = (SetMoveBannerControll_o *)EventDelegate__Set_48553224(onFinished, v15, 0LL);
  if ( !target
...
void __fastcall SetMoveBannerControll__rePositionLeft(SetMoveBannerControll_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9CF & 1) == 0 )
  {
    this = (SetMoveBannerControll_o *)sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___, method);
    byte_4B3F9CF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9CD & 1) == 0 )
  {
    sub_1BDB878(&System_Comparison_EventEntity__TypeInfo, eventDataList);
    sub_1BDB878(&UnityEngine_GameObject___TypeInfo, v5);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___, v6);
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_UISprite___, v7);
    sub_1BDB878(&Method_System_Collections_Generic_List_EventEntity__Sort__, v8);
    sub_1BDB878(&Method_System_Collections_Generic_List_EventEntity__get_Count__, v9);
    sub_1BDB878(&Method_SetMoveBannerControll___c__setBanner_b__15_0__, v10);
    sub_1BDB878(&SetMoveBannerControll___c_TypeInfo, v11);
    sub_1BDB878(&StringLiteral_17040/*"banner_event_002"*/, v12);
    byte_4B3F9CD = 1;
  }
  ...
  if ( !v14 )
  {
    ...
    v14 = (System_Comparison_T__o *)sub_1BDBAC4(System_Comparison_EventEntity__TypeInfo);
    ...
    bannerPanel = sub_1BDB81C(&static_fields->__9__15_0);
  }
  if ( !eventDataList )
    goto LABEL_35;
  ...
  this->fields.bannerList = (struct UnityEngine_GameObject_array *)sub_1BDB920(
                                                                     UnityEngine_GameObject___TypeInfo,
                                                                     (unsigned int)size);
  p_bannerList = &this->fields.bannerList;
  sub_1BDB81C(&this->fields.bannerList);
  if ( (int)size >= 1 )
  {
    v20 = 0LL;
    p_tp = &this->fields.tp;
    ...
    while ( 1 )
    {
      ...
      if ( (v20 & 1) != 0 )
      {
        ...
        if ( !bannerPanel )
          break;
        UISprite__set_spriteName((UISprite_o *)bannerPanel, (System_String_o *)StringLiteral_17040/*"banner_event_002"*/, 0LL);
      }
      else if ( !bannerPanel )
      {
        break;
      ...
      if ( !byte_4B3E916 )
      {
        bannerPanel = sub_1BDB878(&UnityEngine_Vector3_TypeInfo, eventDataList);
        byte_4B3E916 = 1;
      }
      if ( !v31 )
        break;
      ...
      *(UnityEngine_Vector3_o *)&v34 = UnityEngine_Transform__get_localPosition(
      ...
      if ( v20 >= v37->max_length )
        sub_1BDBADC(bannerPanel, eventDataList, v33);
      *(Il2CppClass **)((char *)&v37->obj.klass + v22) = (Il2CppClass *)v25;
      sub_1BDB81C((char *)v37 + v22);
      ++v20;
      v22 += 8LL;
      if ( size == v20 )
        goto LABEL_34;
...
LABEL_35:
    sub_1BDBAD4(bannerPanel, eventDataList);
  }
  v30 = 0.0;
LABEL_34:
...
void __fastcall SetMoveBannerControll___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9D1 & 1) == 0 )
  {
    sub_1BDB878(&SetMoveBannerControll___c_TypeInfo, v1);
    byte_4B3F9D1 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(SetMoveBannerControll___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  SetMoveBannerControll___c_TypeInfo->static_fields->__9 = (struct SetMoveBannerControll___c_o *)v2;
  sub_1BDB81C(SetMoveBannerControll___c_TypeInfo->static_fields);
}
