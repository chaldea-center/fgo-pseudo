        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2FB9 & 1) == 0 )
  {
    ...
    this = (SetMoveBannerControll_o *)sub_B52984(&Method_SetMoveBannerControll_OnMoveFinish__);
    byte_42B2FB9 = 1;
  }
  ...
  this = (SetMoveBannerControll_o *)EventDelegate__Set_29653788(onFinished, v12, 0LL);
  if ( !target
...
void __fastcall SetMoveBannerControll__rePositionLeft(SetMoveBannerControll_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2FBA & 1) == 0 )
  {
    this = (SetMoveBannerControll_o *)sub_B52984(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___);
    byte_42B2FBA = 1;
  }
...
LABEL_21:
      ...
      sub_B52920((BattleServantConfConponent_o *)&v2->fields.tp, Component_srcLineSprite, v12, v13, v14, v15, v16, v17);
      tp = v2->fields.tp;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2FB8 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SetMoveBannerControll___c__setBanner_b__15_0__);
    sub_B52984(&SetMoveBannerControll___c_TypeInfo);
    sub_B52984(&StringLiteral_16717/*"banner_event_002"*/);
    byte_42B2FB8 = 1;
  }
  ...
  if ( !_9__15_0 )
  {
    ...
    _9__15_0 = (System_Comparison_TitleInfoControl_EventEndTimeInfo__o *)sub_B52A54(System_Comparison_EventEntity__TypeInfo);
  ...
  v17 = size;
  v18 = (struct UnityEngine_GameObject_array *)sub_B5299C(UnityEngine_GameObject___TypeInfo, (unsigned int)size);
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (v27 & 1) != 0 )
      {
        ...
        if ( !bannerPanel )
          break;
        UISprite__set_spriteName((UISprite_o *)bannerPanel, (System_String_o *)StringLiteral_16717/*"banner_event_002"*/, 0LL);
      }
      else if ( !bannerPanel )
      {
        break;
      ...
      *(UnityEngine_Vector3_o *)&v50 = UnityEngine_Transform__get_localPosition(
      ...
      if ( !*p_bannerList )
        break;
      v54 = sub_B52A44(v32, *(_QWORD *)(*(_QWORD *)v53 + 64LL));
      if ( !v54 )
      {
        v61 = sub_B52A7C(0LL);
        sub_B52A28(v61, 0LL);
      ...
      *(_QWORD *)&v53[v29] = v32;
      sub_B52920((BattleServantConfConponent_o *)&v53[v29], (System_Int32_array **)v32, v55, v56, v57, v58, v59, v60);
      ++v27;
      v29 += 2LL;
      if ( (__int64)v27 >= v17 )
        goto LABEL_35;
...
LABEL_36:
    sub_B52A5C(bannerPanel, eventDataList);
  }
  v37 = 0.0;
LABEL_35:
...
void __fastcall SetMoveBannerControll___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(SetMoveBannerControll___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  static_fields = SetMoveBannerControll___c_TypeInfo->static_fields;
  static_fields->__9 = (struct SetMoveBannerControll___c_o *)v1;
