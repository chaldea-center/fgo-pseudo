        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74FBB & 1) == 0 )
  {
    sub_1D0F0B4(&IWarBoardObjectData_IndivGetArgs_TypeInfo);
    byte_4E74FBB = 1;
  }
  v9 = (Il2CppObject *)sub_1D0F300(IWarBoardObjectData_IndivGetArgs_TypeInfo);
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.indivGetArgs, (int32_t)v9, v11, v12, v13, v14, v15, v16);
  ...
  sub_1D0F058(p_multiIndividuality, (int32_t)SortedMultiIndividuality, v22, v23, v24, v25, v26, v27);
  ...
  {
LABEL_8:
    sub_1D0F30C(IsIncludeIgnoreIndividuality, v19);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74FBC & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_HashSet_IWarBoardObjectData__Add__);
    sub_1D0F0B4(&IWarBoardObjectData_TypeInfo);
    sub_1D0F0B4(&Individuality_TypeInfo);
    this = (IndividualityTargetDetector_o *)sub_1D0F0B4(&WarBoardPieceData_TypeInfo);
    byte_4E74FBC = 1;
  }
  if ( !objectArray )
LABEL_49:
    sub_1D0F30C(this, objectArray);
  ...
  if ( max_length >= 1 )
  {
    for ( i = 0; i < max_length; ++i )
    {
      ...
      {
LABEL_12:
        v11 = sub_1CE5430(v7, IWarBoardObjectData_TypeInfo, 2);
      }
...
LABEL_36:
        ...
        {
LABEL_40:
          v21 = sub_1CE5430(v7, IWarBoardObjectData_TypeInfo, 6);
        }
        ...
        if ( ((unsigned __int8)this & 1) != 0 )
        {
          ...
          this = (IndividualityTargetDetector_o *)System_Collections_Generic_HashSet_object___Add(
                                                    ...
                                                    v7,
                                                    (const MethodInfo_3807D78 *)Method_System_Collections_Generic_HashSet_IWarBoardObjectData__Add__);
        }
      }
LABEL_47:
      max_length = objectArray->max_length;
