        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC34C0 & 1) == 0 )
  {
    sub_1C1ABD4(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, method);
    sub_1C1ABD4(&Method_SoundPlayerShopItemComponent_OnClickItem__, v3);
    sub_1C1ABD4(&Method_SoundPlayerShopItemComponent_closeItemDetail__, v4);
    byte_4BC34C0 = 1;
  }
  v5 = Method_SoundPlayerShopItemComponent_OnClickItem__;
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_OnClickItem__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C1ABEC(Method_SoundPlayerShopItemComponent_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC34C1 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SoundPlayerShopItemComponent_closeItemDetail__, isDecide);
    byte_4BC34C1 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_closeItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C1ABEC(Method_SoundPlayerShopItemComponent_closeItemDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC34BF & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_ItemMaster___, usrId);
    ...
    sub_1C1ABD4(&StringLiteral_25790/*"必要"*/, v16);
    sub_1C1ABD4(&StringLiteral_25791/*"所持"*/, v17);
    sub_1C1ABD4(&StringLiteral_25354/*"{0:#,0}"*/, v18);
    byte_4BC34BF = 1;
  }
  entity = 0LL;
  v44 = 0LL;
...
LABEL_17:
  ...
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25790/*"必要"*/, 0LL);
  Instance = (__int64)this->fields.haveTitleLb;
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25791/*"所持"*/, 0LL);
  ...
  Instance = (__int64)System_String__Format((System_String_o *)StringLiteral_25354/*"{0:#,0}"*/, v27, 0LL);
  if ( !haveNumLb )
    goto LABEL_40;
  ...
  Instance = (__int64)System_String__Format((System_String_o *)StringLiteral_25354/*"{0:#,0}"*/, v32, 0LL);
  if ( !needNumLb )
    goto LABEL_40;
...
LABEL_29:
  ...
  Instance = sub_1C1AB78(&this->fields.itemEnt);
  itemEnt = this->fields.itemEnt;
  if ( !itemEnt )
    goto LABEL_40;
