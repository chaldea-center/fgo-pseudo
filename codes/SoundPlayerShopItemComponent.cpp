        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA0E1 & 1) == 0 )
  {
    sub_1B64870(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, method);
    sub_1B64870(&Method_SoundPlayerShopItemComponent_OnClickItem__, v3);
    sub_1B64870(&Method_SoundPlayerShopItemComponent_closeItemDetail__, v4);
    byte_49FA0E1 = 1;
  }
  v5 = Method_SoundPlayerShopItemComponent_OnClickItem__;
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_OnClickItem__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B64888(Method_SoundPlayerShopItemComponent_OnClickItem__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B64854(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
  itemDetailComp = this->fields.itemDetailComp;
  itemEnt = this->fields.itemEnt;
  v9 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1B64ABC(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA0E2 & 1) == 0 )
  {
    sub_1B64870(&Method_SoundPlayerShopItemComponent_closeItemDetail__, isDecide);
    byte_49FA0E2 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_closeItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B64888(Method_SoundPlayerShopItemComponent_closeItemDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA0E0 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_ItemMaster___, usrId);
    ...
    sub_1B64870(&StringLiteral_25264/*"必要"*/, v16);
    sub_1B64870(&StringLiteral_25265/*"所持"*/, v17);
    sub_1B64870(&StringLiteral_24838/*"{0:#,0}"*/, v18);
    byte_49FA0E0 = 1;
  }
  entity = 0LL;
  v44 = 0LL;
...
LABEL_17:
  ...
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25264/*"必要"*/, 0LL);
  Instance = (__int64)this->fields.haveTitleLb;
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25265/*"所持"*/, 0LL);
  ...
  Instance = (__int64)System_String__Format((System_String_o *)StringLiteral_24838/*"{0:#,0}"*/, v27, 0LL);
  if ( !haveNumLb )
    goto LABEL_40;
  ...
  Instance = (__int64)System_String__Format((System_String_o *)StringLiteral_24838/*"{0:#,0}"*/, v32, 0LL);
  if ( !needNumLb )
    goto LABEL_40;
...
LABEL_29:
  ...
  Instance = sub_1B64814(&this->fields.itemEnt);
  itemEnt = this->fields.itemEnt;
  if ( !itemEnt )
    goto LABEL_40;
