...
void SoundPlayerShopItemComponent__OnClickItem(SoundPlayerShopItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB19F5 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_SoundPlayerShopItemComponent_OnClickItem__);
    sub_1C6BA08(&Method_SoundPlayerShopItemComponent_closeItemDetail__);
    byte_4CB19F5 = 1;
  }
  v3 = Method_SoundPlayerShopItemComponent_OnClickItem__;
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_OnClickItem__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C6BA20(Method_SoundPlayerShopItemComponent_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_closeItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C6BA20(Method_SoundPlayerShopItemComponent_closeItemDetail__);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v31; // [xsp+8h] [xbp-78h] BYREF
  ...
  if ( (byte_4CB19F4 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_25589/*"必要"*/);
    sub_1C6BA08(&StringLiteral_25590/*"所持"*/);
...
LABEL_17:
  ...
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25589/*"必要"*/, 0);
  Instance = this->fields.haveTitleLb;
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25590/*"所持"*/, 0);
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25162/*"{0:#,0}"*/, v16, 0);
  if ( !haveNumLb )
    goto LABEL_40;
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25162/*"{0:#,0}"*/, v18, 0);
  if ( !needNumLb )
    goto LABEL_40;
  ...
  if ( this->fields.haveItemNum >= this->fields.needItemNum )
  {
    ...
    if ( Instance )
    {
      ...
      v36.fields.a = 1.0;
      v19 = 1.0;
      UIWidget__set_color((UIWidget_o *)Instance, v36, 0);
...
LABEL_40:
  ...
  v21 = 0.0;
  v22 = 1.0;
  UIWidget__set_color((UIWidget_o *)Instance, v35, 0);
  Instance = this->fields.needNumLb;
  if ( !Instance )
    goto LABEL_40;
LABEL_29:
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)v23, v24, v25);
  itemEnt = this->fields.itemEnt;
  if ( !itemEnt )
    goto LABEL_40;
  ...
  if ( !Instance )
    goto LABEL_40;
  v34.fields.x = -(float)((float)((float)idx * 135.0) + -135.0);
  v34.fields.y = y;
  v34.fields.z = z;
