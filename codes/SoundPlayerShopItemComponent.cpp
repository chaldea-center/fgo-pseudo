        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE723 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_SoundPlayerShopItemComponent_OnClickItem__, v3);
    sub_1B00CCC(&Method_SoundPlayerShopItemComponent_closeItemDetail__, v4);
    byte_48DE723 = 1;
  }
  v5 = Method_SoundPlayerShopItemComponent_OnClickItem__;
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_OnClickItem__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B00CE4(Method_SoundPlayerShopItemComponent_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE724 & 1) == 0 )
  {
    sub_1B00CCC(&Method_SoundPlayerShopItemComponent_closeItemDetail__, isDecide);
    byte_48DE724 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_closeItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B00CE4(Method_SoundPlayerShopItemComponent_closeItemDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DE722 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_ItemMaster___, usrId);
    ...
    sub_1B00CCC(&StringLiteral_24992/*"必要"*/, v16);
    sub_1B00CCC(&StringLiteral_24993/*"所持"*/, v17);
    sub_1B00CCC(&StringLiteral_24569/*"{0:#,0}"*/, v18);
    byte_48DE722 = 1;
  }
  entity = 0LL;
  v47 = 0LL;
...
LABEL_17:
  ...
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_24992/*"必要"*/, 0LL);
  Instance = this->fields.haveTitleLb;
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_24993/*"所持"*/, 0LL);
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_24569/*"{0:#,0}"*/, v27, 0LL);
  if ( !haveNumLb )
    goto LABEL_40;
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_24569/*"{0:#,0}"*/, v32, 0LL);
  if ( !needNumLb )
    goto LABEL_40;
...
LABEL_29:
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.itemEnt, (int32_t)v37, v38, v39);
  itemEnt = this->fields.itemEnt;
  if ( !itemEnt )
    goto LABEL_40;
