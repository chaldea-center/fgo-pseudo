...
void SoundPlayerShopItemComponent__OnClickItem(SoundPlayerShopItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C33135 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SoundPlayerShopItemComponent_OnClickItem__);
    sub_1C32C20(&Method_SoundPlayerShopItemComponent_closeItemDetail__);
    byte_4C33135 = 1;
  }
  v3 = Method_SoundPlayerShopItemComponent_OnClickItem__;
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_OnClickItem__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C32C38(Method_SoundPlayerShopItemComponent_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_closeItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C32C38(Method_SoundPlayerShopItemComponent_closeItemDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C33134 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_25474/*"必要"*/);
    sub_1C32C20(&StringLiteral_25475/*"所持"*/);
...
LABEL_17:
  ...
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25474/*"必要"*/, 0);
  Instance = this->fields.haveTitleLb;
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25475/*"所持"*/, 0);
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25047/*"{0:#,0}"*/, v21, 0);
  if ( !haveNumLb )
    goto LABEL_40;
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25047/*"{0:#,0}"*/, v29, 0);
  if ( !needNumLb )
    goto LABEL_40;
...
LABEL_29:
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.itemEnt, (int32_t)v34, v35, v36);
  itemEnt = this->fields.itemEnt;
  if ( !itemEnt )
    goto LABEL_40;
