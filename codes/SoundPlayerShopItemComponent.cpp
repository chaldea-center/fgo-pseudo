...
void SoundPlayerShopItemComponent__OnClickItem(SoundPlayerShopItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BFC1 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SoundPlayerShopItemComponent_OnClickItem__);
    sub_1C93AD4(&Method_SoundPlayerShopItemComponent_closeItemDetail__);
    byte_4D2BFC1 = 1;
  }
  v3 = Method_SoundPlayerShopItemComponent_OnClickItem__;
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_OnClickItem__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_SoundPlayerShopItemComponent_OnClickItem__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_closeItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C93AEC(Method_SoundPlayerShopItemComponent_closeItemDetail__);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v33; // [xsp+8h] [xbp-78h] BYREF
  ...
  if ( (byte_4D2BFC0 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_25804/*"必要"*/);
    sub_1C93AD4(&StringLiteral_25805/*"所持"*/);
...
LABEL_17:
  ...
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25804/*"必要"*/, 0);
  Instance = this->fields.haveTitleLb;
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25805/*"所持"*/, 0);
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25376/*"{0:#,0}"*/, v16, 0);
  if ( !haveNumLb )
    goto LABEL_40;
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25376/*"{0:#,0}"*/, v18, 0);
  if ( !needNumLb )
    goto LABEL_40;
...
LABEL_29:
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.itemEnt, (int32_t)v23, v24, v25, v26, v27, v28, v29);
  itemEnt = this->fields.itemEnt;
  if ( !itemEnt )
    goto LABEL_40;
