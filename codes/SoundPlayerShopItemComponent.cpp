...
void SoundPlayerShopItemComponent__OnClickItem(SoundPlayerShopItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE9CD3 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SoundPlayerShopItemComponent_OnClickItem__);
    sub_1C7BAE8(&Method_SoundPlayerShopItemComponent_closeItemDetail__);
    byte_4CE9CD3 = 1;
  }
  v3 = Method_SoundPlayerShopItemComponent_OnClickItem__;
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_OnClickItem__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C7BB00(Method_SoundPlayerShopItemComponent_OnClickItem__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  itemDetailComp = this->fields.itemDetailComp;
  itemEnt = this->fields.itemEnt;
  v7 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1C7BD34(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SoundPlayerShopItemComponent_closeItemDetail__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C7BB00(Method_SoundPlayerShopItemComponent_closeItemDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE9CD2 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_25734/*"必要"*/);
    sub_1C7BAE8(&StringLiteral_25735/*"所持"*/);
...
LABEL_17:
  ...
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25734/*"必要"*/, 0);
  Instance = this->fields.haveTitleLb;
  if ( !Instance )
    goto LABEL_40;
  UILabel__set_text((UILabel_o *)Instance, (System_String_o *)StringLiteral_25735/*"所持"*/, 0);
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25307/*"{0:#,0}"*/, v16, 0);
  if ( !haveNumLb )
    goto LABEL_40;
  ...
  Instance = System_String__Format((System_String_o *)StringLiteral_25307/*"{0:#,0}"*/, v18, 0);
  if ( !needNumLb )
    goto LABEL_40;
...
LABEL_29:
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.itemEnt, (int32_t)v23, v24, v25, v26, v27, v28, v29);
  itemEnt = this->fields.itemEnt;
  if ( !itemEnt )
    goto LABEL_40;
