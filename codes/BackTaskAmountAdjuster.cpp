void BackTaskAmountAdjuster___ctor(BackTaskAmountAdjuster_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Diagnostics_Stopwatch_o *)sub_1C32E6C(System_Diagnostics_Stopwatch_TypeInfo);
  System_Diagnostics_Stopwatch___ctor(v3, 0);
  this->fields.stopwatch = v3;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.stopwatch, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3963D & 1) == 0 )
  {
    sub_1C32C20(&BackTaskAmountAdjuster__Execute_d__9_TypeInfo);
    byte_4C3963D = 1;
  }
  v5 = sub_1C32E6C(BackTaskAmountAdjuster__Execute_d__9_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  *(_DWORD *)(v5 + 16) = 0;
  *(_QWORD *)(v5 + 32) = this;
  sub_1C32BC4((CGThumbnailListItem_o *)(v5 + 32), (int32_t)this, v6, v7);
  *(_QWORD *)(v5 + 40) = bgTask;
  sub_1C32BC4((CGThumbnailListItem_o *)(v5 + 40), (int32_t)bgTask, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3963E & 1) == 0 )
  {
    this = (BackTaskAmountAdjuster__Execute_d__9_o *)sub_1C32C20(&System_Collections_IEnumerator_TypeInfo);
    byte_4C3963E = 1;
  }
...
LABEL_26:
  ...
  while ( 1 )
  {
    ...
    {
LABEL_11:
      v8 = sub_1C83438(v2->fields.bgTask, System_Collections_IEnumerator_TypeInfo, 0);
    }
    ...
    {
LABEL_19:
      v13 = sub_1C83438(v2->fields.bgTask, System_Collections_IEnumerator_TypeInfo, 1);
    }
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      sub_1C32BC4(p__2__current, 0, v20, v21);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_BackTaskAmountAdjuster__Execute_d__9_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
