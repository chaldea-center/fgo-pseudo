...
void __fastcall EventInfoChronologyDialog__Init(EventInfoChronologyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B450BB & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___, v3);
    sub_1BDB878(&LocalizationManager_TypeInfo, v4);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v5);
    sub_1BDB878(&StringLiteral_3401/*"CHRONOLOGY_DIALOG_TITLE"*/, v6);
    sub_1BDB878(&StringLiteral_17971/*"chronology_line"*/, v7);
    sub_1BDB878(&StringLiteral_3400/*"CHRONOLOGY_DIALOG_CLOSE"*/, v8);
    byte_4B450BB = 1;
  }
  this->fields.state = 0;
  BaseDialog__Init((BaseDialog_o *)this, 0LL);
  this->fields.closeAction = 0LL;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.closeAction, 0, v9, v10);
  ...
  if ( ((unsigned __int8)grid & 1) != 0 )
  {
    ...
    if ( System_String__IsNullOrEmpty(v14->fields.mText, 0LL) )
    {
      ...
      grid = LocalizationManager__Get((System_String_o *)StringLiteral_3401/*"CHRONOLOGY_DIALOG_TITLE"*/, 0LL);
      if ( !v15 )
        goto LABEL_48;
  ...
  if ( ((unsigned __int8)grid & 1) != 0 )
  {
    ...
    if ( System_String__IsNullOrEmpty(v17->fields.mText, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      grid = LocalizationManager__Get((System_String_o *)StringLiteral_3400/*"CHRONOLOGY_DIALOG_CLOSE"*/, 0LL);
      if ( v18 )
      {
...
LABEL_22:
  ...
  if ( UnityEngine_Object__op_Inequality(failySprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v20, (System_String_o *)StringLiteral_17971/*"chronology_line"*/, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(queenSprite, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v22, (System_String_o *)StringLiteral_17971/*"chronology_line"*/, 0LL);
  }
        ...
        if ( grid )
        {
          ...
          if ( grid )
          {
            Component_object = UnityEngine_GameObject__GetComponent_object_(
                                 ...
                                 (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___);
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B450BD & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_EventInfoChronologyDialog_OnClickCloseButton__, v3);
    sub_1BDB878(&Method_EventInfoChronologyDialog__OnClickCloseButton_b__17_0__, v4);
    byte_4B450BD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoChronologyDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BDB890(Method_EventInfoChronologyDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B450BC & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, closeAction);
    sub_1BDB878(&Method_EventInfoChronologyDialog__Open_b__16_0__, v5);
    byte_4B450BC = 1;
  }
  EventInfoChronologyDialog__Init(this, (const MethodInfo *)closeAction);
  this->fields.state = 1;
  this->fields.closeAction = closeAction;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.closeAction, (int32_t)closeAction, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
  {
    ...
    sub_1BDB81C(p_closeAction, 0, v7, v8);
  }
}
