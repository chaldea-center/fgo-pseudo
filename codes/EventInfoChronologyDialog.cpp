...
void EventInfoChronologyDialog__Init(EventInfoChronologyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2CAA4 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___);
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_3364/*"CHRONOLOGY_DIALOG_TITLE"*/);
    sub_1C94098(&StringLiteral_18057/*"chronology_line"*/);
    sub_1C94098(&StringLiteral_3363/*"CHRONOLOGY_DIALOG_CLOSE"*/);
    byte_4D2CAA4 = 1;
  }
  this->fields.state = 0;
  BaseDialog__Init((BaseDialog_o *)this, 0);
  this->fields.closeAction = 0;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.closeAction, 0, v3, v4, v5, v6, v7, v8);
  ...
  if ( ((unsigned __int8)grid & 1) != 0 )
  {
    ...
    if ( System_String__IsNullOrEmpty(v12->fields.mText, 0) )
    {
      ...
      grid = LocalizationManager__Get((System_String_o *)StringLiteral_3364/*"CHRONOLOGY_DIALOG_TITLE"*/, 0);
      if ( !v13 )
        goto LABEL_48;
  ...
  if ( ((unsigned __int8)grid & 1) != 0 )
  {
    ...
    if ( System_String__IsNullOrEmpty(v15->fields.mText, 0) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      grid = LocalizationManager__Get((System_String_o *)StringLiteral_3363/*"CHRONOLOGY_DIALOG_CLOSE"*/, 0);
      if ( v16 )
      {
...
LABEL_22:
  ...
  if ( UnityEngine_Object__op_Inequality(failySprite, 0, 0) )
  {
    ...
    AtlasManager__SetEventUI(v18, (System_String_o *)StringLiteral_18057/*"chronology_line"*/, 0);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(queenSprite, 0, 0) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v20, (System_String_o *)StringLiteral_18057/*"chronology_line"*/, 0);
  }
        ...
        if ( grid )
        {
          ...
          if ( grid )
          {
            Component_object = UnityEngine_GameObject__GetComponent_object_(
                                 ...
                                 (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___);
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void EventInfoChronologyDialog__OnClickCloseButton(EventInfoChronologyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2CAA6 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_EventInfoChronologyDialog_OnClickCloseButton__);
    sub_1C94098(&Method_EventInfoChronologyDialog__OnClickCloseButton_b__17_0__);
    byte_4D2CAA6 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoChronologyDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_EventInfoChronologyDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&Method_EventInfoChronologyDialog__Open_b__16_0__);
    byte_4D2CAA5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
  {
    ...
    sub_1C9403C(p_closeAction, 0, v7, v8, v9, v10, v11, v12);
  }
}
