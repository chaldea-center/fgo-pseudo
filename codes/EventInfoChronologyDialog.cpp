...
void __fastcall EventInfoChronologyDialog__Init(EventInfoChronologyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC828C & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___, v3);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v4);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v5);
    sub_1C1ABD4(&StringLiteral_3511/*"CHRONOLOGY_DIALOG_TITLE"*/, v6);
    sub_1C1ABD4(&StringLiteral_18257/*"chronology_line"*/, v7);
    sub_1C1ABD4(&StringLiteral_3510/*"CHRONOLOGY_DIALOG_CLOSE"*/, v8);
    byte_4BC828C = 1;
  }
  this->fields.state = 0;
  BaseDialog__Init((BaseDialog_o *)this, 0LL);
  this->fields.closeAction = 0LL;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.closeAction, 0LL, v9, v10, v11, v12, v13, v14);
  ...
  if ( ((unsigned __int8)grid & 1) != 0 )
  {
    ...
    if ( System_String__IsNullOrEmpty(v18->fields.mText, 0LL) )
    {
      ...
      grid = LocalizationManager__Get((System_String_o *)StringLiteral_3511/*"CHRONOLOGY_DIALOG_TITLE"*/, 0LL);
      if ( !v19 )
        goto LABEL_48;
  ...
  if ( ((unsigned __int8)grid & 1) != 0 )
  {
    ...
    if ( System_String__IsNullOrEmpty(v21->fields.mText, 0LL) )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      grid = LocalizationManager__Get((System_String_o *)StringLiteral_3510/*"CHRONOLOGY_DIALOG_CLOSE"*/, 0LL);
      if ( v22 )
      {
...
LABEL_22:
  ...
  if ( UnityEngine_Object__op_Inequality(failySprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetEventUI(v24, (System_String_o *)StringLiteral_18257/*"chronology_line"*/, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(queenSprite, 0LL, 0LL) )
  {
    ...
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
    AtlasManager__SetEventUI(v26, (System_String_o *)StringLiteral_18257/*"chronology_line"*/, 0LL);
  }
        ...
        if ( grid )
        {
          ...
          if ( grid )
          {
            Component_object = UnityEngine_GameObject__GetComponent_object_(
                                 ...
                                 (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___);
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC828E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_EventInfoChronologyDialog_OnClickCloseButton__, v3);
    sub_1C1ABD4(&Method_EventInfoChronologyDialog__OnClickCloseButton_b__17_0__, v4);
    byte_4BC828E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoChronologyDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C1ABEC(Method_EventInfoChronologyDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC828D & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, closeAction);
    sub_1C1ABD4(&Method_EventInfoChronologyDialog__Open_b__16_0__, v5);
    byte_4BC828D = 1;
  }
  EventInfoChronologyDialog__Init(this, (const MethodInfo *)closeAction);
  this->fields.state = 1;
  this->fields.closeAction = closeAction;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.closeAction, (int64_t)closeAction, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
  {
    ...
    sub_1C1AB78(p_closeAction, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
