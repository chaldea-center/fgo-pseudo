...
void __fastcall EventInfoChronologyDialog__Init(EventInfoChronologyDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FCF42 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___, v3);
    sub_1B640C8(&LocalizationManager_TypeInfo, v4);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v5);
    sub_1B640C8(&StringLiteral_3448/*"CHRONOLOGY_DIALOG_TITLE"*/, v6);
    sub_1B640C8(&StringLiteral_17898/*"chronology_line"*/, v7);
    sub_1B640C8(&StringLiteral_3447/*"CHRONOLOGY_DIALOG_CLOSE"*/, v8);
    byte_49FCF42 = 1;
  }
  this->fields.state = 0;
  BaseDialog__Init((BaseDialog_o *)this, 0LL);
  this->fields.closeAction = 0LL;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, 0, v9, v10);
  if ( !this->fields.initialized )
  {
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    queenSprite = LocalizationManager__Get((System_String_o *)StringLiteral_3448/*"CHRONOLOGY_DIALOG_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_27;
    UILabel__set_text(titleLabel, queenSprite, 0LL);
    closeLabel = this->fields.closeLabel;
    queenSprite = LocalizationManager__Get((System_String_o *)StringLiteral_3447/*"CHRONOLOGY_DIALOG_CLOSE"*/, 0LL);
    if ( !closeLabel )
      goto LABEL_27;
    ...
    queenSprite = (System_String_o *)AtlasManager__SetEventUI(failySprite, (System_String_o *)StringLiteral_17898/*"chronology_line"*/, 0LL);
    v15 = this->fields.failySprite;
    if ( !v15
      || (queenSprite = (System_String_o *)this->fields.queenSprite) == 0LL
      || (UISprite__set_atlas((UISprite_o *)queenSprite, v15->fields.mAtlas, 0LL),
          (queenSprite = (System_String_o *)this->fields.queenSprite) == 0LL)
      || (UISprite__set_spriteName((UISprite_o *)queenSprite, (System_String_o *)StringLiteral_17898/*"chronology_line"*/, 0LL),
          (queenSprite = (System_String_o *)this->fields.grid) == 0LL) )
    {
LABEL_27:
      sub_1B64324(queenSprite);
    }
    v16 = 0;
    while ( 1 )
    {
      ...
      if ( !queenSprite )
        goto LABEL_27;
      if ( v16 >= UnityEngine_Transform__get_childCount((UnityEngine_Transform_o *)queenSprite, 0LL) )
        break;
          ...
          if ( queenSprite )
          {
            ...
            if ( queenSprite )
            {
              Component_object = UnityEngine_GameObject__GetComponent_object_(
                                   (UnityEngine_GameObject_o *)queenSprite,
                                   (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_EventInfoChronologyComponent___);
  ...
  while ( 1 )
  {
    ...
    if ( UnityEngine_GameObject__get_activeSelf(grid, 0LL) )
    {
      ...
      if ( ((unsigned __int8)grid & 1) != 0 )
      {
        if ( !Component_object )
          goto LABEL_22;
        EventInfoChronologyComponent__Refresh((EventInfoChronologyComponent_o *)Component_object, v10);
      }
      grid = UnityEngine_Component__get_gameObject(v8, 0LL);
      if ( !grid )
        goto LABEL_22;
      ...
      v16 = UnityEngine_BoxCollider__get_size((UnityEngine_BoxCollider_o *)v11, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCF44 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_EventInfoChronologyDialog_OnClickCloseButton__, v3);
    sub_1B640C8(&Method_EventInfoChronologyDialog__OnClickCloseButton_b__17_0__, v4);
    byte_49FCF44 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoChronologyDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B640E0(Method_EventInfoChronologyDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCF43 & 1) == 0 )
  {
    sub_1B640C8(&System_Action_TypeInfo, closeAction);
    sub_1B640C8(&Method_EventInfoChronologyDialog__Open_b__16_0__, v5);
    byte_49FCF43 = 1;
  }
  EventInfoChronologyDialog__Init(this, (const MethodInfo *)closeAction);
  this->fields.state = 1;
  this->fields.closeAction = closeAction;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, (int32_t)closeAction, v6, v7);
  ...
  System_Action___ctor(v14, (Il2CppObject *)this, Method_EventInfoChronologyDialog__Open_b__16_0__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
  {
    ...
    sub_1B6406C(p_closeAction, 0, v7, v8);
  }
}
