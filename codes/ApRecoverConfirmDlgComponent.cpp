        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE72B & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_ApRecoverConfirmDlgComponent_EndClose__);
    byte_4DFE72B = 1;
  }
  this->fields.onClose = callback;
  sub_1CE66A4(&this->fields.onClose, callback);
  this->fields.state = 4;
...
int32_t ApRecoverConfirmDlgComponent__GetItemSliderMax(ApRecoverConfirmDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( entity )
  {
    ...
    Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25505/*"{0:N0}"*/, v9, 0);
    if ( currentNumLb )
    {
...
void ApRecoverConfirmDlgComponent__OnClickCancel(ApRecoverConfirmDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE72D & 1) == 0 )
  {
    sub_1CE6700(&Method_ApRecoverConfirmDlgComponent_OnClickCancel__);
    byte_4DFE72D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ApRecoverConfirmDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ApRecoverConfirmDlgComponent_OnClickCancel__);
...
void ApRecoverConfirmDlgComponent__OnClickDecide(ApRecoverConfirmDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE72C & 1) == 0 )
  {
    sub_1CE6700(&Method_ApRecoverConfirmDlgComponent_OnClickDecide__);
    byte_4DFE72C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ApRecoverConfirmDlgComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_ApRecoverConfirmDlgComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1CE66A4(&this->fields.clickFunc, clickFunc);
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
    if ( gameObject )
    {
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          gameObject = (UnityEngine_GameObject_o *)DataMasterBase_object__object__int___TryGetEntity(
                                                     ...
                                                     &entity,
                                                     recoverId,
                                                     (const MethodInfo_34E92A8 *)Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__);
            ...
            if ( gameObject )
            {
              ...
              if ( gameObject )
              {
                ...
                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_2046/*"AP_RECOVER_TITLE"*/,
                                                           0);
                if ( titleLb )
                {
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_3965/*"CURRENT_NUM_TXT"*/,
                                                             0);
                  if ( currentInfoLb )
                  {
                    ...
                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_12172/*"SHOP_BULK_WINDOW_MAX_LABEL"*/,
                                                               0);
                    if ( maxLabel )
                    {
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_12173/*"SHOP_BULK_WINDOW_MIN_LABEL"*/,
                                                                 0);
                      if ( minLabel )
                      {
...
void ApRecoverConfirmDlgComponent__SetConfirmMessageLb(ApRecoverConfirmDlgComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_2041/*"AP_RECOVER_CONFIRM_TXT"*/);
    byte_4DFE728 = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_2041/*"AP_RECOVER_CONFIRM_TXT"*/, 0);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt
...
void ApRecoverConfirmDlgComponent__SetItemDetailLb(ApRecoverConfirmDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_14964/*"UNIT_INFO"*/, 0);
  v20 = 1;
  ...
  if ( recovItemEnt )
  {
    ...
    if ( recovItemEnt->fields.type == 3 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_2042/*"AP_RECOVER_NUM_TXT"*/, 0);
      v20 = v11;
      v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v20);
      v19 = RecoverVal;
      v14 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v19);
      v15 = System_String__Format_65164204(v12, v8, v13, v14, 0);
      if ( !itemDetailLb )
        goto LABEL_13;
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v17 = LocalizationManager__Get((System_String_o *)StringLiteral_1917/*"ADD_RECOVER_NUM_TXT"*/, 0);
      v20 = RecoverVal;
      v18 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v20);
      v15 = System_String__Format_65164136(v17, v8, v18, 0);
      if ( !itemDetailLb )
LABEL_13:
        sub_1CE6958(v15, v16);
    }
...
LABEL_12:
    sub_1CE6958(itemSlider, *(_QWORD *)&minCount);
  }
  if ( !itemSlider )
    goto LABEL_12;
  UISliderWithButton__SetGray(itemSlider, 0);
...
void ApRecoverConfirmDlgComponent__SetResultApLb(ApRecoverConfirmDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE727 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_2043/*"AP_RECOVER_RESULT"*/);
    sub_1CE6700(&StringLiteral_2047/*"AP_RECOVER_TXT"*/);
    sub_1CE6700(&StringLiteral_2044/*"AP_RECOVER_RESULT_OVER"*/);
    byte_4DFE727 = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    if ( v6 <= userMaxAp )
      v7 = &StringLiteral_2043/*"AP_RECOVER_RESULT"*/;
    else
      v7 = &StringLiteral_2044/*"AP_RECOVER_RESULT_OVER"*/;
    ...
    v11 = System_String__Format_65164136(v8, v9, v10, 0);
    if ( !resultApLb2 )
      goto LABEL_30;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_2047/*"AP_RECOVER_TXT"*/, 0);
    v11 = (System_String_o *)sub_1CE67A8(object___TypeInfo, 4);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt )
      goto LABEL_30;
    v16 = v11;
    ...
    if ( !name || (v11 = (System_String_o *)sub_1CE683C(name, v11->klass->_1.element_class)) != 0 )
    {
      if ( !LODWORD(v16[1].klass) )
        goto LABEL_29;
      v16[1].monitor = name;
      sub_1CE66A4(&v16[1].monitor, name);
      useCount = this->fields.useCount;
      v11 = (System_String_o *)j_il2cpp_value_box_0(int_TypeInfo, &useCount);
      v18 = v11;
      if ( !v11 || (v11 = (System_String_o *)sub_1CE683C(v11, v16->klass->_1.element_class)) != 0 )
      {
        if ( LODWORD(v16[1].klass) <= 1 )
          goto LABEL_29;
        v16[1].fields = (System_String_Fields)v18;
        sub_1CE66A4(&v16[1].fields, v18);
        userCurrentAp = this->fields.userCurrentAp;
        ...
        if ( !v11 || (v11 = (System_String_o *)sub_1CE683C(v11, v16->klass->_1.element_class)) != 0 )
        {
          ...
          if ( !v11 || (v11 = (System_String_o *)sub_1CE683C(v11, v16->klass->_1.element_class)) != 0 )
          {
            ...
            {
              v16[2].monitor = v20;
              sub_1CE66A4(&v16[2].monitor, v20);
              v11 = System_String__Format_65164272(v14, (System_Object_array *)v16, 0);
              if ( resultApLb1 )
              {
