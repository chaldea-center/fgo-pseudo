        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23614 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ApRecoverConfirmDlgComponent_EndClose__, v6);
    byte_4A23614 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23613 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_24912/*"{0:N0}"*/, v6);
    byte_4A23613 = 1;
  }
  entity = 0LL;
  ...
  if ( entity )
  {
    ...
    Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_24912/*"{0:N0}"*/, v16, 0LL);
    if ( currentNumLb )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23616 & 1) == 0 )
  {
    sub_1B715CC(&Method_ApRecoverConfirmDlgComponent_OnClickCancel__, method);
    byte_4A23616 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ApRecoverConfirmDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_ApRecoverConfirmDlgComponent_OnClickCancel__);
    ...
    if ( clickFunc )
    {
      ...
      sub_1B71570(p_clickFunc, 0, v10, v11);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23615 & 1) == 0 )
  {
    sub_1B715CC(&Method_ApRecoverConfirmDlgComponent_OnClickDecide__, method);
    byte_4A23615 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ApRecoverConfirmDlgComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_ApRecoverConfirmDlgComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B715B0(v3, v3[4]);
    ...
    if ( clickFunc )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, 0, v9, v10);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2360F & 1) == 0 )
  {
    sub_1B715CC(&System_Action_TypeInfo, *(_QWORD *)&recoverId);
    sub_1B715CC(&Method_ApRecoverConfirmDlgComponent_EndOpen__, v9);
    sub_1B715CC(&Method_DataManager_GetMasterData_ItemMaster___, v10);
    sub_1B715CC(&Method_DataManager_GetMasterData_RecoverMaster___, v11);
    sub_1B715CC(&Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__, v12);
    ...
    sub_1B715CC(&StringLiteral_2131/*"AP_RECOVER_TITLE"*/, v16);
    sub_1B715CC(&StringLiteral_3931/*"CURRENT_NUM_TXT"*/, v17);
    sub_1B715CC(&StringLiteral_11953/*"SHOP_BULK_WINDOW_MIN_LABEL"*/, v18);
    sub_1B715CC(&StringLiteral_3739/*"COMMON_CONFIRM_DECIDE"*/, v19);
    sub_1B715CC(&StringLiteral_3737/*"COMMON_CONFIRM_CANCEL"*/, v20);
    sub_1B715CC(&StringLiteral_11952/*"SHOP_BULK_WINDOW_MAX_LABEL"*/, v21);
    byte_4A2360F = 1;
  }
  entity = 0LL;
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          gameObject = (UnityEngine_GameObject_o *)DataMasterBase_object__object__int___TryGetEntity(
                                                     ...
                                                     &entity,
                                                     recoverId,
                                                     (const MethodInfo_30F87B4 *)Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__);
              ...
              if ( gameObject )
              {
                ...
                if ( titleLb )
                {
                  ...
                  if ( currentInfoLb )
                  {
                    ...
                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_11952/*"SHOP_BULK_WINDOW_MAX_LABEL"*/,
                                                               0LL);
                    if ( maxLabel )
                    {
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_11953/*"SHOP_BULK_WINDOW_MIN_LABEL"*/,
                                                                 0LL);
                      if ( minLabel )
                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23611 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_2126/*"AP_RECOVER_CONFIRM_TXT"*/, v3);
    byte_4A23611 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23612 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_14748/*"UNIT_INFO"*/, v4);
    sub_1B715CC(&StringLiteral_2048/*"ADD_RECOVER_NUM_TXT"*/, v5);
    sub_1B715CC(&StringLiteral_2127/*"AP_RECOVER_NUM_TXT"*/, v6);
    byte_4A23612 = 1;
  }
  RecoverVal = ApRecoverConfirmDlgComponent__GetRecoverVal(this, method);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_14748/*"UNIT_INFO"*/, 0LL);
  v36 = 1;
  ...
  if ( recovItemEnt )
  {
    ...
    if ( recovItemEnt->fields.type == 3 )
    {
      ...
      v28 = System_String__Format_61519944(v19, v15, v23, v27, 0LL);
      if ( !itemDetailLb )
        goto LABEL_13;
    }
    else
    {
      ...
      v28 = System_String__Format_61519876(v30, v15, v34, 0LL);
      if ( !itemDetailLb )
LABEL_13:
        sub_1B71828(v28, v29);
    }
...
LABEL_12:
    sub_1B71828(itemSlider, *(_QWORD *)&minCount);
  }
  if ( !itemSlider )
    goto LABEL_12;
  UISliderWithButton__SetGray(itemSlider, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23610 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_2128/*"AP_RECOVER_RESULT"*/, v5);
    sub_1B715CC(&StringLiteral_2132/*"AP_RECOVER_TXT"*/, v6);
    sub_1B715CC(&StringLiteral_2129/*"AP_RECOVER_RESULT_OVER"*/, v7);
    byte_4A23610 = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    v22 = System_String__Format_61519876(v13, v17, v21, 0LL);
    if ( !resultApLb2 )
      goto LABEL_30;
    ...
    v22 = (System_String_o *)sub_1B71674(object___TypeInfo, 4LL);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt )
      goto LABEL_30;
    v29 = v22;
    ...
    if ( !name || (v22 = (System_String_o *)sub_1B71708(name, v22->klass->_1.element_class)) != 0LL )
    {
      if ( !LODWORD(v29[1].klass) )
        goto LABEL_29;
      v29[1].monitor = name;
      sub_1B71570((ServantStatusBattleListViewItem_o *)&v29[1].monitor, (int32_t)name, v26, v27);
      useCount = this->fields.useCount;
      v22 = (System_String_o *)j_il2cpp_value_box_0(int_TypeInfo, &useCount, v31, v32, v33);
      v36 = v22;
      if ( !v22 || (v22 = (System_String_o *)sub_1B71708(v22, v29->klass->_1.element_class)) != 0LL )
      {
        if ( LODWORD(v29[1].klass) <= 1 )
          goto LABEL_29;
        v29[1].fields = (System_String_Fields)v36;
        sub_1B71570((ServantStatusBattleListViewItem_o *)&v29[1].fields, (int32_t)v36, v34, v35);
        userCurrentAp = this->fields.userCurrentAp;
        ...
        if ( !v22 || (v22 = (System_String_o *)sub_1B71708(v22, v29->klass->_1.element_class)) != 0LL )
        {
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)&v29[2], (int32_t)v42, v40, v41);
          ...
          if ( !v22 || (v22 = (System_String_o *)sub_1B71708(v22, v29->klass->_1.element_class)) != 0LL )
          {
            ...
            {
              v29[2].monitor = v48;
              sub_1B71570((ServantStatusBattleListViewItem_o *)&v29[2].monitor, (int32_t)v48, v46, v47);
              v22 = System_String__Format_61520012(v25, (System_Object_array *)v29, 0LL);
              if ( resultApLb1 )
              {
