        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B597B & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_ApRecoverConfirmDlgComponent_EndClose__, v5);
    byte_49B597B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B597A & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_24683/*"{0:N0}"*/, v6);
    byte_49B597A = 1;
  }
  entity = 0LL;
  ...
  if ( entity )
  {
    ...
    Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_24683/*"{0:N0}"*/, v16, 0LL);
    if ( currentNumLb )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B597D & 1) == 0 )
  {
    sub_1B4CF90(&Method_ApRecoverConfirmDlgComponent_OnClickCancel__, method);
    byte_49B597D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B597C & 1) == 0 )
  {
    sub_1B4CF90(&Method_ApRecoverConfirmDlgComponent_OnClickDecide__, method);
    byte_49B597C = 1;
  }
  if ( this->fields.state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5976 & 1) == 0 )
  {
    sub_1B4CF90(&System_Action_TypeInfo, *(_QWORD *)&recoverId);
    sub_1B4CF90(&Method_ApRecoverConfirmDlgComponent_EndOpen__, v9);
    sub_1B4CF90(&Method_DataManager_GetMasterData_ItemMaster___, v10);
    sub_1B4CF90(&Method_DataManager_GetMasterData_RecoverMaster___, v11);
    sub_1B4CF90(&Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__, v12);
    ...
    sub_1B4CF90(&StringLiteral_2046/*"AP_RECOVER_TITLE"*/, v16);
    sub_1B4CF90(&StringLiteral_3887/*"CURRENT_NUM_TXT"*/, v17);
    sub_1B4CF90(&StringLiteral_11777/*"SHOP_BULK_WINDOW_MIN_LABEL"*/, v18);
    sub_1B4CF90(&StringLiteral_3658/*"COMMON_CONFIRM_DECIDE"*/, v19);
    sub_1B4CF90(&StringLiteral_3656/*"COMMON_CONFIRM_CANCEL"*/, v20);
    sub_1B4CF90(&StringLiteral_11776/*"SHOP_BULK_WINDOW_MAX_LABEL"*/, v21);
    byte_49B5976 = 1;
  }
  entity = 0LL;
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          gameObject = (UnityEngine_GameObject_o *)DataMasterBase_object__object__int___TryGetEntity(
                                                     ...
                                                     &entity,
                                                     recoverId,
                                                     (const MethodInfo_319D9E8 *)Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__);
            ...
            if ( gameObject )
            {
              ...
              if ( gameObject )
              {
                ...
                if ( titleLb )
                {
                  ...
                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                             (System_String_o *)StringLiteral_3887/*"CURRENT_NUM_TXT"*/,
                                                             0LL);
                  if ( currentInfoLb )
                  {
                    ...
                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_11776/*"SHOP_BULK_WINDOW_MAX_LABEL"*/,
                                                               0LL);
                    if ( maxLabel )
                    {
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_11777/*"SHOP_BULK_WINDOW_MIN_LABEL"*/,
                                                                 0LL);
                      if ( minLabel )
                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5978 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_2041/*"AP_RECOVER_CONFIRM_TXT"*/, v3);
    byte_49B5978 = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_2041/*"AP_RECOVER_CONFIRM_TXT"*/, 0LL);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5979 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_14509/*"UNIT_INFO"*/, v4);
    sub_1B4CF90(&StringLiteral_1932/*"ADD_RECOVER_NUM_TXT"*/, v5);
    sub_1B4CF90(&StringLiteral_2042/*"AP_RECOVER_NUM_TXT"*/, v6);
    byte_49B5979 = 1;
  }
  RecoverVal = ApRecoverConfirmDlgComponent__GetRecoverVal(this, method);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_14509/*"UNIT_INFO"*/, 0LL);
  v36 = 1;
  ...
  if ( recovItemEnt )
  {
    ...
    if ( recovItemEnt->fields.type == 3 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_2042/*"AP_RECOVER_NUM_TXT"*/, 0LL);
      v36 = v18;
      ...
      v28 = System_String__Format_61134828(v19, v15, v23, v27, 0LL);
      if ( !itemDetailLb )
        goto LABEL_13;
    }
    else
    {
      ...
      v28 = System_String__Format_61134760(v30, v15, v34, 0LL);
      if ( !itemDetailLb )
LABEL_13:
        sub_1B4D1EC(v28, v29);
    }
...
LABEL_12:
    sub_1B4D1EC(itemSlider, *(_QWORD *)&minCount);
  }
  if ( !itemSlider )
    goto LABEL_12;
  UISliderWithButton__SetGray(itemSlider, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5977 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_2043/*"AP_RECOVER_RESULT"*/, v5);
    sub_1B4CF90(&StringLiteral_2047/*"AP_RECOVER_TXT"*/, v6);
    sub_1B4CF90(&StringLiteral_2044/*"AP_RECOVER_RESULT_OVER"*/, v7);
    byte_49B5977 = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    if ( v11 <= userMaxAp )
      v12 = &StringLiteral_2043/*"AP_RECOVER_RESULT"*/;
    else
      v12 = &StringLiteral_2044/*"AP_RECOVER_RESULT_OVER"*/;
    ...
    v22 = System_String__Format_61134760(v13, v17, v21, 0LL);
    if ( !resultApLb2 )
      goto LABEL_30;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_2047/*"AP_RECOVER_TXT"*/, 0LL);
    v22 = (System_String_o *)sub_1B4D038(object___TypeInfo, 4LL);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt )
      goto LABEL_30;
    ...
    if ( !name || (v22 = (System_String_o *)sub_1B4D0CC(name, v22->klass->_1.element_class)) != 0LL )
    {
      if ( !v29->max_length )
        goto LABEL_29;
      v29->m_Items[0] = name;
      sub_1B4CF34(v29->m_Items);
      useCount = this->fields.useCount;
      v22 = (System_String_o *)j_il2cpp_value_box_0(int_TypeInfo, &useCount, v31, v32, v33);
      v34 = (Il2CppObject *)v22;
      if ( !v22 || (v22 = (System_String_o *)sub_1B4D0CC(v22, v29->obj.klass->_1.element_class)) != 0LL )
      {
        if ( v29->max_length <= 1 )
          goto LABEL_29;
        v29->m_Items[1] = v34;
        sub_1B4CF34(&v29->m_Items[1]);
        userCurrentAp = this->fields.userCurrentAp;
        ...
        if ( !v22 || (v22 = (System_String_o *)sub_1B4D0CC(v22, v29->obj.klass->_1.element_class)) != 0LL )
        {
          ...
          if ( !v22 || (v22 = (System_String_o *)sub_1B4D0CC(v22, v29->obj.klass->_1.element_class)) != 0LL )
          {
            ...
            {
              v29->m_Items[3] = v42;
              sub_1B4CF34(&v29->m_Items[3]);
              v22 = System_String__Format_61134896(v25, v29, 0LL);
              if ( resultApLb1 )
              {
