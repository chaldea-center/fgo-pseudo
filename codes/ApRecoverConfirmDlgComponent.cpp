        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF41 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_ApRecoverConfirmDlgComponent_EndClose__, v5);
    byte_4B3EF41 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( entity )
  {
    ...
    Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_25166/*"{0:N0}"*/, v16, 0LL);
    if ( currentNumLb )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF43 & 1) == 0 )
  {
    sub_1BDB878(&Method_ApRecoverConfirmDlgComponent_OnClickCancel__, method);
    byte_4B3EF43 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF42 & 1) == 0 )
  {
    sub_1BDB878(&Method_ApRecoverConfirmDlgComponent_OnClickDecide__, method);
    byte_4B3EF42 = 1;
  }
  if ( this->fields.state == 2 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF3C & 1) == 0 )
  {
    sub_1BDB878(&System_Action_TypeInfo, *(_QWORD *)&recoverId);
    sub_1BDB878(&Method_ApRecoverConfirmDlgComponent_EndOpen__, v9);
    sub_1BDB878(&Method_DataManager_GetMasterData_ItemMaster___, v10);
    sub_1BDB878(&Method_DataManager_GetMasterData_RecoverMaster___, v11);
    sub_1BDB878(&Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__, v12);
    ...
    sub_1BDB878(&StringLiteral_2060/*"AP_RECOVER_TITLE"*/, v16);
    sub_1BDB878(&StringLiteral_3965/*"CURRENT_NUM_TXT"*/, v17);
    sub_1BDB878(&StringLiteral_12022/*"SHOP_BULK_WINDOW_MIN_LABEL"*/, v18);
    sub_1BDB878(&StringLiteral_3718/*"COMMON_CONFIRM_DECIDE"*/, v19);
    sub_1BDB878(&StringLiteral_3716/*"COMMON_CONFIRM_CANCEL"*/, v20);
    sub_1BDB878(&StringLiteral_12021/*"SHOP_BULK_WINDOW_MAX_LABEL"*/, v21);
    byte_4B3EF3C = 1;
  }
  entity = 0LL;
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          gameObject = (UnityEngine_GameObject_o *)DataMasterBase_object__object__int___TryGetEntity(
                                                     ...
                                                     &entity,
                                                     recoverId,
                                                     (const MethodInfo_32E1E88 *)Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__);
            ...
            if ( gameObject )
            {
              ...
              if ( gameObject )
              {
                ...
                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_2060/*"AP_RECOVER_TITLE"*/,
                                                           0LL);
                if ( titleLb )
                {
                  ...
                  if ( currentInfoLb )
                  {
                    ...
                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_12021/*"SHOP_BULK_WINDOW_MAX_LABEL"*/,
                                                               0LL);
                    if ( maxLabel )
                    {
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_12022/*"SHOP_BULK_WINDOW_MIN_LABEL"*/,
                                                                 0LL);
                      if ( minLabel )
                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF3E & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_2055/*"AP_RECOVER_CONFIRM_TXT"*/, v3);
    byte_4B3EF3E = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_2055/*"AP_RECOVER_CONFIRM_TXT"*/, 0LL);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF3F & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_14781/*"UNIT_INFO"*/, v4);
    sub_1BDB878(&StringLiteral_1943/*"ADD_RECOVER_NUM_TXT"*/, v5);
    sub_1BDB878(&StringLiteral_2056/*"AP_RECOVER_NUM_TXT"*/, v6);
    byte_4B3EF3F = 1;
  }
  RecoverVal = ApRecoverConfirmDlgComponent__GetRecoverVal(this, method);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_14781/*"UNIT_INFO"*/, 0LL);
  v36 = 1;
  ...
  if ( recovItemEnt )
  {
    ...
    if ( recovItemEnt->fields.type == 3 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_2056/*"AP_RECOVER_NUM_TXT"*/, 0LL);
      v36 = v18;
      ...
      v28 = System_String__Format_62613620(v19, v15, v23, v27, 0LL);
      if ( !itemDetailLb )
        goto LABEL_13;
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v30 = LocalizationManager__Get((System_String_o *)StringLiteral_1943/*"ADD_RECOVER_NUM_TXT"*/, 0LL);
      v36 = RecoverVal;
      v34 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36, v31, v32, v33);
      v28 = System_String__Format_62613552(v30, v15, v34, 0LL);
      if ( !itemDetailLb )
LABEL_13:
        sub_1BDBAD4(v28, v29);
    }
...
LABEL_12:
    sub_1BDBAD4(itemSlider, *(_QWORD *)&minCount);
  }
  if ( !itemSlider )
    goto LABEL_12;
  UISliderWithButton__SetGray(itemSlider, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3EF3D & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_2057/*"AP_RECOVER_RESULT"*/, v5);
    sub_1BDB878(&StringLiteral_2061/*"AP_RECOVER_TXT"*/, v6);
    sub_1BDB878(&StringLiteral_2058/*"AP_RECOVER_RESULT_OVER"*/, v7);
    byte_4B3EF3D = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    if ( v11 <= userMaxAp )
      v12 = &StringLiteral_2057/*"AP_RECOVER_RESULT"*/;
    else
      v12 = &StringLiteral_2058/*"AP_RECOVER_RESULT_OVER"*/;
    ...
    v22 = System_String__Format_62613552(v13, v17, v21, 0LL);
    if ( !resultApLb2 )
      goto LABEL_30;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_2061/*"AP_RECOVER_TXT"*/, 0LL);
    v22 = (System_String_o *)sub_1BDB920(object___TypeInfo, 4LL);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt )
      goto LABEL_30;
    ...
    if ( !name || (v22 = (System_String_o *)sub_1BDB9B4(name, v22->klass->_1.element_class)) != 0LL )
    {
      if ( !v29->max_length )
        goto LABEL_29;
      v29->m_Items[0] = name;
      sub_1BDB81C(v29->m_Items);
      useCount = this->fields.useCount;
      v22 = (System_String_o *)j_il2cpp_value_box_0(int_TypeInfo, &useCount, v31, v32, v33);
      v34 = (Il2CppObject *)v22;
      if ( !v22 || (v22 = (System_String_o *)sub_1BDB9B4(v22, v29->obj.klass->_1.element_class)) != 0LL )
      {
        if ( v29->max_length <= 1 )
          goto LABEL_29;
        v29->m_Items[1] = v34;
        sub_1BDB81C(&v29->m_Items[1]);
        userCurrentAp = this->fields.userCurrentAp;
        ...
        if ( !v22 || (v22 = (System_String_o *)sub_1BDB9B4(v22, v29->obj.klass->_1.element_class)) != 0LL )
        {
          ...
          if ( !v22 || (v22 = (System_String_o *)sub_1BDB9B4(v22, v29->obj.klass->_1.element_class)) != 0LL )
          {
            ...
            {
              v29->m_Items[3] = v42;
              sub_1BDB81C(&v29->m_Items[3]);
              v22 = System_String__Format_62613688(v25, v29, 0LL);
              if ( resultApLb1 )
              {
