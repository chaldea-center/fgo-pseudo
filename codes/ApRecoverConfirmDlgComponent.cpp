        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02018 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_ApRecoverConfirmDlgComponent_EndClose__, v6);
    byte_4A02018 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02017 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_24875/*"{0:N0}"*/, v6);
    byte_4A02017 = 1;
  }
  entity = 0LL;
  ...
  if ( entity )
  {
    ...
    Instance = (DataManager_o *)System_String__Format((System_String_o *)StringLiteral_24875/*"{0:N0}"*/, v16, 0LL);
    if ( currentNumLb )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( !byte_49F988D )
  {
    sub_1B64870(&System_Math_TypeInfo, v3);
    byte_49F988D = 1;
  }
  v5 = fmaxf(v4, 1.0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0201A & 1) == 0 )
  {
    sub_1B64870(&Method_ApRecoverConfirmDlgComponent_OnClickCancel__, method);
    byte_4A0201A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ApRecoverConfirmDlgComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_ApRecoverConfirmDlgComponent_OnClickCancel__);
    ...
    if ( clickFunc )
    {
      ...
      sub_1B64814(p_clickFunc, 0, v10, v11);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02019 & 1) == 0 )
  {
    sub_1B64870(&Method_ApRecoverConfirmDlgComponent_OnClickDecide__, method);
    byte_4A02019 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ApRecoverConfirmDlgComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_ApRecoverConfirmDlgComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B64854(v3, v3[4]);
    ...
    if ( clickFunc )
    {
      ...
      sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.clickFunc, 0, v9, v10);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02013 & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, *(_QWORD *)&recoverId);
    sub_1B64870(&Method_ApRecoverConfirmDlgComponent_EndOpen__, v9);
    sub_1B64870(&Method_DataManager_GetMasterData_ItemMaster___, v10);
    sub_1B64870(&Method_DataManager_GetMasterData_RecoverMaster___, v11);
    sub_1B64870(&Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__, v12);
    ...
    sub_1B64870(&StringLiteral_2131/*"AP_RECOVER_TITLE"*/, v16);
    sub_1B64870(&StringLiteral_3926/*"CURRENT_NUM_TXT"*/, v17);
    sub_1B64870(&StringLiteral_11942/*"SHOP_BULK_WINDOW_MIN_LABEL"*/, v18);
    sub_1B64870(&StringLiteral_3734/*"COMMON_CONFIRM_DECIDE"*/, v19);
    sub_1B64870(&StringLiteral_3732/*"COMMON_CONFIRM_CANCEL"*/, v20);
    sub_1B64870(&StringLiteral_11941/*"SHOP_BULK_WINDOW_MAX_LABEL"*/, v21);
    byte_4A02013 = 1;
  }
  entity = 0LL;
      ...
      if ( gameObject )
      {
        ...
        if ( gameObject )
        {
          gameObject = (UnityEngine_GameObject_o *)DataMasterBase_object__object__int___TryGetEntity(
                                                     ...
                                                     &entity,
                                                     recoverId,
                                                     (const MethodInfo_30D61D4 *)Method_DataMasterBase_RecoverMaster__RecoverEntity__int__TryGetEntity__);
              ...
              if ( gameObject )
              {
                ...
                if ( titleLb )
                {
                  ...
                  if ( currentInfoLb )
                  {
                    ...
                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_11941/*"SHOP_BULK_WINDOW_MAX_LABEL"*/,
                                                               0LL);
                    if ( maxLabel )
                    {
                      ...
                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                 (System_String_o *)StringLiteral_11942/*"SHOP_BULK_WINDOW_MIN_LABEL"*/,
                                                                 0LL);
                      if ( minLabel )
                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02015 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_2126/*"AP_RECOVER_CONFIRM_TXT"*/, v3);
    byte_4A02015 = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_2126/*"AP_RECOVER_CONFIRM_TXT"*/, 0LL);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02016 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_14730/*"UNIT_INFO"*/, v4);
    sub_1B64870(&StringLiteral_2048/*"ADD_RECOVER_NUM_TXT"*/, v5);
    sub_1B64870(&StringLiteral_2127/*"AP_RECOVER_NUM_TXT"*/, v6);
    byte_4A02016 = 1;
  }
  RecoverVal = ApRecoverConfirmDlgComponent__GetRecoverVal(this, method);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_14730/*"UNIT_INFO"*/, 0LL);
  v36 = 1;
  ...
  if ( recovItemEnt )
  {
    ...
    if ( recovItemEnt->fields.type == 3 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_2127/*"AP_RECOVER_NUM_TXT"*/, 0LL);
      v36 = v18;
      ...
      v28 = System_String__Format_61398016(v19, v15, v23, v27, 0LL);
      if ( !itemDetailLb )
        goto LABEL_13;
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v30 = LocalizationManager__Get((System_String_o *)StringLiteral_2048/*"ADD_RECOVER_NUM_TXT"*/, 0LL);
      v36 = RecoverVal;
      v34 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v36, v31, v32, v33);
      v28 = System_String__Format_61397948(v30, v15, v34, 0LL);
      if ( !itemDetailLb )
LABEL_13:
        sub_1B64ACC(v28, v29);
    }
...
LABEL_12:
    sub_1B64ACC(itemSlider, *(_QWORD *)&minCount);
  }
  if ( !itemSlider )
    goto LABEL_12;
  UISliderWithButton__SetGray(itemSlider, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02014 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_2128/*"AP_RECOVER_RESULT"*/, v5);
    sub_1B64870(&StringLiteral_2132/*"AP_RECOVER_TXT"*/, v6);
    sub_1B64870(&StringLiteral_2129/*"AP_RECOVER_RESULT_OVER"*/, v7);
    byte_4A02014 = 1;
  }
  if ( this->fields.recovItemEnt )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    if ( v11 <= userMaxAp )
      v12 = &StringLiteral_2128/*"AP_RECOVER_RESULT"*/;
    else
      v12 = &StringLiteral_2129/*"AP_RECOVER_RESULT_OVER"*/;
    ...
    v22 = System_String__Format_61397948(v13, v17, v21, 0LL);
    if ( !resultApLb2 )
      goto LABEL_30;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v25 = LocalizationManager__Get((System_String_o *)StringLiteral_2132/*"AP_RECOVER_TXT"*/, 0LL);
    v22 = (System_String_o *)sub_1B64918(object___TypeInfo, 4LL);
    recovItemEnt = this->fields.recovItemEnt;
    if ( !recovItemEnt )
      goto LABEL_30;
    v29 = v22;
    ...
    if ( !name || (v22 = (System_String_o *)sub_1B649AC(name, v22->klass->_1.element_class)) != 0LL )
    {
      if ( !LODWORD(v29[1].klass) )
        goto LABEL_29;
      v29[1].monitor = name;
      sub_1B64814((ServantStatusBattleListViewItem_o *)&v29[1].monitor, (int32_t)name, v26, v27);
      useCount = this->fields.useCount;
      v22 = (System_String_o *)j_il2cpp_value_box_0(int_TypeInfo, &useCount, v31, v32, v33);
      v36 = v22;
      if ( !v22 || (v22 = (System_String_o *)sub_1B649AC(v22, v29->klass->_1.element_class)) != 0LL )
      {
        if ( LODWORD(v29[1].klass) <= 1 )
          goto LABEL_29;
        v29[1].fields = (System_String_Fields)v36;
        sub_1B64814((ServantStatusBattleListViewItem_o *)&v29[1].fields, (int32_t)v36, v34, v35);
        userCurrentAp = this->fields.userCurrentAp;
        ...
        if ( !v22 || (v22 = (System_String_o *)sub_1B649AC(v22, v29->klass->_1.element_class)) != 0LL )
        {
          ...
          sub_1B64814((ServantStatusBattleListViewItem_o *)&v29[2], (int32_t)v42, v40, v41);
          ...
          if ( !v22 || (v22 = (System_String_o *)sub_1B649AC(v22, v29->klass->_1.element_class)) != 0LL )
          {
            ...
            {
              v29[2].monitor = v48;
              sub_1B64814((ServantStatusBattleListViewItem_o *)&v29[2].monitor, (int32_t)v48, v46, v47);
              v22 = System_String__Format_61398084(v25, (System_Object_array *)v29, 0LL);
              if ( resultApLb1 )
              {
