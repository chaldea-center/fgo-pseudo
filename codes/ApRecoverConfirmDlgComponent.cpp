...
void ApRecoverConfirmDlgComponent__OnClickCancel(ApRecoverConfirmDlgComponent_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( clickFunc )
    {
      ((void (__fastcall *)(intptr_t, _QWORD, _QWORD, intptr_t))v6->fields.invoke_impl)(
            ...
            if ( gameObject )
            {
              ...
              if ( ((unsigned __int8)gameObject & 1) != 0 )
              {
                ...
                ItemIconComponent__SetItemImage_40820084(
                  ...
                  1,
                  0);
                v11 = this->fields.recovItemEnt;
                if ( !v11 )
                  goto LABEL_29;
                gameObject = (UnityEngine_GameObject_o *)this->fields.itemNameLb;
                if ( !gameObject )
                  goto LABEL_29;
                UILabel__set_text((UILabel_o *)gameObject, v11->fields.name, 0);
                ApRecoverConfirmDlgComponent__SetConfirmMessageLb(this, v12);
              }
              ...
              if ( gameObject )
              {
                ...
                this->fields.userMaxAp = v13[1].fields.m_CachedPtr;
                ItemSliderMax = ApRecoverConfirmDlgComponent__GetItemSliderMax(this, v14);
                this->fields.maxCount = ItemSliderMax;
                this->fields.useCount = ItemSliderMax;
                ItemSliderMin = ApRecoverConfirmDlgComponent__GetItemSliderMin(this, needAp, v16);
                ApRecoverConfirmDlgComponent__SetItemSlider(this, ItemSliderMin, v18);
                ApRecoverConfirmDlgComponent__SetResultApLb(this, v19);
                ApRecoverConfirmDlgComponent__SetItemDetailLb(this, v20);
