        ...
        const MethodInfo *method)
{
  ...
  __int64 v26; // x0
  __int64 v27; // x1
  System_IO_FileInfo_array *Files_62887164; // x21
  ...
  if ( (byte_4B64317 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_ScriptConnectListViewMenu_OnClickErrorDialog__, v11);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1BE4ACC(&StringLiteral_19680/*"file://"*/, v13);
    sub_1BE4ACC(&StringLiteral_22454/*"not find directory ["*/, v14);
    sub_1BE4ACC(&StringLiteral_4768/*"Connect Script Error"*/, v15);
    sub_1BE4ACC(&StringLiteral_19681/*"file:///"*/, v16);
    sub_1BE4ACC(&StringLiteral_851/*"*.txt"*/, v17);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v18);
    sub_1BE4ACC(&StringLiteral_16276/*"]"*/, v19);
    byte_4B64317 = 1;
  }
  ...
  if ( !IsNullOrEmpty )
  {
    if ( path )
    {
      listViewManager = System_String__Replace_62718436(
                          path,
                          (System_String_o *)StringLiteral_19681/*"file:///"*/,
                          (System_String_o *)StringLiteral_1/*""*/,
                          0LL);
      if ( listViewManager )
      {
        v24 = System_String__Replace_62718436(
                listViewManager,
                (System_String_o *)StringLiteral_19680/*"file://"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                0LL);
        if ( System_IO_Directory__Exists(v24, 0LL) )
        {
          v25 = (System_IO_DirectoryInfo_o *)sub_1BE4D18(System_IO_DirectoryInfo_TypeInfo);
          System_IO_DirectoryInfo___ctor(v25, v24, 0LL);
          if ( !v25 )
            sub_1BE4D28(v26, v27);
          Files_62887164 = System_IO_DirectoryInfo__GetFiles_62887164(v25, (System_String_o *)StringLiteral_851/*"*.txt"*/, 0LL);
          ...
          if ( max_length >= 1 )
          {
            for ( i = 0; i < max_length; ++i )
            {
              ...
              v30 = System_Char__Equals_63330772((uint16_t)v61, 0x2Eu, 0LL);
              if ( !v30 )
              {
                v61[0] = System_String__get_Chars(v37, 0, 0LL);
                if ( !char_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(char_TypeInfo);
                v30 = System_Char__Equals_63330772((uint16_t)v61, 0x5Fu, 0LL);
                if ( !v30 )
                {
                  if ( !v29 )
                    sub_1BE4D28(v30, v31);
        ...
        else
        {
          ...
          v58 = (ErrorDialog_ClickDelegate_o *)sub_1BE4D18(ErrorDialog_ClickDelegate_TypeInfo);
    ...
    sub_1BE4D28(listViewManager, v21);
  }
  return (char)listViewManager;
}
...
void __fastcall ScriptConnectListViewMenu__StartInput(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B64318 & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptConnectListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BE4ACC(&Method_ScriptConnectListViewMenu_OnClickItem__, v3);
    byte_4B64318 = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v5 = (ScriptConnectListViewManager_CallbackFunc_o *)sub_1BE4D18(ScriptConnectListViewManager_CallbackFunc_TypeInfo);
  ScriptConnectListViewManager_CallbackFunc___ctor(
    ...
    v6);
  if ( !listViewManager
    || (ScriptConnectListViewManager__SetMode_35713976(listViewManager, 1, v5, v9),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64314 & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptConnectListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4B64314 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A23E70;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A23E18;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64319 & 1) == 0 )
  {
    sub_1BE4ACC(&ScriptConnectListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4B64319 = 1;
  }
  v11[2] = 0LL;
