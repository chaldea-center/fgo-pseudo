        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1C13CC8(p_callbackFunc, 0LL, (int64_t)objectName, (int32_t)method, v4, v5, v6, v7);
...
void __fastcall ScriptConnectListViewMenu__Close(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.scriptFileList )
  {
    ...
    sub_1C13CC8(p_scriptFileList, 0LL, v4, v5, v6, v7, v8, v9);
  }
...
void __fastcall ScriptConnectListViewMenu__OnClickUpdate(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 3 )
  {
    ...
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.scriptFileList, 0LL, v5, v6, v7, v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E31 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_Component_GetComponent_UIInput___, path);
    byte_4BB1E31 = 1;
  }
...
LABEL_6:
      ...
      if ( !scriptTestDefaultNameLabel
        ...
        || (scriptTestObjectRootObject = (UnityEngine_GameObject_o *)UnityEngine_Component__GetComponent_object_(
                                                                       ...
                                                                       (const MethodInfo_2F85F10 *)Method_UnityEngine_Component_GetComponent_UIInput___)) == 0LL )
      {
LABEL_20:
        sub_1C13F80(scriptTestObjectRootObject, v19);
      }
      UIInput__set_value((UIInput_o *)scriptTestObjectRootObject, jumpLine, 0LL);
      this->fields.state = 1;
      this->fields.scriptFileList = 0LL;
      sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.scriptFileList, 0LL, v24, v25, v26, v27, v28, v29);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v26; // x0
  __int64 v27; // x1
  System_IO_FileInfo_array *Files_63156300; // x21
  ...
  if ( (byte_4BB1E32 & 1) == 0 )
  {
    sub_1C13D24(&char_TypeInfo, path);
    sub_1C13D24(&ErrorDialog_ClickDelegate_TypeInfo, v5);
    sub_1C13D24(&System_IO_DirectoryInfo_TypeInfo, v6);
    ...
    sub_1C13D24(&Method_ScriptConnectListViewMenu_OnClickErrorDialog__, v11);
    sub_1C13D24(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1C13D24(&StringLiteral_19724/*"fieldMotionIds"*/, v13);
    sub_1C13D24(&StringLiteral_22506/*"noneSupportFriendPoint"*/, v14);
    sub_1C13D24(&StringLiteral_4771/*"Conflict"*/, v15);
    sub_1C13D24(&StringLiteral_19725/*"fieldName"*/, v16);
    sub_1C13D24(&StringLiteral_854/*"*.txt"*/, v17);
    sub_1C13D24(&StringLiteral_1/*""*/, v18);
    sub_1C13D24(&StringLiteral_16320/*"\\p{_xmlI}"*/, v19);
    byte_4BB1E32 = 1;
  }
  ...
  if ( !IsNullOrEmpty )
  {
    if ( path )
    {
      listViewManager = System_String__Replace_62987572(
                          path,
                          (System_String_o *)StringLiteral_19725/*"fieldName"*/,
                          (System_String_o *)StringLiteral_1/*""*/,
                          0LL);
      if ( listViewManager )
      {
        v24 = System_String__Replace_62987572(
                listViewManager,
                (System_String_o *)StringLiteral_19724/*"fieldMotionIds"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                0LL);
        if ( System_IO_Directory__Exists(v24, 0LL) )
        {
          v25 = (System_IO_DirectoryInfo_o *)sub_1C13F70(System_IO_DirectoryInfo_TypeInfo);
          System_IO_DirectoryInfo___ctor(v25, v24, 0LL);
          if ( !v25 )
            sub_1C13F80(v26, v27);
          Files_63156300 = System_IO_DirectoryInfo__GetFiles_63156300(v25, (System_String_o *)StringLiteral_854/*"*.txt"*/, 0LL);
          v29 = (System_Collections_Generic_List_object__o *)sub_1C13F70(System_Collections_Generic_List_string__TypeInfo);
          System_Collections_Generic_List_object____ctor(
            v29,
            (const MethodInfo_362C998 *)Method_System_Collections_Generic_List_string___ctor__);
          if ( !Files_63156300 )
            sub_1C13F80(v30, v31);
          max_length = Files_63156300->max_length;
          if ( max_length >= 1 )
          {
            for ( i = 0; i < max_length; ++i )
            {
              ...
              v30 = System_Char__Equals_63599908((uint16_t)v61, 0x2Eu, 0LL);
              if ( !v30 )
              {
                v61[0] = System_String__get_Chars(v37, 0, 0LL);
                if ( !char_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(char_TypeInfo);
                v30 = System_Char__Equals_63599908((uint16_t)v61, 0x5Fu, 0LL);
                if ( !v30 )
                {
                  if ( !v29 )
                    sub_1C13F80(v30, v31);
        ...
        else
        {
          v20 = System_String__Concat_62979204(
                  (System_String_o *)StringLiteral_22506/*"noneSupportFriendPoint"*/,
                  v24,
        ...
        else
        {
          ...
          v58 = (ErrorDialog_ClickDelegate_o *)sub_1C13F70(ErrorDialog_ClickDelegate_TypeInfo);
          ...
          if ( Instance )
          {
            *(_QWORD *)&effectDistance.fields.hasValue = 0LL;
            ...
            CommonUI__OpenWarningDialog(
              (CommonUI_o *)Instance,
              (System_String_o *)StringLiteral_4771/*"Conflict"*/,
              v20,
              v58,
              1,
              0,
    ...
    sub_1C13F80(listViewManager, v21);
  }
  return (char)listViewManager;
}
...
void __fastcall ScriptConnectListViewMenu__StartInput(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E33 & 1) == 0 )
  {
    sub_1C13D24(&ScriptConnectListViewManager_CallbackFunc_TypeInfo, method);
    sub_1C13D24(&Method_ScriptConnectListViewMenu_OnClickItem__, v3);
    byte_4BB1E33 = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v5 = (ScriptConnectListViewManager_CallbackFunc_o *)sub_1C13F70(ScriptConnectListViewManager_CallbackFunc_TypeInfo);
  ScriptConnectListViewManager_CallbackFunc___ctor(
    ...
    v6);
  if ( !listViewManager
    || (ScriptConnectListViewManager__SetMode_35943576(listViewManager, 1, v5, v9),
  ...
  {
    sub_1C13F80(scriptTestObjectCancelButton, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E2F & 1) == 0 )
  {
    sub_1C13D24(&ScriptConnectListViewMenu_CallbackFunc_TypeInfo, value);
    byte_4BB1E2F = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A526CC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A52674;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB1E34 & 1) == 0 )
  {
    sub_1C13D24(&ScriptConnectListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_4BB1E34 = 1;
  }
  v11[2] = 0LL;
