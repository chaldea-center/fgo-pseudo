...
void __fastcall ScriptConnectListViewMenu__Close(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.scriptFileList )
  {
    ...
    sub_1B4CF34(p_scriptFileList, 0, v4, v5);
  }
...
void __fastcall ScriptConnectListViewMenu__OnClickUpdate(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 3 )
  {
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.scriptFileList, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B857C & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_Component_GetComponent_UIInput___, path);
    byte_49B857C = 1;
  }
...
LABEL_20:
      ...
      this->fields.state = 1;
      this->fields.scriptFileList = 0LL;
      sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.scriptFileList, 0, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v26; // x0
  __int64 v27; // x1
  System_IO_FileInfo_array *Files_61959440; // x21
  ...
  if ( (byte_49B857D & 1) == 0 )
  {
    sub_1B4CF90(&char_TypeInfo, path);
    sub_1B4CF90(&ErrorDialog_ClickDelegate_TypeInfo, v5);
    sub_1B4CF90(&System_IO_DirectoryInfo_TypeInfo, v6);
    ...
    sub_1B4CF90(&Method_ScriptConnectListViewMenu_OnClickErrorDialog__, v11);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v12);
    sub_1B4CF90(&StringLiteral_19114/*"file://"*/, v13);
    sub_1B4CF90(&StringLiteral_21859/*"not find directory ["*/, v14);
    sub_1B4CF90(&StringLiteral_4599/*"Connect Script Error"*/, v15);
    sub_1B4CF90(&StringLiteral_19115/*"file:///"*/, v16);
    sub_1B4CF90(&StringLiteral_804/*"*.txt"*/, v17);
    sub_1B4CF90(&StringLiteral_1/*""*/, v18);
    sub_1B4CF90(&StringLiteral_15763/*"]"*/, v19);
    byte_49B857D = 1;
  }
  ...
  if ( !IsNullOrEmpty )
  {
    if ( path )
    {
      listViewManager = System_String__Replace_61140016(
                          path,
                          (System_String_o *)StringLiteral_19115/*"file:///"*/,
                          (System_String_o *)StringLiteral_1/*""*/,
                          0LL);
      if ( listViewManager )
      {
        v24 = System_String__Replace_61140016(
                listViewManager,
                (System_String_o *)StringLiteral_19114/*"file://"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                0LL);
        if ( System_IO_Directory__Exists(v24, 0LL) )
        {
          v25 = (System_IO_DirectoryInfo_o *)sub_1B4D1DC(System_IO_DirectoryInfo_TypeInfo);
          System_IO_DirectoryInfo___ctor(v25, v24, 0LL);
          if ( !v25 )
            sub_1B4D1EC(v26, v27);
          Files_61959440 = System_IO_DirectoryInfo__GetFiles_61959440(v25, (System_String_o *)StringLiteral_804/*"*.txt"*/, 0LL);
          v29 = (System_Collections_Generic_List_object__o *)sub_1B4D1DC(System_Collections_Generic_List_string__TypeInfo);
          System_Collections_Generic_List_object____ctor(
            v29,
            (const MethodInfo_357F9A8 *)Method_System_Collections_Generic_List_string___ctor__);
          if ( !Files_61959440 )
            sub_1B4D1EC(v30, v31);
          max_length = Files_61959440->max_length;
          if ( max_length >= 1 )
          {
            for ( i = 0; i < max_length; ++i )
            {
              ...
              v30 = System_Char__Equals_62143720((uint16_t)v53, 0x2Eu, 0LL);
              if ( !v30 )
              {
                v53[0] = System_String__get_Chars(v37, 0, 0LL);
                if ( !char_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(char_TypeInfo);
                v30 = System_Char__Equals_62143720((uint16_t)v53, 0x5Fu, 0LL);
                if ( !v30 )
                {
                  if ( !v29 )
                    sub_1B4D1EC(v30, v31);
          ...
          sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.scriptFileList, (int32_t)v44, v45, v46);
        }
        else
        {
          v20 = System_String__Concat_61131716(
                  (System_String_o *)StringLiteral_21859/*"not find directory ["*/,
                  v24,
        ...
        else
        {
          ...
          v50 = (ErrorDialog_ClickDelegate_o *)sub_1B4D1DC(ErrorDialog_ClickDelegate_TypeInfo);
          ...
          if ( Instance )
          {
            *(_QWORD *)&effectDistance.fields.hasValue = 0LL;
            ...
            CommonUI__OpenWarningDialog(
              (CommonUI_o *)Instance,
              (System_String_o *)StringLiteral_4599/*"Connect Script Error"*/,
              v20,
              v50,
              1,
              0,
    ...
    sub_1B4D1EC(listViewManager, v21);
  }
  return (char)listViewManager;
}
...
void __fastcall ScriptConnectListViewMenu__StartInput(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B857E & 1) == 0 )
  {
    sub_1B4CF90(&ScriptConnectListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B4CF90(&Method_ScriptConnectListViewMenu_OnClickItem__, v3);
    byte_49B857E = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v5 = (ScriptConnectListViewManager_CallbackFunc_o *)sub_1B4D1DC(ScriptConnectListViewManager_CallbackFunc_TypeInfo);
  ScriptConnectListViewManager_CallbackFunc___ctor(
    ...
    v6);
  if ( !listViewManager
    || (ScriptConnectListViewManager__SetMode_35311244(listViewManager, 1, v5, v9),
  ...
  {
    sub_1B4D1EC(scriptTestObjectCancelButton, v8);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B857A & 1) == 0 )
  {
    sub_1B4CF90(&ScriptConnectListViewMenu_CallbackFunc_TypeInfo, value);
    byte_49B857A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1999790;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1999738;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B857F & 1) == 0 )
  {
    sub_1B4CF90(&ScriptConnectListViewMenu_ResultKind_TypeInfo, *(_QWORD *)&result);
    byte_49B857F = 1;
  }
  v11[2] = 0LL;
