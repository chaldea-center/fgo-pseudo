        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1C6B9AC(p_callbackFunc, 0, (int32_t)objectName, method);
...
void ScriptConnectListViewMenu__Close(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.scriptFileList )
  {
    ...
    sub_1C6B9AC(p_scriptFileList, 0, v4, v5);
  }
...
void ScriptConnectListViewMenu__OnClickUpdate(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 3 )
  {
    ...
    sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.scriptFileList, 0, v5, v6);
...
LABEL_6:
      ...
      {
LABEL_20:
        sub_1C6BC60(scriptTestObjectRootObject, v13);
      }
      UIInput__set_value((UIInput_o *)scriptTestObjectRootObject, jumpLine, 0);
      this->fields.state = 1;
      this->fields.scriptFileList = 0;
      sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.scriptFileList, 0, v18, v19);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x0
  __int64 v12; // x1
  System_IO_FileInfo_array *Files_64829648; // x21
  ...
  if ( (byte_4CB386C & 1) == 0 )
  {
    ...
    sub_1C6BA08(&System_IO_DirectoryInfo_TypeInfo);
    ...
    sub_1C6BA08(&Method_ScriptConnectListViewMenu_OnClickErrorDialog__);
    ...
    sub_1C6BA08(&StringLiteral_19501/*"file:///"*/);
    sub_1C6BA08(&StringLiteral_796/*"*.txt"*/);
  ...
  if ( !IsNullOrEmpty )
  {
    if ( path )
    {
      listViewManager = System_String__Replace_64013356(
                          path,
                          (System_String_o *)StringLiteral_19501/*"file:///"*/,
      ...
      if ( listViewManager )
      {
        v9 = System_String__Replace_64013356(
               listViewManager,
               (System_String_o *)StringLiteral_19500/*"file://"*/,
               (System_String_o *)StringLiteral_1/*""*/,
               0);
        if ( System_IO_Directory__Exists(v9, 0) )
        {
          v10 = (System_IO_DirectoryInfo_o *)sub_1C6BC54(System_IO_DirectoryInfo_TypeInfo);
          System_IO_DirectoryInfo___ctor(v10, v9, 0);
          if ( !v10 )
            sub_1C6BC60(v11, v12);
          Files_64829648 = System_IO_DirectoryInfo__GetFiles_64829648(v10, (System_String_o *)StringLiteral_796/*"*.txt"*/, 0);
          v14 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_string__TypeInfo);
          System_Collections_Generic_List_object____ctor(
            v14,
            (const MethodInfo_3800140 *)Method_System_Collections_Generic_List_string___ctor__);
          if ( !Files_64829648 )
            sub_1C6BC60(v15, v16);
          max_length = Files_64829648->max_length;
          if ( max_length >= 1 )
          {
            for ( i = 0; i < max_length; ++i )
            {
              ...
              v15 = System_Char__Equals_65029260((uint16_t)v38, 0x2Eu, 0);
              if ( !v15 )
              {
                v38[0] = System_String__get_Chars(v22, 0, 0);
                if ( !char_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(char_TypeInfo);
                v15 = System_Char__Equals_65029260((uint16_t)v38, 0x5Fu, 0);
                if ( !v15 )
                {
                  if ( !v14 )
                    sub_1C6BC60(v15, v16);
                  ...
                  else
                  {
                    ...
                    sub_1C6B9AC((CGThumbnailListItem_o *)(v28 + 4), (int32_t)v22, v23, v24);
                  }
                }
              }
              max_length = Files_64829648->max_length;
          ...
          sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.scriptFileList, (int32_t)v29, v30, v31);
        }
        else
        {
          v5 = System_String__Concat_64005056(
                 (System_String_o *)StringLiteral_22380/*"not find directory ["*/,
                 v9,
    ...
    sub_1C6BC60(listViewManager, v6);
  }
  return (char)listViewManager;
}
...
void ScriptConnectListViewMenu__StartInput(ScriptConnectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB386D & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_ScriptConnectListViewMenu_OnClickItem__);
    byte_4CB386D = 1;
  }
  this->fields.state = 3;
  listViewManager = this->fields.listViewManager;
  v4 = (ScriptConnectListViewManager_CallbackFunc_o *)sub_1C6BC54(ScriptConnectListViewManager_CallbackFunc_TypeInfo);
  ScriptConnectListViewManager_CallbackFunc___ctor(
    ...
    v5);
  if ( !listViewManager
    || (ScriptConnectListViewManager__SetMode_37661004(listViewManager, 1, v4, v8),
  ...
  {
    sub_1C6BC60(scriptTestObjectCancelButton, v7);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB3869 & 1) == 0 )
  {
    sub_1C6BA08(&ScriptConnectListViewMenu_CallbackFunc_TypeInfo);
    byte_4CB3869 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A9EB1C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB386E & 1) == 0 )
  {
    sub_1C6BA08(&ScriptConnectListViewMenu_ResultKind_TypeInfo);
    byte_4CB386E = 1;
  }
  v11[2] = 0;
