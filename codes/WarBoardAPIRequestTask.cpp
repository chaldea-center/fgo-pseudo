        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE080 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_WarBoardAPIRequestTask_requestComplete__);
    byte_42AE080 = 1;
  }
...
LABEL_10:
  ...
  v20 = (NetworkManager_ResultCallbackFunc_o *)sub_B52A54(NetworkManager_ResultCallbackFunc_TypeInfo);
  ...
  if ( v21 && *v21 != (System_Int32_array *)NetworkManager_ResultCallbackFunc_TypeInfo
    || (p_fields->klass = (BattleServantConfConponent_c *)v21,
        sub_B52920(p_fields, v21, v22, v23, v24, v25, v26, v27),
  ...
  sub_B52920(p_resultCallback, v31, v32, v33, v34, v35, v36, v37);
}


void __fastcall WarBoardAPIRequestTask___ctor_21356684(
        WarBoardAPIRequestTask_o *this,
        NetworkManager_ResultCallbackFunc_o *resultCallback,
        bool onStartBeginRequest,
        const MethodInfo *method)
{
  ...
  *(_WORD *)&p_resultCallback[-1].fields.isOpenAfter = onStartBeginRequest;
  ...
  {
    v16 = (WarBoardAPIContinueRequestTask_o *)sub_B52D50(v9);
    WarBoardAPIContinueRequestTask__SetRequest(v16, v17);
  }
  else
  {
    p_resultCallback->klass = (BattleServantConfConponent_c *)v9;
    sub_B52920(p_resultCallback, v9, v10, v11, v12, v13, v14, v15);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE083 & 1) == 0 )
  {
    sub_B52984(&WarBoardAPIRequestTask__Execute_d__11_TypeInfo);
    byte_42AE083 = 1;
  }
  v3 = sub_B52A54(WarBoardAPIRequestTask__Execute_d__11_TypeInfo);
...
void __fastcall WarBoardAPIRequestTask__OnStart(WarBoardAPIRequestTask_o *this, const MethodInfo *method)
{
  ...
  {
    Instance = (RequestBase_o *)sub_B52D50(v7);
    goto LABEL_18;
  }
  p_fields->klass = (BattleServantConfConponent_c *)v7;
  sub_B52920(p_fields, v7, v8, v9, v10, v11, v12, v13);
...
LABEL_15:
    ...
    Instance = (RequestBase_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( Instance )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE5F8 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_WarBoardAPIRequestTask__Execute_b__11_0__);
    byte_42AE5F8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_WarBoardAPIRequestTask__Execute_d__11_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
