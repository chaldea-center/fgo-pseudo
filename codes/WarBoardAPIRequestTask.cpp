        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C549B3 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_WarBoardAPIRequestTask_requestComplete__);
    byte_4C549B3 = 1;
  }
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.request, (int32_t)request, v9, v10);
  v13 = this->fields.request;
  if ( !v13 )
    sub_1C3E7C0(v11, v12);
  CallBack = (System_Delegate_o *)v13->fields.CallBack;
  p_fields = (CGThumbnailListItem_o *)&v13->fields;
  ...
  NetworkManager_ResultCallbackFunc___ctor(
    ...
    0);
  v17 = System_Delegate__Combine(CallBack, (System_Delegate_o *)v16, 0);
  ...
  if ( v17 )
  {
    ...
    if ( (NetworkManager_ResultCallbackFunc_c *)v17->klass != NetworkManager_ResultCallbackFunc_TypeInfo )
      goto LABEL_12;
    p_fields->klass = (CGThumbnailListItem_c *)v17;
  ...
  sub_1C3E508(p_fields, (int32_t)v17, v18, v19);
  v22 = (System_Delegate_o *)this->fields.resultCallback;
  this = (WarBoardAPIRequestTask_o *)((char *)this + 72);
  v23 = (WarBoardAPIRequestTask_c *)System_Delegate__Combine(v22, (System_Delegate_o *)resultCallback, 0);
  v20 = v23;
  if ( !v23 )
  {
LABEL_13:
...
LABEL_14:
  sub_1C3E508((CGThumbnailListItem_o *)this, (int32_t)v20, v24, v25);
}


void WarBoardAPIRequestTask___ctor_38303084(
        WarBoardAPIRequestTask_o *this,
        NetworkManager_ResultCallbackFunc_o *resultCallback,
        bool onStartBeginRequest,
        const MethodInfo *method)
...
LABEL_7:
  ...
  sub_1C3E508(p_resultCallback, (int32_t)v12, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C549B6 & 1) == 0 )
  {
    sub_1C3E564(&WarBoardAPIRequestTask__Execute_d__11_TypeInfo);
    byte_4C549B6 = 1;
  }
  v3 = sub_1C3E7B0(WarBoardAPIRequestTask__Execute_d__11_TypeInfo);
...
LABEL_10:
  ...
  sub_1C3E508(p_fields, (int32_t)v9, v10, v11);
  if ( !this->fields.requestDone )
  {
    ...
    Instance = (RequestBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( Instance )
    {
        ...
        const MethodInfo *method)
{
  ...
  *((_BYTE *)p_responseStr - 15) = 1;
  sub_1C3E508((CGThumbnailListItem_o *)p_responseStr, (int32_t)result, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C549B8 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_WarBoardAPIRequestTask__Execute_b__11_0__);
    byte_4C549B8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_WarBoardAPIRequestTask__Execute_d__11_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
