        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD23 & 1) == 0 )
  {
    sub_1BC3008(&NetworkManager_ResultCallbackFunc_TypeInfo, request);
    sub_1BC3008(&Method_WarBoardAPIRequestTask_requestComplete__, v9);
    byte_4AFFD23 = 1;
  }
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.request, (int32_t)request, v10, v11);
  ...
  if ( v18 )
  {
    ...
    if ( (NetworkManager_ResultCallbackFunc_c *)v18->klass != NetworkManager_ResultCallbackFunc_TypeInfo )
      goto LABEL_12;
    p_fields->klass = (CGThumbnailListItem_c *)v18;
  ...
  sub_1BC2FAC(p_fields, (int32_t)v18, v19, v20);
...
LABEL_14:
  sub_1BC2FAC((CGThumbnailListItem_o *)this, (int32_t)v21, v25, v26);
}


void __fastcall WarBoardAPIRequestTask___ctor_37334524(
        WarBoardAPIRequestTask_o *this,
        NetworkManager_ResultCallbackFunc_o *resultCallback,
        bool onStartBeginRequest,
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD24 & 1) == 0 )
  {
    sub_1BC3008(&NetworkManager_ResultCallbackFunc_TypeInfo, resultCallback);
    byte_4AFFD24 = 1;
  }
...
LABEL_7:
  ...
  sub_1BC2FAC(p_resultCallback, (int32_t)v12, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD26 & 1) == 0 )
  {
    sub_1BC3008(&WarBoardAPIRequestTask__Execute_d__11_TypeInfo, method);
    byte_4AFFD26 = 1;
  }
  v3 = sub_1BC3254(WarBoardAPIRequestTask__Execute_d__11_TypeInfo);
...
void __fastcall WarBoardAPIRequestTask__OnStart(WarBoardAPIRequestTask_o *this, const MethodInfo *method)
{
  ...
  NetworkManager_ResultCallbackFunc_c *v14; // x1
  __int64 v15; // x1
  ...
  if ( (byte_4AFFD25 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_WarBoardAPIRequestTask_requestComplete__, v4);
    byte_4AFFD25 = 1;
  }
...
LABEL_10:
  ...
  sub_1BC2FAC(p_fields, (int32_t)v11, v12, v13);
  if ( !this->fields.requestDone )
  {
    ...
    Instance = (RequestBase_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    if ( Instance )
    {
        ...
        const MethodInfo *method)
{
  ...
  *((_BYTE *)p_responseStr - 15) = 1;
  sub_1BC2FAC((CGThumbnailListItem_o *)p_responseStr, (int32_t)result, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFD28 & 1) == 0 )
  {
    ...
    sub_1BC3008(&UnityEngine_WaitUntil_TypeInfo, v3);
    sub_1BC3008(&Method_WarBoardAPIRequestTask__Execute_b__11_0__, v4);
    byte_4AFFD28 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_WarBoardAPIRequestTask__Execute_d__11_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
