        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F7A5C & 1) == 0 )
  {
    sub_1B640C8(&Method_NetworkManager_getRequest_CardInitRandomLimitCountRequest___, isRes);
    sub_1B640C8(&NetworkManager_TypeInfo, v5);
    sub_1B640C8(&NetworkManager_ResultCallbackFunc_TypeInfo, v6);
    sub_1B640C8(&Method_SetRandomLimitCountResetOptionControl_EndCardInitRandomLimitCountRequest__, v7);
    sub_1B640C8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v8);
    byte_49F7A5C = 1;
  }
  if ( isRes )
  {
    v9 = (NetworkManager_ResultCallbackFunc_o *)sub_1B64314(NetworkManager_ResultCallbackFunc_TypeInfo, isRes, method);
    ...
    Request_object = NetworkManager__getRequest_object_(
                       v9,
                       (const MethodInfo_2EBA9D0 *)Method_NetworkManager_getRequest_CardInitRandomLimitCountRequest___);
    if ( Request_object )
    {
...
LABEL_10:
  ...
  Request_object = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Request_object )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F7A5E & 1) == 0 )
  {
    sub_1B640C8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, result);
    byte_49F7A5E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F7A5B & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_9634/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_BUTTON"*/, method);
    sub_1B640C8(&StringLiteral_9631/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_BUTTON"*/, v4);
    sub_1B640C8(&StringLiteral_9635/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_EXPLANATION"*/, v5);
    sub_1B640C8(&StringLiteral_9632/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_EXPLANATION"*/, v6);
    byte_49F7A5B = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountResetOptionControl_CategoryInfo__Init(
          ownSettingInfo,
          (System_String_o *)StringLiteral_9634/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_BUTTON"*/,
          (System_String_o *)StringLiteral_9635/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_EXPLANATION"*/,
          v2),
        (ownSettingInfo = this->fields.friendSettingInfo) == 0LL) )
  {
    sub_1B64324(ownSettingInfo);
  }
  SetRandomLimitCountResetOptionControl_CategoryInfo__Init(
    ownSettingInfo,
    (System_String_o *)StringLiteral_9631/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_BUTTON"*/,
    (System_String_o *)StringLiteral_9632/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_EXPLANATION"*/,
    v8);
  this->fields.isOwn = 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F7A5D & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_SetRandomLimitCountResetOptionControl_CloseDlg__, v4);
    sub_1B640C8(&Method_SetRandomLimitCountResetOptionControl_OpenDialog__, v5);
    sub_1B640C8(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v6);
    sub_1B640C8(&StringLiteral_9633/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_MSG"*/, v7);
    sub_1B640C8(&StringLiteral_9636/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_MSG"*/, v8);
    sub_1B640C8(&StringLiteral_3737/*"COMMON_CONFIRM_NO"*/, v9);
    sub_1B640C8(&StringLiteral_3740/*"COMMON_CONFIRM_YES"*/, v10);
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountResetOptionControl_OpenDialog__ + 83) & 2) != 0 )
    v12 = (_QWORD *)sub_1B640E0(Method_SetRandomLimitCountResetOptionControl_OpenDialog__);
  ...
  if ( isOwn )
    v15 = (System_String_o **)&StringLiteral_9636/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_MSG"*/;
  else
    v15 = (System_String_o **)&StringLiteral_9633/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_MSG"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F7A5F & 1) == 0 )
  {
    sub_1B640C8(&LocalizationManager_TypeInfo, buttonKey);
    byte_49F7A5F = 1;
  }
