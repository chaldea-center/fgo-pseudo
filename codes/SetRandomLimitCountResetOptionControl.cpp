        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29510 & 1) == 0 )
  {
    sub_1B761C0(&Method_NetworkManager_getRequest_CardInitRandomLimitCountRequest___, isRes);
    sub_1B761C0(&NetworkManager_TypeInfo, v5);
    sub_1B761C0(&NetworkManager_ResultCallbackFunc_TypeInfo, v6);
    sub_1B761C0(&Method_SetRandomLimitCountResetOptionControl_EndCardInitRandomLimitCountRequest__, v7);
  ...
  if ( isRes )
  {
    ...
    Request_object = NetworkManager__getRequest_object_(
                       v9,
                       (const MethodInfo_2EE44C0 *)Method_NetworkManager_getRequest_CardInitRandomLimitCountRequest___);
    if ( Request_object )
    {
...
LABEL_10:
  ...
  Request_object = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Request_object )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29512 & 1) == 0 )
  {
    sub_1B761C0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, result);
    byte_4A29512 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2950F & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_9676/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_BUTTON"*/, method);
    sub_1B761C0(&StringLiteral_9673/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_BUTTON"*/, v4);
    sub_1B761C0(&StringLiteral_9677/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_EXPLANATION"*/, v5);
    sub_1B761C0(&StringLiteral_9674/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_EXPLANATION"*/, v6);
    byte_4A2950F = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountResetOptionControl_CategoryInfo__Init(
          ownSettingInfo,
          (System_String_o *)StringLiteral_9676/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_BUTTON"*/,
          (System_String_o *)StringLiteral_9677/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_EXPLANATION"*/,
          v2),
        (ownSettingInfo = this->fields.friendSettingInfo) == 0LL) )
  {
    sub_1B7641C(ownSettingInfo, method);
  }
  SetRandomLimitCountResetOptionControl_CategoryInfo__Init(
    ownSettingInfo,
    (System_String_o *)StringLiteral_9673/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_BUTTON"*/,
    (System_String_o *)StringLiteral_9674/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_EXPLANATION"*/,
    v8);
  this->fields.isOwn = 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29511 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SetRandomLimitCountResetOptionControl_CloseDlg__, v4);
    sub_1B761C0(&Method_SetRandomLimitCountResetOptionControl_OpenDialog__, v5);
    sub_1B761C0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v6);
    sub_1B761C0(&StringLiteral_9675/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_MSG"*/, v7);
    sub_1B761C0(&StringLiteral_9678/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_MSG"*/, v8);
    sub_1B761C0(&StringLiteral_3758/*"COMMON_CONFIRM_NO"*/, v9);
    sub_1B761C0(&StringLiteral_3762/*"COMMON_CONFIRM_YES"*/, v10);
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountResetOptionControl_OpenDialog__ + 83) & 2) != 0 )
    v12 = (_QWORD *)sub_1B761D8(Method_SetRandomLimitCountResetOptionControl_OpenDialog__);
  ...
  if ( isOwn )
    v15 = (System_String_o **)&StringLiteral_9678/*"OPTION_RANDOM_LIMIT_COUNT_RESET_OWN_MSG"*/;
  else
    v15 = (System_String_o **)&StringLiteral_9675/*"OPTION_RANDOM_LIMIT_COUNT_RESET_FRIEND_MSG"*/;
  v16 = LocalizationManager__Get(*v15, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_3762/*"COMMON_CONFIRM_YES"*/, 0LL);
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3758/*"COMMON_CONFIRM_NO"*/, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v20 = (CommonConfirmDialog_ClickDelegate_o *)sub_1B7640C(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A29513 & 1) == 0 )
  {
    sub_1B761C0(&LocalizationManager_TypeInfo, buttonKey);
    byte_4A29513 = 1;
  }
