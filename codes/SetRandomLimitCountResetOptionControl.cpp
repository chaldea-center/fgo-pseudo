        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D213 & 1) == 0 )
  {
    sub_1C3B764(&Method_NetworkManager_getRequest_CardInitRandomLimitCountRequest___, isRes);
    sub_1C3B764(&NetworkManager_TypeInfo, v5);
    sub_1C3B764(&NetworkManager_ResultCallbackFunc_TypeInfo, v6);
    sub_1C3B764(&Method_SetRandomLimitCountResetOptionControl_EndCardInitRandomLimitCountRequest__, v7);
  ...
  if ( isRes )
  {
    ...
    Request_object = NetworkManager__getRequest_object_(
                       v9,
                       (const MethodInfo_3075AE8 *)Method_NetworkManager_getRequest_CardInitRandomLimitCountRequest___);
    if ( Request_object )
    {
...
LABEL_10:
  ...
  Request_object = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Request_object )
    goto LABEL_10;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D215 & 1) == 0 )
  {
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, result);
    byte_4C1D215 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D212 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_9872/*"PARTY_ORGANIZATION_COMMAND_CARD_CLOSE"*/, method);
    sub_1C3B764(&StringLiteral_9869/*"PARTY_ORGANIZATION_BONUS_SKILL_INVALID_MESSAGE4"*/, v4);
    sub_1C3B764(&StringLiteral_9873/*"PARTY_ORGANIZATION_COMMAND_CARD_TITLE"*/, v5);
    sub_1C3B764(&StringLiteral_9870/*"PARTY_ORGANIZATION_BONUS_SKILL_INVALID_MESSAGE5"*/, v6);
    byte_4C1D212 = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountResetOptionControl_CategoryInfo__Init(
          ownSettingInfo,
          (System_String_o *)StringLiteral_9872/*"PARTY_ORGANIZATION_COMMAND_CARD_CLOSE"*/,
          (System_String_o *)StringLiteral_9873/*"PARTY_ORGANIZATION_COMMAND_CARD_TITLE"*/,
          v2),
        (ownSettingInfo = this->fields.friendSettingInfo) == 0LL) )
  {
    sub_1C3B9C0(ownSettingInfo, method);
  }
  SetRandomLimitCountResetOptionControl_CategoryInfo__Init(
    ownSettingInfo,
    (System_String_o *)StringLiteral_9869/*"PARTY_ORGANIZATION_BONUS_SKILL_INVALID_MESSAGE4"*/,
    (System_String_o *)StringLiteral_9870/*"PARTY_ORGANIZATION_BONUS_SKILL_INVALID_MESSAGE5"*/,
    v8);
  this->fields.isOwn = 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D214 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_SetRandomLimitCountResetOptionControl_CloseDlg__, v4);
    sub_1C3B764(&Method_SetRandomLimitCountResetOptionControl_OpenDialog__, v5);
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v6);
    sub_1C3B764(&StringLiteral_9871/*"PARTY_ORGANIZATION_BONUS_SKILL_INVALID_MESSAGE6"*/, v7);
    sub_1C3B764(&StringLiteral_9874/*"PARTY_ORGANIZATION_CONFIRM2_BASE_PARTY_TITLE"*/, v8);
    sub_1C3B764(&StringLiteral_3802/*"COSTUME_SERVANT_LIST_MSG"*/, v9);
    sub_1C3B764(&StringLiteral_3807/*"CP00858"*/, v10);
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountResetOptionControl_OpenDialog__ + 83) & 2) != 0 )
    v12 = (_QWORD *)sub_1C3B77C(Method_SetRandomLimitCountResetOptionControl_OpenDialog__);
  ...
  if ( isOwn )
    v15 = (System_String_o **)&StringLiteral_9874/*"PARTY_ORGANIZATION_CONFIRM2_BASE_PARTY_TITLE"*/;
  else
    v15 = (System_String_o **)&StringLiteral_9871/*"PARTY_ORGANIZATION_BONUS_SKILL_INVALID_MESSAGE6"*/;
  v16 = LocalizationManager__Get(*v15, 0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_3807/*"CP00858"*/, 0LL);
  v18 = LocalizationManager__Get((System_String_o *)StringLiteral_3802/*"COSTUME_SERVANT_LIST_MSG"*/, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  v20 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C3B9B0(CommonConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D216 & 1) == 0 )
  {
    sub_1C3B764(&LocalizationManager_TypeInfo, buttonKey);
    byte_4C1D216 = 1;
  }
