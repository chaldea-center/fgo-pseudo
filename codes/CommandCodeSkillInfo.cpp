        ...
        const MethodInfo *method)
{
  ...
  int32_t klass; // w27
  UITexture_o *v28; // x26
  UnityEngine_Object_o *Manager__loadCommandCodeTexture_38913396; // x23
  int32_t v30; // w2
  ...
  if ( (byte_4A4D8C8 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_DataManager_GetMasterData_CommandCodeMaster___, v12);
    ...
    sub_1B863B8(&StringLiteral_22637/*"rarity"*/, v18);
    sub_1B863B8(&StringLiteral_15887/*"_0"*/, v19);
  ...
  if ( Entity )
  {
    ...
    if ( isFirst )
    {
      ...
      Manager__loadCommandCodeTexture_38913396 = (UnityEngine_Object_o *)ServantAssetLoadManager__loadCommandCodeTexture_38913396(
                                                                           v28,
                                                                           commandCodeId,
                                                                           0LL);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality(Manager__loadCommandCodeTexture_38913396, 0LL, 0LL) )
      {
        *p_CommandCodeIcon = (struct UITexture_o *)Manager__loadCommandCodeTexture_38913396;
        sub_1B8635C(
          (CGThumbnailListItem_o *)&this->fields.CommandCodeIcon,
          (int32_t)Manager__loadCommandCodeTexture_38913396,
          v30,
          v31);
      }
      Instance = this->fields.NameBg;
      ...
      Instance = System_String__Concat_61683424(
      ...
      Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47470088(v35, 0LL);
      if ( !CommandCodeName )
        goto LABEL_36;
