        ...
        const MethodInfo *method)
{
  ...
  int32_t klass; // w27
  UITexture_o *v28; // x26
  UnityEngine_Object_o *Manager__loadCommandCodeTexture_38496376; // x23
  int32_t v30; // w2
  ...
  if ( (byte_49BA2A1 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMasterData_CommandCodeMaster___, v12);
    ...
    sub_1B4CF90(&StringLiteral_22513/*"rarity"*/, v18);
    sub_1B4CF90(&StringLiteral_15814/*"_0"*/, v19);
  ...
  if ( Entity )
  {
    ...
    if ( isFirst )
    {
      ...
      {
        *p_CommandCodeIcon = (struct UITexture_o *)Manager__loadCommandCodeTexture_38496376;
        sub_1B4CF34(
          (CGThumbnailListItem_o *)&this->fields.CommandCodeIcon,
          (int32_t)Manager__loadCommandCodeTexture_38496376,
          v30,
          v31);
      }
      Instance = this->fields.NameBg;
      ...
      Instance = System_String__Concat_61131716(
      ...
      Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47044416(v35, 0LL);
      if ( !CommandCodeName )
        goto LABEL_36;
