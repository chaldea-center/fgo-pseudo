        ...
        const MethodInfo *method)
{
  ...
  int32_t klass; // w27
  UITexture_o *v28; // x26
  UnityEngine_Object_o *Manager__loadCommandCodeTexture_38863232; // x23
  int64_t v30; // x2
  int32_t v31; // w3
  ...
  if ( (byte_4B65FF3 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_DataManager_GetMasterData_CommandCodeMaster___, v12);
    ...
    sub_1BE4ACC(&StringLiteral_23108/*"rarity"*/, v18);
    sub_1BE4ACC(&StringLiteral_16331/*"_0"*/, v19);
  ...
  if ( Entity )
  {
    ...
    if ( isFirst )
    {
      ...
      Manager__loadCommandCodeTexture_38863232 = (UnityEngine_Object_o *)ServantAssetLoadManager__loadCommandCodeTexture_38863232(
                                                                           v28,
                                                                           commandCodeId,
                                                                           0LL);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality(Manager__loadCommandCodeTexture_38863232, 0LL, 0LL) )
      {
        *p_CommandCodeIcon = (struct UITexture_o *)Manager__loadCommandCodeTexture_38863232;
        sub_1BE4A70(
          (PartyOrganizationUtility_o *)&this->fields.CommandCodeIcon,
          (int64_t)Manager__loadCommandCodeTexture_38863232,
          v30,
          v31,
          v32,
          v33,
      ...
      Instance = System_String__Concat_62710068(
      ...
      Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47334904(v39, 0LL);
      if ( !CommandCodeName )
        goto LABEL_36;
