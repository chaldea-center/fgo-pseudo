        ...
        const MethodInfo *method)
{
  ...
  int32_t klass; // w27
  UITexture_o *v19; // x26
  UnityEngine_Object_o *Manager__loadCommandCodeTexture_41428172; // x23
  int32_t v21; // w2
  int32_t v22; // w3
  ...
  if ( Entity )
  {
    ...
    if ( isFirst )
    {
      ...
      Manager__loadCommandCodeTexture_41428172 = (UnityEngine_Object_o *)ServantAssetLoadManager__loadCommandCodeTexture_41428172(
                                                                           v19,
                                                                           commandCodeId,
                                                                           0);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      if ( UnityEngine_Object__op_Inequality(Manager__loadCommandCodeTexture_41428172, 0, 0) )
      {
        *p_CommandCodeIcon = (struct UITexture_o *)Manager__loadCommandCodeTexture_41428172;
        sub_1C93A78(
          (GrandQuestFolderBoardItem_o *)&this->fields.CommandCodeIcon,
          (int32_t)Manager__loadCommandCodeTexture_41428172,
          v21,
          v22,
          v23,
          v24,
      ...
      Instance = System_String__Concat_64463988(
      ...
      Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49689872(v30, 0);
      if ( !CommandCodeName )
        goto LABEL_36;
    ...
    else
    {
      ...
      if ( !Instance )
        goto LABEL_36;
      LODWORD(v33.fields.x) = (unsigned int)UnityEngine_Transform__get_localPosition(
                                              (UnityEngine_Transform_o *)Instance,
                                              0);
      if ( !v32 )
        goto LABEL_36;
      v33.fields.y = this->fields.DetailObjHeight;
      v33.fields.z = 0.0;
      UnityEngine_Transform__set_localPosition(v32, v33, 0);
    }
