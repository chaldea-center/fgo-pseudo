        ...
        const MethodInfo *method)
{
  ...
  int32_t flag; // w27
  UITexture_o *v19; // x26
  System_Int32_array **Manager__loadCommandCodeTexture_26822204; // x23
  ...
  if ( Entity )
  {
    ...
    if ( isFirst )
    {
      ...
      Manager__loadCommandCodeTexture_26822204 = (System_Int32_array **)ServantAssetLoadManager__loadCommandCodeTexture_26822204(
                                                                          v19,
                                                                          commandCodeId,
                                                                          0LL);
      ...
      if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Manager__loadCommandCodeTexture_26822204, 0LL, 0LL) )
      {
        *p_CommandCodeIcon = (struct UITexture_o *)Manager__loadCommandCodeTexture_26822204;
        sub_B52920(
          (BattleServantConfConponent_o *)&this->fields.CommandCodeIcon,
          Manager__loadCommandCodeTexture_26822204,
          v21,
          v22,
          v23,
          v24,
      ...
      Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_44824884(v30, 0LL);
      if ( !CommandCodeName )
        goto LABEL_40;
