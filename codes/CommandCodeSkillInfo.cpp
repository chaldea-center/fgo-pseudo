        ...
        const MethodInfo *method)
{
  ...
  int32_t klass; // w27
  UITexture_o *v28; // x26
  UnityEngine_Object_o *Manager__loadCommandCodeTexture_39745596; // x23
  int32_t v30; // w2
  ...
  if ( (byte_4B01403 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMasterData_CommandCodeMaster___, v12);
    ...
    sub_1BC3008(&StringLiteral_22736/*"rarity"*/, v18);
    sub_1BC3008(&StringLiteral_15962/*"_0"*/, v19);
  ...
  if ( Entity )
  {
    ...
    if ( isFirst )
    {
      ...
      {
        *p_CommandCodeIcon = (struct UITexture_o *)Manager__loadCommandCodeTexture_39745596;
        sub_1BC2FAC(
          (CGThumbnailListItem_o *)&this->fields.CommandCodeIcon,
          (int32_t)Manager__loadCommandCodeTexture_39745596,
          v30,
          v31);
      }
      Instance = this->fields.NameBg;
      ...
      Instance = System_String__Concat_62386896(
      ...
      Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_48059904(v35, 0LL);
      if ( !CommandCodeName )
        goto LABEL_36;
