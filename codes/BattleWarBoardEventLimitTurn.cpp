void __fastcall BattleWarBoardEventLimitTurn___ctor(BattleWarBoardEventLimitTurn_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.defLimitAct = 0x200000001LL;
  v3 = (struct System_Int32_array *)sub_1C2E1D4(int___TypeInfo, 1LL);
  if ( !v3 )
    sub_1C2E388(0LL, v4);
  if ( !v3->max_length )
    sub_1C2E390(v3, v3);
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.defTurnEffect, (int64_t)v3, v5, v6, v7, v8, v9, v10);
