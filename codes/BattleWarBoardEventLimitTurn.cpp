void __fastcall BattleWarBoardEventLimitTurn___ctor(BattleWarBoardEventLimitTurn_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.defLimitAct = 0x200000001LL;
  v3 = (struct System_Int32_array *)sub_1B6877C(int___TypeInfo, 1LL);
  if ( !v3 )
    sub_1B68930(0LL, v4);
  if ( !v3->max_length )
    sub_1B68938(v3, v3);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.defTurnEffect, (int32_t)v3, v5, v6);
...
LABEL_15:
  ...
  if ( !*(_QWORD *)&v14->max_length )
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&Data_k__BackingField->fields.turnEffect, (int32_t)v15, v16, v17);
  }
}