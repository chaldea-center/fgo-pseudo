void __fastcall BattleWarBoardEventLimitTurn___ctor(BattleWarBoardEventLimitTurn_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.defLimitAct = 0x200000001LL;
  v3 = (struct System_Int32_array *)sub_1BAB4C4(int___TypeInfo, 1LL);
  if ( !v3 )
    sub_1BAB678(0LL, v4);
  if ( !v3->max_length )
    sub_1BAB680(v3, v3);
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.defTurnEffect, (int32_t)v3, v5, v6);
