void __fastcall SpotRoadMaster___ctor(SpotRoadMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A20484 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_SpotRoadMaster__SpotRoadEntity__int___ctor__, method);
    byte_4A20484 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    22,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_SpotRoadMaster__SpotRoadEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20485 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_SpotRoadEntity__Add__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_SpotRoadEntity__ToArray__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_SpotRoadEntity___ctor__, v8);
    sub_1B715CC(&System_Collections_Generic_List_SpotRoadEntity__TypeInfo, v9);
    sub_1B715CC(&SpotRoadEntity_TypeInfo, v10);
    byte_4A20485 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_SpotRoadEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_SpotRoadEntity___ctor__);
...
LABEL_20:
  ...
  return (SpotRoadEntity_array *)System_Collections_Generic_List_object___ToArray(
                                   v11,
                                   (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_SpotRoadEntity__ToArray__);
}