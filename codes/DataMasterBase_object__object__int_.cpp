void DataMasterBase_object__object__int____ctor(
        ...
        int32_t kind,
        const MethodInfo_3394514 *method)
{
...
void DataMasterBase_object__object__int___AddEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *entity,
        const MethodInfo_3395988 *method)
{
...
void DataMasterBase_object__object__int___Clear(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_33951F0 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
...
void DataMasterBase_object__object__int___CreateLookupTable(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_33953DC *method)
{
...
bool DataMasterBase_object__object__int___Deleted(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *obj,
        const MethodInfo_3395890 *method)
{
  ...
  if ( monitor >= 1 )
  {
    for ( i = 0; i < monitor; ++i )
    {
      ...
      Instance = (Il2CppObject *)DataMasterBase_object__object__int___RemoveEntity(
                                   this,
                                   v10,
                                   (const MethodInfo_33959AC *)method->klass->rgctx_data->_33_DataMasterBase_TMaster__TEntity__PKType__RemoveEntity);
...
void DataMasterBase_object__object__int___ForForceDerived(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3396A6C *method)
{
  ;
}
...
DataEntityBase_array *DataMasterBase_object__object__int___GetBaseEntities(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3395AD8 *method)
{
...
System_Collections_ObjectModel_ObservableCollection_DataEntityBase__o *DataMasterBase_object__object__int___GetBaseEntityList(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3395B44 *method)
{
...
Il2CppObject *DataMasterBase_object__object__int___GetEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        int32_t key,
        const MethodInfo_3396838 *method)
{
  ...
  return DataMasterBase_object__object__int___getEntityFromKey(
           this,
           v5,
           (const MethodInfo_3395BC0 *)method->klass->rgctx_data->_57_DataMasterBase_TMaster__TEntity__PKType__TryGetEntityFromId);
}


System_Type_o *DataMasterBase_object__object__int___GetEntityType(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3396A08 *method)
{
...
Il2CppObject *DataMasterBase_object__object__int___GetSingleEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_33968E4 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
...
void DataMasterBase_object__object__int___OnListChanged(
        ...
        const MethodInfo_339608C *method)
{
    ...
    if ( action >= 3 )
    {
      if ( action != 3 )
      {
        ...
        DataMasterBase_object__object__int___CreateLookupTable(
          v6,
          (const MethodInfo_33953DC *)method->klass->rgctx_data->_7_DataMasterBase_TMaster__TEntity__PKType__CreateLookupTable);
      }
    }
    else
    {
...
void DataMasterBase_object__object__int___OnListChangedImplementation(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_Collections_Specialized_NotifyCollectionChangedEventArgs_o *e,
        const MethodInfo_3396834 *method)
{
  ;
}
...
bool DataMasterBase_object__object__int___RemoveEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *entity,
        const MethodInfo_33959AC *method)
{
  ...
  DataMasterBase___c__DisplayClass23_0_object__object__int____ctor(
    ...
    (const MethodInfo_32ACB40 *)method->klass->rgctx_data->_37_DataMasterBase___c__DisplayClass23_0_TMaster__TEntity__PKType___ctor);
  if ( !entity )
    goto LABEL_11;
...
bool DataMasterBase_object__object__int___Replaced(
        ...
        const MethodInfo_3395214 *method)
{
  int64_t value; // x21
  __int64 v7; // x22
  int64_t v8; // x23
  ...
  *(_QWORD *)&v17.fields.hasValue = v7;
  ...
  v14 = (System_Collections_Generic_IEnumerable_T__o *)DataMasterBase_object__object__int___abstractGetList(
                                                         this,
                                                         objOrBytes,
                                                         v16,
                                                         v17,
                                                         (const MethodInfo_3394940 *)method->klass->rgctx_data->_22_DataMasterBase_TMaster__TEntity__PKType__abstractGetList);
...
bool DataMasterBase_object__object__int___ReplacedForThread(
        ...
        const MethodInfo_3395308 *method)
{
  int64_t value; // x21
  __int64 v10; // x22
  int64_t v11; // x23
  ...
  *(_QWORD *)&v19.fields.hasValue = v10;
  ...
  ListForThread = (System_Collections_Generic_IEnumerable_T__o *)DataMasterBase_object__object__int___abstractGetListForThread(
                                                                   ...
                                                                   v19,
                                                                   work,
                                                                   (const MethodInfo_3394C30 *)method->klass->rgctx_data->_24_DataMasterBase_TMaster__TEntity__PKType__abstractGetListForThread);
  ObservableCollectionExtensions__AddRange_object_(
    list,
    ListForThread,
    (const MethodInfo_3169AB4 *)method->klass->rgctx_data->_23_ObservableCollectionExtensions_AddRange_TEntity_);
...
bool DataMasterBase_object__object__int___TryGetEntity(
        ...
        Il2CppObject **entity,
        int32_t key,
        const MethodInfo_3396884 *method)
{
  ...
  return DataMasterBase_object__object__int___TryGetEntityFromId(
           ...
           entity,
           v7,
           (const MethodInfo_3395EE8 *)method->klass->rgctx_data->_58_TEntity);
}
...
bool DataMasterBase_object__object__int___TryGetEntityFromId(
        ...
        Il2CppObject **result,
        System_String_o *key,
        const MethodInfo_3395EE8 *method)
{
  ...
  if ( !lookup )
  {
    DataMasterBase_object__object__int___CreateLookupTable(
      this,
      (const MethodInfo_33953DC *)method->klass->rgctx_data->_45_DataMasterBase_TMaster__TEntity__PKType__get_lookup->klass->rgctx_data[7].rgctxDataDummy);
    lookup = this->fields._lookup;
  }
  if ( !lookup )
    sub_1C32E7C(this);
...
bool DataMasterBase_object__object__int___TryGetSingleEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject **entity,
        const MethodInfo_3396964 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
  int32_t Count; // w22
...
bool DataMasterBase_object__object__int___Updated(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *obj,
        const MethodInfo_3395718 *method)
{
  Il2CppObject *Instance; // x0
  Il2CppObject *v7; // x21
  ...
  while ( 1 )
  {
    ...
    Instance = (Il2CppObject *)DataMasterBase_object__object__int___UpdatedEntity(
                                 ...
                                 *((Il2CppObject **)&v7[2].klass + v8),
                                 (const MethodInfo_3395810 *)method->klass->rgctx_data->_32_DataMasterBase_TMaster__TEntity__PKType__UpdatedEntity);
    if ( ((unsigned __int8)Instance & 1) == 0 )
      break;
...
bool DataMasterBase_object__object__int___UpdatedEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *entity,
        const MethodInfo_3395810 *method)
{
  if ( !entity )
    sub_1C32E7C(this);
  ...
  DataMasterBase_object__object__int___AddEntity(
    this,
    entity,
    (const MethodInfo_3395988 *)method->klass->rgctx_data->_34_DataMasterBase_TMaster__TEntity__PKType__AddEntity);
  return 1;
}
...
System_Object_array *DataMasterBase_object__object__int___abstractGetList(
        ...
        System_Nullable_long__o start,
        System_Nullable_long__o lenght,
        const MethodInfo_3394940 *method)
{
  bool hasValue; // w23
  bool v7; // w24
  long double v10; // q0
  ...
  List = DataMasterBase_object__object__int___directGetList(
           ...
           v18,
           max_length,
           (const MethodInfo_33946C8 *)method->klass->rgctx_data->_14_DataMasterBase_TMaster__TEntity__PKType__directGetList);
...
System_Object_array *DataMasterBase_object__object__int___abstractGetListForThread(
        ...
        System_Nullable_long__o lenght,
        System_Byte_array *work,
        const MethodInfo_3394C30 *method)
{
  bool hasValue; // w23
  bool v9; // w25
  __int64 v12; // x0
...
System_String_o *DataMasterBase_object__object__int___createKey(
        ...
        const MethodInfo_3395CA8 *method)
{
...
System_Object_array *DataMasterBase_object__object__int___directGetList(
        ...
        int32_t start,
        int32_t length,
        const MethodInfo_33946C8 *method)
{
...
Il2CppObject *DataMasterBase_object__object__int___getEntityFromKey(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_String_o *key,
        const MethodInfo_3395BC0 *method)
{
...
System_Collections_ObjectModel_ObservableCollection_TEntity__o *DataMasterBase_object__object__int___getEntityList(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3395AD0 *method)
{
...
System_Object_array *DataMasterBase_object__object__int___getEntitys(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3395ABC *method)
{
...
System_Object_array *DataMasterBase_object__object__int___getEntitys_object_(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3004200 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
  ...
  const MethodInfo_300437C *v23; // x1
...
System_Object_array *DataMasterBase_object__object__int___getList(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *obj,
        const MethodInfo_339465C *method)
{
  if ( (byte_4C3D2E7 & 1) == 0 )
  {
...
bool DataMasterBase_object__object__int___get_IsCreatedLookupTable(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_339461C *method)
{
...
System_Collections_Generic_IReadOnlyDictionary_string__TEntity__o *DataMasterBase_object__object__int___get_lookup(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_339462C *method)
{
...
bool DataMasterBase_object__object__int___isEntityExistsFromId(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_Int64_array *args,
        const MethodInfo_3395E14 *method)
{
  ...
  Key = DataMasterBase_object__object__int___createKey(this, args, (const MethodInfo_3395CA8 *)method);
  lookup = this->fields._lookup;
  v7 = Key;
  if ( !lookup )
  {
...
bool DataMasterBase_object__object__int___isEntityExistsFromId_54091712(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_String_o *key,
        const MethodInfo_3395FC0 *method)
{
  struct System_Collections_Generic_Dictionary_string__TEntity__o *lookup; // x20
  __int64 _8_System_Collections_Generic_IReadOnlyDictionary_string__TEntity; // x1
  System_Collections_Generic_Dictionary_string__TEntity__c *klass; // x8
