void DataMasterBase_object__object__int____ctor(
        ...
        int32_t kind,
        const MethodInfo_342BFD8 *method)
{
...
void DataMasterBase_object__object__int___AddEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *entity,
        const MethodInfo_342D44C *method)
{
...
void DataMasterBase_object__object__int___Clear(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342CCB4 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
...
void DataMasterBase_object__object__int___CreateLookupTable(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342CEA0 *method)
{
...
bool DataMasterBase_object__object__int___Deleted(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *obj,
        const MethodInfo_342D354 *method)
{
  ...
  if ( monitor >= 1 )
  {
    for ( i = 0; i < monitor; ++i )
    {
      ...
      Instance = (Il2CppObject *)DataMasterBase_object__object__int___RemoveEntity(
                                   this,
                                   v11,
                                   (const MethodInfo_342D470 *)method->klass->rgctx_data->_33_DataMasterBase_TMaster__TEntity__PKType__RemoveEntity);
...
void DataMasterBase_object__object__int___ForForceDerived(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342E530 *method)
{
  ;
}
...
DataEntityBase_array *DataMasterBase_object__object__int___GetBaseEntities(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342D59C *method)
{
...
System_Collections_ObjectModel_ObservableCollection_DataEntityBase__o *DataMasterBase_object__object__int___GetBaseEntityList(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342D608 *method)
{
...
Il2CppObject *DataMasterBase_object__object__int___GetEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        int32_t key,
        const MethodInfo_342E2FC *method)
{
  ...
  return DataMasterBase_object__object__int___getEntityFromKey(
           this,
           v5,
           (const MethodInfo_342D684 *)method->klass->rgctx_data->_57_DataMasterBase_TMaster__TEntity__PKType__TryGetEntityFromId);
}


System_Type_o *DataMasterBase_object__object__int___GetEntityType(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342E4CC *method)
{
...
Il2CppObject *DataMasterBase_object__object__int___GetSingleEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342E3A8 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
...
void DataMasterBase_object__object__int___OnListChanged(
        ...
        const MethodInfo_342DB50 *method)
{
    ...
    if ( action >= 3 )
    {
      if ( action != 3 )
      {
        ...
        DataMasterBase_object__object__int___CreateLookupTable(
          v6,
          (const MethodInfo_342CEA0 *)method->klass->rgctx_data->_7_DataMasterBase_TMaster__TEntity__PKType__CreateLookupTable);
      }
    }
    else
    {
...
void DataMasterBase_object__object__int___OnListChangedImplementation(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_Collections_Specialized_NotifyCollectionChangedEventArgs_o *e,
        const MethodInfo_342E2F8 *method)
{
  ;
}
...
bool DataMasterBase_object__object__int___RemoveEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *entity,
        const MethodInfo_342D470 *method)
{
  ...
  DataMasterBase___c__DisplayClass23_0_object__object__int____ctor(
    ...
    (const MethodInfo_333F974 *)method->klass->rgctx_data->_37_DataMasterBase___c__DisplayClass23_0_TMaster__TEntity__PKType___ctor);
  if ( !entity )
    goto LABEL_11;
...
bool DataMasterBase_object__object__int___Replaced(
        ...
        const MethodInfo_342CCD8 *method)
{
  int64_t value; // x21
  __int64 v7; // x22
  int64_t v8; // x23
  ...
  *(_QWORD *)&v18.fields.hasValue = v7;
  ...
  v15 = (System_Collections_Generic_IEnumerable_T__o *)DataMasterBase_object__object__int___abstractGetList(
                                                         ...
                                                         v17,
                                                         v18,
                                                         (const MethodInfo_342C404 *)method->klass->rgctx_data->_22_DataMasterBase_TMaster__TEntity__PKType__abstractGetList);
...
bool DataMasterBase_object__object__int___ReplacedForThread(
        ...
        const MethodInfo_342CDCC *method)
{
  int64_t value; // x21
  __int64 v10; // x22
  int64_t v11; // x23
  ...
  *(_QWORD *)&v19.fields.hasValue = v10;
  ...
  ListForThread = (System_Collections_Generic_IEnumerable_T__o *)DataMasterBase_object__object__int___abstractGetListForThread(
                                                                   ...
                                                                   v19,
                                                                   work,
                                                                   (const MethodInfo_342C6F4 *)method->klass->rgctx_data->_24_DataMasterBase_TMaster__TEntity__PKType__abstractGetListForThread);
  ObservableCollectionExtensions__AddRange_object_(
    list,
    ListForThread,
    (const MethodInfo_31FC20C *)method->klass->rgctx_data->_23_ObservableCollectionExtensions_AddRange_TEntity_);
...
bool DataMasterBase_object__object__int___TryGetEntity(
        ...
        Il2CppObject **entity,
        int32_t key,
        const MethodInfo_342E348 *method)
{
  ...
  return DataMasterBase_object__object__int___TryGetEntityFromId(
           ...
           entity,
           v7,
           (const MethodInfo_342D9AC *)method->klass->rgctx_data->_58_TEntity);
}
...
bool DataMasterBase_object__object__int___TryGetEntityFromId(
        ...
        Il2CppObject **result,
        System_String_o *key,
        const MethodInfo_342D9AC *method)
{
  ...
  if ( !lookup )
  {
    DataMasterBase_object__object__int___CreateLookupTable(
      this,
      (const MethodInfo_342CEA0 *)method->klass->rgctx_data->_45_DataMasterBase_TMaster__TEntity__PKType__get_lookup->klass->rgctx_data[7].rgctxDataDummy);
    lookup = this->fields._lookup;
  }
  if ( !lookup )
...
bool DataMasterBase_object__object__int___TryGetSingleEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject **entity,
        const MethodInfo_342E428 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
  int32_t Count; // w22
...
bool DataMasterBase_object__object__int___Updated(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *obj,
        const MethodInfo_342D1DC *method)
{
  Il2CppObject *Instance; // x0
  __int64 v7; // x1
  Il2CppObject *v8; // x21
  ...
  while ( 1 )
  {
    ...
    Instance = (Il2CppObject *)DataMasterBase_object__object__int___UpdatedEntity(
                                 ...
                                 *((Il2CppObject **)&v8[2].klass + v9),
                                 (const MethodInfo_342D2D4 *)method->klass->rgctx_data->_32_DataMasterBase_TMaster__TEntity__PKType__UpdatedEntity);
    if ( ((unsigned __int8)Instance & 1) == 0 )
      break;
...
bool DataMasterBase_object__object__int___UpdatedEntity(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *entity,
        const MethodInfo_342D2D4 *method)
{
  if ( !entity )
    sub_1C7BD40(this, 0);
  ...
  DataMasterBase_object__object__int___AddEntity(
    this,
    entity,
    (const MethodInfo_342D44C *)method->klass->rgctx_data->_34_DataMasterBase_TMaster__TEntity__PKType__AddEntity);
  return 1;
}
...
System_Object_array *DataMasterBase_object__object__int___abstractGetList(
        ...
        System_Nullable_long__o start,
        System_Nullable_long__o lenght,
        const MethodInfo_342C404 *method)
{
  bool hasValue; // w23
  bool v7; // w24
  long double v10; // q0
  ...
  List = DataMasterBase_object__object__int___directGetList(
           ...
           v23,
           max_length,
           (const MethodInfo_342C18C *)method->klass->rgctx_data->_14_DataMasterBase_TMaster__TEntity__PKType__directGetList);
...
System_Object_array *DataMasterBase_object__object__int___abstractGetListForThread(
        ...
        System_Nullable_long__o lenght,
        System_Byte_array *work,
        const MethodInfo_342C6F4 *method)
{
  bool hasValue; // w23
  bool v9; // w25
  __int64 v12; // x0
...
System_String_o *DataMasterBase_object__object__int___createKey(
        ...
        const MethodInfo_342D76C *method)
{
...
System_Object_array *DataMasterBase_object__object__int___directGetList(
        ...
        int32_t start,
        int32_t length,
        const MethodInfo_342C18C *method)
{
...
Il2CppObject *DataMasterBase_object__object__int___getEntityFromKey(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_String_o *key,
        const MethodInfo_342D684 *method)
{
...
System_Collections_ObjectModel_ObservableCollection_TEntity__o *DataMasterBase_object__object__int___getEntityList(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342D594 *method)
{
...
System_Object_array *DataMasterBase_object__object__int___getEntitys(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342D580 *method)
{
...
System_Object_array *DataMasterBase_object__object__int___getEntitys_object_(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_3095F48 *method)
{
  System_Collections_ObjectModel_Collection_T__o *list; // x0
  ...
  const MethodInfo_30960C4 *v27; // x1
...
System_Object_array *DataMasterBase_object__object__int___getList(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        Il2CppObject *obj,
        const MethodInfo_342C120 *method)
{
  if ( (byte_4CF40EF & 1) == 0 )
  {
...
bool DataMasterBase_object__object__int___get_IsCreatedLookupTable(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342C0E0 *method)
{
...
System_Collections_Generic_IReadOnlyDictionary_string__TEntity__o *DataMasterBase_object__object__int___get_lookup(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        const MethodInfo_342C0F0 *method)
{
...
bool DataMasterBase_object__object__int___isEntityExistsFromId(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_Int64_array *args,
        const MethodInfo_342D8D8 *method)
{
  ...
  Key = DataMasterBase_object__object__int___createKey(this, args, (const MethodInfo_342D76C *)method);
  lookup = this->fields._lookup;
  v8 = Key;
  if ( !lookup )
  {
...
bool DataMasterBase_object__object__int___isEntityExistsFromId_54712964(
        DataMasterBase_TMaster__TEntity__PKType__o *this,
        System_String_o *key,
        const MethodInfo_342DA84 *method)
{
  struct System_Collections_Generic_Dictionary_string__TEntity__o *lookup; // x20
  __int64 _8_System_Collections_Generic_IReadOnlyDictionary_string__TEntity; // x1
  System_Collections_Generic_Dictionary_string__TEntity__c *klass; // x8
