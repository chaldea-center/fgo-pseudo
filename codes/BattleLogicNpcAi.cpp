        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513A7 & 1) == 0 )
  {
    this = (BattleLogicNpcAi_o *)sub_1B863B8(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513AC & 1) == 0 )
  {
    sub_1B863B8(&BattleComboData_TypeInfo, retList);
    sub_1B863B8(&BattleTreasureDeviceCommandData_TypeInfo, v7);
          ...
          this->klass->vtable._24_AddNoblePhantasm.methodPtr) & 1) != 0 )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&v13->fields.logictarget, (int32_t)isNobleAction, v15, v16);
    v17 = (BattleComboData_o *)sub_1B86604(BattleComboData_TypeInfo);
    BattleComboData___ctor(v17, 0LL);
    v18 = svtData;
    v19 = (BattleTreasureDeviceCommandData_o *)sub_1B86604(BattleTreasureDeviceCommandData_TypeInfo);
...
LABEL_19:
    ...
    else
    {
      ...
      sub_1B8635C((CGThumbnailListItem_o *)(v26 + 4), (int32_t)v13, v21, v22);
    }
  }
}
...
void __fastcall BattleLogicNpcAi__InitAiActTaskFunction(BattleLogicNpcAi_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A513A4 & 1) == 0 )
  {
    sub_1B863B8(
      ...
      method);
    sub_1B863B8(&BattleLogicBaseAi_taskAiActFunction_TypeInfo, v3);
    byte_4A513A4 = 1;
  }
  ...
  v5 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1B86604(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___set_Item(
    ...
    80,
    (Il2CppObject *)v5,
    (const MethodInfo_329E4E4 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__set_Item__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513A6 & 1) == 0 )
  {
    sub_1B863B8(&NpcAiCheckTask_Argument_TypeInfo, *(_QWORD *)&state);
    sub_1B863B8(&BattleLogicTask___TypeInfo, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_AiNpcBattleServantData__get_Count__, v6);
    this = (BattleLogicNpcAi_o *)sub_1B863B8(&NpcAiCheckTask_TypeInfo, v7);
    byte_4A513A6 = 1;
  }
  data = v4->fields.data;
  if ( !data )
  ...
  this = (BattleLogicNpcAi_o *)sub_1B86460(BattleLogicTask___TypeInfo, 1LL);
  v10 = v4->fields.data;
  if ( !v10
    || (v11 = v10->fields.aiNpcDataList,
        v12 = this,
        v13 = (NpcAiCheckTask_Argument_o *)sub_1B86604(NpcAiCheckTask_Argument_TypeInfo),
        NpcAiCheckTask_Argument___ctor(v13, state, v11, 0, v14),
        v15 = (NpcAiCheckTask_o *)sub_1B86604(NpcAiCheckTask_TypeInfo),
        NpcAiCheckTask___ctor(v15, v4, v13, v16),
        !v12) )
  {
LABEL_15:
    sub_1B86614(this, *(_QWORD *)&state);
  }
  if ( v15 )
  {
    this = (BattleLogicNpcAi_o *)sub_1B864F4(v15, v12->klass->_1.element_class);
    if ( !this )
    {
      v20 = sub_1B86638(0LL);
      sub_1B864E0(v20, 0LL);
  ...
  if ( !LODWORD(v12->fields.logic) )
    sub_1B8661C(this, *(_QWORD *)&state);
  v12->fields.logictarget = (struct BattleLogicTarget_o *)v15;
  sub_1B8635C((CGThumbnailListItem_o *)&v12->fields.logictarget, (int32_t)v15, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513AB & 1) == 0 )
  {
    sub_1B863B8(&NpcBackStepBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4A513AB = 1;
  }
  v4 = (NpcBackStepBattleLogicTask_o *)sub_1B86604(NpcBackStepBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513AA & 1) == 0 )
  {
    sub_1B863B8(&PreLoadNpcBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4A513AA = 1;
  }
  v5 = (PreLoadNpcBattleLogicTask_o *)sub_1B86604(PreLoadNpcBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513A9 & 1) == 0 )
  {
    sub_1B863B8(&NpcStepInBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4A513A9 = 1;
  }
  v7 = (NpcStepInBattleLogicTask_o *)sub_1B86604(NpcStepInBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513AD & 1) == 0 )
  {
    sub_1B863B8(&Method_BasicHelper_IndexValue_int____76090408, svtData);
    byte_4A513AD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513A8 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, npcSvt);
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleLogicTask___ctor__, v9);
    sub_1B863B8(&Method_System_Collections_Generic_List_BattleLogicTask__get_Count__, v10);
    sub_1B863B8(&System_Collections_Generic_List_BattleLogicTask__TypeInfo, v11);
    this = (BattleLogicNpcAi_o *)sub_1B863B8(&NpcServantAiActArgument_TypeInfo, v12);
    byte_4A513A8 = 1;
  }
  if ( !aiEnt )
    goto LABEL_13;
  ...
  v17 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  ...
  if ( !checkTaskArg
    || (State_k__BackingField = checkTaskArg->fields._State_k__BackingField,
        v19 = (NpcServantAiActArgument_o *)sub_1B86604(NpcServantAiActArgument_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A513A5 & 1) == 0 )
  {
    sub_1B863B8(&Method_BattleLogicNpcAi_MakeAiActionTask__, list);
    sub_1B863B8(
