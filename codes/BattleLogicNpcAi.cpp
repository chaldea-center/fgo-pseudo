        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69903 & 1) == 0 )
  {
    this = (BattleLogicNpcAi_o *)sub_1BE4ACC(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69908 & 1) == 0 )
  {
    sub_1BE4ACC(&BattleComboData_TypeInfo, retList);
    sub_1BE4ACC(&BattleTreasureDeviceCommandData_TypeInfo, v7);
          ...
          this->klass->vtable._22_AddNoblePhantasm.methodPtr) & 1) != 0 )
  {
    ...
    *(_QWORD *)(v13 + 32) = isNobleAction;
    sub_1BE4A70((PartyOrganizationUtility_o *)(v13 + 32), isNobleAction, v15, v16, v17, v18, v19, v20);
    v21 = (BattleComboData_o *)sub_1BE4D18(BattleComboData_TypeInfo);
    BattleComboData___ctor(v21, 0LL);
    v22 = svtData;
    v23 = (BattleTreasureDeviceCommandData_o *)sub_1BE4D18(BattleTreasureDeviceCommandData_TypeInfo);
...
LABEL_19:
    ...
    else
    {
      ...
      sub_1BE4A70((PartyOrganizationUtility_o *)(v34 + 4), v13, v25, v26, v27, v28, v29, v30);
    }
  }
}
...
void __fastcall BattleLogicNpcAi__InitAiActTaskFunction(BattleLogicNpcAi_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B69900 & 1) == 0 )
  {
    sub_1BE4ACC(
      ...
      method);
    sub_1BE4ACC(&BattleLogicBaseAi_taskAiActFunction_TypeInfo, v3);
    byte_4B69900 = 1;
  }
  ...
  v5 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BE4D18(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___set_Item(
    ...
    80,
    (Il2CppObject *)v5,
    (const MethodInfo_327FFA8 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__set_Item__);
}
...
void __fastcall BattleLogicNpcAi__Initialize(BattleLogicNpcAi_o *this, BattleData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4B698FF & 1) == 0 )
  {
    sub_1BE4ACC(&AiLogic_TypeInfo, data);
    byte_4B698FF = 1;
  }
  BattleLogicBaseAi__Initialize((BattleLogicBaseAi_o *)this, data, 0LL);
  v5 = (AiLogic_o *)sub_1BE4D18(AiLogic_TypeInfo);
  AiLogic___ctor(v5, 0LL);
  this->fields.aiLogic = v5;
  p_aiLogic = &this->fields.aiLogic;
  sub_1BE4A70((PartyOrganizationUtility_o *)p_aiLogic, (int64_t)v5, v7, v8, v9, v10, v11, v12);
  if ( !*p_aiLogic )
    sub_1BE4D28(0LL, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69902 & 1) == 0 )
  {
    sub_1BE4ACC(&NpcAiCheckTask_Argument_TypeInfo, *(_QWORD *)&state);
    sub_1BE4ACC(&BattleLogicTask___TypeInfo, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_AiNpcBattleServantData__get_Count__, v6);
    this = (BattleLogicNpcAi_o *)sub_1BE4ACC(&NpcAiCheckTask_TypeInfo, v7);
    byte_4B69902 = 1;
  }
  data = v4->fields.data;
  if ( !data )
  ...
  this = (BattleLogicNpcAi_o *)sub_1BE4B74(BattleLogicTask___TypeInfo, 1LL);
  v10 = v4->fields.data;
  if ( !v10
    || (v11 = v10->fields.aiNpcDataList,
        v12 = this,
        v13 = (NpcAiCheckTask_Argument_o *)sub_1BE4D18(NpcAiCheckTask_Argument_TypeInfo),
        NpcAiCheckTask_Argument___ctor(v13, state, v11, 0, v14),
        v15 = (NpcAiCheckTask_o *)sub_1BE4D18(NpcAiCheckTask_TypeInfo),
        NpcAiCheckTask___ctor(v15, v4, v13, v16),
        !v12) )
  {
LABEL_15:
    sub_1BE4D28(this, *(_QWORD *)&state);
  }
  if ( v15 )
  {
    this = (BattleLogicNpcAi_o *)sub_1BE4C08(v15, v12->klass->_1.element_class);
    if ( !this )
    {
      v24 = sub_1BE4D4C(0LL);
      sub_1BE4BF4(v24, 0LL);
  ...
  if ( !LODWORD(v12->fields.logic) )
    sub_1BE4D30(this, *(_QWORD *)&state);
  v12->fields.logictarget = (struct BattleLogicTarget_o *)v15;
  sub_1BE4A70((PartyOrganizationUtility_o *)&v12->fields.logictarget, (int64_t)v15, v17, v18, v19, v20, v21, v22);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69907 & 1) == 0 )
  {
    sub_1BE4ACC(&NpcBackStepBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4B69907 = 1;
  }
  v4 = (NpcBackStepBattleLogicTask_o *)sub_1BE4D18(NpcBackStepBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69906 & 1) == 0 )
  {
    sub_1BE4ACC(&PreLoadNpcBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4B69906 = 1;
  }
  v5 = (PreLoadNpcBattleLogicTask_o *)sub_1BE4D18(PreLoadNpcBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69905 & 1) == 0 )
  {
    sub_1BE4ACC(&NpcStepInBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4B69905 = 1;
  }
  v7 = (NpcStepInBattleLogicTask_o *)sub_1BE4D18(NpcStepInBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69909 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BasicHelper_IndexValue_int____77163864, svtData);
    byte_4B69909 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69904 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, npcSvt);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_BattleLogicTask___ctor__, v7);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_BattleLogicTask__get_Count__, v8);
    sub_1BE4ACC(&System_Collections_Generic_List_BattleLogicTask__TypeInfo, v9);
    this = (BattleLogicNpcAi_o *)sub_1BE4ACC(&NpcServantAiActArgument_TypeInfo, v10);
    byte_4B69904 = 1;
  }
  if ( !aiEnt )
    goto LABEL_12;
  ...
  v15 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_BattleLogicTask___ctor__);
  v16 = (NpcServantAiActArgument_o *)sub_1BE4D18(NpcServantAiActArgument_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B69901 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BattleLogicNpcAi_MakeAiActionTask__, list);
    sub_1BE4ACC(
