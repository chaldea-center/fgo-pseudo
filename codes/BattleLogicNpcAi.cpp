        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3C0 & 1) == 0 )
  {
    this = (BattleLogicNpcAi_o *)sub_1C2D490(&Method_System_Collections_Generic_List_BattleLogicTask__AddRange__);
    byte_4C2A3C0 = 1;
  }
  info = 0;
  if ( !arg )
        ...
        const MethodInfo *method)
{
  ...
  svtData = 0;
  if ( (((__int64 (__fastcall *)(BattleLogicNpcAi_o *, BattleServantData_o **, BaseAiActArgument_o *, const MethodInfo *))this->klass->vtable._23_TryGetActorServant.methodPtr)(
          this,
          &svtData,
          arg,
          this->klass->vtable._23_TryGetActorServant.method)
      & 1) != 0 )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&v11->fields.logictarget, (int32_t)isNobleAction, v13, v14);
    v15 = (BattleComboData_o *)sub_1C2D6DC(BattleComboData_TypeInfo);
    BattleComboData___ctor(v15, 0);
    v16 = svtData;
    v17 = (BattleTreasureDeviceCommandData_o *)sub_1C2D6DC(BattleTreasureDeviceCommandData_TypeInfo);
    ...
    BattleLogicTask__setActionCommand((BattleLogicTask_o *)v11, v15, (BattleCommandData_o *)v17, v18, 0);
    isNobleAction = (BattleLogicNpcAi_o *)svtData;
    if ( !svtData )
      goto LABEL_19;
...
LABEL_19:
    ...
    else
    {
      ...
      sub_1C2D434((CGThumbnailListItem_o *)(v24 + 4), (int32_t)v11, v19, v20);
    }
  }
}
...
void BattleLogicNpcAi__InitAiActTaskFunction(BattleLogicNpcAi_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3BD & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__set_Item__);
  ...
  BattleLogicBaseAi_taskAiActFunction___ctor(
    v4,
    (Il2CppObject *)this,
    (intptr_t)this->klass->vtable._24_AddNoblePhantasm.method,
    0);
  if ( !dicAiActFunc )
    sub_1C2D6EC(v5, v6);
  System_Collections_Generic_Dictionary_Int32Enum__object___set_Item(
    ...
    80,
    (Il2CppObject *)v4,
    (const MethodInfo_3414304 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__set_Item__);
}
...
void BattleLogicNpcAi__Initialize(BattleLogicNpcAi_o *this, BattleData_o *data, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)p_aiLogic, (int32_t)v5, v7, v8);
  if ( !*p_aiLogic )
    sub_1C2D6EC(0, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3BF & 1) == 0 )
  {
    sub_1C2D490(&NpcAiCheckTask_Argument_TypeInfo);
    sub_1C2D490(&BattleLogicTask___TypeInfo);
    sub_1C2D490(&Method_System_Collections_Generic_List_AiNpcBattleServantData__get_Count__);
    this = (BattleLogicNpcAi_o *)sub_1C2D490(&NpcAiCheckTask_TypeInfo);
    byte_4C2A3BF = 1;
  }
  data = v4->fields.data;
  if ( !data )
  ...
  this = (BattleLogicNpcAi_o *)sub_1C2D538(BattleLogicTask___TypeInfo, 1);
  v7 = v4->fields.data;
  if ( !v7
    || (v8 = v7->fields.aiNpcDataList,
        v9 = this,
        v10 = (NpcAiCheckTask_Argument_o *)sub_1C2D6DC(NpcAiCheckTask_Argument_TypeInfo),
        NpcAiCheckTask_Argument___ctor(v10, state, v8, 0, v11),
        v12 = (NpcAiCheckTask_o *)sub_1C2D6DC(NpcAiCheckTask_TypeInfo),
        NpcAiCheckTask___ctor(v12, v4, v10, v13),
        !v9) )
  {
LABEL_15:
    sub_1C2D6EC(this, *(_QWORD *)&state);
  }
  if ( v12 )
  {
    this = (BattleLogicNpcAi_o *)sub_1C2D5CC(v12, v9->klass->_1.element_class);
    if ( !this )
    {
      v17 = sub_1C2D710(0);
      sub_1C2D5B8(v17, 0);
  ...
  if ( !LODWORD(v9->fields.logic) )
    sub_1C2D6F4(this, *(_QWORD *)&state, v14);
  v9->fields.logictarget = (struct BattleLogicTarget_o *)v12;
  sub_1C2D434((CGThumbnailListItem_o *)&v9->fields.logictarget, (int32_t)v12, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3C4 & 1) == 0 )
  {
    sub_1C2D490(&NpcBackStepBattleLogicTask_TypeInfo);
    byte_4C2A3C4 = 1;
  }
  v4 = (NpcBackStepBattleLogicTask_o *)sub_1C2D6DC(NpcBackStepBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3C3 & 1) == 0 )
  {
    sub_1C2D490(&PreLoadNpcBattleLogicTask_TypeInfo);
    byte_4C2A3C3 = 1;
  }
  v5 = (PreLoadNpcBattleLogicTask_o *)sub_1C2D6DC(PreLoadNpcBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3C2 & 1) == 0 )
  {
    sub_1C2D490(&NpcStepInBattleLogicTask_TypeInfo);
    byte_4C2A3C2 = 1;
  }
  v7 = (NpcStepInBattleLogicTask_o *)sub_1C2D6DC(NpcStepInBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3C1 & 1) == 0 )
  {
    ...
    this = (BattleLogicNpcAi_o *)sub_1C2D490(&NpcServantAiActArgument_TypeInfo);
    byte_4C2A3C1 = 1;
  }
  if ( !aiEnt )
    goto LABEL_13;
  ...
  v13 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_BattleLogicTask__TypeInfo);
  ...
  if ( !checkTaskArg
    || (State_k__BackingField = checkTaskArg->fields._State_k__BackingField,
        v15 = (NpcServantAiActArgument_o *)sub_1C2D6DC(NpcServantAiActArgument_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A3BE & 1) == 0 )
  {
    sub_1C2D490(&Method_BattleLogicNpcAi_MakeAiActionTask__);
