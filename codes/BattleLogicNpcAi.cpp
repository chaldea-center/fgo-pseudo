        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52FA & 1) == 0 )
  {
    this = (BattleLogicNpcAi_o *)sub_1B00CCC(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52FF & 1) == 0 )
  {
    sub_1B00CCC(&BattleComboData_TypeInfo, retList);
    sub_1B00CCC(&BattleTreasureDeviceCommandData_TypeInfo, v7);
          ...
          this->klass->vtable._22_AddNoblePhantasm.methodPtr) & 1) != 0 )
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&v13->fields.logictarget, (int32_t)isNobleAction, v15, v16);
    v17 = (BattleComboData_o *)sub_1B00F18(BattleComboData_TypeInfo);
    BattleComboData___ctor(v17, 0LL);
    v18 = svtData;
    v19 = (BattleTreasureDeviceCommandData_o *)sub_1B00F18(BattleTreasureDeviceCommandData_TypeInfo);
    ...
    BattleLogicTask__setActionCommand((BattleLogicTask_o *)v13, v17, (BattleCommandData_o *)v19, v20, v21);
    isNobleAction = (BattleLogicNpcAi_o *)svtData;
    if ( !svtData )
      goto LABEL_19;
...
LABEL_19:
    ...
    else
    {
      ...
      sub_1B00C70((ServantStatusBattleListViewItem_o *)(v28 + 4), (int32_t)v13, v23, v24);
    }
  }
}
...
void __fastcall BattleLogicNpcAi__InitAiActTaskFunction(BattleLogicNpcAi_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E52F7 & 1) == 0 )
  {
    sub_1B00CCC(
      ...
      method);
    sub_1B00CCC(&BattleLogicBaseAi_taskAiActFunction_TypeInfo, v3);
    byte_48E52F7 = 1;
  }
  ...
  v5 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1B00F18(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___set_Item(
    ...
    80,
    (Il2CppObject *)v5,
    (const MethodInfo_3063EA8 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__set_Item__);
}
...
void __fastcall BattleLogicNpcAi__Initialize(BattleLogicNpcAi_o *this, BattleData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_48E52F6 & 1) == 0 )
  {
    sub_1B00CCC(&AiLogic_TypeInfo, data);
    byte_48E52F6 = 1;
  }
  BattleLogicBaseAi__Initialize((BattleLogicBaseAi_o *)this, data, 0LL);
  v5 = (AiLogic_o *)sub_1B00F18(AiLogic_TypeInfo);
  AiLogic___ctor(v5, 0LL);
  this->fields.aiLogic = v5;
  p_aiLogic = &this->fields.aiLogic;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)p_aiLogic, (int32_t)v5, v7, v8);
  if ( !*p_aiLogic )
    sub_1B00F28(0LL, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52F9 & 1) == 0 )
  {
    sub_1B00CCC(&NpcAiCheckTask_Argument_TypeInfo, *(_QWORD *)&state);
    sub_1B00CCC(&BattleLogicTask___TypeInfo, v5);
    sub_1B00CCC(&Method_System_Collections_Generic_List_AiNpcBattleServantData__get_Count__, v6);
    this = (BattleLogicNpcAi_o *)sub_1B00CCC(&NpcAiCheckTask_TypeInfo, v7);
    byte_48E52F9 = 1;
  }
  data = v4->fields.data;
  if ( !data )
  ...
  this = (BattleLogicNpcAi_o *)sub_1B00D74(BattleLogicTask___TypeInfo, 1LL);
  v10 = v4->fields.data;
  if ( !v10
    || (v11 = v10->fields.aiNpcDataList,
        v12 = this,
        v13 = (NpcAiCheckTask_Argument_o *)sub_1B00F18(NpcAiCheckTask_Argument_TypeInfo),
        NpcAiCheckTask_Argument___ctor(v13, state, v11, 0, v14),
        v15 = (NpcAiCheckTask_o *)sub_1B00F18(NpcAiCheckTask_TypeInfo),
        NpcAiCheckTask___ctor(v15, v4, v13, v16),
        !v12) )
  {
LABEL_15:
    sub_1B00F28(this, *(_QWORD *)&state);
  }
  if ( v15 )
  {
    this = (BattleLogicNpcAi_o *)sub_1B00E08(v15, v12->klass->_1.element_class);
    if ( !this )
    {
      v20 = sub_1B00F4C(0LL);
      sub_1B00DF4(v20, 0LL);
  ...
  if ( !LODWORD(v12->fields.logic) )
    sub_1B00F30(this, *(_QWORD *)&state);
  v12->fields.logictarget = (struct BattleLogicTarget_o *)v15;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v12->fields.logictarget, (int32_t)v15, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52FE & 1) == 0 )
  {
    sub_1B00CCC(&NpcBackStepBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_48E52FE = 1;
  }
  v4 = (NpcBackStepBattleLogicTask_o *)sub_1B00F18(NpcBackStepBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52FD & 1) == 0 )
  {
    sub_1B00CCC(&PreLoadNpcBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_48E52FD = 1;
  }
  v5 = (PreLoadNpcBattleLogicTask_o *)sub_1B00F18(PreLoadNpcBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52FC & 1) == 0 )
  {
    sub_1B00CCC(&NpcStepInBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_48E52FC = 1;
  }
  v7 = (NpcStepInBattleLogicTask_o *)sub_1B00F18(NpcStepInBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5300 & 1) == 0 )
  {
    sub_1B00CCC(&Method_BasicHelper_IndexValue_int____74583056, svtData);
    byte_48E5300 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52FB & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, npcSvt);
    sub_1B00CCC(&Method_System_Collections_Generic_List_BattleLogicTask___ctor__, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_BattleLogicTask__get_Count__, v8);
    sub_1B00CCC(&System_Collections_Generic_List_BattleLogicTask__TypeInfo, v9);
    this = (BattleLogicNpcAi_o *)sub_1B00CCC(&NpcServantAiActArgument_TypeInfo, v10);
    byte_48E52FB = 1;
  }
  if ( !aiEnt )
    goto LABEL_12;
  ...
  v16 = (NpcServantAiActArgument_o *)sub_1B00F18(NpcServantAiActArgument_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E52F8 & 1) == 0 )
  {
    sub_1B00CCC(&Method_BattleLogicNpcAi_MakeAiActionTask__, list);
    sub_1B00CCC(
