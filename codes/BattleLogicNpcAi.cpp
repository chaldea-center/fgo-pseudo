        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F51A & 1) == 0 )
  {
    this = (BattleLogicNpcAi_o *)sub_1BCAFF8(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F51F & 1) == 0 )
  {
    sub_1BCAFF8(&BattleComboData_TypeInfo, retList);
    sub_1BCAFF8(&BattleTreasureDeviceCommandData_TypeInfo, v7);
          ...
          this->klass->vtable._24_AddNoblePhantasm.methodPtr) & 1) != 0 )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&v13->fields.logictarget, (int32_t)isNobleAction, v15, v16);
    v17 = (BattleComboData_o *)sub_1BCB244(BattleComboData_TypeInfo);
    BattleComboData___ctor(v17, 0LL);
    v18 = svtData;
    v19 = (BattleTreasureDeviceCommandData_o *)sub_1BCB244(BattleTreasureDeviceCommandData_TypeInfo);
    ...
    if ( !svtData
      ...
      || (isNobleAction = (BattleLogicNpcAi_o *)AiBaseEntity__IsForcedActionSpeedAnyTime(
                                                  ...
                                                  0LL),
          LOBYTE(v13[2].fields.logic) = (unsigned __int8)isNobleAction & 1,
          !retList)
...
LABEL_19:
    ...
    else
    {
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)(v26 + 4), (int32_t)v13, v21, v22);
    }
  }
}
...
void __fastcall BattleLogicNpcAi__InitAiActTaskFunction(BattleLogicNpcAi_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1F517 & 1) == 0 )
  {
    sub_1BCAFF8(
      ...
      method);
    sub_1BCAFF8(&BattleLogicBaseAi_taskAiActFunction_TypeInfo, v3);
    byte_4B1F517 = 1;
  }
  ...
  v5 = (BattleLogicBaseAi_taskAiActFunction_o *)sub_1BCB244(BattleLogicBaseAi_taskAiActFunction_TypeInfo);
  ...
  System_Collections_Generic_Dictionary_Int32Enum__object___set_Item(
    ...
    80,
    (Il2CppObject *)v5,
    (const MethodInfo_3352B44 *)Method_System_Collections_Generic_Dictionary_AiAct_TYPE__BattleLogicBaseAi_taskAiActFunction__set_Item__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F519 & 1) == 0 )
  {
    sub_1BCAFF8(&NpcAiCheckTask_Argument_TypeInfo, *(_QWORD *)&state);
    sub_1BCAFF8(&BattleLogicTask___TypeInfo, v5);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_AiNpcBattleServantData__get_Count__, v6);
    this = (BattleLogicNpcAi_o *)sub_1BCAFF8(&NpcAiCheckTask_TypeInfo, v7);
    byte_4B1F519 = 1;
  }
  data = v4->fields.data;
  if ( !data )
  ...
  this = (BattleLogicNpcAi_o *)sub_1BCB0A0(BattleLogicTask___TypeInfo, 1LL);
  v10 = v4->fields.data;
  if ( !v10
    || (v11 = v10->fields.aiNpcDataList,
        v12 = this,
        v13 = (NpcAiCheckTask_Argument_o *)sub_1BCB244(NpcAiCheckTask_Argument_TypeInfo),
        NpcAiCheckTask_Argument___ctor(v13, state, v11, 0, v14),
        v15 = (NpcAiCheckTask_o *)sub_1BCB244(NpcAiCheckTask_TypeInfo),
        NpcAiCheckTask___ctor(v15, v4, v13, v16),
        !v12) )
  {
LABEL_15:
    sub_1BCB254(this, *(_QWORD *)&state);
  }
  if ( v15 )
  {
    this = (BattleLogicNpcAi_o *)sub_1BCB134(v15, v12->klass->_1.element_class);
    if ( !this )
    {
      v20 = sub_1BCB278(0LL);
      sub_1BCB120(v20, 0LL);
  ...
  if ( !LODWORD(v12->fields.logic) )
    sub_1BCB25C(this, *(_QWORD *)&state, v17);
  v12->fields.logictarget = (struct BattleLogicTarget_o *)v15;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v12->fields.logictarget, (int32_t)v15, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F51E & 1) == 0 )
  {
    sub_1BCAFF8(&NpcBackStepBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4B1F51E = 1;
  }
  v4 = (NpcBackStepBattleLogicTask_o *)sub_1BCB244(NpcBackStepBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F51D & 1) == 0 )
  {
    sub_1BCAFF8(&PreLoadNpcBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4B1F51D = 1;
  }
  v5 = (PreLoadNpcBattleLogicTask_o *)sub_1BCB244(PreLoadNpcBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F51C & 1) == 0 )
  {
    sub_1BCAFF8(&NpcStepInBattleLogicTask_TypeInfo, *(_QWORD *)&targetId);
    byte_4B1F51C = 1;
  }
  v7 = (NpcStepInBattleLogicTask_o *)sub_1BCB244(NpcStepInBattleLogicTask_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F520 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BasicHelper_IndexValue_int____76920464, svtData);
    byte_4B1F520 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F51B & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleLogicTask__ToArray__, npcSvt);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleLogicTask___ctor__, v9);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleLogicTask__get_Count__, v10);
    sub_1BCAFF8(&System_Collections_Generic_List_BattleLogicTask__TypeInfo, v11);
    this = (BattleLogicNpcAi_o *)sub_1BCAFF8(&NpcServantAiActArgument_TypeInfo, v12);
    byte_4B1F51B = 1;
  }
  if ( !aiEnt )
    goto LABEL_13;
  ...
  if ( !checkTaskArg
    || (State_k__BackingField = checkTaskArg->fields._State_k__BackingField,
        v19 = (NpcServantAiActArgument_o *)sub_1BCB244(NpcServantAiActArgument_TypeInfo),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F518 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_BattleLogicNpcAi_MakeAiActionTask__, list);
    sub_1BCAFF8(
      &Method_System_Collections_Generic_Dictionary_BattleLogicTask_ACTIONTYPE__BattleLogic_reactionFunction__Add__,
      v5);
    sub_1BCAFF8(&BattleLogic_reactionFunction_TypeInfo, v6);
    byte_4B1F518 = 1;
  }
  v7 = (BattleLogic_reactionFunction_o *)sub_1BCB244(BattleLogic_reactionFunction_TypeInfo);
