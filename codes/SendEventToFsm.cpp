void SendEventToFsm___ctor(SendEventToFsm_o *this, const MethodInfo *method)
{
  ...
  this->fields.sendEvent = (struct System_String_o *)StringLiteral_23396/*"none"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.sendEvent, v9, v2, v3, v4, v5, v6, v7);
