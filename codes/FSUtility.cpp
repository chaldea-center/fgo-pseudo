void __fastcall FSUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDDD66 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_7036/*"FullScreen/FSUtilityList"*/);
    byte_4BDDD66 = 1;
  }
  static_fields = FSUtility_TypeInfo->static_fields;
  *(_QWORD *)&static_fields->RATIO_VISTA = 0x4015555540000000LL;
  v8 = StringLiteral_7036/*"FullScreen/FSUtilityList"*/;
  static_fields->FS_UTILITY_LIST_PATH = (struct System_String_o *)StringLiteral_7036/*"FullScreen/FSUtilityList"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&static_fields->FS_UTILITY_LIST_PATH, v8, v1, v2, v3, v4, v5, v6);
  v9 = sub_1C21EE0(int___TypeInfo, 0LL);
  v10 = FSUtility_TypeInfo->static_fields;
  v10->legacyBacks = (struct System_Int32_array *)v9;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v10->legacyBacks, v9, v11, v12, v13, v14, v15, v16);
  v17 = sub_1C21EE0(string___TypeInfo, 0LL);
  v18 = FSUtility_TypeInfo->static_fields;
  v18->fullScreenImages = (struct System_String_array *)v17;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v18->fullScreenImages, v17, v19, v20, v21, v22, v23, v24);
  v25 = (System_Collections_Generic_Dictionary_int__float__o *)sub_1C22084(System_Collections_Generic_Dictionary_int__float__TypeInfo);
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&v26->trimBackRatioY, (int64_t)v25, v27, v28, v29, v30, v31, v32);
  v33 = sub_1C21EE0(string___TypeInfo, 0LL);
  v34 = FSUtility_TypeInfo->static_fields;
  v34->legacyMovies = (struct System_String_array *)v33;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v34->legacyMovies, v33, v35, v36, v37, v38, v39, v40);
  v41 = sub_1C21EE0(int___TypeInfo, 0LL);
  v42 = FSUtility_TypeInfo->static_fields;
  v42->notFullScreenNpChrs = (struct System_Int32_array *)v41;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v42->notFullScreenNpChrs, v41, v43, v44, v45, v46, v47, v48);
}
...
void __fastcall FSUtility___ctor(FSUtility_o *this, const MethodInfo *method)
{
  if ( (byte_4BDDD65 & 1) == 0 )
  {
    sub_1C21E38(&Method_SingletonMonoBehaviour_FSUtility___ctor__);
    byte_4BDDD65 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_388D470 *)Method_SingletonMonoBehaviour_FSUtility___ctor__);
}
...
float __fastcall FSUtility__GetBackFSOffsetY(System_String_o *fileName, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDD5B & 1) == 0 )
  {
    ...
    sub_1C21E38(&FSUtility_TypeInfo);
    sub_1C21E38(&StringLiteral_3177/*"Back/back"*/);
    fileName = (System_String_o *)sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BDDD5B = 1;
  }
  result = -1;
  if ( !v2 )
  ...
  v3 = System_String__Replace_63135104(
         v2,
         (System_String_o *)StringLiteral_3177/*"Back/back"*/,
...
void __fastcall FSUtility__Initialize(const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
    byte_4BDDD53 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
bool __fastcall FSUtility__IsFullScreenBack(System_String_o *fileName, const MethodInfo *method)
{
  ...
  if ( System_Int32__TryParse(v3, &result, 0LL) )
  {
    ...
    if ( !FSUtility_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(FSUtility_TypeInfo);
    return FSUtility__IsFullScreenBack_42392276(v5, v4);
  }
  else
  {
    return 0;
...
bool __fastcall FSUtility__IsFullScreenBack_42392276(int32_t id, const MethodInfo *method)
{
  FSUtility_c *v3; // x0
  signed int v4; // w8
  signed int v5; // w21
...
bool __fastcall FSUtility__IsFullScreenMovie(System_String_o *fileName, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDD5D & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_1124/*"/(?<name>[^/]*?)\\.[Uu][Ss][Mm]$"*/);
    sub_1C21E38(&StringLiteral_22383/*"name"*/);
    byte_4BDDD5D = 1;
  }
  if ( !System_Text_RegularExpressions_Regex_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Text_RegularExpressions_Regex_TypeInfo);
  Item_69655448 = (__int64)System_Text_RegularExpressions_Regex__Match(
                             fileName,
  ...
  if ( !Item_69655448 )
    goto LABEL_32;
  v5 = Item_69655448;
  if ( !System_Text_RegularExpressions_Group__get_Success((System_Text_RegularExpressions_Group_o *)Item_69655448, 0LL) )
  {
LABEL_18:
    v10 = 0;
    return v10 & 1;
  }
  Item_69655448 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v5 + 392LL))(
                    v5,
                    *(_QWORD *)(*(_QWORD *)v5 + 400LL));
  if ( !Item_69655448 )
    goto LABEL_32;
  Item_69655448 = (__int64)System_Text_RegularExpressions_GroupCollection__get_Item_69655448(
                             (System_Text_RegularExpressions_GroupCollection_o *)Item_69655448,
                             (System_String_o *)StringLiteral_22383/*"name"*/,
                             0LL);
  if ( !Item_69655448 )
    goto LABEL_32;
  Value = System_Text_RegularExpressions_Capture__get_Value(
            (System_Text_RegularExpressions_Capture_o *)Item_69655448,
            0LL);
  v7 = 0LL;
  while ( 1 )
  {
    Item_69655448 = (__int64)FSUtility_TypeInfo;
    if ( !FSUtility_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(FSUtility_TypeInfo);
      Item_69655448 = (__int64)FSUtility_TypeInfo;
    }
    legacyMovies = *(struct System_String_array **)(*(_QWORD *)(Item_69655448 + 184) + 48LL);
    if ( !legacyMovies )
      goto LABEL_32;
    if ( (__int64)v7 >= (int)legacyMovies->max_length )
      break;
    if ( !*(_DWORD *)(Item_69655448 + 224) )
    {
      j_il2cpp_runtime_class_init_0(Item_69655448);
  ...
  Item_69655448 = (__int64)BalanceConfig_TypeInfo;
  if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(BalanceConfig_TypeInfo);
    Item_69655448 = (__int64)BalanceConfig_TypeInfo;
  }
  legacyAspectMovies = *(struct System_String_array **)(*(_QWORD *)(Item_69655448 + 184) + 848LL);
...
LABEL_32:
  ...
  if ( (int)v13 >= 1 )
  {
    ...
    {
      Item_69655448 = System_String__op_Equality(legacyAspectMovies->m_Items[v15], Value, 0LL);
      if ( (Item_69655448 & 1) == 0 )
      {
...
void __fastcall FSUtility__LoadAssetData(const MethodInfo *method)
{
  ...
  if ( (byte_4BDDD55 & 1) == 0 )
  {
    ...
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
    sub_1C21E38(&Method_FSUtility___c__DisplayClass14_0__LoadAssetData_b__0__);
    sub_1C21E38(&FSUtility___c__DisplayClass14_0_TypeInfo);
    byte_4BDDD55 = 1;
  }
  v1 = sub_1C22084(FSUtility___c__DisplayClass14_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v1, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
  if ( !v1 )
    sub_1C22094(Instance, v3);
  *(_QWORD *)(v1 + 16) = Instance;
  sub_1C21DDC((PartyOrganizationUtility_o *)(v1 + 16), (int64_t)Instance, v4, v5, v6, v7, v8, v9);
  ...
  if ( !UnityEngine_Object__op_Equality(v10, 0LL, 0LL) )
  {
    ...
    AssetManager__loadAssetStorage(FS_UTILITY_LIST_PATH, v14, 1, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDDD56 & 1) == 0 )
  {
    ...
    this = (FSUtility_o *)sub_1C21E38(&FSUtility_TypeInfo);
    byte_4BDDD56 = 1;
  }
  if ( !fsUtilityList )
    goto LABEL_18;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&v13->legacyMovies, (int64_t)legacyMovies, v14, v15, v16, v17, v18, v19);
  ...
  sub_1C21DDC(
    (PartyOrganizationUtility_o *)&v21->fullScreenImages,
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v36 >= max_length )
        sub_1C2209C(this, fsUtilityList);
...
LABEL_18:
    sub_1C22094(this, fsUtilityList);
  }
LABEL_15:
  ...
  sub_1C21DDC(
    (PartyOrganizationUtility_o *)&v40->notFullScreenNpChrs,
        ...
        const MethodInfo *method)
{
  ...
  if ( !backTexture )
    sub_1C22094(IsFullScreenBack, v6);
  if ( IsFullScreenBack )
    v7 = 576;
  else
    v7 = 756;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDDD67 & 1) == 0 )
  {
    sub_1C21E38(&Method_AssetData_GetObject_FSUtilityList___);
    this = (FSUtility___c__DisplayClass14_0_o *)sub_1C21E38(&FSUtility_TypeInfo);
    byte_4BDDD67 = 1;
  }
  if ( !assetData
    || (this = (FSUtility___c__DisplayClass14_0_o *)AssetData__GetObject_object_(
                                                      assetData,
                                                      (const MethodInfo_2F91DC0 *)Method_AssetData_GetObject_FSUtilityList___),
        !v4->fields.ins) )
  {
