void __fastcall FSUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C8D0 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_6860/*"FullScreen/FSUtilityList"*/);
    byte_4A5C8D0 = 1;
  }
  static_fields = FSUtility_TypeInfo->static_fields;
  *(_QWORD *)&static_fields->RATIO_VISTA = 0x4015555540000000LL;
  v4 = StringLiteral_6860/*"FullScreen/FSUtilityList"*/;
  static_fields->FS_UTILITY_LIST_PATH = (struct System_String_o *)StringLiteral_6860/*"FullScreen/FSUtilityList"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->FS_UTILITY_LIST_PATH, v4, v1, v2);
  v5 = sub_1B88658(int___TypeInfo, 0LL);
  v6 = FSUtility_TypeInfo->static_fields;
  v6->legacyBacks = (struct System_Int32_array *)v5;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v6->legacyBacks, v5, v7, v8);
  v9 = sub_1B88658(string___TypeInfo, 0LL);
  v10 = FSUtility_TypeInfo->static_fields;
  v10->fullScreenImages = (struct System_String_array *)v9;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v10->fullScreenImages, v9, v11, v12);
  v13 = (System_Collections_Generic_Dictionary_int__float__o *)sub_1B887FC(System_Collections_Generic_Dictionary_int__float__TypeInfo);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v14->trimBackRatioY, (int32_t)v13, v15, v16);
  v17 = sub_1B88658(string___TypeInfo, 0LL);
  v18 = FSUtility_TypeInfo->static_fields;
  v18->legacyMovies = (struct System_String_array *)v17;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v18->legacyMovies, v17, v19, v20);
  v21 = sub_1B88658(int___TypeInfo, 0LL);
  v22 = FSUtility_TypeInfo->static_fields;
  v22->notFullScreenNpChrs = (struct System_Int32_array *)v21;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v22->notFullScreenNpChrs, v21, v23, v24);
}
...
void __fastcall FSUtility___ctor(FSUtility_o *this, const MethodInfo *method)
{
  if ( (byte_4A5C8CF & 1) == 0 )
  {
    sub_1B885B0(&Method_SingletonMonoBehaviour_FSUtility___ctor__);
    byte_4A5C8CF = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3739B30 *)Method_SingletonMonoBehaviour_FSUtility___ctor__);
}
...
float __fastcall FSUtility__GetBackFSOffsetY(System_String_o *fileName, const MethodInfo *method)
{
  ...
  if ( (byte_4A5C8C5 & 1) == 0 )
  {
    ...
    sub_1B885B0(&FSUtility_TypeInfo);
    sub_1B885B0(&StringLiteral_3131/*"Back/back"*/);
    fileName = (System_String_o *)sub_1B885B0(&StringLiteral_1/*""*/);
    byte_4A5C8C5 = 1;
  }
  result = -1;
  if ( !v2 )
...
void __fastcall FSUtility__Initialize(const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
    byte_4A5C8BD = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
bool __fastcall FSUtility__IsFullScreenBack(System_String_o *fileName, const MethodInfo *method)
{
  ...
  if ( System_Int32__TryParse(v3, &result, 0LL) )
  {
    ...
    if ( !FSUtility_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(FSUtility_TypeInfo);
    return FSUtility__IsFullScreenBack_41105084(v5, v4);
  }
  else
  {
    return 0;
...
bool __fastcall FSUtility__IsFullScreenBack_41105084(int32_t id, const MethodInfo *method)
{
  FSUtility_c *v3; // x0
  signed int v4; // w8
  signed int v5; // w21
...
bool __fastcall FSUtility__IsFullScreenMovie(System_String_o *fileName, const MethodInfo *method)
{
  ...
  if ( (byte_4A5C8C7 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_1124/*"/(?<name>[^/]*?)\\.[Uu][Ss][Mm]$"*/);
    sub_1B885B0(&StringLiteral_21982/*"name"*/);
    byte_4A5C8C7 = 1;
  }
  if ( !System_Text_RegularExpressions_Regex_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Text_RegularExpressions_Regex_TypeInfo);
  Item_68246300 = (__int64)System_Text_RegularExpressions_Regex__Match(
                             fileName,
  ...
  if ( !Item_68246300 )
    goto LABEL_32;
  v5 = Item_68246300;
  if ( !System_Text_RegularExpressions_Group__get_Success((System_Text_RegularExpressions_Group_o *)Item_68246300, 0LL) )
  {
LABEL_18:
    v10 = 0;
    return v10 & 1;
  }
  Item_68246300 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v5 + 392LL))(
                    v5,
                    *(_QWORD *)(*(_QWORD *)v5 + 400LL));
  if ( !Item_68246300 )
    goto LABEL_32;
  Item_68246300 = (__int64)System_Text_RegularExpressions_GroupCollection__get_Item_68246300(
                             (System_Text_RegularExpressions_GroupCollection_o *)Item_68246300,
                             (System_String_o *)StringLiteral_21982/*"name"*/,
                             0LL);
  if ( !Item_68246300 )
    goto LABEL_32;
  Value = System_Text_RegularExpressions_Capture__get_Value(
            (System_Text_RegularExpressions_Capture_o *)Item_68246300,
            0LL);
  v7 = 0LL;
  while ( 1 )
  {
    Item_68246300 = (__int64)FSUtility_TypeInfo;
    if ( !FSUtility_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(FSUtility_TypeInfo);
      Item_68246300 = (__int64)FSUtility_TypeInfo;
    }
    legacyMovies = *(struct System_String_array **)(*(_QWORD *)(Item_68246300 + 184) + 48LL);
    if ( !legacyMovies )
      goto LABEL_32;
    if ( (__int64)v7 >= (int)legacyMovies->max_length )
      break;
    if ( !*(_DWORD *)(Item_68246300 + 224) )
    {
      j_il2cpp_runtime_class_init_0(Item_68246300);
  ...
  Item_68246300 = (__int64)BalanceConfig_TypeInfo;
  if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(BalanceConfig_TypeInfo);
    Item_68246300 = (__int64)BalanceConfig_TypeInfo;
  }
  legacyAspectMovies = *(struct System_String_array **)(*(_QWORD *)(Item_68246300 + 184) + 832LL);
  ...
  if ( !*(_DWORD *)(Item_68246300 + 224) )
  {
    ...
    if ( !legacyAspectMovies )
LABEL_32:
      sub_1B8880C(Item_68246300, v4);
  }
  v13 = *(_QWORD *)&legacyAspectMovies->max_length;
  v14 = (int)v13 > 0;
  if ( (int)v13 >= 1 )
  {
    v15 = 0LL;
    ...
    {
      Item_68246300 = System_String__op_Equality(legacyAspectMovies->m_Items[v15], Value, 0LL);
      if ( (Item_68246300 & 1) == 0 )
      {
        LODWORD(v13) = legacyAspectMovies->max_length;
...
void __fastcall FSUtility__LoadAssetData(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C8BF & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
    sub_1B885B0(&Method_FSUtility___c__DisplayClass14_0__LoadAssetData_b__0__);
    sub_1B885B0(&FSUtility___c__DisplayClass14_0_TypeInfo);
    byte_4A5C8BF = 1;
  }
  v1 = sub_1B887FC(FSUtility___c__DisplayClass14_0_TypeInfo);
  FSUtility___c__DisplayClass14_0___ctor((FSUtility___c__DisplayClass14_0_o *)v1, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_FSUtility__get_Instance__);
  if ( !v1 )
    sub_1B8880C(Instance, v3);
  *(_QWORD *)(v1 + 16) = Instance;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v1 + 16), (int32_t)Instance, v4, v5);
  ...
  if ( !UnityEngine_Object__op_Equality(v6, 0LL, 0LL) )
  {
    ...
    AssetManager__loadAssetStorage(FS_UTILITY_LIST_PATH, v10, 1, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C8C0 & 1) == 0 )
  {
    ...
    this = (FSUtility_o *)sub_1B885B0(&FSUtility_TypeInfo);
    byte_4A5C8C0 = 1;
  }
  if ( !fsUtilityList )
    goto LABEL_18;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v9->legacyMovies, (int32_t)legacyMovies, v10, v11);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v13->fullScreenImages, (int32_t)fullScreenImages, v14, v15);
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v20 >= max_length )
        sub_1B88814(this, fsUtilityList);
...
LABEL_18:
    sub_1B8880C(this, fsUtilityList);
  }
LABEL_15:
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v24->notFullScreenNpChrs, (int32_t)notFullScreenNpChrs, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !backTexture )
    sub_1B8880C(IsFullScreenBack, v6);
  if ( IsFullScreenBack )
    v7 = 576;
  else
    v7 = 756;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C8D2 & 1) == 0 )
  {
    sub_1B885B0(&Method_AssetData_GetObject_FSUtilityList___);
    this = (FSUtility___c__DisplayClass14_0_o *)sub_1B885B0(&FSUtility_TypeInfo);
    byte_4A5C8D2 = 1;
  }
  if ( !assetData
    || (this = (FSUtility___c__DisplayClass14_0_o *)AssetData__GetObject_object_(
                                                      assetData,
                                                      (const MethodInfo_2E61D74 *)Method_AssetData_GetObject_FSUtilityList___),
