...
void SetTDPlaySpeedControl__Init(SetTDPlaySpeedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF9AC & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_9791/*"OPTION_TD_PLAY_SPEED_EXPLANATION"*/);
    sub_1CE6700(&StringLiteral_9790/*"OPTION_TD_PLAY_SPEED_DISP"*/);
    byte_4DFF9AC = 1;
  }
  tdPlaySpeedDispTitle = this->fields.tdPlaySpeedDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9790/*"OPTION_TD_PLAY_SPEED_DISP"*/, 0);
  if ( !tdPlaySpeedDispTitle
    || (UILabel__set_text(tdPlaySpeedDispTitle, v4, 0),
        ...
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9791/*"OPTION_TD_PLAY_SPEED_EXPLANATION"*/, 0),
...
void SetTDPlaySpeedControl__OnChangeBtn(SetTDPlaySpeedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF9AF & 1) == 0 )
  {
    sub_1CE6700(&Method_SetTDPlaySpeedControl_OnChangeBtn__);
    byte_4DFF9AF = 1;
  }
  v3 = Method_SetTDPlaySpeedControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetTDPlaySpeedControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1CE6718(Method_SetTDPlaySpeedControl_OnChangeBtn__);
