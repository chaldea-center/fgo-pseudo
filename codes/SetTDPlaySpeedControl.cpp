...
void SetTDPlaySpeedControl__Init(SetTDPlaySpeedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51DBC & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_9715/*"OPTION_TD_PLAY_SPEED_EXPLANATION"*/);
    sub_1C3E564(&StringLiteral_9714/*"OPTION_TD_PLAY_SPEED_DISP"*/);
    byte_4C51DBC = 1;
  }
...
void SetTDPlaySpeedControl__OnChangeBtn(SetTDPlaySpeedControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51DBF & 1) == 0 )
  {
    sub_1C3E564(&Method_SetTDPlaySpeedControl_OnChangeBtn__);
    byte_4C51DBF = 1;
  }
  v3 = Method_SetTDPlaySpeedControl_OnChangeBtn__;
  if ( (*((_BYTE *)Method_SetTDPlaySpeedControl_OnChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_SetTDPlaySpeedControl_OnChangeBtn__);
