...
void __fastcall SubmarineScanConfirmDialog__EndLoad(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6CB40 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v3);
    sub_1B90010(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, v4);
    sub_1B90010(&LocalizationManager_TypeInfo, v5);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    sub_1B90010(&Method_SubmarineScanConfirmDialog__EndLoad_b__18_0__, v7);
    sub_1B90010(&StringLiteral_5713/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/, v8);
    byte_4A6CB40 = 1;
  }
  ...
  if ( Entity )
  {
    ...
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_5713/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/, 0LL);
...
void __fastcall SubmarineScanConfirmDialog__Init(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6CB3E & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_5721/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/, v4);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5721/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/, 0LL);
  if ( !executeLabel
...
LABEL_10:
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, 0, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&Method_SubmarineScanConfirmDialog_OnClickCancelButton__, v3);
    sub_1B90010(&Method_SubmarineScanConfirmDialog__OnClickCancelButton_b__19_0__, v4);
    byte_4A6CB41 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B90028(Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&Method_SubmarineScanConfirmDialog_OnClickExecuteButton__, v3);
    sub_1B90010(&Method_SubmarineScanConfirmDialog__OnClickExecuteButton_b__20_0__, v4);
    byte_4A6CB42 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickExecuteButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B90028(Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6CB3F & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_SubmarineScanConfirmDialog_EndLoad__, v11);
    byte_4A6CB3F = 1;
  }
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, (int32_t)closeAction, v12, v13);
  ...
  baseWindow = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__);
  if ( !baseWindow )
LABEL_15:
    sub_1B9026C(baseWindow, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 0, (const MethodInfo_2DE3468 *)Method_ActionExtensions_Call_bool___);
}
        ...
        const MethodInfo *method)
{
  ...
  closeAction = (System_Action_T__o *)this->fields.closeAction;
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 1, (const MethodInfo_2DE3468 *)Method_ActionExtensions_Call_bool___);
}
