...
void SubmarineScanConfirmDialog__EndLoad(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2A7 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SubmarineScanConfirmDialog__EndLoad_b__18_0__);
    sub_1C93AD4(&StringLiteral_5743/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/);
    byte_4D2D2A7 = 1;
  }
  ...
  if ( Entity )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_5743/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/, 0);
...
void SubmarineScanConfirmDialog__Init(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2A5 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_5751/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5751/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/, 0);
  if ( !executeLabel
...
void SubmarineScanConfirmDialog__OnClickCancelButton(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    sub_1C93AD4(&Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
    sub_1C93AD4(&Method_SubmarineScanConfirmDialog__OnClickCancelButton_b__19_0__);
    byte_4D2D2A8 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
...
void SubmarineScanConfirmDialog__OnClickExecuteButton(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    sub_1C93AD4(&Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    sub_1C93AD4(&Method_SubmarineScanConfirmDialog__OnClickExecuteButton_b__20_0__);
    byte_4D2D2A9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickExecuteButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2D2A6 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SubmarineScanConfirmDialog_EndLoad__);
    byte_4D2D2A6 = 1;
  }
  ...
  baseWindow = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__);
  if ( !baseWindow )
LABEL_15:
    sub_1C93D2C(baseWindow, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 0, (const MethodInfo_30EBB64 *)Method_ActionExtensions_Call_bool___);
}
        ...
        const MethodInfo *method)
{
  ...
  closeAction = (System_Action_T__o *)this->fields.closeAction;
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 1, (const MethodInfo_30EBB64 *)Method_ActionExtensions_Call_bool___);
}
