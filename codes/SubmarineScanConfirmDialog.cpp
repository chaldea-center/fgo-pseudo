...
void SubmarineScanConfirmDialog__EndLoad(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAEEC & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SubmarineScanConfirmDialog__EndLoad_b__18_0__);
    sub_1C7BAE8(&StringLiteral_5725/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/);
    byte_4CEAEEC = 1;
  }
  ...
  if ( Entity )
  {
    ...
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_5725/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/, 0);
...
void SubmarineScanConfirmDialog__Init(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEAEEA & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_5733/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  titleLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5733/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/, 0);
  if ( !executeLabel
...
void SubmarineScanConfirmDialog__OnClickCancelButton(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&System_Action_TypeInfo);
    sub_1C7BAE8(&Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
    sub_1C7BAE8(&Method_SubmarineScanConfirmDialog__OnClickCancelButton_b__19_0__);
    byte_4CEAEED = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
...
void SubmarineScanConfirmDialog__OnClickExecuteButton(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&System_Action_TypeInfo);
    sub_1C7BAE8(&Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    sub_1C7BAE8(&Method_SubmarineScanConfirmDialog__OnClickExecuteButton_b__20_0__);
    byte_4CEAEEE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickExecuteButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C7BB00(Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C7BACC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEAEEB & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_SubmarineScanConfirmDialog_EndLoad__);
    byte_4CEAEEB = 1;
  }
  ...
  baseWindow = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__);
  if ( !baseWindow )
LABEL_15:
    sub_1C7BD40(baseWindow, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 0, (const MethodInfo_30B92A0 *)Method_ActionExtensions_Call_bool___);
}
        ...
        const MethodInfo *method)
{
  ...
  closeAction = (System_Action_T__o *)this->fields.closeAction;
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 1, (const MethodInfo_30B92A0 *)Method_ActionExtensions_Call_bool___);
}
