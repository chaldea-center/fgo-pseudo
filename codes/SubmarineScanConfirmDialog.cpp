...
void SubmarineScanConfirmDialog__EndLoad(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F94A & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SubmarineScanConfirmDialog__EndLoad_b__18_0__);
    sub_1C37058(&StringLiteral_5717/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/);
    byte_4C3F94A = 1;
  }
  ...
  if ( Entity )
  {
    ...
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_5717/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/, 0);
...
void SubmarineScanConfirmDialog__Init(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F948 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_5725/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/);
...
void SubmarineScanConfirmDialog__OnClickCancelButton(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
    sub_1C37058(&Method_SubmarineScanConfirmDialog__OnClickCancelButton_b__19_0__);
    byte_4C3F94B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
...
void SubmarineScanConfirmDialog__OnClickExecuteButton(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    sub_1C37058(&Method_SubmarineScanConfirmDialog__OnClickExecuteButton_b__20_0__);
    byte_4C3F94C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickExecuteButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F949 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_SubmarineScanConfirmDialog_EndLoad__);
    byte_4C3F949 = 1;
  }
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.closeAction, (int32_t)closeAction, v9, v10);
  ...
  baseWindow = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__);
  if ( !baseWindow )
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 0, (const MethodInfo_3034458 *)Method_ActionExtensions_Call_bool___);
}
        ...
        const MethodInfo *method)
{
  ...
  closeAction = (System_Action_T__o *)this->fields.closeAction;
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 1, (const MethodInfo_3034458 *)Method_ActionExtensions_Call_bool___);
}
