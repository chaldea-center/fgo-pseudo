...
void __fastcall SubmarineScanConfirmDialog__EndLoad(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9106 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v3);
    sub_1B640C8(&Method_DataMasterBase_EventPanelScanMaster__EventPanelScanEntity__int__GetEntity__, v4);
    sub_1B640C8(&LocalizationManager_TypeInfo, v5);
    sub_1B640C8(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    sub_1B640C8(&Method_SubmarineScanConfirmDialog__EndLoad_b__18_0__, v7);
    sub_1B640C8(&StringLiteral_5686/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/, v8);
    byte_49F9106 = 1;
  }
  ...
  if ( Entity )
  {
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_5686/*"EVENT_SUBMARINE_DO_SCAN_TITLE"*/, 0LL);
    Instance = (DataManager_o *)System_String__Format(v13, (Il2CppObject *)v11[1].monitor, 0LL);
    if ( titleLabel )
    {
...
void __fastcall SubmarineScanConfirmDialog__Init(SubmarineScanConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9104 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_5694/*"EVENT_SUBMARINE_SCAN_CONFIRM_EXECUTE"*/, v4);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&System_Action_TypeInfo, method);
    sub_1B640C8(&Method_SubmarineScanConfirmDialog_OnClickCancelButton__, v3);
    sub_1B640C8(&Method_SubmarineScanConfirmDialog__OnClickCancelButton_b__19_0__, v4);
    byte_49F9107 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickCancelButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B640E0(Method_SubmarineScanConfirmDialog_OnClickCancelButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B640C8(&System_Action_TypeInfo, method);
    sub_1B640C8(&Method_SubmarineScanConfirmDialog_OnClickExecuteButton__, v3);
    sub_1B640C8(&Method_SubmarineScanConfirmDialog__OnClickExecuteButton_b__20_0__, v4);
    byte_49F9108 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineScanConfirmDialog_OnClickExecuteButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B640E0(Method_SubmarineScanConfirmDialog_OnClickExecuteButton__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B640AC(v5, v5[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9105 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_SingletonMonoBehaviour_AtlasManager__get_Instance__, v10);
    sub_1B640C8(&Method_SubmarineScanConfirmDialog_EndLoad__, v11);
    byte_49F9105 = 1;
  }
  ...
  baseWindow = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__);
  if ( !baseWindow )
LABEL_15:
    sub_1B64324(baseWindow);
  if ( AtlasManager__isLoadedSkinData((AtlasManager_o *)baseWindow, 5, 0LL) )
  {
    SubmarineScanConfirmDialog__EndLoad(this, v18);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 0, (const MethodInfo_2D90988 *)Method_ActionExtensions_Call_bool___);
}
        ...
        const MethodInfo *method)
{
  ...
  closeAction = (System_Action_T__o *)this->fields.closeAction;
  if ( closeAction )
    ActionExtensions__Call_bool_(closeAction, 1, (const MethodInfo_2D90988 *)Method_ActionExtensions_Call_bool___);
}
