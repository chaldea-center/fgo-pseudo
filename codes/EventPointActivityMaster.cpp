void __fastcall EventPointActivityMaster___ctor(EventPointActivityMaster_o *this, const MethodInfo *method)
{
  if ( (byte_40FAC0D & 1) == 0 )
  {
    sub_B16FFC(&Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string___ctor__, method);
    byte_40FAC0D = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    266,
    (const MethodInfo_266F73C *)Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventPointActivityEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                         ...
                                         PK,
                                         (const MethodInfo_266F7D8 *)Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_266F830 *)Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FAC0E & 1) == 0 )
  {
    ...
    sub_B16FFC(&EventPointActivityEntity_TypeInfo, v8);
    sub_B16FFC(&Method_System_Collections_Generic_List_EventPointActivityEntity__Add__, v9);
    sub_B16FFC(&Method_System_Collections_Generic_List_EventPointActivityEntity__ToArray__, v10);
    sub_B16FFC(&Method_System_Collections_Generic_List_EventPointActivityEntity___ctor__, v11);
    sub_B16FFC(&System_Collections_Generic_List_EventPointActivityEntity__TypeInfo, v12);
    byte_40FAC0E = 1;
  }
  ...
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v13,
    (const MethodInfo_2F25014 *)Method_System_Collections_Generic_List_EventPointActivityEntity___ctor__);
  ...
  if ( Count >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !Item )
        break;
      v20 = *(&EventPointActivityEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(&Item->klass->_2.bitflags2 + 1) < (unsigned int)v20
        || (EventPointActivityEntity_c *)Item->klass->_2.typeHierarchy[v20 - 1] != EventPointActivityEntity_TypeInfo )
      {
        break;
      }
      if ( Item->fields.missionTargetId == eventId )
      {
        ...
        System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
          v13,
          Item,
          (const MethodInfo_2F25CD8 *)Method_System_Collections_Generic_List_EventPointActivityEntity__Add__);
      }
      if ( ++v17 >= v16 )
        goto LABEL_14;
    }
...
LABEL_14:
  ...
  return (EventPointActivityEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                             ...
                                             (const MethodInfo_2F27E24 *)Method_System_Collections_Generic_List_EventPointActivityEntity__ToArray__);
}