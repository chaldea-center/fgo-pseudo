void __fastcall EventPointActivityMaster___ctor(EventPointActivityMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FECF & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string___ctor__, method);
    byte_4A6FECF = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    268,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventPointActivityEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                         (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                         PK,
                                         (const MethodInfo_312C900 *)Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_EventPointActivityMaster__EventPointActivityEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FED0 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventPointActivityEntity_TypeInfo, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointActivityEntity__Add__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointActivityEntity__ToArray__, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointActivityEntity___ctor__, v9);
    sub_1B90010(&System_Collections_Generic_List_EventPointActivityEntity__TypeInfo, v10);
    byte_4A6FED0 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventPointActivityEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventPointActivityEntity___ctor__);
...
LABEL_17:
  ...
  return (EventPointActivityEntity_array *)System_Collections_Generic_List_object___ToArray(
                                             v11,
                                             (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_EventPointActivityEntity__ToArray__);
}