void __fastcall ServantProfileLimitCountManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FFCFF & 1) == 0 )
  {
    sub_1B64A00(
      ...
      v1);
    sub_1B64A00(&System_Collections_Generic_List_ServantProfileLimitCountManager_ServantLimitCountInfo__TypeInfo, v4);
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v5);
    sub_1B64A00(&StringLiteral_6616/*"Fgo_20191029"*/, v6);
    byte_49FFCFF = 1;
  }
  ServantProfileLimitCountManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6616/*"Fgo_20191029"*/;
  sub_1B649A4(
    (ServantStatusBattleListViewItem_o *)ServantProfileLimitCountManager_TypeInfo->static_fields,
    StringLiteral_6616/*"Fgo_20191029"*/,
    v2,
    v3);
  *(_WORD *)&ServantProfileLimitCountManager_TypeInfo->static_fields->isModfiy = 0;
  v7 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_ServantProfileLimitCountManager_ServantLimitCountInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_34AF794 *)Method_System_Collections_Generic_List_ServantProfileLimitCountManager_ServantLimitCountInfo___ctor__);
...
void __fastcall ServantProfileLimitCountManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_49FFCF8 & 1) == 0 )
  {
    ...
    sub_1B64A00(
      ...
      v2);
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v3);
    byte_49FFCF8 = 1;
  }
...
void __fastcall ServantProfileLimitCountManager__DeleteSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_49FFCF6 & 1) == 0 )
  {
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v1);
    byte_49FFCF6 = 1;
  }
...
int32_t __fastcall ServantProfileLimitCountManager__GetLimitCount(int32_t servantId, const MethodInfo *method)
{
  ...
  if ( (byte_49FFCFA & 1) == 0 )
  {
    sub_1B64A00(
      ...
      method);
    sub_1B64A00(&System_Predicate_ServantProfileLimitCountManager_ServantLimitCountInfo__TypeInfo, v3);
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v4);
    sub_1B64A00(&Method_ServantProfileLimitCountManager___c__DisplayClass10_0__GetLimitCount_b__0__, v5);
    sub_1B64A00(&ServantProfileLimitCountManager___c__DisplayClass10_0_TypeInfo, v6);
    byte_49FFCFA = 1;
  }
  v7 = sub_1B64C4C(ServantProfileLimitCountManager___c__DisplayClass10_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 16) = servantId;
  ...
  v12 = (System_Predicate_object__o *)sub_1B64C4C(System_Predicate_ServantProfileLimitCountManager_ServantLimitCountInfo__TypeInfo);
...
LABEL_10:
  ...
  v13 = System_Collections_Generic_List_object___Find(
          ...
          (const MethodInfo_34B0630 *)Method_System_Collections_Generic_List_ServantProfileLimitCountManager_ServantLimitCountInfo__Find__);
  if ( v13 )
...
bool __fastcall ServantProfileLimitCountManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_49FFCFB & 1) == 0 )
  {
    ...
    sub_1B64A00(&ServantProfileLimitCountManager_ServantLimitCountInfo_TypeInfo, v5);
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v6);
    byte_49FFCFB = 1;
  }
    ...
    if ( v22 >= 1 )
    {
      do
      {
        ...
        v24 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v14->klass->vtable._15_ReadInt32.method)(
                v14,
                v14->klass->vtable._16_ReadUInt32.methodPtr);
        v25 = sub_1B64C4C(ServantProfileLimitCountManager_ServantLimitCountInfo_TypeInfo);
...
LABEL_36:
  ...
  {
LABEL_46:
    v43 = sub_1BB69E0(v13, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFCF9 & 1) == 0 )
  {
    ...
    sub_1B64A00(
      &Method_System_Collections_Generic_List_ServantProfileLimitCountManager_ServantLimitCountInfo__Find__,
      v5);
    sub_1B64A00(&System_Predicate_ServantProfileLimitCountManager_ServantLimitCountInfo__TypeInfo, v6);
    sub_1B64A00(&ServantProfileLimitCountManager_ServantLimitCountInfo_TypeInfo, v7);
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v8);
    sub_1B64A00(&Method_ServantProfileLimitCountManager___c__DisplayClass9_0__SetLimitCount_b__0__, v9);
    sub_1B64A00(&ServantProfileLimitCountManager___c__DisplayClass9_0_TypeInfo, v10);
    byte_49FFCF9 = 1;
  }
  v11 = sub_1B64C4C(ServantProfileLimitCountManager___c__DisplayClass9_0_TypeInfo);
  ...
  *(_DWORD *)(v11 + 16) = servantId;
  ...
  v16 = (System_Predicate_object__o *)sub_1B64C4C(System_Predicate_ServantProfileLimitCountManager_ServantLimitCountInfo__TypeInfo);
  System_Predicate_object____ctor(
    v16,
    (Il2CppObject *)v11,
  ...
  if ( !v17 )
  {
    v19 = sub_1B64C4C(ServantProfileLimitCountManager_ServantLimitCountInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFCFE & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_ServantProfileMaster___, *(_QWORD *)&limitCount);
    sub_1B64A00(&Method_DataMasterBase_getEntitys_ServantProfileEntity___, v5);
    sub_1B64A00(&Method_System_Collections_Generic_List_ServantProfileEntity__Find__, v6);
    sub_1B64A00(&Method_System_Collections_Generic_List_ServantProfileEntity___ctor___75676040, v7);
    sub_1B64A00(&System_Collections_Generic_List_ServantProfileEntity__TypeInfo, v8);
    sub_1B64A00(&System_Predicate_ServantProfileEntity__TypeInfo, v9);
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v10);
    sub_1B64A00(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v11);
    sub_1B64A00(&Method_ServantProfileLimitCountManager___c__DisplayClass14_0__SetLimitCountExistProfile_b__0__, v12);
    sub_1B64A00(&ServantProfileLimitCountManager___c__DisplayClass14_0_TypeInfo, v13);
    byte_49FFCFE = 1;
  }
  v14 = sub_1B64C4C(ServantProfileLimitCountManager___c__DisplayClass14_0_TypeInfo);
  ...
  *(_DWORD *)(v14 + 16) = servantId;
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2E3BCE0 *)Method_DataManager_GetMasterData_ServantProfileMaster___)) == 0LL
    || (Entitys_object = (System_Collections_Generic_IEnumerable_T__o *)DataMasterBase__getEntitys_object_(
                                                                          (DataMasterBase_o *)Instance,
                                                                          (const MethodInfo_2E3C574 *)Method_DataMasterBase_getEntitys_ServantProfileEntity___),
        v18 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_ServantProfileEntity__TypeInfo),
        System_Collections_Generic_List_object____ctor_55244988(
          v18,
          Entitys_object,
          (const MethodInfo_34AF8BC *)Method_System_Collections_Generic_List_ServantProfileEntity___ctor___75676040),
        v19 = (System_Predicate_object__o *)sub_1B64C4C(System_Predicate_ServantProfileEntity__TypeInfo),
        System_Predicate_object____ctor(
          v19,
          (Il2CppObject *)v14,
...
LABEL_12:
  ...
  if ( System_Collections_Generic_List_object___Find(
         ...
         (const MethodInfo_34B0630 *)Method_System_Collections_Generic_List_ServantProfileEntity__Find__) )
  {
    v21 = *(_DWORD *)(v14 + 16);
    if ( !ServantProfileLimitCountManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(ServantProfileLimitCountManager_TypeInfo);
...
void __fastcall ServantProfileLimitCountManager__UpdateProfileServantLimitCount(const MethodInfo *method)
{
  ...
  if ( (byte_49FFCFD & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, v1);
    sub_1B64A00(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v2);
    sub_1B64A00(&Method_DataManager_GetMasterData_ServantProfileMaster___, v3);
    ...
    sub_1B64A00(&System_Predicate_ServantProfileEntity__TypeInfo, v10);
    sub_1B64A00(&ServantProfileLimitCountManager_TypeInfo, v11);
    ...
    sub_1B64A00(
      ...
      v13);
    sub_1B64A00(&ServantProfileLimitCountManager___c__DisplayClass13_0_TypeInfo, v14);
  ...
  Entitys_object = (System_Collections_Generic_IEnumerable_T__o *)DataMasterBase__getEntitys_object_(
                                                                    (DataMasterBase_o *)Instance,
                                                                    (const MethodInfo_2E3C574 *)Method_DataMasterBase_getEntitys_ServantProfileEntity___);
  v19 = (System_Collections_Generic_List_object__o *)sub_1B64C4C(System_Collections_Generic_List_ServantProfileEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor_55244988(
    v19,
    Entitys_object,
    (const MethodInfo_34AF8BC *)Method_System_Collections_Generic_List_ServantProfileEntity___ctor___75676040);
         ...
         (const MethodInfo_30733FC *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__) >= 1 )
  {
    ...
    while ( 1 )
    {
      v22 = (Il2CppObject *)sub_1B64C4C(ServantProfileLimitCountManager___c__DisplayClass13_0_TypeInfo);
      ...
      sub_1B649A4((ServantStatusBattleListViewItem_o *)v29, v28, v23, v24);
      v30 = (System_Predicate_object__o *)sub_1B64C4C(System_Predicate_ServantProfileEntity__TypeInfo);
      System_Predicate_object____ctor(
        v30,
        v22,
        Method_ServantProfileLimitCountManager___c__DisplayClass13_0__UpdateProfileServantLimitCount_b__0__,
      ...
      if ( Instance )
      {
        ...
        *(_QWORD *)&v38.fields.fakeValue = v32;
        Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46182092(v38, 0LL);
        if ( !*v29 )
          break;
        v34 = (int)Instance;
        v36 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46182092((*v29)[6], 0LL);
        if ( !ServantProfileLimitCountManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(ServantProfileLimitCountManager_TypeInfo);
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               v23,
               i,
               (const MethodInfo_34AFCF8 *)Method_System_Collections_Generic_List_ServantProfileLimitCountManager_ServantLimitCountInfo__get_Item__);
      v26 = Item;
      if ( !Item )
        sub_1B64C5C(0LL, v25);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v14->klass->vtable._17_Write.method)(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFD00 & 1) == 0 )
  {
    this = (ServantProfileLimitCountManager___c__DisplayClass13_0_o *)sub_1B64A00(
  ...
  *(_QWORD *)&v10.fields.fakeValue = v7;
  return svtId == CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46182092(v10, 0LL);
}
