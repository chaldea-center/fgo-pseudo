        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F056 & 1) == 0 )
  {
    sub_1BDB878(&EventMissionItemListViewItem_TypeInfo, method);
    byte_4B3F056 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F057 & 1) == 0 )
  {
    sub_1BDB878(&EventMissionItemListViewManager_TypeInfo, method);
    byte_4B3F057 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F054 & 1) == 0 )
  {
    sub_1BDB878(&EventMissionItemListViewItemDraw_TypeInfo, method);
    byte_4B3F054 = 1;
  }
