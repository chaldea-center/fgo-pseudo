        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5277F & 1) == 0 )
  {
    sub_1B863B8(&EventMissionItemListViewItem_TypeInfo, method);
    byte_4A5277F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52780 & 1) == 0 )
  {
    sub_1B863B8(&EventMissionItemListViewManager_TypeInfo, method);
    byte_4A52780 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5277D & 1) == 0 )
  {
    sub_1B863B8(&EventMissionItemListViewItemDraw_TypeInfo, method);
    byte_4A5277D = 1;
  }
