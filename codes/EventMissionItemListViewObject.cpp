        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6AC6F & 1) == 0 )
  {
    sub_1BE4ACC(&EventMissionItemListViewItem_TypeInfo, method);
    byte_4B6AC6F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6AC70 & 1) == 0 )
  {
    sub_1BE4ACC(&EventMissionItemListViewManager_TypeInfo, method);
    byte_4B6AC70 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6AC6D & 1) == 0 )
  {
    sub_1BE4ACC(&EventMissionItemListViewItemDraw_TypeInfo, method);
    byte_4B6AC6D = 1;
  }
