        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC5B7 & 1) == 0 )
  {
    sub_1BC3008(&EventMissionItemListViewItem_TypeInfo, method);
    byte_4AFC5B7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC5B8 & 1) == 0 )
  {
    sub_1BC3008(&EventMissionItemListViewManager_TypeInfo, method);
    byte_4AFC5B8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC5B5 & 1) == 0 )
  {
    sub_1BC3008(&EventMissionItemListViewItemDraw_TypeInfo, method);
    byte_4AFC5B5 = 1;
  }
