        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187849 & 1) == 0 )
  {
    sub_B2C35C(&EventMissionItemListViewItem_TypeInfo, method);
    byte_4187849 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418784A & 1) == 0 )
  {
    sub_B2C35C(&EventMissionItemListViewManager_TypeInfo, method);
    byte_418784A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187847 & 1) == 0 )
  {
    sub_B2C35C(&EventMissionItemListViewItemDraw_TypeInfo, method);
    byte_4187847 = 1;
  }
