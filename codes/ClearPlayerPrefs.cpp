void __fastcall ClearPlayerPrefs___ctor(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B641D5 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_4602/*"Clear All Player Prefs"*/, method);
    sub_1BE4ACC(&StringLiteral_25631/*"はい"*/, v9);
    sub_1BE4ACC(&StringLiteral_10839/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/, v10);
    sub_1BE4ACC(&StringLiteral_25625/*"いいえ"*/, v11);
    sub_1BE4ACC(&StringLiteral_10838/*"PlayerPrefsの削除"*/, v12);
    sub_1BE4ACC(&StringLiteral_25662/*"データ更新のため再起動します。"*/, v13);
    sub_1BE4ACC(&StringLiteral_25661/*"データ更新のためゲームを終了します。"*/, v14);
    byte_4B641D5 = 1;
  }
  v15 = StringLiteral_10838/*"PlayerPrefsの削除"*/;
  this->fields.windowTitle = (struct System_String_o *)StringLiteral_10838/*"PlayerPrefsの削除"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.windowTitle, v15, v2, v3, v4, v5, v6, v7);
  v16 = StringLiteral_4602/*"Clear All Player Prefs"*/;
  this->fields.allClearTitle = (struct System_String_o *)StringLiteral_4602/*"Clear All Player Prefs"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.allClearTitle, v16, v17, v18, v19, v20, v21, v22);
  v23 = StringLiteral_10839/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  this->fields.message = (struct System_String_o *)StringLiteral_10839/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.message, v23, v24, v25, v26, v27, v28, v29);
  v30 = StringLiteral_25661/*"データ更新のためゲームを終了します。"*/;
  this->fields.quitMessage = (struct System_String_o *)StringLiteral_25661/*"データ更新のためゲームを終了します。"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.quitMessage, v30, v31, v32, v33, v34, v35, v36);
  v37 = StringLiteral_25662/*"データ更新のため再起動します。"*/;
  this->fields.rebootMessage = (struct System_String_o *)StringLiteral_25662/*"データ更新のため再起動します。"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.rebootMessage, v37, v38, v39, v40, v41, v42, v43);
  v44 = StringLiteral_25625/*"いいえ"*/;
  this->fields.cancelBtnMsg = (struct System_String_o *)StringLiteral_25625/*"いいえ"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.cancelBtnMsg, v44, v45, v46, v47, v48, v49, v50);
  v51 = StringLiteral_25631/*"はい"*/;
  this->fields.decideBtnMsg = (struct System_String_o *)StringLiteral_25631/*"はい"*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.decideBtnMsg, v51, v52, v53, v54, v55, v56, v57);
...
void __fastcall ClearPlayerPrefs__Dialog(ClearPlayerPrefs_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_4B641D4 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ClearPlayerPrefs__Dialog_b__9_0__, result);
  ...
  if ( !Instance )
    goto LABEL_11;
  CommonUI__CloseConfirmDialog_30874304((CommonUI_o *)Instance, 0LL, 0LL);
  if ( !result )
    return;
  ...
  v15 = (CommonUI_o *)v9;
  v16 = (CommonConfirmDialog_ClickDelegate_o *)sub_1BE4D18(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
void __fastcall ClearPlayerPrefs__StartMenu(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B641D3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ClearPlayerPrefs_Dialog__, method);
...
void __fastcall ClearPlayerPrefs___Dialog_b__9_0(ClearPlayerPrefs_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4B641D6 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_ClearPlayerPrefs_Dialog__, v5);
    sub_1BE4ACC(&CommonConfirmDialog_ClickDelegate_TypeInfo, v6);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_ManagementManager__get_Instance__, v8);
    byte_4B641D6 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
