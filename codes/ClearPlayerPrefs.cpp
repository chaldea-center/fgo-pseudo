void ClearPlayerPrefs___ctor(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C541D8 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_4493/*"Clear All Player Prefs"*/);
    sub_1C3E564(&StringLiteral_25412/*"はい"*/);
    sub_1C3E564(&StringLiteral_10684/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/);
    sub_1C3E564(&StringLiteral_25405/*"いいえ"*/);
    sub_1C3E564(&StringLiteral_10683/*"PlayerPrefsの削除"*/);
    sub_1C3E564(&StringLiteral_25447/*"データ更新のため再起動します。"*/);
    sub_1C3E564(&StringLiteral_25446/*"データ更新のためゲームを終了します。"*/);
    byte_4C541D8 = 1;
  }
  v5 = StringLiteral_10683/*"PlayerPrefsの削除"*/;
  this->fields.windowTitle = (struct System_String_o *)StringLiteral_10683/*"PlayerPrefsの削除"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.windowTitle, v5, v2, v3);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.allClearTitle, v6, v7, v8);
  v9 = StringLiteral_10684/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  this->fields.message = (struct System_String_o *)StringLiteral_10684/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.message, v9, v10, v11);
  v12 = StringLiteral_25446/*"データ更新のためゲームを終了します。"*/;
  this->fields.quitMessage = (struct System_String_o *)StringLiteral_25446/*"データ更新のためゲームを終了します。"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.quitMessage, v12, v13, v14);
  v15 = StringLiteral_25447/*"データ更新のため再起動します。"*/;
  this->fields.rebootMessage = (struct System_String_o *)StringLiteral_25447/*"データ更新のため再起動します。"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.rebootMessage, v15, v16, v17);
  v18 = StringLiteral_25405/*"いいえ"*/;
  this->fields.cancelBtnMsg = (struct System_String_o *)StringLiteral_25405/*"いいえ"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.cancelBtnMsg, v18, v19, v20);
  v21 = StringLiteral_25412/*"はい"*/;
  this->fields.decideBtnMsg = (struct System_String_o *)StringLiteral_25412/*"はい"*/;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.decideBtnMsg, v21, v22, v23);
...
void ClearPlayerPrefs__Dialog(ClearPlayerPrefs_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_4C541D7 & 1) == 0 )
  {
    sub_1C3E564(&Method_ClearPlayerPrefs__Dialog_b__9_0__);
  ...
  if ( !Instance )
    goto LABEL_11;
  CommonUI__CloseConfirmDialog_31238516((CommonUI_o *)Instance, 0, 0);
  if ( !result )
    return;
...
void ClearPlayerPrefs__StartMenu(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C541D6 & 1) == 0 )
  {
    sub_1C3E564(&Method_ClearPlayerPrefs_Dialog__);
    sub_1C3E564(&CommonConfirmDialog_ClickDelegate_TypeInfo);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C541D6 = 1;
  }
...
void ClearPlayerPrefs___Dialog_b__9_0(ClearPlayerPrefs_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( !isDecide )
  {
    ...
    decideBtnMsg = this->fields.decideBtnMsg;
    v12 = (CommonUI_o *)v7;
    v13 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C3E7B0(CommonConfirmDialog_ClickDelegate_TypeInfo);
