void __fastcall ClearPlayerPrefs___ctor(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DFF5D & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_4479/*"Clear All Player Prefs"*/, method);
    sub_1B00CCC(&StringLiteral_24912/*"はい"*/, v5);
    sub_1B00CCC(&StringLiteral_10543/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/, v6);
    sub_1B00CCC(&StringLiteral_24906/*"いいえ"*/, v7);
    sub_1B00CCC(&StringLiteral_10542/*"PlayerPrefsの削除"*/, v8);
    sub_1B00CCC(&StringLiteral_24943/*"データ更新のため再起動します。"*/, v9);
    sub_1B00CCC(&StringLiteral_24942/*"データ更新のためゲームを終了します。"*/, v10);
    byte_48DFF5D = 1;
  }
  v11 = StringLiteral_10542/*"PlayerPrefsの削除"*/;
  this->fields.windowTitle = (struct System_String_o *)StringLiteral_10542/*"PlayerPrefsの削除"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.windowTitle, v11, v2, v3);
  v12 = StringLiteral_4479/*"Clear All Player Prefs"*/;
  this->fields.allClearTitle = (struct System_String_o *)StringLiteral_4479/*"Clear All Player Prefs"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.allClearTitle, v12, v13, v14);
  v15 = StringLiteral_10543/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  this->fields.message = (struct System_String_o *)StringLiteral_10543/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.message, v15, v16, v17);
  v18 = StringLiteral_24942/*"データ更新のためゲームを終了します。"*/;
  this->fields.quitMessage = (struct System_String_o *)StringLiteral_24942/*"データ更新のためゲームを終了します。"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.quitMessage, v18, v19, v20);
  v21 = StringLiteral_24943/*"データ更新のため再起動します。"*/;
  this->fields.rebootMessage = (struct System_String_o *)StringLiteral_24943/*"データ更新のため再起動します。"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.rebootMessage, v21, v22, v23);
  v24 = StringLiteral_24906/*"いいえ"*/;
  this->fields.cancelBtnMsg = (struct System_String_o *)StringLiteral_24906/*"いいえ"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.cancelBtnMsg, v24, v25, v26);
  v27 = StringLiteral_24912/*"はい"*/;
  this->fields.decideBtnMsg = (struct System_String_o *)StringLiteral_24912/*"はい"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.decideBtnMsg, v27, v28, v29);
...
void __fastcall ClearPlayerPrefs__Dialog(ClearPlayerPrefs_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_48DFF5C & 1) == 0 )
  {
    sub_1B00CCC(&Method_ClearPlayerPrefs__Dialog_b__9_0__, result);
  ...
  if ( !Instance )
    goto LABEL_11;
  CommonUI__CloseConfirmDialog_29937364((CommonUI_o *)Instance, 0LL, 0LL);
  if ( !result )
    return;
  ...
  v15 = (CommonUI_o *)v9;
  v16 = (CommonConfirmDialog_ClickDelegate_o *)sub_1B00F18(CommonConfirmDialog_ClickDelegate_TypeInfo);
...
void __fastcall ClearPlayerPrefs__StartMenu(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DFF5B & 1) == 0 )
  {
    sub_1B00CCC(&Method_ClearPlayerPrefs_Dialog__, method);
...
void __fastcall ClearPlayerPrefs___Dialog_b__9_0(ClearPlayerPrefs_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_48DFF5E & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_ClearPlayerPrefs_Dialog__, v5);
    sub_1B00CCC(&CommonConfirmDialog_ClickDelegate_TypeInfo, v6);
