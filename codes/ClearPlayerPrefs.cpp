void __fastcall ClearPlayerPrefs___ctor(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD9B3E & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_4617/*"Clear All Player Prefs"*/);
    sub_1C21E38(&StringLiteral_25733/*"はい"*/);
    sub_1C21E38(&StringLiteral_10883/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/);
    sub_1C21E38(&StringLiteral_25727/*"いいえ"*/);
    sub_1C21E38(&StringLiteral_10882/*"PlayerPrefsの削除"*/);
    sub_1C21E38(&StringLiteral_25764/*"データ更新のため再起動します。"*/);
    sub_1C21E38(&StringLiteral_25763/*"データ更新のためゲームを終了します。"*/);
    byte_4BD9B3E = 1;
  }
  v9 = StringLiteral_10882/*"PlayerPrefsの削除"*/;
  this->fields.windowTitle = (struct System_String_o *)StringLiteral_10882/*"PlayerPrefsの削除"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.windowTitle, v9, v2, v3, v4, v5, v6, v7);
  v10 = StringLiteral_4617/*"Clear All Player Prefs"*/;
  this->fields.allClearTitle = (struct System_String_o *)StringLiteral_4617/*"Clear All Player Prefs"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.allClearTitle, v10, v11, v12, v13, v14, v15, v16);
  v17 = StringLiteral_10883/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  this->fields.message = (struct System_String_o *)StringLiteral_10883/*"PlayerPrefsを全て削除します\n※元に戻せません\n※再起動後反映されます"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.message, v17, v18, v19, v20, v21, v22, v23);
  v24 = StringLiteral_25763/*"データ更新のためゲームを終了します。"*/;
  this->fields.quitMessage = (struct System_String_o *)StringLiteral_25763/*"データ更新のためゲームを終了します。"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.quitMessage, v24, v25, v26, v27, v28, v29, v30);
  v31 = StringLiteral_25764/*"データ更新のため再起動します。"*/;
  this->fields.rebootMessage = (struct System_String_o *)StringLiteral_25764/*"データ更新のため再起動します。"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.rebootMessage, v31, v32, v33, v34, v35, v36, v37);
  v38 = StringLiteral_25727/*"いいえ"*/;
  this->fields.cancelBtnMsg = (struct System_String_o *)StringLiteral_25727/*"いいえ"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.cancelBtnMsg, v38, v39, v40, v41, v42, v43, v44);
  v45 = StringLiteral_25733/*"はい"*/;
  this->fields.decideBtnMsg = (struct System_String_o *)StringLiteral_25733/*"はい"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.decideBtnMsg, v45, v46, v47, v48, v49, v50, v51);
...
void __fastcall ClearPlayerPrefs__Dialog(ClearPlayerPrefs_o *this, bool result, const MethodInfo *method)
{
  ...
  if ( (byte_4BD9B3D & 1) == 0 )
  {
    sub_1C21E38(&Method_ClearPlayerPrefs__Dialog_b__9_0__);
  ...
  if ( !Instance )
    goto LABEL_11;
  CommonUI__CloseConfirmDialog_31128756((CommonUI_o *)Instance, 0LL, 0LL);
  if ( !result )
    return;
...
void __fastcall ClearPlayerPrefs__StartMenu(ClearPlayerPrefs_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD9B3C & 1) == 0 )
  {
    sub_1C21E38(&Method_ClearPlayerPrefs_Dialog__);
    sub_1C21E38(&CommonConfirmDialog_ClickDelegate_TypeInfo);
    sub_1C21E38(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4BD9B3C = 1;
  }
...
void __fastcall ClearPlayerPrefs___Dialog_b__9_0(ClearPlayerPrefs_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( !isDecide )
  {
    ...
    decideBtnMsg = this->fields.decideBtnMsg;
    v12 = (CommonUI_o *)v7;
    v13 = (CommonConfirmDialog_ClickDelegate_o *)sub_1C22084(CommonConfirmDialog_ClickDelegate_TypeInfo);
