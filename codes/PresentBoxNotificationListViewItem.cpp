        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C(&this->fields.entity, e);
  this->fields.itemEntity = 0;
  p_itemEntity = &this->fields.itemEntity;
  sub_1C9403C(&this->fields.itemEntity, 0);
  this->fields.svtEntity = 0;
  Instance = (Il2CppObject *)sub_1C9403C(&this->fields.svtEntity, 0);
  if ( !e )
    goto LABEL_15;
  ...
  if ( giftType == 2 )
  {
    ...
    if ( Instance )
    {
      ...
      if ( Instance )
      {
        ...
        *p_itemEntity = Entity;
LABEL_13:
        sub_1C9403C(p_itemEntity, Entity);
        return;
      }
    }
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  if ( (byte_4D26556 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_10766/*"Present "*/);
    byte_4D26556 = 1;
  }
  return System_String__Concat_64417744((System_String_o *)StringLiteral_10766/*"Present "*/, this->fields.presentName, 0);
}
