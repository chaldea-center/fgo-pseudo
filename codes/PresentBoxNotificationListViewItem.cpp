        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C(&this->fields.itemEntity);
  this->fields.svtEntity = 0LL;
  Instance = (Il2CppObject *)sub_1BDB81C(&this->fields.svtEntity);
  if ( !e )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  if ( (byte_4B3EEFF & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_10723/*"Present "*/, method);
    byte_4B3EEFF = 1;
  }
  return System_String__Concat_62572260((System_String_o *)StringLiteral_10723/*"Present "*/, this->fields.presentName, 0LL);
}
