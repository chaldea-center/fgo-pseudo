        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01FD7 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_ItemMaster___, *(_QWORD *)&index);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.entity, (int32_t)e, v11, v12);
  this->fields.itemEntity = 0LL;
  p_itemEntity = (ServantStatusBattleListViewItem_o *)&this->fields.itemEntity;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.itemEntity, 0, v14, v15);
  this->fields.svtEntity = 0LL;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.svtEntity, 0, v16, v17);
  if ( !e )
    goto LABEL_15;
...
LABEL_13:
        sub_1B64814(p_itemEntity, v24, v22, v23);
        return;
      }
    }
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A01FD8 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_10676/*"Present "*/, method);
    byte_4A01FD8 = 1;
  }
  return System_String__Concat_61383576((System_String_o *)StringLiteral_10676/*"Present "*/, this->fields.presentName, 0LL);
}
