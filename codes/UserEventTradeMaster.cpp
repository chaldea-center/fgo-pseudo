void UserEventTradeMaster___ctor(UserEventTradeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E78540 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_UserEventTradeMaster__UserEventTradeEntity__string___ctor__);
    byte_4E78540 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    503,
    (const MethodInfo_3538564 *)Method_DataMasterBase_UserEventTradeMaster__UserEventTradeEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78542 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Linq_Enumerable_Select_UserEventTradeEntity__UserEventTradeEntity___);
    sub_1D0F0B4(&Method_System_Linq_Enumerable_ToList_UserEventTradeEntity___);
    sub_1D0F0B4(&System_Func_UserEventTradeEntity__UserEventTradeEntity__TypeInfo);
    sub_1D0F0B4(&Method_UserEventTradeMaster___c__GetEntityList_b__3_0__);
    sub_1D0F0B4(&UserEventTradeMaster___c_TypeInfo);
    byte_4E78542 = 1;
  }
  ...
  if ( !_9__3_0 )
  {
    ...
    _9__3_0 = (System_Func_object__object__o *)sub_1D0F300(System_Func_UserEventTradeEntity__UserEventTradeEntity__TypeInfo);
  ...
  v14 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                               ...
                                                               (const MethodInfo_32866A4 *)Method_System_Linq_Enumerable_Select_UserEventTradeEntity__UserEventTradeEntity___);
  return (System_Collections_Generic_List_UserEventTradeEntity__o *)System_Linq_Enumerable__ToList_object_(
                                                                      v14,
                                                                      (const MethodInfo_329539C *)Method_System_Linq_Enumerable_ToList_UserEventTradeEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78541 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_DataMasterBase_UserEventTradeMaster__UserEventTradeEntity__string__TryGetEntity__);
    byte_4E78541 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_353AB28 *)Method_DataMasterBase_UserEventTradeMaster__UserEventTradeEntity__string__TryGetEntity__);
}
...
void UserEventTradeMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(UserEventTradeMaster___c_TypeInfo);
  System_Object___ctor(v1, 0);
  UserEventTradeMaster___c_TypeInfo->static_fields->__9 = (struct UserEventTradeMaster___c_o *)v1;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)UserEventTradeMaster___c_TypeInfo->static_fields,
    (int32_t)v1,
    v2,
    v3,
    v4,
