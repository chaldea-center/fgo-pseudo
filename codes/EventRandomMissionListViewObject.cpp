        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC9A & 1) == 0 )
  {
    sub_1C1ABD4(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_4BCBC9A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC9B & 1) == 0 )
  {
    sub_1C1ABD4(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_4BCBC9B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1C1ABD4(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_4BCBC99 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1C1AE30(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCBC98 & 1) == 0 )
  {
    sub_1C1ABD4(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_4BCBC98 = 1;
  }
