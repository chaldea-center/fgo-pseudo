        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73E29 & 1) == 0 )
  {
    sub_1B90010(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_4A73E29 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73E2A & 1) == 0 )
  {
    sub_1B90010(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_4A73E2A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1B90010(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_4A73E28 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1B9026C(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73E27 & 1) == 0 )
  {
    sub_1B90010(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_4A73E27 = 1;
  }
