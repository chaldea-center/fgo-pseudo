        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23A3C & 1) == 0 )
  {
    sub_1B715CC(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_4A23A3C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23A3D & 1) == 0 )
  {
    sub_1B715CC(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_4A23A3D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1B715CC(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_4A23A3B = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1B71828(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23A3A & 1) == 0 )
  {
    sub_1B715CC(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_4A23A3A = 1;
  }
