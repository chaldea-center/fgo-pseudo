        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26229 & 1) == 0 )
  {
    sub_1C3B764(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_4C26229 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2622A & 1) == 0 )
  {
    sub_1C3B764(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_4C2622A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1C3B764(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_4C26228 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1C3B9C0(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26227 & 1) == 0 )
  {
    sub_1C3B764(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_4C26227 = 1;
  }
