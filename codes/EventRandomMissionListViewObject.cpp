        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF171 & 1) == 0 )
  {
    sub_1B4CF90(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_49BF171 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF172 & 1) == 0 )
  {
    sub_1B4CF90(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_49BF172 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B4CF90(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1B4CF90(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_49BF170 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1B4D1EC(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF16F & 1) == 0 )
  {
    sub_1B4CF90(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_49BF16F = 1;
  }
