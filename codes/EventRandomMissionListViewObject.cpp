        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E661D & 1) == 0 )
  {
    sub_1B00CCC(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_48E661D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E661E & 1) == 0 )
  {
    sub_1B00CCC(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_48E661E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1B00CCC(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_48E661C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1B00F28(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E661B & 1) == 0 )
  {
    sub_1B00CCC(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_48E661B = 1;
  }
