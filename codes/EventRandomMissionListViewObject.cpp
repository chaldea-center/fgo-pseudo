        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B300 & 1) == 0 )
  {
    sub_1BD3458(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_4B3B300 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B301 & 1) == 0 )
  {
    sub_1BD3458(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_4B3B301 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1BD3458(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_4B3B2FF = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1BD36B4(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3B2FE & 1) == 0 )
  {
    sub_1BD3458(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_4B3B2FE = 1;
  }
