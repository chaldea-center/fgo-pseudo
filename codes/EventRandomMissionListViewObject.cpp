        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC6FA & 1) == 0 )
  {
    sub_1BC3008(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_4AFC6FA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC6FB & 1) == 0 )
  {
    sub_1BC3008(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_4AFC6FB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1BC3008(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_4AFC6F9 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1BC3264(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC6F8 & 1) == 0 )
  {
    sub_1BC3008(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_4AFC6F8 = 1;
  }
