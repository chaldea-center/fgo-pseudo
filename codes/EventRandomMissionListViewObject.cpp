        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CBA0 & 1) == 0 )
  {
    sub_1B686D4(&EventRandomMissionListViewItem_TypeInfo, method);
    byte_4A0CBA0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CBA1 & 1) == 0 )
  {
    sub_1B686D4(&EventRandomMissionListViewManager_TypeInfo, method);
    byte_4A0CBA1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&EventRandomMissionListViewItem_TypeInfo, method);
    sub_1B686D4(&EventRandomMissionListViewManager_TypeInfo, v3);
    byte_4A0CB9F = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
    ...
    if ( LOBYTE(linkItem->klass->vtable._0_Equals.methodPtr) >= (unsigned int)methodPtr_low )
    {
      ...
      if ( v6 == EventRandomMissionListViewItem_TypeInfo )
      {
        ...
        if ( !v10 || !EventRandomMissionItemDraw )
          sub_1B68930(EventRandomMissionItemDraw, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CB9E & 1) == 0 )
  {
    sub_1B686D4(&EventRandomMissionListViewItemDraw_TypeInfo, method);
    byte_4A0CB9E = 1;
  }
