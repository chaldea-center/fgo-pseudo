void __fastcall ClassBoardSquareDetailDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0A3 & 1) == 0 )
  {
    sub_1B686D4(&ClassBoardSquareDetailDialog_TypeInfo, v1);
    byte_4A0C0A3 = 1;
  }
...
void __fastcall ClassBoardSquareDetailDialog__Close(ClassBoardSquareDetailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0C0A0 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_ClassBoardSquareDetailDialog_EndClose__, v3);
    byte_4A0C0A0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C09F & 1) == 0 )
  {
    sub_1B686D4(&Method_ClassBoardSquareDetailDialog_OnClickClose__, method);
    byte_4A0C09F = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardSquareDetailDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B686EC(Method_ClassBoardSquareDetailDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C09E & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_ClassBoardSquareDetailDialog_EndOpen__, v7);
    sub_1B686D4(&ClassBoardSquareDetailDialog_TypeInfo, v8);
    sub_1B686D4(&LocalizationManager_TypeInfo, v9);
    sub_1B686D4(&StringLiteral_3492/*"CLASS_BOARD_SQUARE_DETAIL_DIALOG_TITLE"*/, v10);
    byte_4A0C09E = 1;
  }
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.closeFunc, (int32_t)closeFunc, v11, v12);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_3492/*"CLASS_BOARD_SQUARE_DETAIL_DIALOG_TITLE"*/, 0LL);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A0C0A2 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_15576/*"Window/CloseBtn"*/, method);
    byte_4A0C0A2 = 1;
  }
