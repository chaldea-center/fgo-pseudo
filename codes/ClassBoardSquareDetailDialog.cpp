void __fastcall ClassBoardSquareDetailDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1BA & 1) == 0 )
  {
    sub_1BE4ACC(&ClassBoardSquareDetailDialog_TypeInfo, v1);
    byte_4B6A1BA = 1;
  }
...
void __fastcall ClassBoardSquareDetailDialog__Close(ClassBoardSquareDetailDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1B7 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_ClassBoardSquareDetailDialog_EndClose__, v3);
    byte_4B6A1B7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1B6 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_ClassBoardSquareDetailDialog_OnClickClose__, method);
    byte_4B6A1B6 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_ClassBoardSquareDetailDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_ClassBoardSquareDetailDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A1B5 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_ClassBoardSquareDetailDialog_EndOpen__, v11);
    sub_1BE4ACC(&ClassBoardSquareDetailDialog_TypeInfo, v12);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v13);
    sub_1BE4ACC(&StringLiteral_3551/*"CLASS_BOARD_SQUARE_DETAIL_DIALOG_TITLE"*/, v14);
    byte_4B6A1B5 = 1;
  }
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.closeFunc, (int64_t)closeFunc, v15, v16, v17, v18, v19, v20);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3551/*"CLASS_BOARD_SQUARE_DETAIL_DIALOG_TITLE"*/, 0LL);
