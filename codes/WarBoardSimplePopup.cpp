void __fastcall WarBoardSimplePopup___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDA3C6 & 1) == 0 )
  {
    sub_1C21E38(&WarBoardSimplePopup_TypeInfo);
    byte_4BDA3C6 = 1;
  }
  static_fields = WarBoardSimplePopup_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->LEFT_MARGIN_WHEN_LOCATING_ON_LEFT_SIDE = xmmword_BFE810;
  *(_OWORD *)&static_fields->FS_LEFT_MARGIN_WHEN_LOCATING_ON_LEFT_SIDE = xmmword_BFD950;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !mainView )
    sub_1C22094(0LL, elemPrefab);
  transform = UnityEngine_GameObject__get_transform(mainView, 0LL);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  return (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__50551272(
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    if ( FSUtility__IsUnderVista(0LL) )
    {
      ...
      if ( v24 )
      {
        ...
        mainView = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
        if ( mainView )
        {
...
LABEL_64:
              ...
              if ( v29 < (float)(v31 >> 1) )
              {
                ...
                v53 = *(_DWORD *)(*(_QWORD *)&mainView[7].fields.m_CachedPtr + 12LL);
LABEL_126:
                v30[7] = -v53;
                if ( v33 && v32 )
                {
...
LABEL_130:
    ...
    if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v12, 0LL, 0LL) )
    {
      ...
      if ( ((unsigned __int8)mainView & 1) != 0 )
      {
        ...
        v17 = *(_DWORD *)(*(_QWORD *)&mainView[7].fields.m_CachedPtr + 84LL);
      }
      if ( !v12 )
        goto LABEL_130;
      UIWidget__set_width((UIWidget_o *)v12, v17, 0LL);
      ...
      if ( v46 < (float)(v47 >> 1) )
      {
        ...
        v53 = *(_DWORD *)(*(_QWORD *)&mainView[7].fields.m_CachedPtr + 28LL);
        goto LABEL_126;
      }
      v30[6] = 0;
    ...
    if ( mainView )
    {
      ...
      if ( mainView )
      {
        ...
        if ( (int)mainView < 1 )
        {
          ...
          {
LABEL_21:
            UIWidget__set_height((UIWidget_o *)Component_object, v6, 0LL);
            return;
          }
        }
        else
        {
          ...
          for ( i = 0; i != v5; ++i )
          {
            ...
            if ( ((unsigned __int8)mainView & 1) != 0 )
            {
              ...
              UIRect__SetAnchor_48099980((UIRect_o *)v8, this->fields.mainView, 0LL);
              ...
              v6 += monitor_high;
              UIRect__ResetAnchors((UIRect_o *)v8, 0LL);
              UIRect__UpdateAnchors((UIRect_o *)v8, 0LL);
            }
          }
          if ( Component_object )
            goto LABEL_21;
