void __fastcall WarBoardSimplePopup___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB3C58 & 1) == 0 )
  {
    sub_1BAB41C(&WarBoardSimplePopup_TypeInfo, v1);
    byte_4AB3C58 = 1;
  }
  static_fields = WarBoardSimplePopup_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->LEFT_MARGIN_WHEN_LOCATING_ON_LEFT_SIDE = xmmword_BC37E0;
  *(_OWORD *)&static_fields->FS_LEFT_MARGIN_WHEN_LOCATING_ON_LEFT_SIDE = xmmword_BC28F0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3C53 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_Object_Instantiate_GameObject____76537840, elemPrefab);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v5);
    byte_4AB3C53 = 1;
  }
  mainView = this->fields.mainView;
  if ( !mainView )
    sub_1BAB678(0LL, elemPrefab);
  transform = UnityEngine_GameObject__get_transform(mainView, 0LL);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  return (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__49579268(
...
void __fastcall WarBoardSimplePopup__AdjustMainViewPosition(WarBoardSimplePopup_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB3C55 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&WarBoardSimplePopup_TypeInfo, v7);
    byte_4AB3C55 = 1;
  }
  mainView = this->fields.mainView;
  if ( !mainView )
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    if ( FSUtility__IsUnderVista(0LL) )
    {
      ...
      if ( v29 )
      {
        ...
        mainView = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
        if ( mainView )
        {
        ...
        else
        {
          ...
          for ( i = 0; i != v7; ++i )
          {
            ...
            if ( ((unsigned __int8)mainView & 1) != 0 )
            {
              ...
              UIRect__SetAnchor_47171692((UIRect_o *)v10, this->fields.mainView, 0LL);
