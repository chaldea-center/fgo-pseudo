        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25D75 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_12455/*"SetAutoLabel"*/, v6);
    sub_1C3B764(&StringLiteral_3879/*"CURRENT_FRIEND_POINT_UNIT"*/, v7);
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_3879/*"CURRENT_FRIEND_POINT_UNIT"*/, 0LL);
  if ( !title
    || (UILabel__set_text(title, v10, 0LL),
        subTitle = this->fields.subTitle,
        v13 = LocalizationManager__Get((System_String_o *)StringLiteral_12455/*"SetAutoLabel"*/, 0LL),
        v10 = System_String__Concat_63379872(v13, (System_String_o *)StringLiteral_44/*"\n\n"*/, text, 0LL),
        !subTitle) )
  {
    sub_1C3B9C0(v10, v11);
  }
