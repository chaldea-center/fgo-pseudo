...
void __fastcall DiggingRewardComponent__SetRewardImage(DiggingRewardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCBDC7 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_DataManager_GetMasterData_EventDiggingRewardMaster___, v3);
    ...
    sub_1C1ABD4(&Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__, v7);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_EventDiggingRewardMaster___);
  rewardInfo = this->fields.rewardInfo;
  ...
  v16 = DataMasterBase_object__object__int___GetEntity(
          ...
          (const MethodInfo_3248678 *)Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  if ( !v16 )
    return;
  v17 = v16;
...
LABEL_26:
    ...
    *(_QWORD *)&v39.fields.fakeValue = monitor;
    Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47556128(v39, 0LL);
    if ( (int)Instance < 1 )
    {
      v30 = 0;
    }
    else
    {
      ...
      *(_QWORD *)&v40.fields.fakeValue = v27;
      v29 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47556128(v40, 0LL);
    ...
    if ( entity )
    {
      ...
      *(_QWORD *)&v41.fields.fakeValue = v34;
      v36 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47556128(v41, 0LL);
...
LABEL_10:
    sub_1C1AE30(rewardImageSprite, IsRareReward);
  }
