        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC(&this->fields.rewardInfo);
...
void __fastcall DiggingRewardComponent__SetRewardImage(DiggingRewardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFC92C & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_DataManager_GetMasterData_EventDiggingRewardMaster___, v3);
    ...
    sub_1BC3008(&Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__, v7);
  ...
  v16 = DataMasterBase_object__object__int___GetEntity(
          ...
          (const MethodInfo_32AF070 *)Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  if ( !v16 )
    return;
  v17 = v16;
    ...
    *(_QWORD *)&v39.fields.fakeValue = monitor;
    ...
    else
    {
      ...
      *(_QWORD *)&v40.fields.fakeValue = v27;
      v29 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v40, 0LL);
    ...
    if ( entity )
    {
      ...
      *(_QWORD *)&v41.fields.fakeValue = v34;
      v36 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48024060(v41, 0LL);
...
LABEL_10:
    sub_1BC3264(rewardImageSprite, IsRareReward);
  }
