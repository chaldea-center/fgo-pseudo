        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.rewardInfo, (int32_t)rewardInfo, (int32_t)method, v3);
...
void __fastcall DiggingRewardComponent__SetRewardImage(DiggingRewardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A320DB & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMasterData_EventDiggingRewardMaster___, v3);
    ...
    sub_1B761C0(&Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__, v7);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_2E62408 *)Method_DataManager_GetMasterData_EventDiggingRewardMaster___);
  rewardInfo = this->fields.rewardInfo;
  ...
  v16 = DataMasterBase_object__object__int___GetEntity(
          ...
          (const MethodInfo_30FF780 *)Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  if ( !v16 )
    return;
  v17 = v16;
    ...
    *(_QWORD *)&v39.fields.fakeValue = monitor;
    ...
    else
    {
      ...
      *(_QWORD *)&v40.fields.fakeValue = v27;
      v29 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v40, 0LL);
    ...
    if ( entity )
    {
      ...
      *(_QWORD *)&v41.fields.fakeValue = v34;
      v36 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v41, 0LL);
...
LABEL_10:
    sub_1B7641C(rewardImageSprite, IsRareReward);
  }
