...
void __fastcall DiggingRewardComponent__SetRewardImage(DiggingRewardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BE0889 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  ...
  v6 = DataMasterBase_object__object__int___GetEntity(
         ...
         (const MethodInfo_325BDC8 *)Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  if ( !v6 )
    return;
  v7 = v6;
    ...
    *(_QWORD *)&v29.fields.fakeValue = monitor;
    ...
    else
    {
      ...
      *(_QWORD *)&v30.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v30, 0LL);
    ...
    if ( entity )
    {
      ...
      *(_QWORD *)&v31.fields.fakeValue = v24;
      v26 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v31, 0LL);
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetFaceImage(rewardIconSprite, v26, v20, 1, 0LL, 0LL);
...
LABEL_10:
    sub_1C22094(rewardImageSprite, IsRareReward);
  }
