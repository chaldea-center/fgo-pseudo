        ...
        const MethodInfo *method)
{
  ...
  sub_1C71354(&this->fields.rewardInfo, rewardInfo);
...
void DiggingRewardComponent__SetRewardImage(DiggingRewardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC1B6D & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DataManager_GetMasterData_EventDiggingRewardMaster___);
    ...
    sub_1C713B0(&Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_EventDiggingRewardMaster___);
  rewardInfo = this->fields.rewardInfo;
  ...
  v6 = DataMasterBase_object__object__int___GetEntity(
         ...
         (const MethodInfo_3408E80 *)Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  if ( !v6 )
    return;
  v7 = v6;
    ...
    *(_QWORD *)&v29.fields.fakeValue = monitor;
    ...
    else
    {
      ...
      *(_QWORD *)&v30.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v30, 0);
    ...
    if ( entity )
    {
      ...
      *(_QWORD *)&v31.fields.fakeValue = v24;
      v26 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v31, 0);
...
LABEL_10:
    sub_1C71608(rewardImageSprite, IsRareReward);
  }
