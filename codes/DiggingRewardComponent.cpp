        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434(&this->fields.rewardInfo);
...
void DiggingRewardComponent__SetRewardImage(DiggingRewardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21AE8 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  ...
  v6 = DataMasterBase_object__object__int___GetEntity(
         ...
         (const MethodInfo_3387D98 *)Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  if ( !v6 )
    return;
  v7 = v6;
    ...
    *(_QWORD *)&v29.fields.fakeValue = monitor;
    ...
    else
    {
      ...
      *(_QWORD *)&v30.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v30, 0);
    ...
    if ( entity )
    {
      ...
      *(_QWORD *)&v31.fields.fakeValue = v24;
      v26 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v31, 0);
...
LABEL_10:
    sub_1C2D6EC(rewardImageSprite, IsRareReward);
  }
