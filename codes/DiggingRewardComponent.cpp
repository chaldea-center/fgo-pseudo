        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C(&this->fields.rewardInfo, rewardInfo);
...
void DiggingRewardComponent__SetRewardImage(DiggingRewardComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D26F86 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  ...
  v6 = DataMasterBase_object__object__int___GetEntity(
         ...
         (const MethodInfo_345B4C0 *)Method_DataMasterBase_EventDiggingRewardMaster__EventDiggingRewardEntity__int__GetEntity__);
  if ( !v6 )
    return;
  v7 = v6;
    ...
    *(_QWORD *)&v29.fields.fakeValue = monitor;
    ...
    else
    {
      ...
      *(_QWORD *)&v30.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v30, 0);
    ...
    if ( entity )
    {
      ...
      *(_QWORD *)&v31.fields.fakeValue = v24;
      v26 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v31, 0);
...
LABEL_10:
    sub_1C942F0(rewardImageSprite, IsRareReward);
  }
