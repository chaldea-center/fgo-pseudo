...
void __fastcall ScoreRecordCardDialog__OnClose(ScoreRecordCardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CC7 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_ScoreRecordCardDialog_OnClose__, v4);
    sub_1BAB41C(&Method_ScoreRecordCardDialog__OnClose_b__11_0__, v5);
    byte_4AB7CC7 = 1;
  }
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_ScoreRecordCardDialog_OnClose__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1BAB434(Method_ScoreRecordCardDialog_OnClose__);
...
void __fastcall ScoreRecordCardDialog__Open(ScoreRecordCardDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&System_Action_TypeInfo, method);
    sub_1BAB41C(&Method_ScoreRecordCardDialog__Open_b__9_0__, v3);
    byte_4AB7CC5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CC8 & 1) == 0 )
  {
    sub_1BAB41C(&System_Action_TypeInfo, *(_QWORD *)&animationType);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v7);
    sub_1BAB41C(&Method_ScoreRecordCardDialog_ActiveLargeObject__, v8);
    sub_1BAB41C(&Method_ScoreRecordCardDialog_ActiveSmallObject__, v9);
    sub_1BAB41C(&TweenAnimationComponent___TypeInfo, v10);
    sub_1BAB41C(&Method_ScoreRecordCardDialog___c__DisplayClass12_0__PlayAnimation_b__0__, v11);
    sub_1BAB41C(&ScoreRecordCardDialog___c__DisplayClass12_0_TypeInfo, v12);
    byte_4AB7CC8 = 1;
  }
  v13 = sub_1BAB668(ScoreRecordCardDialog___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v13, 0LL);
  if ( !v13 )
    goto LABEL_36;
  *(_QWORD *)(v13 + 32) = callback;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v13 + 32), (int32_t)callback, v16, v17);
  ...
  if ( delayActionCoroutine )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.delayActionCoroutine, 0, v19, v20);
  }
  if ( animationType )
  {
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.delayActionCoroutine, (int32_t)v30, v31, v32);
  UnityEngine_MonoBehaviour__StartCoroutine_69785892(
    (UnityEngine_MonoBehaviour_o *)this,
    this->fields.delayActionCoroutine,
    0LL);
  v14 = sub_1BAB4C4(TweenAnimationComponent___TypeInfo, 2LL);
  if ( !v14 )
    goto LABEL_36;
  ...
  if ( v35 )
  {
    v14 = sub_1BAB558(this->fields.scaleAnimation, *(_QWORD *)(*(_QWORD *)v14 + 64LL));
    if ( !v14 )
      goto LABEL_37;
  }
  if ( !*(_DWORD *)(v36 + 24) )
    goto LABEL_35;
  *(_QWORD *)(v36 + 32) = v35;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v36 + 32), (int32_t)v35, v33, v34);
  v39 = this->fields.moveAnimation;
  if ( v39 )
  {
    v14 = sub_1BAB558(v39, *(_QWORD *)(*(_QWORD *)v36 + 64LL));
    if ( !v14 )
    {
LABEL_37:
      v47 = sub_1BAB69C(v14);
...
LABEL_35:
    sub_1BAB680(v14, v15);
  *(_QWORD *)(v36 + 40) = v39;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v36 + 40), (int32_t)v39, v37, v38);
  *(_QWORD *)(v13 + 24) = v36;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v13 + 24), v36, v40, v41);
  *(_DWORD *)(v13 + 16) = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7CC6 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, inOnClosed);
    byte_4AB7CC6 = 1;
  }
  closeBtn = (UnityEngine_Object_o *)this->fields.closeBtn;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)p_onClosed, (int32_t)inOnClosed, v13, v14);
...
{
  ServantStatusBattleListViewItem_o *p_onClosed; // x19
  int32_t v3; // w2
  int32_t v4; // w3

  p_onClosed = (ServantStatusBattleListViewItem_o *)&this->fields.onClosed;
  ActionExtensions__Call(this->fields.onClosed, 0LL);
  p_onClosed->klass = 0LL;
  sub_1BAB3C0(p_onClosed, 0, v3, v4);
}
