...
void __fastcall ScoreRecordCardDialog__OnClose(ScoreRecordCardDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2402D & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ScoreRecordCardDialog_OnClose__, v4);
    sub_1C3B764(&Method_ScoreRecordCardDialog__OnClose_b__11_0__, v5);
    byte_4C2402D = 1;
  }
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_ScoreRecordCardDialog_OnClose__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1C3B77C(Method_ScoreRecordCardDialog_OnClose__);
...
void __fastcall ScoreRecordCardDialog__Open(ScoreRecordCardDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&System_Action_TypeInfo, method);
    sub_1C3B764(&Method_ScoreRecordCardDialog__Open_b__9_0__, v3);
    byte_4C2402B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2402E & 1) == 0 )
  {
    sub_1C3B764(&System_Action_TypeInfo, *(_QWORD *)&animationType);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v7);
    sub_1C3B764(&Method_ScoreRecordCardDialog_ActiveLargeObject__, v8);
    sub_1C3B764(&Method_ScoreRecordCardDialog_ActiveSmallObject__, v9);
    sub_1C3B764(&TweenAnimationComponent___TypeInfo, v10);
    sub_1C3B764(&Method_ScoreRecordCardDialog___c__DisplayClass12_0__PlayAnimation_b__0__, v11);
    sub_1C3B764(&ScoreRecordCardDialog___c__DisplayClass12_0_TypeInfo, v12);
    byte_4C2402E = 1;
  }
  v13 = sub_1C3B9B0(ScoreRecordCardDialog___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v13, 0LL);
  if ( !v13 )
    goto LABEL_36;
  *(_QWORD *)(v13 + 32) = callback;
  sub_1C3B708((PartyOrganizationUtility_o *)(v13 + 32), (int64_t)callback, v16, v17, v18, v19, v20, v21);
  ...
  if ( delayActionCoroutine )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.delayActionCoroutine, 0LL, v23, v24, v25, v26, v27, v28);
  }
  if ( animationType )
  {
  ...
  UnityEngine_MonoBehaviour__StartCoroutine_71108020(
    ...
    0LL);
  v14 = sub_1C3B80C(TweenAnimationComponent___TypeInfo, 2LL);
  if ( !v14 )
    goto LABEL_36;
  ...
  if ( v51 )
  {
    v14 = sub_1C3B8A0(this->fields.scaleAnimation, *(_QWORD *)(*(_QWORD *)v14 + 64LL));
    if ( !v14 )
      goto LABEL_37;
  }
  if ( !*(_DWORD *)(v52 + 24) )
    goto LABEL_35;
  *(_QWORD *)(v52 + 32) = v51;
  sub_1C3B708((PartyOrganizationUtility_o *)(v52 + 32), (int64_t)v51, v45, v46, v47, v48, v49, v50);
  v59 = this->fields.moveAnimation;
  if ( v59 )
  {
    v14 = sub_1C3B8A0(v59, *(_QWORD *)(*(_QWORD *)v52 + 64LL));
    if ( !v14 )
    {
LABEL_37:
      v71 = sub_1C3B9E4(v14);
...
LABEL_35:
    sub_1C3B9C8(v14, v15);
  *(_QWORD *)(v52 + 40) = v59;
  sub_1C3B708((PartyOrganizationUtility_o *)(v52 + 40), (int64_t)v59, v53, v54, v55, v56, v57, v58);
  *(_QWORD *)(v13 + 24) = v52;
  sub_1C3B708((PartyOrganizationUtility_o *)(v13 + 24), v52, v60, v61, v62, v63, v64, v65);
  *(_DWORD *)(v13 + 16) = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2402C & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, inOnClosed);
    byte_4C2402C = 1;
  }
  closeBtn = (UnityEngine_Object_o *)this->fields.closeBtn;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)p_onClosed, (int64_t)inOnClosed, v13, v14, v15, v16, v17, v18);
...
void __fastcall ScoreRecordCardDialog___OnClose_b__11_0(ScoreRecordCardDialog_o *this, const MethodInfo *method)
{
  ...
  sub_1C3B708(p_onClosed, 0LL, v3, v4, v5, v6, v7, v8);
}
