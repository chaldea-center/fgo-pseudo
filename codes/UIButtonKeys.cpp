...
void UIButtonKeys__Upgrade(UIButtonKeys_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(onClick, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(selectOnClick, 0, 0) )
    {
      ...
      sub_1CE66A4(
        ...
        v14);
      *p_selectOnClick = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.selectOnClick, 0, v15, v16, v17, v18, v19, v20);
  ...
  if ( UnityEngine_Object__op_Equality(onLeft, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(selectOnLeft, 0, 0) )
    {
      ...
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onLeft, (int32_t)v24, v25, v26, v27, v28, v29, v30);
      *p_selectOnLeft = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.selectOnLeft, 0, v31, v32, v33, v34, v35, v36);
      if ( !NGUITools_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(NGUITools_TypeInfo);
      NGUITools__SetDirty((UnityEngine_Object_o *)this, 0);
    }
  ...
  if ( UnityEngine_Object__op_Equality(onRight, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(selectOnRight, 0, 0) )
    {
      ...
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onRight, (int32_t)v40, v41, v42, v43, v44, v45, v46);
      *p_selectOnRight = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.selectOnRight, 0, v47, v48, v49, v50, v51, v52);
      if ( !NGUITools_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(NGUITools_TypeInfo);
      NGUITools__SetDirty((UnityEngine_Object_o *)this, 0);
    }
  ...
  if ( UnityEngine_Object__op_Equality(onUp, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(selectOnUp, 0, 0) )
    {
      ...
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onUp, (int32_t)v56, v57, v58, v59, v60, v61, v62);
      *p_selectOnUp = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.selectOnUp, 0, v63, v64, v65, v66, v67, v68);
      if ( !NGUITools_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(NGUITools_TypeInfo);
      NGUITools__SetDirty((UnityEngine_Object_o *)this, 0);
    }
  ...
  if ( UnityEngine_Object__op_Equality(onDown, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(selectOnDown, 0, 0) )
    {
      ...
      if ( *p_selectOnDown )
      {
        ...
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.onDown, (int32_t)v72, v73, v74, v75, v76, v77, v78);
        *p_selectOnDown = 0;
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.selectOnDown, 0, v79, v80, v81, v82, v83, v84);
        if ( !NGUITools_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(NGUITools_TypeInfo);
        NGUITools__SetDirty((UnityEngine_Object_o *)this, 0);
        return;
