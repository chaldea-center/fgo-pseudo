        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEA0C & 1) == 0 )
  {
    sub_B52984(&FollowerQuestInfomationDraw__DispTotalDropItemCR_d__17_TypeInfo);
    byte_42AEA0C = 1;
  }
  v5 = sub_B52A54(FollowerQuestInfomationDraw__DispTotalDropItemCR_d__17_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( dispCRW )
  {
    ...
    sub_B52920((BattleServantConfConponent_o *)&this->fields.dispCRW, 0LL, v13, v14, v15, v16, v17, v18);
  }
...
LABEL_12:
    sub_B52A5C(trendInfoBase, dispCRW);
  }
  ...
  sub_B52920(
    ...
    v30,
    v31);
  UnityEngine_MonoBehaviour__StartCoroutine_35611808((UnityEngine_MonoBehaviour_o *)this, this->fields.dispCRW, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  Instance = (ServantClassIconComponent_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_87;
...
LABEL_87:
  ...
  if ( QuestEntity__GetTypeFlag((QuestEntity_o *)Entity, 0LL) != 128 )
  {
    ...
    if ( v12 )
      Entity = QuestEntity__getRecommendLv_25291404((QuestEntity_o *)Entity, v12->fields.questPhase, 0LL);
    else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ACE18 & 1) == 0 )
  {
    ...
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&Method_FollowerQuestInfomationDraw___c__DispTotalDropItemCR_b__17_0__);
    sub_B52984(&FollowerQuestInfomationDraw___c_TypeInfo);
    this = (FollowerQuestInfomationDraw__DispTotalDropItemCR_d__17_o *)sub_B52984(&UnityEngine_WaitForEndOfFrame_TypeInfo);
    byte_42ACE18 = 1;
  }
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        if ( questRestrictionInfo->fields.isUniqueServant && questRestrictionInfo->fields.isUniqueIndividuality )
        {
          ...
          if ( !_9__17_0 )
          {
            ...
            _9__17_0 = (System_Func_WarBoardManager_WarBoardOnboardSkillTarget__bool__o *)sub_B52A54(System_Func_RestrictionEntity__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_FollowerQuestInfomationDraw__DispTotalDropItemCR_d__17_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
...
void __fastcall FollowerQuestInfomationDraw___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(FollowerQuestInfomationDraw___c_TypeInfo);
