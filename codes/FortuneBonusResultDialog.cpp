void FortuneBonusResultDialog___ctor(FortuneBonusResultDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.dayLabelWidth = xmmword_D25EC0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07B8B & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_FortuneBonusResultDialog_EndClose__);
    byte_4E07B8B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v7, 0, 0) )
    return 0;
  GameObjectExtensions__SafeSetParent_37166960((UnityEngine_GameObject_o *)v7, parent, 0);
  if ( !v7 )
    sub_1CE6958(v9, v10);
...
void FortuneBonusResultDialog__EndClose(FortuneBonusResultDialog_o *this, const MethodInfo *method)
{
  ...
  v2->klass = 0;
  sub_1CE66A4(v2, 0, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07B8F & 1) == 0 )
  {
    this = (FortuneBonusResultDialog_o *)sub_1CE6700(&StringLiteral_9304/*"N0"*/);
    byte_4E07B8F = 1;
  }
  if ( gType == 2 )
  {
    if ( !itemEnt )
      sub_1CE6958(this, *(_QWORD *)&gType);
...
LABEL_9:
  ...
  v9 = System_Int32__ToString_66631324((int32_t)&v11, (System_String_o *)StringLiteral_9304/*"N0"*/, 0);
  return System_String__Concat_65122828(v8, v9, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07B89 & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_Find_CommonUI_FortuneBonusDetailData___);
    sub_1CE6700(&System_Func_CommonUI_FortuneBonusDetailData__bool__TypeInfo);
    sub_1CE6700(&Method_FortuneBonusResultDialog___c__DisplayClass27_0__GetFortuneBonusDetailData_b__0__);
    sub_1CE6700(&FortuneBonusResultDialog___c__DisplayClass27_0_TypeInfo);
    byte_4E07B89 = 1;
  }
  v5 = sub_1CE694C(FortuneBonusResultDialog___c__DisplayClass27_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = index;
  ...
  if ( !details || !details->max_length )
    return 0;
  v10 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_CommonUI_FortuneBonusDetailData__bool__TypeInfo);
  ...
  return (CommonUI_FortuneBonusDetailData_o *)BasicHelper__Find_object_(
                                                ...
                                                (const MethodInfo_31EE0A8 *)Method_BasicHelper_Find_CommonUI_FortuneBonusDetailData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07B88 & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_Find_CommonUI_FortuneBonusRewardData___);
    sub_1CE6700(&System_Func_CommonUI_FortuneBonusRewardData__bool__TypeInfo);
    sub_1CE6700(&Method_FortuneBonusResultDialog___c__DisplayClass26_0__GetFortuneBonusLogData_b__0__);
    sub_1CE6700(&FortuneBonusResultDialog___c__DisplayClass26_0_TypeInfo);
    byte_4E07B88 = 1;
  }
  v5 = sub_1CE694C(FortuneBonusResultDialog___c__DisplayClass26_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1CE6958(v6, v7);
  *(_DWORD *)(v5 + 16) = day;
  ...
  if ( !logs || !logs->max_length )
    return 0;
  v10 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_CommonUI_FortuneBonusRewardData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v10,
    (Il2CppObject *)v5,
  ...
  return (CommonUI_FortuneBonusRewardData_o *)BasicHelper__Find_object_(
                                                logs,
                                                (System_Func_T__bool__o *)v10,
                                                (const MethodInfo_31EE0A8 *)Method_BasicHelper_Find_CommonUI_FortuneBonusRewardData___);
}
        ...
        const MethodInfo *method)
{
  ...
  *countText = (System_String_o *)StringLiteral_1/*""*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)countText, StringLiteral_1/*""*/, v13, v14, v15, v16, v17, v18);
  if ( !giftEnt )
    goto LABEL_18;
  ...
  if ( !entity )
LABEL_18:
    sub_1CE6958(Master_object, v20);
  monitor = (System_String_o *)entity[1].monitor;
  *nameText = monitor;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)nameText, (int32_t)monitor, v21, v22, v23, v24, v25, v26);
  v30 = FortuneBonusResultDialog__GetCountText(
          ...
          v29);
  *countText = v30;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)countText, (int32_t)v30, v31, v32, v33, v34, v35, v36);
}
...
void FortuneBonusResultDialog__OnClickButton(FortuneBonusResultDialog_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_FortuneBonusResultDialog_OnClickButton__);
    sub_1CE6700(&Method_FortuneBonusResultDialog__OnClickButton_b__31_0__);
    byte_4E07B8C = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusResultDialog_OnClickButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_FortuneBonusResultDialog_OnClickButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07B84 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_FortuneBonusResultDialog__Open_b__20_0__);
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&StringLiteral_18163/*"chronology_line"*/);
    sub_1CE6700(&StringLiteral_6557/*"FORTUNE_BONUS_RESULT_TITLE"*/);
    sub_1CE6700(&StringLiteral_6553/*"FORTUNE_BONUS_RESULT_BUTTON"*/);
    sub_1CE6700(&StringLiteral_6556/*"FORTUNE_BONUS_RESULT_SUBTITLE"*/);
    sub_1CE6700(&StringLiteral_18198/*"clear00"*/);
    byte_4E07B84 = 1;
  }
  this->fields.isButtonEnable = 0;
  ...
  else
  {
    ...
    if ( !gameObject )
      goto LABEL_25;
    UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_18198/*"clear00"*/, 0);
...
LABEL_25:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_6557/*"FORTUNE_BONUS_RESULT_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_25;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  subTitleLabel = this->fields.subTitleLabel;
  gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_6556/*"FORTUNE_BONUS_RESULT_SUBTITLE"*/, 0);
  if ( !subTitleLabel )
    goto LABEL_25;
  UILabel__set_text(subTitleLabel, (System_String_o *)gameObject, 0);
  okBtnLabel = this->fields.okBtnLabel;
  gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_6553/*"FORTUNE_BONUS_RESULT_BUTTON"*/, 0);
  if ( !okBtnLabel )
    goto LABEL_25;
  ...
  while ( 1 )
  {
    ...
    gameObject = AtlasManager__SetEventUI(v25, (System_String_o *)StringLiteral_18163/*"chronology_line"*/, 0);
    lineSpriteArray = this->fields.lineSpriteArray;
    ++v23;
    if ( !lineSpriteArray )
      goto LABEL_25;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07B87 & 1) == 0 )
  {
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    this = (FortuneBonusResultDialog_o *)sub_1CE6700(&StringLiteral_10556/*"PRESENT_INFO"*/);
    byte_4E07B87 = 1;
  }
  v15 = 0;
  nameText = 0;
  if ( giftEnt )
  {
    ...
    if ( ((unsigned __int8)this & 1) == 0 )
    {
      ...
      else
      {
        ...
        ItemIconComponent__SetItemImage_42068492(
          (ItemIconComponent_o *)ItemIcon,
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_10556/*"PRESENT_INFO"*/, 0);
      v13 = (FortuneBonusResultDialog_o *)System_String__Format_65164136(v12, (Il2CppObject *)nameText, v15, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07B85 & 1) == 0 )
  {
    ...
    sub_1CE6700(&LocalizationManager_TypeInfo);
    sub_1CE6700(&Method_FortuneBonusResultDialog___c__SetupRewardDisp_b__21_0__);
    sub_1CE6700(&FortuneBonusResultDialog___c_TypeInfo);
    sub_1CE6700(&StringLiteral_6555/*"FORTUNE_BONUS_RESULT_NO_NAME"*/);
    this = (FortuneBonusResultDialog_o *)sub_1CE6700(&StringLiteral_6554/*"FORTUNE_BONUS_RESULT_DAY_FORMAT"*/);
    byte_4E07B85 = 1;
  }
  if ( !logDataArray || (rewardDispUnitArray = v4->fields.rewardDispUnitArray) == 0 )
LABEL_63:
    sub_1CE6958(this, logDataArray);
  max_length = rewardDispUnitArray->max_length;
  if ( max_length >= SLODWORD(logDataArray->max_length) && max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_6554/*"FORTUNE_BONUS_RESULT_DAY_FORMAT"*/, 0);
      v49 = targetDay;
      ...
      if ( FortuneBonusLogData )
      {
        ...
        if ( this )
        {
          ...
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          this = (FortuneBonusResultDialog_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_GiftMaster___);
          if ( !this )
            goto LABEL_63;
          ...
          if ( this )
          {
            ...
            if ( SLODWORD(this->fields.m_CancellationTokenSource) >= 1 )
            {
              ...
              if ( !_9__21_0 )
              {
                ...
                _9__21_0 = (System_Comparison_T__o *)sub_1CE694C(System_Comparison_GiftEntity__TypeInfo);
      ...
      else
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (FortuneBonusResultDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6555/*"FORTUNE_BONUS_RESULT_NO_NAME"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&Method_System_Collections_Generic_List_GiftEntity__get_Count__);
    this = (FortuneBonusResultDialog_o *)sub_1CE6700(&Method_System_Collections_Generic_List_GiftEntity__get_Item__);
    byte_4E07B86 = 1;
  }
  if ( !rewardDispUnit || (itemDispUnitArray = rewardDispUnit->fields.itemDispUnitArray) == 0 || !giftEntList )
LABEL_18:
    sub_1CE6958(this, rewardDispUnit);
...
void FortuneBonusResultDialog___OnClickButton_b__31_0(FortuneBonusResultDialog_o *this, const MethodInfo *method)
{
  ...
  p_clickFunc->klass = 0;
  sub_1CE66A4(p_clickFunc, 0, v4, v5, v6, v7, v8, v9);
...
void FortuneBonusResultDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(FortuneBonusResultDialog___c_TypeInfo);
