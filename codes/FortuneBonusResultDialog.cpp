void __fastcall FortuneBonusResultDialog___ctor(FortuneBonusResultDialog_o *this, const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.dayLabelWidth = xmmword_BFB370;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4DF & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_FortuneBonusResultDialog_EndClose__, v10);
    byte_4BCA4DF = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4DE & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_ItemIconComponent___, parent);
  ...
  if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v9, 0LL, 0LL) )
    return 0LL;
  GameObjectExtensions__SafeSetParent_34762256((UnityEngine_GameObject_o *)v9, parent, 0LL);
  if ( !v9 )
    sub_1C1AE30(v11, v12);
...
void __fastcall FortuneBonusResultDialog__EndClose(FortuneBonusResultDialog_o *this, const MethodInfo *method)
{
  ...
  v2->klass = 0LL;
  sub_1C1AB78(v2, 0LL, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4E3 & 1) == 0 )
  {
    this = (FortuneBonusResultDialog_o *)sub_1C1ABD4(&StringLiteral_9389/*"N0"*/, *(_QWORD *)&gType);
    byte_4BCA4E3 = 1;
  }
  if ( gType == 2 )
  {
    if ( !itemEnt )
      sub_1C1AE30(this, *(_QWORD *)&gType);
...
LABEL_9:
  ...
  v9 = System_Int32__ToString_63845976((int32_t)&v11, (System_String_o *)StringLiteral_9389/*"N0"*/, 0LL);
  return System_String__Concat_63040368(v8, v9, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4DD & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_FortuneBonusResultDialog___c__DisplayClass27_0__GetFortuneBonusDetailData_b__0__, v6);
    sub_1C1ABD4(&FortuneBonusResultDialog___c__DisplayClass27_0_TypeInfo, v7);
    byte_4BCA4DD = 1;
  }
  v8 = sub_1C1AE20(FortuneBonusResultDialog___c__DisplayClass27_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4DC & 1) == 0 )
  {
    sub_1C1ABD4(&Method_BasicHelper_Find_CommonUI_FortuneBonusRewardData___, *(_QWORD *)&day);
    sub_1C1ABD4(&System_Func_CommonUI_FortuneBonusRewardData__bool__TypeInfo, v5);
    sub_1C1ABD4(&Method_FortuneBonusResultDialog___c__DisplayClass26_0__GetFortuneBonusLogData_b__0__, v6);
    sub_1C1ABD4(&FortuneBonusResultDialog___c__DisplayClass26_0_TypeInfo, v7);
    byte_4BCA4DC = 1;
  }
  v8 = sub_1C1AE20(FortuneBonusResultDialog___c__DisplayClass26_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1C1AE30(v9, v10);
  *(_DWORD *)(v8 + 16) = day;
  ...
  if ( !logs || !*(_QWORD *)&logs->max_length )
    return 0LL;
  v13 = (System_Func_object__bool__o *)sub_1C1AE20(System_Func_CommonUI_FortuneBonusRewardData__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v13,
    (Il2CppObject *)v8,
  ...
  return (CommonUI_FortuneBonusRewardData_o *)BasicHelper__Find_object_(
                                                ...
                                                (System_Func_T__bool__o *)v13,
                                                (const MethodInfo_2F8AFC8 *)Method_BasicHelper_Find_CommonUI_FortuneBonusRewardData___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4E2 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMaster_ItemMaster___, giftEnt);
    sub_1C1ABD4(&DataManager_TypeInfo, v11);
    sub_1C1ABD4(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__, v12);
  ...
  if ( !byte_4BC3142 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, giftEnt);
    byte_4BC3142 = 1;
  }
  ...
  *countText = (System_String_o *)StringLiteral_1/*""*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)countText, (int64_t)StringLiteral_1/*""*/, v17, v18, v19, v20, v21, v22);
  if ( !giftEnt )
    goto LABEL_18;
...
LABEL_18:
  ...
  *nameText = monitor;
  sub_1C1AB78((PartyOrganizationUtility_o *)nameText, (int64_t)monitor, v25, v26, v27, v28, v29, v30);
  v34 = FortuneBonusResultDialog__GetCountText(
          ...
          v33);
  *countText = v34;
  sub_1C1AB78((PartyOrganizationUtility_o *)countText, (int64_t)v34, v35, v36, v37, v38, v39, v40);
}
...
void __fastcall FortuneBonusResultDialog__OnClickButton(FortuneBonusResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4E0 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_FortuneBonusResultDialog_OnClickButton__, v3);
    sub_1C1ABD4(&Method_FortuneBonusResultDialog__OnClickButton_b__31_0__, v4);
    byte_4BCA4E0 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_FortuneBonusResultDialog_OnClickButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C1ABEC(Method_FortuneBonusResultDialog_OnClickButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4D8 & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, fortuneBonus);
    sub_1C1ABD4(&AtlasManager_TypeInfo, v9);
    sub_1C1ABD4(&Method_FortuneBonusResultDialog__Open_b__20_0__, v10);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v11);
    sub_1C1ABD4(&StringLiteral_18257/*"chronology_line"*/, v12);
    sub_1C1ABD4(&StringLiteral_6636/*"FORTUNE_BONUS_RESULT_TITLE"*/, v13);
    sub_1C1ABD4(&StringLiteral_6632/*"FORTUNE_BONUS_RESULT_BUTTON"*/, v14);
    sub_1C1ABD4(&StringLiteral_6635/*"FORTUNE_BONUS_RESULT_SUBTITLE"*/, v15);
    sub_1C1ABD4(&StringLiteral_18292/*"clear00"*/, v16);
    byte_4BCA4D8 = 1;
  }
  this->fields.isButtonEnable = 0;
  ...
  else
  {
    ...
    if ( !gameObject )
      goto LABEL_25;
    UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_18292/*"clear00"*/, 0LL);
...
LABEL_25:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_6636/*"FORTUNE_BONUS_RESULT_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_25;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  subTitleLabel = this->fields.subTitleLabel;
  gameObject = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_6635/*"FORTUNE_BONUS_RESULT_SUBTITLE"*/, 0LL);
  if ( !subTitleLabel )
    goto LABEL_25;
  ...
  while ( 1 )
  {
    ...
    gameObject = AtlasManager__SetEventUI(v33, (System_String_o *)StringLiteral_18257/*"chronology_line"*/, 0LL);
    lineSpriteArray = this->fields.lineSpriteArray;
    ++v31;
    if ( !lineSpriteArray )
      goto LABEL_25;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4DB & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, itemDispUnit);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v9);
    this = (FortuneBonusResultDialog_o *)sub_1C1ABD4(&StringLiteral_10650/*"PRESENT_INFO"*/, v10);
    byte_4BCA4DB = 1;
  }
  v17 = 0LL;
  nameText = 0LL;
  if ( giftEnt )
  {
    ...
    if ( ((unsigned __int8)this & 1) == 0 )
    {
      ...
      else
      {
        ...
        ItemIconComponent__SetItemImage_39343844(
          (ItemIconComponent_o *)ItemIcon,
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_10650/*"PRESENT_INFO"*/, 0LL);
      v15 = (FortuneBonusResultDialog_o *)System_String__Format_63054740(v14, (Il2CppObject *)nameText, v17, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4D9 & 1) == 0 )
  {
    sub_1C1ABD4(&System_Comparison_GiftEntity__TypeInfo, logDataArray);
    sub_1C1ABD4(&Method_DataManager_GetMaster_GiftMaster___, v5);
    sub_1C1ABD4(&DataManager_TypeInfo, v6);
    sub_1C1ABD4(&int_TypeInfo, v7);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_GiftEntity__Sort__, v8);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, v9);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v10);
    sub_1C1ABD4(&Method_FortuneBonusResultDialog___c__SetupRewardDisp_b__21_0__, v11);
    sub_1C1ABD4(&FortuneBonusResultDialog___c_TypeInfo, v12);
    sub_1C1ABD4(&StringLiteral_6634/*"FORTUNE_BONUS_RESULT_NO_NAME"*/, v13);
    this = (FortuneBonusResultDialog_o *)sub_1C1ABD4(&StringLiteral_6633/*"FORTUNE_BONUS_RESULT_DAY_FORMAT"*/, v14);
    byte_4BCA4D9 = 1;
  }
  if ( !logDataArray || (rewardDispUnitArray = v4->fields.rewardDispUnitArray) == 0LL )
LABEL_63:
    sub_1C1AE30(this, logDataArray);
  max_length = rewardDispUnitArray->max_length;
  if ( max_length >= (signed int)logDataArray->max_length && max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v22 = LocalizationManager__Get((System_String_o *)StringLiteral_6633/*"FORTUNE_BONUS_RESULT_DAY_FORMAT"*/, 0LL);
      v62 = targetDay;
      ...
      if ( FortuneBonusLogData )
      {
        ...
        if ( this )
        {
          ...
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          this = (FortuneBonusResultDialog_o *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_GiftMaster___);
          if ( !this )
            goto LABEL_63;
          ...
          if ( this )
          {
            ...
            if ( SLODWORD(this->fields.m_CancellationTokenSource) >= 1 )
            {
              ...
              if ( !_9__21_0 )
              {
                ...
                _9__21_0 = (System_Comparison_T__o *)sub_1C1AE20(System_Comparison_GiftEntity__TypeInfo);
      ...
      else
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        this = (FortuneBonusResultDialog_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6634/*"FORTUNE_BONUS_RESULT_NO_NAME"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4DA & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_List_GiftEntity__get_Count__, rewardDispUnit);
    this = (FortuneBonusResultDialog_o *)sub_1C1ABD4(&Method_System_Collections_Generic_List_GiftEntity__get_Item__, v7);
    byte_4BCA4DA = 1;
  }
  if ( !rewardDispUnit || (itemDispUnitArray = rewardDispUnit->fields.itemDispUnitArray) == 0LL || !giftEntList )
LABEL_18:
    sub_1C1AE30(this, rewardDispUnit);
    ...
    do
    {
      ...
      if ( this )
      {
        ...
        if ( v10 >= v12->max_length )
          sub_1C1AE38(this, rewardDispUnit);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78(p_clickFunc, 0LL, v4, v5, v6, v7, v8, v9);
...
void __fastcall FortuneBonusResultDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BCA4E6 & 1) == 0 )
  {
    sub_1C1ABD4(&FortuneBonusResultDialog___c_TypeInfo, v1);
    byte_4BCA4E6 = 1;
  }
  v2 = (Il2CppObject *)sub_1C1AE20(FortuneBonusResultDialog___c_TypeInfo);
