        ...
        const MethodInfo *method)
{
  if ( (byte_4C394C2 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19329/*"expeditionIdxs"*/);
    byte_4C394C2 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19143/*"eventId"*/, eventId, 0);
  RequestBase__addField_44145300((RequestBase_o *)this, (System_String_o *)StringLiteral_19329/*"expeditionIdxs"*/, &expeditionIdxs->obj, 0);
...
System_String_o *EventExpeditionFinishRequest__getURL(EventExpeditionFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C394C1 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_19126/*"event/expeditionFinish"*/);
    byte_4C394C1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63518544(BaseUrl, (System_String_o *)StringLiteral_19126/*"event/expeditionFinish"*/, 0);
}
