        ...
        const MethodInfo *method)
{
  if ( (byte_593A20E & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_20184/*"expeditionIdxs"*/);
    byte_593A20E = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19995/*"eventId"*/, eventId, 0);
  RequestBase__addField_51191900((RequestBase_o *)this, (System_String_o *)StringLiteral_20184/*"expeditionIdxs"*/, &expeditionIdxs->obj, 0);
...
System_String_o *EventExpeditionFinishRequest__getURL(EventExpeditionFinishRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A20D & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_19978/*"event/expeditionFinish"*/);
    byte_593A20D = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_19978/*"event/expeditionFinish"*/, 0);
}
