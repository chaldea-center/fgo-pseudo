        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB75D7 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_19340/*"expeditionIdxs"*/, v7);
    byte_4AB75D7 = 1;
  }
  ...
  RequestBase__addField_41524956(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_19340/*"expeditionIdxs"*/,
    &expeditionIdxs->obj,
    v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB75D6 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_19145/*"event/expeditionFinish"*/, v2);
    byte_4AB75D6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_19145/*"event/expeditionFinish"*/, 0LL);
}
