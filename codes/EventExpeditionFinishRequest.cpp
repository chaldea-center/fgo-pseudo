        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EE8 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_19053/*"expeditionIdxs"*/, v7);
    byte_48E3EE8 = 1;
  }
  ...
  RequestBase__addField_39761928(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_19053/*"expeditionIdxs"*/,
    &expeditionIdxs->obj,
    v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EE7 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_18863/*"event/expeditionFinish"*/, v2);
    byte_48E3EE7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_18863/*"event/expeditionFinish"*/, 0LL);
}
