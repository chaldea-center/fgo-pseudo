        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9E1 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19310/*"expeditionIdxs"*/);
    byte_4A5C9E1 = 1;
  }
  ...
  RequestBase__addField_41136012(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_19310/*"expeditionIdxs"*/,
    &expeditionIdxs->obj,
    v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9E0 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19115/*"event/expeditionFinish"*/);
    byte_4A5C9E0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_19115/*"event/expeditionFinish"*/, 0LL);
}
