...
void __fastcall CinemascopeSideFrame__Hide(CinemascopeSideFrame_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A020DE & 1) == 0 )
  {
    sub_1B64870(&CommonUI_TypeInfo, method);
    byte_4A020DE = 1;
  }
  if ( this->fields.hide )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A020DD & 1) == 0 )
  {
    sub_1B64870(&CommonUI_TypeInfo, name);
  ...
  if ( this->fields.show )
  {
    ...
    System_Nullable_int____ctor(v12, v9, (const MethodInfo_35D0064 *)Method_System_Nullable_int___ctor__);
  }
  return v11;
}