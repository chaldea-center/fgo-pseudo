...
void UISlider__OnStart(UISlider_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D30F1D & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&Method_UISlider_OnDragBackground__);
    sub_1C94098(&Method_UISlider_OnDragForeground__);
    sub_1C94098(&Method_UISlider_OnPressBackground__);
    sub_1C94098(&Method_UISlider_OnPressForeground__);
