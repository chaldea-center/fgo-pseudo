...
void UISlider__OnStart(UISlider_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0911E & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_UISlider_OnDragBackground__);
    sub_1CE6700(&Method_UISlider_OnDragForeground__);
    sub_1CE6700(&Method_UISlider_OnPressBackground__);
    sub_1CE6700(&Method_UISlider_OnPressForeground__);
