...
void UISlider__OnStart(UISlider_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7BE50 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&Method_UISlider_OnDragBackground__);
    sub_1D0F0B4(&Method_UISlider_OnDragForeground__);
    sub_1D0F0B4(&Method_UISlider_OnPressBackground__);
    sub_1D0F0B4(&Method_UISlider_OnPressForeground__);
