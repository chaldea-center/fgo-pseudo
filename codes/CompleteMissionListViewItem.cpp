        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8EE8 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_1/*""*/, (_DWORD)missionData, type, method);
    byte_42E8EE8 = 1;
  }
  ...
  sub_B5D560((BattleServantConfConponent_o *)&this->fields.closedMessage, v23, v24, v25, v26, v27, v28, v29);
  v30 = (System_Int32_array **)StringLiteral_1/*""*/;
  this->fields.progTxt = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_B5D560((BattleServantConfConponent_o *)&this->fields.progTxt, v30, v31, v32, v33, v34, v35, v36);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8EE9 & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataManager_GetMasterData_NotEndEventMissionFixMaster___, (_DWORD)method, v2, v3);
  ...
  if ( !eventMissionEnt
    || (this->fields.isNowMission = EventMissionEntity__isNowMission(eventMissionEnt, 0LL),
        (eventMissionEnt = (EventMissionEntity_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2A2FE60 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (eventMissionEnt = (EventMissionEntity_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                                    (DataManager_o *)eventMissionEnt,
                                                    (const MethodInfo_1AE424C *)Method_DataManager_GetMasterData_NotEndEventMissionFixMaster___)) == 0LL
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 )
  {
    ...
    if ( (unsigned int)progStatus <= 4 )
      this->fields.sortValue0 = qword_32A3AE0[progStatus];
    if ( sort )
    {
