        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D09D & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_1/*""*/, missionData);
    byte_4A4D09D = 1;
  }
  MissionListViewItem___ctor((MissionListViewItem_o *)this, 0LL);
  this->fields.eventMissionEnt = missionData;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.eventMissionEnt, (int32_t)missionData, v7, v8);
  if ( !missionData )
    goto LABEL_7;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.condMsg, v14, v11, v12);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.closedMessage, v15, v16, v17);
  v18 = (int)StringLiteral_1/*""*/;
  this->fields.progTxt = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.progTxt, v18, v19, v20);
  ...
  *(_QWORD *)&this->fields.progStatus = 0x400000000LL;
  ...
  {
LABEL_7:
    sub_1B86614(eventMissionEnt, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4D09E & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_NotEndEventMissionFixMaster___, method);
    sub_1B863B8(&MissionInfoMaker_TypeInfo, v3);
  ...
  if ( !eventMissionEnt
    || (this->fields.isNowMission = EventMissionEntity__isNowMission(eventMissionEnt, 0LL),
        (eventMissionEnt = (EventMissionEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (eventMissionEnt = (EventMissionEntity_o *)DataManager__GetMasterData_object_(
                                                    (DataManager_o *)eventMissionEnt,
                                                    (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_NotEndEventMissionFixMaster___)) == 0LL
  ...
  {
    sub_1B86614(eventMissionEnt, method);
  }
  ...
  this->fields.progType = MissionInfoMaker__GetMissionProgressType_45237204(
                            currentEventId,
                            currentMissionId,
                            isNowMission,
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 )
  {
    ...
    if ( (unsigned int)progStatus <= 4 )
      this->fields.sortValue0 = qword_BFC398[progStatus];
    if ( sort )
    {
