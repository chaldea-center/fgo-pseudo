        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.eventMissionEnt, (int32_t)missionData, v7, v8);
  if ( !missionData )
    goto LABEL_7;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.condMsg, v14, v11, v12);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.closedMessage, v15, v16, v17);
  v18 = (int)StringLiteral_1/*""*/;
  this->fields.progTxt = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.progTxt, v18, v19, v20);
  ...
  *(_QWORD *)&this->fields.progStatus = 0x400000000LL;
  ...
  {
LABEL_7:
    sub_1B8880C(eventMissionEnt, v10);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !eventMissionEnt
    || (this->fields.isNowMission = EventMissionEntity__isNowMission(eventMissionEnt, 0LL),
        (eventMissionEnt = (EventMissionEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (eventMissionEnt = (EventMissionEntity_o *)DataManager__GetMasterData_object_(
                                                    (DataManager_o *)eventMissionEnt,
                                                    (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_NotEndEventMissionFixMaster___)) == 0LL
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 )
  {
    ...
    if ( (unsigned int)progStatus <= 4 )
      this->fields.sortValue0 = qword_BEE6B8[progStatus];
    if ( sort )
    {
