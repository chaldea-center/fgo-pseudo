        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35EC0 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_1/*""*/, missionData);
    byte_4B35EC0 = 1;
  }
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.condMsg, (int64_t)v22, v15, v16, v17, v18, v19, v20);
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.closedMessage, (int64_t)v23, v24, v25, v26, v27, v28, v29);
  v30 = StringLiteral_1/*""*/;
  this->fields.progTxt = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields.progTxt, (int64_t)v30, v31, v32, v33, v34, v35, v36);
  ...
  *(_QWORD *)&this->fields.progStatus = 0x400000000LL;
  ...
  {
LABEL_7:
    sub_1BD36B4(eventMissionEnt, v14);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35EC1 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_NotEndEventMissionFixMaster___, method);
  ...
  if ( !eventMissionEnt
    || (this->fields.isNowMission = EventMissionEntity__isNowMission(eventMissionEnt, 0LL),
        (eventMissionEnt = (EventMissionEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (eventMissionEnt = (EventMissionEntity_o *)DataManager__GetMasterData_object_(
                                                    (DataManager_o *)eventMissionEnt,
                                                    (const MethodInfo_2F31684 *)Method_DataManager_GetMasterData_NotEndEventMissionFixMaster___)) == 0LL
        ...
        const MethodInfo *method)
{
  ...
  if ( v5 )
  {
    ...
    if ( (unsigned int)progStatus <= 4 )
      this->fields.sortValue0 = qword_C122B0[progStatus];
    if ( sort )
    {
