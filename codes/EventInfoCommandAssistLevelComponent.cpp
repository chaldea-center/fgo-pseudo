void __fastcall EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC82C1 & 1) == 0 )
  {
    sub_1C1ABD4(&EventInfoCommandAssistLevelComponent_TypeInfo, v1);
    sub_1C1ABD4(&StringLiteral_17326/*"badge_lock"*/, v8);
    sub_1C1ABD4(&StringLiteral_16256/*"[ffff00]"*/, v9);
    byte_4BC82C1 = 1;
  }
  EventInfoCommandAssistLevelComponent_TypeInfo->static_fields->ICON_SPRITE_NAME_LOCK = (struct System_String_o *)StringLiteral_17326/*"badge_lock"*/;
  sub_1C1AB78(
    (PartyOrganizationUtility_o *)EventInfoCommandAssistLevelComponent_TypeInfo->static_fields,
    StringLiteral_17326/*"badge_lock"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v10 = StringLiteral_16256/*"[ffff00]"*/;
  static_fields = EventInfoCommandAssistLevelComponent_TypeInfo->static_fields;
  static_fields->MAX_LEVEL_TEXT_COLOR = (struct System_String_o *)StringLiteral_16256/*"[ffff00]"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v10, v12, v13, v14, v15, v16, v17);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC82BD & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, control);
    byte_4BC82BD = 1;
  }
  ...
  if ( data && !v7 )
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.assistData, (int64_t)data, v14, v15, v16, v17, v18, v19);
    assistData = this->fields.assistData;
    if ( !assistData
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC82BE & 1) == 0 )
  {
    sub_1C1ABD4(&AtlasManager_TypeInfo, *(_QWORD *)&level);
    sub_1C1ABD4(&EventInfoCommandAssistLevelComponent_TypeInfo, v5);
    byte_4BC82BE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC82BF & 1) == 0 )
  {
    sub_1C1ABD4(&EventInfoCommandAssistLevelComponent_TypeInfo, *(_QWORD *)&level);
...
LABEL_15:
    sub_1C1AE30(levelLabel, *(_QWORD *)&level);
  }
  if ( level < 10 )
  {
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8405/*"LEVEL_INFO"*/, 0LL);
  v14 = System_Int32__ToString((int32_t)&v16, 0LL);
  v15 = (Il2CppObject *)System_String__Concat_63040368(v11, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC82C0 & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, endAction);
    byte_4BC82C0 = 1;
  }
