void __fastcall EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E3328 & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoCommandAssistLevelComponent_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_16821/*"badge_lock"*/, v4);
    sub_1B00CCC(&StringLiteral_15761/*"[ffff00]"*/, v5);
    byte_48E3328 = 1;
  }
  EventInfoCommandAssistLevelComponent_TypeInfo->static_fields->ICON_SPRITE_NAME_LOCK = (struct System_String_o *)StringLiteral_16821/*"badge_lock"*/;
  sub_1B00C70(
    (ServantStatusBattleListViewItem_o *)EventInfoCommandAssistLevelComponent_TypeInfo->static_fields,
    StringLiteral_16821/*"badge_lock"*/,
    v2,
    v3);
  v6 = StringLiteral_15761/*"[ffff00]"*/;
  static_fields = EventInfoCommandAssistLevelComponent_TypeInfo->static_fields;
  static_fields->MAX_LEVEL_TEXT_COLOR = (struct System_String_o *)StringLiteral_15761/*"[ffff00]"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3324 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, control);
    byte_48E3324 = 1;
  }
  ...
  if ( data && !v7 )
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.commandAssistLevelControl, (int32_t)control, v8, v9);
    this->fields.assistData = data;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.assistData, (int32_t)data, v10, v11);
    assistData = this->fields.assistData;
    if ( !assistData
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3325 & 1) == 0 )
  {
    sub_1B00CCC(&AtlasManager_TypeInfo, *(_QWORD *)&level);
    sub_1B00CCC(&EventInfoCommandAssistLevelComponent_TypeInfo, v5);
    byte_48E3325 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3326 & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoCommandAssistLevelComponent_TypeInfo, *(_QWORD *)&level);
...
LABEL_15:
    sub_1B00F28(levelLabel, *(_QWORD *)&level);
  }
  if ( level < 10 )
  {
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8145/*"LEVEL_INFO"*/, 0LL);
  v14 = System_Int32__ToString((int32_t)&v16, 0LL);
  v15 = (Il2CppObject *)System_String__Concat_60325748(v11, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3327 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, endAction);
    byte_48E3327 = 1;
  }
