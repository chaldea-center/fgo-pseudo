void __fastcall EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FF690 & 1) == 0 )
  {
    sub_1B64A00(&EventInfoCommandAssistLevelComponent_TypeInfo, v1);
    sub_1B64A00(&StringLiteral_16989/*"badge_lock"*/, v4);
    sub_1B64A00(&StringLiteral_15927/*"[ffff00]"*/, v5);
    byte_49FF690 = 1;
  }
  EventInfoCommandAssistLevelComponent_TypeInfo->static_fields->ICON_SPRITE_NAME_LOCK = (struct System_String_o *)StringLiteral_16989/*"badge_lock"*/;
  sub_1B649A4(
    (ServantStatusBattleListViewItem_o *)EventInfoCommandAssistLevelComponent_TypeInfo->static_fields,
    StringLiteral_16989/*"badge_lock"*/,
    v2,
    v3);
  v6 = StringLiteral_15927/*"[ffff00]"*/;
  static_fields = EventInfoCommandAssistLevelComponent_TypeInfo->static_fields;
  static_fields->MAX_LEVEL_TEXT_COLOR = (struct System_String_o *)StringLiteral_15927/*"[ffff00]"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF68C & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, control);
    byte_49FF68C = 1;
  }
  ...
  if ( data && !v7 )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.commandAssistLevelControl, (int32_t)control, v8, v9);
    this->fields.assistData = data;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.assistData, (int32_t)data, v10, v11);
    assistData = this->fields.assistData;
    if ( !assistData
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF68D & 1) == 0 )
  {
    sub_1B64A00(&AtlasManager_TypeInfo, *(_QWORD *)&level);
    sub_1B64A00(&EventInfoCommandAssistLevelComponent_TypeInfo, v5);
    byte_49FF68D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF68E & 1) == 0 )
  {
    sub_1B64A00(&EventInfoCommandAssistLevelComponent_TypeInfo, *(_QWORD *)&level);
...
LABEL_15:
    sub_1B64C5C(levelLabel, *(_QWORD *)&level);
  }
  if ( level < 10 )
  {
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8200/*"LEVEL_INFO"*/, 0LL);
  v14 = System_Int32__ToString((int32_t)&v16, 0LL);
  v15 = (Il2CppObject *)System_String__Concat_61385136(v11, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF68F & 1) == 0 )
  {
    sub_1B64A00(&UnityEngine_Object_TypeInfo, endAction);
    byte_49FF68F = 1;
  }
