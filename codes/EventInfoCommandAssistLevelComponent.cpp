void __fastcall EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A097D4 & 1) == 0 )
  {
    sub_1B686D4(&EventInfoCommandAssistLevelComponent_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_16989/*"badge_lock"*/, v4);
    sub_1B686D4(&StringLiteral_15926/*"[ffff00]"*/, v5);
    byte_4A097D4 = 1;
  }
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A097D0 & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, control);
    byte_4A097D0 = 1;
  }
  ...
  if ( data && !v7 )
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.commandAssistLevelControl, (int32_t)control, v8, v9);
    this->fields.assistData = data;
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.assistData, (int32_t)data, v10, v11);
    assistData = this->fields.assistData;
    if ( !assistData
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A097D1 & 1) == 0 )
  {
    sub_1B686D4(&AtlasManager_TypeInfo, *(_QWORD *)&level);
    sub_1B686D4(&EventInfoCommandAssistLevelComponent_TypeInfo, v5);
    byte_4A097D1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A097D2 & 1) == 0 )
  {
    sub_1B686D4(&EventInfoCommandAssistLevelComponent_TypeInfo, *(_QWORD *)&level);
...
LABEL_15:
    sub_1B68930(levelLabel, *(_QWORD *)&level);
  }
  if ( level < 10 )
  {
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8202/*"LEVEL_INFO"*/, 0LL);
  v14 = System_Int32__ToString((int32_t)&v16, 0LL);
  v15 = (Il2CppObject *)System_String__Concat_61419468(v11, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A097D3 & 1) == 0 )
  {
    sub_1B686D4(&UnityEngine_Object_TypeInfo, endAction);
    byte_4A097D3 = 1;
  }
