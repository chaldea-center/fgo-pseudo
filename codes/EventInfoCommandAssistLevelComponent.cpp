void __fastcall EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B02607 & 1) == 0 )
  {
    sub_1BC3008(&EventInfoCommandAssistLevelComponent_TypeInfo, v1);
    sub_1BC3008(&StringLiteral_16869/*"badge_lock"*/, v4);
    sub_1BC3008(&StringLiteral_15837/*"[ffff00]"*/, v5);
    byte_4B02607 = 1;
  }
  EventInfoCommandAssistLevelComponent_TypeInfo->static_fields->ICON_SPRITE_NAME_LOCK = (struct System_String_o *)StringLiteral_16869/*"badge_lock"*/;
  sub_1BC2FAC(
    (CGThumbnailListItem_o *)EventInfoCommandAssistLevelComponent_TypeInfo->static_fields,
    StringLiteral_16869/*"badge_lock"*/,
    v2,
    v3);
  v6 = StringLiteral_15837/*"[ffff00]"*/;
  static_fields = EventInfoCommandAssistLevelComponent_TypeInfo->static_fields;
  static_fields->MAX_LEVEL_TEXT_COLOR = (struct System_String_o *)StringLiteral_15837/*"[ffff00]"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02603 & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, control);
    byte_4B02603 = 1;
  }
  ...
  if ( data && !v7 )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.commandAssistLevelControl, (int32_t)control, v8, v9);
    this->fields.assistData = data;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.assistData, (int32_t)data, v10, v11);
    assistData = this->fields.assistData;
    if ( !assistData
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02604 & 1) == 0 )
  {
    sub_1BC3008(&AtlasManager_TypeInfo, *(_QWORD *)&level);
    sub_1BC3008(&EventInfoCommandAssistLevelComponent_TypeInfo, v5);
    byte_4B02604 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02605 & 1) == 0 )
  {
    sub_1BC3008(&EventInfoCommandAssistLevelComponent_TypeInfo, *(_QWORD *)&level);
...
LABEL_15:
    sub_1BC3264(levelLabel, *(_QWORD *)&level);
  }
  if ( level < 10 )
  {
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8183/*"LEVEL_INFO"*/, 0LL);
  v14 = System_Int32__ToString((int32_t)&v16, 0LL);
  v15 = (Il2CppObject *)System_String__Concat_62348648(v11, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B02606 & 1) == 0 )
  {
    sub_1BC3008(&UnityEngine_Object_TypeInfo, endAction);
    byte_4B02606 = 1;
  }
