void __fastcall EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6568 & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoCommandAssistLevelComponent_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_17087/*"badge_lock"*/, v4);
    sub_1BAB41C(&StringLiteral_16022/*"[ffff00]"*/, v5);
    byte_4AB6568 = 1;
  }
  EventInfoCommandAssistLevelComponent_TypeInfo->static_fields->ICON_SPRITE_NAME_LOCK = (struct System_String_o *)StringLiteral_17087/*"badge_lock"*/;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)EventInfoCommandAssistLevelComponent_TypeInfo->static_fields,
    StringLiteral_17087/*"badge_lock"*/,
    v2,
    v3);
  v6 = StringLiteral_16022/*"[ffff00]"*/;
  static_fields = EventInfoCommandAssistLevelComponent_TypeInfo->static_fields;
  static_fields->MAX_LEVEL_TEXT_COLOR = (struct System_String_o *)StringLiteral_16022/*"[ffff00]"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6564 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, control);
    byte_4AB6564 = 1;
  }
  ...
  if ( data && !v7 )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.commandAssistLevelControl, (int32_t)control, v8, v9);
    this->fields.assistData = data;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.assistData, (int32_t)data, v10, v11);
    assistData = this->fields.assistData;
    if ( !assistData
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6565 & 1) == 0 )
  {
    sub_1BAB41C(&AtlasManager_TypeInfo, *(_QWORD *)&level);
    sub_1BAB41C(&EventInfoCommandAssistLevelComponent_TypeInfo, v5);
    byte_4AB6565 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6566 & 1) == 0 )
  {
    sub_1BAB41C(&EventInfoCommandAssistLevelComponent_TypeInfo, *(_QWORD *)&level);
...
LABEL_15:
    sub_1BAB678(levelLabel, *(_QWORD *)&level);
  }
  if ( level < 10 )
  {
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8241/*"LEVEL_INFO"*/, 0LL);
  v14 = System_Int32__ToString((int32_t)&v16, 0LL);
  v15 = (Il2CppObject *)System_String__Concat_62048128(v11, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6567 & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, endAction);
    byte_4AB6567 = 1;
  }
