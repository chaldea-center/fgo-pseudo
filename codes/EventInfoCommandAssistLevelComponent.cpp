void EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E04CAD & 1) == 0 )
  {
    sub_1CE6700(&EventInfoCommandAssistLevelComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_17193/*"badge_lock"*/);
    sub_1CE6700(&StringLiteral_16133/*"[ffff00]"*/);
    byte_4E04CAD = 1;
  }
  EventInfoCommandAssistLevelComponent_TypeInfo->static_fields->ICON_SPRITE_NAME_LOCK = (struct System_String_o *)StringLiteral_17193/*"badge_lock"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)EventInfoCommandAssistLevelComponent_TypeInfo->static_fields,
    StringLiteral_17193/*"badge_lock"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_16133/*"[ffff00]"*/;
  static_fields = EventInfoCommandAssistLevelComponent_TypeInfo->static_fields;
  static_fields->MAX_LEVEL_TEXT_COLOR = (struct System_String_o *)StringLiteral_16133/*"[ffff00]"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v7, v9, v10, v11, v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( data && !v7 )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.assistData, (int32_t)data, v14, v15, v16, v17, v18, v19);
    assistData = this->fields.assistData;
    if ( !assistData
...
LABEL_15:
    sub_1CE6958(levelLabel, *(_QWORD *)&level);
  }
  if ( level < 10 )
  {
  ...
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_8327/*"LEVEL_INFO"*/, 0);
  v11 = System_Int32__ToString((int32_t)&v13, 0);
  v12 = (Il2CppObject *)System_String__Concat_65122828(v8, v11, 0);
