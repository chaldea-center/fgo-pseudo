void __fastcall EventInfoCommandAssistLevelComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FCF77 & 1) == 0 )
  {
    sub_1B640C8(&EventInfoCommandAssistLevelComponent_TypeInfo, v1);
    sub_1B640C8(&StringLiteral_16986/*"badge_lock"*/, v4);
    sub_1B640C8(&StringLiteral_15924/*"[ffff00]"*/, v5);
    byte_49FCF77 = 1;
  }
  EventInfoCommandAssistLevelComponent_TypeInfo->static_fields->ICON_SPRITE_NAME_LOCK = (struct System_String_o *)StringLiteral_16986/*"badge_lock"*/;
  sub_1B6406C(
    (ServantStatusBattleListViewItem_o *)EventInfoCommandAssistLevelComponent_TypeInfo->static_fields,
    StringLiteral_16986/*"badge_lock"*/,
    v2,
    v3);
  v6 = StringLiteral_15924/*"[ffff00]"*/;
  static_fields = EventInfoCommandAssistLevelComponent_TypeInfo->static_fields;
  static_fields->MAX_LEVEL_TEXT_COLOR = (struct System_String_o *)StringLiteral_15924/*"[ffff00]"*/;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&static_fields->MAX_LEVEL_TEXT_COLOR, v6, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCF73 & 1) == 0 )
  {
    sub_1B640C8(&UnityEngine_Object_TypeInfo, control);
    byte_49FCF73 = 1;
  }
  ...
  if ( data && !v7 )
  {
    ...
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.commandAssistLevelControl, (int32_t)control, v8, v9);
    this->fields.assistData = data;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.assistData, (int32_t)data, v10, v11);
    assistData = this->fields.assistData;
    if ( !assistData
      || (EventInfoCommandAssistLevelComponent__SetupIcon(this, assistData->fields.oldLv, v13),
          (v16 = this->fields.assistData) == 0LL) )
    {
      sub_1B64324(v12);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCF74 & 1) == 0 )
  {
    sub_1B640C8(&AtlasManager_TypeInfo, *(_QWORD *)&level);
    sub_1B640C8(&EventInfoCommandAssistLevelComponent_TypeInfo, v5);
    byte_49FCF74 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCF75 & 1) == 0 )
  {
    sub_1B640C8(&EventInfoCommandAssistLevelComponent_TypeInfo, *(_QWORD *)&level);
...
LABEL_15:
  ...
  v13 = LocalizationManager__Get((System_String_o *)StringLiteral_8198/*"LEVEL_INFO"*/, 0LL);
  v14 = System_Int32__ToString((int32_t)&v16, 0LL);
  v15 = (Il2CppObject *)System_String__Concat_61375396(v11, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCF76 & 1) == 0 )
  {
    sub_1B640C8(&UnityEngine_Object_TypeInfo, endAction);
    byte_49FCF76 = 1;
  }
