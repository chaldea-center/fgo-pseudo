        ...
        const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.isStartingMemberFriendshipUpAll = 0;
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.servantName, v13, v7, v8, v9, v10, v11, v12);
...
void EventMargeItemUpValInfo___ctor_42292596(
        EventMargeItemUpValInfo_o *this,
        int32_t member,
...
void EventMargeItemUpValInfo___ctor_42292816(
        EventMargeItemUpValInfo_o *this,
        int32_t eventId,
...
void EventMargeItemUpValInfo___ctor_42292896(
        EventMargeItemUpValInfo_o *this,
        int32_t eventId,
        const MethodInfo *method)
{
...
System_String_o *EventMargeItemUpValInfo__GetColorString(EventMargeItemUpValInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEE1E2 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_10262/*"PARTY_ORGANIZATION_EVENT_MEMBER_MINE_EFFECT"*/);
    sub_1C7BAE8(&StringLiteral_10264/*"PARTY_ORGANIZATION_EVENT_MEMBER_OTHER_EFFECT"*/);
    byte_4CEE1E2 = 1;
  }
  ...
  if ( isOtherUp )
    v4 = (System_String_o **)&StringLiteral_10264/*"PARTY_ORGANIZATION_EVENT_MEMBER_OTHER_EFFECT"*/;
  else
    v4 = (System_String_o **)&StringLiteral_10262/*"PARTY_ORGANIZATION_EVENT_MEMBER_MINE_EFFECT"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEE1E6 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_1/*""*/);
    sub_1C7BAE8(&StringLiteral_10293/*"PARTY_ORGANIZATION_NOT_CLASS_BOARD"*/);
...
LABEL_47:
  ...
  if ( this->fields.friendPointBonus >= 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_11580/*"SELECT_FP_NUM_UP"*/, 0);
  ...
  if ( this->fields.isServantPoint )
  {
    ...
    v16 = System_String__Concat_64176912((System_String_o *)StringLiteral_10328/*"PARTY_ORGANIZATION_SERVANT_POINT_RANK_"*/, v15, 0);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v17 = LocalizationManager__Get((System_String_o *)StringLiteral_10327/*"PARTY_ORGANIZATION_SERVANT_POINT_INFO"*/, 0);
    servantPoint = this->fields.servantPoint;
    v18 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &servantPoint);
    return System_String__Format_64218220(v17, (Il2CppObject *)IconDetailText, v18, 0);
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  return LocalizationManager__Get((System_String_o *)StringLiteral_10293/*"PARTY_ORGANIZATION_NOT_CLASS_BOARD"*/, 0);
}
...
System_String_o *EventMargeItemUpValInfo__GetServantName(EventMargeItemUpValInfo_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_10265/*"PARTY_ORGANIZATION_EVENT_MEMBER_SUPPORT"*/);
    sub_1C7BAE8(&StringLiteral_1/*""*/);
    sub_1C7BAE8(&StringLiteral_10258/*"PARTY_ORGANIZATION_EVENT_MEMBER"*/);
    byte_4CEE1E3 = 1;
  }
  if ( this->fields.member < 0 )
    return (System_String_o *)StringLiteral_1/*""*/;
  v3 = (System_String_o **)&StringLiteral_10258/*"PARTY_ORGANIZATION_EVENT_MEMBER"*/;
  if ( this->fields.isFollower )
    v3 = (System_String_o **)&StringLiteral_10265/*"PARTY_ORGANIZATION_EVENT_MEMBER_SUPPORT"*/;
  v4 = *v3;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
...
System_String_o *EventMargeItemUpValInfo__GetTargetString(EventMargeItemUpValInfo_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_10268/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_ALL"*/);
    sub_1C7BAE8(&StringLiteral_10270/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_OTHER_FULL"*/);
    sub_1C7BAE8(&StringLiteral_10269/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_FULL"*/);
    sub_1C7BAE8(&StringLiteral_10271/*"PARTY_ORGANIZATION_EVENT_TARGET_SELF"*/);
    sub_1C7BAE8(&StringLiteral_1/*""*/);
    byte_4CEE1E5 = 1;
  }
  ...
  if ( targetType <= 3 )
  {
    if ( !targetType )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v6 = &StringLiteral_10271/*"PARTY_ORGANIZATION_EVENT_TARGET_SELF"*/;
    ...
    if ( targetType == 3 )
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v6 = &StringLiteral_10268/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_ALL"*/;
      return LocalizationManager__Get((System_String_o *)*v6, 0);
    }
    return (System_String_o *)StringLiteral_1/*""*/;
  }
  if ( targetType == 7 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v6 = &StringLiteral_10269/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_FULL"*/;
    return LocalizationManager__Get((System_String_o *)*v6, 0);
  }
  if ( targetType != 14 )
    return (System_String_o *)StringLiteral_1/*""*/;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = &StringLiteral_10270/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_OTHER_FULL"*/;
  return LocalizationManager__Get((System_String_o *)*v6, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.nameTitle, (int32_t)titleName, v21, v22, v23, v24, v25, v26);
        ...
        const MethodInfo *method)
{
  ...
  this->fields.nameTitle = titleName;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.nameTitle, (int32_t)titleName, v11, v12, v13, v14, v15, v16);
  if ( calcType == 2 )
  {
...
void EventMargeItemUpValInfo__SetIcon(EventMargeItemUpValInfo_o *this, UISprite_o *sprite, const MethodInfo *method)
{
  ...
  if ( (byte_4CEE1E7 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_19868/*"func_group_icon_"*/);
    sub_1C7BAE8(&StringLiteral_19869/*"func_group_icon_1009"*/);
    sub_1C7BAE8(&StringLiteral_19872/*"func_group_icon_1028"*/);
    this = (EventMargeItemUpValInfo_o *)sub_1C7BAE8(&StringLiteral_19871/*"func_group_icon_1023_starting"*/);
    byte_4CEE1E7 = 1;
  }
  v19 = 0;
  ...
  if ( !funcGroupEntity )
  {
    ...
    if ( v4->fields.isServantPoint )
    {
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v12 = &StringLiteral_19872/*"func_group_icon_1028"*/;
    }
    else if ( v4->fields.isFriendshipUpForCampaign )
    {
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v12 = &StringLiteral_19869/*"func_group_icon_1009"*/;
    }
    else
    {
      ...
      if ( isStartingMemberFriendshipUpAll )
        v12 = &StringLiteral_19871/*"func_group_icon_1023_starting"*/;
      else
        v12 = &StringLiteral_19870/*"func_group_icon_1009_starting"*/;
    }
...
LABEL_25:
  ...
  addPassiveIconNameOverwrite = System_String__Concat_64176912((System_String_o *)StringLiteral_19868/*"func_group_icon_"*/, v13, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
  {
    v15 = AtlasManager_TypeInfo;
LABEL_27:
