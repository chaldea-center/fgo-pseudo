        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF08D & 1) == 0 )
  {
    sub_1B64A00(&QuestReleaseEntity_TypeInfo, method);
    byte_49FF08D = 1;
  }
  v3 = sub_1B64C4C(QuestReleaseEntity_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF08E & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_EventMaster___, nowTime);
