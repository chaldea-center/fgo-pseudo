...
System_String_o *ClassBoardReleaseLockRequest__getURL(ClassBoardReleaseLockRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A1AA & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_18739/*"classBoard/releaseLock"*/);
    byte_593A1AA = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_18739/*"classBoard/releaseLock"*/, 0);
}
