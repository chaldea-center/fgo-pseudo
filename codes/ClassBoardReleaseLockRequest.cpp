        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6845C & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_18221/*"classBoard/releaseLock"*/, v2);
    byte_4B6845C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_18221/*"classBoard/releaseLock"*/, 0LL);
}
