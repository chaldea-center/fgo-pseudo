        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA840 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_17666/*"classBoard/releaseLock"*/, v4, v5, v6);
    byte_42EA840 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_17666/*"classBoard/releaseLock"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(123, responseList, 0LL);
  if ( v12
