        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B06FB & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17572/*"classBoard/releaseLock"*/);
    byte_42B06FB = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17572/*"classBoard/releaseLock"*/, 0LL);
}
