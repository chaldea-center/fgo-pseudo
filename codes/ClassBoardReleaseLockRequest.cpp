        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDB30 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_17919/*"classBoard/releaseLock"*/, v2);
    byte_49FDB30 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_17919/*"classBoard/releaseLock"*/, 0LL);
}
