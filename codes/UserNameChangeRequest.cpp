void UserNameChangeRequest___ctor(UserNameChangeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7F3E & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_9133/*"MockChangeUserNameResponse"*/);
    byte_4CB7F3E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB7F3C & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_19824/*"genderType"*/);
    byte_4CB7F3C = 1;
  }
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19824/*"genderType"*/, genderType, v9);
  RequestBase__addField_44471996((RequestBase_o *)this, (System_String_o *)StringLiteral_21625/*"message"*/, message, v10);
...
System_String_o *UserNameChangeRequest__getURL(UserNameChangeRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&NetworkManager_TypeInfo);
    sub_1C6BA08(&StringLiteral_22882/*"profile/editName"*/);
    byte_4CB7F3A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_22882/*"profile/editName"*/, 0);
}
