void __fastcall UserNameChangeRequest___ctor(UserNameChangeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AEFC0 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_9218/*"MockChangeUserNameResponse"*/);
    byte_42AEFC0 = 1;
  }
  v9 = (System_Int32_array **)StringLiteral_9218/*"MockChangeUserNameResponse"*/;
  this->fields.resMsg = (struct System_String_o *)StringLiteral_9218/*"MockChangeUserNameResponse"*/;
        ...
        const MethodInfo *method)
{
  if ( (byte_42AEFBE & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_19107/*"genderType"*/);
    byte_42AEFBE = 1;
  }
  RequestBase__addField_32020920((RequestBase_o *)this, (System_String_o *)StringLiteral_21171/*"name"*/, name, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19107/*"genderType"*/, genderType, 0LL);
  RequestBase__addField_32020920((RequestBase_o *)this, (System_String_o *)StringLiteral_20628/*"message"*/, message, 0LL);
...
System_String_o *__fastcall UserNameChangeRequest__getURL(UserNameChangeRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&NetworkManager_TypeInfo);
    sub_B52984(&StringLiteral_21722/*"profile/editName"*/);
    byte_42AEFBC = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_21722/*"profile/editName"*/, 0LL);
}
