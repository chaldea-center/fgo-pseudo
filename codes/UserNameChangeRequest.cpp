void __fastcall UserNameChangeRequest___ctor(UserNameChangeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A004A1 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_9066/*"MockChangeUserNameResponse"*/, method);
    byte_4A004A1 = 1;
  }
  v5 = StringLiteral_9066/*"MockChangeUserNameResponse"*/;
  this->fields.resMsg = (struct System_String_o *)StringLiteral_9066/*"MockChangeUserNameResponse"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0049F & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_21898/*"name"*/, name);
    sub_1B64A00(&StringLiteral_21316/*"message"*/, v9);
    sub_1B64A00(&StringLiteral_19638/*"genderType"*/, v10);
    byte_4A0049F = 1;
  }
  ...
  RequestBase__addField_40856580((RequestBase_o *)this, (System_String_o *)StringLiteral_21316/*"message"*/, message, v12);
...
System_String_o *__fastcall UserNameChangeRequest__getURL(UserNameChangeRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&NetworkManager_TypeInfo, method);
    sub_1B64A00(&StringLiteral_22526/*"profile/editName"*/, v2);
    byte_4A0049D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_22526/*"profile/editName"*/, 0LL);
}
