void __fastcall DataAsset___ctor(DataAsset_o *this, System_Byte_array *bytes, const MethodInfo *method)
{
  ...
  if ( (byte_4BC6CAE & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, bytes);
    byte_4BC6CAE = 1;
  }
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.byteData, (int64_t)bytes, v5, v6, v7, v8, v9, v10);
}


void __fastcall DataAsset___ctor_39113332(DataAsset_o *this, System_String_o *text, const MethodInfo *method)
{
  int64_t v5; // x2
  int32_t v6; // w3
  System_String_o *v7; // x4
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.textData, (int64_t)text, v5, v6, v7, v8, v9, v10);
}
