void DataAsset___ctor(DataAsset_o *this, System_Byte_array *bytes, const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.byteData, (int32_t)bytes, v5, v6, v7, v8, v9, v10);
}


void DataAsset___ctor_47598448(DataAsset_o *this, System_String_o *text, const MethodInfo *method)
{
  System_String_o *v5; // x2
  System_String_o *v6; // x3
  int32_t v7; // w4
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.textData, (int32_t)text, v5, v6, v7, v8, v9, v10);
}
