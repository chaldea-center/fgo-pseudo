void DataAsset___ctor(DataAsset_o *this, System_Byte_array *bytes, const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.byteData, (int32_t)bytes, v5, v6, v7, v8, v9, v10);
}


void DataAsset___ctor_41384868(DataAsset_o *this, System_String_o *text, const MethodInfo *method)
{
  int32_t v5; // w2
  int32_t v6; // w3
  System_String_o *v7; // x4
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.textData, (int32_t)text, v5, v6, v7, v8, v9, v10);
}
