void __fastcall DataAsset___ctor(DataAsset_o *this, System_Byte_array *bytes, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B695 & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, bytes);
    byte_4B1B695 = 1;
  }
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.byteData, (int32_t)bytes, v5, v6);
}


void __fastcall DataAsset___ctor_39854604(DataAsset_o *this, System_String_o *text, const MethodInfo *method)
{
  int32_t v5; // w2
  const MethodInfo *v6; // x3
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.textData, (int32_t)text, v5, v6);
}
