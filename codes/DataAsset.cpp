void __fastcall DataAsset___ctor(DataAsset_o *this, System_Byte_array *bytes, const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED19 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, bytes);
    byte_4A1ED19 = 1;
  }
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.byteData, (int32_t)bytes, v5, v6);
}


void __fastcall DataAsset___ctor_37708976(DataAsset_o *this, System_String_o *text, const MethodInfo *method)
{
  int32_t v5; // w2
  int32_t v6; // w3
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.textData, (int32_t)text, v5, v6);
}
