...
void EventInfoTipsArchiveListViewObject__Awake(EventInfoTipsArchiveListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C39833 & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_EventInfoTipsArchiveListViewItemDraw___);
    byte_4C39833 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_EventInfoTipsArchiveListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( !((unsigned __int8)byte_4C313D1 | hasValue) )
  {
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v14, v15);
  v19 = 1;
        ...
        const MethodInfo *method)
{
  ...
  v6 = isLast;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mainInfo, (int32_t)item, (int32_t)item, (const MethodInfo *)isLast);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.viewManager, (int32_t)manager, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( itemDraw )
  {
    ...
    if ( !newIcon )
      sub_1C32E7C(0);
    ShiningIconComponent__Set_40922520(newIcon, isDisp, 0);
  }
}
