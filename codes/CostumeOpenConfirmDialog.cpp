        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB11C3 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CostumeOpenConfirmDialog_OnClickCloseButton__, v3);
    sub_1C13D24(&Method_CostumeOpenConfirmDialog__OnClickCloseButton_b__11_0__, v4);
    byte_4BB11C3 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CostumeOpenConfirmDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C13D3C(Method_CostumeOpenConfirmDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.closeAction, (int64_t)closeAction, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB11C2 & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, userSvtColEntity);
    sub_1C13D24(&StringLiteral_3944/*"COSTUME_EXE_MSG"*/, v9);
    sub_1C13D24(&StringLiteral_3946/*"COSTUME_NEED_QP_TEXT"*/, v10);
    sub_1C13D24(&StringLiteral_1/*""*/, v11);
    sub_1C13D24(&StringLiteral_3945/*"COSTUME_HAVE_QP_TEXT"*/, v12);
    byte_4BB11C2 = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  transform = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_3945/*"COSTUME_HAVE_QP_TEXT"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_27;
  UILabel__set_text(titleLabel, (System_String_o *)transform, 0LL);
  message = this->fields.message;
  transform = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_3944/*"COSTUME_EXE_MSG"*/, 0LL);
  if ( !svtCostumeEntity )
    goto LABEL_27;
  transform = (__int64)System_String__Format_62982316(
  ...
  if ( (transform & 1) == 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3946/*"COSTUME_NEED_QP_TEXT"*/, 0LL);
