...
void CostumeOpenConfirmDialog__OnClickCloseButton(CostumeOpenConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3F88C & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_CostumeOpenConfirmDialog_OnClickCloseButton__);
    sub_1C37058(&Method_CostumeOpenConfirmDialog__OnClickCloseButton_b__15_0__);
    byte_4C3F88C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CostumeOpenConfirmDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C37070(Method_CostumeOpenConfirmDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F88B & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_3850/*"COSTUME_OPEN_MSG"*/);
    sub_1C37058(&StringLiteral_3853/*"COSTUME_OPEN_WARNING_{0}_{1}"*/);
    sub_1C37058(&StringLiteral_3852/*"COSTUME_OPEN_WARNING"*/);
    sub_1C37058(&StringLiteral_1/*""*/);
    sub_1C37058(&StringLiteral_3851/*"COSTUME_OPEN_TITLE"*/);
    byte_4C3F88B = 1;
  }
  ...
  description = System_String__Format_63602948(
                  v18,
  ...
  if ( ServantCostumeEntity__checkFlag(svtCostumeEntity, 128, 0) )
  {
    ...
    if ( description )
    {
      ...
      if ( description )
      {
        ...
        if ( !byte_4C3C929 )
        {
          description = (System_String_o *)sub_1C37058(&UnityEngine_Vector3_TypeInfo);
          byte_4C3C929 = 1;
        }
        if ( v19 )
        {
...
LABEL_43:
    sub_1C372B4(description);
  }
  v23 = sub_1C37100(string___TypeInfo, 2);
  ...
  description = System_String__Format_63602948((System_String_o *)StringLiteral_3853/*"COSTUME_OPEN_WARNING_{0}_{1}"*/, v30, v37, 0);
  if ( !v23 )
    goto LABEL_43;
  if ( !*(_DWORD *)(v23 + 24)
    || (*(_QWORD *)(v23 + 32) = description,
        sub_1C36FFC((CGThumbnailListItem_o *)(v23 + 32), (int32_t)description, v38, v39),
        *(_DWORD *)(v23 + 24) <= 1u) )
  {
    sub_1C372BC(description);
  }
  v42 = StringLiteral_3852/*"COSTUME_OPEN_WARNING"*/;
  *(_QWORD *)(v23 + 40) = StringLiteral_3852/*"COSTUME_OPEN_WARNING"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)(v23 + 40), v42, v40, v41);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
...
LABEL_39:
  ...
  if ( !v47 )
    goto LABEL_43;
  ServantFaceIconComponent__Set_41008764(v47, userSvtColEntity, svtCostumeEntity, 0, 0, 0, 0);
