        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B636AC & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CostumeOpenConfirmDialog_OnClickCloseButton__, v3);
    sub_1BE4ACC(&Method_CostumeOpenConfirmDialog__OnClickCloseButton_b__11_0__, v4);
    byte_4B636AC = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CostumeOpenConfirmDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BE4AE4(Method_CostumeOpenConfirmDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.closeAction, (int64_t)closeAction, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B636AB & 1) == 0 )
  {
    sub_1BE4ACC(&LocalizationManager_TypeInfo, userSvtColEntity);
    sub_1BE4ACC(&StringLiteral_3941/*"COSTUME_OPEN_MSG"*/, v9);
    sub_1BE4ACC(&StringLiteral_3943/*"COSTUME_OPEN_WARNING"*/, v10);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v11);
    sub_1BE4ACC(&StringLiteral_3942/*"COSTUME_OPEN_TITLE"*/, v12);
    byte_4B636AB = 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  transform = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_3942/*"COSTUME_OPEN_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_27;
  UILabel__set_text(titleLabel, (System_String_o *)transform, 0LL);
  message = this->fields.message;
  transform = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_3941/*"COSTUME_OPEN_MSG"*/, 0LL);
  if ( !svtCostumeEntity )
    goto LABEL_27;
  transform = (__int64)System_String__Format_62713180(
  ...
  if ( (transform & 1) == 0 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_3943/*"COSTUME_OPEN_WARNING"*/, 0LL);
