...
void __fastcall EffectSystemBehaviour__Awake(EffectSystemBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A59F40 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_UnityEngine_GameObject_AddComponent_EffectRenderBehaviour___);
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_EffectRenderBehaviour___);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    v6 = UnityEngine_GameObject__GetComponent_object_(
           ...
           (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_EffectRenderBehaviour___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v6, 0LL, 0LL) )
    {
      ...
      UnityEngine_GameObject__AddComponent_object_(
        (UnityEngine_GameObject_o *)gameObject,
        (const MethodInfo_2ECEDD0 *)Method_UnityEngine_GameObject_AddComponent_EffectRenderBehaviour___);
    }
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
