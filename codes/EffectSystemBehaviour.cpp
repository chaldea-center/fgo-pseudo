...
void EffectSystemBehaviour__Awake(EffectSystemBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC614D & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_UnityEngine_GameObject_AddComponent_EffectRenderBehaviour___);
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_EffectRenderBehaviour___);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0, 0) )
  {
    ...
    v6 = UnityEngine_GameObject__GetComponent_object_(
           ...
           (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_EffectRenderBehaviour___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v6, 0, 0) )
    {
      ...
      UnityEngine_GameObject__AddComponent_object_(
        (UnityEngine_GameObject_o *)gameObject,
        (const MethodInfo_31A2DE8 *)Method_UnityEngine_GameObject_AddComponent_EffectRenderBehaviour___);
    }
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
