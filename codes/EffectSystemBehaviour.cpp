...
void __fastcall EffectSystemBehaviour__Awake(EffectSystemBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFC59F & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_UnityEngine_GameObject_AddComponent_EffectRenderBehaviour___, v3);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_EffectRenderBehaviour___, v4);
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponentsInChildren_ParticleSystem___, v5);
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)Component_object, 0LL, 0LL) )
  {
    ...
    v10 = UnityEngine_GameObject__GetComponent_object_(
            ...
            (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_EffectRenderBehaviour___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v10, 0LL, 0LL) )
    {
      ...
      UnityEngine_GameObject__AddComponent_object_(
        (UnityEngine_GameObject_o *)gameObject,
        (const MethodInfo_3022A24 *)Method_UnityEngine_GameObject_AddComponent_EffectRenderBehaviour___);
    }
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
