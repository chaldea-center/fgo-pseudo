        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C1 & 1) == 0 )
  {
    sub_1C3B764(&BalanceConfig_TypeInfo, data1);
    sub_1C3B764(&System_Collections_Generic_IReadOnlyList_RecommendSupportData_RecommendDeckData__TypeInfo, v8);
...
LABEL_31:
  ...
  *diffDeckDataIndex = v30;
  sub_1C3B708((PartyOrganizationUtility_o *)diffDeckDataIndex, (int64_t)v30, v31, v32, v33, v34, v35, v36);
...
LABEL_15:
      sub_1C3B9C8(v7, data1);
    v7 = (BalanceConfig_c *)data1->m_Items[v8];
    if ( !v7 )
LABEL_14:
      sub_1C3B9C0(v7, data1);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0B9 & 1) == 0 )
  {
    ...
    sub_1C3B764(&RecommendSupportData_TypeInfo, v4);
    sub_1C3B764(&Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__, v5);
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v6);
    sub_1C3B764(&StringLiteral_11269/*"SERIALNUMBER"*/, v7);
    sub_1C3B764(&StringLiteral_19971/*"img_fp"*/, v8);
    byte_4C1E0B9 = 1;
  }
  ...
  titleInfoControl = LocalizationManager__Get((System_String_o *)StringLiteral_11269/*"SERIALNUMBER"*/, 0LL);
  if ( !infoMessageLabel )
    goto LABEL_15;
  ...
  AtlasManager__SetPartyOrganizationImage(symbolSprite, (System_String_o *)StringLiteral_19971/*"img_fp"*/, 0LL);
  v12 = (RecommendSupportData_o *)sub_1C3B9B0(RecommendSupportData_TypeInfo);
  RecommendSupportData___ctor(v12, 0LL);
  this->fields.orgData = v12;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.orgData, (int64_t)v12, v13, v14, v15, v16, v17, v18);
  orgData = this->fields.orgData;
  titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !titleInfoControl
    || !orgData
    ...
    || (RecommendSupportListViewManager__CreateList(
        ...
        (titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__)) == 0LL) )
  {
LABEL_15:
    sub_1C3B9C0(titleInfoControl, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C0 & 1) == 0 )
  {
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, changedDeckData);
    byte_4C1E0C0 = 1;
  }
  ...
  if ( !v17 )
  {
    *changedDeckData = name;
    sub_1C3B708((PartyOrganizationUtility_o *)changedDeckData, (int64_t)name, v11, v12, v13, v14, v15, v16);
...
LABEL_12:
  ...
  *changedDeckData = 0LL;
  sub_1C3B708((PartyOrganizationUtility_o *)changedDeckData, 0LL, v11, v12, v13, v14, v15, v16);
  return !v17;
}
        ...
        const MethodInfo *method)
{
  ...
  Instance = (RecommendSupportSelectListViewMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance
    ...
    || (v5 = *(System_Collections_Generic_IReadOnlyList_RecommendSupportData_RecommendDeckData__o **)&symbolSprite->fields.m_CachedPtr,
        (Instance = (RecommendSupportSelectListViewMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C4 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___, v3);
    sub_1C3B764(&Method_RecommendSupportSelectListViewMenu_OnClickBack__, v4);
    sub_1C3B764(&Method_RecommendSupportSelectListViewMenu__OnClickBack_b__26_0__, v5);
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v6);
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickBack__ + 83) & 2) != 0 )
    v8 = (_QWORD *)sub_1C3B77C(Method_RecommendSupportSelectListViewMenu_OnClickBack__);
  ...
  {
    v12 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    v13 = (RecommendSupportSelectControl_DialogResultCallBack_o *)sub_1C3B9B0(RecommendSupportSelectControl_DialogResultCallBack_TypeInfo);
    ...
    if ( Instance && v12 )
    {
      RecommendSupportSelectControl__OpenDialog_object_(
        ...
        (const MethodInfo_308404C *)Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___);
      return;
    }
LABEL_13:
  ...
  if ( !Instance )
    goto LABEL_13;
  RecommendSupportSelectControl__ReturnScene(Instance, (System_String_o *)StringLiteral_22683/*"sandboxSeurity"*/, v15);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C6 & 1) == 0 )
  {
    sub_1C3B764(&RecommendSupportSelectControl_DialogResultCallBack_TypeInfo, method);
    sub_1C3B764(&Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___, v3);
    sub_1C3B764(&Method_RecommendSupportSelectListViewMenu_OnClickCancel__, v4);
    sub_1C3B764(&Method_RecommendSupportSelectListViewMenu__OnClickCancel_b__28_0__, v5);
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v6);
    byte_4C1E0C6 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  ...
  if ( BYTE4(Instance[7].monitor) )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickCancel__ + 83) & 2) != 0 )
      v9 = (_QWORD *)sub_1C3B77C(Method_RecommendSupportSelectListViewMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C5 & 1) == 0 )
  {
    sub_1C3B764(&Method_RecommendSupportSelectListViewMenu_OnClickDecide__, method);
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v3);
    sub_1C3B764(&StringLiteral_22683/*"sandboxSeurity"*/, v4);
    byte_4C1E0C5 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickDecide__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C3B77C(Method_RecommendSupportSelectListViewMenu_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C7 & 1) == 0 )
  {
    sub_1C3B764(&Method_RecommendSupportSelectListViewMenu_OnClickHelp__, method);
    byte_4C1E0C7 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1C3B77C(Method_RecommendSupportSelectListViewMenu_OnClickHelp__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !titleInfoControl
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)titleInfoControl, 1, 0LL),
        ...
        (titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL) )
  {
LABEL_10:
    sub_1C3B9C0(titleInfoControl, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0BB & 1) == 0 )
  {
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, *(_QWORD *)&index);
    byte_4C1E0BB = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, 1, 0LL),
        (gameObject = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0BC & 1) == 0 )
  {
    sub_1C3B764(&Method_NetworkManager_getRequest_FollowerRecommendSupportSetupRequest___, method);
    ...
    sub_1C3B764(&Method_RecommendSupportSelectListViewMenu___c__RequestApi_b__18_0__, v7);
    sub_1C3B764(&RecommendSupportSelectListViewMenu___c_TypeInfo, v8);
    byte_4C1E0BC = 1;
  }
  changedDeckData = 0LL;
  if ( RecommendSupportSelectListViewMenu__IsFinallyUpdate(this, &changedDeckData, v2) )
  {
    ...
    if ( !_9__18_0 )
    {
      ...
      _9__18_0 = (NetworkManager_ResultCallbackFunc_o *)sub_1C3B9B0(NetworkManager_ResultCallbackFunc_TypeInfo);
    ...
    Instance = NetworkManager__getRequest_object_(
                 _9__18_0,
                 (const MethodInfo_3075AE8 *)Method_NetworkManager_getRequest_FollowerRecommendSupportSetupRequest___);
    if ( !Instance )
LABEL_16:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C3 & 1) == 0 )
  {
    sub_1C3B764(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, editOn);
    byte_4C1E0C3 = 1;
  }
  Instance = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  if ( !Instance
    || (v8 = UnityEngine_Component__get_gameObject(Instance, 0LL),
        (Instance = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL)
    || !v8
        ...
        const MethodInfo *method)
{
  ...
  if ( !helpButton
    ...
    || (helpButton = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(helpButton, 0LL)) == 0LL )
  {
    sub_1C3B9C0(helpButton, isEditing);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)helpButton, isEditing, 0LL);
}
...
void __fastcall RecommendSupportSelectListViewMenu___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C1E0C9 & 1) == 0 )
  {
    sub_1C3B764(&RecommendSupportSelectListViewMenu___c_TypeInfo, v1);
    byte_4C1E0C9 = 1;
  }
  v2 = (Il2CppObject *)sub_1C3B9B0(RecommendSupportSelectListViewMenu___c_TypeInfo);
