        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57446 & 1) == 0 )
  {
    ...
    sub_1B885B0(&System_Collections_Generic_IReadOnlyList_RecommendSupportData_RecommendDeckData__TypeInfo);
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( !data1 )
      goto LABEL_31;
    klass = data1->klass;
    v13 = *(unsigned __int16 *)(&data1->klass->_2.bitflags2 + 3);
...
LABEL_12:
    ...
    v11 = (BalanceConfig_c *)(*(__int64 (__fastcall **)(System_Collections_Generic_IReadOnlyList_RecommendSupportData_RecommendDeckData__o *, _QWORD, _QWORD))p_method)(
                               data1,
                               i,
                               *(_QWORD *)(p_method + 8));
    if ( !data2 )
    ...
    v18 = *(unsigned __int16 *)(&data2->klass->_2.bitflags2 + 3);
...
LABEL_31:
  ...
  *diffDeckDataIndex = v24;
  sub_1B88554((ServantStatusBattleListViewItem_o *)diffDeckDataIndex, (int32_t)v24, v25, v26);
...
LABEL_15:
      sub_1B88814(v7, data1);
    v7 = (BalanceConfig_c *)data1->m_Items[v8];
    if ( !v7 )
LABEL_14:
      sub_1B8880C(v7, data1);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5743E & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_11040/*"RECOMMEND_SUPPORT_SERVANT_SELECT_EXPLANATION"*/);
    sub_1B885B0(&StringLiteral_19583/*"formation_symbol"*/);
    byte_4A5743E = 1;
  }
  ...
  titleInfoControl = LocalizationManager__Get((System_String_o *)StringLiteral_11040/*"RECOMMEND_SUPPORT_SERVANT_SELECT_EXPLANATION"*/, 0LL);
  if ( !infoMessageLabel )
    goto LABEL_15;
  ...
  AtlasManager__SetPartyOrganizationImage(symbolSprite, (System_String_o *)StringLiteral_19583/*"formation_symbol"*/, 0LL);
  v6 = (RecommendSupportData_o *)sub_1B887FC(RecommendSupportData_TypeInfo);
  RecommendSupportData___ctor(v6, 0LL);
  this->fields.orgData = v6;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.orgData, (int32_t)v6, v7, v8);
  orgData = this->fields.orgData;
  titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !titleInfoControl
    || !orgData
    ...
    || (RecommendSupportListViewManager__CreateList(
        ...
        (titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__)) == 0LL) )
  {
LABEL_15:
    sub_1B8880C(titleInfoControl, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !v13 )
  {
    *changedDeckData = name;
    sub_1B88554((ServantStatusBattleListViewItem_o *)changedDeckData, (int32_t)name, v11, v12);
...
LABEL_12:
  ...
  *changedDeckData = 0LL;
  sub_1B88554((ServantStatusBattleListViewItem_o *)changedDeckData, 0, v11, v12);
  return !v13;
}
        ...
        const MethodInfo *method)
{
  ...
  Instance = (RecommendSupportSelectListViewMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance
    ...
    || (v5 = *(System_Collections_Generic_IReadOnlyList_RecommendSupportData_RecommendDeckData__o **)&symbolSprite->fields.m_CachedPtr,
        (Instance = (RecommendSupportSelectListViewMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57449 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___);
    sub_1B885B0(&Method_RecommendSupportSelectListViewMenu_OnClickBack__);
    sub_1B885B0(&Method_RecommendSupportSelectListViewMenu__OnClickBack_b__26_0__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_RecommendSupportSelectListViewMenu_OnClickBack__);
  ...
  {
    v7 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    v8 = (RecommendSupportSelectControl_DialogResultCallBack_o *)sub_1B887FC(RecommendSupportSelectControl_DialogResultCallBack_TypeInfo);
    ...
    if ( Instance && v7 )
    {
      RecommendSupportSelectControl__OpenDialog_object_(
        ...
        (const MethodInfo_2F10AF0 *)Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___);
      return;
    }
LABEL_13:
    sub_1B8880C(Instance, v6);
  ...
  if ( !Instance )
    goto LABEL_13;
  RecommendSupportSelectControl__ReturnScene(Instance, (System_String_o *)StringLiteral_22225/*"ok"*/, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5744B & 1) == 0 )
  {
    sub_1B885B0(&RecommendSupportSelectControl_DialogResultCallBack_TypeInfo);
    sub_1B885B0(&Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___);
    sub_1B885B0(&Method_RecommendSupportSelectListViewMenu_OnClickCancel__);
    sub_1B885B0(&Method_RecommendSupportSelectListViewMenu__OnClickCancel_b__28_0__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    byte_4A5744B = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  ...
  if ( BYTE4(Instance[7].monitor) )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickCancel__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B885C8(Method_RecommendSupportSelectListViewMenu_OnClickCancel__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
    OverwriteAssetSoundName__PlaySystemSe(v6, 1, 0LL);
    if ( RecommendSupportSelectListViewMenu__IsUpdate(this, v7) )
    {
      v8 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
      v9 = (RecommendSupportSelectControl_DialogResultCallBack_o *)sub_1B887FC(RecommendSupportSelectControl_DialogResultCallBack_TypeInfo);
      RecommendSupportSelectControl_DialogResultCallBack___ctor(
        v9,
        (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5744A & 1) == 0 )
  {
    sub_1B885B0(&Method_RecommendSupportSelectListViewMenu_OnClickDecide__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    sub_1B885B0(&StringLiteral_22225/*"ok"*/);
    byte_4A5744A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickDecide__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_RecommendSupportSelectListViewMenu_OnClickDecide__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5744C & 1) == 0 )
  {
    sub_1B885B0(&Method_RecommendSupportSelectListViewMenu_OnClickHelp__);
    byte_4A5744C = 1;
  }
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1B885C8(Method_RecommendSupportSelectListViewMenu_OnClickHelp__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !titleInfoControl
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)titleInfoControl, 1, 0LL),
        ...
        (titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL) )
  {
LABEL_10:
    sub_1B8880C(titleInfoControl, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, 1, 0LL),
        (gameObject = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57441 & 1) == 0 )
  {
    sub_1B885B0(&Method_NetworkManager_getRequest_FollowerRecommendSupportSetupRequest___);
    sub_1B885B0(&NetworkManager_TypeInfo);
    sub_1B885B0(&NetworkManager_ResultCallbackFunc_TypeInfo);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1B885B0(&Method_RecommendSupportSelectListViewMenu___c__RequestApi_b__18_0__);
    sub_1B885B0(&RecommendSupportSelectListViewMenu___c_TypeInfo);
    byte_4A57441 = 1;
  }
  changedDeckData = 0LL;
  if ( RecommendSupportSelectListViewMenu__IsFinallyUpdate(this, &changedDeckData, v2) )
  {
    ...
    if ( !_9__18_0 )
    {
      ...
      _9__18_0 = (NetworkManager_ResultCallbackFunc_o *)sub_1B887FC(NetworkManager_ResultCallbackFunc_TypeInfo);
      ...
      sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->__9__18_0, (int32_t)_9__18_0, v10, v11);
    }
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    Instance = NetworkManager__getRequest_object_(
                 _9__18_0,
                 (const MethodInfo_2F019D8 *)Method_NetworkManager_getRequest_FollowerRecommendSupportSetupRequest___);
    if ( !Instance )
LABEL_16:
        ...
        const MethodInfo *method)
{
  ...
  Instance = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  if ( !Instance
    || (v8 = UnityEngine_Component__get_gameObject(Instance, 0LL),
        (Instance = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0LL)
    || !v8
        ...
        const MethodInfo *method)
{
  ...
  if ( !helpButton
    ...
    || (helpButton = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(helpButton, 0LL)) == 0LL )
  {
    sub_1B8880C(helpButton, isEditing);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)helpButton, isEditing, 0LL);
}
...
void __fastcall RecommendSupportSelectListViewMenu___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(RecommendSupportSelectListViewMenu___c_TypeInfo);
