        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC32F8 & 1) == 0 )
  {
    ...
    sub_1C713B0(&System_Collections_Generic_IReadOnlyList_RecommendSupportData_RecommendDeckData__TypeInfo);
...
LABEL_31:
  ...
  *diffDeckDataIndex = v24;
  sub_1C71354((GrandQuestFolderBoardItem_o *)diffDeckDataIndex, (int32_t)v24, v25, v26, v27, v28, v29, v30);
...
void RecommendSupportSelectListViewMenu__Init(RecommendSupportSelectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC32F0 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_11068/*"RECOMMEND_SUPPORT_SERVANT_SELECT_EXPLANATION"*/);
    sub_1C713B0(&StringLiteral_19693/*"formation_symbol"*/);
    byte_4CC32F0 = 1;
  }
  ...
  titleInfoControl = LocalizationManager__Get((System_String_o *)StringLiteral_11068/*"RECOMMEND_SUPPORT_SERVANT_SELECT_EXPLANATION"*/, 0);
  if ( !infoMessageLabel )
    goto LABEL_15;
  ...
  AtlasManager__SetPartyOrganizationImage(symbolSprite, (System_String_o *)StringLiteral_19693/*"formation_symbol"*/, 0);
  v6 = (RecommendSupportData_o *)sub_1C715FC(RecommendSupportData_TypeInfo);
  RecommendSupportData___ctor(v6, 0);
  this->fields.orgData = v6;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.orgData, (int32_t)v6, v7, v8, v9, v10, v11, v12);
  orgData = this->fields.orgData;
  titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !titleInfoControl
    || !orgData
    ...
    || (RecommendSupportListViewManager__CreateList(
        ...
        (titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__)) == 0) )
  {
LABEL_15:
        ...
        const MethodInfo *method)
{
  ...
  if ( !v17 )
  {
    *changedDeckData = name;
    sub_1C71354((GrandQuestFolderBoardItem_o *)changedDeckData, (int32_t)name, v11, v12, v13, v14, v15, v16);
...
LABEL_12:
  ...
  *changedDeckData = 0;
  sub_1C71354((GrandQuestFolderBoardItem_o *)changedDeckData, 0, v11, v12, v13, v14, v15, v16);
  return !v17;
}
...
bool RecommendSupportSelectListViewMenu__IsUpdate(RecommendSupportSelectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  diffDeckDataIndex = 0;
  Instance = (RecommendSupportSelectListViewMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance
    ...
    || (m_CachedPtr = (System_Collections_Generic_IReadOnlyList_RecommendSupportData_RecommendDeckData__o *)symbolSprite->fields.m_CachedPtr,
        (Instance = (RecommendSupportSelectListViewMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC32FB & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___);
    sub_1C713B0(&Method_RecommendSupportSelectListViewMenu_OnClickBack__);
    sub_1C713B0(&Method_RecommendSupportSelectListViewMenu__OnClickBack_b__26_0__);
    sub_1C713B0(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_RecommendSupportSelectListViewMenu_OnClickBack__);
  ...
  {
    v7 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    v8 = (RecommendSupportSelectControl_DialogResultCallBack_o *)sub_1C715FC(RecommendSupportSelectControl_DialogResultCallBack_TypeInfo);
    ...
    if ( Instance && v7 )
    {
      RecommendSupportSelectControl__OpenDialog_object_(
        ...
        (const MethodInfo_31E59A8 *)Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___);
      return;
    }
LABEL_13:
    sub_1C71608(Instance, v6);
  ...
  if ( !Instance )
    goto LABEL_13;
  RecommendSupportSelectControl__ReturnScene(Instance, (System_String_o *)StringLiteral_22486/*"ok"*/, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC32FD & 1) == 0 )
  {
    sub_1C713B0(&RecommendSupportSelectControl_DialogResultCallBack_TypeInfo);
    sub_1C713B0(&Method_RecommendSupportSelectControl_OpenDialog_RecommendSupportCancelConfirmDialog___);
    sub_1C713B0(&Method_RecommendSupportSelectListViewMenu_OnClickCancel__);
    sub_1C713B0(&Method_RecommendSupportSelectListViewMenu__OnClickCancel_b__28_0__);
    sub_1C713B0(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    byte_4CC32FD = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  ...
  if ( BYTE4(Instance[7].monitor) )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickCancel__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1C713C8(Method_RecommendSupportSelectListViewMenu_OnClickCancel__);
    ...
    {
      v8 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
      v9 = (RecommendSupportSelectControl_DialogResultCallBack_o *)sub_1C715FC(RecommendSupportSelectControl_DialogResultCallBack_TypeInfo);
      RecommendSupportSelectControl_DialogResultCallBack___ctor(
        v9,
        (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC32FC & 1) == 0 )
  {
    sub_1C713B0(&Method_RecommendSupportSelectListViewMenu_OnClickDecide__);
    sub_1C713B0(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
    sub_1C713B0(&StringLiteral_22486/*"ok"*/);
    byte_4CC32FC = 1;
  }
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickDecide__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_RecommendSupportSelectListViewMenu_OnClickDecide__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC32FE & 1) == 0 )
  {
    sub_1C713B0(&Method_RecommendSupportSelectListViewMenu_OnClickHelp__);
    byte_4CC32FE = 1;
  }
  ...
  if ( (*((_BYTE *)Method_RecommendSupportSelectListViewMenu_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_1C713C8(Method_RecommendSupportSelectListViewMenu_OnClickHelp__);
...
void RecommendSupportSelectListViewMenu__Open(RecommendSupportSelectListViewMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !titleInfoControl
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)titleInfoControl, 1, 0),
        ...
        (titleInfoControl = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0) )
  {
LABEL_10:
    sub_1C71608(titleInfoControl, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)gameObject, 1, 0),
        (gameObject = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC32F3 & 1) == 0 )
  {
    sub_1C713B0(&Method_NetworkManager_getRequest_FollowerRecommendSupportSetupRequest___);
    sub_1C713B0(&NetworkManager_TypeInfo);
    sub_1C713B0(&NetworkManager_ResultCallbackFunc_TypeInfo);
    sub_1C713B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    sub_1C713B0(&Method_RecommendSupportSelectListViewMenu___c__RequestApi_b__18_0__);
    sub_1C713B0(&RecommendSupportSelectListViewMenu___c_TypeInfo);
    byte_4CC32F3 = 1;
  }
  changedDeckData = 0;
  if ( RecommendSupportSelectListViewMenu__IsFinallyUpdate(this, &changedDeckData, v2) )
  {
    ...
    if ( !_9__18_0 )
    {
      ...
      _9__18_0 = (NetworkManager_ResultCallbackFunc_o *)sub_1C715FC(NetworkManager_ResultCallbackFunc_TypeInfo);
    ...
    Instance = NetworkManager__getRequest_object_(
                 _9__18_0,
                 (const MethodInfo_31D69E8 *)Method_NetworkManager_getRequest_FollowerRecommendSupportSetupRequest___);
    if ( !Instance )
LABEL_16:
        ...
        const MethodInfo *method)
{
  ...
  Instance = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
  if ( !Instance )
    goto LABEL_17;
  ...
  if ( !Instance
    || (v8 = UnityEngine_Component__get_gameObject(Instance, 0),
        (Instance = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__)) == 0)
    || !v8
        ...
        const MethodInfo *method)
{
  ...
  if ( !helpButton
    ...
    || (helpButton = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(helpButton, 0)) == 0 )
  {
    sub_1C71608(helpButton, isEditing);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)helpButton, isEditing, 0);
}
...
void RecommendSupportSelectListViewMenu___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(RecommendSupportSelectListViewMenu___c_TypeInfo);
