void __fastcall NpcServantFollowerMaster___ctor(NpcServantFollowerMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A5B547 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataMasterBase_NpcServantFollowerMaster__NpcServantFollowerEntity__long___ctor__);
    byte_4A5B547 = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    96,
    (const MethodInfo_311DAA0 *)Method_DataMasterBase_NpcServantFollowerMaster__NpcServantFollowerEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  *npcServantFollowerEntity = 0LL;
  sub_1B88554((ServantStatusBattleListViewItem_o *)npcServantFollowerEntity, 0, questId, questPhase);
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_NpcFollowerMaster___);
  if ( !Master_object
...
LABEL_19:
  ...
  if ( max_length >= 1 )
  {
    ...
    *npcServantFollowerEntity = (NpcServantFollowerEntity_o *)entity;
    sub_1B88554((ServantStatusBattleListViewItem_o *)npcServantFollowerEntity, (int32_t)v11, v19, v20);
  }
  return v15;
}