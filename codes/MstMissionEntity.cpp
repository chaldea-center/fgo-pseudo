void __fastcall MstMissionEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1FE6E & 1) == 0 )
  {
    sub_1B715CC(&MstMissionEntity_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_8621/*"MISSION_ICON_DISPLAY_MS_GROUP_NORMAL"*/, v4);
    sub_1B715CC(&StringLiteral_8620/*"MISSION_ICON_DISPLAY_MS_GROUP_LIMITED"*/, v5);
    sub_1B715CC(&StringLiteral_21410/*"missionIconDetailText"*/, v6);
    sub_1B715CC(&StringLiteral_21411/*"missionIconDisplayMsGroup"*/, v7);
    byte_4A1FE6E = 1;
  }
  static_fields = MstMissionEntity_TypeInfo->static_fields;
  static_fields->MS_TO_SEC_DIVISOR = 1000.0;
  v9 = StringLiteral_8621/*"MISSION_ICON_DISPLAY_MS_GROUP_NORMAL"*/;
  static_fields->MISSION_ICON_DISPLAY_MS_GROUP_NORMAL = (struct System_String_o *)StringLiteral_8621/*"MISSION_ICON_DISPLAY_MS_GROUP_NORMAL"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->MISSION_ICON_DISPLAY_MS_GROUP_NORMAL, v9, v2, v3);
  v10 = StringLiteral_8620/*"MISSION_ICON_DISPLAY_MS_GROUP_LIMITED"*/;
  v11 = MstMissionEntity_TypeInfo->static_fields;
  v11->MISSION_ICON_DISPLAY_MS_GROUP_LIMITED = (struct System_String_o *)StringLiteral_8620/*"MISSION_ICON_DISPLAY_MS_GROUP_LIMITED"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v11->MISSION_ICON_DISPLAY_MS_GROUP_LIMITED, v10, v12, v13);
  v14 = StringLiteral_21410/*"missionIconDetailText"*/;
  v15 = MstMissionEntity_TypeInfo->static_fields;
  v15->SCRIPT_KEY_MISSION_ICON_DETAIL_TEXT = (struct System_String_o *)StringLiteral_21410/*"missionIconDetailText"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v15->SCRIPT_KEY_MISSION_ICON_DETAIL_TEXT, v14, v16, v17);
  v18 = StringLiteral_21411/*"missionIconDisplayMsGroup"*/;
  v19 = MstMissionEntity_TypeInfo->static_fields;
  v19->SCRIPT_KEY_MISSION_ICON_DISPLAY_MS_GROUP = (struct System_String_o *)StringLiteral_21411/*"missionIconDisplayMsGroup"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v19->SCRIPT_KEY_MISSION_ICON_DISPLAY_MS_GROUP, v18, v20, v21);
}
...
float __fastcall MstMissionEntity__GetMissionIconDisplaySec(MstMissionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1FE6C & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_Dictionary_string__int__TryGetValue__, v3);
    sub_1B715CC(&Method_System_Collections_Generic_Dictionary_string__int__get_Item__, v4);
    sub_1B715CC(&MstMissionEntity_TypeInfo, v5);
...
LABEL_21:
    sub_1B71828(IsNullOrWhiteSpace, v11);
  }
  if ( !MissionIconDisplayMsDictionary )
    goto LABEL_21;
  System_Collections_Generic_Dictionary_object__int___TryGetValue(
    ...
    &value,
    (const MethodInfo_31976B4 *)Method_System_Collections_Generic_Dictionary_string__int__TryGetValue__);
  Item = value;
LABEL_14:
  if ( Item <= 0 )
  {
...
int32_t __fastcall MstMissionEntity__getMissionType(MstMissionEntity_o *this, const MethodInfo *method)
{
  ...
  Instance = (EventMissionEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_11;
...
bool __fastcall MstMissionEntity__hasUnarchived(MstMissionEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_EventMissionMaster___, method);
    sub_1B715CC(&Method_DataManager_GetMasterData_UserEventMissionMaster___, v3);
  ...
  if ( !Instance
    ...
    || (MissionIdListByEvent = EventMissionMaster__getMissionIdListByEvent(
                                 ...
                                 this->fields.id,
                                 0LL),
        (Instance = (UserEventMissionEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (Instance = (UserEventMissionEntity_array *)DataManager__GetMasterData_object_(
                                                     (DataManager_o *)Instance,
