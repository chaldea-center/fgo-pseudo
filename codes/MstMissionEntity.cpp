void __fastcall MstMissionEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1CA15 & 1) == 0 )
  {
    sub_1BCAFF8(&MstMissionEntity_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_8611/*"MISSION_ICON_DISPLAY_MS_GROUP_NORMAL"*/, v4);
    sub_1BCAFF8(&StringLiteral_8610/*"MISSION_ICON_DISPLAY_MS_GROUP_LIMITED"*/, v5);
    sub_1BCAFF8(&StringLiteral_21411/*"missionIconDetailText"*/, v6);
    sub_1BCAFF8(&StringLiteral_21412/*"missionIconDisplayMsGroup"*/, v7);
    byte_4B1CA15 = 1;
  }
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->MISSION_ICON_DISPLAY_MS_GROUP_NORMAL, v9, v2, v3);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v11->MISSION_ICON_DISPLAY_MS_GROUP_LIMITED, v10, v12, v13);
  v14 = StringLiteral_21411/*"missionIconDetailText"*/;
  v15 = MstMissionEntity_TypeInfo->static_fields;
  v15->SCRIPT_KEY_MISSION_ICON_DETAIL_TEXT = (struct System_String_o *)StringLiteral_21411/*"missionIconDetailText"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v15->SCRIPT_KEY_MISSION_ICON_DETAIL_TEXT, v14, v16, v17);
  v18 = StringLiteral_21412/*"missionIconDisplayMsGroup"*/;
  v19 = MstMissionEntity_TypeInfo->static_fields;
  v19->SCRIPT_KEY_MISSION_ICON_DISPLAY_MS_GROUP = (struct System_String_o *)StringLiteral_21412/*"missionIconDisplayMsGroup"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v19->SCRIPT_KEY_MISSION_ICON_DISPLAY_MS_GROUP, v18, v20, v21);
}
...
float __fastcall MstMissionEntity__GetMissionIconDisplaySec(MstMissionEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1CA13 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__int__TryGetValue__, v3);
    sub_1BCAFF8(&Method_System_Collections_Generic_Dictionary_string__int__get_Item__, v4);
    sub_1BCAFF8(&MstMissionEntity_TypeInfo, v5);
...
LABEL_21:
    sub_1BCB254(IsNullOrWhiteSpace, v11);
  }
  if ( !MissionIconDisplayMsDictionary )
    goto LABEL_21;
...
bool __fastcall MstMissionEntity__hasUnarchived(MstMissionEntity_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventMissionMaster___, method);
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserEventMissionMaster___, v3);
  ...
  if ( !Instance
    ...
    || (MissionIdListByEvent = EventMissionMaster__getMissionIdListByEvent(
                                 ...
                                 this->fields.id,
                                 0LL),
        (Instance = (UserEventMissionEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__)) == 0LL)
    || (Instance = (UserEventMissionEntity_array *)DataManager__GetMasterData_object_(
                                                     (DataManager_o *)Instance,
