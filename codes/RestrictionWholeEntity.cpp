        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFDDCD & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_System_Linq_Enumerable_Contains_int___, v4);
    byte_4BFDDCD = 1;
  }
  ...
  v6 = (System_Boolean_array *)sub_1C2E1D4(bool___TypeInfo, (unsigned int)v5->static_fields->DeckMemberMax);
  for ( i = 0LL; ; ++i )
  {
