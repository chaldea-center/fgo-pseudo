        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2DBE & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_System_Linq_Enumerable_Contains_int___, v4);
    byte_48E2DBE = 1;
  }
  ...
  v6 = (System_Boolean_array *)sub_1B00D74(bool___TypeInfo, (unsigned int)v5->static_fields->DeckMemberMax);
  for ( i = 0LL; ; ++i )
  {
