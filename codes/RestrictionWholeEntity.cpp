        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09269 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_System_Linq_Enumerable_Contains_int___, v4);
    byte_4A09269 = 1;
  }
  ...
  v6 = (System_Boolean_array *)sub_1B6877C(bool___TypeInfo, (unsigned int)v5->static_fields->DeckMemberMax);
  for ( i = 0LL; ; ++i )
  {
