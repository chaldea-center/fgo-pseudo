        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B377D2 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_System_Linq_Enumerable_Contains_int___, v4);
    byte_4B377D2 = 1;
  }
  ...
  v6 = (System_Boolean_array *)sub_1BD3500(bool___TypeInfo, (unsigned int)v5->static_fields->DeckMemberMax);
  for ( i = 0LL; ; ++i )
  {
