        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF124 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_System_Linq_Enumerable_Contains_int___, v4);
    byte_49FF124 = 1;
  }
  ...
  v6 = (System_Boolean_array *)sub_1B64AA8(bool___TypeInfo, (unsigned int)v5->static_fields->DeckMemberMax);
  for ( i = 0LL; ; ++i )
  {
