        ...
        const MethodInfo *method)
{
  if ( (byte_4A700D7 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_23707/*"summonCategoryId"*/, *(_QWORD *)&defId);
    byte_4A700D7 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23707/*"summonCategoryId"*/, defId, 0LL);
}