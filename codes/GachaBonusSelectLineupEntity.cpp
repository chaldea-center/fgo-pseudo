        ...
        const MethodInfo *method)
{
  if ( (byte_4D2CBFB & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_24064/*"summonCategoryId"*/);
    byte_4D2CBFB = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24064/*"summonCategoryId"*/, defId, 0);
}