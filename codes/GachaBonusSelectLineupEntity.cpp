        ...
        const MethodInfo *method)
{
  if ( (byte_4B1C7B8 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_23616/*"summonCategoryId"*/, *(_QWORD *)&defId);
    byte_4B1C7B8 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23616/*"summonCategoryId"*/, defId, 0LL);
}