        ...
        const MethodInfo *method)
{
  if ( (byte_4BB4954 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_24059/*"subs"*/, *(_QWORD *)&defId);
    byte_4BB4954 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24059/*"subs"*/, defId, 0LL);
}