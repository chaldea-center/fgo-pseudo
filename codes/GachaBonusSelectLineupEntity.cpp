        ...
        const MethodInfo *method)
{
  if ( (byte_5970C0B & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_25098/*"summonCategoryId"*/);
    byte_5970C0B = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_25098/*"summonCategoryId"*/, defId, 0);
}