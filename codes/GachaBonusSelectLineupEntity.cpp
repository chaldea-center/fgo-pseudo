        ...
        const MethodInfo *method)
{
  if ( (byte_4E04DBE & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_24212/*"summonCategoryId"*/);
    byte_4E04DBE = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24212/*"summonCategoryId"*/, defId, 0);
}