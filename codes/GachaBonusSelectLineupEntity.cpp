        ...
        const MethodInfo *method)
{
  if ( (byte_4BDC7BB & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_24099/*"summonCategoryId"*/);
    byte_4BDC7BB = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24099/*"summonCategoryId"*/, defId, 0LL);
}