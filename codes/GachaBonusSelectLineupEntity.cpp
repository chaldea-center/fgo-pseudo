        ...
        const MethodInfo *method)
{
  if ( (byte_5938A58 & 1) == 0 )
  {
    sub_21FFC50(&StringLiteral_25050/*"summonCategoryId"*/);
    byte_5938A58 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_25050/*"summonCategoryId"*/, defId, 0);
}