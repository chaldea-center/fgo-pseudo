void __fastcall SpotMaster___ctor(SpotMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E3145 & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_SpotMaster__SpotEntity__int___ctor__, method);
    byte_48E3145 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    20,
    (const MethodInfo_2FE6A0C *)Method_DataMasterBase_SpotMaster__SpotEntity__int___ctor__);
}
...
SpotEntity_array *__fastcall SpotMaster__getList(SpotMaster_o *this, int32_t Map_id, const MethodInfo *method)
{
  ...
  if ( (byte_48E3146 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&Map_id);
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B00CCC(&Method_System_Collections_Generic_List_SpotEntity__Add__, v6);
    sub_1B00CCC(&Method_System_Collections_Generic_List_SpotEntity__ToArray__, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_SpotEntity___ctor__, v8);
    sub_1B00CCC(&System_Collections_Generic_List_SpotEntity__TypeInfo, v9);
    sub_1B00CCC(&SpotEntity_TypeInfo, v10);
    byte_48E3146 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_SpotEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_33C119C *)Method_System_Collections_Generic_List_SpotEntity___ctor__);
...
LABEL_20:
  ...
  return (SpotEntity_array *)System_Collections_Generic_List_object___ToArray(
                               v11,
                               (const MethodInfo_33C3528 *)Method_System_Collections_Generic_List_SpotEntity__ToArray__);
}