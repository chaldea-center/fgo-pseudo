        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields, (int32_t)svtInfoArray, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A42B & 1) == 0 )
  {
    sub_1C32C20(&Method_DataManager_GetMaster_WarBoardPartySkillMaster___);
    this = (WarBoardBattleServantEvent_o *)sub_1C32C20(&DataManager_TypeInfo);
    byte_4C3A42B = 1;
  }
...
LABEL_26:
  ...
  this = (WarBoardBattleServantEvent_o *)DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_WarBoardPartySkillMaster___);
  if ( !this )
LABEL_27:
    sub_1C32E7C(this);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A42A & 1) == 0 )
  {
    ...
    this = (WarBoardBattleServantEvent_o *)sub_1C32C20(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C3A42A = 1;
  }
  if ( !svtData )
    goto LABEL_13;
  ...
  if ( EventServantInfo->fields.squareEffectSkillId < 1 || EventServantInfo->fields.squareEffectSkillLv < 1 )
    return;
  this = (WarBoardBattleServantEvent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3A429 & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Array_Find_BattleWarBoardInfo_WarBoardServantInfo___);
    sub_1C32C20(&System_Predicate_BattleWarBoardInfo_WarBoardServantInfo__TypeInfo);
    sub_1C32C20(&Method_WarBoardBattleServantEvent___c__DisplayClass2_0__GetEventServantInfo_b__0__);
    sub_1C32C20(&WarBoardBattleServantEvent___c__DisplayClass2_0_TypeInfo);
    byte_4C3A429 = 1;
  }
  v5 = (Il2CppObject *)sub_1C32E6C(WarBoardBattleServantEvent___c__DisplayClass2_0_TypeInfo);
  ...
  if ( !svtInfoArray )
    return 0;
  v8 = (System_Predicate_object__o *)sub_1C32E6C(System_Predicate_BattleWarBoardInfo_WarBoardServantInfo__TypeInfo);
  ...
  return (BattleWarBoardInfo_WarBoardServantInfo_o *)System_Array__Find_object_(
                                                       ...
                                                       (const MethodInfo_31E22DC *)Method_System_Array_Find_BattleWarBoardInfo_WarBoardServantInfo___);
}
