        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)svtInfoArray, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F39B & 1) == 0 )
  {
    sub_1C94098(&Method_DataManager_GetMaster_WarBoardPartySkillMaster___);
    this = (WarBoardBattleServantEvent_o *)sub_1C94098(&DataManager_TypeInfo);
    byte_4D2F39B = 1;
  }
...
LABEL_26:
  ...
  this = (WarBoardBattleServantEvent_o *)DataManager__GetMaster_object_((const MethodInfo_319C0E0 *)Method_DataManager_GetMaster_WarBoardPartySkillMaster___);
  if ( !this )
LABEL_27:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F39A & 1) == 0 )
  {
    ...
    this = (WarBoardBattleServantEvent_o *)sub_1C94098(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4D2F39A = 1;
  }
  if ( !svtData )
    goto LABEL_13;
  ...
  if ( EventServantInfo->fields.squareEffectSkillId < 1 || EventServantInfo->fields.squareEffectSkillLv < 1 )
    return;
  this = (WarBoardBattleServantEvent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2F399 & 1) == 0 )
  {
    sub_1C94098(&Method_System_Array_Find_BattleWarBoardInfo_WarBoardServantInfo___);
    sub_1C94098(&System_Predicate_BattleWarBoardInfo_WarBoardServantInfo__TypeInfo);
    sub_1C94098(&Method_WarBoardBattleServantEvent___c__DisplayClass2_0__GetEventServantInfo_b__0__);
    sub_1C94098(&WarBoardBattleServantEvent___c__DisplayClass2_0_TypeInfo);
    byte_4D2F399 = 1;
  }
  v5 = (Il2CppObject *)sub_1C942E4(WarBoardBattleServantEvent___c__DisplayClass2_0_TypeInfo);
  ...
  if ( !svtInfoArray )
    return 0;
  v9 = (System_Predicate_object__o *)sub_1C942E4(System_Predicate_BattleWarBoardInfo_WarBoardServantInfo__TypeInfo);
  ...
  return (BattleWarBoardInfo_WarBoardServantInfo_o *)System_Array__Find_object_(
                                                       ...
                                                       (const MethodInfo_32A2954 *)Method_System_Array_Find_BattleWarBoardInfo_WarBoardServantInfo___);
}
