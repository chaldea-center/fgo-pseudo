        ...
        const MethodInfo *method)
{
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&this->fields, (int64_t)svtInfoArray, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B397A9 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_WarBoardPartySkillMaster___, svtData);
    this = (WarBoardBattleServantEvent_o *)sub_1BD3458(&DataManager_TypeInfo, v6);
    byte_4B397A9 = 1;
  }
...
LABEL_26:
  ...
  this = (WarBoardBattleServantEvent_o *)DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_WarBoardPartySkillMaster___);
  if ( !this )
LABEL_27:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B397A8 & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_SkillMaster___, svtData);
    sub_1BD3458(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v5);
    this = (WarBoardBattleServantEvent_o *)sub_1BD3458(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4B397A8 = 1;
  }
  if ( !svtData )
    goto LABEL_13;
  ...
  if ( EventServantInfo->fields.squareEffectSkillId < 1 || EventServantInfo->fields.squareEffectSkillLv < 1 )
    return;
  this = (WarBoardBattleServantEvent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B397A7 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Array_Find_BattleWarBoardInfo_WarBoardServantInfo___, userSvtId);
    sub_1BD3458(&System_Predicate_BattleWarBoardInfo_WarBoardServantInfo__TypeInfo, v5);
    sub_1BD3458(&Method_WarBoardBattleServantEvent___c__DisplayClass2_0__GetEventServantInfo_b__0__, v6);
    sub_1BD3458(&WarBoardBattleServantEvent___c__DisplayClass2_0_TypeInfo, v7);
    byte_4B397A7 = 1;
  }
  v8 = (Il2CppObject *)sub_1BD36A4(WarBoardBattleServantEvent___c__DisplayClass2_0_TypeInfo);
  ...
  if ( !svtInfoArray )
    return 0LL;
  v12 = (System_Predicate_object__o *)sub_1BD36A4(System_Predicate_BattleWarBoardInfo_WarBoardServantInfo__TypeInfo);
  ...
  return (BattleWarBoardInfo_WarBoardServantInfo_o *)System_Array__Find_object_(
                                                       ...
                                                       (const MethodInfo_302C080 *)Method_System_Array_Find_BattleWarBoardInfo_WarBoardServantInfo___);
}
