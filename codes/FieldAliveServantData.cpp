void __fastcall FieldAliveServantData___ctor(FieldAliveServantData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00952 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleServantData___ctor__, method);
    sub_1B64870(&System_Collections_Generic_List_BattleServantData__TypeInfo, v3);
    byte_4A00952 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_BattleServantData__TypeInfo);
  ...
  v7 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_BattleServantData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_BattleServantData___ctor__);
  this->fields.enemyIdList = (struct System_Collections_Generic_List_BattleServantData__o *)v7;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.enemyIdList, (int32_t)v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00951 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_BattleServantData__Add__, isEnemySide);
    byte_4A00951 = 1;
  }
  v7 = 16LL;
  if ( isEnemySide )
  ...
  else
  {
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)(v12 + 4), (int32_t)svtData, (int32_t)svtData, (int32_t)method);
  }
}
