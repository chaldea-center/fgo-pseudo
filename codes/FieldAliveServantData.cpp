void __fastcall FieldAliveServantData___ctor(FieldAliveServantData_o *this, const MethodInfo *method)
{
  ...
  v7 = (System_Collections_Generic_List_object__o *)sub_1B68920(System_Collections_Generic_List_BattleServantData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_34BBA44 *)Method_System_Collections_Generic_List_BattleServantData___ctor__);
  this->fields.enemyIdList = (struct System_Collections_Generic_List_BattleServantData__o *)v7;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.enemyIdList, (int32_t)v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0B0C7 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_List_BattleServantData__Add__, isEnemySide);
    byte_4A0B0C7 = 1;
  }
  v7 = 16LL;
  if ( isEnemySide )
  ...
  else
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)(v12 + 4), (int32_t)svtData, (int32_t)svtData, (int32_t)method);
  }
}
