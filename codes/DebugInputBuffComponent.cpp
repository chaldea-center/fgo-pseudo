void DebugInputBuffComponent___ctor(DebugInputBuffComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC89E7 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Collections_Generic_List_DebugInputSimpleSelectionElement___ctor__);
    sub_1C713B0(&System_Collections_Generic_List_DebugInputSimpleSelectionElement__TypeInfo);
    byte_4CC89E7 = 1;
  }
  v3 = (System_Collections_Generic_List_object__o *)sub_1C715FC(System_Collections_Generic_List_DebugInputSimpleSelectionElement__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v3,
    (const MethodInfo_380FEE4 *)Method_System_Collections_Generic_List_DebugInputSimpleSelectionElement___ctor__);
  this->fields.paramInputCellList = (struct System_Collections_Generic_List_DebugInputSimpleSelectionElement__o *)v3;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.paramInputCellList, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC89E4 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__getEntitys__);
  ...
  if ( System_Int32__TryParse(value, &result, 0) )
  {
    ...
    Instance = (DataManager_o *)DataMasterBase_object__object__int___getEntitys(
                                  ...
                                  (const MethodInfo_3408104 *)Method_DataMasterBase_SkillDetailMaster__SkillDetailEntity__int__getEntitys__);
    v11 = 0;
    if ( !entity )
      goto LABEL_15;
    if ( !DataMasterBase_object__object__int___TryGetEntity(
...
void DebugInputBuffComponent__OnSubmit(DebugInputBuffComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC89E6 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C713B0(&StringLiteral_25562/*"バフID[{0}]はマスターに存在しておりません"*/);
    sub_1C713B0(&StringLiteral_25598/*"存在しないバフIDです"*/);
    byte_4CC89E6 = 1;
  }
  entity = 0;
  ...
  BuffIdInput = (UIInput_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !BuffIdInput )
    goto LABEL_14;
  ...
  BuffIdInput = (UIInput_o *)System_String__Format((System_String_o *)StringLiteral_25562/*"バフID[{0}]はマスターに存在しておりません"*/, v8, 0);
  if ( !Instance )
LABEL_14:
    sub_1C71608(BuffIdInput, method);
  CommonUI__OpenErrorDialog(
    (CommonUI_o *)Instance,
    (System_String_o *)StringLiteral_25598/*"存在しないバフIDです"*/,
...
void DebugInputBuffComponent__OpenBuffSelect(DebugInputBuffComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC89DE & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DebugInputBuffComponent_TapBuffSelectCallback__);
    byte_4CC89DE = 1;
  }
  BuffSelect = this->fields.BuffSelect;
  v4 = (System_Action_T1__T2__T3__T4__o *)sub_1C715FC(System_Action_int__string__string__int__TypeInfo);
...
void DebugInputBuffComponent__OpenBuffTypeSelect(DebugInputBuffComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC89E0 & 1) == 0 )
  {
    sub_1C713B0(&System_Action_BuffList_TYPE__TypeInfo);
    sub_1C713B0(&Method_DebugInputBuffComponent_TapBuffTypeSelectCallback__);
    byte_4CC89E0 = 1;
  }
  BuffTypeSelect = this->fields.BuffTypeSelect;
  v4 = (System_Action_T__o *)sub_1C715FC(System_Action_BuffList_TYPE__TypeInfo);
...
void DebugInputBuffComponent__OpenSkillSelect(DebugInputBuffComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC89E5 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DebugInputBuffComponent_TapSkillSelectCallback__);
    byte_4CC89E5 = 1;
  }
  SkillSelect = this->fields.SkillSelect;
  v4 = (System_Action_T1__T2__T3__o *)sub_1C715FC(System_Action_int__string__string__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C71608(SelectBuffName, v12);
  }
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_7:
    sub_1C71608(SelectSkillName, v10);
  }
