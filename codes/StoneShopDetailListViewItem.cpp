        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6317A & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMaster_ItemMaster___, *(_QWORD *)&index);
    ...
    sub_1BE4ACC(&StringLiteral_12481/*"STONE_SHOP_EXTRA_ITEM_NUM"*/, v11);
    byte_4B6317A = 1;
  }
...
LABEL_17:
    ...
    v15 = LocalizationManager__Get((System_String_o *)StringLiteral_12481/*"STONE_SHOP_EXTRA_ITEM_NUM"*/, 0LL);
    v27 = num;
