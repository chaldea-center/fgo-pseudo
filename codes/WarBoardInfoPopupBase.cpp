...
LABEL_7:
  ...
  sub_1B88554(p_hideCompleteCallback, (int32_t)v10, v8, v9);
}
...
void __fastcall WarBoardInfoPopupBase__Hide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5913F & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_WarBoardInfoPopupBase__Hide_b__18_0__);
    byte_4A5913F = 1;
  }
  this->fields._isHideAnimating_k__BackingField = 1;
  v3 = (EventDelegate_Callback_o *)sub_1B887FC(EventDelegate_Callback_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  EventDelegate__Set_46771408(onFinished, finishCallback, 0LL);
}
...
LABEL_7:
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_hideCompleteCallback, 0, v7, v8);
...
void __fastcall WarBoardInfoPopupBase__OnAfterHide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( hideCompleteCallback )
  {
    ...
    sub_1B88554(p_hideCompleteCallback, 0, v8, v9);
  }
}
...
void __fastcall WarBoardInfoPopupBase__Show(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&EventDelegate_Callback_TypeInfo);
    sub_1B885B0(&Method_WarBoardInfoPopupBase__Show_b__17_0__);
    byte_4A5913E = 1;
  }
