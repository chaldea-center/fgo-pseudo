...
LABEL_7:
  ...
  sub_1C71354(p_hideCompleteCallback, (int32_t)v14, v8, v9, v10, v11, v12, v13);
}
...
void WarBoardInfoPopupBase__Hide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC509C & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_WarBoardInfoPopupBase__Hide_b__18_0__);
    byte_4CC509C = 1;
  }
  this->fields._isHideAnimating_k__BackingField = 1;
  v3 = (EventDelegate_Callback_o *)sub_1C715FC(EventDelegate_Callback_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  EventDelegate__Set_49625676(onFinished, finishCallback, 0);
}
...
LABEL_7:
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)p_hideCompleteCallback, 0, v7, v8, v9, v10, v11, v12);
...
void WarBoardInfoPopupBase__OnAfterHide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( hideCompleteCallback )
  {
    ...
    sub_1C71354(p_hideCompleteCallback, 0, v8, v9, v10, v11, v12, v13);
  }
}
...
void WarBoardInfoPopupBase__Show(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&EventDelegate_Callback_TypeInfo);
    sub_1C713B0(&Method_WarBoardInfoPopupBase__Show_b__17_0__);
    byte_4CC509B = 1;
  }
