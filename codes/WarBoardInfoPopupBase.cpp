void __fastcall WarBoardInfoPopupBase___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE47 & 1) == 0 )
  {
    sub_1B90010(&WarBoardInfoPopupBase_TypeInfo, v1);
    byte_4A6DE47 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE44 & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, completeCallback);
    byte_4A6DE44 = 1;
  }
...
LABEL_7:
  ...
  sub_1B8FFB4(p_hideCompleteCallback, (int32_t)v10, v8, v9);
}
...
void __fastcall WarBoardInfoPopupBase__Hide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE43 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_WarBoardInfoPopupBase__Hide_b__18_0__, v3);
    byte_4A6DE43 = 1;
  }
  this->fields._isHideAnimating_k__BackingField = 1;
  v4 = (EventDelegate_Callback_o *)sub_1B9025C(EventDelegate_Callback_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE46 & 1) == 0 )
  {
    sub_1B90010(&EventDelegate_TypeInfo, finishCallback);
    sub_1B90010(&WarBoardInfoPopupBase_TypeInfo, v5);
    byte_4A6DE46 = 1;
  }
  ...
  if ( !byte_4A6A9C1 )
  {
    sub_1B90010(&UnityEngine_Vector3_TypeInfo, finishCallback);
    byte_4A6A9C1 = 1;
  }
  ...
  EventDelegate__Set_46827984(onFinished, finishCallback, 0LL);
}
...
LABEL_7:
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)p_hideCompleteCallback, 0, v7, v8);
...
void __fastcall WarBoardInfoPopupBase__OnAfterHide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( hideCompleteCallback )
  {
    ...
    sub_1B8FFB4(p_hideCompleteCallback, 0, v8, v9);
  }
}
...
void __fastcall WarBoardInfoPopupBase__Show(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&EventDelegate_Callback_TypeInfo, method);
    sub_1B90010(&Method_WarBoardInfoPopupBase__Show_b__17_0__, v3);
    byte_4A6DE42 = 1;
  }
