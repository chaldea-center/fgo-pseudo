...
LABEL_7:
  ...
  sub_1C6B9AC(p_hideCompleteCallback, (int32_t)v10, v8, v9);
}
...
void WarBoardInfoPopupBase__Hide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB3F84 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_WarBoardInfoPopupBase__Hide_b__18_0__);
    byte_4CB3F84 = 1;
  }
  this->fields._isHideAnimating_k__BackingField = 1;
  v3 = (EventDelegate_Callback_o *)sub_1C6BC54(EventDelegate_Callback_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  EventDelegate__Set_49560744(onFinished, finishCallback, 0);
}
...
LABEL_7:
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)p_hideCompleteCallback, 0, v7, v8);
...
void WarBoardInfoPopupBase__OnAfterHide(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  if ( hideCompleteCallback )
  {
    ...
    sub_1C6B9AC(p_hideCompleteCallback, 0, v8, v9);
  }
}
...
void WarBoardInfoPopupBase__Show(WarBoardInfoPopupBase_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&EventDelegate_Callback_TypeInfo);
    sub_1C6BA08(&Method_WarBoardInfoPopupBase__Show_b__17_0__);
    byte_4CB3F83 = 1;
  }
