...
void ScriptStoryOpenDialog__Close(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptStoryOpenDialog__Close_44655312(this, 0, v2);
}


void ScriptStoryOpenDialog__Close_44655312(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29309 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptStoryOpenDialog_EndClose__);
    byte_4C29309 = 1;
  }
  ...
  System_Action___ctor(v6, (Il2CppObject *)this, Method_ScriptStoryOpenDialog_EndClose__, 0);
...
void ScriptStoryOpenDialog__OnClickClose(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2930A & 1) == 0 )
  {
    sub_1C2D490(&Method_ScriptStoryOpenDialog_OnClickClose__);
    byte_4C2930A = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptStoryOpenDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_ScriptStoryOpenDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29308 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_ScriptStoryOpenDialog_EndOpen__);
    sub_1C2D490(&StringLiteral_3678/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C2D490(&StringLiteral_12454/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/);
    byte_4C29308 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( closeButton )
    {
      ...
      closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3678/*"COMMON_CONFIRM_CLOSE"*/, 0);
      if ( closeLabel )
      {
        UILabel__set_text(closeLabel, (System_String_o *)closeButton, 0);
        infoLabel = this->fields.infoLabel;
        closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12454/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, 0);
        if ( infoLabel )
        {
          ...
          System_Action___ctor(v15, (Il2CppObject *)this, Method_ScriptStoryOpenDialog_EndOpen__, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29305 & 1) == 0 )
  {
    sub_1C2D490(&ScriptStoryOpenDialog_CallbackFunc_TypeInfo);
    byte_4C29305 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A73DB0;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A73D70;
}
