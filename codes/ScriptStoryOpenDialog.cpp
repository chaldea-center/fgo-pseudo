...
void __fastcall ScriptStoryOpenDialog__Close(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptStoryOpenDialog__Close_41456652(this, 0LL, v2);
}


void __fastcall ScriptStoryOpenDialog__Close_41456652(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A8D3 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_ScriptStoryOpenDialog_EndClose__, v6);
    byte_4A0A8D3 = 1;
  }
...
void __fastcall ScriptStoryOpenDialog__OnClickClose(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A8D4 & 1) == 0 )
  {
    sub_1B686D4(&Method_ScriptStoryOpenDialog_OnClickClose__, method);
    byte_4A0A8D4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptStoryOpenDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B686EC(Method_ScriptStoryOpenDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A8D2 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_ScriptStoryOpenDialog_EndOpen__, v12);
    sub_1B686D4(&StringLiteral_3732/*"COMMON_CONFIRM_CLOSE"*/, v13);
    sub_1B686D4(&StringLiteral_12308/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, v14);
    byte_4A0A8D2 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( closeButton )
    {
      ...
      closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3732/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
      if ( closeLabel )
      {
        UILabel__set_text(closeLabel, (System_String_o *)closeButton, 0LL);
        infoLabel = this->fields.infoLabel;
        closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12308/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, 0LL);
        if ( infoLabel )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A8CF & 1) == 0 )
  {
    sub_1B686D4(&ScriptStoryOpenDialog_CallbackFunc_TypeInfo, value);
    byte_4A0A8CF = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B20BC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B207C;
}
