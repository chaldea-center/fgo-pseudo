...
void __fastcall ScriptStoryOpenDialog__Close(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptStoryOpenDialog__Close_43035048(this, 0LL, v2);
}


void __fastcall ScriptStoryOpenDialog__Close_43035048(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE2B3 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ScriptStoryOpenDialog_EndClose__);
    byte_4BDE2B3 = 1;
  }
...
void __fastcall ScriptStoryOpenDialog__OnClickClose(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDE2B4 & 1) == 0 )
  {
    sub_1C21E38(&Method_ScriptStoryOpenDialog_OnClickClose__);
    byte_4BDE2B4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptStoryOpenDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_ScriptStoryOpenDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE2B2 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_ScriptStoryOpenDialog_EndOpen__);
    sub_1C21E38(&StringLiteral_3811/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C21E38(&StringLiteral_12602/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/);
    byte_4BDE2B2 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( closeButton )
    {
      ...
      closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3811/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
      if ( closeLabel )
      {
        UILabel__set_text(closeLabel, (System_String_o *)closeButton, 0LL);
        infoLabel = this->fields.infoLabel;
        closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12602/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, 0LL);
        if ( infoLabel )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDE2AF & 1) == 0 )
  {
    sub_1C21E38(&ScriptStoryOpenDialog_CallbackFunc_TypeInfo);
    byte_4BDE2AF = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A64C34;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A64BF4;
}
