...
void __fastcall ScriptStoryOpenDialog__Close(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptStoryOpenDialog__Close_34808692(this, 0LL, v2);
}


void __fastcall ScriptStoryOpenDialog__Close_34808692(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EE31E & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_ScriptStoryOpenDialog_EndClose__, v10, v11, v12);
    byte_42EE31E = 1;
  }
...
void __fastcall ScriptStoryOpenDialog__OnClickClose(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EE31F & 1) == 0 )
  {
    sub_B5D5C4(&Method_ScriptStoryOpenDialog_OnClickClose__, (_DWORD)method, v2, v3);
    byte_42EE31F = 1;
  }
  if ( this->fields.state == 2 )
  {
    v5 = Method_ScriptStoryOpenDialog_OnClickClose__;
    if ( (*((_BYTE *)Method_ScriptStoryOpenDialog_OnClickClose__ + 75) & 2) != 0 )
      v5 = (_QWORD *)sub_B5D5CC(Method_ScriptStoryOpenDialog_OnClickClose__);
    v6 = (System_Reflection_MethodBase_o *)sub_B5D5A8(v5, v5[3]);
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
    this->fields.state = 3;
    ScriptStoryOpenDialog__Callback(this, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EE31D & 1) == 0 )
  {
    sub_B5D5C4(&System_Action_TypeInfo, (_DWORD)title, (_DWORD)message, callback);
    sub_B5D5C4(&LocalizationManager_TypeInfo, v13, v14, v15);
    sub_B5D5C4(&Method_ScriptStoryOpenDialog_EndOpen__, v16, v17, v18);
    sub_B5D5C4(&StringLiteral_3327/*"COMMON_CONFIRM_CLOSE"*/, v19, v20, v21);
    sub_B5D5C4(&StringLiteral_12599/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, v22, v23, v24);
    byte_42EE31D = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( closeButton )
    {
      ...
      closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3327/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
      if ( closeLabel )
      {
        UILabel__set_text(closeLabel, (System_String_o *)closeButton, 0LL);
        infoLabel = this->fields.infoLabel;
        closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12599/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, 0LL);
        if ( infoLabel )
        {
          ...
          System_Action___ctor(v29, (Il2CppObject *)this, Method_ScriptStoryOpenDialog_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EE31A & 1) == 0 )
  {
    sub_B5D5C4(&ScriptStoryOpenDialog_CallbackFunc_TypeInfo, (_DWORD)value, (_DWORD)method, v3);
    byte_42EE31A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
    {
      if ( (ScriptStoryOpenDialog_CallbackFunc_c *)v9->klass != ScriptStoryOpenDialog_CallbackFunc_TypeInfo )
        break;
    }
        ...
        const MethodInfo *method)
{
  ...
  __int64 v3; // x8
  __int64 v5; // x23
  ScriptStoryOpenDialog_CallbackFunc_o **v6; // x24
  __int64 v7; // x25
  unsigned int v8; // w22
  __int64 class_0; // x0
  __int64 v10; // x3
  ...
  _DWORD *v29; // x11
  ScriptStoryOpenDialog_CallbackFunc_o *v30; // [xsp+8h] [xbp-38h] BYREF
  ...
  if ( v5 )
  {
    v6 = (ScriptStoryOpenDialog_CallbackFunc_o **)(v3 + 32);
LABEL_5:
    v7 = 0LL;
    while ( 1 )
    {
