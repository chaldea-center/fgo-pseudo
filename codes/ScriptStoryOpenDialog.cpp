...
void __fastcall ScriptStoryOpenDialog__Close(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptStoryOpenDialog__Close_43245044(this, 0LL, v2);
}


void __fastcall ScriptStoryOpenDialog__Close_43245044(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23D21 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ScriptStoryOpenDialog_EndClose__, v10);
    byte_4C23D21 = 1;
  }
...
void __fastcall ScriptStoryOpenDialog__OnClickClose(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C23D22 & 1) == 0 )
  {
    sub_1C3B764(&Method_ScriptStoryOpenDialog_OnClickClose__, method);
    byte_4C23D22 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptStoryOpenDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_ScriptStoryOpenDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23D20 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ScriptStoryOpenDialog_EndOpen__, v14);
    sub_1C3B764(&StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, v15);
    sub_1C3B764(&StringLiteral_12639/*"SpecialShadowEffectId"*/, v16);
    byte_4C23D20 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( closeButton )
    {
      ...
      closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COSTUME_SELECT_SERVANT_EVENT_END_ITEM_COSTUME_MSG"*/, 0LL);
      if ( closeLabel )
      {
        UILabel__set_text(closeLabel, (System_String_o *)closeButton, 0LL);
        infoLabel = this->fields.infoLabel;
        closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12639/*"SpecialShadowEffectId"*/, 0LL);
        if ( infoLabel )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23D1D & 1) == 0 )
  {
    sub_1C3B764(&ScriptStoryOpenDialog_CallbackFunc_TypeInfo, value);
    byte_4C23D1D = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A7E1C0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A7E180;
}
