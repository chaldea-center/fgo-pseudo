...
void __fastcall ScriptStoryOpenDialog__Close(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  ScriptStoryOpenDialog__Close_42981664(this, 0LL, v2);
}


void __fastcall ScriptStoryOpenDialog__Close_42981664(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9808 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ScriptStoryOpenDialog_EndClose__, v10);
    byte_4BC9808 = 1;
  }
...
void __fastcall ScriptStoryOpenDialog__OnClickClose(ScriptStoryOpenDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC9809 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_ScriptStoryOpenDialog_OnClickClose__, method);
    byte_4BC9809 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ScriptStoryOpenDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_ScriptStoryOpenDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9807 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_ScriptStoryOpenDialog_EndOpen__, v14);
    sub_1C1ABD4(&StringLiteral_3802/*"COMMON_CONFIRM_CLOSE"*/, v15);
    sub_1C1ABD4(&StringLiteral_12592/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, v16);
    byte_4BC9807 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( closeButton )
    {
      ...
      closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3802/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
      if ( closeLabel )
      {
        UILabel__set_text(closeLabel, (System_String_o *)closeButton, 0LL);
        infoLabel = this->fields.infoLabel;
        closeButton = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12592/*"SUMMON_OPEN_FRIENDQUEST_INFO"*/, 0LL);
        if ( infoLabel )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC9804 & 1) == 0 )
  {
    sub_1C1ABD4(&ScriptStoryOpenDialog_CallbackFunc_TypeInfo, value);
    byte_4BC9804 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5DC8C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5DC4C;
}
