        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( !notHaveServantEntity )
      sub_1C3B9C0(0LL, tdLv);
    ServantLeaderInfo__getTreasureDeviceInfo_41983672(notHaveServantEntity, tdLv, tdMaxLv, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields, (int64_t)userSvtEntity, (int64_t)method, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25D76 & 1) == 0 )
  {
    ...
    this = (ServantCostumeItemInfo_o *)sub_1C3B764(&ServantLeaderInfo_TypeInfo, v5);
    byte_4C25D76 = 1;
  }
  if ( !userSvtEntity )
  ...
  if ( UserServantEntity__IsWithdrawal(userSvtEntity, 0LL) )
  {
    ...
    *(_QWORD *)&v35.fields.fakeValue = v12;
    v14 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v35, 0LL);
    v15 = (ServantLeaderInfo_o *)sub_1C3B9B0(ServantLeaderInfo_TypeInfo);
    ServantLeaderInfo___ctor_41971544(v15, v14, 0, 1, 0LL);
    v4->fields.isCanRelease = 0;
    v4->fields.userServantEntity = 0LL;
    sub_1C3B708((PartyOrganizationUtility_o *)&v4->fields, 0LL, v16, v17, v18, v19, v20, v21);
  ...
  else
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&v4->fields, (int64_t)userSvtEntity, v6, v7, v8, v9, v10, v11);
    v4->fields.notHaveServantEntity = 0LL;
    p_notHaveServantEntity = &v4->fields.notHaveServantEntity;
    sub_1C3B708((PartyOrganizationUtility_o *)p_notHaveServantEntity, 0LL, v29, v30, v31, v32, v33, v34);
...
int32_t __fastcall ServantCostumeItemInfo__get_NowLimitCount(ServantCostumeItemInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C25D7A & 1) == 0 )
  {
    this = (ServantCostumeItemInfo_o *)sub_1C3B764(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, method);
    byte_4C25D7A = 1;
  }
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v8.fields.fakeValue = v4;
    return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v8, 0LL);
  }
  else
  {
