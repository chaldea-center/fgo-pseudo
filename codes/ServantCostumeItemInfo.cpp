        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( !notHaveServantEntity )
      sub_B52A5C(0LL, tdLv);
    ServantLeaderInfo__getTreasureDeviceInfo_29287072(notHaveServantEntity, tdLv, tdMaxLv, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2E1E & 1) == 0 )
  {
    ...
    this = (ServantCostumeItemInfo_o *)sub_B52984(&ServantLeaderInfo_TypeInfo);
    byte_42B2E1E = 1;
  }
  if ( !userSvtEntity )
  ...
  if ( UserServantEntity__IsWithdrawal(userSvtEntity, 0LL) )
  {
    ...
    *(_QWORD *)&v34.fields.fakeValue = v11;
    v13 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44786420(v34, 0LL);
    ...
    sub_B52920((BattleServantConfConponent_o *)&v4->fields, 0LL, v15, v16, v17, v18, v19, v20);
  ...
  else
  {
    ...
    sub_B52920((BattleServantConfConponent_o *)p_notHaveServantEntity, 0LL, v28, v29, v30, v31, v32, v33);
...
int32_t __fastcall ServantCostumeItemInfo__get_MaxLimitCount(ServantCostumeItemInfo_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v11.fields.currentCryptoKey = v10;
  *(_QWORD *)&v11.fields.fakeValue = v9;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44786420(v11, 0LL);
  if ( !v8
...
int32_t __fastcall ServantCostumeItemInfo__get_NowLimitCount(ServantCostumeItemInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2E22 & 1) == 0 )
  {
    this = (ServantCostumeItemInfo_o *)sub_B52984(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_42B2E22 = 1;
  }
  ...
  if ( userServantEntity )
  {
    ...
    *(_QWORD *)&v8.fields.fakeValue = v4;
    return CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44786420(v8, 0LL);
  }
  else
  {
