        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( !notHaveServantEntity )
      sub_1B9026C(0LL, tdLv);
    ServantLeaderInfo__getTreasureDeviceInfo_40551496(notHaveServantEntity, tdLv, tdMaxLv, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)userSvtEntity, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.notHaveServantEntity, (int32_t)svtData, v6, v7);
  this->fields.isCanRelease = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73A0A & 1) == 0 )
  {
    ...
    this = (ServantCostumeItemInfo_o *)sub_1B90010(&ServantLeaderInfo_TypeInfo, v5);
    byte_4A73A0A = 1;
  }
  if ( !userSvtEntity )
  ...
  if ( UserServantEntity__IsWithdrawal(userSvtEntity, 0LL) )
  {
    ...
    *(_QWORD *)&v19.fields.fakeValue = v8;
    v10 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46506376(v19, 0LL);
    v11 = (ServantLeaderInfo_o *)sub_1B9025C(ServantLeaderInfo_TypeInfo);
    ServantLeaderInfo___ctor_40539908(v11, v10, 0, 1, 0LL);
    v4->fields.isCanRelease = 0;
    v4->fields.userServantEntity = 0LL;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v4->fields, 0, v12, v13);
    v4->fields.notHaveServantEntity = v11;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v4->fields.notHaveServantEntity, (int32_t)v11, v14, v15);
    v4->fields.isCanRelease = 0;
  ...
  else
  {
    ...
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&v4->fields, (int32_t)userSvtEntity, v6, v7);
    v4->fields.notHaveServantEntity = 0LL;
    p_notHaveServantEntity = &v4->fields.notHaveServantEntity;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)p_notHaveServantEntity, 0, v17, v18);
...
int32_t __fastcall ServantCostumeItemInfo__get_NowLimitCount(ServantCostumeItemInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A73A0E & 1) == 0 )
  {
    this = (ServantCostumeItemInfo_o *)sub_1B90010(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, method);
    byte_4A73A0E = 1;
  }
