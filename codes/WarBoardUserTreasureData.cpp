        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DC8C & 1) == 0 )
  {
    sub_1B90010(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___, method);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v5,
                                           (const MethodInfo_2EF48C0 *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
