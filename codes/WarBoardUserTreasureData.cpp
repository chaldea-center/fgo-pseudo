        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC365 & 1) == 0 )
  {
    sub_1B64870(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___, method);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v5,
                                           (const MethodInfo_2EA119C *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
