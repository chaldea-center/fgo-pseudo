        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3B3D & 1) == 0 )
  {
    sub_1BAB41C(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___, method);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v5,
                                           (const MethodInfo_2F2AABC *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
