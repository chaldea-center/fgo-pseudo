        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8BAD & 1) == 0 )
  {
    sub_1B4CF90(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___, method);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v5,
                                           (const MethodInfo_2F6ADF0 *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
