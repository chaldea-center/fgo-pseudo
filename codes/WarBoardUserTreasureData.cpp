        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06AAD & 1) == 0 )
  {
    sub_1B686D4(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___, method);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v5,
                                           (const MethodInfo_2EAF938 *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
