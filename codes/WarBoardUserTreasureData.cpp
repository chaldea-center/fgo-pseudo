        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E0708 & 1) == 0 )
  {
    sub_1B00CCC(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___, method);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v5,
                                           (const MethodInfo_2DB84AC *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
