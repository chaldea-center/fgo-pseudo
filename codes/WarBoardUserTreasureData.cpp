        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC985 & 1) == 0 )
  {
    sub_1B64A00(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___, method);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v5,
                                           (const MethodInfo_2EA17B4 *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
