...
WarBoardUserTreasureData_o *WarBoardUserTreasureData__FromJson(System_String_o *json, const MethodInfo *method)
{
  ...
  if ( (byte_4C35594 & 1) == 0 )
  {
    sub_1C32C20(&Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  ...
  result = (WarBoardUserTreasureData_o *)JsonManager__DeserializeArray_object_(
                                           v3,
                                           (const MethodInfo_314C85C *)Method_JsonManager_DeserializeArray_WarBoardUserTreasureData___);
  if ( result )
  {
