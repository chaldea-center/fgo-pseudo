void __fastcall TipsArchiveStateManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2F15A & 1) == 0 )
  {
    sub_1B761C0(&TipsArchiveStateManager_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_6650/*"Fgo_20230514_1"*/, v4);
    byte_4A2F15A = 1;
  }
  TipsArchiveStateManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6650/*"Fgo_20230514_1"*/;
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)TipsArchiveStateManager_TypeInfo->static_fields,
    StringLiteral_6650/*"Fgo_20230514_1"*/,
    v2,
    v3);
}
...
void __fastcall TipsArchiveStateManager___ctor(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F159 & 1) == 0 )
  {
    sub_1B761C0(
      ...
      method);
    sub_1B761C0(&System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData__TypeInfo, v3);
    byte_4A2F159 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData___ctor__);
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.stateDataList, (int32_t)v4, v5, v6);
...
void __fastcall TipsArchiveStateManager__ClearSaveDataList(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F156 & 1) == 0 )
  {
    sub_1B761C0(
      ...
      method);
    this = (TipsArchiveStateManager_o *)sub_1B761C0(
        ...
        const MethodInfo *method)
{
  ...
  return System_String__Concat_61535060(DatFileSavePath, this->fields.saveName, 0LL);
}
...
bool __fastcall TipsArchiveStateManager__ReadData(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F157 & 1) == 0 )
  {
    ...
    sub_1B761C0(
      ...
      v4);
    sub_1B761C0(&EventInfoTipsArchiveListViewItem_TipsArchiveStateData_TypeInfo, v5);
    sub_1B761C0(&TipsArchiveStateManager_TypeInfo, v6);
    byte_4A2F157 = 1;
  }
    ...
    if ( v16 >= 1 )
    {
      do
      {
        ...
        v19 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v10->klass->vtable._15_ReadInt32.method)(
                v10,
                v10->klass->vtable._16_ReadUInt32.methodPtr);
        v20 = (EventInfoTipsArchiveListViewItem_TipsArchiveStateData_o *)sub_1B7640C(EventInfoTipsArchiveListViewItem_TipsArchiveStateData_TypeInfo);
        ...
        else
        {
          ...
          sub_1B76164((ServantStatusBattleListViewItem_o *)(v28 + 4), (int32_t)v20, v22, v23);
        }
        --v16;
      }
      while ( v16 );
  ...
  {
LABEL_21:
    v32 = sub_1BC81A0(v10, System_IDisposable_TypeInfo, 0LL);
  }
...
{
  __int64 v5; // x1
  System_String_o *FileName_37503916; // x0
  ...
  if ( (byte_4A2F154 & 1) == 0 )
  {
    sub_1B761C0(&DatFileName_TypeInfo, eventUiName);
    sub_1B761C0(&StringLiteral_1123/*"/"*/, v5);
    byte_4A2F154 = 1;
  }
  if ( !DatFileName_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DatFileName_TypeInfo);
  FileName_37503916 = DatFileName__getFileName_37503916(40, eventUiName, 0LL, 0LL);
  v7 = System_String__Concat_61535060((System_String_o *)StringLiteral_1123/*"/"*/, FileName_37503916, 0LL);
  this->fields.saveName = v7;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.saveName, (int32_t)v7, v8, v9);
}
...
bool __fastcall TipsArchiveStateManager__WriteData(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F158 & 1) == 0 )
  {
    ...
    sub_1B761C0(&TipsArchiveStateManager_TypeInfo, v7);
    byte_4A2F158 = 1;
  }
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               ...
               i,
               (const MethodInfo_34D7304 *)Method_System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData__get_Item__);
      v24 = Item;
      if ( !Item )
        sub_1B7641C(0LL, v23);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v12->klass->vtable._17_Write.method)(
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.stateDataList, (int32_t)value, (int32_t)method, v3);
}