void __fastcall TipsArchiveStateManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B67E69 & 1) == 0 )
  {
    sub_1BE4ACC(&TipsArchiveStateManager_TypeInfo, v1);
    sub_1BE4ACC(&StringLiteral_6788/*"Fgo_20230514_1"*/, v8);
    byte_4B67E69 = 1;
  }
  TipsArchiveStateManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6788/*"Fgo_20230514_1"*/;
  sub_1BE4A70(
    (PartyOrganizationUtility_o *)TipsArchiveStateManager_TypeInfo->static_fields,
    StringLiteral_6788/*"Fgo_20230514_1"*/,
    v2,
    v3,
    v4,
    v5,
...
void __fastcall TipsArchiveStateManager___ctor(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67E68 & 1) == 0 )
  {
    sub_1BE4ACC(
      ...
      method);
    sub_1BE4ACC(&System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData__TypeInfo, v3);
    byte_4B67E68 = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData___ctor__);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.stateDataList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
...
void __fastcall TipsArchiveStateManager__ClearSaveDataList(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67E65 & 1) == 0 )
  {
    sub_1BE4ACC(
      ...
      method);
    this = (TipsArchiveStateManager_o *)sub_1BE4ACC(
        ...
        const MethodInfo *method)
{
  ...
  return System_String__Concat_62698808(DatFileSavePath, this->fields.saveName, 0LL);
}
...
bool __fastcall TipsArchiveStateManager__ReadData(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67E66 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(
      ...
      v4);
    sub_1BE4ACC(&EventInfoTipsArchiveListViewItem_TipsArchiveStateData_TypeInfo, v5);
    sub_1BE4ACC(&TipsArchiveStateManager_TypeInfo, v6);
    byte_4B67E66 = 1;
  }
    ...
    if ( v16 >= 1 )
    {
      do
      {
        ...
        v19 = ((__int64 (__fastcall *)(System_IO_BinaryReader_o *, Il2CppMethodPointer))v10->klass->vtable._15_ReadInt32.method)(
                v10,
                v10->klass->vtable._16_ReadUInt32.methodPtr);
        v20 = (EventInfoTipsArchiveListViewItem_TipsArchiveStateData_o *)sub_1BE4D18(EventInfoTipsArchiveListViewItem_TipsArchiveStateData_TypeInfo);
        ...
        else
        {
          ...
          sub_1BE4A70((PartyOrganizationUtility_o *)(v32 + 4), (int64_t)v20, v22, v23, v24, v25, v26, v27);
        }
        --v16;
      }
      while ( v16 );
  ...
  {
LABEL_21:
    v36 = sub_1C36AAC(v10, System_IDisposable_TypeInfo, 0LL);
  }
...
{
  __int64 v5; // x1
  System_String_o *FileName_38587524; // x0
  ...
  if ( (byte_4B67E63 & 1) == 0 )
  {
    sub_1BE4ACC(&DatFileName_TypeInfo, eventUiName);
    sub_1BE4ACC(&StringLiteral_1120/*"/"*/, v5);
    byte_4B67E63 = 1;
  }
  if ( !DatFileName_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DatFileName_TypeInfo);
  FileName_38587524 = DatFileName__getFileName_38587524(40, eventUiName, 0LL, 0LL);
  v7 = System_String__Concat_62698808((System_String_o *)StringLiteral_1120/*"/"*/, FileName_38587524, 0LL);
  this->fields.saveName = v7;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.saveName, (int64_t)v7, v8, v9, v10, v11, v12, v13);
}
...
bool __fastcall TipsArchiveStateManager__WriteData(TipsArchiveStateManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67E67 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&TipsArchiveStateManager_TypeInfo, v7);
    byte_4B67E67 = 1;
  }
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               ...
               i,
               (const MethodInfo_35EBF54 *)Method_System_Collections_Generic_List_EventInfoTipsArchiveListViewItem_TipsArchiveStateData__get_Item__);
      v24 = Item;
      if ( !Item )
        sub_1BE4D28(0LL, v23);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v12->klass->vtable._17_Write.method)(
