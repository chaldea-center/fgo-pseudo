        ...
        const MethodInfo *method)
{
  ...
  __int64 v27; // x25
  int max_length; // w9
  EventTreasureBoxPanelComponent_o *v29; // x26
  ...
  if ( (byte_4C21CD4 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_DataManager_GetMasterData_TreasureBoxMaster___);
  ...
  v19 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_ShopBuyItemListViewObject__TypeInfo);
  ...
  Instance = sub_1C2D434(&currencyInfoController->fields.objectList);
  if ( !v18 )
    goto LABEL_26;
  ...
  if ( !Instance
    || (gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)Instance, 0),
        ...
        v33.fields.y = y,
        v33.fields.z = z,
        (Instance = (__int64)TweenPosition__Begin(gameObject, 0.4, v33, 0)) == 0)
...
LABEL_26:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v27 >= max_length )
      sub_1C2D6F4(Instance, v14, v25);
    v29 = treasureBoxList->m_Items[v27];
    Instance = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
      Instance = (__int64)DataManager__GetMasterData_object_(
                            (DataManager_o *)Instance,
                            (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_TreasureBoxMaster___);
      if ( Instance )
      {
        Instance = (__int64)TreasureBoxMaster__GetTreasureBoxData((TreasureBoxMaster_o *)Instance, eventId, v27, 0);
        if ( v29 )
        {
