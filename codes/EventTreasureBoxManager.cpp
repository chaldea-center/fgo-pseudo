        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0D21 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_DataManager_GetMasterData_TreasureBoxMaster___);
  ...
  v19 = (System_Collections_Generic_List_object__o *)sub_1C6BC54(System_Collections_Generic_List_ShopBuyItemListViewObject__TypeInfo);
  ...
  Instance = sub_1C6B9AC(&currencyInfoController->fields.objectList, v19);
  if ( !v18 )
    goto LABEL_26;
...
LABEL_26:
  ...
  while ( 1 )
  {
    ...
    if ( Instance )
    {
      Instance = (__int64)DataManager__GetMasterData_object_(
                            (DataManager_o *)Instance,
                            (const MethodInfo_313B368 *)Method_DataManager_GetMasterData_TreasureBoxMaster___);
      if ( Instance )
      {
