        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F5AB & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_TreasureBoxMaster___, v14);
    ...
    sub_1BDB878(&System_Collections_Generic_List_ShopBuyItemListViewObject__TypeInfo, v17);
  ...
  v25 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_ShopBuyItemListViewObject__TypeInfo);
  ...
  Instance = sub_1BDB81C(&currencyInfoController->fields.objectList);
  if ( !v24 )
    goto LABEL_26;
...
LABEL_26:
  ...
  while ( 1 )
  {
    ...
    if ( Instance )
    {
      Instance = (__int64)DataManager__GetMasterData_object_(
                            (DataManager_o *)Instance,
                            (const MethodInfo_303395C *)Method_DataManager_GetMasterData_TreasureBoxMaster___);
      if ( Instance )
      {
