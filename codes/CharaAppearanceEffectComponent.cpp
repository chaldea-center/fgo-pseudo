        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418A134 & 1) == 0 )
  {
    sub_B2C35C(&Method_CharaAppearanceEffectComponent_EndCreateEffect__, figure);
    ...
    sub_B2C35C(&StringLiteral_4524/*"Custom/Sprite-ScriptActionFigureErasure"*/, v15);
    byte_418A134 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_36;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4524/*"Custom/Sprite-ScriptActionFigureErasure"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_36;
