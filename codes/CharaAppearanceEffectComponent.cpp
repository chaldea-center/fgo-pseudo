        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31FC8 & 1) == 0 )
  {
    sub_1C93AD4(&Method_CharaAppearanceEffectComponent_EndCreateEffect__);
    ...
    sub_1C93AD4(&StringLiteral_4943/*"Custom/Sprite-ScriptActionFigureErasure"*/);
    byte_4D31FC8 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4943/*"Custom/Sprite-ScriptActionFigureErasure"*/, 0);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
