        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFC43 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_CharaAppearanceEffectComponent_EndCreateEffect__);
    ...
    sub_1C7BAE8(&StringLiteral_4927/*"Custom/Sprite-ScriptActionFigureErasure"*/);
    byte_4CEFC43 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4927/*"Custom/Sprite-ScriptActionFigureErasure"*/, 0);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
