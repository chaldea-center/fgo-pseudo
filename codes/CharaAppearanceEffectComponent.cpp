        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23365 & 1) == 0 )
  {
    sub_1C3B764(&Method_CharaAppearanceEffectComponent_EndCreateEffect__, figure);
    sub_1C3B764(&CommonEffectManager_TypeInfo, v11);
    sub_1C3B764(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v12);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v13);
    sub_1C3B764(&StringLiteral_13830/*"The required attribute must have a value of yes or no."*/, v14);
    sub_1C3B764(&StringLiteral_5052/*"DataTable.DataColumn_{0}.AutoIncrementStep"*/, v15);
    byte_4C23365 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_5052/*"DataTable.DataColumn_{0}.AutoIncrementStep"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
...
LABEL_32:
  ...
  v30 = System_String__Concat_63368612((System_String_o *)StringLiteral_13830/*"The required attribute must have a value of yes or no."*/, this->fields.subEffectName, 0LL);
  v31 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C3B9B0(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
  ...
  CommonEffectManager__Create_42109636(v29, v30, v31, 0, 0, 0, v33);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    {
      sub_1C3B9C0(klass, v4);
    }
    UIStandFigureRender__SetAlpha(klass, 1.0, 0LL);
    p_figure->klass = 0LL;
    sub_1C3B708(p_figure, 0LL, v7, v8, v9, v10, v11, v12);
  }
}
...
LABEL_17:
    ...
    if ( UnityEngine_Object__op_Inequality(klass, 0LL, 0LL) )
    {
      ...
      sub_1C3B708(p_childEffect, 0LL, v10, v11, v12, v13, v14, v15);
    }
  }
}