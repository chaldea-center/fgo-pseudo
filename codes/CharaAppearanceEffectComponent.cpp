        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC294 & 1) == 0 )
  {
    sub_1B4CF90(&Method_CharaAppearanceEffectComponent_EndCreateEffect__, figure);
    sub_1B4CF90(&CommonEffectManager_TypeInfo, v7);
    sub_1B4CF90(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v8);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v9);
    sub_1B4CF90(&StringLiteral_13331/*"Talk/"*/, v10);
    sub_1B4CF90(&StringLiteral_4863/*"Custom/Sprite-ScriptActionFigureErasure"*/, v11);
    byte_49BC294 = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4863/*"Custom/Sprite-ScriptActionFigureErasure"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
...
LABEL_32:
  ...
  v26 = System_String__Concat_61093468((System_String_o *)StringLiteral_13331/*"Talk/"*/, this->fields.subEffectName, 0LL);
  v27 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B4D1DC(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
  ...
  CommonEffectManager__Create_41236180(v25, v26, v27, 0, 0, 0, v29);
}
