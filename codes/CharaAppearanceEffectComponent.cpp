        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F91C & 1) == 0 )
  {
    sub_1B863B8(&Method_CharaAppearanceEffectComponent_EndCreateEffect__, figure);
    ...
    sub_1B863B8(&StringLiteral_4893/*"Custom/Sprite-ScriptActionFigureErasure"*/, v11);
    byte_4A4F91C = 1;
  }
  ...
  if ( !transform )
    goto LABEL_32;
  UIStandFigureRender__SetSharder(transform, (System_String_o *)StringLiteral_4893/*"Custom/Sprite-ScriptActionFigureErasure"*/, 0LL);
  transform = (UIStandFigureRender_o *)*p_figure;
  if ( !*p_figure )
    goto LABEL_32;
