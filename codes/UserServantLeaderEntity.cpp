void __fastcall UserServantLeaderEntity___ctor(UserServantLeaderEntity_o *this, const MethodInfo *method)
{
  ...
  sub_B16F98((BattleServantConfConponent_o *)&this->fields.servantLeaderInfo, 0LL, v9, v10, v11, v12, v13, v14);
  this->fields.supportDeckId = 1;
  ...
  *(struct EquipTargetInfo_o **)((char *)p_equipTarget1 + 20) = 0LL;
  sub_B16F98((BattleServantConfConponent_o *)p_equipTarget1, 0LL, v16, v17, v18, v19, v20, v21);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall UserServantLeaderEntity___ctor_34309140(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FF696 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataEntityBase_string___ctor__, *(_QWORD *)&classPos);
    byte_40FF696 = 1;
  }
  this->fields.supportDeckId = 1;
  DataEntityBase_string____ctor(
    ...
    (const MethodInfo_266F2D4 *)Method_DataEntityBase_string___ctor__);
  this->fields.userServantEntity = 0LL;
  sub_B16F98((BattleServantConfConponent_o *)&this->fields, 0LL, v7, v8, v9, v10, v11, v12);
  this->fields.servantLeaderInfo = 0LL;
  sub_B16F98((BattleServantConfConponent_o *)&this->fields.servantLeaderInfo, 0LL, v13, v14, v15, v16, v17, v18);
  ...
  *((_DWORD *)p_equipTarget1 + 5) = classPos;
  sub_B16F98((BattleServantConfConponent_o *)p_equipTarget1, 0LL, v20, v21, v22, v23, v24, v25);
}


void __fastcall UserServantLeaderEntity___ctor_34309304(
        UserServantLeaderEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FF697 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataEntityBase_string___ctor__, src);
    byte_40FF697 = 1;
  }
  this->fields.supportDeckId = 1;
  DataEntityBase_string____ctor(
  ...
  UserServantLeaderEntity__setEquipTargetInfo(this, src->fields.equipTarget1, v19);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_40FF694 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataEntityBase_CreateMultiplePK_long__int__int___, *(_QWORD *)&classId);
    byte_40FF694 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FF699 & 1) == 0 )
  {
    sub_B16FFC(&EquipTargetInfo_TypeInfo, equipTargetInfo);
    byte_40FF699 = 1;
  }
  v7 = (EquipTargetInfo_o *)sub_B170CC(EquipTargetInfo_TypeInfo, equipTargetInfo, method, v3, v4);
  EquipTargetInfo___ctor_29329860(v7, equipTargetInfo, 0LL);
  this->fields.equipTarget1 = v7;
  sub_B16F98(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FF69A & 1) == 0 )
  {
    sub_B16FFC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, entity);
  ...
  *(_OWORD *)&v25.fields.fakeValue = v19;
  ...
  v24 = v25;
  this->fields.userId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_44071692(&v24, 0LL);
  this->fields.supportDeckId = supportDeckId;
  ...
  *(_OWORD *)&v23.fields.fakeValue = v20;
  this->fields.userSvtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_44071692(&v23, 0LL);
  ...
  *(_QWORD *)&v26.fields.fakeValue = v21;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44068536(v26, 0LL);
}


void __fastcall UserServantLeaderEntity__setUserServantEntity_34310044(
        UserServantLeaderEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  v17 = *(_QWORD *)&info->fields.svtId.fields.currentCryptoKey;
  v16 = *(_QWORD *)&info->fields.svtId.fields.fakeValue;
  if ( (BYTE3(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
  ...
  *(_QWORD *)&v25.fields.fakeValue = v16;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44068536(v25, 0LL);
