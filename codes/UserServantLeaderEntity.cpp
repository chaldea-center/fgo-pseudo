void __fastcall UserServantLeaderEntity___ctor(UserServantLeaderEntity_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.servantLeaderInfo, 0, v5, v6);
  this->fields.supportDeckId = 1;
  ...
  *(struct EquipTargetInfo_o **)((char *)p_equipTarget1 + 20) = 0LL;
  sub_1B71570((ServantStatusBattleListViewItem_o *)p_equipTarget1, 0, v8, v9);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall UserServantLeaderEntity___ctor_40029424(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2093F & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_string___ctor__, *(_QWORD *)&classPos);
    byte_4A2093F = 1;
  }
  this->fields.supportDeckId = 1;
  DataEntityBase_object____ctor(
    ...
    (const MethodInfo_30F85D8 *)Method_DataEntityBase_string___ctor__);
  this->fields.userServantEntity = 0LL;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields, 0, v7, v8);
  this->fields.servantLeaderInfo = 0LL;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.servantLeaderInfo, 0, v9, v10);
  ...
  *((_DWORD *)p_equipTarget1 + 5) = classPos;
  sub_1B71570((ServantStatusBattleListViewItem_o *)p_equipTarget1, 0, v12, v13);
}


void __fastcall UserServantLeaderEntity___ctor_40029584(
        UserServantLeaderEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)userServantEntity, v7, v8);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2093D & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_CreateMultiplePK_long__int__int___, *(_QWORD *)&classId);
    byte_4A2093D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20942 & 1) == 0 )
  {
    sub_1B715CC(&EquipTargetInfo_TypeInfo, equipTargetInfo);
    byte_4A20942 = 1;
  }
  v5 = (EquipTargetInfo_o *)sub_1B71818(EquipTargetInfo_TypeInfo);
  EquipTargetInfo___ctor_38677552(v5, equipTargetInfo, 0LL);
  this->fields.equipTarget1 = v5;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.equipTarget1, (int32_t)v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)entity, classPos, supportDeckId);
  this->fields.servantLeaderInfo = 0LL;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.servantLeaderInfo, 0, v10, v11);
  if ( !entity )
    sub_1B71828(v12, v13);
  ...
  *(_OWORD *)&v20.fields.fakeValue = v14;
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
  v19 = v20;
  this->fields.userId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46311792(&v19, 0LL);
  this->fields.supportDeckId = supportDeckId;
  ...
  *(_OWORD *)&v18.fields.fakeValue = v15;
  this->fields.userSvtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46311792(&v18, 0LL);
  ...
  *(_QWORD *)&v21.fields.fakeValue = v16;
  this->fields.svtId = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46308268(v21, 0LL);
}


void __fastcall UserServantLeaderEntity__setUserServantEntity_40030268(
        UserServantLeaderEntity_o *this,
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.servantLeaderInfo, (int32_t)info, v6, v7);
  if ( !info )
    sub_1B71828(v8, v9);
  ...
  *(_QWORD *)&v15.fields.fakeValue = v10;
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.equipTarget1, (int32_t)equipTarget1, v13, v14);
}