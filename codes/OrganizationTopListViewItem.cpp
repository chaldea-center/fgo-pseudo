        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.info, (int32_t)info, v6, v7);
}
...
System_String_o *OrganizationTopListViewItem__ToString(OrganizationTopListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C524CF & 1) == 0 )
  {
    this = (OrganizationTopListViewItem_o *)sub_1C3E564(&StringLiteral_10063/*"OrganizationTopItem "*/);
    byte_4C524CF = 1;
  }
  info = v2->fields.info;
  if ( !info )
    sub_1C3E7C0(this, method);
  return System_String__Concat_63636468((System_String_o *)StringLiteral_10063/*"OrganizationTopItem "*/, info->fields.textCode, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C524CE & 1) == 0 )
  {
    this = (OrganizationTopListViewItem_o *)sub_1C3E564(&LocalizationManager_TypeInfo);
    byte_4C524CE = 1;
  }
  info = v2->fields.info;
  if ( !info )
