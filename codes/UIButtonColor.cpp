...
void UIButtonColor__OnInit(UIButtonColor_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0902D & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_Light___);
  ...
  if ( UnityEngine_Object__op_Equality(tweenTarget, 0, 0) )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.tweenTarget, (int32_t)gameObject, v6, v7, v8, v9, v10, v11);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v24, 0, 0) )
  {
    ...
    else
    {
      ...
      v26 = UnityEngine_GameObject__GetComponent_object_(
              isPlaying,
              (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_Light___);
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      ...
      if ( ((unsigned __int8)isPlaying & 1) == 0 )
      {
        ...
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.tweenTarget, 0, v27, v28, v29, v30, v31, v32);
