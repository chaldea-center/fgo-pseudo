...
LABEL_10:
      sub_2213CDC(BattleSquareEntity, v6);
    }
  }
  return v3;
}
...
int32_t BattleWarBoardInfo__GetPartySkillId(BattleWarBoardInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59737C4 & 1) == 0 )
  {
    sub_2213A60(&Method_DataManager_GetMaster_WarBoardStageMaster___);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_WarBoardStageMaster___);
  if ( !Master_object )
    sub_2213CDC(0, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59737C5 & 1) == 0 )
  {
    sub_2213A60(&Method_DataManager_GetMaster_WarBoardSquareMaster___);
    sub_2213A60(&Method_DataManager_GetMaster_WarBoardStageMaster___);
    sub_2213A60(&DataManager_TypeInfo);
  ...
  entity = 0;
  *squareEntity = 0;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)squareEntity, 0, (System_String_o *)method, v3, v4, v5, v6, v7);
...
LABEL_14:
  ...
  IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_WarBoardStageMaster___);
  if ( !IsNullOrEmpty )
LABEL_25:
  ...
  else
  {
    ...
    IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_3856318 *)Method_DataManager_GetMaster_WarBoardSquareMaster___);
