...
LABEL_10:
      sub_B52A5C(BattleSquareEntity, v6);
    }
  }
  return v3;
}
...
int32_t __fastcall BattleWarBoardInfo__GetPartySkillId(BattleWarBoardInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AFC8A & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMaster_WarBoardStageMaster___);
  ...
  Master_WarQuestSelectionMaster = (DataMasterBase_WarMaster__WarEntity__int__o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_WarBoardStageMaster___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFC8B & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMaster_WarBoardSquareMaster___);
    sub_B52984(&Method_DataManager_GetMaster_WarBoardStageMaster___);
    sub_B52984(&DataManager_TypeInfo);
  ...
  entity = 0LL;
  *squareEntity = 0LL;
  sub_B52920((BattleServantConfConponent_o *)squareEntity, 0LL, (System_String_array **)method, v3, v4, v5, v6, v7);
...
LABEL_13:
  if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  IsNullOrEmpty = DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_WarBoardStageMaster___);
  if ( !IsNullOrEmpty )
LABEL_26:
  ...
  else
  {
    if ( (BYTE3(DataManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    IsNullOrEmpty = DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_WarBoardSquareMaster___);
