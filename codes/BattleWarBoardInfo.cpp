...
LABEL_10:
      sub_1BD36B4(BattleSquareEntity, v8);
    }
  }
  return v5;
}
...
int32_t __fastcall BattleWarBoardInfo__GetPartySkillId(BattleWarBoardInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B39A6E & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_WarBoardStageMaster___, method);
    sub_1BD3458(&DataManager_TypeInfo, v3);
    sub_1BD3458(&Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int__GetEntity__, v4);
    byte_4B39A6E = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_WarBoardStageMaster___);
  if ( !Master_object )
    sub_1BD36B4(0LL, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39A6F & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMaster_WarBoardSquareMaster___, squareEntity);
    sub_1BD3458(&Method_DataManager_GetMaster_WarBoardStageMaster___, v10);
    sub_1BD3458(&DataManager_TypeInfo, v11);
    sub_1BD3458(&Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int__TryGetEntity__, v12);
    byte_4B39A6F = 1;
  }
  entity = 0LL;
  *squareEntity = 0LL;
  sub_1BD33FC((PartyOrganizationUtility_o *)squareEntity, 0LL, (int64_t)method, v3, v4, v5, v6, v7);
...
LABEL_13:
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_WarBoardStageMaster___);
  if ( !IsNullOrEmpty )
LABEL_24:
  ...
  else
  {
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    IsNullOrEmpty = DataManager__GetMaster_object_((const MethodInfo_2F31630 *)Method_DataManager_GetMaster_WarBoardSquareMaster___);
