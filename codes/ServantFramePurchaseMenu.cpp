        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC768 & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndCloseBuyFrameConfirmCancel__, v7);
    byte_40FC768 = 1;
  }
  if ( isDecide )
  {
  ...
  else
  {
    ...
    if ( !purchaseConfirmMenu )
      sub_B170D4();
    ServantFramePurchaseConfirmMenu__Close_29594984(purchaseConfirmMenu, v9, v10);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B16FFC(&System_Action_TypeInfo, isDecide);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndCloseBuyFrameConfirmPurchase__, v6);
    byte_40FC76B = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  ...
  if ( !purchaseConfirmMenu )
    sub_B170D4();
  ServantFramePurchaseConfirmMenu__Close_29594984(purchaseConfirmMenu, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC766 & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_ServantFramePurchaseMenu_SelectedBuyBankItemConfirm__, v5);
...
LABEL_8:
  ...
  if ( !purchaseConfirmMenu )
    goto LABEL_8;
  ServantFramePurchaseConfirmMenu__Close_29594984(purchaseConfirmMenu, 0LL, method);
  ServantFramePurchaseMenu__Callback(this, 0, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC76A & 1) == 0 )
  {
    sub_B16FFC(&ServantFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, result);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndBuyFrameResultConfirm__, v4);
    byte_40FC76A = 1;
  }
  purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
  this->fields.state = 7;
  if ( !purchaseConfirmMenu
    || (ServantFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, (const MethodInfo *)result),
        ...
        v12 = (ServantFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B170CC(
  ...
  ServantFramePurchaseConfirmMenu__Open(v6, 2, stoneShopEntity, v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  struct ServantFramePurchaseConfirmMenu_o *v45; // x20
  ServantFramePurchaseConfirmMenu_CallbackFunc_o *v46; // x22
  const MethodInfo *v47; // x4
  int32_t v48; // w1
  ServantFramePurchaseConfirmMenu_o *v49; // x0
  struct ServantFramePurchaseConfirmMenu_o *v50; // x20
  ServantFramePurchaseConfirmMenu_CallbackFunc_o *v51; // x21
  StoneShopEntity_o *v52; // x2
  ServantFramePurchaseConfirmMenu_CallbackFunc_o *v53; // x3
  struct ServantFramePurchaseConfirmMenu_o *purchaseConfirmMenu; // x20

  if ( (byte_40FC765 & 1) == 0 )
  {
    sub_B16FFC(&BalanceConfig_TypeInfo, callback);
    sub_B16FFC(&ServantFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, v11);
    sub_B16FFC(&Method_DataManager_GetMasterData_StoneShopMaster___, v12);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndBuyFrameConfirm__, v13);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndBuyStoneConfirm__, v14);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndMaxFrameConfirm__, v15);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndNoShopConfirm__, v16);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( v36 )
    {
      ...
      if ( svtKeep < v43->static_fields->ServantFrameMax )
      {
        stoneShopEntity = this->fields.stoneShopEntity;
        if ( stoneShopEntity )
        {
          if ( SelfUserGame->fields.stone >= stoneShopEntity->fields.price )
          {
            this->fields.state = 3;
            purchaseConfirmMenu = this->fields.purchaseConfirmMenu;
            v46 = (ServantFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B170CC(
                                                                      ServantFramePurchaseConfirmMenu_CallbackFunc_TypeInfo,
                                                                      v38,
                                                                      v39,
                                                                      v40,
...
LABEL_28:
      ...
      v51 = (ServantFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B170CC(
                                                                ServantFramePurchaseConfirmMenu_CallbackFunc_TypeInfo,
                                                                v38,
                                                                v39,
                                                                v40,
    ...
    v53 = v51;
LABEL_27:
    ServantFramePurchaseConfirmMenu__Open(v49, v48, v52, v53, v47);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC769 & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndRequestServantFramePurchase__, v8);
    byte_40FC769 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo *v10; // x2
  ServantFramePurchaseConfirmMenu_o *purchaseConfirmMenu; // x0
  struct ServantFramePurchaseConfirmMenu_o *v12; // x20
  struct StoneShopEntity_o *stoneShopEntity; // x21
  __int64 v14; // x1
  __int64 v15; // x2
  __int64 v16; // x3
  __int64 v17; // x4
  ServantFramePurchaseConfirmMenu_CallbackFunc_o *v18; // x22
  const MethodInfo *v19; // x4
  int32_t v20; // w1
  ServantFramePurchaseConfirmMenu_o *v21; // x0
  StoneShopEntity_o *v22; // x2
  ServantFramePurchaseMenu_o *v23; // x0
  int32_t v24; // w1
  ServantFramePurchaseConfirmMenu_o *v25; // x0
  struct ServantFramePurchaseConfirmMenu_o *v26; // x21
  ...
  if ( (byte_40FC767 & 1) == 0 )
  {
    sub_B16FFC(&ServantFramePurchaseConfirmMenu_CallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndBuyFrameConfirm__, v5);
    sub_B16FFC(&Method_ServantFramePurchaseMenu_EndBuyStoneConfirm__, v6);
...
LABEL_15:
  ...
  switch ( result )
  {
    ...
    case 4:
      ...
      if ( !purchaseConfirmMenu )
        goto LABEL_15;
      ServantFramePurchaseConfirmMenu__Init(purchaseConfirmMenu, v9);
      v12 = this->fields.purchaseConfirmMenu;
      stoneShopEntity = this->fields.stoneShopEntity;
      v18 = (ServantFramePurchaseConfirmMenu_CallbackFunc_o *)sub_B170CC(
                                                                ServantFramePurchaseConfirmMenu_CallbackFunc_TypeInfo,
                                                                v14,
                                                                v15,
                                                                v16,
    ...
    case 2:
      ...
      if ( !v25 )
        goto LABEL_15;
      ServantFramePurchaseConfirmMenu__Init(v25, v9);
      ...
      v22 = v27;
LABEL_14:
      ServantFramePurchaseConfirmMenu__Open(v21, v20, v22, v18, v19);
      break;
    case 3:
      v23 = this;
      v24 = 0;
LABEL_10:
      ServantFramePurchaseMenu__Callback(v23, v24, v10);
      break;
    default:
      return;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FC763 & 1) == 0 )
  {
    sub_B16FFC(&ServantFramePurchaseMenu_CallbackFunc_TypeInfo, value);
    byte_40FC763 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F7631 & 1) == 0 )
  {
    sub_B16FFC(&ServantFramePurchaseMenu_Result_TypeInfo, *(_QWORD *)&result);
    byte_40F7631 = 1;
  }
  v9[1] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  ServantFramePurchaseMenu_CallbackFunc_o *v18; // x8
  __int64 *v19; // x21
  __int64 v20; // x22
  ...
  ServantFramePurchaseMenu_CallbackFunc_o *v31; // [xsp+8h] [xbp-48h] BYREF
