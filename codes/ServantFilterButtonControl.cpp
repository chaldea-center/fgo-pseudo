void __fastcall ServantFilterButtonControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B23FE & 1) == 0 )
  {
    sub_B52984(&ServantFilterButtonControl_TypeInfo);
  ...
  v9->SPRITE_NAME_DISABLE = (struct System_String_o *)StringLiteral_17075/*"btn_bg_04"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->SPRITE_NAME_DISABLE, v10, v11, v12, v13, v14, v15, v16);
}
...
LABEL_8:
  ...
  sub_B52920((BattleServantConfConponent_o *)&this->fields.onClickFilterEvent, 0LL, v13, v14, v15, v16, v17, v18);
  this[1].klass = 0LL;
  sub_B52920((BattleServantConfConponent_o *)&this[1], 0LL, v30, v31, v32, v33, v34, v35);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B23FB & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_11952/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_FIND"*/);
    sub_B52984(&StringLiteral_11953/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_GET"*/);
    byte_42B23FB = 1;
  }
  if ( isSummon )
  {
    ...
    if ( button == 11 )
    {
      ...
      v7 = LocalizationManager__Get((System_String_o *)StringLiteral_11952/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_FIND"*/, 0LL);
      if ( !targetSort )
        goto LABEL_17;
      UILabel__set_text(targetSort, v7, 0LL);
      button = (int)this->fields.button;
    }
    if ( button == 12 )
    {
      v9 = (UILabel_o *)this->fields.targetSort;
      if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
        && !LocalizationManager_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      }
      v7 = LocalizationManager__Get((System_String_o *)StringLiteral_11953/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_GET"*/, 0LL);
      if ( v9 )
      {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B23FD & 1) == 0 )
  {
    sub_B52984(&StringLiteral_357/*"#303030"*/);
    byte_42B23FD = 1;
  }
...
LABEL_12:
    sub_B52A5C(buttonSprite, isActive);
  }
  if ( !UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_357/*"#303030"*/, &gray, 0LL) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B23FA & 1) == 0 )
  {
    sub_B52984(&Method_System_Linq_Enumerable_Contains_ListViewSort_FilterKind___);
...
LABEL_18:
  ...
  if ( System_Linq_Enumerable__Contains_ListViewSort_FilterKind_(
         v5,
         (int32_t)this->fields.button,
         (const MethodInfo_1B5C0B0 *)Method_System_Linq_Enumerable_Contains_ListViewSort_FilterKind___)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD340 & 1) == 0 )
  {
    sub_B52984(&ListViewSort_FilterKind_TypeInfo);
    byte_42AD340 = 1;
  }
  v9[1] = 0LL;
...
LABEL_5:
    ...
    while ( 1 )
    {
      ...
      if ( *(__int16 *)(v22 + 72) == -1 )
        sub_B52A40(*(_QWORD *)&v20->fields.extra_arg, *(_QWORD *)&filterKind, method, v3);
