void ServantFilterButtonControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CE96DC & 1) == 0 )
  {
    sub_1C7BAE8(&ServantFilterButtonControl_TypeInfo);
    sub_1C7BAE8(&StringLiteral_17527/*"btn_bg_04"*/);
    sub_1C7BAE8(&StringLiteral_17526/*"btn_bg_03"*/);
    byte_4CE96DC = 1;
  }
  ServantFilterButtonControl_TypeInfo->static_fields->SPRITE_NAME_ENABLE = (struct System_String_o *)StringLiteral_17526/*"btn_bg_03"*/;
  sub_1C7BA8C(
  ...
  static_fields->SPRITE_NAME_DISABLE = (struct System_String_o *)StringLiteral_17527/*"btn_bg_04"*/;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&static_fields->SPRITE_NAME_DISABLE, v7, v9, v10, v11, v12, v13, v14);
}
...
LABEL_8:
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.targetSort, 0, v15, v16, v17, v18, v19, v20);
  this->fields.onClickFilterEvent = 0;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.onClickFilterEvent, 0, v32, v33, v34, v35, v36, v37);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE96D9 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_11842/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_FIND"*/);
    sub_1C7BAE8(&StringLiteral_11831/*"SERVANT_SORT_FILTER_KIND_CLASS_33_OTHERS"*/);
    sub_1C7BAE8(&StringLiteral_11843/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_GET"*/);
    byte_4CE96D9 = 1;
  }
  if ( isSummon )
  {
    ...
    if ( filterKind == 11 )
    {
      ...
      v9 = LocalizationManager__Get((System_String_o *)StringLiteral_11842/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_FIND"*/, 0);
      if ( !buttonText )
        goto LABEL_21;
    ...
    if ( filterKind == 12 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v9 = LocalizationManager__Get((System_String_o *)StringLiteral_11843/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_GET"*/, 0);
      if ( !v11 )
        goto LABEL_21;
  ...
  if ( isClassOthers && this->fields.filterKind == 64 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = LocalizationManager__Get((System_String_o *)StringLiteral_11831/*"SERVANT_SORT_FILTER_KIND_CLASS_33_OTHERS"*/, 0);
    if ( v12 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE96DB & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_407/*"#303030"*/);
    byte_4CE96DB = 1;
  }
  v8 = 0u;
  button = (UnityEngine_Behaviour_o *)this->fields.button;
...
void ServantFilterButtonControl__SetCondensedScaleButtons(ServantFilterButtonControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CE96D8 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Linq_Enumerable_Contains_ListViewSort_FilterKind___);
...
LABEL_17:
  ...
  if ( System_Linq_Enumerable__Contains_Int32Enum_(
         ...
         (const MethodInfo_318C7F0 *)Method_System_Linq_Enumerable_Contains_ListViewSort_FilterKind___)
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AAA010;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AA9FC8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE96DD & 1) == 0 )
  {
    sub_1C7BAE8(&ListViewSort_FilterKind_TypeInfo);
    byte_4CE96DD = 1;
  }
  v9[1] = 0;
