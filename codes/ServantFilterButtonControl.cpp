void __fastcall ServantFilterButtonControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A03F63 & 1) == 0 )
  {
    sub_1B686D4(&ServantFilterButtonControl_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_17406/*"btn_bg_04"*/, v2);
    sub_1B686D4(&StringLiteral_17405/*"btn_bg_03"*/, v3);
    byte_4A03F63 = 1;
  }
  ServantFilterButtonControl_TypeInfo->static_fields->SPRITE_NAME_ENABLE = (struct System_String_o *)StringLiteral_17405/*"btn_bg_03"*/;
  sub_1B68678(ServantFilterButtonControl_TypeInfo->static_fields);
  static_fields = ServantFilterButtonControl_TypeInfo->static_fields;
  static_fields->SPRITE_NAME_DISABLE = (struct System_String_o *)StringLiteral_17406/*"btn_bg_04"*/;
  sub_1B68678(&static_fields->SPRITE_NAME_DISABLE);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( isDisplay )
  {
    *p_targetSort = targetSort;
    sub_1B68678(&this->fields.targetSort);
    if ( !*p_targetSort )
    {
LABEL_6:
      this->fields.onClickFilterEvent = onClickFilter;
      sub_1B68678(&this->fields.onClickFilterEvent);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03F60 & 1) == 0 )
  {
    sub_1B686D4(&LocalizationManager_TypeInfo, isSummon);
    sub_1B686D4(&StringLiteral_11706/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_FIND"*/, v7);
    sub_1B686D4(&StringLiteral_11695/*"SERVANT_SORT_FILTER_KIND_CLASS_33_OTHERS"*/, v8);
    sub_1B686D4(&StringLiteral_11707/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_GET"*/, v9);
    byte_4A03F60 = 1;
  }
  if ( isSummon )
  {
    ...
    if ( filterKind == 11 )
    {
      ...
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_11706/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_FIND"*/, 0LL);
      if ( !buttonText )
        goto LABEL_21;
    ...
    if ( filterKind == 12 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_11707/*"SERVANT_SORT_FILTER_KIND_COLLECTION_SUMMON_GET"*/, 0LL);
      if ( !v14 )
        goto LABEL_21;
  ...
  if ( isClassOthers && this->fields.filterKind == 64 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_11695/*"SERVANT_SORT_FILTER_KIND_CLASS_33_OTHERS"*/, 0LL);
    if ( v15 )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03F61 & 1) == 0 )
  {
    sub_1B686D4(&ServantFilterButtonControl_TypeInfo, method);
    byte_4A03F61 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03F62 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_439/*"#303030"*/, isActive);
    byte_4A03F62 = 1;
  }
  v11 = 0uLL;
  button = (UnityEngine_Behaviour_o *)this->fields.button;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03F5F & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Linq_Enumerable_Contains_ListViewSort_FilterKind___, method);
    sub_1B686D4(&FilterKindList_TypeInfo, v3);
    sub_1B686D4(&Method_System_Collections_Generic_List_ListViewSort_FilterKind__ToArray__, v4);
    byte_4A03F5F = 1;
  }
...
LABEL_17:
  ...
  if ( System_Linq_Enumerable__Contains_Int32Enum_(
         v7,
         this->fields.filterKind,
         (const MethodInfo_2E63A34 *)Method_System_Linq_Enumerable_Contains_ListViewSort_FilterKind___)
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A8E8C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A8E44;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03F64 & 1) == 0 )
  {
    sub_1B686D4(&ListViewSort_FilterKind_TypeInfo, *(_QWORD *)&filterKind);
    byte_4A03F64 = 1;
  }
  v9[1] = 0LL;
