        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F26E & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v7);
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4972/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_22;
...
LABEL_22:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v22 = System_String__Concat_61535060((System_String_o *)StringLiteral_13530/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v23 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B7640C(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_40435056(v21, v22, v23, 0, 0, 0, v25);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F26D & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v6);
  ...
  if ( this->fields.isSkip )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.figure, 0, v12, v13);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_69287408(gameObject, 0LL);
  ...
  {
    v15 = System_String__Concat_61535060((System_String_o *)StringLiteral_15654/*"Wipe/"*/, this->fields.wipeName, 0LL);
