void CharaWipeTimeReverseEffectComponent___ctor(CharaWipeTimeReverseEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5939D33 & 1) == 0 )
  {
    sub_21FFC50(&StringLiteral_18725/*"circleOut"*/);
    byte_5939D33 = 1;
  }
  v9 = (struct System_String_o *)StringLiteral_18725/*"circleOut"*/;
        ...
        const MethodInfo *method)
{
  ...
  v6 = TweenRenderVolume__Begin(gameObject, this->fields.duration, this->fields.maxAlpha, 0);
  if ( !v6 )
    sub_21FFECC(0, v7);
  v8 = v6;
  v6->fields.method = 1;
        ...
        const MethodInfo *method)
{
  ...
  CommonEffectLoadComponent_LoadEndHandler_o *v21; // x22
  ...
  if ( (byte_5939D2E & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__);
    ...
    sub_21FFC50(&StringLiteral_5114/*"Custom/Sprite-ScriptActionFigureWipe"*/);
    byte_5939D2E = 1;
  }
  ...
  this->fields.maxAlpha = 1.2039 - effectRange;
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5114/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0);
  if ( !data )
    goto LABEL_22;
...
LABEL_22:
  ...
  ((void (__fastcall *)(CharaWipeTimeReverseEffectComponent_o *, const MethodInfo *, double))this->klass->vtable._41_SetTweenVolume.methodPtr)(
    this,
  ...
  {
    v19 = this->fields.subEffectBase;
    v20 = System_String__Concat_75438412((System_String_o *)StringLiteral_14162/*"Talk/"*/, this->fields.subEffectName, 0);
    v21 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_21FFEBC(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_50652356(v19, v20, v21, 0, 0, 0, v24);
  }
  else
  {
    CharaWipeTimeReverseEffectComponent__EndCreateEffect(this, 0, v18);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0, 0) )
  {
    ...
    UIStandFigureRender__SetAlpha(v12, 1.0, 0);
    this->fields.figure = 0;
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.figure, 0, v13, v14, v15, v16, v17, v18);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&AssetManager_TypeInfo);
    sub_21FFC50(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__);
  ...
  if ( this->fields.isSkip )
  {
    ...
    this->fields.figure = 0;
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.figure, 0, v12, v13, v14, v15, v16, v17);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
    if ( !*(&UnityEngine_Object_TypeInfo->_2.cctor_finished + 1) )
  ...
  {
    v20 = System_String__Concat_75438412((System_String_o *)StringLiteral_16245/*"Wipe/"*/, this->fields.wipeName, 0);
