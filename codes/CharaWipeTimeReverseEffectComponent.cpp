        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187CA1 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v11);
  ...
  if ( !figure )
    goto LABEL_25;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4535/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_25;
...
LABEL_25:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v26 = System_String__Concat_44305532((System_String_o *)StringLiteral_13554/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v27 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_B2C42C(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_17920404(v25, v26, v27, 0, 0, 0, 0LL);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4187CA0 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v10);
  ...
  if ( this->fields.isSkip )
  {
    ...
    sub_B2C2F8((BattleServantConfConponent_o *)&this->fields.figure, 0LL, v16, v17, v18, v19, v20, v21);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    {
  ...
  {
    v23 = System_String__Concat_44305532((System_String_o *)StringLiteral_15496/*"Wipe/"*/, this->fields.wipeName, 0LL);
