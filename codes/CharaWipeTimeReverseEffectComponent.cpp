        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD71B & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v7);
  ...
  figure = (UIStandFigureRender_o *)this->fields.figure;
  v16 = 1.2039 - this->fields.effectRange;
  this->fields.bodySize.fields.y = BodySize.fields.y;
  this->fields.maxAlpha = v16;
...
LABEL_22:
  ...
  {
    CharaWipeTimeReverseEffectComponent__EndCreateEffect(this, 0LL, v19);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD71A & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v6);
