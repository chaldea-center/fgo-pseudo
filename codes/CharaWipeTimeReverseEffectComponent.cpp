        ...
        const MethodInfo *method)
{
  ...
  UIStandFigureRender_o *v25; // x0
  UIStandFigureRender_o *v26; // x0
  ...
  if ( (byte_40FAF12 & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v11);
    ...
    sub_B16FFC(&StringLiteral_13498/*"Talk/"*/, v15);
    sub_B16FFC(&StringLiteral_4517/*"Custom/Sprite-ScriptActionFigureWipe"*/, v16);
    byte_40FAF12 = 1;
  }
  ...
  if ( !v20 )
    goto LABEL_25;
  UIStandFigureRender__SetSharder(v20, (System_String_o *)StringLiteral_4517/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_25;
  ...
  if ( !v22
    || (UIStandFigureRender__SetWipeTexture(v22, Object_Texture2D, 0LL),
        (v24 = (UIStandFigureRender_o *)this->fields.figure) == 0LL)
    || (UIStandFigureRender__SetFilterColor(v24, this->fields.wipeColor, 0LL),
        (v25 = (UIStandFigureRender_o *)this->fields.figure) == 0LL)
    || (UIStandFigureRender__SetGradation(v25, 0.2, 0LL), (v26 = (UIStandFigureRender_o *)this->fields.figure) == 0LL) )
  {
LABEL_25:
    sub_B170D4();
  }
  UIStandFigureRender__SetAlpha(v26, 1.0, 0LL);
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v30 = System_String__Concat_43743732((System_String_o *)StringLiteral_13498/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v35 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_B170CC(
    ...
    CommonEffectManager__Create_18186748(v29, v30, v35, 0, 0, 0, 0LL);
  }
  else
  {
    CharaWipeTimeReverseEffectComponent__EndCreateEffect(this, 0LL, v28);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FAF11 & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v10);
  ...
  if ( this->fields.isSkip )
  {
    ...
    sub_B16F98((BattleServantConfConponent_o *)&this->fields.figure, 0LL, v15, v16, v17, v18, v19, v20);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    {
  ...
  else
  {
    ...
    AssetManager__loadAssetStorage(v22, v27, 1, 0LL);
  }
}