        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DFF & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_17924/*"circleOut"*/, method);
    byte_4A20DFF = 1;
  }
  *(_QWORD *)&this->fields.wipeColor.fields.r = 0LL;
  *(_QWORD *)&this->fields.wipeColor.fields.b = 0LL;
  v5 = StringLiteral_17924/*"circleOut"*/;
  this->fields.wipeName = (struct System_String_o *)StringLiteral_17924/*"circleOut"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.wipeName, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DFB & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_9861/*"OnEndEffect"*/, method);
    byte_4A20DFB = 1;
  }
  klass = this->klass;
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v7->fields.eventReceiver, (int32_t)v8, v9, v10);
  v11 = StringLiteral_9861/*"OnEndEffect"*/;
  v7->fields.callWhenFinished = (struct System_String_o *)StringLiteral_9861/*"OnEndEffect"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v7->fields.callWhenFinished, v11, v12, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.childEffect, (int32_t)effect, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DFA & 1) == 0 )
  {
    sub_1B715CC(&Method_AssetData_GetObject_Texture2D___, data);
    sub_1B715CC(&AssetManager_TypeInfo, v6);
    sub_1B715CC(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v7);
    sub_1B715CC(&CommonEffectManager_TypeInfo, v8);
    sub_1B715CC(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v9);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v10);
    sub_1B715CC(&StringLiteral_13488/*"Talk/"*/, v11);
    sub_1B715CC(&StringLiteral_4954/*"Custom/Sprite-ScriptActionFigureWipe"*/, v12);
    byte_4A20DFA = 1;
  }
  ...
  if ( wipeData )
  {
    ...
    AssetManager__releaseAsset_37587324(wipeData, 0LL);
  }
  this->fields.wipeData = data;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.wipeData, (int32_t)data, (int32_t)method, v3);
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4954/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_22;
...
LABEL_22:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v22 = System_String__Concat_61505504((System_String_o *)StringLiteral_13488/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v23 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1B71818(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_40407624(v21, v22, v23, 0, 0, 0, v25);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( wipeData )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.wipeData, 0, v5, v6);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    p_figure->klass = 0LL;
    sub_1B71570(p_figure, 0, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DF9 & 1) == 0 )
  {
    sub_1B715CC(&AssetManager_TypeInfo, figure);
    sub_1B715CC(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v6);
    sub_1B715CC(&AssetLoader_LoadEndDataHandler_TypeInfo, v7);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v8);
    sub_1B715CC(&StringLiteral_15610/*"Wipe/"*/, v9);
    byte_4A20DF9 = 1;
  }
  p_figure = (UIStandFigureRender_o **)&this->fields.figure;
  this->fields.figure = figure;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.figure, (int32_t)figure, (int32_t)method, v3);
  if ( this->fields.isSkip )
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.figure, 0, v12, v13);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_69257852(gameObject, 0LL);
  ...
  {
    v15 = System_String__Concat_61505504((System_String_o *)StringLiteral_15610/*"Wipe/"*/, this->fields.wipeName, 0LL);
