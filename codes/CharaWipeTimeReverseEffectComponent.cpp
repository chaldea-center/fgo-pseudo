        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C4A1 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__);
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4973/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_22;
...
LABEL_22:
  ...
  {
    CharaWipeTimeReverseEffectComponent__EndCreateEffect(this, 0LL, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&AssetManager_TypeInfo);
    sub_1B885B0(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__);
