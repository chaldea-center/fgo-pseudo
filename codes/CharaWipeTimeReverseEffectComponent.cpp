        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8A6D & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__);
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4931/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0);
  if ( !data )
    goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&AssetManager_TypeInfo);
    sub_1C713B0(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__);
