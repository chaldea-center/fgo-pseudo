        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEB6E & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v11);
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5067/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEB6D & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v10);
