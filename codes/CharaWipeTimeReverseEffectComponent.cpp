        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2339D & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_18321/*"downbutton"*/, method);
    byte_4C2339D = 1;
  }
  *(_QWORD *)&this->fields.wipeColor.fields.r = 0LL;
  *(_QWORD *)&this->fields.wipeColor.fields.b = 0LL;
  v9 = StringLiteral_18321/*"downbutton"*/;
  this->fields.wipeName = (struct System_String_o *)StringLiteral_18321/*"downbutton"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23398 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v11);
    sub_1C3B764(&CommonEffectManager_TypeInfo, v12);
    sub_1C3B764(&CommonEffectLoadComponent_LoadEndHandler_TypeInfo, v13);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v14);
    sub_1C3B764(&StringLiteral_13830/*"The required attribute must have a value of yes or no."*/, v15);
    sub_1C3B764(&StringLiteral_5067/*"DataTable.ExtendedProperties"*/, v16);
    byte_4C23398 = 1;
  }
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_5067/*"DataTable.ExtendedProperties"*/, 0LL);
  if ( !data )
    goto LABEL_22;
...
LABEL_22:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v26 = System_String__Concat_63368612((System_String_o *)StringLiteral_13830/*"The required attribute must have a value of yes or no."*/, this->fields.subEffectName, 0LL);
    v27 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1C3B9B0(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_42109636(v25, v26, v27, 0, 0, 0, v29);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( wipeData )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.wipeData, 0LL, v5, v6, v7, v8, v9, v10);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(figure, 0LL, 0LL) )
  {
    ...
    p_figure->klass = 0LL;
    sub_1C3B708(p_figure, 0LL, v15, v16, v17, v18, v19, v20);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2339A & 1) == 0 )
  {
    sub_1C3B764(&CommonEffectManager_TypeInfo, method);
    byte_4C2339A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23397 & 1) == 0 )
  {
    sub_1C3B764(&AssetManager_TypeInfo, figure);
    sub_1C3B764(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v10);
    sub_1C3B764(&AssetLoader_LoadEndDataHandler_TypeInfo, v11);
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v12);
    sub_1C3B764(&StringLiteral_15969/*"_RandomTexture"*/, v13);
    byte_4C23397 = 1;
  }
  p_figure = (UIStandFigureRender_o **)&this->fields.figure;
  this->fields.figure = figure;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.figure, (int64_t)figure, (int64_t)method, v3, v4, v5, v6, v7);
  if ( this->fields.isSkip )
  {
    ...
    sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.figure, 0LL, v16, v17, v18, v19, v20, v21);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_71122748(gameObject, 0LL);
  ...
  {
    v23 = System_String__Concat_63368612((System_String_o *)StringLiteral_15969/*"_RandomTexture"*/, this->fields.wipeName, 0LL);
