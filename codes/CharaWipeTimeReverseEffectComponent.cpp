        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03526 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v7);
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4897/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_22;
...
LABEL_22:
    ...
    && !System_String__IsNullOrEmpty(this->fields.subEffectName, 0LL) )
  {
    ...
    v22 = System_String__Concat_62348648((System_String_o *)StringLiteral_13502/*"Talk/"*/, this->fields.subEffectName, 0LL);
    v23 = (CommonEffectLoadComponent_LoadEndHandler_o *)sub_1BC3254(CommonEffectLoadComponent_LoadEndHandler_TypeInfo);
    ...
    CommonEffectManager__Create_42594492(v21, v22, v23, 0, 0, 0, v25);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03525 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v6);
  ...
  if ( this->fields.isSkip )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.figure, 0, v12, v13);
    gameObject = (UnityEngine_Object_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    UnityEngine_Object__Destroy_70034300(gameObject, 0LL);
  ...
  {
    v15 = System_String__Concat_62348648((System_String_o *)StringLiteral_15513/*"Wipe/"*/, this->fields.wipeName, 0LL);
