        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F79 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CharaWipeTimeReverseEffectComponent_EndCreateEffect__, v7);
  ...
  if ( !figure )
    goto LABEL_22;
  UIStandFigureRender__SetSharder(figure, (System_String_o *)StringLiteral_4977/*"Custom/Sprite-ScriptActionFigureWipe"*/, 0LL);
  if ( !data )
    goto LABEL_22;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F78 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CharaWipeTimeReverseEffectComponent_EndLoadWipe__, v6);
