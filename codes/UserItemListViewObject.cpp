...
void __fastcall UserItemListViewObject__Awake(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB12B2 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___, method);
    byte_4AB12B2 = 1;
  }
  ...
  this->fields.itemDraw = (struct UserItemListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                 dispObject,
                                                                 (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB12B3 & 1) == 0 )
  {
    sub_1BAB41C(&UserItemListViewItem_TypeInfo, method);
    byte_4AB12B3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB12B5 & 1) == 0 )
  {
    sub_1BAB41C(&UserItemListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4AB12B5 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_31415292(
        UserItemListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_31416628(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_31416712(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserItemListViewObject__OnClickSelect(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB12B7 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UserItemListViewObject_OnClickSelect__, method);
  ...
  if ( this->fields.linkItem )
  {
    ...
    if ( (*((_BYTE *)Method_UserItemListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BAB434(Method_UserItemListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB12B4 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UserItemListViewItem_TypeInfo, v5);
    byte_4AB12B4 = 1;
  }
...
void __fastcall UserItemListViewObject__SetupDisp(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB12B6 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&UserItemListViewItem_TypeInfo, v3);
    byte_4AB12B6 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall UserItemListViewObject__Start(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    UserItemListViewObject__Init_31415292(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (UserItemListViewObject_o *)sub_1BAB938(v8);
