...
void __fastcall UserItemListViewObject__Awake(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF8AF6 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___, method);
    byte_4BF8AF6 = 1;
  }
  ...
  this->fields.itemDraw = (struct UserItemListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                 dispObject,
                                                                 (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8AF7 & 1) == 0 )
  {
    sub_1C2E12C(&UserItemListViewItem_TypeInfo, method);
    byte_4BF8AF7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8AF9 & 1) == 0 )
  {
    sub_1C2E12C(&UserItemListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4BF8AF9 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_32105168(
        UserItemListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_32106504(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_32106588(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserItemListViewObject__OnClickSelect(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF8AFB & 1) == 0 )
  {
    sub_1C2E12C(&Method_UserItemListViewObject_OnClickSelect__, method);
  ...
  if ( this->fields.linkItem )
  {
    ...
    if ( (*((_BYTE *)Method_UserItemListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C2E144(Method_UserItemListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8AF8 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&UserItemListViewItem_TypeInfo, v5);
    byte_4BF8AF8 = 1;
  }
...
void __fastcall UserItemListViewObject__SetupDisp(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BF8AFA & 1) == 0 )
  {
    ...
    sub_1C2E12C(&UserItemListViewItem_TypeInfo, v3);
    byte_4BF8AFA = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall UserItemListViewObject__Start(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    UserItemListViewObject__Init_32105168(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (UserItemListViewObject_o *)sub_1C2E648(v8);
