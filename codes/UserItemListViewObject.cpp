...
{
  if ( (qword_4B62000 & 0x1000000) == 0 )
  {
    sub_1BE4ACC(&ListViewObject_TypeInfo, method);
    BYTE3(qword_4B62000) = 1;
  }
...
void __fastcall UserItemListViewObject__Awake(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61FFD & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___, method);
    byte_4B61FFD = 1;
  }
  ...
  this->fields.itemDraw = (struct UserItemListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                 dispObject,
                                                                 (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61FFE & 1) == 0 )
  {
    sub_1BE4ACC(&UserItemListViewItem_TypeInfo, method);
    byte_4B61FFE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (qword_4B62000 & 1) == 0 )
  {
    sub_1BE4ACC(&UserItemListViewItem_TypeInfo, *(_QWORD *)&initMode);
    LOBYTE(qword_4B62000) = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
    && (methodPtr_low = LOBYTE(UserItemListViewItem_TypeInfo->vtable._0_Equals.methodPtr),
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_31807844(
        UserItemListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_31809180(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_31809264(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserItemListViewObject__OnClickSelect(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_4B62000 & 0x10000) == 0 )
  {
    sub_1BE4ACC(&Method_UserItemListViewObject_OnClickSelect__, method);
    sub_1BE4ACC(&StringLiteral_10003/*"OnClickListView"*/, v3);
    BYTE2(qword_4B62000) = 1;
  }
  if ( this->fields.linkItem )
  {
    v4 = Method_UserItemListViewObject_OnClickSelect__;
    if ( (*((_BYTE *)Method_UserItemListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BE4AE4(Method_UserItemListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61FFF & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&UserItemListViewItem_TypeInfo, v5);
    byte_4B61FFF = 1;
  }
...
void __fastcall UserItemListViewObject__SetupDisp(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (qword_4B62000 & 0x100) == 0 )
  {
    sub_1BE4ACC(&UnityEngine_Object_TypeInfo, method);
    sub_1BE4ACC(&UserItemListViewItem_TypeInfo, v3);
    BYTE1(qword_4B62000) = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
    goto LABEL_7;
...
void __fastcall UserItemListViewObject__Start(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    UserItemListViewObject__Init_31807844(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (UserItemListViewObject_o *)sub_1BE4FE8(v8);
