...
void __fastcall UserItemListViewObject__Awake(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E7188 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42E7188 = 1;
  }
  ...
  Component_srcLineSprite = (struct UserItemListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                   dispObject,
                                                                   (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E7189 & 1) == 0 )
  {
    sub_B5D5C4(&UserItemListViewItem_TypeInfo, (_DWORD)method, v2, v3);
    byte_42E7189 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
    return 0LL;
  v6 = *(&UserItemListViewItem_TypeInfo->_2.bitflags2 + 1);
  if ( *(&linkItem->klass->_2.bitflags2 + 1) < (unsigned int)v6 )
    return 0LL;
  if ( (UserItemListViewItem_c *)linkItem->klass->_2.typeHierarchy[v6 - 1] == UserItemListViewItem_TypeInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E718B & 1) == 0 )
  {
    sub_B5D5C4(&UserItemListViewItem_TypeInfo, initMode, (_DWORD)callbackFunc, method);
    byte_42E718B = 1;
  }
  linkItem = this->fields.linkItem;
  ...
  if ( (unsigned int)v13 <= 3 )
  {
    ...
    this->fields.dispMode = *((_DWORD *)&xmmword_32A1640 + v13);
...
void __fastcall UserItemListViewObject__Init_22517672(
        UserItemListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_22518952(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_22519016(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  UserItemListViewItemDraw_o *v14; // x0
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v13);
    UserItemListViewItemDraw__SetInput(v14, (UserItemListViewItem_o *)v13, isInput, v10);
  }
}
...
void __fastcall UserItemListViewObject__SetupDisp(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42E718C & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserItemListViewItem_TypeInfo, v5, v6, v7);
    byte_42E718C = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v9
      && (UserItemListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == UserItemListViewItem_TypeInfo )
    {
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v12);
    UserItemListViewItemDraw__SetItem(v14, (UserItemListViewItem_o *)linkItem, this->fields.dispMode, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x0
  bool v11; // zf
  UserItemListViewObject_o *v12; // x0
  ...
  v12 = (UserItemListViewObject_o *)sub_B5D990(v9);
  UserItemListViewObject__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = (UserItemListViewObject_o *)sub_B5D990(v9);
  UserItemListViewObject__Awake(v12, v13);
}