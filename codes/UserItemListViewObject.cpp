...
void __fastcall UserItemListViewObject__Awake(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17693 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___, method);
    byte_4B17693 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_UserItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17694 & 1) == 0 )
  {
    sub_1BCAFF8(&UserItemListViewItem_TypeInfo, method);
    byte_4B17694 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17696 & 1) == 0 )
  {
    sub_1BCAFF8(&UserItemListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B17696 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_32489348(
        UserItemListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_32490684(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall UserItemListViewObject__Init_32490768(
        UserItemListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall UserItemListViewObject__OnClickSelect(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17698 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UserItemListViewObject_OnClickSelect__, method);
  ...
  if ( this->fields.linkItem )
  {
    ...
    if ( (*((_BYTE *)Method_UserItemListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BCB010(Method_UserItemListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17695 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UserItemListViewItem_TypeInfo, v5);
    byte_4B17695 = 1;
  }
...
void __fastcall UserItemListViewObject__SetupDisp(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17697 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UserItemListViewItem_TypeInfo, v3);
    byte_4B17697 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
...
void __fastcall UserItemListViewObject__Start(UserItemListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
    UserItemListViewObject__Init_32489348(this, 2, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  v11 = (UserItemListViewObject_o *)sub_1BCB514(v8);
