...
System_String_o *__fastcall AuCreateSeedRequest__getURL(AuCreateSeedRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1D4B & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_22291/*"shop/createSeed"*/);
    byte_42B1D4B = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_22291/*"shop/createSeed"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1D4C & 1) == 0 )
  {
    ...
    this = (AuCreateSeedRequest_o *)sub_B52984(&StringLiteral_22133/*"seed"*/);
    byte_42B1D4C = 1;
  }
  value = 0LL;
  if ( !v3 )
LABEL_19:
    sub_B52A5C(this, responseList);
    ...
    while ( 1 )
    {
      ...
      if ( ((unsigned __int8)this & 1) != 0 )
      {
        ...
        this = (AuCreateSeedRequest_o *)System_Collections_Generic_Dictionary_XmlQualifiedName__XmlSchemaObject___ContainsKey(
                                          ...
                                          (System_Xml_XmlQualifiedName_o *)StringLiteral_22133/*"seed"*/,
