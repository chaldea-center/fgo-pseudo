void __fastcall MapGimmickMaster___ctor(MapGimmickMaster_o *this, const MethodInfo *method)
{
  if ( (byte_40FB5E7 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataMasterBase_MapGimmickMaster__MapGimmickEntity__int___ctor__, method);
    byte_40FB5E7 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    22,
    (const MethodInfo_266F2EC *)Method_DataMasterBase_MapGimmickMaster__MapGimmickEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FB5E8 & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_System_Collections_Generic_List_MapGimmickEntity__Add__, v8);
    sub_B16FFC(&Method_System_Collections_Generic_List_MapGimmickEntity__ToArray__, v9);
    sub_B16FFC(&Method_System_Collections_Generic_List_MapGimmickEntity___ctor__, v10);
    sub_B16FFC(&System_Collections_Generic_List_MapGimmickEntity__TypeInfo, v11);
    sub_B16FFC(&MapGimmickEntity_TypeInfo, v12);
    byte_40FB5E8 = 1;
  }
  ...
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v13,
    (const MethodInfo_2F25014 *)Method_System_Collections_Generic_List_MapGimmickEntity___ctor__);
                  ...
                  (const MethodInfo_290DE84 *)Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__) )
  {
    ...
    if ( Item )
    {
      v18 = *(&MapGimmickEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(&Item->klass->_2.bitflags2 + 1) >= (unsigned int)v18
        && (MapGimmickEntity_c *)Item->klass->_2.typeHierarchy[v18 - 1] == MapGimmickEntity_TypeInfo
        && Item->fields.missionConditionDetailId == map_id )
      {
        ...
        System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
          v13,
          Item,
          (const MethodInfo_2F25CD8 *)Method_System_Collections_Generic_List_MapGimmickEntity__Add__);
      }
    }
    list = (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)this->fields.list;
    ++v15;
...
LABEL_17:
  ...
  return (MapGimmickEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                     ...
                                     (const MethodInfo_2F27E24 *)Method_System_Collections_Generic_List_MapGimmickEntity__ToArray__);
}