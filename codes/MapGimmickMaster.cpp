void __fastcall MapGimmickMaster___ctor(MapGimmickMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB60B4 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_MapGimmickMaster__MapGimmickEntity__int___ctor__, method);
    byte_4AB60B4 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    23,
    (const MethodInfo_3163D50 *)Method_DataMasterBase_MapGimmickMaster__MapGimmickEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB60B5 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_System_Collections_Generic_List_MapGimmickEntity__Add__, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_List_MapGimmickEntity__ToArray__, v7);
    sub_1BAB41C(&Method_System_Collections_Generic_List_MapGimmickEntity___ctor__, v8);
    sub_1BAB41C(&System_Collections_Generic_List_MapGimmickEntity__TypeInfo, v9);
    sub_1BAB41C(&MapGimmickEntity_TypeInfo, v10);
    byte_4AB60B5 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1BAB668(System_Collections_Generic_List_MapGimmickEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_354D088 *)Method_System_Collections_Generic_List_MapGimmickEntity___ctor__);
...
LABEL_20:
  ...
  return (MapGimmickEntity_array *)System_Collections_Generic_List_object___ToArray(
                                     v11,
                                     (const MethodInfo_354F414 *)Method_System_Collections_Generic_List_MapGimmickEntity__ToArray__);
}