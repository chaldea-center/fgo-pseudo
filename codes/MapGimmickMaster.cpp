void __fastcall MapGimmickMaster___ctor(MapGimmickMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A1FE31 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataMasterBase_MapGimmickMaster__MapGimmickEntity__int___ctor__, method);
    byte_4A1FE31 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    23,
    (const MethodInfo_30F8720 *)Method_DataMasterBase_MapGimmickMaster__MapGimmickEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1FE32 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_MapGimmickEntity__Add__, v6);
    sub_1B715CC(&Method_System_Collections_Generic_List_MapGimmickEntity__ToArray__, v7);
    sub_1B715CC(&Method_System_Collections_Generic_List_MapGimmickEntity___ctor__, v8);
    sub_1B715CC(&System_Collections_Generic_List_MapGimmickEntity__TypeInfo, v9);
    sub_1B715CC(&MapGimmickEntity_TypeInfo, v10);
    byte_4A1FE32 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B71818(System_Collections_Generic_List_MapGimmickEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34CFA2C *)Method_System_Collections_Generic_List_MapGimmickEntity___ctor__);
...
LABEL_20:
  ...
  return (MapGimmickEntity_array *)System_Collections_Generic_List_object___ToArray(
                                     v11,
                                     (const MethodInfo_34D1DB8 *)Method_System_Collections_Generic_List_MapGimmickEntity__ToArray__);
}