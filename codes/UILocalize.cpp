...
void UILocalize__OnLocalize(UILocalize_o *this, const MethodInfo *method)
{
  ...
  if ( System_String__IsNullOrEmpty(this->fields.key, 0) )
  {
    ...
    if ( v5 )
    {
      ...
      *p_key = monitor;
      sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.key, (int32_t)monitor, v7, v8, v9, v10, v11, v12);
    }
  }
...
void UILocalize__set_value(UILocalize_o *this, System_String_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4D31154 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_NGUITools_FindInParents_UIButton___);
    sub_1C94098(&Method_NGUITools_FindInParents_UIInput___);
    ...
    if ( v13 )
    {
      if ( v9 )
      {
        ...
        v16 = (UnityEngine_Object_o *)NGUITools__FindInParents_object_(
                                        gameObject,
                                        (const MethodInfo_32274D4 *)Method_NGUITools_FindInParents_UIInput___);
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    ...
    else
    {
      ...
      if ( v11 )
      {
        ...
        v20 = (UnityEngine_Object_o *)NGUITools__FindInParents_object_(
                                        v19,
                                        (const MethodInfo_32274D4 *)Method_NGUITools_FindInParents_UIButton___);
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
