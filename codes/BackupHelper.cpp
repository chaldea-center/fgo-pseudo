...
void __fastcall BackupHelper__SetNoBackupFlag_41948056(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_41948060(
