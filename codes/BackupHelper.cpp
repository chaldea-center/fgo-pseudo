...
void __fastcall BackupHelper__SetNoBackupFlag_42285296(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_42285300(
