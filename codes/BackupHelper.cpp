...
void __fastcall BackupHelper__SetNoBackupFlag_40704240(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_40704244(
