...
void __fastcall BackupHelper__SetNoBackupFlag_43106964(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_43106968(
