...
void __fastcall BackupHelper__SetNoBackupFlag_41109312(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_41109316(
