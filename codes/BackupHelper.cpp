...
void __fastcall BackupHelper__SetNoBackupFlag_41499740(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_41499744(
