...
void __fastcall BackupHelper__SetNoBackupFlag_41845624(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_41845628(
