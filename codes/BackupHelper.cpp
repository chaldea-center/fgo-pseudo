...
void __fastcall BackupHelper__SetNoBackupFlag_40923904(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_40923908(
