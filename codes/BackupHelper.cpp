...
void __fastcall BackupHelper__SetNoBackupFlag_40698596(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_40698600(
