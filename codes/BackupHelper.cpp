...
void __fastcall BackupHelper__SetNoBackupFlag_42603236(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_42603240(
