...
void __fastcall BackupHelper__SetNoBackupFlag_40899164(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_40899168(
