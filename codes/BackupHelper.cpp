...
void __fastcall BackupHelper__SetNoBackupFlag_21046876(System_String_o *path, const MethodInfo *method)
{
  ;
}


void __fastcall BackupHelper__SetNoBackupFlag_21046880(
