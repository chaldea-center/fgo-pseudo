        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1FD8C & 1) == 0 )
  {
    sub_1C3B764(&WarBoardWaitTime__Execute_d__2_TypeInfo, method);
    byte_4C1FD8C = 1;
  }
  v3 = sub_1C3B9B0(WarBoardWaitTime__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3B778(&Method_WarBoardWaitTime__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1C3B88C(v3, v4);
}
