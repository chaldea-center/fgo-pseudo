...
System_Collections_IEnumerator_o *WarBoardWaitTime__Execute(WarBoardWaitTime_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0267B & 1) == 0 )
  {
    sub_1CE6700(&WarBoardWaitTime__Execute_d__2_TypeInfo);
    byte_4E0267B = 1;
  }
  v3 = sub_1CE694C(WarBoardWaitTime__Execute_d__2_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_WarBoardWaitTime__Execute_d__2_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
