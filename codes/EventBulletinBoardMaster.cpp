void __fastcall EventBulletinBoardMaster___ctor(EventBulletinBoardMaster_o *this, const MethodInfo *method)
{
  if ( (byte_438DD74 & 1) == 0 )
  {
    sub_B775C4(&Method_DataMasterBase_EventBulletinBoardMaster__EventBulletinBoardEntity__int___ctor__);
    byte_438DD74 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    235,
    (const MethodInfo_21FB7F8 *)Method_DataMasterBase_EventBulletinBoardMaster__EventBulletinBoardEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438DD75 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_DataManager_GetMaster_EventBulletinBoardReleaseMaster___);
    sub_B775C4(&DataManager_TypeInfo);
    sub_B775C4(&EventBulletinBoardEntity_TypeInfo);
  ...
  v5 = (System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData__o *)sub_B77694(System_Collections_Generic_List_EventBulletinBoardEntity__TypeInfo);
  ...
  Master_WarQuestSelectionMaster = (EventBulletinBoardReleaseMaster_o *)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1D18390 *)Method_DataManager_GetMaster_EventBulletinBoardReleaseMaster___);
  if ( !this->fields.list )
    goto LABEL_23;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438DD76 & 1) == 0 )
  {
    sub_B775C4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__);
    sub_B775C4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__);
    sub_B775C4(&Method_DataManager_GetMasterData_EventBulletinBoardReleaseMaster___);
    sub_B775C4(&EventBulletinBoardEntity_TypeInfo);
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_WarQuestSelectionMaster_(
                                      Instance,
                                      (const MethodInfo_1D183F0 *)Method_DataManager_GetMasterData_EventBulletinBoardReleaseMaster___),
        !this->fields.list) )
  {
LABEL_22:
