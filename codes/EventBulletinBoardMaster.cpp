void __fastcall EventBulletinBoardMaster___ctor(EventBulletinBoardMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FC305 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_EventBulletinBoardMaster__EventBulletinBoardEntity__int___ctor__, method);
    byte_49FC305 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    236,
    (const MethodInfo_30D3E64 *)Method_DataMasterBase_EventBulletinBoardMaster__EventBulletinBoardEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC306 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_DataManager_GetMaster_EventBulletinBoardReleaseMaster___, v6);
    sub_1B640C8(&DataManager_TypeInfo, v7);
    sub_1B640C8(&EventBulletinBoardEntity_TypeInfo, v8);
    sub_1B640C8(&Method_System_Collections_Generic_List_EventBulletinBoardEntity__Add__, v9);
    sub_1B640C8(&Method_System_Collections_Generic_List_EventBulletinBoardEntity___ctor__, v10);
    sub_1B640C8(&Method_System_Collections_Generic_List_EventBulletinBoardEntity__get_Count__, v11);
    sub_1B640C8(&System_Collections_Generic_List_EventBulletinBoardEntity__TypeInfo, v12);
    byte_49FC306 = 1;
  }
  ...
  Master_object = (EventBulletinBoardReleaseMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_EventBulletinBoardReleaseMaster___);
  if ( !this->fields.list )
    goto LABEL_25;
  v15 = Master_object;
    ...
    while ( 1 )
    {
      ...
      if ( *(&Master_object->fields._MasterKind_k__BackingField + 1) == eventId )
      {
        ...
        if ( ((unsigned __int8)Master_object & 1) != 0 )
        {
          ...
          v24 = Method_System_Collections_Generic_List_EventBulletinBoardEntity__Add__;
          ++v13->fields._version;
          if ( !items )
            break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC307 & 1) == 0 )
  {
    sub_1B640C8(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&eventId);
    sub_1B640C8(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v5);
    sub_1B640C8(&Method_DataManager_GetMasterData_EventBulletinBoardReleaseMaster___, v6);
    sub_1B640C8(&EventBulletinBoardEntity_TypeInfo, v7);
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_2E393EC *)Method_DataManager_GetMasterData_EventBulletinBoardReleaseMaster___),
        !this->fields.list) )
  {
LABEL_25:
    ...
    if ( *((_DWORD *)&Instance->fields.UnityEngine_Behaviour_Fields + 1) == eventId )
    {
      ...
      if ( ((unsigned __int8)Instance & 1) != 0 )
      {
        ...
        else
        {
          ...
          sub_1B6406C((ServantStatusBattleListViewItem_o *)(v28 + 4), (int32_t)m_CancellationTokenSource, v22, v23);
        }
      }
      v17 = 1;
    }
