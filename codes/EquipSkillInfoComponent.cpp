void EquipSkillInfoComponent___ctor(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.iconLabelInfo, (int32_t)v3, v4, v5, v6, v7, v8, v9);
...
void EquipSkillInfoComponent__OnClickSkill(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E722A5 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_EquipSkillInfoComponent_OnClickSkill__);
    byte_4E722A5 = 1;
  }
  v3 = Method_EquipSkillInfoComponent_OnClickSkill__;
  if ( (*((_BYTE *)Method_EquipSkillInfoComponent_OnClickSkill__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_EquipSkillInfoComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E722A4 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_8651/*"MASTER_EQSKILL_LV_INFO"*/);
    sub_1D0F0B4(&StringLiteral_20968/*"img_skill_0"*/);
    byte_4E722A4 = 1;
  }
  ...
  MasterData_object = (DataManager_o *)System_String__Concat_65562772((System_String_o *)StringLiteral_20968/*"img_skill_0"*/, v22, 0);
  if ( !skillIndxImg )
    goto LABEL_24;
  ...
  if ( !MasterData_object )
    goto LABEL_24;
  SkillIconComponent__Set_42473032((SkillIconComponent_o *)MasterData_object, skillId, skillLv, 0);
  if ( !v21 )
    goto LABEL_24;
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_8651/*"MASTER_EQSKILL_LV_INFO"*/, 0);
  v30 = skillLv;
  ...
  MasterData_object = (DataManager_o *)System_String__Format_65604080(v25, v26, v27, 0);
  if ( !skillLvLabel )
    goto LABEL_24;
...
LABEL_24:
    sub_1D0F30C(MasterData_object, v14);
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B35624;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B355CC;
}
