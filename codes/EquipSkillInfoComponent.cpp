...
void __fastcall EquipSkillInfoComponent__OnClickSkill(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A293C4 & 1) == 0 )
  {
    sub_1B761C0(&Method_EquipSkillInfoComponent_OnClickSkill__, method);
    byte_4A293C4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A293C3 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_8520/*"MASTER_EQSKILL_LV_INFO"*/, v19);
    sub_1B761C0(&StringLiteral_20458/*"img_skill_0"*/, v20);
    byte_4A293C3 = 1;
  }
  this->fields.clickCallbackFunc = callback;
  sub_1B76164(&this->fields.clickCallbackFunc);
  ...
  MasterData_object = (DataManager_o *)System_String__Concat_61535060((System_String_o *)StringLiteral_20458/*"img_skill_0"*/, v28, 0LL);
  if ( !skillIndxImg )
    goto LABEL_24;
  ...
  if ( !MasterData_object )
    goto LABEL_24;
  SkillIconComponent__Set_38055944((SkillIconComponent_o *)MasterData_object, skillId, skillLv, 0LL);
  if ( !v27 )
    goto LABEL_24;
  ...
  v31 = LocalizationManager__Get((System_String_o *)StringLiteral_8520/*"MASTER_EQSKILL_LV_INFO"*/, 0LL);
  v42 = skillLv;
  ...
  MasterData_object = (DataManager_o *)System_String__Format_61549432(v31, v35, v39, 0LL);
  if ( !skillLvLabel )
    goto LABEL_24;
...
LABEL_24:
    sub_1B7641C(MasterData_object, v21);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B6334;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B62DC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A293C6 & 1) == 0 )
  {
    sub_1B761C0(&int_TypeInfo, *(_QWORD *)&skillId);
    byte_4A293C6 = 1;
  }
  v13[2] = 0LL;
