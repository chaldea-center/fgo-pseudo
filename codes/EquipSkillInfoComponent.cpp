void __fastcall EquipSkillInfoComponent___ctor(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC(&this->fields.iconLabelInfo, v3);
...
void __fastcall EquipSkillInfoComponent__OnClickSkill(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD772E & 1) == 0 )
  {
    sub_1C21E38(&Method_EquipSkillInfoComponent_OnClickSkill__);
    byte_4BD772E = 1;
  }
  v3 = Method_EquipSkillInfoComponent_OnClickSkill__;
  if ( (*((_BYTE *)Method_EquipSkillInfoComponent_OnClickSkill__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C21E50(Method_EquipSkillInfoComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD772D & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_8705/*"MASTER_EQSKILL_LV_INFO"*/);
    sub_1C21E38(&StringLiteral_20833/*"img_skill_0"*/);
    byte_4BD772D = 1;
  }
  this->fields.clickCallbackFunc = callback;
  sub_1C21DDC(&this->fields.clickCallbackFunc, callback);
  ...
  MasterData_object = (DataManager_o *)System_String__Concat_63115476((System_String_o *)StringLiteral_20833/*"img_skill_0"*/, v22, 0LL);
  if ( !skillIndxImg )
    goto LABEL_24;
  ...
  if ( !MasterData_object )
    goto LABEL_24;
  SkillIconComponent__Set_39480384((SkillIconComponent_o *)MasterData_object, skillId, skillLv, 0LL);
  if ( !v21 )
    goto LABEL_24;
  skillNameLb = this->fields.skillNameLb;
  MasterData_object = (DataManager_o *)SkillEntity__getName(v21, 0LL);
  if ( !skillNameLb )
    goto LABEL_24;
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_8705/*"MASTER_EQSKILL_LV_INFO"*/, 0LL);
  v36 = skillLv;
  ...
  MasterData_object = (DataManager_o *)System_String__Format_63129848(v25, v29, v33, 0LL);
  if ( !skillLvLabel )
    goto LABEL_24;
...
LABEL_24:
    sub_1C22094(MasterData_object, v14);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5BBBC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5BB64;
}
