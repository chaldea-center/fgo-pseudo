...
void EquipSkillInfoComponent__OnClickSkill(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF6AA & 1) == 0 )
  {
    sub_1CE6700(&Method_EquipSkillInfoComponent_OnClickSkill__);
    byte_4DFF6AA = 1;
  }
  v3 = Method_EquipSkillInfoComponent_OnClickSkill__;
  if ( (*((_BYTE *)Method_EquipSkillInfoComponent_OnClickSkill__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1CE6718(Method_EquipSkillInfoComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF6A9 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_8615/*"MASTER_EQSKILL_LV_INFO"*/);
    sub_1CE6700(&StringLiteral_20877/*"img_skill_0"*/);
    byte_4DFF6A9 = 1;
  }
  ...
  MasterData_object = (DataManager_o *)System_String__Concat_65122828((System_String_o *)StringLiteral_20877/*"img_skill_0"*/, v22, 0);
  if ( !skillIndxImg )
    goto LABEL_24;
  ...
  if ( !MasterData_object )
    goto LABEL_24;
  SkillIconComponent__Set_42253684((SkillIconComponent_o *)MasterData_object, skillId, skillLv, 0);
  if ( !v21 )
    goto LABEL_24;
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_8615/*"MASTER_EQSKILL_LV_INFO"*/, 0);
  v30 = skillLv;
  ...
  MasterData_object = (DataManager_o *)System_String__Format_65164136(v25, v26, v27, 0);
  if ( !skillLvLabel )
    goto LABEL_24;
...
LABEL_24:
    sub_1CE6958(MasterData_object, v14);
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B0F81C;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B0F7C4;
}
