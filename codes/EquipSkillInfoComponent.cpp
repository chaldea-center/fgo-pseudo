void __fastcall EquipSkillInfoComponent___ctor(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C(&this->fields.iconLabelInfo);
...
void __fastcall EquipSkillInfoComponent__OnClickSkill(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4945B & 1) == 0 )
  {
    sub_1B863B8(&Method_EquipSkillInfoComponent_OnClickSkill__, method);
    byte_4A4945B = 1;
  }
  v3 = Method_EquipSkillInfoComponent_OnClickSkill__;
  if ( (*((_BYTE *)Method_EquipSkillInfoComponent_OnClickSkill__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B863D0(Method_EquipSkillInfoComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4945A & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_SingletonMonoBehaviour_DataManager__getInstance__, v18);
    sub_1B863B8(&StringLiteral_8397/*"MASTER_EQSKILL_LV_INFO"*/, v19);
    sub_1B863B8(&StringLiteral_20273/*"img_skill_0"*/, v20);
    byte_4A4945A = 1;
  }
  this->fields.clickCallbackFunc = callback;
  sub_1B8635C(&this->fields.clickCallbackFunc);
  ...
  MasterData_object = (DataManager_o *)System_String__Concat_61645176((System_String_o *)StringLiteral_20273/*"img_skill_0"*/, v29, 0LL);
  if ( !skillIndxImg )
    goto LABEL_24;
  ...
  if ( !MasterData_object )
    goto LABEL_24;
  SkillIconComponent__Set_39193508((SkillIconComponent_o *)MasterData_object, skillId, skillLv, 0LL);
  if ( !v28 )
    goto LABEL_24;
  ...
  v32 = LocalizationManager__Get((System_String_o *)StringLiteral_8397/*"MASTER_EQSKILL_LV_INFO"*/, 0LL);
  v43 = skillLv;
  ...
  MasterData_object = (DataManager_o *)System_String__Format_61686468(v32, v36, v40, 0LL);
  if ( !skillLvLabel )
    goto LABEL_24;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CAF4C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CAEF4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4945D & 1) == 0 )
  {
    sub_1B863B8(&int_TypeInfo, *(_QWORD *)&skillId);
    byte_4A4945D = 1;
  }
  v13[2] = 0LL;
