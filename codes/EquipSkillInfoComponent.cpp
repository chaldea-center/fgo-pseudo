...
void __fastcall EquipSkillInfoComponent__OnClickSkill(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B61E15 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_EquipSkillInfoComponent_OnClickSkill__, method);
    byte_4B61E15 = 1;
  }
  v3 = Method_EquipSkillInfoComponent_OnClickSkill__;
  if ( (*((_BYTE *)Method_EquipSkillInfoComponent_OnClickSkill__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BE4AE4(Method_EquipSkillInfoComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61E14 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_DataManager__getInstance__, v18);
    sub_1BE4ACC(&StringLiteral_8667/*"MASTER_EQSKILL_LV_INFO"*/, v19);
    sub_1BE4ACC(&StringLiteral_20754/*"img_skill_0"*/, v20);
    byte_4B61E14 = 1;
  }
  this->fields.clickCallbackFunc = callback;
  sub_1BE4A70(&this->fields.clickCallbackFunc);
  ...
  MasterData_object = (DataManager_o *)System_String__Concat_62698808((System_String_o *)StringLiteral_20754/*"img_skill_0"*/, v29, 0LL);
  if ( !skillIndxImg )
    goto LABEL_24;
  ...
  if ( !MasterData_object )
    goto LABEL_24;
  SkillIconComponent__Set_39141652((SkillIconComponent_o *)MasterData_object, skillId, skillLv, 0LL);
  if ( !v28 )
    goto LABEL_24;
  ...
  v32 = LocalizationManager__Get((System_String_o *)StringLiteral_8667/*"MASTER_EQSKILL_LV_INFO"*/, 0LL);
  v43 = skillLv;
  ...
  MasterData_object = (DataManager_o *)System_String__Format_62713180(v32, v36, v40, 0LL);
  if ( !skillLvLabel )
    goto LABEL_24;
...
LABEL_24:
    sub_1BE4D28(MasterData_object, v21);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A1F6E4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A1F68C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B61E17 & 1) == 0 )
  {
    sub_1BE4ACC(&int_TypeInfo, *(_QWORD *)&skillId);
    byte_4B61E17 = 1;
  }
  v13[2] = 0LL;
