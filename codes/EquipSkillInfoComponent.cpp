void EquipSkillInfoComponent___ctor(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C6B9AC(&this->fields.iconLabelInfo, v3);
...
void EquipSkillInfoComponent__OnClickSkill(EquipSkillInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB10D4 & 1) == 0 )
  {
    sub_1C6BA08(&Method_EquipSkillInfoComponent_OnClickSkill__);
    byte_4CB10D4 = 1;
  }
  v3 = Method_EquipSkillInfoComponent_OnClickSkill__;
  if ( (*((_BYTE *)Method_EquipSkillInfoComponent_OnClickSkill__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C6BA20(Method_EquipSkillInfoComponent_OnClickSkill__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB10D3 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_8546/*"MASTER_EQSKILL_LV_INFO"*/);
    sub_1C6BA08(&StringLiteral_20641/*"img_skill_0"*/);
    byte_4CB10D3 = 1;
  }
  this->fields.clickCallbackFunc = callback;
  sub_1C6B9AC(&this->fields.clickCallbackFunc, callback);
  ...
  MasterData_object = (DataManager_o *)System_String__Concat_63966792((System_String_o *)StringLiteral_20641/*"img_skill_0"*/, v22, 0);
  if ( !skillIndxImg )
    goto LABEL_24;
  ...
  if ( !MasterData_object )
    goto LABEL_24;
  SkillIconComponent__Set_41257104((SkillIconComponent_o *)MasterData_object, skillId, skillLv, 0);
  if ( !v21 )
    goto LABEL_24;
  ...
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_8546/*"MASTER_EQSKILL_LV_INFO"*/, 0);
  v30 = skillLv;
  ...
  MasterData_object = (DataManager_o *)System_String__Format_64008100(v25, v26, v27, 0);
  if ( !skillLvLabel )
    goto LABEL_24;
...
LABEL_24:
    sub_1C6BC60(MasterData_object, v14);
  }
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A99C94;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A99C3C;
}
