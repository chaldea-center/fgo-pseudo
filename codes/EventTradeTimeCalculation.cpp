void __fastcall EventTradeTimeCalculation___cctor(const MethodInfo *method)
{
  ...
  *EventTradeTimeCalculation_TypeInfo->static_fields = (struct EventTradeTimeCalculation_StaticFields)unk_BB4120;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563E0 & 1) == 0 )
  {
    item = (EventTradeListViewItem_o *)sub_1B885B0(&EventTradeTimeCalculation_TypeInfo);
    byte_4A563E0 = 1;
  }
  if ( !v5 || (TradeInfo_k__BackingField = v5->fields._TradeInfo_k__BackingField) == 0LL )
    sub_1B8880C(item, endedAt);
  ...
  return EventTradeTimeCalculation__GetCompleteNum_30740228(
...
int32_t __fastcall EventTradeTimeCalculation__GetCompleteNum_30740228(
...
LABEL_13:
  ...
  if ( goodsEntity->fields.maxNum >= 1 )
  {
    ...
    do
    {
      ...
      v25 = System_Math__Max_62525680(0, ((int)v22 - (int)startedAt) / v24, 0LL);
      v26 = System_Math__Min_62526008(v25, tradeNum - v18, 0LL);
      Master_object = (Il2CppObject *)EventTradePickupMaster__TryGetEntityTargetTime(
                                        v12,
                                        &v42,
      ...
      if ( startedAt >= 1 && v22 - v26 * v24 - startedAt >= 1 )
      {
        ...
        v33 = System_Convert__ToInt64_62365604(ceil((double)v32 / (double)(int)v31), 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A563E4 & 1) == 0 )
  {
    sub_1B885B0(&System_Convert_TypeInfo);
    sub_1B885B0(&EventTradePickupMaster_TypeInfo);
    mstTradePickup = (EventTradePickupMaster_o *)sub_1B885B0(&System_Math_TypeInfo);
    byte_4A563E4 = 1;
  }
  v27 = 0LL;
  pickupEntity = 0LL;
  ...
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  v16 = System_Convert__ToInt64_62365604(v15, 0LL);
  mstTradePickup = (EventTradePickupMaster_o *)EventTradePickupMaster__TryGetEntityTargetTime(
                                                 v8,
                                                 &v27,
                                                 goodsEntity->fields.id,
...
LABEL_32:
    sub_1B8880C(mstTradePickup, goodsEntity);
  }
...
LABEL_23:
  ...
  if ( (_DWORD)v12 != (_DWORD)v19 )
  {
    ...
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
    return (int)(System_Convert__ToInt64_62365604(v25, 0LL) + v23);
  }
  return v16;
}