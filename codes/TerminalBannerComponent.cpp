void TerminalBannerComponent___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&static_fields->BANNER_INTERVAL_POS = xmmword_C093B0;
}
...
void TerminalBannerComponent__DestroyBanner(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( mBannerWWW )
  {
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.mBannerWWW, 0, v4, v5);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v7, 0, 0) )
  {
    ...
    sub_1C2D434(p_mBannerTex2D, 0, v10, v11);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.mBannerNext, (int32_t)bannerNext, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2458B & 1) == 0 )
  {
    sub_1C2D490(&TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
    byte_4C2458B = 1;
  }
  v3 = sub_1C2D6DC(TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
...
void TerminalBannerComponent__StartLoadAndDisp(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mBannerTex2D, 0, 0) )
  {
    ...
    WebViewAddress_41158236 = NetworkManager__getWebViewAddress_41158236(7, 0);
    mBannerId = this->fields.mBannerId;
    v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &mBannerId, v6, v7, v8);
    v10 = System_String__Format(WebViewAddress_41158236, v9, 0);
    this->fields.mBannerUrl = v10;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.mBannerUrl, (int32_t)v10, v11, v12);
    mBannerTex = (UnityEngine_Component_o *)this->fields.mBannerTex;
    if ( !mBannerTex )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24594 & 1) == 0 )
  {
    ...
    this = (TerminalBannerComponent__StartDownloadBanner_d__24_o *)sub_1C2D490(&UnityEngine_Networking_UnityWebRequest_TypeInfo);
    byte_4C24594 = 1;
  }
    ...
    if ( System_String__IsNullOrEmpty(error, 0) )
    {
      ...
      if ( !this
        ...
        || (format = UnityEngine_Texture2D__get_format((UnityEngine_Texture2D_o *)this, 0),
            v25 = (UnityEngine_Texture2D_o *)sub_1C2D6DC(UnityEngine_Texture2D_TypeInfo),
            UnityEngine_Texture2D___ctor_71051920(v25, v22, v23, format, 0, 0),
...
LABEL_43:
      ...
      UnityEngine_ImageConversion__LoadImage_71272024(v25, data, 0);
    }
    else
    {
LABEL_23:
    ...
    if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v25, 0, 0) )
    {
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&_4__this->fields.mBannerTex2D, (int32_t)v25, v29, v30);
...
LABEL_33:
    ...
    *p_mBannerWWW = 0;
    sub_1C2D434((CGThumbnailListItem_o *)&_4__this->fields.mBannerWWW, 0, v34, v35);
LABEL_40:
    LOBYTE(v17) = 0;
    return (char)v17;
  }
  ...
  v6 = (UnityEngine_Networking_UnityWebRequest_o *)sub_1C2D6DC(UnityEngine_Networking_UnityWebRequest_TypeInfo);
  ...
  v10 = (UnityEngine_Networking_DownloadHandlerTexture_o *)sub_1C2D6DC(UnityEngine_Networking_DownloadHandlerTexture_TypeInfo);
  UnityEngine_Networking_DownloadHandlerTexture___ctor(v10, 0, 0);
  v2->fields._texDl_5__2 = v10;
  sub_1C2D434((CGThumbnailListItem_o *)&v2->fields._texDl_5__2, (int32_t)v10, v11, v12);
  ...
  sub_1C2D434(p__2__current, (int32_t)v13, v15, v16);
  LOBYTE(v17) = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2D4A4(&Method_TerminalBannerComponent__StartDownloadBanner_d__24_System_Collections_IEnumerator_Reset__);
  sub_1C2D5B8(v3, v4);
}
