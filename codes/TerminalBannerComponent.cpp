void __fastcall TerminalBannerComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2B43A & 1) == 0 )
  {
    sub_1B761C0(&TerminalBannerComponent_TypeInfo, v1);
    byte_4A2B43A = 1;
  }
  static_fields = TerminalBannerComponent_TypeInfo->static_fields;
  static_fields->BANNER_RETRY_MAX = 3;
  *(_OWORD *)&static_fields->BANNER_INTERVAL_POS = xmmword_BACC40;
}
...
void __fastcall TerminalBannerComponent__DestroyBanner(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( mBannerWWW )
  {
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.mBannerWWW, 0, v4, v5);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v7, 0LL, 0LL) )
  {
    ...
    sub_1B76164(p_mBannerTex2D, 0, v10, v11);
  }
}
...
int32_t __fastcall TerminalBannerComponent__GetPosIdx(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2B438 & 1) == 0 )
  {
    sub_1B761C0(&TerminalBannerComponent_TypeInfo, method);
    byte_4A2B438 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2B437 & 1) == 0 )
  {
    sub_1B761C0(&TerminalBannerComponent_TypeInfo, questBoardDraw);
    byte_4A2B437 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  LocalPositionX = GameObjectExtensions__GetLocalPositionX(gameObject, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2B439 & 1) == 0 )
  {
    sub_1B761C0(&TerminalBannerComponent_TypeInfo, *(_QWORD *)&posIndex);
    byte_4A2B439 = 1;
  }
  v5 = TerminalBannerComponent_TypeInfo;
  if ( !TerminalBannerComponent_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  int32_t v14; // w2
  int32_t v15; // w3
  TerminalBannerComponent_c *v16; // x0
  UnityEngine_GameObject_o *gameObject; // x0
  float BANNER_INTERVAL_POS; // s0

  if ( (byte_4A2B434 & 1) == 0 )
  {
    sub_1B761C0(&TerminalBannerComponent_TypeInfo, *(_QWORD *)&idx);
    byte_4A2B434 = 1;
  }
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.mBannerNext, (int32_t)bannerNext, v14, v15);
  ...
  this->fields.mTgtPos = v16->static_fields->BANNER_INTERVAL_POS * (float)idx;
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2B432 & 1) == 0 )
  {
    sub_1B761C0(&TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo, method);
    byte_4A2B432 = 1;
  }
  v3 = sub_1B7640C(TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
...
void __fastcall TerminalBannerComponent__StartLoadAndDisp(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mBannerTex2D, 0LL, 0LL) )
  {
    ...
    WebViewAddress_38309280 = NetworkManager__getWebViewAddress_38309280(7, 0LL);
    mBannerId = this->fields.mBannerId;
    v11 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &mBannerId, v8, v9, v10);
    v12 = System_String__Format(WebViewAddress_38309280, v11, 0LL);
    this->fields.mBannerUrl = v12;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.mBannerUrl, (int32_t)v12, v13, v14);
    mBannerTex = (UnityEngine_Component_o *)this->fields.mBannerTex;
    if ( !mBannerTex )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  int32_t v12; // w2
  int32_t v13; // w3
  UnityEngine_Networking_DownloadHandlerTexture_o *v14; // x22
  int32_t v15; // w2
  int32_t v16; // w3
  UnityEngine_Networking_UnityWebRequestAsyncOperation_o *v17; // x0
  ...
  int32_t v34; // w3
  int v35; // w21
  TerminalBannerComponent_c *v36; // x0
  System_Collections_IEnumerator_o *started; // x0
  int32_t v38; // w2
  int32_t v39; // w3
  ...
  if ( (byte_4A2B43B & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Networking_DownloadHandlerTexture_TypeInfo, method);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v3);
    sub_1B761C0(&TerminalBannerComponent_TypeInfo, v4);
    sub_1B761C0(&UnityEngine_Texture2D_TypeInfo, v5);
    this = (TerminalBannerComponent__StartDownloadBanner_d__24_o *)sub_1B761C0(
    ...
    if ( System_String__IsNullOrEmpty(error, 0LL) )
    {
      ...
      if ( !this
        ...
        || (format = UnityEngine_Texture2D__get_format((UnityEngine_Texture2D_o *)this, 0LL),
            v29 = (UnityEngine_Texture2D_o *)sub_1B7640C(UnityEngine_Texture2D_TypeInfo),
            UnityEngine_Texture2D___ctor_69175672(v29, v26, v27, format, 0, 0LL),
...
LABEL_43:
      ...
      UnityEngine_ImageConversion__LoadImage_69392456(v29, data, 0LL);
    }
    else
    {
LABEL_23:
    ...
    if ( !*p_mBannerWWW )
      goto LABEL_43;
    v31 = UnityEngine_Networking_UnityWebRequest__get_error((UnityEngine_Networking_UnityWebRequest_o *)this, 0LL);
    ...
    {
      _4__this->fields.mBannerTex2D = v29;
      sub_1B76164((ServantStatusBattleListViewItem_o *)&_4__this->fields.mBannerTex2D, (int32_t)v29, v33, v34);
      TerminalBannerComponent__SetBannerTexture(_4__this, _4__this->fields.mBannerTex2D, v40);
    }
    else
    {
LABEL_33:
      v35 = _4__this->fields.mBannerRetryCount + 1;
      _4__this->fields.mBannerRetryCount = v35;
      v36 = TerminalBannerComponent_TypeInfo;
      if ( !TerminalBannerComponent_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(TerminalBannerComponent_TypeInfo);
        v36 = TerminalBannerComponent_TypeInfo;
      }
      if ( v35 <= v36->static_fields->BANNER_RETRY_MAX )
      {
    ...
    *p_mBannerWWW = 0LL;
    sub_1B76164((ServantStatusBattleListViewItem_o *)&_4__this->fields.mBannerWWW, 0, v38, v39);
LABEL_40:
    LOBYTE(v21) = 0;
    return (char)v21;
  }
  ...
  v10 = (UnityEngine_Networking_UnityWebRequest_o *)sub_1B7640C(UnityEngine_Networking_UnityWebRequest_TypeInfo);
  UnityEngine_Networking_UnityWebRequest___ctor(v10, mBannerUrl, 0LL);
  _4__this->fields.mBannerWWW = v10;
  v11 = (ServantStatusBattleListViewItem_o *)&_4__this->fields.mBannerWWW;
  sub_1B76164(v11, (int32_t)v10, v12, v13);
  v14 = (UnityEngine_Networking_DownloadHandlerTexture_o *)sub_1B7640C(UnityEngine_Networking_DownloadHandlerTexture_TypeInfo);
  UnityEngine_Networking_DownloadHandlerTexture___ctor(v14, 0, 0LL);
  v2->fields._texDl_5__2 = v14;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v2->fields._texDl_5__2, (int32_t)v14, v15, v16);
  ...
  if ( !v11->klass )
    goto LABEL_43;
  v17 = UnityEngine_Networking_UnityWebRequest__SendWebRequest((UnityEngine_Networking_UnityWebRequest_o *)this, 0LL);
  v2->fields.__2__current = (Il2CppObject *)v17;
  p__2__current = (ServantStatusBattleListViewItem_o *)&v2->fields.__2__current;
  sub_1B76164(p__2__current, (int32_t)v17, v19, v20);
  LOBYTE(v21) = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_TerminalBannerComponent__StartDownloadBanner_d__24_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
