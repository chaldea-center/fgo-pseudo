...
void __fastcall TerminalBannerComponent__DestroyBanner(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( mBannerWWW )
  {
    ...
    sub_B52920(&this->fields.mBannerWWW);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_B52920(&this->fields.mBannerEntity);
  if ( !bannerEnt )
    sub_B52A5C(v11, v12);
  ...
  sub_B52920(&this->fields.mBannerNext);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD01C & 1) == 0 )
  {
    sub_B52984(&TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
    byte_42AD01C = 1;
  }
  v3 = (TerminalBannerComponent__StartDownloadBanner_d__24_o *)sub_B52A54(TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
...
void __fastcall TerminalBannerComponent__StartLoadAndDisp(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mBannerTex2D, 0LL, 0LL) )
  {
    ...
    WebViewAddress_25756092 = NetworkManager__getWebViewAddress_25756092(7, 0LL);
    mBannerId = this->fields.mBannerId;
    v6 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &mBannerId);
    this->fields.mBannerUrl = System_String__Format(WebViewAddress_25756092, v6, 0LL);
    sub_B52920(&this->fields.mBannerUrl);
    mBannerTex = (UnityEngine_Component_o *)this->fields.mBannerTex;
    if ( !mBannerTex )
      goto LABEL_20;
    ...
    {
      started = TerminalBannerComponent__StartDownloadBanner(this, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42ADDCF & 1) == 0 )
  {
    ...
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&TerminalBannerComponent_TypeInfo);
    this = (TerminalBannerComponent__StartDownloadBanner_d__24_o *)sub_B52984(&UnityEngine_Networking_UnityWebRequest_TypeInfo);
    byte_42ADDCF = 1;
  }
...
LABEL_17:
    ...
    if ( !UnityEngine_Object__op_Equality(texture, 0LL, 0LL) )
    {
      ...
      sub_B52920(&_4__this->fields.mBannerTex2D);
...
LABEL_36:
  ...
  v6 = (UnityEngine_Networking_UnityWebRequest_o *)sub_B52A54(UnityEngine_Networking_UnityWebRequest_TypeInfo);
  ...
  sub_B52920(&_4__this->fields.mBannerWWW);
  v8 = (UnityEngine_Networking_DownloadHandlerTexture_o *)sub_B52A54(UnityEngine_Networking_DownloadHandlerTexture_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_TerminalBannerComponent__StartDownloadBanner_d__24_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
