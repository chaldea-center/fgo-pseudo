void TerminalBannerComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E01C68 & 1) == 0 )
  {
    sub_1CE6700(&TerminalBannerComponent_TypeInfo);
    byte_4E01C68 = 1;
  }
  static_fields = TerminalBannerComponent_TypeInfo->static_fields;
  static_fields->BANNER_RETRY_MAX = 3;
  *(_OWORD *)&static_fields->BANNER_INTERVAL_POS = xmmword_D24980;
}
...
void TerminalBannerComponent__DestroyBanner(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  GrandQuestFolderBoardItem_o *p_mBannerTex2D; // x19
  ...
  if ( mBannerWWW )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mBannerWWW, 0, v4, v5, v6, v7, v8, v9);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v11, 0, 0) )
  {
    ...
    sub_1CE66A4(p_mBannerTex2D, 0, v14, v15, v16, v17, v18, v19);
  }
}
...
LABEL_14:
  ...
  GameObjectExtensions__SetLocalPositionX(v18, v16, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01C60 & 1) == 0 )
  {
    sub_1CE6700(&TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
    byte_4E01C60 = 1;
  }
  v3 = sub_1CE694C(TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
...
void TerminalBannerComponent__StartLoadAndDisp(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  const MethodInfo *v4; // x2
  System_String_o *WebViewAddress_42533240; // x20
  Il2CppObject *v6; // x0
  ...
  if ( UnityEngine_Object__op_Equality(mBannerTex2D, 0, 0) )
  {
    ...
    WebViewAddress_42533240 = NetworkManager__getWebViewAddress_42533240(7, 0);
    mBannerId = this->fields.mBannerId;
    v6 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &mBannerId);
    v7 = System_String__Format(WebViewAddress_42533240, v6, 0);
    this->fields.mBannerUrl = v7;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mBannerUrl, (int32_t)v7, v8, v9, v10, v11, v12, v13);
    mBannerTex = (UnityEngine_Component_o *)this->fields.mBannerTex;
    if ( !mBannerTex )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  GrandQuestFolderBoardItem_o *v7; // x19
  int32_t v8; // w2
  int32_t v9; // w3
  System_String_o *v10; // x4
  int32_t v11; // w5
  ...
  GrandQuestFolderBoardItem_o *p__2__current; // x21
  int32_t v23; // w2
  int32_t v24; // w3
  ...
  TerminalBannerComponent__StartDownloadBanner_d__24_o *v29; // x0
  UnityEngine_Networking_UnityWebRequest_o *mBannerWWW; // x0
  TerminalBannerComponent__StartDownloadBanner_d__24_o **p_mBannerWWW; // x20
  System_String_o *error; // x0
  TerminalBannerComponent__StartDownloadBanner_d__24_o *v33; // x22
  int32_t v34; // w24
  int32_t v35; // w25
  int32_t format; // w26
  UnityEngine_Texture2D_o *v37; // x23
  ...
  int v47; // w21
  TerminalBannerComponent_c *v48; // x0
  System_Collections_IEnumerator_o *started; // x0
  int32_t v50; // w2
  int32_t v51; // w3
  ...
  if ( (byte_4E01C69 & 1) == 0 )
  {
    ...
    this = (TerminalBannerComponent__StartDownloadBanner_d__24_o *)sub_1CE6700(&UnityEngine_Networking_UnityWebRequest_TypeInfo);
    byte_4E01C69 = 1;
  }
    ...
    if ( System_String__IsNullOrEmpty(error, 0) )
    {
      ...
      if ( !this
        ...
        || (format = UnityEngine_Texture2D__get_format((UnityEngine_Texture2D_o *)this, 0),
            v37 = (UnityEngine_Texture2D_o *)sub_1CE694C(UnityEngine_Texture2D_TypeInfo),
            UnityEngine_Texture2D___ctor_72806124(v37, v34, v35, format, 0, 0),
...
LABEL_43:
      ...
      UnityEngine_ImageConversion__LoadImage_73027668(v37, data, 0);
    }
    else
    {
LABEL_23:
    ...
    if ( !*p_mBannerWWW )
      goto LABEL_43;
    v39 = UnityEngine_Networking_UnityWebRequest__get_error((UnityEngine_Networking_UnityWebRequest_o *)this, 0);
    IsNullOrEmpty = System_String__IsNullOrEmpty(v39, 0);
    ...
    if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v37, 0, 0) )
    {
      ...
      sub_1CE66A4(
        ...
        v45,
        v46);
      TerminalBannerComponent__SetBannerTexture(_4__this, _4__this->fields.mBannerTex2D, v56);
    }
    else
    {
LABEL_33:
      v47 = _4__this->fields.mBannerRetryCount + 1;
      _4__this->fields.mBannerRetryCount = v47;
      v48 = TerminalBannerComponent_TypeInfo;
      if ( !TerminalBannerComponent_TypeInfo->_2.cctor_finished )
      {
        j_il2cpp_runtime_class_init_0(TerminalBannerComponent_TypeInfo);
        v48 = TerminalBannerComponent_TypeInfo;
    ...
    *p_mBannerWWW = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&_4__this->fields.mBannerWWW, 0, v50, v51, v52, v53, v54, v55);
LABEL_40:
    LOBYTE(v29) = 0;
    return (char)v29;
  }
  ...
  v6 = (UnityEngine_Networking_UnityWebRequest_o *)sub_1CE694C(UnityEngine_Networking_UnityWebRequest_TypeInfo);
  UnityEngine_Networking_UnityWebRequest___ctor_75445168(v6, mBannerUrl, 0);
  ...
  v14 = (UnityEngine_Networking_DownloadHandlerTexture_o *)sub_1CE694C(UnityEngine_Networking_DownloadHandlerTexture_TypeInfo);
  UnityEngine_Networking_DownloadHandlerTexture___ctor(v14, 0, 0);
  v2->fields._texDl_5__2 = v14;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v2->fields._texDl_5__2, (int32_t)v14, v15, v16, v17, v18, v19, v20);
  ...
  sub_1CE66A4(p__2__current, (int32_t)v21, v23, v24, v25, v26, v27, v28);
  LOBYTE(v29) = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_TerminalBannerComponent__StartDownloadBanner_d__24_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
