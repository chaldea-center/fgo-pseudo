void __fastcall TerminalBannerComponent___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&static_fields->BANNER_INTERVAL_POS = xmmword_BFDF20;
}
...
void __fastcall TerminalBannerComponent__DestroyBanner(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( mBannerWWW )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.mBannerWWW, 0LL, v4, v5, v6, v7, v8, v9);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v11, 0LL, 0LL) )
  {
    ...
    sub_1C21DDC(p_mBannerTex2D, 0LL, v14, v15, v16, v17, v18, v19);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD995C & 1) == 0 )
  {
    sub_1C21E38(&TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
    byte_4BD995C = 1;
  }
  v3 = sub_1C22084(TerminalBannerComponent__StartDownloadBanner_d__24_TypeInfo);
...
void __fastcall TerminalBannerComponent__StartLoadAndDisp(TerminalBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mBannerTex2D, 0LL, 0LL) )
  {
    ...
    WebViewAddress_39819560 = NetworkManager__getWebViewAddress_39819560(7, 0LL);
    mBannerId = this->fields.mBannerId;
    v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &mBannerId, v6, v7, v8);
    v10 = System_String__Format(WebViewAddress_39819560, v9, 0LL);
    this->fields.mBannerUrl = v10;
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.mBannerUrl, (int64_t)v10, v11, v12, v13, v14, v15, v16);
    mBannerTex = (UnityEngine_Component_o *)this->fields.mBannerTex;
    if ( !mBannerTex )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  PartyOrganizationUtility_o *v7; // x19
  int64_t v8; // x2
  int32_t v9; // w3
  ...
  if ( (byte_4BD9965 & 1) == 0 )
  {
    ...
    this = (TerminalBannerComponent__StartDownloadBanner_d__24_o *)sub_1C21E38(&UnityEngine_Networking_UnityWebRequest_TypeInfo);
    byte_4BD9965 = 1;
  }
    ...
    if ( System_String__IsNullOrEmpty(error, 0LL) )
    {
      ...
      if ( !this
        ...
        || (format = UnityEngine_Texture2D__get_format((UnityEngine_Texture2D_o *)this, 0LL),
            v37 = (UnityEngine_Texture2D_o *)sub_1C22084(UnityEngine_Texture2D_TypeInfo),
            UnityEngine_Texture2D___ctor_70757788(v37, v34, v35, format, 0, 0LL),
...
LABEL_43:
      ...
      UnityEngine_ImageConversion__LoadImage_70974788(v37, data, 0LL);
    }
    else
    {
LABEL_23:
    ...
    if ( !*p_mBannerWWW )
      goto LABEL_43;
    v39 = UnityEngine_Networking_UnityWebRequest__get_error((UnityEngine_Networking_UnityWebRequest_o *)this, 0LL);
    IsNullOrEmpty = System_String__IsNullOrEmpty(v39, 0LL);
...
LABEL_33:
    ...
    if ( !*p_mBannerWWW )
      return (char)v29;
    UnityEngine_Networking_UnityWebRequest__Dispose((UnityEngine_Networking_UnityWebRequest_o *)v29, 0LL);
    *p_mBannerWWW = 0LL;
    sub_1C21DDC((PartyOrganizationUtility_o *)&_4__this->fields.mBannerWWW, 0LL, v50, v51, v52, v53, v54, v55);
LABEL_40:
    LOBYTE(v29) = 0;
    return (char)v29;
  }
  ...
  v6 = (UnityEngine_Networking_UnityWebRequest_o *)sub_1C22084(UnityEngine_Networking_UnityWebRequest_TypeInfo);
  UnityEngine_Networking_UnityWebRequest___ctor(v6, mBannerUrl, 0LL);
  _4__this->fields.mBannerWWW = v6;
  v7 = (PartyOrganizationUtility_o *)&_4__this->fields.mBannerWWW;
  sub_1C21DDC(v7, (int64_t)v6, v8, v9, v10, v11, v12, v13);
  v14 = (UnityEngine_Networking_DownloadHandlerTexture_o *)sub_1C22084(UnityEngine_Networking_DownloadHandlerTexture_TypeInfo);
  UnityEngine_Networking_DownloadHandlerTexture___ctor(v14, 0, 0LL);
  v2->fields._texDl_5__2 = v14;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v2->fields._texDl_5__2, (int64_t)v14, v15, v16, v17, v18, v19, v20);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_TerminalBannerComponent__StartDownloadBanner_d__24_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
