void __fastcall OuterFrameController___ctor(OuterFrameController_o *this, const MethodInfo *method)
{
  if ( (byte_4B63845 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_OuterFrameController___ctor__, method);
    byte_4B63845 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_38291E0 *)Method_SingletonMonoBehaviour_OuterFrameController___ctor__);
}
...
void __fastcall OuterFrameController__OnPressOuterFrame(OuterFrameController_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Input__get_touchCount(0LL) >= 1 )
  {
    ...
    if ( (unsigned int)(touchCount - 1) < touches->max_length )
    {
      ...
      if ( !byte_4B63735 )
      {
        sub_1BE4ACC(&CTouch_TypeInfo, v10);
        byte_4B63735 = 1;
      }
      v11 = CTouch_TypeInfo;
      if ( !CTouch_TypeInfo->_2.cctor_finished )
...
LABEL_28:
        sub_1BE4D28(touchCount, v9);
      }
    }
    sub_1BE4D30(touchCount, v9);
  }
}
...
void __fastcall OuterFrameController__Start(OuterFrameController_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&CTouch_TypeInfo, method);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_int__Clear__, v2);
    byte_4B63843 = 1;
  }
  if ( !CTouch_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CTouch_TypeInfo);
...
LABEL_35:
        ...
        if ( !byte_4B63735 )
        {
          sub_1BE4ACC(&CTouch_TypeInfo, v9);
          byte_4B63735 = 1;
        }
        v10 = CTouch_TypeInfo;
        if ( !CTouch_TypeInfo->_2.cctor_finished )
