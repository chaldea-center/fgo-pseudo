        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C(p_gaugeChangeAction, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A52523 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponentInChildren_Animation___, gaugeChangeAct);
  ...
  this->fields.commonEffectComponent = (struct CommonEffectComponent_o *)ComponentInChildren_object__49695012;
  sub_1B8635C(
  ...
  transform = (UnityEngine_Component_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  if ( !transform
    || (v14 = UnityEngine_Component__GetComponentInChildren_object__49695012(
                transform,
        ...
        sub_1B8635C((CGThumbnailListItem_o *)&this->fields.simpleAnimation, (int32_t)v14, v15, v16),
...
LABEL_7:
  ...
  v17 = UnityEngine_Component__GetComponentInChildren_object__49695012(
          transform,
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.animation, (int32_t)v17, v18, v19);
  this->fields.gaugeChangeAction = gaugeChangeAct;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.gaugeChangeAction, (int32_t)gaugeChangeAct, v20, v21);
  this->fields.endAction = endAct;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.endAction, (int32_t)endAct, v22, v23);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( EventPointGaugeChangeEffectAction__IsEnd(this, method) )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.endAction, 0, v3, v4);
    if ( endAction )
