        ...
        const MethodInfo *method)
{
  ...
  *p_gaugeChangeAction = 0;
  sub_1C93A78(p_gaugeChangeAction, 0);
        ...
        const MethodInfo *method)
{
  ...
  this->fields.commonEffectComponent = (struct CommonEffectComponent_o *)ComponentInChildren_object__52016240;
  sub_1C93A78(&this->fields.commonEffectComponent, ComponentInChildren_object__52016240);
  transform = (UnityEngine_Component_o *)UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  if ( !transform
    || (v10 = UnityEngine_Component__GetComponentInChildren_object__52016240(
                transform,
        ...
        sub_1C93A78(&this->fields.simpleAnimation, v10),
...
LABEL_7:
  ...
  v11 = UnityEngine_Component__GetComponentInChildren_object__52016240(
          transform,
  ...
  sub_1C93A78(&this->fields.animation, v11);
  this->fields.gaugeChangeAction = gaugeChangeAct;
  sub_1C93A78(&this->fields.gaugeChangeAction, gaugeChangeAct);
  this->fields.endAction = endAct;
  sub_1C93A78(&this->fields.endAction, endAct);
}
...
void EventPointGaugeChangeEffectAction__Update(EventPointGaugeChangeEffectAction_o *this, const MethodInfo *method)
{
  ...
  if ( EventPointGaugeChangeEffectAction__IsEnd(this, method) )
  {
    ...
    sub_1C93A78(&this->fields.endAction, 0);
    if ( endAction )
