        ...
        const MethodInfo *method)
{
  ...
  if ( !isAddFixMessage )
    return System_String__Concat_61718292(
             (System_String_o *)StringLiteral_15936/*"[FFFF00]"*/,
             message,
             (System_String_o *)StringLiteral_15831/*"[-]"*/,
             0LL);
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_11081/*"RESTRICTION_NOT_SATISFY_DIALOG_WHOLE_SUFFIX"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A572A6 & 1) == 0 )
  {
    ...
    this = (RestrictionNotSatisfyWholeInfo_o *)sub_1B885B0(&StringLiteral_1/*""*/);
    byte_4A572A6 = 1;
  }
...
LABEL_20:
        ...
        v21 = *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL);
        if ( v19 >= v21 )
        {
          v26 = v20;
          goto LABEL_100;
...
LABEL_100:
        ...
        if ( !this )
          break;
        this = (RestrictionNotSatisfyWholeInfo_o *)System_String__Replace_61726660(
      ...
      case 2:
        ...
        while ( 2 )
        {
          ...
          v29 = *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL);
          if ( v28 >= v29 )
            goto LABEL_82;
          if ( partyItem )
          {
            this = (RestrictionNotSatisfyWholeInfo_o *)PartyListViewItem__GetMember(partyItem, v28, 0LL);
            if ( this )
            {
              v27 = v28 + 1;
      ...
      case 3:
        ...
        if ( !this )
          break;
        v30 = System_String__Replace_61726660(
                (System_String_o *)this,
                (System_String_o *)StringLiteral_43/*"\n"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                0LL);
        ...
        while ( 1 )
        {
          ...
          if ( ((unsigned __int8)this & 1) != 0 )
          {
            ...
            if ( !PartyOrganizationListViewItem__get_IsEmpty((PartyOrganizationListViewItem_o *)this, 0LL) )
            {
              ...
              v34 = 0;
              v18 = 0;
              if ( !RestrictionWholeEntity__IsIndividuality(restrictionWholeEntity, v41, 0LL) )
                goto LABEL_94;
            }
          }
        }
...
LABEL_62:
        ...
        if ( !targetVals2 )
          break;
        if ( targetVals2->max_length != 1 || v13->fields.isFollower )
        {
          v15 = v13->fields.servantEntity;
          v16 = v13->fields.svtLimitCount;
          this = (RestrictionNotSatisfyWholeInfo_o *)PartyOrganizationListViewItem__GetDispImageLimitCount(v13, 0LL);
          if ( !v15 )
            break;
          v8 = v11 + 1;
          v17 = ServantEntity__getIndividuality(v15, v16, (int32_t)this, 0LL);
          v9 = 0;
          v18 = 0;
          if ( !RestrictionWholeEntity__IsIndividuality(restrictionWholeEntity, v17, 0LL) )
            goto LABEL_63;
          goto LABEL_6;
        }
LABEL_124:
...
LABEL_97:
      ...
      case 8:
        ...
        while ( 2 )
        {
          ...
          if ( v51 >= *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL) )
          {
            for ( i = 0; ; ++i )
            {
              ...
              v62 = *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 160LL);
              v32 = i < v62;
              if ( i >= v62 )
                break;
              if ( !partyItem )
              ...
              if ( !PartyOrganizationListViewItem__get_IsEmpty((PartyOrganizationListViewItem_o *)this, 0LL) )
              {
                ...
                if ( !v64 )
                  goto LABEL_125;
                v66 = ServantEntity__getIndividuality(v64, v65, (int32_t)this, 0LL);
                if ( RestrictionWholeEntity__IsIndividuality(restrictionWholeEntity, v66, 0LL) )
                  break;
              }
              this = (RestrictionNotSatisfyWholeInfo_o *)BalanceConfig_TypeInfo;
            }
...
LABEL_116:
              ...
              if ( !this )
                goto LABEL_125;
LABEL_121:
              v53 = System_String__Replace_61726660(
                      (System_String_o *)this,
                      (System_String_o *)StringLiteral_43/*"\n"*/,
                      (System_String_o *)StringLiteral_1/*""*/,
                      0LL);
...
LABEL_125:
  sub_1B8880C(this, restrictionWholeEntity);
}
        ...
        const MethodInfo *method)
{
  ...
  do
  {
    ...
    v8 = *(_DWORD *)(*(_QWORD *)&Member[7].fields + 156LL);
    if ( v7 >= v8 )
      break;
    if ( !partyItem )
      goto LABEL_14;
    Member = (System_String_o *)PartyListViewItem__GetMember(partyItem, v7, 0LL);
    if ( !Member )
      goto LABEL_14;
    v5 = v7 + 1;
  }
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Member = LocalizationManager__Get((System_String_o *)StringLiteral_11077/*"RESTRICTION_NOT_SATISFY_DIALOG_FATIGUE"*/, 0LL);
  if ( !Member )
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Member = LocalizationManager__Get((System_String_o *)StringLiteral_10286/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_WARNING_SINGLE_SUPPORT"*/, 0LL);
  if ( !Member )
LABEL_14:
    sub_1B8880C(Member, partyItem);
  v9 = System_String__Replace_61726660(
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Member = LocalizationManager__Get((System_String_o *)StringLiteral_11080/*"RESTRICTION_NOT_SATISFY_DIALOG_UNIQUE"*/, 0LL);
  if ( !Member )
LABEL_14:
    sub_1B8880C(Member, partyItem);
  v9 = System_String__Replace_61726660(
...
bool __fastcall RestrictionNotSatisfyWholeInfo__Init_32349432(
        RestrictionNotSatisfyWholeInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  char v12; // w20
  char IsSearchVals_39577084; // w22
  ...
  switch ( restrictionEntity->fields.type )
  {
    case 1:
      ...
      while ( 2 )
      {
        ...
        v19 = *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL);
        if ( v17 >= v19 )
        {
          v24 = v18;
        }
...
LABEL_20:
          ...
          this = (RestrictionNotSatisfyWholeInfo_o *)PartyOrganizationListViewItem__GetDispImageLimitCount(v20, 0LL);
          if ( !servantEntity )
            goto LABEL_171;
          Individuality = ServantEntity__getIndividuality(servantEntity, svtLimitCount, (int32_t)this, 0LL);
          v18 = 0;
          v24 = 0;
          if ( !RestrictionEntity__IsRestriction_39577408(restrictionEntity, Individuality, 0LL) )
            goto LABEL_20;
        }
        break;
      }
...
LABEL_171:
      sub_1B8880C(this, restrictionEntity);
    case 6:
      v25 = 0;
      while ( 2 )
      {
...
LABEL_40:
      ...
      if ( targetVals->max_length != 1 )
      {
        v29 = 0;
        v28 = v31 + 1;
        if ( LOBYTE(v32[2].fields.m_CachedPtr) )
          goto LABEL_40;
        goto LABEL_30;
      }
      v29 = 0;
      IsSearchVals_39577084 = LOBYTE(v32[2].fields.m_CachedPtr) != 0;
LABEL_41:
      this = (RestrictionNotSatisfyWholeInfo_o *)restrictionEntity->fields.name;
      if ( !this )
        goto LABEL_171;
    ...
    case 8:
      ...
      while ( 2 )
      {
        ...
        if ( v35 >= *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 160LL) )
          goto LABEL_157;
        if ( !partyItem )
          goto LABEL_171;
        ...
        if ( v37->fields.isFollower )
        {
          v36 = 0;
LABEL_157:
          IsSearchVals_39577084 = 0;
        }
        else
        {
          v38 = v37->fields.servantEntity;
          v39 = v37->fields.svtLimitCount;
          this = (RestrictionNotSatisfyWholeInfo_o *)PartyOrganizationListViewItem__GetDispImageLimitCount(v37, 0LL);
          if ( !v38 )
            goto LABEL_171;
          v40 = ServantEntity__getIndividuality(v38, v39, (int32_t)this, 0LL);
          v36 = 0;
          if ( !RestrictionEntity__IsSearchVals_39577084(restrictionEntity, v40, 0LL) )
          {
LABEL_55:
            ++v35;
            continue;
    ...
    case 9:
      ...
      else
      {
        ...
        else
        {
          ...
          IsSearchVals_39577084 = RestrictionEntity__IsSearchVals_39577084(restrictionEntity, v69, 0LL);
        }
        v43 = IsSearchVals_39577084 ^ 1;
      }
      this = (RestrictionNotSatisfyWholeInfo_o *)restrictionEntity->fields.name;
      if ( !this )
        goto LABEL_171;
    ...
    case 0xA:
      ...
      while ( 2 )
      {
        ...
        if ( v44 < *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL) )
        {
          if ( partyItem )
          {
            this = (RestrictionNotSatisfyWholeInfo_o *)PartyListViewItem__GetMember(partyItem, v44, 0LL);
            if ( this )
            {
              v45 += !PartyOrganizationListViewItem__get_IsEmpty((PartyOrganizationListViewItem_o *)this, 0LL);
              ++v44;
              continue;
            }
          }
...
LABEL_116:
      if ( restrictionEntity->fields.rangeType == 1 )
      {
        ...
        if ( !v56->max_length )
LABEL_172:
          sub_1B88814(this, restrictionEntity);
        IsSearchVals_39577084 = v45 == v56->m_Items[1];
      }
      else
      {
LABEL_120:
      ...
      if ( !this )
        goto LABEL_171;
      v14 = System_String__Replace_61726660(
              (System_String_o *)this,
              (System_String_o *)StringLiteral_43/*"\n"*/,
              (System_String_o *)StringLiteral_1/*""*/,
              0LL);
      v16 = IsSearchVals_39577084 ^ 1;
LABEL_123:
      v53 = v8;
      goto LABEL_153;
    case 0xB:
      ...
      while ( 2 )
      {
        ...
        if ( v46 >= *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL) )
          goto LABEL_116;
        if ( partyItem )
        {
          ...
          if ( this )
          {
            v47 = this;
            if ( !PartyOrganizationListViewItem__get_IsEmpty((PartyOrganizationListViewItem_o *)this, 0LL) )
              v45 += LOBYTE(v47[2].fields.m_CachedPtr) ^ 1;
            ++v46;
            continue;
          }
        }
    ...
    case 0x10:
      ...
      if ( !name )
        goto LABEL_171;
      v12 = (char)this;
      IsSearchVals_39577084 = (unsigned __int8)this ^ 1;
      v14 = System_String__Replace_61726660(
              name,
              (System_String_o *)StringLiteral_43/*"\n"*/,
              (System_String_o *)StringLiteral_1/*""*/,
      ...
      while ( 2 )
      {
        ...
        if ( v49 >= *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL) )
        {
          for ( i = 0; ; ++i )
          {
            ...
            v60 = *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 160LL);
            IsSearchVals_39577084 = i < v60;
            if ( i >= v60 )
              break;
            if ( !partyItem )
              goto LABEL_171;
              ...
              && !PartyOrganizationListViewItem__get_IsEmpty((PartyOrganizationListViewItem_o *)this, 0LL) )
            {
              ...
              this = (RestrictionNotSatisfyWholeInfo_o *)PartyOrganizationListViewItem__GetDispImageLimitCount(v61, 0LL);
              if ( !v62 )
                goto LABEL_171;
              v64 = ServantEntity__getIndividuality(v62, v63, (int32_t)this, 0LL);
              if ( RestrictionEntity__IsSearchVals_39577084(restrictionEntity, v64, 0LL) )
                break;
            }
            this = (RestrictionNotSatisfyWholeInfo_o *)BalanceConfig_TypeInfo;
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( !isWarning )
  {
    ...
    if ( notSatisfySprite )
    {
      UILabel__set_text((UILabel_o *)notSatisfySprite, (System_String_o *)StringLiteral_25325/*"・"*/, 0LL);
...
LABEL_13:
    sub_1B8880C(notSatisfySprite, isWarning);
  }
