        ...
        const MethodInfo *method)
{
  ...
  if ( !isAddFixMessage )
    return System_String__Concat_61798352(
             (System_String_o *)StringLiteral_15961/*"[FFFF00]"*/,
             message,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BF87 & 1) == 0 )
  {
    sub_1B90010(&BalanceConfig_TypeInfo, restrictionWholeEntity);
    sub_1B90010(&Method_System_Linq_Enumerable_Contains_int___, v8);
    sub_1B90010(&StringLiteral_43/*"\n"*/, v9);
    this = (RestrictionNotSatisfyWholeInfo_o *)sub_1B90010(&StringLiteral_1/*""*/, v10);
    byte_4A6BF87 = 1;
  }
...
LABEL_100:
        ...
        if ( !this )
          break;
        this = (RestrictionNotSatisfyWholeInfo_o *)System_String__Replace_61806720(
      ...
      case 3:
        ...
        if ( !this )
          break;
        v33 = System_String__Replace_61806720(
                (System_String_o *)this,
                (System_String_o *)StringLiteral_43/*"\n"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                0LL);
...
LABEL_116:
              ...
              if ( !this )
                goto LABEL_125;
LABEL_121:
              v56 = System_String__Replace_61806720(
                      (System_String_o *)this,
                      (System_String_o *)StringLiteral_43/*"\n"*/,
                      (System_String_o *)StringLiteral_1/*""*/,
                      0LL);
...
LABEL_125:
  sub_1B9026C(this, restrictionWholeEntity);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BF89 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_43/*"\n"*/, v6);
    sub_1B90010(&StringLiteral_11084/*"RESTRICTION_NOT_SATISFY_DIALOG_FATIGUE"*/, v7);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Member = LocalizationManager__Get((System_String_o *)StringLiteral_11084/*"RESTRICTION_NOT_SATISFY_DIALOG_FATIGUE"*/, 0LL);
  if ( !Member )
LABEL_14:
    sub_1B9026C(Member, partyItem);
  v13 = System_String__Replace_61806720(
          Member,
          (System_String_o *)StringLiteral_43/*"\n"*/,
          (System_String_o *)StringLiteral_1/*""*/,
          0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BF8A & 1) == 0 )
  {
    ...
    sub_1B90010(&LocalizationManager_TypeInfo, v5);
    sub_1B90010(&StringLiteral_43/*"\n"*/, v6);
    sub_1B90010(&StringLiteral_10292/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_WARNING_SINGLE_SUPPORT"*/, v7);
    sub_1B90010(&StringLiteral_1/*""*/, v8);
    byte_4A6BF8A = 1;
  }
  v9 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BF88 & 1) == 0 )
  {
    ...
    sub_1B90010(&LocalizationManager_TypeInfo, v5);
    sub_1B90010(&StringLiteral_43/*"\n"*/, v6);
    sub_1B90010(&StringLiteral_11087/*"RESTRICTION_NOT_SATISFY_DIALOG_UNIQUE"*/, v7);
    sub_1B90010(&StringLiteral_1/*""*/, v8);
    byte_4A6BF88 = 1;
  }
  v9 = 0;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Member = LocalizationManager__Get((System_String_o *)StringLiteral_11087/*"RESTRICTION_NOT_SATISFY_DIALOG_UNIQUE"*/, 0LL);
  if ( !Member )
LABEL_14:
    sub_1B9026C(Member, partyItem);
  v13 = System_String__Replace_61806720(
...
bool __fastcall RestrictionNotSatisfyWholeInfo__Init_32382192(
        RestrictionNotSatisfyWholeInfo_o *this,
        ...
        const MethodInfo *method)
{
  ...
  char v15; // w20
  char IsSearchVals_39630492; // w22
  ...
  if ( (byte_4A6BF8B & 1) == 0 )
  {
    sub_1B90010(&BalanceConfig_TypeInfo, restrictionEntity);
    sub_1B90010(&Method_System_Linq_Enumerable_Contains_int___, v9);
    sub_1B90010(&StringLiteral_43/*"\n"*/, v10);
    this = (RestrictionNotSatisfyWholeInfo_o *)sub_1B90010(&StringLiteral_1/*""*/, v11);
    byte_4A6BF8B = 1;
  }
...
LABEL_20:
          ...
          v21 = 0;
          v27 = 0;
          if ( !RestrictionEntity__IsRestriction_39630816(restrictionEntity, Individuality, 0LL) )
            goto LABEL_20;
        }
        break;
      }
...
LABEL_171:
      sub_1B9026C(this, restrictionEntity);
    case 6:
      v28 = 0;
      while ( 2 )
      {
...
LABEL_40:
      ...
      v32 = 0;
      IsSearchVals_39630492 = LOBYTE(v35[2].fields.m_CachedPtr) != 0;
LABEL_41:
      this = (RestrictionNotSatisfyWholeInfo_o *)restrictionEntity->fields.name;
      if ( !this )
        goto LABEL_171;
...
LABEL_157:
        ...
        else
        {
          ...
          v39 = 0;
          if ( !RestrictionEntity__IsSearchVals_39630492(restrictionEntity, v43, 0LL) )
          {
LABEL_55:
            ++v38;
            continue;
    ...
    case 9:
      ...
      else
      {
        ...
        else
        {
          ...
          IsSearchVals_39630492 = RestrictionEntity__IsSearchVals_39630492(restrictionEntity, v72, 0LL);
        }
        v46 = IsSearchVals_39630492 ^ 1;
      }
      this = (RestrictionNotSatisfyWholeInfo_o *)restrictionEntity->fields.name;
      if ( !this )
        goto LABEL_171;
...
LABEL_116:
      if ( restrictionEntity->fields.rangeType == 1 )
      {
        ...
        if ( !v59->max_length )
LABEL_172:
          sub_1B90274(this, restrictionEntity);
        IsSearchVals_39630492 = v48 == v59->m_Items[1];
      }
      else
      {
LABEL_120:
...
LABEL_123:
    ...
    case 0x10:
      ...
      if ( !name )
        goto LABEL_171;
      v15 = (char)this;
      IsSearchVals_39630492 = (unsigned __int8)this ^ 1;
      v17 = System_String__Replace_61806720(
              name,
              (System_String_o *)StringLiteral_43/*"\n"*/,
              (System_String_o *)StringLiteral_1/*""*/,
        ...
        if ( v52 >= *(_DWORD *)(*(_QWORD *)&this[3].fields.m_CachedPtr + 156LL) )
        {
          for ( i = 0; ; ++i )
          {
              ...
              && !PartyOrganizationListViewItem__get_IsEmpty((PartyOrganizationListViewItem_o *)this, 0LL) )
            {
              ...
              if ( RestrictionEntity__IsSearchVals_39630492(restrictionEntity, v67, 0LL) )
                break;
            }
            this = (RestrictionNotSatisfyWholeInfo_o *)BalanceConfig_TypeInfo;
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6BF8C & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_25365/*"・"*/, isWarning);
    byte_4A6BF8C = 1;
  }
  ...
  if ( !isWarning )
  {
    ...
    if ( notSatisfySprite )
    {
      UILabel__set_text((UILabel_o *)notSatisfySprite, (System_String_o *)StringLiteral_25365/*"・"*/, 0LL);
...
LABEL_13:
    sub_1B9026C(notSatisfySprite, isWarning);
  }
