        ...
        const MethodInfo *method)
{
  ...
  if ( !weightArray || !*(_QWORD *)&weightArray->max_length )
    return defValue;
  v5 = (WeightRate_int__o *)sub_1C22084(WeightRate_int__TypeInfo);
  WeightRate_int____ctor(v5, (const MethodInfo_3A353C4 *)Method_WeightRate_int___ctor__);
...
LABEL_15:
  ...
  if ( !v5 )
    goto LABEL_15;
LABEL_13:
  v11 = UnityEngine_Random__Range_70829352(0, v5->fields.totalweight, 0LL);
  return WeightRate_int___getData(v5, v11, (const MethodInfo_3A34D54 *)Method_WeightRate_int__getData__);
}