...
int32_t RandomUtility__GetRandomRangeIndex(System_Int32_array *weightArray, int32_t defValue, const MethodInfo *method)
{
  ...
  if ( !weightArray || !weightArray->max_length )
    return defValue;
  v5 = (WeightRate_int__o *)sub_1CE694C(WeightRate_int__TypeInfo);
  WeightRate_int____ctor(v5, (const MethodInfo_3D383F0 *)Method_WeightRate_int___ctor__);
...
LABEL_15:
  ...
  if ( !v5 )
    goto LABEL_15;
LABEL_13:
  v11 = UnityEngine_Random__Range_72878252(0, v5->fields.totalweight, 0);
  return WeightRate_int___getData(v5, v11, (const MethodInfo_3D37D80 *)Method_WeightRate_int__getData__);
}