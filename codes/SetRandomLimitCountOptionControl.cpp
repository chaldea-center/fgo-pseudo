        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3F5 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9680/*"OPTION_RANDOM_LIMIT_COUNT_OWN_BUTTON"*/, v3);
    sub_1B90010(&StringLiteral_9681/*"OPTION_RANDOM_LIMIT_COUNT_OWN_EXPLANATION"*/, v4);
    sub_1B90010(&StringLiteral_9679/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/, v5);
    sub_1B90010(&StringLiteral_9678/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_BUTTON"*/, v6);
    byte_4A6B3F5 = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountOptionControl_CategoryInfo__Init(
        ...
        !friendSettingInfo) )
  {
    sub_1B9026C(RandomLimitCountOwn, v9);
  }
  SetRandomLimitCountOptionControl_CategoryInfo__Init(
    friendSettingInfo,
    RandomLimitCountOwn,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3F8 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1B90010(
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v5, v5[4]);
  if ( !flag )
  {
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3F6 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1B90010(&OptionManager_TypeInfo, method);
    byte_4A6B3F6 = 1;
  }
  ownSettingInfo = v2->fields.ownSettingInfo;
  if ( !ownSettingInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6B3F9 & 1) == 0 )
  {
    sub_1B90010(&LocalizationManager_TypeInfo, limitCountFlag);
    byte_4A6B3F9 = 1;
  }
