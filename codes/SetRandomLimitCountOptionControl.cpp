...
void SetRandomLimitCountOptionControl__Init(SetRandomLimitCountOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B885 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_9735/*"OPTION_RANDOM_LIMIT_COUNT_OWN_BUTTON"*/);
    sub_1C93AD4(&StringLiteral_9736/*"OPTION_RANDOM_LIMIT_COUNT_OWN_EXPLANATION"*/);
    sub_1C93AD4(&StringLiteral_9734/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/);
    sub_1C93AD4(&StringLiteral_9733/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_BUTTON"*/);
    byte_4D2B885 = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountOptionControl_CategoryInfo__Init(
          ownSettingInfo,
          RandomLimitCountOwn,
          (System_String_o *)StringLiteral_9735/*"OPTION_RANDOM_LIMIT_COUNT_OWN_BUTTON"*/,
          (System_String_o *)StringLiteral_9736/*"OPTION_RANDOM_LIMIT_COUNT_OWN_EXPLANATION"*/,
          v6),
        friendSettingInfo = this->fields.friendSettingInfo,
        RandomLimitCountOwn = OptionManager__GetRandomLimitCountFriend(0),
        !friendSettingInfo) )
  {
    sub_1C93D2C(RandomLimitCountOwn, v5);
  }
  SetRandomLimitCountOptionControl_CategoryInfo__Init(
    friendSettingInfo,
    RandomLimitCountOwn,
    (System_String_o *)StringLiteral_9733/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_BUTTON"*/,
    (System_String_o *)StringLiteral_9734/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/,
    v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B888 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C93AD4(&Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
    byte_4D2B888 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C93AEC(Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B887 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C93AD4(&Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
    byte_4D2B887 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C93AEC(Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v5, v5[4]);
  if ( !flag )
  {
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0, 0);
...
void SetRandomLimitCountOptionControl__Reflection(SetRandomLimitCountOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B886 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C93AD4(&OptionManager_TypeInfo);
    byte_4D2B886 = 1;
  }
  ownSettingInfo = v2->fields.ownSettingInfo;
  if ( !ownSettingInfo )
