        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56715 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_9674/*"OPTION_RANDOM_LIMIT_COUNT_OWN_BUTTON"*/);
    sub_1B885B0(&StringLiteral_9675/*"OPTION_RANDOM_LIMIT_COUNT_OWN_EXPLANATION"*/);
    sub_1B885B0(&StringLiteral_9673/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/);
    sub_1B885B0(&StringLiteral_9672/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_BUTTON"*/);
    byte_4A56715 = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountOptionControl_CategoryInfo__Init(
        ...
        !friendSettingInfo) )
  {
    sub_1B8880C(RandomLimitCountOwn, v5);
  }
  SetRandomLimitCountOptionControl_CategoryInfo__Init(
    friendSettingInfo,
    RandomLimitCountOwn,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56718 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1B885B0(&Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
    byte_4A56718 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B885C8(Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56717 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1B885B0(&Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
    byte_4A56717 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B885C8(Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B88594(v5, v5[4]);
  if ( !flag )
  {
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56716 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1B885B0(&OptionManager_TypeInfo);
    byte_4A56716 = 1;
  }
  ownSettingInfo = v2->fields.ownSettingInfo;
  if ( !ownSettingInfo )
