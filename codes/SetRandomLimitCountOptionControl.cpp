...
void SetRandomLimitCountOptionControl__Init(SetRandomLimitCountOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3E00B & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_9680/*"OPTION_RANDOM_LIMIT_COUNT_OWN_BUTTON"*/);
    sub_1C37058(&StringLiteral_9681/*"OPTION_RANDOM_LIMIT_COUNT_OWN_EXPLANATION"*/);
    sub_1C37058(&StringLiteral_9679/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/);
    sub_1C37058(&StringLiteral_9678/*"OPTION_RANDOM_LIMIT_COUNT_FRIEND_BUTTON"*/);
    byte_4C3E00B = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountOptionControl_CategoryInfo__Init(
        ...
        !friendSettingInfo) )
  {
    sub_1C372B4(RandomLimitCountOwn);
  }
  SetRandomLimitCountOptionControl_CategoryInfo__Init(
    friendSettingInfo,
    RandomLimitCountOwn,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3E00E & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C37058(&Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
    byte_4C3E00E = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C37070(Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3E00D & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C37058(&Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
    byte_4C3E00D = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C37070(Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1C3703C(v5, v5[4]);
  if ( !flag )
  {
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0, 0);
...
void SetRandomLimitCountOptionControl__Reflection(SetRandomLimitCountOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3E00C & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C37058(&OptionManager_TypeInfo);
    byte_4C3E00C = 1;
  }
  ownSettingInfo = v2->fields.ownSettingInfo;
  if ( !ownSettingInfo )
