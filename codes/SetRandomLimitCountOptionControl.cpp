        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA82 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_9855/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/, v3);
    sub_1C13D24(&StringLiteral_9856/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/, v4);
    sub_1C13D24(&StringLiteral_9854/*"OPTION_NOTICE_RP_EXPLANATION"*/, v5);
    sub_1C13D24(&StringLiteral_9853/*"OPTION_NOTICE_RP"*/, v6);
    byte_4BAFA82 = 1;
  }
  ...
  if ( !ownSettingInfo
    || (SetRandomLimitCountOptionControl_CategoryInfo__Init(
          ownSettingInfo,
          RandomLimitCountOwn,
          (System_String_o *)StringLiteral_9855/*"OPTION_NOT_PLAY_OPENING_MOVIE"*/,
          (System_String_o *)StringLiteral_9856/*"OPTION_NOT_PLAY_OPENING_MOVIE_INFO"*/,
          v10),
        friendSettingInfo = this->fields.friendSettingInfo,
        RandomLimitCountOwn = OptionManager__GetRandomLimitCountFriend(0LL),
        !friendSettingInfo) )
  {
    sub_1C13F80(RandomLimitCountOwn, v9);
  }
  SetRandomLimitCountOptionControl_CategoryInfo__Init(
    friendSettingInfo,
    RandomLimitCountOwn,
    (System_String_o *)StringLiteral_9853/*"OPTION_NOTICE_RP"*/,
    (System_String_o *)StringLiteral_9854/*"OPTION_NOTICE_RP_EXPLANATION"*/,
    v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA85 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C13D24(
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C13D3C(Method_SetRandomLimitCountOptionControl_OnClickFriendSettingButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (*((_BYTE *)Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C13D3C(Method_SetRandomLimitCountOptionControl_OnClickOwnSettingButton__);
  v6 = (System_Reflection_MethodBase_o *)sub_1C13D08(v5, v5[4]);
  if ( !flag )
  {
    OverwriteAssetSoundName__PlaySystemSe(v6, 0, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA83 & 1) == 0 )
  {
    this = (SetRandomLimitCountOptionControl_o *)sub_1C13D24(&OptionManager_TypeInfo, method);
    byte_4BAFA83 = 1;
  }
  ownSettingInfo = v2->fields.ownSettingInfo;
  if ( !ownSettingInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFA86 & 1) == 0 )
  {
    sub_1C13D24(&LocalizationManager_TypeInfo, limitCountFlag);
    byte_4BAFA86 = 1;
  }
