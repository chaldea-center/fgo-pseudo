void __fastcall LotteryShopBuyItemConfirmMenu___cctor(const MethodInfo *method)
{
  ...
  int32_t v6; // w3
  int32_t v7; // w1
  struct LotteryShopBuyItemConfirmMenu_StaticFields *v8; // x0
  int32_t v9; // w2
  int32_t v10; // w3

  if ( (byte_4A5F3BD & 1) == 0 )
  {
    sub_1B885B0(&LotteryShopBuyItemConfirmMenu_TypeInfo);
  ...
  sub_1B88554(
    ...
    v1,
    v2);
  v3 = StringLiteral_24070/*"treasurechest_img_bg"*/;
  static_fields = LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields;
  static_fields->PAY_INFO_BG_SPITE_NAME = (struct System_String_o *)StringLiteral_24070/*"treasurechest_img_bg"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->PAY_INFO_BG_SPITE_NAME, v3, v5, v6);
  v7 = StringLiteral_24074/*"treasurechest_img_line"*/;
  v8 = LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields;
  v8->PAY_INFO_LINE_SPITE_NAME = (struct System_String_o *)StringLiteral_24074/*"treasurechest_img_line"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v8->PAY_INFO_LINE_SPITE_NAME, v7, v9, v10);
...
void __fastcall LotteryShopBuyItemConfirmMenu__Close(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  LotteryShopBuyItemConfirmMenu__Close_46140328(this, 0LL, v2);
}


void __fastcall LotteryShopBuyItemConfirmMenu__Close_46140328(
        LotteryShopBuyItemConfirmMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3B6 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_EndClose__);
    byte_4A5F3B6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( onClose )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.onClose, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3BB & 1) == 0 )
  {
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3B3 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataManager_GetMaster_ShopGroupMaster___);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ShopGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_ShopGroupMaster___);
  if ( !shopEntity )
    goto LABEL_23;
  v7 = Master_object;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3B7 & 1) == 0 )
  {
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__);
    byte_4A5F3B7 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3B4 & 1) == 0 )
  {
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__);
    byte_4A5F3B4 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3B8 & 1) == 0 )
  {
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__);
    byte_4A5F3B8 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3BA & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4A5F3BA = 1;
  }
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  ...
  CommonUI__OpenItemDetailDialog_30558980(v8, name, infoMessage, v11, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3AE & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_LotteryShopBuyItemConfirmMenu_EndOpen__);
    sub_1B885B0(&LotteryShopBuyItemConfirmMenu_TypeInfo);
    sub_1B885B0(&NetworkManager_TypeInfo);
    sub_1B885B0(&StringLiteral_8315/*"LOTTERY_SHOP_PAY_INFO"*/);
    sub_1B885B0(&StringLiteral_8313/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/);
    sub_1B885B0(&StringLiteral_8316/*"LOTTERY_SHOP_SKIP_INFO"*/);
    sub_1B885B0(&StringLiteral_8314/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.shopEntity, (int32_t)entity, v10, v11);
    ...
    if ( gameObject )
    {
      ...
      LotteryShopBuyItemConfirmMenu__SetCheckMark(this, v14);
      ...
      if ( gameObject )
      {
        ...
        if ( item )
        {
          ...
          LotteryShopBuyItemConfirmMenu__UpdateCountValue(this, this->fields.buyCount, v16);
          gameObject = (int64_t)this->fields.shopEntity;
          if ( gameObject )
          {
                      ...
                      if ( shopItemIcon )
                      {
                        ...
                        if ( gameObject )
                        {
                          ...
                          if ( payItemIcon )
                          {
                            ...
                            PAY_INFO_BG_SPITE_NAME = v23->static_fields->PAY_INFO_BG_SPITE_NAME;
                            if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                              j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
                            AtlasManager__SetEventUI(payInfoBg, PAY_INFO_BG_SPITE_NAME, 0LL);
                            v25 = AtlasManager__SetEventUI(
                            ...
                            gameObject = LotteryShopBuyItemConfirmMenu__GetPresentBoxSpace(
                                           (LotteryShopBuyItemConfirmMenu_o *)v25,
                                           v26);
                            if ( this->fields.payInfo )
                            {
                              ...
                              if ( v27 <= 0 )
                              {
                                ...
                                gameObject = (int64_t)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_8643/*"MISSION_ACTION_PRESENT_BOX_FULL_WARNING"*/,
                                                        0LL);
                              ...
                              if ( Shop_k__BackingField )
                              {
                                ...
                                if ( Master_object )
                                {
                                  ...
                                  if ( gameObject )
                                  {
                                    ...
                                    if ( v33 > static_fields->UserItemMax )
                                    {
                                    ...
                                    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                                      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                                    gameObject = (int64_t)LocalizationManager__GetNumberFormatLong(v36, 0LL);
                                    if ( haveNum )
                                    {
                                      UILabel__set_text(haveNum, (System_String_o *)gameObject, 0LL);
                                      haveText = this->fields.haveText;
                                      gameObject = (int64_t)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8313/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/,
                                                              0LL);
                                      if ( haveText )
                                      {
                                        ...
                                        gameObject = (int64_t)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_8314/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/,
                                                                0LL);
                                        if ( needText )
                                        {
                                          ...
                                          gameObject = (int64_t)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_8315/*"LOTTERY_SHOP_PAY_INFO"*/,
                                                                  0LL);
                                          if ( payInfoLabel )
                                          {
                                            ...
                                            gameObject = (int64_t)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_8316/*"LOTTERY_SHOP_SKIP_INFO"*/,
                                                                    0LL);
                                            if ( checkboxLabel )
                                            {
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ShopDetailMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_ShopDetailMaster___);
...
LABEL_17:
    ...
    if ( Master_object )
    {
      UISprite__set_spriteName((UISprite_o *)Master_object, (System_String_o *)StringLiteral_17626/*"btn_txt_trade"*/, 0LL);
      Master_object = (ShopDetailMaster_o *)this->fields.decideButtonImg;
      if ( Master_object )
      {
...
LABEL_23:
  ...
  if ( shopEntity->fields.payType == 6 )
  {
    ...
    v14 = System_String__Concat_61720296(VALENTINE_BTN_NAME, v12, (System_String_o *)StringLiteral_16123/*"_"*/, v13, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemSlider )
LABEL_11:
    sub_1B8880C(itemSlider, *(_QWORD *)&buyableCount);
  if ( buyableCount <= 1 )
    v7 = 1;
  else
    v7 = buyableCount;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5F3B1 & 1) == 0 )
  {
    this = (LotteryShopBuyItemConfirmMenu_o *)sub_1B885B0(&LocalizationManager_TypeInfo);
    byte_4A5F3B1 = 1;
  }
