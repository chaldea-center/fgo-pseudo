void LotteryShopBuyItemConfirmMenu___cctor(const MethodInfo *method)
{
  ...
  struct LotteryShopBuyItemConfirmMenu_StaticFields *v2; // x0

  if ( (byte_4C21B87 & 1) == 0 )
  {
    sub_1C2D490(&LotteryShopBuyItemConfirmMenu_TypeInfo);
  ...
  LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields->VALENTINE_BTN_NAME = (struct System_String_o *)StringLiteral_17558/*"btn_txt_event_"*/;
  sub_1C2D434(LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields);
  static_fields = LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields;
  static_fields->PAY_INFO_BG_SPITE_NAME = (struct System_String_o *)StringLiteral_24185/*"treasurechest_img_bg"*/;
  sub_1C2D434(&static_fields->PAY_INFO_BG_SPITE_NAME);
  v2 = LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields;
  v2->PAY_INFO_LINE_SPITE_NAME = (struct System_String_o *)StringLiteral_24189/*"treasurechest_img_line"*/;
  sub_1C2D434(&v2->PAY_INFO_LINE_SPITE_NAME);
...
void LotteryShopBuyItemConfirmMenu__Close(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  LotteryShopBuyItemConfirmMenu__Close_32149264(this, 0, v2);
}


void LotteryShopBuyItemConfirmMenu__Close_32149264(
        LotteryShopBuyItemConfirmMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21B80 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_EndClose__);
    byte_4C21B80 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21B85 & 1) == 0 )
  {
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
        ...
        const MethodInfo *method)
{
  ...
  v9 = DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_UserItemMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4C211E1 )
  {
...
void LotteryShopBuyItemConfirmMenu__Init(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 0, 0),
        ...
        sub_1C2D434(&this->fields.shopEntity),
...
void LotteryShopBuyItemConfirmMenu__OnClickCancel(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B81 & 1) == 0 )
  {
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__);
    byte_4C21B81 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
...
void LotteryShopBuyItemConfirmMenu__OnClickCheckbox(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B7E & 1) == 0 )
  {
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__);
    byte_4C21B7E = 1;
  }
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
...
void LotteryShopBuyItemConfirmMenu__OnClickDecide(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B82 & 1) == 0 )
  {
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__);
    byte_4C21B82 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
...
void LotteryShopBuyItemConfirmMenu__OnClickDetail(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21B84 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__);
    sub_1C2D490(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C21B84 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  ...
  CommonUI__OpenItemDetailDialog_31246476(v8, name, infoMessage, v11, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21B78 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_LotteryShopBuyItemConfirmMenu_EndOpen__);
    sub_1C2D490(&LotteryShopBuyItemConfirmMenu_TypeInfo);
    sub_1C2D490(&NetworkManager_TypeInfo);
    sub_1C2D490(&StringLiteral_8336/*"LOTTERY_SHOP_PAY_INFO"*/);
    sub_1C2D490(&StringLiteral_8334/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/);
    sub_1C2D490(&StringLiteral_8337/*"LOTTERY_SHOP_SKIP_INFO"*/);
    sub_1C2D490(&StringLiteral_8335/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/);
                          ...
                          if ( payItemIcon )
                          {
                            ...
                            if ( this->fields.payInfo )
                            {
                              ...
                              if ( v25 <= 0 )
                              {
                                ...
                                gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8667/*"MISSION_ACTION_PRESENT_BOX_FULL_WARNING"*/, 0);
                                ...
                                if ( Master_object )
                                {
                                  ...
                                  if ( gameObject )
                                  {
                                    ...
                                    if ( haveNum )
                                    {
                                      ...
                                      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8334/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/, 0);
                                      if ( haveText )
                                      {
                                        UILabel__set_text(haveText, (System_String_o *)gameObject, 0);
                                        needText = this->fields.needText;
                                        gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8335/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/, 0);
                                        if ( needText )
                                        {
                                          ...
                                          gameObject = LocalizationManager__Get(
                                                         (System_String_o *)StringLiteral_8336/*"LOTTERY_SHOP_PAY_INFO"*/,
                                                         0);
                                          if ( payInfoLabel )
                                          {
                                            ...
                                            gameObject = LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_8337/*"LOTTERY_SHOP_SKIP_INFO"*/,
                                                           0);
                                            if ( checkboxLabel )
                                            {
                                              ...
                                              if ( gameObject )
                                              {
                                                ...
                                                System_Action___ctor(
                                                  ...
                                                  0);
                                                BaseDialog__Open((BaseDialog_o *)this, v46, 0, 0);
                                                return;
                                              }
                                            }
                                          }
...
void LotteryShopBuyItemConfirmMenu__SetCheckMark(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2D6EC(checkMarkSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ShopDetailMaster_o *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_ShopDetailMaster___);
...
LABEL_17:
    ...
    if ( Master_object )
    {
      UISprite__set_spriteName((UISprite_o *)Master_object, (System_String_o *)StringLiteral_17613/*"btn_txt_trade"*/, 0);
      Master_object = (ShopDetailMaster_o *)this->fields.decideButtonImg;
      if ( Master_object )
      {
...
LABEL_23:
  ...
  if ( shopEntity->fields.payType == 6 )
  {
    ...
    v14 = System_String__Concat_63498116(VALENTINE_BTN_NAME, v12, (System_String_o *)StringLiteral_16105/*"_"*/, v13, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemSlider )
LABEL_11:
    sub_1C2D6EC(itemSlider, *(_QWORD *)&buyableCount);
  if ( buyableCount <= 1 )
    v7 = 1;
  else
    v7 = buyableCount;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21B7B & 1) == 0 )
  {
    this = (LotteryShopBuyItemConfirmMenu_o *)sub_1C2D490(&LocalizationManager_TypeInfo);
    byte_4C21B7B = 1;
  }
