void __fastcall LotteryShopBuyItemConfirmMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3F45E & 1) == 0 )
  {
    sub_1BDB878(&LotteryShopBuyItemConfirmMenu_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_24260/*"treasurechest_img_bg"*/, v2);
    sub_1BDB878(&StringLiteral_17576/*"btn_txt_event_"*/, v3);
    sub_1BDB878(&StringLiteral_24264/*"treasurechest_img_line"*/, v4);
    byte_4B3F45E = 1;
  }
  LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields->VALENTINE_BTN_NAME = (struct System_String_o *)StringLiteral_17576/*"btn_txt_event_"*/;
  sub_1BDB81C(LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields);
  static_fields = LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields;
  static_fields->PAY_INFO_BG_SPITE_NAME = (struct System_String_o *)StringLiteral_24260/*"treasurechest_img_bg"*/;
  sub_1BDB81C(&static_fields->PAY_INFO_BG_SPITE_NAME);
  v6 = LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields;
  v6->PAY_INFO_LINE_SPITE_NAME = (struct System_String_o *)StringLiteral_24264/*"treasurechest_img_line"*/;
  sub_1BDB81C(&v6->PAY_INFO_LINE_SPITE_NAME);
...
void __fastcall LotteryShopBuyItemConfirmMenu__Close(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  LotteryShopBuyItemConfirmMenu__Close_31535520(this, 0LL, v2);
}


void __fastcall LotteryShopBuyItemConfirmMenu__Close_31535520(
        LotteryShopBuyItemConfirmMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F457 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_EndClose__, v5);
    byte_4B3F457 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F45C & 1) == 0 )
  {
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__, isDecide);
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BDB890(Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F450 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMaster_UserPresentBoxMaster___, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F454 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMaster_ShopGroupMaster___, shopEntity);
    sub_1BDB878(&Method_DataManager_GetMaster_UserItemMaster___, v5);
    sub_1BDB878(&DataManager_TypeInfo, v6);
    sub_1BDB878(&LotteryShopBuyItemConfirmMenu_TypeInfo, v7);
    sub_1BDB878(&NetworkManager_TypeInfo, v8);
    byte_4B3F454 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ShopGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ShopGroupMaster___);
  if ( !shopEntity )
    goto LABEL_27;
  v11 = Master_object;
  ...
  v14 = DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserItemMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  if ( !byte_4B3ED56 )
  {
...
void __fastcall LotteryShopBuyItemConfirmMenu__Init(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !gameObject
    || (UnityEngine_GameObject__SetActive(gameObject, 0, 0LL),
        ...
        sub_1BDB81C(&this->fields.shopEntity),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F458 & 1) == 0 )
  {
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__, method);
    byte_4B3F458 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F455 & 1) == 0 )
  {
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__, method);
    byte_4B3F455 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1BDB890(Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__);
  v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F459 & 1) == 0 )
  {
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__, method);
    byte_4B3F459 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F45B & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__, v3);
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__, v4);
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1BDB890(Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__);
  ...
  if ( !shopEntity
    || (v11 = (CommonUI_o *)Instance,
        ...
        v14 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1BDBAC4(ItemDetailInfoComponent_CallbackFunc_TypeInfo),
  ...
  CommonUI__OpenItemDetailDialog_30911904(v11, name, infoMessage, v14, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F44F & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_LotteryShopBuyItemConfirmMenu_EndOpen__, v14);
    sub_1BDB878(&LotteryShopBuyItemConfirmMenu_TypeInfo, v15);
    sub_1BDB878(&NetworkManager_TypeInfo, v16);
    sub_1BDB878(&StringLiteral_8332/*"LOTTERY_SHOP_PAY_INFO"*/, v17);
    sub_1BDB878(&StringLiteral_8330/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/, v18);
    sub_1BDB878(&StringLiteral_8333/*"LOTTERY_SHOP_SKIP_INFO"*/, v19);
    sub_1BDB878(&StringLiteral_8331/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/, v20);
    sub_1BDB878(&StringLiteral_8666/*"MISSION_ACTION_PRESENT_BOX_FULL_WARNING"*/, v21);
                          ...
                          if ( payItemIcon )
                          {
                            ...
                            if ( this->fields.payInfo )
                            {
                              ...
                              if ( v39 <= 0 )
                              {
                                ...
                                gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8666/*"MISSION_ACTION_PRESENT_BOX_FULL_WARNING"*/, 0LL);
                                ...
                                if ( Master_object )
                                {
                                  ...
                                  if ( gameObject )
                                  {
                                    ...
                                    if ( haveNum )
                                    {
                                      ...
                                      gameObject = LocalizationManager__Get((System_String_o *)StringLiteral_8330/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/, 0LL);
                                      if ( haveText )
                                      {
                                        ...
                                        gameObject = LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_8331/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/,
                                                       0LL);
                                        if ( needText )
                                        {
                                          ...
                                          gameObject = LocalizationManager__Get(
                                                         (System_String_o *)StringLiteral_8332/*"LOTTERY_SHOP_PAY_INFO"*/,
                                                         0LL);
                                          if ( payInfoLabel )
                                          {
                                            ...
                                            gameObject = LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_8333/*"LOTTERY_SHOP_SKIP_INFO"*/,
                                                           0LL);
                                            if ( checkboxLabel )
                                            {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BDBAD4(checkMarkSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F451 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMaster_ShopDetailMaster___, v5);
    sub_1BDB878(&DataManager_TypeInfo, v6);
    sub_1BDB878(&EventRewardRootComponent_TypeInfo, v7);
    sub_1BDB878(&LotteryShopBuyItemConfirmMenu_TypeInfo, v8);
    sub_1BDB878(&StringLiteral_16088/*"_"*/, v9);
    sub_1BDB878(&StringLiteral_17629/*"btn_txt_trade"*/, v10);
    byte_4B3F451 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ShopDetailMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_ShopDetailMaster___);
...
LABEL_17:
    ...
    if ( Master_object )
    {
      UISprite__set_spriteName((UISprite_o *)Master_object, (System_String_o *)StringLiteral_17629/*"btn_txt_trade"*/, 0LL);
      Master_object = (ShopDetailMaster_o *)this->fields.decideButtonImg;
      if ( Master_object )
      {
...
LABEL_23:
  ...
  if ( shopEntity->fields.payType == 6 )
  {
    ...
    v20 = System_String__Concat_62612512(VALENTINE_BTN_NAME, v18, (System_String_o *)StringLiteral_16088/*"_"*/, v19, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemSlider )
LABEL_11:
    sub_1BDBAD4(itemSlider, *(_QWORD *)&buyableCount);
  if ( buyableCount <= 1 )
    v7 = 1;
  else
    v7 = buyableCount;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F452 & 1) == 0 )
  {
    this = (LotteryShopBuyItemConfirmMenu_o *)sub_1BDB878(&LocalizationManager_TypeInfo, *(_QWORD *)&count);
    byte_4B3F452 = 1;
  }
