void __fastcall LotteryShopBuyItemConfirmMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A02CF4 & 1) == 0 )
  {
    sub_1B64A00(&LotteryShopBuyItemConfirmMenu_TypeInfo, v1);
    sub_1B64A00(&StringLiteral_23975/*"treasurechest_img_bg"*/, v4);
    sub_1B64A00(&StringLiteral_17509/*"btn_txt_event_"*/, v5);
    sub_1B64A00(&StringLiteral_23979/*"treasurechest_img_line"*/, v6);
    byte_4A02CF4 = 1;
  }
  LotteryShopBuyItemConfirmMenu_TypeInfo->static_fields->VALENTINE_BTN_NAME = (struct System_String_o *)StringLiteral_17509/*"btn_txt_event_"*/;
  sub_1B649A4(
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->PAY_INFO_BG_SPITE_NAME, v7, v9, v10);
  ...
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v12->PAY_INFO_LINE_SPITE_NAME, v11, v13, v14);
...
void __fastcall LotteryShopBuyItemConfirmMenu__Close(LotteryShopBuyItemConfirmMenu_o *this, const MethodInfo *method)
{
  ...
  LotteryShopBuyItemConfirmMenu__Close_45777188(this, 0LL, v2);
}


void __fastcall LotteryShopBuyItemConfirmMenu__Close_45777188(
        LotteryShopBuyItemConfirmMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CED & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_EndClose__, v6);
    byte_4A02CED = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( onClose )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.onClose, 0, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CF2 & 1) == 0 )
  {
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__, isDecide);
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B64A18(Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CE6 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMaster_UserPresentBoxMaster___, v2);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CEA & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_ShopGroupMaster___, shopEntity);
    sub_1B64A00(&Method_DataManager_GetMaster_UserItemMaster___, v5);
    sub_1B64A00(&DataManager_TypeInfo, v6);
    sub_1B64A00(&LotteryShopBuyItemConfirmMenu_TypeInfo, v7);
    sub_1B64A00(&NetworkManager_TypeInfo, v8);
    byte_4A02CEA = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ShopGroupMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_ShopGroupMaster___);
  if ( !shopEntity )
    goto LABEL_23;
  v11 = Master_object;
  ...
  v13 = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_UserItemMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  UserId = NetworkManager__get_UserId(0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CEE & 1) == 0 )
  {
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__, method);
    byte_4A02CEE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_LotteryShopBuyItemConfirmMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CEB & 1) == 0 )
  {
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__, method);
    byte_4A02CEB = 1;
  }
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B64A18(Method_LotteryShopBuyItemConfirmMenu_OnClickCheckbox__);
  v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CEF & 1) == 0 )
  {
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__, method);
    byte_4A02CEF = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_LotteryShopBuyItemConfirmMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CF1 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_EndShowItemDetailDialog__, v3);
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__, v4);
  ...
  if ( (*((_BYTE *)Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1B64A18(Method_LotteryShopBuyItemConfirmMenu_OnClickDetail__);
  ...
  if ( !shopEntity
    || (v11 = (CommonUI_o *)Instance,
        ...
        v14 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1B64C4C(ItemDetailInfoComponent_CallbackFunc_TypeInfo),
  ...
  CommonUI__OpenItemDetailDialog_30412392(v11, name, infoMessage, v14, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CE5 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMaster_UserItemMaster___, v11);
    sub_1B64A00(&DataManager_TypeInfo, v12);
    sub_1B64A00(&LocalizationManager_TypeInfo, v13);
    sub_1B64A00(&Method_LotteryShopBuyItemConfirmMenu_EndOpen__, v14);
    sub_1B64A00(&LotteryShopBuyItemConfirmMenu_TypeInfo, v15);
    sub_1B64A00(&NetworkManager_TypeInfo, v16);
    sub_1B64A00(&StringLiteral_8279/*"LOTTERY_SHOP_PAY_INFO"*/, v17);
    sub_1B64A00(&StringLiteral_8277/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/, v18);
    sub_1B64A00(&StringLiteral_8280/*"LOTTERY_SHOP_SKIP_INFO"*/, v19);
    sub_1B64A00(&StringLiteral_8278/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/, v20);
    sub_1B64A00(&StringLiteral_8606/*"MISSION_ACTION_PRESENT_BOX_FULL_WARNING"*/, v21);
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.shopEntity, (int32_t)entity, v24, v25);
                            ...
                            if ( this->fields.payInfo )
                            {
                              ...
                              if ( v41 <= 0 )
                              {
                                ...
                                gameObject = (int64_t)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_8606/*"MISSION_ACTION_PRESENT_BOX_FULL_WARNING"*/,
                                                        0LL);
                                ...
                                if ( Master_object )
                                {
                                  ...
                                  if ( gameObject )
                                  {
                                    ...
                                    if ( haveNum )
                                    {
                                      ...
                                      gameObject = (int64_t)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8277/*"LOTTERY_SHOP_HAVE_EVENT_ITEM"*/,
                                                              0LL);
                                      if ( haveText )
                                      {
                                        ...
                                        gameObject = (int64_t)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_8278/*"LOTTERY_SHOP_NEED_EVENT_ITEM"*/,
                                                                0LL);
                                        if ( needText )
                                        {
                                          ...
                                          gameObject = (int64_t)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_8279/*"LOTTERY_SHOP_PAY_INFO"*/,
                                                                  0LL);
                                          if ( payInfoLabel )
                                          {
                                            ...
                                            gameObject = (int64_t)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_8280/*"LOTTERY_SHOP_SKIP_INFO"*/,
                                                                    0LL);
                                            if ( checkboxLabel )
                                            {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64C5C(checkMarkSprite, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CE7 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMaster_ShopDetailMaster___, v5);
    sub_1B64A00(&DataManager_TypeInfo, v6);
    sub_1B64A00(&EventRewardRootComponent_TypeInfo, v7);
    sub_1B64A00(&LotteryShopBuyItemConfirmMenu_TypeInfo, v8);
    sub_1B64A00(&StringLiteral_16057/*"_"*/, v9);
    sub_1B64A00(&StringLiteral_17559/*"btn_txt_trade"*/, v10);
    byte_4A02CE7 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (ShopDetailMaster_o *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_ShopDetailMaster___);
...
LABEL_17:
    ...
    if ( Master_object )
    {
      UISprite__set_spriteName((UISprite_o *)Master_object, (System_String_o *)StringLiteral_17559/*"btn_txt_trade"*/, 0LL);
      Master_object = (ShopDetailMaster_o *)this->fields.decideButtonImg;
      if ( Master_object )
      {
...
LABEL_23:
  ...
  if ( shopEntity->fields.payType == 6 )
  {
    ...
    v20 = System_String__Concat_61398400(VALENTINE_BTN_NAME, v18, (System_String_o *)StringLiteral_16057/*"_"*/, v19, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( !itemSlider )
LABEL_11:
    sub_1B64C5C(itemSlider, *(_QWORD *)&buyableCount);
  if ( buyableCount <= 1 )
    v7 = 1;
  else
    v7 = buyableCount;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02CE8 & 1) == 0 )
  {
    this = (LotteryShopBuyItemConfirmMenu_o *)sub_1B64A00(&LocalizationManager_TypeInfo, *(_QWORD *)&count);
    byte_4A02CE8 = 1;
  }
