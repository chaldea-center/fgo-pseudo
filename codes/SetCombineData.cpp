...
void SetCombineData__Clear(SetCombineData_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.getHpAdjustVal = 0;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.materialUsrSvtIdList, 0, v2, v3, v4, v5, v6, v7);
  this->fields.svtEqMaterialList = 0;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.svtEqMaterialList, 0, v9, v10, v11, v12, v13, v14);
}