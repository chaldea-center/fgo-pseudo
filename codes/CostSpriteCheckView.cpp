void CostSpriteCheckView___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE40 & 1) == 0 )
  {
    sub_1C93AD4(&CostSpriteCheckView_TypeInfo);
    sub_1C93AD4(&string___TypeInfo);
    sub_1C93AD4(&StringLiteral_25830/*"読み込み成功"*/);
    sub_1C93AD4(&StringLiteral_25786/*"全て"*/);
    sub_1C93AD4(&StringLiteral_25829/*"読み込み失敗"*/);
    byte_4D2DE40 = 1;
  }
  ...
  v9 = v1;
  if ( !*(_DWORD *)(v1 + 24)
    || (v10 = StringLiteral_25786/*"全て"*/,
        *(_QWORD *)(v1 + 32) = StringLiteral_25786/*"全て"*/,
        sub_1C93A78((GrandQuestFolderBoardItem_o *)(v1 + 32), v10, v3, v4, v5, v6, v7, v8),
        *(_DWORD *)(v9 + 24) <= 1u)
    || (v17 = StringLiteral_25829/*"読み込み失敗"*/,
        *(_QWORD *)(v9 + 40) = StringLiteral_25829/*"読み込み失敗"*/,
        sub_1C93A78((GrandQuestFolderBoardItem_o *)(v9 + 40), v17, v11, v12, v13, v14, v15, v16),
        *(_DWORD *)(v9 + 24) <= 2u) )
  {
    sub_1C93D34(v1);
  }
  v24 = StringLiteral_25830/*"読み込み成功"*/;
  *(_QWORD *)(v9 + 48) = StringLiteral_25830/*"読み込み成功"*/;
...
void CostSpriteCheckView__Setup(CostSpriteCheckView_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2DE3C & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_CostSpriteCheckView__Setup_b__10_0__);
    sub_1C93AD4(&CostSpriteCheckView_TypeInfo);
    byte_4D2DE3C = 1;
  }
