        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB416B & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_16558/*"_anim"*/, *(_QWORD *)&eventId);
    sub_1BAB41C(&StringLiteral_18869/*"ef_mapnamechange_"*/, v8);
    byte_4AB416B = 1;
  }
  v9 = System_Int32__ToString((int32_t)&v17, 0LL);
  v10 = System_String__Concat_62059388(
          (System_String_o *)StringLiteral_18869/*"ef_mapnamechange_"*/,
          v9,
          (System_String_o *)StringLiteral_16558/*"_anim"*/,
          0LL);
  this->fields.baseName = v10;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.baseName, (int32_t)v10, v11, v12);
  this->fields.changeUiCallback = changeUiCallback;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.changeUiCallback, (int32_t)changeUiCallback, v13, v14);
  this->fields.animEndCallback = endCallback;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.animEndCallback, (int32_t)endCallback, v15, v16);
}