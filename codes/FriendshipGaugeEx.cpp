void __fastcall FriendshipGaugeEx___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B2BA0 & 1) == 0 )
  {
    sub_B52984(&FriendshipGaugeEx_TypeInfo);
    sub_B52984(&StringLiteral_5407/*"DownloadBondAtlas"*/);
    sub_B52984(&StringLiteral_19597/*"img_bondsgage_11"*/);
    sub_B52984(&StringLiteral_2866/*"Bond/DownloadBond"*/);
    byte_42B2BA0 = 1;
  }
  ...
  v9 = (System_Int32_array **)StringLiteral_2866/*"Bond/DownloadBond"*/;
  static_fields->AtlasPath = (struct System_String_o *)StringLiteral_2866/*"Bond/DownloadBond"*/;
  sub_B52920((BattleServantConfConponent_o *)&static_fields->AtlasPath, v9, v1, v2, v3, v4, v5, v6);
  v10 = FriendshipGaugeEx_TypeInfo->static_fields;
  v11 = (System_Int32_array **)StringLiteral_5407/*"DownloadBondAtlas"*/;
  v10->ObjectName = (struct System_String_o *)StringLiteral_5407/*"DownloadBondAtlas"*/;
  sub_B52920((BattleServantConfConponent_o *)&v10->ObjectName, v11, v12, v13, v14, v15, v16, v17);
  v18 = FriendshipGaugeEx_TypeInfo->static_fields;
  v19 = (System_Int32_array **)StringLiteral_19597/*"img_bondsgage_11"*/;
  v18->SpriteName = (struct System_String_o *)StringLiteral_19597/*"img_bondsgage_11"*/;
  sub_B52920((BattleServantConfConponent_o *)&v18->SpriteName, v19, v20, v21, v22, v23, v24, v25);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2B9F & 1) == 0 )
  {
    sub_B52984(&Method_DataManager_GetMaster_FriendshipMaster___);
  ...
  Master_WarQuestSelectionMaster = (int **)DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_FriendshipMaster___);
...
void __fastcall FriendshipGaugeEx__Start(FriendshipGaugeEx_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2B9D & 1) == 0 )
  {
    ...
    sub_B52984(&Method_FriendshipGaugeEx__Start_b__19_0__);
    sub_B52984(&FriendshipGaugeEx_TypeInfo);
    sub_B52984(&AssetLoader_LoadEndDataHandler_TypeInfo);
    sub_B52984(&StringLiteral_4637/*"DISABLE_FRIENDSHIP_EXCEED"*/);
    byte_42B2B9D = 1;
  }
  if ( ConstantMaster__getValue((System_String_o *)StringLiteral_4637/*"DISABLE_FRIENDSHIP_EXCEED"*/, 0LL) != 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( asset )
  {
    ...
    {
      sub_B52A5C(Object_WarBoardWaitTimeSetting, v7);
    }
