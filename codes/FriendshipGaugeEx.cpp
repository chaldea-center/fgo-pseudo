void __fastcall FriendshipGaugeEx___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1FC92 & 1) == 0 )
  {
    sub_1BCAFF8(&FriendshipGaugeEx_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_5288/*"DownloadBondAtlas"*/, v4);
    sub_1BCAFF8(&StringLiteral_20159/*"img_bondsgage_11"*/, v5);
    sub_1BCAFF8(&StringLiteral_3169/*"Bond/DownloadBond"*/, v6);
    byte_4B1FC92 = 1;
  }
  ...
  *(_QWORD *)&static_fields->POSITION_Y_DEFAULT = 0x412000003F19999ALL;
  v8 = StringLiteral_3169/*"Bond/DownloadBond"*/;
  static_fields->AtlasPath = (struct System_String_o *)StringLiteral_3169/*"Bond/DownloadBond"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->AtlasPath, v8, v2, v3);
  v9 = StringLiteral_5288/*"DownloadBondAtlas"*/;
  v10 = FriendshipGaugeEx_TypeInfo->static_fields;
  v10->ObjectName = (struct System_String_o *)StringLiteral_5288/*"DownloadBondAtlas"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v10->ObjectName, v9, v11, v12);
  v13 = StringLiteral_20159/*"img_bondsgage_11"*/;
  v14 = FriendshipGaugeEx_TypeInfo->static_fields;
  v14->SpriteName = (struct System_String_o *)StringLiteral_20159/*"img_bondsgage_11"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v14->SpriteName, v13, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_FriendshipMaster___);
  if ( !Master_object
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FC91 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMaster_FriendshipMaster___, *(_QWORD *)&friendship);
    sub_1BCAFF8(&DataManager_TypeInfo, v5);
    sub_1BCAFF8(&FriendshipGaugeEx_TypeInfo, v6);
    byte_4B1FC91 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = (int **)DataManager__GetMaster_object_((const MethodInfo_301AA50 *)Method_DataManager_GetMaster_FriendshipMaster___);
  if ( !Master_object
...
LABEL_43:
          sub_1BCB25C(Master_object, v8, v16);
...
void __fastcall FriendshipGaugeEx__Start(FriendshipGaugeEx_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1FC8F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_FriendshipGaugeEx__Start_b__19_0__, v3);
    sub_1BCAFF8(&FriendshipGaugeEx_TypeInfo, v4);
    sub_1BCAFF8(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1BCAFF8(&StringLiteral_4973/*"DISABLE_FRIENDSHIP_EXCEED"*/, v6);
    byte_4B1FC8F = 1;
  }
  if ( ConstantMaster__getValue((System_String_o *)StringLiteral_4973/*"DISABLE_FRIENDSHIP_EXCEED"*/, 0LL) != 1 )
  {
        ...
        const MethodInfo *method)
{
  ...
  __int64 v6; // x1
  FriendshipGaugeEx_c *v7; // x0
  UnityEngine_GameObject_o *Object_object__50315216; // x0
  __int64 v9; // x1

  if ( (byte_4B1FC93 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_AssetData_GetObject_GameObject____76915336, asset);
    sub_1BCAFF8(&FriendshipGaugeEx_TypeInfo, v5);
  ...
  if ( asset )
  {
    ...
    Object_object__50315216 = (UnityEngine_GameObject_o *)AssetData__GetObject_object__50315216(
                                                            asset,
    ...
    if ( !Object_object__50315216
      || (Object_object__50315216 = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                  Object_object__50315216,
                                                                  (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_UIAtlas___),
          !this->fields.bigIcon)
      || (UISprite__set_atlas(this->fields.bigIcon, (UIAtlas_o *)Object_object__50315216, 0LL),
          (Object_object__50315216 = (UnityEngine_GameObject_o *)this->fields.bigIcon) == 0LL) )
    {
      sub_1BCB254(Object_object__50315216, v9);
    }
    UISprite__set_spriteName(
      (UISprite_o *)Object_object__50315216,
