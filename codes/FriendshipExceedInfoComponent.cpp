...
void FriendshipExceedInfoComponent__InitLabel(FriendshipExceedInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D30915 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_8819/*"MSG_FRIENDSHIP_EXCEED_DISABLE"*/);
    byte_4D30915 = 1;
  }
  if ( !this->fields.isInitialized )
  {
    ...
    v4 = LocalizationManager__Get((System_String_o *)StringLiteral_8819/*"MSG_FRIENDSHIP_EXCEED_DISABLE"*/, 0);
    if ( !disableLabel
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)max = 0;
  ...
  disableLabel = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !disableLabel )
    goto LABEL_36;
  ...
  *(_QWORD *)&v34.fields.fakeValue = v16;
  disableLabel = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v34, 0);
  if ( !v18 )
    goto LABEL_36;
  ...
  *(_QWORD *)&v35.fields.fakeValue = v22;
  disableLabel = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v35, 0);
  if ( !v20 )
    goto LABEL_36;
