        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A53B & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_8906/*"MSG_FRIENDSHIP_EXCEED_DISABLE"*/, v3);
    byte_4B6A53B = 1;
  }
  if ( !this->fields.isInitialized )
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8906/*"MSG_FRIENDSHIP_EXCEED_DISABLE"*/, 0LL);
    if ( !disableLabel
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A53C & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_FriendshipMaster___, userServantEntity);
  ...
  *(_QWORD *)fraction = 0LL;
  ...
  disableLabel = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !disableLabel )
    goto LABEL_36;
  ...
  *(_QWORD *)&v38.fields.fakeValue = v20;
  disableLabel = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
                                              v38,
                                              0LL);
  if ( !v22 )
    goto LABEL_36;
