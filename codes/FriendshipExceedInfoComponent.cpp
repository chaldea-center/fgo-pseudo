        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB95A7 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_8763/*"MSG_FRIENDSHIP_EXCEED_DISABLE"*/, v3);
    byte_4AB95A7 = 1;
  }
  if ( !this->fields.isInitialized )
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8763/*"MSG_FRIENDSHIP_EXCEED_DISABLE"*/, 0LL);
    if ( !disableLabel
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB95A8 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_FriendshipMaster___, userServantEntity);
  ...
  *(_QWORD *)fraction = 0LL;
  ...
  disableLabel = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !disableLabel )
    goto LABEL_36;
  ...
  *(_QWORD *)&v38.fields.fakeValue = v20;
  disableLabel = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46695852(
                                              v38,
                                              0LL);
  if ( !v22 )
    goto LABEL_36;
