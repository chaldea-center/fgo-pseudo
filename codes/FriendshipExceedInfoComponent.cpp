        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C259E0 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_8942/*"More than one SKU found when purchasing SKU "*/, v3);
    byte_4C259E0 = 1;
  }
  if ( !this->fields.isInitialized )
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8942/*"More than one SKU found when purchasing SKU "*/, 0LL);
    if ( !disableLabel
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C259E1 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_FriendshipMaster___, userServantEntity);
  ...
  *(_QWORD *)fraction = 0LL;
  ...
  disableLabel = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !disableLabel )
    goto LABEL_36;
  ...
  *(_QWORD *)&v38.fields.fakeValue = v20;
  disableLabel = (UnityEngine_Component_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(
                                              v38,
                                              0LL);
  if ( !v22 )
    goto LABEL_36;
