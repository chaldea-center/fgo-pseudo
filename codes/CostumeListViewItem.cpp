        ...
        const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.isNotHaveReleaseItem = 0;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.closedMessage, v7, v8, v9);
  this->fields.baseSvt = baseSvt;
  p_baseSvt = &this->fields.baseSvt;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.baseSvt, (int32_t)baseSvt, v11, v12);
  this->fields.costumeEntity = data;
  p_costumeEntity = &this->fields.costumeEntity;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.costumeEntity, (int32_t)data, v14, v15);
  ...
  *(_QWORD *)&v57.fields.fakeValue = v19;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v57, 0LL);
  if ( !data || !v18 )
    goto LABEL_50;
  v21 = ServantCostumeReleaseMaster__checkItemHaving(v18, (int32_t)Instance, data->fields.id, 0LL);
  this->fields.isNotHaveReleaseItem = !v21;
  if ( !v21 )
  {
    v24 = ServantCostumeEntity__checkFlag(data, 4, 0LL) || ServantCostumeEntity__checkFlag(data, 64, 0LL);
    this->fields.isHide = v24;
    itemGetInfo = data->fields.itemGetInfo;
    this->fields.closedMessage = itemGetInfo;
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.closedMessage, (int32_t)itemGetInfo, v22, v23);
  }
  ...
  *(_QWORD *)&v58.fields.fakeValue = v26;
  v28 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v58, 0LL);
  ...
  *(_OWORD *)&v56.fields.fakeValue = v29;
  ...
  this->fields.isNotClearCond = !ServantCostumeReleaseMaster__IsCostumeReleaseCondClear(v18, data, v30, v32, 0LL);
  v33 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(baseSvt->fields.svtId, 0LL);
  ...
  *(_OWORD *)&v54.fields.fakeValue = v34;
  v36 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46453324(&v54, 0LL);
  this->fields.isNotClearCostumeRelease = !ServantCostumeReleaseMaster__IsCostumeReleaseCondClear(
                                             ...
                                             v36,
                                             0LL);
  v37 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(baseSvt->fields.svtId, 0LL);
  ...
  *(_OWORD *)&v53.fields.fakeValue = v38;
  v40 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46453324(&v53, 0LL);
  ...
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v41[5], 0LL);
  if ( !*p_costumeEntity || !v42 )
    goto LABEL_50;
  if ( !CombineCostumeMaster__IsClearCombineCondition(v42, (int32_t)Instance, (*p_costumeEntity)->fields.id, 0LL) )
  ...
  *(_QWORD *)&v59.fields.fakeValue = v44;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v59, 0LL);
  if ( !v46 )
    goto LABEL_50;
...
LABEL_48:
      ...
      if ( Instance )
      {
        ...
        *(_QWORD *)&v60.fields.fakeValue = v49;
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v60, 0LL);
        if ( v51 )
        {
        ...
        const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.isTermination = 0;
  ...
  if ( (unsigned int)releaseType <= 5 )
    this->fields.sortValue0 = qword_BEF920[releaseType];
  return 1;
}
