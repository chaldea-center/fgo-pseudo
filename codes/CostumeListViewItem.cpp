        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5AF31 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataManager_GetMasterData_CombineCostumeMaster___);
  ...
  *(_WORD *)&this->fields.isNotHaveReleaseItem = 0;
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.closedMessage, v7, v8, v9);
  this->fields.baseSvt = baseSvt;
  p_baseSvt = &this->fields.baseSvt;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.baseSvt, (int32_t)baseSvt, v11, v12);
  this->fields.costumeEntity = data;
  p_costumeEntity = &this->fields.costumeEntity;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.costumeEntity, (int32_t)data, v14, v15);
  ...
  *(_QWORD *)&v57.fields.fakeValue = v19;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v57, 0);
  if ( !data || !v18 )
    goto LABEL_50;
  ...
  if ( !v21 )
  {
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.closedMessage, (int32_t)itemGetInfo, v22, v23);
  }
  ...
  *(_QWORD *)&v58.fields.fakeValue = v26;
  v28 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v58, 0);
  ...
  *(_OWORD *)&v56.fields.fakeValue = v29;
  ...
  v55 = v56;
  v32 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49007660(&v55, 0);
  this->fields.isNotClearCond = !ServantCostumeReleaseMaster__IsCostumeReleaseCondClear(v18, data, v30, v32, 0);
  v33 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(baseSvt->fields.svtId, 0);
  ...
  *(_OWORD *)&v54.fields.fakeValue = v34;
  v36 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49007660(&v54, 0);
  this->fields.isNotClearCostumeRelease = !ServantCostumeReleaseMaster__IsCostumeReleaseCondClear(
                                             ...
                                             v36,
                                             0);
  v37 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(baseSvt->fields.svtId, 0);
  ...
  *(_OWORD *)&v53.fields.fakeValue = v38;
  v40 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49007660(&v53, 0);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_30F9A70 *)Method_DataManager_GetMasterData_CombineCostumeMaster___);
  v41 = (CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o *)*p_baseSvt;
  if ( !*p_baseSvt )
    goto LABEL_50;
  v42 = (CombineCostumeMaster_o *)Instance;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v41[5], 0);
  ...
  *(_QWORD *)&v59.fields.fakeValue = v44;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v59, 0);
  if ( !v46 )
    goto LABEL_50;
...
LABEL_48:
      ...
      if ( Instance )
      {
        ...
        *(_QWORD *)&v60.fields.fakeValue = v49;
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49004136(v60, 0);
        if ( v51 )
        {
...
bool CostumeListViewItem__SetSortValue(CostumeListViewItem_o *this, ListViewSort_o *sort, const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.isTermination = 0;
  ...
  if ( (unsigned int)releaseType <= 5 )
    this->fields.sortValue0 = qword_C4CD98[releaseType];
  return 1;
}
