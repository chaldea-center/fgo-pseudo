        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0C5BF & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_CombineCostumeMaster___, data);
    sub_1B686D4(&Method_DataManager_GetMasterData_EventCombineCostumeMaster___, v7);
    sub_1B686D4(&Method_DataManager_GetMasterData_ServantCostumeReleaseMaster___, v8);
  ...
  *(_WORD *)&this->fields.isNotHaveReleaseItem = 0;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.closedMessage, v14, v15, v16);
  this->fields.baseSvt = baseSvt;
  p_baseSvt = &this->fields.baseSvt;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.baseSvt, (int32_t)baseSvt, v18, v19);
  this->fields.costumeEntity = data;
  p_costumeEntity = &this->fields.costumeEntity;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.costumeEntity, (int32_t)data, v21, v22);
  ...
  *(_QWORD *)&v64.fields.fakeValue = v26;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v64, 0LL);
  if ( !data || !v25 )
    goto LABEL_50;
  ...
  if ( !v28 )
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.closedMessage, (int32_t)itemGetInfo, v29, v30);
  }
  ...
  *(_OWORD *)&v63.fields.fakeValue = v36;
  ...
  v62 = v63;
  v39 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46242940(&v62, 0LL);
  this->fields.isNotClearCond = !ServantCostumeReleaseMaster__IsCostumeReleaseCondClear(v25, data, v37, v39, 0LL);
  v40 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(baseSvt->fields.svtId, 0LL);
  ...
  *(_OWORD *)&v61.fields.fakeValue = v41;
  v43 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46242940(&v61, 0LL);
  this->fields.isNotClearCostumeRelease = !ServantCostumeReleaseMaster__IsCostumeReleaseCondClear(
                                             ...
                                             v43,
                                             0LL);
  v44 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(baseSvt->fields.svtId, 0LL);
  ...
  *(_OWORD *)&v60.fields.fakeValue = v45;
  v47 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46242940(&v60, 0LL);
  ...
  Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                Instance,
                                (const MethodInfo_2E49D50 *)Method_DataManager_GetMasterData_CombineCostumeMaster___);
  v48 = (CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o *)*p_baseSvt;
  if ( !*p_baseSvt )
    goto LABEL_50;
  v49 = (CombineCostumeMaster_o *)Instance;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v48[5], 0LL);
  ...
  *(_QWORD *)&v66.fields.fakeValue = v51;
  Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v66, 0LL);
  if ( !v53 )
    goto LABEL_50;
...
LABEL_48:
      ...
      if ( Instance )
      {
        ...
        *(_QWORD *)&v67.fields.fakeValue = v56;
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46239416(v67, 0LL);
        if ( v58 )
        {
        ...
        const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.isTermination = 0;
  ...
  if ( (unsigned int)releaseType <= 5 )
    this->fields.sortValue0 = qword_BE14F0[releaseType];
  return 1;
}
