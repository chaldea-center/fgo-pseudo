        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24C27 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Array_Empty_BattleLogicTask___, logic);
    byte_4C24C27 = 1;
  }
  ...
  else
  {
    ...
    if ( !v15 )
    {
      sub_1C8D69C(Method_System_Array_Empty_BattleLogicTask___);
      v15 = v14[7];
    }
    v16 = *(_QWORD *)(v15 + 16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24C26 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Array_Empty_BuffList_ACTION___, method);
    byte_4C24C26 = 1;
  }
