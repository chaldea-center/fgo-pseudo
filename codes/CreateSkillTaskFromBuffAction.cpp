        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA6C5 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Array_Empty_BattleLogicTask___, logic);
    byte_4BCA6C5 = 1;
  }
  ...
  else
  {
    ...
    if ( !v15 )
    {
      sub_1C6CB0C(Method_System_Array_Empty_BattleLogicTask___);
      v15 = v14[7];
    }
    v16 = *(_QWORD *)(v15 + 16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCA6C4 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Array_Empty_BuffList_ACTION___, method);
    byte_4BCA6C4 = 1;
  }
