void ProgressIntervalTurnActionData___ctor(ProgressIntervalTurnActionData_o *this, const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.turnProgressSvtHash, (int32_t)v3, v4, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C29879 & 1) == 0 )
  {
    this = (ProgressIntervalTurnActionData_o *)sub_1C2D490(&Method_System_Collections_Generic_HashSet_BattleServantData__Add__);
    byte_4C29879 = 1;
  }
  if ( !svtArray )
    goto LABEL_13;
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v6 >= max_length )
        sub_1C2D6F4(this, svtArray, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2987A & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__Dispose__);
    sub_1C2D490(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__MoveNext__);
    sub_1C2D490(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__get_Current__);
    sub_1C2D490(&System_Func_BattleBuffData_BuffData__bool__TypeInfo);
    sub_1C2D490(&Method_System_Collections_Generic_HashSet_BattleServantData__GetEnumerator__);
    sub_1C2D490(&Method_ProgressIntervalTurnActionData_UpdateIntervalTurn__);
    sub_1C2D490(&Method_ProgressIntervalTurnActionData___c__FixDisplayWaitingIntervalBuff_b__2_0__);
    sub_1C2D490(&ProgressIntervalTurnActionData___c_TypeInfo);
    byte_4C2987A = 1;
  }
  ...
  System_Collections_Generic_HashSet_object___GetEnumerator(
    &v24,
    turnProgressSvtHash,
    (const MethodInfo_36418F0 *)Method_System_Collections_Generic_HashSet_BattleServantData__GetEnumerator__);
  v25 = v24;
  while ( 1 )
  {
    v7 = System_Collections_Generic_HashSet_Enumerator_object___MoveNext(
           &v25,
           (const MethodInfo_3513F98 *)Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__MoveNext__);
    if ( !v7 )
      break;
    ...
    if ( !_9__2_0 )
    {
      ...
      _9__2_0 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_BattleBuffData_BuffData__bool__TypeInfo);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__2_0, (int32_t)_9__2_0, v18, v19);
    }
    ...
    v22 = (System_Action_object__o *)sub_1C2D6DC(System_Action_BattleBuffData_BuffData__TypeInfo);
  ...
  System_Collections_Generic_HashSet_Enumerator_object___Dispose(
    &v25,
    (const MethodInfo_3513F94 *)Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__Dispose__);
}
...
void ProgressIntervalTurnActionData___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(ProgressIntervalTurnActionData___c_TypeInfo);
  System_Object___ctor(v1, 0);
  ProgressIntervalTurnActionData___c_TypeInfo->static_fields->__9 = (struct ProgressIntervalTurnActionData___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)ProgressIntervalTurnActionData___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
