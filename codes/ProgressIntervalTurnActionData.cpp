void ProgressIntervalTurnActionData___ctor(ProgressIntervalTurnActionData_o *this, const MethodInfo *method)
{
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.turnProgressSvtHash, (int32_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9AE1 & 1) == 0 )
  {
    this = (ProgressIntervalTurnActionData_o *)sub_1C713B0(&Method_System_Collections_Generic_HashSet_BattleServantData__Add__);
    byte_4CC9AE1 = 1;
  }
  if ( !svtArray )
    goto LABEL_13;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC9AE2 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__get_Current__);
    sub_1C713B0(&System_Func_BattleBuffData_BuffData__bool__TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_HashSet_BattleServantData__GetEnumerator__);
    sub_1C713B0(&Method_ProgressIntervalTurnActionData_UpdateIntervalTurn__);
    sub_1C713B0(&Method_ProgressIntervalTurnActionData___c__FixDisplayWaitingIntervalBuff_b__2_0__);
    sub_1C713B0(&ProgressIntervalTurnActionData___c_TypeInfo);
    byte_4CC9AE2 = 1;
  }
  ...
  System_Collections_Generic_HashSet_object___GetEnumerator(
    &v29,
    turnProgressSvtHash,
    (const MethodInfo_36C7CEC *)Method_System_Collections_Generic_HashSet_BattleServantData__GetEnumerator__);
  v30 = v29;
  while ( 1 )
  {
    v7 = System_Collections_Generic_HashSet_Enumerator_object___MoveNext(
           &v30,
           (const MethodInfo_3595D58 *)Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__MoveNext__);
    if ( !v7 )
      break;
    ...
    if ( !_9__2_0 )
    {
      ...
      _9__2_0 = (System_Func_object__bool__o *)sub_1C715FC(System_Func_BattleBuffData_BuffData__bool__TypeInfo);
    ...
    v26 = (System_Action_object__o *)sub_1C715FC(System_Action_BattleBuffData_BuffData__TypeInfo);
  ...
  System_Collections_Generic_HashSet_Enumerator_object___Dispose(
    &v30,
    (const MethodInfo_3595D54 *)Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__Dispose__);
  if ( !v28
    || (turnProgressSvtHash = (System_Collections_Generic_HashSet_T__o *)v28->fields._FieldEnvData_k__BackingField) == 0 )
  {
LABEL_20:
    sub_1C71608(turnProgressSvtHash, v5);
  }
...
void ProgressIntervalTurnActionData___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(ProgressIntervalTurnActionData___c_TypeInfo);
