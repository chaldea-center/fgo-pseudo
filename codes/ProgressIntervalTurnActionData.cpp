void __fastcall ProgressIntervalTurnActionData___ctor(ProgressIntervalTurnActionData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5092E & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_Generic_HashSet_BattleServantData___ctor__, v3);
    sub_1B863B8(&System_Collections_Generic_HashSet_BattleServantData__TypeInfo, v4);
    byte_4A5092E = 1;
  }
  v5 = (System_Collections_Generic_HashSet_T__o *)sub_1B86604(System_Collections_Generic_HashSet_BattleServantData__TypeInfo);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.turnProgressSvtHash, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5092C & 1) == 0 )
  {
    this = (ProgressIntervalTurnActionData_o *)sub_1B863B8(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5092D & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Linq_Enumerable_ToArray_BattleBuffData_BuffData___, v5);
    sub_1B863B8(&Method_System_Linq_Enumerable_Where_BattleBuffData_BuffData___, v6);
    sub_1B863B8(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__Dispose__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__MoveNext__, v8);
    sub_1B863B8(&Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__get_Current__, v9);
    sub_1B863B8(&System_Func_BattleBuffData_BuffData__bool__TypeInfo, v10);
    sub_1B863B8(&Method_System_Collections_Generic_HashSet_BattleServantData__GetEnumerator__, v11);
    sub_1B863B8(&Method_ProgressIntervalTurnActionData_UpdateIntervalTurn__, v12);
    sub_1B863B8(&Method_ProgressIntervalTurnActionData___c__FixDisplayWaitingIntervalBuff_b__2_0__, v13);
    sub_1B863B8(&ProgressIntervalTurnActionData___c_TypeInfo, v14);
    byte_4A5092D = 1;
  }
  ...
  System_Collections_Generic_HashSet_object___GetEnumerator(
    &v33,
    turnProgressSvtHash,
    (const MethodInfo_34BE79C *)Method_System_Collections_Generic_HashSet_BattleServantData__GetEnumerator__);
  v34 = v33;
  while ( 1 )
  {
    v17 = System_Collections_Generic_HashSet_Enumerator_object___MoveNext(
            &v34,
            (const MethodInfo_33980C4 *)Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__MoveNext__);
    if ( !v17 )
      break;
    ...
    if ( !_9__2_0 )
    {
      ...
      _9__2_0 = (System_Func_object__bool__o *)sub_1B86604(System_Func_BattleBuffData_BuffData__bool__TypeInfo);
    ...
    v32 = (System_Action_object__o *)sub_1B86604(System_Action_BattleBuffData_BuffData__TypeInfo);
  ...
  System_Collections_Generic_HashSet_Enumerator_object___Dispose(
    &v34,
    (const MethodInfo_33980C0 *)Method_System_Collections_Generic_HashSet_Enumerator_BattleServantData__Dispose__);
}
...
void __fastcall ProgressIntervalTurnActionData___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5092F & 1) == 0 )
  {
    sub_1B863B8(&ProgressIntervalTurnActionData___c_TypeInfo, v1);
    byte_4A5092F = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(ProgressIntervalTurnActionData___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ProgressIntervalTurnActionData___c_TypeInfo->static_fields->__9 = (struct ProgressIntervalTurnActionData___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)ProgressIntervalTurnActionData___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
