void __fastcall UserEventSpotMaster___ctor(UserEventSpotMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A70B3A & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string___ctor__, method);
    byte_4A70B3A = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    351,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70B38 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__GetEntity__, userId);
    byte_4A70B38 = 1;
  }
  ...
  return (UserEventSpotEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_312C900 *)Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70B3C & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_System_Collections_Generic_List_UserEventSpotEntity__Add__, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEventSpotEntity__ToArray__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_UserEventSpotEntity___ctor__, v8);
    sub_1B90010(&System_Collections_Generic_List_UserEventSpotEntity__TypeInfo, v9);
    sub_1B90010(&NetworkManager_TypeInfo, v10);
    sub_1B90010(&UserEventSpotEntity_TypeInfo, v11);
    byte_4A70B3C = 1;
  }
  v12 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_UserEventSpotEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_UserEventSpotEntity___ctor__);
...
LABEL_20:
  ...
  return (UserEventSpotEntity_array *)System_Collections_Generic_List_object___ToArray(
                                        v12,
                                        (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_UserEventSpotEntity__ToArray__);
}


// local variable allocation has failed, the output may be wrong!
UserEventSpotEntity_o *__fastcall UserEventSpotMaster__GetEntity_40165596(
        UserEventSpotMaster_o *this,
        int32_t eventId,
        int32_t spotId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70B3B & 1) == 0 )
  {
    sub_1B90010(&System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, *(_QWORD *)&eventId);
    sub_1B90010(&NetworkManager_TypeInfo, v5);
    sub_1B90010(&string___TypeInfo, v6);
    sub_1B90010(&UserEventSpotEntity_TypeInfo, v7);
    sub_1B90010(&StringLiteral_1545/*":"*/, v8);
    byte_4A70B3B = 1;
  }
  v33 = 0LL;
  v9 = sub_1B900B8(string___TypeInfo, 5LL);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  if ( !*(_DWORD *)(v9 + 24) )
    goto LABEL_25;
  *(_QWORD *)(v9 + 32) = lookup;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v9 + 32), (int32_t)lookup, v12, v13);
  if ( *(_DWORD *)(v9 + 24) <= 1u )
    goto LABEL_25;
  v16 = StringLiteral_1545/*":"*/;
  *(_QWORD *)(v9 + 40) = StringLiteral_1545/*":"*/;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v9 + 40), v16, v14, v15);
  lookup = (__int64 *)System_Int32__ToString((int32_t)&v35, 0LL);
  if ( *(_DWORD *)(v9 + 24) <= 2u
    || (*(_QWORD *)(v9 + 48) = lookup,
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v9 + 48), (int32_t)lookup, v17, v18),
        *(_DWORD *)(v9 + 24) <= 3u)
    || (v21 = StringLiteral_1545/*":"*/,
        *(_QWORD *)(v9 + 56) = StringLiteral_1545/*":"*/,
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v9 + 56), v21, v19, v20),
        lookup = (__int64 *)System_Int32__ToString((int32_t)&v34, 0LL),
        *(_DWORD *)(v9 + 24) <= 4u) )
  {
LABEL_25:
    sub_1B90274(lookup, v11);
  }
  *(_QWORD *)(v9 + 64) = lookup;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v9 + 64), (int32_t)lookup, v22, v23);
  v24 = System_String__Concat_61800620((System_String_array *)v9, 0LL);
...
LABEL_26:
  ...
  {
LABEL_16:
    v29 = sub_1BE1FF0(lookup, System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, 1LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70B39 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__TryGetEntity__, entity);
    byte_4A70B39 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__TryGetEntity__);
}