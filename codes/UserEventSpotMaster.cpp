void __fastcall UserEventSpotMaster___ctor(UserEventSpotMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FD0B2 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string___ctor__, method);
    byte_49FD0B2 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    351,
    (const MethodInfo_30D41BC *)Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD0B0 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__GetEntity__, userId);
    byte_49FD0B0 = 1;
  }
  ...
  return (UserEventSpotEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                    PK,
                                    (const MethodInfo_30D41FC *)Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD0B4 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_System_Collections_Generic_List_UserEventSpotEntity__Add__, v6);
    sub_1B640C8(&Method_System_Collections_Generic_List_UserEventSpotEntity__ToArray__, v7);
    sub_1B640C8(&Method_System_Collections_Generic_List_UserEventSpotEntity___ctor__, v8);
    sub_1B640C8(&System_Collections_Generic_List_UserEventSpotEntity__TypeInfo, v9);
    sub_1B640C8(&NetworkManager_TypeInfo, v10);
    sub_1B640C8(&UserEventSpotEntity_TypeInfo, v11);
    byte_49FD0B4 = 1;
  }
  ...
  System_Collections_Generic_List_object____ctor(
    v12,
    (const MethodInfo_34ACEA0 *)Method_System_Collections_Generic_List_UserEventSpotEntity___ctor__);
    ...
    while ( 1 )
    {
      ...
      if ( list )
      {
          ...
          && *(UserEventSpotEntity_c **)(*(_QWORD *)(*(_QWORD *)list + 200LL) + 8 * methodPtr_low - 8) == UserEventSpotEntity_TypeInfo )
        {
          ...
          if ( v18 == list && *(_DWORD *)(v16 + 24) == eventId )
          {
            if ( !v12 )
              break;
            items = v12->fields._items;
            v22 = Method_System_Collections_Generic_List_UserEventSpotEntity__Add__;
            ++v12->fields._version;
            if ( !items )
              break;
...
LABEL_20:
  ...
  return (UserEventSpotEntity_array *)System_Collections_Generic_List_object___ToArray(
                                        v12,
                                        (const MethodInfo_34AF2CC *)Method_System_Collections_Generic_List_UserEventSpotEntity__ToArray__);
}


// local variable allocation has failed, the output may be wrong!
UserEventSpotEntity_o *__fastcall UserEventSpotMaster__GetEntity_39779860(
        UserEventSpotMaster_o *this,
        int32_t eventId,
        int32_t spotId,
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD0B3 & 1) == 0 )
  {
    ...
    sub_1B640C8(&UserEventSpotEntity_TypeInfo, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD0B1 & 1) == 0 )
  {
    sub_1B640C8(&Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__TryGetEntity__, entity);
    byte_49FD0B1 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D424C *)Method_DataMasterBase_UserEventSpotMaster__UserEventSpotEntity__string__TryGetEntity__);
}