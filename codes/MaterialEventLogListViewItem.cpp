...
void __fastcall MaterialEventLogListViewItem___ctor_30949416(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9CF8 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_VoiceMaterialCondMaster___, *(_QWORD *)&limitCount);
    sub_1B64870(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v5);
    this = (MaterialEventLogListViewItem_o *)sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_49F9CF8 = 1;
  }
  ...
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46216376(voiceId, 0LL);
  if ( System_String__IsNullOrEmpty(v9, 0LL) )
    return 1;
  this = (MaterialEventLogListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_14;
  this = (MaterialEventLogListViewItem_o *)DataManager__GetMasterData_object_(
                                             (DataManager_o *)this,
                                             (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_VoiceMaterialCondMaster___);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
  this = (MaterialEventLogListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46216376(
                                             v15,
                                             0LL);
  if ( !v12 )
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9CF9 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_1/*""*/, sort);
    byte_49F9CF9 = 1;
  }
  klass = this->klass;
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(&this->fields._info_k__BackingField);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814(&this->fields.playableLimitCountlist);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v28; // x0
  __int64 *v30; // x0
  const MethodInfo_32282BC **v31; // x23
  int v32; // w1
  __int64 v33; // x22
  ...
  if ( (byte_49F9CFB & 1) == 0 )
  {
    sub_1B64870(&System_Action_MaterialEventLogListViewItem__TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__Dispose__, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__MoveNext__, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__get_Current__, v6);
    sub_1B64870(&MaterialEventLogListViewItem_Info_TypeInfo, v7);
  ...
  v11 = sub_1B64ABC(MaterialEventLogListViewItem_Info_TypeInfo);
...
LABEL_33:
  ...
  *(_QWORD *)(v11 + 68) = *(_QWORD *)&this->fields.flag;
  ...
  if ( on_click_act )
  {
    ...
    {
      v19 = v18;
      v20 = sub_1B649AC(v18, System_Action_MaterialEventLogListViewItem__TypeInfo);
      if ( v20 )
        goto LABEL_17;
      sub_1B64D8C(v19);
    }
  ...
  *(_QWORD *)(v11 + 88) = this->fields.itm;
  ...
  while ( 1 )
  {
    ...
    if ( !v28 || (System_String_c *)v28->klass == string_TypeInfo )
      break;
LABEL_34:
    v30 = (__int64 *)sub_1B64D8C(v14);
    v31 = (const MethodInfo_32282BC **)v2;
    v2 = v30;
    if ( v32 != 1 )
    {
