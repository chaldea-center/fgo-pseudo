...
void __fastcall MaterialEventLogListViewItem___ctor_32093912(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAFC31 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_VoiceMaterialCondMaster___, *(_QWORD *)&limitCount);
    sub_1C13D24(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v5);
    this = (MaterialEventLogListViewItem_o *)sub_1C13D24(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4BAFC31 = 1;
  }
  ...
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47526452(voiceId, 0LL);
  if ( System_String__IsNullOrEmpty(v9, 0LL) )
    return 1;
  this = (MaterialEventLogListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_14;
  this = (MaterialEventLogListViewItem_o *)DataManager__GetMasterData_object_(
                                             (DataManager_o *)this,
                                             (const MethodInfo_2F8F46C *)Method_DataManager_GetMasterData_VoiceMaterialCondMaster___);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
  this = (MaterialEventLogListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47526452(
                                             v15,
                                             0LL);
  if ( !v12 )
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8(&this->fields._info_k__BackingField);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8(&this->fields.playableLimitCountlist);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v28; // x0
  __int64 *v30; // x0
  const MethodInfo_33BAB18 **v31; // x23
  int v32; // w1
  __int64 v33; // x22
  ...
  if ( (byte_4BAFC34 & 1) == 0 )
  {
    sub_1C13D24(&System_Action_MaterialEventLogListViewItem__TypeInfo, method);
  ...
  v11 = sub_1C13F70(MaterialEventLogListViewItem_Info_TypeInfo);
...
LABEL_33:
  ...
  *(_QWORD *)(v11 + 68) = *(_QWORD *)&this->fields.flag;
  ...
  if ( on_click_act )
  {
    ...
    {
      v19 = v18;
      v20 = sub_1C13E60(v18, System_Action_MaterialEventLogListViewItem__TypeInfo);
      if ( v20 )
        goto LABEL_17;
      sub_1C14240(v19);
    }
  ...
  *(_QWORD *)(v11 + 88) = this->fields.itm;
  ...
  while ( 1 )
  {
    ...
    if ( !v28 || (System_String_c *)v28->klass == string_TypeInfo )
      break;
LABEL_34:
    v30 = (__int64 *)sub_1C14240(v14);
    v31 = (const MethodInfo_33BAB18 **)v2;
    v2 = v30;
    if ( v32 != 1 )
    {
