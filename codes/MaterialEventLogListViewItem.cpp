...
void __fastcall MaterialEventLogListViewItem___ctor_31204336(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A568C3 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataManager_GetMasterData_VoiceMaterialCondMaster___);
    sub_1B885B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
    this = (MaterialEventLogListViewItem_o *)sub_1B885B0(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4A568C3 = 1;
  }
  ...
  v7 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46485644(voiceId, 0LL);
  if ( System_String__IsNullOrEmpty(v7, 0LL) )
    return 1;
  this = (MaterialEventLogListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3739718 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_14;
  this = (MaterialEventLogListViewItem_o *)DataManager__GetMasterData_object_(
                                             (DataManager_o *)this,
                                             (const MethodInfo_2E7F908 *)Method_DataManager_GetMasterData_VoiceMaterialCondMaster___);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
  this = (MaterialEventLogListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46485644(
                                             v13,
                                             0LL);
  if ( !v10 )
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554(&this->fields._info_k__BackingField, value);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554(&this->fields.playableLimitCountlist, v3);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v24; // x0
  __int64 *v26; // x0
  const MethodInfo_3274234 **v27; // x23
  int v28; // w1
  __int64 v29; // x22
  ...
  if ( (byte_4A568C6 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_MaterialEventLogListViewItem__TypeInfo);
  ...
  v4 = sub_1B887FC(MaterialEventLogListViewItem_Info_TypeInfo);
...
LABEL_33:
  ...
  *(_QWORD *)(v4 + 68) = *(_QWORD *)&this->fields.flag;
  ...
  if ( on_click_act )
  {
    ...
    {
      v12 = v11;
      v13 = sub_1B886EC(v11, System_Action_MaterialEventLogListViewItem__TypeInfo);
      if ( v13 )
        goto LABEL_17;
      sub_1B88ACC(v12);
    }
...
LABEL_17:
  *(_QWORD *)(v4 + 80) = v13;
  sub_1B88554(v4 + 80, v13);
  voiceId = this->fields.voiceId;
  *(_QWORD *)(v4 + 96) = voiceId;
  sub_1B88554(v4 + 96, voiceId);
  ...
  *(_QWORD *)(v4 + 144) = commonString;
  sub_1B88554(v4 + 144, commonString);
  itm = this->fields.itm;
  *(_QWORD *)(v4 + 88) = itm;
  sub_1B88554(v4 + 88, itm);
  ...
  while ( 1 )
  {
    ...
    if ( !v24 || (System_String_c *)v24->klass == string_TypeInfo )
      break;
LABEL_34:
    v26 = (__int64 *)sub_1B88ACC(v7);
    v27 = (const MethodInfo_3274234 **)v2;
    v2 = v26;
    if ( v28 != 1 )
    {
