...
void __fastcall MaterialEventLogListViewItem___ctor_32459280(
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)v7, (int32_t)info, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3FD85 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_VoiceMaterialCondMaster___, *(_QWORD *)&limitCount);
    sub_1BDB878(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v5);
    this = (MaterialEventLogListViewItem_o *)sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4B3FD85 = 1;
  }
  ...
  v9 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_48263560(voiceId, 0LL);
  if ( System_String__IsNullOrEmpty(v9, 0LL) )
    return 1;
  this = (MaterialEventLogListViewItem_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_14;
  this = (MaterialEventLogListViewItem_o *)DataManager__GetMasterData_object_(
                                             (DataManager_o *)this,
                                             (const MethodInfo_303395C *)Method_DataManager_GetMasterData_VoiceMaterialCondMaster___);
  ...
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
  this = (MaterialEventLogListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_48263560(
                                             v15,
                                             0LL);
  if ( !v12 )
LABEL_14:
        ...
        const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.isTermination = 0;
  ...
  if ( (v8 & 1) != 0 )
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)p_sortStr1, v10, v6, v7);
    p_sortStr1[1] = 0LL;
    p_sortStr1[2] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._info_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.playableLimitCountlist, (int32_t)v4, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v45; // x0
  __int64 *v47; // x0
  const MethodInfo_34661D4 **v48; // x23
  int v49; // w1
  __int64 v50; // x22
  ...
  if ( (byte_4B3FD88 & 1) == 0 )
  {
    sub_1BDB878(&System_Action_MaterialEventLogListViewItem__TypeInfo, method);
    sub_1BDB878(&Method_System_Collections_Generic_List_Enumerator_int__Dispose__, v4);
    sub_1BDB878(&Method_System_Collections_Generic_List_Enumerator_int__MoveNext__, v5);
    sub_1BDB878(&Method_System_Collections_Generic_List_Enumerator_int__get_Current__, v6);
  ...
  v11 = sub_1BDBAC4(MaterialEventLogListViewItem_Info_TypeInfo);
  ...
  if ( !v11 )
LABEL_33:
    sub_1BDBAD4(IsNullOrEmpty, v16);
  *(_QWORD *)(v11 + 16) = v16;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 16), (int32_t)v16, v14, v15);
  ...
  *(_QWORD *)(v11 + 24) = v16;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 24), (int32_t)v16, v18, v19);
  ...
  *(_QWORD *)(v11 + 68) = *(_QWORD *)&this->fields.flag;
  ...
  if ( on_click_act )
  {
    ...
    {
      v25 = v24;
      v26 = sub_1BDB9B4(v24, System_Action_MaterialEventLogListViewItem__TypeInfo);
      if ( v26 )
        goto LABEL_17;
      sub_1BDBD94(v25);
    }
...
LABEL_17:
  *(_QWORD *)(v11 + 80) = v26;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 80), v26, v21, v22);
  voiceId = this->fields.voiceId;
  *(_QWORD *)(v11 + 96) = voiceId;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 96), (int32_t)voiceId, v28, v29);
  ...
  *(_QWORD *)(v11 + 144) = commonString;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 144), (int32_t)commonString, v31, v32);
  itm = this->fields.itm;
  *(_QWORD *)(v11 + 88) = itm;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 88), (int32_t)itm, v34, v35);
  ...
  *(_BYTE *)(v11 + 209) = this->fields.isGallery;
  ...
  while ( 1 )
  {
    ...
    if ( !v45 || (System_String_c *)v45->klass == string_TypeInfo )
      break;
LABEL_34:
    v47 = (__int64 *)sub_1BDBD94(v16);
    v48 = (const MethodInfo_34661D4 **)v2;
    v2 = v47;
    if ( v49 != 1 )
    {
  ...
  *(_QWORD *)(v11 + 128) = v16;
  sub_1BDB81C((CGThumbnailListItem_o *)(v11 + 128), (int32_t)v16, v43, v44);
