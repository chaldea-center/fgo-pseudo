void __fastcall FriendshipUpItemUseItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FA959 & 1) == 0 )
  {
    sub_1B64A00(&FriendshipUpItemUseItem_TypeInfo, v1);
    sub_1B64A00(&StringLiteral_17432/*"btn_boostitem_off"*/, v4);
    sub_1B64A00(&StringLiteral_17433/*"btn_boostitem_on"*/, v5);
    byte_49FA959 = 1;
  }
  static_fields = FriendshipUpItemUseItem_TypeInfo->static_fields;
  static_fields->FRIENDSHIP_UP_ITEM_MAX_NUM = 9999;
  v7 = StringLiteral_17433/*"btn_boostitem_on"*/;
  static_fields->BUTTON_ON_FILE_NAME = (struct System_String_o *)StringLiteral_17433/*"btn_boostitem_on"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->BUTTON_ON_FILE_NAME, v7, v2, v3);
  v8 = StringLiteral_17432/*"btn_boostitem_off"*/;
  v9 = FriendshipUpItemUseItem_TypeInfo->static_fields;
  v9->BUTTON_OFF_FILE_NAME = (struct System_String_o *)StringLiteral_17432/*"btn_boostitem_off"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&v9->BUTTON_OFF_FILE_NAME, v8, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA956 & 1) == 0 )
  {
    sub_1B64A00(&FriendshipUpItemUseItem_TypeInfo, isOn);
    byte_49FA956 = 1;
  }
...
void __fastcall FriendshipUpItemUseItem__OnDestroy(FriendshipUpItemUseItem_o *this, const MethodInfo *method)
{
  if ( (byte_49FA954 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_12646/*"SetLabelUpdate"*/, method);
    byte_49FA954 = 1;
  }
  if ( UnityEngine_MonoBehaviour__IsInvoking_69122192(
         (UnityEngine_MonoBehaviour_o *)this,
         (System_String_o *)StringLiteral_12646/*"SetLabelUpdate"*/,
         0LL) )
  {
...
void __fastcall FriendshipUpItemUseItem__SetInit(FriendshipUpItemUseItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA953 & 1) == 0 )
  {
    sub_1B64A00(&FriendshipUpItemUseItem_TypeInfo, method);
    ...
    sub_1B64A00(&PartyOrganizationUtility_TypeInfo, v7);
    sub_1B64A00(&Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__, v8);
    sub_1B64A00(&StringLiteral_13286/*"TIME_REST_USER_ITEM"*/, v9);
    sub_1B64A00(&StringLiteral_10221/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_HAVE"*/, v10);
    sub_1B64A00(&StringLiteral_10219/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_AUTO_USE"*/, v11);
    sub_1B64A00(&StringLiteral_10223/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_NUM"*/, v12);
    sub_1B64A00(&StringLiteral_12646/*"SetLabelUpdate"*/, v13);
    byte_49FA953 = 1;
  }
  friendshipUpItemUseFixAutoUseLabel = this->fields.friendshipUpItemUseFixAutoUseLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_10219/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_AUTO_USE"*/, 0LL);
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_10221/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_HAVE"*/, 0LL);
  ...
  v22 = System_Math__Min_62204104(v20, FRIENDSHIP_UP_ITEM_MAX_NUM, 0LL);
  friendshipUpItemUseNumLabel = this->fields.friendshipUpItemUseNumLabel;
  v24 = v22;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_10223/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_NUM"*/, 0LL);
  v44 = v24;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_13286/*"TIME_REST_USER_ITEM"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA958 & 1) == 0 )
  {
    sub_1B64A00(&LocalizationManager_TypeInfo, isUse);
    sub_1B64A00(&StringLiteral_10224/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_UNUSED"*/, v7);
    sub_1B64A00(&StringLiteral_10222/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_IN_USE"*/, v8);
    byte_49FA958 = 1;
  }
  ...
  if ( isValid )
  {
    ...
    if ( !isUse )
    {
      ...
      friendshipUpItemUseSprite = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_10224/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_UNUSED"*/,
                                                               0LL);
      if ( friendshipUpItemUseFixAutoUseLabel )
      {
...
LABEL_25:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  friendshipUpItemUseSprite = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_10222/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_IN_USE"*/,
                                                           0LL);
  if ( !v17 )
    goto LABEL_39;
...
LABEL_39:
    sub_1B64C5C(friendshipUpItemUseSprite, isUse);
  }
  friendshipUpItemUseSprite = (UnityEngine_Component_o *)this->fields.friendshipUpItemIconSprite;
  if ( !friendshipUpItemUseSprite )
    goto LABEL_39;
