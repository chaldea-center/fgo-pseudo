void __fastcall FriendshipUpItemUseItem___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B32D78 & 1) == 0 )
  {
    sub_1BD3458(&FriendshipUpItemUseItem_TypeInfo, v1);
    sub_1BD3458(&StringLiteral_17698/*"btn_boostitem_off"*/, v2);
    sub_1BD3458(&StringLiteral_17699/*"btn_boostitem_on"*/, v3);
    byte_4B32D78 = 1;
  }
  static_fields = FriendshipUpItemUseItem_TypeInfo->static_fields;
  static_fields->FRIENDSHIP_UP_ITEM_MAX_NUM = 9999;
  static_fields->BUTTON_ON_FILE_NAME = (struct System_String_o *)StringLiteral_17699/*"btn_boostitem_on"*/;
  sub_1BD33FC(&static_fields->BUTTON_ON_FILE_NAME);
  v5 = FriendshipUpItemUseItem_TypeInfo->static_fields;
  v5->BUTTON_OFF_FILE_NAME = (struct System_String_o *)StringLiteral_17698/*"btn_boostitem_off"*/;
  sub_1BD33FC(&v5->BUTTON_OFF_FILE_NAME);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B32D75 & 1) == 0 )
  {
    sub_1BD3458(&FriendshipUpItemUseItem_TypeInfo, isOn);
    byte_4B32D75 = 1;
  }
...
void __fastcall FriendshipUpItemUseItem__OnDestroy(FriendshipUpItemUseItem_o *this, const MethodInfo *method)
{
  if ( (byte_4B32D73 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_12880/*"SetLabelUpdate"*/, method);
    byte_4B32D73 = 1;
  }
  if ( UnityEngine_MonoBehaviour__IsInvoking_70262988(
         (UnityEngine_MonoBehaviour_o *)this,
         (System_String_o *)StringLiteral_12880/*"SetLabelUpdate"*/,
         0LL) )
  {
...
void __fastcall FriendshipUpItemUseItem__SetInit(FriendshipUpItemUseItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B32D72 & 1) == 0 )
  {
    sub_1BD3458(&FriendshipUpItemUseItem_TypeInfo, method);
    ...
    sub_1BD3458(&PartyOrganizationUtility_TypeInfo, v7);
    sub_1BD3458(&Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__, v8);
    sub_1BD3458(&StringLiteral_13532/*"TIME_REST_USER_ITEM"*/, v9);
    sub_1BD3458(&StringLiteral_10416/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_HAVE"*/, v10);
    sub_1BD3458(&StringLiteral_10414/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_AUTO_USE"*/, v11);
    sub_1BD3458(&StringLiteral_10418/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_NUM"*/, v12);
    sub_1BD3458(&StringLiteral_12880/*"SetLabelUpdate"*/, v13);
    byte_4B32D72 = 1;
  }
  friendshipUpItemUseFixAutoUseLabel = this->fields.friendshipUpItemUseFixAutoUseLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_10414/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_AUTO_USE"*/, 0LL);
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_10416/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_HAVE"*/, 0LL);
  ...
  v22 = System_Math__Min_63344552(v20, FRIENDSHIP_UP_ITEM_MAX_NUM, 0LL);
  friendshipUpItemUseNumLabel = this->fields.friendshipUpItemUseNumLabel;
  v24 = v22;
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_10418/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_NUM"*/, 0LL);
  v44 = v24;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_13532/*"TIME_REST_USER_ITEM"*/, 0LL);
...
void __fastcall FriendshipUpItemUseItem__SetLabelUpdate(FriendshipUpItemUseItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B32D74 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__, v4);
    byte_4B32D74 = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_37FE068 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
  if ( !Instance )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B32D77 & 1) == 0 )
  {
    sub_1BD3458(&LocalizationManager_TypeInfo, isUse);
    sub_1BD3458(&StringLiteral_10419/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_UNUSED"*/, v7);
    sub_1BD3458(&StringLiteral_10417/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_IN_USE"*/, v8);
    byte_4B32D77 = 1;
  }
  ...
  if ( isValid )
  {
    ...
    if ( !isUse )
    {
      ...
      friendshipUpItemUseSprite = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_10419/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_UNUSED"*/,
                                                               0LL);
      if ( friendshipUpItemUseFixAutoUseLabel )
      {
...
LABEL_25:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  friendshipUpItemUseSprite = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_10417/*"PARTY_ORGANIZATION_FRIENDSHIP_UP_ITEM_IN_USE"*/,
                                                           0LL);
  if ( !v17 )
    goto LABEL_39;
...
LABEL_39:
    sub_1BD36B4(friendshipUpItemUseSprite, isUse);
  }
  friendshipUpItemUseSprite = (UnityEngine_Component_o *)this->fields.friendshipUpItemIconSprite;
  if ( !friendshipUpItemUseSprite )
    goto LABEL_39;
