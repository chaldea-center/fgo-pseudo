void UserServantLeaderMaster___ctor(UserServantLeaderMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4D31A2F & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataMasterBase_UserServantLeaderMaster__UserServantLeaderEntity__string___ctor__);
    byte_4D31A2F = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    150,
    (const MethodInfo_3465C5C *)Method_DataMasterBase_UserServantLeaderMaster__UserServantLeaderEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31A2D & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataMasterBase_UserServantLeaderMaster__UserServantLeaderEntity__string__GetEntity__);
    byte_4D31A2D = 1;
  }
  ...
  return (UserServantLeaderEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                        (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                        PK,
                                        (const MethodInfo_34681D4 *)Method_DataMasterBase_UserServantLeaderMaster__UserServantLeaderEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31A2E & 1) == 0 )
  {
    sub_1C93AD4(&Method_DataMasterBase_UserServantLeaderMaster__UserServantLeaderEntity__string__TryGetEntity__);
    byte_4D31A2E = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_3468220 *)Method_DataMasterBase_UserServantLeaderMaster__UserServantLeaderEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    if ( (__int64)v13 >= v15->static_fields->SupportDeckMemberMax )
      break;
    v16 = (UserServantLeaderEntity_o *)sub_1C93D20(UserServantLeaderEntity_TypeInfo);
    UserServantLeaderEntity___ctor_43914324(v16, v13, supportDeckId, v17);
    if ( !v11 )
      goto LABEL_50;
    if ( v16 )
    {
      Instance = sub_1C93C10(v16, *(_QWORD *)(*(_QWORD *)v11 + 64LL));
      if ( !Instance )
      {
        v36 = sub_1C93D50(0);
        sub_1C93BFC(v36, 0);
...
LABEL_51:
    ...
    *(_QWORD *)&v14[2 * v13] = v16;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&v14[v12], (int32_t)v16, v18, v19, v20, v21, v22, v23);
    ++v13;
    v12 += 2;
  }
  if ( v10 >= 1 )
      ...
      if ( *(_DWORD *)(Instance + 48) == supportDeckId )
      {
        ...
        if ( v29 )
        {
          ...
          *(_OWORD *)&v39.fields.fakeValue = v30;
          ...
          v38 = v39;
          Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49657552(&v38, 0);
          if ( Instance )
          {
            ...
            *(_OWORD *)&v39.fields.fakeValue = v32;
            if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
            v37 = v39;
            Instance = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_49657552(&v37, 0);
            if ( !v33 )
              break;
            if ( !*(_DWORD *)(v33 + 24) )
              goto LABEL_51;
