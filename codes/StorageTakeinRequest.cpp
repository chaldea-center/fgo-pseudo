        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FFB1 & 1) == 0 )
  {
    sub_1B863B8(&System_Convert_TypeInfo, userSvtIds);
    sub_1B863B8(&MiniMessagePack_MiniMessagePacker_TypeInfo, v5);
    sub_1B863B8(&StringLiteral_24293/*"userSvtIds"*/, v6);
    byte_4A4FFB1 = 1;
  }
  ...
  RequestBase__addField_42282000((RequestBase_o *)this, (System_String_o *)StringLiteral_24293/*"userSvtIds"*/, v11, v12);
...
System_String_o *__fastcall StorageTakeinRequest__getURL(StorageTakeinRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4FFB0 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_23396/*"storage/takein"*/, v2);
    byte_4A4FFB0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_23396/*"storage/takein"*/, 0LL);
}
