...
LABEL_14:
  ...
  if ( !Instance )
    goto LABEL_14;
  v27 = ServantEntity__GetName((ServantEntity_o *)Instance, -1, 0, -1, 0, 0LL);
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
  Name = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47657208(v27, 0LL);
LABEL_13:
  this->fields.name = Name;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.name, (int64_t)Name, v21, v22, v23, v24, v25, v26);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.name, (int64_t)value, (int64_t)method, v3, v4, v5, v6, v7);
}