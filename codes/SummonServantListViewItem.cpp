...
LABEL_14:
  ...
  if ( !Instance )
    goto LABEL_14;
  v23 = ServantEntity__GetName((ServantEntity_o *)Instance, -1, 0, -1, 0, 0);
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
  Name = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49039980(v23, 0);
LABEL_13:
  this->fields.name = Name;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.name, (int32_t)Name, v21, v22);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.name, (int32_t)value, (int32_t)method, v3);
}