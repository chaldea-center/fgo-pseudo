        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF1EF & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataMasterBase_CommandCodeMaster__CommandCodeEntity__int__GetEntity__, v20);
    sub_1B00CCC(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo, v21);
...
LABEL_14:
  ...
  Name = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_45348888(v28, 0LL);
LABEL_13:
  this->fields.name = Name;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.name, (int32_t)Name, v26, v27);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.name, (int32_t)value, (int32_t)method, v3);
}