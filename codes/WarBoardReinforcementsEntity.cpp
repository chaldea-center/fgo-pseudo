        ...
        const MethodInfo *method)
{
  ...
  v6 = (System_String_o *)StringLiteral_23370/*"noMovedAfterDefend"*/;
  *type = 0;
        ...
        const MethodInfo *method)
{
  ...
  IntValue = EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_19344/*"deadEffect"*/, -1, 0);
  *value = IntValue;
  return IntValue != -1;
}
        ...
        const MethodInfo *method)
{
  ...
  script = this->fields.script;
  v6 = (System_String_o *)StringLiteral_23367/*"noMoveAfterAttack"*/;
  *type = 0;
  IntValue = EntityScriptUtil__GetIntValue(script, v6, -1, 0);
  if ( (IntValue & 0x80000000) == 0 )
    *type = IntValue;
        ...
        const MethodInfo *method)
{
  ...
  IntValue = EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23670/*"overwriteAttackCost"*/, -1, 0);
  *value = IntValue;
  return IntValue != -1;
}
        ...
        const MethodInfo *method)
{
  ...
  IntValue = EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23672/*"overwriteBaseActionPoint"*/, -1, 0);
  *value = IntValue;
  return IntValue != -1;
}
        ...
        const MethodInfo *method)
{
  ...
  IntValue = EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23712/*"overwriteMoveCost"*/, -1, 0);
  *value = IntValue;
  return IntValue != -1;
}
        ...
        const MethodInfo *method)
{
  ...
  IntValue = EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_23747/*"overwriteWallAttackCost"*/, -1, 0);
  *value = IntValue;
  return IntValue != -1;
}
        ...
        const MethodInfo *method)
{
  ...
  IntValue = EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_26118/*"warBoardSvtDetail"*/, -1, 0);
  *value = IntValue;
  return IntValue >= 0;
}