...
void __fastcall ClassBoardCondData___ctor_46048516(ClassBoardCondData_o this, int32_t lockId, const MethodInfo *method)
{
  int32_t Num; // w20
  _DWORD *v4; // x19
  __int64 v5; // x1
  ...
  if ( (byte_4C00E65 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMaster_ClassBoardLockMaster___, *(_QWORD *)&this.fields.Num);
...
bool __fastcall ClassBoardCondData__IsOpen(ClassBoardCondData_o this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00E66 & 1) == 0 )
  {
    sub_1C2E12C(&CondType_TypeInfo, *(_QWORD *)&this.fields.Num);
    byte_4C00E66 = 1;
  }
  v4 = *v2;
  v3 = v2[1];
