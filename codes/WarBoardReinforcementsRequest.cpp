        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5001B & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_23328/*"stageId"*/, warBoardData);
    sub_1B863B8(&StringLiteral_23329/*"stageReinforcementId"*/, v11);
    sub_1B863B8(&StringLiteral_22692/*"reinforcementsIdx"*/, v12);
    this = (WarBoardReinforcementsRequest_o *)sub_1B863B8(&StringLiteral_23302/*"squareIds"*/, v13);
    byte_4A5001B = 1;
  }
  if ( !warBoardData )
    sub_1B86614(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23328/*"stageId"*/, id, v15);
  WarBoardData__SetRequest(warBoardData, v10, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23329/*"stageReinforcementId"*/, stageReinforcementId, v16);
  RequestBase__addField_42288224(v10, (System_String_o *)StringLiteral_22692/*"reinforcementsIdx"*/, &reinforcementsIds->obj, v17);
  RequestBase__addField_42288224(v10, (System_String_o *)StringLiteral_23302/*"squareIds"*/, &squareIds->obj, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5001A & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_24456/*"warBoard/reinforcements"*/, v2);
    byte_4A5001A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_24456/*"warBoard/reinforcements"*/, 0LL);
}
