        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF223 & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_23927/*"stageId"*/, warBoardData);
    sub_1C2E12C(&StringLiteral_23928/*"stageReinforcementId"*/, v11);
    sub_1C2E12C(&StringLiteral_23278/*"reinforcementsIdx"*/, v12);
    this = (WarBoardReinforcementsRequest_o *)sub_1C2E12C(&StringLiteral_23901/*"squareIds"*/, v13);
    byte_4BFF223 = 1;
  }
  if ( !warBoardData )
    sub_1C2E388(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23927/*"stageId"*/, id, 0LL);
  WarBoardData__SetRequest(warBoardData, v10, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23928/*"stageReinforcementId"*/, stageReinforcementId, 0LL);
  RequestBase__addField_42512364(v10, (System_String_o *)StringLiteral_23278/*"reinforcementsIdx"*/, &reinforcementsIds->obj, 0LL);
  RequestBase__addField_42512364(v10, (System_String_o *)StringLiteral_23901/*"squareIds"*/, &squareIds->obj, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF222 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_25084/*"warBoard/reinforcements"*/, v2);
    byte_4BFF222 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_25084/*"warBoard/reinforcements"*/, 0LL);
}
