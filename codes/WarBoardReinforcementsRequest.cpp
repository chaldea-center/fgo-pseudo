        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FBA67 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_22171, warBoardData);
    sub_B16FFC(&StringLiteral_22172, v11);
    sub_B16FFC(&StringLiteral_21660, v12);
    sub_B16FFC(&StringLiteral_22145, v13);
    byte_40FBA67 = 1;
  }
  if ( !warBoardData )
    sub_B170D4();
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22171, id, 0LL);
  WarBoardData__SetRequest(warBoardData, (RequestBase_o *)this, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22172, stageReinforcementId, 0LL);
  RequestBase__addField_30957272(
    (RequestBase_o *)this,
    (System_String_o *)StringLiteral_21660,
    &reinforcementsIds->obj,
    0LL);
  RequestBase__addField_30957272((RequestBase_o *)this, (System_String_o *)StringLiteral_22145, &squareIds->obj, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FBA66 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_23113, v2);
    byte_40FBA66 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_23113, 0LL);
}
