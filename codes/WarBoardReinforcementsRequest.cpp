        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43539E0 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_22636/*"stageReinforcementId"*/);
    sub_B70694(&StringLiteral_22114/*"reinforcementsIdx"*/);
    this = (WarBoardReinforcementsRequest_o *)sub_B70694(&StringLiteral_22609/*"squareIds"*/);
    byte_43539E0 = 1;
  }
  if ( !warBoardData )
    sub_B7076C(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_22635/*"stageId"*/, id, 0LL);
  WarBoardData__SetRequest(warBoardData, v10, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_22636/*"stageReinforcementId"*/, stageReinforcementId, 0LL);
  RequestBase__addField_32336684(v10, (System_String_o *)StringLiteral_22114/*"reinforcementsIdx"*/, &reinforcementsIds->obj, 0LL);
  RequestBase__addField_32336684(v10, (System_String_o *)StringLiteral_22609/*"squareIds"*/, &squareIds->obj, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43539DF & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_23588/*"warBoard/reinforcements"*/);
    byte_43539DF = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_23588/*"warBoard/reinforcements"*/, 0LL);
}
