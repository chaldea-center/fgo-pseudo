        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28F1C & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_23627/*"stageReinforcementId"*/);
    sub_1C2D490(&StringLiteral_22996/*"reinforcementsIdx"*/);
    this = (WarBoardReinforcementsRequest_o *)sub_1C2D490(&StringLiteral_23601/*"squareIds"*/);
    byte_4C28F1C = 1;
  }
  if ( !warBoardData )
    sub_1C2D6EC(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23626/*"stageId"*/, id, v12);
  WarBoardData__SetRequest(warBoardData, v10, 0);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23627/*"stageReinforcementId"*/, stageReinforcementId, v13);
  RequestBase__addField_44009168(v10, (System_String_o *)StringLiteral_22996/*"reinforcementsIdx"*/, &reinforcementsIds->obj, v14);
  RequestBase__addField_44009168(v10, (System_String_o *)StringLiteral_23601/*"squareIds"*/, &squareIds->obj, v15);
...
System_String_o *WarBoardReinforcementsRequest__getURL(WarBoardReinforcementsRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28F1B & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_24714/*"warBoard/reinforcements"*/);
    byte_4C28F1B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_24714/*"warBoard/reinforcements"*/, 0);
}
