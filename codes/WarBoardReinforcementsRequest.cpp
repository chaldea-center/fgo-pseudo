        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDAE & 1) == 0 )
  {
    sub_1B640C8(&StringLiteral_23380/*"stageId"*/, warBoardData);
    sub_1B640C8(&StringLiteral_23381/*"stageReinforcementId"*/, v11);
    sub_1B640C8(&StringLiteral_22749/*"reinforcementsIdx"*/, v12);
    this = (WarBoardReinforcementsRequest_o *)sub_1B640C8(&StringLiteral_23353/*"squareIds"*/, v13);
    byte_49FDDAE = 1;
  }
  if ( !warBoardData )
    sub_1B64324(this);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23380/*"stageId"*/, id, v15);
  WarBoardData__SetRequest(warBoardData, v10, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23381/*"stageReinforcementId"*/, stageReinforcementId, v16);
  RequestBase__addField_40848776(v10, (System_String_o *)StringLiteral_22749/*"reinforcementsIdx"*/, &reinforcementsIds->obj, v17);
  RequestBase__addField_40848776(v10, (System_String_o *)StringLiteral_23353/*"squareIds"*/, &squareIds->obj, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDDAD & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_24519/*"warBoard/reinforcements"*/, v2);
    byte_49FDDAD = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_24519/*"warBoard/reinforcements"*/, 0LL);
}
