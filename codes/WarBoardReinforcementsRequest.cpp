        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17BFB & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_23725/*"stageId"*/, warBoardData, *(_QWORD *)&stageReinforcementId);
    sub_1BCA7E0(&StringLiteral_23726/*"stageReinforcementId"*/, v11, v12);
    sub_1BCA7E0(&StringLiteral_23088/*"reinforcementsIdx"*/, v13, v14);
    this = (WarBoardReinforcementsRequest_o *)sub_1BCA7E0(&StringLiteral_23699/*"squareIds"*/, v15, v16);
    byte_4B17BFB = 1;
  }
  if ( !warBoardData )
    sub_1BCAA3C(this, warBoardData);
  id = WarBoardData__get_id(warBoardData, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23725/*"stageId"*/, id, 0LL);
  WarBoardData__SetRequest(warBoardData, v10, 0LL);
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23726/*"stageReinforcementId"*/, stageReinforcementId, 0LL);
  RequestBase__addField_41870840(v10, (System_String_o *)StringLiteral_23088/*"reinforcementsIdx"*/, &reinforcementsIds->obj, 0LL);
  RequestBase__addField_41870840(v10, (System_String_o *)StringLiteral_23699/*"squareIds"*/, &squareIds->obj, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17BFA & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_24872/*"warBoard/reinforcements"*/, v3, v4);
    byte_4B17BFA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_24872/*"warBoard/reinforcements"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v15 = ResponseCommandKind__SearchData(103, responseList, 0LL);
  if ( v15
