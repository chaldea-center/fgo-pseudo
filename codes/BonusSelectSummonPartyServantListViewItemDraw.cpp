        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B631CB & 1) == 0 )
  {
    sub_1BE4ACC(&string_TypeInfo, lineupEntity);
    sub_1BE4ACC(&StringLiteral_23900/*"story"*/, v4);
    sub_1BE4ACC(&StringLiteral_20727/*"img_ribbon_{0}"*/, v5);
    sub_1BE4ACC(&StringLiteral_18451/*"constant"*/, v6);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1BE4ACC(&StringLiteral_21404/*"limited"*/, v7);
    byte_4B631CB = 1;
  }
  if ( !lineupEntity )
    sub_1BE4D28(this, lineupEntity);
  SummonCategoryId = GachaBonusSelectLineupEntity__GetSummonCategoryId(lineupEntity, -1, 0LL);
  switch ( SummonCategoryId )
  {
    case 2:
      v9 = &StringLiteral_23900/*"story"*/;
      return System_String__Format((System_String_o *)StringLiteral_20727/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
    case 1:
      v9 = &StringLiteral_21404/*"limited"*/;
      return System_String__Format((System_String_o *)StringLiteral_20727/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
    case 0:
      v9 = &StringLiteral_18451/*"constant"*/;
      return System_String__Format((System_String_o *)StringLiteral_20727/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B631C9 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_20614/*"img_icon_summoned"*/, v12);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1BE4ACC(&StringLiteral_20613/*"img_icon_not_summoned"*/, v13);
    byte_4B631C9 = 1;
  }
  entity = 0LL;
  if ( !v5 || !mode )
  ...
  *(_QWORD *)&v33.fields.fakeValue = v16;
  this = (BonusSelectSummonPartyServantListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
                                                              v33,
                                                              0LL);
  if ( !servantFaceIcon )
    goto LABEL_41;
  ...
  if ( !v23 )
    goto LABEL_41;
  v24 = *(_QWORD *)&this[1].fields.summonInfoSprite->fields.updateAnchors;
  this = (BonusSelectSummonPartyServantListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(
                                                              v23[1],
                                                              0LL);
  if ( !Master_object )
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    {
      v26 = &StringLiteral_20614/*"img_icon_summoned"*/;
      goto LABEL_29;
    }
  }
  else
  ...
  v26 = &StringLiteral_20613/*"img_icon_not_summoned"*/;
LABEL_29:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B631CA & 1) == 0 )
  {
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1BE4ACC(&StringLiteral_12518/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/, v6);
    byte_4B631CA = 1;
  }
  if ( !v3 )
    goto LABEL_19;
...
LABEL_13:
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_12518/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/,
                                                                0LL);
