        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA99B & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_23952/*"story"*/);
    sub_1C7BAE8(&StringLiteral_20717/*"img_ribbon_{0}"*/);
    sub_1C7BAE8(&StringLiteral_18323/*"constant"*/);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_21436/*"limited"*/);
    byte_4CEA99B = 1;
  }
  if ( !lineupEntity )
    sub_1C7BD40(this, lineupEntity);
  SummonCategoryId = GachaBonusSelectLineupEntity__GetSummonCategoryId(lineupEntity, -1, 0);
  switch ( SummonCategoryId )
  {
    case 2:
      v5 = &StringLiteral_23952/*"story"*/;
      return System_String__Format((System_String_o *)StringLiteral_20717/*"img_ribbon_{0}"*/, (Il2CppObject *)*v5, 0);
    case 1:
      v5 = &StringLiteral_21436/*"limited"*/;
      return System_String__Format((System_String_o *)StringLiteral_20717/*"img_ribbon_{0}"*/, (Il2CppObject *)*v5, 0);
    case 0:
      v5 = &StringLiteral_18323/*"constant"*/;
      return System_String__Format((System_String_o *)StringLiteral_20717/*"img_ribbon_{0}"*/, (Il2CppObject *)*v5, 0);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA999 & 1) == 0 )
  {
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_20584/*"img_icon_not_summoned"*/);
    byte_4CEA999 = 1;
  }
  entity = 0;
  if ( !v5 || !mode )
  ...
  *(_QWORD *)&v26.fields.fakeValue = v9;
  this = (BonusSelectSummonPartyServantListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49449776(
                                                              v26,
                                                              0);
  if ( !servantFaceIcon )
    goto LABEL_42;
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    {
      v19 = &StringLiteral_20585/*"img_icon_summoned"*/;
      goto LABEL_30;
    }
  }
  else
  ...
  v19 = &StringLiteral_20584/*"img_icon_not_summoned"*/;
LABEL_30:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEA99A & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&string_TypeInfo);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1C7BAE8(&StringLiteral_12483/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/);
    byte_4CEA99A = 1;
  }
  if ( !v3 )
    goto LABEL_19;
...
LABEL_13:
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_12483/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/,
                                                                0);
