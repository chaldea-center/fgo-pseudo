        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD02 & 1) == 0 )
  {
    sub_1B64870(&string_TypeInfo, lineupEntity);
    sub_1B64870(&StringLiteral_23472/*"story"*/, v4);
    sub_1B64870(&StringLiteral_20360/*"img_ribbon_{0}"*/, v5);
    sub_1B64870(&StringLiteral_18145/*"constant"*/, v6);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1B64870(&StringLiteral_21028/*"limited"*/, v7);
    byte_49FAD02 = 1;
  }
  if ( !lineupEntity )
    sub_1B64ACC(this, lineupEntity);
  ...
  switch ( SummonCategoryId )
  {
    ...
    case 1:
      ...
      return System_String__Format((System_String_o *)StringLiteral_20360/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
    case 0:
      v9 = &StringLiteral_18145/*"constant"*/;
      return System_String__Format((System_String_o *)StringLiteral_20360/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD00 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_20248/*"img_icon_summoned"*/, v12);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1B64870(&StringLiteral_20247/*"img_icon_not_summoned"*/, v13);
    byte_49FAD00 = 1;
  }
  entity = 0LL;
  if ( !v5 || !mode )
  ...
  *(_QWORD *)&v33.fields.fakeValue = v16;
  this = (BonusSelectSummonPartyServantListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(
                                                              v33,
                                                              0LL);
  if ( !servantFaceIcon )
    goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD01 & 1) == 0 )
  {
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1B64870(&StringLiteral_12277/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/, v6);
    byte_49FAD01 = 1;
  }
  if ( !v3 )
    goto LABEL_19;
...
LABEL_13:
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_12277/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/,
                                                                0LL);
