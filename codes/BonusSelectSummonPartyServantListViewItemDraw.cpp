        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8B2A & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_23993/*"story"*/);
    sub_1C21E38(&StringLiteral_20806/*"img_ribbon_{0}"*/);
    sub_1C21E38(&StringLiteral_18523/*"constant"*/);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1C21E38(&StringLiteral_21485/*"limited"*/);
    byte_4BD8B2A = 1;
  }
  if ( !lineupEntity )
    sub_1C22094(this, lineupEntity);
  SummonCategoryId = GachaBonusSelectLineupEntity__GetSummonCategoryId(lineupEntity, -1, 0LL);
  switch ( SummonCategoryId )
  {
    case 2:
      v5 = &StringLiteral_23993/*"story"*/;
      return System_String__Format((System_String_o *)StringLiteral_20806/*"img_ribbon_{0}"*/, (Il2CppObject *)*v5, 0LL);
    case 1:
      v5 = &StringLiteral_21485/*"limited"*/;
      return System_String__Format((System_String_o *)StringLiteral_20806/*"img_ribbon_{0}"*/, (Il2CppObject *)*v5, 0LL);
    case 0:
      v5 = &StringLiteral_18523/*"constant"*/;
      return System_String__Format((System_String_o *)StringLiteral_20806/*"img_ribbon_{0}"*/, (Il2CppObject *)*v5, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8B28 & 1) == 0 )
  {
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1C21E38(&StringLiteral_20688/*"img_icon_not_summoned"*/);
    byte_4BD8B28 = 1;
  }
  entity = 0LL;
  if ( !v5 || !mode )
  ...
  *(_QWORD *)&v26.fields.fakeValue = v9;
  this = (BonusSelectSummonPartyServantListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(
                                                              v26,
                                                              0LL);
  if ( !servantFaceIcon )
    goto LABEL_41;
  ...
  if ( !v16 )
    goto LABEL_41;
  v17 = *(_QWORD *)&this[1].fields.summonInfoSprite->fields.updateAnchors;
  this = (BonusSelectSummonPartyServantListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(
                                                              v16[1],
                                                              0LL);
  if ( !Master_object )
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    {
      v19 = &StringLiteral_20689/*"img_icon_summoned"*/;
      goto LABEL_29;
    }
  }
  else
  ...
  v19 = &StringLiteral_20688/*"img_icon_not_summoned"*/;
LABEL_29:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8B29 & 1) == 0 )
  {
    ...
    sub_1C21E38(&string_TypeInfo);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1C21E38(&StringLiteral_12570/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/);
    byte_4BD8B29 = 1;
  }
  if ( !v3 )
    goto LABEL_19;
...
LABEL_13:
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_12570/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/,
                                                                0LL);
