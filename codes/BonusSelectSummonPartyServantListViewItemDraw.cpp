        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF080 & 1) == 0 )
  {
    sub_1B00CCC(&string_TypeInfo, lineupEntity);
    sub_1B00CCC(&StringLiteral_23218/*"story"*/, v4);
    sub_1B00CCC(&StringLiteral_20160/*"img_ribbon_{0}"*/, v5);
    sub_1B00CCC(&StringLiteral_17967/*"constant"*/, v6);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_20825/*"limited"*/, v7);
    byte_48DF080 = 1;
  }
  if ( !lineupEntity )
    sub_1B00F28(this, lineupEntity);
  SummonCategoryId = GachaBonusSelectLineupEntity__GetSummonCategoryId(lineupEntity, -1, 0LL);
  switch ( SummonCategoryId )
  {
    case 2:
      v9 = &StringLiteral_23218/*"story"*/;
      return System_String__Format((System_String_o *)StringLiteral_20160/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
    case 1:
      v9 = &StringLiteral_20825/*"limited"*/;
      return System_String__Format((System_String_o *)StringLiteral_20160/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
    case 0:
      v9 = &StringLiteral_17967/*"constant"*/;
      return System_String__Format((System_String_o *)StringLiteral_20160/*"img_ribbon_{0}"*/, (Il2CppObject *)*v9, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF07E & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_20050/*"img_icon_summoned"*/, v12);
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_20049/*"img_icon_not_summoned"*/, v13);
    byte_48DF07E = 1;
  }
  entity = 0LL;
  if ( !v5 || !mode )
  ...
  *(_QWORD *)&v33.fields.fakeValue = v16;
  this = (BonusSelectSummonPartyServantListViewItemDraw_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_45313044(
                                                              v33,
                                                              0LL);
  if ( !servantFaceIcon )
    goto LABEL_37;
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    {
      v26 = &StringLiteral_20050/*"img_icon_summoned"*/;
      goto LABEL_25;
    }
  }
  else
  ...
  v26 = &StringLiteral_20049/*"img_icon_not_summoned"*/;
LABEL_25:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF07F & 1) == 0 )
  {
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)sub_1B00CCC(&StringLiteral_12126/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/, v6);
    byte_48DF07F = 1;
  }
  if ( !v3 )
    goto LABEL_19;
...
LABEL_13:
    ...
    this = (BonusSelectSummonPartyServantListViewItemDraw_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_12126/*"SUMMON_BONUS_SELECT_MENU_MASK_MESSAGE"*/,
                                                                0LL);
