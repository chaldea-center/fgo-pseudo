        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields, (int32_t)entity, v7, v8);
  this->fields._standFigure_k__BackingField = standFigure;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._standFigure_k__BackingField, (int32_t)standFigure, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._standFigure_k__BackingField, (int32_t)value, (int32_t)method, v3);
}