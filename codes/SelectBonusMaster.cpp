void __fastcall SelectBonusMaster___ctor(SelectBonusMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A5B789 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataMasterBase_SelectBonusMaster__SelectBonusEntity__string___ctor__);
    byte_4A5B789 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    519,
    (const MethodInfo_311DC4C *)Method_DataMasterBase_SelectBonusMaster__SelectBonusEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B78A & 1) == 0 )
  {
    sub_1B885B0(&Method_DataMasterBase_SelectBonusMaster__SelectBonusEntity__string__GetEntity__);
    byte_4A5B78A = 1;
  }
  ...
  return (SelectBonusEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                  (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                  PK,
                                  (const MethodInfo_311DC8C *)Method_DataMasterBase_SelectBonusMaster__SelectBonusEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B788 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Linq_Enumerable_OfType_SelectBonusEntity___);
    sub_1B885B0(&Method_System_Linq_Enumerable_ToList_SelectBonusEntity___);
    sub_1B885B0(&Method_System_Linq_Enumerable_Where_SelectBonusEntity___);
    sub_1B885B0(&System_Func_SelectBonusEntity__bool__TypeInfo);
    sub_1B885B0(&Method_SelectBonusMaster___c__DisplayClass0_0__GetSelectBonusEntitiesByEventId_b__0__);
    sub_1B885B0(&SelectBonusMaster___c__DisplayClass0_0_TypeInfo);
    byte_4A5B788 = 1;
  }
  v5 = sub_1B887FC(SelectBonusMaster___c__DisplayClass0_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = eventId;
  v8 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_object_(
                                                              ...
                                                              (const MethodInfo_2EA998C *)Method_System_Linq_Enumerable_OfType_SelectBonusEntity___);
  ...
  v10 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_2EBE07C *)Method_System_Linq_Enumerable_Where_SelectBonusEntity___);
  return (System_Collections_Generic_List_SelectBonusEntity__o *)System_Linq_Enumerable__ToList_object_(
                                                                   v10,
                                                                   (const MethodInfo_2EBBFFC *)Method_System_Linq_Enumerable_ToList_SelectBonusEntity___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B78B & 1) == 0 )
  {
    sub_1B885B0(&Method_DataMasterBase_SelectBonusMaster__SelectBonusEntity__string__TryGetEntity__);
    byte_4A5B78B = 1;
  }
  PK = (Il2CppObject *)SelectBonusEntity__CreatePK(eventId, idx, 0LL);
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_311DCDC *)Method_DataMasterBase_SelectBonusMaster__SelectBonusEntity__string__TryGetEntity__);
}
