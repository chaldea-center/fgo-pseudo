        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC759B & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&BattleWaveInfoData_BattleItemInfo_SaveData___TypeInfo, v3);
    sub_1C1ABD4(&DropInfo_SaveData___TypeInfo, v4);
    sub_1C1ABD4(&BattleWaveInfoData_SaveData_TypeInfo, v5);
    byte_4BC759B = 1;
  }
  v6 = sub_1C1AE20(BattleWaveInfoData_SaveData_TypeInfo);
  ...
  *(_QWORD *)(v6 + 16) = *(_QWORD *)&this->fields.wave;
  ...
  v11 = sub_1C1AC7C(int___TypeInfo, (unsigned int)max_length);
  *(_QWORD *)(v6 + 24) = v11;
  v12 = (__int64 *)(v6 + 24);
  sub_1C1AB78((PartyOrganizationUtility_o *)(v6 + 24), v11, v13, v14, v15, v16, v17, v18);
  if ( max_length >= 1 )
  {
...
LABEL_45:
  ...
  v27 = sub_1C1AC7C(DropInfo_SaveData___TypeInfo, (unsigned int)v25);
  *(_QWORD *)(v6 + 32) = v27;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v6 + 32), v27, v28, v29, v30, v31, v32, v33);
  if ( v25 >= 1 )
  {
    v34 = 0;
    while ( 1 )
    {
      ...
      if ( IsNullOrEmpty )
      {
        IsNullOrEmpty = sub_1C1AD10(IsNullOrEmpty, *(_QWORD *)(*(_QWORD *)v36 + 64LL));
        if ( !IsNullOrEmpty )
        {
LABEL_46:
          v66 = sub_1C1AE54(IsNullOrEmpty);
          sub_1C1ACFC(v66, 0LL);
        }
      }
      if ( v34 >= v36[6] )
      ...
      v44 = &v36[2 * v34];
      *((_QWORD *)v44 + 4) = v43;
      sub_1C1AB78((PartyOrganizationUtility_o *)(v44 + 8), v43, v37, v38, v39, v40, v41, v42);
      if ( v25 == ++v34 )
        goto LABEL_29;
    }
LABEL_44:
...
LABEL_29:
  ...
  v47 = sub_1C1AC7C(BattleWaveInfoData_BattleItemInfo_SaveData___TypeInfo, (unsigned int)v45);
  *(_QWORD *)(v6 + 40) = v47;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v6 + 40), v47, v48, v49, v50, v51, v52, v53);
  if ( v45 >= 1 )
  {
    v54 = 0;
    do
    {
      ...
      if ( IsNullOrEmpty )
      {
        IsNullOrEmpty = sub_1C1AD10(IsNullOrEmpty, *(_QWORD *)(*(_QWORD *)v56 + 64LL));
        if ( !IsNullOrEmpty )
          goto LABEL_46;
      }
      if ( v54 >= v56[6] )
      ...
      v64 = &v56[2 * v54];
      *((_QWORD *)v64 + 4) = v63;
      sub_1C1AB78((PartyOrganizationUtility_o *)(v64 + 8), v63, v57, v58, v59, v60, v61, v62);
    }
    while ( v45 != ++v54 );
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC759A & 1) == 0 )
  {
    sub_1C1ABD4(&BattleWaveInfoData_BattleItemInfo___TypeInfo, saveData);
    sub_1C1ABD4(&BattleWaveInfoData_BattleItemInfo_TypeInfo, v5);
    sub_1C1ABD4(&DropInfo___TypeInfo, v6);
    sub_1C1ABD4(&DropInfo_TypeInfo, v7);
    this = (BattleWaveInfoData_o *)sub_1C1ABD4(&int___TypeInfo, v8);
    byte_4BC759A = 1;
  }
  if ( !saveData )
    goto LABEL_34;
  *(_QWORD *)&v4->fields.wave = *(_QWORD *)&saveData->fields.wave;
  ...
  v11 = sub_1C1AC7C(int___TypeInfo, (unsigned int)v10);
  v4->fields.equipSkillChargeNum = (struct System_Int32_array *)v11;
  p_equipSkillChargeNum = &v4->fields.equipSkillChargeNum;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v4->fields.equipSkillChargeNum, v11, v13, v14, v15, v16, v17, v18);
  if ( (int)v10 >= 1 )
  {
...
LABEL_34:
  ...
  v27 = sub_1C1AC7C(DropInfo___TypeInfo, (unsigned int)v26);
  v4->fields.dropInfos = (struct DropInfo_array *)v27;
  p_dropInfos = (unsigned int **)&v4->fields.dropInfos;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v4->fields.dropInfos, v27, v29, v30, v31, v32, v33, v34);
  if ( (int)v26 >= 1 )
  {
    v35 = 0LL;
    ...
    do
    {
      v38 = (DropInfo_o *)sub_1C1AE20(DropInfo_TypeInfo);
      ...
      if ( !*p_dropInfos )
        goto LABEL_34;
      this = (BattleWaveInfoData_o *)sub_1C1AD10(v38, *(_QWORD *)(*(_QWORD *)v40 + 64LL));
      if ( !this )
      {
LABEL_36:
        v69 = sub_1C1AE54(this);
        sub_1C1ACFC(v69, 0LL);
      }
      if ( v35 >= v40[6] )
        goto LABEL_35;
      *(_QWORD *)&v40[v37] = v38;
      sub_1C1AB78((PartyOrganizationUtility_o *)&v40[v37], (int64_t)v38, v41, v42, v43, v44, v45, v46);
      ++v35;
      v37 += 2LL;
    }
    while ( v36 != v35 );
  ...
  v49 = sub_1C1AC7C(BattleWaveInfoData_BattleItemInfo___TypeInfo, (unsigned int)v48);
  v4->fields.battleItemInfos = (struct BattleWaveInfoData_BattleItemInfo_array *)v49;
  p_battleItemInfos = &v4->fields.battleItemInfos;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v4->fields.battleItemInfos, v49, v51, v52, v53, v54, v55, v56);
  if ( v48 >= 1 )
  {
    v57 = 0;
    do
    {
      v58 = (Il2CppObject *)sub_1C1AE20(BattleWaveInfoData_BattleItemInfo_TypeInfo);
      ...
      if ( !*p_battleItemInfos )
        goto LABEL_34;
      this = (BattleWaveInfoData_o *)sub_1C1AD10(v58, v61->obj.klass->_1.element_class);
      if ( !this )
        goto LABEL_36;
      ...
      sub_1C1AB78((PartyOrganizationUtility_o *)(v68 + 4), (int64_t)v58, v62, v63, v64, v65, v66, v67);
    }
    while ( v48 != ++v57 );
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC759C & 1) == 0 )
  {
    sub_1C1ABD4(&BattleWaveInfoData_BattleItemInfo___TypeInfo, battleData);
    sub_1C1ABD4(&BattleWaveInfoData_BattleItemInfo_TypeInfo, v5);
    sub_1C1ABD4(&DropInfo___TypeInfo, v6);
    sub_1C1ABD4(&int___TypeInfo, v7);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_BattleDropItem__get_Count__, v8);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Count__, v9);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_BattleDropItem__get_Item__, v10);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Item__, v11);
    this = (BattleWaveInfoData_o *)sub_1C1ABD4(&Method_SingletonTemplate_BattleItemData__get_Instance__, v12);
    byte_4BC759C = 1;
  }
  if ( !battleData )
    goto LABEL_31;
  ...
  v15 = sub_1C1AC7C(int___TypeInfo, (unsigned int)size);
  v4->fields.equipSkillChargeNum = (struct System_Int32_array *)v15;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v4->fields.equipSkillChargeNum, v15, v16, v17, v18, v19, v20, v21);
  if ( (int)size >= 1 )
  {
    v22 = 0LL;
    while ( 1 )
...
LABEL_12:
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    v27 = sub_1C1AC7C(DropInfo___TypeInfo, (unsigned int)v26);
    v4->fields.dropInfos = (struct DropInfo_array *)v27;
    sub_1C1AB78((PartyOrganizationUtility_o *)&v4->fields.dropInfos, v27, v28, v29, v30, v31, v32, v33);
    if ( (int)v26 >= 1 )
    {
      v34 = 0LL;
      v35 = 8LL;
      do
      {
        ...
        if ( this )
        {
          this = (BattleWaveInfoData_o *)sub_1C1AD10(this, *(_QWORD *)(*(_QWORD *)dropInfos + 64LL));
          if ( !this )
            goto LABEL_33;
        }
        if ( v34 >= dropInfos[6] )
        ...
        *(_QWORD *)&dropInfos[v35] = v43;
        sub_1C1AB78((PartyOrganizationUtility_o *)&dropInfos[v35], (int64_t)v43, v37, v38, v39, v40, v41, v42);
        ++v34;
        v35 += 2LL;
      }
      while ( v26 != v34 );
  ...
  this = (BattleWaveInfoData_o *)SingletonTemplate_object___get_Instance((const MethodInfo_387ACC8 *)Method_SingletonTemplate_BattleItemData__get_Instance__);
  if ( !this )
    goto LABEL_31;
  wave = this->fields.wave;
  v45 = this;
  v46 = sub_1C1AC7C(BattleWaveInfoData_BattleItemInfo___TypeInfo, wave > 0);
  v4->fields.battleItemInfos = (struct BattleWaveInfoData_BattleItemInfo_array *)v46;
  sub_1C1AB78((PartyOrganizationUtility_o *)&v4->fields.battleItemInfos, v46, v47, v48, v49, v50, v51, v52);
  if ( wave >= 1 )
  {
    battleItemInfos = v4->fields.battleItemInfos;
    v54 = (Il2CppObject *)sub_1C1AE20(BattleWaveInfoData_BattleItemInfo_TypeInfo);
    ...
    if ( !battleItemInfos )
      goto LABEL_31;
    this = (BattleWaveInfoData_o *)sub_1C1AD10(v54, battleItemInfos->obj.klass->_1.element_class);
    if ( !this )
    {
LABEL_33:
      v61 = sub_1C1AE54(this);
      sub_1C1ACFC(v61, 0LL);
    }
    if ( !battleItemInfos->max_length )
LABEL_32:
      sub_1C1AE38(this, battleData);
    battleItemInfos->m_Items[0] = (BattleWaveInfoData_BattleItemInfo_o *)v54;
    sub_1C1AB78((PartyOrganizationUtility_o *)battleItemInfos->m_Items, (int64_t)v54, v55, v56, v57, v58, v59, v60);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC759D & 1) == 0 )
  {
    sub_1C1ABD4(&BattleWaveInfoData_BattleItemInfo_SaveData_TypeInfo, method);
    byte_4BC759D = 1;
  }
  v3 = sub_1C1AE20(BattleWaveInfoData_BattleItemInfo_SaveData_TypeInfo);
