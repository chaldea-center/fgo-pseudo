        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1BFCB & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&BattleWaveInfoData_BattleItemInfo_SaveData___TypeInfo, v3);
    sub_1BCAFF8(&DropInfo_SaveData___TypeInfo, v4);
    sub_1BCAFF8(&BattleWaveInfoData_SaveData_TypeInfo, v5);
    byte_4B1BFCB = 1;
  }
  v6 = sub_1BCB244(BattleWaveInfoData_SaveData_TypeInfo);
  ...
  *(_QWORD *)(v6 + 16) = *(_QWORD *)&this->fields.wave;
  ...
  v11 = sub_1BCB0A0(int___TypeInfo, (unsigned int)max_length);
  *(_QWORD *)(v6 + 24) = v11;
  v12 = (__int64 *)(v6 + 24);
  sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 24), v11, v13, v14);
  if ( max_length >= 1 )
  {
...
LABEL_45:
  ...
  v24 = sub_1BCB0A0(DropInfo_SaveData___TypeInfo, (unsigned int)v22);
  *(_QWORD *)(v6 + 32) = v24;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 32), v24, v25, v26);
  if ( v22 >= 1 )
  {
    v27 = 0;
    while ( 1 )
    {
      ...
      if ( IsNullOrEmpty )
      {
        IsNullOrEmpty = sub_1BCB134(IsNullOrEmpty, *(_QWORD *)(*(_QWORD *)v29 + 64LL));
        if ( !IsNullOrEmpty )
        {
LABEL_46:
          v56 = sub_1BCB278(IsNullOrEmpty);
          sub_1BCB120(v56, 0LL);
        }
      }
      if ( v27 >= v29[6] )
      ...
      v32 = &v29[2 * v27];
      *((_QWORD *)v32 + 4) = v31;
      sub_1BCAF9C((CGThumbnailListItem_o *)(v32 + 8), v31, v15, v30);
      if ( v22 == ++v27 )
        goto LABEL_29;
    }
LABEL_44:
...
LABEL_29:
  ...
  v35 = sub_1BCB0A0(BattleWaveInfoData_BattleItemInfo_SaveData___TypeInfo, (unsigned int)v33);
  *(_QWORD *)(v6 + 40) = v35;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 40), v35, v36, v37);
  if ( v33 >= 1 )
  {
    v39 = 0;
    do
    {
      ...
      if ( IsNullOrEmpty )
      {
        IsNullOrEmpty = sub_1BCB134(IsNullOrEmpty, *(_QWORD *)(*(_QWORD *)v41 + 64LL));
        if ( !IsNullOrEmpty )
          goto LABEL_46;
      }
      if ( v39 >= v41[6] )
      ...
      v44 = &v41[2 * v39];
      *((_QWORD *)v44 + 4) = v43;
      sub_1BCAF9C((CGThumbnailListItem_o *)(v44 + 8), v43, v15, v42);
    }
    while ( v33 != ++v39 );
  }
  ...
  *(_QWORD *)(v6 + 56) = enemySvtInfos;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 56), (int32_t)enemySvtInfos, v15, v38);
  battleFlag = this->fields.battleFlag;
  *(_QWORD *)(v6 + 64) = battleFlag;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 64), (int32_t)battleFlag, v47, v48);
  fieldEnvironmentData = this->fields.fieldEnvironmentData;
  *(_QWORD *)(v6 + 72) = fieldEnvironmentData;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 72), (int32_t)fieldEnvironmentData, v50, v51);
  battleMissionFlag = this->fields.battleMissionFlag;
  *(_QWORD *)(v6 + 80) = battleMissionFlag;
  sub_1BCAF9C((CGThumbnailListItem_o *)(v6 + 80), (int32_t)battleMissionFlag, v53, v54);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1BFCA & 1) == 0 )
  {
    sub_1BCAFF8(&BattleWaveInfoData_BattleItemInfo___TypeInfo, saveData);
    sub_1BCAFF8(&BattleWaveInfoData_BattleItemInfo_TypeInfo, v5);
    sub_1BCAFF8(&DropInfo___TypeInfo, v6);
    sub_1BCAFF8(&DropInfo_TypeInfo, v7);
    this = (BattleWaveInfoData_o *)sub_1BCAFF8(&int___TypeInfo, v8);
    byte_4B1BFCA = 1;
  }
  if ( !saveData )
    goto LABEL_34;
  *(_QWORD *)&v4->fields.wave = *(_QWORD *)&saveData->fields.wave;
  ...
  v11 = sub_1BCB0A0(int___TypeInfo, (unsigned int)v10);
  v4->fields.equipSkillChargeNum = (struct System_Int32_array *)v11;
  p_equipSkillChargeNum = &v4->fields.equipSkillChargeNum;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.equipSkillChargeNum, v11, v13, v14);
  if ( (int)v10 >= 1 )
  {
...
LABEL_34:
  ...
  v24 = sub_1BCB0A0(DropInfo___TypeInfo, (unsigned int)v23);
  v4->fields.dropInfos = (struct DropInfo_array *)v24;
  p_dropInfos = (unsigned int **)&v4->fields.dropInfos;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.dropInfos, v24, v26, v27);
  if ( (int)v23 >= 1 )
  {
    v28 = 0LL;
    ...
    do
    {
      v31 = (DropInfo_o *)sub_1BCB244(DropInfo_TypeInfo);
      ...
      if ( !*p_dropInfos )
        goto LABEL_34;
      this = (BattleWaveInfoData_o *)sub_1BCB134(v31, *(_QWORD *)(*(_QWORD *)v33 + 64LL));
      if ( !this )
      {
LABEL_36:
        v60 = sub_1BCB278(this);
        sub_1BCB120(v60, 0LL);
      }
      if ( v28 >= v33[6] )
        goto LABEL_35;
      *(_QWORD *)&v33[v30] = v31;
      sub_1BCAF9C((CGThumbnailListItem_o *)&v33[v30], (int32_t)v31, v15, v34);
      ++v28;
      v30 += 2LL;
    }
    while ( v29 != v28 );
  ...
  v37 = sub_1BCB0A0(BattleWaveInfoData_BattleItemInfo___TypeInfo, (unsigned int)v36);
  v4->fields.battleItemInfos = (struct BattleWaveInfoData_BattleItemInfo_array *)v37;
  p_battleItemInfos = &v4->fields.battleItemInfos;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.battleItemInfos, v37, v39, v40);
  if ( v36 >= 1 )
  {
    v43 = 0;
    do
    {
      v44 = (Il2CppObject *)sub_1BCB244(BattleWaveInfoData_BattleItemInfo_TypeInfo);
      ...
      if ( !*p_battleItemInfos )
        goto LABEL_34;
      this = (BattleWaveInfoData_o *)sub_1BCB134(v44, v47->obj.klass->_1.element_class);
      if ( !this )
        goto LABEL_36;
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)(v49 + 4), (int32_t)v44, v15, v48);
    }
    while ( v36 != ++v43 );
  }
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.enemySvtInfos, (int32_t)enemySvtInfos, v41, v42);
  battleFlag = saveData->fields.battleFlag;
  v4->fields.battleFlag = battleFlag;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.battleFlag, (int32_t)battleFlag, v52, v53);
  fieldEnvironmentData = saveData->fields.fieldEnvironmentData;
  v4->fields.fieldEnvironmentData = fieldEnvironmentData;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.fieldEnvironmentData, (int32_t)fieldEnvironmentData, v55, v56);
  battleMissionFlag = saveData->fields.battleMissionFlag;
  v4->fields.battleMissionFlag = battleMissionFlag;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v4->fields.battleMissionFlag, (int32_t)battleMissionFlag, v58, v59);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1BFCC & 1) == 0 )
  {
    sub_1BCAFF8(&BattleWaveInfoData_BattleItemInfo___TypeInfo, battleData);
    sub_1BCAFF8(&BattleWaveInfoData_BattleItemInfo_TypeInfo, v7);
    sub_1BCAFF8(&Method_ByteCompressor_ImportMiniMessagePack_BattleFieldEnvironmentData_SaveData___, v8);
    sub_1BCAFF8(&Method_ByteCompressor_ImportMiniMessagePack_BattleServantData_SaveData___, v9);
    sub_1BCAFF8(&DropInfo___TypeInfo, v10);
    sub_1BCAFF8(&int___TypeInfo, v11);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleDropItem__get_Count__, v12);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Count__, v13);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleDropItem__get_Item__, v14);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Item__, v15);
    sub_1BCAFF8(&Method_SingletonTemplate_BattleItemData__get_Instance__, v16);
    this = (BattleWaveInfoData_o *)sub_1BCAFF8(&string___TypeInfo, v17);
    byte_4B1BFCC = 1;
  }
  if ( !battleData )
    goto LABEL_47;
  ...
  v20 = sub_1BCB0A0(int___TypeInfo, (unsigned int)size);
  v6->fields.equipSkillChargeNum = (struct System_Int32_array *)v20;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v6->fields.equipSkillChargeNum, v20, v21, v22);
  if ( (int)size >= 1 )
  {
    v23 = 0LL;
    while ( 1 )
...
LABEL_12:
  ...
  if ( ((unsigned __int8)this & 1) == 0 )
  {
    ...
    v29 = sub_1BCB0A0(DropInfo___TypeInfo, (unsigned int)v28);
    v6->fields.dropInfos = (struct DropInfo_array *)v29;
    sub_1BCAF9C((CGThumbnailListItem_o *)&v6->fields.dropInfos, v29, v30, v31);
    if ( (int)v28 >= 1 )
    {
      v32 = 0LL;
      v33 = 8LL;
      do
      {
        ...
        if ( this )
        {
          this = (BattleWaveInfoData_o *)sub_1BCB134(this, *(_QWORD *)(*(_QWORD *)dropInfos + 64LL));
          if ( !this )
            goto LABEL_49;
        }
        if ( v32 >= dropInfos[6] )
        ...
        *(_QWORD *)&dropInfos[v33] = v36;
        sub_1BCAF9C((CGThumbnailListItem_o *)&dropInfos[v33], (int32_t)v36, v25, v35);
        ++v32;
        v33 += 2LL;
      }
      while ( v28 != v32 );
  ...
  this = (BattleWaveInfoData_o *)SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_BattleItemData__get_Instance__);
  if ( !this )
    goto LABEL_47;
  wave = this->fields.wave;
  v38 = this;
  v39 = sub_1BCB0A0(BattleWaveInfoData_BattleItemInfo___TypeInfo, wave > 0);
  v6->fields.battleItemInfos = (struct BattleWaveInfoData_BattleItemInfo_array *)v39;
  sub_1BCAF9C((CGThumbnailListItem_o *)&v6->fields.battleItemInfos, v39, v40, v41);
  if ( wave >= 1 )
  {
    battleItemInfos = v6->fields.battleItemInfos;
    v43 = (Il2CppObject *)sub_1BCB244(BattleWaveInfoData_BattleItemInfo_TypeInfo);
    ...
    if ( !battleItemInfos )
      goto LABEL_47;
    this = (BattleWaveInfoData_o *)sub_1BCB134(v43, battleItemInfos->obj.klass->_1.element_class);
    if ( !this )
    {
LABEL_49:
      v64 = sub_1BCB278(this);
      sub_1BCB120(v64, 0LL);
    }
    if ( !battleItemInfos->max_length )
LABEL_48:
      sub_1BCB25C(this, battleData, v25);
    battleItemInfos->m_Items[0] = (BattleWaveInfoData_BattleItemInfo_o *)v43;
    sub_1BCAF9C((CGThumbnailListItem_o *)battleItemInfos->m_Items, (int32_t)v43, v25, v44);
  }
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    if ( !enemySaveData )
      goto LABEL_47;
    v45 = sub_1BCB0A0(string___TypeInfo, enemySaveData->max_length);
    v6->fields.enemySvtInfos = (struct System_String_array *)v45;
    sub_1BCAF9C((CGThumbnailListItem_o *)&v6->fields.enemySvtInfos, v45, v46, v47);
      ...
      while ( v49 < (unsigned int)v48 )
      {
        ...
        this = (BattleWaveInfoData_o *)ByteCompressor__ImportMiniMessagePack_object_(
                                         *(Il2CppObject **)((char *)&enemySaveData->obj.klass + v50),
                                         (const MethodInfo_300D158 *)Method_ByteCompressor_ImportMiniMessagePack_BattleServantData_SaveData___);
        if ( !this )
          goto LABEL_47;
        ...
        *(Il2CppClass **)((char *)&enemySvtInfos->obj.klass + v50) = (Il2CppClass *)v53;
        sub_1BCAF9C((CGThumbnailListItem_o *)((char *)enemySvtInfos + v50), (int32_t)v53, v25, v52);
...
LABEL_42:
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v6->fields.battleFlag, (int32_t)BattleValueDict, v55, v56);
  ...
  this = (BattleWaveInfoData_o *)ByteCompressor__ImportMiniMessagePack_object_(
                                   SaveData,
                                   (const MethodInfo_300D158 *)Method_ByteCompressor_ImportMiniMessagePack_BattleFieldEnvironmentData_SaveData___);
  if ( !this )
    goto LABEL_47;
  this = (BattleWaveInfoData_o *)ByteCompressor__ToGzip((ByteCompressor_o *)this, 0LL);
  if ( !this )
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&v6->fields.fieldEnvironmentData, (int32_t)v60, v58, v59);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1BFCD & 1) == 0 )
  {
    sub_1BCAFF8(&BattleWaveInfoData_BattleItemInfo_SaveData_TypeInfo, method);
    byte_4B1BFCD = 1;
  }
  v3 = sub_1BCB244(BattleWaveInfoData_BattleItemInfo_SaveData_TypeInfo);
