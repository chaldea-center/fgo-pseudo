...
void PresentBoxOverDialog__Close(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  PresentBoxOverDialog__Close_32266928(this, 0, v2);
}


void PresentBoxOverDialog__Close_32266928(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3225E & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_PresentBoxOverDialog_EndClose__);
    byte_4C3225E = 1;
  }
...
void PresentBoxOverDialog__OnClickClose(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3225F & 1) == 0 )
  {
    sub_1C32C20(&Method_PresentBoxOverDialog_OnClickClose__);
    byte_4C3225F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_PresentBoxOverDialog_OnClickClose__);
...
void PresentBoxOverDialog__OnClickPresentBox(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C32260 & 1) == 0 )
  {
    sub_1C32C20(&Method_PresentBoxOverDialog_OnClickPresentBox__);
    byte_4C32260 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickPresentBox__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_PresentBoxOverDialog_OnClickPresentBox__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3225D & 1) == 0 )
  {
    ...
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&Method_PresentBoxOverDialog_EndOpen__);
    sub_1C32C20(&StringLiteral_9649/*"OPEN_PRESENT_BOX"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(messageLabel, 0, 0) )
    {
      ...
      if ( !v12 )
        goto LABEL_33;
      UILabel__set_fontSize(v12, fontSize, 0);
      v12 = this->fields.messageLabel;
      if ( !v12 )
        goto LABEL_33;
      WrapControlText__textAdjust(v12, message, v12->fields.mFontSize, 0, 0);
      v12 = this->fields.messageLabel;
      if ( !v12 )
        goto LABEL_33;
      UILabel__set_text(v12, message, 0);
    }
    closeBtnLabel = (UnityEngine_Object_o *)this->fields.closeBtnLabel;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( UnityEngine_Object__op_Inequality(closeBtnLabel, 0, 0) )
    {
      v15 = this->fields.closeBtnLabel;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v12 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3685/*"COMMON_CONFIRM_CLOSE"*/, 0);
      if ( !v15 )
        goto LABEL_33;
      UILabel__set_text(v15, (System_String_o *)v12, 0);
    }
    presentBoxBtnLabel = (UnityEngine_Object_o *)this->fields.presentBoxBtnLabel;
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    if ( !UnityEngine_Object__op_Inequality(presentBoxBtnLabel, 0, 0) )
      goto LABEL_32;
    v17 = this->fields.presentBoxBtnLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9649/*"OPEN_PRESENT_BOX"*/, 0);
    if ( v17 )
    {
      UILabel__set_text(v17, (System_String_o *)v12, 0);
LABEL_32:
      this->fields.state = 1;
      v18 = (System_Action_o *)sub_1C32E6C(System_Action_TypeInfo);
      System_Action___ctor(v18, (Il2CppObject *)this, Method_PresentBoxOverDialog_EndOpen__, 0);
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A6F064;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A6F01C;
}
