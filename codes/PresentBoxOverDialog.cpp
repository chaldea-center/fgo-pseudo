...
void PresentBoxOverDialog__Close(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  PresentBoxOverDialog__Close_33396584(this, 0, v2);
}


void PresentBoxOverDialog__Close_33396584(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF1AF & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_PresentBoxOverDialog_EndClose__);
    byte_4DFF1AF = 1;
  }
...
void PresentBoxOverDialog__OnClickClose(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF1B0 & 1) == 0 )
  {
    sub_1CE6700(&Method_PresentBoxOverDialog_OnClickClose__);
    byte_4DFF1B0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_PresentBoxOverDialog_OnClickClose__);
...
void PresentBoxOverDialog__OnClickPresentBox(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF1B1 & 1) == 0 )
  {
    sub_1CE6700(&Method_PresentBoxOverDialog_OnClickPresentBox__);
    byte_4DFF1B1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickPresentBox__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_PresentBoxOverDialog_OnClickPresentBox__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF1AE & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_PresentBoxOverDialog_EndOpen__);
    sub_1CE6700(&StringLiteral_9726/*"OPEN_PRESENT_BOX"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(closeBtnLabel, 0, 0) )
    {
      ...
      v13 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3714/*"COMMON_CONFIRM_CLOSE"*/, 0);
      if ( !v16 )
        goto LABEL_33;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v13 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9726/*"OPEN_PRESENT_BOX"*/, 0);
    if ( v18 )
    {
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B0EFF8;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B0EFB0;
}
