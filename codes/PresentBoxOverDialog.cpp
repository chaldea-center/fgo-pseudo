...
void __fastcall PresentBoxOverDialog__Close(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  PresentBoxOverDialog__Close_30675640(this, 0LL, v2);
}


void __fastcall PresentBoxOverDialog__Close_30675640(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5BC9 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_PresentBoxOverDialog_EndClose__, v5);
    byte_49B5BC9 = 1;
  }
...
void __fastcall PresentBoxOverDialog__OnClickClose(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B5BCA & 1) == 0 )
  {
    sub_1B4CF90(&Method_PresentBoxOverDialog_OnClickClose__, method);
    byte_49B5BCA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B4CFA8(Method_PresentBoxOverDialog_OnClickClose__);
...
void __fastcall PresentBoxOverDialog__OnClickPresentBox(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B5BCB & 1) == 0 )
  {
    sub_1B4CF90(&Method_PresentBoxOverDialog_OnClickPresentBox__, method);
    byte_49B5BCB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickPresentBox__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B4CFA8(Method_PresentBoxOverDialog_OnClickPresentBox__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B4CF74(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5BC8 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_PresentBoxOverDialog_EndOpen__, v13);
    sub_1B4CF90(&StringLiteral_9448/*"OPEN_PRESENT_BOX"*/, v14);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(closeBtnLabel, 0LL, 0LL) )
    {
      ...
      v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3657/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
      if ( !v21 )
        goto LABEL_33;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v18 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9448/*"OPEN_PRESENT_BOX"*/, 0LL);
    if ( v23 )
    {
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19947F4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19947AC;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5BCE & 1) == 0 )
  {
    sub_1B4CF90(&bool_TypeInfo, isPresentBoxOpen);
    byte_49B5BCE = 1;
  }
  v9[1] = 0LL;
