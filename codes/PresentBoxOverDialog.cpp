...
void __fastcall PresentBoxOverDialog__Close(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  PresentBoxOverDialog__Close_25460164(this, 0LL, v2);
}


void __fastcall PresentBoxOverDialog__Close_25460164(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4351EED & 1) == 0 )
  {
    ...
    sub_B70694(&Method_PresentBoxOverDialog_EndClose__);
    byte_4351EED = 1;
  }
...
void __fastcall PresentBoxOverDialog__OnClickClose(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4351EEE & 1) == 0 )
  {
    sub_B70694(&Method_PresentBoxOverDialog_OnClickClose__);
    byte_4351EEE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickClose__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B7069C(Method_PresentBoxOverDialog_OnClickClose__);
    ...
    if ( clickFunc )
    {
      ...
      sub_B70630(p_clickFunc, 0LL, v5, v6, v7, v8, v9, v10);
...
void __fastcall PresentBoxOverDialog__OnClickPresentBox(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4351EEF & 1) == 0 )
  {
    sub_B70694(&Method_PresentBoxOverDialog_OnClickPresentBox__);
    byte_4351EEF = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickPresentBox__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B7069C(Method_PresentBoxOverDialog_OnClickPresentBox__);
    v4 = (System_Reflection_MethodBase_o *)sub_B70678(v3, v3[3]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4351EEC & 1) == 0 )
  {
    ...
    sub_B70694(&UnityEngine_Object_TypeInfo);
    sub_B70694(&Method_PresentBoxOverDialog_EndOpen__);
    sub_B70694(&StringLiteral_9885/*"OPEN_PRESENT_BOX"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(closeBtnLabel, 0LL, 0LL) )
    {
      ...
      v15 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3336/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
      if ( !v18 )
        goto LABEL_39;
    ...
    v15 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9885/*"OPEN_PRESENT_BOX"*/, 0LL);
    if ( v20 )
    {
...
LABEL_5:
    ...
    while ( 1 )
    {
      ...
      if ( *(__int16 *)(v20 + 72) == -1 )
        sub_B70750(*(_QWORD *)&v18->fields.extra_arg, isPresentBoxOpen);
