...
void __fastcall PresentBoxOverDialog__Close(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  PresentBoxOverDialog__Close_25707980(this, 0LL, v2);
}


void __fastcall PresentBoxOverDialog__Close_25707980(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438B5B0 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_PresentBoxOverDialog_EndClose__);
    byte_438B5B0 = 1;
  }
...
void __fastcall PresentBoxOverDialog__OnClickClose(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438B5B1 & 1) == 0 )
  {
    sub_B775C4(&Method_PresentBoxOverDialog_OnClickClose__);
    byte_438B5B1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickClose__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B775CC(Method_PresentBoxOverDialog_OnClickClose__);
...
void __fastcall PresentBoxOverDialog__OnClickPresentBox(PresentBoxOverDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438B5B2 & 1) == 0 )
  {
    sub_B775C4(&Method_PresentBoxOverDialog_OnClickPresentBox__);
    byte_438B5B2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_PresentBoxOverDialog_OnClickPresentBox__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B775CC(Method_PresentBoxOverDialog_OnClickPresentBox__);
    v4 = (System_Reflection_MethodBase_o *)sub_B775A8(v3, v3[3]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438B5AF & 1) == 0 )
  {
    ...
    sub_B775C4(&UnityEngine_Object_TypeInfo);
    sub_B775C4(&Method_PresentBoxOverDialog_EndOpen__);
    sub_B775C4(&StringLiteral_9944/*"OPEN_PRESENT_BOX"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(closeBtnLabel, 0LL, 0LL) )
    {
      ...
      v15 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3387/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
      if ( !v18 )
        goto LABEL_39;
    ...
    v15 = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_9944/*"OPEN_PRESENT_BOX"*/, 0LL);
    if ( v20 )
    {
...
LABEL_5:
    ...
    while ( 1 )
    {
      ...
      if ( *(__int16 *)(v20 + 72) == -1 )
        sub_B77680(*(_QWORD *)&v18->fields.extra_arg, isPresentBoxOpen);
