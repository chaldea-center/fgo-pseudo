void __fastcall WarBoardActionPointMaster___ctor(WarBoardActionPointMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B45B39 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string___ctor__, method);
    byte_4B45B39 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    329,
    (const MethodInfo_32E45D0 *)Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (WarBoardActionPointEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                          (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                          PK,
                                          (const MethodInfo_32E68F4 *)Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45B3A & 1) == 0 )
  {
    sub_1BDB878(&WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_TypeInfo, *(_QWORD *)&stageId);
    byte_4B45B3A = 1;
  }
  v5 = sub_1BDBAC4(WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32E6940 *)Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45B3B & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_WarBoardActionPointEntity__get_Count__, method);
    this = (WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_o *)sub_1BDB878(
...
LABEL_17:
    ...
    this = (WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_o *)System_Collections_ObjectModel_Collection_object___get_Count(
                                                                                 ...
                                                                                 (const MethodInfo_327D624 *)Method_System_Collections_ObjectModel_Collection_WarBoardActionPointEntity__get_Count__);
    method = 0LL;
    *(_QWORD *)&v2->fields._count_5__2 = (unsigned int)this;
    while ( (int)method < (int)this )
    {
      ...
      Item = System_Collections_ObjectModel_Collection_object___get_Item(
               (System_Collections_ObjectModel_Collection_T__o *)this,
               (int32_t)method,
               (const MethodInfo_327D6B4 *)Method_System_Collections_ObjectModel_Collection_WarBoardActionPointEntity__get_Item__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45B3C & 1) == 0 )
  {
    sub_1BDB878(&WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_TypeInfo, method);
    byte_4B45B3C = 1;
  }
  ...
  {
    v4 = (WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_o *)sub_1BDBAC4(WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
