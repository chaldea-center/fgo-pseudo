void __fastcall WarBoardActionPointMaster___ctor(WarBoardActionPointMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4212B4E & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string___ctor__, method);
    byte_4212B4E = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    321,
    (const MethodInfo_2669F88 *)Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (WarBoardActionPointEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                          ...
                                          PK,
                                          (const MethodInfo_266A024 *)Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4212B4F & 1) == 0 )
  {
    sub_B0D8A4(&WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_TypeInfo, *(_QWORD *)&stageId);
    byte_4212B4F = 1;
  }
  v5 = sub_B0D974(WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_TypeInfo, *(_QWORD *)&stageId, method);
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_266A07C *)Method_DataMasterBase_WarBoardActionPointMaster__WarBoardActionPointEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4212692 & 1) == 0 )
  {
    ...
    this = (WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_o *)sub_B0D8A4(
...
LABEL_19:
    ...
    while ( v8 < (int)this )
    {
      ...
      if ( Item )
      {
        v11 = *(&WarBoardActionPointEntity_TypeInfo->_2.bitflags2 + 1);
        if ( *(&Item->klass->_2.bitflags2 + 1) >= (unsigned int)v11
          && (WarBoardActionPointEntity_c *)Item->klass->_2.typeHierarchy[v11 - 1] == WarBoardActionPointEntity_TypeInfo
        ...
        const MethodInfo *method)
{
  ...
  WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_o *v5; // x20
  ...
  if ( (byte_4212693 & 1) == 0 )
  {
    sub_B0D8A4(&WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_TypeInfo, method);
    byte_4212693 = 1;
  }
  ...
  {
    v5 = (WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_o *)sub_B0D974(
  ...
  result = (System_Collections_Generic_IEnumerator_WarBoardActionPointEntity__o *)v5;
        ...
        const MethodInfo *method)
{
  ...
  v6 = sub_B0D8A8(&Method_WarBoardActionPointMaster__GetWarBoardActionPointEntities_d__3_System_Collections_IEnumerator_Reset__);
  sub_B0D948(v5, v6);
}
