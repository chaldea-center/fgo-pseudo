        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AABA & 1) == 0 )
  {
    sub_1C2D490(&BattleResultEventItemComponent_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AAB9 & 1) == 0 )
  {
    sub_1C2D490(&System_Action_BattleFortificationInfo__TypeInfo);
    sub_1C2D490(&Method_BasicHelper_ForEach_BattleFortificationInfo___);
    sub_1C2D490(&Method_UnityEngine_Component_GetComponent_UIGrid___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&Method_BattleResultEventFortificationItemComponent___c__DisplayClass4_0__SetFortificationInfos_b__0__);
    this = (BattleResultEventFortificationItemComponent_o *)sub_1C2D490(&BattleResultEventFortificationItemComponent___c__DisplayClass4_0_TypeInfo);
    byte_4C2AAB9 = 1;
  }
  if ( fortificationInfos && fortificationInfos->max_length )
  {
    ...
    if ( SLODWORD(workTypeOrder->max_length) >= 1 )
    {
      ...
      while ( 1 )
      {
        v7 = sub_1C2D6DC(BattleResultEventFortificationItemComponent___c__DisplayClass4_0_TypeInfo);
        ...
        *(_DWORD *)(v7 + 16) = workTypeOrder->m_Items[v6];
        v13 = (System_Action_object__o *)sub_1C2D6DC(System_Action_BattleFortificationInfo__TypeInfo);
        ...
        BasicHelper__ForEach_object_(
          ...
          (const MethodInfo_30BA910 *)Method_BasicHelper_ForEach_BattleFortificationInfo___);
        if ( (__int64)++v6 >= SLODWORD(workTypeOrder->max_length) )
          goto LABEL_11;
      }
LABEL_18:
      sub_1C2D6EC(this, fortificationInfos);
    }
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( eventId >= 1 )
  {
    ...
    BattleResultEventItemComponent__SetItemWindow_47438904((BattleResultEventItemComponent_o *)this, drop, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AABB & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_Object_Instantiate_FortificationGauge___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2AABB = 1;
  }
  if ( info )
  {
    ...
    if ( (_DWORD)FortificationWorkType == this->fields.workType )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      FortificationWorkType = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object__51752420(
                                                           fortificationGaugePrefab,
                                                           gaugeListRoot,
                                                           (const MethodInfo_315ADE4 *)Method_UnityEngine_Object_Instantiate_FortificationGauge___);
      ...
      {
LABEL_12:
        sub_1C2D6EC(FortificationWorkType, v6);
      }
