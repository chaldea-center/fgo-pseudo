        ...
        const MethodInfo *method)
{
  ...
  v12.fields.value = Field__PrivateImplementationDetails__88A785E43F0814338C5CB47BDE7DE708C7172EABAD671E4511199C78A3B4DAA1;
  v4 = (struct System_Int32_array *)v3;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63022812(v3, v12, 0LL);
  ...
  BattleResultEventItemComponent___ctor((BattleResultEventItemComponent_o *)this, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF934 & 1) == 0 )
  {
    sub_1C21E38(&System_Action_BattleFortificationInfo__TypeInfo);
    sub_1C21E38(&Method_BasicHelper_ForEach_BattleFortificationInfo___);
    sub_1C21E38(&Method_UnityEngine_Component_GetComponent_UIGrid___);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&Method_BattleResultEventFortificationItemComponent___c__DisplayClass4_0__SetFortificationInfos_b__0__);
    this = (BattleResultEventFortificationItemComponent_o *)sub_1C21E38(&BattleResultEventFortificationItemComponent___c__DisplayClass4_0_TypeInfo);
    byte_4BDF934 = 1;
  }
  if ( fortificationInfos && *(_QWORD *)&fortificationInfos->max_length )
  {
    ...
    if ( (int)workTypeOrder->max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        v7 = sub_1C22084(BattleResultEventFortificationItemComponent___c__DisplayClass4_0_TypeInfo);
        ...
        *(_DWORD *)(v7 + 16) = workTypeOrder->m_Items[v6 + 1];
        v16 = (System_Action_object__o *)sub_1C22084(System_Action_BattleFortificationInfo__TypeInfo);
        ...
        BasicHelper__ForEach_object_(
          ...
          (const MethodInfo_2F9CD60 *)Method_BasicHelper_ForEach_BattleFortificationInfo___);
        if ( (__int64)++v6 >= (int)workTypeOrder->max_length )
          goto LABEL_11;
      }
LABEL_18:
      sub_1C22094(this, fortificationInfos);
    }
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( eventId >= 1 )
  {
    ...
    BattleResultEventItemComponent__SetItemWindow_45636644((BattleResultEventItemComponent_o *)this, drop, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDF936 & 1) == 0 )
  {
    sub_1C21E38(&Method_UnityEngine_Object_Instantiate_FortificationGauge___);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    byte_4BDF936 = 1;
  }
  if ( info )
  {
    ...
    if ( (_DWORD)FortificationWorkType == this->fields.workType )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      FortificationWorkType = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object__50551272(
                                                           fortificationGaugePrefab,
                                                           gaugeListRoot,
                                                           (const MethodInfo_30359E8 *)Method_UnityEngine_Object_Instantiate_FortificationGauge___);
      ...
      {
LABEL_12:
        sub_1C22094(FortificationWorkType, v6);
      }
