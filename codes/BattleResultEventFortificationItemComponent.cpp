        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0568F & 1) == 0 )
  {
    sub_1BC3008(&BattleResultEventItemComponent_TypeInfo, method);
  ...
  v5 = (System_Array_o *)sub_1BC30B0(int___TypeInfo, 3LL);
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63047724(v5, v10, 0LL);
  this->fields.workTypeOrder = v6;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.workTypeOrder, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0568E & 1) == 0 )
  {
    sub_1BC3008(&System_Action_BattleFortificationInfo__TypeInfo, fortificationInfos);
    sub_1BC3008(&Method_BasicHelper_ForEach_BattleFortificationInfo___, v5);
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_UIGrid___, v6);
    ...
    sub_1BC3008(
      ...
      v8);
    this = (BattleResultEventFortificationItemComponent_o *)sub_1BC3008(
  ...
  if ( fortificationInfos && *(_QWORD *)&fortificationInfos->max_length )
  {
    ...
    if ( (int)workTypeOrder->max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        v12 = sub_1BC3254(BattleResultEventFortificationItemComponent___c__DisplayClass4_0_TypeInfo);
        System_Object___ctor((Il2CppObject *)v12, 0LL);
        if ( !v12 )
          break;
        *(_QWORD *)(v12 + 24) = v4;
        sub_1BC2FAC((CGThumbnailListItem_o *)(v12 + 24), (int32_t)v4, v13, v14);
        if ( v11 >= workTypeOrder->max_length )
          sub_1BC326C(v15, v16, v17);
        *(_DWORD *)(v12 + 16) = workTypeOrder->m_Items[v11 + 1];
        v18 = (System_Action_object__o *)sub_1BC3254(System_Action_BattleFortificationInfo__TypeInfo);
        ...
        BasicHelper__ForEach_object_(
          ...
          (const MethodInfo_2FEDEFC *)Method_BasicHelper_ForEach_BattleFortificationInfo___);
        if ( (__int64)++v11 >= (int)workTypeOrder->max_length )
          goto LABEL_11;
      }
LABEL_18:
      sub_1BC3264(this, fortificationInfos);
    }
LABEL_11:
        ...
        const MethodInfo *method)
{
  ...
  if ( eventId >= 1 )
  {
    ...
    BattleResultEventItemComponent__SetItemWindow_46493068((BattleResultEventItemComponent_o *)this, drop, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05690 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_FortificationGauge___, info);
  ...
  if ( info )
  {
    ...
    if ( (_DWORD)FortificationWorkType == this->fields.workType )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      FortificationWorkType = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object__50900816(
                                                           fortificationGaugePrefab,
                                                           gaugeListRoot,
                                                           (const MethodInfo_308AF50 *)Method_UnityEngine_Object_Instantiate_FortificationGauge___);
      ...
      {
LABEL_12:
        sub_1BC3264(FortificationWorkType, v7);
      }
