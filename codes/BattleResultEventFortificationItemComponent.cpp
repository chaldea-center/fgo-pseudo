        ...
        const MethodInfo *method)
{
  ...
  v5 = (System_Array_o *)sub_1B64170(int___TypeInfo, 3LL);
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_61282732(v5, v10, 0LL);
  this->fields.workTypeOrder = v6;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.workTypeOrder, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF51A & 1) == 0 )
  {
    sub_1B640C8(&System_Action_BattleFortificationInfo__TypeInfo, fortificationInfos);
    sub_1B640C8(&Method_BasicHelper_ForEach_BattleFortificationInfo___, v5);
    sub_1B640C8(&Method_UnityEngine_Component_GetComponent_UIGrid___, v6);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v7);
    sub_1B640C8(
      &Method_BattleResultEventFortificationItemComponent___c__DisplayClass4_0__SetFortificationInfos_b__0__,
      v8);
    this = (BattleResultEventFortificationItemComponent_o *)sub_1B640C8(
    ...
    if ( (int)workTypeOrder->max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v12 )
          break;
        *(_QWORD *)(v12 + 24) = v4;
        sub_1B6406C((ServantStatusBattleListViewItem_o *)(v12 + 24), (int32_t)v4, v13, v14);
        if ( v11 >= workTypeOrder->max_length )
          sub_1B6432C(v15, v16);
        *(_DWORD *)(v12 + 16) = workTypeOrder->m_Items[v11 + 1];
        v18 = (System_Action_object__o *)sub_1B64314(System_Action_BattleFortificationInfo__TypeInfo, v16, v17);
        ...
        BasicHelper__ForEach_object_(
          ...
          (const MethodInfo_2E26860 *)Method_BasicHelper_ForEach_BattleFortificationInfo___);
        ...
        const MethodInfo *method)
{
  ...
  if ( eventId >= 1 )
  {
    ...
    BattleResultEventItemComponent__SetItemWindow_43799532((BattleResultEventItemComponent_o *)this, drop, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF51C & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_Object_Instantiate_FortificationGauge___, info);
  ...
  if ( info )
  {
    ...
    if ( (_DWORD)FortificationWorkType == this->fields.workType )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      FortificationWorkType = (UnityEngine_Component_o *)UnityEngine_Object__Instantiate_object__49003980(
                                                           fortificationGaugePrefab,
                                                           gaugeListRoot,
                                                           (const MethodInfo_2EBBDCC *)Method_UnityEngine_Object_Instantiate_FortificationGauge___);
      if ( !FortificationWorkType
        || (v11 = FortificationWorkType,
            FortificationGauge__SetData((FortificationGauge_o *)FortificationWorkType, info, v10),
            (FortificationWorkType = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(v11, 0LL)) == 0LL) )
      {
LABEL_12:
        sub_1B64324(FortificationWorkType);
      }
