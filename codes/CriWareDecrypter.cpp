        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_4B10748 )
  {
    ...
    v11[4] = 0x200000000LL;
    v13 = 0;
    qword_4B10748 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))sub_1BCADBC(
                                                                              v11,
  ...
  v9 = sub_1BCADB4(func, enable_mana_decryption, func, *(_QWORD *)&obj, method);
  return qword_4B10748(enable_atom_decryption, enable_mana_decryption, v9, v5);
}
...
uint64_t __fastcall CriWareDecrypter__CallbackFromNative(intptr_t ptr1, const MethodInfo *method)
{
  ...
  if ( (byte_4B10746 & 1) == 0 )
  {
    sub_1BCA7E0(&CriWareDecrypter_TypeInfo, method, v2);
    byte_4B10746 = 1;
  }
...
bool __fastcall CriWareDecrypter__Initialize(CriWareDecrypterConfig_o *config, const MethodInfo *method)
{
  ...
  return CriWareDecrypter__Initialize_30420184(
           config->fields.key,
...
// local variable allocation has failed, the output may be wrong!
bool __fastcall CriWareDecrypter__Initialize_30420184(
        System_String_o *key,
        ...
        const MethodInfo *method)
{
  ...
  CriWareDecrypter_CallbackFromNativeDelegate_o *v28; // x21
  ...
  if ( (byte_4B10745 & 1) == 0 )
  {
    sub_1BCA7E0(&CriWareDecrypter_CallbackFromNativeDelegate_TypeInfo, authenticationFile, enableAtomDecryption);
    sub_1BCA7E0(&System_Convert_TypeInfo, v9, v10);
    sub_1BCA7E0(&CriFsPlugin_TypeInfo, v11, v12);
    sub_1BCA7E0(&Method_CriWareDecrypter_CallbackFromNative__, v13, v14);
    sub_1BCA7E0(&CriWareDecrypter_TypeInfo, v15, v16);
    sub_1BCA7E0(&System_IO_Path_TypeInfo, v17, v18);
    byte_4B10745 = 1;
  }
  inited = CriFsPlugin_TypeInfo;
  if ( !CriFsPlugin_TypeInfo->_2.cctor_finished )
    inited = (CriFsPlugin_c *)j_il2cpp_runtime_class_init_0(CriFsPlugin_TypeInfo, authenticationFile);
  if ( !CriFsPlugin__IsLibraryInitialized((const MethodInfo *)inited) )
    return 0;
  v20 = CriWare_Common__CheckBinaryVersionCompatibility(0LL);
  if ( !v20 )
    return 0;
  if ( !key )
    sub_1BCAA3C(v20, v21);
  v22 = 0xD47EB533AEF7E5LL;
  if ( key->fields._stringLength )
  {
    if ( !System_Convert_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo, v21);
    v22 = System_Convert__ToUInt64_63061968(key, 0LL) ^ 0xD47EB533AEF7E5LL;
  }
  if ( CriWare_Common__IsStreamingAssetsPath(authenticationFile, 0LL) )
  {
    ...
    if ( !System_IO_Path_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_IO_Path_TypeInfo, v26);
    System_IO_Path__Combine(streamingAssetsPath, authenticationFile, 0LL);
  }
  CriWareDecrypter_TypeInfo->static_fields->temporalStorage = v22;
  v28 = (CriWareDecrypter_CallbackFromNativeDelegate_o *)sub_1BCAA2C(
                                                           CriWareDecrypter_CallbackFromNativeDelegate_TypeInfo,
                                                           v23,
                                                           v24,
                                                           v25);
  CriWareDecrypter_CallbackFromNativeDelegate___ctor(v28, 0LL, Method_CriWareDecrypter_CallbackFromNative__, v29);
  CriWareDecrypter__CRIWARE3D9A5BE6(enableAtomDecryption, enableManaDecryption, v28, 0, v30);
  result = 1;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A03274;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A03224;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B10750 & 1) == 0 )
  {
    sub_1BCA7E0(&IntPtr_TypeInfo, *(_QWORD *)&ptr1, callback);
    byte_4B10750 = 1;
  }
  v9[1] = 0LL;
