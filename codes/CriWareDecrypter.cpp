        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_42A6590 )
  {
    ...
    v12 = 24;
    v13 = 0;
    qword_42A6590 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))sub_B52E08(
                                                                              v11,
  ...
  v9 = sub_B52E00(func, enable_mana_decryption, func, *(_QWORD *)&obj, method);
  return qword_42A6590(enable_atom_decryption, enable_mana_decryption, v9, v5);
}
...
uint64_t __fastcall CriWareDecrypter__CallbackFromNative(intptr_t ptr1, const MethodInfo *method)
{
  ...
  if ( (byte_42A658F & 1) == 0 )
  {
    sub_B52984(&CriWareDecrypter_TypeInfo, method);
    byte_42A658F = 1;
  }
...
bool __fastcall CriWareDecrypter__Initialize(CriWareDecrypterConfig_o *config, const MethodInfo *method)
{
  ...
  if ( (byte_42A658D & 1) == 0 )
  {
    config = (CriWareDecrypterConfig_o *)sub_B52984(&CriWareDecrypter_TypeInfo, method);
    byte_42A658D = 1;
  }
  if ( !v3 )
    sub_B52A5C(config, method);
  key = v3->fields.key;
  ...
  return CriWareDecrypter__Initialize_14479008(key, authenticationFile, enableAtomDecryption, enableManaDecryption, v2);
}


bool __fastcall CriWareDecrypter__Initialize_14479008(
        System_String_o *key,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42A658E & 1) == 0 )
  {
    sub_B52984(&CriWareDecrypter_CallbackFromNativeDelegate_TypeInfo, authenticationFile);
    sub_B52984(&CriWare_Common_TypeInfo, v9);
    sub_B52984(&System_Convert_TypeInfo, v10);
    sub_B52984(&CriFsPlugin_TypeInfo, v11);
    sub_B52984(&Method_CriWareDecrypter_CallbackFromNative__, v12);
    sub_B52984(&CriWareDecrypter_TypeInfo, v13);
    sub_B52984(&IntPtr_TypeInfo, v14);
    sub_B52984(&System_IO_Path_TypeInfo, v15);
    byte_42A658E = 1;
  }
  ...
  if ( key->fields.m_stringLength )
  {
    ...
    v19 = System_Convert__ToUInt64_42695060(key, 0LL) ^ 0xD47EB533AEF7E5LL;
  }
  if ( (BYTE3(CriWare_Common_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !CriWare_Common_TypeInfo->_2.cctor_finished )
  {
  ...
  v22 = (CriWareDecrypter_CallbackFromNativeDelegate_o *)sub_B52A54(CriWareDecrypter_CallbackFromNativeDelegate_TypeInfo);
...
LABEL_5:
    ...
    while ( 1 )
    {
      ...
      if ( *(__int16 *)(v23 + 72) == -1 )
        sub_B52A40(*(_QWORD *)&v21->fields.extra_arg, *(_QWORD *)&ptr1, method, v3);
...
LABEL_35:
        ...
        v20 = (__int64 (__fastcall **)(__int64 *, __int64, _QWORD))sub_B52A34(v17, v23);
      ...
      else
      {
        ...
        if ( (v26 & 1) != 0 )
        {
          ...
          {
LABEL_11:
            v16 = sub_AEB880(v22, class_0, v10, v12);
          }
