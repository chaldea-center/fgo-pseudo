        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_49F95A8 )
  {
    ...
    v11[4] = 0x200000000LL;
    v13 = 0;
    qword_49F95A8 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))sub_1B64FDC(
                                                                              v11,
  ...
  v9 = sub_1B64FD4(func, enable_mana_decryption, func, *(_QWORD *)&obj, method);
  return qword_49F95A8(enable_atom_decryption, enable_mana_decryption, v9, v5);
}
...
uint64_t __fastcall CriWareDecrypter__CallbackFromNative(intptr_t ptr1, const MethodInfo *method)
{
  if ( (byte_49F95A6 & 1) == 0 )
  {
    sub_1B64A00(&CriWareDecrypter_TypeInfo, method);
    byte_49F95A6 = 1;
  }
...
bool __fastcall CriWareDecrypter__Initialize(CriWareDecrypterConfig_o *config, const MethodInfo *method)
{
  ...
  return CriWareDecrypter__Initialize_30003028(
           config->fields.key,
...
bool __fastcall CriWareDecrypter__Initialize_30003028(
        System_String_o *key,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F95A5 & 1) == 0 )
  {
    sub_1B64A00(
      ...
      method);
    sub_1B64A00(&System_Convert_TypeInfo, v9, v10, v11, v12);
    sub_1B64A00(&CriFsPlugin_TypeInfo, v13, v14, v15, v16);
    sub_1B64A00(&Method_CriWareDecrypter_CallbackFromNative__, v17, v18, v19, v20);
    sub_1B64A00(&CriWareDecrypter_TypeInfo, v21, v22, v23, v24);
    sub_1B64A00(&System_IO_Path_TypeInfo, v25, v26, v27, v28);
    byte_49F95A5 = 1;
  }
  ...
  if ( key->fields._stringLength )
  {
    ...
    v32 = System_Convert__ToUInt64_62045548(key, 0LL) ^ 0xD47EB533AEF7E5LL;
  }
  ...
  v34 = (CriWareDecrypter_CallbackFromNativeDelegate_o *)sub_1B64C4C(CriWareDecrypter_CallbackFromNativeDelegate_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A32B4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A3264;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F95B0 & 1) == 0 )
  {
    sub_1B64A00(&IntPtr_TypeInfo, *(_QWORD *)&ptr1);
    byte_49F95B0 = 1;
  }
  v9[1] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( !sub_1B649B8(result, 0LL, method) )
    sub_1B64C5C(0LL, v3);
