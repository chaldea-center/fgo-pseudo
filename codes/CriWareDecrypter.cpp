        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_49B50E8 )
  {
    ...
    v11[4] = 0x200000000LL;
    v13 = 0;
    qword_49B50E8 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))sub_1B4D56C(
                                                                              v11,
  ...
  v9 = sub_1B4D564(func, enable_mana_decryption, func, *(_QWORD *)&obj, method);
  return qword_49B50E8(enable_atom_decryption, enable_mana_decryption, v9, v5);
}
...
uint64_t __fastcall CriWareDecrypter__CallbackFromNative(intptr_t ptr1, const MethodInfo *method)
{
  if ( (byte_49B50E6 & 1) == 0 )
  {
    sub_1B4CF90(&CriWareDecrypter_TypeInfo, method);
    byte_49B50E6 = 1;
  }
...
bool __fastcall CriWareDecrypter__Initialize(CriWareDecrypterConfig_o *config, const MethodInfo *method)
{
  ...
  return CriWareDecrypter__Initialize_29899404(
           config->fields.key,
...
bool __fastcall CriWareDecrypter__Initialize_29899404(
        System_String_o *key,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B50E5 & 1) == 0 )
  {
    sub_1B4CF90(
      ...
      method);
    sub_1B4CF90(&System_Convert_TypeInfo, v9, v10, v11, v12);
    sub_1B4CF90(&CriFsPlugin_TypeInfo, v13, v14, v15, v16);
    sub_1B4CF90(&Method_CriWareDecrypter_CallbackFromNative__, v17, v18, v19, v20);
    sub_1B4CF90(&CriWareDecrypter_TypeInfo, v21, v22, v23, v24);
    sub_1B4CF90(&System_IO_Path_TypeInfo, v25, v26, v27, v28);
    byte_49B50E5 = 1;
  }
  ...
  if ( key->fields._stringLength )
  {
    ...
    v32 = System_Convert__ToUInt64_62170960(key, 0LL) ^ 0xD47EB533AEF7E5LL;
  }
  ...
  v34 = (CriWareDecrypter_CallbackFromNativeDelegate_o *)sub_1B4D1DC(CriWareDecrypter_CallbackFromNativeDelegate_TypeInfo);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19926CC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_199267C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B50F0 & 1) == 0 )
  {
    sub_1B4CF90(&IntPtr_TypeInfo, *(_QWORD *)&ptr1);
    byte_49B50F0 = 1;
  }
  v9[1] = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( !sub_1B4CF48(result, 0LL, method) )
    sub_1B4D1EC(0LL, v3);
