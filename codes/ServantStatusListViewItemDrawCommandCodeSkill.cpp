        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFF096 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_11816/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, v8);
    byte_4AFF096 = 1;
  }
  idList = 0LL;
  v42 = 0LL;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11816/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_65;
  ...
  else
  {
    ...
    do
    {
      ...
      else
      {
        if ( v16 >= max_length )
LABEL_67:
          sub_1BC326C(baseSprite, v11, v12);
