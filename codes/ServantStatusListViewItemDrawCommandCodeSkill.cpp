        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD94CC & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_12097/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/);
    byte_4BD94CC = 1;
  }
  idList = 0LL;
  v39 = 0LL;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12097/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_65;
