        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB97E & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_11827/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, v8);
    byte_49FB97E = 1;
  }
  idList = 0LL;
  v41 = 0LL;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11827/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_65;
