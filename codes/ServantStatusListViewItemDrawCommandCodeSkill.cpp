        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3FB70 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_11933/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/);
    byte_4C3FB70 = 1;
  }
  idList = 0;
  v38 = 0;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11933/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, 0);
  if ( !explanationLabel )
    goto LABEL_65;
