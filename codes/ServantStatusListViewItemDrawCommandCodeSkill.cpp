        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3F72 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_11938/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/);
    byte_4CC3F72 = 1;
  }
  idList = 0;
  v39 = 0;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11938/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, 0);
  if ( !explanationLabel )
    goto LABEL_65;
