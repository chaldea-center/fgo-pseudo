        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.skillTitleRangeLabelList, (int32_t)v10, v11, v12);
  v13 = (struct UILabel_array *)sub_1B88658(
                                  UILabel___TypeInfo,
                                  (unsigned int)BalanceConfig_TypeInfo->static_fields->SvtSkillListMax);
  this->fields.skillExplanationLabelList = v13;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.skillExplanationLabelList, (int32_t)v13, v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57DE0 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_11878/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/);
    byte_4A57DE0 = 1;
  }
  idList = 0LL;
  v39 = 0LL;
  ...
  baseSprite = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11878/*"SERVANT_STATUS_EXPLANATION_SKILL_COMMAND_CODE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_65;
  UILabel__set_text(explanationLabel, (System_String_o *)baseSprite, 0LL);
  ServantStatusListViewItem__GetPassiveSkillInfo(item, &idList, &titleList, &v39, 0, 0LL);
  if ( !idList )
    return;
...
LABEL_67:
  ...
  if ( UnityEngine_Object__op_Inequality(baseCollider, 0LL, 0LL) )
  {
    ...
    v42.fields.y = v21;
    v42.fields.z = z;
    UnityEngine_BoxCollider__set_size((UnityEngine_BoxCollider_o *)baseSprite, v42, 0LL);
  }
  baseSprite = (UnityEngine_GameObject_o *)this->fields.baseSprite;
  if ( !baseSprite )
    goto LABEL_65;
  v22 = x == INFINITY ? 0x80000000 : (int)x;
  UIWidget__set_width((UIWidget_o *)baseSprite, v22, 0LL);
  baseSprite = (UnityEngine_GameObject_o *)this->fields.baseSprite;
  if ( !baseSprite )
    goto LABEL_65;
  v23 = v21 == INFINITY ? 0x80000000 : (int)v21;
  UIWidget__set_height((UIWidget_o *)baseSprite, v23, 0LL);
  ...
  if ( !baseSprite
    || (v28 = (float)(v24 >> 1),
        ...
        v43.fields.x = v25,
        v43.fields.z = v27,
        UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)baseSprite, v43, 0LL),
        (skillBaseList = this->fields.skillBaseList) == 0LL) )
  {
LABEL_65:
    sub_1B8880C(baseSprite, v9);
  }
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      v44.fields.y = v33;
      v44.fields.z = v30;
      UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)baseSprite, v44, 0LL);
      ...
      if ( !baseSprite )
        goto LABEL_65;
      SkillIconComponent__Set((SkillIconComponent_o *)baseSprite, idList->m_Items[v32 + 1], 0LL);
      skillTitleRangeLabelList = this->fields.skillTitleRangeLabelList;
      if ( !skillTitleRangeLabelList )
        goto LABEL_65;
      if ( v32 >= skillTitleRangeLabelList->max_length )
        goto LABEL_67;
      if ( !titleList )
        goto LABEL_65;
      ...
      if ( !baseSprite )
        goto LABEL_65;
      UIRangeLabel__Set((UIRangeLabel_o *)baseSprite, titleList->m_Items[v32], 0LL, 1, 0, 0LL);
      skillExplanationLabelList = this->fields.skillExplanationLabelList;
      if ( !skillExplanationLabelList )
        goto LABEL_65;
      if ( v32 >= skillExplanationLabelList->max_length )
        goto LABEL_67;
      if ( !v39 )
        goto LABEL_65;
      if ( v32 >= v39->max_length )
        goto LABEL_67;
