        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8E67 & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___, selBtnInfo);
  ...
  if ( !v10 )
  {
    ...
    v10 = System_Enum__TryParse_Int32Enum_(
            ...
            &result,
            (const MethodInfo_2ECC820 *)Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___);
