        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72F3C & 1) == 0 )
  {
    sub_1B90010(&Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___, selBtnInfo);
  ...
  if ( !v10 )
  {
    ...
    v10 = System_Enum__TryParse_Int32Enum_(
            ...
            &result,
            (const MethodInfo_2E97294 *)Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___);
