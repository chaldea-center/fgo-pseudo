        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E223 & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___);
  ...
  if ( !v8 )
  {
    ...
    v8 = System_Enum__TryParse_Int32Enum_(
           ...
           &result,
           (const MethodInfo_2E88980 *)Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___);
