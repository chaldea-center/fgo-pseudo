        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A9C9 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___);
  ...
  if ( !v8 )
  {
    ...
    v8 = System_Enum__TryParse_Int32Enum_(
           ...
           &result,
           (const MethodInfo_30D5494 *)Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___);
