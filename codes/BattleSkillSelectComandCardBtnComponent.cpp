        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FAF9 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___, selBtnInfo);
  ...
  if ( !v10 )
  {
    ...
    v10 = System_Enum__TryParse_Int32Enum_(
            ...
            &result,
            (const MethodInfo_30215E8 *)Method_System_Enum_TryParse_BattleSkillSelectComandCardBtnComponent_CommandCardType___);
