        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73197 & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1B90010(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4A73197 = 1;
  }
  ...
  if ( !v9 )
    sub_1B9026C(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1BE1FF0(v9, IFriendshipGauge_TypeInfo, 6LL);
  }
