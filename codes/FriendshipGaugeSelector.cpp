        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A591 & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1BD3458(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4B3A591 = 1;
  }
  ...
  if ( !v9 )
    sub_1BD36B4(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1C25438(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
