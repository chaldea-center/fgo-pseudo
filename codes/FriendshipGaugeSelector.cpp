        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CF5 & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1B64A00(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4A01CF5 = 1;
  }
  ...
  if ( !v9 )
    sub_1B64C5C(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1BB69E0(v9, IFriendshipGauge_TypeInfo, 6LL);
  }
