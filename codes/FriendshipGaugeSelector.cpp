        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7B4C & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1C13D24(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4BB7B4C = 1;
  }
  ...
  if ( !v9 )
    sub_1C13F80(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1C65D04(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
