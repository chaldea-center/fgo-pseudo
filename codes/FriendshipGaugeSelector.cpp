        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00CA0 & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1C2E12C(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4C00CA0 = 1;
  }
  ...
  if ( !v9 )
    sub_1C2E388(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1C8010C(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
