        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A51B09 & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1B863B8(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4A51B09 = 1;
  }
  ...
  if ( !v9 )
    sub_1B86614(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1BD6B4C(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
