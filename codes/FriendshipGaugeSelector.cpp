        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C254CE & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1C3B764(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4C254CE = 1;
  }
  ...
  if ( !v9 )
    sub_1C3B9C0(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1C8D744(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
