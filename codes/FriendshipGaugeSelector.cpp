        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4817A & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1BDB878(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4B4817A = 1;
  }
  ...
  if ( !v9 )
    sub_1BDBAD4(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1C2C00C(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
