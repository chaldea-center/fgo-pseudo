        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6A029 & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1BE4ACC(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4B6A029 = 1;
  }
  ...
  if ( !v9 )
    sub_1BE4D28(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1C36AAC(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
