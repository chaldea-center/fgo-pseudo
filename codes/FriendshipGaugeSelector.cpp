        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05751 & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1BC3008(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_4B05751 = 1;
  }
  ...
  if ( !v9 )
    sub_1BC3264(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1C13570(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
