        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E47E & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1B885B0(&IFriendshipGauge_TypeInfo);
    byte_4A5E47E = 1;
  }
  ...
  if ( !v9 )
    sub_1B8880C(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1BDA590(v9, IFriendshipGauge_TypeInfo, 6LL);
  }
