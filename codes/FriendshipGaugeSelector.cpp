        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BE40B & 1) == 0 )
  {
    this = (FriendshipGaugeSelector_o *)sub_1B4CF90(&IFriendshipGauge_TypeInfo, *(_QWORD *)&maxFriendShipRank);
    byte_49BE40B = 1;
  }
  ...
  if ( !v9 )
    sub_1B4D1EC(this, *(_QWORD *)&maxFriendShipRank);
  klass = v9->klass;
  ...
  {
LABEL_13:
    p_method = sub_1B9D724(v9, IFriendshipGauge_TypeInfo, 5LL);
  }
