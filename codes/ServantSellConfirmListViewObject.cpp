...
void ServantSellConfirmListViewObject__Awake(ServantSellConfirmListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E736B8 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_UnityEngine_GameObject_GetComponent_ServantSellConfirmListViewItemDraw___);
    byte_4E736B8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ServantSellConfirmListViewItemDraw___);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_32A8444 *)Method_UnityEngine_GameObject_GetComponent_ServantSellConfirmListViewObject___)) == 0 )
    {
...
bool ServantSellConfirmListViewObject__IsCanDrag(ServantSellConfirmListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E736BC & 1) == 0 )
  {
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&ServantSellConfirmListViewItem_TypeInfo);
    sub_1D0F0B4(&ServantSellConfirmListViewManager_TypeInfo);
    byte_4E736BC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E736C0 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantSellConfirmListViewItem_TypeInfo);
    sub_1D0F0B4(&ServantSellConfirmListViewManager_TypeInfo);
    sub_1D0F0B4(&Method_ServantSellConfirmListViewObject_OnClickSelect__);
    sub_1D0F0B4(&TutorialFlag_TypeInfo);
    sub_1D0F0B4(&StringLiteral_9985/*"OnClickSelectListView"*/);
    this = (ServantSellConfirmListViewObject_o *)sub_1D0F0B4(&StringLiteral_9978/*"OnClickLockModeItem"*/);
    byte_4E736C0 = 1;
  }
...
LABEL_14:
      ...
      if ( manager )
      {
        v9 = &StringLiteral_9985/*"OnClickSelectListView"*/;
...
LABEL_31:
    ...
    if ( monitor_high == 2 || monitor_high == 1 )
    {
      ...
      {
LABEL_24:
        v9 = &StringLiteral_9978/*"OnClickLockModeItem"*/;
    ...
    if ( (*((_BYTE *)Method_ServantSellConfirmListViewObject_OnClickSelect__ + 83) & 2) != 0 )
      v14 = (_QWORD *)sub_1D0F0CC(Method_ServantSellConfirmListViewObject_OnClickSelect__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    this = (ServantSellConfirmListViewObject_o *)sub_1D0F0B4(&ServantSellConfirmListViewManager_TypeInfo);
    byte_4E736C2 = 1;
  }
...
void ServantSellConfirmListViewObject__SetItem_36312628(
        ServantSellConfirmListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
