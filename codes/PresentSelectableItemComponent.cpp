        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1B21A & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_ItemMaster___, data);
    ...
    sub_1BCAFF8(&StringLiteral_24873/*"{0:N0}"*/, v17);
    sub_1BCAFF8(&StringLiteral_856/*"-"*/, v18);
    sub_1BCAFF8(&StringLiteral_10366/*"PRESENT_BOX_SELECTABLE_LIST_CURRENT_HOLD"*/, v19);
    sub_1BCAFF8(&StringLiteral_327/*" ×{0}"*/, v20);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.dialog, (int32_t)dlg, v22, v23);
  maskImg = this->fields.maskImg;
  if ( !maskImg )
    goto LABEL_53;
  ...
  maskImg = LocalizationManager__Get((System_String_o *)StringLiteral_10366/*"PRESENT_BOX_SELECTABLE_LIST_CURRENT_HOLD"*/, 0LL);
  if ( !currentInfoLb )
    goto LABEL_53;
            ...
            if ( maskImg )
            {
              ...
              if ( maskImg )
              {
                ...
                if ( v36 )
                {
                  ...
                  maskImg = System_String__Concat_62450424(name, v40, 0LL);
                  if ( itemNameLb )
                  {
                      ...
                      if ( *p_itemEnt )
                      {
                        if ( MasterData_object )
                        {
                          ...
                          if ( maskImg )
                          {
                            ...
                            maskImg = System_String__Format((System_String_o *)StringLiteral_24873/*"{0:N0}"*/, v47, 0LL);
                            if ( currentNumLb )
                            {
