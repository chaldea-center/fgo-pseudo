        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AFB84 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_10576/*"PRESENT_BOX_SELECTABLE_LIST_CURRENT_HOLD"*/);
    sub_B52984(&StringLiteral_283/*" ×{0}"*/);
  ...
  maskImg = (int64_t)LocalizationManager__Get((System_String_o *)StringLiteral_10576/*"PRESENT_BOX_SELECTABLE_LIST_CURRENT_HOLD"*/, 0LL);
  if ( !currentInfoLb )
    goto LABEL_53;
              ...
              if ( maskImg )
              {
                ...
                if ( v27 )
                {
                  ...
                  else
                  {
                    ...
                    v31 = System_String__Format((System_String_o *)StringLiteral_283/*" ×{0}"*/, v30, 0LL);
                  }
                  maskImg = (int64_t)System_String__Concat_44568316(name, v31, 0LL);
                  if ( itemNameLb )
                  {
                      ...
                      if ( *p_itemEnt )
                      {
                        if ( MasterData_WarQuestSelectionMaster )
                        {
                          ...
                          if ( maskImg )
                          {
                            ...
                            maskImg = (int64_t)System_String__Format((System_String_o *)StringLiteral_23720/*"{0:N0}"*/, v35, 0LL);
                            if ( currentNumLb )
                            {
                              ...
                              if ( spendNumLb )
                              {
                                ...
                                if ( maskImg )
                                {
                                  ...
                                  v37 = (UIWidget_o *)this->fields.spendNumLb;
                                  v38 = requireNum <= ticketsHave;
