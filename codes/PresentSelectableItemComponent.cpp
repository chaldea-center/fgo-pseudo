        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3482 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_ItemMaster___, data);
    ...
    sub_1C13D24(&StringLiteral_918/*"-"*/, v20);
    sub_1C13D24(&StringLiteral_10632/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_DETAIL_UNDER"*/, v21);
    sub_1C13D24(&StringLiteral_355/*" ×{0}"*/, v22);
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.dialog, (int64_t)dlg, v24, v25, v26, v27, v28, v29);
  maskImg = this->fields.maskImg;
  if ( !maskImg )
    goto LABEL_53;
  ...
  maskImg = LocalizationManager__Get((System_String_o *)StringLiteral_10632/*"PRESENT_BOX_SELECTABLE_BULK_CONFIRM_DLG_DETAIL_UNDER"*/, 0LL);
  if ( !currentInfoLb )
    goto LABEL_53;
            ...
            if ( maskImg )
            {
              ...
              if ( maskImg )
              {
                ...
                if ( v41 )
                {
                  ...
                  maskImg = System_String__Concat_62967944(name, v45, 0LL);
                  if ( itemNameLb )
                  {
                      ...
                      if ( *p_itemEnt )
                      {
                        if ( MasterData_object )
                        {
                          ...
                          if ( maskImg )
                          {
                            ...
                            maskImg = System_String__Format((System_String_o *)StringLiteral_25371/*"{0:D2}:{1:D2}:{2:D2}[-]"*/, v52, 0LL);
                            if ( currentNumLb )
                            {
