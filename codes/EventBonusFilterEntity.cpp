        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC3EE & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_DataMasterBase_EventBonusFilterGroupInfoMaster__EventBonusFilterGroupInfoEntity__int__TryGetEntity__);
  ...
  if ( type == 5 )
  {
    ...
    Master_object = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_EventBonusFilterGroupInfoMaster___);
    if ( !Master_object )
      goto LABEL_17;
    Master_object = (Il2CppObject *)DataMasterBase_object__object__int___TryGetEntity(
                                      ...
                                      &entity,
                                      this->fields.value,
                                      (const MethodInfo_325BE14 *)Method_DataMasterBase_EventBonusFilterGroupInfoMaster__EventBonusFilterGroupInfoEntity__int__TryGetEntity__);
...
LABEL_17:
      sub_1C22094(Master_object, value);
    }
LABEL_16:
    if ( v3 )
      return System_Collections_Generic_List_int___ToArray(
  ...
  if ( type != 3 )
  {
    if ( type == 2 )
    {
      ...
      if ( max_length >= 1 )
      {
        ...
        {
          if ( v16 >= max_length )
            sub_1C2209C(MasterData_object, svtId);
          v17 = v15->m_Items[v16];
          if ( !v17 )
            goto LABEL_28;
          if ( !v3 )
    ...
    if ( v3 )
      return System_Collections_Generic_List_int___ToArray(
               ...
               (const MethodInfo_3633B48 *)Method_System_Collections_Generic_List_int__ToArray__);
LABEL_28:
    sub_1C22094(MasterData_object, svtId);
  }
LABEL_6:
  if ( !v3 )
    goto LABEL_28;
