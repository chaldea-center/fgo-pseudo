        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2692 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_DataMasterBase_EventBonusFilterGroupInfoMaster__EventBonusFilterGroupInfoEntity__int__TryGetEntity__);
  ...
  if ( type == 5 )
  {
    ...
    Master_WarQuestSelectionMaster = DataManager__GetMaster_WarQuestSelectionMaster_((const MethodInfo_1A4F124 *)Method_DataManager_GetMaster_EventBonusFilterGroupInfoMaster___);
    ...
    Master_WarQuestSelectionMaster = (WarQuestSelectionMaster_o *)DataMasterBase_WarMaster__WarEntity__int___TryGetEntity(
                                                                    ...
                                                                    &entity,
                                                                    this->fields.value,
                                                                    (const MethodInfo_23E2334 *)Method_DataMasterBase_EventBonusFilterGroupInfoMaster__EventBonusFilterGroupInfoEntity__int__TryGetEntity__);
  ...
  if ( type != 3 )
  {
    if ( type == 2 )
    {
      ...
      if ( v10 >= 1 )
      {
        ...
        do
        {
          if ( v12 >= v10 )
          {
            v15 = sub_B52A88(MasterData_WarQuestSelectionMaster);
            sub_B52A28(v15, 0LL);
          }
    ...
    if ( v3 )
      return System_Collections_Generic_List_int___ToArray(
               ...
               (const MethodInfo_30590BC *)Method_System_Collections_Generic_List_int__ToArray__);
LABEL_23:
    sub_B52A5C(MasterData_WarQuestSelectionMaster, v5);
  }
LABEL_6:
  if ( !v3 )
    goto LABEL_23;
