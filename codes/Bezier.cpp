...
UnityEngine_Vector3_o Bezier__GetFirstDerivative_42270812(
        UnityEngine_Vector3_o p0,
        UnityEngine_Vector3_o p1,
        UnityEngine_Vector3_o p2,
        ...
        const MethodInfo *method)
{
  ...
  result.fields.x = (float)((float)(t - p2.fields.x) * v10)
                  + (float)((float)((float)(p1.fields.x - p0.fields.x) * v11)
                          + (float)((float)(p2.fields.x - p1.fields.x) * v12));
  result.fields.y = (float)((float)(*(&t + 1) - p2.fields.y) * v10)
                  + (float)((float)((float)(p1.fields.y - p0.fields.y) * v11)
                          + (float)((float)(p2.fields.y - p1.fields.y) * v12));
  result.fields.z = (float)((float)(v16 - p2.fields.z) * v10) + (float)((float)(v7 * v11) + (float)(v8 * v12));
  return result;
}
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_Vector3_o Bezier__GetPoint_42270548(
        UnityEngine_Vector3_o p0,
        UnityEngine_Vector3_o p1,
        UnityEngine_Vector3_o p2,
        UnityEngine_Vector3_o p3,
        ...
        const MethodInfo *method)
{
  ...
  result.fields.x = v9
                  + (float)((float)(p2.fields.x * v14) + (float)((float)(p0.fields.x * v12) + (float)(p1.fields.x * v13)));
  result.fields.y = v10
                  + (float)((float)(p2.fields.y * v14) + (float)((float)(p0.fields.y * v12) + (float)(p1.fields.y * v13)));
  result.fields.z = v11
                  + (float)((float)(p2.fields.z * v14) + (float)((float)(p0.fields.z * v12) + (float)(p1.fields.z * v13)));
  return result;
}