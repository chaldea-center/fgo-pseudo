...
void __fastcall ItemDetailInfoComponent__Close(ItemDetailInfoComponent_o *this, const MethodInfo *method)
{
  ...
  ItemDetailInfoComponent__Close_32480428(this, 0LL, v2);
}


void __fastcall ItemDetailInfoComponent__Close_32480428(
        ItemDetailInfoComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17671 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_ItemDetailInfoComponent_EndClose__, v6);
    byte_4B17671 = 1;
  }
  ...
  System_Action___ctor(v7, (Il2CppObject *)this, Method_ItemDetailInfoComponent_EndClose__, 0LL);
...
void __fastcall ItemDetailInfoComponent__Init(ItemDetailInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !itemDetailInfo )
LABEL_16:
    sub_1BCB254(itemDetailInfo, method);
  UnityEngine_GameObject__SetActive(itemDetailInfo, 0, 0LL);
  this->fields.state = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1766E & 1) == 0 )
  {
    sub_1BCAFF8(&System_Action_TypeInfo, itemData);
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UIPanel___, v9);
    sub_1BCAFF8(&Method_ItemDetailInfoComponent_EndOpen__, v10);
    byte_4B1766E = 1;
  }
  if ( !this->fields.state )
  {
    ...
    WrapControlText__textAdjust(
      ...
      0LL);
    this->fields.state = 1;
    ItemDetailInfoComponent__setBtnInfoActive(this, v15);
    v16 = (System_Action_o *)sub_1BCB244(System_Action_TypeInfo);
    System_Action___ctor(v16, (Il2CppObject *)this, Method_ItemDetailInfoComponent_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1766F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_ItemDetailInfoComponent_EndOpen__, v9);
    byte_4B1766F = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( !gameObject
      || (UnityEngine_GameObject__SetActive(gameObject, 1, 0LL),
          this->fields.callbackFunc = callback,
          sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, v12, v13),
          (gameObject = (UnityEngine_GameObject_o *)this->fields.itemNameLabel) == 0LL) )
    {
    ...
    this->fields.state = 1;
    ItemDetailInfoComponent__setBtnInfoActive(this, v14);
    v15 = (System_Action_o *)sub_1BCB244(System_Action_TypeInfo);
    System_Action___ctor(v15, (Il2CppObject *)this, Method_ItemDetailInfoComponent_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&System_Action_TypeInfo, name);
    sub_1BCAFF8(&Method_ItemDetailInfoComponent_EndOpen__, v13);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v14);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v15);
    sub_1BCAFF8(&StringLiteral_5777/*"EXTERNAL_PAYSTONE_INFO_TITLE"*/, v16);
    sub_1BCAFF8(&StringLiteral_6464/*"FREESTONE_INFO_TITLE"*/, v17);
    sub_1BCAFF8(&StringLiteral_10268/*"PAYSTONE_INFO_TITLE"*/, v18);
    sub_1BCAFF8(&StringLiteral_12262/*"STONE_INFO_NOTICE"*/, v19);
    byte_4B17670 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( gameObject )
    {
      UnityEngine_GameObject__SetActive(gameObject, 1, 0LL);
      this->fields.callbackFunc = callback;
      sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, v22, v23);
        ...
        if ( gameObject )
        {
          ...
          if ( gameObject )
          {
            ...
            gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_10268/*"PAYSTONE_INFO_TITLE"*/,
                                                       0LL);
              ...
              if ( userData )
              {
                if ( userExternalPaymentStone )
                {
                  ...
                  if ( payStoneNumLabel )
                  {
                    ...
                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                               (System_String_o *)StringLiteral_6464/*"FREESTONE_INFO_TITLE"*/,
                                                               0LL);
                    if ( freeStoneTitleLabel )
                    {
                      ...
                      if ( freeStoneNumLabel )
                      {
                        ...
                        {
                          v29 = this->fields.externalPayStoneTitleLabel;
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                     (System_String_o *)StringLiteral_5777/*"EXTERNAL_PAYSTONE_INFO_TITLE"*/,
                                                                     0LL);
                          if ( !v29 )
                            goto LABEL_34;
                        ...
                        if ( UnityEngine_Object__op_Inequality(externalPayStoneNumLabel, 0LL, 0LL) )
                        {
                          v31 = this->fields.externalPayStoneNumLabel;
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                   (System_String_o *)StringLiteral_12262/*"STONE_INFO_NOTICE"*/,
                                                                   0LL);
                        if ( stoneNoticeLabel )
                        {
                          UILabel__set_text(stoneNoticeLabel, (System_String_o *)gameObject, 0LL);
                          this->fields.state = 1;
                          ItemDetailInfoComponent__setBtnInfoActive(this, v34);
                          v35 = (System_Action_o *)sub_1BCB244(System_Action_TypeInfo);
                          System_Action___ctor(v35, (Il2CppObject *)this, Method_ItemDetailInfoComponent_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1766A & 1) == 0 )
  {
    sub_1BCAFF8(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, value);
    byte_4B1766A = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (ItemDetailInfoComponent_o *)sub_1BCB514(v8);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B17672 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_7578/*"InfoWindow/CloseBtn"*/, method);
    byte_4B17672 = 1;
  }
  return (System_String_o *)StringLiteral_7578/*"InfoWindow/CloseBtn"*/;
}
...
LABEL_9:
    sub_1BCB254(stoneDetailBtnObject, method);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0DEAC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0DE64;
}
