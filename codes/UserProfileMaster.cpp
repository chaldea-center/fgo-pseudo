void __fastcall UserProfileMaster___ctor(UserProfileMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E34EA & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_UserProfileMaster__UserProfileEntity__long___ctor__, method);
    byte_48E34EA = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    97,
    (const MethodInfo_2FE6BB8 *)Method_DataMasterBase_UserProfileMaster__UserProfileEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E34EC & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long__GetEntity__, v5);
    sub_1B00CCC(&Method_System_Collections_Generic_List_OtherUserGameEntity__Add__, v6);
    sub_1B00CCC(&Method_System_Collections_Generic_List_OtherUserGameEntity__ToArray__, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_OtherUserGameEntity___ctor__, v8);
    sub_1B00CCC(&System_Collections_Generic_List_OtherUserGameEntity__TypeInfo, v9);
    sub_1B00CCC(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v10);
    sub_1B00CCC(&UserProfileEntity_TypeInfo, v11);
    byte_48E34EC = 1;
  }
  ...
  v15 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_OtherUserGameEntity__TypeInfo);
...
int32_t __fastcall UserProfileMaster__GetOtherUserSum(UserProfileMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E34EB & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, method);
    sub_1B00CCC(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Item__, v3);
    sub_1B00CCC(&UserProfileEntity_TypeInfo, v4);
    byte_48E34EB = 1;
  }
