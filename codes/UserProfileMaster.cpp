void __fastcall UserProfileMaster___ctor(UserProfileMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49BBCBA & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_UserProfileMaster__UserProfileEntity__long___ctor__, method);
    byte_49BBCBA = 1;
  }
  DataMasterBase_object__object__long____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    102,
    (const MethodInfo_319DBD4 *)Method_DataMasterBase_UserProfileMaster__UserProfileEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBCBC & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_ObjectModel_Collection_UserProfileEntity__get_Count__, method);
    sub_1B4CF90(&Method_System_Collections_ObjectModel_Collection_UserProfileEntity__get_Item__, v3);
    sub_1B4CF90(&Method_DataManager_GetMasterData_OtherUserGameMaster___, v4);
    sub_1B4CF90(&Method_DataMasterBase_OtherUserGameMaster__OtherUserGameEntity__long__GetEntity__, v5);
  ...
  v14 = (System_Collections_Generic_List_object__o *)sub_1B4D1DC(System_Collections_Generic_List_OtherUserGameEntity__TypeInfo);
  ...
  Instance = (void *)System_Collections_ObjectModel_Collection_object___get_Count(
                       ...
                       (const MethodInfo_313AEE4 *)Method_System_Collections_ObjectModel_Collection_UserProfileEntity__get_Count__);
  if ( (int)Instance >= 1 )
  {
    v15 = (int)Instance;
    v16 = 0;
    while ( 1 )
    {
      ...
      Instance = System_Collections_ObjectModel_Collection_object___get_Item(
                   (System_Collections_ObjectModel_Collection_T__o *)Instance,
                   v16,
                   (const MethodInfo_313AF74 *)Method_System_Collections_ObjectModel_Collection_UserProfileEntity__get_Item__);
      if ( Instance )
      {
