        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A5B & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Linq_Enumerable_Select_int__BattleServantData___, servantUniqueIdArray);
    sub_1BAB41C(&Method_System_Linq_Enumerable_Where_BattleServantData___, v5);
    sub_1BAB41C(&System_Func_int__BattleServantData__TypeInfo, v6);
    sub_1BAB41C(&System_Func_BattleServantData__bool__TypeInfo, v7);
    sub_1BAB41C(&Method_TargetAggregator__BattleServantEnumerable_b__18_0__, v8);
    sub_1BAB41C(&Method_TargetAggregator___c__BattleServantEnumerable_b__18_1__, v9);
    sub_1BAB41C(&TargetAggregator___c_TypeInfo, v10);
    byte_4AB8A5B = 1;
  }
  v11 = (System_Func_T__TResult__o *)sub_1BAB668(System_Func_int__BattleServantData__TypeInfo);
  ...
  if ( !_9__18_1 )
  {
    ...
    _9__18_1 = (System_Func_object__bool__o *)sub_1BAB668(System_Func_BattleServantData__bool__TypeInfo);
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__18_1, (int32_t)_9__18_1, v18, v19);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A5D & 1) == 0 )
  {
    sub_1BAB41C(&Method_System_Linq_Enumerable_FirstOrDefault_BattleServantData___, servantUniqueIdArray);
    byte_4AB8A5D = 1;
  }
  ...
  result = (BattleServantData_o *)System_Linq_Enumerable__FirstOrDefault_object_(
                                    v11,
                                    (const MethodInfo_2EE74A0 *)Method_System_Linq_Enumerable_FirstOrDefault_BattleServantData___);
  if ( result )
    return result;
  args = this->fields.args;
  if ( !args || (result = (BattleServantData_o *)args->fields._battleData_k__BackingField) == 0LL )
LABEL_8:
    sub_1BAB678(result, v10);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)args, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A5C & 1) == 0 )
  {
    sub_1BAB41C(&int___TypeInfo, targetServant);
    byte_4AB8A5C = 1;
  }
  if ( !targetServant )
...
bool __fastcall TargetAggregator__get_IsOpponentTargetOnly(TargetAggregator_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A5A & 1) == 0 )
  {
    ...
    this = (TargetAggregator_o *)sub_1BAB41C(&Method_System_Nullable_bool__get_Value__, v5);
    byte_4AB8A5A = 1;
  }
  ...
  return System_Nullable_bool___get_Value(v12, (const MethodInfo_3666A94 *)Method_System_Nullable_bool__get_Value__);
}
        ...
        const MethodInfo *method)
{
  ...
  *(&v14[-1].fields._ptTargetId_k__BackingField + 1) = targetId;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)v14, (int32_t)battleTargetArgs, v17, v18);
}
...
void __fastcall TargetAggregator___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB8A5E & 1) == 0 )
  {
    sub_1BAB41C(&TargetAggregator___c_TypeInfo, v1);
    byte_4AB8A5E = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(TargetAggregator___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  TargetAggregator___c_TypeInfo->static_fields->__9 = (struct TargetAggregator___c_o *)v2;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)TargetAggregator___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
