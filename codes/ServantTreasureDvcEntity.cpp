        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22919 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataManager_GetMasterData_TreasureDvcMaster___, tdName);
    sub_1C3B764(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v18);
  ...
  *tdName = unknownNameText;
  sub_1C3B708((PartyOrganizationUtility_o *)tdName, (int64_t)unknownNameText, v26, v27, v28, v29, v30, v31);
  *tdExplanation = (System_String_o *)StringLiteral_1/*""*/;
  sub_1C3B708((PartyOrganizationUtility_o *)tdExplanation, (int64_t)StringLiteral_1/*""*/, v35, v36, v37, v38, v39, v40);
  *maxLv = 0;
  *tdGuageCount = 0;
  return 0;
}
...
int32_t __fastcall ServantTreasureDvcEntity__getLevelMax(ServantTreasureDvcEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22917 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DataMasterBase_TreasureDvcMaster__TreasureDvcEntity__int__GetEntity__, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22918 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DataManager_GetMasterData_ServantTreasureDeviceReleaseMaster___, v14);
  ...
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2FF0204 *)Method_DataManager_GetMasterData_ServantTreasureDeviceReleaseMaster___)) == 0LL )
  {
