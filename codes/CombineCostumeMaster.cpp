void __fastcall CombineCostumeMaster___ctor(CombineCostumeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B01DBB & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_CombineCostumeMaster__CombineCostumeEntity__string___ctor__, method);
    byte_4B01DBB = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    209,
    (const MethodInfo_32B1804 *)Method_DataMasterBase_CombineCostumeMaster__CombineCostumeEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  entity = 0LL;
  *itemIds = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)itemIds, 0, costumeId, (const MethodInfo *)itemIds);
  *itemNums = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)itemNums, 0, v13, v14);
  *qp = 0;
  ...
  if ( v16 )
  {
    if ( !entity
      || (v20 = entity->fields.itemIds,
          *itemIds = v20,
          sub_1BC2FAC((CGThumbnailListItem_o *)itemIds, (int32_t)v20, v18, v19),
          !entity)
      || (v23 = entity->fields.itemNums,
          *itemNums = v23,
          sub_1BC2FAC((CGThumbnailListItem_o *)itemNums, (int32_t)v23, v21, v22),
          !entity) )
    {
      sub_1BC3264(v16, v17);
    }
        ...
        const MethodInfo *method)
{
  ...
  return (CombineCostumeEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_32B3B28 *)Method_DataMasterBase_CombineCostumeMaster__CombineCostumeEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01DBC & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_UserItemMaster___, *(_QWORD *)&svtId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01DBA & 1) == 0 )
  {
    sub_1BC3008(&Method_DataMasterBase_CombineCostumeMaster__CombineCostumeEntity__string__TryGetEntity__, entity);
    byte_4B01DBA = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32B3B74 *)Method_DataMasterBase_CombineCostumeMaster__CombineCostumeEntity__string__TryGetEntity__);
}