        ...
        const MethodInfo *method)
{
  ...
  *sprite = 0LL;
  sub_1C3B708((PartyOrganizationUtility_o *)sprite, 0LL, *(int64_t *)&index, (int32_t)method, v4, v5, v6, v7);
  ...
  if ( max_length > index )
  {
    ...
    *sprite = v21;
    sub_1C3B708((PartyOrganizationUtility_o *)sprite, (int64_t)v21, v13, v14, v15, v16, v17, v18);
  }
