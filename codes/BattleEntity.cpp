        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E24AD & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_QuestMaster___, qEnt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E24AF & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_QuestPhaseMaster___, questPhaseEnt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E24AE & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_ReprintStageMaster___, *(_QWORD *)&waveCnt);
    sub_1B00CCC(&Method_DataManager_GetMasterData_StageMaster___, v5);
  ...
  if ( !result || this->fields.mCachedStageWave != waveCnt )
  {
    ...
    SelectableQuestPhase = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_35FBBF0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    SelectableQuestPhase = DataManager__GetMasterData_object_(
                             (DataManager_o *)SelectableQuestPhase,
                             (const MethodInfo_2D62C10 *)Method_DataManager_GetMasterData_StageMaster___);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    ...
    if ( !*p_mStageEnt )
    {
      ...
      SelectableQuestPhase = DataManager__GetMasterData_object_(
                               (DataManager_o *)SelectableQuestPhase,
                               (const MethodInfo_2D62C10 *)Method_DataManager_GetMasterData_ReprintStageMaster___);
      entity = 0LL;
      if ( !SelectableQuestPhase )
        goto LABEL_21;
...
LABEL_21:
        sub_1B00F28(SelectableQuestPhase, v11);
      }
    }
    return *p_mStageEnt;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E24B0 & 1) == 0 )
  {
    sub_1B00CCC(&Method_System_Array_Find_CommandCodeInfo___, userCommandCodeId);
    sub_1B00CCC(&System_Predicate_CommandCodeInfo__TypeInfo, v5);
    sub_1B00CCC(&Method_BattleEntity___c__DisplayClass31_0__getUserCommandCode_b__0__, v6);
    sub_1B00CCC(&BattleEntity___c__DisplayClass31_0_TypeInfo, v7);
    byte_48E24B0 = 1;
  }
  v8 = (Il2CppObject *)sub_1B00F18(BattleEntity___c__DisplayClass31_0_TypeInfo);
  ...
  return (CommandCodeInfo_o *)System_Array__Find_object_(
                                ...
                                (const MethodInfo_2E432F8 *)Method_System_Array_Find_CommandCodeInfo___);
}
