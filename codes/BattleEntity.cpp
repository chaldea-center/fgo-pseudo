        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC1A9 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataManager_GetMasterData_ReprintStageMaster___);
    sub_1C21E38(&Method_DataManager_GetMasterData_StageMaster___);
    sub_1C21E38(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4BDC1A9 = 1;
  }
  ...
  if ( !result || this->fields.mCachedStageWave != waveCnt )
  {
    ...
    SelectableQuestPhase = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    SelectableQuestPhase = DataManager__GetMasterData_object_(
                             (DataManager_o *)SelectableQuestPhase,
                             (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_StageMaster___);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    ...
    if ( !*p_mStageEnt )
    {
      ...
      SelectableQuestPhase = DataManager__GetMasterData_object_(
                               (DataManager_o *)SelectableQuestPhase,
                               (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_ReprintStageMaster___);
      entity = 0LL;
      if ( !SelectableQuestPhase )
        goto LABEL_21;
...
LABEL_21:
        sub_1C22094(SelectableQuestPhase, v9);
      }
    }
    return *p_mStageEnt;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDC1AB & 1) == 0 )
  {
    sub_1C21E38(&Method_System_Array_Find_CommandCodeInfo___);
    sub_1C21E38(&System_Predicate_CommandCodeInfo__TypeInfo);
    sub_1C21E38(&Method_BattleEntity___c__DisplayClass31_0__getUserCommandCode_b__0__);
    sub_1C21E38(&BattleEntity___c__DisplayClass31_0_TypeInfo);
    byte_4BDC1AB = 1;
  }
  v5 = (Il2CppObject *)sub_1C22084(BattleEntity___c__DisplayClass31_0_TypeInfo);
  ...
  if ( !userCommandCode )
    return 0LL;
  v9 = (System_Predicate_object__o *)sub_1C22084(System_Predicate_CommandCodeInfo__TypeInfo);
  ...
  return (CommandCodeInfo_o *)System_Array__Find_object_(
                                ...
                                (const MethodInfo_30AAD74 *)Method_System_Array_Find_CommandCodeInfo___);
}
...
bool __fastcall BattleEntity__isDefeatCount(BattleEntity_o *this, const MethodInfo *method)
{
  ...
  if ( !Instance
    ...
    || (Instance = DataMasterBase_object__object__int___GetEntity(
                     (DataMasterBase_TMaster__TEntity__PKType__o *)Instance,
                     this->fields.eventId,
                     (const MethodInfo_325BDC8 *)Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__)) == 0LL )
  {
