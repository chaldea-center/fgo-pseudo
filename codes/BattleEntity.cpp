        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01C6A & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_QuestMaster___, qEnt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01C6C & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_QuestPhaseMaster___, questPhaseEnt);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01C6B & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_ReprintStageMaster___, *(_QWORD *)&waveCnt);
    sub_1BC3008(&Method_DataManager_GetMasterData_StageMaster___, v5);
  ...
  if ( !result || this->fields.mCachedStageWave != waveCnt )
  {
    ...
    SelectableQuestPhase = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    SelectableQuestPhase = DataManager__GetMasterData_object_(
                             (DataManager_o *)SelectableQuestPhase,
                             (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_StageMaster___);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    ...
    if ( !*p_mStageEnt )
    {
      ...
      SelectableQuestPhase = DataManager__GetMasterData_object_(
                               (DataManager_o *)SelectableQuestPhase,
                               (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_ReprintStageMaster___);
      entity = 0LL;
      if ( !SelectableQuestPhase )
        goto LABEL_21;
...
LABEL_21:
        sub_1BC3264(SelectableQuestPhase, v11);
      }
    }
    return *p_mStageEnt;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B01C6D & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Array_Find_CommandCodeInfo___, userCommandCodeId);
    sub_1BC3008(&System_Predicate_CommandCodeInfo__TypeInfo, v5);
    sub_1BC3008(&Method_BattleEntity___c__DisplayClass32_0__getUserCommandCode_b__0__, v6);
    sub_1BC3008(&BattleEntity___c__DisplayClass32_0_TypeInfo, v7);
    byte_4B01C6D = 1;
  }
  v8 = (Il2CppObject *)sub_1BC3254(BattleEntity___c__DisplayClass32_0_TypeInfo);
  ...
  if ( !userCommandCode )
    return 0LL;
  v12 = (System_Predicate_object__o *)sub_1BC3254(System_Predicate_CommandCodeInfo__TypeInfo);
  ...
  return (CommandCodeInfo_o *)System_Array__Find_object_(
                                ...
                                (const MethodInfo_30FE114 *)Method_System_Array_Find_CommandCodeInfo___);
}
