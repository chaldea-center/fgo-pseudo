...
StageEntity_o *BattleEntity__GetStageEntityAtWave(BattleEntity_o *this, int32_t waveCnt, const MethodInfo *method)
{
  ...
  if ( (byte_4C56981 & 1) == 0 )
  {
    sub_1C3E564(&Method_DataManager_GetMasterData_ReprintStageMaster___);
    sub_1C3E564(&Method_DataManager_GetMasterData_StageMaster___);
    sub_1C3E564(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C56981 = 1;
  }
  ...
  if ( !result || this->fields.mCachedStageWave != waveCnt )
  {
    ...
    SelectableQuestPhase = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    SelectableQuestPhase = DataManager__GetMasterData_object_(
                             (DataManager_o *)SelectableQuestPhase,
                             (const MethodInfo_30F9A70 *)Method_DataManager_GetMasterData_StageMaster___);
    if ( !SelectableQuestPhase )
      goto LABEL_21;
    ...
    if ( !*p_mStageEnt )
    {
      ...
      SelectableQuestPhase = DataManager__GetMasterData_object_(
                               (DataManager_o *)SelectableQuestPhase,
                               (const MethodInfo_30F9A70 *)Method_DataManager_GetMasterData_ReprintStageMaster___);
      entity = 0;
      if ( !SelectableQuestPhase )
        goto LABEL_21;
...
LABEL_21:
        sub_1C3E7C0(SelectableQuestPhase, v9);
      }
    }
    return *p_mStageEnt;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C56983 & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Array_Find_CommandCodeInfo___);
    sub_1C3E564(&System_Predicate_CommandCodeInfo__TypeInfo);
    sub_1C3E564(&Method_BattleEntity___c__DisplayClass32_0__getUserCommandCode_b__0__);
    sub_1C3E564(&BattleEntity___c__DisplayClass32_0_TypeInfo);
    byte_4C56983 = 1;
  }
  v5 = (Il2CppObject *)sub_1C3E7B0(BattleEntity___c__DisplayClass32_0_TypeInfo);
  ...
  if ( !userCommandCode )
    return 0;
  v9 = (System_Predicate_object__o *)sub_1C3E7B0(System_Predicate_CommandCodeInfo__TypeInfo);
  ...
  return (CommandCodeInfo_o *)System_Array__Find_object_(
                                ...
                                (const MethodInfo_31FEA98 *)Method_System_Array_Find_CommandCodeInfo___);
}
