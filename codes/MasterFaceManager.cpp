void __fastcall MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_4B011B6 & 1) == 0 )
  {
    sub_1BC3008(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__, method);
    byte_4B011B6 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_38E0160 *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011B4 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___, parent);
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v6);
    sub_1BC3008(&StringLiteral_14610/*"UIMasterFace"*/, v7);
    byte_4B011B4 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14610/*"UIMasterFace"*/, 0LL);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreateLocal_39706684(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011B5 & 1) == 0 )
  {
    sub_1BC3008(&string___TypeInfo, parent);
    sub_1BC3008(&StringLiteral_856/*"-"*/, v15);
    sub_1BC3008(&StringLiteral_754/*")"*/, v16);
    sub_1BC3008(&StringLiteral_14611/*"UIMasterFace("*/, v17);
    byte_4B011B5 = 1;
  }
  ...
  Local = (char *)sub_1BC30B0(string___TypeInfo, 5LL);
  if ( !Local )
    goto LABEL_13;
  v24 = Local;
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v25 = StringLiteral_14611/*"UIMasterFace("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14611/*"UIMasterFace("*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(Local + 32), v25, v22, v23);
  Local = (char *)System_Int32__ToString((int32_t)&v34, 0LL);
  if ( *((_DWORD *)v24 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v24 + 5) = Local;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v24 + 40), (int32_t)Local, v22, v26);
  if ( *((_DWORD *)v24 + 6) <= 2u
    || (v28 = (int)StringLiteral_856/*"-"*/,
        *((_QWORD *)v24 + 6) = StringLiteral_856/*"-"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v24 + 48), v28, v22, v27),
        Local = (char *)System_Int32__ToString((int32_t)&v33, 0LL),
        *((_DWORD *)v24 + 6) <= 3u)
    || (*((_QWORD *)v24 + 7) = Local,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v24 + 56), (int32_t)Local, v22, v29),
        *((_DWORD *)v24 + 6) <= 4u) )
  {
LABEL_12:
    sub_1BC326C(Local, v19, v22);
  }
  v31 = StringLiteral_754/*")"*/;
  *((_QWORD *)v24 + 8) = StringLiteral_754/*")"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v24 + 64), v31, v22, v30);
  Local = (char *)System_String__Concat_62389164((System_String_array *)v24, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1BC3264(Local, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011B2 & 1) == 0 )
  {
    sub_1BC3008(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__, method);
    byte_4B011B2 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1BC3264(0LL, v4);
...
// local variable allocation has failed, the output may be wrong!
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreatePrefab_39706516(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011B3 & 1) == 0 )
  {
    sub_1BC3008(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__, *(_QWORD *)&dispType);
    byte_4B011B3 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1BC3264(0LL, v16);
  return MasterFaceManager__CreateLocal_39706684(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B011AF & 1) == 0 )
  {
    sub_1BC3008(&AssetManager_TypeInfo, *(_QWORD *)&genderType);
    byte_4B011AF = 1;
  }
  AssetName = MasterFaceManager__GetAssetName(dispType, genderType, equipId, (const MethodInfo *)callback);
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__downloadAssetStorage_39575800(AssetName, callback, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B011AE & 1) == 0 )
  {
    sub_1BC3008(&UIMasterFaceRender_TypeInfo, *(_QWORD *)&genderType);
    byte_4B011AE = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_39577976(AssetName, callback, 1, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__releaseAssetStorage_39580320(AssetName, 0LL);
}