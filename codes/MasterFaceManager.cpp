void MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_4CED7EE & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
    byte_4CED7EE = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3A8CA90 *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED7EC & 1) == 0 )
  {
    sub_1C7BAE8(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
    sub_1C7BAE8(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&StringLiteral_14800/*"UIMasterFace"*/);
    byte_4CED7EC = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_31C70C8 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v8, (System_String_o *)StringLiteral_14800/*"UIMasterFace"*/, 0);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFaceTexture_o *MasterFaceManager__CreateLocal_41234988(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED7ED & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_14801/*"UIMasterFace("*/);
    byte_4CED7ED = 1;
  }
  ...
  Local = (char *)sub_1C7BB90(string___TypeInfo, 5);
  if ( !Local )
    goto LABEL_13;
  v25 = Local;
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v26 = StringLiteral_14801/*"UIMasterFace("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14801/*"UIMasterFace("*/;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(Local + 32), v26, v19, v20, v21, v22, v23, v24);
  Local = (char *)System_Int32__ToString((int32_t)&v55, 0);
  if ( *((_DWORD *)v25 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v25 + 5) = Local;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v25 + 40), (int32_t)Local, v27, v28, v29, v30, v31, v32);
  if ( *((_DWORD *)v25 + 6) <= 2u
    || (v39 = (int)StringLiteral_859/*"-"*/,
        *((_QWORD *)v25 + 6) = StringLiteral_859/*"-"*/,
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v25 + 48), v39, v33, v34, v35, v36, v37, v38),
        Local = (char *)System_Int32__ToString((int32_t)&v54, 0),
        *((_DWORD *)v25 + 6) <= 3u)
    || (*((_QWORD *)v25 + 7) = Local,
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v25 + 56), (int32_t)Local, v40, v41, v42, v43, v44, v45),
        *((_DWORD *)v25 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C7BD48(Local);
  ...
  *((_QWORD *)v25 + 8) = StringLiteral_757/*")"*/;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v25 + 64), v52, v46, v47, v48, v49, v50, v51);
  Local = (char *)System_String__Concat_64217444((System_String_array *)v25, 0);
  if ( !gameObject )
LABEL_13:
    sub_1C7BD40(Local, v16);
...
UIMasterFaceTexture_o *MasterFaceManager__CreatePrefab(UnityEngine_GameObject_o *parent, const MethodInfo *method)
{
  ...
  if ( (byte_4CED7EA & 1) == 0 )
  {
    sub_1C7BAE8(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
    byte_4CED7EA = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1C7BD40(0, v4);
...
UIMasterFaceTexture_o *MasterFaceManager__CreatePrefab_41234820(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_1C7BD40(0, v16);
  return MasterFaceManager__CreateLocal_41234988(
        ...
        const MethodInfo *method)
{
  ...
  AssetManager__downloadAssetStorage_41100904(AssetName, callback, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_41103084(AssetName, callback, 1, 0);
}
...
void MasterFaceManager__ReleaseAsset(int32_t dispType, int32_t genderType, int32_t equipId, const MethodInfo *method)
{
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__releaseAssetStorage_41105432(AssetName, 0);
}