void MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_4C36B1E & 1) == 0 )
  {
    sub_1C32C20(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
    byte_4C36B1E = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_39E2DEC *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36B1C & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
    sub_1C32C20(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    sub_1C32C20(&StringLiteral_14742/*"UIMasterFace"*/);
    byte_4C36B1C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_3134970 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v7, (System_String_o *)StringLiteral_14742/*"UIMasterFace"*/, 0);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFaceTexture_o *MasterFaceManager__CreateLocal_40571332(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C36B1D & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_14743/*"UIMasterFace("*/);
    byte_4C36B1D = 1;
  }
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v21 = StringLiteral_14743/*"UIMasterFace("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14743/*"UIMasterFace("*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(Local + 32), v21, v18, v19);
  Local = (char *)System_Int32__ToString((int32_t)&v34, 0);
  if ( *((_DWORD *)v20 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v20 + 5) = Local;
  sub_1C32BC4((CGThumbnailListItem_o *)(v20 + 40), (int32_t)Local, v22, v23);
  if ( *((_DWORD *)v20 + 6) <= 2u
    || (v26 = (int)StringLiteral_861/*"-"*/,
        *((_QWORD *)v20 + 6) = StringLiteral_861/*"-"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v20 + 48), v26, v24, v25),
        Local = (char *)System_Int32__ToString((int32_t)&v33, 0),
        *((_DWORD *)v20 + 6) <= 3u)
    || (*((_QWORD *)v20 + 7) = Local,
        sub_1C32BC4((CGThumbnailListItem_o *)(v20 + 56), (int32_t)Local, v27, v28),
        *((_DWORD *)v20 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C32E84(Local);
  ...
  *((_QWORD *)v20 + 8) = StringLiteral_759/*")"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v20 + 64), v31, v29, v30);
  Local = (char *)System_String__Concat_63559060((System_String_array *)v20, 0);
  if ( !gameObject )
LABEL_13:
    sub_1C32E7C(Local);
...
UIMasterFaceTexture_o *MasterFaceManager__CreatePrefab(UnityEngine_GameObject_o *parent, const MethodInfo *method)
{
  ...
  if ( (byte_4C36B1A & 1) == 0 )
  {
    sub_1C32C20(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
    byte_4C36B1A = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1C32E7C(0);
...
UIMasterFaceTexture_o *MasterFaceManager__CreatePrefab_40571164(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_1C32E7C(0);
  return MasterFaceManager__CreateLocal_40571332(
