void __fastcall MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A1ED28 & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__, method);
    byte_4A1ED28 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_370B620 *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED26 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___, parent);
    sub_1B715CC(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v6);
    sub_1B715CC(&StringLiteral_14678/*"UIMasterFace"*/, v7);
    byte_4A1ED26 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14678/*"UIMasterFace"*/, 0LL);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreateLocal_37712132(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED27 & 1) == 0 )
  {
    sub_1B715CC(&string___TypeInfo, parent);
    sub_1B715CC(&StringLiteral_919/*"-"*/, v15);
    sub_1B715CC(&StringLiteral_814/*")"*/, v16);
    sub_1B715CC(&StringLiteral_14679/*"UIMasterFace("*/, v17);
    byte_4A1ED27 = 1;
  }
  ...
  Local = (char *)sub_1B71674(string___TypeInfo, 5LL);
  if ( !Local )
    goto LABEL_13;
  v24 = Local;
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v25 = StringLiteral_14679/*"UIMasterFace("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14679/*"UIMasterFace("*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(Local + 32), v25, v22, v23);
  Local = (char *)System_Int32__ToString((int32_t)&v38, 0LL);
  if ( *((_DWORD *)v24 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v24 + 5) = Local;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v24 + 40), (int32_t)Local, v26, v27);
  if ( *((_DWORD *)v24 + 6) <= 2u
    || (v30 = (int)StringLiteral_919/*"-"*/,
        *((_QWORD *)v24 + 6) = StringLiteral_919/*"-"*/,
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v24 + 48), v30, v28, v29),
        Local = (char *)System_Int32__ToString((int32_t)&v37, 0LL),
        *((_DWORD *)v24 + 6) <= 3u)
    || (*((_QWORD *)v24 + 7) = Local,
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v24 + 56), (int32_t)Local, v31, v32),
        *((_DWORD *)v24 + 6) <= 4u) )
  {
LABEL_12:
    sub_1B71830(Local, v19);
  }
  v35 = StringLiteral_814/*")"*/;
  *((_QWORD *)v24 + 8) = StringLiteral_814/*")"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v24 + 64), v35, v33, v34);
  Local = (char *)System_String__Concat_61519032((System_String_array *)v24, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1B71828(Local, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED24 & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__, method);
    byte_4A1ED24 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1B71828(0LL, v4);
...
// local variable allocation has failed, the output may be wrong!
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreatePrefab_37711964(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED25 & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__, *(_QWORD *)&dispType);
    byte_4A1ED25 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1B71828(0LL, v16);
  return MasterFaceManager__CreateLocal_37712132(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1ED21 & 1) == 0 )
  {
    sub_1B715CC(&AssetManager_TypeInfo, *(_QWORD *)&genderType);
    byte_4A1ED21 = 1;
  }
  AssetName = MasterFaceManager__GetAssetName(dispType, genderType, equipId, (const MethodInfo *)callback);
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__downloadAssetStorage_37591780(AssetName, callback, 0LL);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A1ED20 & 1) == 0 )
  {
    sub_1B715CC(&UIMasterFaceRender_TypeInfo, *(_QWORD *)&genderType);
    byte_4A1ED20 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_37593956(AssetName, callback, 1, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__releaseAssetStorage_37596300(AssetName, 0LL);
}