void __fastcall MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_4B43C2B & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__, method);
    byte_4B43C2B = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_39166A0 *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43C29 & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___, parent);
    sub_1BDB878(&Method_UnityEngine_Object_Instantiate_GameObject___, v5);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v6);
    sub_1BDB878(&StringLiteral_14711/*"UIMasterFace"*/, v7);
    byte_4B43C29 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v11, (System_String_o *)StringLiteral_14711/*"UIMasterFace"*/, 0LL);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreateLocal_39689372(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43C2A & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_871/*"-"*/, v15);
    sub_1BDB878(&StringLiteral_767/*")"*/, v16);
    sub_1BDB878(&StringLiteral_14712/*"UIMasterFace("*/, v17);
    byte_4B43C2A = 1;
  }
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v25 = StringLiteral_14712/*"UIMasterFace("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14712/*"UIMasterFace("*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(Local + 32), v25, v22, v23);
  Local = (char *)System_Int32__ToString((int32_t)&v34, 0LL);
  if ( *((_DWORD *)v24 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v24 + 5) = Local;
  sub_1BDB81C((CGThumbnailListItem_o *)(v24 + 40), (int32_t)Local, v22, v26);
  if ( *((_DWORD *)v24 + 6) <= 2u
    || (v28 = (int)StringLiteral_871/*"-"*/,
        *((_QWORD *)v24 + 6) = StringLiteral_871/*"-"*/,
        sub_1BDB81C((CGThumbnailListItem_o *)(v24 + 48), v28, v22, v27),
        Local = (char *)System_Int32__ToString((int32_t)&v33, 0LL),
        *((_DWORD *)v24 + 6) <= 3u)
    || (*((_QWORD *)v24 + 7) = Local,
        sub_1BDB81C((CGThumbnailListItem_o *)(v24 + 56), (int32_t)Local, v22, v29),
        *((_DWORD *)v24 + 6) <= 4u) )
  {
LABEL_12:
    sub_1BDBADC(Local, v19, v22);
  }
  v31 = StringLiteral_767/*")"*/;
  *((_QWORD *)v24 + 8) = StringLiteral_767/*")"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)(v24 + 64), v31, v22, v30);
  Local = (char *)System_String__Concat_62612776((System_String_array *)v24, 0LL);
  if ( !gameObject )
LABEL_13:
    sub_1BDBAD4(Local, v19);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43C27 & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__, method);
    byte_4B43C27 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1BDBAD4(0LL, v4);
...
// local variable allocation has failed, the output may be wrong!
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreatePrefab_39689204(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43C28 & 1) == 0 )
  {
    sub_1BDB878(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__, *(_QWORD *)&dispType);
    byte_4B43C28 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1BDBAD4(0LL, v16);
  return MasterFaceManager__CreateLocal_39689372(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43C24 & 1) == 0 )
  {
    sub_1BDB878(&AssetManager_TypeInfo, *(_QWORD *)&genderType);
    byte_4B43C24 = 1;
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4B43C23 & 1) == 0 )
  {
    sub_1BDB878(&UIMasterFaceRender_TypeInfo, *(_QWORD *)&genderType);
    byte_4B43C23 = 1;
  }
