void __fastcall MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_42B30D1 & 1) == 0 )
  {
    sub_B52984(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
    byte_42B30D1 = 1;
  }
  SingletonMonoBehaviour_WebViewManager____ctor(
    (SingletonMonoBehaviour_WebViewManager__o *)this,
    (const MethodInfo_2B7611C *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B30CF & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
    sub_B52984(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_14780/*"UIMasterFace"*/);
    byte_42B30CF = 1;
  }
  ...
  Component_srcLineSprite = (UIMasterFaceRender_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                      gameObject,
                                                      (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v8, (System_String_o *)StringLiteral_14780/*"UIMasterFace"*/, 0LL);
  if ( !parent )
    goto LABEL_13;
...
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreateLocal_30653852(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B30D0 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_14781/*"UIMasterFace("*/);
    byte_42B30D0 = 1;
  }
  ...
  {
LABEL_30:
    sub_B52A5C(Local, v16);
  }
  v25 = (System_String_array *)Local;
  v26 = (System_String_o *)StringLiteral_14781/*"UIMasterFace("*/;
  if ( StringLiteral_14781/*"UIMasterFace("*/ )
  {
    v26 = (System_String_o *)sub_B52A44(StringLiteral_14781/*"UIMasterFace("*/, v25->obj.klass->_1.element_class);
    if ( !v26 )
      goto LABEL_29;
    v27 = (System_Int32_array **)StringLiteral_14781/*"UIMasterFace("*/;
  }
  else
  {
    v27 = 0LL;
  ...
  sub_B52920((BattleServantConfConponent_o *)v25->m_Items, v27, v19, v20, v21, v22, v23, v24);
  v26 = System_Int32__ToString((int32_t)&v60, 0LL);
  v34 = (System_Int32_array **)v26;
  if ( v26 )
  {
    v26 = (System_String_o *)sub_B52A44(v26, v25->obj.klass->_1.element_class);
    if ( !v26 )
      goto LABEL_29;
  }
  if ( v25->max_length <= 1 )
  ...
  v26 = (System_String_o *)StringLiteral_757/*"-"*/;
  if ( StringLiteral_757/*"-"*/ )
  {
    v26 = (System_String_o *)sub_B52A44(StringLiteral_757/*"-"*/, v25->obj.klass->_1.element_class);
    if ( !v26 )
      goto LABEL_29;
    v41 = (System_Int32_array **)StringLiteral_757/*"-"*/;
  }
  else
  {
    v41 = 0LL;
...
LABEL_29:
  ...
  v26 = (System_String_o *)StringLiteral_661/*")"*/;
  if ( StringLiteral_661/*")"*/ )
  {
    v26 = (System_String_o *)sub_B52A44(StringLiteral_661/*")"*/, v25->obj.klass->_1.element_class);
    if ( v26 )
    {
...
LABEL_28:
  ...
  Local = (UnityEngine_Component_o *)System_String__Concat_44648440(v25, 0LL);
  if ( !gameObject )
    goto LABEL_30;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B30CD & 1) == 0 )
  {
    sub_B52984(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
    byte_42B30CD = 1;
  }
  Instance = (MasterFaceManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_B52A5C(0LL, v4);
...
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreatePrefab_30653680(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_B52A5C(0LL, v16);
  return MasterFaceManager__CreateLocal_30653852(
           Instance,
           parent,
           dispType,
           genderType,
        ...
        const MethodInfo *method)
{
  if ( (byte_42B30C9 & 1) == 0 )
  {
    sub_B52984(&UIMasterFaceRender_TypeInfo);
    byte_42B30C9 = 1;
  }
