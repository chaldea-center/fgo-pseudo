void MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_4C26446 & 1) == 0 )
  {
    sub_1C2D490(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
    byte_4C26446 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_39D40E4 *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26444 & 1) == 0 )
  {
    sub_1C2D490(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
    sub_1C2D490(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_14739/*"UIMasterFace"*/);
    byte_4C26444 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       gameObject,
                       (const MethodInfo_3125ED0 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v8, (System_String_o *)StringLiteral_14739/*"UIMasterFace"*/, 0);
  if ( !parent )
    goto LABEL_16;
...
UIMasterFaceTexture_o *MasterFaceManager__CreateLocal_40449104(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26445 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_14740/*"UIMasterFace("*/);
    byte_4C26445 = 1;
  }
  ...
  if ( !*((_DWORD *)Local + 6) )
    goto LABEL_12;
  v22 = StringLiteral_14740/*"UIMasterFace("*/;
  *((_QWORD *)Local + 4) = StringLiteral_14740/*"UIMasterFace("*/;
  sub_1C2D434((CGThumbnailListItem_o *)(Local + 32), v22, v19, v20);
  Local = (char *)System_Int32__ToString((int32_t)&v31, 0);
  if ( *((_DWORD *)v21 + 6) <= 1u )
    goto LABEL_12;
  *((_QWORD *)v21 + 5) = Local;
  sub_1C2D434((CGThumbnailListItem_o *)(v21 + 40), (int32_t)Local, v19, v23);
  if ( *((_DWORD *)v21 + 6) <= 2u
    || (v25 = (int)StringLiteral_861/*"-"*/,
        *((_QWORD *)v21 + 6) = StringLiteral_861/*"-"*/,
        sub_1C2D434((CGThumbnailListItem_o *)(v21 + 48), v25, v19, v24),
        Local = (char *)System_Int32__ToString((int32_t)&v30, 0),
        *((_DWORD *)v21 + 6) <= 3u)
    || (*((_QWORD *)v21 + 7) = Local,
        sub_1C2D434((CGThumbnailListItem_o *)(v21 + 56), (int32_t)Local, v19, v26),
        *((_DWORD *)v21 + 6) <= 4u) )
  {
LABEL_12:
    sub_1C2D6F4(Local, v16, v19);
  }
  v28 = StringLiteral_759/*")"*/;
  *((_QWORD *)v21 + 8) = StringLiteral_759/*")"*/;
  sub_1C2D434((CGThumbnailListItem_o *)(v21 + 64), v28, v19, v27);
  Local = (char *)System_String__Concat_63498380((System_String_array *)v21, 0);
  if ( !gameObject )
LABEL_13:
    sub_1C2D6EC(Local, v16);
  UnityEngine_Object__set_name(gameObject, (System_String_o *)Local, 0);
  UIMasterFaceTexture__SetCharacter(v17, dispType, v31, v30, callbackFunc, overWriteImageId, 0);
...
UIMasterFaceTexture_o *MasterFaceManager__CreatePrefab(UnityEngine_GameObject_o *parent, const MethodInfo *method)
{
  ...
  if ( (byte_4C26442 & 1) == 0 )
  {
    sub_1C2D490(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
    byte_4C26442 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_1C2D6EC(0, v4);
...
UIMasterFaceTexture_o *MasterFaceManager__CreatePrefab_40448936(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_1C2D6EC(0, v16);
  return MasterFaceManager__CreateLocal_40449104(
        ...
        const MethodInfo *method)
{
  if ( (byte_4C2643E & 1) == 0 )
  {
    sub_1C2D490(&UIMasterFaceRender_TypeInfo);
    byte_4C2643E = 1;
  }
