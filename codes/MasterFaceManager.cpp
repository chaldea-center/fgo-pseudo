void __fastcall MasterFaceManager___ctor(MasterFaceManager_o *this, const MethodInfo *method)
{
  if ( (byte_4354E21 & 1) == 0 )
  {
    sub_B70694(&Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
    byte_4354E21 = 1;
  }
  SingletonMonoBehaviour_WebViewManager____ctor(
    (SingletonMonoBehaviour_WebViewManager__o *)this,
    (const MethodInfo_2CE9C98 *)Method_SingletonMonoBehaviour_MasterFaceManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354E1F & 1) == 0 )
  {
    sub_B70694(&Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
    sub_B70694(&Method_UnityEngine_Object_Instantiate_GameObject___);
    sub_B70694(&UnityEngine_Object_TypeInfo);
    sub_B70694(&StringLiteral_14867/*"UIMasterFace"*/);
    byte_4354E1F = 1;
  }
  ...
  Component_srcLineSprite = (UIMasterFaceRender_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                      gameObject,
                                                      (const MethodInfo_1D4AE28 *)Method_UnityEngine_GameObject_GetComponent_UIMasterFaceTexture___);
  ...
  UnityEngine_Object__set_name((UnityEngine_Object_o *)v8, (System_String_o *)StringLiteral_14867/*"UIMasterFace"*/, 0LL);
  if ( !parent )
    goto LABEL_13;
...
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreateLocal_30989292(
        MasterFaceManager_o *this,
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354E20 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_14868/*"UIMasterFace("*/);
    byte_4354E20 = 1;
  }
  ...
  {
LABEL_30:
    sub_B7076C(Local, v16);
  }
  v25 = (System_String_array *)Local;
  v26 = (System_String_o *)StringLiteral_14868/*"UIMasterFace("*/;
  if ( StringLiteral_14868/*"UIMasterFace("*/ )
  {
    v26 = (System_String_o *)sub_B70754(StringLiteral_14868/*"UIMasterFace("*/, v25->obj.klass->_1.element_class);
    if ( !v26 )
      goto LABEL_29;
    v27 = (System_Int32_array **)StringLiteral_14868/*"UIMasterFace("*/;
  }
  else
  {
    v27 = 0LL;
  ...
  sub_B70630((BattleServantConfConponent_o *)v25->m_Items, v27, v19, v20, v21, v22, v23, v24);
  v26 = System_Int32__ToString((int32_t)&v60, 0LL);
  v34 = (System_Int32_array **)v26;
  if ( v26 )
  {
    v26 = (System_String_o *)sub_B70754(v26, v25->obj.klass->_1.element_class);
    if ( !v26 )
      goto LABEL_29;
  }
  if ( v25->max_length <= 1 )
  ...
  v26 = (System_String_o *)StringLiteral_760/*"-"*/;
  if ( StringLiteral_760/*"-"*/ )
  {
    v26 = (System_String_o *)sub_B70754(StringLiteral_760/*"-"*/, v25->obj.klass->_1.element_class);
    if ( !v26 )
      goto LABEL_29;
    v41 = (System_Int32_array **)StringLiteral_760/*"-"*/;
  }
  else
  {
    v41 = 0LL;
...
LABEL_29:
  ...
  v26 = (System_String_o *)StringLiteral_663/*")"*/;
  if ( StringLiteral_663/*")"*/ )
  {
    v26 = (System_String_o *)sub_B70754(StringLiteral_663/*")"*/, v25->obj.klass->_1.element_class);
    if ( v26 )
    {
...
LABEL_28:
  ...
  Local = (UnityEngine_Component_o *)System_String__Concat_44838292(v25, 0LL);
  if ( !gameObject )
    goto LABEL_30;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354E1D & 1) == 0 )
  {
    sub_B70694(&Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
    byte_4354E1D = 1;
  }
  Instance = (MasterFaceManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_MasterFaceManager__get_Instance__);
  if ( !Instance )
    sub_B7076C(0LL, v4);
...
UIMasterFaceTexture_o *__fastcall MasterFaceManager__CreatePrefab_30989120(
        UnityEngine_GameObject_o *parent,
        int32_t dispType,
        int32_t genderType,
        int32_t equipId,
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance )
    sub_B7076C(0LL, v16);
  return MasterFaceManager__CreateLocal_30989292(
           Instance,
           parent,
           dispType,
           genderType,
        ...
        const MethodInfo *method)
{
  if ( (byte_4354E19 & 1) == 0 )
  {
    sub_B70694(&UIMasterFaceRender_TypeInfo);
    byte_4354E19 = 1;
  }
