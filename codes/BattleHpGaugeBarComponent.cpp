...
void __fastcall BattleHpGaugeBarComponent__setInitValue_43434984(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        const MethodInfo *method)
...
bool __fastcall BattleHpGaugeBarComponent__setValue(
        ...
        const MethodInfo *method)
{
  return BattleHpGaugeBarComponent__setValue_43435072(this, now, max, method);
}


bool __fastcall BattleHpGaugeBarComponent__setValue_43435072(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A012A6 & 1) == 0 )
  {
    sub_1B64870(&double_TypeInfo, now);
    sub_1B64870(&object___TypeInfo, v7);
    sub_1B64870(&float_TypeInfo, v8);
    sub_1B64870(&StringLiteral_19580/*"from"*/, v9);
    sub_1B64870(&StringLiteral_23834/*"time"*/, v10);
    sub_1B64870(&StringLiteral_22196/*"onupdate"*/, v11);
    sub_1B64870(&StringLiteral_24211/*"updateDamageGauge"*/, v12);
    sub_1B64870(&StringLiteral_18481/*"delay"*/, v13);
    sub_1B64870(&StringLiteral_23874/*"to"*/, v14);
    sub_1B64870(&StringLiteral_22188/*"oncomplete"*/, v15);
    sub_1B64870(&StringLiteral_18114/*"completeDamageGauge"*/, v16);
    sub_1B64870(&iTween_TypeInfo, v17);
    byte_4A012A6 = 1;
  }
  ...
  if ( iTween__Count_60030448(gameObject, 0LL) < 1 )
  {
    v22 = 0.5;
  }
  else
  ...
  {
    v29 = sub_1B649AC(StringLiteral_19580/*"from"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)v28->m_Items, v30, v26, v27);
  v75 = 0LL;
  v29 = j_il2cpp_value_box_0(double_TypeInfo, &v75, v31, v32, v33);
  v36 = (Il2CppObject *)v29;
  if ( v29 )
  {
    v29 = sub_1B649AC(v29, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  }
  if ( v28->max_length <= 1 )
    goto LABEL_66;
  v28->m_Items[1] = v36;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[1], (int32_t)v36, v34, v35);
  v29 = StringLiteral_23874/*"to"*/;
  if ( StringLiteral_23874/*"to"*/ )
  {
    v29 = sub_1B649AC(StringLiteral_23874/*"to"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[2], v30, v37, v38);
  ...
  if ( v28->max_length <= 3 )
    goto LABEL_66;
  v28->m_Items[3] = v44;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[3], (int32_t)v44, v42, v43);
  v29 = StringLiteral_22196/*"onupdate"*/;
  if ( StringLiteral_22196/*"onupdate"*/ )
  {
    v29 = sub_1B649AC(StringLiteral_22196/*"onupdate"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[4], v30, v45, v46);
  v29 = StringLiteral_24211/*"updateDamageGauge"*/;
  if ( StringLiteral_24211/*"updateDamageGauge"*/ )
  {
    v29 = sub_1B649AC(StringLiteral_24211/*"updateDamageGauge"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[5], v30, v47, v48);
  v29 = StringLiteral_22188/*"oncomplete"*/;
  if ( StringLiteral_22188/*"oncomplete"*/ )
  {
    v29 = sub_1B649AC(StringLiteral_22188/*"oncomplete"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[6], v30, v49, v50);
  v29 = StringLiteral_18114/*"completeDamageGauge"*/;
  if ( StringLiteral_18114/*"completeDamageGauge"*/ )
  {
    v29 = sub_1B649AC(StringLiteral_18114/*"completeDamageGauge"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_18114/*"completeDamageGauge"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[7], v30, v51, v52);
  v29 = StringLiteral_18481/*"delay"*/;
  if ( StringLiteral_18481/*"delay"*/ )
  {
    v29 = sub_1B649AC(StringLiteral_18481/*"delay"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_18481/*"delay"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[8], v30, v53, v54);
  v73 = v22;
  ...
  if ( v28->max_length <= 9 )
    goto LABEL_66;
  v28->m_Items[9] = v60;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[9], (int32_t)v60, v58, v59);
  v29 = StringLiteral_23834/*"time"*/;
  if ( StringLiteral_23834/*"time"*/ )
  {
    v29 = sub_1B649AC(StringLiteral_23834/*"time"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[10], v30, v61, v62);
  v72 = 1050253722;
...
LABEL_66:
    sub_1B64AD4(v29, v30);
  v28->m_Items[11] = v68;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v28->m_Items[11], (int32_t)v68, v66, v67);
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A012A7 & 1) == 0 )
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, val);
    sub_1B64870(&StringLiteral_22470/*"playerhp_3"*/, v5);
    sub_1B64870(&StringLiteral_22469/*"playerhp_1"*/, v6);
    byte_4A012A7 = 1;
  }
