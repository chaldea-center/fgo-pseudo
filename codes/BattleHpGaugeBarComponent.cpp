...
void BattleHpGaugeBarComponent__setInitValue_54522964(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        const MethodInfo *method)
...
bool BattleHpGaugeBarComponent__setValue(
        ...
        const MethodInfo *method)
{
  return BattleHpGaugeBarComponent__setValue_54523052(this, now, max, isUpdateDamageBarImmediately, method);
}


bool BattleHpGaugeBarComponent__setValue_54523052(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        bool isUpdateDamageBarImmediately,
        const MethodInfo *method)
{
  ...
  if ( iTween__Count_75401132(gameObject, 0) < 1 )
  {
    v16 = 0.5;
...
LABEL_9:
  ...
  v19 = sub_2213B20(object___TypeInfo, 12);
  if ( !v19 )
    sub_2213CDC(0, v20);
  v27 = (System_Object_array *)v19;
  v28 = StringLiteral_20622/*"from"*/;
  if ( StringLiteral_20622/*"from"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_20622/*"from"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  if ( !LODWORD(v27->max_length) )
    goto LABEL_57;
  v30 = StringLiteral_20622/*"from"*/;
  v27->m_Items[0] = (Il2CppObject *)StringLiteral_20622/*"from"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)v27->m_Items, v30, v21, v22, v23, v24, v25, v26);
  v116 = 0;
  v28 = j_il2cpp_value_box_0(qword_5984380, &v116);
  v37 = (Il2CppObject *)v28;
  if ( v28 )
  {
    v28 = sub_2213BB4(v28, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  if ( (v27->max_length & 0xFFFFFFFE) == 0 )
    goto LABEL_57;
  v27->m_Items[1] = v37;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[1], (int32_t)v37, v31, v32, v33, v34, v35, v36);
  v28 = StringLiteral_25406/*"to"*/;
  if ( StringLiteral_25406/*"to"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_25406/*"to"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  if ( LODWORD(v27->max_length) <= 2 )
    goto LABEL_57;
  v44 = StringLiteral_25406/*"to"*/;
  v27->m_Items[2] = (Il2CppObject *)StringLiteral_25406/*"to"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[2], v44, v38, v39, v40, v41, v42, v43);
  v115 = 0x3FF0000000000000LL;
  v28 = j_il2cpp_value_box_0(qword_5984380, &v115);
  ...
  if ( (v27->max_length & 0xFFFFFFFC) == 0 )
    goto LABEL_57;
  v27->m_Items[3] = v51;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[3], (int32_t)v51, v45, v46, v47, v48, v49, v50);
  v28 = StringLiteral_23573/*"onupdate"*/;
  if ( StringLiteral_23573/*"onupdate"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_23573/*"onupdate"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  ...
  v27->m_Items[4] = (Il2CppObject *)StringLiteral_23573/*"onupdate"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[4], v58, v52, v53, v54, v55, v56, v57);
  v28 = StringLiteral_25781/*"updateDamageGauge"*/;
  if ( StringLiteral_25781/*"updateDamageGauge"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_25781/*"updateDamageGauge"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  if ( LODWORD(v27->max_length) <= 5 )
    goto LABEL_57;
  v65 = StringLiteral_25781/*"updateDamageGauge"*/;
  v27->m_Items[5] = (Il2CppObject *)StringLiteral_25781/*"updateDamageGauge"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[5], v65, v59, v60, v61, v62, v63, v64);
  v28 = StringLiteral_23565/*"oncomplete"*/;
  if ( StringLiteral_23565/*"oncomplete"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_23565/*"oncomplete"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  ...
  v27->m_Items[6] = (Il2CppObject *)StringLiteral_23565/*"oncomplete"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[6], v72, v66, v67, v68, v69, v70, v71);
  v28 = StringLiteral_18997/*"completeDamageGauge"*/;
  if ( StringLiteral_18997/*"completeDamageGauge"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_18997/*"completeDamageGauge"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  if ( (v27->max_length & 0xFFFFFFF8) == 0 )
    goto LABEL_57;
  v79 = StringLiteral_18997/*"completeDamageGauge"*/;
  v27->m_Items[7] = (Il2CppObject *)StringLiteral_18997/*"completeDamageGauge"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[7], v79, v73, v74, v75, v76, v77, v78);
  v28 = StringLiteral_19390/*"delay"*/;
  if ( StringLiteral_19390/*"delay"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_19390/*"delay"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  if ( LODWORD(v27->max_length) <= 8 )
    goto LABEL_57;
  v86 = StringLiteral_19390/*"delay"*/;
  v27->m_Items[8] = (Il2CppObject *)StringLiteral_19390/*"delay"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[8], v86, v80, v81, v82, v83, v84, v85);
  v114 = v16;
  v28 = j_il2cpp_value_box_0(qword_5984378, &v114);
  ...
  if ( LODWORD(v27->max_length) <= 9 )
    goto LABEL_57;
  v27->m_Items[9] = v93;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[9], (int32_t)v93, v87, v88, v89, v90, v91, v92);
  v28 = StringLiteral_25366/*"time"*/;
  if ( StringLiteral_25366/*"time"*/ )
  {
    v28 = sub_2213BB4(StringLiteral_25366/*"time"*/, v27->obj.klass->_1.element_class);
    if ( !v28 )
      goto LABEL_58;
  }
  if ( LODWORD(v27->max_length) <= 0xA )
    goto LABEL_57;
  v100 = StringLiteral_25366/*"time"*/;
  v27->m_Items[10] = (Il2CppObject *)StringLiteral_25366/*"time"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[10], v100, v94, v95, v96, v97, v98, v99);
  v113 = 1050253722;
  v28 = j_il2cpp_value_box_0(qword_5984378, &v113);
...
LABEL_57:
    sub_2213CE4(v28);
  v27->m_Items[11] = v107;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v27->m_Items[11], (int32_t)v107, v101, v102, v103, v104, v105, v106);
  if ( !*(&iTween_TypeInfo->_2.cctor_finished + 1) )
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_2213A60(&UnityEngine_Object_TypeInfo);
    sub_2213A60(&StringLiteral_23898/*"playerhp_3"*/);
    sub_2213A60(&StringLiteral_23897/*"playerhp_1"*/);
    byte_5973F33 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(frontGauge, 0, 0) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(frontSprite, 0, 0) )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v10 )
        {
          v12 = (System_String_o **)&StringLiteral_23897/*"playerhp_1"*/;
          if ( value <= 0.1 )
            v12 = (System_String_o **)&StringLiteral_23898/*"playerhp_3"*/;
