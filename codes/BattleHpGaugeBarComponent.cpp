...
void __fastcall BattleHpGaugeBarComponent__setInitValue_45038948(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        const MethodInfo *method)
...
bool __fastcall BattleHpGaugeBarComponent__setValue(
        ...
        const MethodInfo *method)
{
  return BattleHpGaugeBarComponent__setValue_45039036(this, now, max, method);
}


bool __fastcall BattleHpGaugeBarComponent__setValue_45039036(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7625 & 1) == 0 )
  {
    sub_1C13D24(&double_TypeInfo, now);
    sub_1C13D24(&object___TypeInfo, v7);
    sub_1C13D24(&float_TypeInfo, v8);
    sub_1C13D24(&StringLiteral_19961/*"friendCode"*/, v9);
    sub_1C13D24(&StringLiteral_24320/*"textarea"*/, v10);
    sub_1C13D24(&StringLiteral_22651/*"onProductPurchaseDeferred"*/, v11);
    sub_1C13D24(&StringLiteral_24701/*"unknown compressionFunction"*/, v12);
    sub_1C13D24(&StringLiteral_18836/*"defaultPort"*/, v13);
    sub_1C13D24(&StringLiteral_24361/*"timeoutTicks"*/, v14);
    sub_1C13D24(&StringLiteral_22643/*"onFetchStorePromotionOrderFailed"*/, v15);
    sub_1C13D24(&StringLiteral_18463/*"commit"*/, v16);
  ...
  if ( iTween__Count_61614072(gameObject, 0LL) < 1 )
  {
    v22 = 0.5;
  }
  else
  {
    ...
    if ( !iTween_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
    iTween__Stop_61615872(v21, 0LL);
    v22 = 1045220557;
    this->fields.prevval = this->fields.wkprevval;
  }
  v23 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  v24 = sub_1C13DCC(object___TypeInfo, 12LL);
  if ( !v24 )
    sub_1C13F80(0LL, v25);
  v32 = (System_Object_array *)v24;
  v33 = StringLiteral_19961/*"friendCode"*/;
  if ( StringLiteral_19961/*"friendCode"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_19961/*"friendCode"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_19961/*"friendCode"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)v32->m_Items, v34, v26, v27, v28, v29, v30, v31);
  v123 = 0LL;
  v33 = j_il2cpp_value_box_0(double_TypeInfo, &v123, v35, v36, v37);
  v44 = v33;
  if ( v33 )
  {
    v33 = sub_1C13E60(v33, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
  }
  if ( v32->max_length <= 1 )
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[1], v44, v38, v39, v40, v41, v42, v43);
  v33 = StringLiteral_24361/*"timeoutTicks"*/;
  if ( StringLiteral_24361/*"timeoutTicks"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_24361/*"timeoutTicks"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_24361/*"timeoutTicks"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[2], v34, v45, v46, v47, v48, v49, v50);
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[3], v60, v54, v55, v56, v57, v58, v59);
  v33 = StringLiteral_22651/*"onProductPurchaseDeferred"*/;
  if ( StringLiteral_22651/*"onProductPurchaseDeferred"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_22651/*"onProductPurchaseDeferred"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_22651/*"onProductPurchaseDeferred"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[4], v34, v61, v62, v63, v64, v65, v66);
  v33 = StringLiteral_24701/*"unknown compressionFunction"*/;
  if ( StringLiteral_24701/*"unknown compressionFunction"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_24701/*"unknown compressionFunction"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_24701/*"unknown compressionFunction"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[5], v34, v67, v68, v69, v70, v71, v72);
  v33 = StringLiteral_22643/*"onFetchStorePromotionOrderFailed"*/;
  if ( StringLiteral_22643/*"onFetchStorePromotionOrderFailed"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_22643/*"onFetchStorePromotionOrderFailed"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_22643/*"onFetchStorePromotionOrderFailed"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[6], v34, v73, v74, v75, v76, v77, v78);
  v33 = StringLiteral_18463/*"commit"*/;
  if ( StringLiteral_18463/*"commit"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_18463/*"commit"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_18463/*"commit"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[7], v34, v79, v80, v81, v82, v83, v84);
  v33 = StringLiteral_18836/*"defaultPort"*/;
  if ( StringLiteral_18836/*"defaultPort"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_18836/*"defaultPort"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_18836/*"defaultPort"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[8], v34, v85, v86, v87, v88, v89, v90);
  v121 = v22;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[9], v100, v94, v95, v96, v97, v98, v99);
  v33 = StringLiteral_24320/*"textarea"*/;
  if ( StringLiteral_24320/*"textarea"*/ )
  {
    v33 = sub_1C13E60(StringLiteral_24320/*"textarea"*/, v32->obj.klass->_1.element_class);
    if ( !v33 )
      goto LABEL_67;
    v34 = StringLiteral_24320/*"textarea"*/;
  }
  else
  {
    v34 = 0LL;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[10], v34, v101, v102, v103, v104, v105, v106);
  v120 = 1050253722;
...
LABEL_66:
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&v32->m_Items[11], v116, v110, v111, v112, v113, v114, v115);
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB7626 & 1) == 0 )
  {
    sub_1C13D24(&UnityEngine_Object_TypeInfo, val);
    sub_1C13D24(&StringLiteral_22931/*"pitch"*/, v5);
    sub_1C13D24(&StringLiteral_22930/*"pink"*/, v6);
    byte_4BB7626 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(frontGauge, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(frontSprite, 0LL, 0LL) )
    {
      ...
      if ( v9 )
      {
        ...
        if ( v11 )
        {
          v13 = (System_String_o **)&StringLiteral_22930/*"pink"*/;
          if ( value <= 0.1 )
            v13 = (System_String_o **)&StringLiteral_22931/*"pitch"*/;
