...
void __fastcall BattleHpGaugeBarComponent__setInitValue_42421912(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        const MethodInfo *method)
...
bool __fastcall BattleHpGaugeBarComponent__setValue(
        ...
        const MethodInfo *method)
{
  return BattleHpGaugeBarComponent__setValue_42422000(this, now, max, method);
}


bool __fastcall BattleHpGaugeBarComponent__setValue_42422000(
        BattleHpGaugeBarComponent_o *this,
        int64_t now,
        int64_t max,
        const MethodInfo *method)
{
  ...
  if ( (byte_48E54C5 & 1) == 0 )
  {
    sub_1B00CCC(&double_TypeInfo, now);
    sub_1B00CCC(&object___TypeInfo, v7);
    sub_1B00CCC(&float_TypeInfo, v8);
    sub_1B00CCC(&StringLiteral_19387/*"from"*/, v9);
    sub_1B00CCC(&StringLiteral_23574/*"time"*/, v10);
    sub_1B00CCC(&StringLiteral_21979/*"onupdate"*/, v11);
    sub_1B00CCC(&StringLiteral_23951/*"updateDamageGauge"*/, v12);
    sub_1B00CCC(&StringLiteral_18301/*"delay"*/, v13);
    sub_1B00CCC(&StringLiteral_23614/*"to"*/, v14);
    sub_1B00CCC(&StringLiteral_21971/*"oncomplete"*/, v15);
    sub_1B00CCC(&StringLiteral_17936/*"completeDamageGauge"*/, v16);
    sub_1B00CCC(&iTween_TypeInfo, v17);
    byte_48E54C5 = 1;
  }
  ...
  if ( iTween__Count_58972620(gameObject, 0LL) < 1 )
  {
    v22 = 0.5;
  }
  else
  {
    ...
    if ( !iTween_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
    iTween__Stop_58974420(v21, 0LL);
    v22 = 1045220557;
    this->fields.prevval = this->fields.wkprevval;
  }
  v23 = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  v24 = sub_1B00D74(object___TypeInfo, 12LL);
  if ( !v24 )
    sub_1B00F28(0LL, v25);
  v28 = (System_Object_array *)v24;
  v29 = StringLiteral_19387/*"from"*/;
  if ( StringLiteral_19387/*"from"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_19387/*"from"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_19387/*"from"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)v28->m_Items, v30, v26, v27);
  v75 = 0LL;
  v29 = j_il2cpp_value_box_0(double_TypeInfo, &v75, v31, v32, v33);
  v36 = (Il2CppObject *)v29;
  if ( v29 )
  {
    v29 = sub_1B00E08(v29, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
  }
  if ( v28->max_length <= 1 )
    goto LABEL_66;
  v28->m_Items[1] = v36;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[1], (int32_t)v36, v34, v35);
  v29 = StringLiteral_23614/*"to"*/;
  if ( StringLiteral_23614/*"to"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_23614/*"to"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_23614/*"to"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[2], v30, v37, v38);
  ...
  if ( v28->max_length <= 3 )
    goto LABEL_66;
  v28->m_Items[3] = v44;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[3], (int32_t)v44, v42, v43);
  v29 = StringLiteral_21979/*"onupdate"*/;
  if ( StringLiteral_21979/*"onupdate"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_21979/*"onupdate"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_21979/*"onupdate"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[4], v30, v45, v46);
  v29 = StringLiteral_23951/*"updateDamageGauge"*/;
  if ( StringLiteral_23951/*"updateDamageGauge"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_23951/*"updateDamageGauge"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_23951/*"updateDamageGauge"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[5], v30, v47, v48);
  v29 = StringLiteral_21971/*"oncomplete"*/;
  if ( StringLiteral_21971/*"oncomplete"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_21971/*"oncomplete"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_21971/*"oncomplete"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[6], v30, v49, v50);
  v29 = StringLiteral_17936/*"completeDamageGauge"*/;
  if ( StringLiteral_17936/*"completeDamageGauge"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_17936/*"completeDamageGauge"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_17936/*"completeDamageGauge"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[7], v30, v51, v52);
  v29 = StringLiteral_18301/*"delay"*/;
  if ( StringLiteral_18301/*"delay"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_18301/*"delay"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_18301/*"delay"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[8], v30, v53, v54);
  v73 = v22;
  ...
  if ( v28->max_length <= 9 )
    goto LABEL_66;
  v28->m_Items[9] = v60;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[9], (int32_t)v60, v58, v59);
  v29 = StringLiteral_23574/*"time"*/;
  if ( StringLiteral_23574/*"time"*/ )
  {
    v29 = sub_1B00E08(StringLiteral_23574/*"time"*/, v28->obj.klass->_1.element_class);
    if ( !v29 )
      goto LABEL_67;
    v30 = StringLiteral_23574/*"time"*/;
  }
  else
  {
    v30 = 0LL;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[10], v30, v61, v62);
  v72 = 1050253722;
...
LABEL_66:
    sub_1B00F30(v29, v30);
  v28->m_Items[11] = v68;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v28->m_Items[11], (int32_t)v68, v66, v67);
  if ( !iTween_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(iTween_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E54C6 & 1) == 0 )
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, val);
    sub_1B00CCC(&StringLiteral_22251/*"playerhp_3"*/, v5);
    sub_1B00CCC(&StringLiteral_22250/*"playerhp_1"*/, v6);
    byte_48E54C6 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(frontGauge, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(frontSprite, 0LL, 0LL) )
    {
      ...
      if ( v9 )
      {
        ...
        if ( v11 )
        {
          v13 = (System_String_o **)&StringLiteral_22250/*"playerhp_1"*/;
          if ( value <= 0.1 )
            v13 = (System_String_o **)&StringLiteral_22251/*"playerhp_3"*/;
