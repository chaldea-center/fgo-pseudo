...
void __fastcall QuestAfterActionDialog__OnClickCloseButton(QuestAfterActionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2C12 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_QuestAfterActionDialog_OnClickCloseButton__, v3);
    sub_1BAB41C(&Method_QuestAfterActionDialog__OnClickCloseButton_b__8_0__, v4);
    byte_4AB2C12 = 1;
  }
  v5 = Method_QuestAfterActionDialog_OnClickCloseButton__;
  if ( (*((_BYTE *)Method_QuestAfterActionDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BAB434(Method_QuestAfterActionDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !titleLabel || (UILabel__set_text(titleLabel, title, 0LL), (titleLabel = this->fields.messageLabel) == 0LL) )
    sub_1BAB678(titleLabel, v9);
  UILabel__set_text(titleLabel, message, 0LL);
  this->fields.closeAction = closeAction;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.closeAction, (int32_t)closeAction, v11, v12);
