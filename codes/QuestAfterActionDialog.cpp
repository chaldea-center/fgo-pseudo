...
void QuestAfterActionDialog__OnClickCloseButton(QuestAfterActionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01592 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_QuestAfterActionDialog_OnClickCloseButton__);
    sub_1CE6700(&Method_QuestAfterActionDialog__OnClickCloseButton_b__8_0__);
    byte_4E01592 = 1;
  }
  v3 = Method_QuestAfterActionDialog_OnClickCloseButton__;
  if ( (*((_BYTE *)Method_QuestAfterActionDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1CE6718(Method_QuestAfterActionDialog_OnClickCloseButton__);
