...
void QuestAfterActionDialog__OnClickCloseButton(QuestAfterActionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D55B & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_QuestAfterActionDialog_OnClickCloseButton__);
    sub_1C93AD4(&Method_QuestAfterActionDialog__OnClickCloseButton_b__8_0__);
    byte_4D2D55B = 1;
  }
  v3 = Method_QuestAfterActionDialog_OnClickCloseButton__;
  if ( (*((_BYTE *)Method_QuestAfterActionDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_QuestAfterActionDialog_OnClickCloseButton__);
