...
void QuestAfterActionDialog__OnClickCloseButton(QuestAfterActionDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D293CE & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_QuestAfterActionDialog_OnClickCloseButton__);
    sub_1C94098(&Method_QuestAfterActionDialog__OnClickCloseButton_b__8_0__);
    byte_4D293CE = 1;
  }
  v3 = Method_QuestAfterActionDialog_OnClickCloseButton__;
  if ( (*((_BYTE *)Method_QuestAfterActionDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C940B0(Method_QuestAfterActionDialog_OnClickCloseButton__);
