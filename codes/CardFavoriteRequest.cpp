        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00238 & 1) == 0 )
  {
    sub_1B64A00(&TutorialFlag_TypeInfo, targetUsrSVtId);
    sub_1B64A00(&StringLiteral_21025/*"limitCountSupport"*/, v24);
    sub_1B64A00(&StringLiteral_20006/*"iconLimitCount"*/, v25);
    sub_1B64A00(&StringLiteral_23609/*"svtCommonFlag"*/, v26);
    sub_1B64A00(&StringLiteral_20731/*"isPush"*/, v27);
    sub_1B64A00(&StringLiteral_20159/*"imageLimitCount"*/, v28);
    sub_1B64A00(&StringLiteral_24358/*"userSvtId"*/, v29);
    sub_1B64A00(&StringLiteral_22686/*"randomLimitCount"*/, v30);
    sub_1B64A00(&StringLiteral_22481/*"portraitLimitCount"*/, v31);
    sub_1B64A00(&StringLiteral_18572/*"dispLimitCount"*/, v32);
    sub_1B64A00(&StringLiteral_17058/*"battleVoice"*/, v33);
    sub_1B64A00(&StringLiteral_20720/*"isLock"*/, v34);
    sub_1B64A00(&StringLiteral_20705/*"isChoice"*/, v35);
    sub_1B64A00(&StringLiteral_22687/*"randomLimitCountSupport"*/, v36);
    sub_1B64A00(&StringLiteral_18080/*"commandCardLimitCount"*/, v37);
    sub_1B64A00(&StringLiteral_20714/*"isFavorite"*/, v38);
    byte_4A00238 = 1;
  }
  RequestBase__addField_40855016((RequestBase_o *)this, (System_String_o *)StringLiteral_24358/*"userSvtId"*/, targetUsrSVtId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20159/*"imageLimitCount"*/, imageLimitCount, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18572/*"dispLimitCount"*/, dispLimitCount, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18080/*"commandCardLimitCount"*/, commandCardLimitCount, 0LL);
...
System_String_o *__fastcall CardFavoriteRequest__getURL(CardFavoriteRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&NetworkManager_TypeInfo, method);
    sub_1B64A00(&StringLiteral_17686/*"card/favorite"*/, v2);
    byte_4A00236 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_17686/*"card/favorite"*/, 0LL);
}
