void MarkComponent___ctor(MarkComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_HashSet_T__o *)sub_1C93D20(System_Collections_Generic_HashSet_string__TypeInfo);
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.hash, (int32_t)v3, v4, v5, v6, v7, v8, v9);
...
void MarkComponent__Remove(MarkComponent_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4D32080 & 1) == 0 )
  {
    sub_1C93AD4(&Method_System_Collections_Generic_HashSet_string__Remove__);
    byte_4D32080 = 1;
  }
  hash = (System_Collections_Generic_HashSet_T__o *)this->fields.hash;
  if ( !hash )
  ...
  System_Collections_Generic_HashSet_object___Remove(
    hash,
    (Il2CppObject *)key,
    (const MethodInfo_372C08C *)Method_System_Collections_Generic_HashSet_string__Remove__);
}