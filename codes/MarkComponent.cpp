void __fastcall MarkComponent___ctor(MarkComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BC348 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&System_Collections_Generic_HashSet_string__TypeInfo, v3);
    byte_49BC348 = 1;
  }
  v4 = (System_Collections_Generic_HashSet_T__o *)sub_1B4D1DC(System_Collections_Generic_HashSet_string__TypeInfo);
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.hash, (int32_t)v4, v5, v6);
...
void __fastcall MarkComponent__Add(MarkComponent_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_49BC345 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_HashSet_string__Add__, key);
    byte_49BC345 = 1;
  }
...
bool __fastcall MarkComponent__Contains(MarkComponent_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_49BC347 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_HashSet_string__Contains__, key);
    byte_49BC347 = 1;
  }
  hash = (System_Collections_Generic_HashSet_T__o *)this->fields.hash;
  if ( !hash )
...
void __fastcall MarkComponent__Remove(MarkComponent_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_49BC346 & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Collections_Generic_HashSet_string__Remove__, key);
    byte_49BC346 = 1;
  }
  hash = (System_Collections_Generic_HashSet_T__o *)this->fields.hash;
  if ( !hash )
  ...
  System_Collections_Generic_HashSet_object___Remove(
    hash,
    (Il2CppObject *)key,
    (const MethodInfo_34450C0 *)Method_System_Collections_Generic_HashSet_string__Remove__);
}