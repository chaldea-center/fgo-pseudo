void __fastcall MarkComponent___ctor(MarkComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B45FFD & 1) == 0 )
  {
    ...
    sub_1BDB878(&System_Collections_Generic_HashSet_string__TypeInfo, v3);
    byte_4B45FFD = 1;
  }
  v4 = (System_Collections_Generic_HashSet_T__o *)sub_1BDBAC4(System_Collections_Generic_HashSet_string__TypeInfo);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.hash, (int32_t)v4, v5, v6);
...
void __fastcall MarkComponent__Add(MarkComponent_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4B45FFA & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_HashSet_string__Add__, key);
    byte_4B45FFA = 1;
  }
...
bool __fastcall MarkComponent__Contains(MarkComponent_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4B45FFC & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_HashSet_string__Contains__, key);
    byte_4B45FFC = 1;
  }
  hash = (System_Collections_Generic_HashSet_T__o *)this->fields.hash;
  if ( !hash )
...
void __fastcall MarkComponent__Remove(MarkComponent_o *this, System_String_o *key, const MethodInfo *method)
{
  ...
  if ( (byte_4B45FFB & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_Generic_HashSet_string__Remove__, key);
    byte_4B45FFB = 1;
  }
  hash = (System_Collections_Generic_HashSet_T__o *)this->fields.hash;
  if ( !hash )
  ...
  System_Collections_Generic_HashSet_object___Remove(
    hash,
    (Il2CppObject *)key,
    (const MethodInfo_3592684 *)Method_System_Collections_Generic_HashSet_string__Remove__);
}