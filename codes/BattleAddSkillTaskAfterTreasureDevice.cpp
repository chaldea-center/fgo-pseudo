        ...
        const MethodInfo *method)
{
  ...
  CreateComboEndSkillTask_o *v3; // x20
  __int64 v4; // x0
  __int64 v5; // x1
  ...
  if ( (byte_593B722 & 1) == 0 )
  {
    sub_21FFC50(&CreateComboEndSkillTask_TypeInfo);
  ...
  v3 = (CreateComboEndSkillTask_o *)sub_21FFEBC(CreateComboEndSkillTask_TypeInfo);
  CreateComboEndSkillTask___ctor(v3, 0);
  if ( !v2 )
    sub_21FFECC(v4, v5);
  if ( v3 )
  {
