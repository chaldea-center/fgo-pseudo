void __fastcall EventPointUpperMaster___ctor(EventPointUpperMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FEF7 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventPointUpperMaster__EventPointUpperEntity__string___ctor__, method);
    byte_4A6FEF7 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    285,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_EventPointUpperMaster__EventPointUpperEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FEF8 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventPointUpperEntity_TypeInfo, v6);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointUpperEntity__Add__, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointUpperEntity__ToArray__, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointUpperEntity___ctor__, v9);
    sub_1B90010(&System_Collections_Generic_List_EventPointUpperEntity__TypeInfo, v10);
    byte_4A6FEF8 = 1;
  }
  v11 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventPointUpperEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventPointUpperEntity___ctor__);
...
LABEL_20:
  ...
  return (EventPointUpperEntity_array *)System_Collections_Generic_List_object___ToArray(
                                          v11,
                                          (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_EventPointUpperEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventPointUpperEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                      (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                      PK,
                                      (const MethodInfo_312C900 *)Method_DataMasterBase_EventPointUpperMaster__EventPointUpperEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FEF6 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventPointUpperMaster__EventPointUpperEntity__string__TryGetEntity__, entity);
    byte_4A6FEF6 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_EventPointUpperMaster__EventPointUpperEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FEF9 & 1) == 0 )
  {
    ...
    sub_1B90010(&EventPointUpperEntity_TypeInfo, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointUpperEntity__Add__, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointUpperEntity__ToArray__, v10);
    sub_1B90010(&Method_System_Collections_Generic_List_EventPointUpperEntity___ctor__, v11);
    sub_1B90010(&System_Collections_Generic_List_EventPointUpperEntity__TypeInfo, v12);
    byte_4A6FEF9 = 1;
  }
  v13 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventPointUpperEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventPointUpperEntity___ctor__);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
    ...
    if ( list )
    {
        ...
        && HIDWORD(list[1].klass) == groupId )
      {
        ...
        else
        {
          ...
          sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v23 + 4), (int32_t)v14, v17, v18);
        }
      }
    }
    list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FEFA & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_EventPointUpperReleaseMaster___, *(_QWORD *)&eventId);
    sub_1B90010(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v7);
    sub_1B90010(&StringLiteral_8585/*"MAX_EVENT_POINT"*/, v8);
    byte_4A6FEFA = 1;
  }
  ...
  {
    List = (EventPointUpperEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( List )
    {
      List = (EventPointUpperEntity_array *)DataManager__GetMasterData_object_(
                                              (DataManager_o *)List,
                                              (const MethodInfo_2E8E21C *)Method_DataManager_GetMasterData_EventPointUpperReleaseMaster___);
