        ...
        const MethodInfo *method)
{
  ...
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.pageSpriteList, (int64_t)v3, v4, v5, v6, v7, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DDDA & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_ServantStatusCharaGraphListViewIndicator_OnClickLeft__, v3);
    byte_4C1DDDA = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( this->fields.pageIndex >= 1 )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusCharaGraphListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v7 = (_QWORD *)sub_1C3B77C(Method_ServantStatusCharaGraphListViewIndicator_OnClickLeft__);
...
LABEL_19:
    ...
    if ( v10->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusCharaGraphListViewIndicator_OnClickLeft__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1C3B77C(Method_ServantStatusCharaGraphListViewIndicator_OnClickLeft__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, method);
    sub_1C3B764(&Method_ServantStatusCharaGraphListViewIndicator_OnClickRight__, v3);
    byte_4C1DDDB = 1;
  }
  manager = (UnityEngine_Object_o *)this->fields.manager;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( (pageIndex & 0x80000000) == 0 && pageIndex < this->fields.pageMax - 1 )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusCharaGraphListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1C3B77C(Method_ServantStatusCharaGraphListViewIndicator_OnClickRight__);
...
LABEL_20:
    ...
    if ( v11->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusCharaGraphListViewIndicator_OnClickRight__ + 83) & 2) != 0 )
        v12 = (_QWORD *)sub_1C3B77C(Method_ServantStatusCharaGraphListViewIndicator_OnClickRight__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DDD9 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_20882/*"low-limit"*/, *(_QWORD *)&index);
    this = (ServantStatusCharaGraphListViewIndicator_o *)sub_1C3B764(&StringLiteral_20881/*"lotteryShopId"*/, v5);
    byte_4C1DDD9 = 1;
  }
...
LABEL_13:
      ...
      if ( index == (_DWORD)v7 )
        v9 = &StringLiteral_20882/*"low-limit"*/;
      else
        v9 = &StringLiteral_20881/*"lotteryShopId"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1DDD8 & 1) == 0 )
  {
    this = (ServantStatusCharaGraphListViewIndicator_o *)sub_1C3B764(&StringLiteral_20881/*"lotteryShopId"*/, *(_QWORD *)&max);
    byte_4C1DDD8 = 1;
  }
  pageSpriteList = v4->fields.pageSpriteList;
  if ( !pageSpriteList )
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !this )
        break;
      v9 = v8 >= v4->fields.pageMax ? 0LL : (System_String_o *)StringLiteral_20881/*"lotteryShopId"*/;
