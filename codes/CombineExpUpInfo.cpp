void CombineExpUpInfo___cctor(const MethodInfo *method)
{
  if ( (byte_4C3BB60 & 1) == 0 )
  {
    sub_1C32C20(&CombineExpUpInfo_TypeInfo);
    byte_4C3BB60 = 1;
  }
  *CombineExpUpInfo_TypeInfo->static_fields = (struct CombineExpUpInfo_StaticFields)xmmword_C0C050;
}
...
void CombineExpUpInfo___ctor(CombineExpUpInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB5F & 1) == 0 )
  {
    sub_1C32C20(&Method_System_Collections_Generic_List_SvtClassAttri_TYPE__Add__);
    sub_1C32C20(&Method_System_Collections_Generic_List_SvtClassAttri_TYPE___ctor__);
    sub_1C32C20(&System_Collections_Generic_List_SvtClassAttri_TYPE__TypeInfo);
    sub_1C32C20(&string___TypeInfo);
    sub_1C32C20(&StringLiteral_17490/*"btn_hp_"*/);
    sub_1C32C20(&StringLiteral_17429/*"btn_atk_"*/);
    sub_1C32C20(&StringLiteral_17483/*"btn_experience_"*/);
    byte_4C3BB5F = 1;
  }
  ...
  v6 = v3;
  if ( !*(_DWORD *)(v3 + 24)
    || (v7 = StringLiteral_17483/*"btn_experience_"*/,
        *(_QWORD *)(v3 + 32) = StringLiteral_17483/*"btn_experience_"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v3 + 32), v7, v4, v5),
        *(_DWORD *)(v6 + 24) <= 1u)
    || (v10 = StringLiteral_17429/*"btn_atk_"*/,
        *(_QWORD *)(v6 + 40) = StringLiteral_17429/*"btn_atk_"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v6 + 40), v10, v8, v9),
        *(_DWORD *)(v6 + 24) <= 2u) )
  {
    sub_1C32E84(v3);
  }
  v13 = StringLiteral_17490/*"btn_hp_"*/;
  *(_QWORD *)(v6 + 48) = StringLiteral_17490/*"btn_hp_"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v6 + 48), v13, v11, v12);
  this->fields.btnSpriteNameList = (struct System_String_array *)v6;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.btnSpriteNameList, v6, v14, v15);
  v16 = (System_Collections_Generic_List_T__o *)sub_1C32E6C(System_Collections_Generic_List_SvtClassAttri_TYPE__TypeInfo);
  System_Collections_Generic_List_Int32Enum____ctor(
    v16,
    (const MethodInfo_377D770 *)Method_System_Collections_Generic_List_SvtClassAttri_TYPE___ctor__);
  if ( !v16 )
    goto LABEL_34;
...
LABEL_30:
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.SortClassOrder, (int32_t)v16, v17, v18);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB57 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_SvtClassAttri_TYPE__get_Count__);
    sub_1C32C20(&Method_System_Collections_Generic_List_SvtClassAttri_TYPE__get_Item__);
  ...
  v14 = sub_1C32CC8(int___TypeInfo, v13->static_fields->MAX_EXP_UP_RARITY);
  Instance = (DataManager_o *)sub_1C32CC8(int___TypeInfo, SvtClassAttri_TypeInfo->static_fields->MAX_EXP_UP_RARITY);
  ...
  switch ( nowKind )
  {
    case 2:
      ...
      CombineMaterialList = (System_Collections_Generic_IEnumerable_T__o *)UserServantMaster__getCombineMaterialList(
                                                                             ...
                                                                             0);
      v25 = (System_Collections_Generic_List_object__o *)sub_1C32E6C(System_Collections_Generic_List_UserServantEntity__TypeInfo);
  ...
  if ( (int)size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_Int32Enum___get_Item(
               ...
               i,
               (const MethodInfo_377DCD4 *)Method_System_Collections_Generic_List_SvtClassAttri_TYPE__get_Item__);
      if ( !SvtClassAttri_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(SvtClassAttri_TypeInfo);
...
LABEL_63:
      ...
      if ( !Instance )
        goto LABEL_74;
      CombineExpUpClassInfo__Set_48669664((CombineExpUpClassInfo_o *)Instance, (System_Int32_array *)v20, v34);
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB58 & 1) == 0 )
  {
    ...
    sub_1C32C20(&CombineExpUpInfo_MaterialData___TypeInfo);
    sub_1C32C20(&CombineExpUpInfo_MaterialData_TypeInfo);
    sub_1C32C20(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C32C20(&SvtClassAttri_TypeInfo);
    byte_4C3BB58 = 1;
  }
  ...
  v7 = (unsigned int *)sub_1C32CC8(CombineExpUpInfo_MaterialData___TypeInfo, v6->static_fields->MAX_EXP_UP_RARITY);
  ...
  while ( 1 )
  {
    ...
    if ( (__int64)v12 >= v14 )
      break;
    v15 = (Il2CppObject *)sub_1C32E6C(CombineExpUpInfo_MaterialData_TypeInfo);
    System_Object___ctor(v15, 0);
    if ( !v7 )
      goto LABEL_47;
    if ( v15 )
    {
      Instance = sub_1C32D5C(v15, *(_QWORD *)(*(_QWORD *)v7 + 64LL));
      if ( !Instance )
      {
        v34 = sub_1C32EA0(0);
        sub_1C32D48(v34, 0);
        ...
        const MethodInfo *method)
{
  ...
  Instance = (Il2CppObject *)sub_1C32CC8(int___TypeInfo, v10->static_fields->MAX_EXP_UP_RARITY);
  if ( !v11 )
    goto LABEL_59;
...
LABEL_56:
      sub_1C32E84(Instance);
    v17 = m_Items[v15];
    v18 = (ServantLeaderInfo_o *)sub_1C32E6C(ServantLeaderInfo_TypeInfo);
    ServantLeaderInfo___ctor_43374888(v18, v17, 0, 1, 0);
    if ( type == 2 )
    {
      if ( !v18 )
        goto LABEL_59;
...
LABEL_24:
  ...
  if ( !v14 )
    return 0;
  Instance = (Il2CppObject *)sub_1C32CC8(CombineExpUpInfo_MaterialData___TypeInfo, (unsigned int)v14);
  ...
  if ( v14 >= 1 )
  {
    ...
    while ( 1 )
    {
      v22 = (Il2CppObject *)sub_1C32E6C(CombineExpUpInfo_MaterialData_TypeInfo);
      System_Object___ctor(v22, 0);
      if ( !v20 )
        break;
      if ( v22 )
      {
        Instance = (Il2CppObject *)sub_1C32D5C(v22, v20->obj.klass->_1.element_class);
        if ( !Instance )
        {
          v35 = sub_1C32EA0(0);
          sub_1C32D48(v35, 0);
      ...
      sub_1C32BC4(v27, (int32_t)v22, v23, v24);
      if ( v21 >= LODWORD(v20->max_length) )
        goto LABEL_56;
      if ( !v13 )
        break;
...
void CombineExpUpInfo__OnClickCenter(CombineExpUpInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB5C & 1) == 0 )
  {
    sub_1C32C20(&Method_CombineExpUpInfo_OnClickCenter__);
    byte_4C3BB5C = 1;
  }
  if ( this->fields.nowType != 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineExpUpInfo_OnClickCenter__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_CombineExpUpInfo_OnClickCenter__);
...
void CombineExpUpInfo__OnClickChangeButton(CombineExpUpInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB5E & 1) == 0 )
  {
    sub_1C32C20(&Method_CombineExpUpInfo_OnClickChangeButton__);
    byte_4C3BB5E = 1;
  }
  v3 = Method_CombineExpUpInfo_OnClickChangeButton__;
  if ( (*((_BYTE *)Method_CombineExpUpInfo_OnClickChangeButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C32C38(Method_CombineExpUpInfo_OnClickChangeButton__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  nowKind = this->fields.nowKind;
  if ( nowKind )
...
void CombineExpUpInfo__OnClickLeft(CombineExpUpInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB5B & 1) == 0 )
  {
    sub_1C32C20(&Method_CombineExpUpInfo_OnClickLeft__);
    byte_4C3BB5B = 1;
  }
  if ( this->fields.nowType )
  {
    ...
    if ( (*((_BYTE *)Method_CombineExpUpInfo_OnClickLeft__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_CombineExpUpInfo_OnClickLeft__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
...
void CombineExpUpInfo__OnClickRight(CombineExpUpInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB5D & 1) == 0 )
  {
    sub_1C32C20(&Method_CombineExpUpInfo_OnClickRight__);
    byte_4C3BB5D = 1;
  }
  if ( this->fields.nowType != 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CombineExpUpInfo_OnClickRight__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_CombineExpUpInfo_OnClickRight__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
...
void CombineExpUpInfo__SetBtnState(CombineExpUpInfo_o *this, int32_t kind, int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BB5A & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_17435/*"btn_bg_02_on"*/);
    sub_1C32C20(&StringLiteral_22389/*"on"*/);
    sub_1C32C20(&StringLiteral_17657/*"button_total"*/);
    sub_1C32C20(&StringLiteral_17656/*"button_storage"*/);
    sub_1C32C20(&StringLiteral_17651/*"button_possess"*/);
    this = (CombineExpUpInfo_o *)sub_1C32C20(&StringLiteral_17434/*"btn_bg_02_off"*/);
    byte_4C3BB5A = 1;
  }
  v7 = 0;
  ...
  do
  {
    ...
    if ( v8 == v7 )
    {
      ...
      if ( !this )
        goto LABEL_47;
      UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_17435/*"btn_bg_02_on"*/, 0);
      ...
      v17 = (System_String_o *)StringLiteral_22389/*"on"*/;
    }
    else
    {
...
LABEL_48:
      ...
      if ( !this )
        goto LABEL_47;
      UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_17434/*"btn_bg_02_off"*/, 0);
      ...
      v15 = v21->m_Items[v7];
      v16 = v22->m_Items[v7];
      v17 = (System_String_o *)StringLiteral_22362/*"off"*/;
    }
    this = (CombineExpUpInfo_o *)System_String__Concat_63518544(v16, v17, 0);
    if ( !v15 )
      goto LABEL_47;
  ...
  switch ( kind )
  {
    case 2:
      ...
      if ( this )
      {
        v23 = &StringLiteral_17657/*"button_total"*/;
        goto LABEL_45;
      }
LABEL_47:
      sub_1C32E7C(this);
    case 1:
      ...
      if ( this )
      {
        v23 = &StringLiteral_17656/*"button_storage"*/;
        goto LABEL_45;
      }
      goto LABEL_47;
    case 0:
      ...
      if ( this )
      {
        v23 = &StringLiteral_17651/*"button_possess"*/;
LABEL_45:
