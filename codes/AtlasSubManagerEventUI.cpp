void AtlasSubManagerEventUI___ctor(AtlasSubManagerEventUI_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E767CD & 1) == 0 )
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit___ctor__);
    sub_1D0F0B4(&System_Collections_Generic_Dictionary_string__AtlasManagerUnit__TypeInfo);
    byte_4E767CD = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v3 = (System_Collections_Generic_Dictionary_object__object__o *)sub_1D0F300(System_Collections_Generic_Dictionary_string__AtlasManagerUnit__TypeInfo);
  System_Collections_Generic_Dictionary_object__object____ctor(
    v3,
    (const MethodInfo_3600C34 *)Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  return System_String__Format((System_String_o *)StringLiteral_6339/*"EventUI/Prefabs/{0}"*/, v4, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E767CF & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__ContainsKey__);
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__get_Item__);
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__set_Item__);
    byte_4E767CF = 1;
  }
  ...
  if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          ...
          (const MethodInfo_36017D8 *)Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__ContainsKey__) )
  {
    ...
    System_Collections_Generic_Dictionary_object__object___set_Item(
      ...
      (Il2CppObject *)assetPath,
      (Il2CppObject *)v7,
      (const MethodInfo_36015D0 *)Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__set_Item__);
  }
  assetLoadDict = this->fields.assetLoadDict;
  if ( !assetLoadDict )
LABEL_9:
    sub_1D0F30C(assetLoadDict, assetPath);
  return (AtlasManagerUnit_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                 (System_Collections_Generic_Dictionary_object__object__o *)assetLoadDict,
                                 (Il2CppObject *)assetPath,
                                 (const MethodInfo_3601564 *)Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__get_Item__);
}
...
void AtlasSubManagerEventUI__Release(AtlasSubManagerEventUI_o *this, int32_t eventId, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__ContainsKey__);
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__Remove__);
    this = (AtlasSubManagerEventUI_o *)sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__get_Item__);
    byte_4E767CB = 1;
  }
      ...
      if ( AssetPath )
      {
        ...
        if ( AssetPath )
        {
          System_Collections_Generic_Dictionary_object__object___Remove(
            AssetPath,
            v7,
            (const MethodInfo_3602AE0 *)Method_System_Collections_Generic_Dictionary_string__AtlasManagerUnit__Remove__);
          return;
        }
      }
    }
LABEL_10:
    sub_1D0F30C(AssetPath, v6);
  }
}
...
AtlasSubManagerEventUI_o *AtlasSubManagerEventUI__get_Instance(const MethodInfo *method)
{
  ...
  if ( (byte_4E767CA & 1) == 0 )
  {
    sub_1D0F0B4(&AtlasSubManagerEventUI_TypeInfo);
    byte_4E767CA = 1;
  }
  instance = AtlasSubManagerEventUI_TypeInfo->static_fields->instance;
  if ( !instance )
  {
    v2 = (AtlasSubManagerEventUI_o *)sub_1D0F300(AtlasSubManagerEventUI_TypeInfo);
