        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5CAA4 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_System_Linq_Enumerable_Select_long__SellServantRequest_UseSvtHash___);
    sub_1B885B0(&Method_System_Linq_Enumerable_ToList_SellServantRequest_UseSvtHash___);
    sub_1B885B0(&System_Func_long__SellServantRequest_UseSvtHash__TypeInfo);
    sub_1B885B0(&MiniMessagePack_MiniMessagePacker_TypeInfo);
    sub_1B885B0(&Method_SellServantRequest___c__beginRequest_b__2_0__);
    sub_1B885B0(&Method_SellServantRequest___c__beginRequest_b__2_1__);
    sub_1B885B0(&SellServantRequest___c_TypeInfo);
    sub_1B885B0(&StringLiteral_23096/*"sellData"*/);
    sub_1B885B0(&StringLiteral_23095/*"sellCommandCode"*/);
    byte_4A5CAA4 = 1;
  }
  ...
  if ( !_9__2_0 )
  {
    ...
    _9__2_0 = (System_Func_T__TResult__o *)sub_1B887FC(System_Func_long__SellServantRequest_UseSvtHash__TypeInfo);
  ...
  v13 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_long__object_(
                                                               ...
                                                               (const MethodInfo_2EAEEF0 *)Method_System_Linq_Enumerable_Select_long__SellServantRequest_UseSvtHash___);
  v14 = System_Linq_Enumerable__ToList_object_(
          v13,
          (const MethodInfo_2EBBFFC *)Method_System_Linq_Enumerable_ToList_SellServantRequest_UseSvtHash___);
  ...
  if ( !_9__2_1 )
  {
    ...
    _9__2_1 = (System_Func_T__TResult__o *)sub_1B887FC(System_Func_long__SellServantRequest_UseSvtHash__TypeInfo);
    System_Func_long__object____ctor(_9__2_1, v18, Method_SellServantRequest___c__beginRequest_b__2_1__, 0LL);
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&v19->__9__2_1, (int32_t)_9__2_1, v20, v21);
  }
  ...
  v23 = (Il2CppObject *)System_Linq_Enumerable__ToList_object_(
                          v22,
                          (const MethodInfo_2EBBFFC *)Method_System_Linq_Enumerable_ToList_SellServantRequest_UseSvtHash___);
  v24 = (MiniMessagePack_MiniMessagePacker_o *)sub_1B887FC(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v24, 0LL);
  if ( !v24 )
    goto LABEL_20;
  v27 = MiniMessagePack_MiniMessagePacker__PackClass(v24, v16, 0LL);
  if ( !System_Convert_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Convert_TypeInfo);
  v28 = System_Convert__ToBase64String(v27, 0LL);
  RequestBase__addField_41126952((RequestBase_o *)this, (System_String_o *)StringLiteral_23096/*"sellData"*/, v28, v29);
  v30 = (MiniMessagePack_MiniMessagePacker_o *)sub_1B887FC(MiniMessagePack_MiniMessagePacker_TypeInfo);
  MiniMessagePack_MiniMessagePacker___ctor(v30, 0LL);
  if ( !v30 )
LABEL_20:
    sub_1B8880C(v25, v26);
  v31 = MiniMessagePack_MiniMessagePacker__PackClass(v30, v23, 0LL);
  v32 = System_Convert__ToBase64String(v31, 0LL);
  RequestBase__addField_41126952((RequestBase_o *)this, (System_String_o *)StringLiteral_23095/*"sellCommandCode"*/, v32, v33);
...
System_String_o *__fastcall SellServantRequest__getURL(SellServantRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5CAA3 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_23271/*"shop/sellSvt"*/);
    byte_4A5CAA3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_23271/*"shop/sellSvt"*/, 0LL);
}
...
void __fastcall SellServantRequest___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1B887FC(SellServantRequest___c_TypeInfo);
  System_Object___ctor(v1, 0LL);
  SellServantRequest___c_TypeInfo->static_fields->__9 = (struct SellServantRequest___c_o *)v1;
  sub_1B88554((ServantStatusBattleListViewItem_o *)SellServantRequest___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5CAA7 & 1) == 0 )
  {
    sub_1B885B0(&SellServantRequest_UseSvtHash_TypeInfo);
    byte_4A5CAA7 = 1;
  }
  v4 = sub_1B887FC(SellServantRequest_UseSvtHash_TypeInfo);
