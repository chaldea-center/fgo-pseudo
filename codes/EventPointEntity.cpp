        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FEDD & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_61787092(v12, (System_String_o *)StringLiteral_868/*","*/, 0LL);
