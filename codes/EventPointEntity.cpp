  ...
  if ( max_length >= 1 )
  {
    for ( i = 0; i < max_length; v5 = i < max_length )
    {
      if ( i >= (unsigned int)max_length )
        sub_1BCB25C(this, *(_QWORD *)&groupId, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C592 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v12 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_62450424(v13, (System_String_o *)StringLiteral_806/*","*/, 0LL);
