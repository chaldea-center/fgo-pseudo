        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE57B & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_61383576(v12, (System_String_o *)StringLiteral_869/*","*/, 0LL);
