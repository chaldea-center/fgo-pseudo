        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E287C & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_60325748(v12, (System_String_o *)StringLiteral_865/*","*/, 0LL);
