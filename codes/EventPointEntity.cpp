        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66C2A & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_62698808(v12, (System_String_o *)StringLiteral_863/*","*/, 0LL);
        v12 = (System_String_o *)Instance;
      }
      if ( !v15 )
        break;
      Instance = (DataManager_o *)System_String__Concat_62698808(
                                    v12,
