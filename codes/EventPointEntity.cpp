        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E509 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_61645176(v12, (System_String_o *)StringLiteral_817/*","*/, 0LL);
