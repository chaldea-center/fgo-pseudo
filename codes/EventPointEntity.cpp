        ...
        const MethodInfo *method)
{
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_75651716(v9, (System_String_o *)StringLiteral_869/*","*/, 0);
        v9 = (System_String_o *)Instance;
      }
      if ( !v12 )
        break;
      Instance = (DataManager_o *)System_String__Concat_75651716(
                                    v9,
