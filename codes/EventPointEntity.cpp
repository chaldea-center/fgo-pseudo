        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5DC0 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_62048128(v12, (System_String_o *)StringLiteral_863/*","*/, 0LL);
