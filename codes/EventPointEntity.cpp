        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3720D & 1) == 0 )
  {
    sub_1BD3458(&Method_DataManager_GetMasterData_EventPointGroupMaster___, group);
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        Instance = (DataManager_o *)System_String__Concat_62525248(v12, (System_String_o *)StringLiteral_863/*","*/, 0LL);
