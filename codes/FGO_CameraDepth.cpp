...
void __fastcall FGO_CameraDepth__Start(FGO_CameraDepth_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD3FD & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_Camera___, method);
    byte_49FD3FD = 1;
  }
  ...
  if ( !Component_object
    || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                         Component_object,
                                                         (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_Camera___)) == 0LL )
  {
