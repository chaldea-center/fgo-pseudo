...
void __fastcall FGO_CameraDepth__Start(FGO_CameraDepth_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49B9CDC & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_Camera___, method);
    byte_49B9CDC = 1;
  }
  ...
  if ( !Component_object
    || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                         Component_object,
                                                         (const MethodInfo_2F53444 *)Method_UnityEngine_GameObject_GetComponent_Camera___)) == 0LL )
  {
