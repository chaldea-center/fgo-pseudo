...
void __fastcall FGO_CameraDepth__Start(FGO_CameraDepth_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2CE1B & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_Camera___, method);
    byte_4A2CE1B = 1;
  }
  ...
  if ( !Component_object
    || (Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                         Component_object,
                                                         (const MethodInfo_2EB19B8 *)Method_UnityEngine_GameObject_GetComponent_Camera___)) == 0LL )
  {
