        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC10B0 & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_BoostSupportRequestItemListViewItemDraw___);
    byte_4CC10B0 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_BoostSupportRequestItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC10B1 & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_GameObject_GetComponent_BoostSupportRequestItemListViewObject___);
    byte_4CC10B1 = 1;
  }
  ...
  UnityEngine_GameObject__GetComponent_object_(
    DragObject,
    (const MethodInfo_31A2ED0 *)Method_UnityEngine_GameObject_GetComponent_BoostSupportRequestItemListViewObject___);
  return v5;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC10B2 & 1) == 0 )
  {
    sub_1C713B0(&BoostSupportRequsetItemListViewItem_TypeInfo);
    byte_4CC10B2 = 1;
  }
  ...
  else
  {
    ...
    p_callbackFunc = &this->fields.callbackFunc;
    v14 = (BoostSupportRequestItemListViewObject_o *)sub_1C71354(&this->fields.callbackFunc, callbackFunc);
    if ( v9 )
    {
...
void BoostSupportRequestItemListViewObject__Init_31378616(
        BoostSupportRequestItemListViewObject_o *this,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
{
...
void BoostSupportRequestItemListViewObject__Init_31380884(
        BoostSupportRequestItemListViewObject_o *this,
        const MethodInfo *method)
{
  const MethodInfo *v2; // x3
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC10B3 & 1) == 0 )
  {
    this = (BoostSupportRequestItemListViewObject_o *)sub_1C713B0(&Method_SingletonTemplate_BoostFunctionUtility__get_Instance__);
    byte_4CC10B3 = 1;
  }
  if ( !consumeList )
    goto LABEL_12;
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      this = (BoostSupportRequestItemListViewObject_o *)SingletonTemplate_object___get_Instance((const MethodInfo_3A5F648 *)Method_SingletonTemplate_BoostFunctionUtility__get_Instance__);
      if ( !this )
        break;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (BoostSupportRequestItemListViewObject_o *)sub_1C719A4(v8);
