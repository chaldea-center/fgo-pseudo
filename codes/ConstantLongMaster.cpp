void __fastcall ConstantLongMaster___ctor(ConstantLongMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FCAC & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string___ctor__, method);
    byte_4A6FCAC = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    102,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCAE & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_TryGetEntityFromId_ConstantLongEntity___, name);
    byte_4A6FCAE = 1;
  }
  result = 0LL;
  EntityFromId_object = DataMasterBase__TryGetEntityFromId_object_(
                          ...
                          &result,
                          name,
                          (const MethodInfo_2E8E6BC *)Method_DataMasterBase_TryGetEntityFromId_ConstantLongEntity___);
...
int64_t __fastcall ConstantLongMaster__GetValue_39105116(
        ConstantLongMaster_o *this,
        System_String_o *name,
        int64_t def,
        const MethodInfo *method)
...
int64_t __fastcall ConstantLongMaster__getValue(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_4A6FCAD & 1) == 0 )
  {
    sub_1B90010(&Method_DataManager_GetMasterData_ConstantLongMaster___, method);
    sub_1B90010(&Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string__TryGetEntity__, v3);
  ...
  Instance = (Il2CppObject *)DataMasterBase_object__object__object___TryGetEntity(
                               ...
                               &entity,
                               (Il2CppObject *)name,
                               (const MethodInfo_312C950 *)Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string__TryGetEntity__);
