void __fastcall ConstantLongMaster___ctor(ConstantLongMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE34B & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string___ctor__, method);
    byte_49FE34B = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    102,
    (const MethodInfo_30D6498 *)Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FE34D & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_TryGetEntityFromId_ConstantLongEntity___, name);
    byte_49FE34D = 1;
  }
  result = 0LL;
  EntityFromId_object = DataMasterBase__TryGetEntityFromId_object_(
                          ...
                          &result,
                          name,
                          (const MethodInfo_2E3BB68 *)Method_DataMasterBase_TryGetEntityFromId_ConstantLongEntity___);
  if ( !EntityFromId_object )
    return -1LL;
  if ( !result )
    sub_1B64ACC(EntityFromId_object, v6);
  return (int64_t)result[1].monitor;
}


int64_t __fastcall ConstantLongMaster__GetValue_38735160(
        ConstantLongMaster_o *this,
        System_String_o *name,
        int64_t def,
        const MethodInfo *method)
{
  ...
  {
    if ( !result )
      sub_1B64ACC(EntityFromId_object, v8);
    return (int64_t)result[1].monitor;
  }
  return def;
}
...
int64_t __fastcall ConstantLongMaster__getValue(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_49FE34C & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_ConstantLongMaster___, method);
    sub_1B64870(&Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string__TryGetEntity__, v3);
  ...
  Instance = DataManager__GetMasterData_object_(
               ...
               (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_ConstantLongMaster___);
  if ( !Instance )
    goto LABEL_10;
  Instance = (Il2CppObject *)DataMasterBase_object__object__object___TryGetEntity(
                               ...
                               &entity,
                               (Il2CppObject *)name,
                               (const MethodInfo_30D6528 *)Method_DataMasterBase_ConstantLongMaster__ConstantLongEntity__string__TryGetEntity__);
