void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D912 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int___ctor__, v1);
    sub_1BCAFF8(&System_Collections_Generic_List_int__TypeInfo, v4);
    sub_1BCAFF8(&UserCommandCodeCollectionManager_TypeInfo, v5);
    sub_1BCAFF8(&StringLiteral_6623/*"Fgo_20180629_1"*/, v6);
    byte_4B1D912 = 1;
  }
  UserCommandCodeCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6623/*"Fgo_20180629_1"*/;
  sub_1BCAF9C(
    (CGThumbnailListItem_o *)UserCommandCodeCollectionManager_TypeInfo->static_fields,
    StringLiteral_6623/*"Fgo_20180629_1"*/,
    v2,
    v3);
...
void __fastcall UserCommandCodeCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D90B & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int__Clear__, v1);
    sub_1BCAFF8(&Method_System_Collections_Generic_List_int__get_Count__, v2);
    sub_1BCAFF8(&UserCommandCodeCollectionManager_TypeInfo, v3);
    byte_4B1D90B = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D909 & 1) == 0 )
  {
    sub_1BCAFF8(&UserCommandCodeCollectionManager_TypeInfo, v1);
    byte_4B1D909 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D90C & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___, v1);
...
LABEL_19:
  ...
  if ( (unsigned int)namespaze_low >= *((_DWORD *)name + 6) )
  {
    System_Collections_Generic_List_int___AddWithResize(
      (System_Collections_Generic_List_int__o *)v6,
      svtId,
      *(const MethodInfo_369CBAC **)(*(_QWORD *)(v12[4] + 192LL) + 112LL));
    static_fields = UserCommandCodeCollectionManager_TypeInfo->static_fields;
  }
  else
  {
...
void __fastcall UserCommandCodeCollectionManager__SetOld_42662132(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D90F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UserCommandCodeCollectionManager_TypeInfo, v6);
    byte_4B1D90F = 1;
  }
  if ( svtIdList )
  {
