void UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C28718 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_6669/*"Fgo_20180629_1"*/);
    byte_4C28718 = 1;
  }
  ...
  *(_WORD *)&UserCommandCodeCollectionManager_TypeInfo->static_fields->isModfiy = 0;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&static_fields->oldList, (int32_t)v3, v5, v6);
}
...
bool UserCommandCodeCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  if ( !v2->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0) )
    {
      ...
      {
LABEL_35:
        v27 = sub_1C7DCA8(v8, System_IDisposable_TypeInfo, 0);
      }
...
void UserCommandCodeCollectionManager__SetOld_43293984(System_Int32_array *svtIdList, const MethodInfo *method)
{
  __int64 v2; // x2
  il2cpp_array_size_t max_length; // x22
  System_Collections_Generic_List_int__o *oldList; // x0
  struct System_Collections_Generic_List_int__o *v6; // x8
  int size; // w23
  int32_t v8; // w20
  int v9; // w9
  char *v10; // x10
  ...
  if ( svtIdList )
  {
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      v6 = *(struct System_Collections_Generic_List_int__o **)(*(_QWORD *)&oldList[4].fields._size + 16LL);
      if ( v6 )
      {
...
LABEL_21:
          ...
          while ( 1 )
          {
            ...
            if ( m_Items[v13] >= 1 )
            {
              ...
              if ( !oldList )
                goto LABEL_36;
              method = (const MethodInfo *)(unsigned int)m_Items[v13];
              ...
              else
              {
                ...
                *(_DWORD *)&items[4 * v19 + 32] = (_DWORD)method;
              }
              static_fields->isModfiy = 1;
            }
...
LABEL_35:
        ...
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            if ( LODWORD(svtIdList->max_length) == v9 )
              goto LABEL_35;
            v10 = (char *)svtIdList + 4 * v9;
            v12 = *((_DWORD *)v10 + 8);
            v11 = v10 + 32;
            if ( (_DWORD)oldList == v12 )
              break;
...
bool UserCommandCodeCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  if ( !v3->static_fields->UseMock )
  {
    ...
    {
LABEL_27:
      v21 = sub_1C7DCA8(v7, System_IDisposable_TypeInfo, 0);
    }
