void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  struct UserCommandCodeCollectionManager_StaticFields *v19; // x0
  ...
  v19 = UserCommandCodeCollectionManager_TypeInfo->static_fields;
  v19->oldList = v18;
...
void __fastcall UserCommandCodeCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_40FAAD6 & 1) == 0 )
  {
    ...
    sub_B16FFC(&UserCommandCodeCollectionManager_TypeInfo, v3);
    byte_40FAAD6 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_40FAAD4 & 1) == 0 )
  {
    sub_B16FFC(&UserCommandCodeCollectionManager_TypeInfo, v1);
    byte_40FAAD4 = 1;
  }
...
bool __fastcall UserCommandCodeCollectionManager__IsNew(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_40FAAD8 & 1) == 0 )
  {
    ...
    sub_B16FFC(&UserCommandCodeCollectionManager_TypeInfo, v4);
    byte_40FAAD8 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_40FAAD7 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___, v1);
  ...
  if ( v4->static_fields->isContinueDevice )
  {
    ...
    UserCommandCodeCollectionMaster__continueDeviceUserCommandCodeCollection(MasterData_WarQuestSelectionMaster, v7);
    v8 = (const MethodInfo *)UserCommandCodeCollectionManager_TypeInfo;
    if ( (BYTE3(UserCommandCodeCollectionManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UserCommandCodeCollectionManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserCommandCodeCollectionManager_TypeInfo);
    ...
    UserCommandCodeCollectionManager__WriteData(v8);
  }
}
...
bool __fastcall UserCommandCodeCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_40FAADB & 1) == 0 )
  {
    ...
    sub_B16FFC(&UserCommandCodeCollectionManager_TypeInfo, v5);
    byte_40FAADB = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__SetOld_26525656(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FAADA & 1) == 0 )
  {
    ...
    sub_B16FFC(&UserCommandCodeCollectionManager_TypeInfo, v6);
    byte_40FAADA = 1;
  }
  if ( svtIdList )
  {
...
bool __fastcall UserCommandCodeCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  UserCommandCodeCollectionManager_c *v21; // x0
  struct UserCommandCodeCollectionManager_StaticFields *v22; // x8
