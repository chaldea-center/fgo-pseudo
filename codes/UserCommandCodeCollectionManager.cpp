void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  struct UserCommandCodeCollectionManager_StaticFields *v17; // x0
  ...
  if ( (byte_4215B7C & 1) == 0 )
  {
    ...
    sub_B0D8A4(&UserCommandCodeCollectionManager_TypeInfo, v9);
  ...
  v17 = UserCommandCodeCollectionManager_TypeInfo->static_fields;
  v17->oldList = v16;
...
void __fastcall UserCommandCodeCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4215B75 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&UserCommandCodeCollectionManager_TypeInfo, v3);
    byte_4215B75 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4215B73 & 1) == 0 )
  {
    sub_B0D8A4(&UserCommandCodeCollectionManager_TypeInfo, v1);
    byte_4215B73 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4215B76 & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___, v1);
...
bool __fastcall UserCommandCodeCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_4215B7A & 1) == 0 )
  {
    ...
    sub_B0D8A4(&UserCommandCodeCollectionManager_TypeInfo, v5);
    byte_4215B7A = 1;
  }
...
LABEL_39:
  ...
  else
  {
    ...
    UserCommandCodeCollectionManager__ClearSaveDataList((const MethodInfo *)v30);
    return 0;
  }
}
...
void __fastcall UserCommandCodeCollectionManager__SetOld_26715096(
...
bool __fastcall UserCommandCodeCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  struct UserCommandCodeCollectionManager_StaticFields *v20; // x8
  ...
  if ( (byte_4215B7B & 1) == 0 )
  {
    ...
    sub_B0D8A4(&UserCommandCodeCollectionManager_TypeInfo, v6);
    byte_4215B7B = 1;
  }
  v7 = UserCommandCodeCollectionManager_TypeInfo;
  if ( (BYTE3(UserCommandCodeCollectionManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
