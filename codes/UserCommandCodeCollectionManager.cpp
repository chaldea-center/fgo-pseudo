void UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E05F43 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_6720/*"Fgo_20180629_1"*/);
    byte_4E05F43 = 1;
  }
  UserCommandCodeCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6720/*"Fgo_20180629_1"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)UserCommandCodeCollectionManager_TypeInfo->static_fields,
    StringLiteral_6720/*"Fgo_20180629_1"*/,
    v1,
    v2,
    v3,
    v4,
  ...
  *(_WORD *)&UserCommandCodeCollectionManager_TypeInfo->static_fields->isModfiy = 0;
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&static_fields->oldList, (int32_t)v7, v9, v10, v11, v12, v13, v14);
}
  ...
  if ( v1->static_fields->isContinueDevice )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_32043A8 *)Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___)) == 0 )
    {
...
bool UserCommandCodeCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  __int64 v27; // x0
  UserCommandCodeCollectionManager_c *v28; // x0
  ...
  if ( !v2->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0) )
    {
      ...
      {
LABEL_35:
        v27 = sub_1CBCA7C(v8, System_IDisposable_TypeInfo, 0);
      }
    ...
    {
      v28 = UserCommandCodeCollectionManager_TypeInfo;
      if ( !UserCommandCodeCollectionManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UserCommandCodeCollectionManager_TypeInfo);
      UserCommandCodeCollectionManager__ClearSaveDataList((const MethodInfo *)v28);
    }
    return 0;
  }
  return 1;
...
void UserCommandCodeCollectionManager__SetOld_44741272(System_Int32_array *svtIdList, const MethodInfo *method)
{
...
bool UserCommandCodeCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  struct UserCommandCodeCollectionManager_StaticFields *v10; // x8
  ...
  if ( !v3->static_fields->UseMock )
  {
    ...
    {
LABEL_27:
      v21 = sub_1CBCA7C(v7, System_IDisposable_TypeInfo, 0);
    }
