void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDD826 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_6809/*"Fgo_20180629_1"*/);
    byte_4BDD826 = 1;
  }
  UserCommandCodeCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6809/*"Fgo_20180629_1"*/;
  sub_1C21DDC(
    (PartyOrganizationUtility_o *)UserCommandCodeCollectionManager_TypeInfo->static_fields,
    StringLiteral_6809/*"Fgo_20180629_1"*/,
    v1,
    v2,
    v3,
    v4,
...
void __fastcall UserCommandCodeCollectionManager__SetOld_41819608(
