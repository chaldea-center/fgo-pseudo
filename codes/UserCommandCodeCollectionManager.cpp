void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B03409 & 1) == 0 )
  {
    ...
    sub_1BC3008(&UserCommandCodeCollectionManager_TypeInfo, v5);
    sub_1BC3008(&StringLiteral_6618/*"Fgo_20180629_1"*/, v6);
    byte_4B03409 = 1;
  }
  UserCommandCodeCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6618/*"Fgo_20180629_1"*/;
  sub_1BC2FAC(
    (CGThumbnailListItem_o *)UserCommandCodeCollectionManager_TypeInfo->static_fields,
    StringLiteral_6618/*"Fgo_20180629_1"*/,
    v2,
    v3);
...
void __fastcall UserCommandCodeCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4B03402 & 1) == 0 )
  {
    ...
    sub_1BC3008(&UserCommandCodeCollectionManager_TypeInfo, v3);
    byte_4B03402 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4B03400 & 1) == 0 )
  {
    sub_1BC3008(&UserCommandCodeCollectionManager_TypeInfo, v1);
    byte_4B03400 = 1;
  }
...
bool __fastcall UserCommandCodeCollectionManager__IsNew(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4B03404 & 1) == 0 )
  {
    ...
    sub_1BC3008(&UserCommandCodeCollectionManager_TypeInfo, v4);
    byte_4B03404 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4B03403 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___, v1);
  ...
  if ( v4->static_fields->isContinueDevice )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___)) == 0LL )
    {
...
void __fastcall UserCommandCodeCollectionManager__SetOld_42499200(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03406 & 1) == 0 )
  {
    ...
    sub_1BC3008(&UserCommandCodeCollectionManager_TypeInfo, v6);
    byte_4B03406 = 1;
  }
  if ( svtIdList )
  {
    ...
    if ( (int)v7 >= 1 )
    {
      ...
      v9 = *(struct System_Collections_Generic_List_int__o **)(*(_QWORD *)&oldList[4].fields._size + 16LL);
      if ( v9 )
      {
...
LABEL_21:
          ...
          while ( 1 )
          {
            ...
            if ( v17[v16] >= 1 )
            {
              ...
              if ( !oldList )
                goto LABEL_36;
              method = (const MethodInfo *)(unsigned int)v17[v16];
              items = (const char *)oldList->fields._items;
              v21 = Method_System_Collections_Generic_List_int__Add__;
              ++oldList->fields._version;
              if ( !items )
                goto LABEL_36;
              v22 = oldList->fields._size;
              if ( (unsigned int)v22 >= *((_DWORD *)items + 6) )
              {
                System_Collections_Generic_List_int___AddWithResize(
                  oldList,
                  (int32_t)method,
              ...
              {
                oldList->fields._size = v22 + 1;
                *(_DWORD *)&items[4 * v22 + 32] = (_DWORD)method;
              }
              static_fields->isModfiy = 1;
            }
...
LABEL_35:
        ...
        while ( 1 )
        {
          ...
          while ( 1 )
          {
            if ( svtIdList->max_length == v12 )
              goto LABEL_35;
            v13 = (char *)svtIdList + 4 * v12;
            v15 = *((_DWORD *)v13 + 8);
            v14 = v13 + 32;
            if ( (_DWORD)oldList == v15 )
              break;
            if ( (_DWORD)v7 == ++v12 )
              goto LABEL_19;
          }
