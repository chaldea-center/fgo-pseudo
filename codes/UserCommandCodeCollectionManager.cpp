void UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  UserCommandCodeCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6946/*"Fgo_20180629_1"*/;
  sub_21FFBF4(
...
void UserCommandCodeCollectionManager__SetOld_50566336(System_Int32_array *svtIdList, const MethodInfo *method)
{
  __int64 v3; // x22
  System_Collections_Generic_List_int__o *oldList; // x0
