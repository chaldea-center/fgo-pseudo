void UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2DDEF & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_6682/*"Fgo_20180629_1"*/);
    byte_4D2DDEF = 1;
  }
  ...
  if ( v1->static_fields->isContinueDevice )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_319C134 *)Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___)) == 0 )
    {
...
void UserCommandCodeCollectionManager__SetOld_44404380(System_Int32_array *svtIdList, const MethodInfo *method)
{
