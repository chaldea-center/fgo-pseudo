void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A20CF6 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserCommandCodeCollectionManager_TypeInfo, v5);
    sub_1B715CC(&StringLiteral_6618/*"Fgo_20180629_1"*/, v6);
    byte_4A20CF6 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_4A20CEF & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserCommandCodeCollectionManager_TypeInfo, v3);
    byte_4A20CEF = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20CED & 1) == 0 )
  {
    sub_1B715CC(&UserCommandCodeCollectionManager_TypeInfo, v1);
    byte_4A20CED = 1;
  }
...
bool __fastcall UserCommandCodeCollectionManager__IsNew(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( (byte_4A20CF1 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserCommandCodeCollectionManager_TypeInfo, v4);
    byte_4A20CF1 = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_4A20CF0 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___, v1);
  ...
  if ( v4->static_fields->isContinueDevice )
  {
    ...
    if ( !Instance
      || (Instance = DataManager__GetMasterData_object_(
                       ...
                       (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___)) == 0LL )
    {
...
void __fastcall UserCommandCodeCollectionManager__SetOld_40322672(
...
bool __fastcall UserCommandCodeCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_4A20CF5 & 1) == 0 )
  {
    ...
    sub_1B715CC(&UserCommandCodeCollectionManager_TypeInfo, v6);
    byte_4A20CF5 = 1;
  }
