void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5C39D & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_6639/*"Fgo_20180629_1"*/);
    byte_4A5C39D = 1;
  }
  UserCommandCodeCollectionManager_TypeInfo->static_fields->SAVE_DATA_VERSION = (struct System_String_o *)StringLiteral_6639/*"Fgo_20180629_1"*/;
  sub_1B88554(
    (ServantStatusBattleListViewItem_o *)UserCommandCodeCollectionManager_TypeInfo->static_fields,
    StringLiteral_6639/*"Fgo_20180629_1"*/,
    v1,
    v2);
  *(_WORD *)&UserCommandCodeCollectionManager_TypeInfo->static_fields->isModfiy = 0;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->oldList, (int32_t)v3, v5, v6);
}
...
bool __fastcall UserCommandCodeCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  if ( !v2->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
      ...
      {
LABEL_35:
        v27 = sub_1BDA590(v8, System_IDisposable_TypeInfo, 0LL);
      }
...
void __fastcall UserCommandCodeCollectionManager__SetOld_40535512(
...
bool __fastcall UserCommandCodeCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  if ( !v3->static_fields->UseMock )
  {
    ...
    {
LABEL_27:
      v21 = sub_1BDA590(v7, System_IDisposable_TypeInfo, 0LL);
    }
