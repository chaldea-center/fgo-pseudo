void __fastcall UserCommandCodeCollectionManager___cctor(const MethodInfo *method)
{
  ...
  UserCommandCodeCollectionManager_c *v19; // x8
  System_Collections_Generic_List_int__o *v20; // x19
  struct UserCommandCodeCollectionManager_StaticFields *v21; // x0
  ...
  if ( (byte_42EA183 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeCollectionManager_TypeInfo, v11, v12, v13);
    sub_B5D5C4(&StringLiteral_6697/*"Fgo_20180629_1"*/, v14, v15, v16);
    byte_42EA183 = 1;
  }
  static_fields = (BattleServantConfConponent_o *)UserCommandCodeCollectionManager_TypeInfo->static_fields;
  v18 = (System_Int32_array **)StringLiteral_6697/*"Fgo_20180629_1"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_6697/*"Fgo_20180629_1"*/;
  ...
  v21 = UserCommandCodeCollectionManager_TypeInfo->static_fields;
  v21->oldList = v20;
...
void __fastcall UserCommandCodeCollectionManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_42EA17C & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeCollectionManager_TypeInfo, v7, v8, v9);
    byte_42EA17C = 1;
  }
...
void __fastcall UserCommandCodeCollectionManager__CreateContinueDeviceSaveData(const MethodInfo *method)
{
  ...
  UserCommandCodeCollectionManager_c *v6; // x8
  const MethodInfo *v7; // x0

  if ( (byte_42EA17A & 1) == 0 )
  {
    sub_B5D5C4(&UserCommandCodeCollectionManager_TypeInfo, v1, v2, v3);
    byte_42EA17A = 1;
  }
  ...
  UserCommandCodeCollectionManager__DeleteSaveData((const MethodInfo *)v4);
  UserCommandCodeCollectionManager__ClearSaveDataList(v5);
...
void __fastcall UserCommandCodeCollectionManager__Initialize(const MethodInfo *method)
{
  ...
  UserCommandCodeCollectionManager__ReadData((const MethodInfo *)v4);
}
...
void __fastcall UserCommandCodeCollectionManager__LoginProcess(const MethodInfo *method)
{
  ...
  if ( (byte_42EA17D & 1) == 0 )
  {
    sub_B5D5C4(&Method_DataManager_GetMasterData_UserCommandCodeCollectionMaster___, v1, v2, v3);
  ...
  if ( v10->static_fields->isContinueDevice )
  {
    ...
    UserCommandCodeCollectionMaster__continueDeviceUserCommandCodeCollection(
      ...
      v12);
    v13 = (const MethodInfo *)UserCommandCodeCollectionManager_TypeInfo;
    if ( (BYTE3(UserCommandCodeCollectionManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UserCommandCodeCollectionManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserCommandCodeCollectionManager_TypeInfo);
    ...
    UserCommandCodeCollectionManager__WriteData(v13);
  }
}
...
bool __fastcall UserCommandCodeCollectionManager__ReadData(const MethodInfo *method)
{
  ...
  __int64 v40; // x0
  UserCommandCodeCollectionManager_c *v41; // x0
  ...
  if ( (byte_42EA181 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeCollectionManager_TypeInfo, v13, v14, v15);
    byte_42EA181 = 1;
  }
  ...
  SaveFileName = UserCommandCodeCollectionManager__getSaveFileName((const MethodInfo *)v19);
  if ( System_IO_File__Exists(SaveFileName, 0LL) )
  {
    ...
    UserCommandCodeCollectionManager__ClearSaveDataList((const MethodInfo *)v21);
...
LABEL_39:
  ...
  {
    v41 = UserCommandCodeCollectionManager_TypeInfo;
    if ( (BYTE3(UserCommandCodeCollectionManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !UserCommandCodeCollectionManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(UserCommandCodeCollectionManager_TypeInfo);
    }
    UserCommandCodeCollectionManager__ClearSaveDataList((const MethodInfo *)v41);
    return 0;
  }
}
...
void __fastcall UserCommandCodeCollectionManager__SetOld(int32_t svtId, const MethodInfo *method)
{
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      v14 = UserCommandCodeCollectionManager_TypeInfo;
      ++v18;
      v17 = (BYTE3(UserCommandCodeCollectionManager_TypeInfo->vtable._0_Equals.methodPtr) >> 2) & 1;
      if ( (int)v18 >= size )
        goto LABEL_17;
    }
LABEL_23:
...
LABEL_17:
  ...
  v14 = (UserCommandCodeCollectionManager_c *)v14->static_fields->oldList;
  if ( !v14 )
    goto LABEL_23;
  System_Collections_Generic_List_int___Add(
...
void __fastcall UserCommandCodeCollectionManager__SetOld_28031664(
...
LABEL_25:
          ...
          while ( 1 )
          {
            ...
            if ( v23[v22] >= 1 )
            {
              ...
              if ( v22 >= max_length )
                break;
              v15 = (UserCommandCodeCollectionManager_c *)v15->static_fields->oldList;
              if ( !v15 )
                goto LABEL_37;
              System_Collections_Generic_List_int___Add(
...
bool __fastcall UserCommandCodeCollectionManager__WriteData(const MethodInfo *method)
{
  ...
  __int64 v29; // x1
  UserCommandCodeCollectionManager_c *v30; // x0
  struct UserCommandCodeCollectionManager_StaticFields *v31; // x8
  struct System_Collections_Generic_List_int__o *oldList; // x9
  signed __int64 size; // x20
  __int64 v34; // x1
  __int64 v35; // x3
  unsigned __int64 i; // x22
  UserCommandCodeCollectionManager_c *v37; // x0
  ...
  if ( (byte_42EA182 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&UserCommandCodeCollectionManager_TypeInfo, v16, v17, v18);
    byte_42EA182 = 1;
  }
  v19 = UserCommandCodeCollectionManager_TypeInfo;
  if ( (BYTE3(UserCommandCodeCollectionManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
  ...
  *p_isModfiy = 0;
  ...
  if ( !v23->static_fields->UseMock )
  {
    ...
    SaveFileName = UserCommandCodeCollectionManager__getSaveFileName((const MethodInfo *)v25);
    ...
    if ( (int)size >= 1 )
    {
      ...
      {
        v37 = UserCommandCodeCollectionManager_TypeInfo;
        if ( (BYTE3(UserCommandCodeCollectionManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
          && !UserCommandCodeCollectionManager_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(UserCommandCodeCollectionManager_TypeInfo);
