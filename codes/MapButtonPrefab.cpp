void __fastcall MapButtonPrefab___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4B052 & 1) == 0 )
  {
    sub_1B863B8(&MapButtonPrefab_TypeInfo, v1);
    sub_1B863B8(&StringLiteral_17235/*"btn_bg_16"*/, v4);
    sub_1B863B8(&StringLiteral_21100/*"map_button_{0}_c"*/, v5);
    sub_1B863B8(&StringLiteral_6015/*"EntryAnim"*/, v6);
    sub_1B863B8(&StringLiteral_21099/*"map_button_{0}"*/, v7);
    byte_4A4B052 = 1;
  }
  MapButtonPrefab_TypeInfo->static_fields->MAP_BUTTON_SP_NAME = (struct System_String_o *)StringLiteral_21099/*"map_button_{0}"*/;
  sub_1B8635C((CGThumbnailListItem_o *)MapButtonPrefab_TypeInfo->static_fields, StringLiteral_21099/*"map_button_{0}"*/, v2, v3);
  v8 = StringLiteral_21100/*"map_button_{0}_c"*/;
  static_fields = MapButtonPrefab_TypeInfo->static_fields;
  static_fields->MAP_CURRENT_BUTTON_SP_NAME = (struct System_String_o *)StringLiteral_21100/*"map_button_{0}_c"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&static_fields->MAP_CURRENT_BUTTON_SP_NAME, v8, v10, v11);
  v12 = StringLiteral_17235/*"btn_bg_16"*/;
  v13 = MapButtonPrefab_TypeInfo->static_fields;
  v13->DEFAULT_BUTTON_SP = (struct System_String_o *)StringLiteral_17235/*"btn_bg_16"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v13->DEFAULT_BUTTON_SP, v12, v14, v15);
  v16 = MapButtonPrefab_TypeInfo->static_fields;
  *(_QWORD *)&v16->FRAME_IN_ANIM_DURATION = 0x3DCCCCCD3E4CCCCDLL;
  v17 = StringLiteral_6015/*"EntryAnim"*/;
  v16->FUNC_ENTRY_ANIM = (struct System_String_o *)StringLiteral_6015/*"EntryAnim"*/;
  sub_1B8635C((CGThumbnailListItem_o *)&v16->FUNC_ENTRY_ANIM, v17, v18, v19);
...
void __fastcall MapButtonPrefab___ctor(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4B051 & 1) == 0 )
  {
    sub_1B863B8(&MapButtonPrefab_TypeInfo, method);
    byte_4A4B051 = 1;
  }
...
void __fastcall MapButtonPrefab__ExecAnimEndAction(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  sub_1B8635C(p_animEndAction, 0, v2, v3);
...
void __fastcall MapButtonPrefab__FrameIn(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4B04E & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_MapButtonPrefab__FrameIn_b__31_0__, v3);
    sub_1B863B8(&MapButtonPrefab_TypeInfo, v4);
    sub_1B863B8(&Method_UITweener_Begin_TweenPosition___, v5);
    byte_4A4B04E = 1;
  }
...
LABEL_8:
  ...
  *(_QWORD *)(gameObject + 140) = v12;
  ...
  v14 = (EventDelegate_Callback_o *)sub_1B86604(EventDelegate_Callback_TypeInfo);
...
void __fastcall MapButtonPrefab__FrameOut(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&EventDelegate_Callback_TypeInfo, method);
    sub_1B863B8(&Method_MapButtonPrefab__FrameOut_b__32_0__, v3);
    sub_1B863B8(&MapButtonPrefab_TypeInfo, v4);
    sub_1B863B8(&Method_UITweener_Begin_TweenPosition___, v5);
    byte_4A4B04F = 1;
  }
...
void __fastcall MapButtonPrefab__SetBadge(MapButtonPrefab_o *this, int32_t num, const MethodInfo *method)
{
  ...
  if ( (byte_4A4B04B & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_NoticeNumberComponent___, *(_QWORD *)&num);
  ...
  if ( UnityEngine_Object__op_Equality(mNoticeNumber, 0LL, 0LL) )
  {
    ...
    *p_mNoticeNumber = (struct NoticeNumberComponent_o *)Component_object;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mNoticeNumber, (int32_t)Component_object, v12, v13);
  }
  mNoticeNumberObj = (UnityEngine_GameObject_o *)*p_mNoticeNumber;
  if ( !*p_mNoticeNumber )
LABEL_10:
    sub_1B86614(mNoticeNumberObj, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B04A & 1) == 0 )
  {
    sub_1B863B8(&int_TypeInfo, isMapModel);
    sub_1B863B8(&MapButtonPrefab_TypeInfo, v11);
...
LABEL_15:
  ...
  {
LABEL_26:
    sub_1B86614(buttonSprite, isMapModel);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B04D & 1) == 0 )
  {
    sub_1B863B8(&MapButtonPrefab_TypeInfo, endAction);
    byte_4A4B04D = 1;
  }
  this->fields.animEndAction = endAction;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.animEndAction, (int32_t)endAction, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4B049 & 1) == 0 )
  {
    sub_1B863B8(&Method_GameObjectExtensions_SafeGetComponent_BoxCollider___, mapAtlases);
    sub_1B863B8(&Method_GameObjectExtensions_SafeGetComponent_UISprite___, v15);
    byte_4A4B049 = 1;
  }
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mapButtonEntity, (int32_t)mapButtonEntity, v16, v17);
  this->fields.mapAtlases = mapAtlases;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mapAtlases, (int32_t)mapAtlases, v18, v19);
  this->fields.commonUiAtlas = commonUiAtlas;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.commonUiAtlas, (int32_t)commonUiAtlas, v20, v21);
  this->fields.isNew = v14;
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  Component_object = GameObjectExtensions__SafeGetComponent_object_(
                       gameObject,
                       (const MethodInfo_2FC28D8 *)Method_GameObjectExtensions_SafeGetComponent_BoxCollider___);
  ...
  sub_1B8635C((CGThumbnailListItem_o *)p_buttonSprite, (int32_t)v25, v27, v28);
