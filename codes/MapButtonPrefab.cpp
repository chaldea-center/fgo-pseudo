void __fastcall MapButtonPrefab___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C902 & 1) == 0 )
  {
    sub_1B715CC(&MapButtonPrefab_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_17427/*"btn_bg_16"*/, v4);
    sub_1B715CC(&StringLiteral_21220/*"map_button_{0}_c"*/, v5);
    sub_1B715CC(&StringLiteral_6025/*"EntryAnim"*/, v6);
    sub_1B715CC(&StringLiteral_21219/*"map_button_{0}"*/, v7);
    byte_4A1C902 = 1;
  }
  MapButtonPrefab_TypeInfo->static_fields->MAP_BUTTON_SP_NAME = (struct System_String_o *)StringLiteral_21219/*"map_button_{0}"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)MapButtonPrefab_TypeInfo->static_fields, StringLiteral_21219/*"map_button_{0}"*/, v2, v3);
  v8 = StringLiteral_21220/*"map_button_{0}_c"*/;
  static_fields = MapButtonPrefab_TypeInfo->static_fields;
  static_fields->MAP_CURRENT_BUTTON_SP_NAME = (struct System_String_o *)StringLiteral_21220/*"map_button_{0}_c"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->MAP_CURRENT_BUTTON_SP_NAME, v8, v10, v11);
  v12 = StringLiteral_17427/*"btn_bg_16"*/;
  v13 = MapButtonPrefab_TypeInfo->static_fields;
  v13->DEFAULT_BUTTON_SP = (struct System_String_o *)StringLiteral_17427/*"btn_bg_16"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v13->DEFAULT_BUTTON_SP, v12, v14, v15);
  v16 = MapButtonPrefab_TypeInfo->static_fields;
  *(_QWORD *)&v16->FRAME_IN_ANIM_DURATION = 0x3DCCCCCD3E4CCCCDLL;
  v17 = StringLiteral_6025/*"EntryAnim"*/;
  v16->FUNC_ENTRY_ANIM = (struct System_String_o *)StringLiteral_6025/*"EntryAnim"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v16->FUNC_ENTRY_ANIM, v17, v18, v19);
...
void __fastcall MapButtonPrefab___ctor(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C901 & 1) == 0 )
  {
    sub_1B715CC(&MapButtonPrefab_TypeInfo, method);
    byte_4A1C901 = 1;
  }
...
void __fastcall MapButtonPrefab__ExecAnimEndAction(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570(p_animEndAction, 0, v2, v3);
...
void __fastcall MapButtonPrefab__FrameIn(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C8FE & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_MapButtonPrefab__FrameIn_b__31_0__, v3);
    sub_1B715CC(&MapButtonPrefab_TypeInfo, v4);
    sub_1B715CC(&Method_UITweener_Begin_TweenPosition___, v5);
    byte_4A1C8FE = 1;
  }
...
LABEL_8:
  ...
  *(_QWORD *)(gameObject + 140) = v12;
  ...
  v14 = (EventDelegate_Callback_o *)sub_1B71818(EventDelegate_Callback_TypeInfo);
...
void __fastcall MapButtonPrefab__FrameOut(MapButtonPrefab_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&EventDelegate_Callback_TypeInfo, method);
    sub_1B715CC(&Method_MapButtonPrefab__FrameOut_b__32_0__, v3);
    sub_1B715CC(&MapButtonPrefab_TypeInfo, v4);
    sub_1B715CC(&Method_UITweener_Begin_TweenPosition___, v5);
    byte_4A1C8FF = 1;
  }
  ...
  *(void **)((char *)&v8[8].monitor + 4) = v11;
  v12 = (UITweener_o *)v8;
  v13 = (EventDelegate_Callback_o *)sub_1B71818(EventDelegate_Callback_TypeInfo);
...
void __fastcall MapButtonPrefab__SetBadge(MapButtonPrefab_o *this, int32_t num, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C8FB & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_NoticeNumberComponent___, *(_QWORD *)&num);
  ...
  if ( UnityEngine_Object__op_Equality(mNoticeNumber, 0LL, 0LL) )
  {
    ...
    *p_mNoticeNumber = (struct NoticeNumberComponent_o *)Component_object;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mNoticeNumber, (int32_t)Component_object, v12, v13);
  }
  mNoticeNumberObj = (UnityEngine_GameObject_o *)*p_mNoticeNumber;
  if ( !*p_mNoticeNumber )
LABEL_10:
    sub_1B71828(mNoticeNumberObj, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C8FA & 1) == 0 )
  {
    sub_1B715CC(&int_TypeInfo, isMapModel);
    sub_1B715CC(&MapButtonPrefab_TypeInfo, v11);
...
LABEL_15:
  ...
  {
LABEL_26:
    sub_1B71828(buttonSprite, isMapModel);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C8FD & 1) == 0 )
  {
    sub_1B715CC(&MapButtonPrefab_TypeInfo, endAction);
    byte_4A1C8FD = 1;
  }
  this->fields.animEndAction = endAction;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.animEndAction, (int32_t)endAction, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C8F9 & 1) == 0 )
  {
    sub_1B715CC(&Method_GameObjectExtensions_SafeGetComponent_BoxCollider___, mapAtlases);
    sub_1B715CC(&Method_GameObjectExtensions_SafeGetComponent_UISprite___, v15);
    byte_4A1C8F9 = 1;
  }
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mapButtonEntity, (int32_t)mapButtonEntity, v16, v17);
  this->fields.mapAtlases = mapAtlases;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mapAtlases, (int32_t)mapAtlases, v18, v19);
  this->fields.commonUiAtlas = commonUiAtlas;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.commonUiAtlas, (int32_t)commonUiAtlas, v20, v21);
  this->fields.isNew = v14;
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  Component_object = GameObjectExtensions__SafeGetComponent_object_(
                       gameObject,
                       (const MethodInfo_2EAC480 *)Method_GameObjectExtensions_SafeGetComponent_BoxCollider___);
  ...
  v25 = GameObjectExtensions__SafeGetComponent_object_(
          v24,
          (const MethodInfo_2EAC480 *)Method_GameObjectExtensions_SafeGetComponent_UISprite___);
  this->fields.buttonSprite = (struct UISprite_o *)v25;
  p_buttonSprite = &this->fields.buttonSprite;
  sub_1B71570((ServantStatusBattleListViewItem_o *)p_buttonSprite, (int32_t)v25, v27, v28);
