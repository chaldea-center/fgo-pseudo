        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F84C & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_22169/*"num"*/, *(_QWORD *)&recoverId);
    sub_1B761C0(&StringLiteral_22803/*"recoverId"*/, v7);
    byte_4A2F84C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22803/*"recoverId"*/, recoverId, method);
...
System_String_o *__fastcall RecoverUseItemRequest__getURL(RecoverUseItemRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F84B & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_20871/*"item/recover"*/, v2);
    byte_4A2F84B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_20871/*"item/recover"*/, 0LL);
}
