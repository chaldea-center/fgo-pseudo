        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1E04A & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_22137/*"num"*/, *(_QWORD *)&recoverId);
    sub_1BCAFF8(&StringLiteral_22782/*"recoverId"*/, v7);
    byte_4B1E04A = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22782/*"recoverId"*/, recoverId, method);
...
System_String_o *__fastcall RecoverUseItemRequest__getURL(RecoverUseItemRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1E049 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_20828/*"item/recover"*/, v2);
    byte_4B1E049 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_20828/*"item/recover"*/, 0LL);
}
