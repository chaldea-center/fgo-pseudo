        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3F6F & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_21876/*"num"*/, *(_QWORD *)&recoverId);
    sub_1B00CCC(&StringLiteral_22499/*"recoverId"*/, v7);
    byte_48E3F6F = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22499/*"recoverId"*/, recoverId, method);
...
System_String_o *__fastcall RecoverUseItemRequest__getURL(RecoverUseItemRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3F6E & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_20596/*"item/recover"*/, v2);
    byte_48E3F6E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_20596/*"item/recover"*/, 0LL);
}
