        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6855F & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22496/*"num"*/, *(_QWORD *)&recoverId);
    sub_1BE4ACC(&StringLiteral_23136/*"recoverId"*/, v7);
    byte_4B6855F = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23136/*"recoverId"*/, recoverId, method);
...
System_String_o *__fastcall RecoverUseItemRequest__getURL(RecoverUseItemRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6855E & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_21177/*"item/recover"*/, v2);
    byte_4B6855E = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_21177/*"item/recover"*/, 0LL);
}
