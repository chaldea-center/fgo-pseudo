...
void __fastcall FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1D0D & 1) == 0 )
  {
    ...
    sub_1B00CCC(&FadeLogger_TypeInfo, v3);
    sub_1B00CCC(&UnityEngine_GUI_TypeInfo, v4);
    sub_1B00CCC(&string___TypeInfo, v5);
    sub_1B00CCC(&StringLiteral_1836/*"<size="*/, v6);
    sub_1B00CCC(&StringLiteral_15700/*"[FADE]\n"*/, v7);
    sub_1B00CCC(&StringLiteral_1/*""*/, v8);
    sub_1B00CCC(&StringLiteral_1624/*"</size>"*/, v9);
    sub_1B00CCC(&StringLiteral_1857/*">"*/, v10);
    byte_48E1D0D = 1;
  }
  ...
  if ( UnityEngine_Application__get_isPlaying(0LL) )
  {
    ...
    v13 = System_String__Concat_60325748((System_String_o *)StringLiteral_15700/*"[FADE]\n"*/, FadeLog, 0LL);
    ...
    v15 = (System_String_o *)sub_1B00D74(string___TypeInfo, 5LL);
    if ( !v15 )
      sub_1B00F28(0LL, v16);
    v19 = v15;
    if ( !LODWORD(v15[1].klass) )
      goto LABEL_18;
    v20 = StringLiteral_1836/*"<size="*/;
    v15[1].monitor = (void *)StringLiteral_1836/*"<size="*/;
    ...
    if ( LODWORD(v19[1].klass) <= 1
      ...
      || (v25 = StringLiteral_1857/*">"*/,
          v19[2].klass = (System_String_c *)StringLiteral_1857/*">"*/,
          sub_1B00C70((ServantStatusBattleListViewItem_o *)&v19[2], v25, v23, v24),
          LODWORD(v19[1].klass) <= 3)
      || (v19[2].monitor = v13,
          sub_1B00C70((ServantStatusBattleListViewItem_o *)&v19[2].monitor, (int32_t)v13, v26, v27),
          LODWORD(v19[1].klass) <= 4) )
    {
LABEL_18:
      sub_1B00F30(v15, v16);
    }
    v30 = StringLiteral_1624/*"</size>"*/;
    v19[2].fields = (System_String_Fields)StringLiteral_1624/*"</size>"*/;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&v19[2].fields, v30, v28, v29);
    v31 = System_String__Concat_60339276((System_String_array *)v19, 0LL);
