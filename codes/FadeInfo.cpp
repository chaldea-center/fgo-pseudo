...
void FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596FBA9 & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_16543/*"[FADE]\n"*/);
  ...
  if ( UnityEngine_Application__get_isPlaying(0) )
  {
    ...
    v6 = System_String__Concat_75651716((System_String_o *)StringLiteral_16543/*"[FADE]\n"*/, FadeLog, 0);
    ...
    v9 = (System_String_o *)sub_2213B20(string___TypeInfo, 5);
    if ( !v9 )
      sub_2213CDC(0, v10);
    v17 = v9;
    if ( !LODWORD(v9[1].klass) )
      goto LABEL_18;
    v18 = StringLiteral_1805/*"<size="*/;
    v9[1].monitor = (void *)StringLiteral_1805/*"<size="*/;
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&v9[1].monitor, v18, v11, v12, v13, v14, v15, v16);
    v46 = v8 * 18.0;
    ...
    if ( ((__int64)v17[1].klass & 0xFFFFFFFE) == 0
      || (v17[1].fields = (System_String_Fields)v9,
          sub_2213A04((MissionNaviTransitionBoardItem_o *)&v17[1].fields, (int32_t)v9, v19, v20, v21, v22, v23, v24),
          LODWORD(v17[1].klass) <= 2)
      || (v31 = StringLiteral_1831/*">"*/,
          v17[2].klass = (System_String_c *)StringLiteral_1831/*">"*/,
          sub_2213A04((MissionNaviTransitionBoardItem_o *)&v17[2], v31, v25, v26, v27, v28, v29, v30),
          ((__int64)v17[1].klass & 0xFFFFFFFC) == 0)
      || (v17[2].monitor = v6,
          sub_2213A04((MissionNaviTransitionBoardItem_o *)&v17[2].monitor, (int32_t)v6, v32, v33, v34, v35, v36, v37),
          LODWORD(v17[1].klass) <= 4) )
    {
LABEL_18:
      sub_2213CE4(v9);
    }
    v44 = StringLiteral_1607/*"</size>"*/;
    v17[2].fields = (System_String_Fields)StringLiteral_1607/*"</size>"*/;
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&v17[2].fields, v44, v38, v39, v40, v41, v42, v43);
    v45 = System_String__Concat_75697120((System_String_array *)v17, 0);
