...
void __fastcall FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43EBE & 1) == 0 )
  {
    ...
    sub_1BDB878(&FadeLogger_TypeInfo, v3);
    sub_1BDB878(&UnityEngine_GUI_TypeInfo, v4);
    sub_1BDB878(&string___TypeInfo, v5);
    sub_1BDB878(&StringLiteral_1747/*"<size="*/, v6);
    sub_1BDB878(&StringLiteral_15900/*"[FADE]\n"*/, v7);
    sub_1BDB878(&StringLiteral_1/*""*/, v8);
    sub_1BDB878(&StringLiteral_1551/*"</size>"*/, v9);
    sub_1BDB878(&StringLiteral_1773/*">"*/, v10);
    byte_4B43EBE = 1;
  }
  ...
  if ( UnityEngine_Application__get_isPlaying(0LL) )
  {
    ...
    v13 = System_String__Concat_62572260((System_String_o *)StringLiteral_15900/*"[FADE]\n"*/, FadeLog, 0LL);
    ...
    v15 = (System_String_o *)sub_1BDB920(string___TypeInfo, 5LL);
    if ( !v15 )
      sub_1BDBAD4(0LL, v16);
    v19 = v15;
    if ( !LODWORD(v15[1].klass) )
      goto LABEL_18;
    v20 = StringLiteral_1747/*"<size="*/;
    v15[1].monitor = (void *)StringLiteral_1747/*"<size="*/;
    sub_1BDB81C((CGThumbnailListItem_o *)&v15[1].monitor, v20, v17, v18);
    v28 = v14 * 18.0;
    v15 = System_Single__ToString(v14 * 18.0, (const MethodInfo *)&v28);
    if ( LODWORD(v19[1].klass) <= 1
      || (v19[1].fields = (System_String_Fields)v15,
          sub_1BDB81C((CGThumbnailListItem_o *)&v19[1].fields, (int32_t)v15, v17, v21),
          LODWORD(v19[1].klass) <= 2)
      || (v23 = StringLiteral_1773/*">"*/,
          v19[2].klass = (System_String_c *)StringLiteral_1773/*">"*/,
          sub_1BDB81C((CGThumbnailListItem_o *)&v19[2], v23, v17, v22),
          LODWORD(v19[1].klass) <= 3)
      || (v19[2].monitor = v13,
          sub_1BDB81C((CGThumbnailListItem_o *)&v19[2].monitor, (int32_t)v13, v17, v24),
          LODWORD(v19[1].klass) <= 4) )
    {
LABEL_18:
      sub_1BDBADC(v15, v16, v17);
    }
    v26 = StringLiteral_1551/*"</size>"*/;
    v19[2].fields = (System_String_Fields)StringLiteral_1551/*"</size>"*/;
    sub_1BDB81C((CGThumbnailListItem_o *)&v19[2].fields, v26, v17, v25);
    v27 = System_String__Concat_62612776((System_String_array *)v19, 0LL);
