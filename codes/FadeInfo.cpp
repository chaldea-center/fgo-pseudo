...
void __fastcall FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDFFE & 1) == 0 )
  {
    ...
    sub_1B64A00(&FadeLogger_TypeInfo, v3);
    sub_1B64A00(&UnityEngine_GUI_TypeInfo, v4);
    sub_1B64A00(&string___TypeInfo, v5);
    sub_1B64A00(&StringLiteral_1842/*"<size="*/, v6);
    sub_1B64A00(&StringLiteral_15866/*"[FADE]\n"*/, v7);
    sub_1B64A00(&StringLiteral_1/*""*/, v8);
    sub_1B64A00(&StringLiteral_1630/*"</size>"*/, v9);
    sub_1B64A00(&StringLiteral_1863/*">"*/, v10);
    byte_49FDFFE = 1;
  }
  ...
  if ( UnityEngine_Application__get_isPlaying(0LL) )
  {
    ...
    v13 = System_String__Concat_61385136((System_String_o *)StringLiteral_15866/*"[FADE]\n"*/, FadeLog, 0LL);
    ...
    v15 = (System_String_o *)sub_1B64AA8(string___TypeInfo, 5LL);
    if ( !v15 )
      sub_1B64C5C(0LL, v16);
    v19 = v15;
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&v15[1].monitor, v20, v17, v18);
    v32 = v14 * 18.0;
    v15 = System_Single__ToString(v14 * 18.0, (const MethodInfo *)&v32);
    if ( LODWORD(v19[1].klass) <= 1
      || (v19[1].fields = (System_String_Fields)v15,
          sub_1B649A4((ServantStatusBattleListViewItem_o *)&v19[1].fields, (int32_t)v15, v21, v22),
          LODWORD(v19[1].klass) <= 2)
      || (v25 = StringLiteral_1863/*">"*/,
          v19[2].klass = (System_String_c *)StringLiteral_1863/*">"*/,
          sub_1B649A4((ServantStatusBattleListViewItem_o *)&v19[2], v25, v23, v24),
          LODWORD(v19[1].klass) <= 3)
      || (v19[2].monitor = v13,
          sub_1B649A4((ServantStatusBattleListViewItem_o *)&v19[2].monitor, (int32_t)v13, v26, v27),
...
LABEL_18:
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&v19[2].fields, v30, v28, v29);
    v31 = System_String__Concat_61398664((System_String_array *)v19, 0LL);
