...
void __fastcall FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB51EC & 1) == 0 )
  {
    ...
    sub_1BAB41C(&FadeLogger_TypeInfo, v3);
    sub_1BAB41C(&UnityEngine_GUI_TypeInfo, v4);
    sub_1BAB41C(&string___TypeInfo, v5);
    sub_1BAB41C(&StringLiteral_1837/*"<size="*/, v6);
    sub_1BAB41C(&StringLiteral_15961/*"[FADE]\n"*/, v7);
    sub_1BAB41C(&StringLiteral_1/*""*/, v8);
    sub_1BAB41C(&StringLiteral_1625/*"</size>"*/, v9);
    sub_1BAB41C(&StringLiteral_1858/*">"*/, v10);
    byte_4AB51EC = 1;
  }
  ...
  if ( UnityEngine_Application__get_isPlaying(0LL) )
  {
    ...
    v13 = System_String__Concat_62048128((System_String_o *)StringLiteral_15961/*"[FADE]\n"*/, FadeLog, 0LL);
    ...
    v15 = (System_String_o *)sub_1BAB4C4(string___TypeInfo, 5LL);
    if ( !v15 )
      sub_1BAB678(0LL, v16);
    v19 = v15;
    if ( !LODWORD(v15[1].klass) )
      goto LABEL_18;
    v20 = StringLiteral_1837/*"<size="*/;
    v15[1].monitor = (void *)StringLiteral_1837/*"<size="*/;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v15[1].monitor, v20, v17, v18);
    v32 = v14 * 18.0;
    v15 = System_Single__ToString(v14 * 18.0, (const MethodInfo *)&v32);
    if ( LODWORD(v19[1].klass) <= 1
      || (v19[1].fields = (System_String_Fields)v15,
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v19[1].fields, (int32_t)v15, v21, v22),
          LODWORD(v19[1].klass) <= 2)
      || (v25 = StringLiteral_1858/*">"*/,
          v19[2].klass = (System_String_c *)StringLiteral_1858/*">"*/,
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v19[2], v25, v23, v24),
          LODWORD(v19[1].klass) <= 3)
      || (v19[2].monitor = v13,
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v19[2].monitor, (int32_t)v13, v26, v27),
          LODWORD(v19[1].klass) <= 4) )
    {
LABEL_18:
      sub_1BAB680(v15, v16);
    }
    v30 = StringLiteral_1625/*"</size>"*/;
    v19[2].fields = (System_String_Fields)StringLiteral_1625/*"</size>"*/;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&v19[2].fields, v30, v28, v29);
    v31 = System_String__Concat_62061656((System_String_array *)v19, 0LL);
