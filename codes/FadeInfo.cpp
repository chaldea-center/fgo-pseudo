...
void __fastcall FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2D400 & 1) == 0 )
  {
    ...
    sub_1B761C0(&FadeLogger_TypeInfo, v3);
    sub_1B761C0(&UnityEngine_GUI_TypeInfo, v4);
    sub_1B761C0(&string___TypeInfo, v5);
    sub_1B761C0(&StringLiteral_1840/*"<size="*/, v6);
    sub_1B761C0(&StringLiteral_15925/*"[FADE]\n"*/, v7);
    sub_1B761C0(&StringLiteral_1/*""*/, v8);
    sub_1B761C0(&StringLiteral_1628/*"</size>"*/, v9);
    sub_1B761C0(&StringLiteral_1861/*">"*/, v10);
    byte_4A2D400 = 1;
  }
  ...
  if ( UnityEngine_Application__get_isPlaying(0LL) )
  {
    ...
    v13 = System_String__Concat_61535060((System_String_o *)StringLiteral_15925/*"[FADE]\n"*/, FadeLog, 0LL);
    ...
    v15 = (System_String_o *)sub_1B76268(string___TypeInfo, 5LL);
    if ( !v15 )
      sub_1B7641C(0LL, v16);
    v19 = v15;
    ...
    if ( LODWORD(v19[1].klass) <= 1
      ...
      || (v19[2].monitor = v13,
          sub_1B76164((ServantStatusBattleListViewItem_o *)&v19[2].monitor, (int32_t)v13, v26, v27),
...
LABEL_18:
    ...
    sub_1B76164((ServantStatusBattleListViewItem_o *)&v19[2].fields, v30, v28, v29);
    v31 = System_String__Concat_61548588((System_String_array *)v19, 0LL);
