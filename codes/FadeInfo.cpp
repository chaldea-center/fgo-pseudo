...
void __fastcall FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0812D & 1) == 0 )
  {
    ...
    sub_1B686D4(&FadeLogger_TypeInfo, v3);
    sub_1B686D4(&UnityEngine_GUI_TypeInfo, v4);
    sub_1B686D4(&string___TypeInfo, v5);
    sub_1B686D4(&StringLiteral_1840/*"<size="*/, v6);
    sub_1B686D4(&StringLiteral_15865/*"[FADE]\n"*/, v7);
    sub_1B686D4(&StringLiteral_1/*""*/, v8);
    sub_1B686D4(&StringLiteral_1628/*"</size>"*/, v9);
    sub_1B686D4(&StringLiteral_1861/*">"*/, v10);
    byte_4A0812D = 1;
  }
  ...
  if ( UnityEngine_Application__get_isPlaying(0LL) )
  {
    ...
    v13 = System_String__Concat_61419468((System_String_o *)StringLiteral_15865/*"[FADE]\n"*/, FadeLog, 0LL);
    ...
    v15 = (System_String_o *)sub_1B6877C(string___TypeInfo, 5LL);
    if ( !v15 )
      sub_1B68930(0LL, v16);
    v19 = v15;
    if ( !LODWORD(v15[1].klass) )
      goto LABEL_18;
    v20 = StringLiteral_1840/*"<size="*/;
    v15[1].monitor = (void *)StringLiteral_1840/*"<size="*/;
    sub_1B68678((ServantStatusBattleListViewItem_o *)&v15[1].monitor, v20, v17, v18);
    v32 = v14 * 18.0;
    v15 = System_Single__ToString(v14 * 18.0, (const MethodInfo *)&v32);
    if ( LODWORD(v19[1].klass) <= 1
      || (v19[1].fields = (System_String_Fields)v15,
          sub_1B68678((ServantStatusBattleListViewItem_o *)&v19[1].fields, (int32_t)v15, v21, v22),
          LODWORD(v19[1].klass) <= 2)
      || (v25 = StringLiteral_1861/*">"*/,
          v19[2].klass = (System_String_c *)StringLiteral_1861/*">"*/,
          sub_1B68678((ServantStatusBattleListViewItem_o *)&v19[2], v25, v23, v24),
          LODWORD(v19[1].klass) <= 3)
      || (v19[2].monitor = v13,
          sub_1B68678((ServantStatusBattleListViewItem_o *)&v19[2].monitor, (int32_t)v13, v26, v27),
          LODWORD(v19[1].klass) <= 4) )
    {
LABEL_18:
      sub_1B68938(v15, v16);
    }
    v30 = StringLiteral_1628/*"</size>"*/;
    v19[2].fields = (System_String_Fields)StringLiteral_1628/*"</size>"*/;
    sub_1B68678((ServantStatusBattleListViewItem_o *)&v19[2].fields, v30, v28, v29);
    v31 = System_String__Concat_61432996((System_String_array *)v19, 0LL);
