...
void FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E76A9C & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_16124/*"[FADE]\n"*/);
  ...
  if ( UnityEngine_Application__get_isPlaying(0) )
  {
    ...
    v5 = System_String__Concat_65562772((System_String_o *)StringLiteral_16124/*"[FADE]\n"*/, FadeLog, 0);
    ...
    v7 = (System_String_o *)sub_1D0F15C(string___TypeInfo, 5);
    if ( !v7 )
      sub_1D0F30C(0, v8);
    v15 = v7;
    if ( !LODWORD(v7[1].klass) )
      goto LABEL_18;
    v16 = StringLiteral_1720/*"<size="*/;
    v7[1].monitor = (void *)StringLiteral_1720/*"<size="*/;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&v7[1].monitor, v16, v9, v10, v11, v12, v13, v14);
    v44 = v6 * 18.0;
    v7 = System_Single__ToString(v6 * 18.0, (const MethodInfo *)&v44);
    if ( LODWORD(v15[1].klass) <= 1
      || (v15[1].fields = (System_String_Fields)v7,
          sub_1D0F058((GrandQuestFolderBoardItem_o *)&v15[1].fields, (int32_t)v7, v17, v18, v19, v20, v21, v22),
          LODWORD(v15[1].klass) <= 2)
      || (v29 = StringLiteral_1746/*">"*/,
          v15[2].klass = (System_String_c *)StringLiteral_1746/*">"*/,
          sub_1D0F058((GrandQuestFolderBoardItem_o *)&v15[2], v29, v23, v24, v25, v26, v27, v28),
          LODWORD(v15[1].klass) <= 3)
      || (v15[2].monitor = v5,
          sub_1D0F058((GrandQuestFolderBoardItem_o *)&v15[2].monitor, (int32_t)v5, v30, v31, v32, v33, v34, v35),
          LODWORD(v15[1].klass) <= 4) )
    {
LABEL_18:
      sub_1D0F314(v7);
    }
    v42 = StringLiteral_1523/*"</size>"*/;
    v15[2].fields = (System_String_Fields)StringLiteral_1523/*"</size>"*/;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&v15[2].fields, v42, v36, v37, v38, v39, v40, v41);
    v43 = System_String__Concat_65603304((System_String_array *)v15, 0);
