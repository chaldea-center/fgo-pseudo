...
void FadeInfo__OnGUI(FadeInfo_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Application__get_isPlaying(0) )
  {
    ...
    v5 = System_String__Concat_64417744((System_String_o *)StringLiteral_15975/*"[FADE]\n"*/, FadeLog, 0);
    ...
    v7 = (System_String_o *)sub_1C94140(string___TypeInfo, 5);
    if ( !v7 )
      sub_1C942F0(0, v8);
    v15 = v7;
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&v7[1].monitor, v16, v9, v10, v11, v12, v13, v14);
    v44 = v6 * 18.0;
    v7 = System_Single__ToString(v6 * 18.0, (const MethodInfo *)&v44);
    if ( LODWORD(v15[1].klass) <= 1
      || (v15[1].fields = (System_String_Fields)v7,
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[1].fields, (int32_t)v7, v17, v18, v19, v20, v21, v22),
          LODWORD(v15[1].klass) <= 2)
      || (v29 = StringLiteral_1743/*">"*/,
          v15[2].klass = (System_String_c *)StringLiteral_1743/*">"*/,
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[2], v29, v23, v24, v25, v26, v27, v28),
          LODWORD(v15[1].klass) <= 3)
      || (v15[2].monitor = v5,
          sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[2].monitor, (int32_t)v5, v30, v31, v32, v33, v34, v35),
...
LABEL_18:
    ...
    sub_1C9403C((GrandQuestFolderBoardItem_o *)&v15[2].fields, v42, v36, v37, v38, v39, v40, v41);
    v43 = System_String__Concat_64458276((System_String_array *)v15, 0);
