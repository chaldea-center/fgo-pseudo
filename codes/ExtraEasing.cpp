        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF733 & 1) == 0 )
  {
    sub_1B4CF90(&System_Func_float__float__float__float__TypeInfo, v3);
    sub_1B4CF90(&Method_ExtraEasing___c__DisplayClass1_0__AsymptoticSeriesFloat_g__EasingFunc_0__, v6);
    sub_1B4CF90(&ExtraEasing___c__DisplayClass1_0_TypeInfo, v7);
    byte_49BF733 = 1;
  }
  v8 = sub_1B4D1DC(ExtraEasing___c__DisplayClass1_0_TypeInfo);
  ...
  *(float *)(v8 + 20) = powerRate;
  ...
  v12 = (System_Func_float__float__float__float__o *)sub_1B4D1DC(System_Func_float__float__float__float__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF732 & 1) == 0 )
  {
    sub_1B4CF90(&System_Func_Vector3__Vector3__float__Vector3__TypeInfo, v3);
    sub_1B4CF90(&Method_ExtraEasing___c__DisplayClass0_0__AsymptoticSeriesVector3_g__EasingFunc_0__, v6);
    sub_1B4CF90(&ExtraEasing___c__DisplayClass0_0_TypeInfo, v7);
    byte_49BF732 = 1;
  }
  v8 = sub_1B4D1DC(ExtraEasing___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1B4D1EC(v9, v10);
  *(float *)(v8 + 16) = asymptoticSpeed;
  *(float *)(v8 + 20) = powerRate;
  ExtraEasing__ValidateAsymptoticParams((float *)(v8 + 16), (float *)(v8 + 20), v11);
  v12 = (System_Func_Vector3__Vector3__float__Vector3__o *)sub_1B4D1DC(System_Func_Vector3__Vector3__float__Vector3__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BF734 & 1) == 0 )
  {
    sub_1B4CF90(&UnityEngine_Debug_TypeInfo, powerRate);
    sub_1B4CF90(&StringLiteral_16634/*"asymptoticSpeed should be defined on 0～1"*/, v5);
    sub_1B4CF90(&StringLiteral_22302/*"powerRate should be defined on non negative"*/, v6);
    byte_49BF734 = 1;
  }
  if ( *asymptoticSpeed < 0.0 || *asymptoticSpeed > 1.0 )
  {
    ...
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_16634/*"asymptoticSpeed should be defined on 0～1"*/, 0LL);
  ...
  if ( *powerRate < 0.0 )
  {
    if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo);
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_22302/*"powerRate should be defined on non negative"*/, 0LL);
    *powerRate = 0.0;
  }
}
