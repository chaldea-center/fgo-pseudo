        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0D3B & 1) == 0 )
  {
    sub_1C21E38(&System_Func_float__float__float__float__TypeInfo);
    sub_1C21E38(&Method_ExtraEasing___c__DisplayClass1_0__AsymptoticSeriesFloat_g__EasingFunc_0__);
    sub_1C21E38(&ExtraEasing___c__DisplayClass1_0_TypeInfo);
    byte_4BE0D3B = 1;
  }
  v5 = sub_1C22084(ExtraEasing___c__DisplayClass1_0_TypeInfo);
  ...
  *(float *)(v5 + 20) = powerRate;
  ...
  v9 = (System_Func_float__float__float__float__o *)sub_1C22084(System_Func_float__float__float__float__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0D3A & 1) == 0 )
  {
    sub_1C21E38(&System_Func_Vector3__Vector3__float__Vector3__TypeInfo);
    sub_1C21E38(&Method_ExtraEasing___c__DisplayClass0_0__AsymptoticSeriesVector3_g__EasingFunc_0__);
    sub_1C21E38(&ExtraEasing___c__DisplayClass0_0_TypeInfo);
    byte_4BE0D3A = 1;
  }
  v5 = sub_1C22084(ExtraEasing___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  if ( !v5 )
    sub_1C22094(v6, v7);
  *(float *)(v5 + 16) = asymptoticSpeed;
  *(float *)(v5 + 20) = powerRate;
  ExtraEasing__ValidateAsymptoticParams((float *)(v5 + 16), (float *)(v5 + 20), v8);
  v9 = (System_Func_Vector3__Vector3__float__Vector3__o *)sub_1C22084(System_Func_Vector3__Vector3__float__Vector3__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0D3C & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_17230/*"asymptoticSpeed should be defined on 0～1"*/);
    sub_1C21E38(&StringLiteral_22988/*"powerRate should be defined on non negative"*/);
    byte_4BE0D3C = 1;
  }
  if ( *asymptoticSpeed < 0.0 || *asymptoticSpeed > 1.0 )
  {
    ...
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_17230/*"asymptoticSpeed should be defined on 0～1"*/, 0LL);
  ...
  if ( *powerRate < 0.0 )
  {
    if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo);
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_22988/*"powerRate should be defined on non negative"*/, 0LL);
    *powerRate = 0.0;
  }
}
