        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8929 & 1) == 0 )
  {
    sub_1C13D24(&EventDelegate_TypeInfo, onClickAction);
    sub_1C13D24(&Method_System_Collections_Generic_List_EventDelegate__Add__, v5);
    sub_1C13D24(&Method_System_Collections_Generic_List_EventDelegate__Clear__, v6);
  ...
  if ( v9 )
  {
    ...
    EventDelegate___ctor_47827852(v17, onClickAction, 0LL);
    if ( !v16
