        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01A7E & 1) == 0 )
  {
    sub_1C2E12C(&EventDelegate_TypeInfo, onClickAction);
    sub_1C2E12C(&Method_System_Collections_Generic_List_EventDelegate__Add__, v5);
    sub_1C2E12C(&Method_System_Collections_Generic_List_EventDelegate__Clear__, v6);
  ...
  if ( v9 )
  {
    ...
    EventDelegate___ctor_48098832(v17, onClickAction, 0LL);
    if ( !v16
