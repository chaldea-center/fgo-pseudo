        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387BC9 & 1) == 0 )
  {
    vals = (System_Int32_array *)sub_B775C4(&int___TypeInfo);
    byte_4387BC9 = 1;
  }
  if ( !v4 )
    goto LABEL_15;
  ...
  {
    vals = (System_Int32_array *)sub_B775DC(int___TypeInfo, 3LL);
    if ( v5 >= v4->max_length )
      goto LABEL_14;
    if ( vals )
    {
...
LABEL_24:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_22688356(v5, v7, v10, 0LL);
      if ( !Instance )
        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387BC1 & 1) == 0 )
  {
    ...
    sub_B775C4(&System_Collections_Generic_List_int__TypeInfo);
    sub_B775C4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_B775C4(&Method_WarBoardEventTiming___c__DisplayClass22_0__IsAnyPieceMoveToTargetSquares_b__0__);
    entity = (WarBoardEventEntity_o *)sub_B775C4(&WarBoardEventTiming___c__DisplayClass22_0_TypeInfo);
    byte_4387BC1 = 1;
  }
  if ( !v2 )
    goto LABEL_18;
  ...
  entity = (WarBoardEventEntity_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2D1653C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !entity
    || (eventTimingVals = entity[5].fields.eventTimingVals) == 0LL
    || (v6 = *(_QWORD *)&eventTimingVals->m_Items[5]) == 0 )
  {
LABEL_18:
    sub_B7769C(entity, method);
  }
  if ( *(int *)(v6 + 24) < 1 )
    return 0;
  v7 = 0LL;
  while ( 1 )
  {
    v8 = (WarBoardEventTiming___c__DisplayClass22_0_o *)sub_B77694(WarBoardEventTiming___c__DisplayClass22_0_TypeInfo);
    WarBoardEventTiming___c__DisplayClass22_0___ctor(v8, 0LL);
    if ( v7 >= *(unsigned int *)(v6 + 24) )
    {
      v12 = sub_B776C8(entity);
      sub_B77668(v12, 0LL);
    }
    if ( !v8 )
      goto LABEL_18;
    v8->fields.targetPiece = *(struct WarBoardPieceData_o **)(v6 + 32 + 8 * v7);
    sub_B77560(&v8->fields);
    ...
    if ( vals )
    {
      ...
      if ( !(max_length % 3) && max_length >= 3 )
      {
        ...
        if ( v7 >= 3 && !(v7 % 3) )
        {
          ...
          while ( 1 )
          {
            v9 = (System_Int32_array *)sub_B775DC(int___TypeInfo, 3LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387BC2 & 1) == 0 )
  {
    sub_B775C4(&Method_System_Linq_Enumerable_Skip_int___);
    sub_B775C4(&Method_System_Linq_Enumerable_Take_int___);
  ...
  v5 = System_Linq_Enumerable__Take_int_(
         ...
         3,
         (const MethodInfo_1D3CA54 *)Method_System_Linq_Enumerable_Take_int___);
  ...
  if ( !IsCondPiece )
    return 0;
  if ( !condVals )
    sub_B7769C(IsCondPiece, v11);
  if ( (int)condVals->max_length < 4 )
    return 1;
  v13 = System_Linq_Enumerable__Skip_int_(
          (System_Collections_Generic_IEnumerable_TSource__o *)condVals,
          3,
          (const MethodInfo_1D3C700 *)Method_System_Linq_Enumerable_Skip_int___);
...
bool __fastcall WarBoardEventTiming__IsDefeatEnemyAfter(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  {
    v5 = sub_B776C8(DefeatPieceCount);
    sub_B77668(v5, 0LL);
  }
...
LABEL_19:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_22688356(v3, v8, v9, 0LL);
      if ( !Instance )
        goto LABEL_27;
...
bool __fastcall WarBoardEventTiming__IsEnemySvtNumBelow(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals )
    sub_B7769C(AlivePieceCount, v4);
  if ( !condVals->max_length )
  {
    v6 = sub_B776C8(AlivePieceCount);
    sub_B77668(v6, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387BC6 & 1) == 0 )
  {
    condVals = (System_Int32_array *)sub_B775C4(&int___TypeInfo);
    byte_4387BC6 = 1;
  }
  if ( !v4 )
LABEL_18:
  ...
  for ( i = 0; ; i += 3 )
  {
    condVals = (System_Int32_array *)sub_B775DC(int___TypeInfo, 3LL);
    if ( i >= v4->max_length )
      goto LABEL_17;
    if ( !condVals )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4387BC0 & 1) == 0 )
  {
    ...
    sub_B775C4(&System_Collections_Generic_List_int__TypeInfo);
    sub_B775C4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_B775C4(&Method_WarBoardEventTiming___c__DisplayClass21_0__IsPieceMoveToTargetSquares_b__0__);
    sub_B775C4(&WarBoardEventTiming___c__DisplayClass21_0_TypeInfo);
    byte_4387BC0 = 1;
  }
...
LABEL_29:
  ...
  IsNullOrEmpty = (WarBoardData_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2D1653C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !IsNullOrEmpty
    || (IsNullOrEmpty = (WarBoardData_o *)IsNullOrEmpty[1].fields.reinforcementsSaveList) == 0LL
    || (IsNullOrEmpty = (WarBoardData_o *)WarBoardData__GetPieces_22688356(IsNullOrEmpty, v9, v10, 0LL)) == 0LL )
  {
LABEL_28:
  ...
  while ( 1 )
  {
    v15 = (WarBoardEventTiming___c__DisplayClass21_0_o *)sub_B77694(WarBoardEventTiming___c__DisplayClass21_0_TypeInfo);
