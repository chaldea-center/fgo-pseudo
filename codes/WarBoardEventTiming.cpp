        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0273F & 1) == 0 )
  {
    vals = (System_Int32_array *)sub_1CE6700(&int___TypeInfo);
    byte_4E0273F = 1;
  }
  if ( !v4 )
    goto LABEL_15;
  ...
  {
    vals = (System_Int32_array *)sub_1CE67A8(int___TypeInfo, 3);
...
int32_t WarBoardEventTiming__GetAlivePieceCount(bool isMy, const MethodInfo *method)
{
  ...
  Instance = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_27;
...
LABEL_24:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_38971180(v5, v7, v10, 0);
      if ( !Instance )
        goto LABEL_27;
...
bool WarBoardEventTiming__IsAnyPieceMoveToTargetSquares(WarBoardEventEntity_o *entity, const MethodInfo *method)
{
  ...
  if ( (byte_4E02737 & 1) == 0 )
  {
    ...
    sub_1CE6700(&System_Collections_Generic_List_int__TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1CE6700(&Method_WarBoardEventTiming___c__DisplayClass22_0__IsAnyPieceMoveToTargetSquares_b__0__);
    entity = (WarBoardEventEntity_o *)sub_1CE6700(&WarBoardEventTiming___c__DisplayClass22_0_TypeInfo);
    byte_4E02737 = 1;
  }
  if ( !v2 )
    goto LABEL_18;
  ...
  entity = (WarBoardEventEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
...
LABEL_18:
  ...
  while ( 1 )
  {
    v8 = sub_1CE694C(WarBoardEventTiming___c__DisplayClass22_0_TypeInfo);
    ...
    *(_QWORD *)(v8 + 16) = v15;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v8 + 16), v15, v9, v10, v11, v12, v13, v14);
    v16 = *(_QWORD *)(v8 + 16);
    if ( !v16 )
      goto LABEL_18;
    if ( !*(_BYTE *)(v16 + 60) )
    ...
    if ( vals )
    {
      ...
      if ( max_length >= 3 && !(max_length % 3) )
      {
        ...
        if ( v7 >= 3 && !(v7 % 3) )
        {
          ...
          while ( 1 )
          {
            v9 = sub_1CE67A8(int___TypeInfo, 3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02738 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Linq_Enumerable_Skip_int___);
    sub_1CE6700(&Method_System_Linq_Enumerable_Take_int___);
  ...
  v5 = System_Linq_Enumerable__Take_int_(
         ...
         3,
         (const MethodInfo_32420D4 *)Method_System_Linq_Enumerable_Take_int___);
  ...
  if ( !IsCondPiece )
    return 0;
  if ( !condVals )
    sub_1CE6958(IsCondPiece, v11);
  if ( SLODWORD(condVals->max_length) < 4 )
    return 1;
  v12 = System_Linq_Enumerable__Skip_int_(
          (System_Collections_Generic_IEnumerable_TSource__o *)condVals,
          3,
          (const MethodInfo_32419C0 *)Method_System_Linq_Enumerable_Skip_int___);
...
LABEL_19:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_38971180(v3, v8, v9, 0);
      if ( !Instance )
        goto LABEL_26;
      max_length = Instance->max_length;
      v11 = Instance;
...
bool WarBoardEventTiming__IsEnemySvtNumBelow(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals )
    sub_1CE6958(AlivePieceCount, v4);
  if ( !LODWORD(condVals->max_length) )
    sub_1CE6960(AlivePieceCount);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0273C & 1) == 0 )
  {
    condVals = (System_Int32_array *)sub_1CE6700(&int___TypeInfo);
    byte_4E0273C = 1;
  }
  if ( !v4 )
LABEL_19:
  ...
  else
  {
    ...
    do
    {
      condVals = (System_Int32_array *)sub_1CE67A8(int___TypeInfo, 3);
      max_length = v4->max_length;
      if ( v5 >= max_length )
        goto LABEL_18;
      if ( !condVals )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E02736 & 1) == 0 )
  {
    ...
    sub_1CE6700(&System_Collections_Generic_List_int__TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    sub_1CE6700(&Method_WarBoardEventTiming___c__DisplayClass21_0__IsPieceMoveToTargetSquares_b__0__);
    sub_1CE6700(&WarBoardEventTiming___c__DisplayClass21_0_TypeInfo);
    byte_4E02736 = 1;
  }
...
LABEL_33:
  ...
  IsNullOrEmpty = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !IsNullOrEmpty
    || (IsNullOrEmpty = (WarBoardPieceData_array *)IsNullOrEmpty->m_Items[51]) == 0
    || (IsNullOrEmpty = WarBoardData__GetPieces_38971180((WarBoardData_o *)IsNullOrEmpty, v13, v14, 0)) == 0 )
  {
LABEL_32:
  ...
  while ( 1 )
  {
    v19 = sub_1CE694C(WarBoardEventTiming___c__DisplayClass21_0_TypeInfo);
    ...
    v26 = v17->m_Items[v18];
    *(_QWORD *)(v19 + 16) = v26;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v19 + 16), (int32_t)v26, v20, v21, v22, v23, v24, v25);
    v27 = *(_QWORD *)(v19 + 16);
    if ( !v27 )
      goto LABEL_32;
    if ( !*(_BYTE *)(v27 + 60) && (v15 < 0 || v15 == *(_DWORD *)(v27 + 28)) )
    {
      v28 = (System_Func_int__bool__o *)sub_1CE694C(System_Func_int__bool__TypeInfo);
      System_Func_int__bool____ctor(
        v28,
        (Il2CppObject *)v19,
