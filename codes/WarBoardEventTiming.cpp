        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC59C9 & 1) == 0 )
  {
    vals = (System_Int32_array *)sub_1C1ABD4(&int___TypeInfo, *(_QWORD *)&index);
    byte_4BC59C9 = 1;
  }
  if ( !v4 )
    goto LABEL_15;
  ...
  {
    vals = (System_Int32_array *)sub_1C1AC7C(int___TypeInfo, 3LL);
...
LABEL_14:
      sub_1C1AE38(vals, *(_QWORD *)&index);
    }
LABEL_15:
    sub_1C1AE30(vals, *(_QWORD *)&index);
  }
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC59C8 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_List_int__Add__, *(_QWORD *)&forceId);
...
int32_t __fastcall WarBoardEventTiming__GetAlivePieceCount(bool isMy, const MethodInfo *method)
{
  ...
  Instance = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_27;
...
LABEL_24:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_36501064(v5, v7, v10, 0LL);
      if ( !Instance )
        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC59C1 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&System_Func_int__bool__TypeInfo, v3);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_int___ctor___77494032, v4);
    ...
    sub_1C1ABD4(&Method_WarBoardEventTiming___c__DisplayClass22_0__IsAnyPieceMoveToTargetSquares_b__0__, v7);
    entity = (WarBoardEventEntity_o *)sub_1C1ABD4(&WarBoardEventTiming___c__DisplayClass22_0_TypeInfo, v8);
    byte_4BC59C1 = 1;
  }
  if ( !v2 )
    goto LABEL_18;
  ...
  entity = (WarBoardEventEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !entity || (v11 = *(_QWORD *)&entity[5].fields.frequencyType) == 0 || (v12 = *(_QWORD *)(v11 + 48)) == 0 )
LABEL_18:
    sub_1C1AE30(entity, method);
  if ( *(int *)(v12 + 24) < 1 )
    return 0;
  v13 = 0LL;
  while ( 1 )
  {
    v14 = sub_1C1AE20(WarBoardEventTiming___c__DisplayClass22_0_TypeInfo);
    System_Object___ctor((Il2CppObject *)v14, 0LL);
    if ( v13 >= *(unsigned int *)(v12 + 24) )
      sub_1C1AE38(entity, method);
    if ( !v14 )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC59C7 & 1) == 0 )
  {
    sub_1C1ABD4(&int___TypeInfo, vals);
    byte_4BC59C7 = 1;
  }
  result = 0;
  if ( condVals )
    ...
    if ( vals )
    {
      ...
      if ( max_length >= 3 && !(max_length % 3) )
      {
        ...
        if ( v7 >= 3 && !(v7 % 3) )
        {
          ...
          while ( 1 )
          {
            v9 = (System_Int32_array *)sub_1C1AC7C(int___TypeInfo, 3LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC59C2 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Linq_Enumerable_Skip_int___, vals);
    sub_1C1ABD4(&Method_System_Linq_Enumerable_Take_int___, v5);
  ...
  v7 = System_Linq_Enumerable__Take_int_(
         ...
         3,
         (const MethodInfo_2FD7B64 *)Method_System_Linq_Enumerable_Take_int___);
  ...
  if ( !IsCondPiece )
    return 0;
  if ( !condVals )
    sub_1C1AE30(IsCondPiece, v13);
  if ( (int)condVals->max_length < 4 )
    return 1;
  v14 = System_Linq_Enumerable__Skip_int_(
          (System_Collections_Generic_IEnumerable_TSource__o *)condVals,
          3,
          (const MethodInfo_2FD752C *)Method_System_Linq_Enumerable_Skip_int___);
...
bool __fastcall WarBoardEventTiming__IsDefeatEnemyAfter(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals->max_length )
    sub_1C1AE38(DefeatPieceCount, v4);
...
LABEL_19:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_36501064(v4, v9, v10, 0LL);
      if ( !Instance )
        goto LABEL_26;
      max_length = Instance->max_length;
      v12 = Instance;
...
bool __fastcall WarBoardEventTiming__IsEnemySvtNumBelow(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals )
    sub_1C1AE30(AlivePieceCount, v4);
  if ( !condVals->max_length )
    sub_1C1AE38(AlivePieceCount, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC59C6 & 1) == 0 )
  {
    condVals = (System_Int32_array *)sub_1C1ABD4(&int___TypeInfo, vals);
    byte_4BC59C6 = 1;
  }
  if ( !v4 )
LABEL_19:
  ...
  else
  {
    ...
    do
    {
      condVals = (System_Int32_array *)sub_1C1AC7C(int___TypeInfo, 3LL);
      max_length = v4->max_length;
      if ( v5 >= max_length )
        goto LABEL_18;
      if ( !condVals )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC59C0 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_BasicHelper_Any_int___, entity);
    ...
    sub_1C1ABD4(&Method_WarBoardEventTiming___c__DisplayClass21_0__IsPieceMoveToTargetSquares_b__0__, v11);
    sub_1C1ABD4(&WarBoardEventTiming___c__DisplayClass21_0_TypeInfo, v12);
    byte_4BC59C0 = 1;
  }
...
LABEL_33:
  ...
  IsNullOrEmpty = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !IsNullOrEmpty
    || (IsNullOrEmpty = (WarBoardPieceData_array *)IsNullOrEmpty->m_Items[51]) == 0LL
    || (IsNullOrEmpty = WarBoardData__GetPieces_36501064((WarBoardData_o *)IsNullOrEmpty, v21, v22, 0LL)) == 0LL )
  {
LABEL_32:
  ...
  while ( 1 )
  {
    v27 = sub_1C1AE20(WarBoardEventTiming___c__DisplayClass21_0_TypeInfo);
    ...
    *(_QWORD *)(v27 + 16) = v34;
    sub_1C1AB78((PartyOrganizationUtility_o *)(v27 + 16), v34, v28, v29, v30, v31, v32, v33);
    v35 = *(_QWORD *)(v27 + 16);
    if ( !v35 )
      goto LABEL_32;
    if ( !*(_BYTE *)(v35 + 60) && ((v23 & 0x80000000) != 0 || v23 == *(_DWORD *)(v35 + 28)) )
    {
      v36 = (System_Func_int__bool__o *)sub_1C1AE20(System_Func_int__bool__TypeInfo);
      System_Func_int__bool____ctor(
        v36,
        (Il2CppObject *)v27,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&Method_System_Linq_Enumerable_Skip_int___, vals);
    sub_1C1ABD4(&Method_System_Linq_Enumerable_Take_int___, v7);
