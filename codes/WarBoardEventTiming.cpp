        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEE0 & 1) == 0 )
  {
    vals = (System_Int32_array *)sub_1B90010(&int___TypeInfo, *(_QWORD *)&index);
    byte_4A6DEE0 = 1;
  }
  if ( !v4 )
    goto LABEL_15;
  ...
  {
    vals = (System_Int32_array *)sub_1B900B8(int___TypeInfo, 3LL);
...
LABEL_14:
      sub_1B90274(vals, *(_QWORD *)&index);
    }
LABEL_15:
    sub_1B9026C(vals, *(_QWORD *)&index);
  }
  return 0LL;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEDF & 1) == 0 )
  {
    sub_1B90010(&Method_System_Collections_Generic_List_int__Add__, *(_QWORD *)&forceId);
...
int32_t __fastcall WarBoardEventTiming__GetAlivePieceCount(bool isMy, const MethodInfo *method)
{
  ...
  Instance = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_27;
...
LABEL_24:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_35406868(v5, v7, v10, 0LL);
      if ( !Instance )
        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DED8 & 1) == 0 )
  {
    ...
    sub_1B90010(&System_Func_int__bool__TypeInfo, v3);
    sub_1B90010(&Method_System_Collections_Generic_List_int___ctor___76120648, v4);
    ...
    sub_1B90010(&Method_WarBoardEventTiming___c__DisplayClass22_0__IsAnyPieceMoveToTargetSquares_b__0__, v7);
    entity = (WarBoardEventEntity_o *)sub_1B90010(&WarBoardEventTiming___c__DisplayClass22_0_TypeInfo, v8);
    byte_4A6DED8 = 1;
  }
  if ( !v2 )
    goto LABEL_18;
  ...
  entity = (WarBoardEventEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !entity || (v11 = *(_QWORD *)&entity[5].fields.frequencyType) == 0 || (v12 = *(_QWORD *)(v11 + 48)) == 0 )
LABEL_18:
    sub_1B9026C(entity, method);
  if ( *(int *)(v12 + 24) < 1 )
    return 0;
  v13 = 0LL;
  while ( 1 )
  {
    v14 = sub_1B9025C(WarBoardEventTiming___c__DisplayClass22_0_TypeInfo);
    System_Object___ctor((Il2CppObject *)v14, 0LL);
    if ( v13 >= *(unsigned int *)(v12 + 24) )
      sub_1B90274(entity, method);
    if ( !v14 )
      goto LABEL_18;
    v17 = *(_QWORD *)(v12 + 32 + 8 * v13);
    *(_QWORD *)(v14 + 16) = v17;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v14 + 16), v17, v15, v16);
    v18 = *(_QWORD *)(v14 + 16);
    if ( !v18 )
      goto LABEL_18;
    if ( !*(_BYTE *)(v18 + 60) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEDE & 1) == 0 )
  {
    sub_1B90010(&int___TypeInfo, vals);
    byte_4A6DEDE = 1;
  }
  result = 0;
  if ( condVals )
    ...
    if ( vals )
    {
      ...
      if ( max_length >= 3 && !(max_length % 3) )
      {
        ...
        if ( v7 >= 3 && !(v7 % 3) )
        {
          ...
          while ( 1 )
          {
            v9 = (System_Int32_array *)sub_1B900B8(int___TypeInfo, 3LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DED9 & 1) == 0 )
  {
    sub_1B90010(&Method_System_Linq_Enumerable_Skip_int___, vals);
    sub_1B90010(&Method_System_Linq_Enumerable_Take_int___, v5);
  ...
  v7 = System_Linq_Enumerable__Take_int_(
         ...
         3,
         (const MethodInfo_2EC5C88 *)Method_System_Linq_Enumerable_Take_int___);
  ...
  if ( !IsCondPiece )
    return 0;
  if ( !condVals )
    sub_1B9026C(IsCondPiece, v13);
  if ( (int)condVals->max_length < 4 )
    return 1;
  v14 = System_Linq_Enumerable__Skip_int_(
          (System_Collections_Generic_IEnumerable_TSource__o *)condVals,
          3,
          (const MethodInfo_2EC5650 *)Method_System_Linq_Enumerable_Skip_int___);
...
bool __fastcall WarBoardEventTiming__IsDefeatEnemyAfter(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals->max_length )
    sub_1B90274(DefeatPieceCount, v4);
...
bool __fastcall WarBoardEventTiming__IsDefeatHalfEnemy(const MethodInfo *method)
{
  ...
  if ( (byte_4A6DED5 & 1) == 0 )
  {
    sub_1B90010(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v1);
    byte_4A6DED5 = 1;
  }
  Instance = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
...
LABEL_19:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_35406868(v4, v9, v10, 0LL);
      if ( !Instance )
        goto LABEL_26;
      max_length = Instance->max_length;
      v12 = Instance;
...
bool __fastcall WarBoardEventTiming__IsEnemySvtNumBelow(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals )
    sub_1B9026C(AlivePieceCount, v4);
  if ( !condVals->max_length )
    sub_1B90274(AlivePieceCount, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DEDD & 1) == 0 )
  {
    condVals = (System_Int32_array *)sub_1B90010(&int___TypeInfo, vals);
    byte_4A6DEDD = 1;
  }
  if ( !v4 )
LABEL_19:
  ...
  else
  {
    ...
    do
    {
      condVals = (System_Int32_array *)sub_1B900B8(int___TypeInfo, 3LL);
      max_length = v4->max_length;
      if ( v5 >= max_length )
        goto LABEL_18;
      if ( !condVals )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DED7 & 1) == 0 )
  {
    sub_1B90010(&Method_BasicHelper_Any_int___, entity);
    ...
    sub_1B90010(&Method_WarBoardEventTiming___c__DisplayClass21_0__IsPieceMoveToTargetSquares_b__0__, v11);
    sub_1B90010(&WarBoardEventTiming___c__DisplayClass21_0_TypeInfo, v12);
    byte_4A6DED7 = 1;
  }
...
LABEL_33:
  ...
  IsNullOrEmpty = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !IsNullOrEmpty
    || (IsNullOrEmpty = (WarBoardPieceData_array *)IsNullOrEmpty->m_Items[51]) == 0LL
    || (IsNullOrEmpty = WarBoardData__GetPieces_35406868((WarBoardData_o *)IsNullOrEmpty, v21, v22, 0LL)) == 0LL )
  {
LABEL_32:
  ...
  while ( 1 )
  {
    v27 = sub_1B9025C(WarBoardEventTiming___c__DisplayClass21_0_TypeInfo);
    ...
    v30 = v25->m_Items[v26];
    *(_QWORD *)(v27 + 16) = v30;
    sub_1B8FFB4((ServantStatusBattleListViewItem_o *)(v27 + 16), (int32_t)v30, v28, v29);
    v31 = *(_QWORD *)(v27 + 16);
    if ( !v31 )
      goto LABEL_32;
    if ( !*(_BYTE *)(v31 + 60) && ((v23 & 0x80000000) != 0 || v23 == *(_DWORD *)(v31 + 28)) )
    {
      v32 = (System_Func_int__bool__o *)sub_1B9025C(System_Func_int__bool__TypeInfo);
      System_Func_int__bool____ctor(
        v32,
        (Il2CppObject *)v27,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&Method_System_Linq_Enumerable_Skip_int___, vals);
    sub_1B90010(&Method_System_Linq_Enumerable_Take_int___, v7);
