        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AFA & 1) == 0 )
  {
    vals = (System_Int32_array *)sub_1BE4ACC(&int___TypeInfo, *(_QWORD *)&index);
    byte_4B64AFA = 1;
  }
  if ( !v4 )
    goto LABEL_15;
  ...
  {
    vals = (System_Int32_array *)sub_1BE4B74(int___TypeInfo, 3LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AF9 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_int__Add__, *(_QWORD *)&forceId);
...
int32_t __fastcall WarBoardEventTiming__GetAlivePieceCount(bool isMy, const MethodInfo *method)
{
  ...
  Instance = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_27;
...
LABEL_24:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_36228056(v5, v7, v10, 0LL);
      if ( !Instance )
        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AF2 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&System_Func_int__bool__TypeInfo, v3);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_int___ctor___77109024, v4);
    ...
    sub_1BE4ACC(&Method_WarBoardEventTiming___c__DisplayClass22_0__IsAnyPieceMoveToTargetSquares_b__0__, v7);
    entity = (WarBoardEventEntity_o *)sub_1BE4ACC(&WarBoardEventTiming___c__DisplayClass22_0_TypeInfo, v8);
    byte_4B64AF2 = 1;
  }
  if ( !v2 )
    goto LABEL_18;
  ...
  entity = (WarBoardEventEntity_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !entity || (v11 = *(_QWORD *)&entity[5].fields.frequencyType) == 0 || (v12 = *(_QWORD *)(v11 + 48)) == 0 )
LABEL_18:
    sub_1BE4D28(entity, method);
  if ( *(int *)(v12 + 24) < 1 )
    return 0;
  v13 = 0LL;
  while ( 1 )
  {
    v14 = sub_1BE4D18(WarBoardEventTiming___c__DisplayClass22_0_TypeInfo);
    System_Object___ctor((Il2CppObject *)v14, 0LL);
    if ( v13 >= *(unsigned int *)(v12 + 24) )
      sub_1BE4D30(entity, method);
    if ( !v14 )
      goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AF8 & 1) == 0 )
  {
    sub_1BE4ACC(&int___TypeInfo, vals);
    byte_4B64AF8 = 1;
  }
  result = 0;
  if ( condVals )
    ...
    if ( vals )
    {
      ...
      if ( max_length >= 3 && !(max_length % 3) )
      {
        ...
        if ( v7 >= 3 && !(v7 % 3) )
        {
          ...
          while ( 1 )
          {
            v9 = (System_Int32_array *)sub_1BE4B74(int___TypeInfo, 3LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AF3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Linq_Enumerable_Skip_int___, vals);
...
bool __fastcall WarBoardEventTiming__IsDefeatEnemyAfter(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals->max_length )
    sub_1BE4D30(DefeatPieceCount, v4);
...
bool __fastcall WarBoardEventTiming__IsDefeatHalfEnemy(const MethodInfo *method)
{
  ...
  if ( (byte_4B64AEF & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v1);
    byte_4B64AEF = 1;
  }
  Instance = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
...
LABEL_19:
    ...
    while ( 1 )
    {
      Instance = WarBoardData__GetPieces_36228056(v4, v9, v10, 0LL);
      if ( !Instance )
        goto LABEL_26;
      max_length = Instance->max_length;
      v12 = Instance;
...
bool __fastcall WarBoardEventTiming__IsEnemySvtNumBelow(System_Int32_array *condVals, const MethodInfo *method)
{
  ...
  if ( !condVals )
    sub_1BE4D28(AlivePieceCount, v4);
  if ( !condVals->max_length )
    sub_1BE4D30(AlivePieceCount, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AF7 & 1) == 0 )
  {
    condVals = (System_Int32_array *)sub_1BE4ACC(&int___TypeInfo, vals);
    byte_4B64AF7 = 1;
  }
  if ( !v4 )
LABEL_19:
  ...
  else
  {
    ...
    do
    {
      condVals = (System_Int32_array *)sub_1BE4B74(int___TypeInfo, 3LL);
      max_length = v4->max_length;
      if ( v5 >= max_length )
        goto LABEL_18;
      if ( !condVals )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64AF1 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_BasicHelper_Any_int___, entity);
    ...
    sub_1BE4ACC(&Method_WarBoardEventTiming___c__DisplayClass21_0__IsPieceMoveToTargetSquares_b__0__, v11);
    sub_1BE4ACC(&WarBoardEventTiming___c__DisplayClass21_0_TypeInfo, v12);
    byte_4B64AF1 = 1;
  }
...
LABEL_33:
  ...
  IsNullOrEmpty = (WarBoardPieceData_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !IsNullOrEmpty
    || (IsNullOrEmpty = (WarBoardPieceData_array *)IsNullOrEmpty->m_Items[51]) == 0LL
    || (IsNullOrEmpty = WarBoardData__GetPieces_36228056((WarBoardData_o *)IsNullOrEmpty, v21, v22, 0LL)) == 0LL )
  {
LABEL_32:
  ...
  while ( 1 )
  {
    v27 = sub_1BE4D18(WarBoardEventTiming___c__DisplayClass21_0_TypeInfo);
    ...
    *(_QWORD *)(v27 + 16) = v34;
    sub_1BE4A70((PartyOrganizationUtility_o *)(v27 + 16), v34, v28, v29, v30, v31, v32, v33);
    v35 = *(_QWORD *)(v27 + 16);
    if ( !v35 )
      goto LABEL_32;
    if ( !*(_BYTE *)(v35 + 60) && ((v23 & 0x80000000) != 0 || v23 == *(_DWORD *)(v35 + 28)) )
    {
      v36 = (System_Func_int__bool__o *)sub_1BE4D18(System_Func_int__bool__TypeInfo);
      System_Func_int__bool____ctor(
        v36,
        (Il2CppObject *)v27,
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&Method_System_Linq_Enumerable_Skip_int___, vals);
    sub_1BE4ACC(&Method_System_Linq_Enumerable_Take_int___, v7);
