void __fastcall EventTowerListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BAF668 & 1) == 0 )
  {
    sub_1C13D24(&EventTowerListViewItemDraw_TypeInfo, v1);
    sub_1C13D24(&StringLiteral_19577/*"event_superboss_hp_lower_"*/, v2);
    sub_1C13D24(&StringLiteral_19578/*"event_superboss_hp_split"*/, v3);
    byte_4BAF668 = 1;
  }
  EventTowerListViewItemDraw_TypeInfo->static_fields->BANNER_NAME = (struct System_String_o *)StringLiteral_19578/*"event_superboss_hp_split"*/;
  sub_1C13CC8(EventTowerListViewItemDraw_TypeInfo->static_fields);
  static_fields = EventTowerListViewItemDraw_TypeInfo->static_fields;
  static_fields->REWARD_GET_NAME = (struct System_String_o *)StringLiteral_19577/*"event_superboss_hp_lower_"*/;
  sub_1C13CC8(&static_fields->REWARD_GET_NAME);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF667 & 1) == 0 )
  {
    ...
    sub_1C13D24(&EventTowerListViewItemDraw_TypeInfo, v7);
    sub_1C13D24(&LocalizationManager_TypeInfo, v8);
    sub_1C13D24(&StringLiteral_5846/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, v9);
    sub_1C13D24(&StringLiteral_1220/*"00"*/, v10);
    byte_4BAF667 = 1;
  }
  if ( v5 && mode )
  {
        ...
        if ( rewardGetInfo )
        {
          ...
          if ( itemInfo )
          {
            ...
            if ( boardImageId < 1 )
            {
              ...
              v16 = System_String__Concat_62979204(v14, v17, (System_String_o *)StringLiteral_1220/*"00"*/, 0LL);
            }
            else
            {
              if ( !itemInfo )
                      ...
                      if ( rewardCondMessage )
                      {
                        ...
                        if ( v5->fields.isClearFloor )
                        {
                          ...
                          if ( v26 < 1 )
                          {
                            ...
                            v29 = System_String__Concat_62979204(v27, v30, (System_String_o *)StringLiteral_1220/*"00"*/, 0LL);
                          }
                          else
                          {
                            if ( !v25 )
                        ...
                        if ( rewardGetInfo )
                        {
                          ...
                          if ( rewardGetInfo )
                          {
                            ...
                            rewardGetInfo = LocalizationManager__Get((System_String_o *)StringLiteral_5846/*"EVENT_TOTALBOXGACHA_NEXT_FORMAT"*/, 0LL);
                            if ( v33 )
                            {
...
LABEL_51:
    sub_1C13F80(rewardGetInfo, item);
  }
}