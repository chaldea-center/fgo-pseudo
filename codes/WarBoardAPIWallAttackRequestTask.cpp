...
void WarBoardAPIWallAttackRequestTask__SetRequest(WarBoardAPIWallAttackRequestTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596E382 & 1) == 0 )
  {
    sub_2213A60(&Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  ...
  Instance = NetworkManager__getRequest_object_(
               0,
               (const MethodInfo_38F1B78 *)Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  if ( !warBoardData
