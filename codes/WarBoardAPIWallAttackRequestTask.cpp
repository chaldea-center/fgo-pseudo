        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.targetWallData, (int32_t)target, v11, v12);
}
...
void WarBoardAPIWallAttackRequestTask__SetRequest(WarBoardAPIWallAttackRequestTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C24F5D & 1) == 0 )
  {
    sub_1C2D490(&Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  ...
  Instance = NetworkManager__getRequest_object_(
               0,
               (const MethodInfo_31599E8 *)Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  if ( !warBoardData
