...
void WarBoardAPIWallAttackRequestTask__SetRequest(WarBoardAPIWallAttackRequestTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E60D & 1) == 0 )
  {
    sub_1C93AD4(&Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  ...
  Instance = NetworkManager__getRequest_object_(
               0,
               (const MethodInfo_322FB9C *)Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  if ( !warBoardData
