        ...
        const MethodInfo *method)
{
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.targetWallData, (int32_t)target, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A1D9 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_NetworkManager_getRequest_WarBoardWallAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_30A28E4 *)Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  if ( !warBoardData
