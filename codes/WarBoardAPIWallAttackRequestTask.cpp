        ...
        const MethodInfo *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.targetWallData, (int32_t)target, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DDD1 & 1) == 0 )
  {
    sub_1B90010(&Method_NetworkManager_getRequest_WarBoardWallAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F10358 *)Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  if ( !warBoardData
