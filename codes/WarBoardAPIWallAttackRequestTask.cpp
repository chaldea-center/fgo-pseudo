        ...
        const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.targetWallData, (int32_t)target, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC404 & 1) == 0 )
  {
    sub_1B64870(&Method_NetworkManager_getRequest_WarBoardWallAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2EBCCAC *)Method_NetworkManager_getRequest_WarBoardWallAttackRequest___);
  if ( !warBoardData
