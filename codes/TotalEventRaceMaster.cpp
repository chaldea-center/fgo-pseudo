void __fastcall TotalEventRaceMaster___ctor(TotalEventRaceMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A709AF & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_TotalEventRaceMaster__TotalEventRaceEntity__string___ctor__, method);
    byte_4A709AF = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    219,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_TotalEventRaceMaster__TotalEventRaceEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (TotalEventRaceEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                     PK,
                                     (const MethodInfo_312C900 *)Method_DataMasterBase_TotalEventRaceMaster__TotalEventRaceEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A709B0 & 1) == 0 )
  {
    ...
    sub_1B90010(&System_Comparison_TotalEventRaceEntity__TypeInfo, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_TotalEventRaceEntity__Add__, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_TotalEventRaceEntity__Sort__, v10);
    sub_1B90010(&Method_System_Collections_Generic_List_TotalEventRaceEntity__ToArray__, v11);
    sub_1B90010(&Method_System_Collections_Generic_List_TotalEventRaceEntity___ctor__, v12);
    sub_1B90010(&System_Collections_Generic_List_TotalEventRaceEntity__TypeInfo, v13);
    sub_1B90010(&TotalEventRaceEntity_TypeInfo, v14);
    sub_1B90010(&Method_TotalEventRaceMaster___c__GetTargetTermRaceEntityList_b__3_0__, v15);
    sub_1B90010(&TotalEventRaceMaster___c_TypeInfo, v16);
    byte_4A709B0 = 1;
  }
  v17 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_TotalEventRaceEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v17,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_TotalEventRaceEntity___ctor__);
...
LABEL_18:
  ...
  if ( !v30 )
  {
    ...
    v30 = (System_Comparison_T__o *)sub_1B9025C(System_Comparison_TotalEventRaceEntity__TypeInfo);
  ...
  System_Collections_Generic_List_object___Sort_55649412(
    v17,
    v30,
    (const MethodInfo_3512484 *)Method_System_Collections_Generic_List_TotalEventRaceEntity__Sort__);
  return (TotalEventRaceEntity_array *)System_Collections_Generic_List_object___ToArray(
                                         v17,
                                         (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_TotalEventRaceEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A709AE & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_TotalEventRaceMaster__TotalEventRaceEntity__string__TryGetEntity__, entity);
    byte_4A709AE = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_TotalEventRaceMaster__TotalEventRaceEntity__string__TryGetEntity__);
}
...
void __fastcall TotalEventRaceMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A709B1 & 1) == 0 )
  {
    sub_1B90010(&TotalEventRaceMaster___c_TypeInfo, v1);
    byte_4A709B1 = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(TotalEventRaceMaster___c_TypeInfo);
