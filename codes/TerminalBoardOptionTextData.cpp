        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v8->fields, (int32_t)forwardText, v9, v10);
  v8->fields._BehindTextFormat_k__BackingField = behindTextFormat;
  v8 = (TerminalBoardOptionTextData_o *)((char *)v8 + 32);
  sub_1B68678((ServantStatusBattleListViewItem_o *)v8, (int32_t)behindTextFormat, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    v8 = System_String__Format_61433976(this->fields._BehindTextFormat_k__BackingField, args, 0LL);
    this->fields._BehindText_k__BackingField = v8;
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields._BehindText_k__BackingField, (int32_t)v8, v9, v10);
  }
  else
  {
