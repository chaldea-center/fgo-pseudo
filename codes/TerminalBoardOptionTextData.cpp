        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&v10->fields, (int32_t)forwardText, v11, v12);
  v10->fields._BehindTextFormat_k__BackingField = behindTextFormat;
  v10 = (TerminalBoardOptionTextData_o *)((char *)v10 + 32);
  sub_1BDB81C((CGThumbnailListItem_o *)v10, (int32_t)behindTextFormat, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( v6 )
  {
    v8 = System_String__Format_62613688(this->fields._BehindTextFormat_k__BackingField, args, 0LL);
    this->fields._BehindText_k__BackingField = v8;
    sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._BehindText_k__BackingField, (int32_t)v8, v9, v10);
  }
  else
  {
        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields._BehindText_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
