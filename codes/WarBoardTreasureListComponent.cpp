...
void WarBoardTreasureListComponent__OnClickCloseButton(WarBoardTreasureListComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E6F0 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_WarBoardTreasureListComponent_EndClose__);
    sub_1C93AD4(&Method_WarBoardTreasureListComponent_OnClickCloseButton__);
    byte_4D2E6F0 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardTreasureListComponent_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_WarBoardTreasureListComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E6EF & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_WarBoardTreasureListComponent___c__DisplayClass18_0__Open_b__0__);
    sub_1C93AD4(&WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
    sub_1C93AD4(&StringLiteral_15484/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/);
    sub_1C93AD4(&StringLiteral_15483/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/);
    sub_1C93AD4(&StringLiteral_15482/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/);
    byte_4D2E6EF = 1;
  }
  v9 = sub_1C93D20(WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = treasureList;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)(v9 + 24), (int32_t)treasureList, v18, v19, v20, v21, v22, v23);
  ...
  if ( type != 1 )
  {
    ...
    scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15482/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/, 0);
    if ( textLabel )
    {
      UILabel__set_text(textLabel, scrollView, 0);
      titleLabel = this->fields.titleLabel;
      scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15483/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/, 0);
      if ( titleLabel )
      {
...
LABEL_36:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15484/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/, 0);
  if ( !v32 )
    goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E6F1 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_DataManager_GetMasterData_WarBoardTreasureMaster___);
    sub_1C93AD4(&Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__);
  ...
  if ( treasureList )
  {
    ...
    if ( !Instance
      || (MasterData_object = DataManager__GetMasterData_object_(
                                ...
                                (const MethodInfo_31A4A3C *)Method_DataManager_GetMasterData_WarBoardTreasureMaster___),
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Instance = (__int64)DataMasterBase_object__object__int___GetEntity(
                              ...
                              (const MethodInfo_3463274 *)Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__);
        if ( !Instance )
          goto LABEL_33;
        if ( !v10 )
          goto LABEL_33;
...
LABEL_31:
      ...
      while ( v14 < v12 )
      {
        ...
        if ( v20 <= 1 )
          v20 = -1;
        ItemIconComponent__SetGift_41640856((ItemIconComponent_o *)Instance, v16[5], v16[6], v20, 0, 0);
