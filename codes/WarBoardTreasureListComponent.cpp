...
void WarBoardTreasureListComponent__OnClickCloseButton(WarBoardTreasureListComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C54A9B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_WarBoardTreasureListComponent_EndClose__);
    sub_1C3E564(&Method_WarBoardTreasureListComponent_OnClickCloseButton__);
    byte_4C54A9B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardTreasureListComponent_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_WarBoardTreasureListComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C54A9A & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_WarBoardTreasureListComponent___c__DisplayClass18_0__Open_b__0__);
    sub_1C3E564(&WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
    sub_1C3E564(&StringLiteral_15395/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/);
    sub_1C3E564(&StringLiteral_15394/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/);
    sub_1C3E564(&StringLiteral_15393/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/);
    byte_4C54A9A = 1;
  }
  v9 = sub_1C3E7B0(WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = treasureList;
  sub_1C3E508((CGThumbnailListItem_o *)(v9 + 24), (int32_t)treasureList, v14, v15);
  ...
  if ( type != 1 )
  {
    ...
    scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15393/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/, 0);
    if ( textLabel )
    {
      UILabel__set_text(textLabel, scrollView, 0);
      titleLabel = this->fields.titleLabel;
      scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15394/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/, 0);
      if ( titleLabel )
      {
...
LABEL_36:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15395/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/, 0);
  if ( !v20 )
    goto LABEL_36;
...
LABEL_34:
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.closeCallbackFunc, (int32_t)closeCallback, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C54A9C & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_DataManager_GetMasterData_WarBoardTreasureMaster___);
    sub_1C3E564(&Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__);
  ...
  if ( treasureList )
  {
    ...
    if ( !Instance
      || (MasterData_object = DataManager__GetMasterData_object_(
                                ...
                                (const MethodInfo_30F9A70 *)Method_DataManager_GetMasterData_WarBoardTreasureMaster___),
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Instance = (__int64)DataMasterBase_object__object__int___GetEntity(
                              ...
                              (const MethodInfo_33B2F58 *)Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__);
        if ( !Instance )
          goto LABEL_33;
        if ( !v10 )
          goto LABEL_33;
...
LABEL_31:
      ...
      while ( v14 < v12 )
      {
        ...
        if ( v20 <= 1 )
          v20 = -1;
        ItemIconComponent__SetGift_40968388((ItemIconComponent_o *)Instance, v16[5], v16[6], v20, 0, 0);
