...
void WarBoardTreasureListComponent__OnClickCloseButton(WarBoardTreasureListComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C35713 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_WarBoardTreasureListComponent_EndClose__);
    sub_1C32C20(&Method_WarBoardTreasureListComponent_OnClickCloseButton__);
    byte_4C35713 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardTreasureListComponent_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C32C38(Method_WarBoardTreasureListComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C35712 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_WarBoardTreasureListComponent___c__DisplayClass18_0__Open_b__0__);
    sub_1C32C20(&WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
    sub_1C32C20(&StringLiteral_15383/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/);
    sub_1C32C20(&StringLiteral_15382/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/);
    sub_1C32C20(&StringLiteral_15381/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/);
    byte_4C35712 = 1;
  }
  v9 = sub_1C32E6C(WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = treasureList;
  sub_1C32BC4((CGThumbnailListItem_o *)(v9 + 24), (int32_t)treasureList, v13, v14);
  ...
  if ( type != 1 )
  {
    ...
    scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15381/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/, 0);
    if ( textLabel )
    {
      UILabel__set_text(textLabel, scrollView, 0);
      titleLabel = this->fields.titleLabel;
      scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15382/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/, 0);
      if ( titleLabel )
      {
...
LABEL_36:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15383/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/, 0);
  if ( !v19 )
    goto LABEL_36;
...
LABEL_34:
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.closeCallbackFunc, (int32_t)closeCallback, v15, v16);
  ...
  if ( treasureList )
  {
    ...
    if ( !Instance
      || (MasterData_object = DataManager__GetMasterData_object_(
                                ...
                                (const MethodInfo_30DD3F0 *)Method_DataManager_GetMasterData_WarBoardTreasureMaster___),
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !v9 )
          goto LABEL_33;
        v23 = v10;
        Instance = (__int64)GiftMaster__GetGiftListById(v9, *(_DWORD *)(Instance + 40), 0);
        if ( !Instance )
          goto LABEL_33;
...
LABEL_31:
      ...
      while ( v13 < v11 )
      {
        ...
        if ( v19 <= 1 )
          v19 = -1;
        ItemIconComponent__SetGift_40822420((ItemIconComponent_o *)Instance, v15[5], v15[6], v19, 0, 0);
