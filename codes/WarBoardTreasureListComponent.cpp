        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA91 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_WarBoardTreasureListComponent_EndClose__, v3);
    sub_1B715CC(&Method_WarBoardTreasureListComponent_OnClickCloseButton__, v4);
    byte_4A1DA91 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardTreasureListComponent_OnClickCloseButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B715E4(Method_WarBoardTreasureListComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA90 & 1) == 0 )
  {
    sub_1B715CC(&System_Action_TypeInfo, treasureList);
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_BoxCollider___, v9);
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_UISprite___, v10);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_UIWidget___, v11);
    sub_1B715CC(&LocalizationManager_TypeInfo, v12);
    sub_1B715CC(&Method_WarBoardTreasureListComponent___c__DisplayClass18_0__Open_b__0__, v13);
    sub_1B715CC(&WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo, v14);
    sub_1B715CC(&StringLiteral_15347/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/, v15);
    sub_1B715CC(&StringLiteral_15346/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/, v16);
    sub_1B715CC(&StringLiteral_15345/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/, v17);
    byte_4A1DA90 = 1;
  }
  v18 = sub_1B71818(WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v18 + 24) = treasureList;
  sub_1B71570((ServantStatusBattleListViewItem_o *)(v18 + 24), (int32_t)treasureList, v23, v24);
  ...
  if ( type != 1 )
  {
    ...
    scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15345/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/, 0LL);
    if ( textLabel )
    {
      UILabel__set_text(textLabel, scrollView, 0LL);
      titleLabel = this->fields.titleLabel;
      scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15346/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/, 0LL);
      if ( titleLabel )
      {
...
LABEL_36:
    sub_1B71828(scrollView, v20);
  }
  v29 = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15347/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/, 0LL);
  if ( !v29 )
    goto LABEL_36;
...
LABEL_34:
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.closeCallbackFunc, (int32_t)closeCallback, v25, v26);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1DA92 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_UIGrid___, treasureList);
    sub_1B715CC(&Method_DataManager_GetMasterData_GiftMaster___, v6);
    sub_1B715CC(&Method_DataManager_GetMasterData_WarBoardTreasureMaster___, v7);
    sub_1B715CC(&Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__, v8);
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_ItemIconComponent___, v9);
  ...
  if ( v4 )
  {
    ...
    if ( !Instance
      || (MasterData_object = DataManager__GetMasterData_object_(
                                ...
                                (const MethodInfo_2E5B3E8 *)Method_DataManager_GetMasterData_WarBoardTreasureMaster___),
    ...
    if ( (int)v16 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Instance = (__int64)DataMasterBase_object__object__int___GetEntity(
                              ...
                              v4->m_Items[v18 + 1],
                              (const MethodInfo_30F8760 *)Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__);
        if ( !Instance )
          goto LABEL_34;
        if ( !v17 )
          goto LABEL_34;
...
LABEL_32:
      ...
      while ( v21 < v19 )
      {
        ...
        if ( !byte_4A1A751 )
        {
          Instance = sub_1B715CC(&UnityEngine_Vector3_TypeInfo, v14);
          byte_4A1A751 = 1;
        }
        if ( !v25 )
          goto LABEL_34;
        ...
        if ( !Instance )
          goto LABEL_34;
        v27 = v23[7] <= 1 ? -1 : v23[7];
        ItemIconComponent__SetGift_37939160((ItemIconComponent_o *)Instance, v23[5], v23[6], v27, 0, 0LL);
