...
void WarBoardTreasureListComponent__OnClickCloseButton(WarBoardTreasureListComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC510B & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_WarBoardTreasureListComponent_EndClose__);
    sub_1C713B0(&Method_WarBoardTreasureListComponent_OnClickCloseButton__);
    byte_4CC510B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_WarBoardTreasureListComponent_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C713C8(Method_WarBoardTreasureListComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC510A & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_WarBoardTreasureListComponent___c__DisplayClass18_0__Open_b__0__);
    sub_1C713B0(&WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
    sub_1C713B0(&StringLiteral_15388/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/);
    sub_1C713B0(&StringLiteral_15387/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/);
    sub_1C713B0(&StringLiteral_15386/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/);
    byte_4CC510A = 1;
  }
  v9 = sub_1C715FC(WarBoardTreasureListComponent___c__DisplayClass18_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = treasureList;
  sub_1C71354((GrandQuestFolderBoardItem_o *)(v9 + 24), (int32_t)treasureList, v18, v19, v20, v21, v22, v23);
  ...
  if ( type != 1 )
  {
    ...
    scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15386/*"WARBOARD_GET_TREASURE_DIALOG_MESSAGE"*/, 0);
    if ( textLabel )
    {
      UILabel__set_text(textLabel, scrollView, 0);
      titleLabel = this->fields.titleLabel;
      scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15387/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_GET"*/, 0);
      if ( titleLabel )
      {
...
LABEL_36:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  scrollView = LocalizationManager__Get((System_String_o *)StringLiteral_15388/*"WARBOARD_GET_TREASURE_DIALOG_TITLE_RESULT"*/, 0);
  if ( !v32 )
    goto LABEL_36;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC510C & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DataManager_GetMasterData_WarBoardTreasureMaster___);
    sub_1C713B0(&Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__);
  ...
  if ( treasureList )
  {
    ...
    if ( !Instance
      || (MasterData_object = DataManager__GetMasterData_object_(
                                ...
                                (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_WarBoardTreasureMaster___),
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Instance = (__int64)DataMasterBase_object__object__int___GetEntity(
                              ...
                              (const MethodInfo_3408E80 *)Method_DataMasterBase_WarBoardTreasureMaster__WarBoardTreasureEntity__int__GetEntity__);
        if ( !Instance )
          goto LABEL_33;
        if ( !v10 )
          goto LABEL_33;
...
LABEL_31:
      ...
      while ( v14 < v12 )
      {
        ...
        if ( v20 <= 1 )
          v20 = -1;
        ItemIconComponent__SetGift_41196280((ItemIconComponent_o *)Instance, v16[5], v16[6], v20, 0, 0);
