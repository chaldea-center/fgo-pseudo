        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4098C & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___, method);
    byte_4B4098C = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3088520 *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4098E & 1) == 0 )
  {
    sub_1BDB878(&RecommendSupportQuestBoardListViewItem_TypeInfo, method);
    byte_4B4098E = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (RecommendSupportQuestBoardListViewItemDraw_o *)sub_1BDBD94(item);
      goto LABEL_9;
    }
  }
