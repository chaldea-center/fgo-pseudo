        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C0EA & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___, method);
    byte_4A6C0EA = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6C0EC & 1) == 0 )
  {
    sub_1B90010(&RecommendSupportQuestBoardListViewItem_TypeInfo, method);
    byte_4A6C0EC = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (RecommendSupportQuestBoardListViewItemDraw_o *)sub_1B9052C(item);
      goto LABEL_9;
    }
  }
