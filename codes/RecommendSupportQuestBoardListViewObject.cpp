        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B184B8 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___, method);
    byte_4B184B8 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_306E710 *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B184BA & 1) == 0 )
  {
    sub_1BCAFF8(&RecommendSupportQuestBoardListViewItem_TypeInfo, method);
    byte_4B184BA = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (RecommendSupportQuestBoardListViewItemDraw_o *)sub_1BCB514(item);
      goto LABEL_9;
    }
  }
