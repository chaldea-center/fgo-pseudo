        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAE46 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___, method);
    byte_49FAE46 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_RecommendSupportQuestBoardListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAE48 & 1) == 0 )
  {
    sub_1B64A00(&RecommendSupportQuestBoardListViewItem_TypeInfo, method);
    byte_49FAE48 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (RecommendSupportQuestBoardListViewItemDraw_o *)sub_1B64F1C(item);
      goto LABEL_9;
    }
  }
