void __fastcall QuestRacePointEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2001F & 1) == 0 )
  {
    sub_1B715CC(&QuestRacePointEntity_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_24527/*"voice"*/, v4);
    byte_4A2001F = 1;
  }
  QuestRacePointEntity_TypeInfo->static_fields->VOICE_KEY = (struct System_String_o *)StringLiteral_24527/*"voice"*/;
  sub_1B71570(
    (ServantStatusBattleListViewItem_o *)QuestRacePointEntity_TypeInfo->static_fields,
    StringLiteral_24527/*"voice"*/,
    v2,
    v3);
}
...
System_String_o *__fastcall QuestRacePointEntity__CreatePK(int32_t questId, int32_t itemId, const MethodInfo *method)
{
  if ( (byte_4A20019 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&itemId);
    byte_4A20019 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20018 & 1) == 0 )
  {
    sub_1B715CC(&QuestRacePointEntity_TypeInfo, method);
    byte_4A20018 = 1;
  }
...
int32_t __fastcall QuestRacePointEntity__GetBoostTypeColor(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2001A & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_18859/*"effectColor"*/, v3);
    byte_4A2001A = 1;
  }
  value = 0LL;
  ...
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           ...
           (Il2CppObject *)StringLiteral_18859/*"effectColor"*/,
           &value,
...
int32_t __fastcall QuestRacePointEntity__GetEffectGrade(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2001B & 1) == 0 )
  {
    sub_1B715CC(&EventRaceBoostEffect_BoostGrade_var, method);
    ...
    sub_1B715CC(&StringLiteral_19783/*"grade"*/, v6);
    byte_4A2001B = 1;
  }
  value = 0LL;
  script = this->fields.script;
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___TryGetValue(
          (System_Collections_Generic_Dictionary_object__object__o *)script,
          (Il2CppObject *)StringLiteral_19783/*"grade"*/,
          &value,
          (const MethodInfo_31A051C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    return 1;
...
System_String_o *__fastcall QuestRacePointEntity__GetRandVoice(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    if ( klass )
    {
      v5 = UnityEngine_Random__Range_69217592(0, (int32_t)klass, 0LL);
...
System_String_o *__fastcall QuestRacePointEntity__GetSe(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2001C & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22996/*"se"*/, v4);
    byte_4A2001C = 1;
  }
  value = 0LL;
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_22996/*"se"*/,
            &value,
            (const MethodInfo_31A051C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0LL;
...
System_String_array *__fastcall QuestRacePointEntity__GetVoices(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2001D & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_System_Collections_Generic_List_object__ConvertAll_string___, v5);
    sub_1B715CC(&Method_System_Collections_Generic_List_string__ToArray__, v6);
    sub_1B715CC(&System_Collections_Generic_List_object__TypeInfo, v7);
    sub_1B715CC(&QuestRacePointEntity_TypeInfo, v8);
    sub_1B715CC(&Method_QuestRacePointEntity___c__GetVoices_b__10_0__, v9);
    sub_1B715CC(&QuestRacePointEntity___c_TypeInfo, v10);
    byte_4A2001D = 1;
  }
  script = this->fields.script;
  if ( !script )
    ...
    && (System_Collections_Generic_List_object__c *)v16->klass->_2.typeHierarchy[methodPtr_low - 1] == System_Collections_Generic_List_object__TypeInfo )
  {
    if ( !_9__10_0 )
    {
      ...
      _9__10_0 = (System_Converter_TInput__TOutput__o *)sub_1B71818(System_Converter_object__string__TypeInfo);
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->__9__10_0, (int32_t)_9__10_0, v22, v23);
    }
    if ( v16 )
    {
...
void __fastcall QuestRacePointEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A20020 & 1) == 0 )
  {
    sub_1B715CC(&QuestRacePointEntity___c_TypeInfo, v1);
    byte_4A20020 = 1;
  }
  v2 = (Il2CppObject *)sub_1B71818(QuestRacePointEntity___c_TypeInfo);
