void QuestRacePointEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C436E9 & 1) == 0 )
  {
    sub_1C37058(&QuestRacePointEntity_TypeInfo);
    sub_1C37058(&StringLiteral_24705/*"voice"*/);
    byte_4C436E9 = 1;
  }
  QuestRacePointEntity_TypeInfo->static_fields->VOICE_KEY = (struct System_String_o *)StringLiteral_24705/*"voice"*/;
  sub_1C36FFC((CGThumbnailListItem_o *)QuestRacePointEntity_TypeInfo->static_fields, StringLiteral_24705/*"voice"*/, v1, v2);
}
...
int32_t QuestRacePointEntity__GetBoostTypeColor(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C436E4 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_18916/*"effectColor"*/);
    byte_4C436E4 = 1;
  }
  value = 0;
  ...
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           ...
           (Il2CppObject *)StringLiteral_18916/*"effectColor"*/,
           &value,
           (const MethodInfo_3464E3C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
    {
      ...
      LODWORD(script) = System_Int32__Parse(v4, 0);
    }
    else
    {
      LODWORD(script) = 0;
...
int32_t QuestRacePointEntity__GetEffectGrade(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C436E5 & 1) == 0 )
  {
    sub_1C37058(&EventRaceBoostEffect_BoostGrade_var);
    sub_1C37058(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__);
    sub_1C37058(&System_Enum_TypeInfo);
    sub_1C37058(&System_Type_TypeInfo);
    sub_1C37058(&StringLiteral_19885/*"grade"*/);
    byte_4C436E5 = 1;
  }
  value = 0;
  script = this->fields.script;
  if ( !script
    || !System_Collections_Generic_Dictionary_object__object___TryGetValue(
          (System_Collections_Generic_Dictionary_object__object__o *)script,
          (Il2CppObject *)StringLiteral_19885/*"grade"*/,
          &value,
          (const MethodInfo_3464E3C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
  {
    return 1;
  ...
  v7 = EventRaceBoostEffect_BoostGrade_var;
...
System_String_o *QuestRacePointEntity__GetRandVoice(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    if ( klass )
    {
      v5 = UnityEngine_Random__Range_71226972(0, (int32_t)klass, 0);
...
System_String_o *QuestRacePointEntity__GetSe(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( result )
  {
    if ( !System_Collections_Generic_Dictionary_object__object___TryGetValue(
            ...
            (Il2CppObject *)StringLiteral_23222/*"se"*/,
            &value,
            (const MethodInfo_3464E3C *)Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__) )
      return 0;
...
System_String_array *QuestRacePointEntity__GetVoices(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  QuestRacePointEntity___c_c *v8; // x8
  ...
  if ( (byte_4C436E7 & 1) == 0 )
  {
    ...
    sub_1C37058(&QuestRacePointEntity_TypeInfo);
    sub_1C37058(&Method_QuestRacePointEntity___c__GetVoices_b__10_0__);
    sub_1C37058(&QuestRacePointEntity___c_TypeInfo);
    byte_4C436E7 = 1;
  }
  script = this->fields.script;
  if ( !script )
    ...
    && (System_Collections_Generic_List_object__c *)v7->klass->_2.typeHierarchy[naturalAligment - 1] == System_Collections_Generic_List_object__TypeInfo )
  {
    if ( !_9__10_0 )
    {
      ...
      _9__10_0 = (System_Converter_TInput__TOutput__o *)sub_1C372A4(System_Converter_object__string__TypeInfo);
      System_Converter_object__object____ctor(_9__10_0, v11, Method_QuestRacePointEntity___c__GetVoices_b__10_0__, 0);
      ...
      sub_1C36FFC((CGThumbnailListItem_o *)&static_fields->__9__10_0, (int32_t)_9__10_0, v13, v14);
    }
    if ( v7 )
    {
...
LABEL_23:
  ...
  sub_1C37574(v7);
  return (System_String_array *)QuestRacePointEntity__GetRandVoice(v16, v17);
}
...
void QuestRacePointEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C372A4(QuestRacePointEntity___c_TypeInfo);
  System_Object___ctor(v1, 0);
  QuestRacePointEntity___c_TypeInfo->static_fields->__9 = (struct QuestRacePointEntity___c_o *)v1;
  sub_1C36FFC((CGThumbnailListItem_o *)QuestRacePointEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
