void __fastcall QuestRacePointEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FEA49 & 1) == 0 )
  {
    sub_1B64870(&QuestRacePointEntity_TypeInfo, v1);
    sub_1B64870(&StringLiteral_24491/*"voice"*/, v4);
    byte_49FEA49 = 1;
  }
...
System_String_o *__fastcall QuestRacePointEntity__CreatePK(int32_t questId, int32_t itemId, const MethodInfo *method)
{
  if ( (byte_49FEA43 & 1) == 0 )
  {
    sub_1B64870(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&itemId);
    byte_49FEA43 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FEA42 & 1) == 0 )
  {
    sub_1B64870(&QuestRacePointEntity_TypeInfo, method);
    byte_49FEA42 = 1;
  }
...
int32_t __fastcall QuestRacePointEntity__GetBoostTypeColor(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEA44 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_18839/*"effectColor"*/, v3);
    byte_49FEA44 = 1;
  }
  value = 0LL;
  ...
  if ( script )
  {
    if ( System_Collections_Generic_Dictionary_object__object___TryGetValue(
           ...
           (Il2CppObject *)StringLiteral_18839/*"effectColor"*/,
           &value,
...
int32_t __fastcall QuestRacePointEntity__GetEffectGrade(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEA45 & 1) == 0 )
  {
    sub_1B64870(&EventRaceBoostEffect_BoostGrade_var, method);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_string__object__TryGetValue__, v3);
    sub_1B64870(&System_Enum_TypeInfo, v4);
    sub_1B64870(&System_Type_TypeInfo, v5);
    sub_1B64870(&StringLiteral_19758/*"grade"*/, v6);
    byte_49FEA45 = 1;
  }
  value = 0LL;
  script = this->fields.script;
...
System_String_o *__fastcall QuestRacePointEntity__GetRandVoice(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    if ( klass )
    {
      v5 = UnityEngine_Random__Range_69095656(0, (int32_t)klass, 0LL);
...
System_String_o *__fastcall QuestRacePointEntity__GetSe(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEA46 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_22961/*"se"*/, v4);
    byte_49FEA46 = 1;
  }
  value = 0LL;
...
System_String_array *__fastcall QuestRacePointEntity__GetVoices(QuestRacePointEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEA47 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_object__ConvertAll_string___, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_string__ToArray__, v6);
    sub_1B64870(&System_Collections_Generic_List_object__TypeInfo, v7);
    sub_1B64870(&QuestRacePointEntity_TypeInfo, v8);
    sub_1B64870(&Method_QuestRacePointEntity___c__GetVoices_b__10_0__, v9);
    sub_1B64870(&QuestRacePointEntity___c_TypeInfo, v10);
    byte_49FEA47 = 1;
  }
  script = this->fields.script;
  if ( !script )
    ...
    && (System_Collections_Generic_List_object__c *)v16->klass->_2.typeHierarchy[methodPtr_low - 1] == System_Collections_Generic_List_object__TypeInfo )
  {
    if ( !_9__10_0 )
    {
      ...
      _9__10_0 = (System_Converter_TInput__TOutput__o *)sub_1B64ABC(System_Converter_object__string__TypeInfo);
      ...
      sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__10_0, (int32_t)_9__10_0, v22, v23);
    }
    if ( v16 )
    {
...
void __fastcall QuestRacePointEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FEA4A & 1) == 0 )
  {
    sub_1B64870(&QuestRacePointEntity___c_TypeInfo, v1);
    byte_49FEA4A = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(QuestRacePointEntity___c_TypeInfo);
