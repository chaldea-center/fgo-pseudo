void __fastcall MasterEquipIconComponent___ctor(MasterEquipIconComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.ICON_MASK_COLOR = (struct UnityEngine_Color_o)xmmword_BA3120;
...
int32_t __fastcall MasterEquipIconComponent__GetEquipId(MasterEquipIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9A0C & 1) == 0 )
  {
    this = (MasterEquipIconComponent_o *)sub_1B64870(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, method);
    byte_49F9A0C = 1;
  }
...
void __fastcall MasterEquipIconComponent__OnClickEquipIcon(MasterEquipIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v9.fields.fakeValue = v6;
  this = (MasterEquipIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v9, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9A0D & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_Collider___, isEnabled);
    byte_49F9A0D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9A09 & 1) == 0 )
  {
    sub_1B64870(&int_TypeInfo, usrEquipData);
  ...
  sub_1B64814(&this->fields.usrEquipData);
  this->fields.callbackFunc = callback;
  this->fields.moveEqIdx = moveIdx;
  equipIconComp = (ItemIconComponent_o *)sub_1B64814(&this->fields.callbackFunc);
  if ( !usrEquipData )
    goto LABEL_9;
  ...
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_8484/*"MASTER_EQSKILL_LV_TXT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9A0A & 1) == 0 )
  {
    this = (MasterEquipIconComponent_o *)sub_1B64870(
  ...
  *(_QWORD *)&v14.fields.fakeValue = v6;
  this = (MasterEquipIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v14, 0LL);
...
LABEL_15:
    sub_1B64ACC(this, *(_QWORD *)&nowEquipId);
  }
  if ( !equipIconComp )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9A07 & 1) == 0 )
  {
    sub_1B64870(&MasterEquipIconComponent_CallbackFunc_TypeInfo, value);
    byte_49F9A07 = 1;
  }
  ...
  v11 = (MasterEquipIconComponent_o *)sub_1B64D8C(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A5510;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A54B0;
}
