void __fastcall MasterEquipIconComponent___ctor(MasterEquipIconComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.ICON_MASK_COLOR = (struct UnityEngine_Color_o)xmmword_BEAB30;
...
int32_t __fastcall MasterEquipIconComponent__GetEquipId(MasterEquipIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9DB & 1) == 0 )
  {
    this = (MasterEquipIconComponent_o *)sub_1BDB878(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, method);
    byte_4B3F9DB = 1;
  }
...
void __fastcall MasterEquipIconComponent__OnClickEquipIcon(MasterEquipIconComponent_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v9.fields.fakeValue = v6;
  this = (MasterEquipIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v9, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9DC & 1) == 0 )
  {
    sub_1BDB878(&Method_UnityEngine_Component_GetComponent_Collider___, isEnabled);
    byte_4B3F9DC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9D8 & 1) == 0 )
  {
    sub_1BDB878(&int_TypeInfo, usrEquipData);
  ...
  sub_1BDB81C(&this->fields.usrEquipData);
  this->fields.callbackFunc = callback;
  this->fields.moveEqIdx = moveIdx;
  equipIconComp = (ItemIconComponent_o *)sub_1BDB81C(&this->fields.callbackFunc);
  if ( !usrEquipData )
    goto LABEL_9;
  ...
  v16 = LocalizationManager__Get((System_String_o *)StringLiteral_8542/*"MASTER_EQSKILL_LV_TXT"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9D9 & 1) == 0 )
  {
    this = (MasterEquipIconComponent_o *)sub_1BDB878(
  ...
  *(_QWORD *)&v14.fields.fakeValue = v6;
  this = (MasterEquipIconComponent_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48227716(v14, 0LL);
...
LABEL_15:
    sub_1BDBAD4(this, *(_QWORD *)&nowEquipId);
  }
  if ( !equipIconComp )
    goto LABEL_15;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F9D6 & 1) == 0 )
  {
    sub_1BDB878(&MasterEquipIconComponent_CallbackFunc_TypeInfo, value);
    byte_4B3F9D6 = 1;
  }
  ...
  v11 = (MasterEquipIconComponent_o *)sub_1BDBD94(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A1D7D8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A1D778;
}
