        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.aiActArg, (int32_t)arg, v11, v12, v13, v14, v15, v16);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07E05 & 1) == 0 )
  {
    sub_1CE6700(&BattleScriptActionData_TypeInfo);
    byte_4E07E05 = 1;
  }
  v5 = 0;
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.battleScriptEntities, 0) )
  {
    v5 = (BattleScriptActionData_o *)sub_1CE694C(BattleScriptActionData_TypeInfo);
