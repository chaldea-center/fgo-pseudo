        ...
        const MethodInfo *method)
{
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.battleScriptEntities, (int32_t)entities, isEach, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A05E & 1) == 0 )
  {
    sub_1C3E564(&BattleScriptActionData_TypeInfo);
    byte_4C5A05E = 1;
  }
  v5 = 0;
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)this->fields.battleScriptEntities, 0) )
  {
    v5 = (BattleScriptActionData_o *)sub_1C3E7B0(BattleScriptActionData_TypeInfo);
