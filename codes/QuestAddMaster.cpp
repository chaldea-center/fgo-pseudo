void __fastcall QuestAddMaster___ctor(QuestAddMaster_o *this, const MethodInfo *method)
{
  if ( (byte_40FA0B3 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataMasterBase_QuestAddMaster__QuestAddEntity__string___ctor__, method);
    byte_40FA0B3 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    67,
    (const MethodInfo_266F73C *)Method_DataMasterBase_QuestAddMaster__QuestAddEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA0B1 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataMasterBase_QuestAddMaster__QuestAddEntity__string__GetEntity__, *(_QWORD *)&questId);
    byte_40FA0B1 = 1;
  }
  ...
  return (QuestAddEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                               ...
                               PK,
                               (const MethodInfo_266F7D8 *)Method_DataMasterBase_QuestAddMaster__QuestAddEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA0B4 & 1) == 0 )
  {
    ...
    sub_B16FFC(&QuestAddEntity_TypeInfo, v11);
    byte_40FA0B4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA0B2 & 1) == 0 )
  {
    sub_B16FFC(&Method_DataMasterBase_QuestAddMaster__QuestAddEntity__string__TryGetEntity__, entity);
    byte_40FA0B2 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_266F830 *)Method_DataMasterBase_QuestAddMaster__QuestAddEntity__string__TryGetEntity__);
}