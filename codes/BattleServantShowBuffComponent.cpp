        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF416 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_BattleServantBuffIconComponent___, *(_QWORD *)&index);
  ...
  Component_object = (BattleServantBuffIconComponent_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           Object,
                                                           (const MethodInfo_2E87ED8 *)Method_UnityEngine_GameObject_GetComponent_BattleServantBuffIconComponent___);
  ...
  if ( !Component_object
    || (BattleServantBuffIconComponent__setIcon_43602588(Component_object, datalist->m_Items[index], 0LL),
...
LABEL_12:
  ...
  else
  {
    ...
    *(_QWORD *)(v16 + 32) = Object;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)(v16 + 32), (int32_t)Object, v11, v12);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF417 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_BattleServantBuffIconComponent___, method);
...
LABEL_16:
      BattleServantBuffIconComponent__setIcon_43602588((BattleServantBuffIconComponent_o *)objList, 0LL, 0LL);
    }
LABEL_17:
    objList = (System_Collections_Generic_List_object__o *)this->fields.objList;
    ++v6;
        ...
        const MethodInfo *method)
{
  ...
  if ( !datalist )
    goto LABEL_10;
  if ( datalist->max_length <= index )
    sub_1B6432C(objList, v9);
  BattleServantBuffIconComponent__setIcon_43602588(
        ...
        const MethodInfo *method)
{
  ...
  BattleServantBuffIconComponent__setIcon_43602588((BattleServantBuffIconComponent_o *)objList, v13, 0LL);
  objList = (System_Collections_Generic_List_object__o *)this->fields.objList;
  if ( !objList )
LABEL_14:
    sub_1B64324(objList);
  Item = System_Collections_Generic_List_object___get_Item(
           ...
           v8,
           (const MethodInfo_34AD404 *)Method_System_Collections_Generic_List_GameObject__get_Item__);
  BattleServantShowBuffComponent__UpdatePosition(this, (UnityEngine_GameObject_o *)Item, index, v15);
  return v8 < size;
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.datalist, (int32_t)buffList, (int32_t)method, v3);
  ...
  while ( 1 )
  {
    v14 = *(_QWORD *)&datalist->max_length;
    if ( v13 >= (int)v14 )
      return;
    ...
    if ( size <= v13 )
    {
      BattleServantShowBuffComponent__CreateBuffObj(this, v13, v11);
    }
    else
    {
      updated = (System_Collections_Generic_List_object__o *)BattleServantShowBuffComponent__UpdateBuff(this, v13, v11);
      if ( ((unsigned __int8)updated & 1) == 0 )
        BattleServantShowBuffComponent__NewBuff(this, v13, v11);
    }
    datalist = *p_datalist;
    ++v13;
    if ( !*p_datalist )
  ...
  if ( size - v17 >= 1 && v13 < (int)v14 )
  {
    while ( 1 )
    {
      ...
      if ( !updated )
        break;
      v19 = 0;
      while ( v19 < updated->fields._size )
      {
        ...
        if ( monitor )
        {
          ...
          if ( v13 >= v22->max_length )
            sub_1B6432C(updated, v20);
          v23 = v22->m_Items[v13];
          if ( !v23 )
            goto LABEL_13;
          if ( monitor[9] == v23->fields.addOrder )
          {
            BattleServantBuffIconComponent__setIcon_43602588((BattleServantBuffIconComponent_o *)updated, 0LL, 0LL);
            --v18;
            break;
          }
        }
      ...
      if ( !*p_datalist )
        break;
      if ( v18 >= 1 && ++v13 < (signed int)(*p_datalist)->max_length )
        continue;
      return;
    }
LABEL_13:
