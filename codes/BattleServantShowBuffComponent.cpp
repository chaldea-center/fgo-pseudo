        ...
        const MethodInfo *method)
{
  ...
  Component_srcLineSprite = (BattleServantBuffIconComponent_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                  Object,
                                                                  (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_BattleServantBuffIconComponent___);
  datalist = this->fields.datalist;
  if ( !datalist )
    goto LABEL_9;
  if ( datalist->max_length <= index )
  {
    v10 = sub_B52A88(Component_srcLineSprite);
    sub_B52A28(v10, 0LL);
  }
  if ( !Component_srcLineSprite
    || (BattleServantBuffIconComponent__setIcon_21059808(Component_srcLineSprite, datalist->m_Items[index], 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2A6F & 1) == 0 )
  {
    ...
    this = (BattleServantShowBuffComponent_o *)sub_B52984(&Method_System_Collections_Generic_List_GameObject__get_Item__);
    byte_42B2A6F = 1;
  }
...
LABEL_18:
      BattleServantBuffIconComponent__setIcon_21059808((BattleServantBuffIconComponent_o *)this, 0LL, 0LL);
    }
LABEL_19:
    objList = v2->fields.objList;
    ++v4;
        ...
        const MethodInfo *method)
{
  ...
  BattleServantBuffIconComponent__setIcon_21059808(
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( monitor )
        {
          ...
          {
            BattleServantBuffIconComponent__setIcon_21059808((BattleServantBuffIconComponent_o *)updated, 0LL, 0LL);
            --v21;
            break;
          }
        }
