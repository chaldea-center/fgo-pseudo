...
void __fastcall SetSwitch2OptionControl__Init(SetSwitch2OptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B32619 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_9807/*"OPTION_FRIEND_COSTUME_DISP_EXPLANATION"*/, v4);
    sub_1BD3458(&StringLiteral_9806/*"OPTION_FRIEND_COSTUME_DISP"*/, v5);
    byte_4B32619 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3261C & 1) == 0 )
  {
    sub_1BD3458(&Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BD3470(Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__);
...
LABEL_11:
    sub_1BD36B4(friendCostumeDispBtn, v8);
  }
