...
void __fastcall SetSwitch2OptionControl__Init(SetSwitch2OptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FA18E & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_9617/*"OPTION_FRIEND_COSTUME_DISP_EXPLANATION"*/, v4);
    sub_1B64A00(&StringLiteral_9616/*"OPTION_FRIEND_COSTUME_DISP"*/, v5);
    byte_49FA18E = 1;
  }
  firnedCostumeDispTitle = this->fields.firnedCostumeDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9616/*"OPTION_FRIEND_COSTUME_DISP"*/, 0LL);
  if ( !firnedCostumeDispTitle
    || (UILabel__set_text(firnedCostumeDispTitle, v7, 0LL),
        ...
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9617/*"OPTION_FRIEND_COSTUME_DISP_EXPLANATION"*/, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA191 & 1) == 0 )
  {
    sub_1B64A00(&Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B64A18(Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__);
...
LABEL_11:
    sub_1B64C5C(friendCostumeDispBtn, v8);
  }
