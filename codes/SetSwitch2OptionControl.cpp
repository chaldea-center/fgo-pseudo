...
void SetSwitch2OptionControl__Init(SetSwitch2OptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF9A4 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_9742/*"OPTION_FRIEND_COSTUME_DISP_EXPLANATION"*/);
    sub_1CE6700(&StringLiteral_9741/*"OPTION_FRIEND_COSTUME_DISP"*/);
    byte_4DFF9A4 = 1;
  }
  firnedCostumeDispTitle = this->fields.firnedCostumeDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9741/*"OPTION_FRIEND_COSTUME_DISP"*/, 0);
  if ( !firnedCostumeDispTitle
    || (UILabel__set_text(firnedCostumeDispTitle, v4, 0),
        ...
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9742/*"OPTION_FRIEND_COSTUME_DISP_EXPLANATION"*/, 0),
...
void SetSwitch2OptionControl__OnFriendDispChangeBtn(SetSwitch2OptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF9A7 & 1) == 0 )
  {
    sub_1CE6700(&Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__);
  ...
  if ( (*((_BYTE *)Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1CE6718(Method_SetSwitch2OptionControl_OnFriendDispChangeBtn__);
...
LABEL_11:
    sub_1CE6958(friendCostumeDispBtn, v6);
  }
