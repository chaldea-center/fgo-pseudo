        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A83D & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_SummonInfoDlgComponent_EndClose__, v6);
    byte_4A2A83D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A83C & 1) == 0 )
  {
    sub_1B761C0(&LocalizationManager_TypeInfo, title);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A839 & 1) == 0 )
  {
    sub_1B761C0(&SummonInfoDlgComponent_CallbackFunc_TypeInfo, value);
    byte_4A2A839 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A2A83E & 1) == 0 )
  {
    sub_1B761C0(&StringLiteral_4680/*"ConfirmWindow/ConfirmBntInfo/DecideButton"*/, method);
    byte_4A2A83E = 1;
  }
  return (System_String_o *)StringLiteral_4680/*"ConfirmWindow/ConfirmBntInfo/DecideButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B9B54;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)&loc_19B9B14;
}
