...
void SummonInfoDlgComponent__Close(SummonInfoDlgComponent_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4D2CE0A & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SummonInfoDlgComponent_EndClose__);
    byte_4D2CE0A = 1;
  }
...
System_String_o *SummonInfoDlgComponent__get_closeBtnPath(SummonInfoDlgComponent_o *this, const MethodInfo *method)
{
  if ( (byte_4D2CE0B & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_4672/*"ConfirmWindow/ConfirmBntInfo/DecideButton"*/);
    byte_4D2CE0B = 1;
  }
  return (System_String_o *)StringLiteral_4672/*"ConfirmWindow/ConfirmBntInfo/DecideButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1AC4908;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1AC48C8;
}
