        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42184B8 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&Method_SummonInfoDlgComponent_EndClose__, v10);
    byte_42184B8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42184B4 & 1) == 0 )
  {
    sub_B0D8A4(&SummonInfoDlgComponent_CallbackFunc_TypeInfo, value);
    byte_42184B4 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  if ( (byte_42184B9 & 1) == 0 )
  {
    sub_B0D8A4(&StringLiteral_4239/*"ConfirmWindow/ConfirmBntInfo/DecideButton"*/, method);
    byte_42184B9 = 1;
  }
  return (System_String_o *)StringLiteral_4239/*"ConfirmWindow/ConfirmBntInfo/DecideButton"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  _DWORD *v28; // x11
  SummonInfoDlgComponent_CallbackFunc_o *v29; // [xsp+8h] [xbp-38h] BYREF
