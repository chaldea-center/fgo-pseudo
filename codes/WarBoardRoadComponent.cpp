void WarBoardRoadComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E74EA6 & 1) == 0 )
  {
    sub_1D0F0B4(&WarBoardRoadComponent_TypeInfo);
    sub_1D0F0B4(&StringLiteral_5422/*"DrawPath"*/);
    byte_4E74EA6 = 1;
  }
  WarBoardRoadComponent_TypeInfo->static_fields->UNLOCK_ANIMATION_NAME = (struct System_String_o *)StringLiteral_5422/*"DrawPath"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)WarBoardRoadComponent_TypeInfo->static_fields,
    StringLiteral_5422/*"DrawPath"*/,
    v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74EA5 & 1) == 0 )
  {
    this = (WarBoardRoadComponent_o *)sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    byte_4E74EA5 = 1;
  }
  if ( targets )
  {
...
void WarBoardRoadComponent__DisablePass(WarBoardRoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74EA2 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_23607/*"road"*/);
    byte_4E74EA2 = 1;
  }
  roadImage = this->fields.roadImage;
  if ( !roadImage )
    sub_1D0F30C(0, method);
  UISprite__set_spriteName(roadImage, (System_String_o *)StringLiteral_23607/*"road"*/, 0);
}
...
void WarBoardRoadComponent__EnablePass(WarBoardRoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E74EA1 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_23608/*"road_on"*/);
    byte_4E74EA1 = 1;
  }
  roadImage = this->fields.roadImage;
  if ( !roadImage )
    sub_1D0F30C(0, method);
  UISprite__set_spriteName(roadImage, (System_String_o *)StringLiteral_23608/*"road_on"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74EA0 & 1) == 0 )
  {
    ...
    this = (WarBoardRoadComponent_o *)sub_1D0F0B4(&StringLiteral_23607/*"road"*/);
    byte_4E74EA0 = 1;
  }
  if ( !road )
    goto LABEL_39;
  *(_QWORD *)&v16->fields.squareIndex1 = *(_QWORD *)&road->fields.squareIndex1;
  ...
  if ( !this )
    goto LABEL_39;
  UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_23607/*"road"*/, 0);
  this = (WarBoardRoadComponent_o *)v16->fields.roadImage;
  if ( !this )
    goto LABEL_39;
  ...
  if ( v29 <= 0.00001 )
  {
    if ( !byte_4E70C99 )
    {
      this = (WarBoardRoadComponent_o *)sub_1D0F0B4(&UnityEngine_Vector3_TypeInfo);
      byte_4E70C99 = 1;
    }
  ...
  if ( !transform )
LABEL_39:
    sub_1D0F30C(this, imageSetAtlas);
