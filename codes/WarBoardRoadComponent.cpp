void __fastcall WarBoardRoadComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E0356 & 1) == 0 )
  {
    sub_1B00CCC(&WarBoardRoadComponent_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_5345/*"DrawPath"*/, v4);
    byte_48E0356 = 1;
  }
  WarBoardRoadComponent_TypeInfo->static_fields->UNLOCK_ANIMATION_NAME = (struct System_String_o *)StringLiteral_5345/*"DrawPath"*/;
  sub_1B00C70(
    (ServantStatusBattleListViewItem_o *)WarBoardRoadComponent_TypeInfo->static_fields,
    StringLiteral_5345/*"DrawPath"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E0355 & 1) == 0 )
  {
    this = (WarBoardRoadComponent_o *)sub_1B00CCC(&UnityEngine_Object_TypeInfo, immediate);
    byte_48E0355 = 1;
  }
  if ( targets )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E0353 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_Component_GetComponentsInChildren_UIWidget____74599784, immediate);
    sub_1B00CCC(&UICommonButtonColor_TypeInfo, v5);
    byte_48E0353 = 1;
  }
...
void __fastcall WarBoardRoadComponent__DisablePass(WarBoardRoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E0352 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_22642/*"road"*/, method);
    byte_48E0352 = 1;
  }
  roadImage = this->fields.roadImage;
  if ( !roadImage )
    sub_1B00F28(0LL, method);
  UISprite__set_spriteName(roadImage, (System_String_o *)StringLiteral_22642/*"road"*/, 0LL);
}
...
void __fastcall WarBoardRoadComponent__EnablePass(WarBoardRoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E0351 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_22643/*"road_on"*/, method);
    byte_48E0351 = 1;
  }
  roadImage = this->fields.roadImage;
  if ( !roadImage )
    sub_1B00F28(0LL, method);
  UISprite__set_spriteName(roadImage, (System_String_o *)StringLiteral_22643/*"road_on"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E0350 & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___, imageSetAtlas);
    this = (WarBoardRoadComponent_o *)sub_1B00CCC(&StringLiteral_22642/*"road"*/, v17);
    byte_48E0350 = 1;
  }
  if ( !road )
    goto LABEL_39;
  *(_QWORD *)&v16->fields.squareIndex1 = *(_QWORD *)&road->fields.squareIndex1;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v16->fields.simpleAnimation, (int32_t)Component_object, v19, v20);
  ...
  if ( !this )
    goto LABEL_39;
  UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_22642/*"road"*/, 0LL);
  this = (WarBoardRoadComponent_o *)v16->fields.roadImage;
  if ( !this )
    goto LABEL_39;
  ...
  if ( !byte_48DD9F3 )
  {
    sub_1B00CCC(&System_Math_TypeInfo, imageSetAtlas);
    byte_48DD9F3 = 1;
  }
  v23 = v21 - y;
  v24 = x - v37;
  ...
  if ( v26 <= 0.00001 )
  {
    if ( !byte_48DD9F1 )
    {
      this = (WarBoardRoadComponent_o *)sub_1B00CCC(&UnityEngine_Vector3_TypeInfo, imageSetAtlas);
      byte_48DD9F1 = 1;
    }
  ...
  if ( !transform )
LABEL_39:
    sub_1B00F28(this, imageSetAtlas);
