void __fastcall WarBoardRoadComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B64594 & 1) == 0 )
  {
    sub_1BE4ACC(&WarBoardRoadComponent_TypeInfo, v1);
    sub_1BE4ACC(&StringLiteral_5489/*"DrawPath"*/, v8);
    byte_4B64594 = 1;
  }
  WarBoardRoadComponent_TypeInfo->static_fields->UNLOCK_ANIMATION_NAME = (struct System_String_o *)StringLiteral_5489/*"DrawPath"*/;
  sub_1BE4A70(
    (PartyOrganizationUtility_o *)WarBoardRoadComponent_TypeInfo->static_fields,
    StringLiteral_5489/*"DrawPath"*/,
    v2,
    v3,
    v4,
    v5,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64593 & 1) == 0 )
  {
    this = (WarBoardRoadComponent_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, immediate);
    byte_4B64593 = 1;
  }
  if ( targets )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B64591 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponentsInChildren_UIWidget____77181096, immediate);
    sub_1BE4ACC(&UICommonButtonColor_TypeInfo, v5);
    byte_4B64591 = 1;
  }
...
void __fastcall WarBoardRoadComponent__DisablePass(WarBoardRoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B64590 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_23285/*"road"*/, method);
    byte_4B64590 = 1;
  }
  roadImage = this->fields.roadImage;
  if ( !roadImage )
    sub_1BE4D28(0LL, method);
  UISprite__set_spriteName(roadImage, (System_String_o *)StringLiteral_23285/*"road"*/, 0LL);
}
...
void __fastcall WarBoardRoadComponent__EnablePass(WarBoardRoadComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6458F & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_23286/*"road_on"*/, method);
    byte_4B6458F = 1;
  }
  roadImage = this->fields.roadImage;
  if ( !roadImage )
    sub_1BE4D28(0LL, method);
  UISprite__set_spriteName(roadImage, (System_String_o *)StringLiteral_23286/*"road_on"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6458E & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_SimpleAnimation___, imageSetAtlas);
    this = (WarBoardRoadComponent_o *)sub_1BE4ACC(&StringLiteral_23285/*"road"*/, v17);
    byte_4B6458E = 1;
  }
  if ( !road )
    goto LABEL_39;
  *(_QWORD *)&v16->fields.squareIndex1 = *(_QWORD *)&road->fields.squareIndex1;
  ...
  if ( !this )
    goto LABEL_39;
  UISprite__set_spriteName((UISprite_o *)this, (System_String_o *)StringLiteral_23285/*"road"*/, 0LL);
  this = (WarBoardRoadComponent_o *)v16->fields.roadImage;
  if ( !this )
    goto LABEL_39;
  ...
  if ( !byte_4B612E3 )
  {
    sub_1BE4ACC(&System_Math_TypeInfo, imageSetAtlas);
    byte_4B612E3 = 1;
  }
  v27 = v25 - y;
  v28 = x - v41;
  ...
  if ( v30 <= 0.00001 )
  {
    if ( !byte_4B612E1 )
    {
      this = (WarBoardRoadComponent_o *)sub_1BE4ACC(&UnityEngine_Vector3_TypeInfo, imageSetAtlas);
      byte_4B612E1 = 1;
    }
  ...
  if ( !transform )
LABEL_39:
    sub_1BE4D28(this, imageSetAtlas);
