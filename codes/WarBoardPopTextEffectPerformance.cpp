        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B7E & 1) == 0 )
  {
    ...
    v14 = effetctPrefab;
    v15 = parent;
    sub_1B686D4(&StringLiteral_22885/*"root_text/type01/dm_base"*/, parent);
    parent = v15;
    effetctPrefab = v14;
  ...
  WarBoardCommonEffectPerformance___ctor(
    ...
    1,
    v19);
  v16 = UnityEngine_GameObject__Find((System_String_o *)StringLiteral_22885/*"root_text/type01/dm_base"*/, 0LL);
  this->fields.textObject = v16;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.textObject, (int32_t)v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B7F & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_UILabel___, text);
