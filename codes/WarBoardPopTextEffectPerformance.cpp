        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCA56 & 1) == 0 )
  {
    ...
    v14 = effetctPrefab;
    v15 = parent;
    sub_1B64A00(&StringLiteral_22872/*"root_text/type01/dm_base"*/, parent);
    parent = v15;
    effetctPrefab = v14;
  ...
  WarBoardCommonEffectPerformance___ctor(
    ...
    1,
    v19);
  v16 = UnityEngine_GameObject__Find((System_String_o *)StringLiteral_22872/*"root_text/type01/dm_base"*/, 0LL);
  this->fields.textObject = v16;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.textObject, (int32_t)v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCA57 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_UILabel___, text);
