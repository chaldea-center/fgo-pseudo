        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA341 & 1) == 0 )
  {
    ...
    v14 = effetctPrefab;
    v15 = parent;
    sub_1B640C8(&StringLiteral_22869/*"root_text/type01/dm_base"*/, parent);
    parent = v15;
    effetctPrefab = v14;
  ...
  WarBoardCommonEffectPerformance___ctor(
    ...
    1,
    v19);
  v16 = UnityEngine_GameObject__Find((System_String_o *)StringLiteral_22869/*"root_text/type01/dm_base"*/, 0LL);
  this->fields.textObject = v16;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)&this->fields.textObject, (int32_t)v16, v17, v18);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FA342 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_UILabel___, text);
  ...
  if ( !UnityEngine_Object__op_Equality(textObject, 0LL, 0LL) )
  {
    ...
    if ( v8 )
    {
      ...
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      v8 = (UnityEngine_GameObject_o *)UnityEngine_Object__op_Equality(
