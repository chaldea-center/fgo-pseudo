void __fastcall EventConquestRewardMaster___ctor(EventConquestRewardMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4216EFC & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_EventConquestRewardMaster__EventConquestRewardEntity__string___ctor__, method);
    byte_4216EFC = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    272,
    (const MethodInfo_2669F88 *)Method_DataMasterBase_EventConquestRewardMaster__EventConquestRewardEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventConquestRewardEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                          ...
                                          PK,
                                          (const MethodInfo_266A024 *)Method_DataMasterBase_EventConquestRewardMaster__EventConquestRewardEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_266A07C *)Method_DataMasterBase_EventConquestRewardMaster__EventConquestRewardEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4216EFD & 1) == 0 )
  {
    ...
    sub_B0D8A4(&EventConquestRewardEntity_TypeInfo, v6);
    sub_B0D8A4(&Method_System_Collections_Generic_List_EventConquestRewardEntity__Add__, v7);
    sub_B0D8A4(&Method_System_Collections_Generic_List_EventConquestRewardEntity__ToArray__, v8);
    sub_B0D8A4(&Method_System_Collections_Generic_List_EventConquestRewardEntity___ctor__, v9);
    sub_B0D8A4(&System_Collections_Generic_List_EventConquestRewardEntity__TypeInfo, v10);
    byte_4216EFD = 1;
  }
  ...
  System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData____ctor(
    v11,
    (const MethodInfo_2FC4A24 *)Method_System_Collections_Generic_List_EventConquestRewardEntity___ctor__);
  ...
  while ( 1 )
  {
    ...
    if ( list )
    {
      v14 = *(&EventConquestRewardEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(&list->klass->_2.bitflags2 + 1) >= (unsigned int)v14
        && (EventConquestRewardEntity_c *)list->klass->_2.typeHierarchy[v14 - 1] == EventConquestRewardEntity_TypeInfo
        && LODWORD(list->fields.items) == eventId )
      {
        ...
        System_Collections_Generic_List_EventMissionProgressRequest_Argument_ProgressData___Add(
          ...
          (const MethodInfo_2FC56E8 *)Method_System_Collections_Generic_List_EventConquestRewardEntity__Add__);
      }
    }
    list = (System_Collections_ObjectModel_Collection_UnicastIPAddressInformation__o *)this->fields.list;
    ++v13;
...
LABEL_17:
  ...
  return (EventConquestRewardEntity_array *)System_Collections_Generic_List_WarBoardUiData_SaveData___ToArray(
                                              ...
                                              (const MethodInfo_2FC7834 *)Method_System_Collections_Generic_List_EventConquestRewardEntity__ToArray__);
}