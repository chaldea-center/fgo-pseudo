...
void SceneJumpInfo___ctor_42243168(SceneJumpInfo_o *this, System_String_o *name, const MethodInfo *method)
{
  int32_t v5; // w2
  int32_t v6; // w3
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)name, v5, v6, v7, v8, v9, v10);
}


void SceneJumpInfo___ctor_42243216(SceneJumpInfo_o *this, int32_t id, const MethodInfo *method)
{
  System_Object___ctor((Il2CppObject *)this, 0);
  this->fields.id = id;
}
...
void SceneJumpInfo___ctor_42243256(SceneJumpInfo_o *this, System_String_o *name, int32_t id, const MethodInfo *method)
{
...
void SceneJumpInfo___ctor_42243316(
        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)v8, (int32_t)name, v9, v10, v11, v12, v13, v14);
  LODWORD(v8->monitor) = id;
  HIDWORD(v8->monitor) = num;
}


void SceneJumpInfo___ctor_42243388(
        SceneJumpInfo_o *this,
        System_String_o *name,
        int32_t id,
        int64_t userId,
...
void SceneJumpInfo___ctor_42243464(
        SceneJumpInfo_o *this,
        System_String_o *name,
        int64_t userId,
        const MethodInfo *method)
...
void SceneJumpInfo___ctor_42243524(
        SceneJumpInfo_o *this,
        System_String_o *name,
        int64_t userId,
        int64_t userId2,
...
void SceneJumpInfo___ctor_42243596(
        SceneJumpInfo_o *this,
        System_String_o *name,
        int64_t userId,
        int32_t num,
        ...
        const MethodInfo *method)
{
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)v10, (int32_t)name, v11, v12, v13, v14, v15, v16);
...
void SceneJumpInfo__SetName(SceneJumpInfo_o *this, System_String_o *name, const MethodInfo *method)
{
  ...
  this->fields.name = name;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)name, (int32_t)method, v3, v4, v5, v6, v7);
}
