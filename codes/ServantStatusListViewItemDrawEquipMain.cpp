        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B193E3 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_21216/*"maleImageId"*/, v11);
    sub_1BCAFF8(&StringLiteral_10768/*"QUEST_CLEAR_SWITCH_IMAGE_EXPLANATION"*/, v12);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v13);
    sub_1BCAFF8(&StringLiteral_20108/*"imagePartsGroupId"*/, v14);
    sub_1BCAFF8(&StringLiteral_6879/*"GENDER_TYPE_IMAGE_EXPLANATION"*/, v15);
    byte_4B193E3 = 1;
  }
  entity = 0LL;
  exp = 0;
  *(_QWORD *)barExp = 0LL;
  ...
  if ( item && mode )
  {
    ...
    if ( userSvtEntity )
    {
      ...
      if ( !servantFacceIcon )
        goto LABEL_55;
      ServantFaceIconComponent__Set_40190236(servantFacceIcon, userSvtEntity, 0LL, 0LL, 0LL);
    }
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if ( userSvtEntity )
          {
            if ( !servantFacceIcon )
              goto LABEL_55;
            ServantFaceIconComponent__Set_40196320(servantFacceIcon, (EquipTargetInfo_o *)userSvtEntity, 0LL, 0LL, 0LL);
          }
          else
          {
            if ( !servantFacceIcon )
    ...
    if ( levelLabel )
    {
      ...
      if ( maxLevelLabel )
      {
        ...
        if ( costLabel )
        {
          ...
          if ( attackIconLabel )
          {
            UIIconLabel__Set_40290232(attackIconLabel, 5, Atk, (int32_t)servantFacceIcon, 0, 0LL, 0, 0, 0, 0, 0LL);
            ...
            if ( hpIconLabel )
            {
              UIIconLabel__Set_40290232(hpIconLabel, 3, Hp, (int32_t)servantFacceIcon, 0, 0LL, 0, 0, 0, 0, 0LL);
                      ...
                      if ( entity )
                      {
                        ...
                        if ( ((unsigned __int8)servantFacceIcon & 1) != 0 )
                        {
                          ...
                          servantFacceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                             (System_String_o *)StringLiteral_6879/*"GENDER_TYPE_IMAGE_EXPLANATION"*/,
                                                                             0LL);
                        ...
                        if ( entity )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          servantFacceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                             (System_String_o *)StringLiteral_10768/*"QUEST_CLEAR_SWITCH_IMAGE_EXPLANATION"*/,
                                                                             0LL);
                          if ( v33 )
                          {
...
LABEL_55:
    sub_1BCB254(servantFacceIcon, userSvtEntity);
  }
}