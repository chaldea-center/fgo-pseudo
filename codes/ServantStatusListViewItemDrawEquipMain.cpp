        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01A9B & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_10960/*"QUEST_CLEAR_SWITCH_IMAGE_EXPLANATION"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    sub_1CE6700(&StringLiteral_20585/*"imagePartsGroupId"*/);
    sub_1CE6700(&StringLiteral_6983/*"GENDER_TYPE_IMAGE_EXPLANATION"*/);
    byte_4E01A9B = 1;
  }
  entity = 0;
  exp = 0;
  ...
  if ( item && mode )
  {
    ...
    if ( userSvtEntity )
    {
      ...
      if ( !servantFacceIcon )
        goto LABEL_55;
      ServantFaceIconComponent__Set_42235656(servantFacceIcon, userSvtEntity, 0, 0, 1, 0);
    }
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if ( userSvtEntity )
          {
            if ( !servantFacceIcon )
              goto LABEL_55;
            ServantFaceIconComponent__Set_42241744(servantFacceIcon, (EquipTargetInfo_o *)userSvtEntity, 0, 0, 0);
          }
          else
          {
            if ( !servantFacceIcon )
    ...
    if ( levelLabel )
    {
      ...
      if ( maxLevelLabel )
      {
        ...
        if ( costLabel )
        {
          ...
          if ( attackIconLabel )
          {
            UIIconLabel__Set_42257736(attackIconLabel, 5, Atk, (int32_t)servantFacceIcon, 0, 0, 0, 0, 0, 0, 0);
            ...
            if ( hpIconLabel )
            {
              UIIconLabel__Set_42257736(hpIconLabel, 3, Hp, (int32_t)servantFacceIcon, 0, 0, 0, 0, 0, 0, 0);
                      ...
                      if ( entity )
                      {
                        ...
                        if ( ((unsigned __int8)servantFacceIcon & 1) != 0 )
                        {
                          ...
                          servantFacceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                             (System_String_o *)StringLiteral_6983/*"GENDER_TYPE_IMAGE_EXPLANATION"*/,
                                                                             0);
                        ...
                        if ( entity )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          servantFacceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                             (System_String_o *)StringLiteral_10960/*"QUEST_CLEAR_SWITCH_IMAGE_EXPLANATION"*/,
                                                                             0);
                          if ( v24 )
                          {
...
LABEL_55:
    sub_1CE6958(servantFacceIcon, userSvtEntity);
  }
}