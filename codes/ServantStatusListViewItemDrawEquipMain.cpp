        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C53912 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_10852/*"QUEST_CLEAR_SWITCH_IMAGE_EXPLANATION"*/);
    sub_1C3E564(&StringLiteral_1/*""*/);
    sub_1C3E564(&StringLiteral_20307/*"imagePartsGroupId"*/);
    sub_1C3E564(&StringLiteral_6932/*"GENDER_TYPE_IMAGE_EXPLANATION"*/);
    byte_4C53912 = 1;
  }
  entity = 0;
  exp = 0;
  ...
  if ( item && mode )
  {
    ...
    if ( userSvtEntity )
    {
      ...
      if ( !servantFacceIcon )
        goto LABEL_55;
      ServantFaceIconComponent__Set_41053768(servantFacceIcon, userSvtEntity, 0, 0, 0);
    }
    else
    {
      ...
      else
      {
        ...
        if ( userSvtEntity )
        {
          ...
          if ( !servantFacceIcon )
            goto LABEL_55;
          ServantFaceIconComponent__Set_41057640(servantFacceIcon, (ServantLeaderInfo_o *)userSvtEntity, 0, 0, 0, 0, 0);
        }
        else
        {
          ...
          if ( userSvtEntity )
          {
            if ( !servantFacceIcon )
              goto LABEL_55;
            ServantFaceIconComponent__Set_41059852(servantFacceIcon, (EquipTargetInfo_o *)userSvtEntity, 0, 0, 0);
          }
          else
          {
            if ( !servantFacceIcon )
    ...
    if ( levelLabel )
    {
      ...
      if ( maxLevelLabel )
      {
        ...
        if ( costLabel )
        {
          ...
          if ( attackIconLabel )
          {
            UIIconLabel__Set_41158744(attackIconLabel, 5, Atk, (int32_t)servantFacceIcon, 0, 0, 0, 0, 0, 0, 0);
            ...
            if ( hpIconLabel )
            {
              UIIconLabel__Set_41158744(hpIconLabel, 3, Hp, (int32_t)servantFacceIcon, 0, 0, 0, 0, 0, 0, 0);
                      ...
                      if ( entity )
                      {
                        ...
                        if ( entity )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          servantFacceIcon = (ServantFaceIconComponent_o *)LocalizationManager__Get(
                                                                             (System_String_o *)StringLiteral_10852/*"QUEST_CLEAR_SWITCH_IMAGE_EXPLANATION"*/,
                                                                             0);
                          if ( v24 )
                          {
...
LABEL_55:
    sub_1C3E7C0(servantFacceIcon, userSvtEntity);
  }
}