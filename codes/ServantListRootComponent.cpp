...
void ServantListRootComponent__EndLoadCommonBg(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52D67 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ServantListRootComponent_EndLoadOutGameIconAtlas__);
    byte_4C52D67 = 1;
  }
...
void ServantListRootComponent__ExitList(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52D6B & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ServantListRootComponent_EndExitList__);
    byte_4C52D6B = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  v4 = (CharaGraphListMenu_RequestCallbackFunc_o *)sub_1C3E7B0(CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
...
void ServantListRootComponent__Init(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52D69 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ServantListRootComponent_SelectServantList__);
    byte_4C52D69 = 1;
  }
  if ( !this->fields.state )
  {
    this->fields.state = 1;
    charaGraphListMenu = this->fields.charaGraphListMenu;
    v4 = (CharaGraphListMenu_CallbackFunc_o *)sub_1C3E7B0(CharaGraphListMenu_CallbackFunc_TypeInfo);
...
void ServantListRootComponent__OnClickBack(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
    sub_1C3E564(&Method_ServantListRootComponent_EndClickBackRequest__);
    sub_1C3E564(&Method_ServantListRootComponent_OnClickBack__);
    byte_4C52D6C = 1;
  }
  v3 = Method_ServantListRootComponent_OnClickBack__;
  if ( (*((_BYTE *)Method_ServantListRootComponent_OnClickBack__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C3E57C(Method_ServantListRootComponent_OnClickBack__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C52D6A & 1) == 0 )
  {
    sub_1C3E564(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
    sub_1C3E564(&Method_ServantListRootComponent_EndClickBackRequest__);
    sub_1C3E564(&Method_ServantListRootComponent_EndServantQuestRequest__);
    byte_4C52D6A = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  if ( !charaGraphListMenu
    || ((CharaGraphListMenu__Init(charaGraphListMenu, *(const MethodInfo **)&result),
      ...
      : (v11 = &Method_ServantListRootComponent_EndClickBackRequest__),
        ...
        !v6) )
  {
    sub_1C3E7C0(charaGraphListMenu, *(_QWORD *)&result);
  }
...
void ServantListRootComponent__beginFinish(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !charaGraphListMenu
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)charaGraphListMenu, 0, 0),
        (charaGraphListMenu = (CharaGraphListMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39FF5A8 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__)) == 0) )
  {
    sub_1C3E7C0(charaGraphListMenu, method);
  }
...
void ServantListRootComponent__beginStartUp(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C52D66 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_ServantListRootComponent_EndLoadCommonBg__);
  ...
  if ( !titleInfo )
    goto LABEL_16;
  TitleInfoControl__changeTitleInfo_39891972(titleInfo, 1, 21, 0, 0);
