...
void __fastcall ServantListRootComponent__EndLoadCommonBg(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1BEA3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ServantListRootComponent_EndLoadOutGameIconAtlas__, v4);
    byte_4A1BEA3 = 1;
  }
...
void __fastcall ServantListRootComponent__ExitList(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1BEA7 & 1) == 0 )
  {
    sub_1B715CC(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo, method);
    sub_1B715CC(&Method_ServantListRootComponent_EndExitList__, v3);
    byte_4A1BEA7 = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  v5 = (CharaGraphListMenu_RequestCallbackFunc_o *)sub_1B71818(CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
...
void __fastcall ServantListRootComponent__Init(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1BEA5 & 1) == 0 )
  {
    sub_1B715CC(&CharaGraphListMenu_CallbackFunc_TypeInfo, method);
    sub_1B715CC(&Method_ServantListRootComponent_SelectServantList__, v3);
    byte_4A1BEA5 = 1;
  }
  if ( !this->fields.state )
  {
    this->fields.state = 1;
    charaGraphListMenu = this->fields.charaGraphListMenu;
    v5 = (CharaGraphListMenu_CallbackFunc_o *)sub_1B71818(CharaGraphListMenu_CallbackFunc_TypeInfo);
...
void __fastcall ServantListRootComponent__OnClickBack(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo, method);
    sub_1B715CC(&Method_ServantListRootComponent_EndClickBackRequest__, v3);
    sub_1B715CC(&Method_ServantListRootComponent_OnClickBack__, v4);
    byte_4A1BEA8 = 1;
  }
  v5 = Method_ServantListRootComponent_OnClickBack__;
  if ( (*((_BYTE *)Method_ServantListRootComponent_OnClickBack__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B715E4(Method_ServantListRootComponent_OnClickBack__);
  v6 = (System_Reflection_MethodBase_o *)sub_1B715B0(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 1, 0LL);
  charaGraphListMenu = this->fields.charaGraphListMenu;
  v8 = (CharaGraphListMenu_RequestCallbackFunc_o *)sub_1B71818(CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
  CharaGraphListMenu_RequestCallbackFunc___ctor(
    v8,
    (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1BEA6 & 1) == 0 )
  {
    sub_1B715CC(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1B715CC(&Method_ServantListRootComponent_EndClickBackRequest__, v5);
    sub_1B715CC(&Method_ServantListRootComponent_EndServantQuestRequest__, v6);
    byte_4A1BEA6 = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  if ( !charaGraphListMenu
    || ((CharaGraphListMenu__Init(charaGraphListMenu, *(const MethodInfo **)&result),
      ...
      : (v13 = &Method_ServantListRootComponent_EndClickBackRequest__),
        ...
        !v8) )
  {
    sub_1B71828(charaGraphListMenu, *(_QWORD *)&result);
  }
...
void __fastcall ServantListRootComponent__beginFinish(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !charaGraphListMenu
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)charaGraphListMenu, 0, 0LL),
        (charaGraphListMenu = (CharaGraphListMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__)) == 0LL) )
  {
    sub_1B71828(charaGraphListMenu, method);
  }
...
void __fastcall ServantListRootComponent__beginStartUp(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1BEA2 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_ServantListRootComponent_EndLoadCommonBg__, v5);
  ...
  if ( !titleInfo )
    goto LABEL_16;
  TitleInfoControl__changeTitleInfo_36987748(titleInfo, 1, 21, 0, 0LL);
