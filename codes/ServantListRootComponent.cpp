...
void __fastcall ServantListRootComponent__EndLoadCommonBg(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438D5AA & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_ServantListRootComponent_EndLoadOutGameIconAtlas__);
    byte_438D5AA = 1;
  }
...
void __fastcall ServantListRootComponent__ExitList(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438D5AE & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_ServantListRootComponent_EndExitList__);
    byte_438D5AE = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  v4 = (CharaGraphListMenu_RequestCallbackFunc_o *)sub_B77694(CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
...
void __fastcall ServantListRootComponent__Init(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438D5AC & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_ServantListRootComponent_SelectServantList__);
    byte_438D5AC = 1;
  }
  if ( !this->fields.state )
  {
    this->fields.state = 1;
    charaGraphListMenu = this->fields.charaGraphListMenu;
    v4 = (CharaGraphListMenu_CallbackFunc_o *)sub_B77694(CharaGraphListMenu_CallbackFunc_TypeInfo);
...
void __fastcall ServantListRootComponent__OnClickBack(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B775C4(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
    sub_B775C4(&Method_ServantListRootComponent_EndClickBackRequest__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438D5AD & 1) == 0 )
  {
    sub_B775C4(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
    sub_B775C4(&Method_ServantListRootComponent_EndClickBackRequest__);
    sub_B775C4(&Method_ServantListRootComponent_EndServantQuestRequest__);
    byte_438D5AD = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  if ( !charaGraphListMenu
    || ((CharaGraphListMenu__Init(charaGraphListMenu, 0LL),
      ...
      : (v10 = &Method_ServantListRootComponent_EndClickBackRequest__),
        ...
        !v6) )
  {
    sub_B7769C(charaGraphListMenu, *(_QWORD *)&result);
  }
...
void __fastcall ServantListRootComponent__beginFinish(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !charaGraphListMenu
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)charaGraphListMenu, 0, 0LL),
        (charaGraphListMenu = (CharaGraphListMenu_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2D1653C *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__)) == 0LL) )
  {
    sub_B7769C(charaGraphListMenu, method);
  }
...
void __fastcall ServantListRootComponent__beginStartUp(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438D5A9 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_ServantListRootComponent_EndLoadCommonBg__);
    sub_B775C4(&SoundManager_TypeInfo);
    byte_438D5A9 = 1;
  }
  ...
  if ( !titleInfo )
    goto LABEL_19;
  TitleInfoControl__changeTitleInfo_18674844(titleInfo, 1, 21, 0, 0LL);
