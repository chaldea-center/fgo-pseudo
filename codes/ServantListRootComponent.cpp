...
void __fastcall ServantListRootComponent__EndLoadCommonBg(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3347B & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_ServantListRootComponent_EndLoadOutGameIconAtlas__, v4);
    byte_4B3347B = 1;
  }
...
void __fastcall ServantListRootComponent__ExitList(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3347F & 1) == 0 )
  {
    sub_1BD3458(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo, method);
    sub_1BD3458(&Method_ServantListRootComponent_EndExitList__, v3);
    byte_4B3347F = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  v5 = (CharaGraphListMenu_RequestCallbackFunc_o *)sub_1BD36A4(CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
...
void __fastcall ServantListRootComponent__Init(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3347D & 1) == 0 )
  {
    sub_1BD3458(&CharaGraphListMenu_CallbackFunc_TypeInfo, method);
    sub_1BD3458(&Method_ServantListRootComponent_SelectServantList__, v3);
    byte_4B3347D = 1;
  }
  if ( !this->fields.state )
  {
    this->fields.state = 1;
    charaGraphListMenu = this->fields.charaGraphListMenu;
    v5 = (CharaGraphListMenu_CallbackFunc_o *)sub_1BD36A4(CharaGraphListMenu_CallbackFunc_TypeInfo);
...
void __fastcall ServantListRootComponent__OnClickBack(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo, method);
    sub_1BD3458(&Method_ServantListRootComponent_EndClickBackRequest__, v3);
    sub_1BD3458(&Method_ServantListRootComponent_OnClickBack__, v4);
    byte_4B33480 = 1;
  }
  v5 = Method_ServantListRootComponent_OnClickBack__;
  if ( (*((_BYTE *)Method_ServantListRootComponent_OnClickBack__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1BD3470(Method_ServantListRootComponent_OnClickBack__);
  v6 = (System_Reflection_MethodBase_o *)sub_1BD343C(v5, v5[4]);
  OverwriteAssetSoundName__PlaySystemSe(v6, 1, 0LL);
  charaGraphListMenu = this->fields.charaGraphListMenu;
  v8 = (CharaGraphListMenu_RequestCallbackFunc_o *)sub_1BD36A4(CharaGraphListMenu_RequestCallbackFunc_TypeInfo);
  CharaGraphListMenu_RequestCallbackFunc___ctor(
    v8,
    (Il2CppObject *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3347E & 1) == 0 )
  {
    sub_1BD3458(&CharaGraphListMenu_RequestCallbackFunc_TypeInfo, *(_QWORD *)&result);
    sub_1BD3458(&Method_ServantListRootComponent_EndClickBackRequest__, v5);
    sub_1BD3458(&Method_ServantListRootComponent_EndServantQuestRequest__, v6);
    byte_4B3347E = 1;
  }
  charaGraphListMenu = this->fields.charaGraphListMenu;
  if ( !charaGraphListMenu
    || ((CharaGraphListMenu__Init(charaGraphListMenu, 0LL),
      ...
      : (v13 = &Method_ServantListRootComponent_EndClickBackRequest__),
        ...
        !v8) )
  {
    sub_1BD36B4(charaGraphListMenu, *(_QWORD *)&result);
  }
  CharaGraphListMenu__StatusRequest(v8, v12, 0LL);
}
...
void __fastcall ServantListRootComponent__beginFinish(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !charaGraphListMenu
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)charaGraphListMenu, 0, 0LL),
        (charaGraphListMenu = (CharaGraphListMenu_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_AtlasManager__get_Instance__)) == 0LL) )
  {
    sub_1BD36B4(charaGraphListMenu, method);
  }
...
void __fastcall ServantListRootComponent__beginStartUp(ServantListRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3347A & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_ServantListRootComponent_EndLoadCommonBg__, v5);
  ...
  if ( !titleInfo )
    goto LABEL_16;
  TitleInfoControl__changeTitleInfo_37953932(titleInfo, 1, 21, 0, 0LL);
