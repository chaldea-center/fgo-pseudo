        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AED6C & 1) == 0 )
  {
    this = (BattleFieldEffectComponent_o *)sub_B52984(&string___TypeInfo);
    byte_42AED6C = 1;
  }
  fieldeffect = v2->fields.fieldeffect;
  if ( !fieldeffect )
    goto LABEL_15;
  this = (BattleFieldEffectComponent_o *)sub_B5299C(string___TypeInfo, fieldeffect->max_length);
  if ( !this )
    goto LABEL_15;
  ...
  if ( SLODWORD(this->fields.root2D) >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( this )
      {
        this = (BattleFieldEffectComponent_o *)sub_B52A44(this, v4->obj.klass->_1.element_class);
        if ( !this )
        {
          v17 = sub_B52A7C();
          sub_B52A28(v17, 0LL);
...
LABEL_16:
      ...
      sub_B52920((BattleServantConfConponent_o *)(v14 + 4), v13, v7, v8, v9, v10, v11, v12);
