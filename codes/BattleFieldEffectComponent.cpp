        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A50CDA & 1) == 0 )
  {
    this = (BattleFieldEffectComponent_o *)sub_1B863B8(&string___TypeInfo, method);
    byte_4A50CDA = 1;
  }
  fieldeffect = v2->fields.fieldeffect;
  if ( !fieldeffect )
    goto LABEL_13;
  this = (BattleFieldEffectComponent_o *)sub_1B86460(string___TypeInfo, fieldeffect->max_length);
  if ( !this )
    goto LABEL_13;
...
LABEL_14:
      ...
      sub_1B8635C((CGThumbnailListItem_o *)(v10 + 4), (int32_t)v9, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (index & 0x80000000) == 0 )
  {
    ...
    if ( max_length > index )
    {
      ...
      sub_1B8635C((CGThumbnailListItem_o *)&this->fields.viewobject, (int32_t)Object, v12, v13);
    }
  }
}