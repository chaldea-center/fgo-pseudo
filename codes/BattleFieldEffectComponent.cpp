        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1EE12 & 1) == 0 )
  {
    this = (BattleFieldEffectComponent_o *)sub_1BCAFF8(&string___TypeInfo, method);
    byte_4B1EE12 = 1;
  }
  fieldeffect = v2->fields.fieldeffect;
  if ( !fieldeffect )
    goto LABEL_13;
  this = (BattleFieldEffectComponent_o *)sub_1BCB0A0(string___TypeInfo, fieldeffect->max_length);
  if ( !this )
    goto LABEL_13;
...
LABEL_14:
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)(v10 + 4), (int32_t)v9, v4, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (index & 0x80000000) == 0 )
  {
    ...
    if ( max_length > index )
    {
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.viewobject, (int32_t)Object, v13, v14);
    }
  }
}