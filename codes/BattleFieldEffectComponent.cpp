        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07594 & 1) == 0 )
  {
    this = (BattleFieldEffectComponent_o *)sub_1CE6700(&string___TypeInfo);
    byte_4E07594 = 1;
  }
  fieldeffect = v2->fields.fieldeffect;
  if ( !fieldeffect )
    goto LABEL_13;
  this = (BattleFieldEffectComponent_o *)sub_1CE67A8(string___TypeInfo, LODWORD(fieldeffect->max_length));
  if ( !this )
    goto LABEL_13;
  v4 = this;
...
LABEL_14:
      ...
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v14 + 4), (int32_t)v13, v7, v8, v9, v10, v11, v12);
