void __fastcall SpendLimitMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBEC & 1) == 0 )
  {
    sub_1BC3008(&SpendLimitMenu_TypeInfo, v1);
    sub_1BC3008(&string___TypeInfo, v2);
    sub_1BC3008(&StringLiteral_1931/*"AGE_VEIFICATION_TYPE3"*/, v3);
    sub_1BC3008(&StringLiteral_1927/*"AGE_VEIFICATION_NONE"*/, v4);
    sub_1BC3008(&StringLiteral_1929/*"AGE_VEIFICATION_TYPE1"*/, v5);
    sub_1BC3008(&StringLiteral_1930/*"AGE_VEIFICATION_TYPE2"*/, v6);
    byte_4AFFBEC = 1;
  }
  v7 = sub_1BC30B0(string___TypeInfo, 4LL);
  if ( !v7 )
    sub_1BC3264(0LL, v8);
  v11 = v7;
  if ( !*(_DWORD *)(v7 + 24) )
    goto LABEL_9;
  v12 = StringLiteral_1927/*"AGE_VEIFICATION_NONE"*/;
  *(_QWORD *)(v7 + 32) = StringLiteral_1927/*"AGE_VEIFICATION_NONE"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v7 + 32), v12, v9, v10);
  if ( *(_DWORD *)(v11 + 24) <= 1u
    || (v14 = StringLiteral_1929/*"AGE_VEIFICATION_TYPE1"*/,
        *(_QWORD *)(v11 + 40) = StringLiteral_1929/*"AGE_VEIFICATION_TYPE1"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v11 + 40), v14, v9, v13),
        *(_DWORD *)(v11 + 24) <= 2u)
    || (v16 = StringLiteral_1930/*"AGE_VEIFICATION_TYPE2"*/,
        *(_QWORD *)(v11 + 48) = StringLiteral_1930/*"AGE_VEIFICATION_TYPE2"*/,
        sub_1BC2FAC((CGThumbnailListItem_o *)(v11 + 48), v16, v9, v15),
        *(_DWORD *)(v11 + 24) <= 3u) )
  {
LABEL_9:
    sub_1BC326C(v7, v8, v9);
  }
  v18 = StringLiteral_1931/*"AGE_VEIFICATION_TYPE3"*/;
  *(_QWORD *)(v11 + 56) = StringLiteral_1931/*"AGE_VEIFICATION_TYPE3"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)(v11 + 56), v18, v9, v17);
  SpendLimitMenu_TypeInfo->static_fields->typeTextList = (struct System_String_array *)v11;
  sub_1BC2FAC((CGThumbnailListItem_o *)SpendLimitMenu_TypeInfo->static_fields, v11, v19, v20);
}
...
void __fastcall SpendLimitMenu__Close(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  SpendLimitMenu__Close_37174096(this, 0LL, v2);
}


void __fastcall SpendLimitMenu__Close_37174096(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBE8 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_SpendLimitMenu_EndClose__, v6);
    byte_4AFFBE8 = 1;
  }
...
bool __fastcall SpendLimitMenu__IsLimitOver(SpendLimitMenu_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBE5 & 1) == 0 )
  {
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, *(_QWORD *)&value);
...
void __fastcall SpendLimitMenu__OnClickClose(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBE9 & 1) == 0 )
  {
    sub_1BC3008(&Method_SpendLimitMenu_OnClickClose__, method);
    byte_4AFFBE9 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SpendLimitMenu_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_SpendLimitMenu_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBE7 & 1) == 0 )
  {
    sub_1BC3008(&System_Action_TypeInfo, *(_QWORD *)&value);
    sub_1BC3008(&AgeVerificationMenu_TypeInfo, v7);
    sub_1BC3008(&LocalizationManager_TypeInfo, v8);
    sub_1BC3008(&Method_SpendLimitMenu_EndOpen__, v9);
    sub_1BC3008(&SpendLimitMenu_TypeInfo, v10);
    sub_1BC3008(&StringLiteral_12157/*"SPEND_LIMIT_CLOSE"*/, v11);
    sub_1BC3008(&StringLiteral_12158/*"SPEND_LIMIT_MESSAGE"*/, v12);
    sub_1BC3008(&StringLiteral_12159/*"SPEND_LIMIT_TITLE"*/, v13);
    byte_4AFFBE7 = 1;
  }
  ...
  if ( state == 3 )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)p_callbackFunc, (int32_t)callback, (int32_t)callback, method);
  ...
  else if ( !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12159/*"SPEND_LIMIT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_20;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    messageLabel = this->fields.messageLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12158/*"SPEND_LIMIT_MESSAGE"*/, 0LL);
    ...
    if ( v20 >= typeTextList->max_length )
      sub_1BC326C(gameObject, v16, v22);
    v26 = (Il2CppObject *)LocalizationManager__Get(typeTextList->m_Items[v20], 0LL);
    PriceInfo = (Il2CppObject *)LocalizationManager__GetPriceInfo(value, 0LL);
    gameObject = (UnityEngine_GameObject_o *)System_String__Format_62389940(v23, v26, PriceInfo, 0LL);
    if ( !messageLabel
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12157/*"SPEND_LIMIT_CLOSE"*/, 0LL),
          !closeLabel) )
    {
LABEL_20:
    ...
    System_Action___ctor(v29, (Il2CppObject *)this, Method_SpendLimitMenu_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFBE3 & 1) == 0 )
  {
    sub_1BC3008(&SpendLimitMenu_CallbackFunc_TypeInfo, value);
    byte_4AFFBE3 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0B460;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0B420;
}
