void __fastcall SpendLimitMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FC3A5 & 1) == 0 )
  {
    sub_1B64A00(&SpendLimitMenu_TypeInfo, v1);
    sub_1B64A00(&string___TypeInfo, v2);
    sub_1B64A00(&StringLiteral_2068/*"AGE_VEIFICATION_TYPE3"*/, v3);
    sub_1B64A00(&StringLiteral_2064/*"AGE_VEIFICATION_NONE"*/, v4);
    sub_1B64A00(&StringLiteral_2066/*"AGE_VEIFICATION_TYPE1"*/, v5);
    sub_1B64A00(&StringLiteral_2067/*"AGE_VEIFICATION_TYPE2"*/, v6);
    byte_49FC3A5 = 1;
  }
  v7 = sub_1B64AA8(string___TypeInfo, 4LL);
  if ( !v7 )
    sub_1B64C5C(0LL, v8);
  v11 = v7;
  if ( !*(_DWORD *)(v7 + 24) )
...
LABEL_9:
  ...
  *(_QWORD *)(v11 + 56) = StringLiteral_2068/*"AGE_VEIFICATION_TYPE3"*/;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)(v11 + 56), v21, v19, v20);
  SpendLimitMenu_TypeInfo->static_fields->typeTextList = (struct System_String_array *)v11;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)SpendLimitMenu_TypeInfo->static_fields, v11, v22, v23);
}
...
void __fastcall SpendLimitMenu__Close(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  SpendLimitMenu__Close_34592748(this, 0LL, v2);
}


void __fastcall SpendLimitMenu__Close_34592748(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC3A1 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_SpendLimitMenu_EndClose__, v6);
    byte_49FC3A1 = 1;
  }
...
bool __fastcall SpendLimitMenu__IsLimitOver(SpendLimitMenu_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_49FC39E & 1) == 0 )
  {
    sub_1B64A00(&AgeVerificationMenu_TypeInfo, *(_QWORD *)&value);
...
void __fastcall SpendLimitMenu__OnClickClose(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FC3A2 & 1) == 0 )
  {
    sub_1B64A00(&Method_SpendLimitMenu_OnClickClose__, method);
    byte_49FC3A2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SpendLimitMenu_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_SpendLimitMenu_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC3A0 & 1) == 0 )
  {
    sub_1B64A00(&System_Action_TypeInfo, *(_QWORD *)&value);
    sub_1B64A00(&AgeVerificationMenu_TypeInfo, v7);
    sub_1B64A00(&LocalizationManager_TypeInfo, v8);
    sub_1B64A00(&Method_SpendLimitMenu_EndOpen__, v9);
    sub_1B64A00(&SpendLimitMenu_TypeInfo, v10);
    sub_1B64A00(&StringLiteral_12139/*"SPEND_LIMIT_CLOSE"*/, v11);
    sub_1B64A00(&StringLiteral_12140/*"SPEND_LIMIT_MESSAGE"*/, v12);
    sub_1B64A00(&StringLiteral_12141/*"SPEND_LIMIT_TITLE"*/, v13);
    byte_49FC3A0 = 1;
  }
  ...
  else if ( !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12141/*"SPEND_LIMIT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_20;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    messageLabel = this->fields.messageLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12140/*"SPEND_LIMIT_MESSAGE"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Format_61399508(v22, v25, PriceInfo, 0LL);
    if ( !messageLabel
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12139/*"SPEND_LIMIT_CLOSE"*/, 0LL),
          !closeLabel) )
    {
LABEL_20:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC39C & 1) == 0 )
  {
    sub_1B64A00(&SpendLimitMenu_CallbackFunc_TypeInfo, value);
    byte_49FC39C = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19A9CD0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19A9C90;
}
