void __fastcall SpendLimitMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E04B1 & 1) == 0 )
  {
    sub_1B00CCC(&SpendLimitMenu_TypeInfo, v1);
    sub_1B00CCC(&string___TypeInfo, v2);
    sub_1B00CCC(&StringLiteral_2062/*"AGE_VEIFICATION_TYPE3"*/, v3);
    sub_1B00CCC(&StringLiteral_2058/*"AGE_VEIFICATION_NONE"*/, v4);
    sub_1B00CCC(&StringLiteral_2060/*"AGE_VEIFICATION_TYPE1"*/, v5);
    sub_1B00CCC(&StringLiteral_2061/*"AGE_VEIFICATION_TYPE2"*/, v6);
    byte_48E04B1 = 1;
  }
  v7 = sub_1B00D74(string___TypeInfo, 4LL);
  if ( !v7 )
    sub_1B00F28(0LL, v8);
  v11 = v7;
  if ( !*(_DWORD *)(v7 + 24) )
    goto LABEL_9;
  v12 = StringLiteral_2058/*"AGE_VEIFICATION_NONE"*/;
  *(_QWORD *)(v7 + 32) = StringLiteral_2058/*"AGE_VEIFICATION_NONE"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v7 + 32), v12, v9, v10);
  if ( *(_DWORD *)(v11 + 24) <= 1u
    || (v15 = StringLiteral_2060/*"AGE_VEIFICATION_TYPE1"*/,
        *(_QWORD *)(v11 + 40) = StringLiteral_2060/*"AGE_VEIFICATION_TYPE1"*/,
        sub_1B00C70((ServantStatusBattleListViewItem_o *)(v11 + 40), v15, v13, v14),
        *(_DWORD *)(v11 + 24) <= 2u)
    || (v18 = StringLiteral_2061/*"AGE_VEIFICATION_TYPE2"*/,
        *(_QWORD *)(v11 + 48) = StringLiteral_2061/*"AGE_VEIFICATION_TYPE2"*/,
        sub_1B00C70((ServantStatusBattleListViewItem_o *)(v11 + 48), v18, v16, v17),
        *(_DWORD *)(v11 + 24) <= 3u) )
  {
LABEL_9:
    sub_1B00F30(v7, v8);
  }
  v21 = StringLiteral_2062/*"AGE_VEIFICATION_TYPE3"*/;
  *(_QWORD *)(v11 + 56) = StringLiteral_2062/*"AGE_VEIFICATION_TYPE3"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v11 + 56), v21, v19, v20);
  SpendLimitMenu_TypeInfo->static_fields->typeTextList = (struct System_String_array *)v11;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)SpendLimitMenu_TypeInfo->static_fields, v11, v22, v23);
}
...
void __fastcall SpendLimitMenu__Close(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  SpendLimitMenu__Close_34117216(this, 0LL, v2);
}


void __fastcall SpendLimitMenu__Close_34117216(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04AD & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_SpendLimitMenu_EndClose__, v6);
    byte_48E04AD = 1;
  }
...
void __fastcall SpendLimitMenu__OnClickClose(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E04AE & 1) == 0 )
  {
    sub_1B00CCC(&Method_SpendLimitMenu_OnClickClose__, method);
    byte_48E04AE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SpendLimitMenu_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B00CE4(Method_SpendLimitMenu_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04AC & 1) == 0 )
  {
    sub_1B00CCC(&System_Action_TypeInfo, *(_QWORD *)&value);
    sub_1B00CCC(&AgeVerificationMenu_TypeInfo, v7);
    sub_1B00CCC(&LocalizationManager_TypeInfo, v8);
    sub_1B00CCC(&Method_SpendLimitMenu_EndOpen__, v9);
    sub_1B00CCC(&SpendLimitMenu_TypeInfo, v10);
    sub_1B00CCC(&StringLiteral_11999/*"SPEND_LIMIT_CLOSE"*/, v11);
    sub_1B00CCC(&StringLiteral_12000/*"SPEND_LIMIT_MESSAGE"*/, v12);
    sub_1B00CCC(&StringLiteral_12001/*"SPEND_LIMIT_TITLE"*/, v13);
    byte_48E04AC = 1;
  }
  ...
  else if ( !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12001/*"SPEND_LIMIT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_20;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    messageLabel = this->fields.messageLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12000/*"SPEND_LIMIT_MESSAGE"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Format_60340120(v22, v25, PriceInfo, 0LL);
    if ( !messageLabel
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11999/*"SPEND_LIMIT_CLOSE"*/, 0LL),
          !closeLabel) )
    {
LABEL_20:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E04A8 & 1) == 0 )
  {
    sub_1B00CCC(&SpendLimitMenu_CallbackFunc_TypeInfo, value);
    byte_48E04A8 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1948CD4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1948C94;
}
