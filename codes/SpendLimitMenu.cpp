void __fastcall SpendLimitMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDA011 & 1) == 0 )
  {
    sub_1C21E38(&SpendLimitMenu_TypeInfo);
  ...
  v1 = sub_1C21EE0(string___TypeInfo, 4LL);
  if ( !v1 )
    sub_1C22094(0LL, v2);
  v9 = v1;
  if ( !*(_DWORD *)(v1 + 24) )
    goto LABEL_9;
  v10 = StringLiteral_2068/*"AGE_VEIFICATION_NONE"*/;
  *(_QWORD *)(v1 + 32) = StringLiteral_2068/*"AGE_VEIFICATION_NONE"*/;
  sub_1C21DDC((PartyOrganizationUtility_o *)(v1 + 32), v10, v3, v4, v5, v6, v7, v8);
  if ( *(_DWORD *)(v9 + 24) <= 1u
    || (v17 = StringLiteral_2070/*"AGE_VEIFICATION_TYPE1"*/,
        *(_QWORD *)(v9 + 40) = StringLiteral_2070/*"AGE_VEIFICATION_TYPE1"*/,
        sub_1C21DDC((PartyOrganizationUtility_o *)(v9 + 40), v17, v11, v12, v13, v14, v15, v16),
        *(_DWORD *)(v9 + 24) <= 2u)
    || (v24 = StringLiteral_2071/*"AGE_VEIFICATION_TYPE2"*/,
        *(_QWORD *)(v9 + 48) = StringLiteral_2071/*"AGE_VEIFICATION_TYPE2"*/,
...
LABEL_9:
  ...
  v31 = StringLiteral_2072/*"AGE_VEIFICATION_TYPE3"*/;
  *(_QWORD *)(v9 + 56) = StringLiteral_2072/*"AGE_VEIFICATION_TYPE3"*/;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)SpendLimitMenu_TypeInfo->static_fields, v9, v32, v33, v34, v35, v36, v37);
}
...
void __fastcall SpendLimitMenu__Close(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  SpendLimitMenu__Close_36417484(this, 0LL, v2);
}


void __fastcall SpendLimitMenu__Close_36417484(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA00D & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_SpendLimitMenu_EndClose__);
    byte_4BDA00D = 1;
  }
...
void __fastcall SpendLimitMenu__OnClickClose(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDA00E & 1) == 0 )
  {
    sub_1C21E38(&Method_SpendLimitMenu_OnClickClose__);
    byte_4BDA00E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SpendLimitMenu_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_SpendLimitMenu_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA00C & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_SpendLimitMenu_EndOpen__);
    sub_1C21E38(&SpendLimitMenu_TypeInfo);
    sub_1C21E38(&StringLiteral_12428/*"SPEND_LIMIT_CLOSE"*/);
    sub_1C21E38(&StringLiteral_12429/*"SPEND_LIMIT_MESSAGE"*/);
    sub_1C21E38(&StringLiteral_12430/*"SPEND_LIMIT_TITLE"*/);
    byte_4BDA00C = 1;
  }
  ...
  else if ( !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12430/*"SPEND_LIMIT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_20;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    messageLabel = this->fields.messageLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12429/*"SPEND_LIMIT_MESSAGE"*/, 0LL);
    ...
    if ( !typeTextList )
      goto LABEL_20;
    if ( v17 >= typeTextList->max_length )
      sub_1C2209C(gameObject, v13);
    v22 = (Il2CppObject *)LocalizationManager__Get(typeTextList->m_Items[v17], 0LL);
    PriceInfo = (Il2CppObject *)LocalizationManager__GetPriceInfo(value, 0LL);
    gameObject = (UnityEngine_GameObject_o *)System_String__Format_63129848(v19, v22, PriceInfo, 0LL);
    if ( !messageLabel
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12428/*"SPEND_LIMIT_CLOSE"*/, 0LL),
          !closeLabel) )
    {
LABEL_20:
    ...
    System_Action___ctor(v25, (Il2CppObject *)this, Method_SpendLimitMenu_EndOpen__, 0LL);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A60F50;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A60F10;
}
