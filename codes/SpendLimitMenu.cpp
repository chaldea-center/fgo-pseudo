void __fastcall SpendLimitMenu___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC5582 & 1) == 0 )
  {
    sub_1C1ABD4(&SpendLimitMenu_TypeInfo, v1);
    sub_1C1ABD4(&string___TypeInfo, v2);
    sub_1C1ABD4(&StringLiteral_2072/*"AGE_VEIFICATION_TYPE3"*/, v3);
    sub_1C1ABD4(&StringLiteral_2068/*"AGE_VEIFICATION_NONE"*/, v4);
    sub_1C1ABD4(&StringLiteral_2070/*"AGE_VEIFICATION_TYPE1"*/, v5);
    sub_1C1ABD4(&StringLiteral_2071/*"AGE_VEIFICATION_TYPE2"*/, v6);
    byte_4BC5582 = 1;
  }
  v7 = sub_1C1AC7C(string___TypeInfo, 4LL);
  if ( !v7 )
    sub_1C1AE30(0LL, v8);
  v15 = v7;
  if ( !*(_DWORD *)(v7 + 24) )
    goto LABEL_9;
  v16 = StringLiteral_2068/*"AGE_VEIFICATION_NONE"*/;
  *(_QWORD *)(v7 + 32) = StringLiteral_2068/*"AGE_VEIFICATION_NONE"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v7 + 32), v16, v9, v10, v11, v12, v13, v14);
  if ( *(_DWORD *)(v15 + 24) <= 1u
    || (v23 = StringLiteral_2070/*"AGE_VEIFICATION_TYPE1"*/,
        *(_QWORD *)(v15 + 40) = StringLiteral_2070/*"AGE_VEIFICATION_TYPE1"*/,
        sub_1C1AB78((PartyOrganizationUtility_o *)(v15 + 40), v23, v17, v18, v19, v20, v21, v22),
        *(_DWORD *)(v15 + 24) <= 2u)
    || (v30 = StringLiteral_2071/*"AGE_VEIFICATION_TYPE2"*/,
        *(_QWORD *)(v15 + 48) = StringLiteral_2071/*"AGE_VEIFICATION_TYPE2"*/,
...
LABEL_9:
  ...
  v37 = StringLiteral_2072/*"AGE_VEIFICATION_TYPE3"*/;
  *(_QWORD *)(v15 + 56) = StringLiteral_2072/*"AGE_VEIFICATION_TYPE3"*/;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v15 + 56), v37, v31, v32, v33, v34, v35, v36);
  SpendLimitMenu_TypeInfo->static_fields->typeTextList = (struct System_String_array *)v15;
  sub_1C1AB78((PartyOrganizationUtility_o *)SpendLimitMenu_TypeInfo->static_fields, v15, v38, v39, v40, v41, v42, v43);
}
...
void __fastcall SpendLimitMenu__Close(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  SpendLimitMenu__Close_36376488(this, 0LL, v2);
}


void __fastcall SpendLimitMenu__Close_36376488(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC557E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_SpendLimitMenu_EndClose__, v10);
    byte_4BC557E = 1;
  }
...
bool __fastcall SpendLimitMenu__IsLimitOver(SpendLimitMenu_o *this, int32_t value, const MethodInfo *method)
{
  ...
  if ( (byte_4BC557B & 1) == 0 )
  {
    sub_1C1ABD4(&AgeVerificationMenu_TypeInfo, *(_QWORD *)&value);
...
void __fastcall SpendLimitMenu__OnClickClose(SpendLimitMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC557F & 1) == 0 )
  {
    sub_1C1ABD4(&Method_SpendLimitMenu_OnClickClose__, method);
    byte_4BC557F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SpendLimitMenu_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_SpendLimitMenu_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC557D & 1) == 0 )
  {
    sub_1C1ABD4(&System_Action_TypeInfo, *(_QWORD *)&value);
    sub_1C1ABD4(&AgeVerificationMenu_TypeInfo, v11);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v12);
    sub_1C1ABD4(&Method_SpendLimitMenu_EndOpen__, v13);
    sub_1C1ABD4(&SpendLimitMenu_TypeInfo, v14);
    sub_1C1ABD4(&StringLiteral_12418/*"SPEND_LIMIT_CLOSE"*/, v15);
    sub_1C1ABD4(&StringLiteral_12419/*"SPEND_LIMIT_MESSAGE"*/, v16);
    sub_1C1ABD4(&StringLiteral_12420/*"SPEND_LIMIT_TITLE"*/, v17);
    byte_4BC557D = 1;
  }
  ...
  else if ( !state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12420/*"SPEND_LIMIT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_20;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    messageLabel = this->fields.messageLabel;
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12419/*"SPEND_LIMIT_MESSAGE"*/, 0LL);
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Format_63054740(v26, v29, PriceInfo, 0LL);
    if ( !messageLabel
      || (UILabel__set_text(messageLabel, (System_String_o *)gameObject, 0LL),
          closeLabel = this->fields.closeLabel,
          gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12418/*"SPEND_LIMIT_CLOSE"*/, 0LL),
          !closeLabel) )
    {
LABEL_20:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC5579 & 1) == 0 )
  {
    sub_1C1ABD4(&SpendLimitMenu_CallbackFunc_TypeInfo, value);
    byte_4BC5579 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A59FA8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A59F68;
}
