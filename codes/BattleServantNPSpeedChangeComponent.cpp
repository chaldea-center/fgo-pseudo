void BattleServantNPSpeedChangeComponent___ctor(BattleServantNPSpeedChangeComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.maskColor = (struct UnityEngine_Color_o)xmmword_CF5020;
  this->fields.maskLabelEffectColor = (struct UnityEngine_Color_o)xmmword_CF4EF0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1DB7 & 1) == 0 )
  {
    sub_1C7BAE8(&Method_System_Array_IndexOf_UICommonButton___);
    sub_1C7BAE8(&BattleData_TypeInfo);
    sub_1C7BAE8(&Method_BattleServantNPSpeedChangeComponent_OnClickButton__);
    byte_4CF1DB7 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleServantNPSpeedChangeComponent_OnClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C7BB00(Method_BattleServantNPSpeedChangeComponent_OnClickButton__);
  ...
  else
  {
    ...
    v8 = System_Array__IndexOf_object_(
           ...
           (Il2CppObject *)button,
           (const MethodInfo_3275398 *)Method_System_Array_IndexOf_UICommonButton___);
  ...
  while ( 1 )
  {
    ...
    if ( supportServantLabel )
    {
      ...
      if ( npSpeedButtonSpriteArray )
      {
        ...
        if ( supportServantLabel )
        {
          v24 = (System_String_o **)(v22 == 4 ? &StringLiteral_17536/*"btn_bg_21"*/ : &StringLiteral_17535/*"btn_bg_20"*/);
...
LABEL_49:
              sub_1C7BD48(supportServantLabel);
  ...
  {
LABEL_48:
    sub_1C7BD40(supportServantLabel, method);
  }
...
LABEL_27:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12042/*"SERVANT_STATUS_TD_SPEED_FREE"*/, 0);
  if ( !v15 )
    goto LABEL_27;
  ...
  if ( LODWORD(v16->max_length) <= 1 )
    goto LABEL_28;
  v17 = v16->m_Items[1];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12038/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/, 0);
  if ( !v17 )
    goto LABEL_27;
...
LABEL_28:
  ...
  v19 = v18->m_Items[2];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12044/*"SERVANT_STATUS_TD_SPEED_TWICE"*/, 0);
  if ( !v19 )
    goto LABEL_27;
  UIRangeLabel__Set(v19, (System_String_o *)gameObject, 0, 1, 0, 0, 0);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12043/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, 0);
  if ( !explanationLabel )
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1DB8 & 1) == 0 )
  {
    sub_1C7BAE8(&LocalizationManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_17535/*"btn_bg_20"*/);
    sub_1C7BAE8(&StringLiteral_2886/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/);
    sub_1C7BAE8(&StringLiteral_17536/*"btn_bg_21"*/);
    byte_4CF1DB8 = 1;
  }
      ...
      if ( v13 )
      {
        ...
        if ( supportServantLabel )
        {
          ...
          if ( npSpeedButtonSpriteArray )
          {
            ...
            if ( supportServantLabel )
            {
              v15 = (System_String_o **)((_DWORD)v10 == 4 ? &StringLiteral_17536/*"btn_bg_21"*/ : &StringLiteral_17535/*"btn_bg_20"*/);
...
LABEL_43:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  supportServantLabel = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2886/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/, 0);
  if ( !v23 )
LABEL_42:
    sub_1C7BD40(supportServantLabel, method);
