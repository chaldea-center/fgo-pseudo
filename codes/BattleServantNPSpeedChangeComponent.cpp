        ...
        const MethodInfo *method)
{
  ...
  this->fields.maskColor = (struct UnityEngine_Color_o)xmmword_BAA2D0;
  this->fields.maskLabelEffectColor = (struct UnityEngine_Color_o)xmmword_BAA1A0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22ACE & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Array_IndexOf_UICommonButton___, button);
    sub_1B715CC(&BattleData_TypeInfo, v5);
    sub_1B715CC(&Method_BattleServantNPSpeedChangeComponent_OnClickButton__, v6);
    byte_4A22ACE = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleServantNPSpeedChangeComponent_OnClickButton__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B715E4(Method_BattleServantNPSpeedChangeComponent_OnClickButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22ACD & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_17429/*"btn_bg_20"*/, v3);
    sub_1B715CC(&StringLiteral_17430/*"btn_bg_21"*/, v4);
    byte_4A22ACD = 1;
  }
  ...
  while ( 1 )
  {
    ...
    if ( supportServantLabel )
    {
      ...
      if ( npSpeedButtonSpriteArray )
      {
        ...
        if ( supportServantLabel )
        {
          v26 = (System_String_o **)(v24 == 4 ? &StringLiteral_17430/*"btn_bg_21"*/ : &StringLiteral_17429/*"btn_bg_20"*/);
...
LABEL_49:
              sub_1B71830(supportServantLabel, method);
  ...
  {
LABEL_48:
    sub_1B71828(supportServantLabel, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22ACC & 1) == 0 )
  {
    sub_1B715CC(&LocalizationManager_TypeInfo, battleSvtData);
    sub_1B715CC(&StringLiteral_11895/*"SERVANT_STATUS_TD_SPEED_TWICE"*/, v6);
    sub_1B715CC(&StringLiteral_11893/*"SERVANT_STATUS_TD_SPEED_FREE"*/, v7);
    sub_1B715CC(&StringLiteral_11894/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, v8);
    sub_1B715CC(&StringLiteral_11889/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/, v9);
    byte_4A22ACC = 1;
  }
...
LABEL_27:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11893/*"SERVANT_STATUS_TD_SPEED_FREE"*/, 0LL);
  if ( !v15 )
    goto LABEL_27;
  ...
  if ( v16->max_length <= 1 )
    goto LABEL_28;
  v17 = v16->m_Items[1];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11889/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/, 0LL);
  if ( !v17 )
    goto LABEL_27;
...
LABEL_28:
  ...
  v19 = v18->m_Items[2];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11895/*"SERVANT_STATUS_TD_SPEED_TWICE"*/, 0LL);
  if ( !v19 )
    goto LABEL_27;
  UIRangeLabel__Set(v19, (System_String_o *)gameObject, 0LL, 1, 0, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11894/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22ACF & 1) == 0 )
  {
    sub_1B715CC(&LocalizationManager_TypeInfo, method);
    sub_1B715CC(&StringLiteral_17429/*"btn_bg_20"*/, v3);
    sub_1B715CC(&StringLiteral_2982/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/, v4);
    sub_1B715CC(&StringLiteral_17430/*"btn_bg_21"*/, v5);
    byte_4A22ACF = 1;
  }
      ...
      if ( v16 )
      {
        ...
        if ( supportServantLabel )
        {
          ...
          if ( npSpeedButtonSpriteArray )
          {
            ...
            if ( supportServantLabel )
            {
              v18 = (System_String_o **)((_DWORD)v13 == 4 ? &StringLiteral_17430/*"btn_bg_21"*/ : &StringLiteral_17429/*"btn_bg_20"*/);
...
LABEL_43:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  supportServantLabel = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2982/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/, 0LL);
  if ( !v26 )
LABEL_42:
    sub_1B71828(supportServantLabel, method);
