void BattleServantNPSpeedChangeComponent___ctor(BattleServantNPSpeedChangeComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.maskColor = (struct UnityEngine_Color_o)xmmword_CEBA20;
  this->fields.maskLabelEffectColor = (struct UnityEngine_Color_o)xmmword_CEB8F0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9A10 & 1) == 0 )
  {
    sub_1C6BA08(&Method_System_Array_IndexOf_UICommonButton___);
    sub_1C6BA08(&BattleData_TypeInfo);
    sub_1C6BA08(&Method_BattleServantNPSpeedChangeComponent_OnClickButton__);
    byte_4CB9A10 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleServantNPSpeedChangeComponent_OnClickButton__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C6BA20(Method_BattleServantNPSpeedChangeComponent_OnClickButton__);
  ...
  else
  {
    ...
    v8 = System_Array__IndexOf_object_(
           ...
           (Il2CppObject *)button,
           (const MethodInfo_3243314 *)Method_System_Array_IndexOf_UICommonButton___);
  ...
  while ( 1 )
  {
    ...
    if ( supportServantLabel )
    {
      ...
      if ( npSpeedButtonSpriteArray )
      {
        ...
        if ( supportServantLabel )
        {
          v24 = (System_String_o **)(v22 == 4 ? &StringLiteral_17463/*"btn_bg_21"*/ : &StringLiteral_17462/*"btn_bg_20"*/);
...
LABEL_49:
              sub_1C6BC68(supportServantLabel);
  ...
  {
LABEL_48:
    sub_1C6BC60(supportServantLabel, method);
  }
...
LABEL_27:
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.battleServantData, (int32_t)battleSvtData, (int32_t)method, v3);
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9A11 & 1) == 0 )
  {
    sub_1C6BA08(&LocalizationManager_TypeInfo);
    sub_1C6BA08(&StringLiteral_17462/*"btn_bg_20"*/);
    sub_1C6BA08(&StringLiteral_2880/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/);
    sub_1C6BA08(&StringLiteral_17463/*"btn_bg_21"*/);
    byte_4CB9A11 = 1;
  }
      ...
      if ( v13 )
      {
        ...
        if ( supportServantLabel )
        {
          ...
          if ( npSpeedButtonSpriteArray )
          {
            ...
            if ( supportServantLabel )
            {
              v15 = (System_String_o **)((_DWORD)v10 == 4 ? &StringLiteral_17463/*"btn_bg_21"*/ : &StringLiteral_17462/*"btn_bg_20"*/);
...
LABEL_43:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  supportServantLabel = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2880/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/, 0);
  if ( !v23 )
LABEL_42:
    sub_1C6BC60(supportServantLabel, method);
