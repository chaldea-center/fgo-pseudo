        ...
        const MethodInfo *method)
{
  ...
  this->fields.maskColor = (struct UnityEngine_Color_o)xmmword_BA2990;
  this->fields.maskLabelEffectColor = (struct UnityEngine_Color_o)xmmword_BA2860;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014CA & 1) == 0 )
  {
    sub_1B64870(&Method_System_Array_IndexOf_UICommonButton___, button);
    sub_1B64870(&BattleData_TypeInfo, v5);
    sub_1B64870(&Method_BattleServantNPSpeedChangeComponent_OnClickButton__, v6);
    byte_4A014CA = 1;
  }
  ...
  if ( (*((_BYTE *)Method_BattleServantNPSpeedChangeComponent_OnClickButton__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B64888(Method_BattleServantNPSpeedChangeComponent_OnClickButton__);
  ...
  else
  {
    ...
    v10 = System_Array__IndexOf_object_(
            ...
            (Il2CppObject *)button,
            (const MethodInfo_2F342DC *)Method_System_Array_IndexOf_UICommonButton___);
  ...
  while ( 1 )
  {
    ...
    if ( supportServantLabel )
    {
      ...
      if ( npSpeedButtonSpriteArray )
      {
        ...
        if ( supportServantLabel )
        {
          v26 = (System_String_o **)(v24 == 4 ? &StringLiteral_17412/*"btn_bg_21"*/ : &StringLiteral_17411/*"btn_bg_20"*/);
...
LABEL_49:
              sub_1B64AD4(supportServantLabel, method);
  ...
  {
LABEL_48:
    sub_1B64ACC(supportServantLabel, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014C8 & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, battleSvtData);
    sub_1B64870(&StringLiteral_11884/*"SERVANT_STATUS_TD_SPEED_TWICE"*/, v6);
    sub_1B64870(&StringLiteral_11882/*"SERVANT_STATUS_TD_SPEED_FREE"*/, v7);
    sub_1B64870(&StringLiteral_11883/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, v8);
    sub_1B64870(&StringLiteral_11878/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/, v9);
    byte_4A014C8 = 1;
  }
...
LABEL_27:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11882/*"SERVANT_STATUS_TD_SPEED_FREE"*/, 0LL);
  if ( !v15 )
    goto LABEL_27;
  ...
  if ( v16->max_length <= 1 )
    goto LABEL_28;
  v17 = v16->m_Items[1];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11878/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/, 0LL);
  if ( !v17 )
    goto LABEL_27;
...
LABEL_28:
  ...
  v19 = v18->m_Items[2];
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11884/*"SERVANT_STATUS_TD_SPEED_TWICE"*/, 0LL);
  if ( !v19 )
    goto LABEL_27;
  UIRangeLabel__Set(v19, (System_String_o *)gameObject, 0LL, 1, 0, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11883/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A014CB & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, method);
    sub_1B64870(&StringLiteral_17411/*"btn_bg_20"*/, v3);
    sub_1B64870(&StringLiteral_2976/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/, v4);
    sub_1B64870(&StringLiteral_17412/*"btn_bg_21"*/, v5);
    byte_4A014CB = 1;
  }
      ...
      if ( v16 )
      {
        ...
        if ( supportServantLabel )
        {
          ...
          if ( npSpeedButtonSpriteArray )
          {
            ...
            if ( supportServantLabel )
            {
              v18 = (System_String_o **)((_DWORD)v13 == 4 ? &StringLiteral_17412/*"btn_bg_21"*/ : &StringLiteral_17411/*"btn_bg_20"*/);
...
LABEL_43:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  supportServantLabel = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_2976/*"BATTLE_SUPPORT_SERVANT_NP_SPEED"*/, 0LL);
  if ( !v26 )
LABEL_42:
    sub_1B64ACC(supportServantLabel, method);
