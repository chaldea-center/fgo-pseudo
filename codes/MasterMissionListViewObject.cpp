        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A517A2 & 1) == 0 )
  {
    sub_1B863B8(&MasterMissionListViewItem_TypeInfo, method);
    byte_4A517A2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A517A3 & 1) == 0 )
  {
    sub_1B863B8(&MasterMissionListViewManager_TypeInfo, method);
    byte_4A517A3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A517A0 & 1) == 0 )
  {
    sub_1B863B8(&MasterMissionListViewItemDraw_TypeInfo, method);
    byte_4A517A0 = 1;
  }
