void CriDisposableObjectManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C3128F & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___ctor__);
    sub_1C32C20(&System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__TypeInfo);
    byte_4C3128F = 1;
  }
  v1 = (System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__o *)sub_1C32E6C(System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__TypeInfo);
  System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef____ctor(
    v1,
    (const MethodInfo_383B440 *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___ctor__);
  CriDisposableObjectManager_TypeInfo->static_fields->refList = v1;
  sub_1C32BC4(CriDisposableObjectManager_TypeInfo->static_fields, v1);
}
...
void CriDisposableObjectManager__DisposeAll(int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4C3128E & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__RemoveAt__);
    sub_1C32C20(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    sub_1C32C20(&CriDisposableObjectManager_ModuleType_TypeInfo);
    sub_1C32C20(&StringLiteral_15903/*"[CRIWARE] Internal: Object disposal(Type:"*/);
    sub_1C32C20(&StringLiteral_774/*") not handled by CriDisposableObjectManager; memory leak may have occured."*/);
    byte_4C3128E = 1;
  }
  ...
  lockTaken = 0;
  obj = refList;
  System_Threading_Monitor__Enter_65447948(refList, &lockTaken, 0);
  while ( 1 )
  {
    if ( !CriDisposableObjectManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CriDisposableObjectManager_TypeInfo);
    ...
    System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___get_Item(
      ...
      v8,
      NextWithType,
      (const MethodInfo_383B9A4 *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    ...
    else
    {
      ...
      *(_QWORD *)&v16.fields.guid.fields._d = -1;
      ...
      v13 = (Il2CppObject *)System_String__Concat_63556792(
                              (System_String_o *)StringLiteral_15903/*"[CRIWARE] Internal: Object disposal(Type:"*/,
                              v12,
      ...
      System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___RemoveAt(
        v14,
        NextWithType,
        (const MethodInfo_383D79C *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__RemoveAt__);
    }
  }
  if ( lockTaken )
...
int32_t CriDisposableObjectManager__GetNextWithType(int32_t type, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&CriDisposableObjectManager_TypeInfo);
    sub_1C32C20(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Count__);
    sub_1C32C20(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    byte_4C3128D = 1;
  }
  v3 = CriDisposableObjectManager_TypeInfo;
...
void CriDisposableObjectManager__Register(CriDisposable_o *disposable, int32_t type, const MethodInfo *method)
{
  ...
  __int128 v13; // q0
  char *v14; // x8
  const MethodInfo_383BD14 *v15; // x2
  ...
  if ( (byte_4C31289 & 1) == 0 )
  {
    sub_1C32C20(&CriDisposableObjectManager_TypeInfo);
    sub_1C32C20(&UnityEngine_Debug_TypeInfo);
    sub_1C32C20(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__Add__);
    sub_1C32C20(&StringLiteral_15902/*"[CRIWARE] Internal: Duplicated object GUID"*/);
    byte_4C31289 = 1;
  }
  if ( !CriDisposableObjectManager_TypeInfo->_2.cctor_finished )
  ...
  if ( CriDisposableObjectManager__SearchForDisposable(disposable, *(const MethodInfo **)&type) < 0 )
  {
    ...
    *(_QWORD *)&v16.fields.type = (unsigned int)type;
    v9 = sub_1C32BC4(&v16.fields.disposable, disposable);
    if ( !v8 )
      sub_1C32E7C(v9);
    v17 = v16;
    ...
    {
      v15 = *(const MethodInfo_383BD14 **)(*(_QWORD *)(v11[4] + 192LL) + 112LL);
      v18 = v17;
  ...
  else
  {
    if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0();
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_15902/*"[CRIWARE] Internal: Duplicated object GUID"*/, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4(&this->fields.disposable, disposable);
}