void CriDisposableObjectManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4DFDF3F & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___ctor__);
    sub_1CE6700(&System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__TypeInfo);
    byte_4DFDF3F = 1;
  }
  v1 = (System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__o *)sub_1CE694C(System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__TypeInfo);
  System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef____ctor(
    v1,
    (const MethodInfo_39A6668 *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___ctor__);
  CriDisposableObjectManager_TypeInfo->static_fields->refList = v1;
  sub_1CE66A4(CriDisposableObjectManager_TypeInfo->static_fields, v1);
}
...
void CriDisposableObjectManager__DisposeAll(int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4DFDF3E & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__RemoveAt__);
    sub_1CE6700(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    sub_1CE6700(&CriDisposableObjectManager_ModuleType_TypeInfo);
    sub_1CE6700(&StringLiteral_16053/*"[CRIWARE] Internal: Object disposal(Type:"*/);
    sub_1CE6700(&StringLiteral_773/*") not handled by CriDisposableObjectManager; memory leak may have occured."*/);
    byte_4DFDF3E = 1;
  }
  ...
  lockTaken = 0;
  obj = refList;
  System_Threading_Monitor__Enter_67050676(refList, &lockTaken, 0);
  while ( 1 )
  {
    if ( !CriDisposableObjectManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CriDisposableObjectManager_TypeInfo);
    ...
    System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___get_Item(
      ...
      v9,
      NextWithType,
      (const MethodInfo_39A6BCC *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    ...
    else
    {
      ...
      *(_QWORD *)&v19.fields.guid.fields._d = -1;
      ...
      v15 = (Il2CppObject *)System_String__Concat_65161092(
                              (System_String_o *)StringLiteral_16053/*"[CRIWARE] Internal: Object disposal(Type:"*/,
                              v14,
      ...
      System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___RemoveAt(
        v17,
        NextWithType,
        (const MethodInfo_39A89C4 *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__RemoveAt__);
    }
  }
  if ( lockTaken )
...
int32_t CriDisposableObjectManager__GetNextWithType(int32_t type, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&CriDisposableObjectManager_TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Count__);
    sub_1CE6700(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    byte_4DFDF3D = 1;
  }
  v3 = CriDisposableObjectManager_TypeInfo;
...
void CriDisposableObjectManager__Register(CriDisposable_o *disposable, int32_t type, const MethodInfo *method)
{
  ...
  __int128 v15; // q0
  char *v16; // x8
  const MethodInfo_39A6F3C *v17; // x2
  ...
  if ( (byte_4DFDF39 & 1) == 0 )
  {
    sub_1CE6700(&CriDisposableObjectManager_TypeInfo);
    sub_1CE6700(&UnityEngine_Debug_TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__Add__);
    sub_1CE6700(&StringLiteral_16052/*"[CRIWARE] Internal: Duplicated object GUID"*/);
    byte_4DFDF39 = 1;
  }
  if ( !CriDisposableObjectManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CriDisposableObjectManager_TypeInfo);
  if ( CriDisposableObjectManager__SearchForDisposable(disposable, *(const MethodInfo **)&type) < 0 )
  {
    ...
    *(_QWORD *)&v18.fields.type = (unsigned int)type;
    v10 = sub_1CE66A4(&v18.fields.disposable, disposable);
    if ( !v9 )
      sub_1CE6958(v10, v11);
    v19 = v18;
    ...
    {
      v17 = *(const MethodInfo_39A6F3C **)(*(_QWORD *)(v13[4] + 192LL) + 112LL);
      v20 = v19;
  ...
  else
  {
    if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo);
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_16052/*"[CRIWARE] Internal: Duplicated object GUID"*/, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields.disposable, disposable);
}