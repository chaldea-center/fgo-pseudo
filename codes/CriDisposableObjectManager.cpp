void CriDisposableObjectManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D29FCF & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___ctor__);
    sub_1C93AD4(&System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__TypeInfo);
    byte_4D29FCF = 1;
  }
  v1 = (System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__o *)sub_1C93D20(System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__TypeInfo);
  System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef____ctor(
    v1,
    (const MethodInfo_391A09C *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___ctor__);
  CriDisposableObjectManager_TypeInfo->static_fields->refList = v1;
  sub_1C93A78(CriDisposableObjectManager_TypeInfo->static_fields, v1);
}
...
void CriDisposableObjectManager__DisposeAll(int32_t type, const MethodInfo *method)
{
  ...
  if ( (byte_4D29FCE & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__RemoveAt__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    sub_1C93AD4(&CriDisposableObjectManager_ModuleType_TypeInfo);
    sub_1C93AD4(&StringLiteral_16002/*"[CRIWARE] Internal: Object disposal(Type:"*/);
    sub_1C93AD4(&StringLiteral_772/*") not handled by CriDisposableObjectManager; memory leak may have occured."*/);
    byte_4D29FCE = 1;
  }
  ...
  lockTaken = 0;
  obj = refList;
  System_Threading_Monitor__Enter_66353364(refList, &lockTaken, 0);
  while ( 1 )
  {
    if ( !CriDisposableObjectManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(CriDisposableObjectManager_TypeInfo);
    ...
    System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___get_Item(
      ...
      v9,
      NextWithType,
      (const MethodInfo_391A600 *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    ...
    else
    {
      ...
      *(_QWORD *)&v19.fields.guid.fields._d = -1;
      ...
      v15 = (Il2CppObject *)System_String__Concat_64463988(
                              (System_String_o *)StringLiteral_16002/*"[CRIWARE] Internal: Object disposal(Type:"*/,
                              v14,
      ...
      System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef___RemoveAt(
        v17,
        NextWithType,
        (const MethodInfo_391C3F8 *)Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__RemoveAt__);
    }
  }
  if ( lockTaken )
...
int32_t CriDisposableObjectManager__GetNextWithType(int32_t type, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&CriDisposableObjectManager_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Count__);
    sub_1C93AD4(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__get_Item__);
    byte_4D29FCD = 1;
  }
  v3 = CriDisposableObjectManager_TypeInfo;
...
void CriDisposableObjectManager__Register(CriDisposable_o *disposable, int32_t type, const MethodInfo *method)
{
  ...
  __int128 v15; // q0
  char *v16; // x8
  const MethodInfo_391A970 *v17; // x2
  ...
  if ( (byte_4D29FC9 & 1) == 0 )
  {
    sub_1C93AD4(&CriDisposableObjectManager_TypeInfo);
    sub_1C93AD4(&UnityEngine_Debug_TypeInfo);
    sub_1C93AD4(&Method_System_Collections_Generic_List_CriDisposableObjectManager_ObjectRef__Add__);
    sub_1C93AD4(&StringLiteral_16001/*"[CRIWARE] Internal: Duplicated object GUID"*/);
    byte_4D29FC9 = 1;
  }
  if ( !CriDisposableObjectManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CriDisposableObjectManager_TypeInfo);
  if ( CriDisposableObjectManager__SearchForDisposable(disposable, *(const MethodInfo **)&type) < 0 )
  {
    ...
    *(_QWORD *)&v18.fields.type = (unsigned int)type;
    v10 = sub_1C93A78(&v18.fields.disposable, disposable);
    if ( !v9 )
      sub_1C93D2C(v10, v11);
    v19 = v18;
    ...
    {
      v17 = *(const MethodInfo_391A970 **)(*(_QWORD *)(v13[4] + 192LL) + 112LL);
      v20 = v19;
  ...
  else
  {
    if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo);
    UnityEngine_Debug__LogWarning((Il2CppObject *)StringLiteral_16001/*"[CRIWARE] Internal: Duplicated object GUID"*/, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78(&this->fields.disposable, disposable);
}