void __fastcall ShopActionManager___ctor(ShopActionManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62FCB & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ShopActionEntity___ctor__, method);
    sub_1BE4ACC(&System_Collections_Generic_List_ShopActionEntity__TypeInfo, v3);
    byte_4B62FCB = 1;
  }
  v4 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_ShopActionEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v4,
    (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_ShopActionEntity___ctor__);
  this->fields.shopActionList = (struct System_Collections_Generic_List_ShopActionEntity__o *)v4;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.shopActionList, (int64_t)v4, v5, v6, v7, v8, v9, v10);
...
{
  const MethodInfo_3828DC8 **v2; // x20
  __int64 v4; // x1
  __int64 v5; // x1
  __int64 v6; // x1
  __int64 v7; // x1
  ...
  const MethodInfo_3828DC8 **v15; // x24
  ...
  v2 = (const MethodInfo_3828DC8 **)&Method_SingletonMonoBehaviour_AvalonSceneManager__get_Instance__;
  while ( 1 )
  {
    if ( (byte_4B62FC9 & 1) == 0 )
    {
      sub_1BE4ACC(&System_Action_TypeInfo, method);
      sub_1BE4ACC(&EventRewardRootComponent_TypeInfo, v4);
      sub_1BE4ACC(&Method_System_Collections_Generic_List_ShopActionEntity__RemoveAt__, v5);
      sub_1BE4ACC(&Method_System_Collections_Generic_List_ShopActionEntity__get_Count__, v6);
      sub_1BE4ACC(&Method_System_Collections_Generic_List_ShopActionEntity__get_Item__, v7);
      sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v8);
      sub_1BE4ACC(&Method_ShopActionManager_VoiceEnd__, v9);
      sub_1BE4ACC(v2, v10);
      byte_4B62FC9 = 1;
    }
    ...
    if ( !shopActionList )
LABEL_25:
      sub_1BE4D28(shopActionList, method);
    ...
    shopActionList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                    shopActionList,
                                                                    0,
                                                                    (const MethodInfo_35EBF54 *)Method_System_Collections_Generic_List_ShopActionEntity__get_Item__);
    ...
    System_Collections_Generic_List_object___RemoveAt(
      ...
      0,
      (const MethodInfo_35ED9F8 *)Method_System_Collections_Generic_List_ShopActionEntity__RemoveAt__);
    if ( !v12 )
      goto LABEL_25;
...
void __fastcall ShopActionManager__VoiceEnd(ShopActionManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62FCA & 1) == 0 )
  {
    sub_1BE4ACC(&Method_System_Collections_Generic_List_ShopActionEntity__get_Count__, method);
    this = (ShopActionManager_o *)sub_1BE4ACC(&UnityEngine_Object_TypeInfo, v3);
    byte_4B62FCA = 1;
  }
