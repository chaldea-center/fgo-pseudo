...
void __fastcall ShiningIconComponent__Set_39139932(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void __fastcall ShiningIconComponent__Set_39139944(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B66113 & 1) == 0 )
  {
    sub_1BE4ACC(&UISprite_TypeInfo, spriteName);
    byte_4B66113 = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
