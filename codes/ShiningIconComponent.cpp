...
void __fastcall ShiningIconComponent__Set_39658244(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void __fastcall ShiningIconComponent__Set_39658256(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C214AD & 1) == 0 )
  {
    sub_1C3B764(&UISprite_TypeInfo, spriteName);
    byte_4C214AD = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
