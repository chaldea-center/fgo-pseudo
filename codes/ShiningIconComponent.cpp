...
void ShiningIconComponent__Set_42247452(
...
void ShiningIconComponent__Set_42252400(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
