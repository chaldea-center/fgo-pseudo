...
void __fastcall ShiningIconComponent__Set_39549256(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void __fastcall ShiningIconComponent__Set_39549268(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCC9F & 1) == 0 )
  {
    sub_1C2E12C(&UISprite_TypeInfo, spriteName);
    byte_4BFCC9F = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
