...
void __fastcall ShiningIconComponent__Set_38614928(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void __fastcall ShiningIconComponent__Set_38614940(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB52C2 & 1) == 0 )
  {
    sub_1BAB41C(&UISprite_TypeInfo, spriteName);
    byte_4AB52C2 = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
