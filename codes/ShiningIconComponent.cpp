...
void ShiningIconComponent__Set_41065492(
...
void ShiningIconComponent__Set_41070436(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
