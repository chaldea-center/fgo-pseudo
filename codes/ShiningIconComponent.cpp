...
void ShiningIconComponent__Set_42466800(
...
void ShiningIconComponent__Set_42471748(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
