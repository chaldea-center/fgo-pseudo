...
void __fastcall ShiningIconComponent__Set_39432220(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void __fastcall ShiningIconComponent__Set_39432232(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7004 & 1) == 0 )
  {
    sub_1C1ABD4(&UISprite_TypeInfo, spriteName);
    byte_4BC7004 = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
