...
void ShiningIconComponent__Set_41856780(
...
void ShiningIconComponent__Set_41861724(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
