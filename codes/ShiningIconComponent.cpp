...
void __fastcall ShiningIconComponent__Set_39378588(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void __fastcall ShiningIconComponent__Set_39378600(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3C36 & 1) == 0 )
  {
    sub_1C13D24(&UISprite_TypeInfo, spriteName);
    byte_4BB3C36 = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
