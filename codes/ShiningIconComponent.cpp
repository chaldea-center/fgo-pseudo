...
void __fastcall ShiningIconComponent__Set_37977704(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A081F5 & 1) == 0 )
  {
    sub_1B686D4(&UISprite_TypeInfo, spriteName);
    byte_4A081F5 = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
...
void __fastcall ShiningIconComponent__Set_37981856(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
