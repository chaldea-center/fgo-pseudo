...
void __fastcall ShiningIconComponent__Set_38285992(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
...
void __fastcall ShiningIconComponent__Set_38286004(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F3FC & 1) == 0 )
  {
    sub_1B90010(&UISprite_TypeInfo, spriteName);
    byte_4A6F3FC = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
