...
void __fastcall ShiningIconComponent__Set_38025584(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F05D & 1) == 0 )
  {
    sub_1B715CC(&UISprite_TypeInfo, spriteName);
    byte_4A1F05D = 1;
  }
  widget = (UnityEngine_Behaviour_o *)this->fields.widget;
  if ( !widget )
...
void __fastcall ShiningIconComponent__Set_38029736(ShiningIconComponent_o *this, bool isDisp, const MethodInfo *method)
{
  if ( isDisp )
