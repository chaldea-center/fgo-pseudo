...
// local variable allocation has failed, the output may be wrong!
UnityEngine_Color_o __fastcall Easing__Func_46357892(
...
float __fastcall Easing__Func_46359004(float from, float to, float t, int32_t type, const MethodInfo *method)
{
  float v5; // s8
  float v6; // s9
  float v7; // s0
