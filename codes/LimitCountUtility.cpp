...
bool LimitCountUtility__CheckOption(int32_t svtId, int32_t limitCountStage, const MethodInfo *method)
{
  ...
  if ( (byte_4E03F15 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataManager_GetMaster_ServantLimitSpoilerProtectionMaster___);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_ServantLimitSpoilerProtectionMaster___);
  if ( !Master_object )
    sub_1CE6958(0, v6);
        ...
        const MethodInfo *method)
{
  ...
  return System_Math__Min_66644976(limitCountStage, limitCount, 0);
}


int32_t LimitCountUtility__ConvertStageToLimitCount_42187912(int32_t limitCountStage, const MethodInfo *method)
{
  if ( limitCountStage <= 4 )
  {
    if ( (unsigned int)(limitCountStage - 2) > 2 )
      ...
      return dword_D599F8[limitCountStage - 2];
  }
  return limitCountStage;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E03F16 & 1) == 0 )
  {
    sub_1CE6700(&LimitCountUtility__GetLimitCountStageList_d__21_TypeInfo);
    byte_4E03F16 = 1;
  }
  v5 = hasRewardStage;
  v6 = sub_1CE694C(LimitCountUtility__GetLimitCountStageList_d__21_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    v4 = (LimitCountUtility__GetLimitCountStageList_d__21_o *)sub_1CE694C(LimitCountUtility__GetLimitCountStageList_d__21_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_LimitCountUtility__GetLimitCountStageList_d__21_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
