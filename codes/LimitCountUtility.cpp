...
bool LimitCountUtility__CheckOption(int32_t svtId, int32_t limitCountStage, const MethodInfo *method)
{
  ...
  if ( (byte_4CC6830 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataManager_GetMaster_ServantLimitSpoilerProtectionMaster___);
  ...
  Master_object = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_ServantLimitSpoilerProtectionMaster___);
  if ( !Master_object )
    sub_1C71608(0, v6);
        ...
        const MethodInfo *method)
{
  ...
  return System_Math__Min_65553872(limitCountStage, limitCount, 0);
}


int32_t LimitCountUtility__ConvertStageToLimitCount_41234136(int32_t limitCountStage, const MethodInfo *method)
{
  if ( limitCountStage <= 4 )
  {
    if ( (unsigned int)(limitCountStage - 2) > 2 )
      ...
      return dword_D23A14[limitCountStage - 2];
  }
  return limitCountStage;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC6831 & 1) == 0 )
  {
    sub_1C713B0(&LimitCountUtility__GetLimitCountStageList_d__20_TypeInfo);
    byte_4CC6831 = 1;
  }
  v5 = hasRewardStage;
  v6 = sub_1C715FC(LimitCountUtility__GetLimitCountStageList_d__20_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  {
    v4 = (LimitCountUtility__GetLimitCountStageList_d__20_o *)sub_1C715FC(LimitCountUtility__GetLimitCountStageList_d__20_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_LimitCountUtility__GetLimitCountStageList_d__20_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
