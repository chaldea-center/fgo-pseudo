...
void __fastcall EventTowerListViewObject__Awake(EventTowerListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF870 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_EventTowerListViewItemDraw___);
    byte_42AF870 = 1;
  }
  ...
  Component_srcLineSprite = (struct EventTowerListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                     dispObject,
                                                                     (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_EventTowerListViewItemDraw___);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventTowerListViewObject__Init_24294340(
        EventTowerListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventTowerListViewObject__Init_24295244(
        EventTowerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall EventTowerListViewObject__Init_24295776(
        EventTowerListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void __fastcall EventTowerListViewObject__SetItem_24297820(
        EventTowerListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall EventTowerListViewObject__SetupDisp(EventTowerListViewObject_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&EventTowerListViewItem_TypeInfo);
    sub_B52984(&EventTowerListViewManager_TypeInfo);
    sub_B52984(&UnityEngine_Object_TypeInfo);
    byte_42AF875 = 1;
  }
  linkItem = this->fields.linkItem;
        ...
        const MethodInfo *method)
{
  ...
  v11 = (EventTowerListViewObject_o *)sub_B52D50(v8);
