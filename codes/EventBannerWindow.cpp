void __fastcall EventBannerWindow___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4AEA3 & 1) == 0 )
  {
    sub_1B863B8(&EventBannerWindow_TypeInfo, v1);
    byte_4A4AEA3 = 1;
  }
...
void __fastcall EventBannerWindow___ctor(EventBannerWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4AEA2 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBannerWindowScrollItem___ctor__, v3);
    sub_1B863B8(&System_Collections_Generic_List_EventBannerWindowScrollItem__TypeInfo, v4);
    byte_4A4AEA2 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_EventBannerWindowScrollItem__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_EventBannerWindowScrollItem___ctor__);
  this->fields.mScrollItems = (struct System_Collections_Generic_List_EventBannerWindowScrollItem__o *)v5;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mScrollItems, (int32_t)v5, v6, v7);
...
int32_t __fastcall EventBannerWindow__GetNowEventId(EventBannerWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4AE9F & 1) == 0 )
  {
    sub_1B863B8(&EventBannerWindow_TypeInfo, method);
    this = (EventBannerWindow_o *)sub_1B863B8(
...
void __fastcall EventBannerWindow__OnClickClose(EventBannerWindow_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4AEA0 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_EventBannerWindow_OnClickClose__, v3);
    sub_1B863B8(&Method_EventBannerWindow___c__OnClickClose_b__13_0__, v4);
    sub_1B863B8(&EventBannerWindow___c_TypeInfo, v5);
    byte_4A4AEA0 = 1;
  }
  v6 = Method_EventBannerWindow_OnClickClose__;
  if ( (*((_BYTE *)Method_EventBannerWindow_OnClickClose__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1B863D0(Method_EventBannerWindow_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AE9E & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EventDetailMaster___, ev_end_time_infs);
    sub_1B863B8(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__GetEntity__, v5);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_EventBannerWindowScrollItem__Dispose__, v6);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_EventBannerWindowScrollItem__MoveNext__, v7);
    sub_1B863B8(&Method_System_Collections_Generic_List_Enumerator_EventBannerWindowScrollItem__get_Current__, v8);
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_EventBannerWindowScrollItem___, v9);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBannerWindowScrollItem__Add__, v10);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBannerWindowScrollItem__Clear__, v11);
    sub_1B863B8(&Method_System_Collections_Generic_List_EventBannerWindowScrollItem__GetEnumerator__, v12);
    sub_1B863B8(&Method_System_Collections_Generic_List_TitleInfoControl_EventEndTimeInfo__get_Count__, v13);
    sub_1B863B8(&Method_System_Collections_Generic_List_TitleInfoControl_EventEndTimeInfo__get_Item__, v14);
    ...
    sub_1B863B8(&StringLiteral_5483/*"EVENT_BANNER_WINDOW_MESSAGE"*/, v19);
    sub_1B863B8(&StringLiteral_5484/*"EVENT_BANNER_WINDOW_TITLE"*/, v20);
    byte_4A4AE9E = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    mScrollItems,
    (const MethodInfo_35FD450 *)Method_System_Collections_Generic_List_EventBannerWindowScrollItem__GetEnumerator__);
  v47 = v46;
  while ( 1 )
  {
    v22 = System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v47,
            (const MethodInfo_3398634 *)Method_System_Collections_Generic_List_Enumerator_EventBannerWindowScrollItem__MoveNext__);
    if ( !v22 )
      break;
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v47,
    (const MethodInfo_3398630 *)Method_System_Collections_Generic_List_Enumerator_EventBannerWindowScrollItem__Dispose__);
  ...
  mScrollItems = (System_Collections_Generic_List_object__o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !mScrollItems )
    goto LABEL_41;
  ...
  if ( v31 >= 1 )
  {
    ...
    while ( 1 )
    {
      mScrollItems = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                    ...
                                                                    v33,
                                                                    (const MethodInfo_35FC688 *)Method_System_Collections_Generic_List_TitleInfoControl_EventEndTimeInfo__get_Item__);
      if ( !mScrollItems )
        break;
      if ( !v32 )
        break;
      ...
      if ( LODWORD(mScrollItems[1].monitor) )
      {
        ...
        Component_object = UnityEngine_GameObject__GetComponent_object_(
                             (UnityEngine_GameObject_o *)v35,
                             (const MethodInfo_2FC0DF0 *)Method_UnityEngine_GameObject_GetComponent_EventBannerWindowScrollItem___);
        mScrollItems = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                      (System_Collections_Generic_List_object__o *)ev_end_time_infs,
                                                                      v33,
                                                                      (const MethodInfo_35FC688 *)Method_System_Collections_Generic_List_TitleInfoControl_EventEndTimeInfo__get_Item__);
        ...
        else
        {
          ...
          *(_QWORD *)(v43 + 32) = Component_object;
          sub_1B8635C((CGThumbnailListItem_o *)(v43 + 32), (int32_t)Component_object, v38, v39);
        }
      }
      if ( v31 == ++v33 )
        goto LABEL_35;
...
LABEL_41:
    sub_1B86614(mScrollItems, ev_end_time_infs);
  }
LABEL_35:
  mScrollItems = (System_Collections_Generic_List_object__o *)this->fields.grid;
  if ( !mScrollItems )
  ...
  mScrollItems = (System_Collections_Generic_List_object__o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_5484/*"EVENT_BANNER_WINDOW_TITLE"*/,
                                                                0LL);
  if ( !titleLabel )
    goto LABEL_41;
  ...
  mScrollItems = (System_Collections_Generic_List_object__o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_5483/*"EVENT_BANNER_WINDOW_MESSAGE"*/,
                                                                0LL);
  if ( !titleDetailLabel )
    goto LABEL_41;
...
void __fastcall EventBannerWindow___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4AEA4 & 1) == 0 )
  {
    sub_1B863B8(&EventBannerWindow___c_TypeInfo, v1);
    byte_4A4AEA4 = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(EventBannerWindow___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventBannerWindow___c_TypeInfo->static_fields->__9 = (struct EventBannerWindow___c_o *)v2;
  sub_1B8635C((CGThumbnailListItem_o *)EventBannerWindow___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
