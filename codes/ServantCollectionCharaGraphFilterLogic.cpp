        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6DE7 & 1) == 0 )
  {
    sub_1C1ABD4(&CharaGraphServantCollectionListViewItem_TypeInfo, method);
    byte_4BC6DE7 = 1;
  }
    ...
    && (CharaGraphServantCollectionListViewItem_c *)listViewItem->klass->_2.typeHierarchy[methodPtr_low - 1] == CharaGraphServantCollectionListViewItem_TypeInfo )
  {
    ...
    sub_1C1AB78(p_listViewItem, (int64_t)item, v2, v3, v4, v5, v6, v7);
    return listViewItem;
  }
  sub_1C1B0F0(this->fields.item);
