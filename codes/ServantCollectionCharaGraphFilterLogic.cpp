        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F1DF & 1) == 0 )
  {
    sub_1B90010(&CharaGraphServantCollectionListViewItem_TypeInfo, method);
    byte_4A6F1DF = 1;
  }
    ...
    && (CharaGraphServantCollectionListViewItem_c *)listViewItem->klass->_2.typeHierarchy[methodPtr_low - 1] == CharaGraphServantCollectionListViewItem_TypeInfo )
  {
    ...
    sub_1B8FFB4(p_listViewItem, (int32_t)item, v2, v3);
    return listViewItem;
  }
  sub_1B9052C(this->fields.item);
