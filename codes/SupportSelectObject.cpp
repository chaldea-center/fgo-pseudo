...
void __fastcall SupportSelectObject__AddDepth(SupportSelectObject_o *this, int32_t depth, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A946 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_Component_GetComponentsInChildren_UIWidget____75925464, *(_QWORD *)&depth);
    byte_4A2A946 = 1;
  }
...
void __fastcall SupportSelectObject__Awake(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A93F & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_SupportSelectItemDraw___, method);
    byte_4A2A93F = 1;
  }
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
                       (const MethodInfo_2E58EAC *)Method_UnityEngine_Component_GetComponent_SupportSelectItemDraw___);
...
void __fastcall SupportSelectObject__ModifyItem(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( supportServantData )
    {
      ...
      if ( !v7 )
        sub_1B7641C(0LL, supportServantData);
...
void __fastcall SupportSelectObject__OnLongPressItem(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.callbackFunc )
  {
    ...
    else
    {
      ...
      {
        v10 = Servant;
        supportServantData = (SupportServantData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !supportServantData )
          goto LABEL_18;
        ...
        if ( Entity )
        {
          ...
          *(_QWORD *)&v14.fields.fakeValue = monitor;
          supportServantData = (SupportServantData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(
                                                         v14,
                                                         0LL);
...
LABEL_18:
            sub_1B7641C(supportServantData, method);
          }
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A942 & 1) == 0 )
  {
    sub_1B761C0(&UnityEngine_Object_TypeInfo, supportServantData);
    byte_4A2A942 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A945 & 1) == 0 )
  {
    this = (SupportSelectObject_o *)sub_1B761C0(&Method_SupportSelectObject_clickSelectItem__, *(_QWORD *)&result);
    byte_4A2A945 = 1;
  }
...
LABEL_18:
      ...
      if ( (*((_BYTE *)Method_SupportSelectObject_clickSelectItem__ + 83) & 2) != 0 )
        v15 = (_QWORD *)sub_1B761D8(Method_SupportSelectObject_clickSelectItem__);
