...
void SupportSelectObject__Awake(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC3A94 & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_Component_GetComponent_SupportSelectItemDraw___);
    byte_4CC3A94 = 1;
  }
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
                       (const MethodInfo_31418DC *)Method_UnityEngine_Component_GetComponent_SupportSelectItemDraw___);
...
void SupportSelectObject__ModifyItem(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0, 0) )
  {
    ...
    if ( supportServantData )
    {
      ...
      if ( !v5 )
        sub_1C71608(0, supportServantData);
...
void SupportSelectObject__OnLongPressItem(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.callbackFunc )
  {
    ...
    else
    {
      ...
      {
        v8 = Servant;
        supportServantData = (SupportServantData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !supportServantData )
          goto LABEL_18;
        ...
        if ( Entity )
        {
          ...
          *(_QWORD *)&v12.fields.fakeValue = monitor;
          supportServantData = (SupportServantData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(
                                                         v12,
                                                         0);
...
LABEL_18:
            sub_1C71608(supportServantData, method);
          }
        }
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3A9A & 1) == 0 )
  {
    this = (SupportSelectObject_o *)sub_1C713B0(&Method_SupportSelectObject_clickSelectItem__);
    byte_4CC3A9A = 1;
  }
...
LABEL_18:
      ...
      if ( (*((_BYTE *)Method_SupportSelectObject_clickSelectItem__ + 83) & 2) != 0 )
        v15 = (_QWORD *)sub_1C713C8(Method_SupportSelectObject_clickSelectItem__);
