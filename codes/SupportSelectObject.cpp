...
void SupportSelectObject__Awake(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C340AD & 1) == 0 )
  {
    sub_1C32C20(&Method_UnityEngine_Component_GetComponent_SupportSelectItemDraw___);
    byte_4C340AD = 1;
  }
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
                       (const MethodInfo_30D3BC0 *)Method_UnityEngine_Component_GetComponent_SupportSelectItemDraw___);
...
void SupportSelectObject__ClearItem(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.deckNum = 0;
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0, 0) )
  {
    ...
    if ( !v8 )
      sub_1C32E7C(0);
    SupportSelectItemDraw__ClearItem(v8, 0);
  }
}
...
void SupportSelectObject__OnLongPressItem(SupportSelectObject_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.callbackFunc )
  {
    ...
    else
    {
      ...
      {
        v8 = Servant;
        supportServantData = (SupportServantData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !supportServantData )
          goto LABEL_18;
        ...
        if ( Entity )
        {
          ...
          *(_QWORD *)&v12.fields.fakeValue = monitor;
          supportServantData = (SupportServantData_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48887784(
                                                         v12,
                                                         0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C340B3 & 1) == 0 )
  {
    this = (SupportSelectObject_o *)sub_1C32C20(&Method_SupportSelectObject_clickSelectItem__);
    byte_4C340B3 = 1;
  }
...
LABEL_18:
      ...
      if ( (*((_BYTE *)Method_SupportSelectObject_clickSelectItem__ + 83) & 2) != 0 )
        v15 = (_QWORD *)sub_1C32C38(Method_SupportSelectObject_clickSelectItem__);
