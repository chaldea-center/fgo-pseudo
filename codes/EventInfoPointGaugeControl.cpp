        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)(v7 + 32) = eventId;
  ...
  {
    if ( *(_QWORD *)v11 )
      (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(*(_QWORD *)v11 + 24LL))(
        ...
        const MethodInfo *method)
{
  ...
  int32_t v9; // w2
  const MethodInfo *v10; // x3
  EventInfoPointGaugeControl_assetLoadFinish_o *v11; // x21
  ...
  *(_QWORD *)(v7 + 16) = callbackEndFunc;
  ...
  EventInfoPointGaugeControl_assetLoadFinish___ctor(
    ...
    v12);
  EventInfoPointGaugeControl__LoadEventPointGaugeEffect(this, v11, eventId, v13);
}
...
LABEL_15:
  ...
  EventInfoPointGaugeControl__DestroyEventPointGaugeEffect(this, v20);
        ...
        const MethodInfo *method)
{
  ...
  EventInfoPointGaugeControl_o *v15; // x0
  ...
  *(_DWORD *)(v7 + 16) = UserEventPointMaster__GetEventActivityPoint(eventId, 0);
  ...
  m_CachedPtr = v15[1].fields.eventRoot[17].fields.m_CachedPtr;
  EventPointGaugeState = EventInfoPointGaugeControl__GetEventPointGaugeState(v15, eventId, v14);
  *(_DWORD *)(v7 + 32) = EventPointGaugeState;
  v18 = EventPointGaugeState;
  ...
  v22 = v18 == 1 && m_CachedPtr == 0;
  EVENT_POINT_GAUGE_EFFECT_CHANGE = v19->static_fields->EVENT_POINT_GAUGE_EFFECT_CHANGE;
  if ( v22 )
    v24 = 1;
  else
    v24 = m_CachedPtr;
...
LABEL_13:
  ...
  if ( !EventInfoPointGaugeControl_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(EventInfoPointGaugeControl_TypeInfo);
  if ( EventInfoPointGaugeControl__IsEventPointGaugeOpen(eventId, v20) )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( !TerminalPramsManager__CheckEventActivityPointSaveData(0) )
  {
    ...
    v24->static_fields->_BeforeEventActivityPointGauge_k__BackingField = EventPointGaugeState;
  ...
  BeforeEventActivityPointGauge_k__BackingField = v25->static_fields->_BeforeEventActivityPointGauge_k__BackingField;
  gameObject = (UnityEngine_GameObject_o *)EventInfoPointGaugeControl__GetEventPointGaugeState(
                                             (EventInfoPointGaugeControl_o *)v25,
                                             eventId,
                                             v19);
  EventPointGaugeComponent_k__BackingField = this->fields._EventPointGaugeComponent_k__BackingField;
  v30 = (_DWORD)gameObject == 1 && BeforeEventActivityPointGauge_k__BackingField == 0;
