        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B04788 & 1) == 0 )
  {
    sub_1BC3008(&QuestKnockdownInfo_TypeInfo, isRecord);
    byte_4B04788 = 1;
  }
  v7 = (Il2CppObject *)sub_1BC3254(QuestKnockdownInfo_TypeInfo);
  System_Object___ctor(v7, 0LL);
  v7[1].klass = 0LL;
  v7[1].monitor = 0LL;
  this->fields.current = (struct QuestKnockdownInfo_o *)v7;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.current, (int32_t)v7, v8, v9);
  v10 = (Il2CppObject *)sub_1BC3254(QuestKnockdownInfo_TypeInfo);
  System_Object___ctor(v10, 0LL);
  v10[1].klass = 0LL;
  v10[1].monitor = 0LL;
  this->fields.record = (struct QuestKnockdownInfo_o *)v10;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.record, (int32_t)v10, v11, v12);
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.current, (int32_t)currenctKnockdown, v16, v17);
  QuestKnockdownRecord = BattleData__getQuestKnockdownRecord(data, 0LL);
  this->fields.record = QuestKnockdownRecord;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.record, (int32_t)QuestKnockdownRecord, v19, v20);
}