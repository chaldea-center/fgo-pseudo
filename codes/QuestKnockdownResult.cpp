        ...
        const MethodInfo *method)
{
  ...
  v7 = (Il2CppObject *)sub_1C2D6DC(QuestKnockdownInfo_TypeInfo);
  System_Object___ctor(v7, 0);
  v7[1].klass = 0;
  v7[1].monitor = 0;
  this->fields.current = (struct QuestKnockdownInfo_o *)v7;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.current, (int32_t)v7, v8, v9);
  v10 = (Il2CppObject *)sub_1C2D6DC(QuestKnockdownInfo_TypeInfo);
  System_Object___ctor(v10, 0);
  v10[1].klass = 0;
  v10[1].monitor = 0;
  this->fields.record = (struct QuestKnockdownInfo_o *)v10;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.record, (int32_t)v10, v11, v12);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.current, (int32_t)currenctKnockdown, v16, v17);
  QuestKnockdownRecord = BattleData__getQuestKnockdownRecord(data, 0);
  this->fields.record = QuestKnockdownRecord;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.record, (int32_t)QuestKnockdownRecord, v19, v20);
}