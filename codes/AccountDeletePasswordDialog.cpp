void AccountDeletePasswordDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C31709 & 1) == 0 )
  {
    sub_1C32C20(&AccountDeletePasswordDialog_TypeInfo);
    byte_4C31709 = 1;
  }
...
void AccountDeletePasswordDialog__Close(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  AccountDeletePasswordDialog__Close_31086088(this, 0, v2);
}


void AccountDeletePasswordDialog__Close_31086088(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C316FF & 1) == 0 )
  {
    sub_1C32C20(&Method_AccountDeletePasswordDialog_EndClose__);
...
void AccountDeletePasswordDialog__EndClose(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( closeEndFunc )
  {
    ...
    sub_1C32BC4(&this->fields.closeEndFunc, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C316FE & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_1854/*"ACCOUNT_DELETE_PASSWORD_HIDDEN_STR"*/);
    this = (AccountDeletePasswordDialog_o *)sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C316FE = 1;
  }
  ...
  if ( !open )
  {
    ...
    if ( stringLength >= 1 )
    {
      do
      {
        ...
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_1854/*"ACCOUNT_DELETE_PASSWORD_HIDDEN_STR"*/, 0);
        --stringLength;
        passwordText = System_String__Concat_63518544(passwordText, v7, 0);
      }
      while ( stringLength );
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v12.fields.y = y;
    v12.fields.z = z;
    *(UnityEngine_Vector3_o *)&v8 = UnityEngine_Camera__WorldToScreenPoint_71029908(v10, v12, 0);
  }
  result.fields.y = v9;
  result.fields.x = v8;
  return result;
...
void AccountDeletePasswordDialog__OnClickCancel(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C31702 & 1) == 0 )
  {
    sub_1C32C20(&Method_AccountDeletePasswordDialog_OnClickCancel__);
    byte_4C31702 = 1;
  }
  ...
  {
    AccountDeletePasswordDialog__Close_31086088(this, 0, v5);
...
void AccountDeletePasswordDialog__OnClickCopy(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C31703 & 1) == 0 )
  {
    sub_1C32C20(&Method_AccountDeletePasswordDialog_OnClickCopy__);
...
void AccountDeletePasswordDialog__OnClickDecide(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C31700 & 1) == 0 )
  {
    sub_1C32C20(&Method_AccountDeletePasswordDialog_OnClickDecide__);
    byte_4C31700 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  AccountDeletePasswordDialog_c *v23; // x8
  ...
  if ( (byte_4C316FD & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_1849/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_MESSAGE"*/);
    sub_1C32C20(&StringLiteral_1858/*"ACCOUNT_DELETE_PASSWORD_NAME"*/);
    sub_1C32C20(&StringLiteral_1850/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_TITLE"*/);
    sub_1C32C20(&StringLiteral_1851/*"ACCOUNT_DELETE_PASSWORD_CANCEL"*/);
    sub_1C32C20(&StringLiteral_1859/*"ACCOUNT_DELETE_PASSWORD_PASSWORD"*/);
    sub_1C32C20(&StringLiteral_1857/*"ACCOUNT_DELETE_PASSWORD_ISSUED_WARNING"*/);
    sub_1C32C20(&StringLiteral_1853/*"ACCOUNT_DELETE_PASSWORD_DECIDE"*/);
    sub_1C32C20(&StringLiteral_1860/*"ACCOUNT_DELETE_PASSWORD_USER_ID"*/);
    sub_1C32C20(&StringLiteral_1856/*"ACCOUNT_DELETE_PASSWORD_ISSUED_TITLE"*/);
    sub_1C32C20(&StringLiteral_1/*""*/);
    sub_1C32C20(&StringLiteral_1848/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_INFO"*/);
    sub_1C32C20(&StringLiteral_1855/*"ACCOUNT_DELETE_PASSWORD_ISSUED_MESSAGE"*/);
    sub_1C32C20(&StringLiteral_1852/*"ACCOUNT_DELETE_PASSWORD_COPY"*/);
    byte_4C316FD = 1;
  }
  passwordTitleLabel = this->fields.passwordTitleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1859/*"ACCOUNT_DELETE_PASSWORD_PASSWORD"*/, 0);
  if ( !passwordTitleLabel )
    goto LABEL_37;
  UILabel__set_text(passwordTitleLabel, Instance, 0);
  userIdTitleLabel = this->fields.userIdTitleLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1860/*"ACCOUNT_DELETE_PASSWORD_USER_ID"*/, 0);
  if ( !userIdTitleLabel )
    goto LABEL_37;
  UILabel__set_text(userIdTitleLabel, Instance, 0);
  nameTitleLabel = this->fields.nameTitleLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1858/*"ACCOUNT_DELETE_PASSWORD_NAME"*/, 0);
  if ( !nameTitleLabel )
    goto LABEL_37;
  UILabel__set_text(nameTitleLabel, Instance, 0);
  buttonCopyLabel = this->fields.buttonCopyLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1852/*"ACCOUNT_DELETE_PASSWORD_COPY"*/, 0);
  if ( !buttonCopyLabel )
    goto LABEL_37;
  UILabel__set_text(buttonCopyLabel, Instance, 0);
  buttonDecideLabel = this->fields.buttonDecideLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1853/*"ACCOUNT_DELETE_PASSWORD_DECIDE"*/, 0);
  if ( !buttonDecideLabel )
    goto LABEL_37;
  UILabel__set_text(buttonDecideLabel, Instance, 0);
  buttonCancelLabel = this->fields.buttonCancelLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1851/*"ACCOUNT_DELETE_PASSWORD_CANCEL"*/, 0);
  if ( !buttonCancelLabel )
    goto LABEL_37;
  UILabel__set_text(buttonCancelLabel, Instance, 0);
  warningLabel = this->fields.warningLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1857/*"ACCOUNT_DELETE_PASSWORD_ISSUED_WARNING"*/, 0);
  if ( !warningLabel )
    goto LABEL_37;
  UILabel__set_text(warningLabel, Instance, 0);
  this->fields.passwordText = password;
  sub_1C32BC4(&this->fields.passwordText, password);
  ...
  else
  {
    ...
    {
LABEL_14:
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1850/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_TITLE"*/, 0);
      if ( titleLabel )
      {
        UILabel__set_text(titleLabel, Instance, 0);
        infoLabel = this->fields.infoLabel;
        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1848/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_INFO"*/, 0);
        if ( infoLabel )
        {
          UILabel__set_text(infoLabel, Instance, 0);
          messageLabel = this->fields.messageLabel;
          Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1849/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_MESSAGE"*/, 0);
          if ( messageLabel )
          {
            UILabel__set_text(messageLabel, Instance, 0);
            passwordLabel = this->fields.passwordLabel;
            Instance = AccountDeletePasswordDialog__GetPasswordText(this, 0, v21);
            if ( passwordLabel )
            {
              ...
              if ( Instance )
              {
                ...
                v23 = AccountDeletePasswordDialog_TypeInfo;
                ...
                GameObjectExtensions__SetLocalPositionY(gameObject, v23->static_fields->ALREADY_WARNING_LABEL_POS_Y, 0);
                Instance = (System_String_o *)this->fields.warningLabel;
                if ( Instance )
                {
...
LABEL_37:
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1856/*"ACCOUNT_DELETE_PASSWORD_ISSUED_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_37;
  UILabel__set_text(titleLabel, Instance, 0);
  v25 = this->fields.messageLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1855/*"ACCOUNT_DELETE_PASSWORD_ISSUED_MESSAGE"*/, 0);
  if ( !v25 )
    goto LABEL_37;
  UILabel__set_text(v25, Instance, 0);
  v26 = this->fields.passwordLabel;
  Instance = AccountDeletePasswordDialog__GetPasswordText(this, 1, v27);
  if ( !v26 )
    goto LABEL_37;
  UILabel__set_text(v26, Instance, 0);
LABEL_29:
  SelfUserGame = UserGameMaster__getSelfUserGame(0);
  Instance = (System_String_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
  if ( !Instance )
    goto LABEL_37;
  ...
  if ( !this->fields.userIdLabel )
    goto LABEL_37;
  v30 = ((unsigned __int8)Instance & 1) != 0 ? (System_String_o *)StringLiteral_1/*""*/ : DispFriendCode;
  UILabel__set_text(this->fields.userIdLabel, v30, 0);
  if ( !SelfUserGame )
    goto LABEL_37;
  ...
  BaseDialog__Open((BaseDialog_o *)this, 0, 0, 0, v31);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C31701 & 1) == 0 )
  {
    sub_1C32C20(&AccountDeletePasswordDialog__WaitForOpen_d__33_TypeInfo);
    byte_4C31701 = 1;
  }
  v2 = sub_1C32E6C(AccountDeletePasswordDialog__WaitForOpen_d__33_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  bool result; // w0
  System_String_o *WebViewAddress_41280180; // x19
  ...
  if ( _1__state >= 2 )
  {
    if ( _1__state == 2 )
    {
      ...
      WebViewAddress_41280180 = NetworkManager__getWebViewAddress_41280180(12, 0);
      if ( !UnityEngine_Application_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Application_TypeInfo);
      UnityEngine_Application__OpenURL(WebViewAddress_41280180, 0);
    }
    return 0;
  }
  else
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_AccountDeletePasswordDialog__WaitForOpen_d__33_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
