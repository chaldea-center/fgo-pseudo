void AccountDeletePasswordDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E70FB1 & 1) == 0 )
  {
    sub_1D0F0B4(&AccountDeletePasswordDialog_TypeInfo);
    byte_4E70FB1 = 1;
  }
...
void AccountDeletePasswordDialog__Close(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  AccountDeletePasswordDialog__Close_31982348(this, 0, v2);
}


void AccountDeletePasswordDialog__Close_31982348(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E70FA7 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_AccountDeletePasswordDialog_EndClose__);
...
void AccountDeletePasswordDialog__EndClose(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( closeEndFunc )
  {
    ...
    sub_1D0F058(&this->fields.closeEndFunc, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E70FA6 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_1851/*"ACCOUNT_DELETE_PASSWORD_HIDDEN_STR"*/);
    this = (AccountDeletePasswordDialog_o *)sub_1D0F0B4(&StringLiteral_1/*""*/);
    byte_4E70FA6 = 1;
  }
  ...
  if ( !open )
  {
    ...
    if ( stringLength >= 1 )
    {
      do
      {
        ...
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_1851/*"ACCOUNT_DELETE_PASSWORD_HIDDEN_STR"*/, 0);
        --stringLength;
        passwordText = System_String__Concat_65562772(passwordText, v7, 0);
      }
      while ( stringLength );
    }
  }
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v13.fields.y = y;
    v13.fields.z = z;
    *(UnityEngine_Vector3_o *)&v8 = UnityEngine_Camera__WorldToScreenPoint_73162808(v10, v13, 0);
  }
  result.fields.y = v9;
  result.fields.x = v8;
  return result;
...
void AccountDeletePasswordDialog__OnClickCancel(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E70FAA & 1) == 0 )
  {
    sub_1D0F0B4(&Method_AccountDeletePasswordDialog_OnClickCancel__);
    byte_4E70FAA = 1;
  }
  ...
  {
    AccountDeletePasswordDialog__Close_31982348(this, 0, v5);
    ...
    sub_1D0F058(&this->fields.clickFunc, 0);
  }
}
...
void AccountDeletePasswordDialog__OnClickCopy(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E70FAB & 1) == 0 )
  {
    sub_1D0F0B4(&Method_AccountDeletePasswordDialog_OnClickCopy__);
    sub_1D0F0B4(&UnityEngine_GUIUtility_TypeInfo);
    byte_4E70FAB = 1;
  }
...
void AccountDeletePasswordDialog__OnClickDecide(AccountDeletePasswordDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E70FA8 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_AccountDeletePasswordDialog_OnClickDecide__);
    byte_4E70FA8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E70FA5 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_1846/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_MESSAGE"*/);
    sub_1D0F0B4(&StringLiteral_1855/*"ACCOUNT_DELETE_PASSWORD_NAME"*/);
    sub_1D0F0B4(&StringLiteral_1847/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_1848/*"ACCOUNT_DELETE_PASSWORD_CANCEL"*/);
    sub_1D0F0B4(&StringLiteral_1856/*"ACCOUNT_DELETE_PASSWORD_PASSWORD"*/);
    sub_1D0F0B4(&StringLiteral_1854/*"ACCOUNT_DELETE_PASSWORD_ISSUED_WARNING"*/);
    sub_1D0F0B4(&StringLiteral_1850/*"ACCOUNT_DELETE_PASSWORD_DECIDE"*/);
    sub_1D0F0B4(&StringLiteral_1857/*"ACCOUNT_DELETE_PASSWORD_USER_ID"*/);
    sub_1D0F0B4(&StringLiteral_1853/*"ACCOUNT_DELETE_PASSWORD_ISSUED_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    sub_1D0F0B4(&StringLiteral_1845/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_INFO"*/);
    sub_1D0F0B4(&StringLiteral_1852/*"ACCOUNT_DELETE_PASSWORD_ISSUED_MESSAGE"*/);
    sub_1D0F0B4(&StringLiteral_1849/*"ACCOUNT_DELETE_PASSWORD_COPY"*/);
    byte_4E70FA5 = 1;
  }
  passwordTitleLabel = this->fields.passwordTitleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1856/*"ACCOUNT_DELETE_PASSWORD_PASSWORD"*/, 0);
  if ( !passwordTitleLabel )
    goto LABEL_37;
  UILabel__set_text(passwordTitleLabel, Instance, 0);
  userIdTitleLabel = this->fields.userIdTitleLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1857/*"ACCOUNT_DELETE_PASSWORD_USER_ID"*/, 0);
  if ( !userIdTitleLabel )
    goto LABEL_37;
  UILabel__set_text(userIdTitleLabel, Instance, 0);
  nameTitleLabel = this->fields.nameTitleLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1855/*"ACCOUNT_DELETE_PASSWORD_NAME"*/, 0);
  if ( !nameTitleLabel )
    goto LABEL_37;
  UILabel__set_text(nameTitleLabel, Instance, 0);
  buttonCopyLabel = this->fields.buttonCopyLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1849/*"ACCOUNT_DELETE_PASSWORD_COPY"*/, 0);
  if ( !buttonCopyLabel )
    goto LABEL_37;
  UILabel__set_text(buttonCopyLabel, Instance, 0);
  buttonDecideLabel = this->fields.buttonDecideLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1850/*"ACCOUNT_DELETE_PASSWORD_DECIDE"*/, 0);
  if ( !buttonDecideLabel )
    goto LABEL_37;
  UILabel__set_text(buttonDecideLabel, Instance, 0);
  buttonCancelLabel = this->fields.buttonCancelLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1848/*"ACCOUNT_DELETE_PASSWORD_CANCEL"*/, 0);
  if ( !buttonCancelLabel )
    goto LABEL_37;
  UILabel__set_text(buttonCancelLabel, Instance, 0);
  warningLabel = this->fields.warningLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1854/*"ACCOUNT_DELETE_PASSWORD_ISSUED_WARNING"*/, 0);
  if ( !warningLabel )
    goto LABEL_37;
  UILabel__set_text(warningLabel, Instance, 0);
  this->fields.passwordText = password;
  sub_1D0F058(&this->fields.passwordText, password);
  ...
  else
  {
    ...
    {
LABEL_14:
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1847/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_TITLE"*/, 0);
      if ( titleLabel )
      {
        UILabel__set_text(titleLabel, Instance, 0);
        infoLabel = this->fields.infoLabel;
        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1845/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_INFO"*/, 0);
        if ( infoLabel )
        {
          UILabel__set_text(infoLabel, Instance, 0);
          messageLabel = this->fields.messageLabel;
          Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1846/*"ACCOUNT_DELETE_PASSWORD_ALREADY_ISSUED_MESSAGE"*/, 0);
          if ( messageLabel )
          {
...
LABEL_37:
  ...
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1853/*"ACCOUNT_DELETE_PASSWORD_ISSUED_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_37;
  UILabel__set_text(titleLabel, Instance, 0);
  v26 = this->fields.messageLabel;
  Instance = LocalizationManager__Get((System_String_o *)StringLiteral_1852/*"ACCOUNT_DELETE_PASSWORD_ISSUED_MESSAGE"*/, 0);
  if ( !v26 )
    goto LABEL_37;
...
LABEL_29:
  ...
  Instance = (System_String_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
  if ( !Instance )
    goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E70FA9 & 1) == 0 )
  {
    sub_1D0F0B4(&AccountDeletePasswordDialog__WaitForOpen_d__33_TypeInfo);
    byte_4E70FA9 = 1;
  }
  v2 = sub_1D0F300(AccountDeletePasswordDialog__WaitForOpen_d__33_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  bool result; // w0
  System_String_o *WebViewAddress_42753856; // x19
  ...
  if ( _1__state >= 2 )
  {
    if ( _1__state == 2 )
    {
      ...
      WebViewAddress_42753856 = NetworkManager__getWebViewAddress_42753856(12, 0);
      if ( !UnityEngine_Application_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Application_TypeInfo);
      UnityEngine_Application__OpenURL(WebViewAddress_42753856, 0);
    }
    return 0;
  }
  else
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1D0F0C8(&Method_AccountDeletePasswordDialog__WaitForOpen_d__33_System_Collections_IEnumerator_Reset__);
  sub_1D0F1DC(v3, v4);
}
