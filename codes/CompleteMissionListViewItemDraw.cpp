void __fastcall CompleteMissionListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E16BB & 1) == 0 )
  {
    sub_1B00CCC(&CompleteMissionListViewItemDraw_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_6144/*"EventReward/EventRewardAtlas"*/, v4);
    byte_48E16BB = 1;
  }
  CompleteMissionListViewItemDraw_TypeInfo->static_fields->REWARDIMG_ATLAS_PATH = (struct System_String_o *)StringLiteral_6144/*"EventReward/EventRewardAtlas"*/;
  sub_1B00C70(
    (ServantStatusBattleListViewItem_o *)CompleteMissionListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_6144/*"EventReward/EventRewardAtlas"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E16B5 & 1) == 0 )
  {
    ...
    this = (CompleteMissionListViewItemDraw_o *)sub_1B00CCC(&UnityEngine_Object_TypeInfo, v6);
    byte_48E16B5 = 1;
  }
  if ( !data )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E16B4 & 1) == 0 )
  {
    sub_1B00CCC(&AssetManager_TypeInfo, missionListViewItem);
    sub_1B00CCC(&Method_CompleteMissionListViewItemDraw_EndLoadAchiveImg__, v9);
    sub_1B00CCC(&CompleteMissionListViewItemDraw_TypeInfo, v10);
    sub_1B00CCC(&CompleteMissionListViewItem_TypeInfo, v11);
    sub_1B00CCC(&CompleteMissionListViewManager_TypeInfo, v12);
    ...
    sub_1B00CCC(&StringLiteral_18989/*"event_rewardget_{0}01"*/, v16);
    sub_1B00CCC(&StringLiteral_18990/*"event_rewardget_{0}02"*/, v17);
    byte_48E16B4 = 1;
  }
...
LABEL_29:
  ...
  if ( v7->fields.dispNo == 1 )
    v29 = (System_String_o **)&StringLiteral_18989/*"event_rewardget_{0}01"*/;
  else
    v29 = (System_String_o **)&StringLiteral_18990/*"event_rewardget_{0}02"*/;
  v30 = *v29;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E16B6 & 1) == 0 )
  {
    ...
    this = (CompleteMissionListViewItemDraw_o *)sub_1B00CCC(&UnityEngine_Object_TypeInfo, v9);
    byte_48E16B6 = 1;
  }
  if ( !v5 )
    goto LABEL_64;
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v6->fields.giftEntityList, (int32_t)GiftListById, v14, v15);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  v17 = DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_EventMissionAddMaster___);
  this = (CompleteMissionListViewItemDraw_o *)MissionListViewItem__get_EventMissionEntity(
                                                (MissionListViewItem_o *)v5,
                                                0LL);
  if ( !this )
...
LABEL_35:
    ...
    if ( ((unsigned __int8)this & 1) != 0 )
    {
      ...
      if ( (int)item < 1 )
      {
        ...
        if ( !itemIcon )
          goto LABEL_64;
        ItemIconComponent__SetGift(itemIcon, v31, rewardObjectId, (int32_t)this, 0, 0LL);
      }
      else
      {
        if ( !itemIcon )
        ...
        if ( num <= 1 )
          ...
          v28 = num;
        ItemIconComponent__SetItemImage_36937060(v6->fields.itemIcon, (int32_t)item, v28, 0LL);
      }
    }
    else
    {
...
LABEL_65:
  ...
  if ( (int)item < 1 )
  {
    ...
    if ( v22 <= 1 )
      ...
      v34 = v21->fields.num;
    ItemIconComponent__SetGift((ItemIconComponent_o *)this, v21->fields.type, v21->fields.objectId, v34, 0, 0LL);
  }
  else
  {
    if ( !this )
    ...
    if ( v22 <= 1 )
      ...
      v23 = v21->fields.num;
    ItemIconComponent__SetItemImage_36937060((ItemIconComponent_o *)this, (int32_t)item, v23, 0LL);
  }
LABEL_51:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E16B7 & 1) == 0 )
  {
    sub_1B00CCC(&CompleteMissionListViewItem_TypeInfo, missionListViewItem);
    byte_48E16B7 = 1;
  }
