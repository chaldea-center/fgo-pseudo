void CompleteMissionListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CED0A9 & 1) == 0 )
  {
    sub_1C7BAE8(&CompleteMissionListViewItemDraw_TypeInfo);
    sub_1C7BAE8(&StringLiteral_6257/*"EventReward/EventRewardAtlas"*/);
    byte_4CED0A9 = 1;
  }
  CompleteMissionListViewItemDraw_TypeInfo->static_fields->REWARDIMG_ATLAS_PATH = (struct System_String_o *)StringLiteral_6257/*"EventReward/EventRewardAtlas"*/;
  sub_1C7BA8C(
    (GrandQuestFolderBoardItem_o *)CompleteMissionListViewItemDraw_TypeInfo->static_fields,
    StringLiteral_6257/*"EventReward/EventRewardAtlas"*/,
    v1,
    v2,
    v3,
    v4,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED0A3 & 1) == 0 )
  {
    ...
    this = (CompleteMissionListViewItemDraw_o *)sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    byte_4CED0A3 = 1;
  }
  if ( !data )
    goto LABEL_14;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CED0A2 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_CompleteMissionListViewItemDraw_EndLoadAchiveImg__);
    sub_1C7BAE8(&CompleteMissionListViewItemDraw_TypeInfo);
    ...
    sub_1C7BAE8(&UnityEngine_Object_TypeInfo);
    sub_1C7BAE8(&StringLiteral_19408/*"event_rewardget_{0}01"*/);
    sub_1C7BAE8(&StringLiteral_19409/*"event_rewardget_{0}02"*/);
    byte_4CED0A2 = 1;
  }
...
LABEL_29:
  ...
  if ( missionListViewItem->fields.dispNo == 1 )
    v17 = (System_String_o **)&StringLiteral_19408/*"event_rewardget_{0}01"*/;
  else
    v17 = (System_String_o **)&StringLiteral_19409/*"event_rewardget_{0}02"*/;
  v18 = *v17;
