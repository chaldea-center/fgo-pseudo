        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D9A0 & 1) == 0 )
  {
    sub_1B885B0(&Method_BasicHelper_IndexValue_GameObject___);
    sub_1B885B0(&Method_System_Linq_Enumerable_First_GameObject___);
    byte_4A5D9A0 = 1;
  }
  ...
  object = System_Linq_Enumerable__First_object_(
             ...
             (const MethodInfo_2EA17D4 *)Method_System_Linq_Enumerable_First_GameObject___);
  v7 = BasicHelper__IndexValue_object__48686808(
         (System_Collections_Generic_List_T__o *)buffTextClassIconList,
         color - 1,
         object,
         (const MethodInfo_2E6E6D8 *)Method_BasicHelper_IndexValue_GameObject___);
  return WrapBaseBattlePopupControl__CreatePopupObject(
           (WrapBaseBattlePopupControl_o *)this,
        ...
        const MethodInfo *method)
{
  ...
  if ( critical )
    ...
    v10 = v9;
  v11 = BasicHelper__IndexValue_object__48686808(
        ...
        const MethodInfo *method)
{
  ...
  v5 = BasicHelper__IndexValue_object__48686808(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5D99D & 1) == 0 )
  {
    sub_1B885B0(&Method_System_Linq_Enumerable_Select_GameObject__GameObject___);
    sub_1B885B0(&Method_System_Linq_Enumerable_ToList_GameObject___);
    sub_1B885B0(&System_Func_GameObject__GameObject__TypeInfo);
    this = (WrapBattleUIFrontPopupControl_o *)sub_1B885B0(&Method_WrapBattleUIFrontPopupControl_MakePrefab__);
    byte_4A5D99D = 1;
  }
  perf = v2->fields.perf;
  if ( !perf )
  ...
  v6 = (System_Func_object__object__o *)sub_1B887FC(System_Func_GameObject__GameObject__TypeInfo);
  System_Func_object__object____ctor(v6, (Il2CppObject *)v2, Method_WrapBattleUIFrontPopupControl_MakePrefab__, 0LL);
  v7 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                              ...
                                                              (const MethodInfo_2EB040C *)Method_System_Linq_Enumerable_Select_GameObject__GameObject___);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.effectList, (int32_t)v8, v9, v10);
  v11 = v2->fields.perf;
  if ( !v11 )
    goto LABEL_26;
  ...
  v14 = (System_Func_object__object__o *)sub_1B887FC(System_Func_GameObject__GameObject__TypeInfo);
  System_Func_object__object____ctor(v14, (Il2CppObject *)v2, Method_WrapBattleUIFrontPopupControl_MakePrefab__, 0LL);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.damageList, (int32_t)v16, v17, v18);
  v19 = v2->fields.perf;
  if ( !v19 )
    goto LABEL_26;
  ...
  v22 = (System_Func_object__object__o *)sub_1B887FC(System_Func_GameObject__GameObject__TypeInfo);
  System_Func_object__object____ctor(v22, (Il2CppObject *)v2, Method_WrapBattleUIFrontPopupControl_MakePrefab__, 0LL);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.buffTextList, (int32_t)v24, v25, v26);
  v27 = v2->fields.perf;
  if ( !v27 )
    goto LABEL_26;
  ...
  v30 = (System_Func_object__object__o *)sub_1B887FC(System_Func_GameObject__GameObject__TypeInfo);
  System_Func_object__object____ctor(v30, (Il2CppObject *)v2, Method_WrapBattleUIFrontPopupControl_MakePrefab__, 0LL);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.buffTextClassIconList, (int32_t)v32, v33, v34);
  v36 = v2->fields.perf;
  if ( !v36 )
    goto LABEL_26;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.avoidanceObj, (int32_t)PopupObject, v40, v41);
  v43 = v2->fields.perf;
  if ( !v43 )
    goto LABEL_26;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.avoidanceTextObj, (int32_t)v45, v47, v48);
  v50 = v2->fields.perf;
  if ( !v50 )
    goto LABEL_26;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.avoidResetDamageObj, (int32_t)v52, v54, v55);
  v57 = v2->fields.perf;
  if ( !v57 )
    goto LABEL_26;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.avoidResetDamageTextObj, (int32_t)v59, v61, v62);
  v64 = v2->fields.perf;
  if ( !v64 )
    goto LABEL_26;
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.invincibleObj, (int32_t)v66, v68, v69);
  v71 = v2->fields.perf;
  if ( !v71
    || (v72 = v71->fields.effectcontrol) == 0LL
    || (v73 = WrapBaseBattlePopupControl__CreatePopupObject(
        ...
        sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.spInvincibleObj, (int32_t)v73, v75, v76),
        (v78 = v2->fields.perf) == 0LL)
    || (v79 = v78->fields.effectcontrol) == 0LL )
  {
LABEL_26:
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v2->fields.buffIconObj, (int32_t)v80, v82, v83);
}
        ...
        const MethodInfo *method)
{
  ...
  return BattleEffectControl__SetBuffIconObject_42686636(effectcontrol, buffList, this->fields.buffIconObj, 0LL);
}