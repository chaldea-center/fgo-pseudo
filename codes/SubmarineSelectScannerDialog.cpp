...
void SubmarineSelectScannerDialog__OnClickCloseButton(SubmarineSelectScannerDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2909B & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_SubmarineSelectScannerDialog_OnClickCloseButton__);
    sub_1C94098(&Method_SubmarineSelectScannerDialog__OnClickCloseButton_b__10_0__);
    byte_4D2909B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SubmarineSelectScannerDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_SubmarineSelectScannerDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&Method_SubmarineSelectScannerDialog_OnSelectScanner__);
    sub_1C94098(&Method_SubmarineSelectScannerDialog___c__DisplayClass11_0__OnSelectScanner_b__0__);
    sub_1C94098(&SubmarineSelectScannerDialog___c__DisplayClass11_0_TypeInfo);
    byte_4D2909C = 1;
  }
  v7 = sub_1C942E4(SubmarineSelectScannerDialog___c__DisplayClass11_0_TypeInfo);
  ...
  if ( this->fields.state == 2 )
  {
    if ( isEnabled )
    {
      ...
      if ( (*((_BYTE *)Method_SubmarineSelectScannerDialog_OnSelectScanner__ + 83) & 2) != 0 )
        v16 = (_QWORD *)sub_1C940B0(Method_SubmarineSelectScannerDialog_OnSelectScanner__);
    ...
    else
    {
      ...
      if ( (*((_BYTE *)Method_SubmarineSelectScannerDialog_OnSelectScanner__ + 83) & 2) != 0 )
        v19 = (_QWORD *)sub_1C940B0(Method_SubmarineSelectScannerDialog_OnSelectScanner__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2909A & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_SubmarineSelectScannerDialog_OnSelectScanner__);
    sub_1C94098(&Method_SubmarineSelectScannerDialog___c__DisplayClass9_0__Open_b__0__);
    sub_1C94098(&SubmarineSelectScannerDialog___c__DisplayClass9_0_TypeInfo);
    sub_1C94098(&StringLiteral_5730/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_MESSAGE"*/);
    sub_1C94098(&StringLiteral_5732/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_TITLE"*/);
    byte_4D2909A = 1;
  }
  v9 = sub_1C942E4(SubmarineSelectScannerDialog___c__DisplayClass9_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v9, 0);
  if ( !v9 )
    goto LABEL_16;
  *(_QWORD *)(v9 + 16) = openFinishedAction;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)(v9 + 16), (int32_t)openFinishedAction, v12, v13, v14, v15, v16, v17);
  *(_QWORD *)(v9 + 24) = this;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5732/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_16;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  messageLabel = this->fields.messageLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5730/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_MESSAGE"*/, 0);
  if ( !messageLabel )
    goto LABEL_16;
  ...
  if ( UnityEngine_Object__op_Inequality(listViewManager, 0, 0) )
  {
    ...
    if ( gameObject )
    {
      ...
      v36 = (System_Action_int__bool__o *)sub_1C942E4(System_Action_int__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( closeAction )
    ActionExtensions__Call_int_(closeAction, 0, (const MethodInfo_30E5880 *)Method_ActionExtensions_Call_int___);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D290A0 & 1) == 0 )
  {
    this = (SubmarineSelectScannerDialog___c__DisplayClass11_0_o *)sub_1C94098(&Method_ActionExtensions_Call_int___);
    byte_4D290A0 = 1;
  }
