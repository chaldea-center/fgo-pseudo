        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BE76 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__, v12);
    sub_1B863B8(&Method_System_Collections_Generic_Dictionary_int__uint__get_Item__, v13);
    this = (ShortestDistanceFromAllyServant_o *)sub_1B863B8(&WarBoardAIManager_TypeInfo, v14);
    byte_4A4BE76 = 1;
  }
         ...
         (const MethodInfo_32794C4 *)Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__) )
  {
    Item = System_Collections_Generic_Dictionary_int__uint___get_Item(
             dicPiecePlaceData,
             targetSquare->fields._squareIndex_k__BackingField,
             (const MethodInfo_327923C *)Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
            ...
            if ( ratingBase )
              return fmaxf(
                     ...
                     + (float)(ratingBase->fields.adjustmentValueA1 - ratingBase->fields.adjustmentValueA2 * (v21 - 1)),
                       0.0);
LABEL_20:
            sub_1B86614(this, *(_QWORD *)&forceId);
          }
        }
      }
    }
