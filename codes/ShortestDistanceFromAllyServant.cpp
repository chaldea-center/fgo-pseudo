        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E74F24 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
    this = (ShortestDistanceFromAllyServant_o *)sub_1D0F0B4(&WarBoardAIManager_TypeInfo);
    byte_4E74F24 = 1;
  }
         ...
         (const MethodInfo_35B3F68 *)Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__) )
  {
    Item = System_Collections_Generic_Dictionary_int__uint___get_Item(
             dicPiecePlaceData,
             targetSquare->fields._squareIndex_k__BackingField,
             (const MethodInfo_35B3CE0 *)Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
