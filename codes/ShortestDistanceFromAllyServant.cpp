        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E022B1 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
    this = (ShortestDistanceFromAllyServant_o *)sub_1CE6700(&WarBoardAIManager_TypeInfo);
    byte_4E022B1 = 1;
  }
         ...
         (const MethodInfo_3567314 *)Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__) )
  {
    Item = System_Collections_Generic_Dictionary_int__uint___get_Item(
             dicPiecePlaceData,
             targetSquare->fields._squareIndex_k__BackingField,
             (const MethodInfo_356708C *)Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
