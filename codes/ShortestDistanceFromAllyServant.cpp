        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC100 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__, v12);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__uint__get_Item__, v13);
    this = (ShortestDistanceFromAllyServant_o *)sub_1B64870(&WarBoardAIManager_TypeInfo, v14);
    byte_49FC100 = 1;
  }
         ...
         (const MethodInfo_3131AB0 *)Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__) )
  {
    Item = System_Collections_Generic_Dictionary_int__uint___get_Item(
             dicPiecePlaceData,
             targetSquare->fields._squareIndex_k__BackingField,
             (const MethodInfo_3131828 *)Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
            ...
            if ( ratingBase )
              return fmaxf(
                     ...
                     + (float)(ratingBase->fields.adjustmentValueA1
                       ...
                       0.0);
LABEL_20:
            sub_1B64ACC(this, *(_QWORD *)&forceId);
          }
        }
      }
    }
