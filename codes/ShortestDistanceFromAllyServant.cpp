        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F91B5 & 1) == 0 )
  {
    ...
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__, v12);
    sub_B16FFC(&Method_System_Collections_Generic_Dictionary_int__uint__get_Item__, v13);
         ...
         (const MethodInfo_2DF0E28 *)Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__) )
  {
    Item = System_Collections_Generic_Dictionary_int__uint___get_Item(
             dicPiecePlaceData,
             targetSquare->fields._squareIndex_k__BackingField,
             (const MethodInfo_2DF0B04 *)Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
    ...
    {
      v17 = PieceUnique;
      if ( PieceUnique->fields._forceId_k__BackingField == forceId && !WarBoardPieceData__get_isMaster(PieceUnique, 0LL) )
      {
        if ( !calcSquare )
          goto LABEL_24;
