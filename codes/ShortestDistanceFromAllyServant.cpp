        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC54EA & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__, v12);
    sub_1C1ABD4(&Method_System_Collections_Generic_Dictionary_int__uint__get_Item__, v13);
    this = (ShortestDistanceFromAllyServant_o *)sub_1C1ABD4(&WarBoardAIManager_TypeInfo, v14);
    byte_4BC54EA = 1;
  }
         ...
         (const MethodInfo_32C400C *)Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__) )
  {
    Item = System_Collections_Generic_Dictionary_int__uint___get_Item(
             dicPiecePlaceData,
             targetSquare->fields._squareIndex_k__BackingField,
             (const MethodInfo_32C3D84 *)Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
            ...
            if ( ratingBase )
              return fmaxf(
                     ...
                     + (float)(ratingBase->fields.adjustmentValueA1 - ratingBase->fields.adjustmentValueA2 * (v21 - 1)),
                       0.0);
LABEL_20:
            sub_1C1AE30(this, *(_QWORD *)&forceId);
          }
        }
      }
    }
