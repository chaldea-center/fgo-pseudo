        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB212C & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__, v12);
    sub_1C13D24(&Method_System_Collections_Generic_Dictionary_int__uint__get_Item__, v13);
    this = (ShortestDistanceFromAllyServant_o *)sub_1C13D24(&WarBoardAIManager_TypeInfo, v14);
    byte_4BB212C = 1;
  }
         ...
         (const MethodInfo_32B3CCC *)Method_System_Collections_Generic_Dictionary_int__uint__ContainsKey__) )
  {
    Item = System_Collections_Generic_Dictionary_int__uint___get_Item(
             dicPiecePlaceData,
             targetSquare->fields._squareIndex_k__BackingField,
             (const MethodInfo_32B3A44 *)Method_System_Collections_Generic_Dictionary_int__uint__get_Item__);
            ...
            if ( ratingBase )
              return fmaxf(
                     ...
                     + (float)(ratingBase->fields.adjustmentValueA1 - ratingBase->fields.adjustmentValueA2 * (v21 - 1)),
                       0.0);
LABEL_20:
            sub_1C13F80(this, *(_QWORD *)&forceId);
          }
        }
      }
    }
