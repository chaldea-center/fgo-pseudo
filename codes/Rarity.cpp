void Rarity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C368D9 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Field__PrivateImplementationDetails__E21A6F698E635086E28EBB14EDC7838F22DB359A0D1A989690BA55DDA2096301);
    sub_1C32C20(&StringLiteral_17989/*"class_b_"*/);
    sub_1C32C20(&StringLiteral_10964/*"RARITY_TYPE_SSRARE"*/);
    sub_1C32C20(&StringLiteral_10963/*"RARITY_TYPE_SRARE"*/);
    sub_1C32C20(&StringLiteral_10961/*"RARITY_TYPE_NONE"*/);
    sub_1C32C20(&StringLiteral_10962/*"RARITY_TYPE_RARE"*/);
    sub_1C32C20(&StringLiteral_10960/*"RARITY_TYPE_COMMON"*/);
    sub_1C32C20(&StringLiteral_10965/*"RARITY_TYPE_UNCOMMON"*/);
    sub_1C32C20(&StringLiteral_17993/*"class_g_"*/);
    sub_1C32C20(&StringLiteral_17994/*"class_n_"*/);
    sub_1C32C20(&StringLiteral_17995/*"class_s_"*/);
    byte_4C368D9 = 1;
  }
  v1 = (System_Array_o *)sub_1C32CC8(int___TypeInfo, 6);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)Rarity_TypeInfo->static_fields, (int32_t)v3, v4, v5);
  v6 = sub_1C32CC8(string___TypeInfo, 6);
  if ( !v6 )
    goto LABEL_19;
  v9 = v6;
  if ( !*(_DWORD *)(v6 + 24) )
    goto LABEL_18;
  v10 = StringLiteral_17994/*"class_n_"*/;
  *(_QWORD *)(v6 + 32) = StringLiteral_17994/*"class_n_"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v6 + 32), v10, v7, v8);
  if ( *(_DWORD *)(v9 + 24) <= 1u )
    goto LABEL_18;
  v13 = StringLiteral_17989/*"class_b_"*/;
  *(_QWORD *)(v9 + 40) = StringLiteral_17989/*"class_b_"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v9 + 40), v13, v11, v12);
  if ( *(_DWORD *)(v9 + 24) <= 2u )
    goto LABEL_18;
  v16 = StringLiteral_17989/*"class_b_"*/;
  *(_QWORD *)(v9 + 48) = StringLiteral_17989/*"class_b_"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v9 + 48), v16, v14, v15);
  if ( *(_DWORD *)(v9 + 24) <= 3u
    || (v19 = StringLiteral_17995/*"class_s_"*/,
        *(_QWORD *)(v9 + 56) = StringLiteral_17995/*"class_s_"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v9 + 56), v19, v17, v18),
        *(_DWORD *)(v9 + 24) <= 4u)
    || (v22 = StringLiteral_17993/*"class_g_"*/,
        *(_QWORD *)(v9 + 64) = StringLiteral_17993/*"class_g_"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v9 + 64), v22, v20, v21),
        *(_DWORD *)(v9 + 24) <= 5u) )
  {
LABEL_18:
    sub_1C32E84(v6);
  }
  v25 = StringLiteral_17993/*"class_g_"*/;
  *(_QWORD *)(v9 + 72) = StringLiteral_17993/*"class_g_"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v9 + 72), v25, v23, v24);
  static_fields = Rarity_TypeInfo->static_fields;
  static_fields->designCardFileList = (struct System_String_array *)v9;
  sub_1C32BC4((CGThumbnailListItem_o *)&static_fields->designCardFileList, v9, v27, v28);
  v6 = sub_1C32CC8(string___TypeInfo, 6);
  if ( !v6 )
LABEL_19:
    sub_1C32E7C(v6);
  ...
  if ( !*(_DWORD *)(v6 + 24) )
    goto LABEL_18;
  v32 = StringLiteral_10961/*"RARITY_TYPE_NONE"*/;
  *(_QWORD *)(v6 + 32) = StringLiteral_10961/*"RARITY_TYPE_NONE"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v6 + 32), v32, v29, v30);
  if ( *(_DWORD *)(v31 + 24) <= 1u )
    goto LABEL_18;
  v35 = StringLiteral_10960/*"RARITY_TYPE_COMMON"*/;
  *(_QWORD *)(v31 + 40) = StringLiteral_10960/*"RARITY_TYPE_COMMON"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v31 + 40), v35, v33, v34);
  if ( *(_DWORD *)(v31 + 24) <= 2u )
    goto LABEL_18;
  v38 = StringLiteral_10965/*"RARITY_TYPE_UNCOMMON"*/;
  *(_QWORD *)(v31 + 48) = StringLiteral_10965/*"RARITY_TYPE_UNCOMMON"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v31 + 48), v38, v36, v37);
  if ( *(_DWORD *)(v31 + 24) <= 3u )
    goto LABEL_18;
  v41 = StringLiteral_10962/*"RARITY_TYPE_RARE"*/;
  *(_QWORD *)(v31 + 56) = StringLiteral_10962/*"RARITY_TYPE_RARE"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v31 + 56), v41, v39, v40);
  if ( *(_DWORD *)(v31 + 24) <= 4u )
    goto LABEL_18;
  v44 = StringLiteral_10963/*"RARITY_TYPE_SRARE"*/;
  *(_QWORD *)(v31 + 64) = StringLiteral_10963/*"RARITY_TYPE_SRARE"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v31 + 64), v44, v42, v43);
  if ( *(_DWORD *)(v31 + 24) <= 5u )
    goto LABEL_18;
  v47 = StringLiteral_10964/*"RARITY_TYPE_SSRARE"*/;
  *(_QWORD *)(v31 + 72) = StringLiteral_10964/*"RARITY_TYPE_SSRARE"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v31 + 72), v47, v45, v46);
  v48 = Rarity_TypeInfo->static_fields;
  v48->rarityType = (struct System_String_array *)v31;
  sub_1C32BC4((CGThumbnailListItem_o *)&v48->rarityType, v31, v49, v50);
}
...
System_String_o *Rarity__getIcon_40343796(
        int32_t rarity,
        int32_t exceedCount,
        int32_t lv,
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    RarityIcon = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_ServantLvDetailMaster___);
    if ( !Master_object
...
int32_t Rarity__getUpperColorRarity(int32_t rarityId, const MethodInfo *method)
{
  if ( (unsigned int)(rarityId - 1) > 4 )
    ...
    return dword_C46854[rarityId - 1];
}
...
void Rarity__setRarityIcon(
        ...
        const MethodInfo *method)
{
  System_String_o *Icon_40343796; // x22
  ...
  if ( !Rarity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(Rarity_TypeInfo);
  Icon_40343796 = Rarity__getIcon_40343796(rarity, exceedCount, lv, actualRarity, *(const MethodInfo **)&actualRarity);
  if ( exceedCount < 1 )
  {
    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  ...
  else
  {
    ...
    if ( !Master_object
      || (RarityIcon = ServantExceedMaster__GetRarityIcon(
                         ...
                         0,
                         0),
          (Master_object = DataManager__GetMaster_object_((const MethodInfo_30DD39C *)Method_DataManager_GetMaster_ServantLvDetailMaster___)) == 0) )
    {
LABEL_19:
    ...
    if ( v14 >= 3 )
    {
      Master_object = (Il2CppObject *)AtlasManager__SetEventSprite(sprite, Icon_40343796, 0);
      goto LABEL_17;
    }
  }
...
LABEL_17:
  if ( !sprite )
    goto LABEL_19;
  UISprite__set_spriteName(sprite, Icon_40343796, 0);
