        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FB864 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_21083/*"num"*/, *(_QWORD *)&treasureBoxId);
    sub_B16FFC(&StringLiteral_22689/*"treasureBoxId"*/, v7);
    byte_40FB864 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22689/*"treasureBoxId"*/, treasureBoxId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21083/*"num"*/, drawNum, 0LL);
...
System_String_o *__fastcall TreasureBoxDrawRequest__getURL(TreasureBoxDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FB863 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_22688/*"treasureBox/draw"*/, v2);
    byte_40FB863 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_22688/*"treasureBox/draw"*/, 0LL);
}
