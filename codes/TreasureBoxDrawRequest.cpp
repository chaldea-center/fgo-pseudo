        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17BBB & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_22418/*"num"*/, *(_QWORD *)&treasureBoxId, *(_QWORD *)&drawNum);
    sub_1BCA7E0(&StringLiteral_24306/*"treasureBoxId"*/, v7, v8);
    byte_4B17BBB = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24306/*"treasureBoxId"*/, treasureBoxId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22418/*"num"*/, drawNum, 0LL);
...
System_String_o *__fastcall TreasureBoxDrawRequest__getURL(TreasureBoxDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17BBA & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_24305/*"treasureBox/draw"*/, v3, v4);
    byte_4B17BBA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_24305/*"treasureBox/draw"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(109, responseList, 0LL);
  if ( v9
