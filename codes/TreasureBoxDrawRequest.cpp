        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EAC9B & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_21449/*"num"*/, treasureBoxId, drawNum, method);
    sub_B5D5C4(&StringLiteral_23087/*"treasureBoxId"*/, v7, v8, v9);
    byte_42EAC9B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23087/*"treasureBoxId"*/, treasureBoxId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21449/*"num"*/, drawNum, 0LL);
...
System_String_o *__fastcall TreasureBoxDrawRequest__getURL(TreasureBoxDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EAC9A & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_23086/*"treasureBox/draw"*/, v4, v5, v6);
    byte_42EAC9A = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_23086/*"treasureBox/draw"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(109, responseList, 0LL);
  if ( v12
