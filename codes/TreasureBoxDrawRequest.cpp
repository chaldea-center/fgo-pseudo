        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4FFDB & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_22017/*"num"*/, *(_QWORD *)&treasureBoxId);
    sub_1B863B8(&StringLiteral_23893/*"treasureBoxId"*/, v7);
    byte_4A4FFDB = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23893/*"treasureBoxId"*/, treasureBoxId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22017/*"num"*/, drawNum, v8);
...
System_String_o *__fastcall TreasureBoxDrawRequest__getURL(TreasureBoxDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4FFDA & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_23892/*"treasureBox/draw"*/, v2);
    byte_4A4FFDA = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61645176(BaseUrl, (System_String_o *)StringLiteral_23892/*"treasureBox/draw"*/, 0LL);
}
