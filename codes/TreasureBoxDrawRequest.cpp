        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0048A & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_22093/*"num"*/, *(_QWORD *)&treasureBoxId);
    sub_1B64A00(&StringLiteral_23959/*"treasureBoxId"*/, v7);
    byte_4A0048A = 1;
  }
...
System_String_o *__fastcall TreasureBoxDrawRequest__getURL(TreasureBoxDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00489 & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_23958/*"treasureBox/draw"*/, v2);
    byte_4A00489 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_23958/*"treasureBox/draw"*/, 0LL);
}
