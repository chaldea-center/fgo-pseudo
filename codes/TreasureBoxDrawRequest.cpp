        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418999C & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_21171/*"num"*/, *(_QWORD *)&treasureBoxId);
    sub_B2C35C(&StringLiteral_22782/*"treasureBoxId"*/, v7);
    byte_418999C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22782/*"treasureBoxId"*/, treasureBoxId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21171/*"num"*/, drawNum, 0LL);
...
System_String_o *__fastcall TreasureBoxDrawRequest__getURL(TreasureBoxDrawRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_418999B & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_22781/*"treasureBox/draw"*/, v2);
    byte_418999B = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_22781/*"treasureBox/draw"*/, 0LL);
}
