...
void __fastcall UserServantCoinMenu__Close(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinMenu__Close_32668736(this, 0LL, v2);
}


void __fastcall UserServantCoinMenu__Close_32668736(
...
void __fastcall UserServantCoinMenu__EndCloseShowServantCoin(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7ECD & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_UserServantCoinMenu_OnSelectServantCoin__);
    byte_4BD7ECD = 1;
  }
  ...
  if ( !userServantCoinListViewManager
    || (UserServantCoinListViewManager__RequestListObject(userServantCoinListViewManager, 4, 0.0, v2),
        ...
        v6 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1C22084(UserServantCoinListViewManager_CallbackFunc_TypeInfo),
        ...
        !v5) )
  {
    sub_1C22094(userServantCoinListViewManager, method);
  }
  v5->fields.callbackFunc = v6;
  sub_1C21DDC(&v5->fields.callbackFunc, v6);
  UserServantCoinListViewManager__SetMode_32674236(v5, 2, v8);
}
...
void __fastcall UserServantCoinMenu__EndOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  this->fields.state = 2;
  userServantCoinListViewManager = this->fields.userServantCoinListViewManager;
  v4 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1C22084(UserServantCoinListViewManager_CallbackFunc_TypeInfo);
  UserServantCoinListViewManager_CallbackFunc___ctor(
    v4,
    (Il2CppObject *)this,
    Method_UserServantCoinMenu_OnSelectServantCoin__,
  ...
  sub_1C21DDC(&userServantCoinListViewManager->fields.callbackFunc, v4);
  UserServantCoinListViewManager__SetMode_32674236(userServantCoinListViewManager, 2, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD7ECC & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_UserServantCoinMenu_EndCloseShowServantCoin__);
    sub_1C21E38(&Method_UserServantCoinMenu_EndShowServantCoin__);
    byte_4BD7ECC = 1;
  }
  v4 = Method_UserServantCoinMenu_EndShowServantCoin__;
  if ( (*((_BYTE *)Method_UserServantCoinMenu_EndShowServantCoin__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1C21E50(Method_UserServantCoinMenu_EndShowServantCoin__);
...
void __fastcall UserServantCoinMenu__OnClickScaleChange(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7ED0 & 1) == 0 )
  {
    sub_1C21E38(&Method_UserServantCoinMenu_OnClickScaleChange__);
    byte_4BD7ED0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_UserServantCoinMenu_OnClickScaleChange__);
  ...
  if ( kind == 1 && this->fields.state == 2 )
  {
           ...
           (const MethodInfo_325BE14 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( CommonUI__get_IsEnableItemLinkInfoWindow((CommonUI_o *)Instance, 0LL) )
      {
        ...
        v11 = (ItemLinkInfoWindowComponent_CallbackFunc_o *)sub_1C22084(ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo);
        ...
        if ( v10 )
        {
          CommonUI__OpenItemLinkInfoDetailWindow_31232736((CommonUI_o *)v10, UserItemData, v11, 0LL);
          return;
        }
LABEL_16:
...
void __fastcall UserServantCoinMenu__OnStartClose(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_UserServantCoinMenu_EndClose__);
    byte_4BD7ECF = 1;
  }
...
void __fastcall UserServantCoinMenu__OnStartOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_UserServantCoinMenu_EndOpen__);
    byte_4BD7EC9 = 1;
  }
  v3 = (System_Action_o *)sub_1C22084(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1C21DDC(&this->fields.mOpenedAct, openedAct);
    ...
    UserServantCoinListViewManager__SetMode_32674236((UserServantCoinListViewManager_o *)gameObject, 1, v9);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (UserServantCoinMenu_o *)sub_1C22354(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5CB08;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5CAC8;
}
