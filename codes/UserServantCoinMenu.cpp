...
void __fastcall UserServantCoinMenu__Close(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinMenu__Close_32991964(this, 0LL, v2);
}


void __fastcall UserServantCoinMenu__Close_32991964(
...
void __fastcall UserServantCoinMenu__EndCloseShowServantCoin(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD7DC & 1) == 0 )
  {
    sub_1BC3008(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BC3008(&Method_UserServantCoinMenu_OnSelectServantCoin__, v4);
    byte_4AFD7DC = 1;
  }
  ...
  if ( !userServantCoinListViewManager
    || (UserServantCoinListViewManager__RequestListObject(userServantCoinListViewManager, 4, 0.0, v2),
        ...
        v7 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1BC3254(UserServantCoinListViewManager_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1BC3264(userServantCoinListViewManager, method);
  }
  v6->fields.callbackFunc = v7;
  sub_1BC2FAC((CGThumbnailListItem_o *)&v6->fields.callbackFunc, (int32_t)v7, v9, v10);
  UserServantCoinListViewManager__SetMode_32997624(v6, 2, v11);
}
...
void __fastcall UserServantCoinMenu__EndOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BC3008(&Method_UserServantCoinMenu_OnSelectServantCoin__, v3);
    byte_4AFD7D9 = 1;
  }
  this->fields.state = 2;
  userServantCoinListViewManager = this->fields.userServantCoinListViewManager;
  v5 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1BC3254(UserServantCoinListViewManager_CallbackFunc_TypeInfo);
  UserServantCoinListViewManager_CallbackFunc___ctor(
    v5,
    (Il2CppObject *)this,
    Method_UserServantCoinMenu_OnSelectServantCoin__,
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&userServantCoinListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
  UserServantCoinListViewManager__SetMode_32997624(userServantCoinListViewManager, 2, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD7DB & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UserServantCoinMenu_EndCloseShowServantCoin__, v5);
    sub_1BC3008(&Method_UserServantCoinMenu_EndShowServantCoin__, v6);
    byte_4AFD7DB = 1;
  }
  v7 = Method_UserServantCoinMenu_EndShowServantCoin__;
  if ( (*((_BYTE *)Method_UserServantCoinMenu_EndShowServantCoin__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BC3020(Method_UserServantCoinMenu_EndShowServantCoin__);
...
void __fastcall UserServantCoinMenu__OnClickScaleChange(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD7DF & 1) == 0 )
  {
    sub_1BC3008(&Method_UserServantCoinMenu_OnClickScaleChange__, method);
    byte_4AFD7DF = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_UserServantCoinMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD7DA & 1) == 0 )
  {
    sub_1BC3008(&ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1BC3008(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, v7);
    ...
    sub_1BC3008(&Method_UserServantCoinMenu_EndShowServantCoin__, v12);
    byte_4AFD7DA = 1;
  }
  entity = 0LL;
  if ( kind == 1 && this->fields.state == 2 )
  {
           ...
           (const MethodInfo_32AF0BC *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( CommonUI__get_IsEnableItemLinkInfoWindow((CommonUI_o *)Instance, 0LL) )
      {
        ...
        v17 = (ItemLinkInfoWindowComponent_CallbackFunc_o *)sub_1BC3254(ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo);
        ...
        if ( v16 )
        {
          CommonUI__OpenItemLinkInfoDetailWindow_30837068((CommonUI_o *)v16, UserItemData, v17, 0LL);
          return;
        }
LABEL_16:
      ...
      itemDetailInfoComp = this->fields.itemDetailInfoComp;
      v19 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1BC3254(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
...
void __fastcall UserServantCoinMenu__OnStartClose(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFD7DE & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UserServantCoinMenu_EndClose__, v3);
    byte_4AFD7DE = 1;
  }
...
void __fastcall UserServantCoinMenu__OnStartOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&System_Action_TypeInfo, method);
    sub_1BC3008(&Method_UserServantCoinMenu_EndOpen__, v3);
    byte_4AFD7D8 = 1;
  }
  v4 = (System_Action_o *)sub_1BC3254(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.mOpenedAct, (int32_t)openedAct, (int32_t)callback, method);
    this->fields.callbackFunc = callback;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, v6, v7);
    this->fields.state = 1;
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !gameObject
    ...
    UserServantCoinListViewManager__SetMode_32997624((UserServantCoinListViewManager_o *)gameObject, 1, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFD7D6 & 1) == 0 )
  {
    sub_1BC3008(&UserServantCoinMenu_CallbackFunc_TypeInfo, value);
    byte_4AFD7D6 = 1;
  }
  ...
  v11 = (UserServantCoinMenu_o *)sub_1BC3524(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0701C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A06FDC;
}
