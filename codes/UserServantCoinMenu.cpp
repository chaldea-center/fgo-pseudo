...
void __fastcall UserServantCoinMenu__Close(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinMenu__Close_31989356(this, 0LL, v2);
}


void __fastcall UserServantCoinMenu__Close_31989356(
...
void __fastcall UserServantCoinMenu__EndCloseShowServantCoin(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB184C & 1) == 0 )
  {
    sub_1BAB41C(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BAB41C(&Method_UserServantCoinMenu_OnSelectServantCoin__, v4);
    byte_4AB184C = 1;
  }
  ...
  if ( !userServantCoinListViewManager
    || (UserServantCoinListViewManager__RequestListObject(userServantCoinListViewManager, 4, 0.0, v2),
        ...
        v7 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1BAB668(UserServantCoinListViewManager_CallbackFunc_TypeInfo),
...
void __fastcall UserServantCoinMenu__EndOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BAB41C(&Method_UserServantCoinMenu_OnSelectServantCoin__, v3);
    byte_4AB1849 = 1;
  }
  this->fields.state = 2;
  userServantCoinListViewManager = this->fields.userServantCoinListViewManager;
  v5 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1BAB668(UserServantCoinListViewManager_CallbackFunc_TypeInfo);
  UserServantCoinListViewManager_CallbackFunc___ctor(
    v5,
    (Il2CppObject *)this,
    Method_UserServantCoinMenu_OnSelectServantCoin__,
  ...
  sub_1BAB3C0(
    ...
    v9,
    v10);
  UserServantCoinListViewManager__SetMode_31994872(userServantCoinListViewManager, 2, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB184B & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_UserServantCoinMenu_EndCloseShowServantCoin__, v5);
    sub_1BAB41C(&Method_UserServantCoinMenu_EndShowServantCoin__, v6);
    byte_4AB184B = 1;
  }
  v7 = Method_UserServantCoinMenu_EndShowServantCoin__;
  if ( (*((_BYTE *)Method_UserServantCoinMenu_EndShowServantCoin__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BAB434(Method_UserServantCoinMenu_EndShowServantCoin__);
...
LABEL_13:
  ...
  if ( !itemDetailInfoComp )
    goto LABEL_13;
  ItemDetailInfoComponent__Close_31406760(itemDetailInfoComp, v14, 0LL);
}
...
void __fastcall UserServantCoinMenu__OnClickScaleChange(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB184F & 1) == 0 )
  {
    sub_1BAB41C(&Method_UserServantCoinMenu_OnClickScaleChange__, method);
    byte_4AB184F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_UserServantCoinMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB184A & 1) == 0 )
  {
    sub_1BAB41C(&ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1BAB41C(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, v7);
    ...
    sub_1BAB41C(&Method_UserServantCoinMenu_EndShowServantCoin__, v12);
    byte_4AB184A = 1;
  }
  entity = 0LL;
  if ( kind == 1 && this->fields.state == 2 )
  {
           ...
           (const MethodInfo_3163DE4 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( CommonUI__get_IsEnableItemLinkInfoWindow((CommonUI_o *)Instance, 0LL) )
      {
        ...
        if ( v16 )
        {
          CommonUI__OpenItemLinkInfoDetailWindow_30727808((CommonUI_o *)v16, UserItemData, v17, 0LL);
          return;
        }
LABEL_16:
      ...
      itemDetailInfoComp = this->fields.itemDetailInfoComp;
      v19 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1BAB668(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
...
void __fastcall UserServantCoinMenu__OnStartClose(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB184E & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_UserServantCoinMenu_EndClose__, v3);
    byte_4AB184E = 1;
  }
...
void __fastcall UserServantCoinMenu__OnStartOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&System_Action_TypeInfo, method);
    sub_1BAB41C(&Method_UserServantCoinMenu_EndOpen__, v3);
    byte_4AB1848 = 1;
  }
  v4 = (System_Action_o *)sub_1BAB668(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callback, v6, v7);
    this->fields.state = 1;
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !gameObject
    ...
    UserServantCoinListViewManager__SetMode_31994872((UserServantCoinListViewManager_o *)gameObject, 1, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB1846 & 1) == 0 )
  {
    sub_1BAB41C(&UserServantCoinMenu_CallbackFunc_TypeInfo, value);
    byte_4AB1846 = 1;
  }
  ...
  v11 = (UserServantCoinMenu_o *)sub_1BAB938(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19E8898;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19E8858;
}
