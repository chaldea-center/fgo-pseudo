...
void __fastcall UserServantCoinMenu__Close(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinMenu__Close_31393792(this, 0LL, v2);
}


void __fastcall UserServantCoinMenu__Close_31393792(
...
void __fastcall UserServantCoinMenu__EndCloseShowServantCoin(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B5D1 & 1) == 0 )
  {
    sub_1B715CC(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B715CC(&Method_UserServantCoinMenu_OnSelectServantCoin__, v4);
    byte_4A1B5D1 = 1;
  }
  ...
  if ( !userServantCoinListViewManager
    || (UserServantCoinListViewManager__RequestListObject(userServantCoinListViewManager, 4, 0.0, v2),
        ...
        v7 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1B71818(UserServantCoinListViewManager_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1B71828(userServantCoinListViewManager, method);
  }
  v6->fields.callbackFunc = v7;
  sub_1B71570(&v6->fields.callbackFunc);
  UserServantCoinListViewManager__SetMode_31399308(v6, 2, v9);
}
...
void __fastcall UserServantCoinMenu__EndOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B715CC(&Method_UserServantCoinMenu_OnSelectServantCoin__, v3);
    byte_4A1B5CE = 1;
  }
  this->fields.state = 2;
  userServantCoinListViewManager = this->fields.userServantCoinListViewManager;
  v5 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1B71818(UserServantCoinListViewManager_CallbackFunc_TypeInfo);
  UserServantCoinListViewManager_CallbackFunc___ctor(
    v5,
    (Il2CppObject *)this,
    Method_UserServantCoinMenu_OnSelectServantCoin__,
  ...
  sub_1B71570(&userServantCoinListViewManager->fields.callbackFunc);
  UserServantCoinListViewManager__SetMode_31399308(userServantCoinListViewManager, 2, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B5D0 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_UserServantCoinMenu_EndCloseShowServantCoin__, v5);
    sub_1B715CC(&Method_UserServantCoinMenu_EndShowServantCoin__, v6);
    byte_4A1B5D0 = 1;
  }
  v7 = Method_UserServantCoinMenu_EndShowServantCoin__;
  if ( (*((_BYTE *)Method_UserServantCoinMenu_EndShowServantCoin__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B715E4(Method_UserServantCoinMenu_EndShowServantCoin__);
...
LABEL_13:
  ...
  if ( !itemDetailInfoComp )
    goto LABEL_13;
  ItemDetailInfoComponent__Close_30906012(itemDetailInfoComp, v14, 0LL);
}
...
void __fastcall UserServantCoinMenu__OnClickScaleChange(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B5D4 & 1) == 0 )
  {
    sub_1B715CC(&Method_UserServantCoinMenu_OnClickScaleChange__, method);
    byte_4A1B5D4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B715E4(Method_UserServantCoinMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B5CF & 1) == 0 )
  {
    sub_1B715CC(&ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1B715CC(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, v7);
    ...
    sub_1B715CC(&Method_UserServantCoinMenu_EndShowServantCoin__, v12);
    byte_4A1B5CF = 1;
  }
  entity = 0LL;
  if ( kind == 1 && this->fields.state == 2 )
  {
           ...
           (const MethodInfo_30F87B4 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( CommonUI__get_IsEnableItemLinkInfoWindow((CommonUI_o *)Instance, 0LL) )
      {
        ...
        v17 = (ItemLinkInfoWindowComponent_CallbackFunc_o *)sub_1B71818(ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo);
        ...
        if ( v16 )
        {
          CommonUI__OpenItemLinkInfoDetailWindow_30491556((CommonUI_o *)v16, UserItemData, v17, 0LL);
          return;
        }
LABEL_16:
      ...
      itemDetailInfoComp = this->fields.itemDetailInfoComp;
      v19 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1B71818(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
...
void __fastcall UserServantCoinMenu__OnStartClose(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B5D3 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_UserServantCoinMenu_EndClose__, v3);
    byte_4A1B5D3 = 1;
  }
...
void __fastcall UserServantCoinMenu__OnStartOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&System_Action_TypeInfo, method);
    sub_1B715CC(&Method_UserServantCoinMenu_EndOpen__, v3);
    byte_4A1B5CD = 1;
  }
  v4 = (System_Action_o *)sub_1B71818(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    UserServantCoinListViewManager__SetMode_31399308((UserServantCoinListViewManager_o *)gameObject, 1, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1B5CB & 1) == 0 )
  {
    sub_1B715CC(&UserServantCoinMenu_CallbackFunc_TypeInfo, value);
    byte_4A1B5CB = 1;
  }
  ...
  v11 = (UserServantCoinMenu_o *)sub_1B71AE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B2AC4;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B2A84;
}
