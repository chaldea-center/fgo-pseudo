...
void __fastcall UserServantCoinMenu__Close(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinMenu__Close_32236040(this, 0LL, v2);
}


void __fastcall UserServantCoinMenu__Close_32236040(
...
void __fastcall UserServantCoinMenu__EndCloseShowServantCoin(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49CDB & 1) == 0 )
  {
    sub_1B863B8(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B863B8(&Method_UserServantCoinMenu_OnSelectServantCoin__, v4);
    byte_4A49CDB = 1;
  }
  ...
  if ( !userServantCoinListViewManager
    || (UserServantCoinListViewManager__RequestListObject(userServantCoinListViewManager, 4, 0.0, v2),
        ...
        v7 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1B86604(UserServantCoinListViewManager_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1B86614(userServantCoinListViewManager, method);
  }
  v6->fields.callbackFunc = v7;
  sub_1B8635C((CGThumbnailListItem_o *)&v6->fields.callbackFunc, (int32_t)v7, v9, v10);
  UserServantCoinListViewManager__SetMode_32241700(v6, 2, v11);
}
...
void __fastcall UserServantCoinMenu__EndOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1B863B8(&Method_UserServantCoinMenu_OnSelectServantCoin__, v3);
    byte_4A49CD8 = 1;
  }
  this->fields.state = 2;
  userServantCoinListViewManager = this->fields.userServantCoinListViewManager;
  v5 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1B86604(UserServantCoinListViewManager_CallbackFunc_TypeInfo);
  UserServantCoinListViewManager_CallbackFunc___ctor(
    v5,
    (Il2CppObject *)this,
    Method_UserServantCoinMenu_OnSelectServantCoin__,
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&userServantCoinListViewManager->fields.callbackFunc, (int32_t)v5, v9, v10);
  UserServantCoinListViewManager__SetMode_32241700(userServantCoinListViewManager, 2, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49CDA & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_UserServantCoinMenu_EndCloseShowServantCoin__, v5);
    sub_1B863B8(&Method_UserServantCoinMenu_EndShowServantCoin__, v6);
    byte_4A49CDA = 1;
  }
  v7 = Method_UserServantCoinMenu_EndShowServantCoin__;
  if ( (*((_BYTE *)Method_UserServantCoinMenu_EndShowServantCoin__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1B863D0(Method_UserServantCoinMenu_EndShowServantCoin__);
...
LABEL_13:
  ...
  if ( !itemDetailInfoComp )
    goto LABEL_13;
  ItemDetailInfoComponent__Close_31562560(itemDetailInfoComp, v14, 0LL);
}
...
void __fastcall UserServantCoinMenu__OnClickScaleChange(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49CDE & 1) == 0 )
  {
    sub_1B863B8(&Method_UserServantCoinMenu_OnClickScaleChange__, method);
    byte_4A49CDE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_UserServantCoinMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49CD9 & 1) == 0 )
  {
    sub_1B863B8(&ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1B863B8(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, v7);
    ...
    sub_1B863B8(&Method_UserServantCoinMenu_EndShowServantCoin__, v12);
    byte_4A49CD9 = 1;
  }
  entity = 0LL;
  if ( kind == 1 && this->fields.state == 2 )
  {
           ...
           (const MethodInfo_32142CC *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( CommonUI__get_IsEnableItemLinkInfoWindow((CommonUI_o *)Instance, 0LL) )
      {
        ...
        v17 = (ItemLinkInfoWindowComponent_CallbackFunc_o *)sub_1B86604(ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo);
        ...
        if ( v16 )
        {
          CommonUI__OpenItemLinkInfoDetailWindow_30588648((CommonUI_o *)v16, UserItemData, v17, 0LL);
          return;
        }
LABEL_16:
      ...
      itemDetailInfoComp = this->fields.itemDetailInfoComp;
      v19 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1B86604(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
...
void __fastcall UserServantCoinMenu__OnStartClose(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A49CDD & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_UserServantCoinMenu_EndClose__, v3);
    byte_4A49CDD = 1;
  }
...
void __fastcall UserServantCoinMenu__OnStartOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&System_Action_TypeInfo, method);
    sub_1B863B8(&Method_UserServantCoinMenu_EndOpen__, v3);
    byte_4A49CD7 = 1;
  }
  v4 = (System_Action_o *)sub_1B86604(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.mOpenedAct, (int32_t)openedAct, (int32_t)callback, method);
    this->fields.callbackFunc = callback;
    sub_1B8635C((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callback, v6, v7);
    this->fields.state = 1;
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !gameObject
    ...
    UserServantCoinListViewManager__SetMode_32241700((UserServantCoinListViewManager_o *)gameObject, 1, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49CD5 & 1) == 0 )
  {
    sub_1B863B8(&UserServantCoinMenu_CallbackFunc_TypeInfo, value);
    byte_4A49CD5 = 1;
  }
  ...
  v11 = (UserServantCoinMenu_o *)sub_1B868D4(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CBFA0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CBF60;
}
