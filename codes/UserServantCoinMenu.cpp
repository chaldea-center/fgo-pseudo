...
void __fastcall UserServantCoinMenu__Close(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinMenu__Close_32386308(this, 0LL, v2);
}


void __fastcall UserServantCoinMenu__Close_32386308(
...
void __fastcall UserServantCoinMenu__EndCloseShowServantCoin(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62592 & 1) == 0 )
  {
    sub_1BE4ACC(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BE4ACC(&Method_UserServantCoinMenu_OnSelectServantCoin__, v4);
    byte_4B62592 = 1;
  }
  ...
  if ( !userServantCoinListViewManager
    || (UserServantCoinListViewManager__RequestListObject(userServantCoinListViewManager, 4, 0.0, v2),
        ...
        v7 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1BE4D18(UserServantCoinListViewManager_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1BE4D28(userServantCoinListViewManager, method);
  }
  v6->fields.callbackFunc = v7;
  sub_1BE4A70(&v6->fields.callbackFunc);
  UserServantCoinListViewManager__SetMode_32391876(v6, 2, v9);
}
...
void __fastcall UserServantCoinMenu__EndOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1BE4ACC(&Method_UserServantCoinMenu_OnSelectServantCoin__, v3);
    byte_4B6258F = 1;
  }
  this->fields.state = 2;
  userServantCoinListViewManager = this->fields.userServantCoinListViewManager;
  v5 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1BE4D18(UserServantCoinListViewManager_CallbackFunc_TypeInfo);
  UserServantCoinListViewManager_CallbackFunc___ctor(
    v5,
    (Il2CppObject *)this,
    Method_UserServantCoinMenu_OnSelectServantCoin__,
  ...
  sub_1BE4A70(&userServantCoinListViewManager->fields.callbackFunc);
  UserServantCoinListViewManager__SetMode_32391876(userServantCoinListViewManager, 2, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62591 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_UserServantCoinMenu_EndCloseShowServantCoin__, v5);
    sub_1BE4ACC(&Method_UserServantCoinMenu_EndShowServantCoin__, v6);
    byte_4B62591 = 1;
  }
  v7 = Method_UserServantCoinMenu_EndShowServantCoin__;
  if ( (*((_BYTE *)Method_UserServantCoinMenu_EndShowServantCoin__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1BE4AE4(Method_UserServantCoinMenu_EndShowServantCoin__);
...
void __fastcall UserServantCoinMenu__OnClickScaleChange(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62595 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UserServantCoinMenu_OnClickScaleChange__, method);
    byte_4B62595 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_UserServantCoinMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62590 & 1) == 0 )
  {
    sub_1BE4ACC(&ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1BE4ACC(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, v7);
    ...
    sub_1BE4ACC(&Method_UserServantCoinMenu_EndShowServantCoin__, v12);
    byte_4B62590 = 1;
  }
  entity = 0LL;
  if ( kind == 1 && this->fields.state == 2 )
  {
           ...
           (const MethodInfo_31FD818 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( CommonUI__get_IsEnableItemLinkInfoWindow((CommonUI_o *)Instance, 0LL) )
      {
        ...
        if ( v16 )
        {
          CommonUI__OpenItemLinkInfoDetailWindow_30978316((CommonUI_o *)v16, UserItemData, v17, 0LL);
          return;
        }
LABEL_16:
      ...
      itemDetailInfoComp = this->fields.itemDetailInfoComp;
      v19 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1BE4D18(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
...
void __fastcall UserServantCoinMenu__OnStartClose(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B62594 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_UserServantCoinMenu_EndClose__, v3);
    byte_4B62594 = 1;
  }
...
void __fastcall UserServantCoinMenu__OnStartOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&System_Action_TypeInfo, method);
    sub_1BE4ACC(&Method_UserServantCoinMenu_EndOpen__, v3);
    byte_4B6258E = 1;
  }
  v4 = (System_Action_o *)sub_1BE4D18(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    UserServantCoinListViewManager__SetMode_32391876((UserServantCoinListViewManager_o *)gameObject, 1, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6258C & 1) == 0 )
  {
    sub_1BE4ACC(&UserServantCoinMenu_CallbackFunc_TypeInfo, value);
    byte_4B6258C = 1;
  }
  ...
  v11 = (UserServantCoinMenu_o *)sub_1BE4FE8(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A205CC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A2058C;
}
