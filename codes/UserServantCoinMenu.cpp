...
void __fastcall UserServantCoinMenu__Close(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinMenu__Close_32806868(this, 0LL, v2);
}


void __fastcall UserServantCoinMenu__Close_32806868(
...
void __fastcall UserServantCoinMenu__EndCloseShowServantCoin(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D880 & 1) == 0 )
  {
    sub_1C3B764(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1C3B764(&Method_UserServantCoinMenu_OnSelectServantCoin__, v4);
    byte_4C1D880 = 1;
  }
  ...
  if ( !userServantCoinListViewManager
    || (UserServantCoinListViewManager__RequestListObject(userServantCoinListViewManager, 4, 0.0, v2),
        ...
        v7 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1C3B9B0(UserServantCoinListViewManager_CallbackFunc_TypeInfo),
        ...
        !v6) )
  {
    sub_1C3B9C0(userServantCoinListViewManager, method);
  }
  v6->fields.callbackFunc = v7;
  sub_1C3B708(&v6->fields.callbackFunc);
  UserServantCoinListViewManager__SetMode_32812368(v6, 2, v9);
}
...
void __fastcall UserServantCoinMenu__EndOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&UserServantCoinListViewManager_CallbackFunc_TypeInfo, method);
    sub_1C3B764(&Method_UserServantCoinMenu_OnSelectServantCoin__, v3);
    byte_4C1D87D = 1;
  }
  this->fields.state = 2;
  userServantCoinListViewManager = this->fields.userServantCoinListViewManager;
  v5 = (UserServantCoinListViewManager_CallbackFunc_o *)sub_1C3B9B0(UserServantCoinListViewManager_CallbackFunc_TypeInfo);
  UserServantCoinListViewManager_CallbackFunc___ctor(
    v5,
    (Il2CppObject *)this,
    Method_UserServantCoinMenu_OnSelectServantCoin__,
  ...
  sub_1C3B708(&userServantCoinListViewManager->fields.callbackFunc);
  UserServantCoinListViewManager__SetMode_32812368(userServantCoinListViewManager, 2, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D87F & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_UserServantCoinMenu_EndCloseShowServantCoin__, v5);
    sub_1C3B764(&Method_UserServantCoinMenu_EndShowServantCoin__, v6);
    byte_4C1D87F = 1;
  }
  v7 = Method_UserServantCoinMenu_EndShowServantCoin__;
  if ( (*((_BYTE *)Method_UserServantCoinMenu_EndShowServantCoin__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C3B77C(Method_UserServantCoinMenu_EndShowServantCoin__);
...
LABEL_13:
  ...
  if ( !itemDetailInfoComp )
    goto LABEL_13;
  ItemDetailInfoComponent__Close_32151164(itemDetailInfoComp, v14, 0LL);
}
...
void __fastcall UserServantCoinMenu__OnClickScaleChange(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D883 & 1) == 0 )
  {
    sub_1C3B764(&Method_UserServantCoinMenu_OnClickScaleChange__, method);
    byte_4C1D883 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinMenu_OnClickScaleChange__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3B77C(Method_UserServantCoinMenu_OnClickScaleChange__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D87E & 1) == 0 )
  {
    sub_1C3B764(&ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo, *(_QWORD *)&kind);
    sub_1C3B764(&ItemDetailInfoComponent_CallbackFunc_TypeInfo, v7);
    ...
    sub_1C3B764(&Method_UserServantCoinMenu_EndShowServantCoin__, v12);
    byte_4C1D87E = 1;
  }
  entity = 0LL;
  if ( kind == 1 && this->fields.state == 2 )
  {
           ...
           (const MethodInfo_329AE94 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
    {
      ...
      if ( CommonUI__get_IsEnableItemLinkInfoWindow((CommonUI_o *)Instance, 0LL) )
      {
        ...
        v17 = (ItemLinkInfoWindowComponent_CallbackFunc_o *)sub_1C3B9B0(ItemLinkInfoWindowComponent_CallbackFunc_TypeInfo);
        ...
        if ( v16 )
        {
          CommonUI__OpenItemLinkInfoDetailWindow_31336420((CommonUI_o *)v16, UserItemData, v17, 0LL);
          return;
        }
LABEL_16:
      ...
      itemDetailInfoComp = this->fields.itemDetailInfoComp;
      v19 = (ItemDetailInfoComponent_CallbackFunc_o *)sub_1C3B9B0(ItemDetailInfoComponent_CallbackFunc_TypeInfo);
...
void __fastcall UserServantCoinMenu__OnStartClose(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D882 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_UserServantCoinMenu_EndClose__, v3);
    byte_4C1D882 = 1;
  }
...
void __fastcall UserServantCoinMenu__OnStartOpen(UserServantCoinMenu_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3B764(&System_Action_TypeInfo, method);
    sub_1C3B764(&Method_UserServantCoinMenu_EndOpen__, v3);
    byte_4C1D87C = 1;
  }
  v4 = (System_Action_o *)sub_1C3B9B0(System_Action_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    UserServantCoinListViewManager__SetMode_32812368((UserServantCoinListViewManager_o *)gameObject, 1, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1D87A & 1) == 0 )
  {
    sub_1C3B764(&UserServantCoinMenu_CallbackFunc_TypeInfo, value);
    byte_4C1D87A = 1;
  }
  ...
  v11 = (UserServantCoinMenu_o *)sub_1C3BC80(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A76060;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A76020;
}
