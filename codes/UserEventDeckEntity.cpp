...
void __fastcall UserEventDeckEntity___ctor_39809020(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0987A & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_DataEntityBase_string___ctor__, v15);
    sub_1B686D4(&DeckServant_TypeInfo, v16);
    byte_4A0987A = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  if ( waveNum < 1 || memberNum < 1 )
  {
    ...
    DeckServant___ctor_38617348(v17, DeckMemberMax, userEquipId, 0LL);
  }
  else
  {
    v17 = (DeckServant_o *)sub_1B68920(DeckServant_TypeInfo);
    DeckServant___ctor_38618004(v17, waveNum, memberNum, userEquipId, 0LL);
  }
  this->fields.deckInfo = v17;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.deckInfo, (int32_t)v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1B6877C(long___TypeInfo, (unsigned int)v8->static_fields->SvtEquipMax);
}


System_Int64_array *__fastcall UserEventDeckEntity__GetEquipList_39809592(
        UserEventDeckEntity_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_38620292(deckInfo, userSvtId, isInterruption, 0LL);
  ...
  return (System_Int64_array *)sub_1B6877C(long___TypeInfo, (unsigned int)v10->static_fields->SvtEquipMax);
}
...
int32_t __fastcall UserEventDeckEntity__GetFollowerIndex(UserEventDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A09880 & 1) == 0 )
  {
    this = (UserEventDeckEntity_o *)sub_1B686D4(&BalanceConfig_TypeInfo, method);
    byte_4A09880 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v12 >= max_length )
        sub_1B68938(v7, npcFollowerSvtId);
      v13 = svts->m_Items[v12];
      if ( !v13 )
        break;
      if ( !v6 )
...
LABEL_17:
    sub_1B68930(v7, npcFollowerSvtId);
  }
LABEL_15:
  if ( !v6 )
    goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0987E & 1) == 0 )
  {
    sub_1B686D4(&BalanceConfig_TypeInfo, *(_QWORD *)&wave);
    sub_1B686D4(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v5);
    ...
    sub_1B686D4(&UserServantEntity___TypeInfo, v12);
    sub_1B686D4(&UserServantEntity_TypeInfo, v13);
    byte_4A0987E = 1;
  }
  v50 = 0LL;
  entity = 0LL;
  ...
  v15 = DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  ...
  v18 = sub_1B6877C(UserServantEntity___TypeInfo, (unsigned int)v16->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
...
LABEL_35:
        ...
        if ( entity )
        {
          v18 = sub_1B68810(entity, v23->obj.klass->_1.element_class);
          if ( !v18 )
          {
            v44 = sub_1B68954(0LL);
            sub_1B687FC(v44, 0LL);
      ...
      if ( isInterruption )
      {
        ...
        {
          v39 = v50;
          v40 = sub_1B68920(UserServantEntity_TypeInfo);
          UserServantEntity___ctor_39926416((UserServantEntity_o *)v40, v39, 0LL);
