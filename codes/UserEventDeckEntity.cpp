...
void __fastcall UserEventDeckEntity___ctor_41543648(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22C41 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DataEntityBase_string___ctor__, v15);
    sub_1C3B764(&DeckServant_TypeInfo, v16);
    byte_4C22C41 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  if ( waveNum < 1 || memberNum < 1 )
  {
    ...
    DeckServant___ctor_40311016(v17, DeckMemberMax, userEquipId, 0LL);
  }
  else
  {
    v17 = (DeckServant_o *)sub_1C3B9B0(DeckServant_TypeInfo);
    DeckServant___ctor_40311672(v17, waveNum, memberNum, userEquipId, 0LL);
  }
  this->fields.deckInfo = v17;
  sub_1C3B708((PartyOrganizationUtility_o *)&this->fields.deckInfo, (int64_t)v17, v18, v19, v20, v21, v22, v23);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4C22C42 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_long__int__int___, *(_QWORD *)&eventId);
    byte_4C22C42 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1C3B80C(long___TypeInfo, (unsigned int)v8->static_fields->SvtEquipMax);
}


System_Int64_array *__fastcall UserEventDeckEntity__GetEquipList_41544220(
        UserEventDeckEntity_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_40313788(deckInfo, userSvtId, isInterruption, 0LL);
  ...
  return (System_Int64_array *)sub_1C3B80C(long___TypeInfo, (unsigned int)v10->static_fields->SvtEquipMax);
}
...
int32_t __fastcall UserEventDeckEntity__GetFollowerIndex(UserEventDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22C47 & 1) == 0 )
  {
    this = (UserEventDeckEntity_o *)sub_1C3B764(&BalanceConfig_TypeInfo, method);
    byte_4C22C47 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v12 >= max_length )
        sub_1C3B9C8(v7, npcFollowerSvtId);
      v13 = svts->m_Items[v12];
      if ( !v13 )
        break;
      if ( !v6 )
...
LABEL_17:
    sub_1C3B9C0(v7, npcFollowerSvtId);
  }
LABEL_15:
  if ( !v6 )
    goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22C45 & 1) == 0 )
  {
    sub_1C3B764(&BalanceConfig_TypeInfo, *(_QWORD *)&wave);
    ...
    sub_1C3B764(&UserServantEntity___TypeInfo, v12);
  ...
  v15 = DataManager__GetMaster_object_((const MethodInfo_2FF01B0 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  ...
  v18 = sub_1C3B80C(UserServantEntity___TypeInfo, (unsigned int)v16->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
...
LABEL_35:
        ...
        if ( entity )
        {
          v18 = sub_1C3B8A0(entity, v23->obj.klass->_1.element_class);
          if ( !v18 )
          {
            v48 = sub_1C3B9E4(0LL);
            sub_1C3B88C(v48, 0LL);
        ...
        sub_1C3B708((PartyOrganizationUtility_o *)(v42 + 4), (int64_t)v41, v35, v36, v37, v38, v39, v40);
        goto LABEL_53;
      }
      if ( isInterruption )
      {
        ...
        {
          v43 = v54;
          v44 = sub_1C3B9B0(UserServantEntity_TypeInfo);
          UserServantEntity___ctor_41667292((UserServantEntity_o *)v44, v43, 0LL);
