...
void __fastcall UserEventDeckEntity___ctor_39861600(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206F1 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_DataEntityBase_string___ctor__, v15);
    sub_1B715CC(&DeckServant_TypeInfo, v16);
    byte_4A206F1 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  if ( waveNum < 1 || memberNum < 1 )
  {
    ...
    DeckServant___ctor_38665740(v17, DeckMemberMax, userEquipId, 0LL);
  }
  else
  {
    v17 = (DeckServant_o *)sub_1B71818(DeckServant_TypeInfo);
    DeckServant___ctor_38666396(v17, waveNum, memberNum, userEquipId, 0LL);
  }
  this->fields.deckInfo = v17;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.deckInfo, (int32_t)v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1B71674(long___TypeInfo, (unsigned int)v8->static_fields->SvtEquipMax);
}


System_Int64_array *__fastcall UserEventDeckEntity__GetEquipList_39862172(
        UserEventDeckEntity_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_38668684(deckInfo, userSvtId, isInterruption, 0LL);
  ...
  return (System_Int64_array *)sub_1B71674(long___TypeInfo, (unsigned int)v10->static_fields->SvtEquipMax);
}
...
int32_t __fastcall UserEventDeckEntity__GetFollowerIndex(UserEventDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A206F7 & 1) == 0 )
  {
    this = (UserEventDeckEntity_o *)sub_1B715CC(&BalanceConfig_TypeInfo, method);
    byte_4A206F7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v12 >= max_length )
        sub_1B71830(v7, npcFollowerSvtId);
      v13 = svts->m_Items[v12];
      if ( !v13 )
        break;
      if ( !v6 )
...
LABEL_17:
    sub_1B71828(v7, npcFollowerSvtId);
  }
LABEL_15:
  if ( !v6 )
    goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A206F5 & 1) == 0 )
  {
    sub_1B715CC(&BalanceConfig_TypeInfo, *(_QWORD *)&wave);
    sub_1B715CC(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v5);
    ...
    sub_1B715CC(&UserServantEntity___TypeInfo, v12);
    sub_1B715CC(&UserServantEntity_TypeInfo, v13);
    byte_4A206F5 = 1;
  }
  v50 = 0LL;
  entity = 0LL;
  ...
  v15 = DataManager__GetMaster_object_((const MethodInfo_2E5B394 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  ...
  v18 = sub_1B71674(UserServantEntity___TypeInfo, (unsigned int)v16->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
...
LABEL_35:
        ...
        if ( entity )
        {
          v18 = sub_1B71708(entity, v23->obj.klass->_1.element_class);
          if ( !v18 )
          {
            v44 = sub_1B7184C(0LL);
            sub_1B716F4(v44, 0LL);
      ...
      if ( isInterruption )
      {
        ...
        {
          v39 = v50;
          v40 = sub_1B71818(UserServantEntity_TypeInfo);
          UserServantEntity___ctor_39980432((UserServantEntity_o *)v40, v39, 0LL);
