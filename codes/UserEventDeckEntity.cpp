...
void UserEventDeckEntity___ctor_43317640(
        ...
        const MethodInfo *method)
{
  ...
  if ( waveNum < 1 || memberNum < 1 )
  {
    ...
    v15 = (DeckServant_o *)sub_1C715FC(DeckServant_TypeInfo);
    DeckServant___ctor_41975020(v15, DeckMemberMax, userEquipId, 0);
  }
  else
  {
    v15 = (DeckServant_o *)sub_1C715FC(DeckServant_TypeInfo);
    DeckServant___ctor_41975676(v15, waveNum, memberNum, userEquipId, 0);
  }
  this->fields.deckInfo = v15;
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.deckInfo, (int32_t)v15, v16, v17, v18, v19, v20, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1C71458(long___TypeInfo, (unsigned int)v7->static_fields->SvtEquipMax);
}


System_Int64_array *UserEventDeckEntity__GetEquipList_43318216(
        UserEventDeckEntity_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_41977792(deckInfo, userSvtId, isInterruption, 0);
  ...
  return (System_Int64_array *)sub_1C71458(long___TypeInfo, (unsigned int)v9->static_fields->SvtEquipMax);
}
...
int32_t UserEventDeckEntity__GetFollowerIndex(UserEventDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC81DC & 1) == 0 )
  {
    this = (UserEventDeckEntity_o *)sub_1C713B0(&BalanceConfig_TypeInfo);
    byte_4CC81DC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1C71458(long___TypeInfo, (unsigned int)v7->static_fields->GrandSvtEquipMax);
}
...
LABEL_17:
    sub_1C71608(v4, npcFollowerSvtId);
  }
LABEL_15:
  if ( !v3 )
    goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  v6 = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  v7 = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_UserServantStorageMaster___);
  ...
  IsWithdrawal = sub_1C71458(UserServantEntity___TypeInfo, (unsigned int)v8->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
  if ( !deckInfo || (svts = deckInfo->fields.svts, v44 = (UserServantCollectionMaster_o *)v6, !svts) )
LABEL_70:
    sub_1C71608(IsWithdrawal, v11);
  max_length = svts->max_length;
...
LABEL_45:
      ...
      if ( isInterruption )
      {
        ...
        {
          v38 = v49;
          v39 = sub_1C715FC(UserServantEntity_TypeInfo);
          UserServantEntity___ctor_43445644((UserServantEntity_o *)v39, v38, 1, 0);
...
LABEL_47:
          if ( v36 )
          {
            IsWithdrawal = sub_1C714EC(v36, v15->obj.klass->_1.element_class);
            if ( !IsWithdrawal )
            {
              v43 = sub_1C7162C(0);
              sub_1C714D8(v43, 0);
          ...
          v35 = (int)v36;
LABEL_51:
          sub_1C71354(v34, v35, v27, v28, v29, v30, v31, v32);
        }
      }
LABEL_52:
      max_length = svts->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC81DE & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Linq_Enumerable_FirstOrDefault_DeckServantData___);
    sub_1C713B0(&System_Func_DeckServantData__bool__TypeInfo);
    sub_1C713B0(&Method_UserEventDeckEntity___c__DisplayClass18_0__IsEquipTarget2SkillChange_b__0__);
    sub_1C713B0(&UserEventDeckEntity___c__DisplayClass18_0_TypeInfo);
    byte_4CC81DE = 1;
  }
  v5 = sub_1C715FC(UserEventDeckEntity___c__DisplayClass18_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = pos;
  ...
  if ( deckInfo )
  {
    *(_DWORD *)(v5 + 16) = pos + 1;
    ...
    v10 = (System_Func_object__bool__o *)sub_1C715FC(System_Func_DeckServantData__bool__TypeInfo);
    ...
    v11 = System_Linq_Enumerable__FirstOrDefault_object__51858576(
            ...
            (const MethodInfo_3174C90 *)Method_System_Linq_Enumerable_FirstOrDefault_DeckServantData___);
    if ( v11 )
