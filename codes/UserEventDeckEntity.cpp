...
void __fastcall UserEventDeckEntity___ctor_38799228(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E33AF & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataEntityBase_string___ctor__, v15);
    sub_1B00CCC(&DeckServant_TypeInfo, v16);
    byte_48E33AF = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  if ( waveNum < 1 || memberNum < 1 )
  {
    ...
    DeckServant___ctor_37645816(v17, DeckMemberMax, userEquipId, 0LL);
  }
  else
  {
    v17 = (DeckServant_o *)sub_1B00F18(DeckServant_TypeInfo);
    DeckServant___ctor_37646472(v17, waveNum, memberNum, userEquipId, 0LL);
  }
  this->fields.deckInfo = v17;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.deckInfo, (int32_t)v17, v18, v19);
}
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1B00D74(long___TypeInfo, (unsigned int)v8->static_fields->SvtEquipMax);
}


System_Int64_array *__fastcall UserEventDeckEntity__GetEquipList_38799800(
        UserEventDeckEntity_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_37648760(deckInfo, userSvtId, isInterruption, 0LL);
  ...
  return (System_Int64_array *)sub_1B00D74(long___TypeInfo, (unsigned int)v10->static_fields->SvtEquipMax);
}
...
int32_t __fastcall UserEventDeckEntity__GetFollowerIndex(UserEventDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E33B5 & 1) == 0 )
  {
    this = (UserEventDeckEntity_o *)sub_1B00CCC(&BalanceConfig_TypeInfo, method);
    byte_48E33B5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v12 >= max_length )
        sub_1B00F30(v7, npcFollowerSvtId);
      v13 = svts->m_Items[v12];
      if ( !v13 )
        break;
      if ( !v6 )
...
LABEL_17:
    sub_1B00F28(v7, npcFollowerSvtId);
  }
LABEL_15:
  if ( !v6 )
    goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  UserServantCollectionEntity_o *v40; // x26
  __int64 v41; // x25
  const MethodInfo *v42; // x2
  int64_t v43; // x26
  __int128 v44; // q0
  __int64 v46; // x0
  UserServantCollectionMaster_o *v47; // [xsp+8h] [xbp-C8h]
  ...
  UserServantCollectionEntity_o *v52; // [xsp+60h] [xbp-70h] BYREF
  Il2CppObject *entity; // [xsp+68h] [xbp-68h] BYREF

  if ( (byte_48E33B3 & 1) == 0 )
  {
    sub_1B00CCC(&BalanceConfig_TypeInfo, *(_QWORD *)&wave);
    sub_1B00CCC(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v5);
    sub_1B00CCC(&Method_DataManager_GetMaster_UserServantMaster___, v6);
    sub_1B00CCC(&DataManager_TypeInfo, v7);
    sub_1B00CCC(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__, v8);
    ...
    sub_1B00CCC(&UserServantEntity___TypeInfo, v12);
    sub_1B00CCC(&UserServantEntity_TypeInfo, v13);
    byte_48E33B3 = 1;
  }
  v52 = 0LL;
  entity = 0LL;
  ...
  v15 = DataManager__GetMaster_object_((const MethodInfo_2D62BBC *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  ...
  v18 = sub_1B00D74(UserServantEntity___TypeInfo, (unsigned int)v16->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
  if ( !deckInfo || (svts = deckInfo->fields.svts, v47 = (UserServantCollectionMaster_o *)v17, !svts) )
LABEL_54:
    sub_1B00F28(v18, v19);
  max_length = svts->max_length;
...
LABEL_35:
        ...
        if ( entity )
        {
          v18 = sub_1B00E08(entity, v23->obj.klass->_1.element_class);
          if ( !v18 )
          {
            v46 = sub_1B00F4C(0LL);
            sub_1B00DF4(v46, 0LL);
      ...
      if ( isInterruption )
      {
        ...
        if ( !v47 )
          goto LABEL_54;
        v18 = UserServantCollectionMaster__TryGetEntity(v47, &v52, UserId, v25->fields.svtId, v39);
        if ( (v18 & 1) != 0 )
        {
          v40 = v52;
          v41 = sub_1B00F18(UserServantEntity_TypeInfo);
          UserServantEntity___ctor_38801104((UserServantEntity_o *)v41, v40, v42);
          entity = (Il2CppObject *)v41;
          v43 = *p_userSvtId;
          if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
          v18 = (__int64)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit(&v50, v43, 0LL);
          v51 = v50;
          if ( !v41 )
            goto LABEL_54;
          v44 = *(_OWORD *)&v51.fields.fakeValue;
          *(_OWORD *)(v41 + 16) = *(_OWORD *)&v51.fields.currentCryptoKey;
          *(_OWORD *)(v41 + 32) = v44;
          if ( !v23 )
            goto LABEL_54;
          goto LABEL_35;
