...
void __fastcall UserEventDeckEntity___ctor_39888836(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EB63 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataEntityBase_string___ctor__, v15);
    sub_1B761C0(&DeckServant_TypeInfo, v16);
    byte_4A2EB63 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  {
    v17 = (DeckServant_o *)sub_1B7640C(DeckServant_TypeInfo);
    DeckServant___ctor_38691684(v17, waveNum, memberNum, userEquipId, 0LL);
  }
...
System_Int64_array *__fastcall UserEventDeckEntity__GetEquipList_39889408(
        UserEventDeckEntity_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_38693972(deckInfo, userSvtId, isInterruption, 0LL);
  ...
  return (System_Int64_array *)sub_1B76268(long___TypeInfo, (unsigned int)v10->static_fields->SvtEquipMax);
}
...
int32_t __fastcall UserEventDeckEntity__GetFollowerIndex(UserEventDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2EB69 & 1) == 0 )
  {
    this = (UserEventDeckEntity_o *)sub_1B761C0(&BalanceConfig_TypeInfo, method);
    byte_4A2EB69 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      if ( v12 >= max_length )
        sub_1B76424(v7, npcFollowerSvtId);
      v13 = svts->m_Items[v12];
      if ( !v13 )
        break;
      if ( !v6 )
...
LABEL_17:
    sub_1B7641C(v7, npcFollowerSvtId);
  }
LABEL_15:
  if ( !v6 )
    goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EB67 & 1) == 0 )
  {
    sub_1B761C0(&BalanceConfig_TypeInfo, *(_QWORD *)&wave);
    sub_1B761C0(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v5);
    ...
    sub_1B761C0(&UserServantEntity___TypeInfo, v12);
    sub_1B761C0(&UserServantEntity_TypeInfo, v13);
    byte_4A2EB67 = 1;
  }
  v50 = 0LL;
  entity = 0LL;
  ...
  v15 = DataManager__GetMaster_object_((const MethodInfo_2E623B4 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  ...
  v18 = sub_1B76268(UserServantEntity___TypeInfo, (unsigned int)v16->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
...
LABEL_35:
        ...
        if ( entity )
        {
          v18 = sub_1B762FC(entity, v23->obj.klass->_1.element_class);
          if ( !v18 )
          {
            v44 = sub_1B76440(0LL);
            sub_1B762E8(v44, 0LL);
      ...
      if ( isInterruption )
      {
        ...
        {
          v39 = v50;
          v40 = sub_1B7640C(UserServantEntity_TypeInfo);
          UserServantEntity___ctor_40007668((UserServantEntity_o *)v40, v39, 0LL);
