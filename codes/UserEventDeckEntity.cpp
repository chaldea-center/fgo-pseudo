...
void UserEventDeckEntity___ctor_44166360(
        ...
        const MethodInfo *method)
{
  ...
  if ( waveNum < 1 || memberNum < 1 )
  {
    ...
    v15 = (DeckServant_o *)sub_1CE694C(DeckServant_TypeInfo);
    DeckServant___ctor_42850948(v15, DeckMemberMax, userEquipId, 0);
  }
  else
  {
    v15 = (DeckServant_o *)sub_1CE694C(DeckServant_TypeInfo);
    DeckServant___ctor_42851604(v15, waveNum, memberNum, userEquipId, 0);
  }
  this->fields.deckInfo = v15;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.deckInfo, (int32_t)v15, v16, v17, v18, v19, v20, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1CE67A8(long___TypeInfo, (unsigned int)v7->static_fields->SvtEquipMax);
}


System_Int64_array *UserEventDeckEntity__GetEquipList_44166932(
        UserEventDeckEntity_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  deckInfo = this->fields.deckInfo;
  if ( deckInfo )
    return DeckServant__GetEquipList_42854072(deckInfo, userSvtId, isInterruption, 0);
...
int32_t UserEventDeckEntity__GetFollowerIndex(UserEventDeckEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0580A & 1) == 0 )
  {
    this = (UserEventDeckEntity_o *)sub_1CE6700(&BalanceConfig_TypeInfo);
    byte_4E0580A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  return (System_Int64_array *)sub_1CE67A8(long___TypeInfo, (unsigned int)v7->static_fields->GrandSvtEquipMax);
}
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)size >= LODWORD(items->max_length) )
      {
        System_Collections_Generic_List_long___AddWithResize(
          v3,
          npcFollowerSvtId,
          *(const MethodInfo_38EDF9C **)(*(_QWORD *)(v12[4] + 192LL) + 112LL));
      }
      else
      {
        v3->fields._size = size + 1;
...
LABEL_17:
    sub_1CE6958(v4, npcFollowerSvtId);
  }
LABEL_15:
  if ( !v3 )
    goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  v6 = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  v7 = DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_UserServantStorageMaster___);
  ...
  IsWithdrawal = sub_1CE67A8(UserServantEntity___TypeInfo, (unsigned int)v8->static_fields->DeckMemberMax);
  deckInfo = this->fields.deckInfo;
  if ( !deckInfo || (svts = deckInfo->fields.svts, v44 = (UserServantCollectionMaster_o *)v6, !svts) )
LABEL_70:
    sub_1CE6958(IsWithdrawal, v11);
  max_length = svts->max_length;
...
LABEL_45:
      ...
      if ( isInterruption )
      {
        ...
        {
          v38 = v49;
          v39 = sub_1CE694C(UserServantEntity_TypeInfo);
          UserServantEntity___ctor_44292404((UserServantEntity_o *)v39, v38, 1, 0);
...
LABEL_47:
          if ( v36 )
          {
            IsWithdrawal = sub_1CE683C(v36, v15->obj.klass->_1.element_class);
            if ( !IsWithdrawal )
            {
              v43 = sub_1CE697C(0);
              sub_1CE6828(v43, 0);
          ...
          v35 = (int)v36;
LABEL_51:
          sub_1CE66A4(v34, v35, v27, v28, v29, v30, v31, v32);
        }
      }
LABEL_52:
      max_length = svts->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0580C & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Linq_Enumerable_FirstOrDefault_DeckServantData___);
    sub_1CE6700(&System_Func_DeckServantData__bool__TypeInfo);
    sub_1CE6700(&Method_UserEventDeckEntity___c__DisplayClass17_0__IsEquipTarget2SkillChange_b__0__);
    sub_1CE6700(&UserEventDeckEntity___c__DisplayClass17_0_TypeInfo);
    byte_4E0580C = 1;
  }
  v5 = sub_1CE694C(UserEventDeckEntity___c__DisplayClass17_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = pos;
  ...
  if ( deckInfo )
  {
    *(_DWORD *)(v5 + 16) = pos + 1;
    ...
    v10 = (System_Func_object__bool__o *)sub_1CE694C(System_Func_DeckServantData__bool__TypeInfo);
    System_Func_object__bool____ctor(
      v10,
      (Il2CppObject *)v5,
      Method_UserEventDeckEntity___c__DisplayClass17_0__IsEquipTarget2SkillChange_b__0__,
      0);
    v11 = System_Linq_Enumerable__FirstOrDefault_object__52613440(
            svts,
            (System_Func_TSource__bool__o *)v10,
            (const MethodInfo_322D140 *)Method_System_Linq_Enumerable_FirstOrDefault_DeckServantData___);
    if ( v11 )
