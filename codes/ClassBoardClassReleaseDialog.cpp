void __fastcall ClassBoardClassReleaseDialog___ctor(ClassBoardClassReleaseDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00D5F & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent___ctor__, v3);
    sub_1C2E12C(&System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__TypeInfo, v4);
    byte_4C00D5F = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00D5C & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_ClassBoardClassReleaseDialog_OnCloseEnd__, v10);
    byte_4C00D5C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00D5E & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_ClassBoardBaseClassIconNameComponent___, *(_QWORD *)&count);
    sub_1C2E12C(&Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__Add__, v5);
    sub_1C2E12C(&Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__get_Count__, v6);
    sub_1C2E12C(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    this = (ClassBoardClassReleaseDialog_o *)sub_1C2E12C(&UnityEngine_Object_TypeInfo, v8);
    byte_4C00D5E = 1;
  }
      ...
      do
      {
        ...
        if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v13, 0LL, 0LL) )
        {
          ...
          this = (ClassBoardClassReleaseDialog_o *)UnityEngine_GameObject__GetComponent_object_(
                                                     (UnityEngine_GameObject_o *)v13,
                                                     (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_ClassBoardBaseClassIconNameComponent___);
          if ( !v14 )
            goto LABEL_17;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00D5B & 1) == 0 )
  {
    sub_1C2E12C(&Method_ClassBoardClassReleaseDialog_OnClickCloseButton__, method);
  ...
  if ( (*((_BYTE *)Method_ClassBoardClassReleaseDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2E144(Method_ClassBoardClassReleaseDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00D5A & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_Component_GetComponent_UIGrid___, classBaseIds);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Enumerator_ClassBoardBaseClassIconNameComponent__Dispose__, v5);
    sub_1C2E12C(&Method_System_Collections_Generic_List_Enumerator_ClassBoardBaseClassIconNameComponent__MoveNext__, v6);
    sub_1C2E12C(
      &Method_System_Collections_Generic_List_Enumerator_ClassBoardBaseClassIconNameComponent__get_Current__,
      v7);
    sub_1C2E12C(&Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__GetEnumerator__, v8);
    sub_1C2E12C(&Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__get_Count__, v9);
    sub_1C2E12C(&Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__get_Item__, v10);
    byte_4C00D5A = 1;
  }
  ...
  if ( classBaseIds )
  {
    ...
    if ( v11 )
    {
      ...
      System_Collections_Generic_List_object___GetEnumerator(
        ...
        iconList,
        (const MethodInfo_366C3A4 *)Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__GetEnumerator__);
      v22 = v21;
      while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
                &v22,
                (const MethodInfo_34001C4 *)Method_System_Collections_Generic_List_Enumerator_ClassBoardBaseClassIconNameComponent__MoveNext__) )
      {
      ...
      System_Collections_Generic_List_Enumerator_object___Dispose(
        &v22,
        (const MethodInfo_34001C0 *)Method_System_Collections_Generic_List_Enumerator_ClassBoardBaseClassIconNameComponent__Dispose__);
        ...
        while ( 1 )
        {
          ...
          if ( (__int64)v18 < iconList->fields._size )
          {
            iconList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                      iconList,
                                                                      v18,
                                                                      (const MethodInfo_366B5DC *)Method_System_Collections_Generic_List_ClassBoardBaseClassIconNameComponent__get_Item__);
            if ( v18 >= classBaseIds->max_length )
              sub_1C2E390(iconList, v12);
            if ( !iconList )
              break;
...
void __fastcall ClassBoardClassReleaseDialog__SetupText(ClassBoardClassReleaseDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C00D5D & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_3550/*"CLASS_BOARD_RELEASE_DIALOG_CONTENT"*/, v3);
    sub_1C2E12C(&StringLiteral_3799/*"COMMON_CONFIRM_CLOSE"*/, v4);
    sub_1C2E12C(&StringLiteral_3551/*"CLASS_BOARD_RELEASE_DIALOG_TITLE"*/, v5);
    byte_4C00D5D = 1;
  }
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3551/*"CLASS_BOARD_RELEASE_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, v7, 0LL),
        contentLabel = this->fields.contentLabel,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3550/*"CLASS_BOARD_RELEASE_DIALOG_CONTENT"*/, 0LL),
        !contentLabel)
    || (UILabel__set_text(contentLabel, v7, 0LL),
        closeButtonLabel = this->fields.closeButtonLabel,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_3799/*"COMMON_CONFIRM_CLOSE"*/, 0LL),
        !closeButtonLabel) )
  {
    sub_1C2E388(v7, v8);
  }
