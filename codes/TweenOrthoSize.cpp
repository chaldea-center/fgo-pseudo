        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0929E & 1) == 0 )
  {
    sub_1CE6700(&Method_UITweener_Begin_TweenOrthoSize___);
    byte_4E0929E = 1;
  }
  v7 = (TweenOrthoSize_o *)UITweener__Begin_object_(
                             go,
                             duration,
                             (const MethodInfo_32DA710 *)Method_UITweener_Begin_TweenOrthoSize___);
  if ( !v7 )
    sub_1CE6958(0, v8);
  v9 = v7;
...
UnityEngine_Camera_o *TweenOrthoSize__get_cachedCamera(TweenOrthoSize_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(mCam, 0, 0) )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mCam, (int32_t)Component_object, v5, v6, v7, v8, v9, v10);
  }
