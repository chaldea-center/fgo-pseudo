...
UnityEngine_Transform_o *__fastcall BattleMoveObject__GetTransform(BattleMoveObject_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(selfTransform, 0LL, 0LL) )
  {
    ...
    sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.selfTransform, (int64_t)transform, v5, v6, v7, v8, v9, v10);
  }
...
void __fastcall BattleMoveObject__OnSpawn(BattleMoveObject_o *this, const MethodInfo *method)
{
  ...
  *(_WORD *)&this->fields.dropflg = 0;
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.targetTr, 0LL, v2, v3, v4, v5, v6, v7);
  v8->fields.perf = 0LL;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v8->fields.perf, 0LL, v9, v10, v11, v12, v13, v14);
  v8->fields.destoryobject = 0LL;
  v8 = (BattleMoveObject_o *)((char *)v8 + 64);
  sub_1C21DDC((PartyOrganizationUtility_o *)v8, 0LL, v15, v16, v17, v18, v19, v20);
...
void __fastcall BattleMoveObject__PlayStarSe(BattleMoveObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC96 & 1) == 0 )
  {
    sub_1C21E38(&Method_BattleMoveObject_PlayStarSe__);
  ...
  if ( (*((_BYTE *)Method_BattleMoveObject_PlayStarSe__ + 83) & 2) != 0 )
    v7 = (_QWORD *)sub_1C21E50(Method_BattleMoveObject_PlayStarSe__);
  v9 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v7, v7[4]);
  OverwriteAssetSoundName__PlayCommonSe_39860612(v9, 7, v8 / 1000.0, 1, 0, 0LL);
}
...
void __fastcall BattleMoveObject__Start(BattleMoveObject_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.spawner, (int64_t)Instance, v4, v5, v6, v7, v8, v9);
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
                       (const MethodInfo_2FA68A8 *)Method_UnityEngine_Component_GetComponent_Rigidbody___);
  this->fields.rigibody = (struct UnityEngine_Rigidbody_o *)Component_object;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC99 & 1) == 0 )
  {
    sub_1C21E38(&BattleMoveObject___StartNotTweenMove_d__35_TypeInfo);
    byte_4BDEC99 = 1;
  }
  v5 = sub_1C22084(BattleMoveObject___StartNotTweenMove_d__35_TypeInfo);
...
void __fastcall BattleMoveObject__onOpenComplete(BattleMoveObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC95 & 1) == 0 )
  {
    sub_1C21E38(&Method_BattleMoveObject_onOpenComplete__);
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    byte_4BDEC95 = 1;
  }
  ...
  if ( v4 )
  {
    ...
    else if ( type == 2 )
    {
      ...
      if ( (*((_BYTE *)Method_BattleMoveObject_onOpenComplete__ + 83) & 2) != 0 )
        v7 = (_QWORD *)sub_1C21E50(Method_BattleMoveObject_onOpenComplete__);
      v8 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v7, v7[4]);
      OverwriteAssetSoundName__PlaySystemSe(v8, 4, 0, 0LL);
      gameObject = this->fields.perf;
      if ( !gameObject )
        goto LABEL_27;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.targetTr, (int64_t)tr, (int64_t)method, v3, v4, v5, v6, v7);
}
...
void __fastcall BattleMoveObject__startMoveTarget(BattleMoveObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC94 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_22668/*"onOpenComplete"*/);
  ...
  ((void (__fastcall *)(System_Collections_Hashtable_o *, __int64, __int64, Il2CppMethodPointer))v4->klass->vtable._23_Add.method)(
    ...
    StringLiteral_22668/*"onOpenComplete"*/,
    v4->klass->vtable._24_Clear.methodPtr);
  v21 = v3;
  ...
  iTween__MoveTo_61653064(gameObject, v4, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDEC9B & 1) == 0 )
  {
    this = (BattleMoveObject___StartNotTweenMove_d__35_o *)sub_1C21E38(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4BDEC9B = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_BattleMoveObject___StartNotTweenMove_d__35_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
