void __fastcall BlankEarthGimmickMaster___ctor(BlankEarthGimmickMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB5A1B & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_BlankEarthGimmickMaster__BlankEarthGimmickEntity__int___ctor__, method);
    byte_4AB5A1B = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    462,
    (const MethodInfo_3163D50 *)Method_DataMasterBase_BlankEarthGimmickMaster__BlankEarthGimmickEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5A1A & 1) == 0 )
  {
    sub_1BAB41C(&BlankEarthGimmickEntity_TypeInfo, method);
    ...
    sub_1BAB41C(&Method_System_Collections_Generic_List_BlankEarthGimmickEntity__Add__, v5);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BlankEarthGimmickEntity__ToArray__, v6);
    sub_1BAB41C(&Method_System_Collections_Generic_List_BlankEarthGimmickEntity___ctor__, v7);
    sub_1BAB41C(&System_Collections_Generic_List_BlankEarthGimmickEntity__TypeInfo, v8);
    byte_4AB5A1A = 1;
  }
  v9 = (System_Collections_Generic_List_object__o *)sub_1BAB668(System_Collections_Generic_List_BlankEarthGimmickEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v9,
    (const MethodInfo_354D088 *)Method_System_Collections_Generic_List_BlankEarthGimmickEntity___ctor__);
    ...
    if ( list )
    {
        ...
        && (BlankEarthGimmickEntity_c *)list->klass->_2.typeHierarchy[methodPtr_low - 1] == BlankEarthGimmickEntity_TypeInfo )
      {
        ...
        else
        {
          ...
          sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v19 + 4), (int32_t)v10, v13, v14);
        }
      }
    }
    list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
...
LABEL_19:
  ...
  return (BlankEarthGimmickEntity_array *)System_Collections_Generic_List_object___ToArray(
                                            v9,
                                            (const MethodInfo_354F414 *)Method_System_Collections_Generic_List_BlankEarthGimmickEntity__ToArray__);
}