        ...
        const MethodInfo *method)
{
  ...
  BuyStorageConfirmDialogComponent__Close_34107792(this, 0LL, v2);
}


void __fastcall BuyStorageConfirmDialogComponent__Close_34107792(
        BuyStorageConfirmDialogComponent_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BC1 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_BuyStorageConfirmDialogComponent_EndClose__, v6);
    byte_4B40BC1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BBD & 1) == 0 )
  {
    ...
    this = (BuyStorageConfirmDialogComponent_o *)sub_1BDB878(
...
LABEL_16:
  ...
  switch ( shopEntity->fields.payType )
  {
    ...
    case 6:
    case 0xB:
      this = (BuyStorageConfirmDialogComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !this )
        goto LABEL_16;
      ...
      if ( !itemIds->max_length )
        sub_1BDBADC(this, shopEntity, v7);
      if ( !this )
        goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BBC & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_12328/*"STONE_FRAGMENTS_NEED_INFO"*/, v7);
    sub_1BDB878(&StringLiteral_1972/*"ANONYMOUS_NEED_INFO"*/, v8);
    sub_1BDB878(&StringLiteral_10955/*"RARE_PRI_NEED_INFO"*/, v9);
    sub_1BDB878(&StringLiteral_8527/*"MANA_NEED_INFO"*/, v10);
    this = (BuyStorageConfirmDialogComponent_o *)sub_1BDB878(&StringLiteral_1/*""*/, v11);
    byte_4B40BBC = 1;
  }
  if ( !shopEntity )
LABEL_25:
  ...
  switch ( shopEntity->fields.payType )
  {
    case 4:
      ...
      v15 = &StringLiteral_8527/*"MANA_NEED_INFO"*/;
      goto LABEL_24;
    case 6:
    case 0xB:
      this = (BuyStorageConfirmDialogComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      ...
      if ( !itemIds )
        goto LABEL_25;
      if ( !itemIds->max_length )
        sub_1BDBADC(this, shopEntity, v12);
      if ( !this )
        goto LABEL_25;
      this = (BuyStorageConfirmDialogComponent_o *)DataMasterBase_object__object__int___GetEntity(
                                                     (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    ...
    case 8:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v15 = &StringLiteral_12328/*"STONE_FRAGMENTS_NEED_INFO"*/;
      goto LABEL_24;
    case 9:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v15 = &StringLiteral_1972/*"ANONYMOUS_NEED_INFO"*/;
      goto LABEL_24;
    case 0xA:
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v15 = &StringLiteral_10955/*"RARE_PRI_NEED_INFO"*/;
LABEL_24:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BBE & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_UserItemMaster___, shopEntity);
    ...
    this = (BuyStorageConfirmDialogComponent_o *)sub_1BDB878(&StringLiteral_1/*""*/, v9);
    byte_4B40BBE = 1;
  }
  if ( !shopEntity )
    goto LABEL_29;
  ...
  if ( payType <= 0xB )
  {
    if ( ((1 << payType) & 0xB40) != 0 )
    {
      ...
      if ( this )
      {
        ...
        {
          if ( !itemIds->max_length )
            sub_1BDBADC(this, shopEntity, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( !this->fields.state )
  {
    ...
    BuyStorageConfirmDialogComponent__Open_34104108(
      this,
      kind,
      2,
      notificationType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BC3 & 1) == 0 )
  {
    sub_1BDB878(&Method_BuyStorageConfirmDialogComponent_OnClickCancel__, method);
    byte_4B40BC3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BuyStorageConfirmDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_BuyStorageConfirmDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BC4 & 1) == 0 )
  {
    sub_1BDB878(&Method_BuyStorageConfirmDialogComponent_OnClickClose__, method);
    byte_4B40BC4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BuyStorageConfirmDialogComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_BuyStorageConfirmDialogComponent_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BC2 & 1) == 0 )
  {
    sub_1BDB878(&Method_BuyStorageConfirmDialogComponent_OnClickDecide__, method);
    byte_4B40BC2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_BuyStorageConfirmDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_BuyStorageConfirmDialogComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BDB85C(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BC5 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_4692/*"ConfirmWindow/Notification/CloseButton"*/, v3);
    sub_1BDB878(&StringLiteral_4691/*"ConfirmWindow/ConfirmInfo/CancelButton"*/, v4);
    byte_4B40BC5 = 1;
  }
  ...
  AndroidBackKeyManager__AddBackBtn_43873512(v6, (System_String_o *)StringLiteral_4693/*"ConfirmWindow/ResultInfo/CloseButton"*/, 0LL);
  v7 = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  AndroidBackKeyManager__AddBackBtn_43873512(v7, (System_String_o *)StringLiteral_4692/*"ConfirmWindow/Notification/CloseButton"*/, 0LL);
}
...
void __fastcall BuyStorageConfirmDialogComponent__Open_34104108(
        BuyStorageConfirmDialogComponent_o *this,
        int32_t kind,
        int32_t type,
        int32_t notificationType,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BBB & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_BuyStorageConfirmDialogComponent_EndOpen__, v14);
    byte_4B40BBB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40BBF & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_11601/*"SERVANT_EQUIP_STORAGE_PURCHASE_RESULT"*/, v14);
    sub_1BDB878(&StringLiteral_12366/*"STORAGE_SHOP_NOTIFICATION"*/, v15);
    sub_1BDB878(&StringLiteral_11602/*"SERVANT_EQUIP_STORAGE_PURCHASE_TITLE"*/, v16);
    sub_1BDB878(&StringLiteral_11972/*"SERVANT_STORAGE_PURCHASE_RESULT"*/, v17);
    sub_1BDB878(&StringLiteral_11609/*"SERVANT_FRAME_PURCHASE_INFO1"*/, v18);
    sub_1BDB878(&StringLiteral_12367/*"STORAGE_SHOP_SOLD_OUT"*/, v19);
    sub_1BDB878(&StringLiteral_11610/*"SERVANT_FRAME_PURCHASE_INFO2"*/, v20);
    sub_1BDB878(&StringLiteral_11606/*"SERVANT_FRAME_PURCHASE_CANCEL"*/, v21);
    sub_1BDB878(&StringLiteral_11973/*"SERVANT_STORAGE_PURCHASE_TITLE"*/, v22);
    sub_1BDB878(&StringLiteral_11970/*"SERVANT_STORAGE_PURCHASE_MESSAGE"*/, v23);
    sub_1BDB878(&StringLiteral_11607/*"SERVANT_FRAME_PURCHASE_CLOSE"*/, v24);
    sub_1BDB878(&StringLiteral_11608/*"SERVANT_FRAME_PURCHASE_DECIDE"*/, v25);
    sub_1BDB878(&StringLiteral_11600/*"SERVANT_EQUIP_STORAGE_PURCHASE_MESSAGE"*/, v26);
    this = (BuyStorageConfirmDialogComponent_o *)sub_1BDB878(&StringLiteral_11971/*"SERVANT_STORAGE_PURCHASE_NUM"*/, v27);
    byte_4B40BBF = 1;
  }
  *(_QWORD *)max = 0LL;
  ...
  if ( kind )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v36 = &StringLiteral_11602/*"SERVANT_EQUIP_STORAGE_PURCHASE_TITLE"*/;
  }
  else
  {
    titleLabel = v12->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v36 = &StringLiteral_11973/*"SERVANT_STORAGE_PURCHASE_TITLE"*/;
  }
...
LABEL_14:
  if ( type == 2 )
  {
    if ( notificationType == 2 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v41 = &StringLiteral_12366/*"STORAGE_SHOP_NOTIFICATION"*/;
    }
    else
    {
...
LABEL_50:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v41 = &StringLiteral_12367/*"STORAGE_SHOP_SOLD_OUT"*/;
    }
...
LABEL_39:
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v30 = LocalizationManager__Get((System_String_o *)StringLiteral_11609/*"SERVANT_FRAME_PURCHASE_INFO1"*/, 0LL);
        if ( nowNumTextLabel )
        {
          UILabel__set_text(nowNumTextLabel, v30, 0LL);
          afterNumTextLabel = v12->fields.afterNumTextLabel;
          v30 = LocalizationManager__Get((System_String_o *)StringLiteral_11610/*"SERVANT_FRAME_PURCHASE_INFO2"*/, 0LL);
          if ( afterNumTextLabel )
          {
            UILabel__set_text(afterNumTextLabel, v30, 0LL);
            decideBtnLabel = v12->fields.decideBtnLabel;
            v30 = LocalizationManager__Get((System_String_o *)StringLiteral_11608/*"SERVANT_FRAME_PURCHASE_DECIDE"*/, 0LL);
            if ( decideBtnLabel )
            {
              UILabel__set_text(decideBtnLabel, v30, 0LL);
              closeBtnLabel = v12->fields.cancelBtnLabel;
              v62 = &StringLiteral_11606/*"SERVANT_FRAME_PURCHASE_CANCEL"*/;
              goto LABEL_63;
            }
          }
        }
LABEL_66:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v39 = &StringLiteral_11600/*"SERVANT_EQUIP_STORAGE_PURCHASE_MESSAGE"*/;
    }
    else
    {
      messageLabel = v12->fields.messageLabel;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v39 = &StringLiteral_11970/*"SERVANT_STORAGE_PURCHASE_MESSAGE"*/;
    }
    ...
    v30 = System_String__Format_62613620(v45, (Il2CppObject *)CurrencyItemName, NumberFormat, v51, 0LL);
    if ( !messageLabel )
      goto LABEL_66;
    UILabel__set_text(messageLabel, v30, 0LL);
    nowNumLabel = v12->fields.nowNumLabel;
    v53 = LocalizationManager__Get((System_String_o *)StringLiteral_11971/*"SERVANT_STORAGE_PURCHASE_NUM"*/, 0LL);
    ...
    v56 = LocalizationManager__Get((System_String_o *)StringLiteral_11971/*"SERVANT_STORAGE_PURCHASE_NUM"*/, 0LL);
  ...
  if ( v42 == 1 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v44 = &StringLiteral_11601/*"SERVANT_EQUIP_STORAGE_PURCHASE_RESULT"*/;
    goto LABEL_55;
  }
  if ( !v42 )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v44 = &StringLiteral_11972/*"SERVANT_STORAGE_PURCHASE_RESULT"*/;
LABEL_55:
    ...
    v69 = LocalizationManager__Get((System_String_o *)StringLiteral_11971/*"SERVANT_STORAGE_PURCHASE_NUM"*/, 0LL);
    v75 = v32;
  ...
  closeBtnLabel = v12->fields.closeBtnLabel;
LABEL_62:
  v62 = &StringLiteral_11607/*"SERVANT_FRAME_PURCHASE_CLOSE"*/;
LABEL_63:
