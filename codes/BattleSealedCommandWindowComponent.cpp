        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(confLabel, 0LL, 0LL) )
  {
    if ( !args )
    {
      args = (BattleSealedCommandWindowComponent_LabelAdjustArgs_o *)sub_B52A54(BattleSealedCommandWindowComponent_LabelAdjustArgs_TypeInfo);
...
LABEL_17:
    ...
    ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_B52A5C)(transform, fontSize_k__BackingField);
  }
}
