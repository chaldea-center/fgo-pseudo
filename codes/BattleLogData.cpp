...
void __fastcall BattleLogData___ctor_19569656(BattleLogData_o *this, System_String_o *intag, const MethodInfo *method)
{
...
void __fastcall BattleLogData___ctor_19569864(
...
void __fastcall BattleLogData__addStr(BattleLogData_o *this, System_String_o *str, const MethodInfo *method)
{
  ...
  v6 = (EventMissionProgressRequest_Argument_ProgressData_o *)System_String__Concat_44568316(this->fields.tag, str, 0LL);
  if ( !list
