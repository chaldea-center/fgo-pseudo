        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC5D3F & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_24199/*"time_status_icon_noon"*/);
    sub_1C713B0(&StringLiteral_24198/*"time_status_icon_night"*/);
    sub_1C713B0(&StringLiteral_1/*""*/);
    byte_4CC5D3F = 1;
  }
  if ( (state & 0xFFFFFFFE) == 2 )
    v4 = (System_String_o **)&StringLiteral_24198/*"time_status_icon_night"*/;
  else
    v4 = (System_String_o **)&StringLiteral_1/*""*/;
  if ( (unsigned int)state <= 1 )
    v4 = (System_String_o **)&StringLiteral_24199/*"time_status_icon_noon"*/;
  return *v4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC5D40 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_24200/*"time_status_icon_story"*/);
    sub_1C713B0(&StringLiteral_1/*""*/);
    sub_1C713B0(&StringLiteral_24196/*"time_status_icon_free"*/);
    byte_4CC5D40 = 1;
  }
  if ( (unsigned int)state > 3 )
    v4 = (System_String_o **)&StringLiteral_1/*""*/;
  else
    v4 = (System_String_o **)*(&off_46E1150 + state);
  return *v4;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC5D3E & 1) == 0 )
  {
    this = (TitleInfoEventTimeImgListViewDraw_o *)sub_1C713B0(&AtlasManager_TypeInfo);
    byte_4CC5D3E = 1;
  }
