        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD00F & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_23845/*"time_status_icon_noon"*/, *(_QWORD *)&state);
    sub_1B64870(&StringLiteral_23844/*"time_status_icon_night"*/, v4);
    sub_1B64870(&StringLiteral_1/*""*/, v5);
    byte_49FD00F = 1;
  }
  if ( (state & 0xFFFFFFFE) == 2 )
    v6 = (System_String_o **)&StringLiteral_23844/*"time_status_icon_night"*/;
  else
    v6 = (System_String_o **)&StringLiteral_1/*""*/;
  if ( (unsigned int)state <= 1 )
    v6 = (System_String_o **)&StringLiteral_23845/*"time_status_icon_noon"*/;
  return *v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD010 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_23846/*"time_status_icon_story"*/, *(_QWORD *)&state);
    sub_1B64870(&StringLiteral_1/*""*/, v4);
    sub_1B64870(&StringLiteral_23842/*"time_status_icon_free"*/, v5);
    byte_49FD010 = 1;
  }
  if ( (unsigned int)state > 3 )
    v6 = (System_String_o **)&StringLiteral_1/*""*/;
  else
    v6 = (System_String_o **)*(&off_445A7B0 + state);
  return *v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD00E & 1) == 0 )
  {
    this = (TitleInfoEventTimeImgListViewDraw_o *)sub_1B64870(&AtlasManager_TypeInfo, *(_QWORD *)&state);
    byte_49FD00E = 1;
  }
