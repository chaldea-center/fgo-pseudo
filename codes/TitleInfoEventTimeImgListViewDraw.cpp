        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35C20 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_24224/*"time_status_icon_noon"*/, *(_QWORD *)&state);
    sub_1BD3458(&StringLiteral_24223/*"time_status_icon_night"*/, v4);
    sub_1BD3458(&StringLiteral_1/*""*/, v5);
    byte_4B35C20 = 1;
  }
  if ( (state & 0xFFFFFFFE) == 2 )
    v6 = (System_String_o **)&StringLiteral_24223/*"time_status_icon_night"*/;
  else
    v6 = (System_String_o **)&StringLiteral_1/*""*/;
  if ( (unsigned int)state <= 1 )
    v6 = (System_String_o **)&StringLiteral_24224/*"time_status_icon_noon"*/;
  return *v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35C21 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_24225/*"time_status_icon_story"*/, *(_QWORD *)&state);
    sub_1BD3458(&StringLiteral_1/*""*/, v4);
    sub_1BD3458(&StringLiteral_24221/*"time_status_icon_free"*/, v5);
    byte_4B35C21 = 1;
  }
  if ( (unsigned int)state > 3 )
    v6 = (System_String_o **)&StringLiteral_1/*""*/;
  else
    v6 = (System_String_o **)*(&off_45793A8 + state);
  return *v6;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B35C1F & 1) == 0 )
  {
    this = (TitleInfoEventTimeImgListViewDraw_o *)sub_1BD3458(&AtlasManager_TypeInfo, *(_QWORD *)&state);
    byte_4B35C1F = 1;
  }
