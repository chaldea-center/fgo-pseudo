void TitleInfoEventSideItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E03361 & 1) == 0 )
  {
    ...
    sub_1CE6700(&TitleInfoEventSideItemComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_24477/*"time_status_side_04"*/);
    sub_1CE6700(&StringLiteral_24474/*"time_status_side_01"*/);
    sub_1CE6700(&StringLiteral_24476/*"time_status_side_03"*/);
    sub_1CE6700(&StringLiteral_23089/*"point_status_side"*/);
    sub_1CE6700(&StringLiteral_24475/*"time_status_side_02"*/);
    byte_4E03361 = 1;
  }
  ...
  v6 = sub_1CE67A8(string___TypeInfo, 4);
  if ( !v6 )
    sub_1CE6958(0, v7);
  v14 = v6;
  if ( !*(_DWORD *)(v6 + 24) )
    goto LABEL_9;
  v15 = StringLiteral_24474/*"time_status_side_01"*/;
  *(_QWORD *)(v6 + 32) = StringLiteral_24474/*"time_status_side_01"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v6 + 32), v15, v8, v9, v10, v11, v12, v13);
  if ( *(_DWORD *)(v14 + 24) <= 1u
    || (v22 = StringLiteral_24476/*"time_status_side_03"*/,
        *(_QWORD *)(v14 + 40) = StringLiteral_24476/*"time_status_side_03"*/,
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v14 + 40), v22, v16, v17, v18, v19, v20, v21),
        *(_DWORD *)(v14 + 24) <= 2u)
    || (v29 = StringLiteral_24475/*"time_status_side_02"*/,
        *(_QWORD *)(v14 + 48) = StringLiteral_24475/*"time_status_side_02"*/,
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v14 + 48), v29, v23, v24, v25, v26, v27, v28),
        *(_DWORD *)(v14 + 24) <= 3u) )
  {
LABEL_9:
    sub_1CE6960(v6);
  }
  v36 = StringLiteral_24477/*"time_status_side_04"*/;
  *(_QWORD *)(v14 + 56) = StringLiteral_24477/*"time_status_side_04"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v14 + 56), v36, v30, v31, v32, v33, v34, v35);
  ...
  sub_1CE66A4(
    ...
    v42,
    v43);
  v44 = StringLiteral_23089/*"point_status_side"*/;
  v45 = TitleInfoEventSideItemComponent_TypeInfo->static_fields;
  v45->POINT_STATUS_STRING = (struct System_String_o *)StringLiteral_23089/*"point_status_side"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v45->POINT_STATUS_STRING, v44, v46, v47, v48, v49, v50, v51);
}
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SafeSetParent_37166960(gameObject, v10, 0);
        ...
        const MethodInfo *method)
{
  ...
  Instance = (EventPointBuffEntity_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0335F & 1) == 0 )
  {
    ...
    sub_1CE6700(&string___TypeInfo);
    sub_1CE6700(&TitleInfoEventSideItemComponent_TypeInfo);
    sub_1CE6700(&StringLiteral_808/*"+{0:0.0}%"*/);
    sub_1CE6700(&StringLiteral_14968/*"UNIT_REST_NONE"*/);
    sub_1CE6700(&StringLiteral_25464/*"{0:#,0}"*/);
    sub_1CE6700(&StringLiteral_809/*"+{0}%"*/);
    sub_1CE6700(&StringLiteral_16775/*"_{0:00}"*/);
...
LABEL_13:
  ...
  v17 = LocalizationManager__Get((System_String_o *)StringLiteral_14968/*"UNIT_REST_NONE"*/, 0);
  v18 = (float)(int)v16;
  if ( v16 == INFINITY )
    v18 = -2147500000.0;
  v19 = v17;
  *(float *)&v76 = v16;
  if ( v16 == v18 )
  {
    ...
    v21 = (System_String_o *)StringLiteral_809/*"+{0}%"*/;
  }
  else
  {
    v20 = (Il2CppObject *)j_il2cpp_value_box_0(float_TypeInfo, &v76);
    v21 = (System_String_o *)StringLiteral_808/*"+{0:0.0}%"*/;
  }
  ...
  if ( (_DWORD)v15 )
  {
    ...
    v19 = System_String__Format((System_String_o *)StringLiteral_25464/*"{0:#,0}"*/, v23, 0);
  }
  EventPointNoGroup = sub_1CE67A8(string___TypeInfo, 3);
  if ( !EventPointNoGroup )
    goto LABEL_73;
  v30 = EventPointNoGroup;
  if ( !*(_DWORD *)(EventPointNoGroup + 24)
    || (*(_QWORD *)(EventPointNoGroup + 32) = v22,
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(EventPointNoGroup + 32), (int32_t)v22, v24, v25, v26, v27, v28, v29),
        v76 = v10,
        v31 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v76),
        EventPointNoGroup = (__int64)System_String__Format((System_String_o *)StringLiteral_25464/*"{0:#,0}"*/, v31, 0),
        *(_DWORD *)(v30 + 24) <= 1u)
    || (*(_QWORD *)(v30 + 40) = EventPointNoGroup,
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v30 + 40), EventPointNoGroup, v32, v33, v34, v35, v36, v37),
        *(_DWORD *)(v30 + 24) <= 2u) )
  {
LABEL_74:
    sub_1CE6960(EventPointNoGroup);
  }
  *(_QWORD *)(v30 + 48) = v19;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v30 + 48), (int32_t)v19, v38, v39, v40, v41, v42, v43);
  sideItems = this->fields.sideItems;
  if ( !sideItems )
LABEL_73:
    sub_1CE6958(EventPointNoGroup, v8);
  ...
  if ( (int)v45 >= 1 )
  {
    ...
    for ( i = 36; ; i += 8 )
    {
      ...
      v53 = System_String__Format((System_String_o *)StringLiteral_16775/*"_{0:00}"*/, v52, 0);
      v54 = System_String__Concat_65122828(POINT_STATUS_STRING, v53, 0);
      ...
      if ( !v68 )
        goto LABEL_73;
      EventPointNoGroup = sub_1CE683C(v56, *(_QWORD *)(*(_QWORD *)v68 + 64LL));
      if ( !EventPointNoGroup )
      {
        v75 = sub_1CE697C(0);
        sub_1CE6828(v75, 0);
      ...
      *(_QWORD *)&v68[(unsigned __int64)i / 4 - 1] = v56;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v68[(unsigned __int64)i / 4 - 1], v56, v69, v70, v71, v72, v73, v74);
      v46 += 4LL;
      ++v47;
      if ( v48 == v46 )
        return;
        ...
        const MethodInfo *method)
{
  ...
  if ( !Instance
    || (Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_32043A8 *)Method_DataManager_GetMasterData_EventPointGroupMaster___)) == 0
    ...
    if ( v15 )
    {
      ...
      if ( Instance )
      {
        ...
        if ( (v11 & 1) != 0 )
        {
          ...
          GameObjectExtensions__AddLocalPosition_37161936(v20, v19->static_fields->ADD_LAST_LABEL_POS, 0);
          Instance = (DataManager_o *)v16->fields.datalist;
          if ( !Instance )
            goto LABEL_31;
          UILabel__set_effectDistance(
        ...
        if ( datalist )
        {
          ...
          if ( v23 )
          {
            Instance = (DataManager_o *)sub_1CE683C(v16, *(_QWORD *)(*(_QWORD *)v23 + 64LL));
            if ( !Instance )
            {
              v31 = sub_1CE697C(0);
              sub_1CE6828(v31, 0);
...
LABEL_33:
            ...
            v30 = &v23[2 * v9];
            *((_QWORD *)v30 + 4) = v16;
            sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v30 + 8), (int32_t)v16, v24, v25, v26, v27, v28, v29);
            sideItems = this->fields.sideItems;
            ++v9;
            if ( sideItems )
              continue;
