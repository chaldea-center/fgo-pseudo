...
Il2CppObject *SetTargetObjectMatrix__GetRenderer_object_(
        ...
        const MethodInfo_32AC640 *method)
{
  UnityEngine_Component_o *v3; // x20

  v3 = (UnityEngine_Component_o *)this;
  if ( !method->rgctx_data )
    this = (SetTargetObjectMatrix_o *)sub_1CBC7E4();
...
void SetTargetObjectMatrix__Start(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0856A & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SetTargetObjectMatrix_GetRenderer_MeshRenderer___);
    sub_1CE6700(&Method_SetTargetObjectMatrix_GetRenderer_SkinnedMeshRenderer___);
    sub_1CE6700(&Method_SetTargetObjectMatrix_GetRenderer_SpriteRenderer___);
    byte_4E0856A = 1;
  }
...
LABEL_7:
      Renderer_object = SetTargetObjectMatrix__GetRenderer_object_(this, (const MethodInfo_32AC640 *)*v3);
      goto LABEL_8;
    case 3:
...
void SetTargetObjectMatrix__updateMatrix(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&StringLiteral_16741/*"_targetMatrix"*/);
    byte_4E0856B = 1;
  }
      ...
      if ( material )
      {
        ...
        if ( materialType == 1 )
        {
          ...
          if ( material )
          {
            ...
            {
              v8 = &v10;
              v9 = (System_String_o *)StringLiteral_16741/*"_targetMatrix"*/;
              v10 = v12;
              goto LABEL_18;
            }
          }
