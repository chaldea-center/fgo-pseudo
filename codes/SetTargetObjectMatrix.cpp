...
Il2CppObject *__fastcall SetTargetObjectMatrix__GetRenderer_object_(
        ...
        const MethodInfo_2ED6B0C *method)
{
  UnityEngine_Component_o *v3; // x20

  v3 = (UnityEngine_Component_o *)this;
  if ( !method->rgctx_data )
    this = (SetTargetObjectMatrix_o *)sub_1BB6000();
...
void __fastcall SetTargetObjectMatrix__Start(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF5DF & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___, v3);
    sub_1B640C8(&UnityEngine_Object_TypeInfo, v4);
    sub_1B640C8(&Method_SetTargetObjectMatrix_GetRenderer_MeshRenderer___, v5);
    sub_1B640C8(&Method_SetTargetObjectMatrix_GetRenderer_SkinnedMeshRenderer___, v6);
    sub_1B640C8(&Method_SetTargetObjectMatrix_GetRenderer_SpriteRenderer___, v7);
    byte_49FF5DF = 1;
  }
...
LABEL_7:
      Renderer_object = SetTargetObjectMatrix__GetRenderer_object_(this, (const MethodInfo_2ED6B0C *)*v8);
      goto LABEL_8;
    case 3:
...
void __fastcall SetTargetObjectMatrix__updateMatrix(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF5E0 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_16507/*"_targetMatrix"*/, v3);
    byte_49FF5E0 = 1;
  }
      ...
      if ( material )
      {
        ...
        if ( materialType == 1 )
        {
          ...
          if ( material )
          {
            ...
            {
              v8 = &v10;
              v9 = (System_String_o *)StringLiteral_16507/*"_targetMatrix"*/;
              v10 = v12;
              goto LABEL_18;
            }
          }
