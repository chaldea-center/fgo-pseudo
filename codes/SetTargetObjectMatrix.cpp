...
Il2CppObject *SetTargetObjectMatrix__GetRenderer_object_(
        ...
        const MethodInfo_31A13D0 *method)
{
  UnityEngine_Component_o *v3; // x20

  v3 = (UnityEngine_Component_o *)this;
  if ( !method->rgctx_data )
    this = (SetTargetObjectMatrix_o *)sub_1C8ECD4();
...
void SetTargetObjectMatrix__Start(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5A6C0 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SetTargetObjectMatrix_GetRenderer_MeshRenderer___);
    sub_1C3E564(&Method_SetTargetObjectMatrix_GetRenderer_SkinnedMeshRenderer___);
    sub_1C3E564(&Method_SetTargetObjectMatrix_GetRenderer_SpriteRenderer___);
    byte_4C5A6C0 = 1;
  }
...
LABEL_7:
      Renderer_object = SetTargetObjectMatrix__GetRenderer_object_(this, (const MethodInfo_31A13D0 *)*v3);
      goto LABEL_8;
    case 3:
...
LABEL_8:
        ...
        sub_1C3E508((CGThumbnailListItem_o *)&this->fields.targetRenderer, (int32_t)Renderer_object, v5, v6);
      }
LABEL_9:
...
void SetTargetObjectMatrix__updateMatrix(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    sub_1C3E564(&StringLiteral_16596/*"_targetMatrix"*/);
    byte_4C5A6C1 = 1;
  }
      ...
      if ( material )
      {
        ...
        if ( materialType == 1 )
        {
          ...
          if ( material )
          {
            ...
            {
              v8 = &v10;
              v9 = (System_String_o *)StringLiteral_16596/*"_targetMatrix"*/;
              v10 = v12;
              goto LABEL_18;
            }
          }
