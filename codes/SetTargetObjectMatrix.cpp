...
Il2CppObject *__fastcall SetTargetObjectMatrix__GetRenderer_object_(
        ...
        const MethodInfo_2ED8DE8 *method)
{
  UnityEngine_Component_o *v3; // x20

  v3 = (UnityEngine_Component_o *)this;
  if ( !method->rgctx_data )
    this = (SetTargetObjectMatrix_o *)sub_1BB67A8();
...
void __fastcall SetTargetObjectMatrix__Start(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A016DD & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___, v3);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v4);
    sub_1B64870(&Method_SetTargetObjectMatrix_GetRenderer_MeshRenderer___, v5);
    sub_1B64870(&Method_SetTargetObjectMatrix_GetRenderer_SkinnedMeshRenderer___, v6);
    sub_1B64870(&Method_SetTargetObjectMatrix_GetRenderer_SpriteRenderer___, v7);
    byte_4A016DD = 1;
  }
...
LABEL_7:
      Renderer_object = SetTargetObjectMatrix__GetRenderer_object_(this, (const MethodInfo_2ED8DE8 *)*v8);
      goto LABEL_8;
    case 3:
...
void __fastcall SetTargetObjectMatrix__updateMatrix(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A016DE & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_16509/*"_targetMatrix"*/, v3);
    byte_4A016DE = 1;
  }
