...
Il2CppObject *__fastcall SetTargetObjectMatrix__GetRenderer_object_(
        ...
        const MethodInfo_303F500 *method)
{
  UnityEngine_Component_o *v3; // x20

  v3 = (UnityEngine_Component_o *)this;
  if ( !method->rgctx_data )
    this = (SetTargetObjectMatrix_o *)sub_1C6CB0C();
...
void __fastcall SetTargetObjectMatrix__Start(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCAF5D & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___, v3);
    sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v4);
    sub_1C1ABD4(&Method_SetTargetObjectMatrix_GetRenderer_MeshRenderer___, v5);
    sub_1C1ABD4(&Method_SetTargetObjectMatrix_GetRenderer_SkinnedMeshRenderer___, v6);
    sub_1C1ABD4(&Method_SetTargetObjectMatrix_GetRenderer_SpriteRenderer___, v7);
    byte_4BCAF5D = 1;
  }
...
LABEL_7:
      Renderer_object = SetTargetObjectMatrix__GetRenderer_object_(this, (const MethodInfo_303F500 *)*v8);
      goto LABEL_8;
    case 3:
...
void __fastcall SetTargetObjectMatrix__updateMatrix(SetTargetObjectMatrix_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BCAF5E & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_16844/*"_targetMatrix"*/, v3);
    byte_4BCAF5E = 1;
  }
      ...
      if ( material )
      {
        ...
        if ( materialType == 1 )
        {
          ...
          if ( material )
          {
            ...
            {
              v9 = &v11;
              v10 = (System_String_o *)StringLiteral_16844/*"_targetMatrix"*/;
              v11 = v13;
              goto LABEL_18;
            }
          }
