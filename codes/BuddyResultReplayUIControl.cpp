        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v11 = DataManager__GetMaster_object_((const MethodInfo_2E39398 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    UserId = NetworkManager__get_UserId(0LL);
    if ( v11 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A003AA & 1) == 0 )
  {
    sub_1B640C8(&UnityEngine_Object_TypeInfo, onCloseCallback);
    byte_4A003AA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  SelectServantPortraitLimitCountDialog_o *v9; // x21
  ...
  if ( (byte_4A003A9 & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_BuddyResultReplayUIControl_OnSelectPortraitLimitCount__, v3);
  ...
  if ( UnityEngine_Object__op_Inequality(selectDialog, 0LL, 0LL) )
  {
    ...
    if ( buddyServantEnt )
    {
      v9 = this->fields.selectDialog;
      v10 = (System_Action_int__o *)sub_1B64314(System_Action_int__TypeInfo, v6, v7);
      ...
      if ( !v9 )
        sub_1B64324(v11);
      SelectServantPortraitLimitCountDialog__Open(v9, buddyServantEnt, v10, v12);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B6406C((ServantStatusBattleListViewItem_o *)v5, (int32_t)selectLimitCountCallback, v9, v10);
