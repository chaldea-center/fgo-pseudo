        ...
        const MethodInfo *method)
{
  ...
  if ( result )
  {
    ...
    if ( !DataManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
    v9 = DataManager__GetMaster_object_((const MethodInfo_30F9A1C *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
    if ( !NetworkManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
    if ( !byte_4C50AE2 )
    {
...
void BuddyResultReplayUIControl__OpenSelectDialog(BuddyResultReplayUIControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C51374 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_BuddyResultReplayUIControl_OnSelectPortraitLimitCount__);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C51374 = 1;
  }
  ...
  if ( UnityEngine_Object__op_Inequality(selectDialog, 0, 0) )
  {
    ...
    if ( buddyServantEnt )
    {
      ...
      v6 = (System_Action_int__o *)sub_1C3E7B0(System_Action_int__TypeInfo);
