void DetailInfoDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB57EC & 1) == 0 )
  {
    sub_1C6BA08(&DetailInfoDialog_TypeInfo);
    byte_4CB57EC = 1;
  }
...
void DetailInfoDialog__OnClickClose(DetailInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB57E9 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_DetailInfoDialog_EndClose__);
    sub_1C6BA08(&Method_DetailInfoDialog_OnClickClose__);
    byte_4CB57E9 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_DetailInfoDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C6BA20(Method_DetailInfoDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C6BA08(&System_Action_TypeInfo);
    sub_1C6BA08(&Method_DetailInfoDialog_EndOpen__);
    sub_1C6BA08(&StringLiteral_1/*""*/);
    byte_4CB57E6 = 1;
  }
...
void DetailInfoDialog__SetOverFlowName(DetailInfoDialog_o *this, bool isCondensedName, const MethodInfo *method)
{
  ...
  if ( !byte_4CAFC0E )
  {
    nameLabel = (UnityEngine_Component_o *)sub_1C6BA08(&UnityEngine_Vector3_TypeInfo);
    byte_4CAFC0E = 1;
  }
  if ( !v6 )
    goto LABEL_14;
  ...
  if ( !v7 )
LABEL_14:
    sub_1C6BC60(nameLabel, isCondensedName);
