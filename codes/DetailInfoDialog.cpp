void DetailInfoDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CC690D & 1) == 0 )
  {
    sub_1C713B0(&DetailInfoDialog_TypeInfo);
    byte_4CC690D = 1;
  }
...
void DetailInfoDialog__OnClickClose(DetailInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC690A & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DetailInfoDialog_EndClose__);
    sub_1C713B0(&Method_DetailInfoDialog_OnClickClose__);
    byte_4CC690A = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_DetailInfoDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_DetailInfoDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_DetailInfoDialog_EndOpen__);
    sub_1C713B0(&StringLiteral_1/*""*/);
    byte_4CC6907 = 1;
  }
...
void DetailInfoDialog__SetOverFlowName(DetailInfoDialog_o *this, bool isCondensedName, const MethodInfo *method)
{
  ...
  if ( !byte_4CC0D0E )
  {
    nameLabel = (UnityEngine_Component_o *)sub_1C713B0(&UnityEngine_Vector3_TypeInfo);
    byte_4CC0D0E = 1;
  }
  if ( !v6 )
    goto LABEL_14;
  ...
  if ( !v7 )
LABEL_14:
    sub_1C71608(nameLabel, isCondensedName);
