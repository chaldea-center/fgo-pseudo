void DetailInfoDialog___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E03EA7 & 1) == 0 )
  {
    sub_1CE6700(&DetailInfoDialog_TypeInfo);
    byte_4E03EA7 = 1;
  }
...
void DetailInfoDialog__OnClickClose(DetailInfoDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E03EA4 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DetailInfoDialog_EndClose__);
    sub_1CE6700(&Method_DetailInfoDialog_OnClickClose__);
    byte_4E03EA4 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_DetailInfoDialog_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_DetailInfoDialog_OnClickClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&System_Action_TypeInfo);
    sub_1CE6700(&Method_DetailInfoDialog_EndOpen__);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E03EA1 = 1;
  }
...
void DetailInfoDialog__SetOverFlowName(DetailInfoDialog_o *this, bool isCondensedName, const MethodInfo *method)
{
  ...
  if ( !byte_4DFE0AE )
  {
    nameLabel = (UnityEngine_Component_o *)sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
    byte_4DFE0AE = 1;
  }
  if ( !v6 )
    goto LABEL_14;
  ...
  if ( !v7 )
LABEL_14:
    sub_1CE6958(nameLabel, isCondensedName);
