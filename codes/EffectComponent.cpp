void EffectComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D2F8BE & 1) == 0 )
  {
    sub_1C94098(&EffectComponent_TypeInfo);
    byte_4D2F8BE = 1;
  }
...
void EffectComponent__EndLoadAsset(EffectComponent_o *this, AssetData_o *loadData, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F8BC & 1) == 0 )
  {
    this = (EffectComponent_o *)sub_1C94098(&Method_AssetData_GetObject_Texture2D____79044848);
    byte_4D2F8BC = 1;
  }
  if ( !loadData
    || (this = (EffectComponent_o *)AssetData__GetObjectNameList(loadData, 0)) == 0
    || (texture = v4->fields.texture,
        this = (EffectComponent_o *)AssetData__GetObject_object__51893132(
                                      loadData,
                                      v4->fields.filename,
                                      (const MethodInfo_317D38C *)Method_AssetData_GetObject_Texture2D____79044848),
        !texture) )
  {
    sub_1C942F0(this, loadData);
  }
...
UISprite_o *EffectComponent__GetSpriteByIndex(EffectComponent_o *this, int32_t index, const MethodInfo *method)
{
  if ( (byte_4D2F8B9 & 1) == 0 )
  {
    sub_1C94098(&Method_BasicHelper_IndexValue_UISprite___);
    byte_4D2F8B9 = 1;
  }
  return (UISprite_o *)BasicHelper__IndexValue_object_(
                         ...
                         index,
                         0,
                         (const MethodInfo_318A668 *)Method_BasicHelper_IndexValue_UISprite___);
}
...
void EffectComponent__Init(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v5; // x1
  System_Object_array *ComponentsInChildren_object__52384692; // x21
  int32_t v7; // w20
  ...
  if ( this->fields.uieffect )
  {
    ...
    if ( !gameObject )
      goto LABEL_18;
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__52384692(
                                               gameObject,
                                               (const MethodInfo_31F53B4 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UILabel___);
    if ( !((unsigned __int64)ComponentsInChildren_object__52384692 | (unsigned __int64)gameObject) )
    {
      if ( !transform )
        goto LABEL_18;
...
void EffectComponent__Start(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F8B4 & 1) == 0 )
  {
    sub_1C94098(&Method_SingletonMonoBehaviour_Spawner__getInstance__);
    byte_4D2F8B4 = 1;
  }
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&this->fields.spawner, (int32_t)v13, v2, v3, v4, v5, v6, v7);
...
void EffectComponent__replaceFigure(EffectComponent_o *this, UnityEngine_GameObject_o *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4D2F8BA & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_13806/*"Texture"*/);
    byte_4D2F8BA = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  NodeFromName = TransformHelper__getNodeFromName(transform, (System_String_o *)StringLiteral_13806/*"Texture"*/, 1, 0);
  if ( !NodeFromName )
    goto LABEL_18;
  v8 = NodeFromName;
    ...
    if ( Component_object )
    {
      ...
      if ( NodeFromName )
      {
        ...
        if ( NodeFromName )
        {
          ...
          v17.fields.z = 0.0;
          v17.fields.x = -280.0;
          UnityEngine_Transform__set_localPosition(NodeFromName, v17, 0);
          NodeFromName = UnityEngine_Component__get_transform((UnityEngine_Component_o *)Component_object, 0);
          if ( NodeFromName )
          {
            v18.fields.x = 0.0;
            v18.fields.y = 0.0;
            v18.fields.z = 0.0;
            UnityEngine_Transform__set_localEulerAngles(NodeFromName, v18, 0);
            NodeFromName = UnityEngine_Component__get_transform((UnityEngine_Component_o *)Component_object, 0);
            v10 = NodeFromName;
            if ( !byte_4D25F1E )
            {
              NodeFromName = (UnityEngine_Transform_o *)sub_1C94098(&UnityEngine_Vector3_TypeInfo);
              byte_4D25F1E = 1;
            }
            if ( v10 )
            {
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureR_o *RenderPrefab_41427348; // x0
  ...
  if ( (byte_4D2F8BB & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UnityEngine_Component_GetComponent_UITexture___);
    sub_1C94098(&Method_EffectComponent_onFigureAssetLoad__);
    sub_1C94098(&StringLiteral_13806/*"Texture"*/);
    byte_4D2F8BB = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  NodeFromName = (UnityEngine_Component_o *)TransformHelper__getNodeFromName(
                                              transform,
                                              (System_String_o *)StringLiteral_13806/*"Texture"*/,
                                              1,
                                              0);
  if ( !NodeFromName )
    goto LABEL_15;
  ...
  if ( !byte_4D25F1E )
  {
    NodeFromName = (UnityEngine_Component_o *)sub_1C94098(&UnityEngine_Vector3_TypeInfo);
    byte_4D25F1E = 1;
  }
  if ( !v29
