void EffectComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4E07A92 & 1) == 0 )
  {
    sub_1CE6700(&EffectComponent_TypeInfo);
    byte_4E07A92 = 1;
  }
...
void EffectComponent__EndLoadAsset(EffectComponent_o *this, AssetData_o *loadData, const MethodInfo *method)
{
  ...
  if ( (byte_4E07A90 & 1) == 0 )
  {
    this = (EffectComponent_o *)sub_1CE6700(&Method_AssetData_GetObject_Texture2D____79905048);
    byte_4E07A90 = 1;
  }
  if ( !loadData
    || (this = (EffectComponent_o *)AssetData__GetObjectNameList(loadData, 0)) == 0
    || (texture = v4->fields.texture,
        this = (EffectComponent_o *)AssetData__GetObject_object__52317288(
                                      loadData,
                                      v4->fields.filename,
                                      (const MethodInfo_31E4C68 *)Method_AssetData_GetObject_Texture2D____79905048),
        !texture) )
  {
    sub_1CE6958(this, loadData);
  }
...
UISprite_o *EffectComponent__GetSpriteByIndex(EffectComponent_o *this, int32_t index, const MethodInfo *method)
{
  if ( (byte_4E07A8D & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_IndexValue_UISprite___);
    byte_4E07A8D = 1;
  }
  return (UISprite_o *)BasicHelper__IndexValue_object_(
                         ...
                         index,
                         0,
                         (const MethodInfo_31F26DC *)Method_BasicHelper_IndexValue_UISprite___);
}
...
void EffectComponent__Init(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v5; // x1
  System_Object_array *ComponentsInChildren_object__52808288; // x21
  int32_t v7; // w20
  ...
  if ( this->fields.uieffect )
  {
    ...
    if ( !gameObject )
      goto LABEL_18;
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__52808288(
                                               gameObject,
                                               (const MethodInfo_325CA60 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UILabel___);
    if ( !((unsigned __int64)ComponentsInChildren_object__52808288 | (unsigned __int64)gameObject) )
    {
      if ( !transform )
        goto LABEL_18;
...
void EffectComponent__Start(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E07A88 & 1) == 0 )
  {
    sub_1CE6700(&Method_SingletonMonoBehaviour_Spawner__getInstance__);
    byte_4E07A88 = 1;
  }
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.spawner, (int32_t)v13, v2, v3, v4, v5, v6, v7);
...
void EffectComponent__replaceFigure(EffectComponent_o *this, UnityEngine_GameObject_o *obj, const MethodInfo *method)
{
  ...
  if ( (byte_4E07A8E & 1) == 0 )
  {
    ...
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&StringLiteral_13892/*"Texture"*/);
    byte_4E07A8E = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  NodeFromName = (__int64)TransformHelper__getNodeFromName(transform, (System_String_o *)StringLiteral_13892/*"Texture"*/, 1, 0);
  if ( !NodeFromName )
    goto LABEL_18;
      ...
      if ( NodeFromName )
      {
        ...
        if ( NodeFromName )
        {
          ...
          if ( NodeFromName )
          {
            ...
            if ( !byte_4DFE0AE )
            {
              NodeFromName = sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
              byte_4DFE0AE = 1;
            }
            if ( v10 )
            {
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureR_o *RenderPrefab_41818780; // x0
  ...
  if ( (byte_4E07A8F & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_UnityEngine_Component_GetComponent_UITexture___);
    sub_1CE6700(&Method_EffectComponent_onFigureAssetLoad__);
    sub_1CE6700(&StringLiteral_13892/*"Texture"*/);
    byte_4E07A8F = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0);
  NodeFromName = (UnityEngine_Component_o *)TransformHelper__getNodeFromName(
                                              transform,
                                              (System_String_o *)StringLiteral_13892/*"Texture"*/,
                                              1,
                                              0);
  if ( !NodeFromName )
    goto LABEL_15;
  ...
  if ( !byte_4DFE0AE )
  {
    NodeFromName = (UnityEngine_Component_o *)sub_1CE6700(&UnityEngine_Vector3_TypeInfo);
    byte_4DFE0AE = 1;
  }
  if ( !v29
