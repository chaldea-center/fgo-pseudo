void __fastcall EffectComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A00E98 & 1) == 0 )
  {
    sub_1B64870(&EffectComponent_TypeInfo, v1);
    byte_4A00E98 = 1;
  }
...
void __fastcall EffectComponent__EndLoadAsset(EffectComponent_o *this, AssetData_o *loadData, const MethodInfo *method)
{
  ...
  if ( (byte_4A00E96 & 1) == 0 )
  {
    this = (EffectComponent_o *)sub_1B64870(&Method_AssetData_GetObject_Texture2D____75714464, loadData);
    byte_4A00E96 = 1;
  }
  if ( !loadData
    || (this = (EffectComponent_o *)AssetData__GetObjectNameList(loadData, 0LL)) == 0LL
    || (texture = v4->fields.texture,
        this = (EffectComponent_o *)AssetData__GetObject_object__48356600(
                                      loadData,
                                      v4->fields.filename,
                                      (const MethodInfo_2E1DCF8 *)Method_AssetData_GetObject_Texture2D____75714464),
        !texture) )
  {
    sub_1B64ACC(this, loadData);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4A00E93 & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_IndexValue_UISprite___, *(_QWORD *)&index);
    byte_4A00E93 = 1;
  }
  return (UISprite_o *)BasicHelper__IndexValue_object_(
                         ...
                         index,
                         0LL,
                         (const MethodInfo_2E2A514 *)Method_BasicHelper_IndexValue_UISprite___);
}
...
void __fastcall EffectComponent__Init(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v8; // x1
  System_Object_array *ComponentsInChildren_object__48803288; // x21
  int32_t v10; // w20
  UnityEngine_Material_o *v11; // x21

  if ( (byte_4A00E8D & 1) == 0 )
  {
    sub_1B64870(&EffectComponent_TypeInfo, method);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_Renderer___, v3);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponentsInChildren_UILabel___, v4);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponentsInChildren_UISprite___, v5);
    byte_4A00E8D = 1;
  }
  if ( this->fields.uieffect )
  {
    ...
    ComponentsInChildren_object__48803288 = UnityEngine_GameObject__GetComponentsInChildren_object__48803288(
                                              gameObject,
                                              (const MethodInfo_2E8ADD8 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UISprite___);
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !gameObject )
      goto LABEL_18;
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__48803288(
                                               gameObject,
                                               (const MethodInfo_2E8ADD8 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UILabel___);
    if ( !((unsigned __int64)ComponentsInChildren_object__48803288 | (unsigned __int64)gameObject) )
    {
      if ( !transform )
        goto LABEL_18;
...
void __fastcall EffectComponent__Start(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A00E8E & 1) == 0 )
  {
    sub_1B64870(&Method_SingletonMonoBehaviour_Spawner__getInstance__, method);
    byte_4A00E8E = 1;
  }
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.spawner, (int32_t)v8, v2, v3);
  ...
  if ( (int)v14 >= 1 )
  {
    ...
    do
    {
      ...
      if ( ((unsigned __int8)v11 & 1) != 0 )
      {
        if ( !v16 )
          goto LABEL_27;
        UnityEngine_ParticleSystem__Stop_69416404((UnityEngine_ParticleSystem_o *)v16, 0LL);
      }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00E94 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UITexture___, obj);
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_UIStandFigureR___, v5);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v6);
    sub_1B64870(&StringLiteral_13587/*"Texture"*/, v7);
    byte_4A00E94 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  NodeFromName = (__int64)TransformHelper__getNodeFromName(transform, (System_String_o *)StringLiteral_13587/*"Texture"*/, 1, 0LL);
  if ( !NodeFromName )
    goto LABEL_18;
      ...
      if ( NodeFromName )
      {
        ...
        if ( NodeFromName )
        {
          ...
          if ( NodeFromName )
          {
            ...
            if ( !byte_49F9206 )
            {
              NodeFromName = sub_1B64870(&UnityEngine_Vector3_TypeInfo, v10);
              byte_49F9206 = 1;
            }
            if ( v13 )
            {
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureR_o *RenderPrefab_37612308; // x0
  ...
  if ( (byte_4A00E95 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UITexture___, v9);
    sub_1B64870(&Method_EffectComponent_onFigureAssetLoad__, v10);
    sub_1B64870(&StringLiteral_13587/*"Texture"*/, v11);
    byte_4A00E95 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  NodeFromName = (UnityEngine_Component_o *)TransformHelper__getNodeFromName(
                                              transform,
                                              (System_String_o *)StringLiteral_13587/*"Texture"*/,
                                              1,
                                              0LL);
  if ( !NodeFromName )
    goto LABEL_15;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.FigureLoadCallback, (int32_t)callback, v16, v17);
  ...
  RenderPrefab_37612308 = StandFigureManager__CreateRenderPrefab_37612308(
                            ...
                            -1,
                            0LL);
  this->fields.myStandFigure = RenderPrefab_37612308;
  p_myStandFigure = &this->fields.myStandFigure;
  sub_1B64814((ServantStatusBattleListViewItem_o *)p_myStandFigure, (int32_t)RenderPrefab_37612308, v22, v23);
  ...
  if ( !byte_49F9206 )
  {
    NodeFromName = (UnityEngine_Component_o *)sub_1B64870(&UnityEngine_Vector3_TypeInfo, v14);
    byte_49F9206 = 1;
  }
  if ( !v24
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00E92 & 1) == 0 )
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, filename);
