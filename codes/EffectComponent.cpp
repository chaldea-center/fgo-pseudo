void __fastcall EffectComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB72A8 & 1) == 0 )
  {
    sub_1C13D24(&EffectComponent_TypeInfo, v1);
    byte_4BB72A8 = 1;
  }
...
void __fastcall EffectComponent__EndLoadAsset(EffectComponent_o *this, AssetData_o *loadData, const MethodInfo *method)
{
  ...
  if ( (byte_4BB72A6 & 1) == 0 )
  {
    this = (EffectComponent_o *)sub_1C13D24(&Method_AssetData_GetObject_Texture2D____77466824, loadData);
    byte_4BB72A6 = 1;
  }
  if ( !loadData
    || (this = (EffectComponent_o *)AssetData__GetObjectNameList(loadData, 0LL)) == 0LL
    || (texture = v4->fields.texture,
        this = (EffectComponent_o *)AssetData__GetObject_object__49747248(
                                      loadData,
                                      v4->fields.filename,
                                      (const MethodInfo_2F71530 *)Method_AssetData_GetObject_Texture2D____77466824),
        !texture) )
  {
    sub_1C13F80(this, loadData);
  }
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB72A3 & 1) == 0 )
  {
    sub_1C13D24(&Method_BasicHelper_IndexValue_UISprite___, *(_QWORD *)&index);
    byte_4BB72A3 = 1;
  }
  return (UISprite_o *)BasicHelper__IndexValue_object_(
                         ...
                         index,
                         0LL,
                         (const MethodInfo_2F7E034 *)Method_BasicHelper_IndexValue_UISprite___);
}
...
void __fastcall EffectComponent__Init(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  __int64 v8; // x1
  System_Object_array *ComponentsInChildren_object__50202144; // x21
  int32_t v10; // w20
  ...
  if ( (byte_4BB729D & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_Renderer___, v3);
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponentsInChildren_UILabel___, v4);
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponentsInChildren_UISprite___, v5);
    byte_4BB729D = 1;
  }
  if ( this->fields.uieffect )
  {
    ...
    ComponentsInChildren_object__50202144 = UnityEngine_GameObject__GetComponentsInChildren_object__50202144(
                                              gameObject,
                                              (const MethodInfo_2FE0620 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UISprite___);
    gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !gameObject )
      goto LABEL_18;
    gameObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponentsInChildren_object__50202144(
                                               gameObject,
                                               (const MethodInfo_2FE0620 *)Method_UnityEngine_GameObject_GetComponentsInChildren_UILabel___);
    if ( !((unsigned __int64)ComponentsInChildren_object__50202144 | (unsigned __int64)gameObject) )
    {
      if ( !transform )
        goto LABEL_18;
...
void __fastcall EffectComponent__Start(EffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB729E & 1) == 0 )
  {
    sub_1C13D24(&Method_SingletonMonoBehaviour_Spawner__getInstance__, method);
    byte_4BB729E = 1;
  }
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.spawner, (int64_t)v13, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB72A4 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_Component_GetComponent_UITexture___, obj);
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_UIStandFigureR___, v5);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v6);
    sub_1C13D24(&StringLiteral_13888/*"TestSwitch.LocalAppContext.DisableCaching"*/, v7);
    byte_4BB72A4 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  NodeFromName = (__int64)TransformHelper__getNodeFromName(transform, (System_String_o *)StringLiteral_13888/*"TestSwitch.LocalAppContext.DisableCaching"*/, 1, 0LL);
  if ( !NodeFromName )
    goto LABEL_18;
    ...
    if ( Component_object )
    {
      ...
      if ( NodeFromName )
      {
        ...
        if ( NodeFromName )
        {
          ...
          v20.fields.z = 0.0;
          v20.fields.x = -280.0;
          UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)NodeFromName, v20, 0LL);
          NodeFromName = (__int64)UnityEngine_Component__get_transform((UnityEngine_Component_o *)Component_object, 0LL);
          if ( NodeFromName )
          {
            v21.fields.x = 0.0;
            v21.fields.y = 0.0;
            v21.fields.z = 0.0;
            UnityEngine_Transform__set_localEulerAngles((UnityEngine_Transform_o *)NodeFromName, v21, 0LL);
            ...
            if ( !byte_4BAEDA6 )
            {
              NodeFromName = sub_1C13D24(&UnityEngine_Vector3_TypeInfo, v10);
              byte_4BAEDA6 = 1;
            }
            if ( v13 )
            {
        ...
        const MethodInfo *method)
{
  ...
  struct UIStandFigureR_o *RenderPrefab_39123728; // x0
  ...
  if ( (byte_4BB72A5 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_UnityEngine_Component_GetComponent_UITexture___, v9);
    sub_1C13D24(&Method_EffectComponent_onFigureAssetLoad__, v10);
    sub_1C13D24(&StringLiteral_13888/*"TestSwitch.LocalAppContext.DisableCaching"*/, v11);
    byte_4BB72A5 = 1;
  }
  transform = UnityEngine_Component__get_transform((UnityEngine_Component_o *)this, 0LL);
  NodeFromName = (UnityEngine_Component_o *)TransformHelper__getNodeFromName(
                                              transform,
                                              (System_String_o *)StringLiteral_13888/*"TestSwitch.LocalAppContext.DisableCaching"*/,
                                              1,
                                              0LL);
  if ( !NodeFromName )
    goto LABEL_15;
  ...
  if ( !*p_myStandFigure )
    goto LABEL_15;
  NodeFromName = (UnityEngine_Component_o *)UnityEngine_Component__get_transform(NodeFromName, 0LL);
  v32 = (UnityEngine_Transform_o *)NodeFromName;
  if ( !byte_4BAEDA6 )
  {
    NodeFromName = (UnityEngine_Component_o *)sub_1C13D24(&UnityEngine_Vector3_TypeInfo, v14);
    byte_4BAEDA6 = 1;
  }
  if ( !v32
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB72A2 & 1) == 0 )
  {
    sub_1C13D24(&UnityEngine_Object_TypeInfo, filename);
