        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596E29F & 1) == 0 )
  {
    sub_2213A60(&Method_DataManager_GetMasterData_WarBoardEffectMaster___);
    sub_2213A60(&Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  ...
  if ( !layout
    || (effectId = layout->fields.effectId,
        v8 = (const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__,
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_385636C *)Method_DataManager_GetMasterData_WarBoardEffectMaster___)) == 0 )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             (const MethodInfo_3F10B30 *)Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
