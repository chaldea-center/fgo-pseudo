        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA261 & 1) == 0 )
  {
    sub_1C21E38(&Method_DataManager_GetMasterData_WarBoardEffectMaster___);
    sub_1C21E38(&Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  ...
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FAFE04 *)Method_DataManager_GetMasterData_WarBoardEffectMaster___)) == 0LL )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             (const MethodInfo_325BDC8 *)Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  this->fields.effectEntity = (struct WarBoardEffectEntity_o *)Entity;
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.effectEntity, (int64_t)Entity, v8, v9, v10, v11, v12, v13);
}
