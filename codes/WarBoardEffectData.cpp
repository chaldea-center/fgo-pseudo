        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3554A & 1) == 0 )
  {
    sub_1C32C20(&Method_DataManager_GetMasterData_WarBoardEffectMaster___);
    sub_1C32C20(&Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  ...
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_30DD3F0 *)Method_DataManager_GetMasterData_WarBoardEffectMaster___)) == 0 )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             (const MethodInfo_3396838 *)Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  this->fields.effectEntity = (struct WarBoardEffectEntity_o *)Entity;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.effectEntity, (int32_t)Entity, v7, v8);
}
