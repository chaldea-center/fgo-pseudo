        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB450 & 1) == 0 )
  {
    sub_1C2E12C(&Method_DataManager_GetMasterData_WarBoardEffectMaster___, layout);
    sub_1C2E12C(&Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__, v5);
  ...
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_2FD1830 *)Method_DataManager_GetMasterData_WarBoardEffectMaster___)) == 0LL )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             (const MethodInfo_327B180 *)Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  this->fields.effectEntity = (struct WarBoardEffectEntity_o *)Entity;
  sub_1C2E0D0((PartyOrganizationUtility_o *)&this->fields.effectEntity, (int64_t)Entity, v10, v11, v12, v13, v14, v15);
}
