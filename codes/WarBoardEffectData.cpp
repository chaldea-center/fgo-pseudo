        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC42 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataManager_GetMasterData_WarBoardEffectMaster___, layout);
    sub_1BC3008(&Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__, v5);
  ...
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_3001E64 *)Method_DataManager_GetMasterData_WarBoardEffectMaster___)) == 0LL )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             (const MethodInfo_32AF070 *)Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  this->fields.effectEntity = (struct WarBoardEffectEntity_o *)Entity;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.effectEntity, (int32_t)Entity, v10, v11);
}
