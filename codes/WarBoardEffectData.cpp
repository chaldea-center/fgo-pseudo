        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C24E75 & 1) == 0 )
  {
    sub_1C2D490(&Method_DataManager_GetMasterData_WarBoardEffectMaster___);
    sub_1C2D490(&Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  ...
  if ( !layout
    ...
    || (Instance = DataManager__GetMasterData_object_(
                     ...
                     (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_WarBoardEffectMaster___)) == 0 )
  {
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             (const MethodInfo_3387D98 *)Method_DataMasterBase_WarBoardEffectMaster__WarBoardEffectEntity__int__GetEntity__);
  this->fields.effectEntity = (struct WarBoardEffectEntity_o *)Entity;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.effectEntity, (int32_t)Entity, v8, v9);
}
