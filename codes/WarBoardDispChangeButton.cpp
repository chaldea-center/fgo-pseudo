...
void __fastcall WarBoardDispChangeButton__OnClickButton(WarBoardDispChangeButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE89 & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_WarBoardDispChangeButton_OnClickButton__, v3);
    byte_4A6DE89 = 1;
  }
  v4 = Method_WarBoardDispChangeButton_OnClickButton__;
  if ( (*((_BYTE *)Method_WarBoardDispChangeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B90028(Method_WarBoardDispChangeButton_OnClickButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6DE8B & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___, isDisp);
  ...
  if ( (*((_BYTE *)transform + 309) & 1) == 0 )
    transform = (void *)sub_1BE1EEC(transform);
  ...
  if ( !*v8
    ...
    || (transform = UnityEngine_GameObject__GetComponent_object_(
                      ...
                      (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___)) == 0LL )
  {
    sub_1B9026C(transform, isDisp);
  }
