...
void WarBoardDispChangeButton__OnClickButton(WarBoardDispChangeButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596E43C & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_WarBoardDispChangeButton_OnClickButton__);
    byte_596E43C = 1;
  }
  v3 = Method_WarBoardDispChangeButton_OnClickButton__;
  if ( (*((_BYTE *)Method_WarBoardDispChangeButton_OnClickButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_2213A78(Method_WarBoardDispChangeButton_OnClickButton__);
...
void WarBoardDispChangeButton__SetDispUIRoot(WarBoardDispChangeButton_o *this, bool isDisp, const MethodInfo *method)
{
  ...
  if ( (byte_596E43E & 1) == 0 )
  {
    sub_2213A60(&Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___);
    sub_2213A60(&Method_SingletonMonoBehaviour_WarBoardManager__getInstance__);
    byte_596E43E = 1;
  }
  ...
  if ( (*(_WORD *)((_BYTE *)transform + 309) & 1) == 0 )
    transform = (void *)sub_224B908(v3);
  ...
  if ( !*v8
    ...
    || (transform = UnityEngine_GameObject__GetComponent_object_(
                      ...
                      (const MethodInfo_38B6F40 *)Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___)) == 0 )
  {
    sub_2213CDC(transform, isDisp);
  }
