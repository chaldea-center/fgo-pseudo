...
void __fastcall WarBoardDispChangeButton__OnClickButton(WarBoardDispChangeButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B350A6 & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_WarBoardDispChangeButton_OnClickButton__, v3);
    byte_4B350A6 = 1;
  }
  v4 = Method_WarBoardDispChangeButton_OnClickButton__;
  if ( (*((_BYTE *)Method_WarBoardDispChangeButton_OnClickButton__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1BD3470(Method_WarBoardDispChangeButton_OnClickButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B350A8 & 1) == 0 )
  {
    sub_1BD3458(&Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___, isDisp);
  ...
  if ( !*v9
    ...
    || (transform = UnityEngine_GameObject__GetComponent_object_(
                      ...
                      (const MethodInfo_2F81A7C *)Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___)) == 0LL )
  {
    sub_1BD36B4(transform, isDisp);
  }
