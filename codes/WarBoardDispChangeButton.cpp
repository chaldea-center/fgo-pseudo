...
void WarBoardDispChangeButton__OnClickButton(WarBoardDispChangeButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB3FCA & 1) == 0 )
  {
    ...
    sub_1C6BA08(&Method_WarBoardDispChangeButton_OnClickButton__);
    byte_4CB3FCA = 1;
  }
  v3 = Method_WarBoardDispChangeButton_OnClickButton__;
  if ( (*((_BYTE *)Method_WarBoardDispChangeButton_OnClickButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C6BA20(Method_WarBoardDispChangeButton_OnClickButton__);
...
void WarBoardDispChangeButton__SetDispUIRoot(WarBoardDispChangeButton_o *this, bool isDisp, const MethodInfo *method)
{
  ...
  if ( (byte_4CB3FCC & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___);
    sub_1C6BA08(&Method_SingletonMonoBehaviour_WarBoardManager__getInstance__);
    byte_4CB3FCC = 1;
  }
  ...
  if ( !*v8
    ...
    || (transform = UnityEngine_GameObject__GetComponent_object_(
                      ...
                      (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_WarBoardDispChangeComponent___)) == 0 )
  {
    sub_1C6BC60(transform, isDisp);
  }
