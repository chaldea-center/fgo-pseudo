...
LABEL_21:
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mTrf, (int32_t)transform, v17, v18);
}
...
void BillBoard__UpdateBillboard(BillBoard_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(targetCamera, 0, 0) )
  {
    ...
    v17.fields.y = y;
    v17.fields.z = z;
    UnityEngine_Transform__LookAt_71292496((UnityEngine_Transform_o *)transform, v17, 0);
    if ( this->fields.enableRotationZ )
    {
      transform = (UnityEngine_Component_o *)this->fields.mTrf;
      if ( transform )
      {
        UnityEngine_Transform__Rotate_71291428((UnityEngine_Transform_o *)transform, 0.0, 0.0, v8, 0);
        return;
      }
LABEL_22:
