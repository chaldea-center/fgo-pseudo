...
bool StaffPhotoEntity__IsEnableSameSet(StaffPhotoEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C43BE3 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_18999/*"enableSameSet"*/);
    byte_4C43BE3 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.extendData, (System_String_o *)StringLiteral_18999/*"enableSameSet"*/, 0, 0) == 1;
}