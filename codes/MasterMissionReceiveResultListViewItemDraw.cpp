void __fastcall MasterMissionReceiveResultListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3A351 & 1) == 0 )
  {
    sub_1BD3458(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, v1);
    byte_4B3A351 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3A350 & 1) == 0 )
  {
    sub_1BD3458(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, message);
    byte_4B3A350 = 1;
  }
  ...
  if ( !v6 )
LABEL_8:
    sub_1BD36B4(messageLabel, message);
