void __fastcall MasterMissionReceiveResultListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0BF2C & 1) == 0 )
  {
    sub_1B686D4(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, v1);
    byte_4A0BF2C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BF2B & 1) == 0 )
  {
    sub_1B686D4(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, message);
    byte_4A0BF2B = 1;
  }
  ...
  if ( !v6 )
LABEL_8:
    sub_1B68930(messageLabel, message);
