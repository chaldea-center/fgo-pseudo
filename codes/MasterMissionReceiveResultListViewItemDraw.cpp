void __fastcall MasterMissionReceiveResultListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C00A10 & 1) == 0 )
  {
    sub_1C2E12C(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, v1);
    byte_4C00A10 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C00A0F & 1) == 0 )
  {
    sub_1C2E12C(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, message);
    byte_4C00A0F = 1;
  }
  ...
  if ( !v6 )
LABEL_8:
    sub_1C2E388(messageLabel, message);
