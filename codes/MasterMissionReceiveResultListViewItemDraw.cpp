void __fastcall MasterMissionReceiveResultListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB8E73 & 1) == 0 )
  {
    sub_1BAB41C(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, v1);
    byte_4AB8E73 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB8E72 & 1) == 0 )
  {
    sub_1BAB41C(&MasterMissionReceiveResultListViewItemDraw_TypeInfo, message);
    byte_4AB8E72 = 1;
  }
  ...
  if ( !v6 )
LABEL_8:
    sub_1BAB678(messageLabel, message);
