        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2AB4F & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2069/*"AUTO_ORGANIZATION_BTN_LABEL"*/);
    sub_1C93AD4(&StringLiteral_17586/*"btn_bg_auto_organization"*/);
    byte_4D2AB4F = 1;
  }
  ButtonBg = this->fields.ButtonBg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_41320352(eventId, ButtonBg, (System_String_o *)StringLiteral_17586/*"btn_bg_auto_organization"*/, 0);
  ButtonLb = this->fields.ButtonLb;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_2069/*"AUTO_ORGANIZATION_BTN_LABEL"*/, 0);
  if ( !ButtonLb )
    sub_1C93D2C(v9, v10);
  UILabel__set_text(ButtonLb, v9, 0);
  this->fields.onClickAction = onClickAction;
  sub_1C93A78(&this->fields.onClickAction, onClickAction);
}
