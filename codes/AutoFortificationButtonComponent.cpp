        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4355359 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_1784/*"AUTO_ORGANIZATION_BTN_LABEL"*/);
    sub_B70694(&StringLiteral_17225/*"btn_bg_auto_organization"*/);
    byte_4355359 = 1;
  }
  ButtonBg = this->fields.ButtonBg;
  if ( (BYTE3(AtlasManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0 && !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_31552376(eventId, ButtonBg, (System_String_o *)StringLiteral_17225/*"btn_bg_auto_organization"*/, method);
  ...
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_1784/*"AUTO_ORGANIZATION_BTN_LABEL"*/, 0LL);
  if ( !ButtonLb )
    sub_B7076C(v9, v10);
