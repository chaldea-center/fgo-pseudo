        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BE0503 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_2189/*"AUTO_ORGANIZATION_BTN_LABEL"*/);
    sub_1C21E38(&StringLiteral_17775/*"btn_bg_auto_organization"*/);
    byte_4BE0503 = 1;
  }
  ButtonBg = this->fields.ButtonBg;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventUI_39104396(eventId, ButtonBg, (System_String_o *)StringLiteral_17775/*"btn_bg_auto_organization"*/, 0LL);
  ButtonLb = this->fields.ButtonLb;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_2189/*"AUTO_ORGANIZATION_BTN_LABEL"*/, 0LL);
  if ( !ButtonLb )
    sub_1C22094(v9, v10);
