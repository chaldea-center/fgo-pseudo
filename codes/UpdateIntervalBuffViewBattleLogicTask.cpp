        ...
        const MethodInfo *method)
{
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.baseActData, (int32_t)actData, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B47B56 & 1) == 0 )
  {
    sub_1BDB878(&UpdateViewIntervalBuffActionData_TypeInfo, logic);
    byte_4B47B56 = 1;
  }
  baseActData = this->fields.baseActData;
  v5 = (UpdateViewIntervalBuffActionData_o *)sub_1BDBAC4(UpdateViewIntervalBuffActionData_TypeInfo);
