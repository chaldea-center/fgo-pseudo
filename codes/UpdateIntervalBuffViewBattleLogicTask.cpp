        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v4[-2].fields.isEnabled = 58;
  sub_1B71570(v4, (int32_t)actData, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2274D & 1) == 0 )
  {
    sub_1B715CC(&UpdateViewIntervalBuffActionData_TypeInfo, logic);
    byte_4A2274D = 1;
  }
  baseActData = this->fields.baseActData;
  v5 = (UpdateViewIntervalBuffActionData_o *)sub_1B71818(UpdateViewIntervalBuffActionData_TypeInfo);
