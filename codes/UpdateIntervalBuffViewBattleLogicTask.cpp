        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.baseActData, (int32_t)actData, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3AB6C & 1) == 0 )
  {
    sub_1C32C20(&UpdateViewIntervalBuffActionData_TypeInfo);
    byte_4C3AB6C = 1;
  }
  baseActData = this->fields.baseActData;
  v5 = (UpdateViewIntervalBuffActionData_o *)sub_1C32E6C(UpdateViewIntervalBuffActionData_TypeInfo);
