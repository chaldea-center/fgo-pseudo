        ...
        const MethodInfo *method)
{
  ...
  *(_DWORD *)&v4[-2].fields.isEnabled = 58;
  sub_1B88554(v4, (int32_t)actData, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5DE11 & 1) == 0 )
  {
    sub_1B885B0(&UpdateViewIntervalBuffActionData_TypeInfo);
    byte_4A5DE11 = 1;
  }
  baseActData = this->fields.baseActData;
  v5 = (UpdateViewIntervalBuffActionData_o *)sub_1B887FC(UpdateViewIntervalBuffActionData_TypeInfo);
