        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB531B & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Android_PermissionCallbacks_TypeInfo, grantedCallback);
    byte_4AB531B = 1;
  }
  v9 = (UnityEngine_Android_PermissionCallbacks_o *)sub_1BAB668(UnityEngine_Android_PermissionCallbacks_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB531A & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_AndroidJavaClass_TypeInfo, method);
    sub_1BAB41C(&Method_UnityEngine_AndroidJavaObject_Call_bool____76447032, v3);
    sub_1BAB41C(&Method_UnityEngine_AndroidJavaObject_GetStatic_AndroidJavaObject___, v4);
    sub_1BAB41C(&System_IDisposable_TypeInfo, v5);
    sub_1BAB41C(&object___TypeInfo, v6);
    sub_1BAB41C(&StringLiteral_23341/*"shouldShowRequestPermissionRationale"*/, v7);
    sub_1BAB41C(&StringLiteral_18146/*"com.unity3d.player.UnityPlayer"*/, v8);
    sub_1BAB41C(&StringLiteral_18428/*"currentActivity"*/, v9);
    byte_4AB531A = 1;
  }
  v10 = (UnityEngine_AndroidJavaClass_o *)sub_1BAB668(UnityEngine_AndroidJavaClass_TypeInfo);
  UnityEngine_AndroidJavaClass___ctor(v10, (System_String_o *)StringLiteral_18146/*"com.unity3d.player.UnityPlayer"*/, 0LL);
  if ( !v10 )
    sub_1BAB678(v11, v12);
  Static_object = UnityEngine_AndroidJavaObject__GetStatic_object_(
                    (UnityEngine_AndroidJavaObject_o *)v10,
                    (System_String_o *)StringLiteral_18428/*"currentActivity"*/,
                    (const MethodInfo_2E1DDAC *)Method_UnityEngine_AndroidJavaObject_GetStatic_AndroidJavaObject___);
  v14 = sub_1BAB4C4(object___TypeInfo, 1LL);
  v18 = v14;
  if ( !v14 )
    sub_1BAB678(0LL, v15);
  if ( permissionName )
  {
    v14 = sub_1BAB558(permissionName, *(_QWORD *)(*(_QWORD *)v14 + 64LL));
    if ( !v14 )
    {
      v31 = sub_1BAB69C(0LL);
      sub_1BAB544(v31, 0LL);
  ...
  *(_QWORD *)(v18 + 32) = permissionName;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v18 + 32), (int32_t)permissionName, v16, v17);
  if ( !Static_object )
    sub_1BAB678(v19, v20);
  v21 = UnityEngine_AndroidJavaObject__Call_bool_(
          (UnityEngine_AndroidJavaObject_o *)Static_object,
          (System_String_o *)StringLiteral_23341/*"shouldShowRequestPermissionRationale"*/,
          (System_Object_array *)v18,
          (const MethodInfo_2E1B954 *)Method_UnityEngine_AndroidJavaObject_Call_bool____76447032);
  ...
  {
LABEL_13:
    p_method = sub_1BFD3FC(Static_object, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  {
LABEL_19:
    v29 = sub_1BFD3FC(v10, System_IDisposable_TypeInfo, 0LL);
  }
