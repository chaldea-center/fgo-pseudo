        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BE24 & 1) == 0 )
  {
    sub_1C94098(&UnityEngine_Android_PermissionCallbacks_TypeInfo);
    byte_4D2BE24 = 1;
  }
  v9 = (UnityEngine_Android_PermissionCallbacks_o *)sub_1C942E4(UnityEngine_Android_PermissionCallbacks_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BE23 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_23700/*"shouldShowRequestPermissionRationale"*/);
  ...
  if ( permissionName )
  {
    v7 = sub_1C941D4(permissionName, *(_QWORD *)(*(_QWORD *)v7 + 64LL));
    if ( !v7 )
    {
      v28 = sub_1C94314(0);
      sub_1C941C0(v28, 0);
  ...
  *(_QWORD *)(v15 + 32) = permissionName;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)(v15 + 32), (int32_t)permissionName, v9, v10, v11, v12, v13, v14);
  if ( !Static_object )
    sub_1C942F0(v16, v17);
  v18 = UnityEngine_AndroidJavaObject__Call_bool_(
          (UnityEngine_AndroidJavaObject_o *)Static_object,
          (System_String_o *)StringLiteral_23700/*"shouldShowRequestPermissionRationale"*/,
  ...
  {
LABEL_13:
    v22 = sub_1C6A420(Static_object, System_IDisposable_TypeInfo, 0);
  }
  ...
  {
LABEL_19:
    v26 = sub_1C6A420(v3, System_IDisposable_TypeInfo, 0);
  }
