        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC705D & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_Android_PermissionCallbacks_TypeInfo, grantedCallback);
    byte_4BC705D = 1;
  }
  v9 = (UnityEngine_Android_PermissionCallbacks_o *)sub_1C1AE20(UnityEngine_Android_PermissionCallbacks_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC705C & 1) == 0 )
  {
    sub_1C1ABD4(&UnityEngine_AndroidJavaClass_TypeInfo, method);
    sub_1C1ABD4(&Method_UnityEngine_AndroidJavaObject_Call_bool____77539704, v3);
    sub_1C1ABD4(&Method_UnityEngine_AndroidJavaObject_GetStatic_AndroidJavaObject___, v4);
    sub_1C1ABD4(&System_IDisposable_TypeInfo, v5);
    sub_1C1ABD4(&object___TypeInfo, v6);
    sub_1C1ABD4(&StringLiteral_23709/*"shouldShowRequestPermissionRationale"*/, v7);
    sub_1C1ABD4(&StringLiteral_18410/*"com.unity3d.player.UnityPlayer"*/, v8);
    sub_1C1ABD4(&StringLiteral_18695/*"currentActivity"*/, v9);
    byte_4BC705C = 1;
  }
  v10 = (UnityEngine_AndroidJavaClass_o *)sub_1C1AE20(UnityEngine_AndroidJavaClass_TypeInfo);
  UnityEngine_AndroidJavaClass___ctor(v10, (System_String_o *)StringLiteral_18410/*"com.unity3d.player.UnityPlayer"*/, 0LL);
  if ( !v10 )
    sub_1C1AE30(v11, v12);
  Static_object = UnityEngine_AndroidJavaObject__GetStatic_object_(
                    (UnityEngine_AndroidJavaObject_o *)v10,
                    (System_String_o *)StringLiteral_18695/*"currentActivity"*/,
                    (const MethodInfo_2EF75EC *)Method_UnityEngine_AndroidJavaObject_GetStatic_AndroidJavaObject___);
  v14 = sub_1C1AC7C(object___TypeInfo, 1LL);
  v22 = v14;
  if ( !v14 )
    sub_1C1AE30(0LL, v15);
  if ( permissionName )
  {
    v14 = sub_1C1AD10(permissionName, *(_QWORD *)(*(_QWORD *)v14 + 64LL));
    if ( !v14 )
    {
      v35 = sub_1C1AE54(0LL);
      sub_1C1ACFC(v35, 0LL);
  ...
  *(_QWORD *)(v22 + 32) = permissionName;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v22 + 32), (int64_t)permissionName, v16, v17, v18, v19, v20, v21);
  if ( !Static_object )
    sub_1C1AE30(v23, v24);
  v25 = UnityEngine_AndroidJavaObject__Call_bool_(
          (UnityEngine_AndroidJavaObject_o *)Static_object,
          (System_String_o *)StringLiteral_23709/*"shouldShowRequestPermissionRationale"*/,
          (System_Object_array *)v22,
          (const MethodInfo_2EF5194 *)Method_UnityEngine_AndroidJavaObject_Call_bool____77539704);
  ...
  {
LABEL_13:
    p_method = sub_1C6CBB4(Static_object, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  {
LABEL_19:
    v33 = sub_1C6CBB4(v10, System_IDisposable_TypeInfo, 0LL);
  }
