        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DA42 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Android_PermissionCallbacks_TypeInfo, grantedCallback);
    byte_4A4DA42 = 1;
  }
  v9 = (UnityEngine_Android_PermissionCallbacks_o *)sub_1B86604(UnityEngine_Android_PermissionCallbacks_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4DA41 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_AndroidJavaClass_TypeInfo, method);
    sub_1B863B8(&Method_UnityEngine_AndroidJavaObject_Call_bool____76081936, v3);
    sub_1B863B8(&Method_UnityEngine_AndroidJavaObject_GetStatic_AndroidJavaObject___, v4);
    sub_1B863B8(&System_IDisposable_TypeInfo, v5);
    sub_1B863B8(&object___TypeInfo, v6);
    sub_1B863B8(&StringLiteral_23154/*"shouldShowRequestPermissionRationale"*/, v7);
    sub_1B863B8(&StringLiteral_17888/*"com.unity3d.player.UnityPlayer"*/, v8);
    sub_1B863B8(&StringLiteral_18172/*"currentActivity"*/, v9);
    byte_4A4DA41 = 1;
  }
  v10 = (UnityEngine_AndroidJavaClass_o *)sub_1B86604(UnityEngine_AndroidJavaClass_TypeInfo);
  UnityEngine_AndroidJavaClass___ctor(v10, (System_String_o *)StringLiteral_17888/*"com.unity3d.player.UnityPlayer"*/, 0LL);
  if ( !v10 )
    sub_1B86614(v11, v12);
  Static_object = UnityEngine_AndroidJavaObject__GetStatic_object_(
                    (UnityEngine_AndroidJavaObject_o *)v10,
                    (System_String_o *)StringLiteral_18172/*"currentActivity"*/,
                    (const MethodInfo_2EC5650 *)Method_UnityEngine_AndroidJavaObject_GetStatic_AndroidJavaObject___);
  v14 = sub_1B86460(object___TypeInfo, 1LL);
  v18 = v14;
  if ( !v14 )
    sub_1B86614(0LL, v15);
  if ( permissionName )
  {
    v14 = sub_1B864F4(permissionName, *(_QWORD *)(*(_QWORD *)v14 + 64LL));
    if ( !v14 )
    {
      v31 = sub_1B86638(0LL);
      sub_1B864E0(v31, 0LL);
  ...
  *(_QWORD *)(v18 + 32) = permissionName;
  sub_1B8635C((CGThumbnailListItem_o *)(v18 + 32), (int32_t)permissionName, v16, v17);
  if ( !Static_object )
    sub_1B86614(v19, v20);
  v21 = UnityEngine_AndroidJavaObject__Call_bool_(
          (UnityEngine_AndroidJavaObject_o *)Static_object,
          (System_String_o *)StringLiteral_23154/*"shouldShowRequestPermissionRationale"*/,
          (System_Object_array *)v18,
          (const MethodInfo_2EC31F8 *)Method_UnityEngine_AndroidJavaObject_Call_bool____76081936);
  ...
  {
LABEL_13:
    p_method = sub_1BD6B4C(Static_object, System_IDisposable_TypeInfo, 0LL);
  }
  ...
  {
LABEL_19:
    v29 = sub_1BD6B4C(v10, System_IDisposable_TypeInfo, 0LL);
  }
