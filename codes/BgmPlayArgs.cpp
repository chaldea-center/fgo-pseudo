        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F127 & 1) == 0 )
  {
    sub_1B715CC(&BgmManager_TypeInfo, bgmName);
    sub_1B715CC(&Method_System_Nullable_float__GetValueOrDefault__, v11);
    sub_1B715CC(&Method_System_Nullable_float__get_HasValue__, v12);
    byte_4A1F127 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields._BgmName_k__BackingField = bgmName;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)bgmName, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1F128 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Nullable_float__GetValueOrDefault__, volume);
    sub_1B715CC(&Method_System_Nullable_long__GetValueOrDefault__, v10);
    sub_1B715CC(&Method_System_Nullable_long__get_HasValue__, v11);
    this = (BgmPlayArgs_o *)sub_1B715CC(&Method_System_Nullable_float__get_HasValue__, v12);
    byte_4A1F128 = 1;
  }
  if ( volume.fields.hasValue )
  {
    if ( !v9 )
      ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1B71828)(this, volume);
