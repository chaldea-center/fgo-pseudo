        ...
        const MethodInfo *method)
{
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields, (int32_t)bgmName, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB5905 & 1) == 0 )
  {
    ...
    this = (BgmPlayArgs_o *)sub_1C6BA08(&Method_System_Nullable_float__get_HasValue__);
    byte_4CB5905 = 1;
  }
  if ( volume.fields.hasValue )
  {
    if ( !v9 )
      ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1C6BC60)(this, volume);
