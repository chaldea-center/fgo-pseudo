        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)bgmName, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2692E & 1) == 0 )
  {
    ...
    this = (BgmPlayArgs_o *)sub_1C2D490(&Method_System_Nullable_float__get_HasValue__);
    byte_4C2692E = 1;
  }
  if ( volume.fields.hasValue )
  {
    if ( !v9 )
      ((void (__fastcall __noreturn *)(_QWORD, _QWORD))sub_1C2D6EC)(this, volume);
