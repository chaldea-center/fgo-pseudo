...
void BattleSkillSelectBtnBaseComponent__Awake(BattleSkillSelectBtnBaseComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2A9C2 & 1) == 0 )
  {
    ...
    this = (BattleSkillSelectBtnBaseComponent_o *)sub_1C2D490(&StringLiteral_415/*"#808080"*/);
    byte_4C2A9C2 = 1;
  }
  ...
  if ( !UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_415/*"#808080"*/, &v2->fields.disableColor, 0) )
    v2->fields.disableColor = (struct UnityEngine_Color_o)xmmword_C090F0;
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v28; // x2
  System_Collections_Generic_IEnumerable_TSource__o *v29; // x8
  __int64 v30; // x22
  ...
  if ( (byte_4C2A9C3 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Array_Empty_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    sub_1C2D490(&Method_BattleSkillSelectBtnBaseComponent__InitBtn_b__9_0__);
    sub_1C2D490(&Method_UnityEngine_Component_GetComponentInChildren_UILabel___);
    sub_1C2D490(&Method_System_Linq_Enumerable_Any_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    sub_1C2D490(&Method_System_Linq_Enumerable_OfType_Dictionary_string__object____);
    sub_1C2D490(&Method_System_Linq_Enumerable_Select_Dictionary_string__object___BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    sub_1C2D490(&Method_System_Linq_Enumerable_ToArray_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    sub_1C2D490(&System_Func_Dictionary_string__object___BattleSkillSelectBtnBaseComponent_SelectBtnInfo__TypeInfo);
    sub_1C2D490(&Method_System_Collections_Generic_List_UISprite__get_Item__);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2A9C3 = 1;
  }
  this->fields.battleData = data;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.battleData, (int32_t)data, (int32_t)data, method);
  ...
  if ( !UnityEngine_Object__op_Equality(battleData, 0, 0) )
  {
    ...
    if ( !v12 )
    {
      sub_1C7DC00(Method_System_Array_Empty_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
      v12 = v11[7];
    }
    v13 = *(_QWORD *)(v12 + 16);
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selBtnArray, (int32_t)v16, v8, v9);
    if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)btnList, 0) )
    {
      v18 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_object_(
                                                                   ...
                                                                   (const MethodInfo_30FDB2C *)Method_System_Linq_Enumerable_OfType_Dictionary_string__object____);
      v19 = (System_Func_object__object__o *)sub_1C2D6DC(System_Func_Dictionary_string__object___BattleSkillSelectBtnBaseComponent_SelectBtnInfo__TypeInfo);
      ...
      v20 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__object_(
                                                                   ...
                                                                   (const MethodInfo_310501C *)Method_System_Linq_Enumerable_Select_Dictionary_string__object___BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
      v21 = System_Linq_Enumerable__ToArray_object_(
              v20,
              (const MethodInfo_310DFEC *)Method_System_Linq_Enumerable_ToArray_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
      this->fields.selBtnArray = (struct BattleSkillSelectBtnBaseComponent_SelectBtnInfo_array *)v21;
      sub_1C2D434((CGThumbnailListItem_o *)&this->fields.selBtnArray, (int32_t)v21, v22, v23);
    }
    btnTop = (System_Collections_Generic_List_object__o *)System_Linq_Enumerable__Any_object_(
                                                            *p_selBtnArray,
                                                            (const MethodInfo_30DA4C8 *)Method_System_Linq_Enumerable_Any_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    if ( ((unsigned __int8)btnTop & 1) != 0 )
    {
      ...
      {
LABEL_32:
        sub_1C2D6EC(btnTop, v25);
      }
      v27 = 0;
      while ( (__int64)v27 < SLODWORD(selBtnArray->max_length) )
      {
        ...
        if ( btnTop )
        {
          ...
          if ( btnTop )
          {
            ...
            if ( btnTop )
            {
              ...
              if ( *p_selBtnArray )
              {
                if ( v27 >= LODWORD(v29[1].monitor) )
                  sub_1C2D6F4(btnTop, v25, v28);
                btnTop = (System_Collections_Generic_List_object__o *)this->fields.btnTop;
                if ( btnTop )
                {
                  v30 = *((_QWORD *)&v29[2].klass + v27);
                  ...
                  if ( btnTop )
                  {
                    ...
                    if ( btnTop )
                    {
                      ...
                      {
                        v32 = (UnityEngine_GameObject_o *)btnTop;
                        btnTop = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A9C6 & 1) == 0 )
  {
    ...
    sub_1C2D490(&BattleSkillSelectAddFuncConfComponent_TypeInfo);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_12343/*"STAR_HIGHER"*/);
  ...
  if ( !LODWORD(v6->max_length) )
    sub_1C2D6F4(v6, v7, v9);
  v11 = v6->m_Items[0];
  if ( System_String__op_Equality(v11, (System_String_o *)StringLiteral_9269/*"NONE"*/, 0) )
    return 1;
  if ( !System_String__op_Equality(v11, (System_String_o *)StringLiteral_12343/*"STAR_HIGHER"*/, 0) )
    return 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A9C5 & 1) == 0 )
  {
    sub_1C2D490(&Method_BasicHelper_IndexValue_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    byte_4C2A9C5 = 1;
  }
  v5 = BasicHelper__IndexValue_object_(
         ...
         index,
         0,
         (const MethodInfo_30BCEF0 *)Method_BasicHelper_IndexValue_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
  if ( v5 )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A9C4 & 1) == 0 )
  {
    sub_1C2D490(&Method_BasicHelper_IndexValue_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    sub_1C2D490(&Method_System_Linq_Enumerable_Any_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___);
    sub_1C2D490(&Method_UnityEngine_GameObject_TryGetComponent_UIButton___);
    sub_1C2D490(&UnityEngine_Object_TypeInfo);
    sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C2A9C4 = 1;
  }
         ...
         (const MethodInfo_30DA4C8 *)Method_System_Linq_Enumerable_Any_BattleSkillSelectBtnBaseComponent_SelectBtnInfo___) )
  {
    ...
    if ( UnityEngine_GameObject__TryGetComponent_object_(
           obj,
           &component,
           (const MethodInfo_3127160 *)Method_UnityEngine_GameObject_TryGetComponent_UIButton___) )
    {
      v9 = component;
      a = 1.0;
      b = 1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A9C7 & 1) == 0 )
  {
    sub_1C2D490(&Method_BattleSkillSelectBtnBaseComponent_IsCondCheck__);
    sub_1C2D490(&System_Func_string__bool__TypeInfo);
    sub_1C2D490(&BattleSkillSelectBtnBaseComponent_SelectBtnInfo_TypeInfo);
    byte_4C2A9C7 = 1;
  }
  v5 = (System_Func_object__bool__o *)sub_1C2D6DC(System_Func_string__bool__TypeInfo);
  System_Func_object__bool____ctor(v5, (Il2CppObject *)this, Method_BattleSkillSelectBtnBaseComponent_IsCondCheck__, 0);
  v6 = (BattleSkillSelectBtnBaseComponent_SelectBtnInfo_o *)sub_1C2D6DC(BattleSkillSelectBtnBaseComponent_SelectBtnInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2A9C8 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_BasicHelper_GetValue_string___);
    sub_1C2D490(&Method_System_Linq_Enumerable_All_string___);
    sub_1C2D490(&Method_System_Linq_Enumerable_OfType_string___);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, v7, (int32_t)funcCondCheck, method);
  ...
  if ( btnDict )
  {
    Value_object = BasicHelper__GetValue_object_(
                     ...
                     (Il2CppObject *)StringLiteral_1/*""*/,
                     (const MethodInfo_30BC2C4 *)Method_BasicHelper_GetValue_string___);
    this->fields._Name_k__BackingField = (struct System_String_o *)Value_object;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)Value_object, v9, v10);
    v11 = BasicHelper__GetValue_object_(
            btnDict,
            (System_String_o *)StringLiteral_18204/*"conds"*/,
            0,
            (const MethodInfo_30BC2C4 *)Method_BasicHelper_GetValue_List_object____);
    v12 = BasicHelper__GetValue_object_(
            btnDict,
            (System_String_o *)StringLiteral_20270/*"image"*/,
            (Il2CppObject *)StringLiteral_1/*""*/,
            (const MethodInfo_30BC2C4 *)Method_BasicHelper_GetValue_string___);
    this->fields._ImageName_k__BackingField = (struct System_String_o *)v12;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields._ImageName_k__BackingField, (int32_t)v12, v13, v14);
    ...
    else
    {
      v16 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__OfType_object_(
                                                                   ...
                                                                   (const MethodInfo_30FDB2C *)Method_System_Linq_Enumerable_OfType_string___);
      v15 = System_Linq_Enumerable__All_object_(
              v16,
              (System_Func_TSource__bool__o *)funcCondCheck,
              (const MethodInfo_30D8E00 *)Method_System_Linq_Enumerable_All_string___);
    }
