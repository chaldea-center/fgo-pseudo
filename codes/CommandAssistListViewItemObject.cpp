        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2572 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___, method);
    byte_4BC2572 = 1;
  }
  ...
  this->fields.itemDraw = (struct CommandAssistListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                      dispObject,
                                                                      (const MethodInfo_2FEFBC0 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC2573 & 1) == 0 )
  {
    sub_1C1ABD4(&CommandAssistListViewItem_TypeInfo, item);
    byte_4BC2573 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistListViewItemDraw_o *)sub_1C1B0F0(item);
      goto LABEL_9;
    }
  }
