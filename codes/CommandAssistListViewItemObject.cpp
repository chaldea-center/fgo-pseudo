        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF1D2 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___, method);
    byte_4BAF1D2 = 1;
  }
  ...
  this->fields.itemDraw = (struct CommandAssistListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                      dispObject,
                                                                      (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BAF1D3 & 1) == 0 )
  {
    sub_1C13D24(&CommandAssistListViewItem_TypeInfo, item);
    byte_4BAF1D3 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistListViewItemDraw_o *)sub_1C14240(item);
      goto LABEL_9;
    }
  }
