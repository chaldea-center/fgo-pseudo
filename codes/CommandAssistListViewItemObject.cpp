        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03D26 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___, method);
    byte_4A03D26 = 1;
  }
  ...
  this->fields.itemDraw = (struct CommandAssistListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                      dispObject,
                                                                      (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A03D27 & 1) == 0 )
  {
    sub_1B686D4(&CommandAssistListViewItem_TypeInfo, item);
    byte_4A03D27 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistListViewItemDraw_o *)sub_1B68BF0(item);
      goto LABEL_9;
    }
  }
