        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF81C2 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___, method);
    byte_4BF81C2 = 1;
  }
  ...
  this->fields.itemDraw = (struct CommandAssistListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                      dispObject,
                                                                      (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF81C3 & 1) == 0 )
  {
    sub_1C2E12C(&CommandAssistListViewItem_TypeInfo, item);
    byte_4BF81C3 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistListViewItemDraw_o *)sub_1C2E648(item);
      goto LABEL_9;
    }
  }
