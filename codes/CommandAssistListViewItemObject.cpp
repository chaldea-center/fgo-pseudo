        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0081 & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
    byte_42B0081 = 1;
  }
  ...
  Component_srcLineSprite = (struct CommandAssistListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                        dispObject,
                                                                        (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistListViewItemDraw_o *)sub_B52D50(item);
      goto LABEL_9;
    }
  }
