        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8B62 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42E8B62 = 1;
  }
  ...
  Component_srcLineSprite = (struct CommandAssistListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                        dispObject,
                                                                        (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8B63 & 1) == 0 )
  {
    sub_B5D5C4(&CommandAssistListViewItem_TypeInfo, (_DWORD)item, (_DWORD)seed, method);
    byte_42E8B63 = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistListViewItemDraw_o *)sub_B5D990(item);
      goto LABEL_9;
    }
  }
