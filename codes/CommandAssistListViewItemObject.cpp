        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42147B9 & 1) == 0 )
  {
    sub_B0D8A4(&Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___, method);
    byte_42147B9 = 1;
  }
  ...
  Component_srcLineSprite = (struct CommandAssistListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                        dispObject,
                                                                        (const MethodInfo_1B62BA8 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42147BA & 1) == 0 )
  {
    sub_B0D8A4(&CommandAssistListViewItem_TypeInfo, item);
    byte_42147BA = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    v9 = *(&CommandAssistListViewItem_TypeInfo->_2.bitflags2 + 1);
    if ( *(&item->klass->_2.bitflags2 + 1) < (unsigned int)v9
      || (CommandAssistListViewItem_c *)item->klass->_2.typeHierarchy[v9 - 1] != CommandAssistListViewItem_TypeInfo )
    {
      itemDraw = (CommandAssistListViewItemDraw_o *)sub_B0DC70(item);
      goto LABEL_9;
    }
  }
