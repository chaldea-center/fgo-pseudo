        ...
        const MethodInfo *method)
{
  if ( (byte_4BC847C & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&relationSvtId);
    byte_4BC847C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v11.fields.fakeValue = v3;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47556128(v11, 0LL);
