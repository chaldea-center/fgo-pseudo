        ...
        const MethodInfo *method)
{
  if ( (byte_4C2295F & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&relationSvtId);
    byte_4C2295F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v11.fields.fakeValue = v3;
  v5 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47882560(v11, 0LL);
