void MapFogData___ctor(MapFogData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0145F & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_16377/*"_FogColor"*/);
    byte_4E0145F = 1;
  }
  v9 = StringLiteral_16377/*"_FogColor"*/;
  this->fields.propertyName = (struct System_String_o *)StringLiteral_16377/*"_FogColor"*/;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.propertyName, v9, v2, v3, v4, v5, v6, v7);
...
void MapFogData__SetRenderer(MapFogData_o *this, UnityEngine_Renderer_o *setRenderer, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)setRenderer, (int32_t)method, v3, v4, v5, v6, v7);
}
...
LABEL_12:
    sub_1CE6958(renderer, v6);
  Color = UnityEngine_Material__GetColor((UnityEngine_Material_o *)renderer, this->fields.propertyName, 0);
  *(_QWORD *)&retstr->fields.hasValue = 0;
  *(_QWORD *)&retstr->fields.value.fields.g = 0;
  retstr->fields.value.fields.a = 0.0;
  System_Nullable_Color____ctor(retstr, Color, (const MethodInfo_3A2AED4 *)Method_System_Nullable_Color___ctor__);
  return result;
}
