void MapFogData___ctor(MapFogData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596D0EF & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_16875/*"_FogColor"*/);
    byte_596D0EF = 1;
  }
  v9 = StringLiteral_16875/*"_FogColor"*/;
  this->fields.propertyName = (struct System_String_o *)StringLiteral_16875/*"_FogColor"*/;
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.propertyName, v9, v2, v3, v4, v5, v6, v7);
...
LABEL_12:
    sub_2213CDC(renderer, v6);
  Color = UnityEngine_Material__GetColor((UnityEngine_Material_o *)renderer, this->fields.propertyName, 0);
  *(_QWORD *)&retstr->fields.hasValue = 0;
  *(_QWORD *)&retstr->fields.value.fields.g = 0;
  retstr->fields.value.fields.a = 0.0;
  System_Nullable_Color____ctor(retstr, Color, (const MethodInfo_45E1964 *)Method_System_Nullable_Color___ctor__);
  return result;
}
