void __fastcall MapFogData___ctor(MapFogData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB13F7 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_16478/*"_FaceTexOffset"*/, method);
    byte_4BB13F7 = 1;
  }
  v9 = StringLiteral_16478/*"_FaceTexOffset"*/;
  this->fields.propertyName = (struct System_String_o *)StringLiteral_16478/*"_FaceTexOffset"*/;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.propertyName, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields, (int64_t)setRenderer, (int64_t)method, v3, v4, v5, v6, v7);
}
...
LABEL_12:
    sub_1C13F80(renderer, v7);
  Color = UnityEngine_Material__GetColor((UnityEngine_Material_o *)renderer, this->fields.propertyName, 0LL);
  *(_QWORD *)&retstr->fields.hasValue = 0LL;
  *(_QWORD *)&retstr->fields.value.fields.g = 0LL;
  retstr->fields.value.fields.a = 0.0;
  System_Nullable_Color____ctor(retstr, Color, (const MethodInfo_374653C *)Method_System_Nullable_Color___ctor__);
  return result;
}
