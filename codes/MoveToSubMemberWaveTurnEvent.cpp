void MoveToSubMemberWaveTurnEvent___ctor_47094580(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C46276 & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1C37058(&MoveToSubMemberWaveTurnEvent_TypeInfo);
    byte_4C46276 = 1;
  }
  if ( !v2 )
    sub_1C372B4(saveData);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1C372A4(MoveToSubMemberWaveTurnEvent_TypeInfo);
