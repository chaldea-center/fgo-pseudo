void MoveToSubMemberWaveTurnEvent___ctor_47794900(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF1A81 & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1C7BAE8(&MoveToSubMemberWaveTurnEvent_TypeInfo);
    byte_4CF1A81 = 1;
  }
  if ( !v2 )
    sub_1C7BD40(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1C7BD34(MoveToSubMemberWaveTurnEvent_TypeInfo);
