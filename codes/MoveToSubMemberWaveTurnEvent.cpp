void MoveToSubMemberWaveTurnEvent___ctor_47453768(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CCA77F & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1C713B0(&MoveToSubMemberWaveTurnEvent_TypeInfo);
    byte_4CCA77F = 1;
  }
  if ( !v2 )
    sub_1C71608(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1C715FC(MoveToSubMemberWaveTurnEvent_TypeInfo);
