void __fastcall MoveToSubMemberWaveTurnEvent___ctor_44524508(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B39F16 & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1BD3458(&MoveToSubMemberWaveTurnEvent_TypeInfo, method);
    byte_4B39F16 = 1;
  }
  if ( !v2 )
    sub_1BD36B4(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1BD36A4(MoveToSubMemberWaveTurnEvent_TypeInfo);
