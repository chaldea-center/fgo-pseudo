void __fastcall MoveToSubMemberWaveTurnEvent___ctor_46007656(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1F5BA & 1) == 0 )
  {
    saveData = (ServantWaveTurnEvent_SaveData_o *)sub_1BCAFF8(&MoveToSubMemberWaveTurnEvent_TypeInfo, method);
    byte_4B1F5BA = 1;
  }
  if ( !v2 )
    sub_1BCB254(saveData, method);
  v3 = *(Il2CppClass **)&v2->fields.Wave;
  v4 = (Il2CppObject *)sub_1BCB244(MoveToSubMemberWaveTurnEvent_TypeInfo);
