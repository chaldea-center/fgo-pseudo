void __fastcall UserQuestRecordMaster___ctor(UserQuestRecordMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C22DB1 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataMasterBase_UserQuestRecordMaster__UserQuestRecordEntity__string___ctor__, method);
    byte_4C22DB1 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    64,
    (const MethodInfo_329D5DC *)Method_DataMasterBase_UserQuestRecordMaster__UserQuestRecordEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22DAF & 1) == 0 )
  {
    sub_1C3B764(&Method_DataMasterBase_UserQuestRecordMaster__UserQuestRecordEntity__string__GetEntity__, userId);
    sub_1C3B764(&UserQuestRecordEntity_TypeInfo, v9);
    byte_4C22DAF = 1;
  }
  ...
  return (UserQuestRecordEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                      (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                      PK,
                                      (const MethodInfo_329F900 *)Method_DataMasterBase_UserQuestRecordMaster__UserQuestRecordEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22DB3 & 1) == 0 )
  {
    this = (UserQuestRecordMaster_o *)sub_1C3B764(&UserQuestRecordEntity_TypeInfo, userId);
    byte_4C22DB3 = 1;
  }
  entity = 0LL;
  if ( !knockdownInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22DB2 & 1) == 0 )
  {
    sub_1C3B764(&UserQuestRecordEntity_TypeInfo, userId);
    byte_4C22DB2 = 1;
  }
  entity = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22DB0 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataMasterBase_UserQuestRecordMaster__UserQuestRecordEntity__string__TryGetEntity__, entity);
    sub_1C3B764(&UserQuestRecordEntity_TypeInfo, v11);
    byte_4C22DB0 = 1;
  }
  if ( !UserQuestRecordEntity_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UserQuestRecordEntity_TypeInfo);
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_329F94C *)Method_DataMasterBase_UserQuestRecordMaster__UserQuestRecordEntity__string__TryGetEntity__);
}