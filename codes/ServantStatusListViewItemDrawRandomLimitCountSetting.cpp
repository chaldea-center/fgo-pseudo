        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.MASK_SIZE_ALL.fields.y = xmmword_328E670;
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)Component_WebViewObject & 1) != 0 )
  {
    ...
    if ( !Component_WebViewObject )
      goto LABEL_43;
    v10 = &StringLiteral_17084/*"btn_bg_21"*/;
    if ( !isSelectedButton )
      v10 = &StringLiteral_17083/*"btn_bg_20"*/;
...
LABEL_43:
      sub_B52A5C(Component_WebViewObject, v9);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&LocalizationManager_TypeInfo);
    sub_B52984(&StringLiteral_12111/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_OWN"*/);
    sub_B52984(&StringLiteral_12112/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_OWN_EXPLANATION"*/);
    sub_B52984(&StringLiteral_12115/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_SUPPORT"*/);
    sub_B52984(&StringLiteral_12116/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_SUPPORT_EXPLANATION"*/);
    byte_42B4267 = 1;
  }
  if ( item )
  {
    ...
    v7 = LocalizationManager__Get((System_String_o *)StringLiteral_12111/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_OWN"*/, 0LL);
    v8 = LocalizationManager__Get((System_String_o *)StringLiteral_12112/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_OWN_EXPLANATION"*/, 0LL);
    ...
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_12115/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_SUPPORT"*/, 0LL);
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_12116/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_SUPPORT_EXPLANATION"*/, 0LL);
    ServantStatusListViewItemDrawRandomLimitCountSetting__SetupCategoryInfo(
      this,
      supportServantInfo,
      v15,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B4268 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_12114/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_RANDOM_ON_BUTTON"*/);
    sub_B52984(&StringLiteral_12109/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_All_ON_BUTTON"*/);
    sub_B52984(&StringLiteral_12113/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_RANDOM_OFF_BUTTON"*/);
    sub_B52984(&StringLiteral_1/*""*/);
    this = (ServantStatusListViewItemDrawRandomLimitCountSetting_o *)sub_B52984(&StringLiteral_12108/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_All_OFF_BUTTON"*/);
    byte_42B4268 = 1;
  }
  if ( !target )
    goto LABEL_51;
  ...
  if ( !UnityEngine_Object__op_Equality(NameTxt, 0LL, 0LL) )
  {
    ...
    if ( v11->fields.myServantInfo == target )
    {
      ...
      if ( OptionManager__GetRandomLimitCountOwn(0LL) )
      {
        ...
        v16 = &StringLiteral_12109/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_All_ON_BUTTON"*/;
      }
      else
      {
        if ( (WORD1(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
        ...
        v16 = &StringLiteral_12108/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_All_OFF_BUTTON"*/;
      }
    ...
    if ( v11->fields.supportServantInfo == target )
    {
      ...
      if ( OptionManager__GetRandomLimitCountFriend(0LL) )
      {
        ...
        v17 = &StringLiteral_12109/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_All_ON_BUTTON"*/;
      }
      else
      {
        if ( (WORD1(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 0x400) != 0
        ...
        v17 = &StringLiteral_12108/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_All_OFF_BUTTON"*/;
      }
    ...
    v19 = LocalizationManager__Get((System_String_o *)StringLiteral_12114/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_RANDOM_ON_BUTTON"*/, 0LL);
    ServantStatusListViewItemDrawRandomLimitCountSetting__SetButtonText(
    ...
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_12113/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_RANDOM_OFF_BUTTON"*/, 0LL);
    ServantStatusListViewItemDrawRandomLimitCountSetting__SetButtonText(
        ...
        const MethodInfo *method)
{
  ...
  if ( item )
  {
    ...
    *(_QWORD *)&v10.fields.fakeValue = v6;
    if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_44786420(v10, 0LL) )
    {
      v8 = this;
      v9 = 0;
    }
...
LABEL_10:
    ...
    ServantStatusListViewItemDrawRandomLimitCountSetting__SetupMask_33190692(v8, v9, method);
  }
}


// local variable allocation has failed, the output may be wrong!
void __fastcall ServantStatusListViewItemDrawRandomLimitCountSetting__SetupMask_33190692(
        ServantStatusListViewItemDrawRandomLimitCountSetting_o *this,
        int32_t maskType,
        const MethodInfo *method)
{
  ...
  if ( (byte_42B426B & 1) == 0 )
  {
    ...
    this = (ServantStatusListViewItemDrawRandomLimitCountSetting_o *)sub_B52984(&StringLiteral_12110/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_INFO_COMBINE"*/);
    byte_42B426B = 1;
  }
      ...
      if ( this )
      {
        ...
        if ( this )
        {
          ...
          if ( maskType == 1 )
          {
            ...
            Empty = LocalizationManager__Get((System_String_o *)StringLiteral_12110/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_SETTING_INFO_COMBINE"*/, 0LL);
          }
          this = (ServantStatusListViewItemDrawRandomLimitCountSetting_o *)v4->fields.maskSprite;
          if ( this )
          {
            ...
            if ( this )
            {
              ...
              if ( this )
              {
                ...
                if ( this )
                {
                  ...
                  v27.fields.x = v16;
                  v27.fields.y = v17;
                  GameObjectExtensions__SetLocalPosition_32084952(gameObject, v27, 0LL);
                  this = (ServantStatusListViewItemDrawRandomLimitCountSetting_o *)v4->fields.informationLabel;
                  if ( this )
                  {
                    ...
                    v28.fields.x = v20;
                    v28.fields.y = v21;
                    GameObjectExtensions__SetLocalPosition_32084952(v26, v28, 0LL);
                    this = (ServantStatusListViewItemDrawRandomLimitCountSetting_o *)v4->fields.informationLabel;
                    if ( this )
                    {
...
LABEL_32:
    sub_B52A5C(this, *(_QWORD *)&maskType);
  }
