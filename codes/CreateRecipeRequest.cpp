        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6849B & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_22496/*"num"*/, *(_QWORD *)&recipeId);
    sub_1BE4ACC(&StringLiteral_23130/*"recipeId"*/, v7);
    byte_4B6849B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23130/*"recipeId"*/, recipeId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22496/*"num"*/, createNum, v8);
...
System_String_o *__fastcall CreateRecipeRequest__getURL(CreateRecipeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6849A & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_19367/*"event/createRecipe"*/, v2);
    byte_4B6849A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_19367/*"event/createRecipe"*/, 0LL);
}
