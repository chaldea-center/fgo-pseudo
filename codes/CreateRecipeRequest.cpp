        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDDE60 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_23222/*"recipeId"*/);
    byte_4BDDE60 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23222/*"recipeId"*/, recipeId, method);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_22585/*"num"*/, createNum, v7);
...
System_String_o *__fastcall CreateRecipeRequest__getURL(CreateRecipeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDE5F & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_19440/*"event/createRecipe"*/);
    byte_4BDDE5F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_19440/*"event/createRecipe"*/, 0LL);
}
