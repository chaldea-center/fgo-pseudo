        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FBDF6 & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_21083/*"num"*/, *(_QWORD *)&recipeId);
    sub_B16FFC(&StringLiteral_21628/*"recipeId"*/, v7);
    byte_40FBDF6 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21628/*"recipeId"*/, recipeId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21083/*"num"*/, createNum, 0LL);
...
System_String_o *__fastcall CreateRecipeRequest__getURL(CreateRecipeRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_40FBDF5 & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_18385/*"event/createRecipe"*/, v2);
    byte_40FBDF5 = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_18385/*"event/createRecipe"*/, 0LL);
}
