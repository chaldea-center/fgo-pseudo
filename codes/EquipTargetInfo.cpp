...
void EquipTargetInfo___ctor_41488284(
        ...
        const MethodInfo *method)
{
  ...
  if ( equipTargetInfo )
  {
    ...
    *(_QWORD *)&this->fields.skillLv1 = *(_QWORD *)&equipTargetInfo->fields.skillLv1;
    ...
    sub_1C2D434(p_addSkills, (int32_t)addSkills, v5, v6);
    p_addSkills->monitor = (void *)equipTargetInfo->fields.updatedAt;
  }
}


void EquipTargetInfo___ctor_41488412(
        EquipTargetInfo_o *this,
        int32_t svtId,
        int32_t limitCnt,
        int32_t level,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26E1B & 1) == 0 )
  {
    sub_1C2D490(&AddSkillInfoData_TypeInfo);
    ...
    sub_1C2D490(&EquipTargetInfo_TypeInfo);
    sub_1C2D490(&Method_System_Collections_Generic_List_AddSkillInfoData__Add__);
    sub_1C2D490(&Method_System_Collections_Generic_List_AddSkillInfoData__ToArray__);
    sub_1C2D490(&Method_System_Collections_Generic_List_AddSkillInfoData___ctor__);
    sub_1C2D490(&System_Collections_Generic_List_AddSkillInfoData__TypeInfo);
  ...
  v14 = *(_OWORD *)&v52[0].fields.currentCryptoKey;
  v52[1] = v52[0];
...
LABEL_34:
  ...
  *(_QWORD *)&v53.fields.fakeValue = v29;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v53, 0);
  if ( !v31 )
    goto LABEL_71;
  ...
  if ( v33 <= 2 )
LABEL_72:
    sub_1C2D6F4(Instance, v12, v32);
  v37 = *((_QWORD *)Instance + 6);
  if ( v37 )
    LODWORD(v37) = *(_DWORD *)(v37 + 28);
  this->fields.skillId3 = v37;
  v38 = (System_Collections_Generic_List_object__o *)sub_1C2D6DC(System_Collections_Generic_List_AddSkillInfoData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v38,
    (const MethodInfo_3789350 *)Method_System_Collections_Generic_List_AddSkillInfoData___ctor__);
  for ( i = 7; ; ++i )
  {
    ...
    if ( (__int64)v41 >= *(int *)(*((_QWORD *)Instance + 23) + 56LL) )
      break;
    if ( v41 >= *((unsigned int *)v34 + 6) )
      goto LABEL_72;
    if ( v34[i] )
    {
      v42 = (AddSkillInfoData_o *)sub_1C2D6DC(AddSkillInfoData_TypeInfo);
      AddSkillInfoData___ctor(v42, 0);
      if ( v41 >= *((unsigned int *)v34 + 6) )
        goto LABEL_72;
      v44 = v34[i];
      if ( !v44 )
      ...
      if ( !v42 )
        goto LABEL_71;
      v42->fields.num = *(_DWORD *)(v44 + 20);
      v42->fields.skillId = *(_DWORD *)(v44 + 28);
      if ( !v38 )
        goto LABEL_71;
      ...
      else
      {
        ...
        sub_1C2D434((CGThumbnailListItem_o *)(v48 + 4), (int32_t)v42, v32, v43);
      }
    }
  }
  if ( v38 )
  {
    v49 = System_Collections_Generic_List_object___ToArray(
            v38,
            (const MethodInfo_378B6DC *)Method_System_Collections_Generic_List_AddSkillInfoData__ToArray__);
    v50 = (int)v49;
  ...
  sub_1C2D434((CGThumbnailListItem_o *)p_addSkills, v50, v32, v39);
  ...
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v16, 0) >= 1 )
  {
    ...
    while ( 1 )
    {
      *(_QWORD *)&v9 = BalanceConfig_TypeInfo;
      ...
      if ( (__int64)v12 >= *(int *)(*(_QWORD *)(v9 + 184) + 56LL) )
        break;
      if ( !SkillIdList )
        goto LABEL_26;
      if ( v12 >= LODWORD(SkillIdList->max_length) )
        goto LABEL_27;
      *((_QWORD *)&v9 + 1) = (unsigned int)SkillIdList->m_Items[v12];
      if ( SDWORD2(v9) >= 1 )
      {
        if ( !SkillLevelList )
          goto LABEL_26;
        if ( v12 >= LODWORD(SkillLevelList->max_length) )
LABEL_27:
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v28.fields.fakeValue = v9;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v28, 0) < 1 )
    return 0;
...
LABEL_23:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    v20 = *(int *)(*(_QWORD *)&Instance[1].fields._DispLog + 56LL);
    v21 = (__int64)i < v20;
    if ( (__int64)i >= v20 )
      break;
    if ( !SkillIdList )
...
bool EquipTargetInfo__getEventUpVal_41492528(
        EquipTargetInfo_o *this,
...
LABEL_26:
      ...
      if ( Entity )
      {
        if ( SkillLvEntity__getEventUpVal_42665704(Entity, eventUpVallInfo, 1, 0, v20, 0, 0, 0) )
          v19 = 1;
      }
    }
    ++v18;
...
int32_t EquipTargetInfo__getLevelMax(EquipTargetInfo_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v12.fields.fakeValue = v3;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v12, 0) < 1 )
    return 0;
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_13;
  ...
  *(_QWORD *)&v13.fields.fakeValue = v8;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v13, 0);
...
LABEL_23:
  ...
  if ( addSkills )
  {
    v10 = 0;
    v11 = 0x300000000LL;
    while ( (__int64)v10 < SLODWORD(addSkills->max_length) )
    {
      ...
      addSkills = this->fields.addSkills;
      if ( v4->static_fields->SvtEquipSkillListMax > (int)v10 + 3 )
      {
        if ( !addSkills )
          goto LABEL_21;
        if ( v10 >= LODWORD(addSkills->max_length) )
          goto LABEL_23;
        v12 = addSkills->m_Items[v10];
        if ( !v12 )
          goto LABEL_21;
        if ( v10 + 3 >= LODWORD(v8->_1.namespaze) )
          goto LABEL_23;
        *(_DWORD *)((char *)&v8->_1.byval_arg.data + (v11 >> 30)) = v12->fields.skillId;
      }
      ++v10;
      v11 += 0x100000000LL;
      if ( !addSkills )
...
void EquipTargetInfo__getSkillInfo(EquipTargetInfo_o *this, SkillInfo_array **skillInfoList, const MethodInfo *method)
{
  ...
  v5 = (SkillInfo_array *)sub_1C2D538(SkillInfo___TypeInfo, (unsigned int)v4->static_fields->SvtEquipSkillListMax);
  *skillInfoList = v5;
  sub_1C2D434((CGThumbnailListItem_o *)skillInfoList, (int32_t)v5, v6, v7);
  v9 = *(_QWORD *)&this->fields.svtId.fields.currentCryptoKey;
  v8 = *(_QWORD *)&this->fields.svtId.fields.fakeValue;
  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
  ...
  *(_QWORD *)&v39.fields.fakeValue = v8;
  if ( CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v39, 0) >= 1 )
  {
...
LABEL_32:
    ...
    while ( 1 )
    {
      ...
      if ( (__int64)v21 >= v14->static_fields->SvtEquipSkillListMax )
        break;
      if ( !SkillIdList )
        goto LABEL_32;
      if ( v21 >= LODWORD(SkillIdList->max_length) )
LABEL_33:
        sub_1C2D6F4(v14, v10, v19);
      v10 = (unsigned int)m_Items[v21];
      if ( (int)v10 >= 1 )
      {
        if ( !MasterData_object )
          goto LABEL_32;
        ...
        if ( Entity )
        {
          ...
          v26 = sub_1C2D6DC(SkillInfo_TypeInfo);
          SkillInfo___ctor((SkillInfo_o *)v26, 0);
          if ( v21 >= LODWORD(SkillIdList->max_length) )
            goto LABEL_33;
          if ( !v26 )
            goto LABEL_32;
          *(_DWORD *)(v26 + 16) = m_Items[v21];
          if ( !SkillLevelList )
            goto LABEL_32;
          if ( v21 >= LODWORD(SkillLevelList->max_length) )
            goto LABEL_33;
          v27 = SkillLevelList->m_Items[v21];
          *(_DWORD *)(v26 + 20) = v27;
          *(_DWORD *)(v26 + 24) = SkillEntity__getEffectChargeTurn(v25, v27, 0);
          EffectTitle = SkillEntity__getEffectTitle(v25, 0, 0);
          *(_QWORD *)(v26 + 32) = EffectTitle;
          sub_1C2D434((CGThumbnailListItem_o *)(v26 + 32), (int32_t)EffectTitle, v29, v30);
          EffectExplanation = SkillEntity__getEffectExplanation(v25, *(_DWORD *)(v26 + 20), 0);
          *(_QWORD *)(v26 + 40) = EffectExplanation;
          sub_1C2D434((CGThumbnailListItem_o *)(v26 + 40), (int32_t)EffectExplanation, v32, v33);
          *(_BYTE *)(v26 + 56) = 1;
          v34 = *skillInfoList;
          if ( !*skillInfoList )
            goto LABEL_32;
          v14 = (BalanceConfig_c *)sub_1C2D5CC(v26, v34->obj.klass->_1.element_class);
          if ( !v14 )
          {
            v37 = sub_1C2D710(0);
            sub_1C2D5B8(v37, 0);
          ...
          if ( v22 >= LODWORD(v34->max_length) )
            goto LABEL_33;
          v36 = &v34->obj.klass + (int)v22;
          v36[4] = (Il2CppClass *)v26;
          sub_1C2D434((CGThumbnailListItem_o *)(v36 + 4), v26, v19, v35);
          ++v22;
        }
      }
      ++v21;
...
LABEL_20:
  ...
  if ( addSkills )
  {
    v10 = 0;
    v11 = 0x300000000LL;
    while ( v10 < SLODWORD(addSkills->max_length) )
    {
      v4 = BalanceConfig_TypeInfo;
      if ( !BalanceConfig_TypeInfo->_2.cctor_finished )
      {
      ...
      if ( v4->static_fields->SvtEquipSkillListMax > (int)v10 + 3 )
      {
        if ( v10 + 3 >= (unsigned __int64)LODWORD(v8->_1.namespaze) )
          goto LABEL_20;
        *(_DWORD *)((char *)&v8->_1.byval_arg.data + (v11 >> 30)) = 1;
      }
      addSkills = this->fields.addSkills;
      v11 += 0x100000000LL;
      ++v10;
