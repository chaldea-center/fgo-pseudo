        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28824 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_EventInfoProductivityGrowthDialog_OnClickCloseButton__);
    sub_1C2D490(&Method_EventInfoProductivityGrowthDialog__OnClickCloseButton_b__17_0__);
    byte_4C28824 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoProductivityGrowthDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C2D4A8(Method_EventInfoProductivityGrowthDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28823 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_5571/*"EVENT_CONQUEST_UP_MESSAGE"*/);
    sub_1C2D490(&StringLiteral_5570/*"EVENT_CONQUEST_UP_ITEM_FORMAT"*/);
    sub_1C2D490(&StringLiteral_5569/*"EVENT_CONQUEST_UP_ITEM_ADD_FORMAT"*/);
    sub_1C2D490(&StringLiteral_5572/*"EVENT_CONQUEST_UP_TITLE"*/);
    byte_4C28823 = 1;
  }
...
LABEL_64:
        ...
        v16 = sub_1C2D6DC(GiftEntity_TypeInfo);
        ...
        *(_DWORD *)(v16 + 28) = v15->fields.productAdd;
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5570/*"EVENT_CONQUEST_UP_ITEM_FORMAT"*/, 0);
        ...
        if ( v15->fields.productAdd >= 1 )
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v28 = LocalizationManager__Get((System_String_o *)StringLiteral_5569/*"EVENT_CONQUEST_UP_ITEM_ADD_FORMAT"*/, 0);
          productAdd = v15->fields.productAdd;
          v32 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &productAdd, v29, v30, v31);
          System_Text_StringBuilder__AppendFormat(v23, v28, v32, 0);
        }
...
LABEL_39:
          ...
          if ( !dispObjList )
            goto LABEL_63;
          if ( v41 >= LODWORD(dispObjList->max_length) )
            goto LABEL_64;
          messageList = v42->fields.messageList;
          if ( !messageList )
            goto LABEL_63;
          if ( v41 >= LODWORD(messageList->max_length) )
            goto LABEL_64;
          ...
          v62 = v49;
          sub_1C2D434((CGThumbnailListItem_o *)&v42->fields.messageLabel, (int32_t)v48, v11, v12);
          v51 = 0;
          break;
        default:
          goto LABEL_35;
      ...
      do
      {
        v52 = (System_Text_StringBuilder_o *)sub_1C2D6DC(System_Text_StringBuilder_TypeInfo);
        System_Text_StringBuilder___ctor(v52, 0);
        if ( !v47 )
          goto LABEL_63;
        if ( (unsigned int)v51 >= LODWORD(v47->max_length) )
          goto LABEL_64;
        v53 = v47->m_Items[v51];
        ...
        ItemIconComponent__SetGift_40700316(v53, *((_DWORD *)Item + 5), *((_DWORD *)Item + 6), v55, 0, 0);
        if ( !v8 )
          goto LABEL_63;
        Item = System_Collections_Generic_List_object___get_Item(
                 v8,
        ...
        if ( !v54 )
          goto LABEL_63;
        UILabel__set_text(v54, (System_String_o *)Item, 0);
        ++v51;
      }
      while ( v40 != v51 );
      ...
      if ( !v62 )
        goto LABEL_63;
      UnityEngine_GameObject__SetActive(v62, 1, 0);
      BaseDialog__Open((BaseDialog_o *)v64, 0, 0, 0);
      titleLabel = v64->fields.titleLabel;
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Item = LocalizationManager__Get((System_String_o *)StringLiteral_5572/*"EVENT_CONQUEST_UP_TITLE"*/, 0);
      if ( !titleLabel )
        goto LABEL_63;
      UILabel__set_text(titleLabel, (System_String_o *)Item, 0);
      v58 = *p_messageLabel;
      Item = LocalizationManager__Get((System_String_o *)StringLiteral_5571/*"EVENT_CONQUEST_UP_MESSAGE"*/, 0);
      if ( !v58 )
        goto LABEL_63;
      UILabel__set_text(v58, (System_String_o *)Item, 0);
      v64->fields.closeAction = action;
      sub_1C2D434((CGThumbnailListItem_o *)&v64->fields.closeAction, (int32_t)action, v59, v60);
    }
  }
  else
  {
