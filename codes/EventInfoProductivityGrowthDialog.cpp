        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31E54 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_EventInfoProductivityGrowthDialog_OnClickCloseButton__);
    sub_1C93AD4(&Method_EventInfoProductivityGrowthDialog__OnClickCloseButton_b__17_0__);
    byte_4D31E54 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_EventInfoProductivityGrowthDialog_OnClickCloseButton__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_EventInfoProductivityGrowthDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31E53 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_5604/*"EVENT_CONQUEST_UP_MESSAGE"*/);
    sub_1C93AD4(&StringLiteral_5603/*"EVENT_CONQUEST_UP_ITEM_FORMAT"*/);
    sub_1C93AD4(&StringLiteral_5602/*"EVENT_CONQUEST_UP_ITEM_ADD_FORMAT"*/);
    sub_1C93AD4(&StringLiteral_5605/*"EVENT_CONQUEST_UP_TITLE"*/);
    byte_4D31E53 = 1;
  }
  ...
  if ( eventConquestInfos )
  {
    action = closeAction;
    v74 = this;
    v7 = (System_Collections_Generic_List_object__o *)sub_1C93D20(System_Collections_Generic_List_GiftEntity__TypeInfo);
...
LABEL_64:
        ...
        v20 = sub_1C93D20(GiftEntity_TypeInfo);
        ...
        *(_DWORD *)(v20 + 28) = v19->fields.productAdd;
        ...
        else
        {
          ...
          sub_1C93A78((GrandQuestFolderBoardItem_o *)(v30 + 4), v20, v21, v22, v23, v24, v25, v26);
        }
        v31 = (System_Text_StringBuilder_o *)sub_1C93D20(System_Text_StringBuilder_TypeInfo);
        System_Text_StringBuilder___ctor(v31, 0);
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v32 = LocalizationManager__Get((System_String_o *)StringLiteral_5603/*"EVENT_CONQUEST_UP_ITEM_FORMAT"*/, 0);
        ...
        if ( v19->fields.productAdd >= 1 )
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v33 = LocalizationManager__Get((System_String_o *)StringLiteral_5602/*"EVENT_CONQUEST_UP_ITEM_ADD_FORMAT"*/, 0);
...
LABEL_39:
      ...
      do
      {
        v58 = (System_Text_StringBuilder_o *)sub_1C93D20(System_Text_StringBuilder_TypeInfo);
        ...
        ItemIconComponent__SetGift_41640856(v59, *((_DWORD *)Item + 5), *((_DWORD *)Item + 6), v61, 0, 0);
        if ( !v8 )
          goto LABEL_63;
        Item = System_Collections_Generic_List_object___get_Item(
                 v8,
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Item = LocalizationManager__Get((System_String_o *)StringLiteral_5605/*"EVENT_CONQUEST_UP_TITLE"*/, 0);
      if ( !titleLabel )
        goto LABEL_63;
      UILabel__set_text(titleLabel, (System_String_o *)Item, 0);
      v64 = *p_messageLabel;
      Item = LocalizationManager__Get((System_String_o *)StringLiteral_5604/*"EVENT_CONQUEST_UP_MESSAGE"*/, 0);
      if ( !v64 )
        goto LABEL_63;
