...
void __fastcall BattleNoSynchroAnime__Start(BattleNoSynchroAnime_o *this, const MethodInfo *method)
{
  ...
  __int64 v8; // x1
  __int64 v9; // x1
  System_Object_array *ComponentsInChildren_object__49254300; // x19
  ...
  if ( (byte_49BDF1F & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_UnityEngine_Component_GetComponentsInChildren_SimpleAnimation___, v4);
  ...
  v11 = UnityEngine_Component__GetComponentsInChildren_object__49254300(
          (UnityEngine_Component_o *)this,
  ...
  {
    max_length = ComponentsInChildren_object__49254300->max_length;
    if ( max_length >= 1 )
    {
      v14 = 0;
      while ( v14 < max_length )
      {
        States = (SimpleAnimation_o *)ComponentsInChildren_object__49254300->m_Items[v14];
        if ( !States )
          goto LABEL_104;
        ...
        {
LABEL_13:
          v20 = sub_1B9D724(States, System_Collections_Generic_IEnumerable_SimpleAnimation_State__TypeInfo, 0LL);
        }
...
LABEL_20:
          ...
          {
LABEL_27:
            v30 = sub_1B9D724(v22, System_Collections_Generic_IEnumerator_SimpleAnimation_State__TypeInfo, 0LL);
          }
          ...
          {
LABEL_34:
            v37 = sub_1B9D724(v31, SimpleAnimation_State_TypeInfo, 15LL);
          }
          if ( (*(unsigned int (__fastcall **)(__int64, _QWORD))v37)(v33, *(_QWORD *)(v37 + 8)) != 2 )
          {
            ...
            {
LABEL_41:
              v41 = sub_1B9D724(v33, SimpleAnimation_State_TypeInfo, 17LL);
            }
          ...
          {
LABEL_48:
            v45 = sub_1B9D724(v33, SimpleAnimation_State_TypeInfo, 13LL);
          }
          ...
          *(float *)&v47 = UnityEngine_Random__Range(0.0, *(float *)&v46, 0LL);
          ...
          {
LABEL_54:
            v52 = sub_1B9D724(v33, SimpleAnimation_State_TypeInfo, 4LL);
          }
        ...
        {
LABEL_61:
          v56 = sub_1B9D724(v22, System_IDisposable_TypeInfo, 0LL);
        }
...
LABEL_77:
            ...
            {
LABEL_84:
              v69 = sub_1B9D724(Enumerator, System_Collections_IEnumerator_TypeInfo, 1LL);
            }
            ...
            {
              sub_1B4D4AC(v70);
              v80 = sub_1B4D0CC(Enumerator, System_IDisposable_TypeInfo);
              v81 = v80;
              if ( v80 )
              {
                v82 = *(_QWORD *)v80;
                ...
                {
LABEL_111:
                  v85 = sub_1B9D724(v80, System_IDisposable_TypeInfo, 0LL);
                }
          ...
          v11 = (System_Object_array *)sub_1B4D0CC(Enumerator, System_IDisposable_TypeInfo);
          if ( v11 )
          {
            v75 = v11->obj.klass;
            v76 = v11;
            ...
            {
LABEL_95:
              v79 = sub_1B9D724(v11, System_IDisposable_TypeInfo, 0LL);
            }
