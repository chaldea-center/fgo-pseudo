...
{
  System_Object_array *ComponentsInChildren_object__48721436; // x19
  ...
  if ( (byte_4A5DFBE & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_UnityEngine_Component_GetComponentsInChildren_Animation___);
    sub_1B885B0(&Method_UnityEngine_Component_GetComponentsInChildren_SimpleAnimation___);
  ...
  ComponentsInChildren_object__48721436 = UnityEngine_Component__GetComponentsInChildren_object__48721436(
                                            ...
                                            (const MethodInfo_2E76E1C *)Method_UnityEngine_Component_GetComponentsInChildren_SimpleAnimation___);
  v4 = UnityEngine_Component__GetComponentsInChildren_object__48721436(
         (UnityEngine_Component_o *)this,
         (const MethodInfo_2E76E1C *)Method_UnityEngine_Component_GetComponentsInChildren_Animation___);
  if ( ComponentsInChildren_object__48721436 )
  {
    max_length = ComponentsInChildren_object__48721436->max_length;
    if ( max_length >= 1 )
    {
      v7 = 0;
      while ( v7 < max_length )
      {
        States = (SimpleAnimation_o *)ComponentsInChildren_object__48721436->m_Items[v7];
        if ( !States )
          goto LABEL_104;
        ...
        klass = States->klass;
        v10 = States;
        v11 = *(unsigned __int16 *)(&States->klass->_2.bitflags2 + 3);
        ...
        {
LABEL_13:
          v13 = sub_1BDA590(States, System_Collections_Generic_IEnumerable_SimpleAnimation_State__TypeInfo, 0LL);
        }
...
LABEL_27:
          ...
          {
LABEL_34:
            v30 = sub_1BDA590(v24, SimpleAnimation_State_TypeInfo, 15LL);
          }
          if ( (*(unsigned int (__fastcall **)(__int64, _QWORD))v30)(v26, *(_QWORD *)(v30 + 8)) != 2 )
          {
            ...
            {
LABEL_41:
              v34 = sub_1BDA590(v26, SimpleAnimation_State_TypeInfo, 17LL);
            }
          ...
          {
LABEL_48:
            v38 = sub_1BDA590(v26, SimpleAnimation_State_TypeInfo, 13LL);
          }
          v39 = ((long double (__fastcall *)(__int64, _QWORD))*(_QWORD *)v38)(v26, *(_QWORD *)(v38 + 8));
          *(float *)&v40 = UnityEngine_Random__Range(0.0, *(float *)&v39, 0LL);
          v41 = *(_QWORD *)v26;
          v42 = v40;
          ...
          {
LABEL_54:
            v45 = sub_1BDA590(v26, SimpleAnimation_State_TypeInfo, 4LL);
          }
        ...
        {
LABEL_61:
          v49 = sub_1BDA590(v15, System_IDisposable_TypeInfo, 0LL);
        }
...
LABEL_77:
            ...
            {
LABEL_84:
              v62 = sub_1BDA590(Enumerator, System_Collections_IEnumerator_TypeInfo, 1LL);
            }
            ...
            {
              sub_1B88ACC(v63);
              v73 = sub_1B886EC(Enumerator, System_IDisposable_TypeInfo);
              v74 = v73;
              if ( v73 )
              {
                v75 = *(_QWORD *)v73;
                ...
                {
LABEL_111:
                  v78 = sub_1BDA590(v73, System_IDisposable_TypeInfo, 0LL);
                }
            ...
            if ( UnityEngine_AnimationState__get_wrapMode(v63, 0LL) == 2 )
            {
              length = UnityEngine_AnimationState__get_length(v65, 0LL);
              v67 = UnityEngine_Random__Range(0.0, length, 0LL);
              UnityEngine_AnimationState__set_time(v65, v67, 0LL);
            }
          }
          v4 = (System_Object_array *)sub_1B886EC(Enumerator, System_IDisposable_TypeInfo);
          if ( v4 )
          {
            v68 = v4->obj.klass;
            v69 = v4;
            v70 = *(unsigned __int16 *)(&v4->obj.klass->_2.bitflags2 + 3);
            if ( *(_WORD *)(&v4->obj.klass->_2.bitflags2 + 3) )
            {
              ...
              v72 = (__int64)&v68->vtable[*v71].method;
            }
            else
            {
LABEL_95:
              v72 = sub_1BDA590(v4, System_IDisposable_TypeInfo, 0LL);
            }
