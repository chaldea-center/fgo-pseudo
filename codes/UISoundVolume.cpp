...
void UISoundVolume__Awake(UISoundVolume_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CCBB70 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_UnityEngine_Component_GetComponent_UISlider___);
    sub_1C713B0(&EventDelegate_TypeInfo);
    sub_1C713B0(&NGUITools_TypeInfo);
    sub_1C713B0(&Method_UISoundVolume_OnChange__);
    byte_4CCBB70 = 1;
  }
  Component_object = (UIProgressBar_o *)UnityEngine_Component__GetComponent_object_(
                                          (UnityEngine_Component_o *)this,
                                          (const MethodInfo_31418DC *)Method_UnityEngine_Component_GetComponent_UISlider___);
