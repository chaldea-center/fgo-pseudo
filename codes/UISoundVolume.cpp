...
void UISoundVolume__Awake(UISoundVolume_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5B43A & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_UnityEngine_Component_GetComponent_UISlider___);
    sub_1C3E564(&EventDelegate_TypeInfo);
    sub_1C3E564(&NGUITools_TypeInfo);
    sub_1C3E564(&Method_UISoundVolume_OnChange__);
    byte_4C5B43A = 1;
  }
  Component_object = (UIProgressBar_o *)UnityEngine_Component__GetComponent_object_(
                                          (UnityEngine_Component_o *)this,
                                          (const MethodInfo_30F0240 *)Method_UnityEngine_Component_GetComponent_UISlider___);
