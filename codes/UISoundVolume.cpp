...
void UISoundVolume__Awake(UISoundVolume_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E7BE55 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponent_UISlider___);
    sub_1D0F0B4(&EventDelegate_TypeInfo);
    sub_1D0F0B4(&NGUITools_TypeInfo);
    sub_1D0F0B4(&Method_UISoundVolume_OnChange__);
    byte_4E7BE55 = 1;
  }
  Component_object = (UIProgressBar_o *)UnityEngine_Component__GetComponent_object_(
                                          (UnityEngine_Component_o *)this,
                                          (const MethodInfo_3245988 *)Method_UnityEngine_Component_GetComponent_UISlider___);
