...
void UISoundVolume__Awake(UISoundVolume_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D30F22 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_UnityEngine_Component_GetComponent_UISlider___);
    sub_1C94098(&EventDelegate_TypeInfo);
    sub_1C94098(&NGUITools_TypeInfo);
    sub_1C94098(&Method_UISoundVolume_OnChange__);
    byte_4D30F22 = 1;
  }
  Component_object = (UIProgressBar_o *)UnityEngine_Component__GetComponent_object_(
                                          (UnityEngine_Component_o *)this,
                                          (const MethodInfo_3192904 *)Method_UnityEngine_Component_GetComponent_UISlider___);
