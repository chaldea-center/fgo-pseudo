        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01734 & 1) == 0 )
  {
    sub_1CE6700(&RewardEffectComponent__DisplayWait_d__9_TypeInfo);
    byte_4E01734 = 1;
  }
  v3 = sub_1CE694C(RewardEffectComponent__DisplayWait_d__9_TypeInfo);
...
void RewardEffectComponent__Update(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01733 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_RewardEffectComponent__Update_b__7_0__);
    sub_1CE6700(&Method_RewardEffectComponent_Update__);
    byte_4E01733 = 1;
  }
    ...
    if ( CTouch__isTouchPush(0) )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)screenTouchInfo, 0) )
      {
        ...
        if ( (*((_BYTE *)Method_RewardEffectComponent_Update__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1CE6718(Method_RewardEffectComponent_Update__);
...
void RewardEffectComponent___Update_b__7_0(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  GrandQuestFolderBoardItem_o *p_endAction; // x19
  int32_t v4; // w2
  int32_t v5; // w3
  System_String_o *v6; // x4
  int32_t v7; // w5
  ...
  p_endAction = (GrandQuestFolderBoardItem_o *)&this->fields.endAction;
  endAction = this->fields.endAction;
  LOBYTE(p_endAction[-1].fields._ClosedMessage_k__BackingField) = 0;
  ActionExtensions__Call(endAction, 0);
  p_endAction->klass = 0;
  sub_1CE66A4(p_endAction, 0, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E01736 & 1) == 0 )
  {
    this = (RewardEffectComponent__DisplayWait_d__9_o *)sub_1CE6700(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4E01736 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1CE6714(&Method_RewardEffectComponent__DisplayWait_d__9_System_Collections_IEnumerator_Reset__);
  sub_1CE6828(v3, v4);
}
