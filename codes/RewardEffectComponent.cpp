        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596D63A & 1) == 0 )
  {
    sub_2213A60(&RewardEffectComponent__DisplayWait_d__9_TypeInfo);
    byte_596D63A = 1;
  }
  v3 = sub_2213CCC(RewardEffectComponent__DisplayWait_d__9_TypeInfo);
...
void RewardEffectComponent__Update(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596D639 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_RewardEffectComponent__Update_b__7_0__);
    sub_2213A60(&Method_RewardEffectComponent_Update__);
    byte_596D639 = 1;
  }
    ...
    if ( CTouch__isTouchPush(0) )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)screenTouchInfo, 0) )
      {
        ...
        if ( (*((_BYTE *)Method_RewardEffectComponent_Update__ + 83) & 2) != 0 )
          v7 = (_QWORD *)sub_2213A78(Method_RewardEffectComponent_Update__);
...
void RewardEffectComponent___Update_b__7_0(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  p_endAction->klass = 0;
  sub_2213A04(p_endAction, 0, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_596D63C & 1) == 0 )
  {
    this = (RewardEffectComponent__DisplayWait_d__9_o *)sub_2213A60(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_596D63C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_2213A74(&Method_RewardEffectComponent__DisplayWait_d__9_System_Collections_IEnumerator_Reset__);
  sub_2213BA0(v3, v4);
}
