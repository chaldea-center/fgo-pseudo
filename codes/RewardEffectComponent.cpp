        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEB3C8 & 1) == 0 )
  {
    sub_1C7BAE8(&RewardEffectComponent__DisplayWait_d__9_TypeInfo);
    byte_4CEB3C8 = 1;
  }
  v3 = sub_1C7BD34(RewardEffectComponent__DisplayWait_d__9_TypeInfo);
...
void RewardEffectComponent__Update(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEB3C7 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&Method_RewardEffectComponent__Update_b__7_0__);
    sub_1C7BAE8(&Method_RewardEffectComponent_Update__);
    byte_4CEB3C7 = 1;
  }
    ...
    if ( CTouch__isTouchPush(0) )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)screenTouchInfo, 0) )
      {
        ...
        if ( (*((_BYTE *)Method_RewardEffectComponent_Update__ + 83) & 2) != 0 )
          v5 = (_QWORD *)sub_1C7BB00(Method_RewardEffectComponent_Update__);
...
void RewardEffectComponent___Update_b__7_0(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  p_endAction->klass = 0;
  sub_1C7BA8C(p_endAction, 0, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEB3CA & 1) == 0 )
  {
    this = (RewardEffectComponent__DisplayWait_d__9_o *)sub_1C7BAE8(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4CEB3CA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_RewardEffectComponent__DisplayWait_d__9_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
