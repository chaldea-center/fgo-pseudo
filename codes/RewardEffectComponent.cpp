        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEE5F & 1) == 0 )
  {
    sub_1BC3008(&RewardEffectComponent__DisplayWait_d__9_TypeInfo, method);
    byte_4AFEE5F = 1;
  }
  v3 = sub_1BC3254(RewardEffectComponent__DisplayWait_d__9_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.endAction, (int32_t)action, (int32_t)method, v3);
}
...
LABEL_13:
    ...
    *p_screenTouchInfo = (struct ScreenTouchInformationComponent_o *)Component_object;
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.screenTouchInfo, (int32_t)Component_object, v11, v12);
  }
...
void __fastcall RewardEffectComponent__Update(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFEE5E & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_RewardEffectComponent__Update_b__7_0__, v4);
    sub_1BC3008(&Method_RewardEffectComponent_Update__, v5);
    byte_4AFEE5E = 1;
  }
    ...
    if ( CTouch__isTouchPush(0LL) )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)screenTouchInfo, 0LL) )
      {
        ...
        if ( (*((_BYTE *)Method_RewardEffectComponent_Update__ + 83) & 2) != 0 )
          v8 = (_QWORD *)sub_1BC3020(Method_RewardEffectComponent_Update__);
      ...
      {
LABEL_17:
        sub_1BC3264(screenTouchInfo, v6);
      }
...
void __fastcall RewardEffectComponent___Update_b__7_0(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BC2FAC(p_endAction, 0, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFEE61 & 1) == 0 )
  {
    this = (RewardEffectComponent__DisplayWait_d__9_o *)sub_1BC3008(&UnityEngine_WaitForSeconds_TypeInfo, method);
    byte_4AFEE61 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_RewardEffectComponent__DisplayWait_d__9_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
