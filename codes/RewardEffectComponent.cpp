        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2F40 & 1) == 0 )
  {
    sub_1BAB41C(&RewardEffectComponent__DisplayWait_d__9_TypeInfo, method);
    byte_4AB2F40 = 1;
  }
  v3 = sub_1BAB668(RewardEffectComponent__DisplayWait_d__9_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.endAction, (int32_t)action, (int32_t)method, v3);
}
...
LABEL_13:
    ...
    *p_screenTouchInfo = (struct ScreenTouchInformationComponent_o *)Component_object;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.screenTouchInfo, (int32_t)Component_object, v11, v12);
  }
...
void __fastcall RewardEffectComponent__Update(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB2F3F & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_RewardEffectComponent__Update_b__7_0__, v4);
    sub_1BAB41C(&Method_RewardEffectComponent_Update__, v5);
    byte_4AB2F3F = 1;
  }
  ...
  if ( this->fields.isWaitTouch )
  {
    ...
    if ( CTouch__isTouchPush(0LL) )
    {
      ...
      {
        sub_1BAB678(screenTouchInfo, v6);
      }
      ...
      if ( (*((_BYTE *)Method_RewardEffectComponent_Update__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1BAB434(Method_RewardEffectComponent_Update__);
...
void __fastcall RewardEffectComponent___Update_b__7_0(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  ServantStatusBattleListViewItem_o *p_endAction; // x19
  int32_t v4; // w2
  int32_t v5; // w3

  p_endAction = (ServantStatusBattleListViewItem_o *)&this->fields.endAction;
  endAction = this->fields.endAction;
  p_endAction[-1].fields.isMine = 0;
  ActionExtensions__Call(endAction, 0LL);
  p_endAction->klass = 0LL;
  sub_1BAB3C0(p_endAction, 0, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB2F42 & 1) == 0 )
  {
    this = (RewardEffectComponent__DisplayWait_d__9_o *)sub_1BAB41C(&UnityEngine_WaitForSeconds_TypeInfo, method);
    byte_4AB2F42 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_RewardEffectComponent__DisplayWait_d__9_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
