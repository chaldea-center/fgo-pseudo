        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C347CE & 1) == 0 )
  {
    sub_1C32C20(&RewardEffectComponent__DisplayWait_d__9_TypeInfo);
    byte_4C347CE = 1;
  }
  v3 = sub_1C32E6C(RewardEffectComponent__DisplayWait_d__9_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.endAction, (int32_t)action, (int32_t)method, v3);
}
...
LABEL_13:
    ...
    *p_screenTouchInfo = (struct ScreenTouchInformationComponent_o *)Component_object;
    sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.screenTouchInfo, (int32_t)Component_object, v8, v9);
  }
...
void RewardEffectComponent__Update(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C347CD & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_RewardEffectComponent__Update_b__7_0__);
    sub_1C32C20(&Method_RewardEffectComponent_Update__);
    byte_4C347CD = 1;
  }
    ...
    if ( CTouch__isTouchPush(0) )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)screenTouchInfo, 0) )
      {
        ...
        if ( (*((_BYTE *)Method_RewardEffectComponent_Update__ + 83) & 2) != 0 )
          v4 = (_QWORD *)sub_1C32C38(Method_RewardEffectComponent_Update__);
...
void RewardEffectComponent___Update_b__7_0(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  p_endAction->klass = 0;
  sub_1C32BC4(p_endAction, 0, v4, v5);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C347D0 & 1) == 0 )
  {
    this = (RewardEffectComponent__DisplayWait_d__9_o *)sub_1C32C20(&UnityEngine_WaitForSeconds_TypeInfo);
    byte_4C347D0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C32C34(&Method_RewardEffectComponent__DisplayWait_d__9_System_Collections_IEnumerator_Reset__);
  sub_1C32D48(v3, v4);
}
