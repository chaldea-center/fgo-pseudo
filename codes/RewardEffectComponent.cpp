        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3433E & 1) == 0 )
  {
    sub_1BD3458(&RewardEffectComponent__DisplayWait_d__9_TypeInfo, method);
    byte_4B3433E = 1;
  }
  v3 = sub_1BD36A4(RewardEffectComponent__DisplayWait_d__9_TypeInfo);
...
void __fastcall RewardEffectComponent__Update(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3433D & 1) == 0 )
  {
    ...
    sub_1BD3458(&Method_RewardEffectComponent__Update_b__7_0__, v4);
    sub_1BD3458(&Method_RewardEffectComponent_Update__, v5);
    byte_4B3433D = 1;
  }
  ...
  if ( this->fields.isWaitTouch )
  {
    ...
    if ( CTouch__isTouchPush(0LL) )
    {
      ...
      {
        sub_1BD36B4(screenTouchInfo, v6);
      }
      ...
      if ( (*((_BYTE *)Method_RewardEffectComponent_Update__ + 83) & 2) != 0 )
        v8 = (_QWORD *)sub_1BD3470(Method_RewardEffectComponent_Update__);
...
void __fastcall RewardEffectComponent___Update_b__7_0(RewardEffectComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1BD33FC(p_endAction, 0LL, v4, v5, v6, v7, v8, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34340 & 1) == 0 )
  {
    this = (RewardEffectComponent__DisplayWait_d__9_o *)sub_1BD3458(&UnityEngine_WaitForSeconds_TypeInfo, method);
    byte_4B34340 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BD346C(&Method_RewardEffectComponent__DisplayWait_d__9_System_Collections_IEnumerator_Reset__);
  sub_1BD3580(v3, v4);
}
