void __fastcall UserExpMaster___ctor(UserExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A0992C & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int___ctor__, method);
    byte_4A0992C = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    61,
    (const MethodInfo_30E4480 *)Method_DataMasterBase_UserExpMaster__UserExpEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4A0992D & 1) == 0 )
  {
    sub_1B686D4(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int__GetEntity__, *(_QWORD *)&lv);
    byte_4A0992D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0992F & 1) == 0 )
  {
    this = (UserExpMaster_o *)sub_1B686D4(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int__GetEntity__, exp);
    byte_4A0992F = 1;
  }
...
int32_t __fastcall UserExpMaster__getLevelMax(UserExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A0992E & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_8564/*"MAX_USER_LV"*/, method);
    byte_4A0992E = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_8564/*"MAX_USER_LV"*/, 0LL);
}