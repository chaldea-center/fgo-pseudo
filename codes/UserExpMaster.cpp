void __fastcall UserExpMaster___ctor(UserExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB6A47 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int___ctor__, method);
    byte_4AB6A47 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    61,
    (const MethodInfo_3163D50 *)Method_DataMasterBase_UserExpMaster__UserExpEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB6A48 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int__GetEntity__, *(_QWORD *)&lv);
    byte_4AB6A48 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6A4A & 1) == 0 )
  {
    this = (UserExpMaster_o *)sub_1BAB41C(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int__GetEntity__, exp);
    byte_4AB6A4A = 1;
  }
...
int32_t __fastcall UserExpMaster__getLevelMax(UserExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB6A49 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_8603/*"MAX_USER_LV"*/, method);
    byte_4AB6A49 = 1;
  }
