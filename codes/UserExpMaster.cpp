void __fastcall UserExpMaster___ctor(UserExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A5BE45 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int___ctor__);
    byte_4A5BE45 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    61,
    (const MethodInfo_311D8F4 *)Method_DataMasterBase_UserExpMaster__UserExpEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5BE48 & 1) == 0 )
  {
    this = (UserExpMaster_o *)sub_1B885B0(&Method_DataMasterBase_UserExpMaster__UserExpEntity__int__GetEntity__);
    byte_4A5BE48 = 1;
  }
...
int32_t __fastcall UserExpMaster__getLevelMax(UserExpMaster_o *this, const MethodInfo *method)
{
  ...
  return ConstantMaster__getValue((System_String_o *)StringLiteral_8599/*"MAX_USER_LV"*/, 0LL);
}