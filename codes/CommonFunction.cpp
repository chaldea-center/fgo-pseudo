        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D3C7 & 1) == 0 )
  {
    sub_1B761C0(&int___TypeInfo, addIndiv);
    byte_4A2D3C7 = 1;
  }
  if ( addIndiv )
  {
    ...
    if ( v5 )
    {
      ...
      {
        v7 = (System_Array_o *)sub_1B76268(int___TypeInfo, (unsigned int)(v6 + v5));
...
bool __fastcall CommonFunction__ReScaleUiFunc(UIRoot_o *uiRoot, const MethodInfo *method)
{
  ...
  if ( !System_Math_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
  v10 = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !v10 )
LABEL_48:
    sub_1B7641C(v10, v8);
  v24 = v23 - monitor;
...
void __fastcall CommonFunction__ScalingLabelWidth(UILabel_o *label, int32_t maxWidth, const MethodInfo *method)
{
  ...
  if ( !byte_4A28BB6 )
  {
    label = (UILabel_o *)sub_1B761C0(&UnityEngine_Vector3_TypeInfo, *(_QWORD *)&maxWidth);
    byte_4A28BB6 = 1;
  }
  if ( !v5 )
    goto LABEL_11;
...
LABEL_11:
    sub_1B7641C(label, *(_QWORD *)&maxWidth);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D3C6 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_UILabel___, isEnable);
...
LABEL_7:
    sub_1B7641C(parentTransform, isEnable);
  }
}