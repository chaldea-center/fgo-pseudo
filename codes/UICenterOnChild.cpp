...
LABEL_32:
  ...
  if ( !cachedTransform )
LABEL_41:
    sub_21FFECC(cachedTransform, v22);
  v39 = v35 - v36;
...
void UICenterOnChild__CenterOn_56009592(
        UICenterOnChild_o *this,
        UnityEngine_Transform_o *target,
        bool isFinishAction,
        bool applyImmediately,
...
void UICenterOnChild__OnDisable(UICenterOnChild_o *this, const MethodInfo *method)
{
  ...
  if ( v4 )
  {
    ...
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v12->fields.centerOnChild, 0, v6, v7, v8, v9, v10, v11);
  }
}
...
void UICenterOnChild__OnEnable(UICenterOnChild_o *this, const MethodInfo *method)
{
  ...
  if ( v4 )
  {
    ...
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v12->fields.centerOnChild, (int32_t)this, v6, v7, v8, v9, v10, v11);
    ((void (__fastcall *)(UICenterOnChild_o *, const MethodInfo *))this->klass->vtable._4_Recenter.methodPtr)(
      this,
      this->klass->vtable._4_Recenter.method);
  }
...
void UICenterOnChild__Recenter(UICenterOnChild_o *this, const MethodInfo *method)
{
  ...
  bool v110; // nf
  const MethodInfo_444F85C *v111; // x2
  __int64 v112; // x1
  ...
  if ( (byte_593CCD1 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_UnityEngine_Component_GetComponent_UIWrapContent___);
    ...
    sub_21FFC50(&Method_UICenterOnChild_OnDragFinished__);
    sub_21FFC50(&UIScrollView_var);
    sub_21FFC50(&StringLiteral_306/*" requires "*/);
    sub_21FFC50(&StringLiteral_299/*" on a parent object in order to work"*/);
    sub_21FFC50(&StringLiteral_9812/*"Next Page Threshold requires a sorted UIGrid in order to work properly"*/);
    byte_593CCD1 = 1;
  }
    ...
    *p_mScrollView = (struct UIScrollView_o *)v10;
    ...
    if ( UnityEngine_Object__op_Equality(v18, 0, 0) )
    {
      ...
      if ( !*(_DWORD *)(qword_594C108 + 228) )
        j_il2cpp_runtime_class_init_0(qword_594C108, v21);
      ...
      if ( TypeFromHandle )
        ...
        v48 = 0;
      v50 = (Il2CppObject *)System_String__Concat_75483552(v22, v47, v48, (System_String_o *)StringLiteral_299/*" on a parent object in order to work"*/, 0);
      if ( !*(&UnityEngine_Debug_TypeInfo->_2.cctor_finished + 1) )
        j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo, v49);
      UnityEngine_Debug__LogWarning_82996268(v50, (UnityEngine_Object_o *)this, 0);
    ...
    if ( (transform & 1) != 0 )
    {
      ...
      v34 = (UIScrollView_OnDragNotification_o *)sub_21FFEBC(UIScrollView_OnDragNotification_TypeInfo);
      ...
      sub_21FFBF4(p_onDragFinished, (int32_t)v35, v36, v37, v38, v39, v40, v41);
    }
    if ( !*p_mScrollView )
      goto LABEL_134;
    ...
    if ( (transform & 1) != 0 )
    {
      ...
      v54 = (UIProgressBar_OnDragFinished_o *)sub_21FFEBC(UIProgressBar_OnDragFinished_TypeInfo);
      ...
      sub_21FFBF4(p_onDragFinished, (int32_t)v55, v36, v56, v57, v58, v59, v60);
    }
    if ( !*p_mScrollView )
      goto LABEL_134;
    ...
    if ( (transform & 1) != 0 )
    {
      ...
      v64 = (UIProgressBar_OnDragFinished_o *)sub_21FFEBC(UIProgressBar_OnDragFinished_TypeInfo);
...
LABEL_54:
      sub_220024C(v42, v43, v36);
LABEL_55:
      p_onDragFinished->klass = 0;
LABEL_56:
      sub_21FFBF4(p_onDragFinished, (int32_t)v42, v36, v66, v67, v68, v69, v70);
    }
  }
  if ( !*p_mScrollView )
    goto LABEL_134;
...
LABEL_79:
    ...
    *(_QWORD *)&v122.fields.x = v102;
    ...
    v126 = UnityEngine_Quaternion__op_Multiply_83158396(rotation, v122, 0);
    v103 = *p_mScrollView;
    v122 = v126;
    if ( !v103 )
      goto LABEL_134;
    ...
    if ( movement )
    {
      ...
      if ( movement == 1 )
        goto LABEL_99;
      v126.fields.x = sub_244FB30(&v122, 0);
    }
    v105 = v126.fields.x;
LABEL_99:
...
LABEL_138:
      ...
      UnityEngine_Debug__LogWarning_82996268((Il2CppObject *)StringLiteral_9812/*"Next Page Threshold requires a sorted UIGrid in order to work properly"*/, (UnityEngine_Object_o *)this, 0);
      goto LABEL_131;
    }
    ...
    if ( v105 <= nextPageThreshold )
    {
      ...
      if ( v86 < *(_DWORD *)(transform + 24) - 1 )
      {
        LODWORD(v7) = v86 + 1;
LABEL_117:
        v111 = (const MethodInfo_444F85C *)Method_System_Collections_Generic_List_Transform__get_Item__;
LABEL_129:
        v116 = v109;
        goto LABEL_130;
      }
      v115 = UnityEngine_Component__GetComponent_object_(
               (UnityEngine_Component_o *)this,
               (const MethodInfo_37ED7E0 *)Method_UnityEngine_Component_GetComponent_UIWrapContent___);
      if ( !*(&UnityEngine_Object_TypeInfo->_2.cctor_finished + 1) )
...
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_200397C;
}
