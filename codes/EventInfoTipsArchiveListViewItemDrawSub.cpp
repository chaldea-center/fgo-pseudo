        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(v4, 0LL, 0LL) )
  {
    ...
    sub_1B00C70(p_parameterObject, 0, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.viewItem, (int32_t)item, (int32_t)method, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E408B & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterComponent___, method);
    ...
    if ( ((unsigned __int8)Component_object & 1) == 0 )
    {
      ...
      if ( viewItem )
      {
        ...
        *p_parameterObject = (UnityEngine_Object_o *)v12;
        sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.parameterObject, (int32_t)v12, v13, v14);
        if ( UnityEngine_Object__op_Equality(*p_parameterObject, 0LL, 0LL) )
          return;
        GameObjectExtensions__SafeSetParent_32541256(this->fields.parameterObject, this->fields.parameterParent, 0LL);
        Component_object = this->fields.parameterObject;
        if ( Component_object )
        {
          Component_object = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                           Component_object,
                                                           (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_ServantStatusParameterComponent___);
          if ( Component_object )
          {
