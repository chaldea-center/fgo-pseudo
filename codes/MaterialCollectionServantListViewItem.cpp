        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62085 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&IconLabelInfo_TypeInfo, v11);
  ...
  sub_1BE4A70(&this->fields.userSvtCollectionEntity);
  ...
  *(_QWORD *)&v26.fields.fakeValue = v20;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v26, 0LL);
  if ( !v19 )
    goto LABEL_17;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall MaterialCollectionServantListViewItem___ctor_31848768(
        MaterialCollectionServantListViewItem_o *this,
        int32_t index,
        ...
        const MethodInfo *method)
{
  ...
  this->fields.index = index;
  this->fields.displayKind = kind;
  sub_1BE4A70(&this->fields.userCommandCodeCollectionEntity);
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance )
    goto LABEL_12;
  Instance = DataManager__GetMasterData_object_(
  ...
  *(_QWORD *)&v24.fields.fakeValue = v19;
  Instance = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47299060(v24, 0LL);
  if ( !v18 )
    goto LABEL_12;
  ...
  Instance = (Il2CppObject *)sub_1BE4A70(&this->fields.commandCodeEntity);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62088 & 1) == 0 )
  {
    sub_1BE4ACC(&ListViewSort_FilterKind___TypeInfo, sort);
    byte_4B62088 = 1;
  }
  v5 = (ListViewSort_FilterKind_array *)sub_1BE4B74(ListViewSort_FilterKind___TypeInfo, 1LL);
  if ( !v5 )
    goto LABEL_9;
  v6 = v5;
  if ( !v5->max_length )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62089 & 1) == 0 )
  {
    this = (MaterialCollectionServantListViewItem_o *)sub_1BE4ACC(
  ...
  *(_QWORD *)&v10.fields.fakeValue = v6;
  ...
  if ( !this )
LABEL_11:
    sub_1BE4D28(this, *(_QWORD *)&sortKind);
  IconLabelInfo__Set_39043324((IconLabelInfo_o *)this, 57, v8, 0, 0, 0, 0, 0, 0LL);
}
...
LABEL_9:
  ...
  if ( (int)collectionNo >= 1 )
  {
    v7 = 9;
LABEL_10:
    IconLabelInfo__Set_39043324(iconLabelInfo, v7, collectionNo, 0, 0, 0, 0, 0, 0LL);
    return;
  }
  IconLabelInfo__Clear(iconLabelInfo, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6208F & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_19307/*"error"*/, v4);
    byte_4B6208F = 1;
  }
  ...
  else
  {
    if ( this->fields.userCommandCodeCollectionEntity )
      ...
      v8 = (System_String_o **)&StringLiteral_19307/*"error"*/;
    return *v8;
  }
}
...
LABEL_16:
      sub_1BE4D28(servantEntity, method);
    }
    return 0;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B62090 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_3438/*"CAN_SELECT_SVT_MATERIAL_FLAG"*/, v4);
    byte_4B62090 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !Instance
    || (Instance = DataManager__GetMasterData_object_(
                     (DataManager_o *)Instance,
                     (const MethodInfo_2F59110 *)Method_DataManager_GetMasterData_ConstantMaster___)) == 0LL )
  {
    sub_1BE4D28(Instance, v6);
  }
  Value_39976388 = ConstantMaster__GetValue_39976388(
                     (ConstantMaster_o *)Instance,
                     (System_String_o *)StringLiteral_3438/*"CAN_SELECT_SVT_MATERIAL_FLAG"*/,
                     0,
                     0LL);
