...
void __fastcall SyncTransformComponent__sync(SyncTransformComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Implicit(klass, 0LL) )
  {
    ...
    if ( !gameObject )
      goto LABEL_21;
    *(UnityEngine_Vector3_o *)&v9 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)gameObject, 0LL);
    if ( !transform )
      goto LABEL_21;
    ...
    if ( !gameObject )
      goto LABEL_21;
    v12 = UnityEngine_Component__get_transform(gameObject, 0LL);
    gameObject = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    if ( !gameObject )
      goto LABEL_21;
    gameObject = (UnityEngine_Component_o *)UnityEngine_GameObject__get_transform(
                                              ...
                                              0LL);
    if ( !gameObject
      || (*(UnityEngine_Quaternion_o *)&v13 = UnityEngine_Transform__get_rotation(
                                                (UnityEngine_Transform_o *)gameObject,
                                                0LL),
          !v12)
      || (UnityEngine_Transform__set_rotation(v12, *(UnityEngine_Quaternion_o *)&v13, 0LL),
          (gameObject = (UnityEngine_Component_o *)this[1].klass) == 0LL)
      || (v17 = UnityEngine_Component__get_transform(gameObject, 0LL),
      ...
      || (gameObject = (UnityEngine_Component_o *)UnityEngine_GameObject__get_transform(
                                                    (UnityEngine_GameObject_o *)gameObject,
                                                    0LL)) == 0LL
      || (*(UnityEngine_Vector3_o *)&v18 = UnityEngine_Transform__get_localScale(
                                             (UnityEngine_Transform_o *)gameObject,
                                             0LL),
          !v17) )
    {
