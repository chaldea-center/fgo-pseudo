        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)v11, (int32_t)gachaInfo, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3F442 & 1) == 0 )
  {
    ...
    this = (MultiExSummonListViewItem_o *)sub_1C37058(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
    byte_4C3F442 = 1;
  }
  entity = 0;
  info = v3->fields.info;
  ...
  this = (MultiExSummonListViewItem_o *)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_ServantMaster___);
  v6 = v3->fields.info;
  if ( !v6 || !this )
    goto LABEL_44;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (MultiExSummonListViewItem_o *)DataManager__GetMaster_object_((const MethodInfo_30E7C04 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  if ( !entity )
    goto LABEL_44;
  ...
  *(_QWORD *)&v23.fields.fakeValue = monitor;
  this = (MultiExSummonListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48930896(v23, 0);
