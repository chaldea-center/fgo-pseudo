        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)v11, (int32_t)gachaInfo, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4AA28 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMaster_ServantExceedMaster___, sort);
    ...
    this = (MultiExSummonListViewItem_o *)sub_1B863B8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v7);
    byte_4A4AA28 = 1;
  }
  entity = 0LL;
  info = v3->fields.info;
  ...
  this = (MultiExSummonListViewItem_o *)DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_ServantMaster___);
  v10 = v3->fields.info;
  if ( !v10 || !this )
    goto LABEL_46;
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  this = (MultiExSummonListViewItem_o *)DataManager__GetMaster_object_((const MethodInfo_2F6DC64 *)Method_DataManager_GetMaster_ServantExceedMaster___);
  if ( !entity )
    goto LABEL_46;
  ...
  *(_QWORD *)&v27.fields.fakeValue = monitor;
  this = (MultiExSummonListViewItem_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v27, 0LL);
