void TitleInfoEventRaidHpComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E75FBA & 1) == 0 )
  {
    sub_1D0F0B4(&TitleInfoEventRaidHpComponent_TypeInfo);
    sub_1D0F0B4(&StringLiteral_19579/*"event_raid_ok"*/);
    sub_1D0F0B4(&StringLiteral_19577/*"event_raid_ng"*/);
    byte_4E75FBA = 1;
  }
  static_fields = TitleInfoEventRaidHpComponent_TypeInfo->static_fields;
  static_fields->WIDTH = 31.0;
  v8 = StringLiteral_19579/*"event_raid_ok"*/;
  static_fields->RESULT_OK_SPNAME = (struct System_String_o *)StringLiteral_19579/*"event_raid_ok"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&static_fields->RESULT_OK_SPNAME, v8, v1, v2, v3, v4, v5, v6);
  v9 = StringLiteral_19577/*"event_raid_ng"*/;
  v10 = TitleInfoEventRaidHpComponent_TypeInfo->static_fields;
  v10->RESULT_NG_SPNAME = (struct System_String_o *)StringLiteral_19577/*"event_raid_ng"*/;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&v10->RESULT_NG_SPNAME, v9, v11, v12, v13, v14, v15, v16);
}
...
LABEL_22:
      sub_1D0F30C(resultSp, *(_QWORD *)&dispHpType);
    }
    v6 = this->fields.resultSp;
    resultSp = (UnityEngine_Component_o *)TitleInfoEventRaidHpComponent_TypeInfo;
    if ( !TitleInfoEventRaidHpComponent_TypeInfo->_2.cctor_finished )
