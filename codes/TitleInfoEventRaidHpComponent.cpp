void __fastcall TitleInfoEventRaidHpComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E0C77 & 1) == 0 )
  {
    sub_1B00CCC(&TitleInfoEventRaidHpComponent_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_18967/*"event_raid_ok"*/, v4);
    sub_1B00CCC(&StringLiteral_18965/*"event_raid_ng"*/, v5);
    byte_48E0C77 = 1;
  }
  static_fields = TitleInfoEventRaidHpComponent_TypeInfo->static_fields;
  static_fields->WIDTH = 31.0;
  v7 = StringLiteral_18967/*"event_raid_ok"*/;
  static_fields->RESULT_OK_SPNAME = (struct System_String_o *)StringLiteral_18967/*"event_raid_ok"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->RESULT_OK_SPNAME, v7, v2, v3);
  v8 = StringLiteral_18965/*"event_raid_ng"*/;
  v9 = TitleInfoEventRaidHpComponent_TypeInfo->static_fields;
  v9->RESULT_NG_SPNAME = (struct System_String_o *)StringLiteral_18965/*"event_raid_ng"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v9->RESULT_NG_SPNAME, v8, v10, v11);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E0C76 & 1) == 0 )
  {
    sub_1B00CCC(&TitleInfoEventRaidHpComponent_TypeInfo, *(_QWORD *)&dispHpType);
    byte_48E0C76 = 1;
  }
...
LABEL_22:
      sub_1B00F28(resultSp, *(_QWORD *)&dispHpType);
    }
    v6 = this->fields.resultSp;
    resultSp = (UnityEngine_Component_o *)TitleInfoEventRaidHpComponent_TypeInfo;
    if ( !TitleInfoEventRaidHpComponent_TypeInfo->_2.cctor_finished )
