void __fastcall TitleInfoEventRaidHpComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B445C & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_18692/*"event_raid_ok"*/);
    sub_B52984(&StringLiteral_18690/*"event_raid_ng"*/);
    byte_42B445C = 1;
  }
  ...
  v8 = (System_Int32_array **)StringLiteral_18692/*"event_raid_ok"*/;
  static_fields->RESULT_OK_SPNAME = (struct System_String_o *)StringLiteral_18692/*"event_raid_ok"*/;
  sub_B52920((BattleServantConfConponent_o *)&static_fields->RESULT_OK_SPNAME, v8, v1, v2, v3, v4, v5, v6);
  v9 = TitleInfoEventRaidHpComponent_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_18690/*"event_raid_ng"*/;
  v9->RESULT_NG_SPNAME = (struct System_String_o *)StringLiteral_18690/*"event_raid_ng"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->RESULT_NG_SPNAME, v10, v11, v12, v13, v14, v15, v16);
}
...
LABEL_24:
      sub_B52A5C(resultSp, *(_QWORD *)&dispHpType);
    }
    v6 = this->fields.resultSp;
    resultSp = (UnityEngine_Component_o *)TitleInfoEventRaidHpComponent_TypeInfo;
    if ( (BYTE3(TitleInfoEventRaidHpComponent_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
