        ...
        const MethodInfo *method)
{
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.treasureData, (int64_t)treasure, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB2501 & 1) == 0 )
  {
    sub_1C13D24(&Method_NetworkManager_getRequest_WarBoardTreasureRequest___, method);
    sub_1C13D24(&NetworkManager_TypeInfo, v3);
    sub_1C13D24(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v4);
    byte_4BB2501 = 1;
  }
  Instance = (WarBoardTreasureRequest_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_9;
  ...
  Instance = (WarBoardTreasureRequest_o *)NetworkManager__getRequest_object_(
                                            0LL,
                                            (const MethodInfo_3013AB4 *)Method_NetworkManager_getRequest_WarBoardTreasureRequest___);
...
LABEL_9:
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.request, (int64_t)v9, v10, v11, v12, v13, v14, v15);
}