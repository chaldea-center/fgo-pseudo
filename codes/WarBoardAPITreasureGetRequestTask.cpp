        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.treasureData, (int32_t)treasure, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B50 & 1) == 0 )
  {
    sub_1B686D4(&Method_NetworkManager_getRequest_WarBoardTreasureRequest___, method);
  ...
  Instance = (WarBoardTreasureRequest_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_9;
  ...
  Instance = (WarBoardTreasureRequest_o *)NetworkManager__getRequest_object_(
                                            0LL,
                                            (const MethodInfo_2ECB448 *)Method_NetworkManager_getRequest_WarBoardTreasureRequest___);
...
LABEL_9:
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.request, (int32_t)v9, v10, v11);
}