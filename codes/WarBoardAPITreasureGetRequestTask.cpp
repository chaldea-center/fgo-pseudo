        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.treasureData, (int32_t)treasure, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BE1D & 1) == 0 )
  {
    sub_1B761C0(&Method_NetworkManager_getRequest_WarBoardTreasureRequest___, method);
  ...
  Instance = (WarBoardTreasureRequest_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_9;
  ...
  Instance = (WarBoardTreasureRequest_o *)NetworkManager__getRequest_object_(
                                            0LL,
                                            (const MethodInfo_2EE44C0 *)Method_NetworkManager_getRequest_WarBoardTreasureRequest___);
...
LABEL_9:
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.request, (int32_t)v9, v10, v11);
}