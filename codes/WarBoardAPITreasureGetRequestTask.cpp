        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.treasureData, (int64_t)treasure, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDA34E & 1) == 0 )
  {
    sub_1C21E38(&Method_NetworkManager_getRequest_WarBoardTreasureRequest___);
    sub_1C21E38(&NetworkManager_TypeInfo);
    sub_1C21E38(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    byte_4BDA34E = 1;
  }
  Instance = (WarBoardTreasureRequest_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_9;
  ...
  Instance = (WarBoardTreasureRequest_o *)NetworkManager__getRequest_object_(
                                            0LL,
                                            (const MethodInfo_30345EC *)Method_NetworkManager_getRequest_WarBoardTreasureRequest___);
...
LABEL_9:
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.request, (int64_t)v7, v8, v9, v10, v11, v12, v13);
}