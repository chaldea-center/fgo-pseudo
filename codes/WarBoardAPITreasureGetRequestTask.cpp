        ...
        const MethodInfo *method)
{
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.treasureData, (int32_t)treasure, v7, v8, v9, v10, v11, v12);
}
...
void WarBoardAPITreasureGetRequestTask__SetRequest(WarBoardAPITreasureGetRequestTask_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E611 & 1) == 0 )
  {
    sub_1C93AD4(&Method_NetworkManager_getRequest_WarBoardTreasureRequest___);
    sub_1C93AD4(&NetworkManager_TypeInfo);
    sub_1C93AD4(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    byte_4D2E611 = 1;
  }
  Instance = (WarBoardTreasureRequest_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
  if ( !Instance )
    goto LABEL_9;
  ...
  Instance = (WarBoardTreasureRequest_o *)NetworkManager__getRequest_object_(
                                            0,
                                            (const MethodInfo_322FB9C *)Method_NetworkManager_getRequest_WarBoardTreasureRequest___);
...
LABEL_9:
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.request, (int32_t)v7, v8, v9, v10, v11, v12, v13);
}