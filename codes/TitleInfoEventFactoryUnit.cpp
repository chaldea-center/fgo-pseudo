void __fastcall TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDA7F5 & 1) == 0 )
  {
    sub_1C21E38(&TitleInfoEventFactoryUnit_TypeInfo);
    sub_1C21E38(&StringLiteral_19697/*"factory_{0}_{1}"*/);
    byte_4BDA7F5 = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19697/*"factory_{0}_{1}"*/;
  sub_1C21DDC(
    (PartyOrganizationUtility_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields,
    StringLiteral_19697/*"factory_{0}_{1}"*/,
    v1,
    v2,
    v3,
    v4,
...
LABEL_40:
    sub_1C22094(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v16 = System_String__Format_63129848(SPRITE_NAME_ICON, v11, v15, 0LL);
