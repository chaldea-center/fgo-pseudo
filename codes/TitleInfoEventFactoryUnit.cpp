void __fastcall TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1A7C1 & 1) == 0 )
  {
    sub_1BCAFF8(&TitleInfoEventFactoryUnit_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_19212/*"factory_{0}_{1}"*/, v4);
    byte_4B1A7C1 = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19212/*"factory_{0}_{1}"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields, StringLiteral_19212/*"factory_{0}_{1}"*/, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A7C0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UnityEngine_GameObject_GetComponent_UIWidget___, *(_QWORD *)&count);
    sub_1BCAFF8(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, v8);
    sub_1BCAFF8(&Method_UITweener_Begin_TweenAlpha___, v9);
...
LABEL_40:
    sub_1BCB254(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1A7BF & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&TitleInfoEventFactoryUnit_TypeInfo, v10);
    byte_4B1A7BF = 1;
  }
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v18 = System_String__Format_62491716(SPRITE_NAME_ICON, v13, v17, 0LL);
