void TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4CB420E & 1) == 0 )
  {
    sub_1C6BA08(&TitleInfoEventFactoryUnit_TypeInfo);
    sub_1C6BA08(&StringLiteral_19445/*"factory_{0}_{1}"*/);
    byte_4CB420E = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19445/*"factory_{0}_{1}"*/;
  sub_1C6B9AC((CGThumbnailListItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields, StringLiteral_19445/*"factory_{0}_{1}"*/, v1, v2);
}
...
LABEL_40:
    sub_1C6BC60(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v13 = System_String__Format_64008100(SPRITE_NAME_ICON, v11, v12, 0);
