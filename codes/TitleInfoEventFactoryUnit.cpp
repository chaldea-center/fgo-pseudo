void TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C359AC & 1) == 0 )
  {
    sub_1C32C20(&TitleInfoEventFactoryUnit_TypeInfo);
    sub_1C32C20(&StringLiteral_19381/*"factory_{0}_{1}"*/);
    byte_4C359AC = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19381/*"factory_{0}_{1}"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields, StringLiteral_19381/*"factory_{0}_{1}"*/, v1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v22 = System_String__Format_63559836(SPRITE_NAME_ICON, v14, v21, 0);
