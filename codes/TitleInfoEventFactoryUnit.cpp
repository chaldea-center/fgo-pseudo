void __fastcall TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B0038A & 1) == 0 )
  {
    sub_1BC3008(&TitleInfoEventFactoryUnit_TypeInfo, v1);
    sub_1BC3008(&StringLiteral_19198/*"factory_{0}_{1}"*/, v4);
    byte_4B0038A = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19198/*"factory_{0}_{1}"*/;
  sub_1BC2FAC((CGThumbnailListItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields, StringLiteral_19198/*"factory_{0}_{1}"*/, v2, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B00389 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_UIWidget___, *(_QWORD *)&count);
    sub_1BC3008(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    sub_1BC3008(&UnityEngine_Object_TypeInfo, v8);
    sub_1BC3008(&Method_UITweener_Begin_TweenAlpha___, v9);
...
LABEL_40:
    sub_1BC3264(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B00388 & 1) == 0 )
  {
    ...
    sub_1BC3008(&TitleInfoEventFactoryUnit_TypeInfo, v10);
    byte_4B00388 = 1;
  }
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v18 = System_String__Format_62389940(SPRITE_NAME_ICON, v13, v17, 0LL);
