void __fastcall TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB4152 & 1) == 0 )
  {
    sub_1BAB41C(&TitleInfoEventFactoryUnit_TypeInfo, v1);
    sub_1BAB41C(&StringLiteral_19393/*"factory_{0}_{1}"*/, v4);
    byte_4AB4152 = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19393/*"factory_{0}_{1}"*/;
  sub_1BAB3C0(
    (ServantStatusBattleListViewItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields,
    StringLiteral_19393/*"factory_{0}_{1}"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB4151 & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_UIWidget___, *(_QWORD *)&count);
    sub_1BAB41C(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, v8);
    sub_1BAB41C(&Method_UITweener_Begin_TweenAlpha___, v9);
    sub_1BAB41C(&Method_UITweener_Begin_TweenPosition___, v10);
    byte_4AB4151 = 1;
  }
  if ( count >= 1 )
  {
...
LABEL_40:
    sub_1BAB678(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB4150 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&TitleInfoEventFactoryUnit_TypeInfo, v10);
    byte_4AB4150 = 1;
  }
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v18 = System_String__Format_62062500(SPRITE_NAME_ICON, v13, v17, 0LL);
