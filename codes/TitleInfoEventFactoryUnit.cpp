void TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E75980 & 1) == 0 )
  {
    sub_1D0F0B4(&TitleInfoEventFactoryUnit_TypeInfo);
    sub_1D0F0B4(&StringLiteral_19732/*"factory_{0}_{1}"*/);
    byte_4E75980 = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19732/*"factory_{0}_{1}"*/;
  sub_1D0F058(
    (GrandQuestFolderBoardItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields,
    StringLiteral_19732/*"factory_{0}_{1}"*/,
    v1,
    v2,
    v3,
    v4,
...
LABEL_40:
    sub_1D0F30C(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v13 = System_String__Format_65604080(SPRITE_NAME_ICON, v11, v12, 0);
