void __fastcall TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2BF58 & 1) == 0 )
  {
    sub_1B761C0(&TitleInfoEventFactoryUnit_TypeInfo, v1);
    sub_1B761C0(&StringLiteral_19357/*"factory_{0}_{1}"*/, v4);
    byte_4A2BF58 = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19357/*"factory_{0}_{1}"*/;
  sub_1B76164(
    (ServantStatusBattleListViewItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields,
    StringLiteral_19357/*"factory_{0}_{1}"*/,
    v2,
    v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BF57 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_UIWidget___, *(_QWORD *)&count);
    sub_1B761C0(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v8);
    sub_1B761C0(&Method_UITweener_Begin_TweenAlpha___, v9);
    sub_1B761C0(&Method_UITweener_Begin_TweenPosition___, v10);
    byte_4A2BF57 = 1;
  }
  if ( count >= 1 )
  {
...
LABEL_40:
    sub_1B7641C(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BF56 & 1) == 0 )
  {
    ...
    sub_1B761C0(&TitleInfoEventFactoryUnit_TypeInfo, v10);
    byte_4A2BF56 = 1;
  }
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v18 = System_String__Format_61549432(SPRITE_NAME_ICON, v13, v17, 0LL);
