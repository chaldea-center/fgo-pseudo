void __fastcall TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFB9E8 & 1) == 0 )
  {
    sub_1C2E12C(&TitleInfoEventFactoryUnit_TypeInfo, v1);
    sub_1C2E12C(&StringLiteral_19711/*"factory_{0}_{1}"*/, v8);
    byte_4BFB9E8 = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19711/*"factory_{0}_{1}"*/;
  sub_1C2E0D0(
    (PartyOrganizationUtility_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields,
    StringLiteral_19711/*"factory_{0}_{1}"*/,
    v2,
    v3,
    v4,
    v5,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB9E7 & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_UIWidget___, *(_QWORD *)&count);
    sub_1C2E12C(&Method_UnityEngine_Object_Instantiate_GameObject___, v7);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v8);
    sub_1C2E12C(&Method_UITweener_Begin_TweenAlpha___, v9);
...
LABEL_40:
    sub_1C2E388(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFB9E6 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&TitleInfoEventFactoryUnit_TypeInfo, v10);
    byte_4BFB9E6 = 1;
  }
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v18 = System_String__Format_63249956(SPRITE_NAME_ICON, v13, v17, 0LL);
