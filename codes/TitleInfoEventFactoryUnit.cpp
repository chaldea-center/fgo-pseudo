void TitleInfoEventFactoryUnit___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E02D0E & 1) == 0 )
  {
    sub_1CE6700(&TitleInfoEventFactoryUnit_TypeInfo);
    sub_1CE6700(&StringLiteral_19653/*"factory_{0}_{1}"*/);
    byte_4E02D0E = 1;
  }
  TitleInfoEventFactoryUnit_TypeInfo->static_fields->SPRITE_NAME_ICON = (struct System_String_o *)StringLiteral_19653/*"factory_{0}_{1}"*/;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)TitleInfoEventFactoryUnit_TypeInfo->static_fields,
    StringLiteral_19653/*"factory_{0}_{1}"*/,
    v1,
    v2,
    v3,
    v4,
...
LABEL_40:
    sub_1CE6958(iconSprite, *(_QWORD *)&count);
  }
LABEL_19:
        ...
        const MethodInfo *method)
{
  ...
  if ( lv >= 1 && this->fields.lv <= 0 )
  {
    ...
    v13 = System_String__Format_65164136(SPRITE_NAME_ICON, v11, v12, 0);
