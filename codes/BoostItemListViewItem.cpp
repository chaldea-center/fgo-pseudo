        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B687B & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_UserItemMaster___, *(_QWORD *)&index);
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.itemEntity, (int32_t)data, v13, v14);
...
System_String_o *__fastcall BoostItemListViewItem__get_NumText(BoostItemListViewItem_o *this, const MethodInfo *method)
{
  ...
  return System_String__Format((System_String_o *)StringLiteral_24683/*"{0:N0}"*/, v8, 0LL);
}
