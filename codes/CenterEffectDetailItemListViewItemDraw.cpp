void CenterEffectDetailItemListViewItemDraw___cctor(const MethodInfo *method)
{
  if ( (byte_4D2A525 & 1) == 0 )
  {
    sub_1C93AD4(&CenterEffectDetailItemListViewItemDraw_TypeInfo);
    byte_4D2A525 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A524 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_8563/*"Lv."*/);
    byte_4D2A524 = 1;
  }
  skillLevel = 0;
  ...
  if ( !levelLabel
    || (UILabel__set_fontSize(
        ...
        Instance = (DataManager_o *)System_String__Concat_64425724((System_String_o *)StringLiteral_8563/*"Lv."*/, v12, 0),
        !v11)
