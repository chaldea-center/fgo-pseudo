        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF87D & 1) == 0 )
  {
    sub_1B64870(&BgmManager_TypeInfo, name);
    sub_1B64870(&System_Convert_TypeInfo, v4);
    this = (EffectSoundPlayerComponent_o *)sub_1B64870(&SoundManager_TypeInfo, v5);
    byte_49FF87D = 1;
  }
  ...
  v12 = System_Convert__ToSingle_62044820(klass, 0LL);
  if ( m_CancellationTokenSource < 2 )
  {
    if ( !SoundManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
    SoundManager__playBgm_38385828(v10, v12, 0LL);
    return;
  }
  if ( LODWORD(v6->fields.m_CancellationTokenSource) <= 1 )
LABEL_19:
    sub_1B64AD4(BgmName, v9);
  v13 = System_Convert__ToSingle_62044820((System_String_o *)v6[1].monitor, 0LL);
  if ( !SoundManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(SoundManager_TypeInfo);
  SoundManager__playBgm_38385944(v10, v12, v13, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF879 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_BgmMaster___, bgmId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF877 & 1) == 0 )
  {
    this = (EffectSoundPlayerComponent_o *)sub_1B64870(&Method_EffectSoundPlayerComponent_PlaySe__, name);
    byte_49FF877 = 1;
  }
  if ( !name || (this = (EffectSoundPlayerComponent_o *)System_String__Split(name, 0x3Au, 0, 0LL)) == 0LL )
    sub_1B64ACC(this, name);
  ...
  if ( (*((_BYTE *)Method_EffectSoundPlayerComponent_PlaySe__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1B64888(Method_EffectSoundPlayerComponent_PlaySe__);
  ...
  if ( v9 <= 1 )
LABEL_13:
    sub_1B64AD4(v7, klass);
  OverwriteAssetSoundName__PlaySe_38220984(v7, klass, (System_String_o *)v4[1].monitor, 1.0, 0LL, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF878 & 1) == 0 )
  {
    this = (EffectSoundPlayerComponent_o *)sub_1B64870(&Method_EffectSoundPlayerComponent_PlaySeContinue__, name);
    byte_49FF878 = 1;
  }
  if ( !name || (this = (EffectSoundPlayerComponent_o *)System_String__Split(name, 0x3Au, 0, 0LL)) == 0LL )
    sub_1B64ACC(this, name);
  ...
  if ( (*((_BYTE *)Method_EffectSoundPlayerComponent_PlaySeContinue__ + 83) & 2) != 0 )
    v6 = (_QWORD *)sub_1B64888(Method_EffectSoundPlayerComponent_PlaySeContinue__);
  v7 = (System_Reflection_MethodBase_o *)sub_1B64854(v6, v6[4]);
  v9 = (unsigned int)v4->fields.m_CancellationTokenSource;
  if ( !v9 )
    goto LABEL_13;
...
LABEL_13:
    sub_1B64AD4(v7, klass);
  OverwriteAssetSoundName__PlaySeContinue_38220280(v7, klass, (System_String_o *)v4[1].monitor, 0LL);
}
