        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A6C2 & 1) == 0 )
  {
    sub_1B863B8(&ServantOperationListViewManager_TypeInfo, surface);
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1B863B8(&ServantOperationListViewObject_TypeInfo, v4);
    byte_4A4A6C2 = 1;
  }
  mListViewObject = (ServantOperationListViewManager_o **)v3->fields.mListViewObject;
  if ( !mListViewObject )
LABEL_11:
    sub_1B86614(this, surface);
        ...
        const MethodInfo *method)
{
  ...
  manager = (ServantOperationListViewManager_o *)&byte_4A4A000;
  if ( (byte_4A4A6BC & 1) == 0 )
  {
    sub_1B863B8(&ServantOperationListViewManager_TypeInfo, method);
    sub_1B863B8(&ServantOperationListViewObject_TypeInfo, v5);
    byte_4A4A6BC = 1;
  }
...
LABEL_13:
  ...
  v16 = (ServantOperationUIDragDropListViewItem_o *)sub_1B868D4(manager);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A6BD & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, isPressed);
    byte_4A4A6BD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A6C0 & 1) == 0 )
  {
    sub_1B863B8(&Method_UnityEngine_Component_GetComponent_ServantOperationListViewObject___, method);
    sub_1B863B8(&UnityEngine_Object_TypeInfo, v2);
    sub_1B863B8(&UnityEngine_Physics_TypeInfo, v3);
  ...
  UnityEngine_Camera__ScreenPointToRay_69162668(&v21, v9, v24, 0LL);
  v22 = v21;
  if ( !UnityEngine_Physics_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Physics_TypeInfo);
  v20 = v22;
  if ( UnityEngine_Physics__Raycast_69671456(&v20, &v23, 0LL) )
  {
    ...
    Component_object = UnityEngine_Component__GetComponent_object_(
                         ...
                         (const MethodInfo_2F646C0 *)Method_UnityEngine_Component_GetComponent_ServantOperationListViewObject___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
    ...
    if ( ((unsigned __int8)main & 1) == 0 )
    {
      if ( Component_object )
      {
        ...
        if ( monitor )
        {
          ...
          {
            v19 = sub_1B868D4(Component_object[2].monitor);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A6C1 & 1) == 0 )
  {
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1B863B8(&UnityEngine_Object_TypeInfo, scrollView);
    byte_4A4A6C1 = 1;
  }
  if ( !scrollView )
    goto LABEL_44;
...
LABEL_25:
        ...
        if ( v7 > (float)-y
          || (v18.fields.x = 0.0,
              v18.fields.y = 1.0,
              v18.fields.z = 0.0,
              UIScrollView__IsLimitOverPosition2_47735616(scrollView, v18, 0LL)) )
        {
          if ( v7 < y )
            return;
          v14 = 0.0;
...
LABEL_37:
          v16 = 0;
          if ( UIScrollView__IsLimitOverPosition2_47735616(scrollView, *(UnityEngine_Vector3_o *)&v14, 0LL) )
            return;
          v17 = 0.5;
LABEL_43:
  ...
  if ( !v10->fields.isLimit )
  {
    if ( v8 > (float)-x
      || (v19.fields.x = 1.0,
          v19.fields.y = 0.0,
          v19.fields.z = 0.0,
          UIScrollView__IsLimitOverPosition2_47735616(scrollView, v19, 0LL)) )
    {
      if ( v8 < x )
        return;
      v14 = -1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A6BF & 1) == 0 )
  {
    ...
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1B863B8(&UICamera_TypeInfo, v4);
    byte_4A4A6BF = 1;
  }
  if ( v2->fields.isDrag )
  {
      ...
      if ( ((unsigned __int8)main & 1) == 0 )
      {
        if ( scrollView )
        {
          ...
          if ( v11 )
          {
            ...
            *(UnityEngine_Vector3_o *)&v14 = UnityEngine_Camera__ScreenToWorldPoint_69162204(v11, v32, 0LL);
            if ( monitor )
            {
              v17 = v14;
              v18 = v15;
              ...
              if ( main )
              {
                ...
                *(UnityEngine_Vector3_o *)&v20 = UnityEngine_Transform__InverseTransformPoint(
                ...
                if ( mCollider )
                {
                  ...
                  sub_1B868D4(v2->fields.mCollider);
                }
