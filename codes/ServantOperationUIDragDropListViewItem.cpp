        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC34E7 & 1) == 0 )
  {
    ...
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1C713B0(&ServantOperationListViewObject_TypeInfo);
    byte_4CC34E7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  manager = (ServantOperationListViewManager_o *)&byte_4CC3000;
  if ( (byte_4CC34E1 & 1) == 0 )
  {
    sub_1C713B0(&ServantOperationListViewManager_TypeInfo);
...
LABEL_13:
  ...
  v12 = (ServantOperationUIDragDropListViewItem_o *)sub_1C719A4(manager);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC34E5 & 1) == 0 )
  {
    sub_1C713B0(&Method_UnityEngine_Component_GetComponent_ServantOperationListViewObject___);
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
  ...
  UnityEngine_Camera__ScreenPointToRay_71529668(&v11, v5, v14, 0);
  v12 = v11;
  if ( !UnityEngine_Physics_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Physics_TypeInfo);
  v10 = v12;
  if ( UnityEngine_Physics__Raycast_72043260(&v10, &v13, 0) )
  {
    ...
    Component_object = (UnityEngine_Object_o *)UnityEngine_Component__GetComponent_object_(
                                                 ...
                                                 (const MethodInfo_31418DC *)Method_UnityEngine_Component_GetComponent_ServantOperationListViewObject___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC34E6 & 1) == 0 )
  {
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1C713B0(&UnityEngine_Object_TypeInfo);
    byte_4CC34E6 = 1;
  }
  if ( !scrollView )
    goto LABEL_44;
...
LABEL_25:
        ...
        if ( v7 > (float)-y
          || (v18.fields.x = 0.0,
              v18.fields.y = 1.0,
              v18.fields.z = 0.0,
              UIScrollView__IsLimitOverPosition2_49603856(scrollView, v18, 0)) )
        {
          if ( v7 < y )
            return;
          v14 = 0.0;
...
LABEL_37:
          v16 = 0;
          if ( UIScrollView__IsLimitOverPosition2_49603856(scrollView, *(UnityEngine_Vector3_o *)&v14, 0) )
            return;
          v17 = 0.5;
LABEL_43:
  ...
  if ( !v10->fields.isLimit )
  {
    if ( v8 > (float)-x
      || (v19.fields.x = 1.0,
          v19.fields.y = 0.0,
          v19.fields.z = 0.0,
          UIScrollView__IsLimitOverPosition2_49603856(scrollView, v19, 0)) )
    {
      if ( v8 < x )
        return;
      v14 = -1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC34E4 & 1) == 0 )
  {
    ...
    sub_1C713B0(&UnityEngine_Object_TypeInfo);
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1C713B0(&UICamera_TypeInfo);
    byte_4CC34E4 = 1;
  }
  if ( v2->fields.isDrag )
  {
      ...
      if ( ((unsigned __int8)main & 1) == 0 )
      {
        if ( scrollView )
        {
          ...
          if ( v9 )
          {
            ...
            v25 = UnityEngine_Camera__ScreenToWorldPoint_71529204(v9, v24, 0);
            if ( monitor )
            {
              x = v25.fields.x;
              y = v25.fields.y;
              ...
              if ( main )
              {
                ...
                if ( mCollider )
                {
                  ...
                  sub_1C719A4(v2->fields.mCollider);
                }
