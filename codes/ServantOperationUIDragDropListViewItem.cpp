        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C028 & 1) == 0 )
  {
    sub_1B715CC(&ServantOperationListViewManager_TypeInfo, surface);
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1B715CC(&ServantOperationListViewObject_TypeInfo, v4);
    byte_4A1C028 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  manager = (ServantOperationListViewManager_o *)&byte_4A1C000;
  if ( (byte_4A1C022 & 1) == 0 )
  {
    sub_1B715CC(&ServantOperationListViewManager_TypeInfo, method);
    sub_1B715CC(&ServantOperationListViewObject_TypeInfo, v5);
    byte_4A1C022 = 1;
  }
...
LABEL_13:
  ...
  v15 = (ServantOperationUIDragDropListViewItem_o *)sub_1B71AE8(manager);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C023 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, isPressed);
    byte_4A1C023 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C026 & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_Component_GetComponent_ServantOperationListViewObject___, method);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v2);
    sub_1B715CC(&UnityEngine_Physics_TypeInfo, v3);
  ...
  UnityEngine_Camera__ScreenPointToRay_69064632(&v15, v9, v18, 0LL);
  v16 = v15;
  if ( !UnityEngine_Physics_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Physics_TypeInfo);
  v14 = v16;
  if ( UnityEngine_Physics__Raycast_69570744(&v14, &v17, 0LL) )
  {
    ...
    Component_object = UnityEngine_Component__GetComponent_object_(
                         ...
                         (const MethodInfo_2E51E8C *)Method_UnityEngine_Component_GetComponent_ServantOperationListViewObject___);
    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C027 & 1) == 0 )
  {
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1B715CC(&UnityEngine_Object_TypeInfo, scrollView);
    byte_4A1C027 = 1;
  }
  if ( !scrollView )
    goto LABEL_44;
...
LABEL_25:
        ...
        if ( v7 > (float)-y
          || (v18.fields.x = 0.0,
              v18.fields.y = 1.0,
              v18.fields.z = 0.0,
              UIScrollView__IsLimitOverPosition2_46606560(scrollView, v18, 0LL)) )
        {
          if ( v7 < y )
            return;
          v14 = 0.0;
...
LABEL_37:
          v16 = 0;
          if ( UIScrollView__IsLimitOverPosition2_46606560(scrollView, *(UnityEngine_Vector3_o *)&v14, 0LL) )
            return;
          v17 = 0.5;
LABEL_43:
  ...
  if ( !v10->fields.isLimit )
  {
    if ( v8 > (float)-x
      || (v19.fields.x = 1.0,
          v19.fields.y = 0.0,
          v19.fields.z = 0.0,
          UIScrollView__IsLimitOverPosition2_46606560(scrollView, v19, 0LL)) )
    {
      if ( v8 < x )
        return;
      v14 = -1.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C025 & 1) == 0 )
  {
    ...
    this = (ServantOperationUIDragDropListViewItem_o *)sub_1B715CC(&UICamera_TypeInfo, v4);
    byte_4A1C025 = 1;
  }
  if ( v2->fields.isDrag )
  {
      ...
      if ( ((unsigned __int8)main & 1) == 0 )
      {
        if ( scrollView )
        {
          ...
          if ( v11 )
          {
            ...
            *(UnityEngine_Vector3_o *)&v14 = UnityEngine_Camera__ScreenToWorldPoint_69064168(v11, v32, 0LL);
            if ( monitor )
            {
              v17 = v14;
              v18 = v15;
              ...
              if ( main )
              {
                ...
                *(UnityEngine_Vector3_o *)&v20 = UnityEngine_Transform__InverseTransformPoint(
                ...
                if ( mCollider )
                {
                  ...
                  sub_1B71AE8(v2->fields.mCollider);
                }
