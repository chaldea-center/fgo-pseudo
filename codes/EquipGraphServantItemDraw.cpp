        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C8C3 & 1) == 0 )
  {
    ...
    this = (EquipGraphServantItemDraw_o *)sub_1BCAFF8(&StringLiteral_1/*""*/, v11);
    byte_4B1C8C3 = 1;
  }
  skillInfoList = 0LL;
  if ( !v7 )
  ...
  if ( UnityEngine_Object__op_Inequality(servantCostIconLabel, 0LL, 0LL) )
  {
    ...
    UIIconLabel__Set_40290232((UIIconLabel_o *)this, 7, cost, 0, v16, 0LL, 0, 0, 0, 0, 0LL);
  }
  ...
  if ( equipUserSvtEntity )
  {
    ...
    *(_QWORD *)&v59.fields.fakeValue = v24;
    v26 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48125176(v59, 0LL);
...
LABEL_57:
  ...
  if ( UnityEngine_Object__op_Inequality(costIconLabel, 0LL, 0LL) )
  {
    ...
    if ( !this )
      goto LABEL_116;
LABEL_66:
    UIIconLabel__Set_40290232((UIIconLabel_o *)this, 7, (_DWORD)v35 + (_DWORD)servantEntity, 0, 0, 0LL, 0, 0, 0, 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(differCostIconLabel, 0LL, 0LL) )
  {
    ...
    UIIconLabel__Set_40290232((UIIconLabel_o *)this, 43, v38, 0, 0, 0LL, 0, 0, 0, 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(hpIconLabel, 0LL, 0LL) )
  {
    ...
    UIIconLabel__Set_40290232(v41, 3, hp + addBaseHp, (int32_t)this, v44, 0LL, 0, 0, 0, 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(differHpIconLabel, 0LL, 0LL) )
  {
    ...
    UIIconLabel__Set_40290232((UIIconLabel_o *)this, 41, v47, 0, 0, 0LL, 0, 0, 0, 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(attackIconLabel, 0LL, 0LL) )
  {
    ...
    UIIconLabel__Set_40290232(v50, 5, atk + addBaseAtk, (int32_t)this, v53, 0LL, 0, 0, 0, 0, 0LL);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(differAttackIconLabel, 0LL, 0LL) )
  {
    ...
    UIIconLabel__Set_40290232((UIIconLabel_o *)this, 42, v56, 0, 0, 0LL, 0, 0, 0, 0, 0LL);
  }
