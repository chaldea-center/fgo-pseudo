        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    503,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_GachaPickupCollateralGroupMaster__GachaPickupCollateralGroupEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (GachaPickupCollateralGroupEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                                 PK,
                                                 (const MethodInfo_312C900 *)Method_DataMasterBase_GachaPickupCollateralGroupMaster__GachaPickupCollateralGroupEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_GachaPickupCollateralGroupMaster__GachaPickupCollateralGroupEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70107 & 1) == 0 )
  {
    ...
    sub_1B90010(&GachaPickupCollateralGroupEntity_TypeInfo, v7);
  ...
  *gachaPickupCollateralGroupEntity = 0LL;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)gachaPickupCollateralGroupEntity, 0, gachaId, (int32_t)method);
    ...
    if ( v23 )
    {
        ...
        && v23->fields.gachaId == gachaId )
      {
        *gachaPickupCollateralGroupEntity = v23;
        sub_1B8FFB4((ServantStatusBattleListViewItem_o *)gachaPickupCollateralGroupEntity, (int32_t)v23, v24, v25);
        v27 = 1;
        goto LABEL_24;
      }
    }
