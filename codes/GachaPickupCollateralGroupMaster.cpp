        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    510,
    (const MethodInfo_32B1804 *)Method_DataMasterBase_GachaPickupCollateralGroupMaster__GachaPickupCollateralGroupEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (GachaPickupCollateralGroupEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                                 PK,
                                                 (const MethodInfo_32B3B28 *)Method_DataMasterBase_GachaPickupCollateralGroupMaster__GachaPickupCollateralGroupEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_32B3B74 *)Method_DataMasterBase_GachaPickupCollateralGroupMaster__GachaPickupCollateralGroupEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B022DF & 1) == 0 )
  {
    ...
    sub_1BC3008(&System_Collections_Generic_IEnumerator_GachaPickupCollateralGroupEntity__TypeInfo, v8);
    sub_1BC3008(&System_Collections_IEnumerator_TypeInfo, v9);
    byte_4B022DF = 1;
  }
  *gachaPickupCollateralGroupEntity = 0LL;
  sub_1BC2FAC((CGThumbnailListItem_o *)gachaPickupCollateralGroupEntity, 0, gachaId, method);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    sub_1BC3264(0LL, v10);
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_324AE30 *)Method_System_Collections_ObjectModel_Collection_GachaPickupCollateralGroupEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BC3264(0LL, v12);
  while ( 1 )
  {
...
LABEL_16:
    ...
    if ( v22 && v22->fields.gachaId == gachaId )
    {
      *gachaPickupCollateralGroupEntity = v22;
      sub_1BC2FAC((CGThumbnailListItem_o *)gachaPickupCollateralGroupEntity, (int32_t)v22, v23, v24);
      v25 = 1;
      goto LABEL_22;
    }
  }
