        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22F5A & 1) == 0 )
  {
    sub_1B715CC(&ClassBoardSquareModel_TypeInfo, method);
    sub_1B715CC(&System_IDisposable_TypeInfo, v3);
    sub_1B715CC(&System_Collections_Generic_IEnumerable_IClassBoardSquareModel__TypeInfo, v4);
    sub_1B715CC(&System_Collections_Generic_IEnumerator_IClassBoardSquareModel__TypeInfo, v5);
    squareList = (System_Collections_Generic_IReadOnlyList_IClassBoardSquareModel__o *)sub_1B715CC(
                                                                                         &System_Collections_IEnumerator_TypeInfo,
                                                                                         v6);
    byte_4A22F5A = 1;
  }
  if ( !v2 )
    sub_1B71828(squareList, method);
  klass = v2->klass;
  ...
  {
LABEL_8:
    p_method = sub_1BC35AC(v2, System_Collections_Generic_IEnumerable_IClassBoardSquareModel__TypeInfo, 0LL);
  }
  ...
  while ( 1 )
  {
    ...
    {
LABEL_15:
      v16 = sub_1BC35AC(v12, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_22:
      v20 = sub_1BC35AC(v12, System_Collections_Generic_IEnumerator_IClassBoardSquareModel__TypeInfo, 0LL);
    }
  ...
  {
LABEL_29:
    v24 = sub_1BC35AC(v12, System_IDisposable_TypeInfo, 0LL);
  }
  (*(void (__fastcall **)(__int64, _QWORD))v24)(v12, *(_QWORD *)(v24 + 8));
}


void __fastcall ClassBoardValidator__Check_44301288(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22F5B & 1) == 0 )
  {
    ...
    sub_1B715CC(&System_Collections_Generic_IEnumerable_IClassBoardLineModel__TypeInfo, v3);
    sub_1B715CC(&System_Collections_Generic_IEnumerator_IClassBoardLineModel__TypeInfo, v4);
    lineList = (System_Collections_Generic_IReadOnlyList_IClassBoardLineModel__o *)sub_1B715CC(
                                                                                     &System_Collections_IEnumerator_TypeInfo,
                                                                                     v5);
    byte_4A22F5B = 1;
  }
  if ( !v2 )
    sub_1B71828(lineList, method);
  klass = v2->klass;
  ...
  {
LABEL_8:
    p_method = sub_1BC35AC(v2, System_Collections_Generic_IEnumerable_IClassBoardLineModel__TypeInfo, 0LL);
  }
  ...
  while ( 1 )
  {
    ...
    {
LABEL_15:
      v15 = sub_1BC35AC(v11, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_22:
      v19 = sub_1BC35AC(v11, System_Collections_Generic_IEnumerator_IClassBoardLineModel__TypeInfo, 0LL);
    }
  ...
  {
LABEL_29:
    v23 = sub_1BC35AC(v11, System_IDisposable_TypeInfo, 0LL);
  }
