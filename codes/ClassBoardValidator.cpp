        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E62A & 1) == 0 )
  {
    ...
    squareList = (System_Collections_Generic_IReadOnlyList_IClassBoardSquareModel__o *)sub_1B885B0(&System_Collections_IEnumerator_TypeInfo);
    byte_4A5E62A = 1;
  }
  if ( !v2 )
    sub_1B8880C(squareList, method);
  klass = v2->klass;
  ...
  {
LABEL_8:
    p_method = sub_1BDA590(v2, System_Collections_Generic_IEnumerable_IClassBoardSquareModel__TypeInfo, 0LL);
  }
  ...
  while ( 1 )
  {
    ...
    {
LABEL_15:
      v12 = sub_1BDA590(v8, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_22:
      v16 = sub_1BDA590(v8, System_Collections_Generic_IEnumerator_IClassBoardSquareModel__TypeInfo, 0LL);
    }
  ...
  {
LABEL_29:
    v20 = sub_1BDA590(v8, System_IDisposable_TypeInfo, 0LL);
  }
  (*(void (__fastcall **)(__int64, _QWORD))v20)(v8, *(_QWORD *)(v20 + 8));
}


void __fastcall ClassBoardValidator__Check_44522616(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E62B & 1) == 0 )
  {
    ...
    lineList = (System_Collections_Generic_IReadOnlyList_IClassBoardLineModel__o *)sub_1B885B0(&System_Collections_IEnumerator_TypeInfo);
    byte_4A5E62B = 1;
  }
  if ( !v2 )
    sub_1B8880C(lineList, method);
  klass = v2->klass;
  v4 = *(unsigned __int16 *)(&v2->klass->_2.bitflags2 + 3);
  if ( *(_WORD *)(&v2->klass->_2.bitflags2 + 3) )
  {
  ...
  {
LABEL_8:
    p_method = sub_1BDA590(v2, System_Collections_Generic_IEnumerable_IClassBoardLineModel__TypeInfo, 0LL);
  }
...
LABEL_15:
    ...
    {
LABEL_22:
      v16 = sub_1BDA590(v8, System_Collections_Generic_IEnumerator_IClassBoardLineModel__TypeInfo, 0LL);
    }
    (*(void (__fastcall **)(__int64, _QWORD))v16)(v8, *(_QWORD *)(v16 + 8));
  }
  v17 = *(_QWORD *)v8;
