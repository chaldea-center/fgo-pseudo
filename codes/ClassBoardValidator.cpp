        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42146DC & 1) == 0 )
  {
    sub_B0D8A4(&ClassBoardSquareModel_TypeInfo, method);
    sub_B0D8A4(&System_IDisposable_TypeInfo, v3);
    sub_B0D8A4(&System_Collections_Generic_IEnumerable_IClassBoardSquareModel__TypeInfo, v4);
    sub_B0D8A4(&System_Collections_Generic_IEnumerator_IClassBoardSquareModel__TypeInfo, v5);
    squareList = (System_Collections_Generic_IReadOnlyList_IClassBoardSquareModel__o *)sub_B0D8A4(
                                                                                         &System_Collections_IEnumerator_TypeInfo,
                                                                                         v6);
    byte_42146DC = 1;
  }
  if ( !v2 )
    sub_B0D97C(squareList);
  klass = v2->klass;
  if ( *(_WORD *)&v2->klass->_2.bitflags1 )
  {
    ...
    while ( *((System_Collections_Generic_IEnumerable_IClassBoardSquareModel__c **)p_offset - 1) != System_Collections_Generic_IEnumerable_IClassBoardSquareModel__TypeInfo )
    {
      ++v8;
      p_offset += 4;
      if ( v8 >= *(unsigned __int16 *)&v2->klass->_2.bitflags1 )
        goto LABEL_8;
    }
  ...
  {
LABEL_8:
    p_method = sub_AA67A0(v2, System_Collections_Generic_IEnumerable_IClassBoardSquareModel__TypeInfo, 0LL);
  }
  ...
  while ( 1 )
  {
    ...
    {
LABEL_15:
      v15 = sub_AA67A0(v11, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_22:
      v19 = sub_AA67A0(v11, System_Collections_Generic_IEnumerator_IClassBoardSquareModel__TypeInfo, 0LL);
    }
  ...
  {
LABEL_29:
    v23 = sub_AA67A0(v11, System_IDisposable_TypeInfo, 0LL);
  }
  (*(void (__fastcall **)(__int64, _QWORD))v23)(v11, *(_QWORD *)(v23 + 8));
}


void __fastcall ClassBoardValidator__Check_24599312(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42146DD & 1) == 0 )
  {
    ...
    sub_B0D8A4(&System_Collections_Generic_IEnumerable_IClassBoardLineModel__TypeInfo, v3);
    sub_B0D8A4(&System_Collections_Generic_IEnumerator_IClassBoardLineModel__TypeInfo, v4);
    lineList = (System_Collections_Generic_IReadOnlyList_IClassBoardLineModel__o *)sub_B0D8A4(
                                                                                     &System_Collections_IEnumerator_TypeInfo,
                                                                                     v5);
    byte_42146DD = 1;
  }
  ...
  if ( *(_WORD *)&v2->klass->_2.bitflags1 )
  {
    ...
    while ( *((System_Collections_Generic_IEnumerable_IClassBoardLineModel__c **)p_offset - 1) != System_Collections_Generic_IEnumerable_IClassBoardLineModel__TypeInfo )
    {
      ++v7;
      p_offset += 4;
      if ( v7 >= *(unsigned __int16 *)&v2->klass->_2.bitflags1 )
        goto LABEL_8;
    }
    p_method = (__int64)&klass->vtable[*p_offset].method;
  }
  ...
  {
LABEL_8:
    p_method = sub_AA67A0(v2, System_Collections_Generic_IEnumerable_IClassBoardLineModel__TypeInfo, 0LL);
  }
  ...
  while ( 1 )
  {
    ...
    {
LABEL_15:
      v14 = sub_AA67A0(v10, System_Collections_IEnumerator_TypeInfo, 0LL);
    }
    ...
    {
LABEL_22:
      v18 = sub_AA67A0(v10, System_Collections_Generic_IEnumerator_IClassBoardLineModel__TypeInfo, 0LL);
    }
  ...
  {
LABEL_29:
    v22 = sub_AA67A0(v10, System_IDisposable_TypeInfo, 0LL);
  }
