...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFAD09 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_16551/*"_MainTex"*/, v4);
    byte_4BFAD09 = 1;
  }
  ...
  {
LABEL_18:
    sub_1C2E388(material, v7);
  }
  if ( !UnityEngine_Material__HasProperty_70855900(material, (System_String_o *)StringLiteral_16551/*"_MainTex"*/, 0LL) )
  {
LABEL_17:
