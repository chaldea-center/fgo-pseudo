...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B199D5 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_16128/*"_MainTex"*/, v4);
    byte_4B199D5 = 1;
  }
  ...
  {
LABEL_18:
    sub_1BCB254(material, v7);
  }
  if ( !UnityEngine_Material__HasProperty_70002212(material, (System_String_o *)StringLiteral_16128/*"_MainTex"*/, 0LL) )
  {
LABEL_17:
