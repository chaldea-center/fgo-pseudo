...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFF4FF & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_16116/*"_MainTex"*/, v4);
    byte_4AFF4FF = 1;
  }
  ...
  {
LABEL_18:
    sub_1BC3264(material, v7);
  }
  if ( !UnityEngine_Material__HasProperty_69900436(material, (System_String_o *)StringLiteral_16116/*"_MainTex"*/, 0LL) )
  {
LABEL_17:
