...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6D58D & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_16287/*"_MainTex"*/, v4);
    byte_4A6D58D = 1;
  }
  ...
  {
LABEL_18:
    sub_1B9026C(material, v7);
  }
  if ( !UnityEngine_Material__HasProperty_69405708(material, (System_String_o *)StringLiteral_16287/*"_MainTex"*/, 0LL) )
  {
LABEL_17:
