...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)material & 1) == 0 )
  {
    ...
    if ( !material )
      goto LABEL_13;
    if ( UnityEngine_Material__HasProperty_41519220(material, (System_String_o *)StringLiteral_16120/*"_MainTex"*/, 0LL) )
    {
      ...
      if ( material )
      {
        v10.fields.x = v7;
        v10.fields.y = v9;
        UnityEngine_Material__SetTextureOffset(material, (System_String_o *)StringLiteral_16120/*"_MainTex"*/, v10, 0LL);
        return;
      }
LABEL_13:
      sub_B52A5C(material, v5);
    }
  }
