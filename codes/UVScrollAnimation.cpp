...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B641B1 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_16471/*"_MainTex"*/, v4);
    byte_4B641B1 = 1;
  }
  ...
  {
LABEL_18:
    sub_1BE4D28(material, v7);
  }
  if ( !UnityEngine_Material__HasProperty_70318180(material, (System_String_o *)StringLiteral_16471/*"_MainTex"*/, 0LL) )
  {
LABEL_17:
