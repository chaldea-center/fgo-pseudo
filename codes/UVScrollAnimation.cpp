...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1F510 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_16579/*"aspectRatio"*/, v4);
    byte_4C1F510 = 1;
  }
  ...
  {
LABEL_18:
    sub_1C3B9C0(material, v7);
  }
  if ( !UnityEngine_Material__HasProperty_70988928(material, (System_String_o *)StringLiteral_16579/*"aspectRatio"*/, 0LL) )
  {
LABEL_17:
