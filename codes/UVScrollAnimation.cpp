...
void __fastcall UVScrollAnimation__UpdateUVOffset(UVScrollAnimation_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B347B3 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_16450/*"_MainTex"*/, v4);
    byte_4B347B3 = 1;
  }
  ...
  {
LABEL_18:
    sub_1BD36B4(material, v7);
  }
  if ( !UnityEngine_Material__HasProperty_70144452(material, (System_String_o *)StringLiteral_16450/*"_MainTex"*/, 0LL) )
  {
LABEL_17:
