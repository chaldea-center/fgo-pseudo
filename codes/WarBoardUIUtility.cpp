void __fastcall WarBoardUIUtility__ShowRuleDialog(System_Action_o *callbackFunc, const MethodInfo *method)
{
  ...
  if ( (byte_435266A & 1) == 0 )
  {
    ...
    sub_B70694(&Method_WarBoardUIUtility_ShowRuleDialog__);
    sub_B70694(&WebViewManager_TypeInfo);
    sub_B70694(&StringLiteral_24040/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/);
    sub_B70694(&StringLiteral_15592/*"WEB_VIEW_TITLE_WARBOARD_RULE"*/);
    byte_435266A = 1;
  }
  v3 = Method_WarBoardUIUtility_ShowRuleDialog__;
  if ( (*((_BYTE *)Method_WarBoardUIUtility_ShowRuleDialog__ + 75) & 2) != 0 )
    v3 = (_QWORD *)sub_B7069C(Method_WarBoardUIUtility_ShowRuleDialog__);
  ...
  {
    MasterData_WarQuestSelectionMaster = (__int64)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      ...
      if ( Instance )
      {
        ...
        if ( warBoardData_k__BackingField )
        {
          ...
          if ( v10 )
          {
            ...
            v14 = (System_Object_array *)sub_B706AC(object___TypeInfo, 5LL);
            if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
              && !NetworkManager_TypeInfo->_2.cctor_finished )
            {
              j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
            }
            MasterData_WarQuestSelectionMaster = (__int64)NetworkManager__getWebViewAddress_25961988(13, 0LL);
            if ( v14 )
            {
              v21 = (System_Int32_array **)MasterData_WarQuestSelectionMaster;
              if ( MasterData_WarQuestSelectionMaster )
              {
                MasterData_WarQuestSelectionMaster = sub_B70754(
                                                       MasterData_WarQuestSelectionMaster,
              ...
              sub_B70630((BattleServantConfConponent_o *)v14->m_Items, v21, v15, v16, v17, v18, v19, v20);
              detailUrl = (System_Int32_array **)v12->fields.detailUrl;
              if ( detailUrl )
              {
                MasterData_WarQuestSelectionMaster = sub_B70754(detailUrl, v14->obj.klass->_1.element_class);
                if ( !MasterData_WarQuestSelectionMaster )
                  goto LABEL_51;
              }
              if ( v14->max_length <= 1 )
              ...
              sub_B70630((BattleServantConfConponent_o *)&v14->m_Items[1], detailUrl, v22, v23, v24, v25, v26, v27);
              ...
              sub_B70630((BattleServantConfConponent_o *)&v14->m_Items[2], v36, v30, v31, v32, v33, v34, v35);
              if ( !byte_435273D )
              {
                sub_B70694(&NetworkManager_TypeInfo);
                byte_435273D = 1;
              ...
              MasterData_WarQuestSelectionMaster = sub_B706AC(char___TypeInfo, 1LL);
              if ( MasterData_WarQuestSelectionMaster )
              {
                ...
                *(_WORD *)(MasterData_WarQuestSelectionMaster + 32) = 47;
                if ( gameServerAddress )
                {
                                                               ...
                                                               v14->obj.klass->_1.element_class)) != 0 )
                  {
                    ...
                    sub_B70630((BattleServantConfConponent_o *)&v14->m_Items[3], v45, v39, v40, v41, v42, v43, v44);
                    v58 = HasNewWinCond;
                                                                 ...
                                                                 v14->obj.klass->_1.element_class)) != 0 )
                    {
                      if ( v14->max_length > 4 )
                      {
                        ...
                        sub_B70630((BattleServantConfConponent_o *)&v14->m_Items[4], v53, v47, v48, v49, v50, v51, v52);
                        v54 = System_String__Format_44836892((System_String_o *)StringLiteral_24040/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/, v14, 0LL);
                        if ( (BYTE3(LocalizationManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
                          && !LocalizationManager_TypeInfo->_2.cctor_finished )
                        {
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        }
                        v55 = LocalizationManager__Get((System_String_o *)StringLiteral_15592/*"WEB_VIEW_TITLE_WARBOARD_RULE"*/, 0LL);
...
LABEL_50:
                      v56 = sub_B70798(MasterData_WarQuestSelectionMaster);
                      sub_B70738(v56, 0LL);
                    }
                  }
LABEL_51:
                  v57 = sub_B7078C(MasterData_WarQuestSelectionMaster);
                  sub_B70738(v57, 0LL);
                }
              }
            }
    ...
    sub_B7076C(MasterData_WarQuestSelectionMaster, v7);
  }
}