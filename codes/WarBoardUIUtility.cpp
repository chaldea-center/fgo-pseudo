void __fastcall WarBoardUIUtility__ShowRuleDialog(System_Action_o *callbackFunc, const MethodInfo *method)
{
  ...
  if ( (byte_4A06C32 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_WarBoardStageDetailMaster___, method);
    sub_1B686D4(&int_TypeInfo, v3);
    sub_1B686D4(&LocalizationManager_TypeInfo, v4);
    sub_1B686D4(&NetworkManager_TypeInfo, v5);
    sub_1B686D4(&object___TypeInfo, v6);
    ...
    sub_1B686D4(&Method_WarBoardUIUtility_ShowRuleDialog__, v10);
    sub_1B686D4(&WebViewManager_TypeInfo, v11);
    sub_1B686D4(&StringLiteral_25026/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/, v12);
    sub_1B686D4(&StringLiteral_15489/*"WEB_VIEW_TITLE_WARBOARD_RULE"*/, v13);
    byte_4A06C32 = 1;
  }
  v14 = Method_WarBoardUIUtility_ShowRuleDialog__;
  if ( (*((_BYTE *)Method_WarBoardUIUtility_ShowRuleDialog__ + 83) & 2) != 0 )
    v14 = (_QWORD *)sub_1B686EC(Method_WarBoardUIUtility_ShowRuleDialog__);
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Instance, 0LL, 0LL) )
  {
    ...
    if ( MasterData_object )
    {
      MasterData_object = (__int64)DataManager__GetMasterData_object_(
                                     ...
                                     (const MethodInfo_2E49D50 *)Method_DataManager_GetMasterData_WarBoardStageDetailMaster___);
      if ( Instance )
      {
        ...
        if ( warBoardData_k__BackingField )
        {
          ...
          if ( v21 )
          {
            ...
            v25 = (System_Object_array *)sub_1B6877C(object___TypeInfo, 5LL);
            if ( !NetworkManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
            MasterData_object = (__int64)NetworkManager__getWebViewAddress_38236288(13, 0LL);
            if ( v25 )
            {
              v28 = (Il2CppObject *)MasterData_object;
              if ( MasterData_object )
              {
                MasterData_object = sub_1B68810(MasterData_object, v25->obj.klass->_1.element_class);
                if ( !MasterData_object )
                  goto LABEL_44;
              }
              if ( !v25->max_length )
                goto LABEL_43;
              v25->m_Items[0] = v28;
              sub_1B68678((ServantStatusBattleListViewItem_o *)v25->m_Items, (int32_t)v28, v26, v27);
              detailUrl = (Il2CppObject *)v23->fields.detailUrl;
              if ( detailUrl )
              {
                MasterData_object = sub_1B68810(detailUrl, v25->obj.klass->_1.element_class);
                if ( !MasterData_object )
                  goto LABEL_44;
              }
              if ( v25->max_length <= 1 )
              ...
              sub_1B68678((ServantStatusBattleListViewItem_o *)&v25->m_Items[1], (int32_t)detailUrl, v29, v30);
              ...
              if ( v25->max_length <= 2 )
                goto LABEL_43;
              v25->m_Items[2] = v37;
              sub_1B68678((ServantStatusBattleListViewItem_o *)&v25->m_Items[2], (int32_t)v37, v35, v36);
              if ( !byte_4A06C3C )
              {
              ...
              if ( MasterData_object )
              {
                MasterData_object = (__int64)System_String__TrimEnd_61449360(
                                               (System_String_o *)MasterData_object,
                                               0x2Fu,
                                               0LL);
                v41 = (Il2CppObject *)MasterData_object;
                if ( !MasterData_object
                  || (MasterData_object = sub_1B68810(MasterData_object, v25->obj.klass->_1.element_class)) != 0 )
                {
                  if ( v25->max_length <= 3 )
                    goto LABEL_43;
                  v25->m_Items[3] = v41;
                  sub_1B68678((ServantStatusBattleListViewItem_o *)&v25->m_Items[3], (int32_t)v41, v39, v40);
                  v51 = HasNewWinCond;
                    ...
                    || (MasterData_object = sub_1B68810(MasterData_object, v25->obj.klass->_1.element_class)) != 0 )
                  {
                    ...
                    {
                      v25->m_Items[4] = v47;
                      sub_1B68678((ServantStatusBattleListViewItem_o *)&v25->m_Items[4], (int32_t)v47, v45, v46);
                      v48 = System_String__Format_61433976((System_String_o *)StringLiteral_25026/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/, v25, 0LL);
...
LABEL_44:
                v50 = sub_1B68954(MasterData_object);
                sub_1B687FC(v50, 0LL);
              }
            }
          }
