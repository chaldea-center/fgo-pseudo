void WarBoardUIUtility__ShowRuleDialog(System_Action_o *callbackFunc, const MethodInfo *method)
{
  ...
  if ( (byte_4C35718 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_WarBoardUIUtility_ShowRuleDialog__);
    sub_1C32C20(&WebViewManager_TypeInfo);
    sub_1C32C20(&StringLiteral_25204/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/);
    sub_1C32C20(&StringLiteral_15555/*"WEB_VIEW_TITLE_WARBOARD_RULE"*/);
    byte_4C35718 = 1;
  }
  v3 = Method_WarBoardUIUtility_ShowRuleDialog__;
  if ( (*((_BYTE *)Method_WarBoardUIUtility_ShowRuleDialog__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C32C38(Method_WarBoardUIUtility_ShowRuleDialog__);
  ...
  {
    MasterData_object = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39E2904 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      ...
      if ( Instance )
      {
        ...
        if ( warBoardData_k__BackingField )
        {
          ...
          if ( v9 )
          {
            ...
            v13 = sub_1C32CC8(object___TypeInfo, 5);
            if ( !NetworkManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
            MasterData_object = (__int64)NetworkManager__getWebViewAddress_41280180(13, 0);
            if ( v13 )
            {
              v16 = MasterData_object;
              if ( MasterData_object )
              {
                MasterData_object = sub_1C32D5C(MasterData_object, *(_QWORD *)(*(_QWORD *)v13 + 64LL));
                if ( !MasterData_object )
                  goto LABEL_44;
              }
              if ( !*(_DWORD *)(v13 + 24) )
                goto LABEL_43;
              *(_QWORD *)(v13 + 32) = v16;
              sub_1C32BC4((CGThumbnailListItem_o *)(v13 + 32), v16, v14, v15);
              detailUrl = v11->fields.detailUrl;
              if ( detailUrl )
              {
                MasterData_object = sub_1C32D5C(detailUrl, *(_QWORD *)(*(_QWORD *)v13 + 64LL));
                if ( !MasterData_object )
                  goto LABEL_44;
              }
              if ( *(_DWORD *)(v13 + 24) <= 1u )
              ...
              *(_QWORD *)(v13 + 40) = detailUrl;
              sub_1C32BC4((CGThumbnailListItem_o *)(v13 + 40), (int32_t)detailUrl, v17, v18);
              ...
              if ( *(_DWORD *)(v13 + 24) <= 2u )
                goto LABEL_43;
              *(_QWORD *)(v13 + 48) = v28;
              sub_1C32BC4((CGThumbnailListItem_o *)(v13 + 48), v28, v26, v27);
              if ( !byte_4C357BB )
              {
                sub_1C32C20(&NetworkManager_TypeInfo);
                byte_4C357BB = 1;
              ...
              if ( MasterData_object )
              {
                MasterData_object = (__int64)System_String__TrimEnd_63575236(
                                               (System_String_o *)MasterData_object,
                                               0x2Fu,
                                               0);
                v32 = MasterData_object;
                if ( !MasterData_object
                  || (MasterData_object = sub_1C32D5C(MasterData_object, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                {
                  if ( *(_DWORD *)(v13 + 24) <= 3u )
                    goto LABEL_43;
                  *(_QWORD *)(v13 + 56) = v32;
                  sub_1C32BC4((CGThumbnailListItem_o *)(v13 + 56), v32, v30, v31);
                  v45 = HasNewWinCond;
                    ...
                    || (MasterData_object = sub_1C32D5C(MasterData_object, *(_QWORD *)(*(_QWORD *)v13 + 64LL))) != 0 )
                  {
                    ...
                    {
                      *(_QWORD *)(v13 + 64) = v41;
                      sub_1C32BC4((CGThumbnailListItem_o *)(v13 + 64), v41, v39, v40);
                      v42 = System_String__Format_63559972(
                              (System_String_o *)StringLiteral_25204/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/,
                              (System_Object_array *)v13,
                              0);
                      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                      v43 = LocalizationManager__Get((System_String_o *)StringLiteral_15555/*"WEB_VIEW_TITLE_WARBOARD_RULE"*/, 0);
