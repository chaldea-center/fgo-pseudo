void __fastcall WarBoardUIUtility__ShowRuleDialog(System_Action_o *callbackFunc, const MethodInfo *method)
{
  ...
  if ( (byte_4BC59A1 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_WarBoardStageDetailMaster___, method);
    sub_1C1ABD4(&int_TypeInfo, v3);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v4);
    sub_1C1ABD4(&NetworkManager_TypeInfo, v5);
    sub_1C1ABD4(&object___TypeInfo, v6);
    ...
    sub_1C1ABD4(&Method_WarBoardUIUtility_ShowRuleDialog__, v10);
    sub_1C1ABD4(&WebViewManager_TypeInfo, v11);
    sub_1C1ABD4(&StringLiteral_25534/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/, v12);
    sub_1C1ABD4(&StringLiteral_15812/*"WEB_VIEW_TITLE_WARBOARD_RULE"*/, v13);
    byte_4BC59A1 = 1;
  }
  v14 = Method_WarBoardUIUtility_ShowRuleDialog__;
  if ( (*((_BYTE *)Method_WarBoardUIUtility_ShowRuleDialog__ + 83) & 2) != 0 )
    v14 = (_QWORD *)sub_1C1ABEC(Method_WarBoardUIUtility_ShowRuleDialog__);
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Instance, 0LL, 0LL) )
  {
    ...
    if ( MasterData_object )
    {
      MasterData_object = (__int64)DataManager__GetMasterData_object_(
                                     ...
                                     (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_WarBoardStageDetailMaster___);
      if ( Instance )
      {
        ...
        if ( warBoardData_k__BackingField )
        {
          ...
          if ( v21 )
          {
            ...
            v25 = (System_Object_array *)sub_1C1AC7C(object___TypeInfo, 5LL);
            if ( !NetworkManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
            MasterData_object = (__int64)NetworkManager__getWebViewAddress_39773136(13, 0LL);
            if ( v25 )
            {
              v32 = MasterData_object;
              if ( MasterData_object )
              {
                MasterData_object = sub_1C1AD10(MasterData_object, v25->obj.klass->_1.element_class);
                if ( !MasterData_object )
                  goto LABEL_44;
              }
              if ( !v25->max_length )
              ...
              sub_1C1AB78((PartyOrganizationUtility_o *)v25->m_Items, v32, v26, v27, v28, v29, v30, v31);
              detailUrl = (int64_t)v23->fields.detailUrl;
              if ( detailUrl )
              {
                MasterData_object = sub_1C1AD10(detailUrl, v25->obj.klass->_1.element_class);
                if ( !MasterData_object )
                  goto LABEL_44;
              }
              if ( v25->max_length <= 1 )
              ...
              sub_1C1AB78((PartyOrganizationUtility_o *)&v25->m_Items[1], detailUrl, v33, v34, v35, v36, v37, v38);
              ...
              sub_1C1AB78((PartyOrganizationUtility_o *)&v25->m_Items[2], v49, v43, v44, v45, v46, v47, v48);
              if ( !byte_4BC5A44 )
              {
              ...
              if ( MasterData_object )
              {
                MasterData_object = (__int64)System_String__TrimEnd_63070260(
                                               (System_String_o *)MasterData_object,
                                               0x2Fu,
                                               0LL);
                v57 = MasterData_object;
                if ( !MasterData_object
                  || (MasterData_object = sub_1C1AD10(MasterData_object, v25->obj.klass->_1.element_class)) != 0 )
                {
                  if ( v25->max_length <= 3 )
                    goto LABEL_43;
                  v25->m_Items[3] = (Il2CppObject *)v57;
                  sub_1C1AB78((PartyOrganizationUtility_o *)&v25->m_Items[3], v57, v51, v52, v53, v54, v55, v56);
                  v71 = HasNewWinCond;
                    ...
                    || (MasterData_object = sub_1C1AD10(MasterData_object, v25->obj.klass->_1.element_class)) != 0 )
                  {
                    if ( v25->max_length > 4 )
                    {
                      ...
                      sub_1C1AB78((PartyOrganizationUtility_o *)&v25->m_Items[4], v67, v61, v62, v63, v64, v65, v66);
                      v68 = System_String__Format_63054876((System_String_o *)StringLiteral_25534/*"{0}{1}?stageId={2}&gameDomain={3}&changeWinCond={4}"*/, v25, 0LL);
                      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                      v69 = LocalizationManager__Get((System_String_o *)StringLiteral_15812/*"WEB_VIEW_TITLE_WARBOARD_RULE"*/, 0LL);
