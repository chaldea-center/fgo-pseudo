        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B8C4B & 1) == 0 )
  {
    sub_1B4CF90(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F86AFC *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
...
LABEL_11:
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.request, (int32_t)v8, v11, v12);
}