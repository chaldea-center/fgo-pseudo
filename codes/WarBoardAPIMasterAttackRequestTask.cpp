        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE07E & 1) == 0 )
  {
    sub_B52984(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  ...
  Instance = NetworkManager__getRequest_WarBoardWallAttackRequest_(
               0LL,
               (const MethodInfo_1F705CC *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
