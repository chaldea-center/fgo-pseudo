        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BE18 & 1) == 0 )
  {
    sub_1B761C0(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2EE44C0 *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
...
LABEL_11:
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.request, (int32_t)v8, v11, v12);
}