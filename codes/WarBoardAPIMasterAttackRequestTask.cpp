        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A3D5 & 1) == 0 )
  {
    sub_1C94098(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  ...
  Instance = NetworkManager__getRequest_object_(
               0,
               (const MethodInfo_32282A8 *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
