        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A06B4B & 1) == 0 )
  {
    sub_1B686D4(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2ECB448 *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
...
LABEL_11:
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.request, (int32_t)v8, v11, v12);
}