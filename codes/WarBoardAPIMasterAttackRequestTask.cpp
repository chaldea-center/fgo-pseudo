        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1D9AF & 1) == 0 )
  {
    sub_1B715CC(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2EDD4A0 *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
