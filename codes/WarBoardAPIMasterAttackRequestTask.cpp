        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F8C02 & 1) == 0 )
  {
    sub_B16FFC(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method);
  ...
  Request_WarBoardWallAttackRequest = NetworkManager__getRequest_WarBoardWallAttackRequest_(
                                        0LL,
                                        (const MethodInfo_19DD960 *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
    || (v8 = (WarBoardMasterAttackRequest_o *)Request_WarBoardWallAttackRequest,
