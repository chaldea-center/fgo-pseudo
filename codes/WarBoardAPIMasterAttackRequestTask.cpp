        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC58BA & 1) == 0 )
  {
    sub_1C1ABD4(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_3023C78 *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
...
LABEL_11:
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.request, (int64_t)v8, v11, v12, v13, v14, v15, v16);
}