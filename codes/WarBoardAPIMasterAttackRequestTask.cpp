        ...
        const MethodInfo *method)
{
  ...
  WarBoardMasterAttackRequest_o *v11; // x21
  ...
  if ( (byte_4B14057 & 1) == 0 )
  {
    sub_1BCA7E0(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method, v2);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F964CC *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
    || (v11 = (WarBoardMasterAttackRequest_o *)Instance,
...
LABEL_11:
  ...
  sub_1BCA784((PartyOrganizationUtility_o *)&this->fields.request, (int64_t)v11, v14, v15, v16, v17, v18, v19);
}