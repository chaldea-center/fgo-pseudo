        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3BDB & 1) == 0 )
  {
    sub_1BAB41C(&Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___, method);
  ...
  Instance = NetworkManager__getRequest_object_(
               0LL,
               (const MethodInfo_2F47108 *)Method_NetworkManager_getRequest_WarBoardMasterAttackRequest___);
  if ( !warBoardData
...
LABEL_11:
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.request, (int32_t)v8, v11, v12);
}