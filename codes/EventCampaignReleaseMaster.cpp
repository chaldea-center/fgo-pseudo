void __fastcall EventCampaignReleaseMaster___ctor(EventCampaignReleaseMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42B2780 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_EventCampaignReleaseMaster__EventCampaignReleaseEntity__string___ctor__);
    byte_42B2780 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    264,
    (const MethodInfo_23E268C *)Method_DataMasterBase_EventCampaignReleaseMaster__EventCampaignReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B277E & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_EventCampaignReleaseMaster__EventCampaignReleaseEntity__string__GetEntity__);
    byte_42B277E = 1;
  }
  ...
  return (EventCampaignReleaseEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                                           ...
                                           PK,
                                           (const MethodInfo_23E2728 *)Method_DataMasterBase_EventCampaignReleaseMaster__EventCampaignReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B277F & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_EventCampaignReleaseMaster__EventCampaignReleaseEntity__string__TryGetEntity__);
    byte_42B277F = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_23E2780 *)Method_DataMasterBase_EventCampaignReleaseMaster__EventCampaignReleaseEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2781 & 1) == 0 )
  {
    ...
    sub_B52984(&EventCampaignReleaseEntity_TypeInfo);
...
LABEL_20:
    ...
    if ( *(&v25->klass->_2.bitflags2 + 1) < (unsigned int)v11
      || (EventCampaignReleaseEntity_c *)v25->klass->_2.typeHierarchy[v11 - 1] != EventCampaignReleaseEntity_TypeInfo )
    {
      sub_B52D50(v25);
LABEL_25:
