        ...
        const MethodInfo *method)
{
  ...
  UserEventSpotEntity_o *Entity_39784368; // x0
  ...
  if ( (byte_49FB1BA & 1) == 0 )
  {
    eventPanelSpotEntity = (EventPanelSpotEntity_o *)sub_1B64870(&SubmarineSpotInfo_TypeInfo, spotEntity);
    byte_49FB1BA = 1;
  }
  if ( !v4 )
    goto LABEL_11;
...
LABEL_11:
    sub_1B64ACC(eventPanelSpotEntity, spotEntity);
  Entity_39784368 = UserEventSpotMaster__GetEntity_39784368(
                      (UserEventSpotMaster_o *)eventPanelSpotEntity,
                      v4->fields.eventId,
                      v4->fields.spotId,
                      0LL);
  if ( Entity_39784368 )
    panelMapDetailId = Entity_39784368->fields.value;
  else
    panelMapDetailId = 0;
LABEL_10:
  v8 = (SubmarineSpotInfo_o *)sub_1B64ABC(SubmarineSpotInfo_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB1BC & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_EventPanelSpotEntity__Add__, v10);
    sub_1B64870(&Method_System_Collections_Generic_List_EventPanelSpotEntity__ToArray__, v11);
    sub_1B64870(&Method_System_Collections_Generic_List_EventPanelSpotEntity___ctor__, v12);
    sub_1B64870(&System_Collections_Generic_List_EventPanelSpotEntity__TypeInfo, v13);
    byte_49FB1BC = 1;
  }
  v14 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_EventPanelSpotEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v14,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_EventPanelSpotEntity___ctor__);
        ...
        if ( eventPanelSpotMaster )
        {
          ...
          if ( (eventPanelSpotMaster & 1) == 0 && *(int *)(v24 + 32) >= 1 )
          {
            ...
            eventPanelSpotMaster = (__int64)DataMasterBase_object__object__int___GetEntity(
                                              ...
                                              *(_DWORD *)(v24 + 32),
                                              (const MethodInfo_30D6180 *)Method_DataMasterBase_EventPanelMapDetailMaster__EventPanelMapDetailEntity__int__GetEntity__);
            if ( eventPanelSpotMaster )
            {
              v25 = eventPanelSpotMaster;
              eventPanelSpotMaster = sub_1B64918(int___TypeInfo, 2LL);
              if ( !eventPanelSpotMaster )
                goto LABEL_39;
              ...
              *(_DWORD *)(eventPanelSpotMaster + 36) = v30;
              ...
              if ( v32 >= 1 )
              {
                ...
                else
                {
                  ...
                  sub_1B64814((ServantStatusBattleListViewItem_o *)(v39 + 4), v22, v26, v27);
                }
              }
            }
          }
...
LABEL_38:
    sub_1B64AD4(eventPanelSpotMaster, v17);
  }
LABEL_36:
  if ( !v14 )
LABEL_39:
    sub_1B64ACC(eventPanelSpotMaster, v17);
  return (EventPanelSpotEntity_array *)System_Collections_Generic_List_object___ToArray(
                                         v14,
                                         (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_EventPanelSpotEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B9 & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_SpotMaster__SpotEntity__int__TryGetEntity__, *(_QWORD *)&eventId);
    *(_QWORD *)&spotId = sub_1B64870(
  ...
  eventPanelSpotMaster = (DataMasterBase_TMaster__TEntity__PKType__o *)DataMasterBase_object__object__int___TryGetEntity(
                                                                         ...
                                                                         &entity,
                                                                         v6,
                                                                         (const MethodInfo_30D61D4 *)Method_DataMasterBase_EventPanelSpotMaster__EventPanelSpotEntity__int__TryGetEntity__);
  ...
  if ( !v12 )
LABEL_15:
    sub_1B64ACC(eventPanelSpotMaster, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B8 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_SubmarineSpotInfo__Add__, *(_QWORD *)&mapId);
    sub_1B64870(&Method_System_Collections_Generic_List_SubmarineSpotInfo___ctor__, v5);
    *(_QWORD *)&eventId = sub_1B64870(&System_Collections_Generic_List_SubmarineSpotInfo__TypeInfo, v6);
    byte_49FB1B8 = 1;
  }
  ...
  v10 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_SubmarineSpotInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v10,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_SubmarineSpotInfo___ctor__);
...
LABEL_26:
      ...
      if ( max_length >= 1 )
      {
        ...
        else
        {
          ...
          sub_1B64814((ServantStatusBattleListViewItem_o *)(v24 + 4), (int32_t)v23, v18, v19);
        }
      }
LABEL_23:
        ...
        const MethodInfo *method)
{
  ...
  UserEventMapEntity_o *Entity_39757484; // x0
  ...
  if ( (byte_49FB1BB & 1) == 0 )
  {
    ...
    spotEntity = (SpotEntity_o *)sub_1B64870(
                                   &Method_DataMasterBase_EventPanelMapDetailMaster__EventPanelMapDetailEntity__int__GetEntity__,
                                   v5);
    byte_49FB1BB = 1;
  }
...
LABEL_8:
  ...
  Entity = DataMasterBase_object__object__int___GetEntity(
             ...
             v4->fields.mapId,
             (const MethodInfo_30D6180 *)Method_DataMasterBase_EventPanelMapMaster__EventPanelMapEntity__int__GetEntity__);
  if ( !Entity )
    return 0;
  v10 = Entity;
  ...
  if ( !EventPanelSpotEntity__IsCrossLineSpot((EventPanelSpotEntity_o *)spotEntity, 0LL) )
  {
    ...
    if ( spotEntity )
    {
      ...
      if ( spotEntity )
      {
        ...
        if ( spotEntity )
        {
          Entity_39757484 = UserEventMapMaster__GetEntity_39757484(
                              (UserEventMapMaster_o *)spotEntity,
                              HIDWORD(v10[1].klass),
                              (int32_t)v10[1].klass,
                              0LL);
          return !SubmarineMapDataManager__IsOpenPanel(Entity_39757484, (EventPanelMapDetailEntity_o *)v16, id, v18);
        }
      }
    }
    goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B4 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_EventPanelMapDetailMaster___, v1);
  ...
  return (EventPanelMapDetailMaster_o *)DataManager__GetMasterData_object_(
                                          ...
                                          (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_EventPanelMapDetailMaster___);
}
...
EventPanelMapMaster_o *__fastcall SubmarineDataHelperSpot__get_eventPanelMapMaster(const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B3 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_EventPanelMapMaster___, v1);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_49FB1B3 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  return (EventPanelMapMaster_o *)DataManager__GetMasterData_object_(
                                    (DataManager_o *)Instance,
                                    (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_EventPanelMapMaster___);
}
...
EventPanelSpotMaster_o *__fastcall SubmarineDataHelperSpot__get_eventPanelSpotMaster(const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B2 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_EventPanelSpotMaster___, v1);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_49FB1B2 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  return (EventPanelSpotMaster_o *)DataManager__GetMasterData_object_(
                                     (DataManager_o *)Instance,
                                     (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_EventPanelSpotMaster___);
}
...
SpotMaster_o *__fastcall SubmarineDataHelperSpot__get_spotMaster(const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B7 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_SpotMaster___, v1);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_49FB1B7 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
...
UserEventMapMaster_o *__fastcall SubmarineDataHelperSpot__get_userEventMapMaster(const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B5 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_UserEventMapMaster___, v1);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_49FB1B5 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  return (UserEventMapMaster_o *)DataManager__GetMasterData_object_(
                                   (DataManager_o *)Instance,
                                   (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_UserEventMapMaster___);
}
...
UserEventSpotMaster_o *__fastcall SubmarineDataHelperSpot__get_userEventSpotMaster(const MethodInfo *method)
{
  ...
  if ( (byte_49FB1B6 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_UserEventSpotMaster___, v1);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v2);
    byte_49FB1B6 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  return (UserEventSpotMaster_o *)DataManager__GetMasterData_object_(
                                    (DataManager_o *)Instance,
                                    (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_UserEventSpotMaster___);
}