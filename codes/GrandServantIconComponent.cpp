...
{
  *(_OWORD *)&this->fields.skillLevelTextScale = xmmword_D35E60;
  if ( !byte_4E70B79 )
  {
...
LABEL_10:
  ...
  GameObjectExtensions__AddLocalPosition_37343980(gameObject, v4->fields.cacheOffset, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  Master_object = (CommonUI_o *)DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserServantMaster___);
  ...
  *(_OWORD *)&v15.fields.fakeValue = v10;
  ...
  v14 = v15;
  Master_object = (CommonUI_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_50334724(&v14, 0);
  if ( !v11 )
    goto LABEL_13;
  ...
  Master_object = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3BAC684 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Master_object )
LABEL_13:
...
void GrandServantIconComponent__Init(
        ...
        const MethodInfo *method)
{
  GrandServantIconComponent___c__DisplayClass35_0_o *v11; // x24
  ...
  if ( (byte_4E720DE & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_UIIconLabel__TypeInfo);
    sub_1D0F0B4(&Method_BasicHelper_ForEach_UIIconLabel___);
    ...
    sub_1D0F0B4(&Method_GrandServantIconComponent___c__DisplayClass35_0__Init_b__0__);
    sub_1D0F0B4(&GrandServantIconComponent___c__DisplayClass35_0_TypeInfo);
    sub_1D0F0B4(&StringLiteral_11706/*"SELECT_GRAND_HAS_GRAND_CLASS_MASK_TEXT"*/);
    sub_1D0F0B4(&StringLiteral_25596/*"{0:D5}:{1}"*/);
    sub_1D0F0B4(&StringLiteral_6879/*"Fonts/TextAtlas3"*/);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    byte_4E720DE = 1;
  }
  v11 = (GrandServantIconComponent___c__DisplayClass35_0_o *)sub_1D0F300(GrandServantIconComponent___c__DisplayClass35_0_TypeInfo);
  GrandServantIconComponent___c__DisplayClass35_0___ctor(v11, 0);
  this->fields.onClickIconAction = onClickIcon;
  sub_1D0F058(&this->fields.onClickIconAction, onClickIcon);
  this->fields.onEndShowServantStatusAction = onEndShowServantStatus;
  object = (SkillListTreasureDeviceComponent_o *)sub_1D0F058(
  ...
  if ( !v11 )
    goto LABEL_25;
  v11->fields.fontObject = (struct UIFont_o *)object;
  sub_1D0F058(&v11->fields, object);
  iconLabels = (System_Collections_Generic_IEnumerable_T__o *)this->fields.iconLabels;
  v16 = (System_Action_object__o *)sub_1D0F300(System_Action_UIIconLabel__TypeInfo);
  ...
  BasicHelper__ForEach_object_(
    ...
    (const MethodInfo_323AF0C *)Method_BasicHelper_ForEach_UIIconLabel___);
  object = this->fields.skillListTreasureDevice;
  if ( !object )
    goto LABEL_25;
  SkillListTreasureDeviceComponent__SetBitmapFont(object, v11->fields.fontObject, 0);
  ...
  object = (SkillListTreasureDeviceComponent_o *)j_il2cpp_value_box_0(int_TypeInfo, &Index_k__BackingField);
  UserServantEntity_k__BackingField = this->fields._UserServantEntity_k__BackingField;
  if ( !UserServantEntity_k__BackingField )
    goto LABEL_25;
  v20 = (Il2CppObject *)object;
  svtId = UserServantEntity_k__BackingField->fields.svtId;
  v21 = (Il2CppObject *)j_il2cpp_value_box_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, &svtId);
  object = (SkillListTreasureDeviceComponent_o *)System_String__Format_65604080(
                                                   (System_String_o *)StringLiteral_25596/*"{0:D5}:{1}"*/,
                                                   v20,
                                                   v21,
                                                   0);
  if ( !gameObject )
  ...
  if ( !this->fields._CanSelectGrand_k__BackingField )
  {
    ...
    if ( servantInfo->fields._IsSameClass_k__BackingField )
    {
      ...
      object = (SkillListTreasureDeviceComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11706/*"SELECT_GRAND_HAS_GRAND_CLASS_MASK_TEXT"*/, 0);
      if ( maskLabel )
      {
...
LABEL_24:
  GrandServantIconComponent__OnUnselected(this, v22);
}
...
void GrandServantIconComponent__OnLongPressIcon(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E720E3 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_GrandServantIconComponent_EndShowServantWithQuest__);
    sub_1D0F0B4(&Method_GrandServantIconComponent_OnLongPressIcon__);
    sub_1D0F0B4(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    sub_1D0F0B4(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4E720E3 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_GrandServantIconComponent_OnLongPressIcon__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_GrandServantIconComponent_OnLongPressIcon__);
  ...
  *(_OWORD *)&v13.fields.fakeValue = v8;
  ...
  v11 = (ServantStatusDialog_FormationEndDelegate_o *)sub_1D0F300(ServantStatusDialog_FormationEndDelegate_TypeInfo);
...
LABEL_10:
  ...
  CommonUI__OpenServantStatusDialog_32096572(v9, 1, v10, v11, 0, 0);
}
...
void GrandServantIconComponent__OnSelected(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E720E1 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_GrandServantIconComponent___c__OnSelected_b__38_0__);
    sub_1D0F0B4(&GrandServantIconComponent___c_TypeInfo);
    sub_1D0F0B4(&StringLiteral_20527/*"icon_class_grand_servant_select_{0:D3}"*/);
    byte_4E720E1 = 1;
  }
  UserServantEntity_k__BackingField = this->fields._UserServantEntity_k__BackingField;
  if ( !UserServantEntity_k__BackingField )
  ...
  GameObjectExtensions__SetLocalScale_37345220(gameObject, this->fields.onSelectedIconScale, 0);
  ...
  if ( !v7 )
  {
    ...
    v7 = (System_Action_object__o *)sub_1D0F300(System_Action_GameObject__TypeInfo);
    ...
    UserServantEntity_k__BackingField = (void *)sub_1D0F058(&static_fields->__9__38_0, v7);
  }
  ...
  {
LABEL_18:
    sub_1D0F30C(UserServantEntity_k__BackingField, method);
  }
  ...
  v11 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &SvtClassId);
  v12 = System_String__Format((System_String_o *)StringLiteral_20527/*"icon_class_grand_servant_select_{0:D3}"*/, v11, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetGrandServantListImage(classSprite, v12, 0);
...
void GrandServantIconComponent__OnUnselected(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E720E0 & 1) == 0 )
  {
    sub_1D0F0B4(&System_Action_GameObject__TypeInfo);
    sub_1D0F0B4(&Method_System_Collections_Generic_List_GameObject__ForEach__);
    sub_1D0F0B4(&Method_GrandServantIconComponent___c__OnUnselected_b__37_0__);
    sub_1D0F0B4(&GrandServantIconComponent___c_TypeInfo);
    byte_4E720E0 = 1;
  }
  ...
  GameObjectExtensions__SetLocalScale_37345220(gameObject, this->fields.onUnselectedIconScale, 0);
  ...
  if ( !v6 )
  {
    ...
    faceIcon = (void *)sub_1D0F058(&static_fields->__9__37_0, v6);
  }
  if ( !peripheralObjectRootList )
LABEL_12:
...
void GrandServantIconComponent__ResetOffset(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  GameObjectExtensions__AddLocalPosition_37343980(gameObject, v4, 0);
  if ( !byte_4E70B79 )
  {
    sub_1D0F0B4(&UnityEngine_Vector2_TypeInfo);
    byte_4E70B79 = 1;
        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058(&this->fields._UserServantEntity_k__BackingField, userServantEntity);
  faceIcon = this->fields.faceIcon;
  if ( !faceIcon )
    goto LABEL_33;
...
LABEL_34:
  ...
  if ( !v12 )
    goto LABEL_33;
  UIIconLabel__Set_42477084(v12, 32, (int32_t)faceIcon, 0, 0, 0, 0, 0, 0, 0, 0);
  faceIcon = *p_UserServantEntity_k__BackingField;
  if ( !*p_UserServantEntity_k__BackingField )
    goto LABEL_33;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  faceIcon = LocalizationManager__GetLevelList_42647920(v14, 0);
  if ( !tdInfo )
    goto LABEL_33;
  ...
  {
LABEL_33:
    sub_1D0F30C(faceIcon, v6);
  }
  classSprite = this->fields.classSprite;
  SvtClassId = UserServantEntity__getSvtClassId((UserServantEntity_o *)faceIcon, 0, 0, 0);
  v21 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &SvtClassId);
  v22 = System_String__Format((System_String_o *)StringLiteral_20527/*"icon_class_grand_servant_select_{0:D3}"*/, v21, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1D0F058(&this->fields._UserServantEntity_k__BackingField, value);
}
...
void GrandServantIconComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(GrandServantIconComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  GrandServantIconComponent___c_TypeInfo->static_fields->__9 = (struct GrandServantIconComponent___c_o *)v1;
  sub_1D0F058(GrandServantIconComponent___c_TypeInfo->static_fields, v1);
}
