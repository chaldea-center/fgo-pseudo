...
{
  *(_OWORD *)&this->fields.skillLevelTextScale = xmmword_D255C0;
  if ( !byte_4DFDF89 )
  {
...
LABEL_10:
  ...
  GameObjectExtensions__AddLocalPosition_37161936(gameObject, v4->fields.cacheOffset, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  Master_object = (CommonUI_o *)DataManager__GetMaster_object_((const MethodInfo_3204354 *)Method_DataManager_GetMaster_UserServantMaster___);
  ...
  *(_OWORD *)&v15.fields.fakeValue = v10;
  ...
  v14 = v15;
  Master_object = (CommonUI_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_50041532(&v14, 0);
  if ( !v11 )
    goto LABEL_13;
  ...
  Master_object = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Master_object )
LABEL_13:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFF4E5 & 1) == 0 )
  {
    sub_1CE6700(&System_Action_UIIconLabel__TypeInfo);
    sub_1CE6700(&Method_BasicHelper_ForEach_UIIconLabel___);
    ...
    sub_1CE6700(&Method_GrandServantIconComponent___c__DisplayClass35_0__Init_b__0__);
    sub_1CE6700(&GrandServantIconComponent___c__DisplayClass35_0_TypeInfo);
    sub_1CE6700(&StringLiteral_11658/*"SELECT_GRAND_HAS_GRAND_CLASS_MASK_TEXT"*/);
    sub_1CE6700(&StringLiteral_25486/*"{0:D5}:{1}"*/);
    sub_1CE6700(&StringLiteral_6853/*"Fonts/TextAtlas3"*/);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4DFF4E5 = 1;
  }
  v11 = (GrandServantIconComponent___c__DisplayClass35_0_o *)sub_1CE694C(GrandServantIconComponent___c__DisplayClass35_0_TypeInfo);
  GrandServantIconComponent___c__DisplayClass35_0___ctor(v11, 0);
  this->fields.onClickIconAction = onClickIcon;
  sub_1CE66A4(&this->fields.onClickIconAction, onClickIcon);
  this->fields.onEndShowServantStatusAction = onEndShowServantStatus;
  object = (SkillListTreasureDeviceComponent_o *)sub_1CE66A4(
  ...
  sub_1CE66A4(&v11->fields, object);
  iconLabels = (System_Collections_Generic_IEnumerable_T__o *)this->fields.iconLabels;
  v16 = (System_Action_object__o *)sub_1CE694C(System_Action_UIIconLabel__TypeInfo);
  ...
  BasicHelper__ForEach_object_(
    ...
    (const MethodInfo_31F00FC *)Method_BasicHelper_ForEach_UIIconLabel___);
  ...
  object = (SkillListTreasureDeviceComponent_o *)System_String__Format_65164136(
                                                   (System_String_o *)StringLiteral_25486/*"{0:D5}:{1}"*/,
                                                   v20,
                                                   v21,
                                                   0);
  if ( !gameObject )
  ...
  if ( !this->fields._CanSelectGrand_k__BackingField )
  {
    ...
    if ( servantInfo->fields._IsSameClass_k__BackingField )
    {
      ...
      object = (SkillListTreasureDeviceComponent_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11658/*"SELECT_GRAND_HAS_GRAND_CLASS_MASK_TEXT"*/, 0);
      if ( maskLabel )
      {
...
void GrandServantIconComponent__OnLongPressIcon(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF4EA & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_GrandServantIconComponent_EndShowServantWithQuest__);
    sub_1CE6700(&Method_GrandServantIconComponent_OnLongPressIcon__);
    sub_1CE6700(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4DFF4EA = 1;
  }
  ...
  if ( (*((_BYTE *)Method_GrandServantIconComponent_OnLongPressIcon__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1CE6718(Method_GrandServantIconComponent_OnLongPressIcon__);
  ...
  *(_OWORD *)&v13.fields.fakeValue = v8;
  ...
  v11 = (ServantStatusDialog_FormationEndDelegate_o *)sub_1CE694C(ServantStatusDialog_FormationEndDelegate_TypeInfo);
...
LABEL_10:
  ...
  CommonUI__OpenServantStatusDialog_31929428(v9, 1, v10, v11, 0, 0);
}
...
void GrandServantIconComponent__OnSelected(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF4E8 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_GrandServantIconComponent___c__OnSelected_b__38_0__);
    sub_1CE6700(&GrandServantIconComponent___c_TypeInfo);
    sub_1CE6700(&StringLiteral_20439/*"icon_class_grand_servant_select_{0:D3}"*/);
    byte_4DFF4E8 = 1;
  }
  UserServantEntity_k__BackingField = this->fields._UserServantEntity_k__BackingField;
  if ( !UserServantEntity_k__BackingField )
  ...
  GameObjectExtensions__SetLocalScale_37163176(gameObject, this->fields.onSelectedIconScale, 0);
  ...
  if ( !v7 )
  {
    ...
    v7 = (System_Action_object__o *)sub_1CE694C(System_Action_GameObject__TypeInfo);
    ...
    UserServantEntity_k__BackingField = (void *)sub_1CE66A4(&static_fields->__9__38_0, v7);
  }
  ...
  {
LABEL_18:
    sub_1CE6958(UserServantEntity_k__BackingField, method);
  }
  ...
  v12 = System_String__Format((System_String_o *)StringLiteral_20439/*"icon_class_grand_servant_select_{0:D3}"*/, v11, 0);
...
void GrandServantIconComponent__OnUnselected(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFF4E7 & 1) == 0 )
  {
    sub_1CE6700(&System_Action_GameObject__TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_GameObject__ForEach__);
    sub_1CE6700(&Method_GrandServantIconComponent___c__OnUnselected_b__37_0__);
    sub_1CE6700(&GrandServantIconComponent___c_TypeInfo);
    byte_4DFF4E7 = 1;
  }
  ...
  GameObjectExtensions__SetLocalScale_37163176(gameObject, this->fields.onUnselectedIconScale, 0);
  ...
  if ( !v6 )
  {
    ...
    faceIcon = (void *)sub_1CE66A4(&static_fields->__9__37_0, v6);
  }
  if ( !peripheralObjectRootList )
LABEL_12:
...
void GrandServantIconComponent__ResetOffset(GrandServantIconComponent_o *this, const MethodInfo *method)
{
  ...
  GameObjectExtensions__AddLocalPosition_37161936(gameObject, v4, 0);
  if ( !byte_4DFDF89 )
  {
    sub_1CE6700(&UnityEngine_Vector2_TypeInfo);
    byte_4DFDF89 = 1;
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields._UserServantEntity_k__BackingField, userServantEntity);
  faceIcon = this->fields.faceIcon;
  if ( !faceIcon )
    goto LABEL_33;
  ...
  if ( !v9 )
    goto LABEL_33;
  UIIconLabel__Set_42257736(v9, 2, v10, (int32_t)faceIcon, 0, 0, 0, 0, 0, 0, 0);
  v11 = this->fields.iconLabels;
  if ( !v11 )
    goto LABEL_33;
  if ( LODWORD(v11->max_length) <= 1 )
LABEL_34:
    sub_1CE6960(faceIcon);
  faceIcon = *p_UserServantEntity_k__BackingField;
  if ( !*p_UserServantEntity_k__BackingField )
    goto LABEL_33;
  v12 = v11->m_Items[1];
  ...
  if ( !v12 )
    goto LABEL_33;
  UIIconLabel__Set_42257736(v12, 32, (int32_t)faceIcon, 0, 0, 0, 0, 0, 0, 0, 0);
  faceIcon = *p_UserServantEntity_k__BackingField;
  if ( !*p_UserServantEntity_k__BackingField )
    goto LABEL_33;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  faceIcon = LocalizationManager__GetLevelList_42427444(v14, 0);
  if ( !tdInfo )
    goto LABEL_33;
...
LABEL_33:
  ...
  v22 = System_String__Format((System_String_o *)StringLiteral_20439/*"icon_class_grand_servant_select_{0:D3}"*/, v21, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4(&this->fields._UserServantEntity_k__BackingField, value);
}
...
void GrandServantIconComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(GrandServantIconComponent___c_TypeInfo);
  System_Object___ctor(v1, 0);
  GrandServantIconComponent___c_TypeInfo->static_fields->__9 = (struct GrandServantIconComponent___c_o *)v1;
  sub_1CE66A4(GrandServantIconComponent___c_TypeInfo->static_fields, v1);
}
