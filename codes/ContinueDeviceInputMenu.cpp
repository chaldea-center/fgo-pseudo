...
void __fastcall ContinueDeviceInputMenu__Close(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceInputMenu__Close_28454676(this, 0LL, v2);
}


void __fastcall ContinueDeviceInputMenu__Close_28454676(
        ContinueDeviceInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438CCF0 & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_ContinueDeviceInputMenu_EndClose__);
    byte_438CCF0 = 1;
  }
...
void __fastcall ContinueDeviceInputMenu__EndOpen(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !passward1Input
    ...
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                      ...
                                                      (const MethodInfo_1C6D6B0 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_B7769C(passward1Input, method);
  }
...
void __fastcall ContinueDeviceInputMenu__OnChangeInput(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438CCF1 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_3502/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/);
    sub_B775C4(&StringLiteral_3501/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/);
  ...
  if ( m_stringLength <= 0 )
  {
    ...
    if ( passward1Input->fields.m_CachedPtr < 1 )
    {
      ...
      v13 = &StringLiteral_3509/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/;
      goto LABEL_30;
    }
    goto LABEL_26;
  }
...
LABEL_26:
    ...
    v13 = &StringLiteral_3502/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/;
    goto LABEL_30;
  }
  v7 = 0;
  do
  ...
  if ( !v11 )
  {
    ...
    passward1Input = (UILineInput_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3509/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( warningLabel2 )
    {
...
LABEL_43:
  ...
  v13 = &StringLiteral_3501/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/;
LABEL_30:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438CCEE & 1) == 0 )
  {
    ...
    sub_B775C4(&Method_UnityEngine_Component_GetComponent_Collider___);
    sub_B775C4(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_B775C4(&Method_ContinueDeviceInputMenu_EndOpen__);
    sub_B775C4(&LocalizationManager_TypeInfo);
    sub_B775C4(&StringLiteral_3500/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/);
    sub_B775C4(&StringLiteral_3497/*"CONTINUE_DEVICE_INPUT_DECIDE"*/);
    sub_B775C4(&StringLiteral_3498/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/);
    sub_B775C4(&StringLiteral_3503/*"CONTINUE_DEVICE_INPUT_TITLE"*/);
    sub_B775C4(&StringLiteral_3499/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/);
    sub_B775C4(&StringLiteral_1/*""*/);
    sub_B775C4(&StringLiteral_3509/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/);
    byte_438CCEE = 1;
  }
  ...
  else if ( !state )
  {
    ...
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3503/*"CONTINUE_DEVICE_INPUT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_24;
    UILabel__set_text(titleLabel, decideButton, 0LL);
    explanation1Label = this->fields.explanation1Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3498/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/, 0LL);
    if ( !explanation1Label )
      goto LABEL_24;
    UILabel__set_text(explanation1Label, decideButton, 0LL);
    warningLabel1 = this->fields.warningLabel1;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3500/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
    if ( !warningLabel1 )
      goto LABEL_24;
    UILabel__set_text(warningLabel1, decideButton, 0LL);
    warningLabel2 = this->fields.warningLabel2;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3509/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( !warningLabel2 )
      goto LABEL_24;
    UILabel__set_text(warningLabel2, decideButton, 0LL);
    explanation2Label = this->fields.explanation2Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3499/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/, 0LL);
    if ( !explanation2Label )
      goto LABEL_24;
    UILabel__set_text(explanation2Label, decideButton, 0LL);
    decideLabel = this->fields.decideLabel;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3497/*"CONTINUE_DEVICE_INPUT_DECIDE"*/, 0LL);
    if ( !decideLabel )
      goto LABEL_24;
    ...
    {
LABEL_24:
      sub_B7769C(decideButton, v11);
    }
    UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)decideButton, 0, 0LL);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_3500/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ContinueDeviceInputMenu_o *)sub_B77990(v8);
