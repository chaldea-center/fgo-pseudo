...
void __fastcall ContinueDeviceInputMenu__Close(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceInputMenu__Close_31017808(this, 0LL, v2);
}


void __fastcall ContinueDeviceInputMenu__Close_31017808(
        ContinueDeviceInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56679 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_1B885B0(&Method_ContinueDeviceInputMenu_EndClose__);
    byte_4A56679 = 1;
  }
  ...
  if ( !passward1Input
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                      passward1Input,
                                                      (const MethodInfo_2E763AC *)Method_UnityEngine_Component_GetComponent_UIInput___),
    ...
    || (UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)passward1Input, 0, 0LL), !v8)
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                      v8,
                                                      (const MethodInfo_2E763AC *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1B8880C(passward1Input, v5);
  }
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)passward1Input, 0, 0LL);
  v9 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
  System_Action___ctor(v9, (Il2CppObject *)this, Method_ContinueDeviceInputMenu_EndClose__, 0LL);
...
void __fastcall ContinueDeviceInputMenu__EndOpen(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !passward1Input
    ...
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                      ...
                                                      (const MethodInfo_2E763AC *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1B8880C(passward1Input, method);
  }
...
void __fastcall ContinueDeviceInputMenu__OnChangeInput(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5667A & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_3873/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/);
    sub_1B885B0(&StringLiteral_3872/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/);
...
LABEL_25:
      ...
      v15 = (System_String_o *)StringLiteral_3873/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/;
      goto LABEL_28;
    }
LABEL_19:
    ...
    if ( v13 )
    {
      v14 = &StringLiteral_3872/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/;
      goto LABEL_35;
    }
    passward1Input = (UILineInput_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3880/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( warningLabel2 )
    {
...
LABEL_38:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = &StringLiteral_3880/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/;
LABEL_35:
  v15 = (System_String_o *)*v14;
LABEL_28:
  passward1Input = (UILineInput_o *)LocalizationManager__Get(v15, 0LL);
  if ( !warningLabel2 )
    goto LABEL_38;
  UILabel__set_text(warningLabel2, (System_String_o *)passward1Input, 0LL);
...
void __fastcall ContinueDeviceInputMenu__OnClickCancel(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5667C & 1) == 0 )
  {
    sub_1B885B0(&Method_ContinueDeviceInputMenu_OnClickCancel__);
    byte_4A5667C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_ContinueDeviceInputMenu_OnClickCancel__);
...
void __fastcall ContinueDeviceInputMenu__OnClickDecide(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5667B & 1) == 0 )
  {
    sub_1B885B0(&Method_ContinueDeviceInputMenu_OnClickDecide__);
    byte_4A5667B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B885C8(Method_ContinueDeviceInputMenu_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56677 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_UnityEngine_Component_GetComponent_Collider___);
    sub_1B885B0(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_1B885B0(&Method_ContinueDeviceInputMenu_EndOpen__);
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&StringLiteral_3871/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/);
    sub_1B885B0(&StringLiteral_3868/*"CONTINUE_DEVICE_INPUT_DECIDE"*/);
    sub_1B885B0(&StringLiteral_3869/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/);
    sub_1B885B0(&StringLiteral_3874/*"CONTINUE_DEVICE_INPUT_TITLE"*/);
    sub_1B885B0(&StringLiteral_3870/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/);
    sub_1B885B0(&StringLiteral_1/*""*/);
    sub_1B885B0(&StringLiteral_3880/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/);
    byte_4A56677 = 1;
  }
  ...
  if ( state == 3 )
  {
    ...
    ContinueDeviceInputMenu__EndOpen(this, v18);
  }
  else if ( !state )
  {
    this->fields.callbackFunc = callback;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3874/*"CONTINUE_DEVICE_INPUT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_23;
    UILabel__set_text(titleLabel, decideButton, 0LL);
    explanation1Label = this->fields.explanation1Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3869/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/, 0LL);
    if ( !explanation1Label )
      goto LABEL_23;
    UILabel__set_text(explanation1Label, decideButton, 0LL);
    warningLabel1 = this->fields.warningLabel1;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3871/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
    if ( !warningLabel1 )
      goto LABEL_23;
    UILabel__set_text(warningLabel1, decideButton, 0LL);
    warningLabel2 = this->fields.warningLabel2;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3880/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( !warningLabel2 )
      goto LABEL_23;
    UILabel__set_text(warningLabel2, decideButton, 0LL);
    explanation2Label = this->fields.explanation2Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3870/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/, 0LL);
    if ( !explanation2Label )
      goto LABEL_23;
    UILabel__set_text(explanation2Label, decideButton, 0LL);
    decideLabel = this->fields.decideLabel;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3868/*"CONTINUE_DEVICE_INPUT_DECIDE"*/, 0LL);
    if ( !decideLabel )
      goto LABEL_23;
    ...
    if ( !this->fields.passward2Input )
      goto LABEL_23;
    v14 = (UIInput_o *)decideButton;
    decideButton = (System_String_o *)UnityEngine_Component__GetComponent_object_(
                                        (UnityEngine_Component_o *)this->fields.passward2Input,
                                        (const MethodInfo_2E763AC *)Method_UnityEngine_Component_GetComponent_UIInput___);
    if ( !v14
      || (v15 = (UIInput_o *)decideButton, UIInput__set_value(v14, (System_String_o *)StringLiteral_1/*""*/, 0LL), !v15)
      || (UIInput__set_value(v15, (System_String_o *)StringLiteral_1/*""*/, 0LL),
          (decideButton = (System_String_o *)UnityEngine_Component__GetComponent_object_(
    ...
    {
LABEL_23:
      sub_1B8880C(decideButton, v6);
    }
    UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)decideButton, 0, 0LL);
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3871/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
    UIInput__set_defaultText(v14, v16, 0LL);
    UIInput__set_defaultText(v15, v16, 0LL);
    this->fields.state = 1;
    v17 = (System_Action_o *)sub_1B887FC(System_Action_TypeInfo);
    System_Action___ctor(v17, (Il2CppObject *)this, Method_ContinueDeviceInputMenu_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ContinueDeviceInputMenu_o *)sub_1B88ACC(v8);
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C7650;
}
