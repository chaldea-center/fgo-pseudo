...
void ContinueDeviceInputMenu__Close(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceInputMenu__Close_34150132(this, 0, v2);
}


void ContinueDeviceInputMenu__Close_34150132(
        ContinueDeviceInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E72353 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_ContinueDeviceInputMenu_EndClose__);
    byte_4E72353 = 1;
  }
  ...
  if ( !passward1Input
    ...
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                      ...
                                                      (const MethodInfo_3245988 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0 )
  {
    sub_1D0F30C(passward1Input, v10);
  }
...
void ContinueDeviceInputMenu__EndOpen(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !passward1Input
    ...
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                      ...
                                                      (const MethodInfo_3245988 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0 )
  {
    sub_1D0F30C(passward1Input, method);
  }
...
void ContinueDeviceInputMenu__OnChangeInput(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72354 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_3855/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/);
    sub_1D0F0B4(&StringLiteral_3854/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/);
...
LABEL_25:
      ...
      v15 = (System_String_o *)StringLiteral_3855/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/;
      goto LABEL_28;
    }
LABEL_19:
    ...
    if ( v13 )
    {
      v14 = &StringLiteral_3854/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/;
      goto LABEL_35;
    }
    passward1Input = (UILineInput_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3862/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0);
    if ( warningLabel2 )
    {
...
LABEL_38:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = &StringLiteral_3862/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/;
LABEL_35:
...
void ContinueDeviceInputMenu__OnClickCancel(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72356 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_ContinueDeviceInputMenu_OnClickCancel__);
    byte_4E72356 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_ContinueDeviceInputMenu_OnClickCancel__);
...
void ContinueDeviceInputMenu__OnClickDecide(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72355 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_ContinueDeviceInputMenu_OnClickDecide__);
    byte_4E72355 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1D0F0CC(Method_ContinueDeviceInputMenu_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E72351 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponent_Collider___);
    sub_1D0F0B4(&Method_UnityEngine_Component_GetComponent_UIInput___);
    sub_1D0F0B4(&Method_ContinueDeviceInputMenu_EndOpen__);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_3853/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/);
    sub_1D0F0B4(&StringLiteral_3850/*"CONTINUE_DEVICE_INPUT_DECIDE"*/);
    sub_1D0F0B4(&StringLiteral_3851/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/);
    sub_1D0F0B4(&StringLiteral_3856/*"CONTINUE_DEVICE_INPUT_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_3852/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/);
    sub_1D0F0B4(&StringLiteral_1/*""*/);
    sub_1D0F0B4(&StringLiteral_3862/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/);
    byte_4E72351 = 1;
  }
  ...
  else if ( !state )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3856/*"CONTINUE_DEVICE_INPUT_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_23;
    UILabel__set_text(titleLabel, decideButton, 0);
    explanation1Label = this->fields.explanation1Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3851/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/, 0);
    if ( !explanation1Label )
      goto LABEL_23;
    UILabel__set_text(explanation1Label, decideButton, 0);
    warningLabel1 = this->fields.warningLabel1;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3853/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0);
    if ( !warningLabel1 )
      goto LABEL_23;
    UILabel__set_text(warningLabel1, decideButton, 0);
    warningLabel2 = this->fields.warningLabel2;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3862/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0);
    if ( !warningLabel2 )
      goto LABEL_23;
    UILabel__set_text(warningLabel2, decideButton, 0);
    explanation2Label = this->fields.explanation2Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3852/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/, 0);
    if ( !explanation2Label )
      goto LABEL_23;
    UILabel__set_text(explanation2Label, decideButton, 0);
    decideLabel = this->fields.decideLabel;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3850/*"CONTINUE_DEVICE_INPUT_DECIDE"*/, 0);
    if ( !decideLabel )
      goto LABEL_23;
...
LABEL_23:
    ...
    UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)decideButton, 0, 0);
    v21 = LocalizationManager__Get((System_String_o *)StringLiteral_3853/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (ContinueDeviceInputMenu_o *)sub_1D0F6A8(v8);
...
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1B3579C;
}
