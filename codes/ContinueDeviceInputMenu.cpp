...
void __fastcall ContinueDeviceInputMenu__Close(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceInputMenu__Close_32193032(this, 0LL, v2);
}


void __fastcall ContinueDeviceInputMenu__Close_32193032(
        ContinueDeviceInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFCFF1 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_UIInput___, v6);
    sub_1BC3008(&Method_ContinueDeviceInputMenu_EndClose__, v7);
    byte_4AFCFF1 = 1;
  }
...
void __fastcall ContinueDeviceInputMenu__EndOpen(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFCFF0 & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_UIInput___, v3);
    byte_4AFCFF0 = 1;
  }
  passward1Input = (UnityEngine_Component_o *)this->fields.passward1Input;
  this->fields.state = 2;
  if ( !passward1Input
    ...
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                      ...
                                                      (const MethodInfo_2FF8634 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1BC3264(passward1Input, method);
  }
...
void __fastcall ContinueDeviceInputMenu__OnChangeInput(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFCFF2 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_3777/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/, v3);
    sub_1BC3008(&StringLiteral_3776/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/, v4);
    sub_1BC3008(&StringLiteral_3784/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, v5);
    byte_4AFCFF2 = 1;
  }
...
LABEL_25:
      ...
      v18 = (System_String_o *)StringLiteral_3777/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/;
      goto LABEL_28;
    }
LABEL_19:
    ...
    if ( v16 )
    {
      v17 = &StringLiteral_3776/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/;
      goto LABEL_35;
    }
    passward1Input = (UILineInput_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3784/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( warningLabel2 )
    {
...
LABEL_38:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v17 = &StringLiteral_3784/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/;
LABEL_35:
...
void __fastcall ContinueDeviceInputMenu__OnClickCancel(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFCFF4 & 1) == 0 )
  {
    sub_1BC3008(&Method_ContinueDeviceInputMenu_OnClickCancel__, method);
    byte_4AFCFF4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BC3020(Method_ContinueDeviceInputMenu_OnClickCancel__);
...
void __fastcall ContinueDeviceInputMenu__OnClickDecide(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AFCFF3 & 1) == 0 )
  {
    sub_1BC3008(&Method_ContinueDeviceInputMenu_OnClickDecide__, method);
    byte_4AFCFF3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_ContinueDeviceInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1BC3020(Method_ContinueDeviceInputMenu_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFCFEF & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_Collider___, v5);
    sub_1BC3008(&Method_UnityEngine_Component_GetComponent_UIInput___, v6);
    sub_1BC3008(&Method_ContinueDeviceInputMenu_EndOpen__, v7);
    sub_1BC3008(&LocalizationManager_TypeInfo, v8);
    sub_1BC3008(&StringLiteral_3775/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, v9);
    sub_1BC3008(&StringLiteral_3772/*"CONTINUE_DEVICE_INPUT_DECIDE"*/, v10);
    sub_1BC3008(&StringLiteral_3773/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/, v11);
    sub_1BC3008(&StringLiteral_3778/*"CONTINUE_DEVICE_INPUT_TITLE"*/, v12);
    sub_1BC3008(&StringLiteral_3774/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/, v13);
  ...
  else if ( !state )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3778/*"CONTINUE_DEVICE_INPUT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_23;
    UILabel__set_text(titleLabel, decideButton, 0LL);
    explanation1Label = this->fields.explanation1Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3773/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/, 0LL);
    if ( !explanation1Label )
      goto LABEL_23;
    UILabel__set_text(explanation1Label, decideButton, 0LL);
    warningLabel1 = this->fields.warningLabel1;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3775/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
    if ( !warningLabel1 )
      goto LABEL_23;
    UILabel__set_text(warningLabel1, decideButton, 0LL);
    warningLabel2 = this->fields.warningLabel2;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3784/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( !warningLabel2 )
      goto LABEL_23;
    UILabel__set_text(warningLabel2, decideButton, 0LL);
    explanation2Label = this->fields.explanation2Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3774/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/, 0LL);
    if ( !explanation2Label )
      goto LABEL_23;
    UILabel__set_text(explanation2Label, decideButton, 0LL);
    decideLabel = this->fields.decideLabel;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3772/*"CONTINUE_DEVICE_INPUT_DECIDE"*/, 0LL);
    if ( !decideLabel )
      goto LABEL_23;
    ...
    {
LABEL_23:
      sub_1BC3264(decideButton, v17);
    }
    UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)decideButton, 0, 0LL);
    v27 = LocalizationManager__Get((System_String_o *)StringLiteral_3775/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFCFEC & 1) == 0 )
  {
    sub_1BC3008(&ContinueDeviceInputMenu_CallbackFunc_TypeInfo, value);
    byte_4AFCFEC = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (ContinueDeviceInputMenu_o *)sub_1BC3524(v8);
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A05E0C;
}
