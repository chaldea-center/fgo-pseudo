...
void __fastcall ContinueDeviceInputMenu__Close(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  ContinueDeviceInputMenu__Close_28739680(this, 0LL, v2);
}


void __fastcall ContinueDeviceInputMenu__Close_28739680(
        ContinueDeviceInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA78B & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_ContinueDeviceInputMenu_EndClose__, v16, v17, v18);
    byte_42EA78B = 1;
  }
  ...
  if ( !passward1Input
    ...
    || (UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)passward1Input, 0, 0LL), !v22)
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                      v22,
                                                      (const MethodInfo_1ADE2A0 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_B5D69C(passward1Input, v19);
  }
  ...
  System_Action___ctor(v23, (Il2CppObject *)this, Method_ContinueDeviceInputMenu_EndClose__, 0LL);
  BaseMenu__Close((BaseMenu_o *)this, v23, 0LL);
}
  ...
  if ( !passward1Input
    ...
    || (v10 = passward1Input,
        (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                       v9,
                                                       (const MethodInfo_1ADE2A0 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL)
    || (UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)passward1Input, 1, 0LL), !v10)
    || (passward1Input = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                                      v10,
                                                      (const MethodInfo_1ADE2A0 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_B5D69C(passward1Input, method);
  }
...
void __fastcall ContinueDeviceInputMenu__Init(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !this->fields.passward2Input )
    goto LABEL_15;
  v12 = (UIInput_o *)titleLabel;
  titleLabel = (UILabel_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                              (UnityEngine_Component_o *)this->fields.passward2Input,
                              (const MethodInfo_1ADE2A0 *)Method_UnityEngine_Component_GetComponent_UIInput___);
  if ( !v12 )
    goto LABEL_15;
  v13 = (UIInput_o *)titleLabel;
  UIInput__set_value(v12, (System_String_o *)StringLiteral_1/*""*/, 0LL);
  if ( !v13
...
void __fastcall ContinueDeviceInputMenu__OnChangeInput(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EA78C & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_3442/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/, v5, v6, v7);
    sub_B5D5C4(&StringLiteral_3441/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/, v8, v9, v10);
    sub_B5D5C4(&StringLiteral_3449/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, v11, v12, v13);
    byte_42EA78C = 1;
  }
  ...
  if ( m_stringLength <= 0 )
  {
    ...
    if ( passward1Input->fields.m_CachedPtr < 1 )
    {
      ...
      v24 = &StringLiteral_3449/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/;
      goto LABEL_30;
    }
    goto LABEL_26;
  }
...
LABEL_26:
    ...
    v24 = &StringLiteral_3442/*"CONTINUE_DEVICE_INPUT_PASSWARD_LOW"*/;
    goto LABEL_30;
  }
  v18 = 0;
  do
  {
    Chars = System_String__get_Chars(v15, v18, 0LL);
    if ( (unsigned __int16)(Chars - 48) >= 0xAu && (unsigned __int16)((Chars & 0xFFDF) - 65) > 0x19u )
      goto LABEL_26;
    ++v18;
  }
  while ( v18 < v15->fields.m_stringLength );
  if ( v17->fields.m_stringLength >= 1 )
  {
    v20 = 0;
    do
    {
      v21 = System_String__get_Chars(v17, v20, 0LL);
      if ( (unsigned __int16)(v21 - 48) >= 0xAu && (unsigned __int16)((v21 & 0xFFDF) - 65) > 0x19u )
        goto LABEL_26;
    }
    while ( ++v20 < v17->fields.m_stringLength );
  }
  v22 = System_String__op_Inequality(v15, v17, 0LL);
  warningLabel2 = this->fields.warningLabel2;
  if ( !v22 )
  {
    ...
    passward1Input = (UILineInput_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3449/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( warningLabel2 )
    {
...
LABEL_43:
  ...
  v24 = &StringLiteral_3441/*"CONTINUE_DEVICE_INPUT_PASSWARD_DIFFERENT"*/;
LABEL_30:
  passward1Input = (UILineInput_o *)LocalizationManager__Get((System_String_o *)*v24, 0LL);
  if ( !warningLabel2 )
    goto LABEL_43;
  UILabel__set_text(warningLabel2, (System_String_o *)passward1Input, 0LL);
...
void __fastcall ContinueDeviceInputMenu__OnClickDecide(ContinueDeviceInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 2 )
  {
    ...
    ContinueDeviceInputMenu__Callback(this, v7, v8);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA789 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&Method_UnityEngine_Component_GetComponent_Collider___, v10, v11, v12);
    sub_B5D5C4(&Method_UnityEngine_Component_GetComponent_UIInput___, v13, v14, v15);
    sub_B5D5C4(&Method_ContinueDeviceInputMenu_EndOpen__, v16, v17, v18);
    sub_B5D5C4(&LocalizationManager_TypeInfo, v19, v20, v21);
    sub_B5D5C4(&StringLiteral_3440/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, v22, v23, v24);
    sub_B5D5C4(&StringLiteral_3437/*"CONTINUE_DEVICE_INPUT_DECIDE"*/, v25, v26, v27);
    sub_B5D5C4(&StringLiteral_3438/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/, v28, v29, v30);
    sub_B5D5C4(&StringLiteral_3443/*"CONTINUE_DEVICE_INPUT_TITLE"*/, v31, v32, v33);
    sub_B5D5C4(&StringLiteral_3439/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/, v34, v35, v36);
    sub_B5D5C4(&StringLiteral_1/*""*/, v37, v38, v39);
    sub_B5D5C4(&StringLiteral_3449/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, v40, v41, v42);
    byte_42EA789 = 1;
  }
  ...
  if ( state == 3 )
  {
    ...
    sub_B5D560(
      ...
      v6,
      v7);
    ContinueDeviceInputMenu__EndOpen(this, v56);
  }
  else if ( !state )
  {
    this->fields.callbackFunc = callback;
    ...
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3443/*"CONTINUE_DEVICE_INPUT_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_24;
    UILabel__set_text(titleLabel, decideButton, 0LL);
    explanation1Label = this->fields.explanation1Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3438/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN1"*/, 0LL);
    if ( !explanation1Label )
      goto LABEL_24;
    UILabel__set_text(explanation1Label, decideButton, 0LL);
    warningLabel1 = this->fields.warningLabel1;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3440/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
    if ( !warningLabel1 )
      goto LABEL_24;
    UILabel__set_text(warningLabel1, decideButton, 0LL);
    warningLabel2 = this->fields.warningLabel2;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3449/*"CONTINUE_DEVICE_WARNING_MESSAGE"*/, 0LL);
    if ( !warningLabel2 )
      goto LABEL_24;
    UILabel__set_text(warningLabel2, decideButton, 0LL);
    explanation2Label = this->fields.explanation2Label;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3439/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN2"*/, 0LL);
    if ( !explanation2Label )
      goto LABEL_24;
    UILabel__set_text(explanation2Label, decideButton, 0LL);
    decideLabel = this->fields.decideLabel;
    decideButton = LocalizationManager__Get((System_String_o *)StringLiteral_3437/*"CONTINUE_DEVICE_INPUT_DECIDE"*/, 0LL);
    if ( !decideLabel )
      goto LABEL_24;
    ...
    if ( !this->fields.passward2Input )
      goto LABEL_24;
    v52 = (UIInput_o *)decideButton;
    decideButton = (System_String_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                        (UnityEngine_Component_o *)this->fields.passward2Input,
                                        (const MethodInfo_1ADE2A0 *)Method_UnityEngine_Component_GetComponent_UIInput___);
    if ( !v52
      || (v53 = (UIInput_o *)decideButton, UIInput__set_value(v52, (System_String_o *)StringLiteral_1/*""*/, 0LL), !v53)
      || (UIInput__set_value(v53, (System_String_o *)StringLiteral_1/*""*/, 0LL),
          (decideButton = (System_String_o *)UnityEngine_Component__GetComponent_WebViewObject_(
                                               (UnityEngine_Component_o *)v52,
                                               (const MethodInfo_1ADE2A0 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL)
    ...
    {
LABEL_24:
      sub_B5D69C(decideButton, v44);
    }
    UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)decideButton, 0, 0LL);
    v54 = LocalizationManager__Get((System_String_o *)StringLiteral_3440/*"CONTINUE_DEVICE_INPUT_EXPLANATIOIN3"*/, 0LL);
    UIInput__set_defaultText(v52, v54, 0LL);
    UIInput__set_defaultText(v53, v54, 0LL);
    this->fields.state = 1;
    v55 = (System_Action_o *)sub_B5D694(System_Action_TypeInfo);
    System_Action___ctor(v55, (Il2CppObject *)this, Method_ContinueDeviceInputMenu_EndOpen__, 0LL);
    BaseMenu__Open((BaseMenu_o *)this, v55, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x0
  bool v11; // zf
  ContinueDeviceInputMenu_o *v12; // x0
  ContinueDeviceInputMenu_CallbackFunc_o *v13; // x1
  const MethodInfo *v14; // x2

  if ( (byte_42EA786 & 1) == 0 )
  {
    sub_B5D5C4(&ContinueDeviceInputMenu_CallbackFunc_TypeInfo, (_DWORD)value, (_DWORD)method, v3);
    byte_42EA786 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
    {
      if ( (ContinueDeviceInputMenu_CallbackFunc_c *)v9->klass != ContinueDeviceInputMenu_CallbackFunc_TypeInfo )
        break;
    }
  ...
  v12 = (ContinueDeviceInputMenu_o *)sub_B5D990(v9);
  ContinueDeviceInputMenu__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = (ContinueDeviceInputMenu_o *)sub_B5D990(v9);
  ContinueDeviceInputMenu__EndOpen(v12, v13);
}
        ...
        const MethodInfo *method)
{
  ...
  ContinueDeviceInputMenu_CallbackFunc_o *v29; // x8
  __int64 v30; // x21
  __int64 *v31; // x22
  ...
  ContinueDeviceInputMenu_CallbackFunc_o *v51; // [xsp+8h] [xbp-48h] BYREF
