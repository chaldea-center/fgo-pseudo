        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A233AA & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, *(_QWORD *)&skillId);
    sub_1B715CC(&ServantSkillStrengthStatus_TypeInfo, v13);
    byte_4A233AA = 1;
  }
  ...
  if ( svtSkillEntity )
  {
    ...
    if ( iconLimitUp )
    {
      ...
      iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_38104540(
...
LABEL_14:
    sub_1B71828(iconLimitUp, *(_QWORD *)&skillId);
  }
LABEL_13:
