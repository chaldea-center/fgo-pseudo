        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C25AFA & 1) == 0 )
  {
    sub_1C3B764(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, *(_QWORD *)&skillId);
    sub_1C3B764(&ServantSkillStrengthStatus_TypeInfo, v13);
    byte_4C25AFA = 1;
  }
...
LABEL_15:
    sub_1C3B9C0(iconLimitUp, *(_QWORD *)&skillId);
  }
  ...
  iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_39665308(
