        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5F7B & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, *(_QWORD *)&skillId);
    sub_1B00CCC(&ServantSkillStrengthStatus_TypeInfo, v13);
    byte_48E5F7B = 1;
  }
  ...
  if ( svtSkillEntity )
  {
    ...
    if ( iconLimitUp )
    {
      ...
      iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_37094712(
...
LABEL_14:
    sub_1B00F28(iconLimitUp, *(_QWORD *)&skillId);
  }
LABEL_13:
