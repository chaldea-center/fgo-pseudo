        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC93 & 1) == 0 )
  {
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, *(_QWORD *)&skillId);
  ...
  if ( svtSkillEntity )
  {
    ...
    if ( iconLimitUp )
    {
      ...
      iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_37994916(
