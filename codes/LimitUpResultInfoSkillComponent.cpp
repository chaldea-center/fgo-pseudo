        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01D95 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, *(_QWORD *)&skillId);
  ...
  if ( svtSkillEntity )
  {
    ...
    if ( iconLimitUp )
    {
      ...
      iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_37999280(
...
LABEL_14:
    sub_1B64ACC(iconLimitUp, *(_QWORD *)&skillId);
  }
LABEL_13:
