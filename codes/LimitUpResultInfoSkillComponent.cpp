        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31821 & 1) == 0 )
  {
    sub_1B761C0(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, *(_QWORD *)&skillId);
  ...
  if ( svtSkillEntity )
  {
    ...
    if ( iconLimitUp )
    {
      ...
      iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_38129480(
...
LABEL_14:
    sub_1B7641C(iconLimitUp, *(_QWORD *)&skillId);
  }
LABEL_13:
