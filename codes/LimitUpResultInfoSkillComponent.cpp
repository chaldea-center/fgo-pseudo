        ...
        const MethodInfo *method)
{
  ...
  if ( svtSkillEntity )
  {
    ...
    if ( iconLimitUp )
    {
      ...
      iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_38240928(
...
LABEL_14:
    sub_1B8880C(iconLimitUp, *(_QWORD *)&skillId);
  }
LABEL_13:
