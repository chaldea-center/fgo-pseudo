        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEA3F & 1) == 0 )
  {
    sub_1B4CF90(&Method_UnityEngine_GameObject_GetComponent_ServantSkillStrengthStatus___, *(_QWORD *)&skillId);
    sub_1B4CF90(&ServantSkillStrengthStatus_TypeInfo, v13);
    byte_49BEA3F = 1;
  }
...
LABEL_15:
    sub_1B4D1EC(iconLimitUp, *(_QWORD *)&skillId);
  }
  ...
  iconLimitUp = (SkillIconComponent_o *)BaseMonoBehaviour__createObject_38781524(
