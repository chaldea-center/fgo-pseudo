void __fastcall NewsMaster___ctor(NewsMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB610B & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_NewsMaster__NewsEntity__int___ctor__, method);
    byte_4AB610B = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    62,
    (const MethodInfo_3163D50 *)Method_DataMasterBase_NewsMaster__NewsEntity__int___ctor__);
}
...
NewsEntity_array *__fastcall NewsMaster__GetEnableEntitiyList(NewsMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB610C & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_System_Collections_Generic_List_NewsEntity__Add__, v4);
    sub_1BAB41C(&Method_System_Collections_Generic_List_NewsEntity__ToArray__, v5);
    sub_1BAB41C(&Method_System_Collections_Generic_List_NewsEntity___ctor__, v6);
    sub_1BAB41C(&System_Collections_Generic_List_NewsEntity__TypeInfo, v7);
    sub_1BAB41C(&NetworkManager_TypeInfo, v8);
    sub_1BAB41C(&NewsEntity_TypeInfo, v9);
    byte_4AB610C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  v11 = (System_Collections_Generic_List_object__o *)sub_1BAB668(System_Collections_Generic_List_NewsEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_354D088 *)Method_System_Collections_Generic_List_NewsEntity___ctor__);
...
LABEL_20:
  ...
  return (NewsEntity_array *)System_Collections_Generic_List_object___ToArray(
                               v11,
                               (const MethodInfo_354F414 *)Method_System_Collections_Generic_List_NewsEntity__ToArray__);
}