void __fastcall NewsMaster___ctor(NewsMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49FE8AF & 1) == 0 )
  {
    sub_1B64870(&Method_DataMasterBase_NewsMaster__NewsEntity__int___ctor__, method);
    byte_49FE8AF = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    62,
    (const MethodInfo_30D6140 *)Method_DataMasterBase_NewsMaster__NewsEntity__int___ctor__);
}
...
NewsEntity_array *__fastcall NewsMaster__GetEnableEntitiyList(NewsMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE8B0 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_NewsEntity__Add__, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_NewsEntity__ToArray__, v5);
    sub_1B64870(&Method_System_Collections_Generic_List_NewsEntity___ctor__, v6);
    sub_1B64870(&System_Collections_Generic_List_NewsEntity__TypeInfo, v7);
    sub_1B64870(&NetworkManager_TypeInfo, v8);
    sub_1B64870(&NewsEntity_TypeInfo, v9);
    byte_49FE8B0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  v11 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_NewsEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_NewsEntity___ctor__);
...
LABEL_20:
  ...
  return (NewsEntity_array *)System_Collections_Generic_List_object___ToArray(
                               v11,
                               (const MethodInfo_34B15A8 *)Method_System_Collections_Generic_List_NewsEntity__ToArray__);
}