void __fastcall NewsMaster___ctor(NewsMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B66F91 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataMasterBase_NewsMaster__NewsEntity__int___ctor__, method);
    byte_4B66F91 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    66,
    (const MethodInfo_31FD784 *)Method_DataMasterBase_NewsMaster__NewsEntity__int___ctor__);
}
...
NewsEntity_array *__fastcall NewsMaster__GetEnableEntitiyList(NewsMaster_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B66F92 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_System_Collections_Generic_List_NewsEntity__Add__, v4);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_NewsEntity__ToArray__, v5);
    sub_1BE4ACC(&Method_System_Collections_Generic_List_NewsEntity___ctor__, v6);
    sub_1BE4ACC(&System_Collections_Generic_List_NewsEntity__TypeInfo, v7);
    sub_1BE4ACC(&NetworkManager_TypeInfo, v8);
    sub_1BE4ACC(&NewsEntity_TypeInfo, v9);
    byte_4B66F92 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  v11 = (System_Collections_Generic_List_object__o *)sub_1BE4D18(System_Collections_Generic_List_NewsEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v11,
    (const MethodInfo_35EB9F0 *)Method_System_Collections_Generic_List_NewsEntity___ctor__);
...
LABEL_20:
  ...
  return (NewsEntity_array *)System_Collections_Generic_List_object___ToArray(
                               v11,
                               (const MethodInfo_35EDD7C *)Method_System_Collections_Generic_List_NewsEntity__ToArray__);
}