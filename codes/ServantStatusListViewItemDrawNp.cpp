void __fastcall ServantStatusListViewItemDrawNp___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B63B83 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantStatusListViewItemDrawNp_TypeInfo, v1);
    byte_4B63B83 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63B82 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantStatusListViewItemDrawNp_TypeInfo, method);
    sub_1BE4ACC(&ServantStatusNpComponent___TypeInfo, v3);
    byte_4B63B82 = 1;
  }
  ...
  v5 = (struct ServantStatusNpComponent_array *)sub_1BE4B74(
                                                  ServantStatusNpComponent___TypeInfo,
                                                  v4->static_fields->NP_LIST_MAX);
  this->fields.npList = v5;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.npList, (int64_t)v5, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63B81 & 1) == 0 )
  {
    sub_1BE4ACC(&ServantStatusListViewItemDrawNp_TypeInfo, item);
    byte_4B63B81 = 1;
  }
  v5 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B63B80 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataManager_GetMasterData_ServantTreasureDeviceAddMaster___, item);
    ...
    sub_1BE4ACC(&ServantStatusListViewItemDrawNp_TypeInfo, v10);
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_DataManager__getInstance__, v11);
    sub_1BE4ACC(&TreasureDvcInfo_TypeInfo, v12);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v13);
    byte_4B63B80 = 1;
  }
  this->fields.dispMode = mode;
  v14 = (TreasureDvcInfo_o *)sub_1BE4D18(TreasureDvcInfo_TypeInfo);
  TreasureDvcInfo___ctor(v14, 0LL);
  this->fields.tdInfo = v14;
  p_tdInfo = &this->fields.tdInfo;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.tdInfo, (int64_t)v14, v16, v17, v18, v19, v20, v21);
  if ( !item || !mode )
    return;
  ...
  else if ( ServantStatusListViewItem__get_IsMine(item, 0LL) )
  {
    ...
    ConvertOverwriteDispImageLimitCount = ServantLimitImageMaster__GetServantImageLimitSealAfter(
                                            ...
                                            0LL);
    ServantStatusListViewItem__GetNpInfo_34048328(item, &this->fields.tdInfo, ConvertOverwriteDispImageLimitCount, 0LL);
