void __fastcall ServantStatusListViewItemDrawNp___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FB374 & 1) == 0 )
  {
    sub_1B64870(&ServantStatusListViewItemDrawNp_TypeInfo, v1);
    byte_49FB374 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB373 & 1) == 0 )
  {
    sub_1B64870(&ServantStatusListViewItemDrawNp_TypeInfo, method);
    sub_1B64870(&ServantStatusNpComponent___TypeInfo, v3);
    byte_49FB373 = 1;
  }
  ...
  v5 = (struct ServantStatusNpComponent_array *)sub_1B64918(
                                                  ServantStatusNpComponent___TypeInfo,
                                                  v4->static_fields->NP_LIST_MAX);
  this->fields.npList = v5;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.npList, (int32_t)v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB372 & 1) == 0 )
  {
    sub_1B64870(&ServantStatusListViewItemDrawNp_TypeInfo, item);
    byte_49FB372 = 1;
  }
  v5 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB371 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_ServantTreasureDeviceAddMaster___, item);
    ...
    sub_1B64870(&ServantStatusListViewItemDrawNp_TypeInfo, v10);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__getInstance__, v11);
    sub_1B64870(&TreasureDvcInfo_TypeInfo, v12);
    sub_1B64870(&StringLiteral_1/*""*/, v13);
    byte_49FB371 = 1;
  }
  this->fields.dispMode = mode;
  v14 = (TreasureDvcInfo_o *)sub_1B64ABC(TreasureDvcInfo_TypeInfo);
  TreasureDvcInfo___ctor(v14, 0LL);
  this->fields.tdInfo = v14;
  p_tdInfo = &this->fields.tdInfo;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.tdInfo, (int32_t)v14, v16, v17);
  if ( !item || !mode )
    return;
  ...
  else if ( ServantStatusListViewItem__get_IsMine(item, 0LL) )
  {
    ...
    DispLimitCount = ServantLimitImageMaster__GetServantImageLimitSealAfter(
                       ...
                       DispLimitCount,
                       0LL);
    ServantStatusListViewItem__GetNpInfo_32490592(item, &this->fields.tdInfo, DispLimitCount, 0LL);
