void __fastcall FadeClipController___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B0395 & 1) == 0 )
  {
    sub_B52984(&FadeClipController_TypeInfo);
    sub_B52984(&StringLiteral_16092/*"_FadeParam"*/);
    sub_B52984(&StringLiteral_16090/*"_FadeDegreeTo"*/);
    sub_B52984(&StringLiteral_16077/*"_FADE_CLIP"*/);
    sub_B52984(&StringLiteral_16089/*"_FadeDegreeFrom"*/);
    byte_42B0395 = 1;
  }
  FadeClipController_TypeInfo->static_fields->FADE_PARAM_ID = UnityEngine_Shader__PropertyToID(
                                                                (System_String_o *)StringLiteral_16092/*"_FadeParam"*/,
                                                                0LL);
  FadeClipController_TypeInfo->static_fields->FADE_DEGREE_FROM_ID = UnityEngine_Shader__PropertyToID(
                                                                      (System_String_o *)StringLiteral_16089/*"_FadeDegreeFrom"*/,
                                                                      0LL);
  v1 = UnityEngine_Shader__PropertyToID((System_String_o *)StringLiteral_16090/*"_FadeDegreeTo"*/, 0LL);
  v2 = FadeClipController_TypeInfo;
  FadeClipController_TypeInfo->static_fields->FADE_DEGREE_TO_ID = v1;
  static_fields = v2->static_fields;
  v4 = (System_Int32_array **)StringLiteral_16077/*"_FADE_CLIP"*/;
  static_fields->FADE_CLIP_ID = (struct System_String_o *)StringLiteral_16077/*"_FADE_CLIP"*/;
  sub_B52920((BattleServantConfConponent_o *)&static_fields->FADE_CLIP_ID, v4, v5, v6, v7, v8, v9, v10);
}
...
void __fastcall FadeClipController__Update(FadeClipController_o *this, const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(material, 0LL, 0LL) )
  {
    ...
    if ( !v5 )
      goto LABEL_24;
    UnityEngine_Material__SetFloat_41522004(
      v5,
