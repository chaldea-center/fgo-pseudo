void __fastcall FadeClipController___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A09FF2 & 1) == 0 )
  {
    sub_1B686D4(&FadeClipController_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_16151/*"_FadeParam"*/, v2);
    sub_1B686D4(&StringLiteral_16149/*"_FadeDegreeTo"*/, v3);
    sub_1B686D4(&StringLiteral_16133/*"_FADE_CLIP"*/, v4);
    sub_1B686D4(&StringLiteral_16148/*"_FadeDegreeFrom"*/, v5);
    byte_4A09FF2 = 1;
  }
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&static_fields->FADE_CLIP_ID, v8, v9, v10);
}
...
void __fastcall FadeClipController__Setup(FadeClipController_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(meshRenderer, 0LL, 0LL) )
  {
    ...
    if ( UnityEngine_Object__op_Equality(material, 0LL, 0LL) )
    {
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.material, (int32_t)v7, v8, v9);
    }
  }
}
...
void __fastcall FadeClipController__Start(FadeClipController_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality(meshRenderer, 0LL, 0LL) )
  {
    ...
    sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.meshRenderer, (int32_t)Component_object, v7, v8);
  }
...
void __fastcall FadeClipController__Update(FadeClipController_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A09FF1 & 1) == 0 )
  {
    sub_1B686D4(&FadeClipController_TypeInfo, method);
    sub_1B686D4(&UnityEngine_Object_TypeInfo, v3);
    byte_4A09FF1 = 1;
  }
  material = (UnityEngine_Object_o *)this->fields.material;
