void BattleActorAnimationEffect___ctor(BattleActorAnimationEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C463A8 & 1) == 0 )
  {
    sub_1C37058(&BattleActorAnimationEffect_DisplayTrigger_TypeInfo);
    byte_4C463A8 = 1;
  }
  v3 = (BattleActorAnimationEffect_DisplayTrigger_o *)sub_1C372A4(BattleActorAnimationEffect_DisplayTrigger_TypeInfo);
  BattleActorAnimationEffect_DisplayTrigger___ctor(v3, v4);
  this->fields.trigger = v3;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.trigger, (int32_t)v3, v5, v6);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C463A7 & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_IEffectMesh___);
    this = (BattleActorAnimationEffect_o *)sub_1C37058(&IEffectMesh_TypeInfo);
    byte_4C463A7 = 1;
  }
  if ( !obj )
    sub_1C372B4(this);
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       obj,
                       (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_IEffectMesh___);
  if ( Component_object )
  {
    ...
    {
LABEL_9:
      v11 = sub_1C87870(Component_object, IEffectMesh_TypeInfo, 0);
    }
    ...
    {
LABEL_16:
      v15 = sub_1C87870(v8, IEffectMesh_TypeInfo, 1);
    }
        ...
        const MethodInfo *method)
{
  if ( isEnemy && this->fields.isEnemyFlip )
  {
    if ( !effectObj || (this = (BattleActorAnimationEffect_o *)UnityEngine_GameObject__get_transform(effectObj, 0)) == 0 )
      sub_1C372B4(this);
    UnityEngine_Transform__Rotate_71291428((UnityEngine_Transform_o *)this, 0.0, 180.0, 0.0, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C463A6 & 1) == 0 )
  {
    this = (BattleActorAnimationEffect_o *)sub_1C37058(&BattleEffectUtility_TypeInfo);
    byte_4C463A6 = 1;
  }
  if ( !actor )
    goto LABEL_19;
  ...
  if ( !byte_4C3C921 )
  {
    this = (BattleActorAnimationEffect_o *)sub_1C37058(&UnityEngine_Vector3_TypeInfo);
    byte_4C3C921 = 1;
  }
  if ( !v11 )
    goto LABEL_19;
        ...
        const MethodInfo *method)
{
  ...
  return System_String__Format_63602948(
           (System_String_o *)StringLiteral_25177/*"{0}:{1}"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C463A5 & 1) == 0 )
  {
    sub_1C37058(&System_Action_BattleActorControl__TypeInfo);
    sub_1C37058(&Method_BasicHelper_DelayCall_BattleActorControl___);
    sub_1C37058(&Method_BattleActorAnimationEffect_DisplayEffect__);
  ...
  if ( !v5 )
  {
    ...
    if ( delay <= 0.0 )
    {
      BattleActorAnimationEffect__DisplayEffect(this, actor, v6);
    }
    else
    {
      v9 = (System_Action_object__o *)sub_1C372A4(System_Action_BattleActorControl__TypeInfo);
      System_Action_object____ctor(v9, (Il2CppObject *)this, Method_BattleActorAnimationEffect_DisplayEffect__, 0);
      v10 = BasicHelper__DelayCall_object_(
              delay,
              (System_Action_T__o *)v9,
              (Il2CppObject *)actor,
              (const MethodInfo_30D16BC *)Method_BasicHelper_DelayCall_BattleActorControl___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C463A3 & 1) == 0 )
  {
    this = (BattleActorAnimationEffect_o *)sub_1C37058(&AnimationList_NAME_TypeInfo);
    byte_4C463A3 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.eventTag, v5, v2, v3);
  v6 = (struct System_Int32_array *)sub_1C37100(int___TypeInfo, 0);
  this->fields.targetSvtLimits = v6;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.targetSvtLimits, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C463A9 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_BattleActorAnimationEffect_DisplayTrigger___c__DisplayClass4_0__IsTarget_b__0__);
    sub_1C37058(&BattleActorAnimationEffect_DisplayTrigger___c__DisplayClass4_0_TypeInfo);
    byte_4C463A9 = 1;
  }
  v5 = sub_1C372A4(BattleActorAnimationEffect_DisplayTrigger___c__DisplayClass4_0_TypeInfo);
