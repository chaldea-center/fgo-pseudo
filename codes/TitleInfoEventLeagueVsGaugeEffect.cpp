        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59082 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_17319/*"bit_vs_gauge_part_1"*/);
    this = (TitleInfoEventLeagueVsGaugeEffect_o *)sub_1B885B0(&StringLiteral_17320/*"bit_vs_gauge_part_2"*/);
    byte_4A59082 = 1;
  }
  v9 = 0.5;
  v10 = 0.5;
            ...
            if ( v17->max_length > 3 )
            {
              ...
              if ( v21->max_length > 2 )
              {
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeSimpleAnim, 0LL, 0LL) )
                {
                  ...
                  if ( this )
                  {
                    v25 = &StringLiteral_17320/*"bit_vs_gauge_part_2"*/;
LABEL_51:
                    SimpleAnimation__Play_63844704((SimpleAnimation_o *)this, (System_String_o *)*v25, 0LL);
                    return;
                  }
                  goto LABEL_64;
                }
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeAnim, 0LL, 0LL) )
                {
                  ...
                  if ( !this )
                    goto LABEL_64;
                  v38 = &StringLiteral_17320/*"bit_vs_gauge_part_2"*/;
LABEL_62:
                  UnityEngine_Animation__Play_69204472((UnityEngine_Animation_o *)this, (System_String_o *)*v38, 0LL);
                  return;
                }
                return;
              }
...
LABEL_65:
  ...
  if ( UnityEngine_Object__op_Inequality(v36, 0LL, 0LL) )
  {
    ...
    if ( this )
    {
      v25 = &StringLiteral_17319/*"bit_vs_gauge_part_1"*/;
      goto LABEL_51;
    }
LABEL_64:
    sub_1B8880C(this, point1);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v39, 0LL, 0LL) )
  {
    ...
    if ( !this )
      goto LABEL_64;
    v38 = &StringLiteral_17319/*"bit_vs_gauge_part_1"*/;
    goto LABEL_62;
  }
}