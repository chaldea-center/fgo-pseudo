        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3549D & 1) == 0 )
  {
    sub_1BD3458(&UnityEngine_Object_TypeInfo, point1);
    sub_1BD3458(&StringLiteral_17515/*"bit_vs_gauge_part_1"*/, v9);
    this = (TitleInfoEventLeagueVsGaugeEffect_o *)sub_1BD3458(&StringLiteral_17516/*"bit_vs_gauge_part_2"*/, v10);
    byte_4B3549D = 1;
  }
  v11 = 0.5;
  v12 = 0.5;
            ...
            if ( v19->max_length > 3 )
            {
              ...
              if ( v23->max_length > 2 )
              {
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeSimpleAnim, 0LL, 0LL) )
                {
                  ...
                  if ( this )
                  {
                    v27 = &StringLiteral_17516/*"bit_vs_gauge_part_2"*/;
LABEL_51:
                    SimpleAnimation__Play_64663364((SimpleAnimation_o *)this, (System_String_o *)*v27, 0LL);
                    return;
                  }
                  goto LABEL_64;
                }
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeAnim, 0LL, 0LL) )
                {
                  ...
                  if ( !this )
                    goto LABEL_64;
                  v40 = &StringLiteral_17516/*"bit_vs_gauge_part_2"*/;
LABEL_62:
                  UnityEngine_Animation__Play_70023276((UnityEngine_Animation_o *)this, (System_String_o *)*v40, 0LL);
                  return;
                }
                return;
              }
...
LABEL_65:
  ...
  if ( UnityEngine_Object__op_Inequality(v38, 0LL, 0LL) )
  {
    ...
    if ( this )
    {
      v27 = &StringLiteral_17515/*"bit_vs_gauge_part_1"*/;
      goto LABEL_51;
    }
LABEL_64:
    sub_1BD36B4(this, point1);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v41, 0LL, 0LL) )
  {
    ...
    if ( !this )
      goto LABEL_64;
    v40 = &StringLiteral_17515/*"bit_vs_gauge_part_1"*/;
    goto LABEL_62;
  }
}