        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB421D & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_17302/*"bit_vs_gauge_part_1"*/);
    this = (TitleInfoEventLeagueVsGaugeEffect_o *)sub_1C6BA08(&StringLiteral_17303/*"bit_vs_gauge_part_2"*/);
    byte_4CB421D = 1;
  }
  v9 = 0.5;
  v10 = 0.5;
            ...
            if ( LODWORD(v25->max_length) > 3 )
            {
              ...
              if ( LODWORD(v29->max_length) > 2 )
              {
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeSimpleAnim, 0, 0) )
                {
                  ...
                  if ( this )
                  {
                    v33 = &StringLiteral_17303/*"bit_vs_gauge_part_2"*/;
LABEL_51:
                    SimpleAnimation__Play_66911856((SimpleAnimation_o *)this, (System_String_o *)*v33, 0);
                    return;
                  }
                  goto LABEL_64;
                }
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeAnim, 0, 0) )
                {
                  ...
                  if ( !this )
                    goto LABEL_64;
                  v54 = &StringLiteral_17303/*"bit_vs_gauge_part_2"*/;
LABEL_62:
                  UnityEngine_Animation__Play_71403152((UnityEngine_Animation_o *)this, (System_String_o *)*v54, 0);
                  return;
                }
                return;
              }
...
LABEL_65:
  ...
  if ( UnityEngine_Object__op_Inequality(v52, 0, 0) )
  {
    ...
    if ( this )
    {
      v33 = &StringLiteral_17302/*"bit_vs_gauge_part_1"*/;
      goto LABEL_51;
    }
LABEL_64:
    sub_1C6BC60(this, point1);
  }
  ...
  if ( UnityEngine_Object__op_Inequality(v55, 0, 0) )
  {
    ...
    if ( !this )
      goto LABEL_64;
    v54 = &StringLiteral_17302/*"bit_vs_gauge_part_1"*/;
    goto LABEL_62;
  }
}