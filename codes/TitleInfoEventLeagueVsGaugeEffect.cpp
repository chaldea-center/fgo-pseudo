            ...
            if ( (v24->max_length & 0xFFFFFFFC) != 0 )
            {
              ...
              if ( LODWORD(v29->max_length) > 2 )
              {
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeSimpleAnim, 0, 0) )
                {
                  ...
                  if ( this )
                  {
                    v36 = &StringLiteral_18028/*"bit_vs_gauge_part_2"*/;
LABEL_54:
                    SimpleAnimation__Play_78552168((SimpleAnimation_o *)this, (System_String_o *)*v36, 0);
                    return;
                  }
                  goto LABEL_67;
                }
                ...
                if ( UnityEngine_Object__op_Inequality(gaugeAnim, 0, 0) )
                {
                  ...
                  if ( !this )
                    goto LABEL_67;
                  v61 = &StringLiteral_18028/*"bit_vs_gauge_part_2"*/;
LABEL_65:
                  UnityEngine_Animation__Play_83078544((UnityEngine_Animation_o *)this, (System_String_o *)*v61, 0);
                  return;
                }
                return;
              }
...
LABEL_68:
  ...
  if ( UnityEngine_Object__op_Inequality(v58, 0, 0) )
  {
    ...
    if ( this )
    {
      v36 = &StringLiteral_18027/*"bit_vs_gauge_part_1"*/;
      goto LABEL_54;
    }
LABEL_67:
  ...
  if ( UnityEngine_Object__op_Inequality(v62, 0, 0) )
  {
    ...
    if ( !this )
      goto LABEL_67;
    v61 = &StringLiteral_18027/*"bit_vs_gauge_part_1"*/;
    goto LABEL_65;
  }
}