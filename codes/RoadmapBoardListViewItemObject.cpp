        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB0C4E & 1) == 0 )
  {
    sub_1BAB41C(&RoadmapBoardListViewItem_TypeInfo, item);
    byte_4AB0C4E = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (RoadmapBoardListViewItemDraw_o *)sub_1BAB938(item);
      goto LABEL_9;
    }
  }
  RoadmapBoardListViewItemDraw__UpdateBoard(itemDraw, (RoadmapBoardListViewItem_o *)item, 0LL);
}