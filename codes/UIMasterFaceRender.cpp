void UIMasterFaceRender___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&UIMasterFaceRender_TypeInfo->static_fields->MAIN_SIZE_X = xmmword_CF62C0;
  v1 = sub_1C7BB90(UnityEngine_Vector2___TypeInfo, 2);
  if ( !v1 )
    goto LABEL_14;
  v3 = *(_DWORD *)(v1 + 24);
  if ( !v3 )
...
LABEL_13:
  ...
  *(_QWORD *)(v1 + 40) = v13;
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v15->bodyTextureSizeTable, (int32_t)v14, v16, v17, v18, v19, v20, v21);
  v1 = sub_1C7BB90(UnityEngine_Vector2___TypeInfo, 2);
  if ( !v1 )
LABEL_14:
    sub_1C7BD40(v1, v2);
  ...
  *(int32x2_t *)(v1 + 40) = vdup_n_s32(0x432F0000u);
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&v24->bodySizeTable, (int32_t)v23, v25, v26, v27, v28, v29, v30);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFED8 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_8969/*"MasterFace/statusMask"*/);
    sub_1C7BAE8(&StringLiteral_8967/*"MasterFace/equip{0:D5}"*/);
    sub_1C7BAE8(&StringLiteral_8968/*"MasterFace/image{0:D5}"*/);
    byte_4CEFED8 = 1;
  }
  Instance = (char *)sub_1C7BB90(string___TypeInfo, 2);
  v17 = dispType == 1;
  v18 = Instance;
  if ( v17 )
  {
    ...
    if ( *((_DWORD *)Instance + 6) <= 1u )
      goto LABEL_36;
    v19 = StringLiteral_8969/*"MasterFace/statusMask"*/;
    *((_QWORD *)Instance + 5) = StringLiteral_8969/*"MasterFace/statusMask"*/;
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(Instance + 40), v19, v11, v12, v13, v14, v15, v16);
  }
  if ( overWriteImageId )
  {
    v46 = overWriteImageId;
    v20 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v46);
    v21 = (System_String_o *)StringLiteral_8968/*"MasterFace/image{0:D5}"*/;
    goto LABEL_31;
  }
  if ( equipId < 1 )
    goto LABEL_27;
  ...
  *(_QWORD *)&v47.fields.fakeValue = v26;
  ...
  Instance = (char *)System_String__Format((System_String_o *)StringLiteral_8967/*"MasterFace/equip{0:D5}"*/, v28, 0);
  if ( !v18 )
    goto LABEL_35;
  if ( !*((_DWORD *)v18 + 6) )
    goto LABEL_36;
  *((_QWORD *)v18 + 4) = Instance;
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v18 + 32), (int32_t)Instance, v29, v30, v31, v32, v33, v34);
  if ( !*((_DWORD *)v18 + 6) )
    goto LABEL_36;
...
LABEL_27:
    ...
    v21 = (System_String_o *)StringLiteral_8967/*"MasterFace/equip{0:D5}"*/;
LABEL_31:
    ...
    if ( v18 )
    {
      ...
      {
        *((_QWORD *)v18 + 4) = Instance;
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v18 + 32), (int32_t)Instance, v37, v38, v39, v40, v41, v42);
        ...
        const MethodInfo *method)
{
  if ( (byte_4CEFEDB & 1) == 0 )
  {
    this = (UIMasterFaceRender_o *)sub_1C7BAE8(&Method_AssetData_GetObject_Texture2D___);
    byte_4CEFEDB = 1;
  }
  if ( !dataList )
    goto LABEL_7;
...
// local variable allocation has failed, the output may be wrong!
void UIMasterFaceRender__MoveAlpha_44519608(
        UIMasterFaceRender_o *this,
        float duration,
        float alpha,
...
void UIMasterFaceRender__SetLayer(UIMasterFaceRender_o *this, int32_t layer, const MethodInfo *method)
{
  ...
  if ( UnityEngine_GameObject__get_layer(gameObject, 0) != layer )
  {
    ...
    UIMasterFaceRender__SetLayer_44520140(this, transform, layer, v8);
  }
}


void UIMasterFaceRender__SetLayer_44520140(
        UIMasterFaceRender_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEFEDE & 1) == 0 )
  {
    ...
    this = (UIMasterFaceRender_o *)sub_1C7BAE8(&UnityEngine_Transform_TypeInfo);
    byte_4CEFEDE = 1;
  }
  if ( !tf
...
LABEL_17:
    ...
    UIMasterFaceRender__SetLayer_44520140(v6, v17, layer, v18);
  }
