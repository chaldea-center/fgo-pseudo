        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F5A & 1) == 0 )
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, isEnabled);
    byte_4A01F5A = 1;
  }
...
LABEL_12:
      sub_1B64ACC(servantFaceIcon, userServantEntity);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01F5C & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_9251/*"NOT_SELECT_LET_GO"*/, v5);
    sub_1B64870(&StringLiteral_11444/*"SELECT_CANNOT"*/, v6);
    sub_1B64870(&StringLiteral_1/*""*/, v7);
    sub_1B64870(&StringLiteral_8513/*"MATERIAL_FIND_SERVANT"*/, v8);
    sub_1B64870(&StringLiteral_9249/*"NOT_SELECT_COSTUME"*/, v9);
    byte_4A01F5C = 1;
  }
  if ( !item )
    return;
...
LABEL_28:
  ...
  if ( !servantData->fields.userServantEntity )
  {
    ...
    if ( isLetgo )
      v16 = &StringLiteral_9251/*"NOT_SELECT_LET_GO"*/;
    else
      v16 = &StringLiteral_8513/*"MATERIAL_FIND_SERVANT"*/;
LABEL_25:
  ...
  if ( ServantCostumeListViewItem__get_IsHeroineLeave(item, (const MethodInfo *)item) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v16 = &StringLiteral_11444/*"SELECT_CANNOT"*/;
    goto LABEL_25;
  }
  if ( !item->fields.isReleaseItemHaving )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v16 = &StringLiteral_9249/*"NOT_SELECT_COSTUME"*/;
    goto LABEL_25;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&LocalizationManager_TypeInfo, item);
    sub_1B64870(&StringLiteral_9247/*"NOT_RELEASE_COSTUME"*/, v5);
  ...
  if ( v3 )
  {
    ...
    nonColorStatusLabel = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_9247/*"NOT_RELEASE_COSTUME"*/,
                                                       0LL);
    if ( v12 )
    {
...
LABEL_29:
    sub_1B64ACC(nonColorStatusLabel, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&LocalizationManager_TypeInfo, item);
    sub_1B64870(&StringLiteral_458/*"#FFFFFF"*/, v5);
    sub_1B64870(&StringLiteral_455/*"#FEEF99"*/, v6);
    sub_1B64870(&StringLiteral_457/*"#FFFF00"*/, v7);
    sub_1B64870(&StringLiteral_5549/*"EVENT_COMBINE_COSTUME_LF"*/, v8);
    sub_1B64870(&StringLiteral_3868/*"COSTUME_CAN_RELEASE"*/, v9);
    sub_1B64870(&StringLiteral_1/*""*/, v10);
    sub_1B64870(&StringLiteral_450/*"#E1A545"*/, v11);
    sub_1B64870(&StringLiteral_5541/*"EVENT_COMBINE_COSTUME_ITEM"*/, v12);
    byte_4A01F5D = 1;
  }
...
LABEL_24:
    sub_1B64ACC(statusTxtLabel, item);
  }
}