        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B205FA & 1) == 0 )
  {
    sub_1BCAFF8(&UnityEngine_Object_TypeInfo, isEnabled);
    byte_4B205FA = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B205FC & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_9246/*"NOT_SELECT_LET_GO"*/, v5);
    sub_1BCAFF8(&StringLiteral_11417/*"SELECT_CANNOT"*/, v6);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v7);
    sub_1BCAFF8(&StringLiteral_8508/*"MATERIAL_FIND_SERVANT"*/, v8);
    sub_1BCAFF8(&StringLiteral_9244/*"NOT_SELECT_COSTUME"*/, v9);
    byte_4B205FC = 1;
  }
  if ( !item )
    return;
...
LABEL_28:
  ...
  if ( !servantData->fields.userServantEntity )
  {
    ...
    if ( isLetgo )
      v16 = &StringLiteral_9246/*"NOT_SELECT_LET_GO"*/;
    else
      v16 = &StringLiteral_8508/*"MATERIAL_FIND_SERVANT"*/;
LABEL_25:
  ...
  if ( ServantCostumeListViewItem__get_IsHeroineLeave(item, (const MethodInfo *)item) )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v16 = &StringLiteral_11417/*"SELECT_CANNOT"*/;
    goto LABEL_25;
  }
  if ( !item->fields.isReleaseItemHaving )
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v16 = &StringLiteral_9244/*"NOT_SELECT_COSTUME"*/;
    goto LABEL_25;
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&LocalizationManager_TypeInfo, item);
    sub_1BCAFF8(&StringLiteral_9242/*"NOT_RELEASE_COSTUME"*/, v5);
  ...
  if ( v3 )
  {
    ...
    nonColorStatusLabel = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                       (System_String_o *)StringLiteral_9242/*"NOT_RELEASE_COSTUME"*/,
                                                       0LL);
    if ( v12 )
    {
...
LABEL_29:
    sub_1BCB254(nonColorStatusLabel, item);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&LocalizationManager_TypeInfo, item);
    sub_1BCAFF8(&StringLiteral_426/*"#FFFFFF"*/, v5);
    sub_1BCAFF8(&StringLiteral_422/*"#FEEF99"*/, v6);
    sub_1BCAFF8(&StringLiteral_425/*"#FFFF00"*/, v7);
    sub_1BCAFF8(&StringLiteral_5505/*"EVENT_COMBINE_COSTUME_LF"*/, v8);
    sub_1BCAFF8(&StringLiteral_3797/*"COSTUME_CAN_RELEASE"*/, v9);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v10);
    sub_1BCAFF8(&StringLiteral_417/*"#E1A545"*/, v11);
    sub_1BCAFF8(&StringLiteral_5497/*"EVENT_COMBINE_COSTUME_ITEM"*/, v12);
    byte_4B205FD = 1;
  }
  ...
  if ( item )
  {
    ...
    if ( !ServantCostumeListViewItem__get_IsCanNotSelect(item, v14) )
    {
      if ( item->fields.isOpenEventCostume )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        v16 = LocalizationManager__Get((System_String_o *)StringLiteral_5505/*"EVENT_COMBINE_COSTUME_LF"*/, 0LL);
        v17 = (Il2CppObject *)LocalizationManager__Get((System_String_o *)StringLiteral_5497/*"EVENT_COMBINE_COSTUME_ITEM"*/, 0LL);
...
LABEL_16:
      ...
      if ( item->fields.isClearAllCond )
      {
        ...
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        statusTxtLabel = (UILabel_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3797/*"COSTUME_CAN_RELEASE"*/, 0LL);
        if ( !v19 )
          goto LABEL_24;
...
LABEL_24:
    sub_1BCB254(statusTxtLabel, item);
  }
}