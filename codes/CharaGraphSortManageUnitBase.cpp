        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)sortSaveKeyPrefix, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !sortInfo )
  {
    ...
    v6 = System_String__Concat_60325748(SortSaveKeyPrefix_k__BackingField, v5, 0LL);
    v7 = ((__int64 (__fastcall *)(CharaGraphSortManageUnitBase_o *, void *))this->klass[1]._1.namespaze)(
           this,
           this->klass[1]._1.byval_arg.data);
    sortInfo = (struct ListViewSort_o *)sub_1B00F18(ListViewSort_TypeInfo);
    ListViewSort___ctor_39464988(sortInfo, v6, v7, 0, 0LL);
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.sortInfo, (int32_t)sortInfo, v10, v11);
  }
  return sortInfo;
}
