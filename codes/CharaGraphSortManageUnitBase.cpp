        ...
        const MethodInfo *method)
{
  ...
  if ( !sortInfo )
  {
    ...
    v6 = System_String__Concat_64425724(SortSaveKeyPrefix_k__BackingField, v5, 0);
    v7 = ((__int64 (__fastcall *)(CharaGraphSortManageUnitBase_o *, const char *))this->klass[1]._1.name)(
           this,
           this->klass[1]._1.namespaze);
    sortInfo = (struct ListViewSort_o *)sub_1C93D20(ListViewSort_TypeInfo);
    ListViewSort___ctor_44521036(sortInfo, v6, v7, 0, 0);
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.sortInfo, (int32_t)sortInfo, v10, v11, v12, v13, v14, v15);
  }
  return sortInfo;
}
