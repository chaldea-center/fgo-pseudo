        ...
        const MethodInfo *method)
{
  ...
  if ( !sortInfo )
  {
    ...
    v6 = System_String__Concat_62967944(SortSaveKeyPrefix_k__BackingField, v5, 0LL);
    v7 = ((__int64 (__fastcall *)(CharaGraphSortManageUnitBase_o *, void *))this->klass[1]._1.namespaze)(
           this,
           this->klass[1]._1.byval_arg.data);
    sortInfo = (struct ListViewSort_o *)sub_1C13F70(ListViewSort_TypeInfo);
    ListViewSort___ctor_41918496(sortInfo, v6, v7, 0, 0LL);
    ...
    sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.sortInfo, (int64_t)sortInfo, v10, v11, v12, v13, v14, v15);
  }
  return sortInfo;
}
