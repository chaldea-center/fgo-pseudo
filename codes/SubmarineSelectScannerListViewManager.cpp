        ...
        const MethodInfo *method)
{
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      id = v10->fields.id;
      v16 = sub_1C3E7B0(SubmarineSelectScannerListViewItem_TypeInfo);
      ListViewItem___ctor_43860152((ListViewItem_o *)v16, v9, 0);
      *(_DWORD *)(v16 + 128) = iconImageId;
      *(_DWORD *)(v16 + 120) = eventId;
      *(_DWORD *)(v16 + 124) = id;
      *(_QWORD *)(v16 + 136) = name;
      sub_1C3E508((CGThumbnailListItem_o *)(v16 + 136), (int32_t)name, v17, v18);
      *(_BYTE *)(v16 + 152) = v11 & 1;
      if ( !itemList )
        break;
      ...
      else
      {
        ...
        sub_1C3E508((CGThumbnailListItem_o *)(v24 + 4), v16, v19, v20);
      }
      max_length = ListByEventId->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C53702 & 1) == 0 )
  {
    sub_1C3E564(&Method_ActionExtensions_Call_int__bool___);
    this = (SubmarineSelectScannerListViewManager_o *)sub_1C3E564(&SubmarineSelectScannerListViewItem_TypeInfo);
    byte_4C53702 = 1;
  }
  if ( !obj )
LABEL_11:
  ...
  if ( OnClickItemAction_k__BackingField )
    ActionExtensions__Call_int__bool_(
      ...
      (const MethodInfo_30465F4 *)Method_ActionExtensions_Call_int__bool___);
}
