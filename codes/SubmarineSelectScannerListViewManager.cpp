        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB129C & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v4);
    ...
    sub_1C13D24(&SubmarineSelectScannerListViewItem_TypeInfo, v8);
    sub_1C13D24(&StringLiteral_5838/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_MESSAGE"*/, v9);
    byte_4BB129C = 1;
  }
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5838/*"EVENT_SUBMARINE_SELECT_SCAN_METHOD_MESSAGE"*/, 0LL);
  v39 = Instance;
  if ( !ListByEventId )
    goto LABEL_25;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      id = v16->fields.id;
      v22 = sub_1C13F70(SubmarineSelectScannerListViewItem_TypeInfo);
      ListViewItem___ctor_41884928((ListViewItem_o *)v22, v15, 0LL);
      *(_DWORD *)(v22 + 120) = iconImageId;
      *(_DWORD *)(v22 + 112) = eventId;
      *(_DWORD *)(v22 + 116) = id;
      *(_QWORD *)(v22 + 128) = name;
      sub_1C13CC8((PartyOrganizationUtility_o *)(v22 + 128), name, v23, v24, v25, v26, v27, v28);
      *(_BYTE *)(v22 + 144) = v17 & 1;
      if ( !itemList )
        break;
      ...
      else
      {
        ...
        sub_1C13CC8((PartyOrganizationUtility_o *)(v38 + 4), v22, v29, v30, v31, v32, v33, v34);
      }
      max_length = ListByEventId->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB129D & 1) == 0 )
  {
    sub_1C13D24(&Method_ActionExtensions_Call_int__bool___, obj);
    this = (SubmarineSelectScannerListViewManager_o *)sub_1C13D24(&SubmarineSelectScannerListViewItem_TypeInfo, v5);
    byte_4BB129D = 1;
  }
  if ( !obj )
LABEL_11:
  ...
  if ( OnClickItemAction_k__BackingField )
    ActionExtensions__Call_int__bool_(
      ...
      (const MethodInfo_2EE1EB4 *)Method_ActionExtensions_Call_int__bool___);
}
