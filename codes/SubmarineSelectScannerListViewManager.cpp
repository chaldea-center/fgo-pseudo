        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79CE & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v4);
    ...
    sub_1B4CF90(&SubmarineSelectScannerListViewItem_TypeInfo, v8);
    sub_1B4CF90(&StringLiteral_5628/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, v9);
    byte_49B79CE = 1;
  }
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5628/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, 0LL);
  v31 = Instance;
  if ( !ListByEventId )
    goto LABEL_25;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      id = v16->fields.id;
      v22 = sub_1B4D1DC(SubmarineSelectScannerListViewItem_TypeInfo);
      ListViewItem___ctor_41325876((ListViewItem_o *)v22, v15, 0LL);
      *(_DWORD *)(v22 + 120) = iconImageId;
      *(_DWORD *)(v22 + 112) = eventId;
      *(_DWORD *)(v22 + 116) = id;
      *(_QWORD *)(v22 + 128) = name;
      sub_1B4CF34((CGThumbnailListItem_o *)(v22 + 128), (int32_t)name, v23, v24);
      *(_BYTE *)(v22 + 144) = v17 & 1;
      if ( !itemList )
        break;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B79CF & 1) == 0 )
  {
    sub_1B4CF90(&Method_ActionExtensions_Call_int__bool___, obj);
    this = (SubmarineSelectScannerListViewManager_o *)sub_1B4CF90(&SubmarineSelectScannerListViewItem_TypeInfo, v5);
    byte_49B79CF = 1;
  }
  if ( !obj )
LABEL_11:
  ...
  if ( OnClickItemAction_k__BackingField )
    ActionExtensions__Call_int__bool_(
      ...
      (const MethodInfo_2E57F70 *)Method_ActionExtensions_Call_int__bool___);
}
