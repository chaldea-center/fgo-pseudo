        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E012F4 & 1) == 0 )
  {
    ...
    sub_1CE6700(&SubmarineSelectScannerListViewItem_TypeInfo);
    sub_1CE6700(&StringLiteral_5770/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/);
    byte_4E012F4 = 1;
  }
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5770/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, 0);
  v33 = Instance;
  if ( !ListByEventId )
    goto LABEL_25;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      id = v10->fields.id;
      v16 = sub_1CE694C(SubmarineSelectScannerListViewItem_TypeInfo);
      ListViewItem___ctor_44921328((ListViewItem_o *)v16, v9, 0);
      *(_DWORD *)(v16 + 128) = iconImageId;
      *(_DWORD *)(v16 + 120) = eventId;
      *(_DWORD *)(v16 + 124) = id;
      *(_QWORD *)(v16 + 136) = name;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v16 + 136), (int32_t)name, v17, v18, v19, v20, v21, v22);
      *(_BYTE *)(v16 + 144) = v11 & 1;
      if ( !itemList )
        break;
      ...
      else
      {
        ...
        sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v32 + 4), v16, v23, v24, v25, v26, v27, v28);
      }
      max_length = ListByEventId->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E012F5 & 1) == 0 )
  {
    sub_1CE6700(&Method_ActionExtensions_Call_int__bool___);
    this = (SubmarineSelectScannerListViewManager_o *)sub_1CE6700(&SubmarineSelectScannerListViewItem_TypeInfo);
    byte_4E012F5 = 1;
  }
  if ( !obj )
LABEL_11:
  ...
  if ( OnClickItemAction_k__BackingField )
    ActionExtensions__Call_int__bool_(
      ...
      (const MethodInfo_3149CD8 *)Method_ActionExtensions_Call_int__bool___);
}
