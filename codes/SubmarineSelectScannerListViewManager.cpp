        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414E9 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v4);
    ...
    sub_1BDB878(&SubmarineSelectScannerListViewItem_TypeInfo, v8);
    sub_1BDB878(&StringLiteral_5744/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, v9);
    byte_4B414E9 = 1;
  }
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5744/*"EVENT_SUBMARINE_UNKNOWN_VALUE"*/, 0LL);
  v32 = Instance;
  if ( !ListByEventId )
    goto LABEL_25;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      id = v17->fields.id;
      v23 = sub_1BDBAC4(SubmarineSelectScannerListViewItem_TypeInfo);
      ListViewItem___ctor_42734232((ListViewItem_o *)v23, v16, 0LL);
      *(_DWORD *)(v23 + 120) = iconImageId;
      *(_DWORD *)(v23 + 112) = eventId;
      *(_DWORD *)(v23 + 116) = id;
      *(_QWORD *)(v23 + 128) = name;
      sub_1BDB81C((CGThumbnailListItem_o *)(v23 + 128), (int32_t)name, v24, v25);
      *(_BYTE *)(v23 + 144) = v18 & 1;
      if ( !itemList )
        break;
      ...
      else
      {
        ...
        sub_1BDB81C((CGThumbnailListItem_o *)(v31 + 4), v23, v26, v27);
      }
      max_length = ListByEventId->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B414EA & 1) == 0 )
  {
    sub_1BDB878(&Method_ActionExtensions_Call_int__bool___, obj);
    this = (SubmarineSelectScannerListViewManager_o *)sub_1BDB878(&SubmarineSelectScannerListViewItem_TypeInfo, v5);
    byte_4B414EA = 1;
  }
  if ( !obj )
LABEL_11:
  ...
  if ( OnClickItemAction_k__BackingField )
    ActionExtensions__Call_int__bool_(
      ...
      (const MethodInfo_2F83260 *)Method_ActionExtensions_Call_int__bool___);
}
