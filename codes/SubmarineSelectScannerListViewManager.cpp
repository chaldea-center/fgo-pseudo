        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EAD4 & 1) == 0 )
  {
    ...
    sub_1C3B764(&Method_DataManager_GetMasterData_EventPanelScanMaster___, v4);
    ...
    sub_1C3B764(&SubmarineSelectScannerListViewItem_TypeInfo, v8);
    sub_1C3B764(&StringLiteral_5844/*"Empty name is not legal."*/, v9);
    byte_4C1EAD4 = 1;
  }
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5844/*"Empty name is not legal."*/, 0LL);
  v39 = Instance;
  if ( !ListByEventId )
    goto LABEL_25;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      id = v16->fields.id;
      v22 = sub_1C3B9B0(SubmarineSelectScannerListViewItem_TypeInfo);
      ListViewItem___ctor_42199332((ListViewItem_o *)v22, v15, 0LL);
      *(_DWORD *)(v22 + 120) = iconImageId;
      *(_DWORD *)(v22 + 112) = eventId;
      *(_DWORD *)(v22 + 116) = id;
      *(_QWORD *)(v22 + 128) = name;
      sub_1C3B708((PartyOrganizationUtility_o *)(v22 + 128), name, v23, v24, v25, v26, v27, v28);
      *(_BYTE *)(v22 + 144) = v17 & 1;
      if ( !itemList )
        break;
      ...
      else
      {
        ...
        sub_1C3B708((PartyOrganizationUtility_o *)(v38 + 4), v22, v29, v30, v31, v32, v33, v34);
      }
      max_length = ListByEventId->max_length;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1EAD5 & 1) == 0 )
  {
    sub_1C3B764(&Method_ActionExtensions_Call_int__bool___, obj);
    this = (SubmarineSelectScannerListViewManager_o *)sub_1C3B764(&SubmarineSelectScannerListViewItem_TypeInfo, v5);
    byte_4C1EAD5 = 1;
  }
  if ( !obj )
LABEL_11:
  ...
  if ( OnClickItemAction_k__BackingField )
    ActionExtensions__Call_int__bool_(
      ...
      (const MethodInfo_2F42594 *)Method_ActionExtensions_Call_int__bool___);
}
