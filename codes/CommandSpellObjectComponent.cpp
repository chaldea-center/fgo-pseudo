        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AC440 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_14859/*"USE_MASTER_SPELL"*/);
    sub_B52984(&StringLiteral_3284/*"COMMAND_SPELL_ADD_FUNCTION_TEXT"*/);
    sub_B52984(&StringLiteral_8705/*"MASTER_SPELL_UNIT"*/);
    byte_42AC440 = 1;
  }
  this->fields.Id = Id;
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_14859/*"USE_MASTER_SPELL"*/, 0LL);
  v15 = System_Int32__ToString((int)v11 + 20, 0LL);
  Instance = (DataManager_o *)System_String__Concat_44568316(v14, v15, 0LL);
  if ( !label_count )
    goto LABEL_31;
  UILabel__set_text(label_count, (System_String_o *)Instance, 0LL);
  unitLabel = this->fields.unitLabel;
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8705/*"MASTER_SPELL_UNIT"*/, 0LL);
  if ( !unitLabel )
    goto LABEL_31;
    ...
    if ( Master_WarQuestSelectionMaster )
    {
      ...
      if ( ((unsigned __int8)Instance & 1) != 0 )
      {
        ...
        if ( label_conf )
        {
          ...
          v23 = LocalizationManager__Get((System_String_o *)StringLiteral_3284/*"COMMAND_SPELL_ADD_FUNCTION_TEXT"*/, 0LL);
