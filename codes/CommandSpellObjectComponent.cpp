...
void CommandSpellObjectComponent__onClickUse(CommandSpellObjectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB9AF9 & 1) == 0 )
  {
    sub_1C6BA08(&Method_CommandSpellObjectComponent_onClickUse__);
    byte_4CB9AF9 = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CommandSpellObjectComponent_onClickUse__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C6BA20(Method_CommandSpellObjectComponent_onClickUse__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB9AF7 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_14863/*"USE_MASTER_SPELL"*/);
    sub_1C6BA08(&StringLiteral_3664/*"COMMAND_SPELL_ADD_FUNCTION_TEXT"*/);
    sub_1C6BA08(&StringLiteral_8570/*"MASTER_SPELL_UNIT"*/);
    byte_4CB9AF7 = 1;
  }
  this->fields.Id = Id;
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_14863/*"USE_MASTER_SPELL"*/, 0);
  v15 = System_Int32__ToString((int)v11 + 20, 0);
  Instance = (DataManager_o *)System_String__Concat_63966792(v14, v15, 0);
  if ( !label_count )
    goto LABEL_26;
  UILabel__set_text(label_count, (System_String_o *)Instance, 0);
  unitLabel = this->fields.unitLabel;
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8570/*"MASTER_SPELL_UNIT"*/, 0);
  if ( !unitLabel )
    goto LABEL_26;
  ...
  if ( CondType__IsQuestClear_40554260(ClassBoardReleaseQuestId, -1, 0, 0) )
  {
    ...
    Master_object = DataManager__GetMaster_object_((const MethodInfo_313B314 *)Method_DataManager_GetMaster_ClassBoardCommandSpellMaster___);
    if ( Master_object )
    {
      ...
      if ( ((unsigned __int8)Instance & 1) != 0 )
      {
        ...
        if ( label_conf )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v23 = LocalizationManager__Get((System_String_o *)StringLiteral_3664/*"COMMAND_SPELL_ADD_FUNCTION_TEXT"*/, 0);
