...
void __fastcall CommandSpellObjectComponent__onClickUse(CommandSpellObjectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E24B & 1) == 0 )
  {
    sub_1B885B0(&Method_CommandSpellObjectComponent_onClickUse__);
    byte_4A5E24B = 1;
  }
  ...
  if ( (*((_BYTE *)Method_CommandSpellObjectComponent_onClickUse__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1B885C8(Method_CommandSpellObjectComponent_onClickUse__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E249 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_14850/*"USE_MASTER_SPELL"*/);
    sub_1B885B0(&StringLiteral_3745/*"COMMAND_SPELL_ADD_FUNCTION_TEXT"*/);
    sub_1B885B0(&StringLiteral_8545/*"MASTER_SPELL_UNIT"*/);
    byte_4A5E249 = 1;
  }
  this->fields.Id = Id;
  ...
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_14850/*"USE_MASTER_SPELL"*/, 0LL);
  v15 = System_Int32__ToString((int)v11 + 20, 0LL);
  Instance = (DataManager_o *)System_String__Concat_61707032(v14, v15, 0LL);
  if ( !label_count )
    goto LABEL_26;
  UILabel__set_text(label_count, (System_String_o *)Instance, 0LL);
  unitLabel = this->fields.unitLabel;
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8545/*"MASTER_SPELL_UNIT"*/, 0LL);
  if ( !unitLabel )
    goto LABEL_26;
    ...
    if ( Master_object )
    {
      ...
      if ( ((unsigned __int8)Instance & 1) != 0 )
      {
        ...
        if ( label_conf )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v23 = LocalizationManager__Get((System_String_o *)StringLiteral_3745/*"COMMAND_SPELL_ADD_FUNCTION_TEXT"*/, 0LL);
