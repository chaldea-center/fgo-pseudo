void __fastcall UIOpenLabelURL___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1B1E3 & 1) == 0 )
  {
    sub_1BCAFF8(&UIOpenLabelURL_TypeInfo, v1);
    sub_1BCAFF8(&StringLiteral_15473/*"WebView:"*/, v4);
    byte_4B1B1E3 = 1;
  }
  UIOpenLabelURL_TypeInfo->static_fields->BOOT_WEB_VIEW = (struct System_String_o *)StringLiteral_15473/*"WebView:"*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)UIOpenLabelURL_TypeInfo->static_fields, StringLiteral_15473/*"WebView:"*/, v2, v3);
}
...
void __fastcall UIOpenLabelURL__OnClick(UIOpenLabelURL_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1B1E2 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&UIOpenLabelURL_TypeInfo, v6);
