void __fastcall UIOpenLabelURL___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A59E4B & 1) == 0 )
  {
    sub_1B885B0(&UIOpenLabelURL_TypeInfo);
    sub_1B885B0(&StringLiteral_15608/*"WebView:"*/);
    byte_4A59E4B = 1;
  }
  UIOpenLabelURL_TypeInfo->static_fields->BOOT_WEB_VIEW = (struct System_String_o *)StringLiteral_15608/*"WebView:"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)UIOpenLabelURL_TypeInfo->static_fields, StringLiteral_15608/*"WebView:"*/, v1, v2);
}
