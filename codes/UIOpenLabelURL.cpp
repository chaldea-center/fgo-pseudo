void UIOpenLabelURL___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C25F73 & 1) == 0 )
  {
    sub_1C2D490(&UIOpenLabelURL_TypeInfo);
    sub_1C2D490(&StringLiteral_15604/*"WebView:"*/);
    byte_4C25F73 = 1;
  }
  UIOpenLabelURL_TypeInfo->static_fields->BOOT_WEB_VIEW = (struct System_String_o *)StringLiteral_15604/*"WebView:"*/;
  sub_1C2D434((CGThumbnailListItem_o *)UIOpenLabelURL_TypeInfo->static_fields, StringLiteral_15604/*"WebView:"*/, v1, v2);
}
