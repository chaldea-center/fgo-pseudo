void __fastcall UIOpenLabelURL___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB344B & 1) == 0 )
  {
    sub_1C13D24(&UIOpenLabelURL_TypeInfo, v1);
    sub_1C13D24(&StringLiteral_15851/*"WarEpilogue"*/, v8);
    byte_4BB344B = 1;
  }
  UIOpenLabelURL_TypeInfo->static_fields->BOOT_WEB_VIEW = (struct System_String_o *)StringLiteral_15851/*"WarEpilogue"*/;
  sub_1C13CC8(
    (PartyOrganizationUtility_o *)UIOpenLabelURL_TypeInfo->static_fields,
    StringLiteral_15851/*"WarEpilogue"*/,
    v2,
    v3,
    v4,
    v5,
...
void __fastcall UIOpenLabelURL__OnClick(UIOpenLabelURL_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB344A & 1) == 0 )
  {
    ...
    sub_1C13D24(&UIOpenLabelURL_TypeInfo, v6);
