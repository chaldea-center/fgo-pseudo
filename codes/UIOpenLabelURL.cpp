void __fastcall UIOpenLabelURL___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B75CC & 1) == 0 )
  {
    sub_B52984(&UIOpenLabelURL_TypeInfo);
    sub_B52984(&StringLiteral_15548/*"WebView:"*/);
    byte_42B75CC = 1;
  }
  static_fields = (BattleServantConfConponent_o *)UIOpenLabelURL_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_15548/*"WebView:"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_15548/*"WebView:"*/;
