void __fastcall UIOpenLabelURL___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A07962 & 1) == 0 )
  {
    sub_1B686D4(&UIOpenLabelURL_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_15542/*"WebView:"*/, v4);
    byte_4A07962 = 1;
  }
  UIOpenLabelURL_TypeInfo->static_fields->BOOT_WEB_VIEW = (struct System_String_o *)StringLiteral_15542/*"WebView:"*/;
  sub_1B68678((ServantStatusBattleListViewItem_o *)UIOpenLabelURL_TypeInfo->static_fields, StringLiteral_15542/*"WebView:"*/, v2, v3);
}
...
void __fastcall UIOpenLabelURL__OnClick(UIOpenLabelURL_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A07961 & 1) == 0 )
  {
    ...
    sub_1B686D4(&UIOpenLabelURL_TypeInfo, v6);
