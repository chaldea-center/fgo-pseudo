void __fastcall UIOpenLabelURL___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E1573 & 1) == 0 )
  {
    sub_1B00CCC(&UIOpenLabelURL_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_15377/*"WebView:"*/, v4);
    byte_48E1573 = 1;
  }
  UIOpenLabelURL_TypeInfo->static_fields->BOOT_WEB_VIEW = (struct System_String_o *)StringLiteral_15377/*"WebView:"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)UIOpenLabelURL_TypeInfo->static_fields, StringLiteral_15377/*"WebView:"*/, v2, v3);
}
...
void __fastcall UIOpenLabelURL__OnClick(UIOpenLabelURL_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E1572 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&UIOpenLabelURL_TypeInfo, v6);
