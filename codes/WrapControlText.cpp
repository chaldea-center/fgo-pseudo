...
LABEL_10:
  ...
  if ( !*s )
    goto LABEL_10;
  System_Text_StringBuilder__Append_62659772(v3, 0xAu, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43FF1 & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Debug_TypeInfo, text);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v9);
    sub_1BDB878(&StringLiteral_15650/*"WrapControlText textAdjust error: "*/, v10);
...
LABEL_19:
  ...
  v15 = (Il2CppObject *)System_String__Concat_62572260((System_String_o *)StringLiteral_15650/*"WrapControlText textAdjust error: "*/, text, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43FF4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&NGUIText_TypeInfo, v15);
...
LABEL_54:
  ...
  if ( !byte_4B3E910 )
  {
    sub_1BDB878(&System_Math_TypeInfo, v30);
    byte_4B3E910 = 1;
  }
  v48 = v47 + 0.01;
  if ( !System_Math_TypeInfo->_2.cctor_finished )
...
LABEL_80:
  ...
  v51 = (System_Text_StringBuilder_o *)sub_1BDBAC4(System_Text_StringBuilder_TypeInfo);
...
LABEL_115:
      ...
      if ( (unsigned int)v70 - 8201 < 3 || v70 == 32 )
      {
        ...
        if ( index > v59 && ((v61 ^ 1) & 1) != 0 )
        {
          ...
          v78 = s;
          Chars = System_String__Substring_62618184(v13, v59, v76, 0LL);
          if ( !v78 )
            goto LABEL_261;
          System_Text_StringBuilder__Append_62657444(v78, Chars, 0LL);
          v60 = v67;
          v124 = 0;
          v59 = index + 1;
        }
      ...
      if ( !byte_4B3FC1D )
      {
        sub_1BDB878(&System_Math_TypeInfo, text);
        byte_4B3FC1D = 1;
      }
      if ( !System_Math_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(System_Math_TypeInfo);
...
LABEL_180:
      ...
      {
        v94 = s;
        Chars = System_String__Substring_62618184(v13, v59, (index - v59) & (unsigned int)~((index - v59) >> 31), 0LL);
        if ( !v94 )
          goto LABEL_261;
        System_Text_StringBuilder__Append_62657444(v94, Chars, 0LL);
        v95 = 1;
...
LABEL_193:
    ...
    if ( index <= v59 )
    {
      if ( !s )
        goto LABEL_261;
      System_Text_StringBuilder__Append_62659772(s, 0xAu, 0LL);
    }
    else
    {
      Chars = System_String__Substring_62618184(v13, v59, index - v59 + 1, 0LL);
      if ( !v68 )
        goto LABEL_261;
      System_Text_StringBuilder__Append_62657444(v68, Chars, 0LL);
    }
    v60 = 0;
    ++v66;
    v62 = 0.0;
...
LABEL_217:
  ...
  {
    v100 = s;
    Chars = System_String__Substring_62618184(v13, v59, v52, 0LL);
    if ( v100 )
    {
      System_Text_StringBuilder__Append_62657444(v100, Chars, 0LL);
      goto LABEL_220;
    }
LABEL_261:
    sub_1BDBAD4(Chars, text);
  }
LABEL_220:
  if ( v65 >= v62 )
    v101 = v65;
