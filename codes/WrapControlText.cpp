        ...
        const MethodInfo *method)
{
  ...
  return (UnityEngine_Mathf__Min_41525188(text->fields.m_stringLength % (width / fontSize), 1, 0LL)
        + marginLineCount
        + v6 / (width / fontSize))
       * lineHeight;
}
...
LABEL_11:
  ...
  if ( !*s )
    goto LABEL_11;
  System_Text_StringBuilder__Append_42997292(v3, 0xAu, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF99F & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_15609/*"WrapControlText textAdjust error: "*/);
    sub_B52984(&StringLiteral_1/*""*/);
    byte_42AF99F = 1;
  }
  *(_QWORD *)lineOut = 0LL;
...
LABEL_22:
  ...
  v14 = (Il2CppObject *)System_String__Concat_44568316((System_String_o *)StringLiteral_15609/*"WrapControlText textAdjust error: "*/, text, 0LL);
...
LABEL_73:
  ...
  v32 = (System_Text_StringBuilder_o *)sub_B52A54(System_Text_StringBuilder_TypeInfo);
...
LABEL_120:
      ...
      if ( v60 && ((v38 ^ 1) & 1) != 0 )
      {
        ...
        if ( index > v36 )
        {
          ...
          v64 = s;
          Chars = System_String__Substring_44632052(v16, v36, v62, 0LL);
          if ( !v64 )
            goto LABEL_260;
          System_Text_StringBuilder__Append_42994048(v64, Chars, 0LL);
          v37 = v49;
          v105 = 0;
          v36 = index + 1;
        }
...
LABEL_183:
      ...
      {
        v79 = s;
        v80 = UnityEngine_Mathf__Max_41525284(0, index - v36, 0LL);
        Chars = System_String__Substring_44632052(v16, v36, v80, 0LL);
        if ( !v79 )
          goto LABEL_260;
        System_Text_StringBuilder__Append_42994048(v79, Chars, 0LL);
...
LABEL_212:
  ...
  if ( v41 != b )
  {
    ...
    if ( index <= v36 )
    {
      if ( !s )
        goto LABEL_260;
      System_Text_StringBuilder__Append_42997292(s, 0xAu, 0LL);
    }
    else
    {
      Chars = System_String__Substring_44632052(v16, v36, 1 - v36 + index, 0LL);
      if ( !v50 )
        goto LABEL_260;
      System_Text_StringBuilder__Append_42994048(v50, Chars, 0LL);
    }
    v37 = 0;
    ++v41;
    v39 = 0.0;
...
LABEL_215:
  ...
  {
    v82 = s;
    Chars = System_String__Substring_44632052(v16, v36, (int)text - v36, 0LL);
    if ( v82 )
    {
      System_Text_StringBuilder__Append_42994048(v82, Chars, 0LL);
      goto LABEL_218;
    }
LABEL_260:
    sub_B52A5C(Chars, text);
  }
LABEL_218:
  v47 = v98;
LABEL_219:
...
LABEL_240:
      ...
      v95 = UnityEngine_Mathf__Min_41525188(v94->static_fields->maxLines, b, 0LL);
      v88 = v41 > v95;
      if ( v41 <= v95 || v45 > 0 )
        goto LABEL_240;
      return 1;
