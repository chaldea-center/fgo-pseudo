...
LABEL_10:
  ...
  if ( !*s )
    goto LABEL_10;
  System_Text_StringBuilder__Append_62278956(v3, 0xAu, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDBADE & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_15943/*"WrapControlText textAdjust error: "*/);
    sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BDBADE = 1;
  }
  *(_QWORD *)lineOut = 0LL;
...
LABEL_19:
  ...
  v12 = (Il2CppObject *)System_String__Concat_63115476((System_String_o *)StringLiteral_15943/*"WrapControlText textAdjust error: "*/, text, 0LL);
  if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo);
  UnityEngine_Debug__Log(v12, 0LL);
  return lineOut[0];
}
...
LABEL_80:
    UILabel__set_text(label, v50, 0LL);
    return 0;
  }
  if ( !NGUIText_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NGUIText_TypeInfo);
  NGUIText__Prepare(v13, 0LL);
  v46 = (System_Text_StringBuilder_o *)sub_1C22084(System_Text_StringBuilder_TypeInfo);
...
LABEL_209:
      ...
      if ( v64->static_fields->useSymbols )
      {
        ...
        if ( !v64->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(v64);
        Symbol = NGUIText__GetSymbol(v13, v67, stringLength, 0LL);
        v64 = NGUIText_TypeInfo;
      }
      else
      {
...
LABEL_114:
      ...
      GlyphWidth = NGUIText__GetGlyphWidth(v62, v55, 0LL);
      if ( GlyphWidth == 0.0 )
        goto LABEL_211;
...
LABEL_115:
      ...
      if ( (unsigned int)v65 - 8201 < 3 || v65 == 32 )
      {
        ...
        if ( index > v54 && ((v56 ^ 1) & 1) != 0 )
        {
          ...
          {
            v72 = System_String__get_Chars(v13, index, 0LL);
            if ( v72 < 0x20u || (unsigned int)v72 - 8201 < 3 || v72 == 32 )
              v71 = v70;
          }
          v73 = s;
          Chars = System_String__Substring_63134480(v13, v54, v71, 0LL);
          if ( !v73 )
            goto LABEL_261;
          System_Text_StringBuilder__Append_62276628(v73, Chars, 0LL);
          v55 = v62;
          v119 = 0;
          v54 = index + 1;
        }
...
LABEL_207:
        ...
        v92 = index;
        v66 = v92 + BMSymbol__get_length(Symbol, 0LL);
        v55 = 0;
        goto LABEL_209;
      }
      if ( !fontSizeAdjust )
      {
        ...
        while ( (_DWORD)text )
        {
          ...
          if ( !v83 )
            goto LABEL_261;
          v65 = (unsigned __int16)Chars;
          v84 = System_String__IndexOf(v83, (uint16_t)Chars, 0LL);
          ...
          if ( (v84 & 0x80000000) != 0 )
          {
            ...
            if ( (System_String__IndexOf(v115, (uint16_t)Chars, 0LL) & 0x80000000) != 0 )
            {
              if ( v65 != v85 )
                goto LABEL_167;
              Chars = v117;
              if ( !v117 )
                goto LABEL_261;
              if ( (System_String__IndexOf(v117, v65, 0LL) & 0x80000000) != 0 )
              {
LABEL_167:
        ...
        if ( v86->static_fields->useSymbols )
        {
          ...
          Symbol = NGUIText__GetSymbol(v13, v87, stringLength, 0LL);
          v86 = NGUIText_TypeInfo;
        }
        else
        {
        ...
        if ( !Symbol )
        {
          v91 = NGUIText__GetGlyphWidth(v65, v55, 0LL);
          if ( v91 == 0.0 )
          {
            v57 = v57 + v69;
            goto LABEL_193;
...
LABEL_180:
      ...
      {
        v89 = s;
        Chars = System_String__Substring_63134480(v13, v54, (index - v54) & (unsigned int)~((index - v54) >> 31), 0LL);
        if ( !v89 )
          goto LABEL_261;
        System_Text_StringBuilder__Append_62276628(v89, Chars, 0LL);
        v90 = 1;
...
LABEL_193:
    ...
    if ( index <= v54 )
    {
      if ( !s )
        goto LABEL_261;
      System_Text_StringBuilder__Append_62278956(s, 0xAu, 0LL);
    }
    else
    {
      Chars = System_String__Substring_63134480(v13, v54, index - v54 + 1, 0LL);
      if ( !v63 )
        goto LABEL_261;
      System_Text_StringBuilder__Append_62276628(v63, Chars, 0LL);
    }
    v55 = 0;
    ++v61;
    v57 = 0.0;
...
LABEL_217:
  ...
  {
    v95 = s;
    Chars = System_String__Substring_63134480(v13, v54, v47, 0LL);
    if ( v95 )
    {
      System_Text_StringBuilder__Append_62276628(v95, Chars, 0LL);
      goto LABEL_220;
    }
LABEL_261:
    sub_1C22094(Chars, text);
  }
LABEL_220:
  if ( v60 >= v57 )
    v96 = v60;
...
LABEL_228:
    ...
    if ( v96 > v100 )
    {
      ...
      if ( v101 == INFINITY )
        ...
        v102 = (int)v101;
      UILabel__set_fontSize(label, v102, 0LL);
      *v114 = (float)NGUIText_TypeInfo->static_fields->regionWidth;
    }
    Chars = (System_String_o *)s;
    if ( !s )
      goto LABEL_261;
    v50 = (System_String_o *)((__int64 (__fastcall *)(System_Text_StringBuilder_o *, Il2CppMethodPointer))s->klass->vtable._3_ToString.method)(
                               s,
...
LABEL_242:
  ...
  if ( !s )
    goto LABEL_261;
  v104 = (System_String_o *)((__int64 (__fastcall *)(System_Text_StringBuilder_o *, Il2CppMethodPointer, __int64))s->klass->vtable._3_ToString.method)(
                              s,
                              s->klass->vtable._4_System_Runtime_Serialization_ISerializable_GetObjectData.methodPtr,
                              v47);
