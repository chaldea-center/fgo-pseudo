...
void ExchangeSvtCoinConfirmDialog__Close(ExchangeSvtCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  ExchangeSvtCoinConfirmDialog__Close_33307644(this, 0, v2);
}


void ExchangeSvtCoinConfirmDialog__Close_33307644(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC2296 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_ExchangeSvtCoinConfirmDialog_EndClose__);
    byte_4CC2296 = 1;
  }
...
void ExchangeSvtCoinConfirmDialog__OnClickCancel(ExchangeSvtCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC2298 & 1) == 0 )
  {
    sub_1C713B0(&Method_ExchangeSvtCoinConfirmDialog_OnClickCancel__);
    byte_4CC2298 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_ExchangeSvtCoinConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ExchangeSvtCoinConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    ExchangeSvtCoinConfirmDialog__Close_33307644(this, 0, v5);
...
void ExchangeSvtCoinConfirmDialog__OnClickDecide(ExchangeSvtCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC2297 & 1) == 0 )
  {
    sub_1C713B0(&Method_ExchangeSvtCoinConfirmDialog_OnClickDecide__);
    byte_4CC2297 = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_ExchangeSvtCoinConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_ExchangeSvtCoinConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C71394(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0, 0);
    ExchangeSvtCoinConfirmDialog__Close_33307644(this, 0, v5);
    onDecide = this->fields.onDecide;
    this->fields.onDecide = 0;
    sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.onDecide, 0, v7, v8, v9, v10, v11, v12);
    if ( !onDecide )
      sub_1C71608(v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC2295 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_5749/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DECIDE_BUTTON"*/);
    sub_1C713B0(&StringLiteral_5751/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_TITLE"*/);
    sub_1C713B0(&StringLiteral_5750/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DETAIL"*/);
  ...
  if ( !this->fields.state )
  {
    ...
    TargetId = LocalizationManager__Get((System_String_o *)StringLiteral_5751/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_24;
    UILabel__set_text(titleLabel, TargetId, 0);
    decideButtonLabel = this->fields.decideButtonLabel;
    TargetId = LocalizationManager__Get((System_String_o *)StringLiteral_5749/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DECIDE_BUTTON"*/, 0);
    if ( !decideButtonLabel )
      goto LABEL_24;
    UILabel__set_text(decideButtonLabel, TargetId, 0);
    cancelButtonLabel = this->fields.cancelButtonLabel;
    TargetId = LocalizationManager__Get((System_String_o *)StringLiteral_3679/*"COMMON_CONFIRM_CANCEL"*/, 0);
    if ( !cancelButtonLabel )
      goto LABEL_24;
    UILabel__set_text(cancelButtonLabel, TargetId, 0);
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5750/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DETAIL"*/, 0);
