...
void __fastcall ExchangeSvtCoinConfirmDialog__Close(ExchangeSvtCoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  ExchangeSvtCoinConfirmDialog__Close_31422052(this, 0LL, v2);
}


void __fastcall ExchangeSvtCoinConfirmDialog__Close_31422052(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49510 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_ExchangeSvtCoinConfirmDialog_EndClose__, v5);
    byte_4A49510 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49512 & 1) == 0 )
  {
    sub_1B863B8(&Method_ExchangeSvtCoinConfirmDialog_OnClickCancel__, method);
    byte_4A49512 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_ExchangeSvtCoinConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_ExchangeSvtCoinConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0LL);
    ExchangeSvtCoinConfirmDialog__Close_31422052(this, 0LL, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A49511 & 1) == 0 )
  {
    sub_1B863B8(&Method_ExchangeSvtCoinConfirmDialog_OnClickDecide__, method);
    byte_4A49511 = 1;
  }
  if ( this->fields.state == 1 && this->fields.onDecide )
  {
    ...
    if ( (*((_BYTE *)Method_ExchangeSvtCoinConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B863D0(Method_ExchangeSvtCoinConfirmDialog_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B8639C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 8, 0, 0LL);
    ExchangeSvtCoinConfirmDialog__Close_31422052(this, 0LL, v5);
    onDecide = this->fields.onDecide;
    this->fields.onDecide = 0LL;
    v7 = sub_1B8635C(&this->fields.onDecide);
    if ( !onDecide )
      sub_1B86614(v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4950F & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_5693/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DECIDE_BUTTON"*/, v15);
    sub_1B863B8(&StringLiteral_5695/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_TITLE"*/, v16);
    sub_1B863B8(&StringLiteral_5694/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DETAIL"*/, v17);
  ...
  if ( !this->fields.state )
  {
    ...
    TargetId = LocalizationManager__Get((System_String_o *)StringLiteral_5695/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_24;
    UILabel__set_text(titleLabel, TargetId, 0LL);
    decideButtonLabel = this->fields.decideButtonLabel;
    TargetId = LocalizationManager__Get((System_String_o *)StringLiteral_5693/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DECIDE_BUTTON"*/, 0LL);
    if ( !decideButtonLabel )
      goto LABEL_24;
    UILabel__set_text(decideButtonLabel, TargetId, 0LL);
    cancelButtonLabel = this->fields.cancelButtonLabel;
    TargetId = LocalizationManager__Get((System_String_o *)StringLiteral_3675/*"COMMON_CONFIRM_CANCEL"*/, 0LL);
    if ( !cancelButtonLabel )
      goto LABEL_24;
    UILabel__set_text(cancelButtonLabel, TargetId, 0LL);
    v24 = LocalizationManager__Get((System_String_o *)StringLiteral_5694/*"EXCHANGE_SVT_COIN_CONFIRM_DIALOG_DETAIL"*/, 0LL);
