...
void EventBoardGameDiceEffectAction__PlayDiceVoice(EventBoardGameDiceEffectAction_o *this, const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.voiceCueName, 0) )
  {
    ...
    VoiceAssetName_42847476 = ServantVoiceEntity__getVoiceAssetName_42847476(this->fields.servantId, 0);
    v4 = SeManager_TypeInfo;
    voiceCueName = this->fields.voiceCueName;
    v6 = VoiceAssetName_42847476;
    if ( !SeManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(SeManager_TypeInfo);
      v4 = SeManager_TypeInfo;
    }
    SoundManager__playVoice_41566940(v6, voiceCueName, v4->static_fields->DEFAULT_VOLUME, 0, 0, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  name = (System_String_o *)sub_1C3E508(&this->fields.modelObj, v17);
  if ( !v16
    || (modelObj = (UnityEngine_Object_o *)this->fields.modelObj,
...
LABEL_10:
  ...
  GameObjectExtensions__SafeSetParent_36182084(this->fields.modelObj, this->fields.rootDiceObj, 0);
}