        ...
        const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(this->fields.voiceCueName, 0LL) )
  {
    ...
    VoiceAssetName_41071744 = ServantVoiceEntity__getVoiceAssetName_41071744(this->fields.servantId, 0LL);
    v5 = SeManager_TypeInfo;
    voiceCueName = this->fields.voiceCueName;
    v7 = VoiceAssetName_41071744;
    if ( !SeManager_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(SeManager_TypeInfo);
      v5 = SeManager_TypeInfo;
    }
    SoundManager__playVoice_39911060(v7, voiceCueName, v5->static_fields->DEFAULT_VOLUME, 0LL, 0, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCB8F9 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_UnityEngine_Object_Instantiate_GameObject___, asset);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.endAction, (int64_t)endAction, v14, v15, v16, v17, v18, v19);
  diceModelObjList = this->fields.diceModelObjList;
  if ( !diceModelObjList )
    goto LABEL_10;
  if ( diceType - 1 >= diceModelObjList->max_length )
    sub_1C1AE38(name, v21);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.modelObj, (int64_t)v24, v25, v26, v27, v28, v29, v30);
  if ( !v23
    || (modelObj = (UnityEngine_Object_o *)this->fields.modelObj,
  ...
  {
LABEL_10:
    sub_1C1AE30(name, v21);
  }
  UnityEngine_Object__set_name(modelObj, name, 0LL);
  GameObjectExtensions__SafeSetParent_34762256(this->fields.modelObj, this->fields.rootDiceObj, 0LL);
}