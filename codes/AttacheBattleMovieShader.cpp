...
void AttacheBattleMovieShader__OnEnable(AttacheBattleMovieShader_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C59352 & 1) == 0 )
  {
    sub_1C3E564(&Method_AttacheBattleMovieShader_ShaderDispatch__);
    sub_1C3E564(&Method_UnityEngine_Component_GetComponent_CriManaMovieController___);
    sub_1C3E564(&CriMana_Player_ShaderDispatchCallback_TypeInfo);
    byte_4C59352 = 1;
  }
  Component_object = UnityEngine_Component__GetComponent_object_(
                       (UnityEngine_Component_o *)this,
                       (const MethodInfo_30F0240 *)Method_UnityEngine_Component_GetComponent_CriManaMovieController___);
  if ( !Component_object
    || (monitor = (char *)Component_object[3].monitor,
        v6 = (CriMana_Player_ShaderDispatchCallback_o *)sub_1C3E7B0(CriMana_Player_ShaderDispatchCallback_TypeInfo),
  ...
  *((_QWORD *)monitor + 13) = v6;
  sub_1C3E508((CGThumbnailListItem_o *)(monitor + 104), (int32_t)v6, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C59353 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_4909/*"Custom/BattleMovieAndroidSofdecPrimeYuvLegacy"*/);
    sub_1C3E564(&StringLiteral_4877/*"CriMana/SofdecPrimeYuv"*/);
    byte_4C59353 = 1;
  }
