void AssistEffectListViewItemDraw___cctor(const MethodInfo *method)
{
  if ( (byte_5931CA7 & 1) == 0 )
  {
    sub_21FFC50(&AssistEffectListViewItemDraw_TypeInfo);
    byte_5931CA7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5931CA6 & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_AssistEffectListViewItemDraw___c__DisplayClass6_0__UpdateUi_b__0__);
    sub_21FFC50(&AssistEffectListViewItemDraw___c__DisplayClass6_0_TypeInfo);
    sub_21FFC50(&StringLiteral_8598/*"LEVEL_INFO"*/);
    sub_21FFC50(&StringLiteral_5709/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_LEVEL_FORMAT"*/);
    byte_5931CA6 = 1;
  }
  v5 = (Il2CppObject *)sub_21FFEBC(AssistEffectListViewItemDraw___c__DisplayClass6_0_TypeInfo);
  ...
  Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5709/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_LEVEL_FORMAT"*/, 0);
  if ( !v10 )
    goto LABEL_24;
  v20 = (System_String_o *)Instance;
  v31 = *(_DWORD *)&v10->fields._DispLog;
  Instance = (DataManager_o *)j_il2cpp_value_box_0(qword_594C070, &v31);
  if ( !MaxLevelEntity )
    goto LABEL_24;
  v21 = (Il2CppObject *)Instance;
  lv = MaxLevelEntity->fields.lv;
  v22 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &lv);
  Instance = (DataManager_o *)System_String__Format_75484576(v20, v21, v22, 0);
  if ( !levelLabel )
    goto LABEL_24;
  ...
  v26 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &v29);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&AtlasManager_TypeInfo);
    this = (AssistEffectListViewItemDraw___c__DisplayClass6_0_o *)sub_21FFC50(&StringLiteral_20125/*"event_skill_icon_{0}{1:D2}"*/);
    byte_5931CA8 = 1;
  }
  ...
  v8 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &IconImageId_k__BackingField);
  v11 = System_String__Format_75484576((System_String_o *)StringLiteral_20125/*"event_skill_icon_{0}{1:D2}"*/, v7, v8, 0);
  if ( !*(&AtlasManager_TypeInfo->_2.cctor_finished + 1) )
