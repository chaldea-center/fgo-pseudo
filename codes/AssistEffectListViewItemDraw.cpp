void AssistEffectListViewItemDraw___cctor(const MethodInfo *method)
{
  if ( (byte_4D2A4B0 & 1) == 0 )
  {
    sub_1C93AD4(&AssistEffectListViewItemDraw_TypeInfo);
    byte_4D2A4B0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A4AF & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_AssistEffectListViewItemDraw___c__DisplayClass6_0__UpdateUi_b__0__);
    sub_1C93AD4(&AssistEffectListViewItemDraw___c__DisplayClass6_0_TypeInfo);
    sub_1C93AD4(&StringLiteral_8311/*"LEVEL_INFO"*/);
    sub_1C93AD4(&StringLiteral_5545/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_LEVEL_FORMAT"*/);
    byte_4D2A4AF = 1;
  }
  v5 = (Il2CppObject *)sub_1C93D20(AssistEffectListViewItemDraw___c__DisplayClass6_0_TypeInfo);
  ...
  Instance = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_5545/*"EVENT_ASSIST_SKILL_CONFIRM_DIALOG_LEVEL_FORMAT"*/, 0);
  if ( !v10 )
    goto LABEL_24;
  ...
  Instance = (__int64)System_String__Format_64467032(v15, v16, v17, 0);
  if ( !levelLabel )
    goto LABEL_24;
  ...
  v20 = LocalizationManager__Get((System_String_o *)StringLiteral_8311/*"LEVEL_INFO"*/, 0);
  v24 = *(_DWORD *)(v10 + 32);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2A4B1 & 1) == 0 )
  {
    sub_1C93AD4(&AtlasManager_TypeInfo);
    sub_1C93AD4(&int_TypeInfo);
    this = (AssistEffectListViewItemDraw___c__DisplayClass6_0_o *)sub_1C93AD4(&StringLiteral_19469/*"event_skill_icon_{0}{1:D2}"*/);
    byte_4D2A4B1 = 1;
  }
  ...
  v9 = System_String__Format_64467032((System_String_o *)StringLiteral_19469/*"event_skill_icon_{0}{1:D2}"*/, v7, v8, 0);
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
