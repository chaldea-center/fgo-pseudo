...
bool Target__CheckAressSkill(BattleData_o *bData, int32_t taskActorType, const MethodInfo *method)
{
  ...
  if ( (byte_4E03950 & 1) == 0 )
  {
    ...
    bData = (BattleData_o *)sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__getInstance__);
    byte_4E03950 = 1;
  }
  if ( !v5 )
    goto LABEL_19;
  ...
  {
LABEL_19:
    sub_1CE6958(bData, *(_QWORD *)&taskActorType);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !v5 )
LABEL_10:
    sub_1CE6958(battleData, isEnemyID);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E0394D & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_Target___c__GetAliveLogicFieldRandomTargetId_b__9_0__);
    battleData = (BattleData_o *)sub_1CE6700(&Target___c_TypeInfo);
    byte_4E0394D = 1;
  }
  if ( !v6 )
    goto LABEL_15;
  ...
  if ( !_9__9_0 )
  {
    ...
    _9__9_0 = (System_Func_object__int__o *)sub_1CE694C(System_Func_BattleServantData__int__TypeInfo);
  ...
  if ( !v20 )
LABEL_15:
    sub_1CE6958(battleData, *(_QWORD *)&targetFlag);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E03951 & 1) == 0 )
  {
    sub_1CE6700(&AllFieldTargetAggregator_TypeInfo);
    sub_1CE6700(&TargetAggregator_Args_TypeInfo);
    sub_1CE6700(&NoneTargetAggregator_TypeInfo);
    sub_1CE6700(&OpponentAllFieldTargetAggregator_TypeInfo);
    sub_1CE6700(&OpponentFullTargetAggregator_TypeInfo);
    sub_1CE6700(&OpponentOtherFullTargetAggregator_TypeInfo);
    sub_1CE6700(&OpponentOtherTargetAggregator_TypeInfo);
    sub_1CE6700(&OpponentRangeAggregator_TypeInfo);
    sub_1CE6700(&PartyAllFieldTargetAggregator_TypeInfo);
    sub_1CE6700(&PartyFullTargetAggregator_TypeInfo);
    sub_1CE6700(&PartyLowsetHpRateTargetChoicer_TypeInfo);
    sub_1CE6700(&PartyLowsetHpValueTargetChoicer_TypeInfo);
    sub_1CE6700(&PartyOneOtherTargetAggregator_TypeInfo);
    sub_1CE6700(&PartyOtherFullTargetAggregator_TypeInfo);
    sub_1CE6700(&PartyOtherTargetAggregator_TypeInfo);
    byte_4E03951 = 1;
  }
  switch ( type )
  {
    case 3:
      v15 = sub_1CE694C(PartyAllFieldTargetAggregator_TypeInfo);
      PartyAllFieldTargetAggregator___ctor((PartyAllFieldTargetAggregator_o *)v15, 0);
      break;
    case 6:
      v15 = sub_1CE694C(OpponentAllFieldTargetAggregator_TypeInfo);
      OpponentAllFieldTargetAggregator___ctor((OpponentAllFieldTargetAggregator_o *)v15, 0);
      break;
    case 7:
      v15 = sub_1CE694C(PartyFullTargetAggregator_TypeInfo);
      PartyFullTargetAggregator___ctor((PartyFullTargetAggregator_o *)v15, 0);
      break;
    case 8:
      v15 = sub_1CE694C(OpponentFullTargetAggregator_TypeInfo);
      OpponentFullTargetAggregator___ctor((OpponentFullTargetAggregator_o *)v15, 0);
      break;
    case 9:
      v15 = sub_1CE694C(PartyOtherTargetAggregator_TypeInfo);
      PartyOtherTargetAggregator___ctor((PartyOtherTargetAggregator_o *)v15, 0);
      break;
    case 10:
      v15 = sub_1CE694C(PartyOneOtherTargetAggregator_TypeInfo);
      PartyOneOtherTargetAggregator___ctor((PartyOneOtherTargetAggregator_o *)v15, 0);
      break;
    case 12:
      v15 = sub_1CE694C(OpponentOtherTargetAggregator_TypeInfo);
      OpponentOtherTargetAggregator___ctor((OpponentOtherTargetAggregator_o *)v15, 0);
      break;
    case 14:
      v15 = sub_1CE694C(PartyOtherFullTargetAggregator_TypeInfo);
      PartyOtherFullTargetAggregator___ctor((PartyOtherFullTargetAggregator_o *)v15, 0);
      break;
    case 15:
      v15 = sub_1CE694C(OpponentOtherFullTargetAggregator_TypeInfo);
      OpponentOtherFullTargetAggregator___ctor((OpponentOtherFullTargetAggregator_o *)v15, 0);
      break;
    case 28:
      v15 = sub_1CE694C(PartyLowsetHpValueTargetChoicer_TypeInfo);
      PartyLowsetHpValueTargetChoicer___ctor((PartyLowsetHpValueTargetChoicer_o *)v15, 0);
      break;
    case 29:
      v15 = sub_1CE694C(PartyLowsetHpRateTargetChoicer_TypeInfo);
      PartyLowsetHpRateTargetChoicer___ctor((PartyLowsetHpRateTargetChoicer_o *)v15, 0);
      break;
    case 30:
      v15 = sub_1CE694C(OpponentRangeAggregator_TypeInfo);
      OpponentRangeAggregator___ctor((OpponentRangeAggregator_o *)v15, 0);
      break;
    case 32:
      v15 = sub_1CE694C(AllFieldTargetAggregator_TypeInfo);
      AllFieldTargetAggregator___ctor((AllFieldTargetAggregator_o *)v15, 0);
      break;
    default:
      v15 = sub_1CE694C(NoneTargetAggregator_TypeInfo);
      NoneTargetAggregator___ctor((NoneTargetAggregator_o *)v15, 0);
      break;
  }
  v16 = (TargetAggregator_Args_o *)sub_1CE694C(TargetAggregator_Args_TypeInfo);
  TargetAggregator_Args___ctor(v16, battleData, actorId, targetId, pttargetId, taskActorType, battleTargetArgs, 0);
  if ( !v15 )
    sub_1CE6958(v17, v18);
  *(_QWORD *)(v15 + 16) = v16;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)(v15 + 16), (int32_t)v16, v19, v20, v21, v22, v23, v24);
        ...
        const MethodInfo *method)
{
  ...
  {
    if ( isOrderDesc )
      System_Array__Reverse_int_(checkIdArray, (const MethodInfo_31C3FA4 *)Method_System_Array_Reverse_int___);
    ...
    {
      v9 = sub_1CE67A8(int___TypeInfo, 1);
        ...
        const MethodInfo *method)
{
  ...
  return Target__getTargetIds_41596588(bdata, actorId, targetId, pttargetId, tgType, 0, 0, tvals, 0, 0, v8);
}


System_Int32_array *Target__getTargetIds_41596588(
        BattleData_o *bdata,
        int32_t actorId,
        int32_t targetId,
        int32_t pttargetId,
        ...
        const MethodInfo *method)
{
  ...
  cardIndex = 0;
  v19 = sub_1CE67A8(int___TypeInfo, 0);
  ...
  if ( !BattleData__IsAiNpcID(bdata, actorId, 0) )
    goto LABEL_8;
  v19 = sub_1CE67A8(int___TypeInfo, 1);
  if ( !v19 )
LABEL_150:
    sub_1CE6958(v19, v20);
...
LABEL_8:
  ...
  switch ( type )
  {
    case 0:
    case 25:
      v28 = sub_1CE67A8(int___TypeInfo, 1);
      v30 = v28;
      if ( !v28 )
        sub_1CE6958(0, v29);
      if ( !*(_DWORD *)(v28 + 24) )
      ...
      *(_DWORD *)(v28 + 32) = actorId;
      ...
      if ( actorId == -1 )
      {
        ...
        if ( !LODWORD(FieldPlayerServantIDList->max_length) )
          sub_1CE6960(FieldPlayerServantIDList);
        if ( !*(_DWORD *)(v30 + 24) )
          sub_1CE6960(FieldPlayerServantIDList);
        goto LABEL_39;
      }
    ...
    case 4:
      v53 = sub_1CE67A8(int___TypeInfo, 1);
      v33 = v53;
      if ( !v53 )
        sub_1CE6958(0, v54);
      if ( !*(_DWORD *)(v53 + 24) )
    ...
    case 11:
      ...
      if ( !v33 )
        sub_1CE6958(AliveFieldRandomTargetId, v47);
      if ( !*(_DWORD *)(v33 + 24) )
        sub_1CE6960(AliveFieldRandomTargetId);
      goto LABEL_140;
    case 13:
      v33 = sub_1CE67A8(int___TypeInfo, 1);
      ...
      if ( !v33 )
        sub_1CE6958(AliveFieldRandomTargetId, v57);
      if ( !*(_DWORD *)(v33 + 24) )
        sub_1CE6960(AliveFieldRandomTargetId);
      goto LABEL_140;
    case 16:
...
LABEL_77:
    ...
    case 17:
      v48 = sub_1CE67A8(int___TypeInfo, 1);
      v30 = v48;
      if ( !v48 )
        sub_1CE6958(0, v49);
      if ( !*(_DWORD *)(v48 + 24) )
...
LABEL_39:
    ...
    case 18:
          ...
          if ( (_DWORD)v82 != pttargetId )
          {
            ...
            if ( (unsigned int)size >= LODWORD(items->max_length) )
            {
              System_Collections_Generic_List_int___AddWithResize(
                v80,
                v82,
                *(const MethodInfo_38E8F44 **)(*(_QWORD *)(v86[4] + 192LL) + 112LL));
            }
            else
            {
      ...
      if ( !v33 )
        sub_1CE6958(AliveFieldRandomTargetId, v90);
      if ( !*(_DWORD *)(v33 + 24) )
        sub_1CE6960(AliveFieldRandomTargetId);
      goto LABEL_140;
    case 19:
      ...
      v104 = (System_Collections_Generic_List_int__o *)sub_1CE694C(System_Collections_Generic_List_int__TypeInfo);
      System_Collections_Generic_List_int____ctor(
        v104,
        (const MethodInfo_38E86F0 *)Method_System_Collections_Generic_List_int___ctor__);
      if ( !v103 )
          ...
          if ( (_DWORD)v106 != actorId )
          {
            ...
            if ( (unsigned int)v111 >= LODWORD(v109->max_length) )
            {
              System_Collections_Generic_List_int___AddWithResize(
                v104,
                v106,
                *(const MethodInfo_38E8F44 **)(*(_QWORD *)(v110[4] + 192LL) + 112LL));
            }
            else
            {
      ...
      AliveFieldRandomTargetId = System_Collections_Generic_List_int___get_Item(
                                   ...
                                   (const MethodInfo_38E8C54 *)Method_System_Collections_Generic_List_int__get_Item__);
      if ( !v33 )
        sub_1CE6958(AliveFieldRandomTargetId, v114);
      if ( !*(_DWORD *)(v33 + 24) )
        sub_1CE6960(AliveFieldRandomTargetId);
      goto LABEL_140;
    case 20:
      ...
      v91 = v61;
      v92 = (System_Collections_Generic_List_int__o *)sub_1CE694C(System_Collections_Generic_List_int__TypeInfo);
      System_Collections_Generic_List_int____ctor(
        v92,
        (const MethodInfo_38E86F0 *)Method_System_Collections_Generic_List_int___ctor__);
      if ( !v91 )
      ...
      AliveFieldRandomTargetId = System_Collections_Generic_List_int___get_Item(
                                   ...
                                   (const MethodInfo_38E8C54 *)Method_System_Collections_Generic_List_int__get_Item__);
      if ( !v33 )
        sub_1CE6958(AliveFieldRandomTargetId, v102);
      if ( !*(_DWORD *)(v33 + 24) )
        sub_1CE6960(AliveFieldRandomTargetId);
      goto LABEL_140;
    case 21:
    ...
    case 27:
      ...
      {
        v63 = sub_1CE67A8(int___TypeInfo, 1);
        v33 = v63;
        if ( !v63 )
          sub_1CE6958(0, v64);
        if ( !*(_DWORD *)(v63 + 24) )
...
LABEL_66:
    ...
    case 31:
      v73 = sub_1CE67A8(int___TypeInfo, 1);
      PlayerServantFromRandomCommandCard = BattleData__GetPlayerServantFromRandomCommandCard(bdata, &cardIndex, 0);
      if ( !v73 )
        sub_1CE6958(PlayerServantFromRandomCommandCard, v75);
      if ( !*(_DWORD *)(v73 + 24) )
        sub_1CE6960(PlayerServantFromRandomCommandCard);
      *(_DWORD *)(v73 + 32) = PlayerServantFromRandomCommandCard;
      ...
      return v116;
    case 33:
      v65 = sub_1CE67A8(int___TypeInfo, 1);
    ...
    case 34:
      ...
      if ( !v33 )
        sub_1CE6958(AliveFieldRandomTargetId, v36);
      if ( !*(_DWORD *)(v33 + 24) )
        sub_1CE6960(AliveFieldRandomTargetId);
LABEL_140:
...
void Target_BattleTargetArgs___ctor(Target_BattleTargetArgs_o *this, DataVals_o *dataVals, const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)dataVals, v5, v6, v7, v8, v9, v10);
}
...
System_Int32_array *Target_BattleTargetArgs__get_EnemyRange(Target_BattleTargetArgs_o *this, const MethodInfo *method)
{
  ...
  if ( !enemyRange )
  {
    ...
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.enemyRange, (int32_t)enemyRange, v5, v6, v7, v8, v9, v10);
  }
  return enemyRange;
}
...
void Target___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E03953 & 1) == 0 )
  {
    sub_1CE6700(&Target___c_TypeInfo);
    byte_4E03953 = 1;
  }
  v1 = (Il2CppObject *)sub_1CE694C(Target___c_TypeInfo);
  System_Object___ctor(v1, 0);
  Target___c_TypeInfo->static_fields->__9 = (struct Target___c_o *)v1;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)Target___c_TypeInfo->static_fields, (int32_t)v1, v2, v3, v4, v5, v6, v7);
}
