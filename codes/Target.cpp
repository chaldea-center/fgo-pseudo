...
bool __fastcall Target__CheckAressSkill(BattleData_o *bData, int32_t taskActorType, const MethodInfo *method)
{
  ...
  if ( (byte_4BC6A9B & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_SkillLvMaster___, *(_QWORD *)&taskActorType);
    bData = (BattleData_o *)sub_1C1ABD4(&Method_SingletonMonoBehaviour_DataManager__getInstance__, v6);
    byte_4BC6A9B = 1;
  }
  if ( !v5 )
    goto LABEL_19;
  ...
  {
LABEL_19:
    sub_1C1AE30(bData, *(_QWORD *)&taskActorType);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !v5 )
LABEL_10:
    sub_1C1AE30(battleData, isEnemyID);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6A9C & 1) == 0 )
  {
    sub_1C1ABD4(&AllFieldTargetAggregator_TypeInfo, *(_QWORD *)&actorId);
    sub_1C1ABD4(&TargetAggregator_Args_TypeInfo, v15);
    sub_1C1ABD4(&NoneTargetAggregator_TypeInfo, v16);
    sub_1C1ABD4(&OpponentAllFieldTargetAggregator_TypeInfo, v17);
    sub_1C1ABD4(&OpponentFullTargetAggregator_TypeInfo, v18);
    sub_1C1ABD4(&OpponentOtherFullTargetAggregator_TypeInfo, v19);
    sub_1C1ABD4(&OpponentOtherTargetAggregator_TypeInfo, v20);
    sub_1C1ABD4(&OpponentRangeAggregator_TypeInfo, v21);
    sub_1C1ABD4(&PartyAllFieldTargetAggregator_TypeInfo, v22);
    sub_1C1ABD4(&PartyFullTargetAggregator_TypeInfo, v23);
    sub_1C1ABD4(&PartyLowsetHpRateTargetChoicer_TypeInfo, v24);
    sub_1C1ABD4(&PartyLowsetHpValueTargetChoicer_TypeInfo, v25);
    sub_1C1ABD4(&PartyOneOtherTargetAggregator_TypeInfo, v26);
    sub_1C1ABD4(&PartyOtherFullTargetAggregator_TypeInfo, v27);
    sub_1C1ABD4(&PartyOtherTargetAggregator_TypeInfo, v28);
    byte_4BC6A9C = 1;
  }
  switch ( type )
  {
    case 3:
      v29 = sub_1C1AE20(PartyAllFieldTargetAggregator_TypeInfo);
      PartyAllFieldTargetAggregator___ctor((PartyAllFieldTargetAggregator_o *)v29, 0LL);
      break;
    case 6:
      v29 = sub_1C1AE20(OpponentAllFieldTargetAggregator_TypeInfo);
      OpponentAllFieldTargetAggregator___ctor((OpponentAllFieldTargetAggregator_o *)v29, 0LL);
      break;
    case 7:
      v29 = sub_1C1AE20(PartyFullTargetAggregator_TypeInfo);
      PartyFullTargetAggregator___ctor((PartyFullTargetAggregator_o *)v29, 0LL);
      break;
    case 8:
      v29 = sub_1C1AE20(OpponentFullTargetAggregator_TypeInfo);
      OpponentFullTargetAggregator___ctor((OpponentFullTargetAggregator_o *)v29, 0LL);
      break;
    case 9:
      v29 = sub_1C1AE20(PartyOtherTargetAggregator_TypeInfo);
      PartyOtherTargetAggregator___ctor((PartyOtherTargetAggregator_o *)v29, 0LL);
      break;
    case 10:
      v29 = sub_1C1AE20(PartyOneOtherTargetAggregator_TypeInfo);
      PartyOneOtherTargetAggregator___ctor((PartyOneOtherTargetAggregator_o *)v29, 0LL);
      break;
    case 12:
      v29 = sub_1C1AE20(OpponentOtherTargetAggregator_TypeInfo);
      OpponentOtherTargetAggregator___ctor((OpponentOtherTargetAggregator_o *)v29, 0LL);
      break;
    case 14:
      v29 = sub_1C1AE20(PartyOtherFullTargetAggregator_TypeInfo);
      PartyOtherFullTargetAggregator___ctor((PartyOtherFullTargetAggregator_o *)v29, 0LL);
      break;
    case 15:
      v29 = sub_1C1AE20(OpponentOtherFullTargetAggregator_TypeInfo);
      OpponentOtherFullTargetAggregator___ctor((OpponentOtherFullTargetAggregator_o *)v29, 0LL);
      break;
    case 28:
      v29 = sub_1C1AE20(PartyLowsetHpValueTargetChoicer_TypeInfo);
      PartyLowsetHpValueTargetChoicer___ctor((PartyLowsetHpValueTargetChoicer_o *)v29, 0LL);
      break;
    case 29:
      v29 = sub_1C1AE20(PartyLowsetHpRateTargetChoicer_TypeInfo);
      PartyLowsetHpRateTargetChoicer___ctor((PartyLowsetHpRateTargetChoicer_o *)v29, 0LL);
      break;
    case 30:
      v29 = sub_1C1AE20(OpponentRangeAggregator_TypeInfo);
      OpponentRangeAggregator___ctor((OpponentRangeAggregator_o *)v29, 0LL);
      break;
    case 32:
      v29 = sub_1C1AE20(AllFieldTargetAggregator_TypeInfo);
      AllFieldTargetAggregator___ctor((AllFieldTargetAggregator_o *)v29, 0LL);
      break;
    default:
      v29 = sub_1C1AE20(NoneTargetAggregator_TypeInfo);
      NoneTargetAggregator___ctor((NoneTargetAggregator_o *)v29, 0LL);
      break;
  }
  v30 = (TargetAggregator_Args_o *)sub_1C1AE20(TargetAggregator_Args_TypeInfo);
  TargetAggregator_Args___ctor(v30, battleData, actorId, targetId, pttargetId, taskActorType, battleTargetArgs, 0LL);
  if ( !v29 )
    sub_1C1AE30(v31, v32);
  *(_QWORD *)(v29 + 16) = v30;
  sub_1C1AB78((PartyOrganizationUtility_o *)(v29 + 16), (int64_t)v30, v33, v34, v35, v36, v37, v38);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6A9A & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Array_IndexOf_int___, *(_QWORD *)&excludeId);
    sub_1C1ABD4(&Method_System_Array_Reverse_int___, v9);
  ...
  {
    if ( isOrderDesc )
      System_Array__Reverse_int_(checkIdArray, (const MethodInfo_2F60BA4 *)Method_System_Array_Reverse_int___);
        ...
        const MethodInfo *method)
{
  ...
  return Target__getTargetIds_38911012(bdata, actorId, targetId, pttargetId, tgType, 0, 0, tvals, 0, 0LL, v8);
}


// local variable allocation has failed, the output may be wrong!
System_Int32_array *__fastcall Target__getTargetIds_38911012(
        BattleData_o *bdata,
        int32_t actorId,
        int32_t targetId,
        int32_t pttargetId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC6A99 & 1) == 0 )
  {
    sub_1C1ABD4(&int___TypeInfo, *(_QWORD *)&actorId);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_int__Add__, v19);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_int___ctor__, v20);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_int__get_Count__, v21);
    sub_1C1ABD4(&Method_System_Collections_Generic_List_int__get_Item__, v22);
    sub_1C1ABD4(&System_Collections_Generic_List_int__TypeInfo, v23);
    byte_4BC6A99 = 1;
  }
  cardIndex = 0;
  v24 = sub_1C1AC7C(int___TypeInfo, 0LL);
  ...
  if ( !BattleData__IsAiNpcID(bdata, actorId, 0LL) )
    goto LABEL_8;
  v24 = sub_1C1AC7C(int___TypeInfo, 1LL);
  if ( !v24 )
LABEL_142:
    sub_1C1AE30(v24, v25);
...
LABEL_8:
  ...
  switch ( type )
  {
    case 0:
    case 25:
      v33 = sub_1C1AC7C(int___TypeInfo, 1LL);
      ...
      *(_DWORD *)(v33 + 32) = actorId;
      ...
      if ( actorId == -1 )
      {
        ...
        if ( !FieldPlayerServantIDList->max_length )
          sub_1C1AE38(FieldPlayerServantIDList, v37);
        if ( !v35->max_length )
          sub_1C1AE38(FieldPlayerServantIDList, v37);
        goto LABEL_70;
      }
    ...
    case 4:
      v65 = sub_1C1AC7C(int___TypeInfo, 1LL);
    ...
    case 11:
      ...
      if ( !v43 )
        sub_1C1AE30(AliveFieldRandomTargetId, v64);
      if ( !v43->max_length )
        sub_1C1AE38(AliveFieldRandomTargetId, v64);
      goto LABEL_126;
    case 13:
      v43 = (System_Int32_array *)sub_1C1AC7C(int___TypeInfo, 1LL);
      ...
      if ( !v43 )
        sub_1C1AE30(AliveFieldRandomTargetId, v72);
      if ( !v43->max_length )
        sub_1C1AE38(AliveFieldRandomTargetId, v72);
      goto LABEL_126;
    case 16:
      v43 = (System_Int32_array *)sub_1C1AC7C(int___TypeInfo, 1LL);
...
LABEL_41:
      ...
      return v43;
    case 17:
      v67 = sub_1C1AC7C(int___TypeInfo, 1LL);
      ...
      *(_DWORD *)(v67 + 32) = actorId;
      ...
      if ( actorId == -1 )
      {
        ...
        if ( !FieldPlayerServantIDList )
          sub_1C1AE30(0LL, v69);
        if ( !FieldPlayerServantIDList->max_length )
          sub_1C1AE38(FieldPlayerServantIDList, v69);
        if ( !v35->max_length )
          sub_1C1AE38(FieldPlayerServantIDList, v69);
LABEL_70:
        v116 = v35;
    ...
    case 18:
          ...
          if ( (_DWORD)v80 != pttargetId )
          {
            ...
            if ( (unsigned int)size >= items->max_length )
            {
              System_Collections_Generic_List_int___AddWithResize(
                v78,
                v80,
                *(const MethodInfo_361F86C **)(*(_QWORD *)(v84[4] + 192LL) + 112LL));
            }
            else
            {
      ...
      if ( !v43 )
        sub_1C1AE30(AliveFieldRandomTargetId, v88);
      if ( !v43->max_length )
        sub_1C1AE38(AliveFieldRandomTargetId, v88);
      goto LABEL_126;
    case 19:
      if ( BattleData__isEnemyID(bdata, actorId, 0LL) )
          ...
          if ( (_DWORD)v104 != actorId )
          {
            ...
            if ( (unsigned int)v109 >= v107->max_length )
            {
              System_Collections_Generic_List_int___AddWithResize(
                v102,
                v104,
                *(const MethodInfo_361F86C **)(*(_QWORD *)(v108[4] + 192LL) + 112LL));
            }
            else
            {
      ...
      AliveFieldRandomTargetId = System_Collections_Generic_List_int___get_Item(
                                   ...
                                   (const MethodInfo_361F57C *)Method_System_Collections_Generic_List_int__get_Item__);
      if ( !v43 )
        sub_1C1AE30(AliveFieldRandomTargetId, v112);
      if ( !v43->max_length )
        sub_1C1AE38(AliveFieldRandomTargetId, v112);
      goto LABEL_126;
    case 20:
      if ( BattleData__isEnemyID(bdata, actorId, 0LL) )
      ...
      v89 = v41;
      v90 = (System_Collections_Generic_List_int__o *)sub_1C1AE20(System_Collections_Generic_List_int__TypeInfo);
      System_Collections_Generic_List_int____ctor(
        v90,
        (const MethodInfo_361F018 *)Method_System_Collections_Generic_List_int___ctor__);
      if ( !v89 )
          ...
          if ( (_DWORD)v92 != targetId )
          {
            ...
            if ( (unsigned int)v97 >= v95->max_length )
            {
              System_Collections_Generic_List_int___AddWithResize(
                v90,
                v92,
                *(const MethodInfo_361F86C **)(*(_QWORD *)(v96[4] + 192LL) + 112LL));
            }
            else
            {
      ...
      AliveFieldRandomTargetId = System_Collections_Generic_List_int___get_Item(
                                   ...
                                   (const MethodInfo_361F57C *)Method_System_Collections_Generic_List_int__get_Item__);
      if ( !v43 )
        sub_1C1AE30(AliveFieldRandomTargetId, v100);
      if ( !v43->max_length )
        sub_1C1AE38(AliveFieldRandomTargetId, v100);
LABEL_126:
    ...
    case 27:
      ...
      {
        v47 = sub_1C1AC7C(int___TypeInfo, 1LL);
...
LABEL_63:
    ...
    case 31:
      v57 = sub_1C1AC7C(int___TypeInfo, 1LL);
      PlayerServantFromRandomCommandCard = BattleData__GetPlayerServantFromRandomCommandCard(bdata, &cardIndex, 0LL);
      if ( !v57 )
        sub_1C1AE30(PlayerServantFromRandomCommandCard, v59);
      if ( !*(_DWORD *)(v57 + 24) )
        sub_1C1AE38(PlayerServantFromRandomCommandCard, v59);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)dataVals, v5, v6, v7, v8, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !enemyRange )
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.enemyRange, (int64_t)enemyRange, v5, v6, v7, v8, v9, v10);
  }
  return enemyRange;
}