        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D27A33 & 1) == 0 )
  {
    ...
    this = (MultipleViewListViewItemDraw_o *)sub_1C94098(&StringLiteral_8839/*"MULTIPLE_SERVANT_SELECTED_SERVANT_"*/);
    byte_4D27A33 = 1;
  }
  if ( !item )
    goto LABEL_39;
...
LABEL_17:
  ...
  if ( (item->fields.selectNum & 0x80000000) == 0 )
  {
    ...
    v10 = System_String__Concat_64417744((System_String_o *)StringLiteral_8839/*"MULTIPLE_SERVANT_SELECTED_SERVANT_"*/, v9, 0);
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v8 = v10;
    goto LABEL_25;
