        ...
        const MethodInfo *method)
{
  ...
  GrandServantListSelectObject_o *v13; // x21
  ...
  if ( (byte_4C51B17 & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_Component_GetComponent_GrandServantListSelectObject___);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_UITouchPress___);
    sub_1C3E564(&Method_UnityEngine_Object_Instantiate_GrandServantListItemDraw___);
  ...
  v8 = UnityEngine_Object__Instantiate_object__51929056(
         (Il2CppObject *)prefab,
         transform,
         (const MethodInfo_3185FE0 *)Method_UnityEngine_Object_Instantiate_GrandServantListItemDraw___);
  this->fields.draw = (struct GrandServantListItemDraw_o *)v8;
  p_draw = &this->fields.draw;
  sub_1C3E508(&this->fields.draw, v8);
  draw = this->fields.draw;
  if ( !draw )
    goto LABEL_11;
  GrandServantListItemDraw__Initialize(draw, v10);
  draw = *p_draw;
  if ( !*p_draw
    || (draw = (GrandServantListItemDraw_o *)UnityEngine_Component__GetComponent_object_(
                                               (UnityEngine_Component_o *)draw,
                                               (const MethodInfo_30F0240 *)Method_UnityEngine_Component_GetComponent_GrandServantListSelectObject___)) == 0
    || (v13 = (GrandServantListSelectObject_o *)draw,
    ...
    || (Component_object = UnityEngine_GameObject__GetComponent_object_(
        ...
        GrandServantListSelectObject__AddServantTouchPress(v13, (UITouchPress_o *)Component_object, v15),
        (draw = (GrandServantListItemDraw_o *)this->fields.emptyRoot) == 0) )
  {
LABEL_11:
    sub_1C3E7C0(draw, v10);
  }
  v16 = UnityEngine_GameObject__GetComponent_object_(
          (UnityEngine_GameObject_o *)draw,
          (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_UITouchPress___);
  GrandServantListSelectObject__AddServantTouchPress(v13, (UITouchPress_o *)v16, v17);
}
...
LABEL_20:
      sub_1C3E7C0(this, grandServantListData);
    }
