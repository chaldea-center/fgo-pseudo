        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)simpleAnim, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E57AB & 1) == 0 )
  {
    ...
    sub_1B00CCC(&System_Collections_Generic_IEnumerable_SimpleAnimation_State__TypeInfo, v3);
    sub_1B00CCC(&System_Collections_Generic_IEnumerator_SimpleAnimation_State__TypeInfo, v4);
    sub_1B00CCC(&System_Collections_IEnumerator_TypeInfo, v5);
    sub_1B00CCC(&WrapBattleBaseAnimation_SimpleData_TypeInfo, v6);
  ...
  {
LABEL_9:
    v13 = sub_1B52CAC(animation, System_Collections_Generic_IEnumerable_SimpleAnimation_State__TypeInfo, 0LL);
  }
...
LABEL_16:
    ...
    {
LABEL_23:
      v23 = sub_1B52CAC(v15, System_Collections_Generic_IEnumerator_SimpleAnimation_State__TypeInfo, 0LL);
    }
    ...
    {
LABEL_30:
      v30 = sub_1B52CAC(v24, SimpleAnimation_State_TypeInfo, 0LL);
    }
  }
  ...
  {
LABEL_37:
    v34 = sub_1B52CAC(v26, SimpleAnimation_State_TypeInfo, 9LL);
  }
  ...
  {
LABEL_44:
    v41 = sub_1B52CAC(v26, SimpleAnimation_State_TypeInfo, 3LL);
  }
  v42 = COERCE_UNSIGNED_INT128(((long double (__fastcall *)(__int64, _QWORD))*(_QWORD *)v41)(v26, *(_QWORD *)(v41 + 8)));
  v35 = sub_1B00F18(WrapBattleBaseAnimation_SimpleData_TypeInfo);
  System_Object___ctor((Il2CppObject *)v35, 0LL);
  *(_QWORD *)(v35 + 16) = v38;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v35 + 16), v38, v43, v44);
  *(_DWORD *)(v35 + 24) = v42;
LABEL_47:
  v45 = *(_QWORD *)v15;
  ...
  {
LABEL_51:
    v48 = sub_1B52CAC(v15, System_IDisposable_TypeInfo, 0LL);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E57AA & 1) == 0 )
  {
    sub_1B00CCC(&SimpleAnimation_State_TypeInfo, animName);
    byte_48E57AA = 1;
  }
  animation = this->fields.animation;
  if ( !animation )
  ...
  {
LABEL_9:
    v12 = sub_1B52CAC(animation, SimpleAnimation_State_TypeInfo, 4LL);
  }
...
LABEL_14:
    sub_1B00F28(animation, animName);
  SimpleAnimation__Play_62462980(animation, animName, 0LL);
}