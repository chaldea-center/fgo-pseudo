        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17C0C & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_23725/*"stageId"*/, *(_QWORD *)&stageId, warBoardData);
    byte_4B17C0C = 1;
  }
...
System_String_o *__fastcall WarBoardTurnEndRequest__getURL(WarBoardTurnEndRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BCA7E0(&NetworkManager_TypeInfo, method, v2);
    sub_1BCA7E0(&StringLiteral_24877/*"warBoard/turnEnd"*/, v3, v4);
    byte_4B17C0A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_24877/*"warBoard/turnEnd"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v15 = ResponseCommandKind__SearchData(95, responseList, 0LL);
  if ( v15
