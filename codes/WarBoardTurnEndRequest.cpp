        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E9341 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_22565/*"stageId"*/, stageId, (_DWORD)warBoardData, method);
    byte_42E9341 = 1;
  }
...
System_String_o *__fastcall WarBoardTurnEndRequest__getURL(WarBoardTurnEndRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B5D5C4(&NetworkManager_TypeInfo, (_DWORD)method, v2, v3);
    sub_B5D5C4(&StringLiteral_23521/*"warBoard/turnEnd"*/, v4, v5, v6);
    byte_42E933F = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_23521/*"warBoard/turnEnd"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v21 = ResponseCommandKind__SearchData(95, responseList, 0LL);
  if ( v21
