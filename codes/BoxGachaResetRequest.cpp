        ...
        const MethodInfo *method)
{
  if ( (byte_41896E7 & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_16898/*"boxGachaId"*/, *(_QWORD *)&gachaId);
    byte_41896E7 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16898/*"boxGachaId"*/, gachaId, 0LL);
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_41896E6 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_16896/*"boxGacha/reset"*/, v2);
    byte_41896E6 = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_16896/*"boxGacha/reset"*/, 0LL);
}
