        ...
        const MethodInfo *method)
{
  if ( (byte_42B17BE & 1) == 0 )
  {
    sub_B52984(&StringLiteral_17014/*"boxGachaId"*/);
    byte_42B17BE = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17014/*"boxGachaId"*/, gachaId, 0LL);
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B17BD & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_17012/*"boxGacha/reset"*/);
    byte_42B17BD = 1;
  }
  ...
  return System_String__Concat_44568316(BaseUrl, (System_String_o *)StringLiteral_17012/*"boxGacha/reset"*/, 0LL);
}
