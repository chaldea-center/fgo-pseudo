        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17A20 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_17568/*"boxGachaId"*/, *(_QWORD *)&gachaId, method);
    byte_4B17A20 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17568/*"boxGachaId"*/, gachaId, v3);
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17A1F & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_17566/*"boxGacha/reset"*/, v3, v4);
    byte_4B17A1F = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_17566/*"boxGacha/reset"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(48, responseList, 0LL);
  if ( v9
