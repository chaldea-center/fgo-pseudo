        ...
        const MethodInfo *method)
{
  if ( (byte_4A0A37D & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_17330/*"boxGachaId"*/, *(_QWORD *)&gachaId);
    byte_4A0A37D = 1;
  }
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0A37C & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_17328/*"boxGacha/reset"*/, v2);
    byte_4A0A37C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61419468(BaseUrl, (System_String_o *)StringLiteral_17328/*"boxGacha/reset"*/, 0LL);
}
