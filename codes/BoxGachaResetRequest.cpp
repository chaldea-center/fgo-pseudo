        ...
        const MethodInfo *method)
{
  if ( (byte_4A0022E & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_17328/*"boxGachaId"*/, *(_QWORD *)&gachaId);
    byte_4A0022E = 1;
  }
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0022D & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_17326/*"boxGacha/reset"*/, v2);
    byte_4A0022D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61385136(BaseUrl, (System_String_o *)StringLiteral_17326/*"boxGacha/reset"*/, 0LL);
}
