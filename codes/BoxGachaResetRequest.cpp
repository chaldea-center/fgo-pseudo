...
void BoxGachaResetRequest__beginRequest(BoxGachaResetRequest_o *this, int32_t gachaId, const MethodInfo *method)
{
  if ( (byte_4E79135 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_17623/*"boxGachaId"*/);
    byte_4E79135 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17623/*"boxGachaId"*/, gachaId, 0);
...
System_String_o *BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E79134 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_17621/*"boxGacha/reset"*/);
    byte_4E79134 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_17621/*"boxGacha/reset"*/, 0);
}
