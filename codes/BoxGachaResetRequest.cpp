...
void BoxGachaResetRequest__beginRequest(BoxGachaResetRequest_o *this, int32_t gachaId, const MethodInfo *method)
{
  if ( (byte_593A189 & 1) == 0 )
  {
    sub_21FFC50(&StringLiteral_18085/*"boxGachaId"*/);
    byte_593A189 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18085/*"boxGachaId"*/, gachaId, 0);
...
System_String_o *BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A188 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_18083/*"boxGacha/reset"*/);
    byte_593A188 = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_18083/*"boxGacha/reset"*/, 0);
}
