        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7558 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_17425/*"boxGachaId"*/, *(_QWORD *)&gachaId);
    byte_4AB7558 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17425/*"boxGachaId"*/, gachaId, v3);
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB7557 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_17423/*"boxGacha/reset"*/, v2);
    byte_4AB7557 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_17423/*"boxGacha/reset"*/, 0LL);
}
