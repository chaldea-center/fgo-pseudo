        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6843E & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_17615/*"boxGachaId"*/, *(_QWORD *)&gachaId);
    byte_4B6843E = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17615/*"boxGachaId"*/, gachaId, v3);
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6843D & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&StringLiteral_17613/*"boxGacha/reset"*/, v2);
    byte_4B6843D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_17613/*"boxGacha/reset"*/, 0LL);
}
