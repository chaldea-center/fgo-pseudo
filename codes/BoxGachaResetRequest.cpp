...
void BoxGachaResetRequest__beginRequest(BoxGachaResetRequest_o *this, int32_t gachaId, const MethodInfo *method)
{
  if ( (byte_4C28D3A & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_17360/*"boxGachaId"*/);
    byte_4C28D3A = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17360/*"boxGachaId"*/, gachaId, 0);
...
System_String_o *BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C28D39 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_17358/*"boxGacha/reset"*/);
    byte_4C28D39 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_17358/*"boxGacha/reset"*/, 0);
}
