        ...
        const MethodInfo *method)
{
  if ( (byte_4216356 & 1) == 0 )
  {
    sub_B0D8A4(&StringLiteral_16948/*"boxGachaId"*/, *(_QWORD *)&gachaId);
    byte_4216356 = 1;
  }
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4216355 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&StringLiteral_16946/*"boxGacha/reset"*/, v2);
    byte_4216355 = 1;
  }
  ...
  return System_String__Concat_43849904(BaseUrl, (System_String_o *)StringLiteral_16946/*"boxGacha/reset"*/, 0LL);
}
