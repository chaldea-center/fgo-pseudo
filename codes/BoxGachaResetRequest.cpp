        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EA5A0 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_17105/*"boxGachaId"*/, gachaId, (_DWORD)method, v3);
    byte_42EA5A0 = 1;
  }
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EA59F & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_17103/*"boxGacha/reset"*/, v4, v5, v6);
    byte_42EA59F = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_17103/*"boxGacha/reset"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(48, responseList, 0LL);
  if ( v12
