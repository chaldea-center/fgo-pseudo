        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3E6C & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_17157/*"boxGachaId"*/, *(_QWORD *)&gachaId);
    byte_48E3E6C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17157/*"boxGachaId"*/, gachaId, v3);
...
System_String_o *__fastcall BoxGachaResetRequest__getURL(BoxGachaResetRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E3E6B & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_17155/*"boxGacha/reset"*/, v2);
    byte_48E3E6B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_17155/*"boxGacha/reset"*/, 0LL);
}
