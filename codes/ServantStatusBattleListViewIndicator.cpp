        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56CA7 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_ServantStatusBattleListViewIndicator_OnClickBottom__);
    byte_4A56CA7 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( (pageIndex & 0x80000000) == 0 && pageIndex < this->fields.pageMax - 1 )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickBottom__ + 83) & 2) != 0 )
        v7 = (_QWORD *)sub_1B885C8(Method_ServantStatusBattleListViewIndicator_OnClickBottom__);
...
LABEL_20:
        ListViewManager__MoveCenterItem(v5, v10, 1, v9, 0.0, 0LL);
        return;
      }
      goto LABEL_22;
    }
    ...
    if ( v11->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickBottom__ + 83) & 2) != 0 )
        v12 = (_QWORD *)sub_1B885C8(Method_ServantStatusBattleListViewIndicator_OnClickBottom__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_ServantStatusBattleListViewIndicator_OnClickTop__);
    byte_4A56CA6 = 1;
  }
  manager = (UnityEngine_Object_o *)this->fields.manager;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0LL, 0LL) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( this->fields.pageIndex >= 1 )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickTop__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1B885C8(Method_ServantStatusBattleListViewIndicator_OnClickTop__);
      ...
      if ( v5 )
      {
        ...
        v9 = 1;
LABEL_19:
        ListViewManager__MoveCenterItem(v5, pageIndex - 1, 1, v9, 0.0, 0LL);
        return;
      }
      goto LABEL_21;
    }
    ...
    if ( v10->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickTop__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1B885C8(Method_ServantStatusBattleListViewIndicator_OnClickTop__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554(&this->fields.manager, manager);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B8880C(topObject, *(_QWORD *)&max);
  }
