        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DDFF6 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_ServantStatusBattleListViewIndicator_OnClickBottom__, v3);
    byte_48DDFF6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, method);
    sub_1B00CCC(&Method_ServantStatusBattleListViewIndicator_OnClickTop__, v3);
    byte_48DDFF5 = 1;
  }
  manager = (UnityEngine_Object_o *)this->fields.manager;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70(&this->fields.manager);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B00F28(topObject, *(_QWORD *)&max);
  }
