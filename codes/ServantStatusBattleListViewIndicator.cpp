        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C20A & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_ServantStatusBattleListViewIndicator_OnClickBottom__);
    byte_4D2C20A = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0, 0) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( (pageIndex & 0x80000000) == 0 && pageIndex < this->fields.pageMax - 1 )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickBottom__ + 83) & 2) != 0 )
        v7 = (_QWORD *)sub_1C93AEC(Method_ServantStatusBattleListViewIndicator_OnClickBottom__);
...
LABEL_20:
    ...
    if ( v11->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickBottom__ + 83) & 2) != 0 )
        v12 = (_QWORD *)sub_1C93AEC(Method_ServantStatusBattleListViewIndicator_OnClickBottom__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&Method_ServantStatusBattleListViewIndicator_OnClickTop__);
    byte_4D2C209 = 1;
  }
  manager = (UnityEngine_Object_o *)this->fields.manager;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
  ...
  if ( !UnityEngine_Object__op_Equality(manager, 0, 0) && (this->fields.pageIndex & 0x80000000) == 0 )
  {
    ...
    if ( this->fields.pageIndex >= 1 )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickTop__ + 83) & 2) != 0 )
        v6 = (_QWORD *)sub_1C93AEC(Method_ServantStatusBattleListViewIndicator_OnClickTop__);
...
LABEL_19:
    ...
    if ( v10->fields.isLoop )
    {
      ...
      if ( (*((_BYTE *)Method_ServantStatusBattleListViewIndicator_OnClickTop__ + 83) & 2) != 0 )
        v11 = (_QWORD *)sub_1C93AEC(Method_ServantStatusBattleListViewIndicator_OnClickTop__);
        ...
        const MethodInfo *method)
{
  ...
  if ( !topObject || (UnityEngine_GameObject__SetActive(topObject, 0, 0), (topObject = this->fields.bottomObject) == 0) )
    sub_1C93D2C(topObject, *(_QWORD *)&max);
