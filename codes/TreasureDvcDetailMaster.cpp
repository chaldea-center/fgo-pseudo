void TreasureDvcDetailMaster___ctor(TreasureDvcDetailMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4D2D598 & 1) == 0 )
  {
    sub_1C94098(&Method_DataMasterBase_TreasureDvcDetailMaster__TreasureDvcDetailEntity__int___ctor__);
    byte_4D2D598 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    97,
    (const MethodInfo_345919C *)Method_DataMasterBase_TreasureDvcDetailMaster__TreasureDvcDetailEntity__int___ctor__);
}
...
System_String_o *TreasureDvcDetailMaster__getDetail(int32_t id, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D599 & 1) == 0 )
  {
    sub_1C94098(&Method_DataManager_GetMasterData_TreasureDvcDetailMaster___);
    sub_1C94098(&Method_DataMasterBase_TreasureDvcDetailMaster__TreasureDvcDetailEntity__int__get_lookup__);
    sub_1C94098(&System_Collections_Generic_IReadOnlyDictionary_string__TreasureDvcDetailEntity__TypeInfo);
  ...
  MasterData_object = DataManager__GetMasterData_object_(
                        Instance,
                        (const MethodInfo_319C134 *)Method_DataManager_GetMasterData_TreasureDvcDetailMaster___);
  ...
  Instance = (DataManager_o *)DataMasterBase_object__object__int___get_lookup(
                                ...
                                (const MethodInfo_34592B4 *)Method_DataMasterBase_TreasureDvcDetailMaster__TreasureDvcDetailEntity__int__get_lookup__);
  if ( !Instance )
    goto LABEL_29;
