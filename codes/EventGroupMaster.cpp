void EventGroupMaster___ctor(EventGroupMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4E049F7 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventGroupMaster__EventGroupEntity__string___ctor__);
    byte_4E049F7 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    299,
    (const MethodInfo_34EBC44 *)Method_DataMasterBase_EventGroupMaster__EventGroupEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E049F8 & 1) == 0 )
  {
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_EventGroupEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_ObjectModel_Collection_EventGroupEntity__get_Item__);
    sub_1CE6700(&Method_System_Collections_Generic_List_EventGroupEntity__Add__);
    sub_1CE6700(&Method_System_Collections_Generic_List_EventGroupEntity___ctor__);
    sub_1CE6700(&System_Collections_Generic_List_EventGroupEntity__TypeInfo);
    byte_4E049F8 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1CE694C(System_Collections_Generic_List_EventGroupEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_3905734 *)Method_System_Collections_Generic_List_EventGroupEntity___ctor__);
...
LABEL_15:
  ...
  while ( v8 < System_Collections_ObjectModel_Collection_object___get_Count(
                 list,
                 (const MethodInfo_3480AB0 *)Method_System_Collections_ObjectModel_Collection_EventGroupEntity__get_Count__) )
  {
    list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
    if ( !list )
      goto LABEL_15;
    list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                               list,
                                                               v8,
                                                               (const MethodInfo_3480B40 *)Method_System_Collections_ObjectModel_Collection_EventGroupEntity__get_Item__);
    if ( list )
    {
      v6 = list;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E049F5 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventGroupMaster__EventGroupEntity__string__GetEntity__);
    byte_4E049F5 = 1;
  }
  ...
  return (EventGroupEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_34EE1BC *)Method_DataMasterBase_EventGroupMaster__EventGroupEntity__string__GetEntity__);
}
...
int32_t EventGroupMaster__GetFirstOpenEventId(EventGroupMaster_o *this, int32_t eventId, const MethodInfo *method)
{
  ...
  if ( (byte_4E049FA & 1) == 0 )
  {
    sub_1CE6700(&System_Comparison_EventGroupEntity__TypeInfo);
    sub_1CE6700(&Method_System_Collections_Generic_List_EventGroupEntity__Sort__);
    sub_1CE6700(&Method_System_Collections_Generic_List_EventGroupEntity__get_Count__);
    sub_1CE6700(&Method_System_Collections_Generic_List_EventGroupEntity__get_Item__);
    sub_1CE6700(&Method_EventGroupMaster___c__GetFirstOpenEventId_b__5_0__);
    sub_1CE6700(&EventGroupMaster___c_TypeInfo);
    byte_4E049FA = 1;
  }
  ...
  if ( EventGroupId != -1 )
  {
    ...
    if ( *((_DWORD *)EntitiesByGroupId + 6) )
    {
      ...
      if ( !_9__5_0 )
      {
        ...
        _9__5_0 = (System_Comparison_T__o *)sub_1CE694C(System_Comparison_EventGroupEntity__TypeInfo);
      ...
      System_Collections_Generic_List_object___Sort_59800108(
        v9,
        _9__5_0,
        (const MethodInfo_3907A2C *)Method_System_Collections_Generic_List_EventGroupEntity__Sort__);
      EntitiesByGroupId = System_Collections_Generic_List_object___get_Item(
                            v9,
                            0,
                            (const MethodInfo_3905C98 *)Method_System_Collections_Generic_List_EventGroupEntity__get_Item__);
      if ( EntitiesByGroupId )
        return *((_DWORD *)EntitiesByGroupId + 5);
LABEL_15:
      sub_1CE6958(EntitiesByGroupId, v8);
    }
  }
  return eventId;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E049F6 & 1) == 0 )
  {
    sub_1CE6700(&Method_DataMasterBase_EventGroupMaster__EventGroupEntity__string__TryGetEntity__);
    byte_4E049F6 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_34EE208 *)Method_DataMasterBase_EventGroupMaster__EventGroupEntity__string__TryGetEntity__);
}
...
void EventGroupMaster___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1CE694C(EventGroupMaster___c_TypeInfo);
  System_Object___ctor(v1, 0);
  EventGroupMaster___c_TypeInfo->static_fields->__9 = (struct EventGroupMaster___c_o *)v1;
  sub_1CE66A4(
    (GrandQuestFolderBoardItem_o *)EventGroupMaster___c_TypeInfo->static_fields,
    (int32_t)v1,
    v2,
    v3,
    v4,
