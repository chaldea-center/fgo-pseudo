...
void __fastcall CharaCutEffectComponent__CutinResume(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B03500 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_9811/*"OnEndCutinEffect"*/, v4);
    sub_1BC3008(&StringLiteral_4881/*"Custom/Sprite-ScriptActionFigureCut"*/, v5);
    byte_4B03500 = 1;
  }
  ...
  if ( !image )
    goto LABEL_19;
  UIImageRender__SetSharder(image, (System_String_o *)StringLiteral_4881/*"Custom/Sprite-ScriptActionFigureCut"*/, 0LL);
  ...
  *(float *)&v2 = v8 + 1.0039;
  ...
  if ( !isSkip && this->fields.duration > 0.0 )
  {
    ...
    if ( image )
    {
      ...
      sub_1BC2FAC((CGThumbnailListItem_o *)&v13->fields.mTrans, (int32_t)v14, v15, v16);
      v17 = StringLiteral_9811/*"OnEndCutinEffect"*/;
      v13->fields.mChildren = (struct BetterList_UIRect__o *)StringLiteral_9811/*"OnEndCutinEffect"*/;
      sub_1BC2FAC((CGThumbnailListItem_o *)&v13->fields.mChildren, v17, v18, v19);
      return;
    }
    goto LABEL_19;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B034FE & 1) == 0 )
  {
    sub_1BC3008(&AssetManager_TypeInfo, image);
    sub_1BC3008(&Method_CharaCutEffectComponent_EndLoadWipe__, v9);
    sub_1BC3008(&AssetLoader_LoadEndDataHandler_TypeInfo, v10);
    sub_1BC3008(&StringLiteral_15513/*"Wipe/"*/, v11);
    byte_4B034FE = 1;
  }
  this->fields.isCutBusy = 1;
  this->fields.image = image;
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.image, (int32_t)image, (int32_t)wipeName, method);
  this->fields.mgd = mgd;
  v12 = System_String__Concat_62348648((System_String_o *)StringLiteral_15513/*"Wipe/"*/, wipeName, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03501 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_9812/*"OnEndCutoutEffect"*/, v8);
    byte_4B03501 = 1;
  }
  ...
  else
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&v12->fields.eventReceiver, (int32_t)v13, v14, v15);
    v16 = StringLiteral_9812/*"OnEndCutoutEffect"*/;
    v12->fields.callWhenFinished = (struct System_String_o *)StringLiteral_9812/*"OnEndCutoutEffect"*/;
