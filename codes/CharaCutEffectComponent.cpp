...
void __fastcall CharaCutEffectComponent__CutinResume(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B1735 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_10061/*"OnEndCutinEffect"*/);
    sub_B52984(&StringLiteral_4562/*"Custom/Sprite-ScriptActionFigureCut"*/);
    byte_42B1735 = 1;
  }
  ...
  if ( !image )
    goto LABEL_19;
  UIImageRender__SetSharder(image, (System_String_o *)StringLiteral_4562/*"Custom/Sprite-ScriptActionFigureCut"*/, 0LL);
  ...
  *(float *)&v2 = v6 + 1.0039;
  ...
  if ( !isSkip && this->fields.duration > 0.0 )
  {
    ...
    if ( image )
    {
      ...
      sub_B52920((BattleServantConfConponent_o *)&v16->fields.mTrans, v17, v18, v19, v20, v21, v22, v23);
      v24 = (System_Int32_array **)StringLiteral_10061/*"OnEndCutinEffect"*/;
      v16->fields.mChildren = (struct BetterList_UIRect__o *)StringLiteral_10061/*"OnEndCutinEffect"*/;
      sub_B52920((BattleServantConfConponent_o *)&v16->fields.mChildren, v24, v25, v26, v27, v28, v29, v30);
      return;
    }
    goto LABEL_19;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1733 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_CharaCutEffectComponent_EndLoadWipe__);
  ...
  sub_B52920(
    ...
    v8);
  this->fields.mgd = mgd;
  v13 = System_String__Concat_44568316((System_String_o *)StringLiteral_15601/*"Wipe/"*/, wipeName, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B1736 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_10062/*"OnEndCutoutEffect"*/);
    byte_42B1736 = 1;
  }
  ...
  else
  {
    ...
    sub_B52920((BattleServantConfConponent_o *)&v10->fields.eventReceiver, v11, v12, v13, v14, v15, v16, v17);
    v18 = (System_Int32_array **)StringLiteral_10062/*"OnEndCutoutEffect"*/;
    v10->fields.callWhenFinished = (struct System_String_o *)StringLiteral_10062/*"OnEndCutoutEffect"*/;
    sub_B52920((BattleServantConfConponent_o *)&v10->fields.callWhenFinished, v18, v19, v20, v21, v22, v23, v24);
  }
}
...
void __fastcall CharaCutEffectComponent__OnDestroy(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(image, 0LL, 0LL) )
  {
    ...
    p_image->klass = 0LL;
    sub_B52920(p_image, 0LL, v14, v15, v16, v17, v18, v19);
  }
}
