...
void __fastcall CharaCutEffectComponent__CutinResume(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B45F53 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_9898/*"OnEndCutinEffect"*/, v4);
    sub_1BDB878(&StringLiteral_4961/*"Custom/Sprite-ScriptActionFigureCut"*/, v5);
    byte_4B45F53 = 1;
  }
  ...
  *(float *)&v2 = v8 + 1.0039;
  ...
  if ( !isSkip && this->fields.duration > 0.0 )
  {
    ...
    if ( image )
    {
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&v13->fields.mTrans, (int32_t)v14, v15, v16);
      v17 = StringLiteral_9898/*"OnEndCutinEffect"*/;
      v13->fields.mChildren = (struct BetterList_UIRect__o *)StringLiteral_9898/*"OnEndCutinEffect"*/;
      sub_1BDB81C((CGThumbnailListItem_o *)&v13->fields.mChildren, v17, v18, v19);
      return;
    }
    goto LABEL_19;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F51 & 1) == 0 )
  {
    sub_1BDB878(&AssetManager_TypeInfo, image);
    sub_1BDB878(&Method_CharaCutEffectComponent_EndLoadWipe__, v9);
    sub_1BDB878(&AssetLoader_LoadEndDataHandler_TypeInfo, v10);
    sub_1BDB878(&StringLiteral_15635/*"Wipe/"*/, v11);
    byte_4B45F51 = 1;
  }
  this->fields.isCutBusy = 1;
  this->fields.image = image;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.image, (int32_t)image, (int32_t)wipeName, method);
  this->fields.mgd = mgd;
  v12 = System_String__Concat_62572260((System_String_o *)StringLiteral_15635/*"Wipe/"*/, wipeName, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45F54 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_9899/*"OnEndCutoutEffect"*/, v8);
    byte_4B45F54 = 1;
  }
  ...
  else
  {
    ...
    sub_1BDB81C((CGThumbnailListItem_o *)&v12->fields.eventReceiver, (int32_t)v13, v14, v15);
    v16 = StringLiteral_9899/*"OnEndCutoutEffect"*/;
    v12->fields.callWhenFinished = (struct System_String_o *)StringLiteral_9899/*"OnEndCutoutEffect"*/;
