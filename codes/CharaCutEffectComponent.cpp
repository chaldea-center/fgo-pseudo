...
void __fastcall CharaCutEffectComponent__CutinResume(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A20DD4 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9859/*"OnEndCutinEffect"*/, v4);
    sub_1B715CC(&StringLiteral_4942/*"Custom/Sprite-ScriptActionFigureCut"*/, v5);
    byte_4A20DD4 = 1;
  }
  ...
  if ( !image )
    goto LABEL_19;
  UIImageRender__SetSharder(image, (System_String_o *)StringLiteral_4942/*"Custom/Sprite-ScriptActionFigureCut"*/, 0LL);
  ...
  *(float *)&v2 = v8 + 1.0039;
  ...
  if ( !isSkip && this->fields.duration > 0.0 )
  {
    ...
    if ( image )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&v13->fields.mTrans, (int32_t)v14, v15, v16);
      v17 = StringLiteral_9859/*"OnEndCutinEffect"*/;
      v13->fields.mChildren = (struct BetterList_UIRect__o *)StringLiteral_9859/*"OnEndCutinEffect"*/;
      sub_1B71570((ServantStatusBattleListViewItem_o *)&v13->fields.mChildren, v17, v18, v19);
      return;
    }
    goto LABEL_19;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DD2 & 1) == 0 )
  {
    sub_1B715CC(&AssetManager_TypeInfo, image);
    sub_1B715CC(&Method_CharaCutEffectComponent_EndLoadWipe__, v9);
    sub_1B715CC(&AssetLoader_LoadEndDataHandler_TypeInfo, v10);
    sub_1B715CC(&StringLiteral_15610/*"Wipe/"*/, v11);
    byte_4A20DD2 = 1;
  }
  this->fields.isCutBusy = 1;
  ...
  sub_1B71570(
    ...
    (int32_t)method);
  this->fields.mgd = mgd;
  v12 = System_String__Concat_61505504((System_String_o *)StringLiteral_15610/*"Wipe/"*/, wipeName, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A20DD5 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9860/*"OnEndCutoutEffect"*/, v8);
    byte_4A20DD5 = 1;
  }
  ...
  else
  {
    ...
    sub_1B71570((ServantStatusBattleListViewItem_o *)&v12->fields.eventReceiver, (int32_t)v13, v14, v15);
    v16 = StringLiteral_9860/*"OnEndCutoutEffect"*/;
    v12->fields.callWhenFinished = (struct System_String_o *)StringLiteral_9860/*"OnEndCutoutEffect"*/;
