...
void CharaCutEffectComponent__CutinResume(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78CC4 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_10017/*"OnEndCutinEffect"*/);
    sub_1D0F0B4(&StringLiteral_4970/*"Custom/Sprite-ScriptActionFigureCut"*/);
    byte_4E78CC4 = 1;
  }
  ...
  if ( !image )
    goto LABEL_19;
  UIImageRender__SetSharder(image, (System_String_o *)StringLiteral_4970/*"Custom/Sprite-ScriptActionFigureCut"*/, 0);
  ...
  *(float *)&v2 = v6 + 1.0039;
  ...
  if ( !isSkip && this->fields.duration > 0.0 )
  {
    ...
    if ( image )
    {
      ...
      sub_1D0F058((GrandQuestFolderBoardItem_o *)&v11->fields.mTrans, (int32_t)v12, v13, v14, v15, v16, v17, v18);
      v19 = StringLiteral_10017/*"OnEndCutinEffect"*/;
      v11->fields.mChildren = (struct BetterList_UIRect__o *)StringLiteral_10017/*"OnEndCutinEffect"*/;
      sub_1D0F058((GrandQuestFolderBoardItem_o *)&v11->fields.mChildren, v19, v20, v21, v22, v23, v24, v25);
      return;
    }
    goto LABEL_19;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78CC2 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_CharaCutEffectComponent_EndLoadWipe__);
  ...
  sub_1D0F058(
    ...
    v8);
  this->fields.mgd = mgd;
  v13 = System_String__Concat_65562772((System_String_o *)StringLiteral_15864/*"Wipe/"*/, wipeName, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78CC5 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_10018/*"OnEndCutoutEffect"*/);
    byte_4E78CC5 = 1;
  }
  ...
  else
  {
    ...
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&v11->fields.eventReceiver, (int32_t)v12, v13, v14, v15, v16, v17, v18);
    v19 = StringLiteral_10018/*"OnEndCutoutEffect"*/;
    v11->fields.callWhenFinished = (struct System_String_o *)StringLiteral_10018/*"OnEndCutoutEffect"*/;
...
void CharaCutEffectComponent__OnDestroy(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(image, 0, 0) )
  {
    ...
    p_image->klass = 0;
    sub_1D0F058(p_image, 0, v14, v15, v16, v17, v18, v19);
  }
}
