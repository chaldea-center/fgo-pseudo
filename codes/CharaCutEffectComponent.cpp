...
void __fastcall CharaCutEffectComponent__CutinResume(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  UIImageRender_o *v17; // x20
  int v18; // s0
  _BOOL4 isSkip; // w8
  UnityEngine_GameObject_o *gameObject; // x0
  UIImageRender_o *v24; // x20
  ...
  if ( (byte_42EB6FC & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_10103/*"OnEndCutinEffect"*/, v6, v7, v8);
    sub_B5D5C4(&StringLiteral_4595/*"Custom/Sprite-ScriptActionFigureCut"*/, v9, v10, v11);
    byte_42EB6FC = 1;
  }
  ...
  image = (UIImageRender_o *)this->fields.image;
  v14 = fmaxf(this->fields.mgd, 0.0);
  this->fields.addVolume = v14;
  if ( !image )
    goto LABEL_19;
  UIImageRender__SetSharder(image, (System_String_o *)StringLiteral_4595/*"Custom/Sprite-ScriptActionFigureCut"*/, 0LL);
  wipeData = this->fields.wipeData;
  if ( wipeData )
  {
    v16 = (UIImageRender_o *)this->fields.image;
    image = (UIImageRender_o *)AssetData__GetObject_Texture2D_(
                                 wipeData,
                                 (const MethodInfo_1AD08C8 *)Method_AssetData_GetObject_Texture2D___);
    if ( !v16 )
      goto LABEL_19;
    UIImageRender__SetWipeTexture(v16, (UnityEngine_Texture_o *)image, 0LL);
  }
  v17 = (UIImageRender_o *)this->fields.image;
  *(UnityEngine_Color_o *)&v18 = UnityEngine_Color__get_white(0LL);
  if ( !v17
    || (UIImageRender__SetFilterColor(v17, *(UnityEngine_Color_o *)&v18, 0LL),
        (image = (UIImageRender_o *)this->fields.image) == 0LL) )
  {
LABEL_19:
    sub_B5D69C(image, method);
  }
  *(float *)&v4 = v14 + 1.0039;
  UIImageRender__SetGradation(image, v14, 0LL);
  ...
  if ( !isSkip && this->fields.duration > 0.0 )
  {
    ...
    image = (UIImageRender_o *)TweenRenderVolume__Begin(gameObject, this->fields.duration, *(float *)&v4, 0LL);
    if ( image )
    {
      v24 = image;
      ...
      v24->fields.mTrans = (struct UnityEngine_Transform_o *)v25;
      sub_B5D560((BattleServantConfConponent_o *)&v24->fields.mTrans, v25, v26, v27, v28, v29, v30, v31);
      v32 = (System_Int32_array **)StringLiteral_10103/*"OnEndCutinEffect"*/;
      v24->fields.mChildren = (struct BetterList_UIRect__o *)StringLiteral_10103/*"OnEndCutinEffect"*/;
      sub_B5D560((BattleServantConfConponent_o *)&v24->fields.mChildren, v32, v33, v34, v35, v36, v37, v38);
      return;
    }
    goto LABEL_19;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EB6FA & 1) == 0 )
  {
    sub_B5D5C4(&AssetManager_TypeInfo, (_DWORD)image, (_DWORD)wipeName, method);
    sub_B5D5C4(&Method_CharaCutEffectComponent_EndLoadWipe__, v13, v14, v15);
    sub_B5D5C4(&AssetLoader_LoadEndDataHandler_TypeInfo, v16, v17, v18);
  ...
  sub_B5D560(
    ...
    v8);
  this->fields.mgd = mgd;
  v22 = System_String__Concat_44577788((System_String_o *)StringLiteral_15686/*"Wipe/"*/, wipeName, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  TweenRenderVolume_o *v12; // x0
  __int64 v13; // x1
  TweenRenderVolume_o *v14; // x20
  ...
  if ( (byte_42EB6FD & 1) == 0 )
  {
    sub_B5D5C4(&UnityEngine_Object_TypeInfo, isSkip, (_DWORD)method, v4);
    sub_B5D5C4(&StringLiteral_10104/*"OnEndCutoutEffect"*/, v8, v9, v10);
    byte_42EB6FD = 1;
  }
  ...
  else
  {
    ...
    v12 = TweenRenderVolume__Begin(v11, this->fields.duration, 0.0, 0LL);
    if ( !v12 )
      sub_B5D69C(0LL, v13);
    v14 = v12;
    v12->fields.style = 1;
    v15 = (System_Int32_array **)UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
    v14->fields.eventReceiver = (struct UnityEngine_GameObject_o *)v15;
    sub_B5D560((BattleServantConfConponent_o *)&v14->fields.eventReceiver, v15, v16, v17, v18, v19, v20, v21);
    v22 = (System_Int32_array **)StringLiteral_10104/*"OnEndCutoutEffect"*/;
    v14->fields.callWhenFinished = (struct System_String_o *)StringLiteral_10104/*"OnEndCutoutEffect"*/;
    sub_B5D560((BattleServantConfConponent_o *)&v14->fields.callWhenFinished, v22, v23, v24, v25, v26, v27, v28);
  }
}
...
void __fastcall CharaCutEffectComponent__OnDestroy(CharaCutEffectComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(image, 0LL, 0LL) )
  {
    ...
    p_image->klass = 0LL;
    sub_B5D560(p_image, 0LL, v19, v20, v21, v22, v23, v24);
  }
}
