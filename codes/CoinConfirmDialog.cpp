...
void CoinConfirmDialog__Close(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmDialog__Close_49048908(this, 0, v2);
}


void CoinConfirmDialog__Close_49048908(CoinConfirmDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  int32_t v3; // w3
  ...
  if ( (byte_4D305F3 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_CoinConfirmDialog_EndClose__);
    byte_4D305F3 = 1;
  }
...
void CoinConfirmDialog__OnClickCancel(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D305F5 & 1) == 0 )
  {
    sub_1C94098(&Method_CoinConfirmDialog_OnClickCancel__);
    byte_4D305F5 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_CoinConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C9407C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    CoinConfirmDialog__Close_49048908(this, 0, v5);
  }
}
...
void CoinConfirmDialog__OnClickDecide(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D305F4 & 1) == 0 )
  {
    sub_1C94098(&Method_CoinConfirmDialog_OnClickDecide__);
    byte_4D305F4 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( onDecide )
    {
      ...
      if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1C940B0(Method_CoinConfirmDialog_OnClickDecide__);
      ...
      p_onDecide->klass = 0;
      sub_1C9403C(p_onDecide, 0, v8, v9, v10, v11, v12, v13);
      if ( !klass )
        sub_1C942F0(v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D305F2 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_3548/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/);
    sub_1C94098(&StringLiteral_3549/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/);
    byte_4D305F2 = 1;
  }
