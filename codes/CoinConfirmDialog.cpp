...
void __fastcall CoinConfirmDialog__Close(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmDialog__Close_44192824(this, 0LL, v2);
}


void __fastcall CoinConfirmDialog__Close_44192824(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01FB0 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_CoinConfirmDialog_EndClose__, v6);
    byte_4A01FB0 = 1;
  }
...
void __fastcall CoinConfirmDialog__OnClickCancel(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01FB2 & 1) == 0 )
  {
    sub_1B64A00(&Method_CoinConfirmDialog_OnClickCancel__, method);
    byte_4A01FB2 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_CoinConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B649E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0LL);
    CoinConfirmDialog__Close_44192824(this, 0LL, v5);
  }
}
...
void __fastcall CoinConfirmDialog__OnClickDecide(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01FB1 & 1) == 0 )
  {
    sub_1B64A00(&Method_CoinConfirmDialog_OnClickDecide__, method);
    byte_4A01FB1 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( onDecide )
    {
      ...
      if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1B64A18(Method_CoinConfirmDialog_OnClickDecide__);
      ...
      sub_1B649A4(p_onDecide, 0, v8, v9);
      if ( !klass )
        sub_1B64C5C(v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01FAF & 1) == 0 )
  {
    sub_1B64A00(&CoinRoomUtility_TypeInfo, selectedCoinDic);
    sub_1B64A00(&int_TypeInfo, v7);
    sub_1B64A00(&LocalizationManager_TypeInfo, v8);
    sub_1B64A00(&StringLiteral_3601/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, v9);
    sub_1B64A00(&StringLiteral_3602/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/, v10);
    byte_4A01FAF = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.onDecide, (int32_t)onDecide, v13, v14);
    ...
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3601/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, 0LL);
    v17 = v16;
