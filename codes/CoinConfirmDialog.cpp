...
void CoinConfirmDialog__Close(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmDialog__Close_49457140(this, 0, v2);
}


void CoinConfirmDialog__Close_49457140(CoinConfirmDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  int32_t v3; // w3
  ...
  if ( (byte_4E087E5 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_CoinConfirmDialog_EndClose__);
    byte_4E087E5 = 1;
  }
...
void CoinConfirmDialog__OnClickCancel(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E087E7 & 1) == 0 )
  {
    sub_1CE6700(&Method_CoinConfirmDialog_OnClickCancel__);
    byte_4E087E7 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_CoinConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    CoinConfirmDialog__Close_49457140(this, 0, v5);
  }
}
...
void CoinConfirmDialog__OnClickDecide(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E087E6 & 1) == 0 )
  {
    sub_1CE6700(&Method_CoinConfirmDialog_OnClickDecide__);
    byte_4E087E6 = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( onDecide )
    {
      ...
      if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1CE6718(Method_CoinConfirmDialog_OnClickDecide__);
      ...
      p_onDecide->klass = 0;
      sub_1CE66A4(p_onDecide, 0, v8, v9, v10, v11, v12, v13);
      if ( !klass )
        sub_1CE6958(v14, v15);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E087E4 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_3571/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/);
    sub_1CE6700(&StringLiteral_3572/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/);
    byte_4E087E4 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3572/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/, 0);
    if ( !titleLabel )
      goto LABEL_14;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3571/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, 0);
    v17 = v16;
