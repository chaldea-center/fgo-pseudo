...
void __fastcall CoinConfirmDialog__Close(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmDialog__Close_26739052(this, 0LL, v2);
}


void __fastcall CoinConfirmDialog__Close_26739052(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188821 & 1) == 0 )
  {
    ...
    sub_B2C35C(&Method_CoinConfirmDialog_EndClose__, v10);
    byte_4188821 = 1;
  }
...
void __fastcall CoinConfirmDialog__OnClickCancel(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 1 )
  {
    ...
    CoinConfirmDialog__Close_26739052(this, 0LL, v3);
  }
}
...
void __fastcall CoinConfirmDialog__OnClickDecide(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( onDecide )
    {
      ...
      sub_B2C2F8(p_onDecide, 0LL, v6, v7, v8, v9, v10, v11);
      if ( !klass )
        sub_B2C434(v12, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188820 & 1) == 0 )
  {
    sub_B2C35C(&CoinRoomUtility_TypeInfo, selectedCoinDic);
    sub_B2C35C(&int_TypeInfo, v7);
    sub_B2C35C(&LocalizationManager_TypeInfo, v8);
    sub_B2C35C(&StringLiteral_3130/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, v9);
    sub_B2C35C(&StringLiteral_3131/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/, v10);
    byte_4188820 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3131/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_16;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    v20 = LocalizationManager__Get((System_String_o *)StringLiteral_3130/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, 0LL);
    v21 = v20;
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Format(v21, v24, 0LL);
    if ( !detailLabel
