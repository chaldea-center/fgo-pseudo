...
void CoinConfirmDialog__Close(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmDialog__Close_48235960(this, 0, v2);
}


void CoinConfirmDialog__Close_48235960(CoinConfirmDialog_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9EC & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_CoinConfirmDialog_EndClose__);
    byte_4C5A9EC = 1;
  }
...
void CoinConfirmDialog__OnClickCancel(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9EE & 1) == 0 )
  {
    sub_1C3E564(&Method_CoinConfirmDialog_OnClickCancel__);
    byte_4C5A9EE = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_CoinConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3E548(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    CoinConfirmDialog__Close_48235960(this, 0, v5);
  }
}
...
void CoinConfirmDialog__OnClickDecide(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9ED & 1) == 0 )
  {
    sub_1C3E564(&Method_CoinConfirmDialog_OnClickDecide__);
    byte_4C5A9ED = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( onDecide )
    {
      ...
      if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1C3E57C(Method_CoinConfirmDialog_OnClickDecide__);
      ...
      p_onDecide->klass = 0;
      sub_1C3E508(p_onDecide, 0, v8, v9);
      if ( !klass )
        sub_1C3E7C0(v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5A9EB & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_3543/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/);
    sub_1C3E564(&StringLiteral_3544/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/);
    byte_4C5A9EB = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3543/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, 0);
    ...
    gameObject = (UnityEngine_GameObject_o *)System_String__Format(v12, v21, 0);
    if ( !detailLabel
