...
void __fastcall CoinConfirmDialog__Close(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  CoinConfirmDialog__Close_47045568(this, 0LL, v2);
}


void __fastcall CoinConfirmDialog__Close_47045568(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FEFA & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_CoinConfirmDialog_EndClose__, v6);
    byte_4B1FEFA = 1;
  }
...
void __fastcall CoinConfirmDialog__OnClickCancel(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1FEFC & 1) == 0 )
  {
    sub_1BCAFF8(&Method_CoinConfirmDialog_OnClickCancel__, method);
    byte_4B1FEFC = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_CoinConfirmDialog_OnClickCancel__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0LL);
    CoinConfirmDialog__Close_47045568(this, 0LL, v5);
  }
}
...
void __fastcall CoinConfirmDialog__OnClickDecide(CoinConfirmDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1FEFB & 1) == 0 )
  {
    sub_1BCAFF8(&Method_CoinConfirmDialog_OnClickDecide__, method);
    byte_4B1FEFB = 1;
  }
  if ( this->fields.state == 1 )
  {
    ...
    if ( onDecide )
    {
      ...
      if ( (*((_BYTE *)Method_CoinConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
        v5 = (_QWORD *)sub_1BCB010(Method_CoinConfirmDialog_OnClickDecide__);
      ...
      sub_1BCAF9C(p_onDecide, 0, v8, v9);
      if ( !klass )
        sub_1BCB254(v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FEF9 & 1) == 0 )
  {
    sub_1BCAFF8(&CoinRoomUtility_TypeInfo, selectedCoinDic);
    sub_1BCAFF8(&int_TypeInfo, v7);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v8);
    sub_1BCAFF8(&StringLiteral_3508/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, v9);
    sub_1BCAFF8(&StringLiteral_3509/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/, v10);
    byte_4B1FEF9 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.onDecide, (int32_t)onDecide, v13, v14);
    titleLabel = this->fields.titleLabel;
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_3509/*"COIN_ROOM_CONFIRM_DIALOG_TITLE"*/, 0LL);
    if ( !titleLabel )
      goto LABEL_14;
    UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
    v16 = LocalizationManager__Get((System_String_o *)StringLiteral_3508/*"COIN_ROOM_CONFIRM_DIALOG_DETAIL"*/, 0LL);
