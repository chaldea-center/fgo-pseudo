        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21588 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_EventCraftUseSupportToolDialogComponent_Init__);
    byte_4C21588 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21587 & 1) == 0 )
  {
    sub_1C2D490(&Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__);
    byte_4C21587 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21586 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__);
    byte_4C21586 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C2D4A8(Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C2D474(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C21584 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_EventCraftUseSupportToolDialogComponent__Open_b__24_0__);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&NetworkManager_TypeInfo);
    sub_1C2D490(&StringLiteral_3685/*"COMMON_CONFIRM_USE"*/);
    ...
    sub_1C2D490(&StringLiteral_3905/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_TITLE"*/);
    sub_1C2D490(&StringLiteral_3903/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_HEADER"*/);
    this = (EventCraftUseSupportToolDialogComponent_o *)sub_1C2D490(&StringLiteral_3902/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_DESCRIPTION"*/);
    byte_4C21584 = 1;
  }
  entity = 0;
  if ( !v10->fields.state )
  {
    ...
    if ( v9 )
    {
      ...
      sub_1C2D434(&v10->fields.pickupInfoList);
      v10->fields.supportTool = support;
      p_supportTool = &v10->fields.supportTool;
      sub_1C2D434(&v10->fields.supportTool);
      ...
      this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                            (System_String_o *)StringLiteral_3905/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_TITLE"*/,
                                                            0);
      if ( titleLabel )
      {
        ...
        this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_3902/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_DESCRIPTION"*/,
                                                              0);
        if ( detailLabel )
        {
          ...
          this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_3903/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_HEADER"*/,
                                                                0);
          if ( craftCompletionHeaderLb )
          {
            ...
            if ( supportToolLeftTimeHeaderLb )
            {
              ...
              this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_3685/*"COMMON_CONFIRM_USE"*/,
                                                                    0);
              if ( decideButtonLb )
              {
...
LABEL_33:
                      ...
                      System_Action___ctor(
                        ...
                        0);
                      BaseDialog__Open((BaseDialog_o *)v10, v21, 0, 0);
                      return;
                    }
                  }
                }
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_38AFA90 *v38; // x3
  const MethodInfo_38AFA90 *v39; // x3
  int64_t v40; // x8
  int64_t v41; // x21
  ...
  if ( (byte_4C21585 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_EventCraftUseSupportToolDialogComponent___c__SetTimeLabel_b__25_0__);
    sub_1C2D490(&EventCraftUseSupportToolDialogComponent___c_TypeInfo);
    sub_1C2D490(&StringLiteral_13390/*"TIME_FORMAT_1"*/);
    this = (EventCraftUseSupportToolDialogComponent_o *)sub_1C2D490(&StringLiteral_13495/*"TRADE_EVENT_TRADE_COMPLETE_TIME"*/);
    byte_4C21585 = 1;
  }
  ...
  {
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_13390/*"TIME_FORMAT_1"*/, 0);
...
LABEL_23:
  ...
  if ( v24 < 0 )
    goto LABEL_23;
LABEL_21:
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_13390/*"TIME_FORMAT_1"*/, 0);
...
LABEL_24:
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)v3->fields.pickupInfoList, 0) )
  {
    ...
    if ( !_9__25_0 )
    {
      ...
      _9__25_0 = (System_Func_object__long__o *)sub_1C2D6DC(System_Func_EventCraftPickupInfo__long__TypeInfo);
    ...
    v26 = System_Linq_Enumerable__Max_66459884((System_Collections_Generic_IEnumerable_long__o *)v32, 0);
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  v34 = System_Math__Max_64982052(v26 - v33, 0, 0);
  ...
  v44 = 0;
  System_Nullable_int____ctor(v37, TradePickupTime, (const MethodInfo_38AF304 *)Method_System_Nullable_int___ctor__);
  if ( !(_BYTE)v44 )
    goto LABEL_41;
...
LABEL_41:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v43 = LocalizationManager__Get((System_String_o *)StringLiteral_13390/*"TIME_FORMAT_1"*/, 0);
...
void EventCraftUseSupportToolDialogComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(EventCraftUseSupportToolDialogComponent___c_TypeInfo);
  ...
  sub_1C2D434(EventCraftUseSupportToolDialogComponent___c_TypeInfo->static_fields);
}
