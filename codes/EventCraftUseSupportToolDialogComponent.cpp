        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716AD & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventCraftUseSupportToolDialogComponent_Init__);
    byte_4E716AD = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716AC & 1) == 0 )
  {
    sub_1D0F0B4(&Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__);
    byte_4E716AC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716AB & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__);
    byte_4E716AB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1D0F098(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E716A9 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventCraftUseSupportToolDialogComponent__Open_b__24_0__);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_3731/*"COMMON_CONFIRM_USE"*/);
    ...
    sub_1D0F0B4(&StringLiteral_3951/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_TITLE"*/);
    sub_1D0F0B4(&StringLiteral_3949/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_HEADER"*/);
    this = (EventCraftUseSupportToolDialogComponent_o *)sub_1D0F0B4(&StringLiteral_3948/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_DESCRIPTION"*/);
    byte_4E716A9 = 1;
  }
  entity = 0;
  if ( !v10->fields.state )
  {
    ...
    if ( v9 )
    {
      ...
      sub_1D0F058(&v10->fields.eventTradeInfo, TradeInfo_k__BackingField);
      ...
      sub_1D0F058(&v10->fields.pickupInfoList, PickupInfoList_k__BackingField);
      v10->fields.supportTool = support;
      p_supportTool = &v10->fields.supportTool;
      sub_1D0F058(&v10->fields.supportTool, support);
      v10->fields.onDecide = decideAction;
      sub_1D0F058(&v10->fields.onDecide, decideAction);
      ...
      this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                            (System_String_o *)StringLiteral_3951/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_TITLE"*/,
                                                            0);
      if ( titleLabel )
      {
        ...
        this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_3948/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_DESCRIPTION"*/,
                                                              0);
        if ( detailLabel )
        {
          ...
          this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_3949/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_HEADER"*/,
                                                                0);
          if ( craftCompletionHeaderLb )
          {
            ...
            if ( supportToolLeftTimeHeaderLb )
            {
              ...
              this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_3731/*"COMMON_CONFIRM_USE"*/,
                                                                    0);
              if ( decideButtonLb )
              {
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_3A84A74 *v38; // x3
  const MethodInfo_3A84A74 *v39; // x3
  int64_t v40; // x8
  int64_t v41; // x21
  ...
  if ( (byte_4E716AA & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_EventCraftUseSupportToolDialogComponent___c__SetTimeLabel_b__25_0__);
    sub_1D0F0B4(&EventCraftUseSupportToolDialogComponent___c_TypeInfo);
    sub_1D0F0B4(&StringLiteral_13582/*"TIME_FORMAT_1"*/);
    this = (EventCraftUseSupportToolDialogComponent_o *)sub_1D0F0B4(&StringLiteral_13688/*"TRADE_EVENT_TRADE_COMPLETE_TIME"*/);
    byte_4E716AA = 1;
  }
  ...
  {
    v13 = LocalizationManager__Get((System_String_o *)StringLiteral_13582/*"TIME_FORMAT_1"*/, 0);
...
LABEL_23:
  ...
  if ( v24 < 0 )
    goto LABEL_23;
LABEL_21:
  v25 = LocalizationManager__Get((System_String_o *)StringLiteral_13582/*"TIME_FORMAT_1"*/, 0);
...
LABEL_24:
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)v3->fields.pickupInfoList, 0) )
  {
    ...
    if ( !_9__25_0 )
    {
      ...
      _9__25_0 = (System_Func_object__long__o *)sub_1D0F300(System_Func_EventCraftPickupInfo__long__TypeInfo);
    ...
    v26 = System_Linq_Enumerable__Max_68565992((System_Collections_Generic_IEnumerable_long__o *)v32, 0);
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  v34 = System_Math__Max_67084756(v26 - v33, 0, 0);
  ...
  v44 = 0;
  System_Nullable_int____ctor(v37, TradePickupTime, (const MethodInfo_3A842E8 *)Method_System_Nullable_int___ctor__);
  if ( !(_BYTE)v44 )
    goto LABEL_41;
...
LABEL_41:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v43 = LocalizationManager__Get((System_String_o *)StringLiteral_13582/*"TIME_FORMAT_1"*/, 0);
...
void EventCraftUseSupportToolDialogComponent___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(EventCraftUseSupportToolDialogComponent___c_TypeInfo);
  ...
  sub_1D0F058(EventCraftUseSupportToolDialogComponent___c_TypeInfo->static_fields, v1);
}
