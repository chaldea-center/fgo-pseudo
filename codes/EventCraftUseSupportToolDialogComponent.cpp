        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEE85 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventCraftUseSupportToolDialogComponent_Init__, v3);
    byte_49BEE85 = 1;
  }
  this->fields.state = 4;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEE84 & 1) == 0 )
  {
    sub_1B4CF90(&Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__, method);
    byte_49BEE84 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B4CFA8(Method_EventCraftUseSupportToolDialogComponent_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEE83 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__, v3);
    byte_49BEE83 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B4CFA8(Method_EventCraftUseSupportToolDialogComponent_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BEE81 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventCraftUseSupportToolDialogComponent__Open_b__24_0__, v13);
    sub_1B4CF90(&LocalizationManager_TypeInfo, v14);
    sub_1B4CF90(&NetworkManager_TypeInfo, v15);
    sub_1B4CF90(&StringLiteral_3664/*"COMMON_CONFIRM_USE"*/, v16);
    sub_1B4CF90(&StringLiteral_3656/*"COMMON_CONFIRM_CANCEL"*/, v17);
    sub_1B4CF90(&StringLiteral_3863/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_LEFT_TIME_HEADER"*/, v18);
    sub_1B4CF90(&StringLiteral_3864/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_TITLE"*/, v19);
    sub_1B4CF90(&StringLiteral_3862/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_HEADER"*/, v20);
    this = (EventCraftUseSupportToolDialogComponent_o *)sub_1B4CF90(&StringLiteral_3861/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_DESCRIPTION"*/, v21);
    byte_49BEE81 = 1;
  }
  entity = 0LL;
  if ( !v10->fields.state )
  {
    ...
    if ( v9 )
    {
      ...
      sub_1B4CF34((CGThumbnailListItem_o *)&v10->fields.eventTradeInfo, (int32_t)TradeInfo_k__BackingField, v24, v25);
      ...
      sub_1B4CF34((CGThumbnailListItem_o *)&v10->fields.supportTool, (int32_t)support, v30, v31);
      v10->fields.onDecide = decideAction;
      sub_1B4CF34((CGThumbnailListItem_o *)&v10->fields.onDecide, (int32_t)decideAction, v32, v33);
      ...
      this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                            (System_String_o *)StringLiteral_3864/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_TITLE"*/,
                                                            0LL);
      if ( titleLabel )
      {
        ...
        this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_3861/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_DESCRIPTION"*/,
                                                              0LL);
        if ( detailLabel )
        {
          ...
          this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                                (System_String_o *)StringLiteral_3862/*"CRAFT_EVENT_SUPPORT_TOOL_DIALOG_HEADER"*/,
                                                                0LL);
          if ( craftCompletionHeaderLb )
          {
            ...
            if ( supportToolLeftTimeHeaderLb )
            {
              ...
              this = (EventCraftUseSupportToolDialogComponent_o *)LocalizationManager__Get(
                                                                    (System_String_o *)StringLiteral_3664/*"COMMON_CONFIRM_USE"*/,
                                                                    0LL);
              if ( decideButtonLb )
              {
        ...
        const MethodInfo *method)
{
  ...
  const MethodInfo_369A3B8 *v54; // x3
  const MethodInfo_369A3B8 *v55; // x3
  __int64 v56; // x8
  int64_t v57; // x21
  ...
  if ( (byte_49BEE82 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&EventCraftTimeCalculation_TypeInfo, v4);
    ...
    sub_1B4CF90(&Method_System_Nullable_long__GetValueOrDefault__, v9);
    sub_1B4CF90(&Method_System_Nullable_int__GetValueOrDefault__, v10);
    sub_1B4CF90(&Method_System_Nullable_long___ctor__, v11);
    sub_1B4CF90(&Method_System_Nullable_int___ctor__, v12);
    sub_1B4CF90(&Method_System_Nullable_long__get_HasValue__, v13);
    sub_1B4CF90(&Method_System_Nullable_int__get_HasValue__, v14);
    sub_1B4CF90(&Method_EventCraftUseSupportToolDialogComponent___c__SetTimeLabel_b__25_0__, v15);
    sub_1B4CF90(&EventCraftUseSupportToolDialogComponent___c_TypeInfo, v16);
    sub_1B4CF90(&StringLiteral_13098/*"TIME_FORMAT_1"*/, v17);
    this = (EventCraftUseSupportToolDialogComponent_o *)sub_1B4CF90(&StringLiteral_13203/*"TRADE_EVENT_TRADE_COMPLETE_TIME"*/, v18);
    byte_49BEE82 = 1;
  }
  ...
  {
    v28 = LocalizationManager__Get((System_String_o *)StringLiteral_13098/*"TIME_FORMAT_1"*/, 0LL);
...
LABEL_23:
  ...
  if ( (v39 & 0x8000000000000000LL) != 0 )
    goto LABEL_23;
LABEL_21:
  v40 = LocalizationManager__Get((System_String_o *)StringLiteral_13098/*"TIME_FORMAT_1"*/, 0LL);
...
LABEL_24:
  ...
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)v3->fields.pickupInfoList, 0LL) )
  {
    ...
    if ( !_9__25_0 )
    {
      ...
      _9__25_0 = (System_Func_T__TResult__o *)sub_1B4D1DC(System_Func_EventCraftPickupInfo__long__TypeInfo);
      ...
      sub_1B4CF34((CGThumbnailListItem_o *)&static_fields->__9__25_0, (int32_t)_9__25_0, v47, v48);
    }
    ...
    v41 = System_Linq_Enumerable__Max_64099968((System_Collections_Generic_IEnumerable_long__o *)v49, 0LL);
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  ...
  v51 = System_Math__Max_62621800(v41 - v50, 0LL, 0LL);
  ...
  v60 = 0LL;
  System_Nullable_int____ctor(v62, TradePickupTime, (const MethodInfo_3699C2C *)Method_System_Nullable_int___ctor__);
  if ( !(_BYTE)v60 )
    goto LABEL_41;
...
LABEL_41:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v59 = LocalizationManager__Get((System_String_o *)StringLiteral_13098/*"TIME_FORMAT_1"*/, 0LL);
...
void __fastcall EventCraftUseSupportToolDialogComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BEE88 & 1) == 0 )
  {
    sub_1B4CF90(&EventCraftUseSupportToolDialogComponent___c_TypeInfo, v1);
    byte_49BEE88 = 1;
  }
  v2 = (Il2CppObject *)sub_1B4D1DC(EventCraftUseSupportToolDialogComponent___c_TypeInfo);
