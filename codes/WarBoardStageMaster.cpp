void __fastcall WarBoardStageMaster___ctor(WarBoardStageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4BC8B4A & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__, method);
    byte_4BC8B4A = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    326,
    (const MethodInfo_3246354 *)Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8B4B & 1) == 0 )
  {
    sub_1C1ABD4(
      ...
      *(_QWORD *)&stageId);
    sub_1C1ABD4(&Method_DataManager_GetMasterData_WarBoardMaster___, v5);
    sub_1C1ABD4(&Method_DataMasterBase_WarBoardMaster__WarBoardEntity__int__GetEntity__, v6);
    sub_1C1ABD4(&System_IDisposable_TypeInfo, v7);
    sub_1C1ABD4(&System_Collections_Generic_IEnumerator_WarBoardStageEntity__TypeInfo, v8);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_31E2F54 *)Method_System_Collections_ObjectModel_Collection_WarBoardStageEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1C1AE30(0LL, v12);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v21 = sub_1C6CBB4(Enumerator, System_Collections_Generic_IEnumerator_WarBoardStageEntity__TypeInfo, 0LL);
    }
