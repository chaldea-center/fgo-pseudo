void __fastcall WarBoardStageMaster___ctor(WarBoardStageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B45C0D & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__, method);
    byte_4B45C0D = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    328,
    (const MethodInfo_32DFB18 *)Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45C0E & 1) == 0 )
  {
    sub_1BDB878(
      ...
      *(_QWORD *)&stageId);
    sub_1BDB878(&Method_DataManager_GetMasterData_WarBoardMaster___, v5);
    sub_1BDB878(&Method_DataMasterBase_WarBoardMaster__WarBoardEntity__int__GetEntity__, v6);
    sub_1BDB878(&System_IDisposable_TypeInfo, v7);
    sub_1BDB878(&System_Collections_Generic_IEnumerator_WarBoardStageEntity__TypeInfo, v8);
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_327DBFC *)Method_System_Collections_ObjectModel_Collection_WarBoardStageEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1BDBAD4(0LL, v12);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v21 = sub_1C2C00C(Enumerator, System_Collections_Generic_IEnumerator_WarBoardStageEntity__TypeInfo, 0LL);
    }
