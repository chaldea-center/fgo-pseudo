void __fastcall WarBoardStageMaster___ctor(WarBoardStageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A2EF59 & 1) == 0 )
  {
    sub_1B761C0(&Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__, method);
    byte_4A2EF59 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    322,
    (const MethodInfo_30FF740 *)Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2EF5A & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMasterData_WarBoardMaster___, v5);
    sub_1B761C0(&Method_DataMasterBase_WarBoardMaster__WarBoardEntity__int__GetEntity__, v6);
    ...
    sub_1B761C0(&WarBoardStageEntity_TypeInfo, v11);
    byte_4A2EF5A = 1;
  }
