void __fastcall WarBoardStageMaster___ctor(WarBoardStageMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A5C189 & 1) == 0 )
  {
    sub_1B885B0(&Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__);
    byte_4A5C189 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    322,
    (const MethodInfo_311D8F4 *)Method_DataMasterBase_WarBoardStageMaster__WarBoardStageEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C18A & 1) == 0 )
  {
    ...
    sub_1B885B0(&WarBoardStageEntity_TypeInfo);
    byte_4A5C18A = 1;
  }
...
LABEL_16:
    ...
    if ( v16 )
    {
      ...
      if ( *(unsigned __int8 *)(*(_QWORD *)v16 + 304LL) < (unsigned int)methodPtr_low
        || *(WarBoardStageEntity_c **)(*(_QWORD *)(*(_QWORD *)v16 + 200LL) + 8 * methodPtr_low - 8) != WarBoardStageEntity_TypeInfo )
      {
        sub_1B88ACC(v16);
        goto LABEL_44;
      }
