        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E021BB & 1) == 0 )
  {
    sub_1CE6700(&Method_BasicHelper_GetOrAddComponent_UIWidget___);
    sub_1CE6700(&bool___TypeInfo);
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___);
    this = (WarBoardControlPlayTalkUiComponent_o *)sub_1CE6700(&UnityEngine_Object_TypeInfo);
    byte_4E021BB = 1;
  }
...
LABEL_28:
    ...
    v28 = sub_1CE67A8(bool___TypeInfo, LODWORD(controlUiObjects->max_length));
    v11->fields.activeStates = (struct System_Boolean_array *)v28;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v11->fields.activeStates, v28, v29, v30, v31, v32, v33, v34);
    v12 = 1;
  }
...
LABEL_27:
    ...
    BasicHelper__GetOrAddComponent_object_(
      transform,
      (const MethodInfo_31F1840 *)Method_BasicHelper_GetOrAddComponent_UIWidget___);
  ...
  {
    *p_activeStates = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v11->fields.activeStates, 0, (int32_t)method, v4, v5, v6, v7, v8);
  }
}