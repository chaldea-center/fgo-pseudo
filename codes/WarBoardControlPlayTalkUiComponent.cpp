        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9F16 & 1) == 0 )
  {
    sub_1B640C8(&Method_BasicHelper_AddNotExistComponent_UIWidget___, isDisp);
    sub_1B640C8(&bool___TypeInfo, v8);
    sub_1B640C8(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___, v9);
    this = (WarBoardControlPlayTalkUiComponent_o *)sub_1B640C8(&UnityEngine_Object_TypeInfo, v10);
    byte_49F9F16 = 1;
  }
...
LABEL_28:
      sub_1B64324(this);
    v27 = sub_1B64170(bool___TypeInfo, controlUiObjects->max_length);
    v7->fields.activeStates = (struct System_Boolean_array *)v27;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&v7->fields.activeStates, v27, v28, v29);
    v11 = 1;
  }
...
LABEL_27:
    ...
    BasicHelper__AddNotExistComponent_object_(
      transform,
      (const MethodInfo_2E24484 *)Method_BasicHelper_AddNotExistComponent_UIWidget___);
  ...
  {
    *p_activeStates = 0LL;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)&v7->fields.activeStates, 0, (int32_t)method, v4);
  }
}