        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4BD80 & 1) == 0 )
  {
    sub_1B863B8(&Method_BasicHelper_GetOrAddComponent_UIWidget___, isDisp);
    sub_1B863B8(&bool___TypeInfo, v8);
    sub_1B863B8(&Method_UnityEngine_GameObject_GetComponent_ParticleSystem___, v9);
    this = (WarBoardControlPlayTalkUiComponent_o *)sub_1B863B8(&UnityEngine_Object_TypeInfo, v10);
    byte_4A4BD80 = 1;
  }
...
LABEL_28:
    ...
    v27 = sub_1B86460(bool___TypeInfo, controlUiObjects->max_length);
    v7->fields.activeStates = (struct System_Boolean_array *)v27;
    sub_1B8635C((CGThumbnailListItem_o *)&v7->fields.activeStates, v27, v28, v29);
    v11 = 1;
  }
...
LABEL_27:
    ...
    BasicHelper__GetOrAddComponent_object_(
      transform,
      (const MethodInfo_2F5B6F4 *)Method_BasicHelper_GetOrAddComponent_UIWidget___);
  ...
  {
    *p_activeStates = 0LL;
    sub_1B8635C((CGThumbnailListItem_o *)&v7->fields.activeStates, 0, (int32_t)method, v4);
  }
}