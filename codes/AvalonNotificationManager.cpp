void __fastcall AvalonNotificationManager___ctor(AvalonNotificationManager_o *this, const MethodInfo *method)
{
  if ( (byte_49FDB0F & 1) == 0 )
  {
    sub_1B64870(&Method_SingletonMonoBehaviour_AvalonNotificationManager___ctor__, method);
    byte_49FDB0F = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_36EE730 *)Method_SingletonMonoBehaviour_AvalonNotificationManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDB0E & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_EventExpeditionMaster___, isFocus);
    sub_1B64870(&Method_DataManager_GetMasterData_EventExpeditionPieceMaster___, v4);
    sub_1B64870(&Method_DataManager_GetMasterData_EventMaster___, v5);
    sub_1B64870(&Method_DataManager_GetMasterData_SpotMaster___, v6);
    sub_1B64870(&Method_DataManager_GetMasterData_UserEventExpeditionMaster___, v7);
    sub_1B64870(&Method_DataManager_GetMasterData_UserEventQuestCooltimeMaster___, v8);
    sub_1B64870(&Method_DataManager_GetMasterData_UserEventServantFatigueMaster___, v9);
    sub_1B64870(&Method_DataManager_GetMaster_EventCooltimeRewardMaster___, v10);
    sub_1B64870(&Method_DataManager_GetMaster_EventDetailMaster___, v11);
    sub_1B64870(&Method_DataManager_GetMaster_EventMaster___, v12);
    sub_1B64870(&Method_DataManager_GetMaster_EventTradeGoodsMaster___, v13);
    sub_1B64870(&Method_DataManager_GetMaster_UserEventCooltimeRewardMaster___, v14);
    sub_1B64870(&Method_DataManager_GetMaster_UserEventTradeMaster___, v15);
    sub_1B64870(&DataManager_TypeInfo, v16);
    sub_1B64870(&Method_DataMasterBase_SpotMaster__SpotEntity__int__GetEntity__, v17);
    sub_1B64870(&Method_DataMasterBase_EventMaster__EventEntity__int__TryGetEntity__, v18);
    sub_1B64870(&Method_DataMasterBase_EventDetailMaster__EventDetailEntity__int__TryGetEntity__, v19);
    sub_1B64870(&Method_DataMasterBase_EventTradeGoodsMaster__EventTradeGoodsEntity__int__TryGetEntity__, v20);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__Dispose__, v21);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__Dispose__, v22);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__Dispose__, v23);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__Dispose__, v24);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__MoveNext__, v25);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__MoveNext__, v26);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__MoveNext__, v27);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__MoveNext__, v28);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__get_Current__, v29);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__get_Current__, v30);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_int__get_Current__, v31);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__get_Current__, v32);
    sub_1B64870(&int_TypeInfo, v33);
    sub_1B64870(&Method_System_Collections_Generic_List_UserEventTradeEntity__GetEnumerator__, v34);
    sub_1B64870(&Method_System_Collections_Generic_List_UserEventExpeditionEntity__GetEnumerator__, v35);
    sub_1B64870(&Method_System_Collections_Generic_List_int__GetEnumerator__, v36);
    sub_1B64870(&Method_System_Collections_Generic_List_UserEventQuestCooltimeEntity__GetEnumerator__, v37);
    sub_1B64870(&Method_System_Collections_Generic_List_int__get_Count__, v38);
    sub_1B64870(&LocalizationManager_TypeInfo, v39);
    sub_1B64870(&NetworkManager_TypeInfo, v40);
    sub_1B64870(&OptionManager_TypeInfo, v41);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v42);
    sub_1B64870(&Method_SingletonTemplate_clsQuestCheck__get_Instance__, v43);
    sub_1B64870(&StringLiteral_16739/*"ap_max"*/, v44);
    sub_1B64870(&StringLiteral_9232/*"NOTIFICATION_COMPLETE_EXPEDITION_MESSAGE"*/, v45);
    sub_1B64870(&StringLiteral_22884/*"rp_max"*/, v46);
    sub_1B64870(&StringLiteral_22015/*"no_expedition_{0}"*/, v47);
    sub_1B64870(&StringLiteral_9233/*"NOTIFICATION_COMPLETE_HARVEST_MESSAGE"*/, v48);
    sub_1B64870(&StringLiteral_9231/*"NOTIFICATION_AP_RECOVER_MESSAGE"*/, v49);
    sub_1B64870(&StringLiteral_9237/*"NOTIFICATION_RP_RECOVER_MESSAGE"*/, v50);
    sub_1B64870(&StringLiteral_9234/*"NOTIFICATION_COMPLETE_OPERATION_MESSAGE"*/, v51);
    sub_1B64870(&StringLiteral_9236/*"NOTIFICATION_FATIGUE_RECOVER_MESSAGE"*/, v52);
    sub_1B64870(&StringLiteral_22018/*"no_operation_{0}"*/, v53);
    sub_1B64870(&StringLiteral_9235/*"NOTIFICATION_COMPLETE_TRADE_MESSAGE"*/, v54);
    sub_1B64870(&StringLiteral_22017/*"no_harvest_{0}"*/, v55);
    sub_1B64870(&StringLiteral_22016/*"no_fatigue"*/, v56);
    byte_49FDB0E = 1;
  }
  entity = 0LL;
  ...
  if ( !byte_49FBCFD )
  {
    sub_1B64870(&NetworkManager_TypeInfo, isFocus);
    byte_49FBCFD = 1;
  }
    ...
    if ( SelfUserGame )
    {
      ...
      if ( OptionManager__GetLocalNotiffication(0LL) )
      {
        ...
        if ( ActAllRecoverTime >= 1 )
        {
          ...
          v62 = LocalizationManager__Get((System_String_o *)StringLiteral_9231/*"NOTIFICATION_AP_RECOVER_MESSAGE"*/, 0LL);
          NotificationPluginScript__SetLocalNotification(v61, v62, (System_String_o *)StringLiteral_16739/*"ap_max"*/, 0LL);
        }
      }
      if ( !OptionManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
      if ( OptionManager__GetRaidNotiffication(0LL) )
      {
        ...
        if ( RpAllRecoverTime >= 1 )
        {
          ...
          if ( EventMaster__IsBPNotification((EventMaster_o *)Instance, v59->fields.rpRecoverAt, 0LL) )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v67 = LocalizationManager__Get((System_String_o *)StringLiteral_9237/*"NOTIFICATION_RP_RECOVER_MESSAGE"*/, 0LL);
      ...
      if ( EventRewardSaveData__GetFatigueNotification(0LL) )
      {
        ...
        if ( FatigueAllRecoverTime >= 1 )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v70 = LocalizationManager__Get((System_String_o *)StringLiteral_9236/*"NOTIFICATION_FATIGUE_RECOVER_MESSAGE"*/, 0LL);
      ...
      Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_EventMaster___);
      if ( !Instance )
        goto LABEL_157;
      ...
      Time_38166012 = NetworkManager__getTime_38166012(v186, 0LL);
      Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_EventDetailMaster___);
      if ( !EnableEntityList )
LABEL_157:
        sub_1B64ACC(Instance, v66);
      ...
      if ( max_length >= 1 )
      {
        ...
        do
        {
          ...
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_EventCooltimeRewardMaster___);
          if ( !Instance )
            goto LABEL_157;
          ...
          if ( SLODWORD(Instance->fields.m_CancellationTokenSource) >= 1 )
          {
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_UserEventCooltimeRewardMaster___);
            ...
            while ( 1 )
            {
              ...
              if ( CurrentLevelEntity )
              {
                ...
                v89 = v88 - Time_38166012;
                if ( v88 - Time_38166012 >= 1 && v88 < v77->fields.endedAt )
                {
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  v90 = LocalizationManager__Get((System_String_o *)StringLiteral_9234/*"NOTIFICATION_COMPLETE_OPERATION_MESSAGE"*/, 0LL);
...
LABEL_69:
      ...
      if ( EventRewardSaveData__GetCooltimeNotification(0LL) )
      {
        ...
        v97 = NetworkManager__getTime_38166012(v187, 0LL);
        Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !Instance )
          goto LABEL_157;
        Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_UserEventQuestCooltimeMaster___);
        if ( !Instance )
          goto LABEL_157;
        ...
        System_Collections_Generic_List_object___GetEnumerator(
          ...
          (const MethodInfo_34B0548 *)Method_System_Collections_Generic_List_UserEventQuestCooltimeEntity__GetEnumerator__);
        v177 = 0;
        v183 = v178;
        while ( 1 )
        {
          v98 = System_Collections_Generic_List_Enumerator_object___MoveNext(
                  &v183,
                  (const MethodInfo_322C38C *)Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__MoveNext__);
          if ( !v98 )
            break;
          ...
          MasterEntity = UserEventQuestCooltimeEntity__GetMasterEntity(
                           ...
                           0LL);
          if ( !MasterEntity )
            sub_1B64ACC(0LL, v103);
          cooltime = MasterEntity->fields.cooltime;
          if ( current->fields.eventId < 1 )
            goto LABEL_92;
          v105 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !v105 )
...
LABEL_92:
          ...
          if ( v112 && (__int64)v113 > 0 )
          {
            ...
            if ( QuestEntity )
            {
              v115 = SingletonTemplate_object___get_Instance((const MethodInfo_36EE738 *)Method_SingletonTemplate_clsQuestCheck__get_Instance__);
              if ( !v115 )
                sub_1B64ACC(0LL, v116);
              if ( clsQuestCheck__CheckQuestPlayableNow((clsQuestCheck_o *)v115, QuestEntity->fields.id, 0LL) )
              {
                v117 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                if ( !v117 )
                  sub_1B64ACC(0LL, v118);
                ...
                if ( v121 )
                {
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  v122 = LocalizationManager__Get((System_String_o *)StringLiteral_9233/*"NOTIFICATION_COMPLETE_HARVEST_MESSAGE"*/, 0LL);
        ...
        System_Collections_Generic_List_Enumerator_object___Dispose(
          &v183,
          (const MethodInfo_322C388 *)Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__Dispose__);
      }
      if ( EventRewardSaveData__GetExpeditionNotification(0LL) )
      {
        ...
        v129 = NetworkManager__getTime_38166012(v188, 0LL);
        Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !Instance )
          goto LABEL_157;
        Instance = (DataManager_o *)DataManager__GetMasterData_object_(
        ...
        System_Collections_Generic_List_object___GetEnumerator(
          (System_Collections_Generic_List_Enumerator_T__o *)&v178,
          (System_Collections_Generic_List_object__o *)Instance,
          (const MethodInfo_34B0548 *)Method_System_Collections_Generic_List_UserEventExpeditionEntity__GetEnumerator__);
        v130 = 0;
        v181 = v178;
        while ( 1 )
        {
          v131 = (Il2CppObject **)System_Collections_Generic_List_Enumerator_object___MoveNext(
                                    &v181,
                                    (const MethodInfo_322C38C *)Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__MoveNext__);
          ...
          if ( (int)namespaze >= 1 )
          {
            ...
            do
            {
              ...
              if ( v138 - v129 >= 1 )
              {
                v140 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                if ( !v140 )
                ...
                if ( v131 )
                {
                  v145 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                  if ( !v145 )
                    sub_1B64ACC(0LL, v146);
                  v147 = DataManager__GetMasterData_object_(
                           (DataManager_o *)v145,
                           (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_EventExpeditionPieceMaster___);
                  if ( !v147 )
                  ...
                  if ( v131 )
                  {
                    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                    v150 = LocalizationManager__Get((System_String_o *)StringLiteral_9232/*"NOTIFICATION_COMPLETE_EXPEDITION_MESSAGE"*/, 0LL);
                    v151 = System_String__Format_61397948(v150, v149[3], v144[3], 0LL);
        ...
        System_Collections_Generic_List_Enumerator_object___Dispose(
          &v181,
          (const MethodInfo_322C388 *)Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__Dispose__);
      }
      if ( EventRewardSaveData__GetTradeNotification(0LL) )
      {
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_UserEventTradeMaster___);
        if ( !Instance )
          goto LABEL_157;
        EntityList = (System_Collections_Generic_List_object__o *)UserEventTradeMaster__GetEntityList(
                                                                    (UserEventTradeMaster_o *)Instance,
                                                                    0LL);
        Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_EventTradeGoodsMaster___);
        if ( !EntityList )
          goto LABEL_157;
        ...
        System_Collections_Generic_List_object___GetEnumerator(
          (System_Collections_Generic_List_Enumerator_T__o *)&v178,
          EntityList,
          (const MethodInfo_34B0548 *)Method_System_Collections_Generic_List_UserEventTradeEntity__GetEnumerator__);
        v180 = v178;
        v160 = 0;
        while ( 1 )
        {
          v161 = System_Collections_Generic_List_Enumerator_object___MoveNext(
                   &v180,
                   (const MethodInfo_322C38C *)Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__MoveNext__);
          if ( !v161 )
            break;
            ...
            do
            {
              ...
              if ( v167 - Time >= 1 )
              {
                ...
                if ( v161 )
                {
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  v169 = LocalizationManager__Get((System_String_o *)StringLiteral_9235/*"NOTIFICATION_COMPLETE_TRADE_MESSAGE"*/, 0LL);
                  if ( !v179 )
                    sub_1B64ACC(v169, v170);
        ...
        System_Collections_Generic_List_Enumerator_object___Dispose(
          &v180,
          (const MethodInfo_322C388 *)Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__Dispose__);
      }
    }
  }
}
