void AvalonNotificationManager___ctor(AvalonNotificationManager_o *this, const MethodInfo *method)
{
  if ( (byte_4CC69C1 & 1) == 0 )
  {
    sub_1C713B0(&Method_SingletonMonoBehaviour_AvalonNotificationManager___ctor__);
    byte_4CC69C1 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3A5F640 *)Method_SingletonMonoBehaviour_AvalonNotificationManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC69C0 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_DataManager_GetMasterData_SpotMaster___);
    sub_1C713B0(&Method_DataManager_GetMasterData_UserEventExpeditionMaster___);
    sub_1C713B0(&Method_DataManager_GetMasterData_UserEventQuestCooltimeMaster___);
    ...
    sub_1C713B0(&Method_DataMasterBase_EventTradeGoodsMaster__EventTradeGoodsEntity__int__TryGetEntity__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_int__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__Dispose__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_int__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__MoveNext__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_int__get_Current__);
    sub_1C713B0(&Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__get_Current__);
    sub_1C713B0(&int_TypeInfo);
    sub_1C713B0(&Method_System_Collections_Generic_List_UserEventTradeEntity__GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_List_UserEventExpeditionEntity__GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_List_int__GetEnumerator__);
    sub_1C713B0(&Method_System_Collections_Generic_List_UserEventQuestCooltimeEntity__GetEnumerator__);
    ...
    sub_1C713B0(&StringLiteral_16827/*"ap_max"*/);
    sub_1C713B0(&StringLiteral_9299/*"NOTIFICATION_COMPLETE_EXPEDITION_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_23276/*"rp_max"*/);
    sub_1C713B0(&StringLiteral_22357/*"no_expedition_{0}"*/);
    sub_1C713B0(&StringLiteral_9298/*"NOTIFICATION_COMPLETE_CRAFT_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_9300/*"NOTIFICATION_COMPLETE_HARVEST_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_9297/*"NOTIFICATION_AP_RECOVER_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_9304/*"NOTIFICATION_RP_RECOVER_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_22356/*"no_craft_{0}"*/);
    sub_1C713B0(&StringLiteral_9301/*"NOTIFICATION_COMPLETE_OPERATION_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_9303/*"NOTIFICATION_FATIGUE_RECOVER_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_22360/*"no_operation_{0}"*/);
    sub_1C713B0(&StringLiteral_9302/*"NOTIFICATION_COMPLETE_TRADE_MESSAGE"*/);
    sub_1C713B0(&StringLiteral_22359/*"no_harvest_{0}"*/);
    sub_1C713B0(&StringLiteral_22358/*"no_fatigue"*/);
    byte_4CC69C0 = 1;
  }
  entity = 0;
    ...
    if ( SelfUserGame )
    {
      ...
      if ( OptionManager__GetLocalNotiffication(0) )
      {
        ...
        if ( ActAllRecoverTime >= 1 )
        {
          ...
          v9 = LocalizationManager__Get((System_String_o *)StringLiteral_9297/*"NOTIFICATION_AP_RECOVER_MESSAGE"*/, 0);
          NotificationPluginScript__SetLocalNotification(v8, v9, (System_String_o *)StringLiteral_16827/*"ap_max"*/, 0);
        }
      }
      if ( !OptionManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(OptionManager_TypeInfo);
      if ( OptionManager__GetRaidNotiffication(0) )
      {
        ...
        if ( RpAllRecoverTime >= 1 )
        {
          ...
          if ( EventMaster__IsBPNotification((EventMaster_o *)Instance, v6->fields.rpRecoverAt, 0) )
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v14 = LocalizationManager__Get((System_String_o *)StringLiteral_9304/*"NOTIFICATION_RP_RECOVER_MESSAGE"*/, 0);
            NotificationPluginScript__SetLocalNotification(v11, v14, (System_String_o *)StringLiteral_23276/*"rp_max"*/, 0);
          }
        }
      }
      if ( EventRewardSaveData__GetFatigueNotification(0) )
      {
        ...
        if ( FatigueAllRecoverTime >= 1 )
        {
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v17 = LocalizationManager__Get((System_String_o *)StringLiteral_9303/*"NOTIFICATION_FATIGUE_RECOVER_MESSAGE"*/, 0);
          NotificationPluginScript__SetLocalNotification(v16, v17, (System_String_o *)StringLiteral_22358/*"no_fatigue"*/, 0);
        }
      }
      if ( !DataManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
      Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventMaster___);
      if ( !Instance )
        goto LABEL_186;
      ...
      Time_41642924 = NetworkManager__getTime_41642924(v19, 0);
      Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventDetailMaster___);
      if ( !EnableEntityList )
LABEL_186:
      ...
      if ( max_length >= 1 )
      {
        ...
        do
        {
          ...
          if ( !DataManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
          Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventCooltimeRewardMaster___);
          if ( !Instance )
            goto LABEL_186;
          ...
          if ( SLODWORD(Instance->fields.m_CancellationTokenSource) >= 1 )
          {
            if ( !DataManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
            Master_object = DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_UserEventCooltimeRewardMaster___);
            ...
            while ( 1 )
            {
              ...
              if ( CurrentLevelEntity )
              {
                ...
                v37 = v36 - Time_41642924;
                if ( v36 - Time_41642924 >= 1 && v36 < v25->fields.endedAt )
                {
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  v38 = LocalizationManager__Get((System_String_o *)StringLiteral_9301/*"NOTIFICATION_COMPLETE_OPERATION_MESSAGE"*/, 0);
                  ...
                  v41 = System_String__Format((System_String_o *)StringLiteral_22360/*"no_operation_{0}"*/, v40, 0);
...
LABEL_69:
      ...
      if ( EventRewardSaveData__GetCooltimeNotification(0) )
      {
        ...
        v43 = NetworkManager__getTime_41642924(v42, 0);
        Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !Instance )
          goto LABEL_186;
        Instance = (DataManager_o *)DataManager__GetMasterData_object_(
                                      Instance,
                                      (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_UserEventQuestCooltimeMaster___);
        if ( !Instance )
          goto LABEL_186;
        ...
        System_Collections_Generic_List_object___GetEnumerator(
          ...
          (const MethodInfo_3811210 *)Method_System_Collections_Generic_List_UserEventQuestCooltimeEntity__GetEnumerator__);
        v132 = 0;
        v139 = v133;
        while ( 1 )
        {
          v44 = System_Collections_Generic_List_Enumerator_object___MoveNext(
                  &v139,
                  (const MethodInfo_35962C8 *)Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__MoveNext__);
          if ( !v44 )
            break;
          ...
          if ( current->fields.eventId < 1 )
            goto LABEL_92;
          v51 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !v51 )
            sub_1C71608(0, v52);
...
LABEL_92:
          ...
          if ( v58 && (__int64)v59 > 0 )
          {
            ...
            if ( QuestEntity )
            {
              v61 = SingletonTemplate_object___get_Instance((const MethodInfo_3A5F648 *)Method_SingletonTemplate_clsQuestCheck__get_Instance__);
              if ( !v61 )
                sub_1C71608(0, v62);
              if ( clsQuestCheck__CheckQuestPlayableNow((clsQuestCheck_o *)v61, QuestEntity->fields.id, 0, 0) )
              {
                v63 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                if ( !v63 )
                  sub_1C71608(0, v64);
                v65 = DataManager__GetMasterData_object_(
                        (DataManager_o *)v63,
                        (const MethodInfo_314B10C *)Method_DataManager_GetMasterData_SpotMaster___);
                if ( !v65 )
                  sub_1C71608(0, v66);
                ...
                if ( v67 )
                {
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  v68 = LocalizationManager__Get((System_String_o *)StringLiteral_9300/*"NOTIFICATION_COMPLETE_HARVEST_MESSAGE"*/, 0);
                  ...
                  v71 = System_String__Format((System_String_o *)StringLiteral_22359/*"no_harvest_{0}"*/, v70, 0);
        ...
        System_Collections_Generic_List_Enumerator_object___Dispose(
          &v139,
          (const MethodInfo_35962C4 *)Method_System_Collections_Generic_List_Enumerator_UserEventQuestCooltimeEntity__Dispose__);
      }
      if ( EventRewardSaveData__GetExpeditionNotification(0) )
      {
        ...
        v73 = NetworkManager__getTime_41642924(v72, 0);
        Instance = (DataManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( !Instance )
          goto LABEL_186;
        Instance = (DataManager_o *)DataManager__GetMasterData_object_(
        ...
        System_Collections_Generic_List_object___GetEnumerator(
          (System_Collections_Generic_List_Enumerator_T__o *)&v133,
          (System_Collections_Generic_List_object__o *)Instance,
          (const MethodInfo_3811210 *)Method_System_Collections_Generic_List_UserEventExpeditionEntity__GetEnumerator__);
        v74 = 0;
        v137 = v133;
        while ( 1 )
        {
          v75 = (Il2CppObject **)System_Collections_Generic_List_Enumerator_object___MoveNext(
                                   &v137,
                                   (const MethodInfo_35962C8 *)Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__MoveNext__);
          ...
          if ( (int)namespaze >= 1 )
          {
            ...
            do
            {
              ...
              if ( v82 - v73 >= 1 )
              {
                v84 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                if ( !v84 )
                  sub_1C71608(0, v85);
                ...
                if ( v75 )
                {
                  v89 = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
                  if ( !v89 )
                    sub_1C71608(0, v90);
                  ...
                  if ( v75 )
                  {
                    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                    v94 = LocalizationManager__Get((System_String_o *)StringLiteral_9299/*"NOTIFICATION_COMPLETE_EXPEDITION_MESSAGE"*/, 0);
                    v95 = System_String__Format_64073032(v94, v93[3], v88[3], 0);
                    LODWORD(v133.fields._list) = v74;
                    v96 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v133);
                    v97 = System_String__Format((System_String_o *)StringLiteral_22357/*"no_expedition_{0}"*/, v96, 0);
        ...
        System_Collections_Generic_List_Enumerator_object___Dispose(
          &v137,
          (const MethodInfo_35962C4 *)Method_System_Collections_Generic_List_Enumerator_UserEventExpeditionEntity__Dispose__);
      }
      if ( EventRewardSaveData__GetTradeNotification(0) )
      {
        ...
        if ( !DataManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
        Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_UserEventTradeMaster___);
        if ( !Instance )
          goto LABEL_186;
        EntityList = (System_Collections_Generic_List_object__o *)UserEventTradeMaster__GetEntityList(
                                                                    (UserEventTradeMaster_o *)Instance,
                                                                    0);
        Instance = (DataManager_o *)DataManager__GetMaster_object_((const MethodInfo_314B0B8 *)Method_DataManager_GetMaster_EventTradeGoodsMaster___);
        if ( !EntityList )
          goto LABEL_186;
        ...
        System_Collections_Generic_List_object___GetEnumerator(
          (System_Collections_Generic_List_Enumerator_T__o *)&v133,
          EntityList,
          (const MethodInfo_3811210 *)Method_System_Collections_Generic_List_UserEventTradeEntity__GetEnumerator__);
        v136 = v133;
        v101 = 0;
        while ( 1 )
        {
          v102 = System_Collections_Generic_List_Enumerator_object___MoveNext(
                   &v136,
                   (const MethodInfo_35962C8 *)Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__MoveNext__);
          if ( !v102 )
            break;
          if ( !v136.fields._current )
            sub_1C71608(v102, v103);
            ...
            do
            {
              ...
              if ( v108 - Time >= 1 )
              {
                ...
                v102 = DataMasterBase_object__object__int___TryGetEntity(
                         ...
                         &v135,
                         *(_DWORD *)(v107 + 20),
                         (const MethodInfo_3408ECC *)Method_DataMasterBase_EventTradeGoodsMaster__EventTradeGoodsEntity__int__TryGetEntity__);
                if ( v102 )
                {
                  if ( !v135 )
                    sub_1C71608(v102, v103);
                  if ( !LODWORD(v135[1].monitor) )
                  {
                    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                    v110 = LocalizationManager__Get((System_String_o *)StringLiteral_9302/*"NOTIFICATION_COMPLETE_TRADE_MESSAGE"*/, 0);
                    if ( !v135 )
                    ...
                    v114 = System_String__Format((System_String_o *)StringLiteral_22357/*"no_expedition_{0}"*/, v113, 0);
        ...
        System_Collections_Generic_List_Enumerator_object___Dispose(
          &v136,
          (const MethodInfo_35962C4 *)Method_System_Collections_Generic_List_Enumerator_UserEventTradeEntity__Dispose__);
      }
              ...
              if ( v125 - v115 >= 1 )
              {
                ...
                if ( v119 )
                {
                  ...
                  if ( LODWORD(v134[1].monitor) == 1 )
                  {
                    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                    v127 = LocalizationManager__Get((System_String_o *)StringLiteral_9298/*"NOTIFICATION_COMPLETE_CRAFT_MESSAGE"*/, 0);
                    if ( !v134 )
                    ...
                    v131 = System_String__Format((System_String_o *)StringLiteral_22356/*"no_craft_{0}"*/, v130, 0);
