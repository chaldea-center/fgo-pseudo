        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC87 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Count__, servantData);
    this = (WarBoardUserServantData_o *)sub_1BC3008(
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v4->fields.buffData, (int32_t)buffData, v7, v8);
  v11 = v4->fields.buffData;
  if ( v11 )
  {
    SaveData = BattleBuffData__getSaveData(v11, 0LL);
    v4->fields.buffDataSave = SaveData;
    sub_1BC2FAC((CGThumbnailListItem_o *)&v4->fields.buffDataSave, (int32_t)SaveData, v13, v14);
  }
...
LABEL_16:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&v4->fields.changeModelData, (int32_t)ChangeModelData_k__BackingField, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC8A & 1) == 0 )
  {
    ...
    sub_1BC3008(&Method_JsonManager_Deserialize_WarBoardUserServantData___, v3);
  ...
  v5 = JsonManager__Deserialize_object_(
         (Il2CppObject *)json,
         (const MethodInfo_306D7CC *)Method_JsonManager_Deserialize_WarBoardUserServantData___);
  if ( v5 )
  {
    v6 = (BattleBuffData_o *)sub_1BC3254(BattleBuffData_TypeInfo);
    BattleBuffData___ctor(v6, 0LL);
    p_monitor = (BattleBuffData_o **)&v5[42].monitor;
    v5[42].monitor = v6;
    sub_1BC2FAC((CGThumbnailListItem_o *)&v5[42].monitor, (int32_t)v6, v8, v9);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFFC88 & 1) == 0 )
  {
    sub_1BC3008(&int___TypeInfo, servantData);
    sub_1BC3008(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Count__, v5);
    sub_1BC3008(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Item__, v6);
    this = (WarBoardUserServantData_o *)sub_1BC3008(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__, v7);
    byte_4AFFC88 = 1;
  }
  if ( !servantData )
    goto LABEL_31;
    ...
    if ( ((unsigned __int8)this & 1) == 0 )
    {
      ...
      if ( v11 < max_length )
      {
        if ( v11 >= (unsigned int)max_length )
          sub_1BC326C(this, servantData, v8);
  ...
  if ( servantData->fields.transformIndex != transformIndex )
  {
    ...
    this = (WarBoardUserServantData_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38DFD48 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( this )
    {
...
LABEL_30:
  ...
  v15 = (System_Int32_array *)sub_1BC30B0(int___TypeInfo, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.squareIndex = *(_QWORD *)&saveData->fields.squareIndex;
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.buffDataSave, (int32_t)buffSave, (int32_t)method, v3);
...
System_String_o *__fastcall WarBoardUserServantData__ToJson(WarBoardUserServantData_o *this, const MethodInfo *method)
{
  ...
  if ( buffData )
  {
    ...
    sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.buffDataSave, (int32_t)SaveData, v5, v6);
  }
  if ( !JsonManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(JsonManager_TypeInfo);
