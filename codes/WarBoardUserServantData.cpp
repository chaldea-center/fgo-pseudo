        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BDD & 1) == 0 )
  {
    ...
    this = (WarBoardUserServantData_o *)sub_B52984(&Method_System_Collections_Generic_List_BattleSkillInfoData__get_Item__);
    byte_42B0BDD = 1;
  }
  if ( !servantData )
    goto LABEL_21;
  ...
  sub_B52920((BattleServantConfConponent_o *)&v4->fields.buffData, buffData, v6, v7, v8, v9, v10, v11);
  ...
  if ( this )
  {
    ...
    sub_B52920((BattleServantConfConponent_o *)&v4->fields.buffDataSave, SaveData, v13, v14, v15, v16, v17, v18);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BE0 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_JsonManager_Deserialize_WarBoardUserServantData___);
  ...
  v3 = JsonManager__Deserialize_TerminalPramsManager_ClearData_(
         (Il2CppObject *)json,
         (const MethodInfo_1F69038 *)Method_JsonManager_Deserialize_WarBoardUserServantData___);
  if ( v3 )
  {
    ...
    sub_B52920((BattleServantConfConponent_o *)&v3[3], (System_Int32_array **)v4, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0BDE & 1) == 0 )
  {
    ...
    this = (WarBoardUserServantData_o *)sub_B52984(&Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    byte_42B0BDE = 1;
  }
  if ( !servantData )
    goto LABEL_35;
  ...
  if ( servantData->fields.transformIndex != transformIndex )
  {
    ...
    this = (WarBoardUserServantData_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_WarBoardManager__get_Instance__);
    if ( this )
    {
...
LABEL_34:
  ...
  v17 = (System_Int32_array *)sub_B5299C(int___TypeInfo, 0LL);
