void __fastcall ShopRootConstants___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B3376C & 1) == 0 )
  {
    sub_1BD3458(&ShopRootConstants_TypeInfo, v1);
    sub_1BD3458(&StringLiteral_3047/*"BGM_EVENT_128"*/, v8);
    sub_1BD3458(&StringLiteral_3163/*"Back/back{0}"*/, v9);
    byte_4B3376C = 1;
  }
  ...
  *(_QWORD *)&static_fields->DEFAULT_FIGURE_ID = 500900LL;
  v11 = StringLiteral_3163/*"Back/back{0}"*/;
  static_fields->BG_ROOT = (struct System_String_o *)StringLiteral_3163/*"Back/back{0}"*/;
  sub_1BD33FC((PartyOrganizationUtility_o *)&static_fields->BG_ROOT, v11, v2, v3, v4, v5, v6, v7);
  v12 = ShopRootConstants_TypeInfo;
  v13 = ShopRootConstants_TypeInfo->static_fields;
  v13->DISP_RECT = (struct UnityEngine_Rect_o)xmmword_BD9060;
  ...
  *(_QWORD *)&v18->SCOPE_HELP_ANCHOR.fields.x = 0x4204000000000000LL;
  ...
  v20 = StringLiteral_3047/*"BGM_EVENT_128"*/;
  v19->SVT_COSTUME_BGM_NAME = (struct System_String_o *)StringLiteral_3047/*"BGM_EVENT_128"*/;
  sub_1BD33FC((PartyOrganizationUtility_o *)&v19->SVT_COSTUME_BGM_NAME, v20, v21, v22, v23, v24, v25, v26);
}
...
System_String_o *__fastcall ShopRootConstants__GetHelpSaveKey(int32_t state, const MethodInfo *method)
{
  ...
  if ( (byte_4B33768 & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_13043/*"SpecialItemHelp"*/, method);
    sub_1BD3458(&StringLiteral_12921/*"Shop15Help"*/, v3);
    sub_1BD3458(&StringLiteral_2403/*"AnonymousHelp"*/, v4);
    sub_1BD3458(&StringLiteral_1/*""*/, v5);
    sub_1BD3458(&StringLiteral_11304/*"RarePriHelp"*/, v6);
    byte_4B33768 = 1;
  }
  if ( state > 5 )
  {
    ...
    if ( state == 20 )
    {
      v7 = &StringLiteral_12921/*"Shop15Help"*/;
      return (System_String_o *)*v7;
    }
LABEL_10:
  ...
  if ( state == 3 )
  {
    v7 = &StringLiteral_11304/*"RarePriHelp"*/;
    return (System_String_o *)*v7;
  }
  if ( state != 5 )
    goto LABEL_10;
  v7 = &StringLiteral_13043/*"SpecialItemHelp"*/;
  return (System_String_o *)*v7;
}
...
bool __fastcall ShopRootConstants__IsSvtCostumeShopOpen(const MethodInfo *method)
{
  ...
  if ( (byte_4B3376B & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_12134/*"SHOP04_SHOP_STATE"*/, v1);
    byte_4B3376B = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_12134/*"SHOP04_SHOP_STATE"*/, 0LL) == 0;
}