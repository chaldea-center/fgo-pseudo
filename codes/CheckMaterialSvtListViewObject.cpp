...
void __fastcall CheckMaterialSvtListViewObject__Awake(CheckMaterialSvtListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B05F56 & 1) == 0 )
  {
    sub_1BC3008(&Method_UnityEngine_GameObject_GetComponent_CheckMaterialSvtListViewItemDraw___, method);
    byte_4B05F56 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_CheckMaterialSvtListViewItemDraw___);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    if ( !DragObject
      || (Component_object = UnityEngine_GameObject__GetComponent_object_(
                               ...
                               (const MethodInfo_3055998 *)Method_UnityEngine_GameObject_GetComponent_CheckMaterialSvtListViewObject___)) == 0LL )
    {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05F58 & 1) == 0 )
  {
    sub_1BC3008(&CheckMaterialSvtListViewItem_TypeInfo, method);
    byte_4B05F58 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05F5C & 1) == 0 )
  {
    sub_1BC3008(&CheckMaterialSvtListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B05F5C = 1;
  }
  linkItem = this->fields.linkItem;
...
LABEL_7:
  ...
  sub_1BC2FAC((CGThumbnailListItem_o *)&this->fields.onMoveEnd, (int32_t)onMoveEnd, v13, v14);
  v15 = CheckMaterialSvtListViewItemDraw__GetDispMode(v5, 0LL);
  if ( v5 == 3 )
    v17 = 3;
  else
    v17 = 0;
  ...
  if ( !state || dispMode != v15 )
    CheckMaterialSvtListViewObject__SetupDisp(this, v16);
  CheckMaterialSvtListViewObject__CallOnMoveEnd(this, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&CheckMaterialSvtListViewItem_TypeInfo, method);
    sub_1BC3008(&CheckMaterialSvtListViewManager_TypeInfo, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05F5E & 1) == 0 )
  {
    sub_1BC3008(&CheckMaterialSvtListViewManager_TypeInfo, method);
    this = (CheckMaterialSvtListViewObject_o *)sub_1BC3008(&StringLiteral_9780/*"OnClickSelectListView"*/, v3);
    byte_4B05F5E = 1;
  }
  if ( v2->fields.linkItem )
  {
    ...
    UnityEngine_Component__SendMessage(manager, (System_String_o *)StringLiteral_9780/*"OnClickSelectListView"*/, v6, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&CheckMaterialSvtListViewManager_TypeInfo, method);
    this = (CheckMaterialSvtListViewObject_o *)sub_1BC3008(&UnityEngine_Object_TypeInfo, v3);
    byte_4B05F60 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05F61 & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_3994/*"CancelDragEnd"*/, v4);
    byte_4B05F61 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B05F59 & 1) == 0 )
  {
    sub_1BC3008(&CheckMaterialSvtListViewItem_TypeInfo, isInput);
    sub_1BC3008(&CheckMaterialSvtListViewManager_TypeInfo, v5);
    ...
    else
    {
        ...
        && (CheckMaterialSvtListViewItem_c *)linkItem->klass->_2.typeHierarchy[methodPtr_low - 1] == CheckMaterialSvtListViewItem_TypeInfo )
      {
        if ( !manager || (manager = this->fields.itemDraw) == 0LL )
          sub_1BC3264(manager, linkItem);
        CheckMaterialSvtListViewItemDraw__SetInput(manager, (CheckMaterialSvtListViewItem_o *)linkItem, 1, 0LL);
        return;
      }
    }
    sub_1BC3524(linkItem);
    CheckMaterialSvtListViewObject__IsCanDrag(v12, v13);
  }
}
...
void __fastcall CheckMaterialSvtListViewObject__SetItem_47495976(
        CheckMaterialSvtListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&CheckMaterialSvtListViewItem_TypeInfo, method);
    sub_1BC3008(&CheckMaterialSvtListViewManager_TypeInfo, v4);
