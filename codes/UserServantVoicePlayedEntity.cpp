        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v8.fields.fakeValue = v3;
  ...
  v7 = v8;
  v4 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_47559652(&v7, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC89E0 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_HashSet_int__Contains__, *(_QWORD *)&flagNum);
  ...
  if ( voicePlayed && voicePlayed[1].monitor )
  {
    ...
    sub_1C1AB78(p_voicePlayedHash, (int64_t)v11, v12, v13, v14, v15, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC89E1 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Collections_Generic_HashSet_int__Add__, *(_QWORD *)&flagNum);
    sub_1C1ABD4(&Method_System_Collections_Generic_HashSet_int___ctor___77473576, v5);
    sub_1C1ABD4(&System_Collections_Generic_HashSet_int__TypeInfo, v6);
    byte_4BC89E1 = 1;
  }
  ...
  if ( !voicePlayedHash )
  {
    ...
    sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.voicePlayedHash, (int64_t)v9, v10, v11, v12, v13, v14, v15);
    voicePlayedHash = this->fields.voicePlayedHash;
    if ( !voicePlayedHash )
      sub_1C1AE30(0LL, v16);
  }
