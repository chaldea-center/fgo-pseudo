        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&v8.fields.fakeValue = v3;
  ...
  v7 = v8;
  v4 = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_48934420(&v7, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( voicePlayed && voicePlayed[1].monitor )
  {
    ...
    sub_1C36FFC(p_voicePlayedHash, (int32_t)v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( !voicePlayedHash )
  {
    ...
    sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.voicePlayedHash, (int32_t)v7, v8, v9);
    voicePlayedHash = this->fields.voicePlayedHash;
    if ( !voicePlayedHash )
      sub_1C372B4(0);
  }
