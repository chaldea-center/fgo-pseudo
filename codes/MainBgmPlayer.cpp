...
BgmPlayArgs_o *__fastcall MainBgmPlayer__ExportPlayArgs(MainBgmPlayer_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FE19D & 1) == 0 )
  {
    sub_1B64A00(&MainBgmPlayArgs_TypeInfo, method);
    sub_1B64A00(&Method_System_Nullable_float___ctor__, v3);
    byte_49FE19D = 1;
  }
  ...
  volume = 0LL;
  System_Nullable_float____ctor(p_volume, bgmVolume, (const MethodInfo_35D28A0 *)Method_System_Nullable_float___ctor__);
  PlayTime = BgmPlayerBase__get_PlayTime((BgmPlayerBase_o *)this, v6);
  v8 = (BgmPlayArgs_o *)sub_1B64C4C(MainBgmPlayArgs_TypeInfo);
  v14 = volume;
  v9 = v8;
