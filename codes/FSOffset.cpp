...
void __fastcall FSOffset__AddOffsetX(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.enableAddOffsetX )
  {
    ...
    FSOffset__AddOffsetX_42337552(this, v6, v5);
  }
}


// local variable allocation has failed, the output may be wrong!
void __fastcall FSOffset__AddOffsetX_42337552(FSOffset_o *this, float ratio, const MethodInfo *method)
{
  float subMarginX; // s9
  FSUtility_c *v6; // x0
...
void __fastcall FSOffset__OnEnable(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC92A3 & 1) == 0 )
  {
    sub_1C1ABD4(&CommonUI_TypeInfo, method);
    byte_4BC92A3 = 1;
  }
