...
void __fastcall FSOffset__AddOffsetX(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( LOBYTE(this->fields.enableAddOffsetXFouseScopeRatio) )
  {
    ...
    FSOffset__AddOffsetX_26034536(this, v6, v5);
  }
}


// local variable allocation has failed, the output may be wrong!
void __fastcall FSOffset__AddOffsetX_26034536(FSOffset_o *this, float ratio, const MethodInfo *method)
{
...
void __fastcall FSOffset__OnEnable(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4215441 & 1) == 0 )
  {
    sub_B0D8A4(&CommonUI_TypeInfo, method);
    byte_4215441 = 1;
  }
...
void __fastcall FSOffset__SetOffset(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( LOBYTE(this->fields.vistaScale.fields.x) )
  {
    ...
    if ( v10 )
    {
      if ( transform )
      {
        v11 = this->fields.vistaScale.fields.y;
        v12 = this->fields.vistaScale.fields.z;
        v13 = this->fields.scopeScale.fields.x;
LABEL_23:
    ...
    {
      v11 = this->fields.scopeScale.fields.y;
      v12 = this->fields.scopeScale.fields.z;
      v13 = *(float *)&this->fields.enableAddOffsetX;
      goto LABEL_23;
    }
LABEL_24:
    sub_B0D97C(transform);
