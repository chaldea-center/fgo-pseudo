...
void __fastcall FSOffset__AddOffsetX(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.enableAddOffsetX )
  {
    ...
    FSOffset__AddOffsetX_40691780(this, v6, v5);
  }
}


// local variable allocation has failed, the output may be wrong!
void __fastcall FSOffset__AddOffsetX_40691780(FSOffset_o *this, float ratio, const MethodInfo *method)
{
  float subMarginX; // s9
  FSUtility_c *v6; // x0
  ...
  *(UnityEngine_Vector3_o *)&v12 = UnityEngine_Transform__get_localPosition(transform, 0LL);
...
void __fastcall FSOffset__OnEnable(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDA69 & 1) == 0 )
  {
    sub_1B640C8(&CommonUI_TypeInfo, method);
    byte_49FDA69 = 1;
  }
...
void __fastcall FSOffset__SetOffset(FSOffset_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.enablePosition )
  {
    ...
    UnityEngine_Transform__set_localPosition(transform, v14, 0LL);
  }
