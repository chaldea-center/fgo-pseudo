...
void EventInfoSkillDialog__OnClose(EventInfoSkillDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C397CD & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_EventInfoSkillDialog_OnClose__);
    sub_1C32C20(&Method_EventInfoSkillDialog__OnClose_b__10_0__);
  ...
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillDialog_OnClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C32C38(Method_EventInfoSkillDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&Method_EventInfoSkillDialog__Open_b__8_0__);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C397CB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C397CC & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_GameObjectHelper_Instantiate_EventInfoSkillDetailComponent___);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C397CC = 1;
  }
      ...
      while ( 1 )
      {
        ...
        if ( ((unsigned __int8)Master_object & 1) != 0 )
        {
          v13 = GameObjectHelper__Instantiate_object_(
                  ...
                  0,
                  (const MethodInfo_3136594 *)Method_GameObjectHelper_Instantiate_EventInfoSkillDetailComponent___);
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
