...
void EventInfoSkillDialog__OnClose(EventInfoSkillDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E5B2 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_EventInfoSkillDialog_OnClose__);
    sub_1C94098(&Method_EventInfoSkillDialog__OnClose_b__10_0__);
  ...
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillDialog_OnClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C940B0(Method_EventInfoSkillDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&Method_EventInfoSkillDialog__Open_b__8_0__);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2E5B0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E5B1 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_GameObjectHelper_Instantiate_EventInfoSkillDetailComponent___);
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    byte_4D2E5B1 = 1;
  }
  skillParent = this->fields.skillParent;
  if ( skillParent )
    TransformHelper__DestroyChildren(skillParent, 0, 0);
      ...
      while ( 1 )
      {
        ...
        if ( ((unsigned __int8)Master_object & 1) != 0 )
        {
          v14 = GameObjectHelper__Instantiate_object_(
                  ...
                  0,
                  (const MethodInfo_31F63B4 *)Method_GameObjectHelper_Instantiate_EventInfoSkillDetailComponent___);
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
