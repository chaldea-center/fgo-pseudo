...
void EventInfoSkillDialog__OnClose(EventInfoSkillDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C58B93 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_EventInfoSkillDialog_OnClose__);
    sub_1C3E564(&Method_EventInfoSkillDialog__OnClose_b__10_0__);
  ...
  if ( this->fields.canTap )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoSkillDialog_OnClose__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C3E57C(Method_EventInfoSkillDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_EventInfoSkillDialog__Open_b__8_0__);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C58B91 = 1;
  }
  this->fields.onClosed = inOnClosed;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.onClosed, (int32_t)inOnClosed, (int32_t)inOnClosed, method);
  closeBtn = (UnityEngine_Object_o *)this->fields.closeBtn;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(closeBtn, 0, 0) )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C58B92 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_GameObjectHelper_Instantiate_EventInfoSkillDetailComponent___);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C58B92 = 1;
  }
      ...
      while ( 1 )
      {
        ...
        if ( ((unsigned __int8)Master_object & 1) != 0 )
        {
          v14 = GameObjectHelper__Instantiate_object_(
                  ...
                  0,
                  (const MethodInfo_3152CF0 *)Method_GameObjectHelper_Instantiate_EventInfoSkillDetailComponent___);
          if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
void EventInfoSkillDialog___OnClose_b__10_0(EventInfoSkillDialog_o *this, const MethodInfo *method)
{
  ...
  p_onClosed->klass = 0;
  sub_1C3E508(p_onClosed, 0, v6, v7);
}
