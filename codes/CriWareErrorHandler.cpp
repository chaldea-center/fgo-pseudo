...
void __fastcall CriWareErrorHandler__Awake(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B316D5 & 1) == 0 )
  {
    sub_1BD3458(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1BD3458(&CriWareErrorHandler_TypeInfo, v3);
    sub_1BD3458(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v4);
    this = (CriWareErrorHandler_o *)sub_1BD3458(&UnityEngine_Object_TypeInfo, v5);
    byte_4B316D5 = 1;
  }
  ...
  if ( initializationCount )
  {
    ...
    UnityEngine_Object__Destroy_70278272((UnityEngine_Object_o *)v2, 0LL);
  }
  else
  {
    ...
    v11 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1BD36A4(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__CRIWARE063A11A2(uint32_t length, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_4B316E0;
  if ( !qword_4B316E0 )
  {
    ...
    v4[4] = 0x200000000LL;
    v6 = 0;
    v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))sub_1BD3A34(v4);
    qword_4B316E0 = (__int64)v2;
  }
  v2(length, method);
}
...
void __fastcall CriWareErrorHandler__CRIWARE3BCC893C(const MethodInfo *method)
{
  ...
  if ( !qword_4B316F0 )
  {
    ...
    v2[4] = 0x200000000LL;
    v4 = 0;
    v1 = (void (*)(void))sub_1BD3A34(v2);
    qword_4B316F0 = (__int64)v1;
  }
  v1();
}
...
void __fastcall CriWareErrorHandler__CRIWARE527DA518(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4B31710;
  if ( !qword_4B31710 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
    ...
    v4[4] = 0x200000000LL;
    v6 = 0;
    v2 = (void (__fastcall *)(bool, const MethodInfo *))sub_1BD3A34(v4);
    qword_4B31710 = (__int64)v2;
  }
  v2(sw, method);
}
...
intptr_t __fastcall CriWareErrorHandler__CRIWARE841C0338(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_4B31708;
  if ( !qword_4B31708 )
  {
    v4 = 0;
    ...
    v3[4] = 0x200000000LL;
    v5 = 0;
    method = (const MethodInfo *)sub_1BD3A34(v3);
    v1 = method;
    qword_4B31708 = (__int64)method;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_4B31718 )
  {
    ...
    v7[4] = 0x200000000LL;
    v9 = 0;
    qword_4B31718 = (__int64 (__fastcall *)(_QWORD))sub_1BD3A34(v7);
  }
  v6 = sub_1BD3A2C(callback, method, v2, v3, v4);
  qword_4B31718(v6);
}
...
void __fastcall CriWareErrorHandler__CRIWAREDBC6F415(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4B316F8;
  if ( !qword_4B316F8 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
...
void __fastcall CriWareErrorHandler__DequeueErrorMessages(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B316D8 & 1) == 0 )
  {
    ...
    this = (CriWareErrorHandler_o *)sub_1BD3458(&string_TypeInfo, v2);
    byte_4B316D8 = 1;
  }
...
void __fastcall CriWareErrorHandler__HandleMessage(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4B316D9 & 1) == 0 )
  {
    sub_1BD3458(&CriWareErrorHandler_TypeInfo, method);
    byte_4B316D9 = 1;
  }
  if ( errmsg )
  {
...
void __fastcall CriWareErrorHandler__OnEnable(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1BD3458(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v3);
    byte_4B316D6 = 1;
  }
  CriMonoBehaviour__OnEnable((CriMonoBehaviour_o *)this, method);
  v4 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1BD36A4(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__OutputDefaultLog(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4B316DA & 1) == 0 )
  {
    sub_1BD3458(&StringLiteral_15565/*"W"*/, method);
    errmsg = (System_String_o *)sub_1BD3458(&StringLiteral_5512/*"E"*/, v3);
    byte_4B316DA = 1;
  }
  if ( !v2 )
    sub_1BD36B4(errmsg, method);
  if ( !System_String__StartsWith(v2, (System_String_o *)StringLiteral_5512/*"E"*/, 0LL) )
    System_String__StartsWith(v2, (System_String_o *)StringLiteral_15565/*"W"*/, 0LL);
}
...
void __fastcall CriWareErrorHandler__add_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4B316D3 & 1) == 0 )
  {
    sub_1BD3458(&CriWareErrorHandler_Callback_TypeInfo, method);
    sub_1BD3458(&CriWareErrorHandler_TypeInfo, v3);
    byte_4B316D3 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v6 = sub_1C0E948(&CriWareErrorHandler_TypeInfo->static_fields->OnCallback, v5, OnCallback);
    v7 = OnCallback == (System_Delegate_o *)v6;
    OnCallback = (System_Delegate_o *)v6;
    if ( v7 )
      return;
  }
  v8 = (CriWareErrorHandler_Callback_o *)sub_1BD3974(v5);
...
System_String_o *__fastcall CriWareErrorHandler__get_errorMessage(const MethodInfo *method)
{
  ...
  if ( (byte_4B316D1 & 1) == 0 )
  {
    sub_1BD3458(&CriWareErrorHandler_TypeInfo, v1);
    byte_4B316D1 = 1;
  }
...
void __fastcall CriWareErrorHandler__remove_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  v8 = (CriWareErrorHandler_o *)sub_1BD3974(v5);
...
void __fastcall CriWareErrorHandler__set_errorMessage(System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1BD33FC(CriWareErrorHandler_TypeInfo->static_fields);
}
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0BC20;
}
...
LABEL_8:
  ...
  this->fields.original_method_info = v10;
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0BCC4;
}
