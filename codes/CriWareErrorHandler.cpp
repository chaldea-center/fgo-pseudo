...
void CriWareErrorHandler__Awake(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29EA5 & 1) == 0 )
  {
    sub_1C93AD4(&Method_CriWareErrorHandler_ErrorCallbackFromNative__);
    sub_1C93AD4(&CriWareErrorHandler_TypeInfo);
    sub_1C93AD4(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
    this = (CriWareErrorHandler_o *)sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    byte_4D29EA5 = 1;
  }
  ...
  if ( initializationCount )
  {
    ...
    UnityEngine_Object__Destroy_72119908((UnityEngine_Object_o *)v2, 0);
  }
  else
  {
    ...
    v8 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1C93D20(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
intptr_t CriWareErrorHandler__CRIWARE841C0338(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)off_4D29ED8;
  if ( !off_4D29ED8 )
  {
    v4 = 0;
    v3[0] = "cri_ware_unity";
  ...
  return ((intptr_t (__fastcall *)(const MethodInfo *))v1)(method);
}
...
void CriWareErrorHandler__CRIWARED1107B8D(CriWareErrorHandler_ErrorCallbackFunc_o *callback, const MethodInfo *method)
{
  ...
  if ( !off_4D29EE8 )
  {
    ...
    v7[4] = 0x200000000LL;
    v9 = 0;
    off_4D29EE8 = (__int64 (__fastcall *)(_QWORD))sub_1C94184(v7);
  }
  v6 = sub_1C61ED4(callback, method, v2, v3, v4);
  off_4D29EE8(v6);
}
...
void CriWareErrorHandler__DequeueErrorMessages(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D29EA8 & 1) == 0 )
  {
    ...
    this = (CriWareErrorHandler_o *)sub_1C93AD4(&string_TypeInfo);
    byte_4D29EA8 = 1;
  }
...
void CriWareErrorHandler__OnEnable(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  v3 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1C93D20(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void CriWareErrorHandler__OutputDefaultLog(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4D29EAA & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_15465/*"W"*/);
    errmsg = (System_String_o *)sub_1C93AD4(&StringLiteral_5427/*"E"*/);
    byte_4D29EAA = 1;
  }
  if ( !v2 )
    sub_1C93D2C(errmsg, method);
  if ( !System_String__StartsWith(v2, (System_String_o *)StringLiteral_5427/*"E"*/, 0) )
    System_String__StartsWith(v2, (System_String_o *)StringLiteral_15465/*"W"*/, 0);
}
...
void CriWareErrorHandler__add_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4D29EA3 & 1) == 0 )
  {
    sub_1C93AD4(&CriWareErrorHandler_Callback_TypeInfo);
    sub_1C93AD4(&CriWareErrorHandler_TypeInfo);
    byte_4D29EA3 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v5 = sub_1CEF8A8(&CriWareErrorHandler_TypeInfo->static_fields->OnCallback, v4, OnCallback);
    v6 = OnCallback == (System_Delegate_o *)v5;
    OnCallback = (System_Delegate_o *)v5;
    if ( v6 )
      return;
  }
  v7 = (CriWareErrorHandler_Callback_o *)sub_1C940C8(v4);
...
void CriWareErrorHandler__remove_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  v7 = (CriWareErrorHandler_o *)sub_1C940C8(v4);
...
void CriWareErrorHandler__set_errorMessage(System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C93A78(CriWareErrorHandler_TypeInfo->static_fields, value);
}
...
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1ABD608;
}
...
LABEL_8:
  ...
  this->fields.method_code = (intptr_t)m_target;
LABEL_9:
  this->fields.extra_arg = (intptr_t)sub_1ABD6AC;
}
