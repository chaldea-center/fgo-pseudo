...
void __fastcall CriWareErrorHandler__Awake(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48575 & 1) == 0 )
  {
    sub_1B863B8(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1B863B8(&CriWareErrorHandler_TypeInfo, v3);
    sub_1B863B8(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v4);
    this = (CriWareErrorHandler_o *)sub_1B863B8(&UnityEngine_Object_TypeInfo, v5);
    byte_4A48575 = 1;
  }
  ...
  if ( initializationCount )
  {
    ...
    UnityEngine_Object__Destroy_69356292((UnityEngine_Object_o *)v2, 0LL);
  }
  else
  {
    ...
    v11 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1B86604(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__CRIWARE063A11A2(uint32_t length, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_4A48580;
  if ( !qword_4A48580 )
  {
    ...
    v4[4] = 0x200000000LL;
    v6 = 0;
    v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))sub_1B86994(v4);
    qword_4A48580 = (__int64)v2;
  }
  v2(length, method);
}
...
void __fastcall CriWareErrorHandler__CRIWARE3BCC893C(const MethodInfo *method)
{
  ...
  if ( !qword_4A48590 )
  {
    ...
    v2[4] = 0x200000000LL;
    v4 = 0;
    v1 = (void (*)(void))sub_1B86994(v2);
    qword_4A48590 = (__int64)v1;
  }
  v1();
}
...
void __fastcall CriWareErrorHandler__CRIWARE527DA518(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4A485B0;
  if ( !qword_4A485B0 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
    ...
    v4[4] = 0x200000000LL;
    v6 = 0;
    v2 = (void (__fastcall *)(bool, const MethodInfo *))sub_1B86994(v4);
    qword_4A485B0 = (__int64)v2;
  }
  v2(sw, method);
}
...
intptr_t __fastcall CriWareErrorHandler__CRIWARE841C0338(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_4A485A8;
  if ( !qword_4A485A8 )
  {
    v4 = 0;
    ...
    v3[4] = 0x200000000LL;
    v5 = 0;
    method = (const MethodInfo *)sub_1B86994(v3);
    v1 = method;
    qword_4A485A8 = (__int64)method;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_4A485B8 )
  {
    ...
    v7[4] = 0x200000000LL;
    v9 = 0;
    qword_4A485B8 = (__int64 (__fastcall *)(_QWORD))sub_1B86994(v7);
  }
  v6 = sub_1B8698C(callback, method, v2, v3, v4);
  qword_4A485B8(v6);
}
...
void __fastcall CriWareErrorHandler__CRIWAREDBC6F415(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4A48598;
  if ( !qword_4A48598 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
...
void __fastcall CriWareErrorHandler__DequeueErrorMessages(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A48578 & 1) == 0 )
  {
    ...
    this = (CriWareErrorHandler_o *)sub_1B863B8(&string_TypeInfo, v2);
    byte_4A48578 = 1;
  }
...
void __fastcall CriWareErrorHandler__HandleMessage(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4A48579 & 1) == 0 )
  {
    sub_1B863B8(&CriWareErrorHandler_TypeInfo, method);
    byte_4A48579 = 1;
  }
  if ( errmsg )
  {
...
void __fastcall CriWareErrorHandler__OnEnable(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1B863B8(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v3);
    byte_4A48576 = 1;
  }
  CriMonoBehaviour__OnEnable((CriMonoBehaviour_o *)this, method);
  v4 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1B86604(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__OutputDefaultLog(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4A4857A & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_15151/*"W"*/, method);
    errmsg = (System_String_o *)sub_1B863B8(&StringLiteral_5369/*"E"*/, v3);
    byte_4A4857A = 1;
  }
  if ( !v2 )
    sub_1B86614(errmsg, method);
  if ( !System_String__StartsWith(v2, (System_String_o *)StringLiteral_5369/*"E"*/, 0LL) )
    System_String__StartsWith(v2, (System_String_o *)StringLiteral_15151/*"W"*/, 0LL);
}
...
void __fastcall CriWareErrorHandler__add_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4A48573 & 1) == 0 )
  {
    sub_1B863B8(&CriWareErrorHandler_Callback_TypeInfo, method);
    sub_1B863B8(&CriWareErrorHandler_TypeInfo, v3);
    byte_4A48573 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v6 = sub_1BC0674(&CriWareErrorHandler_TypeInfo->static_fields->OnCallback, v5, OnCallback);
    v7 = OnCallback == (System_Delegate_o *)v6;
    OnCallback = (System_Delegate_o *)v6;
    if ( v7 )
      return;
  }
  v8 = (CriWareErrorHandler_Callback_o *)sub_1B868D4(v5);
...
System_String_o *__fastcall CriWareErrorHandler__get_errorMessage(const MethodInfo *method)
{
  ...
  if ( (byte_4A48571 & 1) == 0 )
  {
    sub_1B863B8(&CriWareErrorHandler_TypeInfo, v1);
    byte_4A48571 = 1;
  }
...
void __fastcall CriWareErrorHandler__remove_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  v8 = (CriWareErrorHandler_o *)sub_1B868D4(v5);
...
void __fastcall CriWareErrorHandler__set_errorMessage(System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1B8635C(CriWareErrorHandler_TypeInfo->static_fields);
}
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C8718;
}
...
LABEL_8:
  ...
  this->fields.original_method_info = v10;
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19C87BC;
}
