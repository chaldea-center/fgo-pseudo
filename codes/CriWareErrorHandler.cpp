...
void __fastcall CriWareErrorHandler__Awake(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1ED5 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1C1ABD4(&CriWareErrorHandler_TypeInfo, v3);
    sub_1C1ABD4(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v4);
    this = (CriWareErrorHandler_o *)sub_1C1ABD4(&UnityEngine_Object_TypeInfo, v5);
    byte_4BC1ED5 = 1;
  }
  ...
  if ( initializationCount )
  {
    ...
    UnityEngine_Object__Destroy_70794412((UnityEngine_Object_o *)v2, 0LL);
  }
  else
  {
    ...
    v11 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1C1AE20(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__CRIWARE063A11A2(uint32_t length, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_4BC1EE0;
  if ( !qword_4BC1EE0 )
  {
    ...
    v4[4] = 0x200000000LL;
    v6 = 0;
    v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))sub_1C1B1B0(v4);
    qword_4BC1EE0 = (__int64)v2;
  }
  v2(length, method);
}
...
void __fastcall CriWareErrorHandler__CRIWARE3BCC893C(const MethodInfo *method)
{
  ...
  if ( !qword_4BC1EF0 )
  {
    ...
    v2[4] = 0x200000000LL;
    v4 = 0;
    v1 = (void (*)(void))sub_1C1B1B0(v2);
    qword_4BC1EF0 = (__int64)v1;
  }
  v1();
}
...
void __fastcall CriWareErrorHandler__CRIWARE527DA518(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4BC1F10;
  if ( !qword_4BC1F10 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
    ...
    v4[4] = 0x200000000LL;
    v6 = 0;
    v2 = (void (__fastcall *)(bool, const MethodInfo *))sub_1C1B1B0(v4);
    qword_4BC1F10 = (__int64)v2;
  }
  v2(sw, method);
}
...
intptr_t __fastcall CriWareErrorHandler__CRIWARE841C0338(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_4BC1F08;
  if ( !qword_4BC1F08 )
  {
    v4 = 0;
    ...
    v3[4] = 0x200000000LL;
    v5 = 0;
    method = (const MethodInfo *)sub_1C1B1B0(v3);
    v1 = method;
    qword_4BC1F08 = (__int64)method;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_4BC1F18 )
  {
    ...
    v7[4] = 0x200000000LL;
    v9 = 0;
    qword_4BC1F18 = (__int64 (__fastcall *)(_QWORD))sub_1C1B1B0(v7);
  }
  v6 = sub_1C1B1A8(callback, method, v2, v3, v4);
  qword_4BC1F18(v6);
}
...
void __fastcall CriWareErrorHandler__CRIWAREDBC6F415(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4BC1EF8;
  if ( !qword_4BC1EF8 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
...
void __fastcall CriWareErrorHandler__DequeueErrorMessages(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1ED8 & 1) == 0 )
  {
    ...
    this = (CriWareErrorHandler_o *)sub_1C1ABD4(&string_TypeInfo, v2);
    byte_4BC1ED8 = 1;
  }
...
void __fastcall CriWareErrorHandler__HandleMessage(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1ED9 & 1) == 0 )
  {
    sub_1C1ABD4(&CriWareErrorHandler_TypeInfo, method);
    byte_4BC1ED9 = 1;
  }
  if ( errmsg )
  {
...
void __fastcall CriWareErrorHandler__OnEnable(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C1ABD4(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1C1ABD4(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v3);
    byte_4BC1ED6 = 1;
  }
  CriMonoBehaviour__OnEnable((CriMonoBehaviour_o *)this, method);
  v4 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1C1AE20(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__OutputDefaultLog(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1EDA & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_15634/*"W"*/, method);
    errmsg = (System_String_o *)sub_1C1ABD4(&StringLiteral_5532/*"E"*/, v3);
    byte_4BC1EDA = 1;
  }
  if ( !v2 )
    sub_1C1AE30(errmsg, method);
  if ( !System_String__StartsWith(v2, (System_String_o *)StringLiteral_5532/*"E"*/, 0LL) )
    System_String__StartsWith(v2, (System_String_o *)StringLiteral_15634/*"W"*/, 0LL);
}
...
void __fastcall CriWareErrorHandler__add_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4BC1ED3 & 1) == 0 )
  {
    sub_1C1ABD4(&CriWareErrorHandler_Callback_TypeInfo, method);
    sub_1C1ABD4(&CriWareErrorHandler_TypeInfo, v3);
    byte_4BC1ED3 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v6 = sub_1C560C4(&CriWareErrorHandler_TypeInfo->static_fields->OnCallback, v5, OnCallback);
    v7 = OnCallback == (System_Delegate_o *)v6;
    OnCallback = (System_Delegate_o *)v6;
    if ( v7 )
      return;
  }
  v8 = (CriWareErrorHandler_Callback_o *)sub_1C1B0F0(v5);
...
System_String_o *__fastcall CriWareErrorHandler__get_errorMessage(const MethodInfo *method)
{
  ...
  if ( (byte_4BC1ED1 & 1) == 0 )
  {
    sub_1C1ABD4(&CriWareErrorHandler_TypeInfo, v1);
    byte_4BC1ED1 = 1;
  }
...
void __fastcall CriWareErrorHandler__remove_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  v8 = (CriWareErrorHandler_o *)sub_1C1B0F0(v5);
...
void __fastcall CriWareErrorHandler__set_errorMessage(System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1C1AB78(CriWareErrorHandler_TypeInfo->static_fields);
}
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A525D8;
}
...
LABEL_8:
  ...
  this->fields.original_method_info = v10;
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5267C;
}
