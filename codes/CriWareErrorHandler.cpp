...
void __fastcall CriWareErrorHandler__Awake(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42A659D & 1) == 0 )
  {
    sub_B52984(&Method_CriWareErrorHandler_ErrorCallbackFromNative__);
    sub_B52984(&CriWareErrorHandler_TypeInfo);
    sub_B52984(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
  ...
  if ( ++inited->static_fields->initializationCount == 1 )
  {
    ...
    v7 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_B52A54(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__CRIWARE063A11A2(uint32_t length, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_42A65A8;
  if ( !qword_42A65A8 )
  {
    ...
    v5 = 4;
    v6 = 0;
    v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))sub_B52E08(v4);
    qword_42A65A8 = (__int64)v2;
  }
  v2(length, method);
}
...
void __fastcall CriWareErrorHandler__CRIWARE3BCC893C(const MethodInfo *method)
{
  ...
  if ( !qword_42A65B8 )
  {
    ...
    v3 = 0;
    v4 = 0;
    v1 = (void (*)(void))sub_B52E08(v2);
    qword_42A65B8 = (__int64)v1;
  }
  v1();
}
...
void __fastcall CriWareErrorHandler__CRIWARE527DA518(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_42A65D8;
  if ( !qword_42A65D8 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
    ...
    v5 = 4;
    v6 = 0;
    v2 = (void (__fastcall *)(bool, const MethodInfo *))sub_B52E08(v4);
    qword_42A65D8 = (__int64)v2;
  }
  v2(sw, method);
}
...
intptr_t __fastcall CriWareErrorHandler__CRIWARE841C0338(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_42A65D0;
  if ( !qword_42A65D0 )
  {
    ...
    v4 = 0;
    v5 = 0;
    method = (const MethodInfo *)sub_B52E08(v3);
    v1 = method;
    qword_42A65D0 = (__int64)method;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_42A65E0 )
  {
    ...
    v8 = 8;
    v9 = 0;
    qword_42A65E0 = (__int64 (__fastcall *)(_QWORD))sub_B52E08(v7);
  }
  v6 = sub_B52E00(callback, method, v2, v3, v4);
  qword_42A65E0(v6);
}
...
void __fastcall CriWareErrorHandler__CRIWAREDBC6F415(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_42A65C0;
  if ( !qword_42A65C0 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
...
void __fastcall CriWareErrorHandler__DequeueErrorMessages(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52984(&CriWareErrorHandler_TypeInfo);
    sub_B52984(&IntPtr_TypeInfo);
    sub_B52984(&System_Runtime_InteropServices_Marshal_TypeInfo);
...
void __fastcall CriWareErrorHandler__ErrorCallbackFromNative(System_String_o *errmsg, const MethodInfo *method)
{
  if ( (byte_42A65A4 & 1) == 0 )
  {
    sub_B52984(&CriWareErrorHandler_TypeInfo, method);
    byte_42A65A4 = 1;
  }
  if ( (BYTE3(CriWareErrorHandler_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !CriWareErrorHandler_TypeInfo->_2.cctor_finished )
...
void __fastcall CriWareErrorHandler__OnEnable(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  v3 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_B52A54(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__OutputDefaultLog(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_42A65A3 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_15327/*"W"*/);
    errmsg = (System_String_o *)sub_B52984(&StringLiteral_5474/*"E"*/);
    byte_42A65A3 = 1;
  }
  if ( !v2 )
    sub_B52A5C(errmsg, method);
  if ( !System_String__StartsWith(v2, (System_String_o *)StringLiteral_5474/*"E"*/, 0LL) )
    System_String__StartsWith(v2, (System_String_o *)StringLiteral_15327/*"W"*/, 0LL);
}
...
void __fastcall CriWareErrorHandler__add_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_42A659B & 1) == 0 )
  {
    sub_B52984(&CriWareErrorHandler_Callback_TypeInfo);
    sub_B52984(&CriWareErrorHandler_TypeInfo);
    byte_42A659B = 1;
  }
  v3 = CriWareErrorHandler_TypeInfo;
  ...
  while ( 1 )
  {
    ...
    v8 = sub_B4739C(&v7->static_fields->OnCallback, v6, OnCallback);
    v9 = OnCallback == (System_Delegate_o *)v8;
    OnCallback = (System_Delegate_o *)v8;
    if ( v9 )
      return;
  }
  v10 = (CriWareErrorHandler_Callback_o *)sub_B52D50(v5);
...
void __fastcall CriWareErrorHandler__remove_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  v10 = (CriWareErrorHandler_o *)sub_B52D50(v5);
...
LABEL_5:
    for ( i = 0LL; i != v7; ++i )
    {
      ...
      v33 = *(void (__fastcall **)(System_String_o *, __int64))&v30->fields.method_ptr;
      if ( *(__int16 *)(v31 + 72) == -1 )
        sub_B52A40(*(_QWORD *)&v30->fields.extra_arg, errmsg, method, v3);
      v34 = sub_B529B4(v31);
      v35 = *(unsigned __int8 *)(v31 + 74);
      if ( (v34 & 1) != 0 )
      {
          ...
          if ( *(__int16 *)(v31 + 72) != -1 && this->fields.m_target )
          {
            ...
            if ( (v44 & 1) != 0 )
            {
              if ( (v45 & 1) != 0 )
              {
                ...
                {
LABEL_57:
                  v26 = sub_AEB880(errmsg, v48, v49, v46);
                }
                v17 = *(_QWORD *)(v26 + 8);
              }
              else
            ...
            else
            {
              ...
              if ( (v45 & 1) != 0 )
              {
                ...
                {
LABEL_11:
                  v16 = sub_AEB880(errmsg, class_0, v10, v12);
                }
