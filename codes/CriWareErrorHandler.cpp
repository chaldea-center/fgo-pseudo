...
void __fastcall CriWareErrorHandler__Awake(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3E6A5 & 1) == 0 )
  {
    sub_1BDB878(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1BDB878(&CriWareErrorHandler_TypeInfo, v3);
    sub_1BDB878(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v4);
    this = (CriWareErrorHandler_o *)sub_1BDB878(&UnityEngine_Object_TypeInfo, v5);
    byte_4B3E6A5 = 1;
  }
  ...
  if ( initializationCount )
  {
    ...
    UnityEngine_Object__Destroy_70284200((UnityEngine_Object_o *)v2, 0LL);
  }
  else
  {
    ...
    v11 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1BDBAC4(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__CRIWARE063A11A2(uint32_t length, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(_QWORD, const MethodInfo *))qword_4B3E6B0;
  if ( !qword_4B3E6B0 )
  {
...
void __fastcall CriWareErrorHandler__CRIWARE3BCC893C(const MethodInfo *method)
{
  ...
  if ( !qword_4B3E6C0 )
  {
    ...
    v2[4] = 0x200000000LL;
    v4 = 0;
    v1 = (void (*)(void))sub_1BDBE54(v2);
    qword_4B3E6C0 = (__int64)v1;
  }
  v1();
}
...
void __fastcall CriWareErrorHandler__CRIWARE527DA518(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4B3E6E0;
  if ( !qword_4B3E6E0 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
    ...
    v4[4] = 0x200000000LL;
    v6 = 0;
    v2 = (void (__fastcall *)(bool, const MethodInfo *))sub_1BDBE54(v4);
    qword_4B3E6E0 = (__int64)v2;
  }
  v2(sw, method);
}
...
intptr_t __fastcall CriWareErrorHandler__CRIWARE841C0338(const MethodInfo *method)
{
  ...
  v1 = (const MethodInfo *)qword_4B3E6D8;
  if ( !qword_4B3E6D8 )
  {
    v4 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !qword_4B3E6E8 )
  {
    ...
    v7[4] = 0x200000000LL;
    v9 = 0;
    qword_4B3E6E8 = (__int64 (__fastcall *)(_QWORD))sub_1BDBE54(v7);
  }
  v6 = sub_1BDBE4C(callback, method, v2, v3, v4);
  qword_4B3E6E8(v6);
}
...
void __fastcall CriWareErrorHandler__CRIWAREDBC6F415(bool sw, const MethodInfo *method)
{
  ...
  v2 = (void (__fastcall *)(bool, const MethodInfo *))qword_4B3E6C8;
  if ( !qword_4B3E6C8 )
  {
    v4[0] = (__int64)"cri_ware_unity";
    v4[1] = 14LL;
...
void __fastcall CriWareErrorHandler__DequeueErrorMessages(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B3E6A8 & 1) == 0 )
  {
    ...
    this = (CriWareErrorHandler_o *)sub_1BDB878(&string_TypeInfo, v2);
    byte_4B3E6A8 = 1;
  }
...
void __fastcall CriWareErrorHandler__HandleMessage(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4B3E6A9 & 1) == 0 )
  {
    sub_1BDB878(&CriWareErrorHandler_TypeInfo, method);
    byte_4B3E6A9 = 1;
  }
  if ( errmsg )
  {
...
void __fastcall CriWareErrorHandler__OnEnable(CriWareErrorHandler_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BDB878(&Method_CriWareErrorHandler_ErrorCallbackFromNative__, method);
    sub_1BDB878(&CriWareErrorHandler_ErrorCallbackFunc_TypeInfo, v3);
    byte_4B3E6A6 = 1;
  }
  CriMonoBehaviour__OnEnable((CriMonoBehaviour_o *)this, method);
  v4 = (CriWareErrorHandler_ErrorCallbackFunc_o *)sub_1BDBAC4(CriWareErrorHandler_ErrorCallbackFunc_TypeInfo);
...
void __fastcall CriWareErrorHandler__OutputDefaultLog(System_String_o *errmsg, const MethodInfo *method)
{
  ...
  if ( (byte_4B3E6AA & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_15351/*"W"*/, method);
    errmsg = (System_String_o *)sub_1BDB878(&StringLiteral_5439/*"E"*/, v3);
    byte_4B3E6AA = 1;
  }
  if ( !v2 )
    sub_1BDBAD4(errmsg, method);
  if ( !System_String__StartsWith(v2, (System_String_o *)StringLiteral_5439/*"E"*/, 0LL) )
    System_String__StartsWith(v2, (System_String_o *)StringLiteral_15351/*"W"*/, 0LL);
}
...
void __fastcall CriWareErrorHandler__add_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  if ( (byte_4B3E6A3 & 1) == 0 )
  {
    sub_1BDB878(&CriWareErrorHandler_Callback_TypeInfo, method);
    sub_1BDB878(&CriWareErrorHandler_TypeInfo, v3);
    byte_4B3E6A3 = 1;
  }
  ...
  while ( 1 )
  {
    ...
    v6 = sub_1C15B34(&CriWareErrorHandler_TypeInfo->static_fields->OnCallback, v5, OnCallback);
    v7 = OnCallback == (System_Delegate_o *)v6;
    OnCallback = (System_Delegate_o *)v6;
    if ( v7 )
      return;
  }
  v8 = (CriWareErrorHandler_Callback_o *)sub_1BDBD94(v5);
...
System_String_o *__fastcall CriWareErrorHandler__get_errorMessage(const MethodInfo *method)
{
  ...
  if ( (byte_4B3E6A1 & 1) == 0 )
  {
    sub_1BDB878(&CriWareErrorHandler_TypeInfo, v1);
    byte_4B3E6A1 = 1;
  }
...
void __fastcall CriWareErrorHandler__remove_OnCallback(CriWareErrorHandler_Callback_o *value, const MethodInfo *method)
{
  ...
  v8 = (CriWareErrorHandler_o *)sub_1BDBD94(v5);
...
void __fastcall CriWareErrorHandler__set_errorMessage(System_String_o *value, const MethodInfo *method)
{
  ...
  sub_1BDB81C(CriWareErrorHandler_TypeInfo->static_fields);
}
...
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A1A7C0;
}
...
LABEL_8:
  ...
  this->fields.original_method_info = v10;
LABEL_9:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A1A864;
}
