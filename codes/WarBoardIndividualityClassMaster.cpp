...
void WarBoardIndividualityClassMaster___ctor(WarBoardIndividualityClassMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C44155 & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_WarBoardIndividualityClassMaster__WarBoardIndividualityClassEntity__int___ctor__);
    byte_4C44155 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    342,
    (const MethodInfo_339ED7C *)Method_DataMasterBase_WarBoardIndividualityClassMaster__WarBoardIndividualityClassEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C44156 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_System_Collections_ObjectModel_Collection_WarBoardIndividualityClassEntity__GetEnumerator__);
    sub_1C37058(&System_Func_int__bool__TypeInfo);
    sub_1C37058(&System_IDisposable_TypeInfo);
    sub_1C37058(&System_Collections_Generic_IEnumerator_WarBoardIndividualityClassEntity__TypeInfo);
    sub_1C37058(&System_Collections_IEnumerator_TypeInfo);
    sub_1C37058(&Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity__Add__);
    sub_1C37058(&Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity__ToArray__);
    sub_1C37058(&Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity___ctor__);
    sub_1C37058(&System_Collections_Generic_List_WarBoardIndividualityClassEntity__TypeInfo);
    sub_1C37058(&Method_WarBoardIndividualityClassMaster___c__DisplayClass3_0__GetEntities_b__0__);
    sub_1C37058(&WarBoardIndividualityClassMaster___c__DisplayClass3_0_TypeInfo);
    byte_4C44156 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_WarBoardIndividualityClassEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_37A27F0 *)Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity___ctor__);
  if ( individualities )
  {
    ...
    Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                   list,
                   (const MethodInfo_333AAE8 *)Method_System_Collections_ObjectModel_Collection_WarBoardIndividualityClassEntity__GetEnumerator__);
    if ( !Enumerator )
      sub_1C372B4(0);
    while ( 1 )
    {
...
LABEL_10:
      ...
      if ( ((*(__int64 (__fastcall **)(System_Collections_Generic_IEnumerator_T__o *, _QWORD))v11)(
          ...
          & 1) == 0 )
        break;
      v12 = sub_1C372A4(WarBoardIndividualityClassMaster___c__DisplayClass3_0_TypeInfo);
...
LABEL_17:
      ...
      if ( !v12 )
        sub_1C372B4(v17);
      *(_QWORD *)(v12 + 16) = v17;
      sub_1C36FFC((CGThumbnailListItem_o *)(v12 + 16), v17, v18, v19);
      if ( *(_QWORD *)(v12 + 16) )
      {
        ...
        System_Func_int__bool____ctor(
          ...
          0);
        v21 = BasicHelper__Any_int__51187064(
                individualities,
...
LABEL_39:
  ...
  return (WarBoardIndividualityClassEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                     v5,
                                                     (const MethodInfo_37A4B7C *)Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C44157 & 1) == 0 )
  {
    sub_1C37058(&Method_System_Collections_Generic_List_ServantClassEntity__Add__);
    sub_1C37058(&Method_System_Collections_Generic_List_ServantClassEntity__ToArray__);
    sub_1C37058(&Method_System_Collections_Generic_List_ServantClassEntity___ctor__);
    sub_1C37058(&System_Collections_Generic_List_ServantClassEntity__TypeInfo);
    byte_4C44157 = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1C372A4(System_Collections_Generic_List_ServantClassEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_37A27F0 *)Method_System_Collections_Generic_List_ServantClassEntity___ctor__);
    ...
    while ( 1 )
    {
      ...
      if ( (int)++v11 >= (int)klass )
        return (ServantClassEntity_array *)System_Collections_Generic_List_object___ToArray(
                                             v5,
                                             (const MethodInfo_37A4B7C *)Method_System_Collections_Generic_List_ServantClassEntity__ToArray__);
    }
LABEL_18:
        ...
        const MethodInfo *method)
{
  ...
  result = (ServantClassEntity_o *)sub_1C37100(int___TypeInfo, 1);
  if ( !result )
    sub_1C372B4(0);
