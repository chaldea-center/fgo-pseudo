...
void WarBoardIndividualityClassMaster___ctor(WarBoardIndividualityClassMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C57F1D & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_WarBoardIndividualityClassMaster__WarBoardIndividualityClassEntity__int___ctor__);
    byte_4C57F1D = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    342,
    (const MethodInfo_33B0C34 *)Method_DataMasterBase_WarBoardIndividualityClassMaster__WarBoardIndividualityClassEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C57F1E & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_System_Collections_ObjectModel_Collection_WarBoardIndividualityClassEntity__GetEnumerator__);
    sub_1C3E564(&System_Func_int__bool__TypeInfo);
    sub_1C3E564(&System_IDisposable_TypeInfo);
    sub_1C3E564(&System_Collections_Generic_IEnumerator_WarBoardIndividualityClassEntity__TypeInfo);
    sub_1C3E564(&System_Collections_IEnumerator_TypeInfo);
    sub_1C3E564(&Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity__Add__);
    sub_1C3E564(&Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity__ToArray__);
    sub_1C3E564(&Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity___ctor__);
    sub_1C3E564(&System_Collections_Generic_List_WarBoardIndividualityClassEntity__TypeInfo);
    sub_1C3E564(&Method_WarBoardIndividualityClassMaster___c__DisplayClass3_0__GetEntities_b__0__);
    sub_1C3E564(&WarBoardIndividualityClassMaster___c__DisplayClass3_0_TypeInfo);
    byte_4C57F1E = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1C3E7B0(System_Collections_Generic_List_WarBoardIndividualityClassEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_37B4C2C *)Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity___ctor__);
  if ( individualities )
  {
    ...
    Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                   list,
                   (const MethodInfo_334C9A0 *)Method_System_Collections_ObjectModel_Collection_WarBoardIndividualityClassEntity__GetEnumerator__);
    if ( !Enumerator )
      sub_1C3E7C0(0, v8);
    while ( 1 )
    {
...
LABEL_10:
      ...
      if ( ((*(__int64 (__fastcall **)(System_Collections_Generic_IEnumerator_T__o *, _QWORD))v13)(
          ...
          & 1) == 0 )
        break;
      v14 = sub_1C3E7B0(WarBoardIndividualityClassMaster___c__DisplayClass3_0_TypeInfo);
      ...
      *(_QWORD *)(v14 + 16) = v19;
      ...
      if ( *(_QWORD *)(v14 + 16) )
      {
        ...
        System_Func_int__bool____ctor(
          ...
          0);
        v23 = BasicHelper__Any_int__51260304(
                individualities,
        ...
        if ( v23 )
        {
          ...
          else
          {
            ...
            sub_1C3E508((CGThumbnailListItem_o *)(v31 + 4), (int32_t)v27, v25, v26);
          }
        }
      }
    }
...
LABEL_39:
  ...
  return (WarBoardIndividualityClassEntity_array *)System_Collections_Generic_List_object___ToArray(
                                                     v5,
                                                     (const MethodInfo_37B6FB8 *)Method_System_Collections_Generic_List_WarBoardIndividualityClassEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C57F1F & 1) == 0 )
  {
    sub_1C3E564(&Method_System_Collections_Generic_List_ServantClassEntity__Add__);
    sub_1C3E564(&Method_System_Collections_Generic_List_ServantClassEntity__ToArray__);
    sub_1C3E564(&Method_System_Collections_Generic_List_ServantClassEntity___ctor__);
    sub_1C3E564(&System_Collections_Generic_List_ServantClassEntity__TypeInfo);
    byte_4C57F1F = 1;
  }
  v5 = (System_Collections_Generic_List_object__o *)sub_1C3E7B0(System_Collections_Generic_List_ServantClassEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v5,
    (const MethodInfo_37B4C2C *)Method_System_Collections_Generic_List_ServantClassEntity___ctor__);
    ...
    while ( 1 )
    {
      ...
      if ( (int)++v11 >= (int)klass )
        return (ServantClassEntity_array *)System_Collections_Generic_List_object___ToArray(
                                             v5,
                                             (const MethodInfo_37B6FB8 *)Method_System_Collections_Generic_List_ServantClassEntity__ToArray__);
    }
LABEL_18:
    sub_1C3E7C0(Entities, v8);
  }
  if ( !v5 )
    goto LABEL_18;
  return (ServantClassEntity_array *)System_Collections_Generic_List_object___ToArray(
        ...
        const MethodInfo *method)
{
  ...
  result = (ServantClassEntity_o *)sub_1C3E60C(int___TypeInfo, 1);
  if ( !result )
    sub_1C3E7C0(0, v6);
  v8 = result;
