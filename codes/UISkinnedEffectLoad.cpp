        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43898 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_TerminalOverwriteMaster___, *(_QWORD *)&uiChangeType);
  ...
  EffectNameList = 0LL;
  result = (System_String_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !result )
    goto LABEL_16;
...
void __fastcall UISkinnedEffectLoad__SetEffects(UISkinnedEffectLoad_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43897 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_System_Linq_Enumerable_Where_GameObject___, v3);
    sub_1BDB878(&System_Func_GameObject__bool__TypeInfo, v4);
    sub_1BDB878(&System_IDisposable_TypeInfo, v5);
    sub_1BDB878(&System_Collections_Generic_IEnumerable_GameObject__TypeInfo, v6);
    sub_1BDB878(&System_Collections_Generic_IEnumerator_GameObject__TypeInfo, v7);
    ...
    sub_1BDB878(&Method_UISkinnedEffectLoad___c__SetEffects_b__9_0__, v11);
    sub_1BDB878(&UISkinnedEffectLoad___c_TypeInfo, v12);
    byte_4B43897 = 1;
  }
  if ( !ServantCommentManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ServantCommentManager_TypeInfo);
    ...
    if ( UiFlag < (signed int)skinEffects->max_length )
    {
      ...
      if ( setEffectList )
      {
        ...
        if ( !_9__9_0 )
        {
          ...
          _9__9_0 = (System_Func_object__bool__o *)sub_1BDBAC4(System_Func_GameObject__bool__TypeInfo);
          ...
          sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__9_0, (int32_t)_9__9_0, v23, v24);
        }
        ...
        {
LABEL_19:
          p_method = sub_1C2C00C(v25, System_Collections_Generic_IEnumerable_GameObject__TypeInfo, 0LL);
        }
...
LABEL_27:
          ...
          {
LABEL_34:
            v41 = sub_1C2C00C(v33, System_Collections_Generic_IEnumerator_GameObject__TypeInfo, 0LL);
          }
        ...
        {
LABEL_44:
          v48 = sub_1C2C00C(v33, System_IDisposable_TypeInfo, 0LL);
        }
      ...
      sub_1BDB81C(p_setEffectList, (int32_t)v53, v54, v55);
    }
  }
}
...
void __fastcall UISkinnedEffectLoad___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B43899 & 1) == 0 )
  {
    sub_1BDB878(&UISkinnedEffectLoad___c_TypeInfo, v1);
    byte_4B43899 = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(UISkinnedEffectLoad___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  UISkinnedEffectLoad___c_TypeInfo->static_fields->__9 = (struct UISkinnedEffectLoad___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)UISkinnedEffectLoad___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
        ...
        const MethodInfo *method)
{
  if ( (byte_4B4389A & 1) == 0 )
  {
    sub_1BDB878(&UnityEngine_Object_TypeInfo, setEffect);
    byte_4B4389A = 1;
  }
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
