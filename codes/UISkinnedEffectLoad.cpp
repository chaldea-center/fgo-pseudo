...
LABEL_37:
  ...
  IsNullOrEmpty = System_String__Format((System_String_o *)*v15, v14, 0);
  v7 = IsNullOrEmpty;
  if ( !v13 )
    goto LABEL_37;
  ...
  if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
  {
    ...
    if ( !*(&ServantCommentManager_TypeInfo->_2.cctor_finished + 1) )
      j_il2cpp_runtime_class_init_0(ServantCommentManager_TypeInfo, v7, v16);
...
LABEL_34:
      ...
      {
        j_il2cpp_runtime_class_init_0(UISkinnedEffectLoad_TypeInfo, v7, v16);
        v21 = UISkinnedEffectLoad_TypeInfo;
      }
      IsNullOrEmpty = (System_String_o *)v21->static_fields->DefaultSkinEffects;
      if ( !IsNullOrEmpty )
        goto LABEL_37;
...
System_String_array *UISkinnedEffectLoad__GetReplaceEffectnames(
        ...
        const MethodInfo *method)
{
  struct UISkinnedEffectLoad_ReplaceData_array *replaceDatas; // x9
  int max_length; // w8
  UISkinnedEffectLoad_ReplaceData_o **i; // x9
  UISkinnedEffectLoad_ReplaceData_o *v7; // x10
...
void UISkinnedEffectLoad__SetEffects(UISkinnedEffectLoad_o *this, const MethodInfo *method)
{
  ...
  int32_t v6; // w21
  MissionNaviTransitionBoardItem_o *p_setEffectList; // x20
  struct System_Collections_Generic_List_GameObject__o *setEffectList; // x22
  UISkinnedEffectLoad___c_c *v9; // x0
  struct UISkinnedEffectLoad___c_StaticFields *static_fields; // x8
  System_Func_object__bool__o *_9__10_0; // x23
  Il2CppObject *v12; // x24
  struct UISkinnedEffectLoad___c_StaticFields *v13; // x0
  ...
  System_Collections_Generic_List_GameObject__o *v50; // x0
  ...
  if ( !Instance )
    goto LABEL_49;
  v6 = Instance[20];
  p_setEffectList = (MissionNaviTransitionBoardItem_o *)&this->fields.setEffectList;
  setEffectList = this->fields.setEffectList;
  if ( !setEffectList )
    goto LABEL_44;
  v9 = UISkinnedEffectLoad___c_TypeInfo;
  if ( !*(&UISkinnedEffectLoad___c_TypeInfo->_2.cctor_finished + 1) )
  {
    j_il2cpp_runtime_class_init_0(UISkinnedEffectLoad___c_TypeInfo, v4, v5);
    v9 = UISkinnedEffectLoad___c_TypeInfo;
  }
  ...
  if ( !_9__10_0 )
  {
    ...
    {
      j_il2cpp_runtime_class_init_0(v9, v4, v5);
...
LABEL_49:
  ...
  if ( *(_WORD *)(*(_QWORD *)Instance + 302LL) )
  {
    ...
    while ( *((System_Collections_Generic_IEnumerable_GameObject__c **)v23 - 1) != System_Collections_Generic_IEnumerable_GameObject__TypeInfo )
    {
      --v22;
      v23 += 4;
      if ( !v22 )
...
LABEL_24:
    ...
    if ( ((*(__int64 (__fastcall **)(__int64, _QWORD))v30)(v57, *(_QWORD *)(v30 + 8)) & 1) == 0 )
      break;
    v31 = *(_QWORD *)v57;
    v32 = *(unsigned __int16 *)(*(_QWORD *)v57 + 302LL);
    if ( *(_WORD *)(*(_QWORD *)v57 + 302LL) )
    {
