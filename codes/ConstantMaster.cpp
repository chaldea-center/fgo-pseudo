void __fastcall ConstantMaster___ctor(ConstantMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4AB5B97 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__, method);
    byte_4AB5B97 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    101,
    (const MethodInfo_31640A8 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
}
...
int32_t __fastcall ConstantMaster__GetFlagTransformSvtRestrict(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5BA3 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_9284/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/, v1);
    byte_4AB5BA3 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9284/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/, v1);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B9B & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataMasterBase_TryGetEntityFromId_ConstantEntity___, name);
    byte_4AB5B9B = 1;
  }
  result = 0LL;
  EntityFromId_object = DataMasterBase__TryGetEntityFromId_object_(
                          ...
                          &result,
                          name,
                          (const MethodInfo_2EC5A68 *)Method_DataMasterBase_TryGetEntityFromId_ConstantEntity___);
...
int32_t __fastcall ConstantMaster__GetValue_39440184(
        ConstantMaster_o *this,
        System_String_o *name,
        int32_t def,
        const MethodInfo *method)
...
bool __fastcall ConstantMaster__IsDisableServantEffectFilter(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B9D & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_5048/*"DISABLE_SERVANT_EFFECT_FILTER"*/, v1);
    byte_4AB5B9D = 1;
  }
...
bool __fastcall ConstantMaster__IsFLAG20240804(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5BA0 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_6389/*"FLAG_20240804"*/, v1);
    byte_4AB5BA0 = 1;
  }
...
bool __fastcall ConstantMaster__IsFLAG20241004(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5BA2 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_6390/*"FLAG_20241004"*/, v1);
    byte_4AB5BA2 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_6390/*"FLAG_20241004"*/, v1) == 1;
}
...
bool __fastcall ConstantMaster__IsNotDisplayBattleAttribute(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B9F & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_9285/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/, v1);
    byte_4AB5B9F = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9285/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/, v1) == 1;
}
...
bool __fastcall ConstantMaster__IsNotUseRestrictionDialog(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B9E & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_9300/*"NOT_USE_RESTRICTION_DIALOG"*/, v1);
    byte_4AB5B9E = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9300/*"NOT_USE_RESTRICTION_DIALOG"*/, v1) == 1;
}
...
bool __fastcall ConstantMaster__IsOtherImage(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B9C & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_8305/*"LOGIN_DAY"*/, v3);
    byte_4AB5B9C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime(0LL).fields._dateData;
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_8305/*"LOGIN_DAY"*/, v4);
  v8 = NetworkManager__getServerDateTime_38939020(Value, 0LL).fields._dateData;
...
bool __fastcall ConstantMaster__IsUseSimpleMesh(const MethodInfo *method)
{
  ...
  if ( (byte_4AB5BA1 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_6384/*"FIGURE_USE_SIMPLE_MESH"*/, v1);
    byte_4AB5BA1 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_6384/*"FIGURE_USE_SIMPLE_MESH"*/, v1) == 1;
}
...
int32_t __fastcall ConstantMaster__getValue(System_String_o *name, const MethodInfo *method)
{
  ...
  if ( (byte_4AB5B98 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DataMasterBase_TryGetEntityFromId_ConstantEntity___, v3);
