void ConstantMaster___ctor(ConstantMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4D2C687 & 1) == 0 )
  {
    sub_1C94098(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
    byte_4D2C687 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    105,
    (const MethodInfo_345DC54 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
}
...
int32_t ConstantMaster__GetFlagTransformSvtRestrict(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C692 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_9326/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/);
    byte_4D2C692 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9326/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/, v1);
}
...
int32_t ConstantMaster__GetGrandEffectId(int32_t effectId, const MethodInfo *method)
{
  ...
  if ( (byte_4D2C68C & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_3681/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_1"*/);
    sub_1C94098(&StringLiteral_3682/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_2"*/);
    byte_4D2C68C = 1;
  }
...
float ConstantMaster__GetRateValue(ConstantMaster_o *this, System_String_o *name, float def, const MethodInfo *method)
{
  ...
  if ( (byte_4D2C68B & 1) == 0 )
  {
    sub_1C94098(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
    byte_4D2C68B = 1;
  }
  result = 0;
  EntityFromId = DataMasterBase_object__object__object___TryGetEntityFromId(
                   ...
                   &result,
                   name,
                   (const MethodInfo_345F628 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
  if ( EntityFromId )
  {
    if ( !result )
...
int32_t ConstantMaster__GetValue_42669740(
...
bool ConstantMaster__IsDisableServantEffectFilter(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C68E & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_5018/*"DISABLE_SERVANT_EFFECT_FILTER"*/);
    byte_4D2C68E = 1;
  }
...
bool ConstantMaster__IsEnableFixGetQuestPhaseDetail(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C693 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_5428/*"ENABLE_FIX_GET_QUEST_PHASE_DETAIL"*/);
    byte_4D2C693 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_5428/*"ENABLE_FIX_GET_QUEST_PHASE_DETAIL"*/, v1) == 1;
}
...
bool ConstantMaster__IsNotDisplayBattleAttribute(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C690 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_9328/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/);
    byte_4D2C690 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9328/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/, v1) == 1;
}
...
bool ConstantMaster__IsNotUseRestrictionDialog(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C68F & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_9343/*"NOT_USE_RESTRICTION_DIALOG"*/);
    byte_4D2C68F = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9343/*"NOT_USE_RESTRICTION_DIALOG"*/, v1) == 1;
}
...
bool ConstantMaster__IsOtherImage(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C68D & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_8346/*"LOGIN_DAY"*/);
    byte_4D2C68D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime(0).fields._dateData;
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_8346/*"LOGIN_DAY"*/, v1);
  v9 = NetworkManager__getServerDateTime_42129376(Value, 0).fields._dateData;
...
bool ConstantMaster__IsUseSimpleMesh(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C691 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_6424/*"FIGURE_USE_SIMPLE_MESH"*/);
    byte_4D2C691 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_6424/*"FIGURE_USE_SIMPLE_MESH"*/, v1) == 1;
}
