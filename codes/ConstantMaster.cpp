void ConstantMaster___ctor(ConstantMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CC7212 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
    byte_4CC7212 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    105,
    (const MethodInfo_340B614 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
}
...
int32_t ConstantMaster__GetFlagTransformSvtRestrict(const MethodInfo *method)
{
  ...
  if ( (byte_4CC721D & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_9306/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/);
    byte_4CC721D = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9306/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/, v1);
}
...
int32_t ConstantMaster__GetGrandEffectId(int32_t effectId, const MethodInfo *method)
{
  ...
  if ( (byte_4CC7217 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_3671/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_1"*/);
    sub_1C713B0(&StringLiteral_3672/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_2"*/);
    byte_4CC7217 = 1;
  }
  if ( ConstantMaster__getValue((System_String_o *)StringLiteral_3671/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_1"*/, method) == effectId )
    return ConstantMaster__getValue((System_String_o *)StringLiteral_3672/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_2"*/, v3);
  else
    return effectId;
}
...
float ConstantMaster__GetRateValue(ConstantMaster_o *this, System_String_o *name, float def, const MethodInfo *method)
{
  ...
  if ( (byte_4CC7216 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
    byte_4CC7216 = 1;
  }
  result = 0;
  EntityFromId = DataMasterBase_object__object__object___TryGetEntityFromId(
                   ...
                   &result,
                   name,
                   (const MethodInfo_340CFE8 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
  if ( EntityFromId )
  {
    if ( !result )
...
int32_t ConstantMaster__GetValue_42182688(
...
bool ConstantMaster__IsDisableServantEffectFilter(const MethodInfo *method)
{
  ...
  if ( (byte_4CC7219 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_5008/*"DISABLE_SERVANT_EFFECT_FILTER"*/);
    byte_4CC7219 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_5008/*"DISABLE_SERVANT_EFFECT_FILTER"*/, v1) == 1;
}
...
bool ConstantMaster__IsEnableFixGetQuestPhaseDetail(const MethodInfo *method)
{
  ...
  if ( (byte_4CC721E & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_5417/*"ENABLE_FIX_GET_QUEST_PHASE_DETAIL"*/);
    byte_4CC721E = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_5417/*"ENABLE_FIX_GET_QUEST_PHASE_DETAIL"*/, v1) == 1;
}
...
bool ConstantMaster__IsNotDisplayBattleAttribute(const MethodInfo *method)
{
  ...
  if ( (byte_4CC721B & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_9308/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/);
    byte_4CC721B = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9308/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/, v1) == 1;
}
...
bool ConstantMaster__IsNotUseRestrictionDialog(const MethodInfo *method)
{
  ...
  if ( (byte_4CC721A & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_9323/*"NOT_USE_RESTRICTION_DIALOG"*/);
    byte_4CC721A = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9323/*"NOT_USE_RESTRICTION_DIALOG"*/, v1) == 1;
}
...
bool ConstantMaster__IsOtherImage(const MethodInfo *method)
{
  ...
  if ( (byte_4CC7218 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_8327/*"LOGIN_DAY"*/);
    byte_4CC7218 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime(0).fields._dateData;
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_8327/*"LOGIN_DAY"*/, v1);
  v9 = NetworkManager__getServerDateTime_41644032(Value, 0).fields._dateData;
...
bool ConstantMaster__IsUseSimpleMesh(const MethodInfo *method)
{
  ...
  if ( (byte_4CC721C & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_6411/*"FIGURE_USE_SIMPLE_MESH"*/);
    byte_4CC721C = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_6411/*"FIGURE_USE_SIMPLE_MESH"*/, v1) == 1;
}
