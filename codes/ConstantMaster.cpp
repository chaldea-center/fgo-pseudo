void ConstantMaster___ctor(ConstantMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C56B8B & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
    byte_4C56B8B = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    105,
    (const MethodInfo_33B56EC *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
}
...
int32_t ConstantMaster__GetFlagTransformSvtRestrict(const MethodInfo *method)
{
  ...
  if ( (byte_4C56B96 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_9305/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/);
    byte_4C56B96 = 1;
  }
...
int32_t ConstantMaster__GetGrandEffectId(int32_t effectId, const MethodInfo *method)
{
  ...
  if ( (byte_4C56B90 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_3676/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_1"*/);
    sub_1C3E564(&StringLiteral_3677/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_2"*/);
    byte_4C56B90 = 1;
  }
...
float ConstantMaster__GetRateValue(ConstantMaster_o *this, System_String_o *name, float def, const MethodInfo *method)
{
  ...
  if ( (byte_4C56B8F & 1) == 0 )
  {
    sub_1C3E564(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
    byte_4C56B8F = 1;
  }
  result = 0;
  EntityFromId = DataMasterBase_object__object__object___TryGetEntityFromId(
                   ...
                   &result,
                   name,
                   (const MethodInfo_33B70C0 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
  if ( EntityFromId )
  {
    if ( !result )
...
int32_t ConstantMaster__GetValue_41951728(
...
bool ConstantMaster__IsDisableServantEffectFilter(const MethodInfo *method)
{
  ...
  if ( (byte_4C56B92 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_5018/*"DISABLE_SERVANT_EFFECT_FILTER"*/);
    byte_4C56B92 = 1;
  }
...
bool ConstantMaster__IsEnableFixGetQuestPhaseDetail(const MethodInfo *method)
{
  ...
  if ( (byte_4C56B97 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_5424/*"ENABLE_FIX_GET_QUEST_PHASE_DETAIL"*/);
    byte_4C56B97 = 1;
  }
...
bool ConstantMaster__IsNotDisplayBattleAttribute(const MethodInfo *method)
{
  ...
  if ( (byte_4C56B94 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_9307/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/);
    byte_4C56B94 = 1;
  }
...
bool ConstantMaster__IsNotUseRestrictionDialog(const MethodInfo *method)
{
  ...
  if ( (byte_4C56B93 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_9322/*"NOT_USE_RESTRICTION_DIALOG"*/);
    byte_4C56B93 = 1;
  }
...
bool ConstantMaster__IsOtherImage(const MethodInfo *method)
{
  ...
  if ( (byte_4C56B91 & 1) == 0 )
  {
    ...
    sub_1C3E564(&StringLiteral_8326/*"LOGIN_DAY"*/);
    byte_4C56B91 = 1;
  }
  ...
  v9 = NetworkManager__getServerDateTime_41416004(Value, 0).fields._dateData;
...
bool ConstantMaster__IsUseSimpleMesh(const MethodInfo *method)
{
  ...
  if ( (byte_4C56B95 & 1) == 0 )
  {
    sub_1C3E564(&StringLiteral_6417/*"FIGURE_USE_SIMPLE_MESH"*/);
    byte_4C56B95 = 1;
  }
