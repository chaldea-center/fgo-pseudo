void ConstantMaster___ctor(ConstantMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4C42DE2 & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
    byte_4C42DE2 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    105,
    (const MethodInfo_33A3834 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string___ctor__);
}
...
int32_t ConstantMaster__GetFlagTransformSvtRestrict(const MethodInfo *method)
{
  ...
  if ( (byte_4C42DED & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_9305/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/);
    byte_4C42DED = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9305/*"NOT_CHANGE_BEHAVIOR_TRANSFORM_SVT_ID"*/, v1);
}
...
int32_t ConstantMaster__GetGrandEffectId(int32_t effectId, const MethodInfo *method)
{
  ...
  if ( (byte_4C42DE7 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_3676/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_1"*/);
    sub_1C37058(&StringLiteral_3677/*"COMMAND_SPELL_CLASS_ICON_EFFECT_ID_2"*/);
    byte_4C42DE7 = 1;
  }
...
float ConstantMaster__GetRateValue(ConstantMaster_o *this, System_String_o *name, float def, const MethodInfo *method)
{
  ...
  if ( (byte_4C42DE6 & 1) == 0 )
  {
    sub_1C37058(&Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
    byte_4C42DE6 = 1;
  }
  result = 0;
  EntityFromId = DataMasterBase_object__object__object___TryGetEntityFromId(
                   ...
                   &result,
                   name,
                   (const MethodInfo_33A5208 *)Method_DataMasterBase_ConstantMaster__ConstantEntity__string__TryGetEntityFromId__);
  if ( EntityFromId )
  {
    if ( !result )
...
int32_t ConstantMaster__GetValue_41902656(
...
bool ConstantMaster__IsDisableServantEffectFilter(const MethodInfo *method)
{
  ...
  if ( (byte_4C42DE9 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_5018/*"DISABLE_SERVANT_EFFECT_FILTER"*/);
    byte_4C42DE9 = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_5018/*"DISABLE_SERVANT_EFFECT_FILTER"*/, v1) == 1;
}
...
bool ConstantMaster__IsEnableFixGetQuestPhaseDetail(const MethodInfo *method)
{
  ...
  if ( (byte_4C42DEE & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_5424/*"ENABLE_FIX_GET_QUEST_PHASE_DETAIL"*/);
    byte_4C42DEE = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_5424/*"ENABLE_FIX_GET_QUEST_PHASE_DETAIL"*/, v1) == 1;
}
...
bool ConstantMaster__IsNotDisplayBattleAttribute(const MethodInfo *method)
{
  ...
  if ( (byte_4C42DEB & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_9307/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/);
    byte_4C42DEB = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9307/*"NOT_DISPLAY_BATTLE_ATTRIBUTE"*/, v1) == 1;
}
...
bool ConstantMaster__IsNotUseRestrictionDialog(const MethodInfo *method)
{
  ...
  if ( (byte_4C42DEA & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_9322/*"NOT_USE_RESTRICTION_DIALOG"*/);
    byte_4C42DEA = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_9322/*"NOT_USE_RESTRICTION_DIALOG"*/, v1) == 1;
}
...
bool ConstantMaster__IsOtherImage(const MethodInfo *method)
{
  ...
  if ( (byte_4C42DE8 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_8326/*"LOGIN_DAY"*/);
    byte_4C42DE8 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  dateData = NetworkManager__getServerDateTime(0).fields._dateData;
  Value = ConstantMaster__getValue((System_String_o *)StringLiteral_8326/*"LOGIN_DAY"*/, v1);
  v9 = NetworkManager__getServerDateTime_41367476(Value, 0).fields._dateData;
...
bool ConstantMaster__IsUseSimpleMesh(const MethodInfo *method)
{
  ...
  if ( (byte_4C42DEC & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_6417/*"FIGURE_USE_SIMPLE_MESH"*/);
    byte_4C42DEC = 1;
  }
  return ConstantMaster__getValue((System_String_o *)StringLiteral_6417/*"FIGURE_USE_SIMPLE_MESH"*/, v1) == 1;
}
