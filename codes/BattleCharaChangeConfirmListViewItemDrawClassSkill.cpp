void __fastcall BattleCharaChangeConfirmListViewItemDrawClassSkill___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A13A & 1) == 0 )
  {
    sub_1B863B8(&BattleCharaChangeConfirmListViewItemDrawClassSkill_TypeInfo, v1);
    byte_4A4A13A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A139 & 1) == 0 )
  {
    ...
    sub_1B863B8(&BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject___TypeInfo, v3);
    byte_4A4A139 = 1;
  }
  ...
  v5 = (struct BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject_array *)sub_1B86460(
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.nowClassSkillUIObjectList, (int32_t)v5, v6, v7);
  v8 = (struct BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject_array *)sub_1B86460(
                                                                                               BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject___TypeInfo,
                                                                                               (unsigned int)BalanceConfig_TypeInfo->static_fields->SvtPassiveSkillListMax);
  this->fields.nextClassSkillUIObjectList = v8;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.nextClassSkillUIObjectList, (int32_t)v8, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A138 & 1) == 0 )
  {
    sub_1B863B8(&BattleCharaChangeConfirmListViewItemDrawClassSkill_TypeInfo, method);
    byte_4A4A138 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  struct BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject_array *v15; // x8
  ...
  if ( (byte_4A4A134 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_11689/*"SERVANT_STATUS_BATTLE_CHANGE_CONFIRM_CLASS_SKILL_TITLE"*/, v6);
  ...
  nowGrid = (UnityEngine_Behaviour_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11689/*"SERVANT_STATUS_BATTLE_CHANGE_CONFIRM_CLASS_SKILL_TITLE"*/, 0LL);
  if ( !nowTitleLabel
...
LABEL_33:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( (signed int)i >= *(_DWORD *)(*(_QWORD *)&nowGrid[7].fields.m_CachedPtr + 32LL) )
      break;
...
LABEL_34:
    ...
    if ( !nowGrid )
      goto LABEL_33;
    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)nowGrid, 0, 0LL);
    v15 = this->fields.nowClassSkillUIObjectList;
    if ( !v15 )
      goto LABEL_33;
    if ( i >= v15->max_length )
      goto LABEL_34;
    nowGrid = (UnityEngine_Behaviour_o *)v15->m_Items[i].fields.icon;
    if ( !nowGrid )
      goto LABEL_33;
    SkillIconComponent__Clear((SkillIconComponent_o *)nowGrid, 0LL);
    v16 = this->fields.nextClassSkillUIObjectList;
    if ( !v16 )
      goto LABEL_33;
    if ( i >= v16->max_length )
      goto LABEL_34;
    ...
    if ( !nowGrid )
      goto LABEL_33;
    SkillIconComponent__Clear((SkillIconComponent_o *)nowGrid, 0LL);
    v17 = this->fields.nowClassSkillUIObjectList;
    if ( !v17 )
      goto LABEL_33;
    if ( i >= v17->max_length )
      goto LABEL_34;
    nowGrid = (UnityEngine_Behaviour_o *)v17->m_Items[i].fields.nameLabel;
    if ( !nowGrid )
      goto LABEL_33;
    UILabel__set_text((UILabel_o *)nowGrid, (System_String_o *)StringLiteral_1/*""*/, 0LL);
    v18 = this->fields.nextClassSkillUIObjectList;
    if ( !v18 )
      goto LABEL_33;
    if ( i >= v18->max_length )
      goto LABEL_34;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A135 & 1) == 0 )
  {
    ...
    this = (BattleCharaChangeConfirmListViewItemDrawClassSkill_o *)sub_1B863B8(
...
LABEL_18:
    ...
    for ( i = 0LL; ; ++i )
    {
      ...
      if ( (__int64)i >= SHIDWORD(this[1].fields.arrowSprite->fields.leftAnchor) )
        break;
      if ( !v11 )
        goto LABEL_18;
      if ( i >= v11->max_length )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A136 & 1) == 0 )
  {
    ...
    sub_1B863B8(
      ...
      v7);
    sub_1B863B8(&Method_DataManager_GetMaster_SkillMaster___, v8);
    sub_1B863B8(&DataManager_TypeInfo, v9);
    sub_1B863B8(&Method_DataMasterBase_SkillMaster__SkillEntity__int__TryGetEntity__, v10);
    sub_1B863B8(&Method_BattleCharaChangeConfirmListViewItemDrawClassSkill___c__SetUI_b__11_0__, v11);
    sub_1B863B8(&BattleCharaChangeConfirmListViewItemDrawClassSkill___c_TypeInfo, v12);
    byte_4A4A136 = 1;
  }
  ...
  if ( !_9__11_0 )
  {
    ...
    _9__11_0 = (System_Action_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject__o *)sub_1B86604(System_Action_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject__TypeInfo);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&static_fields->__9__11_0, (int32_t)_9__11_0, v17, v18);
  }
  BasicHelper__ForEach_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject_(
    ...
    (const MethodInfo_2F5AD80 *)Method_BasicHelper_ForEach_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject___);
  if ( !BasicHelper__IsNullOrEmpty((System_Collections_ICollection_o *)classSkillIds, 0LL) )
  {
    ...
    for ( i = &uiObjects->m_Items[0].fields.nameLabel; ; i += 3 )
    {
      ...
      if ( (__int64)v21 >= *(int *)(*(_QWORD *)&Name[7].fields.m_CachedPtr + 36LL) )
        break;
      if ( !classSkillIds )
        goto LABEL_34;
      if ( v21 >= classSkillIds->max_length )
        goto LABEL_35;
      if ( !Master_object )
        goto LABEL_34;
...
LABEL_35:
          ...
          if ( !entity
            || (v24 = *i, Name = (UnityEngine_GameObject_o *)SkillEntity__getName((SkillEntity_o *)entity, 0LL), !v24) )
          {
LABEL_34:
            sub_1B86614(Name, v19);
          }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4A13B & 1) == 0 )
  {
    sub_1B863B8(&BattleCharaChangeConfirmListViewItemDrawClassSkill_TypeInfo, grid);
    sub_1B863B8(
      &Method_System_Linq_Enumerable_Count_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject___,
      v7);
    sub_1B863B8(&System_Func_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject__bool__TypeInfo, v8);
    sub_1B863B8(&Method_BattleCharaChangeConfirmListViewItemDrawClassSkill___c__ReSize_b__12_1__, v9);
    frame = (UISprite_o *)sub_1B863B8(&BattleCharaChangeConfirmListViewItemDrawClassSkill___c_TypeInfo, v10);
    byte_4A4A13B = 1;
  }
  if ( !grid )
    goto LABEL_17;
  ...
  if ( !_9__12_1 )
  {
    ...
    _9__12_1 = (System_Func_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject__bool__o *)sub_1B86604(System_Func_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject__bool__TypeInfo);
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&static_fields->__9__12_1, (int32_t)_9__12_1, v16, v17);
  }
  frame = (UISprite_o *)System_Linq_Enumerable__Count_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject_(
                          ...
                          (const MethodInfo_2F8D560 *)Method_System_Linq_Enumerable_Count_BattleCharaChangeConfirmListViewItemDrawClassSkill_ClassSkillUIObject___);
  v18 = (int)frame;
  if ( !BattleCharaChangeConfirmListViewItemDrawClassSkill_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(BattleCharaChangeConfirmListViewItemDrawClassSkill_TypeInfo);
  if ( !v6 )
...
void __fastcall BattleCharaChangeConfirmListViewItemDrawClassSkill___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4A13C & 1) == 0 )
  {
    sub_1B863B8(&BattleCharaChangeConfirmListViewItemDrawClassSkill___c_TypeInfo, v1);
    byte_4A4A13C = 1;
  }
  v2 = (Il2CppObject *)sub_1B86604(BattleCharaChangeConfirmListViewItemDrawClassSkill___c_TypeInfo);
