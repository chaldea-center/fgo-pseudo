        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    ...
    235,
    (const MethodInfo_2669F88 *)Method_DataMasterBase_EventBulletinBoardReleaseMaster__EventBulletinBoardReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (EventBulletinBoardReleaseEntity_o *)DataMasterBase_WarGroupMaster__WarGroupEntity__string___GetEntity(
                                                ...
                                                PK,
                                                (const MethodInfo_266A024 *)Method_DataMasterBase_EventBulletinBoardReleaseMaster__EventBulletinBoardReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  void *list; // x0
  EventBulletinBoardReleaseEntity_c **v23; // x26
  int32_t v24; // w22
  int32_t v25; // w23
  _DWORD *v26; // x24
  __int64 v27; // x10
  EventBulletinBoardReleaseMaster_o *v28; // x22
  int32_t v29; // w20
  EventBulletinBoardReleaseEntity_c **v30; // x19
  int32_t v31; // w25
  int32_t v32; // w27
  int64_t v33; // x26
  bool IsOpen; // w0
  ...
  if ( (byte_4216EBE & 1) == 0 )
  {
    sub_B0D8A4(&Method_System_Collections_ObjectModel_Collection_DataEntityBase__get_Count__, *(_QWORD *)&messageId);
    ...
    sub_B0D8A4(&EventBulletinBoardReleaseEntity_TypeInfo, v17);
  ...
  if ( (int)list >= 1 )
  {
    v23 = &EventBulletinBoardReleaseEntity_TypeInfo;
    v24 = (int)list;
    v25 = 0;
    v42 = (int)list;
    while ( 1 )
    {
      ...
      if ( *(unsigned __int8 *)(*(_QWORD *)list + 300LL) < (unsigned int)v27
        || *(EventBulletinBoardReleaseEntity_c **)(*(_QWORD *)(*(_QWORD *)list + 200LL) + 8 * v27 - 8) != *v23 )
      {
        break;
      }
      if ( *((_DWORD *)list + 4) == v3 )
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_266A07C *)Method_DataMasterBase_EventBulletinBoardReleaseMaster__EventBulletinBoardReleaseEntity__string__TryGetEntity__);
}