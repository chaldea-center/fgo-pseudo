...
void __fastcall Submarine2DUILocationInfo___ctor(Submarine2DUILocationInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4AEB6 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Collections_Generic_List_Rect__Add__, method);
    sub_1B863B8(&Method_System_Collections_Generic_List_Rect___ctor__, v3);
    sub_1B863B8(&System_Collections_Generic_List_Rect__TypeInfo, v4);
    byte_4A4AEB6 = 1;
  }
  Base2DUILocationInfo___ctor((Base2DUILocationInfo_o *)this, 0LL);
  v5 = (System_Collections_Generic_List_Rect__o *)sub_1B86604(System_Collections_Generic_List_Rect__TypeInfo);
  ...
  if ( (unsigned int)size >= items->max_length )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_360D6F8 **)(*(_QWORD *)(v13[4] + 192LL) + 112LL));
  }
  else
  {
    v15 = &items->obj + size;
  ...
  if ( (unsigned int)v22 >= v20->max_length )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_360D6F8 **)(*(_QWORD *)(v21[4] + 192LL) + 112LL));
  }
  else
  {
    v23 = &v20->obj + v22;
  ...
  if ( (unsigned int)v30 >= v28->max_length )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_360D6F8 **)(*(_QWORD *)(v29[4] + 192LL) + 112LL));
  }
  else
  {
    v31 = &v28->obj + v30;
  ...
  if ( (unsigned int)v38 >= v36->max_length )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_360D6F8 **)(*(_QWORD *)(v37[4] + 192LL) + 112LL));
  }
  else
  {
    v39 = &v36->obj + v38;
  ...
  if ( (unsigned int)v46 >= v44->max_length )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_360D6F8 **)(*(_QWORD *)(v45[4] + 192LL) + 112LL));
  }
  else
  {
    v47 = &v44->obj + v46;
...
LABEL_29:
  ...
  if ( (unsigned int)v56 >= v54->max_length )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_360D6F8 **)(*(_QWORD *)(v55[4] + 192LL) + 112LL));
  }
  else
  {
    v57 = &v54->obj + v56;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields, (int32_t)v5, v48, v49);
}
