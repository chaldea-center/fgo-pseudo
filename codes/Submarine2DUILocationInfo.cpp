...
void Submarine2DUILocationInfo___ctor(Submarine2DUILocationInfo_o *this, const MethodInfo *method)
{
  ...
  v3 = (System_Collections_Generic_List_Rect__o *)sub_1C7BD34(System_Collections_Generic_List_Rect__TypeInfo);
  ...
  if ( (unsigned int)size >= LODWORD(items->max_length) )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_38526F0 **)(*(_QWORD *)(v11[4] + 192LL) + 112LL));
  }
  else
  {
    v13 = &items->obj + size;
  ...
  if ( (unsigned int)v20 >= LODWORD(v18->max_length) )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_38526F0 **)(*(_QWORD *)(v19[4] + 192LL) + 112LL));
  }
  else
  {
    v21 = &v18->obj + v20;
  ...
  if ( (unsigned int)v28 >= LODWORD(v26->max_length) )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_38526F0 **)(*(_QWORD *)(v27[4] + 192LL) + 112LL));
  }
  else
  {
    v29 = &v26->obj + v28;
  ...
  if ( (unsigned int)v36 >= LODWORD(v34->max_length) )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_38526F0 **)(*(_QWORD *)(v35[4] + 192LL) + 112LL));
  }
  else
  {
    v37 = &v34->obj + v36;
  ...
  if ( (unsigned int)v44 >= LODWORD(v42->max_length) )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_38526F0 **)(*(_QWORD *)(v43[4] + 192LL) + 112LL));
  }
  else
  {
    v45 = &v42->obj + v44;
...
LABEL_29:
  ...
  if ( (unsigned int)v58 >= LODWORD(v56->max_length) )
  {
    System_Collections_Generic_List_Rect___AddWithResize(
      ...
      *(const MethodInfo_38526F0 **)(*(_QWORD *)(v57[4] + 192LL) + 112LL));
  }
  else
  {
    v59 = &v56->obj + v58;
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)v3, v46, v47, v48, v49, v50, v51);
}
