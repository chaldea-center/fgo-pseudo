        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AF2E & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_List_UISprite__ToArray__, objList);
    this = (QuestBoardListViewMultiSecondBattleInformation_o *)sub_1B761C0(
  ...
  v6 = System_Collections_Generic_List_object___ToArray(
         ...
         (const MethodInfo_34D912C *)Method_System_Collections_Generic_List_UISprite__ToArray__);
  v4->fields.spList = (struct UISprite_array *)v6;
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v4->fields.spList, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.spList, 0, v2, v3);
  v4->fields.oldSp = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AF2F & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Linq_Enumerable_Count_UISprite___, method);
...
LABEL_19:
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.oldSp, (int32_t)v14, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2AF2D & 1) == 0 )
  {
    sub_1B761C0(&QuestBoardListViewMultiSecondBattleInformation_TypeInfo, method);
    byte_4A2AF2D = 1;
  }
