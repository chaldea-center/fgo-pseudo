        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E769D4 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantCharaGraphEquipFilterLogic_TypeInfo);
    byte_4E769D4 = 1;
  }
  v2 = (Il2CppObject *)sub_1D0F300(ServantCharaGraphEquipFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E769D3 & 1) == 0 )
  {
    sub_1D0F0B4(&ServantEquipCharaGraphSortLogic_TypeInfo);
    byte_4E769D3 = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1D0F300(ServantEquipCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_1313/*"2"*/;
}