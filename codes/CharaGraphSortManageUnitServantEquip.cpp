        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD91C & 1) == 0 )
  {
    sub_1B64870(&ServantCharaGraphEquipFilterLogic_TypeInfo, method);
    byte_49FD91C = 1;
  }
  v2 = (ServantCharaGraphFilterLogic_o *)sub_1B64ABC(ServantCharaGraphEquipFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD91B & 1) == 0 )
  {
    sub_1B64870(&ServantEquipCharaGraphSortLogic_TypeInfo, method);
    byte_49FD91B = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1B64ABC(ServantEquipCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_49FD91A & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_1414/*"2"*/, method);
    byte_49FD91A = 1;
  }
