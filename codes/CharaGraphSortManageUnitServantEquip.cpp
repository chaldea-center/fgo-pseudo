        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC670E & 1) == 0 )
  {
    sub_1C713B0(&ServantCharaGraphEquipFilterLogic_TypeInfo);
    byte_4CC670E = 1;
  }
  v2 = (Il2CppObject *)sub_1C715FC(ServantCharaGraphEquipFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC670D & 1) == 0 )
  {
    sub_1C713B0(&ServantEquipCharaGraphSortLogic_TypeInfo);
    byte_4CC670D = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1C715FC(ServantEquipCharaGraphSortLogic_TypeInfo);
