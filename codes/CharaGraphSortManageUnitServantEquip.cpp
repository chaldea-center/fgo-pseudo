        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BB70 & 1) == 0 )
  {
    sub_1C94098(&ServantCharaGraphEquipFilterLogic_TypeInfo);
    byte_4D2BB70 = 1;
  }
  v2 = (Il2CppObject *)sub_1C942E4(ServantCharaGraphEquipFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2BB6F & 1) == 0 )
  {
    sub_1C94098(&ServantEquipCharaGraphSortLogic_TypeInfo);
    byte_4D2BB6F = 1;
  }
  v2 = (CharaGraphSortLogicBase_o *)sub_1C942E4(ServantEquipCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  return (System_String_o *)StringLiteral_1310/*"2"*/;
}