        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F261 & 1) == 0 )
  {
    sub_1B90010(&ServantCharaGraphEquipFilterLogic_TypeInfo, method);
    byte_4A6F261 = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(ServantCharaGraphEquipFilterLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6F260 & 1) == 0 )
  {
    sub_1B90010(&ServantEquipCharaGraphSortLogic_TypeInfo, method);
    byte_4A6F260 = 1;
  }
  v2 = (ServantEquipCharaGraphSortLogic_o *)sub_1B9025C(ServantEquipCharaGraphSortLogic_TypeInfo);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A6F25F & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_1413/*"2"*/, method);
    byte_4A6F25F = 1;
  }
