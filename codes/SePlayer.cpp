        ...
        const MethodInfo *method)
{
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.objName, (int32_t)name, v22, v23, v24, v25, v26, v27);
...
LABEL_7:
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.callbackFunc, (int32_t)v36, v30, v31, v32, v33, v34, v35);
  BaseVolume = 0.0;
  ...
  *(_WORD *)&this->fields.isLoading = 256;
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.cueSheetName, (int32_t)v41, v42, v43, v44, v45, v46, v47);
  PreDelayTime = 0.0;
...
void SePlayer__Destroy(SePlayer_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(source, 0, 0) )
  {
    ...
    *p_source = 0;
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.source, 0, v12, v13, v14, v15, v16, v17);
  }
...
void SePlayer__RemoveCallback(SePlayer_o *this, System_Action_o *callbackFunc, const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1C7BA8C(p_callbackFunc, (int32_t)v7, v8, v9, v10, v11, v12, v13);
  }
}
    ...
    if ( fadeoutTime <= 0.0 )
    {
      ...
      *(_WORD *)&this->fields.isStop = 1;
      ...
      if ( UnityEngine_Object__op_Inequality(source, 0, 0) )
      {
        ...
        *p_source = 0;
        sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.source, 0, v11, v12, v13, v14, v15, v16);
      }
      Instance = (CriAtomSource_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_SeManager__get_Instance__);
      if ( Instance )
      {
        SeManager__ReleaseAudioSource((SeManager_o *)Instance, this, v17);
        return;
      }
    }
    else
...
bool SePlayer__Update(SePlayer_o *this, float delta, const MethodInfo *method)
{
  ...
  struct CriAtomSource_o *AudioSource_42075960; // x0
  int32_t v12; // w2
  int32_t v13; // w3
  System_String_o *v14; // x4
  int32_t v15; // w5
  ...
  if ( (byte_4CEE060 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_16131/*"] vol:"*/);
    sub_1C7BAE8(&StringLiteral_16118/*"] : ["*/);
    sub_1C7BAE8(&StringLiteral_11563/*"SE Play (not found) for debug : ["*/);
    byte_4CEE060 = 1;
  }
  volume = 0.0;
  ...
  if ( UnityEngine_Object__op_Equality(source, 0, 0) )
  {
    ...
    {
      Instance = (__int64)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A8C5A8 *)Method_SingletonMonoBehaviour_SeManager__get_Instance__);
      if ( !Instance )
        goto LABEL_97;
      AudioSource_42075960 = SeManager__GetAudioSource_42075960(
                               ...
                               v10);
      this->fields.source = AudioSource_42075960;
      sub_1C7BA8C(
        (GrandQuestFolderBoardItem_o *)&this->fields.source,
        (int32_t)AudioSource_42075960,
        v12,
        v13,
        v14,
        v15,
      ...
      *(_QWORD *)(Instance + 120) = cueSheetName;
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(Instance + 120), (int32_t)cueSheetName, v19, v20, v21, v22, v23, v24);
      Instance = (__int64)this->fields.source;
      if ( !Instance )
        goto LABEL_97;
      objName = this->fields.objName;
      *(_QWORD *)(Instance + 112) = objName;
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(Instance + 112), (int32_t)objName, v26, v27, v28, v29, v30, v31);
      ...
      if ( !SoundManager__IsExistsSound(
              ...
              v59) )
      {
        Instance = sub_1C7BB90(string___TypeInfo, 6);
        if ( !Instance )
          goto LABEL_97;
        v68 = Instance;
        if ( *(_DWORD *)(Instance + 24) )
        {
          v69 = StringLiteral_11563/*"SE Play (not found) for debug : ["*/;
          *(_QWORD *)(Instance + 32) = StringLiteral_11563/*"SE Play (not found) for debug : ["*/;
          sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(Instance + 32), v69, v62, v63, v64, v65, v66, v67);
          if ( *(_DWORD *)(v68 + 24) > 1u )
          {
            v76 = this->fields.cueSheetName;
            *(_QWORD *)(v68 + 40) = v76;
            sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v68 + 40), (int32_t)v76, v70, v71, v72, v73, v74, v75);
            if ( *(_DWORD *)(v68 + 24) > 2u )
            {
              v83 = StringLiteral_16118/*"] : ["*/;
              *(_QWORD *)(v68 + 48) = StringLiteral_16118/*"] : ["*/;
              sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v68 + 48), v83, v77, v78, v79, v80, v81, v82);
              if ( *(_DWORD *)(v68 + 24) > 3u )
              {
                v90 = this->fields.objName;
                *(_QWORD *)(v68 + 56) = v90;
                sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v68 + 56), (int32_t)v90, v84, v85, v86, v87, v88, v89);
                if ( *(_DWORD *)(v68 + 24) > 4u )
                {
                  v97 = StringLiteral_16131/*"] vol:"*/;
                  *(_QWORD *)(v68 + 64) = StringLiteral_16131/*"] vol:"*/;
                  ...
                  if ( *(_DWORD *)(v68 + 24) > 5u )
                  {
                    *(_QWORD *)(v68 + 72) = Instance;
                    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)(v68 + 72), Instance, v98, v99, v100, v101, v102, v103);
                    System_String__Concat_64217444((System_String_array *)v68, 0);
                    goto LABEL_4;
                  }
                }
              }
...
LABEL_61:
  ...
  if ( fadeoutTime > 0.0 )
  {
    ...
    if ( v37 >= fadeoutTime )
    {
      ...
      *p_source = 0;
      sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields.source, 0, v47, v48, v49, v50, v51, v52);
      goto LABEL_61;
    }
    if ( !SeManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(SeManager_TypeInfo);
