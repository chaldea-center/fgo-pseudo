void FigureViewListViewItemDraw___ctor(FigureViewListViewItemDraw_o *this, const MethodInfo *method)
{
...
void FigureViewListViewItemDraw__SetItem(
        FigureViewListViewItemDraw_o *this,
        FigureViewListViewItem_o *item,
        int32_t mode,
        const MethodInfo *method)
{
  ...
  if ( item && mode )
  {
    if ( FigureViewListViewItem__get_TitleText(item, (const MethodInfo *)item) )
    {
      titleTextLabel = this->fields.titleTextLabel;
      TitleText = FigureViewListViewItem__get_TitleText(item, v7);
      if ( !titleTextLabel )
        goto LABEL_20;
