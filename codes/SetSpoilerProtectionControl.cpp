...
void SetSpoilerProtectionControl__Init(SetSpoilerProtectionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E72597 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_9827/*"OPTION_SPOILER_PROTECTION_INFO"*/);
    sub_1D0F0B4(&StringLiteral_9828/*"OPTION_SPOILER_PROTECTION_TITLE"*/);
    byte_4E72597 = 1;
  }
  btnTitle = this->fields.btnTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9828/*"OPTION_SPOILER_PROTECTION_TITLE"*/, 0);
  if ( !btnTitle
    || (UILabel__set_text(btnTitle, v4, 0),
        infoLabel = this->fields.infoLabel,
        v4 = LocalizationManager__Get((System_String_o *)StringLiteral_9827/*"OPTION_SPOILER_PROTECTION_INFO"*/, 0),
        !infoLabel) )
  {
    sub_1D0F30C(v4, v5);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7259A & 1) == 0 )
  {
    sub_1D0F0B4(&Method_SetSpoilerProtectionControl_OnClickSpoilerProtection__);
    byte_4E7259A = 1;
  }
  ...
  if ( (*((_BYTE *)Method_SetSpoilerProtectionControl_OnClickSpoilerProtection__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1D0F0CC(Method_SetSpoilerProtectionControl_OnClickSpoilerProtection__);
