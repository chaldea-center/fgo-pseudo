        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2125C & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_16583/*"accountLinkageAnx/beginAuth"*/, v2);
    byte_4A2125C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_16583/*"accountLinkageAnx/beginAuth"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2125D & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_22056/*"nonce"*/, v6);
    sub_1B715CC(&StringLiteral_22170/*"ok"*/, v7);
    sub_1B715CC(&StringLiteral_19651/*"gameId"*/, v8);
    sub_1B715CC(&StringLiteral_22762/*"redirectUri"*/, v9);
    sub_1B715CC(&StringLiteral_17963/*"clientId"*/, v10);
    sub_1B715CC(&StringLiteral_22000/*"ng"*/, v11);
    this = (AccountLinkageBeginAuthRequest_o *)sub_1B715CC(&StringLiteral_16928/*"authorizationUrl"*/, v12);
    byte_4A2125D = 1;
  }
  if ( !responseList )
    goto LABEL_19;
  ...
  if ( ((unsigned __int8)this & 1) != 0 )
  {
    ...
    if ( success )
    {
      this = (AccountLinkageBeginAuthRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                                   success,
                                                   (Il2CppObject *)StringLiteral_16928/*"authorizationUrl"*/,
      ...
      if ( this )
      {
        ...
        this = (AccountLinkageBeginAuthRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                                     success,
                                                     (Il2CppObject *)StringLiteral_19651/*"gameId"*/,
                                                     (const MethodInfo_319EC90 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( this )
        {
          ...
          this = (AccountLinkageBeginAuthRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                                       success,
                                                       (Il2CppObject *)StringLiteral_17963/*"clientId"*/,
                                                       (const MethodInfo_319EC90 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
          if ( this )
          {
            ...
            this = (AccountLinkageBeginAuthRequest_o *)System_Collections_Generic_Dictionary_object__object___get_Item(
                                                         success,
                                                         (Il2CppObject *)StringLiteral_22762/*"redirectUri"*/,
                                                         (const MethodInfo_319EC90 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
            if ( this )
            {
              ...
              if ( this )
              {
                ...
                sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->authorizationUrl, v15, v21, v22);
                v23 = AccountLinkageParams_TypeInfo->static_fields;
                v23->gameId = (struct System_String_o *)v16;
                sub_1B71570((ServantStatusBattleListViewItem_o *)&v23->gameId, v16, v24, v25);
                v26 = AccountLinkageParams_TypeInfo->static_fields;
                v26->clientId = (struct System_String_o *)v17;
                sub_1B71570((ServantStatusBattleListViewItem_o *)&v26->clientId, v17, v27, v28);
                v29 = AccountLinkageParams_TypeInfo->static_fields;
                v29->redirectUri = (struct System_String_o *)v18;
                sub_1B71570((ServantStatusBattleListViewItem_o *)&v29->redirectUri, v18, v30, v31);
                v32 = AccountLinkageParams_TypeInfo->static_fields;
                v32->nonce = (struct System_String_o *)v19;
                sub_1B71570((ServantStatusBattleListViewItem_o *)&v32->nonce, v19, v33, v34);
                CallBack = v4->fields.CallBack;
                if ( CallBack )
                {
                  v36 = &StringLiteral_22170/*"ok"*/;
LABEL_17:
