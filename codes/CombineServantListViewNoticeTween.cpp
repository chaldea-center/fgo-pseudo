        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523A6 & 1) == 0 )
  {
    sub_1B863B8(
      ...
      monoBehaviour);
    sub_1B863B8(&System_Collections_Generic_List_CombineServantListViewNoticeTween_TweenController__TypeInfo, v5);
    byte_4A523A6 = 1;
  }
  this->fields.to = 1.0;
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.monoBehaviour = monoBehaviour;
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.monoBehaviour, (int32_t)monoBehaviour, v6, v7);
  v8 = (System_Collections_Generic_List_object__o *)sub_1B86604(System_Collections_Generic_List_CombineServantListViewNoticeTween_TweenController__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v8,
    (const MethodInfo_35FC124 *)Method_System_Collections_Generic_List_CombineServantListViewNoticeTween_TweenController___ctor__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523A7 & 1) == 0 )
  {
    sub_1B863B8(
      ...
      tweenTarget);
    sub_1B863B8(&CombineServantListViewNoticeTween_TweenController_TypeInfo, v7);
    byte_4A523A7 = 1;
  }
          ...
          (const MethodInfo *)texts) )
  {
    ...
    v9 = (CombineServantListViewNoticeTween_TweenController_o *)sub_1B86604(CombineServantListViewNoticeTween_TweenController_TypeInfo);
    ...
    else
    {
      ...
      sub_1B8635C((CGThumbnailListItem_o *)(v18 + 4), (int32_t)v9, v13, v14);
    }
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523AC & 1) == 0 )
  {
    this = (CombineServantListViewNoticeTween_o *)sub_1B863B8(&UnityEngine_Object_TypeInfo, tweenAlphas);
    byte_4A523AC = 1;
  }
  if ( !tweenAlphas )
LABEL_16:
        ...
        const MethodInfo *method)
{
  ...
  if ( !tweenControllers )
LABEL_11:
    sub_1B86614(tweenControllers, tweenTarget);
  v8 = 0;
  while ( 1 )
  {
    size = tweenControllers->fields._size;
    ...
    tweenControllers = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                      tweenControllers,
                                                                      v8,
                                                                      (const MethodInfo_35FC688 *)Method_System_Collections_Generic_List_CombineServantListViewNoticeTween_TweenController__get_Item__);
    if ( !tweenControllers )
      goto LABEL_11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523A9 & 1) == 0 )
  {
    sub_1B863B8(
      ...
      tweenTarget);
    sub_1B863B8(&System_Predicate_CombineServantListViewNoticeTween_TweenController__TypeInfo, v5);
    sub_1B863B8(&Method_CombineServantListViewNoticeTween___c__DisplayClass9_0__RemoveTarget_b__0__, v6);
    sub_1B863B8(&CombineServantListViewNoticeTween___c__DisplayClass9_0_TypeInfo, v7);
    byte_4A523A9 = 1;
  }
  v8 = sub_1B86604(CombineServantListViewNoticeTween___c__DisplayClass9_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8
    || (*(_QWORD *)(v8 + 16) = tweenTarget,
        sub_1B8635C((CGThumbnailListItem_o *)(v8 + 16), (int32_t)tweenTarget, v11, v12),
        tweenControllers = (System_Collections_Generic_List_object__o *)this->fields.tweenControllers,
        v14 = (System_Predicate_object__o *)sub_1B86604(System_Predicate_CombineServantListViewNoticeTween_TweenController__TypeInfo),
  ...
  System_Collections_Generic_List_object___RemoveAll(
    ...
    (const MethodInfo_35FDFB4 *)Method_System_Collections_Generic_List_CombineServantListViewNoticeTween_TweenController__RemoveAll__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !isSwitch )
  {
    if ( tweenControllers )
      goto LABEL_11;
LABEL_15:
    sub_1B86614(tweenControllers, isSwitch);
  }
  if ( !tweenControllers )
    goto LABEL_15;
  v7 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523AB & 1) == 0 )
  {
    sub_1B863B8(&CombineServantListViewNoticeTween__TweenLoop_d__13_TypeInfo, method);
    byte_4A523AB = 1;
  }
  v3 = sub_1B86604(CombineServantListViewNoticeTween__TweenLoop_d__13_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&v6->fields, (int32_t)tweenTarget, v7, v8);
  v6->fields._Texts_k__BackingField = texts;
  v6 = (CombineServantListViewNoticeTween_TweenController_o *)((char *)v6 + 24);
  sub_1B8635C((CGThumbnailListItem_o *)v6, (int32_t)texts, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523AE & 1) == 0 )
  {
    this = (CombineServantListViewNoticeTween_TweenController_o *)sub_1B863B8(
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B86614(Texts_k__BackingField, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields._Texts_k__BackingField, (int32_t)value, (int32_t)method, v3);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523B1 & 1) == 0 )
  {
    ...
    this = (CombineServantListViewNoticeTween__TweenLoop_d__13_o *)sub_1B863B8(&UnityEngine_WaitForSeconds_TypeInfo, v8);
    byte_4A523B1 = 1;
  }
  ...
  switch ( v4->fields.__1__state )
  {
    case 0:
      ...
      sub_1B8635C((CGThumbnailListItem_o *)&v4->fields._loopWaitOnShow_5__2, (int32_t)v10, v11, v12);
      if ( !_4__this )
        goto LABEL_40;
      if ( _4__this->fields.to == 0.0 )
      {
        ...
        sub_1B8635C(p__2__current, (int32_t)loopWaitOnShow_5__2, (int32_t)v2, v3);
        result = 1;
...
LABEL_40:
    ...
    if ( !tweenControllers || (size = (unsigned int)tweenControllers->fields._size, !(_DWORD)size) )
    {
      ...
      sub_1B8635C(v34, 0, (int32_t)v2, v3);
      v35 = 2;
      goto LABEL_48;
    }
    v20 = sub_1B86460(TweenAlpha___TypeInfo, size);
    v4->fields._tweenAlphas_5__3 = (struct TweenAlpha_array *)v20;
    p_tweenAlphas_5__3 = (unsigned int **)&v4->fields._tweenAlphas_5__3;
    sub_1B8635C((CGThumbnailListItem_o *)&v4->fields._tweenAlphas_5__3, v20, v22, v23);
    ...
    while ( (__int64)v24 < SLODWORD(this->fields.__2__current) )
    {
      ...
      if ( !UnityEngine_Object__op_Equality(v25, 0LL, 0LL) )
      {
        ...
        if ( this )
        {
          this = (CombineServantListViewNoticeTween__TweenLoop_d__13_o *)sub_1B864F4(
                                                                           this,
        ...
        v31 = &v26[2 * v24];
        *((_QWORD *)v31 + 4) = v30;
        sub_1B8635C((CGThumbnailListItem_o *)(v31 + 8), (int32_t)v30, v28, v29);
...
LABEL_9:
    ...
    if ( v16 )
    {
      ...
      v34 = (CGThumbnailListItem_o *)&v4->fields.__2__current;
      sub_1B8635C(v34, (int32_t)v36, (int32_t)v2, v3);
      v35 = 4;
      goto LABEL_48;
    }
LABEL_14:
    ...
    sub_1B8635C((CGThumbnailListItem_o *)&v4->fields._tweenAlphas_5__3, 0, (int32_t)v2, v3);
  }
  if ( !_4__this->fields.isTween )
    return 0;
  v4->fields.__2__current = 0LL;
  ...
  v35 = 3;
LABEL_48:
  LODWORD(v34[-1].fields._ThumbnailSpritePath_k__BackingField) = v35;
  return 1;
}
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B863CC(&Method_CombineServantListViewNoticeTween__TweenLoop_d__13_System_Collections_IEnumerator_Reset__);
  sub_1B864E0(v3, v4);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A523B0 & 1) == 0 )
  {
    this = (CombineServantListViewNoticeTween___c__DisplayClass9_0_o *)sub_1B863B8(&UnityEngine_Object_TypeInfo, t);
    byte_4A523B0 = 1;
  }
  if ( !t )
    sub_1B86614(this, t);
