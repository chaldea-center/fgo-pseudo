...
bool UserEquipEntity__IsNew(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v10.fields.fakeValue = v4;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v10, 0);
  lv = this->fields.lv;
  v8 = v6;
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v55.fields.fakeValue = v18;
  SelfUserGame = (UserGameEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v55, 0);
  if ( !v20 )
    goto LABEL_25;
  ...
  if ( !Entity )
  {
    ...
    *equipName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1C9403C((GrandQuestFolderBoardItem_o *)equipName, StringLiteral_1/*""*/, v22, v23, v24, v25, v26, v27);
    *detail = (System_String_o *)StringLiteral_1/*""*/;
    sub_1C9403C((GrandQuestFolderBoardItem_o *)detail, StringLiteral_1/*""*/, v48, v49, v50, v51, v52, v53);
    v54 = 0;
    goto LABEL_23;
  }
  v28 = Entity;
  ...
  *maxLv = HIDWORD(Entity[3].monitor);
  ...
  v30 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49657388(klass, 0);
  *equipName = v30;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)equipName, (int32_t)v30, v31, v32, v33, v34, v35, v36);
  v37 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49657388(
          (CodeStage_AntiCheat_ObscuredTypes_ObscuredString_o *)v28[3].klass,
          0);
  *detail = v37;
  sub_1C9403C((GrandQuestFolderBoardItem_o *)detail, (int32_t)v37, v38, v39, v40, v41, v42, v43);
  *genderImageId = 0;
  SelfUserGame = UserGameMaster__getSelfUserGame(0);
  if ( !SelfUserGame )
LABEL_25:
    sub_1C942F0(SelfUserGame, condUsrLv);
  ...
  *(_QWORD *)&v56.fields.fakeValue = monitor;
  v54 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v56, 0);
LABEL_23:
  *genderImageId = v54;
}
...
System_Int32_array *UserEquipEntity__getSkillIdList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D63B & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_DataManager_GetMasterData_EquipSkillMaster___);
  ...
  v5 = sub_1C94140(int___TypeInfo, (unsigned int)v3->static_fields->UserEquipSkillListMax);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_319C134 *)Method_DataManager_GetMasterData_EquipSkillMaster___),
        !v5) )
  {
LABEL_25:
    sub_1C942F0(MasterData_object, v4);
  }
  if ( *(int *)(v5 + 24) >= 1 )
  {
    ...
    do
    {
      ...
      for ( i = (int32_t *)(v5 + 4LL * (v11 - 1) + 32); ; *i = -1 )
      {
        ...
        *(_QWORD *)&v21.fields.fakeValue = v14;
        MasterData_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v21, 0);
        if ( !v10 )
          goto LABEL_25;
...
int32_t UserEquipEntity__getSkillLv(UserEquipEntity_o *this, int32_t index, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v12.fields.fakeValue = v8;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v12, 0);
  if ( !v10 )
    goto LABEL_17;
...
System_Int32_array *UserEquipEntity__getSkillLvList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v11.fields.fakeValue = v6;
  result = (System_Int32_array *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49621544(v11, 0);
  if ( !v8
