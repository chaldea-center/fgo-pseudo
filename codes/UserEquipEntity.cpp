...
bool UserEquipEntity__IsNew(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v10.fields.fakeValue = v4;
  v6 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v10, 0);
  lv = this->fields.lv;
  v8 = v6;
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v40.fields.fakeValue = v18;
  SelfUserGame = (UserGameEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v40, 0);
  if ( !v20 )
    goto LABEL_25;
  ...
  if ( !Entity )
  {
    ...
    *equipName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1C2D434((CGThumbnailListItem_o *)equipName, StringLiteral_1/*""*/, v22, v23);
    *detail = (System_String_o *)StringLiteral_1/*""*/;
    sub_1C2D434((CGThumbnailListItem_o *)detail, StringLiteral_1/*""*/, v37, v38);
    v39 = 0;
    goto LABEL_23;
  }
  v24 = Entity;
  ...
  *maxLv = HIDWORD(Entity[3].monitor);
  ...
  v26 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_48863712(klass, 0);
  *equipName = v26;
  sub_1C2D434((CGThumbnailListItem_o *)equipName, (int32_t)v26, v27, v28);
  v29 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_48863712(
          (CodeStage_AntiCheat_ObscuredTypes_ObscuredString_o *)v24[3].klass,
          0);
  *detail = v29;
  sub_1C2D434((CGThumbnailListItem_o *)detail, (int32_t)v29, v30, v31);
  *genderImageId = 0;
  SelfUserGame = UserGameMaster__getSelfUserGame(v32);
  if ( !SelfUserGame )
LABEL_25:
    sub_1C2D6EC(SelfUserGame, condUsrLv);
  ...
  *(_QWORD *)&v41.fields.fakeValue = monitor;
  v39 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v41, 0);
LABEL_23:
  *genderImageId = v39;
}
...
System_Int32_array *UserEquipEntity__getSkillIdList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2805D & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_DataManager_GetMasterData_EquipSkillMaster___);
  ...
  v5 = sub_1C2D538(int___TypeInfo, (unsigned int)v3->static_fields->UserEquipSkillListMax);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_EquipSkillMaster___),
        !v5) )
  {
LABEL_25:
    ...
    do
    {
      ...
      for ( i = (int32_t *)(v5 + 4LL * (v11 - 1) + 32); ; *i = -1 )
      {
        ...
        *(_QWORD *)&v23.fields.fakeValue = v14;
        MasterData_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v23, 0);
        if ( !v10 )
          goto LABEL_25;
...
int32_t UserEquipEntity__getSkillLv(UserEquipEntity_o *this, int32_t index, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v12.fields.fakeValue = v8;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v12, 0);
  if ( !v10 )
    goto LABEL_17;
...
System_Int32_array *UserEquipEntity__getSkillLvList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&v12.fields.fakeValue = v6;
  result = (System_Int32_array *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_48827868(v12, 0);
  if ( !v8
