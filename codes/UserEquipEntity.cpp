...
bool __fastcall UserEquipEntity__IsNew(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FCFF0 & 1) == 0 )
  {
    ...
    sub_1B640C8(&UserEquipNewManager_TypeInfo, v4);
    byte_49FCFF0 = 1;
  }
  ...
  *(_QWORD *)&v11.fields.fakeValue = v5;
  v7 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46171608(v11, 0LL);
  lv = this->fields.lv;
  v9 = v7;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCFEE & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_EquipMaster___, condUsrLv);
    ...
    sub_1B640C8(&Method_SingletonMonoBehaviour_DataManager__getInstance__, v16);
  ...
  *(_QWORD *)&v44.fields.fakeValue = v22;
  SelfUserGame = (UserGameEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46171608(v44, 0LL);
  if ( !v24 )
    goto LABEL_25;
  ...
  if ( !Entity )
  {
    ...
    *equipName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)equipName, (int32_t)StringLiteral_1/*""*/, v26, v27);
    *detail = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B6406C((ServantStatusBattleListViewItem_o *)detail, (int32_t)StringLiteral_1/*""*/, v41, v42);
    v43 = 0;
    goto LABEL_23;
  }
  v28 = Entity;
  ...
  *maxLv = HIDWORD(Entity[3].monitor);
  ...
  v30 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46207452(klass, 0LL);
  *equipName = v30;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)equipName, (int32_t)v30, v31, v32);
  v33 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46207452(
          (CodeStage_AntiCheat_ObscuredTypes_ObscuredString_o *)v28[3].klass,
          0LL);
  *detail = v33;
  sub_1B6406C((ServantStatusBattleListViewItem_o *)detail, (int32_t)v33, v34, v35);
  *genderImageId = 0;
...
LABEL_25:
  ...
  *(_QWORD *)&v45.fields.fakeValue = monitor;
  v43 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46171608(v45, 0LL);
LABEL_23:
  *genderImageId = v43;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FCFEF & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_EquipExpMaster___, exp);
    sub_1B640C8(&Method_DataManager_GetMasterData_EquipMaster___, v9);
    sub_1B640C8(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v10);
  ...
  if ( this->fields.lv < SHIDWORD(Instance->fields.masterDataBytes) )
  {
    ...
    if ( this->fields.lv >= 2 )
    {
      ...
      *(_QWORD *)&v26.fields.fakeValue = v21;
      Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46171608(v26, 0LL);
      if ( !v18 )
        goto LABEL_24;
      Instance = (DataManager_o *)EquipExpMaster__GetEntity(
                                    (EquipExpMaster_o *)v18,
                                    (int32_t)Instance,
                                    this->fields.lv - 1,
                                    0LL);
      if ( !Instance )
...
System_Int32_array *__fastcall UserEquipEntity__getSkillIdList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FCFED & 1) == 0 )
  {
    ...
    sub_1B640C8(&Method_DataManager_GetMasterData_EquipSkillMaster___, v3);
  ...
  v8 = (System_Int32_array *)sub_1B64170(int___TypeInfo, (unsigned int)v7->static_fields->UserEquipSkillListMax);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2E393EC *)Method_DataManager_GetMasterData_EquipSkillMaster___),
        !v8) )
  {
LABEL_25:
  ...
  {
    v12 = (EquipSkillMaster_o *)MasterData_object;
    v13 = 1;
    do
    {
      v14 = v13 - 1;
      for ( i = &v8->m_Items[v13]; ; *i = -1 )
      {
        ...
        *(_QWORD *)&v24.fields.fakeValue = v16;
        MasterData_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46171608(
                                              v24,
                                              0LL);
        if ( !v12 )
          goto LABEL_25;
        Entity = EquipSkillMaster__GetEntity(v12, (int32_t)MasterData_object, v13, 0LL);
        if ( !Entity )
          goto LABEL_23;
        v19 = Entity;
...
int32_t __fastcall UserEquipEntity__getSkillLv(UserEquipEntity_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_49FCFEB & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_EquipExpMaster___, *(_QWORD *)&index);
    sub_1B640C8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
  ...
  *(_QWORD *)&v13.fields.fakeValue = v9;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46171608(v13, 0LL);
  if ( !v11 )
    goto LABEL_17;
...
System_Int32_array *__fastcall UserEquipEntity__getSkillLvList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FCFEC & 1) == 0 )
  {
    sub_1B640C8(&Method_DataManager_GetMasterData_EquipExpMaster___, method);
  ...
  *(_QWORD *)&v14.fields.fakeValue = v8;
  result = (System_Int32_array *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46171608(v14, 0LL);
  if ( !v10
