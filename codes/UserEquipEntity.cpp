...
bool __fastcall UserEquipEntity__IsNew(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1B4 & 1) == 0 )
  {
    ...
    sub_1B863B8(&UserEquipNewManager_TypeInfo, v4);
    byte_4A4F1B4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1B2 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EquipMaster___, condUsrLv);
  ...
  *(_QWORD *)&v44.fields.fakeValue = v23;
  SelfUserGame = (UserGameEntity_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v44, 0LL);
  if ( !v25 )
    goto LABEL_25;
  ...
  if ( !Entity )
  {
    ...
    *equipName = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B8635C((CGThumbnailListItem_o *)equipName, (int32_t)StringLiteral_1/*""*/, v27, v28);
    *detail = (System_String_o *)StringLiteral_1/*""*/;
    sub_1B8635C((CGThumbnailListItem_o *)detail, (int32_t)StringLiteral_1/*""*/, v41, v42);
    v43 = 0;
    goto LABEL_23;
  }
  v29 = Entity;
  ...
  *maxLv = HIDWORD(Entity[3].monitor);
  ...
  v31 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47470088(klass, 0LL);
  *equipName = v31;
  sub_1B8635C((CGThumbnailListItem_o *)equipName, (int32_t)v31, v32, v33);
  v34 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_47470088(
          (CodeStage_AntiCheat_ObscuredTypes_ObscuredString_o *)v29[3].klass,
          0LL);
  *detail = v34;
  sub_1B8635C((CGThumbnailListItem_o *)detail, (int32_t)v34, v35, v36);
  *genderImageId = 0;
  SelfUserGame = UserGameMaster__getSelfUserGame(0LL);
  if ( !SelfUserGame )
LABEL_25:
    sub_1B86614(SelfUserGame, condUsrLv);
  ...
  *(_QWORD *)&v45.fields.fakeValue = monitor;
  v43 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v45, 0LL);
LABEL_23:
  *genderImageId = v43;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1B3 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EquipExpMaster___, exp);
    sub_1B863B8(&Method_DataManager_GetMasterData_EquipMaster___, v9);
    sub_1B863B8(&Method_DataMasterBase_EquipMaster__EquipEntity__int__GetEntity__, v10);
  ...
  if ( this->fields.lv < SHIDWORD(Instance->fields.masterDataBytes) )
  {
    ...
    if ( this->fields.lv >= 2 )
    {
      ...
      *(_QWORD *)&v27.fields.fakeValue = v22;
      Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v27, 0LL);
      if ( !v19 )
        goto LABEL_24;
...
System_Int32_array *__fastcall UserEquipEntity__getSkillIdList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1B1 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_DataManager_GetMasterData_EquipSkillMaster___, v3);
  ...
  v9 = (System_Int32_array *)sub_1B86460(int___TypeInfo, (unsigned int)v7->static_fields->UserEquipSkillListMax);
  ...
  if ( !MasterData_object
    || (MasterData_object = DataManager__GetMasterData_object_(
                              ...
                              (const MethodInfo_2F6DCB8 *)Method_DataManager_GetMasterData_EquipSkillMaster___),
        !v9) )
  {
LABEL_25:
    ...
    do
    {
      ...
      for ( i = &v9->m_Items[v15]; ; *i = -1 )
      {
        ...
        *(_QWORD *)&v26.fields.fakeValue = v18;
        MasterData_object = (Il2CppObject *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(
                                              v26,
                                              0LL);
        if ( !v14 )
          goto LABEL_25;
...
int32_t __fastcall UserEquipEntity__getSkillLv(UserEquipEntity_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1AF & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EquipExpMaster___, *(_QWORD *)&index);
    sub_1B863B8(&CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo, v5);
  ...
  *(_QWORD *)&v14.fields.fakeValue = v10;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v14, 0LL);
  if ( !v12 )
    goto LABEL_17;
...
System_Int32_array *__fastcall UserEquipEntity__getSkillLvList(UserEquipEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F1B0 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataManager_GetMasterData_EquipExpMaster___, method);
  ...
  result = (System_Int32_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !result )
    goto LABEL_13;
  MasterData_object = DataManager__GetMasterData_object_(
  ...
  *(_QWORD *)&v14.fields.fakeValue = v9;
  result = (System_Int32_array *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47434244(v14, 0LL);
  if ( !v11
