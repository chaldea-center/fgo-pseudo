        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0004 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_8697/*"MASTER_MISSION_RECEIVE_RESULT_DLG_TITLE"*/);
    sub_B52984(&StringLiteral_3294/*"COMMON_CONFIRM_CLOSE"*/);
    sub_B52984(&StringLiteral_8696/*"MASTER_MISSION_RECEIVE_RESULT_DLG_MSG"*/);
    byte_42B0004 = 1;
  }
  ...
  receiveResultListViewManager = (ListViewManager_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_8697/*"MASTER_MISSION_RECEIVE_RESULT_DLG_TITLE"*/,
                                                        0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, (System_String_o *)receiveResultListViewManager, 0LL),
        subTitleLabel = this->fields.subTitleLabel,
        receiveResultListViewManager = (ListViewManager_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8696/*"MASTER_MISSION_RECEIVE_RESULT_DLG_MSG"*/,
                                                              0LL),
        !subTitleLabel)
  ...
  {
LABEL_11:
    sub_B52A5C(receiveResultListViewManager, v3);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0005 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_MasterMissionReceiveResultDialog_OnClickCloseButton__);
    sub_B52984(&Method_MasterMissionReceiveResultDialog__OnClickCloseButton_b__9_0__);
    byte_42B0005 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_MasterMissionReceiveResultDialog_OnClickCloseButton__ + 75) & 2) != 0 )
      v3 = (_QWORD *)sub_B5298C(Method_MasterMissionReceiveResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_B52920((BattleServantConfConponent_o *)v6, (System_Int32_array **)action, v7, v8, v9, v10, v11, v12);
