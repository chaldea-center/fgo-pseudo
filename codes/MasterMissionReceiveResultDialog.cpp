...
void MasterMissionReceiveResultDialog__Init(MasterMissionReceiveResultDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3ABF1 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_8564/*"MASTER_MISSION_RECEIVE_RESULT_DLG_TITLE"*/);
    sub_1C32C20(&StringLiteral_3685/*"COMMON_CONFIRM_CLOSE"*/);
    sub_1C32C20(&StringLiteral_8563/*"MASTER_MISSION_RECEIVE_RESULT_DLG_MSG"*/);
    byte_4C3ABF1 = 1;
  }
  ...
  receiveResultListViewManager = (ListViewManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_8564/*"MASTER_MISSION_RECEIVE_RESULT_DLG_TITLE"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, (System_String_o *)receiveResultListViewManager, 0),
        ...
        receiveResultListViewManager = (ListViewManager_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8563/*"MASTER_MISSION_RECEIVE_RESULT_DLG_MSG"*/,
                                                              0),
        !subTitleLabel)
  ...
  {
LABEL_10:
    sub_1C32E7C(receiveResultListViewManager);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3ABF2 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_MasterMissionReceiveResultDialog_OnClickCloseButton__);
    sub_1C32C20(&Method_MasterMissionReceiveResultDialog__OnClickCloseButton_b__9_0__);
    byte_4C3ABF2 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_MasterMissionReceiveResultDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_MasterMissionReceiveResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)v6, (int32_t)action, v7, v8);
