        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A3122F & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_8536/*"MASTER_MISSION_RECEIVE_RESULT_DLG_TITLE"*/, v3);
    sub_1B761C0(&StringLiteral_3755/*"COMMON_CONFIRM_CLOSE"*/, v4);
    sub_1B761C0(&StringLiteral_8535/*"MASTER_MISSION_RECEIVE_RESULT_DLG_MSG"*/, v5);
    byte_4A3122F = 1;
  }
  ...
  receiveResultListViewManager = (ListViewManager_o *)LocalizationManager__Get(
                                                        (System_String_o *)StringLiteral_8536/*"MASTER_MISSION_RECEIVE_RESULT_DLG_TITLE"*/,
                                                        0LL);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, (System_String_o *)receiveResultListViewManager, 0LL),
        subTitleLabel = this->fields.subTitleLabel,
        receiveResultListViewManager = (ListViewManager_o *)LocalizationManager__Get(
                                                              (System_String_o *)StringLiteral_8535/*"MASTER_MISSION_RECEIVE_RESULT_DLG_MSG"*/,
                                                              0LL),
        !subTitleLabel)
  ...
  {
LABEL_10:
    sub_1B7641C(receiveResultListViewManager, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A31230 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_MasterMissionReceiveResultDialog_OnClickCloseButton__, v3);
    sub_1B761C0(&Method_MasterMissionReceiveResultDialog__OnClickCloseButton_b__9_0__, v4);
    byte_4A31230 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    if ( (*((_BYTE *)Method_MasterMissionReceiveResultDialog_OnClickCloseButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B761D8(Method_MasterMissionReceiveResultDialog_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)v6, (int32_t)action, v7, v8);
