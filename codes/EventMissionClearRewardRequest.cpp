        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EF1 & 1) == 0 )
  {
    sub_1B00CCC(&int___TypeInfo, *(_QWORD *)&missionId);
    byte_48E3EF1 = 1;
  }
  v5 = (System_Int32_array *)sub_1B00D74(int___TypeInfo, 1LL);
  if ( !v5 )
    sub_1B00F28(0LL, v6);
  if ( !v5->max_length )
    sub_1B00F30(v5, v5);
  v5->m_Items[1] = missionId;
  EventMissionClearRewardRequest__beginRequest_39805140(this, v5, v7);
}


void __fastcall EventMissionClearRewardRequest__beginRequest_39805140(
        EventMissionClearRewardRequest_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EF2 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_21182/*"missionIds"*/, missionIds);
    byte_48E3EF2 = 1;
  }
  RequestBase__addField_39761928((RequestBase_o *)this, (System_String_o *)StringLiteral_21182/*"missionIds"*/, &missionIds->obj, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E3EF0 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&StringLiteral_18885/*"eventMission/receive"*/, v2);
    byte_48E3EF0 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_60325748(BaseUrl, (System_String_o *)StringLiteral_18885/*"eventMission/receive"*/, 0LL);
}
