        ...
        const MethodInfo *method)
{
  if ( (byte_40F88AF & 1) == 0 )
  {
    sub_B16FFC(&StringLiteral_20446, missionIds);
    byte_40F88AF = 1;
  }
  RequestBase__addField_30957272((RequestBase_o *)this, (System_String_o *)StringLiteral_20446, &missionIds->obj, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F88AD & 1) == 0 )
  {
    ...
    sub_B16FFC(&StringLiteral_18408, v2);
    byte_40F88AD = 1;
  }
  ...
  return System_String__Concat_43743732(BaseUrl, (System_String_o *)StringLiteral_18408, 0LL);
}
