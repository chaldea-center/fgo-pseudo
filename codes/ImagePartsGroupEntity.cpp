...
bool __fastcall ImagePartsGroupEntity__ExistsSkill(ImagePartsGroupEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB197 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_5198/*"DialogSkillId"*/, v3);
    byte_49BB197 = 1;
  }
  ...
  return System_Collections_Generic_Dictionary_object__object___ContainsKey(
           ...
           (Il2CppObject *)StringLiteral_5198/*"DialogSkillId"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB194 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_SkillLvMaster___, isShort);
...
int32_t __fastcall ImagePartsGroupEntity__GetSkillId(ImagePartsGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49BB195 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_5198/*"DialogSkillId"*/, method);
    byte_49BB195 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_5198/*"DialogSkillId"*/, 0, 0LL);
}
...
int32_t __fastcall ImagePartsGroupEntity__GetSkillLv(ImagePartsGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49BB196 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_5199/*"DialogSkillLv"*/, method);
    byte_49BB196 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_5199/*"DialogSkillLv"*/, 0, 0LL);
}
...
// local variable allocation has failed, the output may be wrong!
bool __fastcall ImagePartsGroupEntity__IsOpen_39941844(
        ImagePartsGroupEntity_o *this,
        bool isCollection,
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB199 & 1) == 0 )
  {
    sub_1B4CF90(&CondType_TypeInfo, isCollection);
    byte_49BB199 = 1;
  }
...
bool __fastcall ImagePartsGroupEntity__IsUseEquipImage(ImagePartsGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49BB198 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_9369/*"NotEquipImage"*/, method);
    byte_49BB198 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_9369/*"NotEquipImage"*/, 0, 0LL) == 0;
}