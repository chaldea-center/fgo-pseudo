...
bool ImagePartsGroupEntity__ExistsSkill(ImagePartsGroupEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2762F & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_5253/*"DialogSkillId"*/);
    byte_4C2762F = 1;
  }
...
int32_t ImagePartsGroupEntity__GetSkillLv(ImagePartsGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C2762E & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_5254/*"DialogSkillLv"*/);
    byte_4C2762E = 1;
  }
...
bool ImagePartsGroupEntity__IsOpen_42031996(ImagePartsGroupEntity_o *this, bool isCollection, const MethodInfo *method)
{
  int32_t condId; // w21
...
bool ImagePartsGroupEntity__IsUseEquipImage(ImagePartsGroupEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C27630 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_9566/*"NotEquipImage"*/);
    byte_4C27630 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_9566/*"NotEquipImage"*/, 0, 0) == 0;
}