        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE49D & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_CenterEffectDetailItemListViewItemDraw___);
    byte_4DFE49D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_CenterEffectDetailItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CenterEffectDetailItemListViewObject_o *)sub_1CE6CF4(v8);
