        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2630D & 1) == 0 )
  {
    sub_1C94098(&Method_UnityEngine_GameObject_GetComponent_CenterEffectDetailItemListViewItemDraw___);
    byte_4D2630D = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31F4790 *)Method_UnityEngine_GameObject_GetComponent_CenterEffectDetailItemListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  v11 = (CenterEffectDetailItemListViewObject_o *)sub_1C9468C(v8);
