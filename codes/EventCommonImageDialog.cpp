...
void __fastcall EventCommonImageDialog__Init(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( !transform
    ...
    || (Component_object = UnityEngine_Component__GetComponent_object_(
        ...
        sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.basePanel, (int32_t)Component_object, v7, v8),
...
void __fastcall EventCommonImageDialog__OnClose(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB617 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventCommonImageDialog_OnClose__, v3);
    sub_1B4CF90(&Method_EventCommonImageDialog__OnClose_b__6_0__, v4);
    byte_49BB617 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_EventCommonImageDialog_OnClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B4CFA8(Method_EventCommonImageDialog_OnClose__);
    ...
    sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.closeCallback, 0, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB616 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_EventCommonImageDialog__Open_b__5_0__, v5);
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.closeCallback, (int32_t)callBack, v8, v9);
  closeLabel = this->fields.closeLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v11 = LocalizationManager__Get((System_String_o *)StringLiteral_3657/*"COMMON_CONFIRM_CLOSE"*/, 0LL);
  if ( !closeLabel )
    sub_1B4D1EC(v11, v12);
