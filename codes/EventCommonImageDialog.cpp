...
void __fastcall EventCommonImageDialog__Init(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( !transform
    ...
    || (Component_object = UnityEngine_Component__GetComponent_object_(
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.basePanel, (int32_t)Component_object, v7, v8),
...
void __fastcall EventCommonImageDialog__OnClose(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1C8D4 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_EventCommonImageDialog_OnClose__, v3);
    sub_1BCAFF8(&Method_EventCommonImageDialog__OnClose_b__6_0__, v4);
    byte_4B1C8D4 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_EventCommonImageDialog_OnClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BCB010(Method_EventCommonImageDialog_OnClose__);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.closeCallback, 0, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1C8D3 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_EventCommonImageDialog__Open_b__5_0__, v5);
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.closeCallback, (int32_t)callBack, v8, v9);
