...
void EventCommonImageDialog__OnClose(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D30BDF & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_EventCommonImageDialog_OnClose__);
    sub_1C93AD4(&Method_EventCommonImageDialog__OnClose_b__6_0__);
    byte_4D30BDF = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_EventCommonImageDialog_OnClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C93AEC(Method_EventCommonImageDialog_OnClose__);
    ...
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.closeCallback, 0, v8, v9, v10, v11, v12, v13);
...
void EventCommonImageDialog__Open(EventCommonImageDialog_o *this, System_Action_o *callBack, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&System_Action_TypeInfo);
    sub_1C93AD4(&Method_EventCommonImageDialog__Open_b__5_0__);
  ...
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3707/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    sub_1C93D2C(v12, v13);
