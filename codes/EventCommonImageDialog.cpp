...
void EventCommonImageDialog__OnClose(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC775B & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_EventCommonImageDialog_OnClose__);
    sub_1C713B0(&Method_EventCommonImageDialog__OnClose_b__6_0__);
    byte_4CC775B = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_EventCommonImageDialog_OnClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C713C8(Method_EventCommonImageDialog_OnClose__);
    ...
    sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.closeCallback, 0, v8, v9, v10, v11, v12, v13);
...
void EventCommonImageDialog__Open(EventCommonImageDialog_o *this, System_Action_o *callBack, const MethodInfo *method)
{
  ...
  {
    sub_1C713B0(&System_Action_TypeInfo);
    sub_1C713B0(&Method_EventCommonImageDialog__Open_b__5_0__);
  ...
  sub_1C71354((GrandQuestFolderBoardItem_o *)&this->fields.closeCallback, (int32_t)callBack, v5, v6, v7, v8, v9, v10);
  closeLabel = this->fields.closeLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_3680/*"COMMON_CONFIRM_CLOSE"*/, 0);
  if ( !closeLabel )
    sub_1C71608(v12, v13);
