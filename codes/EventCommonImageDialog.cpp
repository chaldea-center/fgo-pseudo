...
void EventCommonImageDialog__Init(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( !transform
    ...
    || (Component_object = UnityEngine_Component__GetComponent_object_(
        ...
        sub_1C3E508((CGThumbnailListItem_o *)&this->fields.basePanel, (int32_t)Component_object, v6, v7),
...
void EventCommonImageDialog__OnClose(EventCommonImageDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C570CA & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_EventCommonImageDialog_OnClose__);
    sub_1C3E564(&Method_EventCommonImageDialog__OnClose_b__6_0__);
    byte_4C570CA = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_EventCommonImageDialog_OnClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C3E57C(Method_EventCommonImageDialog_OnClose__);
    ...
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.closeCallback, 0, v8, v9);
...
void EventCommonImageDialog__Open(EventCommonImageDialog_o *this, System_Action_o *callBack, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_EventCommonImageDialog__Open_b__5_0__);
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.closeCallback, (int32_t)callBack, v5, v6);
