...
void __fastcall SetSwitchOptionControl__Init(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B422 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9667/*"OPTION_FRIEND_DISP_EXPLANATION"*/, v4);
    sub_1B90010(&StringLiteral_9664/*"OPTION_FIREND_DISP"*/, v5);
    byte_4A6B422 = 1;
  }
...
void __fastcall SetSwitchOptionControl__OnFriendDispChangeBtn(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B425 & 1) == 0 )
  {
    sub_1B90010(&Method_SetSwitchOptionControl_OnFriendDispChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetSwitchOptionControl_OnFriendDispChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B90028(Method_SetSwitchOptionControl_OnFriendDispChangeBtn__);
