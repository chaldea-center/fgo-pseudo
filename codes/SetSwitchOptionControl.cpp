...
void __fastcall SetSwitchOptionControl__Init(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9B72 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_9617/*"OPTION_FRIEND_DISP_EXPLANATION"*/, v4);
    sub_1B64870(&StringLiteral_9614/*"OPTION_FIREND_DISP"*/, v5);
    byte_49F9B72 = 1;
  }
  firnedDispTitle = this->fields.firnedDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9614/*"OPTION_FIREND_DISP"*/, 0LL);
  if ( !firnedDispTitle
    || (UILabel__set_text(firnedDispTitle, v7, 0LL),
        friendDispInfoLb = this->fields.friendDispInfoLb,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9617/*"OPTION_FRIEND_DISP_EXPLANATION"*/, 0LL),
        !friendDispInfoLb) )
  {
    sub_1B64ACC(v7, v8);
  }
...
void __fastcall SetSwitchOptionControl__OnFriendDispChangeBtn(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9B75 & 1) == 0 )
  {
    sub_1B64870(&Method_SetSwitchOptionControl_OnFriendDispChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetSwitchOptionControl_OnFriendDispChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B64888(Method_SetSwitchOptionControl_OnFriendDispChangeBtn__);
