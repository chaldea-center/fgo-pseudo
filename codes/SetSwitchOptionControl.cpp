...
void __fastcall SetSwitchOptionControl__Init(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0D6 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_9627/*"OPTION_FRIEND_DISP_EXPLANATION"*/, v4);
    sub_1B715CC(&StringLiteral_9624/*"OPTION_FIREND_DISP"*/, v5);
    byte_4A1B0D6 = 1;
  }
  firnedDispTitle = this->fields.firnedDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9624/*"OPTION_FIREND_DISP"*/, 0LL);
  if ( !firnedDispTitle
    || (UILabel__set_text(firnedDispTitle, v7, 0LL),
        friendDispInfoLb = this->fields.friendDispInfoLb,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9627/*"OPTION_FRIEND_DISP_EXPLANATION"*/, 0LL),
        !friendDispInfoLb) )
  {
    sub_1B71828(v7, v8);
  }
...
void __fastcall SetSwitchOptionControl__OnFriendDispChangeBtn(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1B0D9 & 1) == 0 )
  {
    sub_1B715CC(&Method_SetSwitchOptionControl_OnFriendDispChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetSwitchOptionControl_OnFriendDispChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1B715E4(Method_SetSwitchOptionControl_OnFriendDispChangeBtn__);
