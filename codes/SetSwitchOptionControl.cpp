...
void __fastcall SetSwitchOptionControl__Init(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D239 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_9854/*"Owner"*/, v4);
    sub_1C3B764(&StringLiteral_9851/*"OverwriteShadowServantEffectNodes"*/, v5);
    byte_4C1D239 = 1;
  }
  firnedDispTitle = this->fields.firnedDispTitle;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9851/*"OverwriteShadowServantEffectNodes"*/, 0LL);
  if ( !firnedDispTitle
    || (UILabel__set_text(firnedDispTitle, v7, 0LL),
        friendDispInfoLb = this->fields.friendDispInfoLb,
        v7 = LocalizationManager__Get((System_String_o *)StringLiteral_9854/*"Owner"*/, 0LL),
        !friendDispInfoLb) )
  {
    sub_1C3B9C0(v7, v8);
  }
...
void __fastcall SetSwitchOptionControl__OnFriendDispChangeBtn(SetSwitchOptionControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C1D23C & 1) == 0 )
  {
    sub_1C3B764(&Method_SetSwitchOptionControl_OnFriendDispChangeBtn__, method);
  ...
  if ( (*((_BYTE *)Method_SetSwitchOptionControl_OnFriendDispChangeBtn__ + 83) & 2) != 0 )
    v5 = (_QWORD *)sub_1C3B77C(Method_SetSwitchOptionControl_OnFriendDispChangeBtn__);
