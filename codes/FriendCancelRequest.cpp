...
System_String_o *__fastcall FriendCancelRequest__getURL(FriendCancelRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17AF3 & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_19837/*"friend/cancel"*/, v3, v4);
    byte_4B17AF3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_19837/*"friend/cancel"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(16, responseList, 0LL);
