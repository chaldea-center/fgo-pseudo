...
System_String_o *__fastcall FriendCancelRequest__getURL(FriendCancelRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EBDE6 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_19132/*"friend/cancel"*/, v4, v5, v6);
    byte_42EBDE6 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_19132/*"friend/cancel"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(16, responseList, 0LL);
