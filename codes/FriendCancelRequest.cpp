...
void FriendCancelRequest__beginRequest(FriendCancelRequest_o *this, int64_t targetUserId, const MethodInfo *method)
{
  if ( (byte_4C44B11 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_24002/*"targetUserId"*/);
    byte_4C44B11 = 1;
  }
  RequestBase__addField_44246844((RequestBase_o *)this, (System_String_o *)StringLiteral_24002/*"targetUserId"*/, targetUserId, 0);
...
System_String_o *FriendCancelRequest__getURL(FriendCancelRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44B10 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_19671/*"friend/cancel"*/);
    byte_4C44B10 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63561656(BaseUrl, (System_String_o *)StringLiteral_19671/*"friend/cancel"*/, 0);
}
