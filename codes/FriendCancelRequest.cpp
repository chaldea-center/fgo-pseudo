...
System_String_o *__fastcall FriendCancelRequest__getURL(FriendCancelRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDDED6 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_19969/*"friend/cancel"*/);
    byte_4BDDED6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63115476(BaseUrl, (System_String_o *)StringLiteral_19969/*"friend/cancel"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v5 = ResponseCommandKind__SearchData(16, responseList, 0LL);
