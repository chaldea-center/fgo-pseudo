void __fastcall BattleFieldData___ctor(BattleFieldData_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A7243F & 1) == 0 )
  {
    ...
    sub_1B90010(&BattleFieldData_SaveData_TypeInfo, v3);
    byte_4A7243F = 1;
  }
  v4 = (Il2CppObject *)sub_1B9025C(BattleFieldData_SaveData_TypeInfo);
  System_Object___ctor(v4, 0LL);
  this->fields.tmpsave = (struct BattleFieldData_SaveData_o *)v4;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.tmpsave, (int32_t)v4, v5, v6);
  v7 = (struct System_Double_array *)sub_1B900B8(double___TypeInfo, 1LL);
  this->fields.wkZeroParam = v7;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.wkZeroParam, (int32_t)v7, v8, v9);
  System_Object___ctor((Il2CppObject *)this, 0LL);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall BattleFieldData___ctor_42804616(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72440 & 1) == 0 )
  {
    sub_1B90010(&BattleFieldData_AiField_TypeInfo, *(_QWORD *)&inIndex);
    sub_1B90010(&AiState_TypeInfo, v7);
    ...
    sub_1B90010(&double___TypeInfo, v11);
    sub_1B90010(&long_TypeInfo, v12);
    sub_1B90010(&BattleFieldData_SaveData_TypeInfo, v13);
    sub_1B90010(&StringLiteral_22789/*"raid"*/, v14);
    sub_1B90010(&StringLiteral_20227/*"id"*/, v15);
    byte_4A72440 = 1;
  }
  v16 = (Il2CppObject *)sub_1B9025C(BattleFieldData_SaveData_TypeInfo);
  System_Object___ctor(v16, 0LL);
  this->fields.tmpsave = (struct BattleFieldData_SaveData_o *)v16;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.tmpsave, (int32_t)v16, v17, v18);
  v19 = (struct System_Double_array *)sub_1B900B8(double___TypeInfo, 1LL);
  this->fields.wkZeroParam = v19;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.wkZeroParam, (int32_t)v19, v20, v21);
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields.index = inIndex;
  this->fields.uniqueId = -1;
  v22 = (Il2CppObject *)sub_1B9025C(BattleFieldData_AiField_TypeInfo);
  System_Object___ctor(v22, 0LL);
  this->fields.aiField = (struct BattleFieldData_AiField_o *)v22;
  p_aiField = &this->fields.aiField;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.aiField, (int32_t)v22, v24, v25);
  if ( !obj )
    goto LABEL_19;
  ...
  if ( System_Collections_Generic_Dictionary_object__object___ContainsKey(
         ...
         (Il2CppObject *)StringLiteral_22789/*"raid"*/,
  ...
  if ( !System_Collections_Generic_Dictionary_object__object___ContainsKey(
          (System_Collections_Generic_Dictionary_object__object__o *)obj,
          (Il2CppObject *)StringLiteral_20227/*"id"*/,
          (const MethodInfo_31D8FA8 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
  {
LABEL_16:
    v35 = (AiState_o *)sub_1B9025C(AiState_TypeInfo);
    AiState___ctor(v35, 0LL);
    this->fields.aiState = v35;
    p_aiState = (ServantStatusBattleListViewItem_o *)&this->fields.aiState;
    sub_1B8FFB4(p_aiState, (int32_t)v35, v37, v38);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A72441 & 1) == 0 )
  {
    this = (BattleFieldData_o *)sub_1B90010(&double___TypeInfo, bData);
    byte_4A72441 = 1;
  }
  if ( param <= 16 )
  {
    if ( param == 1 )
    {
      this = (BattleFieldData_o *)sub_1B900B8(double___TypeInfo, 1LL);
      if ( this )
      {
...
BattleFieldData_SaveData_o *__fastcall BattleFieldData__getSaveData(BattleFieldData_o *this, const MethodInfo *method)
{
  ...
  if ( !aiState || (tmpsave = this->fields.tmpsave, aiState = (AiState_o *)AiState__getSaveData(aiState, 0LL), !tmpsave) )
    sub_1B9026C(aiState, method);
  tmpsave->fields.aistateSave = (struct AiState_SaveData_o *)aiState;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&tmpsave->fields, (int32_t)aiState, v5, v6);
