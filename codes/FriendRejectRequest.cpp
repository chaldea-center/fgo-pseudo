...
System_String_o *__fastcall FriendRejectRequest__getURL(FriendRejectRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EB458 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_19136/*"friend/reject"*/, v4, v5, v6);
    byte_42EB458 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_19136/*"friend/reject"*/, 0LL);
}
