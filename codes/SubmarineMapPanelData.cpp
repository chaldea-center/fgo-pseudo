        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57E20 & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&Method_SubmarineMapPanelData___c__DisplayClass48_0__SetPanelClickAction_b__0__);
    sub_1B885B0(&SubmarineMapPanelData___c__DisplayClass48_0_TypeInfo);
    byte_4A57E20 = 1;
  }
  v5 = sub_1B887FC(SubmarineMapPanelData___c__DisplayClass48_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 24) = this;
  ...
  if ( UnityEngine_Object__op_Inequality(Component_k__BackingField, 0LL, 0LL) )
  {
    ...
    if ( v13 )
    {
      ...
      sub_1B88554(
        (ServantStatusBattleListViewItem_o *)&v13->fields._OnClickPanel_k__BackingField,
        (int32_t)v14,
        v15,
        v16);
      return;
        ...
        const MethodInfo *method)
{
  if ( (byte_4A57E23 & 1) == 0 )
  {
    sub_1B885B0(&Method_ActionExtensions_Call_SubmarineMapPanelData___);
    byte_4A57E23 = 1;
  }
  ActionExtensions__Call_object_(
    (System_Action_T__o *)this->fields.clickAction,
    (Il2CppObject *)this->fields.__4__this,
    (const MethodInfo_2DD5858 *)Method_ActionExtensions_Call_SubmarineMapPanelData___);
}