        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFC89 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_20139/*"idxY"*/, v11);
    sub_1B64870(&StringLiteral_16820/*"areaNum"*/, v12);
    sub_1B64870(&StringLiteral_20138/*"idxX"*/, v13);
    byte_49FFC89 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19061/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16820/*"areaNum"*/, areaNum, 0LL);
  RequestBase__addField_40853908((RequestBase_o *)this, (System_String_o *)StringLiteral_20138/*"idxX"*/, &idxX->obj, 0LL);
  RequestBase__addField_40853908((RequestBase_o *)this, (System_String_o *)StringLiteral_20139/*"idxY"*/, &idxY->obj, 0LL);
...
System_String_o *__fastcall EventDiggingRequest__getURL(EventDiggingRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FFC88 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_19043/*"event/digging"*/, v2);
    byte_49FFC88 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61383576(BaseUrl, (System_String_o *)StringLiteral_19043/*"event/digging"*/, 0LL);
}
