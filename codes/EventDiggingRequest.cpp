        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FDB8E & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_20136/*"idxY"*/, v11);
    sub_1B640C8(&StringLiteral_16818/*"areaNum"*/, v12);
    sub_1B640C8(&StringLiteral_20135/*"idxX"*/, v13);
    byte_49FDB8E = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19059/*"eventId"*/, eventId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_16818/*"areaNum"*/, areaNum, 0LL);
  RequestBase__addField_40848776((RequestBase_o *)this, (System_String_o *)StringLiteral_20135/*"idxX"*/, &idxX->obj, 0LL);
  RequestBase__addField_40848776((RequestBase_o *)this, (System_String_o *)StringLiteral_20136/*"idxY"*/, &idxY->obj, 0LL);
...
System_String_o *__fastcall EventDiggingRequest__getURL(EventDiggingRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDB8D & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_19041/*"event/digging"*/, v2);
    byte_49FDB8D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_19041/*"event/digging"*/, 0LL);
}
