...
void __fastcall StandFigureCamera__OnPostRender(StandFigureCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B0B08 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_11426/*"RednerTexture"*/);
    sub_B52984(&StringLiteral_13693/*"TempStandFigurenRednerTexture"*/);
    byte_42B0B08 = 1;
  }
        ...
        if ( Component_WebViewObject )
        {
          ...
          if ( v8 )
          {
            ...
            *p_recycleTexture = 0LL;
            sub_B52920((BattleServantConfConponent_o *)&this->fields.recycleTexture, 0LL, v10, v11, v12, v13, v14, v15);
          }
          else
          {
            Component_WebViewObject = (UnityEngine_Camera_o *)UnityEngine_RenderTexture__GetTemporary_35676488(
                                                                2048,
                                                                1024,
                                                                0,
                                                                0,
          ...
          if ( Component_WebViewObject )
          {
            ...
            if ( Component_WebViewObject )
            {
              UnityEngine_Object__set_name(
                ...
                (System_String_o *)StringLiteral_11426/*"RednerTexture"*/,
                0LL);
              UnityEngine_Object__set_name(v5, (System_String_o *)StringLiteral_13693/*"TempStandFigurenRednerTexture"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B0B06 & 1) == 0 )
  {
    ...
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&StringLiteral_11426/*"RednerTexture"*/);
    sub_B52984(&StringLiteral_11420/*"RecycleRednerTexture"*/);
    byte_42B0B06 = 1;
  }
  ...
  {
    *p_recycleTexture = 0LL;
    sub_B52920((BattleServantConfConponent_o *)&this->fields.recycleTexture, 0LL, v18, v19, v20, v21, v22, v23);
    return 1;
  }
  if ( !recycleTexture
    || (UnityEngine_Object__set_name(
