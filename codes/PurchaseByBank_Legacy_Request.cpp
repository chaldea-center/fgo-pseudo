        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF153 & 1) == 0 )
  {
    sub_1C2E12C(&UnityEngine_Debug_TypeInfo, v1);
    sub_1C2E12C(&Method_System_Linq_Enumerable_ToList_PurchaseByBank_Legacy_Request_PurchaseResult___, v2);
    sub_1C2E12C(&Method_System_Collections_Generic_List_PurchaseByBank_Legacy_Request_PurchaseResult___ctor__, v3);
    sub_1C2E12C(&System_Collections_Generic_List_PurchaseByBank_Legacy_Request_PurchaseResult__TypeInfo, v4);
    sub_1C2E12C(&PurchaseByBank_Legacy_Request_TypeInfo, v5);
    sub_1C2E12C(&StringLiteral_23082/*"purchaseResultArray is null."*/, v6);
    byte_4BFF153 = 1;
  }
  ...
  if ( purchaseResultArray )
    return (System_Collections_Generic_List_PurchaseByBank_Legacy_Request_PurchaseResult__o *)System_Linq_Enumerable__ToList_object_(
                                                                                                purchaseResultArray,
                                                                                                (const MethodInfo_300FBA0 *)Method_System_Linq_Enumerable_ToList_PurchaseByBank_Legacy_Request_PurchaseResult___);
  if ( !UnityEngine_Debug_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Debug_TypeInfo);
  UnityEngine_Debug__LogError((Il2CppObject *)StringLiteral_23082/*"purchaseResultArray is null."*/, 0LL);
  v9 = (System_Collections_Generic_List_object__o *)sub_1C2E378(System_Collections_Generic_List_PurchaseByBank_Legacy_Request_PurchaseResult__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v9,
    (const MethodInfo_366B078 *)Method_System_Collections_Generic_List_PurchaseByBank_Legacy_Request_PurchaseResult___ctor__);
...
int32_t __fastcall PurchaseByBank_Legacy_Request__GetTotalAddedChargeStoneNum(const MethodInfo *method)
{
  ...
  if ( (byte_4BFF152 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Linq_Enumerable_Select_PurchaseByBank_Legacy_Request_PurchaseResult__int___, v1);
    sub_1C2E12C(&System_Func_PurchaseByBank_Legacy_Request_PurchaseResult__int__TypeInfo, v2);
    sub_1C2E12C(&PurchaseByBank_Legacy_Request_TypeInfo, v3);
    sub_1C2E12C(&Method_PurchaseByBank_Legacy_Request___c__GetTotalAddedChargeStoneNum_b__7_0__, v4);
    sub_1C2E12C(&PurchaseByBank_Legacy_Request___c_TypeInfo, v5);
    byte_4BFF152 = 1;
  }
  purchaseResultArray = (System_Collections_Generic_IEnumerable_TSource__o *)PurchaseByBank_Legacy_Request_TypeInfo->static_fields->purchaseResultArray;
  if ( !purchaseResultArray )
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Func_object__int__o *)sub_1C2E378(System_Func_PurchaseByBank_Legacy_Request_PurchaseResult__int__TypeInfo);
  ...
  v17 = (System_Collections_Generic_IEnumerable_int__o *)System_Linq_Enumerable__Select_object__int_(
                                                           ...
                                                           (const MethodInfo_30032B4 *)Method_System_Linq_Enumerable_Select_PurchaseByBank_Legacy_Request_PurchaseResult__int___);
...
int32_t __fastcall PurchaseByBank_Legacy_Request__GetTotalAddedFreeStoneNum(const MethodInfo *method)
{
  ...
  if ( (byte_4BFF151 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&System_Func_PurchaseByBank_Legacy_Request_PurchaseResult__int__TypeInfo, v2);
    sub_1C2E12C(&PurchaseByBank_Legacy_Request_TypeInfo, v3);
    sub_1C2E12C(&Method_PurchaseByBank_Legacy_Request___c__GetTotalAddedFreeStoneNum_b__6_0__, v4);
    sub_1C2E12C(&PurchaseByBank_Legacy_Request___c_TypeInfo, v5);
    byte_4BFF151 = 1;
  }
  purchaseResultArray = (System_Collections_Generic_IEnumerable_TSource__o *)PurchaseByBank_Legacy_Request_TypeInfo->static_fields->purchaseResultArray;
  ...
  if ( !_9__6_0 )
  {
    ...
    v9 = (Il2CppObject *)v7->static_fields->__9;
    _9__6_0 = (System_Func_object__int__o *)sub_1C2E378(System_Func_PurchaseByBank_Legacy_Request_PurchaseResult__int__TypeInfo);
    System_Func_object__int____ctor(
      _9__6_0,
      v9,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF150 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&PurchaseByBank_Legacy_Request_TypeInfo, v11);
    sub_1C2E12C(&StringLiteral_24008/*"storeError"*/, v12);
    sub_1C2E12C(&StringLiteral_23079/*"purchaseData"*/, v13);
    sub_1C2E12C(&StringLiteral_23080/*"purchaseDataBase64"*/, v14);
    sub_1C2E12C(&StringLiteral_23770/*"signatureData"*/, v15);
    byte_4BFF150 = 1;
  }
  ...
  if ( !System_String__IsNullOrEmpty(purchaseBaseData, 0LL) )
    RequestBase__addField_42503872((RequestBase_o *)this, (System_String_o *)StringLiteral_23080/*"purchaseDataBase64"*/, purchaseBaseData, v16);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_24008/*"storeError"*/, storeError, v16);
  if ( !System_String__IsNullOrEmpty(extraToken, 0LL) )
    RequestBase__addField_42503872((RequestBase_o *)this, (System_String_o *)StringLiteral_23770/*"signatureData"*/, extraToken, v18);
...
int32_t __fastcall PurchaseByBank_Legacy_Request__getPurchasedBankShopId(const MethodInfo *method)
{
  ...
  if ( (byte_4BFF14D & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Linq_Enumerable_FirstOrDefault_PurchaseByBank_Legacy_Request_PurchaseResult___, v1);
    sub_1C2E12C(&PurchaseByBank_Legacy_Request_TypeInfo, v2);
    byte_4BFF14D = 1;
  }
  ...
  if ( purchaseResultArray )
  {
    purchaseResultArray = (struct PurchaseByBank_Legacy_Request_PurchaseResult_array *)System_Linq_Enumerable__FirstOrDefault_object_(
                                                                                         ...
                                                                                         (const MethodInfo_2FF4638 *)Method_System_Linq_Enumerable_FirstOrDefault_PurchaseByBank_Legacy_Request_PurchaseResult___);
    if ( purchaseResultArray )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF154 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_JsonManager_DeserializeArray_PurchaseByBank_Legacy_Request_PurchaseResult___, v6);
    sub_1C2E12C(&JsonManager_TypeInfo, v7);
    sub_1C2E12C(&PurchaseByBank_Legacy_Request_TypeInfo, v8);
...
LABEL_11:
                 ...
                 (const MethodInfo_3335D68 *)Method_System_Collections_Generic_Dictionary_string__object__ContainsKey__) )
          {
            ...
            v22 = JsonManager__DeserializeArray_object_(
                    v21,
                    (const MethodInfo_3039DDC *)Method_JsonManager_DeserializeArray_PurchaseByBank_Legacy_Request_PurchaseResult___);
...
void __fastcall PurchaseByBank_Legacy_Request___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFF155 & 1) == 0 )
  {
    sub_1C2E12C(&PurchaseByBank_Legacy_Request___c_TypeInfo, v1);
    byte_4BFF155 = 1;
  }
  v2 = (Il2CppObject *)sub_1C2E378(PurchaseByBank_Legacy_Request___c_TypeInfo);
