void __fastcall PartyOrganizationListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BD82F3 & 1) == 0 )
  {
    sub_1C21E38(&PartyOrganizationListViewItemDraw_TypeInfo);
    byte_4BD82F3 = 1;
  }
  static_fields = PartyOrganizationListViewItemDraw_TypeInfo->static_fields;
  *(_OWORD *)&static_fields->MESSAGE_X_SIZE_MAX = xmmword_BFDCE0;
        ...
        const MethodInfo *method)
{
  ...
  if ( ((unsigned __int8)transform & 1) != 0 )
  {
    ...
    sub_1C21DDC(&this->fields.baseDefaultUIAtlas, mAtlas);
  }
  ...
  if ( ((unsigned __int8)transform & 1) != 0 )
  {
    ...
    if ( v13 )
    {
      ...
      sub_1C21DDC(&this->fields.base2DefaultUIAtlas, v14);
      goto LABEL_32;
    }
LABEL_33:
...
LABEL_32:
  v15 = (System_Collections_Generic_List_object__o *)sub_1C22084(System_Collections_Generic_List_UIWidget__TypeInfo);
  ...
  sub_1C21DDC(&this->fields.switchSkillUIList, v15);
  ...
  sub_1C21DDC(&this->fields.switchMessageUIList, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(&this->fields.linkItem, 0LL);
...
LABEL_8:
    ...
    {
      Instance = (ServantClassCompatibilityIconComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( !Instance )
        goto LABEL_23;
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality(dataLostMaskSprite, 0LL, 0LL) )
  {
    ...
    AtlasManager__SetPartyOrganizationImage(v6, (System_String_o *)StringLiteral_18787/*"datalost_party_edit"*/, 0LL);
    gameObject = (UnityEngine_Component_o *)this->fields.dataLostMaskSprite;
    if ( !gameObject )
LABEL_12:
      sub_1C22094(gameObject, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD82EC & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_20671/*"img_frames_mask02"*/);
    sub_1C21E38(&StringLiteral_11728/*"SELECT_NO_SORTIE_FATIGURE_NARROW_FIGURE"*/);
    this = (PartyOrganizationListViewItemDraw_o *)sub_1C21E38(&StringLiteral_11730/*"SELECT_NO_SORTIE_FATIGURE_RECOVER_NARROW_FIGURE"*/);
    byte_4BD82EC = 1;
  }
  if ( !item )
    goto LABEL_15;
  ...
  v9 = (System_String_o **)(item->fields.isFatigureRecover ? &StringLiteral_11730/*"SELECT_NO_SORTIE_FATIGURE_RECOVER_NARROW_FIGURE"*/ : &StringLiteral_11728/*"SELECT_NO_SORTIE_FATIGURE_NARROW_FIGURE"*/);
  v10 = *v9;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
...
LABEL_15:
  ...
  PartyOrganizationListViewItemDraw__SetMask2Message(
    ...
    v13,
    (System_String_o *)StringLiteral_20671/*"img_frames_mask02"*/,
    1,
    v12);
}
        ...
        const MethodInfo *method)
{
  ...
  int32_t Level; // w23
  System_String_o *Icon_38945792; // x29
  ...
  struct System_Collections_Generic_List_UIWidget__o *v188; // x0
  SwitchUIWidgetComponent_o *v189; // x22
  UnityEngine_Object_o *svtCommandCardList; // x22
  ServantLeaderInfo_o *ServantLeader; // x0
  struct ServantCommandCardListComponent_o *v192; // x24
  ServantLeaderInfo_o *v193; // x26
  CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o v194; // kr20_16
  int32_t v195; // w25
  System_Int32_array *commandCodeIdList; // x3
  System_Int32_array *v197; // x2
  ServantCommandCardListComponent_o *v198; // x0
  int32_t v199; // w1
  ServantCommandCardListComponent_o *v200; // x24
  CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o v201; // kr30_16
  UnityEngine_Object_o *memberTypeBaseSprite; // x22
  int32_t index; // w21
  System_String_o **v204; // x8
  UnityEngine_Object_o *memberTypeSprite; // x22
  UISprite_o *v206; // x22
  System_String_o *v207; // x0
  UnityEngine_Object_o *supportSprite; // x22
  UserServantEntity_o *v209; // x0
  __int64 *v210; // x8
  ...
  int v215; // w29
  int v216; // w8
  EventCampaignEntity_o *v217; // x21
  System_Int32_array *targetIds; // x26
  CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o v219; // kr40_16
  int32_t v220; // w0
  struct System_Int32_array *v221; // x8
  EventMargeItemUpValInfo_o *v222; // x26
  struct System_Object_array *items; // x8
  _QWORD *v224; // x9
  __int64 v225; // x10
  Il2CppClass **v226; // x0
  BalanceConfig_c *v227; // x0
  EventMargeItemUpValInfo_o *v228; // x24
  ...
  int v238; // w8
  __int64 v239; // x22
  EventMargeItemUpValInfo_o *v240; // x24
  ...
  EventMargeItemUpValInfo_o *v247; // x24
  ...
  struct QuestRestrictionInfo_o *questRestrictionInfo; // x8
  int32_t v254; // w22
  EventMargeItemUpValInfo_o *v255; // x24
  ...
  struct EventMargeItemUpValInfo_array *v283; // x8
  float v284; // s8
  float v285; // s9
  _BOOL4 v286; // w9
  unsigned int v287; // w21
  PartyOrganizationListViewItemDraw_c *v288; // x0
  __int64 v289; // x9
  UISprite_o *v290; // x22
  ...
  struct QuestRestrictionInfo_o *v300; // x8
  ...
  int32_t v321; // w20
  int32_t v322; // w23
  EventUpValIconComponent_o *v323; // x24
  UnityEngine_Object_o *v324; // x20
  ...
  int v343; // [xsp+1Ch] [xbp-104h]
  int32_t frameType; // [xsp+20h] [xbp-100h]
  int32_t eventId; // [xsp+24h] [xbp-FCh]
  int32_t eventIda; // [xsp+24h] [xbp-FCh]
  System_Collections_Generic_List_object__o *v347; // [xsp+28h] [xbp-F8h]
  int v348; // [xsp+30h] [xbp-F0h] BYREF
  ...
  int32_t v352[2]; // [xsp+48h] [xbp-D8h] BYREF
  ...
  SkillInfo_array *v356; // [xsp+68h] [xbp-B8h] BYREF
  TreasureDvcInfo_o *v357; // [xsp+70h] [xbp-B0h] BYREF
  SkillInfo_array *v358; // [xsp+78h] [xbp-A8h] BYREF
  SkillInfo_array *v359; // [xsp+80h] [xbp-A0h] BYREF
  ...
  if ( (byte_4BD82E3 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_10475/*"PARTY_ORGANIZATION_GET_SERVANT_POINT"*/);
  ...
  *(_QWORD *)v352 = 0LL;
  ...
  sub_1C21DDC(&this->fields.linkItem, v5);
  v8 = (System_Collections_Generic_List_object__o *)sub_1C22084(System_Collections_Generic_List_EventMargeItemUpValInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v8,
  ...
  if ( (mode | 4) != 4 )
  {
    ...
    if ( v5->fields.isFollower )
    {
      ...
      if ( UnityEngine_Object__op_Inequality(servantFaceIcon, 0LL, 0LL) )
      {
        ...
        if ( !v29 )
          goto LABEL_813;
        ServantFaceIconComponent__Set_39468548(v29, (ServantLeaderInfo_o *)Time, 0LL, 0LL, 0, 0, 0LL);
      }
      if ( IsHideSupport )
      {
      ...
      else
      {
        ...
        if ( (Time & 1) == 0 )
        {
          ...
          Time = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(SvtId, 0LL);
        ...
        if ( (int)item <= 0 )
        {
          v362 = PartyOrganizationListViewItem__get_SvtId(v5, 0LL);
          item = (PartyOrganizationListViewItem_o *)(unsigned int)BasicHelper__DecryptValue_42396584(v362, 0LL);
        }
        Time = (__int64)this->fields.servantNarrowTexture;
        if ( !Time )
          goto LABEL_813;
      ...
      if ( (unsigned int)(type - 3) < 2 )
      {
        ...
        if ( !Time )
          goto LABEL_813;
        UISprite__set_spriteName((UISprite_o *)Time, (System_String_o *)StringLiteral_20545/*"icon_support_01"*/, 0LL);
        Time = (__int64)this->fields.typeSprite;
        if ( !Time )
          goto LABEL_813;
      ...
      if ( type == 5 )
      {
        ...
        if ( !Time )
          goto LABEL_813;
        v41 = &StringLiteral_20506/*"icon_follow"*/;
      }
      else
      {
        if ( type != 1 )
        ...
        if ( !Time )
          goto LABEL_813;
        v41 = &StringLiteral_20507/*"icon_friend"*/;
      }
...
LABEL_122:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      Time = (__int64)LocalizationManager__GetLevelList_39646380(v43, 0LL);
      if ( !tdInfo )
        goto LABEL_813;
      treasureDeviceNum = tdInfo->fields.treasureDeviceNum;
      v42 = (System_String_o *)Time;
      HIDWORD(v341) = tdInfo->fields.lv;
      ...
      if ( !v45 )
        goto LABEL_813;
      ServantLeaderInfo__GetAppendPassiveSkillInfo_41790300(v45, &v359, Time & 1, 0LL);
      v46 = v359;
      if ( v359 && *(_QWORD *)&v359->max_length )
      {
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        LevelList_39646380 = LocalizationManager__GetLevelList_39646380(v46, 0LL);
        v34 = 0;
      }
      else
      {
...
LABEL_200:
      if ( v5->fields.userServantEntity || v5->fields.followerInfo )
      {
        ...
        if ( (Time & 1) != 0 )
        {
          ...
          if ( (v34 & 1) != 0 )
          {
            item = (PartyOrganizationListViewItem_o *)StringLiteral_1883/*"??"*/;
          }
          else
          {
        ...
        if ( UnityEngine_Object__op_Inequality(raritySprite, 0LL, 0LL) )
        {
          ...
          else
          {
            ...
            else
            {
              ...
              v97 = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_ServantLvDetailMaster___);
            ...
            if ( !AtlasManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
            if ( v101 >= 3 )
              AtlasManager__SetEventSprite(v135, Icon_38945792, 0LL);
            else
              AtlasManager__SetCommon(v135, 0LL);
            Time = (__int64)this->fields.raritySprite;
            if ( !Time )
              goto LABEL_813;
            LevelList_39646380 = v89;
            UISprite__set_spriteName((UISprite_o *)Time, Icon_38945792, 0LL);
            Time = (__int64)this->fields.raritySprite;
            if ( !Time )
              goto LABEL_813;
            ...
            v367.fields.y = y;
            v367.fields.z = z;
            UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)Time, v367, 0LL);
          }
        }
        ...
        if ( UnityEngine_Object__op_Inequality(attackLabel, 0LL, 0LL) )
        {
          ...
          if ( (v34 & 1) != 0 )
          {
            item = (PartyOrganizationListViewItem_o *)StringLiteral_1885/*"???"*/;
          }
          else
          {
            startingNum[1] = PartyOrganizationListViewItem__get_MargeAtk(v5, 0LL);
            Time = (__int64)System_Int32__ToString_63921084(
          ...
          else
          {
            ...
            else
            {
              ...
              v167 = (Il2CppObject *)j_il2cpp_value_box_0(
                                       ...
                                       v163);
              v348 = v159;
              v171 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v348, v168, v169, v170);
              Time = (__int64)System_String__Concat_63126488(v167, (Il2CppObject *)StringLiteral_858/*"+"*/, v171, 0LL);
              if ( !v158 )
                goto LABEL_813;
              UILabel__set_text(v158, (System_String_o *)Time, 0LL);
              v8 = v347;
              LevelList_39646380 = v166;
              v30 = v165;
              v42 = v164;
            }
          }
        ...
        if ( UnityEngine_Object__op_Inequality(skillListTreasureDevice, 0LL, 0LL) )
        {
          if ( !System_String__IsNullOrEmpty(v42, 0LL) )
          {
            ...
            if ( Time )
            {
              ...
              v173 = *(_QWORD *)(Time + 16);
              v174 = Method_System_Collections_Generic_List_UIWidget__Add__;
              ++*(_DWORD *)(Time + 28);
              if ( !v173 )
                goto LABEL_813;
              v175 = *(int *)(Time + 24);
              ...
              {
                v176 = v173 + 8 * v175;
                *(_DWORD *)(Time + 24) = v175 + 1;
                *(_QWORD *)(v176 + 32) = item;
                sub_1C21DDC(v176 + 32, item);
              }
            }
          }
          if ( eventId )
...
LABEL_457:
          ...
          {
            v188 = this->fields.switchSkillUIList;
            if ( v188 )
            {
              v189 = this->fields.switchSkillInfo;
              Time = (__int64)System_Collections_Generic_List_object___ToArray(
                                (System_Collections_Generic_List_object__o *)v188,
                                (const MethodInfo_3650C0C *)Method_System_Collections_Generic_List_UIWidget__ToArray__);
              if ( !v189 )
                goto LABEL_813;
              SwitchUIWidgetComponent__Set(v189, (UIWidget_array *)Time, 0LL);
            }
          }
          ...
          if ( UnityEngine_Object__op_Inequality(svtCommandCardList, 0LL, 0LL) )
          {
            ...
            else if ( v5->fields.isFollower )
            {
              ...
              v192 = this->fields.svtCommandCardList;
              v193 = ServantLeader;
              v194 = PartyOrganizationListViewItem__get_SvtId(v5, 0LL);
              if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
              Time = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v194, 0LL);
              v195 = Time;
              if ( v193 )
              {
                Time = (__int64)PartyOrganizationListViewItem__get_ServantLeader(v5, 0LL);
                ...
                v197 = *(System_Int32_array **)(Time + 208);
                v198 = v192;
                v199 = v195;
              }
              else
              ...
              ServantCommandCardListComponent__Set_39457436(v198, v199, v197, commandCodeIdList, 2, 0, 0LL);
            }
            else
            {
              v200 = this->fields.svtCommandCardList;
              v201 = PartyOrganizationListViewItem__get_SvtId(v5, 0LL);
              if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
              Time = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v201, 0LL);
              if ( !v200 )
                goto LABEL_813;
              ServantCommandCardListComponent__Set_39457680(v200, Time, v5->fields.commandCodeIdList, 2, 0, 0LL);
            }
          }
          ...
          if ( UnityEngine_Object__op_Inequality(memberTypeBaseSprite, 0LL, 0LL) )
          {
            ...
            if ( index >= BalanceConfig_TypeInfo->static_fields->DeckMainMemberMax )
              v204 = (System_String_o **)&StringLiteral_19919/*"formation_txtbg_03"*/;
            else
              v204 = (System_String_o **)&StringLiteral_19918/*"formation_txtbg_02"*/;
            UISprite__set_spriteName((UISprite_o *)Time, *v204, 0LL);
          }
          ...
          {
            v206 = this->fields.memberTypeSprite;
            startingNum[1] = v5->fields.index + 1;
            v207 = System_Int32__ToString((int32_t)&startingNum[1], 0LL);
            Time = (__int64)System_String__Concat_63115476((System_String_o *)StringLiteral_21771/*"member_txt_"*/, v207, 0LL);
            if ( !v206 )
              goto LABEL_813;
            UISprite__set_spriteName(v206, (System_String_o *)Time, 0LL);
...
LABEL_512:
            if ( !(eventId & 1 | !v5->fields.isFollower) )
            {
              ...
              if ( friendPointCampaignEntityList )
              {
                ...
                if ( max_length >= 1 )
                {
                  ...
                  do
                  {
                    if ( v216 >= (unsigned int)max_length )
                      goto LABEL_815;
                    v217 = friendPointCampaignEntityList->m_Items[v216];
                    if ( !v217 )
                      goto LABEL_813;
                    targetIds = v217->fields.targetIds;
                    v219 = PartyOrganizationListViewItem__get_SvtId(v5, 0LL);
                    if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
                    v220 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v219, 0LL);
                    Time = System_Array__IndexOf_int_(
                             targetIds,
                             v220,
                             (const MethodInfo_30ACCCC *)Method_System_Array_IndexOf_int___);
                    v221 = v217->fields.targetIds;
                    if ( v221 )
                      v215 = Time;
                    if ( v221 && (v215 & 0x80000000) == 0 && v221->max_length && v214 < v217->fields.value )
                    {
                      v214 = v217->fields.value;
                      eventIda = v217->fields.eventId;
                    }
                    v216 = startingNum[1] + 1;
                    startingNum[1] = v216;
                    max_length = friendPointCampaignEntityList->max_length;
                  }
                  ...
                  if ( v214 >= 1 )
                  {
                    v222 = (EventMargeItemUpValInfo_o *)sub_1C22084(EventMargeItemUpValInfo_TypeInfo);
                    EventMargeItemUpValInfo___ctor_40149804(v222, eventIda, v214, 0LL);
                    if ( !v347 )
                      goto LABEL_813;
                    items = v347->fields._items;
                    v224 = Method_System_Collections_Generic_List_EventMargeItemUpValInfo__Add__;
                    ++v347->fields._version;
                    if ( !items )
                      goto LABEL_813;
                    v225 = v347->fields._size;
                    if ( (unsigned int)v225 >= items->max_length )
                    {
                      System_Collections_Generic_List_object___AddWithResize(
                        v347,
                        (Il2CppObject *)v222,
                        *(const MethodInfo_364F0B4 **)(*(_QWORD *)(v224[4] + 192LL) + 112LL));
                    }
                    else
                    {
                      v226 = &items->obj.klass + v225;
                      v347->fields._size = v225 + 1;
                      v226[4] = (Il2CppClass *)v222;
                      sub_1C21DDC(v226 + 4, v222);
                    }
                  }
                }
              }
            ...
            if ( v227->static_fields->StartingMemberFriendshipRate >= 1 )
            {
              ...
              {
                Time = (__int64)SingletonTemplate_object___get_Instance((const MethodInfo_388D478 *)Method_SingletonTemplate_PartyOrganizationUtility__get_Instance__);
                if ( !Time )
                  goto LABEL_813;
                ...
                if ( !HIDWORD(myCnt) || !(_DWORD)myCnt )
                  goto LABEL_564;
                v228 = (EventMargeItemUpValInfo_o *)sub_1C22084(EventMargeItemUpValInfo_TypeInfo);
                EventMargeItemUpValInfo___ctor_40149884(v228, 0, 0LL);
                if ( !v228 )
                  goto LABEL_813;
                EventMargeItemUpValInfo__SetStartingMemberFriendshipUpAll(v228, SHIDWORD(myCnt), 0LL);
                if ( !v8 )
                  goto LABEL_813;
                goto LABEL_560;
              }
                ...
                && PartyOrganizationListViewItem__get_IsStartingMember(v5, 0LL) )
              {
                ...
                if ( friendshipUpBonus[1] )
                {
                  if ( !DataManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
                  v229 = DataManager__GetMaster_object_((const MethodInfo_2FAFDB0 *)Method_DataManager_GetMaster_UserServantMaster___);
                  v230 = PartyOrganizationListViewItem__get_SvtId(v5, 0LL);
                  if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
                  Time = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v230, 0LL);
                  if ( !v229 )
                    goto LABEL_813;
                  HeroineData = UserServantMaster__getHeroineData((UserServantMaster_o *)v229, Time, 0LL);
                  if ( !HeroineData || UserServantEntity__IsAddFriendShipHeroine(HeroineData, 0LL) )
                  {
                    ...
                    if ( !v228 )
                      goto LABEL_813;
                    EventMargeItemUpValInfo__SetStartingMemberFriendshipUp(v228, friendshipUpBonus[1], 0LL);
                    if ( !v8 )
                      goto LABEL_813;
LABEL_560:
                    v232 = v8->fields._items;
                    v233 = Method_System_Collections_Generic_List_EventMargeItemUpValInfo__Add__;
                    ++v8->fields._version;
                    if ( !v232 )
                      goto LABEL_813;
                    v234 = v8->fields._size;
                    ...
                    else
                    {
                      ...
                      v8->fields._size = v234 + 1;
                      v235[4] = (Il2CppClass *)v228;
                      sub_1C21DDC(v235 + 4, v228);
                    }
                  }
                }
              }
...
LABEL_564:
            ...
            if ( *(_BYTE *)(*(_QWORD *)(Time + 184) + 1105LL) )
            {
              ...
              {
                startingNum[1] = 0;
                v237 = FriendshipUpValTuple_k__BackingField->max_length;
                if ( v237 >= 1 )
                {
                  v238 = 0;
                  while ( v238 < (unsigned int)v237 )
                  {
                    v239 = *(_QWORD *)&FriendshipUpValTuple_k__BackingField->m_Items[v238].fields.Item2;
                    v240 = (EventMargeItemUpValInfo_o *)sub_1C22084(EventMargeItemUpValInfo_TypeInfo);
                    EventMargeItemUpValInfo___ctor_40149884(v240, 0, 0LL);
                    if ( !v240 )
                      goto LABEL_813;
                    EventMargeItemUpValInfo__SetFriendshipUpBonus(v240, v239, SHIDWORD(v239), 0LL);
                    if ( !v8 )
                      goto LABEL_813;
                    v241 = v8->fields._items;
                    v242 = Method_System_Collections_Generic_List_EventMargeItemUpValInfo__Add__;
                    ++v8->fields._version;
                    if ( !v241 )
                      goto LABEL_813;
                    v243 = v8->fields._size;
                    ...
                    else
                    {
                      ...
                      v8->fields._size = v243 + 1;
                      v244[4] = (Il2CppClass *)v240;
                      Time = sub_1C21DDC(v244 + 4, v240);
                    }
                    v238 = startingNum[1] + 1;
                    startingNum[1] = v238;
                    v237 = FriendshipUpValTuple_k__BackingField->max_length;
                    if ( v238 >= v237 )
                      goto LABEL_578;
...
LABEL_578:
            if ( v5->fields._IsNotClassBoardNpc_k__BackingField )
            {
              ...
              ClassBoardReleaseQuestId = v245->static_fields->ClassBoardReleaseQuestId;
              if ( !CondType_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
              Time = CondType__IsQuestClear_38834244(ClassBoardReleaseQuestId, -1, 0, 0LL);
              if ( (Time & 1) != 0 )
              {
                v247 = (EventMargeItemUpValInfo_o *)sub_1C22084(EventMargeItemUpValInfo_TypeInfo);
                EventMargeItemUpValInfo___ctor_40149884(v247, 0, 0LL);
                if ( !v247 )
                  goto LABEL_813;
                EventMargeItemUpValInfo__SetNotClassBoard(v247, 0LL);
                if ( !v8 )
                  goto LABEL_813;
                v248 = v8->fields._items;
                v249 = Method_System_Collections_Generic_List_EventMargeItemUpValInfo__Add__;
                ++v8->fields._version;
                if ( !v248 )
                  goto LABEL_813;
                v250 = v8->fields._size;
                if ( (unsigned int)v250 >= v248->max_length )
                {
                  System_Collections_Generic_List_object___AddWithResize(
                    v8,
                    (Il2CppObject *)v247,
                    *(const MethodInfo_364F0B4 **)(*(_QWORD *)(v249[4] + 192LL) + 112LL));
                }
                else
                {
                  v251 = &v248->obj.klass + v250;
                  v8->fields._size = v250 + 1;
                  v251[4] = (Il2CppClass *)v247;
                  Time = sub_1C21DDC(v251 + 4, v247);
                }
              }
            }
            v252 = v343;
            if ( v5->fields._IsDispSvtPoint_k__BackingField )
            {
              ...
              if ( !questRestrictionInfo )
                goto LABEL_813;
              v254 = questRestrictionInfo->fields.eventId;
              v255 = (EventMargeItemUpValInfo_o *)sub_1C22084(EventMargeItemUpValInfo_TypeInfo);
              EventMargeItemUpValInfo___ctor_40149884(v255, v254, 0LL);
              if ( !v255 )
                goto LABEL_813;
            ...
            if ( UnityEngine_Object__op_Inequality(noneEquipSprite, 0LL, 0LL) )
            {
              ...
              if ( UnityEngine_Object__op_Inequality(hideEquipSprite, 0LL, 0LL) )
              {
                ...
                if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
                v259 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(EquipSvtId, 0LL);
                if ( (v341 & 1) != 0 )
                {
                ...
                else
                {
                  ...
                  if ( v261 < 1 )
                  {
                    ...
                    if ( !Time )
                      goto LABEL_813;
                    UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Time, 0, 0LL);
                    v265 = (UnityEngine_Object_o *)this->fields.equipLimitCountSprite;
                    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_646:
                  ...
                  else
                  {
                    ...
                    if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
                    AtlasManager__SetEquipFace(equipSprite, v261, ImagePartsGroupIdxs_k__BackingField, 0LL);
                    v266 = (UnityEngine_Object_o *)this->fields.equipLimitCountSprite;
                    if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                      j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
                    if ( UnityEngine_Object__op_Inequality(v266, 0LL, 0LL) )
                    {
                      ...
                      else
                      {
                        ...
                        item = (PartyOrganizationListViewItem_o *)((int)Time >= v267);
                      }
                      if ( !v268 )
                        goto LABEL_813;
                      Time = v268;
            ...
            if ( PartyOrganizationListViewItem__get_IsLeave(v5, 0LL) )
            {
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              QuestRestrictionMessage = LocalizationManager__Get((System_String_o *)StringLiteral_11725/*"SELECT_NO_SORTIE"*/, 0LL);
              goto LABEL_653;
            }
...
LABEL_653:
              v273 = QuestRestrictionMessage;
              v274 = 1116471296;
LABEL_654:
              v368.fields.x = 0.0;
              v368.fields.z = 0.0;
              LODWORD(v368.fields.y) = v274;
              PartyOrganizationListViewItemDraw__SetMaskMessage(this, v273, v368, v270);
LABEL_655:
              v276 = 1;
              goto LABEL_662;
            }
...
LABEL_658:
              ...
              v276 = 1;
LABEL_661:
              PartyOrganizationListViewItemDraw__SetWarningMessage(this, UniqueIndividualityRestrictionMessage, 1, v278);
              goto LABEL_662;
            }
...
LABEL_790:
            ...
            {
              PartyOrganizationListViewItemDraw__SetFatigueMask(this, v5, v272);
              goto LABEL_655;
            }
            if ( v5->fields._IsAllOutBattle_k__BackingField )
            {
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              v273 = LocalizationManager__Get((System_String_o *)StringLiteral_11726/*"SELECT_NO_SORTIE_ALLOUT_BATTLE"*/, 0LL);
              v274 = 1113325568;
              goto LABEL_654;
            }
            if ( v5->fields._IsNotSupportSingle_k__BackingField )
            {
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              UniqueSvtRestrictionMessage = LocalizationManager__Get((System_String_o *)StringLiteral_10489/*"PARTY_ORGANIZATION_QUEST_RESTRICTION_WARNING_SINGLE_SUPPORT"*/, 0LL);
              goto LABEL_658;
            }
            if ( v5->fields._IsDataLost_k__BackingField )
            {
              PartyOrganizationListViewItemDraw__SetDataLostMask(this, v271);
            }
            else
            {
              if ( v5->fields._TimesToRestart_k__BackingField < 1 )
              {
                PartyOrganizationListViewItemDraw__ClearMessage(this, v271);
                v276 = 0;
                goto LABEL_812;
              }
              if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
              v334 = LocalizationManager__Get((System_String_o *)StringLiteral_11732/*"SELECT_NO_SORTIE_TIMES_TO_RESTART"*/, 0LL);
              TimesToRestart_k__BackingField = v5->fields._TimesToRestart_k__BackingField;
              v338 = (Il2CppObject *)j_il2cpp_value_box_0(
                                       int_TypeInfo,
                                       &TimesToRestart_k__BackingField,
                                       v335,
                                       v336,
                                       v337);
              v339 = System_String__Format(v334, v338, 0LL);
              v372.fields.x = 0.0;
              v372.fields.z = 0.0;
              v372.fields.y = 55.0;
              PartyOrganizationListViewItemDraw__SetMaskMessage(this, v339, v372, v340);
            }
            v276 = 1;
LABEL_812:
            v8 = v347;
            v252 = v343;
LABEL_662:
            PartyOrganizationListViewItemDraw__SetWaveBattleMask(this, v5, v275);
            v281 = v276 | v252 || !v5->fields.questRestrictionInfo || v5->fields._IsDataLost_k__BackingField;
            PartyOrganizationListViewItemDraw__SetClassCompatibilityIcon(this, v5, v281 != 0, v280);
            correctionIconSprite = (UnityEngine_Object_o *)this->fields.correctionIconSprite;
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
            if ( UnityEngine_Object__op_Inequality(correctionIconSprite, 0LL, 0LL) )
            {
              v352[0] = PartyOrganizationListViewItem__GetCorrectionIconId(v5, 0LL);
              Time = (__int64)this->fields.correctionIconSprite;
              if ( !Time )
                goto LABEL_813;
              if ( (v352[0] & 0x80000000) != 0 )
              {
                UISprite__set_spriteName((UISprite_o *)Time, 0LL, 0LL);
              }
              else
              {
                ...
                v283 = v5->fields.eventUpValItemList;
                v284 = localPosition.fields.x;
                v285 = localPosition.fields.z;
                if ( v283 )
                  LODWORD(v283) = v283->max_length != 0;
                if ( v8 )
                  v286 = v8->fields._size > 0;
                else
                  v286 = 0;
                v287 = v286 | (unsigned int)v283;
                v288 = PartyOrganizationListViewItemDraw_TypeInfo;
                ...
                if ( !v287 )
                  v289 = 4LL;
                value = (float)*(int *)((char *)&v288->static_fields->MESSAGE_X_SIZE_MAX + v289);
                Time = (__int64)this->fields.correctionIconSprite;
                if ( !Time )
                  goto LABEL_813;
                Time = (__int64)UnityEngine_Component__get_transform((UnityEngine_Component_o *)Time, 0LL);
                ...
                v370.fields.x = v284;
                v370.fields.z = v285;
                UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)Time, v370, 0LL);
                v290 = this->fields.correctionIconSprite;
                v291 = System_Int32__ToString((int32_t)v352, 0LL);
                Time = (__int64)System_String__Concat_63115476((System_String_o *)StringLiteral_18581/*"correction_icon_"*/, v291, 0LL);
                if ( !v290 )
                  goto LABEL_813;
                UISprite__set_spriteName(v290, (System_String_o *)Time, 0LL);
                Time = (__int64)this->fields.correctionIconSprite;
                if ( !Time )
                  goto LABEL_813;
                (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)Time + 840LL))(
            ...
            {
              v292 = PartyOrganizationListViewItem__GetQuestRestrictionMessage(v5, 0LL);
              v371.fields.x = 0.0;
              v371.fields.y = 18.0;
              v371.fields.z = 0.0;
              PartyOrganizationListViewItemDraw__SetMessage(this, v292, v371, 1, 0, 0, 0, v293);
              Time = (__int64)this->fields.switchMessageUIList;
              if ( Time )
              {
                item = (PartyOrganizationListViewItem_o *)this->fields.fixNpcUiWidget;
                v294 = *(_QWORD *)(Time + 16);
                v295 = Method_System_Collections_Generic_List_UIWidget__Add__;
                ++*(_DWORD *)(Time + 28);
                if ( !v294 )
                  goto LABEL_813;
                v296 = *(int *)(Time + 24);
                if ( (unsigned int)v296 >= *(_DWORD *)(v294 + 24) )
                {
                  System_Collections_Generic_List_object___AddWithResize(
                    (System_Collections_Generic_List_object__o *)Time,
                    (Il2CppObject *)item,
                    *(const MethodInfo_364F0B4 **)(*(_QWORD *)(v295[4] + 192LL) + 112LL));
                }
                else
                {
                  v297 = v294 + 8 * v296;
                  *(_DWORD *)(Time + 24) = v296 + 1;
                  *(_QWORD *)(v297 + 32) = item;
                  sub_1C21DDC(v297 + 32, item);
                }
              }
            }
            else
            ...
            if ( (Time & 1) != 0 )
            {
              if ( !v5->fields.isMyServantOrNpcRestriction )
                goto LABEL_706;
              v300 = v5->fields.questRestrictionInfo;
              if ( !v300 )
                goto LABEL_813;
              if ( v300->fields.isDataLostBattle || PartyOrganizationListViewItem__get_IsQuestRestriction(v5, 0LL) )
              {
LABEL_706:
              ...
              else
              {
                ...
                if ( !Time )
                  goto LABEL_813;
                UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Time, 1, 0LL);
                v326 = (UnityEngine_Object_o *)this->fields.restrictionMessageText;
                if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
                if ( UnityEngine_Object__op_Inequality(v326, 0LL, 0LL) )
                {
                  v327 = this->fields.restrictionMessageText;
                  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                  Time = (__int64)LocalizationManager__Get((System_String_o *)StringLiteral_10521/*"PARTY_ORGANIZATION_SERVANT_QUEST_RESTRICTION_MY_SERVANT_OR_NPC"*/, 0LL);
                  if ( !v327 )
                    goto LABEL_813;
                  UILabel__set_text(v327, (System_String_o *)Time, 0LL);
                  Time = (__int64)this->fields.switchMessageUIList;
                  if ( !Time )
                    goto LABEL_813;
...
LABEL_724:
            ...
            {
              v305 = this->fields.baseSprite;
              baseDefaultUIAtlas = this->fields.baseDefaultUIAtlas;
              classId = v5->fields.classId;
              if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
              AtlasManager__SetFormationBase(v305, frameType, baseDefaultUIAtlas, classId, 0LL);
            }
            base2Sprite = (UnityEngine_Object_o *)this->fields.base2Sprite;
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
            ...
            {
              v309 = this->fields.base2Sprite;
              base2DefaultUIAtlas = this->fields.base2DefaultUIAtlas;
              v311 = v5->fields.classId;
              if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
              AtlasManager__SetFormationFrame(v309, frameType, base2DefaultUIAtlas, v311, 0LL);
            }
            eventUpValIcon = (UnityEngine_Object_o *)this->fields.eventUpValIcon;
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_767:
              ...
              v318 = isEventUpVal;
LABEL_766:
              ShiningIconComponent__Set_39478664((ShiningIconComponent_o *)Time, v318, 0LL);
              goto LABEL_767;
            }
            ...
            if ( userServantEntity )
            {
              ...
              if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
              *(_QWORD *)&v364.fields.currentCryptoKey = v315;
              *(_QWORD *)&v364.fields.fakeValue = v314;
              Time = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v364, 0LL);
              if ( !v5->fields.userServantEntity )
                goto LABEL_813;
              v316 = Time;
            ...
            else
            {
              ...
              if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
              *(_QWORD *)&v365.fields.currentCryptoKey = v320;
              *(_QWORD *)&v365.fields.fakeValue = v319;
              v316 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v365, 0LL);
              Time = (__int64)PartyOrganizationListViewItem__get_ServantLeader(v5, 0LL);
              if ( !Time )
                goto LABEL_813;
...
LABEL_756:
            if ( eventUpValInfo )
            {
              v322 = eventUpValInfo->fields.equipSvtId;
              if ( !v8 )
                goto LABEL_813;
            }
            else
            ...
            v323 = this->fields.eventUpValIcon;
            Time = (__int64)System_Collections_Generic_List_object___ToArray(
                              v8,
                              (const MethodInfo_3650C0C *)Method_System_Collections_Generic_List_EventMargeItemUpValInfo__ToArray__);
            if ( !v323 )
              goto LABEL_813;
            EventUpValIconComponent__Set(v323, (EventMargeItemUpValInfo_array *)Time, v316, v321, v322, 0LL);
            v324 = (UnityEngine_Object_o *)this->fields.bounusIcon;
            if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
            if ( !UnityEngine_Object__op_Inequality(v324, 0LL, 0LL) )
              goto LABEL_767;
            Time = (__int64)this->fields.bounusIcon;
            if ( !Time )
              goto LABEL_813;
          ...
          v209 = v5->fields.userServantEntity;
          if ( v209 && UserServantEntity__IsEventJoin(v209, 0LL) )
          {
            Time = (__int64)this->fields.supportSprite;
            if ( !Time )
              goto LABEL_813;
            v210 = &StringLiteral_20505/*"icon_eventjoin_02"*/;
          }
          else
          {
            Time = (__int64)this->fields.supportSprite;
            ...
            v210 = &StringLiteral_20546/*"icon_support_02"*/;
          }
          v211 = (System_String_o *)*v210;
LABEL_511:
          UISprite__set_spriteName((UISprite_o *)Time, v211, 0LL);
          goto LABEL_512;
        }
        Time = (__int64)this->fields.switchSkillUIList;
        if ( Time )
        {
          ...
          if ( (unsigned int)v185 >= *(_DWORD *)(v183 + 24) )
          {
            System_Collections_Generic_List_object___AddWithResize(
              (System_Collections_Generic_List_object__o *)Time,
              (Il2CppObject *)item,
              *(const MethodInfo_364F0B4 **)(*(_QWORD *)(v184[4] + 192LL) + 112LL));
          }
          else
          {
            v186 = v183 + 8 * v185;
            *(_DWORD *)(Time + 24) = v185 + 1;
            *(_QWORD *)(v186 + 32) = item;
            sub_1C21DDC(v186 + 32, item);
          }
        }
        Time = (__int64)this->fields.appendSkillList;
        if ( Time )
        {
          ...
          if ( Time )
          {
            ...
            if ( Time )
            {
              AppendSkillListComponent__Set((AppendSkillListComponent_o *)Time, LevelList_39646380, 0LL);
              goto LABEL_457;
            }
          }
        }
LABEL_813:
        sub_1C22094(Time, item);
      }
...
LABEL_410:
          ...
          else
          {
            ...
            {
LABEL_411:
              v177 = (UnityEngine_Object_o *)this->fields.restrictionMessageFrameSprite;
              if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
              if ( UnityEngine_Object__op_Inequality(v177, 0LL, 0LL) )
              {
                ...
                if ( !Time )
                  goto LABEL_813;
                UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Time, 0, 0LL);
                v178 = (UnityEngine_Object_o *)this->fields.restrictionMessageText;
                if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
              ...
              v179 = (UnityEngine_Object_o *)this->fields.fixPosMessageFrameSprite;
              if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
              ...
              v180 = (UnityEngine_Object_o *)this->fields.fixPosMessageLabel;
              if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
                j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
...
LABEL_163:
          ...
          && v5->fields._IsDispCanGetBuddyPoint_k__BackingField )
        {
          ...
          if ( !AtlasManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
          AtlasManager__SetEventUI(canGetBuddyPointIconSprite, (System_String_o *)StringLiteral_20016/*"func_group_icon_1028"*/, 0LL);
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v63 = LocalizationManager__Get((System_String_o *)StringLiteral_10475/*"PARTY_ORGANIZATION_GET_SERVANT_POINT"*/, 0LL);
          ...
          Time = (__int64)System_String__Format(v63, v67, 0LL);
          if ( !v62 )
            goto LABEL_813;
          ...
          if ( UnityEngine_Object__op_Inequality(canGetBuddyPointBaseObj, 0LL, 0LL) )
          {
            ...
            *(UnityEngine_Vector3_o *)(&v69 - 1) = UnityEngine_Transform__get_localPosition(
            ...
            if ( !Time )
              goto LABEL_813;
            v366.fields.x = -(float)(v74 + (float)(v77 * v82));
            v366.fields.y = v71;
            v366.fields.z = v72;
            UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)Time, v366, 0LL);
          }
        }
        v34 = 0;
        eventId = 0;
      ...
      if ( v5->fields.userServantEntity )
      {
        ...
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_TypeInfo);
        Time = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v51, 0LL);
        if ( !v50 )
          goto LABEL_813;
        ...
        v363 = PartyOrganizationListViewItem__get_SvtId(v5, 0LL);
        Time = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47621364(v363, 0LL);
        ...
        if ( !v5->fields.userServantEntity )
          goto LABEL_813;
        v55 = Time;
        UserServantEntity__getSkillInfo(v5->fields.userServantEntity, &v358, -1, Time, 1, 0, -1, 0LL);
        Time = (__int64)v5->fields.userServantEntity;
        if ( !Time )
          goto LABEL_813;
        UserServantEntity__getTreasureDeviceInfo((UserServantEntity_o *)Time, &v357, -1, v55, 0, 0LL);
        v56 = v358;
        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
        Time = (__int64)LocalizationManager__GetLevelList_39646380(v56, 0LL);
        if ( !v357 )
          goto LABEL_813;
        v42 = (System_String_o *)Time;
        Time = (__int64)v5->fields.userServantEntity;
        if ( !Time )
          goto LABEL_813;
        v30 = v357->fields.treasureDeviceNum;
        LevelList_39646380 = v48;
        lv = v357->fields.lv;
        strengthStatus = v357->fields.strengthStatus;
        UserServantEntity__GetAppendPassiveSkillInfo_41506440((UserServantEntity_o *)Time, &v356, 0LL);
        v57 = v356;
        if ( v356 && *(_QWORD *)&v356->max_length )
        {
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          LevelList_39646380 = LocalizationManager__GetLevelList_39646380(v57, 0LL);
        }
        goto LABEL_163;
      }
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD82E8 & 1) == 0 )
  {
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&PartyOrganizationListViewItemDraw_TypeInfo);
    sub_1C21E38(&StringLiteral_434/*"#0039E2"*/);
    sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BD82E8 = 1;
  }
  ...
  *(_QWORD *)&v21.fields.b = 0LL;
  ...
  if ( UnityEngine_Object__op_Inequality(restrictionMaskSprite, 0LL, 0LL) )
  {
    ...
    if ( isFatigue )
    {
      UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_434/*"#0039E2"*/, &v21, 0LL);
      gameObject = (UnityEngine_Component_o *)this->fields.restrictionMaskSprite;
      if ( !gameObject )
        goto LABEL_47;
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v17.fields.b = 0LL;
  ...
  if ( UnityEngine_Object__op_Inequality(restrictionMaskSprite, 0LL, 0LL) )
  {
    UnityEngine_ColorUtility__TryParseHtmlString((System_String_o *)StringLiteral_433/*"#000000"*/, &v17, 0LL);
    ...
    if ( !byte_4BD6BB6 )
    {
      gameObject = (UIWidget_o *)sub_1C21E38(&UnityEngine_Vector3_TypeInfo);
      byte_4BD6BB6 = 1;
    }
    if ( !v13 )
      goto LABEL_44;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD82E6 & 1) == 0 )
  {
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&PartyOrganizationListViewItemDraw_TypeInfo);
    sub_1C21E38(&StringLiteral_20677/*"img_frames_mask12"*/);
    sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BD82E6 = 1;
  }
  restrictionMaskSprite = (UnityEngine_Object_o *)this->fields.restrictionMaskSprite;
  ...
  if ( isSlotRestriction )
  {
    ...
    if ( !gameObject )
      goto LABEL_111;
    UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_20677/*"img_frames_mask12"*/, 0LL);
    gameObject = (UnityEngine_Component_o *)this->fields.restrictionMask2Sprite;
    if ( !gameObject )
      goto LABEL_111;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD82EA & 1) == 0 )
  {
    ...
    sub_1C21E38(&UnityEngine_Object_TypeInfo);
    sub_1C21E38(&PartyOrganizationListViewItemDraw_TypeInfo);
    sub_1C21E38(&StringLiteral_20675/*"img_frames_mask08"*/);
    sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BD82EA = 1;
  }
  restrictionMaskSprite = (UnityEngine_Object_o *)this->fields.restrictionMaskSprite;
  ...
  if ( UnityEngine_Object__op_Inequality(restrictionMask2Sprite, 0LL, 0LL) )
  {
    ...
    if ( !gameObject )
      goto LABEL_64;
    UISprite__set_spriteName((UISprite_o *)gameObject, (System_String_o *)StringLiteral_20675/*"img_frames_mask08"*/, 0LL);
  }
  restrictionWarningBase = (UnityEngine_Object_o *)this->fields.restrictionWarningBase;
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD82F2 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_20678/*"img_frames_mask13"*/);
    sub_1C21E38(&StringLiteral_15771/*"WAVE_BATTLE_DISAPPEAR_EQUIP"*/);
    sub_1C21E38(&StringLiteral_20675/*"img_frames_mask08"*/);
    sub_1C21E38(&StringLiteral_15772/*"WAVE_BATTLE_DISAPPEAR_SERVANT"*/);
    byte_4BD82F2 = 1;
  }
  PartyOrganizationListViewItemDraw__ClearWaveBattleMask(this, (const MethodInfo *)item);
  if ( !item )
  ...
  if ( item->fields._IsClearedWave_k__BackingField )
  {
    ...
    if ( !restrictionMaskMessageText
      ...
      || (UISprite__set_spriteName(
            ...
            (System_String_o *)StringLiteral_20675/*"img_frames_mask08"*/,
            0LL),
    ...
    {
LABEL_69:
      sub_1C22094(restrictionMaskMessageText, v6);
    }
    v21.fields.x = 0.0;
    v21.fields.y = 0.0;
    v21.fields.z = 0.0;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v14 = &StringLiteral_15759/*"WAVE_BATTLE_ALREADY_SORTIE"*/;
LABEL_64:
  ...
  if ( item->fields._IsDisappearSvt_k__BackingField )
  {
    if ( item->fields._IsDisappearEquip_k__BackingField )
    {
      ...
      if ( !UnityEngine_Object__op_Equality(v8, 0LL, 0LL) )
      {
        ...
        if ( !restrictionMaskMessageText )
          goto LABEL_69;
        UISprite__set_spriteName((UISprite_o *)restrictionMaskMessageText, (System_String_o *)StringLiteral_20675/*"img_frames_mask08"*/, 0LL);
        ...
        restrictionMaskMessageText = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                                  (System_String_o *)StringLiteral_15772/*"WAVE_BATTLE_DISAPPEAR_SERVANT"*/,
                                                                  0LL);
        if ( !v10 )
          goto LABEL_69;
...
LABEL_61:
          ...
          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          v14 = &StringLiteral_15771/*"WAVE_BATTLE_DISAPPEAR_EQUIP"*/;
          goto LABEL_64;
        }
      }
    }
    else
    {
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      v18 = LocalizationManager__Get((System_String_o *)StringLiteral_15772/*"WAVE_BATTLE_DISAPPEAR_SERVANT"*/, 0LL);
      v22.fields.x = 0.0;
      v22.fields.z = 0.0;
      v22.fields.y = 47.0;
  ...
  else
  {
    ...
    if ( UnityEngine_Object__op_Inequality(waveBattleEquipMaskSprite, 0LL, 0LL) )
    {
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      AtlasManager__SetEventSprite(v16, (System_String_o *)StringLiteral_20678/*"img_frames_mask13"*/, 0LL);
