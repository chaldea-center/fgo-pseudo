        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7F5 & 1) == 0 )
  {
    sub_1B761C0(&BalanceConfig_TypeInfo, supportServantData);
  ...
  while ( 1 )
  {
    ...
    if ( v7 >= supportServantData->max_length )
      sub_1B76424(v9, supportServantData);
    v9 = supportServantData->m_Items[v7];
    if ( !v9 )
LABEL_16:
      sub_1B7641C(v9, supportServantData);
    v10 = SupportServantData__updateNameCheck(v9, 0LL);
    if ( v10 )
    {
      v11 = v10;
      if ( v8 >= 1 )
        v6 = System_String__Concat_61535060(v6, (System_String_o *)StringLiteral_868/*","*/, 0LL);
      v6 = System_String__Concat_61535060(v6, v11, 0LL);
      ++v8;
    }
    ++v7;
  }
  ...
  while ( 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v8 >= supportServantData->max_length )
        sub_1B76424(v7, supportServantData);
      v7 = *v11;
      if ( !*v11 )
LABEL_21:
        sub_1B7641C(v7, supportServantData);
      ...
      if ( v12 )
      {
        ...
        if ( v9 >= 1 )
          v6 = System_String__Concat_61535060(v6, (System_String_o *)StringLiteral_868/*","*/, 0LL);
        v6 = System_String__Concat_61535060(v6, v13, 0LL);
        ++v9;
      }
      v7 = BalanceConfig_TypeInfo;
      ++v10;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B761C0(&BalanceConfig_TypeInfo, supportServantData);
    sub_1B761C0(&Method_System_Collections_Generic_List_SupportServantData_FollowerData__Add__, v4);
    sub_1B761C0(&Method_System_Collections_Generic_List_SupportServantData_FollowerData___ctor__, v5);
    sub_1B761C0(&System_Collections_Generic_List_SupportServantData_FollowerData__TypeInfo, v6);
    byte_4A2F7F3 = 1;
  }
  v7 = (System_Collections_Generic_List_object__o *)sub_1B7640C(System_Collections_Generic_List_SupportServantData_FollowerData__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_34D6DA0 *)Method_System_Collections_Generic_List_SupportServantData_FollowerData___ctor__);
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    while ( 1 )
    {
      ...
      if ( i >= supportServantData->max_length )
        sub_1B76424(FollowerDataIfUpdated, v8);
      FollowerDataIfUpdated = (SupportServantData_o *)*v12;
      if ( !*v12 )
LABEL_23:
        sub_1B7641C(FollowerDataIfUpdated, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7F6 & 1) == 0 )
  {
    sub_1B761C0(&System_Convert_TypeInfo, supportServantData);
    sub_1B761C0(&JsonManager_TypeInfo, v11);
    sub_1B761C0(&MiniMessagePack_MiniMessagePacker_TypeInfo, v12);
    sub_1B761C0(&StringLiteral_23676/*"supportDeckId"*/, v13);
    sub_1B761C0(&StringLiteral_19438/*"fixEventSupportDeckIds"*/, v14);
    sub_1B761C0(&StringLiteral_18516/*"deckName"*/, v15);
    sub_1B761C0(&StringLiteral_15806/*"["*/, v16);
    sub_1B761C0(&StringLiteral_19439/*"fixMainSupportDeckIds"*/, v17);
    sub_1B761C0(&StringLiteral_16063/*"]"*/, v18);
    this = (FollowerSetupRequest_o *)sub_1B761C0(&StringLiteral_19499/*"followerData"*/, v19);
    byte_4A2F7F6 = 1;
  }
  ...
  RequestBase__addField(v10, (System_String_o *)StringLiteral_23676/*"supportDeckId"*/, supportDeckId, v25);
  v26 = System_String__Concat_61546320(
          (System_String_o *)StringLiteral_15806/*"["*/,
          DeckNameData,
          (System_String_o *)StringLiteral_16063/*"]"*/,
          0LL);
  RequestBase__addField_40941128(v10, (System_String_o *)StringLiteral_18516/*"deckName"*/, v26, v27);
  v28 = (MiniMessagePack_MiniMessagePacker_o *)sub_1B7640C(MiniMessagePack_MiniMessagePacker_TypeInfo);
  ...
  if ( !v28 )
    sub_1B7641C(FollowerDataList, v32);
  ...
  RequestBase__addField_40941128(v10, (System_String_o *)StringLiteral_19499/*"followerData"*/, v34, v35);
  RequestBase__addField_40941128(v10, (System_String_o *)StringLiteral_19439/*"fixMainSupportDeckIds"*/, v23, v36);
  RequestBase__addField_40941128(v10, (System_String_o *)StringLiteral_19438/*"fixEventSupportDeckIds"*/, v24, v37);
...
System_String_o *__fastcall FollowerSetupRequest__getURL(FollowerSetupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2F7F1 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_19496/*"follower/setup"*/, v2);
    byte_4A2F7F1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61535060(BaseUrl, (System_String_o *)StringLiteral_19496/*"follower/setup"*/, 0LL);
}
