void SampleEventListViewItem___ctor(SampleEventListViewItem_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4C350FB & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_6191/*"Event Number {0}"*/);
    byte_4C350FB = 1;
  }
  ...
  v13 = System_String__Format((System_String_o *)StringLiteral_6191/*"Event Number {0}"*/, v12, 0);
  this->fields.eventText = v13;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.eventText, (int32_t)v13, v14, v15);
}
...
System_String_o *SampleEventListViewItem__ToString(SampleEventListViewItem_o *this, const MethodInfo *method)
{
  ...
  return System_String__Concat_63558796(
           (System_String_o *)StringLiteral_19155/*"eventType "*/,
           v3,
