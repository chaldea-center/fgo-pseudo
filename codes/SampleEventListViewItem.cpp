void SampleEventListViewItem___ctor(SampleEventListViewItem_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E0E3 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_6223/*"Event Number {0}"*/);
    byte_4D2E0E3 = 1;
  }
  ...
  v7 = System_String__Format((System_String_o *)StringLiteral_6223/*"Event Number {0}"*/, v6, 0);
  this->fields.eventText = v7;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.eventText, (int32_t)v7, v8, v9, v10, v11, v12, v13);
}
