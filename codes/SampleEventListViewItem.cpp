void SampleEventListViewItem___ctor(SampleEventListViewItem_o *this, int32_t index, const MethodInfo *method)
{
  ...
  if ( (byte_4E74D94 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_6257/*"Event Number {0}"*/);
    byte_4E74D94 = 1;
  }
  ...
  v7 = System_String__Format((System_String_o *)StringLiteral_6257/*"Event Number {0}"*/, v6, 0);
  this->fields.eventText = v7;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields.eventText, (int32_t)v7, v8, v9, v10, v11, v12, v13);
}
