void TypewriterEffect___ctor(TypewriterEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0901E & 1) == 0 )
  {
    sub_1CE6700(&Method_BetterList_TypewriterEffect_FadeEntry___ctor__);
    sub_1CE6700(&BetterList_TypewriterEffect_FadeEntry__TypeInfo);
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mFullText, v10, v11, v12, v13, v14, v15, v16);
  this->fields.mReset = 1;
  v17 = (BetterList_TypewriterEffect_FadeEntry__o *)sub_1CE694C(BetterList_TypewriterEffect_FadeEntry__TypeInfo);
  BetterList_TypewriterEffect_FadeEntry____ctor(
    v17,
    (const MethodInfo_3465C5C *)Method_BetterList_TypewriterEffect_FadeEntry___ctor__);
  this->fields.mFade = v17;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mFade, (int32_t)v17, v18, v19, v20, v21, v22, v23);
...
void TypewriterEffect__Finish(TypewriterEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0901C & 1) == 0 )
  {
    sub_1CE6700(&Method_BetterList_TypewriterEffect_FadeEntry__Clear__);
    sub_1CE6700(&EventDelegate_TypeInfo);
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    this = (TypewriterEffect_o *)sub_1CE6700(&TypewriterEffect_TypeInfo);
    byte_4E0901C = 1;
  }
  if ( v8->fields.mActive )
  {
    ...
    if ( !mReset )
    {
      ...
      BetterList_TypewriterEffect_FadeEntry___Clear(
        ...
        (const MethodInfo_34651F8 *)Method_BetterList_TypewriterEffect_FadeEntry__Clear__);
...
LABEL_15:
      ...
      EventDelegate__Execute_50327612(onFinished, 0);
...
void TypewriterEffect__Update(TypewriterEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0901D & 1) == 0 )
  {
    sub_1CE6700(&Method_BetterList_TypewriterEffect_FadeEntry__Add__);
    sub_1CE6700(&Method_BetterList_TypewriterEffect_FadeEntry__Clear__);
    sub_1CE6700(&Method_BetterList_TypewriterEffect_FadeEntry__RemoveAt__);
    sub_1CE6700(&Method_BetterList_TypewriterEffect_FadeEntry__get_Item__);
    sub_1CE6700(&Method_BetterList_TypewriterEffect_FadeEntry__set_Item__);
    ...
    sub_1CE6700(&TypewriterEffect_TypeInfo);
    this = (TypewriterEffect_o *)sub_1CE6700(&StringLiteral_15992/*"[00]"*/);
    byte_4E0901D = 1;
  }
...
LABEL_28:
    ...
    if ( fadeInTime == 0.0 )
    {
      ...
      this = (TypewriterEffect_o *)System_String__Substring_65168768(
      ...
      if ( keepFullDimensions )
      {
        ...
        this = (TypewriterEffect_o *)System_String__Concat_65161092(v39, (System_String_o *)StringLiteral_15992/*"[00]"*/, v40, 0);
        v39 = (System_String_o *)this;
      }
      if ( !mLabel )
        goto LABEL_107;
    ...
    else
    {
      ...
      *(_OWORD *)&v78.fields.index = (unsigned int)mCurrentOffset;
      ...
      if ( !this )
        goto LABEL_107;
      v78.fields.text = System_String__Substring_65168768(
                          (System_String_o *)this,
                          mCurrentOffset,
      ...
      BetterList_TypewriterEffect_FadeEntry___Add(
        (BetterList_TypewriterEffect_FadeEntry__o *)this,
        &length,
        (const MethodInfo_3465210 *)Method_BetterList_TypewriterEffect_FadeEntry__Add__);
    }
    mFullText = v8->fields.mFullText;
    if ( !mFullText )
      goto LABEL_107;
  ...
  if ( LODWORD(this->fields.m_CancellationTokenSource) )
  {
    ...
    while ( 1 )
    {
      ...
      BetterList_TypewriterEffect_FadeEntry___get_Item(
        ...
        (BetterList_TypewriterEffect_FadeEntry__o *)this,
        v50,
        (const MethodInfo_3464F60 *)Method_BetterList_TypewriterEffect_FadeEntry__get_Item__);
      ...
      if ( v55 < 1.0 )
      {
        ...
        *(_OWORD *)&length.fields.index = v77;
        BetterList_TypewriterEffect_FadeEntry___set_Item(
          ...
          v50,
          &length,
          (const MethodInfo_3464FA0 *)Method_BetterList_TypewriterEffect_FadeEntry__set_Item__);
        this = (TypewriterEffect_o *)v8->fields.mFade;
        ++v50;
        if ( !this )
          goto LABEL_107;
      ...
      else
      {
        ...
        BetterList_TypewriterEffect_FadeEntry___RemoveAt(
          (BetterList_TypewriterEffect_FadeEntry__o *)this,
          v50,
          (const MethodInfo_346588C *)Method_BetterList_TypewriterEffect_FadeEntry__RemoveAt__);
        this = (TypewriterEffect_o *)v8->fields.mFade;
        if ( !this )
          goto LABEL_107;
      }
    ...
    {
      v56 = (System_Text_StringBuilder_o *)sub_1CE694C(System_Text_StringBuilder_TypeInfo);
      ...
      while ( v57 < SLODWORD(this->fields.m_CancellationTokenSource) )
      {
        ...
        else
        {
          ...
          if ( !v56 )
            goto LABEL_107;
          System_Text_StringBuilder__Append_65206788(v56, (System_String_o *)this, 0);
        }
        System_Text_StringBuilder__Append_65209116(v56, 0x5Bu, 0);
        if ( !NGUIText_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(NGUIText_TypeInfo);
        v60 = NGUIText__EncodeAlpha(v59, 0);
        System_Text_StringBuilder__Append_65206788(v56, v60, 0);
        System_Text_StringBuilder__Append_65209116(v56, 0x5Du, 0);
        System_Text_StringBuilder__Append_65206788(v56, text, 0);
        this = (TypewriterEffect_o *)v8->fields.mFade;
        ++v57;
        if ( !this )
          goto LABEL_107;
      ...
      if ( v8->fields.keepFullDimensions )
      {
        if ( v56 )
        {
          System_Text_StringBuilder__Append_65206788(v56, (System_String_o *)StringLiteral_15992/*"[00]"*/, 0);
          this = (TypewriterEffect_o *)v8->fields.mFullText;
          if ( this )
          {
            v61 = System_String__Substring((System_String_o *)this, *p_mCurrentOffset, 0);
            System_Text_StringBuilder__Append_65206788(v56, v61, 0);
            goto LABEL_101;
          }
        }
        goto LABEL_107;
...
LABEL_107:
    ...
    else
    {
      ...
      if ( v71 )
      {
        ...
        this = (TypewriterEffect_o *)System_String__Concat_65161092(v72, (System_String_o *)StringLiteral_15992/*"[00]"*/, v73, 0);
        if ( !v70 )
          goto LABEL_107;
        v74 = (System_String_o *)this;
        v75 = v70;
