void TypewriterEffect___ctor(TypewriterEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BFC3 & 1) == 0 )
  {
    sub_1C32C20(&Method_BetterList_TypewriterEffect_FadeEntry___ctor__);
    sub_1C32C20(&BetterList_TypewriterEffect_FadeEntry__TypeInfo);
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.onFinished, (int32_t)v3, v4, v5);
  v6 = StringLiteral_1/*""*/;
  this->fields.mFullText = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mFullText, v6, v7, v8);
  this->fields.mReset = 1;
  v9 = (BetterList_TypewriterEffect_FadeEntry__o *)sub_1C32E6C(BetterList_TypewriterEffect_FadeEntry__TypeInfo);
  BetterList_TypewriterEffect_FadeEntry____ctor(
    v9,
    (const MethodInfo_3314ED0 *)Method_BetterList_TypewriterEffect_FadeEntry___ctor__);
  this->fields.mFade = v9;
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.mFade, (int32_t)v9, v10, v11);
...
void TypewriterEffect__Finish(TypewriterEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BFC1 & 1) == 0 )
  {
    sub_1C32C20(&Method_BetterList_TypewriterEffect_FadeEntry__Clear__);
    sub_1C32C20(&EventDelegate_TypeInfo);
    sub_1C32C20(&UnityEngine_Object_TypeInfo);
    this = (TypewriterEffect_o *)sub_1C32C20(&TypewriterEffect_TypeInfo);
    byte_4C3BFC1 = 1;
  }
  if ( v4->fields.mActive )
  {
    ...
    if ( !mReset )
    {
      ...
      BetterList_TypewriterEffect_FadeEntry___Clear(
        ...
        (const MethodInfo_331446C *)Method_BetterList_TypewriterEffect_FadeEntry__Clear__);
...
LABEL_15:
      ...
      sub_1C32BC4((CGThumbnailListItem_o *)TypewriterEffect_TypeInfo->static_fields, (int32_t)v4, v2, v3);
      onFinished = v4->fields.onFinished;
      if ( !EventDelegate_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
      EventDelegate__Execute_49177388(onFinished, 0);
      TypewriterEffect_TypeInfo->static_fields->current = 0;
      sub_1C32BC4((CGThumbnailListItem_o *)TypewriterEffect_TypeInfo->static_fields, 0, v9, v10);
      return;
    }
LABEL_19:
    sub_1C32E7C(this);
...
void TypewriterEffect__Update(TypewriterEffect_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3BFC2 & 1) == 0 )
  {
    sub_1C32C20(&Method_BetterList_TypewriterEffect_FadeEntry__Add__);
    sub_1C32C20(&Method_BetterList_TypewriterEffect_FadeEntry__Clear__);
    sub_1C32C20(&Method_BetterList_TypewriterEffect_FadeEntry__RemoveAt__);
    sub_1C32C20(&Method_BetterList_TypewriterEffect_FadeEntry__get_Item__);
    sub_1C32C20(&Method_BetterList_TypewriterEffect_FadeEntry__set_Item__);
    ...
    sub_1C32C20(&TypewriterEffect_TypeInfo);
    this = (TypewriterEffect_o *)sub_1C32C20(&StringLiteral_15839/*"[00]"*/);
    byte_4C3BFC2 = 1;
  }
  ...
  if ( v4->fields.mReset )
  {
    ...
    sub_1C32BC4((CGThumbnailListItem_o *)&v4->fields.mLabel, (int32_t)Component_object, v6, v7);
    this = (TypewriterEffect_o *)v4->fields.mLabel;
    if ( !this )
      goto LABEL_107;
    processedText = UILabel__get_processedText((UILabel_o *)this, 0);
    v4->fields.mFullText = processedText;
    sub_1C32BC4((CGThumbnailListItem_o *)&v4->fields.mFullText, (int32_t)processedText, v9, v10);
    this = (TypewriterEffect_o *)v4->fields.mFade;
    if ( !this )
      goto LABEL_107;
    BetterList_TypewriterEffect_FadeEntry___Clear(
...
LABEL_28:
    ...
    if ( fadeInTime == 0.0 )
    {
      ...
      this = (TypewriterEffect_o *)System_String__Substring_63564468(
      ...
      if ( keepFullDimensions )
      {
        ...
        this = (TypewriterEffect_o *)System_String__Concat_63556792(v27, (System_String_o *)StringLiteral_15839/*"[00]"*/, v28, 0);
        v27 = (System_String_o *)this;
      }
      if ( !mLabel )
        goto LABEL_107;
    ...
    else
    {
      ...
      *(_OWORD *)&v58.fields.index = (unsigned int)mCurrentOffset;
      ...
      if ( !this )
        goto LABEL_107;
      v58.fields.text = System_String__Substring_63564468(
                          (System_String_o *)this,
                          mCurrentOffset,
                          v4->fields.mCurrentOffset - mCurrentOffset,
                          0);
      sub_1C32BC4((CGThumbnailListItem_o *)&v58.fields.text, (int32_t)v58.fields.text, v30, v31);
      this = (TypewriterEffect_o *)v4->fields.mFade;
      if ( !this )
        goto LABEL_107;
      length = v58;
      BetterList_TypewriterEffect_FadeEntry___Add(
        (BetterList_TypewriterEffect_FadeEntry__o *)this,
        &length,
        (const MethodInfo_3314484 *)Method_BetterList_TypewriterEffect_FadeEntry__Add__);
    }
    mFullText = v4->fields.mFullText;
    if ( !mFullText )
      goto LABEL_107;
  ...
  if ( LODWORD(this->fields.m_CancellationTokenSource) )
  {
    ...
    while ( 1 )
    {
      ...
      BetterList_TypewriterEffect_FadeEntry___get_Item(
        ...
        (BetterList_TypewriterEffect_FadeEntry__o *)this,
        v34,
        (const MethodInfo_33141D4 *)Method_BetterList_TypewriterEffect_FadeEntry__get_Item__);
      ...
      if ( v39 < 1.0 )
      {
        ...
        *(_OWORD *)&length.fields.index = v57;
        BetterList_TypewriterEffect_FadeEntry___set_Item(
          ...
          v34,
          &length,
          (const MethodInfo_3314214 *)Method_BetterList_TypewriterEffect_FadeEntry__set_Item__);
        this = (TypewriterEffect_o *)v4->fields.mFade;
        ++v34;
        if ( !this )
          goto LABEL_107;
      ...
      else
      {
        ...
        BetterList_TypewriterEffect_FadeEntry___RemoveAt(
          (BetterList_TypewriterEffect_FadeEntry__o *)this,
          v34,
          (const MethodInfo_3314B00 *)Method_BetterList_TypewriterEffect_FadeEntry__RemoveAt__);
        this = (TypewriterEffect_o *)v4->fields.mFade;
        if ( !this )
          goto LABEL_107;
      }
    ...
    {
      v40 = (System_Text_StringBuilder_o *)sub_1C32E6C(System_Text_StringBuilder_TypeInfo);
      ...
      while ( v41 < SLODWORD(this->fields.m_CancellationTokenSource) )
      {
        ...
        else
        {
          ...
          if ( !v40 )
            goto LABEL_107;
          System_Text_StringBuilder__Append_63603608(v40, (System_String_o *)this, 0);
        }
        System_Text_StringBuilder__Append_63605936(v40, 0x5Bu, 0);
        if ( !NGUIText_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(NGUIText_TypeInfo);
        v44 = NGUIText__EncodeAlpha(v43, 0);
        System_Text_StringBuilder__Append_63603608(v40, v44, 0);
        System_Text_StringBuilder__Append_63605936(v40, 0x5Du, 0);
        System_Text_StringBuilder__Append_63603608(v40, text, 0);
        this = (TypewriterEffect_o *)v4->fields.mFade;
        ++v41;
        if ( !this )
          goto LABEL_107;
      ...
      if ( v4->fields.keepFullDimensions )
      {
        if ( v40 )
        {
          System_Text_StringBuilder__Append_63603608(v40, (System_String_o *)StringLiteral_15839/*"[00]"*/, 0);
          this = (TypewriterEffect_o *)v4->fields.mFullText;
          if ( this )
          {
            v45 = System_String__Substring((System_String_o *)this, *p_mCurrentOffset, 0);
            System_Text_StringBuilder__Append_63603608(v40, v45, 0);
            goto LABEL_101;
          }
        }
        goto LABEL_107;
...
LABEL_107:
    ...
    else
    {
      ...
      if ( v51 )
      {
        ...
        this = (TypewriterEffect_o *)System_String__Concat_63556792(v52, (System_String_o *)StringLiteral_15839/*"[00]"*/, v53, 0);
        if ( !v50 )
          goto LABEL_107;
        v54 = (System_String_o *)this;
        v55 = v50;
  ...
  else
  {
    ...
    if ( *p_mCurrentOffset == v46->fields._stringLength )
    {
      ...
      EventDelegate__Execute_49177388(onFinished, 0);
      TypewriterEffect_TypeInfo->static_fields->current = 0;
      sub_1C32BC4((CGThumbnailListItem_o *)TypewriterEffect_TypeInfo->static_fields, 0, v48, v49);
      v4->fields.mActive = 0;
    }
  }
}
