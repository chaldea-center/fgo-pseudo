        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78F0D & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&AssetManager_TypeInfo);
    sub_1D0F0B4(&Method_UIHorizontalImageM_EndLoadAsset__);
    sub_1D0F0B4(&UIHorizontalImageRender_TypeInfo);
    byte_4E78F0D = 1;
  }
  if ( !UIHorizontalImageRender_TypeInfo->_2.cctor_finished )
...
void UIHorizontalImageM__SetTexture(UIHorizontalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78F0F & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageM_o *)sub_1D0F0B4(&StringLiteral_16857/*"a"*/);
    byte_4E78F0F = 1;
  }
  ...
  this = (UIHorizontalImageM_o *)AssetData__GetObject_object__52624444(
                                   v4,
                                   LastName,
