        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2E12B & 1) == 0 )
  {
    ...
    sub_1C94098(&AssetManager_TypeInfo);
    sub_1C94098(&Method_UIHorizontalImageM_EndLoadAsset__);
    sub_1C94098(&UIHorizontalImageRender_TypeInfo);
    byte_4D2E12B = 1;
  }
  if ( !UIHorizontalImageRender_TypeInfo->_2.cctor_finished )
...
void UIHorizontalImageM__SetTexture(UIHorizontalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2E12D & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageM_o *)sub_1C94098(&StringLiteral_16690/*"a"*/);
    byte_4D2E12D = 1;
  }
  ...
  this = (UIHorizontalImageM_o *)AssetData__GetObject_object__51893132(
                                   v4,
                                   LastName,
