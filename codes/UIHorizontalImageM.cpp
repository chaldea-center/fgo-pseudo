        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C39229 & 1) == 0 )
  {
    ...
    sub_1C32C20(&AssetManager_TypeInfo);
    sub_1C32C20(&Method_UIHorizontalImageM_EndLoadAsset__);
    sub_1C32C20(&UIHorizontalImageRender_TypeInfo);
    byte_4C39229 = 1;
  }
  if ( !UIHorizontalImageRender_TypeInfo->_2.cctor_finished )
...
void UIHorizontalImageM__SetTexture(UIHorizontalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3922B & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageM_o *)sub_1C32C20(&StringLiteral_16629/*"a"*/);
    byte_4C3922B = 1;
  }
  ...
  this = (UIHorizontalImageM_o *)AssetData__GetObject_object__51111776(
                                   v4,
                                   LastName,
