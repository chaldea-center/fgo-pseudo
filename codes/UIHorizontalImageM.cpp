        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E06266 & 1) == 0 )
  {
    ...
    sub_1CE6700(&AssetManager_TypeInfo);
    sub_1CE6700(&Method_UIHorizontalImageM_EndLoadAsset__);
    sub_1CE6700(&UIHorizontalImageRender_TypeInfo);
    byte_4E06266 = 1;
  }
  if ( !UIHorizontalImageRender_TypeInfo->_2.cctor_finished )
...
void UIHorizontalImageM__SetTexture(UIHorizontalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06268 & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageM_o *)sub_1CE6700(&StringLiteral_16786/*"a"*/);
    byte_4E06268 = 1;
  }
  ...
  this = (UIHorizontalImageM_o *)AssetData__GetObject_object__52317288(
                                   v4,
                                   LastName,
