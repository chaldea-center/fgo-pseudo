        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8C8E & 1) == 0 )
  {
    ...
    sub_1C713B0(&AssetManager_TypeInfo);
    sub_1C713B0(&Method_UIHorizontalImageM_EndLoadAsset__);
    sub_1C713B0(&UIHorizontalImageRender_TypeInfo);
    byte_4CC8C8E = 1;
  }
  if ( !UIHorizontalImageRender_TypeInfo->_2.cctor_finished )
...
void UIHorizontalImageM__SetTexture(UIHorizontalImageM_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC8C90 & 1) == 0 )
  {
    ...
    this = (UIHorizontalImageM_o *)sub_1C713B0(&StringLiteral_16632/*"a"*/);
    byte_4CC8C90 = 1;
  }
  ...
  this = (UIHorizontalImageM_o *)AssetData__GetObject_object__51560868(
                                   v4,
                                   LastName,
