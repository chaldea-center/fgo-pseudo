void __fastcall WarClearReward___ctor(WarClearReward_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.giftId = 0LL;
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.title, (int64_t)v3, v4, v5, v6, v7, v8, v9);
  v10 = StringLiteral_1/*""*/;
  this->fields.message = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.message, (int64_t)v10, v11, v12, v13, v14, v15, v16);
}