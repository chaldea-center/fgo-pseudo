...
void SampleAssetBundleScene__Init(SampleAssetBundleScene_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_5935CBA & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_SampleAssetBundleScene_LoadDependEnd__);
    sub_21FFC50(&Method_SampleAssetBundleScene_LoadMatEnd__);
    sub_21FFC50(&Method_SampleAssetBundleScene_LoadPackEnd4__);
    sub_21FFC50(&Method_SampleAssetBundleScene_LoadPackEnd__);
    sub_21FFC50(&string___TypeInfo);
    sub_21FFC50(&StringLiteral_14273/*"Test/card003"*/);
    sub_21FFC50(&StringLiteral_14265/*"Test/Card001d"*/);
    sub_21FFC50(&StringLiteral_8480/*"Items/ItemAtlas"*/);
    sub_21FFC50(&StringLiteral_14266/*"Test/DependCommon"*/);
    sub_21FFC50(&StringLiteral_14270/*"Test/TestCube"*/);
    sub_21FFC50(&StringLiteral_14271/*"Test/card002d.png"*/);
    byte_5935CBA = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v11 = v3;
    if ( !*(_DWORD *)(v3 + 24)
      || (v12 = StringLiteral_14265/*"Test/Card001d"*/,
          *(_QWORD *)(v3 + 32) = StringLiteral_14265/*"Test/Card001d"*/,
          sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v3 + 32), v12, v5, v6, v7, v8, v9, v10),
          (*(_DWORD *)(v11 + 24) & 0xFFFFFFFE) == 0)
      || (v19 = StringLiteral_14271/*"Test/card002d.png"*/,
          *(_QWORD *)(v11 + 40) = StringLiteral_14271/*"Test/card002d.png"*/,
          sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v11 + 40), v19, v13, v14, v15, v16, v17, v18),
          *(_DWORD *)(v11 + 24) <= 2u) )
    {
      sub_21FFED4(v3);
    }
    v26 = StringLiteral_14270/*"Test/TestCube"*/;
    *(_QWORD *)(v11 + 48) = StringLiteral_14270/*"Test/TestCube"*/;
    ...
    AssetManager__loadAssetStorage_47472372((System_String_array *)v11, v27, 1, 0);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_8480/*"Items/ItemAtlas"*/, v30, 1, 0, 0);
    ...
    v33 = (AssetLoader_LoadEndDataHandler_o *)sub_21FFEBC(v32);
    AssetLoader_LoadEndDataHandler___ctor(v33, (Il2CppObject *)this, Method_SampleAssetBundleScene_LoadPackEnd4__, 0);
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_14273/*"Test/card003"*/, v33, 1, 0, 0);
    v34 = (AssetLoader_LoadEndDataHandler_o *)sub_21FFEBC(AssetLoader_LoadEndDataHandler_TypeInfo);
    AssetLoader_LoadEndDataHandler___ctor(v34, (Il2CppObject *)this, Method_SampleAssetBundleScene_LoadDependEnd__, 0);
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_14266/*"Test/DependCommon"*/, v34, 1, 0, 0);
  }
}
...
void SampleAssetBundleScene__LoadDependEnd(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_5935CC1 & 1) == 0 )
  {
    sub_21FFC50(&System_Action_TypeInfo);
    sub_21FFC50(&AssetManager_TypeInfo);
    sub_21FFC50(&Method_SampleAssetBundleScene_LoadDependEnd2__);
    sub_21FFC50(&string___TypeInfo);
    sub_21FFC50(&StringLiteral_14267/*"Test/DependPrefab1"*/);
    sub_21FFC50(&StringLiteral_14269/*"Test/DependPrefab3"*/);
    sub_21FFC50(&StringLiteral_14268/*"Test/DependPrefab2"*/);
    byte_5935CC1 = 1;
  }
  v4 = sub_21FFD10(string___TypeInfo, 3);
  if ( !v4 )
    sub_21FFECC(0, v5);
  v12 = v4;
  if ( !*(_DWORD *)(v4 + 24)
    || (v13 = StringLiteral_14267/*"Test/DependPrefab1"*/,
        *(_QWORD *)(v4 + 32) = StringLiteral_14267/*"Test/DependPrefab1"*/,
        sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v4 + 32), v13, v6, v7, v8, v9, v10, v11),
        (*(_DWORD *)(v12 + 24) & 0xFFFFFFFE) == 0)
    || (v20 = StringLiteral_14268/*"Test/DependPrefab2"*/,
        *(_QWORD *)(v12 + 40) = StringLiteral_14268/*"Test/DependPrefab2"*/,
        sub_21FFBF4((MissionNaviTransitionBoardItem_o *)(v12 + 40), v20, v14, v15, v16, v17, v18, v19),
        *(_DWORD *)(v12 + 24) <= 2u) )
  {
    sub_21FFED4(v4);
  }
  v27 = StringLiteral_14269/*"Test/DependPrefab3"*/;
  *(_QWORD *)(v12 + 48) = StringLiteral_14269/*"Test/DependPrefab3"*/;
  ...
  AssetManager__loadAssetStorage_47472372((System_String_array *)v12, v28, 1, 0);
}
...
void SampleAssetBundleScene__LoadDependEnd2(SampleAssetBundleScene_o *this, const MethodInfo *method)
{
  ...
  SampleAssetBundleScene__SetAssetPrefab(this, (System_String_o *)StringLiteral_14267/*"Test/DependPrefab1"*/, 100.0, 0.0, v2);
  SampleAssetBundleScene__SetAssetPrefab(this, (System_String_o *)StringLiteral_14268/*"Test/DependPrefab2"*/, 200.0, 0.0, v4);
  SampleAssetBundleScene__SetAssetPrefab(this, (System_String_o *)StringLiteral_14269/*"Test/DependPrefab3"*/, 300.0, 0.0, v5);
}
...
void SampleAssetBundleScene__LoadMatEnd(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_5935CC0 & 1) == 0 )
  {
    ...
    this = (SampleAssetBundleScene_o *)sub_21FFC50(&StringLiteral_1371/*"100"*/);
    byte_5935CC0 = 1;
  }
  if ( !data
    || (this = (SampleAssetBundleScene_o *)AssetData__GetObject_object_(
                                             data,
                                             (const MethodInfo_379EFEC *)Method_AssetData_GetObject_GameObject___)) == 0
...
void SampleAssetBundleScene__LoadPackEnd(SampleAssetBundleScene_o *this, const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&AssetManager_TypeInfo);
    sub_21FFC50(&StringLiteral_14272/*"Test/card002p.png"*/);
    sub_21FFC50(&StringLiteral_14264/*"Test/Card001"*/);
    sub_21FFC50(&StringLiteral_14270/*"Test/TestCube"*/);
    byte_5935CBB = 1;
  }
  if ( !*(&AssetManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo, method, v2);
  AssetStorage = AssetManager__getAssetStorage((System_String_o *)StringLiteral_14264/*"Test/Card001"*/, 0);
  SampleAssetBundleScene__LoadPackEnd1(this, AssetStorage, v5);
  v6 = AssetManager__getAssetStorage((System_String_o *)StringLiteral_14272/*"Test/card002p.png"*/, 0);
  SampleAssetBundleScene__LoadPackEnd2(this, v6, v7);
  v8 = AssetManager__getAssetStorage((System_String_o *)StringLiteral_14270/*"Test/TestCube"*/, 0);
...
void SampleAssetBundleScene__LoadPackEnd1(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_5935CBC & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_UnityEngine_GameObject_AddComponent_UITexture___);
    sub_21FFC50(&NGUITools_TypeInfo);
    sub_21FFC50(&StringLiteral_14275/*"Test1"*/);
    sub_21FFC50(&StringLiteral_18508/*"card001"*/);
    byte_5935CBC = 1;
  }
  ...
  UnityEngine_Object__set_name(transform, (System_String_o *)StringLiteral_14275/*"Test1"*/, 0);
  ...
  if ( !transform
    || (v10.fields.z = 0.0,
        ...
        transform = (UnityEngine_Object_o *)UnityEngine_GameObject__AddComponent_object_(
                                              v8,
                                              (const MethodInfo_38839E8 *)Method_UnityEngine_GameObject_AddComponent_UITexture___),
        !data)
    || (v9 = (UIWidget_o *)transform,
        transform = (UnityEngine_Object_o *)AssetData__GetObject_object__58323140(
                                              data,
                                              (System_String_o *)StringLiteral_18508/*"card001"*/,
...
void SampleAssetBundleScene__LoadPackEnd2(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_5935CBD & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_UnityEngine_GameObject_AddComponent_UITexture___);
    sub_21FFC50(&NGUITools_TypeInfo);
    sub_21FFC50(&StringLiteral_14276/*"Test2"*/);
    byte_5935CBD = 1;
  }
  testParentObject = this->fields.testParentObject;
  if ( !*(&NGUITools_TypeInfo->_2.cctor_finished + 1) )
  ...
  if ( !transform )
    goto LABEL_10;
  v8 = (UnityEngine_GameObject_o *)transform;
  UnityEngine_Object__set_name(transform, (System_String_o *)StringLiteral_14276/*"Test2"*/, 0);
  transform = (UnityEngine_Object_o *)UnityEngine_GameObject__get_transform(v8, 0);
  if ( !transform
    || (v10.fields.z = 0.0,
        v10.fields.x = 200.0,
...
void SampleAssetBundleScene__LoadPackEnd3(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_5935CBE & 1) == 0 )
  {
    ...
    this = (SampleAssetBundleScene_o *)sub_21FFC50(&UnityEngine_Object_TypeInfo);
    byte_5935CBE = 1;
  }
  if ( !data )
    goto LABEL_13;
  ...
  this = (SampleAssetBundleScene_o *)UnityEngine_Object__Instantiate_83245144(Object, 0);
  if ( !this )
    goto LABEL_13;
  v8 = this;
...
void SampleAssetBundleScene__LoadPackEnd4(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_5935CBF & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_14277/*"Test4"*/);
    byte_5935CBF = 1;
  }
  testParentObject = this->fields.testParentObject;
  if ( !*(&NGUITools_TypeInfo->_2.cctor_finished + 1) )
  ...
  if ( !transform )
    goto LABEL_15;
  v8 = (UnityEngine_GameObject_o *)transform;
  UnityEngine_Object__set_name(transform, (System_String_o *)StringLiteral_14277/*"Test4"*/, 0);
  transform = (UnityEngine_Object_o *)UnityEngine_GameObject__get_transform(v8, 0);
  if ( !transform )
    goto LABEL_15;
  v10.fields.z = 0.0;
        ...
        const MethodInfo *method)
{
  ...
  AssetStorage = (AssetData_o *)UnityEngine_Object__Instantiate_83245144(Object, 0);
  if ( !AssetStorage )
    goto LABEL_18;
  ...
  if ( !byte_5931945 )
  {
    AssetStorage = (AssetData_o *)sub_21FFC50(&UnityEngine_Vector3_TypeInfo);
    byte_5931945 = 1;
  }
  if ( !v16
