...
void SampleAssetBundleScene__Init(SampleAssetBundleScene_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C350A2 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SampleAssetBundleScene_LoadDependEnd__);
    sub_1C32C20(&Method_SampleAssetBundleScene_LoadMatEnd__);
    sub_1C32C20(&Method_SampleAssetBundleScene_LoadPackEnd4__);
    sub_1C32C20(&Method_SampleAssetBundleScene_LoadPackEnd__);
    sub_1C32C20(&string___TypeInfo);
    sub_1C32C20(&StringLiteral_13732/*"Test/card003"*/);
    sub_1C32C20(&StringLiteral_13724/*"Test/Card001d"*/);
    sub_1C32C20(&StringLiteral_8145/*"Items/ItemAtlas"*/);
    sub_1C32C20(&StringLiteral_13725/*"Test/DependCommon"*/);
    sub_1C32C20(&StringLiteral_13729/*"Test/TestCube"*/);
    sub_1C32C20(&StringLiteral_13730/*"Test/card002d.png"*/);
    byte_4C350A2 = 1;
  }
  if ( !this->fields.state )
  {
    ...
    v6 = v3;
    if ( !*(_DWORD *)(v3 + 24)
      || (v7 = StringLiteral_13724/*"Test/Card001d"*/,
          *(_QWORD *)(v3 + 32) = StringLiteral_13724/*"Test/Card001d"*/,
          sub_1C32BC4((CGThumbnailListItem_o *)(v3 + 32), v7, v4, v5),
          *(_DWORD *)(v6 + 24) <= 1u)
      || (v10 = StringLiteral_13730/*"Test/card002d.png"*/,
          *(_QWORD *)(v6 + 40) = StringLiteral_13730/*"Test/card002d.png"*/,
          sub_1C32BC4((CGThumbnailListItem_o *)(v6 + 40), v10, v8, v9),
          *(_DWORD *)(v6 + 24) <= 2u) )
    {
      sub_1C32E84(v3);
    }
    v13 = StringLiteral_13729/*"Test/TestCube"*/;
    *(_QWORD *)(v6 + 48) = StringLiteral_13729/*"Test/TestCube"*/;
    ...
    AssetManager__loadAssetStorage_40442140((System_String_array *)v6, v14, 1, 0);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_8145/*"Items/ItemAtlas"*/, v15, 1, 0);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_13732/*"Test/card003"*/, v16, 1, 0);
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_13725/*"Test/DependCommon"*/, v17, 1, 0);
  }
}
...
void SampleAssetBundleScene__LoadDependEnd(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C350A9 & 1) == 0 )
  {
    sub_1C32C20(&System_Action_TypeInfo);
    sub_1C32C20(&AssetManager_TypeInfo);
    sub_1C32C20(&Method_SampleAssetBundleScene_LoadDependEnd2__);
    sub_1C32C20(&string___TypeInfo);
    sub_1C32C20(&StringLiteral_13726/*"Test/DependPrefab1"*/);
    sub_1C32C20(&StringLiteral_13728/*"Test/DependPrefab3"*/);
    sub_1C32C20(&StringLiteral_13727/*"Test/DependPrefab2"*/);
    byte_4C350A9 = 1;
  }
  v4 = sub_1C32CC8(string___TypeInfo, 3);
  if ( !v4 )
    sub_1C32E7C(0);
  v7 = v4;
  if ( !*(_DWORD *)(v4 + 24)
    || (v8 = StringLiteral_13726/*"Test/DependPrefab1"*/,
        *(_QWORD *)(v4 + 32) = StringLiteral_13726/*"Test/DependPrefab1"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v4 + 32), v8, v5, v6),
        *(_DWORD *)(v7 + 24) <= 1u)
    || (v11 = StringLiteral_13727/*"Test/DependPrefab2"*/,
        *(_QWORD *)(v7 + 40) = StringLiteral_13727/*"Test/DependPrefab2"*/,
        sub_1C32BC4((CGThumbnailListItem_o *)(v7 + 40), v11, v9, v10),
        *(_DWORD *)(v7 + 24) <= 2u) )
  {
    sub_1C32E84(v4);
  }
  v14 = StringLiteral_13728/*"Test/DependPrefab3"*/;
  *(_QWORD *)(v7 + 48) = StringLiteral_13728/*"Test/DependPrefab3"*/;
  sub_1C32BC4((CGThumbnailListItem_o *)(v7 + 48), v14, v12, v13);
  ...
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetManager__loadAssetStorage_40442140((System_String_array *)v7, v15, 1, 0);
}
...
void SampleAssetBundleScene__LoadDependEnd2(SampleAssetBundleScene_o *this, const MethodInfo *method)
{
  ...
  SampleAssetBundleScene__SetAssetPrefab(this, (System_String_o *)StringLiteral_13726/*"Test/DependPrefab1"*/, 100.0, 0.0, v2);
  SampleAssetBundleScene__SetAssetPrefab(this, (System_String_o *)StringLiteral_13727/*"Test/DependPrefab2"*/, 200.0, 0.0, v4);
  SampleAssetBundleScene__SetAssetPrefab(this, (System_String_o *)StringLiteral_13728/*"Test/DependPrefab3"*/, 300.0, 0.0, v5);
}
...
void SampleAssetBundleScene__LoadMatEnd(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C350A8 & 1) == 0 )
  {
    ...
    this = (SampleAssetBundleScene_o *)sub_1C32C20(&StringLiteral_1295/*"100"*/);
    byte_4C350A8 = 1;
  }
  if ( !data
    || (this = (SampleAssetBundleScene_o *)AssetData__GetObject_object_(
                                             data,
                                             (const MethodInfo_30BE658 *)Method_AssetData_GetObject_GameObject___)) == 0
...
void SampleAssetBundleScene__LoadPackEnd(SampleAssetBundleScene_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C32C20(&AssetManager_TypeInfo);
    sub_1C32C20(&StringLiteral_13731/*"Test/card002p.png"*/);
    sub_1C32C20(&StringLiteral_13723/*"Test/Card001"*/);
    sub_1C32C20(&StringLiteral_13729/*"Test/TestCube"*/);
    byte_4C350A3 = 1;
  }
  if ( !AssetManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
  AssetStorage = AssetManager__getAssetStorage((System_String_o *)StringLiteral_13723/*"Test/Card001"*/, 0);
  SampleAssetBundleScene__LoadPackEnd1(this, AssetStorage, v4);
  v5 = AssetManager__getAssetStorage((System_String_o *)StringLiteral_13731/*"Test/card002p.png"*/, 0);
  SampleAssetBundleScene__LoadPackEnd2(this, v5, v6);
  v7 = AssetManager__getAssetStorage((System_String_o *)StringLiteral_13729/*"Test/TestCube"*/, 0);
...
void SampleAssetBundleScene__LoadPackEnd1(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C350A4 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_UnityEngine_GameObject_AddComponent_UITexture___);
    sub_1C32C20(&NGUITools_TypeInfo);
    sub_1C32C20(&StringLiteral_13734/*"Test1"*/);
    sub_1C32C20(&StringLiteral_17756/*"card001"*/);
    byte_4C350A4 = 1;
  }
  ...
  UnityEngine_Object__set_name(transform, (System_String_o *)StringLiteral_13734/*"Test1"*/, 0);
  ...
  if ( !transform
    || (v9.fields.z = 0.0,
        ...
        transform = (UnityEngine_Object_o *)UnityEngine_GameObject__AddComponent_object_(
                                              v7,
                                              (const MethodInfo_3134888 *)Method_UnityEngine_GameObject_AddComponent_UITexture___),
        !data)
    || (v8 = (UIWidget_o *)transform,
        transform = (UnityEngine_Object_o *)AssetData__GetObject_object__51111776(
                                              data,
                                              (System_String_o *)StringLiteral_17756/*"card001"*/,
...
void SampleAssetBundleScene__LoadPackEnd2(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C350A5 & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_UnityEngine_GameObject_AddComponent_UITexture___);
    sub_1C32C20(&NGUITools_TypeInfo);
    sub_1C32C20(&StringLiteral_13735/*"Test2"*/);
    byte_4C350A5 = 1;
  }
  testParentObject = this->fields.testParentObject;
  if ( !NGUITools_TypeInfo->_2.cctor_finished )
  ...
  if ( !transform )
    goto LABEL_10;
  v7 = (UnityEngine_GameObject_o *)transform;
  UnityEngine_Object__set_name(transform, (System_String_o *)StringLiteral_13735/*"Test2"*/, 0);
  transform = (UnityEngine_Object_o *)UnityEngine_GameObject__get_transform(v7, 0);
  if ( !transform
    || (v9.fields.z = 0.0,
        v9.fields.x = 200.0,
...
void SampleAssetBundleScene__LoadPackEnd3(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C350A6 & 1) == 0 )
  {
    ...
    this = (SampleAssetBundleScene_o *)sub_1C32C20(&UnityEngine_Object_TypeInfo);
    byte_4C350A6 = 1;
  }
  if ( !data )
    goto LABEL_13;
  ...
  this = (SampleAssetBundleScene_o *)UnityEngine_Object__Instantiate_71222852(Object, 0);
  if ( !this )
    goto LABEL_13;
  v6 = this;
...
void SampleAssetBundleScene__LoadPackEnd4(SampleAssetBundleScene_o *this, AssetData_o *data, const MethodInfo *method)
{
  ...
  if ( (byte_4C350A7 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_13736/*"Test4"*/);
    byte_4C350A7 = 1;
  }
  testParentObject = this->fields.testParentObject;
  if ( !NGUITools_TypeInfo->_2.cctor_finished )
  ...
  if ( !transform )
    goto LABEL_15;
  v7 = (UnityEngine_GameObject_o *)transform;
  UnityEngine_Object__set_name(transform, (System_String_o *)StringLiteral_13736/*"Test4"*/, 0);
  transform = (UnityEngine_Object_o *)UnityEngine_GameObject__get_transform(v7, 0);
  if ( !transform )
    goto LABEL_15;
  v10.fields.z = 0.0;
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  AssetStorage = (AssetData_o *)UnityEngine_Object__Instantiate_71222852(Object, 0);
  if ( !AssetStorage )
    goto LABEL_18;
  ...
  if ( !byte_4C313D6 )
  {
    AssetStorage = (AssetData_o *)sub_1C32C20(&UnityEngine_Vector3_TypeInfo);
    byte_4C313D6 = 1;
  }
  if ( !v13
