        ...
        const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Equality((UnityEngine_Object_o *)v8, 0, 0) )
    return 0;
  GameObjectExtensions__SafeSetParent_37349004((UnityEngine_GameObject_o *)v8, parentObject, 0);
  if ( !v8 )
LABEL_12:
    sub_1D0F30C(mapEntity, parentObject);
...
void PlanetMapRootComponent__DestroyAll(PlanetMapRootComponent_o *this, const MethodInfo *method)
{
  ...
  if ( UnityEngine_Object__op_Inequality(PlanetEarth_k__BackingField, 0, 0) )
  {
    ...
    *p_PlanetEarth_k__BackingField = 0;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)&this->fields._PlanetEarth_k__BackingField, 0, v7, v8, v9, v10, v11, v12);
  }
  PlanetMapAssetData_k__BackingField = this->fields._PlanetMapAssetData_k__BackingField;
  if ( PlanetMapAssetData_k__BackingField )
  {
    ...
    AssetManager__releaseAsset_41894156(PlanetMapAssetData_k__BackingField, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E740DF & 1) == 0 )
  {
    ...
    this = (PlanetMapRootComponent_o *)sub_1D0F0B4(&StringLiteral_13884/*"Terminal/MapModels/{0:D4}_{1}"*/);
    byte_4E740DF = 1;
  }
  if ( !mapEntity )
    sub_1D0F30C(this, mapEntity);
  ...
  return System_String__Format_65604080((System_String_o *)StringLiteral_13884/*"Terminal/MapModels/{0:D4}_{1}"*/, v4, v5, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E740DA & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_PlanetMapRootComponent___c__DisplayClass13_0__LoadAssetData_b__0__);
    sub_1D0F0B4(&PlanetMapRootComponent___c__DisplayClass13_0_TypeInfo);
    byte_4E740DA = 1;
  }
  v7 = sub_1D0F300(PlanetMapRootComponent___c__DisplayClass13_0_TypeInfo);
  ...
  *(_QWORD *)(v7 + 24) = endAction;
  v16 = v7 + 24;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)(v7 + 24), (int32_t)endAction, v17, v18, v19, v20, v21, v22);
  this->fields.mapEntity = mapEnt;
  p_mapEntity = &this->fields.mapEntity;
  sub_1D0F058((GrandQuestFolderBoardItem_o *)p_mapEntity, (int32_t)mapEnt, v24, v25, v26, v27, v28, v29);
  ...
  if ( PlanetMapAssetData_k__BackingField )
  {
    ...
    if ( mapEntity )
    {
      ...
      if ( !PlanetEarth_k__BackingField )
        sub_1D0F30C(0, PlanetMapAssetData_k__BackingField);
...
LABEL_26:
    sub_1D0F30C(planetMapBackground, method);
  }
}
