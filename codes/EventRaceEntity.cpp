...
System_String_o *__fastcall EventRaceEntity__CreatePK(int32_t eventId, int32_t termId, const MethodInfo *method)
{
  if ( (byte_4C22000 & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&termId);
    byte_4C22000 = 1;
  }
...
int32_t __fastcall EventRaceEntity__GetGroupIdx(EventRaceEntity_o *this, int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4C22001 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Array_FindIndex_int___, *(_QWORD *)&groupId);
    sub_1C3B764(&System_Predicate_int__TypeInfo, v5);
    sub_1C3B764(&Method_EventRaceEntity___c__DisplayClass12_0__GetGroupIdx_b__0__, v6);
    sub_1C3B764(&EventRaceEntity___c__DisplayClass12_0_TypeInfo, v7);
    byte_4C22001 = 1;
  }
  v8 = sub_1C3B9B0(EventRaceEntity___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1C3B9C0(v9, v10);
  *(_DWORD *)(v8 + 16) = groupId;
  groupIds = this->fields.groupIds;
  v12 = (System_Predicate_int__o *)sub_1C3B9B0(System_Predicate_int__TypeInfo);
