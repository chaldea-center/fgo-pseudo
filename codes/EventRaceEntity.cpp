...
int32_t __fastcall EventRaceEntity__GetGroupIdx(EventRaceEntity_o *this, int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4A5B20E & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_EventRaceEntity___c__DisplayClass12_0__GetGroupIdx_b__0__);
    sub_1B885B0(&EventRaceEntity___c__DisplayClass12_0_TypeInfo);
    byte_4A5B20E = 1;
  }
  v5 = sub_1B887FC(EventRaceEntity___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  if ( !v5 )
    sub_1B8880C(v6, v7);
  *(_DWORD *)(v5 + 16) = groupId;
  groupIds = this->fields.groupIds;
  v9 = (System_Predicate_int__o *)sub_1B887FC(System_Predicate_int__TypeInfo);
