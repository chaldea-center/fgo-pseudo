...
System_String_o *__fastcall EventRaceEntity__CreatePK(int32_t eventId, int32_t termId, const MethodInfo *method)
{
  if ( (byte_4BC7B4D & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&termId);
    byte_4BC7B4D = 1;
  }
...
int32_t __fastcall EventRaceEntity__GetGroupIdx(EventRaceEntity_o *this, int32_t groupId, const MethodInfo *method)
{
  ...
  if ( (byte_4BC7B4E & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Array_FindIndex_int___, *(_QWORD *)&groupId);
    sub_1C1ABD4(&System_Predicate_int__TypeInfo, v5);
    sub_1C1ABD4(&Method_EventRaceEntity___c__DisplayClass12_0__GetGroupIdx_b__0__, v6);
    sub_1C1ABD4(&EventRaceEntity___c__DisplayClass12_0_TypeInfo, v7);
    byte_4BC7B4E = 1;
  }
  v8 = sub_1C1AE20(EventRaceEntity___c__DisplayClass12_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v8, 0LL);
  if ( !v8 )
    sub_1C1AE30(v9, v10);
  *(_DWORD *)(v8 + 16) = groupId;
  groupIds = this->fields.groupIds;
  v12 = (System_Predicate_int__o *)sub_1C1AE20(System_Predicate_int__TypeInfo);
