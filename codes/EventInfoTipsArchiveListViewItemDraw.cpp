void __fastcall EventInfoTipsArchiveListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FFD65 & 1) == 0 )
  {
    sub_1B64870(&EventInfoTipsArchiveListViewItemDraw_TypeInfo, v1);
    byte_49FFD65 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFD63 & 1) == 0 )
  {
    sub_1B64870(&EventInfoTipsArchiveListViewItemDraw_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FFD62 & 1) == 0 )
  {
    this = (EventInfoTipsArchiveListViewItemDraw_o *)sub_1B64870(&UnityEngine_Object_TypeInfo, *(_QWORD *)&id);
    byte_49FFD62 = 1;
  }
  v10->fields.id = v9;
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v10->fields.stateData, (int32_t)StateData, v13, v14);
  *(_QWORD *)&id = v10->fields.stateData && v10->fields.stateData->fields.state & 1;
  ...
  if ( !this )
    goto LABEL_17;
  ShiningIconComponent__Set_37924248((ShiningIconComponent_o *)this, id, 0LL);
  if ( !*p_stateData )
    goto LABEL_17;
...
LABEL_41:
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&v10->fields.currentSubDrawObject, (int32_t)v27, v24, v25);
LABEL_28:
