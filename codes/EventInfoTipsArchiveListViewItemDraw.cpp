        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5972FE5 & 1) == 0 )
  {
    this = (EventInfoTipsArchiveListViewItemDraw_o *)sub_2213A60(&UnityEngine_Object_TypeInfo);
    byte_5972FE5 = 1;
  }
  v10->fields.id = v9;
  ...
  sub_2213A04(
    (MissionNaviTransitionBoardItem_o *)&v10->fields.stateData,
    (int32_t)StateData,
    v13,
    v14,
    v15,
  ...
  *(_QWORD *)&id = v10->fields.stateData && v10->fields.stateData->fields.state & 1;
  ...
  if ( !this )
    goto LABEL_17;
  ShiningIconComponent__Set_48066308((ShiningIconComponent_o *)this, id, 0);
  if ( !*p_stateData )
    goto LABEL_17;
...
LABEL_41:
  ...
  sub_2213A04(
    (MissionNaviTransitionBoardItem_o *)&v10->fields.currentSubDrawObject,
    (int32_t)v35,
    v28,
    v29,
    v30,
...
LABEL_28:
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)FrameCollider, 0, 0) )
  {
    ...
    if ( this )
    {
      ...
      {
        v38 = this;
        v43 = COERCE_FLOAT(LODWORD(UnityEngine_BoxCollider__get_size(FrameCollider, 0).fields.y));
        GameObjectExtensions__SetLocalPositionY((UnityEngine_GameObject_o *)v38, v43 * -0.5, 0);
        this = (EventInfoTipsArchiveListViewItemDraw_o *)v10->fields.partitionSprite;
        if ( this )
        {
          this = (EventInfoTipsArchiveListViewItemDraw_o *)UnityEngine_Component__get_gameObject(
...
LABEL_36:
  ...
  if ( Height >= 0 )
    ...
    v42 = Height + 1;
  GameObjectExtensions__SetLocalPositionY(gameObject, v10->fields.newIconPosOffsetY + (float)(v42 >> 1), 0);
}
