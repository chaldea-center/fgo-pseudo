void __fastcall EventInfoTipsArchiveListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0A4DD & 1) == 0 )
  {
    sub_1B686D4(&EventInfoTipsArchiveListViewItemDraw_TypeInfo, v1);
    byte_4A0A4DD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A4DB & 1) == 0 )
  {
    sub_1B686D4(&EventInfoTipsArchiveListViewItemDraw_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A4DA & 1) == 0 )
  {
    this = (EventInfoTipsArchiveListViewItemDraw_o *)sub_1B686D4(&UnityEngine_Object_TypeInfo, *(_QWORD *)&id);
    byte_4A0A4DA = 1;
  }
  v10->fields.id = v9;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v10->fields.stateData, (int32_t)StateData, v13, v14);
  *(_QWORD *)&id = v10->fields.stateData && v10->fields.stateData->fields.state & 1;
  ...
  if ( !this )
    goto LABEL_17;
  ShiningIconComponent__Set_37981856((ShiningIconComponent_o *)this, id, 0LL);
  if ( !*p_stateData )
    goto LABEL_17;
...
LABEL_41:
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v10->fields.currentSubDrawObject, (int32_t)v26, v23, v24);
LABEL_28:
