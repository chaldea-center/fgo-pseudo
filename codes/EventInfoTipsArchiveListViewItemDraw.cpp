void __fastcall EventInfoTipsArchiveListViewItemDraw___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFF782 & 1) == 0 )
  {
    sub_1C2E12C(&EventInfoTipsArchiveListViewItemDraw_TypeInfo, v1);
    byte_4BFF782 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF780 & 1) == 0 )
  {
    sub_1C2E12C(&EventInfoTipsArchiveListViewItemDraw_TypeInfo, method);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFF77F & 1) == 0 )
  {
    this = (EventInfoTipsArchiveListViewItemDraw_o *)sub_1C2E12C(&UnityEngine_Object_TypeInfo, *(_QWORD *)&id);
    byte_4BFF77F = 1;
  }
  v10->fields.id = v9;
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v10->fields.stateData, (int64_t)StateData, v13, v14, v15, v16, v17, v18);
  *(_QWORD *)&id = v10->fields.stateData && v10->fields.stateData->fields.state & 1;
  ...
  if ( !this )
    goto LABEL_17;
  ShiningIconComponent__Set_39549256((ShiningIconComponent_o *)this, id, 0LL);
  if ( !*p_stateData )
    goto LABEL_17;
...
LABEL_41:
  ...
  sub_1C2E0D0((PartyOrganizationUtility_o *)&v10->fields.currentSubDrawObject, v35, v28, v29, v30, v31, v32, v33);
LABEL_28:
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)FrameCollider, 0LL, 0LL) )
  {
    ...
    if ( this )
    {
      ...
      if ( FrameCollider )
      {
        ...
        GameObjectExtensions__SetLocalPositionY((UnityEngine_GameObject_o *)v37, size.fields.y * -0.5, 0LL);
        this = (EventInfoTipsArchiveListViewItemDraw_o *)v10->fields.partitionSprite;
        if ( this )
        {
          this = (EventInfoTipsArchiveListViewItemDraw_o *)UnityEngine_Component__get_gameObject(
