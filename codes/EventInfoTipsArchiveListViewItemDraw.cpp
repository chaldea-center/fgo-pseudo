        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D32855 & 1) == 0 )
  {
    this = (EventInfoTipsArchiveListViewItemDraw_o *)sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    byte_4D32855 = 1;
  }
  v10->fields.id = v9;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v10->fields.stateData, (int32_t)StateData, v13, v14, v15, v16, v17, v18);
  *(_QWORD *)&id = v10->fields.stateData && v10->fields.stateData->fields.state & 1;
  ...
  if ( !this )
    goto LABEL_17;
  ShiningIconComponent__Set_41828676((ShiningIconComponent_o *)this, id, 0);
  if ( !*p_stateData )
    goto LABEL_17;
...
LABEL_28:
  ...
  if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)FrameCollider, 0, 0) )
  {
    ...
    if ( this )
    {
      ...
      {
        v37 = this;
        v42 = COERCE_FLOAT(LODWORD(UnityEngine_BoxCollider__get_size(FrameCollider, 0).fields.y));
        GameObjectExtensions__SetLocalPositionY((UnityEngine_GameObject_o *)v37, v42 * -0.5, 0);
        this = (EventInfoTipsArchiveListViewItemDraw_o *)v10->fields.partitionSprite;
        if ( this )
        {
          this = (EventInfoTipsArchiveListViewItemDraw_o *)UnityEngine_Component__get_gameObject(
