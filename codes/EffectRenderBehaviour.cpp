...
void __fastcall EffectRenderBehaviour__Awake(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A59F3B & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_ParticleSystemRenderer_TypeInfo);
    byte_4A59F3B = 1;
  }
...
void __fastcall EffectRenderBehaviour__OnWillRenderObject(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A59F3F & 1) == 0 )
  {
    ...
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&UnityEngine_ParticleSystemRenderer_TypeInfo);
    sub_1B885B0(&StringLiteral_16331/*"_Scaling"*/);
    sub_1B885B0(&StringLiteral_16154/*"_CameraInv"*/);
    sub_1B885B0(&StringLiteral_16155/*"_Center"*/);
    sub_1B885B0(&StringLiteral_16153/*"_Camera"*/);
    sub_1B885B0(&StringLiteral_16316/*"_RenderType"*/);
    byte_4A59F3F = 1;
  }
    ...
    && this->fields.mbCustomShader )
  {
    ...
    *(UnityEngine_Vector3_o *)&v8 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0LL);
    ...
    UnityEngine_Material__SetVector(
      material,
      (System_String_o *)StringLiteral_16155/*"_Center"*/,
    ...
    *(UnityEngine_Vector3_o *)&v13 = UnityEngine_Transform__get_lossyScale((UnityEngine_Transform_o *)transform, 0LL);
    if ( !v12 )
      goto LABEL_21;
    v16 = 0;
    UnityEngine_Material__SetVector(v12, (System_String_o *)StringLiteral_16331/*"_Scaling"*/, *(UnityEngine_Vector4_o *)&v13, 0LL);
    ...
    if ( !v17 )
      goto LABEL_21;
    v24 = v26;
    UnityEngine_Material__SetMatrix(v17, (System_String_o *)StringLiteral_16153/*"_Camera"*/, &v24, 0LL);
    ...
    if ( !v18
      || (v22 = v25,
          UnityEngine_Material__SetMatrix(v18, (System_String_o *)StringLiteral_16154/*"_CameraInv"*/, &v22, 0LL),
...
LABEL_21:
    ...
    UnityEngine_Material__SetInt(v19, (System_String_o *)StringLiteral_16316/*"_RenderType"*/, (int32_t)transform, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A59F3D & 1) == 0 )
  {
    this = (EffectRenderBehaviour_o *)sub_1B885B0(&StringLiteral_733/*"(Custom)"*/);
    byte_4A59F3D = 1;
  }
  if ( !sh )
    sub_1B8880C(this, sh);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL);
  v5 = System_String__Concat_61707032(name, (System_String_o *)StringLiteral_733/*"(Custom)"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    sub_1B885B0(&StringLiteral_733/*"(Custom)"*/);
        ...
        const MethodInfo *method)
{
  ...
  if ( !sh || (name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
    sub_1B8880C(name, v5);
  return System_String__IndexOf_61738608(name, (System_String_o *)StringLiteral_733/*"(Custom)"*/, 0LL) >= 0;
}