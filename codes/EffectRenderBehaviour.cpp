...
void __fastcall EffectRenderBehaviour__Awake(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB353B & 1) == 0 )
  {
    ...
    sub_1C13D24(&UnityEngine_ParticleSystemRenderer_TypeInfo, v5);
    byte_4BB353B = 1;
  }
...
void __fastcall EffectRenderBehaviour__OnWillRenderObject(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB353F & 1) == 0 )
  {
    ...
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v4);
    sub_1C13D24(&UnityEngine_ParticleSystemRenderer_TypeInfo, v5);
    sub_1C13D24(&StringLiteral_16584/*"_RotationMatrix"*/, v6);
    sub_1C13D24(&StringLiteral_16405/*"_Angle"*/, v7);
    sub_1C13D24(&StringLiteral_16406/*"_AxialAberration"*/, v8);
    sub_1C13D24(&StringLiteral_16404/*"_AlphaTexture_ST"*/, v9);
    sub_1C13D24(&StringLiteral_16569/*"_PerspectiveFilter"*/, v10);
    byte_4BB353F = 1;
  }
    ...
    && this->fields.mbCustomShader )
  {
    ...
    *(UnityEngine_Vector3_o *)&v16 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0LL);
    ...
    UnityEngine_Material__SetVector(
      material,
      (System_String_o *)StringLiteral_16406/*"_AxialAberration"*/,
    ...
    *(UnityEngine_Vector3_o *)&v21 = UnityEngine_Transform__get_lossyScale((UnityEngine_Transform_o *)transform, 0LL);
    if ( !v20 )
      goto LABEL_21;
    v24 = 0;
    UnityEngine_Material__SetVector(v20, (System_String_o *)StringLiteral_16584/*"_RotationMatrix"*/, *(UnityEngine_Vector4_o *)&v21, 0LL);
    ...
    if ( !v25 )
      goto LABEL_21;
    v32 = v34;
    UnityEngine_Material__SetMatrix(v25, (System_String_o *)StringLiteral_16404/*"_AlphaTexture_ST"*/, &v32, 0LL);
    ...
    if ( !v26
      || (v30 = v33,
          UnityEngine_Material__SetMatrix(v26, (System_String_o *)StringLiteral_16405/*"_Angle"*/, &v30, 0LL),
...
LABEL_21:
    ...
    UnityEngine_Material__SetInt(v27, (System_String_o *)StringLiteral_16569/*"_PerspectiveFilter"*/, (int32_t)transform, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB353D & 1) == 0 )
  {
    this = (EffectRenderBehaviour_o *)sub_1C13D24(&StringLiteral_731/*"(Custom)"*/, sh);
    byte_4BB353D = 1;
  }
  if ( !sh )
    sub_1C13F80(this, sh);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL);
  v5 = System_String__Concat_62967944(name, (System_String_o *)StringLiteral_731/*"(Custom)"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB353E & 1) == 0 )
  {
    sub_1C13D24(&UnityEngine_Object_TypeInfo, sh);
    sub_1C13D24(&StringLiteral_731/*"(Custom)"*/, v4);
  ...
  if ( !v7 )
  {
    ...
    if ( ((unsigned __int8)isCustomShader & 1) != 0 )
    {
      if ( !sh || (isCustomShader = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
        sub_1C13F80(isCustomShader, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( !sh || (name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
    sub_1C13F80(name, v6);
  return System_String__IndexOf_62999520(name, (System_String_o *)StringLiteral_731/*"(Custom)"*/, 0LL) >= 0;
}