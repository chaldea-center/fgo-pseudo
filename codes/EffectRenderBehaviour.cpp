...
void __fastcall EffectRenderBehaviour__Awake(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C20DA8 & 1) == 0 )
  {
    ...
    sub_1C3B764(&UnityEngine_ParticleSystemRenderer_TypeInfo, v5);
    byte_4C20DA8 = 1;
  }
...
void __fastcall EffectRenderBehaviour__OnWillRenderObject(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C20DAC & 1) == 0 )
  {
    ...
    sub_1C3B764(&UnityEngine_Object_TypeInfo, v4);
    sub_1C3B764(&UnityEngine_ParticleSystemRenderer_TypeInfo, v5);
    sub_1C3B764(&StringLiteral_16649/*"ba-RU"*/, v6);
    sub_1C3B764(&StringLiteral_16469/*"appStore"*/, v7);
    sub_1C3B764(&StringLiteral_16470/*"appVer"*/, v8);
    sub_1C3B764(&StringLiteral_16468/*"appCheckToken"*/, v9);
    sub_1C3B764(&StringLiteral_16634/*"availMem"*/, v10);
    byte_4C20DAC = 1;
  }
    ...
    && this->fields.mbCustomShader )
  {
    ...
    *(UnityEngine_Vector3_o *)&v16 = UnityEngine_Transform__get_position((UnityEngine_Transform_o *)transform, 0LL);
    ...
    UnityEngine_Material__SetVector(
      material,
      (System_String_o *)StringLiteral_16470/*"appVer"*/,
    ...
    *(UnityEngine_Vector3_o *)&v21 = UnityEngine_Transform__get_lossyScale((UnityEngine_Transform_o *)transform, 0LL);
    if ( !v20 )
      goto LABEL_21;
    v24 = 0;
    UnityEngine_Material__SetVector(v20, (System_String_o *)StringLiteral_16649/*"ba-RU"*/, *(UnityEngine_Vector4_o *)&v21, 0LL);
    ...
    if ( !v25 )
      goto LABEL_21;
    v32 = v34;
    UnityEngine_Material__SetMatrix(v25, (System_String_o *)StringLiteral_16468/*"appCheckToken"*/, &v32, 0LL);
    ...
    if ( !v26
      || (v30 = v33,
          UnityEngine_Material__SetMatrix(v26, (System_String_o *)StringLiteral_16469/*"appStore"*/, &v30, 0LL),
...
LABEL_21:
    ...
    UnityEngine_Material__SetInt(v27, (System_String_o *)StringLiteral_16634/*"availMem"*/, (int32_t)transform, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C20DAA & 1) == 0 )
  {
    this = (EffectRenderBehaviour_o *)sub_1C3B764(&StringLiteral_710/*"(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/reflect/Field;"*/, sh);
    byte_4C20DAA = 1;
  }
  if ( !sh )
    sub_1C3B9C0(this, sh);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL);
  v5 = System_String__Concat_63368612(name, (System_String_o *)StringLiteral_710/*"(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/reflect/Field;"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C20DAB & 1) == 0 )
  {
    sub_1C3B764(&UnityEngine_Object_TypeInfo, sh);
    sub_1C3B764(&StringLiteral_710/*"(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/reflect/Field;"*/, v4);
  ...
  if ( !v7 )
  {
    ...
    if ( ((unsigned __int8)isCustomShader & 1) != 0 )
    {
      if ( !sh || (isCustomShader = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
        sub_1C3B9C0(isCustomShader, v10);
      v11 = System_String__Replace_63388240(
              isCustomShader,
              (System_String_o *)StringLiteral_710/*"(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/reflect/Field;"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( !sh || (name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
    sub_1C3B9C0(name, v6);
  return System_String__IndexOf_63400188(name, (System_String_o *)StringLiteral_710/*"(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/reflect/Field;"*/, 0LL) >= 0;
}