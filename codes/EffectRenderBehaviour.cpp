...
void EffectRenderBehaviour__Awake(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  const MethodInfo_37ED7E0 *v6; // x1
  ...
  {
    v6 = (const MethodInfo_37ED7E0 *)Method_UnityEngine_Component_GetComponent_ParticleSystem___;
    ...
    {
      sub_220024C(material, UnityEngine_ParticleSystemRenderer_TypeInfo, v9, v10);
...
void EffectRenderBehaviour__OnWillRenderObject(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59373C1 & 1) == 0 )
  {
    ...
    sub_21FFC50(&UnityEngine_Object_TypeInfo);
    sub_21FFC50(&UnityEngine_ParticleSystemRenderer_TypeInfo);
    sub_21FFC50(&StringLiteral_16953/*"_Scaling"*/);
    sub_21FFC50(&StringLiteral_16757/*"_CameraInv"*/);
    sub_21FFC50(&StringLiteral_16758/*"_Center"*/);
    sub_21FFC50(&StringLiteral_16756/*"_Camera"*/);
    sub_21FFC50(&StringLiteral_16938/*"_RenderType"*/);
    byte_59373C1 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0, 0) && this->fields.mbCustomShader )
  {
    ...
    {
      sub_220024C(transform, UnityEngine_ParticleSystemRenderer_TypeInfo, v8, v9);
    ...
    UnityEngine_Material__SetVector(
      material,
      (System_String_o *)StringLiteral_16758/*"_Center"*/,
    ...
    UnityEngine_Material__SetVector(
      v13,
      (System_String_o *)StringLiteral_16953/*"_Scaling"*/,
    ...
    if ( !v15 )
      goto LABEL_21;
    v23 = v24;
    UnityEngine_Material__SetMatrix(v15, (System_String_o *)StringLiteral_16756/*"_Camera"*/, &v23, 0);
    ...
    if ( !transform
      || (UnityEngine_Camera__get_worldToCameraMatrix(&v22, (UnityEngine_Camera_o *)transform, 0),
          ...
          !v16)
      || (v20 = v21,
          UnityEngine_Material__SetMatrix(v16, (System_String_o *)StringLiteral_16757/*"_CameraInv"*/, &v20, 0),
...
LABEL_21:
    ...
    UnityEngine_Material__SetInt(v17, (System_String_o *)StringLiteral_16938/*"_RenderType"*/, (int32_t)transform, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59373BF & 1) == 0 )
  {
    this = (EffectRenderBehaviour_o *)sub_21FFC50(&StringLiteral_714/*"(Custom)"*/);
    byte_59373BF = 1;
  }
  if ( !sh )
    sub_21FFECC(this, sh);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0);
  v5 = System_String__Concat_75438412(name, (System_String_o *)StringLiteral_714/*"(Custom)"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_21FFC50(&UnityEngine_Object_TypeInfo);
    sub_21FFC50(&StringLiteral_714/*"(Custom)"*/);
        ...
        const MethodInfo *method)
{
  ...
  if ( !sh || (name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0)) == 0 )
    sub_21FFECC(name, v5);
  return System_String__IndexOf_75501892(name, (System_String_o *)StringLiteral_714/*"(Custom)"*/, 0) >= 0;
}