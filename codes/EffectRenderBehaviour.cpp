...
void EffectRenderBehaviour__Awake(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B5A8 & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_ParticleSystemRenderer_TypeInfo);
    byte_4D2B5A8 = 1;
  }
...
void EffectRenderBehaviour__OnWillRenderObject(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2B5AC & 1) == 0 )
  {
    ...
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&UnityEngine_ParticleSystemRenderer_TypeInfo);
    sub_1C94098(&StringLiteral_16394/*"_Scaling"*/);
    sub_1C94098(&StringLiteral_16204/*"_CameraInv"*/);
    sub_1C94098(&StringLiteral_16205/*"_Center"*/);
    sub_1C94098(&StringLiteral_16203/*"_Camera"*/);
    sub_1C94098(&StringLiteral_16379/*"_RenderType"*/);
    byte_4D2B5AC = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)Component_object, 0, 0) && this->fields.mbCustomShader )
  {
    ...
    UnityEngine_Material__SetVector(
      material,
      (System_String_o *)StringLiteral_16205/*"_Center"*/,
    ...
    UnityEngine_Material__SetVector(
      v9,
      (System_String_o *)StringLiteral_16394/*"_Scaling"*/,
    ...
    if ( !v11 )
      goto LABEL_21;
    v18 = v20;
    UnityEngine_Material__SetMatrix(v11, (System_String_o *)StringLiteral_16203/*"_Camera"*/, &v18, 0);
    ...
    if ( !v12
      || (v16 = v19,
          UnityEngine_Material__SetMatrix(v12, (System_String_o *)StringLiteral_16204/*"_CameraInv"*/, &v16, 0),
...
LABEL_21:
    ...
    UnityEngine_Material__SetInt(v13, (System_String_o *)StringLiteral_16379/*"_RenderType"*/, (int32_t)transform, 0);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2B5AA & 1) == 0 )
  {
    this = (EffectRenderBehaviour_o *)sub_1C94098(&StringLiteral_683/*"(Custom)"*/);
    byte_4D2B5AA = 1;
  }
  if ( !sh )
    sub_1C942F0(this, sh);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0);
  v5 = System_String__Concat_64417744(name, (System_String_o *)StringLiteral_683/*"(Custom)"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C94098(&UnityEngine_Object_TypeInfo);
    sub_1C94098(&StringLiteral_683/*"(Custom)"*/);
        ...
        const MethodInfo *method)
{
  ...
  if ( !sh || (name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0)) == 0 )
    sub_1C942F0(name, v5);
  return System_String__IndexOf_64476136(name, (System_String_o *)StringLiteral_683/*"(Custom)"*/, 0) >= 0;
}