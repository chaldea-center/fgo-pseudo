...
void __fastcall EffectRenderBehaviour__Awake(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438FA4C & 1) == 0 )
  {
    ...
    sub_B775C4(&UnityEngine_ParticleSystemRenderer_TypeInfo);
    byte_438FA4C = 1;
  }
...
void __fastcall EffectRenderBehaviour__OnWillRenderObject(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_438FA50 & 1) == 0 )
  {
    ...
    sub_B775C4(&UnityEngine_Object_TypeInfo);
    sub_B775C4(&UnityEngine_ParticleSystemRenderer_TypeInfo);
    sub_B775C4(&StringLiteral_16357/*"_Scaling"*/);
    sub_B775C4(&StringLiteral_16225/*"_CameraInv"*/);
    sub_B775C4(&StringLiteral_16226/*"_Center"*/);
    sub_B775C4(&StringLiteral_16224/*"_Camera"*/);
    sub_B775C4(&StringLiteral_16350/*"_RenderType"*/);
    byte_438FA50 = 1;
  }
  ...
  if ( !UnityEngine_Object__op_Equality(Component_WebViewObject, 0LL, 0LL) && LOBYTE(this[1].klass) )
  {
    ...
    *(UnityEngine_Vector4_o *)&v8 = UnityEngine_Vector4__op_Implicit(position, 0LL);
    ...
    UnityEngine_Material__SetVector(
      material,
      (System_String_o *)StringLiteral_16226/*"_Center"*/,
    ...
    *(UnityEngine_Vector4_o *)&v13 = UnityEngine_Vector4__op_Implicit(lossyScale, 0LL);
    if ( !v12 )
      goto LABEL_22;
    UnityEngine_Material__SetVector(v12, (System_String_o *)StringLiteral_16357/*"_Scaling"*/, *(UnityEngine_Vector4_o *)&v13, 0LL);
    ...
    if ( !v17 )
      goto LABEL_22;
    v24 = v26;
    UnityEngine_Material__SetMatrix(v17, (System_String_o *)StringLiteral_16224/*"_Camera"*/, &v24, 0LL);
    ...
    if ( !v18
      || (v22 = v25,
          UnityEngine_Material__SetMatrix(v18, (System_String_o *)StringLiteral_16225/*"_CameraInv"*/, &v22, 0LL),
...
LABEL_22:
    ...
    UnityEngine_Material__SetInt(v19, (System_String_o *)StringLiteral_16350/*"_RenderType"*/, (int32_t)transform, 0LL);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438FA4E & 1) == 0 )
  {
    this = (EffectRenderBehaviour_o *)sub_B775C4(&StringLiteral_622/*"(Custom)"*/);
    byte_438FA4E = 1;
  }
  if ( !sh )
    sub_B7769C(this, sh);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL);
  v5 = System_String__Concat_44901936(name, (System_String_o *)StringLiteral_622/*"(Custom)"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B775C4(&UnityEngine_Object_TypeInfo);
    sub_B775C4(&StringLiteral_622/*"(Custom)"*/);
  ...
  if ( !v5 )
  {
    ...
    if ( ((unsigned __int8)isCustomShader & 1) != 0 )
    {
      if ( !sh || (isCustomShader = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
        sub_B7769C(isCustomShader, v8);
      v9 = System_String__Replace_44909172(
             isCustomShader,
             (System_String_o *)StringLiteral_622/*"(Custom)"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( !sh || (name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
    sub_B7769C(name, v5);
  return System_String__IndexOf_44974284(name, (System_String_o *)StringLiteral_622/*"(Custom)"*/, 0LL) >= 0;
}