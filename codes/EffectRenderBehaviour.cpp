...
void __fastcall EffectRenderBehaviour__Awake(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD304 & 1) == 0 )
  {
    ...
    sub_1B64870(&UnityEngine_ParticleSystemRenderer_TypeInfo, v5);
    byte_49FD304 = 1;
  }
...
void __fastcall EffectRenderBehaviour__OnWillRenderObject(EffectRenderBehaviour_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FD308 & 1) == 0 )
  {
    ...
    sub_1B64870(&UnityEngine_Object_TypeInfo, v4);
    sub_1B64870(&UnityEngine_ParticleSystemRenderer_TypeInfo, v5);
    sub_1B64870(&StringLiteral_16264/*"_Scaling"*/, v6);
    sub_1B64870(&StringLiteral_16087/*"_CameraInv"*/, v7);
    sub_1B64870(&StringLiteral_16088/*"_Center"*/, v8);
    sub_1B64870(&StringLiteral_16086/*"_Camera"*/, v9);
    sub_1B64870(&StringLiteral_16249/*"_RenderType"*/, v10);
    byte_49FD308 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD306 & 1) == 0 )
  {
    this = (EffectRenderBehaviour_o *)sub_1B64870(&StringLiteral_734/*"(Custom)"*/, sh);
    byte_49FD306 = 1;
  }
  if ( !sh )
    sub_1B64ACC(this, sh);
  name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL);
  v5 = System_String__Concat_61383576(name, (System_String_o *)StringLiteral_734/*"(Custom)"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD307 & 1) == 0 )
  {
    sub_1B64870(&UnityEngine_Object_TypeInfo, sh);
    sub_1B64870(&StringLiteral_734/*"(Custom)"*/, v4);
  ...
  if ( !v7 )
  {
    ...
    if ( ((unsigned __int8)isCustomShader & 1) != 0 )
    {
      if ( !sh || (isCustomShader = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
        sub_1B64ACC(isCustomShader, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( !sh || (name = UnityEngine_Object__get_name((UnityEngine_Object_o *)sh, 0LL)) == 0LL )
    sub_1B64ACC(name, v6);
  return System_String__IndexOf_61415144(name, (System_String_o *)StringLiteral_734/*"(Custom)"*/, 0LL) >= 0;
}