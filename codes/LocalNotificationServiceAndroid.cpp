        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC739 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__, v3);
    sub_1B4CF90(&StringLiteral_6531/*"Fate/Grand Order"*/, v4);
    sub_1B4CF90(&StringLiteral_2195/*"All notifications"*/, v5);
    sub_1B4CF90(&StringLiteral_25053/*"全ての通知"*/, v6);
    sub_1B4CF90(&StringLiteral_3335/*"CHANNEL_ALL"*/, v7);
    byte_49BC739 = 1;
  }
  ...
  if ( UnityEngine_Application__get_systemLanguage(0LL) == 22 )
    v8 = (System_String_o **)&StringLiteral_25053/*"全ての通知"*/;
  else
    v8 = (System_String_o **)&StringLiteral_2195/*"All notifications"*/;
  v9 = *v8;
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_37B4830 *)Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__);
  if ( !Instance )
    sub_1B4D1EC(0LL, v11);
  LocalNotificationManagerAndroid__SetNotificationChannelParam(
    ...
    v9,
    v9,
    (System_String_o *)StringLiteral_6531/*"Fate/Grand Order"*/,
    v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC73B & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__, key);
    byte_49BC73B = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_37B4830 *)Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__);
  if ( !Instance )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BC73C & 1) == 0 )
  {
    sub_1B4CF90(&Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__, method);
    byte_49BC73C = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_37B4830 *)Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__);
  if ( !Instance )
