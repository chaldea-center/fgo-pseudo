void LocalNotificationServiceAndroid___ctor(LocalNotificationServiceAndroid_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E790C9 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_6716/*"Fate/Grand Order"*/);
    sub_1D0F0B4(&StringLiteral_2204/*"All notifications"*/);
    sub_1D0F0B4(&StringLiteral_25984/*"全ての通知"*/);
    sub_1D0F0B4(&StringLiteral_3366/*"CHANNEL_ALL"*/);
    byte_4E790C9 = 1;
  }
  ...
  if ( UnityEngine_Application__get_systemLanguage(0) == 22 )
    v3 = (System_String_o **)&StringLiteral_25984/*"全ての通知"*/;
  else
    v3 = (System_String_o **)&StringLiteral_2204/*"All notifications"*/;
  v4 = *v3;
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_3BACB74 *)Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__);
  if ( !Instance )
    sub_1D0F30C(0, v6);
  LocalNotificationManagerAndroid__SetNotificationChannelParam(
    (LocalNotificationManagerAndroid_o *)Instance,
    (System_String_o *)StringLiteral_3366/*"CHANNEL_ALL"*/,
    v4,
    v4,
    (System_String_o *)StringLiteral_6716/*"Fate/Grand Order"*/,
    v7);
}
