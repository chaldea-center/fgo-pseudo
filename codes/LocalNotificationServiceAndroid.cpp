void LocalNotificationServiceAndroid___ctor(LocalNotificationServiceAndroid_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E06422 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_6690/*"Fate/Grand Order"*/);
    sub_1CE6700(&StringLiteral_2202/*"All notifications"*/);
    sub_1CE6700(&StringLiteral_25875/*"全ての通知"*/);
    sub_1CE6700(&StringLiteral_3356/*"CHANNEL_ALL"*/);
    byte_4E06422 = 1;
  }
  ...
  if ( UnityEngine_Application__get_systemLanguage(0) == 22 )
    v3 = (System_String_o **)&StringLiteral_25875/*"全ての通知"*/;
  else
    v3 = (System_String_o **)&StringLiteral_2202/*"All notifications"*/;
  v4 = *v3;
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_3B55234 *)Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__);
  if ( !Instance )
    sub_1CE6958(0, v6);
  LocalNotificationManagerAndroid__SetNotificationChannelParam(
    (LocalNotificationManagerAndroid_o *)Instance,
    (System_String_o *)StringLiteral_3356/*"CHANNEL_ALL"*/,
    v4,
    v4,
    (System_String_o *)StringLiteral_6690/*"Fate/Grand Order"*/,
    v7);
}
