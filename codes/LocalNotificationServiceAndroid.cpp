void LocalNotificationServiceAndroid___ctor(LocalNotificationServiceAndroid_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59722FA & 1) == 0 )
  {
    ...
    sub_2213A60(&StringLiteral_6928/*"Fate/Grand Order"*/);
    sub_2213A60(&StringLiteral_2295/*"All notifications"*/);
    sub_2213A60(&StringLiteral_26862/*"全ての通知"*/);
    sub_2213A60(&StringLiteral_3469/*"CHANNEL_ALL"*/);
    byte_59722FA = 1;
  }
  ...
  v5 = StringLiteral_26862/*"全ての通知"*/;
  v6 = systemLanguage;
  v7 = StringLiteral_2295/*"All notifications"*/;
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_47A2F30 *)Method_SingletonTemplate_LocalNotificationManagerAndroid__get_Instance__);
  if ( !Instance )
    sub_2213CDC(0, v9);
  if ( v6 == 22 )
  ...
  LocalNotificationManagerAndroid__SetNotificationChannelParam(
    ...
    v11,
    v11,
    (System_String_o *)StringLiteral_6928/*"Fate/Grand Order"*/,
    v10);
}
