...
void ClassBoardLock__PlayClickedSe(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D304E9 & 1) == 0 )
  {
    this = (ClassBoardLock_o *)sub_1C94098(&IClassBoardSquareModel_TypeInfo);
    byte_4D304E9 = 1;
  }
  ...
  {
LABEL_8:
    v7 = sub_1C6A420(v2->fields._SquareModel_k__BackingField, IClassBoardSquareModel_TypeInfo, 15);
  }
...
void ClassBoardLock__PlayReleaseEffect(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D304EA & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_ClassBoardLock__PlayReleaseEffect_b__13_0__);
    sub_1C94098(&IClassBoardSquareModel_TypeInfo);
    sub_1C94098(&int_TypeInfo);
    sub_1C94098(&StringLiteral_25461/*"{0}{1}"*/);
    sub_1C94098(&StringLiteral_15192/*"Unlock"*/);
    byte_4D304EA = 1;
  }
  ...
  {
LABEL_8:
    v9 = sub_1C6A420(LockModel, IClassBoardSquareModel_TypeInfo, 2);
  }
  ...
  v11 = System_String__Format_64459052(
          ...
          (Il2CppObject *)StringLiteral_15192/*"Unlock"*/,
          v10,
          0);
...
void ClassBoardLock__SetupIcon(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D304E7 & 1) == 0 )
  {
    sub_1C94098(&IClassBoardSquareModel_TypeInfo);
    sub_1C94098(&int_TypeInfo);
    sub_1C94098(&StringLiteral_21536/*"lock_light_{0}"*/);
    sub_1C94098(&StringLiteral_21539/*"lock_stopper"*/);
    sub_1C94098(&StringLiteral_21538/*"lock_on_{0}"*/);
    sub_1C94098(&StringLiteral_21537/*"lock_off_{0}"*/);
    sub_1C94098(&StringLiteral_21540/*"lock_{0}"*/);
    byte_4D304E7 = 1;
  }
...
LABEL_8:
  ...
  if ( (int)max_length >= 1 )
  {
    ...
    while ( v13 < (unsigned int)max_length )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21540/*"lock_{0}"*/, v16, 0);
...
LABEL_16:
  ...
  if ( (int)v18 >= 1 )
  {
    ...
    while ( v19 < (unsigned int)v18 )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21538/*"lock_on_{0}"*/, v22, 0);
      if ( !v21 )
        goto LABEL_42;
...
LABEL_22:
  ...
  if ( (int)v24 >= 1 )
  {
    ...
    while ( v25 < (unsigned int)v24 )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21537/*"lock_off_{0}"*/, v28, 0);
      if ( !v27 )
        goto LABEL_42;
  ...
  if ( (int)v30 >= 1 )
  {
    ...
    while ( v31 < (unsigned int)v30 )
    {
      ...
      LockModel = (MethodInfo *)AtlasManagerUnit__SetUI(
                                  ...
                                  v32,
                                  (System_String_o *)StringLiteral_21539/*"lock_stopper"*/,
                                  0);
...
LABEL_42:
  ...
  if ( (int)v34 >= 1 )
  {
    ...
    while ( v35 < (unsigned int)v34 )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21536/*"lock_light_{0}"*/, v38, 0);
      if ( !v37 )
        goto LABEL_42;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D304E8 & 1) == 0 )
  {
    ...
    this = (ClassBoardLock_o *)sub_1C94098(&Method_System_Nullable_AcquireFlag__get_Value__);
    byte_4D304E8 = 1;
  }
  if ( hasValue )
  {
...
IClassBoardLockModel_o *ClassBoardLock__get_LockModel(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  return (IClassBoardLockModel_o *)sub_1C941D4(this->fields._SquareModel_k__BackingField, IClassBoardLockModel_TypeInfo);
}