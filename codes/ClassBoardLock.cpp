...
void __fastcall ClassBoardLock__PlayClickedSe(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E5A8 & 1) == 0 )
  {
    this = (ClassBoardLock_o *)sub_1B885B0(&IClassBoardSquareModel_TypeInfo);
    byte_4A5E5A8 = 1;
  }
  ...
  {
LABEL_8:
    p_method = sub_1BDA590(SquareModel_k__BackingField, IClassBoardSquareModel_TypeInfo, 13LL);
  }
...
void __fastcall ClassBoardLock__PlayReleaseEffect(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E5A9 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_ClassBoardLock__PlayReleaseEffect_b__13_0__);
    sub_1B885B0(&IClassBoardSquareModel_TypeInfo);
    sub_1B885B0(&int_TypeInfo);
    sub_1B885B0(&StringLiteral_25106/*"{0}{1}"*/);
    sub_1B885B0(&StringLiteral_15131/*"Unlock"*/);
    byte_4A5E5A9 = 1;
  }
  ...
  {
LABEL_8:
    p_method = sub_1BDA590(LockModel, IClassBoardSquareModel_TypeInfo, 2LL);
  }
  ...
  v14 = System_String__Format_61721404(
...
void __fastcall ClassBoardLock__SetupIcon(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A5E5A6 & 1) == 0 )
  {
    sub_1B885B0(&IClassBoardSquareModel_TypeInfo);
    sub_1B885B0(&int_TypeInfo);
    sub_1B885B0(&StringLiteral_21194/*"lock_light_{0}"*/);
    sub_1B885B0(&StringLiteral_21197/*"lock_stopper"*/);
    sub_1B885B0(&StringLiteral_21196/*"lock_on_{0}"*/);
    sub_1B885B0(&StringLiteral_21195/*"lock_off_{0}"*/);
    sub_1B885B0(&StringLiteral_21198/*"lock_{0}"*/);
    byte_4A5E5A6 = 1;
  }
  ...
  {
LABEL_8:
    v9 = sub_1BDA590(LockModel, IClassBoardSquareModel_TypeInfo, 2LL);
  }
  ...
  if ( (int)v11 >= 1 )
  {
    ...
    while ( v13 < (unsigned int)v11 )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21198/*"lock_{0}"*/, v19, 0LL);
...
LABEL_16:
  ...
  if ( (int)v21 >= 1 )
  {
    ...
    while ( v22 < (unsigned int)v21 )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21196/*"lock_on_{0}"*/, v28, 0LL);
      if ( !v24 )
        goto LABEL_42;
...
LABEL_22:
  ...
  if ( (int)v30 >= 1 )
  {
    ...
    while ( v31 < (unsigned int)v30 )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21195/*"lock_off_{0}"*/, v37, 0LL);
      if ( !v33 )
        goto LABEL_42;
  ...
  if ( (int)v39 >= 1 )
  {
    ...
    while ( v40 < (unsigned int)v39 )
    {
      ...
      LockModel = (MethodInfo *)AtlasManagerUnit__SetUI(
                                  ...
                                  v41,
                                  (System_String_o *)StringLiteral_21197/*"lock_stopper"*/,
                                  0LL);
...
LABEL_42:
  ...
  if ( (int)v43 >= 1 )
  {
    ...
    while ( v44 < (unsigned int)v43 )
    {
      ...
      LockModel = (MethodInfo *)System_String__Format((System_String_o *)StringLiteral_21194/*"lock_light_{0}"*/, v50, 0LL);
      if ( !v46 )
        goto LABEL_42;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E5A7 & 1) == 0 )
  {
    ...
    this = (ClassBoardLock_o *)sub_1B885B0(&Method_System_Nullable_AcquireFlag__get_Value__);
    byte_4A5E5A7 = 1;
  }
  if ( hasValue )
  {
...
IClassBoardLockModel_o *__fastcall ClassBoardLock__get_LockModel(ClassBoardLock_o *this, const MethodInfo *method)
{
  ...
  return (IClassBoardLockModel_o *)sub_1B886EC(this->fields._SquareModel_k__BackingField, IClassBoardLockModel_TypeInfo);
}