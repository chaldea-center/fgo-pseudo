...
int32_t __fastcall UserEventTradeEntity__GetTotalTradeCount(UserEventTradeEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF7CF & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Linq_Enumerable_Sum_EventTradeResultInfo___, method);
    sub_1B64A00(&System_Func_EventTradeResultInfo__int__TypeInfo, v3);
    sub_1B64A00(&Method_UserEventTradeEntity___c__GetTotalTradeCount_b__6_0__, v4);
    sub_1B64A00(&UserEventTradeEntity___c_TypeInfo, v5);
    byte_49FF7CF = 1;
  }
  ...
  if ( !_9__6_0 )
  {
    ...
    _9__6_0 = (System_Func_object__int__o *)sub_1B64C4C(System_Func_EventTradeResultInfo__int__TypeInfo);
  ...
  return System_Linq_Enumerable__Sum_object_(
           ...
           (const MethodInfo_2E729D0 *)Method_System_Linq_Enumerable_Sum_EventTradeResultInfo___);
}
...
bool __fastcall UserEventTradeEntity__IsAbleReceiveRewards(UserEventTradeEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FF7D2 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMaster_EventTradeGoodsMaster___, method);
    sub_1B64A00(&DataManager_TypeInfo, v3);
    sub_1B64A00(&Method_DataMasterBase_EventTradeGoodsMaster__EventTradeGoodsEntity__int__GetEntity__, v4);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      Master_object = (Il2CppObject *)EventTradeTimeCalculation__GetCompleteNum_45909576(
                                        v20,
                                        startedAt,
                                        Time,
                                        tradeNum,
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v6 >= (unsigned int)max_length )
        sub_1B64C64(this, commonConsumeEntityArray);
...
LABEL_10:
    sub_1B64C5C(this, commonConsumeEntityArray);
  }
  return !v5;
}
...
bool __fastcall UserEventTradeEntity__IsRefillable(UserEventTradeEntity_o *this, const MethodInfo *method)
{
  ...
  CommonConsumeEntity_array *CompleteNum_45909576; // x0
  __int64 v11; // x1
  ...
  if ( (byte_49FF7D1 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataMasterBase_EventTradeGoodsMaster__EventTradeGoodsEntity__int__GetEntity__, v5);
    sub_1B64A00(&EventTradeTimeCalculation_TypeInfo, v6);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  Master_object = DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_EventTradeGoodsMaster___);
  CompleteNum_45909576 = (CommonConsumeEntity_array *)DataManager__GetMaster_object_((const MethodInfo_2E3BC8C *)Method_DataManager_GetMaster_CommonConsumeMaster___);
  tradeList = this->fields.tradeList;
  if ( !tradeList )
    goto LABEL_21;
  max_length = tradeList->max_length;
  ...
  if ( max_length >= 1 )
  {
    v15 = (CommonConsumeMaster_o *)CompleteNum_45909576;
    v16 = 0;
    while ( 1 )
    {
      if ( v16 >= (unsigned int)max_length )
        sub_1B64C64(CompleteNum_45909576, v11);
      ...
      v22 = TradeMaxNum;
      CompleteNum_45909576 = (CommonConsumeEntity_array *)EventTradeTimeCalculation__GetCompleteNum_45909576(
                                                            Entity,
                                                            startedAt,
                                                            Time,
                                                            tradeNum,
      ...
      if ( !Entity || !v15 )
        break;
      v23 = (int)CompleteNum_45909576;
      CompleteNum_45909576 = CommonConsumeMaster__GetSortedEntityList(v15, Entity->fields.commonConsumeId, 0LL);
      if ( tradeNum - v23 >= v22
        || (CompleteNum_45909576 = (CommonConsumeEntity_array *)UserEventTradeEntity__IsBuyAble(
                                                                  (UserEventTradeEntity_o *)CompleteNum_45909576,
                                                                  CompleteNum_45909576,
                                                                  v24),
            ((unsigned __int8)CompleteNum_45909576 & 1) == 0) )
      {
        max_length = tradeList->max_length;
        v14 = ++v16 < max_length;
        if ( v16 < max_length )
...
LABEL_21:
    sub_1B64C5C(CompleteNum_45909576, v11);
  }
  return v14;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF7D0 & 1) == 0 )
  {
    sub_1B64A00(&Method_System_Array_Empty_int___, usedStoreIdx);
    sub_1B64A00(&Method_System_Linq_Enumerable_Select_EventTradeInfo__int___, v6);
    sub_1B64A00(&Method_System_Linq_Enumerable_ToArray_int___, v7);
    sub_1B64A00(&System_Func_EventTradeInfo__int__TypeInfo, v8);
    sub_1B64A00(&Method_UserEventTradeEntity___c__TryGetUsedStoreIdx_b__7_0__, v9);
    sub_1B64A00(&UserEventTradeEntity___c_TypeInfo, v10);
    byte_49FF7D0 = 1;
  }
  ...
  v16 = *v15;
  *usedStoreIdx = *v15;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)usedStoreIdx, (int32_t)v16, (int32_t)method, v3);
  ...
  if ( monitor )
  {
    ...
    if ( !_9__7_0 )
    {
      ...
      _9__7_0 = (System_Func_object__int__o *)sub_1B64C4C(System_Func_EventTradeInfo__int__TypeInfo);
      ...
      sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->__9__7_0, (int32_t)_9__7_0, v25, v26);
    }
    v27 = (System_Collections_Generic_IEnumerable_TSource__o *)System_Linq_Enumerable__Select_object__int_(
                                                                 tradeList,
                                                                 (System_Func_TSource__TResult__o *)_9__7_0,
                                                                 (const MethodInfo_2E6B3C4 *)Method_System_Linq_Enumerable_Select_EventTradeInfo__int___);
    v28 = System_Linq_Enumerable__ToArray_int_(
            v27,
            (const MethodInfo_2E73B20 *)Method_System_Linq_Enumerable_ToArray_int___);
    *usedStoreIdx = v28;
    sub_1B649A4((ServantStatusBattleListViewItem_o *)usedStoreIdx, (int32_t)v28, v29, v30);
  }
  return monitor != 0LL;
}
...
void __fastcall UserEventTradeEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FF7D4 & 1) == 0 )
  {
    sub_1B64A00(&UserEventTradeEntity___c_TypeInfo, v1);
    byte_49FF7D4 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64C4C(UserEventTradeEntity___c_TypeInfo);
