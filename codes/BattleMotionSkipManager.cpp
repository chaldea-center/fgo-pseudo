        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C45ADC & 1) == 0 )
  {
    sub_1C37058(&BaseMotionSkip_TypeInfo);
    byte_4C45ADC = 1;
  }
  v5 = (Il2CppObject *)sub_1C372A4(BaseMotionSkip_TypeInfo);
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields._Perf_k__BackingField, (int32_t)perf, v8, v9);
}
...
void BattleMotionSkipManager__ReleaseMotionSkip(BattleMotionSkipManager_o *this, const MethodInfo *method)
{
  ...
  sub_1C36FFC(p_mainMotionSkip, 0, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !skillInfo
    || (v6 = (struct BaseMotionSkip_o *)((__int64 (__fastcall *)(BattleSkillInfoData_o *, const MethodInfo *))skillInfo->klass->vtable._16_MakeSkillSkip.methodPtr)(
        ...
        sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mainMotionSkip, (int32_t)v6, v7, v8),
        (mainMotionSkip = this->fields.mainMotionSkip) == 0)
    && (mainMotionSkip = this->fields.defaultMotionSkip) == 0 )
  {
    sub_1C372B4(mainMotionSkip);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.mainMotionSkip, (int32_t)value, (int32_t)method, v3);
}
