        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A220D9 & 1) == 0 )
  {
    sub_1B715CC(&BaseMotionSkip_TypeInfo, perf);
    byte_4A220D9 = 1;
  }
  v5 = (Il2CppObject *)sub_1B71818(BaseMotionSkip_TypeInfo);
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields._Perf_k__BackingField, (int32_t)perf, v8, v9);
}
...
void __fastcall BattleMotionSkipManager__ReleaseMotionSkip(BattleMotionSkipManager_o *this, const MethodInfo *method)
{
  ...
  sub_1B71570(p_mainMotionSkip, 0, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !skillInfo
    || (v7 = (struct BaseMotionSkip_o *)((__int64 (__fastcall *)(BattleSkillInfoData_o *, Il2CppMethodPointer))skillInfo->klass->vtable._14_MakeSkillSkip.method)(
        ...
        sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mainMotionSkip, (int32_t)v7, v8, v9),
        (mainMotionSkip = this->fields.mainMotionSkip) == 0LL)
    && (mainMotionSkip = this->fields.defaultMotionSkip) == 0LL )
  {
    sub_1B71828(mainMotionSkip, v6);
  }
        ...
        const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mainMotionSkip, (int32_t)value, (int32_t)method, v3);
}
