  ...
  if ( SLODWORD(VoiceJson[1].klass) >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        VoiceJson = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49333796(v18, 0);
        ...
        if ( !VoiceJson )
          goto LABEL_30;
        VoiceJson = (System_String_o *)System_String__Equals_64067044(VoiceJson, v11, 0);
...
LABEL_31:
      ...
      else
      {
        ...
        sub_1C71354((GrandQuestFolderBoardItem_o *)(v30 + 4), (int32_t)v11, v21, v22, v23, v24, v25, v26);
      }
LABEL_28:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7632 & 1) == 0 )
  {
    ...
    this = (EventVoicePlayEntity_o *)sub_1C713B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
    byte_4CC7632 = 1;
  }
...
LABEL_25:
        ...
        while ( 1 )
        {
          ...
          if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
          v21 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49333796(v20, 0);
          if ( !v19 )
            sub_1C71608(v21, v21);
          v11 = System_String__Equals_64067044(v19, v21, 0);
          if ( v11 )
            goto LABEL_24;
          voiceIds = v8->fields.voiceIds;
          ++v16;
  ...
  if ( SLODWORD(Instance->fields.m_CancellationTokenSource) >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_49333796(v18, 0);
        ...
        if ( !Instance )
          goto LABEL_31;
        Instance = (DataManager_o *)System_String__Equals_64067044((System_String_o *)Instance, v9, 0);
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        sub_1C71354((GrandQuestFolderBoardItem_o *)(v26 + 4), (int32_t)p_obj, v13, v14, v15, v16, v17, v18);
      }
