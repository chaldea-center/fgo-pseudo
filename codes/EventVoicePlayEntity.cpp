  ...
  if ( SLODWORD(VoiceJson[1].klass) >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        VoiceJson = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46485644(v18, 0LL);
        ...
        if ( !VoiceJson )
          goto LABEL_30;
        VoiceJson = (System_String_o *)System_String__Equals_61715348(VoiceJson, v11, 0LL);
...
LABEL_31:
      ...
      else
      {
        ...
        sub_1B88554((ServantStatusBattleListViewItem_o *)(v26 + 4), (int32_t)v11, v21, v22);
      }
LABEL_28:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5B374 & 1) == 0 )
  {
    ...
    this = (EventVoicePlayEntity_o *)sub_1B885B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
    byte_4A5B374 = 1;
  }
...
LABEL_25:
        ...
        while ( 1 )
        {
          ...
          if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
            j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
          v21 = CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46485644(v20, 0LL);
          if ( !v19 )
            sub_1B8880C(v21, v21);
          v11 = System_String__Equals_61715348(v19, v21, 0LL);
          if ( v11 )
            goto LABEL_24;
          voiceIds = v8->fields.voiceIds;
          ++v16;
  ...
  if ( SLODWORD(Instance->fields.m_CancellationTokenSource) >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CodeStage_AntiCheat_ObscuredTypes_ObscuredString_TypeInfo);
        Instance = (DataManager_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredString__op_Implicit_46485644(v18, 0LL);
        ...
        if ( !Instance )
          goto LABEL_31;
        Instance = (DataManager_o *)System_String__Equals_61715348((System_String_o *)Instance, v9, 0LL);
...
LABEL_32:
      ...
      else
      {
        ...
        sub_1B88554((ServantStatusBattleListViewItem_o *)(v26 + 4), (int32_t)v9, v21, v22);
      }
LABEL_29:
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        sub_1B88554((ServantStatusBattleListViewItem_o *)(v22 + 4), (int32_t)p_obj, v13, v14);
      }
