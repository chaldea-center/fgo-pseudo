...
void MstExpInfoComponent__Close(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3E0A5 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_MstExpInfoComponent_Close__);
    sub_1C37058(&Method_MstExpInfoComponent_EndClose__);
    byte_4C3E0A5 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_Close__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_MstExpInfoComponent_Close__);
...
void MstExpInfoComponent__OnClickClose(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3E0A4 & 1) == 0 )
  {
    sub_1C37058(&System_Action_TypeInfo);
    sub_1C37058(&Method_MstExpInfoComponent_EndClose__);
    sub_1C37058(&Method_MstExpInfoComponent_OnClickClose__);
    byte_4C3E0A4 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C37070(Method_MstExpInfoComponent_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C3703C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    this->fields.isButtonEnable = 0;
    v5 = (System_Action_o *)sub_1C372A4(System_Action_TypeInfo);
...
void MstExpInfoComponent__openExpInfo(MstExpInfoComponent_o *this, int64_t exp, const MethodInfo *method)
{
  ...
  if ( (byte_4C3E0A3 & 1) == 0 )
  {
    ...
    sub_1C37058(&Method_MstExpInfoComponent_EndOpen__);
    sub_1C37058(&StringLiteral_25092/*"{0:N0}"*/);
    sub_1C37058(&StringLiteral_8574/*"MASTER_TOTAL_EXP"*/);
    byte_4C3E0A3 = 1;
  }
  ...
  if ( !expInfoTitleLb
    || (UILabel__set_text(expInfoTitleLb, v6, 0),
        ...
        v6 = System_String__Format((System_String_o *)StringLiteral_25092/*"{0:N0}"*/, v14, 0),
        !expInfoLb) )
  {
    sub_1C372B4(v6);
  }
