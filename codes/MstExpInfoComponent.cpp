...
void __fastcall MstExpInfoComponent__Close(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B48E & 1) == 0 )
  {
    ...
    sub_1B90010(&Method_MstExpInfoComponent_Close__, v3);
    sub_1B90010(&Method_MstExpInfoComponent_EndClose__, v4);
    byte_4A6B48E = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_Close__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B90028(Method_MstExpInfoComponent_Close__);
...
void __fastcall MstExpInfoComponent__OnClickClose(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B90010(&System_Action_TypeInfo, method);
    sub_1B90010(&Method_MstExpInfoComponent_EndClose__, v3);
    sub_1B90010(&Method_MstExpInfoComponent_OnClickClose__, v4);
    byte_4A6B48D = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_OnClickClose__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1B90028(Method_MstExpInfoComponent_OnClickClose__);
    v6 = (System_Reflection_MethodBase_o *)sub_1B8FFF4(v5, v5[4]);
    OverwriteAssetSoundName__PlaySystemSe(v6, 1, 0LL);
    this->fields.isButtonEnable = 0;
    v7 = (System_Action_o *)sub_1B9025C(System_Action_TypeInfo);
...
void __fastcall MstExpInfoComponent__openExpInfo(MstExpInfoComponent_o *this, int64_t exp, const MethodInfo *method)
{
  ...
  if ( (byte_4A6B48C & 1) == 0 )
  {
    sub_1B90010(&System_Action_TypeInfo, exp);
    sub_1B90010(&long_TypeInfo, v5);
    sub_1B90010(&LocalizationManager_TypeInfo, v6);
    sub_1B90010(&Method_MstExpInfoComponent_EndOpen__, v7);
    sub_1B90010(&StringLiteral_25011/*"{0:N0}"*/, v8);
    sub_1B90010(&StringLiteral_8550/*"MASTER_TOTAL_EXP"*/, v9);
    byte_4A6B48C = 1;
  }
  ...
  if ( !expInfoTitleLb
    || (UILabel__set_text(expInfoTitleLb, v11, 0LL),
        ...
        v11 = System_String__Format((System_String_o *)StringLiteral_25011/*"{0:N0}"*/, v17, 0LL),
        !expInfoLb) )
  {
    sub_1B9026C(v11, v12);
  }
