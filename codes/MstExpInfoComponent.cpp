...
void MstExpInfoComponent__Close(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D278A4 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_MstExpInfoComponent_Close__);
    sub_1C94098(&Method_MstExpInfoComponent_EndClose__);
    byte_4D278A4 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_Close__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_MstExpInfoComponent_Close__);
...
void MstExpInfoComponent__OnClickClose(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D278A3 & 1) == 0 )
  {
    sub_1C94098(&System_Action_TypeInfo);
    sub_1C94098(&Method_MstExpInfoComponent_EndClose__);
    sub_1C94098(&Method_MstExpInfoComponent_OnClickClose__);
    byte_4D278A3 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C940B0(Method_MstExpInfoComponent_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C9407C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    this->fields.isButtonEnable = 0;
    v5 = (System_Action_o *)sub_1C942E4(System_Action_TypeInfo);
...
void MstExpInfoComponent__openExpInfo(MstExpInfoComponent_o *this, int64_t exp, const MethodInfo *method)
{
  ...
  if ( (byte_4D278A2 & 1) == 0 )
  {
    ...
    sub_1C94098(&Method_MstExpInfoComponent_EndOpen__);
    sub_1C94098(&StringLiteral_25345/*"{0:N0}"*/);
    sub_1C94098(&StringLiteral_8594/*"MASTER_TOTAL_EXP"*/);
    byte_4D278A2 = 1;
  }
  expInfoTitleLb = this->fields.expInfoTitleLb;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_8594/*"MASTER_TOTAL_EXP"*/, 0);
  if ( !expInfoTitleLb
    || (UILabel__set_text(expInfoTitleLb, v6, 0),
        ...
        v6 = System_String__Format((System_String_o *)StringLiteral_25345/*"{0:N0}"*/, v9, 0),
        !expInfoLb) )
  {
    sub_1C942F0(v6, v7);
  }
