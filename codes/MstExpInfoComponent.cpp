...
void __fastcall MstExpInfoComponent__Close(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4350D5B & 1) == 0 )
  {
    ...
    sub_B70694(&Method_MstExpInfoComponent_EndClose__);
...
void __fastcall MstExpInfoComponent__openExpInfo(MstExpInfoComponent_o *this, int64_t exp, const MethodInfo *method)
{
  ...
  if ( (byte_4350D59 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_MstExpInfoComponent_EndOpen__);
    sub_B70694(&StringLiteral_23910/*"{0:N0}"*/);
    sub_B70694(&StringLiteral_8758/*"MASTER_TOTAL_EXP"*/);
    byte_4350D59 = 1;
  }
  ...
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_8758/*"MASTER_TOTAL_EXP"*/, 0LL);
  if ( !expInfoTitleLb
    || (UILabel__set_text(expInfoTitleLb, v6, 0LL),
        ...
        v6 = System_String__Format((System_String_o *)StringLiteral_23910/*"{0:N0}"*/, v10, 0LL),
        !expInfoLb) )
  {
    sub_B7076C(v6, v7);
  }
