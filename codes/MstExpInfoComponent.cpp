...
void __fastcall MstExpInfoComponent__Close(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7946 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MstExpInfoComponent_Close__);
    sub_1C21E38(&Method_MstExpInfoComponent_EndClose__);
    byte_4BD7946 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_Close__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MstExpInfoComponent_Close__);
...
void __fastcall MstExpInfoComponent__OnClickClose(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7945 & 1) == 0 )
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_MstExpInfoComponent_EndClose__);
    sub_1C21E38(&Method_MstExpInfoComponent_OnClickClose__);
    byte_4BD7945 = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_MstExpInfoComponent_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0LL);
    this->fields.isButtonEnable = 0;
    v5 = (System_Action_o *)sub_1C22084(System_Action_TypeInfo);
...
void __fastcall MstExpInfoComponent__openExpInfo(MstExpInfoComponent_o *this, int64_t exp, const MethodInfo *method)
{
  ...
  if ( (byte_4BD7944 & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_MstExpInfoComponent_EndOpen__);
    sub_1C21E38(&StringLiteral_25415/*"{0:N0}"*/);
    sub_1C21E38(&StringLiteral_8730/*"MASTER_TOTAL_EXP"*/);
    byte_4BD7944 = 1;
  }
  expInfoTitleLb = this->fields.expInfoTitleLb;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_8730/*"MASTER_TOTAL_EXP"*/, 0LL);
  if ( !expInfoTitleLb
    || (UILabel__set_text(expInfoTitleLb, v6, 0LL),
        ...
        v6 = System_String__Format((System_String_o *)StringLiteral_25415/*"{0:N0}"*/, v12, 0LL),
        !expInfoLb) )
  {
    sub_1C22094(v6, v7);
  }
