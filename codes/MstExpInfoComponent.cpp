...
void MstExpInfoComponent__Close(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593353C & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_MstExpInfoComponent_Close__);
    sub_21FFC50(&Method_MstExpInfoComponent_EndClose__);
    byte_593353C = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_Close__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_MstExpInfoComponent_Close__);
...
void MstExpInfoComponent__OnClickClose(MstExpInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593353B & 1) == 0 )
  {
    sub_21FFC50(&System_Action_TypeInfo);
    sub_21FFC50(&Method_MstExpInfoComponent_EndClose__);
    sub_21FFC50(&Method_MstExpInfoComponent_OnClickClose__);
    byte_593353B = 1;
  }
  if ( this->fields.isButtonEnable )
  {
    ...
    if ( (*((_BYTE *)Method_MstExpInfoComponent_OnClickClose__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_21FFC68(Method_MstExpInfoComponent_OnClickClose__);
    v4 = (System_Reflection_MethodBase_o *)sub_21FFC34(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 1, 0, 0);
    v5 = System_Action_TypeInfo;
    this->fields.isButtonEnable = 0;
...
void MstExpInfoComponent__openExpInfo(MstExpInfoComponent_o *this, int64_t exp, const MethodInfo *method)
{
  ...
  if ( (byte_593353A & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_MstExpInfoComponent_EndOpen__);
    sub_21FFC50(&StringLiteral_26423/*"{0:N0}"*/);
    sub_21FFC50(&StringLiteral_8924/*"MASTER_TOTAL_EXP"*/);
    byte_593353A = 1;
  }
  expInfoTitleLb = this->fields.expInfoTitleLb;
  if ( !*(&LocalizationManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo, exp, method);
  v6 = LocalizationManager__Get((System_String_o *)StringLiteral_8924/*"MASTER_TOTAL_EXP"*/, 0);
  if ( !expInfoTitleLb
    || (UILabel__set_text(expInfoTitleLb, v6, 0),
        ...
        v6 = System_String__Format((System_String_o *)StringLiteral_26423/*"{0:N0}"*/, v9, 0),
        !expInfoLb) )
  {
    sub_21FFECC(v6, v7);
  }
