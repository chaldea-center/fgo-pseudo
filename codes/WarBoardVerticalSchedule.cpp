void __fastcall WarBoardVerticalSchedule___ctor(WarBoardVerticalSchedule_o *this, const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.tasks, 0, v3, v4);
}


void __fastcall WarBoardVerticalSchedule___ctor_35405108(
...
void __fastcall WarBoardVerticalSchedule___ctor_35405152(
        WarBoardVerticalSchedule_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC449 & 1) == 0 )
  {
    sub_1B64870(&WarBoardVerticalSchedule__Execute_d__7_TypeInfo, method);
    byte_49FC449 = 1;
  }
  v3 = sub_1B64ABC(WarBoardVerticalSchedule__Execute_d__7_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FC44B & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_WarBoardVerticalSchedule___c__Execute_b__7_0__, v8);
    sub_1B64870(&WarBoardVerticalSchedule___c_TypeInfo, v9);
    this = (WarBoardVerticalSchedule__Execute_d__7_o *)sub_1B64870(&WarBoardManager_TypeInfo, v10);
    byte_49FC44B = 1;
  }
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)&v29[v28] = 0LL;
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            this = (WarBoardVerticalSchedule__Execute_d__7_o *)sub_1B649AC(this, *(_QWORD *)(*(_QWORD *)v31 + 64LL));
            if ( !this )
            {
LABEL_74:
              v68 = sub_1B64AF0(this);
              sub_1B64998(v68, 0LL);
            }
          }
          if ( v27 >= v31[6] )
...
LABEL_22:
  ...
  if ( !_9__7_0 )
  {
    ...
    _9__7_0 = (System_Func_bool__bool__o *)sub_1B64ABC(System_Func_bool__bool__TypeInfo);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__7_0, (int32_t)_9__7_0, v40, v41);
  }
      ...
      if ( !*v48 )
      {
        ...
        if ( v50 )
        {
          ...
          *v48 = ((unsigned __int8)this & 1) == 0;
          ...
          {
LABEL_45:
            p_method = sub_1BB6850(v50, System_Collections_IEnumerator_TypeInfo, 1LL);
          }
          ...
          if ( this )
          {
            this = (WarBoardVerticalSchedule__Execute_d__7_o *)sub_1B649AC(
                                                                 this,
        ...
        sub_1B64814(v59, (int32_t)v58, v42, v43);
  ...
  sub_1B64814(p__2__current, (int32_t)v66, v42, v43);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64884(&Method_WarBoardVerticalSchedule__Execute_d__7_System_Collections_IEnumerator_Reset__);
  sub_1B64998(v3, v4);
}
...
void __fastcall WarBoardVerticalSchedule___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FC44A & 1) == 0 )
  {
    sub_1B64870(&WarBoardVerticalSchedule___c_TypeInfo, v1);
    byte_49FC44A = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(WarBoardVerticalSchedule___c_TypeInfo);
