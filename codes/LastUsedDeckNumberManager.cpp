void __fastcall LastUsedDeckNumberManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FE10D & 1) == 0 )
  {
    sub_1B64870(&LastUsedDeckNumberManager_TypeInfo, v1);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo___ctor__, v4);
    sub_1B64870(&System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo, v5);
    sub_1B64870(&StringLiteral_6619/*"Fgo_20210906"*/, v6);
    byte_49FE10D = 1;
  }
  ...
  *(_WORD *)&LastUsedDeckNumberManager_TypeInfo->static_fields->isModfiy = 0;
  v7 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v7,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo___ctor__);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->lastUsedInfoList, (int32_t)v7, v9, v10);
}
...
void __fastcall LastUsedDeckNumberManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&LastUsedDeckNumberManager_TypeInfo, v1);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Clear__, v2);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__get_Count__, v3);
    byte_49FE107 = 1;
  }
...
void __fastcall LastUsedDeckNumberManager__DeleteData(int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_49FE10A & 1) == 0 )
  {
    sub_1B64870(&LastUsedDeckNumberManager_TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Find__, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Remove__, v4);
    sub_1B64870(&System_Predicate_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo, v5);
    sub_1B64870(&Method_LastUsedDeckNumberManager___c__DisplayClass11_0__DeleteData_b__0__, v6);
    sub_1B64870(&LastUsedDeckNumberManager___c__DisplayClass11_0_TypeInfo, v7);
    byte_49FE10A = 1;
  }
  v8 = sub_1B64ABC(LastUsedDeckNumberManager___c__DisplayClass11_0_TypeInfo);
  ...
  *(_DWORD *)(v8 + 16) = questId;
  ...
  v13 = (System_Predicate_object__o *)sub_1B64ABC(System_Predicate_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo);
  ...
  v14 = System_Collections_Generic_List_object___Find(
          ...
          (const MethodInfo_34B0018 *)Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Find__);
  if ( !v14 )
    return;
  v15 = v14;
...
LABEL_13:
  ...
  System_Collections_Generic_List_object___Remove(
    v9,
    v15,
    (const MethodInfo_34B0F78 *)Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Remove__);
...
int32_t __fastcall LastUsedDeckNumberManager__GetDeckNumber(int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_49FE109 & 1) == 0 )
  {
    sub_1B64870(&LastUsedDeckNumberManager_TypeInfo, method);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Find__, v3);
    sub_1B64870(&System_Predicate_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo, v4);
    sub_1B64870(&Method_LastUsedDeckNumberManager___c__DisplayClass10_0__GetDeckNumber_b__0__, v5);
    sub_1B64870(&LastUsedDeckNumberManager___c__DisplayClass10_0_TypeInfo, v6);
    byte_49FE109 = 1;
  }
  v7 = sub_1B64ABC(LastUsedDeckNumberManager___c__DisplayClass10_0_TypeInfo);
  ...
  *(_DWORD *)(v7 + 16) = questId;
  ...
  v12 = (System_Predicate_object__o *)sub_1B64ABC(System_Predicate_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo);
  System_Predicate_object____ctor(
    v12,
    (Il2CppObject *)v7,
...
bool __fastcall LastUsedDeckNumberManager__ReadData(const MethodInfo *method)
{
  ...
  if ( (byte_49FE10B & 1) == 0 )
  {
    ...
    sub_1B64870(&LastUsedDeckNumberManager_TypeInfo, v3);
    sub_1B64870(&LastUsedDeckNumberManager_LastUsedInfo_TypeInfo, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Add__, v5);
  ...
  if ( !v8->static_fields->UseMock )
  {
    ...
    if ( System_IO_File__Exists(SaveFileName, 0LL) )
    {
      ...
      else
      {
        ...
        if ( v22 >= 1 )
        {
          do
          {
            ...
            v26 = sub_1B64ABC(LastUsedDeckNumberManager_LastUsedInfo_TypeInfo);
            ...
            *(_QWORD *)(v26 + 24) = v25;
            ...
            if ( !items )
              sub_1B64ACC(lastUsedInfoList, v28);
            size = lastUsedInfoList->fields._size;
            ...
            else
            {
              ...
              sub_1B64814((ServantStatusBattleListViewItem_o *)(v36 + 4), v26, v29, v30);
            }
            --v22;
          }
          while ( v22 );
      ...
      {
LABEL_36:
        v40 = sub_1BB6850(v14, System_IDisposable_TypeInfo, 0LL);
      }
...
void __fastcall LastUsedDeckNumberManager__SetDeckNumber(int32_t questId, int32_t deckNumber, const MethodInfo *method)
{
  ...
  if ( (byte_49FE108 & 1) == 0 )
  {
    sub_1B64870(&BalanceConfig_TypeInfo, *(_QWORD *)&deckNumber);
    sub_1B64870(&Method_System_Linq_Enumerable_Aggregate_LastUsedDeckNumberManager_LastUsedInfo___, v5);
    sub_1B64870(
      ...
      v6);
    sub_1B64870(&LastUsedDeckNumberManager_TypeInfo, v7);
    sub_1B64870(&LastUsedDeckNumberManager_LastUsedInfo_TypeInfo, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Add__, v9);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__Find__, v10);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__get_Count__, v11);
    sub_1B64870(&NetworkManager_TypeInfo, v12);
    sub_1B64870(&System_Predicate_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo, v13);
    sub_1B64870(&Method_LastUsedDeckNumberManager___c__SetDeckNumber_b__9_1__, v14);
    sub_1B64870(&Method_LastUsedDeckNumberManager___c__DisplayClass9_0__SetDeckNumber_b__0__, v15);
    sub_1B64870(&LastUsedDeckNumberManager___c__DisplayClass9_0_TypeInfo, v16);
    sub_1B64870(&LastUsedDeckNumberManager___c_TypeInfo, v17);
    byte_49FE108 = 1;
  }
  v18 = sub_1B64ABC(LastUsedDeckNumberManager___c__DisplayClass9_0_TypeInfo);
  ...
  *(_DWORD *)(v18 + 16) = questId;
  ...
  v25 = (System_Predicate_object__o *)sub_1B64ABC(System_Predicate_LastUsedDeckNumberManager_LastUsedInfo__TypeInfo);
  System_Predicate_object____ctor(
    v25,
    (Il2CppObject *)v18,
    ...
    if ( v28 )
    {
      ...
      if ( v29 >= v30->static_fields->MemoryDeckLimitByQuest )
      {
        ...
        if ( !_9__9_1 )
        {
          ...
          _9__9_1 = (System_Func_T1__T2__TResult__o *)sub_1B64ABC(System_Func_LastUsedDeckNumberManager_LastUsedInfo__LastUsedDeckNumberManager_LastUsedInfo__LastUsedDeckNumberManager_LastUsedInfo__TypeInfo);
          ...
          sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->__9__9_1, (int32_t)_9__9_1, v37, v38);
        }
        v19 = (System_Collections_Generic_List_object__o *)System_Linq_Enumerable__Aggregate_object_(
                                                             ...
                                                             (const MethodInfo_2E4542C *)Method_System_Linq_Enumerable_Aggregate_LastUsedDeckNumberManager_LastUsedInfo___);
        if ( !v19 )
          goto LABEL_40;
      ...
      v40 = sub_1B64ABC(LastUsedDeckNumberManager_LastUsedInfo_TypeInfo);
        ...
        if ( v19 )
        {
          ...
          if ( v45 )
          {
            ...
            else
            {
              ...
              *(_QWORD *)(v48 + 32) = v40;
              sub_1B64814((ServantStatusBattleListViewItem_o *)(v48 + 32), v40, v41, v42);
            }
            goto LABEL_38;
          }
        }
...
bool __fastcall LastUsedDeckNumberManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_49FE10C & 1) == 0 )
  {
    ...
    sub_1B64870(&System_IDisposable_TypeInfo, v2);
    sub_1B64870(&LastUsedDeckNumberManager_TypeInfo, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__get_Count__, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__get_Item__, v5);
    sub_1B64870(&ManagerConfig_TypeInfo, v6);
    byte_49FE10C = 1;
  }
  v7 = LastUsedDeckNumberManager_TypeInfo;
  ...
  if ( size >= 1 )
  {
    for ( i = 0; i != size; ++i )
    {
      ...
      Item = System_Collections_Generic_List_object___get_Item(
               v23,
               i,
               (const MethodInfo_34AF6E0 *)Method_System_Collections_Generic_List_LastUsedDeckNumberManager_LastUsedInfo__get_Item__);
      v26 = Item;
      if ( !Item )
        sub_1B64ACC(0LL, v25);
      ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v14->klass->vtable._17_Write.method)(
...
void __fastcall LastUsedDeckNumberManager___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FE10E & 1) == 0 )
  {
    sub_1B64870(&LastUsedDeckNumberManager___c_TypeInfo, v1);
    byte_49FE10E = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(LastUsedDeckNumberManager___c_TypeInfo);
