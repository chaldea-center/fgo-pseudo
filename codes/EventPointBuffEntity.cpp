void __fastcall EventPointBuffEntity___ctor(EventPointBuffEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.groupId = 0LL;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.name, v5, v6, v7);
  v8 = (int)StringLiteral_1/*""*/;
  this->fields.detail = (struct System_String_o *)StringLiteral_1/*""*/;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.detail, v8, v9, v10);
  *(_QWORD *)&this->fields.imageId = 0LL;
  *(_QWORD *)&this->fields.skillIconId = 0LL;
  this->fields.value = 0;
  v11 = (struct System_Int32_array *)sub_1BCB0A0(int___TypeInfo, 0LL);
  this->fields.funcIds = v11;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.funcIds, (int32_t)v11, v12, v13);
}


void __fastcall EventPointBuffEntity___ctor_41219744(
        ...
        const MethodInfo *method)
{
  ...
  *(_OWORD *)&this->fields.id = *(_OWORD *)&cSrc->fields.id;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.detail, (int32_t)detail, v11, v12);
  *(_OWORD *)&this->fields.imageId = *(_OWORD *)&cSrc->fields.imageId;
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.funcIds, (int32_t)funcIds, v14, v15);
}
