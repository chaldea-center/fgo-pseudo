void EventPointBuffEntity___ctor(EventPointBuffEntity_o *this, const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.groupId = 0;
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.detail, v10, v11, v12, v13, v14, v15, v16);
  *(_QWORD *)&this->fields.imageId = 0;
  *(_QWORD *)&this->fields.skillIconId = 0;
  this->fields.value = 0;
  v17 = (struct System_Int32_array *)sub_1CE67A8(int___TypeInfo, 0);
  this->fields.funcIds = v17;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.funcIds, (int32_t)v17, v18, v19, v20, v21, v22, v23);
}
