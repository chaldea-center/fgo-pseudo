        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A50E & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_CharaGraphCommandCodeListViewItem___c__DisplayClass20_0___ctor_b__0__);
    sub_1B885B0(&CharaGraphCommandCodeListViewItem___c__DisplayClass20_0_TypeInfo);
    byte_4A5A50E = 1;
  }
  ...
  v11 = (Il2CppObject *)sub_1B887FC(CharaGraphCommandCodeListViewItem___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)&v32.fields.fakeValue = v17;
  Master_object = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46449800(v32, 0LL);
  v19 = this->fields._UserCommandCodeEntity_k__BackingField;
  this->fields._CommandCodeId_k__BackingField = Master_object;
  if ( !v19 )
    goto LABEL_15;
  CategoryIdList = UserCommandCodeEntity__GetCategoryIdList(v19, 0LL);
  ...
  Master_object = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2E7F8B4 *)Method_DataManager_GetMaster_CommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_15;
  ...
  *(_OWORD *)&v31.fields.fakeValue = v28;
  ...
  v30 = v31;
  Master_object = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46453324(&v30, 0LL);
  if ( !v11 )
LABEL_15:
    sub_1B8880C(Master_object, v15);
  v11[1].klass = (Il2CppClass *)Master_object;
  v29 = (System_Func_long__bool__o *)sub_1B887FC(System_Func_long__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( !UserCommandCodeEntity_k__BackingField
    || (UserCommandCodeEntity_k__BackingField = (UserCommandCodeEntity_o *)UserCommandCodeEntity__IsLock(
        ...
        !v4) )
  {
    sub_1B8880C(UserCommandCodeEntity_k__BackingField, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5A50D & 1) == 0 )
  {
    this = (CharaGraphCommandCodeListViewItem_o *)sub_1B885B0(&CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_TypeInfo);
    byte_4A5A50D = 1;
  }
