        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB50DE & 1) == 0 )
  {
    sub_1BAB41C(&Method_BasicHelper_Any_long___, *(_QWORD *)&index);
    sub_1BAB41C(&Method_DataManager_GetMaster_CommandCodeMaster___, v11);
    ...
    sub_1BAB41C(&System_Func_long__bool__TypeInfo, v14);
    ...
    sub_1BAB41C(&Method_CharaGraphCommandCodeListViewItem___c__DisplayClass20_0___ctor_b__0__, v17);
    sub_1BAB41C(&CharaGraphCommandCodeListViewItem___c__DisplayClass20_0_TypeInfo, v18);
    byte_4AB50DE = 1;
  }
  ...
  v19 = (Il2CppObject *)sub_1BAB668(CharaGraphCommandCodeListViewItem___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)&v40.fields.fakeValue = v25;
  Master_object = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46695852(v40, 0LL);
  ...
  Master_object = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2EC5574 *)Method_DataManager_GetMaster_CommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_15;
  ...
  *(_OWORD *)&v39.fields.fakeValue = v36;
  ...
  v38 = v39;
  Master_object = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46699376(&v38, 0LL);
  if ( !v19 )
LABEL_15:
    sub_1BAB678(Master_object, v23);
  v19[1].klass = (Il2CppClass *)Master_object;
  v37 = (System_Func_long__bool__o *)sub_1BAB668(System_Func_long__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB50DF & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMaster_UserCommandCodeMaster___, args);
        ...
        const MethodInfo *method)
{
  ...
  if ( !UserCommandCodeEntity_k__BackingField
    || (UserCommandCodeEntity_k__BackingField = (UserCommandCodeEntity_o *)UserCommandCodeEntity__IsLock(
        ...
        !v4) )
  {
    sub_1BAB678(UserCommandCodeEntity_k__BackingField, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB50DD & 1) == 0 )
  {
    this = (CharaGraphCommandCodeListViewItem_o *)sub_1BAB41C(
