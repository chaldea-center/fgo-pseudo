        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD8D1 & 1) == 0 )
  {
    sub_1B64870(&Method_BasicHelper_Any_long___, *(_QWORD *)&index);
    sub_1B64870(&Method_DataManager_GetMaster_CommandCodeMaster___, v11);
    ...
    sub_1B64870(&System_Func_long__bool__TypeInfo, v14);
    ...
    sub_1B64870(&Method_CharaGraphCommandCodeListViewItem___c__DisplayClass20_0___ctor_b__0__, v17);
    sub_1B64870(&CharaGraphCommandCodeListViewItem___c__DisplayClass20_0_TypeInfo, v18);
    byte_49FD8D1 = 1;
  }
  ...
  v19 = (Il2CppObject *)sub_1B64ABC(CharaGraphCommandCodeListViewItem___c__DisplayClass20_0_TypeInfo);
  ...
  *(_QWORD *)&v40.fields.fakeValue = v25;
  Master_object = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v40, 0LL);
  ...
  Master_object = (int64_t)DataManager__GetMaster_object_((const MethodInfo_2E3B674 *)Method_DataManager_GetMaster_CommandCodeMaster___);
  if ( !Master_object )
    goto LABEL_15;
  ...
  *(_OWORD *)&v39.fields.fakeValue = v36;
  ...
  v38 = v39;
  Master_object = CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_46184056(&v38, 0LL);
  if ( !v19 )
LABEL_15:
    sub_1B64ACC(Master_object, v23);
  v19[1].klass = (Il2CppClass *)Master_object;
  v37 = (System_Func_long__bool__o *)sub_1B64ABC(System_Func_long__bool__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD8D2 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_UserCommandCodeMaster___, args);
        ...
        const MethodInfo *method)
{
  ...
  if ( !UserCommandCodeEntity_k__BackingField
    || (UserCommandCodeEntity_k__BackingField = (UserCommandCodeEntity_o *)UserCommandCodeEntity__IsLock(
        ...
        !v4) )
  {
    sub_1B64ACC(UserCommandCodeEntity_k__BackingField, method);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FD8D0 & 1) == 0 )
  {
    this = (CharaGraphCommandCodeListViewItem_o *)sub_1B64870(
