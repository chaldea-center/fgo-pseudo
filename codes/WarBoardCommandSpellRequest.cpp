        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43503BB & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_23584/*"warBoard/commandSpell"*/);
    byte_43503BB = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_23584/*"warBoard/commandSpell"*/, 0LL);
}
