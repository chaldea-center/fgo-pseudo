        ...
        const MethodInfo *method)
{
  ...
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18932/*"commandSpellId"*/, commandSpellId, v9);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_19030/*"continueNum"*/, continueNum, v10);
...
System_String_o *WarBoardCommandSpellRequest__getURL(WarBoardCommandSpellRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_593A365 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_26055/*"warBoard/commandSpell"*/);
    byte_593A365 = 1;
  }
  if ( !*(&NetworkManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_75438412(BaseUrl, (System_String_o *)StringLiteral_26055/*"warBoard/commandSpell"*/, 0);
}
