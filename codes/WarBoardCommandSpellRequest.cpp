        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7722 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_18274/*"continueNum"*/, v9);
    sub_1BAB41C(&StringLiteral_18186/*"commandSpellId"*/, v10);
    byte_4AB7722 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_23516/*"stageId"*/, stageId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18186/*"commandSpellId"*/, commandSpellId, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18274/*"continueNum"*/, continueNum, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB7721 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_24656/*"warBoard/commandSpell"*/, v2);
    byte_4AB7721 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62048128(BaseUrl, (System_String_o *)StringLiteral_24656/*"warBoard/commandSpell"*/, 0LL);
}
