        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_43899E4 & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_23686/*"warBoard/commandSpell"*/);
    byte_43899E4 = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_23686/*"warBoard/commandSpell"*/, 0LL);
}
