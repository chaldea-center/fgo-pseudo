void MapCamera___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2D3E6 & 1) == 0 )
  {
    sub_1C93AD4(&MapCamera_TypeInfo);
    byte_4D2D3E6 = 1;
  }
...
UnityEngine_Rect_o MapCamera__GetWorldRect_36785424(
        MapCamera_o *this,
...
void MapCamera__Init(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D3DD & 1) == 0 )
  {
    sub_1C93AD4(&MapScroll_TypeInfo);
    sub_1C93AD4(&MapTouchDetector_TypeInfo);
  ...
  if ( !this->fields.mIsInitDone )
  {
    ...
    v3 = (MapTouchDetector_o *)sub_1C93D20(MapTouchDetector_TypeInfo);
    MapTouchDetector___ctor(v3, 0);
    this->fields.touchDetector = v3;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.touchDetector, (int32_t)v3, v4, v5, v6, v7, v8, v9);
    v10 = (MapScroll_o *)sub_1C93D20(MapScroll_TypeInfo);
    MapScroll___ctor(v10, 0);
    this->fields.mScrl = v10;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mScrl, (int32_t)v10, v11, v12, v13, v14, v15, v16);
    mScrl = this->fields.mScrl;
    if ( !mScrl )
      goto LABEL_8;
    MapScroll__Init(mScrl, this, this->fields.touchDetector, 0);
    v19 = (MapZoom_o *)sub_1C93D20(MapZoom_TypeInfo);
    MapZoom___ctor(v19, 0);
    this->fields.mZoom = v19;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mZoom, (int32_t)v19, v20, v21, v22, v23, v24, v25);
...
LABEL_19:
      sub_1C93D2C(mCamera, is_tch_enable);
    }
  }
}
...
void MapCamera__RemoveMapTexture(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D3E2 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_7523/*"IN_TerminalScene"*/);
    byte_4D2D3E2 = 1;
  }
  ...
  {
    mMapBg = (CrashReporter_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( !mMapBg )
      goto LABEL_11;
    CrashReporter__SetNowState(mMapBg, (System_String_o *)StringLiteral_7523/*"IN_TerminalScene"*/, 0);
  }
  mMapBg = (CrashReporter_o *)this->fields.mMapBg;
  if ( !mMapBg )
LABEL_11:
    sub_1C93D2C(mMapBg, method);
...
void MapCamera__SetMapBg(MapCamera_o *this, UITexture_o *mapBg, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D3DF & 1) == 0 )
  {
    sub_1C93AD4(&UnityEngine_Object_TypeInfo);
    sub_1C93AD4(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    sub_1C93AD4(&StringLiteral_12112/*"SET_TERMINAL_MAP"*/);
    byte_4D2D3DF = 1;
  }
  this->fields.mMapBg = mapBg;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mMapBg, (int32_t)mapBg, (int32_t)method, v3, v4, v5, v6, v7);
  MapCamera__SetMapRate(this, v10);
  mMapBg = (CrashReporter_o *)this->fields.mMapBg;
  if ( !mMapBg )
    goto LABEL_10;
  v13 = (UnityEngine_Object_o *)((__int64 (__fastcall *)(CrashReporter_o *, Il2CppMethodPointer))mMapBg->klass[1].vtable._2_GetHashCode.method)(
                                  mMapBg,
                                  mMapBg->klass[1].vtable._3_ToString.methodPtr);
  if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
  if ( UnityEngine_Object__op_Inequality(0, v13, 0) )
  {
    ...
    if ( mMapBg )
    {
      CrashReporter__SetNowState(mMapBg, (System_String_o *)StringLiteral_12112/*"SET_TERMINAL_MAP"*/, 0);
      return;
    }
LABEL_10:
    sub_1C93D2C(mMapBg, v11);
  }
}
...
void MapCamera__SetMapRate(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2D3E1 & 1) == 0 )
  {
    ...
    this = (MapCamera_o *)sub_1C93AD4(&MapCamera_TypeInfo);
    byte_4D2D3E1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    mMapBg = (UIWidget_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( mMapBg )
    {
      CrashReporter__SetNowState((CrashReporter_o *)mMapBg, (System_String_o *)StringLiteral_12112/*"SET_TERMINAL_MAP"*/, 0);
      return;
    }
LABEL_13:
    sub_1C93D2C(mMapBg, tex);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v14.fields.value.fields.y = 0;
  System_Nullable_Vector3____ctor(v15, v16, (const MethodInfo_39A43D0 *)endAct);
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v18.fields.value.fields.y = v10;
  SafeCameraDestination = (MapZoom_o *)MapCameraViewAdjusterUtil__GetSafeCameraDestination(this, v18, size, 0);
  ...
  {
    sub_1C93D2C(SafeCameraDestination, v15);
  }
...
void MapCamera__UnInit(MapCamera_o *this, const MethodInfo *method)
{
  ...
  System_String_o *v7; // x7
  MapScroll_o *mScrl; // x0
  GrandQuestFolderBoardItem_o *p_mScrl; // x20
  int32_t v11; // w2
  int32_t v12; // w3
  System_String_o *v13; // x4
  int32_t v14; // w5
  ...
  if ( this->fields.mIsInitDone )
  {
    p_mScrl = (GrandQuestFolderBoardItem_o *)&this->fields.mScrl;
    mScrl = this->fields.mScrl;
    if ( mScrl )
    {
      MapScroll__UnInit(mScrl, 0);
      p_mScrl->klass = 0;
      sub_1C93A78(p_mScrl, 0, v11, v12, v13, v14, v15, v16);
    }
    mZoom = this->fields.mZoom;
    if ( mZoom )
    {
      ...
      this->fields.mZoom = 0;
      sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.mZoom, 0, v18, v19, v20, v21, v22, v23);
    }
    this->fields.touchDetector = 0;
    p_touchDetector = &this->fields.touchDetector;
    sub_1C93A78((GrandQuestFolderBoardItem_o *)p_touchDetector, 0, v2, v3, v4, v5, v6, v7);
