void MapCamera___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4E01418 & 1) == 0 )
  {
    sub_1CE6700(&MapCamera_TypeInfo);
    byte_4E01418 = 1;
  }
...
UnityEngine_Rect_o MapCamera__GetWorldRect_37202188(
        MapCamera_o *this,
...
void MapCamera__Init(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0140F & 1) == 0 )
  {
    sub_1CE6700(&MapScroll_TypeInfo);
    sub_1CE6700(&MapTouchDetector_TypeInfo);
  ...
  if ( !this->fields.mIsInitDone )
  {
    ...
    v3 = (MapTouchDetector_o *)sub_1CE694C(MapTouchDetector_TypeInfo);
    MapTouchDetector___ctor(v3, 0);
    this->fields.touchDetector = v3;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.touchDetector, (int32_t)v3, v4, v5, v6, v7, v8, v9);
    v10 = (MapScroll_o *)sub_1CE694C(MapScroll_TypeInfo);
    MapScroll___ctor(v10, 0);
    this->fields.mScrl = v10;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mScrl, (int32_t)v10, v11, v12, v13, v14, v15, v16);
    mScrl = this->fields.mScrl;
    if ( !mScrl )
      goto LABEL_8;
    MapScroll__Init(mScrl, this, this->fields.touchDetector, 0);
    v19 = (MapZoom_o *)sub_1CE694C(MapZoom_TypeInfo);
    MapZoom___ctor(v19, 0);
    this->fields.mZoom = v19;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mZoom, (int32_t)v19, v20, v21, v22, v23, v24, v25);
...
LABEL_19:
      sub_1CE6958(mCamera, is_tch_enable);
    }
  }
}
...
void MapCamera__RemoveMapTexture(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01414 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_7539/*"IN_TerminalScene"*/);
    byte_4E01414 = 1;
  }
  ...
  {
    mMapBg = (CrashReporter_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( !mMapBg )
      goto LABEL_11;
    CrashReporter__SetNowState(mMapBg, (System_String_o *)StringLiteral_7539/*"IN_TerminalScene"*/, 0);
  }
  mMapBg = (CrashReporter_o *)this->fields.mMapBg;
  if ( !mMapBg )
LABEL_11:
    sub_1CE6958(mMapBg, method);
...
void MapCamera__SetMapBg(MapCamera_o *this, UITexture_o *mapBg, const MethodInfo *method)
{
  ...
  if ( (byte_4E01411 & 1) == 0 )
  {
    sub_1CE6700(&UnityEngine_Object_TypeInfo);
    sub_1CE6700(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    sub_1CE6700(&StringLiteral_12147/*"SET_TERMINAL_MAP"*/);
    byte_4E01411 = 1;
  }
  this->fields.mMapBg = mapBg;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mMapBg, (int32_t)mapBg, (int32_t)method, v3, v4, v5, v6, v7);
  ...
  if ( UnityEngine_Object__op_Inequality(0, v13, 0) )
  {
    ...
    if ( mMapBg )
    {
      CrashReporter__SetNowState(mMapBg, (System_String_o *)StringLiteral_12147/*"SET_TERMINAL_MAP"*/, 0);
      return;
    }
LABEL_10:
    sub_1CE6958(mMapBg, v11);
  }
}
...
void MapCamera__SetMapRate(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E01413 & 1) == 0 )
  {
    ...
    this = (MapCamera_o *)sub_1CE6700(&MapCamera_TypeInfo);
    byte_4E01413 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    mMapBg = (UIWidget_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_CrashReporter__get_Instance__);
    if ( mMapBg )
    {
      CrashReporter__SetNowState((CrashReporter_o *)mMapBg, (System_String_o *)StringLiteral_12147/*"SET_TERMINAL_MAP"*/, 0);
      return;
    }
LABEL_13:
    sub_1CE6958(mMapBg, tex);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v15.fields.value.fields.y = 0;
  System_Nullable_Vector3____ctor(v16, v17, (const MethodInfo_3A32A38 *)endAct);
  v13 = 0;
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&v19.fields.value.fields.y = v10;
  ...
  {
    sub_1CE6958(SafeCameraDestination, v16);
  }
        ...
        const MethodInfo *method)
{
  ...
  sizea = 0;
  System_Nullable_float____ctor(p_sizea, size, (const MethodInfo_3A30574 *)Method_System_Nullable_float___ctor__);
  v12 = sizea;
  *(_QWORD *)&v15.fields.hasValue = 0;
  *(_QWORD *)&v15.fields.value.fields.y = 0;
...
void MapCamera__UnInit(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.mIsInitDone )
  {
    ...
    if ( mScrl )
    {
      ...
      p_mScrl->klass = 0;
      sub_1CE66A4(p_mScrl, 0, v11, v12, v13, v14, v15, v16);
    }
    mZoom = this->fields.mZoom;
    if ( mZoom )
    {
      ...
      this->fields.mZoom = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.mZoom, 0, v18, v19, v20, v21, v22, v23);
    }
    this->fields.touchDetector = 0;
    p_touchDetector = &this->fields.touchDetector;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_touchDetector, 0, v2, v3, v4, v5, v6, v7);
