void __fastcall MapCamera___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C909 & 1) == 0 )
  {
    sub_1B715CC(&MapCamera_TypeInfo, v1);
    byte_4A1C909 = 1;
  }
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_Rect_o __fastcall MapCamera__GetWorldRect_33569628(
        MapCamera_o *this,
        UnityEngine_Vector3_o cam_pos,
        float scale,
        const MethodInfo *method)
...
void __fastcall MapCamera__Init(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C903 & 1) == 0 )
  {
    sub_1B715CC(&MapScroll_TypeInfo, method);
    sub_1B715CC(&MapTouchDetector_TypeInfo, v3);
    sub_1B715CC(&MapZoom_TypeInfo, v4);
    byte_4A1C903 = 1;
  }
  if ( !this->fields.mIsInitDone )
  {
    this->fields._windowSize_k__BackingField = FSWindowUtil__GetSize(0LL);
    v5 = (MapTouchDetector_o *)sub_1B71818(MapTouchDetector_TypeInfo);
    MapTouchDetector___ctor(v5, 0LL);
    this->fields.touchDetector = v5;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.touchDetector, (int32_t)v5, v6, v7);
    v8 = (MapScroll_o *)sub_1B71818(MapScroll_TypeInfo);
    MapScroll___ctor(v8, 0LL);
    this->fields.mScrl = v8;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mScrl, (int32_t)v8, v9, v10);
    mScrl = this->fields.mScrl;
    if ( !mScrl )
      goto LABEL_8;
    MapScroll__Init(mScrl, this, this->fields.touchDetector, 0LL);
    v13 = (MapZoom_o *)sub_1B71818(MapZoom_TypeInfo);
    MapZoom___ctor(v13, 0LL);
    this->fields.mZoom = v13;
    sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mZoom, (int32_t)v13, v14, v15);
...
void __fastcall MapCamera__Process(MapCamera_o *this, bool is_tch_enable, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C904 & 1) == 0 )
  {
    sub_1B715CC(&TerminalPramsManager_TypeInfo, is_tch_enable);
    byte_4A1C904 = 1;
  }
  if ( this->fields.mIsInitDone )
  {
...
LABEL_19:
      sub_1B71828(mCamera, is_tch_enable);
    }
  }
}
...
void __fastcall MapCamera__SetMapBg(MapCamera_o *this, UITexture_o *mapBg, const MethodInfo *method)
{
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mMapBg, (int32_t)mapBg, (int32_t)method, v3);
...
void __fastcall MapCamera__SetMapRate(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A1C905 & 1) == 0 )
  {
    ...
    this = (MapCamera_o *)sub_1B715CC(&MapCamera_TypeInfo, v3);
    byte_4A1C905 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C906 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Nullable_Vector3___ctor__, *(_QWORD *)&easeType);
    byte_4A1C906 = 1;
  }
  ...
  *(_QWORD *)&v14.fields.value.fields.y = 0LL;
  System_Nullable_Vector3____ctor(v16, v17, (const MethodInfo_35F1204 *)endAct);
  v15 = 0LL;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C908 & 1) == 0 )
  {
    sub_1B715CC(&MapCameraViewAdjusterUtil_TypeInfo, *(_QWORD *)&screenPos.fields.hasValue);
    sub_1B715CC(&MapCamera_TypeInfo, v14);
    byte_4A1C908 = 1;
  }
  ...
  *(_QWORD *)&v20.fields.value.fields.y = v10;
  ...
  {
    sub_1B71828(SafeCameraDestination, v16);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C907 & 1) == 0 )
  {
    sub_1B715CC(&Method_System_Nullable_float___ctor__, *(_QWORD *)&easeType);
    byte_4A1C907 = 1;
  }
  p_sizea = (System_Nullable_float__o)&sizea;
  sizea = 0LL;
  System_Nullable_float____ctor(p_sizea, size, (const MethodInfo_35EF1A0 *)Method_System_Nullable_float___ctor__);
  v14 = sizea;
...
void __fastcall MapCamera__UnInit(MapCamera_o *this, const MethodInfo *method)
{
  ...
  if ( this->fields.mIsInitDone )
  {
    ...
    if ( mZoom )
    {
      ...
      sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.mZoom, 0, v10, v11);
    }
    this->fields.touchDetector = 0LL;
    p_touchDetector = &this->fields.touchDetector;
    sub_1B71570((ServantStatusBattleListViewItem_o *)p_touchDetector, 0, v2, v3);
