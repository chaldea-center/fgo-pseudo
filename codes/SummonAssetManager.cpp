void __fastcall SummonAssetManager___ctor(SummonAssetManager_o *this, const MethodInfo *method)
{
  if ( (byte_48E1BA0 & 1) == 0 )
  {
    sub_1B00CCC(&Method_SingletonMonoBehaviour_SummonAssetManager___ctor__, method);
    byte_48E1BA0 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_35FC008 *)Method_SingletonMonoBehaviour_SummonAssetManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1B9E & 1) == 0 )
  {
    sub_1B00CCC(&Method_AssetData_GetObject_GameObject____74577936, parent);
    sub_1B00CCC(&Method_GameObjectExtensions_SafeGetComponent_ServantRewardAction___, v7);
    sub_1B00CCC(&Method_UnityEngine_Object_Instantiate_GameObject___, v8);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v9);
    sub_1B00CCC(&StringLiteral_12439/*"Servant_get_prefab"*/, v10);
    sub_1B00CCC(&StringLiteral_12440/*"Servant_get_prefab_for_battle"*/, v11);
    byte_48E1B9E = 1;
  }
  result = (ServantRewardAction_o *)this->fields.summonAssets;
  if ( result )
  {
    v13 = (System_String_o **)&StringLiteral_12440/*"Servant_get_prefab_for_battle"*/;
    if ( !isForBattle )
      v13 = (System_String_o **)&StringLiteral_12439/*"Servant_get_prefab"*/;
    ...
    if ( !byte_48DD9F7 )
    {
      transform = (UnityEngine_GameObject_o *)sub_1B00CCC(&UnityEngine_Quaternion_TypeInfo, v16);
      byte_48DD9F7 = 1;
    }
    if ( !v19 )
      goto LABEL_21;
...
LABEL_21:
    ...
    return (ServantRewardAction_o *)GameObjectExtensions__SafeGetComponent_object_(
                                      v17,
                                      (const MethodInfo_2DAF8F0 *)Method_GameObjectExtensions_SafeGetComponent_ServantRewardAction___);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E1B9D & 1) == 0 )
  {
    sub_1B00CCC(&AssetManager_TypeInfo, onLoad);
    sub_1B00CCC(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B00CCC(&Method_SummonAssetManager___c__DisplayClass1_0__LoadSummonAssets_b__0__, v6);
    sub_1B00CCC(&SummonAssetManager___c__DisplayClass1_0_TypeInfo, v7);
    sub_1B00CCC(&StringLiteral_5791/*"Effect/Summon"*/, v8);
    byte_48E1B9D = 1;
  }
  v9 = sub_1B00F18(SummonAssetManager___c__DisplayClass1_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = onLoad;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)(v9 + 24), (int32_t)onLoad, v14, v15);
  ...
  else
  {
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_5791/*"Effect/Summon"*/, v17, 1, 0LL);
  }
}
...
void __fastcall SummonAssetManager__UnloadSummonAssets(SummonAssetManager_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets )
  {
    ...
    sub_1B00C70(p_summonAssets, 0, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&_4__this->fields.summonAssets, (int32_t)data, (int32_t)method, v3);
