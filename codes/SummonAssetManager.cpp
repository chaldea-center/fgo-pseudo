void __fastcall SummonAssetManager___ctor(SummonAssetManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A07FAF & 1) == 0 )
  {
    sub_1B686D4(&Method_SingletonMonoBehaviour_SummonAssetManager___ctor__, method);
    byte_4A07FAF = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_36F7AB4 *)Method_SingletonMonoBehaviour_SummonAssetManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A07FAD & 1) == 0 )
  {
    sub_1B686D4(&Method_AssetData_GetObject_GameObject____75755192, parent);
    sub_1B686D4(&Method_GameObjectExtensions_SafeGetComponent_ServantRewardAction___, v7);
    sub_1B686D4(&Method_UnityEngine_Object_Instantiate_GameObject___, v8);
    sub_1B686D4(&UnityEngine_Object_TypeInfo, v9);
    sub_1B686D4(&StringLiteral_12594/*"Servant_get_prefab"*/, v10);
    sub_1B686D4(&StringLiteral_12595/*"Servant_get_prefab_for_battle"*/, v11);
    byte_4A07FAD = 1;
  }
  result = (ServantRewardAction_o *)this->fields.summonAssets;
  if ( result )
  {
    v13 = (System_String_o **)&StringLiteral_12595/*"Servant_get_prefab_for_battle"*/;
    if ( !isForBattle )
      v13 = (System_String_o **)&StringLiteral_12594/*"Servant_get_prefab"*/;
    ...
    if ( !byte_4A03907 )
    {
      transform = (UnityEngine_GameObject_o *)sub_1B686D4(&UnityEngine_Quaternion_TypeInfo, v16);
      byte_4A03907 = 1;
    }
    if ( !v19 )
      goto LABEL_21;
...
LABEL_21:
    ...
    return (ServantRewardAction_o *)GameObjectExtensions__SafeGetComponent_object_(
                                      v17,
                                      (const MethodInfo_2E9A438 *)Method_GameObjectExtensions_SafeGetComponent_ServantRewardAction___);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A07FAC & 1) == 0 )
  {
    sub_1B686D4(&AssetManager_TypeInfo, onLoad);
    sub_1B686D4(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1B686D4(&Method_SummonAssetManager___c__DisplayClass1_0__LoadSummonAssets_b__0__, v6);
    sub_1B686D4(&SummonAssetManager___c__DisplayClass1_0_TypeInfo, v7);
    sub_1B686D4(&StringLiteral_5827/*"Effect/Summon"*/, v8);
    byte_4A07FAC = 1;
  }
  v9 = sub_1B68920(SummonAssetManager___c__DisplayClass1_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = onLoad;
  sub_1B68678((ServantStatusBattleListViewItem_o *)(v9 + 24), (int32_t)onLoad, v14, v15);
...
void __fastcall SummonAssetManager__UnloadSummonAssets(SummonAssetManager_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets )
  {
    ...
    sub_1B68678(p_summonAssets, 0, v6, v7);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&_4__this->fields.summonAssets, (int32_t)data, (int32_t)method, v3);
