void __fastcall SummonAssetManager___ctor(SummonAssetManager_o *this, const MethodInfo *method)
{
  if ( (byte_4BFCA4B & 1) == 0 )
  {
    sub_1C2E12C(&Method_SingletonMonoBehaviour_SummonAssetManager___ctor__, method);
    byte_4BFCA4B = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_38A83A8 *)Method_SingletonMonoBehaviour_SummonAssetManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCA49 & 1) == 0 )
  {
    sub_1C2E12C(&Method_AssetData_GetObject_GameObject____77757312, parent);
    sub_1C2E12C(&Method_GameObjectExtensions_SafeGetComponent_ServantRewardAction___, v7);
    sub_1C2E12C(&Method_UnityEngine_Object_Instantiate_GameObject___, v8);
    sub_1C2E12C(&UnityEngine_Object_TypeInfo, v9);
    sub_1C2E12C(&StringLiteral_12906/*"Servant_get_prefab"*/, v10);
    sub_1C2E12C(&StringLiteral_12907/*"Servant_get_prefab_for_battle"*/, v11);
    byte_4BFCA49 = 1;
  }
  result = (ServantRewardAction_o *)this->fields.summonAssets;
  if ( result )
  {
    v13 = (System_String_o **)&StringLiteral_12907/*"Servant_get_prefab_for_battle"*/;
    if ( !isForBattle )
      v13 = (System_String_o **)&StringLiteral_12906/*"Servant_get_prefab"*/;
    ...
    if ( !byte_4BF7D91 )
    {
      transform = (UnityEngine_GameObject_o *)sub_1C2E12C(&UnityEngine_Vector3_TypeInfo, v16);
      byte_4BF7D91 = 1;
    }
    if ( !v18 )
      goto LABEL_21;
    ...
    if ( !byte_4BF7D97 )
    {
      transform = (UnityEngine_GameObject_o *)sub_1C2E12C(&UnityEngine_Quaternion_TypeInfo, v16);
      byte_4BF7D97 = 1;
    }
    if ( !v19 )
      goto LABEL_21;
...
LABEL_21:
    ...
    return (ServantRewardAction_o *)GameObjectExtensions__SafeGetComponent_object_(
                                      v17,
                                      (const MethodInfo_30245F4 *)Method_GameObjectExtensions_SafeGetComponent_ServantRewardAction___);
  }
  return result;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFCA48 & 1) == 0 )
  {
    sub_1C2E12C(&AssetManager_TypeInfo, onLoad);
    sub_1C2E12C(&AssetLoader_LoadEndDataHandler_TypeInfo, v5);
    sub_1C2E12C(&Method_SummonAssetManager___c__DisplayClass1_0__LoadSummonAssets_b__0__, v6);
    sub_1C2E12C(&SummonAssetManager___c__DisplayClass1_0_TypeInfo, v7);
    sub_1C2E12C(&StringLiteral_6000/*"Effect/Summon"*/, v8);
    byte_4BFCA48 = 1;
  }
  v9 = sub_1C2E378(SummonAssetManager___c__DisplayClass1_0_TypeInfo);
  ...
  *(_QWORD *)(v9 + 24) = onLoad;
  sub_1C2E0D0((PartyOrganizationUtility_o *)(v9 + 24), (int64_t)onLoad, v18, v19, v20, v21, v22, v23);
  ...
  else
  {
    ...
    AssetManager__loadAssetStorage((System_String_o *)StringLiteral_6000/*"Effect/Summon"*/, v25, 1, 0LL);
  }
}
...
void __fastcall SummonAssetManager__UnloadSummonAssets(SummonAssetManager_o *this, const MethodInfo *method)
{
  ...
  if ( summonAssets )
  {
    ...
    sub_1C2E0D0(p_summonAssets, 0LL, v6, v7, v8, v9, v10, v11);
  }
}
