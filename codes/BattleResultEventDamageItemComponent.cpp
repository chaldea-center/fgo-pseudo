void __fastcall BattleResultEventDamageItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C25400 & 1) == 0 )
  {
    sub_1C3B764(&BattleResultEventDamageItemComponent_TypeInfo, v1);
    sub_1C3B764(&StringLiteral_20938/*"mapCameraMoveTimeConstant"*/, v8);
    sub_1C3B764(&StringLiteral_2983/*"BOX_GACHA_RESET_LIMIT_MSG"*/, v9);
    sub_1C3B764(&StringLiteral_20656/*"keyboard-type"*/, v10);
    byte_4C25400 = 1;
  }
  BattleResultEventDamageItemComponent_TypeInfo->static_fields->DAMAGE_POINT_REWARD_AT_LOCALE_KEY = (struct System_String_o *)StringLiteral_2983/*"BOX_GACHA_RESET_LIMIT_MSG"*/;
  sub_1C3B708(
    (PartyOrganizationUtility_o *)BattleResultEventDamageItemComponent_TypeInfo->static_fields,
    StringLiteral_2983/*"BOX_GACHA_RESET_LIMIT_MSG"*/,
    v2,
    v3,
    v4,
    v5,
    v6,
    v7);
  v11 = StringLiteral_20938/*"mapCameraMoveTimeConstant"*/;
  static_fields = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  static_fields->DAMAGE_POINT_REWARD_TITLE_NAME = (struct System_String_o *)StringLiteral_20938/*"mapCameraMoveTimeConstant"*/;
  sub_1C3B708(
    ...
    v17,
    v18);
  v19 = StringLiteral_20656/*"keyboard-type"*/;
  v20 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v20->DAMAGE_POINT_REWARD_SPRITE_NAME = (struct System_String_o *)StringLiteral_20656/*"keyboard-type"*/;
  sub_1C3B708((PartyOrganizationUtility_o *)&v20->DAMAGE_POINT_REWARD_SPRITE_NAME, v19, v21, v22, v23, v24, v25, v26);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C253FE & 1) == 0 )
  {
    sub_1C3B764(&BattleResultEventDamageItemComponent_TypeInfo, *(_QWORD *)&currentGroup);
  ...
  mAtlas = (UIAtlas_o *)System_String__Concat_63368612(DAMAGE_POINT_REWARD_TITLE_NAME, v7, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C253FD & 1) == 0 )
  {
    sub_1C3B764(&AtlasManager_TypeInfo, drop);
    sub_1C3B764(&BattleResultEventDamageItemComponent_TypeInfo, v9);
    sub_1C3B764(&Method_BetterList_string__Contains__, v10);
    sub_1C3B764(&Method_DataManager_GetMasterData_EventMaster___, v11);
    sub_1C3B764(&Method_DataManager_GetMasterData_EventRewardMaster___, v12);
    sub_1C3B764(&Method_DataManager_GetMasterData_UserEventRaidMaster___, v13);
    ...
    sub_1C3B764(&StringLiteral_2982/*"BOX_GACHA_RESET_LAST_RESULT_MSG"*/, v18);
    sub_1C3B764(&StringLiteral_2969/*"BOOST_SUPPORT_REQUEST_USE_INVALID_TITLE"*/, v19);
    sub_1C3B764(&StringLiteral_2967/*"BOOST_SUPPORT_REQUEST_USE_DETAIL_SUPPORT_REQUEST"*/, v20);
    sub_1C3B764(&StringLiteral_2968/*"BOOST_SUPPORT_REQUEST_USE_DETAIL_SUPPORT_REQUEST_"*/, v21);
    sub_1C3B764(&StringLiteral_2965/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, v22);
  ...
  if ( eventId >= 1 )
  {
    ...
    v27 = System_String__Concat_63368612(DAMAGE_POINT_REWARD_AT_LOCALE_KEY, v26, 0LL);
    ...
    if ( titleAtLabel )
    {
      ...
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2982/*"BOX_GACHA_RESET_LAST_RESULT_MSG"*/, 0LL);
      if ( titleNextItemLabel )
      {
        ...
        BattleResultEventItemComponent__SetItemWindow_45908744((BattleResultEventItemComponent_o *)this, drop, v34);
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              Instance = System_String__Concat_63368612(DAMAGE_POINT_REWARD_SPRITE_NAME, v52, 0LL);
                  ...
                  if ( Instance )
                  {
                    ...
                    if ( Instance )
                    {
                      ...
                      if ( v46 )
                      {
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        v57 = LocalizationManager__Get((System_String_o *)StringLiteral_2969/*"BOOST_SUPPORT_REQUEST_USE_INVALID_TITLE"*/, 0LL);
                        ...
                        if ( atLabel )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          v65 = LocalizationManager__Get((System_String_o *)StringLiteral_2968/*"BOOST_SUPPORT_REQUEST_USE_DETAIL_SUPPORT_REQUEST_"*/, 0LL);
                          v66 = (Il2CppObject *)(v64 ? StringLiteral_1/*""*/ : nameText);
                          Instance = System_String__Format_63382984(v65, v66, (Il2CppObject *)countText, 0LL);
                          if ( nextItemLabel )
                          {
LABEL_55:
                      ...
                      else
                      {
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2967/*"BOOST_SUPPORT_REQUEST_USE_DETAIL_SUPPORT_REQUEST"*/, 0LL);
                        if ( v67 )
                        {
                          UILabel__set_text(v67, Instance, 0LL);
                          nextItemLabel = this->fields.nextItemLabel;
                          Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2965/*"BOOST_ITEM_USE_TITLE_FRIEND_CHOCOLATE"*/, 0LL);
                          if ( nextItemLabel )
                            goto LABEL_55;
                        }
                      }
