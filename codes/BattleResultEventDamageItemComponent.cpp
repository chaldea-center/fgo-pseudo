void __fastcall BattleResultEventDamageItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A22C1A & 1) == 0 )
  {
    sub_1B715CC(&BattleResultEventDamageItemComponent_TypeInfo, v1);
    sub_1B715CC(&StringLiteral_20468/*"img_txt_dpreward"*/, v4);
    sub_1B715CC(&StringLiteral_2942/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/, v5);
    sub_1B715CC(&StringLiteral_20201/*"img_bg_dp"*/, v6);
    byte_4A22C1A = 1;
  }
  BattleResultEventDamageItemComponent_TypeInfo->static_fields->DAMAGE_POINT_REWARD_AT_LOCALE_KEY = (struct System_String_o *)StringLiteral_2942/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/;
  sub_1B71570(
    (ServantStatusBattleListViewItem_o *)BattleResultEventDamageItemComponent_TypeInfo->static_fields,
    StringLiteral_2942/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/,
    v2,
    v3);
  v7 = StringLiteral_20468/*"img_txt_dpreward"*/;
  static_fields = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  static_fields->DAMAGE_POINT_REWARD_TITLE_NAME = (struct System_String_o *)StringLiteral_20468/*"img_txt_dpreward"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&static_fields->DAMAGE_POINT_REWARD_TITLE_NAME, v7, v9, v10);
  v11 = StringLiteral_20201/*"img_bg_dp"*/;
  v12 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v12->DAMAGE_POINT_REWARD_SPRITE_NAME = (struct System_String_o *)StringLiteral_20201/*"img_bg_dp"*/;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v12->DAMAGE_POINT_REWARD_SPRITE_NAME, v11, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22C18 & 1) == 0 )
  {
    sub_1B715CC(&BattleResultEventDamageItemComponent_TypeInfo, *(_QWORD *)&currentGroup);
  ...
  mAtlas = (UIAtlas_o *)System_String__Concat_61505504(DAMAGE_POINT_REWARD_TITLE_NAME, v7, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A22C17 & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, drop);
    sub_1B715CC(&BattleResultEventDamageItemComponent_TypeInfo, v9);
    sub_1B715CC(&Method_BetterList_string__Contains__, v10);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventMaster___, v11);
    sub_1B715CC(&Method_DataManager_GetMasterData_EventRewardMaster___, v12);
    sub_1B715CC(&Method_DataManager_GetMasterData_UserEventRaidMaster___, v13);
    ...
    sub_1B715CC(&StringLiteral_2941/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/, v18);
    sub_1B715CC(&StringLiteral_2928/*"BATTLE_RESULEVENTTITEM_NEXT_POINT"*/, v19);
    sub_1B715CC(&StringLiteral_2926/*"BATTLE_RESULEVENTTITEM_AT_POINT_NONE"*/, v20);
    sub_1B715CC(&StringLiteral_2927/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, v21);
    sub_1B715CC(&StringLiteral_2924/*"BATTLE_RESULEVENTTITEM_AT_ITEM_NONE"*/, v22);
  ...
  if ( eventId >= 1 )
  {
    ...
    v27 = System_String__Concat_61505504(DAMAGE_POINT_REWARD_AT_LOCALE_KEY, v26, 0LL);
    ...
    if ( titleAtLabel )
    {
      ...
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2941/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/, 0LL);
      if ( titleNextItemLabel )
      {
        ...
        BattleResultEventItemComponent__SetItemWindow_43941024((BattleResultEventItemComponent_o *)this, drop, 0LL);
        ...
        if ( Instance )
        {
          ...
          sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.usrEvent, (int32_t)MasterData_object, v34, v35);
          usrEvent = this->fields.usrEvent;
          if ( !usrEvent )
            return;
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              Instance = System_String__Concat_61505504(DAMAGE_POINT_REWARD_SPRITE_NAME, v46, 0LL);
                  ...
                  if ( Instance )
                  {
                    ...
                    if ( Instance )
                    {
                      ...
                      if ( v40 )
                      {
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        v51 = LocalizationManager__Get((System_String_o *)StringLiteral_2928/*"BATTLE_RESULEVENTTITEM_NEXT_POINT"*/, 0LL);
                        ...
                        if ( atLabel )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          v59 = LocalizationManager__Get((System_String_o *)StringLiteral_2927/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, 0LL);
                          v60 = (Il2CppObject *)(v58 ? StringLiteral_1/*""*/ : nameText);
                          Instance = System_String__Format_61519876(v59, v60, (Il2CppObject *)countText, 0LL);
                          if ( nextItemLabel )
                          {
LABEL_55:
                      ...
                      else
                      {
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2926/*"BATTLE_RESULEVENTTITEM_AT_POINT_NONE"*/, 0LL);
                        if ( v61 )
                        {
                          UILabel__set_text(v61, Instance, 0LL);
                          nextItemLabel = this->fields.nextItemLabel;
                          Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2924/*"BATTLE_RESULEVENTTITEM_AT_ITEM_NONE"*/, 0LL);
                          if ( nextItemLabel )
                            goto LABEL_55;
                        }
                      }
