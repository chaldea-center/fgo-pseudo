void BattleResultEventDamageItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D34341 & 1) == 0 )
  {
    sub_1C93AD4(&BattleResultEventDamageItemComponent_TypeInfo);
    sub_1C93AD4(&StringLiteral_20874/*"img_txt_dpreward"*/);
    sub_1C93AD4(&StringLiteral_2850/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/);
    sub_1C93AD4(&StringLiteral_20538/*"img_bg_dp"*/);
    byte_4D34341 = 1;
  }
  BattleResultEventDamageItemComponent_TypeInfo->static_fields->DAMAGE_POINT_REWARD_AT_LOCALE_KEY = (struct System_String_o *)StringLiteral_2850/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/;
  sub_1C93A78(
    (GrandQuestFolderBoardItem_o *)BattleResultEventDamageItemComponent_TypeInfo->static_fields,
    StringLiteral_2850/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_20874/*"img_txt_dpreward"*/;
  ...
  sub_1C93A78(
    ...
    v13,
    v14);
  v15 = StringLiteral_20538/*"img_bg_dp"*/;
  v16 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v16->DAMAGE_POINT_REWARD_SPRITE_NAME = (struct System_String_o *)StringLiteral_20538/*"img_bg_dp"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v16->DAMAGE_POINT_REWARD_SPRITE_NAME, v15, v17, v18, v19, v20, v21, v22);
}
        ...
        const MethodInfo *method)
{
  ...
  mAtlas = (UIAtlas_o *)System_String__Concat_64425724(DAMAGE_POINT_REWARD_TITLE_NAME, v6, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3433E & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2849/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/);
  ...
  if ( eventId >= 1 )
  {
    ...
    v12 = System_String__Concat_64425724(DAMAGE_POINT_REWARD_AT_LOCALE_KEY, v11, 0);
    ...
    if ( titleAtLabel )
    {
      ...
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2849/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/, 0);
      if ( titleNextItemLabel )
      {
        ...
        BattleResultEventItemComponent__SetItemWindow_48536156((BattleResultEventItemComponent_o *)this, drop, v19);
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              Instance = System_String__Concat_64425724(DAMAGE_POINT_REWARD_SPRITE_NAME, v37, 0);
                    ...
                    if ( Instance )
                    {
                      ...
                      if ( v31 )
                      {
                        ...
                        if ( atLabel )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          v47 = LocalizationManager__Get((System_String_o *)StringLiteral_2834/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, 0);
                          v48 = v46 ? (Il2CppObject *)StringLiteral_1/*""*/ : (Il2CppObject *)nameText;
                          Instance = System_String__Format_64467032(v47, v48, (Il2CppObject *)countText, 0);
                          if ( nextItemLabel )
                          {
LABEL_55:
                      ...
                      else
                      {
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2833/*"BATTLE_RESULEVENTTITEM_AT_POINT_NONE"*/, 0);
                        if ( v49 )
                        {
                          UILabel__set_text(v49, Instance, 0);
                          nextItemLabel = this->fields.nextItemLabel;
                          Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2831/*"BATTLE_RESULEVENTTITEM_AT_ITEM_NONE"*/, 0);
                          if ( nextItemLabel )
                            goto LABEL_55;
                        }
                      }
