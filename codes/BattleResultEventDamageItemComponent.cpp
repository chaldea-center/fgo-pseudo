void __fastcall BattleResultEventDamageItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E5823 & 1) == 0 )
  {
    sub_1B00CCC(&BattleResultEventDamageItemComponent_TypeInfo, v1);
    sub_1B00CCC(&StringLiteral_20241/*"img_txt_dpreward"*/, v4);
    sub_1B00CCC(&StringLiteral_2931/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/, v5);
    sub_1B00CCC(&StringLiteral_19979/*"img_bg_dp"*/, v6);
    byte_48E5823 = 1;
  }
  BattleResultEventDamageItemComponent_TypeInfo->static_fields->DAMAGE_POINT_REWARD_AT_LOCALE_KEY = (struct System_String_o *)StringLiteral_2931/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/;
  sub_1B00C70(
    (ServantStatusBattleListViewItem_o *)BattleResultEventDamageItemComponent_TypeInfo->static_fields,
    StringLiteral_2931/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/,
    v2,
    v3);
  v7 = StringLiteral_20241/*"img_txt_dpreward"*/;
  static_fields = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  static_fields->DAMAGE_POINT_REWARD_TITLE_NAME = (struct System_String_o *)StringLiteral_20241/*"img_txt_dpreward"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&static_fields->DAMAGE_POINT_REWARD_TITLE_NAME, v7, v9, v10);
  v11 = StringLiteral_19979/*"img_bg_dp"*/;
  v12 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v12->DAMAGE_POINT_REWARD_SPRITE_NAME = (struct System_String_o *)StringLiteral_19979/*"img_bg_dp"*/;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&v12->DAMAGE_POINT_REWARD_SPRITE_NAME, v11, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E5821 & 1) == 0 )
  {
    sub_1B00CCC(&BattleResultEventDamageItemComponent_TypeInfo, *(_QWORD *)&currentGroup);
  ...
  mAtlas = (UIAtlas_o *)System_String__Concat_60325748(DAMAGE_POINT_REWARD_TITLE_NAME, v7, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v62; // x1
  UILabel_o *v63; // x20
  int64_t v64; // [xsp+8h] [xbp-68h] BYREF
  ...
  if ( (byte_48E5820 & 1) == 0 )
  {
    sub_1B00CCC(&AtlasManager_TypeInfo, drop);
    sub_1B00CCC(&BattleResultEventDamageItemComponent_TypeInfo, v9);
    sub_1B00CCC(&Method_BetterList_string__Contains__, v10);
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventMaster___, v11);
    sub_1B00CCC(&Method_DataManager_GetMasterData_EventRewardMaster___, v12);
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserEventRaidMaster___, v13);
    ...
    sub_1B00CCC(&StringLiteral_2930/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/, v18);
    sub_1B00CCC(&StringLiteral_2917/*"BATTLE_RESULEVENTTITEM_NEXT_POINT"*/, v19);
    sub_1B00CCC(&StringLiteral_2915/*"BATTLE_RESULEVENTTITEM_AT_POINT_NONE"*/, v20);
    sub_1B00CCC(&StringLiteral_2916/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, v21);
    sub_1B00CCC(&StringLiteral_2913/*"BATTLE_RESULEVENTTITEM_AT_ITEM_NONE"*/, v22);
  ...
  if ( eventId >= 1 )
  {
    ...
    v27 = System_String__Concat_60325748(DAMAGE_POINT_REWARD_AT_LOCALE_KEY, v26, 0LL);
    ...
    if ( titleAtLabel )
    {
      ...
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2930/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/, 0LL);
      if ( titleNextItemLabel )
      {
        ...
        BattleResultEventItemComponent__SetItemWindow_42783880((BattleResultEventItemComponent_o *)this, drop, v34);
        ...
        if ( Instance )
        {
          ...
          sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.usrEvent, (int32_t)MasterData_object, v36, v37);
          usrEvent = this->fields.usrEvent;
          if ( !usrEvent )
            return;
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              if ( UnityEngine_Object__op_Inequality(eventIconSprite, 0LL, 0LL) )
              {
                ...
                v44 = this->fields.eventIconSprite;
                v45 = RaidEventImageId;
                if ( !AtlasManager_TypeInfo->_2.cctor_finished )
                  j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
                AtlasManager__SetItem(v44, v45, 0LL);
              }
              v46 = BattleResultEventDamageItemComponent_TypeInfo;
              if ( !BattleResultEventDamageItemComponent_TypeInfo->_2.cctor_finished )
              {
                j_il2cpp_runtime_class_init_0(BattleResultEventDamageItemComponent_TypeInfo);
                v46 = BattleResultEventDamageItemComponent_TypeInfo;
              }
              DAMAGE_POINT_REWARD_SPRITE_NAME = v46->static_fields->DAMAGE_POINT_REWARD_SPRITE_NAME;
              v48 = System_Int32__ToString((int)this + 168, 0LL);
              Instance = System_String__Concat_60325748(DAMAGE_POINT_REWARD_SPRITE_NAME, v48, 0LL);
                ...
                if ( Instance )
                {
                  ...
                  if ( Instance )
                  {
                    if ( !BetterList_object___Contains(
                            ...
                            (const MethodInfo_2F61C00 *)Method_BetterList_string__Contains__) )
                    {
                      v51 = BattleResultEventDamageItemComponent_TypeInfo;
                      if ( !BattleResultEventDamageItemComponent_TypeInfo->_2.cctor_finished )
                      {
                        j_il2cpp_runtime_class_init_0(BattleResultEventDamageItemComponent_TypeInfo);
                        v51 = BattleResultEventDamageItemComponent_TypeInfo;
                      }
                      v50 = (Il2CppObject *)v51->static_fields->DAMAGE_POINT_REWARD_SPRITE_NAME;
                    }
                    ...
                    if ( Instance )
                    {
                      ...
                      if ( v42 )
                      {
                        EventRewardEntity__GetInfo(v42, &nameText, &countText, 0LL);
                        atLabel = this->fields.atLabel;
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        v53 = LocalizationManager__Get((System_String_o *)StringLiteral_2917/*"BATTLE_RESULEVENTTITEM_NEXT_POINT"*/, 0LL);
                        v64 = v42->fields.point - TotalDamagePoint;
                        v57 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v64, v54, v55, v56);
                        Instance = System_String__Format(v53, v57, 0LL);
                        if ( atLabel )
                        {
                          UILabel__set_text(atLabel, Instance, 0LL);
                          isQp = EventRewardEntity__isQp(v42, 0LL);
                          nextItemLabel = this->fields.nextItemLabel;
                          v60 = isQp;
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          v61 = LocalizationManager__Get((System_String_o *)StringLiteral_2916/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, 0LL);
                          v62 = (Il2CppObject *)(v60 ? StringLiteral_1/*""*/ : nameText);
                          Instance = System_String__Format_60340120(v61, v62, (Il2CppObject *)countText, 0LL);
                          if ( nextItemLabel )
                          {
LABEL_55:
                      ...
                      else
                      {
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2915/*"BATTLE_RESULEVENTTITEM_AT_POINT_NONE"*/, 0LL);
                        if ( v63 )
                        {
                          UILabel__set_text(v63, Instance, 0LL);
                          nextItemLabel = this->fields.nextItemLabel;
                          Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2913/*"BATTLE_RESULEVENTTITEM_AT_ITEM_NONE"*/, 0LL);
                          if ( nextItemLabel )
                            goto LABEL_55;
                        }
                      }
