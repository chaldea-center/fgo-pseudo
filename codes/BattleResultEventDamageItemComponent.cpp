void __fastcall BattleResultEventDamageItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42B026C & 1) == 0 )
  {
    sub_B52984(&BattleResultEventDamageItemComponent_TypeInfo);
    sub_B52984(&StringLiteral_19825/*"img_txt_dpreward"*/);
    sub_B52984(&StringLiteral_2524/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/);
    sub_B52984(&StringLiteral_19579/*"img_bg_dp"*/);
    byte_42B026C = 1;
  }
  static_fields = (BattleServantConfConponent_o *)BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_2524/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_2524/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/;
  sub_B52920(static_fields, v8, v1, v2, v3, v4, v5, v6);
  v9 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_19825/*"img_txt_dpreward"*/;
  v9->DAMAGE_POINT_REWARD_TITLE_NAME = (struct System_String_o *)StringLiteral_19825/*"img_txt_dpreward"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->DAMAGE_POINT_REWARD_TITLE_NAME, v10, v11, v12, v13, v14, v15, v16);
  v17 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v18 = (System_Int32_array **)StringLiteral_19579/*"img_bg_dp"*/;
  v17->DAMAGE_POINT_REWARD_SPRITE_NAME = (struct System_String_o *)StringLiteral_19579/*"img_bg_dp"*/;
  sub_B52920((BattleServantConfConponent_o *)&v17->DAMAGE_POINT_REWARD_SPRITE_NAME, v18, v19, v20, v21, v22, v23, v24);
}
        ...
        const MethodInfo *method)
{
  ...
  mAtlas = (UIAtlas_o *)System_String__Concat_44568316(DAMAGE_POINT_REWARD_TITLE_NAME, v6, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  Il2CppObject *v48; // x1
  UILabel_o *v49; // x20
  int64_t v50; // [xsp+0h] [xbp-60h] BYREF
  ...
  if ( (byte_42B0269 & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_2523/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/);
  ...
  if ( eventId >= 1 )
  {
    ...
    v12 = System_String__Concat_44568316(DAMAGE_POINT_REWARD_AT_LOCALE_KEY, v11, 0LL);
    ...
    if ( titleAtLabel )
    {
      ...
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2523/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/, 0LL);
      if ( titleNextItemLabel )
      {
        ...
        BattleResultEventItemComponent__SetItemWindow_25373496((BattleResultEventItemComponent_o *)this, drop, v19);
        ...
        if ( Instance )
        {
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              Instance = System_String__Concat_44568316(DAMAGE_POINT_REWARD_SPRITE_NAME, v37, 0LL);
                  ...
                  if ( Instance )
                  {
                    ...
                    if ( Instance )
                    {
                      ...
                      if ( v31 )
                      {
                        ...
                        v42 = LocalizationManager__Get((System_String_o *)StringLiteral_2510/*"BATTLE_RESULEVENTTITEM_NEXT_POINT"*/, 0LL);
                        v50 = v31->fields.point - TotalDamagePoint;
                        v43 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v50);
                        Instance = System_String__Format(v42, v43, 0LL);
                        if ( atLabel )
                        {
                          ...
                          if ( isQp )
                          {
                            ...
                            v46 = LocalizationManager__Get((System_String_o *)StringLiteral_2509/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, 0LL);
                            v47 = (Il2CppObject *)countText;
                          ...
                          Instance = System_String__Format_44563852(v46, v48, v47, 0LL);
                          if ( nextItemLabel )
                          {
LABEL_69:
                      ...
                      else
                      {
                        ...
                        Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2508/*"BATTLE_RESULEVENTTITEM_AT_POINT_NONE"*/, 0LL);
                        if ( v49 )
                        {
                          UILabel__set_text(v49, Instance, 0LL);
                          nextItemLabel = this->fields.nextItemLabel;
                          Instance = LocalizationManager__Get((System_String_o *)StringLiteral_2506/*"BATTLE_RESULEVENTTITEM_AT_ITEM_NONE"*/, 0LL);
                          if ( nextItemLabel )
                            goto LABEL_69;
                        }
                      }
