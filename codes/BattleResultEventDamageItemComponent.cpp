void __fastcall BattleResultEventDamageItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A5E2EA & 1) == 0 )
  {
    sub_1B885B0(&BattleResultEventDamageItemComponent_TypeInfo);
    sub_1B885B0(&StringLiteral_20520/*"img_txt_dpreward"*/);
    sub_1B885B0(&StringLiteral_2957/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/);
    sub_1B885B0(&StringLiteral_20253/*"img_bg_dp"*/);
    byte_4A5E2EA = 1;
  }
  ...
  sub_1B88554(
    ...
    v1,
    v2);
  v3 = StringLiteral_20520/*"img_txt_dpreward"*/;
  static_fields = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  static_fields->DAMAGE_POINT_REWARD_TITLE_NAME = (struct System_String_o *)StringLiteral_20520/*"img_txt_dpreward"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&static_fields->DAMAGE_POINT_REWARD_TITLE_NAME, v3, v5, v6);
  v7 = StringLiteral_20253/*"img_bg_dp"*/;
  v8 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v8->DAMAGE_POINT_REWARD_SPRITE_NAME = (struct System_String_o *)StringLiteral_20253/*"img_bg_dp"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v8->DAMAGE_POINT_REWARD_SPRITE_NAME, v7, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  mAtlas = (UIAtlas_o *)System_String__Concat_61707032(DAMAGE_POINT_REWARD_TITLE_NAME, v6, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5E2E7 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_2956/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/);
  ...
  if ( eventId >= 1 )
  {
    ...
    v12 = System_String__Concat_61707032(DAMAGE_POINT_REWARD_AT_LOCALE_KEY, v11, 0LL);
    ...
    if ( titleAtLabel )
    {
      ...
      if ( titleNextItemLabel )
      {
        ...
        BattleResultEventItemComponent__SetItemWindow_44167192((BattleResultEventItemComponent_o *)this, drop, v19);
        ...
        if ( Instance )
        {
          ...
          sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.usrEvent, (int32_t)MasterData_object, v21, v22);
          usrEvent = this->fields.usrEvent;
          if ( !usrEvent )
            return;
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              if ( UnityEngine_Object__op_Inequality(eventIconSprite, 0LL, 0LL) )
              {
                ...
                AtlasManager__SetItem(v29, v30, 0LL);
              }
              ...
              v33 = System_Int32__ToString((int)this + 168, 0LL);
              Instance = System_String__Concat_61707032(DAMAGE_POINT_REWARD_SPRITE_NAME, v33, 0LL);
              ...
              if ( eventPointAtSprite )
              {
                ...
                if ( Instance )
                {
                  ...
                  if ( Instance )
                  {
                    ...
                    if ( Instance )
                    {
                      UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)v35, 0LL);
                      if ( v27 )
                      {
                        EventRewardEntity__GetInfo(v27, &nameText, &countText, 0LL);
                        atLabel = this->fields.atLabel;
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        v38 = LocalizationManager__Get((System_String_o *)StringLiteral_2943/*"BATTLE_RESULEVENTTITEM_NEXT_POINT"*/, 0LL);
                        v49 = v27->fields.point - TotalDamagePoint;
                        v42 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v49, v39, v40, v41);
                        Instance = System_String__Format(v38, v42, 0LL);
                        if ( atLabel )
                        {
                          UILabel__set_text(atLabel, Instance, 0LL);
                          isQp = EventRewardEntity__isQp(v27, 0LL);
                          nextItemLabel = this->fields.nextItemLabel;
                          v45 = isQp;
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          v46 = LocalizationManager__Get((System_String_o *)StringLiteral_2942/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, 0LL);
                          v47 = (Il2CppObject *)(v45 ? StringLiteral_1/*""*/ : nameText);
                          Instance = System_String__Format_61721404(v46, v47, (Il2CppObject *)countText, 0LL);
                          if ( nextItemLabel )
                          {
LABEL_55:
