void BattleResultEventDamageItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C2AAB8 & 1) == 0 )
  {
    sub_1C2D490(&BattleResultEventDamageItemComponent_TypeInfo);
    sub_1C2D490(&StringLiteral_20626/*"img_txt_dpreward"*/);
    sub_1C2D490(&StringLiteral_2838/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_POINT"*/);
    sub_1C2D490(&StringLiteral_20296/*"img_bg_dp"*/);
    byte_4C2AAB8 = 1;
  }
  ...
  sub_1C2D434(
    ...
    v1,
    v2);
  v3 = StringLiteral_20626/*"img_txt_dpreward"*/;
  static_fields = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  static_fields->DAMAGE_POINT_REWARD_TITLE_NAME = (struct System_String_o *)StringLiteral_20626/*"img_txt_dpreward"*/;
  sub_1C2D434((CGThumbnailListItem_o *)&static_fields->DAMAGE_POINT_REWARD_TITLE_NAME, v3, v5, v6);
  v7 = StringLiteral_20296/*"img_bg_dp"*/;
  v8 = BattleResultEventDamageItemComponent_TypeInfo->static_fields;
  v8->DAMAGE_POINT_REWARD_SPRITE_NAME = (struct System_String_o *)StringLiteral_20296/*"img_bg_dp"*/;
  sub_1C2D434((CGThumbnailListItem_o *)&v8->DAMAGE_POINT_REWARD_SPRITE_NAME, v7, v9, v10);
}
        ...
        const MethodInfo *method)
{
  ...
  mAtlas = (UIAtlas_o *)System_String__Concat_63457864(DAMAGE_POINT_REWARD_TITLE_NAME, v6, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2AAB5 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_2837/*"BATTLE_RESULT_EVENTDAMAGEITEM_AT_ITEM"*/);
  ...
  if ( eventId >= 1 )
  {
    ...
    v12 = System_String__Concat_63457864(DAMAGE_POINT_REWARD_AT_LOCALE_KEY, v11, 0);
    ...
    if ( titleAtLabel )
    {
      ...
      if ( titleNextItemLabel )
      {
        ...
        BattleResultEventItemComponent__SetItemWindow_47438904((BattleResultEventItemComponent_o *)this, drop, v19);
        ...
        if ( Instance )
        {
          ...
          sub_1C2D434((CGThumbnailListItem_o *)&this->fields.usrEvent, (int32_t)MasterData_object, v21, v22);
          usrEvent = this->fields.usrEvent;
          if ( !usrEvent )
            return;
          ...
          if ( Instance )
          {
            ...
            if ( Instance )
            {
              ...
              Instance = System_String__Concat_63457864(DAMAGE_POINT_REWARD_SPRITE_NAME, v33, 0);
                  ...
                  if ( Instance )
                  {
                    ...
                    if ( Instance )
                    {
                      ...
                      if ( v27 )
                      {
                        ...
                        if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                          j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                        v38 = LocalizationManager__Get((System_String_o *)StringLiteral_2823/*"BATTLE_RESULEVENTTITEM_NEXT_POINT"*/, 0);
                        v49 = v27->fields.point - TotalDamagePoint;
                        v42 = (Il2CppObject *)j_il2cpp_value_box_0(long_TypeInfo, &v49, v39, v40, v41);
                        Instance = System_String__Format(v38, v42, 0);
                        if ( atLabel )
                        {
                          ...
                          if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
                            j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
                          v46 = LocalizationManager__Get((System_String_o *)StringLiteral_2822/*"BATTLE_RESULEVENTTITEM_NEXT_ITEM"*/, 0);
                          v47 = v45 ? (Il2CppObject *)StringLiteral_1/*""*/ : (Il2CppObject *)nameText;
                          Instance = System_String__Format_63499156(v46, v47, (Il2CppObject *)countText, 0);
                          if ( nextItemLabel )
                          {
LABEL_55:
