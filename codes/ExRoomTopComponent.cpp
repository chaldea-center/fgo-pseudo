...
void ExRoomTopComponent__Init(ExRoomTopComponent_o *this, const MethodInfo *method)
{
  ...
  if ( !menuPanel )
    goto LABEL_12;
  SlideFadeObject__SlideOut_42907896((SlideFadeObject_o *)menuPanel, this->fields.slideValue, 0.0, 0.0, 0, 0);
  ...
  if ( !menuPanel )
LABEL_12:
    sub_2213CDC(menuPanel, v10);
  UISprite__set_spriteName((UISprite_o *)menuPanel, (System_String_o *)StringLiteral_18260/*"btn_help"*/, 0);
}
...
void ExRoomTopComponent__OnClickHelp(ExRoomTopComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596AEA4 & 1) == 0 )
  {
    sub_2213A60(&Method_ExRoomTopComponent_OnClickHelp__);
    byte_596AEA4 = 1;
  }
  v2 = Method_ExRoomTopComponent_OnClickHelp__;
  if ( (*((_BYTE *)Method_ExRoomTopComponent_OnClickHelp__ + 83) & 2) != 0 )
    v2 = (_QWORD *)sub_2213A78(Method_ExRoomTopComponent_OnClickHelp__);
...
void ExRoomTopComponent__OnClickQuest(ExRoomTopComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596AEA2 & 1) == 0 )
  {
    sub_2213A60(&Method_ExRoomTopComponent_OnClickQuest__);
    byte_596AEA2 = 1;
  }
  v3 = Method_ExRoomTopComponent_OnClickQuest__;
  if ( (*((_BYTE *)Method_ExRoomTopComponent_OnClickQuest__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_2213A78(Method_ExRoomTopComponent_OnClickQuest__);
...
void ExRoomTopComponent__OnClickShop(ExRoomTopComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596AEA3 & 1) == 0 )
  {
    sub_2213A60(&Method_ExRoomTopComponent_OnClickShop__);
    byte_596AEA3 = 1;
  }
  v3 = Method_ExRoomTopComponent_OnClickShop__;
  if ( (*((_BYTE *)Method_ExRoomTopComponent_OnClickShop__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_2213A78(Method_ExRoomTopComponent_OnClickShop__);
  v4 = (System_Reflection_MethodBase_o *)sub_2213A44(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  root = this->fields.root;
  if ( !root )
...
void ExRoomTopComponent__SlideIn(ExRoomTopComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_596AEA0 & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ExRoomTopComponent__SlideIn_b__12_0__);
  ...
  if ( !menuPanel
    || (SlideFadeObject__SlideIn_42906952(menuPanel, slideValue, v7, 0.0, v9, 0),
  ...
  {
    sub_2213CDC(helpButtonSprite, v11);
  }
...
void ExRoomTopComponent__SlideOut(ExRoomTopComponent_o *this, System_Action_o *callback, const MethodInfo *method)
{
  ...
  if ( (byte_596AEA1 & 1) == 0 )
  {
    sub_2213A60(&System_Action_TypeInfo);
    sub_2213A60(&TerminalPramsManager_TypeInfo);
    sub_2213A60(&Method_ExRoomTopComponent___c__DisplayClass13_0__SlideOut_b__0__);
    sub_2213A60(&ExRoomTopComponent___c__DisplayClass13_0_TypeInfo);
    byte_596AEA1 = 1;
  }
  v5 = sub_2213CCC(ExRoomTopComponent___c__DisplayClass13_0_TypeInfo);
...
LABEL_10:
  ...
  SlideFadeObject__SlideOut_42907896(menuPanel, slideValue, v19, 0.0, v21, 0);
}
