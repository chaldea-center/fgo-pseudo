        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFC6E6 & 1) == 0 )
  {
    sub_1C2E12C(&int_TypeInfo, unitString);
    sub_1C2E12C(&StringLiteral_837/*"+"*/, v7);
    sub_1C2E12C(&StringLiteral_25638/*"×"*/, v8);
    sub_1C2E12C(&StringLiteral_1/*""*/, v9);
    byte_4BFC6E6 = 1;
  }
  if ( (unsigned int)(type - 3) < 2 )
  {
    v14 = System_String__Concat_63235584((System_String_o *)StringLiteral_837/*"+"*/, unitString, 0LL);
    v18 = num;
    v15 = &v18;
  }
  else
  {
    ...
    v14 = System_String__Concat_63235584((System_String_o *)StringLiteral_25638/*"×"*/, unitString, 0LL);
    v15 = &v17;
    v17 = num;
  }
...
bool __fastcall Gift__IsCommandCode_38999992(int32_t type, const MethodInfo *method)
{
  return type == 11;
}
...
bool __fastcall Gift__IsEventPointBuff_39000016(int32_t type, const MethodInfo *method)
{
  return type == 12;
}
...
bool __fastcall Gift__IsEventSvtGet_38999648(int32_t type, const MethodInfo *method)
{
  return type == 7;
}
...
bool __fastcall Gift__IsEventSvtJoin_38999672(int32_t type, const MethodInfo *method)
{
  return type == 6;
}
...
bool __fastcall Gift__IsItem_38999548(int32_t type, const MethodInfo *method)
{
  return (unsigned int)(type - 2) < 4;
}
...
bool __fastcall Gift__IsServant_38999600(int32_t type, const MethodInfo *method)
{
  _BOOL4 v2; // w0
