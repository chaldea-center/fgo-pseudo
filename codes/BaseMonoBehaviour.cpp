        ...
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v7, 0, 0) )
    {
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      transform = (System_String_o *)UnityEngine_Object__Instantiate_71658888(v7, 0);
      if ( !transform )
        goto LABEL_20;
        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)prefab, 0, 0) )
  {
    ...
    v24.fields.z = z;
    v24.fields.w = w;
    transform = (UnityEngine_GameObject_o *)UnityEngine_Object__Instantiate_object__52199792(
                                              (Il2CppObject *)prefab,
                                              v18,
                                              v24,
...
UnityEngine_GameObject_o *BaseMonoBehaviour__createObject_41419124(
        BaseMonoBehaviour_o *this,
        System_String_o *resouceurl,
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v8, 0, 0) )
    {
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      transform = (System_String_o *)UnityEngine_Object__Instantiate_71658888(v8, 0);
      if ( !transform )
        goto LABEL_20;
      resouceurl = transform;
      if ( (UnityEngine_GameObject_c *)transform->klass != UnityEngine_GameObject_TypeInfo )
...
Il2CppObject *BaseMonoBehaviour__createObject_object_(
        ...
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo_3123D08 *method)
{
  Il2CppObject *v9; // x20
  float x; // s8
  float y; // s9
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)prefab, 0, 0) )
  {
    ...
    v28.fields.z = z;
    v28.fields.w = w;
    v14 = UnityEngine_Object__Instantiate_object__52199792(
            prefab,
            v22,
            v28,
            (const MethodInfo_31C8170 *)method->rgctx_data->_1_UnityEngine_Object_Instantiate_T_);
    v9 = v14;
    if ( !v14 )
      goto LABEL_11;
