        ...
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v7, 0LL, 0LL) )
    {
      ...
      transform = (System_String_o *)UnityEngine_Object__Instantiate_36309128(v7, 0LL);
      if ( !transform )
        goto LABEL_22;
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_GameObject_o *__fastcall BaseMonoBehaviour__createObject_22413920(
        BaseMonoBehaviour_o *this,
        System_String_o *resouceurl,
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v8, 0LL, 0LL) )
    {
      ...
      transform = (System_String_o *)UnityEngine_Object__Instantiate_36309128(v8, 0LL);
      if ( !transform )
        goto LABEL_22;
      resouceurl = transform;
      if ( (UnityEngine_GameObject_c *)transform->klass != UnityEngine_GameObject_TypeInfo )
...
Il2CppObject *__fastcall BaseMonoBehaviour__createObject_object_(
        ...
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo_1C65AF4 *method)
{
  Il2CppObject *v9; // x20
  long double v10; // q8
  long double v11; // q9
  ...
  if ( (byte_438D972 & 1) == 0 )
  {
    sub_B775C4(&UnityEngine_MonoBehaviour_TypeInfo);
    sub_B775C4(&UnityEngine_Object_TypeInfo);
    byte_438D972 = 1;
  }
  if ( (BYTE3(UnityEngine_Object_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)prefab, 0LL, 0LL) )
  {
    ...
    v22.fields.y = 0.0;
    v22.fields.z = 0.0;
    *(UnityEngine_Quaternion_o *)&v26 = UnityEngine_Quaternion__Euler_36342120(v22, 0LL);
    v10 = v26;
    ...
    v9 = (Il2CppObject *)((__int64 (__fastcall *)(Il2CppObject *, float, float, float, long double, long double, long double, long double))method->rgctx_data->_1_UnityEngine_Object_Instantiate_T_->methodPointer)(
                           ...
                           v12,
                           v13);
    v14 = (UnityEngine_Object_o *)sub_B77684(v9, UnityEngine_MonoBehaviour_TypeInfo);
