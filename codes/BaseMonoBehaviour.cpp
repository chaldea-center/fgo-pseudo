        ...
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v8, 0, 0) )
    {
      ...
      transform = (System_String_o *)UnityEngine_Object__Instantiate_83245144(v8, 0);
      if ( !transform )
        goto LABEL_20;
...
UnityEngine_GameObject_o *BaseMonoBehaviour__createObject_48121252(
        BaseMonoBehaviour_o *this,
        System_String_o *resouceurl,
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v9, 0, 0) )
    {
      ...
      transform = (System_String_o *)UnityEngine_Object__Instantiate_83245144(v9, 0);
      if ( !transform )
        goto LABEL_20;
      resouceurl = transform;
      if ( (UnityEngine_GameObject_c *)transform->klass != UnityEngine_GameObject_TypeInfo )
...
Il2CppObject *BaseMonoBehaviour__createObject_object_(
        ...
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo_37DC194 *method)
{
  Il2CppObject *v9; // x20
  __int64 v10; // x1
  float x; // s8
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)prefab, 0, 0) )
  {
    ...
    v30.fields.z = z;
    v30.fields.w = w;
    v15 = UnityEngine_Object__Instantiate_object__59507304(
            prefab,
            v24,
            v30,
            (const MethodInfo_38C0268 *)method->rgctx_data->_1_UnityEngine_Object_Instantiate_T_);
    v9 = v15;
    if ( !v15 )
      goto LABEL_11;
