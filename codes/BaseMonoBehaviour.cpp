        ...
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v7, 0LL, 0LL) )
    {
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      transform = (System_String_o *)UnityEngine_Object__Instantiate_69458584(v7, 0LL);
      if ( !transform )
        goto LABEL_20;
...
// local variable allocation has failed, the output may be wrong!
UnityEngine_GameObject_o *__fastcall BaseMonoBehaviour__createObject_38240928(
        BaseMonoBehaviour_o *this,
        System_String_o *resouceurl,
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo *method)
{
  ...
  if ( resouceurl )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(v8, 0LL, 0LL) )
    {
      if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
      transform = (System_String_o *)UnityEngine_Object__Instantiate_69458584(v8, 0LL);
      if ( !transform )
        goto LABEL_20;
      resouceurl = transform;
      if ( (UnityEngine_GameObject_c *)transform->klass != UnityEngine_GameObject_TypeInfo )
...
Il2CppObject *__fastcall BaseMonoBehaviour__createObject_object_(
        ...
        UnityEngine_Transform_o *root,
        UnityEngine_Transform_o *pos,
        const MethodInfo_2E6A584 *method)
{
  Il2CppObject *v9; // x20
  float x; // s8
  float y; // s9
  ...
  {
    sub_1B885B0(&UnityEngine_MonoBehaviour_TypeInfo);
    sub_1B885B0(&UnityEngine_Object_TypeInfo);
    if ( !method->rgctx_data )
      sub_1BDA4E8(method);
  }
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)prefab, 0LL, 0LL) )
  {
    ...
    v30.fields.z = z;
    v30.fields.w = w;
    v14 = UnityEngine_Object__Instantiate_object__49298104(
            prefab,
            v25,
            v30,
            (const MethodInfo_2F03AB8 *)method->rgctx_data->_1_UnityEngine_Object_Instantiate_T_);
    v9 = v14;
    if ( !v14 )
      goto LABEL_11;
