        ...
        const MethodInfo *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)prefab, 0, 0) )
  {
    ...
    v18.fields.y = 0.0;
    v18.fields.z = 0.0;
    UnityEngine_Transform__set_eulerAngles((UnityEngine_Transform_o *)transform, v18, 0);
    transform = (UnityEngine_GameObject_o *)UnityEngine_GameObject__get_transform(v8, 0);
    if ( !transform )
      goto LABEL_18;
    v19.fields.x = 1.0;
        ...
        const MethodInfo_380F544 *method)
{
  ...
  if ( !UnityEngine_Object__op_Equality((UnityEngine_Object_o *)prefab, 0, 0) )
  {
    ...
    v21.fields.y = 0.0;
    v21.fields.z = 0.0;
    v11 = UnityEngine_Object__Instantiate_object__59717424(
            prefab,
            v21,
            v19,
    ...
    {
      v13 = (UnityEngine_MonoBehaviour_c *)v11->klass->_2.typeHierarchy[naturalAligment - 1] == UnityEngine_MonoBehaviour_TypeInfo
    ...
    transform = (UnityEngine_Transform_o *)UnityEngine_Object__op_Inequality(v13, 0, 0);
