void __fastcall BattleCallBack_object____ctor(
        ...
        const MethodInfo_30A4B7C *method)
{
  int32_t v7; // w2
  int32_t v8; // w3
  int32_t v9; // w2
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)argument, v7, v8);
  this->fields.callBack = callBack;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.callBack, (int32_t)callBack, v9, v10);
}


void __fastcall BattleCallBack_object___call(BattleCallBack_T__o *this, const MethodInfo_30A4BC0 *method)
{
