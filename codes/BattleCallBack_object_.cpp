void __fastcall BattleCallBack_object____ctor(
        ...
        const MethodInfo_2D4CB9C *method)
{
  ...
  if ( !this )
    sub_B52A5C(0LL, argument);
  BattleCallBackBase___ctor((BattleCallBackBase_o *)this, 0LL);
  this->fields.argument = argument;
  sub_B52920((BattleServantConfConponent_o *)&this->fields, (System_Int32_array **)argument, v7, v8, v9, v10, v11, v12);
...
void __fastcall BattleCallBack_object___call(BattleCallBack_T__o *this, const MethodInfo_2D4CBF4 *method)
{
