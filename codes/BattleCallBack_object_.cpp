void __fastcall BattleCallBack_object____ctor(
        ...
        const MethodInfo_2DCCE2C *method)
{
  ...
  if ( !this )
    sub_B5D69C(0LL, argument);
  BattleCallBackBase___ctor((BattleCallBackBase_o *)this, 0LL);
  this->fields.argument = argument;
  sub_B5D560((BattleServantConfConponent_o *)&this->fields, (System_Int32_array **)argument, v7, v8, v9, v10, v11, v12);
...
void __fastcall BattleCallBack_object___call(BattleCallBack_T__o *this, const MethodInfo_2DCCE84 *method)
{
