void __fastcall PurchaseLogicExternal___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2D84F & 1) == 0 )
  {
    sub_1B761C0(&PurchaseLogicExternal_TypeInfo, v1);
    byte_4A2D84F = 1;
  }
...
void __fastcall PurchaseLogicExternal__ExternalPaymentCheck(PurchaseLogicExternal_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2D84B & 1) == 0 )
  {
    sub_1B761C0(&Method_NetworkManager_getRequest_ExternalPaymentReflectRequest___, method);
    sub_1B761C0(&NetworkManager_TypeInfo, v3);
    sub_1B761C0(&Method_PurchaseLogicExternal_ExternalPaymentCheckCallBack__, v4);
    sub_1B761C0(&PurchaseLogicExternal_TypeInfo, v5);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v8,
                     (const MethodInfo_2EE44C0 *)Method_NetworkManager_getRequest_ExternalPaymentReflectRequest___);
  if ( !Request_object )
    sub_1B7641C(0LL, v11);
        ...
        const MethodInfo *method)
{
  ...
  PurchaseLogicExternal_c *v47; // x0
  PurchaseLogicExternal_o *v48; // x0
  int32_t v49; // w1
  ...
  if ( (byte_4A2D84C & 1) == 0 )
  {
    sub_1B761C0(&Method_System_Collections_Generic_Dictionary_string__object__get_Item__, result);
    ...
    sub_1B761C0(&PurchaseBehaviour_TypeInfo, v10);
    sub_1B761C0(&PurchaseLogicExternal_TypeInfo, v11);
    sub_1B761C0(&StringLiteral_19624/*"freeStoneNum"*/, v12);
    sub_1B761C0(&StringLiteral_22586/*"price"*/, v13);
    sub_1B761C0(&StringLiteral_22325/*"orderId"*/, v14);
    sub_1B761C0(&StringLiteral_22046/*"ng"*/, v15);
    sub_1B761C0(&StringLiteral_17923/*"chargeStoneNum"*/, v16);
    sub_1B761C0(&StringLiteral_19315/*"externalPaymentResults"*/, v17);
    sub_1B761C0(&StringLiteral_24096/*"type"*/, v18);
    byte_4A2D84C = 1;
  }
...
LABEL_35:
    v47 = PurchaseLogicExternal_TypeInfo;
    if ( !PurchaseLogicExternal_TypeInfo->_2.cctor_finished )
    {
      j_il2cpp_runtime_class_init_0(PurchaseLogicExternal_TypeInfo);
      v47 = PurchaseLogicExternal_TypeInfo;
    }
    v47->static_fields->isEnd = 1;
    return;
  }
  ...
  if ( v24 )
  {
    if ( v24 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       (System_Collections_Generic_Dictionary_object__object__o *)Dictionary,
                       (Il2CppObject *)StringLiteral_24096/*"type"*/,
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_22325/*"orderId"*/,
                       (const MethodInfo_31A5CB0 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_38;
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_17923/*"chargeStoneNum"*/,
                       (const MethodInfo_31A5CB0 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_38;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_19624/*"freeStoneNum"*/,
                       (const MethodInfo_31A5CB0 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_38;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_22586/*"price"*/,
                       (const MethodInfo_31A5CB0 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_38;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
      ...
      sub_1B766DC(Dictionary);
LABEL_40:
      sub_1B766DC(v28);
LABEL_41:
      v52 = sub_1B766DC(v22);
      PurchaseLogicExternal__SendPurchaseAction(v48, v49, *(double *)&v52, v50, v51);
      return;
    }
    v26 = 0;
    v25 = 0;
LABEL_34:
    ...
    StoneCountRefreshComponent__RefreshAllStoneCount(v46);
    goto LABEL_35;
  }
  ...
  v45->static_fields->isOpenPurchaseDialogEvent = 0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D84E & 1) == 0 )
  {
    sub_1B761C0(&Method_SingletonMonoBehaviour_AdManager__get_Instance__, *(_QWORD *)&actionId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D84D & 1) == 0 )
  {
    sub_1B761C0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, *(_QWORD *)&chargeStoneNum);
    byte_4A2D84D = 1;
  }
