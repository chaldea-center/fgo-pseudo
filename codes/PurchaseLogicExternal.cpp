void __fastcall PurchaseLogicExternal___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C218F4 & 1) == 0 )
  {
    sub_1C3B764(&PurchaseLogicExternal_TypeInfo, v1);
    byte_4C218F4 = 1;
  }
...
void __fastcall PurchaseLogicExternal__ExternalPaymentCheck(PurchaseLogicExternal_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C218F0 & 1) == 0 )
  {
    sub_1C3B764(&Method_NetworkManager_getRequest_ExternalPaymentReflectRequest___, method);
    sub_1C3B764(&NetworkManager_TypeInfo, v3);
    sub_1C3B764(&Method_PurchaseLogicExternal_ExternalPaymentCheckCallBack__, v4);
    sub_1C3B764(&PurchaseLogicExternal_TypeInfo, v5);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v8,
                     (const MethodInfo_3075AE8 *)Method_NetworkManager_getRequest_ExternalPaymentReflectRequest___);
  if ( !Request_object )
    sub_1C3B9C0(0LL, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C218F1 & 1) == 0 )
  {
    sub_1C3B764(&Method_System_Collections_Generic_Dictionary_string__object__get_Item__, result);
    ...
    sub_1C3B764(&PurchaseBehaviour_TypeInfo, v10);
    sub_1C3B764(&PurchaseLogicExternal_TypeInfo, v11);
    sub_1C3B764(&StringLiteral_20014/*"img_listbg_01"*/, v12);
    sub_1C3B764(&StringLiteral_23066/*"socket"*/, v13);
    sub_1C3B764(&StringLiteral_22794/*"servant_icon"*/, v14);
    sub_1C3B764(&StringLiteral_22507/*"referrerMapId"*/, v15);
    sub_1C3B764(&StringLiteral_18283/*"digit"*/, v16);
    sub_1C3B764(&StringLiteral_19703/*"i"*/, v17);
    sub_1C3B764(&StringLiteral_24611/*"{0:D2}h{1:D2}m{2:D2}s"*/, v18);
    byte_4C218F1 = 1;
  }
  ...
  if ( v24 )
  {
    if ( v24 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       (System_Collections_Generic_Dictionary_object__object__o *)Dictionary,
                       (Il2CppObject *)StringLiteral_24611/*"{0:D2}h{1:D2}m{2:D2}s"*/,
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_22794/*"servant_icon"*/,
                       (const MethodInfo_33556E8 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_18283/*"digit"*/,
                       (const MethodInfo_33556E8 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_20014/*"img_listbg_01"*/,
                       (const MethodInfo_33556E8 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_23066/*"socket"*/,
                       (const MethodInfo_33556E8 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C218F3 & 1) == 0 )
  {
    sub_1C3B764(&Method_SingletonMonoBehaviour_AdManager__get_Instance__, *(_QWORD *)&actionId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C218F2 & 1) == 0 )
  {
    sub_1C3B764(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, *(_QWORD *)&chargeStoneNum);
    byte_4C218F2 = 1;
  }
