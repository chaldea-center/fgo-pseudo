void __fastcall PurchaseLogicExternal___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0E5 & 1) == 0 )
  {
    sub_1C2E12C(&PurchaseLogicExternal_TypeInfo, v1);
    byte_4BFD0E5 = 1;
  }
...
void __fastcall PurchaseLogicExternal__ExternalPaymentCheck(PurchaseLogicExternal_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0E1 & 1) == 0 )
  {
    sub_1C2E12C(&Method_NetworkManager_getRequest_ExternalPaymentReflectRequest___, method);
    sub_1C2E12C(&NetworkManager_TypeInfo, v3);
    sub_1C2E12C(&Method_PurchaseLogicExternal_ExternalPaymentCheckCallBack__, v4);
    sub_1C2E12C(&PurchaseLogicExternal_TypeInfo, v5);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v8,
                     (const MethodInfo_3056BC4 *)Method_NetworkManager_getRequest_ExternalPaymentReflectRequest___);
  if ( !Request_object )
    sub_1C2E388(0LL, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0E2 & 1) == 0 )
  {
    sub_1C2E12C(&Method_System_Collections_Generic_Dictionary_string__object__get_Item__, result);
    ...
    sub_1C2E12C(&PurchaseBehaviour_TypeInfo, v10);
    sub_1C2E12C(&PurchaseLogicExternal_TypeInfo, v11);
    sub_1C2E12C(&StringLiteral_19979/*"freeStoneNum"*/, v12);
    sub_1C2E12C(&StringLiteral_23024/*"price"*/, v13);
    sub_1C2E12C(&StringLiteral_22755/*"orderId"*/, v14);
    sub_1C2E12C(&StringLiteral_22468/*"ng"*/, v15);
    sub_1C2E12C(&StringLiteral_18249/*"chargeStoneNum"*/, v16);
    sub_1C2E12C(&StringLiteral_19668/*"externalPaymentResults"*/, v17);
    sub_1C2E12C(&StringLiteral_24567/*"type"*/, v18);
    byte_4BFD0E2 = 1;
  }
  ...
  if ( v24 )
  {
    if ( v24 >= 1 )
    {
      ...
      while ( 1 )
      {
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       (System_Collections_Generic_Dictionary_object__object__o *)Dictionary,
                       (Il2CppObject *)StringLiteral_24567/*"type"*/,
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_22755/*"orderId"*/,
                       (const MethodInfo_3335AF4 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_18249/*"chargeStoneNum"*/,
                       (const MethodInfo_3335AF4 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_19979/*"freeStoneNum"*/,
                       (const MethodInfo_3335AF4 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        Dictionary = System_Collections_Generic_Dictionary_object__object___get_Item(
                       v28,
                       (Il2CppObject *)StringLiteral_23024/*"price"*/,
                       (const MethodInfo_3335AF4 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
        if ( !Dictionary )
          goto LABEL_35;
        if ( *(Il2CppClass **)(*(_QWORD *)Dictionary + 64LL) != long_TypeInfo->_1.element_class )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0E4 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SingletonMonoBehaviour_AdManager__get_Instance__, *(_QWORD *)&actionId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFD0E3 & 1) == 0 )
  {
    sub_1C2E12C(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, *(_QWORD *)&chargeStoneNum);
    byte_4BFD0E3 = 1;
  }
