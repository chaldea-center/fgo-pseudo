void __fastcall UserEventRaceMaster___ctor(UserEventRaceMaster_o *this, const MethodInfo *method)
{
  if ( (byte_42AEEC2 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_UserEventRaceMaster__UserEventRaceEntity__string___ctor__);
    byte_42AEEC2 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    213,
    (const MethodInfo_23E268C *)Method_DataMasterBase_UserEventRaceMaster__UserEventRaceEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEEC0 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_UserEventRaceMaster__UserEventRaceEntity__string__GetEntity__);
    byte_42AEEC0 = 1;
  }
  ...
  return (UserEventRaceEntity_o *)DataMasterBase_WarMessageMaster__WarMessageEntity__string___GetEntity(
                                    ...
                                    PK,
                                    (const MethodInfo_23E2728 *)Method_DataMasterBase_UserEventRaceMaster__UserEventRaceEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEEC3 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_System_Collections_Generic_Dictionary_int__long__Remove__);
    sub_B52984(&Method_System_Collections_Generic_Dictionary_int__long__TryGetValue__);
    ...
    sub_B52984(&UserEventRaceEntity_TypeInfo);
    byte_42AEEC3 = 1;
  }
  value = 0LL;
  entity = 0LL;
  ...
  v6 = (System_Collections_Generic_Dictionary_int__long__o *)sub_B52A54(System_Collections_Generic_Dictionary_int__long__TypeInfo);
...
LABEL_47:
        ...
        Instance = System_Collections_Generic_Dictionary_int__long___TryGetValue(
                     ...
                     v18[v16],
                     &value,
                     (const MethodInfo_2F25D2C *)Method_System_Collections_Generic_Dictionary_int__long__TryGetValue__);
        if ( (Instance & 1) != 0 )
        {
          if ( v16 >= groupIds->max_length )
            goto LABEL_47;
          Instance = System_Collections_Generic_Dictionary_int__long___Remove(
                       v6,
                       v18[v16],
                       (const MethodInfo_2F259E4 *)Method_System_Collections_Generic_Dictionary_int__long__Remove__);
          v19 = value;
        }
        else
        {
...
LABEL_13:
  ...
  return (System_Int64_array *)sub_B5299C(long___TypeInfo, EventJoinGroupNum);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AEEC1 & 1) == 0 )
  {
    sub_B52984(&Method_DataMasterBase_UserEventRaceMaster__UserEventRaceEntity__string__TryGetEntity__);
    byte_42AEEC1 = 1;
  }
  ...
  return DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string___TryGetEntity(
           ...
           PK,
           (const MethodInfo_23E2780 *)Method_DataMasterBase_UserEventRaceMaster__UserEventRaceEntity__string__TryGetEntity__);
}