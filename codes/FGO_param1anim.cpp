...
void __fastcall FGO_param1anim__Start(FGO_param1anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB3562 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_16815/*"_keyPairContainer"*/, v3);
    byte_4BB3562 = 1;
  }
  ...
  if ( !renderer
    ...
    || (UnityEngine_Material__EnableKeyword(
          ...
          (System_String_o *)StringLiteral_16815/*"_keyPairContainer"*/,
          0LL),
...
void __fastcall FGO_param1anim__Update(FGO_param1anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB3563 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_16815/*"_keyPairContainer"*/, method);
    byte_4BB3563 = 1;
  }
  renderer = this->fields._renderer;
