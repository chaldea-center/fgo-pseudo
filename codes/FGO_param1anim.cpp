...
void __fastcall FGO_param1anim__Start(FGO_param1anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C20DCF & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_16881/*"bit_expedition_start_dog_{0}"*/, v3);
    byte_4C20DCF = 1;
  }
  ...
  if ( !renderer
    ...
    || (UnityEngine_Material__EnableKeyword(
          ...
          (System_String_o *)StringLiteral_16881/*"bit_expedition_start_dog_{0}"*/,
          0LL),
...
void __fastcall FGO_param1anim__Update(FGO_param1anim_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C20DD0 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_16881/*"bit_expedition_start_dog_{0}"*/, method);
    byte_4C20DD0 = 1;
  }
  renderer = this->fields._renderer;
