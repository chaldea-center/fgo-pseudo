...
{
  *(_OWORD *)&this->fields.currencySpritePosTypeA.fields.x = xmmword_C09A60;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23553 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_20315/*"img_bg_seed"*/);
    sub_1C2D490(&StringLiteral_20308/*"img_bg_mp"*/);
    sub_1C2D490(&StringLiteral_20299/*"img_bg_evocation"*/);
    sub_1C2D490(&StringLiteral_20300/*"img_bg_fragments"*/);
    sub_1C2D490(&StringLiteral_20310/*"img_bg_pureprism_itemstock_resetticket"*/);
    sub_1C2D490(&StringLiteral_20290/*"img_bg_ap"*/);
    sub_1C2D490(&StringLiteral_20312/*"img_bg_rp"*/);
    sub_1C2D490(&StringLiteral_20307/*"img_bg_hgd"*/);
    sub_1C2D490(&StringLiteral_1/*""*/);
    sub_1C2D490(&StringLiteral_20317/*"img_bg_spsummon"*/);
  ...
  if ( (unsigned int)(kind - 2) > 0x15 )
    ...
    v4 = (System_String_o **)*(&off_46513C0 + kind - 2);
  return *v4;
}
        ...
        const MethodInfo *method)
{
  ...
  ItemEntity_o *v61; // x8
  ShopCurrencyInfoController_OverCurrencyInfoObject_o *v62; // x26
  int32_t id; // w25
  UILabel_o *v64; // x25
  int32_t v65; // w26
  UISprite_o *v66; // x20
  ...
  ShopCurrencyInfoController_o *v70; // x0
  ...
  if ( ((unsigned __int8)gameObject & 1) != 0 )
  {
    ...
    *p_baseAtlas = mAtlas;
    sub_1C2D434((CGThumbnailListItem_o *)&this->fields.baseAtlas, (int32_t)mAtlas, v16, v17);
  }
        ...
        if ( EntityList )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !overCurrencyInfos )
              break;
            v60 = overCurrencyInfos->max_length;
            if ( (int)v58 >= (int)v60 )
              return;
            if ( v58 >= max_length )
              goto LABEL_117;
            v61 = EntityList->m_Items[v58];
            if ( !v61 )
              goto LABEL_116;
            if ( v58 >= v60 )
LABEL_117:
              sub_1C2D6F4(gameObject, v8, v55);
            v62 = overCurrencyInfos->m_Items[v58];
            if ( !v62 )
              break;
            gameObject = v62->fields.itemIcon;
            if ( !gameObject )
              break;
            id = v61->fields.id;
            ItemIconComponent__SetItem((ItemIconComponent_o *)gameObject, id, -1, 1, 0);
            gameObject = v62->fields.currencySprite;
            if ( !gameObject )
              break;
            ...
            if ( !gameObject )
              break;
            UISprite__set_spriteName((UISprite_o *)gameObject, v57, 0);
            if ( !NetworkManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
            if ( !byte_4C211E1 )
            {
            ...
            if ( !gameObject )
              break;
            v64 = v62->fields.currencyLabel;
            v65 = *((_DWORD *)gameObject + 7);
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            gameObject = LocalizationManager__GetNumberFormat(v65, 0);
            if ( !v64 )
              break;
...
LABEL_48:
    ...
    case 16:
      ...
      if ( !AtlasManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
      v27 = v26;
      v28 = (System_String_o *)StringLiteral_20309/*"img_bg_pp"*/;
LABEL_51:
      AtlasManager__SetShopBanner_40386924(v27, v28, 0);
      goto LABEL_55;
  }
...
LABEL_55:
  ...
  v73.fields.x = p_currencySpritePosTypeA->fields.x;
  v73.fields.y = *p_y;
  v73.fields.z = *p_z;
  UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)gameObject, v73, 0);
  gameObject = this->fields.currencySprite;
  if ( !gameObject )
    goto LABEL_116;
  ...
  if ( !UnityEngine_Object__op_Equality(itemInfo1, 0, 0) )
  {
    ...
    if ( !UnityEngine_Object__op_Equality(itemInfo2, 0, 0) )
    {
      ...
      GameObjectExtensions__SetLocalPosition_35918496(this->fields.itemInfo1, 0.0, 0.0, 0);
      ...
      if ( v45 )
      {
        GameObjectExtensions__SetLocalPosition_35918496(this->fields.itemInfo1, -90.0, 0.0, 0);
        GameObjectExtensions__SetLocalPosition_35918496(this->fields.itemInfo2, 90.0, 0.0, 0);
        switch ( v43 )
        {
          case 0:
          case 6:
...
LABEL_111:
            ...
            if ( !gameObject )
              goto LABEL_116;
            v70 = (ShopCurrencyInfoController_o *)(*(__int64 (__fastcall **)(void *, _QWORD))(*(_QWORD *)gameObject
                                                                                            + 840LL))(
                                                    gameObject,
                                                    *(_QWORD *)(*(_QWORD *)gameObject + 848LL));
            currencyLabel2 = this->fields.currencyLabel2;
            gameObject = ShopCurrencyInfoController__GetCurrencyNumber(v70, v51, v72);
            if ( !currencyLabel2 )
              goto LABEL_116;
          ...
          case 3:
            ...
            v67 = ShopCurrencyInfoController__GetCurrencySprite(v46, 17, v47);
            if ( !AtlasManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
            AtlasManager__SetShopBanner_40386924(v66, v67, 0);
            v51 = 17;
            goto LABEL_111;
          case 4:
            v68 = this->fields.currencySprite2;
            v69 = ShopCurrencyInfoController__GetCurrencySprite(v46, 19, v47);
            if ( !AtlasManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
            AtlasManager__SetShopBanner_40386924(v68, v69, 0);
            v51 = 19;
            goto LABEL_111;
          default:
            return;
        ...
        const MethodInfo *method)
{
  ...
  EventItemDisplayEntity_o *v21; // x8
...
LABEL_108:
  ...
  this->fields.kind = kind;
  gameObject = (EventItemComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !gameObject )
    goto LABEL_109;
  gameObject = (EventItemComponent_o *)DataManager__GetMasterData_object_(
                                         (DataManager_o *)gameObject,
                                         (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_EventItemDisplayMaster___);
  if ( !gameObject )
    goto LABEL_109;
  ...
  if ( max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      if ( v20 >= max_length )
LABEL_110:
        sub_1C2D6F4(gameObject, targetId, v18);
      v21 = ListByEventIdAndScreenFlag->m_Items[v20];
      if ( !v21 )
        break;
      if ( v21->fields.pointType == 1 )
      {
        if ( !v17 )
          break;
        targetId = (const MethodInfo *)(unsigned int)v21->fields.targetId;
...
LABEL_109:
    sub_1C2D6EC(gameObject, targetId);
  }
LABEL_25:
  if ( isEventShop )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23556 & 1) == 0 )
  {
    this = (ShopCurrencyInfoController_o *)sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C23556 = 1;
  }
  v6 = 160;
  if ( isLimitOver )
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v5->fields.eventItemTimeLabel, (int32_t)v7, (int32_t)method, v3);
  v11 = 168;
  if ( isLimitOver )
    v11 = 184;
  ...
  sub_1C2D434(p_eventItemRestLabel, (int32_t)v12, v9, v10);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C23555 & 1) == 0 )
  {
    this = (ShopCurrencyInfoController_o *)sub_1C2D490(&StringLiteral_15189/*"UpdateRemainTime"*/);
    byte_4C23555 = 1;
  }
  v7 = 160;
  if ( isLimitOver )
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&v6->fields.eventItemTimeLabel, (int32_t)v8, isLimitOver, method);
  v11 = 168;
  if ( isLimitOver )
    v11 = 184;
  v12 = *(struct UILabel_o **)((char *)&v6->klass + v11);
  v6->fields.eventItemRestLabel = v12;
  sub_1C2D434((CGThumbnailListItem_o *)&v6->fields.eventItemRestLabel, (int32_t)v12, v9, v10);
  ...
  UnityEngine_MonoBehaviour__CancelInvoke_71148584(
    ...
    (System_String_o *)StringLiteral_15189/*"UpdateRemainTime"*/,
    0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2355A & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_System_Linq_Enumerable_Max_ShopEntity___);
    sub_1C2D490(&System_Func_ShopEntity__long__TypeInfo);
    sub_1C2D490(&LocalizationManager_TypeInfo);
    sub_1C2D490(&NetworkManager_TypeInfo);
    sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C2D490(&Method_ShopCurrencyInfoController___c__SetEventItemRestTimeLabels_b__51_0__);
    sub_1C2D490(&ShopCurrencyInfoController___c_TypeInfo);
  ...
  if ( this->fields.isRarePriShopPurchased )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    Instance = (DataManager_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12123/*"SHOP_INDEFINITE_PERIOD"*/, 0);
    if ( !timeLabel )
      goto LABEL_50;
  }
  else
  {
    ...
    if ( !_9__51_0 )
    {
      ...
      _9__51_0 = (System_Func_object__long__o *)sub_1C2D6DC(System_Func_ShopEntity__long__TypeInfo);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__51_0, (int32_t)_9__51_0, v17, v18);
    }
    v19 = System_Linq_Enumerable__Max_object__51367112(
            EventEntitiyList,
            (System_Func_TSource__long__o *)_9__51_0,
            (const MethodInfo_30FCCC8 *)Method_System_Linq_Enumerable_Max_ShopEntity___);
...
LABEL_50:
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v23 = (System_String_o **)&StringLiteral_13413/*"TIME_REST_EVENTREWARD"*/;
  if ( v22 )
    v23 = (System_String_o **)&StringLiteral_13391/*"TIME_OVER_EVENTREWARD"*/;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.objectList, (int32_t)objectList, (int32_t)method, v3);
}
...
void ShopCurrencyInfoController__StopUpdateRemainTime(ShopCurrencyInfoController_o *this, const MethodInfo *method)
{
  if ( (byte_4C23557 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_15189/*"UpdateRemainTime"*/);
    byte_4C23557 = 1;
  }
  UnityEngine_MonoBehaviour__CancelInvoke_71148584(
...
void ShopCurrencyInfoController___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(ShopCurrencyInfoController___c_TypeInfo);
  System_Object___ctor(v1, 0);
  ShopCurrencyInfoController___c_TypeInfo->static_fields->__9 = (struct ShopCurrencyInfoController___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)ShopCurrencyInfoController___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
