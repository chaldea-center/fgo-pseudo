        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD81 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_RecommendSupportCancelConfirmDialog_EndClose__, v6);
    byte_49FAD81 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD83 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_RecommendSupportCancelConfirmDialog_OnClickCancel__, v3);
    sub_1B64A00(&Method_RecommendSupportCancelConfirmDialog___c__OnClickCancel_b__23_0__, v4);
    sub_1B64A00(&RecommendSupportCancelConfirmDialog___c_TypeInfo, v5);
    byte_49FAD83 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportCancelConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B64A18(Method_RecommendSupportCancelConfirmDialog_OnClickCancel__);
    ...
    if ( !_9__23_0 )
    {
      ...
      sub_1B649A4((ServantStatusBattleListViewItem_o *)&static_fields->__9__23_0, (int32_t)_9__23_0, v14, v15);
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64A00(&System_Action_TypeInfo, method);
    sub_1B64A00(&Method_RecommendSupportCancelConfirmDialog_OnClickDecide__, v3);
    sub_1B64A00(&Method_RecommendSupportCancelConfirmDialog___c__OnClickDecide_b__22_0__, v4);
    sub_1B64A00(&RecommendSupportCancelConfirmDialog___c_TypeInfo, v5);
    byte_49FAD82 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportCancelConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1B64A18(Method_RecommendSupportCancelConfirmDialog_OnClickDecide__);
    v7 = (System_Reflection_MethodBase_o *)sub_1B649E4(v6, v6[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FAD80 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_RecommendSupportCancelConfirmDialog__Open_b__18_0__, v6);
    sub_1B64A00(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v7);
    sub_1B64A00(&StringLiteral_10987/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_OLD_STATE"*/, v8);
    sub_1B64A00(&StringLiteral_10986/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_MESSAGE"*/, v9);
    sub_1B64A00(&StringLiteral_10984/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CURRENT_STATE"*/, v10);
    sub_1B64A00(&StringLiteral_10983/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CANCEL"*/, v11);
    sub_1B64A00(&StringLiteral_10988/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_TITLE"*/, v12);
    sub_1B64A00(&StringLiteral_10985/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_DECIDE"*/, v13);
    byte_49FAD80 = 1;
  }
  if ( (this->fields.state | 4) == 4 )
  {
    ...
    if ( gameObject )
    {
      ...
      sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.resultCallback, (int32_t)callback, v17, v18);
      currentSupportMemberObject = this->fields.currentSupportMemberObject;
      gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE930 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
      if ( gameObject )
      {
                        ...
                        if ( gameObject )
                        {
                          ...
                          if ( gameObject )
                          {
                            ...
                            gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                       (System_String_o *)StringLiteral_10984/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CURRENT_STATE"*/,
                                                                       0LL);
                            if ( currentSupportMemberTitleLabel )
                            {
                              ...
                              gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                         (System_String_o *)StringLiteral_10987/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_OLD_STATE"*/,
                                                                         0LL);
                              if ( oldSupportMemberTitleLabel )
                              {
                                ...
                                titleLabel = this->fields.titleLabel;
                                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                           (System_String_o *)StringLiteral_10988/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_TITLE"*/,
                                                                           0LL);
                                if ( titleLabel )
                                {
                                  ...
                                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                             (System_String_o *)StringLiteral_10986/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_MESSAGE"*/,
                                                                             0LL);
                                  if ( messageLabel )
                                  {
                                    ...
                                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                               (System_String_o *)StringLiteral_10985/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_DECIDE"*/,
                                                                               0LL);
                                    if ( decideLabel )
                                    {
                                      ...
                                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                                 (System_String_o *)StringLiteral_10983/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CANCEL"*/,
                                                                                 0LL);
                                      if ( cancelLabel )
                                      {
        ...
        const MethodInfo *method)
{
  ...
  if ( resultCallback )
  {
    ...
    sub_1B649A4(p_resultCallback, 0, (int32_t)method, v3);
...
void __fastcall RecommendSupportCancelConfirmDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49FAD85 & 1) == 0 )
  {
    sub_1B64A00(&RecommendSupportCancelConfirmDialog___c_TypeInfo, v1);
    byte_49FAD85 = 1;
  }
  v2 = (Il2CppObject *)sub_1B64C4C(RecommendSupportCancelConfirmDialog___c_TypeInfo);
