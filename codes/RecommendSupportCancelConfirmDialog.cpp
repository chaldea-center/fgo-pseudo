        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18311 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_RecommendSupportCancelConfirmDialog_EndClose__, v6);
    byte_4B18311 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18313 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_RecommendSupportCancelConfirmDialog_OnClickCancel__, v3);
    sub_1BCAFF8(&Method_RecommendSupportCancelConfirmDialog___c__OnClickCancel_b__23_0__, v4);
    sub_1BCAFF8(&RecommendSupportCancelConfirmDialog___c_TypeInfo, v5);
    byte_4B18313 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportCancelConfirmDialog_OnClickCancel__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1BCB010(Method_RecommendSupportCancelConfirmDialog_OnClickCancel__);
    ...
    if ( !_9__23_0 )
    {
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__23_0, (int32_t)_9__23_0, v14, v15);
    }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&System_Action_TypeInfo, method);
    sub_1BCAFF8(&Method_RecommendSupportCancelConfirmDialog_OnClickDecide__, v3);
    sub_1BCAFF8(&Method_RecommendSupportCancelConfirmDialog___c__OnClickDecide_b__22_0__, v4);
    sub_1BCAFF8(&RecommendSupportCancelConfirmDialog___c_TypeInfo, v5);
    byte_4B18312 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_RecommendSupportCancelConfirmDialog_OnClickDecide__ + 83) & 2) != 0 )
      v6 = (_QWORD *)sub_1BCB010(Method_RecommendSupportCancelConfirmDialog_OnClickDecide__);
    v7 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v6, v6[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B18310 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_RecommendSupportCancelConfirmDialog__Open_b__18_0__, v6);
    sub_1BCAFF8(&Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__, v7);
    sub_1BCAFF8(&StringLiteral_10964/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_OLD_STATE"*/, v8);
    sub_1BCAFF8(&StringLiteral_10963/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_MESSAGE"*/, v9);
    sub_1BCAFF8(&StringLiteral_10961/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CURRENT_STATE"*/, v10);
    sub_1BCAFF8(&StringLiteral_10960/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CANCEL"*/, v11);
    sub_1BCAFF8(&StringLiteral_10965/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_TITLE"*/, v12);
    sub_1BCAFF8(&StringLiteral_10962/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_DECIDE"*/, v13);
    byte_4B18310 = 1;
  }
  if ( (this->fields.state | 4) == 4 )
  {
    ...
    if ( gameObject )
    {
      ...
      sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.resultCallback, (int32_t)callback, v17, v18);
      currentSupportMemberObject = this->fields.currentSupportMemberObject;
      gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
      if ( gameObject )
      {
        ...
        if ( v20 )
        {
          ...
          if ( gameObject )
          {
            if ( v21 )
            {
              ...
              if ( !gameObject )
                goto LABEL_34;
              v25 = *(_QWORD *)&gameObject[4].fields.m_CachedPtr;
              if ( !v25 )
                goto LABEL_34;
              v26 = *(_QWORD *)(v25 + 24);
              gameObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38F8AD8 *)Method_SingletonMonoBehaviour_RecommendSupportSelectControl__get_Instance__);
              if ( !gameObject || !v26 )
                goto LABEL_34;
              v27 = SLODWORD(gameObject[5].klass);
              if ( (unsigned int)v27 >= *(_DWORD *)(v26 + 24) )
LABEL_35:
                sub_1BCB25C(gameObject, v15, v22);
              if ( oldSupportMemberObject )
              {
                RecommendSupportListViewItemDraw__SetConfirmItem(
                  oldSupportMemberObject,
                  *(RecommendSupportData_RecommendDeckData_o **)(v26 + 8 * v27 + 32),
                  0LL);
                        ...
                        if ( gameObject )
                        {
                          ...
                          if ( gameObject )
                          {
                            ...
                            gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                       (System_String_o *)StringLiteral_10961/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CURRENT_STATE"*/,
                                                                       0LL);
                            if ( currentSupportMemberTitleLabel )
                            {
                              ...
                              gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                         (System_String_o *)StringLiteral_10964/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_OLD_STATE"*/,
                                                                         0LL);
                              if ( oldSupportMemberTitleLabel )
                              {
                                ...
                                titleLabel = this->fields.titleLabel;
                                gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                           (System_String_o *)StringLiteral_10965/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_TITLE"*/,
                                                                           0LL);
                                if ( titleLabel )
                                {
                                  ...
                                  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                             (System_String_o *)StringLiteral_10963/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_MESSAGE"*/,
                                                                             0LL);
                                  if ( messageLabel )
                                  {
                                    ...
                                    gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                               (System_String_o *)StringLiteral_10962/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_DECIDE"*/,
                                                                               0LL);
                                    if ( decideLabel )
                                    {
                                      ...
                                      gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get(
                                                                                 (System_String_o *)StringLiteral_10960/*"RECOMMEND_SUPPORT_SELECT_CANCEL_CONFIRM_CANCEL"*/,
                                                                                 0LL);
                                      if ( cancelLabel )
                                      {
                                        ...
                                        if ( gameObject )
                                        {
                                          v34 = UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0LL);
                                          AndroidBackKeyManager__AddBackBtn(v34, 0LL);
                                          this->fields.state = 1;
                                          ...
                                          System_Action___ctor(
                                            ...
                                            0LL);
                                          BaseDialog__Open((BaseDialog_o *)this, v35, 1, 0LL);
                                          return;
                                        }
                                      }
                                    }
        ...
        const MethodInfo *method)
{
  ...
  if ( resultCallback )
  {
    ...
    sub_1BCAF9C(p_resultCallback, 0, (int32_t)method, v3);
...
void __fastcall RecommendSupportCancelConfirmDialog___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B183F3 & 1) == 0 )
  {
    sub_1BCAFF8(&RecommendSupportCancelConfirmDialog___c_TypeInfo, v1);
    byte_4B183F3 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(RecommendSupportCancelConfirmDialog___c_TypeInfo);
