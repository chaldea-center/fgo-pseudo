        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEEACA & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_22748/*"overwriteCondNum"*/);
    sub_1C7BAE8(&StringLiteral_22749/*"overwriteCondTargetId"*/);
    sub_1C7BAE8(&StringLiteral_22750/*"overwriteCondType"*/);
    sub_1C7BAE8(&StringLiteral_22770/*"overwriteImageId"*/);
    byte_4CEEACA = 1;
  }
  Script = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22750/*"overwriteCondType"*/, 0, v3);
  v8 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22749/*"overwriteCondTargetId"*/, 0, v7);
  v10 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22748/*"overwriteCondNum"*/, 0, v9);
  if ( !CondType_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
  if ( CondType__IsOpen(Script, v8, v10, 0, 0, 0) )
    return HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22770/*"overwriteImageId"*/, 0, v11);
  else
        ...
        const MethodInfo *method)
{
  ...
  if ( !CondType_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
  if ( CondType__IsOpen(Script, v8, v10, 0, 0, 0) )
    return HeelPortraitEntity__getScriptStr(this, (System_String_o *)StringLiteral_22779/*"overwriteName"*/, 0, v11);
  else
    return originName;
}
...
bool HeelPortraitEntity__IsSetOverwriteImageId(HeelPortraitEntity_o *this, const MethodInfo *method)
{
  ...
  return HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22770/*"overwriteImageId"*/, 0, v2) != 0;
}
...
bool HeelPortraitEntity__IsSetOverwriteName(HeelPortraitEntity_o *this, const MethodInfo *method)
{
  ...
  ScriptStr = HeelPortraitEntity__getScriptStr(this, (System_String_o *)StringLiteral_22779/*"overwriteName"*/, 0, v2);
