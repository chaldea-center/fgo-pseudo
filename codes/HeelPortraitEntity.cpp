        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0235F & 1) == 0 )
  {
    sub_1BC3008(&CondType_TypeInfo, *(_QWORD *)&originImageId);
    sub_1BC3008(&StringLiteral_22319/*"overwriteCondNum"*/, v6);
    sub_1BC3008(&StringLiteral_22320/*"overwriteCondTargetId"*/, v7);
    sub_1BC3008(&StringLiteral_22321/*"overwriteCondType"*/, v8);
    sub_1BC3008(&StringLiteral_22335/*"overwriteImageId"*/, v9);
    byte_4B0235F = 1;
  }
  Script = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22321/*"overwriteCondType"*/, 0, v3);
  v12 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22320/*"overwriteCondTargetId"*/, 0, v11);
  v14 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22319/*"overwriteCondNum"*/, 0, v13);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B0235D & 1) == 0 )
  {
    sub_1BC3008(&CondType_TypeInfo, originName);
    sub_1BC3008(&StringLiteral_22319/*"overwriteCondNum"*/, v6);
    sub_1BC3008(&StringLiteral_22320/*"overwriteCondTargetId"*/, v7);
    sub_1BC3008(&StringLiteral_22344/*"overwriteName"*/, v8);
    sub_1BC3008(&StringLiteral_22321/*"overwriteCondType"*/, v9);
    byte_4B0235D = 1;
  }
  Script = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22321/*"overwriteCondType"*/, 0, v3);
  v12 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22320/*"overwriteCondTargetId"*/, 0, v11);
  ...
  if ( !CondType_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
  if ( CondType__IsOpen(Script, v12, v14, 0, 0LL, 0LL) )
    return HeelPortraitEntity__getScriptStr(this, (System_String_o *)StringLiteral_22344/*"overwriteName"*/, 0LL, v15);
  else
    return originName;
}
...
bool __fastcall HeelPortraitEntity__IsSetOverwriteImageId(HeelPortraitEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0235E & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_22335/*"overwriteImageId"*/, method);
    byte_4B0235E = 1;
  }
...
bool __fastcall HeelPortraitEntity__IsSetOverwriteName(HeelPortraitEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B0235C & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_22344/*"overwriteName"*/, method);
    byte_4B0235C = 1;
  }
  ScriptStr = HeelPortraitEntity__getScriptStr(this, (System_String_o *)StringLiteral_22344/*"overwriteName"*/, 0LL, v2);
