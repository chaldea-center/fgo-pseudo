        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B44DAD & 1) == 0 )
  {
    sub_1BDB878(&CondType_TypeInfo, *(_QWORD *)&originImageId);
    sub_1BDB878(&StringLiteral_22558/*"overwriteCondNum"*/, v6);
    sub_1BDB878(&StringLiteral_22559/*"overwriteCondTargetId"*/, v7);
    sub_1BDB878(&StringLiteral_22560/*"overwriteCondType"*/, v8);
    sub_1BDB878(&StringLiteral_22573/*"overwriteImageId"*/, v9);
    byte_4B44DAD = 1;
  }
  Script = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22560/*"overwriteCondType"*/, 0, v3);
  v12 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22559/*"overwriteCondTargetId"*/, 0, v11);
  v14 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22558/*"overwriteCondNum"*/, 0, v13);
  if ( !CondType_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
  if ( CondType__IsOpen(Script, v12, v14, 0, 0LL, 0LL) )
    return HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22573/*"overwriteImageId"*/, 0, v15);
  else
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B44DAB & 1) == 0 )
  {
    sub_1BDB878(&CondType_TypeInfo, originName);
    sub_1BDB878(&StringLiteral_22558/*"overwriteCondNum"*/, v6);
    sub_1BDB878(&StringLiteral_22559/*"overwriteCondTargetId"*/, v7);
    sub_1BDB878(&StringLiteral_22582/*"overwriteName"*/, v8);
    sub_1BDB878(&StringLiteral_22560/*"overwriteCondType"*/, v9);
    byte_4B44DAB = 1;
  }
  Script = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22560/*"overwriteCondType"*/, 0, v3);
  v12 = HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22559/*"overwriteCondTargetId"*/, 0, v11);
  ...
  if ( !CondType_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
  if ( CondType__IsOpen(Script, v12, v14, 0, 0LL, 0LL) )
    return HeelPortraitEntity__getScriptStr(this, (System_String_o *)StringLiteral_22582/*"overwriteName"*/, 0LL, v15);
  else
    return originName;
}
...
bool __fastcall HeelPortraitEntity__IsSetOverwriteImageId(HeelPortraitEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B44DAC & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22573/*"overwriteImageId"*/, method);
    byte_4B44DAC = 1;
  }
  return HeelPortraitEntity__getScript(this, (System_String_o *)StringLiteral_22573/*"overwriteImageId"*/, 0, v2) != 0;
}
...
bool __fastcall HeelPortraitEntity__IsSetOverwriteName(HeelPortraitEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B44DAA & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_22582/*"overwriteName"*/, method);
    byte_4B44DAA = 1;
  }
  ScriptStr = HeelPortraitEntity__getScriptStr(this, (System_String_o *)StringLiteral_22582/*"overwriteName"*/, 0LL, v2);
