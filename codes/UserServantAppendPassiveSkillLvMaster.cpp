        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__long____ctor(
    ...
    370,
    (const MethodInfo_30D62EC *)Method_DataMasterBase_UserServantAppendPassiveSkillLvMaster__UserServantAppendPassiveSkillLvEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF294 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMaster_UserServantMaster___, userId);
    ...
    sub_1B64870(
      ...
      v7);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__int__Add__, v8);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__int__TryGetValue__, v9);
    sub_1B64870(&Method_System_Collections_Generic_Dictionary_int__int___ctor__, v10);
    ...
    sub_1B64870(&Method_System_Collections_Generic_List_long__GetEnumerator__, v16);
    byte_49FF294 = 1;
  }
  entity = 0LL;
  memset(&v38, 0, sizeof(v38));
  value = 0;
  v17 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1B64ABC(System_Collections_Generic_Dictionary_int__int__TypeInfo);
