        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__long____ctor(
    ...
    376,
    (const MethodInfo_319DBD4 *)Method_DataMasterBase_UserServantAppendPassiveSkillLvMaster__UserServantAppendPassiveSkillLvEntity__long___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBCFC & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMaster_UserServantMaster___, userId);
    ...
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_int__int__TryGetValue__, v9);
    sub_1B4CF90(&Method_System_Collections_Generic_Dictionary_int__int___ctor__, v10);
    ...
    sub_1B4CF90(&Method_System_Collections_Generic_List_long__GetEnumerator__, v16);
    byte_49BBCFC = 1;
  }
  entity = 0LL;
  memset(&v38, 0, sizeof(v38));
  value = 0;
  v17 = (System_Collections_Generic_Dictionary_int__int__o *)sub_1B4D1DC(System_Collections_Generic_Dictionary_int__int__TypeInfo);
