        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B5BEC & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_12265/*"SHOP_RETURN_EXCHANGE_ITEM"*/);
    byte_42B5BEC = 1;
  }
  if ( shopEntity )
  {
...
LABEL_25:
      ...
      v14 = LocalizationManager__Get((System_String_o *)StringLiteral_12265/*"SHOP_RETURN_EXCHANGE_ITEM"*/, 0LL);
      v15 = System_String__Format(v14, *(Il2CppObject **)(v12 + 24), 0LL);
      v16 = System_String__Concat_44568316(mText, v15, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B5BED & 1) == 0 )
  {
    sub_B52984(&UnityEngine_Object_TypeInfo);
    sub_B52984(&string_TypeInfo);
    sub_B52984(&StringLiteral_19645/*"img_icon_acquired"*/);
    byte_42B5BED = 1;
  }
  if ( shopEntity )
  {
...
LABEL_21:
      ...
      if ( UnityEngine_GameObject__get_activeSelf(v7, 0LL) )
      {
        ...
        if ( ShopEntity__IsServantGet(shopEntity, v10) )
          v12 = (System_String_o *)StringLiteral_19645/*"img_icon_acquired"*/;
        else
          v12 = Empty;
