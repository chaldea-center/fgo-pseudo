void __fastcall ShopBuyItemUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A052B8 & 1) == 0 )
  {
    sub_1B686D4(&ShopBuyItemUtility_TypeInfo, v1);
    byte_4A052B8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A052B6 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_ItemMaster___, textOnMaskLabel);
    ...
    sub_1B686D4(&StringLiteral_12021/*"SHOP_RETURN_EXCHANGE_ITEM"*/, v11);
    byte_4A052B6 = 1;
  }
  if ( shopEntity )
  {
...
LABEL_22:
      ...
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_12021/*"SHOP_RETURN_EXCHANGE_ITEM"*/, 0LL);
      v20 = System_String__Format(v19, *(Il2CppObject **)(v17 + 24), 0LL);
      v21 = System_String__Concat_61419468(mText, v20, 0LL);
...
void __fastcall ShopBuyItemUtility__SetDefaultMessageLabel(UILabel_o *label, const MethodInfo *method)
{
  ...
  if ( (byte_4A052B5 & 1) == 0 )
  {
    ...
    sub_1B686D4(&ShopBuyItemUtility_TypeInfo, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A052B7 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_20253/*"img_icon_acquired"*/, v8);
    byte_4A052B7 = 1;
  }
  if ( shopEntity )
  {
    ...
    if ( ((unsigned __int8)v9 & 1) == 0 )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf(v9, 0LL) )
      {
        ...
        if ( ShopEntity__IsServantGet(shopEntity, 0LL) )
          v13 = (System_String_o *)StringLiteral_20253/*"img_icon_acquired"*/;
        else
          v13 = Empty;
