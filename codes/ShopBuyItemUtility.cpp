void __fastcall ShopBuyItemUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B78 & 1) == 0 )
  {
    sub_1C13D24(&ShopBuyItemUtility_TypeInfo, v1);
    byte_4BB0B78 = 1;
  }
  *ShopBuyItemUtility_TypeInfo->static_fields = (struct ShopBuyItemUtility_StaticFields)xmmword_BF71C0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B70 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_ItemMaster___, textOnMaskLabel);
    ...
    sub_1C13D24(&StringLiteral_12286/*"SHOP_QUEST_PAID_EXCHANGE_CLEARED"*/, v11);
    byte_4BB0B70 = 1;
  }
  if ( shopEntity )
  {
...
LABEL_26:
      ...
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_12286/*"SHOP_QUEST_PAID_EXCHANGE_CLEARED"*/, 0LL);
      v20 = System_String__Format(v19, (Il2CppObject *)v17->fields.m_CancellationTokenSource, 0LL);
      v21 = System_String__Concat_62967944(mText, v20, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B77 & 1) == 0 )
  {
    sub_1C13D24(&ShopBuyItemUtility_TypeInfo, possessionNumLabel);
    byte_4BB0B77 = 1;
  }
  ...
  {
LABEL_24:
    sub_1C13F80(gameObject, possessionNumLabel);
  }
...
void __fastcall ShopBuyItemUtility__SetDefaultMessageLabel(UILabel_o *label, const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B6F & 1) == 0 )
  {
    ...
    sub_1C13D24(&ShopBuyItemUtility_TypeInfo, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B72 & 1) == 0 )
  {
    *(_QWORD *)&svtId = sub_1C13D24(&ShopBuyItemUtility_TypeInfo, grid);
    byte_4BB0B72 = 1;
  }
  if ( v17 >= 1 && isDispFlag )
  {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B73 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMaster_UserServantMaster___, possessionNumLabel);
    sub_1C13D24(&DataManager_TypeInfo, v5);
    sub_1C13D24(&LocalizationManager_TypeInfo, v6);
    sub_1C13D24(&StringLiteral_10590/*"PLAY_TREASUREARMS"*/, v7);
    *(_QWORD *)&svtId = sub_1C13D24(&StringLiteral_11998/*"SERVANT_SORT_FILTER_SERVANT_EQUIP_TYPE_EQUIP_EXP"*/, v8);
    byte_4BB0B73 = 1;
  }
  if ( !possessionNumLabel )
    goto LABEL_14;
  ...
  *(_QWORD *)&svtId = DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_UserServantMaster___);
  if ( !*(_QWORD *)&svtId )
LABEL_14:
    sub_1C13F80(*(_QWORD *)&svtId, possessionNumLabel);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( IsServantHaving )
      goto LABEL_10;
LABEL_12:
    v14 = LocalizationManager__Get((System_String_o *)StringLiteral_11998/*"SERVANT_SORT_FILTER_SERVANT_EQUIP_TYPE_EQUIP_EXP"*/, 0LL);
    goto LABEL_13;
  }
  if ( !IsServantHaving )
    goto LABEL_12;
LABEL_10:
  v12 = LocalizationManager__Get((System_String_o *)StringLiteral_10590/*"PLAY_TREASUREARMS"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B71 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_20658/*"img_frames_mask04"*/, v8);
    byte_4BB0B71 = 1;
  }
  if ( shopEntity )
  {
    ...
    if ( ((unsigned __int8)v9 & 1) == 0 )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf(v9, 0LL) )
      {
        ...
        if ( ShopEntity__IsServantGet(shopEntity, 0LL) )
          v13 = (System_String_o *)StringLiteral_20658/*"img_frames_mask04"*/;
        else
          v13 = Empty;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B76 & 1) == 0 )
  {
    sub_1C13D24(&AtlasManager_TypeInfo, summonedSprite);
    sub_1C13D24(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v5);
    sub_1C13D24(&DataManager_TypeInfo, v6);
    sub_1C13D24(&StringLiteral_20660/*"img_frames_mask08"*/, v7);
    *(_QWORD *)&svtId = sub_1C13D24(&StringLiteral_20659/*"img_frames_mask05"*/, v8);
    byte_4BB0B76 = 1;
  }
  if ( !summonedSprite )
    goto LABEL_14;
  *(_QWORD *)&svtId = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)summonedSprite, 0LL);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  *(_QWORD *)&svtId = DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !*(_QWORD *)&svtId )
LABEL_14:
    sub_1C13F80(*(_QWORD *)&svtId, summonedSprite);
  v9 = UserServantCollectionMaster__IsGet(*(UserServantCollectionMaster_o **)&svtId, v4, 0LL);
  v10 = StringLiteral_20660/*"img_frames_mask08"*/;
  v11 = StringLiteral_20659/*"img_frames_mask05"*/;
  v12 = v9;
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&svtId = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)coinIcon, 0LL);
  ...
  if ( !byte_4BAF1E5 )
  {
    sub_1C13D24(&NetworkManager_TypeInfo, coinNumLabel);
    byte_4BAF1E5 = 1;
  }
  ...
  *(_QWORD *)&svtId = UserSvtCoinMaster__TryGetEntity(
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v15 = LocalizationManager__Get((System_String_o *)StringLiteral_7259/*"H4020"*/, 0LL);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  *(_QWORD *)&svtId = DataManager__GetMaster_object_((const MethodInfo_2F8F418 *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !*(_QWORD *)&svtId
    || (*(_QWORD *)&svtId = ItemMaster__GetServantCoinItemEntity(*(ItemMaster_o **)&svtId, v6, 0LL)) == 0LL )
  {
LABEL_29:
    sub_1C13F80(*(_QWORD *)&svtId, coinNumLabel);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0B75 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMaster_UserServantMaster___, treasureDeviceLevelLabel);
    sub_1C13D24(&DataManager_TypeInfo, v5);
    sub_1C13D24(&int_TypeInfo, v6);
    sub_1C13D24(&LocalizationManager_TypeInfo, v7);
    sub_1C13D24(&StringLiteral_8758/*"MAX_FRIEND_HISTORY_NUM"*/, v8);
    byte_4BB0B75 = 1;
  }
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v14 = LocalizationManager__Get((System_String_o *)StringLiteral_8758/*"MAX_FRIEND_HISTORY_NUM"*/, 0LL);
