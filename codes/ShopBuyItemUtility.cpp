void __fastcall ShopBuyItemUtility___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A2A57D & 1) == 0 )
  {
    sub_1B761C0(&ShopBuyItemUtility_TypeInfo, v1);
    byte_4A2A57D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A57B & 1) == 0 )
  {
    sub_1B761C0(&Method_DataManager_GetMasterData_ItemMaster___, textOnMaskLabel);
    ...
    sub_1B761C0(&StringLiteral_12067/*"SHOP_RETURN_EXCHANGE_ITEM"*/, v11);
    byte_4A2A57B = 1;
  }
  if ( shopEntity )
  {
...
LABEL_22:
      ...
      v19 = LocalizationManager__Get((System_String_o *)StringLiteral_12067/*"SHOP_RETURN_EXCHANGE_ITEM"*/, 0LL);
      v20 = System_String__Format(v19, *(Il2CppObject **)(v17 + 24), 0LL);
      v21 = System_String__Concat_61535060(mText, v20, 0LL);
...
void __fastcall ShopBuyItemUtility__SetDefaultMessageLabel(UILabel_o *label, const MethodInfo *method)
{
  ...
  if ( (byte_4A2A57A & 1) == 0 )
  {
    ...
    sub_1B761C0(&ShopBuyItemUtility_TypeInfo, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2A57C & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_20316/*"img_icon_acquired"*/, v8);
    byte_4A2A57C = 1;
  }
  if ( shopEntity )
  {
    ...
    if ( ((unsigned __int8)v9 & 1) == 0 )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf(v9, 0LL) )
      {
        ...
        if ( ShopEntity__IsServantGet(shopEntity, 0LL) )
          v13 = (System_String_o *)StringLiteral_20316/*"img_icon_acquired"*/;
        else
          v13 = Empty;
