void ShopBuyItemUtility___cctor(const MethodInfo *method)
{
  ...
  *ShopBuyItemUtility_TypeInfo->static_fields = (struct ShopBuyItemUtility_StaticFields)xmmword_D361F0;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7379E & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_12322/*"SHOP_RETURN_EXCHANGE_ITEM"*/);
    byte_4E7379E = 1;
  }
  if ( shopEntity )
  {
...
LABEL_26:
      ...
      v12 = LocalizationManager__Get((System_String_o *)StringLiteral_12322/*"SHOP_RETURN_EXCHANGE_ITEM"*/, 0);
      v13 = System_String__Format(v12, (Il2CppObject *)v10->fields.m_CancellationTokenSource, 0);
      v14 = System_String__Concat_65562772(mText, v13, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_24:
    sub_1D0F30C(gameObject, possessionNumLabel);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E737A0 & 1) == 0 )
  {
    *(_QWORD *)&svtId = sub_1D0F0B4(&ShopBuyItemUtility_TypeInfo);
    byte_4E737A0 = 1;
  }
  if ( v17 >= 1 && isDispFlag )
  {
...
void ShopBuyItemUtility__SetPossessionNumLabel(int32_t svtId, UILabel_o *possessionNumLabel, const MethodInfo *method)
{
  ...
  if ( (byte_4E737A1 & 1) == 0 )
  {
    ...
    *(_QWORD *)&svtId = sub_1D0F0B4(&StringLiteral_12014/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/);
    byte_4E737A1 = 1;
  }
  if ( !possessionNumLabel )
    goto LABEL_14;
  ...
  *(_QWORD *)&svtId = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserServantMaster___);
  if ( !*(_QWORD *)&svtId )
LABEL_14:
    sub_1D0F30C(*(_QWORD *)&svtId, possessionNumLabel);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    if ( IsServantHaving )
      goto LABEL_10;
LABEL_12:
    v10 = LocalizationManager__Get((System_String_o *)StringLiteral_12014/*"SERVANT_SORT_FILTER_SERVANT_NOT_HAVE"*/, 0);
    goto LABEL_13;
  }
  if ( !IsServantHaving )
    goto LABEL_12;
LABEL_10:
  v8 = LocalizationManager__Get((System_String_o *)StringLiteral_10549/*"POSSESSION_NUM"*/, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E7379F & 1) == 0 )
  {
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&string_TypeInfo);
    sub_1D0F0B4(&StringLiteral_20802/*"img_icon_acquired"*/);
    byte_4E7379F = 1;
  }
  if ( shopEntity )
  {
    ...
    if ( ((unsigned __int8)v7 & 1) == 0 )
    {
      ...
      if ( UnityEngine_GameObject__get_activeSelf(v7, 0) )
      {
        ...
        if ( ShopEntity__IsServantGet(shopEntity, 0) )
          v11 = (System_String_o *)StringLiteral_20802/*"img_icon_acquired"*/;
        else
          v11 = Empty;
...
void ShopBuyItemUtility__SetSummonedIcon(int32_t svtId, UISprite_o *summonedSprite, const MethodInfo *method)
{
  ...
  if ( (byte_4E737A4 & 1) == 0 )
  {
    ...
    *(_QWORD *)&svtId = sub_1D0F0B4(&StringLiteral_20803/*"img_icon_not_summoned"*/);
    byte_4E737A4 = 1;
  }
  if ( !summonedSprite )
    goto LABEL_14;
  *(_QWORD *)&svtId = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)summonedSprite, 0);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  *(_QWORD *)&svtId = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  if ( !*(_QWORD *)&svtId )
LABEL_14:
    sub_1D0F30C(*(_QWORD *)&svtId, summonedSprite);
  v5 = UserServantCollectionMaster__IsGet(*(UserServantCollectionMaster_o **)&svtId, v4, 0);
  v6 = StringLiteral_20804/*"img_icon_summoned"*/;
  v7 = StringLiteral_20803/*"img_icon_not_summoned"*/;
  v8 = v5;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E737A2 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    *(_QWORD *)&svtId = sub_1D0F0B4(&StringLiteral_7275/*"HAVE_MULTIPLE_INFO"*/);
    byte_4E737A2 = 1;
  }
  entity = 0;
  if ( !coinNumLabel )
  ...
  *(_QWORD *)&svtId = UserSvtCoinMaster__TryGetEntity(
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v9 = LocalizationManager__Get((System_String_o *)StringLiteral_7275/*"HAVE_MULTIPLE_INFO"*/, 0);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  *(_QWORD *)&svtId = DataManager__GetMaster_object_((const MethodInfo_324F164 *)Method_DataManager_GetMaster_ItemMaster___);
  if ( !*(_QWORD *)&svtId
    || (*(_QWORD *)&svtId = ItemMaster__GetServantCoinItemEntity(*(ItemMaster_o **)&svtId, v6, 0)) == 0 )
  {
LABEL_29:
    sub_1D0F30C(*(_QWORD *)&svtId, coinNumLabel);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  v10 = LocalizationManager__Get((System_String_o *)StringLiteral_8719/*"MAX_NP_LEVEL"*/, 0);
