        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40F93EB & 1) == 0 )
  {
    sub_B16FFC(&Method_DataManager_GetMaster_SkillMaster___, title);
  ...
  if ( Entity )
  {
    ...
    *title = EffectTitle;
    sub_B16F98((BattleServantConfConponent_o *)title, (System_Int32_array **)EffectTitle, v24, v25, v26, v27, v28, v29);
