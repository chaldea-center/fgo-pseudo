...
void EventInfoPassportDialog__OnClose(EventInfoPassportDialog_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59399BF & 1) == 0 )
  {
    ...
    sub_21FFC50(&Method_EventInfoPassportDialog_OnClose__);
    sub_21FFC50(&Method_EventInfoPassportDialog__OnClose_b__8_0__);
  ...
  if ( BaseDialog__IsInputState((BaseDialog_o *)this, 0) )
  {
    ...
    if ( (*((_BYTE *)Method_EventInfoPassportDialog_OnClose__ + 83) & 2) != 0 )
      v8 = (_QWORD *)sub_21FFC68(Method_EventInfoPassportDialog_OnClose__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59399BE & 1) == 0 )
  {
    ...
    sub_21FFC50(&UnityEngine_Object_TypeInfo);
    sub_21FFC50(&Method_EventInfoPassportDialog___c__Open_b__7_0__);
    sub_21FFC50(&EventInfoPassportDialog___c_TypeInfo);
    sub_21FFC50(&StringLiteral_10734/*"PASSPORT_DIALOG_INFO"*/);
    sub_21FFC50(&StringLiteral_10735/*"PASSPORT_DIALOG_TITLE"*/);
    byte_59399BE = 1;
  }
  ...
  if ( !_9__7_0 )
  {
    ...
    sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v18->__9__7_0, (int32_t)_9__7_0, v19, v20, v21, v22, v23, v24);
  }
  ...
  passportListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10735/*"PASSPORT_DIALOG_TITLE"*/, 0);
  if ( !titleLabel
    || (UILabel__set_text(titleLabel, passportListViewManager, 0),
        infoLabel = this->fields.infoLabel,
        passportListViewManager = LocalizationManager__Get((System_String_o *)StringLiteral_10734/*"PASSPORT_DIALOG_INFO"*/, 0),
        !infoLabel)
  ...
  {
    sub_21FFECC(passportListViewManager, v28);
  }
...
void EventInfoPassportDialog___OnClose_b__8_0(EventInfoPassportDialog_o *this, const MethodInfo *method)
{
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&this->fields.onClosed, 0, v3, v4, v5, v6, v7, v8);
...
void EventInfoPassportDialog___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_21FFEBC(EventInfoPassportDialog___c_TypeInfo);
