void __fastcall ServantFilterMaster___ctor(ServantFilterMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4B4534B & 1) == 0 )
  {
    sub_1BDB878(&Method_DataMasterBase_ServantFilterMaster__ServantFilterEntity__int___ctor__, method);
    byte_4B4534B = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    208,
    (const MethodInfo_32DFB18 *)Method_DataMasterBase_ServantFilterMaster__ServantFilterEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( DataMasterBase_object__object__int___TryGetEntity(
         ...
         &entity,
         id,
         (const MethodInfo_32E1E88 *)Method_DataMasterBase_ServantFilterMaster__ServantFilterEntity__int__TryGetEntity__) )
  {
    if ( !entity )
      sub_1BDBAD4(0LL, v8);
...
bool __fastcall ServantFilterMaster__IsEnableServant_41635308(
        ServantFilterMaster_o *this,
        CodeStage_AntiCheat_ObscuredTypes_ObscuredInt_o svtId,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4534E & 1) == 0 )
  {
    this = (ServantFilterMaster_o *)sub_1BDB878(
  ...
  if ( (int)v8 >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      this = (ServantFilterMaster_o *)DataMasterBase_object__object__int___GetEntity(
                                        v7,
                                        ids->m_Items[v10 + 1],
                                        (const MethodInfo_32E1E3C *)Method_DataMasterBase_ServantFilterMaster__ServantFilterEntity__int__GetEntity__);
      if ( !this )
        break;
      *(_QWORD *)&v13.fields.currentCryptoKey = v6;
      *(_QWORD *)&v13.fields.fakeValue = v5;
...
LABEL_12:
    sub_1BDBAD4(this, *(_QWORD *)&svtId.fields.currentCryptoKey);
  }
  return v9;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4534C & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_ServantFilterEntity__get_Count__, method);
    sub_1BDB878(&Method_System_Collections_ObjectModel_Collection_ServantFilterEntity__get_Item__, v3);
    sub_1BDB878(&System_Comparison_ServantFilterEntity__TypeInfo, v4);
    sub_1BDB878(&int___TypeInfo, v5);
    sub_1BDB878(&Method_System_Collections_Generic_List_ServantFilterEntity__Add__, v6);
    sub_1BDB878(&Method_System_Collections_Generic_List_ServantFilterEntity__Sort__, v7);
    sub_1BDB878(&Method_System_Collections_Generic_List_ServantFilterEntity___ctor__, v8);
    sub_1BDB878(&Method_System_Collections_Generic_List_ServantFilterEntity__get_Count__, v9);
    sub_1BDB878(&Method_System_Collections_Generic_List_ServantFilterEntity__get_Item__, v10);
    sub_1BDB878(&System_Collections_Generic_List_ServantFilterEntity__TypeInfo, v11);
    sub_1BDB878(&NetworkManager_TypeInfo, v12);
    sub_1BDB878(&Method_ServantFilterMaster___c__getEnableIdList_b__1_0__, v13);
    sub_1BDB878(&ServantFilterMaster___c_TypeInfo, v14);
    byte_4B4534C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  Time = NetworkManager__getTime(0LL);
  v16 = (System_Collections_Generic_List_object__o *)sub_1BDBAC4(System_Collections_Generic_List_ServantFilterEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v16,
    (const MethodInfo_36D5590 *)Method_System_Collections_Generic_List_ServantFilterEntity___ctor__);
  list = (System_Collections_ObjectModel_Collection_T__o *)this->fields.list;
  if ( !list )
    goto LABEL_33;
  list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Count(
                                                             list,
                                                             (const MethodInfo_327D624 *)Method_System_Collections_ObjectModel_Collection_ServantFilterEntity__get_Count__);
  if ( (int)list >= 1 )
  {
    v19 = (int)list;
    v20 = 0;
    while ( 1 )
    {
      ...
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_ObjectModel_Collection_object___get_Item(
                                                                 list,
                                                                 v20,
                                                                 (const MethodInfo_327D6B4 *)Method_System_Collections_ObjectModel_Collection_ServantFilterEntity__get_Item__);
      if ( !list )
        break;
...
LABEL_17:
  ...
  if ( (int)v29 >= 1 )
  {
    ...
    if ( !_9__1_0 )
    {
      ...
      _9__1_0 = (System_Comparison_T__o *)sub_1BDBAC4(System_Comparison_ServantFilterEntity__TypeInfo);
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)&static_fields->__9__1_0, (int32_t)_9__1_0, v34, v35);
    }
    System_Collections_Generic_List_object___Sort_57505928(
      v16,
      _9__1_0,
      (const MethodInfo_36D7888 *)Method_System_Collections_Generic_List_ServantFilterEntity__Sort__);
    v36 = (System_Int32_array *)sub_1BDB920(int___TypeInfo, (unsigned int)v29);
    v37 = 0LL;
    while ( 1 )
    {
      list = (System_Collections_ObjectModel_Collection_T__o *)System_Collections_Generic_List_object___get_Item(
                                                                 v16,
                                                                 v37,
                                                                 (const MethodInfo_36D5AF4 *)Method_System_Collections_Generic_List_ServantFilterEntity__get_Item__);
      if ( !list || !v36 )
        break;
      if ( v37 >= v36->max_length )
        sub_1BDBADC(list, v17, v38);
...
void __fastcall ServantFilterMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B4534F & 1) == 0 )
  {
    sub_1BDB878(&ServantFilterMaster___c_TypeInfo, v1);
    byte_4B4534F = 1;
  }
  v2 = (Il2CppObject *)sub_1BDBAC4(ServantFilterMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  ServantFilterMaster___c_TypeInfo->static_fields->__9 = (struct ServantFilterMaster___c_o *)v2;
  sub_1BDB81C((CGThumbnailListItem_o *)ServantFilterMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
