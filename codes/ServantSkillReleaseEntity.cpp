        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_597130F & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_ServantSkillReleaseEntity___c__IsUseInternal_b__12_0__);
    sub_2213A60(&ServantSkillReleaseEntity___c_TypeInfo);
    byte_597130F = 1;
  }
  value = 0;
      ...
      if ( userSvtId < 1 || !IsLimitCountCondType )
      {
        if ( currentCondType == 113 )
        {
          ...
          if ( Master_object )
          {
            ...
            v24 = (System_Collections_Generic_Dictionary_int__bool__o *)sub_2213CCC(System_Collections_Generic_Dictionary_int__bool__TypeInfo);
...
void ServantSkillReleaseEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_2213CCC(ServantSkillReleaseEntity___c_TypeInfo);
