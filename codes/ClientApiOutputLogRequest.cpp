        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188802 & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_17487/*"code"*/, title);
    sub_B2C35C(&StringLiteral_22703/*"title"*/, v9);
    sub_B2C35C(&StringLiteral_20604/*"msg"*/, v10);
    byte_4188802 = 1;
  }
  RequestBase__addField_31051928((RequestBase_o *)this, (System_String_o *)StringLiteral_22703/*"title"*/, title, 0LL);
  RequestBase__addField_31051928((RequestBase_o *)this, (System_String_o *)StringLiteral_20604/*"msg"*/, message, 0LL);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_17487/*"code"*/, code, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188800 & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_4034/*"ClientApi/OutputLog"*/, v2);
    byte_4188800 = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_4034/*"ClientApi/OutputLog"*/, 0LL);
}
