        ...
        const MethodInfo *method)
{
  ...
  sub_1C21DDC(&this->fields.changeName, inputName);
  if ( System_String__IsNullOrEmpty(this->fields.changeName, 0LL) )
    goto LABEL_7;
  decideButton = *p_changeName;
  if ( !*p_changeName )
    goto LABEL_19;
  v8 = System_String__Trim(decideButton, 0LL);
...
LABEL_19:
  ...
  v14 = System_String__Trim(decideButton, 0LL);
  v9 = !System_String__IsNullOrEmpty(v14, 0LL);
LABEL_8:
...
void __fastcall DeckNameInputMenu__Close(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  DeckNameInputMenu__Close_32806168(this, 0LL, v2);
}


void __fastcall DeckNameInputMenu__Close_32806168(
        DeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD802B & 1) == 0 )
  {
    ...
    sub_1C21E38(&Method_DeckNameInputMenu_EndClose__);
    byte_4BD802B = 1;
  }
  ...
  System_Action___ctor(v7, (Il2CppObject *)this, Method_DeckNameInputMenu_EndClose__, 0LL);
...
void __fastcall DeckNameInputMenu__OnClickCancel(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD802D & 1) == 0 )
  {
    sub_1C21E38(&Method_DeckNameInputMenu_OnClickCancel__);
    sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BD802D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_DeckNameInputMenu_OnClickCancel__);
...
void __fastcall DeckNameInputMenu__OnClickClear(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD802E & 1) == 0 )
  {
    sub_1C21E38(&Method_DeckNameInputMenu_OnClickClear__);
    sub_1C21E38(&StringLiteral_1/*""*/);
    byte_4BD802E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_DeckNameInputMenu_OnClickClear__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
...
void __fastcall DeckNameInputMenu__OnClickDecide(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD802C & 1) == 0 )
  {
    sub_1C21E38(&Method_DeckNameInputMenu_OnClickDecide__);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    byte_4BD802C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_DeckNameInputMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
...
void __fastcall DeckNameInputMenu__OnClickInit(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BD802F & 1) == 0 )
  {
    sub_1C21E38(&Method_DeckNameInputMenu_OnClickInit__);
    byte_4BD802F = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C21E50(Method_DeckNameInputMenu_OnClickInit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C21E1C(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    inputTarget = this->fields.inputTarget;
    if ( !inputTarget )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8028 & 1) == 0 )
  {
    sub_1C21E38(&System_Action_TypeInfo);
    sub_1C21E38(&Method_UnityEngine_Component_GetComponent_Collider___);
    sub_1C21E38(&Method_DeckNameInputMenu_EndOpen__);
    sub_1C21E38(&Method_EmojiUtility_ValidateNameText__);
    sub_1C21E38(&LocalizationManager_TypeInfo);
    sub_1C21E38(&UIInput_OnValidate_TypeInfo);
    sub_1C21E38(&StringLiteral_10477/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_TITLE"*/);
    sub_1C21E38(&StringLiteral_3812/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C21E38(&StringLiteral_10481/*"PARTY_ORGANIZATION_NAME_INIT"*/);
    sub_1C21E38(&StringLiteral_3810/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C21E38(&StringLiteral_10476/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_EXPLANATION"*/);
    sub_1C21E38(&StringLiteral_10480/*"PARTY_ORGANIZATION_NAME_CLEAR"*/);
    byte_4BD8028 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  sub_1C21DDC(&this->fields.changeName, deckName);
  this->fields.baseName = deckName;
  sub_1C21DDC(&this->fields.baseName, deckName);
  this->fields.initName = initName;
  sub_1C21DDC(&this->fields.initName, initName);
  this->fields.callbackFunc = callback;
  sub_1C21DDC(&this->fields.callbackFunc, callback);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10477/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10476/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0LL);
  inputTarget = this->fields.inputTarget;
  v14 = (UIInput_OnValidate_o *)sub_1C22084(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v14, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !inputTarget )
    goto LABEL_18;
  inputTarget->fields.onValidate = v14;
  sub_1C21DDC(&inputTarget->fields.onValidate, v14);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10480/*"PARTY_ORGANIZATION_NAME_CLEAR"*/, 0LL);
  if ( !clearLabel
    || (UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0LL),
        initLabel = this->fields.initLabel,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10481/*"PARTY_ORGANIZATION_NAME_INIT"*/, 0LL),
        !initLabel)
...
LABEL_18:
  ...
  System_Action___ctor(v19, (Il2CppObject *)this, Method_DeckNameInputMenu_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8025 & 1) == 0 )
  {
    sub_1C21E38(&DeckNameInputMenu_CallbackFunc_TypeInfo);
    byte_4BD8025 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (DeckNameInputMenu_o *)sub_1C22354(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A5CFD8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A5CF80;
}
