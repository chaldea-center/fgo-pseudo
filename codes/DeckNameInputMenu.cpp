        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E10 & 1) == 0 )
  {
    sub_1BCAFF8(&LocalizationManager_TypeInfo, inputName);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v6);
    byte_4B17E10 = 1;
  }
  this->fields.changeName = inputName;
  p_changeName = &this->fields.changeName;
  sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.changeName, (int32_t)inputName, (int32_t)method, v3);
...
void __fastcall DeckNameInputMenu__Close(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  DeckNameInputMenu__Close_33270036(this, 0LL, v2);
}


void __fastcall DeckNameInputMenu__Close_33270036(
        DeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E12 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_DeckNameInputMenu_EndClose__, v7);
    byte_4B17E12 = 1;
  }
...
void __fastcall DeckNameInputMenu__OnClickCancel(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17E14 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DeckNameInputMenu_OnClickCancel__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BCB010(Method_DeckNameInputMenu_OnClickCancel__);
...
void __fastcall DeckNameInputMenu__OnClickClear(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17E15 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DeckNameInputMenu_OnClickClear__, method);
    sub_1BCAFF8(&StringLiteral_1/*""*/, v3);
    byte_4B17E15 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BCB010(Method_DeckNameInputMenu_OnClickClear__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v4, v4[4]);
...
void __fastcall DeckNameInputMenu__OnClickDecide(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17E13 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DeckNameInputMenu_OnClickDecide__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BCB010(Method_DeckNameInputMenu_OnClickDecide__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v4, v4[4]);
...
void __fastcall DeckNameInputMenu__OnClickInit(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B17E16 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DeckNameInputMenu_OnClickInit__, method);
    byte_4B17E16 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_DeckNameInputMenu_OnClickInit__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E0F & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_DeckNameInputMenu_EndOpen__, v10);
    sub_1BCAFF8(&Method_EmojiUtility_ValidateNameText__, v11);
    sub_1BCAFF8(&LocalizationManager_TypeInfo, v12);
    sub_1BCAFF8(&UIInput_OnValidate_TypeInfo, v13);
    sub_1BCAFF8(&StringLiteral_10179/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_TITLE"*/, v14);
    sub_1BCAFF8(&StringLiteral_3651/*"COMMON_CONFIRM_DECIDE"*/, v15);
    sub_1BCAFF8(&StringLiteral_10183/*"PARTY_ORGANIZATION_NAME_INIT"*/, v16);
    sub_1BCAFF8(&StringLiteral_3649/*"COMMON_CONFIRM_CANCEL"*/, v17);
    sub_1BCAFF8(&StringLiteral_10178/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_EXPLANATION"*/, v18);
    sub_1BCAFF8(&StringLiteral_10182/*"PARTY_ORGANIZATION_NAME_CLEAR"*/, v19);
    byte_4B17E0F = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10179/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10178/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0LL);
  inputTarget = this->fields.inputTarget;
  v33 = (UIInput_OnValidate_o *)sub_1BCB244(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v33, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !inputTarget )
    goto LABEL_18;
  inputTarget->fields.onValidate = v33;
  sub_1BCAF9C((CGThumbnailListItem_o *)&inputTarget->fields.onValidate, (int32_t)v33, v34, v35);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10182/*"PARTY_ORGANIZATION_NAME_CLEAR"*/, 0LL);
  if ( !clearLabel
    || (UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0LL),
        initLabel = this->fields.initLabel,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10183/*"PARTY_ORGANIZATION_NAME_INIT"*/, 0LL),
        !initLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17E0C & 1) == 0 )
  {
    sub_1BCAFF8(&DeckNameInputMenu_CallbackFunc_TypeInfo, value);
    byte_4B17E0C = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  ...
  v11 = (DeckNameInputMenu_o *)sub_1BCB514(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0F35C;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0F304;
}
