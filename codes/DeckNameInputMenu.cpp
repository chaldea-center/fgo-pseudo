        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC35A8 & 1) == 0 )
  {
    sub_1C1ABD4(&LocalizationManager_TypeInfo, inputName);
...
void __fastcall DeckNameInputMenu__Close(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  DeckNameInputMenu__Close_32770808(this, 0LL, v2);
}


void __fastcall DeckNameInputMenu__Close_32770808(
        DeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC35AA & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_DeckNameInputMenu_EndClose__, v6);
    byte_4BC35AA = 1;
  }
...
void __fastcall DeckNameInputMenu__OnClickCancel(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC35AC & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DeckNameInputMenu_OnClickCancel__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C1ABEC(Method_DeckNameInputMenu_OnClickCancel__);
...
void __fastcall DeckNameInputMenu__OnClickClear(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC35AD & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DeckNameInputMenu_OnClickClear__, method);
    sub_1C1ABD4(&StringLiteral_1/*""*/, v3);
    byte_4BC35AD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C1ABEC(Method_DeckNameInputMenu_OnClickClear__);
    v5 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v4, v4[4]);
...
void __fastcall DeckNameInputMenu__OnClickDecide(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC35AB & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DeckNameInputMenu_OnClickDecide__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1C1ABEC(Method_DeckNameInputMenu_OnClickDecide__);
    v5 = (System_Reflection_MethodBase_o *)sub_1C1ABB8(v4, v4[4]);
...
void __fastcall DeckNameInputMenu__OnClickInit(DeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC35AE & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DeckNameInputMenu_OnClickInit__, method);
    byte_4BC35AE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_DeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C1ABEC(Method_DeckNameInputMenu_OnClickInit__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC35A7 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_DeckNameInputMenu_EndOpen__, v10);
    sub_1C1ABD4(&Method_EmojiUtility_ValidateNameText__, v11);
    sub_1C1ABD4(&LocalizationManager_TypeInfo, v12);
    sub_1C1ABD4(&UIInput_OnValidate_TypeInfo, v13);
    sub_1C1ABD4(&StringLiteral_10467/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_TITLE"*/, v14);
    sub_1C1ABD4(&StringLiteral_3803/*"COMMON_CONFIRM_DECIDE"*/, v15);
    sub_1C1ABD4(&StringLiteral_10471/*"PARTY_ORGANIZATION_NAME_INIT"*/, v16);
    sub_1C1ABD4(&StringLiteral_3801/*"COMMON_CONFIRM_CANCEL"*/, v17);
    sub_1C1ABD4(&StringLiteral_10466/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_EXPLANATION"*/, v18);
    sub_1C1ABD4(&StringLiteral_10470/*"PARTY_ORGANIZATION_NAME_CLEAR"*/, v19);
    byte_4BC35A7 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  sub_1C1AB78(&this->fields.initName);
  this->fields.callbackFunc = callback;
  sub_1C1AB78(&this->fields.callbackFunc);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10467/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10466/*"PARTY_ORGANIZATION_INPUT_DECK_NAME_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0LL);
  inputTarget = this->fields.inputTarget;
  v25 = (UIInput_OnValidate_o *)sub_1C1AE20(UIInput_OnValidate_TypeInfo);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10470/*"PARTY_ORGANIZATION_NAME_CLEAR"*/, 0LL);
  if ( !clearLabel
    || (UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0LL),
        initLabel = this->fields.initLabel,
        gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_10471/*"PARTY_ORGANIZATION_NAME_INIT"*/, 0LL),
        !initLabel)
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC35A4 & 1) == 0 )
  {
    sub_1C1ABD4(&DeckNameInputMenu_CallbackFunc_TypeInfo, value);
    byte_4BC35A4 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
  p_callbackFunc = &this->fields.callbackFunc;
  ...
  v11 = (DeckNameInputMenu_o *)sub_1C1B0F0(v8);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A56030;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A55FD8;
}
