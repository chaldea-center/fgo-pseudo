...
void __fastcall SwitchUIWidgetComponent__Clear(SwitchUIWidgetComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&this->fields.componentList, 0LL, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( activeSelf )
    SwitchUIWidgetComponent__Set_39504572(this, count, v7);
  return activeSelf;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( componentList )
  {
    ...
    sub_1C21DDC(p_componentList, (int64_t)componentList, (int64_t)method, v3, v4, v5, v6, v7);
    ...
    SwitchUIWidgetComponent__Set_39504572(this, Instance->fields.count, v13);
  }
  else
  {
    this->fields.componentList = 0LL;
    sub_1C21DDC(p_componentList, 0LL, (int64_t)method, v3, v4, v5, v6, v7);
...
LABEL_5:
  ...
  sub_1C21DDC((PartyOrganizationUtility_o *)&v5->fields.component, v4, v6, v7, v8, v9, v10, v11);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall SwitchUIWidgetComponent__Set_39504572(
        SwitchUIWidgetComponent_o *this,
        int32_t count,
        const MethodInfo *method)
{
...
LABEL_19:
      sub_1C22094(component, v7);
    }
    v9 = count % (int)v6;
    SwitchUIWidgetComponent__SetParam(this, v9, method);
    component = (float *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_388D058 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__);
    if ( !component )
      goto LABEL_19;
