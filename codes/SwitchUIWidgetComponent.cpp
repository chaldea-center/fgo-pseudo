...
void __fastcall SwitchUIWidgetComponent__Clear(SwitchUIWidgetComponent_o *this, const MethodInfo *method)
{
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&this->fields.componentList, 0, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( activeSelf )
    SwitchUIWidgetComponent__Set_38079640(this, count, v7);
  return activeSelf;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2D4FC & 1) == 0 )
  {
    sub_1B761C0(&Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__, componentList);
    byte_4A2D4FC = 1;
  }
  ...
  if ( componentList )
  {
    ...
    sub_1B76164(p_componentList, (int32_t)componentList, (int32_t)method, v3);
    ...
    SwitchUIWidgetComponent__Set_38079640(this, Instance->fields.count, v9);
  }
  else
  {
    this->fields.componentList = 0LL;
    sub_1B76164(p_componentList, 0, (int32_t)method, v3);
...
LABEL_5:
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v5->fields.component, (int32_t)v4, v6, v7);
}


// local variable allocation has failed, the output may be wrong!
void __fastcall SwitchUIWidgetComponent__Set_38079640(
        SwitchUIWidgetComponent_o *this,
        int32_t count,
        const MethodInfo *method)
{
...
LABEL_19:
    ...
    component = (float *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__);
    if ( !component )
      goto LABEL_19;
