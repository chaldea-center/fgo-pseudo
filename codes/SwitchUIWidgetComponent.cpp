...
void SwitchUIWidgetComponent__Clear(SwitchUIWidgetComponent_o *this, const MethodInfo *method)
{
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&this->fields.componentList, 0, v2, v3, v4, v5, v6, v7);
...
bool SwitchUIWidgetComponent__ParameterChange(SwitchUIWidgetComponent_o *this, int32_t count, const MethodInfo *method)
{
  ...
  if ( activeSelf )
    SwitchUIWidgetComponent__Set_48092744(this, count, v7);
  return activeSelf;
}
  ...
  if ( componentList )
  {
    ...
    if ( !Instance
      || (SwitchParameterDisplayManager__AddComponent(Instance, (SwitchParameterDisplayComponent_o *)this, 0),
          (Instance = (SwitchParameterDisplayManager_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__)) == 0) )
    {
      sub_2213CDC(Instance, v12);
    }
    SwitchUIWidgetComponent__Set_48092744(this, Instance->fields.count, v13);
  }
  else
  {
    this->fields.isEnableSingle = 0;
...
LABEL_5:
  ...
  sub_2213A04((MissionNaviTransitionBoardItem_o *)&v4->fields.component, (int32_t)v5, v6, v7, v8, v9, v10, v11);
}


// local variable allocation has failed, the output may be wrong!
void SwitchUIWidgetComponent__Set_48092744(SwitchUIWidgetComponent_o *this, int32_t count, const MethodInfo *method)
{
  struct UIWidget_array *componentList; // x8
  ...
  if ( componentList && (max_length = componentList->max_length) != 0 )
  {
    ...
    else
    {
      ...
      Instance = (float *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_47A29F8 *)Method_SingletonMonoBehaviour_SwitchParameterDisplayManager__get_Instance__);
      if ( !Instance
