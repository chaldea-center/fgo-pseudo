        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A296EF & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_DataManager_GetMaster_UserServantMaster___, v15);
    ...
    sub_1B761C0(&UserServantCollectionEntity_TypeInfo, v20);
    byte_4A296EF = 1;
  }
  ...
  v23 = (UserServantCollectionEntity_o *)sub_1B7640C(UserServantCollectionEntity_TypeInfo);
  UserServantCollectionEntity___ctor_39981116(v23, userSvtCollectionEntity, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A296F0 & 1) == 0 )
  {
    sub_1B761C0(&Method_GameObjectExtensions_SafeGetComponent_UIWidget___, method);
    ...
    if ( ((unsigned __int8)gameObject & 1) != 0 )
    {
      if ( !this->fields.isCoercionInactive )
      {
        ...
        Component_object = GameObjectExtensions__SafeGetComponent_object_(
                             v9,
                             (const MethodInfo_2EB34A0 *)Method_GameObjectExtensions_SafeGetComponent_UIWidget___);
      }
      goto LABEL_25;
    }
    if ( this->fields.isCoercionInactive )
        ...
        const MethodInfo *method)
{
  ...
  if ( sortKind != 9 )
  {
    ...
    if ( iconLabelInfo )
    {
      IconLabelInfo__Set_37960168(iconLabelInfo, 57, collectionNo, 0, 0, 0, 0, 0, 0LL);
      return;
    }
LABEL_10:
  ...
  if ( (int)maxLimitCount < 1 )
    ...
    IconLabelInfo__Set_37960168(v6, 9, maxLimitCount, 0, 0, 0, 0, 0, 0LL);
}
