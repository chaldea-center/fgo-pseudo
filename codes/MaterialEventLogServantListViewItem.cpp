        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8C73 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_DataManager_GetMaster_UserServantMaster___, v15);
    ...
    sub_1C2E12C(&UserServantCollectionEntity_TypeInfo, v20);
    byte_4BF8C73 = 1;
  }
  ...
  v23 = (UserServantCollectionEntity_o *)sub_1C2E378(UserServantCollectionEntity_TypeInfo);
  UserServantCollectionEntity___ctor_41524516(v23, userSvtCollectionEntity, 0LL);
  ...
  *(_QWORD *)&v45.fields.fakeValue = v28;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v45, 0LL);
  if ( !v27 )
    goto LABEL_37;
  ...
  if ( v32 != v33->static_fields->ServantIdMashu1 )
  {
    ...
    if ( *p_userSvtCollectionEntity )
    {
      ...
      *(_QWORD *)&v47.fields.fakeValue = v42;
      Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v47, 0LL);
      if ( v31 )
      {
...
LABEL_37:
  ...
  *(_QWORD *)&v46.fields.fakeValue = v35;
  Instance = (void *)CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47758816(v46, 0LL);
  if ( !v31 )
    goto LABEL_37;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF8C74 & 1) == 0 )
  {
    sub_1C2E12C(&Method_GameObjectExtensions_SafeGetComponent_UIWidget___, method);
    ...
    if ( ((unsigned __int8)gameObject & 1) != 0 )
    {
      if ( !this->fields.isCoercionInactive )
      {
        ...
        Component_object = GameObjectExtensions__SafeGetComponent_object_(
                             v9,
                             (const MethodInfo_30245F4 *)Method_GameObjectExtensions_SafeGetComponent_UIWidget___);
      }
      goto LABEL_25;
    }
    if ( this->fields.isCoercionInactive )
        ...
        const MethodInfo *method)
{
  ...
  if ( sortKind != 9 )
  {
    ...
    if ( iconLabelInfo )
    {
      IconLabelInfo__Set_39452344(iconLabelInfo, 57, collectionNo, 0, 0, 0, 0, 0, 0LL);
      return;
    }
LABEL_10:
  ...
  if ( (int)maxLimitCount < 1 )
    ...
    IconLabelInfo__Set_39452344(v6, 9, maxLimitCount, 0, 0, 0, 0, 0, 0LL);
}
