void __fastcall ServantStatusListViewItemDrawButton___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B34177 & 1) == 0 )
  {
    sub_1BD3458(&ServantStatusListViewItemDrawButton_TypeInfo, v1);
    sub_1BD3458(&string___TypeInfo, v2);
    sub_1BD3458(&StringLiteral_12093/*"SERVANT_STATUS_TD_SPEED_TWICE"*/, v3);
    sub_1BD3458(&StringLiteral_12091/*"SERVANT_STATUS_TD_SPEED_FREE"*/, v4);
    sub_1BD3458(&StringLiteral_12087/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/, v5);
    byte_4B34177 = 1;
  }
  ...
  *(_QWORD *)&static_fields->TD_SPEED_EXPLANATION_LABEL_HEIGHT = 0xC238000000000046LL;
  ...
  v7 = sub_1BD3500(string___TypeInfo, 3LL);
  if ( !v7 )
    sub_1BD36B4(0LL, v8);
  v15 = v7;
  if ( !*(_DWORD *)(v7 + 24)
    || (v16 = StringLiteral_12091/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        *(_QWORD *)(v7 + 32) = StringLiteral_12091/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        sub_1BD33FC((PartyOrganizationUtility_o *)(v7 + 32), v16, v9, v10, v11, v12, v13, v14),
        *(_DWORD *)(v15 + 24) <= 1u)
    || (v23 = StringLiteral_12087/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        *(_QWORD *)(v15 + 40) = StringLiteral_12087/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        sub_1BD33FC((PartyOrganizationUtility_o *)(v15 + 40), v23, v17, v18, v19, v20, v21, v22),
        *(_DWORD *)(v15 + 24) <= 2u) )
  {
    sub_1BD36BC(v7, v8);
  }
  v30 = StringLiteral_12093/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  *(_QWORD *)(v15 + 48) = StringLiteral_12093/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  ...
  sub_1BD33FC((PartyOrganizationUtility_o *)&v31->TD_SPEED_LOCALIZATION_KEYS, v15, v32, v33, v34, v35, v36, v37);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34175 & 1) == 0 )
  {
    ...
    sub_1BD3458(&ServantStatusListViewItemDrawButton_TypeInfo, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B34176 & 1) == 0 )
  {
    ...
    sub_1BD3458(&ServantStatusListViewItemDrawButton_TypeInfo, v7);
    sub_1BD3458(&StringLiteral_12012/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/, v8);
    sub_1BD3458(&StringLiteral_20817/*"img_txt_npspeed"*/, v9);
    sub_1BD3458(&StringLiteral_12014/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/, v10);
    sub_1BD3458(&StringLiteral_20756/*"img_txt_battlevoice"*/, v11);
    sub_1BD3458(&StringLiteral_12092/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, v12);
    sub_1BD3458(&StringLiteral_12013/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/, v13);
    byte_4B34176 = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    if ( (_DWORD)gameObject == 17 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12012/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/, 0LL);
      if ( !v26 )
        goto LABEL_15;
...
LABEL_55:
      ...
      v28 = v27->m_Items[1];
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12013/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/, 0LL);
      if ( !v28 )
        goto LABEL_15;
      ...
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12014/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v30 = &StringLiteral_20756/*"img_txt_battlevoice"*/;
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12092/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, 0LL);
      if ( !v31 )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v30 = &StringLiteral_20817/*"img_txt_npspeed"*/;
    }
