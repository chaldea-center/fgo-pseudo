void __fastcall ServantStatusListViewItemDrawButton___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A1C84C & 1) == 0 )
  {
    sub_1B715CC(&ServantStatusListViewItemDrawButton_TypeInfo, v1);
    sub_1B715CC(&string___TypeInfo, v2);
    sub_1B715CC(&StringLiteral_11895/*"SERVANT_STATUS_TD_SPEED_TWICE"*/, v3);
    sub_1B715CC(&StringLiteral_11893/*"SERVANT_STATUS_TD_SPEED_FREE"*/, v4);
    sub_1B715CC(&StringLiteral_11889/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/, v5);
    byte_4A1C84C = 1;
  }
  ...
  *(_QWORD *)&static_fields->TD_SPEED_EXPLANATION_LABEL_HEIGHT = 0xC238000000000046LL;
  ...
  v7 = sub_1B71674(string___TypeInfo, 3LL);
  if ( !v7 )
    sub_1B71828(0LL, v8);
  v11 = v7;
  if ( !*(_DWORD *)(v7 + 24)
    || (v12 = StringLiteral_11893/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        *(_QWORD *)(v7 + 32) = StringLiteral_11893/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v7 + 32), v12, v9, v10),
        *(_DWORD *)(v11 + 24) <= 1u)
    || (v15 = StringLiteral_11889/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        *(_QWORD *)(v11 + 40) = StringLiteral_11889/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        sub_1B71570((ServantStatusBattleListViewItem_o *)(v11 + 40), v15, v13, v14),
        *(_DWORD *)(v11 + 24) <= 2u) )
  {
    sub_1B71830(v7, v8);
  }
  v18 = StringLiteral_11895/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  *(_QWORD *)(v11 + 48) = StringLiteral_11895/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  ...
  sub_1B71570((ServantStatusBattleListViewItem_o *)&v19->TD_SPEED_LOCALIZATION_KEYS, v11, v20, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C84A & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantStatusListViewItemDrawButton_TypeInfo, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C84B & 1) == 0 )
  {
    ...
    sub_1B715CC(&ServantStatusListViewItemDrawButton_TypeInfo, v7);
    sub_1B715CC(&StringLiteral_11814/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/, v8);
    sub_1B715CC(&StringLiteral_20513/*"img_txt_npspeed"*/, v9);
    sub_1B715CC(&StringLiteral_11816/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/, v10);
    sub_1B715CC(&StringLiteral_20452/*"img_txt_battlevoice"*/, v11);
    sub_1B715CC(&StringLiteral_11894/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, v12);
    sub_1B715CC(&StringLiteral_11815/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/, v13);
    byte_4A1C84B = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    if ( (_DWORD)gameObject == 17 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11814/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/, 0LL);
      if ( !v26 )
        goto LABEL_15;
...
LABEL_55:
      ...
      v28 = v27->m_Items[1];
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11815/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/, 0LL);
      if ( !v28 )
        goto LABEL_15;
      ...
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11816/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v30 = &StringLiteral_20452/*"img_txt_battlevoice"*/;
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11894/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, 0LL);
      if ( !v31 )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v30 = &StringLiteral_20513/*"img_txt_npspeed"*/;
    }
