void ServantStatusListViewItemDrawButton___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D29C23 & 1) == 0 )
  {
    sub_1C94098(&ServantStatusListViewItemDrawButton_TypeInfo);
  ...
  *(_QWORD *)&static_fields->TD_SPEED_EXPLANATION_LABEL_HEIGHT = 0xC238000000000046LL;
  ...
  v10 = v2;
  if ( !*(_DWORD *)(v2 + 24)
    || (v11 = StringLiteral_12039/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        *(_QWORD *)(v2 + 32) = StringLiteral_12039/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        sub_1C9403C((GrandQuestFolderBoardItem_o *)(v2 + 32), v11, v4, v5, v6, v7, v8, v9),
        *(_DWORD *)(v10 + 24) <= 1u)
    || (v18 = StringLiteral_12035/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        *(_QWORD *)(v10 + 40) = StringLiteral_12035/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        sub_1C9403C((GrandQuestFolderBoardItem_o *)(v10 + 40), v18, v12, v13, v14, v15, v16, v17),
        *(_DWORD *)(v10 + 24) <= 2u) )
  {
    sub_1C942F8(v2);
  }
  v25 = StringLiteral_12041/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  *(_QWORD *)(v10 + 48) = StringLiteral_12041/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  ...
  sub_1C9403C((GrandQuestFolderBoardItem_o *)&v26->TD_SPEED_LOCALIZATION_KEYS, v10, v27, v28, v29, v30, v31, v32);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D29C22 & 1) == 0 )
  {
    sub_1C94098(&LocalizationManager_TypeInfo);
    sub_1C94098(&ServantStatusListViewItemDrawButton_TypeInfo);
    sub_1C94098(&StringLiteral_11955/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/);
    sub_1C94098(&StringLiteral_20872/*"img_txt_npspeed"*/);
    sub_1C94098(&StringLiteral_11957/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/);
    sub_1C94098(&StringLiteral_20802/*"img_txt_battlevoice"*/);
    sub_1C94098(&StringLiteral_12040/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/);
    sub_1C94098(&StringLiteral_11956/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/);
    byte_4D29C22 = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    if ( (_DWORD)gameObject == 17 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11955/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/, 0);
      if ( !v19 )
        goto LABEL_15;
...
LABEL_55:
      ...
      v21 = v20->m_Items[1];
      gameObject = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11956/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/, 0);
      if ( !v21 )
        goto LABEL_15;
      ...
      gameObject = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11957/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/, 0);
      if ( !explanationLabel )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v23 = &StringLiteral_20802/*"img_txt_battlevoice"*/;
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12040/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, 0);
      if ( !v24 )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v23 = &StringLiteral_20872/*"img_txt_npspeed"*/;
    }
