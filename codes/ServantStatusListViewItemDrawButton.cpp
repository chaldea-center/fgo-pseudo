void __fastcall ServantStatusListViewItemDrawButton___cctor(const MethodInfo *method)
{
  ...
  *(_QWORD *)&static_fields->TD_SPEED_EXPLANATION_LABEL_HEIGHT = 0xC238000000000046LL;
  ...
  v2 = sub_1B88658(string___TypeInfo, 3LL);
  if ( !v2 )
    sub_1B8880C(0LL, v3);
  v6 = v2;
  if ( !*(_DWORD *)(v2 + 24)
    || (v7 = StringLiteral_11934/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        *(_QWORD *)(v2 + 32) = StringLiteral_11934/*"SERVANT_STATUS_TD_SPEED_FREE"*/,
        sub_1B88554((ServantStatusBattleListViewItem_o *)(v2 + 32), v7, v4, v5),
        *(_DWORD *)(v6 + 24) <= 1u)
    || (v10 = StringLiteral_11930/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        *(_QWORD *)(v6 + 40) = StringLiteral_11930/*"SERVANT_STATUS_TD_SPEED_ACTUAL"*/,
        sub_1B88554((ServantStatusBattleListViewItem_o *)(v6 + 40), v10, v8, v9),
        *(_DWORD *)(v6 + 24) <= 2u) )
  {
    sub_1B88814(v2, v3);
  }
  v13 = StringLiteral_11936/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  *(_QWORD *)(v6 + 48) = StringLiteral_11936/*"SERVANT_STATUS_TD_SPEED_TWICE"*/;
  sub_1B88554((ServantStatusBattleListViewItem_o *)(v6 + 48), v13, v11, v12);
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&v14->TD_SPEED_LOCALIZATION_KEYS, v6, v15, v16);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57DD3 & 1) == 0 )
  {
    sub_1B885B0(&LocalizationManager_TypeInfo);
    sub_1B885B0(&ServantStatusListViewItemDrawButton_TypeInfo);
    sub_1B885B0(&StringLiteral_11855/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/);
    sub_1B885B0(&StringLiteral_20565/*"img_txt_npspeed"*/);
    sub_1B885B0(&StringLiteral_11857/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/);
    sub_1B885B0(&StringLiteral_20504/*"img_txt_battlevoice"*/);
    sub_1B885B0(&StringLiteral_11935/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/);
    sub_1B885B0(&StringLiteral_11856/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/);
    byte_4A57DD3 = 1;
  }
  ...
  if ( item && mode )
  {
    ...
    if ( (_DWORD)gameObject == 17 )
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11855/*"SERVANT_STATUS_BATTLE_VOICE_AFTER"*/, 0LL);
      if ( !v19 )
        goto LABEL_15;
...
LABEL_55:
      ...
      v21 = v20->m_Items[1];
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11856/*"SERVANT_STATUS_BATTLE_VOICE_BEFORE"*/, 0LL);
      if ( !v21 )
        goto LABEL_15;
      ...
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11857/*"SERVANT_STATUS_BATTLE_VOICE_MESSAGE"*/, 0LL);
      if ( !explanationLabel )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v23 = &StringLiteral_20504/*"img_txt_battlevoice"*/;
    }
    else
    {
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      gameObject = (UICommonButton_o *)LocalizationManager__Get((System_String_o *)StringLiteral_11935/*"SERVANT_STATUS_TD_SPEED_MESSAGE"*/, 0LL);
      if ( !v24 )
        goto LABEL_15;
      ...
      if ( !gameObject )
        goto LABEL_15;
      v23 = &StringLiteral_20565/*"img_txt_npspeed"*/;
    }
