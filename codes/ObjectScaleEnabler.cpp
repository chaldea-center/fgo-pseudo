...
void __fastcall ObjectScaleEnabler__OnUpdate(ObjectScaleEnabler_o *this, const MethodInfo *method)
{
  ...
  System_Object_array *ComponentsInChildren_object__49612324; // x21
  ...
  if ( (byte_4B660AF & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponentsInChildren_ParticleSystem___, v4);
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponentsInChildren_SimpleAnimation___, v5);
...
LABEL_16:
          ...
          {
LABEL_23:
            v22 = sub_1C36AAC(Enumerator, System_Collections_IEnumerator_TypeInfo, 1LL);
          }
...
LABEL_66:
      ...
      transform = (Il2CppObject *)UnityEngine_Component__GetComponentsInChildren_object__49612324(
                                    (UnityEngine_Component_o *)this,
...
LABEL_88:
        ...
        if ( ComponentsInChildren_object__49612324
          && (v65 = *(_QWORD *)&ComponentsInChildren_object__49612324->max_length) != 0 )
        {
          if ( (int)v65 >= 1 )
          {
            v66 = 0LL;
            ...
            {
              transform = ComponentsInChildren_object__49612324->m_Items[v66];
              if ( !transform )
                goto LABEL_137;
              SimpleAnimation__Stop((SimpleAnimation_o *)transform, 0LL);
              LODWORD(v65) = ComponentsInChildren_object__49612324->max_length;
              if ( (int)++v66 >= (int)v65 )
                goto LABEL_81;
            }
            goto LABEL_138;
...
LABEL_81:
      ...
      while ( v62 < monitor )
      {
        ...
        if ( !transform )
          goto LABEL_137;
        UnityEngine_ParticleSystem__Stop_70732448((UnityEngine_ParticleSystem_o *)transform, 0LL);
...
LABEL_43:
          ...
          {
LABEL_50:
            v39 = sub_1C36AAC(v31, System_Collections_IEnumerator_TypeInfo, 1LL);
          }
...
LABEL_140:
        ...
        v53 = sub_1BE4C08(v31, System_IDisposable_TypeInfo);
        if ( v53 )
        {
          v54 = *(_QWORD *)v53;
          v55 = v53;
          ...
          {
LABEL_72:
            v58 = sub_1C36AAC(v53, System_IDisposable_TypeInfo, 0LL);
          }
        ...
        else
        {
          ...
          if ( v70 >= 1 )
          {
            ...
            while ( v72 < v70 )
            {
              ...
              if ( !transform )
                goto LABEL_137;
              UnityEngine_ParticleSystem__Play_70732096((UnityEngine_ParticleSystem_o *)transform, 0LL);
...
LABEL_120:
          v73 = UnityEngine_Component__GetComponentsInChildren_object__49612324(
                  (UnityEngine_Component_o *)this,
                  (const MethodInfo_2F50624 *)Method_UnityEngine_Component_GetComponentsInChildren_SimpleAnimation___);
          transform = (Il2CppObject *)UnityEngine_Component__GetComponentsInChildren_object__49612324(
                                        (UnityEngine_Component_o *)this,
