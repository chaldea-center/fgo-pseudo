...
void __fastcall ObjectScaleEnabler__OnUpdate(ObjectScaleEnabler_o *this, const MethodInfo *method)
{
  ...
  System_Object_array *ComponentsInChildren_object__48721436; // x21
...
LABEL_23:
          ...
          if ( v16 )
          {
            ...
            if ( *(unsigned __int8 *)(*(_QWORD *)v16 + 304LL) < (unsigned int)methodPtr_low
              || *(UnityEngine_Transform_c **)(*(_QWORD *)(*(_QWORD *)v16 + 200LL) + 8 * methodPtr_low - 8) != UnityEngine_Transform_TypeInfo )
            {
              sub_1B88ACC(v16);
LABEL_137:
        ...
        v40 = sub_1B886EC(Enumerator, System_IDisposable_TypeInfo);
        if ( v40 )
        {
          v41 = *(_QWORD *)v40;
          v42 = v40;
          ...
          {
LABEL_66:
            v45 = sub_1BDA590(v40, System_IDisposable_TypeInfo, 0LL);
          }
      ...
      transform = (Il2CppObject *)UnityEngine_Component__GetComponentsInChildren_object__48721436(
                                    (UnityEngine_Component_o *)this,
...
LABEL_88:
        ...
        if ( ComponentsInChildren_object__48721436
          && (v58 = *(_QWORD *)&ComponentsInChildren_object__48721436->max_length) != 0 )
        {
          if ( (int)v58 >= 1 )
          {
            v59 = 0LL;
            ...
            {
              transform = ComponentsInChildren_object__48721436->m_Items[v59];
              if ( !transform )
                goto LABEL_137;
              SimpleAnimation__Stop((SimpleAnimation_o *)transform, 0LL);
              LODWORD(v58) = ComponentsInChildren_object__48721436->max_length;
              if ( (int)++v59 >= (int)v58 )
                goto LABEL_81;
            }
            goto LABEL_138;
...
LABEL_81:
      ...
      while ( v55 < monitor )
      {
        ...
        if ( !transform )
          goto LABEL_137;
        UnityEngine_ParticleSystem__Stop_69739868((UnityEngine_ParticleSystem_o *)transform, 0LL);
...
LABEL_138:
    ...
    v73 = UnityEngine_Transform__get_localScale((UnityEngine_Transform_o *)visibleCheckTarget, 0LL);
...
LABEL_43:
          ...
          {
LABEL_50:
            v32 = sub_1BDA590(v24, System_Collections_IEnumerator_TypeInfo, 1LL);
          }
...
LABEL_140:
        ...
        v46 = sub_1B886EC(v24, System_IDisposable_TypeInfo);
        if ( v46 )
        {
          v47 = *(_QWORD *)v46;
          v48 = v46;
...
LABEL_72:
      ...
      else
      {
        ...
        if ( !UnityEngine_Object_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(UnityEngine_Object_TypeInfo);
        transform = (Il2CppObject *)UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)v62, 0LL, 0LL);
        if ( ((unsigned __int8)transform & 1) != 0 )
        {
          if ( !v62 )
            goto LABEL_137;
        ...
        else
        {
          ...
          if ( v63 >= 1 )
          {
            ...
            while ( v65 < v63 )
            {
              ...
              if ( !transform )
                goto LABEL_137;
              UnityEngine_ParticleSystem__Play_69739516((UnityEngine_ParticleSystem_o *)transform, 0LL);
...
LABEL_120:
          v66 = UnityEngine_Component__GetComponentsInChildren_object__48721436(
                  (UnityEngine_Component_o *)this,
                  (const MethodInfo_2E76E1C *)Method_UnityEngine_Component_GetComponentsInChildren_SimpleAnimation___);
          transform = (Il2CppObject *)UnityEngine_Component__GetComponentsInChildren_object__48721436(
                                        (UnityEngine_Component_o *)this,
