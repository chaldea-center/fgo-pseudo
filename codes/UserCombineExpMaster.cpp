void __fastcall UserCombineExpMaster___ctor(UserCombineExpMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4188AA5 & 1) == 0 )
  {
    sub_B2C35C(&Method_DataMasterBase_UserCombineExpMaster__UserCombineExpEntity__string___ctor__, method);
    byte_4188AA5 = 1;
  }
  DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string____ctor(
    (DataMasterBase_WarQuestSelectionMaster__WarQuestSelectionEntity__string__o *)this,
    303,
    (const MethodInfo_24E4484 *)Method_DataMasterBase_UserCombineExpMaster__UserCombineExpEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4188AA6 & 1) == 0 )
  {
    ...
    sub_B2C35C(&UserCombineExpEntity_TypeInfo, v7);
    byte_4188AA6 = 1;
  }
  memset(&v21[1], 0, 64);
          ...
          if ( (int)v13 >= 1 )
          {
            ...
            do
            {
              ...
              *(_OWORD *)&v21[0].fields.fakeValue = v17;
              ...
              v20 = v21[0];
              result = (CodeStage_AntiCheat_ObscuredTypes_ObscuredLong_o *)CodeStage_AntiCheat_ObscuredTypes_ObscuredLong__op_Implicit_44761220(
                                                                             &v20,
                                                                             0LL);
