        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.label, (int32_t)label, v6, v7);
}
...
System_String_o *ScriptBackLogListViewItem__ToString(ScriptBackLogListViewItem_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C398EB & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_21397/*"mainText "*/);
    sub_1C32C20(&StringLiteral_20289/*"imageText "*/);
    this = (ScriptBackLogListViewItem_o *)sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C398EB = 1;
  }
  ...
  v5 = (System_String_o **)&StringLiteral_20289/*"imageText "*/;
  v6 = 120;
  if ( ((unsigned __int8)this & 1) != 0 )
    v6 = 136;
  else
    v5 = (System_String_o **)&StringLiteral_21397/*"mainText "*/;
  return System_String__Concat_63518544(*v5, *(System_String_o **)((char *)&v4->klass + v6), 0);
}
