...
void __fastcall LinkableSprite__SetSize(LinkableSprite_o *this, int32_t w, int32_t h, const MethodInfo *method)
{
  ...
  {
    sub_1B68930(mUiSprite, *(_QWORD *)&w);
  }
  v8.fields.y = (float)h;
  v8.fields.x = (float)w;
  v8.fields.z = 1.0;
        ...
        const MethodInfo *method)
{
  ...
  *((_DWORD *)p_linkUrl - 2) = lnkType;
  sub_1B68678((ServantStatusBattleListViewItem_o *)p_linkUrl, (int32_t)lnkUrl, (int32_t)lnkUrl, (int32_t)method);
}