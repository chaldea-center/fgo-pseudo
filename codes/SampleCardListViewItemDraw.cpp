        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( cardData )
    {
      if ( !AssetManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo);
      AssetManager__releaseAsset_41676764(cardData, 0);
      this->fields.cardData = 0;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.cardData, 0, v11, v12, v13, v14, v15, v16);
    }
    if ( data )
    {
...
void SampleCardListViewItemDraw__OnDestroy(SampleCardListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( cardData )
  {
    ...
    AssetManager__releaseAsset_41676764(cardData, 0);
    this->fields.cardData = 0;
    sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.cardData, 0, v10, v11, v12, v13, v14, v15);
  }
  this->fields.cardFileName = 0;
  p_cardFileName = &this->fields.cardFileName;
  *((_DWORD *)p_cardFileName - 2) = -1;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)p_cardFileName, 0, v2, v3, v4, v5, v6, v7);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E020EC & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SampleCardListViewItemDraw_EndLoadCard__);
    this = (SampleCardListViewItemDraw_o *)sub_1CE6700(&StringLiteral_13876/*"Test/card{0:d3}"*/);
    byte_4E020EC = 1;
  }
  if ( item )
    v7 = mode;
  ...
  if ( v7 )
  {
    ...
    if ( v6->fields.cardId != isFront )
    {
      ...
      v10 = System_String__Format((System_String_o *)StringLiteral_13876/*"Test/card{0:d3}"*/, v9, 0);
      v6->fields.cardFileName = v10;
      sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v6->fields.cardFileName, (int32_t)v10, v11, v12, v13, v14, v15, v16);
