...
void __fastcall CombineBannerComponent__onOpenWebView(CombineBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B485B4 & 1) == 0 )
  {
    ...
    sub_1BDB878(&WebViewManager_TypeInfo, v3);
    this = (CombineBannerComponent_o *)sub_1BDB878(&StringLiteral_1/*""*/, v4);
    byte_4B485B4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B485B3 & 1) == 0 )
  {
    sub_1BDB878(&AtlasManager_TypeInfo, eventData);
    byte_4B485B3 = 1;
  }
  bannerSprite = this->fields.bannerSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBanner_39624000(bannerSprite, eventData, 0LL);
  this->fields.eventEntity = eventData;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.eventEntity, (int32_t)eventData, v6, v7);
}