...
void __fastcall CombineBannerComponent__onOpenWebView(CombineBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A2305C & 1) == 0 )
  {
    ...
    sub_1B715CC(&WebViewManager_TypeInfo, v3);
    this = (CombineBannerComponent_o *)sub_1B715CC(&StringLiteral_1/*""*/, v4);
    byte_4A2305C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2305B & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, eventData);
    byte_4A2305B = 1;
  }
  bannerSprite = this->fields.bannerSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBanner_37652572(bannerSprite, eventData, 0LL);
  this->fields.eventEntity = eventData;
  sub_1B71570((ServantStatusBattleListViewItem_o *)&this->fields.eventEntity, (int32_t)eventData, v6, v7);
}