...
void __fastcall CombineBannerComponent__onOpenWebView(CombineBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9368 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&WebViewManager_TypeInfo, v3);
    this = (CombineBannerComponent_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v4);
    byte_4AB9368 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9367 & 1) == 0 )
  {
    sub_1BAB41C(&AtlasManager_TypeInfo, eventData);
    byte_4AB9367 = 1;
  }
  bannerSprite = this->fields.bannerSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetBanner_38242740(bannerSprite, eventData, 0LL);
  this->fields.eventEntity = eventData;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.eventEntity, (int32_t)eventData, v6, v7);
}