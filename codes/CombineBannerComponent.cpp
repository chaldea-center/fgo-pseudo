...
void CombineBannerComponent__onOpenWebView(CombineBannerComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C46DC6 & 1) == 0 )
  {
    ...
    this = (CombineBannerComponent_o *)sub_1C37058(&StringLiteral_1/*""*/);
    byte_4C46DC6 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetBanner_40604756(bannerSprite, eventData, 0);
  this->fields.eventEntity = eventData;
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.eventEntity, (int32_t)eventData, v6, v7);
}