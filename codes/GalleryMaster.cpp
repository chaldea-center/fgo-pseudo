void GalleryMaster___ctor(GalleryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4CC7705 & 1) == 0 )
  {
    sub_1C713B0(&Method_DataMasterBase_GalleryMaster__GalleryEntity__int___ctor__);
    byte_4CC7705 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    542,
    (const MethodInfo_3406B5C *)Method_DataMasterBase_GalleryMaster__GalleryEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC7703 & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_System_Linq_Enumerable_Where_GalleryEntity___);
    sub_1C713B0(&System_Func_GalleryEntity__bool__TypeInfo);
    sub_1C713B0(&Method_GalleryMaster___c__DisplayClass0_0__GetEnableGalleryEntitiesByWarId_b__0__);
    sub_1C713B0(&GalleryMaster___c__DisplayClass0_0_TypeInfo);
    byte_4CC7703 = 1;
  }
  v5 = sub_1C715FC(GalleryMaster___c__DisplayClass0_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1C71608(v6, v7);
  *(_DWORD *)(v5 + 16) = warId;
  list = this->fields.list;
  v9 = (System_Func_object__bool__o *)sub_1C715FC(System_Func_GalleryEntity__bool__TypeInfo);
  ...
  v10 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_3192108 *)Method_System_Linq_Enumerable_Where_GalleryEntity___);
...
bool GalleryMaster__HasEnableGalleryWar(GalleryMaster_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_4CC7704 & 1) == 0 )
  {
    sub_1C713B0(&Method_System_Linq_Enumerable_Any_GalleryEntity____78677064);
    sub_1C713B0(&System_Func_GalleryEntity__bool__TypeInfo);
    sub_1C713B0(&Method_GalleryMaster___c__DisplayClass1_0__HasEnableGalleryWar_b__0__);
    sub_1C713B0(&GalleryMaster___c__DisplayClass1_0_TypeInfo);
    byte_4CC7704 = 1;
  }
  v5 = sub_1C715FC(GalleryMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_1C71608(v6, v7);
  *(_DWORD *)(v5 + 16) = warId;
  ...
  return System_Linq_Enumerable__Any_object__51743576(
           (System_Collections_Generic_IEnumerable_TSource__o *)list,
           (System_Func_TSource__bool__o *)v9,
           (const MethodInfo_3158B58 *)Method_System_Linq_Enumerable_Any_GalleryEntity____78677064);
}
