void GalleryMaster___ctor(GalleryMaster_o *this, const MethodInfo *method)
{
  if ( (byte_5970C6F & 1) == 0 )
  {
    sub_2213A60(&Method_DataMasterBase_GalleryMaster__GalleryEntity__int___ctor__);
    byte_5970C6F = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    544,
    (const MethodInfo_3F0E6E0 *)Method_DataMasterBase_GalleryMaster__GalleryEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_5970C6D & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_System_Linq_Enumerable_Where_GalleryEntity___);
    sub_2213A60(&System_Func_GalleryEntity__bool__TypeInfo);
    sub_2213A60(&Method_GalleryMaster___c__DisplayClass0_0__GetEnableGalleryEntitiesByWarId_b__0__);
    sub_2213A60(&GalleryMaster___c__DisplayClass0_0_TypeInfo);
    byte_5970C6D = 1;
  }
  v5 = sub_2213CCC(GalleryMaster___c__DisplayClass0_0_TypeInfo);
  ...
  *(_DWORD *)(v5 + 16) = warId;
  ...
  v11 = System_Linq_Enumerable__Where_object_(
          ...
          (const MethodInfo_38A3478 *)Method_System_Linq_Enumerable_Where_GalleryEntity___);
...
bool GalleryMaster__HasEnableGalleryWar(GalleryMaster_o *this, int32_t warId, const MethodInfo *method)
{
  ...
  if ( (byte_5970C6E & 1) == 0 )
  {
    sub_2213A60(&Method_System_Linq_Enumerable_Any_GalleryEntity____91750040);
    sub_2213A60(&System_Func_GalleryEntity__bool__TypeInfo);
    sub_2213A60(&Method_GalleryMaster___c__DisplayClass1_0__HasEnableGalleryWar_b__0__);
    sub_2213A60(&GalleryMaster___c__DisplayClass1_0_TypeInfo);
    byte_5970C6E = 1;
  }
  v5 = sub_2213CCC(GalleryMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v5, 0);
  if ( !v5 )
    sub_2213CDC(v6, v7);
  list = this->fields.list;
  *(_DWORD *)(v5 + 16) = warId;
  v9 = (System_Func_object__bool__o *)sub_2213CCC(System_Func_GalleryEntity__bool__TypeInfo);
  System_Func_object__bool____ctor(
    v9,
    (Il2CppObject *)v5,
  ...
  return System_Linq_Enumerable__Any_object__59145568(
           ...
           (const MethodInfo_3867D60 *)Method_System_Linq_Enumerable_Any_GalleryEntity____91750040);
}
