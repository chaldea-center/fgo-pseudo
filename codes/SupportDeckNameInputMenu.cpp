        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1BE4A70(p_callbackFunc, 0LL, (int64_t)name, (int32_t)method, v4, v5, v6, v7);
...
void __fastcall SupportDeckNameInputMenu__Close(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  SupportDeckNameInputMenu__Close_33982860(this, 0LL, v2);
}


void __fastcall SupportDeckNameInputMenu__Close_33982860(
        SupportDeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B633AF & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_Collider___, v10);
    sub_1BE4ACC(&Method_SupportDeckNameInputMenu_EndClose__, v11);
    byte_4B633AF = 1;
  }
...
void __fastcall SupportDeckNameInputMenu__OnClickCancel(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B633B1 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SupportDeckNameInputMenu_OnClickCancel__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BE4AE4(Method_SupportDeckNameInputMenu_OnClickCancel__);
...
void __fastcall SupportDeckNameInputMenu__OnClickClear(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B633B2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SupportDeckNameInputMenu_OnClickClear__, method);
    sub_1BE4ACC(&StringLiteral_1/*""*/, v3);
    byte_4B633B2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BE4AE4(Method_SupportDeckNameInputMenu_OnClickClear__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v4, v4[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickDecide(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B633B0 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_SupportDeckNameInputMenu_OnClickDecide__, v3);
    byte_4B633B0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BE4AE4(Method_SupportDeckNameInputMenu_OnClickDecide__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BE4AB0(v4, v4[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickInit(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B633B3 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SupportDeckNameInputMenu_OnClickInit__, method);
    byte_4B633B3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BE4AE4(Method_SupportDeckNameInputMenu_OnClickInit__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B633AB & 1) == 0 )
  {
    sub_1BE4ACC(&System_Action_TypeInfo, deckName);
    sub_1BE4ACC(&Method_UnityEngine_Component_GetComponent_Collider___, v9);
    sub_1BE4ACC(&Method_EmojiUtility_ValidateNameText__, v10);
    sub_1BE4ACC(&LocalizationManager_TypeInfo, v11);
    sub_1BE4ACC(&UIInput_OnValidate_TypeInfo, v12);
    sub_1BE4ACC(&Method_SupportDeckNameInputMenu_EndOpen__, v13);
    sub_1BE4ACC(&StringLiteral_12643/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, v14);
    sub_1BE4ACC(&StringLiteral_12644/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, v15);
    sub_1BE4ACC(&StringLiteral_12647/*"SUPPORT_SELECT_NAME_CLEAR"*/, v16);
    sub_1BE4ACC(&StringLiteral_3797/*"COMMON_CONFIRM_DECIDE"*/, v17);
    sub_1BE4ACC(&StringLiteral_3795/*"COMMON_CONFIRM_CANCEL"*/, v18);
    sub_1BE4ACC(&StringLiteral_12628/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, v19);
    byte_4B633AB = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.changeName, (int64_t)deckName, v22, v23, v24, v25, v26, v27);
  this->fields.baseName = deckName;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.baseName, (int64_t)deckName, v28, v29, v30, v31, v32, v33);
  this->fields.initName = initName;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.initName, (int64_t)initName, v34, v35, v36, v37, v38, v39);
  this->fields.callbackFunc = callback;
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.callbackFunc, (int64_t)callback, v40, v41, v42, v43, v44, v45);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12644/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12643/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_18;
  UILabel__set_text(explanationLabel, (System_String_o *)gameObject, 0LL);
  clearLabel = this->fields.clearLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12647/*"SUPPORT_SELECT_NAME_CLEAR"*/, 0LL);
  if ( !clearLabel )
    goto LABEL_18;
  UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0LL);
  initLabel = this->fields.initLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12628/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, 0LL);
  if ( !initLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0LL);
  inputTarget = this->fields.inputTarget;
  v51 = (UIInput_OnValidate_o *)sub_1BE4D18(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v51, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !inputTarget )
    goto LABEL_18;
  inputTarget->fields.onValidate = v51;
  sub_1BE4A70((PartyOrganizationUtility_o *)&inputTarget->fields.onValidate, (int64_t)v51, v52, v53, v54, v55, v56, v57);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B633A8 & 1) == 0 )
  {
    sub_1BE4ACC(&SupportDeckNameInputMenu_CallbackFunc_TypeInfo, value);
    byte_4B633A8 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B633AD & 1) == 0 )
  {
    sub_1BE4ACC(&LocalizationManager_TypeInfo, initName);
  ...
  sub_1BE4A70((PartyOrganizationUtility_o *)&this->fields.changeName, (int64_t)Text, v8, v9, v10, v11, v12, v13);
        ...
        const MethodInfo *method)
{
  if ( (byte_4B633B4 & 1) == 0 )
  {
    sub_1BE4ACC(&StringLiteral_3224/*"BaseWindow/ButtonRoot/CancleButton"*/, method);
    byte_4B633B4 = 1;
  }
  return (System_String_o *)StringLiteral_3224/*"BaseWindow/ButtonRoot/CancleButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A232B0;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A23258;
}
