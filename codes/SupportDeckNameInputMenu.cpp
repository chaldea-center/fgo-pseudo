        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1BAB3C0(p_callbackFunc, 0, (int32_t)name, (int32_t)method);
...
void __fastcall SupportDeckNameInputMenu__Close(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  SupportDeckNameInputMenu__Close_33515980(this, 0LL, v2);
}


void __fastcall SupportDeckNameInputMenu__Close_33515980(
        SupportDeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25CE & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_UnityEngine_Component_GetComponent_Collider___, v6);
    sub_1BAB41C(&Method_SupportDeckNameInputMenu_EndClose__, v7);
    byte_4AB25CE = 1;
  }
  ...
  if ( !inputTarget
    || (inputTarget = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                   inputTarget,
                                                   (const MethodInfo_2EBAE18 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
  {
    sub_1BAB678(inputTarget, v8);
  }
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( !inputTarget
      || (inputTarget = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_2EBAE18 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0LL )
    {
      sub_1BAB678(inputTarget, method);
    }
...
void __fastcall SupportDeckNameInputMenu__OnClickCancel(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB25D0 & 1) == 0 )
  {
    sub_1BAB41C(&Method_SupportDeckNameInputMenu_OnClickCancel__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BAB434(Method_SupportDeckNameInputMenu_OnClickCancel__);
...
void __fastcall SupportDeckNameInputMenu__OnClickClear(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB25D1 & 1) == 0 )
  {
    sub_1BAB41C(&Method_SupportDeckNameInputMenu_OnClickClear__, method);
    sub_1BAB41C(&StringLiteral_1/*""*/, v3);
    byte_4AB25D1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BAB434(Method_SupportDeckNameInputMenu_OnClickClear__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BAB400(v4, v4[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickDecide(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB25CF & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SupportDeckNameInputMenu_OnClickDecide__, v3);
    byte_4AB25CF = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BAB434(Method_SupportDeckNameInputMenu_OnClickDecide__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BAB400(v4, v4[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickInit(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB25D2 & 1) == 0 )
  {
    sub_1BAB41C(&Method_SupportDeckNameInputMenu_OnClickInit__, method);
    byte_4AB25D2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BAB434(Method_SupportDeckNameInputMenu_OnClickInit__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25CA & 1) == 0 )
  {
    sub_1BAB41C(&System_Action_TypeInfo, deckName);
    sub_1BAB41C(&Method_UnityEngine_Component_GetComponent_Collider___, v9);
    sub_1BAB41C(&Method_EmojiUtility_ValidateNameText__, v10);
    sub_1BAB41C(&LocalizationManager_TypeInfo, v11);
    sub_1BAB41C(&UIInput_OnValidate_TypeInfo, v12);
    sub_1BAB41C(&Method_SupportDeckNameInputMenu_EndOpen__, v13);
    sub_1BAB41C(&StringLiteral_12478/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, v14);
    sub_1BAB41C(&StringLiteral_12479/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, v15);
    sub_1BAB41C(&StringLiteral_12482/*"SUPPORT_SELECT_NAME_CLEAR"*/, v16);
    sub_1BAB41C(&StringLiteral_3755/*"COMMON_CONFIRM_DECIDE"*/, v17);
    sub_1BAB41C(&StringLiteral_3753/*"COMMON_CONFIRM_CANCEL"*/, v18);
    sub_1BAB41C(&StringLiteral_12463/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, v19);
    byte_4AB25CA = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.changeName, (int32_t)deckName, v22, v23);
  this->fields.baseName = deckName;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.baseName, (int32_t)deckName, v24, v25);
  this->fields.initName = initName;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.initName, (int32_t)initName, v26, v27);
  this->fields.callbackFunc = callback;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callback, v28, v29);
  titleLabel = this->fields.titleLabel;
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12479/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12478/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_18;
  UILabel__set_text(explanationLabel, (System_String_o *)gameObject, 0LL);
  clearLabel = this->fields.clearLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12482/*"SUPPORT_SELECT_NAME_CLEAR"*/, 0LL);
  if ( !clearLabel )
    goto LABEL_18;
  UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0LL);
  initLabel = this->fields.initLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12463/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, 0LL);
  if ( !initLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0LL);
  inputTarget = this->fields.inputTarget;
  v35 = (UIInput_OnValidate_o *)sub_1BAB668(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v35, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !inputTarget )
    goto LABEL_18;
  inputTarget->fields.onValidate = v35;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&inputTarget->fields.onValidate, (int32_t)v35, v36, v37);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25C7 & 1) == 0 )
  {
    sub_1BAB41C(&SupportDeckNameInputMenu_CallbackFunc_TypeInfo, value);
    byte_4AB25C7 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB25CC & 1) == 0 )
  {
    sub_1BAB41C(&LocalizationManager_TypeInfo, initName);
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.changeName, (int32_t)Text, v8, v9);
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB25D3 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_3188/*"BaseWindow/ButtonRoot/CancleButton"*/, method);
    byte_4AB25D3 = 1;
  }
  return (System_String_o *)StringLiteral_3188/*"BaseWindow/ButtonRoot/CancleButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19EB2AC;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19EB254;
}
