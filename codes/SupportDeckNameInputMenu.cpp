        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1CE66A4(p_callbackFunc, 0, (int32_t)name, (int32_t)method, v4, v5, v6, v7);
...
void SupportDeckNameInputMenu__Close(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  SupportDeckNameInputMenu__Close_36623284(this, 0, v2);
}


void SupportDeckNameInputMenu__Close_36623284(
        SupportDeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00EE2 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SupportDeckNameInputMenu_EndClose__);
    byte_4E00EE2 = 1;
  }
  ...
  if ( this->fields.state == 1 )
  {
    ...
    if ( !inputTarget
      || (inputTarget = (UnityEngine_Component_o *)UnityEngine_Component__GetComponent_object_(
                                                     ...
                                                     (const MethodInfo_31FAB78 *)Method_UnityEngine_Component_GetComponent_Collider___)) == 0 )
    {
      sub_1CE6958(inputTarget, method);
    }
...
void SupportDeckNameInputMenu__OnClickCancel(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00EE4 & 1) == 0 )
  {
    sub_1CE6700(&Method_SupportDeckNameInputMenu_OnClickCancel__);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E00EE4 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SupportDeckNameInputMenu_OnClickCancel__);
...
void SupportDeckNameInputMenu__OnClickClear(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00EE5 & 1) == 0 )
  {
    sub_1CE6700(&Method_SupportDeckNameInputMenu_OnClickClear__);
    sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4E00EE5 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SupportDeckNameInputMenu_OnClickClear__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
...
void SupportDeckNameInputMenu__OnClickDecide(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00EE3 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SupportDeckNameInputMenu_OnClickDecide__);
    byte_4E00EE3 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SupportDeckNameInputMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
...
void SupportDeckNameInputMenu__OnClickInit(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E00EE6 & 1) == 0 )
  {
    sub_1CE6700(&Method_SupportDeckNameInputMenu_OnClickInit__);
    byte_4E00EE6 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1CE6718(Method_SupportDeckNameInputMenu_OnClickInit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1CE66E4(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    inputTarget = this->fields.inputTarget;
    if ( !inputTarget )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E00EDE & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SupportDeckNameInputMenu_EndOpen__);
    sub_1CE6700(&StringLiteral_12684/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/);
    sub_1CE6700(&StringLiteral_12685/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/);
    sub_1CE6700(&StringLiteral_12688/*"SUPPORT_SELECT_NAME_CLEAR"*/);
    sub_1CE6700(&StringLiteral_3715/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1CE6700(&StringLiteral_3713/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1CE6700(&StringLiteral_12669/*"SUPPORT_SELECT_DECK_NAME_INIT"*/);
    byte_4E00EDE = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.changeName, (int32_t)deckName, v11, v12, v13, v14, v15, v16);
  this->fields.baseName = deckName;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.baseName, (int32_t)deckName, v17, v18, v19, v20, v21, v22);
  this->fields.initName = initName;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.initName, (int32_t)initName, v23, v24, v25, v26, v27, v28);
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12685/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12684/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, 0);
  if ( !explanationLabel )
    goto LABEL_18;
  UILabel__set_text(explanationLabel, (System_String_o *)gameObject, 0);
  clearLabel = this->fields.clearLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12688/*"SUPPORT_SELECT_NAME_CLEAR"*/, 0);
  if ( !clearLabel )
    goto LABEL_18;
  UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0);
  initLabel = this->fields.initLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12669/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, 0);
  if ( !initLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0);
  inputTarget = this->fields.inputTarget;
  v40 = (UIInput_OnValidate_o *)sub_1CE694C(UIInput_OnValidate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&this->fields.changeName, (int32_t)initName, v7, v8, v9, v10, v11, v12);
...
System_String_o *SupportDeckNameInputMenu__get_closeBtnPath(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4E00EE7 & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_3089/*"BaseWindow/ButtonRoot/CancleButton"*/);
    byte_4E00EE7 = 1;
  }
  return (System_String_o *)StringLiteral_3089/*"BaseWindow/ButtonRoot/CancleButton"*/;
}
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1B13B00;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1B13AA8;
}
