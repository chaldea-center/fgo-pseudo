...
void __fastcall SupportDeckNameInputMenu__Close(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  SupportDeckNameInputMenu__Close_33217856(this, 0LL, v2);
}


void __fastcall SupportDeckNameInputMenu__Close_33217856(
        SupportDeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57AAA & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SupportDeckNameInputMenu_EndClose__);
    byte_4A57AAA = 1;
  }
  ...
  System_Action___ctor(v8, (Il2CppObject *)this, Method_SupportDeckNameInputMenu_EndClose__, 0LL);
...
void __fastcall SupportDeckNameInputMenu__OnClickCancel(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57AAC & 1) == 0 )
  {
    sub_1B885B0(&Method_SupportDeckNameInputMenu_OnClickCancel__);
    sub_1B885B0(&StringLiteral_1/*""*/);
    byte_4A57AAC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_SupportDeckNameInputMenu_OnClickCancel__);
...
void __fastcall SupportDeckNameInputMenu__OnClickClear(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57AAD & 1) == 0 )
  {
    sub_1B885B0(&Method_SupportDeckNameInputMenu_OnClickClear__);
    sub_1B885B0(&StringLiteral_1/*""*/);
    byte_4A57AAD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_SupportDeckNameInputMenu_OnClickClear__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickDecide(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57AAB & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SupportDeckNameInputMenu_OnClickDecide__);
    byte_4A57AAB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_SupportDeckNameInputMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickInit(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A57AAE & 1) == 0 )
  {
    sub_1B885B0(&Method_SupportDeckNameInputMenu_OnClickInit__);
    byte_4A57AAE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B885C8(Method_SupportDeckNameInputMenu_OnClickInit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1B88594(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0LL);
    inputTarget = this->fields.inputTarget;
    if ( !inputTarget )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A57AA6 & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_SupportDeckNameInputMenu_EndOpen__);
    sub_1B885B0(&StringLiteral_12451/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/);
    sub_1B885B0(&StringLiteral_12452/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/);
    sub_1B885B0(&StringLiteral_12455/*"SUPPORT_SELECT_NAME_CLEAR"*/);
    sub_1B885B0(&StringLiteral_3757/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1B885B0(&StringLiteral_3755/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1B885B0(&StringLiteral_12436/*"SUPPORT_SELECT_DECK_NAME_INIT"*/);
    byte_4A57AA6 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12452/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12451/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_18;
  UILabel__set_text(explanationLabel, (System_String_o *)gameObject, 0LL);
  clearLabel = this->fields.clearLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12455/*"SUPPORT_SELECT_NAME_CLEAR"*/, 0LL);
  if ( !clearLabel )
    goto LABEL_18;
  UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0LL);
  initLabel = this->fields.initLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12436/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, 0LL);
  if ( !initLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0LL);
  inputTarget = this->fields.inputTarget;
  v24 = (UIInput_OnValidate_o *)sub_1B887FC(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v24, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !inputTarget )
    goto LABEL_18;
  inputTarget->fields.onValidate = v24;
  sub_1B88554((ServantStatusBattleListViewItem_o *)&inputTarget->fields.onValidate, (int32_t)v24, v25, v26);
...
LABEL_18:
  ...
  System_Action___ctor(v29, (Il2CppObject *)this, Method_SupportDeckNameInputMenu_EndOpen__, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.changeName, (int32_t)initName, v7, v8);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A57AAF & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_3192/*"BaseWindow/ButtonRoot/CancleButton"*/);
    byte_4A57AAF = 1;
  }
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19CAF58;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19CAF00;
}
