...
void SupportDeckNameInputMenu__Close(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  SupportDeckNameInputMenu__Close_35585884(this, 0, v2);
}


void SupportDeckNameInputMenu__Close_35585884(
        SupportDeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3400A & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SupportDeckNameInputMenu_EndClose__);
    byte_4C3400A = 1;
  }
...
void SupportDeckNameInputMenu__OnClickCancel(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3400C & 1) == 0 )
  {
    sub_1C32C20(&Method_SupportDeckNameInputMenu_OnClickCancel__);
    sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C3400C = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_SupportDeckNameInputMenu_OnClickCancel__);
...
void SupportDeckNameInputMenu__OnClickClear(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3400D & 1) == 0 )
  {
    sub_1C32C20(&Method_SupportDeckNameInputMenu_OnClickClear__);
    sub_1C32C20(&StringLiteral_1/*""*/);
    byte_4C3400D = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_SupportDeckNameInputMenu_OnClickClear__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
...
void SupportDeckNameInputMenu__OnClickDecide(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3400B & 1) == 0 )
  {
    ...
    sub_1C32C20(&Method_SupportDeckNameInputMenu_OnClickDecide__);
    byte_4C3400B = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_SupportDeckNameInputMenu_OnClickDecide__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
...
void SupportDeckNameInputMenu__OnClickInit(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C3400E & 1) == 0 )
  {
    sub_1C32C20(&Method_SupportDeckNameInputMenu_OnClickInit__);
    byte_4C3400E = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1C32C38(Method_SupportDeckNameInputMenu_OnClickInit__);
    v4 = (System_Reflection_MethodBase_o *)sub_1C32C04(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
    inputTarget = this->fields.inputTarget;
    if ( !inputTarget )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C34006 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_12553/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/);
    sub_1C32C20(&StringLiteral_12554/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/);
    sub_1C32C20(&StringLiteral_12557/*"SUPPORT_SELECT_NAME_CLEAR"*/);
    sub_1C32C20(&StringLiteral_3686/*"COMMON_CONFIRM_DECIDE"*/);
    sub_1C32C20(&StringLiteral_3684/*"COMMON_CONFIRM_CANCEL"*/);
    sub_1C32C20(&StringLiteral_12538/*"SUPPORT_SELECT_DECK_NAME_INIT"*/);
    byte_4C34006 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0);
  if ( !gameObject )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12554/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12553/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, 0);
  if ( !explanationLabel )
    goto LABEL_18;
  UILabel__set_text(explanationLabel, (System_String_o *)gameObject, 0);
  clearLabel = this->fields.clearLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12557/*"SUPPORT_SELECT_NAME_CLEAR"*/, 0);
  if ( !clearLabel )
    goto LABEL_18;
  UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0);
  initLabel = this->fields.initLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12538/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, 0);
  if ( !initLabel )
    goto LABEL_18;
        ...
        const MethodInfo *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)&this->fields.changeName, (int32_t)initName, v6, v7);
...
System_String_o *SupportDeckNameInputMenu__get_closeBtnPath(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  if ( (byte_4C3400F & 1) == 0 )
  {
    sub_1C32C20(&StringLiteral_3070/*"BaseWindow/ButtonRoot/CancleButton"*/);
    byte_4C3400F = 1;
  }
...
LABEL_5:
  ...
  this->fields.invoke_impl = (intptr_t)sub_1A73C24;
LABEL_6:
  this->fields.extra_arg = (intptr_t)sub_1A73BCC;
}
