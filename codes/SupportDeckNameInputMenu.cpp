...
void __fastcall SupportDeckNameInputMenu__Close(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  SupportDeckNameInputMenu__Close_32982268(this, 0LL, v2);
}


void __fastcall SupportDeckNameInputMenu__Close_32982268(
        SupportDeckNameInputMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A055D9 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_SupportDeckNameInputMenu_EndClose__, v7);
    byte_4A055D9 = 1;
  }
...
void __fastcall SupportDeckNameInputMenu__OnClickCancel(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A055DB & 1) == 0 )
  {
    sub_1B686D4(&Method_SupportDeckNameInputMenu_OnClickCancel__, method);
  ...
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickCancel__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B686EC(Method_SupportDeckNameInputMenu_OnClickCancel__);
...
void __fastcall SupportDeckNameInputMenu__OnClickClear(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A055DC & 1) == 0 )
  {
    sub_1B686D4(&Method_SupportDeckNameInputMenu_OnClickClear__, method);
    sub_1B686D4(&StringLiteral_1/*""*/, v3);
    byte_4A055DC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickClear__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B686EC(Method_SupportDeckNameInputMenu_OnClickClear__);
    v5 = (System_Reflection_MethodBase_o *)sub_1B686B8(v4, v4[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickDecide(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A055DA & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_SupportDeckNameInputMenu_OnClickDecide__, v3);
    byte_4A055DA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickDecide__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1B686EC(Method_SupportDeckNameInputMenu_OnClickDecide__);
    v5 = (System_Reflection_MethodBase_o *)sub_1B686B8(v4, v4[4]);
...
void __fastcall SupportDeckNameInputMenu__OnClickInit(SupportDeckNameInputMenu_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A055DD & 1) == 0 )
  {
    sub_1B686D4(&Method_SupportDeckNameInputMenu_OnClickInit__, method);
    byte_4A055DD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_SupportDeckNameInputMenu_OnClickInit__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B686EC(Method_SupportDeckNameInputMenu_OnClickInit__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A055D5 & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_EmojiUtility_ValidateNameText__, v10);
    sub_1B686D4(&LocalizationManager_TypeInfo, v11);
    sub_1B686D4(&UIInput_OnValidate_TypeInfo, v12);
    sub_1B686D4(&Method_SupportDeckNameInputMenu_EndOpen__, v13);
    sub_1B686D4(&StringLiteral_12401/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, v14);
    sub_1B686D4(&StringLiteral_12402/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, v15);
    sub_1B686D4(&StringLiteral_12405/*"SUPPORT_SELECT_NAME_CLEAR"*/, v16);
    sub_1B686D4(&StringLiteral_3733/*"COMMON_CONFIRM_DECIDE"*/, v17);
    sub_1B686D4(&StringLiteral_3731/*"COMMON_CONFIRM_CANCEL"*/, v18);
    sub_1B686D4(&StringLiteral_12386/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, v19);
    byte_4A055D5 = 1;
  }
  gameObject = UnityEngine_Component__get_gameObject((UnityEngine_Component_o *)this, 0LL);
  if ( !gameObject )
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12402/*"SUPPORT_SELECT_INPUT_DECK_NAME_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_18;
  UILabel__set_text(titleLabel, (System_String_o *)gameObject, 0LL);
  explanationLabel = this->fields.explanationLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12401/*"SUPPORT_SELECT_INPUT_DECK_NAME_EXPLANATION"*/, 0LL);
  if ( !explanationLabel )
    goto LABEL_18;
  UILabel__set_text(explanationLabel, (System_String_o *)gameObject, 0LL);
  clearLabel = this->fields.clearLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12405/*"SUPPORT_SELECT_NAME_CLEAR"*/, 0LL);
  if ( !clearLabel )
    goto LABEL_18;
  UILabel__set_text(clearLabel, (System_String_o *)gameObject, 0LL);
  initLabel = this->fields.initLabel;
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_12386/*"SUPPORT_SELECT_DECK_NAME_INIT"*/, 0LL);
  if ( !initLabel )
    goto LABEL_18;
  ...
  UnityEngine_Collider__set_enabled((UnityEngine_Collider_o *)gameObject, 0, 0LL);
  inputTarget = this->fields.inputTarget;
  v35 = (UIInput_OnValidate_o *)sub_1B68920(UIInput_OnValidate_TypeInfo);
  UIInput_OnValidate___ctor(v35, 0LL, Method_EmojiUtility_ValidateNameText__, 0LL);
  if ( !inputTarget )
    goto LABEL_18;
  inputTarget->fields.onValidate = v35;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&inputTarget->fields.onValidate, (int32_t)v35, v36, v37);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A055D2 & 1) == 0 )
  {
    sub_1B686D4(&SupportDeckNameInputMenu_CallbackFunc_TypeInfo, value);
    byte_4A055D2 = 1;
  }
  callbackFunc = this->fields.callbackFunc;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A055D7 & 1) == 0 )
  {
    sub_1B686D4(&LocalizationManager_TypeInfo, initName);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.changeName, (int32_t)Text, v8, v9);
        ...
        const MethodInfo *method)
{
  if ( (byte_4A055DE & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_3170/*"BaseWindow/ButtonRoot/CancleButton"*/, method);
    byte_4A055DE = 1;
  }
  return (System_String_o *)StringLiteral_3170/*"BaseWindow/ButtonRoot/CancleButton"*/;
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19ACD04;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19ACCAC;
}
