        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E792FD & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_21434/*"itemSelectIdx"*/);
    sub_1D0F0B4(&StringLiteral_23227/*"presentIds"*/);
    sub_1D0F0B4(&StringLiteral_21435/*"itemSelectNum"*/);
    byte_4E792FD = 1;
  }
  v9 = (MiniMessagePack_MiniMessagePacker_o *)sub_1D0F300(MiniMessagePack_MiniMessagePacker_TypeInfo);
  ...
  RequestBase__addField_45601604((RequestBase_o *)this, (System_String_o *)StringLiteral_23227/*"presentIds"*/, v13, v14);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21434/*"itemSelectIdx"*/, itemSelectIdx, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21435/*"itemSelectNum"*/, itemSelectNum, v16);
...
System_String_o *UserPresentReceiveRequest__getMockData(UserPresentReceiveRequest_o *this, const MethodInfo *method)
{
  if ( (byte_4E792FC & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&StringLiteral_9253/*"MockUserPresentReceiveResponse"*/);
    byte_4E792FC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9253/*"MockUserPresentReceiveResponse"*/, 0);
}
...
System_String_o *UserPresentReceiveRequest__getURL(UserPresentReceiveRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1D0F0B4(&NetworkManager_TypeInfo);
    sub_1D0F0B4(&StringLiteral_23224/*"present/receive"*/);
    byte_4E792FB = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65562772(BaseUrl, (System_String_o *)StringLiteral_23224/*"present/receive"*/, 0);
}
