        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF027D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_21207/*"itemSelectIdx"*/);
    sub_1C7BAE8(&StringLiteral_22981/*"presentIds"*/);
    sub_1C7BAE8(&StringLiteral_21208/*"itemSelectNum"*/);
    byte_4CF027D = 1;
  }
  v9 = (MiniMessagePack_MiniMessagePacker_o *)sub_1C7BD34(MiniMessagePack_MiniMessagePacker_TypeInfo);
  ...
  RequestBase__addField_44748720((RequestBase_o *)this, (System_String_o *)StringLiteral_22981/*"presentIds"*/, v13, v14);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21207/*"itemSelectIdx"*/, itemSelectIdx, v15);
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21208/*"itemSelectNum"*/, itemSelectNum, v16);
...
System_String_o *UserPresentReceiveRequest__getMockData(UserPresentReceiveRequest_o *this, const MethodInfo *method)
{
  if ( (byte_4CF027C & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_9168/*"MockUserPresentReceiveResponse"*/);
    byte_4CF027C = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9168/*"MockUserPresentReceiveResponse"*/, 0);
}
...
System_String_o *UserPresentReceiveRequest__getURL(UserPresentReceiveRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C7BAE8(&NetworkManager_TypeInfo);
    sub_1C7BAE8(&StringLiteral_22978/*"present/receive"*/);
    byte_4CF027B = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_22978/*"present/receive"*/, 0);
}
