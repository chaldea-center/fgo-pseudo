...
System_String_o *__fastcall AccountRegistRequest__getMockData(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, method);
    sub_1C2E12C(&StringLiteral_9283/*"MockAccountRegistRequest"*/, v2);
    byte_4BFEFF7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9283/*"MockAccountRegistRequest"*/, 0LL);
}
...
System_String_o *__fastcall AccountRegistRequest__getURL(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C2E12C(&NetworkManager_TypeInfo, method);
    sub_1C2E12C(&StringLiteral_16924/*"account/regist"*/, v2);
    byte_4BFEFF6 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_63235584(BaseUrl, (System_String_o *)StringLiteral_16924/*"account/regist"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFEFF8 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v6);
    ...
    sub_1C2E12C(&StringLiteral_24888/*"userId"*/, v11);
    byte_4BFEFF8 = 1;
  }
  ...
  if ( v12
    && (v13 = v12, ResponseData__checkError_42594652(v12, 0LL))
    && (success = (System_Collections_Generic_Dictionary_object__object__o *)v13->fields.success) != 0LL )
  {
    ...
    if ( !Item
      ...
      || (v19 = (System_String_o *)((__int64 (__fastcall *)(Il2CppObject *, Il2CppMethodPointer))Item->klass->vtable[3].method)(
                                     Item,
                                     Item->klass->vtable[4].methodPtr),
          (Item = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38A7F90 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL)
