...
void AccountRegistRequest__AddAppCheckField(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0643C & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_14405/*"The token wasn't created in time"*/);
    sub_1CE6700(&StringLiteral_16986/*"appCheckToken"*/);
    sub_1CE6700(&StringLiteral_16984/*"appCheckErrorMessage"*/);
    sub_1CE6700(&StringLiteral_6796/*"Firebase wasn't available"*/);
    byte_4E0643C = 1;
  }
  ...
  if ( !v3->static_fields->_CanUseFirebase_k__BackingField )
  {
    ...
    {
      v7 = &StringLiteral_6796/*"Firebase wasn't available"*/;
      goto LABEL_32;
    }
  }
  if ( !v3->_2.cctor_finished )
...
LABEL_34:
    ...
    v10 = &StringLiteral_16986/*"appCheckToken"*/;
...
LABEL_18:
  ...
  {
    v7 = &StringLiteral_14405/*"The token wasn't created in time"*/;
LABEL_32:
    RequestBase__addField_45365032(
      (RequestBase_o *)this,
      (System_String_o *)StringLiteral_16984/*"appCheckErrorMessage"*/,
      (System_String_o *)*v7,
      0);
    v8 = 0;
    goto LABEL_47;
  ...
  v10 = &StringLiteral_16984/*"appCheckErrorMessage"*/;
  AppCheckToken_k__BackingField = v12->static_fields->_AppCheckTokenError_k__BackingField;
LABEL_46:
  RequestBase__addField_45365032((RequestBase_o *)this, (System_String_o *)*v10, AppCheckToken_k__BackingField, 0);
  v8 = 1;
LABEL_47:
  if ( !FirebaseScript_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(FirebaseScript_TypeInfo);
  ...
  if ( UnityEngine_PlayerPrefs__HasKey(v13->static_fields->_AppCheckPrevMessageKey_k__BackingField, 0) )
  {
    ...
    String_72876844 = UnityEngine_PlayerPrefs__GetString_72876844(
                        ...
                        0);
    RequestBase__addField_45365032((RequestBase_o *)this, AppCheckPrevMessageKey_k__BackingField, String_72876844, 0);
    if ( !byte_4E042CA )
    {
      sub_1CE6700(&FirebaseScript_TypeInfo);
      byte_4E042CA = 1;
...
System_String_o *AccountRegistRequest__getMockData(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&StringLiteral_9197/*"MockAccountRegistRequest"*/);
    byte_4E06439 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9197/*"MockAccountRegistRequest"*/, 0);
}
...
System_String_o *AccountRegistRequest__getURL(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&NetworkManager_TypeInfo);
    sub_1CE6700(&StringLiteral_16796/*"account/regist"*/);
    byte_4E06438 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_65122828(BaseUrl, (System_String_o *)StringLiteral_16796/*"account/regist"*/, 0);
}
    ...
    && (success = (System_Collections_Generic_Dictionary_object__object__o *)v6->fields.success) != 0 )
  {
    ...
    if ( !Item
      ...
      || (v12 = (System_String_o *)((__int64 (__fastcall *)(Il2CppObject *, const MethodInfo *))Item->klass->vtable[3].methodPtr)(
                                     Item,
                                     Item->klass->vtable[3].method),
          (Item = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0)
...
LABEL_16:
    ...
    v13 = &StringLiteral_22728/*"ok"*/;
  }
  else
  {
    v13 = &StringLiteral_22555/*"ng"*/;
  }
