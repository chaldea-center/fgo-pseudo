...
void AccountRegistRequest__AddAppCheckField(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  if ( !v3->static_fields->_CanUseFirebase_k__BackingField )
  {
    ...
    {
      v7 = &StringLiteral_6780/*"Firebase wasn't available"*/;
      goto LABEL_32;
    }
  }
  if ( !v3->_2.cctor_finished )
...
LABEL_34:
    ...
    v10 = &StringLiteral_16934/*"appCheckToken"*/;
...
LABEL_18:
  ...
  {
    v7 = &StringLiteral_14361/*"The token wasn't created in time"*/;
LABEL_32:
  ...
  v10 = &StringLiteral_16932/*"appCheckErrorMessage"*/;
  AppCheckToken_k__BackingField = v12->static_fields->_AppCheckTokenError_k__BackingField;
LABEL_46:
  RequestBase__addField_44907496((RequestBase_o *)this, (System_String_o *)*v10, AppCheckToken_k__BackingField, 0);
  v8 = 1;
LABEL_47:
  if ( !FirebaseScript_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(FirebaseScript_TypeInfo);
  ...
  if ( UnityEngine_PlayerPrefs__HasKey(v13->static_fields->_AppCheckPrevMessageKey_k__BackingField, 0) )
  {
    ...
    String_72078212 = UnityEngine_PlayerPrefs__GetString_72078212(
                        ...
                        0);
    RequestBase__addField_44907496((RequestBase_o *)this, AppCheckPrevMessageKey_k__BackingField, String_72078212, 0);
    if ( !byte_4D30291 )
    {
      sub_1C93AD4(&FirebaseScript_TypeInfo);
      byte_4D30291 = 1;
...
System_String_o *AccountRegistRequest__getMockData(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&NetworkManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_9180/*"MockAccountRegistRequest"*/);
    byte_4D323F3 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9180/*"MockAccountRegistRequest"*/, 0);
}
...
System_String_o *AccountRegistRequest__getURL(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&NetworkManager_TypeInfo);
    sub_1C93AD4(&StringLiteral_16744/*"account/regist"*/);
    byte_4D323F2 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64425724(BaseUrl, (System_String_o *)StringLiteral_16744/*"account/regist"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D323F4 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_24869/*"userId"*/);
    byte_4D323F4 = 1;
  }
    ...
    && (success = (System_Collections_Generic_Dictionary_object__object__o *)v6->fields.success) != 0 )
  {
    ...
    if ( !Item
      ...
      || (v12 = (System_String_o *)((__int64 (__fastcall *)(Il2CppObject *, const MethodInfo *))Item->klass->vtable[3].methodPtr)(
                                     Item,
                                     Item->klass->vtable[3].method),
          (Item = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0)
