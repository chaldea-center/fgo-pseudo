...
System_String_o *__fastcall AccountRegistRequest__getMockData(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B70694(&NetworkManager_TypeInfo);
    sub_B70694(&StringLiteral_9264/*"MockAccountRegistRequest"*/);
    byte_434FB3A = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return NetworkManager__getMockFile((System_String_o *)StringLiteral_9264/*"MockAccountRegistRequest"*/, 0LL);
}
...
System_String_o *__fastcall AccountRegistRequest__getURL(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B70694(&NetworkManager_TypeInfo);
    sub_B70694(&StringLiteral_16468/*"account/regist"*/);
    byte_434FB39 = 1;
  }
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_16468/*"account/regist"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_434FB3B & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_16771/*"authKey"*/);
    sub_B70694(&StringLiteral_21408/*"ng"*/);
    sub_B70694(&StringLiteral_22313/*"secretKey"*/);
    sub_B70694(&StringLiteral_23419/*"userId"*/);
    byte_434FB3B = 1;
  }
    ...
    && (success = (System_Collections_Generic_Dictionary_Type__IStoreExtension__o *)v6->fields.success) != 0LL )
  {
    Item = (NetworkManager_o *)System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
                                 ...
                                 (System_Type_o *)StringLiteral_23419/*"userId"*/,
    ...
    Item = (NetworkManager_o *)System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
                                 success,
                                 (System_Type_o *)StringLiteral_16771/*"authKey"*/,
                                 (const MethodInfo_2F4F924 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
    if ( !Item
      || (v11 = (System_String_o *)((__int64 (__fastcall *)(NetworkManager_o *, void *))Item->klass->vtable._3_ToString.method)(
          ...
          (Item = (NetworkManager_o *)System_Collections_Generic_Dictionary_Type__IStoreExtension___get_Item(
                                        success,
                                        (System_Type_o *)StringLiteral_22313/*"secretKey"*/,
      ...
      || (v12 = (System_String_o *)((__int64 (__fastcall *)(NetworkManager_o *, void *))Item->klass->vtable._3_ToString.method)(
                                     Item,
                                     Item->klass[1]._1.image),
          (Item = (NetworkManager_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2CE992C *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL)
...
LABEL_17:
    ...
    v13 = &StringLiteral_21560/*"ok"*/;
  }
  else
  {
    v13 = &StringLiteral_21408/*"ng"*/;
  }
