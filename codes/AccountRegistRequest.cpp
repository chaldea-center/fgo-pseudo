...
System_String_o *__fastcall AccountRegistRequest__getMockData(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&NetworkManager_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_9249/*"MockAccountRegistRequest"*/, v2);
    byte_4B683EE = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
System_String_o *__fastcall AccountRegistRequest__getURL(AccountRegistRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BE4ACC(&NetworkManager_TypeInfo, method);
    sub_1BE4ACC(&StringLiteral_16843/*"account/regist"*/, v2);
    byte_4B683ED = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62698808(BaseUrl, (System_String_o *)StringLiteral_16843/*"account/regist"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B683EF & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_SingletonMonoBehaviour_NetworkManager__get_Instance__, v6);
    sub_1BE4ACC(&StringLiteral_22543/*"ok"*/, v7);
    sub_1BE4ACC(&StringLiteral_17184/*"authKey"*/, v8);
    sub_1BE4ACC(&StringLiteral_22370/*"ng"*/, v9);
    sub_1BE4ACC(&StringLiteral_23408/*"secretKey"*/, v10);
    sub_1BE4ACC(&StringLiteral_24766/*"userId"*/, v11);
    byte_4B683EF = 1;
  }
  ...
  if ( v12
    && (v13 = v12, ResponseData__checkError_42194996(v12, 0LL))
    && (success = (System_Collections_Generic_Dictionary_object__object__o *)v13->fields.success) != 0LL )
  {
    Item = System_Collections_Generic_Dictionary_object__object___get_Item(
             ...
             (Il2CppObject *)StringLiteral_24766/*"userId"*/,
    ...
    Item = System_Collections_Generic_Dictionary_object__object___get_Item(
             success,
             (Il2CppObject *)StringLiteral_17184/*"authKey"*/,
             (const MethodInfo_32B01A4 *)Method_System_Collections_Generic_Dictionary_string__object__get_Item__);
    if ( !Item
      || (v18 = (System_String_o *)((__int64 (__fastcall *)(Il2CppObject *, Il2CppMethodPointer))Item->klass->vtable[3].method)(
          ...
          (Item = System_Collections_Generic_Dictionary_object__object___get_Item(
                    success,
                    (Il2CppObject *)StringLiteral_23408/*"secretKey"*/,
      ...
      || (v19 = (System_String_o *)((__int64 (__fastcall *)(Il2CppObject *, Il2CppMethodPointer))Item->klass->vtable[3].method)(
                                     Item,
                                     Item->klass->vtable[4].methodPtr),
          (Item = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3828DC8 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL)
