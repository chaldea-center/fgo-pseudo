void __fastcall BuffAggregationArgs___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB8234 & 1) == 0 )
  {
    sub_1BAB41C(&BuffAggregationArgs_TypeInfo, v1);
    byte_4AB8234 = 1;
  }
  v2 = sub_1BAB668(BuffAggregationArgs_TypeInfo);
  *(_BYTE *)(v2 + 16) = 1;
  *(_BYTE *)(v2 + 18) = 1;
  ...
  *(_WORD *)(v2 + 16) = 256;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)BuffAggregationArgs_TypeInfo->static_fields, v2, v3, v4);
  v5 = sub_1BAB668(BuffAggregationArgs_TypeInfo);
  *(_BYTE *)(v5 + 16) = 1;
  *(_BYTE *)(v5 + 18) = 1;
  System_Object___ctor((Il2CppObject *)v5, 0LL);
  static_fields = BuffAggregationArgs_TypeInfo->static_fields;
  static_fields->LogicSet = (struct BuffAggregationArgs_o *)v5;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->LogicSet, v5, v7, v8);
}
