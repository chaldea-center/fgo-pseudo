void __fastcall BuffAggregationArgs___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB6C84 & 1) == 0 )
  {
    sub_1C13D24(&BuffAggregationArgs_TypeInfo, v1);
    byte_4BB6C84 = 1;
  }
  v2 = sub_1C13F70(BuffAggregationArgs_TypeInfo);
  *(_BYTE *)(v2 + 16) = 1;
  *(_BYTE *)(v2 + 18) = 1;
  ...
  *(_WORD *)(v2 + 16) = 256;
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)BuffAggregationArgs_TypeInfo->static_fields, v2, v3, v4, v5, v6, v7, v8);
  v9 = sub_1C13F70(BuffAggregationArgs_TypeInfo);
  *(_BYTE *)(v9 + 16) = 1;
  *(_BYTE *)(v9 + 18) = 1;
  System_Object___ctor((Il2CppObject *)v9, 0LL);
  static_fields = BuffAggregationArgs_TypeInfo->static_fields;
  static_fields->LogicSet = (struct BuffAggregationArgs_o *)v9;
  sub_1C13CC8((PartyOrganizationUtility_o *)&static_fields->LogicSet, v9, v11, v12, v13, v14, v15, v16);
}
