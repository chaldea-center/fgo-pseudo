void BuffAggregationArgs___cctor(const MethodInfo *method)
{
  ...
  v1 = sub_1C93D20(BuffAggregationArgs_TypeInfo);
  *(_BYTE *)(v1 + 16) = 1;
  *(_WORD *)(v1 + 18) = 257;
  ...
  *(_WORD *)(v1 + 16) = 256;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)BuffAggregationArgs_TypeInfo->static_fields, v1, v2, v3, v4, v5, v6, v7);
  v8 = sub_1C93D20(BuffAggregationArgs_TypeInfo);
  *(_BYTE *)(v8 + 16) = 1;
  *(_WORD *)(v8 + 18) = 257;
  System_Object___ctor((Il2CppObject *)v8, 0);
  static_fields = BuffAggregationArgs_TypeInfo->static_fields;
  static_fields->LogicSet = (struct BuffAggregationArgs_o *)v8;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&static_fields->LogicSet, v8, v10, v11, v12, v13, v14, v15);
  v16 = sub_1C93D20(BuffAggregationArgs_TypeInfo);
  *(_BYTE *)(v16 + 16) = 1;
  *(_WORD *)(v16 + 18) = 257;
  ...
  *(_BYTE *)(v16 + 19) = 0;
  ...
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v17->EndMotionDisplaySet, v16, v18, v19, v20, v21, v22, v23);
}
