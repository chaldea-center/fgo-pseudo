        ...
        const MethodInfo *method)
{
  ...
  IntArray = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_21369/*"overwriteLimitCountSvtIds"*/, 0LL, 0LL);
  *overwriteLimitCountSvtIds = IntArray;
  ...
  {
    v24 = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_21370/*"overwriteLimitCounts"*/, 0LL, 0LL);
    *overwriteLimitCounts = v24;
    sub_B2C2F8(
      ...
      v29,
      v30);
    v31 = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_21368/*"overwriteLimitCountIconIds"*/, 0LL, 0LL);
  ...
  else
  {
    *overwriteLimitCounts = 0LL;
    sub_B2C2F8((BattleServantConfConponent_o *)overwriteLimitCounts, 0LL, v18, v19, v20, v21, v22, v23);
    *overwriteLimitCountIconIds = 0LL;
    sub_B2C2F8((BattleServantConfConponent_o *)overwriteLimitCountIconIds, 0LL, v39, v40, v41, v42, v43, v44);
    return 0;
  }
}
...
int32_t __fastcall RestrictionBaseEntity__GetUserEventDeckNo(RestrictionBaseEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_22980/*"useEventDeckNo"*/, 1, 0LL);
}
