        ...
        const MethodInfo *method)
{
  ...
  IntArray = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22542/*"overwriteLimitCountSvtIds"*/, 0, 0);
  *overwriteLimitCountSvtIds = IntArray;
  sub_1C2D434((CGThumbnailListItem_o *)overwriteLimitCountSvtIds, (int32_t)IntArray, v10, v11);
  if ( *overwriteLimitCountSvtIds )
  {
    v14 = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22543/*"overwriteLimitCounts"*/, 0, 0);
    *overwriteLimitCounts = v14;
    sub_1C2D434((CGThumbnailListItem_o *)overwriteLimitCounts, (int32_t)v14, v15, v16);
    v17 = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22540/*"overwriteLimitCountIconIds"*/, 0, 0);
    *overwriteLimitCountIconIds = v17;
    sub_1C2D434((CGThumbnailListItem_o *)overwriteLimitCountIconIds, (int32_t)v17, v18, v19);
  ...
  else
  {
    ...
    *overwriteLimitCountIconIds = 0;
    sub_1C2D434((CGThumbnailListItem_o *)overwriteLimitCountIconIds, 0, v21, v22);
    return 0;
  }
}
...
int32_t RestrictionBaseEntity__GetUserEventDeckNo(RestrictionBaseEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24457/*"useEventDeckNo"*/, 1, 0);
}
