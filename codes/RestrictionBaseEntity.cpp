        ...
        const MethodInfo *method)
{
  ...
  IntArray = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22782/*"overwriteLimitCountSvtIds"*/, 0LL, 0LL);
  *overwriteLimitCountSvtIds = IntArray;
  sub_1C1AB78((PartyOrganizationUtility_o *)overwriteLimitCountSvtIds, (int64_t)IntArray, v12, v13, v14, v15, v16, v17);
  if ( *overwriteLimitCountSvtIds )
  {
    v24 = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22783/*"overwriteLimitCounts"*/, 0LL, 0LL);
    *overwriteLimitCounts = v24;
    sub_1C1AB78((PartyOrganizationUtility_o *)overwriteLimitCounts, (int64_t)v24, v25, v26, v27, v28, v29, v30);
    v31 = EntityScriptUtil__GetIntArray(this->fields.script, (System_String_o *)StringLiteral_22781/*"overwriteLimitCountIconIds"*/, 0LL, 0LL);
    *overwriteLimitCountIconIds = v31;
    sub_1C1AB78((PartyOrganizationUtility_o *)overwriteLimitCountIconIds, (int64_t)v31, v32, v33, v34, v35, v36, v37);
    return *overwriteLimitCounts != 0LL;
  }
  else
  {
    *overwriteLimitCounts = 0LL;
    sub_1C1AB78((PartyOrganizationUtility_o *)overwriteLimitCounts, 0LL, v18, v19, v20, v21, v22, v23);
    *overwriteLimitCountIconIds = 0LL;
    sub_1C1AB78((PartyOrganizationUtility_o *)overwriteLimitCountIconIds, 0LL, v39, v40, v41, v42, v43, v44);
    return 0;
  }
}
...
int32_t __fastcall RestrictionBaseEntity__GetUserEventDeckNo(RestrictionBaseEntity_o *this, const MethodInfo *method)
{
  ...
  return EntityScriptUtil__GetIntValue(this->fields.script, (System_String_o *)StringLiteral_24771/*"useEventDeckNo"*/, 1, 0LL);
}
