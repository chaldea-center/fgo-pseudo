void __fastcall EventRecipeMaster___ctor(EventRecipeMaster_o *this, const MethodInfo *method)
{
  if ( (byte_48E28FF & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataMasterBase_EventRecipeMaster__EventRecipeEntity__int___ctor__, method);
    byte_48E28FF = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    381,
    (const MethodInfo_2FE6A0C *)Method_DataMasterBase_EventRecipeMaster__EventRecipeEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E2900 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&EventRecipeEntity_TypeInfo, v6);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRecipeEntity__Add__, v7);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRecipeEntity__ToArray__, v8);
    sub_1B00CCC(&Method_System_Collections_Generic_List_EventRecipeEntity___ctor__, v9);
    sub_1B00CCC(&System_Collections_Generic_List_EventRecipeEntity__TypeInfo, v10);
    byte_48E2900 = 1;
  }
  ...
  v13 = (System_Collections_Generic_List_object__o *)sub_1B00F18(System_Collections_Generic_List_EventRecipeEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v13,
    (const MethodInfo_33C119C *)Method_System_Collections_Generic_List_EventRecipeEntity___ctor__);
  if ( Count >= 1 )
  {
    v14 = 0;
    while ( 1 )
...
LABEL_17:
  ...
  return (EventRecipeEntity_array *)System_Collections_Generic_List_object___ToArray(
                                      v13,
                                      (const MethodInfo_33C3528 *)Method_System_Collections_Generic_List_EventRecipeEntity__ToArray__);
}