  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__51649344, 0, 0) )
    {
      ...
      if ( ComponentInChildren_object__51649344 )
      {
        ...
        v23 = v20[26];
        v24 = v20[27];
        UILabel__set_overflowMethod((UILabel_o *)ComponentInChildren_object__51649344, 2, 0);
        ...
        if ( isSelected )
          ...
          v28 = v18;
        UILabel__set_effectColor((UILabel_o *)ComponentInChildren_object__51649344, *(UnityEngine_Color_o *)&v25, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3F98 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_11965/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/);
    sub_1C713B0(&StringLiteral_11945/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/);
    sub_1C713B0(&StringLiteral_11973/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_REFLECT_OWN"*/);
  ...
  if ( item && item->fields.supportRandomLimitCountList )
  {
    ...
    if ( userSvtEntity )
    {
      ...
      *(_QWORD *)&v40.fields.fakeValue = v6;
      v8 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_49297952(v40, 0) != 0;
    }
    else
    {
      v8 = 1;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v12 = LocalizationManager__Get((System_String_o *)StringLiteral_11973/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_REFLECT_OWN"*/, 0);
    ...
    while ( 1 )
    {
      ...
      if ( limitCountButtonList && (v20 = LODWORD(limitCountButtonList->max_length), (__int64)v16 < (int)v20) )
      {
        if ( v16 >= v20 )
LABEL_71:
          sub_1C71610(reflectOwnSettingButton);
      ...
      if ( ((unsigned __int8)reflectOwnSettingButton & 1) != 0 )
      {
        ...
        if ( v18 <= v22->static_fields->ServantLimitMax )
        {
          ...
          if ( v28 )
          {
            ...
            v30 = System_String__Concat_64031724((System_String_o *)StringLiteral_11945/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v29, 0);
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          }
          else
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v30 = (System_String_o *)StringLiteral_11946/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_CLOSE"*/;
          }
        ...
        {
          reflectOwnSettingButton = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A5F158 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !reflectOwnSettingButton )
            goto LABEL_54;
    ...
    reflectOwnSettingButton = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_11965/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/,
                                                           0);
    if ( !explanationLabel )
LABEL_54:
      sub_1C71608(reflectOwnSettingButton, item);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC3F99 & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_11963/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_COMBINE_INFO"*/);
    sub_1C713B0(&StringLiteral_11964/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_ENABLE_INFO"*/);
    byte_4CC3F99 = 1;
  }
  maskBase = this->fields.maskBase;
  if ( !maskBase )
LABEL_21:
    sub_1C71608(maskBase, *(_QWORD *)&maskType);
  if ( !maskType )
  {
  ...
  if ( maskType == 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v6 = &StringLiteral_11963/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_COMBINE_INFO"*/;
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v6 = &StringLiteral_11964/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_ENABLE_INFO"*/;
  }
