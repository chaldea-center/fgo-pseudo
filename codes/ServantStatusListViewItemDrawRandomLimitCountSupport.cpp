        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB380 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_UnityEngine_Component_GetComponent_UISprite___, v11);
    sub_1B64870(&LocalizationManager_TypeInfo, v12);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v13);
    sub_1B64870(&StringLiteral_17411/*"btn_bg_20"*/, v14);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    ...
    if ( !Component_object )
      goto LABEL_38;
    v18 = &StringLiteral_17412/*"btn_bg_21"*/;
    if ( !isSelected )
      v18 = &StringLiteral_17411/*"btn_bg_20"*/;
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__48440272, 0LL, 0LL) )
    {
      ...
      if ( ComponentInChildren_object__48440272 )
      {
        ...
        v28 = v25[26];
        v29 = v25[27];
        UILabel__set_overflowMethod((UILabel_o *)ComponentInChildren_object__48440272, 2, 0LL);
        ...
        if ( isSelected )
          ...
          v33 = v23;
        UILabel__set_effectColor((UILabel_o *)ComponentInChildren_object__48440272, *(UnityEngine_Color_o *)&v30, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB37E & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_11852/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/, v12);
    sub_1B64870(&StringLiteral_11833/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v13);
    sub_1B64870(&StringLiteral_11860/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_REFLECT_OWN"*/, v14);
    sub_1B64870(&StringLiteral_11834/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_CLOSE"*/, v15);
    byte_49FB37E = 1;
  }
  v50 = 0;
  if ( item && item->fields.supportRandomLimitCountList )
  {
    ...
    if ( userSvtEntity )
    {
      ...
      *(_QWORD *)&v51.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46180532(v51, 0LL) != 0;
    }
    else
    {
      v19 = 1;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_11860/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_REFLECT_OWN"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      if ( limitCountButtonList && (v30 = limitCountButtonList->max_length, (__int64)v26 < (int)v30) )
      {
        if ( v26 >= v30 )
LABEL_69:
          sub_1B64AD4(reflectOwnSettingButton, item);
      ...
      if ( ((unsigned __int8)reflectOwnSettingButton & 1) != 0 )
      {
        ...
        if ( v28 <= v32->static_fields->ServantLimitMax )
        {
          ...
          if ( v39 )
          {
            ...
            v41 = System_String__Concat_61383576((System_String_o *)StringLiteral_11833/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v40, 0LL);
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          }
          else
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v41 = (System_String_o *)StringLiteral_11834/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_CLOSE"*/;
          }
        ...
        {
          reflectOwnSettingButton = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !reflectOwnSettingButton )
            goto LABEL_52;
          ...
          else
          {
            ...
            if ( !byte_49F9E5A )
            {
              sub_1B64870(&LocalizationManager_TypeInfo, v36);
              byte_49F9E5A = 1;
            }
    ...
    reflectOwnSettingButton = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_11852/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/,
                                                           0LL);
    if ( !explanationLabel )
LABEL_52:
      sub_1B64ACC(reflectOwnSettingButton, item);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FB37F & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_11850/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_COMBINE_INFO"*/, v6);
    sub_1B64870(&StringLiteral_11851/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_ENABLE_INFO"*/, v7);
    byte_49FB37F = 1;
  }
  maskBase = this->fields.maskBase;
  if ( !maskBase )
LABEL_21:
    sub_1B64ACC(maskBase, *(_QWORD *)&maskType);
  if ( !maskType )
  {
  ...
  if ( maskType == 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = &StringLiteral_11850/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_COMBINE_INFO"*/;
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = &StringLiteral_11851/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_ENABLE_INFO"*/;
  }
