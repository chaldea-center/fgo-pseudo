        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB16A4 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_UnityEngine_Component_GetComponent_UISprite___, v11);
    sub_1C13D24(&LocalizationManager_TypeInfo, v12);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v13);
    sub_1C13D24(&StringLiteral_17741/*"btn_auto_on"*/, v14);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    ...
    if ( !Component_object )
      goto LABEL_38;
    v18 = &StringLiteral_17742/*"btn_badge_organization"*/;
    if ( !isSelected )
      v18 = &StringLiteral_17741/*"btn_auto_on"*/;
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__49832308, 0LL, 0LL) )
    {
      ...
      if ( ComponentInChildren_object__49832308 )
      {
        ...
        v28 = v25[26];
        v29 = v25[27];
        UILabel__set_overflowMethod((UILabel_o *)ComponentInChildren_object__49832308, 2, 0LL);
        ...
        if ( isSelected )
          ...
          v33 = v23;
        UILabel__set_effectColor((UILabel_o *)ComponentInChildren_object__49832308, *(UnityEngine_Color_o *)&v30, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB16A2 & 1) == 0 )
  {
    ...
    sub_1C13D24(&UserServantEntity_TypeInfo, v11);
    sub_1C13D24(&StringLiteral_12101/*"SERVANT_STATUS_PUSH_CONFIRM_CANCEL"*/, v12);
    sub_1C13D24(&StringLiteral_12082/*"SERVANT_STATUS_EXPLANATION_SERVANT_QUEST_DARK"*/, v13);
    sub_1C13D24(&StringLiteral_12109/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_DIALOG_SETTING_OWN"*/, v14);
    sub_1C13D24(&StringLiteral_12083/*"SERVANT_STATUS_EXPLANATION_SERVANT_QUEST_INTERLUDE"*/, v15);
    byte_4BB16A2 = 1;
  }
  v50 = 0;
  if ( item && item->fields.supportRandomLimitCountList )
  {
    ...
    if ( userSvtEntity )
    {
      ...
      *(_QWORD *)&v51.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_47490608(v51, 0LL) != 0;
    }
    else
    {
      v19 = 1;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_12109/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_DIALOG_SETTING_OWN"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      if ( limitCountButtonList && (v30 = limitCountButtonList->max_length, (__int64)v26 < (int)v30) )
      {
        if ( v26 >= v30 )
LABEL_69:
          sub_1C13F88(reflectOwnSettingButton, item);
      ...
      if ( ((unsigned __int8)reflectOwnSettingButton & 1) != 0 )
      {
        ...
        if ( v28 <= v32->static_fields->ServantLimitMax )
        {
          ...
          if ( v39 )
          {
            ...
            v41 = System_String__Concat_62967944((System_String_o *)StringLiteral_12082/*"SERVANT_STATUS_EXPLANATION_SERVANT_QUEST_DARK"*/, v40, 0LL);
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          }
          else
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v41 = (System_String_o *)StringLiteral_12083/*"SERVANT_STATUS_EXPLANATION_SERVANT_QUEST_INTERLUDE"*/;
          }
        ...
        {
          reflectOwnSettingButton = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !reflectOwnSettingButton )
            goto LABEL_52;
          ...
          else
          {
            ...
            if ( !byte_4BAFD99 )
            {
              sub_1C13D24(&LocalizationManager_TypeInfo, v36);
              byte_4BAFD99 = 1;
            }
    ...
    reflectOwnSettingButton = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_12101/*"SERVANT_STATUS_PUSH_CONFIRM_CANCEL"*/,
                                                           0LL);
    if ( !explanationLabel )
LABEL_52:
      sub_1C13F80(reflectOwnSettingButton, item);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB16A3 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_12099/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/, v6);
    sub_1C13D24(&StringLiteral_12100/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/, v7);
    byte_4BB16A3 = 1;
  }
  maskBase = this->fields.maskBase;
  if ( !maskBase )
LABEL_21:
    sub_1C13F80(maskBase, *(_QWORD *)&maskType);
  if ( !maskType )
  {
  ...
  if ( maskType == 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = &StringLiteral_12099/*"SERVANT_STATUS_PROFILE_CV_TITLE"*/;
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = &StringLiteral_12100/*"SERVANT_STATUS_PROFILE_ILLUST_TITLE"*/;
  }
