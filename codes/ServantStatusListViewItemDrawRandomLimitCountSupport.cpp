        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2ACE3 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_UnityEngine_Component_GetComponent_UISprite___, v11);
    sub_1B761C0(&LocalizationManager_TypeInfo, v12);
    sub_1B761C0(&UnityEngine_Object_TypeInfo, v13);
    sub_1B761C0(&StringLiteral_17473/*"btn_bg_20"*/, v14);
  ...
  if ( ((unsigned __int8)Component_object & 1) != 0 )
  {
    ...
    if ( !Component_object )
      goto LABEL_38;
    v18 = &StringLiteral_17474/*"btn_bg_21"*/;
    if ( !isSelected )
      v18 = &StringLiteral_17473/*"btn_bg_20"*/;
    ...
    if ( UnityEngine_Object__op_Inequality((UnityEngine_Object_o *)ComponentInChildren_object__48599312, 0LL, 0LL) )
    {
      ...
      if ( ComponentInChildren_object__48599312 )
      {
        ...
        v28 = v25[26];
        v29 = v25[27];
        UILabel__set_overflowMethod((UILabel_o *)ComponentInChildren_object__48599312, 2, 0LL);
        ...
        if ( isSelected )
          ...
          v33 = v23;
        UILabel__set_effectColor((UILabel_o *)ComponentInChildren_object__48599312, *(UnityEngine_Color_o *)&v30, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2ACE1 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_11900/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/, v12);
    sub_1B761C0(&StringLiteral_11881/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v13);
    sub_1B761C0(&StringLiteral_11908/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_REFLECT_OWN"*/, v14);
    sub_1B761C0(&StringLiteral_11882/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_CLOSE"*/, v15);
    byte_4A2ACE1 = 1;
  }
  v50 = 0;
  if ( item && item->fields.supportRandomLimitCountList )
  {
    ...
    if ( userSvtEntity )
    {
      ...
      *(_QWORD *)&v51.fields.fakeValue = v17;
      v19 = CodeStage_AntiCheat_ObscuredTypes_ObscuredInt__op_Implicit_46336972(v51, 0LL) != 0;
    }
    else
    {
      v19 = 1;
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v22 = LocalizationManager__Get((System_String_o *)StringLiteral_11908/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_REFLECT_OWN"*/, 0LL);
    ...
    while ( 1 )
    {
      ...
      if ( limitCountButtonList && (v30 = limitCountButtonList->max_length, (__int64)v26 < (int)v30) )
      {
        if ( v26 >= v30 )
LABEL_69:
          sub_1B76424(reflectOwnSettingButton, item);
      ...
      if ( ((unsigned __int8)reflectOwnSettingButton & 1) != 0 )
      {
        ...
        if ( v28 <= v32->static_fields->ServantLimitMax )
        {
          ...
          if ( v39 )
          {
            ...
            v41 = System_String__Concat_61535060((System_String_o *)StringLiteral_11881/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_"*/, v40, 0LL);
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
          }
          else
          {
            if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
              j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
            v41 = (System_String_o *)StringLiteral_11882/*"SERVANT_STATUS_IMAGE_LIMIT_COUNT_LEVEL_CLOSE"*/;
          }
        ...
        {
          reflectOwnSettingButton = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_371257C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
          if ( !reflectOwnSettingButton )
            goto LABEL_52;
          ...
          else
          {
            ...
            if ( !byte_4A29821 )
            {
              sub_1B761C0(&LocalizationManager_TypeInfo, v36);
              byte_4A29821 = 1;
            }
    ...
    reflectOwnSettingButton = (UnityEngine_Component_o *)LocalizationManager__Get(
                                                           (System_String_o *)StringLiteral_11900/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_EXPLANATION"*/,
                                                           0LL);
    if ( !explanationLabel )
LABEL_52:
      sub_1B7641C(reflectOwnSettingButton, item);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2ACE2 & 1) == 0 )
  {
    ...
    sub_1B761C0(&StringLiteral_11898/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_COMBINE_INFO"*/, v6);
    sub_1B761C0(&StringLiteral_11899/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_ENABLE_INFO"*/, v7);
    byte_4A2ACE2 = 1;
  }
  maskBase = this->fields.maskBase;
  if ( !maskBase )
LABEL_21:
    sub_1B7641C(maskBase, *(_QWORD *)&maskType);
  if ( !maskType )
  {
  ...
  if ( maskType == 1 )
  {
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = &StringLiteral_11898/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_COMBINE_INFO"*/;
  }
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    v9 = &StringLiteral_11899/*"SERVANT_STATUS_RANDOM_LIMIT_COUNT_FRIEND_ENABLE_INFO"*/;
  }
