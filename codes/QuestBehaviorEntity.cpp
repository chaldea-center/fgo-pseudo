        ...
        const MethodInfo *method)
{
  if ( (byte_49BB2FE & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&phase);
    byte_49BB2FE = 1;
  }
...
bool __fastcall QuestBehaviorEntity__checkConditions(QuestBehaviorEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BB300 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataManager_GetMasterData_UserItemMaster___, v3);
