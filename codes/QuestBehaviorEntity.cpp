        ...
        const MethodInfo *method)
{
  if ( (byte_49FEF48 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&phase);
    byte_49FEF48 = 1;
  }
...
bool __fastcall QuestBehaviorEntity__checkConditions(QuestBehaviorEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FEF4A & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_DataManager_GetMasterData_UserItemMaster___, v3);
