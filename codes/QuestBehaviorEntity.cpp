        ...
        const MethodInfo *method)
{
  if ( (byte_4B67017 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&phase);
    byte_4B67017 = 1;
  }
...
bool __fastcall QuestBehaviorEntity__checkConditions(QuestBehaviorEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B67019 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_DataManager_GetMasterData_UserItemMaster___, v3);
