        ...
        const MethodInfo *method)
{
  if ( (byte_4A0908B & 1) == 0 )
  {
    sub_1B686D4(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&phase);
    byte_4A0908B = 1;
  }
...
bool __fastcall QuestBehaviorEntity__checkConditions(QuestBehaviorEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A0908D & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_DataManager_GetMasterData_UserItemMaster___, v3);
