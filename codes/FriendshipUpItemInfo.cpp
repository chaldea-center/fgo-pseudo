void __fastcall FriendshipUpItemInfo___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB021E & 1) == 0 )
  {
    sub_1C13D24(&FriendshipUpItemInfo_TypeInfo, v1);
    sub_1C13D24(&StringLiteral_7012/*"FriendshipExceed"*/, v2);
    sub_1C13D24(&StringLiteral_25497/*"{0}:{1:D2}:{2:D2}"*/, v3);
    sub_1C13D24(&StringLiteral_7010/*"FriendScene"*/, v4);
    byte_4BB021E = 1;
  }
  FriendshipUpItemInfo_TypeInfo->static_fields->SAVE_KEY_FRIENDSHIP_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_7012/*"FriendshipExceed"*/;
  sub_1C13CC8(FriendshipUpItemInfo_TypeInfo->static_fields);
  static_fields = FriendshipUpItemInfo_TypeInfo->static_fields;
  static_fields->SAVE_KEY_FRIENDSHIP_EVENT_ITEM_USE_STATE = (struct System_String_o *)StringLiteral_7010/*"FriendScene"*/;
  sub_1C13CC8(&static_fields->SAVE_KEY_FRIENDSHIP_EVENT_ITEM_USE_STATE);
  v6 = FriendshipUpItemInfo_TypeInfo->static_fields;
  v6->FRIENDSHIP_UP_ITEM_ICON_SUFFIX = (struct System_String_o *)StringLiteral_25497/*"{0}:{1:D2}:{2:D2}"*/;
  sub_1C13CC8(&v6->FRIENDSHIP_UP_ITEM_ICON_SUFFIX);
}
...
void __fastcall FriendshipUpItemInfo___ctor_32745224(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB0218 & 1) == 0 )
  {
    sub_1C13D24(&AtlasManager_TypeInfo, *(_QWORD *)&id);
    byte_4BB0218 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  this->fields._Id_k__BackingField = id;
  this->fields._Name_k__BackingField = name;
  sub_1C13CC8(&this->fields._Name_k__BackingField);
  this->fields._SpriteName_k__BackingField = spriteName;
  sub_1C13CC8(&this->fields._SpriteName_k__BackingField);
...
bool __fastcall FriendshipUpItemInfo__GetUseFlag(FriendshipUpItemInfo_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB0219 & 1) == 0 )
  {
    sub_1C13D24(&FriendshipUpItemInfo_TypeInfo, method);
    byte_4BB0219 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB021C & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_CommonUI_CloseNotificationDialog__, v5);
    sub_1C13D24(&LocalizationManager_TypeInfo, v6);
    sub_1C13D24(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v7);
    sub_1C13D24(&StringLiteral_10449/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_FULL"*/, v8);
  ...
  {
    v18 = (FriendshipUpItemInfo_o *)sub_1C14240(v12);
  ...
  else
  {
    ...
    v15 = LocalizationManager__Get((System_String_o *)StringLiteral_10449/*"PARTY_ORGANIZATION_EVENT_TARGET_PT_FULL"*/, 0LL);
...
void __fastcall FriendshipUpItemInfo__SetUseFlag(FriendshipUpItemInfo_o *this, bool flag, const MethodInfo *method)
{
  ...
  if ( (byte_4BB021A & 1) == 0 )
  {
    sub_1C13D24(&FriendshipUpItemInfo_TypeInfo, flag);
    byte_4BB021A = 1;
  }
