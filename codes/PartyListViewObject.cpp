...
void __fastcall PartyListViewObject__Awake(PartyListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4354CA4 & 1) == 0 )
  {
    sub_B70694(&Method_UnityEngine_GameObject_GetComponent_PartyListViewItemDraw___);
    byte_4354CA4 = 1;
  }
  ...
  Component_srcLineSprite = (struct PartyListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                dispObject,
                                                                (const MethodInfo_1D4AE28 *)Method_UnityEngine_GameObject_GetComponent_PartyListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1D4AE28 *)Method_UnityEngine_GameObject_GetComponent_PartyListViewObject___)) == 0LL) )
  {
...
void __fastcall PartyListViewObject__EndCloseShowServant(PartyListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4354CAE & 1) == 0 )
  {
    sub_B70694(&PartyListViewManager_TypeInfo);
    byte_4354CAE = 1;
  }
...
void __fastcall PartyListViewObject__EndShowEquip(PartyListViewObject_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4354CB2 & 1) == 0 )
  {
    ...
    sub_B70694(&Method_PartyListViewObject_EndCloseShowEquip__);
    sub_B70694(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_B70694(&StringLiteral_10151/*"OnModifyListView"*/);
    byte_4354CB2 = 1;
  }
  ...
  if ( !v6
    ...
    || (UnityEngine_Component__SendMessage(
          ...
          (System_String_o *)StringLiteral_10151/*"OnModifyListView"*/,
          (Il2CppObject *)v3,
          0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354CAD & 1) == 0 )
  {
    sub_B70694(&System_Action_TypeInfo);
    sub_B70694(&ManagerConfig_TypeInfo);
    sub_B70694(&Method_PartyListViewObject_EndCloseShowServant__);
    sub_B70694(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_B70694(&StringLiteral_10151/*"OnModifyListView"*/);
    byte_4354CAD = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B70694(&System_Action_TypeInfo);
    sub_B70694(&Method_PartyListViewObject_EndCloseShowServantQuestJump__);
    sub_B70694(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4354CAF = 1;
  }
  if ( questId < 1 )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyListViewObject__Init_30829508(
        PartyListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyListViewObject__Init_30830768(
        PartyListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyListViewObject__Init_30830832(
        PartyListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall PartyListViewObject__OpenEquipDetail(PartyListViewObject_o *this, int32_t m, const MethodInfo *method)
{
  ...
  if ( (byte_4354CB1 & 1) == 0 )
  {
    ...
    sub_B70694(&PartyListViewItem_TypeInfo);
    sub_B70694(&Method_PartyListViewObject_EndShowEquip__);
    sub_B70694(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_B70694(&SoundManager_TypeInfo);
    byte_4354CB1 = 1;
  }
...
LABEL_42:
                ...
                if ( this )
                {
                  ...
                  EquipTarget1 = PartyOrganizationListViewItem__get_EquipTarget1(
                                   (PartyOrganizationListViewItem_o *)v10,
                                   0LL);
                  v18 = (ServantStatusDialog_EndDelegate_o *)sub_B70764(ServantStatusDialog_EndDelegate_TypeInfo);
                  ...
                  if ( Instance )
                  {
                    if ( IsNpc )
                      ...
                      v19 = 14;
                    CommonUI__OpenServantEquipStatusDialog_17919496(Instance, v19, EquipTarget1, v18, 0LL, 0LL);
                    return;
                  }
                }
              }
              else
              {
                ...
                EquipUserSvtId = PartyOrganizationListViewItem__get_EquipUserSvtId(
                                   (PartyOrganizationListViewItem_o *)v10,
                                   0LL);
                v13 = (ServantStatusDialog_EndDelegate_o *)sub_B70764(ServantStatusDialog_EndDelegate_TypeInfo);
                ServantStatusDialog_EndDelegate___ctor(
                  v13,
                  (Il2CppObject *)v4,
                  Method_PartyListViewObject_EndShowEquip__,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4354CAC & 1) == 0 )
  {
    ...
    sub_B70694(&PartyListViewItem_TypeInfo);
    sub_B70694(&PartyListViewManager_TypeInfo);
    sub_B70694(&Method_PartyListViewObject_EndShowServantWithQuest__);
    sub_B70694(&Method_PartyListViewObject_EndShowServant__);
    sub_B70694(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_B70694(&SoundManager_TypeInfo);
    byte_4354CAC = 1;
  }
          ...
          if ( v9 )
          {
            ...
            if ( this )
            {
              ...
              if ( this->fields.callbackFunc && !BYTE1(this[1].fields.itemSeed) )
              {
                ...
                if ( v23 )
                {
                  v25 = (ServantStatusDialog_FormationEndDelegate_o *)sub_B70764(ServantStatusDialog_FormationEndDelegate_TypeInfo);
                  ...
                  if ( v24 )
                  {
                    CommonUI__OpenServantStatusDialog_17913536(v24, 1, v9, m, v25, 1, 0LL);
                    return;
                  }
                }
                else
                {
                  v26 = (ServantStatusDialog_EndDelegate_o *)sub_B70764(ServantStatusDialog_EndDelegate_TypeInfo);
                  ServantStatusDialog_EndDelegate___ctor(
                    v26,
                    (Il2CppObject *)v4,
              ...
              else
              {
                ...
                if ( v16 )
                {
                  CommonUI__OpenServantStatusDialog_17917132(v16, 5, ServantLeader, v18, 0LL);
                  return;
                }
              }
            }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B70694(&PartyListViewItem_TypeInfo);
    sub_B70694(&Method_PartyListViewObject_SelectMemberEquip__);
    sub_B70694(&StringLiteral_10081/*"OnClickListViewChangeEquip"*/);
    byte_4354CAB = 1;
  }
  v13 = 0;
            ...
            if ( Member )
            {
              if ( Member[1].fields._IsWaveBattleRestart_k__BackingField )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_SelectMemberEquip__ + 75) & 2) != 0 )
                  v9 = (_QWORD *)sub_B7069C(Method_PartyListViewObject_SelectMemberEquip__);
              ...
              Member = (PartyListViewItem_o *)System_String__Concat_44758168(
                                                (System_String_o *)StringLiteral_10081/*"OnClickListViewChangeEquip"*/,
                                                v12,
                                                0LL);
              if ( manager )
              {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B70694(&PartyListViewItem_TypeInfo);
    sub_B70694(&Method_PartyListViewObject_SelectMemberServant__);
    sub_B70694(&StringLiteral_10082/*"OnClickListViewChangeServant"*/);
    byte_4354CAA = 1;
  }
  v13 = 0;
  if ( this->fields.state == 3 )
            ...
            if ( Member )
            {
              if ( Member[1].fields._IsWaveBattleRestart_k__BackingField )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_SelectMemberServant__ + 75) & 2) != 0 )
                  v9 = (_QWORD *)sub_B7069C(Method_PartyListViewObject_SelectMemberServant__);
                v10 = (System_Reflection_MethodBase_o *)sub_B70678(v9, v9[3]);
                OverwriteAssetSoundName__PlaySystemSe(v10, 2, 0LL);
                return;
              }
              ...
              v12 = System_Int32__ToString((int32_t)&v13, 0LL);
              Member = (PartyListViewItem_o *)System_String__Concat_44758168(
                                                (System_String_o *)StringLiteral_10082/*"OnClickListViewChangeServant"*/,
                                                v12,
                                                0LL);
              if ( manager )
              {
...
void __fastcall PartyListViewObject__SetItem_30834952(
        PartyListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
