...
void __fastcall PartyListViewObject__Awake(PartyListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56FAE & 1) == 0 )
  {
    sub_1B885B0(&Method_UnityEngine_GameObject_GetComponent_PartyListViewItemDraw___);
    byte_4A56FAE = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_PartyListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2ECEEB8 *)Method_UnityEngine_GameObject_GetComponent_PartyListViewObject___)) == 0LL) )
  {
    sub_1B8880C(DragObject, v4);
  }
  PartyListViewObject__Init_31953452((PartyListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void __fastcall PartyListViewObject__EndCloseShowServant(PartyListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A56FB8 & 1) == 0 )
  {
    sub_1B885B0(&PartyListViewManager_TypeInfo);
    byte_4A56FB8 = 1;
  }
...
void __fastcall PartyListViewObject__EndShowEquip(PartyListViewObject_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4A56FBC & 1) == 0 )
  {
    ...
    sub_1B885B0(&Method_PartyListViewObject_EndCloseShowEquip__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_1B885B0(&StringLiteral_9927/*"OnModifyListView"*/);
    byte_4A56FBC = 1;
  }
  ...
  if ( !v6
    ...
    || (UnityEngine_Component__SendMessage(
          ...
          (System_String_o *)StringLiteral_9927/*"OnModifyListView"*/,
          (Il2CppObject *)v3,
          0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56FB7 & 1) == 0 )
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&ManagerConfig_TypeInfo);
    sub_1B885B0(&Method_PartyListViewObject_EndCloseShowServant__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_1B885B0(&StringLiteral_9927/*"OnModifyListView"*/);
    byte_4A56FB7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&System_Action_TypeInfo);
    sub_1B885B0(&Method_PartyListViewObject_EndCloseShowServantQuestJump__);
    sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4A56FB9 = 1;
  }
  if ( questId < 1 )
...
LABEL_31:
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v16, v17);
  switch ( initMode )
  {
    case 0:
      v18 = 0;
...
LABEL_22:
  ...
  {
    *p_callbackFunc = 0LL;
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields.callbackFunc, 0, v21, (int32_t)v22);
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyListViewObject__Init_31953452(
        PartyListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyListViewObject__Init_31954752(
        PartyListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyListViewObject__Init_31954836(
        PartyListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void __fastcall PartyListViewObject__OpenEquipDetail(PartyListViewObject_o *this, int32_t m, const MethodInfo *method)
{
  ...
  if ( (byte_4A56FBB & 1) == 0 )
  {
    ...
    sub_1B885B0(&PartyListViewItem_TypeInfo);
    sub_1B885B0(&Method_PartyListViewObject_EndShowEquip__);
    sub_1B885B0(&Method_PartyListViewObject_OpenEquipDetail__);
    this = (PartyListViewObject_o *)sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4A56FBB = 1;
  }
...
LABEL_32:
                  ...
                  if ( (*((_BYTE *)Method_PartyListViewObject_OpenEquipDetail__ + 83) & 2) != 0 )
                    v24 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_OpenEquipDetail__);
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenEquipDetail__ + 83) & 2) != 0 )
                  v17 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_OpenEquipDetail__);
                ...
                if ( this )
                {
                  ...
                  if ( Instance )
                  {
                    if ( IsNpc )
                      ...
                      v23 = 14;
                    CommonUI__OpenServantEquipStatusDialog_30509528(
                      (CommonUI_o *)Instance,
                      v23,
                      EquipTarget1,
                      v22,
              ...
              else
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenEquipDetail__ + 83) & 2) != 0 )
                  v11 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_OpenEquipDetail__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A56FB6 & 1) == 0 )
  {
    ...
    sub_1B885B0(&PartyListViewItem_TypeInfo);
    sub_1B885B0(&PartyListViewManager_TypeInfo);
    sub_1B885B0(&Method_PartyListViewObject_EndShowServantWithQuest__);
    sub_1B885B0(&Method_PartyListViewObject_EndShowServant__);
    sub_1B885B0(&Method_PartyListViewObject_OpenServantDetail__);
    this = (PartyListViewObject_o *)sub_1B885B0(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4A56FB6 = 1;
  }
  state = v4->fields.state;
            ...
            if ( this )
            {
              ...
              if ( *(_QWORD *)&this->fields.isBusy && !BYTE1(this[1].fields.maxAlphaRate) )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenServantDetail__ + 83) & 2) != 0 )
                  v25 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_OpenServantDetail__);
                ...
                if ( v29 )
                {
                  v31 = (ServantStatusDialog_FormationEndDelegate_o *)sub_1B887FC(ServantStatusDialog_FormationEndDelegate_TypeInfo);
                  ...
                  if ( v30 )
                  {
                    CommonUI__OpenServantStatusDialog_30503084(v30, 1, v9, m, v31, 1, 0LL);
                    return;
                  }
                }
                else
              ...
              else
              {
                ...
                if ( !callbackFunc || FollowerInfo__get_IsNpc(callbackFunc, 0LL) )
                {
                  ...
                  if ( (*((_BYTE *)Method_PartyListViewObject_OpenServantDetail__ + 83) & 2) != 0 )
                    v14 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_OpenServantDetail__);
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenServantDetail__ + 83) & 2) != 0 )
                  v18 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_OpenServantDetail__);
                ...
                if ( v20 )
                {
                  CommonUI__OpenServantStatusDialog_30506432((CommonUI_o *)v20, 5, ServantLeader, v22, 0LL);
                  return;
                }
              }
            }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&PartyListViewItem_TypeInfo);
    sub_1B885B0(&Method_PartyListViewObject_SelectMemberEquip__);
    sub_1B885B0(&StringLiteral_9851/*"OnClickListViewChangeEquip"*/);
    byte_4A56FB5 = 1;
  }
            ...
            if ( Member )
            {
              if ( Member[1].fields._IsWaveBattleRestart_k__BackingField )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_SelectMemberEquip__ + 83) & 2) != 0 )
                  v9 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_SelectMemberEquip__);
              ...
              Member = (PartyListViewItem_o *)System_String__Concat_61707032(
                                                (System_String_o *)StringLiteral_9851/*"OnClickListViewChangeEquip"*/,
                                                v12,
                                                0LL);
              if ( manager )
              {
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B885B0(&PartyListViewItem_TypeInfo);
    sub_1B885B0(&Method_PartyListViewObject_SelectMemberServant__);
    sub_1B885B0(&StringLiteral_9852/*"OnClickListViewChangeServant"*/);
    byte_4A56FB4 = 1;
  }
  if ( this->fields.state == 3 )
  {
            ...
            if ( Member )
            {
              if ( Member[1].fields._IsWaveBattleRestart_k__BackingField )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_SelectMemberServant__ + 83) & 2) != 0 )
                  v9 = (_QWORD *)sub_1B885C8(Method_PartyListViewObject_SelectMemberServant__);
                v10 = (System_Reflection_MethodBase_o *)sub_1B88594(v9, v9[4]);
                OverwriteAssetSoundName__PlaySystemSe(v10, 2, 0LL);
                return;
              }
              ...
              v12 = System_Int32__ToString((int32_t)&v13, 0LL);
              Member = (PartyListViewItem_o *)System_String__Concat_61707032(
                                                (System_String_o *)StringLiteral_9852/*"OnClickListViewChangeServant"*/,
                                                v12,
                                                0LL);
              if ( manager )
              {
...
void __fastcall PartyListViewObject__SetItem_31959312(
        PartyListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  v11 = (PartyListViewObject_o *)sub_1B88ACC(v8);
