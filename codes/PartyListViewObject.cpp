...
void PartyListViewObject__Awake(PartyListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C5269F & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponent_PartyListViewItemDraw___);
    byte_4C5269F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_PartyListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_31510CC *)Method_UnityEngine_GameObject_GetComponent_PartyListViewObject___)) == 0) )
  {
    sub_1C3E7C0(DragObject, v4);
  }
  PartyListViewObject__Init_34158448((PartyListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
void PartyListViewObject__EndCloseShowServant(PartyListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C526A9 & 1) == 0 )
  {
    sub_1C3E564(&PartyListViewManager_TypeInfo);
    byte_4C526A9 = 1;
  }
...
void PartyListViewObject__EndShowEquip(PartyListViewObject_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4C526AD & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_PartyListViewObject_EndCloseShowEquip__);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_1C3E564(&StringLiteral_9934/*"OnModifyListView"*/);
    byte_4C526AD = 1;
  }
...
void PartyListViewObject__EndShowServant(PartyListViewObject_o *this, bool isDecide, const MethodInfo *method)
{
  ...
  if ( (byte_4C526A8 & 1) == 0 )
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&ManagerConfig_TypeInfo);
    sub_1C3E564(&Method_PartyListViewObject_EndCloseShowServant__);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    this = (PartyListViewObject_o *)sub_1C3E564(&StringLiteral_9934/*"OnModifyListView"*/);
    byte_4C526A8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&System_Action_TypeInfo);
    sub_1C3E564(&Method_PartyListViewObject_EndCloseShowServantQuestJump__);
    sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C526AA = 1;
  }
  if ( questId < 1 )
...
LABEL_31:
  ...
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.callbackFunc, (int32_t)callbackFunc, v16, v17);
  switch ( initMode )
  {
    case 0:
      v18 = 0;
...
LABEL_22:
  ...
  {
    *p_callbackFunc = 0;
    sub_1C3E508((CGThumbnailListItem_o *)&this->fields.callbackFunc, 0, v21, v22);
...
void PartyListViewObject__InitAlphaMask(PartyListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C526AE & 1) == 0 )
  {
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponentInChildren_ListViewItemSeed___);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponentInParent_UIScrollView___);
    sub_1C3E564(&Method_UnityEngine_GameObject_GetComponentsInChildren_BoxCollider___);
    sub_1C3E564(&UnityEngine_Object_TypeInfo);
    byte_4C526AE = 1;
  }
  dispObject = this->fields.dispObject;
  ...
  ComponentsInChildren_object__51715312 = UnityEngine_GameObject__GetComponentsInChildren_object__51715312(
                                            dispObject,
                                            (const MethodInfo_3151CF0 *)Method_UnityEngine_GameObject_GetComponentsInChildren_BoxCollider___);
  this->fields.colliders = (struct UnityEngine_BoxCollider_array *)ComponentsInChildren_object__51715312;
  sub_1C3E508((CGThumbnailListItem_o *)&this->fields.colliders, (int32_t)ComponentsInChildren_object__51715312, v5, v6);
  ...
  if ( this->fields.useAlphaMask )
  {
    ...
    if ( dispObject )
    {
      ComponentInParent_object = UnityEngine_GameObject__GetComponentInParent_object_(
                                   dispObject,
                                   (const MethodInfo_31516AC *)Method_UnityEngine_GameObject_GetComponentInParent_UIScrollView___);
      this->fields.scrollView = (struct UIScrollView_o *)ComponentInParent_object;
      sub_1C3E508((CGThumbnailListItem_o *)&this->fields.scrollView, (int32_t)ComponentInParent_object, v10, v11);
      ...
      if ( dispObject )
      {
        ...
        if ( dispObject )
        {
          ComponentInChildren_object = UnityEngine_GameObject__GetComponentInChildren_object_(
                                         dispObject,
                                         (const MethodInfo_3151330 *)Method_UnityEngine_GameObject_GetComponentInChildren_ListViewItemSeed___);
          this->fields.itemSeed = (struct ListViewItemSeed_o *)ComponentInChildren_object;
          sub_1C3E508((CGThumbnailListItem_o *)&this->fields.itemSeed, (int32_t)ComponentInChildren_object, v13, v14);
...
// local variable allocation has failed, the output may be wrong!
void PartyListViewObject__Init_34158448(PartyListViewObject_o *this, int32_t initMode, const MethodInfo *method)
{
  const MethodInfo *v3; // x3
  float v4; // s0
...
// local variable allocation has failed, the output may be wrong!
void PartyListViewObject__Init_34159748(
        PartyListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void PartyListViewObject__Init_34159832(
        PartyListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void PartyListViewObject__OpenEquipDetail(PartyListViewObject_o *this, int32_t m, const MethodInfo *method)
{
  ...
  if ( (byte_4C526AC & 1) == 0 )
  {
    ...
    sub_1C3E564(&PartyListViewItem_TypeInfo);
    sub_1C3E564(&Method_PartyListViewObject_EndShowEquip__);
    sub_1C3E564(&Method_PartyListViewObject_OpenEquipDetail__);
    this = (PartyListViewObject_o *)sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C526AC = 1;
  }
...
LABEL_32:
                  ...
                  if ( (*((_BYTE *)Method_PartyListViewObject_OpenEquipDetail__ + 83) & 2) != 0 )
                    v24 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_OpenEquipDetail__);
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenEquipDetail__ + 83) & 2) != 0 )
                  v17 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_OpenEquipDetail__);
                ...
                if ( this )
                {
                  ...
                  if ( Instance )
                  {
                    if ( IsNpc )
                      ...
                      v23 = 14;
                    CommonUI__OpenServantEquipStatusDialog_31253688(
                      (CommonUI_o *)Instance,
                      v23,
              ...
              else
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenEquipDetail__ + 83) & 2) != 0 )
                  v11 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_OpenEquipDetail__);
...
void PartyListViewObject__OpenServantDetail(PartyListViewObject_o *this, int32_t m, const MethodInfo *method)
{
  ...
  if ( (byte_4C526A7 & 1) == 0 )
  {
    ...
    sub_1C3E564(&PartyListViewItem_TypeInfo);
    sub_1C3E564(&PartyListViewManager_TypeInfo);
    sub_1C3E564(&Method_PartyListViewObject_EndShowServantWithQuest__);
    sub_1C3E564(&Method_PartyListViewObject_EndShowServant__);
    sub_1C3E564(&Method_PartyListViewObject_OpenServantDetail__);
    this = (PartyListViewObject_o *)sub_1C3E564(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
    byte_4C526A7 = 1;
  }
  state = v4->fields.state;
            ...
            if ( this )
            {
              ...
              if ( this->fields.callbackFunc && !BYTE1(this[1].fields.colliders) )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenServantDetail__ + 83) & 2) != 0 )
                  v25 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_OpenServantDetail__);
                ...
                if ( v29 )
                {
                  v31 = (ServantStatusDialog_FormationEndDelegate_o *)sub_1C3E7B0(ServantStatusDialog_FormationEndDelegate_TypeInfo);
                  ...
                  if ( v30 )
                  {
                    CommonUI__OpenServantStatusDialog_31247168(v30, 1, v9, m, v31, 1, 0, 0);
                    return;
                  }
                }
                else
              ...
              else
              {
                ...
                if ( !itemDraw || FollowerInfo__get_IsNpc(itemDraw, 0) )
                {
                  ...
                  if ( (*((_BYTE *)Method_PartyListViewObject_OpenServantDetail__ + 83) & 2) != 0 )
                    v14 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_OpenServantDetail__);
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_OpenServantDetail__ + 83) & 2) != 0 )
                  v18 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_OpenServantDetail__);
                ...
                if ( v20 )
                {
                  CommonUI__OpenServantStatusDialog_31250580((CommonUI_o *)v20, 5, ServantLeader, v22, 0);
                  return;
                }
              }
            }
...
void PartyListViewObject__SelectMemberEquip(PartyListViewObject_o *this, int32_t m, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&PartyListViewItem_TypeInfo);
    sub_1C3E564(&Method_PartyListViewObject_SelectMemberEquip__);
    sub_1C3E564(&StringLiteral_9853/*"OnClickListViewChangeEquip"*/);
    byte_4C526A6 = 1;
  }
            ...
            if ( Member )
            {
              if ( LOBYTE(Member[3].fields.sortValue0B) )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_SelectMemberEquip__ + 83) & 2) != 0 )
                  v9 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_SelectMemberEquip__);
              ...
              Member = (struct ListViewItem_o *)System_String__Concat_63636468(
                                                  (System_String_o *)StringLiteral_9853/*"OnClickListViewChangeEquip"*/,
                                                  v12,
                                                  0);
              if ( manager )
              {
...
void PartyListViewObject__SelectMemberServant(PartyListViewObject_o *this, int32_t m, const MethodInfo *method)
{
  ...
  {
    sub_1C3E564(&PartyListViewItem_TypeInfo);
    sub_1C3E564(&Method_PartyListViewObject_SelectMemberServant__);
    sub_1C3E564(&StringLiteral_9854/*"OnClickListViewChangeServant"*/);
    byte_4C526A5 = 1;
  }
  if ( this->fields.state == 3 )
  {
            ...
            if ( Member )
            {
              if ( LOBYTE(Member[3].fields.sortValue0B) )
              {
                ...
                if ( (*((_BYTE *)Method_PartyListViewObject_SelectMemberServant__ + 83) & 2) != 0 )
                  v9 = (_QWORD *)sub_1C3E57C(Method_PartyListViewObject_SelectMemberServant__);
                v10 = (System_Reflection_MethodBase_o *)sub_1C3E548(v9, v9[4]);
                OverwriteAssetSoundName__PlaySystemSe(v10, 2, 0, 0);
                return;
              }
              ...
              v12 = System_Int32__ToString((int32_t)&v13, 0);
              Member = (struct ListViewItem_o *)System_String__Concat_63636468(
                                                  (System_String_o *)StringLiteral_9854/*"OnClickListViewChangeServant"*/,
                                                  v12,
                                                  0);
              if ( manager )
              {
...
void PartyListViewObject__SetItem_34165924(PartyListViewObject_o *this, ListViewItem_o *item, const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  v11 = (PartyListViewObject_o *)sub_1C3EA80(v8);
