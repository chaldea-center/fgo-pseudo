...
void __fastcall CombineUICommonButton__OnClick(CombineUICommonButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A8BD & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&Method_CombineUICommonButton_OnClick__, v3);
    ...
    sub_1BE4ACC(&UICommonButton_TypeInfo, v7);
    byte_4B6A8BD = 1;
  }
          ...
          this->klass->vtable._5_set_isEnabled.methodPtr) & 1) != 0 )
  {
    ...
    EventDelegate__Execute_47611192(onClick, 0LL);
    UICommonButton_TypeInfo->static_fields->current = 0LL;
    sub_1BE4A70((PartyOrganizationUtility_o *)UICommonButton_TypeInfo->static_fields, 0LL, v16, v17, v18, v19, v20, v21);
    return;
  }
...
LABEL_24:
    ...
    if ( (*((_BYTE *)Method_CombineUICommonButton_OnClick__ + 83) & 2) != 0 )
      v27 = (_QWORD *)sub_1BE4AE4(Method_CombineUICommonButton_OnClick__);
