...
void __fastcall CombineUICommonButton__OnClick(CombineUICommonButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48E610E & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_CombineUICommonButton_OnClick__, v3);
    ...
    sub_1B00CCC(&UICommonButton_TypeInfo, v7);
    byte_48E610E = 1;
  }
          ...
          this->klass->vtable._5_set_isEnabled.methodPtr) & 1) != 0 )
  {
    ...
    sub_1B00C70((ServantStatusBattleListViewItem_o *)UICommonButton_TypeInfo->static_fields, (int32_t)this, v9, v10);
    onClick = this->fields.onClick;
    if ( !EventDelegate_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(EventDelegate_TypeInfo);
    EventDelegate__Execute_45624868(onClick, 0LL);
    UICommonButton_TypeInfo->static_fields->current = 0LL;
    sub_1B00C70((ServantStatusBattleListViewItem_o *)UICommonButton_TypeInfo->static_fields, 0, v12, v13);
    return;
  }
...
LABEL_24:
    ...
    if ( (*((_BYTE *)Method_CombineUICommonButton_OnClick__ + 83) & 2) != 0 )
      v19 = (_QWORD *)sub_1B00CE4(Method_CombineUICommonButton_OnClick__);
