...
LABEL_24:
    ...
    if ( (*((_BYTE *)Method_CombineUICommonButton_OnClick__ + 83) & 2) != 0 )
      v10 = (_QWORD *)sub_1D0F0CC(Method_CombineUICommonButton_OnClick__);
...
LABEL_27:
  ...
  {
    v12 = (CombineUICommonButton_o *)sub_1D0F6A8(gameObject);
