        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C2A0 & 1) == 0 )
  {
    ...
    this = (SummonHistoryListViewItemDraw_o *)sub_1B715CC(&StringLiteral_6850/*"GACHA_HISTORY_LIST_DOT"*/, v5);
    byte_4A1C2A0 = 1;
  }
  if ( !item )
    goto LABEL_53;
                                ...
                                if ( this )
                                {
                                  ...
                                  if ( this )
                                  {
                                    ...
                                    this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get(
                                                                                (System_String_o *)StringLiteral_6850/*"GACHA_HISTORY_LIST_DOT"*/,
                                                                                0LL);
                                    if ( dotLabel )
                                    {
...
LABEL_53:
    ...
    case 0:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_6850/*"GACHA_HISTORY_LIST_DOT"*/, 0LL);
      if ( !v7 )
        goto LABEL_53;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A1C2A1 & 1) == 0 )
  {
    sub_1B715CC(&StringLiteral_1528/*"7"*/, method);
    this = (SummonHistoryListViewItemDraw_o *)sub_1B715CC(&StringLiteral_1530/*"7999"*/, v3);
    byte_4A1C2A1 = 1;
  }
...
LABEL_17:
  ...
  if ( System_String__op_Equality(v11->fields.mSpriteName, (System_String_o *)StringLiteral_1530/*"7999"*/, 0LL) )
  {
    this = (SummonHistoryListViewItemDraw_o *)v2->fields.bonusItemSpr;
    if ( this )
    {
