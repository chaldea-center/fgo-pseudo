        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E548 & 1) == 0 )
  {
    ...
    this = (SummonHistoryListViewItemDraw_o *)sub_1C3B764(&StringLiteral_7042/*"HH:mm:ss.ffffffzzzzzz"*/, v5);
    byte_4C1E548 = 1;
  }
  if ( !item )
    goto LABEL_53;
                                ...
                                if ( this )
                                {
                                  ...
                                  if ( this )
                                  {
                                    ...
                                    this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get(
                                                                                (System_String_o *)StringLiteral_7042/*"HH:mm:ss.ffffffzzzzzz"*/,
                                                                                0LL);
                                    if ( dotLabel )
                                    {
...
LABEL_53:
    ...
    case 0:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7042/*"HH:mm:ss.ffffffzzzzzz"*/, 0LL);
      if ( !v7 )
        goto LABEL_53;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1E549 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_1508/*";/?:@&=+$,"*/, method);
    this = (SummonHistoryListViewItemDraw_o *)sub_1C3B764(&StringLiteral_1510/*"< 0"*/, v3);
    byte_4C1E549 = 1;
  }
  ...
  this = (SummonHistoryListViewItemDraw_o *)System_String__op_Equality(
                                              ...
                                              (System_String_o *)StringLiteral_1508/*";/?:@&=+$,"*/,
                                              0LL);
...
LABEL_17:
  ...
  if ( System_String__op_Equality(v11->fields.mSpriteName, (System_String_o *)StringLiteral_1510/*"< 0"*/, 0LL) )
  {
    this = (SummonHistoryListViewItemDraw_o *)v2->fields.bonusItemSpr;
    if ( this )
    {
