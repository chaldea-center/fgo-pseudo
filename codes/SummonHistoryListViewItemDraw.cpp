        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8B5B & 1) == 0 )
  {
    ...
    this = (SummonHistoryListViewItemDraw_o *)sub_1C21E38(&StringLiteral_7049/*"GACHA_HISTORY_LIST_DOT"*/);
    byte_4BD8B5B = 1;
  }
  if ( !item )
    goto LABEL_53;
                                ...
                                if ( this )
                                {
                                  ...
                                  if ( this )
                                  {
                                    ...
                                    this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get(
                                                                                (System_String_o *)StringLiteral_7049/*"GACHA_HISTORY_LIST_DOT"*/,
                                                                                0LL);
                                    if ( dotLabel )
                                    {
...
LABEL_53:
    ...
    case 0:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7049/*"GACHA_HISTORY_LIST_DOT"*/, 0LL);
      if ( !v6 )
        goto LABEL_53;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD8B5C & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_1528/*"7"*/);
    this = (SummonHistoryListViewItemDraw_o *)sub_1C21E38(&StringLiteral_1531/*"7999"*/);
    byte_4BD8B5C = 1;
  }
  ...
  this = (SummonHistoryListViewItemDraw_o *)System_String__op_Equality(
                                              ...
                                              (System_String_o *)StringLiteral_1528/*"7"*/,
                                              0LL);
...
LABEL_17:
  ...
  if ( System_String__op_Equality(v10->fields.mSpriteName, (System_String_o *)StringLiteral_1531/*"7999"*/, 0LL) )
  {
    this = (SummonHistoryListViewItemDraw_o *)v2->fields.bonusItemSpr;
    if ( this )
    {
      ...
      if ( v11 )
      {
        ...
        if ( this )
        {
          ...
          GameObjectExtensions__SetLocalPositionX((UnityEngine_GameObject_o *)v12, v13 + -1.0, 0LL);
          return;
        }
      }
    }
