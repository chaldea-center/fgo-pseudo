        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40F3C & 1) == 0 )
  {
    ...
    this = (SummonHistoryListViewItemDraw_o *)sub_1BDB878(&StringLiteral_6916/*"GACHA_HISTORY_LIST_DOT"*/, v5);
    byte_4B40F3C = 1;
  }
  if ( !item )
    goto LABEL_53;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B40F3D & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_1462/*"7"*/, method);
    this = (SummonHistoryListViewItemDraw_o *)sub_1BDB878(&StringLiteral_1464/*"7999"*/, v3);
    byte_4B40F3D = 1;
  }
  ...
  this = (SummonHistoryListViewItemDraw_o *)System_String__op_Equality(
                                              ...
                                              (System_String_o *)StringLiteral_1462/*"7"*/,
                                              0LL);
...
LABEL_17:
  ...
  if ( System_String__op_Equality(v11->fields.mSpriteName, (System_String_o *)StringLiteral_1464/*"7999"*/, 0LL) )
  {
    this = (SummonHistoryListViewItemDraw_o *)v2->fields.bonusItemSpr;
    if ( this )
    {
