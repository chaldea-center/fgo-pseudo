        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC40CC & 1) == 0 )
  {
    ...
    this = (SummonHistoryListViewItemDraw_o *)sub_1C1ABD4(&StringLiteral_7039/*"GACHA_HISTORY_LIST_DOT"*/, v5);
    byte_4BC40CC = 1;
  }
  if ( !item )
    goto LABEL_53;
                                ...
                                if ( this )
                                {
                                  ...
                                  if ( this )
                                  {
                                    ...
                                    this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get(
                                                                                (System_String_o *)StringLiteral_7039/*"GACHA_HISTORY_LIST_DOT"*/,
                                                                                0LL);
                                    if ( dotLabel )
                                    {
...
LABEL_53:
    ...
    case 0:
      ...
      if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
      this = (SummonHistoryListViewItemDraw_o *)LocalizationManager__Get((System_String_o *)StringLiteral_7039/*"GACHA_HISTORY_LIST_DOT"*/, 0LL);
      if ( !v7 )
        goto LABEL_53;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC40CD & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_1529/*"7"*/, method);
    this = (SummonHistoryListViewItemDraw_o *)sub_1C1ABD4(&StringLiteral_1531/*"7999"*/, v3);
    byte_4BC40CD = 1;
  }
