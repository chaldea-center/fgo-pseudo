        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05441 & 1) == 0 )
  {
    ...
    this = (SummonHistoryListViewItemDraw_o *)sub_1B686D4(&StringLiteral_6845/*"GACHA_HISTORY_LIST_DOT"*/, v5);
    byte_4A05441 = 1;
  }
  if ( !item )
    goto LABEL_53;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A05442 & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_1527/*"7"*/, method);
    this = (SummonHistoryListViewItemDraw_o *)sub_1B686D4(&StringLiteral_1529/*"7999"*/, v3);
    byte_4A05442 = 1;
  }
...
LABEL_17:
  ...
  if ( System_String__op_Equality(v11->fields.mSpriteName, (System_String_o *)StringLiteral_1529/*"7999"*/, 0LL) )
  {
    this = (SummonHistoryListViewItemDraw_o *)v2->fields.bonusItemSpr;
    if ( this )
    {
