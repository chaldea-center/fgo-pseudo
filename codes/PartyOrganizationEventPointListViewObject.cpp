        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3E9DB & 1) == 0 )
  {
    sub_1C37058(&Method_UnityEngine_GameObject_GetComponent_PartyOrganizationEventPointListViewItemDraw___);
    byte_4C3E9DB = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_PartyOrganizationEventPointListViewItemDraw___);
  ...
  if ( !DragObject
    || (v4 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_313F1D8 *)Method_UnityEngine_GameObject_GetComponent_PartyOrganizationEventPointListViewObject___)) == 0) )
  {
...
void PartyOrganizationEventPointListViewObject__Init_34216032(
        PartyOrganizationEventPointListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void PartyOrganizationEventPointListViewObject__Init_34217192(
        PartyOrganizationEventPointListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void PartyOrganizationEventPointListViewObject__Init_34217800(
        PartyOrganizationEventPointListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
void PartyOrganizationEventPointListViewObject__SetItem_34219280(
        PartyOrganizationEventPointListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  v11 = (PartyOrganizationEventPointListViewObject_o *)sub_1C37574(v8);
