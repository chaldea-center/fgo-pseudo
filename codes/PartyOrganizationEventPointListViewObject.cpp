        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6289E & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_PartyOrganizationEventPointListViewItemDraw___, method);
    byte_4B6289E = 1;
  }
  ...
  if ( !dispObject )
    sub_1BE4D28(0LL, v3);
  this->fields.itemDraw = (struct PartyOrganizationEventPointListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_object_(
                                                                                    dispObject,
                                                                                    (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_PartyOrganizationEventPointListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B628A2 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_PartyOrganizationEventPointListViewObject___, method);
    byte_4B628A2 = 1;
  }
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_PartyOrganizationEventPointListViewObject___)) == 0LL) )
  {
    sub_1BE4D28(DragObject, v4);
  }
  PartyOrganizationEventPointListViewObject__Init_32717476(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B628A0 & 1) == 0 )
  {
    sub_1BE4ACC(&PartyOrganizationEventPointListViewItem_TypeInfo, method);
    byte_4B628A0 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B628A3 & 1) == 0 )
  {
    sub_1BE4ACC(&PartyOrganizationEventPointListViewItem_TypeInfo, *(_QWORD *)&initMode);
    byte_4B628A3 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem
...
LABEL_20:
    PartyOrganizationEventPointListViewObject__SetupDisp(this, v17);
  v20 = *p_callbackFunc;
  if ( *p_callbackFunc )
  {
    *p_callbackFunc = 0LL;
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyOrganizationEventPointListViewObject__Init_32717476(
        PartyOrganizationEventPointListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyOrganizationEventPointListViewObject__Init_32718636(
        PartyOrganizationEventPointListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
// local variable allocation has failed, the output may be wrong!
void __fastcall PartyOrganizationEventPointListViewObject__Init_32719244(
        PartyOrganizationEventPointListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B628A1 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationEventPointListViewItem_TypeInfo, v5);
    byte_4B628A1 = 1;
  }
...
void __fastcall PartyOrganizationEventPointListViewObject__SetItem_32720860(
        PartyOrganizationEventPointListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B628A4 & 1) == 0 )
  {
    ...
    sub_1BE4ACC(&PartyOrganizationEventPointListViewItem_TypeInfo, v3);
    byte_4B628A4 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
        ...
        const MethodInfo *method)
{
  ...
  v11 = (PartyOrganizationEventPointListViewObject_o *)sub_1BE4FE8(v8);
