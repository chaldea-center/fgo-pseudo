void __fastcall EventInfoSubmarineItemCounterComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0035D & 1) == 0 )
  {
    sub_1B64A00(&EventInfoSubmarineItemCounterComponent_TypeInfo, v1);
    byte_4A0035D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0035C & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_UserItemMaster___, *(_QWORD *)&itemId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A00359 & 1) == 0 )
  {
    sub_1B64A00(&AtlasManager_TypeInfo, eventUiValueEntity);
    sub_1B64A00(&EventInfoSubmarineItemCounterComponent_TypeInfo, v7);
  ...
  if ( itemData )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(countLabel, 0LL, 0LL) )
    {
      ...
      GameObjectExtensions__SetLocalPosition_33376744(gameObject, itemData->fields.CountPosition, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(nameLabel, 0LL, 0LL) )
    {
      ...
      if ( ItemInfo )
      {
        ...
        GameObjectExtensions__SetLocalPosition_33376744(v24, itemData->fields.namePosition, 0LL);
        return;
      }
LABEL_30:
      sub_1B64C5C(ItemInfo, v12);
    }
  }
}
