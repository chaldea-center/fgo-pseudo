void __fastcall EventInfoSubmarineItemCounterComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A21202 & 1) == 0 )
  {
    sub_1B715CC(&EventInfoSubmarineItemCounterComponent_TypeInfo, v1);
    byte_4A21202 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A21201 & 1) == 0 )
  {
    sub_1B715CC(&Method_DataManager_GetMasterData_UserItemMaster___, *(_QWORD *)&itemId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A211FE & 1) == 0 )
  {
    sub_1B715CC(&AtlasManager_TypeInfo, eventUiValueEntity);
    sub_1B715CC(&EventInfoSubmarineItemCounterComponent_TypeInfo, v7);
    sub_1B715CC(&UnityEngine_Object_TypeInfo, v8);
    sub_1B715CC(&StringLiteral_24874/*"{0:#,0}"*/, v9);
    byte_4A211FE = 1;
  }
  ...
  if ( itemData )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(countLabel, 0LL, 0LL) )
    {
      ...
      GameObjectExtensions__SetLocalPosition_33529300(gameObject, itemData->fields.CountPosition, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(nameLabel, 0LL, 0LL) )
    {
      ...
      if ( ItemInfo )
      {
        ...
        GameObjectExtensions__SetLocalPosition_33529300(v24, itemData->fields.namePosition, 0LL);
        return;
      }
LABEL_30:
      sub_1B71828(ItemInfo, v12);
    }
  }
}
