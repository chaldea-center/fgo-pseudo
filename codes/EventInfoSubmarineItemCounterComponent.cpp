void __fastcall EventInfoSubmarineItemCounterComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_48E405F & 1) == 0 )
  {
    sub_1B00CCC(&EventInfoSubmarineItemCounterComponent_TypeInfo, v1);
    byte_48E405F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E405E & 1) == 0 )
  {
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserItemMaster___, *(_QWORD *)&itemId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E405B & 1) == 0 )
  {
    sub_1B00CCC(&AtlasManager_TypeInfo, eventUiValueEntity);
    sub_1B00CCC(&EventInfoSubmarineItemCounterComponent_TypeInfo, v7);
    sub_1B00CCC(&UnityEngine_Object_TypeInfo, v8);
    sub_1B00CCC(&StringLiteral_24569/*"{0:#,0}"*/, v9);
    byte_48E405B = 1;
  }
  ...
  if ( itemData )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(countLabel, 0LL, 0LL) )
    {
      ...
      GameObjectExtensions__SetLocalPosition_32535360(gameObject, itemData->fields.CountPosition, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(nameLabel, 0LL, 0LL) )
    {
      ...
      if ( ItemInfo )
      {
        ...
        GameObjectExtensions__SetLocalPosition_32535360(v24, itemData->fields.namePosition, 0LL);
        return;
      }
LABEL_30:
      sub_1B00F28(ItemInfo, v12);
    }
  }
}
