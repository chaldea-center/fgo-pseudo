void __fastcall EventInfoSubmarineItemCounterComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0A4B4 & 1) == 0 )
  {
    sub_1B686D4(&EventInfoSubmarineItemCounterComponent_TypeInfo, v1);
    byte_4A0A4B4 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A4B3 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_UserItemMaster___, *(_QWORD *)&itemId);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0A4B0 & 1) == 0 )
  {
    sub_1B686D4(&AtlasManager_TypeInfo, eventUiValueEntity);
    sub_1B686D4(&EventInfoSubmarineItemCounterComponent_TypeInfo, v7);
    sub_1B686D4(&UnityEngine_Object_TypeInfo, v8);
    sub_1B686D4(&StringLiteral_24850/*"{0:#,0}"*/, v9);
    byte_4A0A4B0 = 1;
  }
  ...
  if ( itemData )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(countLabel, 0LL, 0LL) )
    {
      ...
      GameObjectExtensions__SetLocalPosition_33415288(gameObject, itemData->fields.CountPosition, 0LL);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(nameLabel, 0LL, 0LL) )
    {
      ...
      if ( ItemInfo )
      {
        ...
        GameObjectExtensions__SetLocalPosition_33415288(v24, itemData->fields.namePosition, 0LL);
        return;
      }
LABEL_30:
      sub_1B68930(ItemInfo, v12);
    }
  }
}
