void EventInfoSubmarineItemCounterComponent___cctor(const MethodInfo *method)
{
  if ( (byte_4D3282E & 1) == 0 )
  {
    sub_1C93AD4(&EventInfoSubmarineItemCounterComponent_TypeInfo);
    byte_4D3282E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( itemData )
  {
    ...
    if ( UnityEngine_Object__op_Inequality(countLabel, 0, 0) )
    {
      ...
      GameObjectExtensions__SetLocalPosition_36745064(gameObject, itemData->fields.CountPosition, 0);
    }
    ...
    if ( UnityEngine_Object__op_Inequality(nameLabel, 0, 0) )
    {
      ...
      if ( ItemInfo )
      {
        ...
        GameObjectExtensions__SetLocalPosition_36745064(v25, itemData->fields.namePosition, 0);
        return;
      }
LABEL_30:
      sub_1C93D2C(ItemInfo, v13);
    }
  }
}
