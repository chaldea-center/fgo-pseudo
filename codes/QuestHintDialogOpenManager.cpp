void __fastcall QuestHintDialogOpenManager___cctor(const MethodInfo *method)
{
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&static_fields->questHintDialogOpenList, (int32_t)v7, v9, v10);
...
void __fastcall QuestHintDialogOpenManager__ClearSaveDataList(const MethodInfo *method)
{
  ...
  if ( (byte_49FF608 & 1) == 0 )
  {
    ...
    sub_1B64870(&QuestHintDialogOpenManager_TypeInfo, v2);
    byte_49FF608 = 1;
  }
...
void __fastcall QuestHintDialogOpenManager__DeleteSaveData(const MethodInfo *method)
{
  ...
  if ( (byte_49FF606 & 1) == 0 )
  {
    sub_1B64870(&QuestHintDialogOpenManager_TypeInfo, v1);
    byte_49FF606 = 1;
  }
...
bool __fastcall QuestHintDialogOpenManager__IsQuestHintOpen(int32_t questId, const MethodInfo *method)
{
  ...
  if ( (byte_49FF60B & 1) == 0 )
  {
    ...
    sub_1B64870(&QuestHintDialogOpenManager_TypeInfo, v4);
    byte_49FF60B = 1;
  }
  ...
  if ( size >= 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( System_Collections_Generic_List_int___get_Item(
             ...
             v9 - 1,
             (const MethodInfo_3491EC8 *)Method_System_Collections_Generic_List_int__get_Item__) == questId )
        return v10;
      v10 = v9 < size;
      if ( size == v9 )
        return v10;
    ...
    else
    {
      ...
      if ( v17 >= 1 )
      {
        do
        {
          ...
          if ( !items )
            sub_1B64ACC(questHintDialogOpenList, v18);
...
bool __fastcall QuestHintDialogOpenManager__WriteData(const MethodInfo *method)
{
  ...
  if ( (byte_49FF60A & 1) == 0 )
  {
    ...
    sub_1B64870(&QuestHintDialogOpenManager_TypeInfo, v6);
    byte_49FF60A = 1;
  }
  ...
  if ( !v7->static_fields->UseMock )
  {
    ...
    System_IO_BinaryWriter___ctor_61621732(v11, v10, 0LL);
