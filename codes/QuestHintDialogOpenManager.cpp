...
bool __fastcall QuestHintDialogOpenManager__ReadData(const MethodInfo *method)
{
  ...
  if ( System_IO_File__Exists(SaveFileName, 0LL) )
  {
    ...
    {
LABEL_33:
      v22 = sub_AEB880(v7, System_IDisposable_TypeInfo, 0LL, v12);
    }
    (*(void (__fastcall **)(System_IO_BinaryReader_o *, _QWORD))v22)(v7, *(_QWORD *)(v22 + 8));
  }
  else
  {
    ...
    QuestHintDialogOpenManager__ClearSaveDataList((const MethodInfo *)v23);
    return 0;
  }
  return v2;
}
  ...
  if ( !v1->static_fields->UseMock )
  {
    ...
    if ( (int)size >= 1 )
    {
      for ( i = 0LL; (__int64)i < size; ++i )
      {
        ...
        v16 = v15->static_fields->questHintDialogOpenList;
        if ( !v16 )
          sub_B52A5C(v15, v12);
        if ( i >= (unsigned int)v16->fields._size )
          System_ThrowHelper__ThrowArgumentOutOfRangeException_42202232(0LL);
        ((void (__fastcall *)(System_IO_BinaryWriter_o *, _QWORD, Il2CppMethodPointer))v6->klass->vtable._17_Write.method)(
          v6,
          (unsigned int)v16->fields._items->m_Items[i + 1],
          v6->klass->vtable._18_Write.methodPtr);
      }
    }
    klass = v6->klass;
    if ( *(_WORD *)&v6->klass->_2.bitflags1 )
    {
      ...
      while ( *((System_IDisposable_c **)p_offset - 1) != System_IDisposable_TypeInfo )
      {
        ++v18;
        p_offset += 4;
        if ( v18 >= *(unsigned __int16 *)&v6->klass->_2.bitflags1 )
          goto LABEL_29;
      }
    ...
    {
LABEL_29:
      v20 = sub_AEB880(v6, System_IDisposable_TypeInfo, 0LL, v13);
    }
    (*(void (__fastcall **)(System_IO_BinaryWriter_o *, _QWORD))v20)(v6, *(_QWORD *)(v20 + 8));
  }
  return 1;
}