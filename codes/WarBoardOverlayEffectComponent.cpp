        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BA61 & 1) == 0 )
  {
    ...
    this = (WarBoardOverlayEffectComponent_o *)sub_1B761C0(&StringLiteral_1/*""*/, v6);
    byte_4A2BA61 = 1;
  }
  v40[0] = 0;
  if ( !message )
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)&v5->fields.mainText, v8, (int32_t)method, v3);
  ...
  sub_1B76164(p_rubyText, v10, v12, v13);
  if ( stringLength >= 1 )
  {
    v14 = 0;
    v15 = 0;
...
LABEL_33:
    ...
    if ( Chars == 91 )
    {
      ...
      else
      {
        ...
        v36 = System_String__Concat_61535060(klass, v35, 0LL);
        p_mainText->klass = (ServantStatusBattleListViewItem_c *)v36;
        sub_1B76164(p_mainText, (int32_t)v36, v37, v38);
      }
      goto LABEL_33;
    }
    if ( Chars != 93 )
...
LABEL_15:
      if ( (v16 & 1) != 0 )
      {
        ...
        sub_1B76164(p_rubyText, (int32_t)v21, v22, v23);
        v16 = 1;
      }
      else
      {
        ...
        v31 = System_String__Concat_61535060(v29, v30, 0LL);
        p_mainText->klass = (ServantStatusBattleListViewItem_c *)v31;
        sub_1B76164(p_mainText, (int32_t)v31, v32, v33);
        v16 = 0;
      }
      goto LABEL_33;
    }
...
LABEL_21:
      ...
      v26 = System_String__Concat_61535060(v24, v25, 0LL);
      p_mainText->klass = (ServantStatusBattleListViewItem_c *)v26;
      sub_1B76164(p_mainText, (int32_t)v26, v27, v28);
    }
    v15 = 0;
    goto LABEL_33;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( UILabel__get_printedSize(mainLabel, 0LL).fields.x > v5 )
  {
    ...
    if ( mainLabel )
    {
      UILabel__SetCondensedScale_46926104(mainLabel, v6, 0LL);
      return;
    }
LABEL_10:
    sub_1B7641C(mainLabel, method);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A2BA63 & 1) == 0 )
  {
    ...
    sub_1B761C0(&Method_System_Collections_Generic_List_char__get_Count__, v5);
    sub_1B761C0(&Method_System_Collections_Generic_List_char__get_Item__, v6);
    this = (WarBoardOverlayEffectComponent_o *)sub_1B761C0(&StringLiteral_1/*""*/, v7);
    byte_4A2BA63 = 1;
  }
  v31[0] = 0;
  ...
  if ( localMainTextList->fields._size >= 1 )
  {
    ...
    do
    {
      this = (WarBoardOverlayEffectComponent_o *)System_Collections_Generic_List_char___get_Item(
                                                   localMainTextList,
                                                   v9,
                                                   (const MethodInfo_3493348 *)Method_System_Collections_Generic_List_char__get_Item__);
      ...
      if ( v12 == Chars )
      {
        ...
        this = (WarBoardOverlayEffectComponent_o *)System_String__Concat_61535060(v8, v14, 0LL);
      ...
      else
      {
        if ( (unsigned __int16)this != 10 )
        {
          ...
          v8 = System_String__Concat_61535060(v8, v24, 0LL);
          goto LABEL_36;
        }
        v15 = v4->fields.mainLabel;
        if ( !v15 )
...
LABEL_24:
          ...
          this = (WarBoardOverlayEffectComponent_o *)System_String__Concat_61535060(v8, v21, 0LL);
        ...
        else
        {
          ...
          if ( (unsigned __int16)this == 10 )
          {
            ...
            this = (WarBoardOverlayEffectComponent_o *)System_String__Concat_61535060(v8, v26, 0LL);
          ...
          else
          {
            ...
            v8 = System_String__Concat_61535060(v8, v29, 0LL);
            ++v9;
          }
        }
      }
