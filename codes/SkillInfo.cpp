        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF6F5 & 1) == 0 )
  {
    sub_1B64870(&System_Text_StringBuilder_TypeInfo, isEquipExplanation);
    sub_1B64870(&StringLiteral_365/*" ＋ "*/, v5);
    skillInfoList = (SkillInfo_array *)sub_1B64870(&StringLiteral_360/*" ……"*/, v6);
    byte_49FF6F5 = 1;
  }
  if ( !v4 )
    goto LABEL_19;
  ...
  System_Text_StringBuilder___ctor_60538824(v8, 1024, 0LL);
  if ( (int)v7 >= 1 )
  {
    v9 = 0LL;
    ...
    {
      if ( v9 >= v4->max_length )
        sub_1B64AD4(skillInfoList, isEquipExplanation);
      v11 = v4->m_Items[v9];
      if ( v11 )
      {
        ...
        if ( ((unsigned __int8)skillInfoList & 1) == 0 )
        {
          ...
          if ( v9 >= 2 && !v10 )
          {
            System_Text_StringBuilder__Append_60545472(v8, (System_String_o *)StringLiteral_360/*" ……"*/, 0LL);
          ...
          if ( System_Text_StringBuilder__get_Length(v8, 0LL) >= 1 )
            System_Text_StringBuilder__Append_60545472(v8, (System_String_o *)StringLiteral_365/*" ＋ "*/, 0LL);
          skillInfoList = (SkillInfo_array *)System_Text_StringBuilder__Append_60545472(v8, explanation, 0LL);
        }
      }
    }
  ...
  if ( !v8 )
LABEL_19:
    sub_1B64ACC(skillInfoList, isEquipExplanation);
  return (System_String_o *)((__int64 (__fastcall *)(System_Text_StringBuilder_o *, Il2CppMethodPointer))v8->klass->vtable._3_ToString.method)(
                              v8,
                              v8->klass->vtable._4_System_Runtime_Serialization_ISerializable_GetObjectData.methodPtr);
}
...
System_String_o *__fastcall SkillInfo__GetMargeExplanation_40195884(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF6F6 & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_365/*" ＋ "*/, v3);
  ...
  System_Text_StringBuilder___ctor_60538824(v6, 1024, 0LL);
  if ( (int)v5 >= 1 )
  {
    v9 = 0LL;
    v10 = (unsigned int)v5;
    do
    {
      ...
      if ( ((unsigned __int8)IsNullOrEmpty & 1) == 0 )
      {
        ...
        if ( System_Text_StringBuilder__get_Length(v6, 0LL) >= 1 )
          System_Text_StringBuilder__Append_60545472(v6, (System_String_o *)StringLiteral_365/*" ＋ "*/, 0LL);
        IsNullOrEmpty = System_Text_StringBuilder__Append_60545472(v6, v11, 0LL);
      }
      ++v9;
    }
    while ( v10 != v9 );
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49FF6F9 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_DataManager_GetMasterData_ServantSkillReleaseMaster___, v9);
    ...
    sub_1B64870(&Method_DataMasterBase_SkillMaster__SkillEntity__int__GetEntity__, v12);
    sub_1B64870(
      &Method_System_Collections_Generic_Dictionary_int__List_ServantSkillReleaseEntity___GetEnumerator__,
      v13);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_ServantSkillReleaseEntity__Dispose__, v14);
    sub_1B64870(
      &Method_System_Collections_Generic_Dictionary_Enumerator_int__List_ServantSkillReleaseEntity___Dispose__,
      v15);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_ServantSkillReleaseEntity__MoveNext__, v16);
    sub_1B64870(
      &Method_System_Collections_Generic_Dictionary_Enumerator_int__List_ServantSkillReleaseEntity___MoveNext__,
      v17);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_ServantSkillReleaseEntity__get_Current__, v18);
    sub_1B64870(
      &Method_System_Collections_Generic_Dictionary_Enumerator_int__List_ServantSkillReleaseEntity___get_Current__,
      v19);
    sub_1B64870(&Method_System_Collections_Generic_KeyValuePair_int__List_ServantSkillReleaseEntity___get_Value__, v20);
    sub_1B64870(&Method_System_Collections_Generic_List_ServantSkillReleaseEntity__GetEnumerator__, v21);
               ...
               0LL) )
        {
          ...
          if ( ((unsigned __int8)Instance & 1) != 0 )
          {
            ...
            System_Collections_Generic_Dictionary_int__object___GetEnumerator(
              ...
              (const MethodInfo_3126098 *)Method_System_Collections_Generic_Dictionary_int__List_ServantSkillReleaseEntity___GetEnumerator__);
            v45 = v43;
            do
            {
              v34 = System_Collections_Generic_Dictionary_Enumerator_int__object___MoveNext(
                      &v45,
                      (const MethodInfo_326BF50 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__List_ServantSkillReleaseEntity___MoveNext__);
              if ( !v34 )
                break;
              ...
              System_Collections_Generic_List_object___GetEnumerator(
                ...
                (const MethodInfo_34B0548 *)Method_System_Collections_Generic_List_ServantSkillReleaseEntity__GetEnumerator__);
              isUse = 0;
...
LABEL_38:
              ...
              while ( 1 )
              {
                v37 = System_Collections_Generic_List_Enumerator_object___MoveNext(
                        &v44,
                        (const MethodInfo_322C38C *)Method_System_Collections_Generic_List_Enumerator_ServantSkillReleaseEntity__MoveNext__);
                if ( !v37 )
                  break;
              ...
              System_Collections_Generic_List_Enumerator_object___Dispose(
                &v44,
                (const MethodInfo_322C388 *)Method_System_Collections_Generic_List_Enumerator_ServantSkillReleaseEntity__Dispose__);
            }
            while ( !v36 );
            System_Collections_Generic_Dictionary_Enumerator_int__object___Dispose(
              &v45,
              (const MethodInfo_326C074 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__List_ServantSkillReleaseEntity___Dispose__);
