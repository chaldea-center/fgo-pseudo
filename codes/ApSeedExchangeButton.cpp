void ApSeedExchangeButton___cctor(const MethodInfo *method)
{
  if ( (byte_4DFE418 & 1) == 0 )
  {
    sub_1CE6700(&ApSeedExchangeButton_TypeInfo);
    byte_4DFE418 = 1;
  }
...
void ApSeedExchangeButton__OnClickButton(ApSeedExchangeButton_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFE417 & 1) == 0 )
  {
    sub_1CE6700(&Method_ApSeedExchangeButton_OnClickButton__);
    byte_4DFE417 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFE415 & 1) == 0 )
  {
    ...
    sub_1CE6700(&StringLiteral_17671/*"btn_event_fruit"*/);
    byte_4DFE415 = 1;
  }
  if ( !shopEntity )
  {
...
LABEL_12:
  ...
  sub_1CE66A4(&this->fields.shopEntity, shopEntity);
  this->fields.onClickCallback = onClickCallback;
  sub_1CE66A4(&this->fields.onClickCallback, onClickCallback);
  SelfUserGame = UserGameMaster__getSelfUserGame(0);
  this->fields.userEnt = SelfUserGame;
  sub_1CE66A4(&this->fields.userEnt, SelfUserGame);
  ...
  sub_1CE66A4(&this->fields.commonConsumeEntities, CommonConsumeEntities);
  buttonSprite = this->fields.buttonSprite;
  if ( !AtlasManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(AtlasManager_TypeInfo);
  AtlasManager__SetEventSprite(buttonSprite, (System_String_o *)StringLiteral_17671/*"btn_event_fruit"*/, 0);
