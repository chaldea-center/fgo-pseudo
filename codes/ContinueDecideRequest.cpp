        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03A6C & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_18087/*"continueType"*/, v7);
    sub_1BC3008(&StringLiteral_18086/*"continuePass"*/, v8);
    byte_4B03A6C = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18087/*"continueType"*/, 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03A6E & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_19193/*"facebookId"*/, facebookId);
    sub_1BC3008(&StringLiteral_18087/*"continueType"*/, v7);
    sub_1BC3008(&StringLiteral_16491/*"accessToken"*/, v8);
    byte_4B03A6E = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18087/*"continueType"*/, 3, 0LL);
  RequestBase__addField_43185568((RequestBase_o *)this, (System_String_o *)StringLiteral_19193/*"facebookId"*/, facebookId, 0LL);
  RequestBase__addField_43185568((RequestBase_o *)this, (System_String_o *)StringLiteral_16491/*"accessToken"*/, accessToken, 0LL);
  ContinueDecideRequest__beginRequest(this, v9);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03A6D & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_24003/*"twitterId"*/, twitterId);
    sub_1BC3008(&StringLiteral_18087/*"continueType"*/, v7);
    sub_1BC3008(&StringLiteral_16491/*"accessToken"*/, v8);
    byte_4B03A6D = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_18087/*"continueType"*/, 2, 0LL);
  RequestBase__addField_43185568((RequestBase_o *)this, (System_String_o *)StringLiteral_24003/*"twitterId"*/, twitterId, 0LL);
  RequestBase__addField_43185568((RequestBase_o *)this, (System_String_o *)StringLiteral_16491/*"accessToken"*/, accessToken, 0LL);
  ContinueDecideRequest__beginRequest(this, v9);
}
...
System_String_o *__fastcall ContinueDecideRequest__getURL(ContinueDecideRequest_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1BC3008(&NetworkManager_TypeInfo, method);
    sub_1BC3008(&StringLiteral_18081/*"continue/decide"*/, v2);
    byte_4B03A6A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_18081/*"continue/decide"*/, 0LL);
}
