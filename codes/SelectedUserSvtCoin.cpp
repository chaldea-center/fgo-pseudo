...
LABEL_9:
  ...
  if ( !linkItem )
  {
    ...
    sub_1C7BA8C((GrandQuestFolderBoardItem_o *)&this->fields, (int32_t)iconObject, v9, v10, v11, v12, v13, v14);
    sub_1C7BD40(v18, v19);
  }
  ...
  sub_1C7BA8C((GrandQuestFolderBoardItem_o *)p_fields, (int32_t)iconObject, v9, v10, v11, v12, v13, v14);
