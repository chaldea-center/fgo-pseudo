...
LABEL_9:
  ...
  if ( !linkItem )
  {
    ...
    sub_1B88554((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)iconObject, v9, v10);
    sub_1B8880C(v14, v15);
  }
  ...
  sub_1B88554((ServantStatusBattleListViewItem_o *)p_fields, (int32_t)iconObject, v9, v10);
