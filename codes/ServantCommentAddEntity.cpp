        ...
        const MethodInfo *method)
{
  if ( (byte_4BB4DA5 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&id);
    byte_4BB4DA5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB4DA7 & 1) == 0 )
  {
    sub_1C13D24(&CondType_TypeInfo, *(_QWORD *)&questId);
    this = (ServantCommentAddEntity_o *)sub_1C13D24(&NetworkManager_TypeInfo, v7);
    byte_4BB4DA7 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB4DA6 & 1) == 0 )
  {
    sub_1C13D24(&CondType_TypeInfo, *(_QWORD *)&oldFriendShipRank);
    this = (ServantCommentAddEntity_o *)sub_1C13D24(&NetworkManager_TypeInfo, v5);
    byte_4BB4DA6 = 1;
  }
  ...
  if ( condValues )
  {
    ...
    while ( 1 )
    {
      if ( v7 >= condValues->max_length )
        sub_1C13F88(this, *(_QWORD *)&oldFriendShipRank);
      ...
      if ( condType == 1 )
      {
        ...
        if ( !byte_4BAF1E5 )
        {
          sub_1C13D24(&NetworkManager_TypeInfo, *(_QWORD *)&oldFriendShipRank);
          byte_4BAF1E5 = 1;
        }
      ...
      else if ( (oldFriendShipRank & 0x80000000) != 0 || condType != 9 )
      {
        ...
        if ( !CondType_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
        this = (ServantCommentAddEntity_o *)CondType__IsOpen_38775628(condType, v10, v16, svtId, 0LL);
        if ( ((unsigned __int8)this & 1) != 0 )
          return 1;
      }
      ...
      condValues = v4->fields.condValues;
      if ( !condValues )
        sub_1C13F80(this, *(_QWORD *)&oldFriendShipRank);
    }
  }
  ...
  else
  {
    ...
    if ( (oldFriendShipRank & 0x80000000) != 0 || v18 != 9 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      return CondType__IsOpen_38775628(v18, v23, v26, v25, 0LL);
    }
    else
    {
