        ...
        const MethodInfo *method)
{
  if ( (byte_4BC8180 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int__int__int___, *(_QWORD *)&id);
    byte_4BC8180 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8182 & 1) == 0 )
  {
    ...
    this = (ServantCommentAddEntity_o *)sub_1C1ABD4(&NetworkManager_TypeInfo, v7);
    byte_4BC8182 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8181 & 1) == 0 )
  {
    ...
    this = (ServantCommentAddEntity_o *)sub_1C1ABD4(&NetworkManager_TypeInfo, v5);
    byte_4BC8181 = 1;
  }
  ...
  if ( condValues )
  {
    ...
    while ( 1 )
    {
      ...
      else if ( (oldFriendShipRank & 0x80000000) != 0 || condType != 9 )
      {
        ...
        if ( !CondType_TypeInfo->_2.cctor_finished )
          j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
        this = (ServantCommentAddEntity_o *)CondType__IsOpen_38828316(condType, v10, v16, svtId, 0LL);
        if ( ((unsigned __int8)this & 1) != 0 )
          return 1;
      }
  ...
  else
  {
    ...
    if ( (oldFriendShipRank & 0x80000000) != 0 || v18 != 9 )
    {
      ...
      if ( !CondType_TypeInfo->_2.cctor_finished )
        j_il2cpp_runtime_class_init_0(CondType_TypeInfo);
      return CondType__IsOpen_38828316(v18, v23, v26, v25, 0LL);
    }
    else
    {
