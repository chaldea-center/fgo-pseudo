        ...
        const MethodInfo *method)
{
  ...
  DataMasterBase_object__object__object____ctor(
    ...
    247,
    (const MethodInfo_30D41BC *)Method_DataMasterBase_ServantPassiveSkillReleaseMaster__ServantPassiveSkillReleaseEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  return (ServantPassiveSkillReleaseEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                                 PK,
                                                 (const MethodInfo_30D41FC *)Method_DataMasterBase_ServantPassiveSkillReleaseMaster__ServantPassiveSkillReleaseEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_30D424C *)Method_DataMasterBase_ServantPassiveSkillReleaseMaster__ServantPassiveSkillReleaseEntity__string__TryGetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  ServantPhotoEntity_o *v26; // x0
  int32_t v27; // w1
  const MethodInfo *v28; // x2
  ServantPassiveSkillReleaseEntity_o *v31; // [xsp+8h] [xbp-68h] BYREF

  if ( (byte_49FCBB6 & 1) == 0 )
  {
    sub_1B640C8(&System_Collections_Generic_IReadOnlyDictionary_string__DataEntityBase__TypeInfo, *(_QWORD *)&svtId);
    sub_1B640C8(&ServantPassiveSkillReleaseEntity_TypeInfo, v13);
    byte_49FCBB6 = 1;
  }
  condGroup = 0;
  v15 = 1;
...
LABEL_9:
    ...
    if ( LOBYTE(v31->klass->vtable._0_Equals.methodPtr) < (unsigned int)methodPtr_low
      || (ServantPassiveSkillReleaseEntity_c *)v31->klass->_2.typeHierarchy[methodPtr_low - 1] != ServantPassiveSkillReleaseEntity_TypeInfo )
    {
      break;
    }
    ++v15;
    ...
    else
    {
      ...
      if ( v16 )
        return v16;
LABEL_19:
      isBaseResult = ServantPassiveSkillReleaseEntity__isUse(v31, dispLimitCount, beforeClearQuestId, 0LL);
    }
  }
  sub_1B645E4(v31);
  return (unsigned __int8)ServantPhotoEntity__GetFaceList(v26, v27, v28);
}