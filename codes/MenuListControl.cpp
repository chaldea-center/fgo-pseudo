void __fastcall MenuListControl___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A01CEA & 1) == 0 )
  {
    sub_1B64870(&MenuListControl_TypeInfo, v1);
    byte_4A01CEA = 1;
  }
...
void __fastcall MenuListControl___ctor(MenuListControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE9 & 1) == 0 )
  {
    sub_1B64870(&MenuListControl_CombineKind_var, method);
    sub_1B64870(&System_Enum_TypeInfo, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_SetNoticeNumControl___ctor__, v4);
    sub_1B64870(&System_Collections_Generic_List_SetNoticeNumControl__TypeInfo, v5);
    sub_1B64870(&RestTimeNoticeControl___TypeInfo, v6);
    sub_1B64870(&System_Type_TypeInfo, v7);
    byte_4A01CE9 = 1;
  }
  v8 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_SetNoticeNumControl__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v8,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_SetNoticeNumControl___ctor__);
  this->fields.setNoticeNumList = (struct System_Collections_Generic_List_SetNoticeNumControl__o *)v8;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.setNoticeNumList, (int32_t)v8, v9, v10);
  ...
  if ( !Names )
    sub_1B64ACC(0LL, v14);
  v15 = (struct RestTimeNoticeControl_array *)sub_1B64918(RestTimeNoticeControl___TypeInfo, Names->max_length);
  this->fields.restTimeNoticeList = v15;
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.restTimeNoticeList, (int32_t)v15, v16, v17);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE4 & 1) == 0 )
  {
    ...
    sub_1B64870(&MenuListControl_TypeInfo, v2);
    byte_4A01CE4 = 1;
  }
...
void __fastcall MenuListControl__InitMenuEventNotice(MenuListControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01CDD & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponentsInChildren_EventNoticeControl___, method);
    sub_1B64870(&Method_System_Collections_Generic_List_EventNoticeControl__Add__, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_EventNoticeControl___ctor__, v4);
    sub_1B64870(&System_Collections_Generic_List_EventNoticeControl__TypeInfo, v5);
    byte_4A01CDD = 1;
  }
  ...
  v9 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_EventNoticeControl__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v9,
    (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_EventNoticeControl___ctor__);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.noticeList, (int32_t)v9, v11, v12);
  v13 = childCount - 1;
  if ( childCount - 1 >= 1 )
  {
    v14 = 0;
    while ( 1 )
    {
      ...
      gameObject = (UnityEngine_GameObject_o *)UnityEngine_Component__GetComponentsInChildren_object_(
                                                 (UnityEngine_Component_o *)gameObject,
                                                 1,
                                                 (const MethodInfo_2E32C58 *)Method_UnityEngine_Component_GetComponentsInChildren_EventNoticeControl___);
      if ( !gameObject )
        goto LABEL_25;
...
void __fastcall MenuListControl__SetBudgeNumNotice(MenuListControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01CDE & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_Component_GetComponentInChildren_RestTimeNoticeControl___, method);
    sub_1B64870(&Method_UnityEngine_Component_GetComponentInChildren_SetNoticeNumControl___, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_SetNoticeNumControl__Add__, v4);
  ...
  if ( v8 >= 1 )
  {
    ...
    for ( i = 32LL; ; i += 8LL )
    {
      ...
      if ( !gameObject )
        break;
      gameObject = (UnityEngine_GameObject_o *)UnityEngine_Component__GetComponentInChildren_object__48440272(
                                                 (UnityEngine_Component_o *)gameObject,
                                                 (const MethodInfo_2E323D0 *)Method_UnityEngine_Component_GetComponentInChildren_SetNoticeNumControl___);
      ...
      else
      {
        ...
        sub_1B64814((ServantStatusBattleListViewItem_o *)(v19 + 4), (int32_t)v18, v12, v13);
      }
      gameObject = (UnityEngine_GameObject_o *)this->fields.menuListGrid;
      if ( !gameObject )
        break;
      ...
      ComponentInChildren_object__48440272 = UnityEngine_Component__GetComponentInChildren_object__48440272(
                                               (UnityEngine_Component_o *)gameObject,
                                               (const MethodInfo_2E323D0 *)Method_UnityEngine_Component_GetComponentInChildren_RestTimeNoticeControl___);
      ...
      if ( ((unsigned __int8)gameObject & 1) != 0 )
      {
        ...
        {
          gameObject = (UnityEngine_GameObject_o *)sub_1B649AC(
                                                     ComponentInChildren_object__48440272,
        ...
        if ( v9 >= restTimeNoticeList->max_length )
          sub_1B64AD4(gameObject, v7);
        restTimeNoticeList->m_Items[v9] = (RestTimeNoticeControl_o *)ComponentInChildren_object__48440272;
        sub_1B64814(
...
void __fastcall MenuListControl__SetEventNotice(MenuListControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE5 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_EventNoticeControl__get_Count__, method);
    sub_1B64870(&Method_System_Collections_Generic_List_EventNoticeControl__get_Item__, v3);
    byte_4A01CE5 = 1;
  }
    ...
    if ( size >= 1 )
    {
      ...
      do
      {
        noticeList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                    noticeList,
                                                                    v7,
                                                                    (const MethodInfo_34AF6E0 *)Method_System_Collections_Generic_List_EventNoticeControl__get_Item__);
        if ( !noticeList )
          break;
...
void __fastcall MenuListControl__UpdateAnim(MenuListControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE3 & 1) == 0 )
  {
    sub_1B64870(&MenuListControl_TypeInfo, method);
...
void __fastcall MenuListControl__UpdateEventNotice(MenuListControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE7 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_EventNoticeControl__Dispose__, method);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_EventNoticeControl__MoveNext__, v3);
    sub_1B64870(&Method_System_Collections_Generic_List_Enumerator_EventNoticeControl__get_Current__, v4);
    sub_1B64870(&Method_System_Collections_Generic_List_EventNoticeControl__GetEnumerator__, v5);
    byte_4A01CE7 = 1;
  }
  ...
  System_Collections_Generic_List_object___GetEnumerator(
    ...
    noticeList,
    (const MethodInfo_34B0548 *)Method_System_Collections_Generic_List_EventNoticeControl__GetEnumerator__);
  while ( System_Collections_Generic_List_Enumerator_object___MoveNext(
            &v8,
            (const MethodInfo_322C38C *)Method_System_Collections_Generic_List_Enumerator_EventNoticeControl__MoveNext__) )
  {
  ...
  System_Collections_Generic_List_Enumerator_object___Dispose(
    &v8,
    (const MethodInfo_322C388 *)Method_System_Collections_Generic_List_Enumerator_EventNoticeControl__Dispose__);
}
...
void __fastcall MenuListControl__checkEventNotice(MenuListControl_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A01CDF & 1) == 0 )
  {
    sub_1B64870(&Method_System_Linq_Enumerable_FirstOrDefault_EventEntity___, method);
    ...
    sub_1B64870(&System_Func_EventEntity__bool__TypeInfo, v6);
    sub_1B64870(&Method_System_Collections_Generic_List_EventCampaignEntity__Add__, v7);
    sub_1B64870(&Method_System_Collections_Generic_List_EventInfoData__Add__, v8);
    sub_1B64870(&Method_System_Collections_Generic_List_EventCampaignEntity__GetEnumerator__, v9);
    sub_1B64870(&Method_System_Collections_Generic_List_EventInfoData___ctor__, v10);
    sub_1B64870(&Method_System_Collections_Generic_List_EventCampaignEntity___ctor__, v11);
    sub_1B64870(&Method_System_Collections_Generic_List_EventNoticeControl__get_Item__, v12);
    sub_1B64870(&System_Collections_Generic_List_EventInfoData__TypeInfo, v13);
    sub_1B64870(&System_Collections_Generic_List_EventCampaignEntity__TypeInfo, v14);
    sub_1B64870(&Method_MenuListControl___c__DisplayClass20_0__checkEventNotice_b__0__, v15);
    this = (MenuListControl_o *)sub_1B64870(&MenuListControl___c__DisplayClass20_0_TypeInfo, v16);
    byte_4A01CDF = 1;
  }
  ...
  if ( combineEventList )
  {
    v19 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_EventInfoData__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v19,
      (const MethodInfo_34AF17C *)Method_System_Collections_Generic_List_EventInfoData___ctor__);
    ...
    sub_1B64814((ServantStatusBattleListViewItem_o *)&v2->fields.combineEventList, (int32_t)v19, v21, v22);
    v23 = (System_Collections_Generic_List_object__o *)sub_1B64ABC(System_Collections_Generic_List_EventCampaignEntity__TypeInfo);
    System_Collections_Generic_List_object____ctor(
      v23,
...
LABEL_17:
    ...
    {
      v34 = sub_1B64ABC(MenuListControl___c__DisplayClass20_0_TypeInfo);
      System_Object___ctor((Il2CppObject *)v34, 0LL);
      if ( !v34 )
        sub_1B64ACC(v35, v36);
      current = (int32_t)v68.fields._current;
      *(_QWORD *)(v34 + 16) = v68.fields._current;
      sub_1B64814((ServantStatusBattleListViewItem_o *)(v34 + 16), current, v37, v38);
      if ( !*(_QWORD *)(v34 + 16) )
        sub_1B64ACC(v40, v41);
      v42 = *(_DWORD *)(*(_QWORD *)(v34 + 16) + 20LL) - 1;
      if ( (unsigned int)v42 < 0x21 && ((0x1840782BBuLL >> v42) & 1) != 0 )
      {
        v43 = (System_Func_object__bool__o *)sub_1B64ABC(System_Func_EventEntity__bool__TypeInfo);
        ...
        else
        {
          ...
          sub_1B64814((ServantStatusBattleListViewItem_o *)(v66 + 4), (int32_t)v47, v60, v61);
        }
      }
    }
    System_Collections_Generic_List_Enumerator_object___Dispose(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE1 & 1) == 0 )
  {
    sub_1B64870(&AtlasManager_TypeInfo, targetSprite);
    byte_4A01CE1 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE2 & 1) == 0 )
  {
    sub_1B64870(&Method_System_Collections_Generic_List_SetNoticeNumControl__get_Item__, enableData);
    byte_4A01CE2 = 1;
  }
  setNoticeNumList = (System_Collections_Generic_List_object__o *)this->fields.setNoticeNumList;
  if ( !setNoticeNumList )
  ...
  setNoticeNumList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                    setNoticeNumList,
                                                                    1,
                                                                    (const MethodInfo_34AF6E0 *)Method_System_Collections_Generic_List_SetNoticeNumControl__get_Item__);
  if ( !enableData )
    goto LABEL_17;
  if ( !setNoticeNumList )
    goto LABEL_17;
  ...
  if ( !setNoticeNumList
    || (setNoticeNumList = (System_Collections_Generic_List_object__o *)System_Collections_Generic_List_object___get_Item(
                                                                          setNoticeNumList,
                                                                          9,
                                                                          (const MethodInfo_34AF6E0 *)Method_System_Collections_Generic_List_SetNoticeNumControl__get_Item__)) == 0LL
    || (SetNoticeNumControl__setNoticeNum(
          (SetNoticeNumControl_o *)setNoticeNumList,
  ...
  {
LABEL_17:
    sub_1B64ACC(setNoticeNumList, enableData);
  }
  SetNoticeNumControl__setNoticeNum(
    (SetNoticeNumControl_o *)setNoticeNumList,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01CE0 & 1) == 0 )
  {
    sub_1B64870(&EventInfoData_TypeInfo, combineEventEnt);
    byte_4A01CE0 = 1;
  }
  v6 = sub_1B64ABC(EventInfoData_TypeInfo);
  ...
  *(_QWORD *)(v6 + 32) = targetIds;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 32), (int32_t)targetIds, v9, v10);
  *(_DWORD *)(v6 + 24) = eventEnt->fields.iconId;
  EventName = EventEntity__getEventName(eventEnt, 0LL);
  *(_QWORD *)(v6 + 40) = EventName;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 40), (int32_t)EventName, v13, v14);
  detail = eventEnt->fields.detail;
  *(_QWORD *)(v6 + 48) = detail;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 48), (int32_t)detail, v16, v17);
  *(float *)(v6 + 56) = (float)combineEventEnt->fields.value / 1000.0;
  *(_OWORD *)(v6 + 64) = *(_OWORD *)&eventEnt->fields.startedAt;
  *(_QWORD *)(v6 + 80) = eventEnt;
  sub_1B64814((ServantStatusBattleListViewItem_o *)(v6 + 80), (int32_t)eventEnt, v18, v19);
