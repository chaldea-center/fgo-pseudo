void DiggingBlockComponent___ctor(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = StringLiteral_16072/*"[FF0000]"*/;
  this->fields.consumableItemTextColor = (struct System_String_o *)StringLiteral_16072/*"[FF0000]"*/;
  sub_1CE66A4(&this->fields.consumableItemTextColor, v3);
...
System_String_o *DiggingBlockComponent__GetDiggingSeName(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEF9D & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1CE6700(&StringLiteral_17026/*"ar173"*/);
    byte_4DFEF9D = 1;
  }
  ...
  {
    v6 = (System_String_o **)&StringLiteral_17026/*"ar173"*/;
  }
  else
  {
...
int32_t DiggingBlockComponent__GetHintConsumeNum(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEF9C & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1CE6700(&Method_System_Array_IndexOf_int___);
    byte_4DFEF9C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  struct EventDiggingBlockEntity_o *v11; // x8
  ...
  if ( (byte_4DFEF97 & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1CE6700(&StringLiteral_19439/*"event_digging_block_{0}"*/);
    byte_4DFEF97 = 1;
  }
  this->fields.hintInfo = 0;
  sub_1CE66A4(&this->fields.hintInfo, 0);
  ...
  sub_1CE66A4(&this->fields.blockInfo, blockInfo);
  hintSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !hintSprite )
    goto LABEL_13;
  ...
  hintSprite = (UnityEngine_Component_o *)sub_1CE66A4(&this->fields.diggingBlockEntity, Entity);
  ...
  v11 = this->fields.diggingBlockEntity;
  if ( !v11
    || (blockSprite = this->fields.blockSprite,
        imageId = v11->fields.imageId,
        v13 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &imageId),
        v14 = System_String__Format((System_String_o *)StringLiteral_19439/*"event_digging_block_{0}"*/, v13, 0),
        ...
        hintSprite = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0),
        (v16 = this->fields.blockInfo) == 0)
    || !hintSprite )
  {
LABEL_13:
    sub_1CE6958(hintSprite, v7);
  }
  ...
  sub_1CE66A4(&this->fields._OnClickPanel_k__BackingField, 0);
}
...
void DiggingBlockComponent__SetActiveBlockUI(DiggingBlockComponent_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1CE6958(blockSprite, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)blockSprite, isActive, 0);
}
...
void DiggingBlockComponent__SetConsumableItemInfo(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEF9A & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    this = (DiggingBlockComponent_o *)sub_1CE6700(&StringLiteral_1/*""*/);
    byte_4DFEF9A = 1;
  }
  v16 = 0;
  entity = 0;
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3B54D44 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  if ( !entity || !v16 )
LABEL_26:
    sub_1CE6958(commonConsumeMaster, v4);
...
LABEL_22:
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)System_String__Concat_65122828(consumableItemTextColor, v14, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1CE6700(&int_TypeInfo);
    sub_1CE6700(&StringLiteral_19440/*"event_digging_layer_{0}"*/);
    byte_4DFEF99 = 1;
  }
  this->fields.hintInfo = hintInfo;
  sub_1CE66A4(&this->fields.hintInfo, hintInfo);
  hintSprite = (UnityEngine_Component_o *)this->fields.hintSprite;
  if ( !hintSprite
    || (hintSprite = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(hintSprite, 0),
  ...
  v10 = System_String__Format((System_String_o *)StringLiteral_19440/*"event_digging_layer_{0}"*/, v9, 0);
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI_41749752(eventId, sprite, name, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4DFEF9B & 1) == 0 )
  {
    ...
    sub_1CE6700(&Method_DiggingBlockComponent___c__DisplayClass23_0__SetPanelClickAction_b__0__);
    sub_1CE6700(&DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
    byte_4DFEF9B = 1;
  }
  v5 = (Il2CppObject *)sub_1CE694C(DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
  System_Object___ctor(v5, 0);
  if ( !v5 )
    sub_1CE6958(v6, v7);
  v5[1].klass = (Il2CppClass *)clickAction;
  sub_1CE66A4(&v5[1], clickAction);
  v5[1].monitor = this;
  ...
  this->fields._OnClickPanel_k__BackingField = v8;
  sub_1CE66A4(&this->fields._OnClickPanel_k__BackingField, v8);
}
...
void DiggingBlockComponent__SetPointAnimSprite(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4DFEF9E & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_6283/*"EventPoint_"*/);
    byte_4DFEF9E = 1;
  }
  ...
  v5 = System_String__Concat_65122828((System_String_o *)StringLiteral_6283/*"EventPoint_"*/, v4, 0);
        ...
        const MethodInfo *method)
{
  if ( (byte_4DFEFA1 & 1) == 0 )
  {
    sub_1CE6700(&Method_ActionExtensions_Call_DiggingBlockComponent___);
    byte_4DFEFA1 = 1;
  }
  ActionExtensions__Call_object_(
    (System_Action_T__o *)this->fields.clickAction,
    (Il2CppObject *)this->fields.__4__this,
    (const MethodInfo_3149A44 *)Method_ActionExtensions_Call_DiggingBlockComponent___);
}