void DiggingBlockComponent___ctor(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  v3 = StringLiteral_16021/*"[FF0000]"*/;
  this->fields.consumableItemTextColor = (struct System_String_o *)StringLiteral_16021/*"[FF0000]"*/;
  sub_1C93A78(&this->fields.consumableItemTextColor, v3);
...
System_String_o *DiggingBlockComponent__GetDiggingSeName(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2AEAA & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1C93AD4(&StringLiteral_16974/*"ar173"*/);
    byte_4D2AEAA = 1;
  }
  ...
  {
    v6 = (System_String_o **)&StringLiteral_16974/*"ar173"*/;
  }
  else
  {
...
int32_t DiggingBlockComponent__GetHintConsumeNum(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2AEA9 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1C93AD4(&Method_System_Array_IndexOf_int___);
    byte_4D2AEA9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2AEA4 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C93AD4(&StringLiteral_19378/*"event_digging_block_{0}"*/);
    byte_4D2AEA4 = 1;
  }
  this->fields.hintInfo = 0;
  sub_1C93A78(&this->fields.hintInfo, 0);
  ...
  sub_1C93A78(&this->fields.blockInfo, blockInfo);
  hintSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !hintSprite )
    goto LABEL_13;
  ...
  hintSprite = (UnityEngine_Component_o *)sub_1C93A78(&this->fields.diggingBlockEntity, Entity);
  ...
  if ( !v11
    || (blockSprite = this->fields.blockSprite,
        ...
        v14 = System_String__Format((System_String_o *)StringLiteral_19378/*"event_digging_block_{0}"*/, v13, 0),
...
void DiggingBlockComponent__SetActiveBlockUI(DiggingBlockComponent_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C93D2C(blockSprite, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)blockSprite, isActive, 0);
}
...
void DiggingBlockComponent__SetConsumableItemInfo(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2AEA7 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    this = (DiggingBlockComponent_o *)sub_1C93AD4(&StringLiteral_1/*""*/);
    byte_4D2AEA7 = 1;
  }
  v16 = 0;
  entity = 0;
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3AC52FC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  if ( !entity || !v16 )
LABEL_26:
    sub_1C93D2C(commonConsumeMaster, v4);
...
LABEL_22:
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)System_String__Concat_64425724(consumableItemTextColor, v14, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&int_TypeInfo);
    sub_1C93AD4(&StringLiteral_19379/*"event_digging_layer_{0}"*/);
    byte_4D2AEA6 = 1;
  }
  this->fields.hintInfo = hintInfo;
  sub_1C93A78(&this->fields.hintInfo, hintInfo);
  hintSprite = (UnityEngine_Component_o *)this->fields.hintSprite;
  if ( !hintSprite
    || (hintSprite = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(hintSprite, 0),
  ...
  v10 = System_String__Format((System_String_o *)StringLiteral_19379/*"event_digging_layer_{0}"*/, v9, 0);
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI_41320352(eventId, sprite, name, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2AEA8 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&Method_DiggingBlockComponent___c__DisplayClass23_0__SetPanelClickAction_b__0__);
    sub_1C93AD4(&DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
    byte_4D2AEA8 = 1;
  }
  v5 = (Il2CppObject *)sub_1C93D20(DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
  System_Object___ctor(v5, 0);
  if ( !v5 )
    sub_1C93D2C(v6, v7);
  v5[1].klass = (Il2CppClass *)clickAction;
  sub_1C93A78(&v5[1], clickAction);
  v5[1].monitor = this;
...
void DiggingBlockComponent__SetPointAnimSprite(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2AEAB & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_6268/*"EventPoint_"*/);
    byte_4D2AEAB = 1;
  }
  ...
  v5 = System_String__Concat_64425724((System_String_o *)StringLiteral_6268/*"EventPoint_"*/, v4, 0);
        ...
        const MethodInfo *method)
{
  if ( (byte_4D2AEAE & 1) == 0 )
  {
    sub_1C93AD4(&Method_ActionExtensions_Call_DiggingBlockComponent___);
    byte_4D2AEAE = 1;
  }
  ActionExtensions__Call_object_(
    (System_Action_T__o *)this->fields.clickAction,
    (Il2CppObject *)this->fields.__4__this,
    (const MethodInfo_30EBC54 *)Method_ActionExtensions_Call_DiggingBlockComponent___);
}