void __fastcall DiggingBlockComponent___ctor(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB8984 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_16182/*"[CRIWARE] StopForSeek is not supported on this platform/codec."*/, method);
    byte_4BB8984 = 1;
  }
  v9 = StringLiteral_16182/*"[CRIWARE] StopForSeek is not supported on this platform/codec."*/;
  this->fields.consumableItemTextColor = (struct System_String_o *)StringLiteral_16182/*"[CRIWARE] StopForSeek is not supported on this platform/codec."*/;
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.consumableItemTextColor, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8981 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1C13D24(&StringLiteral_17131/*"ar-KW"*/, method);
    byte_4BB8981 = 1;
  }
  ...
  {
    v6 = (System_String_o **)&StringLiteral_17131/*"ar-KW"*/;
  }
  else
  {
...
int32_t __fastcall DiggingBlockComponent__GetHintConsumeNum(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB8980 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1C13D24(&Method_System_Array_IndexOf_int___, method);
    byte_4BB8980 = 1;
  }
...
int32_t __fastcall DiggingBlockComponent__GetTotalEventPoint(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB8983 & 1) == 0 )
  {
    ...
    sub_1C13D24(&Method_DataManager_GetMasterData_EventDiggingBlockMaster___, v3);
    sub_1C13D24(&Method_DataMasterBase_EventDiggingBlockMaster__EventDiggingBlockEntity__int__GetEntity__, v4);
        ...
        const MethodInfo *method)
{
  ...
  struct DiggingInfo_BlockInfos_o *v39; // x8
  int32_t imageId; // [xsp+Ch] [xbp-24h] BYREF

  if ( (byte_4BB897B & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_EventDiggingBlockMaster___, blockInfo);
    ...
    sub_1C13D24(&StringLiteral_19468/*"event_bg_{0}03"*/, v14);
    byte_4BB897B = 1;
  }
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&this->fields.blockInfo, (int64_t)blockInfo, v17, v18, v19, v20, v21, v22);
  hintSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !hintSprite )
    goto LABEL_13;
  ...
  if ( !v34
    || (blockSprite = this->fields.blockSprite,
        ...
        v36 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &imageId, v31, v32, v33),
        v37 = System_String__Format((System_String_o *)StringLiteral_19468/*"event_bg_{0}03"*/, v36, 0LL),
        ...
        hintSprite = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0LL),
        (v39 = this->fields.blockInfo) == 0LL)
    || !hintSprite )
  {
LABEL_13:
    sub_1C13F80(hintSprite, v15);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)hintSprite, v39->fields.isDigged != 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C13F80(blockSprite, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)blockSprite, isActive, 0LL);
}
...
void __fastcall DiggingBlockComponent__SetConsumableItemInfo(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB897E & 1) == 0 )
  {
    ...
    this = (DiggingBlockComponent_o *)sub_1C13D24(&StringLiteral_1/*""*/, v5);
    byte_4BB897E = 1;
  }
  v19 = 0LL;
  entity = 0LL;
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  if ( !entity || !v19 )
LABEL_26:
    sub_1C13F80(commonConsumeMaster, v7);
...
LABEL_22:
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)System_String__Concat_62967944(consumableItemTextColor, v17, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB897D & 1) == 0 )
  {
    sub_1C13D24(&int_TypeInfo, hintInfo);
    sub_1C13D24(&StringLiteral_19469/*"event_bg_{0}04"*/, v10);
    byte_4BB897D = 1;
  }
  ...
  if ( !hintSprite
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)hintSprite, blockInfo->fields.isDigged != 1, 0LL),
        !hintInfo) )
  {
    sub_1C13F80(hintSprite, v11);
  }
  v17 = this->fields.hintSprite;
  hintImageId = hintInfo->fields.hintImageId;
  v18 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &hintImageId, v14, v15, v16);
  v19 = System_String__Format((System_String_o *)StringLiteral_19469/*"event_bg_{0}04"*/, v18, 0LL);
  DiggingBlockComponent__SetImage(this, v17, v19, v20);
  DiggingBlockComponent__SetConsumableItemInfo(this, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI_39004844(eventId, sprite, name, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB897F & 1) == 0 )
  {
    sub_1C13D24(&System_Action_TypeInfo, clickAction);
    sub_1C13D24(&Method_DiggingBlockComponent___c__DisplayClass23_0__SetPanelClickAction_b__0__, v5);
    sub_1C13D24(&DiggingBlockComponent___c__DisplayClass23_0_TypeInfo, v6);
    byte_4BB897F = 1;
  }
  v7 = sub_1C13F70(DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  if ( !v7 )
    sub_1C13F80(v8, v9);
  *(_QWORD *)(v7 + 16) = clickAction;
  sub_1C13CC8((PartyOrganizationUtility_o *)(v7 + 16), (int64_t)clickAction, v10, v11, v12, v13, v14, v15);
  *(_QWORD *)(v7 + 24) = this;
...
void __fastcall DiggingBlockComponent__SetPointAnimSprite(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB8982 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_6351/*"EventMove"*/, method);
    byte_4BB8982 = 1;
  }
  ...
  v5 = System_String__Concat_62967944((System_String_o *)StringLiteral_6351/*"EventMove"*/, v4, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB897A & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_CommonConsumeMaster___, method);
        ...
        const MethodInfo *method)
{
  if ( (byte_4BB8985 & 1) == 0 )
  {
    sub_1C13D24(&Method_ActionExtensions_Call_DiggingBlockComponent___, method);
    byte_4BB8985 = 1;
  }
  ActionExtensions__Call_object_(
    (System_Action_T__o *)this->fields.clickAction,
    (Il2CppObject *)this->fields.__4__this,
    (const MethodInfo_2EE1C78 *)Method_ActionExtensions_Call_DiggingBlockComponent___);
}