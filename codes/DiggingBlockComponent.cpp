void DiggingBlockComponent___ctor(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  this->fields.consumableItemTextColor = (struct System_String_o *)StringLiteral_15920/*"[FF0000]"*/;
  sub_1C2D434(&this->fields.consumableItemTextColor);
...
System_String_o *DiggingBlockComponent__GetDiggingSeName(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21991 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1C2D490(&StringLiteral_16848/*"ar173"*/);
    byte_4C21991 = 1;
  }
  ...
  {
    v7 = (System_String_o **)&StringLiteral_16848/*"ar173"*/;
  }
  else
  {
...
int32_t DiggingBlockComponent__GetHintConsumeNum(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21990 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1C2D490(&Method_System_Array_IndexOf_int___);
    byte_4C21990 = 1;
  }
  ...
  if ( !v6 || (consumeHintItemNums = v6->fields.consumeHintItemNums) == 0 )
LABEL_11:
    sub_1C2D6EC(this, method);
        ...
        const MethodInfo *method)
{
  ...
  __int64 v11; // x3
  __int64 v12; // x4
  struct EventDiggingBlockEntity_o *v13; // x8
  UISprite_o *blockSprite; // x20
  Il2CppObject *v15; // x0
  System_String_o *v16; // x0
  const MethodInfo *v17; // x3
  struct DiggingInfo_BlockInfos_o *v18; // x8
  ...
  if ( (byte_4C2198B & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_1C2D490(&StringLiteral_19170/*"event_digging_block_{0}"*/);
    byte_4C2198B = 1;
  }
  this->fields.hintInfo = 0;
  sub_1C2D434(&this->fields.hintInfo);
  ...
  sub_1C2D434(&this->fields.blockInfo);
  hintSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !hintSprite )
    goto LABEL_13;
  ...
  this->fields.diggingBlockEntity = (struct EventDiggingBlockEntity_o *)DataMasterBase_object__object__int___GetEntity(
                                                                          ...
                                                                          blockInfo->fields.diggingBlockId,
                                                                          (const MethodInfo_3387D98 *)Method_DataMasterBase_EventDiggingBlockMaster__EventDiggingBlockEntity__int__GetEntity__);
  hintSprite = (UnityEngine_Component_o *)sub_1C2D434(&this->fields.diggingBlockEntity);
  ...
  v13 = this->fields.diggingBlockEntity;
  if ( !v13
    || (blockSprite = this->fields.blockSprite,
        ...
        v16 = System_String__Format((System_String_o *)StringLiteral_19170/*"event_digging_block_{0}"*/, v15, 0),
        DiggingBlockComponent__SetImage(this, blockSprite, v16, v17),
        hintSprite = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(
                                                  (UnityEngine_Component_o *)this,
                                                  0),
        (v18 = this->fields.blockInfo) == 0)
    || !hintSprite )
  {
LABEL_13:
    sub_1C2D6EC(hintSprite, v7);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)hintSprite, v18->fields.isDigged != 1, 0);
...
void DiggingBlockComponent__SetActiveBlockUI(DiggingBlockComponent_o *this, bool isActive, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C2D6EC(blockSprite, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)blockSprite, isActive, 0);
}
...
void DiggingBlockComponent__SetConsumableItemInfo(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C2198E & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    this = (DiggingBlockComponent_o *)sub_1C2D490(&StringLiteral_1/*""*/);
    byte_4C2198E = 1;
  }
  v16 = 0;
  entity = 0;
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  if ( !entity || !v16 )
LABEL_26:
    sub_1C2D6EC(commonConsumeMaster, v4);
...
LABEL_22:
  ...
  commonConsumeMaster = (CommonConsumeMaster_o *)System_String__Concat_63457864(consumableItemTextColor, v14, 0);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1C2D490(&int_TypeInfo);
    sub_1C2D490(&StringLiteral_19171/*"event_digging_layer_{0}"*/);
    byte_4C2198D = 1;
  }
  ...
  if ( !hintSprite
    ...
    || (UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)hintSprite, blockInfo->fields.isDigged != 1, 0),
        !hintInfo) )
  {
    sub_1C2D6EC(hintSprite, v5);
  }
  v11 = this->fields.hintSprite;
  hintImageId = hintInfo->fields.hintImageId;
  v12 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &hintImageId, v8, v9, v10);
  v13 = System_String__Format((System_String_o *)StringLiteral_19171/*"event_digging_layer_{0}"*/, v12, 0);
  DiggingBlockComponent__SetImage(this, v11, v13, v14);
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI_40385372(eventId, sprite, name, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2198F & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_DiggingBlockComponent___c__DisplayClass23_0__SetPanelClickAction_b__0__);
    sub_1C2D490(&DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
    byte_4C2198F = 1;
  }
  v5 = (Il2CppObject *)sub_1C2D6DC(DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
...
void DiggingBlockComponent__SetPointAnimSprite(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C21992 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_6228/*"EventPoint_"*/);
    byte_4C21992 = 1;
  }
  ...
  v5 = System_String__Concat_63457864((System_String_o *)StringLiteral_6228/*"EventPoint_"*/, v4, 0);
        ...
        const MethodInfo *method)
{
  if ( (byte_4C21995 & 1) == 0 )
  {
    sub_1C2D490(&Method_ActionExtensions_Call_DiggingBlockComponent___);
    byte_4C21995 = 1;
  }
  ActionExtensions__Call_object_(
    (System_Action_T__o *)this->fields.clickAction,
    (Il2CppObject *)this->fields.__4__this,
    (const MethodInfo_301B240 *)Method_ActionExtensions_Call_DiggingBlockComponent___);
}