void __fastcall DiggingBlockComponent___ctor(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E2C & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_15963/*"[FF0000]"*/, method);
    byte_4AB9E2C = 1;
  }
  v5 = StringLiteral_15963/*"[FF0000]"*/;
  this->fields.consumableItemTextColor = (struct System_String_o *)StringLiteral_15963/*"[FF0000]"*/;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.consumableItemTextColor, v5, v2, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E29 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1BAB41C(&StringLiteral_16906/*"ar173"*/, method);
    byte_4AB9E29 = 1;
  }
  ...
  {
    v6 = (System_String_o **)&StringLiteral_16906/*"ar173"*/;
  }
  else
  {
...
int32_t __fastcall DiggingBlockComponent__GetHintConsumeNum(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E28 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_1BAB41C(&Method_System_Array_IndexOf_int___, method);
    byte_4AB9E28 = 1;
  }
...
int32_t __fastcall DiggingBlockComponent__GetTotalEventPoint(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E2B & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventDiggingBlockMaster___, v3);
    sub_1BAB41C(&Method_DataMasterBase_EventDiggingBlockMaster__EventDiggingBlockEntity__int__GetEntity__, v4);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E23 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_EventDiggingBlockMaster___, blockInfo);
    sub_1BAB41C(&Method_DataMasterBase_EventDiggingBlockMaster__EventDiggingBlockEntity__int__GetEntity__, v7);
    sub_1BAB41C(&int_TypeInfo, v8);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9);
    sub_1BAB41C(&StringLiteral_19195/*"event_digging_block_{0}"*/, v10);
    byte_4AB9E23 = 1;
  }
  this->fields.hintInfo = 0LL;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.hintInfo, 0, eventId, (int32_t)method);
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.blockInfo, (int32_t)blockInfo, v13, v14);
  hintSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !hintSprite )
    goto LABEL_13;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.diggingBlockEntity, (int32_t)Entity, v16, v17);
  ...
  if ( !v22
    || (blockSprite = this->fields.blockSprite,
        ...
        v25 = System_String__Format((System_String_o *)StringLiteral_19195/*"event_digging_block_{0}"*/, v24, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1BAB678(blockSprite, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)blockSprite, isActive, 0LL);
}
...
void __fastcall DiggingBlockComponent__SetConsumableItemInfo(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E26 & 1) == 0 )
  {
    ...
    this = (DiggingBlockComponent_o *)sub_1BAB41C(&StringLiteral_1/*""*/, v5);
    byte_4AB9E26 = 1;
  }
  entity = 0LL;
  v19 = 0LL;
  ...
  commonConsumeMaster = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  if ( !entity || !v19 )
LABEL_22:
    sub_1BAB678(commonConsumeMaster, v7);
...
LABEL_18:
  ...
  commonConsumeMaster = (int64_t)System_String__Concat_62048128(consumableItemTextColor, v17, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E25 & 1) == 0 )
  {
    sub_1BAB41C(&int_TypeInfo, hintInfo);
    sub_1BAB41C(&StringLiteral_19196/*"event_digging_layer_{0}"*/, v6);
    byte_4AB9E25 = 1;
  }
  this->fields.hintInfo = hintInfo;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.hintInfo, (int32_t)hintInfo, (int32_t)method, v3);
  hintSprite = (UnityEngine_Component_o *)this->fields.hintSprite;
  if ( !hintSprite
    || (hintSprite = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(hintSprite, 0LL),
  ...
  v15 = System_String__Format((System_String_o *)StringLiteral_19196/*"event_digging_layer_{0}"*/, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI_38244724(eventId, sprite, name, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E27 & 1) == 0 )
  {
    sub_1BAB41C(&System_Action_TypeInfo, clickAction);
    sub_1BAB41C(&Method_DiggingBlockComponent___c__DisplayClass23_0__SetPanelClickAction_b__0__, v5);
    sub_1BAB41C(&DiggingBlockComponent___c__DisplayClass23_0_TypeInfo, v6);
    byte_4AB9E27 = 1;
  }
  v7 = sub_1BAB668(DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v7, 0LL);
  if ( !v7 )
    sub_1BAB678(v8, v9);
  *(_QWORD *)(v7 + 16) = clickAction;
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v7 + 16), (int32_t)clickAction, v10, v11);
  *(_QWORD *)(v7 + 24) = this;
...
void __fastcall DiggingBlockComponent__SetPointAnimSprite(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E2A & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_6201/*"EventPoint_"*/, method);
    byte_4AB9E2A = 1;
  }
  ...
  v5 = System_String__Concat_62048128((System_String_o *)StringLiteral_6201/*"EventPoint_"*/, v4, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E22 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataManager_GetMasterData_CommonConsumeMaster___, method);
        ...
        const MethodInfo *method)
{
  if ( (byte_4AB9E2D & 1) == 0 )
  {
    sub_1BAB41C(&Method_ActionExtensions_Call_DiggingBlockComponent___, method);
    byte_4AB9E2D = 1;
  }
  ActionExtensions__Call_object_(
    (System_Action_T__o *)this->fields.clickAction,
    (Il2CppObject *)this->fields.__4__this,
    (const MethodInfo_2E184C8 *)Method_ActionExtensions_Call_DiggingBlockComponent___);
}