void __fastcall DiggingBlockComponent___ctor(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  v9 = (System_Int32_array **)StringLiteral_15845/*"[FF0000]"*/;
  this->fields.consumableItemTextColor = (struct System_String_o *)StringLiteral_15845/*"[FF0000]"*/;
  sub_B52920((BattleServantConfConponent_o *)&this->fields.consumableItemTextColor, v9, v2, v3, v4, v5, v6, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2006 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_B52984(&StringLiteral_16548/*"ar173"*/);
    byte_42B2006 = 1;
  }
  ...
  {
    v6 = (System_String_o **)&StringLiteral_16548/*"ar173"*/;
  }
  else
  {
...
int32_t __fastcall DiggingBlockComponent__GetHintConsumeNum(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2005 & 1) == 0 )
  {
    this = (DiggingBlockComponent_o *)sub_B52984(&Method_System_Array_IndexOf_int___);
    byte_42B2005 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2000 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    sub_B52984(&StringLiteral_18634/*"event_digging_block_{0}"*/);
    byte_42B2000 = 1;
  }
  ...
  sub_B52920(
    ...
    v17,
    v18);
  hintSprite = (UnityEngine_Component_o *)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !hintSprite )
    goto LABEL_13;
  ...
  if ( !v27
    || (blockSprite = this->fields.blockSprite,
        ...
        v30 = System_String__Format((System_String_o *)StringLiteral_18634/*"event_digging_block_{0}"*/, v29, 0LL),
        ...
        hintSprite = (UnityEngine_Component_o *)UnityEngine_Component__get_gameObject(
                                                  ...
                                                  0LL),
        (v32 = this->fields.blockInfo) == 0LL)
    || !hintSprite )
  {
LABEL_13:
    sub_B52A5C(hintSprite, v11);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)hintSprite, v32->fields.isDigged != 1, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_B52A5C(blockSprite, isActive);
  }
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)blockSprite, isActive, 0LL);
}
...
void __fastcall DiggingBlockComponent__SetConsumableItemInfo(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2003 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    this = (DiggingBlockComponent_o *)sub_B52984(&StringLiteral_1/*""*/);
    byte_42B2003 = 1;
  }
  v16 = 0LL;
  entity = 0LL;
  ...
  commonConsumeMaster = (int64_t)SingletonMonoBehaviour_WebViewManager___get_Instance((const MethodInfo_2B75DB0 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  ...
  if ( !entity || !v16 )
LABEL_23:
    sub_B52A5C(commonConsumeMaster, v4);
...
LABEL_19:
  ...
  commonConsumeMaster = (int64_t)System_String__Concat_44568316(consumableItemTextColor, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_B52984(&int_TypeInfo);
    sub_B52984(&StringLiteral_18635/*"event_digging_layer_{0}"*/);
    byte_42B2002 = 1;
  }
  ...
  v15 = System_String__Format((System_String_o *)StringLiteral_18635/*"event_digging_layer_{0}"*/, v14, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  AtlasManager__SetEventUI_28377220(eventId, sprite, name, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2004 & 1) == 0 )
  {
    ...
    sub_B52984(&Method_DiggingBlockComponent___c__DisplayClass23_0__SetPanelClickAction_b__0__);
    sub_B52984(&DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
    byte_42B2004 = 1;
  }
  v5 = sub_B52A54(DiggingBlockComponent___c__DisplayClass23_0_TypeInfo);
  ...
  *(_QWORD *)(v5 + 16) = clickAction;
  sub_B52920((BattleServantConfConponent_o *)(v5 + 16), (System_Int32_array **)clickAction, v8, v9, v10, v11, v12, v13);
  *(_QWORD *)(v5 + 24) = this;
...
void __fastcall DiggingBlockComponent__SetPointAnimSprite(DiggingBlockComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2007 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_6223/*"EventPoint_"*/);
    byte_42B2007 = 1;
  }
  ...
  v5 = System_String__Concat_44568316((System_String_o *)StringLiteral_6223/*"EventPoint_"*/, v4, 0LL);
        ...
        const MethodInfo *method)
{
  if ( (byte_42AE318 & 1) == 0 )
  {
    sub_B52984(&Method_ActionExtensions_Call_DiggingBlockComponent___);
    byte_42AE318 = 1;
  }
  ActionExtensions__Call_BlankEarth_QAARotateEarthResponse_(
    (System_Action_T__o *)this->fields.clickAction,
    (BlankEarth_QAARotateEarthResponse_o *)this->fields.__4__this,
    (const MethodInfo_2D61674 *)Method_ActionExtensions_Call_DiggingBlockComponent___);
}