...
System_String_o *TopSignupRequest__getURL(TopSignupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB7F1D & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_23591/*"signup/top"*/);
    byte_4CB7F1D = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63966792(BaseUrl, (System_String_o *)StringLiteral_23591/*"signup/top"*/, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v13
    || (NetworkManager__SetSignup_41590468(v13, name, genderType, Month, (int32_t)Day, 0),
        (Day = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0)
