...
System_String_o *__fastcall TopSignupRequest__getURL(TopSignupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB6109 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_23712/*"show-alternating-row-backgrounds"*/, v2);
    byte_4BB6109 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62967944(BaseUrl, (System_String_o *)StringLiteral_23712/*"show-alternating-row-backgrounds"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
    ...
    && (SelfUserGame = UserGameMaster__getSelfUserGame(0LL)) != 0LL )
  {
    ...
    if ( !v18
      || (NetworkManager__SetSignup_39696728(v18, name, genderType, Month, (int32_t)Day, 0LL),
          (Day = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3869BD8 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL)
    ...
    v22 = &StringLiteral_22595/*"offline"*/;
  }
  else
  {
    v22 = &StringLiteral_22421/*"newAttributes"*/;
  }
