...
System_String_o *__fastcall TopSignupRequest__getURL(TopSignupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A21445 & 1) == 0 )
  {
    ...
    sub_1B715CC(&StringLiteral_23266/*"signup/top"*/, v2);
    byte_4A21445 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61505504(BaseUrl, (System_String_o *)StringLiteral_23266/*"signup/top"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( v10
    && ResponseData__checkError_40915860(v10, 0LL)
    && (SelfUserGame = UserGameMaster__getSelfUserGame(0LL)) != 0LL )
  {
    ...
    if ( !v17
      || (NetworkManager__SetSignup_38262348(v17, name, genderType, Month, (int32_t)Day, 0LL),
          (Day = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_370B208 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL)
    ...
    v21 = &StringLiteral_22170/*"ok"*/;
  }
  else
  {
    v21 = &StringLiteral_22000/*"ng"*/;
  }
