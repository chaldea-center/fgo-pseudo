...
System_String_o *__fastcall TopSignupRequest__getURL(TopSignupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B38B80 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_23607/*"signup/top"*/, v2);
    byte_4B38B80 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62525248(BaseUrl, (System_String_o *)StringLiteral_23607/*"signup/top"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
    ...
    && (SelfUserGame = UserGameMaster__getSelfUserGame(0LL)) != 0LL )
  {
    ...
    if ( !v18
      || (NetworkManager__SetSignup_39331416(v18, name, genderType, Month, (int32_t)Day, 0LL),
          (Day = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37FDC48 *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL)
    ...
    v22 = &StringLiteral_22498/*"ok"*/;
  }
  else
  {
    v22 = &StringLiteral_22325/*"ng"*/;
  }
