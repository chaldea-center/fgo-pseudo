...
System_String_o *__fastcall TopSignupRequest__getURL(TopSignupRequest_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49FDD64 & 1) == 0 )
  {
    ...
    sub_1B640C8(&StringLiteral_23226/*"signup/top"*/, v2);
    byte_49FDD64 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61375396(BaseUrl, (System_String_o *)StringLiteral_23226/*"signup/top"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !v18
    || (NetworkManager__SetSignup_38152572(v18, name, genderType, Month, (int32_t)Day, 0LL),
        (Day = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EC03C *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__)) == 0LL)
