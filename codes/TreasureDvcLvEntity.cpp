        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8130 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_19492/*"fieldHpDamageInvincible"*/);
    byte_4CC8130 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntArrayParam(this, (System_String_o *)StringLiteral_19492/*"fieldHpDamageInvincible"*/, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpDamage(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC812E & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_19490/*"fieldHpDamage"*/);
    byte_4CC812E = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19490/*"fieldHpDamage"*/, 0, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpDamageEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC812F & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_19491/*"fieldHpDamageEffectId"*/);
    byte_4CC812F = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19491/*"fieldHpDamageEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8131 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_19493/*"fieldHpDamageSpecialInvincibleEffectId"*/);
    byte_4CC8131 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19493/*"fieldHpDamageSpecialInvincibleEffectId"*/, -1, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpGuardEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CC8132 & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_19494/*"fieldHpGuardEffectId"*/);
    byte_4CC8132 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19494/*"fieldHpGuardEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC812D & 1) == 0 )
  {
    ...
    sub_1C713B0(&Method_TreasureDvcLvEntity___c__GetScriptIntArrayParam_b__29_0__);
    sub_1C713B0(&TreasureDvcLvEntity___c_TypeInfo);
    byte_4CC812D = 1;
  }
  ...
  if ( !_9__29_0 )
  {
    ...
    _9__29_0 = (System_Converter_object__int__o *)sub_1C715FC(System_Converter_object__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( *p_svals )
  {
    v7 = sub_1C71458(DataVals___TypeInfo, LODWORD(v6->max_length));
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      {
        v13 = *m_Items;
        v14 = (DataVals_o *)sub_1C715FC(DataVals_TypeInfo);
        DataVals___ctor(v14, v13, 0);
        if ( !v9 )
          goto LABEL_29;
        if ( v14 )
        {
          v7 = sub_1C714EC(v14, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
          if ( !v7 )
            goto LABEL_30;
        }
        if ( v10 >= v9[6] )
        ...
        sub_1C71354(v12, (int32_t)v14, v16, v17, v18, v19, v20, v21);
...
LABEL_28:
  ...
  {
    v9 = (unsigned int *)sub_1C71458(DataVals___TypeInfo, 1);
    v22 = (DataVals_o *)sub_1C715FC(DataVals_TypeInfo);
...
LABEL_29:
    ...
    if ( v22 )
    {
      v7 = sub_1C714EC(v22, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
      if ( !v7 )
      {
LABEL_30:
        v30 = sub_1C7162C(v7);
    ...
    if ( !v9[6] )
      goto LABEL_28;
    *((_QWORD *)v9 + 4) = v22;
    sub_1C71354((GrandQuestFolderBoardItem_o *)(v9 + 8), (int32_t)v22, v23, v24, v25, v26, v27, v28);
  }
  return (DataVals_array *)v9;
}
...
System_String_o *TreasureDvcLvEntity__getDetail(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetail_43266192(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetail_43266192(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8264/*"LEVEL_INFO"*/, 0);
    v10 = lv;
...
System_String_o *TreasureDvcLvEntity__getDetalShort(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetalShort_43276092(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetalShort_43276092(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8126 & 1) == 0 )
  {
    ...
    sub_1C713B0(&int___TypeInfo);
    sub_1C713B0(&Method_TreasureDvcLvEntity___c__getValues_b__18_0__);
    sub_1C713B0(&TreasureDvcLvEntity___c_TypeInfo);
  ...
  if ( *p_svals )
  {
    v7 = (System_String_o *)sub_1C71458(int_____TypeInfo, LODWORD(v6->max_length));
    max_length = v6->max_length;
    v10 = (__int64)v7;
    if ( max_length >= 1 )
    {
      ...
      while ( (unsigned int)v11 < max_length )
      {
        ...
        if ( !_9__18_0 )
        {
          ...
          _9__18_0 = (System_Converter_object__int__o *)sub_1C715FC(System_Converter_string__int__TypeInfo);
        ...
        sub_1C71354(p_monitor, (int32_t)v7, v25, v26, v27, v28, v29, v30);
        max_length = v6->max_length;
        ++v11;
...
LABEL_34:
  ...
  {
    v10 = sub_1C71458(int_____TypeInfo, 1);
    v7 = (System_String_o *)sub_1C71458(int___TypeInfo, 5);
    if ( !v10 )
LABEL_33:
      sub_1C71608(v7, v8);
    if ( !*(_DWORD *)(v10 + 24) )
      goto LABEL_34;
    *(_QWORD *)(v10 + 32) = v7;
    sub_1C71354((GrandQuestFolderBoardItem_o *)(v10 + 32), (int32_t)v7, v31, v32, v33, v34, v35, v36);
  }
  return (System_Int32_array_array *)v10;
}
...
void TreasureDvcLvEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C715FC(TreasureDvcLvEntity___c_TypeInfo);
