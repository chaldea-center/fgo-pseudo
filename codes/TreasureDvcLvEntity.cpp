        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2380 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18847/*"fieldHpDamageInvincible"*/);
    byte_42B2380 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntArrayParam(this, (System_String_o *)StringLiteral_18847/*"fieldHpDamageInvincible"*/, v2);
}
...
int32_t __fastcall TreasureDvcLvEntity__GetFieldHpDamage(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B237E & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18845/*"fieldHpDamage"*/);
    byte_42B237E = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_18845/*"fieldHpDamage"*/, 0, v2);
}
...
int32_t __fastcall TreasureDvcLvEntity__GetFieldHpDamageEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B237F & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18846/*"fieldHpDamageEffectId"*/);
    byte_42B237F = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_18846/*"fieldHpDamageEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2381 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18848/*"fieldHpDamageSpecialInvincibleEffectId"*/);
    byte_42B2381 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_18848/*"fieldHpDamageSpecialInvincibleEffectId"*/, -1, v2);
}
...
int32_t __fastcall TreasureDvcLvEntity__GetFieldHpGuardEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42B2382 & 1) == 0 )
  {
    sub_B52984(&StringLiteral_18849/*"fieldHpGuardEffectId"*/);
    byte_42B2382 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_18849/*"fieldHpGuardEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B237D & 1) == 0 )
  {
    ...
    sub_B52984(&Method_TreasureDvcLvEntity___c__GetScriptIntArrayParam_b__29_0__);
    sub_B52984(&TreasureDvcLvEntity___c_TypeInfo);
    byte_42B237D = 1;
  }
  ...
  if ( !_9__29_0 )
  {
    ...
    _9__29_0 = (System_Converter_BattleActionData_HealData__int__o *)sub_B52A54(System_Converter_object__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( *p_svals )
  {
    v7 = sub_B5299C(DataVals___TypeInfo, v6->max_length);
    ...
    if ( (int)v8 >= 1 )
    {
      ...
      {
        v13 = *m_Items;
        v14 = (DataVals_o *)sub_B52A54(DataVals_TypeInfo);
        DataVals___ctor(v14, v13, 0LL);
        if ( !v9 )
          goto LABEL_29;
        if ( v14 )
        {
          v7 = sub_B52A44(v14, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
          if ( !v7 )
            goto LABEL_30;
        }
        if ( v10 >= v9[6] )
        ...
        sub_B52920(v12, (System_Int32_array **)v14, v16, v17, v18, v19, v20, v21);
...
LABEL_28:
  ...
  {
    v9 = (unsigned int *)sub_B5299C(DataVals___TypeInfo, 1LL);
    v22 = (DataVals_o *)sub_B52A54(DataVals_TypeInfo);
...
LABEL_29:
    ...
    if ( v22 )
    {
      v7 = sub_B52A44(v22, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
      if ( !v7 )
      {
LABEL_30:
        v31 = sub_B52A7C(v7);
    ...
    if ( !v9[6] )
      goto LABEL_28;
    *((_QWORD *)v9 + 4) = v22;
    sub_B52920((BattleServantConfConponent_o *)(v9 + 8), (System_Int32_array **)v22, v23, v24, v25, v26, v27, v28);
  }
  return (DataVals_array *)v9;
}
...
System_String_o *__fastcall TreasureDvcLvEntity__getDetail(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetail_29176852(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *__fastcall TreasureDvcLvEntity__getDetail_29176852(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8424/*"LEVEL_INFO"*/, 0LL);
    v10 = lv;
    v6 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v10);
    v7 = (Il2CppObject *)System_String__Format(v5, v6, 0LL);
  }
  Detail = TreasureDvcDetailMaster__getDetail(this->fields.detailId, *(const MethodInfo **)&lv);
  return System_String__Format(Detail, v7, 0LL);
}
...
System_String_o *__fastcall TreasureDvcLvEntity__getDetalShort(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetalShort_29185304(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *__fastcall TreasureDvcLvEntity__getDetalShort_29185304(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
  ...
  return System_String__Format(DetailShort, v7, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2376 & 1) == 0 )
  {
    ...
    sub_B52984(&int___TypeInfo);
    sub_B52984(&Method_TreasureDvcLvEntity___c__getValues_b__18_0__);
    sub_B52984(&TreasureDvcLvEntity___c_TypeInfo);
  ...
  if ( *p_svals )
  {
    v7 = (System_String_o *)sub_B5299C(int_____TypeInfo, v6->max_length);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( (unsigned int)v11 < max_length )
      {
        ...
        if ( !v7 )
          goto LABEL_41;
        v13 = System_String__Replace_44575552(
                v7,
                (System_String_o *)StringLiteral_15976/*"]"*/,
                (System_String_o *)StringLiteral_1/*""*/,
                0LL);
        v7 = (System_String_o *)sub_B5299C(char___TypeInfo, 1LL);
        if ( !v7 )
          goto LABEL_41;
        v8 = v7;
        ...
        if ( !_9__18_0 )
        {
          ...
          _9__18_0 = (System_Converter_BattleActionData_HealData__int__o *)sub_B52A54(System_Converter_string__int__TypeInfo);
          System_Converter_BattleActionData_HealData__int____ctor(
            _9__18_0,
            v19,
        ...
        if ( v7 )
        {
          v7 = (System_String_o *)sub_B52A44(v7, v10->klass->_1.element_class);
          if ( !v7 )
            goto LABEL_43;
        }
        ...
        sub_B52920(p_monitor, v33, v27, v28, v29, v30, v31, v32);
        max_length = v6->max_length;
        ++v11;
...
LABEL_42:
  ...
  {
    v10 = (System_String_o *)sub_B5299C(int_____TypeInfo, 1LL);
    v7 = (System_String_o *)sub_B5299C(int___TypeInfo, 5LL);
    if ( !v10 )
LABEL_41:
      sub_B52A5C(v7, v8);
...
LABEL_43:
    ...
    if ( !LODWORD(v10[1].klass) )
      goto LABEL_42;
    v10[1].monitor = v40;
    sub_B52920((BattleServantConfConponent_o *)&v10[1].monitor, v40, v34, v35, v36, v37, v38, v39);
  }
  return (System_Int32_array_array *)v10;
}
...
void __fastcall TreasureDvcLvEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_B52A54(TreasureDvcLvEntity___c_TypeInfo);
