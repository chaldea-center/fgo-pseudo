        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78403 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_19768/*"fieldHpDamageInvincible"*/);
    byte_4E78403 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntArrayParam(this, (System_String_o *)StringLiteral_19768/*"fieldHpDamageInvincible"*/, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpDamage(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78402 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_19767/*"fieldHpDamage"*/);
    byte_4E78402 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19767/*"fieldHpDamage"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78404 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_19769/*"fieldHpDamageSpecialInvincibleEffectId"*/);
    byte_4E78404 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19769/*"fieldHpDamageSpecialInvincibleEffectId"*/, -1, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpGuardEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E78405 & 1) == 0 )
  {
    sub_1D0F0B4(&StringLiteral_19770/*"fieldHpGuardEffectId"*/);
    byte_4E78405 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19770/*"fieldHpGuardEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E78401 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_TreasureDvcLvEntity___c__GetScriptIntArrayParam_b__27_0__);
    sub_1D0F0B4(&TreasureDvcLvEntity___c_TypeInfo);
    byte_4E78401 = 1;
  }
  ...
  if ( !_9__27_0 )
  {
    ...
    _9__27_0 = (System_Converter_object__int__o *)sub_1D0F300(System_Converter_object__int__TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( *p_svals )
  {
    v7 = sub_1D0F15C(DataVals___TypeInfo, LODWORD(v6->max_length));
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      {
        v13 = *m_Items;
        v14 = (DataVals_o *)sub_1D0F300(DataVals_TypeInfo);
        DataVals___ctor(v14, v13, 0);
        if ( !v9 )
          goto LABEL_29;
        if ( v14 )
        {
          v7 = sub_1D0F1F0(v14, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
          if ( !v7 )
            goto LABEL_30;
        }
        if ( v10 >= v9[6] )
        ...
        sub_1D0F058(v12, (int32_t)v14, v16, v17, v18, v19, v20, v21);
...
LABEL_28:
  ...
  {
    v9 = (unsigned int *)sub_1D0F15C(DataVals___TypeInfo, 1);
    v22 = (DataVals_o *)sub_1D0F300(DataVals_TypeInfo);
...
LABEL_29:
    ...
    if ( v22 )
    {
      v7 = sub_1D0F1F0(v22, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
      if ( !v7 )
      {
LABEL_30:
        v30 = sub_1D0F330(v7);
    ...
    if ( !v9[6] )
      goto LABEL_28;
    *((_QWORD *)v9 + 4) = v22;
    sub_1D0F058((GrandQuestFolderBoardItem_o *)(v9 + 8), (int32_t)v22, v23, v24, v25, v26, v27, v28);
  }
  return (DataVals_array *)v9;
}
...
System_String_o *TreasureDvcLvEntity__getDetail(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetail_44351948(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetail_44351948(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8363/*"LEVEL_INFO"*/, 0);
    v10 = lv;
...
System_String_o *TreasureDvcLvEntity__getDetalShort(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetalShort_44362232(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetalShort_44362232(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
...
void TreasureDvcLvEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1D0F300(TreasureDvcLvEntity___c_TypeInfo);
