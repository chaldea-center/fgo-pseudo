        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1F2 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19248/*"fieldHpDamageInvincible"*/, method);
    byte_4B1D1F2 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntArrayParam(this, (System_String_o *)StringLiteral_19248/*"fieldHpDamageInvincible"*/, v2);
}
...
int32_t __fastcall TreasureDvcLvEntity__GetFieldHpDamage(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1F0 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19246/*"fieldHpDamage"*/, method);
    byte_4B1D1F0 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19246/*"fieldHpDamage"*/, 0, v2);
}
...
int32_t __fastcall TreasureDvcLvEntity__GetFieldHpDamageEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1F1 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19247/*"fieldHpDamageEffectId"*/, method);
    byte_4B1D1F1 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19247/*"fieldHpDamageEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1F3 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19249/*"fieldHpDamageSpecialInvincibleEffectId"*/, method);
    byte_4B1D1F3 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19249/*"fieldHpDamageSpecialInvincibleEffectId"*/, -1, v2);
}
...
int32_t __fastcall TreasureDvcLvEntity__GetFieldHpGuardEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1F4 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_19250/*"fieldHpGuardEffectId"*/, method);
    byte_4B1D1F4 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19250/*"fieldHpGuardEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1EF & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_TreasureDvcLvEntity___c__GetScriptIntArrayParam_b__29_0__, v10);
    sub_1BCAFF8(&TreasureDvcLvEntity___c_TypeInfo, v11);
    byte_4B1D1EF = 1;
  }
  ...
  if ( !_9__29_0 )
  {
    ...
    _9__29_0 = (System_Converter_object__int__o *)sub_1BCB244(System_Converter_object__int__TypeInfo);
    ...
    sub_1BCAF9C((CGThumbnailListItem_o *)&static_fields->__9__29_0, (int32_t)_9__29_0, v20, v21);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1E9 & 1) == 0 )
  {
    sub_1BCAFF8(&DataVals___TypeInfo, *(_QWORD *)&param);
  ...
  if ( *p_svals )
  {
    v9 = sub_1BCB0A0(DataVals___TypeInfo, v8->max_length);
    ...
    if ( (int)v12 >= 1 )
    {
      ...
      while ( v14 < (unsigned int)v12 )
      {
        ...
        if ( v18 )
        {
          v9 = sub_1BCB134(v18, *(_QWORD *)(*(_QWORD *)v13 + 64LL));
          if ( !v9 )
            goto LABEL_30;
        }
        if ( v14 >= v13[6] )
        ...
        sub_1BCAF9C(v16, (int32_t)v18, v11, v19);
...
LABEL_28:
  ...
  {
    v13 = (unsigned int *)sub_1BCB0A0(DataVals___TypeInfo, 1LL);
    v20 = (DataVals_o *)sub_1BCB244(DataVals_TypeInfo);
...
LABEL_29:
    ...
    if ( v20 )
    {
      v9 = sub_1BCB134(v20, *(_QWORD *)(*(_QWORD *)v13 + 64LL));
      if ( !v9 )
      {
LABEL_30:
        v23 = sub_1BCB278(v9);
    ...
    if ( !v13[6] )
      goto LABEL_28;
    *((_QWORD *)v13 + 4) = v20;
    sub_1BCAF9C((CGThumbnailListItem_o *)(v13 + 8), (int32_t)v20, v11, v21);
  }
  return (DataVals_array *)v13;
}
...
System_String_o *__fastcall TreasureDvcLvEntity__getDetail(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetail_42118980(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *__fastcall TreasureDvcLvEntity__getDetail_42118980(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
...
System_String_o *__fastcall TreasureDvcLvEntity__getDetalShort(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetalShort_42128524(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *__fastcall TreasureDvcLvEntity__getDetalShort_42128524(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1E8 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_System_Array_ConvertAll_string__int___, *(_QWORD *)&param);
    sub_1BCAFF8(&System_Converter_string__int__TypeInfo, v5);
    sub_1BCAFF8(&int_____TypeInfo, v6);
    sub_1BCAFF8(&int___TypeInfo, v7);
    sub_1BCAFF8(&Method_TreasureDvcLvEntity___c__getValues_b__18_0__, v8);
    sub_1BCAFF8(&TreasureDvcLvEntity___c_TypeInfo, v9);
  ...
  if ( *p_svals )
  {
    v15 = (System_String_o *)sub_1BCB0A0(int_____TypeInfo, v14->max_length);
    ...
    if ( max_length >= 1 )
    {
      ...
      while ( (unsigned int)v20 < max_length )
      {
        ...
        if ( !v15 )
          goto LABEL_33;
        v15 = System_String__Replace_62496972(
                v15,
        ...
        if ( !_9__18_0 )
        {
          ...
          _9__18_0 = (System_Converter_object__int__o *)sub_1BCB244(System_Converter_string__int__TypeInfo);
        ...
        sub_1BCAF9C(p_monitor, (int32_t)v15, v17, v30);
        max_length = v14->max_length;
        ++v20;
...
LABEL_34:
  ...
  {
    v19 = sub_1BCB0A0(int_____TypeInfo, 1LL);
    v15 = (System_String_o *)sub_1BCB0A0(int___TypeInfo, 5LL);
    if ( !v19 )
LABEL_33:
      sub_1BCB254(v15, v16);
    if ( !*(_DWORD *)(v19 + 24) )
      goto LABEL_34;
    *(_QWORD *)(v19 + 32) = v15;
    sub_1BCAF9C((CGThumbnailListItem_o *)(v19 + 32), (int32_t)v15, v17, v31);
  }
  return (System_Int32_array_array *)v19;
}
...
void __fastcall TreasureDvcLvEntity___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B1D1F6 & 1) == 0 )
  {
    sub_1BCAFF8(&TreasureDvcLvEntity___c_TypeInfo, v1);
    byte_4B1D1F6 = 1;
  }
  v2 = (Il2CppObject *)sub_1BCB244(TreasureDvcLvEntity___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  TreasureDvcLvEntity___c_TypeInfo->static_fields->__9 = (struct TreasureDvcLvEntity___c_o *)v2;
  sub_1BCAF9C((CGThumbnailListItem_o *)TreasureDvcLvEntity___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
