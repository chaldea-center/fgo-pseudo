        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C27FE7 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_19406/*"fieldHpDamageInvincible"*/);
    byte_4C27FE7 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntArrayParam(this, (System_String_o *)StringLiteral_19406/*"fieldHpDamageInvincible"*/, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpDamage(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C27FE5 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_19404/*"fieldHpDamage"*/);
    byte_4C27FE5 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19404/*"fieldHpDamage"*/, 0, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpDamageEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C27FE6 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_19405/*"fieldHpDamageEffectId"*/);
    byte_4C27FE6 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19405/*"fieldHpDamageEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C27FE8 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_19407/*"fieldHpDamageSpecialInvincibleEffectId"*/);
    byte_4C27FE8 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19407/*"fieldHpDamageSpecialInvincibleEffectId"*/, -1, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpGuardEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C27FE9 & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_19408/*"fieldHpGuardEffectId"*/);
    byte_4C27FE9 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_19408/*"fieldHpGuardEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C27FE4 & 1) == 0 )
  {
    ...
    sub_1C2D490(&Method_TreasureDvcLvEntity___c__GetScriptIntArrayParam_b__29_0__);
    sub_1C2D490(&TreasureDvcLvEntity___c_TypeInfo);
    byte_4C27FE4 = 1;
  }
  ...
  if ( !_9__29_0 )
  {
    ...
    _9__29_0 = (System_Converter_object__int__o *)sub_1C2D6DC(System_Converter_object__int__TypeInfo);
    ...
    sub_1C2D434((CGThumbnailListItem_o *)&static_fields->__9__29_0, (int32_t)_9__29_0, v13, v14);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( *p_svals )
  {
    v7 = sub_1C2D538(DataVals___TypeInfo, LODWORD(v6->max_length));
    ...
    if ( (int)max_length >= 1 )
    {
      v12 = 0;
      m_Items = v6->m_Items;
      v14 = (CGThumbnailListItem_o *)(v7 + 32);
      while ( v12 < (unsigned int)max_length )
      {
        v15 = *m_Items;
        v16 = (DataVals_o *)sub_1C2D6DC(DataVals_TypeInfo);
        DataVals___ctor(v16, v15, 0);
        if ( !v11 )
          goto LABEL_29;
        if ( v16 )
        {
          v7 = sub_1C2D5CC(v16, *(_QWORD *)(*(_QWORD *)v11 + 64LL));
          if ( !v7 )
            goto LABEL_30;
        }
        if ( v12 >= v11[6] )
          break;
        v14->klass = (CGThumbnailListItem_c *)v16;
        sub_1C2D434(v14, (int32_t)v16, v9, v17);
        LODWORD(max_length) = v6->max_length;
        ++v12;
        ++m_Items;
        v14 = (CGThumbnailListItem_o *)((char *)v14 + 8);
...
LABEL_28:
  ...
  {
    v11 = (unsigned int *)sub_1C2D538(DataVals___TypeInfo, 1);
    v18 = (DataVals_o *)sub_1C2D6DC(DataVals_TypeInfo);
...
LABEL_29:
    ...
    if ( v18 )
    {
      v7 = sub_1C2D5CC(v18, *(_QWORD *)(*(_QWORD *)v11 + 64LL));
      if ( !v7 )
      {
LABEL_30:
        v21 = sub_1C2D710(v7);
    ...
    if ( !v11[6] )
      goto LABEL_28;
    *((_QWORD *)v11 + 4) = v18;
    sub_1C2D434((CGThumbnailListItem_o *)(v11 + 8), (int32_t)v18, v9, v19);
  }
  return (DataVals_array *)v11;
}
...
System_String_o *TreasureDvcLvEntity__getDetail(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetail_42745352(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetail_42745352(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_8256/*"LEVEL_INFO"*/, 0);
    v13 = lv;
    v9 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &v13, v6, v7, v8);
    v10 = (Il2CppObject *)System_String__Format(v5, v9, 0);
  }
...
System_String_o *TreasureDvcLvEntity__getDetalShort(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetalShort_42755252(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetalShort_42755252(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
  ...
  return System_String__Format(DetailShort, v10, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C27FDD & 1) == 0 )
  {
    ...
    sub_1C2D490(&int___TypeInfo);
    sub_1C2D490(&Method_TreasureDvcLvEntity___c__getValues_b__18_0__);
    sub_1C2D490(&TreasureDvcLvEntity___c_TypeInfo);
  ...
  if ( *p_svals )
  {
    v7 = (System_String_o *)sub_1C2D538(int_____TypeInfo, LODWORD(v6->max_length));
    max_length = v6->max_length;
    v11 = (__int64)v7;
    if ( max_length >= 1 )
    {
      ...
      while ( (unsigned int)v12 < max_length )
      {
        ...
        if ( !v7 )
          goto LABEL_33;
        v14 = System_String__Split(v7, 0x2Cu, 0, 0);
        v15 = TreasureDvcLvEntity___c_TypeInfo;
        v16 = (System_Object_array *)v14;
        if ( !TreasureDvcLvEntity___c_TypeInfo->_2.cctor_finished )
        {
          j_il2cpp_runtime_class_init_0(TreasureDvcLvEntity___c_TypeInfo);
          v15 = TreasureDvcLvEntity___c_TypeInfo;
        }
        _9__18_0 = (System_Converter_object__int__o *)v15->static_fields->__9__18_0;
        if ( !_9__18_0 )
        {
          ...
          _9__18_0 = (System_Converter_object__int__o *)sub_1C2D6DC(System_Converter_string__int__TypeInfo);
          System_Converter_object__int____ctor(_9__18_0, v18, Method_TreasureDvcLvEntity___c__getValues_b__18_0__, 0);
          static_fields = TreasureDvcLvEntity___c_TypeInfo->static_fields;
        ...
        sub_1C2D434(p_monitor, (int32_t)v7, v9, v22);
        max_length = v6->max_length;
        ++v12;
        p_monitor = (CGThumbnailListItem_o *)((char *)p_monitor + 8);
        if ( (int)v12 >= max_length )
          return (System_Int32_array_array *)v11;
      }
LABEL_34:
      sub_1C2D6F4(v7, v8, v9);
    }
  ...
  else
  {
    ...
    v7 = (System_String_o *)sub_1C2D538(int___TypeInfo, 5);
    if ( !v11 )
LABEL_33:
      sub_1C2D6EC(v7, v8);
    if ( !*(_DWORD *)(v11 + 24) )
      goto LABEL_34;
    *(_QWORD *)(v11 + 32) = v7;
    sub_1C2D434((CGThumbnailListItem_o *)(v11 + 32), (int32_t)v7, v9, v23);
  }
  return (System_Int32_array_array *)v11;
}
...
void TreasureDvcLvEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_1C2D6DC(TreasureDvcLvEntity___c_TypeInfo);
  System_Object___ctor(v1, 0);
  TreasureDvcLvEntity___c_TypeInfo->static_fields->__9 = (struct TreasureDvcLvEntity___c_o *)v1;
  sub_1C2D434((CGThumbnailListItem_o *)TreasureDvcLvEntity___c_TypeInfo->static_fields, (int32_t)v1, v2, v3);
}
