        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59715F0 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_20328/*"fieldHpDamageInvincible"*/);
    byte_59715F0 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntArrayParam(this, (System_String_o *)StringLiteral_20328/*"fieldHpDamageInvincible"*/, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpDamage(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59715EF & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_20327/*"fieldHpDamage"*/);
    byte_59715EF = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_20327/*"fieldHpDamage"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59715F1 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_20329/*"fieldHpDamageSpecialInvincibleEffectId"*/);
    byte_59715F1 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_20329/*"fieldHpDamageSpecialInvincibleEffectId"*/, -1, v2);
}
...
int32_t TreasureDvcLvEntity__GetFieldHpGuardEffectId(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_59715F2 & 1) == 0 )
  {
    sub_2213A60(&StringLiteral_20330/*"fieldHpGuardEffectId"*/);
    byte_59715F2 = 1;
  }
  return TreasureDvcLvEntity__GetScriptIntParam(this, (System_String_o *)StringLiteral_20330/*"fieldHpGuardEffectId"*/, -1, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_59715EE & 1) == 0 )
  {
    ...
    sub_2213A60(&Method_TreasureDvcLvEntity___c__GetScriptIntArrayParam_b__27_0__);
    sub_2213A60(&TreasureDvcLvEntity___c_TypeInfo);
    byte_59715EE = 1;
  }
  ...
  if ( !_9__27_0 )
  {
    ...
    _9__27_0 = (System_Converter_object__int__o *)sub_2213CCC(System_Converter_object__int__TypeInfo);
    ...
    sub_2213A04((MissionNaviTransitionBoardItem_o *)&v14->__9__27_0, (int32_t)_9__27_0, v15, v16, v17, v18, v19, v20);
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( *p_svals )
  {
    v7 = sub_2213B20(DataVals___TypeInfo, LODWORD(v6->max_length));
    ...
    if ( (int)max_length >= 1 )
    {
      ...
      while ( v10 < (unsigned int)max_length )
      {
        ...
        if ( v13 )
        {
          v7 = sub_2213BB4(v13, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
          if ( !v7 )
            goto LABEL_30;
        }
        if ( v10 >= v9[6] )
          break;
        *(_QWORD *)&v9[v11] = v13;
        sub_2213A04((MissionNaviTransitionBoardItem_o *)&v9[v11], (int32_t)v13, v15, v16, v17, v18, v19, v20);
...
LABEL_28:
  ...
  {
    v9 = (unsigned int *)sub_2213B20(DataVals___TypeInfo, 1);
    v22 = (DataVals_o *)sub_2213CCC(DataVals_TypeInfo);
...
LABEL_29:
    ...
    if ( v22 )
    {
      v7 = sub_2213BB4(v22, *(_QWORD *)(*(_QWORD *)v9 + 64LL));
      if ( !v7 )
      {
LABEL_30:
        v30 = sub_2213D00(v7, v21);
        sub_2213BA0(v30, 0);
      }
    }
    if ( !v9[6] )
      goto LABEL_28;
    *((_QWORD *)v9 + 4) = v22;
    sub_2213A04((MissionNaviTransitionBoardItem_o *)(v9 + 8), (int32_t)v22, v23, v24, v25, v26, v27, v28);
  }
  return (DataVals_array *)v9;
}
...
System_String_o *TreasureDvcLvEntity__getDetail(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetail_50000128(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetail_50000128(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
...
System_String_o *TreasureDvcLvEntity__getDetalShort(TreasureDvcLvEntity_o *this, const MethodInfo *method)
{
  ...
  return TreasureDvcLvEntity__getDetalShort_50010268(this, this->fields.lv, v2);
}


// local variable allocation has failed, the output may be wrong!
System_String_o *TreasureDvcLvEntity__getDetalShort_50010268(
        TreasureDvcLvEntity_o *this,
        int32_t lv,
        const MethodInfo *method)
{
...
void TreasureDvcLvEntity___c___cctor(const MethodInfo *method)
{
  ...
  v1 = (Il2CppObject *)sub_2213CCC(TreasureDvcLvEntity___c_TypeInfo);
