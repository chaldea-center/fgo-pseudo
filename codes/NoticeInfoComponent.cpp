void __fastcall NoticeInfoComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA9 & 1) == 0 )
  {
    sub_1B64870(&NoticeInfoComponent_TypeInfo, v1);
    byte_49F9FA9 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA3 & 1) == 0 )
  {
    sub_1B64870(&AccountDeleteConfirmDialog_ClickDelegate_TypeInfo, method);
    sub_1B64870(&Method_NoticeInfoComponent__OpenAccountDeleteConfirmDialog_b__18_0__, v3);
  ...
  v6 = (AccountDeleteConfirmDialog_ClickDelegate_o *)sub_1B64ABC(AccountDeleteConfirmDialog_ClickDelegate_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA7 & 1) == 0 )
  {
    sub_1B64870(&System_Action_TypeInfo, password);
    sub_1B64870(&Method_NoticeInfoComponent__OpenAccountDeletePasswordDialog_b__22_0__, v5);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA4 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_NoticeInfoComponent__OpenAccountDeleteReConfirmDialog_b__19_0__, v4);
    sub_1B64870(&NoticeInfoComponent_TypeInfo, v5);
    sub_1B64870(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, v6);
    sub_1B64870(&StringLiteral_1990/*"ACCOUNT_DELETE_RECONFIRM_DECIDE"*/, v7);
    sub_1B64870(&StringLiteral_1989/*"ACCOUNT_DELETE_RECONFIRM_CANCEL"*/, v8);
    sub_1B64870(&StringLiteral_1991/*"ACCOUNT_DELETE_RECONFIRM_MESSAGE"*/, v9);
  ...
  if ( !Instance )
    sub_1B64ACC(v17, v16);
  CommonUI__OpenConfirmDialog_30347460(
    (CommonUI_o *)Instance,
...
void __fastcall NoticeInfoComponent__SetReboot(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA8 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_NoticeInfoComponent___c__SetReboot_b__23_0__, v4);
    sub_1B64870(&NoticeInfoComponent___c_TypeInfo, v5);
    byte_49F9FA8 = 1;
  }
  Instance = SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  ...
  if ( !_9__23_0 )
  {
    ...
    v10 = (NoticeInfoComponent___c_c *)sub_1B64814(&static_fields->__9__23_0);
  }
  if ( !v9 )
    sub_1B64ACC(v10, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9F9C & 1) == 0 )
  {
    sub_1B64870(&NoticeInfoComponent__WaitForSE_d__11_TypeInfo, method);
    byte_49F9F9C = 1;
  }
  v3 = sub_1B64ABC(NoticeInfoComponent__WaitForSE_d__11_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FAA & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_3535/*"CLICK_OK"*/, v5);
    sub_1B64870(&StringLiteral_3511/*"CLICK_CANCLE"*/, v6);
    byte_49F9FAA = 1;
  }
  ...
  v9 = &StringLiteral_3535/*"CLICK_OK"*/;
  if ( !isDecide )
    v9 = &StringLiteral_3511/*"CLICK_CANCLE"*/;
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&Method_SingletonMonoBehaviour_CommonUI__get_Instance__, isDecide);
    sub_1B64870(&StringLiteral_3511/*"CLICK_CANCLE"*/, v5);
    byte_49F9FAB = 1;
  }
  Instance = (CommonUI_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_CommonUI__get_Instance__);
  if ( !Instance )
...
LABEL_8:
  ...
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)Instance, (System_String_o *)StringLiteral_3511/*"CLICK_CANCLE"*/, 0LL);
}
...
void __fastcall NoticeInfoComponent__onEndWebView(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA1 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_3582/*"CLOSE_WEBVIEW"*/, method);
    byte_49F9FA1 = 1;
  }
  myRoomFsm = this->fields.myRoomFsm;
  if ( !myRoomFsm )
    sub_1B64ACC(0LL, method);
  PlayMakerFSM__SendEvent(myRoomFsm, (System_String_o *)StringLiteral_3582/*"CLOSE_WEBVIEW"*/, 0LL);
}
...
void __fastcall NoticeInfoComponent__openWebView(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B64870(&System_Action_TypeInfo, method);
    sub_1B64870(&Method_NoticeInfoComponent_onEndWebView__, v3);
...
void __fastcall NoticeInfoComponent__requestUserDelete(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA5 & 1) == 0 )
  {
    sub_1B64870(&Method_NetworkManager_getRequest_UserDeleteRequest___, method);
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&Method_NoticeInfoComponent_userDeleteCallback__, v4);
  ...
  Request_object = NetworkManager__getRequest_object_(
                     v6,
                     (const MethodInfo_2EBCCAC *)Method_NetworkManager_getRequest_UserDeleteRequest___);
  if ( !Request_object )
    sub_1B64ACC(0LL, v8);
...
void __fastcall NoticeInfoComponent__setCreditWebViewInfo(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9F9E & 1) == 0 )
  {
    ...
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&StringLiteral_15481/*"WEB_VIEW_TITLE_CREDIT"*/, v4);
    byte_49F9F9E = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  this->fields.title = LocalizationManager__Get((System_String_o *)StringLiteral_15481/*"WEB_VIEW_TITLE_CREDIT"*/, 0LL);
  sub_1B64814(&this->fields.title);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  this->fields.path = NetworkManager__getWebViewAddress_38178928(5, 0LL);
  sub_1B64814(&this->fields.path);
}
...
void __fastcall NoticeInfoComponent__setHelpWebViewInfo(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9F9A & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, method);
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&StringLiteral_15482/*"WEB_VIEW_TITLE_HELP"*/, v4);
    byte_49F9F9A = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  this->fields.path = NetworkManager__getWebViewAddress_38178928(2, 0LL);
  sub_1B64814(&this->fields.path);
}
...
void __fastcall NoticeInfoComponent__setInfomationWebViewInfo(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9F99 & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, method);
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&StringLiteral_15483/*"WEB_VIEW_TITLE_INFOMATION"*/, v4);
    byte_49F9F99 = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  this->fields.path = NetworkManager__getWebViewAddress_38178928(0, 0LL);
  sub_1B64814(&this->fields.path);
}
...
void __fastcall NoticeInfoComponent__setInquiryWebViewInfo(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9F9B & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, method);
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&StringLiteral_15480/*"WEB_VIEW_TITLE_CONTACT_US"*/, v4);
    byte_49F9F9B = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  this->fields.path = NetworkManager__getWebViewAddress_38178928(3, 0LL);
  sub_1B64814(&this->fields.path);
...
void __fastcall NoticeInfoComponent__setRightWebViewInfo(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9F9F & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, method);
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&StringLiteral_15484/*"WEB_VIEW_TITLE_RIGHT_NOTATION"*/, v4);
    byte_49F9F9F = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  this->fields.path = NetworkManager__getWebViewAddress_38178928(6, 0LL);
  sub_1B64814(&this->fields.path);
}
...
void __fastcall NoticeInfoComponent__setRulesWebViewInfo(NoticeInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49F9F9D & 1) == 0 )
  {
    sub_1B64870(&LocalizationManager_TypeInfo, method);
    sub_1B64870(&NetworkManager_TypeInfo, v3);
    sub_1B64870(&StringLiteral_15488/*"WEB_VIEW_TITLE_TERMS_OF_USE"*/, v4);
    byte_49F9F9D = 1;
  }
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  this->fields.path = NetworkManager__getWebViewAddress_38178928(4, 0LL);
  sub_1B64814(&this->fields.path);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FA6 & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_UserDeleteReservationMaster___, result);
    sub_1B64870(&NetworkManager_TypeInfo, v5);
    sub_1B64870(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    sub_1B64870(&UserDeleteReservationEntity_TypeInfo, v7);
    sub_1B64870(&StringLiteral_21971/*"ng"*/, v8);
    this = (NoticeInfoComponent_o *)sub_1B64870(&StringLiteral_3511/*"CLICK_CANCLE"*/, v9);
    byte_49F9FA6 = 1;
  }
  if ( !result )
    goto LABEL_15;
  ...
  this = (NoticeInfoComponent_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36EE318 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_15;
  MasterData_object = DataManager__GetMasterData_object_(
                        (DataManager_o *)this,
                        (const MethodInfo_2E3B6C8 *)Method_DataManager_GetMasterData_UserDeleteReservationMaster___);
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
...
LABEL_13:
  ...
  if ( !this )
    goto LABEL_15;
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)this, (System_String_o *)StringLiteral_3511/*"CLICK_CANCLE"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49F9FAF & 1) == 0 )
  {
    ...
    this = (NoticeInfoComponent__WaitForSE_d__11_o *)sub_1B64870(&StringLiteral_9588/*"OPEN_BROWSER"*/, v4);
    byte_49F9FAF = 1;
  }
  ...
  if ( _1__state >= 2 )
  {
    if ( _1__state == 2 )
    {
      ...
      PlayMakerFSM__SendEvent((PlayMakerFSM_o *)this, (System_String_o *)StringLiteral_9588/*"OPEN_BROWSER"*/, 0LL);
    }
    return 0;
  }
  else
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64884(&Method_NoticeInfoComponent__WaitForSE_d__11_System_Collections_IEnumerator_Reset__);
  sub_1B64998(v3, v4);
}
...
void __fastcall NoticeInfoComponent___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49F9FAD & 1) == 0 )
  {
    sub_1B64870(&NoticeInfoComponent___c_TypeInfo, v1);
    byte_49F9FAD = 1;
  }
  v2 = (Il2CppObject *)sub_1B64ABC(NoticeInfoComponent___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  NoticeInfoComponent___c_TypeInfo->static_fields->__9 = (struct NoticeInfoComponent___c_o *)v2;
  sub_1B64814(NoticeInfoComponent___c_TypeInfo->static_fields);
}
