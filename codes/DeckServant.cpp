...
void __fastcall DeckServant___ctor_38617348(
        DeckServant_o *this,
        int32_t sum,
        int64_t userEquipId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A087ED & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Array_Empty_DeckWaveServantData___, *(_QWORD *)&sum);
    sub_1B686D4(&DeckServantData___TypeInfo, v7);
    sub_1B686D4(&DeckServantData_TypeInfo, v8);
    byte_4A087ED = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v9 = (struct DeckServantData_array *)sub_1B6877C(DeckServantData___TypeInfo, (unsigned int)sum);
  this->fields.svts = v9;
  p_fields = &this->fields;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v9, v11, v12);
  v15 = Method_System_Array_Empty_DeckWaveServantData___;
  v16 = *((_QWORD *)Method_System_Array_Empty_DeckWaveServantData___ + 7);
  if ( !v16 )
  {
    sub_1BBA60C(Method_System_Array_Empty_DeckWaveServantData___);
    v16 = v15[7];
  }
  v17 = *(_QWORD *)(v16 + 16);
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.waveSvts, (int32_t)v20, v13, v14);
  if ( sum >= 1 )
  {
    svts = p_fields->svts;
    v22 = 0;
    do
    {
      v23 = (DeckServantData_o *)sub_1B68920(DeckServantData_TypeInfo);
      DeckServantData___ctor(v23, v24);
      if ( !svts )
        goto LABEL_22;
      if ( v23 )
      {
        v25 = sub_1B68810(v23, svts->obj.klass->_1.element_class);
        if ( !v25 )
        {
          v31 = sub_1B68954(0LL);
          sub_1B687FC(v31, 0LL);
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)(v29 + 4), (int32_t)v23, v27, v28);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        goto LABEL_22;
      if ( v22 >= svts->max_length )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckServant___ctor_38618004(
        DeckServant_o *this,
        int32_t waveNum,
        int32_t memberNum,
        int64_t userEquipId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A087EE & 1) == 0 )
  {
    sub_1B686D4(&DeckServantData___TypeInfo, *(_QWORD *)&waveNum);
    sub_1B686D4(&DeckServantData_TypeInfo, v8);
    sub_1B686D4(&DeckWaveServantData___TypeInfo, v9);
    sub_1B686D4(&DeckWaveServantData_TypeInfo, v10);
    byte_4A087EE = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v11 = (struct DeckServantData_array *)sub_1B6877C(DeckServantData___TypeInfo, (unsigned int)(memberNum * waveNum));
  this->fields.svts = v11;
  p_fields = &this->fields;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v11, v13, v14);
  v15 = (struct DeckWaveServantData_array *)sub_1B6877C(DeckWaveServantData___TypeInfo, (unsigned int)waveNum);
  this->fields.waveSvts = v15;
  p_waveSvts = &this->fields.waveSvts;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.waveSvts, (int32_t)v15, v17, v18);
  if ( memberNum * waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v21 = (DeckServantData_o *)sub_1B68920(DeckServantData_TypeInfo);
      DeckServantData___ctor(v21, v22);
      if ( !svts )
        break;
      if ( v21 )
      {
        v23 = sub_1B68810(v21, svts->obj.klass->_1.element_class);
        if ( !v23 )
        {
LABEL_33:
          v44 = sub_1B68954(v23);
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)(v27 + 4), (int32_t)v21, v25, v26);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        break;
      if ( v20 >= svts->max_length )
...
LABEL_15:
  if ( waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v34 = (DeckWaveServantData_o *)sub_1B68920(DeckWaveServantData_TypeInfo);
      DeckWaveServantData___ctor(v34, v35);
      if ( !v31 )
        goto LABEL_32;
      if ( v34 )
      {
        v23 = sub_1B68810(v34, v31->obj.klass->_1.element_class);
        if ( !v23 )
          goto LABEL_33;
      }
      ...
      sub_1B68678((ServantStatusBattleListViewItem_o *)(v38 + 4), (int32_t)v34, v36, v37);
      v31 = *p_waveSvts;
      if ( !*p_waveSvts )
        goto LABEL_32;
      if ( v32 >= v31->max_length )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckServant___ctor_38618812(
        DeckServant_o *this,
        int32_t sum,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A087EF & 1) == 0 )
  {
    sub_1B686D4(&DeckServantData___TypeInfo, *(_QWORD *)&sum);
    sub_1B686D4(&DeckServantData_TypeInfo, v7);
    byte_4A087EF = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v8 = (struct DeckServantData_array *)sub_1B6877C(DeckServantData___TypeInfo, (unsigned int)sum);
  this->fields.svts = v8;
  p_fields = &this->fields;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields, (int32_t)v8, v10, v11);
  if ( !deckInfo )
LABEL_24:
    sub_1B68930(v12, v13);
  if ( sum >= 1 )
  {
    ...
    do
    {
      ...
      if ( svts && (max_length = svts->max_length, (__int64)v16 < (int)max_length) )
      {
        ...
        if ( v21 )
        {
          v12 = sub_1B68810(v21, *(_QWORD *)(*(_QWORD *)v20 + 64LL));
          if ( !v12 )
            goto LABEL_26;
        }
        if ( v16 >= v20[6] )
        ...
        v22 = &v20[2 * v16];
        *((_QWORD *)v22 + 4) = v21;
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v22 + 8), (int32_t)v21, v14, v15);
        ++v16;
      }
      else
      {
        v23 = (unsigned int *)p_fields->svts;
        v24 = (DeckServantData_o *)sub_1B68920(DeckServantData_TypeInfo);
        DeckServantData___ctor(v24, v25);
        if ( !v23 )
          goto LABEL_24;
        if ( v24 )
        {
          v12 = sub_1B68810(v24, *(_QWORD *)(*(_QWORD *)v23 + 64LL));
          if ( !v12 )
          {
LABEL_26:
            v31 = sub_1B68954(v12);
        ...
        v28 = &v23[2 * v16];
        *((_QWORD *)v28 + 4) = v24;
        sub_1B68678((ServantStatusBattleListViewItem_o *)(v28 + 8), (int32_t)v24, v26, v27);
        v29 = p_fields->svts;
        if ( !p_fields->svts )
          goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A087F5 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_UserServantMaster___, svtCollectList);
    sub_1B686D4(&long___TypeInfo, v7);
    ...
    sub_1B686D4(&Method_System_Collections_Generic_List_long__get_Item__, v10);
...
System_Int64_array *__fastcall DeckServant__GetEquipList(DeckServant_o *this, int32_t menber, const MethodInfo *method)
{
  ...
  if ( (byte_4A087F1 & 1) == 0 )
  {
    sub_1B686D4(&BalanceConfig_TypeInfo, *(_QWORD *)&menber);
  ...
  Instance = (System_Int64_array *)sub_1B6877C(long___TypeInfo, (unsigned int)v8->static_fields->SvtEquipMax);
  svts = this->fields.svts;
  if ( !svts )
    goto LABEL_36;
  max_length = svts->max_length;
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      Instance = (System_Int64_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( Instance )
      {
        MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)Instance,
                              (const MethodInfo_2E49D50 *)Method_DataManager_GetMasterData_UserServantMaster___);
        Instance = (System_Int64_array *)sub_1B6877C(long___TypeInfo, 1LL);
        if ( Instance )
        {
          v10 = Instance;
...
System_Int64_array *__fastcall DeckServant__GetEquipList_38620292(
        DeckServant_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A087F2 & 1) == 0 )
  {
    sub_1B686D4(&BalanceConfig_TypeInfo, userSvtId);
    sub_1B686D4(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v7);
    sub_1B686D4(&Method_DataManager_GetMaster_UserServantMaster___, v8);
  ...
  v14 = (System_Int64_array *)sub_1B6877C(long___TypeInfo, (unsigned int)v12->static_fields->SvtEquipMax);
  isEntityExistsFromId = (System_Int64_array *)sub_1B6877C(long___TypeInfo, 1LL);
  if ( !isEntityExistsFromId )
    goto LABEL_40;
  v16 = isEntityExistsFromId;
  if ( !isEntityExistsFromId->max_length )
LABEL_41:
    sub_1B68938(isEntityExistsFromId, v16);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  isEntityExistsFromId = (System_Int64_array *)DataManager__GetMaster_object_((const MethodInfo_2E49CFC *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  svts = this->fields.svts;
  if ( !svts )
LABEL_40:
    sub_1B68930(isEntityExistsFromId, v16);
  max_length = svts->max_length;
  if ( max_length >= 1 )
  {
    v20 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A087F0 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_UserServantMaster___, *(_QWORD *)&menber);
    sub_1B686D4(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__, v5);
    this = (DeckServant_o *)sub_1B686D4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4A087F0 = 1;
  }
  entity = 0LL;
  svts = v4->fields.svts;
  if ( !svts )
LABEL_16:
    sub_1B68930(this, *(_QWORD *)&menber);
  v8 = 0LL;
  v9 = menber + 1;
  while ( 1 )
  {
    ...
    if ( (unsigned int)v8 >= max_length )
      sub_1B68938(this, *(_QWORD *)&menber);
    v11 = svts->m_Items[v8];
    if ( !v11 )
      goto LABEL_16;
...
LABEL_15:
  ...
  this = (DeckServant_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_16;
...
bool __fastcall DeckServant__IsEquip(DeckServant_o *this, int64_t userSvtId, const MethodInfo *method)
{
  ...
  while ( 1 )
  {
    ...
    {
      Instance = (Il2CppObject *)sub_1B6877C(long___TypeInfo, 1LL);
      if ( !Instance )
        goto LABEL_32;
      v8 = Instance;
...
bool __fastcall DeckServant__IsEquip_38621340(
        DeckServant_o *this,
        int64_t userSvtId,
