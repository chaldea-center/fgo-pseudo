...
void __fastcall DeckServant___ctor_40697064(
        DeckServant_o *this,
        int32_t sum,
        int64_t userEquipId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B445C9 & 1) == 0 )
  {
    sub_1BDB878(&Method_System_Array_Empty_DeckWaveServantData___, *(_QWORD *)&sum);
    sub_1BDB878(&DeckServantData___TypeInfo, v7);
    sub_1BDB878(&DeckServantData_TypeInfo, v8);
    byte_4B445C9 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v9 = (struct DeckServantData_array *)sub_1BDB920(DeckServantData___TypeInfo, (unsigned int)sum);
  this->fields.svts = v9;
  p_fields = &this->fields;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)v9, v11, v12);
  v16 = Method_System_Array_Empty_DeckWaveServantData___;
  v17 = *((_QWORD *)Method_System_Array_Empty_DeckWaveServantData___ + 7);
  if ( !v17 )
  {
    sub_1C2BF64(Method_System_Array_Empty_DeckWaveServantData___);
    v17 = v16[7];
  }
  v18 = *(_QWORD *)(v17 + 16);
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.waveSvts, (int32_t)v21, v13, v14);
  if ( sum >= 1 )
  {
    svts = p_fields->svts;
    v23 = 0;
    do
    {
      v24 = (DeckServantData_o *)sub_1BDBAC4(DeckServantData_TypeInfo);
      DeckServantData___ctor(v24, v25);
      if ( !svts )
        goto LABEL_22;
      if ( v24 )
      {
        v26 = sub_1BDB9B4(v24, svts->obj.klass->_1.element_class);
        if ( !v26 )
        {
          v32 = sub_1BDBAF8(0LL);
          sub_1BDB9A0(v32, 0LL);
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)(v30 + 4), (int32_t)v24, v28, v29);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        goto LABEL_22;
      if ( v23 >= svts->max_length )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckServant___ctor_40697720(
        DeckServant_o *this,
        int32_t waveNum,
        int32_t memberNum,
        int64_t userEquipId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B445CA & 1) == 0 )
  {
    sub_1BDB878(&DeckServantData___TypeInfo, *(_QWORD *)&waveNum);
    sub_1BDB878(&DeckServantData_TypeInfo, v8);
    sub_1BDB878(&DeckWaveServantData___TypeInfo, v9);
    sub_1BDB878(&DeckWaveServantData_TypeInfo, v10);
    byte_4B445CA = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v11 = (struct DeckServantData_array *)sub_1BDB920(DeckServantData___TypeInfo, (unsigned int)(memberNum * waveNum));
  this->fields.svts = v11;
  p_fields = &this->fields;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)v11, v13, v14);
  v15 = (struct DeckWaveServantData_array *)sub_1BDB920(DeckWaveServantData___TypeInfo, (unsigned int)waveNum);
  this->fields.waveSvts = v15;
  p_waveSvts = &this->fields.waveSvts;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.waveSvts, (int32_t)v15, v17, v18);
  if ( memberNum * waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v21 = (DeckServantData_o *)sub_1BDBAC4(DeckServantData_TypeInfo);
      DeckServantData___ctor(v21, v22);
      if ( !svts )
        break;
      if ( v21 )
      {
        v23 = sub_1BDB9B4(v21, svts->obj.klass->_1.element_class);
        if ( !v23 )
        {
LABEL_33:
          v43 = sub_1BDBAF8(v23);
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)(v27 + 4), (int32_t)v21, v25, v26);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        break;
      if ( v20 >= svts->max_length )
...
LABEL_15:
  if ( waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v34 = (DeckWaveServantData_o *)sub_1BDBAC4(DeckWaveServantData_TypeInfo);
      DeckWaveServantData___ctor(v34, v35);
      if ( !v31 )
        goto LABEL_32;
      if ( v34 )
      {
        v23 = sub_1BDB9B4(v34, v31->obj.klass->_1.element_class);
        if ( !v23 )
          goto LABEL_33;
      }
      ...
      sub_1BDB81C((CGThumbnailListItem_o *)(v37 + 4), (int32_t)v34, v25, v36);
      v31 = *p_waveSvts;
      if ( !*p_waveSvts )
        goto LABEL_32;
      if ( v32 >= v31->max_length )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckServant___ctor_40698528(
        DeckServant_o *this,
        int32_t sum,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B445CB & 1) == 0 )
  {
    sub_1BDB878(&DeckServantData___TypeInfo, *(_QWORD *)&sum);
    sub_1BDB878(&DeckServantData_TypeInfo, v7);
    byte_4B445CB = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v8 = (struct DeckServantData_array *)sub_1BDB920(DeckServantData___TypeInfo, (unsigned int)sum);
  this->fields.svts = v8;
  p_fields = &this->fields;
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields, (int32_t)v8, v10, v11);
  if ( !deckInfo )
LABEL_24:
    sub_1BDBAD4(v12, v13);
  if ( sum >= 1 )
  {
    ...
    do
    {
      ...
      if ( svts && (max_length = svts->max_length, (__int64)v16 < (int)max_length) )
      {
        ...
        if ( v21 )
        {
          v12 = sub_1BDB9B4(v21, *(_QWORD *)(*(_QWORD *)v20 + 64LL));
          if ( !v12 )
            goto LABEL_26;
        }
        if ( v16 >= v20[6] )
        ...
        v22 = &v20[2 * v16];
        *((_QWORD *)v22 + 4) = v21;
        sub_1BDB81C((CGThumbnailListItem_o *)(v22 + 8), (int32_t)v21, v14, v15);
        ++v16;
      }
      else
      {
        ...
        if ( v24 )
        {
          v12 = sub_1BDB9B4(v24, *(_QWORD *)(*(_QWORD *)v23 + 64LL));
          if ( !v12 )
          {
LABEL_26:
            v30 = sub_1BDBAF8(v12);
        ...
        v27 = &v23[2 * v16];
        *((_QWORD *)v27 + 4) = v24;
        sub_1BDB81C((CGThumbnailListItem_o *)(v27 + 8), (int32_t)v24, v14, v26);
        v28 = p_fields->svts;
        if ( !p_fields->svts )
          goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B445D2 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_UserServantMaster___, svtCollectList);
    sub_1BDB878(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__isEntityExistsFromId__, v7);
    ...
    sub_1BDB878(&Method_System_Collections_Generic_List_long__get_Item__, v11);
          ...
          if ( userSvtId >= 1 )
          {
            ...
            if ( size >= items->max_length )
            {
              System_Collections_Generic_List_long___AddWithResize(
                svtCollectList,
                userSvtId,
                *(const MethodInfo_36BDDF8 **)(*(_QWORD *)(v25[4] + 192LL) + 112LL));
            }
            else
            {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B445CD & 1) == 0 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, *(_QWORD *)&memberIdx);
    sub_1BDB878(&Method_DataManager_GetMasterData_UserServantMaster___, v7);
    sub_1BDB878(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__isEntityExistsFromId__, v8);
  ...
  Instance = (System_Int64_array *)sub_1BDB920(long___TypeInfo, (unsigned int)max);
  svts = this->fields.svts;
  if ( !svts )
    goto LABEL_37;
  max_length = svts->max_length;
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      Instance = (System_Int64_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( Instance )
      {
        MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)Instance,
                              (const MethodInfo_303395C *)Method_DataManager_GetMasterData_UserServantMaster___);
        Instance = (System_Int64_array *)sub_1BDB920(long___TypeInfo, 1LL);
        if ( Instance )
        {
          v13 = Instance;
...
System_Int64_array *__fastcall DeckServant__GetEquipList_40699836(
        DeckServant_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B445CE & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__isEntityExistsFromId__, v10);
  ...
  v15 = (System_Int64_array *)sub_1BDB920(long___TypeInfo, (unsigned int)v13->static_fields->SvtEquipMax);
  isEntityExistsFromId = (System_Int64_array *)sub_1BDB920(long___TypeInfo, 1LL);
  if ( !isEntityExistsFromId )
    goto LABEL_40;
  v17 = isEntityExistsFromId;
  if ( !isEntityExistsFromId->max_length )
LABEL_41:
    sub_1BDBADC(isEntityExistsFromId, v17, v18);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  isEntityExistsFromId = (System_Int64_array *)DataManager__GetMaster_object_((const MethodInfo_3033908 *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  svts = this->fields.svts;
  if ( !svts )
LABEL_40:
    sub_1BDBAD4(isEntityExistsFromId, v17);
  max_length = svts->max_length;
  if ( max_length >= 1 )
  {
    v21 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B445CC & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_UserServantMaster___, *(_QWORD *)&menber);
    sub_1BDB878(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__, v5);
    this = (DeckServant_o *)sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4B445CC = 1;
  }
  entity = 0LL;
  svts = v4->fields.svts;
  if ( !svts )
LABEL_16:
    sub_1BDBAD4(this, *(_QWORD *)&menber);
  v8 = 0LL;
  v9 = menber + 1;
  while ( 1 )
  {
    ...
    if ( (unsigned int)v8 >= max_length )
      sub_1BDBADC(this, *(_QWORD *)&menber, method);
    v11 = svts->m_Items[v8];
    if ( !v11 )
      goto LABEL_16;
...
LABEL_15:
  ...
  this = (DeckServant_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_16;
...
bool __fastcall DeckServant__IsEquip_40701072(
        DeckServant_o *this,
        int64_t userSvtId,
