...
void DeckServant___ctor_41475048(DeckServant_o *this, int32_t sum, int64_t userEquipId, const MethodInfo *method)
{
  ...
  if ( (byte_4C26DF9 & 1) == 0 )
  {
    sub_1C2D490(&Method_System_Array_Empty_DeckWaveServantData___);
    sub_1C2D490(&DeckServantData___TypeInfo);
    sub_1C2D490(&DeckServantData_TypeInfo);
    byte_4C26DF9 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v7 = (struct DeckServantData_array *)sub_1C2D538(DeckServantData___TypeInfo, (unsigned int)sum);
  this->fields.svts = v7;
  p_fields = &this->fields;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)v7, v9, v10);
  v14 = Method_System_Array_Empty_DeckWaveServantData___;
  v15 = *((_QWORD *)Method_System_Array_Empty_DeckWaveServantData___ + 7);
  if ( !v15 )
  {
    sub_1C7DC00(Method_System_Array_Empty_DeckWaveServantData___);
    v15 = v14[7];
  }
  v16 = *(_QWORD *)(v15 + 16);
  ...
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.waveSvts, (int32_t)v19, v11, v12);
  if ( sum >= 1 )
  {
    svts = p_fields->svts;
    v21 = 0;
    do
    {
      v22 = (DeckServantData_o *)sub_1C2D6DC(DeckServantData_TypeInfo);
      DeckServantData___ctor(v22, v23);
      if ( !svts )
        goto LABEL_22;
      if ( v22 )
      {
        v24 = sub_1C2D5CC(v22, svts->obj.klass->_1.element_class);
        if ( !v24 )
        {
          v30 = sub_1C2D710(0);
          sub_1C2D5B8(v30, 0);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)(v28 + 4), (int32_t)v22, v26, v27);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        goto LABEL_22;
      if ( v21 >= LODWORD(svts->max_length) )
...
void DeckServant___ctor_41475704(
        DeckServant_o *this,
        int32_t waveNum,
        int32_t memberNum,
        int64_t userEquipId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4C26DFA & 1) == 0 )
  {
    sub_1C2D490(&DeckServantData___TypeInfo);
    sub_1C2D490(&DeckServantData_TypeInfo);
    sub_1C2D490(&DeckWaveServantData___TypeInfo);
    sub_1C2D490(&DeckWaveServantData_TypeInfo);
    byte_4C26DFA = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0);
  v8 = (struct DeckServantData_array *)sub_1C2D538(DeckServantData___TypeInfo, (unsigned int)(memberNum * waveNum));
  this->fields.svts = v8;
  p_fields = &this->fields;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields, (int32_t)v8, v10, v11);
  v12 = (struct DeckWaveServantData_array *)sub_1C2D538(DeckWaveServantData___TypeInfo, (unsigned int)waveNum);
  this->fields.waveSvts = v12;
  p_waveSvts = &this->fields.waveSvts;
  sub_1C2D434((CGThumbnailListItem_o *)&this->fields.waveSvts, (int32_t)v12, v14, v15);
  if ( memberNum * waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v18 = (DeckServantData_o *)sub_1C2D6DC(DeckServantData_TypeInfo);
      DeckServantData___ctor(v18, v19);
      if ( !svts )
        break;
      if ( v18 )
      {
        v20 = sub_1C2D5CC(v18, svts->obj.klass->_1.element_class);
        if ( !v20 )
        {
LABEL_33:
          v40 = sub_1C2D710(v20);
      ...
      sub_1C2D434((CGThumbnailListItem_o *)(v24 + 4), (int32_t)v18, v22, v23);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        break;
      if ( v17 >= LODWORD(svts->max_length) )
...
LABEL_15:
  if ( waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v31 = (DeckWaveServantData_o *)sub_1C2D6DC(DeckWaveServantData_TypeInfo);
      DeckWaveServantData___ctor(v31, v32);
      if ( !v28 )
        goto LABEL_32;
      if ( v31 )
      {
        v20 = sub_1C2D5CC(v31, v28->obj.klass->_1.element_class);
        if ( !v20 )
          goto LABEL_33;
      }
      if ( v29 >= LODWORD(v28->max_length) )
        goto LABEL_31;
      v34 = &v28->obj.klass + (int)v29;
      v34[4] = (Il2CppClass *)v31;
      sub_1C2D434((CGThumbnailListItem_o *)(v34 + 4), (int32_t)v31, v22, v33);
      v28 = *p_waveSvts;
      if ( !*p_waveSvts )
        goto LABEL_32;
      if ( v29 >= LODWORD(v28->max_length) )
...
void DeckServant___ctor_41476512(DeckServant_o *this, int32_t sum, DeckServant_o *deckInfo, const MethodInfo *method)
{
  struct DeckServantData_array *v7; // x0
  ...
  if ( sum >= 1 )
  {
    ...
    do
    {
      ...
      if ( svts && (max_length_low = LODWORD(svts->max_length), (__int64)v15 < (int)max_length_low) )
      {
        ...
        if ( v20 )
        {
          v11 = sub_1C2D5CC(v20, *(_QWORD *)(*(_QWORD *)v19 + 64LL));
          if ( !v11 )
            goto LABEL_26;
        }
        if ( v15 >= v19[6] )
        ...
        v21 = &v19[2 * v15];
        *((_QWORD *)v21 + 4) = v20;
        sub_1C2D434((CGThumbnailListItem_o *)(v21 + 8), (int32_t)v20, v13, v14);
        ++v15;
      }
      else
      {
        v22 = (unsigned int *)p_fields->svts;
        v23 = (DeckServantData_o *)sub_1C2D6DC(DeckServantData_TypeInfo);
        DeckServantData___ctor(v23, v24);
        if ( !v22 )
          goto LABEL_24;
        if ( v23 )
        {
          v11 = sub_1C2D5CC(v23, *(_QWORD *)(*(_QWORD *)v22 + 64LL));
          if ( !v11 )
          {
LABEL_26:
            v29 = sub_1C2D710(v11);
        ...
        v26 = &v22[2 * v15];
        *((_QWORD *)v26 + 4) = v23;
        sub_1C2D434((CGThumbnailListItem_o *)(v26 + 8), (int32_t)v23, v13, v25);
        v27 = p_fields->svts;
        if ( !p_fields->svts )
          goto LABEL_24;
          ...
          if ( userSvtId >= 1 )
          {
            ...
            if ( (unsigned int)size >= LODWORD(items->max_length) )
            {
              System_Collections_Generic_List_long___AddWithResize(
                svtCollectList,
                userSvtId,
                *(const MethodInfo_3771BB8 **)(*(_QWORD *)(v19[4] + 192LL) + 112LL));
            }
            else
            {
          ...
          while ( 1 )
          {
            ...
            *(_QWORD *)(Instance + 32) = v26;
            ...
            if ( (Instance & 1) != 0 )
            {
              if ( !equipCollectList )
                break;
              v27 = equipCollectList->fields._size;
              if ( v27 < 1 )
              {
LABEL_43:
                if ( v26 >= 1 )
                {
                  v29 = equipCollectList->fields._items;
                  v30 = Method_System_Collections_Generic_List_long__Add__;
                  ++equipCollectList->fields._version;
                  if ( !v29 )
                    break;
                  if ( (unsigned int)v27 >= LODWORD(v29->max_length) )
                  {
                    System_Collections_Generic_List_long___AddWithResize(
                      equipCollectList,
                      v26,
                      *(const MethodInfo_3771BB8 **)(*(_QWORD *)(v30[4] + 192LL) + 112LL));
                  }
                  else
                  {
                    equipCollectList->fields._size = v27 + 1;
                    v29->m_Items[v27] = v26;
                  }
                }
              }
        ...
        const MethodInfo *method)
{
  ...
  Instance = (System_Int64_array *)sub_1C2D538(long___TypeInfo, (unsigned int)max);
  svts = this->fields.svts;
  if ( !svts )
    goto LABEL_37;
  max_length = svts->max_length;
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      Instance = (System_Int64_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( Instance )
      {
        MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)Instance,
                              (const MethodInfo_30CE950 *)Method_DataManager_GetMasterData_UserServantMaster___);
        Instance = (System_Int64_array *)sub_1C2D538(long___TypeInfo, 1);
        if ( Instance )
        {
          v9 = &Instance->obj;
                   ...
                   (const MethodInfo_33898D0 *)Method_DataMasterBase_UserServantMaster__UserServantEntity__long__isEntityExistsFromId__) )
            {
              ...
              if ( userSvtEquipIds )
              {
                if ( max >= 1 )
                {
                  ...
                  while ( (__int64)v20 < SLODWORD(userSvtEquipIds->max_length) )
                  {
                    Instance = (System_Int64_array *)sub_1C2D538(long___TypeInfo, 1);
                    if ( v20 >= LODWORD(userSvtEquipIds->max_length) )
                      goto LABEL_38;
                    v9 = &Instance->obj;
                    if ( !Instance )
                      goto LABEL_37;
                    ...
                    if ( ((unsigned __int8)Instance & 1) != 0 )
                    {
                      ...
                      if ( !p_obj )
                        goto LABEL_37;
                      if ( v20 >= LODWORD(p_obj[1].monitor) )
                        goto LABEL_38;
                      *((_QWORD *)&p_obj[2].klass + v20) = v21[v20];
                    }
                    if ( max == ++v20 )
                      return (System_Int64_array *)p_obj;
                  }
...
System_Int64_array *DeckServant__GetEquipList_41477820(
        DeckServant_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  v10 = sub_1C2D538(long___TypeInfo, (unsigned int)v8->static_fields->SvtEquipMax);
  isEntityExistsFromId = (System_Int64_array *)sub_1C2D538(long___TypeInfo, 1);
  if ( !isEntityExistsFromId )
    goto LABEL_40;
  v12 = isEntityExistsFromId;
  if ( !LODWORD(isEntityExistsFromId->max_length) )
LABEL_41:
    sub_1C2D6F4(isEntityExistsFromId, v12, v13);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  isEntityExistsFromId = (System_Int64_array *)DataManager__GetMaster_object_((const MethodInfo_30CE8FC *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  svts = this->fields.svts;
  if ( !svts )
LABEL_40:
    sub_1C2D6EC(isEntityExistsFromId, v12);
  max_length = svts->max_length;
  if ( max_length >= 1 )
  {
    v16 = 0;
    ...
    if ( !v17->fields.isFollowerSvt )
    {
      ...
      if ( userSvtEquipIds )
      {
        ...
        while ( 1 )
        {
          ...
          if ( (__int64)v20 >= v22->static_fields->SvtEquipMax || (__int64)v20 >= SLODWORD(userSvtEquipIds->max_length) )
            break;
          isEntityExistsFromId = (System_Int64_array *)sub_1C2D538(long___TypeInfo, 1);
          if ( v20 >= LODWORD(userSvtEquipIds->max_length) )
            goto LABEL_41;
          ...
          if ( ((unsigned __int8)isEntityExistsFromId & 1) != 0 || isInterruption )
          {
            ...
            if ( !v10 )
              goto LABEL_40;
            if ( v20 >= *(unsigned int *)(v10 + 24) )
              goto LABEL_41;
            *(_QWORD *)(v10 + 32 + 8 * v20) = m_Items[v20];
          }
          ++v20;
        }
      }
...
UserServantEntity_o *DeckServant__GetUserServant(DeckServant_o *this, int32_t menber, const MethodInfo *method)
{
  ...
  if ( (byte_4C26DFC & 1) == 0 )
  {
    ...
    this = (DeckServant_o *)sub_1C2D490(&Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    byte_4C26DFC = 1;
  }
  entity = 0;
  svts = v4->fields.svts;
  if ( !svts )
LABEL_16:
    sub_1C2D6EC(this, *(_QWORD *)&menber);
  v6 = 0;
  v7 = menber + 1;
  while ( 1 )
  {
    ...
    if ( (unsigned int)v6 >= max_length )
      sub_1C2D6F4(this, *(_QWORD *)&menber, method);
    v9 = svts->m_Items[v6];
    if ( !v9 )
      goto LABEL_16;
...
LABEL_15:
  ...
  this = (DeckServant_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39D3CCC *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_16;
...
bool DeckServant__IsEquip_41479056(
        DeckServant_o *this,
        int64_t userSvtId,
