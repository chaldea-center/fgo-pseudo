...
void __fastcall DeckServant___ctor_40082464(
        DeckServant_o *this,
        int32_t sum,
        int64_t userEquipId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7619 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Array_Empty_DeckWaveServantData___, *(_QWORD *)&sum);
    sub_1C1ABD4(&DeckServantData___TypeInfo, v7);
    sub_1C1ABD4(&DeckServantData_TypeInfo, v8);
    byte_4BC7619 = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v9 = (struct DeckServantData_array *)sub_1C1AC7C(DeckServantData___TypeInfo, (unsigned int)sum);
  this->fields.svts = v9;
  p_fields = &this->fields;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)v9, v11, v12, v13, v14, v15, v16);
  v24 = Method_System_Array_Empty_DeckWaveServantData___;
  v25 = *((_QWORD *)Method_System_Array_Empty_DeckWaveServantData___ + 7);
  if ( !v25 )
  {
    sub_1C6CB0C(Method_System_Array_Empty_DeckWaveServantData___);
    v25 = v24[7];
  }
  v26 = *(_QWORD *)(v25 + 16);
  ...
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.waveSvts, (int64_t)v29, v17, v18, v19, v20, v21, v22);
  if ( sum >= 1 )
  {
    svts = p_fields->svts;
    v31 = 0;
    do
    {
      v32 = (DeckServantData_o *)sub_1C1AE20(DeckServantData_TypeInfo);
      DeckServantData___ctor(v32, v33);
      if ( !svts )
        goto LABEL_22;
      if ( v32 )
      {
        v34 = sub_1C1AD10(v32, svts->obj.klass->_1.element_class);
        if ( !v34 )
        {
          v44 = sub_1C1AE54(0LL);
          sub_1C1ACFC(v44, 0LL);
      ...
      sub_1C1AB78((PartyOrganizationUtility_o *)(v42 + 4), (int64_t)v32, v36, v37, v38, v39, v40, v41);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        goto LABEL_22;
      if ( v31 >= svts->max_length )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckServant___ctor_40083120(
        DeckServant_o *this,
        int32_t waveNum,
        int32_t memberNum,
        int64_t userEquipId,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC761A & 1) == 0 )
  {
    sub_1C1ABD4(&DeckServantData___TypeInfo, *(_QWORD *)&waveNum);
    sub_1C1ABD4(&DeckServantData_TypeInfo, v8);
    sub_1C1ABD4(&DeckWaveServantData___TypeInfo, v9);
    sub_1C1ABD4(&DeckWaveServantData_TypeInfo, v10);
    byte_4BC761A = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v11 = (struct DeckServantData_array *)sub_1C1AC7C(DeckServantData___TypeInfo, (unsigned int)(memberNum * waveNum));
  this->fields.svts = v11;
  p_fields = &this->fields;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)v11, v13, v14, v15, v16, v17, v18);
  v19 = (struct DeckWaveServantData_array *)sub_1C1AC7C(DeckWaveServantData___TypeInfo, (unsigned int)waveNum);
  this->fields.waveSvts = v19;
  p_waveSvts = &this->fields.waveSvts;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields.waveSvts, (int64_t)v19, v21, v22, v23, v24, v25, v26);
  if ( memberNum * waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v29 = (DeckServantData_o *)sub_1C1AE20(DeckServantData_TypeInfo);
      DeckServantData___ctor(v29, v30);
      if ( !svts )
        break;
      if ( v29 )
      {
        v31 = sub_1C1AD10(v29, svts->obj.klass->_1.element_class);
        if ( !v31 )
        {
LABEL_33:
          v60 = sub_1C1AE54(v31);
      ...
      sub_1C1AB78((PartyOrganizationUtility_o *)(v39 + 4), (int64_t)v29, v33, v34, v35, v36, v37, v38);
      svts = p_fields->svts;
      if ( !p_fields->svts )
        break;
      if ( v28 >= svts->max_length )
...
LABEL_15:
  if ( waveNum >= 1 )
  {
    ...
    while ( 1 )
    {
      v46 = (DeckWaveServantData_o *)sub_1C1AE20(DeckWaveServantData_TypeInfo);
      DeckWaveServantData___ctor(v46, v47);
      if ( !v43 )
        goto LABEL_32;
      if ( v46 )
      {
        v31 = sub_1C1AD10(v46, v43->obj.klass->_1.element_class);
        if ( !v31 )
          goto LABEL_33;
      }
      ...
      sub_1C1AB78((PartyOrganizationUtility_o *)(v54 + 4), (int64_t)v46, v48, v49, v50, v51, v52, v53);
      v43 = *p_waveSvts;
      if ( !*p_waveSvts )
        goto LABEL_32;
      if ( v44 >= v43->max_length )
...
// local variable allocation has failed, the output may be wrong!
void __fastcall DeckServant___ctor_40083928(
        DeckServant_o *this,
        int32_t sum,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC761B & 1) == 0 )
  {
    sub_1C1ABD4(&DeckServantData___TypeInfo, *(_QWORD *)&sum);
    sub_1C1ABD4(&DeckServantData_TypeInfo, v7);
    byte_4BC761B = 1;
  }
  System_Object___ctor((Il2CppObject *)this, 0LL);
  v8 = (struct DeckServantData_array *)sub_1C1AC7C(DeckServantData___TypeInfo, (unsigned int)sum);
  this->fields.svts = v8;
  p_fields = &this->fields;
  sub_1C1AB78((PartyOrganizationUtility_o *)&this->fields, (int64_t)v8, v10, v11, v12, v13, v14, v15);
  if ( !deckInfo )
LABEL_24:
    sub_1C1AE30(v16, v17);
  if ( sum >= 1 )
  {
    ...
    do
    {
      ...
      if ( svts && (max_length = svts->max_length, (__int64)v24 < (int)max_length) )
      {
        ...
        if ( v29 )
        {
          v16 = sub_1C1AD10(v29, *(_QWORD *)(*(_QWORD *)v28 + 64LL));
          if ( !v16 )
            goto LABEL_26;
        }
        if ( v24 >= v28[6] )
        ...
        v30 = &v28[2 * v24];
        *((_QWORD *)v30 + 4) = v29;
        sub_1C1AB78((PartyOrganizationUtility_o *)(v30 + 8), v29, v18, v19, v20, v21, v22, v23);
        ++v24;
      }
      else
      {
        ...
        if ( v32 )
        {
          v16 = sub_1C1AD10(v32, *(_QWORD *)(*(_QWORD *)v31 + 64LL));
          if ( !v16 )
          {
LABEL_26:
            v43 = sub_1C1AE54(v16);
        ...
        v40 = &v31[2 * v24];
        *((_QWORD *)v40 + 4) = v32;
        sub_1C1AB78((PartyOrganizationUtility_o *)(v40 + 8), (int64_t)v32, v34, v35, v36, v37, v38, v39);
        v41 = p_fields->svts;
        if ( !p_fields->svts )
          goto LABEL_24;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC7621 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserServantMaster___, svtCollectList);
    sub_1C1ABD4(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__isEntityExistsFromId__, v7);
    ...
    sub_1C1ABD4(&Method_System_Collections_Generic_List_long__get_Item__, v11);
          ...
          if ( userSvtId >= 1 )
          {
            ...
            if ( size >= items->max_length )
            {
              System_Collections_Generic_List_long___AddWithResize(
                svtCollectList,
                userSvtId,
                *(const MethodInfo_36248C4 **)(*(_QWORD *)(v24[4] + 192LL) + 112LL));
            }
            else
            {
                ...
                if ( v31 >= 1 )
                {
                  ...
                  if ( v32 >= v34->max_length )
                  {
                    System_Collections_Generic_List_long___AddWithResize(
                      equipCollectList,
                      v31,
                      *(const MethodInfo_36248C4 **)(*(_QWORD *)(v35[4] + 192LL) + 112LL));
                  }
                  else
                  {
...
System_Int64_array *__fastcall DeckServant__GetEquipList(DeckServant_o *this, int32_t menber, const MethodInfo *method)
{
  ...
  if ( (byte_4BC761D & 1) == 0 )
  {
    sub_1C1ABD4(&BalanceConfig_TypeInfo, *(_QWORD *)&menber);
  ...
  Instance = (System_Int64_array *)sub_1C1AC7C(long___TypeInfo, (unsigned int)v9->static_fields->SvtEquipMax);
  svts = this->fields.svts;
  if ( !svts )
    goto LABEL_36;
  max_length = svts->max_length;
  ...
  if ( max_length >= 1 )
  {
    ...
    {
      Instance = (System_Int64_array *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
      if ( Instance )
      {
        MasterData_object = DataManager__GetMasterData_object_(
                              (DataManager_o *)Instance,
                              (const MethodInfo_2F9F490 *)Method_DataManager_GetMasterData_UserServantMaster___);
        Instance = (System_Int64_array *)sub_1C1AC7C(long___TypeInfo, 1LL);
        if ( Instance )
        {
          v11 = Instance;
...
System_Int64_array *__fastcall DeckServant__GetEquipList_40085236(
        DeckServant_o *this,
        int64_t userSvtId,
        bool isInterruption,
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC761E & 1) == 0 )
  {
    sub_1C1ABD4(&BalanceConfig_TypeInfo, userSvtId);
    sub_1C1ABD4(&Method_DataManager_GetMaster_UserServantCollectionMaster___, v7);
    sub_1C1ABD4(&Method_DataManager_GetMaster_UserServantMaster___, v8);
    sub_1C1ABD4(&DataManager_TypeInfo, v9);
    sub_1C1ABD4(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__isEntityExistsFromId__, v10);
  ...
  v15 = (System_Int64_array *)sub_1C1AC7C(long___TypeInfo, (unsigned int)v13->static_fields->SvtEquipMax);
  isEntityExistsFromId = (System_Int64_array *)sub_1C1AC7C(long___TypeInfo, 1LL);
  if ( !isEntityExistsFromId )
    goto LABEL_40;
  v17 = isEntityExistsFromId;
  if ( !isEntityExistsFromId->max_length )
LABEL_41:
    sub_1C1AE38(isEntityExistsFromId, v17);
  ...
  if ( !DataManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo);
  isEntityExistsFromId = (System_Int64_array *)DataManager__GetMaster_object_((const MethodInfo_2F9F43C *)Method_DataManager_GetMaster_UserServantCollectionMaster___);
  svts = this->fields.svts;
  if ( !svts )
LABEL_40:
    sub_1C1AE30(isEntityExistsFromId, v17);
  max_length = svts->max_length;
  if ( max_length >= 1 )
  {
    v20 = 0;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC761C & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_UserServantMaster___, *(_QWORD *)&menber);
    sub_1C1ABD4(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__TryGetEntity__, v5);
    this = (DeckServant_o *)sub_1C1ABD4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v6);
    byte_4BC761C = 1;
  }
  entity = 0LL;
  svts = v4->fields.svts;
  if ( !svts )
LABEL_16:
    sub_1C1AE30(this, *(_QWORD *)&menber);
  v8 = 0LL;
  v9 = menber + 1;
  while ( 1 )
  {
    ...
    if ( (unsigned int)v8 >= max_length )
      sub_1C1AE38(this, *(_QWORD *)&menber);
    v11 = svts->m_Items[v8];
    if ( !v11 )
      goto LABEL_16;
...
LABEL_15:
  ...
  this = (DeckServant_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !this )
    goto LABEL_16;
...
bool __fastcall DeckServant__IsEquip(DeckServant_o *this, int64_t userSvtId, const MethodInfo *method)
{
  ...
  if ( (byte_4BC761F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&Method_DataMasterBase_UserServantMaster__UserServantEntity__long__isEntityExistsFromId__, v5);
  ...
  while ( 1 )
  {
    ...
    {
      Instance = (Il2CppObject *)sub_1C1AC7C(long___TypeInfo, 1LL);
      if ( !Instance )
        goto LABEL_32;
      v9 = Instance;
...
bool __fastcall DeckServant__IsEquip_40086360(
        DeckServant_o *this,
        int64_t userSvtId,
