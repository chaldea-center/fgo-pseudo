...
void SupportServantListViewObject__Awake(SupportServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4E0106F & 1) == 0 )
  {
    sub_1CE6700(&Method_UnityEngine_GameObject_GetComponent_SupportServantListViewItemDraw___);
    byte_4E0106F = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_SupportServantListViewItemDraw___);
  ...
  if ( !DragObject
    || (v5 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_object_(
                                                    DragObject,
                                                    (const MethodInfo_325BE3C *)Method_UnityEngine_GameObject_GetComponent_SupportServantListViewObject___)) == 0) )
  {
    sub_1CE6958(DragObject, v4);
  }
  SupportServantListViewObject__Init_36791244((SupportServantListViewObject_o *)DragObject, 2, v6);
  return v5;
}
...
// local variable allocation has failed, the output may be wrong!
void SupportServantListViewObject__Init_36791244(
        SupportServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void SupportServantListViewObject__Init_36793020(
        SupportServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void SupportServantListViewObject__Init_36793104(
        SupportServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
...
void SupportServantListViewObject__SetItem_36801396(
        SupportServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
