...
void __fastcall SupportServantListViewObject__Awake(SupportServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EC4AF & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_SupportServantListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42EC4AF = 1;
  }
  ...
  Component_srcLineSprite = (struct SupportServantListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                         dispObject,
                                                                         (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_SupportServantListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  SupportServantListViewObject_o *v8; // x20
  const MethodInfo *v9; // x3
  UnityEngine_Vector3_o zero; // 0:s0.4,4:s1.4,8:s2.4 OVERLAPPED

  if ( (byte_42EC4B3 & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_SupportServantListViewObject___, (_DWORD)method, v2, v3);
    byte_42EC4B3 = 1;
  }
  ...
  if ( !DragObject
    || (v7 = DragObject,
        (DragObject = (UnityEngine_GameObject_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                    DragObject,
                                                    (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_SupportServantListViewObject___)) == 0LL) )
  {
    sub_B5D69C(DragObject, v6);
  }
  v8 = (SupportServantListViewObject_o *)DragObject;
  zero = UnityEngine_Vector3__get_zero(0LL);
  SupportServantListViewObject__Init(v8, 2, 0LL, zero.fields.x, *(UnityEngine_Vector3_o *)&zero.fields.y, v9);
  return v7;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EC4B1 & 1) == 0 )
  {
    sub_B5D5C4(&SupportServantListViewItem_TypeInfo, (_DWORD)method, v2, v3);
    byte_42EC4B1 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( !linkItem )
    return 0LL;
  v6 = *(&SupportServantListViewItem_TypeInfo->_2.bitflags2 + 1);
  if ( *(&linkItem->klass->_2.bitflags2 + 1) < (unsigned int)v6 )
    return 0LL;
  if ( (SupportServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[v6 - 1] == SupportServantListViewItem_TypeInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42EC4B4 & 1) == 0 )
  {
    sub_B5D5C4(&SupportServantListViewItem_TypeInfo, initMode, (_DWORD)callbackFunc, method);
    byte_42EC4B4 = 1;
  }
  if ( initMode == 4 )
  {
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SupportServantListViewObject__Init_32183180(
        SupportServantListViewObject_o *this,
        int32_t initMode,
        const MethodInfo *method)
{
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SupportServantListViewObject__Init_32184972(
        SupportServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        float delay,
...
// local variable allocation has failed, the output may be wrong!
void __fastcall SupportServantListViewObject__Init_32185036(
        SupportServantListViewObject_o *this,
        int32_t initMode,
        System_Action_o *callbackFunc,
        const MethodInfo *method)
        ...
        const MethodInfo *method)
{
  ...
  SupportServantListViewItemDraw_o *v14; // x0
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v13);
    SupportServantListViewItemDraw__SetInput(v14, (SupportServantListViewItem_o *)v13, isInput, v10);
  }
}
...
void __fastcall SupportServantListViewObject__SetItem_32192420(
        SupportServantListViewObject_o *this,
        ListViewItem_o *item,
        const MethodInfo *method)
{
...
void __fastcall SupportServantListViewObject__SetupDisp(SupportServantListViewObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42EC4B5 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&SupportServantListViewItem_TypeInfo, v5, v6, v7);
    byte_42EC4B5 = 1;
  }
  linkItem = this->fields.linkItem;
  if ( linkItem )
  {
    ...
    if ( *(&linkItem->klass->_2.bitflags2 + 1) >= (unsigned int)v9
      && (SupportServantListViewItem_c *)linkItem->klass->_2.typeHierarchy[v9 - 1] == SupportServantListViewItem_TypeInfo )
    {
...
LABEL_8:
  ...
  if ( UnityEngine_Object__op_Inequality(itemDraw, 0LL, 0LL) )
  {
    ...
    if ( !v14 )
      sub_B5D69C(0LL, v12);
    SupportServantListViewItemDraw__SetItem(v14, (SupportServantListViewItem_o *)linkItem, this->fields.dispMode, v13);
  }
}
        ...
        const MethodInfo *method)
{
  ...
  __int64 v10; // x0
  bool v11; // zf
  SupportServantListViewObject_o *v12; // x0
  ...
  sub_B5D990(v9);
  SupportServantListViewObject__remove_callbackFunc(v12, v13, v14);
}
        ...
        const MethodInfo *method)
{
  ...
  sub_B5D990(v9);
  SupportServantListViewObject__Awake(v12, v13);
}