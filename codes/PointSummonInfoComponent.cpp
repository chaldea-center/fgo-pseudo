...
void __fastcall PointSummonInfoComponent__OnClickGacha(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_48DF0C3 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_PointSummonInfoComponent_OnClickGacha__, v3);
    byte_48DF0C3 = 1;
  }
  v4 = Method_PointSummonInfoComponent_OnClickGacha__;
  if ( (*((_BYTE *)Method_PointSummonInfoComponent_OnClickGacha__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B00CE4(Method_PointSummonInfoComponent_OnClickGacha__);
  v5 = (System_Reflection_MethodBase_o *)sub_1B00CB0(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0LL);
  v6 = (GachaRqParamData_o *)sub_1B00F18(GachaRqParamData_TypeInfo);
  GachaRqParamData___ctor(v6, 0LL);
  this->fields.requestData = v6;
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.requestData, (int32_t)v6, v7, v8);
...
void __fastcall PointSummonInfoComponent__OnClickMutiGacha(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00CCC(&GachaRqParamData_TypeInfo, method);
    sub_1B00CCC(&Method_PointSummonInfoComponent_OnClickMutiGacha__, v3);
    byte_48DF0C4 = 1;
  }
  v4 = Method_PointSummonInfoComponent_OnClickMutiGacha__;
  if ( (*((_BYTE *)Method_PointSummonInfoComponent_OnClickMutiGacha__ + 83) & 2) != 0 )
    v4 = (_QWORD *)sub_1B00CE4(Method_PointSummonInfoComponent_OnClickMutiGacha__);
  v5 = (System_Reflection_MethodBase_o *)sub_1B00CB0(v4, v4[4]);
  OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0LL);
  v6 = (GachaRqParamData_o *)sub_1B00F18(GachaRqParamData_TypeInfo);
  GachaRqParamData___ctor(v6, 0LL);
...
void __fastcall PointSummonInfoComponent__init(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B00F28(singleGachaBtnInfo, method);
  }
  UnityEngine_GameObject__SetActive(singleGachaBtnInfo, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
LABEL_17:
    sub_1B00F28(freeGachaBtn, isDisp);
  }
  v16.fields.a = 1.0;
  v16.fields.r = v7;
  v16.fields.g = v7;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF0C2 & 1) == 0 )
  {
    sub_1B00CCC(&StringLiteral_23326/*"summon_txt_f10"*/, *(_QWORD *)&price);
    sub_1B00CCC(&StringLiteral_23324/*"summon_txt_f0"*/, v7);
    sub_1B00CCC(&StringLiteral_23325/*"summon_txt_f01"*/, v8);
    byte_48DF0C2 = 1;
  }
  ...
  if ( v9 < 2 )
  {
    ...
    if ( singleGachaBtnInfo )
    {
      *(_QWORD *)&price = StringLiteral_23325/*"summon_txt_f01"*/;
      goto LABEL_12;
    }
LABEL_13:
    sub_1B00F28(singleGachaBtnInfo, *(_QWORD *)&price);
  }
  UnityEngine_GameObject__SetActive(singleGachaBtnInfo, 0, 0LL);
  ...
  v13 = System_String__Concat_60325748((System_String_o *)StringLiteral_23324/*"summon_txt_f0"*/, v12, 0LL);
  if ( *p_gachaTime >= 10 )
  {
    *p_gachaTime = 10;
    *(_QWORD *)&price = StringLiteral_23326/*"summon_txt_f10"*/;
  }
  else
  {
    *(_QWORD *)&price = v13;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48DF0C1 & 1) == 0 )
  {
    ...
    sub_1B00CCC(&Method_DataManager_GetMasterData_UserGachaMaster___, v4);
    ...
    sub_1B00CCC(&StringLiteral_10274/*"POINT_SUMMON_DETAIL"*/, v12);
    sub_1B00CCC(&StringLiteral_4938/*"DAILY_SUMMON_DETAIL"*/, v13);
    sub_1B00CCC(&StringLiteral_23327/*"summon_txt_free"*/, v14);
    byte_48DF0C1 = 1;
  }
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  t1.fields._dateData = NetworkManager__getServerDateTime_37177692(freeDrawAt, 0LL).fields._dateData;
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  v35.fields._dateData = NetworkManager__getServerDateTime_37177692(v34, 0LL).fields._dateData;
  if ( v34 <= 0 )
    goto LABEL_44;
...
LABEL_44:
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_47:
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_4938/*"DAILY_SUMMON_DETAIL"*/, 0LL);
      if ( pointGachaDetailLb )
      {
        ...
        if ( Instance )
        {
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_23327/*"summon_txt_free"*/, 0LL);
...
LABEL_58:
  ...
  v40 = LocalizationManager__Get((System_String_o *)StringLiteral_10274/*"POINT_SUMMON_DETAIL"*/, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  sub_1B00C70((ServantStatusBattleListViewItem_o *)&this->fields.pointGachaData, (int32_t)pointGachaEnt, v11, v12);
  ...
  else
  {
    if ( !v8 )
    {
      if ( LOBYTE(this[1].fields.method_ptr) )
      {
        ...
        {
          if ( (v12 & 1) != 0 )
            v9 = (Il2CppObject *)sub_1946E08;
          else
            v9 = (Il2CppObject *)sub_1946DCC;
        }
        else if ( (v12 & 1) != 0 )
        {
          v9 = (Il2CppObject *)sub_1946D48;
        }
        else
        {
          v9 = (Il2CppObject *)sub_1946D1C;
        }
      }
      else
      {
        v9 = (Il2CppObject *)sub_1946CEC;
      }
      goto LABEL_16;
    }
    if ( !object )
...
LABEL_17:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1946CA4;
}
