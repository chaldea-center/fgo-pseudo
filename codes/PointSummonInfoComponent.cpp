...
void PointSummonInfoComponent__OnClickGacha(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2CCD4 & 1) == 0 )
  {
    sub_1C93AD4(&GachaRqParamData_TypeInfo);
    sub_1C93AD4(&Method_PointSummonInfoComponent_OnClickGacha__);
    byte_4D2CCD4 = 1;
  }
  v3 = Method_PointSummonInfoComponent_OnClickGacha__;
  if ( (*((_BYTE *)Method_PointSummonInfoComponent_OnClickGacha__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_PointSummonInfoComponent_OnClickGacha__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  v5 = (Il2CppObject *)sub_1C93D20(GachaRqParamData_TypeInfo);
  System_Object___ctor(v5, 0);
  this->fields.requestData = (struct GachaRqParamData_o *)v5;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&this->fields.requestData, (int32_t)v5, v6, v7, v8, v9, v10, v11);
...
void PointSummonInfoComponent__OnClickMutiGacha(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93AD4(&GachaRqParamData_TypeInfo);
    sub_1C93AD4(&Method_PointSummonInfoComponent_OnClickMutiGacha__);
    byte_4D2CCD5 = 1;
  }
  v3 = Method_PointSummonInfoComponent_OnClickMutiGacha__;
  if ( (*((_BYTE *)Method_PointSummonInfoComponent_OnClickMutiGacha__ + 83) & 2) != 0 )
    v3 = (_QWORD *)sub_1C93AEC(Method_PointSummonInfoComponent_OnClickMutiGacha__);
  v4 = (System_Reflection_MethodBase_o *)sub_1C93AB8(v3, v3[4]);
  OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0);
  v5 = (Il2CppObject *)sub_1C93D20(GachaRqParamData_TypeInfo);
  System_Object___ctor(v5, 0);
...
void PointSummonInfoComponent__init(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C93D2C(singleGachaBtnInfo, method);
  }
  UnityEngine_GameObject__SetActive(singleGachaBtnInfo, 0, 0);
...
void PointSummonInfoComponent__setDispPointBtn(PointSummonInfoComponent_o *this, bool isDisp, const MethodInfo *method)
{
  ...
  {
LABEL_17:
    sub_1C93D2C(freeGachaBtn, isDisp);
  }
  v16.fields.a = 1.0;
  v16.fields.r = v7;
  v16.fields.g = v7;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2CCD3 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_24136/*"summon_txt_f10"*/);
    sub_1C93AD4(&StringLiteral_24134/*"summon_txt_f0"*/);
    sub_1C93AD4(&StringLiteral_24135/*"summon_txt_f01"*/);
    byte_4D2CCD3 = 1;
  }
  ...
  if ( v7 < 2 )
  {
    ...
    if ( singleGachaBtnInfo )
    {
      *(_QWORD *)&price = StringLiteral_24135/*"summon_txt_f01"*/;
      goto LABEL_12;
    }
LABEL_13:
    sub_1C93D2C(singleGachaBtnInfo, *(_QWORD *)&price);
  }
  UnityEngine_GameObject__SetActive(singleGachaBtnInfo, 0, 0);
  ...
  v11 = System_String__Concat_64425724((System_String_o *)StringLiteral_24134/*"summon_txt_f0"*/, v10, 0);
  if ( *p_gachaTime >= 10 )
  {
    *p_gachaTime = 10;
    *(_QWORD *)&price = StringLiteral_24136/*"summon_txt_f10"*/;
  }
  else
  {
    *(_QWORD *)&price = v11;
...
void PointSummonInfoComponent__setPointSummonDispInfo(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2CCD2 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_10470/*"POINT_SUMMON_DETAIL"*/);
    sub_1C93AD4(&StringLiteral_4978/*"DAILY_SUMMON_DETAIL"*/);
    sub_1C93AD4(&StringLiteral_24137/*"summon_txt_free"*/);
    byte_4D2CCD2 = 1;
  }
  ...
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  t1.fields._dateData = NetworkManager__getServerDateTime_42097084(freeDrawAt, 0).fields._dateData;
  ...
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
  v18 = System_DateTime__get_Hour((System_DateTime_o)&t1, 0);
  ...
  v23 = v17
      - (System_DateTime__get_Second((System_DateTime_o)&t1, 0)
       + 60 * (Minute + 60 * (v20 - DailyFreeGachaResetTime)));
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  v24.fields._dateData = NetworkManager__getServerDateTime_42097084(v23, 0).fields._dateData;
  if ( v23 <= 0 )
    goto LABEL_44;
  ...
  if ( !System_DateTime_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
  if ( System_DateTime__op_LessThanOrEqual((System_DateTime_o)v26, (System_DateTime_o)dateData, 0) )
  {
    if ( !System_DateTime_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_DateTime_TypeInfo);
    if ( System_DateTime__op_LessThanOrEqual((System_DateTime_o)dateData, v11, 0) )
LABEL_44:
  ...
  if ( LocalizationManager_TypeInfo->_2.cctor_finished )
  {
    ...
    {
LABEL_47:
      Instance = LocalizationManager__Get((System_String_o *)StringLiteral_4978/*"DAILY_SUMMON_DETAIL"*/, 0);
      if ( pointGachaDetailLb )
      {
        ...
        if ( Instance )
        {
          UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_24137/*"summon_txt_free"*/, 0);
...
LABEL_58:
  ...
  v29 = LocalizationManager__Get((System_String_o *)StringLiteral_10470/*"POINT_SUMMON_DETAIL"*/, 0);
  price = this->fields.price;
  v30 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &price);
  Instance = System_String__Format(v29, v30, 0);
  if ( !pointGachaDetailLb )
    goto LABEL_58;
  UILabel__set_text(pointGachaDetailLb, (System_String_o *)Instance, 0);
  PointSummonInfoComponent__setMultiGachaNum(this, this->fields.price, usrFriendPoint, v31);
LABEL_55:
...
LABEL_17:
  this->fields.extra_arg = (intptr_t)sub_1AC4420;
}
