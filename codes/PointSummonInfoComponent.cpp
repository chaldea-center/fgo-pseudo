...
void __fastcall PointSummonInfoComponent__OnClickGacha(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_42AF820 & 1) == 0 )
  {
    sub_B52984(&GachaRqParamData_TypeInfo);
  ...
  v3 = (GachaRqParamData_o *)sub_B52A54(GachaRqParamData_TypeInfo);
...
void __fastcall PointSummonInfoComponent__init(PointSummonInfoComponent_o *this, const MethodInfo *method)
{
  ...
  {
    sub_B52A5C(singleGachaBtnInfo, method);
  }
  UnityEngine_GameObject__SetActive(singleGachaBtnInfo, 0, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  *(UnityEngine_Color_o *)&v7 = isDisp ? UnityEngine_Color__get_white(0LL) : UnityEngine_Color__get_gray(0LL);
  ...
  {
LABEL_17:
    sub_B52A5C(freeGachaBtn, isDisp);
  }
  v22.fields.r = v11;
  v22.fields.g = v12;
  v22.fields.b = v13;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF81F & 1) == 0 )
  {
    sub_B52984(&StringLiteral_22628/*"summon_txt_f10"*/);
    sub_B52984(&StringLiteral_22626/*"summon_txt_f0"*/);
    sub_B52984(&StringLiteral_22627/*"summon_txt_f01"*/);
    byte_42AF81F = 1;
  }
  ...
  if ( v7 < 2 )
  {
    ...
    if ( singleGachaBtnInfo )
    {
      *(_QWORD *)&price = StringLiteral_22627/*"summon_txt_f01"*/;
      goto LABEL_12;
    }
LABEL_13:
    sub_B52A5C(singleGachaBtnInfo, *(_QWORD *)&price);
  }
  UnityEngine_GameObject__SetActive(singleGachaBtnInfo, 0, 0LL);
  ...
  v11 = System_String__Concat_44568316((System_String_o *)StringLiteral_22626/*"summon_txt_f0"*/, v10, 0LL);
  if ( *p_gachaTime >= 10 )
  {
    *p_gachaTime = 10;
    *(_QWORD *)&price = StringLiteral_22628/*"summon_txt_f10"*/;
  }
  else
  {
    *(_QWORD *)&price = v11;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AF81E & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_10532/*"POINT_SUMMON_DETAIL"*/);
    sub_B52984(&StringLiteral_4591/*"DAILY_SUMMON_DETAIL"*/);
    sub_B52984(&StringLiteral_22629/*"summon_txt_free"*/);
    byte_42AF81E = 1;
  }
  usrFriendPoint = 0;
  ...
  t1.fields.dateData = NetworkManager__getServerDateTime_25742200(freeDrawAt, 0LL).fields.dateData;
  v34.fields.dateData = (uint64_t)&t1;
  ...
  if ( Hour >= v15->static_fields->DailyFreeGachaResetTime )
    ...
    v16 = freeDrawAt;
  v17 = System_DateTime__get_Hour(v35, 0LL);
  ...
  Minute = System_DateTime__get_Minute(v36, 0LL);
  v37.fields.dateData = (uint64_t)&t1;
  v22 = v16 - (System_DateTime__get_Second(v37, 0LL) + 60 * (Minute + 60 * (v19 - DailyFreeGachaResetTime)));
  if ( (BYTE3(NetworkManager_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !NetworkManager_TypeInfo->_2.cctor_finished )
  {
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  }
  v23.fields.dateData = NetworkManager__getServerDateTime_25742200(v22, 0LL).fields.dateData;
  if ( v22 <= 0 )
    goto LABEL_47;
  ...
  v38.fields.dateData = v25;
  v40.fields.dateData = v24;
  if ( System_DateTime__op_LessThanOrEqual(v38, v40, 0LL) )
  {
    if ( (BYTE3(System_DateTime_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
      && !System_DateTime_TypeInfo->_2.cctor_finished )
    {
    ...
    v39.fields.dateData = v24;
    v41.fields.dateData = dateData;
...
LABEL_47:
  ...
  if ( this->fields.isFree )
  {
    ...
    Instance = LocalizationManager__Get((System_String_o *)StringLiteral_4591/*"DAILY_SUMMON_DETAIL"*/, 0LL);
    if ( pointGachaDetailLb )
    {
      ...
      if ( Instance )
      {
        UISprite__set_spriteName((UISprite_o *)Instance, (System_String_o *)StringLiteral_22629/*"summon_txt_free"*/, 0LL);
...
LABEL_65:
  ...
  v27 = LocalizationManager__Get((System_String_o *)StringLiteral_10532/*"POINT_SUMMON_DETAIL"*/, 0LL);
  price = this->fields.price;
  v28 = (Il2CppObject *)j_il2cpp_value_box_0(int_TypeInfo, &price);
  Instance = System_String__Format(v27, v28, 0LL);
  if ( !pointGachaDetailLb )
    goto LABEL_65;
  UILabel__set_text(pointGachaDetailLb, (System_String_o *)Instance, 0LL);
  PointSummonInfoComponent__setMultiGachaNum(this, this->fields.price, usrFriendPoint, v29);
LABEL_62:
...
LABEL_5:
    for ( i = 0LL; i != v7; ++i )
    {
      ...
      if ( *(__int16 *)(v31 + 72) == -1 )
        sub_B52A40(*(_QWORD *)&v30->fields.extra_arg, paramData, method, v3);
      v34 = sub_B529B4(v31);
          ...
          if ( *(__int16 *)(v31 + 72) != -1 && this->fields.m_target )
          {
            ...
            if ( (v44 & 1) != 0 )
            {
              if ( (v45 & 1) != 0 )
              {
                ...
                {
LABEL_57:
                  v26 = sub_AEB880(paramData, v48, v49, v46);
                }
                v17 = *(_QWORD *)(v26 + 8);
              }
              else
              ...
              v27 = (void (__fastcall **)(GachaRqParamData_o *, _QWORD))sub_B52A34(v17, v31);
              (*v27)(paramData, v27);
            }
            else
            {
              ...
              if ( (v45 & 1) != 0 )
              {
                ...
                {
LABEL_11:
                  v16 = sub_AEB880(paramData, class_0, v10, v12);
                }
...
LABEL_48:
            ...
            v29 = (void (__fastcall **)(__int64 *, GachaRqParamData_o *, _QWORD))sub_B52A34(v25, v31);
