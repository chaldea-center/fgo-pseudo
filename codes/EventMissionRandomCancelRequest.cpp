        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17AB0 & 1) == 0 )
  {
    sub_1BCA7E0(&StringLiteral_21696/*"missionId"*/, *(_QWORD *)&missionId, method);
    byte_4B17AB0 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21696/*"missionId"*/, missionId, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17AAF & 1) == 0 )
  {
    ...
    sub_1BCA7E0(&StringLiteral_19333/*"eventMission/randomCancel"*/, v3, v4);
    byte_4B17AAF = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo, method);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62401220(BaseUrl, (System_String_o *)StringLiteral_19333/*"eventMission/randomCancel"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v9 = ResponseCommandKind__SearchData(110, responseList, 0LL);
  if ( v9
