        ...
        const MethodInfo *method)
{
  if ( (byte_4CF014B & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_21809/*"missionId"*/);
    byte_4CF014B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21809/*"missionId"*/, missionId, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CF014A & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_19291/*"eventMission/randomCancel"*/);
    byte_4CF014A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64176912(BaseUrl, (System_String_o *)StringLiteral_19291/*"eventMission/randomCancel"*/, 0);
}
