        ...
        const MethodInfo *method)
{
  if ( (byte_4B1DFB8 & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_21413/*"missionId"*/, *(_QWORD *)&missionId);
    byte_4B1DFB8 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21413/*"missionId"*/, missionId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1DFB7 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_18981/*"eventMission/randomCancel"*/, v2);
    byte_4B1DFB7 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62450424(BaseUrl, (System_String_o *)StringLiteral_18981/*"eventMission/randomCancel"*/, 0LL);
}
