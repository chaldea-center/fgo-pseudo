        ...
        const MethodInfo *method)
{
  if ( (byte_438B50D & 1) == 0 )
  {
    sub_B775C4(&StringLiteral_20947/*"missionId"*/);
    byte_438B50D = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20947/*"missionId"*/, missionId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_438B50C & 1) == 0 )
  {
    ...
    sub_B775C4(&StringLiteral_18843/*"eventMission/randomCancel"*/);
    byte_438B50C = 1;
  }
  ...
  return System_String__Concat_44901936(BaseUrl, (System_String_o *)StringLiteral_18843/*"eventMission/randomCancel"*/, 0LL);
}
