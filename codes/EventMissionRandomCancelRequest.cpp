        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E9069 & 1) == 0 )
  {
    sub_B5D5C4(&StringLiteral_20791/*"missionId"*/, missionId, (_DWORD)method, v3);
    byte_42E9069 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20791/*"missionId"*/, missionId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E9068 & 1) == 0 )
  {
    ...
    sub_B5D5C4(&StringLiteral_18705/*"eventMission/randomCancel"*/, v4, v5, v6);
    byte_42E9068 = 1;
  }
  ...
  return System_String__Concat_44577788(BaseUrl, (System_String_o *)StringLiteral_18705/*"eventMission/randomCancel"*/, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  v12 = ResponseCommandKind__SearchData(110, responseList, 0LL);
  if ( v12
