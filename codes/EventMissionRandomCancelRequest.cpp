        ...
        const MethodInfo *method)
{
  if ( (byte_4B03AAD & 1) == 0 )
  {
    sub_1BC3008(&StringLiteral_21395/*"missionId"*/, *(_QWORD *)&missionId);
    byte_4B03AAD = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21395/*"missionId"*/, missionId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03AAC & 1) == 0 )
  {
    ...
    sub_1BC3008(&StringLiteral_18967/*"eventMission/randomCancel"*/, v2);
    byte_4B03AAC = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_62348648(BaseUrl, (System_String_o *)StringLiteral_18967/*"eventMission/randomCancel"*/, 0LL);
}
