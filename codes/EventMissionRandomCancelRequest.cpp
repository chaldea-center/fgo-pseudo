        ...
        const MethodInfo *method)
{
  if ( (byte_4CC8F3B & 1) == 0 )
  {
    sub_1C713B0(&StringLiteral_21709/*"missionId"*/);
    byte_4CC8F3B = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21709/*"missionId"*/, missionId, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC8F3A & 1) == 0 )
  {
    ...
    sub_1C713B0(&StringLiteral_19209/*"eventMission/randomCancel"*/);
    byte_4CC8F3A = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_64031724(BaseUrl, (System_String_o *)StringLiteral_19209/*"eventMission/randomCancel"*/, 0);
}
