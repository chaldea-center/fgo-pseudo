        ...
        const MethodInfo *method)
{
  if ( (byte_418785E & 1) == 0 )
  {
    sub_B2C35C(&StringLiteral_20528/*"missionId"*/, *(_QWORD *)&missionId);
    byte_418785E = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20528/*"missionId"*/, missionId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_418785D & 1) == 0 )
  {
    ...
    sub_B2C35C(&StringLiteral_18476/*"eventMission/randomCancel"*/, v2);
    byte_418785D = 1;
  }
  ...
  return System_String__Concat_44305532(BaseUrl, (System_String_o *)StringLiteral_18476/*"eventMission/randomCancel"*/, 0LL);
}
