        ...
        const MethodInfo *method)
{
  if ( (byte_4C28DCA & 1) == 0 )
  {
    sub_1C2D490(&StringLiteral_21591/*"missionId"*/);
    byte_4C28DCA = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21591/*"missionId"*/, missionId, 0);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C28DC9 & 1) == 0 )
  {
    ...
    sub_1C2D490(&StringLiteral_19137/*"eventMission/randomCancel"*/);
    byte_4C28DC9 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0);
  return System_String__Concat_63457864(BaseUrl, (System_String_o *)StringLiteral_19137/*"eventMission/randomCancel"*/, 0);
}
