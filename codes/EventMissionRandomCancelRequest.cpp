        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9F2 & 1) == 0 )
  {
    sub_1B885B0(&StringLiteral_21464/*"missionId"*/);
    byte_4A5C9F2 = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_21464/*"missionId"*/, missionId, v3);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A5C9F1 & 1) == 0 )
  {
    ...
    sub_1B885B0(&StringLiteral_19136/*"eventMission/randomCancel"*/);
    byte_4A5C9F1 = 1;
  }
  if ( !NetworkManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(NetworkManager_TypeInfo);
  BaseUrl = NetworkManager__getBaseUrl(1, 0LL);
  return System_String__Concat_61707032(BaseUrl, (System_String_o *)StringLiteral_19136/*"eventMission/randomCancel"*/, 0LL);
}
