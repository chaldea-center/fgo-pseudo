        ...
        const MethodInfo *method)
{
  if ( (byte_4351E4A & 1) == 0 )
  {
    sub_B70694(&StringLiteral_20851/*"missionId"*/);
    byte_4351E4A = 1;
  }
  RequestBase__addField((RequestBase_o *)this, (System_String_o *)StringLiteral_20851/*"missionId"*/, missionId, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4351E49 & 1) == 0 )
  {
    ...
    sub_B70694(&StringLiteral_18755/*"eventMission/randomCancel"*/);
    byte_4351E49 = 1;
  }
  ...
  return System_String__Concat_44758168(BaseUrl, (System_String_o *)StringLiteral_18755/*"eventMission/randomCancel"*/, 0LL);
}
