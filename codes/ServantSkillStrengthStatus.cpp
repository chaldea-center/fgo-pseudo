    ...
    if ( skillRecord - 1 >= 1 )
    {
      ...
      if ( skillNameLabel )
      {
        ...
        if ( StrengthenedCnt )
        {
          ...
          if ( StrengthenedCnt )
          {
            StrengthenedCnt = UnityEngine_Transform__Find(StrengthenedCnt, (System_String_o *)StringLiteral_20108/*"icon_stateup"*/, 0LL);
            if ( StrengthenedCnt )
            {
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              gameObject = (UnityEngine_GameObject_o *)UnityEngine_Transform__Find(
                                                         ...
                                                         (System_String_o *)StringLiteral_20108/*"icon_stateup"*/,
                                                         0LL);
              if ( gameObject )
              {
