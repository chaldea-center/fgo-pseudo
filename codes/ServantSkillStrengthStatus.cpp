void __fastcall ServantSkillStrengthStatus___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_42AE33B & 1) == 0 )
  {
    ...
    sub_B52984(&StringLiteral_4227/*"CommonUI/ServantStatus/ServantSkillStrengthStatusPrefab"*/);
    sub_B52984(&StringLiteral_19519/*"icon_stateup_on"*/);
    sub_B52984(&StringLiteral_19511/*"icon_skill_off"*/);
    sub_B52984(&StringLiteral_19518/*"icon_stateup_off"*/);
    sub_B52984(&StringLiteral_19512/*"icon_skill_on"*/);
    byte_42AE33B = 1;
  }
  static_fields = (BattleServantConfConponent_o *)ServantSkillStrengthStatus_TypeInfo->static_fields;
  v8 = (System_Int32_array **)StringLiteral_4227/*"CommonUI/ServantStatus/ServantSkillStrengthStatusPrefab"*/;
  static_fields->klass = (BattleServantConfConponent_c *)StringLiteral_4227/*"CommonUI/ServantStatus/ServantSkillStrengthStatusPrefab"*/;
  sub_B52920(static_fields, v8, v1, v2, v3, v4, v5, v6);
  v9 = ServantSkillStrengthStatus_TypeInfo->static_fields;
  v10 = (System_Int32_array **)StringLiteral_19519/*"icon_stateup_on"*/;
  v9->ICON_NAME_ON = (struct System_String_o *)StringLiteral_19519/*"icon_stateup_on"*/;
  sub_B52920((BattleServantConfConponent_o *)&v9->ICON_NAME_ON, v10, v11, v12, v13, v14, v15, v16);
  v17 = ServantSkillStrengthStatus_TypeInfo->static_fields;
  v18 = (System_Int32_array **)StringLiteral_19518/*"icon_stateup_off"*/;
  v17->ICON_NAME_OFF = (struct System_String_o *)StringLiteral_19518/*"icon_stateup_off"*/;
  sub_B52920((BattleServantConfConponent_o *)&v17->ICON_NAME_OFF, v18, v19, v20, v21, v22, v23, v24);
  v25 = ServantSkillStrengthStatus_TypeInfo->static_fields;
  v26 = (System_Int32_array **)StringLiteral_19512/*"icon_skill_on"*/;
  v25->ICON_SKILL_ON = (struct System_String_o *)StringLiteral_19512/*"icon_skill_on"*/;
  sub_B52920((BattleServantConfConponent_o *)&v25->ICON_SKILL_ON, v26, v27, v28, v29, v30, v31, v32);
  v33 = ServantSkillStrengthStatus_TypeInfo->static_fields;
  v34 = (System_Int32_array **)StringLiteral_19511/*"icon_skill_off"*/;
  v33->ICON_SKILL_OFF = (struct System_String_o *)StringLiteral_19511/*"icon_skill_off"*/;
  sub_B52920((BattleServantConfConponent_o *)&v33->ICON_SKILL_OFF, v34, v35, v36, v37, v38, v39, v40);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AE338 & 1) == 0 )
  {
    ...
    sub_B52984(&ServantSkillStrengthStatus_TypeInfo);
    sub_B52984(&StringLiteral_19517/*"icon_stateup"*/);
    byte_42AE338 = 1;
  }
  if ( (BYTE3(ServantSkillStrengthStatus_TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
    && !ServantSkillStrengthStatus_TypeInfo->_2.cctor_finished )
    ...
    if ( skillRecord - 1 >= 1 )
    {
      ...
      if ( skillNameLabel )
      {
        ...
        if ( StrengthenedCnt )
        {
          ...
          if ( StrengthenedCnt )
          {
            StrengthenedCnt = UnityEngine_Transform__Find(StrengthenedCnt, (System_String_o *)StringLiteral_19517/*"icon_stateup"*/, 0LL);
            if ( StrengthenedCnt )
            {
      ...
      sub_B52A5C(StrengthenedCnt, v15);
    }
  }
}
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              gameObject = (UnityEngine_GameObject_o *)UnityEngine_Transform__Find(
                                                         ...
                                                         (System_String_o *)StringLiteral_19517/*"icon_stateup"*/,
                                                         0LL);
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  while ( 1 )
                  {
                    ...
                    GameObjectExtensions__SetLocalPosition_32085060(v20, 0.0, v18 * (float)v17, 0LL);
