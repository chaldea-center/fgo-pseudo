void ServantSkillStrengthStatus___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2C200 & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_4633/*"CommonUI/ServantStatus/ServantSkillStrengthStatusPrefab"*/);
    sub_1C93AD4(&StringLiteral_20464/*"icon_stateup_on"*/);
    sub_1C93AD4(&StringLiteral_20456/*"icon_skill_off"*/);
    sub_1C93AD4(&StringLiteral_20463/*"icon_stateup_off"*/);
    sub_1C93AD4(&StringLiteral_20457/*"icon_skill_on"*/);
    byte_4D2C200 = 1;
  }
  ServantSkillStrengthStatus_TypeInfo->static_fields->PATH = (struct System_String_o *)StringLiteral_4633/*"CommonUI/ServantStatus/ServantSkillStrengthStatusPrefab"*/;
  sub_1C93A78(
    (GrandQuestFolderBoardItem_o *)ServantSkillStrengthStatus_TypeInfo->static_fields,
    StringLiteral_4633/*"CommonUI/ServantStatus/ServantSkillStrengthStatusPrefab"*/,
    v1,
    v2,
    v3,
    v4,
    v5,
    v6);
  v7 = StringLiteral_20464/*"icon_stateup_on"*/;
  static_fields = ServantSkillStrengthStatus_TypeInfo->static_fields;
  static_fields->ICON_NAME_ON = (struct System_String_o *)StringLiteral_20464/*"icon_stateup_on"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&static_fields->ICON_NAME_ON, v7, v9, v10, v11, v12, v13, v14);
  v15 = StringLiteral_20463/*"icon_stateup_off"*/;
  v16 = ServantSkillStrengthStatus_TypeInfo->static_fields;
  v16->ICON_NAME_OFF = (struct System_String_o *)StringLiteral_20463/*"icon_stateup_off"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v16->ICON_NAME_OFF, v15, v17, v18, v19, v20, v21, v22);
  v23 = StringLiteral_20457/*"icon_skill_on"*/;
  v24 = ServantSkillStrengthStatus_TypeInfo->static_fields;
  v24->ICON_SKILL_ON = (struct System_String_o *)StringLiteral_20457/*"icon_skill_on"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v24->ICON_SKILL_ON, v23, v25, v26, v27, v28, v29, v30);
  v31 = StringLiteral_20456/*"icon_skill_off"*/;
  v32 = ServantSkillStrengthStatus_TypeInfo->static_fields;
  v32->ICON_SKILL_OFF = (struct System_String_o *)StringLiteral_20456/*"icon_skill_off"*/;
  sub_1C93A78((GrandQuestFolderBoardItem_o *)&v32->ICON_SKILL_OFF, v31, v33, v34, v35, v36, v37, v38);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2C1FD & 1) == 0 )
  {
    ...
    sub_1C93AD4(&ServantSkillStrengthStatus_TypeInfo);
    sub_1C93AD4(&StringLiteral_20462/*"icon_stateup"*/);
    byte_4D2C1FD = 1;
  }
  if ( !ServantSkillStrengthStatus_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(ServantSkillStrengthStatus_TypeInfo);
  if ( strengthStatus < 1 || (v38 = skillRecord - 1, skillRecord - 1 <= 0) )
  {
    ...
    if ( ((unsigned __int8)IsNullOrEmpty & 1) != 0 )
    {
      if ( !skillNameLabel || !addLabel )
        goto LABEL_61;
      v19 = System_String__Concat_64425724(skillNameLabel->fields.mText, addLabel->fields.mText, 0);
...
LABEL_13:
  ...
  if ( !IsNullOrEmpty )
    goto LABEL_61;
  IsNullOrEmpty = UnityEngine_Transform__Find(IsNullOrEmpty, (System_String_o *)StringLiteral_20462/*"icon_stateup"*/, 0);
  if ( !IsNullOrEmpty )
    goto LABEL_61;
          ...
          if ( gameObject )
          {
            ...
            if ( gameObject )
            {
              gameObject = (UnityEngine_GameObject_o *)UnityEngine_Transform__Find(
                                                         ...
                                                         (System_String_o *)StringLiteral_20462/*"icon_stateup"*/,
                                                         0);
              if ( gameObject )
              {
                ...
                if ( gameObject )
                {
                  ...
                  while ( 1 )
                  {
                    ...
                    GameObjectExtensions__SetLocalPosition_36745168(v20, 0.0, v18 * (float)v17, 0);
