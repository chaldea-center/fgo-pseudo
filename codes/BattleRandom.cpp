void __fastcall BattleRandom___ctor(BattleRandom_o *this, const MethodInfo *method)
{
  if ( (byte_4A22117 & 1) == 0 )
  {
    sub_1B715CC(&Method_SingletonMonoBehaviour_BattleRandom___ctor__, method);
    byte_4A22117 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_370B620 *)Method_SingletonMonoBehaviour_BattleRandom___ctor__);
}
...
int32_t __fastcall BattleRandom__GetGutsCount(const MethodInfo *method)
{
  ...
  if ( (byte_4A22116 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v2);
    byte_4A22116 = 1;
  }
...
void __fastcall BattleRandom__SetCount(int32_t logic, int32_t guts, const MethodInfo *method)
{
  ...
  if ( (byte_4A22114 & 1) == 0 )
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, *(_QWORD *)&guts);
    sub_1B715CC(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v5);
    byte_4A22114 = 1;
  }
...
int32_t __fastcall BattleRandom__getGutsNext(int32_t max, const MethodInfo *method)
{
  ...
  if ( (byte_4A22112 & 1) == 0 )
  {
    ...
    sub_1B715CC(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v3);
    byte_4A22112 = 1;
  }
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *__fastcall BattleRandom__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2E4CDD8 *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_2E4CDD8_RGCTXs *rgctx_data; // x8
  ...
  {
    v8 = (Il2CppClass *)sub_1BC34A8(method->rgctx_data->_0_T__);
    _0_T = v8;
  }
  v26 = StatusReg;
  if ( !v10 )
  ...
  if ( (int)v13 >= 2 )
  {
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(Next + 309) & 1) == 0 )
        Next = sub_1BC34A8(Next);
      v23 = v27;
      if ( (unsigned int)v21 >= v14->max_length )
        goto LABEL_22;
      sub_1B71574(Next, (char *)v14->m_Items + v14->obj.klass->_2.thread_static_fields_size * v21, v7);
...
System_Int32_array *__fastcall BattleRandom__getShuffle_int_(
        ...
        const MethodInfo_2E4CBE4 *method)
{
  ...
  const MethodInfo_2E4CCCC *v18; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Int32_array *)sub_1BC3504(method);
  if ( !v3 )
    goto LABEL_15;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Int32_array *)sub_1BC34A8(method->rgctx_data->_0_T__);
    _0_T = list;
  }
  if ( !v4 )
LABEL_15:
    sub_1B71828(list, method);
  v6 = sub_1B71708(v4, _0_T);
  if ( v6 )
  {
    v7 = *(_QWORD *)(v6 + 24);
...
System_Object_array *__fastcall BattleRandom__getShuffle_object_(
        ...
        const MethodInfo_2E4CCCC *method)
{
  System_Array_o *v3; // x20
  ...
  const MethodInfo_2E4CDD8 *v25; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Object_array *)sub_1BC3504(method);
  if ( !v3 )
    goto LABEL_16;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Object_array *)sub_1BC34A8(method->rgctx_data->_0_T__);
    _0_T = list;
  }
  if ( !v4 )
LABEL_16:
      ...
      do
      {
        ...
        if ( (unsigned int)v7 >= max_length
          || (v18 = &v8->obj.klass + (unsigned int)v7,
              ...
              Next->klass = v20,
              sub_1B71570(Next, (int32_t)v20, v12, v13),
...
LABEL_15:
        ...
        v19->klass = v16;
        sub_1B71570(v19, (int32_t)v16, v21, v22);
        --v9;
      }
      while ( v9 > 2 );
    }
...
void __fastcall BattleRandom__setSeed(int32_t seed, const MethodInfo *method)
{
  ...
  {
    sub_1B715CC(&UnityEngine_Object_TypeInfo, method);
    sub_1B715CC(&System_Random_TypeInfo, v3);
    sub_1B715CC(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v4);
    byte_4A2210F = 1;
  }
  ...
  {
    v8 = (System_Random_o *)sub_1B71818(System_Random_TypeInfo);
    System_Random___ctor_62386412(v8, seed, 0LL);
    if ( !v7 )
      sub_1B71828(v9, v10);
    *(_QWORD *)(v7 + 32) = v8;
    sub_1B71570((ServantStatusBattleListViewItem_o *)(v7 + 32), (int32_t)v8, v11, v12);
    v13 = (System_Random_o *)sub_1B71818(System_Random_TypeInfo);
    System_Random___ctor_62386412(v13, seed, 0LL);
    *(_QWORD *)(v7 + 40) = v13;
    v14 = (ServantStatusBattleListViewItem_o *)(v7 + 40);
    sub_1B71570(v14, (int32_t)v13, v15, v16);
    v14->monitor = 0LL;
  }
}