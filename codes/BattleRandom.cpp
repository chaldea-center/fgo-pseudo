void __fastcall BattleRandom___ctor(BattleRandom_o *this, const MethodInfo *method)
{
  if ( (byte_4AB83DD & 1) == 0 )
  {
    sub_1BAB41C(&Method_SingletonMonoBehaviour_BattleRandom___ctor__, method);
    byte_4AB83DD = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_378A644 *)Method_SingletonMonoBehaviour_BattleRandom___ctor__);
}
...
int32_t __fastcall BattleRandom__GetGutsCount(const MethodInfo *method)
{
  ...
  if ( (byte_4AB83DC & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v3);
    byte_4AB83DC = 1;
  }
...
void __fastcall BattleRandom__SetCount(int32_t logic, int32_t guts, const MethodInfo *method)
{
  ...
  if ( (byte_4AB83DA & 1) == 0 )
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, *(_QWORD *)&guts);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v6);
    byte_4AB83DA = 1;
  }
...
int32_t __fastcall BattleRandom__getGutsNext(int32_t max, const MethodInfo *method)
{
  ...
  if ( (byte_4AB83D8 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v4);
    byte_4AB83D8 = 1;
  }
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *__fastcall BattleRandom__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2EB5D64 *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_2EB5D64_RGCTXs *rgctx_data; // x8
  ...
  {
    v8 = (Il2CppClass *)sub_1BFD2F8(v10);
    _0_T = v8;
  }
  v29 = StatusReg;
  if ( !v11 )
  ...
  if ( (int)v14 >= 2 )
  {
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(Next + 309) & 1) == 0 )
        Next = sub_1BFD2F8(v24);
      v25 = v30;
      if ( (unsigned int)v22 >= v15->max_length )
        goto LABEL_22;
      sub_1BAB3C4(Next, (char *)v15->m_Items + v15->obj.klass->_2.thread_static_fields_size * v22, v7);
      ...
      if ( (*(_BYTE *)(Next + 309) & 1) == 0 )
      {
        Next = sub_1BFD2F8(v27);
        v26 = v15->max_length;
      }
      if ( (unsigned int)v14 >= v26 )
LABEL_22:
        sub_1BAB680(Next, v19);
      sub_1BAB3C4(
        Next,
        (char *)v15->m_Items + v15->obj.klass->_2.thread_static_fields_size * (unsigned __int64)(unsigned int)v14,
        v25);
...
System_Int32_array *__fastcall BattleRandom__getShuffle_int_(
        ...
        const MethodInfo_2EB5B70 *method)
{
  ...
  const MethodInfo_2EB5C58 *v19; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Int32_array *)sub_1BFD354(method);
  if ( !v3 )
    goto LABEL_15;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Int32_array *)sub_1BFD2F8(v4);
    _0_T = list;
  }
  if ( !v5 )
LABEL_15:
    sub_1BAB678(list, method);
  v7 = sub_1BAB558(v5, _0_T);
  if ( v7 )
  {
    v8 = *(_QWORD *)(v7 + 24);
...
System_Object_array *__fastcall BattleRandom__getShuffle_object_(
        ...
        const MethodInfo_2EB5C58 *method)
{
  System_Array_o *v3; // x20
  long double v4; // q0
  ...
  unsigned int max_length; // w8
  Il2CppClass **v16; // x0
  ServantStatusBattleListViewItem_c *v17; // x21
  ServantStatusBattleListViewItem_c *v18; // t1
  Il2CppClass **v19; // x22
  ServantStatusBattleListViewItem_o *v20; // x22
  ServantStatusBattleListViewItem_c *v21; // t1
  int32_t v22; // w2
  int32_t v23; // w3
  Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *v25; // x0
  const MethodInfo_2EB5D64 *v26; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Object_array *)sub_1BFD354(method);
  if ( !v3 )
    goto LABEL_16;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Object_array *)sub_1BFD2F8(v4);
    _0_T = list;
  }
  if ( !v5 )
LABEL_16:
  ...
  if ( v7 )
  {
    ...
    if ( (int)v8 >= 2 )
    {
      ...
      do
      {
        Next = (ServantStatusBattleListViewItem_o *)BattleRandom__getNext(v8, 0LL);
        max_length = v9->max_length;
        if ( (unsigned int)Next >= max_length )
          goto LABEL_15;
        v16 = &v9->obj.klass + (int)Next;
        v18 = (ServantStatusBattleListViewItem_c *)v16[4];
        Next = (ServantStatusBattleListViewItem_o *)(v16 + 4);
        v17 = v18;
        LODWORD(v8) = v8 - 1;
        if ( (unsigned int)v8 >= max_length
          || (v19 = &v9->obj.klass + (unsigned int)v8,
              v21 = (ServantStatusBattleListViewItem_c *)v19[4],
              v20 = (ServantStatusBattleListViewItem_o *)(v19 + 4),
              Next->klass = v21,
              sub_1BAB3C0(Next, (int32_t)v21, v13, v14),
...
LABEL_15:
        ...
        v20->klass = v17;
        sub_1BAB3C0(v20, (int32_t)v17, v22, v23);
        --v10;
      }
      while ( v10 > 2 );
    }
  ...
  {
    sub_1BAB938(v5);
    return (System_Object_array *)BattleRandom__getShuffle___Il2CppFullySharedGenericType_(v25, v26);
  }
}
...
void __fastcall BattleRandom__setSeed(int32_t seed, const MethodInfo *method)
{
  ...
  {
    sub_1BAB41C(&UnityEngine_Object_TypeInfo, method);
    sub_1BAB41C(&System_Random_TypeInfo, v4);
    sub_1BAB41C(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v5);
    byte_4AB83D5 = 1;
  }
  ...
  {
    v9 = (System_Random_o *)sub_1BAB668(System_Random_TypeInfo);
    System_Random___ctor_62929036(v9, seed, 0LL);
    if ( !v8 )
      sub_1BAB678(v10, v11);
    *(_QWORD *)(v8 + 32) = v9;
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)(v8 + 32), (int32_t)v9, v12, v13);
    v14 = (System_Random_o *)sub_1BAB668(System_Random_TypeInfo);
    System_Random___ctor_62929036(v14, seed, 0LL);
    *(_QWORD *)(v8 + 40) = v14;
    v15 = (ServantStatusBattleListViewItem_o *)(v8 + 40);
    sub_1BAB3C0(v15, (int32_t)v14, v16, v17);
    v15->monitor = 0LL;
  }
}