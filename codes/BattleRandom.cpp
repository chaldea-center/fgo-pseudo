void BattleRandom___ctor(BattleRandom_o *this, const MethodInfo *method)
{
  if ( (byte_4C598F7 & 1) == 0 )
  {
    sub_1C3E564(&Method_SingletonMonoBehaviour_BattleRandom___ctor__);
    byte_4C598F7 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_39FFA90 *)Method_SingletonMonoBehaviour_BattleRandom___ctor__);
}
...
int32_t BattleRandom__GetGutsCount(const MethodInfo *method)
{
  ...
  if ( (byte_4C598F6 & 1) == 0 )
  {
    ...
    sub_1C3E564(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__);
    byte_4C598F6 = 1;
  }
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *BattleRandom__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_30EABB4 *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_30EABB4_RGCTXs *rgctx_data; // x8
  ...
  v31 = (char *)&v29 - ((actualSize + 15) & 0x1FFFFFFF0LL);
  v7 = v31;
  v33 = v31;
  v8 = (Il2CppClass *)memset(v31, 0, actualSize);
  if ( !list )
    goto LABEL_23;
  ...
  {
    v8 = (Il2CppClass *)sub_1C8EC78(v10);
    _0_T = v8;
  }
  v29 = StatusReg;
  if ( !v11 )
LABEL_23:
  ...
  if ( (int)v14 >= 2 )
  {
    ...
    v30 = (char *)&v29 - ((actualSize + 15) & 0x1FFFFFFF0LL);
    do
    {
      v32 = v16;
      v17 = v7;
      ...
      LODWORD(v14) = v14 - 1;
      memcpy(v31, (char *)v15->m_Items + native_size * (int)Next, actualSize);
      Next = (__int64)memcpy(v33, v21, actualSize);
      if ( (unsigned int)v14 >= max_length )
        goto LABEL_22;
      v7 = v17;
      Next = (__int64)memcpy(v17, (char *)v15->m_Items + native_size * (unsigned int)v14, actualSize);
      if ( (unsigned int)v22 >= LODWORD(v15->max_length) )
        goto LABEL_22;
      memcpy((char *)v15->m_Items + (unsigned int)v15->obj.klass->_2.native_size * v22, v17, actualSize);
      Next = (__int64)method->rgctx_data->_1_T;
      if ( (*(_BYTE *)(Next + 309) & 1) == 0 )
        Next = sub_1C8EC78(v24);
      v25 = v30;
      if ( (unsigned int)v22 >= LODWORD(v15->max_length) )
        goto LABEL_22;
      sub_1C3E50C(Next, (char *)v15->m_Items + (unsigned int)v15->obj.klass->_2.native_size * v22, v7);
      Next = (__int64)memcpy(v25, v33, actualSize);
      v26 = v15->max_length;
...
System_Int32_array *BattleRandom__getShuffle_int_(System_Int32_array *list, const MethodInfo_30EA9C0 *method)
{
  ...
  const MethodInfo_30EAAA8 *v19; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Int32_array *)sub_1C8ECD4(method);
  if ( !v3 )
    goto LABEL_15;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Int32_array *)sub_1C8EC78(v4);
    _0_T = list;
  }
  if ( !v5 )
LABEL_15:
    sub_1C3E7C0(list, method);
  v7 = sub_1C3E6A0(v5, _0_T);
  if ( v7 )
  {
    v8 = *(_QWORD *)(v7 + 24);
    v9 = v7;
    if ( (int)v8 >= 2 )
    {
      ...
      do
      {
        ...
        v13 = *(_DWORD *)(v9 + 24);
        if ( (unsigned int)Next >= v13 || (LODWORD(v8) = v8 - 1, (unsigned int)v8 >= v13) )
          sub_1C3E7C8(Next, v12);
        v14 = v9 + 4LL * (int)Next;
        v15 = v9 + 4LL * (unsigned int)v8;
        v16 = *(_DWORD *)(v14 + 32);
        --v10;
...
System_Object_array *BattleRandom__getShuffle_object_(System_Object_array *list, const MethodInfo_30EAAA8 *method)
{
  System_Array_o *v3; // x20
  long double v4; // q0
  ...
  const MethodInfo_30EABB4 *v26; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Object_array *)sub_1C8ECD4(method);
  if ( !v3 )
    goto LABEL_16;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Object_array *)sub_1C8EC78(v4);
    _0_T = list;
  }
  if ( !v5 )
LABEL_16:
      ...
      do
      {
        ...
        if ( (unsigned int)v8 >= v15
          || (v19 = v9 + 8LL * (unsigned int)v8,
              ...
              Next->klass = v21,
              sub_1C3E508(Next, (int32_t)v21, v13, v14),
...
LABEL_15:
        ...
        v20->klass = v17;
        sub_1C3E508(v20, (int32_t)v17, v22, v23);
        --v10;
      }
      while ( v10 > 2 );
    }
...
void BattleRandom__setSeed(int32_t seed, const MethodInfo *method)
{
  ...
  {
    v7 = (System_Random_o *)sub_1C3E7B0(System_Random_TypeInfo);
    System_Random___ctor_65224828(v7, seed, 0);
    if ( !v6 )
      sub_1C3E7C0(v8, v9);
    *(_QWORD *)(v6 + 32) = v7;
    sub_1C3E508((CGThumbnailListItem_o *)(v6 + 32), (int32_t)v7, v10, v11);
    v12 = (System_Random_o *)sub_1C3E7B0(System_Random_TypeInfo);
    System_Random___ctor_65224828(v12, seed, 0);
    *(_QWORD *)(v6 + 40) = v12;
