void __fastcall BattleRandom___ctor(BattleRandom_o *this, const MethodInfo *method)
{
  if ( (byte_4A50D77 & 1) == 0 )
  {
    sub_1B863B8(&Method_SingletonMonoBehaviour_BattleRandom___ctor__, method);
    byte_4A50D77 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_3839A98 *)Method_SingletonMonoBehaviour_BattleRandom___ctor__);
}
...
int32_t __fastcall BattleRandom__GetGutsCount(const MethodInfo *method)
{
  ...
  if ( (byte_4A50D76 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v3);
    byte_4A50D76 = 1;
  }
...
void __fastcall BattleRandom__SetCount(int32_t logic, int32_t guts, const MethodInfo *method)
{
  ...
  if ( (byte_4A50D74 & 1) == 0 )
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, *(_QWORD *)&guts);
    sub_1B863B8(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v6);
    byte_4A50D74 = 1;
  }
...
int32_t __fastcall BattleRandom__getGutsNext(int32_t max, const MethodInfo *method)
{
  ...
  if ( (byte_4A50D72 & 1) == 0 )
  {
    ...
    sub_1B863B8(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v4);
    byte_4A50D72 = 1;
  }
...
Unity_IL2CPP_Metadata___Il2CppFullySharedGenericType_array *__fastcall BattleRandom__getShuffle___Il2CppFullySharedGenericType_(
        ...
        const MethodInfo_2F5F134 *method)
{
  unsigned __int64 StatusReg; // x19
  const MethodInfo_2F5F134_RGCTXs *rgctx_data; // x8
  ...
  {
    v8 = (Il2CppClass *)sub_1BD6A48(v10);
    _0_T = v8;
  }
  v29 = StatusReg;
  if ( !v11 )
  ...
  if ( (int)v14 >= 2 )
  {
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(Next + 309) & 1) == 0 )
        Next = sub_1BD6A48(v24);
      v25 = v30;
      if ( (unsigned int)v22 >= v15->max_length )
        goto LABEL_22;
      sub_1B86360(Next, (char *)v15->m_Items + v15->obj.klass->_2.thread_static_fields_size * v22, v7);
      ...
      if ( (*(_BYTE *)(Next + 309) & 1) == 0 )
      {
        Next = sub_1BD6A48(v27);
        v26 = v15->max_length;
      }
      if ( (unsigned int)v14 >= v26 )
LABEL_22:
        sub_1B8661C(Next, v19);
      sub_1B86360(
        Next,
        (char *)v15->m_Items + v15->obj.klass->_2.thread_static_fields_size * (unsigned __int64)(unsigned int)v14,
        v25);
...
System_Int32_array *__fastcall BattleRandom__getShuffle_int_(
        ...
        const MethodInfo_2F5EF40 *method)
{
  ...
  const MethodInfo_2F5F028 *v19; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Int32_array *)sub_1BD6AA4(method);
  if ( !v3 )
    goto LABEL_15;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Int32_array *)sub_1BD6A48(v4);
    _0_T = list;
  }
  if ( !v5 )
LABEL_15:
    sub_1B86614(list, method);
  v7 = sub_1B864F4(v5, _0_T);
  if ( v7 )
  {
    v8 = *(_QWORD *)(v7 + 24);
...
System_Object_array *__fastcall BattleRandom__getShuffle_object_(
        ...
        const MethodInfo_2F5F028 *method)
{
  System_Array_o *v3; // x20
  long double v4; // q0
  ...
  const MethodInfo_2F5F134 *v26; // x1

  v3 = (System_Array_o *)list;
  if ( !method->rgctx_data )
    list = (System_Object_array *)sub_1BD6AA4(method);
  if ( !v3 )
    goto LABEL_16;
  ...
  if ( (_0_T[309] & 1) == 0 )
  {
    list = (System_Object_array *)sub_1BD6A48(v4);
    _0_T = list;
  }
  if ( !v5 )
LABEL_16:
      ...
      do
      {
        ...
        if ( (unsigned int)v8 >= max_length
          || (v19 = &v9->obj.klass + (unsigned int)v8,
              ...
              Next->klass = v21,
              sub_1B8635C(Next, (int32_t)v21, v13, v14),
...
LABEL_15:
        ...
        v20->klass = v17;
        sub_1B8635C(v20, (int32_t)v17, v22, v23);
        --v10;
      }
      while ( v10 > 2 );
    }
...
void __fastcall BattleRandom__setSeed(int32_t seed, const MethodInfo *method)
{
  ...
  {
    sub_1B863B8(&UnityEngine_Object_TypeInfo, method);
    sub_1B863B8(&System_Random_TypeInfo, v4);
    sub_1B863B8(&Method_SingletonMonoBehaviour_BattleRandom__getInstance__, v5);
    byte_4A50D6F = 1;
  }
  ...
  {
    v9 = (System_Random_o *)sub_1B86604(System_Random_TypeInfo);
    System_Random___ctor_63237892(v9, seed, 0LL);
    if ( !v8 )
      sub_1B86614(v10, v11);
    *(_QWORD *)(v8 + 32) = v9;
    sub_1B8635C((CGThumbnailListItem_o *)(v8 + 32), (int32_t)v9, v12, v13);
    v14 = (System_Random_o *)sub_1B86604(System_Random_TypeInfo);
    System_Random___ctor_63237892(v14, seed, 0LL);
    *(_QWORD *)(v8 + 40) = v14;
    v15 = (CGThumbnailListItem_o *)(v8 + 40);
    sub_1B8635C(v15, (int32_t)v14, v16, v17);
    v15->monitor = 0LL;
  }
}