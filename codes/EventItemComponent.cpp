void __fastcall EventItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B43E95 & 1) == 0 )
  {
    sub_1BDB878(&EventItemComponent_TypeInfo, v1);
    sub_1BDB878(&StringLiteral_20581/*"img_shopbg04"*/, v4);
    byte_4B43E95 = 1;
  }
  EventItemComponent_TypeInfo->static_fields->BASE_SPRITE_DEFAULT_NAME = (struct System_String_o *)StringLiteral_20581/*"img_shopbg04"*/;
  sub_1BDB81C((CGThumbnailListItem_o *)EventItemComponent_TypeInfo->static_fields, StringLiteral_20581/*"img_shopbg04"*/, v2, v3);
}
...
void __fastcall EventItemComponent__Awake(EventItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B43E8A & 1) == 0 )
  {
    sub_1BDB878(&EventItemComponent_TypeInfo, method);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v3);
    sub_1BDB878(&Method_UnityEngine_Resources_Load_UIAtlas___, v4);
    sub_1BDB878(&StringLiteral_12812/*"Shop/Atlas/ShopAtlas"*/, v5);
    byte_4B43E8A = 1;
  }
  ...
  if ( ((unsigned __int8)object & 1) != 0 )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mAtlas, 0LL, 0LL) )
    {
      ...
      object = (UIAtlas_o *)UnityEngine_Resources__Load_object_(
                              (System_String_o *)StringLiteral_12812/*"Shop/Atlas/ShopAtlas"*/,
...
void __fastcall EventItemComponent__Set(EventItemComponent_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4B43E8D & 1) == 0 )
  {
    sub_1BDB878(&BalanceConfig_TypeInfo, *(_QWORD *)&itemId);
  ...
  baseObject = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !baseObject )
    goto LABEL_55;
  ...
  if ( !ItemMaster__isFriendPoint(v11, itemId, 0LL) )
  {
    ...
    if ( baseObject )
    {
      ...
      if ( !byte_4B3ED56 )
      {
        sub_1BDB878(&NetworkManager_TypeInfo, *(_QWORD *)&itemId);
        byte_4B3ED56 = 1;
      }
      ...
      if ( MasterData_object )
      {
        ...
        if ( baseObject )
        {
          ...
          if ( v23 >= v25->UserEventItemMax )
          {
            ...
            p_UserEventItemMax = &v25->UserEventItemMax;
          }
          v16 = *p_UserEventItemMax;
          goto LABEL_51;
        }
      }
    }
LABEL_55:
    sub_1BDBAD4(baseObject, *(_QWORD *)&itemId);
  }
  baseObject = (char *)UserGameMaster__getSelfUserGame(0LL);
  if ( !baseObject )
    goto LABEL_55;
...
LABEL_51:
  ...
  baseObject = (char *)LocalizationManager__GetNumberFormatLong(v16, 0LL);
  if ( !dataLabel )
    goto LABEL_55;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E91 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_EventMissionMaster___, *(_QWORD *)&eventId);
  ...
  else
  {
    ...
    if ( !baseObject )
      goto LABEL_21;
    UnityEngine_GameObject__SetActive(baseObject, 1, 0LL);
    baseObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !baseObject )
      goto LABEL_21;
    MasterData_object = DataManager__GetMasterData_object_(
                          (DataManager_o *)baseObject,
    ...
    if ( !baseObject
      ...
      || (v11 = (System_String_o *)baseObject,
          ...
          baseObject = (UnityEngine_GameObject_o *)System_String__Concat_62610508(
                                                     v11,
    ...
    {
LABEL_21:
      sub_1BDBAD4(baseObject, *(_QWORD *)&eventId);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E8E & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_DataManager_GetMasterData_UserEventPointMaster___, v5);
    sub_1BDB878(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__, v6);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
    sub_1BDB878(&NetworkManager_TypeInfo, v8);
    sub_1BDB878(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9);
    sub_1BDB878(&StringLiteral_19152/*"eventId"*/, v10);
    sub_1BDB878(&StringLiteral_19151/*"eventGroupId"*/, v11);
    byte_4B43E8E = 1;
  }
  entity = 0LL;
         ...
         (const MethodInfo_32E1E88 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    if ( entity )
    {
      ...
      {
        v13 = (int)baseObject;
        Script = ItemEntity__getScript((ItemEntity_o *)entity, (System_String_o *)StringLiteral_19151/*"eventGroupId"*/, 0, 0LL);
        baseObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3916288 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( baseObject )
        {
          MasterData_object = DataManager__GetMasterData_object_(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E93 & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, *(_QWORD *)&num);
    byte_4B43E93 = 1;
  }
  dataLabel = this->fields.dataLabel;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat_40281376 = LocalizationManager__GetNumberFormat_40281376(v10, 0LL);
  if ( !dataLabel
    || (UILabel__set_text(dataLabel, NumberFormat_40281376, 0LL),
        (NumberFormat_40281376 = (System_String_o *)this->fields.dataLabel) == 0LL) )
  {
    sub_1BDBAD4(NumberFormat_40281376, v12);
  }
  v14.fields.r = r;
  v14.fields.g = g;
  v14.fields.b = b;
  v14.fields.a = a;
  UIWidget__set_color((UIWidget_o *)NumberFormat_40281376, v14, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E8F & 1) == 0 )
  {
    sub_1BDB878(&LocalizationManager_TypeInfo, *(_QWORD *)&eventId);
    byte_4B43E8F = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E92 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataManager_GetMasterData_UserEventRaidMaster___, *(_QWORD *)&eventId);
    sub_1BDB878(&LocalizationManager_TypeInfo, v7);
  ...
  else
  {
    ...
    baseObject = (UnityEngine_GameObject_o *)DataManager__GetMasterData_object_(
                                               (DataManager_o *)baseObject,
                                               (const MethodInfo_303395C *)Method_DataManager_GetMasterData_UserEventRaidMaster___);
    if ( !baseObject )
      goto LABEL_24;
    v10 = day
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    baseObject = (UnityEngine_GameObject_o *)LocalizationManager__GetNumberFormat_40281376(v12, 0LL);
    if ( !dataLabel )
LABEL_24:
      sub_1BDBAD4(baseObject, *(_QWORD *)&eventId);
    UILabel__set_text(dataLabel, (System_String_o *)baseObject, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B43E94 & 1) == 0 )
  {
    sub_1BDB878(&AtlasManager_TypeInfo, spName);
    byte_4B43E94 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalPosition_35211104(gameObject, x, y, 0LL);
}
