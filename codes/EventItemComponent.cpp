void EventItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4D2BC0F & 1) == 0 )
  {
    sub_1C94098(&EventItemComponent_TypeInfo);
    sub_1C94098(&StringLiteral_20750/*"img_shopbg04"*/);
    byte_4D2BC0F = 1;
  }
  EventItemComponent_TypeInfo->static_fields->BASE_SPRITE_DEFAULT_NAME = (struct System_String_o *)StringLiteral_20750/*"img_shopbg04"*/;
  sub_1C9403C(
    (GrandQuestFolderBoardItem_o *)EventItemComponent_TypeInfo->static_fields,
    StringLiteral_20750/*"img_shopbg04"*/,
    v1,
    v2,
    v3,
    v4,
...
void EventItemComponent__Awake(EventItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D2BC04 & 1) == 0 )
  {
    ...
    sub_1C94098(&StringLiteral_12900/*"Shop/Atlas/ShopAtlas"*/);
    byte_4D2BC04 = 1;
  }
  ...
  if ( ((unsigned __int8)object & 1) != 0 )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mAtlas, 0, 0) )
    {
      ...
      object = (UIAtlas_o *)UnityEngine_Resources__Load_object_(
                              (System_String_o *)StringLiteral_12900/*"Shop/Atlas/ShopAtlas"*/,
...
void EventItemComponent__Set(EventItemComponent_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  baseObject = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !baseObject )
    goto LABEL_55;
...
LABEL_55:
    sub_1C942F0(baseObject, *(_QWORD *)&itemId);
  }
  baseObject = (char *)UserGameMaster__getSelfUserGame(0);
  if ( !baseObject )
    goto LABEL_55;
...
void EventItemComponent__SetDailyMissionEvent(EventItemComponent_o *this, int32_t eventId, const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( !baseObject )
      goto LABEL_21;
    UnityEngine_GameObject__SetActive(baseObject, 1, 0);
    baseObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !baseObject )
      goto LABEL_21;
    MasterData_object = DataManager__GetMasterData_object_(
                          (DataManager_o *)baseObject,
    ...
    if ( !baseObject
      ...
      || (v8 = (System_String_o *)baseObject,
          ...
          baseObject = (UnityEngine_GameObject_o *)System_String__Concat_64456008(
                                                     v8,
    ...
    {
LABEL_21:
      sub_1C942F0(baseObject, *(_QWORD *)&eventId);
    }
...
void EventItemComponent__SetGroupPointEvent(EventItemComponent_o *this, int32_t itemId, const MethodInfo *method)
{
         ...
         (const MethodInfo_345B50C *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    if ( entity )
    {
      ...
      {
        v7 = (int)baseObject;
        Script = ItemEntity__getScript((ItemEntity_o *)entity, (System_String_o *)StringLiteral_19289/*"eventGroupId"*/, 0, 0);
        baseObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3ABA574 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( baseObject )
        {
          MasterData_object = DataManager__GetMasterData_object_(
        ...
        const MethodInfo *method)
{
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat_42032932 = LocalizationManager__GetNumberFormat_42032932(v10, 0);
  if ( !dataLabel
    || (UILabel__set_text(dataLabel, NumberFormat_42032932, 0),
        (NumberFormat_42032932 = (System_String_o *)this->fields.dataLabel) == 0) )
  {
    sub_1C942F0(NumberFormat_42032932, v12);
  }
  v14.fields.r = r;
  v14.fields.g = g;
  v14.fields.b = b;
  v14.fields.a = a;
  UIWidget__set_color((UIWidget_o *)NumberFormat_42032932, v14, 0);
}
        ...
        const MethodInfo *method)
{
  ...
  else
  {
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    baseObject = (UnityEngine_GameObject_o *)LocalizationManager__GetNumberFormat_42032932(v11, 0);
    if ( !dataLabel )
LABEL_24:
      sub_1C942F0(baseObject, *(_QWORD *)&eventId);
    UILabel__set_text(dataLabel, (System_String_o *)baseObject, 0);
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalPosition_36798812(gameObject, x, y, 0);
}
