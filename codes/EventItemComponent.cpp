void __fastcall EventItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A08106 & 1) == 0 )
  {
    sub_1B686D4(&EventItemComponent_TypeInfo, v1);
    sub_1B686D4(&StringLiteral_20391/*"img_shopbg04"*/, v4);
    byte_4A08106 = 1;
  }
  EventItemComponent_TypeInfo->static_fields->BASE_SPRITE_DEFAULT_NAME = (struct System_String_o *)StringLiteral_20391/*"img_shopbg04"*/;
  sub_1B68678(
    (ServantStatusBattleListViewItem_o *)EventItemComponent_TypeInfo->static_fields,
    StringLiteral_20391/*"img_shopbg04"*/,
    v2,
    v3);
}
...
void __fastcall EventItemComponent__Awake(EventItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A080FB & 1) == 0 )
  {
    sub_1B686D4(&EventItemComponent_TypeInfo, method);
    sub_1B686D4(&UnityEngine_Object_TypeInfo, v3);
    sub_1B686D4(&Method_UnityEngine_Resources_Load_UIAtlas___, v4);
    sub_1B686D4(&StringLiteral_12687/*"Shop/Atlas/ShopAtlas"*/, v5);
    byte_4A080FB = 1;
  }
  ...
  if ( ((unsigned __int8)object & 1) != 0 )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mAtlas, 0LL, 0LL) )
    {
      ...
      object = (UIAtlas_o *)UnityEngine_Resources__Load_object_(
                              (System_String_o *)StringLiteral_12687/*"Shop/Atlas/ShopAtlas"*/,
...
void __fastcall EventItemComponent__Set(EventItemComponent_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_4A080FE & 1) == 0 )
  {
    sub_1B686D4(&BalanceConfig_TypeInfo, *(_QWORD *)&itemId);
  ...
  baseObject = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !baseObject )
    goto LABEL_49;
...
LABEL_49:
    sub_1B68930(baseObject, *(_QWORD *)&itemId);
  }
  baseObject = (int64_t)UserGameMaster__getSelfUserGame(0LL);
  if ( !baseObject )
    goto LABEL_49;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08102 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_EventMissionMaster___, *(_QWORD *)&eventId);
  ...
  else
  {
    ...
    if ( !baseObject )
      goto LABEL_21;
    UnityEngine_GameObject__SetActive(baseObject, 1, 0LL);
    baseObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( !baseObject )
      goto LABEL_21;
    MasterData_object = DataManager__GetMasterData_object_(
                          (DataManager_o *)baseObject,
    ...
    if ( !baseObject
      ...
      || (v11 = (System_String_o *)baseObject,
          ...
          baseObject = (UnityEngine_GameObject_o *)System_String__Concat_61430728(
                                                     v11,
    ...
    {
LABEL_21:
      sub_1B68930(baseObject, *(_QWORD *)&eventId);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A080FF & 1) == 0 )
  {
    ...
    sub_1B686D4(&Method_DataManager_GetMasterData_UserEventPointMaster___, v5);
    sub_1B686D4(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__, v6);
    sub_1B686D4(&LocalizationManager_TypeInfo, v7);
    sub_1B686D4(&NetworkManager_TypeInfo, v8);
    sub_1B686D4(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9);
    sub_1B686D4(&StringLiteral_19064/*"eventId"*/, v10);
    sub_1B686D4(&StringLiteral_19063/*"eventGroupId"*/, v11);
    byte_4A080FF = 1;
  }
  entity = 0LL;
         ...
         (const MethodInfo_30E4514 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    if ( entity )
    {
      baseObject = ItemEntity__getScript((ItemEntity_o *)entity, (System_String_o *)StringLiteral_19064/*"eventId"*/, 0, 0LL);
      if ( entity )
      {
        v14 = baseObject;
        Script = ItemEntity__getScript((ItemEntity_o *)entity, (System_String_o *)StringLiteral_19063/*"eventGroupId"*/, 0, 0LL);
        baseObject = (int64_t)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_36F769C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( baseObject )
        {
          MasterData_object = DataManager__GetMasterData_object_(
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *NumberFormat_38142144; // x0
  __int64 v12; // x1
  ...
  if ( (byte_4A08104 & 1) == 0 )
  {
    sub_1B686D4(&LocalizationManager_TypeInfo, *(_QWORD *)&num);
    byte_4A08104 = 1;
  }
  dataLabel = this->fields.dataLabel;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat_38142144 = LocalizationManager__GetNumberFormat_38142144(v10, 0LL);
  if ( !dataLabel
    || (UILabel__set_text(dataLabel, NumberFormat_38142144, 0LL),
        (NumberFormat_38142144 = (System_String_o *)this->fields.dataLabel) == 0LL) )
  {
    sub_1B68930(NumberFormat_38142144, v12);
  }
  v14.fields.r = r;
  v14.fields.g = g;
  v14.fields.b = b;
  v14.fields.a = a;
  UIWidget__set_color((UIWidget_o *)NumberFormat_38142144, v14, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08100 & 1) == 0 )
  {
    sub_1B686D4(&LocalizationManager_TypeInfo, *(_QWORD *)&eventId);
    byte_4A08100 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08103 & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_UserEventRaidMaster___, *(_QWORD *)&eventId);
    sub_1B686D4(&LocalizationManager_TypeInfo, v7);
  ...
  else
  {
    ...
    baseObject = (UnityEngine_GameObject_o *)DataManager__GetMasterData_object_(
                                               (DataManager_o *)baseObject,
                                               (const MethodInfo_2E49D50 *)Method_DataManager_GetMasterData_UserEventRaidMaster___);
    if ( !baseObject )
      goto LABEL_24;
    v11 = day
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    baseObject = (UnityEngine_GameObject_o *)LocalizationManager__GetNumberFormat_38142144(v13, 0LL);
    if ( !dataLabel )
LABEL_24:
      sub_1B68930(baseObject, *(_QWORD *)&eventId);
    UILabel__set_text(dataLabel, (System_String_o *)baseObject, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08105 & 1) == 0 )
  {
    sub_1B686D4(&AtlasManager_TypeInfo, spName);
    byte_4A08105 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalPosition_33415392(gameObject, x, y, 0LL);
}
