void __fastcall EventItemComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BA2C2 & 1) == 0 )
  {
    sub_1B4CF90(&EventItemComponent_TypeInfo, v1);
    sub_1B4CF90(&StringLiteral_20171/*"img_shopbg04"*/, v4);
    byte_49BA2C2 = 1;
  }
  EventItemComponent_TypeInfo->static_fields->BASE_SPRITE_DEFAULT_NAME = (struct System_String_o *)StringLiteral_20171/*"img_shopbg04"*/;
  sub_1B4CF34((CGThumbnailListItem_o *)EventItemComponent_TypeInfo->static_fields, StringLiteral_20171/*"img_shopbg04"*/, v2, v3);
}
...
void __fastcall EventItemComponent__Awake(EventItemComponent_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BA2B7 & 1) == 0 )
  {
    sub_1B4CF90(&EventItemComponent_TypeInfo, method);
    sub_1B4CF90(&UnityEngine_Object_TypeInfo, v3);
    sub_1B4CF90(&Method_UnityEngine_Resources_Load_UIAtlas___, v4);
    sub_1B4CF90(&StringLiteral_12551/*"Shop/Atlas/ShopAtlas"*/, v5);
    byte_49BA2B7 = 1;
  }
  ...
  if ( ((unsigned __int8)object & 1) != 0 )
  {
    ...
    if ( UnityEngine_Object__op_Equality(mAtlas, 0LL, 0LL) )
    {
      ...
      object = (UIAtlas_o *)UnityEngine_Resources__Load_object_(
                              (System_String_o *)StringLiteral_12551/*"Shop/Atlas/ShopAtlas"*/,
...
void __fastcall EventItemComponent__Set(EventItemComponent_o *this, int32_t itemId, const MethodInfo *method)
{
  ...
  if ( (byte_49BA2BA & 1) == 0 )
  {
    sub_1B4CF90(&BalanceConfig_TypeInfo, *(_QWORD *)&itemId);
  ...
  baseObject = (char *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !baseObject )
    goto LABEL_53;
  ...
  if ( !ItemMaster__isFriendPoint(v11, itemId, 0LL) )
  {
    ...
    if ( baseObject )
    {
      ...
      if ( !byte_49B57A5 )
      {
        sub_1B4CF90(&NetworkManager_TypeInfo, *(_QWORD *)&itemId);
        byte_49B57A5 = 1;
      }
...
LABEL_53:
    sub_1B4D1EC(baseObject, *(_QWORD *)&itemId);
  }
  baseObject = (char *)UserGameMaster__getSelfUserGame(0LL);
  if ( !baseObject )
    goto LABEL_53;
  ...
  else
  {
    ...
    if ( !baseObject
      ...
      || (v11 = (System_String_o *)baseObject,
          ...
          baseObject = (UnityEngine_GameObject_o *)System_String__Concat_61131716(
                                                     v11,
    ...
    {
LABEL_21:
      sub_1B4D1EC(baseObject, *(_QWORD *)&eventId);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA2BB & 1) == 0 )
  {
    ...
    sub_1B4CF90(&Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__, v6);
    sub_1B4CF90(&LocalizationManager_TypeInfo, v7);
    sub_1B4CF90(&NetworkManager_TypeInfo, v8);
    sub_1B4CF90(&Method_SingletonMonoBehaviour_DataManager__get_Instance__, v9);
    sub_1B4CF90(&StringLiteral_18824/*"eventId"*/, v10);
    sub_1B4CF90(&StringLiteral_18823/*"eventGroupId"*/, v11);
    byte_49BA2BB = 1;
  }
  entity = 0LL;
         ...
         (const MethodInfo_319D9E8 *)Method_DataMasterBase_ItemMaster__ItemEntity__int__TryGetEntity__) )
  {
    ...
    if ( entity )
    {
      ...
      {
        v13 = (int)baseObject;
        Script = ItemEntity__getScript((ItemEntity_o *)entity, (System_String_o *)StringLiteral_18823/*"eventGroupId"*/, 0, 0LL);
        baseObject = (UnityEngine_GameObject_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
        if ( baseObject )
        {
          MasterData_object = DataManager__GetMasterData_object_(
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *NumberFormat_38939144; // x0
  __int64 v12; // x1
  ...
  if ( (byte_49BA2C0 & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, *(_QWORD *)&num);
    byte_49BA2C0 = 1;
  }
  dataLabel = this->fields.dataLabel;
  ...
  if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
    j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
  NumberFormat_38939144 = LocalizationManager__GetNumberFormat_38939144(v10, 0LL);
  if ( !dataLabel
    || (UILabel__set_text(dataLabel, NumberFormat_38939144, 0LL),
        (NumberFormat_38939144 = (System_String_o *)this->fields.dataLabel) == 0LL) )
  {
    sub_1B4D1EC(NumberFormat_38939144, v12);
  }
  v14.fields.r = r;
  v14.fields.g = g;
  v14.fields.b = b;
  v14.fields.a = a;
  UIWidget__set_color((UIWidget_o *)NumberFormat_38939144, v14, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA2BC & 1) == 0 )
  {
    sub_1B4CF90(&LocalizationManager_TypeInfo, *(_QWORD *)&eventId);
    byte_49BA2BC = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BA2BF & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataManager_GetMasterData_UserEventRaidMaster___, *(_QWORD *)&eventId);
    sub_1B4CF90(&LocalizationManager_TypeInfo, v7);
  ...
  else
  {
    ...
    baseObject = (UnityEngine_GameObject_o *)DataManager__GetMasterData_object_(
                                               (DataManager_o *)baseObject,
                                               (const MethodInfo_2F01B24 *)Method_DataManager_GetMasterData_UserEventRaidMaster___);
    if ( !baseObject )
      goto LABEL_24;
    v10 = day
    ...
    if ( !LocalizationManager_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(LocalizationManager_TypeInfo);
    baseObject = (UnityEngine_GameObject_o *)LocalizationManager__GetNumberFormat_38939144(v12, 0LL);
    if ( !dataLabel )
LABEL_24:
      sub_1B4D1EC(baseObject, *(_QWORD *)&eventId);
    UILabel__set_text(dataLabel, (System_String_o *)baseObject, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  GameObjectExtensions__SetLocalPosition_34069556(gameObject, x, y, 0LL);
}
