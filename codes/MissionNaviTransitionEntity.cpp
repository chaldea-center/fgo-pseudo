        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D2CD88 & 1) == 0 )
  {
    sub_1C94098(&StringLiteral_21608/*"mainquest"*/);
  ...
  *challengeIconName = (System_String_o *)StringLiteral_1/*""*/;
  ...
  if ( this->fields.missionTransitionType == 2
    && System_String__op_Equality(this->fields.transitionParam, (System_String_o *)StringLiteral_8551/*"MAIN_SCENARIO"*/, 0) )
  {
    *challengeIconName = (System_String_o *)StringLiteral_21608/*"mainquest"*/;
    LODWORD(iconName) = StringLiteral_21608/*"mainquest"*/;
  }
  else
  {
