        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E885 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_21082/*"mainquest"*/, challengeIconName);
    sub_1B863B8(&StringLiteral_115/*" "*/, v6);
    sub_1B863B8(&StringLiteral_8378/*"MAIN_SCENARIO"*/, v7);
  ...
  *challengeIconName = (System_String_o *)StringLiteral_1/*""*/;
  ...
  if ( this->fields.missionTransitionType == 2
    && System_String__op_Equality(this->fields.transitionParam, (System_String_o *)StringLiteral_8378/*"MAIN_SCENARIO"*/, 0LL) )
  {
    *challengeIconName = (System_String_o *)StringLiteral_21082/*"mainquest"*/;
    LODWORD(iconName) = StringLiteral_21082/*"mainquest"*/;
  }
  else
  {
  ...
  sub_1B8635C((CGThumbnailListItem_o *)challengeIconName, (int32_t)iconName, v9, v10);
  return 1;
}
