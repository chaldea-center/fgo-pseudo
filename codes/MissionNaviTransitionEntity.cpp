        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E04F4D & 1) == 0 )
  {
    sub_1CE6700(&StringLiteral_21738/*"mainquest"*/);
  ...
  *challengeIconName = (System_String_o *)StringLiteral_1/*""*/;
  ...
  if ( this->fields.missionTransitionType == 2
    && System_String__op_Equality(this->fields.transitionParam, (System_String_o *)StringLiteral_8596/*"MAIN_SCENARIO"*/, 0) )
  {
    *challengeIconName = (System_String_o *)StringLiteral_21738/*"mainquest"*/;
    LODWORD(iconName) = StringLiteral_21738/*"mainquest"*/;
  }
  else
  {
