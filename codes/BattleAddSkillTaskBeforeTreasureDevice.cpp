        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E07AD0 & 1) == 0 )
  {
    ...
    sub_1CE6700(&CreateTreasureDeviceBeforeSkillTask_TypeInfo);
    byte_4E07AD0 = 1;
  }
  v2 = (CreateSkillTaskFromBuffAction_array *)sub_1CE67A8(CreateSkillTaskFromBuffAction___TypeInfo, 2);
  ...
  v12 = (Il2CppObject *)sub_1CE694C(CreateTreasureDeviceBeforeSkillTask_TypeInfo);
  System_Object___ctor(v12, 0);
  if ( v12 )
  {
    v4 = sub_1CE683C(v12, v2->obj.klass->_1.element_class);
    if ( !v4 )
    {
LABEL_12:
      v20 = sub_1CE697C(v4);
...
LABEL_11:
  ...
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&v2->m_Items[1], (int32_t)v12, v13, v14, v15, v16, v17, v18);
  return v2;
}
