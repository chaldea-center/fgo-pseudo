...
bool DebugSignupMenu__CloseTakeoverInput(DebugSignupMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_10:
    sub_1C372B4(takeoverLineInput1);
  }
...
void DebugSignupMenu__OnClickInputTakeover(DebugSignupMenu_o *this, const MethodInfo *method)
{
  ...
  if ( !myFSM )
    sub_1C372B4(0);
  PlayMakerFSM__SendEvent(myFSM, (System_String_o *)StringLiteral_13333/*"TAKEOVER_INPUT_OK"*/, 0);
}
...
bool DebugSignupMenu__Open(DebugSignupMenu_o *this, PlayMakerFSM_o *fsm, const MethodInfo *method)
{
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.myFSM, (int32_t)fsm, (int32_t)method, v3);
...
bool DebugSignupMenu__OpenTakeoverInput(DebugSignupMenu_o *this, const MethodInfo *method)
{
  ...
  {
LABEL_12:
    sub_1C372B4(takeoverRootObject);
  }
...
void DebugSignupMenu__RequestSignup(DebugSignupMenu_o *this, PlayMakerFSM_o *fsm, const MethodInfo *method)
{
  ...
  if ( (byte_4C40469 & 1) == 0 )
  {
    sub_1C37058(&Method_DebugSignupMenu_callbackTopSignup__);
    sub_1C37058(&ManagerConfig_TypeInfo);
...
void DebugSignupMenu__SetupTakeover(DebugSignupMenu_o *this, PlayMakerFSM_o *fsm, const MethodInfo *method)
{
  ...
  if ( (byte_4C4046B & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_12017/*"SETUP_OK"*/);
    byte_4C4046B = 1;
  }
  this->fields.myFSM = fsm;
  p_myFSM = &this->fields.myFSM;
  ...
  takeoverLineInput1 = (UILineInput_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
  if ( !takeoverLineInput1 )
    goto LABEL_37;
  if ( !byte_4C4052D )
  {
  ...
  takeoverLineInput1 = (UILineInput_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_39ED16C *)Method_SingletonMonoBehaviour_NetworkManager__get_Instance__);
  if ( !takeoverLineInput1 )
    goto LABEL_37;
...
LABEL_37:
    sub_1C372B4(takeoverLineInput1);
  PlayMakerFSM__SendEvent((PlayMakerFSM_o *)takeoverLineInput1, (System_String_o *)StringLiteral_12017/*"SETUP_OK"*/, 0);
}
