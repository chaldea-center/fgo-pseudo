        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B697AA & 1) == 0 )
  {
    sub_1BE4ACC(&CreateSkillTaskFromBuffAction___TypeInfo, method);
    sub_1BE4ACC(&ForceCreateComboStartSkillTask_TypeInfo, v2);
    byte_4B697AA = 1;
  }
  v3 = (CreateSkillTaskFromBuffAction_array *)sub_1BE4B74(CreateSkillTaskFromBuffAction___TypeInfo, 1LL);
  v4 = (Il2CppObject *)sub_1BE4D18(ForceCreateComboStartSkillTask_TypeInfo);
