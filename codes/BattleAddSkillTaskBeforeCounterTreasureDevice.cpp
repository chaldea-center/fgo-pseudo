        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B4789F & 1) == 0 )
  {
    sub_1BDB878(&CreateSkillTaskFromBuffAction___TypeInfo, method);
    sub_1BDB878(&ForceCreateComboStartSkillTask_TypeInfo, v2);
    byte_4B4789F = 1;
  }
  v3 = (CreateSkillTaskFromBuffAction_array *)sub_1BDB920(CreateSkillTaskFromBuffAction___TypeInfo, 1LL);
  v4 = (Il2CppObject *)sub_1BDBAC4(ForceCreateComboStartSkillTask_TypeInfo);
