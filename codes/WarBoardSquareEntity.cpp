        ...
        const MethodInfo *method)
{
  if ( (byte_4B03199 & 1) == 0 )
  {
    sub_1BC3008(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&squareIndex);
    byte_4B03199 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B03198 & 1) == 0 )
  {
    sub_1BC3008(&Method_System_Nullable_Vector3___ctor__, method);
    sub_1BC3008(&Method_System_Nullable_Vector3__get_HasValue__, v4);
    sub_1BC3008(&Method_System_Nullable_Vector3__get_Value__, v5);
    byte_4B03198 = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)&v6 = System_Nullable_Vector3___get_Value(v11, (const MethodInfo_37C479C *)v2);
  result.fields.z = v8;
  result.fields.y = v7;
  result.fields.x = v6;
  return result;
