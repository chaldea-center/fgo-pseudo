        ...
        const MethodInfo *method)
{
  if ( (byte_4BC8B29 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&squareIndex);
    byte_4BC8B29 = 1;
  }
...
UnityEngine_Vector3_o __fastcall WarBoardSquareEntity__GetPosition(
        ...
        const MethodInfo *method)
{
  const MethodInfo_375CF8C *v2; // x2
  __int64 v4; // x1
  __int64 v5; // x1
  float v6; // s0
  float v7; // s1
  ...
  if ( (byte_4BC8B28 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_System_Nullable_Vector3___ctor__, method);
    sub_1C1ABD4(&Method_System_Nullable_Vector3__get_HasValue__, v4);
    sub_1C1ABD4(&Method_System_Nullable_Vector3__get_Value__, v5);
    byte_4BC8B28 = 1;
  }
  ...
  *(UnityEngine_Vector3_o *)&v6 = System_Nullable_Vector3___get_Value(v11, (const MethodInfo_375CFA8 *)v2);
  result.fields.z = v8;
  result.fields.y = v7;
  result.fields.x = v6;
  return result;
