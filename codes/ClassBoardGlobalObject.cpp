void __fastcall ClassBoardGlobalObject___ctor(ClassBoardGlobalObject_o *this, const MethodInfo *method)
{
  if ( (byte_4BB7C64 & 1) == 0 )
  {
    sub_1C13D24(&Method_SingletonTemplate_ClassBoardGlobalObject___ctor__, method);
    byte_4BB7C64 = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_386A8A0 *)Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
}
...
void __fastcall ClassBoardGlobalObject__SetCamera(MapCamera_o *mapCamera, const MethodInfo *method)
{
  ...
  if ( (byte_4BB7C63 & 1) == 0 )
  {
    sub_1C13D24(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__, method);
    byte_4BB7C63 = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_386A7A8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !Instance )
    sub_1C13F80(0LL, v4);
  Instance[2].klass = (Il2CppClass *)mapCamera;
  sub_1C13CC8((PartyOrganizationUtility_o *)&Instance[2], (int64_t)mapCamera, v5, v6, v7, v8, v9, v10);
}
  ...
  if ( !contents
    ...
    || (IconAtlasManagerUnit_k__BackingField = contents->fields._IconAtlasManagerUnit_k__BackingField,
        ...
        sub_1C13CC8(
          ...
          v9,
          v10),
        (Instance = SingletonTemplate_object___get_Instance((const MethodInfo_386A7A8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__)) == 0LL) )
  {
...
AtlasManagerUnit_o *__fastcall ClassBoardGlobalObject__get_IconAtlasManagerUnit(const MethodInfo *method)
{
  ...
  if ( (byte_4BB7C5F & 1) == 0 )
  {
    sub_1C13D24(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__, v1);
    byte_4BB7C5F = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_386A7A8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !Instance )
