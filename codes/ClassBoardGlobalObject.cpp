void __fastcall ClassBoardGlobalObject___ctor(ClassBoardGlobalObject_o *this, const MethodInfo *method)
{
  if ( (byte_4B1FDF1 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SingletonTemplate_ClassBoardGlobalObject___ctor__, method);
    byte_4B1FDF1 = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_38F8FF0 *)Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
}
...
void __fastcall ClassBoardGlobalObject__SetCamera(MapCamera_o *mapCamera, const MethodInfo *method)
{
  ...
  if ( (byte_4B1FDF0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__, method);
    byte_4B1FDF0 = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !Instance )
    sub_1BCB254(0LL, v4);
  Instance[2].klass = (Il2CppClass *)mapCamera;
  sub_1BCAF9C((CGThumbnailListItem_o *)&Instance[2], (int32_t)mapCamera, v5, v6);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !contents
    ...
    || (IconAtlasManagerUnit_k__BackingField = contents->fields._IconAtlasManagerUnit_k__BackingField,
        ...
        sub_1BCAF9C((CGThumbnailListItem_o *)&Instance[1], (int32_t)IconAtlasManagerUnit_k__BackingField, v5, v6),
        (Instance = SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__)) == 0LL) )
  {
  ...
  sub_1BCAF9C((CGThumbnailListItem_o *)&Instance[1].monitor, (int32_t)BoardUiAtlasManagerUnit_k__BackingField, v8, v9);
}
...
AtlasManagerUnit_o *__fastcall ClassBoardGlobalObject__get_IconAtlasManagerUnit(const MethodInfo *method)
{
  ...
  if ( (byte_4B1FDEC & 1) == 0 )
  {
    sub_1BCAFF8(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__, v1);
    byte_4B1FDEC = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_38F8EF8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !Instance )
