void __fastcall ClassBoardGlobalObject___ctor(ClassBoardGlobalObject_o *this, const MethodInfo *method)
{
  if ( (byte_4B6A142 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonTemplate_ClassBoardGlobalObject___ctor__, method);
    byte_4B6A142 = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_38292E0 *)Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
}
...
void __fastcall ClassBoardGlobalObject__SetCamera(MapCamera_o *mapCamera, const MethodInfo *method)
{
  ...
  if ( (byte_4B6A141 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__, method);
    byte_4B6A141 = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_38291E8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !Instance )
    sub_1BE4D28(0LL, v4);
  Instance[2].klass = (Il2CppClass *)mapCamera;
  sub_1BE4A70((PartyOrganizationUtility_o *)&Instance[2], (int64_t)mapCamera, v5, v6, v7, v8, v9, v10);
}
  ...
  if ( !contents
    ...
    || (IconAtlasManagerUnit_k__BackingField = contents->fields._IconAtlasManagerUnit_k__BackingField,
        ...
        sub_1BE4A70(
          ...
          v9,
          v10),
        (Instance = SingletonTemplate_object___get_Instance((const MethodInfo_38291E8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__)) == 0LL) )
  {
...
AtlasManagerUnit_o *__fastcall ClassBoardGlobalObject__get_IconAtlasManagerUnit(const MethodInfo *method)
{
  ...
  if ( (byte_4B6A13D & 1) == 0 )
  {
    sub_1BE4ACC(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__, v1);
    byte_4B6A13D = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_38291E8 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !Instance )
