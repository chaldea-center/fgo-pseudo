void ClassBoardGlobalObject___ctor(ClassBoardGlobalObject_o *this, const MethodInfo *method)
{
  if ( (byte_4E086C8 & 1) == 0 )
  {
    sub_1CE6700(&Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
    byte_4E086C8 = 1;
  }
  SingletonTemplate_object____ctor(
    (SingletonTemplate_CLASS__o *)this,
    (const MethodInfo_3B5532C *)Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
}
...
void ClassBoardGlobalObject__SetCamera(MapCamera_o *mapCamera, const MethodInfo *method)
{
  ...
  if ( (byte_4E086C7 & 1) == 0 )
  {
    sub_1CE6700(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
    byte_4E086C7 = 1;
  }
  Instance = SingletonTemplate_object___get_Instance((const MethodInfo_3B55234 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !Instance )
    sub_1CE6958(0, v4);
  Instance[2].klass = (Il2CppClass *)mapCamera;
  sub_1CE66A4((GrandQuestFolderBoardItem_o *)&Instance[2], (int32_t)mapCamera, v5, v6, v7, v8, v9, v10);
}
  ...
  if ( !contents
    ...
    || (IconAtlasManagerUnit_k__BackingField = contents->fields._IconAtlasManagerUnit_k__BackingField,
        ...
        sub_1CE66A4(
          ...
          v9,
          v10),
        (Instance = SingletonTemplate_object___get_Instance((const MethodInfo_3B55234 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__)) == 0) )
  {
