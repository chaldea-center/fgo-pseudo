void __fastcall ClassBoardGlobalObject___ctor(ClassBoardGlobalObject_o *this, const MethodInfo *method)
{
  if ( (byte_42B385D & 1) == 0 )
  {
    sub_B52984(&Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
  ...
  SingletonTemplate_clsQuestCheck____ctor(
    ...
    (const MethodInfo_2B7641C *)Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
}
...
void __fastcall ClassBoardGlobalObject__SetCamera(MapCamera_o *mapCamera, const MethodInfo *method)
{
  ...
  if ( (byte_42B385C & 1) == 0 )
  {
    sub_B52984(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
    sub_B52984(&SingletonTemplate_ClassBoardGlobalObject__TypeInfo);
    byte_42B385C = 1;
  }
  if ( (BYTE3(SingletonTemplate_ClassBoardGlobalObject__TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
  ...
  v3 = SingletonTemplate_clsQuestCheck___get_Instance((const MethodInfo_2B76134 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !v3 )
    sub_B52A5C(0LL, v4);
  v3[1].klass = (clsQuestCheck_c *)mapCamera;
  sub_B52920((BattleServantConfConponent_o *)&v3[1], (System_Int32_array **)mapCamera, v5, v6, v7, v8, v9, v10);
}
  ...
  if ( !contents
    ...
    || (IconAtlasManagerUnit_k__BackingField = (System_Int32_array **)contents->fields._IconAtlasManagerUnit_k__BackingField,
        ...
        sub_B52920(
          ...
          v9,
          v10),
        (v3 = SingletonTemplate_clsQuestCheck___get_Instance((const MethodInfo_2B76134 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__)) == 0LL) )
  {
    sub_B52A5C(v3, v4);
  }
...
AtlasManagerUnit_o *__fastcall ClassBoardGlobalObject__get_IconAtlasManagerUnit(const MethodInfo *method)
{
  ...
  v1 = SingletonTemplate_clsQuestCheck___get_Instance((const MethodInfo_2B76134 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !v1 )
    sub_B52A5C(0LL, v2);
