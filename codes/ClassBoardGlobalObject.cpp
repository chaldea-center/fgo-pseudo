void __fastcall ClassBoardGlobalObject___ctor(ClassBoardGlobalObject_o *this, const MethodInfo *method)
{
  if ( (byte_438D3A9 & 1) == 0 )
  {
    sub_B775C4(&Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
  ...
  SingletonTemplate_clsQuestCheck____ctor(
    ...
    (const MethodInfo_2D16BA8 *)Method_SingletonTemplate_ClassBoardGlobalObject___ctor__);
}
...
void __fastcall ClassBoardGlobalObject__SetCamera(MapCamera_o *mapCamera, const MethodInfo *method)
{
  ...
  if ( (byte_438D3A8 & 1) == 0 )
  {
    sub_B775C4(&Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
    sub_B775C4(&SingletonTemplate_ClassBoardGlobalObject__TypeInfo);
    byte_438D3A8 = 1;
  }
  if ( (BYTE3(SingletonTemplate_ClassBoardGlobalObject__TypeInfo->vtable._0_Equals.methodPtr) & 4) != 0
  ...
  v3 = SingletonTemplate_clsQuestCheck___get_Instance((const MethodInfo_2D168C0 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !v3 )
    sub_B7769C(0LL, v4);
  v3[1].klass = (clsQuestCheck_c *)mapCamera;
  sub_B77560((BattleServantConfConponent_o *)&v3[1], (System_Int32_array **)mapCamera, v5, v6, v7, v8, v9, v10);
}
  ...
  if ( !contents
    ...
    || (IconAtlasManagerUnit_k__BackingField = (System_Int32_array **)contents->fields._IconAtlasManagerUnit_k__BackingField,
        ...
        sub_B77560(
          ...
          v9,
          v10),
        (v3 = SingletonTemplate_clsQuestCheck___get_Instance((const MethodInfo_2D168C0 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__)) == 0LL) )
  {
    sub_B7769C(v3, v4);
  }
...
AtlasManagerUnit_o *__fastcall ClassBoardGlobalObject__get_IconAtlasManagerUnit(const MethodInfo *method)
{
  ...
  v1 = SingletonTemplate_clsQuestCheck___get_Instance((const MethodInfo_2D168C0 *)Method_SingletonTemplate_ClassBoardGlobalObject__get_Instance__);
  if ( !v1 )
    sub_B7769C(0LL, v2);
