void UINarrowFigureRender___cctor(const MethodInfo *method)
{
  ...
  *(_OWORD *)&static_fields->TEXTURE_PAGE_SIZE = xmmword_E93960;
  ...
  *(_QWORD *)(v3 + 48) = 1134166016;
  ...
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)&v7->bodyTopTable, (int32_t)Only_Vector2, v8, v9, v10, v11, v12, v13);
...
System_String_o *UINarrowFigureRender__GetAssetName(int32_t svtId, int32_t limitCountStage, const MethodInfo *method)
{
  ...
  if ( (byte_5939FE0 & 1) == 0 )
  {
    ...
    sub_21FFC50(&StringLiteral_9772/*"NarrowFigure/100000"*/);
    sub_21FFC50(&StringLiteral_9773/*"NarrowFigure/{0}"*/);
    byte_5939FE0 = 1;
  }
  ...
  v10 = System_String__Format((System_String_o *)StringLiteral_9773/*"NarrowFigure/{0}"*/, v8, 0);
  if ( !*(&AssetManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(AssetManager_TypeInfo, v9);
  if ( AssetManager__isExistAssetStorage(v10, 0) )
    return v10;
  else
    return (System_String_o *)StringLiteral_9772/*"NarrowFigure/100000"*/;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( !System_String__IsNullOrEmpty(changeSuffix, 0) )
    LastName = System_String__Concat_75438412(LastName, changeSuffix, 0);
  if ( v15 < 1 )
  ...
  v23 = v15 + 1;
  v16 = (Il2CppObject *)j_il2cpp_value_box_0(qword_594C070, &v23);
  v17 = System_String__Format_75484576((System_String_o *)StringLiteral_26544/*"{0}_{1}"*/, (Il2CppObject *)LastName, v16, 0);
  ...
  return (UnityEngine_Texture2D_o *)Object_object__58323140;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( LimitCountUtility__IsCostume(v10, 0) )
  {
    ...
    Master_object = (ServantLimitAddMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_ServantLimitAddMaster___);
    if ( Master_object )
    {
...
LABEL_26:
  ...
  if ( useGroupImage )
    v17 = (System_String_o *)StringLiteral_17191/*"_group"*/;
  else
    v17 = 0;
  imageIndex = LimitCountUtility__ConvertLimitCountStageIndexOneToZero(v10, 0);
  v19 = LimitCountUtility__ConvertStageToLimitCount_47970664(v10, 0);
  if ( !*(&DataManager_TypeInfo->_2.cctor_finished + 1) )
    j_il2cpp_runtime_class_init_0(DataManager_TypeInfo, v18);
  Master_object = (ServantLimitAddMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_ServantLimitMaster___);
  if ( !Master_object )
    goto LABEL_26;
  if ( ServantLimitMaster__TryGetEntity((ServantLimitMaster_o *)Master_object, &entity, v11, v19, 0) )
  {
    ...
    if ( (v20 & 0x80000000) == 0 )
    {
      ...
      Master_object = (ServantLimitAddMaster_o *)DataManager__GetMaster_object_((const MethodInfo_3822E50 *)Method_DataManager_GetMaster_CommonReleaseMaster___);
      if ( !Master_object )
        goto LABEL_26;
...
LABEL_23:
  ...
  *texture2d = BodyTexture;
  sub_21FFBF4((MissionNaviTransitionBoardItem_o *)texture2d, (int32_t)BodyTexture, v23, v24, v25, v26, v27, v28);
