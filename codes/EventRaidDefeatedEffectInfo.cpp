        ...
        const MethodInfo *method)
{
            ...
            (const MethodInfo_28883E4 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__List_int___MoveNext__) )
  {
    ...
    v9 = System_String__Concat_44901936(v8, (System_String_o *)StringLiteral_1252/*":"*/, 0LL);
    if ( !v3 )
      sub_B7769C(v9, v9);
    appended = System_Text_StringBuilder__Append_42951964(v3, v9, 0LL);
    if ( !current.fields.value )
      sub_B7769C(appended, v11);
              ...
              (const MethodInfo_225A1B4 *)Method_System_Collections_Generic_List_Enumerator_int__MoveNext__) )
    {
      ...
      if ( (v12 & 1) != 0 )
        System_Text_StringBuilder__Append_42951964(v3, (System_String_o *)StringLiteral_714/*","*/, 0LL);
      v13 = System_Int32__ToString((int32_t)&v18 + 4, 0LL);
      v12 = 1;
      System_Text_StringBuilder__Append_42951964(v3, v13, 0LL);
    }
    *(_DWORD *)&v17[2 * v6 + 20] = 149;
    ...
    System_Text_StringBuilder__Append_42951964(v3, (System_String_o *)StringLiteral_1289/*";"*/, 0LL);
  }
  *(_DWORD *)&v17[2 * v6 + 20] = 189;
  ...
  if ( !v3 )
LABEL_24:
    sub_B7769C(playedEffectList, v4);
