        ...
        const MethodInfo *method)
{
            ...
            (const MethodInfo_28895A0 *)Method_System_Collections_Generic_Dictionary_Enumerator_int__List_int___MoveNext__) )
  {
    ...
    v9 = System_String__Concat_44568316(v8, (System_String_o *)StringLiteral_1240/*":"*/, 0LL);
    if ( !v3 )
      sub_B52A5C(v9, v9);
    appended = System_Text_StringBuilder__Append_42994048(v3, v9, 0LL);
    if ( !current.fields.value )
      sub_B52A5C(appended, v11);
              ...
              (const MethodInfo_200F3F0 *)Method_System_Collections_Generic_List_Enumerator_int__MoveNext__) )
    {
      ...
      if ( (v12 & 1) != 0 )
        System_Text_StringBuilder__Append_42994048(v3, (System_String_o *)StringLiteral_709/*","*/, 0LL);
      v13 = System_Int32__ToString((int32_t)&v18 + 4, 0LL);
      v12 = 1;
      System_Text_StringBuilder__Append_42994048(v3, v13, 0LL);
    }
    *(_DWORD *)&v17[2 * v6 + 20] = 149;
    ...
    System_Text_StringBuilder__Append_42994048(v3, (System_String_o *)StringLiteral_1277/*";"*/, 0LL);
  }
  *(_DWORD *)&v17[2 * v6 + 20] = 189;
  ...
  if ( !v3 )
LABEL_24:
    sub_B52A5C(playedEffectList, v4);
