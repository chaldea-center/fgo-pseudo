        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0C5 & 1) == 0 )
  {
    this = (BattleServantSuperBossParamComponent_o *)sub_1C32C20(&long_TypeInfo);
    byte_4C3B0C5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3B0C3 & 1) == 0 )
  {
    ...
    sub_1C32C20(&StringLiteral_2887/*"BATTLE_SUPERBOSS_TOTALHP"*/);
    byte_4C3B0C3 = 1;
  }
  ...
  if ( !result )
  {
    ...
    sub_1C32BC4(p_hpformat, (int32_t)v5, v6, v7);
