        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCACB4 & 1) == 0 )
  {
    this = (BattleServantSuperBossParamComponent_o *)sub_1C1ABD4(&long_TypeInfo, svtData);
    byte_4BCACB4 = 1;
  }
  if ( !svtData )
    goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCACB2 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_3031/*"BATTLE_SUPERBOSS_TOTALHP"*/, v3);
    byte_4BCACB2 = 1;
  }
  ...
  if ( !result )
  {
    ...
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_3031/*"BATTLE_SUPERBOSS_TOTALHP"*/, 0LL);
    p_hpformat->klass = (PartyOrganizationUtility_c *)v6;
    sub_1C1AB78(p_hpformat, (int64_t)v6, v7, v8, v9, v10, v11, v12);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCACB3 & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataManager_GetMasterData_EventBossStatusUiMaster___, data);
    sub_1C1ABD4(&Method_DataManager_GetMaster_BattleMaster___, v5);
    sub_1C1ABD4(&DataManager_TypeInfo, v6);
    sub_1C1ABD4(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BCACB6 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_1212/*"0"*/, method);
    byte_4BCACB6 = 1;
  }
  superBosshplabel = this->fields.superBosshplabel;
  if ( !superBosshplabel )
