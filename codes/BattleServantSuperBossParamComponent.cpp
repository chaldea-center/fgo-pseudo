        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FAD8 & 1) == 0 )
  {
    this = (BattleServantSuperBossParamComponent_o *)sub_1BCAFF8(&long_TypeInfo, svtData);
    byte_4B1FAD8 = 1;
  }
  if ( !svtData )
    goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FAD6 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&StringLiteral_2870/*"BATTLE_SUPERBOSS_TOTALHP"*/, v3);
    byte_4B1FAD6 = 1;
  }
  ...
  if ( !result )
  {
    ...
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2870/*"BATTLE_SUPERBOSS_TOTALHP"*/, 0LL);
    p_hpformat->klass = (CGThumbnailListItem_c *)v6;
    sub_1BCAF9C(p_hpformat, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FAD7 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_DataManager_GetMasterData_EventBossStatusUiMaster___, data);
    sub_1BCAFF8(&Method_DataManager_GetMaster_BattleMaster___, v5);
    sub_1BCAFF8(&DataManager_TypeInfo, v6);
    sub_1BCAFF8(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B1FADA & 1) == 0 )
  {
    sub_1BCAFF8(&StringLiteral_1113/*"0"*/, method);
    byte_4B1FADA = 1;
  }
  superBosshplabel = this->fields.superBosshplabel;
  if ( !superBosshplabel )
