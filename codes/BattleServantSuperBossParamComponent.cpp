        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B51 & 1) == 0 )
  {
    this = (BattleServantSuperBossParamComponent_o *)sub_1B64A00(&long_TypeInfo, svtData);
    byte_4A01B51 = 1;
  }
  if ( !svtData )
    goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B4F & 1) == 0 )
  {
    ...
    sub_1B64A00(&StringLiteral_2976/*"BATTLE_SUPERBOSS_TOTALHP"*/, v3);
    byte_4A01B4F = 1;
  }
  ...
  if ( !result )
  {
    ...
    sub_1B649A4(p_hpformat, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B50 & 1) == 0 )
  {
    sub_1B64A00(&Method_DataManager_GetMasterData_EventBossStatusUiMaster___, data);
    sub_1B64A00(&Method_DataManager_GetMaster_BattleMaster___, v5);
    sub_1B64A00(&DataManager_TypeInfo, v6);
    sub_1B64A00(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01B53 & 1) == 0 )
  {
    sub_1B64A00(&StringLiteral_1213/*"0"*/, method);
    byte_4A01B53 = 1;
  }
  superBosshplabel = this->fields.superBosshplabel;
  if ( !superBosshplabel )
