        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BCAB & 1) == 0 )
  {
    this = (BattleServantSuperBossParamComponent_o *)sub_1B686D4(&long_TypeInfo, svtData);
    byte_4A0BCAB = 1;
  }
  if ( !svtData )
    goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BCA9 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_2974/*"BATTLE_SUPERBOSS_TOTALHP"*/, v3);
    byte_4A0BCA9 = 1;
  }
  ...
  if ( !result )
  {
    ...
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2974/*"BATTLE_SUPERBOSS_TOTALHP"*/, 0LL);
    p_hpformat->klass = (ServantStatusBattleListViewItem_c *)v6;
    sub_1B68678(p_hpformat, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BCAA & 1) == 0 )
  {
    sub_1B686D4(&Method_DataManager_GetMasterData_EventBossStatusUiMaster___, data);
    sub_1B686D4(&Method_DataManager_GetMaster_BattleMaster___, v5);
    sub_1B686D4(&DataManager_TypeInfo, v6);
    sub_1B686D4(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0BCAD & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_1212/*"0"*/, method);
    byte_4A0BCAD = 1;
  }
  superBosshplabel = this->fields.superBosshplabel;
  if ( !superBosshplabel )
