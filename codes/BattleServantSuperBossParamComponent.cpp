        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3422C & 1) == 0 )
  {
    this = (BattleServantSuperBossParamComponent_o *)sub_1C93AD4(&long_TypeInfo);
    byte_4D3422C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D3422A & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_2897/*"BATTLE_SUPERBOSS_TOTALHP"*/);
    byte_4D3422A = 1;
  }
  ...
  if ( !result )
  {
    ...
    v5 = LocalizationManager__Get((System_String_o *)StringLiteral_2897/*"BATTLE_SUPERBOSS_TOTALHP"*/, 0);
    p_hpformat->klass = (GrandQuestFolderBoardItem_c *)v5;
    sub_1C93A78(p_hpformat, (int32_t)v5, v6, v7, v8, v9, v10, v11);
        ...
        const MethodInfo *method)
{
  ...
  if ( Master_object )
  {
    ...
    TextEffectColor = EventBossStatusUiEntity__GetTextEffectColor(v10, v22, 0);
    if ( !superBosshplabel )
      goto LABEL_37;
  }
  else
  ...
  Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)UnityEngine_Object__op_Inequality(v17, 0, 0);
  ...
  if ( !Master_object
    ...
    || (UnityEngine_Transform__set_localPosition((UnityEngine_Transform_o *)Master_object, this->fields.shiftTdPos, 0),
        (Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)this->fields.showBuffComponent) == 0)
    || (Master_object = (DataMasterBase_TMaster__TEntity__PKType__o *)UnityEngine_Component__get_transform(
                                                                        (UnityEngine_Component_o *)Master_object,
                                                                        0)) == 0 )
  {
...
LABEL_32:
  ...
  if ( !Master_object )
    goto LABEL_37;
  UnityEngine_GameObject__SetActive((UnityEngine_GameObject_o *)Master_object, !this->fields.isShift, 0);
  BattleServantParamComponent__setData((BattleServantParamComponent_o *)this, battleServantData, stageEntity, v20);
  BattleServantSuperBossParamComponent__updateStateString(this, v21);
}
        ...
        const MethodInfo *method)
{
  ...
  UILabel__set_text(superBosshplabel, (System_String_o *)StringLiteral_1116/*"0"*/, 0);
}
