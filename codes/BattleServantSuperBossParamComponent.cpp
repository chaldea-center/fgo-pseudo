        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01530 & 1) == 0 )
  {
    this = (BattleServantSuperBossParamComponent_o *)sub_1B64870(&long_TypeInfo, svtData);
    byte_4A01530 = 1;
  }
  if ( !svtData )
    goto LABEL_16;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0152E & 1) == 0 )
  {
    ...
    sub_1B64870(&StringLiteral_2975/*"BATTLE_SUPERBOSS_TOTALHP"*/, v3);
    byte_4A0152E = 1;
  }
  ...
  if ( !result )
  {
    ...
    v6 = LocalizationManager__Get((System_String_o *)StringLiteral_2975/*"BATTLE_SUPERBOSS_TOTALHP"*/, 0LL);
    p_hpformat->klass = (ServantStatusBattleListViewItem_c *)v6;
    sub_1B64814(p_hpformat, (int32_t)v6, v7, v8);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0152F & 1) == 0 )
  {
    sub_1B64870(&Method_DataManager_GetMasterData_EventBossStatusUiMaster___, data);
    sub_1B64870(&Method_DataManager_GetMaster_BattleMaster___, v5);
    sub_1B64870(&DataManager_TypeInfo, v6);
    sub_1B64870(&Method_DataMasterBase_BattleMaster__BattleEntity__long__GetSingleEntity__, v7);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A01532 & 1) == 0 )
  {
    sub_1B64870(&StringLiteral_1213/*"0"*/, method);
    byte_4A01532 = 1;
  }
  superBosshplabel = this->fields.superBosshplabel;
  if ( !superBosshplabel )
