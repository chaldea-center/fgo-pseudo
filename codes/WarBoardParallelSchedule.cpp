...
void __fastcall WarBoardParallelSchedule___ctor_36069436(
        WarBoardParallelSchedule_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3C0B & 1) == 0 )
  {
    sub_1BAB41C(&WarBoardParallelSchedule__Execute_d__4_TypeInfo, method);
    byte_4AB3C0B = 1;
  }
  v3 = sub_1BAB668(WarBoardParallelSchedule__Execute_d__4_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB3C0D & 1) == 0 )
  {
    ...
    sub_1BAB41C(&Method_WarBoardParallelSchedule___c__Execute_b__4_0__, v8);
    sub_1BAB41C(&WarBoardParallelSchedule___c_TypeInfo, v9);
    this = (WarBoardParallelSchedule__Execute_d__4_o *)sub_1BAB41C(&WarBoardManager_TypeInfo, v10);
    byte_4AB3C0D = 1;
  }
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)&v29[v28] = 0LL;
        ...
        if ( this )
        {
          ...
          if ( this )
          {
            this = (WarBoardParallelSchedule__Execute_d__4_o *)sub_1BAB558(this, *(_QWORD *)(*(_QWORD *)v31 + 64LL));
            if ( !this )
            {
LABEL_67:
              v64 = sub_1BAB69C(this);
              sub_1BAB544(v64, 0LL);
            }
          }
          if ( v27 >= v31[6] )
...
LABEL_22:
  ...
  if ( !_9__4_0 )
  {
    ...
    _9__4_0 = (System_Func_bool__bool__o *)sub_1BAB668(System_Func_bool__bool__TypeInfo);
    ...
    sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&static_fields->__9__4_0, (int32_t)_9__4_0, v40, v41);
  }
      ...
      if ( !*v47 )
      {
        ...
        if ( v49 )
        {
          ...
          *v47 = ((unsigned __int8)this & 1) == 0;
          ...
          {
LABEL_45:
            p_method = sub_1BFD3FC(v49, System_Collections_IEnumerator_TypeInfo, 1LL);
          }
          ...
          if ( this )
          {
            this = (WarBoardParallelSchedule__Execute_d__4_o *)sub_1BAB558(
                                                                 this,
        ...
        sub_1BAB3C0(v58, (int32_t)v57, v42, v43);
  ...
  sub_1BAB3C0(p__2__current, (int32_t)v62, v42, v43);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BAB430(&Method_WarBoardParallelSchedule__Execute_d__4_System_Collections_IEnumerator_Reset__);
  sub_1BAB544(v3, v4);
}
...
void __fastcall WarBoardParallelSchedule___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB3C0C & 1) == 0 )
  {
    sub_1BAB41C(&WarBoardParallelSchedule___c_TypeInfo, v1);
    byte_4AB3C0C = 1;
  }
  v2 = (Il2CppObject *)sub_1BAB668(WarBoardParallelSchedule___c_TypeInfo);
