void __fastcall EventTowerMaster___ctor(EventTowerMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A6FFF7 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventTowerMaster__EventTowerEntity__string___ctor__, method);
    byte_4A6FFF7 = 1;
  }
  DataMasterBase_object__object__object____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    234,
    (const MethodInfo_312C8C0 *)Method_DataMasterBase_EventTowerMaster__EventTowerEntity__string___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFF8 & 1) == 0 )
  {
    ...
    sub_1B90010(&System_Comparison_EventTowerEntity__TypeInfo, v6);
    sub_1B90010(&EventTowerEntity_TypeInfo, v7);
    sub_1B90010(&Method_System_Collections_Generic_List_EventTowerEntity__Add__, v8);
    sub_1B90010(&Method_System_Collections_Generic_List_EventTowerEntity__Sort__, v9);
    sub_1B90010(&Method_System_Collections_Generic_List_EventTowerEntity__ToArray__, v10);
    sub_1B90010(&Method_System_Collections_Generic_List_EventTowerEntity___ctor__, v11);
    sub_1B90010(&System_Collections_Generic_List_EventTowerEntity__TypeInfo, v12);
    sub_1B90010(&Method_EventTowerMaster___c__GetDatas_b__3_0__, v13);
    sub_1B90010(&EventTowerMaster___c_TypeInfo, v14);
    byte_4A6FFF8 = 1;
  }
  v15 = (System_Collections_Generic_List_object__o *)sub_1B9025C(System_Collections_Generic_List_EventTowerEntity__TypeInfo);
  System_Collections_Generic_List_object____ctor(
    v15,
    (const MethodInfo_351018C *)Method_System_Collections_Generic_List_EventTowerEntity___ctor__);
...
LABEL_17:
  ...
  if ( !v28 )
  {
    ...
    v28 = (System_Comparison_T__o *)sub_1B9025C(System_Comparison_EventTowerEntity__TypeInfo);
  ...
  System_Collections_Generic_List_object___Sort_55649412(
    v15,
    v28,
    (const MethodInfo_3512484 *)Method_System_Collections_Generic_List_EventTowerEntity__Sort__);
  return (EventTowerEntity_array *)System_Collections_Generic_List_object___ToArray(
                                     v15,
                                     (const MethodInfo_3512518 *)Method_System_Collections_Generic_List_EventTowerEntity__ToArray__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFF5 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventTowerMaster__EventTowerEntity__string__GetEntity__, *(_QWORD *)&eventId);
    byte_4A6FFF5 = 1;
  }
  ...
  return (EventTowerEntity_o *)DataMasterBase_object__object__object___GetEntity(
                                 (DataMasterBase_TMaster__TEntity__PKType__o *)this,
                                 PK,
                                 (const MethodInfo_312C900 *)Method_DataMasterBase_EventTowerMaster__EventTowerEntity__string__GetEntity__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFF6 & 1) == 0 )
  {
    sub_1B90010(&Method_DataMasterBase_EventTowerMaster__EventTowerEntity__string__TryGetEntity__, entity);
    byte_4A6FFF6 = 1;
  }
  ...
  return DataMasterBase_object__object__object___TryGetEntity(
           ...
           (Il2CppObject **)entity,
           PK,
           (const MethodInfo_312C950 *)Method_DataMasterBase_EventTowerMaster__EventTowerEntity__string__TryGetEntity__);
}
...
void __fastcall EventTowerMaster___c___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A6FFF9 & 1) == 0 )
  {
    sub_1B90010(&EventTowerMaster___c_TypeInfo, v1);
    byte_4A6FFF9 = 1;
  }
  v2 = (Il2CppObject *)sub_1B9025C(EventTowerMaster___c_TypeInfo);
  System_Object___ctor(v2, 0LL);
  EventTowerMaster___c_TypeInfo->static_fields->__9 = (struct EventTowerMaster___c_o *)v2;
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)EventTowerMaster___c_TypeInfo->static_fields, (int32_t)v2, v3, v4);
}
