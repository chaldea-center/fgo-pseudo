        ...
        const MethodInfo *method)
{
  ...
  sub_B17000(&Method_CommandCardEquipmentControl__PlayReplaceEffect_d__122_System_Collections_IEnumerator_Reset__, v8);
  sub_B170A0();
}
        ...
        const MethodInfo *method)
{
  ...
  System_NotSupportedException___ctor(v7, 0LL);
  sub_B17000(
    &Method_CommandCardEquipmentControl__PlaySelfAttachReplaceEffect_d__123_System_Collections_IEnumerator_Reset__,
    v8);
  sub_B170A0();
}
