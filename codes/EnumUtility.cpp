int32_t EnumUtility__CastToEnum_Int32Enum_(
        ...
        const MethodInfo_31773B8 *method)
{
  ...
  __int64 v14; // x3
  long double v15; // q0
  const MethodInfo_31773B8_RGCTXs *rgctx_data; // x8
  ...
  {
    v12 = (Il2CppObject *)sub_1C51B7C(v15);
    p_image = &v12->klass;
  }
  if ( !v17 )
    sub_1C7BD40(v12, p_image);
        ...
        __int64 a4)
{
  ...
  if ( System_Enum__IsDefined(TypeFromHandle, v12, 0) )
  {
    ...
    if ( !System_Enum_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Enum_TypeInfo);
    v16 = System_Enum__ToObject_65911484(v15, a1, 0);
    v20 = *(_QWORD *)(a4 + 56);
    v21 = v16;
    v22 = *(Il2CppObject **)(v20 + 8);
    if ( (BYTE5(v22[19].klass) & 1) == 0 )
    {
      v16 = (Il2CppObject *)sub_1C51B7C(v19);
      v22 = v16;
    }
    if ( !v21 )
      sub_1C7BD40(v16, v22);
...
void *__fastcall EnumUtility__CastToEnum___Il2CppFullySharedGenericStructType__51869476(
        System_String_o *a1,
        const void *a2,
        void *a3,
        __int64 a4)
