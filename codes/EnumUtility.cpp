...
int32_t __fastcall EnumUtility__CastToEnum_Int32Enum_(
        ...
        const MethodInfo_2FD8C48 *method)
{
  int32_t v4; // w21
  __int64 v6; // x1
  ...
  __int64 v13; // x3
  long double v14; // q0
  const MethodInfo_2FD8C48_RGCTXs *rgctx_data; // x8
  ...
  {
    sub_1C2E12C(&System_Enum_TypeInfo, *(_QWORD *)&defaultValue);
  ...
  {
    v11 = (Il2CppObject *)sub_1C80008(v14);
    p_image = &v11->klass;
  }
  if ( !v16 )
    sub_1C2E388(v11, p_image);
        ...
        __int64 a4)
{
  ...
  if ( !v7 )
  {
    sub_1C2E12C(&System_Enum_TypeInfo, a2);
  ...
  if ( System_Enum__IsDefined(TypeFromHandle, v16, 0LL) )
  {
    ...
    if ( !System_Enum_TypeInfo->_2.cctor_finished )
      j_il2cpp_runtime_class_init_0(System_Enum_TypeInfo);
    v19 = System_Enum__ToObject_64265424(v18, a1, 0LL);
    v23 = *(_QWORD *)(a4 + 56);
    v24 = v19;
    v25 = *(Il2CppObject **)(v23 + 8);
    if ( (BYTE5(v25[19].klass) & 1) == 0 )
    {
      v19 = (Il2CppObject *)sub_1C80008(v22);
      v25 = v19;
    }
    if ( !v24 )
      sub_1C2E388(v19, v25);
...
void *__fastcall EnumUtility__CastToEnum___Il2CppFullySharedGenericStructType__50171828(
        System_String_o *a1,
        const void *a2,
        void *a3,
        __int64 a4)
...
LABEL_19:
  ...
  else
  {
    ...
    {
      v15 = (Il2CppObject *)sub_1C80008(v18);
      v21 = v15;
    }
    if ( !v20 )
      sub_1C2E388(v15, v21);
