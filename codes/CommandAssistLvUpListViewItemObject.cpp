        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E0E & 1) == 0 )
  {
    sub_1BAB41C(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4AB9E0E = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2F13970 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB9E0F & 1) == 0 )
  {
    sub_1BAB41C(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4AB9E0F = 1;
  }
