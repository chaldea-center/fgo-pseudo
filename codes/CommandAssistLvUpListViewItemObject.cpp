        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E66DD & 1) == 0 )
  {
    sub_1B00CCC(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_48E66DD = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2DADE08 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_48E66DE & 1) == 0 )
  {
    sub_1B00CCC(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_48E66DE = 1;
  }
