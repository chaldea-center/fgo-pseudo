        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01ABB & 1) == 0 )
  {
    sub_1C2E12C(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4C01ABB = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_3022B0C *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C01ABC & 1) == 0 )
  {
    sub_1C2E12C(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4C01ABC = 1;
  }
