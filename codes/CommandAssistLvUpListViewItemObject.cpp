        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73EE9 & 1) == 0 )
  {
    sub_1B90010(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4A73EE9 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EDD768 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A73EEA & 1) == 0 )
  {
    sub_1B90010(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4A73EEA = 1;
  }
