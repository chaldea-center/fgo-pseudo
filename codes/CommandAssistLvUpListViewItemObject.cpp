        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA538 & 1) == 0 )
  {
    sub_B16FFC(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_40FA538 = 1;
  }
  ...
  Component_srcLineSprite = (struct CommandAssistLvUpListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                            dispObject,
                                                                            (const MethodInfo_19D14E0 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_40FA539 & 1) == 0 )
  {
    sub_B16FFC(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_40FA539 = 1;
  }
