        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02B07 & 1) == 0 )
  {
    sub_1B64A00(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4A02B07 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A7CC *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02B08 & 1) == 0 )
  {
    sub_1B64A00(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4A02B08 = 1;
  }
