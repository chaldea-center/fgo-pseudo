        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B008B & 1) == 0 )
  {
    sub_B52984(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
    byte_42B008B = 1;
  }
  ...
  Component_srcLineSprite = (struct CommandAssistLvUpListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                            dispObject,
                                                                            (const MethodInfo_1B7B1B8 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistLvUpListViewItemDraw_o *)sub_B52D50(item);
      goto LABEL_9;
    }
  }
