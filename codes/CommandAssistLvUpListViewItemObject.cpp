        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8966 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4BB8966 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FDF9FC *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB8967 & 1) == 0 )
  {
    sub_1C13D24(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4BB8967 = 1;
  }
