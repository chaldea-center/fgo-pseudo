        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6AE59 & 1) == 0 )
  {
    sub_1BE4ACC(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4B6AE59 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2FA979C *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B6AE5A & 1) == 0 )
  {
    sub_1BE4ACC(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4B6AE5A = 1;
  }
