        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024E6 & 1) == 0 )
  {
    sub_1B64870(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4A024E6 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E8A1B4 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024E7 & 1) == 0 )
  {
    sub_1B64870(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4A024E7 = 1;
  }
