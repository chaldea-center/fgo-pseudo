        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23AFC & 1) == 0 )
  {
    sub_1B715CC(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4A23AFC = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2EAA998 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A23AFD & 1) == 0 )
  {
    sub_1B715CC(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4A23AFD = 1;
  }
