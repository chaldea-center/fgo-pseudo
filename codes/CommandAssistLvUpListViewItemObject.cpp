        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CC60 & 1) == 0 )
  {
    sub_1B686D4(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, method);
    byte_4A0CC60 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_2E98950 *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0CC61 & 1) == 0 )
  {
    sub_1B686D4(&CommandAssistLvUpListViewItem_TypeInfo, item);
    byte_4A0CC61 = 1;
  }
