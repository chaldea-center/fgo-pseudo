...
void CommandAssistLvUpListViewItemObject__Awake(CommandAssistLvUpListViewItemObject_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB08F7 & 1) == 0 )
  {
    sub_1C6BA08(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
    byte_4CB08F7 = 1;
  }
  ...
  Component_object = UnityEngine_GameObject__GetComponent_object_(
                       dispObject,
                       (const MethodInfo_319312C *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistLvUpListViewItemDraw_o *)sub_1C6BFFC(item);
      goto LABEL_9;
    }
  }
