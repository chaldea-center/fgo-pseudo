        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8B6C & 1) == 0 )
  {
    sub_B5D5C4(&Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___, (_DWORD)method, v2, v3);
    byte_42E8B6C = 1;
  }
  ...
  Component_srcLineSprite = (struct CommandAssistLvUpListViewItemDraw_o *)UnityEngine_GameObject__GetComponent_srcLineSprite_(
                                                                            dispObject,
                                                                            (const MethodInfo_1CC439C *)Method_UnityEngine_GameObject_GetComponent_CommandAssistLvUpListViewItemDraw___);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42E8B6D & 1) == 0 )
  {
    sub_B5D5C4(&CommandAssistLvUpListViewItem_TypeInfo, (_DWORD)item, (_DWORD)seed, method);
    byte_42E8B6D = 1;
  }
...
LABEL_9:
  ...
  if ( item )
  {
    ...
    {
      itemDraw = (CommandAssistLvUpListViewItemDraw_o *)sub_B5D990(item);
      goto LABEL_9;
    }
  }
