void __fastcall AccountingManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BDBE80 & 1) == 0 )
  {
    sub_1C21E38(&AccountingManager_TypeInfo);
    sub_1C21E38(&PaymentInfo_TypeInfo);
    byte_4BDBE80 = 1;
  }
  ...
  *(_WORD *)&static_fields->isEnableStore = 0;
  ...
  v2 = (PaymentInfo_o *)sub_1C22084(PaymentInfo_TypeInfo);
  PaymentInfo___ctor(v2, v3);
  v4 = AccountingManager_TypeInfo->static_fields;
  v4->paymentInfo = v2;
  sub_1C21DDC((PartyOrganizationUtility_o *)&v4->paymentInfo, (int64_t)v2, v5, v6, v7, v8, v9, v10);
}
...
void __fastcall AccountingManager___ctor(AccountingManager_o *this, const MethodInfo *method)
{
  if ( (byte_4BDBE7F & 1) == 0 )
  {
    sub_1C21E38(&Method_SingletonMonoBehaviour_AccountingManager___ctor__);
    byte_4BDBE7F = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_388D470 *)Method_SingletonMonoBehaviour_AccountingManager___ctor__);
}
...
void __fastcall AccountingManager__AddExtraDataProductID(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1C21E38(&AccountingManager_TypeInfo);
    sub_1C21E38(&StringLiteral_25588/*"{{\"ProductId\":\"{0}\"}}"*/);
    byte_4BDBE7D = 1;
  }
  ...
  v4 = (AccountingManager_o *)System_String__Format(
                                (System_String_o *)StringLiteral_25588/*"{{\"ProductId\":\"{0}\"}}"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1C21DDC(p_callbackFunc, 0LL, *(int64_t *)&perMonthAmount, (int32_t)method, v4, v5, v6, v7);
...
System_String_o *__fastcall AccountingManager__GetHistoryFileName(System_String_o *name, const MethodInfo *method)
{
  ...
  return System_String__Concat_63126736(PaymentHistoryPath, (System_String_o *)StringLiteral_1123/*"/"*/, name, 0LL);
}


System_String_o *__fastcall AccountingManager__GetHistoryFileName_39863456(int64_t time, const MethodInfo *method)
{
  AccountingManager_c *v3; // x0
  System_String_o *PaymentHistoryPath; // x20
  System_String_o *FileName_38923880; // x2
  ...
  FileName_38923880 = DatFileName__getFileName_38923880(22, time, 0LL);
...
System_String_o *__fastcall AccountingManager__GetOldPaymentFileName(const MethodInfo *method)
{
  ...
  return System_String__Concat_63126736(temporaryCachePath, (System_String_o *)StringLiteral_1123/*"/"*/, FileName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDBE77 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_1109/*".meta"*/);
    byte_4BDBE77 = 1;
  }
  v2 = AccountingManager_TypeInfo;
  Chars = 0;
  ...
  v6 = (System_IO_DirectoryInfo_o *)sub_1C22084(System_IO_DirectoryInfo_TypeInfo);
...
LABEL_28:
      ...
      Files = (System_String_o *)System_Char__Equals_63747440((uint16_t)&Chars, 0x2Eu, 0LL);
      if ( ((unsigned __int8)Files & 1) == 0 )
      {
        if ( !v16 )
          break;
        Files = (System_String_o *)System_String__Equals_63123792(v16, (System_String_o *)StringLiteral_1109/*".meta"*/, 0LL);
        if ( ((unsigned __int8)Files & 1) == 0 )
        {
          if ( !v3 )
            break;
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *HistoryFileName_39863456; // x0
  ...
  if ( !v4->static_fields->UseMock )
  {
    ...
    if ( !paymentInfo
      || (HistoryFileName_39863456 = AccountingManager__GetHistoryFileName_39863456(
                                       paymentInfo->fields._Time_k__BackingField,
                                       v7),
          (v10 = AccountingManager_TypeInfo->static_fields->paymentInfo) == 0LL) )
    {
      sub_1C22094(HistoryFileName_39863456, v7);
    }
    PaymentInfo__WriteHistoryFile(v10, HistoryFileName_39863456, state, v9);
  }
}
...
System_String_o *__fastcall AccountingManager__ReadHistory(System_String_o *name, const MethodInfo *method)
{
  ...
  {
LABEL_12:
    v15 = sub_1C73E18(v7, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall AccountingManager__ReadOldPayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  return AccountingManager__ReadPayment_39865536(this, 0, v2);
}
...
bool __fastcall AccountingManager__ReadPayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  return AccountingManager__ReadPayment_39865536(this, 1, v2);
}


// local variable allocation has failed, the output may be wrong!
bool __fastcall AccountingManager__ReadPayment_39865536(
        AccountingManager_o *this,
        bool isNewFormat,
        const MethodInfo *method)
{
...
LABEL_11:
  ...
  if ( !paymentInfo )
LABEL_20:
    sub_1C22094(paymentInfo, isNewFormat);
      ...
      if ( paymentInfo )
      {
        if ( !paymentInfo->fields._Time_k__BackingField )
        {
          ...
          *(_QWORD *)(Time + 48) = StringLiteral_1/*""*/;
          sub_1C21DDC((PartyOrganizationUtility_o *)(Time + 48), (int64_t)v14, v8, v9, v10, v11, v12, v13);
          Time = (int64_t)AccountingManager_TypeInfo->static_fields->paymentInfo;
          if ( !Time )
            goto LABEL_31;
          v21 = StringLiteral_1/*""*/;
          *(_QWORD *)(Time + 40) = StringLiteral_1/*""*/;
          sub_1C21DDC((PartyOrganizationUtility_o *)(Time + 40), (int64_t)v21, v15, v16, v17, v18, v19, v20);
          ...
          *(_QWORD *)(Time + 64) = StringLiteral_1/*""*/;
          sub_1C21DDC((PartyOrganizationUtility_o *)(Time + 64), (int64_t)v29, v23, v24, v25, v26, v27, v28);
          Time = (int64_t)AccountingManager_TypeInfo;
        }
        if ( !*(_DWORD *)(Time + 224) )
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A63884;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A6382C;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BDBE81 & 1) == 0 )
  {
    ...
    sub_1C21E38(&AccountingManager_Result_TypeInfo);
    byte_4BDBE81 = 1;
  }
  v13[2] = 0LL;
