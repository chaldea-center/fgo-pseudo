void __fastcall AccountingManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B36AD8 & 1) == 0 )
  {
    sub_1BD3458(&AccountingManager_TypeInfo, v1);
    sub_1BD3458(&PaymentInfo_TypeInfo, v2);
    byte_4B36AD8 = 1;
  }
  ...
  *(_WORD *)&static_fields->isEnableStore = 0;
  ...
  v4 = (PaymentInfo_o *)sub_1BD36A4(PaymentInfo_TypeInfo);
  PaymentInfo___ctor(v4, v5);
  v6 = AccountingManager_TypeInfo->static_fields;
  v6->paymentInfo = v4;
  sub_1BD33FC((PartyOrganizationUtility_o *)&v6->paymentInfo, (int64_t)v4, v7, v8, v9, v10, v11, v12);
}
...
void __fastcall AccountingManager___ctor(AccountingManager_o *this, const MethodInfo *method)
{
  if ( (byte_4B36AD7 & 1) == 0 )
  {
    sub_1BD3458(&Method_SingletonMonoBehaviour_AccountingManager___ctor__, method);
    byte_4B36AD7 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_37FE060 *)Method_SingletonMonoBehaviour_AccountingManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36AD6 & 1) == 0 )
  {
    sub_1BD3458(&Method_System_Collections_Generic_Dictionary_string__object__GetEnumerator__, value);
    ...
    sub_1BD3458(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__, v10);
    byte_4B36AD6 = 1;
  }
...
void __fastcall AccountingManager__AddExtraDataProductID(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B36AD5 & 1) == 0 )
  {
    ...
    sub_1BD3458(&StringLiteral_25430/*"{{\"ProductId\":\"{0}\"}}"*/, v2);
    byte_4B36AD5 = 1;
  }
  ...
  v5 = (AccountingManager_o *)System_String__Format(
                                (System_String_o *)StringLiteral_25430/*"{{\"ProductId\":\"{0}\"}}"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1BD33FC(p_callbackFunc, 0LL, *(int64_t *)&perMonthAmount, (int32_t)method, v4, v5, v6, v7);
...
System_String_o *__fastcall AccountingManager__GetHistoryFileName(System_String_o *name, const MethodInfo *method)
{
  ...
  return System_String__Concat_62536508(PaymentHistoryPath, (System_String_o *)StringLiteral_1120/*"/"*/, name, 0LL);
}


System_String_o *__fastcall AccountingManager__GetHistoryFileName_39397616(int64_t time, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  AccountingManager_c *v5; // x0
  System_String_o *PaymentHistoryPath; // x20
  System_String_o *FileName_38463024; // x2
  ...
  FileName_38463024 = DatFileName__getFileName_38463024(22, time, 0LL);
...
System_String_o *__fastcall AccountingManager__GetOldPaymentFileName(const MethodInfo *method)
{
  ...
  return System_String__Concat_62536508(temporaryCachePath, (System_String_o *)StringLiteral_1120/*"/"*/, FileName, 0LL);
}
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&AccountingManager_TypeInfo, method);
    sub_1BD3458(&char_TypeInfo, v2);
    sub_1BD3458(&System_IO_DirectoryInfo_TypeInfo, v3);
    ...
    sub_1BD3458(&StringLiteral_1106/*".meta"*/, v8);
    byte_4B36ACF = 1;
  }
  ...
  v13 = (System_IO_DirectoryInfo_o *)sub_1BD36A4(System_IO_DirectoryInfo_TypeInfo);
...
LABEL_28:
      ...
      Files = (System_String_o *)System_Char__Equals_63157212((uint16_t)&Chars, 0x2Eu, 0LL);
      if ( ((unsigned __int8)Files & 1) == 0 )
      {
        if ( !v23 )
          break;
        Files = (System_String_o *)System_String__Equals_62533564(v23, (System_String_o *)StringLiteral_1106/*".meta"*/, 0LL);
        if ( ((unsigned __int8)Files & 1) == 0 )
        {
          if ( !v10 )
            break;
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *HistoryFileName_39397616; // x0
  ...
  if ( (byte_4B36AD3 & 1) == 0 )
  {
    sub_1BD3458(&AccountingManager_TypeInfo, state);
  ...
  if ( !v5->static_fields->UseMock )
  {
    ...
    if ( !paymentInfo
      || (HistoryFileName_39397616 = AccountingManager__GetHistoryFileName_39397616(
                                       paymentInfo->fields._Time_k__BackingField,
                                       v8),
          (v11 = AccountingManager_TypeInfo->static_fields->paymentInfo) == 0LL) )
    {
      sub_1BD36B4(HistoryFileName_39397616, v8);
    }
    PaymentInfo__WriteHistoryFile(v11, HistoryFileName_39397616, state, v10);
  }
}
...
System_String_o *__fastcall AccountingManager__ReadHistory(System_String_o *name, const MethodInfo *method)
{
  ...
  {
    sub_1BD3458(&AccountingManager_TypeInfo, method);
    sub_1BD3458(&System_IO_BinaryReader_TypeInfo, v3);
  ...
  {
LABEL_12:
    v18 = sub_1C25438(v10, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall AccountingManager__ReadOldPayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  return AccountingManager__ReadPayment_39399696(this, 0, v2);
}
...
bool __fastcall AccountingManager__ReadPayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  return AccountingManager__ReadPayment_39399696(this, 1, v2);
}


// local variable allocation has failed, the output may be wrong!
bool __fastcall AccountingManager__ReadPayment_39399696(
        AccountingManager_o *this,
        bool isNewFormat,
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36AD0 & 1) == 0 )
  {
    sub_1BD3458(&AccountingManager_TypeInfo, isNewFormat);
    sub_1BD3458(&ManagerConfig_TypeInfo, v4);
    byte_4B36AD0 = 1;
  }
  v5 = ManagerConfig_TypeInfo;
...
LABEL_11:
  ...
  if ( !paymentInfo )
LABEL_20:
    sub_1BD36B4(paymentInfo, isNewFormat);
...
void __fastcall AccountingManager__WritePayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  PaymentInfo_o *v35; // x8

  if ( (byte_4B36AD1 & 1) == 0 )
  {
    sub_1BD3458(&AccountingManager_TypeInfo, method);
    sub_1BD3458(&AgeVerificationMenu_TypeInfo, v2);
      ...
      if ( paymentInfo )
      {
        if ( !paymentInfo->fields._Time_k__BackingField )
        {
          ...
          *(_QWORD *)(Time + 48) = StringLiteral_1/*""*/;
          sub_1BD33FC((PartyOrganizationUtility_o *)(Time + 48), (int64_t)v18, v12, v13, v14, v15, v16, v17);
          Time = (int64_t)AccountingManager_TypeInfo->static_fields->paymentInfo;
          if ( !Time )
            goto LABEL_31;
          v25 = StringLiteral_1/*""*/;
          *(_QWORD *)(Time + 40) = StringLiteral_1/*""*/;
          sub_1BD33FC((PartyOrganizationUtility_o *)(Time + 40), (int64_t)v25, v19, v20, v21, v22, v23, v24);
          ...
          if ( !v26 )
            goto LABEL_31;
          v26->fields._CumulativeAmount_k__BackingField = Time;
          Time = (int64_t)AccountingManager_TypeInfo->static_fields->paymentInfo;
          if ( !Time )
            goto LABEL_31;
          v33 = StringLiteral_1/*""*/;
          *(_QWORD *)(Time + 64) = StringLiteral_1/*""*/;
          sub_1BD33FC((PartyOrganizationUtility_o *)(Time + 64), (int64_t)v33, v27, v28, v29, v30, v31, v32);
          Time = (int64_t)AccountingManager_TypeInfo;
        }
        if ( !*(_DWORD *)(Time + 224) )
          j_il2cpp_runtime_class_init_0(Time);
        Time = (int64_t)AccountingManager__GetPaymentFileName((const MethodInfo *)Time);
        v35 = AccountingManager_TypeInfo->static_fields->paymentInfo;
        if ( v35 )
        {
          PaymentInfo__WriteFile(v35, (System_String_o *)Time, v34);
          return;
        }
      }
    }
LABEL_31:
    sub_1BD36B4(Time, method);
  }
}
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A15DD8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A15D80;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B36AD9 & 1) == 0 )
  {
    ...
    sub_1BD3458(&AccountingManager_Result_TypeInfo, v9);
    byte_4B36AD9 = 1;
  }
  v14[2] = 0LL;
