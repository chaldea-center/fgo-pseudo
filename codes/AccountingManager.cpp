void __fastcall AccountingManager___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A0851A & 1) == 0 )
  {
    sub_1B686D4(&AccountingManager_TypeInfo, v1);
    sub_1B686D4(&PaymentInfo_TypeInfo, v2);
    byte_4A0851A = 1;
  }
  ...
  *(_WORD *)&static_fields->isEnableStore = 0;
  ...
  v4 = (PaymentInfo_o *)sub_1B68920(PaymentInfo_TypeInfo);
  PaymentInfo___ctor(v4, v5);
  v6 = AccountingManager_TypeInfo->static_fields;
  v6->paymentInfo = v4;
  sub_1B68678((ServantStatusBattleListViewItem_o *)&v6->paymentInfo, (int32_t)v4, v7, v8);
}
...
void __fastcall AccountingManager___ctor(AccountingManager_o *this, const MethodInfo *method)
{
  if ( (byte_4A08519 & 1) == 0 )
  {
    sub_1B686D4(&Method_SingletonMonoBehaviour_AccountingManager___ctor__, method);
    byte_4A08519 = 1;
  }
  SingletonMonoBehaviour_object____ctor(
    (SingletonMonoBehaviour_T__o *)this,
    (const MethodInfo_36F7AB4 *)Method_SingletonMonoBehaviour_AccountingManager___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08518 & 1) == 0 )
  {
    sub_1B686D4(&Method_System_Collections_Generic_Dictionary_string__object__GetEnumerator__, value);
    ...
    sub_1B686D4(&Method_SingletonMonoBehaviour_CrashReporter__get_Instance__, v10);
    byte_4A08518 = 1;
  }
...
void __fastcall AccountingManager__AddExtraDataProductID(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A08517 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_25055/*"{{\"ProductId\":\"{0}\"}}"*/, v2);
    byte_4A08517 = 1;
  }
  ...
  v5 = (AccountingManager_o *)System_String__Format(
                                (System_String_o *)StringLiteral_25055/*"{{\"ProductId\":\"{0}\"}}"*/,
        ...
        const MethodInfo *method)
{
  ...
  if ( callbackFunc )
  {
    ...
    sub_1B68678(p_callbackFunc, 0, perMonthAmount, (int32_t)method);
...
System_String_o *__fastcall AccountingManager__GetHistoryFileName(System_String_o *name, const MethodInfo *method)
{
  ...
  return System_String__Concat_61430728(PaymentHistoryPath, (System_String_o *)StringLiteral_1123/*"/"*/, name, 0LL);
}


System_String_o *__fastcall AccountingManager__GetHistoryFileName_38283148(int64_t time, const MethodInfo *method)
{
  __int64 v3; // x1
  __int64 v4; // x1
  AccountingManager_c *v5; // x0
  System_String_o *PaymentHistoryPath; // x20
  System_String_o *FileName_37431892; // x2
  ...
  FileName_37431892 = DatFileName__getFileName_37431892(22, time, 0LL);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&AccountingManager_TypeInfo, method);
    sub_1B686D4(&char_TypeInfo, v2);
    sub_1B686D4(&System_IO_DirectoryInfo_TypeInfo, v3);
    ...
    sub_1B686D4(&StringLiteral_1109/*".meta"*/, v8);
    byte_4A08511 = 1;
  }
  ...
  v13 = (System_IO_DirectoryInfo_o *)sub_1B68920(System_IO_DirectoryInfo_TypeInfo);
...
LABEL_28:
      ...
      Files = (System_String_o *)System_Char__Equals_62051104((uint16_t)&Chars, 0x2Eu, 0LL);
      if ( ((unsigned __int8)Files & 1) == 0 )
      {
        if ( !v23 )
          break;
        Files = (System_String_o *)System_String__Equals_61427784(v23, (System_String_o *)StringLiteral_1109/*".meta"*/, 0LL);
        if ( ((unsigned __int8)Files & 1) == 0 )
        {
          if ( !v10 )
            break;
        ...
        const MethodInfo *method)
{
  ...
  System_String_o *HistoryFileName_38283148; // x0
  ...
  if ( (byte_4A08515 & 1) == 0 )
  {
    sub_1B686D4(&AccountingManager_TypeInfo, state);
  ...
  if ( !v5->static_fields->UseMock )
  {
    ...
    if ( !paymentInfo
      || (HistoryFileName_38283148 = AccountingManager__GetHistoryFileName_38283148(
                                       paymentInfo->fields._Time_k__BackingField,
                                       v8),
          (v11 = AccountingManager_TypeInfo->static_fields->paymentInfo) == 0LL) )
    {
      sub_1B68930(HistoryFileName_38283148, v8);
    }
    PaymentInfo__WriteHistoryFile(v11, HistoryFileName_38283148, state, v10);
  }
}
...
System_String_o *__fastcall AccountingManager__ReadHistory(System_String_o *name, const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&AccountingManager_TypeInfo, method);
    sub_1B686D4(&System_IO_BinaryReader_TypeInfo, v3);
  ...
  {
LABEL_12:
    v18 = sub_1BBA6B4(v10, System_IDisposable_TypeInfo, 0LL);
  }
...
bool __fastcall AccountingManager__ReadOldPayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  return AccountingManager__ReadPayment_38285228(this, 0, v2);
}
...
bool __fastcall AccountingManager__ReadPayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  return AccountingManager__ReadPayment_38285228(this, 1, v2);
}


// local variable allocation has failed, the output may be wrong!
bool __fastcall AccountingManager__ReadPayment_38285228(
        AccountingManager_o *this,
        bool isNewFormat,
        const MethodInfo *method)
{
  ...
  if ( (byte_4A08512 & 1) == 0 )
  {
    sub_1B686D4(&AccountingManager_TypeInfo, isNewFormat);
    sub_1B686D4(&ManagerConfig_TypeInfo, v4);
    byte_4A08512 = 1;
  }
  v5 = ManagerConfig_TypeInfo;
...
LABEL_11:
  ...
  if ( !paymentInfo )
LABEL_20:
    sub_1B68930(paymentInfo, isNewFormat);
...
void __fastcall AccountingManager__WritePayment(AccountingManager_o *this, const MethodInfo *method)
{
  ...
  {
    sub_1B686D4(&AccountingManager_TypeInfo, method);
    sub_1B686D4(&AgeVerificationMenu_TypeInfo, v2);
      ...
      if ( paymentInfo )
      {
        if ( !paymentInfo->fields._Time_k__BackingField )
        {
          ...
          *(_QWORD *)(Time + 48) = StringLiteral_1/*""*/;
          sub_1B68678((ServantStatusBattleListViewItem_o *)(Time + 48), v14, v12, v13);
          Time = (int64_t)AccountingManager_TypeInfo->static_fields->paymentInfo;
          if ( !Time )
            goto LABEL_31;
          v17 = (int)StringLiteral_1/*""*/;
          *(_QWORD *)(Time + 40) = StringLiteral_1/*""*/;
          sub_1B68678((ServantStatusBattleListViewItem_o *)(Time + 40), v17, v15, v16);
          ...
          *(_QWORD *)(Time + 64) = StringLiteral_1/*""*/;
          sub_1B68678((ServantStatusBattleListViewItem_o *)(Time + 64), v21, v19, v20);
          Time = (int64_t)AccountingManager_TypeInfo;
        }
        if ( !*(_DWORD *)(Time + 224) )
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_19B0A10;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_19B09B8;
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A0851B & 1) == 0 )
  {
    ...
    sub_1B686D4(&AccountingManager_Result_TypeInfo, v9);
    byte_4A0851B = 1;
  }
  v14[2] = 0LL;
