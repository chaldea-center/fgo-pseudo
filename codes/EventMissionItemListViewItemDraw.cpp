...
void EventMissionItemListViewItemDraw__Awake(EventMissionItemListViewItemDraw_o *this, const MethodInfo *method)
{
  ...
  if ( (v4 & 1) != 0 )
  {
    ...
    v4 = sub_1C2D434(&this->fields.baseStampSpriteAtlas);
    v7 = this->fields.stampSprite;
    if ( !v7 )
      goto LABEL_16;
    this->fields.baseStampSpriteName = v7->fields.mSpriteName;
    sub_1C2D434(&this->fields.baseStampSpriteName);
  }
  ...
  if ( (v4 & 1) != 0 )
  {
    ...
    if ( v9 )
    {
      ...
      v4 = sub_1C2D434(&this->fields.baseBoardMaskSpriteAtlas);
      v10 = this->fields.boardMaskSprite;
      if ( v10 )
      {
        this->fields.baseBoardMaskSpriteName = v10->fields.mSpriteName;
        sub_1C2D434(&this->fields.baseBoardMaskSpriteName);
        return;
      }
    }
LABEL_16:
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C2172B & 1) == 0 )
  {
    ...
    this = (EventMissionItemListViewItemDraw_o *)sub_1C2D490(&UnityEngine_Object_TypeInfo);
    byte_4C2172B = 1;
  }
  if ( !v5 )
    goto LABEL_78;
...
LABEL_8:
  ...
  v6->fields.giftEntityList = MissionInfoMaker__GetIconGiftEntities(missionNoLb_high, 0);
  p_giftEntityList = &v6->fields.giftEntityList;
  this = (EventMissionItemListViewItemDraw_o *)sub_1C2D434(&v6->fields.giftEntityList);
  ...
  if ( !this || !Master_object )
    goto LABEL_78;
  v14 = EventMissionAddMaster__GetEventMissionChangeRewardIcon(
...
LABEL_23:
    if ( !System_String__IsNullOrEmpty(v14, 0) )
    {
      ...
      if ( !this )
        goto LABEL_78;
      ItemIconComponent__SetItemImageByName((ItemIconComponent_o *)this, v14, 0);
LABEL_31:
      this = (EventMissionItemListViewItemDraw_o *)v6->fields.itemIcon;
      if ( !this )
        goto LABEL_78;
    ...
    if ( LODWORD(v24->max_length) )
    {
      ...
      else
      {
        ...
        if ( (int)v26 <= 1 )
          ...
          v27 = v26;
        ItemIconComponent__SetItemImage_40702764((ItemIconComponent_o *)this, (int32_t)item, v27, 0);
      }
      goto LABEL_31;
    }
LABEL_79:
    sub_1C2D6F4(this, item, v15, v16);
  }
  ...
  if ( !v21 )
    goto LABEL_78;
  item = (EventMissionItemListViewItem_o *)(unsigned int)v21->fields.prioredIconId;
  this = (EventMissionItemListViewItemDraw_o *)v6->fields.itemIcon;
  v22 = v21->fields.num;
  if ( (int)item < 1 )
  {
    ...
    if ( v22 <= 1 )
      ...
      v31 = v21->fields.num;
    ItemIconComponent__SetGiftDesignSize((ItemIconComponent_o *)this, v21->fields.type, v21->fields.objectId, v31, 0);
  }
  else
  {
    if ( !this )
...
LABEL_33:
  ...
  {
    if ( EventMissionItemListViewItem__get_IsHideReward(v5, v18) )
    {
      this = (EventMissionItemListViewItemDraw_o *)v6->fields.itemIcon;
      v6->fields.isMultipleReward = 0;
      if ( this )
        ...
        if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)resTimeLb, 0) )
        {
          ...
          if ( UnityEngine_GameObject__get_activeSelf((UnityEngine_GameObject_o *)resTimeLb, 0) )
          {
            ...
            if ( v12 - oldTime >= v13->static_fields->TIME_UPDATE_ITVL_SEC )
            {
              ...
              resTimeLb = (UnityEngine_Component_o *)LocalizationManager__Get((System_String_o *)StringLiteral_13435/*"TIME_REST_TIMEOVER"*/, 0);
              if ( !RestTime )
                goto LABEL_33;
              if ( System_String__Equals_63493168(RestTime, (System_String_o *)resTimeLb, 0) )
              {
