void __fastcall IndividualityPolicyMaster___ctor(IndividualityPolicyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4215CD6 & 1) == 0 )
  {
    sub_B0D8A4(&Method_DataMasterBase_IndividualityPolicyMaster__IndividualityPolicyEntity__int___ctor__, method);
    byte_4215CD6 = 1;
  }
  DataMasterBase_WarMaster__WarEntity__int____ctor(
    (DataMasterBase_WarMaster__WarEntity__int__o *)this,
    474,
    (const MethodInfo_2669B38 *)Method_DataMasterBase_IndividualityPolicyMaster__IndividualityPolicyEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4215CD5 & 1) == 0 )
  {
    ...
    sub_B0D8A4(&IndividualityPolicyEntity_TypeInfo, v12);
    byte_4215CD5 = 1;
  }
...
LABEL_16:
    ...
    if ( v23 )
    {
      v27 = *(&IndividualityPolicyEntity_TypeInfo->_2.bitflags2 + 1);
      if ( *(unsigned __int8 *)(*v23 + 300LL) >= (unsigned int)v27
        && *(IndividualityPolicyEntity_c **)(*(_QWORD *)(*v23 + 200LL) + 8 * v27 - 8) == IndividualityPolicyEntity_TypeInfo )
      {
        v28 = v23[3];
        if ( !v28 )
          sub_B0D97C(v23);
