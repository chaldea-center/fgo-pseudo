void __fastcall IndividualityPolicyMaster___ctor(IndividualityPolicyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_49BB1AE & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataMasterBase_IndividualityPolicyMaster__IndividualityPolicyEntity__int___ctor__, method);
    byte_49BB1AE = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    483,
    (const MethodInfo_319B678 *)Method_DataMasterBase_IndividualityPolicyMaster__IndividualityPolicyEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB1AC & 1) == 0 )
  {
    ...
    sub_1B4CF90(&System_Collections_Generic_IEnumerator_IndividualityPolicyEntity__TypeInfo, v9);
    sub_1B4CF90(&System_Collections_IEnumerator_TypeInfo, v10);
    sub_1B4CF90(&IndividualityPolicyEntity_TypeInfo, v11);
    byte_49BB1AC = 1;
  }
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_313B4BC *)Method_System_Collections_ObjectModel_Collection_IndividualityPolicyEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1B4D1EC(0LL, v13);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v22 = sub_1B9D724(Enumerator, System_Collections_Generic_IEnumerator_IndividualityPolicyEntity__TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BB1AD & 1) == 0 )
  {
    sub_1B4CF90(&Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPolicyEntity___, entity);
    sub_1B4CF90(&System_Func_IndividualityPolicyEntity__bool__TypeInfo, v7);
    sub_1B4CF90(&Method_IndividualityPolicyMaster___c__DisplayClass1_0__TryGetEntityByPolicyValue_b__0__, v8);
    sub_1B4CF90(&IndividualityPolicyMaster___c__DisplayClass1_0_TypeInfo, v9);
    byte_49BB1AD = 1;
  }
  v10 = sub_1B4D1DC(IndividualityPolicyMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10 )
    sub_1B4D1EC(v11, v12);
  *(_DWORD *)(v10 + 16) = policyValue;
  list = this->fields.list;
  v14 = (System_Func_object__bool__o *)sub_1B4D1DC(System_Func_IndividualityPolicyEntity__bool__TypeInfo);
  ...
  v15 = System_Linq_Enumerable__FirstOrDefault_object__49446844(
          ...
          (const MethodInfo_2F27FBC *)Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPolicyEntity___);
