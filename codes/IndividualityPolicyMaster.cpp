void __fastcall IndividualityPolicyMaster___ctor(IndividualityPolicyMaster_o *this, const MethodInfo *method)
{
  if ( (byte_4A4E7E4 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataMasterBase_IndividualityPolicyMaster__IndividualityPolicyEntity__int___ctor__, method);
    byte_4A4E7E4 = 1;
  }
  DataMasterBase_object__object__int____ctor(
    (DataMasterBase_TMaster__TEntity__PKType__o *)this,
    483,
    (const MethodInfo_3211F5C *)Method_DataMasterBase_IndividualityPolicyMaster__IndividualityPolicyEntity__int___ctor__);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E7E2 & 1) == 0 )
  {
    ...
    sub_1B863B8(&System_Collections_Generic_IEnumerator_IndividualityPolicyEntity__TypeInfo, v9);
    sub_1B863B8(&System_Collections_IEnumerator_TypeInfo, v10);
    sub_1B863B8(&IndividualityPolicyEntity_TypeInfo, v11);
    byte_4A4E7E2 = 1;
  }
  ...
  Enumerator = System_Collections_ObjectModel_Collection_object___GetEnumerator(
                 list,
                 (const MethodInfo_31B0EE0 *)Method_System_Collections_ObjectModel_Collection_IndividualityPolicyEntity__GetEnumerator__);
  if ( !Enumerator )
    sub_1B86614(0LL, v13);
  while ( 1 )
  {
...
LABEL_9:
    ...
    {
LABEL_16:
      v22 = sub_1BD6B4C(Enumerator, System_Collections_Generic_IEnumerator_IndividualityPolicyEntity__TypeInfo, 0LL);
    }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4E7E3 & 1) == 0 )
  {
    sub_1B863B8(&Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPolicyEntity___, entity);
    sub_1B863B8(&System_Func_IndividualityPolicyEntity__bool__TypeInfo, v7);
    sub_1B863B8(&Method_IndividualityPolicyMaster___c__DisplayClass1_0__TryGetEntityByPolicyValue_b__0__, v8);
    sub_1B863B8(&IndividualityPolicyMaster___c__DisplayClass1_0_TypeInfo, v9);
    byte_4A4E7E3 = 1;
  }
  v10 = sub_1B86604(IndividualityPolicyMaster___c__DisplayClass1_0_TypeInfo);
  System_Object___ctor((Il2CppObject *)v10, 0LL);
  if ( !v10 )
    sub_1B86614(v11, v12);
  *(_DWORD *)(v10 + 16) = policyValue;
  list = this->fields.list;
  v14 = (System_Func_object__bool__o *)sub_1B86604(System_Func_IndividualityPolicyEntity__bool__TypeInfo);
  ...
  v15 = System_Linq_Enumerable__FirstOrDefault_object__49893388(
          ...
          (const MethodInfo_2F9500C *)Method_System_Linq_Enumerable_FirstOrDefault_IndividualityPolicyEntity___);
