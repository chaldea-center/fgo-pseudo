void __fastcall ServantClassCompatibilityIconComponent___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB3BEA & 1) == 0 )
  {
    sub_1C13D24(&ServantClassCompatibilityIconComponent_TypeInfo, v1);
    sub_1C13D24(&float___TypeInfo, v2);
    sub_1C13D24(
  ...
  v6 = (System_Array_o *)sub_1C13DCC(float___TypeInfo, 5LL);
  ...
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62875280(v6, v32, 0LL);
  ...
  sub_1C13CC8(
    ...
    v12,
    v13);
  v14 = (System_Array_o *)sub_1C13DCC(float___TypeInfo, 5LL);
  v33.fields.value = Field__PrivateImplementationDetails__8FD8636127BEF610717EDA6C87275DE8FABC7EAFB50E06E32438371EA366A436;
  v15 = (int64_t)v14;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62875280(v14, v33, 0LL);
  ...
  sub_1C13CC8((PartyOrganizationUtility_o *)&static_fields->POSITION_X_DOWN, v15, v17, v18, v19, v20, v21, v22);
  v23 = (System_Array_o *)sub_1C13DCC(float___TypeInfo, 5LL);
  v34.fields.value = Field__PrivateImplementationDetails__C08A644CA14B47C51D4206B9CD5FD8F3A046D90EF77DC2C18058397DC1F57528;
  v24 = (int64_t)v23;
  System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_62875280(v23, v34, 0LL);
  v25 = ServantClassCompatibilityIconComponent_TypeInfo->static_fields;
  v25->POSITION_X_CENTER = (struct System_Single_array *)v24;
  sub_1C13CC8((PartyOrganizationUtility_o *)&v25->POSITION_X_CENTER, v24, v26, v27, v28, v29, v30, v31);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3BE7 & 1) == 0 )
  {
    sub_1C13D24(&Method_DataManager_GetMasterData_ClassRelationMaster___, *(_QWORD *)&classId);
    sub_1C13D24(&UnityEngine_Object_TypeInfo, v9);
    sub_1C13D24(&ServantClassCompatibilityIconComponent_TypeInfo, v10);
...
LABEL_58:
          ...
          if ( (dispMode & 0xFFFFFFFE) == 2 )
          {
            ...
            GameObjectExtensions__SetLocalScale_34713904(gameObject, 0.8, 0LL);
            ...
            GameObjectExtensions__SetLocalScale_34713904(v37, 0.8, 0LL);
          }
        }
        else if ( v21 )
        {
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3BE8 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_20572/*"iiiil"*/, icon);
    sub_1C13D24(&StringLiteral_20574/*"image"*/, v10);
    sub_1C13D24(&StringLiteral_20573/*"ilc"*/, v11);
    this = (ServantClassCompatibilityIconComponent_o *)sub_1C13D24(&StringLiteral_20571/*"ii-CN"*/, v12);
    byte_4BB3BE8 = 1;
  }
  if ( !icon )
    goto LABEL_18;
  ...
  if ( iconId != 1 )
  {
    v15 = (System_String_o **)&StringLiteral_20572/*"iiiil"*/;
    if ( !advantage )
      v15 = (System_String_o **)&StringLiteral_20574/*"image"*/;
  ...
  v13 = (System_String_o **)&StringLiteral_20571/*"ii-CN"*/;
  if ( !advantage )
    v13 = (System_String_o **)&StringLiteral_20573/*"ilc"*/;
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB3BE9 & 1) == 0 )
  {
    sub_1C13D24(&Method_UnityEngine_GameObject_GetComponent_TweenPosition___, icon);
    this = (ServantClassCompatibilityIconComponent_o *)sub_1C13D24(&UnityEngine_Object_TypeInfo, v6);
    byte_4BB3BE9 = 1;
  }
  if ( !icon )
    goto LABEL_11;
