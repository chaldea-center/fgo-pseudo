        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BF854F & 1) == 0 )
  {
    sub_1C2E12C(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_4BF854F = 1;
  }
  v3 = sub_1C2E378(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C2E140(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C2E254(v3, v4);
}
