        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AFC93A & 1) == 0 )
  {
    sub_1BC3008(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_4AFC93A = 1;
  }
  v3 = sub_1BC3254(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BC301C(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1BC3130(v3, v4);
}
