        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C3D7AF & 1) == 0 )
  {
    sub_1C37058(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
    byte_4C3D7AF = 1;
  }
  v3 = sub_1C372A4(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3706C(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C37180(v3, v4);
}
