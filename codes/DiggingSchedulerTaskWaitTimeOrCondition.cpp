        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C5152F & 1) == 0 )
  {
    sub_1C3E564(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
    byte_4C5152F = 1;
  }
  v3 = sub_1C3E7B0(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3E578(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C3E68C(v3, v4);
}
