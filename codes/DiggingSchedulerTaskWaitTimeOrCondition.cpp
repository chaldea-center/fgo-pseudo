        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB0A77 & 1) == 0 )
  {
    sub_1C6BA08(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
    byte_4CB0A77 = 1;
  }
  v3 = sub_1C6BC54(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C6BA1C(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C6BB30(v3, v4);
}
