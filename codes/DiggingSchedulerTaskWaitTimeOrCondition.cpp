        ...
        const MethodInfo *method)
{
  ...
  *((float *)&v6[-1].fields.isMine + 1) = waitTime;
  sub_1B76164(v6, (int32_t)cond, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A320E9 & 1) == 0 )
  {
    sub_1B761C0(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_4A320E9 = 1;
  }
  v3 = sub_1B7640C(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
...
LABEL_7:
  ...
  sub_1B76164((ServantStatusBattleListViewItem_o *)p__2__current, 0, v2, v3);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B761D4(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1B762E8(v3, v4);
}
