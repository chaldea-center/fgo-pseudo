        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F3D5 & 1) == 0 )
  {
    sub_1BDB878(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_4B3F3D5 = 1;
  }
  v3 = sub_1BDBAC4(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1BDB88C(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1BDB9A0(v3, v4);
}
