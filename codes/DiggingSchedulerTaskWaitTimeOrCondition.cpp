        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CE8E1F & 1) == 0 )
  {
    sub_1C7BAE8(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
    byte_4CE8E1F = 1;
  }
  v3 = sub_1C7BD34(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C7BAFC(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C7BC10(v3, v4);
}
