        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49B5B38 & 1) == 0 )
  {
    sub_1B4CF90(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_49B5B38 = 1;
  }
  v3 = sub_1B4D1DC(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B4CFA4(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1B4D0B8(v3, v4);
}
