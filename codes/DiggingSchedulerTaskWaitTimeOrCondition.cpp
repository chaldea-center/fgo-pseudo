        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC28F9 & 1) == 0 )
  {
    sub_1C1ABD4(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_4BC28F9 = 1;
  }
  v3 = sub_1C1AE20(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C1ABE8(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C1ACFC(v3, v4);
}
