        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BD736F & 1) == 0 )
  {
    sub_1C21E38(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
    byte_4BD736F = 1;
  }
  v3 = sub_1C22084(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C21E4C(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C21F60(v3, v4);
}
