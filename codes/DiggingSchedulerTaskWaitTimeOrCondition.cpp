        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CC1B7B & 1) == 0 )
  {
    sub_1C713B0(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
    byte_4CC1B7B = 1;
  }
  v3 = sub_1C715FC(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C713C4(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C714D8(v3, v4);
}
