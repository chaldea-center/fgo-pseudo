        ...
        const MethodInfo *method)
{
  ...
  *((float *)&v6[-1].fields.isMine + 1) = waitTime;
  sub_1B64814(v6, (int32_t)cond, v7, v8);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02658 & 1) == 0 )
  {
    sub_1B64870(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_4A02658 = 1;
  }
  v3 = sub_1B64ABC(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
...
LABEL_7:
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)p__2__current, 0, v2, v3);
  result = 1;
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1B64884(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1B64998(v3, v4);
}
