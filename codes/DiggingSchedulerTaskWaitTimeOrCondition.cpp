        ...
        const MethodInfo *method)
{
  ...
  *((float *)&v6[-1].fields.Cond + 1) = waitTime;
  sub_B52920((BattleServantConfConponent_o *)v6, (System_Int32_array **)cond, v7, v8, v9, v10, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42B2055 & 1) == 0 )
  {
    sub_B52984(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
    byte_42B2055 = 1;
  }
  v3 = sub_B52A54(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_42AD886 & 1) == 0 )
  {
    this = (DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_o *)sub_B52984(&Method_System_Func_bool__Invoke__);
    byte_42AD886 = 1;
  }
...
LABEL_9:
  ...
  if ( v7 )
  {
    if ( System_Func_bool___Invoke(v7, (const MethodInfo_2774304 *)Method_System_Func_bool__Invoke__) )
      return 0;
  }
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_B52988(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_B52A28(v3, v4);
}
