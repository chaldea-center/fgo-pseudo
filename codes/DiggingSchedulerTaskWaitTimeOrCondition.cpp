        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C1CCCF & 1) == 0 )
  {
    sub_1C3B764(&DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo, method);
    byte_4C1CCCF = 1;
  }
  v3 = sub_1C3B9B0(DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  v4 = sub_1C3B778(&Method_DiggingSchedulerTaskWaitTimeOrCondition__Execute_d__3_System_Collections_IEnumerator_Reset__);
  sub_1C3B88C(v3, v4);
}
