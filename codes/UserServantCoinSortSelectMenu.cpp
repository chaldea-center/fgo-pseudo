...
void __fastcall UserServantCoinSortSelectMenu__Close(UserServantCoinSortSelectMenu_o *this, const MethodInfo *method)
{
  ...
  UserServantCoinSortSelectMenu__Close_33150992(this, 0LL, v2);
}


void __fastcall UserServantCoinSortSelectMenu__Close_33150992(
        UserServantCoinSortSelectMenu_o *this,
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CC2 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_EndClose__, v6);
    byte_4B17CC2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CC4 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu___c__DisplayClass41_0__InitCategoryContainer_b__0__, v11);
    this = (UserServantCoinSortSelectMenu_o *)sub_1BCAFF8(
...
LABEL_27:
  ...
  if ( (int)categoryKindKist->max_length >= 1 )
  {
    ...
    while ( 1 )
    {
      v24 = sub_1BCB244(UserServantCoinSortSelectMenu___c__DisplayClass41_0_TypeInfo);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CCA & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickCancel__, method);
    byte_4B17CCA = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickCancel__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickCancel__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CCB & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickClear__, v3);
    byte_4B17CCB = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickClear__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickClear__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CC9 & 1) == 0 )
  {
    this = (UserServantCoinSortSelectMenu_o *)sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickDecide__, method);
    byte_4B17CC9 = 1;
  }
  if ( v2->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickDecide__ + 83) & 2) != 0 )
      v7 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickDecide__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CD1 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickFilterButton__, *(_QWORD *)&filterKind);
    byte_4B17CD1 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickFilterButton__ + 83) & 2) != 0 )
      v5 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickFilterButton__);
        ...
        const MethodInfo *method)
{
  ...
  {
    sub_1BCAFF8(&Method_System_Collections_Generic_List_ListViewSort_FilterKind__ToArray__, method);
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickReset__, v3);
    byte_4B17CCC = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickReset__ + 83) & 2) != 0 )
      v4 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickReset__);
    v5 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v4, v4[4]);
    OverwriteAssetSoundName__PlaySystemSe(v5, 0, 0, 0LL);
    useFilterKindList = (System_Collections_Generic_List_T__o *)this->fields.useFilterKindList;
    if ( !useFilterKindList
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CCF & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickSortAmount__, method);
    byte_4B17CCF = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickSortAmount__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickSortAmount__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CCD & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickSortId__, method);
    byte_4B17CCD = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickSortId__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickSortId__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CCE & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickSortRarity__, method);
    byte_4B17CCE = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickSortRarity__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickSortRarity__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CD0 & 1) == 0 )
  {
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickSortServantName__, method);
    byte_4B17CD0 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_UserServantCoinSortSelectMenu_OnClickSortServantName__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BCB010(Method_UserServantCoinSortSelectMenu_OnClickSortServantName__);
    v4 = (System_Reflection_MethodBase_o *)sub_1BCAFDC(v3, v3[4]);
    OverwriteAssetSoundName__PlaySystemSe(v4, 0, 0, 0LL);
    operationSortInfo = this->fields.operationSortInfo;
    if ( !operationSortInfo )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CC1 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_EndOpen__, v11);
  ...
  if ( !this->fields.state )
  {
    ...
    if ( gameObject )
    {
      ...
      if ( baseSortInfo )
      {
        ...
        v26 = (ListViewSort_o *)sub_1BCB244(ListViewSort_TypeInfo);
        ListViewSort___ctor_42966300(v26, baseSortInfo, 0LL);
        p_operationSortInfo = &this->fields.operationSortInfo;
        this->fields.operationSortInfo = v26;
        sub_1BCAF9C((CGThumbnailListItem_o *)&this->fields.operationSortInfo, (int32_t)v26, v28, v29);
                    ...
                    if ( clearLabel )
                    {
                      ...
                      if ( resetLabel )
                      {
                        ...
                        if ( sortLabel )
                        {
                          ...
                          if ( v45->max_length <= 3 )
LABEL_37:
                            sub_1BCB25C(gameObject, v21, v38);
                          gameObject = (UnityEngine_GameObject_o *)*p_operationSortInfo;
                          if ( *p_operationSortInfo )
                          {
                            v46 = v45->m_Items[3];
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CC8 & 1) == 0 )
  {
    ...
    this = (UserServantCoinSortSelectMenu_o *)sub_1BCAFF8(&StringLiteral_17298/*"btn_bg_03"*/, v11);
    byte_4B17CC8 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( !servantFilterRoot
    || (UnityEngine_GameObject__SetActive(servantFilterRoot, 1, 0LL),
        v6 = (System_Array_o *)sub_1BCB0A0(ListViewSort_FilterCategoryKind___TypeInfo, 4LL),
        ...
        System_Runtime_CompilerServices_RuntimeHelpers__InitializeArray_63149500(v6, v9, 0LL),
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CC5 & 1) == 0 )
  {
    ...
    sub_1BCAFF8(&Method_System_Collections_Generic_List_ServantFilterButtonControl__GetEnumerator__, v9);
    sub_1BCAFF8(&ServantFilterButtonControl_OnClickFilterButton_TypeInfo, v10);
    sub_1BCAFF8(&System_Predicate_ServantFilterButtonControl__TypeInfo, v11);
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu_OnClickFilterButton__, v12);
    sub_1BCAFF8(&Method_UserServantCoinSortSelectMenu__SetupFilterButtons_b__42_0__, v13);
    byte_4B17CC5 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B17CBF & 1) == 0 )
  {
    sub_1BCAFF8(&UserServantCoinSortSelectMenu_CallbackFunc_TypeInfo, value);
    byte_4B17CBF = 1;
  }
  ...
  v10 = (UserServantCoinSortSelectMenu_o *)sub_1BCB514(v7);
...
LABEL_5:
  ...
  this->fields.m_target = (Il2CppObject *)sub_1A0EEE8;
LABEL_6:
  this->fields.method_info = (struct System_Reflection_MethodInfo_o *)sub_1A0EEA0;
}
