void BattleCallBack_int__bool__bool____ctor(
        ...
        const MethodInfo_330D2F4 *method)
{
  ...
  sub_1C32BC4((CGThumbnailListItem_o *)v8, (int32_t)callBack, v11, v12);
}


void BattleCallBack_int__bool__bool___call(BattleCallBack_int__bool__bool__o *this, const MethodInfo_330D344 *method)
{
  ActionExtensions__Call_int__bool__bool_(
    ...
    this->fields.arg2,
    this->fields.arg3,
    (const MethodInfo_302A2C8 *)method->klass->rgctx_data->_5_ActionExtensions_Call_T1__T2__T3_);
}