void BattleCallBack_int__bool__bool____ctor(
        ...
        const MethodInfo_32FE854 *method)
{
  ...
  sub_1C2D434((CGThumbnailListItem_o *)v8, (int32_t)callBack, v11, v12);
}


void BattleCallBack_int__bool__bool___call(BattleCallBack_int__bool__bool__o *this, const MethodInfo_32FE8A4 *method)
{
  ActionExtensions__Call_int__bool__bool_(
    ...
    this->fields.arg2,
    this->fields.arg3,
    (const MethodInfo_301B828 *)method->klass->rgctx_data->_5_ActionExtensions_Call_T1__T2__T3_);
}