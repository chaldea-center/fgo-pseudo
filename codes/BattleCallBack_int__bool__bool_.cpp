void __fastcall BattleCallBack_int__bool__bool____ctor(
        ...
        const MethodInfo_30DC27C *method)
{
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)v8, (int32_t)callBack, v11, v12);
}


void __fastcall BattleCallBack_int__bool__bool___call(
        BattleCallBack_int__bool__bool__o *this,
        const MethodInfo_30DC2CC *method)
{
  ActionExtensions__Call_int__bool__bool_(
    ...
    this->fields.arg2,
    this->fields.arg3,
    (const MethodInfo_2E18994 *)method->klass->rgctx_data->_5_ActionExtensions_Call_T1__T2__T3_);
}