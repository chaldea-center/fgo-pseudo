void __fastcall BattleCallBack_int__bool__bool____ctor(
        ...
        const MethodInfo_30A5110 *method)
{
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)v8, (int32_t)callBack, v11, v12);
}


void __fastcall BattleCallBack_int__bool__bool___call(
        BattleCallBack_int__bool__bool__o *this,
        const MethodInfo_30A5160 *method)
{
  ActionExtensions__Call_int__bool__bool_(
    ...
    this->fields.arg2,
    this->fields.arg3,
    (const MethodInfo_2DE3A24 *)method->klass->rgctx_data->_5_ActionExtensions_Call_T1__T2__T3_);
}