        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F254 & 1) == 0 )
  {
    sub_1BDB878(&Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__, method);
    byte_4B3F254 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1BDB890(Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B3F253 & 1) == 0 )
  {
    ...
    sub_1BDB878(&Method_CommandAssistLvUpDialogComponent__Open_b__11_0__, v9);
    sub_1BDB878(&CondType_TypeInfo, v10);
    sub_1BDB878(&LocalizationManager_TypeInfo, v11);
    sub_1BDB878(&UnityEngine_Object_TypeInfo, v12);
    sub_1BDB878(&StringLiteral_5589/*"EVENT_COMMAND_ASSIST_EVENT_END_MSG"*/, v13);
    sub_1BDB878(&StringLiteral_5590/*"EVENT_COMMAND_ASSIST_LEVEL_UP_DIALOG_TITLE"*/, v14);
