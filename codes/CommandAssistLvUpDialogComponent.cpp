        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71B73 & 1) == 0 )
  {
    sub_1D0F0B4(&Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__);
    byte_4E71B73 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1D0F0CC(Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4E71B72 & 1) == 0 )
  {
    ...
    sub_1D0F0B4(&Method_CommandAssistLvUpDialogComponent__Open_b__11_0__);
    sub_1D0F0B4(&CondType_TypeInfo);
    sub_1D0F0B4(&LocalizationManager_TypeInfo);
    sub_1D0F0B4(&UnityEngine_Object_TypeInfo);
    sub_1D0F0B4(&StringLiteral_5614/*"EVENT_COMMAND_ASSIST_EVENT_END_MSG"*/);
    sub_1D0F0B4(&StringLiteral_5615/*"EVENT_COMMAND_ASSIST_LEVEL_UP_DIALOG_TITLE"*/);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5615/*"EVENT_COMMAND_ASSIST_LEVEL_UP_DIALOG_TITLE"*/, 0);
  if ( !titleLabel )
    goto LABEL_19;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5614/*"EVENT_COMMAND_ASSIST_EVENT_END_MSG"*/, 0);
