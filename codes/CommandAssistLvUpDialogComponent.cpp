        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024E2 & 1) == 0 )
  {
    sub_1B64870(&Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__, method);
    byte_4A024E2 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64888(Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A024E1 & 1) == 0 )
  {
    ...
    sub_1B64870(&Method_CommandAssistLvUpDialogComponent__Open_b__11_0__, v9);
    sub_1B64870(&CondType_TypeInfo, v10);
    sub_1B64870(&LocalizationManager_TypeInfo, v11);
    sub_1B64870(&UnityEngine_Object_TypeInfo, v12);
    sub_1B64870(&StringLiteral_5555/*"EVENT_COMMAND_ASSIST_EVENT_END_MSG"*/, v13);
    sub_1B64870(&StringLiteral_5556/*"EVENT_COMMAND_ASSIST_LEVEL_UP_DIALOG_TITLE"*/, v14);
  ...
  sub_1B64814((ServantStatusBattleListViewItem_o *)&this->fields.closeCallback, (int32_t)closeCallback, v22, v23);
