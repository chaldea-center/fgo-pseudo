        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02B03 & 1) == 0 )
  {
    sub_1B64A00(&Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__, method);
    byte_4A02B03 = 1;
  }
  if ( this->fields.state == 2 )
  {
    ...
    if ( (*((_BYTE *)Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__ + 83) & 2) != 0 )
      v3 = (_QWORD *)sub_1B64A18(Method_CommandAssistLvUpDialogComponent_OnClickCloseButton__);
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A02B02 & 1) == 0 )
  {
    ...
    sub_1B64A00(&Method_CommandAssistLvUpDialogComponent__Open_b__11_0__, v9);
    sub_1B64A00(&CondType_TypeInfo, v10);
    sub_1B64A00(&LocalizationManager_TypeInfo, v11);
    sub_1B64A00(&UnityEngine_Object_TypeInfo, v12);
    sub_1B64A00(&StringLiteral_5556/*"EVENT_COMMAND_ASSIST_EVENT_END_MSG"*/, v13);
    sub_1B64A00(&StringLiteral_5557/*"EVENT_COMMAND_ASSIST_LEVEL_UP_DIALOG_TITLE"*/, v14);
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5557/*"EVENT_COMMAND_ASSIST_LEVEL_UP_DIALOG_TITLE"*/, 0LL);
  if ( !titleLabel )
    goto LABEL_19;
  ...
  gameObject = (UnityEngine_GameObject_o *)LocalizationManager__Get((System_String_o *)StringLiteral_5556/*"EVENT_COMMAND_ASSIST_EVENT_END_MSG"*/, 0LL);
  if ( !endEventMessageLabel )
    goto LABEL_19;
  UILabel__set_text(endEventMessageLabel, (System_String_o *)gameObject, 0LL);
  this->fields.closeCallback = closeCallback;
  sub_1B649A4((ServantStatusBattleListViewItem_o *)&this->fields.closeCallback, (int32_t)closeCallback, v22, v23);
