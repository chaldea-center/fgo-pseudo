void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A4F4CB & 1) == 0 )
  {
    sub_1B863B8(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4A4F4CB = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_41328724(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F4C0 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_string___ctor__, old);
    byte_4A4F4C0 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1B8635C((CGThumbnailListItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v11, v12);
}
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_4A4F4C2 & 1) == 0 )
  {
    sub_1B863B8(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_4A4F4C2 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F4C1 & 1) == 0 )
  {
    sub_1B863B8(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4A4F4C1 = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F4C4 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_9128/*"NONE"*/, v10);
    sub_1B863B8(&StringLiteral_15288/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_4A4F4C4 = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15288/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9128/*"NONE"*/, 0LL) )
      return name;
    Instance = (clsQuestCheck_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3839680 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1B8661C(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_18800/*"enemyNameEffect"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F4C9 & 1) == 0 )
  {
    sub_1B863B8(&Method_BasicHelper_GetValue_Dictionary_string__object____, method);
    sub_1B863B8(&StringLiteral_14901/*"UnknownDispInfo"*/, v3);
    byte_4A4F4C9 = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.enemyScript,
                                                                      (System_String_o *)StringLiteral_14901/*"UnknownDispInfo"*/,
                                                                      0LL,
                                                                      (const MethodInfo_2F5B964 *)Method_BasicHelper_GetValue_Dictionary_string__object____);
}
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A4F4C7 & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_24397/*"viewWaveEnemyDispDanger"*/, method);
    byte_4A4F4C7 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24397/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A4F4C8 & 1) == 0 )
  {
    ...
    sub_1B863B8(&StringLiteral_24398/*"viewWaveEnemyHideName"*/, v5);
    byte_4A4F4C8 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24398/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A4F4CA & 1) == 0 )
  {
    sub_1B863B8(&StringLiteral_17759/*"className"*/, *(_QWORD *)&kind);
    sub_1B863B8(&StringLiteral_19137/*"faceSprite"*/, v7);
    sub_1B863B8(&StringLiteral_17757/*"classIconImage"*/, v8);
    sub_1B863B8(&StringLiteral_18799/*"enemyName"*/, v9);
    byte_4A4F4CA = 1;
  }
  if ( unknownDispInfo
    || (v10 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v10) != 0LL) )
  {
    ...
    {
      case 0:
        v11 = &StringLiteral_17757/*"classIconImage"*/;
        goto LABEL_11;
      case 1:
        v11 = &StringLiteral_17759/*"className"*/;
        goto LABEL_11;
      case 2:
        v11 = &StringLiteral_18799/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v11 = &StringLiteral_19137/*"faceSprite"*/;
LABEL_11:
