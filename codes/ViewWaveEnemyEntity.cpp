void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4C22F25 & 1) == 0 )
  {
    sub_1C3B764(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4C22F25 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_41763460(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22F1A & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_string___ctor__, old);
    byte_4C22F1A = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_4C22F1C & 1) == 0 )
  {
    sub_1C3B764(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_4C22F1C = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22F1B & 1) == 0 )
  {
    sub_1C3B764(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4C22F1B = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22F1E & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_9440/*"OPTION_FRIEND_MESSAGE_EXPLANATION"*/, v10);
    sub_1C3B764(&StringLiteral_15822/*"_ClipRange2"*/, v11);
    byte_4C22F1E = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15822/*"_ClipRange2"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9440/*"OPTION_FRIEND_MESSAGE_EXPLANATION"*/, 0LL) )
      return name;
    Instance = (clsQuestCheck_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_38C8734 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1C3B9C8(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19399/*"getDeclaringClass"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22F23 & 1) == 0 )
  {
    sub_1C3B764(&Method_BasicHelper_GetValue_Dictionary_string__object____, method);
    sub_1C3B764(&StringLiteral_15427/*"XmlNodeConverter cannot convert JSON with an empty property name to XML."*/, v3);
    byte_4C22F23 = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.enemyScript,
                                                                      (System_String_o *)StringLiteral_15427/*"XmlNodeConverter cannot convert JSON with an empty property name to XML."*/,
                                                                      0LL,
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C22F21 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_25069/*"𠀀"*/, method);
    byte_4C22F21 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25069/*"𠀀"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C22F22 & 1) == 0 )
  {
    ...
    sub_1C3B764(&StringLiteral_25070/*"𯿽"*/, v5);
    byte_4C22F22 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25070/*"𯿽"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C22F24 & 1) == 0 )
  {
    sub_1C3B764(&StringLiteral_18342/*"durationMilliseconds"*/, *(_QWORD *)&kind);
    sub_1C3B764(&StringLiteral_19738/*"icon_append_mini"*/, v7);
    sub_1C3B764(&StringLiteral_18340/*"dummyCueSheet_streamfiles.awb"*/, v8);
    sub_1C3B764(&StringLiteral_19398/*"getDebugMessage"*/, v9);
    byte_4C22F24 = 1;
  }
  if ( unknownDispInfo
    || (v10 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v10) != 0LL) )
  {
    ...
    {
      case 0:
        v11 = &StringLiteral_18340/*"dummyCueSheet_streamfiles.awb"*/;
        goto LABEL_11;
      case 1:
        v11 = &StringLiteral_18342/*"durationMilliseconds"*/;
        goto LABEL_11;
      case 2:
        v11 = &StringLiteral_19398/*"getDebugMessage"*/;
        goto LABEL_11;
      case 3:
        v11 = &StringLiteral_19738/*"icon_append_mini"*/;
LABEL_11:
