void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4B45AE5 & 1) == 0 )
  {
    sub_1BDB878(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4B45AE5 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_42198560(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45AD9 & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_string___ctor__, old);
    byte_4B45AD9 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1BDB81C((CGThumbnailListItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v11, v12);
}
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_4B45ADB & 1) == 0 )
  {
    sub_1BDB878(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_4B45ADB = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45ADA & 1) == 0 )
  {
    sub_1BDB878(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4B45ADA = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B45ADD & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_9273/*"NONE"*/, v10);
    sub_1BDB878(&StringLiteral_15488/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_4B45ADD = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15488/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9273/*"NONE"*/, 0LL) )
      return name;
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1BDBADC(EnemyInfoOverwriteNpcSvtNameList, v21, v22);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19043/*"enemyNameEffect"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45AE2 & 1) == 0 )
  {
    sub_1BDB878(&Method_BasicHelper_GetValue_Dictionary_string__object____, method);
    sub_1BDB878(&StringLiteral_15099/*"UnknownDispInfo"*/, v3);
    byte_4B45AE2 = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.enemyScript,
                                                                      (System_String_o *)StringLiteral_15099/*"UnknownDispInfo"*/,
                                                                      0LL,
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B45AE0 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_24753/*"viewWaveEnemyDispDanger"*/, method);
    byte_4B45AE0 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24753/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsGrand(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4B45AE4 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_20934/*"isGrandSvt"*/, method);
    byte_4B45AE4 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_20934/*"isGrandSvt"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4B45AE1 & 1) == 0 )
  {
    ...
    sub_1BDB878(&StringLiteral_24754/*"viewWaveEnemyHideName"*/, v5);
    byte_4B45AE1 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24754/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4B45AE3 & 1) == 0 )
  {
    sub_1BDB878(&StringLiteral_17996/*"className"*/, *(_QWORD *)&kind);
    sub_1BDB878(&StringLiteral_19380/*"faceSprite"*/, v7);
    sub_1BDB878(&StringLiteral_17994/*"classIconImage"*/, v8);
    sub_1BDB878(&StringLiteral_19042/*"enemyName"*/, v9);
    byte_4B45AE3 = 1;
  }
  if ( unknownDispInfo
    || (v10 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v10) != 0LL) )
  {
    ...
    {
      case 0:
        v11 = &StringLiteral_17994/*"classIconImage"*/;
        goto LABEL_11;
      case 1:
        v11 = &StringLiteral_17996/*"className"*/;
        goto LABEL_11;
      case 2:
        v11 = &StringLiteral_19042/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v11 = &StringLiteral_19380/*"faceSprite"*/;
LABEL_11:
