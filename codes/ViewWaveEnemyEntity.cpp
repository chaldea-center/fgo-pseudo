...
void ViewWaveEnemyEntity___ctor_43958676(
...
System_String_o *ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D31AAA & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_15606/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/);
    byte_4D31AAA = 1;
  }
  entity = 0;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15606/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0);
  }
...
int32_t ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19229/*"enemyNameEffect"*/, 0, v2);
}
...
bool ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4D31AAD & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_25009/*"viewWaveEnemyDispDanger"*/);
    byte_4D31AAD = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25009/*"viewWaveEnemyDispDanger"*/, 0, 0) > 0;
}
...
bool ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4D31AAE & 1) == 0 )
  {
    ...
    sub_1C93AD4(&StringLiteral_25010/*"viewWaveEnemyHideName"*/);
    byte_4D31AAE = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25010/*"viewWaveEnemyHideName"*/, 0, 0);
  if ( IntValue < 1 )
    return 0;
  v4 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4D31AB0 & 1) == 0 )
  {
    sub_1C93AD4(&StringLiteral_18130/*"className"*/);
    sub_1C93AD4(&StringLiteral_19583/*"faceSprite"*/);
    sub_1C93AD4(&StringLiteral_18128/*"classIconImage"*/);
    sub_1C93AD4(&StringLiteral_19228/*"enemyName"*/);
    byte_4D31AB0 = 1;
  }
  if ( unknownDispInfo
    || (v7 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v7) != 0) )
  {
    ...
    {
      case 0:
        v8 = &StringLiteral_18128/*"classIconImage"*/;
        goto LABEL_11;
      case 1:
        v8 = &StringLiteral_18130/*"className"*/;
        goto LABEL_11;
      case 2:
        v8 = &StringLiteral_19228/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v8 = &StringLiteral_19583/*"faceSprite"*/;
LABEL_11:
