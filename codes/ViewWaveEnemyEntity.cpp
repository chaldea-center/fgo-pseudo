void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_49BBE53 & 1) == 0 )
  {
    sub_1B4CF90(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_49BBE53 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_40889924(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBE48 & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_string___ctor__, old);
    byte_49BBE48 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1B4CF34((CGThumbnailListItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v11, v12);
}
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_49BBE4A & 1) == 0 )
  {
    sub_1B4CF90(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_49BBE4A = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBE49 & 1) == 0 )
  {
    sub_1B4CF90(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_49BBE49 = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BBE4C & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_9078/*"NONE"*/, v10);
    sub_1B4CF90(&StringLiteral_15215/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_49BBE4C = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15215/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9078/*"NONE"*/, 0LL) )
      return name;
    Instance = (clsQuestCheck_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_37B4410 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1B4D1F4(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_18717/*"enemyNameEffect"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBE51 & 1) == 0 )
  {
    sub_1B4CF90(&Method_BasicHelper_GetValue_Dictionary_string__object____, method);
    sub_1B4CF90(&StringLiteral_14827/*"UnknownDispInfo"*/, v3);
    byte_49BBE51 = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.enemyScript,
                                                                      (System_String_o *)StringLiteral_14827/*"UnknownDispInfo"*/,
                                                                      0LL,
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_49BBE4F & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_24272/*"viewWaveEnemyDispDanger"*/, method);
    byte_49BBE4F = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24272/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_49BBE50 & 1) == 0 )
  {
    ...
    sub_1B4CF90(&StringLiteral_24273/*"viewWaveEnemyHideName"*/, v5);
    byte_49BBE50 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24273/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_49BBE52 & 1) == 0 )
  {
    sub_1B4CF90(&StringLiteral_17683/*"className"*/, *(_QWORD *)&kind);
    sub_1B4CF90(&StringLiteral_19051/*"faceSprite"*/, v7);
    sub_1B4CF90(&StringLiteral_17681/*"classIconImage"*/, v8);
    sub_1B4CF90(&StringLiteral_18716/*"enemyName"*/, v9);
    byte_49BBE52 = 1;
  }
  if ( unknownDispInfo
    || (v10 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v10) != 0LL) )
  {
    ...
    {
      case 0:
        v11 = &StringLiteral_17681/*"classIconImage"*/;
        goto LABEL_11;
      case 1:
        v11 = &StringLiteral_17683/*"className"*/;
        goto LABEL_11;
      case 2:
        v11 = &StringLiteral_18716/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v11 = &StringLiteral_19051/*"faceSprite"*/;
LABEL_11:
