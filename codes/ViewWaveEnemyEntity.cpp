void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BC8A24 & 1) == 0 )
  {
    sub_1C1ABD4(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4BC8A24 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_41511204(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8A1B & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_string___ctor__, old);
    byte_4BC8A1B = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_4BC8A1D & 1) == 0 )
  {
    sub_1C1ABD4(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_4BC8A1D = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BC8A1C & 1) == 0 )
  {
    sub_1C1ABD4(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4BC8A1C = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC8A1F & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_9434/*"NONE"*/, v10);
    sub_1C1ABD4(&StringLiteral_15770/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_4BC8A1F = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15770/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9434/*"NONE"*/, 0LL) )
      return name;
    Instance = (clsQuestCheck_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_387A8A8 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1C1AE38(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19338/*"enemyNameEffect"*/, 0, v2);
}
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BC8A22 & 1) == 0 )
  {
    sub_1C1ABD4(&StringLiteral_24980/*"viewWaveEnemyDispDanger"*/, method);
    byte_4BC8A22 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24980/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BC8A23 & 1) == 0 )
  {
    ...
    sub_1C1ABD4(&StringLiteral_24981/*"viewWaveEnemyHideName"*/, v5);
    byte_4BC8A23 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24981/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
