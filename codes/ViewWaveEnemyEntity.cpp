void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BB5645 & 1) == 0 )
  {
    sub_1C13D24(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4BB5645 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_41453100(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB563C & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_string___ctor__, old);
    byte_4BB563C = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_4BB563E & 1) == 0 )
  {
    sub_1C13D24(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_4BB563E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BB563D & 1) == 0 )
  {
    sub_1C13D24(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4BB563D = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB5640 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_9428/*"NMTOKEN"*/, v10);
    sub_1C13D24(&StringLiteral_15758/*"WAVE_BATTLE_COST_OVER_MESSAGE"*/, v11);
    byte_4BB5640 = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15758/*"WAVE_BATTLE_COST_OVER_MESSAGE"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9428/*"NMTOKEN"*/, 0LL) )
      return name;
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1C13F88(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19324/*"endVoiceOff"*/, 0, v2);
}
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BB5643 & 1) == 0 )
  {
    sub_1C13D24(&StringLiteral_24958/*"verticalImageChange"*/, method);
    byte_4BB5643 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24958/*"verticalImageChange"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BB5644 & 1) == 0 )
  {
    ...
    sub_1C13D24(&StringLiteral_24959/*"verticalImageSet"*/, v5);
    byte_4BB5644 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24959/*"verticalImageSet"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
