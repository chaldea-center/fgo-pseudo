void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A09B4D & 1) == 0 )
  {
    sub_1B686D4(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4A09B4D = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_40023088(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1B68678((ServantStatusBattleListViewItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v11, v12);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A09B45 & 1) == 0 )
  {
    sub_1B686D4(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4A09B45 = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A09B48 & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_9214/*"NONE"*/, v10);
    sub_1B686D4(&StringLiteral_15449/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_4A09B48 = 1;
  }
  entity = 0LL;
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1B68938(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_18957/*"enemyNameEffect"*/, 0, v2);
}
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A09B4B & 1) == 0 )
  {
    sub_1B686D4(&StringLiteral_24477/*"viewWaveEnemyDispDanger"*/, method);
    byte_4A09B4B = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24477/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A09B4C & 1) == 0 )
  {
    ...
    sub_1B686D4(&StringLiteral_24478/*"viewWaveEnemyHideName"*/, v5);
    byte_4A09B4C = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24478/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
