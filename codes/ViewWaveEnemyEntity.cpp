...
void __fastcall ViewWaveEnemyEntity___ctor_41562592(
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD4C2 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_15781/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/);
    byte_4BDD4C2 = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15781/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_29:
  ...
  if ( v10 >= max_length )
    sub_1C2209C(EnemyInfoOverwriteNpcSvtNameList, v12);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19353/*"enemyNameEffect"*/, 0, v2);
}
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BDD4C5 & 1) == 0 )
  {
    sub_1C21E38(&StringLiteral_25001/*"viewWaveEnemyDispDanger"*/);
    byte_4BDD4C5 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25001/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BDD4C6 & 1) == 0 )
  {
    ...
    sub_1C21E38(&StringLiteral_25002/*"viewWaveEnemyHideName"*/);
    byte_4BDD4C6 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25002/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v4 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
