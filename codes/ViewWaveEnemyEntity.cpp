...
void ViewWaveEnemyEntity___ctor_43797964(
...
System_String_o *ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEF729 & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_15564/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/);
    byte_4CEF729 = 1;
  }
  entity = 0;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15564/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9302/*"NONE"*/, 0) )
      return name;
...
LABEL_29:
  ...
  if ( v10 >= max_length )
    sub_1C7BD48(EnemyInfoOverwriteNpcSvtNameList);
...
int32_t ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19178/*"enemyNameEffect"*/, 0, v2);
}
...
bool ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CEF72C & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_24940/*"viewWaveEnemyDispDanger"*/);
    byte_4CEF72C = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24940/*"viewWaveEnemyDispDanger"*/, 0, 0) > 0;
}
...
bool ViewWaveEnemyEntity__IsGrand(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CEF730 & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_21101/*"isGrandSvt"*/);
    byte_4CEF730 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_21101/*"isGrandSvt"*/, 0, 0) > 0;
}
...
bool ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CEF72D & 1) == 0 )
  {
    ...
    sub_1C7BAE8(&StringLiteral_24941/*"viewWaveEnemyHideName"*/);
    byte_4CEF72D = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24941/*"viewWaveEnemyHideName"*/, 0, 0);
  if ( IntValue < 1 )
    return 0;
  v4 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CEF72F & 1) == 0 )
  {
    sub_1C7BAE8(&StringLiteral_18082/*"className"*/);
    sub_1C7BAE8(&StringLiteral_19530/*"faceSprite"*/);
    sub_1C7BAE8(&StringLiteral_18080/*"classIconImage"*/);
    sub_1C7BAE8(&StringLiteral_19177/*"enemyName"*/);
    byte_4CEF72F = 1;
  }
  if ( unknownDispInfo
    || (v7 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v7) != 0) )
  {
    switch ( kind )
    {
      ...
      case 1:
        ...
        goto LABEL_11;
      case 2:
        v8 = &StringLiteral_19177/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v8 = &StringLiteral_19530/*"faceSprite"*/;
LABEL_11:
