void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4A70D75 & 1) == 0 )
  {
    sub_1B90010(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4A70D75 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_40341604(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70D6C & 1) == 0 )
  {
    sub_1B90010(&Method_DataEntityBase_string___ctor__, old);
    byte_4A70D6C = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1B8FFB4((ServantStatusBattleListViewItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v11, v12);
}
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_4A70D6E & 1) == 0 )
  {
    sub_1B90010(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_4A70D6E = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4A70D6D & 1) == 0 )
  {
    sub_1B90010(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4A70D6D = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70D70 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_9255/*"NONE"*/, v10);
    sub_1B90010(&StringLiteral_15540/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_4A70D70 = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15540/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9255/*"NONE"*/, 0LL) )
      return name;
    Instance = (clsQuestCheck_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_374C890 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1B90274(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19052/*"enemyNameEffect"*/, 0, v2);
}
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4A70D73 & 1) == 0 )
  {
    sub_1B90010(&StringLiteral_24599/*"viewWaveEnemyDispDanger"*/, method);
    byte_4A70D73 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24599/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4A70D74 & 1) == 0 )
  {
    ...
    sub_1B90010(&StringLiteral_24600/*"viewWaveEnemyHideName"*/, v5);
    byte_4A70D74 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24600/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
