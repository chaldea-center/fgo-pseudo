void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4BFE700 & 1) == 0 )
  {
    sub_1C2E12C(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4BFE700 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_41646028(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE6F6 & 1) == 0 )
  {
    sub_1C2E12C(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4BFE6F6 = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE6F9 & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_9438/*"NONE"*/, v10);
    sub_1C2E12C(&StringLiteral_15794/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_4BFE6F9 = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15794/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1C2E390(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19364/*"enemyNameEffect"*/, 0, v2);
}
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE6FE & 1) == 0 )
  {
    sub_1C2E12C(&Method_BasicHelper_GetValue_Dictionary_string__object____, method);
    sub_1C2E12C(&StringLiteral_15399/*"UnknownDispInfo"*/, v3);
    byte_4BFE6FE = 1;
  }
  return (System_Collections_Generic_Dictionary_string__object__o *)BasicHelper__GetValue_object_(
                                                                      this->fields.enemyScript,
                                                                      (System_String_o *)StringLiteral_15399/*"UnknownDispInfo"*/,
                                                                      0LL,
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4BFE6FC & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_25025/*"viewWaveEnemyDispDanger"*/, method);
    byte_4BFE6FC = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25025/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4BFE6FD & 1) == 0 )
  {
    ...
    sub_1C2E12C(&StringLiteral_25026/*"viewWaveEnemyHideName"*/, v5);
    byte_4BFE6FD = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_25026/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4BFE6FF & 1) == 0 )
  {
    sub_1C2E12C(&StringLiteral_18308/*"className"*/, *(_QWORD *)&kind);
    sub_1C2E12C(&StringLiteral_19703/*"faceSprite"*/, v7);
    sub_1C2E12C(&StringLiteral_18306/*"classIconImage"*/, v8);
    sub_1C2E12C(&StringLiteral_19363/*"enemyName"*/, v9);
    byte_4BFE6FF = 1;
  }
  if ( unknownDispInfo
    || (v10 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v10) != 0LL) )
  {
    ...
    {
      case 0:
        v11 = &StringLiteral_18306/*"classIconImage"*/;
        goto LABEL_11;
      case 1:
        v11 = &StringLiteral_18308/*"className"*/;
        goto LABEL_11;
      case 2:
        v11 = &StringLiteral_19363/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v11 = &StringLiteral_19703/*"faceSprite"*/;
LABEL_11:
