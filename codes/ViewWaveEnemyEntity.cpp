...
void ViewWaveEnemyEntity___ctor_43263280(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1C36FFC((CGThumbnailListItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v10, v11);
}
...
System_String_o *ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44093 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_15507/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/);
    byte_4C44093 = 1;
  }
  entity = 0;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15507/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0);
  }
...
int32_t ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19038/*"enemyNameEffect"*/, 0, v2);
}
...
bool ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4C44096 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_24693/*"viewWaveEnemyDispDanger"*/);
    byte_4C44096 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24693/*"viewWaveEnemyDispDanger"*/, 0, 0) > 0;
}
...
bool ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4C44097 & 1) == 0 )
  {
    ...
    sub_1C37058(&StringLiteral_24694/*"viewWaveEnemyHideName"*/);
    byte_4C44097 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24694/*"viewWaveEnemyHideName"*/, 0, 0);
  if ( IntValue < 1 )
    return 0;
  v4 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4C44099 & 1) == 0 )
  {
    sub_1C37058(&StringLiteral_17990/*"className"*/);
    sub_1C37058(&StringLiteral_19376/*"faceSprite"*/);
    sub_1C37058(&StringLiteral_17988/*"classIconImage"*/);
    sub_1C37058(&StringLiteral_19037/*"enemyName"*/);
    byte_4C44099 = 1;
  }
  if ( unknownDispInfo
    || (v7 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v7) != 0) )
  {
    ...
    {
      case 0:
        v8 = &StringLiteral_17988/*"classIconImage"*/;
        goto LABEL_11;
      case 1:
        v8 = &StringLiteral_17990/*"className"*/;
        goto LABEL_11;
      case 2:
        v8 = &StringLiteral_19037/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v8 = &StringLiteral_19376/*"faceSprite"*/;
LABEL_11:
