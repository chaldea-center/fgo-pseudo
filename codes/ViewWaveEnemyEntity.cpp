void __fastcall ViewWaveEnemyEntity___cctor(const MethodInfo *method)
{
  ...
  if ( (byte_4AB6C69 & 1) == 0 )
  {
    sub_1BAB41C(&ViewWaveEnemyEntity_TypeInfo, v1);
    byte_4AB6C69 = 1;
  }
...
void __fastcall ViewWaveEnemyEntity___ctor_40679764(
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6C60 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_string___ctor__, old);
    byte_4AB6C60 = 1;
  }
  DataEntityBase_object____ctor(
    (DataEntityBase_PKType__o *)this,
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1BAB3C0((ServantStatusBattleListViewItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v11, v12);
}
...
System_String_o *__fastcall ViewWaveEnemyEntity__CreatePK(int32_t questId, int32_t enemyId, const MethodInfo *method)
{
  if ( (byte_4AB6C62 & 1) == 0 )
  {
    sub_1BAB41C(&Method_DataEntityBase_CreateMultiplePK_int__int___, *(_QWORD *)&enemyId);
    byte_4AB6C62 = 1;
  }
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4AB6C61 & 1) == 0 )
  {
    sub_1BAB41C(&ViewWaveEnemyEntity_TypeInfo, method);
    byte_4AB6C61 = 1;
  }
...
System_String_o *__fastcall ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB6C64 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_9256/*"NONE"*/, v10);
    sub_1BAB41C(&StringLiteral_15546/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, v11);
    byte_4AB6C64 = 1;
  }
  entity = 0LL;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15546/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0LL);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9256/*"NONE"*/, 0LL) )
      return name;
    Instance = (clsQuestCheck_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_378A22C *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_29:
  ...
  if ( v19 >= max_length )
    sub_1BAB680(EnemyInfoOverwriteNpcSvtNameList, v21);
...
int32_t __fastcall ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19055/*"enemyNameEffect"*/, 0, v2);
}
...
bool __fastcall ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4AB6C67 & 1) == 0 )
  {
    sub_1BAB41C(&StringLiteral_24602/*"viewWaveEnemyDispDanger"*/, method);
    byte_4AB6C67 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24602/*"viewWaveEnemyDispDanger"*/, 0, 0LL) > 0;
}
...
bool __fastcall ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4AB6C68 & 1) == 0 )
  {
    ...
    sub_1BAB41C(&StringLiteral_24603/*"viewWaveEnemyHideName"*/, v5);
    byte_4AB6C68 = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24603/*"viewWaveEnemyHideName"*/, 0, 0LL);
  if ( IntValue < 1 )
    return 0;
  v7 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
