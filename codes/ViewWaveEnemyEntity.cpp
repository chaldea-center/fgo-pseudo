...
void ViewWaveEnemyEntity___ctor_43508904(
        ...
        const MethodInfo *method)
{
  ...
  *(_QWORD *)&this->fields.displayType = *(_QWORD *)&old->fields.displayType;
  ...
  sub_1C6B9AC((CGThumbnailListItem_o *)&this->fields.enemyScript, (int32_t)enemyScript, v11, v12);
}
...
System_String_o *ViewWaveEnemyEntity__GetBattleName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB73C9 & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_15504/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/);
    byte_4CB73C9 = 1;
  }
  entity = 0;
  if ( ViewWaveEnemyEntity__IsHideName(this, method) )
  {
    ...
    return LocalizationManager__Get((System_String_o *)StringLiteral_15504/*"WAVE_BATTLE_HIDE_ENEMY_NAME"*/, 0);
  }
...
LABEL_22:
    ...
    if ( !System_String__op_Equality(name, (System_String_o *)StringLiteral_9273/*"NONE"*/, 0) )
      return name;
    Instance = (clsQuestCheck_o *)SingletonMonoBehaviour_object___get_Instance((const MethodInfo_3A4F3B4 *)Method_SingletonMonoBehaviour_DataManager__get_Instance__);
    if ( Instance )
    {
...
LABEL_29:
  ...
  if ( v10 >= max_length )
    sub_1C6BC68(EnemyInfoOverwriteNpcSvtNameList);
...
int32_t ViewWaveEnemyEntity__GetEnemyNameEffect(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  return ViewWaveEnemyEntity__GetScript(this, (System_String_o *)StringLiteral_19087/*"enemyNameEffect"*/, 0, v2);
}
...
bool ViewWaveEnemyEntity__IsDispDanger(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CB73CC & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_24797/*"viewWaveEnemyDispDanger"*/);
    byte_4CB73CC = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24797/*"viewWaveEnemyDispDanger"*/, 0, 0) > 0;
}
...
bool ViewWaveEnemyEntity__IsGrand(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  if ( (byte_4CB73D0 & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_20990/*"isGrandSvt"*/);
    byte_4CB73D0 = 1;
  }
  return EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_20990/*"isGrandSvt"*/, 0, 0) > 0;
}
...
bool ViewWaveEnemyEntity__IsHideName(ViewWaveEnemyEntity_o *this, const MethodInfo *method)
{
  ...
  if ( (byte_4CB73CD & 1) == 0 )
  {
    ...
    sub_1C6BA08(&StringLiteral_24798/*"viewWaveEnemyHideName"*/);
    byte_4CB73CD = 1;
  }
  IntValue = EntityScriptUtil__GetIntValue(this->fields.enemyScript, (System_String_o *)StringLiteral_24798/*"viewWaveEnemyHideName"*/, 0, 0);
  if ( IntValue < 1 )
    return 0;
  v4 = IntValue;
  if ( !DataManager_TypeInfo->_2.cctor_finished )
        ...
        const MethodInfo *method)
{
  ...
  if ( (byte_4CB73CF & 1) == 0 )
  {
    sub_1C6BA08(&StringLiteral_18007/*"className"*/);
    sub_1C6BA08(&StringLiteral_19437/*"faceSprite"*/);
    sub_1C6BA08(&StringLiteral_18005/*"classIconImage"*/);
    sub_1C6BA08(&StringLiteral_19086/*"enemyName"*/);
    byte_4CB73CF = 1;
  }
  if ( unknownDispInfo
    || (v7 = ViewWaveEnemyEntity__GetUnknownDispInfo(this, *(const MethodInfo **)&kind), (unknownDispInfo = v7) != 0) )
  {
    switch ( kind )
    {
      ...
      case 1:
        ...
        goto LABEL_11;
      case 2:
        v8 = &StringLiteral_19086/*"enemyName"*/;
        goto LABEL_11;
      case 3:
        v8 = &StringLiteral_19437/*"faceSprite"*/;
LABEL_11:
